...
#[no_mangle]
pub unsafe extern "C" fn kvm_irq_map_chip_pin(kvm: *mut kvm, irqchip: unsigned, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_irq_routing_table(rt: *mut kvm_irq_routing_table) {
...
// Called only during vm destruction. Nobody can use the pointer
    ...
    int r;
    let mut gsi: u32 = array_index_nospec(ue.gsi, KVM_MAX_IRQ_ROUTES);
//
...
#[no_mangle]
pub unsafe extern "C" fn __attribute__(kvm: *mut (weak)) kvm_arch_irq_routing_update(struct kvm) {
    void __attribute__((weak)) kvm_arch_irq_routing_update(struct kvm *kvm)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_can_set_irq_routing(kvm: *mut kvm) -> bool __weak {
