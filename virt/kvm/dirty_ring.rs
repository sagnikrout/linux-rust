...
#[no_mangle]
pub unsafe extern "C" fn kvm_cpu_dirty_log_size(kvm: *mut kvm) -> int __weak {
...
#[no_mangle]
unsafe extern "C" fn kvm_dirty_ring_used(ring: *mut kvm_dirty_ring) -> u32 {
    static u32 kvm_dirty_ring_used(struct kvm_dirty_ring *ring)
    {
    return READ_ONCE(ring.dirty_index) - READ_ONCE(ring.reset_index);
    }
#[no_mangle]
unsafe extern "C" fn kvm_dirty_ring_soft_full(ring: *mut kvm_dirty_ring) -> bool {
    static bool kvm_dirty_ring_soft_full(struct kvm_dirty_ring *ring)
    {
    return kvm_dirty_ring_used(ring) >= ring.soft_limit;
    }
#[no_mangle]
unsafe extern "C" fn kvm_dirty_ring_full(ring: *mut kvm_dirty_ring) -> bool {
    static bool kvm_dirty_ring_full(struct kvm_dirty_ring *ring)
    {
    return kvm_dirty_ring_used(ring) >= ring.size;
    }
#[no_mangle]
unsafe extern "C" fn kvm_reset_dirty_gfn(kvm: *mut kvm, slot: u32, offset: u64, mask: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_dirty_gfn_set_invalid(gfn: *mut kvm_dirty_gfn) {
    static inline void kvm_dirty_gfn_set_invalid(struct kvm_dirty_gfn *gfn)
    {
    smp_store_release(&gfn.flags, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_dirty_gfn_set_dirtied(gfn: *mut kvm_dirty_gfn) {
    static inline void kvm_dirty_gfn_set_dirtied(struct kvm_dirty_gfn *gfn)
    {
    gfn.flags = KVM_DIRTY_GFN_F_DIRTY;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_dirty_gfn_harvested(gfn: *mut kvm_dirty_gfn) -> bool {
...
//
    ...
    let mut delta: i64 = next_offset - cur_offset;
