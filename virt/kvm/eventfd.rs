...
#[no_mangle]
pub unsafe extern "C" fn __attribute__(_arg: (weak)) -> bool {
...
#[no_mangle]
unsafe extern "C" fn irqfd_resampler_notify(resampler: *mut kvm_kernel_irqfd_resampler) {
...
#[no_mangle]
unsafe extern "C" fn irqfd_is_active(irqfd: *mut kvm_kernel_irqfd) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn irqfd_deactivate(irqfd: *mut kvm_kernel_irqfd) {
...
#[no_mangle]
unsafe extern "C" fn irqfd_update(kvm: *mut kvm, irqfd: *mut kvm_kernel_irqfd) {
...
//
    ...
    {
    struct kvm_kernel_irqfd *irqfd;
    struct eventfd_ctx *eventfd = core::ptr::null_mut(), *resamplefd = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn kvm_irq_has_notifier(kvm: *mut kvm, irqchip: unsigned, pin: unsigned) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_notify_acked_irq(kvm: *mut kvm, irqchip: unsigned, pin: unsigned) {
...
// Under irqfds.lock, so can read irq_entry safely
    let mut old: kvm_kernel_irq_routing_entry = irqfd.irq_entry;
...
// otherwise, we have to actually compare the data
    ...
    let mut _val: return = = p.datamatch;
    }
...
#[no_mangle]
unsafe extern "C" fn ioeventfd_bus_from_flags(flags: __u32) -> enum kvm_bus {
...
#[no_mangle]
unsafe extern "C" fn kvm_deassign_ioeventfd(kvm: *mut kvm, args: *mut kvm_ioeventfd) -> c_int {
    static int kvm_deassign_ioeventfd(struct kvm *kvm, struct kvm_ioeventfd *args)
    {
    let mut bus_idx: enum kvm_bus = ioeventfd_bus_from_flags(args.flags);
    let mut ret: c_int = kvm_deassign_ioeventfd_idx(kvm, bus_idx, args);
