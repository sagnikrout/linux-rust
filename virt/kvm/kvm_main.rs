...
pub const ITOA_MAX_LEN: c_int = 12;
    MODULE_AUTHOR("Qumranet");
    MODULE_DESCRIPTION("Kernel-based Virtual Machine (KVM) Hypervisor");
    MODULE_LICENSE("GPL");
// Architectures should define their poll value according to the halt latency
    let mut halt_poll_ns: unsigned int __read_mostly = KVM_HALT_POLL_NS_DEFAULT;
    module_param(halt_poll_ns, uint, 0644);
    EXPORT_SYMBOL_FOR_KVM_INTERNAL(halt_poll_ns);
// Default doubles per-vcpu halt_poll_ns.
    let mut halt_poll_ns_grow: unsigned int __read_mostly = 2;
...
// Default halves per-vcpu halt_poll_ns.
    let mut halt_poll_ns_shrink: unsigned int __read_mostly = 2;
...
#[no_mangle]
unsafe extern "C" fn kvm_no_compat_open(inode: *mut inode, file: *mut file) -> c_int {
...
pub const KVM_EVENT_CREATE_VM: c_int = 0;
pub const KVM_EVENT_DESTROY_VM: c_int = 1;
    static void kvm_uevent_notify_change(unsigned int type, struct kvm *kvm);
    static unsigned long long kvm_createvm_count;
    static unsigned long long kvm_active_vms;
    static DEFINE_PER_CPU(cpumask_var_t, cpu_kick_mask);
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_guest_memory_reclaimed(kvm: *mut kvm) -> __weak void {
...
//
#[no_mangle]
pub unsafe extern "C" fn vcpu_load(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vcpu_put(vcpu: *mut kvm_vcpu) {
    void vcpu_put(struct kvm_vcpu *vcpu)
    {
    preempt_disable();
    kvm_arch_vcpu_put(vcpu);
    preempt_notifier_unregister(&vcpu.preempt_notifier);
    __this_cpu_write(kvm_running_vcpu, core::ptr::null_mut());
    preempt_enable();
    }
    EXPORT_SYMBOL_FOR_KVM_INTERNAL(vcpu_put);
// TODO: merge with kvm_arch_vcpu_should_kick
#[no_mangle]
unsafe extern "C" fn kvm_request_needs_ipi(vcpu: *mut kvm_vcpu, req: unsigned) -> bool {
    static bool kvm_request_needs_ipi(struct kvm_vcpu *vcpu, unsigned req)
    {
    let mut mode: c_int = kvm_vcpu_exiting_guest_mode(vcpu);
//
...
//
    let mut mode: return = = IN_GUEST_MODE;
    }
#[no_mangle]
unsafe extern "C" fn ack_kick(_completed: *mut c_void) {
    static void ack_kick(void *_completed)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_kick_many_cpus(cpus: *mut cpumask, wait: bool) -> bool {
    static inline bool kvm_kick_many_cpus(struct cpumask *cpus, bool wait)
    {
    if (cpumask_empty(cpus))
    return false;
    smp_call_function_many(cpus, ack_kick, core::ptr::null_mut(), wait);
    return true;
    }
...
#[no_mangle]
pub unsafe extern "C" fn kvm_make_all_cpus_request(kvm: *mut kvm, req: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_flush_remote_tlbs(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_flush_remote_tlbs_range(kvm: *mut kvm, gfn: gfn_t, nr_pages: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvm_flush_shadow_all(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_mmu_topup_memory_cache(mc: *mut kvm_mmu_memory_cache, capacity: c_int, min: c_int) -> c_int {
    int __kvm_mmu_topup_memory_cache(struct kvm_mmu_memory_cache *mc, int capacity, int min)
    {
    let mut gfp: gfp_t = mc.gfp_custom ? mc.gfp_custom : GFP_KERNEL_ACCOUNT;
    void *obj;
    if (mc.nobjs >= min)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_topup_memory_cache(mc: *mut kvm_mmu_memory_cache, min: c_int) -> c_int {
    int kvm_mmu_topup_memory_cache(struct kvm_mmu_memory_cache *mc, int min)
    {
    return __kvm_mmu_topup_memory_cache(mc, KVM_ARCH_NR_OBJS_PER_MEMORY_CACHE, min);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_memory_cache_nr_free_objects(mc: *mut kvm_mmu_memory_cache) -> c_int {
    int kvm_mmu_memory_cache_nr_free_objects(struct kvm_mmu_memory_cache *mc)
    {
    return mc.nobjs;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_free_memory_cache(mc: *mut kvm_mmu_memory_cache) {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_init(vcpu: *mut kvm_vcpu, kvm: *mut kvm, id: unsigned) {
    ...
    vcpu.last_used_slot = core::ptr::null_mut();
// Fill the stats id string for the vcpu
    snprintf(vcpu.stats_id, sizeof(vcpu.stats_id), "kvm-%d/vcpu-%d",
    task_pid_nr(current), id);
    }
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_destroy(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_destroy_vcpus(kvm: *mut kvm) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_mmu_notifier_range {
//
...
//
    pub start: u64,
    pub end: u64,
    pub arg: union kvm_mmu_notifier_arg,
    pub handler: gfn_handler_t,
    pub on_lock: on_lock_fn_t,
    pub flush_on_ret: bool,
    pub may_block: bool,
    pub lockless: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn kvm_null_fn() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_invalidate_start(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_invalidate_range_add(kvm: *mut kvm, start: gfn_t, end: gfn_t) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_unmap_gfn_range(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_invalidate_end(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvm_init_mmu_notifier(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_init_pm_notifier(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvm_destroy_pm_notifier(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvm_destroy_dirty_bitmap(memslot: *mut kvm_memory_slot) {
    static void kvm_destroy_dirty_bitmap(struct kvm_memory_slot *memslot)
    {
    if (!memslot.dirty_bitmap)
    return;
    vfree(memslot.dirty_bitmap);
    memslot.dirty_bitmap = core::ptr::null_mut();
    }
// This does not remove the slot from struct kvm_memslots data structures
#[no_mangle]
unsafe extern "C" fn kvm_free_memslot(kvm: *mut kvm, slot: *mut kvm_memory_slot) {
...
#[no_mangle]
unsafe extern "C" fn kvm_free_memslots(kvm: *mut kvm, slots: *mut kvm_memslots) {
...
#[no_mangle]
unsafe extern "C" fn kvm_stats_debugfs_mode(desc: *const kvm_stats_desc) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn kvm_destroy_vm_debugfs(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvm_create_vm_debugfs(kvm: *mut kvm, fdname: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_pre_destroy_vm(kvm: *mut kvm) -> void __weak {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_create_vm_debugfs(kvm: *mut kvm) -> void __weak {
...
//
    ...
    atomic_long_set(&slots.last_used_slot, (unsigned long)core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn kvm_destroy_devices(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvm_destroy_vm(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_get_kvm(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_get_kvm_safe(kvm: *mut kvm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_put_kvm(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_put_kvm_no_destroy(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvm_vm_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_trylock_all_vcpus(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_lock_all_vcpus(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_unlock_all_vcpus(kvm: *mut kvm) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_alloc_dirty_bitmap(memslot: *mut kvm_memory_slot) -> c_int {
    static int kvm_alloc_dirty_bitmap(struct kvm_memory_slot *memslot)
    {
    let mut dirty_bytes: c_ulong = kvm_dirty_bitmap_bytes(memslot);
    ...
    let mut node_idx_inactive: c_int = active.node_idx ^ 1;
...
//
    ...
    let mut idx: c_int = slots.node_idx;
    ...
    node = &(*node).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(tmp->base_gfn: slot->base_gfn >) -> else {
...
//
    ...
    struct kvm_memory_slot *new)
    {
    let mut as_id: c_int = kvm_memslots_get_as_id(old, new);
...
//
    ...
    {
    let mut valid_flags: u32 = KVM_MEM_LOG_DIRTY_PAGES;
...
#[no_mangle]
unsafe extern "C" fn kvm_swap_active_memslots(kvm: *mut kvm, as_id: c_int) {
    static void kvm_swap_active_memslots(struct kvm *kvm, int as_id)
    {
    struct kvm_memslots *slots = kvm_get_inactive_memslots(kvm, as_id);
// Grab the generation from the activate memslots.
    let mut gen: u64 = __kvm_memslots(kvm, as_id).generation;
...
//
    ...
    new.dirty_bitmap = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(old->dirty_bitmap: old &&) -> else {
    else if (old && old.dirty_bitmap)
    new.dirty_bitmap = old.dirty_bitmap;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: kvm_use_dirty_bitmap(kvm)) -> else {
...
// Free the bitmap on failure if it was allocated above.
    ...
    enum kvm_mr_change change)
    {
    let mut old_flags: c_int = old ? old.flags : 0;
    let mut new_flags: c_int = new ? new.flags : 0;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(KVM_MR_CREATE: change ==) -> else {
    else if (change == KVM_MR_CREATE)
    kvm.nr_memslot_pages += new.npages;
    if ((old_flags ^ new_flags) & KVM_MEM_LOG_DIRTY_PAGES) {
    let mut change: c_int = (new_flags & KVM_MEM_LOG_DIRTY_PAGES) ? 1 : -1;
...
// Add the new memslot to the inactive set and activate.
    kvm_replace_memslot(kvm, core::ptr::null_mut(), new);
    kvm_activate_memslot(kvm, core::ptr::null_mut(), new);
    }
...
//
    kvm_replace_memslot(kvm, old, core::ptr::null_mut());
    kvm_activate_memslot(kvm, invalid_slot, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(KVM_MR_DELETE: change ==) -> else {
    else if (change == KVM_MR_DELETE)
    kvm_delete_memslot(kvm, old, invalid_slot);
#[no_mangle]
pub unsafe extern "C" fn if(KVM_MR_MOVE: change ==) -> else {
    else if (change == KVM_MR_MOVE)
    kvm_move_memslot(kvm, old, new, invalid_slot);
#[no_mangle]
pub unsafe extern "C" fn if(KVM_MR_FLAGS_ONLY: change ==) -> else {
...
//
    ...
    return -EIO;
    return kvm_set_memslot(kvm, old, core::ptr::null_mut(), KVM_MR_DELETE);
    }
...
// Private memslots are immutable, they can only be deleted.
    ...
    change = KVM_MR_MOVE;
#[no_mangle]
pub unsafe extern "C" fn if(old->flags: mem->flags !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_get_dirty_log_protect(kvm: *mut kvm, log: *mut kvm_dirty_log) -> c_int {
...
// Dirty ring tracking may be exclusive to dirty log tracking
    ...
    let mut mask: c_ulong = *dirty_bitmap_buffer++;
...
#[no_mangle]
unsafe extern "C" fn kvm_supported_mem_attributes(kvm: *mut kvm) -> u64 {
...
//
    ...
    struct kvm_memslots *slots;
    struct kvm_memslot_iter iter;
    let mut found_memslot: bool = false;
...
// Set @attributes for the gfn range [@start, @end).
    ...
    void *entry;
    let mut r: c_int = 0;
    entry = attributes ? xa_mk_value(attributes) : core::ptr::null_mut();
...
//
    ...
    let mut gen: u64 = slots.generation;
    struct kvm_memory_slot *slot;
//
...
#[no_mangle]
pub unsafe extern "C" fn kvm_is_visible_gfn(kvm: *mut kvm, gfn: gfn_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_is_visible_gfn(vcpu: *mut kvm_vcpu, gfn: gfn_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_host_page_size(vcpu: *mut kvm_vcpu, gfn: gfn_t) -> c_ulong {
    unsigned long kvm_host_page_size(struct kvm_vcpu *vcpu, gfn_t gfn)
    {
    struct vm_area_struct *vma;
    unsigned long addr, size;
    size = PAGE_SIZE;
    addr = kvm_vcpu_gfn_to_hva_prot(vcpu, gfn, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn memslot_is_readonly(slot: *const kvm_memory_slot) -> bool {
...
// nr_pages = slot->npages - (gfn - slot->base_gfn);
    ...
    gfn_t gfn)
    {
    return gfn_to_hva_many(slot, gfn, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_FOR_KVM_INTERNAL(gfn_to_hva_memslot);
#[no_mangle]
pub unsafe extern "C" fn gfn_to_hva(kvm: *mut kvm, gfn: gfn_t) -> c_ulong {
    unsigned long gfn_to_hva(struct kvm *kvm, gfn_t gfn)
    {
    return gfn_to_hva_many(gfn_to_memslot(kvm, gfn), gfn, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_FOR_KVM_INTERNAL(gfn_to_hva);
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_gfn_to_hva(vcpu: *mut kvm_vcpu, gfn: gfn_t) -> c_ulong {
    unsigned long kvm_vcpu_gfn_to_hva(struct kvm_vcpu *vcpu, gfn_t gfn)
    {
    return gfn_to_hva_many(kvm_vcpu_gfn_to_memslot(vcpu, gfn), gfn, core::ptr::null_mut());
    }
...
//
    ...
    {
    let mut hva: c_ulong = __gfn_to_hva_many(slot, gfn, core::ptr::null_mut(), false);
    if (!kvm_is_error_hva(hva) && writable)
// writable = !memslot_is_readonly(slot);
    return hva;
    }
#[no_mangle]
pub unsafe extern "C" fn gfn_to_hva_prot(kvm: *mut kvm, gfn: gfn_t, writable: *mut bool) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_gfn_to_hva_prot(vcpu: *mut kvm_vcpu, gfn: gfn_t, writable: *mut bool) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn kvm_is_ad_tracked_page(page: *mut page) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_set_page_dirty(page: *mut page) {
...
#[no_mangle]
unsafe extern "C" fn kvm_set_page_accessed(page: *mut page) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_release_page_clean(page: *mut page) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_release_page_dirty(page: *mut page) {
...
//
#[no_mangle]
unsafe extern "C" fn hva_to_pfn_fast(kfp: *mut kvm_follow_pfn, pfn: *mut kvm_pfn_t) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn hva_to_pfn_slow(kfp: *mut kvm_follow_pfn, pfn: *mut kvm_pfn_t) -> c_int {
...
//
    let mut flags: c_uint = FOLL_HWPOISON | FOLL_HONOR_NUMA_FAULT | kfp.flags;
...
#[no_mangle]
unsafe extern "C" fn vma_is_valid(vma: *mut vm_area_struct, write_fault: bool) -> bool {
    ...
    {
    let mut args: follow_pfnmap_args = { .vma = vma, .address = kfp.hva };
    let mut write_fault: bool = kfp.flags & FOLL_WRITE;
    int r;
//
...
#[no_mangle]
pub unsafe extern "C" fn hva_to_pfn(kfp: *mut kvm_follow_pfn) -> kvm_pfn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(VM_PFNMAP): vma->vm_flags & (VM_IO |) -> else {
...
#[no_mangle]
unsafe extern "C" fn kvm_follow_pfn(kfp: *mut kvm_follow_pfn) -> kvm_pfn_t {
    static kvm_pfn_t kvm_follow_pfn(struct kvm_follow_pfn *kfp)
    {
    kfp.hva = __gfn_to_hva_many(kfp.slot, kfp.gfn, core::ptr::null_mut(),
...
// kfp->map_writable = false;
    kfp.map_writable = core::ptr::null_mut();
    }
...
//
    ...
    {
    struct page *refcounted_page = core::ptr::null_mut();
    struct kvm_follow_pfn kfp = {
    ...
    map.pinned_page = core::ptr::null_mut();
    map.page = core::ptr::null_mut();
    map.hva = core::ptr::null_mut();
    map.gfn = gfn;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_unmap(vcpu: *mut kvm_vcpu, map: *mut kvm_host_map) {
...
#[no_mangle]
unsafe extern "C" fn next_segment(len: c_ulong, offset: c_int) -> c_int {
...
// Copy @len bytes from guest memory at '(@gfn * PAGE_SIZE) + @offset' to @data
    ...
    return -EFAULT;
    addr = gfn_to_hva_memslot_prot(slot, gfn, core::ptr::null_mut());
    if (kvm_is_error_hva(addr))
    return -EFAULT;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_read_guest(kvm: *mut kvm, gpa: gpa_t, data: *mut c_void, len: c_ulong) -> c_int {
    int kvm_read_guest(struct kvm *kvm, gpa_t gpa, void *data, unsigned long len)
    {
    let mut gfn: gfn_t = gpa >> PAGE_SHIFT;
    int seg;
    let mut offset: c_int = offset_in_page(gpa);
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_read_guest(vcpu: *mut kvm_vcpu, gpa: gpa_t, data: *mut c_void, len: c_ulong) -> c_int {
...
// Copy @len bytes from @data into guest memory at '(@gfn * PAGE_SIZE) + @offset'
    ...
    {
    let mut offset: c_int = offset_in_page(gpa);
    let mut start_gfn: gfn_t = gpa >> PAGE_SHIFT;
    let mut end_gfn: gfn_t = (gpa + len - 1) >> PAGE_SHIFT;
    let mut nr_pages_needed: gfn_t = end_gfn - start_gfn + 1;
...
// Use the slow path for cross page reads and writes.
    ...
    struct kvm_memslots *slots = kvm_memslots(kvm);
    int r;
    let mut gpa: gpa_t = ghc.gpa + offset;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_clear_guest(kvm: *mut kvm, gpa: gpa_t, len: c_ulong) -> c_int {
    ...
    let mut rel_gfn: c_ulong = gfn - memslot.base_gfn;
    let mut slot: u32 = (memslot.as_id << 16) | memslot.id;
    if (kvm.dirty_ring_size && vcpu)
    kvm_dirty_ring_push(vcpu, slot, rel_gfn);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: memslot->dirty_bitmap) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mark_page_dirty(kvm: *mut kvm, gfn: gfn_t) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_mark_page_dirty(vcpu: *mut kvm_vcpu, gfn: gfn_t) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_sigset_activate(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_sigset_deactivate(vcpu: *mut kvm_vcpu) {
    void kvm_sigset_deactivate(struct kvm_vcpu *vcpu)
    {
    if (!vcpu.sigset_active)
    return;
    sigprocmask(SIG_SETMASK, &current.real_blocked, core::ptr::null_mut());
    sigemptyset(&current.real_blocked);
    }
#[no_mangle]
unsafe extern "C" fn grow_halt_poll_ns(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn shrink_halt_poll_ns(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_check_block(vcpu: *mut kvm_vcpu) -> c_int {
    static int kvm_vcpu_check_block(struct kvm_vcpu *vcpu)
    {
    let mut ret: c_int = -EINTR;
    let mut idx: c_int = srcu_read_lock(&vcpu.kvm.srcu);
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_block(vcpu: *mut kvm_vcpu) -> bool {
    ...
    let mut poll_ns: u64 = ktime_to_ns(ktime_sub(end, start));
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_max_halt_poll_ns(vcpu: *mut kvm_vcpu) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_halt(vcpu: *mut kvm_vcpu) {
    void kvm_vcpu_halt(struct kvm_vcpu *vcpu)
    {
    let mut max_halt_poll_ns: c_uint = kvm_vcpu_max_halt_poll_ns(vcpu);
    let mut halt_poll_allowed: bool = !kvm_arch_no_poll(vcpu);
    ...
    if (do_halt_poll) {
    let mut stop: ktime_t = ktime_add_ns(start, vcpu.halt_poll_ns);
    do {
    if (kvm_vcpu_check_block(vcpu) < 0)
    goto out;
    cpu_relax();
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_wake_up(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn __kvm_vcpu_kick(vcpu: *mut kvm_vcpu, wait: bool) {
...
//
    if (wait)
    smp_call_function_single(cpu, ack_kick, core::ptr::null_mut(), wait);
    else
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_yield_to(target: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_eligible_for_directed_yield(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_dy_runnable(vcpu: *mut kvm_vcpu) -> bool __weak {
    bool __weak kvm_arch_dy_runnable(struct kvm_vcpu *vcpu)
    {
    return kvm_arch_vcpu_runnable(vcpu);
    }
#[no_mangle]
unsafe extern "C" fn vcpu_dy_runnable(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_preempted_in_kernel(vcpu: *mut kvm_vcpu) -> bool __weak {
    bool __weak kvm_arch_vcpu_preempted_in_kernel(struct kvm_vcpu *vcpu)
    {
    return kvm_arch_vcpu_in_kernel(vcpu);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_dy_has_pending_interrupt(vcpu: *mut kvm_vcpu) -> bool __weak {
    bool __weak kvm_arch_dy_has_pending_interrupt(struct kvm_vcpu *vcpu)
    {
    return false;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_on_spin(me: *mut kvm_vcpu, yield_to_kernel_mode: bool) {
...
#[no_mangle]
unsafe extern "C" fn kvm_page_in_dirty_ring(kvm: *mut kvm, pgoff: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(KVM_PIO_PAGE_OFFSET: vmf->pgoff ==) -> else {
    else if (vmf.pgoff == KVM_PIO_PAGE_OFFSET)
    page = virt_to_page(vcpu.arch.pio_data);

#[no_mangle]
pub unsafe extern "C" fn if(KVM_COALESCED_MMIO_PAGE_OFFSET: vmf->pgoff ==) -> else {
    else if (vmf.pgoff == KVM_COALESCED_MMIO_PAGE_OFFSET)
    page = virt_to_page(vcpu.kvm.coalesced_mmio_ring);

#[no_mangle]
pub unsafe extern "C" fn if(_arg: kvm_page_in_dirty_ring(vcpu->kvm, _arg: vmf->pgoff)) -> else {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
    static int kvm_vcpu_mmap(struct file *file, struct vm_area_struct *vma)
    {
    struct kvm_vcpu *vcpu = file.private_data;
    let mut pages: c_ulong = vma_pages(vma);
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_release(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn create_vcpu_fd(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcpu_get_pid(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = pid_nr(vcpu->pid);
    ...
    DEFINE_SIMPLE_ATTRIBUTE(vcpu_get_pid_fops, vcpu_get_pid, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn kvm_create_vcpu_debugfs(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_vm_ioctl_create_vcpu(kvm: *mut kvm, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_ioctl_set_sigmask(vcpu: *mut kvm_vcpu, sigset: *mut sigset_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_stats_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_ioctl_get_stats_fd(vcpu: *mut kvm_vcpu) -> c_int {
...
// Return success if at least one page was mapped successfully.
    let mut full_size: return = = range.size ? r : 0;
    }

#[no_mangle]
unsafe extern "C" fn kvm_wait_for_vcpu_online(vcpu: *mut kvm_vcpu) -> c_int {
...
//
    ...
    int r;
    struct kvm_fpu *fpu = core::ptr::null_mut();
    struct kvm_sregs *kvm_sregs = core::ptr::null_mut();
...
// Pass back leftover range.
    ...
    r = kvm_vcpu_ioctl_set_sigmask(vcpu, core::ptr::null_mut());
    break;
    }
    default:
...
#[no_mangle]
unsafe extern "C" fn kvm_device_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_device_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_register_device_ops(ops: *const kvm_device_ops, type: u32) -> c_int {
    int kvm_register_device_ops(const struct kvm_device_ops *ops, u32 type)
    {
    if (type >= ARRAY_SIZE(kvm_device_ops_table))
    return -ENOSPC;
    if (kvm_device_ops_table[type] != core::ptr::null_mut())
    return -EEXIST;
    kvm_device_ops_table[type] = ops;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_unregister_device_ops(type: u32) {
    void kvm_unregister_device_ops(u32 type)
    {
    if (kvm_device_ops_table[type] != core::ptr::null_mut())
    kvm_device_ops_table[type] = core::ptr::null_mut();
    }
    ...
    let mut test: bool = cd.flags & KVM_CREATE_DEVICE_TEST;
    int type;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn kvm_vm_ioctl_check_extension_generic(kvm: *mut kvm, arg: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vm_ioctl_enable_dirty_log_ring(kvm: *mut kvm, size: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vm_ioctl_reset_dirty_pages(kvm: *mut kvm) -> c_int {
    static int kvm_vm_ioctl_reset_dirty_pages(struct kvm *kvm)
    {
    unsigned long i;
    struct kvm_vcpu *vcpu;
    let mut cleared: c_int = 0, r;
    if (!kvm.dirty_ring_size)
    return -EINVAL;
    mutex_lock(&kvm.slots_lock);
    kvm_for_each_vcpu(i, vcpu, kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_are_all_memslots_empty(kvm: *mut kvm) -> bool {
    ...
    case KVM_CAP_MANUAL_DIRTY_LOG_PROTECT2: {
    let mut allowed_options: u64 = KVM_DIRTY_LOG_MANUAL_PROTECT_ENABLE;
...
#[no_mangle]
unsafe extern "C" fn kvm_vm_stats_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vm_ioctl_get_stats_fd(kvm: *mut kvm) -> c_int {
...
// Ensure the common parts of the two structs are identical.
    ...
    struct kvm_irq_routing_entry *entries = core::ptr::null_mut();
    r = -EFAULT;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_kvm_dirty_log {
    pub slot: __u32,
    pub padding1: __u32,
    union {
    pub /: *mut *mut compat_uptr_t dirty_bitmap; / one bit per page,
    pub padding2: __u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_kvm_clear_dirty_log {
    pub slot: __u32,
    pub num_pages: __u32,
...
#[no_mangle]
pub unsafe extern "C" fn file_is_kvm(file: *mut file) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_dev_ioctl_create_vm(type: c_ulong) -> c_int {
...
//
    ...
    break;
    case KVM_CHECK_EXTENSION:
    r = kvm_vm_ioctl_check_extension_generic(core::ptr::null_mut(), arg);
    break;
    ...
    let mut enable_virt_at_load: bool __ro_after_init = true;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_shutdown() -> __weak void {
    __weak void kvm_arch_shutdown(void)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_enable_virtualization() -> __weak void {
    __weak void kvm_arch_enable_virtualization(void)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_disable_virtualization() -> __weak void {
    __weak void kvm_arch_disable_virtualization(void)
    {
    }
#[no_mangle]
unsafe extern "C" fn kvm_enable_virtualization_cpu() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_online_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_disable_virtualization_cpu(ign: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kvm_offline_cpu(cpu: c_uint) -> c_int {
    static int kvm_offline_cpu(unsigned int cpu)
    {
    kvm_disable_virtualization_cpu(core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn kvm_shutdown(data: *mut c_void) {
...
//
    ...
    on_each_cpu(kvm_disable_virtualization_cpu, core::ptr::null_mut(), 1);
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn kvm_enable_virtualization() -> c_int {
    static int kvm_enable_virtualization(void)
    {
    int r;
...
#[no_mangle]
unsafe extern "C" fn kvm_disable_virtualization() {
    static void kvm_disable_virtualization(void)
    {
    guard(mutex)(&kvm_usage_lock);
    if (--kvm_usage_count)
...
#[no_mangle]
unsafe extern "C" fn kvm_init_virtualization() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_uninit_virtualization() {
...
#[no_mangle]
unsafe extern "C" fn kvm_iodevice_destructor(dev: *mut kvm_io_device) {
...
#[no_mangle]
unsafe extern "C" fn kvm_io_bus_destroy(bus: *mut kvm_io_bus) {
    static void kvm_io_bus_destroy(struct kvm_io_bus *bus)
    {
    int i;
    ...
    {
    let mut addr1: gpa_t = r1.addr;
    let mut addr2: gpa_t = r2.addr;
    if (addr1 < addr2)
    return -1;
...
#[no_mangle]
unsafe extern "C" fn kvm_io_bus_sort_cmp(p1: *const c_void, p2: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __free_bus(rcu: *mut rcu_head) {
...
//
    ...
    ? set : core::ptr::null_mut(), fmt);
    if (ret)
    kvm_put_kvm(stat_data.kvm);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn kvm_debugfs_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_get_stat_per_vm(kvm: *mut kvm, offset: usize, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_clear_stat_per_vm(kvm: *mut kvm, offset: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_get_stat_per_vcpu(kvm: *mut kvm, offset: usize, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_clear_stat_per_vcpu(kvm: *mut kvm, offset: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_stat_data_get(data: *mut c_void, val: *mut u64) -> c_int {
    static int kvm_stat_data_get(void *data, u64 *val)
    {
    let mut r: c_int = -EFAULT;
...
#[no_mangle]
unsafe extern "C" fn kvm_stat_data_clear(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_stat_data_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vm_stat_get(_offset: *mut c_void, val: *mut u64) -> c_int {
    static int vm_stat_get(void *_offset, u64 *val)
    {
    let mut offset: unsigned = (long)_offset;
    struct kvm *kvm;
    u64 tmp_val;
// val = 0;
    mutex_lock(&kvm_lock);
...
#[no_mangle]
unsafe extern "C" fn vm_stat_clear(_offset: *mut c_void, val: u64) -> c_int {
    ...
    DEFINE_SIMPLE_ATTRIBUTE(vm_stat_readonly_fops, vm_stat_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn vcpu_stat_get(_offset: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcpu_stat_clear(_offset: *mut c_void, val: u64) -> c_int {
    ...
    "%llu\n");
    DEFINE_SIMPLE_ATTRIBUTE(vcpu_stat_readonly_fops, vcpu_stat_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn kvm_uevent_notify_change(type: c_uint, kvm: *mut kvm) {
    static void kvm_uevent_notify_change(unsigned int type, struct kvm *kvm)
    {
...
// no need for checks, since we are adding at most only 5 keys
    env.envp[env.envp_idx++] = core::ptr::null_mut();
    kobject_uevent_env(&kvm_dev.this_device.kobj, KOBJ_CHANGE, env.envp);
    kfree(env);
    }
#[no_mangle]
unsafe extern "C" fn kvm_init_debug() {
    static void kvm_init_debug(void)
    {
    const struct file_operations *fops;
    const struct kvm_stats_desc *pdesc;
    int i;
    kvm_debugfs_dir = debugfs_create_dir("kvm", core::ptr::null_mut());
    for (i = 0; i < kvm_vm_stats_header.num_desc; ++i) {
    pdesc = &kvm_vm_stats_desc[i];
...
#[no_mangle]
unsafe extern "C" fn kvm_sched_in(pn: *mut preempt_notifier, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kvm_guest_state() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn kvm_guest_get_ip() -> c_ulong {
...
// Retrieving the IP must be guarded by a call to kvm_guest_state().
    ...
    .handle_mediated_pmi	= core::ptr::null_mut(),
    };
...
#[no_mangle]
pub unsafe extern "C" fn kvm_unregister_perf_callbacks() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_init(vcpu_size: unsigned, vcpu_align: unsigned, module: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_exit() {
    void kvm_exit(void)
    {
    int cpu;
//
