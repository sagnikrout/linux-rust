...
#[no_mangle]
pub unsafe extern "C" fn kvm_gpc_check(gpc: *mut gfn_to_pfn_cache, len: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpc_unmap(pfn: kvm_pfn_t, khva: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn mmu_notifier_retry_cache(kvm: *mut kvm, mmu_seq: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hva_to_pfn_retry(gpc: *mut gfn_to_pfn_cache) -> kvm_pfn_t {
    static kvm_pfn_t hva_to_pfn_retry(struct gfn_to_pfn_cache *gpc)
    {
// Note, the new page offset may be different than the old!
    void *old_khva = (void *)PAGE_ALIGN_DOWN((uintptr_t)gpc.khva);
    let mut new_pfn: kvm_pfn_t = KVM_PFN_ERR_FAULT;
    void *new_khva = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __kvm_gpc_refresh(gpc: *mut gfn_to_pfn_cache, gpa: gpa_t, uhva: c_ulong) -> c_int {
...
// Either gpa or uhva must be valid, but not both
    ...
    let mut gfn: gfn_t = gpa_to_gfn(gpa);
    gpc.gpa = gpa;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_gpc_refresh(gpc: *mut gfn_to_pfn_cache, len: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_gpc_activate(gpc: *mut gfn_to_pfn_cache, gpa: gpa_t, len: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_gpc_activate_hva(gpc: *mut gfn_to_pfn_cache, uhva: c_ulong, len: c_ulong) -> c_int {
