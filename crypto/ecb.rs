...
#[no_mangle]
unsafe extern "C" fn crypto_ecb_create2(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ecb_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ecb_module_init() -> int __init {
    static int __init crypto_ecb_module_init(void)
    {
    return crypto_register_template(&crypto_ecb_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn crypto_ecb_module_exit() -> void __exit {
