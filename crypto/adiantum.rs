...
//
pub const BLOCKCIPHER_BLOCK_SIZE: c_int = 16;
// Size of the block cipher key (K_E) in bytes
pub const BLOCKCIPHER_KEY_SIZE: c_int = 32;
...
//
pub const TWEAK_SIZE: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adiantum_instance_ctx {
    pub streamcipher_spawn: crypto_skcipher_spawn,
    pub blockcipher_spawn: crypto_cipher_spawn,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct adiantum_tfm_ctx {
    pub streamcipher: *mut crypto_skcipher,
    pub blockcipher: *mut crypto_cipher,
    pub header_hash_key: poly1305_core_key,
    pub msg_poly_key: poly1305_core_key,
    pub nh_key: [u32; NH_KEY_WORDS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nhpoly1305_ctx {
// Running total of polynomial evaluation
    pub poly_state: poly1305_state,
// Partial block buffer
    pub buffer: [u8; NH_MESSAGE_UNIT],
    pub buflen: c_uint,
//
...
//
    pub nh_remaining: c_uint,
    pub nh_hash: [__le64; NH_NUM_PASSES],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct adiantum_request_ctx {
//
// skcipher sub-request size is unknown at compile-time, so it needs to
// go after the members with known sizes.
//
    union {
    pub hash_ctx: nhpoly1305_ctx,
    pub streamcipher_req: skcipher_request,
    pub u: },
}
...
#[no_mangle]
pub unsafe extern "C" fn le128_add(r: *mut le128, v1: *const le128, v2: *const le128) {
    static inline void le128_add(le128 *r, const le128 *v1, const le128 *v2)
    {
    let mut x: u64 = le64_to_cpu(v1.b);
    let mut y: u64 = le64_to_cpu(v2.b);
    r.b = cpu_to_le64(x + y);
...
#[no_mangle]
pub unsafe extern "C" fn le128_sub(r: *mut le128, v1: *const le128, v2: *const le128) {
...
//
#[no_mangle]
unsafe extern "C" fn adiantum_hash_header(req: *mut skcipher_request, out: *mut le128) {
    static void adiantum_hash_header(struct skcipher_request *req, le128 *out)
    {
    struct crypto_skcipher *tfm = crypto_skcipher_reqtfm(req);
    const struct adiantum_tfm_ctx *tctx = crypto_skcipher_ctx(tfm);
    let mut bulk_len: c_uint = req.cryptlen - BLOCKCIPHER_BLOCK_SIZE;
    struct {
    __le64 message_bits;
    __le64 padding;
    } header = {
    ...
    poly1305_core_emit(&state, core::ptr::null_mut(), out);
    }
...
#[no_mangle]
unsafe extern "C" fn nhpoly1305_init(ctx: *mut nhpoly1305_ctx) {
    ...
    if (ctx.nh_remaining)
    process_nh_hash_value(ctx, key);
    poly1305_core_emit(&ctx.poly_state, core::ptr::null_mut(), out);
    }
//
...
//
    ...
    let mut len: c_uint = req.cryptlen - BLOCKCIPHER_BLOCK_SIZE;
...
#[no_mangle]
unsafe extern "C" fn adiantum_crypt(req: *mut skcipher_request, enc: bool) -> c_int {
...
//
    ...
    req.base.flags, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn adiantum_encrypt(req: *mut skcipher_request) -> c_int {
    static int adiantum_encrypt(struct skcipher_request *req)
    {
    return adiantum_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn adiantum_decrypt(req: *mut skcipher_request) -> c_int {
    static int adiantum_decrypt(struct skcipher_request *req)
    {
    return adiantum_crypt(req, false);
    }
#[no_mangle]
unsafe extern "C" fn adiantum_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adiantum_exit_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn adiantum_free_instance(inst: *mut skcipher_instance) {
...
#[no_mangle]
unsafe extern "C" fn adiantum_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adiantum_module_init() -> int __init {
    static int __init adiantum_module_init(void)
    {
    return crypto_register_template(&adiantum_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn adiantum_module_exit() -> void __exit {
