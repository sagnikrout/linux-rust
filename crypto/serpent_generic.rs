...
//! Source: crypto/serpent_generic.c
#![no_std]
...
//
pub const PHI: c_uint = 0x9e3779b9UL;
...
#[no_mangle]
pub unsafe extern "C" fn serpent_setkey(tfm: *mut crypto_tfm, key: *const u8, keylen: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __serpent_encrypt(c: *const c_void, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn serpent_encrypt(tfm: *mut crypto_tfm, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn __serpent_decrypt(c: *const c_void, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn serpent_decrypt(tfm: *mut crypto_tfm, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn serpent_mod_init() -> int __init {
    static int __init serpent_mod_init(void)
    {
    return crypto_register_alg(&srp_alg);
    }
#[no_mangle]
unsafe extern "C" fn serpent_mod_fini() -> void __exit {
