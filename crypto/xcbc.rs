...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xcbc_tfm_ctx {
    pub child: *mut crypto_cipher,
    pub consts: [u8; ],
}

pub const XCBC_BLOCKSIZE: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn crypto_xcbc_digest_init(pdesc: *mut shash_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xcbc_init_tfm(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xcbc_exit_tfm(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn xcbc_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_xcbc_module_init() -> int __init {
    static int __init crypto_xcbc_module_init(void)
    {
    return crypto_register_template(&crypto_xcbc_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn crypto_xcbc_module_exit() -> void __exit {
