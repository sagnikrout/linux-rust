...
pub const KHAZAD_KEY_SIZE: c_int = 16;
pub const KHAZAD_BLOCK_SIZE: c_int = 8;
pub const KHAZAD_ROUNDS: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct khazad_ctx {
    pub 1]: u64 E[KHAZAD_ROUNDS +,
    pub 1]: u64 D[KHAZAD_ROUNDS +,
}
...
#[no_mangle]
unsafe extern "C" fn khazad_encrypt(tfm: *mut crypto_tfm, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn khazad_decrypt(tfm: *mut crypto_tfm, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn khazad_mod_init() -> int __init {
    static int __init khazad_mod_init(void)
    {
    return crypto_register_alg(&khazad_alg);
    }
#[no_mangle]
unsafe extern "C" fn khazad_mod_fini() -> void __exit {
