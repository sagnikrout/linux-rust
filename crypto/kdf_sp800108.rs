...
//
    ...
    let mut h: c_uint = crypto_shash_digestsize(kmd), dlen_orig = dlen;
    unsigned int i;
    let mut err: c_int = 0;
    u8 *dst_orig = dst;
    desc.tfm = kmd;
...
//
    ...
    {
    let mut ds: c_uint = crypto_shash_digestsize(kmd);
...
#[no_mangle]
unsafe extern "C" fn crypto_kdf108_init() -> int __init {
