...
#[no_mangle]
unsafe extern "C" fn lz4_free_ctx(ctx: *mut c_void) {
...
// dlen = out_len;
    ...
    void *ctx)
    {
    return __lz4_decompress_crypto(src, slen, dst, dlen, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn lz4_mod_init() -> int __init {
    static int __init lz4_mod_init(void)
    {
    return crypto_register_scomp(&scomp);
    }
#[no_mangle]
unsafe extern "C" fn lz4_mod_fini() -> void __exit {
