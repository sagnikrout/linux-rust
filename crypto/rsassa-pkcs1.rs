...
//
    ...
    0x05, 0x00, 0x04, 0x10		      /* core::ptr::null_mut()), OCTET STRING <hash>) */
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rsassa_pkcs1_inst_ctx {
    pub spawn: crypto_akcipher_spawn,
    pub hash_prefix: *const hash_prefix,
}
...
// Four billion to one
    ...
    const struct hash_prefix *hash_prefix = ictx.hash_prefix;
    struct rsassa_pkcs1_ctx *ctx = crypto_sig_ctx(tfm);
    let mut child_reqsize: c_uint = crypto_akcipher_reqsize(ctx.child);
    struct akcipher_request *child_req __free(kfree_sensitive) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rsassa_pkcs1_key_size(tfm: *mut crypto_sig) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rsassa_pkcs1_init_tfm(tfm: *mut crypto_sig) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsassa_pkcs1_exit_tfm(tfm: *mut crypto_sig) {
...
#[no_mangle]
unsafe extern "C" fn rsassa_pkcs1_free(inst: *mut sig_instance) {
...
#[no_mangle]
unsafe extern "C" fn rsassa_pkcs1_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
