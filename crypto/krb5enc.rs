...
//
    ...
    let mut flags: c_uint = crypto_aead_get_flags(krb5enc);
...
#[no_mangle]
unsafe extern "C" fn krb5enc_encrypt_done(data: *mut c_void, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn krb5enc_insert_checksum(req: *mut aead_request, hash: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn krb5enc_encrypt_ahash_done(data: *mut c_void, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn krb5enc_dispatch_encrypt_hash(req: *mut aead_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn krb5enc_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn krb5enc_verify_hash(req: *mut aead_request) -> c_int {
    ...
    struct krb5enc_request_ctx *areq_ctx = aead_request_ctx(req);
    struct ahash_request *ahreq = (void *)(areq_ctx.tail + ictx.reqoff);
    let mut authsize: c_uint = crypto_aead_authsize(krb5enc);
...
#[no_mangle]
unsafe extern "C" fn krb5enc_decrypt_hash_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn krb5enc_decrypt_done(data: *mut c_void, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn krb5enc_dispatch_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn krb5enc_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn krb5enc_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn krb5enc_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn krb5enc_free(inst: *mut aead_instance) {
...
//
#[no_mangle]
unsafe extern "C" fn krb5enc_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_krb5enc_module_init() -> int __init {
    static int __init crypto_krb5enc_module_init(void)
    {
    return crypto_register_template(&crypto_krb5enc_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn crypto_krb5enc_module_exit() -> void __exit {
