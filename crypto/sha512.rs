...
//
pub const SHA512_SHASH_STATE_SIZE: c_int = 209;
...
#[no_mangle]
unsafe extern "C" fn __crypto_sha512_export(ctx0: *const __sha512_ctx, out: *mut c_void) -> c_int {
    static int __crypto_sha512_export(const struct __sha512_ctx *ctx0, void *out)
    {
    let mut ctx: __sha512_ctx = *ctx0;
...
#[no_mangle]
unsafe extern "C" fn __crypto_sha512_import(ctx: *mut __sha512_ctx, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __crypto_sha512_import_core(ctx: *mut __sha512_ctx, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha384_init(desc: *mut shash_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha384_final(desc: *mut shash_desc, out: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha384_export(desc: *mut shash_desc, out: *mut c_void) -> c_int {
    static int crypto_sha384_export(struct shash_desc *desc, void *out)
    {
    return __crypto_sha512_export(&SHA384_CTX(desc).ctx, out);
    }
#[no_mangle]
unsafe extern "C" fn crypto_sha384_import(desc: *mut shash_desc, in: *const c_void) -> c_int {
    static int crypto_sha384_import(struct shash_desc *desc, const void *in)
    {
    return __crypto_sha512_import(&SHA384_CTX(desc).ctx, in);
    }
#[no_mangle]
unsafe extern "C" fn crypto_sha384_export_core(desc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha384_import_core(desc: *mut shash_desc, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha512_init(desc: *mut shash_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha512_final(desc: *mut shash_desc, out: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha512_export(desc: *mut shash_desc, out: *mut c_void) -> c_int {
    static int crypto_sha512_export(struct shash_desc *desc, void *out)
    {
    return __crypto_sha512_export(&SHA512_CTX(desc).ctx, out);
    }
#[no_mangle]
unsafe extern "C" fn crypto_sha512_import(desc: *mut shash_desc, in: *const c_void) -> c_int {
    static int crypto_sha512_import(struct shash_desc *desc, const void *in)
    {
    return __crypto_sha512_import(&SHA512_CTX(desc).ctx, in);
    }
#[no_mangle]
unsafe extern "C" fn crypto_sha512_export_core(desc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha512_import_core(desc: *mut shash_desc, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha384_init(desc: *mut shash_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha384_final(desc: *mut shash_desc, out: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha384_export(desc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha384_import(desc: *mut shash_desc, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha384_export_core(desc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha512_init(desc: *mut shash_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha512_final(desc: *mut shash_desc, out: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha512_export(desc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha512_import(desc: *mut shash_desc, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_hmac_sha512_export_core(desc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha512_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn crypto_sha512_mod_exit() -> void __exit {
