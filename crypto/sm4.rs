...
#[no_mangle]
pub unsafe extern "C" fn sm4_t_non_lin_sub(x: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sm4_key_lin_sub(x: u32) -> u32 {
    static inline u32 sm4_key_lin_sub(u32 x)
    {
    return x ^ rol32(x, 13) ^ rol32(x, 23);
    }
#[no_mangle]
pub unsafe extern "C" fn sm4_enc_lin_sub(x: u32) -> u32 {
    static inline u32 sm4_enc_lin_sub(u32 x)
    {
    return x ^ rol32(x, 2) ^ rol32(x, 10) ^ rol32(x, 18) ^ rol32(x, 24);
    }
#[no_mangle]
pub unsafe extern "C" fn sm4_key_sub(x: u32) -> u32 {
    static inline u32 sm4_key_sub(u32 x)
    {
    return sm4_key_lin_sub(sm4_t_non_lin_sub(x));
    }
#[no_mangle]
pub unsafe extern "C" fn sm4_enc_sub(x: u32) -> u32 {
    static inline u32 sm4_enc_sub(u32 x)
    {
    return sm4_enc_lin_sub(sm4_t_non_lin_sub(x));
    }
#[no_mangle]
pub unsafe extern "C" fn sm4_round(x0: u32, x1: u32, x2: u32, x3: u32, rk: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn sm4_crypt_block(rk: *const u32, out: *mut u8, in: *const u8) {
