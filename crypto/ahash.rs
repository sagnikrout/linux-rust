...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_block_only(tfm: *mut crypto_ahash) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_final_nonzero(tfm: *mut crypto_ahash) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_need_fallback(tfm: *mut crypto_ahash) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hash_walk_next(walk: *mut crypto_hash_walk) -> c_int {
    static int hash_walk_next(struct crypto_hash_walk *walk)
    {
    let mut offset: c_uint = walk.offset;
...
#[no_mangle]
unsafe extern "C" fn hash_walk_new_entry(walk: *mut crypto_hash_walk) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_hash_walk_done(walk: *mut crypto_hash_walk, err: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn shash_ahash_update(req: *mut ahash_request, desc: *mut shash_desc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn shash_ahash_finup(req: *mut ahash_request, desc: *mut shash_desc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn shash_ahash_digest(req: *mut ahash_request, desc: *mut shash_desc) -> c_int {
    int shash_ahash_digest(struct ahash_request *req, struct shash_desc *desc)
    {
    let mut nbytes: c_uint = req.nbytes;
    struct scatterlist *sg;
    unsigned int offset;
    struct page *page;
    const u8 *data;
...
#[no_mangle]
unsafe extern "C" fn crypto_exit_ahash_using_shash(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn crypto_init_ahash_using_shash(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahash_set_needkey(tfm: *mut crypto_ahash, alg: *mut ahash_alg) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahash_save_req(req: *mut ahash_request, cplt: crypto_completion_t) {
...
#[no_mangle]
unsafe extern "C" fn ahash_restore_req(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn ahash_update_finish(req: *mut ahash_request, err: c_int) -> c_int {
    static int ahash_update_finish(struct ahash_request *req, int err)
    {
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(req);
    let mut nonzero: bool = crypto_ahash_final_nonzero(tfm);
...
#[no_mangle]
unsafe extern "C" fn ahash_update_done(data: *mut c_void, err: c_int) {
    static void ahash_update_done(void *data, int err)
    {
    ahash_op_done(data, err, ahash_update_finish);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahash_finup_finish(req: *mut ahash_request, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahash_finup_done(data: *mut c_void, err: c_int) {
    static void ahash_finup_done(void *data, int err)
    {
    ahash_op_done(data, err, ahash_finup_finish);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: req->src != req->sg_head +) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahash_def_finup_done2(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ahash_def_finup_finish1(req: *mut ahash_request, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahash_def_finup_done1(data: *mut c_void, err: c_int) {
    static void ahash_def_finup_done1(void *data, int err)
    {
    ahash_op_done(data, err, ahash_def_finup_finish1);
    }
#[no_mangle]
unsafe extern "C" fn ahash_def_finup(req: *mut ahash_request) -> c_int {
    static int ahash_def_finup(struct ahash_request *req)
    {
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_export_core(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
    ...
    if (crypto_ahash_block_only(tfm)) {
    let mut plen: c_uint = crypto_ahash_blocksize(tfm) + 1;
    let mut reqsize: c_uint = crypto_ahash_reqsize(tfm);
    let mut ss: c_uint = crypto_ahash_statesize(tfm);
    u8 *buf = ahash_request_ctx(req);
...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_import_core(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_ahash_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ahash_exit_tfm(tfm: *mut crypto_tfm) {
    ...
    alg.exit_tfm(hash);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tfm->__crt_alg->cra_exit) -> else {
...
#[no_mangle]
unsafe extern "C" fn crypto_ahash_init_tfm(tfm: *mut crypto_tfm) -> c_int {
    static int crypto_ahash_init_tfm(struct crypto_tfm *tfm)
    {
    struct crypto_ahash *hash = __crypto_ahash_cast(tfm);
    struct ahash_alg *alg = crypto_ahash_alg(hash);
    struct crypto_ahash *fb = core::ptr::null_mut();
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tfm->__crt_alg->cra_init) -> else {
...
#[no_mangle]
unsafe extern "C" fn crypto_ahash_extsize(alg: *mut crypto_alg) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn crypto_ahash_free_instance(inst: *mut crypto_instance) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_has_ahash(alg_name: *const c_char, type: u32, mask: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_hash_alg_has_setkey(halg: *mut hash_alg_common) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ahash_default_export_core(req: *mut ahash_request, out: *mut c_void) -> c_int {
    static int ahash_default_export_core(struct ahash_request *req, void *out)
    {
    return -ENOSYS;
    }
#[no_mangle]
unsafe extern "C" fn ahash_default_import_core(req: *mut ahash_request, in: *const c_void) -> c_int {
    static int ahash_default_import_core(struct ahash_request *req, const void *in)
    {
    return -ENOSYS;
    }
#[no_mangle]
unsafe extern "C" fn ahash_prepare_alg(alg: *mut ahash_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_register_ahash(alg: *mut ahash_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_unregister_ahash(alg: *mut ahash_alg) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_register_ahashes(algs: *mut ahash_alg, count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_unregister_ahashes(algs: *mut ahash_alg, count: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ahash_request_free(req: *mut ahash_request) {
...
#[no_mangle]
pub unsafe extern "C" fn ahash_free_singlespawn_instance(inst: *mut ahash_instance) {
