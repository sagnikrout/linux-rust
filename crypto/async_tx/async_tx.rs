...
//! Source: crypto/async_tx/async_tx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn async_tx_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn async_tx_exit() -> void __exit {
...
//
    ...
    intr_tx = core::ptr::null_mut();
    if (intr_tx) {
    intr_tx.callback = core::ptr::null_mut();
...
//
    ...
    tx = device ? device.device_prep_dma_interrupt(chan, 0) : core::ptr::null_mut();
    } else
...
//
#[no_mangle]
pub unsafe extern "C" fn async_tx_quiesce(tx: *mut dma_async_tx_descriptor) {
