...
#[no_mangle]
unsafe extern "C" fn ecdh_compute_value(req: *mut kpp_request) -> c_int {
    static int ecdh_compute_value(struct kpp_request *req)
    {
    struct crypto_kpp *tfm = crypto_kpp_reqtfm(req);
    struct ecdh_ctx *ctx = ecdh_get_ctx(tfm);
    u64 *public_key;
    u64 *shared_secret = core::ptr::null_mut();
    void *buf;
...
#[no_mangle]
unsafe extern "C" fn ecdh_max_size(tfm: *mut crypto_kpp) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ecdh_nist_p192_init_tfm(tfm: *mut crypto_kpp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecdh_nist_p256_init_tfm(tfm: *mut crypto_kpp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecdh_nist_p384_init_tfm(tfm: *mut crypto_kpp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecdh_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ecdh_exit() -> void __exit {
