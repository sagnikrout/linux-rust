...
#[no_mangle]
unsafe extern "C" fn crypto_chacha_crypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_xchacha_crypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_chacha_mod_init() -> int __init {
    static int __init crypto_chacha_mod_init(void)
    {
    return crypto_register_skciphers(algs, ARRAY_SIZE(algs));
    }
#[no_mangle]
unsafe extern "C" fn crypto_chacha_mod_fini() -> void __exit {
