...
#[no_mangle]
unsafe extern "C" fn cts_cbc_crypt_done(data: *mut c_void, err: c_int) {
...
unsafe extern "C" fn cts_cbc_encrypt(req: *mut skcipher_request) -> c_int {
    ...
    let mut bsize: c_int = crypto_skcipher_blocksize(tfm);
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_encrypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_decrypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_exit_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_free(inst: *mut skcipher_instance) {
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_cts_module_init() -> int __init {
    static int __init crypto_cts_module_init(void)
    {
    return crypto_register_template(&crypto_cts_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn crypto_cts_module_exit() -> void __exit {
