...
pub const CRYPTO_ENGINE_MAX_QLEN: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn crypto_pump_work(work: *mut kthread_work) {
...
//
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_start(engine: *mut crypto_engine) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_stop(engine: *mut crypto_engine) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_exit(engine: *mut crypto_engine) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_register_aead(alg: *mut aead_engine_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_unregister_aead(alg: *mut aead_engine_alg) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_register_aeads(algs: *mut aead_engine_alg, count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_unregister_aeads(algs: *mut aead_engine_alg, count: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_register_ahash(alg: *mut ahash_engine_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_unregister_ahash(alg: *mut ahash_engine_alg) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_register_ahashes(algs: *mut ahash_engine_alg, count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_register_akcipher(alg: *mut akcipher_engine_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_unregister_akcipher(alg: *mut akcipher_engine_alg) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_register_kpp(alg: *mut kpp_engine_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_unregister_kpp(alg: *mut kpp_engine_alg) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_register_skcipher(alg: *mut skcipher_engine_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_engine_unregister_skcipher(alg: *mut skcipher_engine_alg) {
