...
#[no_mangle]
unsafe extern "C" fn authenc_request_complete(req: *mut aead_request, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn authenc_geniv_ahash_finish(req: *mut aead_request) {
...
#[no_mangle]
unsafe extern "C" fn authenc_geniv_ahash_done(data: *mut c_void, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn authenc_geniv_ahash_done2(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_authenc_genicv(req: *mut aead_request, mask: c_uint) -> c_int {
    ...
    struct authenc_request_ctx *areq_ctx = aead_request_ctx(req);
    struct ahash_request *ahreq = (void *)(areq_ctx.tail + ictx.reqoff);
    let mut flags: c_uint = aead_request_flags(req) & ~mask;
...
#[no_mangle]
unsafe extern "C" fn crypto_authenc_encrypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_authenc_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn authenc_decrypt_tail_done(data: *mut c_void, err: c_int) {
    ...
    struct skcipher_request *skreq = (void *)(areq_ctx.tail +
    ictx.reqoff);
    let mut authsize: c_uint = crypto_aead_authsize(authenc);
    let mut flags: c_uint = aead_request_flags(req) & ~mask;
...
#[no_mangle]
unsafe extern "C" fn authenc_verify_ahash_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_authenc_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_authenc_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_authenc_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn crypto_authenc_free(inst: *mut aead_instance) {
...
#[no_mangle]
unsafe extern "C" fn crypto_authenc_module_init() -> int __init {
    static int __init crypto_authenc_module_init(void)
    {
    return crypto_register_template(&crypto_authenc_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn crypto_authenc_module_exit() -> void __exit {
