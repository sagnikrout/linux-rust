...
pub const WP512_BLOCK_SIZE: c_int = 64;
pub const WP512_LENGTHBYTES: c_int = 32;
pub const WHIRLPOOL_ROUNDS: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wp512_ctx {
    pub bitLength: [u8; WP512_LENGTHBYTES],
    pub hash: [u64; WP512_DIGEST_SIZE/8],
}
...
#[no_mangle]
unsafe extern "C" fn wp512_init(desc: *mut shash_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wp512_add_length(bitLength: *mut u8, value: u64) {
    ...
    {
    struct wp512_ctx *wctx = shash_desc_ctx(desc);
    let mut remain: c_uint = len % WP512_BLOCK_SIZE;
    let mut bits_len: u64 = (len - remain) * 8ull;
