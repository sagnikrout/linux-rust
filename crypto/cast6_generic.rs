...
// forward octave
#[no_mangle]
pub unsafe extern "C" fn W(key: *mut u32, i: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn __cast6_setkey(c: *mut cast6_ctx, in_key: *const u8, key_len: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cast6_setkey(tfm: *mut crypto_tfm, key: *const u8, keylen: c_uint) -> c_int {
...
// forward quad round
#[no_mangle]
pub unsafe extern "C" fn Q(block: *mut u32, Kr: *const u8, Km: *const u32) {
...
// reverse quad round
#[no_mangle]
pub unsafe extern "C" fn QBAR(block: *mut u32, Kr: *const u8, Km: *const u32) {
...
#[no_mangle]
pub unsafe extern "C" fn __cast6_encrypt(ctx: *const c_void, outbuf: *mut u8, inbuf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn cast6_encrypt(tfm: *mut crypto_tfm, outbuf: *mut u8, inbuf: *const u8) {
    static void cast6_encrypt(struct crypto_tfm *tfm, u8 *outbuf, const u8 *inbuf)
    {
    __cast6_encrypt(crypto_tfm_ctx(tfm), outbuf, inbuf);
    }
#[no_mangle]
pub unsafe extern "C" fn __cast6_decrypt(ctx: *const c_void, outbuf: *mut u8, inbuf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn cast6_decrypt(tfm: *mut crypto_tfm, outbuf: *mut u8, inbuf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn cast6_mod_init() -> int __init {
    static int __init cast6_mod_init(void)
    {
    return crypto_register_alg(&alg);
    }
#[no_mangle]
unsafe extern "C" fn cast6_mod_fini() -> void __exit {
