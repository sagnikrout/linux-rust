...
// Get the r and s components of a signature from the X.509 certificate.
    ...
    {
    let mut bufsize: usize = ndigits * sizeof(u64);
    const char *d = value;
...
#[no_mangle]
unsafe extern "C" fn ecdsa_x962_key_size(tfm: *mut crypto_sig) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ecdsa_x962_max_size(tfm: *mut crypto_sig) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ecdsa_x962_digest_size(tfm: *mut crypto_sig) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ecdsa_x962_init_tfm(tfm: *mut crypto_sig) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ecdsa_x962_exit_tfm(tfm: *mut crypto_sig) {
...
#[no_mangle]
unsafe extern "C" fn ecdsa_x962_free(inst: *mut sig_instance) {
...
#[no_mangle]
unsafe extern "C" fn ecdsa_x962_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
