...
pub const LRW_BLOCK_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lrw_tfm_ctx {
...
// with key2
//
    pub mulinc: [be128; 128],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lrw_request_ctx {
    pub t: be128,
    pub subreq: skcipher_request,
}

#[no_mangle]
pub unsafe extern "C" fn lrw_setbit128_bbe(b: *mut c_void, bit: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn lrw_next_index(counter: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lrw_xor_tweak_pre(req: *mut skcipher_request) -> c_int {
    static int lrw_xor_tweak_pre(struct skcipher_request *req)
    {
    return lrw_xor_tweak(req, false);
    }
#[no_mangle]
unsafe extern "C" fn lrw_xor_tweak_post(req: *mut skcipher_request) -> c_int {
    static int lrw_xor_tweak_post(struct skcipher_request *req)
    {
    return lrw_xor_tweak(req, true);
    }
#[no_mangle]
unsafe extern "C" fn lrw_crypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lrw_init_crypt(req: *mut skcipher_request) {
...
#[no_mangle]
unsafe extern "C" fn lrw_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lrw_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lrw_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lrw_exit_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn lrw_free_instance(inst: *mut skcipher_instance) {
...
#[no_mangle]
unsafe extern "C" fn lrw_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lrw_module_init() -> int __init {
    static int __init lrw_module_init(void)
    {
    return crypto_register_template(&lrw_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn lrw_module_exit() -> void __exit {
