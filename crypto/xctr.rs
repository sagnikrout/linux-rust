...
pub const XCTR_BLOCKSIZE: c_int = 16;
    ...
    let mut ctr32: __le32 = cpu_to_le32(byte_ctr / XCTR_BLOCKSIZE + 1);
...
#[no_mangle]
unsafe extern "C" fn crypto_xctr_crypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_xctr_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_xctr_module_init() -> int __init {
    static int __init crypto_xctr_module_init(void)
    {
    return crypto_register_template(&crypto_xctr_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn crypto_xctr_module_exit() -> void __exit {
