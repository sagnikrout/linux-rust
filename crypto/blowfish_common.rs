...
//! Source: crypto/blowfish_common.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn encrypt_block(bctx: *mut bf_ctx, dst: *mut u32, src: *mut u32) {
    static void encrypt_block(struct bf_ctx *bctx, u32 *dst, u32 *src)
    {
    const u32 *P = bctx.p;
    const u32 *S = bctx.s;
    let mut yl: u32 = src[0];
    let mut yr: u32 = src[1];
    ROUND(yr, yl, 0);
    ROUND(yl, yr, 1);
    ROUND(yr, yl, 2);
    ROUND(yl, yr, 3);
...
//
#[no_mangle]
pub unsafe extern "C" fn blowfish_setkey(tfm: *mut crypto_tfm, key: *const u8, keylen: c_uint) -> c_int {
