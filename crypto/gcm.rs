...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gcm_instance_ctx {
    pub ctr: crypto_skcipher_spawn,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_gcm_ctx {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_rfc4106_req_ctx {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_rfc4543_instance_ctx {
    pub aead: crypto_aead_spawn,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_rfc4543_ctx {
    pub child: *mut crypto_aead,
    pub nonce: [u8; 4],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_rfc4543_req_ctx {
    pub subreq: aead_request,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_gcm_req_priv_ctx {
    pub iv: [u8; 16],
    pub auth_tag: [u8; 16],
    pub iauth_tag: [u8; 16],
    pub src: [scatterlist; 3],
    pub dst: [scatterlist; 3],
    pub /: *mut *mut skcipher_request skreq; / Must be last,
}
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_init_common(req: *mut aead_request) {
    ...
    if (len) {
    let mut pad_len: c_uint = -len % GHASH_BLOCK_SIZE;
    struct scatter_walk walk;
    scatterwalk_start(&walk, sg);
    do {
    let mut n: c_uint = scatterwalk_next(&walk, len);
...
#[no_mangle]
unsafe extern "C" fn gcm_add_auth_tag(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcm_encrypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_verify(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcm_decrypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_decrypt(req: *mut aead_request) -> c_int {
    static int crypto_gcm_decrypt(struct aead_request *req)
    {
    struct crypto_aead *aead = crypto_aead_reqtfm(req);
    struct crypto_gcm_req_priv_ctx *pctx = crypto_gcm_reqctx(req);
    struct skcipher_request *skreq = &pctx.skreq;
    let mut datalen: c_uint = req.cryptlen - crypto_aead_authsize(aead);
    crypto_gcm_init_common(req);
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_free(inst: *mut aead_instance) {
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4106_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4106_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4106_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4106_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4106_free(inst: *mut aead_instance) {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4543_crypt(req: *mut aead_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4543_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4543_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4543_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4543_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4543_free(inst: *mut aead_instance) {
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn crypto_gcm_module_exit() -> void __exit {
