...
pub const ANUBIS_MIN_KEY_SIZE: c_int = 16;
pub const ANUBIS_MAX_KEY_SIZE: c_int = 40;
pub const ANUBIS_BLOCK_SIZE: c_int = 16;
pub const ANUBIS_MAX_N: c_int = 10;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct anubis_ctx {
    pub bits: int key_len; // in,
    pub R: c_int,
    pub 1][4]: u32 E[ANUBIS_MAX_ROUNDS +,
    pub 1][4]: u32 D[ANUBIS_MAX_ROUNDS +,
}
...
#[no_mangle]
unsafe extern "C" fn anubis_encrypt(tfm: *mut crypto_tfm, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn anubis_decrypt(tfm: *mut crypto_tfm, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn anubis_mod_init() -> int __init {
    static int __init anubis_mod_init(void)
    {
    return crypto_register_alg(&anubis_alg);
    }
#[no_mangle]
unsafe extern "C" fn anubis_mod_fini() -> void __exit {
