...
//
    ...
    {
    let mut buffer_size: usize = *_buffer_size, data_size;
    switch (mode) {
    case KRB5_CHECKSUM_MODE:
...
#[no_mangle]
unsafe extern "C" fn crypto_krb5_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn crypto_krb5_exit() -> void __exit {
