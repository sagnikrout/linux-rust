...
//! Source: crypto/krb5/rfc3961_simplified.c
#![no_std]
...
// Maximum blocksize for the supported crypto algorithms
    ...
    skcipher_request_set_callback(req, 0, core::ptr::null_mut(), core::ptr::null_mut());
...
// loop encrypting the blocks until enough key bytes are generated
    n = 0;
    while (n < rawkey.len) {
    rfc3961_do_encrypt(cipher, core::ptr::null_mut(), &inblock, &outblock);
...
//
    ...
    if (ret < 0)
    goto err_free;
    ret = rfc3961_do_encrypt(cipher, core::ptr::null_mut(), in_data, result);
    err_free:
    crypto_free_sync_skcipher(cipher);
    err:
    return ret;
...
//
    ...
    let mut m: c_uint = krb5.block_len;
    void *buffer;
    int ret;
