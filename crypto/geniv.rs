...
#[no_mangle]
unsafe extern "C" fn aead_geniv_free(inst: *mut aead_instance) {
...
#[no_mangle]
pub unsafe extern "C" fn aead_init_geniv(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aead_exit_geniv(tfm: *mut crypto_aead) {
