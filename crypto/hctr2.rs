...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hctr2_instance_ctx {
    pub blockcipher_spawn: crypto_cipher_spawn,
    pub xctr_spawn: crypto_skcipher_spawn,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hctr2_tfm_ctx {
    pub blockcipher: *mut crypto_cipher,
    pub xctr: *mut crypto_skcipher,
    pub poly_key: polyval_key,
    pub hashed_tweaklens: [polyval_elem; 2],
    pub L: [u8; BLOCKCIPHER_BLOCK_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hctr2_request_ctx {
    pub first_block: [u8; BLOCKCIPHER_BLOCK_SIZE],
    pub xctr_iv: [u8; BLOCKCIPHER_BLOCK_SIZE],
    pub bulk_part_dst: *mut scatterlist,
    pub bulk_part_src: *mut scatterlist,
    pub sg_src: [scatterlist; 2],
    pub sg_dst: [scatterlist; 2],
    pub hashed_tweak: polyval_elem,
//
// skcipher sub-request size is unknown at compile-time, so it needs to
// go after the members with known sizes.
//
    union {
    pub poly_ctx: polyval_ctx,
    pub xctr_req: skcipher_request,
    pub u: },
}
...
//
#[no_mangle]
unsafe extern "C" fn hctr2_hash_tweaklens(tctx: *mut hctr2_tfm_ctx) {
...
#[no_mangle]
unsafe extern "C" fn hctr2_hash_tweak(req: *mut skcipher_request) {
    ...
    let mut has_remainder: bool = req.cryptlen % POLYVAL_BLOCK_SIZE;
...
#[no_mangle]
unsafe extern "C" fn hctr2_finish(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hctr2_xctr_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hctr2_crypt(req: *mut skcipher_request, enc: bool) -> c_int {
    ...
    struct hctr2_request_ctx *rctx = skcipher_request_ctx(req);
    u8 digest[POLYVAL_DIGEST_SIZE];
    let mut bulk_len: c_int = req.cryptlen - BLOCKCIPHER_BLOCK_SIZE;
...
#[no_mangle]
unsafe extern "C" fn hctr2_encrypt(req: *mut skcipher_request) -> c_int {
    static int hctr2_encrypt(struct skcipher_request *req)
    {
    return hctr2_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn hctr2_decrypt(req: *mut skcipher_request) -> c_int {
    static int hctr2_decrypt(struct skcipher_request *req)
    {
    return hctr2_crypt(req, false);
    }
#[no_mangle]
unsafe extern "C" fn hctr2_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hctr2_exit_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn hctr2_free_instance(inst: *mut skcipher_instance) {
...
#[no_mangle]
unsafe extern "C" fn hctr2_create_base(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hctr2_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
