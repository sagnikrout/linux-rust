...
//
    ...
    let mut cryptd_max_cpu_qlen: static unsigned int = 1000;
    module_param(cryptd_max_cpu_qlen, uint, 0);
    MODULE_PARM_DESC(cryptd_max_cpu_qlen, "Set cryptd Max queue depth");
    static struct workqueue_struct *cryptd_wq;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cryptd_cpu_queue {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cryptd_queue {
//
// Protected by disabling BH to allow enqueueing from softinterrupt and
// dequeuing from kworker (cryptd_queue_worker()).
//
    pub cpu_queue: *mut cryptd_cpu_queue __percpu,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cryptd_instance_ctx {
    pub spawn: crypto_spawn,
    pub queue: *mut cryptd_queue,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct skcipherd_instance_ctx {
    pub spawn: crypto_skcipher_spawn,
    pub queue: *mut cryptd_queue,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hashd_instance_ctx {
    pub spawn: crypto_shash_spawn,
    pub queue: *mut cryptd_queue,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aead_instance_ctx {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cryptd_skcipher_ctx {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cryptd_skcipher_request_ctx {
    pub req: skcipher_request,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cryptd_hash_ctx {
    pub refcnt: refcount_t,
    pub child: *mut crypto_shash,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cryptd_hash_request_ctx {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cryptd_aead_request_ctx {
...
#[no_mangle]
unsafe extern "C" fn cryptd_fini_queue(queue: *mut cryptd_queue) {
...
// do.
#[no_mangle]
unsafe extern "C" fn cryptd_queue_worker(work: *mut work_struct) {
    static void cryptd_queue_worker(struct work_struct *work)
    {
    struct cryptd_cpu_queue *cpu_queue;
...
// mask |= crypto_algt_inherited_mask(algt);
    ...
    struct skcipher_request *subreq = &rctx.req;
    let mut refcnt: c_int = refcount_read(&ctx.refcnt);
    local_bh_disable();
...
#[no_mangle]
unsafe extern "C" fn cryptd_skcipher_encrypt(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_skcipher_decrypt(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_skcipher_encrypt_enqueue(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cryptd_skcipher_decrypt_enqueue(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cryptd_skcipher_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cryptd_skcipher_exit_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_skcipher_free(inst: *mut skcipher_instance) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_init_tfm(tfm: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_exit_tfm(tfm: *mut crypto_ahash) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_init(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_init_enqueue(req: *mut ahash_request) -> c_int {
    static int cryptd_hash_init_enqueue(struct ahash_request *req)
    {
    return cryptd_hash_enqueue(req, cryptd_hash_init);
    }
#[no_mangle]
unsafe extern "C" fn cryptd_hash_update(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_update_enqueue(req: *mut ahash_request) -> c_int {
    static int cryptd_hash_update_enqueue(struct ahash_request *req)
    {
    return cryptd_hash_enqueue(req, cryptd_hash_update);
    }
#[no_mangle]
unsafe extern "C" fn cryptd_hash_final(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_final_enqueue(req: *mut ahash_request) -> c_int {
    static int cryptd_hash_final_enqueue(struct ahash_request *req)
    {
    return cryptd_hash_enqueue(req, cryptd_hash_final);
    }
#[no_mangle]
unsafe extern "C" fn cryptd_hash_finup(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_finup_enqueue(req: *mut ahash_request) -> c_int {
    static int cryptd_hash_finup_enqueue(struct ahash_request *req)
    {
    return cryptd_hash_enqueue(req, cryptd_hash_finup);
    }
#[no_mangle]
unsafe extern "C" fn cryptd_hash_digest(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_digest_enqueue(req: *mut ahash_request) -> c_int {
    static int cryptd_hash_digest_enqueue(struct ahash_request *req)
    {
    return cryptd_hash_enqueue(req, cryptd_hash_digest);
    }
#[no_mangle]
unsafe extern "C" fn cryptd_hash_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cryptd_hash_free(inst: *mut ahash_instance) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_aead_encrypt(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_aead_decrypt(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_aead_encrypt_enqueue(req: *mut aead_request) -> c_int {
    static int cryptd_aead_encrypt_enqueue(struct aead_request *req)
    {
    return cryptd_aead_enqueue(req, cryptd_aead_encrypt );
    }
#[no_mangle]
unsafe extern "C" fn cryptd_aead_decrypt_enqueue(req: *mut aead_request) -> c_int {
    static int cryptd_aead_decrypt_enqueue(struct aead_request *req)
    {
    return cryptd_aead_enqueue(req, cryptd_aead_decrypt );
    }
#[no_mangle]
unsafe extern "C" fn cryptd_aead_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cryptd_aead_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_aead_free(inst: *mut aead_instance) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cryptd_aead_queued(tfm: *mut cryptd_aead) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cryptd_free_aead(tfm: *mut cryptd_aead) {
...
#[no_mangle]
unsafe extern "C" fn cryptd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cryptd_exit() -> void __exit {
