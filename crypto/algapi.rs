...
#[no_mangle]
pub unsafe extern "C" fn crypto_check_module_sig(mod: *mut module) {
...
#[no_mangle]
unsafe extern "C" fn crypto_check_alg(alg: *mut crypto_alg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_free_instance(inst: *mut crypto_instance) {
...
//
    ...
    {
    let mut new_type: u32 = (nalg ?: alg).cra_flags;
    struct crypto_spawn *spawn, *n;
...
//
    if (spawns.next == core::ptr::null_mut())
    break;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: spawn->registered) -> else {
    ...
    return core::ptr::null_mut(); /* No self-test needed */
...
unsafe extern "C" fn crypto_free_alg(alg: *mut crypto_alg) {
    ...
    {
    let mut algsize: c_uint = alg.cra_type.algsize;
    u8 *p = (u8 *)alg - algsize;
    crypto_destroy_alg(alg);
    kfree(p);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto_register_alg(alg: *mut crypto_alg) -> c_int {
    int crypto_register_alg(struct crypto_alg *alg)
    {
    struct crypto_larval *larval;
    let mut test_started: bool = false;
...
#[no_mangle]
unsafe extern "C" fn crypto_remove_alg(alg: *mut crypto_alg, list: *mut list_head) -> c_int {
    ...
    alg.cra_flags |= CRYPTO_ALG_DEAD;
    list_del_init(&alg.cra_list);
    crypto_remove_spawns(alg, list, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn crypto_register_templates(tmpls: *mut crypto_template, count: c_int) -> c_int {
...
pub unsafe extern "C" fn crypto_unregister_template(tmpl: *mut crypto_template) {
    ...
    let mut err: c_int = crypto_remove_alg(&inst.alg, &users);
    BUG_ON(err);
    }
    up_write(&crypto_alg_sem);
    hlist_for_each_entry_safe(inst, n, list, list) {
...
pub unsafe extern "C" fn crypto_unregister_templates(tmpls: *mut crypto_template, count: c_int) {
    ...
    {
    struct crypto_template *q, *tmpl = core::ptr::null_mut();
    ...
    goto unlock;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: larval) -> else {
    else if (larval)
...
pub unsafe extern "C" fn crypto_unregister_instance(inst: *mut crypto_instance) {
    ...
    LIST_HEAD(list);
    down_write(&crypto_alg_sem);
    crypto_remove_spawns(&inst.alg, &list, core::ptr::null_mut());
    ...
    if (WARN_ON_ONCE(inst == core::ptr::null_mut()))
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn crypto_check_attr_type(tb: *mut rtattr, type: u32, mask_ret: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_inc_byte(a: *mut u8, size: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_inc(a: *mut u8, size: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn crypto_start_tests() -> void __init {
    ...
    for (;;) {
    struct crypto_larval *larval = core::ptr::null_mut();
    struct crypto_alg *q;
    down_write(&crypto_alg_sem);
    list_for_each_entry(q, &crypto_alg_list, cra_list) {
...
#[no_mangle]
unsafe extern "C" fn crypto_algapi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn crypto_algapi_exit() -> void __exit {
