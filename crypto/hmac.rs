...
// Contains 'u8 ipad[statesize];', then 'u8 opad[statesize];'
    ...
    let mut ds: c_int = crypto_shash_digestsize(parent);
    let mut ss: c_int = crypto_shash_statesize(parent);
...
#[no_mangle]
unsafe extern "C" fn hmac_export(pdesc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_import(pdesc: *mut shash_desc, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_export_core(pdesc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_import_core(pdesc: *mut shash_desc, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_init(pdesc: *mut shash_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_init_tfm(parent: *mut crypto_shash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_exit_tfm(parent: *mut crypto_shash) {
...
// The underlying hash algorithm must not require a key
    ...
    let mut ds: c_int = crypto_ahash_digestsize(parent);
    let mut bs: c_int = crypto_ahash_blocksize(parent);
    let mut ss: c_int = crypto_ahash_statesize(parent);
    ...
    ahash_request_set_virt(req, ipad, core::ptr::null_mut(), bs);
    err = crypto_ahash_init(req) ?:
    crypto_ahash_update(req) ?:
    crypto_ahash_export(req, ipad);
    ahash_request_set_virt(req, opad, core::ptr::null_mut(), bs);
    err = err ?:
...
#[no_mangle]
unsafe extern "C" fn hmac_export_ahash(preq: *mut ahash_request, out: *mut c_void) -> c_int {
    static int hmac_export_ahash(struct ahash_request *preq, void *out)
    {
    return crypto_ahash_export(ahash_request_ctx(preq), out);
    }
#[no_mangle]
unsafe extern "C" fn hmac_import_ahash(preq: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_export_core_ahash(preq: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_import_core_ahash(preq: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_init_ahash(preq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_update_ahash(preq: *mut ahash_request) -> c_int {
    ...
    ahash_request_set_virt(req, preq.svirt, core::ptr::null_mut(), preq.nbytes);
    else
    ahash_request_set_crypt(req, preq.src, core::ptr::null_mut(), preq.nbytes);
    return crypto_ahash_update(req);
    }
#[no_mangle]
unsafe extern "C" fn hmac_finup_finish(preq: *mut ahash_request, mask: c_uint) -> c_int {
    static int hmac_finup_finish(struct ahash_request *preq, unsigned int mask)
    {
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(preq);
    struct ahash_request *req = ahash_request_ctx(preq);
    struct ahash_hmac_ctx *tctx = crypto_ahash_ctx(tfm);
    let mut ds: c_int = crypto_ahash_digestsize(tfm);
    let mut ss: c_int = crypto_ahash_statesize(tfm);
    const u8 *opad = &tctx.pads[ss];
...
#[no_mangle]
unsafe extern "C" fn hmac_finup_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hmac_finup_ahash(preq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_digest_ahash(preq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_init_ahash_tfm(parent: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_exit_ahash_tfm(parent: *mut crypto_ahash) {
...
#[no_mangle]
unsafe extern "C" fn hmac_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hmac_create_shash(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
    ...
    if (err)
    let mut err: return = = -EINVAL ? -ENOENT : err;
    return __hmac_create_shash(tmpl, tb, mask);
    }
...
#[no_mangle]
unsafe extern "C" fn hmac_module_init() -> int __init {
    static int __init hmac_module_init(void)
    {
    return crypto_register_templates(hmac_tmpls, ARRAY_SIZE(hmac_tmpls));
    }
#[no_mangle]
unsafe extern "C" fn hmac_module_exit() -> void __exit {
