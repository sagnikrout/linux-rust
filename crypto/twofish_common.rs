...
//! Source: crypto/twofish_common.c
#![no_std]
...
// 128-bit keys use only sa through sh; 256-bit use all of them.
    let mut sa: u8 = 0, sb = 0, sc = 0, sd = 0, se = 0, sf = 0, sg = 0, sh = 0;
    let mut si: u8 = 0, sj = 0, sk = 0, sl = 0, sm = 0, sn = 0, so = 0, sp = 0;
...
#[no_mangle]
pub unsafe extern "C" fn twofish_setkey(tfm: *mut crypto_tfm, key: *const u8, key_len: c_uint) -> c_int {
