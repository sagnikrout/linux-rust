...
//
    ...
    let mut af_alg_restrict: static int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn af_alg_register_type(type: *const af_alg_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn af_alg_unregister_type(type: *const af_alg_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn af_alg_capable() -> bool {
    ...
    {
    let mut level: c_int = READ_ONCE(af_alg_restrict);
    if (level == 0)
    return 0;
    if (level == 1) {
...
#[no_mangle]
unsafe extern "C" fn alg_do_release(type: *const af_alg_type, private: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn af_alg_release(sock: *mut socket) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn af_alg_release_parent(sk: *mut sock) {
    void af_alg_release_parent(struct sock *sk)
    {
    struct alg_sock *ask = alg_sk(sk);
    let mut nokey: c_uint = atomic_read(&ask.nokey_refcnt);
    sk = ask.parent;
    ask = alg_sk(sk);
    if (nokey)
...
#[no_mangle]
unsafe extern "C" fn alg_bind(sock: *mut socket, uaddr: *mut sockaddr_unsized, addr_len: c_int) -> c_int {
    static int alg_bind(struct socket *sock, struct sockaddr_unsized *uaddr, int addr_len)
    {
    let mut allowed: u32 = CRYPTO_ALG_KERN_DRIVER_ONLY;
...
#[no_mangle]
unsafe extern "C" fn alg_setkey(sk: *mut sock, ukey: sockptr_t, keylen: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alg_sock_destruct(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn af_alg_cmsg_send(msg: *mut msghdr, con: *mut af_alg_control) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn af_alg_alloc_tsgl(sk: *mut sock) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn af_alg_count_tsgl(sk: *mut sock, bytes: usize) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn af_alg_pull_tsgl(sk: *mut sock, used: usize, dst: *mut scatterlist) {
    ...
    sg = sgl.sg;
    for (i = 0; i < sgl.cur; i++) {
    let mut plen: usize = min_t(size_t, used, sg[i].length);
...
// reassign page to dst
    ...
    return;
    put_page(page);
    sg_assign_page(sg + i, core::ptr::null_mut());
    }
    list_del(&sgl.list);
...
//
#[no_mangle]
unsafe extern "C" fn af_alg_free_areq_sgls(areq: *mut af_alg_async_req) {
...
//
#[no_mangle]
unsafe extern "C" fn af_alg_wait_for_wmem(sk: *mut sock, flags: c_uint) -> c_int {
    static int af_alg_wait_for_wmem(struct sock *sk, unsigned int flags)
    {
    DEFINE_WAIT_FUNC(wait, woken_wake_function);
    let mut err: c_int = -ERESTARTSYS;
    long timeout;
...
//
#[no_mangle]
pub unsafe extern "C" fn af_alg_wmem_wakeup(sk: *mut sock) {
...
//
#[no_mangle]
pub unsafe extern "C" fn af_alg_wait_for_data(sk: *mut sock, flags: unsigned, min: unsigned) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn af_alg_data_wakeup(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn af_alg_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn af_alg_exit() -> void __exit {
