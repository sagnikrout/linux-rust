...
#[no_mangle]
unsafe extern "C" fn crypto_aes_encrypt(tfm: *mut crypto_tfm, out: *mut u8, in: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_decrypt(tfm: *mut crypto_tfm, out: *mut u8, in: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_cmac_init(desc: *mut shash_desc) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_cbcmac_init(desc: *mut shash_desc) -> int __maybe_unused {
...
// AES-ECB
#[no_mangle]
unsafe extern "C" fn crypto_aes_ecb_encrypt(req: *mut skcipher_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_ecb_decrypt(req: *mut skcipher_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_cbc_encrypt(req: *mut skcipher_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_cbc_decrypt(req: *mut skcipher_request) -> __maybe_unused int {
...
//
    ...
    const struct aes_key *key =
    crypto_skcipher_ctx(crypto_skcipher_reqtfm(req));
    let mut main_len: c_uint = req.cryptlen;
...
// AES-CTR
#[no_mangle]
unsafe extern "C" fn crypto_aes_ctr_crypt(req: *mut skcipher_request) -> __maybe_unused int {
...
// AES-XCTR
#[no_mangle]
unsafe extern "C" fn crypto_aes_xctr_crypt(req: *mut skcipher_request) -> __maybe_unused int {
...
//
    ...
    u8 tmp[2 * AES_BLOCK_SIZE] __aligned(__alignof__(long));
    let mut main_len: c_uint = req.cryptlen;
    let mut tail_len: c_uint = main_len % AES_BLOCK_SIZE;
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_xts_encrypt(req: *mut skcipher_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_xts_decrypt(req: *mut skcipher_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_gcm_encrypt(req: *mut aead_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_gcm_decrypt(req: *mut aead_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_rfc4106_encrypt(req: *mut aead_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_rfc4106_decrypt(req: *mut aead_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_ccm_encrypt(req: *mut aead_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_ccm_decrypt(req: *mut aead_request) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_mod_init() -> int __init {
    static int __init crypto_aes_mod_init(void)
    {
    let mut err: c_int = crypto_register_alg(&alg);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn crypto_aes_mod_exit() -> void __exit {
