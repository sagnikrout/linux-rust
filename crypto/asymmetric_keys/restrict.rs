...
//! Source: crypto/asymmetric_keys/restrict.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ca_keys_setup(str: *mut c_char) -> int __init {
    ...
    let mut hexlen: usize = (strlen(str) - 3) / 2;
    int ret;
...
//
    ...
    return -ENOKEY;
#[no_mangle]
pub unsafe extern "C" fn if(&key_type_keyring: dest_keyring->type !=) -> else {
