...
//! Source: crypto/asymmetric_keys/asymmetric_type.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn asymmetric_key_match_preparse(match_data: *mut key_match_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn asymmetric_key_match_free(match_data: *mut key_match_data) {
...
//
#[no_mangle]
unsafe extern "C" fn asymmetric_key_describe(key: *const key, m: *mut seq_file) {
...
//
#[no_mangle]
unsafe extern "C" fn asymmetric_key_preparse(prep: *mut key_preparsed_payload) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn asymmetric_key_free_kids(kids: *mut asymmetric_key_ids) {
...
//
#[no_mangle]
unsafe extern "C" fn asymmetric_key_free_preparse(prep: *mut key_preparsed_payload) {
...
//
#[no_mangle]
unsafe extern "C" fn asymmetric_key_destroy(key: *mut key) {
    ...
    key.payload.data[asym_crypto] = core::ptr::null_mut();
    key.payload.data[asym_subtype] = core::ptr::null_mut();
    key.payload.data[asym_key_ids] = core::ptr::null_mut();
    key.payload.data[asym_auth] = core::ptr::null_mut();
    if (subtype) {
...
//
    ...
    restrict_link_by_builtin_trusted, core::ptr::null_mut());
    if (strcmp("builtin_and_secondary_trusted", restriction) == 0)
    return asymmetric_restriction_alloc(
    restrict_link_by_builtin_and_secondary_trusted, core::ptr::null_mut());
    ...
    let mut allow_null_key: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn register_asymmetric_key_parser(parser: *mut asymmetric_key_parser) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_asymmetric_key_parser(parser: *mut asymmetric_key_parser) {
...
//
#[no_mangle]
unsafe extern "C" fn asymmetric_key_init() -> int __init {
    static int __init asymmetric_key_init(void)
    {
    return register_key_type(&key_type_asymmetric);
    }
#[no_mangle]
unsafe extern "C" fn asymmetric_key_cleanup() -> void __exit {
