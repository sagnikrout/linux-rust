...
//! Source: crypto/asymmetric_keys/pkcs7_verify.c
#![no_std]
...
//
    if (sinfo == core::ptr::null_mut() || sinfo.next != core::ptr::null_mut())
    return -EBADMSG;
...
//
    ...
    {
    struct pkcs7_signed_info *sinfo;
    let mut actual_ret: c_int = -ENOPKG;
    int ret;
    kenter("");
    switch (usage) {
