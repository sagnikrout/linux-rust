...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ccm_instance_ctx {
    pub ctr: crypto_skcipher_spawn,
    pub mac: crypto_ahash_spawn,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_ccm_ctx {
    pub mac: *mut crypto_ahash,
    pub ctr: *mut crypto_skcipher,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_rfc4309_ctx {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_rfc4309_req_ctx {
    pub src: [scatterlist; 3],
    pub dst: [scatterlist; 3],
    pub subreq: aead_request,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct crypto_ccm_req_priv_ctx {
    pub odata: [u8; 16],
    pub idata: [u8; 16],
    pub auth_tag: [u8; 16],
    pub flags: u32,
    ...
    pub dst: [scatterlist; 3],
    union {
    pub ahreq: ahash_request,
    pub skreq: skcipher_request,
}

    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cbcmac_tfm_ctx {
    ...
    {
    let mut align: c_ulong = crypto_aead_alignmask(crypto_aead_reqtfm(req));
    return (void *)PTR_ALIGN((u8 *)aead_request_ctx(req), align + 1);
    }
#[no_mangle]
unsafe extern "C" fn set_msg_len(block: *mut u8, msglen: c_uint, csize: c_int) -> c_int {
...
pub unsafe extern "C" fn if(csize)): *mut *mut msglen > (1 << (8) -> else {
    ...
    let mut lp: c_uint = req.iv[0];
    let mut l: c_uint = lp + 1;
    unsigned int m;
...
#[no_mangle]
unsafe extern "C" fn format_adata(adata: *mut u8, a: c_uint) -> c_int {
...
// format associated data and compute into mac
    ...
    ahash_request_set_callback(ahreq, pctx.flags, core::ptr::null_mut(), core::ptr::null_mut());
    ahash_request_set_crypt(ahreq, sg, core::ptr::null_mut(), assoclen + ilen + 16);
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_encrypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_init_crypt(req: *mut aead_request, tag: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_decrypt_done(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_free(inst: *mut aead_instance) {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4309_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4309_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4309_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4309_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn crypto_rfc4309_free(inst: *mut aead_instance) {
...
#[no_mangle]
unsafe extern "C" fn crypto_cbcmac_digest_init(pdesc: *mut shash_desc) -> c_int {
    static int crypto_cbcmac_digest_init(struct shash_desc *pdesc)
    {
    let mut bs: c_int = crypto_shash_digestsize(pdesc.tfm);
    ...
    let mut bs: c_int = crypto_shash_digestsize(parent);
    u8 *dg = shash_desc_ctx(pdesc);
    do {
    crypto_xor(dg, p, bs);
...
#[no_mangle]
unsafe extern "C" fn cbcmac_init_tfm(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cbcmac_exit_tfm(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn cbcmac_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn crypto_ccm_module_exit() -> void __exit {
