...
pub const ZSTD_DEF_LEVEL: c_int = 3;
pub const ZSTD_MAX_WINDOWLOG: c_int = 18;
...
pub struct zstd_ctx {
    ...
    pub __counted_by(wksp_size): u8 wksp[] __aligned(8),
}
...
#[no_mangle]
unsafe extern "C" fn zstd_free_stream(ctx: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn zstd_init(acomp_tfm: *mut crypto_acomp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zstd_compress(req: *mut acomp_req) -> c_int {
    static int zstd_compress(struct acomp_req *req)
    {
    struct crypto_acomp_stream *s;
    unsigned int pos, scur, dcur;
    let mut total_out: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn zstd_decompress(req: *mut acomp_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zstd_mod_init() -> int __init {
    static int __init zstd_mod_init(void)
    {
    return crypto_register_acomp(&zstd_acomp);
    }
#[no_mangle]
unsafe extern "C" fn zstd_mod_fini() -> void __exit {
