...
pub const SEED_NUM_KCONSTANTS: c_int = 16;
pub const SEED_KEY_SIZE: c_int = 16;
pub const SEED_BLOCK_SIZE: c_int = 16;
pub const SEED_KEYSCHED_LEN: c_int = 32;
//
...
#[derive(Copy, Clone)]
pub struct seed_ctx {
    pub keysched: [u32; SEED_KEYSCHED_LEN],
}
...
#[no_mangle]
unsafe extern "C" fn seed_encrypt(tfm: *mut crypto_tfm, out: *mut u8, in: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn seed_decrypt(tfm: *mut crypto_tfm, out: *mut u8, in: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn seed_init() -> int __init {
    static int __init seed_init(void)
    {
    return crypto_register_alg(&seed_alg);
    }
#[no_mangle]
unsafe extern "C" fn seed_fini() -> void __exit {
