...
//! Source: crypto/camellia_generic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn camellia_setup_tail(subkey: *mut u32, subL: *mut u32, subR: *mut u32, max: c_int) {
...
#[no_mangle]
unsafe extern "C" fn camellia_setup128(key: *const c_uchar, subkey: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn camellia_setup256(key: *const c_uchar, subkey: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn camellia_setup192(key: *const c_uchar, subkey: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn camellia_do_encrypt(subkey: *const u32, io: *mut u32, max: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn camellia_do_decrypt(subkey: *const u32, io: *mut u32, i: unsigned) {
...
pub struct camellia_ctx {
    ...
    pub sizeof(u32)]: u32 key_table[CAMELLIA_TABLE_BYTE_LEN /,
}
...
#[no_mangle]
unsafe extern "C" fn camellia_encrypt(tfm: *mut crypto_tfm, out: *mut u8, in: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn camellia_decrypt(tfm: *mut crypto_tfm, out: *mut u8, in: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn camellia_init() -> int __init {
    static int __init camellia_init(void)
    {
    return crypto_register_alg(&camellia_alg);
    }
#[no_mangle]
unsafe extern "C" fn camellia_fini() -> void __exit {
