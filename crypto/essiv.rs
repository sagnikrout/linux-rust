...
#[no_mangle]
unsafe extern "C" fn essiv_skcipher_crypt(req: *mut skcipher_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn essiv_skcipher_encrypt(req: *mut skcipher_request) -> c_int {
    static int essiv_skcipher_encrypt(struct skcipher_request *req)
    {
    return essiv_skcipher_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn essiv_skcipher_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn essiv_aead_crypt(req: *mut aead_request, enc: bool) -> c_int {
    ...
    let mut ivsize: c_int = crypto_aead_ivsize(tfm);
    let mut ssize: c_int = req.assoclen - ivsize;
...
#[no_mangle]
unsafe extern "C" fn essiv_aead_encrypt(req: *mut aead_request) -> c_int {
    static int essiv_aead_encrypt(struct aead_request *req)
    {
    return essiv_aead_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn essiv_aead_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn essiv_skcipher_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn essiv_aead_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn essiv_skcipher_exit_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn essiv_aead_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn essiv_skcipher_free_instance(inst: *mut skcipher_instance) {
...
#[no_mangle]
unsafe extern "C" fn essiv_aead_free_instance(inst: *mut aead_instance) {
...
#[no_mangle]
unsafe extern "C" fn parse_cipher_name(essiv_cipher_name: *mut c_char, cra_name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn essiv_create(tmpl: *mut crypto_template, tb: *mut rtattr) -> c_int {
    static int essiv_create(struct crypto_template *tmpl, struct rtattr **tb)
    {
    struct skcipher_alg_common *skcipher_alg = core::ptr::null_mut();
    struct crypto_attr_type *algt;
    const char *inner_cipher_name;
    const char *shash_name;
    struct skcipher_instance *skcipher_inst = core::ptr::null_mut();
    struct aead_instance *aead_inst = core::ptr::null_mut();
    struct crypto_instance *inst;
    struct crypto_alg *base, *block_base;
    struct essiv_instance_ctx *ictx;
    struct aead_alg *aead_alg = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn essiv_module_init() -> int __init {
    static int __init essiv_module_init(void)
    {
    return crypto_register_template(&essiv_tmpl);
    }
#[no_mangle]
unsafe extern "C" fn essiv_module_exit() -> void __exit {
