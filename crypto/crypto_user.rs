...
pub struct crypto_dump_info {
    ...
    p.cru_driver_name);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !exact) -> else {
    else if (!exact)
...
#[no_mangle]
unsafe extern "C" fn crypto_report_cipher(skb: *mut sk_buff, alg: *mut crypto_alg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_dump_report(skb: *mut sk_buff, cb: *mut netlink_callback) -> c_int {
    static int crypto_dump_report(struct sk_buff *skb, struct netlink_callback *cb)
    {
    let mut start_pos: usize = cb.args[0];
    let mut pos: usize = 0;
    struct crypto_dump_info info;
    struct crypto_alg *alg;
    int res;
...
#[no_mangle]
unsafe extern "C" fn crypto_dump_report_done(cb: *mut netlink_callback) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_netlink_rcv(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn crypto_netlink_init(net: *mut net) -> int __net_init {
    ...
    return net.crypto_nlsk == core::ptr::null_mut() ? -ENOMEM : 0;
    }
#[no_mangle]
unsafe extern "C" fn crypto_netlink_exit(net: *mut net) -> void __net_exit {
    static void __net_exit crypto_netlink_exit(struct net *net)
    {
    netlink_kernel_release(net.crypto_nlsk);
    net.crypto_nlsk = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn crypto_user_init() -> int __init {
    static int __init crypto_user_init(void)
    {
    return register_pernet_subsys(&crypto_netlink_net_ops);
    }
#[no_mangle]
unsafe extern "C" fn crypto_user_exit() -> void __exit {
