...
//
    ...
    (((s1[I >> 24] + s2[(I>>16)&0xff]) ^ s3[(I>>8)&0xff]) - s4[I&0xff]))
#[no_mangle]
pub unsafe extern "C" fn __cast5_encrypt(c: *mut cast5_ctx, outbuf: *mut u8, inbuf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn cast5_encrypt(tfm: *mut crypto_tfm, outbuf: *mut u8, inbuf: *const u8) {
    static void cast5_encrypt(struct crypto_tfm *tfm, u8 *outbuf, const u8 *inbuf)
    {
    __cast5_encrypt(crypto_tfm_ctx(tfm), outbuf, inbuf);
    }
#[no_mangle]
pub unsafe extern "C" fn __cast5_decrypt(c: *mut cast5_ctx, outbuf: *mut u8, inbuf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn cast5_decrypt(tfm: *mut crypto_tfm, outbuf: *mut u8, inbuf: *const u8) {
    static void cast5_decrypt(struct crypto_tfm *tfm, u8 *outbuf, const u8 *inbuf)
    {
    __cast5_decrypt(crypto_tfm_ctx(tfm), outbuf, inbuf);
    }
#[no_mangle]
unsafe extern "C" fn key_schedule(x: *mut u32, z: *mut u32, k: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cast5_setkey(tfm: *mut crypto_tfm, key: *const u8, key_len: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cast5_mod_init() -> int __init {
    static int __init cast5_mod_init(void)
    {
    return crypto_register_alg(&alg);
    }
#[no_mangle]
unsafe extern "C" fn cast5_mod_fini() -> void __exit {
