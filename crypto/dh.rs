...
#[derive(Copy, Clone)]
pub struct dh_ctx {
    pub /: *mut *mut MPI p; / Value is guaranteed to be set.,
    pub /: *mut *mut MPI g; / Value is guaranteed to be set.,
    pub /: *mut *mut MPI xa; / Value is guaranteed to be set.,
}

#[no_mangle]
unsafe extern "C" fn dh_clear_ctx(ctx: *mut dh_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn _compute_val(ctx: *const dh_ctx, base: MPI, val: MPI) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dh_check_params_length(p_len: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dh_set_params(ctx: *mut dh_ctx, params: *mut dh) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dh_is_pubkey_valid(ctx: *mut dh_ctx, y: MPI) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dh_compute_value(req: *mut kpp_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dh_max_size(tfm: *mut crypto_kpp) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dh_exit_tfm(tfm: *mut crypto_kpp) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dh_safe_prime {
    pub max_strength: c_uint,
    pub p_size: c_uint,
    pub p: *const c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dh_safe_prime_instance_ctx {
    pub dh_spawn: crypto_kpp_spawn,
    pub safe_prime: *const dh_safe_prime,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dh_safe_prime_tfm_ctx {
    pub dh_tfm: *mut crypto_kpp,
}

#[no_mangle]
unsafe extern "C" fn dh_safe_prime_free_instance(inst: *mut kpp_instance) {
...
#[no_mangle]
unsafe extern "C" fn dh_safe_prime_init_tfm(tfm: *mut crypto_kpp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dh_safe_prime_exit_tfm(tfm: *mut crypto_kpp) {
...
#[no_mangle]
unsafe extern "C" fn __add_u64_to_be(dst: *mut __be64, n: c_uint, val: u64) -> u64 {
    static u64 __add_u64_to_be(__be64 *dst, unsigned int n, u64 val)
    {
    unsigned int i;
    for (i = n; val && i > 0; --i) {
    let mut tmp: u64 = be64_to_cpu(dst[i - 1]);
    tmp += val;
    val = tmp >= val ? 0 : 1;
...
// Strip the leading extra __be64, which is (virtually) zero by now.
    ...
    struct dh_safe_prime_tfm_ctx *tfm_ctx = kpp_tfm_ctx(tfm);
    let mut params: dh = {};
    void *buf = core::ptr::null_mut(), *key = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dh_safe_prime_complete_req(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dh_safe_prime_generate_public_key(req: *mut kpp_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dh_safe_prime_compute_shared_secret(req: *mut kpp_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dh_safe_prime_max_size(tfm: *mut crypto_kpp) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dh_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dh_exit() -> void __exit {
