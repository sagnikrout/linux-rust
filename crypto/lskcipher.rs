...
//
    ...
    {
    let mut alignmask: c_ulong = crypto_lskcipher_alignmask(tfm);
    ...
    {
    let mut statesize: unsigned = crypto_lskcipher_statesize(tfm);
    let mut ivsize: unsigned = crypto_lskcipher_ivsize(tfm);
    let mut bs: unsigned = crypto_lskcipher_blocksize(tfm);
    let mut cs: unsigned = crypto_lskcipher_chunksize(tfm);
    int err;
    u8 *tiv;
    u8 *p;
    ...
    goto out;
    while (len >= bs) {
    let mut chunk: unsigned = min((unsigned)PAGE_SIZE, len);
    if (chunk > cs)
    chunk &= ~(cs - 1);
    memcpy(p, src, chunk);
...
#[no_mangle]
pub unsafe extern "C" fn crypto_lskcipher_encrypt_sg(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_lskcipher_decrypt_sg(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_lskcipher_exit_tfm(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn crypto_lskcipher_init_tfm(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_lskcipher_free_instance(inst: *mut crypto_instance) {
...
#[no_mangle]
unsafe extern "C" fn crypto_lskcipher_exit_tfm_sg(tfm: *mut crypto_tfm) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_init_lskcipher_ops_sg(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lskcipher_prepare_alg(alg: *mut lskcipher_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_register_lskcipher(alg: *mut lskcipher_alg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_unregister_lskcipher(alg: *mut lskcipher_alg) {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_register_lskciphers(algs: *mut lskcipher_alg, count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto_unregister_lskciphers(algs: *mut lskcipher_alg, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lskcipher_init_tfm_simple(tfm: *mut crypto_lskcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lskcipher_exit_tfm_simple(tfm: *mut crypto_lskcipher) {
...
#[no_mangle]
unsafe extern "C" fn lskcipher_free_instance_simple(inst: *mut lskcipher_instance) {
