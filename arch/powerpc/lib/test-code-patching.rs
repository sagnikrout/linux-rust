...
//! Source: arch/powerpc/lib/test-code-patching.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn instr_is_branch_to_addr(instr: *const u32, addr: c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn test_trampoline() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_branch_iform() -> void __init {
    ...
    u32 tmp[2];
    u32 *iptr = tmp;
    let mut addr: c_ulong = (unsigned long)tmp;
...
#[no_mangle]
unsafe extern "C" fn test_create_function_call() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_branch_bform() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_translate_branch() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_prefixed_patching() -> void __init {
    static void __init test_prefixed_patching(void)
    {
    u32 *iptr = (u32 *)ppc_function_entry(test_trampoline);
    u32 expected[2] = {OP_PREFIX << 26, 0};
    let mut inst: ppc_inst_t = ppc_inst_prefix(OP_PREFIX << 26, 0);
...
#[no_mangle]
unsafe extern "C" fn test_multi_instruction_patching() -> void __init {
    ...
    u32 *addr32;
    u64 *addr64;
    let mut inst64: ppc_inst_t = ppc_inst_prefix(OP_PREFIX << 26 | 3UL << 24, PPC_RAW_TRAP());
    let mut inst32: u32 = PPC_RAW_NOP();
...
#[no_mangle]
unsafe extern "C" fn test_data_patching() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_code_patching() -> int __init {
