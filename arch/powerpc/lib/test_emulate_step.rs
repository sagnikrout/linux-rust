...
//! Source: arch/powerpc/lib/test_emulate_step.c
#![no_std]
...
pub const MAX_SUBTESTS: c_int = 16;
    ...
    PPC_RAW_ADDI(t, a, i))
#[no_mangle]
unsafe extern "C" fn init_pt_regs(regs: *mut pt_regs) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn show_result(mnemonic: *mut c_char, result: *mut c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_ld() -> void __init {
    static void __init test_ld(void)
    {
    struct pt_regs regs;
    let mut a: c_ulong = 0x23;
    let mut stepped: c_int = -1;
    init_pt_regs(&regs);
...
#[no_mangle]
unsafe extern "C" fn test_pld() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lwz() -> void __init {
    static void __init test_lwz(void)
    {
    struct pt_regs regs;
    let mut a: c_uint = 0x4545;
    let mut stepped: c_int = -1;
    init_pt_regs(&regs);
    regs.gpr[3] = (unsigned long) &a;
// lwz r5, 0(r3)
...
#[no_mangle]
unsafe extern "C" fn test_plwz() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lwzx() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_std() -> void __init {
    static void __init test_std(void)
    {
    struct pt_regs regs;
    let mut a: c_ulong = 0x1234;
    let mut stepped: c_int = -1;
    init_pt_regs(&regs);
    regs.gpr[3] = (unsigned long) &a;
    regs.gpr[5] = 0x5678;
...
#[no_mangle]
unsafe extern "C" fn test_pstd() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_ldarx_stdcx() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lfsx_stfsx() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_plfs_pstfs() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lfdx_stfdx() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_plfd_pstfd() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lvx_stvx() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lxvd2x_stxvd2x() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lxvp_stxvp() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lxvpx_stxvpx() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_plxvp_pstxvp() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn run_tests_load_store() -> void __init {
...
pub struct compute_test {
    ...
    pub cpu_feature: c_ulong,
    struct {
    pub descr: *mut c_char,
    pub flags: c_ulong,
    pub instr: ppc_inst_t,
    pub regs: pt_regs,
    pub 1]: } subtests[MAX_SUBTESTS +,
}
...
// Patch the NOP with the actual instruction
    ...
    name, exp, got)
#[no_mangle]
unsafe extern "C" fn run_tests_compute() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_emulate_step() -> int __init {
