...
//! Source: arch/powerpc/lib/qspinlock.c
#![no_std]
...
pub struct qnode {
    ...
    pub cpu: c_int,
    pub or: *mut *mut u8 sleepy; / 1 if the previous vCPU was preempted,
// if the previous node was sleepy
    pub /: *mut *mut u8 locked; / 1 if lock acquired,
}
...
pub struct qnodes {
    pub count: c_int,
    pub nodes: [qnode; MAX_NODES],
}

// Tuning parameters
    let mut __read_mostly: static int steal_spins = (1 << 5);
    let mut __read_mostly: static int remote_steal_spins = (1 << 2);

    let mut maybe_stealers: static bool = true;

    let mut __read_mostly: static bool maybe_stealers = true;

    let mut __read_mostly: static int head_spins = (1 << 8);
    let mut __read_mostly: static bool pv_yield_owner = true;
    let mut __read_mostly: static bool pv_yield_allow_steal = false;
    let mut __read_mostly: static bool pv_spin_on_preempted_owner = false;
    let mut __read_mostly: static bool pv_sleepy_lock = true;
    let mut __read_mostly: static bool pv_sleepy_lock_sticky = false;
    let mut __read_mostly: static u64 pv_sleepy_lock_interval_ns = 0;
    let mut __read_mostly: static int pv_sleepy_lock_factor = 256;
    let mut __read_mostly: static bool pv_yield_prev = true;
    let mut __read_mostly: static bool pv_yield_sleepy_owner = true;
    let mut __read_mostly: static bool pv_prod_head = false;
    static DEFINE_PER_CPU_ALIGNED(struct qnodes, qnodes);
    static DEFINE_PER_CPU_ALIGNED(u64, sleepy_lock_seen_clock);

#[no_mangle]
unsafe extern "C" fn recently_sleepy() -> __always_inline bool {
    static __always_inline bool recently_sleepy(void)
    {
// pv_sleepy_lock is true when this is called
    if (pv_sleepy_lock_interval_ns) {
    let mut seen: u64 = this_cpu_read(sleepy_lock_seen_clock);
    if (seen) {
    let mut delta: u64 = sched_clock() - seen;
...
#[no_mangle]
unsafe extern "C" fn get_steal_spins(paravirt: bool, sleepy: bool) -> __always_inline int {
...
#[no_mangle]
unsafe extern "C" fn get_remote_steal_spins(paravirt: bool, sleepy: bool) -> __always_inline int {
...
#[no_mangle]
unsafe extern "C" fn get_head_spins(paravirt: bool, sleepy: bool) -> __always_inline int {
...
#[no_mangle]
pub unsafe extern "C" fn encode_tail_cpu(cpu: c_int) -> u32 {
    static inline u32 encode_tail_cpu(int cpu)
    {
    return (cpu + 1) << _Q_TAIL_CPU_OFFSET;
    }
#[no_mangle]
pub unsafe extern "C" fn decode_tail_cpu(val: u32) -> c_int {
    static inline int decode_tail_cpu(u32 val)
    {
    return (val >> _Q_TAIL_CPU_OFFSET) - 1;
    }
#[no_mangle]
pub unsafe extern "C" fn get_owner_cpu(val: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn trylock_clean_tail(lock: *mut qspinlock, tail: u32) -> __always_inline u32 {
    static __always_inline u32 trylock_clean_tail(struct qspinlock *lock, u32 tail)
    {
    let mut newval: u32 = queued_spin_encode_locked_val();
    u32 prev, tmp;
    asm volatile(
...
//
#[no_mangle]
unsafe extern "C" fn publish_tail_cpu(lock: *mut qspinlock, tail: u32) -> __always_inline u32 {
...
#[no_mangle]
unsafe extern "C" fn set_mustq(lock: *mut qspinlock) -> __always_inline u32 {
...
#[no_mangle]
unsafe extern "C" fn clear_mustq(lock: *mut qspinlock) -> __always_inline u32 {
...
#[no_mangle]
unsafe extern "C" fn try_set_sleepy(lock: *mut qspinlock, old: u32) -> __always_inline bool {
    static __always_inline bool try_set_sleepy(struct qspinlock *lock, u32 old)
    {
    u32 prev;
    let mut new: u32 = old | _Q_SLEEPY_VAL;
...
#[no_mangle]
unsafe extern "C" fn seen_sleepy_owner(lock: *mut qspinlock, val: u32) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn seen_sleepy_lock() -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn seen_sleepy_node() -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn __yield_to_locked_owner(lock: *mut qspinlock, val: u32, paravirt: bool, mustq: bool) -> __always_inline bool {
...
// Called inside spin_begin(). Returns whether or not the vCPU was preempted.
#[no_mangle]
unsafe extern "C" fn yield_to_locked_owner(lock: *mut qspinlock, val: u32, paravirt: bool) -> __always_inline bool {
...
// Called inside spin_begin(). Returns whether or not the vCPU was preempted.
#[no_mangle]
unsafe extern "C" fn yield_head_to_locked_owner(lock: *mut qspinlock, val: u32, paravirt: bool) -> __always_inline bool {
    static __always_inline bool yield_head_to_locked_owner(struct qspinlock *lock, u32 val, bool paravirt)
    {
    let mut mustq: bool = false;
    if ((val & _Q_MUST_Q_VAL) && pv_yield_allow_steal)
    mustq = true;
    return __yield_to_locked_owner(lock, val, paravirt, mustq);
    }
#[no_mangle]
unsafe extern "C" fn propagate_sleepy(node: *mut qnode, val: u32, paravirt: bool) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn yield_to_prev(lock: *mut qspinlock, node: *mut qnode, prev_cpu: c_int, paravirt: bool) -> __always_inline bool {
...
//
    ...
    let mut val: u32 = READ_ONCE(lock.val);
...
#[no_mangle]
unsafe extern "C" fn steal_break(val: u32, iters: c_int, paravirt: bool, sleepy: bool) -> __always_inline bool {
    ...
    let mut cpu: c_int = get_owner_cpu(val);
...
#[no_mangle]
unsafe extern "C" fn try_to_steal_lock(lock: *mut qspinlock, paravirt: bool) -> __always_inline bool {
    static __always_inline bool try_to_steal_lock(struct qspinlock *lock, bool paravirt)
    {
    let mut seen_preempted: bool = false;
    let mut sleepy: bool = false;
...
#[no_mangle]
unsafe extern "C" fn queued_spin_lock_mcs_queue(lock: *mut qspinlock, paravirt: bool) -> __always_inline void {
...
//
    ...
    let mut prev_cpu: c_int = decode_tail_cpu(old);
...
//
    ...
    let mut next_cpu: c_int = next.cpu;
...
//
    node.lock = core::ptr::null_mut();
    barrier();
    qnodesp.count--;
    }
#[no_mangle]
pub unsafe extern "C" fn queued_spin_lock_slowpath(lock: *mut qspinlock) -> void __lockfunc {
...
#[no_mangle]
pub unsafe extern "C" fn pv_spinlocks_init() {
    void pv_spinlocks_init(void)
    {
    }

#[no_mangle]
unsafe extern "C" fn steal_spins_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn steal_spins_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remote_steal_spins_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remote_steal_spins_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn head_spins_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn head_spins_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_yield_owner_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_yield_owner_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_yield_allow_steal_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_yield_allow_steal_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_spin_on_preempted_owner_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_spin_on_preempted_owner_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_sleepy_lock_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_sleepy_lock_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_sleepy_lock_sticky_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_sleepy_lock_sticky_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_sleepy_lock_interval_ns_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_sleepy_lock_interval_ns_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_sleepy_lock_factor_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_sleepy_lock_factor_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_yield_prev_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_yield_prev_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_yield_sleepy_owner_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_yield_sleepy_owner_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_prod_head_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pv_prod_head_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spinlock_debugfs_init() -> __init int {
    static __init int spinlock_debugfs_init(void)
    {
    debugfs_create_file("qspl_steal_spins", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_steal_spins);
    debugfs_create_file("qspl_remote_steal_spins", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_remote_steal_spins);
    debugfs_create_file("qspl_head_spins", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_head_spins);
    if (is_shared_processor()) {
    debugfs_create_file("qspl_pv_yield_owner", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_yield_owner);
    debugfs_create_file("qspl_pv_yield_allow_steal", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_yield_allow_steal);
    debugfs_create_file("qspl_pv_spin_on_preempted_owner", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_spin_on_preempted_owner);
    debugfs_create_file("qspl_pv_sleepy_lock", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_sleepy_lock);
    debugfs_create_file("qspl_pv_sleepy_lock_sticky", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_sleepy_lock_sticky);
    debugfs_create_file("qspl_pv_sleepy_lock_interval_ns", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_sleepy_lock_interval_ns);
    debugfs_create_file("qspl_pv_sleepy_lock_factor", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_sleepy_lock_factor);
    debugfs_create_file("qspl_pv_yield_prev", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_yield_prev);
    debugfs_create_file("qspl_pv_yield_sleepy_owner", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_yield_sleepy_owner);
    debugfs_create_file("qspl_pv_prod_head", 0600, arch_debugfs_dir, core::ptr::null_mut(), &fops_pv_prod_head);
    }
    return 0;
    }
