...
//! Source: arch/powerpc/lib/feature-fixups.c
#![no_std]
...
pub struct fixup_entry {
    pub mask: c_ulong,
    pub value: c_ulong,
    pub start_off: c_long,
    pub end_off: c_long,
    pub alt_start_off: c_long,
    pub alt_end_off: c_long,
}
...
#[no_mangle]
unsafe extern "C" fn patch_alt_instruction(src: *mut u32, dest: *mut u32, alt_start: *mut u32, alt_end: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_feature_fixups(value: c_ulong, fixup_start: *mut c_void, fixup_end: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn is_fixup_addr_valid(dest: *mut c_void, size: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn do_patch_fixups(start: *mut c_long, end: *mut c_long, instrs: *mut c_uint, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_stf_entry_barrier_fixups(types: enum stf_barrier_type) {
...
#[no_mangle]
unsafe extern "C" fn do_stf_exit_barrier_fixups(types: enum stf_barrier_type) {
    ...
    let mut stf_exit_reentrant: static bool = false;
    let mut rfi_exit_reentrant: static bool = false;
    static DEFINE_MUTEX(exit_flush_lock);
#[no_mangle]
unsafe extern "C" fn __do_stf_barrier_fixups(data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_stf_barrier_fixups(types: enum stf_barrier_type) {
...
// Prevent static key update races with do_rfi_flush_fixups()
    ...
    stop_machine(__do_stf_barrier_fixups, &types, core::ptr::null_mut());
    if ((types & STF_BARRIER_FALLBACK) || (types & STF_BARRIER_SYNC_ORI))
...
#[no_mangle]
pub unsafe extern "C" fn do_uaccess_flush_fixups(types: enum l1d_flush_type) {
...
#[no_mangle]
unsafe extern "C" fn __do_entry_flush_fixups(data: *mut c_void) -> c_int {
    static int __do_entry_flush_fixups(void *data)
    {
    let mut types: enum l1d_flush_type = *(enum l1d_flush_type *)data;
    unsigned int instrs[3];
    long *start, *end;
    int i;
    instrs[0] = PPC_RAW_NOP();
...
#[no_mangle]
pub unsafe extern "C" fn do_entry_flush_fixups(types: enum l1d_flush_type) {
...
// hard disabled.
//
    stop_machine(__do_entry_flush_fixups, &types, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn __do_rfi_flush_fixups(data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_rfi_flush_fixups(types: enum l1d_flush_type) {
...
// Prevent static key update races with do_stf_barrier_fixups()
    mutex_lock(&exit_flush_lock);
    static_branch_enable(&interrupt_exit_not_reentrant);
    stop_machine(__do_rfi_flush_fixups, &types, core::ptr::null_mut());
    if (types & L1D_FLUSH_FALLBACK)
...
#[no_mangle]
pub unsafe extern "C" fn do_barrier_nospec_fixups_range(enable: bool, fixup_start: *mut c_void, fixup_end: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn do_barrier_nospec_fixups(enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn patch_btb_flush_section(curr: *mut c_long) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn do_btb_flush_fixups() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn do_lwsync_fixups(value: c_ulong, fixup_start: *mut c_void, fixup_end: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn do_final_fixups() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn apply_feature_fixups() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn update_mmu_feature_fixups(mask: c_ulong) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_feature_keys() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn check_features() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn patch_feature_section(value: c_ulong, fcur: *mut fixup_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_offset(entry: *mut fixup_entry, p: *mut c_uint) -> long __init {
    static long __init calc_offset(struct fixup_entry *entry, unsigned int *p)
    {
    return (unsigned long)p - (unsigned long)entry;
    }
#[no_mangle]
unsafe extern "C" fn test_basic_patching() -> void __init {
    ...
    let mut size: c_int = 4 * (end_ftr_fixup_test1 - ftr_fixup_test1);
...
#[no_mangle]
unsafe extern "C" fn test_alternative_patching() -> void __init {
    ...
    let mut size: c_int = 4 * (end_ftr_fixup_test2 - ftr_fixup_test2);
...
#[no_mangle]
unsafe extern "C" fn test_alternative_case_too_big() -> void __init {
    ...
    let mut size: c_int = 4 * (end_ftr_fixup_test3 - ftr_fixup_test3);
...
#[no_mangle]
unsafe extern "C" fn test_alternative_case_too_small() -> void __init {
    ...
    let mut size: c_int = 4 * (end_ftr_fixup_test4 - ftr_fixup_test4);
    unsigned long flag;
...
#[no_mangle]
unsafe extern "C" fn test_alternative_case_with_branch() {
    static void test_alternative_case_with_branch(void)
    {
    extern unsigned int ftr_fixup_test5[];
    extern unsigned int end_ftr_fixup_test5[];
    extern unsigned int ftr_fixup_test5_expected[];
    let mut size: c_int = 4 * (end_ftr_fixup_test5 - ftr_fixup_test5);
    check(memcmp(ftr_fixup_test5, ftr_fixup_test5_expected, size) == 0);
    }
#[no_mangle]
unsafe extern "C" fn test_alternative_case_with_external_branch() -> void __init {
    static void __init test_alternative_case_with_external_branch(void)
    {
    extern unsigned int ftr_fixup_test6[];
    extern unsigned int end_ftr_fixup_test6[];
    extern unsigned int ftr_fixup_test6_expected[];
    let mut size: c_int = 4 * (end_ftr_fixup_test6 - ftr_fixup_test6);
    check(memcmp(ftr_fixup_test6, ftr_fixup_test6_expected, size) == 0);
    }
#[no_mangle]
unsafe extern "C" fn test_alternative_case_with_branch_to_end() -> void __init {
    ...
    let mut size: c_int = 4 * (end_ftr_fixup_test7 - ftr_fixup_test7);
    check(memcmp(ftr_fixup_test7, ftr_fixup_test7_expected, size) == 0);
    }
#[no_mangle]
unsafe extern "C" fn test_cpu_macros() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_fw_macros() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_lwsync_macros() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn test_prefix_patching() -> void __init {
    ...
    let mut size: c_int = sizeof(unsigned int) * (end_ftr_fixup_prefix1 - ftr_fixup_prefix1);
    fixup.value = fixup.mask = 8;
...
#[no_mangle]
unsafe extern "C" fn test_prefix_alt_patching() -> void __init {
    ...
    let mut size: c_int = sizeof(unsigned int) * (end_ftr_fixup_prefix2 - ftr_fixup_prefix2);
    fixup.value = fixup.mask = 8;
...
#[no_mangle]
unsafe extern "C" fn test_prefix_word_alt_patching() -> void __init {
    ...
    let mut size: c_int = sizeof(unsigned int) * (end_ftr_fixup_prefix3 - ftr_fixup_prefix3);
    fixup.value = fixup.mask = 8;
...
#[no_mangle]
unsafe extern "C" fn test_feature_fixups() -> int __init {
