...
//! Source: arch/powerpc/crypto/aes-gcm-p10-glue.c
#![no_std]
...
pub struct gcm_ctx {
    ...
    pub aad_hash: [u8; 16],
    pub aadLen: u64,
    pub /: *mut *mut u64 Plen; / offset 56 - used in aes_p10_gcm_{en/de}crypt,
    pub pblock: [u8; 16],
}
...
#[derive(Copy, Clone)]
pub struct Hash_ctx {
    pub /: *mut *mut u8 H[16]; / subkey,
    pub /: *mut *mut u8 Htable[256]; / Xi, Hash table(offset 32),
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct p10_aes_gcm_ctx {
    pub enc_key: p10_aes_key,
    pub nonce: [u8; RFC4106_NONCE_SIZE],
}

#[no_mangle]
unsafe extern "C" fn vsx_begin() {
...
#[no_mangle]
unsafe extern "C" fn set_subkey(hash: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn finish_tag(gctx: *mut gcm_ctx, hash: *mut Hash_ctx, len: c_int) {
    ...
    let mut clen: __be64 = cpu_to_be64(len << 3);
    let mut alen: __be64 = cpu_to_be64(gctx.aadLen << 3);
...
#[no_mangle]
unsafe extern "C" fn set_authsize(tfm: *mut crypto_aead, authsize: c_uint) -> c_int {
    ...
    u8 *assocmem = core::ptr::null_mut();
    u8 *assoc;
    let mut cryptlen: c_uint = req.cryptlen;
    unsigned char ivbuf[AES_BLOCK_SIZE+PPC_ALIGN];
    unsigned char *iv = PTR_ALIGN((void *)ivbuf, PPC_ALIGN);
    int ret;
    let mut auth_tag_len: c_ulong = crypto_aead_authsize(__crypto_aead_cast(tfm));
    u8 otag[16];
    let mut total_processed: c_int = 0;
    int nbytes;
...
#[no_mangle]
unsafe extern "C" fn p10_aes_gcm_encrypt(req: *mut aead_request) -> c_int {
    static int p10_aes_gcm_encrypt(struct aead_request *req)
    {
    return p10_aes_gcm_crypt(req, req.iv, req.assoclen, 1);
    }
#[no_mangle]
unsafe extern "C" fn p10_aes_gcm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p10_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn p10_exit() -> void __exit {
