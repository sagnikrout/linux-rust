...
//! Source: arch/powerpc/crypto/aes_ctr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn p8_aes_ctr_init(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p8_aes_ctr_exit(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn p8_aes_ctr_crypt(req: *mut skcipher_request) -> c_int {
