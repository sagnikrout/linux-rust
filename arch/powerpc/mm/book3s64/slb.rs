...
//! Source: arch/powerpc/mm/book3s64/slb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn parse_stress_slb(p: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_no_slb_preload(p: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn assert_slb_presence(present: bool, ea: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn slb_shadow_clear(index: enum slb_index) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __slb_restore_bolted_realmode() {
...
//
#[no_mangle]
pub unsafe extern "C" fn slb_restore_bolted_realmode() {
...
//
#[no_mangle]
pub unsafe extern "C" fn slb_flush_all_realmode() {
    void slb_flush_all_realmode(void)
    {
    asm volatile("slbmte %0,%0; slbia" : : "r" (0));
    }
#[no_mangle]
unsafe extern "C" fn __slb_flush_and_restore_bolted(preserve_kernel_lookaside: bool) -> __always_inline void {
...
//
#[no_mangle]
pub unsafe extern "C" fn slb_flush_and_restore_bolted() {
...
#[no_mangle]
pub unsafe extern "C" fn slb_save_contents(slb_ptr: *mut slb_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn slb_dump_contents(slb_ptr: *mut slb_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn slb_vmalloc_update() {
...
#[no_mangle]
unsafe extern "C" fn preload_hit(ti: *mut thread_info, esid: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn preload_add(ti: *mut thread_info, ea: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn preload_age(ti: *mut thread_info) {
...
#[no_mangle]
unsafe extern "C" fn slb_cache_slbie_kernel(index: c_uint) {
    static void slb_cache_slbie_kernel(unsigned int index)
    {
    let mut slbie_data: c_ulong = get_paca().slb_cache[index];
    let mut ksp: c_ulong = get_paca().kstack;
...
#[no_mangle]
unsafe extern "C" fn slb_cache_slbie_user(index: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn switch_slb(tsk: *mut task_struct, mm: *mut mm_struct) {
...
//
    ...
    let mut offset: c_ulong = get_paca().slb_cache_ptr;
...
//
    ...
    let mut pc: c_ulong = KSTK_EIP(tsk);
    preload_age(ti);
    preload_add(ti, pc);
    }
    for (i = 0; i < ti.slb_preload_nr; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn slb_set_size(size: u16) {
    void slb_set_size(u16 size)
    {
    mmu_slb_size = size;
    }
#[no_mangle]
pub unsafe extern "C" fn slb_initialize() {
...
#[no_mangle]
unsafe extern "C" fn slb_cache_update(esid_data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn alloc_slb_index(kernel: bool) -> enum slb_index {
...
//
    assert_slb_presence(false, ea);
    if (stress_slb()) {
    let mut slb_cache_index: c_int = local_paca.slb_cache_ptr;
//
...
#[no_mangle]
unsafe extern "C" fn slb_allocate_kernel(ea: c_ulong, id: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn slb_allocate_user(mm: *mut mm_struct, ea: c_ulong) -> c_long {
    static long slb_allocate_user(struct mm_struct *mm, unsigned long ea)
    {
    unsigned long context;
    unsigned long flags;
...
//
    ...
    let mut id: c_ulong = get_region_id(ea);
