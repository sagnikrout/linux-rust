...
//! Source: arch/powerpc/mm/book3s64/hash_pgtable.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hash__map_kernel_page(ea: c_ulong, pa: c_ulong, prot: pgprot_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_nothing(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn serialize_against_pte_lookup(mm: *mut mm_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hash__pgtable_trans_huge_withdraw(mm: *mut mm_struct, pmdp: *mut pmd_t) -> pgtable_t {
...
#[no_mangle]
pub unsafe extern "C" fn hash__has_transparent_hugepage() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct change_memory_parms {
    pub newpp: unsigned long start, end,,
    pub nr_cpus: unsigned int step,,
    pub master_cpu: core::sync::atomic::AtomicI32,
    pub cpu_counter: core::sync::atomic::AtomicI32,
}
...
#[no_mangle]
unsafe extern "C" fn chmem_secondary_loop(parms: *mut change_memory_parms) -> int notrace {
...
#[no_mangle]
unsafe extern "C" fn change_memory_range_fn(data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hash__mark_rodata_ro() {
...
#[no_mangle]
pub unsafe extern "C" fn hash__mark_initmem_nx() {
