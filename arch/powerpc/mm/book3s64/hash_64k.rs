...
//! Source: arch/powerpc/mm/book3s64/hash_64k.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hpte_soft_invalid(hidx: c_ulong) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn __rpte_sub_valid(rpte: real_pte_t, index: c_ulong) -> bool {
    ...
    let mut shift: c_ulong = mmu_psize_defs[MMU_PAGE_4K].shift;
//
// atomically mark the linux large page PTE busy and dirty
//
    do {
    let mut pte: pte_t = READ_ONCE(*ptep);
    old_pte = pte_val(pte);
...
// ptep = __pte(new_pte & ~H_PAGE_BUSY);
    ...
    let mut shift: c_ulong = mmu_psize_defs[MMU_PAGE_64K].shift;
//
// atomically mark the linux large page PTE busy and dirty
//
    do {
