...
//! Source: arch/powerpc/mm/book3s64/pgtable.c
#![no_std]
...
//
    ...
    let mut mmu_vmemmap_psize: c_int = MMU_PAGE_4K;
...
//
    ...
    {
    pmd_t pmd;
    let mut was_present: bool = pmd_present(*pmdp);
...
#[no_mangle]
unsafe extern "C" fn pmd_set_protbits(pmd: pmd_t, pgprot: pgprot_t) -> pmd_t {
    static pmd_t pmd_set_protbits(pmd_t pmd, pgprot_t pgprot)
    {
    return __pmd(pmd_val(pmd) | pgprot_val(pgprot));
    }
#[no_mangle]
unsafe extern "C" fn pud_set_protbits(pud: pud_t, pgprot: pgprot_t) -> pud_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn pfn_pmd(pfn: c_ulong, pgprot: pgprot_t) -> pmd_t {
...
#[no_mangle]
pub unsafe extern "C" fn pfn_pud(pfn: c_ulong, pgprot: pgprot_t) -> pud_t {
...
#[no_mangle]
pub unsafe extern "C" fn pmd_modify(pmd: pmd_t, newprot: pgprot_t) -> pmd_t {
...
#[no_mangle]
pub unsafe extern "C" fn pud_modify(pud: pud_t, newprot: pgprot_t) -> pud_t {
...
#[no_mangle]
pub unsafe extern "C" fn mmu_cleanup_all() -> notrace void {
    notrace void mmu_cleanup_all(void)
    {
    if (radix_enabled())
    radix__mmu_cleanup_all();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mmu_hash_ops.hpte_clear_all) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn remove_section_mapping(start: c_ulong, end: c_ulong) -> int __meminit {
...
#[no_mangle]
pub unsafe extern "C" fn mmu_partition_table_init() -> void __init {
    void __init mmu_partition_table_init(void)
    {
    let mut patb_size: c_ulong = 1UL << PATB_SIZE_SHIFT;
    unsigned long ptcr;
...
#[no_mangle]
unsafe extern "C" fn flush_partition(lpid: c_uint, radix: bool) {
...
// do we need fixup here ?
    ...
    {
    let mut old: c_ulong = be64_to_cpu(partition_tb[lpid].patb0);
//
...
//
    ...
    let mut gfp: gfp_t = GFP_KERNEL_ACCOUNT | __GFP_ZERO;
    if (mm == &init_mm)
    gfp &= ~__GFP_ACCOUNT;
...
#[no_mangle]
pub unsafe extern "C" fn pmd_fragment_free(pmd: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn pgtable_free(table: *mut c_void, index: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn pgtable_free_tlb(tlb: *mut mmu_gather, table: *mut c_void, index: c_int) {
    void pgtable_free_tlb(struct mmu_gather *tlb, void *table, int index)
    {
    let mut pgf: c_ulong = (unsigned long)table;
    BUG_ON(index > MAX_PGTABLE_INDEX_SIZE);
    pgf |= index;
    tlb_remove_table(tlb, (void *)pgf);
    }
#[no_mangle]
pub unsafe extern "C" fn __tlb_remove_table(_table: *mut c_void) {
    void __tlb_remove_table(void *_table)
    {
    void *table = (void *)((unsigned long)_table & ~MAX_PGTABLE_INDEX_SIZE);
    let mut index: c_uint = (unsigned long)_table & MAX_PGTABLE_INDEX_SIZE;
...
//
    let mut __read_mostly: bool tlbie_capable = IS_ENABLED(CONFIG_PPC_RADIX_BROADCAST_TLBIE);
...
//
    let mut __read_mostly: bool tlbie_enabled = IS_ENABLED(CONFIG_PPC_RADIX_BROADCAST_TLBIE);
#[no_mangle]
unsafe extern "C" fn setup_disable_tlbie(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pgtable_debugfs_setup() -> int __init {
...
pub unsafe extern "C" fn memremap_compat_align() -> c_ulong {
    ...
    {
    if (!radix_enabled()) {
    let mut shift: c_uint = mmu_psize_defs[mmu_linear_psize].shift;
