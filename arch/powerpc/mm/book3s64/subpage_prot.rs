...
//! Source: arch/powerpc/mm/book3s64/subpage_prot.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn subpage_prot_free(mm: *mut mm_struct) {
    ...
    if (!p)
    continue;
    spt.protptrs[i] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn subpage_prot_clear(addr: c_ulong, len: c_ulong) {
...
//
    ...
    walk_page_vma(vma, &subpage_walk_ops, core::ptr::null_mut());
    }
    }
