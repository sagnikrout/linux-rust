...
//! Source: arch/powerpc/mm/nohash/kaslr_booke.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kaslr_get_cmdline(fdt: *mut c_void) -> __init void {
...
//
#[no_mangle]
unsafe extern "C" fn get_boot_seed(fdt: *mut c_void) -> unsigned long __init {
...
#[no_mangle]
unsafe extern "C" fn get_kaslr_seed(fdt: *mut c_void) -> __init u64 {
...
#[no_mangle]
unsafe extern "C" fn regions_overlap(s1: u32, e1: u32, s2: u32, e2: u32) -> __init bool {
...
#[no_mangle]
unsafe extern "C" fn get_crash_kernel(fdt: *mut c_void, size: c_ulong) -> void __init {
    ...
    &crash_base, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn get_initrd_range(fdt: *mut c_void) -> void __init {
...
pub unsafe extern "C" fn kaslr_disabled() -> __init bool {
    ...
    {
    return strstr(boot_command_line, "nokaslr") != core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn kaslr_early_init(dt_ptr: *mut c_void, size: phys_addr_t) -> notrace void __init {
...
#[no_mangle]
pub unsafe extern "C" fn kaslr_late_init() -> void __init {
