...
//! Source: arch/powerpc/mm/nohash/book3e_pgtable.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn map_kernel_page(ea: c_ulong, pa: phys_addr_t, prot: pgprot_t) -> int __ref {
...
#[no_mangle]
pub unsafe extern "C" fn __patch_exception(exc: c_int, addr: c_ulong) {
