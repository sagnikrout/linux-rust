...
//! Source: arch/powerpc/mm/nohash/44x.c
#![no_std]
...
//
    ...
    let mut tlb_44x_hwater: c_uint = PPC44x_TLB_SIZE - 1 - PPC44x_EARLY_TLBS;
    int icache_44x_need_flush;
    unsigned long tlb_47x_boltmap[1024/8];
#[no_mangle]
unsafe extern "C" fn ppc44x_update_tlb_hwater() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn ppc44x_pin_tlb(virt: c_uint, phys: c_uint) -> void __init {
    static void __init ppc44x_pin_tlb(unsigned int virt, unsigned int phys)
    {
    let mut entry: c_uint = tlb_44x_hwater--;
...
#[no_mangle]
unsafe extern "C" fn ppc47x_find_free_bolted() -> int __init {
    static int __init ppc47x_find_free_bolted(void)
    {
    let mut mmube0: c_uint = mfspr(SPRN_MMUBE0);
    let mut mmube1: c_uint = mfspr(SPRN_MMUBE1);
...
#[no_mangle]
unsafe extern "C" fn ppc47x_update_boltmap() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn ppc47x_pin_tlb(virt: c_uint, phys: c_uint) -> void __init {
...
pub unsafe extern "C" fn mmu_mapin_ram(base: c_ulong, top: c_ulong) -> unsigned long __init {
    ...
    {
    unsigned long addr;
    let mut memstart: c_ulong = memstart_addr & ~(PPC_PIN_SIZE - 1);
...
#[no_mangle]
pub unsafe extern "C" fn mmu_init_secondary(cpu: c_int) -> void __init {
