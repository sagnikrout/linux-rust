...
//! Source: arch/powerpc/mm/pgtable.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn is_exec_fault() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pte_looks_normal(pte: pte_t, addr: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_pte_filter_hash(pte: pte_t, addr: c_ulong) -> pte_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_pte_filter(pte: pte_t, addr: c_ulong) -> pte_t {
...
#[no_mangle]
pub unsafe extern "C" fn unmap_kernel_page(va: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn __set_huge_pte_at(pmd: *mut pmd_t, ptep: *mut pte_t, val: pte_basic_t) {
...
pub unsafe extern "C" fn if(P4D_SIZE: sz <) -> else {
    ...
    pdsize = PUD_SIZE;
#[no_mangle]
pub unsafe extern "C" fn if(PGDIR_SIZE: sz <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn assert_pte_locked(mm: *mut mm_struct, addr: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn vmalloc_to_phys(va: *mut c_void) -> c_ulong {
    unsigned long vmalloc_to_phys(void *va)
    {
    let mut pfn: c_ulong = vmalloc_to_pfn(va);
    BUG_ON(!pfn);
