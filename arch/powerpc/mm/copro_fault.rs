...
//! Source: arch/powerpc/mm/copro_fault.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn copro_calculate_slb(mm: *mut mm_struct, ea: u64, slb: *mut copro_slb) -> c_int {
