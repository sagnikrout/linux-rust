...
//! Source: arch/powerpc/kvm/book3s_hv_nestedv2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gs_msg_ops_vcpu_get_size(gsm: *mut kvmppc_gs_msg) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpu_has_feature(CPU_FTR_ARCH_31)) -> else {
    else if (cpu_has_feature(CPU_FTR_ARCH_31))
    arch_compat = PVR_ARCH_31;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpu_has_feature(CPU_FTR_ARCH_300)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn __kvmhv_nestedv2_mark_dirty(vcpu: *mut kvm_vcpu, iden: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __kvmhv_nestedv2_cached_reload(vcpu: *mut kvm_vcpu, iden: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_nestedv2_flush_vcpu(vcpu: *mut kvm_vcpu, time_limit: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_nestedv2_set_ptbl_entry(lpid: c_ulong, dw0: u64, dw1: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_nestedv2_set_vpa(vcpu: *mut kvm_vcpu, vpa: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_nestedv2_parse_output(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __kvmhv_nestedv2_reload_ptregs(vcpu: *mut kvm_vcpu, regs: *mut pt_regs) -> c_int {
