...
//! Source: arch/powerpc/kvm/test-guest-state-buffer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn test_creating_buffer(test: *mut kunit) {
    static void test_creating_buffer(struct kunit *test)
    {
    struct kvmppc_gs_buff *gsb;
    let mut size: usize = 0x100;
...
#[no_mangle]
unsafe extern "C" fn test_adding_element(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_gs_parsing(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_gs_bitmap(test: *mut kunit) {
    static void test_gs_bitmap(struct kunit *test)
    {
    let mut gsbm: kvmppc_gs_bitmap = { 0 };
    let mut gsbm1: kvmppc_gs_bitmap = { 0 };
    let mut gsbm2: kvmppc_gs_bitmap = { 0 };
    u16 iden;
    int i, j;
    i = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvmppc_gs_msg_test1_data {
    pub a: u64,
    pub b: u32,
    pub c: kvmppc_gs_part_table,
    pub d: kvmppc_gs_proc_table,
    pub e: kvmppc_gs_buff_info,
}

#[no_mangle]
unsafe extern "C" fn test1_get_size(gsm: *mut kvmppc_gs_msg) -> usize {
...
#[no_mangle]
unsafe extern "C" fn test_gs_msg(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvmppc_gs_msg_test_hostwide_data {
    pub guest_heap: u64,
    pub guest_heap_max: u64,
    pub guest_pgtable_size: u64,
    pub guest_pgtable_size_max: u64,
    pub guest_pgtable_reclaim: u64,
}

#[no_mangle]
unsafe extern "C" fn test_hostwide_get_size(gsm: *mut kvmppc_gs_msg) -> usize {
...
#[no_mangle]
unsafe extern "C" fn test_gs_hostwide_msg(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_gs_hostwide_counters(test: *mut kunit) {
