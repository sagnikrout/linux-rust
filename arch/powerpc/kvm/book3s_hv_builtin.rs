...
//! Source: arch/powerpc/kvm/book3s_hv_builtin.c
#![no_std]
...
pub const KVM_CMA_CHUNK_ORDER: c_int = 18;
...
//
    let mut kvm_cma_resv_ratio: static unsigned long = 5;
    static struct cma *kvm_cma;
#[no_mangle]
unsafe extern "C" fn early_parse_kvm_cma_resv(p: *mut c_char) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_cma_reserve() -> void __init {
...
//
    ...
    let mut ptid: c_int = local_paca.kvm_hstate.ptid;
    int threads_running;
    int threads_ceded;
    int threads_conferring;
    let mut stop: u64 = get_tb() + 10 * tb_ticks_per_usec;
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_hcall_impl_hv_realmode(cmd: c_ulong) -> c_int {
...
pub unsafe extern "C" fn kvmppc_hwrng_present() -> c_int {
    ...
    {
    return ppc_md.get_random_seed != core::ptr::null_mut();
    }
...
pub unsafe extern "C" fn kvmhv_rm_send_ipi(cpu: c_int) {
    ...
    let mut msg: c_ulong = PPC_DBELL_TYPE(PPC_DBELL_SERVER);
...
//
#[no_mangle]
unsafe extern "C" fn kvmhv_interrupt_vcore(vc: *mut kvmppc_vcore, active: c_int) {
    static void kvmhv_interrupt_vcore(struct kvmppc_vcore *vc, int active)
    {
    let mut cpu: c_int = vc.pcpu;
...
//
#[no_mangle]
unsafe extern "C" fn kvmppc_check_passthru(xisr: u32, xirr: __be32, again: *mut bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_check_passthru(xisr: u32, xirr: __be32, again: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_read_one_intr(again: *mut bool) -> c_long {
    static long kvmppc_read_one_intr(bool *again)
    {
    void __iomem *xics_phys;
    u32 h_xirr;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_end_cede(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_set_msr_hv(vcpu: *mut kvm_vcpu, msr: u64) {
...
#[no_mangle]
unsafe extern "C" fn inject_interrupt(vcpu: *mut kvm_vcpu, vec: c_int, srr1_flags: u64) {
...
// Insert EXTERNAL bit into LPCR at the MER bit position
    ...
    let mut dec: long int = mfspr(SPRN_DEC);
    if (!(lpcr & LPCR_LD))
    dec = (int) dec;
    if (dec < 0)
