...
//! Source: arch/powerpc/kvm/book3s_hv_p9_entry.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn store_spr_state(vcpu: *mut kvm_vcpu) {
...
// Returns true if current MSR and/or guest MSR may have changed
    ...
    let mut guest_msr: c_ulong = vcpu.arch.shregs.msr;
...
#[no_mangle]
pub unsafe extern "C" fn store_vcpu_state(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_p9_host_os_sprs(host_os_sprs: *mut p9_host_os_sprs) {
...
#[no_mangle]
pub unsafe extern "C" fn accumulate_time(vcpu: *mut kvm_vcpu, next: *mut kvmhv_tb_accumulator) {
    void accumulate_time(struct kvm_vcpu *vcpu, struct kvmhv_tb_accumulator *next)
    {
    struct kvmppc_vcore *vc = vcpu.arch.vcore;
    struct kvmhv_tb_accumulator *curr;
    let mut tb: u64 = mftb() - vc.tb_offset_applied;
    u64 prev_tb;
    u64 delta;
    u64 seq;
...
#[no_mangle]
pub unsafe extern "C" fn mfslbv(idx: c_uint) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn mfslbe(idx: c_uint) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn mtslb(slbee: u64, slbev: u64) {
    static inline void mtslb(u64 slbee, u64 slbev)
    {
    asm volatile("slbmte %0,%1" :: "r" (slbev), "r" (slbee));
    }
#[no_mangle]
pub unsafe extern "C" fn clear_slb_entry(idx: c_uint) {
    static inline void clear_slb_entry(unsigned int idx)
    {
    mtslb(idx, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn slb_clear_invalidate_partition() {
...
//
#[no_mangle]
unsafe extern "C" fn radix_clear_slb() {
...
#[no_mangle]
unsafe extern "C" fn switch_mmu_to_guest_radix(kvm: *mut kvm, vcpu: *mut kvm_vcpu, lpcr: u64) {
...
#[no_mangle]
unsafe extern "C" fn switch_mmu_to_guest_hpt(kvm: *mut kvm, vcpu: *mut kvm_vcpu, lpcr: u64) {
...
#[no_mangle]
unsafe extern "C" fn switch_mmu_to_host(kvm: *mut kvm, pid: u32) {
    static void switch_mmu_to_host(struct kvm *kvm, u32 pid)
    {
    let mut lpid: u32 = kvm.arch.host_lpid;
    let mut lpcr: u64 = kvm.arch.host_lpcr;
//
...
#[no_mangle]
unsafe extern "C" fn save_clear_host_mmu(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn save_clear_guest_mmu(kvm: *mut kvm, vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn flush_guest_tlb(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_msr_hard_disable_set_facilities(vcpu: *mut kvm_vcpu, msr: c_ulong) -> c_ulong {
    unsigned long kvmppc_msr_hard_disable_set_facilities(struct kvm_vcpu *vcpu, unsigned long msr)
    {
    let mut msr_needed: c_ulong = 0;
    msr &= ~MSR_EE;
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_vcpu_entry_p9(vcpu: *mut kvm_vcpu, time_limit: u64, lpcr: c_ulong, tb: *mut u64) -> c_int {
...
// Save MSR for restore, with EE clear.
    ...
    if (vc.tb_offset) {
    let mut new_tb: u64 = *tb + vc.tb_offset;
...
#[no_mangle]
pub unsafe extern "C" fn if(BOOK3S_INTERRUPT_SYSTEM_RESET: trap ==) -> else {
...
// tb = mftb();
    ...
    let mut new_tb: u64 = *tb - vc.tb_offset_applied;
    mtspr(SPRN_TBU40, new_tb);
    if ((mftb() & 0xffffff) < (new_tb & 0xffffff)) {
    new_tb += 0x1000000;
    mtspr(SPRN_TBU40, new_tb);
