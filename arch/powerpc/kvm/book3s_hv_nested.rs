...
//! Source: arch/powerpc/kvm/book3s_hv_nested.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_save_hv_regs(vcpu: *mut kvm_vcpu, hr: *mut hv_guest_state) {
...
#[no_mangle]
unsafe extern "C" fn byteswap_pt_regs(regs: *mut pt_regs) -> noinline_for_stack void {
...
#[no_mangle]
unsafe extern "C" fn byteswap_hv_regs(hr: *mut hv_guest_state) {
...
#[no_mangle]
unsafe extern "C" fn restore_hv_regs(vcpu: *mut kvm_vcpu, hr: *const hv_guest_state) {
...
#[no_mangle]
unsafe extern "C" fn kvmhv_nested_mmio_needed(vcpu: *mut kvm_vcpu, regs_ptr: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_enter_nested_guest(vcpu: *mut kvm_vcpu) -> c_long {
    long kvmhv_enter_nested_guest(struct kvm_vcpu *vcpu)
    {
    long int err, r;
    struct kvm_nested_guest *l2;
    struct pt_regs l2_regs, saved_l1_regs;
    let mut l2_hv: hv_guest_state = {0}, saved_l1_hv;
    struct kvmppc_vcore *vc = vcpu.arch.vcore;
    u64 hv_ptr, regs_ptr;
    u64 hdec_exp, lpcr;
...
// restore L1 state
    vcpu.arch.nested = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_nested_init() -> c_long {
    ...
    if (rc == H_SUCCESS) {
    let mut capabilities: c_ulong = 0;
...
// Minimum partition table size is 1<<12 bytes
    ...
    pseries_partition_tb = core::ptr::null_mut();
    return -ENODEV;
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn kvmhv_nested_exit() {
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_flush_lpid(lpid: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_set_ptbl_entry(lpid: u64, dw0: u64, dw1: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvmhv_set_nested_ptbl(gp: *mut kvm_nested_guest) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_set_partition_table(vcpu: *mut kvm_vcpu) -> c_long {
    long kvmhv_set_partition_table(struct kvm_vcpu *vcpu)
    {
    struct kvm *kvm = vcpu.kvm;
    let mut ptcr: c_ulong = kvmppc_get_gpr(vcpu, 4);
    int srcu_idx;
    let mut ret: c_long = H_SUCCESS;
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_copy_tofrom_guest_nested(vcpu: *mut kvm_vcpu) -> c_long {
    long kvmhv_copy_tofrom_guest_nested(struct kvm_vcpu *vcpu)
    {
    struct kvm_nested_guest *gp;
    let mut l1_lpid: c_int = kvmppc_get_gpr(vcpu, 4);
    let mut pid: c_int = kvmppc_get_gpr(vcpu, 5);
    let mut eaddr: gva_t = kvmppc_get_gpr(vcpu, 6);
    let mut gp_to: gpa_t = (gpa_t) kvmppc_get_gpr(vcpu, 7);
    let mut gp_from: gpa_t = (gpa_t) kvmppc_get_gpr(vcpu, 8);
    void *buf;
    let mut n: c_ulong = kvmppc_get_gpr(vcpu, 9);
    let mut is_load: bool = !!gp_to;
    long rc;
    if (gp_to && gp_from) /* One must be core::ptr::null_mut() to determine the direction */
    return H_PARAMETER;
    if (eaddr & (0xFFFUL << 52))
    return H_PARAMETER;
...
//
#[no_mangle]
unsafe extern "C" fn kvmhv_update_ptbl_cache(gp: *mut kvm_nested_guest) {
    static void kvmhv_update_ptbl_cache(struct kvm_nested_guest *gp)
    {
    int ret;
    ...
    let mut srcu_idx: c_int = srcu_read_lock(&kvm.srcu);
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_vm_nested_init(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn __prealloc_nested(kvm: *mut kvm, lpid: c_int) -> bool {
    static bool __prealloc_nested(struct kvm *kvm, int lpid)
    {
    if (idr_alloc(&kvm.arch.kvm_nested_guest_idr,
    core::ptr::null_mut(), lpid, lpid + 1, GFP_KERNEL) != lpid)
    return false;
    return true;
    }
#[no_mangle]
unsafe extern "C" fn __add_nested(kvm: *mut kvm, lpid: c_int, gp: *mut kvm_nested_guest) {
...
#[no_mangle]
unsafe extern "C" fn __remove_nested(kvm: *mut kvm, lpid: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn kvmhv_release_nested(gp: *mut kvm_nested_guest) {
...
#[no_mangle]
unsafe extern "C" fn kvmhv_remove_nested(gp: *mut kvm_nested_guest) {
    static void kvmhv_remove_nested(struct kvm_nested_guest *gp)
    {
    struct kvm *kvm = gp.l1_host;
    let mut lpid: c_int = gp.l1_lpid;
    long ref;
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_release_all_nested(kvm: *mut kvm) {
    void kvmhv_release_all_nested(struct kvm *kvm)
    {
    int lpid;
    struct kvm_nested_guest *gp;
    struct kvm_nested_guest *freelist = core::ptr::null_mut();
...
// idr is empty and may be reused at this point
    spin_unlock(&kvm.mmu_lock);
    while ((gp = freelist) != core::ptr::null_mut()) {
    freelist = gp.next;
    kvmhv_release_nested(gp);
    }
    srcu_idx = srcu_read_lock(&kvm.srcu);
...
// caller must hold gp->tlb_lock
#[no_mangle]
unsafe extern "C" fn kvmhv_flush_nested(gp: *mut kvm_nested_guest) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_put_nested(gp: *mut kvm_nested_guest) {
    ...
    pte = __find_linux_pte(gp.shadow_pgtable, ea, core::ptr::null_mut(), hshift);
    return pte;
    }
#[no_mangle]
pub unsafe extern "C" fn kvmhv_n_rmap_is_equal(rmap_1: u64, rmap_2: u64) -> bool {
...
// Don't spuriously invalidate ptes if the pfn has changed
    if (ptep && pte_present(*ptep) && ((pte_val(*ptep) & mask) == hpa))
    kvmppc_unmap_pte(kvm, ptep, gpa, shift, core::ptr::null_mut(), gp.shadow_lpid);
    }
...
#[no_mangle]
unsafe extern "C" fn kvmhv_free_memslot_nest_rmap(free: *mut kvm_memory_slot) {
    static void kvmhv_free_memslot_nest_rmap(struct kvm_memory_slot *free)
    {
    unsigned long page;
...
#[no_mangle]
pub unsafe extern "C" fn get_ric(instr: c_uint) -> c_int {
    static inline int get_ric(unsigned int instr)
    {
    return (instr >> 18) & 0x3;
    }
#[no_mangle]
pub unsafe extern "C" fn get_prs(instr: c_uint) -> c_int {
    static inline int get_prs(unsigned int instr)
    {
    return (instr >> 17) & 0x1;
    }
#[no_mangle]
pub unsafe extern "C" fn get_r(instr: c_uint) -> c_int {
    static inline int get_r(unsigned int instr)
    {
    return (instr >> 16) & 0x1;
    }
#[no_mangle]
pub unsafe extern "C" fn get_lpid(r_val: c_ulong) -> c_int {
    static inline int get_lpid(unsigned long r_val)
    {
    return r_val & 0xffffffff;
    }
#[no_mangle]
pub unsafe extern "C" fn get_is(r_val: c_ulong) -> c_int {
    static inline int get_is(unsigned long r_val)
    {
    return (r_val >> 10) & 0x3;
    }
#[no_mangle]
pub unsafe extern "C" fn get_ap(r_val: c_ulong) -> c_int {
    static inline int get_ap(unsigned long r_val)
    {
    return (r_val >> 5) & 0x7;
    }
#[no_mangle]
pub unsafe extern "C" fn get_epn(r_val: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn kvmhv_emulate_tlbie_all_lpid(vcpu: *mut kvm_vcpu, ric: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_do_nested_tlbie(vcpu: *mut kvm_vcpu) -> c_long {
...
//
    let mut __read_mostly: static unsigned long tlb_range_flush_page_ceiling = 33;
...
// Can we read?
    ...
    {
    struct kvm *kvm = vcpu.kvm;
    let mut writing: bool = !!(dsisr & DSISR_ISSTORE);
    u64 pgflags;
    long ret;
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_radix_level_to_shift(level: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_radix_shift_to_level(shift: c_int) -> c_int {
...
// called with gp->tlb_lock held
    ...
    let mut dsisr: c_ulong = vcpu.arch.fault_dsisr;
    let mut ea: c_ulong = vcpu.arch.fault_dar;
    unsigned long *rmapp;
...
// What size pte can we insert?
    if (shift > l1_shift) {
    u64 mask;
    let mut actual_shift: c_uint = PAGE_SHIFT;
...
// 4. Insert the pte into our shadow_pgtable
    ...
    return ret;
    inval:
    kvmhv_invalidate_shadow_pte(vcpu, gp, n_gpa, core::ptr::null_mut());
    return RESUME_GUEST;
    }
#[no_mangle]
pub unsafe extern "C" fn kvmhv_nested_page_fault(vcpu: *mut kvm_vcpu) -> long int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmhv_nested_next_lpid(kvm: *mut kvm, lpid: c_int) -> c_int {
    int kvmhv_nested_next_lpid(struct kvm *kvm, int lpid)
    {
    let mut ret: c_int = lpid + 1;
    spin_lock(&kvm.mmu_lock);
