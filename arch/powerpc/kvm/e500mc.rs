...
//! Source: arch/powerpc/kvm/e500mc.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_set_pending_interrupt(vcpu: *mut kvm_vcpu, type: enum int_class) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_tlbil_all(vcpu_e500: *mut kvmppc_vcpu_e500) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_set_pid(vcpu: *mut kvm_vcpu, pid: u32) {
    void kvmppc_set_pid(struct kvm_vcpu *vcpu, u32 pid)
    {
    vcpu.arch.pid = pid;
    }
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_msr_notify(vcpu: *mut kvm_vcpu, old_msr: u32) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_vcpu_load_e500mc(vcpu: *mut kvm_vcpu, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_vcpu_put_e500mc(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_e500mc_check_processor_compat() -> c_int {
    ...
    r = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(cur_cpu_spec->cpu_name, 0: "e5500") ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(cur_cpu_spec->cpu_name, 0: "e6500") ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_core_vcpu_setup(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_vcpu_create_e500mc(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_vcpu_free_e500mc(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_init_vm_e500mc(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_destroy_vm_e500mc(kvm: *mut kvm) {
    static void kvmppc_core_destroy_vm_e500mc(struct kvm *kvm)
    {
    let mut lpid: c_int = kvm.arch.lpid;
    if (threads_per_core == 2)
    lpid >>= 1;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_e500mc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_e500mc_exit() -> void __exit {
