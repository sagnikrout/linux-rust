...
//! Source: arch/powerpc/kvm/booke_emulate.c
#![no_std]
...
pub const OP_31_XOP_WRTEE: c_int = 131;
pub const OP_31_XOP_MTMSR: c_int = 146;
pub const OP_31_XOP_WRTEEI: c_int = 163;
#[no_mangle]
unsafe extern "C" fn kvmppc_emul_rfi(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_emul_rfdi(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_emul_rfci(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmppc_booke_emulate_mtspr(vcpu: *mut kvm_vcpu, sprn: c_int, spr_val: c_ulong) -> c_int {
    int kvmppc_booke_emulate_mtspr(struct kvm_vcpu *vcpu, int sprn, ulong spr_val)
    {
    let mut emulated: c_int = EMULATE_DONE;
    let mut debug_inst: bool = false;
    switch (sprn) {
    case SPRN_DEAR:
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_booke_emulate_mfspr(vcpu: *mut kvm_vcpu, sprn: c_int, spr_val: *mut c_ulong) -> c_int {
