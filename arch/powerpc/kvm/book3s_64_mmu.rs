...
//! Source: arch/powerpc/kvm/book3s_64_mmu.c
#![no_std]
...
// #define DEBUG_MMU
    ...
    {
    int i;
    let mut esid: u64 = GET_ESID(eaddr);
    let mut esid_1t: u64 = GET_ESID_1T(eaddr);
    for (i = 0; i < vcpu.arch.slb_nr; i++) {
    let mut cmp_esid: u64 = esid;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_slb_sid_shift(slbe: *mut kvmppc_slb) -> c_int {
    static int kvmppc_slb_sid_shift(struct kvmppc_slb *slbe)
    {
    return slbe.tb ? SID_SHIFT_1T : SID_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn kvmppc_slb_offset_mask(slbe: *mut kvmppc_slb) -> u64 {
    static u64 kvmppc_slb_offset_mask(struct kvmppc_slb *slbe)
    {
    return (1ul << kvmppc_slb_sid_shift(slbe)) - 1;
    }
#[no_mangle]
unsafe extern "C" fn kvmppc_slb_calc_vpn(slb: *mut kvmppc_slb, eaddr: gva_t) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn mmu_pagesize(mmu_pg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_get_pagesize(slbe: *mut kvmppc_slb) -> c_int {
    static int kvmppc_mmu_book3s_64_get_pagesize(struct kvmppc_slb *slbe)
    {
    return mmu_pagesize(slbe.base_page_size);
    }
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_get_page(slbe: *mut kvmppc_slb, eaddr: gva_t) -> u32 {
    static u32 kvmppc_mmu_book3s_64_get_page(struct kvmppc_slb *slbe, gva_t eaddr)
    {
    let mut p: c_int = kvmppc_mmu_book3s_64_get_pagesize(slbe);
...
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_get_avpn(slbe: *mut kvmppc_slb, eaddr: gva_t) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn decode_pagesize(slbe: *mut kvmppc_slb, r: u64) -> c_int {
...
// Magic page override
    ...
    key = 4;
#[no_mangle]
pub unsafe extern "C" fn if(slbe->Ks: !(kvmppc_get_msr(vcpu) & MSR_PR) &&) -> else {
    else if (!(kvmppc_get_msr(vcpu) & MSR_PR) && slbe.Ks)
    key = 4;
    for (i=0; i<16; i+=2) {
    let mut pte0: u64 = be64_to_cpu(pteg[i]);
    let mut pte1: u64 = be64_to_cpu(pteg[i + 1]);
...
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_slbmte(vcpu: *mut kvm_vcpu, rs: u64, rb: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_slbmfee(vcpu: *mut kvm_vcpu, slb_nr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_slbmfev(vcpu: *mut kvm_vcpu, slb_nr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_slbie(vcpu: *mut kvm_vcpu, ea: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_slbia(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn segment_contains_magic_page(vcpu: *mut kvm_vcpu, esid: c_ulong) -> c_int {
    ...
    let mut mp_ea: c_ulong = vcpu.arch.magic_page_ea;
    let mut pagesize: c_int = MMU_PAGE_64K;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_mmu_book3s_64_is_dcbz32(vcpu: *mut kvm_vcpu) -> bool {
    static bool kvmppc_mmu_book3s_64_is_dcbz32(struct kvm_vcpu *vcpu)
    {
    return (to_book3s(vcpu).hid[5] & 0x80);
    }
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_book3s_64_init(vcpu: *mut kvm_vcpu) {
    void kvmppc_mmu_book3s_64_init(struct kvm_vcpu *vcpu)
    {
    struct kvmppc_mmu *mmu = &vcpu.arch.mmu;
    mmu.mfsrin = core::ptr::null_mut();
