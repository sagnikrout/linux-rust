...
//! Source: arch/powerpc/kvm/book3s_hv_tm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn emulate_tx_failure(vcpu: *mut kvm_vcpu, failure_cause: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmhv_p9_tm_emulation(vcpu: *mut kvm_vcpu) -> c_int {
