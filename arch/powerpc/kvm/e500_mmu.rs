...
//! Source: arch/powerpc/kvm/e500_mmu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tlb0_set_base(addr: gva_t, sets: c_int, ways: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gtlb0_set_base(vcpu_e500: *mut kvmppc_vcpu_e500, addr: gva_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_tlb_esel(vcpu: *mut kvm_vcpu, tlbsel: c_int) -> c_uint {
    static unsigned int get_tlb_esel(struct kvm_vcpu *vcpu, int tlbsel)
    {
    struct kvmppc_vcpu_e500 *vcpu_e500 = to_e500(vcpu);
    let mut esel: c_int = get_tlb_esel_bit(vcpu);
    if (tlbsel == 0) {
...
// Search the guest TLB for a matching entry.
    ...
    {
    let mut size: c_int = vcpu_e500.gtlb_params[tlbsel].entries;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_recalc_tlb1map_range(vcpu_e500: *mut kvmppc_vcpu_e500) {
    static void kvmppc_recalc_tlb1map_range(struct kvmppc_vcpu_e500 *vcpu_e500)
    {
    let mut size: c_int = vcpu_e500.gtlb_params[1].entries;
    unsigned int offset;
    gva_t eaddr;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_emul_mt_mmucsr0(vcpu_e500: *mut kvmppc_vcpu_e500, value: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_emul_tlbivax(vcpu: *mut kvm_vcpu, ea: gva_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_emul_tlbilx(vcpu: *mut kvm_vcpu, type: c_int, ea: gva_t) -> c_int {
    int kvmppc_e500_emul_tlbilx(struct kvm_vcpu *vcpu, int type, gva_t ea)
    {
    struct kvmppc_vcpu_e500 *vcpu_e500 = to_e500(vcpu);
    let mut pid: c_int = get_cur_spid(vcpu);
    if (type == 0 || type == 1) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_emul_tlbre(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_emul_tlbsx(vcpu: *mut kvm_vcpu, ea: gva_t) -> c_int {
    int kvmppc_e500_emul_tlbsx(struct kvm_vcpu *vcpu, gva_t ea)
    {
    struct kvmppc_vcpu_e500 *vcpu_e500 = to_e500(vcpu);
    let mut as: c_int = !!get_cur_sas(vcpu);
    let mut pid: c_uint = get_cur_spid(vcpu);
    int esel, tlbsel;
    struct kvm_book3e_206_tlb_entry *gtlbe = core::ptr::null_mut();
    for (tlbsel = 0; tlbsel < 2; tlbsel++) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_emul_tlbwe(vcpu: *mut kvm_vcpu) -> c_int {
    int kvmppc_e500_emul_tlbwe(struct kvm_vcpu *vcpu)
    {
    struct kvmppc_vcpu_e500 *vcpu_e500 = to_e500(vcpu);
    struct kvm_book3e_206_tlb_entry *gtlbe;
    int tlbsel, esel;
    let mut recal: c_int = 0;
    int idx;
    tlbsel = get_tlb_tlbsel(vcpu);
    esel = get_tlb_esel(vcpu, tlbsel);
    gtlbe = get_entry(vcpu_e500, tlbsel, esel);
...
// Invalidate shadow mappings for the about-to-be-clobbered TLBE.
    ...
    let mut eaddr: u64 = get_tlb_eaddr(gtlbe);
    let mut raddr: u64 = get_tlb_raddr(gtlbe);
    if (tlbsel == 0) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_itlb_index(vcpu: *mut kvm_vcpu, eaddr: gva_t) -> c_int {
    int kvmppc_mmu_itlb_index(struct kvm_vcpu *vcpu, gva_t eaddr)
    {
    let mut as: c_uint = !!(vcpu.arch.shared.msr & MSR_IS);
    return kvmppc_e500_tlb_search(vcpu, eaddr, get_cur_pid(vcpu), as);
    }
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_dtlb_index(vcpu: *mut kvm_vcpu, eaddr: gva_t) -> c_int {
    int kvmppc_mmu_dtlb_index(struct kvm_vcpu *vcpu, gva_t eaddr)
    {
    let mut as: c_uint = !!(vcpu.arch.shared.msr & MSR_DS);
    return kvmppc_e500_tlb_search(vcpu, eaddr, get_cur_pid(vcpu), as);
    }
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_itlb_miss(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_dtlb_miss(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn free_gtlb(vcpu_e500: *mut kvmppc_vcpu_e500) {
    ...
    vcpu_e500.shared_tlb_pages = core::ptr::null_mut();
    } else {
    kfree(vcpu_e500.gtlb_arch);
    }
    vcpu_e500.gtlb_arch = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn kvmppc_get_sregs_e500_tlb(vcpu: *mut kvm_vcpu, sregs: *mut kvm_sregs) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_set_sregs_e500_tlb(vcpu: *mut kvm_vcpu, sregs: *mut kvm_sregs) -> c_int {
...
// Only allow MMU registers to be set to the config supported by KVM
    case KVM_REG_PPC_MMUCFG: {
    let mut reg: u32 = set_reg_val(id, *val);
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_tlb_init(vcpu_e500: *mut kvmppc_vcpu_e500) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_e500_tlb_uninit(vcpu_e500: *mut kvmppc_vcpu_e500) {
