...
//! Source: arch/powerpc/kvm/book3s_pr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kvmppc_is_split_real(vcpu: *mut kvm_vcpu) -> bool {
    static bool kvmppc_is_split_real(struct kvm_vcpu *vcpu)
    {
    let mut msr: c_ulong = kvmppc_get_msr(vcpu);
    return (msr & (MSR_IR|MSR_DR)) == MSR_DR;
    }
#[no_mangle]
unsafe extern "C" fn kvmppc_fixup_split_real(vcpu: *mut kvm_vcpu) {
    static void kvmppc_fixup_split_real(struct kvm_vcpu *vcpu)
    {
    let mut msr: c_ulong = kvmppc_get_msr(vcpu);
    let mut pc: c_ulong = kvmppc_get_pc(vcpu);
...
#[no_mangle]
unsafe extern "C" fn kvmppc_unfixup_split_real(vcpu: *mut kvm_vcpu) {
    static void kvmppc_unfixup_split_real(struct kvm_vcpu *vcpu)
    {
    if (vcpu.arch.hflags & BOOK3S_HFLAG_SPLIT_HACK) {
    let mut pc: c_ulong = kvmppc_get_pc(vcpu);
    let mut lr: c_ulong = kvmppc_get_lr(vcpu);
...
#[no_mangle]
unsafe extern "C" fn kvmppc_inject_interrupt_pr(vcpu: *mut kvm_vcpu, vec: c_int, srr1_flags: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_vcpu_load_pr(vcpu: *mut kvm_vcpu, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_vcpu_put_pr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_copy_to_svcpu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_recalc_shadow_msr(vcpu: *mut kvm_vcpu) {
    static void kvmppc_recalc_shadow_msr(struct kvm_vcpu *vcpu)
    {
    let mut guest_msr: c_ulong = kvmppc_get_msr(vcpu);
    let mut smsr: c_ulong = guest_msr;
// Guest MSR values
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_copy_from_svcpu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_save_tm_sprs(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_restore_tm_sprs(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn kvmppc_handle_lost_math_exts(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn if(MSR_VEC: ext_diff ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_save_tm_pr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_restore_tm_pr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_check_requests_pr(vcpu: *mut kvm_vcpu) -> c_int {
...
// MMU Notifiers
#[no_mangle]
unsafe extern "C" fn do_kvm_unmap_gfn(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_unmap_gfn_range_pr(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
    static bool kvm_unmap_gfn_range_pr(struct kvm *kvm, struct kvm_gfn_range *range)
    {
    return do_kvm_unmap_gfn(kvm, range);
    }
#[no_mangle]
unsafe extern "C" fn kvm_age_gfn_pr(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_test_age_gfn_pr(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn kvmppc_set_msr_pr(vcpu: *mut kvm_vcpu, msr: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_set_pvr_pr(vcpu: *mut kvm_vcpu, pvr: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn kvmppc_patch_dcbz(vcpu: *mut kvm_vcpu, pte: *mut kvmppc_pte) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_visible_gpa(vcpu: *mut kvm_vcpu, gpa: gpa_t) -> bool {
    static bool kvmppc_visible_gpa(struct kvm_vcpu *vcpu, gpa_t gpa)
    {
    let mut mp_pa: c_ulong = vcpu.arch.magic_page_pa;
    ...
    ulong eaddr, int vec)
    {
    let mut data: bool = (vec == BOOK3S_INTERRUPT_DATA_STORAGE);
    let mut iswrite: bool = false;
    let mut r: c_int = RESUME_GUEST;
    int relocated;
    let mut page_found: c_int = 0;
    let mut pte: kvmppc_pte = { 0 };
    let mut dr: bool = (kvmppc_get_msr(vcpu) & MSR_DR) ? true : false;
    let mut ir: bool = (kvmppc_get_msr(vcpu) & MSR_IR) ? true : false;
    u64 vsid;
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_giveup_ext(vcpu: *mut kvm_vcpu, msr: c_ulong) {
...
//
    ...
    giveup_fpu(current);
    t.fp_save_area = core::ptr::null_mut();
    }

    if (msr & MSR_VEC) {
    if (current.thread.regs.msr & MSR_VEC)
    giveup_altivec(current);
    t.vr_save_area = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_giveup_fac(vcpu: *mut kvm_vcpu, fac: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn kvmppc_handle_lost_ext(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_trigger_fac_interrupt(vcpu: *mut kvm_vcpu, fac: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_emulate_fac(vcpu: *mut kvm_vcpu, fac: c_ulong) {
    static void kvmppc_emulate_fac(struct kvm_vcpu *vcpu, ulong fac)
    {
    let mut er: enum emulation_result = EMULATE_FAIL;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_handle_fac(vcpu: *mut kvm_vcpu, fac: c_ulong) -> c_int {
    static int kvmppc_handle_fac(struct kvm_vcpu *vcpu, ulong fac)
    {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_set_fscr(vcpu: *mut kvm_vcpu, fscr: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_setup_debug(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_clear_debug(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_exit_pr_progint(vcpu: *mut kvm_vcpu, exit_nr: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_handle_exit_pr(vcpu: *mut kvm_vcpu, exit_nr: c_uint) -> c_int {
    int kvmppc_handle_exit_pr(struct kvm_vcpu *vcpu, unsigned int exit_nr)
    {
    struct kvm_run *run = vcpu.run;
    let mut r: c_int = RESUME_HOST;
    int s;
    vcpu.stat.sum_exits++;
...
// We get here with MSR.EE=1
    ...
    {
    let mut shadow_srr1: c_ulong = vcpu.arch.shadow_srr1;
...
//
    ...
    {
    let mut dar: c_ulong = kvmppc_get_fault_dar(vcpu);
    let mut fault_dsisr: u32 = vcpu.arch.fault_dsisr;
...
// Enable external provider
    ...
    {
    ppc_inst_t last_inst;
    let mut emul: c_int = kvmppc_get_last_inst(vcpu, INST_GENERIC, &last_inst);
    if (emul == EMULATE_DONE) {
    u32 dsisr;
    u64 dar;
...
// Flush all SLB entries
    ...
    for (i = 0; i < 64; i++) {
    let mut rb: u64 = sregs.u.s.ppc64.slb[i].slbe;
    let mut rs: u64 = sregs.u.s.ppc64.slb[i].slbv;
    if (rb & SLB_ESID_V)
...
#[no_mangle]
unsafe extern "C" fn kvmppc_set_lpcr_pr(vcpu: *mut kvm_vcpu, new_lpcr: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_vcpu_create_pr(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_vcpu_free_pr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_vcpu_run_pr(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_free_memslot_pr(slot: *mut kvm_memory_slot) {
...
#[no_mangle]
unsafe extern "C" fn kvm_configure_mmu_pr(kvm: *mut kvm, cfg: *mut kvm_ppc_mmuv3_cfg) -> c_int {
...
// We should not get called
    ...
    let mut kvm_global_user_count: static unsigned int = 0;
    static DEFINE_SPINLOCK(kvm_global_user_count_lock);
#[no_mangle]
unsafe extern "C" fn kvmppc_core_init_vm_pr(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_destroy_vm_pr(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_core_check_processor_compat_pr() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_book3s_init_pr() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_book3s_exit_pr() {
    void kvmppc_book3s_exit_pr(void)
    {
    kvmppc_pr_ops = core::ptr::null_mut();
