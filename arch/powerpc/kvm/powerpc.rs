...
//! Source: arch/powerpc/kvm/powerpc.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_dy_runnable(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvmppc_prepare_to_enter(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_swab_shared(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_kvm_pv(vcpu: *mut kvm_vcpu) -> c_int {
    int kvmppc_kvm_pv(struct kvm_vcpu *vcpu)
    {
    let mut nr: c_int = kvmppc_get_gpr(vcpu, 11);
    int r;
    let mut param1: unsigned long __maybe_unused = kvmppc_get_gpr(vcpu, 3);
    let mut param2: unsigned long __maybe_unused = kvmppc_get_gpr(vcpu, 4);
    let mut param3: unsigned long __maybe_unused = kvmppc_get_gpr(vcpu, 5);
    let mut param4: unsigned long __maybe_unused = kvmppc_get_gpr(vcpu, 6);
    let mut r2: c_ulong = 0;
...
// Book3S can be little endian, find it out here
    let mut shared_big_endian: c_int = true;
...
//
    ...
    let mut shared: c_ulong = (ulong)vcpu.arch.shared;
    void *new_shared;
    shared &= PAGE_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_sanity_check(vcpu: *mut kvm_vcpu) -> c_int {
    int kvmppc_sanity_check(struct kvm_vcpu *vcpu)
    {
    let mut r: c_int = false;
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_emulate_mmio(vcpu: *mut kvm_vcpu) -> c_int {
...
//
    ...
    let mut dsisr: c_ulong = DSISR_BADACCESS;
...
//
    ...
    bool data)
    {
    let mut mp_pa: c_ulong = vcpu.arch.magic_page_pa & KVM_PAM & PAGE_MASK;
...
pub unsafe extern "C" fn kvm_arch_init_vm(kvm: *mut kvm, type: c_ulong) -> c_int {
    ...
    {
    struct kvmppc_ops *kvm_ops = core::ptr::null_mut();
    int r;
//
...
// Assume we're using HV mode when the HV module is loaded
    let mut hv_enabled: c_int = kvmppc_hv_ops ? 1 : 0;
    if (kvm) {
//
...
// P9 can emulate dbells, so allow any mode
    ...
    !kvmppc_hv_ops.enable_nested(core::ptr::null_mut()));
    break;
...
//
    ...
    !kvmppc_hv_ops.enable_svm(core::ptr::null_mut());
    break;
    case KVM_CAP_PPC_DAWR1:
    r = !!(hv_enabled && kvmppc_hv_ops.enable_dawr1 &&
    !kvmppc_hv_ops.enable_dawr1(core::ptr::null_mut()));
    break;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_decrementer_wakeup(timer: *mut hrtimer) -> enum hrtimer_restart {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_has_irq_bypass() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_get_vsr_dword_offset(index: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_get_vsr_word_offset(index: c_int) -> c_int {
    ...
    let mut offset: c_int = kvmppc_get_vsr_dword_offset(vcpu.arch.mmio_vsx_offset);
    let mut index: c_int = vcpu.arch.io_gpr & KVM_MMIO_REG_MASK;
    if (offset == -1)
    return;
    if (index >= 32) {
    ...
    {
    union kvmppc_one_reg val;
    let mut offset: c_int = kvmppc_get_vsr_word_offset(vcpu.arch.mmio_vsx_offset);
    let mut index: c_int = vcpu.arch.io_gpr & KVM_MMIO_REG_MASK;
    ...
    {
    int offset;
    let mut elts: c_int = sizeof(vector128)/element_size;
...
#[no_mangle]
pub unsafe extern "C" fn sp_to_dp(fprs: u32) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn dp_to_sp(fprd: u64) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_complete_mmio_load(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn if(KVMPPC_VSX_COPY_WORD: vcpu->arch.mmio_copy_type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(KVMPPC_VMX_COPY_WORD: vcpu->arch.mmio_copy_type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_get_vsr_data(vcpu: *mut kvm_vcpu, rs: c_int, val: *mut u64) -> c_int {
    static inline int kvmppc_get_vsr_data(struct kvm_vcpu *vcpu, int rs, u64 *val)
    {
    u32 dword_offset, word_offset;
    union kvmppc_one_reg reg;
    let mut vsx_offset: c_int = 0;
    let mut copy_type: c_int = vcpu.arch.mmio_copy_type;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_emulate_mmio_vsx_loadstore(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_get_vmx_dword(vcpu: *mut kvm_vcpu, index: c_int, val: *mut u64) -> c_int {
    static int kvmppc_get_vmx_dword(struct kvm_vcpu *vcpu, int index, u64 *val)
    {
    union kvmppc_one_reg reg;
    let mut vmx_offset: c_int = 0;
    let mut result: c_int = 0;
    vmx_offset =
...
#[no_mangle]
unsafe extern "C" fn kvmppc_get_vmx_word(vcpu: *mut kvm_vcpu, index: c_int, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_get_vmx_hword(vcpu: *mut kvm_vcpu, index: c_int, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_get_vmx_byte(vcpu: *mut kvm_vcpu, index: c_int, val: *mut u64) -> c_int {
...
// val = reg.vsx8val[vmx_offset];
    ...
    {
    let mut val: u64 = 0;
    let mut index: c_uint = rs & KVM_MMIO_REG_MASK;
    let mut emulated: enum emulation_result = EMULATE_DONE;
    if (vcpu.arch.mmio_vmx_copy_nums > 2)
    return EMULATE_FAIL;
    vcpu.arch.io_gpr = rs;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_emulate_mmio_vmx_loadstore(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_ioctl_get_one_reg(vcpu: *mut kvm_vcpu, reg: *mut kvm_one_reg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_ioctl_set_one_reg(vcpu: *mut kvm_vcpu, reg: *mut kvm_one_reg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_ioctl_interrupt(vcpu: *mut kvm_vcpu, irq: *mut kvm_interrupt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vm_ioctl_get_pvinfo(pvinfo: *mut kvm_ppc_pvinfo) -> c_int {
    static int kvm_vm_ioctl_get_pvinfo(struct kvm_ppc_pvinfo *pvinfo)
    {
    let mut inst_nop: u32 = 0x60000000;

    let mut inst_sc1: u32 = 0x44000022;
    pvinfo.hcall[0] = cpu_to_be32(inst_sc1);
    pvinfo.hcall[1] = cpu_to_be32(inst_nop);
    pvinfo.hcall[2] = cpu_to_be32(inst_nop);
    pvinfo.hcall[3] = cpu_to_be32(inst_nop);

    let mut inst_lis: u32 = 0x3c000000;
    let mut inst_ori: u32 = 0x60000000;
    let mut inst_sc: u32 = 0x44000002;
    let mut inst_imm_mask: u32 = 0xffff;
//
...
pub unsafe extern "C" fn kvm_arch_irqchip_in_kernel(kvm: *mut kvm) -> bool {
    ...
    ret = ret || (kvm.arch.mpic != core::ptr::null_mut());

    ret = ret || (kvm.arch.xics != core::ptr::null_mut());
    ret = ret || (kvm.arch.xive != core::ptr::null_mut());
    ...
    case KVM_CAP_PPC_ENABLE_HCALL: {
    let mut hcall: c_ulong = cap.args[0];
    r = -EINVAL;
    ...
    case KVM_CAP_PPC_SMT: {
    let mut mode: c_ulong = cap.args[0];
    let mut flags: c_ulong = cap.args[1];
    r = -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn pseries_get_cpu_char(cp: *mut kvm_ppc_cpu_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_get_cpu_char(cp: *mut kvm_ppc_cpu_char) -> c_int {
...
pub unsafe extern "C" fn kvm_arch_vm_ioctl(filp: *mut file, ioctl: c_uint, arg: c_ulong) -> c_int {
    ...
    {
    let mut __maybe_unused: *mut kvm kvm = filp.private_data;
    void __user *argp = (void __user *)arg;
    int r;
    switch (ioctl) {
    ...
    let mut host_caps: kvm_ppc_compat_caps = {};
    u64 usize;
//
...
//
    ...
    sizeof(host_caps), core::ptr::null_mut());
    break;
    }
    default: {
    struct kvm *kvm = filp.private_data;
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_alloc_lpid() -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_free_lpid(lpid: c_long) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_init_lpid(nr_lpids_param: c_ulong) {
