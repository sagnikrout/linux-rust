...
//! Source: arch/powerpc/kvm/book3s_64_mmu_hv.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_allocate_hpt(info: *mut kvm_hpt_info, order: u32) -> c_int {
    int kvmppc_allocate_hpt(struct kvm_hpt_info *info, u32 order)
    {
    let mut hpt: c_ulong = 0;
    let mut cma: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_set_hpt(kvm: *mut kvm, info: *mut kvm_hpt_info) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_alloc_reset_hpt(kvm: *mut kvm, order: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_free_hpt(info: *mut kvm_hpt_info) {
    void kvmppc_free_hpt(struct kvm_hpt_info *info)
    {
    vfree(info.rev);
    info.rev = core::ptr::null_mut();
    if (info.cma)
    kvm_free_hpt_cma(virt_to_page((void *)info.virt),
    1 << (info.order - PAGE_SHIFT));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: info->virt) -> else {
    else if (info.virt)
...
#[no_mangle]
pub unsafe extern "C" fn hpte0_pgsize_encoding(pgsize: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn hpte1_pgsize_encoding(pgsize: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_hv_init() -> c_int {
...
// this can't happen
    ...
    __be64 *hptep;
    long int index;
    let mut virtmode: c_int = __kvmppc_get_msr_hv(vcpu) & (data ? MSR_DR : MSR_IR);
...
// Storage key permission check for POWER7
    if (data && virtmode) {
    let mut amrfield: c_int = hpte_get_skey_perm(gr, vcpu.arch.amr);
    if (amrfield & 1)
    gpte.may_read = 0;
    if (amrfield & 2)
    gpte.may_write = 0;
...
//
#[no_mangle]
unsafe extern "C" fn instruction_is_store(instr: ppc_inst_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x7c000000: (suffix & 0xfc000000) ==) -> else {
    ...
    let mut is_prefixed: bool = !!(kvmppc_get_msr(vcpu) & SRR1_PREFIXED);
//
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_rmap_reset(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_unmap_gfn_range_hv(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_age_gfn_hv(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_test_age_gfn_hv(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vcpus_running(kvm: *mut kvm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_test_clear_dirty_npages(kvm: *mut kvm, rmapp: *mut c_ulong) -> c_int {
...
// need to make it temporarily absent so C is stable
    ...
    let mut npages: c_int = kvm_test_clear_dirty_npages(kvm, rmapp);
//
...
//
    ...
    {
    struct kvm_memory_slot *memslot;
    let mut gfn: c_ulong = gpa >> PAGE_SHIFT;
...
//
#[no_mangle]
unsafe extern "C" fn resize_hpt_allocate(resize: *mut kvm_resize_hpt) -> c_int {
    ...
    let mut old_hash_mask: c_ulong = (1ULL << (old.order - 7)) - 1;
    let mut new_hash_mask: c_ulong = (1ULL << (new.order - 7)) - 1;
...
// Unmap
    ...
    let mut gfn: c_ulong = hpte_rpn(guest_rpte, apsize);
...
// We only have 40 - 23 bits of seg_off in avpn
    ...
    if (cpu_has_feature(CPU_FTR_ARCH_300)) {
    let mut replace_rpte: c_ulong = be64_to_cpu(new_hptep[1]);
...
#[no_mangle]
unsafe extern "C" fn resize_hpt_rehash(resize: *mut kvm_resize_hpt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn resize_hpt_pivot(resize: *mut kvm_resize_hpt) {
...
#[no_mangle]
unsafe extern "C" fn resize_hpt_release(kvm: *mut kvm, resize: *mut kvm_resize_hpt) {
    ...
    kvm.arch.resize_hpt = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn resize_hpt_prepare_work(work: *mut work_struct) {
...
//
    ...
    {
    let mut flags: c_ulong = rhpt.flags;
    let mut shift: c_ulong = rhpt.shift;
...
#[no_mangle]
unsafe extern "C" fn resize_hpt_boot_vcpu(opaque: *mut c_void) {
...
// mmu_ready
    on_each_cpu(resize_hpt_boot_vcpu, core::ptr::null_mut(), 1);
    ret = -ENXIO;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_htab_ctx {
    pub index: c_ulong,
    pub flags: c_ulong,
    pub kvm: *mut kvm,
    pub first_pass: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn hpte_dirty(revp: *mut revmap_entry, hptp: *mut __be64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_htab_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vm_ioctl_get_htab_fd(kvm: *mut kvm, ghf: *mut kvm_get_htab_fd) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct debugfs_htab_state {
    pub kvm: *mut kvm,
    pub mutex: mutex,
    pub hpt_index: c_ulong,
    pub chars_left: c_int,
    pub buf_index: c_int,
    pub buf: [c_char; 64],
}

#[no_mangle]
unsafe extern "C" fn debugfs_htab_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_htab_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_debugfs_init(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_mmu_book3s_hv_init(vcpu: *mut kvm_vcpu) {
