...
//! Source: arch/powerpc/kvm/book3s_xive_native.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xive_vm_esb_load(xd: *mut xive_irq_data, offset: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_native_cleanup_queue(vcpu: *mut kvm_vcpu, prio: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_xive_native_cleanup_vcpu(vcpu: *mut kvm_vcpu) {
...
// Cleanup the vcpu
    ...
    struct kvmppc_xive_vcpu *xc = core::ptr::null_mut();
    int rc;
    u32 vp_id;
...
//
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_native_reset_mapped(kvm: *mut kvm, irq: c_ulong) -> c_int {
    static int kvmppc_xive_native_reset_mapped(struct kvm *kvm, unsigned long irq)
    {
    struct kvmppc_xive *xive = kvm.arch.xive;
    let mut esb_pgoff: pgoff_t = KVM_XIVE_ESB_PAGE_OFFSET + irq * 2;
...
#[no_mangle]
unsafe extern "C" fn xive_native_esb_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn xive_native_tima_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
// Increment the number of valid sources and mark this one valid
    ...
    state.act_priority);
    kvmppc_xive_select_irq(state, &hw_num, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn xive_native_validate_queue_size(qshift: u32) -> c_int {
...
//
    ...
    int rc;
    __be32 *qaddr = core::ptr::null_mut();
    struct page *page;
    struct xive_q *q;
    gfn_t gfn;
...
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_reset_sources(sb: *mut kvmppc_xive_src_block) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_reset(xive: *mut kvmppc_xive) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_native_sync_sources(sb: *mut kvmppc_xive_src_block) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_native_vcpu_eq_sync(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_native_eq_sync(xive: *mut kvmppc_xive) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_native_release(dev: *mut kvm_device) {
...
//
    mutex_lock(&xive.mapping_lock);
    xive.mapping = core::ptr::null_mut();
    mutex_unlock(&xive.mapping_lock);
//
...
//
    kvm.arch.xive = core::ptr::null_mut();
    for (i = 0; i <= xive.max_sbid; i++) {
    if (xive.src_blocks[i])
    kvmppc_xive_free_sources(xive.src_blocks[i]);
    kfree(xive.src_blocks[i]);
    xive.src_blocks[i] = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_native_create(dev: *mut kvm_device, type: u32) -> c_int {
...
//
pub const TM_IPB_SHIFT: c_int = 40;

#[no_mangle]
pub unsafe extern "C" fn kvmppc_xive_native_get_vp(vcpu: *mut kvm_vcpu, val: *mut union kvmppc_one_reg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_xive_native_set_vp(vcpu: *mut kvm_vcpu, val: *mut union kvmppc_one_reg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_xive_native_supported() -> bool {
    bool kvmppc_xive_native_supported(void)
    {
    return xive_native_has_queue_state_support();
    }
#[no_mangle]
unsafe extern "C" fn xive_native_debug_show(m: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_native_debugfs_init(xive: *mut kvmppc_xive) {
...
#[no_mangle]
unsafe extern "C" fn kvmppc_xive_native_init(dev: *mut kvm_device) {
