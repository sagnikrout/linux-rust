...
//! Source: arch/powerpc/math-emu/math_efp.c
#![no_std]
...
// Macro flag: #define FP_EX_BOOKE_E500_SPE

pub const EFAPU: c_uint = 0x4;
pub const VCT: c_uint = 0x4;
pub const SPFP: c_uint = 0x6;
pub const DPFP: c_uint = 0x7;
pub const EFSADD: c_uint = 0x2c0;
pub const EFSSUB: c_uint = 0x2c1;
pub const EFSABS: c_uint = 0x2c4;
pub const EFSNABS: c_uint = 0x2c5;
pub const EFSNEG: c_uint = 0x2c6;
pub const EFSMUL: c_uint = 0x2c8;
pub const EFSDIV: c_uint = 0x2c9;
pub const EFSCMPGT: c_uint = 0x2cc;
pub const EFSCMPLT: c_uint = 0x2cd;
pub const EFSCMPEQ: c_uint = 0x2ce;
pub const EFSCFD: c_uint = 0x2cf;
pub const EFSCFSI: c_uint = 0x2d1;
pub const EFSCTUI: c_uint = 0x2d4;
pub const EFSCTSI: c_uint = 0x2d5;
pub const EFSCTUF: c_uint = 0x2d6;
pub const EFSCTSF: c_uint = 0x2d7;
pub const EFSCTUIZ: c_uint = 0x2d8;
pub const EFSCTSIZ: c_uint = 0x2da;
pub const EVFSADD: c_uint = 0x280;
pub const EVFSSUB: c_uint = 0x281;
pub const EVFSABS: c_uint = 0x284;
pub const EVFSNABS: c_uint = 0x285;
pub const EVFSNEG: c_uint = 0x286;
pub const EVFSMUL: c_uint = 0x288;
pub const EVFSDIV: c_uint = 0x289;
pub const EVFSCMPGT: c_uint = 0x28c;
pub const EVFSCMPLT: c_uint = 0x28d;
pub const EVFSCMPEQ: c_uint = 0x28e;
pub const EVFSCTUI: c_uint = 0x294;
pub const EVFSCTSI: c_uint = 0x295;
pub const EVFSCTUF: c_uint = 0x296;
pub const EVFSCTSF: c_uint = 0x297;
pub const EVFSCTUIZ: c_uint = 0x298;
pub const EVFSCTSIZ: c_uint = 0x29a;
pub const EFDADD: c_uint = 0x2e0;
pub const EFDSUB: c_uint = 0x2e1;
pub const EFDABS: c_uint = 0x2e4;
pub const EFDNABS: c_uint = 0x2e5;
pub const EFDNEG: c_uint = 0x2e6;
pub const EFDMUL: c_uint = 0x2e8;
pub const EFDDIV: c_uint = 0x2e9;
pub const EFDCTUIDZ: c_uint = 0x2ea;
pub const EFDCTSIDZ: c_uint = 0x2eb;
pub const EFDCMPGT: c_uint = 0x2ec;
pub const EFDCMPLT: c_uint = 0x2ed;
pub const EFDCMPEQ: c_uint = 0x2ee;
pub const EFDCFS: c_uint = 0x2ef;
pub const EFDCTUI: c_uint = 0x2f4;
pub const EFDCTSI: c_uint = 0x2f5;
pub const EFDCTUF: c_uint = 0x2f6;
pub const EFDCTSF: c_uint = 0x2f7;
pub const EFDCTUIZ: c_uint = 0x2f8;
pub const EFDCTSIZ: c_uint = 0x2fa;
pub const AB: c_int = 2;
pub const XA: c_int = 3;
pub const XB: c_int = 4;
pub const XCR: c_int = 5;
pub const NOTYPE: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn insn_type(speinsn: c_ulong) -> c_ulong {
    static unsigned long insn_type(unsigned long speinsn)
    {
    let mut ret: c_ulong = NOTYPE;
...
#[no_mangle]
pub unsafe extern "C" fn do_spe_mathemu(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn speround_handler(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spe_mathemu_init() -> int __init {
