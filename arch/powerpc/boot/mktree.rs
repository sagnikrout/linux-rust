...
//! Source: arch/powerpc/boot/mktree.c
#![no_std]
...
// If we have the optional entry point parameter, use it
    bt.bb_dest = htonl(strtoul(argv[3], core::ptr::null_mut(), 0));
    bt.bb_entry_point = htonl(strtoul(argv[4], core::ptr::null_mut(), 0));
