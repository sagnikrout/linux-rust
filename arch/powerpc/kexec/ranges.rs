...
//! Source: arch/powerpc/kexec/ranges.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn get_max_nr_ranges(size: usize) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_mem_rngs_size(mem_rngs: *mut crash_mem) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn __add_mem_range(mem_ranges: *mut crash_mem, base: u64, size: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __merge_memory_ranges(mem_rngs: *mut crash_mem) {
...
#[no_mangle]
unsafe extern "C" fn rngcmp(_x: *const c_void, _y: *const c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sort_memory_ranges(mem_rngs: *mut crash_mem, merge: bool) {
...
// Sort the ranges in-place
    ...
    sizeof(mem_rngs.ranges[0]), rngcmp, core::ptr::null_mut());
    if (merge)
...
//
#[no_mangle]
pub unsafe extern "C" fn add_mem_range(mem_ranges: *mut crash_mem, base: u64, size: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_tce_mem_ranges(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_initrd_mem_range(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_htab_mem_range(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_kernel_mem_range(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_rtas_mem_range(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_opal_mem_range(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_reserved_mem_ranges(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_reserved_memory_ranges(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_exclude_memory_ranges(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_usable_memory_ranges(mem_ranges: *mut crash_mem) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_crash_memory_ranges(mem_ranges: *mut crash_mem) -> c_int {
