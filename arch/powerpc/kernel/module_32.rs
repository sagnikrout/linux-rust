...
//! Source: arch/powerpc/kernel/module_32.c
#![no_std]
...
// Count how many different relocations (different symbol, different
    addend) */
#[no_mangle]
unsafe extern "C" fn count_relocs(rela: *const Elf32_Rela, num: c_uint) -> c_uint {
...
// If it's called *.init*, and we're not init, we're
    not interested */
    if ((strstr(secstrings + sechdrs[i].sh_name, ".init") != core::ptr::null_mut())
    != is_init)
    continue;
...
//
    ...
    sechdrs[i].sh_size / sizeof(Elf32_Rela),
    sizeof(Elf32_Rela), relacmp, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(sechdrs[i].sh_name: strcmp(secstrings +, 0: ".plt") ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn entry_matches(entry: *mut ppc_plt_entry, val: Elf32_Addr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn patch_location_16(loc: *mut u32, value: u16) -> c_int {
