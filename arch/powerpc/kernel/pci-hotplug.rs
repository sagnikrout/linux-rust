...
//! Source: arch/powerpc/kernel/pci-hotplug.c
#![no_std]
...
//
    ...
    {
    struct pci_bus *child = core::ptr::null_mut();
    struct pci_bus *tmp;
...
#[no_mangle]
unsafe extern "C" fn traverse_siblings_and_scan_slot(start: *mut device_node, bus: *mut pci_bus) {
