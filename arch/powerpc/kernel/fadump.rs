...
//! Source: arch/powerpc/kernel/fadump.c
#![no_std]
...
//
pub const CRASH_TIMEOUT: c_int = 500;
...
//
#[no_mangle]
pub unsafe extern "C" fn fadump_cma_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn fadump_append_bootargs() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_fadump_memory_area(addr: u64, size: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn should_fadump_crash() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_fadump_active() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn is_fadump_mem_area_contiguous(d_start: u64, d_end: u64) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_fadump_reserved_mem_contiguous() -> bool {
...
#[no_mangle]
unsafe extern "C" fn fadump_show_config() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn fadump_calculate_reserve_size() -> __init u64 {
...
//
    ...
    &size, &base, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    if (ret == 0 && size > 0) {
...
//
#[no_mangle]
unsafe extern "C" fn get_fadump_area_size() -> unsigned long __init {
...
// This is to hold kernel metadata on platforms that support it
    ...
    unsigned long rsize)
    {
    let mut max_boot_mem_rgns: c_int = fw_dump.ops.fadump_max_boot_mem_rgns();
    let mut i: c_int = fw_dump.boot_mem_regs_cnt++;
...
#[no_mangle]
unsafe extern "C" fn fadump_get_boot_mem_regions() -> int __init {
    static int __init fadump_get_boot_mem_regions(void)
    {
    unsigned long size, cur_size, hole_size, last_end;
    let mut mem_size: c_ulong = fw_dump.boot_memory_size;
    phys_addr_t reg_start, reg_end;
    let mut ret: c_int = 1;
    u64 i;
...
//
#[no_mangle]
unsafe extern "C" fn overlaps_reserved_ranges(base: u64, end: u64, idx: *mut c_int) -> bool __init {
    static bool __init overlaps_reserved_ranges(u64 base, u64 end, int *idx)
    {
    let mut ret: bool = false;
    int i;
    for (i = *idx; i < reserved_mrange_info.mem_range_cnt; i++) {
    let mut rbase: u64 = reserved_mrange_info.mem_ranges[i].base;
    let mut rend: u64 = rbase + reserved_mrange_info.mem_ranges[i].size;
    if (end <= rbase)
    break;
...
//
#[no_mangle]
unsafe extern "C" fn fadump_locate_reserve_mem(base: u64, size: u64) -> u64 __init {
...
#[no_mangle]
pub unsafe extern "C" fn fadump_reserve_mem() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_fadump_param(p: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(p, _arg: "off", 0: 3) ==) -> else {
    else if (strncmp(p, "off", 3) == 0)
    fw_dump.fadump_enabled = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(p, _arg: "nocma", 0: 5) ==) -> else {
    fw_dump.fadump_enabled = 1;
    fw_dump.nocma = 1;
    }
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn early_fadump_reserve_mem(p: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn crash_fadump(regs: *mut pt_regs, str: *const c_char) {
    void crash_fadump(struct pt_regs *regs, const char *str)
    {
    unsigned int msecs;
    struct fadump_crash_info_header *fdh = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn fadump_regs_to_elf_notes(buf: *mut u32, regs: *mut pt_regs) -> *mut u32 __init {
...
#[no_mangle]
pub unsafe extern "C" fn fadump_update_elfcore_header(bufp: *mut c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fadump_alloc_buffer(size: c_ulong) -> *mut void __init {
    static void *__init fadump_alloc_buffer(unsigned long size)
    {
    return  alloc_pages_exact(size, GFP_KERNEL | __GFP_ZERO);
    }
#[no_mangle]
unsafe extern "C" fn fadump_free_buffer(vaddr: c_ulong, size: c_ulong) {
    static void fadump_free_buffer(unsigned long vaddr, unsigned long size)
    {
    free_pages_exact((void *)vaddr, size);
    }
#[no_mangle]
pub unsafe extern "C" fn fadump_setup_cpu_notes_buf(num_cpus: u32) -> s32 __init {
...
#[no_mangle]
pub unsafe extern "C" fn fadump_free_cpu_notes_buf() {
...
#[no_mangle]
unsafe extern "C" fn fadump_free_mem_ranges(mrange_info: *mut fadump_mrange_info) {
...
//
#[no_mangle]
unsafe extern "C" fn fadump_alloc_mem_ranges(mrange_info: *mut fadump_mrange_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fadump_init_elfcore_header(bufp: *mut c_char) -> c_int {
    ...
    elf.e_flags = 2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ENABLED(CONFIG_PPC64_ELF_ABI_V1)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn fadump_relocate(paddr: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn fadump_populate_elfcorehdr(fdh: *mut fadump_crash_info_header) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_fadump_header(addr: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn register_fadump() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fadump_cleanup() {
...
//
#[no_mangle]
unsafe extern "C" fn fadump_release_reserved_area(start: u64, end: u64) {
    ...
    spfn = PHYS_PFN(start);
    epfn = PHYS_PFN(end);
    for_each_mem_pfn_range(i, MAX_NUMNODES, &reg_spfn, &reg_epfn, core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn sort_and_merge_mem_ranges(mrange_info: *mut fadump_mrange_info) {
...
//
#[no_mangle]
unsafe extern "C" fn early_init_dt_scan_reserved_ranges(node: c_ulong) -> void __init {
    static void __init early_init_dt_scan_reserved_ranges(unsigned long node)
    {
    const __be32 *prop;
    int len, ret = -1;
...
//
#[no_mangle]
unsafe extern "C" fn fadump_release_memory(begin: u64, end: u64) {
...
#[no_mangle]
unsafe extern "C" fn fadump_free_elfcorehdr_buf() {
...
#[no_mangle]
unsafe extern "C" fn fadump_invalidate_release_mem() {
...
#[no_mangle]
unsafe extern "C" fn unregister_fadump() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fadump_region_show(m: *mut seq_file, private: *mut c_void) -> c_int {
    ...
    let mut release_attr: static struct kobj_attribute = __ATTR_WO(release_mem);
    let mut enable_attr: static struct kobj_attribute = __ATTR_RO(enabled);
    let mut register_attr: static struct kobj_attribute = __ATTR_RW(registered);
    let mut mem_reserved_attr: static struct kobj_attribute = __ATTR_RO(mem_reserved);
    let mut hotplug_ready_attr: static struct kobj_attribute = __ATTR_RO(hotplug_ready);
    let mut bootargs_append_attr: static struct kobj_attribute = __ATTR_RW(bootargs_append);
...
#[no_mangle]
unsafe extern "C" fn fadump_init_files() -> void __init {
    ...
    debugfs_create_file("fadump_region", 0444, arch_debugfs_dir, core::ptr::null_mut(),
    &fadump_region_fops);
    if (fw_dump.dump_active) {
...
#[no_mangle]
unsafe extern "C" fn fadump_setup_elfcorehdr_buf() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn is_fadump_header_compatible(fdh: *mut fadump_crash_info_header) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn fadump_process() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn fadump_setup_param_area() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn setup_fadump() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fw_dump.reserve_dump_area_size) -> else {
    fw_dump.ops.fadump_init_mem_struct(&fw_dump);
    register_fadump();
    }
//
...
#[no_mangle]
unsafe extern "C" fn fadump_reserve_crash_area(base: u64) -> void __init {
    static void __init fadump_reserve_crash_area(u64 base)
    {
