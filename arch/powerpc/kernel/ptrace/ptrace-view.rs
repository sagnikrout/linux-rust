...
//! Source: arch/powerpc/kernel/ptrace/ptrace-view.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn get_user_msr(task: *mut task_struct) -> c_ulong {
    static unsigned long get_user_msr(struct task_struct *task)
    {
    return task.thread.regs.msr | task.thread.fpexc_mode;
    }
#[no_mangle]
unsafe extern "C" fn set_user_msr(task: *mut task_struct, msr: c_ulong) -> __always_inline int {
...
#[no_mangle]
unsafe extern "C" fn get_user_dscr(task: *mut task_struct, data: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_user_dscr(task: *mut task_struct, dscr: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_user_trap(task: *mut task_struct, trap: c_ulong) -> __always_inline int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ptrace_get_reg(task: *mut task_struct, regno: c_int, data: *mut c_ulong) -> c_int {
    int ptrace_get_reg(struct task_struct *task, int regno, unsigned long *data)
    {
    unsigned int regs_max;
    if (task.thread.regs == core::ptr::null_mut() || !data)
    return -EIO;
    if (regno == PT_MSR) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ptrace_put_reg(task: *mut task_struct, regno: c_int, data: c_ulong) -> c_int {
    int ptrace_put_reg(struct task_struct *task, int regno, unsigned long data)
    {
    if (task.thread.regs == core::ptr::null_mut())
    return -EIO;
    if (regno == PT_MSR)
    ...
    struct membuf to)
    {
    let mut to_msr: membuf = membuf_at(&to, offsetof(struct pt_regs, msr));

    let mut to_softe: membuf = membuf_at(&to, offsetof(struct pt_regs, softe));

    if (target.thread.regs == core::ptr::null_mut())
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn ebb_active(target: *mut task_struct, regset: *const user_regset) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_active(target: *mut task_struct, regset: *const user_regset) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dexcr_active(target: *mut task_struct, regset: *const user_regset) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hashkeyr_active(target: *mut task_struct, regset: *const user_regset) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_active(target: *mut task_struct, regset: *const user_regset) -> c_int {
...
//
    ...
    pos *= sizeof(compat_ulong_t);
    count *= sizeof(compat_ulong_t);
    user_regset_copyin_ignore(&pos, &count, &kbuf, core::ptr::null_mut(),
    ...
    const void *kbuf = core::ptr::null_mut();
    compat_ulong_t reg;
