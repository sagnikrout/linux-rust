...
//! Source: arch/powerpc/kernel/rtas.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtas_function {
    pub token: i32,
    pub banned_for_syscall_on_le:1: bool,
    pub name: *const *const c_char,
    pub filter: *const rtas_filter,
    pub lock: *mut mutex,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_function_token(handle: rtas_fn_handle_t) -> i32 {
    s32 rtas_function_token(const rtas_fn_handle_t handle)
    {
    let mut index: usize = handle.index;
    let mut out_of_bounds: bool = index >= ARRAY_SIZE(rtas_function_table);
...
#[no_mangle]
unsafe extern "C" fn rtas_function_cmp(a: *const c_void, b: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtas_token_to_function_xarray_init() -> int __init {
    static int __init rtas_token_to_function_xarray_init(void)
    {
    const struct rtas_function *func;
    let mut err: c_int = 0;
    for_each_rtas_function(func) {
    let mut token: i32 = func.token;
...
#[no_mangle]
unsafe extern "C" fn __do_enter_rtas(args: *mut rtas_args) {
...
#[no_mangle]
unsafe extern "C" fn __do_enter_rtas_trace(args: *mut rtas_args) {
...
#[no_mangle]
unsafe extern "C" fn do_enter_rtas(args: *mut rtas_args) {
    static void do_enter_rtas(struct rtas_args *args)
    {
    let mut msr: c_ulong = mfmsr();
//
...
//
    let mut mask: c_ulong = MSR_IR | MSR_DR;
...
//
#[no_mangle]
unsafe extern "C" fn call_rtas_display_status(c: c_uchar) {
    ...
    rtas_call_unlocked(&rtas_args, 10, 1, 1, core::ptr::null_mut(), c);
    raw_spin_unlock_irqrestore(&rtas_lock, flags);
    }
#[no_mangle]
unsafe extern "C" fn call_rtas_display_status_delay(c: c_char) {
    static void call_rtas_display_status_delay(char c)
    {
    static int pending_newline = 0;  /* did last write end with unprinted newline? */
    let mut width: static int = 16;
    if (c == '\n') {
    while (width-- > 0)
...
#[no_mangle]
pub unsafe extern "C" fn udbg_init_rtas_panel() -> void __init {
    void __init udbg_init_rtas_panel(void)
    {
    udbg_putc = call_rtas_display_status_delay;
    }
#[no_mangle]
pub unsafe extern "C" fn rtas_progress(s: *mut c_char, hex: c_ushort) {
    ...
    "ibm,display-line-length", core::ptr::null_mut())))
    display_width = be32_to_cpu(*p);
    if ((p = of_get_property(root,
    "ibm,form-feed", core::ptr::null_mut())))
    form_feed = be32_to_cpu(*p);
    if ((p = of_get_property(root,
    "ibm,display-number-of-lines", core::ptr::null_mut())))
    display_lines = be32_to_cpu(*p);
    row_width = of_get_property(root,
    "ibm,display-truncation-length", core::ptr::null_mut());
    of_node_put(root);
    }
...
// use hex display if available
    ...
    rtas_call(set_indicator, 3, 1, core::ptr::null_mut(), 6, 0, hex);
    return;
    }
...
//
    if (pending_newline) {
    rtas_call(display_character, 1, 1, core::ptr::null_mut(), '\r');
    rtas_call(display_character, 1, 1, core::ptr::null_mut(), '\n');
    pending_newline = 0;
    } else {
    current_line = 0;
    if (form_feed)
...
//
    rtas_call(display_character, 1, 1, core::ptr::null_mut(), *os);
    }
    if (row_width)
    width = row_width[current_line];
    else
...
#[no_mangle]
pub unsafe extern "C" fn rtas_token(service: *const c_char) -> c_int {
    int rtas_token(const char *service)
    {
    const struct rtas_function *func;
    const __be32 *tokp;
    if (rtas.dev == core::ptr::null_mut())
    return RTAS_UNKNOWN_SERVICE;
...
//
    ...
    service);
    tokp = of_get_property(rtas.dev, service, core::ptr::null_mut());
    return tokp ? be32_to_cpu(*tokp) : RTAS_UNKNOWN_SERVICE;
    }
    EXPORT_SYMBOL_GPL(rtas_token);

    let mut __ro_after_init: static u32 rtas_error_log_max = RTAS_ERROR_LOG_MAX;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_get_error_log_max() -> c_int {
    int rtas_get_error_log_max(void)
    {
    return rtas_error_log_max;
    }
#[no_mangle]
unsafe extern "C" fn init_error_log_max() -> void __init {
...
//
    ...
    {
    let mut token: i32 = rtas_function_token(RTAS_FN_RTAS_LAST_ERROR);
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_call_unlocked(args: *mut rtas_args, token: c_int, nargs: c_int, nret: c_int, ...) {
...
#[no_mangle]
unsafe extern "C" fn token_is_restricted_errinjct(token: i32) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_call(token: c_int, nargs: c_int, nret: c_int, outputs: *mut c_int, ...) -> c_int {
    ...
    char *buff_copy = core::ptr::null_mut();
    int ret;
...
// A -1 return code indicates that the last command couldn't
    ...
    buff_copy = __fetch_rtas_last_error(core::ptr::null_mut());
    if (nret > 1 && outputs != core::ptr::null_mut())
    for (i = 0; i < nret-1; ++i)
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_busy_delay_time(status: c_int) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn rtas_busy_delay_early(status: c_int) -> bool __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_busy_delay(status: c_int) -> bool __ref {
...
#[no_mangle]
pub unsafe extern "C" fn rtas_error_rc(rtas_rc: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtas_get_power_level(powerdomain: c_int, level: *mut c_int) -> c_int {
    int rtas_get_power_level(int powerdomain, int *level)
    {
    let mut token: c_int = rtas_function_token(RTAS_FN_GET_POWER_LEVEL);
    int rc;
    if (token == RTAS_UNKNOWN_SERVICE)
    return -ENOENT;
...
#[no_mangle]
pub unsafe extern "C" fn rtas_set_power_level(powerdomain: c_int, level: c_int, setlevel: *mut c_int) -> c_int {
    int rtas_set_power_level(int powerdomain, int level, int *setlevel)
    {
    let mut token: c_int = rtas_function_token(RTAS_FN_SET_POWER_LEVEL);
    int rc;
    if (token == RTAS_UNKNOWN_SERVICE)
    return -ENOENT;
    do {
...
#[no_mangle]
pub unsafe extern "C" fn rtas_get_sensor(sensor: c_int, index: c_int, state: *mut c_int) -> c_int {
    int rtas_get_sensor(int sensor, int index, int *state)
    {
    let mut token: c_int = rtas_function_token(RTAS_FN_GET_SENSOR_STATE);
    int rc;
    if (token == RTAS_UNKNOWN_SERVICE)
    return -ENOENT;
    do {
...
#[no_mangle]
pub unsafe extern "C" fn rtas_get_sensor_fast(sensor: c_int, index: c_int, state: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtas_indicator_present(token: c_int, maxindex: *mut c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rtas_set_indicator(indicator: c_int, index: c_int, new_value: c_int) -> c_int {
    int rtas_set_indicator(int indicator, int index, int new_value)
    {
    let mut token: c_int = rtas_function_token(RTAS_FN_SET_INDICATOR);
    int rc;
    if (token == RTAS_UNKNOWN_SERVICE)
    return -ENOENT;
    do {
    rc = rtas_call(token, 3, 1, core::ptr::null_mut(), indicator, index, new_value);
    } while (rtas_busy_delay(rc));
    if (rc < 0)
    return rtas_error_rc(rc);
    return rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_set_indicator_fast(indicator: c_int, index: c_int, new_value: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_ibm_suspend_me(fw_status: *mut c_int) -> c_int {
    int rtas_ibm_suspend_me(int *fw_status)
    {
    let mut token: c_int = rtas_function_token(RTAS_FN_IBM_SUSPEND_ME);
    int fwrc;
    int ret;
    fwrc = rtas_call(token, 0, 1, core::ptr::null_mut());
    switch (fwrc) {
    case 0:
    ret = 0;
    break;
...
#[no_mangle]
pub unsafe extern "C" fn rtas_restart(cmd: *mut c_char) -> void __noreturn {
    void __noreturn rtas_restart(char *cmd)
    {
    if (rtas_flash_term_hook)
    rtas_flash_term_hook(SYS_RESTART);
    pr_emerg("system-reboot returned %d\n",
    rtas_call(rtas_function_token(RTAS_FN_SYSTEM_REBOOT), 0, 1, core::ptr::null_mut()));
    for (;;);
    }
#[no_mangle]
pub unsafe extern "C" fn rtas_power_off() {
...
// allow power on only with power button press
    ...
    rtas_call(rtas_function_token(RTAS_FN_POWER_OFF), 2, 1, core::ptr::null_mut(), -1, -1));
    for (;;);
    }
#[no_mangle]
pub unsafe extern "C" fn rtas_halt() -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn rtas_os_term(str: *mut c_char) {
    void rtas_os_term(char *str)
    {
    let mut token: i32 = rtas_function_token(RTAS_FN_IBM_OS_TERM);
...
//
    do {
    rtas_call_unlocked(&args, token, 1, 1, core::ptr::null_mut(), __pa(rtas_os_term_buf));
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_activate_firmware() {
    void rtas_activate_firmware(void)
    {
    let mut token: c_int = rtas_function_token(RTAS_FN_IBM_ACTIVATE_FIRMWARE);
    int fwrc;
    if (token == RTAS_UNKNOWN_SERVICE) {
...
//
    ...
    let mut ext_log_length: u32 = rtas_error_extended_log_length(log);
    let mut log_format: u8 = rtas_ext_event_log_format(ext_log);
    let mut company_id: u32 = rtas_ext_event_company_id(ext_log);
...
//
#[no_mangle]
unsafe extern "C" fn in_rmo_buf(base: u32, end: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: f->fixed_size) -> else {
...
// We assume to be passed big endian arguments
    ...
    struct rtas_args args;
    unsigned long flags;
    char *buff_copy, *errbuf = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn sizeof(0: rtas_arg_t)) !=) -> *mut nargs {
...
#[no_mangle]
pub unsafe extern "C" fn if(-EIO: rc ==) -> else {
    else if (rc == -EIO)
...
// Copy out args.
    ...
    args.args + nargs,
#[no_mangle]
pub unsafe extern "C" fn sizeof(0: rtas_arg_t)) !=) -> *mut nret {
    nret * sizeof(rtas_arg_t)) != 0)
    return -EFAULT;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn rtas_function_table_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtas_initialize() -> void __init {
    void __init rtas_initialize(void)
    {
    let mut rtas_region: c_ulong = RTAS_INSTANTIATE_MAX;
    u32 base, size, entry;
    int no_base, no_size, no_entry;
// Get RTAS dev node and fill up our "rtas" structure with infos
// about it.
//
    rtas.dev = of_find_node_by_name(core::ptr::null_mut(), "rtas");
    if (!rtas.dev)
    return;
...
//
    ...
    return 0;
    basep  = of_get_flat_dt_prop(node, "linux,rtas-base", core::ptr::null_mut());
    entryp = of_get_flat_dt_prop(node, "linux,rtas-entry", core::ptr::null_mut());
    sizep  = of_get_flat_dt_prop(node, "rtas-size", core::ptr::null_mut());

// need this feature to decide the crashkernel offset
    if (of_get_flat_dt_prop(node, "ibm,hypertas-functions", core::ptr::null_mut()))
...
// break now
    ...
    let mut timebase: static u64 = 0;
#[no_mangle]
pub unsafe extern "C" fn rtas_give_timebase() {
    void rtas_give_timebase(void)
    {
    unsigned long flags;
    raw_spin_lock_irqsave(&timebase_lock, flags);
    hard_irq_disable();
    rtas_call(rtas_function_token(RTAS_FN_FREEZE_TIME_BASE), 0, 1, core::ptr::null_mut());
    timebase = get_tb();
    raw_spin_unlock(&timebase_lock);
    while (timebase)
    barrier();
    rtas_call(rtas_function_token(RTAS_FN_THAW_TIME_BASE), 0, 1, core::ptr::null_mut());
    local_irq_restore(flags);
    }
#[no_mangle]
pub unsafe extern "C" fn rtas_take_timebase() {
