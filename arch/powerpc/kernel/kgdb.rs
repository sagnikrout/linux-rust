...
//! Source: arch/powerpc/kernel/kgdb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn computeSignal(tt: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_debugger_ipi(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_debugger(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_handle_breakpoint(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_singlestep(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_iabr_match(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_break_match(regs: *mut pt_regs) -> c_int {
...
pub unsafe extern "C" fn kgdb_arch_remove_breakpoint(bpt: *mut kgdb_bkpt) -> c_int {
    ...
    {
    int err;
    let mut instr: c_uint = *(unsigned int *)bpt.saved_instr;
...
#[no_mangle]
unsafe extern "C" fn kgdb_not_implemented(regs: *mut pt_regs) -> c_int {
