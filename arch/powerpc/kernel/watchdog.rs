...
//! Source: arch/powerpc/kernel/watchdog.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn wd_try_report() -> bool {
...
#[no_mangle]
unsafe extern "C" fn wd_end_reporting() {
...
#[no_mangle]
pub unsafe extern "C" fn wd_smp_lock(flags: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn wd_smp_unlock(flags: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn wd_lockup_ipi(regs: *mut pt_regs) {
    static void wd_lockup_ipi(struct pt_regs *regs)
    {
    let mut cpu: c_int = raw_smp_processor_id();
    let mut tb: u64 = get_tb();
...
#[no_mangle]
unsafe extern "C" fn set_cpu_stuck(cpu: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn watchdog_smp_panic(cpu: c_int) {
...
//
    ...
    if (hardlockup_panic)
    nmi_panic(core::ptr::null_mut(), "Hard LOCKUP");
    wd_end_reporting();
    return;
    out:
    wd_smp_unlock(&flags);
...
#[no_mangle]
unsafe extern "C" fn wd_smp_clear_cpu_pending(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn watchdog_timer_interrupt(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn arch_touch_nmi_watchdog() {
    void arch_touch_nmi_watchdog(void)
    {
    let mut ticks: c_ulong = tb_ticks_per_usec * wd_timer_period_ms * 1000;
    let mut cpu: c_int = smp_processor_id();
    u64 tb;
    if (!cpumask_test_cpu(cpu, &watchdog_cpumask))
    return;
...
#[no_mangle]
unsafe extern "C" fn start_watchdog(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn start_watchdog_on_cpu(cpu: c_uint) -> c_int {
    static int start_watchdog_on_cpu(unsigned int cpu)
    {
    return smp_call_function_single(cpu, start_watchdog, core::ptr::null_mut(), true);
    }
#[no_mangle]
unsafe extern "C" fn stop_watchdog(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn stop_watchdog_on_cpu(cpu: c_uint) -> c_int {
    static int stop_watchdog_on_cpu(unsigned int cpu)
    {
    return smp_call_function_single(cpu, stop_watchdog, core::ptr::null_mut(), true);
    }
#[no_mangle]
unsafe extern "C" fn watchdog_calc_timeouts() {
    static void watchdog_calc_timeouts(void)
    {
    let mut threshold: u64 = watchdog_thresh;
...
#[no_mangle]
pub unsafe extern "C" fn watchdog_hardlockup_stop() {
...
#[no_mangle]
pub unsafe extern "C" fn watchdog_hardlockup_start() {
...
#[no_mangle]
pub unsafe extern "C" fn watchdog_hardlockup_set_timeout_pct(pct: u64) {
