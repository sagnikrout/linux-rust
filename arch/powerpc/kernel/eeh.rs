...
//! Source: arch/powerpc/kernel/eeh.c
#![no_std]
...
//
pub const EEH_MAX_FAILS: c_int = 2100000;
...
// Platform dependent EEH operations
    struct eeh_ops *eeh_ops = core::ptr::null_mut();
...
// can access it.
//
pub const EEH_PCI_REGS_LOG_LEN: c_int = 8192;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eeh_stats {
    pub /: *mut *mut u64 no_device; / PCI device not found,
    pub /: *mut *mut u64 no_dn; / OF node not found,
    pub /: *mut *mut u64 no_cfg_addr; / Config address not found,
    pub /: *mut *mut u64 ignored_check; / EEH check skipped,
    pub /: *mut *mut u64 total_mmio_ffs; / Total EEH checks,
    pub /: *mut *mut u64 false_positives; / Unnecessary EEH checks,
    pub /: *mut *mut u64 slot_resets; / PE reset,
}

    static struct eeh_stats eeh_stats;
#[no_mangle]
unsafe extern "C" fn eeh_setup(str: *mut c_char) -> int __init {
    static int __init eeh_setup(char *str)
    {
    if (!strcmp(str, "off"))
    eeh_add_flag(EEH_FORCE_DISABLED);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "early_log")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn eeh_show_enabled() {
    void eeh_show_enabled(void)
    {
    if (eeh_has_flag(EEH_FORCE_DISABLED))
    pr_info("EEH: Recovery disabled by kernel parameter.\n");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: eeh_has_flag(EEH_ENABLED)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_dump_dev_log(edev: *mut eeh_dev, buf: *mut c_char, len: usize) -> usize {
    static size_t eeh_dump_dev_log(struct eeh_dev *edev, char *buf, size_t len)
    {
    u32 cfg;
    int cap, i;
    let mut n: c_int = 0, l = 0;
    char buffer[128];
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_slot_error_detail(pe: *mut eeh_pe, severity: c_int) {
    void eeh_slot_error_detail(struct eeh_pe *pe, int severity)
    {
    let mut loglen: usize = 0;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_token_to_phys(token: c_ulong) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_phb_check_failure(pe: *mut eeh_pe) -> c_int {
...
// Check PHB state
    ret = eeh_ops.get_state(phb_pe, core::ptr::null_mut());
    if ((ret < 0) ||
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_dev_check_failure(edev: *mut eeh_dev) -> c_int {
    ...
    let mut rc: c_int = 0;
    const char *location = core::ptr::null_mut();
...
//
    ret = eeh_ops.get_state(pe, core::ptr::null_mut());
...
// Hit the ceiling ?
    ...
    break;
// Frozen parent PE ?
    ret = eeh_ops.get_state(parent_pe, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_check_failure(token: *const volatile void __iomem) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pci_enable(pe: *mut eeh_pe, function: c_int) -> c_int {
...
//
    if (active_flag) {
    rc = eeh_ops.get_state(pe, core::ptr::null_mut());
    if (rc < 0)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn eeh_restore_dev_state(edev: *mut eeh_dev, userdata: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcibios_set_pcie_reset_state(dev: *mut pci_dev, state: enum pcie_reset_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_set_dev_freset(edev: *mut eeh_dev, flag: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn eeh_pe_refreeze_passed(root: *mut eeh_pe) {
    ...
    if (eeh_pe_passed(pe)) {
    state = eeh_ops.get_state(pe, core::ptr::null_mut());
    if (state &
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_reset_full(pe: *mut eeh_pe, include_passed: bool) -> c_int {
    int eeh_pe_reset_full(struct eeh_pe *pe, bool include_passed)
    {
    let mut reset_state: c_int = (EEH_PE_RESET | EEH_PE_CFG_BLOCKED);
    let mut type: c_int = EEH_RESET_HOT;
    let mut freset: c_uint = 0;
    int i, state = 0, ret;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_save_bars(edev: *mut eeh_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_init(ops: *mut eeh_ops) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_probe_device(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_remove_device(dev: *mut pci_dev) {
...
//
    edev.in_error = false;
    dev.dev.archdata.edev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn eeh_unfreeze_pe(pe: *mut eeh_pe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeh_pe_change_owner(pe: *mut eeh_pe) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_dev_open(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_dev_release(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_set_option(pe: *mut eeh_pe, option: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_get_state(pe: *mut eeh_pe) -> c_int {
...
//
    ...
    result = eeh_ops.get_state(pe, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(mmio_en: dma_en &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn eeh_pe_reenable_devices(pe: *mut eeh_pe, include_passed: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_reset(pe: *mut eeh_pe, option: c_int, include_passed: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_configure(pe: *mut eeh_pe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_eeh_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeh_break_device(pdev: *mut pci_dev) -> c_int {
    static int eeh_break_device(struct pci_dev *pdev)
    {
    struct resource *bar = core::ptr::null_mut();
    void __iomem *mapped;
    u16 old, bit;
    int i, pos;
...
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_inject_mmio_error(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeh_enable_dbgfs_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeh_enable_dbgfs_get(data: *mut c_void, val: *mut u64) -> c_int {
...
//
    ...
    __eeh_send_failure_event(core::ptr::null_mut());
    return count;
    }
...
#[no_mangle]
unsafe extern "C" fn eeh_init_proc() -> int __init {
    static int __init eeh_init_proc(void)
    {
    if (machine_is(pseries) || machine_is(powernv)) {
    proc_create_single("powerpc/eeh", 0, core::ptr::null_mut(), proc_eeh_show);
