...
//! Source: arch/powerpc/kernel/prom_init.c
#![no_std]
...
//
pub const DEVTREE_CHUNK_SIZE: c_uint = 0x100000;
//
...
// compatibility
//
pub const MEM_RESERVE_MAP_SIZE: c_int = 8;
//
...
//
pub const CAS_MAX_PVR_ENTRIES: c_int = 16;

pub const OF_WORKAROUNDS: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn enter_prom(args: *mut prom_args, entry: c_ulong) -> c_int {
...
//
pub const PLATFORM_PSERIES: c_uint = 0x0100;
pub const PLATFORM_PSERIES_LPAR: c_uint = 0x0101;
pub const PLATFORM_LPAR: c_uint = 0x0001;
pub const PLATFORM_POWERMAC: c_uint = 0x0400;
pub const PLATFORM_GENERIC: c_uint = 0x0500;
...
#[no_mangle]
unsafe extern "C" fn prom_strcmp(cs: *const c_char, ct: *const c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn prom_strscpy_pad(dest: *mut c_char, src: *const c_char, n: usize) -> ssize_t __init {
...
#[no_mangle]
unsafe extern "C" fn prom_strncmp(cs: *const c_char, ct: *const c_char, count: usize) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn prom_strlen(s: *const c_char) -> size_t __init {
...
#[no_mangle]
unsafe extern "C" fn prom_memcmp(cs: *const c_void, ct: *const c_void, count: usize) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn prom_strlcat(dest: *mut c_char, src: *const c_char, count: usize) -> size_t __init {
    static size_t __init prom_strlcat(char *dest, const char *src, size_t count)
    {
    let mut dsize: usize = prom_strlen(dest);
    let mut len: usize = prom_strlen(src);
    let mut res: usize = dsize + len;
// This would be a bug
    if (dsize >= count)
    return count;
    dest += dsize;
...
#[no_mangle]
unsafe extern "C" fn prom_strtobool(s: *const c_char, res: *mut bool) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn call_prom(service: *const c_char, nargs: c_int, nret: c_int, ...) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn prom_print(msg: *const c_char) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn prom_print_hex(val: c_ulong) -> void __init {
...
pub const UL_DIGITS: c_int = 21;
#[no_mangle]
unsafe extern "C" fn prom_print_dec(val: c_ulong) -> void __init {
...
// shift stuff down
    ...
    __printf(1, 2)
#[no_mangle]
unsafe extern "C" fn prom_printf(format: *const c_char, ...) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __attribute__(reason: *const (noreturn)) prom_panic(char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn prom_next_node(nodep: *mut phandle) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn prom_getproplen(node: phandle, pname: *const c_char) -> int __init {
    static inline int __init prom_getproplen(phandle node, const char *pname)
    {
    return call_prom("getproplen", 2, 1, node, ADDR(pname));
    }
#[no_mangle]
unsafe extern "C" fn add_string(str: *mut c_char, q: *const c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn tohex(x: c_uint) -> *mut char __init {
...
#[no_mangle]
unsafe extern "C" fn prom_strtoul(cp: *const c_char, endp: *const c_char) -> unsigned long __init {
    static unsigned long __init prom_strtoul(const char *cp, const char **endp)
    {
    let mut result: c_ulong = 0, base = 10, value;
    if (*cp == '0') {
    base = 8;
    cp++;
...
#[no_mangle]
unsafe extern "C" fn prom_memparse(ptr: *const c_char, retptr: *const c_char) -> unsigned long __init {
    static unsigned long __init prom_memparse(const char *ptr, const char **retptr)
    {
    let mut ret: c_ulong = prom_strtoul(ptr, retptr);
...
//
#[no_mangle]
unsafe extern "C" fn early_cmdline_parse() -> void __init {
    ...
    prom_iommu_off = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !prom_strncmp(opt, _arg: "force", _arg: 5)) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct option_vector1 {
    pub byte1: u8,
    pub arch_versions: u8,
    pub arch_versions3: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct option_vector2 {
    pub byte1: u8,
    pub reserved: __be16,
    pub real_base: __be32,
    pub real_size: __be32,
    pub virt_base: __be32,
    pub virt_size: __be32,
    pub load_base: __be32,
    pub min_rma: __be32,
    pub min_load: __be32,
    pub min_rma_percent: u8,
    pub max_pft_size: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct option_vector3 {
    pub byte1: u8,
    pub byte2: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct option_vector4 {
    pub byte1: u8,
    pub min_vp_cap: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct option_vector5 {
    pub byte1: u8,
    pub byte2: u8,
    pub byte3: u8,
    pub cmo: u8,
    ...
    pub bin_opts: u8,
    pub micro_checkpoint: u8,
    pub reserved0: u8,
    pub max_cpus: __be32,
    pub papr_level: __be16,
    pub reserved1: __be16,
    pub platform_facilities: u8,
    pub reserved2: u8,
    pub reserved3: __be16,
    pub subprocessors: u8,
    pub byte22: u8,
    pub intarch: u8,
    pub mmu: u8,
    pub hash_ext: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct option_vector6 {
    pub reserved: u8,
    pub secondary_pteg: u8,
    pub os_name: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct option_vector7 {
    pub os_id: [u8; 256],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ibm_arch_vec {
    pub pvrs: [{ __be32 mask, val; }; 18],
    pub num_vectors: u8,
    pub vec1_len: u8,
    pub vec1: option_vector1,
    pub vec2_len: u8,
    pub vec2: option_vector2,
    pub vec3_len: u8,
    pub vec3: option_vector3,
    pub vec4_len: u8,
    pub vec4: option_vector4,
    pub vec5_len: u8,
    pub vec5: option_vector5,
    pub vec6_len: u8,
    pub vec6: option_vector6,
    pub vec7_len: u8,
    pub vec7: option_vector7,
    pub __packed: },
...
pub struct chrpnote {
    ...
    pub descsz: u32,
    pub type: u32,
    pub /: *mut *mut char name[8]; / "PowerPC",
#[repr(C)]
#[derive(Copy, Clone)]
pub struct chrpdesc {
    pub real_mode: u32,
...
pub struct rpanote {
    ...
    pub descsz: u32,
    pub type: u32,
    pub /: *mut *mut char name[24]; / "IBM,RPA-Client-Config",
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpadesc {
    pub lpar_affinity: u32,
    pub min_rmo_size: u32,
    pub min_rmo_percent: u32,
    pub max_pft_size: u32,
    pub splpar: u32,
    pub min_load: u32,
    pub new_mem_def: u32,
    pub ignore_me: u32,
...
#[no_mangle]
unsafe extern "C" fn prom_count_smt_threads() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn prom_check_platform_support() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn prom_send_capabilities() -> void __init {
    static void __init prom_send_capabilities(void)
    {
    ihandle root;
    prom_arg_t ret;
    u32 cores;
    let mut start_index: c_int = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn alloc_up(size: c_ulong, align: c_ulong) -> unsigned long __init {
    static unsigned long __init alloc_up(unsigned long size, unsigned long align)
    {
    let mut base: c_ulong = alloc_bottom;
...
//
#[no_mangle]
unsafe extern "C" fn prom_next_cell(s: c_int, cellp: *mut cell_t) -> unsigned long __init {
...
//
#[no_mangle]
unsafe extern "C" fn reserve_mem(base: u64, size: u64) -> void __init {
    static void __init reserve_mem(u64 base, u64 size)
    {
    let mut top: u64 = base + size;
    let mut cnt: c_ulong = mem_reserve_cnt;
    if (size == 0)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn prom_init_mem() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn prom_close_stdin() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn prom_rtas_hcall(args: u64) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn prom_rtas_os_term(str: *mut c_char) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn prom_instantiate_rtas() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn prom_instantiate_sml() -> void __init {
    static void __init prom_instantiate_sml(void)
    {
    phandle ibmvtpm_node;
    ihandle ibmvtpm_inst;
    let mut entry: u32 = 0, size = 0, succ = 0;
    u64 base;
    __be32 val;
...
#[no_mangle]
unsafe extern "C" fn prom_initialize_tce_table() -> void __init {
...
// Search all nodes looking for PHBs.
    ...
    if ((type[0] == 0) || (prom_strstr(type, "pci") == core::ptr::null_mut()))
    continue;
// Keep the old logic intact to avoid regression.
    if (compatible[0] != 0) {
    if ((prom_strstr(compatible, "python") == core::ptr::null_mut()) &&
    (prom_strstr(compatible, "Speedwagon") == core::ptr::null_mut()) &&
    (prom_strstr(compatible, "Winnipeg") == core::ptr::null_mut()))
    continue;
    } else if (model[0] != 0) {
    if ((prom_strstr(model, "ython") == core::ptr::null_mut()) &&
    (prom_strstr(model, "peedwagon") == core::ptr::null_mut()) &&
    (prom_strstr(model, "innipeg") == core::ptr::null_mut()))
    continue;
    }
...
#[no_mangle]
unsafe extern "C" fn prom_hold_cpus() -> void __init {
    ...
    let mut secondary_hold: c_ulong = LOW_ADDR(__secondary_hold);
//
...
#[no_mangle]
unsafe extern "C" fn prom_init_client_services(pp: c_ulong) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn prom_find_mmu() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: prom_strncmp(version, _arg: "FirmWorks, _arg: 3.", 0: 12) ==) -> else {
...
// Macro flag: #define prom_find_mmu()

#[no_mangle]
unsafe extern "C" fn prom_init_stdout() -> void __init {
...
// If it's a display, note it
    ...
    prom_setprop(stdout_node, path, "linux,boot-display", core::ptr::null_mut(), 0);
    }
    }
#[no_mangle]
unsafe extern "C" fn prom_find_machine_type() -> int __init {
...
// Look for a PowerMac or a Cell
    ...
    while (i < len) {
    char *p = &compat[i];
    let mut sl: c_int = prom_strlen(p);
    if (sl == 0)
    break;
...
#[no_mangle]
unsafe extern "C" fn prom_set_color(ih: ihandle, i: c_int, r: c_int, g: c_int, b: c_int) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn prom_check_displays() -> void __init {
...
// Success
    prom_printf("done\n");
    prom_setprop(node, path, "linux,opened", core::ptr::null_mut(), 0);
...
// method is available. Should update this to set-colors
    ...
    if (prom_getprop(node, "linux,boot-display", core::ptr::null_mut(), 0) !=
    PROM_ERROR) {
...
#[no_mangle]
unsafe extern "C" fn dt_find_string(str: *mut c_char) -> unsigned long __init {
...
//
pub const MAX_PROPERTY_NAME: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn flatten_device_tree() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_device_tree_chrp() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fixup_device_tree_pmac64() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fixup_device_tree_pmac() -> void __init {
    static void __init fixup_device_tree_pmac(void)
    {
    let mut val: __be32 = 1;
    char type[8];
    phandle node;
// Some pmacs are missing #size-cells on escc or i2s nodes
    ...
    continue;
    prom_setprop(node, core::ptr::null_mut(), "#size-cells", &val, sizeof(val));
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fixup_device_tree_efika_add_phy() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fixup_device_tree_efika() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_device_tree_pasemi() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fixup_device_tree() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn prom_find_boot_cpu() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn prom_check_initrd(r3: c_ulong, r4: c_ulong) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn enter_secure_mode(kbase: c_ulong, fdt: c_ulong) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn setup_secure_guest(kbase: c_ulong, fdt: c_ulong) -> void __init {
...
//
    ...
    let mut offset: c_ulong = reloc_offset();
    reloc_got2(offset);
...
//
    if (prom_memory_limit) {
    let mut val: __be64 = cpu_to_be64(prom_memory_limit);
