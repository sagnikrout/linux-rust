...
//! Source: arch/powerpc/kernel/eeh_cache.c
#![no_std]
...
pub struct pci_io_addr_range {
    ...
    n = n.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(piar->addr_hi: addr >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_addr_cache_print(cache: *mut pci_io_addr_cache) {
...
#[no_mangle]
unsafe extern "C" fn __eeh_addr_cache_insert_dev(dev: *mut pci_dev) {
...
//
    ...
    let mut start: resource_size_t = pci_resource_start(dev,i);
    let mut end: resource_size_t = pci_resource_end(dev,i);
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_addr_cache_insert_dev(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn __eeh_addr_cache_rmv_dev(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_addr_cache_rmv_dev(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_addr_cache_init() {
    void eeh_addr_cache_init(void)
    {
    spin_lock_init(&pci_io_addr_cache_root.piar_lock);
    }
#[no_mangle]
unsafe extern "C" fn eeh_addr_cache_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn eeh_cache_debugfs_init() -> void __init {
