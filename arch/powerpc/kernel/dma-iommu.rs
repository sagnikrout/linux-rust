...
//! Source: arch/powerpc/kernel/dma-iommu.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn arch_dma_map_phys_direct(dev: *mut device, addr: phys_addr_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_dma_unmap_phys_direct(dev: *mut device, dma_handle: dma_addr_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_dma_alloc_direct(dev: *mut device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_dma_free_direct(dev: *mut device, dma_handle: dma_addr_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dma_iommu_bypass_supported(dev: *mut device, mask: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn dma_iommu_dma_supported(dev: *mut device, mask: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dma_iommu_get_required_mask(dev: *mut device) -> u64 {
    u64 dma_iommu_get_required_mask(struct device *dev)
    {
    struct iommu_table *tbl = get_iommu_table_base(dev);
    u64 mask;
    if (dev_is_pci(dev)) {
    let mut bypass_mask: u64 = dma_direct_get_required_mask(dev);
