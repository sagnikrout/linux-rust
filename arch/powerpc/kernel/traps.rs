...
//! Source: arch/powerpc/kernel/traps.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pmac_backlight_unblank() {
...
//
#[no_mangle]
pub unsafe extern "C" fn die_will_crash() -> bool {
    ...
    let mut die_lock: static arch_spinlock_t = __ARCH_SPIN_LOCK_UNLOCKED;
    let mut die_owner: static int = -1;
    static unsigned int die_nest_count;
    static int die_counter;
#[no_mangle]
pub unsafe extern "C" fn panic_flush_kmsg_start() {
...
#[no_mangle]
pub unsafe extern "C" fn panic_flush_kmsg_end() {
...
#[no_mangle]
unsafe extern "C" fn oops_begin(regs: *mut pt_regs) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn __die(str: *const c_char, regs: *mut pt_regs, err: c_long) -> c_int {
...
//
    ...
    NOKPROBE_SYMBOL(die);
#[no_mangle]
pub unsafe extern "C" fn user_single_step_report(regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn _exception_pkey(regs: *mut pt_regs, addr: c_ulong, key: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn _exception(signr: c_int, regs: *mut pt_regs, code: c_int, addr: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_nmi_check_nonrecoverable(regs: *mut pt_regs) -> noinstr void {
    noinstr void hv_nmi_check_nonrecoverable(struct pt_regs *regs)
    {

    let mut kbase: c_ulong = (unsigned long)_stext;
...
// Trampoline code runs un-relocated so subtract kbase.
    ...
    let mut saved_hsrrs: bool = false;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn check_io_access(regs: *mut pt_regs) -> c_int {
    ...
    && (entry = search_exception_tables(regs.nip)) != core::ptr::null_mut()) {
//
...
//
    ...
    nip -= 2;
#[no_mangle]
pub unsafe extern "C" fn if(PPC_RAW_ISYNC(): *mut *mut nip ==) -> else {
...
pub const REASON_PREFIXED: c_int = 0;
pub const REASON_BOUNDARY: c_int = 0;
// single-step stuff
...
#[no_mangle]
pub unsafe extern "C" fn machine_check_e500mc(regs: *mut pt_regs) -> c_int {
    int machine_check_e500mc(struct pt_regs *regs)
    {
    let mut mcsr: c_ulong = mfspr(SPRN_MCSR);
    let mut pvr: c_ulong = mfspr(SPRN_PVR);
    let mut reason: c_ulong = mcsr;
    let mut recoverable: c_int = 1;
    if (reason & MCSR_LD) {
...
#[no_mangle]
pub unsafe extern "C" fn machine_check_e500(regs: *mut pt_regs) -> c_int {
    int machine_check_e500(struct pt_regs *regs)
    {
    let mut reason: c_ulong = mfspr(SPRN_MCSR);
...
#[no_mangle]
pub unsafe extern "C" fn machine_check_generic(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn die_mce(str: *const c_char, regs: *mut pt_regs, err: c_long) {
...
//
#[no_mangle]
unsafe extern "C" fn __machine_check_exception(regs: *mut pt_regs) {
    static void __machine_check_exception(struct pt_regs *regs)
    {
    let mut recover: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cur_cpu_spec->machine_check) -> else {
...
#[no_mangle]
unsafe extern "C" fn p9_hmi_special_emu(regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn __single_step_exception(regs: *mut pt_regs) {
...
//
#[no_mangle]
pub unsafe extern "C" fn emulate_single_step(regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn __parse_fpscr(fpscr: c_ulong) -> c_int {
    static inline int __parse_fpscr(unsigned long fpscr)
    {
    let mut ret: c_int = FPE_FLTUNK;
// Invalid operation
    if ((fpscr & FPSCR_VE) && (fpscr & FPSCR_VX))
    ret = FPE_FLTINV;
// Overflow
#[no_mangle]
pub unsafe extern "C" fn if(FPSCR_OX): (fpscr & FPSCR_OE) && (fpscr &) -> else {
    else if ((fpscr & FPSCR_OE) && (fpscr & FPSCR_OX))
    ret = FPE_FLTOVF;
// Underflow
#[no_mangle]
pub unsafe extern "C" fn if(FPSCR_UX): (fpscr & FPSCR_UE) && (fpscr &) -> else {
    else if ((fpscr & FPSCR_UE) && (fpscr & FPSCR_UX))
    ret = FPE_FLTUND;
// Divide by zero
#[no_mangle]
pub unsafe extern "C" fn if(FPSCR_ZX): (fpscr & FPSCR_ZE) && (fpscr &) -> else {
    else if ((fpscr & FPSCR_ZE) && (fpscr & FPSCR_ZX))
    ret = FPE_FLTDIV;
// Inexact result
#[no_mangle]
pub unsafe extern "C" fn if(FPSCR_XX): (fpscr & FPSCR_XE) && (fpscr &) -> else {
...
#[no_mangle]
unsafe extern "C" fn parse_fpe(regs: *mut pt_regs) {
...
//
#[no_mangle]
unsafe extern "C" fn emulate_string_inst(regs: *mut pt_regs, instword: u32) -> c_int {
    static int emulate_string_inst(struct pt_regs *regs, u32 instword)
    {
    let mut rT: u8 = (instword >> 21) & 0x1f;
    let mut rA: u8 = (instword >> 16) & 0x1f;
    let mut NB_RB: u8 = (instword >> 11) & 0x1f;
    u32 num_bytes;
    unsigned long EA;
    let mut pos: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn emulate_popcntb_inst(regs: *mut pt_regs, instword: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emulate_isel(regs: *mut pt_regs, instword: u32) -> c_int {
    static int emulate_isel(struct pt_regs *regs, u32 instword)
    {
    let mut rT: u8 = (instword >> 21) & 0x1f;
    let mut rA: u8 = (instword >> 16) & 0x1f;
    let mut rB: u8 = (instword >> 11) & 0x1f;
    let mut BC: u8 = (instword >> 6) & 0x1f;
    u8 bit;
    unsigned long tmp;
...
#[no_mangle]
pub unsafe extern "C" fn tm_abort_check(regs: *mut pt_regs, cause: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tm_abort_check(regs: *mut pt_regs, reason: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn emulate_instruction(regs: *mut pt_regs) -> c_int {
...
// Emulate the mcrxr insn.
    ...
    let mut shift: c_int = (instword >> 21) & 0x1c;
    let mut msk: c_ulong = 0xf0000000UL >> shift;
...
#[no_mangle]
unsafe extern "C" fn emulate_math(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_program_check(regs: *mut pt_regs) {
    static void do_program_check(struct pt_regs *regs)
    {
    let mut reason: c_uint = get_reason(regs);
...
#[no_mangle]
unsafe extern "C" fn tm_unavailable(regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn handle_debug(regs: *mut pt_regs, debug_status: c_ulong) {
...
// Make sure the IDM flag is off
    ...
    {
    let mut debug_status: c_ulong = regs.dsisr;
...
// XXX quick hack for now: set the non-Java bit in the VSCR
    ...
    {
    let mut error_code: c_ulong = regs.dsisr;
...
#[no_mangle]
pub unsafe extern "C" fn if(PR_FP_EXC_UND): (spefscr & SPEFSCR_FUNF) && (fpexc_mode &) -> else {
    code = FPE_FLTUND;
    }
#[no_mangle]
pub unsafe extern "C" fn if(PR_FP_EXC_DIV): (spefscr & SPEFSCR_FDBZ) && (fpexc_mode &) -> else {
    else if ((spefscr & SPEFSCR_FDBZ) && (fpexc_mode & PR_FP_EXC_DIV))
    code = FPE_FLTDIV;
#[no_mangle]
pub unsafe extern "C" fn if(PR_FP_EXC_INV): (spefscr & SPEFSCR_FINV) && (fpexc_mode &) -> else {
    code = FPE_FLTINV;
    }
#[no_mangle]
pub unsafe extern "C" fn if(PR_FP_EXC_RES): (spefscr & (SPEFSCR_FG | SPEFSCR_FX)) && (fpexc_mode &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn unrecoverable_exception(regs: *mut pt_regs) -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn ppc_warn_emulated_print(type: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn ppc_warn_emulated_init() -> int __init {
