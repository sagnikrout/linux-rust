...
//! Source: arch/powerpc/kernel/module_64.c
#![no_std]
...
// FIXME: We don't do .init separately.  To do this, we'd need to have
    ...
    --RR.  */
#[no_mangle]
pub unsafe extern "C" fn module_elf_check_arch(hdr: *mut Elf_Ehdr) -> bool {
    bool module_elf_check_arch(Elf_Ehdr *hdr)
    {
    let mut abi_level: c_ulong = hdr.e_flags & 0x3;
    if (IS_ENABLED(CONFIG_PPC64_ELF_ABI_V2))
    let mut abi_level: return = = 2;
    else
    return abi_level < 2;
    }

#[no_mangle]
unsafe extern "C" fn func_desc(addr: c_ulong) -> func_desc_t {
...
pub const STO_PPC64_LOCAL_BIT: c_int = 5;

    (((1 << (((other) & STO_PPC64_LOCAL_MASK) >> STO_PPC64_LOCAL_BIT)) >> 2) << 2)
#[no_mangle]
unsafe extern "C" fn local_entry_offset(sym: *const Elf64_Sym) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn func_addr(addr: c_ulong) -> c_ulong {
    static unsigned long func_addr(unsigned long addr)
    {
    return func_desc(addr).addr;
    }
#[no_mangle]
unsafe extern "C" fn stub_func_addr(func: func_desc_t) -> c_ulong {
    static unsigned long stub_func_addr(func_desc_t func)
    {
    return func.addr;
    }
pub const STUB_MAGIC: c_uint = 0x73747562 /* stub */;
...
#[no_mangle]
unsafe extern "C" fn relacmp(_x: *const c_void, _y: *const c_void) -> c_int {
...
//
    ...
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(y->r_info: x->r_info >) -> else {
    else if (x.r_info > y.r_info)
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(y->r_addend: x->r_addend <) -> else {
...
//
    ...
    sechdrs[i].sh_size / sizeof(Elf64_Rela),
    sizeof(Elf64_Rela), relacmp, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dedotify_ext_version_names(str_seq: *mut c_char, size: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn dedotify(syms: *mut Elf64_Sym, numsyms: c_uint, strtab: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn module_init_section(name: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(sechdrs[i].sh_name: strcmp(secstrings +, 0: ".data..percpu") ==) -> else {
    else if (strcmp(secstrings + sechdrs[i].sh_name, ".data..percpu") == 0)
    me.arch.pcpu_section = i;
#[no_mangle]
pub unsafe extern "C" fn if(sechdrs[i].sh_name: strcmp(secstrings +, 0: ".mygot") ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(sechdrs[i].sh_name: strcmp(secstrings +, 0: ".toc") ==) -> else {
    ...
    sechdrs[i].sh_size);
#[no_mangle]
pub unsafe extern "C" fn if(sechdrs[i].sh_name: strcmp(secstrings +, 0: "__version_ext_names") ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn is_mprofile_ftrace_call(name: *const c_char) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn my_r2(sechdrs: *const Elf64_Shdr, me: *mut module) -> c_ulong {
...
// We expect a noop next: if it is, replace it with instruction to
    restore r2. */
#[no_mangle]
unsafe extern "C" fn restore_r2(name: *const c_char, instruction: *mut u32, me: *mut module) -> c_int {
    static int restore_r2(const char *name, u32 *instruction, struct module *me)
    {
    u32 *prev_insn = instruction - 1;
    let mut insn_val: u32 = *instruction;
    if (IS_ENABLED(CONFIG_PPC_KERNEL_PCREL))
    return 0;
    if (is_mprofile_ftrace_call(name))
    return 0;
...
// (u32 *)location = value;
    ...
    let mut absvalue: c_ulong = value;
// Convert value to relative
    value -= (unsigned long)location;
...
#[no_mangle]
unsafe extern "C" fn setup_ftrace_ool_stubs(sechdrs: *const Elf64_Shdr, addr: c_ulong, me: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn module_finalize_ftrace(mod: *mut module, sechdrs: *const Elf_Shdr) -> c_int {
