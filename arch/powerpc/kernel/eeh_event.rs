...
//! Source: arch/powerpc/kernel/eeh_event.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn eeh_event_handler(dummy: *mut *mut c_void) -> c_int {
...
pub unsafe extern "C" fn eeh_event_init() -> c_int {
    ...
    let mut ret: c_int = 0;
    t = kthread_run(eeh_event_handler, core::ptr::null_mut(), "eehd");
    if (IS_ERR(t)) {
    ret = PTR_ERR(t);
