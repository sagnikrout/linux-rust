...
//! Source: arch/powerpc/kernel/eeh_pe.c
#![no_std]
...
//
    ...
    let mut eeh_pe_aux_size: static int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_set_pe_aux_size(size: c_int) {
...
// Allocate PHB PE
    ...
    if (!pe) return core::ptr::null_mut();
// Initialize PHB PE
    pe.type = type;
    pe.phb = phb;
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_phb_pe_create(phb: *mut pci_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_wait_state(pe: *mut eeh_pe, max_wait: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_tree_insert(edev: *mut eeh_dev, new_pe_parent: *mut eeh_pe) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_tree_remove(edev: *mut eeh_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_update_time_stamp(pe: *mut eeh_pe) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_state_mark(root: *mut eeh_pe, state: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_mark_isolated(root: *mut eeh_pe) {
...
#[no_mangle]
unsafe extern "C" fn __eeh_pe_dev_mode_mark(edev: *mut eeh_dev, flag: *mut c_void) {
    static void __eeh_pe_dev_mode_mark(struct eeh_dev *edev, void *flag)
    {
    let mut mode: c_int = *((int *)flag);
    edev.mode |= mode;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_dev_mode_mark(pe: *mut eeh_pe, mode: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_state_clear(root: *mut eeh_pe, state: c_int, include_passed: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_bridge_check_link(edev: *mut eeh_dev) {
...
#[no_mangle]
unsafe extern "C" fn eeh_restore_bridge_bars(edev: *mut eeh_dev) {
...
#[no_mangle]
unsafe extern "C" fn eeh_restore_device_bars(edev: *mut eeh_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_restore_one_device_bars(edev: *mut eeh_dev, flag: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_restore_bars(pe: *mut eeh_pe) {
...
// will take that.
//
    eeh_pe_dev_traverse(pe, eeh_restore_one_device_bars, core::ptr::null_mut());
    }
//
...
//
    ...
    const char *loc = core::ptr::null_mut();
    while (bus) {
    ...
    loc = of_get_property(dn, "ibm,io-base-loc-code", core::ptr::null_mut());
    else
...
//
    ...
    struct eeh_dev *edev;
    struct pci_dev *pdev;
    struct pci_bus *bus = core::ptr::null_mut();
    if (pe.type & EEH_PE_PHB)
    return pe.phb.bus;
