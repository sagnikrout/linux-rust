...
//! Source: arch/powerpc/kernel/time.c
#![no_std]
...
pub const DECREMENTER_DEFAULT_MAX: c_uint = 0x7FFFFFFF;
    let mut decrementer_max: u64 = DECREMENTER_DEFAULT_MAX;
...
//
#[no_mangle]
pub unsafe extern "C" fn read_spurr(tb: c_ulong) -> c_ulong {
...
//
    ...
    {
    let mut stime_scaled: c_ulong = 0;
...
#[no_mangle]
pub unsafe extern "C" fn vtime_account_idle(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn vtime_account_softirq(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn vtime_account_hardirq(tsk: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vtime_flush(tsk: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vtime_task_switch(prev: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vtime_reset() {
...
//
#[no_mangle]
pub unsafe extern "C" fn vtime_dyntick_start() {
...
//
#[no_mangle]
pub unsafe extern "C" fn vtime_dyntick_stop() {
...
#[no_mangle]
pub unsafe extern "C" fn __delay(loops: c_ulong) -> void __no_kcsan {
...
#[no_mangle]
pub unsafe extern "C" fn udelay(usecs: c_ulong) -> void __no_kcsan {
...
#[no_mangle]
pub unsafe extern "C" fn test_irq_work_pending() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn set_irq_work_pending_flag() {
...
#[no_mangle]
pub unsafe extern "C" fn clear_irq_work_pending() {
...
#[no_mangle]
unsafe extern "C" fn set_dec_or_work(val: u64) {
...
pub const test_irq_work_pending(): c_int = 0;
// Macro flag: #define clear_irq_work_pending()
#[no_mangle]
unsafe extern "C" fn set_dec_or_work(val: u64) {
    static void set_dec_or_work(u64 val)
    {
...
#[no_mangle]
pub unsafe extern "C" fn timer_rearm_host_dec(now: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn timer_broadcast_interrupt() {
...
#[no_mangle]
pub unsafe extern "C" fn tb_to_ns(ticks: c_ulonglong) -> c_ulonglong {
...
#[no_mangle]
pub unsafe extern "C" fn get_boot_tb() -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn running_clock() -> c_ulonglong {
...
#[no_mangle]
unsafe extern "C" fn get_freq(name: *mut c_char, cells: c_int, val: *mut c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn start_cpu_decrementer() {
...
#[no_mangle]
pub unsafe extern "C" fn generic_calibrate_decr() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __read_persistent_clock(ts: *mut timespec64) {
...
// clocksource code
#[no_mangle]
unsafe extern "C" fn timebase_read(cs: *mut clocksource) -> notrace u64 {
    static notrace u64 timebase_read(struct clocksource *cs)
    {
    return (u64)get_tb();
    }
#[no_mangle]
unsafe extern "C" fn clocksource_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn decrementer_shutdown(dev: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_decrementer_clockevent(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn enable_large_decrementer() {
...
#[no_mangle]
unsafe extern "C" fn set_decrementer_max() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_decrementer_clockevent() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn secondary_cpu_time_init() {
...
#[no_mangle]
unsafe extern "C" fn rtc_generic_get_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtc_generic_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
unsafe extern "C" fn rtc_init() -> int __init {
    ...
    if (!ppc_md.get_rtc_time)
    return -ENODEV;
    pdev = platform_device_register_data(core::ptr::null_mut(), "rtc-generic", -1,
    &rtc_generic_ops,
