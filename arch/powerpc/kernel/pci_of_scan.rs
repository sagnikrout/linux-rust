...
//! Source: arch/powerpc/kernel/pci_of_scan.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn get_int_prop(np: *mut device_node, name: *const c_char, def: u32) -> u32 {
...
pub const OF_PCI_ADDR0_BUS: c_uint = 0x00FF0000UL;
pub const OF_PCI_ADDR0_DEV: c_uint = 0x0000F800UL;
pub const OF_PCI_ADDR0_FN: c_uint = 0x00000700UL;
pub const OF_PCI_ADDR0_BARREG: c_uint = 0x000000FFUL;
#[no_mangle]
pub unsafe extern "C" fn pci_parse_of_flags(addr0: u32, bridge: c_int) -> c_uint {
    unsigned int pci_parse_of_flags(u32 addr0, int bridge)
    {
    let mut flags: c_uint = 0, as = addr0 & OF_PCI_ADDR0_SPACE_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn of_pci_parse_addrs(node: *mut device_node, dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_scan_pci_bridge(dev: *mut pci_dev) {
...
// parse bus-range property
    ...
    if (busrange == core::ptr::null_mut() || len != 8) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_PROBE_NORMAL: mode ==) -> else {
    ...
    if (reg == core::ptr::null_mut() || reglen < 20)
    return core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn of_scan_bus(node: *mut device_node, bus: *mut pci_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_rescan_bus(node: *mut device_node, bus: *mut pci_bus) {
