...
//! Source: arch/powerpc/kernel/eeh_driver.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eeh_rmv_data {
    pub removed_vf_list: list_head,
    pub removed_dev_count: c_int,
}

#[no_mangle]
unsafe extern "C" fn eeh_result_priority(result: enum pci_ers_result) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeh_dev_removed(edev: *mut eeh_dev) -> bool {
    static bool eeh_dev_removed(struct eeh_dev *edev)
    {
    return !edev || (edev.mode & EEH_DEV_REMOVED);
    }
#[no_mangle]
unsafe extern "C" fn eeh_edev_actionable(edev: *mut eeh_dev) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_pcid_put(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_disable_irq(edev: *mut eeh_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_enable_irq(edev: *mut eeh_dev) {
...
#[no_mangle]
unsafe extern "C" fn eeh_dev_save_state(edev: *mut eeh_dev, userdata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn eeh_set_channel_state(root: *mut eeh_pe, s: pci_channel_state_t) {
...
#[no_mangle]
unsafe extern "C" fn eeh_set_irq_state(root: *mut eeh_pe, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !driver->err_handler) -> else {
    else if (!driver.err_handler)
    eeh_edev_info(edev, "driver not EEH aware");
#[no_mangle]
pub unsafe extern "C" fn if(EEH_DEV_NO_HANDLER: edev->mode &) -> else {
...
#[no_mangle]
unsafe extern "C" fn eeh_dev_restore_state(edev: *mut eeh_dev, userdata: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn eeh_rmv_device(edev: *mut eeh_dev, userdata: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_clear_pe_frozen_state(root: *mut eeh_pe, include_passed: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn eeh_pe_reset_and_recover(pe: *mut eeh_pe) -> c_int {
...
// Save states
    eeh_pe_dev_traverse(pe, eeh_dev_save_state, core::ptr::null_mut());
// Issue reset
...
// Restore device state
    eeh_pe_dev_traverse(pe, eeh_dev_restore_state, core::ptr::null_mut());
// Clear recovery mode
    eeh_pe_state_clear(pe, EEH_PE_RECOVERING, true);
    return 0;
    }
...
//
    ...
    eeh_pe_traverse(pe, eeh_pe_detach_dev, core::ptr::null_mut());
...
//
pub const MAX_WAIT_FOR_RECOVERY: c_int = 300;
...
//
#[no_mangle]
unsafe extern "C" fn eeh_pe_cleanup(pe: *mut eeh_pe) {
...
//
#[no_mangle]
unsafe extern "C" fn eeh_slot_presence_check(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn eeh_clear_slot_attention(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_handle_normal_event(pe: *mut eeh_pe) {
    ...
    struct eeh_pe *tmp_pe;
    let mut rc: c_int = 0;
    let mut result: enum pci_ers_result = PCI_ERS_RESULT_NONE;
    struct eeh_rmv_data rmv_data =
...
//
    ...
    rc = eeh_reset_device(pe, bus, core::ptr::null_mut(), false);
    if (rc) {
...
// Tell all device drivers that they can resume operations
    ...
    eeh_set_channel_state(pe, pci_channel_io_normal);
    eeh_set_irq_state(pe, true);
    eeh_pe_report("resume", pe, eeh_report_resume, core::ptr::null_mut());
    eeh_for_each_pe(pe, tmp_pe) {
    eeh_pe_for_each_dev(tmp_pe, edev, tmp) {
    edev.mode &= ~EEH_DEV_NO_HANDLER;
    edev.in_error = false;
...
// Notify all devices that they're about to go down.
    ...
    eeh_report_failure, core::ptr::null_mut());
...
//
    if (pe.type & EEH_PE_VF) {
    eeh_pe_dev_traverse(pe, eeh_rmv_device, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn eeh_handle_special_event() {
...
// Purge all events
    eeh_remove_event(core::ptr::null_mut(), true);
