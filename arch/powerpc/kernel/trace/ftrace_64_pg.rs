...
//! Source: arch/powerpc/kernel/trace/ftrace_64_pg.c
#![no_std]
...
//
pub const NUM_FTRACE_TRAMPS: c_int = 8;
...
//
#[no_mangle]
unsafe extern "C" fn test_24bit_addr(ip: c_ulong, addr: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_b_op(op: ppc_inst_t) -> c_int {
    static int is_b_op(ppc_inst_t op)
    {
    return (ppc_inst_val(op) & ~PPC_LI_MASK) == PPC_RAW_BRANCH(0);
    }
#[no_mangle]
unsafe extern "C" fn find_bl_target(ip: c_ulong, op: ppc_inst_t) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn __ftrace_make_nop(mod: *mut module, rec: *mut dyn_ftrace, addr: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_ftrace_tramp(tramp: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn setup_mcount_compiler_tramp(tramp: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ftrace_make_nop_kernel(rec: *mut dyn_ftrace, addr: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn expected_nop_sequence(ip: *mut c_void, op0: ppc_inst_t, op1: ppc_inst_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __ftrace_make_call(rec: *mut dyn_ftrace, addr: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ftrace_make_call_kernel(rec: *mut dyn_ftrace, addr: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ftrace_modify_call(rec: *mut dyn_ftrace, old_addr: c_ulong, addr: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ftrace_modify_ftrace_graph_caller(enable: bool) -> c_int {
    static int ftrace_modify_ftrace_graph_caller(bool enable)
    {
    let mut ip: c_ulong = (unsigned long)(&ftrace_graph_call);
    let mut addr: c_ulong = (unsigned long)(&ftrace_graph_caller);
    let mut stub: c_ulong = (unsigned long)(&ftrace_graph_stub);
    ppc_inst_t old, new;
...
//
    ...
    unsigned long sp)
    {
    return __prepare_ftrace_return(parent, ip, sp, core::ptr::null_mut());
    }
