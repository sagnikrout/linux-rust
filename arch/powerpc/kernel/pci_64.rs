...
//! Source: arch/powerpc/kernel/pci_64.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_unmap_io_space(bus: *mut pci_bus) -> c_int {
    int pcibios_unmap_io_space(struct pci_bus *bus)
    {
    struct pci_controller *hose;
    WARN_ON(bus == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pcibios_map_phb_io_space(hose: *mut pci_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_map_io_space(bus: *mut pci_bus) -> c_int {
...
pub const IOBASE_ISA_MEM: c_int = 4;
    ...
    {
    struct pci_controller* hose;
    struct pci_bus *tmp_bus, *bus = core::ptr::null_mut();
...
//
    ...
    agp = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "u3-agp");
    if (agp)
    in_bus = 0xf0;
    of_node_put(agp);
    }
...
//
    ...
    if (bus == core::ptr::null_mut() || bus.dev.of_node == core::ptr::null_mut())
    return -ENODEV;
...
#[no_mangle]
pub unsafe extern "C" fn pci_device_from_OF_node(np: *mut device_node, bus: *mut u8, devfn: *mut u8) -> c_int {
