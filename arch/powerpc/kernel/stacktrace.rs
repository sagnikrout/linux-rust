...
//! Source: arch/powerpc/kernel/stacktrace.c
#![no_std]
...
//
    ...
    sp = regs.gpr[1];
#[no_mangle]
pub unsafe extern "C" fn if(current: task ==) -> else {
...
//
    ...
    unsigned long sp;
    unsigned long newsp;
    let mut stack_page: c_ulong = (unsigned long)task_stack_page(task);
...
#[no_mangle]
unsafe extern "C" fn handle_backtrace_ipi(regs: *mut pt_regs) {
    static void handle_backtrace_ipi(struct pt_regs *regs)
    {
    nmi_cpu_backtrace(regs);
    }
#[no_mangle]
unsafe extern "C" fn raise_backtrace_ipi(mask: *mut cpumask_t) {
