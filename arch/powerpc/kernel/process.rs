...
//! Source: arch/powerpc/kernel/process.c
#![no_std]
...
//
    let mut __ro_after_init: bool tm_suspend_disabled = false;
#[no_mangle]
unsafe extern "C" fn check_if_tm_restore_required(tsk: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn enable_strict_msr_control(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn msr_check_and_set(bits: c_ulong) -> unsigned long notrace {
    unsigned long notrace msr_check_and_set(unsigned long bits)
    {
    let mut oldmsr: c_ulong = mfmsr();
...
// notrace because it's called by restore_math
#[no_mangle]
pub unsafe extern "C" fn __msr_check_and_clear(bits: c_ulong) -> void notrace {
...
#[no_mangle]
unsafe extern "C" fn __giveup_fpu(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn giveup_fpu(tsk: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn flush_fp_to_thread(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn enable_kernel_fp() {
...
#[no_mangle]
unsafe extern "C" fn __giveup_altivec(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn giveup_altivec(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn enable_kernel_altivec() {
...
//
#[no_mangle]
pub unsafe extern "C" fn flush_altivec_to_thread(tsk: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn __giveup_vsx(tsk: *mut task_struct) {
    static void __giveup_vsx(struct task_struct *tsk)
    {
    let mut msr: c_ulong = tsk.thread.regs.msr;
//
...
#[no_mangle]
unsafe extern "C" fn giveup_vsx(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn enable_kernel_vsx() {
...
#[no_mangle]
pub unsafe extern "C" fn flush_vsx_to_thread(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn giveup_spe(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn enable_kernel_spe() {
...
#[no_mangle]
pub unsafe extern "C" fn flush_spe_to_thread(tsk: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn init_msr_all_available() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn giveup_all(tsk: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn should_restore_fp() -> bool {
...
#[no_mangle]
unsafe extern "C" fn do_restore_fp() {
...
#[no_mangle]
unsafe extern "C" fn should_restore_altivec() -> bool {
...
#[no_mangle]
unsafe extern "C" fn do_restore_altivec() {
...
#[no_mangle]
unsafe extern "C" fn should_restore_vsx() -> bool {
...
#[no_mangle]
unsafe extern "C" fn do_restore_vsx() {
...
//
#[no_mangle]
pub unsafe extern "C" fn restore_math(regs: *mut pt_regs) -> void notrace {
...
#[no_mangle]
unsafe extern "C" fn save_all(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn flush_all_to_thread(tsk: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn do_break_handler(regs: *mut pt_regs) {
    static void do_break_handler(struct pt_regs *regs)
    {
    let mut null_brk: arch_hw_breakpoint = {0};
    struct arch_hw_breakpoint *info;
    let mut instr: ppc_inst_t = ppc_inst(0);
...
//
#[no_mangle]
unsafe extern "C" fn set_debug_reg_defaults(thread: *mut thread_struct) {
...
#[no_mangle]
unsafe extern "C" fn prime_debug_regs(debug: *mut debug_reg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn switch_booke_debug_regs(new_debug: *mut debug_reg) {
...
#[no_mangle]
unsafe extern "C" fn set_breakpoint(i: c_int, brk: *mut arch_hw_breakpoint) {
...
#[no_mangle]
unsafe extern "C" fn switch_hw_breakpoint(new: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn set_dabr(brk: *mut arch_hw_breakpoint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_breakpoint_8xx(brk: *mut arch_hw_breakpoint) -> c_int {
    static inline int set_breakpoint_8xx(struct arch_hw_breakpoint *brk)
    {
    unsigned long lctrl1 = LCTRL1_CTE_GT | LCTRL1_CTF_LT | LCTRL1_CRWE_RW |
    LCTRL1_CRWF_RW;
    let mut lctrl2: c_ulong = LCTRL2_LW0EN | LCTRL2_LW0LADC | LCTRL2_SLW0EN;
    let mut start_addr: c_ulong = ALIGN_DOWN(brk.address, HW_BREAKPOINT_SIZE);
    let mut end_addr: c_ulong = ALIGN(brk.address + brk.len, HW_BREAKPOINT_SIZE);
    if (start_addr == 0)
    lctrl2 |= LCTRL2_LW0LA_F;
#[no_mangle]
pub unsafe extern "C" fn if(0: end_addr ==) -> else {
    else if (end_addr == 0)
...
#[no_mangle]
unsafe extern "C" fn set_hw_breakpoint(nr: c_int, brk: *mut arch_hw_breakpoint) {
...
// Power8 or later
    set_dawr(nr, brk);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ENABLED(CONFIG_PPC_8xx)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn __set_breakpoint(nr: c_int, brk: *mut arch_hw_breakpoint) {
...
#[no_mangle]
pub unsafe extern "C" fn ppc_breakpoint_available() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn suspend_breakpoints() {
    void suspend_breakpoints(void)
    {
    let mut brk: arch_hw_breakpoint = {0};
    int i;
    if (!ppc_breakpoint_available())
    return;
    for (i = 0; i < nr_wp_slots(); i++)
...
//
#[no_mangle]
pub unsafe extern "C" fn restore_breakpoints() {
...
#[no_mangle]
pub unsafe extern "C" fn tm_enabled(tsk: *mut task_struct) -> bool {
    static inline bool tm_enabled(struct task_struct *tsk)
    {
    return tsk && tsk.thread.regs && (tsk.thread.regs.msr & MSR_TM);
    }
#[no_mangle]
unsafe extern "C" fn tm_reclaim_thread(thr: *mut thread_struct, cause: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn tm_reclaim_current(cause: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn tm_reclaim_task(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tm_recheckpoint(thread: *mut thread_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tm_recheckpoint_new_task(new: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn restore_tm_state(regs: *mut pt_regs) {
...
// Macro flag: #define tm_recheckpoint_new_task(new)

    void tm_reclaim_current(uint8_t cause) {}

#[no_mangle]
pub unsafe extern "C" fn save_sprs(t: *mut thread_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_save_user_regs() {
...
#[no_mangle]
pub unsafe extern "C" fn kvmppc_save_current_sprs() {
    ...
    if (cpu_has_feature(CPU_FTR_DSCR)) {
    let mut dscr: u64 = get_paca().dscr_default;
...
pub const NR_INSN_TO_PRINT: c_int = 16;
#[no_mangle]
unsafe extern "C" fn show_instructions(regs: *mut pt_regs) {
    static void show_instructions(struct pt_regs *regs)
    {
    int i;
    let mut nip: c_ulong = regs.nip;
    let mut pc: c_ulong = regs.nip - (NR_INSN_TO_PRINT * 3 / 4 * sizeof(int));
    printk("Code: ");
//
...
#[no_mangle]
pub unsafe extern "C" fn show_user_instructions(regs: *mut pt_regs) {
    void show_user_instructions(struct pt_regs *regs)
    {
    unsigned long pc;
    let mut n: c_int = NR_INSN_TO_PRINT;
    struct seq_buf s;
...
#[no_mangle]
unsafe extern "C" fn print_bits(val: c_ulong, bits: *mut regbit, sep: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn print_tm_bits(val: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn print_msr_bits(val: c_ulong) {
...
pub const REGS_PER_LINE: c_int = 4;

pub const REGS_PER_LINE: c_int = 8;

#[no_mangle]
unsafe extern "C" fn __show_regs(regs: *mut pt_regs) {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_thread_tidr(t: *mut task_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_ksp_vsid(p: *mut task_struct, sp: c_ulong) {
    static void setup_ksp_vsid(struct task_struct *p, unsigned long sp)
    {

    unsigned long sp_vsid;
    let mut llp: c_ulong = mmu_psize_defs[mmu_linear_psize].sllp;
    if (radix_enabled())
    return;
...
pub unsafe extern "C" fn copy_thread(p: *mut task_struct, args: *const kernel_clone_args) -> c_int {
    ...
    void (*f)(void);
    let mut sp: c_ulong = (unsigned long)task_stack_page(p) + THREAD_SIZE;
...
// Create initial minimum stack frame.
    ...
    p.thread.regs = core::ptr::null_mut();	/* no user register state */
...
//
    ...
    for (i = 0; i < nr_wp_slots(); i++)
    p.thread.ptrace_bps[i] = core::ptr::null_mut();

    p.thread.fp_save_area = core::ptr::null_mut();

    p.thread.vr_save_area = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn start_thread(regs: *mut pt_regs, start: c_ulong, sp: c_ulong) {
...
//
    ...
    current.thread.fp_save_area = core::ptr::null_mut();

    memset(&current.thread.vr_state, 0, sizeof(current.thread.vr_state));
    current.thread.vr_state.vscr.u[3] = 0x00010000; /* Java mode disabled */
    current.thread.vr_save_area = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn set_fpexc_mode(tsk: *mut task_struct, val: c_uint) -> c_int {
...
// them does not change anything
    ...
    if (regs != core::ptr::null_mut() && (regs.msr & MSR_FP) != 0) {
...
#[no_mangle]
pub unsafe extern "C" fn get_fpexc_mode(tsk: *mut task_struct, adr: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_endian(tsk: *mut task_struct, val: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PR_ENDIAN_PPC_LITTLE: val == PR_ENDIAN_LITTLE || val ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn get_endian(tsk: *mut task_struct, adr: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_unalign_ctl(tsk: *mut task_struct, val: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_unalign_ctl(tsk: *mut task_struct, adr: c_ulong) -> c_int {
    ...
    let mut cpu: c_ulong = task_cpu(p);
...
//
    ...
    unsigned long nbytes)
    {
    let mut stack_page: c_ulong = (unsigned long)task_stack_page(p);
    if (sp < THREAD_SIZE)
    return 0;
    if (sp >= stack_page && sp <= stack_page + THREAD_SIZE - nbytes)
    return 1;
...
#[no_mangle]
pub unsafe extern "C" fn validate_sp(sp: c_ulong, p: *mut task_struct) -> c_int {
    int validate_sp(unsigned long sp, struct task_struct *p)
    {
    return validate_sp_size(sp, p, STACK_FRAME_MIN_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn ___get_wchan(p: *mut task_struct) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn empty_user_regs(regs: *mut pt_regs, tsk: *mut task_struct) -> bool {
...
// Check it sits at the very base of the stack
    ...
    let mut kstack_depth_to_print: static int = CONFIG_PRINT_STACK_DEPTH;
    ...
    let mut count: c_int = 0;
    let mut firstframe: c_int = 1;
    unsigned long ret_addr;
    let mut ftrace_idx: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn __ppc64_runlatch_on() -> void notrace {
...
// Called with hard IRQs off
#[no_mangle]
pub unsafe extern "C" fn __ppc64_runlatch_off() -> void notrace {
