...
//! Source: arch/powerpc/kernel/align.c
#![no_std]
...
pub const SW: c_uint = 0x20	/* byte swap */;
pub const E4: c_uint = 0x40	/* SPE endianness is word */;
pub const E8: c_uint = 0x80	/* SPE endianness is double word */;
...
pub const EVLDD: c_uint = 0x00;
pub const EVLDW: c_uint = 0x01;
pub const EVLDH: c_uint = 0x02;
pub const EVLHHESPLAT: c_uint = 0x04;
pub const EVLHHOUSPLAT: c_uint = 0x06;
pub const EVLHHOSSPLAT: c_uint = 0x07;
pub const EVLWHE: c_uint = 0x08;
pub const EVLWHOU: c_uint = 0x0A;
pub const EVLWHOS: c_uint = 0x0B;
pub const EVLWWSPLAT: c_uint = 0x0C;
pub const EVLWHSPLAT: c_uint = 0x0E;
pub const EVSTDD: c_uint = 0x10;
pub const EVSTDW: c_uint = 0x11;
pub const EVSTDH: c_uint = 0x12;
pub const EVSTWHE: c_uint = 0x18;
pub const EVSTWHO: c_uint = 0x1A;
pub const EVSTWWE: c_uint = 0x1C;
pub const EVSTWWO: c_uint = 0x1E;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fix_alignment(regs: *mut pt_regs) -> c_int {
...
// We don't handle PPC little-endian any more...
    ...
    let mut reg: c_int = (ppc_inst_val(instr) >> 21) & 0x1f;
