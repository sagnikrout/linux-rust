...
//! Source: arch/powerpc/kernel/iommu.c
#![no_std]
...
// Macro flag: #define DBG(...)

#[no_mangle]
unsafe extern "C" fn iommu_debugfs_weight_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = bitmap_weight(tbl->it_map, tbl->it_size);
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(iommu_debugfs_fops_weight, iommu_debugfs_weight_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn iommu_debugfs_add(tbl: *mut iommu_table) {
...
#[no_mangle]
unsafe extern "C" fn iommu_debugfs_del(tbl: *mut iommu_table) {
...
#[no_mangle]
unsafe extern "C" fn setup_iommu(str: *mut c_char) -> int __init {
    static int __init setup_iommu(char *str)
    {
    if (!strcmp(str, "novmerge"))
    novmerge = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "vmerge")) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn setup_iommu_pool_hash() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn setup_fail_iommu(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn should_fail_iommu(dev: *mut device) -> bool {
    static bool should_fail_iommu(struct device *dev)
    {
    return dev.archdata.fail_iommu && should_fail(&fail_iommu, 1);
    }
#[no_mangle]
unsafe extern "C" fn fail_iommu_debugfs() -> int __init {
    static int __init fail_iommu_debugfs(void)
    {
    struct dentry *dir = fault_create_debugfs_attr("fail_iommu",
    core::ptr::null_mut(), &fail_iommu);
...
#[no_mangle]
unsafe extern "C" fn fail_iommu_setup() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn should_fail_iommu(dev: *mut device) -> bool {
    ...
    unsigned long limit;
    let mut largealloc: c_int = npages > 15;
...
// handle = end;
    ...
    int build_fail;
    entry = iommu_range_alloc(dev, tbl, npages, core::ptr::null_mut(), mask, align_order);
...
// Make sure updates are seen by hardware
    ...
    {
    struct iommu_pool *p;
    let mut largepool_start: c_ulong = tbl.large_pool.start;
// The large pool is the last pool at the top of the table
    if (entry >= largepool_start) {
    p = &tbl.large_pool;
    } else {
    let mut pool_nr: c_uint = entry / tbl.poolsize;
...
//
    ...
    unsigned long attrs)
    {
    let mut dma_next: dma_addr_t = 0, dma_addr;
...
// Make sure updates are seen by hardware
    ...
    while (nelems--) {
    unsigned int npages;
    let mut dma_handle: dma_addr_t = sg.dma_address;
    if (sg.dma_length == 0)
    break;
...
#[no_mangle]
pub unsafe extern "C" fn iommu_table_clear(tbl: *mut iommu_table) {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_table_in_use(tbl: *mut iommu_table) -> bool {
    bool iommu_table_in_use(struct iommu_table *tbl)
    {
    let mut start: c_ulong = 0, end;
...
#[no_mangle]
unsafe extern "C" fn iommu_table_free(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_tce_table_put(tbl: *mut iommu_table) -> c_int {
...
//
    ...
    struct page *page;
    let mut tcesize: c_int = (1 << tbl.it_page_shift);
...
#[no_mangle]
pub unsafe extern "C" fn iommu_direction_to_tce_perm(dir: enum dma_data_direction) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn dev_has_iommu_table(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn group_release(iommu_data: *mut c_void) {
    static void group_release(void *iommu_data)
    {
    struct iommu_table_group *table_group = iommu_data;
    table_group.group = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn iommu_tce_direction(tce: c_ulong) -> enum dma_data_direction {
    enum dma_data_direction iommu_tce_direction(unsigned long tce)
    {
    if ((tce & TCE_PCI_READ) && (tce & TCE_PCI_WRITE))
    return DMA_BIDIRECTIONAL;
#[no_mangle]
pub unsafe extern "C" fn if(TCE_PCI_READ: tce &) -> else {
    else if (tce & TCE_PCI_READ)
    return DMA_TO_DEVICE;
#[no_mangle]
pub unsafe extern "C" fn if(TCE_PCI_WRITE: tce &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_flush_tce(tbl: *mut iommu_table) {
...
// Make sure updates are seen by hardware
    ...
    {
    let mut mask: c_ulong = (1UL << page_shift) - 1;
    if (ioba & mask)
    return -EINVAL;
    ioba >>= page_shift;
    if (ioba < offset)
...
#[no_mangle]
pub unsafe extern "C" fn iommu_tce_check_gpa(page_shift: c_ulong, gpa: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_add_device(table_group: *mut iommu_table_group, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spapr_tce_iommu_capable(dev: *mut device, cap: enum iommu_cap) -> bool {
...
#[no_mangle]
unsafe extern "C" fn spapr_tce_iommu_release_device(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn ppc_iommu_register_device(phb: *mut pci_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn ppc_iommu_unregister_device(phb: *mut pci_controller) {
...
//
#[no_mangle]
unsafe extern "C" fn spapr_tce_setup_phb_iommus_initcall() -> int __init {
