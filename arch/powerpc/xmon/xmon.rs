...
//! Source: arch/powerpc/xmon/xmon.c
#![no_std]
...
//
    ...
    let mut cpus_in_xmon: static cpumask_t = CPU_MASK_NONE;
    let mut xmon_taken: static unsigned long = 1;
    static int xmon_owner;
    static int xmon_gate;
    static int xmon_batch;
    static unsigned long xmon_batch_start_cpu;
    let mut xmon_batch_cpus: static cpumask_t = CPU_MASK_NONE;

pub const xmon_owner: c_int = 0;

    let mut __read_mostly: static unsigned long in_xmon = 0;
    let mut xmon_on: static int = IS_ENABLED(CONFIG_XMON_DEFAULT);
    let mut xmon_is_ro: static bool = IS_ENABLED(CONFIG_XMON_DEFAULT_RO_MODE);
    static unsigned long adrs;
    let mut size: static int = 1;

    let mut ndump: static unsigned long = 64;

    let mut nidump: static unsigned long = 16;
    let mut ncsum: static unsigned long = 4096;
    static int termch;
...
// Bits in bpt.enabled
pub const BP_CIABR: c_int = 1;
pub const BP_TRAP: c_int = 2;
pub const BP_DABR: c_int = 4;
    static struct bpt bpts[NBPTS];
    static struct bpt dabr[HBP_NUM_MAX];
    static struct bpt *iabr;
    let mut bpinstr: static unsigned int = PPC_RAW_TRAP();
...
#[no_mangle]
pub unsafe extern "C" fn dump_opal_msglog() {
...
#[no_mangle]
unsafe extern "C" fn xmon_is_locked_down() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn xmon_is_locked_down() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cflush(p: *mut c_void) {
    static inline void cflush(void *p)
    {
    asm volatile ("dcbf 0,%0; icbi 0,%0" : : "r" (p));
    }
#[no_mangle]
pub unsafe extern "C" fn cinval(p: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn write_ciabr(ciabr: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn set_ciabr(addr: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn disable_surveillance() {
    static inline void disable_surveillance(void)
    {

// Since this can't be a module, args should end up below 4GB.
    static struct rtas_args args;
    let mut token: i32 = rtas_function_token(RTAS_FN_SET_INDICATOR);
//
...
//
    ...
    return;
    rtas_call_unlocked(&args, token, 3, 1, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn get_output_lock() {
    static void get_output_lock(void)
    {
    let mut me: c_int = smp_processor_id() + 0x100;
    let mut last_speaker: c_int = 0, prev;
    long timeout;
    if (xmon_speaker == me)
    return;
    for (;;) {
...
#[no_mangle]
unsafe extern "C" fn release_output_lock() {
    static void release_output_lock(void)
    {
    xmon_speaker = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn cpus_are_in_xmon() -> c_int {
    int cpus_are_in_xmon(void)
    {
    return !cpumask_empty(&cpus_in_xmon);
    }
#[no_mangle]
unsafe extern "C" fn wait_for_other_cpus(ncpus: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xmon_touch_watchdogs() {
...
#[no_mangle]
unsafe extern "C" fn xmon_core(regs: *mut pt_regs, fromipi: volatile int) -> c_int {
    static int xmon_core(struct pt_regs *regs, volatile int fromipi)
    {
    let mut cmd: volatile int = 0;
...
// have switched to some other cpu
    ...
    xmon_fault_jmp[cpu] = core::ptr::null_mut();
...
// for breakpoint or single step, print current insn
    ...
    bp = at_breakpoint(regs.nip);
    if (bp != core::ptr::null_mut()) {
    let mut stepped: c_int = emulate_step(regs, ppc_inst_read(bp.instr));
    if (stepped == 0) {
    regs_set_return_ip(regs, (unsigned long) &bp.instr[0]);
    atomic_inc(&bp.ref_count);
    } else if (stepped < 0) {
...
#[no_mangle]
pub unsafe extern "C" fn xmon(excp: *mut pt_regs) -> c_int {
    int xmon(struct pt_regs *excp)
    {
    struct pt_regs regs;
    if (excp == core::ptr::null_mut()) {
    ppc_save_regs(&regs);
    excp = &regs;
    }
    ...
    EXPORT_SYMBOL(xmon);
#[no_mangle]
pub unsafe extern "C" fn xmon_irq(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xmon_bpt(regs: *mut pt_regs) -> c_int {
...
// Are we at the trap at bp->instr[1] for some bp?
    bp = in_breakpoint_table(regs.nip, &offset);
    if (bp != core::ptr::null_mut() && (offset == 4 || offset == 8)) {
    regs_set_return_ip(regs, bp.address + offset);
    atomic_dec(&bp.ref_count);
    return 1;
    }
...
#[no_mangle]
unsafe extern "C" fn xmon_sstep(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xmon_break_match(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xmon_iabr_match(regs: *mut pt_regs) -> c_int {
    static int xmon_iabr_match(struct pt_regs *regs)
    {
    if ((regs.msr & (MSR_IR|MSR_PR|MSR_64BIT)) != (MSR_IR|MSR_64BIT))
    return 0;
    if (iabr == core::ptr::null_mut())
    return 0;
    xmon_core(regs, 0);
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn xmon_ipi(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xmon_fault_handler(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn force_enable_xmon() {
...
#[no_mangle]
unsafe extern "C" fn insert_bpts() {
    static void insert_bpts(void)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn insert_cpu_bpts() {
    static void insert_cpu_bpts(void)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn remove_bpts() {
    static void remove_bpts(void)
    {
    int i;
    struct bpt *bp;
...
#[no_mangle]
unsafe extern "C" fn remove_cpu_bpts() {
    static void remove_cpu_bpts(void)
    {
...
#[no_mangle]
unsafe extern "C" fn set_lpp_cmd() {
...
#[no_mangle]
unsafe extern "C" fn do_step(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xmon_switch_cpu(cpu: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xmon_batch_next_cpu() -> c_int {
    static int xmon_batch_next_cpu(void)
    {
    unsigned long cpu;
...
#[no_mangle]
unsafe extern "C" fn batch_cmds(excp: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_cmd() -> c_int {
    static int cpu_cmd(void)
    {
...
//
#[no_mangle]
unsafe extern "C" fn check_bp_loc(addr: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn find_free_data_bpt() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_data_bpts() {
    ...
    mode = 5;
#[no_mangle]
pub unsafe extern "C" fn if('w': cmd ==) -> else {
    else if (cmd == 'w')
    mode = 6;
    else
    termch = cmd;
...
// startp = *endp = 0;
    ...
    catch_memory_errors = 1;
    sync();
    name = kallsyms_lookup(pc, &size, &offset, core::ptr::null_mut(), tmpstr);
...
#[no_mangle]
unsafe extern "C" fn backtrace(excp: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn print_bug_trap(regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn excprint(fp: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn prregs(fp: *mut pt_regs) {
...
pub const R_PER_LINE: c_int = 2;

pub const R_PER_LINE: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn dump_206_sprs() {
...
#[no_mangle]
unsafe extern "C" fn dump_207_sprs() {
...
#[no_mangle]
unsafe extern "C" fn dump_300_sprs() {
    static void dump_300_sprs(void)
    {

    let mut hv: bool = mfmsr() & MSR_HV;
...
#[no_mangle]
unsafe extern "C" fn dump_310_sprs() {
...
#[no_mangle]
unsafe extern "C" fn dump_one_spr(spr: c_int, show_unimplemented: bool) {
...
unsafe extern "C" fn handle_fault(regs: *mut pt_regs) -> c_int {
    ...
    size = 1;
#[no_mangle]
pub unsafe extern "C" fn if(8: size >) -> else {
    else if( size > 8 )
    size = 8;
    for(;;){
    if (!mnoread)
    ...
    n = bsesc();
#[no_mangle]
pub unsafe extern "C" fn if('\'': n ==) -> else {
    else if( n == '\'' )
    break;
    for (i = 0; i < size; ++i)
    val[i] = n >> (i * 8);
...
#[no_mangle]
unsafe extern "C" fn xmon_rawdump(adrs: c_ulong, ndump: c_long) {
...
#[no_mangle]
unsafe extern "C" fn dump_tracing() {
...
#[no_mangle]
unsafe extern "C" fn dump_one_paca(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dump_all_pacas() {
...
#[no_mangle]
unsafe extern "C" fn dump_one_xive(cpu: c_int) {
    static void dump_one_xive(int cpu)
    {
    let mut hwid: c_uint = get_hard_smp_processor_id(cpu);
    let mut hv: bool = cpu_has_feature(CPU_FTR_HVMODE);
    if (hv) {
...
#[no_mangle]
unsafe extern "C" fn dump_all_xives() {
...
unsafe extern "C" fn dump_xives() {
    ...
    if (scanhex(&num))
    xmon_xive_get_irq_config(num, core::ptr::null_mut());
    else
...
#[no_mangle]
unsafe extern "C" fn dump_by_size(addr: c_ulong, count: c_long, size: c_int) {
    ...
    nidump = 16;
#[no_mangle]
pub unsafe extern "C" fn if(MAX_IDUMP: nidump >) -> else {
...
// dump virtual to physical translation
    ...
    ndump = 64;
#[no_mangle]
pub unsafe extern "C" fn if(MAX_DUMP: ndump >) -> else {
...
#[no_mangle]
unsafe extern "C" fn dump_opal_msglog() {
    static void dump_opal_msglog(void)
    {
    unsigned char buf[128];
    ssize_t res;
    let mut pos: volatile loff_t = 0;
...
//
    ...
    let mut mskip: static unsigned long = 0x1000;
    let mut mlim: static unsigned long = 0xffffffff;
    static void
    memzcan(void)
    {
    unsigned char v;
...
#[no_mangle]
unsafe extern "C" fn show_task(tsk: *mut *mut task_volatile) {
    static void show_task(struct task_struct *volatile tsk)
    {
    let mut p_state: c_uint = READ_ONCE(tsk.__state);
    char state;
//
...
#[no_mangle]
unsafe extern "C" fn format_pte(ptep: *mut c_void, pte: c_ulong) {
    static void format_pte(void *ptep, unsigned long pte)
    {
    let mut entry: pte_t = __pte(pte);
...
#[no_mangle]
unsafe extern "C" fn show_pte(addr: c_ulong) {
    static void show_pte(unsigned long addr)
    {
    let mut tskv: c_ulong = 0;
    let mut tsk: *mut task_volatile = core::ptr::null_mut();
...
// parse register name
    ...
    if (xmon_regs == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn hexdigit(c: c_int) -> c_int {
...
// s = 0;
    ...
    flush_input(void)
    {
    lineptr = core::ptr::null_mut();
    }
    static int
    inchar(void)
    {
    if (lineptr == core::ptr::null_mut() || *lineptr == 0) {
    if (xmon_gets(line, sizeof(line)) == core::ptr::null_mut()) {
    lineptr = core::ptr::null_mut();
    return EOF;
    }
    lineptr = line;
    ...
    symbol_lookup(void)
    {
    let mut type: c_int = inchar();
    unsigned long addr, cpu;
    void __percpu *ptr = core::ptr::null_mut();
...
// Print an address in numeric and symbolic form (if possible)
    ...
    {
    char *modname;
    let mut name: *const char volatile = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn dump_segments() {
    void dump_segments(void)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn dump_tlb_44x() {
    static void dump_tlb_44x(void)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn dump_tlb_book3e() {
    static void dump_tlb_book3e(void)
    {
    u32 mmucfg;
    u64 ramask;
...
// Gather some infos about the MMU
    ...
    for (i = 0; i < nent; i++) {
    let mut mas0: u32 = MAS0_TLBSEL(tlb);
    let mut mas1: u32 = MAS1_TSIZE(BOOK3E_PAGESZ_4K);
    let mut mas2: u64 = 0;
    u64 mas7_mas3;
    let mut esel: c_int = i, cc = i;
    if (assoc != 0) {
    cc = i / assoc;
    esel = i % assoc;
    mas2 = cc * 0x1000;
    ...
    printf("%04x- ", i);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: new_cc) -> else {
    else if (new_cc)
...
#[no_mangle]
unsafe extern "C" fn xmon_init(enable: c_int) {
    ...
    __debugger = core::ptr::null_mut();
    __debugger_ipi = core::ptr::null_mut();
    __debugger_bpt = core::ptr::null_mut();
    __debugger_sstep = core::ptr::null_mut();
    __debugger_iabr_match = core::ptr::null_mut();
    __debugger_break_match = core::ptr::null_mut();
    __debugger_fault_handler = core::ptr::null_mut();
    }
    }

#[no_mangle]
unsafe extern "C" fn sysrq_handle_xmon(key: u8) {
...
#[no_mangle]
unsafe extern "C" fn setup_xmon_sysrq() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn clear_all_bpt() {
    static void clear_all_bpt(void)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn xmon_dbgfs_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xmon_dbgfs_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = xmon_on;
    ...
    xmon_dbgfs_set, "%llu\n");
#[no_mangle]
unsafe extern "C" fn setup_xmon_dbgfs() -> int __init {
    static int __init setup_xmon_dbgfs(void)
    {
    debugfs_create_file("xmon", 0600, arch_debugfs_dir, core::ptr::null_mut(),
    &xmon_dbgfs_ops);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn early_parse_xmon(p: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn xmon_setup() -> void __init {
