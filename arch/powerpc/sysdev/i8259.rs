...
//! Source: arch/powerpc/sysdev/i8259.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn i8259_set_irq_mask(irq_nr: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn i8259_get_host() -> *mut irq_domain __init {
...
// create a legacy host
    ...
    &i8259_host_ops, core::ptr::null_mut());
    if (i8259_host == core::ptr::null_mut()) {
