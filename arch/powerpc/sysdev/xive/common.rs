...
//! Source: arch/powerpc/sysdev/xive/common.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn xive_ipi_cpu_to_irq(cpu: c_uint) -> c_uint {
...
//
    let mut xive_store_eoi: static bool = true;
#[no_mangle]
unsafe extern "C" fn xive_is_store_eoi(xd: *mut xive_irq_data) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn xive_read_eq(q: *mut xive_q, just_peek: bool) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn xive_scan_interrupts(xc: *mut xive_cpu, just_peek: bool) -> u32 {
...
//
    ...
    let mut p: c_int = atomic_xchg(&q.pending_count, 0);
    if (p) {
...
//
#[no_mangle]
unsafe extern "C" fn xive_esb_read(xd: *mut xive_irq_data, offset: u32) -> notrace u8 {
...
#[no_mangle]
unsafe extern "C" fn xive_esb_write(xd: *mut xive_irq_data, offset: u32, data: u64) {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_data_dump(xd: *mut xive_irq_data, buffer: *mut c_char, size: usize) {
    static void xive_irq_data_dump(struct xive_irq_data *xd, char *buffer, size_t size)
    {
    let mut val: u64 = xive_esb_read(xd, XIVE_ESB_GET);
...
#[no_mangle]
unsafe extern "C" fn xive_dump_eq(name: *const c_char, q: *mut xive_q) -> notrace void {
...
#[no_mangle]
pub unsafe extern "C" fn xmon_xive_do_dump(cpu: c_int) -> notrace void {
    ...
    {
    let mut irq: c_uint = irq_find_mapping(xive_irq_domain, hw_irq);
    return irq ? irq_get_irq_data(irq) : core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn xmon_xive_get_irq_config(hw_irq: u32, d: *mut irq_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xmon_xive_get_irq_all() {
...
#[no_mangle]
unsafe extern "C" fn xive_get_irq() -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn xive_do_queue_eoi(xc: *mut xive_cpu) {
...
//
#[no_mangle]
unsafe extern "C" fn xive_do_source_eoi(xd: *mut xive_irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_eoi(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn xive_try_pick_target(cpu: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn xive_dec_target_count(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_startup(d: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_shutdown(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_set_type(d: *mut irq_data, flow_type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_retrigger(d: *mut irq_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xive_irq_set_vcpu_affinity(d: *mut irq_data, state: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_xive_irq(chip: *mut irq_chip) -> bool {
    bool is_xive_irq(struct irq_chip *chip)
    {
    let mut chip: return = = &xive_irq_chip;
    }
    EXPORT_SYMBOL_GPL(is_xive_irq);
#[no_mangle]
pub unsafe extern "C" fn xive_cleanup_irq_data(xd: *mut xive_irq_data) {
    ...
    xd.trig_mmio = core::ptr::null_mut();
    xd.eoi_mmio = core::ptr::null_mut();
    }
    if (xd.trig_mmio) {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_free_data(domain: *mut irq_domain, virq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xive_cause_ipi(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xive_muxed_ipi_action(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t xive_muxed_ipi_action(int irq, void *dev_id)
    {
    return smp_ipi_demux();
    }
#[no_mangle]
unsafe extern "C" fn xive_ipi_eoi(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xive_ipi_do_nothing(d: *mut irq_data) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xive_ipi_alloc_info {
...
#[no_mangle]
unsafe extern "C" fn xive_init_ipis() -> int __init {
    ...
    &xive_ipi_irq_domain_ops, core::ptr::null_mut());
    if (!ipi_domain)
    ...
    let mut info: xive_ipi_alloc_info = { node };
//
...
#[no_mangle]
unsafe extern "C" fn xive_request_ipi(cpu: c_uint) -> c_int {
    ...
    xid.name, core::ptr::null_mut());
    WARN(ret < 0, "Failed to request IPI %d: %d\n", xid.irq, ret);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn xive_setup_cpu_ipi(cpu: c_uint) -> c_int {
    static int xive_setup_cpu_ipi(unsigned int cpu)
    {
    let mut xive_ipi_irq: c_uint = xive_ipi_cpu_to_irq(cpu);
    struct xive_cpu *xc;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn xive_cleanup_cpu_ipi(cpu: c_uint, xc: *mut xive_cpu) -> noinstr static void {
...
#[no_mangle]
pub unsafe extern "C" fn xive_smp_probe() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_domain_unmap(d: *mut irq_domain, virq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xive_init_host(np: *mut device_node) -> void __init {
    static void __init xive_init_host(struct device_node *np)
    {
    xive_irq_domain = irq_domain_create_tree(of_fwnode_handle(np), &xive_irq_domain_ops, core::ptr::null_mut());
    if (WARN_ON(xive_irq_domain == core::ptr::null_mut()))
    return;
    irq_set_default_domain(xive_irq_domain);
    }
#[no_mangle]
unsafe extern "C" fn xive_cleanup_cpu_queues(cpu: c_uint, xc: *mut xive_cpu) {
...
#[no_mangle]
unsafe extern "C" fn xive_setup_cpu_queues(cpu: c_uint, xc: *mut xive_cpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_prepare_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_setup_cpu() {
...
#[no_mangle]
pub unsafe extern "C" fn xive_smp_setup_cpu() {
...
#[no_mangle]
pub unsafe extern "C" fn xive_smp_prepare_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_flush_cpu_queue(cpu: c_uint, xc: *mut xive_cpu) {
...
#[no_mangle]
pub unsafe extern "C" fn xive_smp_disable_cpu() {
...
#[no_mangle]
pub unsafe extern "C" fn xive_flush_interrupt() {
...
#[no_mangle]
pub unsafe extern "C" fn xive_teardown_cpu() -> noinstr void {
...
#[no_mangle]
pub unsafe extern "C" fn xive_shutdown() {
...
#[no_mangle]
unsafe extern "C" fn xive_off(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xive_store_eoi_cmdline(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xive_debug_show_ipi(m: *mut seq_file, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xive_debug_show_irq(m: *mut seq_file, d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xive_irq_debug_show(m: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_ipi_debug_show(m: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_eq_debug_show_one(m: *mut seq_file, q: *mut xive_q, prio: u8) {
...
#[no_mangle]
unsafe extern "C" fn xive_eq_debug_show(m: *mut seq_file, private: *mut c_void) -> c_int {
    static int xive_eq_debug_show(struct seq_file *m, void *private)
    {
    let mut cpu: c_int = (long)m.private;
    struct xive_cpu *xc = per_cpu(xive_cpu, cpu);
    if (xc)
...
#[no_mangle]
unsafe extern "C" fn xive_core_debugfs_create() {
    ...
    core::ptr::null_mut(), &xive_ipi_debug_fops);
    debugfs_create_file("interrupts", 0400, xive_dir,
    core::ptr::null_mut(), &xive_irq_debug_fops);
...
#[no_mangle]
pub unsafe extern "C" fn xive_core_debug_init() -> c_int {
