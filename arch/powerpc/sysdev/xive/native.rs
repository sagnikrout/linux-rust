...
//! Source: arch/powerpc/sysdev/xive/native.c
#![no_std]
...
//
    ...
    let mut xive_pool_vps: static u32 = XIVE_INVALID_VP;
    static struct kmem_cache *xive_provision_cache;
    static bool xive_has_single_esc;
    bool xive_has_save_restore;
#[no_mangle]
pub unsafe extern "C" fn xive_native_populate_irq_data(hw_irq: u32, data: *mut xive_irq_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_configure_irq(hw_irq: u32, target: u32, prio: u8, sw_irq: u32) -> c_int {
...
// Initialize the rest of the fields
    ...
    q.idx = 0;
    q.toggle = 0;
    rc = opal_xive_get_queue_info(vp_id, prio, core::ptr::null_mut(), core::ptr::null_mut(),
    &qeoi_page_be,
    &esc_irq_be,
    core::ptr::null_mut());
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn __xive_native_disable_queue(vp_id: u32, q: *mut xive_q, prio: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_disable_queue(vp_id: u32, q: *mut xive_q, prio: u8) {
...
#[no_mangle]
unsafe extern "C" fn xive_native_setup_queue(cpu: c_uint, xc: *mut xive_cpu, prio: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_native_cleanup_queue(cpu: c_uint, xc: *mut xive_cpu, prio: u8) {
...
#[no_mangle]
unsafe extern "C" fn xive_native_match(node: *mut device_node) -> bool {
    static bool xive_native_match(struct device_node *node)
    {
    return of_device_is_compatible(node, "ibm,opal-xive-vc");
    }
#[no_mangle]
unsafe extern "C" fn opal_xive_allocate_irq(chip_id: u32) -> i64 {
    static s64 opal_xive_allocate_irq(u32 chip_id)
    {
    let mut irq: i64 = opal_xive_allocate_irq_raw(chip_id);
//
// Old versions of skiboot can incorrectly return 0xffffffff to
// indicate no space, fix it up here.
//
    let mut irq: return = = 0xffffffff ? OPAL_RESOURCE : irq;
    }

#[no_mangle]
unsafe extern "C" fn xive_native_get_ipi(cpu: c_uint, xc: *mut xive_cpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_alloc_irq_on_chip(chip_id: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_free_irq(irq: u32) {
    void xive_native_free_irq(u32 irq)
    {
    for (;;) {
    let mut rc: i64 = opal_xive_free_irq(irq);
    if (rc != OPAL_BUSY)
    break;
    msleep(OPAL_BUSY_DELAY_MS);
    }
...
#[no_mangle]
unsafe extern "C" fn xive_native_put_ipi(cpu: c_uint, xc: *mut xive_cpu) {
...
#[no_mangle]
unsafe extern "C" fn xive_native_shutdown() {
...
//
#[no_mangle]
unsafe extern "C" fn xive_native_update_pending(xc: *mut xive_cpu) {
...
#[no_mangle]
unsafe extern "C" fn xive_native_prepare_cpu(cpu: c_uint, xc: *mut xive_cpu) {
    static void xive_native_prepare_cpu(unsigned int cpu, struct xive_cpu *xc)
    {
    xc.chip_id = cpu_to_chip_id(cpu);
    }
#[no_mangle]
unsafe extern "C" fn xive_native_setup_cpu(cpu: c_uint, xc: *mut xive_cpu) {
...
// Grab its CAM value
    rc = opal_xive_get_vp_info(vp, core::ptr::null_mut(), &vp_cam_be, core::ptr::null_mut(), core::ptr::null_mut());
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn xive_native_teardown_cpu(cpu: c_uint, xc: *mut xive_cpu) {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_sync_source(hw_irq: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_sync_queue(hw_irq: u32) {
...
#[no_mangle]
unsafe extern "C" fn xive_native_debug_create(xive_dir: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xive_parse_provisioning(np: *mut device_node) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn xive_native_setup_pools() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_default_eq_shift() -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_init() -> bool __init {
    bool __init xive_native_init(void)
    {
    struct device_node *np;
    struct resource r;
    void __iomem *tima;
    let mut max_prio: u8 = 7;
    u32 val, cpu;
    s64 rc;
    if (xive_cmdline_disabled)
    return false;
    pr_devel("xive_native_init()\n");
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "ibm,opal-xive-pe");
    if (!np) {
    pr_devel("not found !\n");
    return false;
    }
...
#[no_mangle]
unsafe extern "C" fn xive_native_provision_pages() -> bool {
    static bool xive_native_provision_pages(void)
    {
    u32 i;
    void *p;
    for (i = 0; i < xive_provision_chip_count; i++) {
    let mut chip: u32 = xive_provision_chips[i];
//
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_alloc_vp_block(max_vcpus: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_free_vp_block(vp_base: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_enable_vp(vp_id: u32, single_escalation: bool) -> c_int {
    int xive_native_enable_vp(u32 vp_id, bool single_escalation)
    {
    s64 rc;
    let mut flags: u64 = OPAL_XIVE_VP_ENABLED;
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_disable_vp(vp_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_get_vp_info(vp_id: u32, out_cam_id: *mut u32, out_chip_id: *mut u32) -> c_int {
    int xive_native_get_vp_info(u32 vp_id, u32 *out_cam_id, u32 *out_chip_id)
    {
    __be64 vp_cam_be;
    __be32 vp_chip_id_be;
    s64 rc;
    rc = opal_xive_get_vp_info(vp_id, core::ptr::null_mut(), &vp_cam_be, core::ptr::null_mut(), &vp_chip_id_be);
    if (rc) {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_has_single_escalation() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_has_save_restore() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_get_queue_state(vp_id: u32, prio: u32, qtoggle: *mut u32, qindex: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_set_queue_state(vp_id: u32, prio: u32, qtoggle: u32, qindex: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_has_queue_state_support() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn xive_native_get_vp_state(vp_id: u32, out_state: *mut u64) -> c_int {
