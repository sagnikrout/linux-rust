...
//! Source: arch/powerpc/sysdev/fsl_rcpm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rcpm_v2_irq_mask(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v1_irq_unmask(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v2_irq_unmask(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v1_set_ip_power(enable: bool, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v2_set_ip_power(enable: bool, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v1_cpu_enter_state(cpu: c_int, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v2_cpu_enter_state(cpu: c_int, state: c_int) {
    static void rcpm_v2_cpu_enter_state(int cpu, int state)
    {
    let mut hw_cpu: c_int = get_hard_smp_processor_id(cpu);
    let mut mask: u32 = 1 << cpu_core_index_of_thread(cpu);
    switch (state) {
    case E500_PM_PH10:
...
#[no_mangle]
unsafe extern "C" fn rcpm_v1_cpu_die(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qoriq_disable_thread(cpu: c_int) {
    static void qoriq_disable_thread(int cpu)
    {
    let mut thread: c_int = cpu_thread_in_core(cpu);
    book3e_stop_thread(thread);
    }

#[no_mangle]
unsafe extern "C" fn rcpm_v2_cpu_die(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v1_cpu_exit_state(cpu: c_int, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v1_cpu_up_prepare(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v2_cpu_exit_state(cpu: c_int, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v2_cpu_up_prepare(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v1_plat_enter_state(state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v2_plat_enter_state(state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcpm_v1_plat_enter_sleep() -> c_int {
    static int rcpm_v1_plat_enter_sleep(void)
    {
    return rcpm_v1_plat_enter_state(PLAT_PM_SLEEP);
    }
#[no_mangle]
unsafe extern "C" fn rcpm_v2_plat_enter_sleep() -> c_int {
    static int rcpm_v2_plat_enter_sleep(void)
    {
    return rcpm_v2_plat_enter_state(PLAT_PM_LPM20);
    }
#[no_mangle]
unsafe extern "C" fn rcpm_common_freeze_time_base(tben_reg: *mut u32, freeze: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn fsl_rcpm_init() -> int __init {
    int __init fsl_rcpm_init(void)
    {
    struct device_node *np;
    const struct of_device_id *match;
    void __iomem *base;
    np = of_find_matching_node_and_match(core::ptr::null_mut(), rcpm_matches, &match);
    if (!np)
    return 0;
    base = of_iomap(np, 0);
    of_node_put(np);
