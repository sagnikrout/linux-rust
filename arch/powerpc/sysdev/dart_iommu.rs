...
//! Source: arch/powerpc/sysdev/dart_iommu.c
#![no_std]
...
pub const DART_U4_BYPASS_BASE: c_uint = 0x8000000000ull;
// Macro flag: #define DBG(...)
    static DEFINE_SPINLOCK(invalidate_lock);
#[no_mangle]
pub unsafe extern "C" fn dart_tlb_invalidate_all() {
...
#[no_mangle]
pub unsafe extern "C" fn dart_tlb_invalidate_one(bus_rpn: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn dart_cache_sync(base: *mut c_uint, count: c_uint) {
...
//
    let mut start: c_ulong = (unsigned long)base;
    let mut end: c_ulong = start + (count + 1) * sizeof(unsigned int);
    unsigned int tmp;
...
#[no_mangle]
unsafe extern "C" fn dart_flush(tbl: *mut iommu_table) {
...
#[no_mangle]
unsafe extern "C" fn dart_free(tbl: *mut iommu_table, index: c_long, npages: c_long) {
    static void dart_free(struct iommu_table *tbl, long index, long npages)
    {
    unsigned int *dp, *orig_dp;
    let mut orig_npages: c_long = npages;
...
#[no_mangle]
unsafe extern "C" fn allocate_dart() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn dart_init(dart_node: *mut device_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iommu_table_dart_setup() {
...
#[no_mangle]
unsafe extern "C" fn pci_dma_bus_setup_dart(bus: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn dart_device_on_pcie(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_dma_dev_setup_dart(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn iommu_bypass_supported_dart(dev: *mut pci_dev, mask: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_init_early_dart(controller_ops: *mut pci_controller_ops) -> void __init {
    void __init iommu_init_early_dart(struct pci_controller_ops *controller_ops)
    {
    struct device_node *dn;
// Find the DART in the device-tree
    dn = of_find_compatible_node(core::ptr::null_mut(), "dart", "u3-dart");
    if (dn == core::ptr::null_mut()) {
    dn = of_find_compatible_node(core::ptr::null_mut(), "dart", "u4-dart");
    if (dn == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn iommu_dart_restore() {
...
#[no_mangle]
unsafe extern "C" fn iommu_init_late_dart() -> int __init {
