...
//! Source: arch/powerpc/sysdev/mpic_u3msi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mpic_u3msi_mask_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpic_u3msi_unmask_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn read_ht_magic_addr(pdev: *mut pci_dev, pos: c_uint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn find_ht_magic_addr(pdev: *mut pci_dev, hwirq: c_uint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn find_u4_magic_addr(pdev: *mut pci_dev, hwirq: c_uint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn u3msi_teardown_msi_irqs(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn u3msi_setup_msi_irqs(pdev: *mut pci_dev, nvec: c_int, type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mpic_u3msi_init(mpic: *mut mpic) -> int __init {
