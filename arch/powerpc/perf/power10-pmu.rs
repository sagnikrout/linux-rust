...
//! Source: arch/powerpc/perf/power10-pmu.c
#![no_std]
...
pub const POWER10_MMCRA_IFM1: c_uint = 0x0000000040000000UL;
pub const POWER10_MMCRA_IFM2: c_uint = 0x0000000080000000UL;
pub const POWER10_MMCRA_IFM3: c_uint = 0x00000000C0000000UL;
pub const POWER10_MMCRA_BHRB_MASK: c_uint = 0x00000000C0000000UL;
...
#[no_mangle]
unsafe extern "C" fn power10_get_alternatives(event: u64, flags: c_uint, alt[]: u64) -> c_int {
    static int power10_get_alternatives(u64 event, unsigned int flags, u64 alt[])
    {
    let mut num_alt: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn power10_check_attr_config(ev: *mut perf_event) -> c_int {
    static int power10_check_attr_config(struct perf_event *ev)
    {
    u64 val;
    let mut event: u64 = ev.attr.config;
...
#[no_mangle]
unsafe extern "C" fn power10_bhrb_filter_map(branch_sample_type: u64) -> u64 {
    static u64 power10_bhrb_filter_map(u64 branch_sample_type)
    {
    let mut pmu_bhrb_filter: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn power10_config_bhrb(pmu_bhrb_filter: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn init_power10_pmu() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn init_power11_pmu() -> int __init {
