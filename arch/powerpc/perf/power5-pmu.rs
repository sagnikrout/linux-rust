...
// Masks and values for using events from the various units
    ...
    grp = (pmc - 1) >> 1;
#[no_mangle]
pub unsafe extern "C" fn if(0x600005: event != 0x500009 && event !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn find_alternative(event: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power5_get_alternatives(event: u64, flags: c_uint, alt[]: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn power5_marked_instr_event(event: u64) -> c_int {
...
// byte 4 bits 1,3,5,7, byte 5 bits 6-7, byte 7 bits 0-4,6
    ...
    let mut mmcra: c_ulong = MMCRA_SDAR_DCACHE_MISS | MMCRA_SDAR_ERAT_MISS;
...
#[no_mangle]
unsafe extern "C" fn power5_disable_pmc(pmc: c_uint, mmcr: *mut mmcr_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn init_power5_pmu() -> int __init {
