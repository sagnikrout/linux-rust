...
//! Source: arch/powerpc/perf/mpc7450-pmu.c
#![no_std]
...
//
pub const PM_THRMULT_MSKS: c_uint = 0x40000;
pub const PM_THRESH_SH: c_int = 12;
pub const PM_THRESH_MSK: c_uint = 0x3f;
pub const PM_PMC_SH: c_int = 8;
pub const PM_PMC_MSK: c_int = 7;
...
//
pub const N_CLASSES: c_int = 5;
#[no_mangle]
unsafe extern "C" fn mpc7450_classify_event(event: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpc7450_threshold_use(event: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn find_alternative(event: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpc7450_get_alternatives(event: u64, flags: c_uint, alt[]: u64) -> c_int {
...
//
    ...
    int i, j, class, tuse;
    let mut pmc_inuse: u32 = 0, pmc_avail;
    let mut mmcr0: u32 = 0, mmcr1 = 0, mmcr2 = 0;
    u32 ev, pmc, thresh;
    if (n_ev > N_COUNTER)
    return -1;
...
//
#[no_mangle]
unsafe extern "C" fn mpc7450_disable_pmc(pmc: c_uint, mmcr: *mut mmcr_regs) {
...
#[no_mangle]
unsafe extern "C" fn init_mpc7450_pmu() -> int __init {
