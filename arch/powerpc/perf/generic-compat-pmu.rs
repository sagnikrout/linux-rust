...
//! Source: arch/powerpc/perf/generic-compat-pmu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn generic_get_alternatives(event: u64, flags: c_uint, alt[]: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn init_generic_compat_pmu() -> int __init {
