...
//! Source: arch/powerpc/perf/power9-pmu.c
#![no_std]
...
pub const POWER9_MMCRA_IFM1: c_uint = 0x0000000040000000UL;
pub const POWER9_MMCRA_IFM2: c_uint = 0x0000000080000000UL;
pub const POWER9_MMCRA_IFM3: c_uint = 0x00000000C0000000UL;
pub const POWER9_MMCRA_BHRB_MASK: c_uint = 0x00000000C0000000UL;
...
#[no_mangle]
unsafe extern "C" fn power9_get_alternatives(event: u64, flags: c_uint, alt[]: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power9_check_attr_config(ev: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power9_bhrb_filter_map(branch_sample_type: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn power9_config_bhrb(pmu_bhrb_filter: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn init_power9_pmu() -> int __init {
