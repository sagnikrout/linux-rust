...
//! Source: arch/powerpc/include/uapi/asm/kvm.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_ppc_compat_caps {
    pub /: *mut *mut __u64 size; / Size of this structure,
    pub /: *mut *mut __u64 flags; / Reserved for future use,
    pub /: *mut *mut __u64 compat_capabilities; / Capabilities supported by the host,
}
