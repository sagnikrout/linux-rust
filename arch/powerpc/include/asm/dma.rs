...
//! Source: arch/powerpc/include/asm/dma.h
#![no_std]
...
pub const DMA_LO_PAGE_0: c_uint = 0x87	/* DMA page registers */;
pub const DMA_LO_PAGE_1: c_uint = 0x83;
pub const DMA_LO_PAGE_2: c_uint = 0x81;
pub const DMA_LO_PAGE_3: c_uint = 0x82;
pub const DMA_LO_PAGE_5: c_uint = 0x8B;
pub const DMA_LO_PAGE_6: c_uint = 0x89;
pub const DMA_LO_PAGE_7: c_uint = 0x8A;
pub const DMA_HI_PAGE_0: c_uint = 0x487	/* DMA page registers */;
pub const DMA_HI_PAGE_1: c_uint = 0x483;
pub const DMA_HI_PAGE_2: c_uint = 0x481;
pub const DMA_HI_PAGE_3: c_uint = 0x482;
pub const DMA_HI_PAGE_5: c_uint = 0x48B;
pub const DMA_HI_PAGE_6: c_uint = 0x489;
pub const DMA_HI_PAGE_7: c_uint = 0x48A;
pub const DMA1_EXT_REG: c_uint = 0x40B;
pub const DMA2_EXT_REG: c_uint = 0x4D6;

// in arch/powerpc/kernel/setup_32.c -- Cort

pub const DMA_MODE_READ: c_uint = 0x44	/* I/O to memory, no autoinit, increment, single mode */;
pub const DMA_MODE_WRITE: c_uint = 0x48	/* memory to I/O, no autoinit, increment, single mode */;

pub const DMA_MODE_CASCADE: c_uint = 0xC0	/* pass thru DREQ->HRQ, DACK<-HLDA only */;
