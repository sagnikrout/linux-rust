...
//! Source: arch/powerpc/include/asm/papr-sysparm.h
#![no_std]
...
extern "C" {
    pub fn papr_sysparm_set(param: papr_sysparm_t, buf: *const papr_sysparm_buf) -> c_int;
}
extern "C" {
    pub fn papr_sysparm_get(param: papr_sysparm_t, buf: *mut papr_sysparm_buf) -> c_int;
}
