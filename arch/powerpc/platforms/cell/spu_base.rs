...
//! Source: arch/powerpc/platforms/cell/spu_base.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mm_needs_global_tlbie(mm: *mut mm_struct) {
    static inline void mm_needs_global_tlbie(struct mm_struct *mm)
    {
    let mut nr: c_int = (NR_CPUS > 1) ? NR_CPUS : NR_CPUS + 1;
...
#[no_mangle]
unsafe extern "C" fn spu_restart_dma(spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn spu_load_slb(spu: *mut spu, slbe: c_int, slb: *mut copro_slb) {
...
#[no_mangle]
unsafe extern "C" fn __spu_trap_data_seg(spu: *mut spu, ea: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __spu_trap_data_map(spu: *mut spu, ea: c_ulong, dsisr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __spu_kernel_slb(addr: *mut c_void, slb: *mut copro_slb) {
    static void __spu_kernel_slb(void *addr, struct copro_slb *slb)
    {
    let mut ea: c_ulong = (unsigned long)addr;
    u64 llp;
...
//
    ...
    void *new_addr)
    {
    let mut ea: c_ulong = (unsigned long)new_addr;
    int i;
    for (i = 0; i < nr_slbs; i++)
...
#[no_mangle]
unsafe extern "C" fn spu_request_irqs(spu: *mut spu) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn spu_free_irqs(spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn spu_add_dev_attr(attr: *mut device_attribute) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn spu_add_dev_attr_group(attrs: *const attribute_group) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn spu_remove_dev_attr(attr: *mut device_attribute) {
...
#[no_mangle]
pub unsafe extern "C" fn spu_remove_dev_attr_group(attrs: *const attribute_group) {
...
#[no_mangle]
unsafe extern "C" fn spu_create_dev(spu: *mut spu) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn create_spu(data: *mut c_void) -> int __init {
    ...
    {
    let mut time: c_ulonglong = spu.stats.times[state];
//
...
//
    ...
    static DEVICE_ATTR(stat, 0444, spu_stat_show, core::ptr::null_mut());

#[repr(C)]
#[derive(Copy, Clone)]
pub struct crash_spu_info {
    pub spu: *mut spu,
    pub saved_spu_runcntl_RW: u32,
    pub saved_spu_status_R: u32,
    pub saved_spu_npc_RW: u32,
    pub saved_mfc_sr1_RW: u64,
    pub saved_mfc_dar: u64,
    pub saved_mfc_dsisr: u64,
}

    static struct crash_spu_info crash_spu_info[CRASH_NUM_SPUS];
#[no_mangle]
unsafe extern "C" fn crash_kexec_stop_spus() {
...
#[no_mangle]
unsafe extern "C" fn crash_register_spus(list: *mut list_head) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn crash_register_spus(list: *mut list_head) {
    static inline void crash_register_spus(struct list_head *list)
    {
    }

#[no_mangle]
unsafe extern "C" fn spu_shutdown(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn init_spu_base() -> int __init {
...
// create system subsystem for spus
    ret = subsys_system_register(&spu_subsys, core::ptr::null_mut());
    if (ret)
    goto out;
