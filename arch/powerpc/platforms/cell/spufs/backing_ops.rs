...
//! Source: arch/powerpc/platforms/cell/spufs/backing_ops.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn gen_spu_event(ctx: *mut spu_context, event: u32) {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_mbox_read(ctx: *mut spu_context, data: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_mbox_stat_read(ctx: *mut spu_context) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_ibox_read(ctx: *mut spu_context, data: *mut *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_wbox_write(ctx: *mut spu_context, data: u32) -> c_int {
    static int spu_backing_wbox_write(struct spu_context *ctx, u32 data)
    {
    int ret;
    spin_lock(&ctx.csa.register_lock);
    if ((ctx.csa.prob.mb_stat_R) & 0x00ff00) {
    let mut slot: c_int = ctx.csa.spu_chnlcnt_RW[29];
    let mut avail: c_int = (ctx.csa.prob.mb_stat_R & 0x00ff00) >> 8;
...
#[no_mangle]
unsafe extern "C" fn spu_backing_signal1_read(ctx: *mut spu_context) -> u32 {
    static u32 spu_backing_signal1_read(struct spu_context *ctx)
    {
    return ctx.csa.spu_chnldata_RW[3];
    }
#[no_mangle]
unsafe extern "C" fn spu_backing_signal1_write(ctx: *mut spu_context, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_signal2_read(ctx: *mut spu_context) -> u32 {
    static u32 spu_backing_signal2_read(struct spu_context *ctx)
    {
    return ctx.csa.spu_chnldata_RW[4];
    }
#[no_mangle]
unsafe extern "C" fn spu_backing_signal2_write(ctx: *mut spu_context, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_signal1_type_set(ctx: *mut spu_context, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_signal1_type_get(ctx: *mut spu_context) -> u64 {
    static u64 spu_backing_signal1_type_get(struct spu_context *ctx)
    {
    return ((ctx.csa.priv2.spu_cfg_RW & 1) != 0);
    }
#[no_mangle]
unsafe extern "C" fn spu_backing_signal2_type_set(ctx: *mut spu_context, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_privcntl_write(ctx: *mut spu_context, val: u64) {
    static void spu_backing_privcntl_write(struct spu_context *ctx, u64 val)
    {
    ctx.csa.priv2.spu_privcntl_RW = val;
    }
#[no_mangle]
unsafe extern "C" fn spu_backing_runcntl_read(ctx: *mut spu_context) -> u32 {
    static u32 spu_backing_runcntl_read(struct spu_context *ctx)
    {
    return ctx.csa.prob.spu_runcntl_RW;
    }
#[no_mangle]
unsafe extern "C" fn spu_backing_runcntl_write(ctx: *mut spu_context, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_runcntl_stop(ctx: *mut spu_context) {
    static void spu_backing_runcntl_stop(struct spu_context *ctx)
    {
    spu_backing_runcntl_write(ctx, SPU_RUNCNTL_STOP);
    }
#[no_mangle]
unsafe extern "C" fn spu_backing_master_start(ctx: *mut spu_context) {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_master_stop(ctx: *mut spu_context) {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_read_mfc_tagstatus(ctx: *mut *mut spu_context) -> u32 {
    static u32 spu_backing_read_mfc_tagstatus(struct spu_context * ctx)
    {
    return ctx.csa.prob.dma_tagstatus_R;
    }
#[no_mangle]
unsafe extern "C" fn spu_backing_get_mfc_free_elements(ctx: *mut spu_context) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn spu_backing_restart_dma(ctx: *mut spu_context) {
