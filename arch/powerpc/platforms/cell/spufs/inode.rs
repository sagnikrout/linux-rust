...
//! Source: arch/powerpc/platforms/cell/spufs/inode.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn spufs_free_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn spufs_rmdir(parent: *mut inode, dir: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn unuse_gang(dir: *mut dentry) {
    ...
    inode_unlock(inode);
    if (dead)
    simple_recursive_removal(dir, core::ptr::null_mut());
    }
    }
#[no_mangle]
unsafe extern "C" fn spufs_dir_close(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_context_open(path: *const path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_gang_close(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_gang_open(path: *const path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_show_options(m: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_exit_isolated_loader() {
...
#[no_mangle]
unsafe extern "C" fn spufs_create_root(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_get_tree(fc: *mut fs_context) -> c_int {
    static int spufs_get_tree(struct fs_context *fc)
    {
    return get_tree_single(fc, spufs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn spufs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn spufs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn spufs_exit() -> void __exit {
