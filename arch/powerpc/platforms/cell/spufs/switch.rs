...
//! Source: arch/powerpc/platforms/cell/spufs/switch.c
#![no_std]
...
pub const RELAX_SPIN_COUNT: c_int = 1000;
...
#[no_mangle]
pub unsafe extern "C" fn acquire_spu_lock(spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn release_spu_lock(spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn check_spu_isolate(csa: *mut spu_state, spu: *mut spu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn disable_interrupts(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn set_watchdog_timer(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn inhibit_user_access(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn set_switch_pending(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_cntl(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_spu_runcntl(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_sr1(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_spu_status(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn halt_mfc_decr(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_timebase(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn do_mfc_mssync(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn issue_mfc_tlbie(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_queues(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_ppu_querymask(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_ppu_querytype(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_ppu_tagstatus(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_csr_tsq(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_csr_cmd(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_csr_ato(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_tclass_id(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn set_mfc_tclass_id(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn purge_mfc_queue(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn wait_purge_complete(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn setup_mfc_sr1(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_spu_npc(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_spu_privcntl(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn reset_spu_privcntl(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_spu_lslr(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn reset_spu_lslr(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_spu_cfg(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_pm_trace(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_rag(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_ppu_mb_stat(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_ppu_mb(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_ppuint_mb(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_ch_part1(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_spu_mb(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn save_mfc_cmd(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn reset_ch(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn resume_mfc_queue(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn set_switch_active(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn enable_interrupts(csa: *mut spu_state, spu: *mut spu) {
...
//
    ...
    let mut status: volatile unsigned int = 0x0;
    while (size > 0) {
    transfer_size =
...
#[no_mangle]
pub unsafe extern "C" fn save_ls_16kb(csa: *mut spu_state, spu: *mut spu) {
    static inline void save_ls_16kb(struct spu_state *csa, struct spu *spu)
    {
    let mut addr: c_ulong = (unsigned long)&csa.lscsa.ls[0];
    let mut ls_offset: c_uint = 0x0;
    let mut size: c_uint = 16384;
    let mut tag: c_uint = 0;
    let mut rclass: c_uint = 0;
    let mut cmd: c_uint = MFC_PUT_CMD;
// Save, Step 50:
...
#[no_mangle]
pub unsafe extern "C" fn set_spu_npc(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn set_signot1(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn set_signot2(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn send_save_code(csa: *mut spu_state, spu: *mut spu) {
    static inline void send_save_code(struct spu_state *csa, struct spu *spu)
    {
    let mut addr: c_ulong = (unsigned long)&spu_save_code[0];
    let mut ls_offset: c_uint = 0x0;
    let mut size: c_uint = sizeof(spu_save_code);
    let mut tag: c_uint = 0;
    let mut rclass: c_uint = 0;
    let mut cmd: c_uint = MFC_GETFS_CMD;
// Save, Step 54:
...
#[no_mangle]
pub unsafe extern "C" fn set_ppu_querymask(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn wait_tag_complete(csa: *mut spu_state, spu: *mut spu) {
    static inline void wait_tag_complete(struct spu_state *csa, struct spu *spu)
    {
    struct spu_problem __iomem *prob = spu.problem;
    let mut mask: u32 = MFC_TAGID_TO_TAGMASK(0);
    unsigned long flags;
// Save, Step 56:
// Restore, Step 39.
// Restore, Step 46.
...
#[no_mangle]
pub unsafe extern "C" fn wait_spu_stopped(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn check_save_status(csa: *mut spu_state, spu: *mut spu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn terminate_spu_app(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn suspend_spe(csa: *mut spu_state, spu: *mut spu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn clear_spu_status(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn reset_ch_part1(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn reset_ch_part2(csa: *mut spu_state, spu: *mut spu) {
...
//
    ...
    struct spu *spu)
    {
    let mut status_P: u32 = SPU_STATUS_STOPPED_BY_STOP;
    let mut status_I: u32 = SPU_STATUS_INVALID_INSTR;
    let mut status_H: u32 = SPU_STATUS_STOPPED_BY_HALT;
    let mut status_S: u32 = SPU_STATUS_SINGLE_STEP;
    let mut status_S_I: u32 = SPU_STATUS_SINGLE_STEP | SPU_STATUS_INVALID_INSTR;
    let mut status_S_P: u32 = SPU_STATUS_SINGLE_STEP | SPU_STATUS_STOPPED_BY_STOP;
    let mut status_P_H: u32 = SPU_STATUS_STOPPED_BY_HALT |SPU_STATUS_STOPPED_BY_STOP;
    let mut status_P_I: u32 = SPU_STATUS_STOPPED_BY_STOP |SPU_STATUS_INVALID_INSTR;
    u32 status_code;
// Restore, Step 27:
...
#[no_mangle]
pub unsafe extern "C" fn restore_mfc_rag(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn send_restore_code(csa: *mut spu_state, spu: *mut spu) {
    static inline void send_restore_code(struct spu_state *csa, struct spu *spu)
    {
    let mut addr: c_ulong = (unsigned long)&spu_restore_code[0];
    let mut ls_offset: c_uint = 0x0;
    let mut size: c_uint = sizeof(spu_restore_code);
    let mut tag: c_uint = 0;
    let mut rclass: c_uint = 0;
    let mut cmd: c_uint = MFC_GETFS_CMD;
// Restore, Step 37:
...
#[no_mangle]
pub unsafe extern "C" fn setup_decr(csa: *mut spu_state, spu: *mut spu) {
...
//
    ...
    let mut resume_time: cycles_t = get_cycles();
    let mut delta_time: cycles_t = resume_time - csa.suspend_time;
...
#[no_mangle]
pub unsafe extern "C" fn setup_ppu_mb(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn setup_ppuint_mb(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn check_restore_status(csa: *mut spu_state, spu: *mut spu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn restore_spu_privcntl(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_status_part1(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_status_part2(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_ls_16kb(csa: *mut spu_state, spu: *mut spu) {
    ...
    let mut tag: c_uint = 0;
    let mut rclass: c_uint = 0;
    let mut cmd: c_uint = MFC_GET_CMD;
// Restore, Step 44:
...
#[no_mangle]
pub unsafe extern "C" fn suspend_mfc(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_interrupts(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_mfc_queues(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_ppu_querymask(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_ppu_querytype(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_mfc_csr_tsq(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_mfc_csr_cmd(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_mfc_csr_ato(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_mfc_tclass_id(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn set_llr_event(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_decr_wrapped(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_ch_part1(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_ch_part2(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_spu_lslr(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_spu_cfg(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_pm_trace(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_spu_npc(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_spu_mb(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn check_ppu_mb_stat(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn check_ppuint_mb_stat(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_mfc_sr1(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn set_int_route(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_spu_runcntl(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_mfc_cntl(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn enable_user_access(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn reset_switch_active(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
pub unsafe extern "C" fn reenable_interrupts(csa: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn quiece_spu(prev: *mut spu_state, spu: *mut spu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn save_csa(prev: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn save_lscsa(prev: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn force_spu_isolate_exit(spu: *mut spu) {
...
//
#[no_mangle]
unsafe extern "C" fn stop_spu_isolate(spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn harvest(prev: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn restore_lscsa(next: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn restore_csa(next: *mut spu_state, spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn __do_spu_save(prev: *mut spu_state, spu: *mut spu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __do_spu_restore(next: *mut spu_state, spu: *mut spu) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spu_save(prev: *mut spu_state, spu: *mut spu) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn spu_restore(new: *mut spu_state, spu: *mut spu) -> c_int {
    int spu_restore(struct spu_state *new, struct spu *spu)
    {
    int rc;
    acquire_spu_lock(spu);
    harvest(core::ptr::null_mut(), spu);
    spu.slb_replace = 0;
...
#[no_mangle]
unsafe extern "C" fn init_prob(csa: *mut spu_state) {
...
#[no_mangle]
unsafe extern "C" fn init_priv1(csa: *mut spu_state) {
...
#[no_mangle]
unsafe extern "C" fn init_priv2(csa: *mut spu_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn spu_init_csa(csa: *mut spu_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn spu_fini_csa(csa: *mut spu_state) {
