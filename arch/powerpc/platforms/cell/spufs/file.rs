...
//! Source: arch/powerpc/platforms/cell/spufs/file.c
#![no_std]
...
pub struct spufs_attr {
    pub ): *mut *mut *mut int (get)(void , u64,
    pub u64): *mut *mut *mut int (set)(void ,,
    pub /: *mut *mut char get_buf[24]; / enough to store a u64 and "\n\0",
    pub set_buf: [c_char; 24],
    pub data: *mut c_void,
    pub /: *const *const *const char fmt; / format for read operation,
    pub /: *mut *mut mutex mutex; / protects access to these buffers,
}
...
#[no_mangle]
unsafe extern "C" fn spufs_attr_release(inode: *mut inode, file: *mut file) -> c_int {
    ...
    attr.set_buf[size] = '\0';
    val = simple_strtol(attr.set_buf, core::ptr::null_mut(), 0);
    ...
    mutex_lock(&ctx.mapping_lock);
    if (!--i.i_openers)
    ctx.local_store = core::ptr::null_mut();
    mutex_unlock(&ctx.mapping_lock);
    return 0;
    }
    static ssize_t
    ...
    {
    struct spu_context *ctx = vma.vm_file.private_data;
    let mut offset: c_ulong = address - vma.vm_start;
    char *local_store;
...
#[no_mangle]
unsafe extern "C" fn spufs_mem_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_cntl_mmap_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
//
#[no_mangle]
unsafe extern "C" fn spufs_cntl_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_cntl_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_cntl_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_cntl_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_pipe_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn spu_ibox_read(ctx: *mut spu_context, data: *mut u32) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn spufs_ibox_callback(spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn spufs_ibox_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
pub unsafe extern "C" fn spu_wbox_write(ctx: *mut spu_context, data: u32) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn spufs_wbox_callback(spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn spufs_wbox_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn spufs_signal1_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_signal1_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_signal2_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_signal2_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
//
pub const SPU_ATTR_NOACQUIRE: c_int = 0;
pub const SPU_ATTR_ACQUIRE: c_int = 1;
pub const SPU_ATTR_ACQUIRE_SAVED: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn spufs_signal1_type_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_signal1_type_get(ctx: *mut spu_context) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn spufs_signal2_type_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_signal2_type_get(ctx: *mut spu_context) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn spufs_mss_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_mss_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spufs_psmap_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_psmap_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spufs_mfc_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_mfc_open(inode: *mut inode, file: *mut file) -> c_int {
...
// we don't want to deal with DMA into other processes
    ...
    mutex_lock(&ctx.mapping_lock);
    if (!--i.i_openers)
    ctx.mfc = core::ptr::null_mut();
    mutex_unlock(&ctx.mapping_lock);
    return 0;
    }
// interrupt-level mfc callback function.
#[no_mangle]
pub unsafe extern "C" fn spufs_mfc_callback(spu: *mut spu) {
...
#[no_mangle]
unsafe extern "C" fn spufs_read_mfc_tagstatus(ctx: *mut spu_context, status: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_check_valid_dma(cmd: *mut mfc_dma_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_mfc_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn spufs_mfc_flush(file: *mut file, id: fl_owner_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_mfc_fsync(file: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
    ...
    if (!err) {
    inode_lock(inode);
    err = spufs_mfc_flush(file, core::ptr::null_mut());
    inode_unlock(inode);
    }
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn spufs_npc_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_npc_get(ctx: *mut spu_context) -> u64 {
    ...
    "0x%llx\n", SPU_ATTR_ACQUIRE);
#[no_mangle]
unsafe extern "C" fn spufs_decr_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_decr_get(ctx: *mut spu_context) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn spufs_decr_status_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_decr_status_get(ctx: *mut spu_context) -> u64 {
    ...
    SPU_ATTR_ACQUIRE_SAVED);
#[no_mangle]
unsafe extern "C" fn spufs_event_mask_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_event_mask_get(ctx: *mut spu_context) -> u64 {
    ...
    SPU_ATTR_ACQUIRE_SAVED);
#[no_mangle]
unsafe extern "C" fn spufs_event_status_get(ctx: *mut spu_context) -> u64 {
    ...
    core::ptr::null_mut(), "0x%llx\n", SPU_ATTR_ACQUIRE_SAVED)
#[no_mangle]
unsafe extern "C" fn spufs_srr0_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_srr0_get(ctx: *mut spu_context) -> u64 {
    ...
    "0x%llx\n", SPU_ATTR_ACQUIRE_SAVED)
#[no_mangle]
unsafe extern "C" fn spufs_id_get(ctx: *mut spu_context) -> u64 {
    ...
    DEFINE_SPUFS_ATTRIBUTE(spufs_id_ops, spufs_id_get, core::ptr::null_mut(), "0x%llx\n",
    SPU_ATTR_ACQUIRE)
#[no_mangle]
unsafe extern "C" fn spufs_object_id_get(ctx: *mut spu_context) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn spufs_object_id_set(data: *mut c_void, id: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_lslr_get(ctx: *mut spu_context) -> u64 {
    static u64 spufs_lslr_get(struct spu_context *ctx)
    {
    return ctx.csa.priv2.spu_lslr_RW;
    }
    DEFINE_SPUFS_ATTRIBUTE(spufs_lslr_ops, spufs_lslr_get, core::ptr::null_mut(), "0x%llx\n",
    SPU_ATTR_ACQUIRE_SAVED);
#[no_mangle]
unsafe extern "C" fn spufs_info_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_caps_show(s: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_caps_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_wbox_info_cnt(ctx: *mut spu_context) -> usize {
...
#[no_mangle]
unsafe extern "C" fn spufs_show_tid(s: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_tid_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    {
    let mut time: c_ulonglong = ctx.stats.times[state];
//
...
#[no_mangle]
unsafe extern "C" fn spufs_slb_flts(ctx: *mut spu_context) -> c_ulonglong {
    static unsigned long long spufs_slb_flts(struct spu_context *ctx)
    {
    let mut slb_flts: c_ulonglong = ctx.stats.slb_flt;
    if (ctx.state == SPU_STATE_RUNNABLE) {
...
#[no_mangle]
unsafe extern "C" fn spufs_class2_intrs(ctx: *mut spu_context) -> c_ulonglong {
    static unsigned long long spufs_class2_intrs(struct spu_context *ctx)
    {
    let mut class2_intrs: c_ulonglong = ctx.stats.class2_intr;
    if (ctx.state == SPU_STATE_RUNNABLE) {
...
#[no_mangle]
unsafe extern "C" fn spufs_show_stat(s: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_stat_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn spufs_switch_log_used(ctx: *mut spu_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn spufs_switch_log_avail(ctx: *mut spu_context) -> c_int {
    static inline int spufs_switch_log_avail(struct spu_context *ctx)
    {
    return SWITCH_LOG_BUFSIZE - spufs_switch_log_used(ctx);
    }
#[no_mangle]
unsafe extern "C" fn spufs_switch_log_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_switch_log_release(inode: *mut inode, file: *mut file) -> c_int {
    ...
    ctx.switch_log = core::ptr::null_mut();
    spu_release(ctx);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn switch_log_sprint(ctx: *mut spu_context, tbuf: *mut c_char, n: c_int) -> c_int {
...
// partial buffer (so far)
    ...
    spu_release(ctx);
    let mut cnt: return = = 0 ? error : cnt;
    }
#[no_mangle]
unsafe extern "C" fn spufs_switch_log_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn spufs_show_ctx(s: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spufs_ctx_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    { "regs", spufs_regs_dump, core::ptr::null_mut(), sizeof(struct spu_reg128[128])},
    { "fpcr", spufs_fpcr_dump, core::ptr::null_mut(), sizeof(struct spu_reg128) },
    { "lslr", core::ptr::null_mut(), spufs_lslr_get, 19 },
    { "decr", core::ptr::null_mut(), spufs_decr_get, 19 },
    { "decr_status", core::ptr::null_mut(), spufs_decr_status_get, 19 },
    { "mem", spufs_mem_dump, core::ptr::null_mut(), LS_SIZE, },
    { "signal1", spufs_signal1_dump, core::ptr::null_mut(), sizeof(u32) },
    { "signal1_type", core::ptr::null_mut(), spufs_signal1_type_get, 19 },
    { "signal2", spufs_signal2_dump, core::ptr::null_mut(), sizeof(u32) },
    { "signal2_type", core::ptr::null_mut(), spufs_signal2_type_get, 19 },
    { "event_mask", core::ptr::null_mut(), spufs_event_mask_get, 19 },
    { "event_status", core::ptr::null_mut(), spufs_event_status_get, 19 },
    { "mbox_info", spufs_mbox_info_dump, core::ptr::null_mut(), sizeof(u32) },
    { "ibox_info", spufs_ibox_info_dump, core::ptr::null_mut(), sizeof(u32) },
    { "wbox_info", spufs_wbox_info_dump, core::ptr::null_mut(), 4 * sizeof(u32)},
    { "dma_info", spufs_dma_info_dump, core::ptr::null_mut(), sizeof(struct spu_dma_info)},
    { "proxydma_info", spufs_proxydma_info_dump,
    core::ptr::null_mut(), sizeof(struct spu_proxydma_info)},
    { "object-id", core::ptr::null_mut(), spufs_object_id_get, 19 },
    { "npc", core::ptr::null_mut(), spufs_npc_get, 19 },
    { core::ptr::null_mut() },
    };
