...
//! Source: arch/powerpc/platforms/cell/spufs/fault.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn spufs_handle_class0(ctx: *mut spu_context) -> c_int {
    int spufs_handle_class0(struct spu_context *ctx)
    {
    let mut stat: c_ulong = ctx.csa.class_0_pending & CLASS0_INTR_MASK;
    if (likely(!stat))
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn spufs_handle_class1(ctx: *mut spu_context) -> c_int {
