...
//! Source: arch/powerpc/platforms/book3s/vas-api.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct coproc_instance {
    pub coproc: *mut coproc_dev,
    pub txwin: *mut vas_window,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn get_vas_user_win_ref(task_ref: *mut vas_user_win_ref) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vas_dump_crb(crb: *mut coprocessor_request_block) {
...
#[no_mangle]
unsafe extern "C" fn coproc_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coproc_ioc_tx_win_open(fp: *mut file, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coproc_release(inode: *mut inode, fp: *mut file) -> c_int {
    ...
    cp_inst.txwin = core::ptr::null_mut();
    }
    kfree(cp_inst);
...
//
#[no_mangle]
unsafe extern "C" fn do_fail_paste() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vas_mmap_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
//
#[no_mangle]
unsafe extern "C" fn vas_mmap_close(vma: *mut vm_area_struct) {
...
//
    ...
    scoped_guard(mutex, &txwin.task_ref.mmap_mutex)
    txwin.task_ref.vma = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn coproc_mmap(fp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coproc_ioctl(fp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
    ...
    coproc_device.device = device_create(coproc_device.class, core::ptr::null_mut(),
    devno, core::ptr::null_mut(), name, MINOR(devno));
