...
//! Source: arch/powerpc/platforms/pseries/mobility.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct update_props_workarea {
    pub phandle: __be32,
    pub state: __be32,
    pub reserved: __be64,
    pub nprops: __be32,
    pub __packed: },
pub const NODE_ACTION_MASK: c_uint = 0xff000000;
pub const NODE_COUNT_MASK: c_uint = 0x00ffffff;
pub const DELETE_DT_NODE: c_uint = 0x01000000;
pub const UPDATE_DT_NODE: c_uint = 0x02000000;
pub const ADD_DT_NODE: c_uint = 0x03000000;

    pub 200: static unsigned int nmi_wd_lpm_factor =,
...
#[no_mangle]
unsafe extern "C" fn register_nmi_wd_lpm_factor_sysctl() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mobility_rtas_call(token: c_int, buf: *mut c_char, scope: i32) -> c_int {
    static int mobility_rtas_call(int token, char *buf, s32 scope)
    {
    int rc;
    spin_lock(&rtas_data_buf_lock);
    memcpy(rtas_data_buf, buf, RTAS_DATA_BUF_SIZE);
    rc = rtas_call(token, 2, 1, core::ptr::null_mut(), rtas_data_buf, scope);
    memcpy(buf, rtas_data_buf, RTAS_DATA_BUF_SIZE);
    spin_unlock(&rtas_data_buf_lock);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn delete_dt_node(dn: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_dt_node(dn: *mut device_node, scope: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_dt_node(parent_dn: *mut device_node, drc_index: __be32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseries_devicetree_update(scope: i32) -> c_int {
    ...
    int i;
    let mut action: u32 = be32_to_cpu(*data) & NODE_ACTION_MASK;
    let mut node_count: u32 = be32_to_cpu(*data) & NODE_COUNT_MASK;
    data++;
    for (i = 0; i < node_count; i++) {
    struct device_node *np;
    let mut phandle: __be32 = *data++;
    __be32 drc_index;
...
#[no_mangle]
pub unsafe extern "C" fn post_mobility_fixup() {
...
#[no_mangle]
unsafe extern "C" fn poll_vasi_state(handle: u64, res: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_for_vasi_session_suspending(handle: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_for_vasi_session_completed(handle: u64) {
...
#[no_mangle]
unsafe extern "C" fn prod_single(target_cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn prod_others() {
...
#[no_mangle]
unsafe extern "C" fn clamp_slb_size() -> u16 {
    static u16 clamp_slb_size(void)
    {

    let mut prev: u16 = mmu_slb_size;
...
#[no_mangle]
unsafe extern "C" fn do_suspend() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pseries_suspend_info {
    pub counter: core::sync::atomic::AtomicI32,
    pub done: bool,
}

#[no_mangle]
unsafe extern "C" fn do_join(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseries_cancel_migration(handle: u64, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pseries_suspend(handle: u64) -> c_int {
    static int pseries_suspend(u64 handle)
    {
    let mut max_attempts: c_uint = 5;
    let mut retry_interval_ms: c_uint = 1;
    let mut attempt: c_uint = 1;
    int ret;
    while (true) {
...
#[no_mangle]
unsafe extern "C" fn pseries_migrate_partition(handle: u64) -> c_int {
    static int pseries_migrate_partition(u64 handle)
    {
    int ret;
    let mut factor: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn rtas_syscall_dispatch_ibm_suspend_me(handle: u64) -> c_int {
...
//
pub const MIGRATION_API_VERSION: c_int = 1;
    static CLASS_ATTR_WO(migration);
    static CLASS_ATTR_STRING(api_version, 0444, __stringify(MIGRATION_API_VERSION));
#[no_mangle]
unsafe extern "C" fn mobility_sysfs_init() -> int __init {
