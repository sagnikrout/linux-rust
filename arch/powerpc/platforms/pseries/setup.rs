...
//! Source: arch/powerpc/platforms/pseries/setup.c
#![no_std]
...
unsafe extern "C" fn parse_no_stealacc(arg: *mut c_char) -> int __init {
    ...
    let mut CMO_PrPSP: c_int = -1;
    let mut CMO_SecPSP: c_int = -1;
    let mut CMO_PageSize: c_ulong = (ASM_CONST(1) << IOMMU_PAGE_SHIFT_4K);
    EXPORT_SYMBOL(CMO_PageSize);
    int fwnmi_active;  /* TRUE if an FWNMI handler is present */
    int ibm_nmi_interlock_token;
    u32 pseries_security_flavor;
#[no_mangle]
unsafe extern "C" fn pSeries_show_cpuinfo(m: *mut seq_file) {
...
//
#[no_mangle]
unsafe extern "C" fn fwnmi_init() -> void __init {
    static void __init fwnmi_init(void)
    {
    unsigned long system_reset_addr, machine_check_addr;
    u8 *mce_data_buf;
    unsigned int i;
    let mut nr_cpus: c_int = num_possible_cpus();
...
// addresses anyway, and use a trampoline to get to the real code.
    ...
    if (0 == rtas_call(ibm_nmi_register_token, 2, 1, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn pseries_crash_stop_watchdogs() {
...
//
#[no_mangle]
unsafe extern "C" fn pseries_wdt_init() -> __init int {
    static __init int pseries_wdt_init(void)
    {
    struct platform_device *pdev;
    if (!firmware_has_feature(FW_FEATURE_WATCHDOG))
    return 0;
    pdev = platform_device_register_simple("pseries-wdt", 0, core::ptr::null_mut(), 0);
    if (IS_ERR(pdev)) {
...
#[no_mangle]
unsafe extern "C" fn pseries_8259_cascade(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn pseries_setup_i8259_cascade() -> void __init {
    static void __init pseries_setup_i8259_cascade(void)
    {
    struct device_node *np, *old, *found = core::ptr::null_mut();
    ...
    for (old = of_node_get(found); old != core::ptr::null_mut() ; old = np) {
    ...
    continue;
    addrp = of_get_property(np, "8259-interrupt-acknowledge", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pseries_init_irq() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pseries_lpar_enable_pmcs() {
...
#[no_mangle]
unsafe extern "C" fn pci_dn_reconfig_notifier(nb: *mut notifier_block, action: c_ulong, data: *mut c_void) -> c_int {
    ...
    pdn = parent ? PCI_DN(parent) : core::ptr::null_mut();
    if (pdn)
...
//
#[no_mangle]
unsafe extern "C" fn alloc_dispatch_logs() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn alloc_dispatch_logs() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alloc_dispatch_log_kmem_cache() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseries_lpar_idle() {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_reloc_on_exception() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pseries_enable_reloc_on_exc() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_disable_reloc_on_exc() {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_big_endian_exceptions() {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_little_endian_exceptions() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pSeries_discover_phbs() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_cpu_char_feature_flags(result: *mut h_cpu_char_result) {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_setup_security_mitigations() {
...
//
    ...
    int i, num_res, ret = 0;
    indexes = of_get_property(dn, "ibm,open-sriov-vf-bar-info", core::ptr::null_mut());
    if (!indexes)
    return  0;
//
...
#[no_mangle]
unsafe extern "C" fn of_pci_set_vf_bar_size(dev: *mut pci_dev, indexes: *const c_int) {
...
#[no_mangle]
unsafe extern "C" fn of_pci_parse_iov_addrs(dev: *mut pci_dev, indexes: *const c_int) {
...
#[no_mangle]
unsafe extern "C" fn pseries_disable_sriov_resources(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pseries_pci_fixup_resources(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pseries_pci_fixup_iov_resources(pdev: *mut pci_dev) {
...
// Firmware must support open sriov otherwise report regular alignment
    reg = of_get_property(dn, "ibm,is-open-sriov-pf", core::ptr::null_mut());
    if (!reg)
...
#[no_mangle]
unsafe extern "C" fn pSeries_setup_arch() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pseries_panic(str: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn pSeries_init_panel() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pseries_set_dabr(dabr: c_ulong, dabrx: c_ulong) -> c_int {
    static int pseries_set_dabr(unsigned long dabr, unsigned long dabrx)
    {
    return plpar_hcall_norets(H_SET_DABR, dabr);
    }
#[no_mangle]
unsafe extern "C" fn pseries_set_xdabr(dabr: c_ulong, dabrx: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseries_set_dawr(nr: c_int, dawr: c_ulong, dawrx: c_ulong) -> c_int {
...
pub const CMO_CHARACTERISTICS_TOKEN: c_int = 44;
pub const CMO_MAXLENGTH: c_int = 1026;
#[no_mangle]
pub unsafe extern "C" fn pSeries_coalesce_init() {
...
//
#[no_mangle]
unsafe extern "C" fn pSeries_cmo_feature_init() -> void __init {
    ...
    let mut page_order: c_int = IOMMU_PAGE_SHIFT_4K;
...
// Never found a '=', end processing
    ...
    page_order = simple_strtol(value, core::ptr::null_mut(), 10);
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(key: 0 ==, _arg: "PrPSP")) -> else {
    else if (0 == strcmp(key, "PrPSP"))
    CMO_PrPSP = simple_strtol(value, core::ptr::null_mut(), 10);
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(key: 0 ==, _arg: "SecPSP")) -> else {
    else if (0 == strcmp(key, "SecPSP"))
    CMO_SecPSP = simple_strtol(value, core::ptr::null_mut(), 10);
    value = key = ptr + 1;
    }
    ptr++;
    }
...
#[no_mangle]
unsafe extern "C" fn pseries_add_hw_description() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn pseries_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: firmware_has_feature(FW_FEATURE_DABR)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn pseries_power_off() {
    static void pseries_power_off(void)
    {
    int rc;
    let mut rtas_poweroff_ups_token: c_int = rtas_function_token(RTAS_FN_IBM_POWER_OFF_UPS);
    if (rtas_flash_term_hook)
    rtas_flash_term_hook(SYS_POWER_OFF);
    if (rtas_poweron_auto == 0 ||
    rtas_poweroff_ups_token == RTAS_UNKNOWN_SERVICE) {
    rc = rtas_call(rtas_function_token(RTAS_FN_POWER_OFF), 2, 1, core::ptr::null_mut(), -1, -1);
    printk(KERN_INFO "RTAS power-off returned %d\n", rc);
    } else {
    rc = rtas_call(rtas_poweroff_ups_token, 0, 1, core::ptr::null_mut());
    printk(KERN_INFO "RTAS ibm,power-off-ups returned %d\n", rc);
    }
    for (;;);
    }
#[no_mangle]
unsafe extern "C" fn pSeries_probe() -> int __init {
    static int __init pSeries_probe(void)
    {
    struct device_node *root = of_find_node_by_path("/");
    let mut ret: bool = of_node_is_type(root, "chrp");
    of_node_put(root);
    if (!ret)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn pSeries_pci_probe_mode(bus: *mut pci_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseries_memory_block_size() -> c_ulong {
