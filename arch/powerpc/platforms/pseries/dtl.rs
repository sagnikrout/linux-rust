...
//! Source: arch/powerpc/platforms/pseries/dtl.c
#![no_std]
...
pub struct dtl {
    ...
    pub cpu: c_int,
    pub buf_entries: c_int,
    pub last_idx: u64,
    pub lock: spinlock_t,
}

    static DEFINE_PER_CPU(struct dtl, cpu_dtl);
    let mut dtl_event_mask: static u8 = DTL_LOG_ALL;
//
// Size of per-cpu log buffers. Firmware requires that the buffer does
// not cross a 4k boundary.
//
    let mut dtl_buf_entries: static int = N_DISPATCH_LOG;
...
pub struct dtl_ring {
    pub write_index: u64,
    pub write_ptr: *mut dtl_entry,
    pub buf: *mut dtl_entry,
    pub buf_end: *mut dtl_entry,
}
...
//
#[no_mangle]
unsafe extern "C" fn consume_dtle(dtle: *mut dtl_entry, index: u64) {
...
#[no_mangle]
unsafe extern "C" fn dtl_start(dtl: *mut dtl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dtl_stop(dtl: *mut dtl) {
...
// restore dtl_enable_mask
    ...
    dtl_consumer = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dtl_current_index(dtl: *mut dtl) -> u64 {
...
unsafe extern "C" fn dtl_stop(dtl: *mut dtl) {
    static void dtl_stop(struct dtl *dtl)
    {
    let mut hwcpu: c_int = get_hard_smp_processor_id(dtl.cpu);
...
#[no_mangle]
unsafe extern "C" fn dtl_enable(dtl: *mut dtl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dtl_disable(dtl: *mut dtl) {
...
// file interface
#[no_mangle]
unsafe extern "C" fn dtl_file_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dtl_file_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dtl_setup_file(dtl: *mut dtl) {
...
#[no_mangle]
unsafe extern "C" fn dtl_init() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn scan_dispatch_log(stop_tb: u64) -> notrace u64 {
    static notrace u64 scan_dispatch_log(u64 stop_tb)
    {
    let mut i: u64 = local_paca.dtl_ridx;
...
//
#[no_mangle]
pub unsafe extern "C" fn pseries_accumulate_stolen_time() -> void notrace {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_calculate_stolen_time(stop_tb: u64) -> u64 {
