...
//! Source: arch/powerpc/platforms/pseries/papr-platform-dump.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ibm_platform_dump_params {
    ...
    pub sequence_hi: u32,
    pub sequence_lo: u32,
    pub bytes_ret_hi: u32,
    pub bytes_ret_lo: u32,
    pub status: i32,
    pub list: list_head,
}
...
//
#[no_mangle]
unsafe extern "C" fn papr_platform_dump_create_handle(dump_tag: u64) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn papr_platform_dump_init() -> __init int {
