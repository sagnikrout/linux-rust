...
//! Source: arch/powerpc/platforms/pseries/lpar.c
#![no_std]
...
pub const HBR_REQUEST: c_uint = 0x4000000000000000UL;
pub const HBR_RESPONSE: c_uint = 0x8000000000000000UL;
pub const HBR_END: c_uint = 0xc000000000000000UL;
pub const HBR_AVPN: c_uint = 0x0200000000000000UL;
pub const HBR_ANDCOND: c_uint = 0x0100000000000000UL;
// in hvCall.S
...
//
pub const HBLKRM_SUPPORTED_BLOCK_SIZE: c_int = 8;

    let mut dtl_mask: static u8 = DTL_LOG_PREEMPT;

    static u8 dtl_mask;

#[no_mangle]
pub unsafe extern "C" fn alloc_dtl_buffers(time_limit: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn register_dtl_buffer(cpu: c_int) {
    void register_dtl_buffer(int cpu)
    {
    long ret;
    struct paca_struct *pp;
    struct dtl_entry *dtl;
    let mut hwcpu: c_int = get_hard_smp_processor_id(cpu);
    pp = paca_ptrs[cpu];
    dtl = pp.dispatch_log;
    if (dtl && dtl_mask) {
    pp.dtl_ridx = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vcpu_dispatch_data {
    pub last_disp_cpu: c_int,
    pub total_disp: c_int,
    pub same_cpu_disp: c_int,
    pub same_chip_disp: c_int,
    pub diff_chip_disp: c_int,
    pub far_chip_disp: c_int,
    pub numa_home_disp: c_int,
    pub numa_remote_disp: c_int,
    pub numa_far_disp: c_int,
}
...
//
    ...
    let mut vcpudispatch_stats_freq: static int = 50;
    static __be32 *vcpu_associativity, *pcpu_associativity;
#[no_mangle]
unsafe extern "C" fn free_dtl_buffers(time_limit: *mut c_ulong) {
    ...
    pp.dtl_ridx = 0;
    pp.dispatch_log = core::ptr::null_mut();
    pp.dispatch_log_end = core::ptr::null_mut();
    pp.dtl_curr = core::ptr::null_mut();
    if (time_limit && time_after(jiffies, *time_limit)) {
    cond_resched();
// time_limit = jiffies + HZ;
    }
...
#[no_mangle]
unsafe extern "C" fn init_cpu_associativity() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_cpu_associativity() {
    static void destroy_cpu_associativity(void)
    {
    kfree(vcpu_associativity);
    kfree(pcpu_associativity);
    vcpu_associativity = pcpu_associativity = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn cpu_relative_dispatch_distance(last_disp_cpu: c_int, cur_disp_cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_home_node_dispatch_distance(disp_cpu: c_int) -> c_int {
    static int cpu_home_node_dispatch_distance(int disp_cpu)
    {
    __be32 *disp_cpu_assoc, *vcpu_assoc;
    let mut vcpu_id: c_int = smp_processor_id();
...
#[no_mangle]
unsafe extern "C" fn update_vcpu_disp_stat(disp_cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn process_dtl_buffer(work: *mut work_struct) {
    static void process_dtl_buffer(struct work_struct *work)
    {
    struct dtl_entry dtle;
    let mut i: u64 = __this_cpu_read(dtl_entry_ridx);
...
#[no_mangle]
unsafe extern "C" fn dtl_worker_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dtl_worker_offline(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_global_dtl_mask(mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn reset_global_dtl_mask() {
...
#[no_mangle]
unsafe extern "C" fn dtl_worker_enable(time_limit: *mut c_ulong) -> c_int {
    static int dtl_worker_enable(unsigned long *time_limit)
    {
    let mut rc: c_int = 0, state;
...
#[no_mangle]
unsafe extern "C" fn dtl_worker_disable(time_limit: *mut c_ulong) {
    ...
    {
    let mut time_limit: c_ulong = jiffies + HZ;
    struct vcpu_dispatch_data *disp;
    int rc, cmd, cpu;
    char buf[16];
    if (count > 15)
...
#[no_mangle]
unsafe extern "C" fn vcpudispatch_stats_display(p: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcpudispatch_stats_open(inode: *mut inode, file: *mut file) -> c_int {
    static int vcpudispatch_stats_open(struct inode *inode, struct file *file)
    {
    return single_open(file, vcpudispatch_stats_display, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn vcpudispatch_stats_freq_display(p: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcpudispatch_stats_freq_open(inode: *mut inode, file: *mut file) -> c_int {
    static int vcpudispatch_stats_freq_open(struct inode *inode, struct file *file)
    {
    return single_open(file, vcpudispatch_stats_freq_display, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn vcpudispatch_stats_procfs_init() -> int __init {
    static int __init vcpudispatch_stats_procfs_init(void)
    {
    if (!lppaca_shared_proc())
    return 0;
    if (!proc_create("powerpc/vcpudispatch_stats", 0600, core::ptr::null_mut(),
    &vcpudispatch_stats_proc_ops))
    pr_err("vcpudispatch_stats: error creating procfs file\n");
    else if (!proc_create("powerpc/vcpudispatch_stats_freq", 0600, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn pseries_paravirt_steal_clock(cpu: c_int) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn vpa_init(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pSeries_lpar_hpte_remove(hpte_group: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn manual_hpte_clear_all() -> notrace void {
    static notrace void manual_hpte_clear_all(void)
    {
    let mut size_bytes: c_ulong = 1UL << ppc64_pft_size;
    let mut hpte_count: c_ulong = size_bytes >> 4;
    struct {
    unsigned long pteh;
    unsigned long ptel;
    } ptes[4];
...
// Called during kexec sequence with MMU off
#[no_mangle]
unsafe extern "C" fn hcall_hpte_clear_all() -> notrace int {
...
// Called during kexec sequence with MMU off
#[no_mangle]
unsafe extern "C" fn pseries_hpte_clear_all() -> notrace void {
...
#[no_mangle]
unsafe extern "C" fn __pSeries_lpar_hpte_find(want_v: c_ulong, hpte_group: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn pSeries_lpar_hpte_find(vpn: c_ulong, psize: c_int, ssize: c_int) -> c_long {
...
// the processed PTE.
//
pub const HBLKR_AVPN: c_uint = 0x0100000000000000UL;
pub const HBLKR_CTRL_MASK: c_uint = 0xf800000000000000UL;
pub const HBLKR_CTRL_SUCCESS: c_uint = 0x8000000000000000UL;
pub const HBLKR_CTRL_ERRNOTFOUND: c_uint = 0x8800000000000000UL;
pub const HBLKR_CTRL_ERRBUSY: c_uint = 0xa000000000000000UL;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn is_supported_hlbkrm(bpsize: c_int, psize: c_int) -> bool {
...
// Check that the unprocessed entries were 'not found' or 'busy'
    for (i = 0; i < idx-1; i++) {
    let mut ctrl: c_ulong = retbuf[i] & HBLKR_CTRL_MASK;
...
//
pub const PPC64_HUGE_HPTE_BATCH: c_int = 12;
...
//
    ...
    {
    let mut flags: c_ulong = 0;
    let mut lock_tlbie: c_int = !mmu_has_feature(MMU_FTR_LOCKLESS_TLBIE);
    if (lock_tlbie)
...
//
pub const HBLKRM_L_MASK: c_uint = 0x80;
pub const HBLKRM_PENC_MASK: c_uint = 0x3f;
...
//
pub const SPLPAR_TLB_BIC_MAXLENGTH: c_int = 128;
#[no_mangle]
pub unsafe extern "C" fn pseries_lpar_read_hblkrm_characteristics() -> void __init {
    ...
    idx = 0;
    while (idx < len) {
    let mut block_shift: u8 = buf.val[idx++];
    u32 block_size;
    unsigned int npsize;
    if (!block_shift)
    break;
...
//
#[no_mangle]
unsafe extern "C" fn pSeries_lpar_flush_hash_range(number: c_ulong, local: c_int) {
...
#[no_mangle]
unsafe extern "C" fn disable_bulk_remove(str: *mut c_char) -> int __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpt_resize_state {
    pub shift: c_ulong,
    pub commit_rc: c_int,
}

#[no_mangle]
unsafe extern "C" fn pseries_lpar_resize_hpt_commit(data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pseries_lpar_resize_hpt(shift: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hpte_init_pseries() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn radix_init_pseries() -> void __init {
...
pub const CMO_FREE_HINT_DEFAULT: c_int = 1;
    let mut cmo_free_hint_flag: static int = CMO_FREE_HINT_DEFAULT;
#[no_mangle]
unsafe extern "C" fn cmo_free_hint(str: *mut c_char) -> int __init {
...
pub unsafe extern "C" fn arch_free_page(page: *mut page, order: c_int) {
    ...
    let mut hcall_tracepoint_key: static_key = STATIC_KEY_INIT;
#[no_mangle]
pub unsafe extern "C" fn hcall_tracepoint_regfunc() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hcall_tracepoint_unregfunc() {
...
#[no_mangle]
pub unsafe extern "C" fn __trace_hcall_entry(opcode: c_ulong, args: *mut c_ulong) -> notrace void {
...
#[no_mangle]
pub unsafe extern "C" fn __trace_hcall_exit(opcode: c_long, retval: c_long, retbuf: *mut c_ulong) -> notrace void {
...
//
#[no_mangle]
pub unsafe extern "C" fn h_get_mpp(mpp_data: *mut hvcall_mpp_data) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn h_get_mpp_x(mpp_x_data: *mut hvcall_mpp_x_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsid_unscramble(vsid: c_ulong, ssize: c_int) -> unsigned long __init {
    static unsigned long __init vsid_unscramble(unsigned long vsid, int ssize)
    {
    unsigned long protovsid;
    let mut va_bits: c_ulong = VA_BITS;
...
#[no_mangle]
unsafe extern "C" fn reserve_vrma_context_id() -> int __init {
...
// debugfs file interface for vpa data
    ...
    loff_t *pos)
    {
    let mut cpu: c_int = (long)filp.private_data;
    struct lppaca *lppaca = &lppaca_of(cpu);
...
#[no_mangle]
unsafe extern "C" fn vpa_debugfs_init() -> int __init {
