...
//! Source: arch/powerpc/platforms/pseries/io_event_irq.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ioei_find_event(elog: *mut rtas_error_log) -> *mut pseries_io_event {
...
//
#[no_mangle]
unsafe extern "C" fn ioei_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t ioei_interrupt(int irq, void *dev_id)
    {
    struct pseries_io_event *event;
    int rtas_rc;
    for (;;) {
    rtas_rc = rtas_call(ioei_check_exception_token, 6, 1, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ioei_init() -> int __init {
