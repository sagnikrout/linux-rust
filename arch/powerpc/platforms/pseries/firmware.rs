...
//! Source: arch/powerpc/platforms/pseries/firmware.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hypertas_fw_feature {
    pub val: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn fw_vec5_feature_init(vec5: *const c_char, len: c_ulong) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_probe_fw_features() -> void __init {
    void __init pseries_probe_fw_features(void)
    {
    of_scan_flat_dt(probe_fw_features, core::ptr::null_mut());
    }
