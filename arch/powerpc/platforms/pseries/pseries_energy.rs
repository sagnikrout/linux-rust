...
//! Source: arch/powerpc/platforms/pseries/pseries_energy.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cpu_to_drc_index(cpu: c_int) -> u32 {
...
// Convert logical cpu number to core number
    ...
    u32 num_set_entries;
    const __be32 *value;
    value = of_prop_next_u32(info, core::ptr::null_mut(), &num_set_entries);
    if (!value)
...
#[no_mangle]
unsafe extern "C" fn drc_index_to_cpu(drc_index: u32) -> c_int {
    static int drc_index_to_cpu(u32 drc_index)
    {
    struct device_node *dn = core::ptr::null_mut();
    struct property *info;
    const int *indexes;
    let mut thread_index: c_int = 0, cpu = 0;
    let mut rc: c_int = 1;
    dn = of_find_node_by_path("/cpus");
    if (dn == core::ptr::null_mut())
    goto err;
...
// energy consumption.
//
pub const FLAGS_MODE1: c_uint = 0x004E200000080E01UL;
pub const FLAGS_MODE2: c_uint = 0x004E200000080401UL;
pub const FLAGS_ACTIVATE: c_uint = 0x100;
#[no_mangle]
unsafe extern "C" fn get_best_energy_list(page: *mut c_char, activate: c_int) -> isize {
...
//
    ...
    cpu_activate_hint_list_show, core::ptr::null_mut());
    static struct device_attribute attr_cpu_deactivate_hint_list =
    __ATTR(pseries_deactivate_hint_list, 0444,
    cpu_deactivate_hint_list_show, core::ptr::null_mut());
    static struct device_attribute attr_percpu_activate_hint =
    __ATTR(pseries_activate_hint, 0444,
    percpu_activate_hint_show, core::ptr::null_mut());
    static struct device_attribute attr_percpu_deactivate_hint =
    __ATTR(pseries_deactivate_hint, 0444,
    percpu_deactivate_hint_show, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn pseries_energy_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pseries_energy_cleanup() -> void __exit {
