...
//! Source: arch/powerpc/platforms/pseries/htmdump.c
#![no_std]
...
pub const HTM_ENABLE: c_int = 1;
pub const HTM_DISABLE: c_int = 0;
pub const HTM_NOWRAP: c_int = 1;
pub const HTM_WRAP: c_int = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn htm_return_check(rc: c_long) -> isize {
...
#[no_mangle]
unsafe extern "C" fn htmconfigure_set(data: *mut c_void, val: u64) -> c_int {
    static int  htmconfigure_set(void *data, u64 val)
    {
    long rc, ret;
    let mut param1: c_ulong = -1, param2 = -1;
//
...
#[no_mangle]
unsafe extern "C" fn htmconfigure_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn htmstart_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn htmstart_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn htmsetup_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn htmsetup_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn htmflags_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(HTM_WRAP: val ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn htmflags_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn htmdump_init_debugfs() -> c_int {
...
//
    debugfs_create_file("htmconfigure", 0600, htmdump_debugfs_dir, core::ptr::null_mut(), &htmconfigure_fops);
    debugfs_create_file("htmstart", 0600, htmdump_debugfs_dir, core::ptr::null_mut(), &htmstart_fops);
    debugfs_create_file("htmsetup", 0600, htmdump_debugfs_dir, core::ptr::null_mut(), &htmsetup_fops);
    debugfs_create_file("htmflags", 0600, htmdump_debugfs_dir, core::ptr::null_mut(), &htmflags_fops);
...
#[no_mangle]
unsafe extern "C" fn htmdump_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn htmdump_exit() -> void __exit {
