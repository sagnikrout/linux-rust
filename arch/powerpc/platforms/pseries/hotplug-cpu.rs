...
//! Source: arch/powerpc/platforms/pseries/hotplug-cpu.c
#![no_std]
...
// This version can't take the spinlock, because it never returns
    let mut rtas_stop_self_token: static int = RTAS_UNKNOWN_SERVICE;
//
...
#[no_mangle]
unsafe extern "C" fn rtas_stop_self() {
    static void rtas_stop_self(void)
    {
    static struct rtas_args args;
    local_irq_disable();
    BUG_ON(rtas_stop_self_token == RTAS_UNKNOWN_SERVICE);
    rtas_call_unlocked(&args, rtas_stop_self_token, 0, 1, core::ptr::null_mut());
    panic("Alas, I survived.\n");
    }
#[no_mangle]
unsafe extern "C" fn pseries_cpu_offline_self() {
    static void pseries_cpu_offline_self(void)
    {
    let mut hwcpu: c_uint = hard_smp_processor_id();
    local_irq_disable();
    idle_task_exit();
    if (xive_enabled())
    xive_teardown_cpu();
...
#[no_mangle]
unsafe extern "C" fn pseries_cpu_disable() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pseries_cpu_die(cpu: c_uint) {
    static void pseries_cpu_die(unsigned int cpu)
    {
    let mut cpu_status: c_int = 1;
    let mut pcpu: c_uint = get_hard_smp_processor_id(cpu);
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(120000);
    while (true) {
...
//
#[no_mangle]
unsafe extern "C" fn pseries_add_processor(np: *mut device_node) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pseries_remove_processor(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn dlpar_offline_cpu(dn: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_online_cpu(dn: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_cpu_exists(parent: *mut device_node, drc_index: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn drc_info_valid_index(parent: *mut device_node, drc_index: u32) -> bool {
    ...
    u32 index;
    int count, i, j;
    info = of_find_property(parent, "ibm,drc-info", core::ptr::null_mut());
    if (!info)
    return false;
...
#[no_mangle]
unsafe extern "C" fn valid_cpu_drc_index(parent: *mut device_node, drc_index: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pseries_cpuhp_attach_nodes(dn: *mut device_node) -> c_int {
...
// traversal.
//
    for (of_changeset_init(&cs); dn != core::ptr::null_mut(); dn = dn.sibling) {
...
#[no_mangle]
unsafe extern "C" fn dlpar_cpu_add(drc_index: u32) -> isize {
...
#[no_mangle]
unsafe extern "C" fn pseries_cpuhp_cache_use_count(cachedn: *const device_node) -> c_uint {
    static unsigned int pseries_cpuhp_cache_use_count(const struct device_node *cachedn)
    {
    let mut use_count: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn pseries_cpuhp_detach_nodes(cpudn: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_cpu_remove(dn: *mut device_node, drc_index: u32) -> isize {
...
#[no_mangle]
unsafe extern "C" fn dlpar_cpu_remove_by_index(drc_index: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dlpar_cpu(hp_elog: *mut pseries_hp_errorlog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_cpu_probe(buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn dlpar_cpu_release(buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_cpu_hotplug_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pseries_dlpar_init() -> int __init {
