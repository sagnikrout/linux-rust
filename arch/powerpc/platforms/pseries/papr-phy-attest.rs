...
//! Source: arch/powerpc/platforms/pseries/papr-phy-attest.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtas_phy_attest_params {
    pub cmd: papr_phy_attest_io_block,
...
//
#[no_mangle]
unsafe extern "C" fn rtas_physical_attestation(params: *mut rtas_phy_attest_params) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn phy_attest_sequence_begin(seq: *mut papr_rtas_sequence) {
...
//
#[no_mangle]
unsafe extern "C" fn phy_attest_sequence_end(seq: *mut papr_rtas_sequence) {
...
//
#[no_mangle]
unsafe extern "C" fn papr_phy_attest_create_handle(ulc: *mut papr_phy_attest_io_block __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn papr_phy_attest_dev_ioctl(filp: *mut file, ioctl: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn papr_phy_attest_init() -> __init int {
