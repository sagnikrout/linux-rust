...
//! Source: arch/powerpc/platforms/pseries/hvcserver.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_convert(to_convert: c_long) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hvcs_free_partner_info(head: *mut list_head) -> c_int {
...
//
    ...
    struct hvcs_partner_info *next_partner_info = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn hvcs_free_connection(unit_address: u32) -> c_int {
