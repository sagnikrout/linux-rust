...
//! Source: arch/powerpc/platforms/pseries/papr-sysparm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn papr_sysparm_buf_free(buf: *mut papr_sysparm_buf) {
    void papr_sysparm_buf_free(struct papr_sysparm_buf *buf)
    {
    kfree(buf);
    }
#[no_mangle]
unsafe extern "C" fn papr_sysparm_buf_get_length(buf: *const papr_sysparm_buf) -> usize {
    static size_t papr_sysparm_buf_get_length(const struct papr_sysparm_buf *buf)
    {
    return be16_to_cpu(buf.len);
    }
#[no_mangle]
unsafe extern "C" fn papr_sysparm_buf_set_length(buf: *mut papr_sysparm_buf, length: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn papr_sysparm_buf_clamp_length(buf: *mut papr_sysparm_buf) {
...
//
#[no_mangle]
unsafe extern "C" fn papr_sysparm_buf_can_submit(buf: *const papr_sysparm_buf) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn papr_sysparm_get(param: papr_sysparm_t, buf: *mut papr_sysparm_buf) -> c_int {
    int papr_sysparm_get(papr_sysparm_t param, struct papr_sysparm_buf *buf)
    {
    let mut token: i32 = rtas_function_token(RTAS_FN_IBM_GET_SYSTEM_PARAMETER);
...
#[no_mangle]
pub unsafe extern "C" fn papr_sysparm_set(param: papr_sysparm_t, buf: *const papr_sysparm_buf) -> c_int {
    int papr_sysparm_set(papr_sysparm_t param, const struct papr_sysparm_buf *buf)
    {
    let mut token: i32 = rtas_function_token(RTAS_FN_IBM_SET_SYSTEM_PARAMETER);
    struct rtas_work_area *work_area;
    s32 fwrc;
    int ret;
    might_sleep();
...
//
    ...
    {
    let mut len_out: u16 = papr_sysparm_buf_get_length(kern_spbuf);
...
#[no_mangle]
unsafe extern "C" fn papr_sysparm_ioctl_get(user_iob: *mut papr_sysparm_io_block __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn papr_sysparm_ioctl_set(user_iob: *mut papr_sysparm_io_block __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn papr_sysparm_ioctl(filp: *mut file, ioctl: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn papr_sysparm_init() -> __init int {
