...
//! Source: arch/powerpc/platforms/pseries/hotplug-memory.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dlpar_free_property(prop: *mut property) {
...
#[no_mangle]
unsafe extern "C" fn update_lmb_associativity_index(lmb: *mut drmem_lmb) -> c_int {
    ...
    if (!lmb_node)
    return -EINVAL;
    lmb_assoc = of_get_property(lmb_node, "ibm,associativity", core::ptr::null_mut());
    if (!lmb_assoc) {
...
#[no_mangle]
unsafe extern "C" fn dlpar_change_lmb_state(lmb: *mut drmem_lmb, online: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(!dev_offline(&mem_block->dev): !online &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn dlpar_online_lmb(lmb: *mut drmem_lmb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_offline_lmb(lmb: *mut drmem_lmb) -> c_int {
    static int dlpar_offline_lmb(struct drmem_lmb *lmb)
    {
    return dlpar_change_lmb_state(lmb, false);
    }
#[no_mangle]
unsafe extern "C" fn pseries_remove_memblock(base: c_ulong, memblock_size: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseries_remove_mem_node(np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmb_is_removable(lmb: *mut drmem_lmb) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dlpar_remove_lmb(lmb: *mut drmem_lmb) -> c_int {
    ...
    return -EINVAL;
    mem_block = lmb_to_memblock(lmb);
    if (mem_block == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn dlpar_memory_remove_by_count(lmbs_to_remove: u32) -> c_int {
    static int dlpar_memory_remove_by_count(u32 lmbs_to_remove)
    {
    struct drmem_lmb *lmb;
    let mut lmbs_reserved: c_int = 0;
    let mut lmbs_available: c_int = 0;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn dlpar_memory_remove_by_index(drc_index: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_memory_remove_by_ic(lmbs_to_remove: u32, drc_index: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pseries_remove_mem_node(np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_add_lmb(lmb: *mut drmem_lmb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_memory_add_by_count(lmbs_to_add: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_memory_add_by_index(drc_index: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_memory_add_by_ic(lmbs_to_add: u32, drc_index: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dlpar_memory(hp_elog: *mut pseries_hp_errorlog) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseries_add_mem_node(np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pseries_memory_hotplug_init() -> int __init {
