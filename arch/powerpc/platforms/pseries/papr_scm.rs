...
//! Source: arch/powerpc/platforms/pseries/papr_scm.c
#![no_std]
...
pub struct papr_scm_perf_stats {
    pub eye_catcher: [u8; 8],
// Should be PAPR_SCM_PERF_STATS_VERSION
    pub stats_version: __be32,
// Number of stats following
    pub num_statistics: __be32,
// zero or more performance matrics
    pub scm_statistic: [papr_scm_perf_stat; ],
    pub __packed: },
...
pub struct papr_scm_priv {
    ...
    pub nd_set: nd_interleave_set,
    pub region_list: list_head,
// Protect dimm health data from concurrent read/writes
    pub health_mutex: mutex,
// Last time the health information of the dimm was updated
    pub lasthealth_jiffies: c_ulong,
// Health information for the dimm
    pub health_bitmap: u64,
// Holds the last known dirty shutdown counter value
    pub dirty_shutdown_counter: u64,
// length of the stat buffer as expected by phyp
    pub stat_buffer_len: usize,
...
#[no_mangle]
unsafe extern "C" fn drc_pmem_bind(p: *mut papr_scm_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drc_pmem_unbind(p: *mut papr_scm_priv) {
...
#[no_mangle]
unsafe extern "C" fn drc_pmem_query_n_bind(p: *mut papr_scm_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn papr_scm_pmu_get_value(event: *mut perf_event, dev: *mut device, count: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn papr_scm_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn papr_scm_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn papr_scm_pmu_read(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn papr_scm_pmu_del(event: *mut perf_event, flags: c_int) {
    static void papr_scm_pmu_del(struct perf_event *event, int flags)
    {
    papr_scm_pmu_read(event);
    }
#[no_mangle]
unsafe extern "C" fn papr_scm_pmu_register(p: *mut papr_scm_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn __drc_pmem_query_health(p: *mut papr_scm_priv) -> c_int {
...
// issue the hcall
    ...
    bitmap = ret[0] & ret[1];
#[no_mangle]
pub unsafe extern "C" fn if(H_FUNCTION: rc ==) -> else {
...
pub const MIN_HEALTH_QUERY_INTERVAL: c_int = 60;
// Query cached health info and if needed call drc_pmem_query_health
#[no_mangle]
unsafe extern "C" fn drc_pmem_query_health(p: *mut papr_scm_priv) -> c_int {
...
// Assume cached health data is valid
    ...
    read = 8;
#[no_mangle]
pub unsafe extern "C" fn if(4: len >=) -> else {
    else if (len >= 4)
    read = 4;
#[no_mangle]
...
//
    ...
    {
    let mut cmd_mask: c_ulong = PAPR_SCM_DIMM_CMD_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn if(PAPR_PMEM_HEALTH_CRITICAL: p->health_bitmap &) -> else {
    else if (p.health_bitmap & PAPR_PMEM_HEALTH_CRITICAL)
    payload.health.dimm_health = PAPR_PDSM_DIMM_CRITICAL;
#[no_mangle]
pub unsafe extern "C" fn if(PAPR_PMEM_HEALTH_UNHEALTHY: p->health_bitmap &) -> else {
...
// Inject a smart error Add the dirty-shutdown-counter value to the pdsm
    ...
    let mut inject_mask: u64 = 0, clear_mask = 0;
    u64 mask;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pdsm_cmd_desc {
    pub size_in: u32,
    pub size_out: u32,
    int (*service)(struct papr_scm_priv *dimm,
    pub payload): *mut union nd_pdsm_payload,
}
...
// Get the PDSM header and PDSM command
    ...
    let mut pdsm: enum papr_pdsm = (enum papr_pdsm)pkg.nd_command;
...
#[no_mangle]
unsafe extern "C" fn papr_scm_nvdimm_init(p: *mut papr_scm_priv) -> c_int {
...
// Set the dimm command family mask to accept PDSMs
    ...
    return -ENOMEM;
    p.bus = nvdimm_bus_register(core::ptr::null_mut(), &p.bus_desc);
    if (!p.bus) {
...
//
    ...
    dimm_flags, PAPR_SCM_DIMM_CMD_MASK, 0, core::ptr::null_mut());
    if (!p.nvdimm) {
...
// now add the region
    ...
    {
    let mut aligned_addr: u64 = ALIGN_DOWN(phys_addr, L1_CACHE_BYTES);
...
#[no_mangle]
unsafe extern "C" fn papr_scm_probe(pdev: *mut platform_device) -> c_int {
...
// Try retrieving the stat buffer and see if its supported
    stat_size = drc_pmem_query_stats(p, core::ptr::null_mut(), 0);
    if (stat_size > 0) {
...
#[no_mangle]
unsafe extern "C" fn papr_scm_remove(pdev: *mut platform_device) {
    ...
    pdev.archdata.priv = core::ptr::null_mut();
    kfree(p.bus_desc.provider_name);
    kfree(p);
    }
...
#[no_mangle]
unsafe extern "C" fn papr_scm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn papr_scm_exit() -> void __exit {
