...
//! Source: arch/powerpc/platforms/fsl_uli1575.c
#![no_std]
...
pub const ULI_PIRQA: c_uint = 0x08;
pub const ULI_PIRQB: c_uint = 0x09;
pub const ULI_PIRQC: c_uint = 0x0a;
pub const ULI_PIRQD: c_uint = 0x0b;
pub const ULI_PIRQE: c_uint = 0x0c;
pub const ULI_PIRQF: c_uint = 0x0d;
pub const ULI_PIRQG: c_uint = 0x0e;
pub const ULI_8259_NONE: c_uint = 0x00;
pub const ULI_8259_IRQ1: c_uint = 0x08;
pub const ULI_8259_IRQ3: c_uint = 0x02;
pub const ULI_8259_IRQ4: c_uint = 0x04;
pub const ULI_8259_IRQ5: c_uint = 0x05;
pub const ULI_8259_IRQ6: c_uint = 0x07;
pub const ULI_8259_IRQ7: c_uint = 0x06;
pub const ULI_8259_IRQ9: c_uint = 0x01;
pub const ULI_8259_IRQ10: c_uint = 0x03;
pub const ULI_8259_IRQ11: c_uint = 0x09;
pub const ULI_8259_IRQ12: c_uint = 0x0b;
pub const ULI_8259_IRQ14: c_uint = 0x0d;
pub const ULI_8259_IRQ15: c_uint = 0x0f;
...
#[no_mangle]
pub unsafe extern "C" fn is_quirk_valid() -> bool {
...
// Bridge
#[no_mangle]
unsafe extern "C" fn early_uli5249(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_uli1575(dev: *mut pci_dev) {
...
// ULI1575 IRQ mapping conf register maps PIRQx to IRQn
    for (i = 0; i < 4; i++) {
    let mut val: u8 = uli_pirq_to_irq[i*2] | (uli_pirq_to_irq[i*2+1] << 4);
...
#[no_mangle]
unsafe extern "C" fn quirk_final_uli1575(dev: *mut pci_dev) {
...
// SATA
#[no_mangle]
unsafe extern "C" fn quirk_uli5288(dev: *mut pci_dev) {
...
// PATA
#[no_mangle]
unsafe extern "C" fn quirk_uli5229(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_final_uli5249(dev: *mut pci_dev) {
    ...
    let mut flags: c_ulong = pci_resource_flags(dev, i);
...
#[no_mangle]
unsafe extern "C" fn hpcd_quirk_uli1575(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hpcd_quirk_uli5288(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn hpcd_quirk_uli5229(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn hpcd_final_uli5288(dev: *mut pci_dev) {
    static void hpcd_final_uli5288(struct pci_dev *dev)
    {
    struct pci_controller *hose = pci_bus_to_host(dev.bus);
    struct device_node *hosenode = hose ? hose.dn : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn uli_exclude_device(hose: *mut pci_controller, bus: u_char, devfn: u_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uli_init() -> void __init {
    void __init uli_init(void)
    {
    struct device_node *node;
    struct device_node *pci_with_uli;
// See if we have a ULI under the primary
    node = of_find_node_by_name(core::ptr::null_mut(), "uli1575");
