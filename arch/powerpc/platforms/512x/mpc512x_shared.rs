...
//! Source: arch/powerpc/platforms/512x/mpc512x_shared.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mpc512x_restart(cmd: *mut c_char) -> void __noreturn {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_diu_shared_fb {
    pub /: *mut *mut u8 gamma[0x300]; / 32-bit aligned!,
    pub /: *mut *mut diu_ad ad0; / 32-bit aligned!,
    pub fb_phys: phys_addr_t,
    pub fb_len: usize,
    pub in_use: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mpc512x_set_pixel_clock(pixclock: c_uint) {
...
// lookup and enable the DIU clock
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,mpc5121-diu");
    if (!np) {
...
#[no_mangle]
pub unsafe extern "C" fn mpc512x_free_bootmem(page: *mut page) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_release_bootmem() {
    static void mpc512x_release_bootmem(void)
    {
    let mut addr: c_ulong = diu_shared_fb.fb_phys & PAGE_MASK;
    let mut size: c_ulong = diu_shared_fb.fb_len;
    ...
    diu_ops.release_bootmem	= core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mpc512x_init_diu() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_setup_diu() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn mpc512x_init_IRQ() -> void __init {
    void __init mpc512x_init_IRQ(void)
    {
    struct device_node *np;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,mpc5121-ipic");
    if (!np)
    return;
    ipic_init(np, 0);
    of_node_put(np);
...
#[no_mangle]
unsafe extern "C" fn mpc512x_declare_of_platform_devices() -> void __init {
    static void __init mpc512x_declare_of_platform_devices(void)
    {
    if (of_platform_bus_probe(core::ptr::null_mut(), of_bus_ids, core::ptr::null_mut()))
    printk(KERN_ERR __FILE__ ": "
    "Error while probing of_platform bus\n");
    }
pub const DEFAULT_FIFO_SIZE: c_int = 16;
#[no_mangle]
pub unsafe extern "C" fn mpc512x_select_psc_compat() -> *const char __init {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_select_reset_compat() -> *const char __init {
    ...
    fp = of_get_property(np, prop_name, core::ptr::null_mut());
    if (fp)
    return *fp;
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_fifo_init() -> void __init {
    ...
    for_each_compatible_node(np, core::ptr::null_mut(), psc_compat) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_restart_init() -> void __init {
    static void __init mpc512x_restart_init(void)
    {
    struct device_node *np;
    const char *reset_compat;
    reset_compat = mpc512x_select_reset_compat();
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), reset_compat);
    if (!np)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn mpc512x_init_early() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn mpc512x_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn mpc512x_setup_arch() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc512x_cs_config(cs: c_uint, val: u32) -> c_int {
    ...
    return -EINVAL;
    if (!lpc) {
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,mpc5121-lpc");
    lpc = of_iomap(np, 0);
    of_node_put(np);
    if (!lpc)
    return -ENOMEM;
