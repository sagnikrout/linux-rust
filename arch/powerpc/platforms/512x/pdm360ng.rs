...
//! Source: arch/powerpc/platforms/512x/pdm360ng.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pdm360ng_get_pendown_state() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdm360ng_penirq_init() -> int __init {
    static int __init pdm360ng_penirq_init(void)
    {
    struct device_node *np;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,mpc5121-gpio");
    if (!np) {
...
#[no_mangle]
unsafe extern "C" fn pdm360ng_touchscreen_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn pdm360ng_touchscreen_init() -> void __init {
    static inline void __init pdm360ng_touchscreen_init(void)
    {
    }

#[no_mangle]
unsafe extern "C" fn pdm360ng_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pdm360ng_probe() -> int __init {
