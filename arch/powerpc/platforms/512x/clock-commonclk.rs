...
//! Source: arch/powerpc/platforms/512x/clock-commonclk.c
#![no_std]
...
pub const NR_PSCS: c_int = 12;
pub const NR_MSCANS: c_int = 4;
pub const NR_SPDIFS: c_int = 1;
pub const NR_OUTCLK: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn mpc512x_clk_determine_soc() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_mbx() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_axe() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_viu() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_spdif() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_pata() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_sata() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_pci() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_fec2() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_max_pscnum() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_sdhc2() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_nfc_5125() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_outclk() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_cpmf_0_bypass() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn soc_has_mclk_mux0_canin() -> bool __init {
...
// convenience wrappers around the common clk API
    ...
    return clk_register_fixed_factor(core::ptr::null_mut(), name, parent_name, clkflags,
    mul, div);
    }
    ...
    return clk_register_divider(core::ptr::null_mut(), name, parent_name, clkflags,
    ...
    return clk_register_gate(core::ptr::null_mut(), name, parent_name, clkflags,
    ...
    return clk_register_mux(core::ptr::null_mut(), name,
...
#[no_mangle]
pub unsafe extern "C" fn get_bit_field(reg: *mut uint32_t __iomem, pos: u8, len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_spmf_mult() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn get_sys_div_x2() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn get_cpmf_mult_x2() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn get_freq_from_dt(propname: *mut c_char) -> int __init {
    ...
    int val;
    val = 0;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,mpc5121-immr");
    if (np) {
    prop = of_get_property(np, propname, core::ptr::null_mut());
    if (prop)
    val = *prop;
    of_node_put(np);
    }
...
#[no_mangle]
unsafe extern "C" fn mpc512x_clk_preset_data() -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mclk_setup_data {
    pub type: enum mclk_type,
    pub has_mclk1: bool,
    pub name_mux0: *const c_char,
    pub name_en0: *const c_char,
    pub name_div0: *const c_char,
    pub parent_names_mux1: [*const c_char; 2],
    pub name_mclk: *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn mpc512x_clk_setup_mclk(entry: *mut mclk_setup_data, idx: usize) -> void __init {
...
// }}} MCLK helpers
#[no_mangle]
unsafe extern "C" fn mpc512x_clk_setup_clock_tree(np: *mut device_node, busfreq: c_int) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn mpc5121_clk_register_of_provider(np: *mut device_node) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn mpc5121_clk_provide_migration_support() -> void __init {
...
//
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), "pci", "fsl,mpc5121-pci");
    of_node_put(np);
    if (np)
...
//
    ...
    for_each_compatible_node(np, core::ptr::null_mut(), compatname)
...
//
#[no_mangle]
unsafe extern "C" fn mpc5121_clk_provide_backwards_compat() -> void __init {
...
//
    ...
    clk_register_clkdev(clks[MPC512x_CLK_IPS], "ips", core::ptr::null_mut());
    clk_register_clkdev(clks[MPC512x_CLK_SYS], "sys", core::ptr::null_mut());
    clk_register_clkdev(clks[MPC512x_CLK_REF], "ref", core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc5121_clk_init() -> int __init {
    int __init mpc5121_clk_init(void)
    {
    struct device_node *clk_np;
    int busfreq;
// map the clock control registers
    clk_np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,mpc5121-clock");
    if (!clk_np)
    return -ENODEV;
