...
//! Source: arch/powerpc/platforms/52xx/mpc52xx_pic.c
#![no_std]
...
// MPC5200 device tree match tables
    ...
    static struct irq_domain *mpc52xx_irqhost = core::ptr::null_mut();
...
// Utility functions
#[no_mangle]
pub unsafe extern "C" fn io_be_setbit(addr: *mut u32 __iomem, bitno: c_int) {
    static inline void io_be_setbit(u32 __iomem *addr, int bitno)
    {
    out_be32(addr, in_be32(addr) | (1 << bitno));
    }
#[no_mangle]
pub unsafe extern "C" fn io_be_clrbit(addr: *mut u32 __iomem, bitno: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mpc52xx_extirq_mask(d: *mut irq_data) {
    static void mpc52xx_extirq_mask(struct irq_data *d)
    {
    let mut l2irq: c_int = irqd_to_hwirq(d) & MPC52xx_IRQ_L2_MASK;
    io_be_clrbit(&intr.ctrl, 11 - l2irq);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_extirq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_extirq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_extirq_set_type(d: *mut irq_data, flow_type: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpc52xx_null_set_type(d: *mut irq_data, flow_type: c_uint) -> c_int {
    static int mpc52xx_null_set_type(struct irq_data *d, unsigned int flow_type)
    {
    return 0; /* Do nothing so that the sense mask will get updated */
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_main_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_main_unmask(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn mpc52xx_periph_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_periph_unmask(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn mpc52xx_sdma_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_sdma_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_sdma_ack(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn mpc52xx_is_extirq(l1: c_int, l2: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_init_irq() -> void __init {
...
// Remap the necessary zones
    picnode = of_find_matching_node(core::ptr::null_mut(), mpc52xx_pic_ids);
    intr = of_iomap(picnode, 0);
    if (!intr)
    panic(__FILE__	": find_and_map failed on 'mpc5200-pic'. "
    "Check node !");
    np = of_find_matching_node(core::ptr::null_mut(), mpc52xx_sdma_ids);
    sdma = of_iomap(np, 0);
    of_node_put(np);
    if (!sdma)
...
//
    ...
    &mpc52xx_irqhost_ops, core::ptr::null_mut());
    if (!mpc52xx_irqhost)
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_get_irq() -> c_uint {
