...
//! Source: arch/powerpc/platforms/52xx/mpc52xx_common.c
#![no_std]
...
//
    ...
    np = of_find_matching_node(core::ptr::null_mut(), mpc52xx_xlb_ids);
    xlb = of_iomap(np, 0);
    of_node_put(np);
    if (!xlb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_declare_of_platform_devices() -> void __init {
    void __init mpc52xx_declare_of_platform_devices(void)
    {
// Find all the 'platform' devices and register them.
    if (of_platform_populate(core::ptr::null_mut(), mpc52xx_bus_ids, core::ptr::null_mut(), core::ptr::null_mut()))
...
// Clock Distribution Module, used by PSC clock setting function
    np = of_find_matching_node(core::ptr::null_mut(), mpc52xx_cdm_ids);
    mpc52xx_cdm = of_iomap(np, 0);
    of_node_put(np);
// simple_gpio registers
    np = of_find_matching_node(core::ptr::null_mut(), mpc52xx_gpio_simple);
    simple_gpio = of_iomap(np, 0);
    of_node_put(np);
// wkup_gpio registers
    np = of_find_matching_node(core::ptr::null_mut(), mpc52xx_gpio_wkup);
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_set_psc_clkdiv(psc_id: c_int, clkdiv: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_restart(cmd: *mut c_char) -> void __noreturn {
...
pub const PSC1_RESET: c_uint = 0x1;
pub const PSC1_SYNC: c_uint = 0x4;
pub const PSC1_SDATA_OUT: c_uint = 0x1;
pub const PSC2_RESET: c_uint = 0x2;

pub const MPC52xx_GPIO_PSC1_MASK: c_uint = 0x7;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc5200_psc_ac97_gpio_reset(psc_number: c_int) -> c_int {
