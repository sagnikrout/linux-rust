...
//! Source: arch/powerpc/platforms/52xx/mpc52xx_pm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_pm_valid(state: suspend_state_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_set_wakeup_gpio(pin: u8, level: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_pm_prepare() -> c_int {
...
// map the whole register space
    np = of_find_matching_node(core::ptr::null_mut(), immr_ids);
...
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_pm_enter(state: suspend_state_t) -> c_int {
    int mpc52xx_pm_enter(suspend_state_t state)
    {
    u32 clk_enables;
    u32 msr, hid0;
    u32 intr_main_mask;
    let mut irq_0x500: *mut void __iomem = (void __iomem *)CONFIG_KERNEL_START + 0x500;
    let mut irq_0x500_stop: c_ulong = (unsigned long)irq_0x500 + mpc52xx_ds_cached_size;
...
#[no_mangle]
pub unsafe extern "C" fn mpc52xx_pm_init() -> int __init {
