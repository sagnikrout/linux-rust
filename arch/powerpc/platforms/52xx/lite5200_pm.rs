...
//! Source: arch/powerpc/platforms/52xx/lite5200_pm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lite5200_pm_valid(state: suspend_state_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lite5200_pm_begin(state: suspend_state_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lite5200_pm_prepare() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lite5200_save_regs() {
...
#[no_mangle]
unsafe extern "C" fn lite5200_restore_regs() {
...
#[no_mangle]
unsafe extern "C" fn lite5200_pm_enter(state: suspend_state_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lite5200_pm_finish() {
...
#[no_mangle]
unsafe extern "C" fn lite5200_pm_end() {
...
#[no_mangle]
pub unsafe extern "C" fn lite5200_pm_init() -> int __init {
