...
//! Source: arch/powerpc/platforms/52xx/lite5200.c
#![no_std]
...
// Map zones
    np = of_find_matching_node(core::ptr::null_mut(), mpc5200_cdm_ids);
    cdm = of_iomap(np, 0);
    of_node_put(np);
    if (!cdm) {
...
#[no_mangle]
unsafe extern "C" fn lite5200_suspend_prepare(mbar: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn lite5200_resume_finish(mbar: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn lite5200_setup_arch() -> void __init {
