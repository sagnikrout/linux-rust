...
//! Source: arch/powerpc/platforms/52xx/media5200.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn media5200_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn media5200_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn media5200_irq_cascade(desc: *mut irq_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn media5200_init_irq() -> void __init {
...
// Now find the FPGA IRQ
    fpga_np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,media5200-fpga");
    if (!fpga_np)
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn media5200_setup_arch() -> void __init {
...
// Some mpc5200 & mpc5200b related configuration
    ...
    np = of_find_matching_node(core::ptr::null_mut(), mpc5200_gpio_ids);
    gpio = of_iomap(np, 0);
    of_node_put(np);
    if (!gpio) {
