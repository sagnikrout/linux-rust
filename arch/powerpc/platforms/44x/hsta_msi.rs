...
//! Source: arch/powerpc/platforms/44x/hsta_msi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hsta_setup_msi_irqs(dev: *mut pci_dev, nvec: c_int, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hsta_find_hwirq_offset(hwirq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hsta_teardown_msi_irqs(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hsta_msi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hsta_msi_init() -> c_int {
