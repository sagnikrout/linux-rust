...
//! Source: arch/powerpc/platforms/44x/ppc44x_simple.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ppc44x_device_probe() -> int __init {
    static int __init ppc44x_device_probe(void)
    {
    of_platform_bus_probe(core::ptr::null_mut(), ppc44x_of_bus, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn ppc44x_probe() -> int __init {
