...
//! Source: arch/powerpc/platforms/8xx/micropatch.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cpm_write_patch(cp: *mut cpm8xx_t, offset: c_int, patch: *mut c_uint, len: c_int) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn cpm_load_patch(cp: *mut cpm8xx_t) -> void __init {
