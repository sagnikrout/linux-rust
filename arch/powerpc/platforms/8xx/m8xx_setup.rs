...
//! Source: arch/powerpc/platforms/8xx/m8xx_setup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn timebase_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn get_freq(name: *mut c_char, val: *mut c_ulong) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc8xx_calibrate_decr() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpc8xx_set_rtc_time(tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mpc8xx_get_rtc_time(tm: *mut rtc_time) {
...
#[no_mangle]
pub unsafe extern "C" fn mpc8xx_restart(cmd: *mut c_char) -> void __noreturn {
