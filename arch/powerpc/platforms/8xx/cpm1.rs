...
//! Source: arch/powerpc/platforms/8xx/cpm1.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cpm_reset() -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpm_ioport16 {
    pub intr: __be16 dir, par, odr_sor, dat,,
    pub res: [__be16; 3],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpm_ioport32b {
    pub dat: __be32 dir, par, odr,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpm_ioport32e {
    pub dat: __be32 dir, par, sor, odr,,
}

#[no_mangle]
unsafe extern "C" fn cpm1_set_pin32(port: c_int, pin: c_int, flags: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn cpm1_set_pin16(port: c_int, pin: c_int, flags: c_int) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn cpm1_set_pin(port: enum cpm_port, pin: c_int, flags: c_int) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn cpm1_clk_setup(target: enum cpm_clk_target, clock: c_int, mode: c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio16_save_regs(cpm1_gc: *mut cpm1_gpio16_chip) {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio16_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __cpm1_gpio16_set(cpm1_gc: *mut cpm1_gpio16_chip, pin_mask: u16, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio16_set(gc: *mut gpio_chip, gpio: c_uint, value: c_int) -> c_int {
    static int cpm1_gpio16_set(struct gpio_chip *gc, unsigned int gpio, int value)
    {
    struct cpm1_gpio16_chip *cpm1_gc = gpiochip_get_data(gc);
    unsigned long flags;
    let mut pin_mask: u16 = 1 << (15 - gpio);
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio16_to_irq(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio16_dir_out(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio16_dir_in(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio16_get_direction(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpm1_gpiochip_add16(dev: *mut device) -> c_int {
    ...
    if (!gc.label)
    return -ENOMEM;
    cpm1_gc.regs = devm_of_iomap(dev, np, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio32_save_regs(cpm1_gc: *mut cpm1_gpio32_chip) {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio32_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __cpm1_gpio32_set(cpm1_gc: *mut cpm1_gpio32_chip, pin_mask: u32, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio32_set(gc: *mut gpio_chip, gpio: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio32_dir_out(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio32_dir_in(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpm1_gpio32_get_direction(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpm1_gpiochip_add32(dev: *mut device) -> c_int {
