...
// Macro flag: #define PS3_VERBOSE_RESULT
...
#[no_mangle]
unsafe extern "C" fn ps3_hpte_remove(hpte_group: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ps3_hpte_clear() -> notrace void {
    static notrace void ps3_hpte_clear(void)
    {
    let mut hpte_count: c_ulong = (1UL << ppc64_pft_size) >> 4;
    u64 i;
...
#[no_mangle]
pub unsafe extern "C" fn ps3_hpte_init(htab_size: c_ulong) -> void __init {
