...
//! Source: arch/powerpc/platforms/ps3/mm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn make_page_sizes(a: c_ulong, b: c_ulong) -> unsigned long __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_mm_phys_to_lpar(phys_addr: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_mm_vas_create(htab_size: *mut *mut c_ulong) -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_mm_vas_destroy() -> notrace void {
...
#[no_mangle]
unsafe extern "C" fn ps3_mm_get_repository_highmem(r: *mut mem_region) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ps3_mm_set_repository_highmem(r: *const mem_region) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ps3_mm_region_create(r: *mut mem_region, size: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ps3_mm_region_destroy(r: *mut mem_region) {
    ...
    ps3_mm_set_repository_highmem(core::ptr::null_mut());
    }
// ============================================================================
// dma routines
// ============================================================================
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dma_chunk {
    pub region: *mut ps3_dma_region,
    ...
    {
    struct dma_chunk *c;
    let mut aligned_bus: c_ulong = ALIGN_DOWN(bus_addr, 1 << r.page_size);
...
// we don't handle the multi-chunk case for now
    ...
    {
    struct dma_chunk *c;
    let mut aligned_lpar: c_ulong = ALIGN_DOWN(lpar_addr, 1 << r.page_size);
...
#[no_mangle]
unsafe extern "C" fn dma_sb_free_chunk(c: *mut dma_chunk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_ioc0_free_chunk(c: *mut dma_chunk) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dma_sb_region_create(r: *mut ps3_dma_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_ioc0_region_create(r: *mut ps3_dma_region) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dma_sb_region_free(r: *mut ps3_dma_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_ioc0_region_free(r: *mut ps3_dma_region) -> c_int {
...
//
    ...
    : virt_addr;
    let mut aligned_phys: c_ulong = ALIGN_DOWN(phys_addr, 1 << r.page_size);
    unsigned long aligned_len = ALIGN(len + phys_addr - aligned_phys,
    1 << r.page_size);
// bus_addr = dma_sb_lpar_to_bus(r, ps3_mm_phys_to_lpar(phys_addr));
    if (!USE_DYNAMIC_DMA) {
    let mut lpar_addr: c_ulong = ps3_mm_phys_to_lpar(phys_addr);
    DBG(" . %s:%d\n", __func__, __LINE__);
...
//
#[no_mangle]
unsafe extern "C" fn dma_sb_region_create_linear(r: *mut ps3_dma_region) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dma_sb_region_free_linear(r: *mut ps3_dma_region) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_dma_region_create(r: *mut ps3_dma_region) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_dma_region_free(r: *mut ps3_dma_region) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_mm_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_mm_shutdown() -> notrace void {
