...
//! Source: arch/powerpc/platforms/ps3/repository.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn _dump_field(hdr: *const c_char, n: u64, func: *const c_char, line: c_int) {
    static void _dump_field(const char *hdr, u64 n, const char *func, int line)
    {

    char s[16];
    let mut in: *const char const = (const char *)&n;
    unsigned int i;
    for (i = 0; i < 8; i++)
...
//
#[no_mangle]
unsafe extern "C" fn make_first_field(text: *const c_char, index: u64) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn make_field(text: *const c_char, index: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_bus_id(bus_index: c_uint, bus_id: *mut u64) -> c_int {
    int ps3_repository_read_bus_id(unsigned int bus_index, u64 *bus_id)
    {
    return read_node(PS3_LPAR_ID_PME, make_first_field("bus", bus_index),
    make_field("id", 0), 0, 0, bus_id, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_find_device(repo: *mut ps3_repository_device) -> c_int {
    int ps3_repository_find_device(struct ps3_repository_device *repo)
    {
    int result;
    let mut tmp: ps3_repository_device = *repo;
    unsigned int num_dev;
...
// len = l;
    ...
    0, num_blocks, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_num_pu(num_pu: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_pu_id(pu_index: c_uint, pu_id: *mut u64) -> c_int {
    ...
    0, 0,
    pu_id, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_rm_size(ppe_id: c_uint, rm_size: *mut u64) -> c_int {
    ...
    rm_size, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_region_total(region_total: *mut u64) -> c_int {
    ...
    0, 0,
    region_total, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_mm_info(rm_base: *mut u64, rm_size: *mut u64, region_total: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_highmem_region_count(region_count: *mut c_uint) -> c_int {
...
// region_count = v1;
    ...
    make_field("base", 0),
    0,
    highmem_base, core::ptr::null_mut());
    }
    ...
    make_field("size", 0),
    0,
    highmem_size, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_num_spu_reserved(num_spu_reserved: *mut c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_num_spu_resource_id(num_resource_id: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_repository_read_boot_dat_address(address: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_boot_dat_size(size: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_vuart_av_port(port: *mut c_uint) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_vuart_sysmgr_port(port: *mut c_uint) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_boot_dat_info(lpar_addr: *mut u64, size: *mut c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_num_be(num_be: *mut c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_be_node_id(be_index: c_uint, node_id: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_be_id(node_id: u64, be_id: *mut u64) -> c_int {
    ...
    0,
    0,
    be_id, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_tb_freq(node_id: u64, tb_freq: *mut u64) -> int __init {
    ...
    make_field("clock", 0),
    0,
    tb_freq, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_read_be_tb_freq(be_index: c_uint, tb_freq: *mut u64) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn create_node(n1: u64, n2: u64, n3: u64, n4: u64, v1: u64, v2: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delete_node(n1: u64, n2: u64, n3: u64, n4: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_node(n1: u64, n2: u64, n3: u64, n4: u64, v1: u64, v2: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_write_highmem_region_count(region_count: c_uint) -> c_int {
    int ps3_repository_write_highmem_region_count(unsigned int region_count)
    {
    int result;
    let mut v1: u64 = (u64)region_count;
    result = write_node(
    make_first_field("highmem", 0),
    make_field("region", 0),
    make_field("count", 0),
...
#[no_mangle]
unsafe extern "C" fn ps3_repository_delete_highmem_base(region_index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_repository_delete_highmem_size(region_index: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_delete_highmem_info(region_index: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_dump_resource_info(repo: *const ps3_repository_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dump_stor_dev_info(repo: *mut ps3_repository_device) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_repository_dump_bus_info() -> int __init {
