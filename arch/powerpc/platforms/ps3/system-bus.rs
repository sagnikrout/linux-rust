...
//! Source: arch/powerpc/platforms/ps3/system-bus.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ps3_open_hv_device_sb(dev: *mut ps3_system_bus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_close_hv_device_sb(dev: *mut ps3_system_bus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_open_hv_device_gpu(dev: *mut ps3_system_bus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_close_hv_device_gpu(dev: *mut ps3_system_bus_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_open_hv_device(dev: *mut ps3_system_bus_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_close_hv_device(dev: *mut ps3_system_bus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_sb_mmio_region_create(r: *mut ps3_mmio_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_ioc0_mmio_region_create(r: *mut ps3_mmio_region) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_mmio_region_create(r: *mut ps3_mmio_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_sb_free_mmio_region(r: *mut ps3_mmio_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_ioc0_free_mmio_region(r: *mut ps3_mmio_region) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_free_mmio_region(r: *mut ps3_mmio_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_system_bus_probe(_dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_system_bus_remove(_dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ps3_system_bus_shutdown(_dev: *mut device) {
    ...
    drv.shutdown(dev);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: drv->remove) -> else {
...
#[no_mangle]
unsafe extern "C" fn ps3_system_bus_uevent(_dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3_system_bus_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ps3_dma_supported(_dev: *mut device, mask: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ps3_system_bus_release_device(_dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ps3_system_bus_device_register(dev: *mut ps3_system_bus_device) -> c_int {
    ...
    dev.core.of_node = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ps3_system_bus_driver_register(drv: *mut ps3_system_bus_driver) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ps3_system_bus_driver_unregister(drv: *mut ps3_system_bus_driver) {
