...
//! Source: arch/powerpc/platforms/chrp/pegasos_eth.c
#![no_std]
...
pub const MV64340_BASE_ADDR_ENABLE: c_uint = 0x278;
pub const MV64340_INTEGRATED_SRAM_BASE_ADDR: c_uint = 0x268;
pub const MV64340_SRAM_CONFIG: c_uint = 0x380;
...
#[no_mangle]
unsafe extern "C" fn Enable_SRAM() -> int __init {
    static int __init Enable_SRAM(void)
    {
    u32 ALong;
    if (mv643xx_reg_base == core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn mv643xx_eth_add_pds() -> int __init {
