...
//! Source: arch/powerpc/platforms/chrp/setup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn chrp_show_cpuinfo(m: *mut seq_file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sio_write(val: u8, index: u8) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn sio_read(index: u8) -> u8 __init {
...
#[no_mangle]
unsafe extern "C" fn sio_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pegasos_set_l2cr() -> void __init {
...
// Enable L2 cache if needed
    ...
    const unsigned int *l2cr = of_get_property(np, "l2cr", core::ptr::null_mut());
    if (l2cr == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn briq_restart(cmd: *mut c_char) -> void __noreturn {
...
//
#[no_mangle]
unsafe extern "C" fn chrp_init() -> __init void {
...
// find the boot console from /chosen/stdout
    ...
    if (!node)
    return;
    property = of_get_property(node, "model", core::ptr::null_mut());
    if (!property)
    goto out_put;
    if (strcmp(property, "Pegasos2"))
    goto out_put;
// this is a Pegasos2
    property = of_get_property(of_chosen, "linux,stdout-path", core::ptr::null_mut());
    if (!property)
    goto out_put;
    of_node_put(node);
...
#[no_mangle]
unsafe extern "C" fn chrp_setup_arch() -> void __init {
...
// init to some ~sane value until calibrate_delay() runs
    ...
    if (root)
    machine = of_get_property(root, "model", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn chrp_8259_cascade(desc: *mut irq_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn chrp_find_openpic() -> void __init {
    static void __init chrp_find_openpic(void)
    {
    struct device_node *np, *root;
    int len, i, j;
    int isu_size;
    const unsigned int *iranges, *opprop = core::ptr::null_mut();
    let mut oplen: c_int = 0;
...
//
    ...
    isu_size, 0, " MPIC    ");
    if (chrp_mpic == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn chrp_find_8259() -> void __init {
    static void __init chrp_find_8259(void)
    {
    struct device_node *np, *pic = core::ptr::null_mut();
    let mut chrp_int_ack: c_ulong = 0;
...
//
    if (pic == core::ptr::null_mut() && chrp_mpic != core::ptr::null_mut()) {
...
//
    ...
    "8259-interrupt-acknowledge", core::ptr::null_mut());
    ...
    if (ppc_md.get_irq == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn chrp_init_IRQ() -> void __init {
