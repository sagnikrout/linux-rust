...
//! Source: arch/powerpc/platforms/pasemi/setup.c
#![no_std]
...
pub const MAX_MCE_REGS: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mce_regs {
    pub name: *mut c_char,
    ...
    let mut nmi_virq: static int = 0;
#[no_mangle]
unsafe extern "C" fn pas_restart(cmd: *mut c_char) -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn nemo_init_rtc() {
...
#[no_mangle]
unsafe extern "C" fn pas_setup_arch() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pas_setup_mce_regs() -> int __init {
...
// Remap various SoC status registers for use by the MCE handler
    reg = 0;
    dev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa00a, core::ptr::null_mut());
    ...
    dev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa001, core::ptr::null_mut());
    ...
    dev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa009, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sb600_8259_cascade(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn nemo_init_IRQ(mpic: *mut mpic) -> void __init {
...
// Connect the SB600's legacy i8259 controller
    ...
    i8259_init(np, 0);
    of_node_put(np);
    gpio_virq = irq_create_mapping(core::ptr::null_mut(), 3);
...
#[no_mangle]
pub unsafe extern "C" fn nemo_init_IRQ(mpic: *mut mpic) {
    static inline void nemo_init_IRQ(struct mpic *mpic)
    {
    }

#[no_mangle]
unsafe extern "C" fn pas_init_IRQ() -> __init void {
...
// Find address list in /platform-open-pic
    ...
    nmiprop = of_get_property(mpic_node, "nmi-source", core::ptr::null_mut());
    if (nmiprop)
...
// The NMI/MCK source needs to be prio 15
    if (nmiprop) {
    nmi_virq = irq_create_mapping(core::ptr::null_mut(), *nmiprop);
...
#[no_mangle]
unsafe extern "C" fn pas_progress(s: *mut c_char, hex: c_ushort) -> void __init {
    static void __init pas_progress(char *s, unsigned short hex)
    {
    printk("[%04x] : %s\n", hex, s ? s : "");
    }
#[no_mangle]
unsafe extern "C" fn pas_machine_check_handler(regs: *mut pt_regs) -> c_int {
    static int pas_machine_check_handler(struct pt_regs *regs)
    {
    let mut cpu: c_int = smp_processor_id();
    unsigned long srr0, srr1, dsisr;
    let mut dump_slb: c_int = 0;
    int i;
    srr0 = regs.nip;
    srr1 = regs.msr;
...
#[no_mangle]
unsafe extern "C" fn pasemi_publish_devices() -> int __init {
    static int __init pasemi_publish_devices(void)
    {
// Publish OF platform devices for SDC and other non-PCI devices
    of_platform_bus_probe(core::ptr::null_mut(), pasemi_bus_ids, core::ptr::null_mut());
    nemo_init_rtc();
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn pas_probe() -> int __init {
