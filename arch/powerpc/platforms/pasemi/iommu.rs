...
//! Source: arch/powerpc/platforms/pasemi/iommu.c
#![no_std]
...
pub const IOBMAP_PAGE_SHIFT: c_int = 12;

pub const IOB_BASE: c_uint = 0xe0000000;
pub const IOB_SIZE: c_uint = 0x3000;
// Configuration registers
pub const IOBCAP_REG: c_uint = 0x40;
pub const IOBCOM_REG: c_uint = 0x100;
// Enable IOB address translation
pub const IOBCOM_ATEN: c_uint = 0x00000100;
// Address decode configuration register
pub const IOB_AD_REG: c_uint = 0x14c;
// IOBCOM_AD_REG fields
pub const IOB_AD_VGPRT: c_uint = 0x00000e00;
pub const IOB_AD_VGAEN: c_uint = 0x00000100;
// Direct mapping settings
pub const IOB_AD_MPSEL_MASK: c_uint = 0x00000030;
pub const IOB_AD_MPSEL_B38: c_uint = 0x00000000;
pub const IOB_AD_MPSEL_B40: c_uint = 0x00000010;
pub const IOB_AD_MPSEL_B42: c_uint = 0x00000020;
// Translation window size / enable
pub const IOB_AD_TRNG_MASK: c_uint = 0x00000003;
pub const IOB_AD_TRNG_256M: c_uint = 0x00000000;
pub const IOB_AD_TRNG_2G: c_uint = 0x00000001;
pub const IOB_AD_TRNG_128G: c_uint = 0x00000003;
pub const IOB_TABLEBASE_REG: c_uint = 0x154;
// Base of the 64 4-byte L1 registers
pub const IOB_XLT_L1_REGBASE: c_uint = 0x2b00;
// Register to invalidate TLB entries
pub const IOB_AT_INVAL_TLB_REG: c_uint = 0x2d00;
// The top two bits of the level 1 entry contains valid and type flags
pub const IOBMAP_L1E_V: c_uint = 0x40000000;
pub const IOBMAP_L1E_V_B: c_uint = 0x80000000;
// For big page entries, the bottom two bits contains flags
pub const IOBMAP_L1E_BIG_CACHED: c_uint = 0x00000002;
pub const IOBMAP_L1E_BIG_PRIORITY: c_uint = 0x00000001;
// For regular level 2 entries, top 2 bits contain valid and cache flags
pub const IOBMAP_L2E_V: c_uint = 0x80000000;
pub const IOBMAP_L2E_V_CACHED: c_uint = 0xc0000000;
...
#[no_mangle]
unsafe extern "C" fn iommu_table_iobmap_setup() {
...
#[no_mangle]
unsafe extern "C" fn pci_dma_bus_setup_pasemi(bus: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn pci_dma_dev_setup_pasemi(dev: *mut pci_dev) {
...
//
    ...
    dev.dev.dma_ops = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn iob_init(dn: *mut device_node) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_init_early_pasemi() -> void __init {
