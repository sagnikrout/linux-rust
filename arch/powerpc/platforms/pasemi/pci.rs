...
//! Source: arch/powerpc/platforms/pasemi/pci.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pa_pxp_offset_valid(bus: u8, devfn: u8, offset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_root_port(busno: c_int, devfn: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_5945_reg(reg: c_int) -> c_int {
...
pub const PXP_ERR_CFG_REG: c_uint = 0x4;
pub const PXP_IGNORE_PCIE_ERRORS: c_uint = 0x800;
pub const SB600_BUS: c_int = 5;
#[no_mangle]
unsafe extern "C" fn sb600_set_flag(bus: c_int) {
    static void sb600_set_flag(int bus)
    {
    static void __iomem *iob_mapbase = core::ptr::null_mut();
    struct resource res;
    struct device_node *dn;
    int err;
    if (iob_mapbase == core::ptr::null_mut()) {
    dn = of_find_compatible_node(core::ptr::null_mut(), "isa", "pasemi,1682m-iob");
    if (!dn) {
...
#[no_mangle]
unsafe extern "C" fn setup_pa_pxp(hose: *mut pci_controller) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pas_add_bridge(dev: *mut device_node) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn pas_pci_init() -> void __init {
    void __init pas_pci_init(void)
    {
    struct device_node *root = of_find_node_by_path("/");
    struct device_node *np;
    pci_set_flags(PCI_SCAN_ALL_PCIE_DEVS);
    np = of_find_compatible_node(root, core::ptr::null_mut(), "pasemi,rootbus");
    if (np) {
    pas_add_bridge(np);
    of_node_put(np);
    }
...
#[no_mangle]
pub unsafe extern "C" fn pasemi_pci_getcfgaddr(dev: *mut pci_dev, offset: c_int) -> *mut void __iomem __init {
