...
//! Source: arch/powerpc/platforms/pasemi/dma_lib.c
#![no_std]
...
pub const MAX_TXCH: c_int = 64;
pub const MAX_RXCH: c_int = 64;
pub const MAX_FLAGS: c_int = 64;
pub const MAX_FUN: c_int = 8;
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_read_iob_reg(reg: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_write_iob_reg(reg: c_uint, val: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_read_mac_reg(intf: c_int, reg: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_write_mac_reg(intf: c_int, reg: c_uint, val: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_read_dma_reg(reg: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_write_dma_reg(reg: c_uint, val: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pasemi_alloc_tx_chan(type: enum pasemi_dmachan_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pasemi_free_tx_chan(chan: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pasemi_alloc_rx_chan() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pasemi_free_rx_chan(chan: c_int) {
...
//
    ...
    chan.chno = chno;
    chan.irq = irq_create_mapping(core::ptr::null_mut(),
    ...
    chan.chno = chno;
    chan.irq = irq_create_mapping(core::ptr::null_mut(), base_hw_irq + chno);
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_free_chan(chan: *mut pasemi_dmachan) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_alloc_ring(chan: *mut pasemi_dmachan, ring_size: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_free_ring(chan: *mut pasemi_dmachan) {
    ...
    chan.ring_virt = core::ptr::null_mut();
    chan.ring_size = 0;
    chan.ring_dma = 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_start_chan(chan: *const pasemi_dmachan, cmdsta: u32) {
...
//
pub const MAX_RETRIES: c_int = 5000;
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_stop_chan(chan: *const pasemi_dmachan) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_alloc_flag() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_free_flag(flag: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_set_flag(flag: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_clear_flag(flag: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_alloc_fun() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_free_fun(fun: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pasemi_dma_init() -> c_int {
...
// Make sure we haven't already initialized
    if (dma_pdev)
    goto out;
    iob_pdev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa001, core::ptr::null_mut());
    if (!iob_pdev) {
    BUG();
    ...
    dma_pdev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa007, core::ptr::null_mut());
    if (!dma_pdev) {
    BUG();
    ...
    intf = 0;
    for (pdev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa006, core::ptr::null_mut());
    pdev;
    pdev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa006, pdev))
    mac_regs[intf++] = map_onedev(pdev, 0);
    pci_dev_put(pdev);
    for (pdev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa005, core::ptr::null_mut());
    pdev;
