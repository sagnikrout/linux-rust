...
//! Source: arch/powerpc/platforms/powernv/opal-hmi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct OpalHmiEvtNode {
    pub list: list_head,
    pub hmi_evt: OpalHMIEvent,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xstop_reason {
    pub xstop_reason: u32,
    pub unit_failed: *const c_char,
...
//
    ...
    struct OpalHMIEvent *hmi_evt)
    {
    let mut type: u8 = hmi_evt.u.xstop_error.xstop_type;
    switch (type) {
...
#[no_mangle]
unsafe extern "C" fn print_hmi_event_info(hmi_evt: *mut OpalHMIEvent) {
...
#[no_mangle]
unsafe extern "C" fn hmi_event_handler(work: *mut work_struct) {
...
// HMI event info starts from param[0]
    ...
    pnv_platform_error_reboot(core::ptr::null_mut(), "Unrecoverable HMI exception");
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn opal_hmi_handler_init() -> int __init {
