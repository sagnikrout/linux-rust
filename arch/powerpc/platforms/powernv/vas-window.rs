...
//! Source: arch/powerpc/platforms/powernv/vas-window.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn vas_win_paste_addr(window: *mut pnv_vas_window, addr: *mut u64, len: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn unmap_region(addr: *mut c_void, start: u64, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn unmap_paste_region(window: *mut pnv_vas_window) {
    ...
    window.paste_kaddr = core::ptr::null_mut();
    kfree(window.paste_addr_name);
    window.paste_addr_name = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn unmap_winctx_mmio_bars(window: *mut pnv_vas_window) {
    ...
    window.hvwc_map = core::ptr::null_mut();
    uwc_map = window.uwc_map;
    window.uwc_map = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn map_winctx_mmio_bars(window: *mut pnv_vas_window) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn reset_window_regs(window: *mut pnv_vas_window) {
...
//
#[no_mangle]
unsafe extern "C" fn init_xlate_regs(window: *mut pnv_vas_window, user_win: bool) {
...
#[no_mangle]
unsafe extern "C" fn vas_release_window_id(ida: *mut ida, winid: c_int) {
    static void vas_release_window_id(struct ida *ida, int winid)
    {
    ida_free(ida, winid);
    }
#[no_mangle]
unsafe extern "C" fn vas_assign_window_id(ida: *mut ida) -> c_int {
    static int vas_assign_window_id(struct ida *ida)
    {
    let mut winid: c_int = ida_alloc_max(ida, VAS_WINDOWS_PER_CHIP - 1, GFP_KERNEL);
    if (winid == -ENOSPC) {
...
#[no_mangle]
unsafe extern "C" fn vas_window_free(window: *mut pnv_vas_window) {
    static void vas_window_free(struct pnv_vas_window *window)
    {
    struct vas_instance *vinst = window.vinst;
    let mut winid: c_int = window.vas_win.winid;
    unmap_winctx_mmio_bars(window);
...
#[no_mangle]
unsafe extern "C" fn put_rx_win(rxwin: *mut pnv_vas_window) {
...
//
    ...
    struct pnv_vas_window *window)
    {
    let mut id: c_int = window.vas_win.winid;
    mutex_lock(&vinst.mutex);
//
...
//
    ...
    WARN_ON_ONCE(vinst.windows[id] != core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn clear_vinst_win(window: *mut pnv_vas_window) {
    ...
    if (!window.user_win && !window.tx_win) {
    WARN_ON_ONCE(!vinst.rxwin[window.vas_win.cop]);
    vinst.rxwin[window.vas_win.cop] = core::ptr::null_mut();
    }
    WARN_ON_ONCE(vinst.windows[id] != window);
    vinst.windows[id] = core::ptr::null_mut();
    mutex_unlock(&vinst.mutex);
    }
...
#[no_mangle]
pub unsafe extern "C" fn vas_init_rx_win_attr(rxattr: *mut vas_rx_win_attr, cop: enum vas_cop_type) {
...
#[no_mangle]
pub unsafe extern "C" fn vas_init_tx_win_attr(txattr: *mut vas_tx_win_attr, cop: enum vas_cop_type) {
...
//
    ...
    decode_pswid(attr.pswid, &vasid, core::ptr::null_mut());
    vinst = find_vas_instance(vasid);
    if (!vinst) {
    pr_devel("vasid %d not found!\n", vasid);
    return ERR_PTR(-EINVAL);
...
#[no_mangle]
pub unsafe extern "C" fn vas_copy_crb(crb: *mut c_void, offset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vas_paste_crb(vwin: *mut vas_window, offset: c_int, re: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn poll_window_credits(window: *mut pnv_vas_window) {
...
//
#[no_mangle]
unsafe extern "C" fn poll_window_busy_state(window: *mut pnv_vas_window) {
...
//
#[no_mangle]
unsafe extern "C" fn poll_window_castout(window: *mut pnv_vas_window) {
...
//
#[no_mangle]
unsafe extern "C" fn unpin_close_window(window: *mut pnv_vas_window) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vas_win_close(vwin: *mut vas_window) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vas_return_credit(window: *mut pnv_vas_window, tx: bool) {
    ...
    decode_pswid(pswid, core::ptr::null_mut(), &winid);
...
//
    ...
    {
    let mut txattr: vas_tx_win_attr = {};
...
#[no_mangle]
unsafe extern "C" fn vas_user_win_paste_addr(txwin: *mut vas_window) -> u64 {
    ...
    vas_win_paste_addr(win, &paste_addr, core::ptr::null_mut());
    return paste_addr;
    }
#[no_mangle]
unsafe extern "C" fn vas_user_win_close(txwin: *mut vas_window) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vas_unregister_api_powernv() {
