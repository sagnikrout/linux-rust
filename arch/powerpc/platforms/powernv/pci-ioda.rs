...
//! Source: arch/powerpc/platforms/powernv/pci-ioda.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(PNV_IODA_PE_BUS_ALL): pe->flags & (PNV_IODA_PE_BUS |) -> else {
    else if (pe.flags & (PNV_IODA_PE_BUS | PNV_IODA_PE_BUS_ALL))
    sprintf(pfix, "%04x:%02x     ",
    pci_domain_nr(pe.pbus), pe.pbus.number);

#[no_mangle]
pub unsafe extern "C" fn if(PNV_IODA_PE_VF: pe->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn iommu_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pci_reset_phbs_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_reserve_pe(phb: *mut pnv_phb, pe_no: c_int) {
    ...
    {
    struct pnv_ioda_pe *ret = core::ptr::null_mut();
    let mut run: c_int = 0, pe, i;
    mutex_lock(&phb.ioda.pe_alloc_mutex);
...
pub unsafe extern "C" fn pnv_ioda_free_pe(pe: *mut pnv_ioda_pe) {
    ...
    let mut pe_num: c_uint = pe.pe_number;
    WARN_ON(pe.pdev);
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda2_init_m64(phb: *mut pnv_phb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1): phb->ioda.reserved_pe_idx == (phb->ioda.total_pe_num -) -> else {
    ...
    {
    unsigned long *pe_alloc __free(bitmap) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_parse_m64_window(phb: *mut pnv_phb) -> void __init {
    ...
    r = of_get_property(dn, "ibm,opal-m64-window", core::ptr::null_mut());
    if (!r) {
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_freeze_pe(phb: *mut pnv_phb, pe_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_unfreeze_pe(phb: *mut pnv_phb, pe_no: c_int, opt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_get_pe_state(phb: *mut pnv_phb, pe_no: c_int) -> c_int {
    static int pnv_ioda_get_pe_state(struct pnv_phb *phb, int pe_no)
    {
    struct pnv_ioda_pe *slave, *pe;
    let mut fstate: u8 = 0, state;
    let mut pcierr: __be16 = 0;
    s64 rc;
...
// Check the master PE
    ...
    &state, &pcierr, core::ptr::null_mut());
    if (rc != OPAL_SUCCESS) {
...
//
    ...
    {
    let mut pe_number: c_int = phb.ioda.pe_rmap[bdfn];
...
// For compound PEs, any one affects all of them
    ...
    pdev = pe.pbus.self;
#[no_mangle]
pub unsafe extern "C" fn if(PNV_IODA_PE_DEV: pe->flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_ioda_deconfigure_pe(phb: *mut pnv_phb, pe: *mut pnv_ioda_pe) -> c_int {
...
//
    ...
    pe.pbus = core::ptr::null_mut();
    pe.pdev = core::ptr::null_mut();

    pe.parent_dev = core::ptr::null_mut();

    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn pnv_ioda_configure_pe(phb: *mut pnv_phb, pe: *mut pnv_ioda_pe) -> c_int {
...
//
    ...
    {
    struct pnv_phb *phb = pci_bus_to_pnvhb(bus);
    struct pnv_ioda_pe *pe = core::ptr::null_mut();
    unsigned int pe_num;
//
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda_dma_dev_setup(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda_dma_64bit_bypass(pe: *mut pnv_ioda_pe) -> c_int {
...
// reconfigure window 0
    ...
    let mut top: u64 = pe.tce_bypass_base + memblock_end_of_DRAM() - 1;
    if (dma_mask >= top)
    return true;
    }
//
...
// Configure the bypass mode
    let mut rc: i64 = pnv_pci_ioda_dma_64bit_bypass(pe);
    if (rc)
    return false;
...
#[no_mangle]
pub unsafe extern "C" fn pnv_pci_phb3_tce_invalidate_pe(pe: *mut pnv_ioda_pe) {
    static inline void pnv_pci_phb3_tce_invalidate_pe(struct pnv_ioda_pe *pe)
    {
// 01xb - invalidate TCEs that match the specified PE#
    __be64 __iomem *invalidate = pnv_ioda_get_inval_reg(pe.phb);
    let mut val: c_ulong = PHB3_TCE_KILL_INVAL_PE | (pe.pe_number & 0xFF);
...
#[no_mangle]
pub unsafe extern "C" fn pnv_pci_ioda2_tce_invalidate_pe(pe: *mut pnv_ioda_pe) {
    ...
    struct pnv_phb *phb = pe.phb;
    let mut shift: c_uint = tbl.it_page_shift;
    if (phb.model == PNV_PHB_MODEL_PHB3 && phb.regs)
    ...
    let mut start_addr: __u64 = tbl.it_offset << tbl.it_page_shift;
    let mut win_size: __u64 = tbl.it_size << tbl.it_page_shift;
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda2_set_bypass(pe: *mut pnv_ioda_pe, enable: bool) {
    static void pnv_pci_ioda2_set_bypass(struct pnv_ioda_pe *pe, bool enable)
    {
    let mut window_id: u16 = (pe.pe_number << 1 ) + 1;
    int64_t rc;
    pe_info(pe, "%sabling 64-bit DMA bypass\n", enable ? "En" : "Dis");
    if (enable) {
    let mut top: phys_addr_t = memblock_end_of_DRAM();
    ...
    struct pnv_ioda_pe *pe = container_of(table_group, struct pnv_ioda_pe,
    table_group);
    let mut nid: c_int = pe.phb.hose.node;
    let mut bus_offset: __u64 = num ? pe.tce_bypass_base : table_group.tce32_start;
    long ret;
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda2_setup_default_config(pe: *mut pnv_ioda_pe) -> c_long {
...
//
    let mut max_memory: u64 = __rounddown_pow_of_two(memory_hotplug_max());
//
// In memory constrained environments, e.g. kdump kernel, the
// DMA window can be larger than available memory, which will
// cause errors later.
//
    let mut maxblock: u64 = 1UL << (PAGE_SHIFT + MAX_PAGE_ORDER);
//
...
// iommu_table::it_map uses 1 bit per IOMMU page, hence 8
    let mut window_size: u64 = min((maxblock * 8) << PAGE_SHIFT, max_memory);
// Each TCE level cannot exceed maxblock so go multilevel if needed
    let mut tces_order: c_ulong = ilog2(window_size >> PAGE_SHIFT);
    let mut tcelevel_order: c_ulong = ilog2(maxblock >> 3);
    let mut levels: c_uint = tces_order / tcelevel_order;
...
// We use top part of 32bit space for MMIO so exclude it from DMA
    ...
    iommu_tce_table_put(tbl);
    tbl = core::ptr::null_mut(); /* This clears iommu_table_base below */
    }
...
//
    ...
    let mut window_shift: unsigned = ilog2(window_size);
    let mut entries_shift: unsigned = window_shift - page_shift;
    let mut table_shift: unsigned = entries_shift + 3;
    let mut tce_table_size: c_ulong = max(0x1000UL, 1UL << table_shift);
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_setup_bus_dma(pe: *mut pnv_ioda_pe, bus: *mut pci_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pe->pdev) -> else {
    else if (pe.pdev)
    set_iommu_table_base(&pe.pdev.dev, core::ptr::null_mut());
    iommu_tce_table_put(tbl);
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pnv_opal_pci_msi_eoi(d: *mut irq_data) -> i64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_pnv_opal_msi(chip: *mut irq_chip) -> bool {
    bool is_pnv_opal_msi(struct irq_chip *chip)
    {
    let mut chip: return = = &pnv_pci_msi_irq_chip;
    }
...
#[no_mangle]
unsafe extern "C" fn pnv_msi_shutdown(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pnv_msi_compose_msg(d: *mut irq_data, msg: *mut msi_msg) {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_msi_eoi(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pnv_msi_allocate_domains(hose: *mut pci_controller, count: c_uint) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_init_ioda_msis(phb: *mut pnv_phb) -> void __init {
    static void __init pnv_pci_init_ioda_msis(struct pnv_phb *phb)
    {
    unsigned int count;
    const __be32 *prop = of_get_property(phb.hose.dn,
    "ibm,opal-msi-ranges", core::ptr::null_mut());
    if (!prop) {
// BML Fallback
    prop = of_get_property(phb.hose.dn, "msi-ranges", core::ptr::null_mut());
    }
    if (!prop)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn pnv_ioda_setup_pe_seg(pe: *mut pnv_ioda_pe) {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_diag_data_set(data: *mut c_void, val: u64) -> c_int {
...
// Print the diag data to the kernel log
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(pnv_pci_diag_data_fops, core::ptr::null_mut(), pnv_pci_diag_data_set,
    "%llu\n");
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda_pe_dump(data: *mut c_void, val: u64) -> c_int {
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(pnv_pci_ioda_pe_dump_fops, core::ptr::null_mut(),
    pnv_pci_ioda_pe_dump, "%llu\n");

#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda_create_dbgfs() {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_enable_bridge(bus: *mut pci_bus) {
...
//
    if (dev) {
    let mut rc: c_int = pci_enable_device(dev);
    if (rc)
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_enable_bridges() {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda_fixup() {
...
//
    ...
    {
    struct pnv_phb *phb = pci_bus_to_pnvhb(bus);
    let mut num_pci_bridges: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_MEM: r->flags & type &) -> else {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_configure_bus(bus: *mut pci_bus) {
    static void pnv_pci_configure_bus(struct pci_bus *bus)
    {
    struct pci_dev *bridge = bus.self;
    struct pnv_ioda_pe *pe;
    let mut all: bool = (bridge && pci_pcie_type(bridge) == PCI_EXP_TYPE_PCI_BRIDGE);
    dev_info(&bus.dev, "Configuring PE for bus\n");
// Don't assign PE to PCI bus, which doesn't have subordinate devices
    if (WARN_ON(list_empty(&bus.devices)))
    return;
// Reserve PEs according to used M64 resources
    pnv_ioda_reserve_m64_pe(bus, core::ptr::null_mut(), all);
//
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_default_alignment() -> resource_size_t {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_pci_enable_device_hook(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pnv_ocapi_enable_device_hook(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_pci_ioda2_release_pe_dma(pe: *mut pnv_ioda_pe) {
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_release_pe_seg(pe: *mut pnv_ioda_pe) {
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_release_pe(pe: *mut pnv_ioda_pe) {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_release_device(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda_shutdown(hose: *mut pci_controller) {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda_dma_bus_setup(bus: *mut pci_bus) {
    ...
    prop64 = of_get_property(np, "ibm,opal-phbid", core::ptr::null_mut());
    if (!prop64) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "ibm, _arg: power8-pciex")) -> else {
    else if (of_device_is_compatible(np, "ibm,power8-pciex"))
    phb.model = PNV_PHB_MODEL_PHB3;
    else
    phb.model = PNV_PHB_MODEL_UNKNOWN;
// Initialize diagnostic data buffer
    prop32 = of_get_property(np, "ibm,phb-diag-data-size", core::ptr::null_mut());
    if (prop32)
...
// Get registers
    ...
    if (phb.regs == core::ptr::null_mut())
    pr_err("  Failed to map registers !\n");
    }
// Initialize more IODA stuff
    phb.ioda.total_pe_num = 1;
    prop32 = of_get_property(np, "ibm,opal-num-pes", core::ptr::null_mut());
    if (prop32)
    phb.ioda.total_pe_num = be32_to_cpup(prop32);
    prop32 = of_get_property(np, "ibm,opal-reserved-pe", core::ptr::null_mut());
    if (prop32)
...
#[no_mangle]
pub unsafe extern "C" fn pnv_pci_init_ioda2_phb(np: *mut device_node) -> void __init {
    void __init pnv_pci_init_ioda2_phb(struct device_node *np)
    {
    pnv_pci_init_ioda_phb(np, 0, PNV_PHB_IODA2);
    }
#[no_mangle]
pub unsafe extern "C" fn pnv_pci_init_npu2_opencapi_phb(np: *mut device_node) -> void __init {
    void __init pnv_pci_init_npu2_opencapi_phb(struct device_node *np)
    {
    pnv_pci_init_ioda_phb(np, 0, PNV_PHB_NPU_OCAPI);
    }
#[no_mangle]
unsafe extern "C" fn pnv_npu2_opencapi_cfg_size_fixup(dev: *mut pci_dev) {
