...
//! Source: arch/powerpc/platforms/powernv/opal-irqchip.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn opal_handle_events() {
...
#[no_mangle]
pub unsafe extern "C" fn opal_have_pending_events() -> bool {
...
#[no_mangle]
unsafe extern "C" fn opal_event_set_type(d: *mut irq_data, flow_type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn opal_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn opal_event_shutdown() {
...
// First free interrupts, which will also mask them
    ...
    free_irq(opal_irqs[i].start, core::ptr::null_mut());
    opal_irqs[i].start = 0;
    }
    }
#[no_mangle]
pub unsafe extern "C" fn opal_event_init() -> int __init {
    int __init opal_event_init(void)
    {
    struct device_node *dn, *opal_node;
    let mut old_style: bool = false;
    int i, rc = 0;
...
// anyway.
    dn = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "ibm,opal-event");
...
// Old style "opal-interrupts" property
    ...
    i, &name);
    virq = irq_create_mapping(core::ptr::null_mut(), hw_irq);
    if (!virq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn opal_event_request(opal_event_nr: c_uint) -> c_int {
