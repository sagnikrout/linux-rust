...
//! Source: arch/powerpc/platforms/powernv/opal-lpc.c
#![no_std]
...
//
    ...
    let mut opal_lpc_chip_id: static int = -1;
#[no_mangle]
unsafe extern "C" fn opal_lpc_inb(port: c_ulong) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn __opal_lpc_inw(port: c_ulong) -> __le16 {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_inw(port: c_ulong) -> u16 {
    static u16 opal_lpc_inw(unsigned long port)
    {
    return le16_to_cpu(__opal_lpc_inw(port));
    }
#[no_mangle]
unsafe extern "C" fn __opal_lpc_inl(port: c_ulong) -> __le32 {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_inl(port: c_ulong) -> u32 {
    static u32 opal_lpc_inl(unsigned long port)
    {
    return le32_to_cpu(__opal_lpc_inl(port));
    }
#[no_mangle]
unsafe extern "C" fn opal_lpc_outb(val: u8, port: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn __opal_lpc_outw(val: __le16, port: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_outw(val: u16, port: c_ulong) {
    static void opal_lpc_outw(u16 val, unsigned long port)
    {
    __opal_lpc_outw(cpu_to_le16(val), port);
    }
#[no_mangle]
unsafe extern "C" fn __opal_lpc_outl(val: __le32, port: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_outl(val: u32, port: c_ulong) {
    static void opal_lpc_outl(u32 val, unsigned long port)
    {
    __opal_lpc_outl(cpu_to_le32(val), port);
    }
#[no_mangle]
unsafe extern "C" fn opal_lpc_insb(p: c_ulong, b: *mut c_void, c: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_insw(p: c_ulong, b: *mut c_void, c: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_insl(p: c_ulong, b: *mut c_void, c: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_outsb(p: c_ulong, b: *const c_void, c: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_outsw(p: c_ulong, b: *const c_void, c: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_outsl(p: c_ulong, b: *const c_void, c: c_ulong) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc_debugfs_entry {
    pub lpc_type: enum OpalLPCAddressType,
}
...
//
    ...
    len = 4;
#[no_mangle]
pub unsafe extern "C" fn if(0: todo > 1 && (pos & 1) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn opal_lpc_init_debugfs() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_lpc_init() -> void __init {
