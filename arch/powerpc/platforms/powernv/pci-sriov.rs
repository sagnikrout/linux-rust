...
//! Source: arch/powerpc/platforms/powernv/pci-sriov.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn pnv_pci_ioda_fixup_iov_resources(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_pci_ioda_fixup_iov(pdev: *mut pci_dev) {
...
//
    ...
    int resno)
    {
    let mut align: resource_size_t = pci_iov_resource_size(pdev, resno);
    struct pnv_phb *phb = pci_bus_to_pnvhb(pdev.bus);
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_vf_release_m64(pdev: *mut pci_dev, num_vfs: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_alloc_m64_bar(phb: *mut pnv_phb, iov: *mut pnv_iov_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_vf_assign_m64(pdev: *mut pci_dev, num_vfs: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_release_vf_PE(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_vf_resource_shift(dev: *mut pci_dev, offset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_sriov_disable(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pnv_ioda_setup_vf_PE(pdev: *mut pci_dev, num_vfs: u16) {
...
// Reserve PE for each VF
    ...
    let mut vf_devfn: c_int = pci_iov_virtfn_devfn(pdev, vf_index);
    let mut vf_bus: c_int = pci_iov_virtfn_bus(pdev, vf_index);
...
#[no_mangle]
unsafe extern "C" fn pnv_pci_sriov_enable(pdev: *mut pci_dev, num_vfs: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_pcibios_sriov_disable(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_pcibios_sriov_enable(pdev: *mut pci_dev, num_vfs: u16) -> c_int {
