...
//! Source: arch/powerpc/platforms/powernv/opal-sysparam.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn opal_get_sys_param(param_id: u32, length: u32, buffer: *mut c_void) -> isize {
...
#[no_mangle]
unsafe extern "C" fn opal_set_sys_param(param_id: u32, length: u32, buffer: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_sys_param_init() -> void __init {
