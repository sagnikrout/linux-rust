...
//! Source: arch/powerpc/platforms/powernv/vas-fault.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dump_fifo(vinst: *mut vas_instance, entry: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vas_fault_thread_fn(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn vas_fault_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn vas_setup_fault_window(vinst: *mut vas_instance) -> c_int {
