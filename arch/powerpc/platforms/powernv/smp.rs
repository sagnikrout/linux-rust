...
//! Source: arch/powerpc/platforms/powernv/smp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pnv_smp_setup_cpu(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pnv_smp_kick_cpu(nr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_smp_cpu_disable() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_flush_interrupts() {
...
#[no_mangle]
unsafe extern "C" fn pnv_cpu_offline_self() {
...
#[no_mangle]
unsafe extern "C" fn pnv_cpu_bootable(nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_smp_prepare_cpu(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_cause_ipi(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pnv_smp_probe() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_system_reset_exception(regs: *mut pt_regs) -> noinstr static int {
...
#[no_mangle]
unsafe extern "C" fn pnv_cause_nmi_ipi(cpu: c_int) -> c_int {
    static int pnv_cause_nmi_ipi(int cpu)
    {
    int64_t rc;
    if (cpu >= 0) {
    let mut h: c_int = get_hard_smp_processor_id(cpu);
...
//
    ...
    .cause_ipi	= core::ptr::null_mut(),	/* Filled at runtime by pnv_smp_probe() */
...
#[no_mangle]
pub unsafe extern "C" fn pnv_smp_init() -> void __init {
