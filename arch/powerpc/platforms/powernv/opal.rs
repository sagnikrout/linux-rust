...
//! Source: arch/powerpc/platforms/powernv/opal.c
#![no_std]
...
pub const OPAL_MSG_QUEUE_MAX: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct opal_msg_node {
    pub list: list_head,
    pub msg: opal_msg,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcheck_recoverable_range {
    pub start_addr: u64,
    pub end_addr: u64,
    pub recover_addr: u64,
}
...
#[no_mangle]
pub unsafe extern "C" fn opal_configure_cores() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn opal_register_exception_handlers() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn queue_replay_msg(msg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dequeue_replay_msg(msg_type: enum opal_msg_type) {
...
#[no_mangle]
unsafe extern "C" fn opal_message_do_notify(msg_type: u32, msg: *mut c_void) {
    static void opal_message_do_notify(uint32_t msg_type, void *msg)
    {
    unsigned long flags;
    let mut queued: bool = false;
    spin_lock_irqsave(&msg_list_lock, flags);
    if (opal_msg_notifier_head[msg_type].head == core::ptr::null_mut()) {
//
...
#[no_mangle]
unsafe extern "C" fn opal_handle_message() {
...
#[no_mangle]
unsafe extern "C" fn opal_message_notify(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn opal_message_init(opal_node: *mut device_node) -> int __init {
...
// Try to allocate fixed message size
    opal_msg = kmalloc(opal_msg_size, GFP_KERNEL);
    BUG_ON(opal_msg == core::ptr::null_mut());
    }
    ...
    IRQ_TYPE_LEVEL_HIGH, "opal-msg", core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn opal_get_chars(vtermno: u32, buf: *mut u8, count: usize) -> isize {
    ...
    {
    let mut flags: c_ulong = 0 /* shut up gcc */;
    ssize_t written;
    __be64 olen;
    s64 rc;
    if (!opal.entry)
...
#[no_mangle]
pub unsafe extern "C" fn opal_put_chars(vtermno: u32, data: *const u8, total_len: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn __opal_flush_console(vtermno: u32) -> i64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn opal_flush_console(vtermno: u32) -> c_int {
    int opal_flush_console(uint32_t vtermno)
    {
    for (;;) {
    let mut rc: i64 = __opal_flush_console(vtermno);
...
//
#[no_mangle]
pub unsafe extern "C" fn opal_flush_chars(vtermno: u32, wait: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_platform_error_reboot(regs: *mut pt_regs, msg: *const c_char) -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn opal_machine_check(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_hmi_exception_early(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_hmi_exception_early2(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_handle_hmi_exception(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_recovery_address(nip: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn opal_mce_check_early_recovery(regs: *mut pt_regs) -> bool {
    bool opal_mce_check_early_recovery(struct pt_regs *regs)
    {
    let mut recover_addr: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn opal_sysfs_init() -> int __init {
    ...
    {
    struct bin_attribute *attr = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn opal_export_attrs() {
...
#[no_mangle]
unsafe extern "C" fn opal_dump_region_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn opal_pdev_init(compatible: *const c_char) -> void __init {
    static void __init opal_pdev_init(const char *compatible)
    {
    struct device_node *np;
    for_each_compatible_node(np, core::ptr::null_mut(), compatible)
    of_platform_device_create(np, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn opal_imc_init_dev() -> void __init {
    static void __init opal_imc_init_dev(void)
    {
    struct device_node *np;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), IMC_DTB_COMPAT);
    if (np)
    of_platform_device_create(np, core::ptr::null_mut(), core::ptr::null_mut());
    of_node_put(np);
    }
#[no_mangle]
unsafe extern "C" fn kopald(unused: *mut c_void) -> c_int {
    static int kopald(void *unused)
    {
    let mut timeout: c_ulong = msecs_to_jiffies(opal_heartbeat) + 1;
    set_freezable();
    do {
    try_to_freeze();
    opal_handle_events();
...
#[no_mangle]
pub unsafe extern "C" fn opal_wake_poller() {
...
#[no_mangle]
unsafe extern "C" fn opal_init_heartbeat() -> void __init {
...
// Old firwmware, we assume the HVC heartbeat is sufficient
    ...
    opal_heartbeat = 0;
    if (opal_heartbeat)
    kopald_tsk = kthread_run(kopald, core::ptr::null_mut(), "kopald");
    }
#[no_mangle]
unsafe extern "C" fn opal_init() -> int __init {
...
// Create leds platform devices
    ...
    if (leds) {
    of_platform_device_create(leds, "opal_leds", core::ptr::null_mut());
    of_node_put(leds);
    }
...
#[no_mangle]
pub unsafe extern "C" fn opal_shutdown() {
...
// Convert a region of vmalloc memory to an opal sg list
    ...
    {
    struct opal_sg_list *sg, *first = core::ptr::null_mut();
    let mut i: c_ulong = 0;
    ...
    let mut data: u64 = vmalloc_to_pfn(vmalloc_addr) << PAGE_SHIFT;
    let mut length: u64 = min(vmalloc_size, PAGE_SIZE);
...
#[no_mangle]
pub unsafe extern "C" fn opal_free_sg_list(sg: *mut opal_sg_list) {
    void opal_free_sg_list(struct opal_sg_list *sg)
    {
    while (sg) {
    let mut next: u64 = be64_to_cpu(sg.next);
    kfree(sg);
    if (next)
    sg = __va(next);
    else
...
#[no_mangle]
pub unsafe extern "C" fn opal_error_code(rc: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn powernv_set_nmmu_ptcr(ptcr: c_ulong) {
