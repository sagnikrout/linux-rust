...
//! Source: arch/powerpc/platforms/powernv/eeh-powernv.c
#![no_std]
...
//
    ...
    let mut eeh_event_irq: static int = -EINVAL;
#[no_mangle]
unsafe extern "C" fn pnv_pcibios_bus_add_device(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_event(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    if (eeh_enabled())
    eeh_send_failure_event(core::ptr::null_mut());
    return IRQ_HANDLED;
    }
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_dbgfs_set(data: *mut c_void, offset: c_int, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_dbgfs_get(data: *mut c_void, offset: c_int, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_enable_phbs() {
...
//
#[no_mangle]
pub unsafe extern "C" fn pnv_eeh_post_init() -> c_int {
...
// Register OPAL event notifier
    ...
    IRQ_TYPE_LEVEL_HIGH, "opal-eeh", core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_find_cap(pdn: *mut pci_dn, cap: c_int) -> c_int {
    static int pnv_eeh_find_cap(struct pci_dn *pdn, int cap)
    {
    let mut pos: c_int = PCI_CAPABILITY_LIST;
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_find_ecap(pdn: *mut pci_dn, cap: c_int) -> c_int {
    static int pnv_eeh_find_ecap(struct pci_dn *pdn, int cap)
    {
    struct eeh_dev *edev = pdn_to_eeh_dev(pdn);
    u32 header;
    let mut pos: c_int = 256, ttl = (4096 - 256) / 8;
    if (!edev || !edev.pcie_cap)
    return 0;
    if (pnv_pci_cfg_read(pdn, pos, 4, &header) != PCIBIOS_SUCCESSFUL)
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !header) -> else {
    else if (!header)
    return 0;
    while (ttl-- > 0) {
...
//
    ...
    uint32_t pcie_flags;
    int ret;
    let mut config_addr: c_int = (pdn.busno << 8) | (pdn.devfn);
//
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_EXP_TYPE_DOWNSTREAM: pcie_flags ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_eeh_set_option(pe: *mut eeh_pe, option: c_int) -> c_int {
    static int pnv_eeh_set_option(struct eeh_pe *pe, int option)
    {
    struct pci_controller *hose = pe.phb;
    struct pnv_phb *phb = hose.private_data;
    let mut freeze_pe: bool = false;
    int opt;
    s64 rc;
    switch (option) {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_get_phb_diag(pe: *mut eeh_pe) {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_get_phb_state(pe: *mut eeh_pe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_get_pe_state(pe: *mut eeh_pe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_eeh_get_state(pe: *mut eeh_pe, delay: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_poll(id: c_ulong) -> i64 {
    static s64 pnv_eeh_poll(unsigned long id)
    {
    let mut rc: i64 = OPAL_HARDWARE;
    while (1) {
    rc = opal_pci_poll(id);
    if (rc <= 0)
    break;
...
#[no_mangle]
pub unsafe extern "C" fn pnv_eeh_phb_reset(hose: *mut pci_controller, option: c_int) -> c_int {
...
// Issue PHB complete reset request
    ...
    OPAL_ASSERT_RESET);
#[no_mangle]
pub unsafe extern "C" fn if(EEH_RESET_DEACTIVATE: option ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_root_reset(hose: *mut pci_controller, option: c_int) -> c_int {
...
//
    ...
    OPAL_ASSERT_RESET);
#[no_mangle]
pub unsafe extern "C" fn if(EEH_RESET_HOT: option ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn __pnv_eeh_bridge_reset(dev: *mut pci_dev, option: c_int) -> c_int {
    static int __pnv_eeh_bridge_reset(struct pci_dev *dev, int option)
    {
    struct pci_dn *pdn = pci_get_pdn_by_devfn(dev.bus, dev.devfn);
    struct eeh_dev *edev = pdn_to_eeh_dev(pdn);
    let mut aer: c_int = edev ? edev.aer_cap : 0;
    u32 ctrl;
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_bridge_reset(pdev: *mut pci_dev, option: c_int) -> c_int {
    static int pnv_eeh_bridge_reset(struct pci_dev *pdev, int option)
    {
    struct pci_controller *hose = pci_bus_to_host(pdev.bus);
    struct pnv_phb *phb = hose.private_data;
    struct device_node *dn = pci_device_to_OF_node(pdev);
    let mut id: u64 = PCI_SLOT_ID(phb.opal_id, pci_dev_id(pdev));
    uint8_t scope;
    int64_t rc;
...
#[no_mangle]
pub unsafe extern "C" fn pnv_pci_reset_secondary_bus(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_do_flr(pdn: *mut pci_dn, option: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_do_af_flr(pdn: *mut pci_dn, option: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_reset_vf_pe(pe: *mut eeh_pe, option: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_eeh_reset(pe: *mut eeh_pe, option: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_eeh_configure_bridge(pe: *mut eeh_pe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_eeh_cfg_blocked(pdn: *mut pci_dn) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_dump_hub_diag_common(data: *mut OpalIoP7IOCErrorData) {
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_get_and_dump_hub_diag(hose: *mut pci_controller) {
...
//
    ...
    int ret;
    ret = eeh_ops.get_state(dev_pe, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn pnv_eeh_next_error(pe: *mut eeh_pe) -> c_int {
...
//
    eeh_remove_event(core::ptr::null_mut(), false);
    list_for_each_entry(hose, &hose_list, list_node) {
//
...
// Hit the ceiling ?
    ...
    break;
// Frozen parent PE ?
    state = eeh_ops.get_state(parent_pe, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pnv_eeh_restore_config(edev: *mut eeh_dev) -> c_int {
    ...
    .notify_resume		= core::ptr::null_mut()
    };
//
...
//
#[no_mangle]
unsafe extern "C" fn eeh_powernv_init() -> int __init {
    static int __init eeh_powernv_init(void)
    {
    let mut max_diag_size: c_int = PNV_PCI_DIAG_BUF_SIZE;
    struct pci_controller *hose;
    struct pnv_phb *phb;
