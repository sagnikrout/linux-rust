...
//! Source: arch/powerpc/platforms/powernv/opal-async.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct opal_async_token {
    pub state: enum opal_async_token_state,
    pub response: opal_msg,
}
...
#[no_mangle]
unsafe extern "C" fn __opal_async_get_token() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn opal_async_get_token_interruptible() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __opal_async_release_token(token: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_async_release_token(token: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_async_wait_response(token: u64, msg: *mut opal_msg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_async_wait_response_interruptible(token: u64, msg: *mut opal_msg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn opal_async_comp_init() -> int __init {
    ...
    async = of_get_property(opal_node, "opal-msg-async-num", core::ptr::null_mut());
    if (!async) {
