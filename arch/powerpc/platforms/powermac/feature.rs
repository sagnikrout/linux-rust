...
//! Source: arch/powerpc/platforms/powermac/feature.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct feature_table_entry {
    pub selector: c_uint,
    pub function: feature_call,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_node_name_eq(node, _arg: "ch-b")) -> else {
...
#[no_mangle]
unsafe extern "C" fn ohare_mesh_enable(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ohare_ide_enable(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ohare_ide_reset(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ohare_sleep_state(node: *mut device_node, param: c_long, value: c_long) -> c_long {
    static long ohare_sleep_state(struct device_node *node, long param, long value)
    {
    let mut macio: *mut macio_chip = &macio_chips[0];
...
#[no_mangle]
unsafe extern "C" fn dbdma_save(macio: *mut macio_chip, save: *mut dbdma_regs) {
...
#[no_mangle]
unsafe extern "C" fn dbdma_restore(macio: *mut macio_chip, save: *mut dbdma_regs) {
...
#[no_mangle]
unsafe extern "C" fn heathrow_sleep(macio: *mut macio_chip, secondary: c_int) {
...
#[no_mangle]
unsafe extern "C" fn heathrow_wakeup(macio: *mut macio_chip, secondary: c_int) {
...
#[no_mangle]
unsafe extern "C" fn core99_scc_enable(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
pub unsafe extern "C" fn if(_arg: of_node_name_eq(node, _arg: "ch-b")) -> else {
    ...
    return -ENODEV;
    if (value) {
    let mut need_reset_scc: c_int = 0;
    let mut need_reset_irda: c_int = 0;
    LOCK(flags);
...
//
    ...
    const u32 *rst = of_get_property(np, "soft-reset", core::ptr::null_mut());
    if (!rst)
    continue;
    ...
    if (np == core::ptr::null_mut() || reset_io == 0)
    ...
    macio.type != macio_intrepid)
    return -ENODEV;
    prop = of_get_property(node, "AAPL,clock-id", core::ptr::null_mut());
    if (!prop)
    return -ENODEV;
    if (strncmp(prop, "usb0u048", 8) == 0)
    number = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(prop, _arg: "usb1u148", 0: 8) ==) -> else {
    else if (strncmp(prop, "usb1u148", 8) == 0)
    number = 2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(prop, _arg: "usb2u248", 0: 8) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn g5_gmac_enable(node: *mut device_node, param: c_long, value: c_long) -> c_long {
    ...
    mb();
    k2_skiplist[0] = core::ptr::null_mut();
    } else {
    k2_skiplist[0] = node;
    mb();
...
#[no_mangle]
unsafe extern "C" fn g5_fw_enable(node: *mut device_node, param: c_long, value: c_long) -> c_long {
    ...
    mb();
    k2_skiplist[1] = core::ptr::null_mut();
    } else {
    k2_skiplist[1] = node;
    mb();
...
#[no_mangle]
unsafe extern "C" fn g5_mpic_enable(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn g5_eth_phy_reset(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
// the iMac G5.
//
    phy = of_get_next_child(node, core::ptr::null_mut());
    if (!phy)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn g5_i2s_enable(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn g5_reset_cpu(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
//
#[no_mangle]
pub unsafe extern "C" fn g5_phy_disable_cpu1() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn keylargo_shutdown(macio: *mut macio_chip, sleep_mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pangea_shutdown(macio: *mut macio_chip, sleep_mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intrepid_shutdown(macio: *mut macio_chip, sleep_mode: c_int) {
...
// We power off the FW cable. Should be done by the driver...
    if (macio.flags & MACIO_FLAG_FW_SUPPORTED) {
    core99_firewire_enable(core::ptr::null_mut(), 0, 0);
    core99_firewire_cable_power(core::ptr::null_mut(), 0, 0);
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(macio_intrepid: macio->type ==) -> else {
    else if (macio.type == macio_intrepid)
    intrepid_shutdown(macio, 1);
#[no_mangle]
pub unsafe extern "C" fn if(macio_keylargo: macio->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn generic_get_mb_info(node: *mut device_node, param: c_long, value: c_long) -> c_long {
...
//
    ...
    PMAC_TYPE_PSURGE,		core::ptr::null_mut(),
    0
    },
    ...
    PMAC_TYPE_ANS,			core::ptr::null_mut(),
    0
    },
    {	"AAPL,e407",			"Alchemy",
    PMAC_TYPE_ALCHEMY,		core::ptr::null_mut(),
    0
    },
    {	"AAPL,e411",			"Gazelle",
    PMAC_TYPE_GAZELLE,		core::ptr::null_mut(),
    0
    },
...
//
#[no_mangle]
pub unsafe extern "C" fn pmac_do_feature_call(selector: c_uint, ...) -> c_long {
    long pmac_do_feature_call(unsigned int selector, ...)
    {
    struct device_node *node;
    long param, value;
    int i;
    let mut func: feature_call = core::ptr::null_mut();
    va_list args;
    if (pmac_mb.features)
...
#[no_mangle]
unsafe extern "C" fn probe_motherboard() -> int __init {
    static int __init probe_motherboard(void)
    {
    int i;
    struct macio_chip *macio = &macio_chips[0];
    const char *model = core::ptr::null_mut();
...
//
    dt = of_find_node_by_name(core::ptr::null_mut(), "device-tree");
    if (dt != core::ptr::null_mut())
    model = of_get_property(dt, "model", core::ptr::null_mut());
...
// Fixup Hooper vs. Comet
    ...
    let mut mach_id_ptr: *mut u32 __iomem = ioremap(0xf3000034, 4);
    if (!mach_id_ptr) {
    ret = -ENODEV;
    goto done;
    }
...
//
#[no_mangle]
unsafe extern "C" fn probe_uninorth() -> void __init {
    static void __init probe_uninorth(void)
    {
    struct resource res;
    unsigned long actrl;
// Locate core99 Uni-N
    uninorth_node = of_find_node_by_name(core::ptr::null_mut(), "uni-n");
    uninorth_maj = 1;
// Locate G5 u3
    if (uninorth_node == core::ptr::null_mut()) {
    uninorth_node = of_find_node_by_name(core::ptr::null_mut(), "u3");
    uninorth_maj = 3;
    }
// Locate G5 u4
    if (uninorth_node == core::ptr::null_mut()) {
    uninorth_node = of_find_node_by_name(core::ptr::null_mut(), "u4");
    uninorth_maj = 4;
    }
    if (uninorth_node == core::ptr::null_mut()) {
    uninorth_maj = 0;
...
#[no_mangle]
unsafe extern "C" fn probe_one_macio(name: *const c_char, compat: *const c_char, type: c_int) -> void __init {
    ...
    addrp = of_get_pci_address(node, 0, &size, core::ptr::null_mut());
    ...
    const u32 *did = of_get_property(node, "device-id", core::ptr::null_mut());
    if (*did == 0x00000025)
    type = macio_pangea;
    if (*did == 0x0000003e)
    type = macio_intrepid;
    ...
    revp = of_get_property(node, "revision-id", core::ptr::null_mut());
    if (revp)
...
// Warning, ordering is important
    probe_one_macio("gc", core::ptr::null_mut(), macio_grand_central);
    probe_one_macio("ohare", core::ptr::null_mut(), macio_ohare);
    probe_one_macio("pci106b,7", core::ptr::null_mut(), macio_ohareII);
...
// Make sure the "main" macio chip appear first
    ...
    let mut temp: macio_chip = macio_chips[0];
    ...
    return (macio_chips[0].of_node == core::ptr::null_mut()) ? -ENODEV : 0;
    }
    static void __init
    ...
    const char *conn;
    let mut port_type: c_int = PMAC_SCC_ASYNC;
    let mut modem: c_int = 0;
    slots = of_get_property(np, "slot-names", &len);
    conn = of_get_property(np, "AAPL,connector", &len);
    if (conn && (strcmp(conn, "infrared") == 0))
    port_type = PMAC_SCC_IRDA;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "cobalt")) -> else {
    else if (of_device_is_compatible(np, "cobalt"))
    modem = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0: slots && slots->count >) -> else {
    if (strcmp(slots.name, "IrDA") == 0)
    port_type = PMAC_SCC_IRDA;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(slots->name, 0: "Modem") ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dump_HT_speeds(name: *mut c_char, cfg: u32, frq: u32) {
    static void dump_HT_speeds(char *name, u32 cfg, u32 frq)
    {
    int	freqs[16] = { 200,300,400,500,600,800,1000,0,0,0,0,0,0,0,0,0 };
    int	bits[8] = { 8,16,0,32,2,4,0,0 };
    let mut freq: c_int = (frq >> 8) & 0xf;
    if (freqs[freq] == 0)
...
#[no_mangle]
pub unsafe extern "C" fn pmac_check_ht_link() -> void __init {
    ...
    pcix_node = of_find_compatible_node(core::ptr::null_mut(), "pci", "pci-x");
    if (pcix_node == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn pmac_set_early_video_resume(data): *mut *mut void (proc)(void, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn pmac_call_early_video_resume() {
...
//
    ...
    return;
    pmac_agp_suspend = pmac_agp_resume = core::ptr::null_mut();
    return;
    }
    EXPORT_SYMBOL(pmac_register_agp_pm);
#[no_mangle]
pub unsafe extern "C" fn pmac_suspend_agp_for_card(dev: *mut pci_dev) {
    void pmac_suspend_agp_for_card(struct pci_dev *dev)
    {
    if (pmac_agp_bridge == core::ptr::null_mut() || pmac_agp_suspend == core::ptr::null_mut())
    return;
...
#[no_mangle]
pub unsafe extern "C" fn pmac_resume_agp_for_card(dev: *mut pci_dev) {
    void pmac_resume_agp_for_card(struct pci_dev *dev)
    {
    if (pmac_agp_bridge == core::ptr::null_mut() || pmac_agp_resume == core::ptr::null_mut())
    return;
    if (pmac_agp_bridge.bus != dev.bus)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn pmac_get_uninorth_variant() -> c_int {
