...
//! Source: arch/powerpc/platforms/powermac/pci.c
#![no_std]
...
//
pub const BANDIT_DEVID_2: c_int = 8;
pub const BANDIT_REVID: c_int = 3;
pub const BANDIT_DEVNUM: c_int = 11;
pub const BANDIT_MAGIC: c_uint = 0x50;
pub const BANDIT_COHERENT: c_uint = 0x40;
#[no_mangle]
unsafe extern "C" fn fixup_one_level_bus_range(node: *mut device_node, higher: c_int) -> int __init {
...
// For PCI<->PCI bridges or CardBus bridges, we go down
    class_code = of_get_property(node, "class-code", core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn fixup_bus_range(bridge: *mut device_node) -> void __init {
...
// Lookup the "bus-range" property for the hose
    ...
    if (prop == core::ptr::null_mut() || prop.length < 2 * sizeof(int))
    return;
...
//
    ...
    return core::ptr::null_mut();
    vendor = of_get_property(np, "vendor-id", core::ptr::null_mut());
    device = of_get_property(np, "device-id", core::ptr::null_mut());
    if (vendor == core::ptr::null_mut() || device == core::ptr::null_mut())
    return core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(0: devfn ==) -> else {
    else if (devfn == 0)
    return 0;
    else
    busdn = hose.dn;
...
#[no_mangle]
unsafe extern "C" fn pmac_pci_fixup_u4_of_node(dev: *mut pci_dev) {
...
//
    if (dev.dev.of_node == core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn init_bandit(bp: *mut pci_controller) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn init_p2pbridge() -> void __init {
...
// XXX it would be better here to identify the specific
    ...
    p2pbridge = of_find_node_by_name(core::ptr::null_mut(), "pci-bridge");
    if (p2pbridge == core::ptr::null_mut() || !of_node_name_eq(p2pbridge.parent, "pci"))
    goto done;
...
#[no_mangle]
unsafe extern "C" fn init_second_ohare() -> void __init {
    static void __init init_second_ohare(void)
    {
    struct device_node *np = of_find_node_by_name(core::ptr::null_mut(), "pci106b,7");
...
//
#[no_mangle]
unsafe extern "C" fn fixup_nec_usb2() -> void __init {
    ...
    const u32 *prop;
    u8 bus, devfn;
    prop = of_get_property(nec, "vendor-id", core::ptr::null_mut());
    if (prop == core::ptr::null_mut())
    continue;
    if (0x1033 != *prop)
    continue;
    prop = of_get_property(nec, "device-id", core::ptr::null_mut());
    if (prop == core::ptr::null_mut())
    continue;
    if (0x0035 != *prop)
    continue;
    prop = of_get_property(nec, "reg", core::ptr::null_mut());
    if (prop == core::ptr::null_mut())
    continue;
    devfn = (prop[0] >> 8) & 0xff;
    bus = (prop[0] >> 16) & 0xff;
...
#[no_mangle]
unsafe extern "C" fn setup_u3_agp(hose: *mut *mut pci_controller) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_u4_pcie(hose: *mut *mut pci_controller) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_u3_ht(hose: *mut *mut pci_controller) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn pmac_add_bridge(dev: *mut device_node) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn pmac_pci_irq_fixup(dev: *mut pci_dev) {
...
//
    ...
    dev.irq = irq_create_mapping(core::ptr::null_mut(), 60);
...
#[no_mangle]
unsafe extern "C" fn pmac_pci_root_bridge_prepare(bridge: *mut pci_host_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmac_pci_init() -> void __init {
    void __init pmac_pci_init(void)
    {
    struct device_node *np, *root;
    let mut __maybe_unused: *mut device_node ht = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pmac_pci_enable_device_hook(dev: *mut pci_dev) -> bool {
    static bool pmac_pci_enable_device_hook(struct pci_dev *dev)
    {
    struct device_node* node;
    let mut updatecfg: c_int = 0;
    int uninorth_child;
...
#[no_mangle]
unsafe extern "C" fn pmac_pci_fixup_ohci(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pmac_pcibios_after_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pmac_pci_fixup_cardbus(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pmac_pci_fixup_pciata(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_k2_sata(dev: *mut *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pmac_pci_probe_mode(bus: *mut pci_bus) -> c_int {
...
//
    if (bus.self == core::ptr::null_mut() && (of_device_is_compatible(node, "u3-agp") ||
