...
//! Source: arch/powerpc/platforms/86xx/gef_sbc310.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gef_sbc310_init_irq() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn gef_sbc310_setup_arch() -> void __init {
...
// Remap basic board registers
    ...
    if (sbc310_regs == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn gef_sbc310_get_board_id() -> c_uint {
...
// Return the PCB revision
#[no_mangle]
unsafe extern "C" fn gef_sbc310_get_pcb_rev() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gef_sbc310_get_board_rev() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gef_sbc310_get_fpga_rev() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gef_sbc310_show_cpuinfo(m: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn gef_sbc310_nec_fixup(pdev: *mut pci_dev) {
