...
//! Source: arch/powerpc/platforms/86xx/gef_ppc9a.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_init_irq() -> void __init {
...
//
    cascade_node = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "gef,fpga-pic-1.00");
    if (!cascade_node) {
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_setup_arch() -> void __init {
...
// Remap basic board registers
    regs = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "gef,ppc9a-fpga-regs");
    if (regs) {
    ppc9a_regs = of_iomap(regs, 0);
    if (ppc9a_regs == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_get_pcb_rev() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_get_board_rev() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_get_fpga_rev() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_get_vme_geo_addr() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_get_vme_is_syscon() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_show_cpuinfo(m: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn gef_ppc9a_nec_fixup(pdev: *mut pci_dev) {
