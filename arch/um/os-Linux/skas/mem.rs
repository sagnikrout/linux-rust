...
//! Source: arch/um/os-Linux/skas/mem.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn syscall_stub_dump_error(mm_idp: *mut mm_id) {
...
#[no_mangle]
unsafe extern "C" fn init_syscall_regs() -> int __init {
    static int __init init_syscall_regs(void)
    {
    get_safe_registers(syscall_regs, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn do_syscall_stub(mm_idp: *mut mm_id) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn syscall_stub_flush(mm_idp: *mut mm_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_stub_fd(mm_idp: *mut mm_id, fd: c_int) -> c_int {
...
// Find existing FD in map if we can allocate another syscall
    ...
    ARRAY_SIZE(((struct stub_data *)core::ptr::null_mut()).syscall_data)) {
...
// Compress with previous syscall if that is possible
    ...
    let mut prev_fd: c_int = sc.mem.fd;
    if (using_seccomp)
...
#[no_mangle]
pub unsafe extern "C" fn unmap(mm_idp: *mut mm_id, addr: c_ulong, len: c_ulong) -> c_int {
