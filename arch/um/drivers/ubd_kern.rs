...
//! Source: arch/um/drivers/ubd_kern.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ubd_test_bit(bit: __u64, data: *mut c_uchar) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ubd_set_bit(bit: __u64, data: *mut c_uchar) {
...
// End stuff from ubd_user.h
    ...
    let mut global_openflags: static struct openflags = OPEN_FLAGS;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cow {
// backing file name
...
// backing file fd
    ...
    pub bitmap_len: c_ulong,
    pub bitmap_offset: c_int,
    pub data_offset: c_int,
}

pub const MAX_SG: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ubd {
...
// backing or the cow file.
    ...
    pub fd: c_int,
    pub size: __u64,
    pub boot_openflags: openflags,
    pub openflags: openflags,
    pub shared:1: unsigned,
    pub no_cow:1: unsigned,
    pub no_trim:1: unsigned,
    pub cow: cow,
...
#[no_mangle]
unsafe extern "C" fn fake_ide_setup(str: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parse_unit(ptr: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if('z'): *mut *mut *mut ('a' <= str) && (str <=) -> else {
    n = *str - 'a';
    str++;
// ptr = str;
    }
...
//
#[no_mangle]
unsafe extern "C" fn ubd_setup_common(str: *mut c_char, index_out: *mut c_int, error_out: *mut c_char) -> c_int {
    static int ubd_setup_common(char *str, int *index_out, char **error_out)
    {
    struct ubd *ubd_dev;
    let mut flags: openflags = global_openflags;
...
// error_out = "Device number out of range";
    ...
    mutex_lock(&ubd_lock);
    ubd_dev = &ubd_devs[n];
    if(ubd_dev.file != core::ptr::null_mut()){
...
// error_out = "Missing '='";
    ...
    backing_file = core::ptr::null_mut();
    serial = strsep(&str, ",:");
    if (serial && *serial == '\0')
    serial = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ubd_setup(str: *mut c_char) -> c_int {
    static int ubd_setup(char *str)
    {
    char *error;
    int err;
    err = ubd_setup_common(str, core::ptr::null_mut(), &error);
    if(err)
...
#[no_mangle]
unsafe extern "C" fn udb_setup(str: *mut c_char) -> c_int {
...
// Only changed by ubd_init, which is an initcall.
    let mut thread_fd: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn ubd_end_request(io_req: *mut io_thread_req) {
...
#[no_mangle]
pub unsafe extern "C" fn if(REQ_OP_WRITE_ZEROES: req_op(io_req->req) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ubd_intr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn kill_io_thread() {
...
#[no_mangle]
pub unsafe extern "C" fn ubd_file_size(ubd_dev: *mut ubd, size_out: *mut __u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_cow_bitmap(fd: c_int, buf: *mut c_void, offset: c_int, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn backing_file_mismatch(file: *mut c_char, size: __u64, mtime: time64_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn path_requires_switch(from_cmdline: *mut c_char, from_cow: *mut c_char, cow: *mut c_char) -> c_int {
    static int path_requires_switch(char *from_cmdline, char *from_cow, char *cow)
    {
    struct uml_stat buf1, buf2;
    int err;
    if (from_cmdline == core::ptr::null_mut())
    return 0;
    ...
    if (fd < 0) {
    if ((fd == -ENOENT) && (create_cow_out != core::ptr::null_mut()))
// create_cow_out = 1;
    if (!openflags.w ||
    ((fd != -EROFS) && (fd != -EACCES)))
    return fd;
...
// Successful return case!
    ...
    if (err && (*backing_file_out != core::ptr::null_mut())) {
...
// backing_file_out = backing_file;
    ...
    int err, fd;
    flags.c = 1;
    fd = open_ubd_file(cow_file, &flags, 0, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    if (fd < 0) {
    err = fd;
...
#[no_mangle]
unsafe extern "C" fn ubd_close_dev(ubd_dev: *mut ubd) {
    static void ubd_close_dev(struct ubd *ubd_dev)
    {
    os_close_file(ubd_dev.fd);
    if(ubd_dev.cow.file == core::ptr::null_mut())
    return;
    os_close_file(ubd_dev.cow.fd);
    vfree(ubd_dev.cow.bitmap);
    ubd_dev.cow.bitmap = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ubd_open_dev(ubd_dev: *mut ubd) -> c_int {
    ...
    create_cow = 0;
    create_ptr = (ubd_dev.cow.file != core::ptr::null_mut()) ? &create_cow : core::ptr::null_mut();
    back_ptr = ubd_dev.no_cow ? core::ptr::null_mut() : &ubd_dev.cow.file;
    ...
    if(ubd_dev.cow.bitmap == core::ptr::null_mut()){
    ...
    flags.w = 0;
    err = open_ubd_file(ubd_dev.cow.file, &flags, ubd_dev.shared, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ubd_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ubd_add(n: c_int, error_out: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubd_config(str: *mut c_char, error_out: *mut c_char) -> c_int {
...
// error_out = "Failed to allocate memory";
    ...
    if (ret)
    ubd_devs[n].file = core::ptr::null_mut();
    mutex_unlock(&ubd_lock);
    out:
    return ret;
    err_free:
...
#[no_mangle]
unsafe extern "C" fn ubd_get_config(name: *mut c_char, str: *mut c_char, size: c_int, error_out: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubd_id(str: *mut c_char, start_out: *mut c_int, end_out: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubd_remove(n: c_int, error_out: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubd_mc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ubd0_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ubd_init() -> int __init {
    ...
    UBD_REQ_BUFFER_SIZE);
    irq_remainder = 0;
    if (irq_req_buffer == core::ptr::null_mut()) {
    ...
    UBD_REQ_BUFFER_SIZE);
    io_remainder = 0;
    if (io_req_buffer == core::ptr::null_mut()) {
    printk(KERN_ERR "Failed to initialize ubd buffering\n");
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn ubd_driver_init() -> int __init {
...
// enough. So use anyway the io thread.
    ...
    __u64 bitmap_len)
    {
    let mut sector: __u64 = io_offset >> SECTOR_SHIFT;
    int i, update_bitmap = 0;
    for (i = 0; i < length >> SECTOR_SHIFT; i++) {
    if(cow_mask != core::ptr::null_mut())
...
// cow_offset += bitmap_offset;
    ...
    {
    let mut sector: __u64 = offset >> SECTOR_SHIFT;
    int i;
    ...
    let mut i: c_int = 0;
    let mut byte_offset: c_ulong = io_req.offset;
    let mut op: enum req_op = req_op(req);
    if (op == REQ_OP_WRITE_ZEROES || op == REQ_OP_DISCARD) {
    io_req.io_desc[0].buffer = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ubd_submit_request(dev: *mut ubd, req: *mut request) -> c_int {
    static int ubd_submit_request(struct ubd *dev, struct request *req)
    {
    let mut segs: c_int = 0;
    struct io_thread_req *io_req;
    int ret;
    let mut op: enum req_op = req_op(req);
    if (op == REQ_OP_FLUSH)
    segs = 0;
#[no_mangle]
pub unsafe extern "C" fn if(REQ_OP_DISCARD: op == REQ_OP_WRITE_ZEROES || op ==) -> else {
    ...
    let mut ret: c_int = 0, res = BLK_STS_OK;
...
#[no_mangle]
unsafe extern "C" fn ubd_getgeo(disk: *mut gendisk, geo: *mut hd_geometry) -> c_int {
    static int ubd_getgeo(struct gendisk *disk, struct hd_geometry *geo)
    {
    struct ubd *ubd_dev = disk.private_data;
    geo.heads = 128;
...
#[no_mangle]
unsafe extern "C" fn map_error(error_code: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn update_bitmap(req: *mut io_thread_req, segment: *mut io_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_io(req: *mut io_thread_req, desc: *mut io_desc) {
...
// fds[0] is always either the rw image or our cow file
    ...
    if (desc.buffer != core::ptr::null_mut())
