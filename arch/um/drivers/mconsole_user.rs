...
//! Source: arch/um/drivers/mconsole_user.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mconsole_reply_v0(req: *mut mc_request, reply: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mconsole_get_request(fd: c_int, req: *mut mc_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mconsole_reply(req: *mut mc_request, str: *const c_char, err: c_int, more: c_int) -> c_int {
    int mconsole_reply(struct mc_request *req, const char *str, int err, int more)
    {
    return mconsole_reply_len(req, str, strlen(str), err, more);
    }
#[no_mangle]
pub unsafe extern "C" fn mconsole_unlink_socket() -> c_int {
    int mconsole_unlink_socket(void)
    {
    unlink(mconsole_socket_name);
    return 0;
    }
    let mut notify_sock: static int = -1;
#[no_mangle]
pub unsafe extern "C" fn mconsole_notify(sock_name: *mut c_char, type: c_int, data: *const c_void, len: c_int) -> c_int {
