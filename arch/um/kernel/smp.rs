...
#[no_mangle]
unsafe extern "C" fn ipi_handler(vector: c_int, regs: *mut uml_pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn uml_ipi_handler(vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn start_secondary(unused: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uml_start_secondary(opaque: *mut c_void) {
...
// Set in uml_ncpus_setup
    let mut uml_ncpus: c_int = 1;
#[no_mangle]
pub unsafe extern "C" fn prefill_possible_map() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn uml_ncpus_setup(line: *mut c_char, add: *mut c_int) -> int __init {
