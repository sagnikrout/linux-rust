...
//
    ...
    let mut time_travel_ext_fd: static int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn sched_clock() -> notrace unsigned long long {
...
#[no_mangle]
unsafe extern "C" fn time_travel_set_time(ns: c_ulonglong) {
    ...
    time_travel_time, ns);
#[no_mangle]
pub unsafe extern "C" fn if(S64_MAX): unlikely(ns >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn _time_travel_print_bc_msg() {
...
#[no_mangle]
unsafe extern "C" fn time_travel_setup_shm(fd: c_int, id: u16) {
    ...
    time_travel_shm = core::ptr::null_mut();
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn time_travel_ext_req(op: u32, time: u64) -> u64 {
    static u64 time_travel_ext_req(u32 op, u64 time)
    {
    static int seq;
    let mut mseq: c_int = ++seq;
...
#[no_mangle]
pub unsafe extern "C" fn __time_travel_wait_readable(fd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn time_travel_ext_update_request(time: c_ulonglong) {
...
#[no_mangle]
pub unsafe extern "C" fn __time_travel_propagate_time() {
...
#[no_mangle]
unsafe extern "C" fn time_travel_ext_request(time: c_ulonglong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn time_travel_ext_wait(idle: bool) {
    ...
    if (!time_travel_shm)
    time_travel_ext_free_until = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn time_travel_ext_get_time() {
...
#[no_mangle]
unsafe extern "C" fn __time_travel_update_time(ns: c_ulonglong, idle: bool) {
...
#[no_mangle]
unsafe extern "C" fn time_travel_periodic_timer(e: *mut time_travel_event) {
...
#[no_mangle]
pub unsafe extern "C" fn deliver_time_travel_irqs() {
...
#[no_mangle]
unsafe extern "C" fn time_travel_deliver_event(e: *mut time_travel_event) {
...
#[no_mangle]
pub unsafe extern "C" fn time_travel_del_event(e: *mut time_travel_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn time_travel_update_time(next: c_ulonglong, idle: bool) {
...
#[no_mangle]
unsafe extern "C" fn time_travel_update_time_rel(offs: c_ulonglong) {
...
#[no_mangle]
pub unsafe extern "C" fn time_travel_ndelay(nsec: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn time_travel_add_irq_event(e: *mut time_travel_event) {
...
#[no_mangle]
unsafe extern "C" fn time_travel_oneshot_timer(e: *mut time_travel_event) {
...
#[no_mangle]
pub unsafe extern "C" fn time_travel_sleep() {
...
//
    let mut next: c_ulonglong = S64_MAX;
...
#[no_mangle]
unsafe extern "C" fn time_travel_handle_real_alarm() {
...
#[no_mangle]
unsafe extern "C" fn time_travel_set_interval(interval: c_ulonglong) {
    static void time_travel_set_interval(unsigned long long interval)
    {
    time_travel_timer_interval = interval;
    }
#[no_mangle]
unsafe extern "C" fn time_travel_connect_external(socket: *const c_char) -> c_int {
    static int time_travel_connect_external(const char *socket)
    {
    const char *sep;
    let mut id: c_ulonglong = (unsigned long long)-1;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn time_travel_set_start() {
...
pub const time_travel_start_set: c_int = 0;
pub const time_travel_start: c_int = 0;
pub const time_travel_time: c_int = 0;
pub const time_travel_ext_waiting: c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn time_travel_update_time(ns: c_ulonglong, idle: bool) {
    static inline void time_travel_update_time(unsigned long long ns, bool idle)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn time_travel_update_time_rel(offs: c_ulonglong) {
    static inline void time_travel_update_time_rel(unsigned long long offs)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn time_travel_handle_real_alarm() {
...
#[no_mangle]
pub unsafe extern "C" fn time_travel_set_start() {
...
#[no_mangle]
pub unsafe extern "C" fn timer_handler(sig: c_int, unused_si: *mut siginfo, regs: *mut uml_pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn itimer_shutdown(evt: *mut clock_event_device) -> c_int {
    static int itimer_shutdown(struct clock_event_device *evt)
    {
    let mut cpu: c_int = evt - &timer_clockevent[0];
...
#[no_mangle]
unsafe extern "C" fn itimer_set_periodic(evt: *mut clock_event_device) -> c_int {
    static int itimer_set_periodic(struct clock_event_device *evt)
    {
    let mut interval: c_ulonglong = NSEC_PER_SEC / HZ;
    let mut cpu: c_int = evt - &timer_clockevent[0];
    if (time_travel_mode != TT_MODE_OFF) {
    time_travel_del_event(&time_travel_timer_event);
...
#[no_mangle]
unsafe extern "C" fn itimer_one_shot(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn um_timer(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn timer_read(cs: *mut clocksource) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn um_setup_timer() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn um_timer_init() -> void __init {
    static void __init um_timer_init(void)
    {
    int err;
    err = request_irq(TIMER_IRQ, um_timer, IRQF_TIMER, "hr timer", core::ptr::null_mut());
    if (err != 0)
...
#[no_mangle]
unsafe extern "C" fn setup_time_travel(str: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_time_travel_start(str: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bc_show(kobj: *mut kobject, attr: *mut kobj_attribute, buf: *mut c_char) -> isize {
    static ssize_t bc_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
    {
    return sprintf(buf, "0x%llx", bc_message);
    }
#[no_mangle]
unsafe extern "C" fn bc_store(kobj: *mut kobject, attr: *mut kobj_attribute, buf: *const c_char, count: usize) -> isize {
    ...
    let mut bc_attribute: static struct kobj_attribute = __ATTR(bc-message, 0660, bc_show, bc_store);
#[no_mangle]
unsafe extern "C" fn um_bc_start() -> int __init {
