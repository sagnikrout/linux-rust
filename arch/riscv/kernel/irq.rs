...
//! Source: arch/riscv/kernel/irq.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn riscv_set_intc_hwnode_fn((*fn)(void): *mut fwnode_handle) {
...
#[no_mangle]
unsafe extern "C" fn init_irq_scs() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_irq_stacks() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn ___do_softirq(regs: *mut pt_regs) {
