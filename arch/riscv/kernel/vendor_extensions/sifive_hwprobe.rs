...
//! Source: arch/riscv/kernel/vendor_extensions/sifive_hwprobe.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hwprobe_isa_vendor_ext_sifive_0(pair: *mut riscv_hwprobe, cpus: *const cpumask) {
