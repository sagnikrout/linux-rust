...
//! Source: arch/riscv/kernel/hibernate.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn arch_hdr_invariants(i: *mut arch_hibernate_hdr_invariants) {
...
//
    ...
    do {
    let mut pte: pte_t = READ_ONCE(*src_ptep);
    if (pte_present(pte))
    ...
    do {
    let mut p4d: p4d_t = READ_ONCE(*src_p4dp);
...
#[no_mangle]
unsafe extern "C" fn temp_pgtable_mapping(pgdp: *mut pgd_t, start: c_ulong, end: c_ulong, prot: pgprot_t) -> c_int {
    ...
    unsigned long ret;
    do {
    let mut pgd: pgd_t = READ_ONCE(*src_pgdp);
...
#[no_mangle]
unsafe extern "C" fn relocate_restore_code() -> c_ulong {
...
pub unsafe extern "C" fn swsusp_arch_resume() -> c_int {
    ...
    {
    let mut end: c_ulong = (unsigned long)pfn_to_virt(max_low_pfn);
    let mut start: c_ulong = PAGE_OFFSET;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn riscv_hibernate_init() -> int __init {
