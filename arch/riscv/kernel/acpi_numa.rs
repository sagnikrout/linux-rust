...
//! Source: arch/riscv/kernel/acpi_numa.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn acpi_numa_get_nid(cpu: c_uint) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_map_cpus_to_nodes() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_numa_rintc_affinity_init(pa: *mut acpi_srat_rintc_affinity) -> void __init {
