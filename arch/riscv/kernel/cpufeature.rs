...
//! Source: arch/riscv/kernel/cpufeature.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn riscv_isa_extension_base(isa_bitmap: *const c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn __riscv_isa_extension_available(isa_bitmap: *const c_ulong, bit: c_uint) -> bool {
...
//
    ...
    let mut riscv_isa_ext_count: usize = ARRAY_SIZE(riscv_isa_ext);
#[no_mangle]
unsafe extern "C" fn riscv_isa_set_ext(ext: *const riscv_isa_ext_data, bitmap: *mut c_ulong) {
...
//
    ...
    let mut max_loop_count: c_int = riscv_isa_ext_count, ret;
    unsigned int bit;
    do {
    loop = false;
    if (max_loop_count-- < 0) {
...
#[no_mangle]
unsafe extern "C" fn match_isa_ext(name: *const c_char, name_end: *const c_char, bitmap: *mut c_ulong) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn riscv_parse_isa_string(isa: *const c_char, bitmap: *mut c_ulong) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn riscv_fill_hwcap_from_isa_string(isa2hwcap: *mut c_ulong) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn riscv_fill_cpu_vendor_ext(cpu_node: *mut device_node, cpu: c_int) -> void __init {
    ...
    let mut ext: riscv_isa_ext_data = ext_list.ext_data[j];
...
//
#[no_mangle]
unsafe extern "C" fn riscv_fill_vendor_ext_list(cpu: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn has_thead_homogeneous_vlenb() -> c_int {
    static int has_thead_homogeneous_vlenb(void)
    {
    int cpu;
    let mut prev_vlenb: u32 = 0;
    let mut vlenb: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn riscv_fill_hwcap_from_ext_list(isa2hwcap: *mut c_ulong) -> int __init {
...
//
    ...
    let mut riscv_isa_fallback: bool __initdata = true;

    bool __initdata riscv_isa_fallback;
#[no_mangle]
unsafe extern "C" fn riscv_isa_fallback_setup(__unused: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn riscv_fill_hwcap() -> void __init {
    ...
    let mut ret: c_int = riscv_fill_hwcap_from_ext_list(isa2hwcap);
...
//
    ...
    if (__riscv_isa_extension_available(core::ptr::null_mut(), RISCV_ISA_EXT_ZVE32X) ||
...
#[no_mangle]
pub unsafe extern "C" fn riscv_get_elf_hwcap() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn riscv_user_isa_enable() -> void __init {
    void __init riscv_user_isa_enable(void)
    {
    if (riscv_has_extension_unlikely(RISCV_ISA_EXT_ZICBOZ))
    current.thread.envcfg |= ENVCFG_CBZE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: any_cpu_has_zicboz) -> else {
    else if (any_cpu_has_zicboz)
    pr_warn("Zicboz disabled as it is unavailable on some harts\n");
    if (riscv_has_extension_unlikely(RISCV_ISA_EXT_ZICBOM))
    current.thread.envcfg |= ENVCFG_CBCFE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: any_cpu_has_zicbom) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn riscv_cpufeature_patch_check(id: u16, value: u16) -> bool {
...
//
    if (alt.vendor_id != 0)
    continue;
    if (!__riscv_isa_extension_available(core::ptr::null_mut(), id))
    continue;
