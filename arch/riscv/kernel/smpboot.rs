...
//! Source: arch/riscv/kernel/smpboot.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn acpi_parse_rintc(header: *mut union acpi_subtable_headers, end: c_ulong) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_smp() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn start_secondary_cpu(cpu: c_int, tidle: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn smp_callin() -> asmlinkage __visible void {
    asmlinkage __visible void smp_callin(void)
    {
    struct mm_struct *mm = &init_mm;
    let mut curr_cpuid: c_uint = smp_processor_id();
    if (has_vector()) {
//
