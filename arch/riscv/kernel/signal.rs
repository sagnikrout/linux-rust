...
//! Source: arch/riscv/kernel/signal.c
#![no_std]
...
pub const DEBUG_SIG: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt_sigframe {
    pub info: siginfo,
    pub uc: ucontext,
    pub sigreturn_code: [u32; 2],
}
...
#[no_mangle]
unsafe extern "C" fn save_v_state(regs: *mut pt_regs, sc_vec: *mut void __user) -> c_long {
...
// Copy the pointer datap itself.
    err |= __put_user(( void *)datap, &state.v_state.datap);
...
//
#[no_mangle]
unsafe extern "C" fn __restore_v_state(regs: *mut pt_regs, sc_vec: *mut void __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn save_cfiss_state(regs: *mut pt_regs, sc_cfi: *mut void __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn __restore_cfiss_state(regs: *mut pt_regs, sc_cfi: *mut void __user) -> c_long {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arch_ext_priv {
    pub magic: __u32,
    pub sc_vec): *mut *mut *mut long (save)(struct pt_regs regs, void __user,
}
    ...
    let mut nr_arch_exts: static size_t = ARRAY_SIZE(arch_ext_list);
...
#[no_mangle]
unsafe extern "C" fn get_rt_frame_size(cal_all: bool) -> usize {
...
//
    ...
    sigset_t set;
    let mut frame_size: usize = get_rt_frame_size(false);
...
pub unsafe extern "C" fn arch_do_signal_or_restart(regs: *mut pt_regs) {
    ...
    struct ksignal ksig;
    let mut syscall: bool = (regs.cause == EXC_SYSCALL);
...
#[no_mangle]
pub unsafe extern "C" fn init_rt_signal_env() -> void __init {
