...
//! Source: arch/riscv/kernel/unaligned_access_speed.c
#![no_std]
...
pub const MISALIGNED_ACCESS_NS: c_int = 8000000;
pub const MISALIGNED_BUFFER_SIZE: c_uint = 0x4000;

    DEFINE_PER_CPU(long, misaligned_access_speed) = RISCV_HWPROBE_MISALIGNED_SCALAR_UNKNOWN;
    DEFINE_PER_CPU(long, vector_misaligned_access) = RISCV_HWPROBE_MISALIGNED_VECTOR_UNSUPPORTED;
    let mut unaligned_scalar_speed_param: static long = RISCV_HWPROBE_MISALIGNED_SCALAR_UNKNOWN;
    let mut unaligned_vector_speed_param: static long = RISCV_HWPROBE_MISALIGNED_VECTOR_UNKNOWN;
...
#[no_mangle]
unsafe extern "C" fn check_unaligned_access(page: *mut page) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _check_unaligned_access(param: *mut c_void) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn check_unaligned_access_speed_all_cpus() -> void __init {
    static void __init check_unaligned_access_speed_all_cpus(void)
    {
    unsigned int cpu;
    let mut cpu_count: c_uint = num_possible_cpus();
...
#[no_mangle]
unsafe extern "C" fn modify_unaligned_access_branches(mask: *const cpumask_t) {
    static void modify_unaligned_access_branches(const cpumask_t *mask)
    {
    let mut fast: bool = true;
    int cpu;
...
#[no_mangle]
unsafe extern "C" fn riscv_online_cpu(cpu: c_uint) -> c_int {
    static int riscv_online_cpu(unsigned int cpu)
    {
    let mut ret: c_int = cpu_online_unaligned_access_init(cpu);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn riscv_offline_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_vector_unaligned_access(__always_unused: *mut *mut work_work) {
...
#[no_mangle]
unsafe extern "C" fn riscv_online_cpu_vec(cpu: c_uint) -> c_int {
    ...
    if (per_cpu(vector_misaligned_access, cpu) != RISCV_HWPROBE_MISALIGNED_VECTOR_UNKNOWN)
    return 0;
    check_vector_unaligned_access_emulated(core::ptr::null_mut());
    check_vector_unaligned_access(core::ptr::null_mut());

    return 0;
    }
    static const char * const speed_str[] __initconst = { core::ptr::null_mut(), core::ptr::null_mut(), "slow", "fast", "unsupported" };
#[no_mangle]
unsafe extern "C" fn set_unaligned_scalar_speed_param(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: speed_str[RISCV_HWPROBE_MISALIGNED_SCALAR_FAST])) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: speed_str[RISCV_HWPROBE_MISALIGNED_SCALAR_UNSUPPORTED])) -> else {
...
#[no_mangle]
unsafe extern "C" fn set_unaligned_vector_speed_param(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: speed_str[RISCV_HWPROBE_MISALIGNED_VECTOR_FAST])) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: speed_str[RISCV_HWPROBE_MISALIGNED_VECTOR_UNSUPPORTED])) -> else {
...
#[no_mangle]
unsafe extern "C" fn check_unaligned_access_all_cpus() -> int __init {
...
//
    ...
    cpuhp_setup_state_nocalls(CPUHP_AP_ONLINE_DYN, "riscv:online",
    riscv_online_cpu_vec, core::ptr::null_mut());
    cpus_read_lock();
    modify_unaligned_access_branches(cpu_online_mask);
    cpus_read_unlock();
    return 0;
