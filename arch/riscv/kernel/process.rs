...
//! Source: arch/riscv/kernel/process.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn compat_elf_check_arch(hdr: *mut Elf32_Ehdr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn compat_mode_detect() -> int __init {
    static int __init compat_mode_detect(void)
    {
    let mut tmp: c_ulong = csr_read(CSR_STATUS);
...
#[no_mangle]
pub unsafe extern "C" fn ret_from_fork_kernel(fn_arg: *mut c_void, ): *mut *mut int (fn)(void, regs: *mut pt_regs) -> asmlinkage void {
...
#[no_mangle]
pub unsafe extern "C" fn ret_from_fork_user(regs: *mut pt_regs) -> asmlinkage void {
...
#[no_mangle]
pub unsafe extern "C" fn arch_task_cache_init() -> void __init {
...
pub unsafe extern "C" fn set_tagged_addr_ctrl(task: *mut task_struct, arg: c_ulong) -> c_long {
    ...
    {
    let mut valid_mask: c_ulong = PR_PMLEN_MASK | PR_TAGGED_ADDR_ENABLE;
