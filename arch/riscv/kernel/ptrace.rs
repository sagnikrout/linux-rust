...
//! Source: arch/riscv/kernel/ptrace.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn riscv_vr_active(target: *mut task_struct, regset: *const user_regset) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn update_regset_vector_info(size: c_ulong) -> void __init {
...
pub unsafe extern "C" fn ptrace_disable(child: *mut task_struct) {
    ...
    let mut compat_riscv_user_native_view: static struct user_regset_view = {};
