...
//! Source: arch/riscv/kernel/acpi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn acpi_parse_madt_rintc(header: *mut union acpi_subtable_headers, end: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_init_rintc_map() -> void __init {
