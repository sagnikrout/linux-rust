...
//! Source: arch/riscv/kvm/vcpu_sbi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_riscv_sbi_extension_entry {
    pub ext_idx: enum KVM_RISCV_SBI_EXT_ID,
    pub ext_ptr: *const kvm_vcpu_sbi_extension,
}
    ...
    {
    const struct kvm_riscv_sbi_extension_entry *sext = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn riscv_vcpu_supports_sbi_ext(vcpu: *mut kvm_vcpu, idx: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_sbi_load_reset_state(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_sbi_return(vcpu: *mut kvm_vcpu, run: *mut kvm_run) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_reg_indices_sbi_ext(vcpu: *mut kvm_vcpu, uindices: *mut u64 __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_reg_indices_sbi(vcpu: *mut kvm_vcpu, uindices: *mut u64 __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_set_reg_sbi(vcpu: *mut kvm_vcpu, reg: *const kvm_one_reg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_get_reg_sbi(vcpu: *mut kvm_vcpu, reg: *const kvm_one_reg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_sbi_ecall(vcpu: *mut kvm_vcpu, run: *mut kvm_run) -> c_int {
    int kvm_riscv_vcpu_sbi_ecall(struct kvm_vcpu *vcpu, struct kvm_run *run)
    {
    let mut ret: c_int = 1;
    let mut next_sepc: bool = true;
    struct kvm_cpu_context *cp = &vcpu.arch.guest_context;
    const struct kvm_vcpu_sbi_extension *sbi_ext;
    let mut utrap: kvm_cpu_trap = {0};
    struct kvm_vcpu_sbi_return sbi_ret = {
    .out_val = 0,
    .err_val = 0,
    .utrap = &utrap,
    };
    let mut ext_is_v01: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_sbi_init(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_sbi_deinit(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_sbi_reset(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_sbi_validate(vcpu: *mut kvm_vcpu) {
