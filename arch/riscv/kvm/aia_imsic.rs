...
//! Source: arch/riscv/kvm/aia_imsic.c
#![no_std]
...
pub struct imsic_mrif_eix {
    pub BITS_PER_LONG]: unsigned long eip[BITS_PER_TYPE(u64) /,
    pub BITS_PER_LONG]: unsigned long eie[BITS_PER_TYPE(u64) /,
}
...
// IMSIC VS-file
    ...
    pub vsfile_va: *mut void __iomem,
...
#[no_mangle]
unsafe extern "C" fn imsic_eix_read(ireg: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn imsic_eix_swap(ireg: c_int, val: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn imsic_eix_write(ireg: c_int, val: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn imsic_eix_set(ireg: c_int, val: c_ulong) {
    ...
    {
    let mut old_val: c_ulong = 0, tmp = 0;
    new_val &= wr_mask;
...
#[no_mangle]
unsafe extern "C" fn imsic_mrif_topei(mrif: *mut imsic_mrif, nr_eix: u32, nr_msis: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn imsic_mrif_isel_check(nr_eix: u32, isel: c_ulong) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imsic_vsfile_read_data {
    pub hgei: c_int,
    pub nr_eix: u32,
    pub clear: bool,
    pub mrif: *mut imsic_mrif,
}

#[no_mangle]
unsafe extern "C" fn imsic_vsfile_local_read(data: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imsic_vsfile_rw_data {
    pub hgei: c_int,
    pub isel: c_int,
    pub write: bool,
    pub val: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn imsic_vsfile_local_rw(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imsic_vsfile_local_clear(vsfile_hgei: c_int, nr_eix: u32) {
...
#[no_mangle]
unsafe extern "C" fn imsic_vsfile_cleanup(imsic: *mut imsic) {
...
//
    ...
    imsic.vsfile_va = core::ptr::null_mut();
    imsic.vsfile_pa = 0;
...
#[no_mangle]
unsafe extern "C" fn imsic_swfile_extirq_update(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_imsic_has_interrupt(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_imsic_load(vcpu: *mut kvm_vcpu, cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_imsic_put(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_imsic_release(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_imsic_update(vcpu: *mut kvm_vcpu) -> c_int {
    ...
    let mut ret: c_int = 0, new_vsfile_hgei = -1, old_vsfile_hgei, old_vsfile_cpu;
...
// Forward unknown IMSIC register to user-space
    ...
    isel, core::ptr::null_mut(), *val, -1UL);
    imsic_swfile_extirq_update(vcpu);
    } else
    rc = imsic_mrif_rmw(imsic.swfile, imsic.nr_eix,
    isel, val, 0, 0);
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_imsic_has_attr(kvm: *mut kvm, type: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_imsic_reset(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_imsic_init(vcpu: *mut kvm_vcpu) -> c_int {
...
// Setup IO device
    ...
    get_order(sizeof(*imsic.swfile)));
    fail_free_imsic:
    vcpu.arch.aia_context.imsic_state = core::ptr::null_mut();
    kfree(imsic);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_imsic_cleanup(vcpu: *mut kvm_vcpu) {
