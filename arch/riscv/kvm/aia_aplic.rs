...
//! Source: arch/riscv/kvm/aia_aplic.c
#![no_std]
...
pub struct aplic {
    ...
    pub nr_irqs: u32,
    pub nr_words: u32,
    pub __counted_by(nr_irqs): aplic_irq irqs[],
}

#[no_mangle]
unsafe extern "C" fn aplic_read_sourcecfg(aplic: *mut aplic, irq: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aplic_write_sourcecfg(aplic: *mut aplic, irq: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn aplic_read_target(aplic: *mut aplic, irq: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aplic_write_target(aplic: *mut aplic, irq: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn aplic_read_pending(aplic: *mut aplic, irq: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aplic_write_pending(aplic: *mut aplic, irq: u32, pending: bool) {
...
#[no_mangle]
unsafe extern "C" fn aplic_read_enabled(aplic: *mut aplic, irq: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aplic_write_enabled(aplic: *mut aplic, irq: u32, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn aplic_read_input(aplic: *mut aplic, irq: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aplic_inject_msi(kvm: *mut kvm, irq: u32, target: u32) {
...
#[no_mangle]
unsafe extern "C" fn aplic_update_irq_range(kvm: *mut kvm, first: u32, last: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_aplic_inject(kvm: *mut kvm, source: u32, level: bool) -> c_int {
    int kvm_riscv_aia_aplic_inject(struct kvm *kvm, u32 source, bool level)
    {
    u32 target;
    let mut inject: bool = false, ie;
    unsigned long flags;
    struct aplic_irq *irqd;
    struct aplic *aplic = kvm.arch.aia.aplic_state;
...
#[no_mangle]
unsafe extern "C" fn aplic_read_input_word(aplic: *mut aplic, word: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aplic_read_pending_word(aplic: *mut aplic, word: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aplic_read_enabled_word(aplic: *mut aplic, word: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aplic_mmio_read_offset(kvm: *mut kvm, off: gpa_t, val32: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aplic_mmio_write_offset(kvm: *mut kvm, off: gpa_t, val32: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_aplic_set_attr(kvm: *mut kvm, type: c_ulong, v: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_aplic_get_attr(kvm: *mut kvm, type: c_ulong, v: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_aplic_has_attr(kvm: *mut kvm, type: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_aplic_init(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_aplic_cleanup(kvm: *mut kvm) {
