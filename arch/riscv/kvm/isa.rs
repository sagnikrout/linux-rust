...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_base2isa_ext(base_ext: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_riscv_isa_check_host(kvm_ext: c_ulong, base_ext: *mut c_ulong) -> c_int {
...
//
    ...
    if (!__riscv_isa_extension_available(core::ptr::null_mut(), host_ext))
    return -ENOENT;
    if (base_ext)
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_isa_enable_allowed(ext: c_ulong) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_isa_disable_allowed(ext: c_ulong) -> bool {
