...
//! Source: arch/riscv/kvm/aia_device.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aia_create(dev: *mut kvm_device, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aia_destroy(dev: *mut kvm_device) {
...
#[no_mangle]
unsafe extern "C" fn aia_aplic_addr(kvm: *mut kvm, addr: *mut u64, write: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aia_imsic_ppn(aia: *mut kvm_aia, addr: gpa_t) -> gpa_t {
    static gpa_t aia_imsic_ppn(struct kvm_aia *aia, gpa_t addr)
    {
    u32 h, l;
    let mut mask: gpa_t = 0;
...
#[no_mangle]
unsafe extern "C" fn aia_imsic_hart_index(aia: *mut kvm_aia, addr: gpa_t) -> u32 {
    static u32 aia_imsic_hart_index(struct kvm_aia *aia, gpa_t addr)
    {
    let mut hart: u32 = 0, group = 0;
    if (aia.nr_hart_bits)
...
#[no_mangle]
unsafe extern "C" fn aia_init(kvm: *mut kvm) -> c_int {
    ...
    struct kvm_aia *aia = &kvm.arch.aia;
    let mut base_ppn: gpa_t = KVM_RISCV_AIA_UNDEF_ADDR;
...
#[no_mangle]
unsafe extern "C" fn aia_set_attr(dev: *mut kvm_device, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(KVM_DEV_RISCV_AIA_ADDR_IMSIC(nr_vcpus): type <) -> else {
...
#[no_mangle]
unsafe extern "C" fn aia_get_attr(dev: *mut kvm_device, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aia_has_attr(dev: *mut kvm_device, attr: *mut kvm_device_attr) -> c_int {
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(KVM_DEV_RISCV_AIA_ADDR_IMSIC(nr_vcpus): attr->attr <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_update(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_reset(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_init(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_deinit(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_inject_msi(kvm: *mut kvm, msi: *mut kvm_msi) -> c_int {
    ...
    struct kvm_aia *aia = &kvm.arch.aia;
    let mut target: gpa_t = (((gpa_t)msi.address_hi) << 32) | msi.address_lo;
// Proceed only if AIA was initialized successfully
    if (!kvm_riscv_aia_initialized(kvm))
    return -EBUSY;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_inject_irq(kvm: *mut kvm, irq: c_uint, level: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_init_vm(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_destroy_vm(kvm: *mut kvm) {
