...
//! Source: arch/riscv/kvm/vcpu_exit.c
#![no_std]
...
//
    ...
    struct kvm_cpu_trap *trap)
    {
    let mut vsstatus: c_ulong = ncsr_read(CSR_VSSTATUS);
...
#[no_mangle]
pub unsafe extern "C" fn vcpu_redirect(vcpu: *mut kvm_vcpu, trap: *mut kvm_cpu_trap) -> c_int {
