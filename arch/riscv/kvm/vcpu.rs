...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_clear_former_vcpu() {
...
//
    __this_cpu_write(kvm_former_vcpu, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn kvm_riscv_reset_vcpu(vcpu: *mut kvm_vcpu, kvm_sbi_reset: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_flush_interrupts(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_sync_interrupts(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_set_interrupt(vcpu: *mut kvm_vcpu, irq: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_unset_interrupt(vcpu: *mut kvm_vcpu, irq: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_has_interrupts(vcpu: *mut kvm_vcpu, mask: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_riscv_vcpu_power_off(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_power_off(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_riscv_vcpu_power_on(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_power_on(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_stopped(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(!vcpu->arch.csr_dirty: vcpu->arch.last_exit_cpu == cpu &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_riscv_check_vcpu_requests(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_riscv_update_hvip(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_riscv_vcpu_swap_in_guest_state(vcpu: *mut kvm_vcpu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn kvm_riscv_vcpu_swap_in_host_state(vcpu: *mut kvm_vcpu) -> __always_inline void {
