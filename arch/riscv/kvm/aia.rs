...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aia_hgei_control {
    pub lock: raw_spinlock_t,
    pub free_bitmap_initialized: bool,
    pub free_bitmap: c_ulong,
    pub owners: [*mut kvm_vcpu; BITS_PER_LONG],
    pub nr_hgei: c_uint,
    pub saved_hgeie: c_ulong,
}
...
#[no_mangle]
pub unsafe extern "C" fn aia_hvictl_value(ext_irq_pending: bool) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_flush_interrupts(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_sync_interrupts(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_has_interrupts(vcpu: *mut kvm_vcpu, mask: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_update_hvip(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_load(vcpu: *mut kvm_vcpu, cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_vcpu_aia_put(vcpu: *mut kvm_vcpu) {
    ...
    {
    struct kvm_vcpu_aia_csr *csr = &vcpu.arch.aia_context.guest_csr;
    let mut regs_max: c_ulong = sizeof(struct kvm_riscv_aia_csr) / sizeof(unsigned long);
...
#[no_mangle]
unsafe extern "C" fn aia_get_iprio8(vcpu: *mut kvm_vcpu, irq: c_uint) -> u8 {
    static u8 aia_get_iprio8(struct kvm_vcpu *vcpu, unsigned int irq)
    {
    unsigned long hviprio;
    let mut bitpos: c_int = aia_irq2bitpos[irq];
    if (bitpos < 0)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn aia_set_iprio8(vcpu: *mut kvm_vcpu, irq: c_uint, prio: u8) {
...
// We can't handle it here so redirect to user space
    ...
    lc = (gc) ? per_cpu_ptr(gc.local, cpu) : core::ptr::null_mut();
    if (lc && ret > 0) {
    if (hgei_va)
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_free_hgei(cpu: c_int, hgei: c_int) {
    ...
    hgctrl.owners[hgei] = core::ptr::null_mut();
    }
    }
    raw_spin_unlock_irqrestore(&hgctrl.lock, flags);
    }
#[no_mangle]
unsafe extern "C" fn hgei_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn aia_hgei_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aia_hgei_exit() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_pm_exit() {
...
// Enable IRQ filtering for overflow interrupt only if sscofpmf is present
    if (__riscv_isa_extension_available(core::ptr::null_mut(), RISCV_ISA_EXT_SSCOFPMF))
    csr_set(CSR_HVIEN, BIT(IRQ_PMU_OVF));
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_pm_enter() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_enable() {
    ...
    return;
    gc = imsic_get_global_config();
    lc = (gc) ? this_cpu_ptr(gc.local) : core::ptr::null_mut();
    hgctrl = this_cpu_ptr(&aia_hgei);
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_disable() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_init() -> c_int {
    int kvm_riscv_aia_init(void)
    {
    int rc;
    const struct imsic_global_config *gc;
    if (!riscv_isa_extension_available(core::ptr::null_mut(), SxAIA))
    return -ENODEV;
    gc = imsic_get_global_config();
...
#[no_mangle]
pub unsafe extern "C" fn kvm_riscv_aia_exit() {
