...
//! Source: arch/riscv/crypto/sm4-riscv64-glue.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn riscv64_sm4_encrypt(tfm: *mut crypto_tfm, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn riscv64_sm4_decrypt(tfm: *mut crypto_tfm, dst: *mut u8, src: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn riscv64_sm4_mod_init() -> int __init {
    static int __init riscv64_sm4_mod_init(void)
    {
    if (riscv_isa_extension_available(core::ptr::null_mut(), ZVKSED) &&
...
#[no_mangle]
unsafe extern "C" fn riscv64_sm4_mod_exit() -> void __exit {
