...
//! Source: arch/riscv/crypto/aes-riscv64-glue.c
#![no_std]
...
// AES-ECB
#[no_mangle]
pub unsafe extern "C" fn riscv64_aes_ecb_crypt(req: *mut skcipher_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riscv64_aes_ecb_encrypt(req: *mut skcipher_request) -> c_int {
    static int riscv64_aes_ecb_encrypt(struct skcipher_request *req)
    {
    return riscv64_aes_ecb_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn riscv64_aes_ecb_decrypt(req: *mut skcipher_request) -> c_int {
...
// AES-CBC
#[no_mangle]
unsafe extern "C" fn riscv64_aes_cbc_crypt(req: *mut skcipher_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riscv64_aes_cbc_encrypt(req: *mut skcipher_request) -> c_int {
    static int riscv64_aes_cbc_encrypt(struct skcipher_request *req)
    {
    return riscv64_aes_cbc_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn riscv64_aes_cbc_decrypt(req: *mut skcipher_request) -> c_int {
...
// AES-CBC-CTS
#[no_mangle]
unsafe extern "C" fn riscv64_aes_cbc_cts_crypt(req: *mut skcipher_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riscv64_aes_cbc_cts_encrypt(req: *mut skcipher_request) -> c_int {
    static int riscv64_aes_cbc_cts_encrypt(struct skcipher_request *req)
    {
    return riscv64_aes_cbc_cts_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn riscv64_aes_cbc_cts_decrypt(req: *mut skcipher_request) -> c_int {
...
// AES-CTR
#[no_mangle]
unsafe extern "C" fn riscv64_aes_ctr_crypt(req: *mut skcipher_request) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct riscv64_aes_xts_ctx {
    pub ctx1: crypto_aes_ctx,
...
#[no_mangle]
unsafe extern "C" fn riscv64_aes_xts_crypt(req: *mut skcipher_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riscv64_aes_xts_encrypt(req: *mut skcipher_request) -> c_int {
    static int riscv64_aes_xts_encrypt(struct skcipher_request *req)
    {
    return riscv64_aes_xts_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn riscv64_aes_xts_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn riscv64_aes_xts_supported() -> bool {
    static inline bool riscv64_aes_xts_supported(void)
    {
    return riscv_isa_extension_available(core::ptr::null_mut(), ZVBB) &&
    riscv_isa_extension_available(core::ptr::null_mut(), ZVKG) &&
    riscv_vector_vlen() < 2048 /* Implementation limitation */;
    }
#[no_mangle]
unsafe extern "C" fn riscv64_aes_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn riscv64_aes_mod_exit() -> void __exit {
