...
//! Source: arch/riscv/mm/kasan_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kasan_populate_pte(pmd: *mut pmd_t, vaddr: c_ulong, end: c_ulong) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn kasan_populate_pmd(pud: *mut pud_t, vaddr: c_ulong, end: c_ulong) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn kasan_swapper_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn kasan_populate(start: *mut c_void, end: *mut c_void) -> void __init {
    static void __init kasan_populate(void *start, void *end)
    {
    let mut vaddr: c_ulong = (unsigned long)start & PAGE_MASK;
    let mut vend: c_ulong = PAGE_ALIGN((unsigned long)end);
...
#[no_mangle]
unsafe extern "C" fn kasan_shallow_populate_pgd(vaddr: c_ulong, end: c_ulong) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn kasan_shallow_populate(start: *mut c_void, end: *mut c_void) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn create_tmp_mapping() -> void __init {
