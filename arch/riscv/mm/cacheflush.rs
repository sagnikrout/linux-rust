...
//! Source: arch/riscv/mm/cacheflush.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipi_remote_fence_i(info: *mut c_void) {
    static void ipi_remote_fence_i(void *info)
    {
    return local_flush_icache_all();
    }
#[no_mangle]
pub unsafe extern "C" fn flush_icache_all() {
...
//
    ...
    on_each_cpu(ipi_remote_fence_i, core::ptr::null_mut(), 1);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn flush_icache_mm(mm: *mut mm_struct, local: bool) {
...
//
    ...
    on_each_cpu_mask(&others, ipi_remote_fence_i, core::ptr::null_mut(), 1);
    }
    preempt_enable();
    }

#[no_mangle]
pub unsafe extern "C" fn flush_icache_pte(mm: *mut mm_struct, pte: pte_t) {
...
#[no_mangle]
pub unsafe extern "C" fn riscv_init_cbo_blocksizes() -> void __init {
    void __init riscv_init_cbo_blocksizes(void)
    {
    unsigned long cbom_hartid, cboz_hartid, cbop_hartid;
    let mut cbom_block_size: u32 = 0, cboz_block_size = 0, cbop_block_size = 0;
...
#[no_mangle]
unsafe extern "C" fn set_icache_stale_mask() {
...
//
#[no_mangle]
pub unsafe extern "C" fn riscv_set_icache_flush_ctx(ctx: c_ulong, scope: c_ulong) -> c_int {
