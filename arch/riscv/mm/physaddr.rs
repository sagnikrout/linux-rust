...
//! Source: arch/riscv/mm/physaddr.c
#![no_std]
...
pub unsafe extern "C" fn __phys_addr_symbol(x: c_ulong) -> phys_addr_t {
    ...
    {
    let mut kernel_start: c_ulong = kernel_map.virt_addr;
    let mut kernel_end: c_ulong = kernel_start + kernel_map.size;
//
...
#[no_mangle]
pub unsafe extern "C" fn linear_mapping_va_to_pa(x: c_ulong) -> phys_addr_t {
