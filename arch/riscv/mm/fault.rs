...
#[no_mangle]
pub unsafe extern "C" fn no_context(regs: *mut pt_regs, addr: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn mm_fault_error(regs: *mut pt_regs, addr: c_ulong, fault: vm_fault_t) {
...
#[no_mangle]
pub unsafe extern "C" fn vmalloc_fault(regs: *mut pt_regs, code: c_int, addr: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn access_error(cause: c_ulong, vma: *mut vm_area_struct) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_page_fault(regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn if(EXC_INST_PAGE_FAULT: cause ==) -> else {
