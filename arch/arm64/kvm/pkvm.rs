...
#[no_mangle]
unsafe extern "C" fn register_memblock_regions() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_hyp_reserve() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __pkvm_destroy_hyp_vm(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn __pkvm_create_hyp_vcpu(vcpu: *mut kvm_vcpu) -> c_int {
    static int __pkvm_create_hyp_vcpu(struct kvm_vcpu *vcpu)
    {
    let mut hyp_vcpu_sz: usize = PAGE_ALIGN(PKVM_HYP_VCPU_SIZE);
    let mut handle: pkvm_handle_t = vcpu.kvm.arch.pkvm.handle;
    void *hyp_vcpu;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn __pkvm_create_hyp_vm(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_hyp_vm_is_created(kvm: *mut kvm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_create_hyp_vm(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_create_hyp_vcpu(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_destroy_hyp_vm(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_init_host_vm(kvm: *mut kvm, type: c_ulong) -> c_int {
    int pkvm_init_host_vm(struct kvm *kvm, unsigned long type)
    {
    int ret;
    let mut protected: bool = type & KVM_VM_TYPE_ARM_PROTECTED;
...
#[no_mangle]
unsafe extern "C" fn _kvm_host_prot_finalize(arg: *mut c_void) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pkvm_drop_host_privileges() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn finalize_pkvm() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn __pkvm_mapping_start(m: *mut pkvm_mapping) -> u64 {
    static u64 __pkvm_mapping_start(struct pkvm_mapping *m)
    {
    return m.gfn * PAGE_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn __pkvm_mapping_end(m: *mut pkvm_mapping) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn __pkvm_pgtable_stage2_reclaim(pgt: *mut kvm_pgtable, start: u64, end: u64) -> c_int {
    static int __pkvm_pgtable_stage2_reclaim(struct kvm_pgtable *pgt, u64 start, u64 end)
    {
    struct kvm *kvm = kvm_s2_mmu_to_kvm(pgt.mmu);
    let mut handle: pkvm_handle_t = kvm.arch.pkvm.handle;
...
#[no_mangle]
unsafe extern "C" fn __pkvm_pgtable_stage2_unshare(pgt: *mut kvm_pgtable, start: u64, end: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_pgtable_stage2_destroy_pgd(pgt: *mut kvm_pgtable) {
...
// Expected to be called after all pKVM mappings have been released.
    ...
    {
    struct kvm *kvm = kvm_s2_mmu_to_kvm(pgt.mmu);
    struct pkvm_mapping *mapping = core::ptr::null_mut();
    struct kvm_hyp_memcache *cache = mc;
    let mut gfn: u64 = addr >> PAGE_SHIFT;
    let mut pfn: u64 = phys >> PAGE_SHIFT;
    let mut end: u64 = addr + size;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_pgtable_stage2_unmap(pgt: *mut kvm_pgtable, addr: u64, size: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_pgtable_stage2_wrprotect(pgt: *mut kvm_pgtable, addr: u64, size: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_pgtable_stage2_flush(pgt: *mut kvm_pgtable, addr: u64, size: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_pgtable_stage2_test_clear_young(pgt: *mut kvm_pgtable, addr: u64, size: u64, mkold: bool) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_pgtable_stage2_free_unlinked(mm_ops: *mut kvm_pgtable_mm_ops, pgtable: *mut c_void, level: i8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pkvm_force_reclaim_guest_page(phys: phys_addr_t) -> bool {
    bool pkvm_force_reclaim_guest_page(phys_addr_t phys)
    {
    let mut ret: c_int = kvm_call_hyp_nvhe(__pkvm_force_reclaim_guest_page, phys);
