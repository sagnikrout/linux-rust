...
// Macro flag: #define CREATE_TRACE_POINTS
    ...
    let mut kvm_mode: static enum kvm_mode = KVM_MODE_DEFAULT;
    enum kvm_wfx_trap_policy {
    KVM_WFX_NOTRAP_SINGLE_TASK, /* Default option */
    KVM_WFX_NOTRAP,
    KVM_WFX_TRAP,
    };
    let mut __read_mostly: static enum kvm_wfx_trap_policy kvm_wfi_trap_policy = KVM_WFX_NOTRAP_SINGLE_TASK;
    let mut __read_mostly: static enum kvm_wfx_trap_policy kvm_wfe_trap_policy = KVM_WFX_NOTRAP_SINGLE_TASK;
//
// Tracks KVM IOCTLs and their associated KVM capabilities.
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_ioctl_cap_map {
    pub ioctl: c_uint,
    pub ext: c_long,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_get_cap_for_kvm_ioctl(ioctl: c_uint, ext: *mut c_long) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn is_kvm_arm_initialised() -> bool {
    bool is_kvm_arm_initialised(void)
    {
    return kvm_arm_initialised;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_should_kick(vcpu: *mut kvm_vcpu) -> c_int {
...
//
    ...
    let mut new_cap: u64 = cap.args[0];
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_default_max_vcpus() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_fault(vcpu: *mut kvm_vcpu, vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn kvm_destroy_mpidr_data(kvm: *mut kvm) {
    ...
    if (data) {
    rcu_assign_pointer(kvm.arch.mpidr_data, core::ptr::null_mut());
    synchronize_rcu();
    kfree(data);
    }
    mutex_unlock(&kvm.arch.config_lock);
...
#[no_mangle]
unsafe extern "C" fn kvm_has_full_ptr_auth() -> bool {
...
//
    ...
    {
    let mut sz: usize = sizeof(struct kvm);
    if (!has_vhe())
    return kzalloc(sz, GFP_KERNEL_ACCOUNT);
    return kvzalloc(sz, GFP_KERNEL_ACCOUNT);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_precreate(kvm: *mut kvm, id: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_create(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_postcreate(vcpu: *mut kvm_vcpu) {
    void kvm_arch_vcpu_postcreate(struct kvm_vcpu *vcpu)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_destroy(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_blocking(vcpu: *mut kvm_vcpu) {
    void kvm_arch_vcpu_blocking(struct kvm_vcpu *vcpu)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_unblocking(vcpu: *mut kvm_vcpu) {
    void kvm_arch_vcpu_unblocking(struct kvm_vcpu *vcpu)
    {
    }
#[no_mangle]
unsafe extern "C" fn vcpu_set_pauth_traps(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_should_clear_twi(vcpu: *mut kvm_vcpu) -> bool {
    static bool kvm_vcpu_should_clear_twi(struct kvm_vcpu *vcpu)
    {
    if (unlikely(kvm_wfi_trap_policy != KVM_WFX_NOTRAP_SINGLE_TASK))
    let mut kvm_wfi_trap_policy: return = = KVM_WFX_NOTRAP;
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_should_clear_twe(vcpu: *mut kvm_vcpu) -> bool {
    static bool kvm_vcpu_should_clear_twe(struct kvm_vcpu *vcpu)
    {
    if (unlikely(kvm_wfe_trap_policy != KVM_WFX_NOTRAP_SINGLE_TASK))
    let mut kvm_wfe_trap_policy: return = = KVM_WFX_NOTRAP;
    return single_task_running();
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_load(vcpu: *mut kvm_vcpu, cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_put(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __kvm_arm_vcpu_power_off(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_vcpu_power_off(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_vcpu_stopped(vcpu: *mut kvm_vcpu) -> bool {
    bool kvm_arm_vcpu_stopped(struct kvm_vcpu *vcpu)
    {
    return READ_ONCE(vcpu.arch.mp_state.mp_state) == KVM_MP_STATE_STOPPED;
    }
#[no_mangle]
unsafe extern "C" fn kvm_arm_vcpu_suspend(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_vcpu_suspended(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_runnable(v: *mut kvm_vcpu) -> c_int {
    int kvm_arch_vcpu_runnable(struct kvm_vcpu *v)
    {
    let mut irq_lines: bool = *vcpu_hcr(v) & (HCR_VI | HCR_VF | HCR_VSE);
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_in_kernel(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_get_ip(vcpu: *mut kvm_vcpu) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn kvm_init_mpidr_data(kvm: *mut kvm) {
    static void kvm_init_mpidr_data(struct kvm *kvm)
    {
    struct kvm_mpidr_data *data = core::ptr::null_mut();
    unsigned long c, mask, nr_entries;
    let mut aff_set: u64 = 0, aff_clr = ~0UL;
    ...
    let mut aff: u64 = kvm_vcpu_get_mpidr_aff(vcpu);
    aff_set |= aff;
    aff_clr &= aff;
    }
//
...
//
    ...
    kvm_for_each_vcpu(c, vcpu, kvm) {
    let mut aff: u64 = kvm_vcpu_get_mpidr_aff(vcpu);
    let mut index: u16 = kvm_mpidr_index(data, aff);
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_run_pid_change(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_halt_guest(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_resume_guest(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_sleep(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_wfi(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_suspend(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_vcpu_requests(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcpu_mode_is_bad_32bit(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_irq_update_run(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_exit_request(vcpu: *mut kvm_vcpu, ret: *mut c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_arm_vcpu_enter_exit(vcpu: *mut kvm_vcpu) -> int noinstr {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ioctl_run(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcpu_interrupt_line(vcpu: *mut kvm_vcpu, number: c_int, level: bool) -> c_int {
...
//
    ...
    let mut level: bool = irq_level.level;
    let mut irq: u32 = irq_level.irq;
    unsigned long *mask;
    ...
    if (irqchip_in_kernel(kvm)) {
    let mut ret: c_int = vgic_lazy_init(kvm);
    if (ret)
    return ret;
    } else {
    return -ENXIO;
...
// Build a GICv5-style IntID here
    ...
    return kvm_vgic_inject_irq(kvm, vcpu, irq_num, level, core::ptr::null_mut());
...
// Build a GICv5-style IntID here
    ...
    return kvm_vgic_inject_irq(kvm, core::ptr::null_mut(), irq_num, level, core::ptr::null_mut());
    }
    return -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn system_supported_vcpu_features() -> c_ulong {
    static unsigned long system_supported_vcpu_features(void)
    {
    let mut features: c_ulong = KVM_VCPU_VALID_FEATURES;
    ...
    {
    let mut features: c_ulong = init.features[0];
    int i;
...
#[no_mangle]
unsafe extern "C" fn kvm_setup_vcpu(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_sync_dirty_log(kvm: *mut kvm, memslot: *mut kvm_memory_slot) {
...
#[no_mangle]
unsafe extern "C" fn kvm_vm_set_attr(kvm: *mut kvm, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvhe_percpu_size() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn nvhe_percpu_order() -> c_ulong {
    static unsigned long nvhe_percpu_order(void)
    {
    let mut size: c_ulong = nvhe_percpu_size();
    return size ? get_order(size) : 0;
    }
#[no_mangle]
unsafe extern "C" fn pkvm_host_sve_state_order() -> usize {
...
#[no_mangle]
unsafe extern "C" fn kvm_init_vector_slot(base: *mut c_void, slot: enum arm64_hyp_spectre_vector) {
    static void kvm_init_vector_slot(void *base, enum arm64_hyp_spectre_vector slot)
    {
    hyp_spectre_vector_selector[slot] = __kvm_vector_slot2addr(base, slot);
    }
#[no_mangle]
unsafe extern "C" fn kvm_init_vector_slots() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_prepare_hyp_mode(cpu: c_int, hyp_va_bits: u32) -> void __init {
...
//
    ...
    let mut ips: c_ulong = FIELD_GET(TCR_IPS_MASK, tcr);
    tcr &= TCR_EL2_MASK;
...
#[no_mangle]
unsafe extern "C" fn hyp_install_host_vector() {
...
#[no_mangle]
unsafe extern "C" fn cpu_init_hyp_mode() {
...
#[no_mangle]
unsafe extern "C" fn cpu_hyp_reset() {
...
//
#[no_mangle]
unsafe extern "C" fn cpu_set_hyp_vector() {
...
#[no_mangle]
unsafe extern "C" fn cpu_hyp_init_context() {
...
#[no_mangle]
unsafe extern "C" fn cpu_hyp_init_features() {
...
#[no_mangle]
unsafe extern "C" fn cpu_hyp_reinit() {
...
#[no_mangle]
unsafe extern "C" fn cpu_hyp_init(discard: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cpu_hyp_uninit(discard: *mut c_void) {
...
//
    preempt_disable();
    cpu_hyp_init(core::ptr::null_mut());
    kvm_vgic_cpu_up();
    kvm_timer_cpu_up();
    preempt_enable();
    return 0;
...
pub unsafe extern "C" fn kvm_arch_disable_virtualization_cpu() {
    ...
    kvm_vgic_cpu_down();
    if (!is_protected_kvm_enabled())
    cpu_hyp_uninit(core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn hyp_cpu_pm_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hyp_cpu_pm_exit() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_cpu_pm_init() -> void __init {
    static inline void __init hyp_cpu_pm_init(void)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn hyp_cpu_pm_exit() -> void __init {
    static inline void __init hyp_cpu_pm_exit(void)
    {
    }

#[no_mangle]
unsafe extern "C" fn init_cpu_logical_map() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_psci_relay() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn init_subsystems() -> int __init {
...
//
    on_each_cpu(cpu_hyp_init, core::ptr::null_mut(), 1);
//
...
//
    ...
    on_each_cpu(cpu_hyp_uninit, core::ptr::null_mut(), 1);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn teardown_subsystems() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn teardown_hyp_mode() -> void __init {
    static void __init teardown_hyp_mode(void)
    {
    let mut free_sve: bool = system_supports_sve() && is_protected_kvm_enabled();
    int cpu;
    free_hyp_pgds();
...
#[no_mangle]
unsafe extern "C" fn do_pkvm_init(hyp_va_bits: u32) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn get_hyp_id_aa64pfr0_el1() -> u64 {
...
// protected VMs.
//
    let mut val: u64 = read_sanitised_ftr_reg(SYS_ID_AA64PFR0_EL1);
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_init_symbols() {
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_init_protection(hyp_va_bits: u32) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_pkvm_host_sve_state() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkvm_check_sme_dvmsync_fw_call() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn finalize_init_hyp_mode() {
...
#[no_mangle]
unsafe extern "C" fn pkvm_hyp_init_ptrauth() {
...
#[no_mangle]
unsafe extern "C" fn init_hyp_mode() -> int __init {
    static int __init init_hyp_mode(void)
    {
    let mut hyp_va_bits: u32 = kvm_hyp_va_bits();
    int cpu;
...
// Prepare the CPU initialization parameters
    ...
    if (data) {
    let mut idx: u16 = kvm_mpidr_index(data, mpidr);
    vcpu = kvm_get_vcpu(kvm, data.cmpidr_to_idx[idx]);
    if (mpidr != kvm_vcpu_get_mpidr_aff(vcpu))
    vcpu = core::ptr::null_mut();
    }
    rcu_read_unlock();
    if (vcpu)
    return vcpu;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_irq_bypass_stop(cons: *mut irq_bypass_consumer) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_irq_bypass_start(cons: *mut irq_bypass_consumer) {
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn early_kvm_mode_cfg(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_kvm_wfx_trap_policy_cfg(arg: *mut c_char, p: *mut enum kvm_wfx_trap_policy) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_kvm_wfi_trap_policy_cfg(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_kvm_wfe_trap_policy_cfg(arg: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_get_mode() -> enum kvm_mode {
