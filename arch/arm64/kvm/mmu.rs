...
//
    ...
    phys_addr_t size)
    {
    let mut boundary: phys_addr_t = ALIGN_DOWN(addr + size, size);
    return (boundary - 1 < end - 1) ? boundary : end;
    }
#[no_mangle]
unsafe extern "C" fn stage2_range_addr_end(addr: phys_addr_t, end: phys_addr_t) -> phys_addr_t {
    static phys_addr_t stage2_range_addr_end(phys_addr_t addr, phys_addr_t end)
    {
    let mut size: phys_addr_t = kvm_granule_size(KVM_PGTABLE_MIN_BLOCK_LEVEL);
...
//
#[no_mangle]
unsafe extern "C" fn kvm_mmu_split_nr_page_tables(range: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn need_split_memcache_topup_or_resched(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn memslot_is_logging(memslot: *mut kvm_memory_slot) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_flush_remote_tlbs(kvm: *mut kvm) -> c_int {
    ...
    {
    let mut size: u64 = nr_pages << PAGE_SHIFT;
    let mut addr: u64 = gfn << PAGE_SHIFT;
    if (is_protected_kvm_enabled())
    kvm_call_hyp_nvhe(__pkvm_tlb_flush_vmid, kvm.arch.pkvm.handle);
    else
...
#[no_mangle]
unsafe extern "C" fn kvm_s2_free_pages_exact(virt: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn stage2_free_unlinked_table_rcu_cb(head: *mut rcu_head) {
    static void stage2_free_unlinked_table_rcu_cb(struct rcu_head *head)
    {
    struct page *page = container_of(head, struct page, rcu_head);
    void *pgtable = page_to_virt(page);
    let mut level: i8 = page_private(page);
    KVM_PGT_FN(kvm_pgtable_stage2_free_unlinked)(&kvm_s2_mm_ops, pgtable, level);
    }
#[no_mangle]
unsafe extern "C" fn stage2_free_unlinked_table(addr: *mut c_void, level: i8) {
...
#[no_mangle]
unsafe extern "C" fn kvm_host_get_page(addr: *mut c_void) {
    static void kvm_host_get_page(void *addr)
    {
    get_page(virt_to_page(addr));
    }
#[no_mangle]
unsafe extern "C" fn kvm_host_put_page(addr: *mut c_void) {
    static void kvm_host_put_page(void *addr)
    {
    put_page(virt_to_page(addr));
    }
#[no_mangle]
unsafe extern "C" fn kvm_s2_put_page(addr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kvm_host_page_count(addr: *mut c_void) -> c_int {
    static int kvm_host_page_count(void *addr)
    {
    return page_count(virt_to_page(addr));
    }
#[no_mangle]
unsafe extern "C" fn kvm_host_pa(addr: *mut c_void) -> phys_addr_t {
...
#[no_mangle]
unsafe extern "C" fn clean_dcache_guest_page(va: *mut c_void, size: usize) {
    static void clean_dcache_guest_page(void *va, size_t size)
    {
    __clean_dcache_guest_page(va, size);
    }
#[no_mangle]
unsafe extern "C" fn invalidate_icache_guest_page(va: *mut c_void, size: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_stage2_flush_range(mmu: *mut kvm_s2_mmu, addr: phys_addr_t, end: phys_addr_t) {
    ...
    {
    let mut addr: phys_addr_t = memslot.base_gfn << PAGE_SHIFT;
    let mut end: phys_addr_t = addr + PAGE_SIZE * memslot.npages;
...
//
#[no_mangle]
unsafe extern "C" fn stage2_flush_vm(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn free_hyp_pgds() -> void __init {
    ...
    kfree(hyp_pgtable);
    hyp_pgtable = core::ptr::null_mut();
    }
    mutex_unlock(&kvm_hyp_pgd_mutex);
    }
#[no_mangle]
unsafe extern "C" fn kvm_host_owns_hyp_mappings() -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_kaddr_to_phys(kaddr: *mut c_void) -> phys_addr_t {
...
pub struct hyp_shared_pfn {
    ...
    let mut hyp_shared_pfns: static struct rb_root = RB_ROOT;
...
// node = &((**node)->rb_left);
#[no_mangle]
pub unsafe extern "C" fn if(pfn: this->pfn >) -> else {
...
#[no_mangle]
unsafe extern "C" fn share_pfn_hyp(pfn: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unshare_pfn_hyp(pfn: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_share_hyp(from: *mut c_void, to: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_unshare_hyp(from: *mut c_void, to: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn create_hyp_mappings(from: *mut c_void, to: *mut c_void, prot: enum kvm_pgtable_prot) -> c_int {
    int create_hyp_mappings(void *from, void *to, enum kvm_pgtable_prot prot)
    {
    phys_addr_t phys_addr;
    unsigned long virt_addr;
    let mut start: c_ulong = kern_hyp_va((unsigned long)from);
    let mut end: c_ulong = kern_hyp_va((unsigned long)to);
    if (is_kernel_in_hyp_mode())
    return 0;
    if (!kvm_host_owns_hyp_mappings())
    return -EPERM;
...
#[no_mangle]
unsafe extern "C" fn __hyp_alloc_private_va_range(base: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hyp_alloc_private_va_range(size: usize, haddr: *mut c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn create_hyp_stack(phys_addr: phys_addr_t, haddr: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_user_mapping_size(kvm: *mut kvm, addr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_init_ipa_range(mmu: *mut kvm_s2_mmu, type: c_ulong) -> c_int {
    static int kvm_init_ipa_range(struct kvm_s2_mmu *mmu, unsigned long type)
    {
    let mut kvm_ipa_limit: u32 = get_kvm_ipa_limit();
    u64 mmfr0, mmfr1;
    u32 phys_shift;
...
#[no_mangle]
unsafe extern "C" fn kvm_stage2_destroy(pgt: *mut kvm_pgtable) {
    static void kvm_stage2_destroy(struct kvm_pgtable *pgt)
    {
    let mut ia_bits: c_uint = VTCR_EL2_IPA(pgt.mmu.vtcr);
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_init_stage2_mmu(kvm: *mut kvm, mmu: *mut kvm_s2_mmu, type: c_ulong) -> c_int {
...
// The eager page splitting is disabled by default
    ...
    mmu.pgt = core::ptr::null_mut();
    out_free_pgtable:
    kfree(pgt);
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_uninit_stage2_mmu(kvm: *mut kvm) {
    ...
    struct kvm_memory_slot *memslot)
    {
    let mut hva: hva_t = memslot.userspace_addr;
    let mut addr: phys_addr_t = memslot.base_gfn << PAGE_SHIFT;
    let mut size: phys_addr_t = PAGE_SIZE * memslot.npages;
    let mut reg_end: hva_t = hva + size;
//
...
//
    ...
    let mut gpa: gpa_t = addr + (vm_start - memslot.userspace_addr);
...
//
#[no_mangle]
pub unsafe extern "C" fn stage2_unmap_vm(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_free_stage2_pgd(mmu: *mut kvm_s2_mmu) {
    void kvm_free_stage2_pgd(struct kvm_s2_mmu *mmu)
    {
    struct kvm *kvm = kvm_s2_mmu_to_kvm(mmu);
    struct kvm_pgtable *pgt = core::ptr::null_mut();
    write_lock(&kvm.mmu_lock);
    pgt = mmu.pgt;
    if (pgt) {
    mmu.pgd_phys = 0;
...
#[no_mangle]
unsafe extern "C" fn hyp_mc_free_fn(addr: *mut c_void, mc: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn free_hyp_memcache(mc: *mut kvm_hyp_memcache) {
...
#[no_mangle]
pub unsafe extern "C" fn topup_hyp_memcache(mc: *mut kvm_hyp_memcache, min_pages: c_ulong) -> c_int {
...
//
    ...
    phys_addr_t addr;
    let mut ret: c_int = 0;
    let mut cache: kvm_mmu_memory_cache = { .gfp_zero = __GFP_ZERO };
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_stage2_wp_range(mmu: *mut kvm_s2_mmu, addr: phys_addr_t, end: phys_addr_t) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_mmu_wp_memory_region(kvm: *mut kvm, slot: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_mmu_split_memory_region(kvm: *mut kvm, slot: c_int) {
...
//
    ...
    {
    let mut base_gfn: phys_addr_t = slot.base_gfn + gfn_offset;
    let mut start: phys_addr_t = (base_gfn +  __ffs(mask)) << PAGE_SHIFT;
    let mut end: phys_addr_t = (base_gfn + __fls(mask) + 1) << PAGE_SHIFT;
    lockdep_assert_held_write(&kvm.mmu_lock);
    kvm_stage2_wp_range(&kvm.arch.mmu, start, end);
//
...
#[no_mangle]
unsafe extern "C" fn kvm_send_hwpoison_signal(address: c_ulong, lsb: c_short) {
...
//
    ...
    {
    let mut pfn: kvm_pfn_t = *pfnp;
    let mut gfn: gfn_t = *gfnp;
//
...
//
    ...
    let mut sz: c_int = get_user_mapping_size(kvm, hva);
    if (sz < 0)
    return sz;
    if (sz < PMD_SIZE)
    return PAGE_SIZE;
...
#[no_mangle]
unsafe extern "C" fn get_vma_page_shift(vma: *mut vm_area_struct, hva: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vma_mte_allowed(vma: *mut vm_area_struct) -> bool {
    static bool kvm_vma_mte_allowed(struct vm_area_struct *vma)
    {
    return vma.vm_flags & VM_MTE_ALLOWED;
    }
#[no_mangle]
unsafe extern "C" fn kvm_vma_is_cacheable(vma: *mut vm_area_struct) -> bool {
...
#[no_mangle]
unsafe extern "C" fn topup_mmu_memcache(vcpu: *mut kvm_vcpu, memcache: *mut c_void) -> c_int {
    static int topup_mmu_memcache(struct kvm_vcpu *vcpu, void *memcache)
    {
    let mut min_pages: c_int = kvm_mmu_cache_min_pages(vcpu.arch.hw_mmu);
    if (!is_protected_kvm_enabled())
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_s2_fault_desc {
    pub vcpu: *mut kvm_vcpu,
    pub fault_ipa: phys_addr_t,
    pub nested: *mut kvm_s2_trans,
    pub memslot: *mut kvm_memory_slot,
    pub hva: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn gmem_abort(s2fd: *const kvm_s2_fault_desc) -> c_int {
    static int gmem_abort(const struct kvm_s2_fault_desc *s2fd)
    {
    bool write_fault, exec_fault;
    let mut perm_fault: bool = kvm_vcpu_trap_is_permission_fault(s2fd.vcpu);
    let mut flags: enum kvm_pgtable_walk_flags = KVM_PGTABLE_WALK_SHARED;
    let mut prot: enum kvm_pgtable_prot = KVM_PGTABLE_PROT_R;
    struct kvm_pgtable *pgt = s2fd.vcpu.arch.hw_mmu.pgt;
    unsigned long mmu_seq;
    struct page *page;
    struct kvm *kvm = s2fd.vcpu.kvm;
    void *memcache = core::ptr::null_mut();
    kvm_pfn_t pfn;
    gfn_t gfn;
    int ret;
    if (!perm_fault) {
...
// Pairs with the smp_wmb() in kvm_mmu_invalidate_end().
    smp_rmb();
    ret = kvm_gmem_get_pfn(kvm, s2fd.memslot, gfn, &pfn, &page, core::ptr::null_mut());
    if (ret) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_s2_fault_vma_info {
    pub mmu_seq: c_ulong,
    pub vma_pagesize: c_long,
    pub vm_flags: vm_flags_t,
    pub max_map_size: c_ulong,
    pub page: *mut page,
    pub pfn: kvm_pfn_t,
    pub gfn: gfn_t,
    pub device: bool,
    pub mte_allowed: bool,
    pub is_vma_cacheable: bool,
    pub map_writable: bool,
    pub map_non_cacheable: bool,
}

#[no_mangle]
unsafe extern "C" fn pkvm_mem_abort(s2fd: *const kvm_s2_fault_desc) -> c_int {
    static int pkvm_mem_abort(const struct kvm_s2_fault_desc *s2fd)
    {
    let mut flags: c_uint = FOLL_HWPOISON | FOLL_LONGTERM | FOLL_WRITE;
...
#[no_mangle]
pub unsafe extern "C" fn if(PMD_SIZE: max_map_size >= PAGE_SIZE && max_map_size <) -> else {
...
#[no_mangle]
unsafe extern "C" fn kvm_s2_fault_is_perm(s2fd: *const kvm_s2_fault_desc) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpus_have_final_cap(ARM64_HAS_CACHE_DIC)) -> else {
...
// Check the VMM hasn't introduced a new disallowed VMA
    ...
    {
    let mut flags: enum kvm_pgtable_walk_flags = KVM_PGTABLE_WALK_SHARED;
    let mut writable: bool = prot & KVM_PGTABLE_PROT_W;
    struct kvm *kvm = s2fd.vcpu.kvm;
    struct kvm_pgtable *pgt;
...
//
    if (writable && !ret) {
    let mut ipa: phys_addr_t = gfn_to_gpa(get_canonical_gfn(s2fd, s2vi));
    ipa &= ~(mapping_size - 1);
...
#[no_mangle]
unsafe extern "C" fn user_mem_abort(s2fd: *const kvm_s2_fault_desc) -> c_int {
    static int user_mem_abort(const struct kvm_s2_fault_desc *s2fd)
    {
    let mut perm_fault: bool = kvm_vcpu_trap_is_permission_fault(s2fd.vcpu);
    let mut s2vi: kvm_s2_fault_vma_info = {};
    enum kvm_pgtable_prot prot;
    void *memcache;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn handle_access_fault(vcpu: *mut kvm_vcpu, fault_ipa: phys_addr_t) {
...
//
#[no_mangle]
unsafe extern "C" fn host_owns_sea(vcpu: *mut kvm_vcpu, esr: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_guest_sea(vcpu: *mut kvm_vcpu) -> c_int {
    int kvm_handle_guest_sea(struct kvm_vcpu *vcpu)
    {
    struct kvm *kvm = vcpu.kvm;
    struct kvm_run *run = vcpu.run;
    let mut esr: u64 = kvm_vcpu_get_esr(vcpu);
...
//
    ...
    if (apei_claim_sea(core::ptr::null_mut()) == 0)
    return 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_guest_abort(vcpu: *mut kvm_vcpu) -> c_int {
    int kvm_handle_guest_abort(struct kvm_vcpu *vcpu)
    {
    struct kvm_s2_trans nested_trans, *nested = core::ptr::null_mut();
    unsigned long esr;
...
pub unsafe extern "C" fn kvm_age_gfn(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
    ...
    {
    let mut size: u64 = (range.end - range.start) << PAGE_SHIFT;
    if (!kvm.arch.mmu.pgt || kvm_vm_is_protected(kvm))
    return false;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_get_httbr() -> phys_addr_t {
    phys_addr_t kvm_mmu_get_httbr(void)
    {
    return __pa(hyp_pgtable.pgd);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_get_idmap_vector() -> phys_addr_t {
    phys_addr_t kvm_get_idmap_vector(void)
    {
    return hyp_idmap_vector;
    }
#[no_mangle]
unsafe extern "C" fn kvm_map_idmap_text() -> c_int {
    static int kvm_map_idmap_text(void)
    {
    let mut size: c_ulong = hyp_idmap_end - hyp_idmap_start;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmu_init(hyp_va_bits: u32) -> int __init {
...
//
    ...
    {
    let mut log_dirty_pages: bool = new && new.flags & KVM_MEM_LOG_DIRTY_PAGES;
//
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_free_memslot(kvm: *mut kvm, slot: *mut kvm_memory_slot) {
    void kvm_arch_free_memslot(struct kvm *kvm, struct kvm_memory_slot *slot)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_memslots_updated(kvm: *mut kvm, gen: u64) {
    ...
    struct kvm_memory_slot *slot)
    {
    let mut gpa: gpa_t = slot.base_gfn << PAGE_SHIFT;
    let mut size: phys_addr_t = slot.npages << PAGE_SHIFT;
    write_lock(&kvm.mmu_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_set_way_flush(vcpu: *mut kvm_vcpu) {
    void kvm_set_way_flush(struct kvm_vcpu *vcpu)
    {
    let mut hcr: c_ulong = *vcpu_hcr(vcpu);
//
...
#[no_mangle]
pub unsafe extern "C" fn kvm_toggle_cache(vcpu: *mut kvm_vcpu, was_enabled: bool) {
    void kvm_toggle_cache(struct kvm_vcpu *vcpu, bool was_enabled)
    {
    let mut now_enabled: bool = vcpu_has_cache_enabled(vcpu);
//
