...
//! Source: arch/arm64/kvm/hyp/aarch32.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_condition_valid32(vcpu: *const kvm_vcpu) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_adjust_itstate(vcpu: *mut kvm_vcpu) {
    static void kvm_adjust_itstate(struct kvm_vcpu *vcpu)
    {
    unsigned long itbits, cond;
    let mut cpsr: c_ulong = *vcpu_cpsr(vcpu);
    let mut is_arm: bool = !(cpsr & PSR_AA32_T_BIT);
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_skip_instr32(vcpu: *mut kvm_vcpu) {
    void kvm_skip_instr32(struct kvm_vcpu *vcpu)
    {
    let mut pc: u32 = *vcpu_pc(vcpu);
    bool is_thumb;
