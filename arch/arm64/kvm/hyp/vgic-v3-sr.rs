...
//! Source: arch/arm64/kvm/hyp/vgic-v3-sr.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __gic_v3_get_lr(lr: c_uint) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn __gic_v3_set_lr(val: u64, lr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_ap0rn(val: u32, n: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_ap1rn(val: u32, n: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_ap0rn(n: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_ap1rn(n: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn compute_ich_hcr(cpu_if: *mut vgic_v3_cpu_if) -> u64 {
    static u64 compute_ich_hcr(struct vgic_v3_cpu_if *cpu_if)
    {
    return cpu_if.vgic_hcr | vgic_ich_hcr_trap_bits();
    }
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_save_state(cpu_if: *mut vgic_v3_cpu_if) {
    void __vgic_v3_save_state(struct vgic_v3_cpu_if *cpu_if)
    {
    let mut used_lrs: u64 = cpu_if.used_lrs;
//
...
//
    ...
    let mut val: u64 = read_gicreg(ICH_HCR_EL2);
...
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_restore_state(cpu_if: *mut vgic_v3_cpu_if) {
...
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_activate_traps(cpu_if: *mut vgic_v3_cpu_if) {
...
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_deactivate_traps(cpu_if: *mut vgic_v3_cpu_if) {
...
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_save_aprs(cpu_if: *mut vgic_v3_cpu_if) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_restore_aprs(cpu_if: *mut vgic_v3_cpu_if) {
...
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_init_lrs() {
    void __vgic_v3_init_lrs(void)
    {
    let mut max_lr_idx: c_int = vtr_to_max_lr_idx(vgic_ich_vtr());
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_get_gic_config() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_compat_mode_enable() {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_vmcr() -> u64 {
    static u64 __vgic_v3_read_vmcr(void)
    {
    return read_gicreg(ICH_VMCR_EL2);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_vmcr(vmcr: u32) {
    static void __vgic_v3_write_vmcr(u32 vmcr)
    {
    write_gicreg(vmcr, ICH_VMCR_EL2);
    }
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_restore_vmcr_aprs(cpu_if: *mut vgic_v3_cpu_if) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_bpr_min() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_get_group(vcpu: *mut kvm_vcpu) -> c_int {
    static int __vgic_v3_get_group(struct kvm_vcpu *vcpu)
    {
    let mut esr: u64 = kvm_vcpu_get_esr(vcpu);
    let mut crm: u8 = (esr & ESR_ELx_SYS64_ISS_CRM_MASK) >> ESR_ELx_SYS64_ISS_CRM_SHIFT;
    return crm != 8;
    }
pub const GICv3_IDLE_PRIORITY: c_uint = 0xff;
    static int __vgic_v3_highest_priority_lr(struct kvm_vcpu *vcpu, u32 vmcr,
    u64 *lr_val)
    {
    let mut used_lrs: c_uint = vcpu.arch.vgic_cpu.vgic_v3.used_lrs;
    let mut priority: u8 = GICv3_IDLE_PRIORITY;
    int i, lr = -1;
    for (i = 0; i < used_lrs; i++) {
    let mut val: u64 = __gic_v3_get_lr(i);
    let mut lr_prio: u8 = (val & ICH_LR_PRIORITY_MASK) >> ICH_LR_PRIORITY_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_get_highest_active_priority() -> c_int {
    static int __vgic_v3_get_highest_active_priority(void)
    {
    let mut nr_apr_regs: u8 = vtr_to_nr_apr_regs(vgic_ich_vtr());
    let mut hap: u32 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_get_bpr0(vmcr: u32) -> c_uint {
    static unsigned int __vgic_v3_get_bpr0(u32 vmcr)
    {
    return FIELD_GET(ICH_VMCR_EL2_VBPR0, vmcr);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_get_bpr1(vmcr: u32) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn __vgic_v3_pri_to_pre(pri: u8, vmcr: u32, grp: c_int) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn __vgic_v3_set_active_priority(pri: u8, vmcr: u32, grp: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_clear_highest_active_priority() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_iar(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_clear_active_lr(lr: c_int, lr_val: u64) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_bump_eoicount() {
...
#[no_mangle]
unsafe extern "C" fn ___vgic_v3_write_dir(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) -> c_int {
    static int ___vgic_v3_write_dir(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    let mut vid: u32 = vcpu_get_reg(vcpu, rt);
    u64 lr_val;
    int lr;
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_dir(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_eoir(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_igrpen0(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_read_igrpen0(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    vcpu_set_reg(vcpu, rt, FIELD_GET(ICH_VMCR_EL2_VENG0, vmcr));
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_igrpen1(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_read_igrpen1(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    vcpu_set_reg(vcpu, rt, FIELD_GET(ICH_VMCR_EL2_VENG1, vmcr));
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_igrpen0(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_write_igrpen0(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    let mut val: u64 = vcpu_get_reg(vcpu, rt);
    FIELD_MODIFY(ICH_VMCR_EL2_VENG0, &vmcr, val & 1);
    __vgic_v3_write_vmcr(vmcr);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_igrpen1(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_bpr0(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_read_bpr0(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    vcpu_set_reg(vcpu, rt, __vgic_v3_get_bpr0(vmcr));
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_bpr1(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_read_bpr1(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    vcpu_set_reg(vcpu, rt, __vgic_v3_get_bpr1(vmcr));
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_bpr0(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_write_bpr0(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    let mut val: u64 = vcpu_get_reg(vcpu, rt);
    let mut bpr_min: u8 = __vgic_v3_bpr_min() - 1;
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_bpr1(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_write_bpr1(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    let mut val: u64 = vcpu_get_reg(vcpu, rt);
    let mut bpr_min: u8 = __vgic_v3_bpr_min();
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_apxrn(vcpu: *mut kvm_vcpu, rt: c_int, n: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_apxrn(vcpu: *mut kvm_vcpu, rt: c_int, n: c_int) {
    static void __vgic_v3_write_apxrn(struct kvm_vcpu *vcpu, int rt, int n)
    {
    let mut val: u32 = vcpu_get_reg(vcpu, rt);
    if (!__vgic_v3_get_group(vcpu))
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_apxr2(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_read_apxr2(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    __vgic_v3_read_apxrn(vcpu, rt, 2);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_apxr3(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_read_apxr3(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    __vgic_v3_read_apxrn(vcpu, rt, 3);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_apxr0(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_write_apxr0(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    __vgic_v3_write_apxrn(vcpu, rt, 0);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_apxr1(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_write_apxr1(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    __vgic_v3_write_apxrn(vcpu, rt, 1);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_apxr2(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_write_apxr2(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    __vgic_v3_write_apxrn(vcpu, rt, 2);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_apxr3(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_write_apxr3(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    __vgic_v3_write_apxrn(vcpu, rt, 3);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_hppir(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_pmr(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_read_pmr(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    vcpu_set_reg(vcpu, rt, FIELD_GET(ICH_VMCR_EL2_VPMR, vmcr));
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_pmr(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_rpr(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
    static void __vgic_v3_read_rpr(struct kvm_vcpu *vcpu, u32 vmcr, int rt)
    {
    let mut val: u32 = __vgic_v3_get_highest_active_priority();
    vcpu_set_reg(vcpu, rt, val);
    }
#[no_mangle]
unsafe extern "C" fn __vgic_v3_read_ctlr(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __vgic_v3_write_ctlr(vcpu: *mut kvm_vcpu, vmcr: u32, rt: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn __vgic_v3_perform_cpuif_access(vcpu: *mut kvm_vcpu) -> c_int {
