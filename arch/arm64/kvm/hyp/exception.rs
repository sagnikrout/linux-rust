...
//! Source: arch/arm64/kvm/hyp/exception.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __vcpu_write_spsr_abt(vcpu: *mut kvm_vcpu, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn __vcpu_write_spsr_und(vcpu: *mut kvm_vcpu, val: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn if(target_mode: (mode | PSR_MODE_THREAD_BIT) ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn get_except32_cpsr(vcpu: *mut kvm_vcpu, mode: u32) -> c_ulong {
    static unsigned long get_except32_cpsr(struct kvm_vcpu *vcpu, u32 mode)
    {
    let mut sctlr: u32 = vcpu_read_sys_reg(vcpu, SCTLR_EL1);
...
#[no_mangle]
unsafe extern "C" fn enter_exception32(vcpu: *mut kvm_vcpu, mode: u32, vect_offset: u32) {
    static void enter_exception32(struct kvm_vcpu *vcpu, u32 mode, u32 vect_offset)
    {
    let mut spsr: c_ulong = *vcpu_cpsr(vcpu);
    let mut is_thumb: bool = (spsr & PSR_AA32_T_BIT);
    let mut sctlr: u32 = vcpu_read_sys_reg(vcpu, SCTLR_EL1);
    u32 return_address;
...
#[no_mangle]
unsafe extern "C" fn kvm_inject_exception(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __kvm_adjust_pc(vcpu: *mut kvm_vcpu) {
