...
//! Source: arch/arm64/kvm/hyp/nvhe/switch.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __hyp_vgic_save_state(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __hyp_vgic_restore_state(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __pmu_switch_to_guest(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn __pmu_switch_to_host(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_pvm_sys64(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fixup_guest_exit(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_panic() -> asmlinkage void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_panic_bad_stack() -> asmlinkage void __noreturn {
