...
//! Source: arch/arm64/kvm/hyp/nvhe/setup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn divide_memory_pool(virt: *mut c_void, size: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkvm_create_host_sve_mappings() -> c_int {
    ...
    let mut pgt_size: c_ulong = hyp_s1_pgtable_pages() << PAGE_SHIFT;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn update_nvhe_init_params() {
...
#[no_mangle]
unsafe extern "C" fn hpool_get_page(addr: *mut c_void) {
    static void hpool_get_page(void *addr)
    {
    hyp_get_page(&hpool, addr);
    }
#[no_mangle]
unsafe extern "C" fn hpool_put_page(addr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fix_host_ownership() -> c_int {
    ...
    let mut start: u64 = (u64)hyp_phys_to_virt(reg.base);
...
#[no_mangle]
unsafe extern "C" fn fix_hyp_pgtable_refcnt() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_init_finalise() -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_init(phys: phys_addr_t, size: c_ulong, per_cpu_base: *mut c_ulong, hyp_va_bits: u32) -> c_int {
