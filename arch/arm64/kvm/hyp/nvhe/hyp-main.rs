...
//! Source: arch/arm64/kvm/hyp/nvhe/hyp-main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __hyp_sve_save_guest(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __hyp_sve_restore_host() {
...
#[no_mangle]
unsafe extern "C" fn fpsimd_sve_flush() {
    static void fpsimd_sve_flush(void)
    {
// host_data_ptr(fp_owner) = FP_STATE_HOST_OWNED;
    }
#[no_mangle]
unsafe extern "C" fn fpsimd_sve_sync(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn flush_hyp_vgic_state(hyp_vcpu: *mut pkvm_hyp_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn sync_hyp_vgic_state(hyp_vcpu: *mut pkvm_hyp_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn sync_debug_state(hyp_vcpu: *mut pkvm_hyp_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: kvm_host_owns_debug_regs(&hyp_vcpu->vcpu)) -> else {
    else if (kvm_host_owns_debug_regs(&hyp_vcpu.vcpu))
    host_vcpu.arch.external_debug_state = hyp_vcpu.vcpu.arch.external_debug_state;
    }
#[no_mangle]
unsafe extern "C" fn flush_hyp_vcpu(hyp_vcpu: *mut pkvm_hyp_vcpu) {
...
// __hyp_running_vcpu must be NULL in a guest context.
    hyp_vcpu.vcpu.arch.ctxt.__hyp_running_vcpu = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sync_hyp_vcpu(hyp_vcpu: *mut pkvm_hyp_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_vcpu_load(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_vcpu_put(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_vcpu_sync_state(host_ctxt: *mut kvm_cpu_context) {
    ...
    struct pkvm_hyp_vcpu *hyp_vcpu = core::ptr::null_mut();
    if (unlikely(is_protected_kvm_enabled())) {
    hyp_vcpu = pkvm_get_loaded_hyp_vcpu();
    if (!hyp_vcpu || hyp_vcpu.host_vcpu != host_vcpu) {
    hyp_vcpu = core::ptr::null_mut();
    host_vcpu = core::ptr::null_mut();
    }
    }
// hyp_vcpup = hyp_vcpu;
    return host_vcpu;
...
#[no_mangle]
unsafe extern "C" fn handle___kvm_vcpu_run(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn pkvm_refill_memcache(hyp_vcpu: *mut pkvm_hyp_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_donate_guest(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_share_guest(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_unshare_guest(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_relax_perms_guest(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_wrprotect_guest(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_test_clear_young_guest(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_mkyoung_guest(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___kvm_adjust_pc(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___kvm_flush_vm_context(host_ctxt: *mut kvm_cpu_context) {
    static void handle___kvm_flush_vm_context(struct kvm_cpu_context *host_ctxt)
    {
    __kvm_flush_vm_context();
    }
#[no_mangle]
unsafe extern "C" fn handle___kvm_tlb_flush_vmid_ipa(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___kvm_tlb_flush_vmid_ipa_nsh(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___kvm_tlb_flush_vmid(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_tlb_flush_vmid(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___kvm_flush_cpu_context(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___kvm_timer_set_cntvoff(host_ctxt: *mut kvm_cpu_context) {
    static void handle___kvm_timer_set_cntvoff(struct kvm_cpu_context *host_ctxt)
    {
    __kvm_timer_set_cntvoff(cpu_reg(host_ctxt, 1));
    }
#[no_mangle]
unsafe extern "C" fn handle___kvm_enable_ssbs(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___vgic_v3_get_gic_config(host_ctxt: *mut kvm_cpu_context) {
    static void handle___vgic_v3_get_gic_config(struct kvm_cpu_context *host_ctxt)
    {
    cpu_reg(host_ctxt, 1) = __vgic_v3_get_gic_config();
    }
#[no_mangle]
unsafe extern "C" fn handle___vgic_v3_init_lrs(host_ctxt: *mut kvm_cpu_context) {
    static void handle___vgic_v3_init_lrs(struct kvm_cpu_context *host_ctxt)
    {
    __vgic_v3_init_lrs();
    }
#[no_mangle]
unsafe extern "C" fn handle___vgic_v3_save_aprs(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___vgic_v3_restore_vmcr_aprs(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_init(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_cpu_set_vector(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_share_hyp(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_host_unshare_hyp(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_create_private_mapping(host_ctxt: *mut kvm_cpu_context) {
...
//
    unsigned long haddr;
    let mut err: c_int = __pkvm_create_private_mapping(phys, size, prot, &haddr);
    if (err)
    haddr = (unsigned long)ERR_PTR(err);
    cpu_reg(host_ctxt, 1) = haddr;
    }
#[no_mangle]
unsafe extern "C" fn handle___pkvm_prot_finalize(host_ctxt: *mut kvm_cpu_context) {
    static void handle___pkvm_prot_finalize(struct kvm_cpu_context *host_ctxt)
    {
    cpu_reg(host_ctxt, 1) = __pkvm_prot_finalize();
    }
#[no_mangle]
unsafe extern "C" fn handle___pkvm_reserve_vm(host_ctxt: *mut kvm_cpu_context) {
    static void handle___pkvm_reserve_vm(struct kvm_cpu_context *host_ctxt)
    {
    cpu_reg(host_ctxt, 1) = __pkvm_reserve_vm();
    }
#[no_mangle]
unsafe extern "C" fn handle___pkvm_unreserve_vm(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_init_vm(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_init_vcpu(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_vcpu_in_poison_fault(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_force_reclaim_guest_page(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_reclaim_dying_guest_page(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_start_teardown_vm(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___pkvm_finalize_teardown_vm(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___tracing_load(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___tracing_unload(host_ctxt: *mut kvm_cpu_context) {
    static void handle___tracing_unload(struct kvm_cpu_context *host_ctxt)
    {
    __tracing_unload();
    }
#[no_mangle]
unsafe extern "C" fn handle___tracing_enable(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___tracing_swap_reader(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___tracing_update_clock(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___tracing_reset(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___tracing_enable_event(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___tracing_write_event(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___vgic_v5_save_apr(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle___vgic_v5_restore_vmcr_apr(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle_host_hcall(host_ctxt: *mut kvm_cpu_context) {
    static void handle_host_hcall(struct kvm_cpu_context *host_ctxt)
    {
    DECLARE_REG(unsigned long, id, host_ctxt, 0);
    let mut hcall_min: c_ulong = 0, hcall_max = __KVM_HOST_SMCCC_FUNC_MAX;
    hcall_t hfn;
...
#[no_mangle]
unsafe extern "C" fn default_host_smc_handler(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
unsafe extern "C" fn handle_host_smc(host_ctxt: *mut kvm_cpu_context) {
    static void handle_host_smc(struct kvm_cpu_context *host_ctxt)
    {
    DECLARE_REG(u64, func_id, host_ctxt, 0);
    let mut esr: u64 = read_sysreg_el2(SYS_ESR);
    bool handled;
...
#[no_mangle]
pub unsafe extern "C" fn inject_host_exception(esr: u64) {
...
#[no_mangle]
unsafe extern "C" fn inject_host_undef64() {
...
#[no_mangle]
unsafe extern "C" fn handle_host_mte(esr: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn handle_trap(host_ctxt: *mut kvm_cpu_context) {
