...
//! Source: arch/arm64/kvm/hyp/nvhe/ffa.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_ffa_descriptor_buffer {
    pub buf: *mut c_void,
    pub len: usize,
}
...
#[no_mangle]
unsafe extern "C" fn ffa_to_smccc_error(res: *mut arm_smccc_1_2_regs, ffa_errno: u64) {
...
#[no_mangle]
unsafe extern "C" fn ffa_to_smccc_res_prop(res: *mut arm_smccc_1_2_regs, ret: c_int, prop: u64) {
...
#[no_mangle]
unsafe extern "C" fn ffa_to_smccc_res(res: *mut arm_smccc_1_2_regs, ret: c_int) {
...
#[no_mangle]
unsafe extern "C" fn is_ffa_call(func_id: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ffa_map_hyp_buffers(ffa_page_count: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ffa_unmap_hyp_buffers() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ffa_retrieve_req(res: *mut arm_smccc_1_2_regs, len: u32) {
...
#[no_mangle]
unsafe extern "C" fn ffa_rx_release(res: *mut arm_smccc_1_2_regs) {
...
//
    ...
    let mut sz: u64 = (u64)range.pg_cnt * FFA_PAGE_SIZE;
    let mut pfn: u64 = hyp_phys_to_pfn(range.address);
    ...
    u32 nranges)
    {
    let mut nshared: u32 = __ffa_host_share_ranges(ranges, nranges);
    let mut ret: c_int = 0;
    if (nshared != nranges) {
    ...
    u32 nranges)
    {
    let mut nunshared: u32 = __ffa_host_unshare_ranges(ranges, nranges);
    let mut ret: c_int = 0;
    ...
    let mut ret: c_int = FFA_RET_INVALID_PARAMETERS;
    u32 nr_ranges;
...
//
    ...
    let mut ret: c_int = 0;
    let mut mem_region_len: usize = FFA_MEM_REGION_SZ(hyp_ffa_version);
...
//
#[no_mangle]
unsafe extern "C" fn ffa_call_supported(func_id: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hyp_ffa_post_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_host_ffa_handler(host_ctxt: *mut kvm_cpu_context, func_id: u32) -> bool {
    bool kvm_host_ffa_handler(struct kvm_cpu_context *host_ctxt, u32 func_id)
    {
    let mut res: arm_smccc_1_2_regs = {0};
//
...
#[no_mangle]
pub unsafe extern "C" fn hyp_ffa_init(pages: *mut c_void) -> c_int {
