...
//! Source: arch/arm64/kvm/hyp/nvhe/psci-relay.c
#![no_std]
...
pub const PSCI_BOOT_ARGS_UNLOCKED: c_int = 0;
pub const PSCI_BOOT_ARGS_LOCKED: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn is_psci_0_1_call(func_id: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_psci_0_2_call(func_id: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn psci_forward(host_ctxt: *mut kvm_cpu_context) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn find_cpu_id(mpidr: u64) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn try_acquire_boot_args(args: *mut psci_boot_args) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn release_boot_args(args: *mut psci_boot_args) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn psci_cpu_on(func_id: u64, host_ctxt: *mut kvm_cpu_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psci_cpu_suspend(func_id: u64, host_ctxt: *mut kvm_cpu_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psci_system_suspend(func_id: u64, host_ctxt: *mut kvm_cpu_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __kvm_host_psci_cpu_entry(pc: c_ulong, r0: c_ulong) -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_host_psci_cpu_on_entry() -> asmlinkage void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_host_psci_cpu_resume_entry() -> asmlinkage void __noreturn {
...
#[no_mangle]
unsafe extern "C" fn psci_0_1_handler(func_id: u64, host_ctxt: *mut kvm_cpu_context) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn psci_0_2_handler(func_id: u64, host_ctxt: *mut kvm_cpu_context) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn psci_1_0_handler(func_id: u64, host_ctxt: *mut kvm_cpu_context) -> c_ulong {
