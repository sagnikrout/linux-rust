...
//! Source: arch/arm64/kvm/hyp/nvhe/pkvm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pkvm_vcpu_reset_hcr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn pvm_init_traps_hcr(vcpu: *mut kvm_vcpu) {
    static void pvm_init_traps_hcr(struct kvm_vcpu *vcpu)
    {
    struct kvm *kvm = vcpu.kvm;
    let mut val: u64 = vcpu.arch.hcr_el2;
...
#[no_mangle]
unsafe extern "C" fn pvm_init_traps_mdcr(vcpu: *mut kvm_vcpu) {
    static void pvm_init_traps_mdcr(struct kvm_vcpu *vcpu)
    {
    struct kvm *kvm = vcpu.kvm;
    let mut val: u64 = vcpu.arch.mdcr_el2;
...
//
#[no_mangle]
unsafe extern "C" fn pkvm_check_pvm_cpu_features(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pkvm_vcpu_init_traps(hyp_vcpu: *mut pkvm_hyp_vcpu) -> c_int {
...
//
pub const HANDLE_OFFSET: c_uint = 0x1000;
//
// Marks a reserved but not yet used entry in the VM table.
//

#[no_mangle]
unsafe extern "C" fn vm_handle_to_idx(handle: pkvm_handle_t) -> c_uint {
    static unsigned int vm_handle_to_idx(pkvm_handle_t handle)
    {
    return handle - HANDLE_OFFSET;
    }
#[no_mangle]
unsafe extern "C" fn idx_to_vm_handle(idx: c_uint) -> pkvm_handle_t {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_hyp_vm_table_init(tbl: *mut c_void) {
...
//
    ...
    {
    let mut idx: c_uint = vm_handle_to_idx(handle);
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_put_hyp_vcpu(hyp_vcpu: *mut pkvm_hyp_vcpu) {
    void pkvm_put_hyp_vcpu(struct pkvm_hyp_vcpu *hyp_vcpu)
    {
    struct pkvm_hyp_vm *hyp_vm = pkvm_hyp_vcpu_to_hyp_vm(hyp_vcpu);
    hyp_spin_lock(&vm_table_lock);
    hyp_vcpu.loaded_hyp_vcpu = core::ptr::null_mut();
    __this_cpu_write(loaded_hyp_vcpu, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn put_pkvm_hyp_vm(hyp_vm: *mut pkvm_hyp_vm) {
    ...
    hyp_vm = core::ptr::null_mut();
    }
    return hyp_vm;
    }
#[no_mangle]
unsafe extern "C" fn pkvm_init_features_from_host(hyp_vm: *mut pkvm_hyp_vm, host_kvm: *const kvm) {
    static void pkvm_init_features_from_host(struct pkvm_hyp_vm *hyp_vm, const struct kvm *host_kvm)
    {
    struct kvm *kvm = &hyp_vm.kvm;
    let mut host_arch_flags: c_ulong = READ_ONCE(host_kvm.arch.flags);
...
#[no_mangle]
unsafe extern "C" fn unpin_host_vcpu(host_vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn unpin_host_sve_state(hyp_vcpu: *mut pkvm_hyp_vcpu) {
    ...
    let mut idx: c_int = vm_handle_to_idx(handle);
...
#[no_mangle]
unsafe extern "C" fn pkvm_vcpu_init_sve(hyp_vcpu: *mut pkvm_hyp_vcpu, host_vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vm_copy_id_regs(hyp_vcpu: *mut pkvm_hyp_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkvm_vcpu_init_sysregs(hyp_vcpu: *mut pkvm_hyp_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_free_vm_table_entry() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn allocate_vm_table_entry() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn remove_vm_table_entry(handle: pkvm_handle_t) {
    static void remove_vm_table_entry(pkvm_handle_t handle)
    {
    hyp_assert_lock_held(&vm_table_lock);
    vm_table[vm_handle_to_idx(handle)] = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn pkvm_get_hyp_vm_size(nr_vcpus: c_uint) -> usize {
...
#[no_mangle]
unsafe extern "C" fn __unmap_donated_memory(va: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn unmap_donated_memory(va: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn unmap_donated_memory_noclear(va: *mut c_void, size: usize) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __pkvm_reserve_vm() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __pkvm_unreserve_vm(handle: pkvm_handle_t) {
...
#[no_mangle]
pub unsafe extern "C" fn teardown_selftest_vm() {
...
//
    ...
    {
    struct pkvm_hyp_vm *hyp_vm = core::ptr::null_mut();
    size_t vm_size, pgd_size;
    unsigned int nr_vcpus;
    pkvm_handle_t handle;
    void *pgd = core::ptr::null_mut();
    int ret;
...
//
    ...
    {
    let mut idx: c_uint = hyp_vcpu.vcpu.vcpu_idx;
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_reclaim_dying_guest_page(handle: pkvm_handle_t, gfn: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_start_teardown_vm(handle: pkvm_handle_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_finalize_teardown_vm(handle: pkvm_handle_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pkvm_memshare_page_req(vcpu: *mut kvm_vcpu, ipa: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn pkvm_memshare_call(ret: *mut u64, vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
    static bool pkvm_memshare_call(u64 *ret, struct kvm_vcpu *vcpu, u64 *exit_code)
    {
    struct pkvm_hyp_vcpu *hyp_vcpu;
    let mut ipa: u64 = smccc_get_arg1(vcpu);
    if (!PAGE_ALIGNED(ipa))
    goto out_guest;
...
#[no_mangle]
unsafe extern "C" fn pkvm_memunshare_call(ret: *mut u64, vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_pvm_hvc64(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
