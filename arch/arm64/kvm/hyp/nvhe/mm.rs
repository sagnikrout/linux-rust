...
//! Source: arch/arm64/kvm/hyp/nvhe/mm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __pkvm_alloc_private_va_range(start: c_ulong, size: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pkvm_alloc_private_va_range(size: usize, haddr: *mut c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_create_mappings_locked(from: *mut c_void, to: *mut c_void, prot: enum kvm_pgtable_prot) -> c_int {
    int pkvm_create_mappings_locked(void *from, void *to, enum kvm_pgtable_prot prot)
    {
    let mut start: c_ulong = (unsigned long)from;
    let mut end: c_ulong = (unsigned long)to;
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_create_mappings(from: *mut c_void, to: *mut c_void, prot: enum kvm_pgtable_prot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_back_vmemmap(back: phys_addr_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_cpu_set_vector(slot: enum arm64_hyp_spectre_vector) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_map_vectors() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fixmap_clear_slot(slot: *mut hyp_fixmap_slot) {
    static void fixmap_clear_slot(struct hyp_fixmap_slot *slot)
    {
    kvm_pte_t *ptep = slot.ptep;
    let mut addr: u64 = slot.addr;
    u32 level;
...
#[no_mangle]
pub unsafe extern "C" fn hyp_fixmap_unmap() {
...
#[no_mangle]
unsafe extern "C" fn create_fixmap_slot(addr: u64, cpu: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_fixblock_unmap() {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_create_fixmap() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_create_idmap(hyp_va_bits: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_create_stack(phys: phys_addr_t, haddr: *mut c_ulong) -> c_int {
...
// Refill our local memcache by popping pages from the one provided by the host.
    ...
    {
    let mut tmp: kvm_hyp_memcache = *host_mc;
    int ret;
