...
//! Source: arch/arm64/kvm/hyp/nvhe/mem_protect.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pkvm_sme_dvmsync_fw_call() {
...
#[no_mangle]
unsafe extern "C" fn guest_lock_component(vm: *mut pkvm_hyp_vm) {
...
#[no_mangle]
unsafe extern "C" fn guest_unlock_component(vm: *mut pkvm_hyp_vm) {
    static void guest_unlock_component(struct pkvm_hyp_vm *vm)
    {
    current_vm = core::ptr::null_mut();
    hyp_spin_unlock(&vm.lock);
    }
#[no_mangle]
unsafe extern "C" fn host_lock_component() {
    static void host_lock_component(void)
    {
    hyp_spin_lock(&host_mmu.lock);
    }
#[no_mangle]
unsafe extern "C" fn host_unlock_component() {
    static void host_unlock_component(void)
    {
    hyp_spin_unlock(&host_mmu.lock);
    }
#[no_mangle]
unsafe extern "C" fn hyp_lock_component() {
    static void hyp_lock_component(void)
    {
    hyp_spin_lock(&pkvm_pgd_lock);
    }
#[no_mangle]
unsafe extern "C" fn hyp_unlock_component() {
...
#[no_mangle]
unsafe extern "C" fn host_s2_get_page(addr: *mut c_void) {
    static void host_s2_get_page(void *addr)
    {
    hyp_get_page(&host_s2_pool, addr);
    }
#[no_mangle]
unsafe extern "C" fn host_s2_put_page(addr: *mut c_void) {
    static void host_s2_put_page(void *addr)
    {
    hyp_put_page(&host_s2_pool, addr);
    }
#[no_mangle]
unsafe extern "C" fn host_s2_free_unlinked_table(addr: *mut c_void, level: i8) {
    static void host_s2_free_unlinked_table(void *addr, s8 level)
    {
    kvm_pgtable_stage2_free_unlinked(&host_mmu.mm_ops, addr, level);
    }
#[no_mangle]
unsafe extern "C" fn prepare_s2_pool(pgt_pool_base: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_host_vtcr() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_host_prepare_stage2(pgt_pool_base: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn guest_s2_free_pages_exact(addr: *mut c_void, size: c_ulong) {
    static void guest_s2_free_pages_exact(void *addr, unsigned long size)
    {
    let mut order: u8 = get_order(size);
    unsigned int i;
    for (i = 0; i < (1 << order); i++)
...
#[no_mangle]
unsafe extern "C" fn guest_s2_get_page(addr: *mut c_void) {
    static void guest_s2_get_page(void *addr)
    {
    hyp_get_page(&current_vm.pool, addr);
    }
#[no_mangle]
unsafe extern "C" fn guest_s2_put_page(addr: *mut c_void) {
    ...
    while (size) {
    let mut map_size: usize = PAGE_SIZE;
    void *map;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_guest_prepare_stage2(vm: *mut pkvm_hyp_vm, pgd: *mut c_void) -> c_int {
    ...
    ret = __kvm_pgtable_stage2_init(mmu.pgt, mmu, &vm.mm_ops, 0, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn kvm_guest_destroy_stage2(vm: *mut pkvm_hyp_vm) {
...
#[no_mangle]
pub unsafe extern "C" fn reclaim_pgtable_pages(vm: *mut pkvm_hyp_vm, mc: *mut kvm_hyp_memcache) {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_prot_finalize() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn host_stage2_unmap_dev_all() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pfn_range_is_valid(pfn: u64, nr_pages: u64) -> bool {
    static bool pfn_range_is_valid(u64 pfn, u64 nr_pages)
    {
    let mut limit: u64 = BIT(kvm_phys_shift(&host_mmu.arch.mmu) - PAGE_SHIFT);
    return pfn < limit && ((limit - pfn) >= nr_pages);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_mem_range {
    pub start: u64,
    pub end: u64,
}
...
#[no_mangle]
pub unsafe extern "C" fn addr_is_memory(phys: phys_addr_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_in_mem_range(addr: u64, range: *mut kvm_mem_range) -> bool {
    static bool is_in_mem_range(u64 addr, struct kvm_mem_range *range)
    {
    return range.start <= addr && addr < range.end;
    }
#[no_mangle]
unsafe extern "C" fn check_range_allowed_memory(start: u64, end: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn range_is_memory(start: u64, end: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn host_stage2_adjust_range(addr: u64, range: *mut kvm_mem_range) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __host_update_page_state(addr: phys_addr_t, size: u64, state: enum pkvm_page_state) {
...
#[no_mangle]
pub unsafe extern "C" fn host_stage2_set_owner_locked(addr: phys_addr_t, size: u64, owner_id: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn host_stage2_encode_gfn_meta(vm: *mut pkvm_hyp_vm, gfn: u64) -> u64 {
    static u64 host_stage2_encode_gfn_meta(struct pkvm_hyp_vm *vm, u64 gfn)
    {
    let mut handle: pkvm_handle_t = vm.kvm.arch.pkvm.handle;
...
#[no_mangle]
unsafe extern "C" fn host_stage2_force_pte_cb(addr: u64, end: u64, prot: enum kvm_pgtable_prot) -> bool {
    static bool host_stage2_force_pte_cb(u64 addr, u64 end, enum kvm_pgtable_prot prot)
    {
//
...
#[no_mangle]
unsafe extern "C" fn host_stage2_idmap(addr: u64) -> c_int {
    static int host_stage2_idmap(u64 addr)
    {
    struct kvm_mem_range range;
    let mut is_memory: bool = !!find_mem_range(addr, &range);
    enum kvm_pgtable_prot prot;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn host_inject_mem_abort(host_ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ESR_ELx_EC_IABT_LOW: ec ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn handle_host_mem_abort(host_ctxt: *mut kvm_cpu_context) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct check_walk_data {
    pub desired: enum pkvm_page_state,
    pub addr): *mut *mut enum pkvm_page_state (get_page_state)(kvm_pte_t pte, u64,
}
    ...
    let mut ret: c_int = host_stage2_idmap_locked(addr, size, PKVM_HOST_MEM_PROT);
    if (ret)
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn __hyp_set_page_state_range(phys: phys_addr_t, size: u64, state: enum pkvm_page_state) {
...
#[no_mangle]
unsafe extern "C" fn __hyp_check_page_state_range(phys: phys_addr_t, size: u64, state: enum pkvm_page_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __hyp_check_page_count_range(phys: phys_addr_t, size: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn guest_pte_is_poisoned(pte: kvm_pte_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn guest_get_page_state(pte: kvm_pte_t, addr: u64) -> enum pkvm_page_state {
...
#[no_mangle]
unsafe extern "C" fn get_valid_guest_pte(vm: *mut pkvm_hyp_vm, ipa: u64, ptep: *mut kvm_pte_t, physp: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_vcpu_in_poison_fault(hyp_vcpu: *mut pkvm_hyp_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_share_hyp(pfn: u64) -> c_int {
    int __pkvm_host_share_hyp(u64 pfn)
    {
    let mut phys: u64 = hyp_pfn_to_phys(pfn);
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_guest_share_host(vcpu: *mut pkvm_hyp_vcpu, gfn: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_guest_unshare_host(vcpu: *mut pkvm_hyp_vcpu, gfn: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_unshare_hyp(pfn: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_donate_hyp(pfn: u64, nr_pages: u64) -> c_int {
    int __pkvm_host_donate_hyp(u64 pfn, u64 nr_pages)
    {
    let mut phys: u64 = hyp_pfn_to_phys(pfn);
    let mut size: u64 = PAGE_SIZE * nr_pages;
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_hyp_donate_host(pfn: u64, nr_pages: u64) -> c_int {
    int __pkvm_hyp_donate_host(u64 pfn, u64 nr_pages)
    {
    let mut phys: u64 = hyp_pfn_to_phys(pfn);
    let mut size: u64 = PAGE_SIZE * nr_pages;
    let mut virt: u64 = (u64)__hyp_va(phys);
    int ret;
    if (!pfn_range_is_valid(pfn, nr_pages))
    return -EINVAL;
    host_lock_component();
...
#[no_mangle]
pub unsafe extern "C" fn hyp_pin_shared_mem(from: *mut c_void, to: *mut c_void) -> c_int {
    int hyp_pin_shared_mem(void *from, void *to)
    {
    u64 cur, start = ALIGN_DOWN((u64)from, PAGE_SIZE);
    let mut end: u64 = PAGE_ALIGN((u64)to);
    let mut phys: u64 = __hyp_pa(start);
    let mut size: u64 = end - start;
    struct hyp_page *p;
    int ret;
    host_lock_component();
    hyp_lock_component();
...
#[no_mangle]
pub unsafe extern "C" fn hyp_unpin_shared_mem(from: *mut c_void, to: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_share_ffa(pfn: u64, nr_pages: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_unshare_ffa(pfn: u64, nr_pages: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __guest_check_transition_size(phys: u64, ipa: u64, nr_pages: u64, size: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hyp_poison_page(phys: phys_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_force_reclaim_page_guest(phys: phys_addr_t) -> c_int {
...
// We really shouldn't be allocating, so don't pass a memcache
    ret = kvm_pgtable_stage2_annotate(&vm.pgt, ipa, PAGE_SIZE, core::ptr::null_mut(),
    KVM_GUEST_INVALID_PTE_TYPE_POISONED,
    0);
    if (ret)
    goto unlock_guest;
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_reclaim_page_guest(gfn: u64, vm: *mut pkvm_hyp_vm) -> c_int {
    int __pkvm_host_reclaim_page_guest(u64 gfn, struct pkvm_hyp_vm *vm)
    {
    let mut ipa: u64 = hyp_pfn_to_phys(gfn);
    kvm_pte_t pte;
    u64 phys;
    int ret;
    host_lock_component();
...
//
#[no_mangle]
unsafe extern "C" fn __guest_check_pgtable_memcache(vcpu: *mut pkvm_hyp_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_donate_guest(pfn: u64, gfn: u64, vcpu: *mut pkvm_hyp_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __check_host_shared_guest(vm: *mut pkvm_hyp_vm, __phys: *mut u64, ipa: u64, size: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_unshare_guest(gfn: u64, nr_pages: u64, vm: *mut pkvm_hyp_vm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn assert_host_shared_guest(vm: *mut pkvm_hyp_vm, ipa: u64, size: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_relax_perms_guest(gfn: u64, vcpu: *mut pkvm_hyp_vcpu, prot: enum kvm_pgtable_prot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_wrprotect_guest(gfn: u64, nr_pages: u64, vm: *mut pkvm_hyp_vm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_test_clear_young_guest(gfn: u64, nr_pages: u64, mkold: bool, vm: *mut pkvm_hyp_vm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __pkvm_host_mkyoung_guest(gfn: u64, vcpu: *mut pkvm_hyp_vcpu) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pkvm_expected_state {
    pub host: enum pkvm_page_state,
    pub hyp: enum pkvm_page_state,
    pub /: *mut *mut enum pkvm_page_state guest[2]; / [ gfn, gfn + 1 ],
}
...
#[no_mangle]
pub unsafe extern "C" fn pkvm_ownership_selftest(base: *mut c_void) {
    void pkvm_ownership_selftest(void *base)
    {
    let mut prot: enum kvm_pgtable_prot = KVM_PGTABLE_PROT_RWX;
