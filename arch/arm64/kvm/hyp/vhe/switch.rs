...
//! Source: arch/arm64/kvm/hyp/vhe/switch.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __compute_hcr(vcpu: *mut kvm_vcpu) -> u64 {
...
//
    ...
    if (guest_hcr & HCR_NV) {
    let mut va: u64 = __fix_to_virt(vncr_fixmap(smp_processor_id()));
...
#[no_mangle]
unsafe extern "C" fn __activate_traps(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __deactivate_traps(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn __vcpu_load_activate_traps(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __vcpu_put_deactivate_traps(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_load_vhe(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_put_vhe(vcpu: *mut kvm_vcpu) {
    void kvm_vcpu_put_vhe(struct kvm_vcpu *vcpu)
    {
    __vcpu_put_deactivate_traps(vcpu);
    __vcpu_put_switch_sysregs(vcpu);
    host_data_ptr(host_ctxt).__hyp_running_vcpu = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_handle_timer(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_handle_eret(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_handle_tlbi_el2(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
//
    ...
    ret = __kvm_tlbi_s1e2(core::ptr::null_mut(), val, instr);
    if (ret)
    return false;
//
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_handle_cpacr_el1(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_handle_zcr_el2(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_handle_sysreg_vhe(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_hyp_handle_impdef(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
//
    ...
    [0 ... ESR_ELx_EC_MAX]		= core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn fixup_nv_guest_exit(vcpu: *mut kvm_vcpu) {
...
//
    ...
    let mut mode: u64 = *vcpu_cpsr(vcpu) & (PSR_MODE_MASK | PSR_MODE32_BIT);
    u64 hcr;
    switch (mode) {
    case PSR_MODE_EL1t:
    mode = PSR_MODE_EL2t;
...
#[no_mangle]
unsafe extern "C" fn fixup_guest_exit(vcpu: *mut kvm_vcpu, exit_code: *mut u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __kvm_vcpu_run_vhe(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_vcpu_run(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __hyp_call_panic(spsr: u64, elr: u64, par: u64) -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn hyp_panic() -> void __noreturn {
    void __noreturn hyp_panic(void)
    {
    let mut spsr: u64 = read_sysreg_el2(SYS_SPSR);
    let mut elr: u64 = read_sysreg_el2(SYS_ELR);
    let mut par: u64 = read_sysreg_par();
    __hyp_call_panic(spsr, elr, par);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_unexpected_el2_exception() -> asmlinkage void {
