...
//! Source: arch/arm64/kvm/hyp/vhe/sysreg-sr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __sysreg_save_vel2_state(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __sysreg_restore_vel2_state(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sysreg_save_host_state_vhe(ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
pub unsafe extern "C" fn sysreg_save_guest_state_vhe(ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
pub unsafe extern "C" fn sysreg_restore_host_state_vhe(ctxt: *mut kvm_cpu_context) {
...
#[no_mangle]
pub unsafe extern "C" fn sysreg_restore_guest_state_vhe(ctxt: *mut kvm_cpu_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __mpam_guest_load() {
    static inline void __mpam_guest_load(void)
    {
    let mut mask: u64 = MPAM0_EL1_PARTID_D | MPAM0_EL1_PARTID_I | MPAM0_EL1_PMG_D | MPAM0_EL1_PMG_I;
    if (system_supports_mpam()) {
    let mut val: u64 = (read_sysreg_s(SYS_MPAM0_EL1) & mask) | MPAM1_EL1_MPAMEN;
...
//
#[no_mangle]
pub unsafe extern "C" fn __vcpu_load_switch_sysregs(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __vcpu_put_switch_sysregs(vcpu: *mut kvm_vcpu) {
