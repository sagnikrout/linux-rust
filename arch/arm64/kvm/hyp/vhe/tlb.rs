...
//! Source: arch/arm64/kvm/hyp/vhe/tlb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn exit_vmid_context(cxt: *mut tlb_inv_context) {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_tlb_flush_vmid(mmu: *mut kvm_s2_mmu) {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_flush_cpu_context(mmu: *mut kvm_s2_mmu) {
...
#[no_mangle]
pub unsafe extern "C" fn __kvm_flush_vm_context() {
...
//
#[no_mangle]
pub unsafe extern "C" fn __kvm_tlbi_s1e2(mmu: *mut kvm_s2_mmu, va: u64, sys_encoding: u64) -> c_int {
