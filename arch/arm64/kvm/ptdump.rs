...
//! Source: arch/arm64/kvm/ptdump.c
#![no_std]
...
pub const MARKERS_LEN: c_int = 2;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct kvm_ptdump_guest_state {
    pub mmu: *mut kvm_s2_mmu,
    pub parser_state: ptdump_pg_state,
    pub ipa_marker: [addr_marker; MARKERS_LEN],
    pub level: [ptdump_pg_level; KVM_PGTABLE_MAX_LEVELS],
}
...
#[no_mangle]
unsafe extern "C" fn kvm_ptdump_build_levels(level: *mut ptdump_pg_level, start_lvl: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_ptdump_guest_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_ptdump_guest_open(m: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_ptdump_guest_close(m: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_pgtable_range_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_pgtable_levels_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_pgtable_range_open(m: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_pgtable_levels_open(m: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_pgtable_debugfs_close(m: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_nested_s2_ptdump_create_debugfs(mmu: *mut kvm_s2_mmu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_nested_s2_ptdump_remove_debugfs(mmu: *mut kvm_s2_mmu) {
    void kvm_nested_s2_ptdump_remove_debugfs(struct kvm_s2_mmu *mmu)
    {
    debugfs_remove(mmu.shadow_pt_debugfs_dentry);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_s2_ptdump_create_debugfs(kvm: *mut kvm) {
