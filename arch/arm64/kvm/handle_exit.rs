...
//! Source: arch/arm64/kvm/handle_exit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_guest_serror(vcpu: *mut kvm_vcpu, esr: u64) {
...
#[no_mangle]
unsafe extern "C" fn handle_hvc(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_smc(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_fpasimd(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_wfx(vcpu: *mut kvm_vcpu) -> c_int {
    static int kvm_handle_wfx(struct kvm_vcpu *vcpu)
    {
    let mut esr: u64 = kvm_vcpu_get_esr(vcpu);
    let mut is_wfe: bool = !!(esr & ESR_ELx_WFx_ISS_WFE);
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_guest_debug(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_unknown_ec(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn handle_sve(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_ptrauth(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_eret(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_svc(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_gcs(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_other(vcpu: *mut kvm_vcpu) -> c_int {
    static int handle_other(struct kvm_vcpu *vcpu)
    {
    bool allowed, fwd = is_nested_ctxt(vcpu);
    let mut hcrx: u64 = __vcpu_sys_reg(vcpu, HCRX_EL2);
    let mut esr: u64 = kvm_vcpu_get_esr(vcpu);
    let mut iss: u64 = ESR_ELx_ISS(esr);
...
#[no_mangle]
unsafe extern "C" fn kvm_get_exit_handler(vcpu: *mut kvm_vcpu) -> exit_handle_fn {
    static exit_handle_fn kvm_get_exit_handler(struct kvm_vcpu *vcpu)
    {
    let mut esr: u64 = kvm_vcpu_get_esr(vcpu);
    let mut esr_ec: u8 = ESR_ELx_EC(esr);
...
//
#[no_mangle]
unsafe extern "C" fn handle_trap_exceptions(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_exit(vcpu: *mut kvm_vcpu, exception_index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_exit_pkvm_state(vcpu: *mut kvm_vcpu, exception_index: c_int) {
    static void handle_exit_pkvm_state(struct kvm_vcpu *vcpu, int exception_index)
    {
    let mut exception_code: c_int = ARM_EXCEPTION_CODE(exception_index);
...
#[no_mangle]
pub unsafe extern "C" fn handle_exit_early(vcpu: *mut kvm_vcpu, exception_index: c_int) {
    void handle_exit_early(struct kvm_vcpu *vcpu, int exception_index)
    {
    handle_exit_pkvm_state(vcpu, exception_index);
    if (ARM_SERROR_PENDING(exception_index)) {
    if (this_cpu_has_cap(ARM64_HAS_RAS_EXTN)) {
    let mut disr: u64 = kvm_vcpu_get_disr(vcpu);
...
#[no_mangle]
unsafe extern "C" fn nvhe_hyp_panic_host_s2_disabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn print_nvhe_hyp_panic(name: *const c_char, panic_addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvm_nvhe_report_cfi_failure(panic_addr: u64) {
    ...
    u64 far, u64 hpfar) {
    let mut elr_in_kimg: u64 = __phys_to_kimg(elr_phys);
    let mut hyp_offset: u64 = elr_in_kimg - kaslr_offset() - elr_virt;
    let mut mode: u64 = spsr & PSR_MODE_MASK;
    let mut panic_addr: u64 = elr_virt + hyp_offset;
    if (mode != PSR_MODE_EL2t && mode != PSR_MODE_EL2h) {
    kvm_err("Invalid host exception to nVHE hyp!\n");
    } else if (ESR_ELx_EC(esr) == ESR_ELx_EC_BRK64 &&
    esr_brk_comment(esr) == BUG_BRK_IMM) {
    const char *file = core::ptr::null_mut();
