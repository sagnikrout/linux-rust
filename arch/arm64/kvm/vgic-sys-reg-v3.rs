...
//! Source: arch/arm64/kvm/vgic-sys-reg-v3.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_apr_reg(vcpu: *mut kvm_vcpu, val: u64, apr: u8, idx: u8) {
...
#[no_mangle]
unsafe extern "C" fn get_apr_reg(vcpu: *mut kvm_vcpu, apr: u8, idx: u8) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn attr_to_id(attr: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_has_cpu_sysregs_attr(vcpu: *mut kvm_vcpu, attr: *mut kvm_device_attr) -> c_int {
