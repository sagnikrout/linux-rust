...
//
#[no_mangle]
unsafe extern "C" fn kvm_psci_vcpu_suspend(vcpu: *mut kvm_vcpu) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_vcpu_on(source_vcpu: *mut kvm_vcpu) -> c_ulong {
    static unsigned long kvm_psci_vcpu_on(struct kvm_vcpu *source_vcpu)
    {
    struct vcpu_reset_state *reset_state;
    struct kvm *kvm = source_vcpu.kvm;
    struct kvm_vcpu *vcpu = core::ptr::null_mut();
    let mut ret: c_int = PSCI_RET_SUCCESS;
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_vcpu_affinity_info(vcpu: *mut kvm_vcpu) -> c_ulong {
    static unsigned long kvm_psci_vcpu_affinity_info(struct kvm_vcpu *vcpu)
    {
    let mut matching_cpus: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn kvm_prepare_system_event(vcpu: *mut kvm_vcpu, type: u32, flags: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_system_off(vcpu: *mut kvm_vcpu) {
    static void kvm_psci_system_off(struct kvm_vcpu *vcpu)
    {
    kvm_prepare_system_event(vcpu, KVM_SYSTEM_EVENT_SHUTDOWN, 0);
    }
#[no_mangle]
unsafe extern "C" fn kvm_psci_system_off2(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_system_reset(vcpu: *mut kvm_vcpu) {
    static void kvm_psci_system_reset(struct kvm_vcpu *vcpu)
    {
    kvm_prepare_system_event(vcpu, KVM_SYSTEM_EVENT_RESET, 0);
    }
#[no_mangle]
unsafe extern "C" fn kvm_psci_system_reset2(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_system_suspend(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_check_allowed_function(vcpu: *mut kvm_vcpu, fn: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_0_2_call(vcpu: *mut kvm_vcpu) -> c_int {
    static int kvm_psci_0_2_call(struct kvm_vcpu *vcpu)
    {
    let mut psci_fn: u32 = smccc_get_function(vcpu);
    unsigned long val;
    let mut ret: c_int = 1;
    switch (psci_fn) {
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_1_x_call(vcpu: *mut kvm_vcpu, minor: u32) -> c_int {
    static int kvm_psci_1_x_call(struct kvm_vcpu *vcpu, u32 minor)
    {
    let mut val: c_ulong = PSCI_RET_NOT_SUPPORTED;
    let mut psci_fn: u32 = smccc_get_function(vcpu);
    struct kvm *kvm = vcpu.kvm;
    u32 arg;
    let mut ret: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn kvm_psci_0_1_call(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_psci_call(vcpu: *mut kvm_vcpu) -> c_int {
    int kvm_psci_call(struct kvm_vcpu *vcpu)
    {
    let mut psci_fn: u32 = smccc_get_function(vcpu);
    let mut version: c_int = kvm_psci_version(vcpu);
    unsigned long val;
