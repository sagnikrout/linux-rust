...
#[no_mangle]
unsafe extern "C" fn check_update_reserved_vmid(vmid: u64, newvmid: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn new_vmid(kvm_vmid: *mut kvm_vmid) -> u64 {
    static u64 new_vmid(struct kvm_vmid *kvm_vmid)
    {
    let mut cur_idx: static u32 = 1;
    let mut vmid: u64 = atomic64_read(&kvm_vmid.id);
    let mut generation: u64 = atomic64_read(&vmid_generation);
    if (vmid != 0) {
    let mut newvmid: u64 = generation | (vmid & ~VMID_MASK);
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_vmid_clear_active() {
    void kvm_arm_vmid_clear_active(void)
    {
    atomic64_set(this_cpu_ptr(&active_vmids), VMID_ACTIVE_INVALID);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_vmid_update(kvm_vmid: *mut kvm_vmid) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_vmid_alloc_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_vmid_alloc_free() -> void __init {
