...
//! Source: arch/arm64/kvm/fpsimd.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_load_fp(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ctxflush_fp(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ctxsync_fp(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_put_fp(vcpu: *mut kvm_vcpu) {
