...
//! Source: arch/arm64/kvm/nested.c
#![no_std]
...
// The guest's VNCR_EL2
    pub gva: u64,
    pub wi: s1_walk_info,
    pub wr: s1_walk_result,
    pub hpa: u64,
    pub hpa_writable: bool,
// -1 when not mapped on a CPU
    pub cpu: core::sync::atomic::AtomicI32,
//
...
//
pub const S2_MMU_PER_VCPU: c_int = 2;
#[no_mangle]
pub unsafe extern "C" fn kvm_init_nested(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn init_nested_s2_mmu(kvm: *mut kvm, mmu: *mut kvm_s2_mmu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_init_nested(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compute_fsc(level: c_int, fsc: u32) -> u32 {
    static u32 compute_fsc(int level, u32 fsc)
    {
    return fsc | (level & 0x3);
    }
#[no_mangle]
unsafe extern "C" fn esr_s2_fault(vcpu: *mut kvm_vcpu, level: c_int, fsc: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ia_size(wi: *mut s2_walk_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_output_size(wi: *mut s2_walk_info, output: phys_addr_t) -> c_int {
    static int check_output_size(struct s2_walk_info *wi, phys_addr_t output)
    {
    let mut output_size: c_uint = wi.max_oa_bits;
...
//
    if (wi.be)
// desc = be64_to_cpu(( __be64)val);
    else
// desc = le64_to_cpu(( __le64)val);
    return 0;
    }
    ...
    {
    if (wi.be) {
    old = ( u64)cpu_to_be64(old);
    new = ( u64)cpu_to_be64(new);
    } else {
    old = ( u64)cpu_to_le64(old);
    new = ( u64)cpu_to_le64(new);
    }
...
#[no_mangle]
unsafe extern "C" fn has_tgran_2(mmfr0: u64, shift: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fallback_tgran2_shift(mmfr0: u64) -> c_uint {
    static unsigned int fallback_tgran2_shift(u64 mmfr0)
    {
    if (has_tgran_2(mmfr0, PAGE_SHIFT))
    return PAGE_SHIFT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_tgran_2(mmfr0, _arg: 12)) -> else {
    else if (has_tgran_2(mmfr0, 12))
    return 12;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_tgran_2(mmfr0, _arg: 14)) -> else {
    else if (has_tgran_2(mmfr0, 14))
    return 14;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: has_tgran_2(mmfr0, _arg: 16)) -> else {
...
#[no_mangle]
unsafe extern "C" fn vtcr_to_tg0_pgshift(kvm: *mut kvm, vtcr: u64) -> c_uint {
    static unsigned int vtcr_to_tg0_pgshift(struct kvm *kvm, u64 vtcr)
    {
    let mut tg0: u64 = FIELD_GET(VTCR_EL2_TG0_MASK, vtcr);
    let mut mmfr0: u64 = kvm_read_vm_id_reg(kvm, SYS_ID_AA64MMFR0_EL1);
    unsigned int shift;
    switch (tg0) {
...
#[no_mangle]
unsafe extern "C" fn vtcr_to_tg0_pgsize(kvm: *mut kvm, vtcr: u64) -> usize {
    static size_t vtcr_to_tg0_pgsize(struct kvm *kvm, u64 vtcr)
    {
    return BIT(vtcr_to_tg0_pgshift(kvm, vtcr));
    }
#[no_mangle]
unsafe extern "C" fn setup_s2_walk(vcpu: *mut kvm_vcpu, wi: *mut s2_walk_info) {
    static void setup_s2_walk(struct kvm_vcpu *vcpu, struct s2_walk_info *wi)
    {
    let mut vtcr: u64 = vcpu_read_sys_reg(vcpu, VTCR_EL2);
...
#[no_mangle]
unsafe extern "C" fn __ttl_to_size(ttl: u8) -> c_uint {
    static unsigned int __ttl_to_size(u8 ttl)
    {
    let mut level: c_int = ttl & 3;
    let mut gran: c_int = (ttl >> 2) & 3;
    let mut max_size: c_uint = 0;
    switch (gran) {
    case TLBI_TTL_TG_4K:
    switch (level) {
    case 0:
...
#[no_mangle]
unsafe extern "C" fn ttl_to_size(ttl: u8) -> c_uint {
    static unsigned int ttl_to_size(u8 ttl)
    {
    return __ttl_to_size(ttl) ?: SZ_1G;
    }
#[no_mangle]
unsafe extern "C" fn pgshift_level_to_ttl(shift: u16, level: i8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn get_guest_mapping_ttl(mmu: *mut kvm_s2_mmu, addr: u64) -> u8 {
    static u8 get_guest_mapping_ttl(struct kvm_s2_mmu *mmu, u64 addr)
    {
    let mut tg0_size: usize = vtcr_to_tg0_pgsize(kvm_s2_mmu_to_kvm(mmu), mmu.tlb_vtcr);
    u64 tmp, sz = 0;
    kvm_pte_t pte;
    u8 ttl, level;
...
#[no_mangle]
pub unsafe extern "C" fn compute_tlb_inval_range(mmu: *mut kvm_s2_mmu, val: u64) -> c_ulong {
...
// No TTL, check the shadow S2 for a hint
    let mut addr: u64 = (val & GENMASK_ULL(35, 0)) << 12;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_init_nested_s2_mmu(mmu: *mut kvm_s2_mmu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_load_hw_mmu(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn unmap_l1_vncr(vt: *mut vncr_tlb) -> c_int {
    static int unmap_l1_vncr(struct vncr_tlb *vt)
    {
    let mut cpu: c_int = atomic_xchg_relaxed(&vt.cpu, -1);
    if (cpu != -1)
    clear_fixmap(vncr_fixmap(cpu));
    return cpu;
    }
#[no_mangle]
unsafe extern "C" fn this_cpu_reset_vncr_fixmap(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_put_hw_mmu(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s2_handle_perm_fault(vcpu: *mut kvm_vcpu, trans: *mut kvm_s2_trans) -> c_int {
    int kvm_s2_handle_perm_fault(struct kvm_vcpu *vcpu, struct kvm_s2_trans *trans)
    {
    let mut forward_fault: bool = false;
    trans.esr = 0;
    ...
    let mut write_fault: bool = kvm_is_write_fault(vcpu);
...
#[no_mangle]
pub unsafe extern "C" fn kvm_inject_s2_fault(vcpu: *mut kvm_vcpu, esr_el2: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_asid_by_regime(vcpu: *mut kvm_vcpu, regime: enum trans_regime) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn invalidate_vncr(kvm: *mut kvm, vt: *mut vncr_tlb) {
...
//
    ...
    (tlbp).valid)
#[no_mangle]
unsafe extern "C" fn kvm_invalidate_vncr_ipa(kvm: *mut kvm, start: u64, end: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_s1e2_tlbi(vcpu: *mut kvm_vcpu, inst: u32, val: u64) {
    void kvm_handle_s1e2_tlbi(struct kvm_vcpu *vcpu, u32 inst, u64 val)
    {
    let mut scope: s1e2_tlbi_scope = {};
    compute_s1_tlbi_range(vcpu, inst, val, &scope);
    guard(write_lock)(&vcpu.kvm.mmu_lock);
    invalidate_vncr_va(vcpu.kvm, &scope);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_nested_s2_wp(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_nested_s2_unmap(kvm: *mut kvm, may_block: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_nested_s2_flush(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_allocate_vncr_tlb(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_vncr_el2(vcpu: *mut kvm_vcpu) -> u64 {
    static u64 read_vncr_el2(struct kvm_vcpu *vcpu)
    {
    return (u64)sign_extend64(__vcpu_sys_reg(vcpu, VNCR_EL2), 48);
    }
#[no_mangle]
unsafe extern "C" fn kvm_translate_vncr(vcpu: *mut kvm_vcpu, is_gmem: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_vncr_perm(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_vncr_abort(vcpu: *mut kvm_vcpu) -> c_int {
    int kvm_handle_vncr_abort(struct kvm_vcpu *vcpu)
    {
    struct vncr_tlb *vt = vcpu.arch.vncr_tlb;
    let mut esr: u64 = kvm_vcpu_get_esr(vcpu);
    let mut is_gmem: bool = false;
    bool perm;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn kvm_map_l1_vncr(vcpu: *mut kvm_vcpu) {
...
// We cache the MMU state in the TLB. Check that it matches.
    ...
    prot = PAGE_KERNEL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vt->wr.pr) -> else {
    else if (vt.wr.pr)
    prot = PAGE_KERNEL_RO;
    else
    prot = PAGE_NONE;
...
//
#[no_mangle]
pub unsafe extern "C" fn limit_nv_id_reg(kvm: *mut kvm, reg: u32, val: u64) -> u64 {
    u64 limit_nv_id_reg(struct kvm *kvm, u32 reg, u64 val)
    {
    let mut orig_val: u64 = val;
    switch (reg) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpus_have_final_cap(ARM64_HAS_NV2P1)) -> else {
...
#[no_mangle]
unsafe extern "C" fn set_sysreg_masks(kvm: *mut kvm, sr: c_int, resx: resx) -> __always_inline void {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_init_nv_sysregs(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn check_nested_vcpu_requests(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_nested_flush_hwstate(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_nested_sync_hwstate(vcpu: *mut kvm_vcpu) {
...
//
    ...
    MDCR_EL2_TDOSA)
#[no_mangle]
pub unsafe extern "C" fn kvm_nested_setup_mdcr_el2(vcpu: *mut kvm_vcpu) {
    void kvm_nested_setup_mdcr_el2(struct kvm_vcpu *vcpu)
    {
    let mut guest_mdcr: u64 = __vcpu_sys_reg(vcpu, MDCR_EL2);
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !cpus_have_final_cap(ARM64_HAS_FGT)) -> else {
