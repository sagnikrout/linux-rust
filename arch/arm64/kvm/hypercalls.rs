...
//! Source: arch/arm64/kvm/hypercalls.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kvm_ptp_get_time(vcpu: *mut kvm_vcpu, val: *mut u64) {
    static void kvm_ptp_get_time(struct kvm_vcpu *vcpu, u64 *val)
    {
    struct system_time_snapshot systime_snapshot;
    let mut cycles: u64 = ~0UL;
    u32 feature;
//
...
#[no_mangle]
unsafe extern "C" fn kvm_smccc_default_allowed(func_id: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_smccc_test_fw_bmap(vcpu: *mut kvm_vcpu, func_id: u32) -> bool {
    ...
    0, ARM_SMCCC_FUNC_MASK)
#[no_mangle]
unsafe extern "C" fn kvm_smccc_filter_insert_reserved(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_smccc_filter_configured(kvm: *mut kvm) -> bool {
    static bool kvm_smccc_filter_configured(struct kvm *kvm)
    {
    return !mtree_empty(&kvm.arch.smccc_filter);
    }
#[no_mangle]
unsafe extern "C" fn kvm_smccc_set_filter(kvm: *mut kvm, uaddr: *mut kvm_smccc_filter __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_smccc_filter_get_action(kvm: *mut kvm, func_id: u32) -> u8 {
    static u8 kvm_smccc_filter_get_action(struct kvm *kvm, u32 func_id)
    {
    let mut idx: c_ulong = func_id;
    void *val;
    if (!kvm_smccc_filter_configured(kvm))
...
#[no_mangle]
unsafe extern "C" fn kvm_smccc_get_action(vcpu: *mut kvm_vcpu, func_id: u32) -> u8 {
...
//
    let mut action: u8 = kvm_smccc_filter_get_action(vcpu.kvm, func_id);
...
#[no_mangle]
unsafe extern "C" fn kvm_prepare_hypercall_exit(vcpu: *mut kvm_vcpu, func_id: u32) {
    static void kvm_prepare_hypercall_exit(struct kvm_vcpu *vcpu, u32 func_id)
    {
    let mut ec: u8 = ESR_ELx_EC(kvm_vcpu_get_esr(vcpu));
...
#[no_mangle]
pub unsafe extern "C" fn kvm_smccc_call_handler(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_init_hypercalls(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_teardown_hypercalls(kvm: *mut kvm) {
    void kvm_arm_teardown_hypercalls(struct kvm *kvm)
    {
    mtree_destroy(&kvm.arch.smccc_filter);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_get_fw_num_regs(vcpu: *mut kvm_vcpu) -> c_int {
    int kvm_arm_get_fw_num_regs(struct kvm_vcpu *vcpu)
    {
    return ARRAY_SIZE(kvm_arm_fw_reg_ids);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_copy_fw_reg_indices(vcpu: *mut kvm_vcpu, uindices: *mut u64 __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_kernel_wa_level(vcpu: *mut kvm_vcpu, regid: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_get_fw_reg(vcpu: *mut kvm_vcpu, reg: *const kvm_one_reg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_set_fw_reg_bmap(vcpu: *mut kvm_vcpu, reg_id: u64, val: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_set_fw_reg(vcpu: *mut kvm_vcpu, reg: *const kvm_one_reg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vm_smccc_has_attr(kvm: *mut kvm, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vm_smccc_set_attr(kvm: *mut kvm, attr: *mut kvm_device_attr) -> c_int {
