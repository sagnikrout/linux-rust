...
//! Source: arch/arm64/kvm/vgic/vgic-v4.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vgic_v4_doorbell_handler(irq: c_int, info: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vgic_v4_sync_sgi_config(vpe: *mut its_vpe, irq: *mut vgic_irq) {
...
#[no_mangle]
unsafe extern "C" fn vgic_v4_enable_vsgis(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn vgic_v4_disable_vsgis(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_configure_vsgis(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_get_vlpi_state(irq: *mut vgic_irq, val: *mut bool) {
    void vgic_v4_get_vlpi_state(struct vgic_irq *irq, bool *val)
    {
    struct its_vpe *vpe = &irq.target_vcpu.arch.vgic_cpu.vgic_v3.its_vpe;
    let mut mask: c_int = BIT(irq.intid % BITS_PER_BYTE);
    void *va;
    u8 *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_request_vpe_irq(vcpu: *mut kvm_vcpu, irq: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_init(kvm: *mut kvm) -> c_int {
    ...
    kvm_for_each_vcpu(i, vcpu, kvm) {
    let mut irq: c_int = dist.its_vm.vpes[i].irq;
    let mut irq_flags: c_ulong = DB_IRQ_FLAGS;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_teardown(kvm: *mut kvm) {
    ...
    let mut irq: c_int = its_vm.vpes[i].irq;
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_want_doorbell(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_put(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_load(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v4_commit(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vgic_v4_unset_forwarding(kvm: *mut kvm, host_irq: c_int) {
