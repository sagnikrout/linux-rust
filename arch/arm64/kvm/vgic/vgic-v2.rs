...
//! Source: arch/arm64/kvm/vgic/vgic-v2.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_write_lr(lr: c_int, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_init_lrs() {
...
#[no_mangle]
unsafe extern "C" fn lr_signals_eoi_mi(lr_val: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vgic_v2_fold_lr(vcpu: *mut kvm_vcpu, val: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_fold_lr_state(vcpu: *mut kvm_vcpu) {
    void vgic_v2_fold_lr_state(struct kvm_vcpu *vcpu)
    {
    struct vgic_cpu *vgic_cpu = &vcpu.arch.vgic_cpu;
    struct vgic_v2_cpu_if *cpuif = &vgic_cpu.vgic_v2;
    let mut eoicount: u32 = FIELD_GET(GICH_HCR_EOICOUNT, cpuif.vgic_hcr);
...
#[no_mangle]
unsafe extern "C" fn vgic_v2_compute_lr(vcpu: *mut kvm_vcpu, irq: *mut vgic_irq) -> u32 {
    static u32 vgic_v2_compute_lr(struct kvm_vcpu *vcpu, struct vgic_irq *irq)
    {
    let mut val: u32 = irq.intid;
    let mut allow_pending: bool = true;
    WARN_ON(irq.on_lr);
    if (irq.active) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_populate_lr(vcpu: *mut kvm_vcpu, irq: *mut vgic_irq, lr: c_int) {
    void vgic_v2_populate_lr(struct kvm_vcpu *vcpu, struct vgic_irq *irq, int lr)
    {
    let mut val: u32 = vgic_v2_compute_lr(vcpu, irq);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_clear_lr(vcpu: *mut kvm_vcpu, lr: c_int) {
    void vgic_v2_clear_lr(struct kvm_vcpu *vcpu, int lr)
    {
    vcpu.arch.vgic_cpu.vgic_v2.vgic_lr[lr] = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_set_vmcr(vcpu: *mut kvm_vcpu, vmcrp: *mut vgic_vmcr) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_get_vmcr(vcpu: *mut kvm_vcpu, vmcrp: *mut vgic_vmcr) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_reset(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn vgic_v2_check_base(dist_base: gpa_t, cpu_base: gpa_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_map_resources(kvm: *mut kvm) -> c_int {
...
//
    ...
    dist.cpuif_iodev.redist_vcpu = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_probe(info: *const gic_kvm_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn save_lrs(vcpu: *mut kvm_vcpu, base: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_save_state(vcpu: *mut kvm_vcpu) {
    void vgic_v2_save_state(struct kvm_vcpu *vcpu)
    {
    struct vgic_v2_cpu_if *cpu_if = &vcpu.arch.vgic_cpu.vgic_v2;
    void __iomem *base = kvm_vgic_global_state.vctrl_base;
    let mut used_lrs: u64 = vcpu.arch.vgic_cpu.vgic_v2.used_lrs;
    if (!base)
    return;
    ...
    let mut val: u32 = readl_relaxed(base + GICH_HCR);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_restore_state(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_load(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v2_put(vcpu: *mut kvm_vcpu) {
