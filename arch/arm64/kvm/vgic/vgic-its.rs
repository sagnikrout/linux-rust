...
//! Source: arch/arm64/kvm/vgic/vgic-its.c
#![no_std]
...
//
    ret = update_lpi_config(kvm, irq, core::ptr::null_mut(), false);
    if (ret) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vgic_its_abi {
    pub cte_esz: c_int,
    pub dte_esz: c_int,
    pub ite_esz: c_int,
    pub its): *mut *mut int (save_tables)(struct vgic_its,
    pub its): *mut *mut int (restore_tables)(struct vgic_its,
    pub its): *mut *mut void (commit)(struct vgic_its,
}

pub const ABI_0_ESZ: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn vgic_its_set_abi(its: *mut vgic_its, rev: u32) {
...
pub const GIC_LPI_OFFSET: c_int = 8192;
pub const VITS_TYPER_IDBITS: c_int = 16;

pub const VITS_TYPER_DEVBITS: c_int = 16;
...
//
    ...
    struct kvm_vcpu *filter_vcpu, bool needs_inv)
    {
    let mut propbase: u64 = GICR_PROPBASER_ADDRESS(kvm.arch.vgic.propbaser);
    u8 prop;
    int ret;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn update_affinity(irq: *mut vgic_irq, vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn update_affinity_ite(kvm: *mut kvm, ite: *mut its_ite) {
...
#[no_mangle]
unsafe extern "C" fn max_lpis_propbaser(propbaser: u64) -> u32 {
    static u32 max_lpis_propbaser(u64 propbaser)
    {
    let mut nr_idbits: c_int = (propbaser & 0x1f) + 1;
...
//
#[no_mangle]
unsafe extern "C" fn its_sync_lpi_pending_table(vcpu: *mut kvm_vcpu) -> c_int {
    static int its_sync_lpi_pending_table(struct kvm_vcpu *vcpu)
    {
    let mut pendbase: gpa_t = GICR_PENDBASER_ADDRESS(vcpu.arch.vgic_cpu.pendbaser);
    struct vgic_dist *dist = &vcpu.kvm.arch.vgic;
    unsigned long intid, flags;
    struct vgic_irq *irq;
    let mut last_byte_offset: c_int = -1;
    let mut ret: c_int = 0;
    u8 pendmask;
...
//
    ...
    let mut reg: u64 = GITS_TYPER_PLPIS;
//
...
//
    ...
    unsigned long val)
    {
    let mut rev: u32 = GITS_IIDR_REV(val);
    if (rev >= NR_ITS_ABIS)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn vgic_its_cache_key(devid: u32, eventid: u32) -> c_ulong {
    ...
    {
    let mut cache_key: c_ulong = vgic_its_cache_key(devid, eventid);
    struct vgic_its *its;
    struct vgic_irq *irq;
...
#[no_mangle]
unsafe extern "C" fn vgic_its_invalidate_cache(its: *mut vgic_its) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_its_invalidate_all_caches(kvm: *mut kvm) {
...
//
    ...
    u32 devid, u32 eventid)
    {
    struct vgic_irq *irq = core::ptr::null_mut();
    unsigned long flags;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn vgic_its_inject_cached_translation(kvm: *mut kvm, msi: *mut kvm_msi) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_its_inject_msi(kvm: *mut kvm, msi: *mut kvm_msi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_free_ite(kvm: *mut kvm, ite: *mut its_ite) {
...
#[no_mangle]
unsafe extern "C" fn its_cmd_mask_field(its_cmd: *mut u64, word: c_int, shift: c_int, size: c_int) -> u64 {
...
//
    ...
    u64 *its_cmd)
    {
    let mut device_id: u32 = its_cmd_get_deviceid(its_cmd);
    let mut event_id: u32 = its_cmd_get_id(its_cmd);
    struct its_ite *ite;
    ite = find_ite(its, device_id, event_id);
    if (ite && its_is_collection_mapped(ite.collection)) {
    struct its_device *device = find_its_device(its, device_id);
    let mut ite_esz: c_int = vgic_its_get_abi(its).ite_esz;
    let mut gpa: gpa_t = device.itt_addr + ite.event_id * ite_esz;
//
...
//
    ...
    let mut device_id: u32 = its_cmd_get_deviceid(its_cmd);
    let mut event_id: u32 = its_cmd_get_id(its_cmd);
    let mut coll_id: u32 = its_cmd_get_collection(its_cmd);
    struct kvm_vcpu *vcpu;
    struct its_ite *ite;
    struct its_collection *collection;
    ite = find_ite(its, device_id, event_id);
...
#[no_mangle]
unsafe extern "C" fn __is_visible_gfn_locked(its: *mut vgic_its, gpa: gpa_t) -> bool {
...
//
    ...
    gpa_t *eaddr)
    {
    let mut l1_tbl_size: c_int = GITS_BASER_NR_PAGES(baser) * SZ_64K;
    u64 indirect_ptr, type = GITS_BASER_TYPE(baser);
    let mut base: phys_addr_t = GITS_BASER_ADDR_48_to_52(baser);
    let mut esz: c_int = GITS_BASER_ENTRY_SIZE(baser);
    int index;
    switch (type) {
...
//
    ...
    {
    const struct vgic_its_abi *abi = vgic_its_get_abi(its);
    let mut ite_esz: c_int = abi.ite_esz;
    gpa_t gpa;
...
#[no_mangle]
unsafe extern "C" fn vgic_its_free_collection(its: *mut vgic_its, coll_id: u32) {
...
//
    ...
    ite.collection = core::ptr::null_mut();
...
//
    ...
    struct its_device *device;
    struct its_collection *collection, *new_coll = core::ptr::null_mut();
    struct vgic_irq *irq;
    int lpi_nr;
    device = find_its_device(its, device_id);
    if (!device)
...
// If there is an existing mapping, behavior is UNPREDICTABLE.
    ...
    if (!collection) {
    int ret;
    if (!vgic_its_check_id(its, its.baser_coll_table, coll_id, core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn vgic_its_free_device_list(kvm: *mut kvm, its: *mut vgic_its) {
...
// its lock must be held
#[no_mangle]
unsafe extern "C" fn vgic_its_free_collection_list(kvm: *mut kvm, its: *mut vgic_its) {
...
//
    ...
    {
    let mut device_id: u32 = its_cmd_get_deviceid(its_cmd);
    let mut valid: bool = its_cmd_get_validbit(its_cmd);
    let mut num_eventid_bits: u8 = its_cmd_get_size(its_cmd);
    let mut itt_addr: gpa_t = its_cmd_get_ittaddr(its_cmd);
    struct its_device *device;
    gpa_t gpa;
...
#[no_mangle]
pub unsafe extern "C" fn vgic_its_inv_lpi(kvm: *mut kvm, irq: *mut vgic_irq) -> c_int {
    int vgic_its_inv_lpi(struct kvm *kvm, struct vgic_irq *irq)
    {
    return update_lpi_config(kvm, irq, core::ptr::null_mut(), true);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_its_invall(vcpu: *mut kvm_vcpu) -> c_int {
...
//
    ...
    u64 *its_cmd)
    {
    let mut msi_data: u32 = its_cmd_get_id(its_cmd);
    let mut msi_devid: u64 = its_cmd_get_deviceid(its_cmd);
...
#[no_mangle]
unsafe extern "C" fn vgic_sanitise_its_baser(reg: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vgic_sanitise_its_cbaser(reg: u64) -> u64 {
...
pub const ITS_CMD_SIZE: c_int = 32;

// Must be called with the cmd_lock held.
#[no_mangle]
unsafe extern "C" fn vgic_its_process_commands(kvm: *mut kvm, its: *mut vgic_its) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_enable_lpis(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn vgic_its_create(dev: *mut kvm_device, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgic_its_destroy(kvm_dev: *mut kvm_device) {
    ...
    let mut offset: gpa_t = attr.attr;
    int align;
...
#[no_mangle]
unsafe extern "C" fn compute_next_eventid_offset(h: *mut list_head, ite: *mut its_ite) -> u32 {
...
//
    ...
    {
    struct kvm *kvm = its.dev.kvm;
    let mut len: c_ulong = size;
    let mut id: c_int = start_id;
    let mut gpa: gpa_t = base;
    char entry[ESZ_MAX];
    int ret;
    memset(entry, 0, esz);
    while (true) {
...
#[no_mangle]
unsafe extern "C" fn vgic_its_save_itt(its: *mut vgic_its, device: *mut its_device) -> c_int {
    static int vgic_its_save_itt(struct vgic_its *its, struct its_device *device)
    {
    const struct vgic_its_abi *abi = vgic_its_get_abi(its);
    let mut base: gpa_t = device.itt_addr;
    struct its_ite *ite;
    int ret;
    let mut ite_esz: c_int = abi.ite_esz;
    list_sort(core::ptr::null_mut(), &device.itt_head, vgic_its_ite_cmp);
    list_for_each_entry(ite, &device.itt_head, ite_list) {
    let mut gpa: gpa_t = base + ite.event_id * ite_esz;
//
...
//
#[no_mangle]
unsafe extern "C" fn vgic_its_restore_itt(its: *mut vgic_its, dev: *mut its_device) -> c_int {
    static int vgic_its_restore_itt(struct vgic_its *its, struct its_device *dev)
    {
    const struct vgic_its_abi *abi = vgic_its_get_abi(its);
    let mut base: gpa_t = dev.itt_addr;
    int ret;
    let mut ite_esz: c_int = abi.ite_esz;
    let mut max_size: usize = BIT_ULL(dev.num_eventid_bits) * ite_esz;
...
//
    ...
    {
    struct its_device *dev;
    let mut baser: u64 = its.baser_device_table;
    gpa_t itt_addr;
    u8 num_eventid_bits;
    let mut entry: u64 = *(u64 *)ptr;
    bool valid;
    u32 offset;
    int ret;
...
// Mimic the MAPD behaviour and reject invalid EID bits.
    ...
    return -EINVAL;
    if (!vgic_its_check_id(its, baser, id, core::ptr::null_mut()))
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn vgic_its_save_device_tables(its: *mut vgic_its) -> c_int {
    ...
    return 0;
    list_sort(core::ptr::null_mut(), &its.device_list, vgic_its_device_cmp);
    list_for_each_entry(dev, &its.device_list, dev_list) {
    int ret;
    gpa_t eaddr;
...
//
    ...
    {
    const struct vgic_its_abi *abi = vgic_its_get_abi(its);
    let mut l2_start_id: c_int = id * (SZ_64K / abi.dte_esz);
    let mut entry: u64 = *(u64 *)addr;
    let mut dte_esz: c_int = abi.dte_esz;
    gpa_t gpa;
    int ret;
    entry = le64_to_cpu(entry);
    ...
    l2_start_id, vgic_its_restore_dte, core::ptr::null_mut());
    return ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn vgic_its_restore_device_tables(its: *mut vgic_its) -> c_int {
    ...
    handle_l1_dte, core::ptr::null_mut());
    } else {
    l1_esz = abi.dte_esz;
    ret = scan_its_table(its, l1_gpa, l1_tbl_size, l1_esz, 0,
    vgic_its_restore_dte, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn vgic_its_restore_cte(its: *mut vgic_its, gpa: gpa_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vgic_its_save_collection_table(its: *mut vgic_its) -> c_int {
    static int vgic_its_save_collection_table(struct vgic_its *its)
    {
    const struct vgic_its_abi *abi = vgic_its_get_abi(its);
    let mut baser: u64 = its.baser_coll_table;
    let mut gpa: gpa_t = GITS_BASER_ADDR_48_to_52(baser);
    struct its_collection *collection;
    ...
    list_for_each_entry(collection, &its.collection_list, coll_list) {
    if (!vgic_its_check_id(its, baser, collection.collection_id, core::ptr::null_mut()))
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn vgic_its_restore_collection_table(its: *mut vgic_its) -> c_int {
    static int vgic_its_restore_collection_table(struct vgic_its *its)
    {
    const struct vgic_its_abi *abi = vgic_its_get_abi(its);
    let mut baser: u64 = its.baser_coll_table;
    let mut cte_esz: c_int = abi.cte_esz;
...
//
#[no_mangle]
unsafe extern "C" fn vgic_its_save_tables_v0(its: *mut vgic_its) -> c_int {
    static int vgic_its_save_tables_v0(struct vgic_its *its)
    {
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn vgic_its_restore_tables_v0(its: *mut vgic_its) -> c_int {
    static int vgic_its_restore_tables_v0(struct vgic_its *its)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn vgic_its_commit_v0(its: *mut vgic_its) {
    static void vgic_its_commit_v0(struct vgic_its *its)
    {
    const struct vgic_its_abi *abi;
    abi = vgic_its_get_abi(its);
...
#[no_mangle]
unsafe extern "C" fn vgic_its_reset(kvm: *mut kvm, its: *mut vgic_its) {
...
#[no_mangle]
unsafe extern "C" fn vgic_its_ctrl(kvm: *mut kvm, its: *mut vgic_its, attr: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_allow_write_without_running_vcpu(kvm: *mut kvm) -> bool {
    ...
    let mut type: c_ulong = (unsigned long)attr.attr;
    u64 addr;
    ...
    case KVM_DEV_ARM_VGIC_GRP_ADDR: {
    struct vgic_its *its = dev.private;
    let mut addr: u64 = its.vgic_its_base;
    u64 __user *uaddr = (u64 __user *)(long)attr.addr;
    let mut type: c_ulong = (unsigned long)attr.attr;
    if (type != KVM_VGIC_ITS_ADDR_TYPE)
    return -ENODEV;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vgic_register_its_device() -> c_int {
