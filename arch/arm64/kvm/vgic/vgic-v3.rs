...
//! Source: arch/arm64/kvm/vgic/vgic-v3.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lr_signals_eoi_mi(lr_val: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vgic_v3_fold_lr(vcpu: *mut kvm_vcpu, val: u64) {
    static void vgic_v3_fold_lr(struct kvm_vcpu *vcpu, u64 val)
    {
    struct vgic_irq *irq;
    let mut is_v2_sgi: bool = false;
    bool deactivated;
    u32 intid;
...
//
    ...
    if (is_v2_sgi) {
    let mut cpuid: u8 = FIELD_GET(GICH_LR_PHYSID_CPUID, val);
    if (irq.active)
...
#[no_mangle]
unsafe extern "C" fn vgic_v3_deactivate_phys(intid: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_fold_lr_state(vcpu: *mut kvm_vcpu) {
    void vgic_v3_fold_lr_state(struct kvm_vcpu *vcpu)
    {
    struct vgic_cpu *vgic_cpu = &vcpu.arch.vgic_cpu;
    struct vgic_v3_cpu_if *cpuif = &vgic_cpu.vgic_v3;
    let mut eoicount: u32 = FIELD_GET(ICH_HCR_EL2_EOIcount, cpuif.vgic_hcr);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_deactivate(vcpu: *mut kvm_vcpu, val: u64) {
    void vgic_v3_deactivate(struct kvm_vcpu *vcpu, u64 val)
    {
    struct vgic_cpu *vgic_cpu = &vcpu.arch.vgic_cpu;
    struct vgic_v3_cpu_if *cpuif = &vgic_cpu.vgic_v3;
    let mut model: u32 = vcpu.kvm.arch.vgic.vgic_model;
    struct kvm_vcpu *target_vcpu = core::ptr::null_mut();
    let mut mmio: bool = false, is_v2_sgi;
    struct vgic_irq *irq;
    unsigned long flags;
    let mut lr: u64 = 0;
    u8 cpuid;
...
#[no_mangle]
unsafe extern "C" fn vgic_v3_compute_lr(vcpu: *mut kvm_vcpu, irq: *mut vgic_irq) -> u64 {
    static u64 vgic_v3_compute_lr(struct kvm_vcpu *vcpu, struct vgic_irq *irq)
    {
    let mut model: u32 = vcpu.kvm.arch.vgic.vgic_model;
    let mut val: u64 = irq.intid;
    let mut allow_pending: bool = true, is_v2_sgi;
    WARN_ON(irq.on_lr);
...
//
    ...
    val |= ICH_LR_PENDING_BIT;
    if (is_v2_sgi) {
    let mut src: u32 = ffs(irq.source);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_populate_lr(vcpu: *mut kvm_vcpu, irq: *mut vgic_irq, lr: c_int) {
    void vgic_v3_populate_lr(struct kvm_vcpu *vcpu, struct vgic_irq *irq, int lr)
    {
    let mut model: u32 = vcpu.kvm.arch.vgic.vgic_model;
    let mut val: u64 = vgic_v3_compute_lr(vcpu, irq);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_clear_lr(vcpu: *mut kvm_vcpu, lr: c_int) {
    void vgic_v3_clear_lr(struct kvm_vcpu *vcpu, int lr)
    {
    vcpu.arch.vgic_cpu.vgic_v3.vgic_lr[lr] = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_set_vmcr(vcpu: *mut kvm_vcpu, vmcrp: *mut vgic_vmcr) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_get_vmcr(vcpu: *mut kvm_vcpu, vmcrp: *mut vgic_vmcr) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_reset(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vcpu_set_ich_hcr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_lpi_sync_pending_status(kvm: *mut kvm, irq: *mut vgic_irq) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn unmap_all_vpes(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn map_all_vpes(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_save_pending_tables(kvm: *mut kvm) -> c_int {
    int vgic_v3_save_pending_tables(struct kvm *kvm)
    {
    struct vgic_dist *dist = &kvm.arch.vgic;
    struct vgic_irq *irq;
    let mut last_ptr: gpa_t = ~(gpa_t)0;
    let mut vlpi_avail: bool = false;
    unsigned long index;
    let mut ret: c_int = 0;
    u8 val;
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_rdist_overlap(kvm: *mut kvm, base: gpa_t, size: usize) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_check_base(kvm: *mut kvm) -> bool {
    ...
    return false;
    list_for_each_entry(rdreg, &d.rd_regions, list) {
    let mut sz: usize = vgic_v3_rd_region_size(kvm, rdreg);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_map_resources(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn early_group0_trap_cfg(buf: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_group1_trap_cfg(buf: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_common_trap_cfg(buf: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_gicv4_enable(buf: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vgic_v3_broken_seis() -> __always_inline bool {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_enable_cpuif_traps() {
    void vgic_v3_enable_cpuif_traps(void)
    {
    let mut traps: u64 = vgic_ich_hcr_trap_bits();
    if (traps) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_probe(info: *const gic_kvm_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_load(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_put(vcpu: *mut kvm_vcpu) {
