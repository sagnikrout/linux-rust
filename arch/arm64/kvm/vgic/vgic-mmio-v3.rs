...
//! Source: arch/arm64/kvm/vgic/vgic-mmio-v3.c
#![no_std]
...
// allows updates of any half of a 64-bit register (or the whole thing)
    ...
    unsigned long val)
    {
    let mut lower: c_int = (offset & 4) * 8;
    let mut upper: c_int = lower + 8 * len - 1;
    reg &= ~GENMASK_ULL(upper, lower);
    val &= GENMASK_ULL(len * 8 - 1, 0);
    return reg | ((u64)val << lower);
    }
#[no_mangle]
pub unsafe extern "C" fn vgic_has_its(kvm: *mut kvm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_supports_direct_msis(kvm: *mut kvm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn system_supports_direct_sgis() -> bool {
    bool system_supports_direct_sgis(void)
    {
    return kvm_vgic_global_state.has_gicv4_1 && gic_cpuif_has_vsgi();
    }
#[no_mangle]
pub unsafe extern "C" fn vgic_supports_direct_sgis(kvm: *mut kvm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(dist->enabled: !was_enabled &&) -> else {
...
// Not a GICv4.1? No HW SGIs
    ...
    gpa_t addr, unsigned int len)
    {
    let mut intid: c_int = VGIC_ADDR_TO_INTID(addr, 64);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_lpis_enabled(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vgic_mmio_vcpu_rdist_is_last(vcpu: *mut kvm_vcpu) -> bool {
    ...
    let mut end: gpa_t = rdreg.base + rdreg.count * KVM_VGIC_V3_REDIST_SIZE;
//
...
//
    ...
    gpa_t addr, unsigned int len)
    {
    let mut mpidr: c_ulong = kvm_vcpu_get_mpidr_aff(vcpu);
    let mut target_vcpu_id: c_int = vcpu.vcpu_id;
    u64 value;
...
#[no_mangle]
pub unsafe extern "C" fn vgic_sanitise_shareability(field: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_sanitise_inner_cacheability(field: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_sanitise_outer_cacheability(field: u64) -> u64 {
    ...
    u64 (*sanitise_fn)(u64))
    {
    let mut field: u64 = (reg & field_mask) >> field_shift;
...
#[no_mangle]
unsafe extern "C" fn vgic_sanitise_pendbaser(reg: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vgic_sanitise_propbaser(reg: u64) -> u64 {
...
// Storing a value with LPIs already enabled is undefined
    ...
    {
    struct vgic_cpu *vgic_cpu = &vcpu.arch.vgic_cpu;
    let mut value: u64 = vgic_cpu.pendbaser;
...
#[no_mangle]
unsafe extern "C" fn vgic_set_rdist_busy(vcpu: *mut kvm_vcpu, busy: bool) {
...
//
    ...
    core::ptr::null_mut(), vgic_mmio_uaccess_write_v3_misc,
    16, VGIC_ACCESS_32bit),
    REGISTER_DESC_WITH_LENGTH(GICD_STATUSR,
    vgic_mmio_read_rao, vgic_mmio_write_wi, 4,
    VGIC_ACCESS_32bit),
    REGISTER_DESC_WITH_BITS_PER_IRQ_SHARED(GICD_IGROUPR,
    vgic_mmio_read_group, vgic_mmio_write_group, core::ptr::null_mut(), core::ptr::null_mut(), 1,
    VGIC_ACCESS_32bit),
    REGISTER_DESC_WITH_BITS_PER_IRQ_SHARED(GICD_ISENABLER,
    vgic_mmio_read_enable, vgic_mmio_write_senable,
    core::ptr::null_mut(), vgic_uaccess_write_senable, 1,
    VGIC_ACCESS_32bit),
    REGISTER_DESC_WITH_BITS_PER_IRQ_SHARED(GICD_ICENABLER,
    vgic_mmio_read_enable, vgic_mmio_write_cenable,
    core::ptr::null_mut(), vgic_uaccess_write_cenable, 1,
    VGIC_ACCESS_32bit),
    ...
    vgic_mmio_read_priority, vgic_mmio_write_priority, core::ptr::null_mut(), core::ptr::null_mut(),
    8, VGIC_ACCESS_32bit | VGIC_ACCESS_8bit),
    REGISTER_DESC_WITH_BITS_PER_IRQ_SHARED(GICD_ITARGETSR,
    vgic_mmio_read_raz, vgic_mmio_write_wi, core::ptr::null_mut(), core::ptr::null_mut(), 8,
    VGIC_ACCESS_32bit | VGIC_ACCESS_8bit),
    REGISTER_DESC_WITH_BITS_PER_IRQ_SHARED(GICD_ICFGR,
    vgic_mmio_read_config, vgic_mmio_write_config, core::ptr::null_mut(), core::ptr::null_mut(), 2,
    VGIC_ACCESS_32bit),
    REGISTER_DESC_WITH_BITS_PER_IRQ_SHARED(GICD_IGRPMODR,
    vgic_mmio_read_raz, vgic_mmio_write_wi, core::ptr::null_mut(), core::ptr::null_mut(), 1,
    VGIC_ACCESS_32bit),
    REGISTER_DESC_WITH_BITS_PER_IRQ_SHARED(GICD_IROUTER,
    vgic_mmio_read_irouter, vgic_mmio_write_irouter, core::ptr::null_mut(), core::ptr::null_mut(), 64,
...
// RD_base registers
    ...
    core::ptr::null_mut(), vgic_mmio_uaccess_write_wi, 8,
    VGIC_ACCESS_64bit | VGIC_ACCESS_32bit),
...
// SGI_base registers
    ...
    vgic_mmio_read_enable, vgic_mmio_write_senable,
    core::ptr::null_mut(), vgic_uaccess_write_senable, 4,
    VGIC_ACCESS_32bit),
    REGISTER_DESC_WITH_LENGTH_UACCESS(SZ_64K + GICR_ICENABLER0,
    vgic_mmio_read_enable, vgic_mmio_write_cenable,
    core::ptr::null_mut(), vgic_uaccess_write_cenable, 4,
    VGIC_ACCESS_32bit),
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_init_dist_iodev(dev: *mut vgic_io_device) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_register_redist_iodev(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_unregister_redist_iodev(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn vgic_register_all_redist_iodevs(kvm: *mut kvm) -> c_int {
...
//
    ...
    let mut nr_vcpus: c_int = atomic_read(&kvm.online_vcpus);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_free_redist_region(kvm: *mut kvm, rdreg: *mut vgic_redist_region) {
...
// Garbage collect the region
    ...
    vcpu.arch.vgic_cpu.rdreg = core::ptr::null_mut();
    }
    list_del(&rdreg.list);
    kfree(rdreg);
    }
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_set_redist_base(kvm: *mut kvm, index: u32, addr: u64, count: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_has_attr_regs(dev: *mut kvm_device, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vgic_v3_queue_sgi(vcpu: *mut kvm_vcpu, sgi: u32, allow_group1: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_dispatch_sgi(vcpu: *mut kvm_vcpu, reg: u64, allow_group1: bool) {
