...
//! Source: arch/arm64/kvm/vgic/vgic-v3-nested.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct shadow_if {
    pub cpuif: vgic_v3_cpu_if,
    pub lr_map: c_ulong,
}

    static DEFINE_PER_CPU(struct shadow_if, shadow_if);
#[no_mangle]
unsafe extern "C" fn lr_map_idx_to_shadow_idx(shadow_if: *mut shadow_if, idx: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_state_is_nested(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lr_triggers_eoi(lr: u64) -> bool {
    static bool lr_triggers_eoi(u64 lr)
    {
    return !(lr & (ICH_LR_STATE | ICH_LR_HW)) && (lr & ICH_LR_EOI);
    }
#[no_mangle]
unsafe extern "C" fn vgic_compute_mi_state(vcpu: *mut kvm_vcpu, mi_state: *mut mi_state) {
    static void vgic_compute_mi_state(struct kvm_vcpu *vcpu, struct mi_state *mi_state)
    {
    let mut eisr: u16 = 0, elrsr = 0;
    let mut pend: bool = false;
    for (int i = 0; i < kvm_vgic_global_state.nr_lr; i++) {
    let mut lr: u64 = __vcpu_sys_reg(vcpu, ICH_LRN(i));
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_get_eisr(vcpu: *mut kvm_vcpu) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_get_elrsr(vcpu: *mut kvm_vcpu) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_get_misr(vcpu: *mut kvm_vcpu) -> u64 {
    u64 vgic_v3_get_misr(struct kvm_vcpu *vcpu)
    {
    struct mi_state mi_state;
    let mut reg: u64 = 0, hcr, vmcr;
    ...
    let mut used_lrs: c_int = kvm_vgic_global_state.nr_lr;
...
#[no_mangle]
unsafe extern "C" fn translate_lr_pintid(vcpu: *mut kvm_vcpu, lr: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_flush_nested(vcpu: *mut kvm_vcpu) {
    void vgic_v3_flush_nested(struct kvm_vcpu *vcpu)
    {
    let mut val: u64 = __vcpu_sys_reg(vcpu, ICH_HCR_EL2);
    write_sysreg_s(val | vgic_ich_hcr_trap_bits(), SYS_ICH_HCR_EL2);
    }
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_sync_nested(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_load_nested(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_put_nested(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_handle_nested_maint_irq(vcpu: *mut kvm_vcpu) {
    void vgic_v3_handle_nested_maint_irq(struct kvm_vcpu *vcpu)
    {
    let mut state: bool = read_sysreg_s(SYS_ICH_MISR_EL2);
...
#[no_mangle]
pub unsafe extern "C" fn vgic_v3_nested_update_mi(vcpu: *mut kvm_vcpu) {
