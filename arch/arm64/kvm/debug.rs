...
#[no_mangle]
unsafe extern "C" fn cpu_has_spe(dfr0: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_arm_setup_mdcr_el2(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_init_host_debug_data() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_debug_init_vhe() {
...
//
#[no_mangle]
unsafe extern "C" fn setup_external_mdscr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_load_debug(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_put_debug(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_debug_set_guest_ownership(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_debug_handle_oslar(vcpu: *mut kvm_vcpu, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn skip_trbe_access(skip_condition: bool) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_enable_trbe() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_disable_trbe() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_tracing_set_el1_configuration(trfcr_while_in_guest: u64) {
