...
//! Source: arch/arm64/kvm/pmu-emul.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kvm_supports_guest_pmuv3() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __kvm_pmu_event_mask(pmuver: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn kvm_pmu_event_mask(kvm: *mut kvm) -> u32 {
    static u32 kvm_pmu_event_mask(struct kvm *kvm)
    {
    let mut dfr0: u64 = kvm_read_vm_id_reg(kvm, SYS_ID_AA64DFR0_EL1);
    let mut pmuver: u8 = SYS_FIELD_GET(ID_AA64DFR0_EL1, PMUVer, dfr0);
    return __kvm_pmu_event_mask(pmuver);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_evtyper_mask(kvm: *mut kvm) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_pmc_is_64bit(pmc: *mut kvm_pmc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kvm_pmc_has_64bit_overflow(pmc: *mut kvm_pmc) -> bool {
    static bool kvm_pmc_has_64bit_overflow(struct kvm_pmc *pmc)
    {
    struct kvm_vcpu *vcpu = kvm_pmc_to_vcpu(pmc);
    let mut val: u64 = kvm_vcpu_read_pmcr(vcpu);
...
#[no_mangle]
unsafe extern "C" fn kvm_pmu_counter_can_chain(pmc: *mut kvm_pmc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn counter_index_to_reg(idx: u64) -> u32 {
    static u32 counter_index_to_reg(u64 idx)
    {
    return (idx == ARMV8_PMU_CYCLE_IDX) ? PMCCNTR_EL0 : PMEVCNTR0_EL0 + idx;
    }
#[no_mangle]
unsafe extern "C" fn counter_index_to_evtreg(idx: u64) -> u32 {
    static u32 counter_index_to_evtreg(u64 idx)
    {
    return (idx == ARMV8_PMU_CYCLE_IDX) ? PMCCFILTR_EL0 : PMEVTYPER0_EL0 + idx;
    }
#[no_mangle]
unsafe extern "C" fn kvm_pmc_read_evtreg(pmc: *const kvm_pmc) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn kvm_pmu_get_pmc_value(pmc: *mut kvm_pmc) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_get_counter_value(vcpu: *mut kvm_vcpu, select_idx: u64) -> u64 {
    u64 kvm_pmu_get_counter_value(struct kvm_vcpu *vcpu, u64 select_idx)
    {
    return kvm_pmu_get_pmc_value(kvm_vcpu_idx_to_pmc(vcpu, select_idx));
    }
#[no_mangle]
unsafe extern "C" fn kvm_pmu_set_pmc_value(pmc: *mut kvm_pmc, val: u64, force: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_set_counter_value(vcpu: *mut kvm_vcpu, select_idx: u64, val: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_set_counter_value_user(vcpu: *mut kvm_vcpu, select_idx: u64, val: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_pmu_release_perf_event(pmc: *mut kvm_pmc) {
    static void kvm_pmu_release_perf_event(struct kvm_pmc *pmc)
    {
    if (pmc.perf_event) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_pmu_stop_counter(pmc: *mut kvm_pmc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_vcpu_init(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_vcpu_destroy(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_pmu_hyp_counter_mask(vcpu: *mut kvm_vcpu) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_counter_is_hyp(vcpu: *mut kvm_vcpu, idx: c_uint) -> bool {
    bool kvm_pmu_counter_is_hyp(struct kvm_vcpu *vcpu, unsigned int idx)
    {
    return kvm_pmu_hyp_counter_mask(vcpu) & BIT(idx);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_accessible_counter_mask(vcpu: *mut kvm_vcpu) -> u64 {
    u64 kvm_pmu_accessible_counter_mask(struct kvm_vcpu *vcpu)
    {
    let mut mask: u64 = kvm_pmu_implemented_counter_mask(vcpu);
    if (!vcpu_has_nv(vcpu) || vcpu_is_el2(vcpu))
    return mask;
    return mask & ~kvm_pmu_hyp_counter_mask(vcpu);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_implemented_counter_mask(vcpu: *mut kvm_vcpu) -> u64 {
    u64 kvm_pmu_implemented_counter_mask(struct kvm_vcpu *vcpu)
    {
    let mut val: u64 = FIELD_GET(ARMV8_PMU_PMCR_N, kvm_vcpu_read_pmcr(vcpu));
    if (val == 0)
...
#[no_mangle]
unsafe extern "C" fn kvm_pmc_enable_perf_event(pmc: *mut kvm_pmc) {
...
#[no_mangle]
unsafe extern "C" fn kvm_pmc_disable_perf_event(pmc: *mut kvm_pmc) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_reprogram_counter_mask(vcpu: *mut kvm_vcpu, val: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_pmu_overflow_status(vcpu: *mut kvm_vcpu) -> bool {
    static bool kvm_pmu_overflow_status(struct kvm_vcpu *vcpu)
    {
    let mut reg: u64 = __vcpu_sys_reg(vcpu, PMOVSSET_EL0);
...
#[no_mangle]
unsafe extern "C" fn kvm_pmu_update_state(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_should_notify_user(vcpu: *mut kvm_vcpu) -> bool {
    bool kvm_pmu_should_notify_user(struct kvm_vcpu *vcpu)
    {
    struct kvm_sync_regs *sregs = &vcpu.run.s.regs;
    let mut run_level: bool = sregs.device_irq_level & KVM_ARM_DEV_PMU;
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_update_run(vcpu: *mut kvm_vcpu) -> bool {
    bool kvm_pmu_update_run(struct kvm_vcpu *vcpu)
    {
    let mut update: bool = kvm_pmu_should_notify_user(vcpu);
    if (update)
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_flush_hwstate(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_sync_hwstate(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_pmu_perf_overflow_notify_vcpu(work: *mut irq_work) {
...
#[no_mangle]
unsafe extern "C" fn compute_period(pmc: *mut kvm_pmc, counter: u64) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_software_increment(vcpu: *mut kvm_vcpu, val: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_handle_pmcr(vcpu: *mut kvm_vcpu, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn kvm_pmu_counter_is_enabled(pmc: *mut kvm_pmc) -> bool {
    static bool kvm_pmu_counter_is_enabled(struct kvm_pmc *pmc)
    {
    struct kvm_vcpu *vcpu = kvm_pmc_to_vcpu(pmc);
    let mut mdcr: c_uint = __vcpu_sys_reg(vcpu, MDCR_EL2);
...
#[no_mangle]
unsafe extern "C" fn kvm_pmc_counts_at_el0(pmc: *mut kvm_pmc) -> bool {
    static bool kvm_pmc_counts_at_el0(struct kvm_pmc *pmc)
    {
    let mut evtreg: u64 = kvm_pmc_read_evtreg(pmc);
    let mut nsu: bool = evtreg & ARMV8_PMU_EXCLUDE_NS_EL0;
    let mut u: bool = evtreg & ARMV8_PMU_EXCLUDE_EL0;
    let mut u: return = = nsu;
    }
#[no_mangle]
unsafe extern "C" fn kvm_pmc_counts_at_el1(pmc: *mut kvm_pmc) -> bool {
    static bool kvm_pmc_counts_at_el1(struct kvm_pmc *pmc)
    {
    let mut evtreg: u64 = kvm_pmc_read_evtreg(pmc);
    let mut nsk: bool = evtreg & ARMV8_PMU_EXCLUDE_NS_EL1;
    let mut p: bool = evtreg & ARMV8_PMU_EXCLUDE_EL1;
    let mut p: return = = nsk;
    }
#[no_mangle]
unsafe extern "C" fn kvm_pmc_counts_at_el2(pmc: *mut kvm_pmc) -> bool {
    static bool kvm_pmc_counts_at_el2(struct kvm_pmc *pmc)
    {
    struct kvm_vcpu *vcpu = kvm_pmc_to_vcpu(pmc);
    let mut mdcr: u64 = __vcpu_sys_reg(vcpu, MDCR_EL2);
    if (!kvm_pmu_counter_is_hyp(vcpu, pmc.idx) && (mdcr & MDCR_EL2_HPMD))
    return false;
    return kvm_pmc_read_evtreg(pmc) & ARMV8_PMU_INCLUDE_EL2;
    }
#[no_mangle]
unsafe extern "C" fn kvm_map_pmu_event(kvm: *mut kvm, eventsel: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_pmu_create_perf_event(pmc: *mut kvm_pmc) {
    static void kvm_pmu_create_perf_event(struct kvm_pmc *pmc)
    {
    struct kvm_vcpu *vcpu = kvm_pmc_to_vcpu(pmc);
...
#[no_mangle]
pub unsafe extern "C" fn kvm_host_pmu_init(pmu: *mut arm_pmu) {
...
#[no_mangle]
unsafe extern "C" fn __compute_pmceid(pmu: *mut arm_pmu, pmceid1: bool) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn compute_pmceid0(vcpu: *mut kvm_vcpu) -> u64 {
    static u64 compute_pmceid0(struct kvm_vcpu *vcpu)
    {
    let mut val: u64 = __compute_pmceid(vcpu.kvm.arch.arm_pmu, 0);
...
#[no_mangle]
unsafe extern "C" fn compute_pmceid1(vcpu: *mut kvm_vcpu) -> u64 {
    static u64 compute_pmceid1(struct kvm_vcpu *vcpu)
    {
    let mut val: u64 = __compute_pmceid(vcpu.kvm.arch.arm_pmu, 1);
//
...
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_get_pmceid(vcpu: *mut kvm_vcpu, pmceid1: bool) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_reload_pmu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_pmu_v3_enable(vcpu: *mut kvm_vcpu) -> c_int {
...
//
    ...
    let mut irq: c_int = vcpu.arch.pmu.irq_num;
//
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_pmu_v3_init(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pmu_irq_is_valid(kvm: *mut kvm, irq: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_pmu_get_max_counters(kvm: *mut kvm) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_set_nr_counters(kvm: *mut kvm, nr: c_uint) {
...
// Reset MDCR_EL2.HPMN behind the vcpus' back...
    ...
    unsigned long i;
    kvm_for_each_vcpu(i, vcpu, kvm) {
    let mut val: u64 = __vcpu_sys_reg(vcpu, MDCR_EL2);
    val &= ~MDCR_EL2_HPMN;
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_set_pmu(kvm: *mut kvm, arm_pmu: *mut arm_pmu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_set_default_pmu(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_pmu_v3_set_pmu(vcpu: *mut kvm_vcpu, pmu_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_arm_pmu_v3_set_nr_counters(vcpu: *mut kvm_vcpu, n: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_pmu_v3_set_attr(vcpu: *mut kvm_vcpu, attr: *mut kvm_device_attr) -> c_int {
...
// The PMU overflow interrupt can be a PPI or a valid SPI.
    ...
    let mut pmuver: u8 = kvm_arm_pmu_get_pmuver_limit();
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_pmu_v3_get_attr(vcpu: *mut kvm_vcpu, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_pmu_v3_has_attr(vcpu: *mut kvm_vcpu, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arm_pmu_get_pmuver_limit() -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_read_pmcr(vcpu: *mut kvm_vcpu) -> u64 {
    u64 kvm_vcpu_read_pmcr(struct kvm_vcpu *vcpu)
    {
    let mut pmcr: u64 = __vcpu_sys_reg(vcpu, PMCR_EL0);
    let mut n: u64 = vcpu.kvm.arch.nr_pmu_counters;
    if (vcpu_has_nv(vcpu) && !vcpu_is_el2(vcpu))
    n = FIELD_GET(MDCR_EL2_HPMN, __vcpu_sys_reg(vcpu, MDCR_EL2));
    return u64_replace_bits(pmcr, n, ARMV8_PMU_PMCR_N);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_pmu_nested_transition(vcpu: *mut kvm_vcpu) {
    void kvm_pmu_nested_transition(struct kvm_vcpu *vcpu)
    {
    let mut reprogrammed: bool = false;
    unsigned long mask;
    int i;
    mask = __vcpu_sys_reg(vcpu, PMCNTENSET_EL0);
    for_each_set_bit(i, &mask, 32) {
