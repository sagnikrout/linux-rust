...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmio_write_buf(buf: *mut c_void, len: c_uint, data: c_ulong) {
    void kvm_mmio_write_buf(void *buf, unsigned int len, unsigned long data)
    {
    void *datap = core::ptr::null_mut();
    union {
    u8	byte;
    u16	hword;
    u32	word;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_mmio_read_buf(buf: *const c_void, len: c_uint) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn kvm_pending_external_abort(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_mmio_return(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn io_mem_abort(vcpu: *mut kvm_vcpu, fault_ipa: phys_addr_t) -> c_int {
