...
#[no_mangle]
unsafe extern "C" fn effective_tbi(vcpu: *mut kvm_vcpu, bit55: bool) -> bool {
    static bool effective_tbi(struct kvm_vcpu *vcpu, bool bit55)
    {
    let mut tcr: u64 = vcpu_read_sys_reg(vcpu, TCR_EL2);
    bool tbi, tbid;
//
...
#[no_mangle]
unsafe extern "C" fn compute_bottom_pac(vcpu: *mut kvm_vcpu, bit55: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compute_pac_mask(vcpu: *mut kvm_vcpu, bit55: bool) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn to_canonical_addr(vcpu: *mut kvm_vcpu, ptr: u64, mask: u64) -> u64 {
    static u64 to_canonical_addr(struct kvm_vcpu *vcpu, u64 ptr, u64 mask)
    {
    let mut bit55: bool = !!(ptr & BIT(55));
    if (bit55)
    return ptr | mask;
    return ptr & ~mask;
    }
#[no_mangle]
unsafe extern "C" fn corrupt_addr(vcpu: *mut kvm_vcpu, ptr: u64) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_auth_eretax(vcpu: *mut kvm_vcpu, elr: *mut u64) -> bool {
    bool kvm_auth_eretax(struct kvm_vcpu *vcpu, u64 *elr)
    {
    let mut sctlr: u64 = vcpu_read_sys_reg(vcpu, SCTLR_EL2);
