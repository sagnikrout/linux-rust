...
//! Source: arch/arm64/kvm/config.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct reg_bits_to_feat_map {
    union {
    pub bits: u64,
    pub masks: *mut fgt_masks,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct reg_feat_map_desc {
    pub name: *const c_char,
    pub feat_map: reg_bits_to_feat_map,
    pub bit_feat_map: *const reg_bits_to_feat_map,
    pub bit_feat_map_sz: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn not_feat_aa64el3(kvm: *mut kvm) -> bool {
    static bool not_feat_aa64el3(struct kvm *kvm)
    {
    return !kvm_has_feat(kvm, FEAT_AA64EL3);
    }
#[no_mangle]
unsafe extern "C" fn feat_nv2(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_nv2_e2h0_ni(kvm: *mut kvm) -> bool {
    static bool feat_nv2_e2h0_ni(struct kvm *kvm)
    {
    return feat_nv2(kvm) && !kvm_has_feat(kvm, FEAT_E2H0);
    }
#[no_mangle]
unsafe extern "C" fn feat_rasv1p1(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_csv2_2_csv2_1p2(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_pauth(kvm: *mut kvm) -> bool {
    static bool feat_pauth(struct kvm *kvm)
    {
    return kvm_has_pauth(kvm, PAuth);
    }
#[no_mangle]
unsafe extern "C" fn feat_pauth_lr(kvm: *mut kvm) -> bool {
    static bool feat_pauth_lr(struct kvm *kvm)
    {
    return kvm_has_pauth(kvm, PAuth_LR);
    }
#[no_mangle]
unsafe extern "C" fn feat_aderr(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_anerr(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_sme_smps(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_spe_fds(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_spe_fne(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_trbe_mpam(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_lpa2(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn feat_vmid16(kvm: *mut kvm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn reg_feat_map_bits(map: *const reg_bits_to_feat_map) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn check_reg_desc(r: *const reg_feat_map_desc) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn check_feature_map() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn idreg_feat_match(kvm: *mut kvm, map: *const reg_bits_to_feat_map) -> bool {
    static bool idreg_feat_match(struct kvm *kvm, const struct reg_bits_to_feat_map *map)
    {
    let mut regval: u64 = kvm.arch.id_regs[map.regidx];
    let mut regfld: u64 = (regval >> map.shift) & GENMASK(map.width - 1, 0);
    if (map.sign) {
    let mut sfld: i64 = sign_extend64(regfld, map.width - 1);
    let mut slim: i64 = sign_extend64(map.lo_lim, map.width - 1);
    return sfld >= slim;
    } else {
    ...
    {
    let mut e2h0: bool = kvm_has_feat(kvm, FEAT_E2H0);
    let mut resx: resx = {};
    for (int i = 0; i < map_size; i++) {
    bool match;
    ...
    match = false;
#[no_mangle]
pub unsafe extern "C" fn if(CALL_FUNC: map[i].flags &) -> else {
    ...
    match &= !e2h0;
    if (!match) {
    let mut bits: u64 = reg_feat_map_bits(&map[i]);
...
#[no_mangle]
unsafe extern "C" fn compute_fgu_bits(kvm: *mut kvm, r: *const reg_feat_map_desc) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn compute_fgu(kvm: *mut kvm, fgt: enum fgt_group_id) {
...
#[no_mangle]
pub unsafe extern "C" fn get_reg_fixed_bits(kvm: *mut kvm, reg: enum vcpu_sysreg) -> resx {
...
#[no_mangle]
unsafe extern "C" fn __compute_fgt(vcpu: *mut kvm_vcpu, reg: enum vcpu_sysreg) -> __always_inline void {
    static __always_inline void __compute_fgt(struct kvm_vcpu *vcpu, enum vcpu_sysreg reg)
    {
    let mut fgu: u64 = vcpu.kvm.arch.fgu[__fgt_reg_to_group_id(reg)];
    struct fgt_masks *m = __fgt_reg_to_masks(reg);
    let mut clear: u64 = 0, set = 0, val = m.nmask;
    set |= fgu & m.mask;
    clear |= fgu & m.nmask;
    if (is_nested_ctxt(vcpu)) {
    let mut nested: u64 = __vcpu_sys_reg(vcpu, reg);
    set |= nested & m.mask;
...
#[no_mangle]
unsafe extern "C" fn __compute_hfgwtr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __compute_hdfgwtr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __compute_ich_hfgrtr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __compute_ich_hfgwtr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_vcpu_load_fgt(vcpu: *mut kvm_vcpu) {
