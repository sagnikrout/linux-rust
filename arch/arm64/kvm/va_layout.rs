...
//! Source: arch/arm64/kvm/va_layout.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn __early_kern_hyp_va(addr: u64) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn init_hyp_physvirt_offset() {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_hyp_va_bits() -> __init u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_compute_layout() -> __init void {
    __init void kvm_compute_layout(void)
    {
    let mut idmap_addr: phys_addr_t = __pa_symbol(__hyp_idmap_text_start);
    u64 hyp_va_msb;
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_apply_hyp_relocations() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn compute_instruction(n: c_int, rd: u32, rn: u32) -> u32 {
    static u32 compute_instruction(int n, u32 rd, u32 rn)
    {
    let mut insn: u32 = AARCH64_BREAK_FAULT;
    switch (n) {
    case 0:
...
#[no_mangle]
unsafe extern "C" fn generate_mov_q(val: u64, origptr: *mut __le32, updptr: *mut __le32, nr_inst: c_int) {
