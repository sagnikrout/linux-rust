...
//! Source: arch/arm64/kvm/emulate-nested.c
#![no_std]
...
pub struct trap_bits {
    pub index: enum vcpu_sysreg,
    pub behaviour: enum trap_behaviour,
    pub value: u64,
    pub mask: u64,
}
...
//
#[no_mangle]
unsafe extern "C" fn get_sanitized_cnthctl(vcpu: *mut kvm_vcpu) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn check_cnthctl_el1pcten(vcpu: *mut kvm_vcpu) -> enum trap_behaviour {
...
#[no_mangle]
unsafe extern "C" fn check_cnthctl_el1pten(vcpu: *mut kvm_vcpu) -> enum trap_behaviour {
...
#[no_mangle]
unsafe extern "C" fn is_nested_nv2_guest(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn check_cnthctl_el1nvpct(vcpu: *mut kvm_vcpu) -> enum trap_behaviour {
...
#[no_mangle]
unsafe extern "C" fn check_cnthctl_el1nvvct(vcpu: *mut kvm_vcpu) -> enum trap_behaviour {
...
#[no_mangle]
unsafe extern "C" fn check_cptr_tta(vcpu: *mut kvm_vcpu) -> enum trap_behaviour {
    static enum trap_behaviour check_cptr_tta(struct kvm_vcpu *vcpu)
    {
    let mut val: u64 = __vcpu_sys_reg(vcpu, CPTR_EL2);
    if (!vcpu_el2_e2h_is_set(vcpu))
...
#[no_mangle]
unsafe extern "C" fn check_mdcr_hpmn(vcpu: *mut kvm_vcpu) -> enum trap_behaviour {
    static enum trap_behaviour check_mdcr_hpmn(struct kvm_vcpu *vcpu)
    {
    let mut sysreg: u32 = esr_sys64_to_sysreg(kvm_vcpu_get_esr(vcpu));
    unsigned int idx;
    switch (sysreg) {
...
#[no_mangle]
unsafe extern "C" fn check_hcr_nv_hcrx_nnvtge(vcpu: *mut kvm_vcpu) -> enum trap_behaviour {
...
//
pub const TC_CGT_BITS: c_int = 10;
pub const TC_FGT_BITS: c_int = 4;
pub const TC_FGF_BITS: c_int = 5;
pub const TC_SRI_BITS: c_int = 10;
    union trap_config {
    u64	val;
    struct {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct encoding_to_trap_config {
    pub encoding: u32,
    pub end: u32,
    pub tc: union trap_config,
    pub line: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn get_trap_config(sysreg: u32) -> union trap_config {
...
#[no_mangle]
unsafe extern "C" fn encoding_next(encoding: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aggregate_fgt(tc: union trap_config) -> __init bool {
...
#[no_mangle]
unsafe extern "C" fn check_fgt_masks(masks: *mut fgt_masks) -> __init int {
    static __init int check_fgt_masks(struct fgt_masks *masks)
    {
    let mut duplicate: c_ulong = masks.mask & masks.nmask;
    let mut ret: c_int = 0;
    if (duplicate) {
    int i;
...
#[no_mangle]
unsafe extern "C" fn check_all_fgt_masks(ret: c_int) -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn populate_nv_trap_config() -> int __init {
...
//
    ...
    {
    let mut b: enum trap_behaviour = BEHAVE_HANDLE_LOCALLY;
    u64 val;
...
#[no_mangle]
unsafe extern "C" fn kvm_get_sysreg_res0(kvm: *mut kvm, sr: enum vcpu_sysreg) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn triage_sysreg_trap(vcpu: *mut kvm_vcpu, sr_index: *mut c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __forward_traps(vcpu: *mut kvm_vcpu, reg: c_uint, control_bit: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn forward_hcr_traps(vcpu: *mut kvm_vcpu, control_bit: u64) -> bool {
    static bool forward_hcr_traps(struct kvm_vcpu *vcpu, u64 control_bit)
    {
    return __forward_traps(vcpu, HCR_EL2, control_bit);
    }
#[no_mangle]
pub unsafe extern "C" fn forward_smc_trap(vcpu: *mut kvm_vcpu) -> bool {
    bool forward_smc_trap(struct kvm_vcpu *vcpu)
    {
    return forward_hcr_traps(vcpu, HCR_TSC);
    }
#[no_mangle]
unsafe extern "C" fn forward_mdcr_traps(vcpu: *mut kvm_vcpu, control_bit: u64) -> bool {
    static bool forward_mdcr_traps(struct kvm_vcpu *vcpu, u64 control_bit)
    {
    return __forward_traps(vcpu, MDCR_EL2, control_bit);
    }
#[no_mangle]
pub unsafe extern "C" fn forward_debug_exception(vcpu: *mut kvm_vcpu) -> bool {
    bool forward_debug_exception(struct kvm_vcpu *vcpu)
    {
    return forward_mdcr_traps(vcpu, MDCR_EL2_TDE);
    }
#[no_mangle]
unsafe extern "C" fn kvm_check_illegal_exception_return(vcpu: *mut kvm_vcpu, spsr: u64) -> u64 {
    static u64 kvm_check_illegal_exception_return(struct kvm_vcpu *vcpu, u64 spsr)
    {
    let mut mode: u64 = spsr & PSR_MODE_MASK;
//
...
#[no_mangle]
pub unsafe extern "C" fn kvm_emulate_nested_eret(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_inject_nested_sync(vcpu: *mut kvm_vcpu, esr_el2: u64) -> c_int {
    int kvm_inject_nested_sync(struct kvm_vcpu *vcpu, u64 esr_el2)
    {
    return kvm_inject_nested(vcpu, esr_el2, except_type_sync);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_inject_nested_irq(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_inject_nested_sea(vcpu: *mut kvm_vcpu, iabt: bool, addr: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_inject_nested_serror(vcpu: *mut kvm_vcpu, esr: u64) -> c_int {
