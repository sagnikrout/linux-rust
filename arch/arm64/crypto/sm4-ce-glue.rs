...
//! Source: arch/arm64/crypto/sm4-ce-glue.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sm4_mac_tfm_ctx {
    pub key: sm4_ctx,
    pub consts: [u8 __aligned(8); ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sm4_mac_desc_ctx {
    pub digest: [u8; SM4_BLOCK_SIZE],
}
...
#[no_mangle]
unsafe extern "C" fn sm4_ecb_do_crypt(req: *mut skcipher_request, rkey: *const u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm4_ecb_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm4_ecb_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm4_cbc_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm4_cbc_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm4_cbc_cts_crypt(req: *mut skcipher_request, encrypt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm4_cbc_cts_encrypt(req: *mut skcipher_request) -> c_int {
    static int sm4_cbc_cts_encrypt(struct skcipher_request *req)
    {
    return sm4_cbc_cts_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn sm4_cbc_cts_decrypt(req: *mut skcipher_request) -> c_int {
    static int sm4_cbc_cts_decrypt(struct skcipher_request *req)
    {
    return sm4_cbc_cts_crypt(req, false);
    }
#[no_mangle]
unsafe extern "C" fn sm4_ctr_crypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm4_xts_crypt(req: *mut skcipher_request, encrypt: bool) -> c_int {
    static int sm4_xts_crypt(struct skcipher_request *req, bool encrypt)
    {
    struct crypto_skcipher *tfm = crypto_skcipher_reqtfm(req);
    struct sm4_xts_ctx *ctx = crypto_skcipher_ctx(tfm);
    let mut tail: c_int = req.cryptlen % SM4_BLOCK_SIZE;
    ...
    let mut nblocks: c_int = DIV_ROUND_UP(req.cryptlen, SM4_BLOCK_SIZE) - 2;
...
#[no_mangle]
unsafe extern "C" fn sm4_xts_encrypt(req: *mut skcipher_request) -> c_int {
    static int sm4_xts_encrypt(struct skcipher_request *req)
    {
    return sm4_xts_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn sm4_xts_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm4_mac_init(desc: *mut shash_desc) -> c_int {
    ...
    struct sm4_mac_desc_ctx *ctx = shash_desc_ctx(desc);
    let mut nblocks: c_uint = len / SM4_BLOCK_SIZE;
    len %= SM4_BLOCK_SIZE;
    scoped_ksimd()
