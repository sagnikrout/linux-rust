...
pub const ADR_IMM_HILOSPLIT: c_int = 2;

pub const ADR_IMM_LOSHIFT: c_int = 29;
pub const ADR_IMM_HISHIFT: c_int = 5;
#[no_mangle]
pub unsafe extern "C" fn aarch64_insn_decode_immediate(type: enum aarch64_insn_imm_type, insn: u32) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn aarch64_get_branch_offset(insn: u32) -> i32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn aarch64_set_branch_offset(insn: u32, offset: i32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn aarch64_insn_adrp_get_offset(insn: u32) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn aarch64_insn_adrp_set_offset(insn: u32, offset: i32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn aarch64_insn_extract_system_reg(insn: u32) -> u32 {
    u32 aarch64_insn_extract_system_reg(u32 insn)
    {
    return (insn & 0x1FFFE0) >> 5;
    }
#[no_mangle]
pub unsafe extern "C" fn aarch32_insn_is_wide(insn: u32) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn aarch32_insn_extract_reg_num(insn: u32, offset: c_int) -> u32 {
    u32 aarch32_insn_extract_reg_num(u32 insn, int offset)
    {
    return (insn & (0xf << offset)) >> offset;
    }
pub const OPC2_MASK: c_uint = 0x7;
pub const OPC2_OFFSET: c_int = 5;
#[no_mangle]
pub unsafe extern "C" fn aarch32_insn_mcr_extract_opc2(insn: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn aarch32_insn_mcr_extract_crm(insn: u32) -> u32 {
    u32 aarch32_insn_mcr_extract_crm(u32 insn)
    {
    return insn & CRM_MASK;
    }
#[no_mangle]
unsafe extern "C" fn range_of_ones(val: u64) -> bool {
    static bool range_of_ones(u64 val)
    {
// Doesn't handle full ones or full zeroes
    let mut sval: u64 = val >> __ffs64(val);
...
#[no_mangle]
unsafe extern "C" fn __get_barrier_crm_val(type: enum aarch64_insn_mb_type) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn aarch64_insn_gen_dmb(type: enum aarch64_insn_mb_type) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn aarch64_insn_gen_dsb(type: enum aarch64_insn_mb_type) -> u32 {
    ...
    {
    let mut insn: u32 = aarch64_insn_get_mrs_value();
    insn &= ~GENMASK(19, 0);
    insn |= sysreg << 5;
