...
//! Source: arch/arm64/include/asm/cputype.h
#![no_std]
...
pub const ARM_CPU_PART_CORTEX_A520AE: c_uint = 0xD88;
...
pub const ARM_CPU_PART_C1_ULTRA: c_uint = 0xD8C;
pub const ARM_CPU_PART_NEOVERSE_N3: c_uint = 0xD8E;
pub const ARM_CPU_PART_C1_NANO: c_uint = 0xD8A;
pub const ARM_CPU_PART_C1_PRO: c_uint = 0xD8B;
pub const ARM_CPU_PART_C1_PREMIUM: c_uint = 0xD90;
...
extern "C" {
    pub fn is_midr_in_range_list(ranges: *const midr_range) -> bool;
}
extern "C" {
