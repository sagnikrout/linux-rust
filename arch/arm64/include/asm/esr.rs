...
//! Source: arch/arm64/include/asm/esr.h
#![no_std]
...
pub const ESR_ELx_SME_ISS_SMTC_SME_DISABLED: c_int = 0;
pub const ESR_ELx_SME_ISS_SMTC_ILL: c_int = 1;
pub const ESR_ELx_SME_ISS_SMTC_SM_DISABLED: c_int = 2;
pub const ESR_ELx_SME_ISS_SMTC_ZA_DISABLED: c_int = 3;
pub const ESR_ELx_SME_ISS_SMTC_ZT_DISABLED: c_int = 4;
// ISS field definitions for MOPS exceptions

// ISS field definitions for GCS

pub const ESR_ELx_Rvalue_SHIFT: c_int = 5;

pub const ESR_ELx_ExType_DATA_CHECK: c_int = 0;
pub const ESR_ELx_ExType_EXLOCK: c_int = 1;
pub const ESR_ELx_ExType_STR: c_int = 2;
pub const ESR_ELx_IT_RET: c_int = 0;
pub const ESR_ELx_IT_GCSPOPM: c_int = 1;
pub const ESR_ELx_IT_RET_KEYA: c_int = 2;
pub const ESR_ELx_IT_RET_KEYB: c_int = 3;
pub const ESR_ELx_IT_GCSSS1: c_int = 4;
pub const ESR_ELx_IT_GCSSS2: c_int = 5;
pub const ESR_ELx_IT_GCSPOPCX: c_int = 6;
pub const ESR_ELx_IT_GCSPOPX: c_int = 7;
