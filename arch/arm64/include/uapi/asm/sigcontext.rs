...
//! Source: arch/arm64/include/uapi/asm/sigcontext.h
#![no_std]
...
// 4K reserved for FP/SIMD state and future expansion
    pub __attribute__((__aligned__(16))): __u8 __reserved[4096],
}
...
pub const FPSIMD_MAGIC: c_uint = 0x46508001;
#[repr(C)]
#[derive(Copy, Clone)]
...
//
// ESR_EL1 context
pub const ESR_MAGIC: c_uint = 0x45535201;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const POE_MAGIC: c_uint = 0x504f4530;
#[repr(C)]
#[derive(Copy, Clone)]
...
// _aarch64_ctx.
//
pub const EXTRA_MAGIC: c_uint = 0x45585401;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct extra_context {
    pub head: _aarch64_ctx,
    pub /: *mut *mut __u64 datap; / 16-byte aligned pointer to extra space cast to __u64,
    pub /: *mut *mut __u32 size; / size in bytes of the extra space,
    pub __reserved: [__u32; 3],
}

pub const SVE_MAGIC: c_uint = 0x53564501;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const SVE_SIG_FLAG_SM: c_uint = 0x1	/* Context describes streaming mode */;
// TPIDR2_EL0 context
pub const TPIDR2_MAGIC: c_uint = 0x54504902;
#[repr(C)]
#[derive(Copy, Clone)]
...
// FPMR context
pub const FPMR_MAGIC: c_uint = 0x46504d52;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const ZA_MAGIC: c_uint = 0x54366345;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const ZT_MAGIC: c_uint = 0x5a544e01;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const GCS_MAGIC: c_uint = 0x47435300;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const ZT_SIG_REG_SIZE: c_int = 512;
