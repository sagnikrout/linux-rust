...
//! Source: arch/arm64/kernel/fpsimd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vec_vl_inherit_flag(type: enum vec_type) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vl_config {
    pub /: *mut *mut int __default_vl; / Default VL for tasks,
}

    static struct vl_config vl_config[ARM64_VEC_MAX];
#[no_mangle]
pub unsafe extern "C" fn get_default_vl(type: enum vec_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_sme_default_vl() -> c_int {
    static int get_sme_default_vl(void)
    {
    return get_default_vl(ARM64_VEC_SME);
    }
#[no_mangle]
unsafe extern "C" fn set_sme_default_vl(val: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn get_cpu_fpsimd_context() {
...
//
#[no_mangle]
unsafe extern "C" fn put_cpu_fpsimd_context() {
...
#[no_mangle]
pub unsafe extern "C" fn task_get_vl(task: *const task_struct, type: enum vec_type) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn task_fpsimd_load() {
    static void task_fpsimd_load(void)
    {
    let mut restore_sve_regs: bool = false;
    bool restore_ffr;
...
// Stop tracking SVE for this task until next use.
    ...
    let mut vq: c_ulong = sve_vq_from_vl(task_get_sve_vl(current));
...
// Restore SME, override SVE register configuration if needed
    ...
    let mut sme_vl: c_ulong = task_get_sme_vl(current);
// Ensure VL is set up for restoring data
    if (test_thread_flag(TIF_SME)) {
    let mut vq: c_ulong = sve_vq_from_vl(sme_vl);
...
//
#[no_mangle]
unsafe extern "C" fn fpsimd_save_user_state() {
    static void fpsimd_save_user_state(void)
    {
    struct cpu_fp_state const *last =
    this_cpu_ptr(&fpsimd_last_state);
// set by fpsimd_bind_task_to_cpu() or fpsimd_bind_state_to_cpu()
    let mut save_sve_regs: bool = false;
    bool save_ffr;
    unsigned int vl;
    WARN_ON(!system_supports_fpsimd());
    WARN_ON(preemptible());
...
//
    ...
    int bit;
    let mut max_vl: c_int = info.max_vl;
    ...
    let mut type: enum vec_type = info.type;
    int ret;
    let mut vl: c_int = get_default_vl(type);
...
#[no_mangle]
unsafe extern "C" fn sve_sysctl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sme_sysctl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn arm64_cpu_to_le128(x: __uint128_t) -> __uint128_t {
    static __uint128_t arm64_cpu_to_le128(__uint128_t x)
    {
    let mut a: u64 = swab64(x);
    let mut b: u64 = swab64(x >> 64);
...
//
#[no_mangle]
pub unsafe extern "C" fn fpsimd_to_sve(task: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sve_to_fpsimd(task: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn __fpsimd_zero_vregs(fpsimd: *mut user_fpsimd_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn task_smstop_sm(task: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_enable_fpmr(p: *const *const arm64_cpu_capabilities __always_unused) {
...
#[no_mangle]
unsafe extern "C" fn sve_free(task: *mut task_struct) {
    static void sve_free(struct task_struct *task)
    {
    kfree(task.thread.sve_state);
    task.thread.sve_state = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn sve_alloc(task: *mut task_struct, flush: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpsimd_sync_from_effective_state(task: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpsimd_sync_to_effective_state_zeropad(task: *mut task_struct) {
    ...
    unsigned long vl)
    {
    let mut sve_vl: c_uint = task_get_sve_vl(task);
    let mut sme_vl: c_uint = task_get_sme_vl(task);
    struct arm64_sve_state *sve_state = core::ptr::null_mut();
    struct arm64_sme_state *sme_state = core::ptr::null_mut();
...
//
    ...
    {
    let mut onexec: bool = flags & PR_SVE_SET_VL_ONEXEC;
    let mut inherit: bool = flags & PR_SVE_VL_INHERIT;
...
//
#[no_mangle]
unsafe extern "C" fn vec_prctl_status(type: enum vec_type, flags: c_ulong) -> c_int {
...
// PR_SVE_SET_VL
#[no_mangle]
pub unsafe extern "C" fn sve_set_current_vl(arg: c_ulong) -> c_int {
...
// PR_SVE_GET_VL
#[no_mangle]
pub unsafe extern "C" fn sve_get_current_vl() -> c_int {
...
// PR_SME_SET_VL
#[no_mangle]
pub unsafe extern "C" fn sme_set_current_vl(arg: c_ulong) -> c_int {
...
// PR_SME_GET_VL
#[no_mangle]
pub unsafe extern "C" fn sme_get_current_vl() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vec_init_vq_map(type: enum vec_type) -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn vec_update_vq_map(type: enum vec_type) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vec_verify_vq_map(type: enum vec_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_enable_sve(p: *const *const arm64_cpu_capabilities __always_unused) {
...
#[no_mangle]
pub unsafe extern "C" fn sve_setup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(1): WARN_ON(b == SVE_VQ_MAX -) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpsimd_release_task(dead_task: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sme_alloc(task: *mut task_struct, flush: bool) {
...
#[no_mangle]
unsafe extern "C" fn sme_free(task: *mut task_struct) {
    static void sme_free(struct task_struct *task)
    {
    kfree(task.thread.sme_state);
    task.thread.sme_state = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_enable_sme(p: *const *const arm64_cpu_capabilities __always_unused) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_enable_sme2(p: *const *const arm64_cpu_capabilities __always_unused) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_enable_fa64(p: *const *const arm64_cpu_capabilities __always_unused) {
...
#[no_mangle]
pub unsafe extern "C" fn sme_setup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn sme_suspend_exit() {
...
//
#[no_mangle]
pub unsafe extern "C" fn do_sve_acc(esr: c_ulong, regs: *mut pt_regs) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sme_set_active() {
...
#[no_mangle]
pub unsafe extern "C" fn sme_clear_active() {
...
#[no_mangle]
unsafe extern "C" fn sme_dvmsync_ipi(unused: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn sme_do_dvmsync(mask: *const cpumask) {
...
//
    ...
    return;
    preempt_disable();
    smp_call_function_many(mask, sme_dvmsync_ipi, core::ptr::null_mut(), true);
    preempt_enable();
    }
#[no_mangle]
pub unsafe extern "C" fn sme_enable_dvmsync() {
...
//
#[no_mangle]
pub unsafe extern "C" fn do_sme_acc(esr: c_ulong, regs: *mut pt_regs) {
...
// With TIF_SME userspace shouldn't generate any traps
    ...
    WARN_ON(1);
    if (!test_thread_flag(TIF_FOREIGN_FPSTATE)) {
    let mut vq: c_ulong = sve_vq_from_vl(task_get_sme_vl(current));
    sysreg_clear_set_s(SYS_SMCR_EL1, SMCR_ELx_LEN, vq - 1);
    fpsimd_bind_task_to_cpu();
    } else {
    fpsimd_flush_task_state(current);
...
//
#[no_mangle]
pub unsafe extern "C" fn do_fpsimd_acc(esr: c_ulong, regs: *mut pt_regs) {
...
//
#[no_mangle]
pub unsafe extern "C" fn do_fpsimd_exc(esr: c_ulong, regs: *mut pt_regs) {
    void do_fpsimd_exc(unsigned long esr, struct pt_regs *regs)
    {
    let mut si_code: c_uint = FPE_FLTUNK;
    if (esr & ESR_ELx_FP_EXC_TFV) {
    if (esr & FPEXC_IOF)
    si_code = FPE_FLTINV;
#[no_mangle]
pub unsafe extern "C" fn if(FPEXC_DZF: esr &) -> else {
    else if (esr & FPEXC_DZF)
    si_code = FPE_FLTDIV;
#[no_mangle]
pub unsafe extern "C" fn if(FPEXC_OFF: esr &) -> else {
    else if (esr & FPEXC_OFF)
    si_code = FPE_FLTOVF;
#[no_mangle]
pub unsafe extern "C" fn if(FPEXC_UFF: esr &) -> else {
    else if (esr & FPEXC_UFF)
    si_code = FPE_FLTUND;
#[no_mangle]
pub unsafe extern "C" fn if(FPEXC_IXF: esr &) -> else {
...
#[no_mangle]
unsafe extern "C" fn fpsimd_load_kernel_state(task: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn fpsimd_save_kernel_state(task: *mut task_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn fpsimd_flush_cpu_state() {
    static void fpsimd_flush_cpu_state(void)
    {
    WARN_ON(!system_supports_fpsimd());
    __this_cpu_write(fpsimd_last_state.st, core::ptr::null_mut());
//
...
#[no_mangle]
pub unsafe extern "C" fn fpsimd_thread_switch(next: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn fpsimd_flush_thread_vl(type: enum vec_type) {
...
#[no_mangle]
pub unsafe extern "C" fn fpsimd_flush_thread() {
...
// Defer kfree() while in atomic context
    ...
    current.thread.sve_state = core::ptr::null_mut();
...
// Defer kfree() while in atomic context
    ...
    current.thread.sme_state = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn fpsimd_preserve_current_state() {
...
//
#[no_mangle]
unsafe extern "C" fn fpsimd_bind_task_to_cpu() {
    static void fpsimd_bind_task_to_cpu(void)
    {
    struct cpu_fp_state *last = this_cpu_ptr(&fpsimd_last_state);
    WARN_ON(!system_supports_fpsimd());
...
#[no_mangle]
pub unsafe extern "C" fn fpsimd_bind_state_to_cpu(state: *mut cpu_fp_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpsimd_restore_current_state() {
...
#[no_mangle]
pub unsafe extern "C" fn fpsimd_update_current_state(state: *const user_fpsimd_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpsimd_flush_task_state(t: *mut task_struct) {
    void fpsimd_flush_task_state(struct task_struct *t)
    {
    t.thread.fpsimd_cpu = NR_CPUS;
    t.thread.kernel_fpsimd_state = core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn fpsimd_save_and_flush_current_state() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpsimd_save_and_flush_cpu_state() {
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_neon_begin(state: *mut user_fpsimd_state) {
...
//
    WARN_ON(current.thread.kernel_fpsimd_state != core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn kernel_neon_end(state: *mut user_fpsimd_state) {
...
//
    ...
    current.thread.kernel_fpsimd_state = core::ptr::null_mut();
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn __efi_fpsimd_begin() {
...
//
#[no_mangle]
pub unsafe extern "C" fn __efi_fpsimd_end() {
...
#[no_mangle]
unsafe extern "C" fn fpsimd_pm_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fpsimd_cpu_dead(cpu: c_uint) -> c_int {
    static int fpsimd_cpu_dead(unsigned int cpu)
    {
    per_cpu(fpsimd_last_state.st, cpu) = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn fpsimd_hotplug_init() {
    static inline void fpsimd_hotplug_init(void)
    {
    cpuhp_setup_state_nocalls(CPUHP_ARM64_FPSIMD_DEAD, "arm64/fpsimd:dead",
    core::ptr::null_mut(), fpsimd_cpu_dead);
    }

    static inline void fpsimd_hotplug_init(void) { }

#[no_mangle]
pub unsafe extern "C" fn cpu_enable_fpsimd(p: *const *const arm64_cpu_capabilities __always_unused) {
    void cpu_enable_fpsimd(const struct arm64_cpu_capabilities *__always_unused p)
    {
    let mut enable: c_ulong = CPACR_EL1_FPEN_EL1EN | CPACR_EL1_FPEN_EL0EN;
...
//
#[no_mangle]
unsafe extern "C" fn fpsimd_init() -> int __init {
