...
//
    ...
    [COMPAT_KERNEL_HWCAP(26BIT)]	= core::ptr::null_mut(),	/* Not possible on arm64 */
    [COMPAT_KERNEL_HWCAP(FAST_MULT)] = "fastmult",
    [COMPAT_KERNEL_HWCAP(FPA)]	= core::ptr::null_mut(),	/* Not possible on arm64 */
    [COMPAT_KERNEL_HWCAP(VFP)]	= "vfp",
    [COMPAT_KERNEL_HWCAP(EDSP)]	= "edsp",
    [COMPAT_KERNEL_HWCAP(JAVA)]	= core::ptr::null_mut(),	/* Not possible on arm64 */
    [COMPAT_KERNEL_HWCAP(IWMMXT)]	= core::ptr::null_mut(),	/* Not possible on arm64 */
    [COMPAT_KERNEL_HWCAP(CRUNCH)]	= core::ptr::null_mut(),	/* Not possible on arm64 */
    [COMPAT_KERNEL_HWCAP(THUMBEE)]	= core::ptr::null_mut(),	/* Not possible on arm64 */
    [COMPAT_KERNEL_HWCAP(NEON)]	= "neon",
    [COMPAT_KERNEL_HWCAP(VFPv3)]	= "vfpv3",
    [COMPAT_KERNEL_HWCAP(VFPV3D16)]	= core::ptr::null_mut(),	/* Not possible on arm64 */
    [COMPAT_KERNEL_HWCAP(TLS)]	= "tls",
    [COMPAT_KERNEL_HWCAP(VFPv4)]	= "vfpv4",
    [COMPAT_KERNEL_HWCAP(IDIVA)]	= "idiva",
    [COMPAT_KERNEL_HWCAP(IDIVT)]	= "idivt",
    [COMPAT_KERNEL_HWCAP(VFPD32)]	= core::ptr::null_mut(),	/* Not possible on arm64 */
...
unsafe extern "C" fn c_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    {
    int j;
    let mut cpu: c_int = m.index;
    let mut compat: bool = personality(current.personality) == PER_LINUX32;
    struct cpuinfo_arm64 *cpuinfo = v;
    let mut midr: u32 = cpuinfo.reg_midr;
//
...
// pos = cpumask_next(*pos - 1, cpu_online_mask);
    return *pos < nr_cpu_ids ? &per_cpu(cpu_data, *pos) : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn cpuid_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpuid_cpu_offline(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpuinfo_regs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cpuinfo_detect_icache_policy(info: *mut cpuinfo_arm64) {
    static void cpuinfo_detect_icache_policy(struct cpuinfo_arm64 *info)
    {
    let mut cpu: c_uint = smp_processor_id();
    let mut l1ip: u32 = CTR_L1IP(info.reg_ctr);
    switch (l1ip) {
    case CTR_EL0_L1Ip_PIPT:
    break;
    case CTR_EL0_L1Ip_VIPT:
...
#[no_mangle]
unsafe extern "C" fn __cpuinfo_store_cpu_32bit(info: *mut cpuinfo_32bit) {
...
#[no_mangle]
unsafe extern "C" fn __cpuinfo_store_cpu(info: *mut cpuinfo_arm64) {
...
#[no_mangle]
pub unsafe extern "C" fn cpuinfo_store_cpu() {
...
#[no_mangle]
pub unsafe extern "C" fn cpuinfo_store_boot_cpu() -> void __init {
