...
//! Source: arch/arm64/kernel/rsi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rsi_version_matches() -> bool {
...
#[no_mangle]
unsafe extern "C" fn arm64_rsi_setup_memory() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn arm64_rsi_is_protected(base: phys_addr_t, size: usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn realm_ioremap_hook(phys: phys_addr_t, size: usize, prot: *mut pgprot_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arm64_rsi_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn arm64_create_dummy_rsi_dev() -> int __init {
