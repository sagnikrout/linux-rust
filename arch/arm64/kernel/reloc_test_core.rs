...
//! Source: arch/arm64/kernel/reloc_test_core.c
#![no_std]
...
//
    ...
    int sym64_rel;
pub const SYM64_ABS_VAL: c_uint = 0xffff880000cccccc;
pub const SYM32_ABS_VAL: c_uint = 0xf800cccc;
pub const SYM16_ABS_VAL: c_uint = 0xf8cc;
...
#[no_mangle]
unsafe extern "C" fn reloc_test_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn reloc_test_exit() -> void __exit {
