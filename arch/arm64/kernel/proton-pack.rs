...
//! Source: arch/arm64/kernel/proton-pack.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn parse_spectre_v2_param(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_mitigations_off() -> bool {
...
#[no_mangle]
unsafe extern "C" fn _unprivileged_ebpf_enabled() -> bool {
    ...
    char *buf)
    {
    let mut bhb_state: enum mitigation_state = arm64_get_spectre_bhb_state();
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_get_cpu_hw_mitigation_state() -> enum mitigation_state {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_get_cpu_fw_mitigation_state() -> enum mitigation_state {
...
#[no_mangle]
pub unsafe extern "C" fn has_spectre_v2(entry: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arm64_get_spectre_v2_state() -> enum mitigation_state {
...
#[no_mangle]
unsafe extern "C" fn install_bp_hardening_cb(fn: bp_hardening_cb_t) {
...
#[no_mangle]
unsafe extern "C" fn call_smc_arch_workaround_1() -> noinstr void {
...
// Called during entry so must be noinstr
#[no_mangle]
unsafe extern "C" fn call_hvc_arch_workaround_1() -> noinstr void {
...
// Called during entry so must be noinstr
#[no_mangle]
unsafe extern "C" fn qcom_link_stack_sanitisation() -> noinstr void {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_get_sw_mitigation_cb() -> bp_hardening_cb_t {
    static bp_hardening_cb_t spectre_v2_get_sw_mitigation_cb(void)
    {
    let mut midr: u32 = read_cpuid_id();
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_enable_fw_mitigation() -> enum mitigation_state {
...
#[no_mangle]
pub unsafe extern "C" fn spectre_v2_enable_mitigation(__unused: *const arm64_cpu_capabilities) {
...
//
#[no_mangle]
pub unsafe extern "C" fn has_spectre_v3a(entry: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn spectre_v3a_enable_mitigation(__unused: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn parse_spectre_v4_param(str: *mut c_char) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn spectre_v4_mitigations_off() -> bool {
...
#[no_mangle]
unsafe extern "C" fn spectre_v4_mitigations_dynamic() -> bool {
...
#[no_mangle]
unsafe extern "C" fn spectre_v4_mitigations_on() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arm64_get_spectre_v4_state() -> enum mitigation_state {
    enum mitigation_state arm64_get_spectre_v4_state(void)
    {
    return spectre_v4_state;
    }
#[no_mangle]
unsafe extern "C" fn spectre_v4_get_cpu_hw_mitigation_state() -> enum mitigation_state {
...
#[no_mangle]
unsafe extern "C" fn spectre_v4_get_cpu_fw_mitigation_state() -> enum mitigation_state {
...
#[no_mangle]
pub unsafe extern "C" fn has_spectre_v4(cap: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn try_emulate_el1_ssbs(regs: *mut pt_regs, instr: u32) -> bool {
    bool try_emulate_el1_ssbs(struct pt_regs *regs, u32 instr)
    {
    let mut instr_mask: u32 = ~(1U << PSTATE_Imm_shift);
    let mut instr_val: u32 = 0xd500401f | PSTATE_SSBS;
...
#[no_mangle]
unsafe extern "C" fn spectre_v4_enable_hw_mitigation() -> enum mitigation_state {
...
#[no_mangle]
unsafe extern "C" fn spectre_v4_enable_fw_mitigation() -> enum mitigation_state {
    ...
    return state;
    if (spectre_v4_mitigations_off()) {
    arm_smccc_1_1_invoke(ARM_SMCCC_ARCH_WORKAROUND_2, false, core::ptr::null_mut());
    return SPECTRE_VULNERABLE;
    }
    arm_smccc_1_1_invoke(ARM_SMCCC_ARCH_WORKAROUND_2, true, core::ptr::null_mut());
    if (spectre_v4_mitigations_dynamic())
    __this_cpu_write(arm64_ssbd_callback_required, 1);
    return SPECTRE_MITIGATED;
    }
#[no_mangle]
pub unsafe extern "C" fn spectre_v4_enable_mitigation(__unused: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn __update_pstate_ssbs(regs: *mut pt_regs, state: bool) {
    static void __update_pstate_ssbs(struct pt_regs *regs, bool state)
    {
    let mut bit: u64 = compat_user_mode(regs) ? PSR_AA32_SSBS_BIT : PSR_SSBS_BIT;
    if (state)
    regs.pstate |= bit;
    else
    regs.pstate &= ~bit;
...
#[no_mangle]
pub unsafe extern "C" fn spectre_v4_enable_task_mitigation(tsk: *mut task_struct) {
    void spectre_v4_enable_task_mitigation(struct task_struct *tsk)
    {
    struct pt_regs *regs = task_pt_regs(tsk);
    let mut ssbs: bool = false, kthread = tsk.flags & PF_KTHREAD;
    if (spectre_v4_mitigations_off())
    ssbs = true;
#[no_mangle]
pub unsafe extern "C" fn if(!kthread: spectre_v4_mitigations_dynamic() &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ssbd_prctl_enable_mitigation(task: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn ssbd_prctl_disable_mitigation(task: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn ssbd_prctl_set(task: *mut task_struct, ctrl: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssbd_prctl_get(task: *mut task_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arm64_get_spectre_bhb_state() -> enum mitigation_state {
...
//
#[no_mangle]
unsafe extern "C" fn is_spectre_bhb_safe(scope: c_int) -> bool {
    ...
    let mut all_safe: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn spectre_bhb_loop_affected() -> u8 {
    ...
    k = 132;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_midr_in_range_list(spectre_bhb_k38_list)) -> else {
    else if (is_midr_in_range_list(spectre_bhb_k38_list))
    k = 38;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_midr_in_range_list(spectre_bhb_k32_list)) -> else {
    else if (is_midr_in_range_list(spectre_bhb_k32_list))
    k = 32;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_midr_in_range_list(spectre_bhb_k24_list)) -> else {
    else if (is_midr_in_range_list(spectre_bhb_k24_list))
    k = 24;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_midr_in_range_list(spectre_bhb_k11_list)) -> else {
    else if (is_midr_in_range_list(spectre_bhb_k11_list))
    k = 11;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_midr_in_range_list(spectre_bhb_k8_list)) -> else {
    else if (is_midr_in_range_list(spectre_bhb_k8_list))
    k =  8;
    return k;
    }
#[no_mangle]
unsafe extern "C" fn spectre_bhb_get_cpu_fw_mitigation_state() -> enum mitigation_state {
...
#[no_mangle]
unsafe extern "C" fn has_spectre_bhb_fw_mitigation() -> bool {
    static bool has_spectre_bhb_fw_mitigation(void)
    {
    enum mitigation_state fw_state;
    let mut has_smccc: bool = arm_smccc_1_1_get_conduit() != SMCCC_CONDUIT_NONE;
    fw_state = spectre_bhb_get_cpu_fw_mitigation_state();
    return has_smccc && fw_state == SPECTRE_MITIGATED;
    }
#[no_mangle]
unsafe extern "C" fn supports_ecbhb(scope: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn get_spectre_bhb_loop_value() -> u8 {
    u8 get_spectre_bhb_loop_value(void)
    {
    return max_bhb_k;
    }
#[no_mangle]
unsafe extern "C" fn this_cpu_set_vectors(slot: enum arm64_bp_harden_el1_vectors) {
...
#[no_mangle]
unsafe extern "C" fn parse_spectre_bhb_param(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_bhb_mitigations_off() -> bool {
    static bool spectre_bhb_mitigations_off(void)
    {
    return __nospectre_bhb || cpu_mitigations_off();
    }
#[no_mangle]
pub unsafe extern "C" fn spectre_bhb_enable_mitigation(entry: *const arm64_cpu_capabilities) {
    void spectre_bhb_enable_mitigation(const struct arm64_cpu_capabilities *entry)
    {
    bp_hardening_cb_t cpu_cb;
    let mut state: enum mitigation_state = SPECTRE_VULNERABLE;
    struct bp_hardening_data *data = this_cpu_ptr(&bp_hardening_data);
...
//
    ...
    __this_cpu_write(bp_hardening_data.fn, core::ptr::null_mut());
    state = SPECTRE_MITIGATED;
...
#[no_mangle]
pub unsafe extern "C" fn is_spectre_bhb_fw_mitigated() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn spectre_print_disabled_mitigations() {
