...
//! Source: arch/arm64/kernel/machine_kexec.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn machine_kexec_cleanup(kimage: *mut kimage) {
...
//
#[no_mangle]
unsafe extern "C" fn kexec_segment_flush(kimage: *const kimage) {
...
#[no_mangle]
pub unsafe extern "C" fn machine_kexec_post_load(kimage: *mut kimage) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn machine_kexec(kimage: *mut kimage) {
    void machine_kexec(struct kimage *kimage)
    {
    let mut in_kexec_crash: bool = (kimage == kexec_crash_image);
    let mut stuck_cpus: bool = cpus_are_stuck_in_kernel();
//
...
//
#[no_mangle]
pub unsafe extern "C" fn crash_prepare_suspend() {
...
#[no_mangle]
pub unsafe extern "C" fn crash_post_resume() {
...
//
#[no_mangle]
pub unsafe extern "C" fn crash_is_nosave(pfn: c_ulong) -> bool {
