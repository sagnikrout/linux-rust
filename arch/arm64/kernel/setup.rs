...
pub unsafe extern "C" fn arch_match_cpu_phys_id(cpu: c_int, phys_id: u64) -> bool {
    ...
    {
    let mut phys_id: return = = cpu_logical_map(cpu);
    }
...
//
#[no_mangle]
unsafe extern "C" fn smp_build_mpidr_hash() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_machine_fdt(dt_phys: phys_addr_t) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn request_standard_resources() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_arch(cmdline_p: *mut c_char) -> void __init __no_sanitize_address {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_can_disable(cpu: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_cpu_is_hotpluggable(num: c_int) -> bool {
    bool arch_cpu_is_hotpluggable(int num)
    {
    return cpu_can_disable(num);
    }
#[no_mangle]
unsafe extern "C" fn dump_kernel_offset() {
    static void dump_kernel_offset(void)
    {
    let mut offset: c_ulong = kaslr_offset();
...
#[no_mangle]
unsafe extern "C" fn register_arm64_panic_block() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn check_mmu_enabled_at_boot() -> int __init {
