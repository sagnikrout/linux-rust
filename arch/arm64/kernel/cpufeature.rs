...
//! Source: arch/arm64/kernel/cpufeature.c
#![no_std]
...
// Kernel representation of AT_HWCAP and AT_HWCAP2
    ...
    COMPAT_HWCAP_LPAE)
    let mut __read_mostly: unsigned int compat_elf_hwcap = COMPAT_ELF_HWCAP_DEFAULT;
...
//
    let mut __read_mostly: bool arm64_use_ng_mappings = false;
...
#[no_mangle]
pub unsafe extern "C" fn dump_cpu_features() {
...
//
    ...
    let mut no_override: static struct arm64_ftr_override __ro_after_init = { };
...
#[no_mangle]
unsafe extern "C" fn search_cmp_ftr_reg(id: *const c_void, regp: *const c_void) -> c_int {
...
//
    ...
    s64 ftr_val)
    {
    let mut mask: u64 = arm64_ftr_mask(ftrp);
    reg &= ~mask;
...
#[no_mangle]
unsafe extern "C" fn sort_ftr_regs() -> void __init {
...
//
    ...
    let mut width: c_uint = ftr_reg.ftr_bits[j].width;
    let mut shift: c_uint = ftr_reg.ftr_bits[j].shift;
...
//
#[no_mangle]
unsafe extern "C" fn init_cpu_ftr_reg(sys_reg: u32, new: u64) {
    static void init_cpu_ftr_reg(u32 sys_reg, u64 new)
    {
    let mut val: u64 = 0;
    let mut strict_mask: u64 = ~0x0ULL;
    let mut user_mask: u64 = 0;
    ...
    let mut ftr_mask: u64 = arm64_ftr_mask(ftrp);
    let mut ftr_new: i64 = arm64_ftr_value(ftrp, new);
    let mut ftr_ovr: i64 = arm64_ftr_value(ftrp, reg.override.val);
    if ((ftr_mask & reg.override.mask) == ftr_mask) {
    let mut tmp: i64 = arm64_ftr_safe_value(ftrp, ftr_ovr, ftr_new);
...
#[no_mangle]
unsafe extern "C" fn init_cpucap_indirect_list() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_32bit_cpu_features(info: *mut cpuinfo_32bit) {
...
#[no_mangle]
unsafe extern "C" fn early_enable_pseudo_nmi(p: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn detect_system_supports_pseudo_nmi() -> __init void {
...
//
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "arm,gic-v3");
...
#[no_mangle]
unsafe extern "C" fn detect_ftr_has_mpam() -> bool {
    static bool detect_ftr_has_mpam(void)
    {
    let mut pfr0: u64 = read_sanitised_ftr_reg(SYS_ID_AA64PFR0_EL1);
    let mut pfr1: u64 = read_sanitised_ftr_reg(SYS_ID_AA64PFR1_EL1);
    return id_aa64pfr0_mpam(pfr0) || id_aa64pfr1_mpamfrac(pfr1);
    }
#[no_mangle]
pub unsafe extern "C" fn gmid_el1_accessible(info: *const cpuinfo_arm64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn init_cpu_features(info: *mut cpuinfo_arm64) -> void __init {
...
// Before we start using the tables, make sure it is sorted
    ...
    let mut cpacr: c_ulong = cpacr_save_enable_kernel_sve();
    vec_init_vq_map(ARM64_VEC_SVE);
    cpacr_restore(cpacr);
    }
    if (IS_ENABLED(CONFIG_ARM64_SME) &&
    id_aa64pfr1_sme(read_sanitised_ftr_reg(SYS_ID_AA64PFR1_EL1))) {
    let mut cpacr: c_ulong = cpacr_save_enable_kernel_sme();
...
#[no_mangle]
unsafe extern "C" fn update_cpu_ftr_reg(reg: *mut arm64_ftr_reg, new: u64) {
    static void update_cpu_ftr_reg(struct arm64_ftr_reg *reg, u64 new)
    {
    const struct arm64_ftr_bits *ftrp;
    for (ftrp = reg.ftr_bits; ftrp.width; ftrp++) {
    let mut ftr_cur: i64 = arm64_ftr_value(ftrp, reg.sys_val);
    let mut ftr_new: i64 = arm64_ftr_value(ftrp, new);
    if (ftr_cur == ftr_new)
    continue;
// Find a safe value
...
#[no_mangle]
unsafe extern "C" fn check_update_ftr_reg(sys_id: u32, cpu: c_int, val: u64, boot: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn relax_cpu_ftr_reg(sys_id: u32, field: c_int) {
...
// Bogus field?
    ...
    {
    let mut boot_cpu_32bit_regs_overridden: static bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn read_sanitised_ftr_reg(id: u32) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn __read_sysreg_by_encoding(sys_id: u32) -> u64 {
    ...
    int mask;
    struct arm64_ftr_reg *regp;
    let mut val: u64 = read_scoped_sysreg(entry, scope);
...
#[no_mangle]
unsafe extern "C" fn parse_32bit_el0_param(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aarch32_el0_sysfs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn has_32bit_el0(entry: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_useable_gicv3_cpuif(entry: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpu_emulate_effective_ctr(__unused: *const arm64_cpu_capabilities) {
...
//
    ...
    let mut __meltdown_safe: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn has_nv1(entry: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_lpa2_at_stage1(mmfr0: u64) -> bool {
    static bool has_lpa2_at_stage1(u64 mmfr0)
    {
    unsigned int tgran;
    tgran = cpuid_feature_extract_unsigned_field(mmfr0,
    ID_AA64MMFR0_EL1_TGRAN_SHIFT);
    let mut tgran: return = = ID_AA64MMFR0_EL1_TGRAN_LPA2;
    }
#[no_mangle]
unsafe extern "C" fn has_lpa2_at_stage2(mmfr0: u64) -> bool {
    static bool has_lpa2_at_stage2(u64 mmfr0)
    {
    unsigned int tgran;
    tgran = cpuid_feature_extract_unsigned_field(mmfr0,
    ID_AA64MMFR0_EL1_TGRAN_2_SHIFT);
    let mut tgran: return = = ID_AA64MMFR0_EL1_TGRAN_2_SUPPORTED_LPA2;
    }
#[no_mangle]
unsafe extern "C" fn has_lpa2(entry: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_pmuv3(entry: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpu_enable_kpti(cap: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn parse_kpti(str: *mut c_char) -> int __init {
    static int __init parse_kpti(char *str)
    {
    bool enabled;
    let mut ret: c_int = kstrtobool(str, &enabled);
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn __cpu_enable_hw_dbm() {
    static inline void __cpu_enable_hw_dbm(void)
    {
    let mut tcr: u64 = read_sysreg(tcr_el1) | TCR_EL1_HD;
    write_sysreg(tcr, tcr_el1);
    isb();
    local_flush_tlb_all();
    }
#[no_mangle]
unsafe extern "C" fn cpu_has_broken_dbm() -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpu_can_use_dbm(cap: *const arm64_cpu_capabilities) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpu_enable_hw_dbm(cap: *const arm64_cpu_capabilities) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_has_amu_feat(cpu: c_int) -> bool {
    bool cpu_has_amu_feat(int cpu)
    {
    return cpumask_test_cpu(cpu, &amu_cpus);
    }
#[no_mangle]
pub unsafe extern "C" fn get_cpu_with_amu_feat() -> c_int {
    int get_cpu_with_amu_feat(void)
    {
    return cpumask_any(&amu_cpus);
    }
#[no_mangle]
unsafe extern "C" fn cpu_amu_enable(cap: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn runs_at_el2(entry: *const arm64_cpu_capabilities, __unused: c_int) -> bool {
    static bool runs_at_el2(const struct arm64_cpu_capabilities *entry, int __unused)
    {
    return is_kernel_in_hyp_mode();
    }
#[no_mangle]
unsafe extern "C" fn cpu_copy_el2regs(__unused: *const arm64_cpu_capabilities) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_supports_bbml3() -> bool {
...
// Erratum 3683289 fixed in r1p1
    ...
    let mut mmfr2: u64 = __read_sysreg_by_encoding(SYS_ID_AA64MMFR2_EL1);
    if (SYS_FIELD_GET(ID_AA64MMFR2_EL1, BBM, mmfr2) >= ID_AA64MMFR2_EL1_BBM_3)
    return true;
    return is_midr_in_range_list(supports_bbml3_list);
    }
#[no_mangle]
unsafe extern "C" fn has_bbml3(caps: *const arm64_cpu_capabilities, scope: c_int) -> bool {
    static bool has_bbml3(const struct arm64_cpu_capabilities *caps, int scope)
    {
    return cpu_supports_bbml3();
    }
#[no_mangle]
unsafe extern "C" fn cpu_enable_pan(__unused: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn cpu_clear_disr(__unused: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn has_rasv1p1(__unused: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_address_auth_cpucap(entry: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
// Now check for the secondary CPUs with SCOPE_LOCAL_CPU scope
    ...
    int scope)
    {
    let mut api: bool = has_address_auth_cpucap(cpucap_ptrs[ARM64_HAS_ADDRESS_AUTH_IMP_DEF], scope);
    let mut apa: bool = has_address_auth_cpucap(cpucap_ptrs[ARM64_HAS_ADDRESS_AUTH_ARCH_QARMA5], scope);
    let mut apa3: bool = has_address_auth_cpucap(cpucap_ptrs[ARM64_HAS_ADDRESS_AUTH_ARCH_QARMA3], scope);
    return apa || apa3 || api;
    }
    static bool has_generic_auth(const struct arm64_cpu_capabilities *entry,
    int __unused)
    {
    let mut gpi: bool = __system_matches_cap(ARM64_HAS_GENERIC_AUTH_IMP_DEF);
    let mut gpa: bool = __system_matches_cap(ARM64_HAS_GENERIC_AUTH_ARCH_QARMA5);
    let mut gpa3: bool = __system_matches_cap(ARM64_HAS_GENERIC_AUTH_ARCH_QARMA3);
    return gpa || gpa3 || gpi;
    }

#[no_mangle]
unsafe extern "C" fn cpu_enable_e0pd(cap: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn cpu_enable_ls64(cap: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn cpu_enable_ls64_v(cap: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn bti_enable(__unused: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn cpu_enable_mte(cap: *const arm64_cpu_capabilities) {
    static void cpu_enable_mte(struct arm64_cpu_capabilities const *cap)
    {
    let mut cleared_zero_page: static bool = false;
...
#[no_mangle]
unsafe extern "C" fn user_feature_fixup() {
...
#[no_mangle]
unsafe extern "C" fn elf_hwcap_fixup() {
...
#[no_mangle]
unsafe extern "C" fn is_kvm_protected_mode(entry: *const arm64_cpu_capabilities, __unused: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpu_trap_el0_impdef(__unused: *const arm64_cpu_capabilities) {
    static void cpu_trap_el0_impdef(const struct arm64_cpu_capabilities *__unused)
    {
    sysreg_clear_set(sctlr_el1, 0, SCTLR_EL1_TIDCP);
    }
#[no_mangle]
unsafe extern "C" fn cpu_enable_dit(__unused: *const arm64_cpu_capabilities) {
    static void cpu_enable_dit(const struct arm64_cpu_capabilities *__unused)
    {
    set_pstate_dit(1);
    }
#[no_mangle]
unsafe extern "C" fn cpu_enable_mops(__unused: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn cpu_enable_poe(__unused: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn cpu_enable_gcs(__unused: *const arm64_cpu_capabilities) {
...
// Synchronising the EL0 write is left until the ERET to EL0
    ...
    {
    let mut idr: u64 = read_sanitised_ftr_reg(SYS_MPAMIDR_EL1);
...
#[no_mangle]
unsafe extern "C" fn has_sve_feature(cap: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_sme_feature(cap: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn compat_has_neon(cap: *const arm64_cpu_capabilities, scope: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cap_set_elf_hwcap(cap: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn cpus_have_elf_hwcap(cap: *const arm64_cpu_capabilities) -> bool {
...
#[no_mangle]
unsafe extern "C" fn setup_elf_hwcaps(hwcaps: *const arm64_cpu_capabilities) {
...
#[no_mangle]
unsafe extern "C" fn update_cpu_capabilities(scope_mask: u16) {
    ...
    let mut caps_set: bool = false;
    let mut boot_cpu: bool = false;
    caps = cpucap_ptrs[i];
...
//
#[no_mangle]
unsafe extern "C" fn cpu_enable_non_boot_scope_capabilities(__unused: *mut c_void) -> c_int {
    static int cpu_enable_non_boot_scope_capabilities(void *__unused)
    {
    int i;
    let mut non_boot_scope: u16 = SCOPE_ALL & ~SCOPE_BOOT_CPU;
...
//
#[no_mangle]
unsafe extern "C" fn enable_cpu_capabilities(scope_mask: u16) -> void __init {
...
//
    ...
    core::ptr::null_mut(), cpu_online_mask);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn verify_local_cpu_caps(scope_mask: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn check_early_cpu_features() {
...
#[no_mangle]
unsafe extern "C" fn verify_local_elf_hwcaps() {
...
#[no_mangle]
unsafe extern "C" fn verify_sve_features() {
...
#[no_mangle]
unsafe extern "C" fn verify_sme_features() {
...
#[no_mangle]
unsafe extern "C" fn verify_hyp_capabilities() {
...
#[no_mangle]
unsafe extern "C" fn verify_mpam_capabilities() {
    static void verify_mpam_capabilities(void)
    {
    let mut cpu_idr: u64 = read_cpuid(ID_AA64PFR0_EL1);
    let mut sys_idr: u64 = read_sanitised_ftr_reg(SYS_ID_AA64PFR0_EL1);
...
//
#[no_mangle]
unsafe extern "C" fn verify_local_cpu_capabilities() {
...
#[no_mangle]
pub unsafe extern "C" fn check_local_cpu_capabilities() {
...
#[no_mangle]
pub unsafe extern "C" fn this_cpu_has_cap(n: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn __system_matches_cap(n: c_uint) -> bool __maybe_unused {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_set_feature(num: c_uint) {
    void cpu_set_feature(unsigned int num)
    {
    set_bit(num, elf_hwcap);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_have_feature(num: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_get_elf_hwcap() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_get_elf_hwcap2() -> c_ulong {
    unsigned long cpu_get_elf_hwcap2(void)
    {
    return elf_hwcap[1];
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_get_elf_hwcap3() -> c_ulong {
    unsigned long cpu_get_elf_hwcap3(void)
    {
    return elf_hwcap[2];
    }
#[no_mangle]
unsafe extern "C" fn setup_boot_cpu_capabilities() -> void __init {
    static void __init setup_boot_cpu_capabilities(void)
    {
...
#[no_mangle]
pub unsafe extern "C" fn setup_boot_cpu_features() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_system_capabilities() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_system_features() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_user_features() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn enable_mismatched_32bit_el0(cpu: c_uint) -> c_int {
...
//
    let mut lucky_winner: static int = -1;
    struct cpuinfo_arm64 *info = &per_cpu(cpu_data, cpu);
    let mut cpu_32bit: bool = false;
    if (id_aa64pfr0_32bit_el0(info.reg_id_aa64pfr0)) {
...
#[no_mangle]
unsafe extern "C" fn init_32bit_el0_mask() -> int __init {
    ...
    enable_mismatched_32bit_el0, core::ptr::null_mut());
    }
    subsys_initcall_sync(init_32bit_el0_mask);
#[no_mangle]
unsafe extern "C" fn cpu_enable_cnp(cap: *const arm64_cpu_capabilities) -> void __maybe_unused {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_emulated(id: u32) -> bool __attribute_const__ {
...
//
#[no_mangle]
pub unsafe extern "C" fn emulate_id_reg(id: u32, valp: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emulate_sys_reg(id: u32, valp: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_emulate_mrs(regs: *mut pt_regs, sys_reg: u32, rt: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn try_emulate_mrs(regs: *mut pt_regs, insn: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arm64_get_meltdown_state() -> enum mitigation_state {
