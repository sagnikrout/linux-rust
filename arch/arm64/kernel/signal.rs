...
pub struct rt_sigframe_user_layout {
    pub sigframe: *mut rt_sigframe __user,
    pub next_frame: *mut frame_record __user,
    pub /: *mut *mut unsigned long size; / size of allocated sigframe data,
    pub /: *mut *mut unsigned long limit; / largest allowed size,
    pub fpsimd_offset: c_ulong,
    pub esr_offset: c_ulong,
    pub gcs_offset: c_ulong,
    pub sve_offset: c_ulong,
    pub tpidr2_offset: c_ulong,
    pub za_offset: c_ulong,
    pub zt_offset: c_ulong,
    pub fpmr_offset: c_ulong,
    pub poe_offset: c_ulong,
    pub extra_offset: c_ulong,
    pub end_offset: c_ulong,
}
...
//
#[no_mangle]
unsafe extern "C" fn save_reset_user_access_state(ua_state: *mut user_access_state) {
    static void save_reset_user_access_state(struct user_access_state *ua_state)
    {
    if (system_supports_poe()) {
    let mut por_enable_all: u64 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn set_handler_user_access_state() {
...
//
#[no_mangle]
unsafe extern "C" fn restore_user_access_state(ua_state: *const user_access_state) {
...
#[no_mangle]
unsafe extern "C" fn init_user_layout(user: *mut rt_sigframe_user_layout) {
...
#[no_mangle]
unsafe extern "C" fn sigframe_size(user: *const rt_sigframe_user_layout) -> usize {
...
//
    ...
    {
    let mut padded_size: usize = round_up(size, 16);
...
#[no_mangle]
unsafe extern "C" fn sigframe_alloc_end(user: *mut rt_sigframe_user_layout) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct user_ctxs {
    pub fpsimd: *mut fpsimd_context __user,
    pub fpsimd_size: u32,
    pub sve: *mut sve_context __user,
    pub sve_size: u32,
    pub tpidr2: *mut tpidr2_context __user,
    pub tpidr2_size: u32,
    pub za: *mut za_context __user,
    pub za_size: u32,
    pub zt: *mut zt_context __user,
    pub zt_size: u32,
    pub fpmr: *mut fpmr_context __user,
    pub fpmr_size: u32,
    pub poe: *mut poe_context __user,
    pub poe_size: u32,
    pub gcs: *mut gcs_context __user,
    pub gcs_size: u32,
}

#[no_mangle]
unsafe extern "C" fn preserve_fpsimd_context(ctx: *mut fpsimd_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_fpsimd_context(user: *mut user_ctxs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn preserve_fpmr_context(ctx: *mut fpmr_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_fpmr_context(user: *mut user_ctxs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn preserve_sve_context(ctx: *mut sve_context __user) -> c_int {
    static int preserve_sve_context(struct sve_context __user *ctx)
    {
    let mut err: c_int = 0;
    u16 reserved[ARRAY_SIZE(ctx.__reserved)];
    let mut flags: u16 = 0;
    let mut vl: c_uint = task_get_sve_vl(current);
    let mut vq: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn restore_sve_fpsimd_context(user: *mut user_ctxs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn preserve_tpidr2_context(ctx: *mut tpidr2_context __user) -> c_int {
    static int preserve_tpidr2_context(struct tpidr2_context __user *ctx)
    {
    let mut tpidr2_el0: u64 = read_sysreg_s(SYS_TPIDR2_EL0);
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn restore_tpidr2_context(user: *mut user_ctxs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn preserve_za_context(ctx: *mut za_context __user) -> c_int {
    static int preserve_za_context(struct za_context __user *ctx)
    {
    let mut err: c_int = 0;
    u16 reserved[ARRAY_SIZE(ctx.__reserved)];
    let mut vl: c_uint = task_get_sme_vl(current);
    unsigned int vq;
...
#[no_mangle]
unsafe extern "C" fn restore_za_context(user: *mut user_ctxs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn preserve_zt_context(ctx: *mut zt_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_zt_context(user: *mut user_ctxs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn preserve_gcs_context(ctx: *mut gcs_context __user) -> c_int {
    static int preserve_gcs_context(struct gcs_context __user *ctx)
    {
    let mut err: c_int = 0;
    let mut gcspr: u64 = read_sysreg_s(SYS_GCSPR_EL0);
//
...
#[no_mangle]
unsafe extern "C" fn restore_gcs_context(user: *mut user_ctxs) -> c_int {
...
// Turn any non-optimised out attempts to use these into a link error:
    ...
    {
    let mut sc: *mut sigcontext __user const = &sf.uc.uc_mcontext;
    struct _aarch64_ctx __user *head;
    char __user *base = (char __user *)&sc.__reserved;
    let mut offset: usize = 0;
    let mut limit: usize = sizeof(sc.__reserved);
    let mut have_extra_context: bool = false;
    let mut sfp: *const char __user const = (char const __user *)sf;
    user.fpsimd = core::ptr::null_mut();
    user.sve = core::ptr::null_mut();
    user.tpidr2 = core::ptr::null_mut();
    user.za = core::ptr::null_mut();
    user.zt = core::ptr::null_mut();
    user.fpmr = core::ptr::null_mut();
    user.poe = core::ptr::null_mut();
    user.gcs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gcs_restore_signal() -> c_int {
...
// Invalidate the token to prevent reuse
    ...
    let mut ua_state: user_access_state = {};
...
// fault information, if valid
    ...
    let mut vl: c_int = max(sve_max_vl(), sme_max_vl());
    if (!add_all)
...
#[no_mangle]
unsafe extern "C" fn gcs_signal_entry(sigtramp: __sigrestore_t, ksig: *mut ksignal) -> c_int {
...
// Signal handlers are invoked with ZA and streaming mode disabled
    ...
    __put_user_error(core::ptr::null_mut(), &frame.uc.uc_link, err);
...
#[no_mangle]
unsafe extern "C" fn setup_restart_syscall(regs: *mut pt_regs) {
...
pub unsafe extern "C" fn arch_do_signal_or_restart(regs: *mut pt_regs) {
    ...
    {
    let mut continue_addr: c_ulong = 0, restart_addr = 0;
    let mut retval: c_int = 0;
    struct ksignal ksig;
    let mut syscall: bool = in_syscall(regs);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn minsigstksz_setup() -> void __init {
