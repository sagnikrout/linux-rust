...
//! Source: arch/arm64/kernel/kgdb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(1: compiled_break ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn kgdb_brk_handler(regs: *mut pt_regs, esr: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kgdb_compiled_brk_handler(regs: *mut pt_regs, esr: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kgdb_single_step_handler(regs: *mut pt_regs, esr: c_ulong) -> c_int {
