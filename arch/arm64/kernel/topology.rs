...
//! Source: arch/arm64/kernel/topology.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amu_cntr_sample {
    pub arch_const_cycles_prev: u64,
    pub arch_core_cycles_prev: u64,
    pub last_scale_update: c_ulong,
}

    static DEFINE_PER_CPU_SHARED_ALIGNED(struct amu_cntr_sample, cpu_amu_samples);
#[no_mangle]
pub unsafe extern "C" fn update_freq_counters_refs() {
...
#[no_mangle]
pub unsafe extern "C" fn freq_counters_valid(cpu: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn freq_inv_set_max_ratio(cpu: c_int, max_rate: u64) {
...
#[no_mangle]
unsafe extern "C" fn amu_scale_freq_tick() {
...
#[no_mangle]
unsafe extern "C" fn amu_fie_cpu_supported(cpu: c_uint) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn amu_fie_setup(cpus: *const cpumask) {
...
#[no_mangle]
unsafe extern "C" fn cpuhp_topology_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_amu_fie() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cpu_read_corecnt(val: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cpu_read_constcnt(val: *mut c_void) {
...
// (u64 *)val = this_cpu_has_cap(ARM64_WORKAROUND_2457168) ?
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn counters_read_on_cpu(cpu: c_int, func: smp_call_func_t, val: *mut c_void) -> c_int {
...
pub unsafe extern "C" fn cpc_ffh_supported() -> bool {
    ...
    {
    let mut cpu: c_int = get_cpu_with_amu_feat();
//
...
#[no_mangle]
unsafe extern "C" fn amu_read_core_const_ctrs(val: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cpc_ffh_extract_bits(reg: *const cpc_reg, val: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn is_amu_ctr_reg(reg: *const cpc_reg) -> bool {
