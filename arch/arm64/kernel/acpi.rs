...
//! Source: arch/arm64/kernel/acpi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dt_is_stub() -> bool __init {
    static bool __init dt_is_stub(void)
    {
    int node;
    fdt_for_each_subnode(node, initial_boot_params, 0) {
    const char *name = fdt_get_name(initial_boot_params, node, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn acpi_psci_present() -> bool __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_psci_use_hvc() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_fadt_sanity_check() -> int __init {
...
//
    ...
    struct acpi_table_header *facs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __acpi_get_writethrough_mem_attribute() -> pgprot_t {
...
#[no_mangle]
pub unsafe extern "C" fn __acpi_get_mem_attribute(addr: phys_addr_t) -> pgprot_t {
...
//
    ...
    {
    efi_memory_desc_t *md, *region = core::ptr::null_mut();
    pgprot_t prot;
    if (WARN_ON_ONCE(!efi_enabled(EFI_MEMMAP)))
    return core::ptr::null_mut();
    for_each_efi_memory_desc(md) {
    let mut end: u64 = md.phys_addr + (md.num_pages << EFI_PAGE_SHIFT);
...
//
    ...
    prot = PAGE_KERNEL;
#[no_mangle]
pub unsafe extern "C" fn if(EFI_MEMORY_WC: region->attribute &) -> else {
    else if (region.attribute & EFI_MEMORY_WC)
    prot = __pgprot(PROT_NORMAL_NC);
#[no_mangle]
pub unsafe extern "C" fn if(EFI_MEMORY_WT: region->attribute &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn apei_claim_sea(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arch_reserve_mem_area(addr: acpi_physical_address, size: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn get_cpu_for_acpi_id(uid: u32) -> c_int {
