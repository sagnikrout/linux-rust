...
//! Source: arch/arm64/kernel/module.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn do_reloc(reloc_op: enum aarch64_reloc_op, place: *mut __le32, val: u64) -> u64 {
...
// (place) = __val;					\
    ...
    struct module *me)
    {
    let mut sval: i64 = do_reloc(op, place, val);
//
...
//
    ...
    u64 imm;
    s64 sval;
    let mut insn: u32 = le32_to_cpu(*place);
...
#[no_mangle]
pub unsafe extern "C" fn __init_plt(plt: *mut plt_entry, addr: c_ulong) {
