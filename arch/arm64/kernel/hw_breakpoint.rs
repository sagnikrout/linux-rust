...
//! Source: arch/arm64/kernel/hw_breakpoint.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hw_breakpoint_slots(type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_wb_reg(reg: c_int, n: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn write_wb_reg(reg: c_int, n: c_int, val: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn debug_exception_level(privilege: c_int) -> enum dbg_active_el {
...
#[no_mangle]
unsafe extern "C" fn is_compat_bp(bp: *mut perf_event) -> c_int {
...
// slot = NULL;
    ...
    let mut dbg_el: enum dbg_active_el = debug_exception_level(info.ctrl.privilege);
    u32 ctrl;
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_install_hw_breakpoint(bp: *mut perf_event) -> c_int {
    int arch_install_hw_breakpoint(struct perf_event *bp)
    {
    return hw_breakpoint_control(bp, HW_BREAKPOINT_INSTALL);
    }
#[no_mangle]
pub unsafe extern "C" fn arch_uninstall_hw_breakpoint(bp: *mut perf_event) {
    void arch_uninstall_hw_breakpoint(struct perf_event *bp)
    {
    hw_breakpoint_control(bp, HW_BREAKPOINT_UNINSTALL);
    }
#[no_mangle]
unsafe extern "C" fn get_hbp_len(hbp_len: u8) -> c_int {
    static int get_hbp_len(u8 hbp_len)
    {
    let mut len_in_bytes: c_uint = 0;
    switch (hbp_len) {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_check_bp_in_kernelspace(hw: *mut arch_hw_breakpoint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn toggle_bp_registers(reg: c_int, el: enum dbg_active_el, enable: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn do_breakpoint(esr: c_ulong, regs: *mut pt_regs) {
...
//
    ...
    return wp_low - addr;
#[no_mangle]
pub unsafe extern "C" fn if(wp_high: addr >) -> else {
    ...
    struct pt_regs *regs)
    {
    let mut step: c_int = is_default_overflow_handler(wp);
...
#[no_mangle]
pub unsafe extern "C" fn do_watchpoint(addr: c_ulong, esr: c_ulong, regs: *mut pt_regs) {
    void do_watchpoint(unsigned long addr, unsigned long esr, struct pt_regs *regs)
    {
    int i, step = 0, *kernel_step, access, closest_match = 0;
    let mut min_dist: u64 = -1, dist;
    u32 ctrl_reg;
    u64 val;
...
//
#[no_mangle]
pub unsafe extern "C" fn try_step_suspended_breakpoints(regs: *mut pt_regs) -> bool {
    bool try_step_suspended_breakpoints(struct pt_regs *regs)
    {
    struct debug_info *debug_info = &current.thread.debug;
    int *kernel_step = this_cpu_ptr(&stepping_kernel_bp);
    let mut handled_exception: bool = false;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn hw_breakpoint_thread_switch(next: *mut task_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_breakpoint_reset(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arch_hw_breakpoint_init() -> int __init {
...
//
    ...
    hw_breakpoint_reset, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
pub unsafe extern "C" fn hw_breakpoint_pmu_read(bp: *mut perf_event) {
