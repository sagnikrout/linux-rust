...
#[no_mangle]
unsafe extern "C" fn alloc_gcs(addr: c_ulong, size: c_ulong) -> c_ulong {
    static unsigned long alloc_gcs(unsigned long addr, unsigned long size)
    {
    return vm_mmap_shadow_stack(addr, size, 0);
    }
#[no_mangle]
unsafe extern "C" fn gcs_size(size: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn gcs_set_el0_mode(task: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn gcs_free(task: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn arch_set_shadow_stack_status(task: *mut task_struct, arg: c_ulong) -> c_int {
