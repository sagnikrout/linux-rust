...
#[no_mangle]
unsafe extern "C" fn data_abort_decode(esr: c_ulong) {
    static void data_abort_decode(unsigned long esr)
    {
    let mut iss2: c_ulong = ESR_ELx_ISS2(esr);
...
#[no_mangle]
unsafe extern "C" fn mem_abort_decode(esr: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn mm_to_pgd_phys(mm: *mut mm_struct) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn is_el1_instruction_abort(esr: c_ulong) -> bool {
    static bool is_el1_instruction_abort(unsigned long esr)
    {
    return ESR_ELx_EC(esr) == ESR_ELx_EC_IABT_CUR;
    }
#[no_mangle]
unsafe extern "C" fn is_el1_data_abort(esr: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_pkvm_stage2_abort(esr: c_uint) -> bool {
...
//
    let mut is_write: bool = !!(esr & ESR_ELx_WNR);
...
#[no_mangle]
unsafe extern "C" fn is_el1_mte_sync_tag_check_fault(esr: c_ulong) -> bool {
    static bool is_el1_mte_sync_tag_check_fault(unsigned long esr)
    {
    let mut fsc: c_ulong = esr & ESR_ELx_FSC;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_el1_instruction_abort(esr)) -> else {
    else if (is_el1_instruction_abort(esr))
    msg = "execute from non-executable memory";
    else
    msg = "read from unreadable memory";
    } else if (addr < PAGE_SIZE) {
    msg = "core::ptr::null_mut() pointer dereference";
...
#[no_mangle]
unsafe extern "C" fn set_thread_esr(address: c_ulong, esr: c_ulong) {
...
//
    ...
    struct pt_regs *regs)
    {
    let mut addr: c_ulong = untagged_addr(far);
//
...
#[no_mangle]
unsafe extern "C" fn fault_from_pkey(vma: *mut vm_area_struct, mm_flags: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_gcs_fault(esr: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_el0_instruction_abort(esr: c_ulong) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn is_write_abort(esr: c_ulong) -> bool {
    static bool is_write_abort(unsigned long esr)
    {
    return (esr & ESR_ELx_WNR) && !(esr & ESR_ELx_CM);
    }
#[no_mangle]
unsafe extern "C" fn is_invalid_gcs_access(vma: *mut vm_area_struct, esr: u64) -> bool {
...
// Only GCS operations can write to a GCS page
    ...
    vm_fault_t fault;
    vm_flags_t vm_flags;
    let mut mm_flags: c_uint = FAULT_FLAG_DEFAULT;
    let mut addr: c_ulong = untagged_addr(far);
    struct vm_area_struct *vma;
    int si_code;
    let mut pkey: c_int = -1;
...
#[no_mangle]
unsafe extern "C" fn do_bad(far: c_ulong, esr: c_ulong, regs: *mut pt_regs) -> c_int {
    static int do_bad(unsigned long far, unsigned long esr, struct pt_regs *regs)
    {
    return 1; /* "fault" */
    }
#[no_mangle]
unsafe extern "C" fn do_sea(far: c_ulong, esr: c_ulong, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_mem_abort(far: c_ulong, esr: c_ulong, regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn do_sp_pc_abort(addr: c_ulong, esr: c_ulong, regs: *mut pt_regs) {
...
//
    ...
    unsigned long vaddr)
    {
    let mut flags: gfp_t = GFP_HIGHUSER_MOVABLE | __GFP_ZERO;
//
...
#[no_mangle]
pub unsafe extern "C" fn tag_clear_highpages(page: *mut page, numpages: c_int, clear_pages: bool) -> bool {
