...
//
    let mut __ro_after_init: s64 memstart_addr = -1;
...
#[no_mangle]
unsafe extern "C" fn max_zone_phys(zone_limit: phys_addr_t) -> phys_addr_t __init {
...
#[no_mangle]
unsafe extern "C" fn dma_limits_init() -> void __init {
    ...
    dt_zone_dma_limit = of_dma_get_max_cpu_address(core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn pfn_is_map_memory(pfn: c_ulong) -> c_int {
    int pfn_is_map_memory(unsigned long pfn)
    {
    let mut addr: phys_addr_t = PFN_PHYS(pfn);
// avoid false positives for bogus PFNs, see comment in pfn_valid()
    ...
    let mut __ro_after_init: static phys_addr_t memory_limit = PHYS_ADDR_MAX;
//
...
#[no_mangle]
pub unsafe extern "C" fn arm64_memblock_init() -> void __init {
    void __init arm64_memblock_init(void)
    {
    let mut linear_region_size: i64 = PAGE_END - _PAGE_OFFSET(vabits_actual);
//
...
//
    let mut base: phys_addr_t = phys_initrd_start & PAGE_MASK;
    let mut size: resource_size_t = PAGE_ALIGN(phys_initrd_start + phys_initrd_size) - base;
//
...
#[no_mangle]
pub unsafe extern "C" fn bootmem_init() -> void __init {
...
pub unsafe extern "C" fn arch_mm_preinit() -> void __init {
    ...
    {
    let mut flags: c_uint = SWIOTLB_VERBOSE;
...
#[no_mangle]
pub unsafe extern "C" fn dump_mem_limit() {
...
pub unsafe extern "C" fn cc_platform_has(attr: enum cc_attr) -> bool {
    ...
    let mut __ro_after_init: static u64 module_direct_base = 0;
    let mut __ro_after_init: static u64 module_plt_base = 0;
//
// Choose a random page-aligned base address for a window of 'size' bytes which
// entirely contains the interval [start, end - 1].
//
#[no_mangle]
unsafe extern "C" fn random_bounding_box(size: u64, start: u64, end: u64) -> u64 __init {
...
//
#[no_mangle]
unsafe extern "C" fn module_init_limits() -> int __init {
    static int __init module_init_limits(void)
    {
    let mut kernel_end: u64 = (u64)_end;
    let mut kernel_start: u64 = (u64)_text;
    let mut kernel_size: u64 = kernel_end - kernel_start;
//
...
//
    ...
    let mut min: u64 = kernel_start;
    let mut max: u64 = kernel_end;
