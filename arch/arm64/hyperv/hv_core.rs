...
//! Source: arch/arm64/hyperv/hv_core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_do_hypercall(control: u64, input: *mut c_void, output: *mut c_void) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_do_fast_hypercall8(code: u16, input: u64) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_do_fast_hypercall16(code: u16, input1: u64, input2: u64) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_set_vpreg(msr: u32, value: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_get_vpreg_128(msr: u32, result: *mut hv_get_vp_registers_output) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_get_vpreg(msr: u32) -> u64 {
