...
//! Source: arch/arm64/hyperv/mshyperv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hyperv_detect_via_acpi() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn hyperv_detect_via_smccc() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn hyperv_init() -> int __init {
