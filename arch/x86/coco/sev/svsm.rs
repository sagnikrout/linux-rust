...
//! Source: arch/x86/coco/sev/svsm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn svsm_perform_ghcb_protocol(ghcb: *mut ghcb, call: *mut svsm_call) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svsm_perform_call_protocol(call: *mut svsm_call) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svsm_pval_terminate(pc: *mut svsm_pvalidate_call, ret: c_int, svsm_ret: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn svsm_pval_pages(desc: *mut snp_psc_desc) {
...
#[no_mangle]
unsafe extern "C" fn update_attest_input(call: *mut svsm_call, input: *mut svsm_attest_call) {
...
//
#[no_mangle]
pub unsafe extern "C" fn snp_svsm_vtpm_send_command(buffer: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snp_svsm_vtpm_probe() -> bool {
