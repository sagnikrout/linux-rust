...
//! Source: arch/x86/events/utils.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn decode_branch_type(insn: *mut insn) -> c_int {
...
//
    ...
    let mut ret: c_int = X86_BR_NONE;
    int to_plm, from_plm;
    u8 buf[MAX_INSN_SIZE];
    let mut is64: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn branch_type(from: c_ulong, to: c_ulong, abort: c_int) -> c_int {
    int branch_type(unsigned long from, unsigned long to, int abort)
    {
    return get_branch_type(from, to, abort, false, core::ptr::null_mut());
    }
...
pub const X86_BR_TYPE_MAP_MAX: c_int = 16;
...
#[no_mangle]
pub unsafe extern "C" fn common_branch_type(type: c_int) -> c_int {
