...
//
#[no_mangle]
pub unsafe extern "C" fn x86_perf_event_update(event: *mut perf_event) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn x86_pmu_extra_regs(config: u64, event: *mut perf_event) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_possible_counter_mask() -> u64 {
    static inline u64 get_possible_counter_mask(void)
    {
    let mut cntr_mask: u64 = x86_pmu.cntr_mask64;
    int i;
    if (!is_hybrid())
    return cntr_mask;
...
#[no_mangle]
unsafe extern "C" fn reserve_pmc_hardware() -> bool {
    static bool reserve_pmc_hardware(void)
    {
    let mut cntr_mask: u64 = get_possible_counter_mask();
    int i, end;
...
#[no_mangle]
unsafe extern "C" fn release_pmc_hardware() {
    ...
    let mut bios_fail: c_int = 0;
    let mut reg_safe: c_int = -1;
//
...
#[no_mangle]
pub unsafe extern "C" fn hw_perf_lbr_event_destroy(event: *mut perf_event) {
...
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_initialized() -> c_int {
    static inline int x86_pmu_initialized(void)
    {
    return x86_pmu.handle_irq != core::ptr::null_mut();
    }
    static inline int
...
#[no_mangle]
pub unsafe extern "C" fn x86_reserve_hardware() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn x86_release_hardware() {
...
//
#[no_mangle]
pub unsafe extern "C" fn x86_add_exclusive(what: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn x86_del_exclusive(what: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn x86_setup_perfctr(event: *mut perf_event) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn precise_br_compat(event: *mut perf_event) -> c_int {
    static inline int precise_br_compat(struct perf_event *event)
    {
    let mut m: u64 = event.attr.branch_sample_type;
    let mut b: u64 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_max_precise(pmu: *mut pmu) -> c_int {
    int x86_pmu_max_precise(struct pmu *pmu)
    {
    let mut precise: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_hw_config(event: *mut perf_event) -> c_int {
    int x86_pmu_hw_config(struct perf_event *event)
    {
    if (event.attr.precise_ip) {
    let mut precise: c_int = x86_pmu_max_precise(event.pmu);
...
//
    ...
    let mut left: i64 = event.attr.sample_period;
...
//
#[no_mangle]
unsafe extern "C" fn __x86_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_disable_all() {
...
//
#[no_mangle]
unsafe extern "C" fn x86_pmu_disable(pmu: *mut pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_enable_all(added: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn is_x86_event(event: *mut perf_event) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sched_state {
    pub weight: c_int,
    pub /: *mut *mut int event; / event index,
    pub /: *mut *mut int counter; / counter index,
    pub /: *mut *mut int unassigned; / number of events to be assigned left,
    pub /: *mut *mut int nr_gp; / number of GP counters used,
    pub used: u64,
}

// Total max is X86_PMC_IDX_MAX, but we are O(n!) limited
pub const SCHED_STATES_MAX: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct perf_sched {
    ...
    pub max_gp: c_int,
    pub saved_states: c_int,
    pub constraints: *mut event_constraint,
    pub state: sched_state,
    pub saved: [sched_state; SCHED_STATES_MAX],
}
...
#[no_mangle]
unsafe extern "C" fn perf_sched_save_state(sched: *mut perf_sched) {
...
#[no_mangle]
unsafe extern "C" fn perf_sched_restore_state(sched: *mut perf_sched) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn __perf_sched_find_counter(sched: *mut perf_sched) -> bool {
...
#[no_mangle]
unsafe extern "C" fn perf_sched_find_counter(sched: *mut perf_sched) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn perf_sched_next_event(sched: *mut perf_sched) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn x86_schedule_events(cpuc: *mut cpu_hw_events, n: c_int, assign: *mut c_int) -> c_int {
...
// slow path
    if (i != n) {
    let mut gpmax: c_int = x86_pmu_max_num_counters(cpuc.pmu);
//
...
//
    ...
    cpuc.event_constraint[i] = core::ptr::null_mut();
    }
    }
    ...
    int max_count, int n)
    {
    let mut intel_cap: union perf_capabilities = hybrid(cpuc.pmu, intel_cap);
...
//
#[no_mangle]
unsafe extern "C" fn collect_events(cpuc: *mut cpu_hw_events, leader: *mut perf_event, dogrp: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn x86_perf_rdpmc_index(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_enable(pmu: *mut pmu) {
    ...
    return;
    if (cpuc.n_added) {
    let mut n_running: c_int = cpuc.n_events - cpuc.n_added;
//
...
//
    ...
    cpuc.events[hwc.idx] = core::ptr::null_mut();
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn if(n_running: i <) -> else {
    else if (i < n_running)
    continue;
...
//
#[no_mangle]
pub unsafe extern "C" fn x86_perf_event_set_period(event: *mut perf_event) -> c_int {
    int x86_perf_event_set_period(struct perf_event *event)
    {
    struct hw_perf_event *hwc = &event.hw;
    let mut left: i64 = local64_read(&hwc.period_left);
    let mut period: i64 = hwc.sample_period;
    let mut ret: c_int = 0, idx = hwc.idx;
    if (unlikely(!hwc.event_base))
    return 0;
//
...
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_enable_event(event: *mut perf_event) {
...
//
#[no_mangle]
unsafe extern "C" fn x86_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_start(event: *mut perf_event, flags: c_int) {
    static void x86_pmu_start(struct perf_event *event, int flags)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
...
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_del(event: *mut perf_event, flags: c_int) {
...
//
    x86_pmu_stop(event, PERF_EF_UPDATE);
    cpuc.events[event.hw.idx] = core::ptr::null_mut();
    for (i = 0; i < cpuc.n_events; i++) {
...
// Delete the array entry.
    ...
    cpuc.event_constraint[i-1] = core::ptr::null_mut();
    --cpuc.n_events;
...
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_handle_irq(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn perf_events_lapic_init() {
...
#[no_mangle]
pub unsafe extern "C" fn perf_load_guest_lvtpc(guest_lvtpc: u32) {
    void perf_load_guest_lvtpc(u32 guest_lvtpc)
    {
    let mut masked: u32 = guest_lvtpc & APIC_LVT_MASKED;
...
#[no_mangle]
pub unsafe extern "C" fn perf_put_guest_lvtpc() {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_prepare_cpu(cpu: c_uint) -> c_int {
    static int x86_pmu_prepare_cpu(unsigned int cpu)
    {
    struct cpu_hw_events *cpuc = &per_cpu(cpu_hw_events, cpu);
    int i;
    for (i = 0 ; i < X86_PERF_KFREE_MAX; i++)
    cpuc.kfree_on_online[i] = core::ptr::null_mut();
    if (x86_pmu.cpu_prepare)
    return x86_pmu.cpu_prepare(cpu);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn x86_pmu_dead_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_online_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_dying_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_check_apic() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn events_sysfs_show(dev: *mut device, attr: *mut device_attribute, page: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn x86_event_sysfs_show(page: *mut c_char, config: u64, event: u64) -> isize {
    ssize_t x86_event_sysfs_show(char *page, u64 config, u64 event)
    {
    let mut umask: u64 = (config & ARCH_PERFMON_EVENTSEL_UMASK) >> 8;
    let mut cmask: u64 = (config & ARCH_PERFMON_EVENTSEL_CMASK) >> 24;
    let mut edge: bool = (config & ARCH_PERFMON_EVENTSEL_EDGE);
    let mut pc: bool = (config & ARCH_PERFMON_EVENTSEL_PIN_CONTROL);
    let mut any: bool = (config & ARCH_PERFMON_EVENTSEL_ANY);
    let mut inv: bool = (config & ARCH_PERFMON_EVENTSEL_INV);
    ssize_t ret;
//
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_static_call_update() {
...
#[no_mangle]
unsafe extern "C" fn _x86_pmu_read(event: *mut perf_event) {
    static void _x86_pmu_read(struct perf_event *event)
    {
    static_call(x86_pmu_update)(event);
    }
#[no_mangle]
pub unsafe extern "C" fn x86_pmu_show_pmu_cap(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_free_hybrid() {
    ...
    x86_pmu.hybrid_pmu = core::ptr::null_mut();
    x86_pmu.num_hybrid_pmus = 0;
    }
#[no_mangle]
unsafe extern "C" fn init_hw_perf_events() -> int __init {
...
// enable userspace RDPMC usage by default
    ...
    0, x86_pmu_num_counters(core::ptr::null_mut()), 0, 0);
    x86_pmu_format_group.attrs = x86_pmu.format_attrs;
    if (!x86_pmu.events_sysfs_show)
    x86_pmu_events_group.attrs = &empty_attrs;
    pmu.attr_update = x86_pmu.attr_update;
    if (!is_hybrid())
    x86_pmu_show_pmu_cap(core::ptr::null_mut());
    if (!x86_pmu.read)
...
//
    ...
    x86_pmu_online_cpu, core::ptr::null_mut());
    if (err)
    goto out1;
    if (!is_hybrid()) {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_read(event: *mut perf_event) {
...
//
#[no_mangle]
unsafe extern "C" fn x86_pmu_start_txn(pmu: *mut pmu, txn_flags: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn x86_pmu_cancel_txn(pmu: *mut pmu) {
...
//
#[no_mangle]
unsafe extern "C" fn x86_pmu_commit_txn(pmu: *mut pmu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn free_fake_cpuc(cpuc: *mut cpu_hw_events) {
...
//
#[no_mangle]
unsafe extern "C" fn validate_event(event: *mut perf_event) -> c_int {
...
unsafe extern "C" fn validate_group(event: *mut perf_event) -> c_int {
    ...
    struct cpu_hw_events *fake_cpuc;
    let mut ret: c_int = -EINVAL, n;
//
// Reject events from different hybrid PMUs.
//
    if (is_hybrid()) {
    struct perf_event *sibling;
    struct pmu *pmu = core::ptr::null_mut();
    if (is_x86_event(leader))
    pmu = leader.pmu;
    ...
    pmu = sibling.pmu;
#[no_mangle]
pub unsafe extern "C" fn if(sibling->pmu: pmu !=) -> else {
...
//
    ...
    ret = x86_pmu.schedule_events(fake_cpuc, n, core::ptr::null_mut());
    out:
    free_fake_cpuc(fake_cpuc);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn x86_pmu_event_init(event: *mut perf_event) -> c_int {
    static int x86_pmu_event_init(struct perf_event *event)
    {
    struct x86_hybrid_pmu *pmu = core::ptr::null_mut();
    int err;
    if ((event.attr.type != event.pmu.type) &&
...
#[no_mangle]
pub unsafe extern "C" fn perf_clear_dirty_counters() {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_event_mapped(event: *mut perf_event, mm: *mut mm_struct) {
...
//
    ...
    on_each_cpu_mask(mm_cpumask(mm), cr4_update_pce, core::ptr::null_mut(), 1);
    }
#[no_mangle]
unsafe extern "C" fn x86_pmu_event_unmapped(event: *mut perf_event, mm: *mut mm_struct) {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_event_idx(event: *mut perf_event) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(X86_USER_RDPMC_NEVER_ENABLE: x86_pmu.attr_rdpmc ==) -> else {
    else if (x86_pmu.attr_rdpmc == X86_USER_RDPMC_NEVER_ENABLE)
    static_branch_dec(&rdpmc_never_available_key);
    if (val == 2)
    static_branch_inc(&rdpmc_always_available_key);
#[no_mangle]
pub unsafe extern "C" fn if(X86_USER_RDPMC_ALWAYS_ENABLE: x86_pmu.attr_rdpmc ==) -> else {
    else if (x86_pmu.attr_rdpmc == X86_USER_RDPMC_ALWAYS_ENABLE)
    static_branch_dec(&rdpmc_always_available_key);
    on_each_cpu(cr4_update_pce, core::ptr::null_mut(), 1);
...
#[no_mangle]
pub unsafe extern "C" fn perf_check_microcode() {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_check_period(event: *mut perf_event, value: u64) -> c_int {
    static int x86_pmu_check_period(struct perf_event *event, u64 value)
    {
    if (x86_pmu.check_period && x86_pmu.check_period(event, value))
    return -EINVAL;
    if (value && x86_pmu.limit_period) {
    let mut left: i64 = value;
    x86_pmu.limit_period(event, &left);
    if (left > value)
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_aux_output_match(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_filter(pmu: *mut pmu, cpu: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn perf_hw_regs(regs: *mut pt_regs) -> bool {
...
// TODO: We don't support guest os callchain now
    ...
    return;
    unwind_start(&state, current, regs, core::ptr::null_mut());
    } else {
    unwind_start(&state, current, core::ptr::null_mut(), (void *)regs.sp);
    }
...
#[no_mangle]
unsafe extern "C" fn get_segment_base(segment: c_uint) -> c_ulong {
    static unsigned long get_segment_base(unsigned int segment)
    {
    struct desc_struct *desc;
    let mut idx: c_uint = segment >> 3;
...
//
#[no_mangle]
unsafe extern "C" fn code_segment_base(regs: *mut pt_regs) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn common_misc_flags(regs: *mut pt_regs) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn guest_misc_flags(regs: *mut pt_regs) -> c_ulong {
    static unsigned long guest_misc_flags(struct pt_regs *regs)
    {
    let mut guest_state: c_ulong = perf_guest_state();
...
#[no_mangle]
unsafe extern "C" fn host_misc_flags(regs: *mut pt_regs) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn perf_arch_guest_misc_flags(regs: *mut pt_regs) -> c_ulong {
    unsigned long perf_arch_guest_misc_flags(struct pt_regs *regs)
    {
    let mut flags: c_ulong = common_misc_flags(regs);
...
#[no_mangle]
pub unsafe extern "C" fn perf_get_x86_pmu_capability(cap: *mut x86_pmu_capability) {
...
//
    ...
    cap.num_counters_gp	= x86_pmu_num_counters(core::ptr::null_mut());
    cap.num_counters_fixed	= x86_pmu_num_counters_fixed(core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn perf_get_hw_event_config(hw_event: c_int) -> u64 {
    u64 perf_get_hw_event_config(int hw_event)
    {
    let mut max: c_int = x86_pmu.max_events;
    if (hw_event < max)
