...
//! Source: arch/x86/events/zhaoxin/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn zhaoxin_pmu_disable_all() {
    static void zhaoxin_pmu_disable_all(void)
    {
    wrmsrq(MSR_CORE_PERF_GLOBAL_CTRL, 0);
    }
#[no_mangle]
unsafe extern "C" fn zhaoxin_pmu_enable_all(added: c_int) {
    static void zhaoxin_pmu_enable_all(int added)
    {
    wrmsrq(MSR_CORE_PERF_GLOBAL_CTRL, x86_pmu.intel_ctrl);
    }
#[no_mangle]
pub unsafe extern "C" fn zhaoxin_pmu_get_status() -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn zhaoxin_pmu_ack_status(ack: u64) {
    static inline void zhaoxin_pmu_ack_status(u64 ack)
    {
    wrmsrq(MSR_CORE_PERF_GLOBAL_OVF_CTRL, ack);
    }
#[no_mangle]
pub unsafe extern "C" fn zxc_pmu_ack_status(ack: u64) {
...
#[no_mangle]
unsafe extern "C" fn zhaoxin_pmu_disable_fixed(hwc: *mut hw_perf_event) {
    static void zhaoxin_pmu_disable_fixed(struct hw_perf_event *hwc)
    {
    let mut idx: c_int = hwc.idx - INTEL_PMC_IDX_FIXED;
    u64 ctrl_val, mask;
    mask = 0xfULL << (idx * 4);
...
#[no_mangle]
unsafe extern "C" fn zhaoxin_pmu_disable_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn zhaoxin_pmu_enable_fixed(hwc: *mut hw_perf_event) {
...
#[no_mangle]
unsafe extern "C" fn zhaoxin_pmu_enable_event(event: *mut perf_event) {
...
//
#[no_mangle]
unsafe extern "C" fn zhaoxin_pmu_handle_irq(regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zhaoxin_pmu_event_map(hw_event: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn zhaoxin_event_sysfs_show(page: *mut c_char, config: u64) -> isize {
...
#[no_mangle]
unsafe extern "C" fn zhaoxin_arch_events_quirk() -> __init void {
...
#[no_mangle]
pub unsafe extern "C" fn zhaoxin_pmu_init() -> __init int {
...
// Clearing status works only if the global control is enable on zxc.
    ...
    c.weight += x86_pmu_num_counters(core::ptr::null_mut());
    }
    }
    return 0;
    }
