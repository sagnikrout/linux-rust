...
//! Source: arch/x86/events/intel/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_event_map(hw_event: c_int) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn __intel_pmu_disable_all(bts: bool) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_disable_all() -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn __intel_pmu_enable_all(added: c_int, pmi: bool) {
    static void __intel_pmu_enable_all(int added, bool pmi)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    let mut intel_ctrl: u64 = hybrid(cpuc.pmu, intel_ctrl);
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_enable_all(added: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn intel_pmu_nhm_workaround() {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_nhm_enable_all(added: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_set_tfa(cpuc: *mut cpu_hw_events, on: bool) {
    static void intel_set_tfa(struct cpu_hw_events *cpuc, bool on)
    {
    let mut val: u64 = on ? MSR_TFA_RTM_FORCE_ABORT : 0;
...
#[no_mangle]
unsafe extern "C" fn intel_tfa_commit_scheduling(cpuc: *mut cpu_hw_events, idx: c_int, cntr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_tfa_pmu_enable_all(added: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_get_status() -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_ack_status(ack: u64) {
    static inline void intel_pmu_ack_status(u64 ack)
    {
    wrmsrq(MSR_CORE_PERF_GLOBAL_OVF_CTRL, ack);
    }
#[no_mangle]
pub unsafe extern "C" fn event_is_checkpointed(event: *mut perf_event) -> bool {
    static inline bool event_is_checkpointed(struct perf_event *event)
    {
    return unlikely(event.hw.config & HSW_IN_TX_CHECKPOINTED) != 0;
    }
#[no_mangle]
pub unsafe extern "C" fn intel_set_masks(event: *mut perf_event, idx: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_clear_masks(event: *mut perf_event, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_disable_fixed(event: *mut perf_event) {
...
#[no_mangle]
pub unsafe extern "C" fn __intel_pmu_update_event_ext(idx: c_int, ext: u64) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_disable_event_ext(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_disable_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_assign_event(event: *mut perf_event, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_needs_branch_stack(event: *mut perf_event) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_del_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn icl_set_topdown_event_period(event: *mut perf_event) -> c_int {
    static int icl_set_topdown_event_period(struct perf_event *event)
    {
    struct hw_perf_event *hwc = &event.hw;
    let mut left: i64 = local64_read(&hwc.period_left);
//
...
#[no_mangle]
pub unsafe extern "C" fn icl_get_metrics_event_value(metric: u64, slots: u64, idx: c_int) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn intel_update_topdown_event(event: *mut perf_event, metric_end: c_int, val: *mut u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn icl_update_topdown_event(event: *mut perf_event, val: *mut u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_read_event(event: *mut perf_event) {
    static void intel_pmu_read_event(struct perf_event *event)
    {
    if (event.hw.flags & (PERF_X86_EVENT_AUTO_RELOAD | PERF_X86_EVENT_TOPDOWN) ||
    is_pebs_counter_event_group(event)) {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    let mut pmu_enabled: bool = cpuc.enabled;
...
//
    ...
    static_call(intel_pmu_update_topdown_event)(event, core::ptr::null_mut());
    else
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_enable_fixed(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_config_acr(idx: c_int, mask: u64, reload: u32) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_enable_acr(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_enable_event_ext(event: *mut perf_event) {
    ...
    if (event.attr.precise_ip) {
    let mut pebs_data_cfg: u64 = intel_get_arch_pebs_data_config(event);
    let mut cap: arch_pebs_cap = hybrid(cpuc.pmu, arch_pebs_cap);
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_update_rdpmc_user_disable(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_enable_event(event: *mut perf_event) {
    static void intel_pmu_enable_event(struct perf_event *event)
    {
    let mut enable_mask: u64 = ARCH_PERFMON_EVENTSEL_ENABLE;
    struct hw_perf_event *hwc = &event.hw;
    let mut idx: c_int = hwc.idx;
    if (unlikely(event.attr.precise_ip))
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !event->attr.precise_ip) -> else {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_acr_late_setup(cpuc: *mut cpu_hw_events) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_late_setup() {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_add_event(event: *mut perf_event) {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_save_and_restart(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_set_period(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_update(event: *mut perf_event) -> u64 {
    static u64 intel_pmu_update(struct perf_event *event)
    {
    if (unlikely(is_topdown_count(event)))
    return static_call(intel_pmu_update_topdown_event)(event, core::ptr::null_mut());
    return x86_perf_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn intel_pmu_reset() {
...
//
    ...
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    let mut guest_pebs_idxs: u64 = cpuc.pebs_enabled & ~cpuc.intel_ctrl_host_mask;
    struct perf_event *event = core::ptr::null_mut();
    int bit;
...
#[no_mangle]
unsafe extern "C" fn handle_pmi_common(regs: *mut pt_regs, status: u64) -> c_int {
...
//
    ...
    let mut pebs_enabled: u64 = cpuc.pebs_enabled;
    handled++;
...
//
    ...
    handled++;
    static_call(intel_pmu_update_topdown_event)(core::ptr::null_mut(), core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn intel_pmu_handle_irq(regs: *mut pt_regs) -> c_int {
    static int intel_pmu_handle_irq(struct pt_regs *regs)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    let mut late_ack: bool = hybrid_bit(cpuc.pmu, late_ack);
    let mut mid_ack: bool = hybrid_bit(cpuc.pmu, mid_ack);
    int loops;
    u64 status;
    int handled;
    int pmu_enabled;
...
#[no_mangle]
unsafe extern "C" fn intel_fixup_er(event: *mut perf_event, idx: c_int) {
...
//
    ...
    return core::ptr::null_mut(); /* call x86_get_event_constraint() */
    again:
...
// allocate again next time
    ...
    struct perf_event *event)
    {
    struct event_constraint *c = core::ptr::null_mut(), *d;
    ...
    let mut tid: c_int = cpuc.excl_thread_id;
//
...
#[no_mangle]
unsafe extern "C" fn intel_commit_scheduling(cpuc: *mut cpu_hw_events, idx: c_int, cntr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_pebs_aliases_core2(event: *mut perf_event) {
...
//
    let mut alt_config: u64 = X86_CONFIG(.event=0xc0, .inv=1, .cmask=16);
    alt_config |= (event.hw.config & ~X86_RAW_EVENT_MASK);
    event.hw.config = alt_config;
    }
    }
#[no_mangle]
unsafe extern "C" fn intel_pebs_aliases_snb(event: *mut perf_event) {
...
// Thereby we gain a PEBS capable cycle counter.
//
    let mut alt_config: u64 = X86_CONFIG(.event=0xc2, .umask=0x01, .inv=1, .cmask=16);
    alt_config |= (event.hw.config & ~X86_RAW_EVENT_MASK);
    event.hw.config = alt_config;
    }
    }
#[no_mangle]
unsafe extern "C" fn intel_pebs_aliases_precdist(event: *mut perf_event) {
...
//
    let mut alt_config: u64 = X86_CONFIG(.event=0xc0, .umask=0x01, .inv=1, .cmask=16);
    alt_config |= (event.hw.config & ~X86_RAW_EVENT_MASK);
    event.hw.config = alt_config;
    }
    }
#[no_mangle]
unsafe extern "C" fn intel_pebs_aliases_ivb(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn intel_pebs_aliases_skl(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_large_pebs_flags(event: *mut perf_event) -> c_ulong {
    static unsigned long intel_pmu_large_pebs_flags(struct perf_event *event)
    {
    let mut flags: c_ulong = x86_pmu.large_pebs_flags;
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_bts_config(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn core_pmu_hw_config(event: *mut perf_event) -> c_int {
    static int core_pmu_hw_config(struct perf_event *event)
    {
    let mut ret: c_int = x86_pmu_hw_config(event);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn is_available_metric_event(event: *mut perf_event) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_mem_loads_event(event: *mut perf_event) -> bool {
    static inline bool is_mem_loads_event(struct perf_event *event)
    {
    return (event.attr.config & INTEL_ARCH_EVENT_MASK) == X86_CONFIG(.event=0xcd, .umask=0x01);
    }
#[no_mangle]
pub unsafe extern "C" fn is_mem_loads_aux_event(event: *mut perf_event) -> bool {
    static inline bool is_mem_loads_aux_event(struct perf_event *event)
    {
    return (event.attr.config & INTEL_ARCH_EVENT_MASK) == X86_CONFIG(.event=0x03, .umask=0x82);
    }
#[no_mangle]
pub unsafe extern "C" fn require_mem_loads_aux_event(event: *mut perf_event) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_has_cap(event: *mut perf_event, idx: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_freq_start_period(event: *mut perf_event) -> u64 {
    static u64 intel_pmu_freq_start_period(struct perf_event *event)
    {
    let mut type: c_int = event.attr.type;
    u64 config, factor;
    s64 start;
//
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_has_acr(pmu: *mut pmu) -> bool {
    static inline bool intel_pmu_has_acr(struct pmu *pmu)
    {
    return !!hybrid(pmu, acr_cause_mask64);
    }
#[no_mangle]
unsafe extern "C" fn intel_pmu_is_acr_group(event: *mut perf_event) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_has_pebs_counter_group(pmu: *mut pmu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_hw_config(event: *mut perf_event) -> c_int {
    ...
    if (event.attr.precise_ip) {
    let mut pebs_cap: arch_pebs_cap = hybrid(event.pmu, arch_pebs_cap);
...
// disallow lbr if conflicting events are present
    ...
    let mut has_sw_event: bool = false;
    let mut num: c_int = 0, idx = 0;
    let mut cause_mask: u64 = 0;
...
//
    ...
    struct perf_event *leader = event.group_leader;
    struct perf_event *sibling = core::ptr::null_mut();
//
...
//
    ...
    let mut intel_ctrl: u64 = hybrid(cpuc.pmu, intel_ctrl);
    let mut pebs_mask: u64 = cpuc.pebs_enabled & x86_pmu.pebs_capable;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: event->attr.exclude_guest) -> else {
...
#[no_mangle]
unsafe extern "C" fn core_pmu_enable_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn core_pmu_enable_all(added: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hsw_hw_config(event: *mut perf_event) -> c_int {
    static int hsw_hw_config(struct perf_event *event)
    {
    let mut ret: c_int = intel_pmu_hw_config(event);
    if (ret)
    return ret;
...
// Force instruction:ppp on PMC0 and Fixed counter 0
    ...
    let mut allow_tsx_force_abort: static bool = true;
    static struct event_constraint *
...
#[no_mangle]
pub unsafe extern "C" fn if(hybrid_small: pmu->pmu_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn adl_hw_config(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adl_get_hybrid_cpu_type() -> enum intel_cpu_type {
    static enum intel_cpu_type adl_get_hybrid_cpu_type(void)
    {
    return INTEL_CPU_TYPE_CORE;
    }
#[no_mangle]
pub unsafe extern "C" fn erratum_hsw11(event: *mut perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn arl_h_hw_config(event: *mut perf_event) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hsw_limit_period(event: *mut perf_event, left: *mut i64) {
...
//
#[no_mangle]
unsafe extern "C" fn bdw_limit_period(event: *mut perf_event, left: *mut i64) {
...
#[no_mangle]
unsafe extern "C" fn nhm_limit_period(event: *mut perf_event, left: *mut i64) {
    static void nhm_limit_period(struct perf_event *event, s64 *left)
    {
// left = max(*left, 32LL);
    }
#[no_mangle]
unsafe extern "C" fn glc_limit_period(event: *mut perf_event, left: *mut i64) {
...
// left = max(*left, 128LL);
    ...
    char *page)
    {
    let mut mask: u64 = hybrid(dev_get_drvdata(dev), config_mask) & ARCH_PERFMON_EVENTSEL_UMASK2;
...
// Roll back to the old format if umask2 is not supported.
    ...
    __ATTR(umask, 0444, umask2_show, core::ptr::null_mut());
...
// PERF_CAPABILITIES.RDPMC_METRICS_CLEAR
    if (i == 2) {
    let mut intel_cap: union perf_capabilities = hybrid(dev_get_drvdata(dev), intel_cap);
...
#[no_mangle]
pub unsafe extern "C" fn intel_event_sysfs_show(page: *mut c_char, config: u64) -> isize {
    ssize_t intel_event_sysfs_show(char *page, u64 config)
    {
    let mut event: u64 = (config & ARCH_PERFMON_EVENTSEL_EVENT);
...
#[no_mangle]
pub unsafe extern "C" fn intel_cpuc_prepare(cpuc: *mut cpu_hw_events, cpu: c_int) -> c_int {
    ...
    let mut sz: usize = X86_PMC_IDX_MAX * sizeof(struct event_constraint);
    ...
    cpuc.constraint_list = core::ptr::null_mut();
    err_shared_regs:
    kfree(cpuc.shared_regs);
    cpuc.shared_regs = core::ptr::null_mut();
    err:
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn intel_pmu_cpu_prepare(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flip_smm_bit(data: *mut c_void) {
    static void flip_smm_bit(void *data)
    {
    let mut set: c_ulong = *(unsigned long *)data;
    if (set > 0) {
...
//
    ...
    u64 cntr_mask)
    {
    let mut gp_mask: u64 = GENMASK_ULL(INTEL_PMC_MAX_GENERIC - 1, 0);
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_check_event_constraints_all(pmu: *mut pmu) {
    ...
    let mut cntr_mask: u64 = hybrid(pmu, cntr_mask64);
    let mut fixed_cntr_mask: u64 = hybrid(pmu, fixed_cntr_mask64);
    let mut intel_ctrl: u64 = hybrid(pmu, intel_ctrl);
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_broken_perf_cap() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn __intel_update_pmu_caps(pmu: *mut pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn __intel_update_large_pebs_flags(pmu: *mut pmu) {
    static inline void __intel_update_large_pebs_flags(struct pmu *pmu)
    {
    let mut caps: u64 = hybrid(pmu, arch_pebs_cap).caps;
...
#[no_mangle]
unsafe extern "C" fn update_pmu_cap_from_perfmonext(pmu: *mut pmu) {
    static void update_pmu_cap_from_perfmonext(struct pmu *pmu)
    {
    unsigned int eax, ebx, ecx, edx;
    union cpuid35_eax eax_0;
    union cpuid35_ebx ebx_0;
    let mut cntrs_mask: u64 = 0;
    let mut pebs_mask: u64 = 0;
    let mut pdists_mask: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn intel_update_pmu_caps(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_check_hybrid_pmus(pmu: *mut x86_hybrid_pmu) {
    ...
    let mut cpu_type: enum intel_cpu_type = c.topo.intel_type;
    int i;
//
...
//
    ...
    let mut pmu_type: enum hybrid_pmu_type = x86_pmu.hybrid_pmu[i].pmu_type;
    u32 native_id;
...
#[no_mangle]
unsafe extern "C" fn init_hybrid_pmu(cpu: c_int) -> bool {
    static bool init_hybrid_pmu(int cpu)
    {
    struct cpu_hw_events *cpuc = &per_cpu(cpu_hw_events, cpu);
    struct x86_hybrid_pmu *pmu = find_hybrid_pmu_for_cpu();
    if (WARN_ON_ONCE(!pmu || (pmu.pmu.type == -1))) {
    cpuc.pmu = core::ptr::null_mut();
    return false;
    }
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_cpu_starting(cpu: c_int) {
    static void intel_pmu_cpu_starting(int cpu)
    {
    struct cpu_hw_events *cpuc = &per_cpu(cpu_hw_events, cpu);
    let mut core_id: c_int = topology_core_id(cpu);
    int i;
...
//
    ...
    intel_pmu_lbr_reset();
    cpuc.lbr_sel = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn free_excl_cntrs(cpuc: *mut cpu_hw_events) {
    ...
    kfree(c);
    cpuc.excl_cntrs = core::ptr::null_mut();
    }
    kfree(cpuc.constraint_list);
    cpuc.constraint_list = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn intel_pmu_cpu_dying(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_cpuc_finish(cpuc: *mut cpu_hw_events) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_cpu_dead(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_check_period(event: *mut perf_event, value: u64) -> c_int {
    static int intel_pmu_check_period(struct perf_event *event, u64 value)
    {
    return intel_pmu_has_bts_period(event, value) ? -EINVAL : 0;
    }
#[no_mangle]
unsafe extern "C" fn intel_aux_output_init() {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_aux_output_match(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_filter(pmu: *mut pmu, cpu: c_int, ret: *mut bool) {
...
#[no_mangle]
unsafe extern "C" fn intel_clovertown_quirk() -> __init void {
...
//
    ...
    x86_pmu.ds_pebs = 0;
    x86_pmu.pebs_constraints = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn intel_check_pebs_isolation() {
    static void intel_check_pebs_isolation(void)
    {
    x86_pmu.pebs_no_isolation = !x86_match_min_microcode_rev(isolation_ucodes);
    }
#[no_mangle]
unsafe extern "C" fn intel_pebs_isolation_quirk() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn intel_snb_pebs_broken() -> bool {
    static bool intel_snb_pebs_broken(void)
    {
    return !x86_match_min_microcode_rev(pebs_ucodes);
    }
#[no_mangle]
unsafe extern "C" fn intel_snb_check_microcode() {
...
#[no_mangle]
unsafe extern "C" fn is_lbr_from(msr: c_ulong) -> bool {
    static bool is_lbr_from(unsigned long msr)
    {
    let mut lbr_from_nr: c_ulong = x86_pmu.lbr_from + x86_pmu.lbr_nr;
...
//
#[no_mangle]
unsafe extern "C" fn check_msr(msr: c_ulong, mask: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn intel_sandybridge_quirk() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn intel_arch_events_quirk() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn intel_nehalem_quirk() -> __init void {
...
//
#[no_mangle]
unsafe extern "C" fn intel_ht_bug() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn update_tfa_sched(ignored: *mut c_void) {
...
// no change
    ...
    cpus_read_lock();
    on_each_cpu(update_tfa_sched, core::ptr::null_mut(), 1);
    cpus_read_unlock();
    return count;
    }
...
#[no_mangle]
unsafe extern "C" fn is_attr_for_this_pmu(kobj: *mut kobject, attr: *mut attribute) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hybrid_find_supported_cpu(pmu: *mut x86_hybrid_pmu) -> c_int {
    static inline int hybrid_find_supported_cpu(struct x86_hybrid_pmu *pmu)
    {
    let mut cpu: c_int = cpumask_first(&pmu.supported_cpus);
    ...
    struct x86_hybrid_pmu *pmu =
    container_of(dev_get_drvdata(dev), struct x86_hybrid_pmu, pmu);
    let mut cpu: c_int = hybrid_find_supported_cpu(pmu);
...
// Only the big core supports perf metrics
    ...
    static DEVICE_ATTR(cpus, S_IRUGO, intel_hybrid_get_attr_cpus, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_check_extra_regs(extra_regs: *mut extra_reg) {
    static void intel_pmu_check_extra_regs(struct extra_reg *extra_regs)
    {
    struct extra_reg *er;
//
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_v6_addr_offset(index: c_int, eventsel: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_hybrid(pmus: enum hybrid_pmu_type) -> __always_inline int {
    static __always_inline int intel_pmu_init_hybrid(enum hybrid_pmu_type pmus)
    {
    let mut pmus_mask: c_ulong = pmus;
    struct x86_hybrid_pmu *pmu;
    let mut idx: c_int = 0, bit;
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_ref_cycles_ext() -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_glc(pmu: *mut pmu) -> __always_inline void {
    static __always_inline void intel_pmu_init_glc(struct pmu *pmu)
    {
    x86_pmu.late_ack = true;
    x86_pmu.limit_period = glc_limit_period;
    x86_pmu.pebs_aliases = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_glc_hybrid(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_grt(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_cmt(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_lnc(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_pnc(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_cyc(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_skt(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_dkt_hybrid(pmu: *mut pmu) -> __always_inline void {
...
//
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_dkt(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_init_arw(pmu: *mut pmu) -> __always_inline void {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_init() -> __init int {
...
//
    ...
    let mut assume: c_int = 3 * !boot_cpu_has(X86_FEATURE_HYPERVISOR);
...
//
    ...
    intel_pmu_init_grt(core::ptr::null_mut());
    ...
    intel_pmu_init_cmt(core::ptr::null_mut());
    ...
    intel_pmu_init_dkt(core::ptr::null_mut());
    intel_pmu_pebs_data_source_cmt();
    x86_pmu.pebs_latency_data = cmt_latency_data;
    x86_pmu.get_event_constraints = cmt_get_event_constraints;
...
//
    ...
    intel_pmu_init_pnc(core::ptr::null_mut());
    x86_pmu.pebs_latency_data = pnc_latency_data;
    pr_cont("Panthercove events, ");
    name = "panthercove";
    goto glc_base;
    glc_common:
    intel_pmu_init_glc(core::ptr::null_mut());
...
//
    if (!is_hybrid())
    intel_update_pmu_caps(core::ptr::null_mut());
    if (x86_pmu.arch_pebs) {
...
// AnyThread may be deprecated on arch perfmon v5 or later
    ...
    intel_pmu_check_event_constraints_all(core::ptr::null_mut());
//
...
//
#[no_mangle]
unsafe extern "C" fn fixup_ht_bug() -> __init int {
...
//
    ...
    x86_pmu.flags &= ~(PMU_FL_EXCL_CNTRS | PMU_FL_EXCL_ENABLED);
    x86_pmu.start_scheduling = core::ptr::null_mut();
    x86_pmu.commit_scheduling = core::ptr::null_mut();
    x86_pmu.stop_scheduling = core::ptr::null_mut();
