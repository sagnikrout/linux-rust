...
//! Source: arch/x86/events/intel/cstate.c
#![no_std]
...
//
    ...
    __ATTR(_name, 0444, __cstate_##_var##_show, core::ptr::null_mut())
// Model -> events mapping
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cstate_model {
    pub core_events: c_ulong,
    pub pkg_events: c_ulong,
    pub module_events: c_ulong,
    pub quirks: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn cstate_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cstate_pmu_read_counter(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn cstate_pmu_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn cstate_pmu_event_start(event: *mut perf_event, mode: c_int) {
    static void cstate_pmu_event_start(struct perf_event *event, int mode)
    {
    local64_set(&event.hw.prev_count, cstate_pmu_read_counter(event));
    }
#[no_mangle]
unsafe extern "C" fn cstate_pmu_event_stop(event: *mut perf_event, mode: c_int) {
    static void cstate_pmu_event_stop(struct perf_event *event, int mode)
    {
    cstate_pmu_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn cstate_pmu_event_del(event: *mut perf_event, mode: c_int) {
    static void cstate_pmu_event_del(struct perf_event *event, int mode)
    {
    cstate_pmu_event_stop(event, PERF_EF_UPDATE);
    }
#[no_mangle]
unsafe extern "C" fn cstate_pmu_event_add(event: *mut perf_event, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cstate_probe(cm: *const cstate_model) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn cstate_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn cstate_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cstate_pmu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cstate_pmu_exit() -> void __exit {
