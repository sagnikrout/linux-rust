...
//! Source: arch/x86/events/intel/uncore_snbep.c
#![no_std]
...
pub const SNBEP_CPUNODEID: c_uint = 0x40;
pub const SNBEP_GIDNIDMAP: c_uint = 0x54;
// SNB-EP Box level control

    SNBEP_PMON_BOX_CTL_RST_CTRS | \
    SNBEP_PMON_BOX_CTL_FRZ_EN)
// SNB-EP event control
pub const SNBEP_PMON_CTL_EV_SEL_MASK: c_uint = 0x000000ff;
pub const SNBEP_PMON_CTL_UMASK_MASK: c_uint = 0x0000ff00;

pub const SNBEP_PMON_CTL_TRESH_MASK: c_uint = 0xff000000;
...
pub const SNBEP_U_MSR_PMON_CTL_TRESH_MASK: c_uint = 0x1f000000;
...
pub const SNBEP_PCU_MSR_PMON_CTL_OCC_SEL_MASK: c_uint = 0x0000c000;
pub const SNBEP_PCU_MSR_PMON_CTL_TRESH_MASK: c_uint = 0x1f000000;
...
pub const SNBEP_PCI_PMON_BOX_CTL: c_uint = 0xf4;
pub const SNBEP_PCI_PMON_CTL0: c_uint = 0xd8;
// SNB-EP pci counter register
pub const SNBEP_PCI_PMON_CTR0: c_uint = 0xa0;
// SNB-EP home agent register
pub const SNBEP_HA_PCI_PMON_BOX_ADDRMATCH0: c_uint = 0x40;
pub const SNBEP_HA_PCI_PMON_BOX_ADDRMATCH1: c_uint = 0x44;
pub const SNBEP_HA_PCI_PMON_BOX_OPCODEMATCH: c_uint = 0x48;
// SNB-EP memory controller register
pub const SNBEP_MC_CHy_PCI_PMON_FIXED_CTL: c_uint = 0xf0;
pub const SNBEP_MC_CHy_PCI_PMON_FIXED_CTR: c_uint = 0xd0;
// SNB-EP QPI register
pub const SNBEP_Q_Py_PCI_PMON_PKT_MATCH0: c_uint = 0x228;
pub const SNBEP_Q_Py_PCI_PMON_PKT_MATCH1: c_uint = 0x22c;
pub const SNBEP_Q_Py_PCI_PMON_PKT_MASK0: c_uint = 0x238;
pub const SNBEP_Q_Py_PCI_PMON_PKT_MASK1: c_uint = 0x23c;
// SNB-EP Ubox register
pub const SNBEP_U_MSR_PMON_CTR0: c_uint = 0xc16;
pub const SNBEP_U_MSR_PMON_CTL0: c_uint = 0xc10;
pub const SNBEP_U_MSR_PMON_UCLK_FIXED_CTL: c_uint = 0xc08;
pub const SNBEP_U_MSR_PMON_UCLK_FIXED_CTR: c_uint = 0xc09;
// SNB-EP Cbo register
pub const SNBEP_C0_MSR_PMON_CTR0: c_uint = 0xd16;
pub const SNBEP_C0_MSR_PMON_CTL0: c_uint = 0xd10;
pub const SNBEP_C0_MSR_PMON_BOX_CTL: c_uint = 0xd04;
pub const SNBEP_C0_MSR_PMON_BOX_FILTER: c_uint = 0xd14;
pub const SNBEP_CBO_MSR_OFFSET: c_uint = 0x20;
pub const SNBEP_CB0_MSR_PMON_BOX_FILTER_TID: c_uint = 0x1f;
pub const SNBEP_CB0_MSR_PMON_BOX_FILTER_NID: c_uint = 0x3fc00;
pub const SNBEP_CB0_MSR_PMON_BOX_FILTER_STATE: c_uint = 0x7c0000;
pub const SNBEP_CB0_MSR_PMON_BOX_FILTER_OPC: c_uint = 0xff800000;
...
// SNB-EP PCU register
pub const SNBEP_PCU_MSR_PMON_CTR0: c_uint = 0xc36;
pub const SNBEP_PCU_MSR_PMON_CTL0: c_uint = 0xc30;
pub const SNBEP_PCU_MSR_PMON_BOX_CTL: c_uint = 0xc24;
pub const SNBEP_PCU_MSR_PMON_BOX_FILTER: c_uint = 0xc34;
pub const SNBEP_PCU_MSR_PMON_BOX_FILTER_MASK: c_uint = 0xffffffff;
pub const SNBEP_PCU_MSR_CORE_C3_CTR: c_uint = 0x3fc;
pub const SNBEP_PCU_MSR_CORE_C6_CTR: c_uint = 0x3fd;
// IVBEP event control
    ...
    SNBEP_PMON_CTL_TRESH_MASK)
// IVBEP Ubox
pub const IVBEP_U_MSR_PMON_GLOBAL_CTL: c_uint = 0xc00;
...
// IVBEP QPI
    ...
    ((1ULL << (n)) - 1)))
// Haswell-EP Ubox
pub const HSWEP_U_MSR_PMON_CTR0: c_uint = 0x709;
pub const HSWEP_U_MSR_PMON_CTL0: c_uint = 0x705;
pub const HSWEP_U_MSR_PMON_FILTER: c_uint = 0x707;
pub const HSWEP_U_MSR_PMON_UCLK_FIXED_CTL: c_uint = 0x703;
pub const HSWEP_U_MSR_PMON_UCLK_FIXED_CTR: c_uint = 0x704;

    (HSWEP_U_MSR_PMON_BOX_FILTER_TID | \
    HSWEP_U_MSR_PMON_BOX_FILTER_CID)
// Haswell-EP CBo
pub const HSWEP_C0_MSR_PMON_CTR0: c_uint = 0xe08;
pub const HSWEP_C0_MSR_PMON_CTL0: c_uint = 0xe01;
pub const HSWEP_C0_MSR_PMON_BOX_CTL: c_uint = 0xe00;
pub const HSWEP_C0_MSR_PMON_BOX_FILTER0: c_uint = 0xe05;
pub const HSWEP_CBO_MSR_OFFSET: c_uint = 0x10;

// Haswell-EP Sbox
pub const HSWEP_S0_MSR_PMON_CTR0: c_uint = 0x726;
pub const HSWEP_S0_MSR_PMON_CTL0: c_uint = 0x721;
pub const HSWEP_S0_MSR_PMON_BOX_CTL: c_uint = 0x720;
pub const HSWEP_SBOX_MSR_OFFSET: c_uint = 0xa;

    SNBEP_CBO_PMON_CTL_TID_EN)
// Haswell-EP PCU
pub const HSWEP_PCU_MSR_PMON_CTR0: c_uint = 0x717;
pub const HSWEP_PCU_MSR_PMON_CTL0: c_uint = 0x711;
pub const HSWEP_PCU_MSR_PMON_BOX_CTL: c_uint = 0x710;
pub const HSWEP_PCU_MSR_PMON_BOX_FILTER: c_uint = 0x715;
// KNL Ubox

    (SNBEP_U_MSR_PMON_RAW_EVENT_MASK | \
    SNBEP_CBO_PMON_CTL_TID_EN)
// KNL CHA
pub const KNL_CHA_MSR_OFFSET: c_uint = 0xc;

    (SNBEP_CBO_MSR_PMON_RAW_EVENT_MASK | \
    KNL_CHA_MSR_PMON_CTL_QOR)
pub const KNL_CHA_MSR_PMON_BOX_FILTER_TID: c_uint = 0x1ff;

// KNL EDC/MC UCLK
pub const KNL_UCLK_MSR_PMON_CTR0_LOW: c_uint = 0x400;
pub const KNL_UCLK_MSR_PMON_CTL0: c_uint = 0x420;
pub const KNL_UCLK_MSR_PMON_BOX_CTL: c_uint = 0x430;
pub const KNL_UCLK_MSR_PMON_UCLK_FIXED_LOW: c_uint = 0x44c;
pub const KNL_UCLK_MSR_PMON_UCLK_FIXED_CTL: c_uint = 0x454;
pub const KNL_PMON_FIXED_CTL_EN: c_uint = 0x1;
// KNL EDC
pub const KNL_EDC0_ECLK_MSR_PMON_CTR0_LOW: c_uint = 0xa00;
pub const KNL_EDC0_ECLK_MSR_PMON_CTL0: c_uint = 0xa20;
pub const KNL_EDC0_ECLK_MSR_PMON_BOX_CTL: c_uint = 0xa30;
pub const KNL_EDC0_ECLK_MSR_PMON_ECLK_FIXED_LOW: c_uint = 0xa3c;
pub const KNL_EDC0_ECLK_MSR_PMON_ECLK_FIXED_CTL: c_uint = 0xa44;
// KNL MC
pub const KNL_MC0_CH0_MSR_PMON_CTR0_LOW: c_uint = 0xb00;
pub const KNL_MC0_CH0_MSR_PMON_CTL0: c_uint = 0xb20;
pub const KNL_MC0_CH0_MSR_PMON_BOX_CTL: c_uint = 0xb30;
pub const KNL_MC0_CH0_MSR_PMON_FIXED_LOW: c_uint = 0xb3c;
pub const KNL_MC0_CH0_MSR_PMON_FIXED_CTL: c_uint = 0xb44;
// KNL IRP
pub const KNL_IRP_PCI_PMON_BOX_CTL: c_uint = 0xf0;

    KNL_CHA_MSR_PMON_CTL_QOR)
// KNL PCU
pub const KNL_PCU_PMON_CTL_EV_SEL_MASK: c_uint = 0x0000007f;

pub const KNL_PCU_MSR_PMON_CTL_TRESH_MASK: c_uint = 0x3f000000;
...
pub const SKX_CPUNODEID: c_uint = 0xc0;
pub const SKX_GIDNIDMAP: c_uint = 0xd4;
//
...
// CPUBUSNO(0). (RO)
//
pub const SKX_MSR_CPU_BUS_NUMBER: c_uint = 0x300;

pub const BUS_NUM_STRIDE: c_int = 8;
// SKX CHA

// SKX IIO
pub const SKX_IIO0_MSR_PMON_CTL0: c_uint = 0xa48;
pub const SKX_IIO0_MSR_PMON_CTR0: c_uint = 0xa41;
pub const SKX_IIO0_MSR_PMON_BOX_CTL: c_uint = 0xa40;
pub const SKX_IIO_MSR_OFFSET: c_uint = 0x20;
...
// SKX IRP
pub const SKX_IRP0_MSR_PMON_CTL0: c_uint = 0xa5b;
pub const SKX_IRP0_MSR_PMON_CTR0: c_uint = 0xa59;
pub const SKX_IRP0_MSR_PMON_BOX_CTL: c_uint = 0xa58;
pub const SKX_IRP_MSR_OFFSET: c_uint = 0x20;
// SKX UPI
pub const SKX_UPI_PCI_PMON_CTL0: c_uint = 0x350;
pub const SKX_UPI_PCI_PMON_CTR0: c_uint = 0x318;
pub const SKX_UPI_PCI_PMON_BOX_CTL: c_uint = 0x378;
pub const SKX_UPI_CTL_UMASK_EXT: c_uint = 0xffefff;
// SKX M2M
pub const SKX_M2M_PCI_PMON_CTL0: c_uint = 0x228;
pub const SKX_M2M_PCI_PMON_CTR0: c_uint = 0x200;
pub const SKX_M2M_PCI_PMON_BOX_CTL: c_uint = 0x258;
// Memory Map registers device ID
pub const SNR_ICX_MESH2IIO_MMAP_DID: c_uint = 0x9a2;
pub const SNR_ICX_SAD_CONTROL_CFG: c_uint = 0x3f4;
// Getting I/O stack id in SAD_COTROL_CFG notation

// SNR Ubox
pub const SNR_U_MSR_PMON_CTR0: c_uint = 0x1f98;
pub const SNR_U_MSR_PMON_CTL0: c_uint = 0x1f91;
pub const SNR_U_MSR_PMON_UCLK_FIXED_CTL: c_uint = 0x1f93;
pub const SNR_U_MSR_PMON_UCLK_FIXED_CTR: c_uint = 0x1f94;
// SNR CHA
pub const SNR_CHA_RAW_EVENT_MASK_EXT: c_uint = 0x3ffffff;
pub const SNR_CHA_MSR_PMON_CTL0: c_uint = 0x1c01;
pub const SNR_CHA_MSR_PMON_CTR0: c_uint = 0x1c08;
pub const SNR_CHA_MSR_PMON_BOX_CTL: c_uint = 0x1c00;
pub const SNR_C0_MSR_PMON_BOX_FILTER0: c_uint = 0x1c05;
// SNR IIO
pub const SNR_IIO_MSR_PMON_CTL0: c_uint = 0x1e08;
pub const SNR_IIO_MSR_PMON_CTR0: c_uint = 0x1e01;
pub const SNR_IIO_MSR_PMON_BOX_CTL: c_uint = 0x1e00;
pub const SNR_IIO_MSR_OFFSET: c_uint = 0x10;
pub const SNR_IIO_PMON_RAW_EVENT_MASK_EXT: c_uint = 0x7ffff;
// SNR IRP
pub const SNR_IRP0_MSR_PMON_CTL0: c_uint = 0x1ea8;
pub const SNR_IRP0_MSR_PMON_CTR0: c_uint = 0x1ea1;
pub const SNR_IRP0_MSR_PMON_BOX_CTL: c_uint = 0x1ea0;
pub const SNR_IRP_MSR_OFFSET: c_uint = 0x10;
// SNR M2PCIE
pub const SNR_M2PCIE_MSR_PMON_CTL0: c_uint = 0x1e58;
pub const SNR_M2PCIE_MSR_PMON_CTR0: c_uint = 0x1e51;
pub const SNR_M2PCIE_MSR_PMON_BOX_CTL: c_uint = 0x1e50;
pub const SNR_M2PCIE_MSR_OFFSET: c_uint = 0x10;
// SNR PCU
pub const SNR_PCU_MSR_PMON_CTL0: c_uint = 0x1ef1;
pub const SNR_PCU_MSR_PMON_CTR0: c_uint = 0x1ef8;
pub const SNR_PCU_MSR_PMON_BOX_CTL: c_uint = 0x1ef0;
pub const SNR_PCU_MSR_PMON_BOX_FILTER: c_uint = 0x1efc;
// SNR M2M
pub const SNR_M2M_PCI_PMON_CTL0: c_uint = 0x468;
pub const SNR_M2M_PCI_PMON_CTR0: c_uint = 0x440;
pub const SNR_M2M_PCI_PMON_BOX_CTL: c_uint = 0x438;
pub const SNR_M2M_PCI_PMON_UMASK_EXT: c_uint = 0xff;
// SNR PCIE3
pub const SNR_PCIE3_PCI_PMON_CTL0: c_uint = 0x508;
pub const SNR_PCIE3_PCI_PMON_CTR0: c_uint = 0x4e8;
pub const SNR_PCIE3_PCI_PMON_BOX_CTL: c_uint = 0x4e0;
// SNR IMC
pub const SNR_IMC_MMIO_PMON_FIXED_CTL: c_uint = 0x54;
pub const SNR_IMC_MMIO_PMON_FIXED_CTR: c_uint = 0x38;
pub const SNR_IMC_MMIO_PMON_CTL0: c_uint = 0x40;
pub const SNR_IMC_MMIO_PMON_CTR0: c_uint = 0x8;
pub const SNR_IMC_MMIO_PMON_BOX_CTL: c_uint = 0x22800;
pub const SNR_IMC_MMIO_OFFSET: c_uint = 0x4000;
pub const SNR_IMC_MMIO_SIZE: c_uint = 0x4000;
pub const SNR_IMC_MMIO_BASE_OFFSET: c_uint = 0xd0;
pub const SNR_IMC_MMIO_BASE_MASK: c_uint = 0x1FFFFFFF;
pub const SNR_IMC_MMIO_MEM0_OFFSET: c_uint = 0xd8;
pub const SNR_IMC_MMIO_MEM0_MASK: c_uint = 0x7FF;
// ICX CHA
pub const ICX_C34_MSR_PMON_CTR0: c_uint = 0xb68;
pub const ICX_C34_MSR_PMON_CTL0: c_uint = 0xb61;
pub const ICX_C34_MSR_PMON_BOX_CTL: c_uint = 0xb60;
pub const ICX_C34_MSR_PMON_BOX_FILTER0: c_uint = 0xb65;
// ICX IIO
pub const ICX_IIO_MSR_PMON_CTL0: c_uint = 0xa58;
pub const ICX_IIO_MSR_PMON_CTR0: c_uint = 0xa51;
pub const ICX_IIO_MSR_PMON_BOX_CTL: c_uint = 0xa50;
// ICX IRP
pub const ICX_IRP0_MSR_PMON_CTL0: c_uint = 0xa4d;
pub const ICX_IRP0_MSR_PMON_CTR0: c_uint = 0xa4b;
pub const ICX_IRP0_MSR_PMON_BOX_CTL: c_uint = 0xa4a;
// ICX M2PCIE
pub const ICX_M2PCIE_MSR_PMON_CTL0: c_uint = 0xa46;
pub const ICX_M2PCIE_MSR_PMON_CTR0: c_uint = 0xa41;
pub const ICX_M2PCIE_MSR_PMON_BOX_CTL: c_uint = 0xa40;
// ICX UPI
pub const ICX_UPI_PCI_PMON_CTL0: c_uint = 0x350;
pub const ICX_UPI_PCI_PMON_CTR0: c_uint = 0x320;
pub const ICX_UPI_PCI_PMON_BOX_CTL: c_uint = 0x318;
pub const ICX_UPI_CTL_UMASK_EXT: c_uint = 0xffffff;
pub const ICX_UBOX_DID: c_uint = 0x3450;
// ICX M3UPI
pub const ICX_M3UPI_PCI_PMON_CTL0: c_uint = 0xd8;
pub const ICX_M3UPI_PCI_PMON_CTR0: c_uint = 0xa8;
pub const ICX_M3UPI_PCI_PMON_BOX_CTL: c_uint = 0xa0;
// ICX IMC
pub const ICX_NUMBER_IMC_CHN: c_int = 3;
pub const ICX_IMC_MEM_STRIDE: c_uint = 0x4;
// SPR
pub const SPR_RAW_EVENT_MASK_EXT: c_uint = 0xffffff;
pub const SPR_UBOX_DID: c_uint = 0x3250;
// SPR CHA
pub const SPR_CHA_EVENT_MASK_EXT: c_uint = 0xffffffff;

    SPR_CHA_PMON_CTL_TID_EN)
pub const SPR_CHA_PMON_BOX_FILTER_TID: c_uint = 0x3ff;
pub const SPR_C0_MSR_PMON_BOX_FILTER0: c_uint = 0x200e;
// DMR
pub const DMR_IMH1_HIOP_MMIO_BASE: c_uint = 0x1ffff6ae7000;
pub const DMR_HIOP_MMIO_SIZE: c_uint = 0x8000;
pub const DMR_CXLCM_EVENT_MASK_EXT: c_uint = 0xf;
pub const DMR_HAMVF_EVENT_MASK_EXT: c_uint = 0xffffffff;
pub const DMR_PCIE4_EVENT_MASK_EXT: c_uint = 0xffffff;
pub const UNCORE_DMR_ITC: c_uint = 0x30;
pub const DMR_IMC_PMON_FIXED_CTR: c_uint = 0x18;
pub const DMR_IMC_PMON_FIXED_CTL: c_uint = 0x10;
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_pci_disable_box(box: *mut intel_uncore_box) {
    static void snbep_uncore_pci_disable_box(struct intel_uncore_box *box)
    {
    struct pci_dev *pdev = box.pci_dev;
    let mut box_ctl: c_int = uncore_pci_box_ctl(box);
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_pci_enable_box(box: *mut intel_uncore_box) {
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_pci_enable_event(box: *mut intel_uncore_box, event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_pci_disable_event(box: *mut intel_uncore_box, event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_pci_read_counter(box: *mut intel_uncore_box, event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_pci_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_msr_disable_box(box: *mut intel_uncore_box) {
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_msr_enable_box(box: *mut intel_uncore_box) {
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_msr_enable_event(box: *mut intel_uncore_box, event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn snbep_uncore_msr_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snbep_cbox_put_constraint(box: *mut intel_uncore_box, event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn snbep_cbox_filter_mask(fields: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn snbep_cbox_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snbep_pcu_alter_er(event: *mut perf_event, new_idx: c_int, modify: bool) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn snbep_pcu_put_constraint(box: *mut intel_uncore_box, event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn snbep_pcu_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
    static int snbep_pcu_hw_config(struct intel_uncore_box *box, struct perf_event *event)
    {
    struct hw_perf_event *hwc = &event.hw;
    struct hw_perf_event_extra *reg1 = &hwc.extra_reg;
    let mut ev_sel: c_int = hwc.config & SNBEP_PMON_CTL_EV_SEL_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn snbep_uncore_cpu_init() {
...
#[no_mangle]
unsafe extern "C" fn snbep_qpi_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snbep_qpi_enable_event(box: *mut intel_uncore_box, event: *mut perf_event) {
    ...
    struct hw_perf_event_extra *reg2 = &hwc.branch_reg;
    if (reg1.idx != EXTRA_REG_NONE) {
    let mut idx: c_int = box.pmu.pmu_idx + SNBEP_PCI_QPI_PORT0_FILTER;
    let mut die: c_int = box.dieid;
...
pub const NODE_ID_MASK: c_uint = 0x7;
...
#[no_mangle]
unsafe extern "C" fn topology_gidnid_map(nodeid: c_int, gidnid: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snbep_pci2phy_map_init(devid: c_int, nodeid_loc: c_int, idmap_loc: c_int, reverse: bool) -> c_int {
    static int snbep_pci2phy_map_init(int devid, int nodeid_loc, int idmap_loc, bool reverse)
    {
    struct pci_dev *ubox_dev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn snbep_uncore_pci_init() -> c_int {
    int snbep_uncore_pci_init(void)
    {
    let mut ret: c_int = snbep_pci2phy_map_init(0x3ce0, SNBEP_CPUNODEID, SNBEP_GIDNIDMAP, true);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ivbep_uncore_msr_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ivbep_uncore_pci_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ivbep_cbox_filter_mask(fields: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ivbep_cbox_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ivbep_cbox_enable_event(box: *mut intel_uncore_box, event: *mut perf_event) {
    static void ivbep_cbox_enable_event(struct intel_uncore_box *box, struct perf_event *event)
    {
    struct hw_perf_event *hwc = &event.hw;
    struct hw_perf_event_extra *reg1 = &hwc.extra_reg;
    if (reg1.idx != EXTRA_REG_NONE) {
    let mut filter: u64 = uncore_shared_reg_config(box, 0);
...
#[no_mangle]
pub unsafe extern "C" fn ivbep_uncore_cpu_init() {
...
#[no_mangle]
unsafe extern "C" fn ivbep_uncore_irp_enable_event(box: *mut intel_uncore_box, event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn ivbep_uncore_irp_disable_event(box: *mut intel_uncore_box, event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn ivbep_uncore_irp_read_counter(box: *mut intel_uncore_box, event: *mut perf_event) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn ivbep_uncore_pci_init() -> c_int {
    int ivbep_uncore_pci_init(void)
    {
    let mut ret: c_int = snbep_pci2phy_map_init(0x0e1e, SNBEP_CPUNODEID, SNBEP_GIDNIDMAP, true);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn knl_cha_filter_mask(fields: c_int) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn knl_uncore_cpu_init() {
    void knl_uncore_cpu_init(void)
    {
    uncore_msr_uncores = knl_msr_uncores;
    }
#[no_mangle]
unsafe extern "C" fn knl_uncore_imc_enable_box(box: *mut intel_uncore_box) {
...
#[no_mangle]
pub unsafe extern "C" fn knl_uncore_pci_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hswep_ubox_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hswep_cbox_filter_mask(fields: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn hswep_cbox_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hswep_uncore_sbox_msr_init_box(box: *mut intel_uncore_box) -> c_int {
    static int hswep_uncore_sbox_msr_init_box(struct intel_uncore_box *box)
    {
    let mut msr: unsigned = uncore_msr_box_ctl(box);
    if (msr) {
    let mut init: u64 = SNBEP_PMON_BOX_CTL_INT;
    let mut flags: u64 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn hswep_pcu_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
pub const HSWEP_PCU_DID: c_uint = 0x2fc0;
pub const HSWEP_PCU_CAPID4_OFFET: c_uint = 0x94;

#[no_mangle]
unsafe extern "C" fn hswep_has_limit_sbox(device: c_uint) -> bool {
    static bool hswep_has_limit_sbox(unsigned int device)
    {
    struct pci_dev *dev = pci_get_device(PCI_VENDOR_ID_INTEL, device, core::ptr::null_mut());
    u32 capid4;
    if (!dev)
    return false;
...
#[no_mangle]
pub unsafe extern "C" fn hswep_uncore_cpu_init() {
...
#[no_mangle]
unsafe extern "C" fn hswep_uncore_irp_read_counter(box: *mut intel_uncore_box, event: *mut perf_event) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn hswep_uncore_pci_init() -> c_int {
    int hswep_uncore_pci_init(void)
    {
    let mut ret: c_int = snbep_pci2phy_map_init(0x2f1e, SNBEP_CPUNODEID, SNBEP_GIDNIDMAP, true);
    if (ret)
    return ret;
...
pub const BDX_MSR_UNCORE_SBOX: c_int = 3;
...
pub const BDX_PCU_DID: c_uint = 0x6fc0;
#[no_mangle]
pub unsafe extern "C" fn bdx_uncore_cpu_init() {
...
// Detect systems with no SBOXes
    ...
    uncore_msr_uncores[BDX_MSR_UNCORE_SBOX] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn bdx_uncore_pci_init() -> c_int {
    int bdx_uncore_pci_init(void)
    {
    let mut ret: c_int = snbep_pci2phy_map_init(0x6f1e, SNBEP_CPUNODEID, SNBEP_GIDNIDMAP, true);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn skx_cha_filter_mask(fields: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn skx_cha_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
// Root bus 0x00 is valid only for pmu_idx = 0.
    ...
    let mut die: c_long = (long)ea.var;
    struct intel_uncore_topology *pmut = pmu_topology(pmu, die);
    return sprintf(buf, "%04x:%02x\n", pmut ? pmut.iio.segment : 0,
    pmut ? pmut.iio.pci_bus_no : 0);
    }
#[no_mangle]
unsafe extern "C" fn skx_msr_cpu_bus_read(cpu: c_int, topology: *mut u64) -> c_int {
...
// topology = msr_value;
    ...
    sizeof(*((struct intel_uncore_topology *)core::ptr::null_mut()).iio),
    sizeof(*((struct intel_uncore_topology *)core::ptr::null_mut()).upi)
    };
#[no_mangle]
unsafe extern "C" fn pmu_alloc_topology(type: *mut intel_uncore_type, topology_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_free_topology(type: *mut intel_uncore_type) {
    ...
    kfree(type.topology);
    type.topology = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn skx_iio_get_topology(type: *mut intel_uncore_type) -> c_int {
    ...
    char buf[64];
    int ret;
    let mut die: c_long = -1;
    struct attribute **attrs = core::ptr::null_mut();
    struct dev_ext_attribute *eas = core::ptr::null_mut();
...
// One more for NULL.
    ...
    eas[die].attr.store = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn skx_iio_set_mapping(type: *mut intel_uncore_type) {
    static void skx_iio_set_mapping(struct intel_uncore_type *type)
    {
    pmu_iio_set_mapping(type, &skx_iio_mapping_group);
    }
#[no_mangle]
unsafe extern "C" fn skx_iio_cleanup_mapping(type: *mut intel_uncore_type) {
...
//
pub const SKX_CAPID6: c_uint = 0x9c;

#[no_mangle]
unsafe extern "C" fn skx_count_chabox() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn skx_uncore_cpu_init() {
...
#[no_mangle]
unsafe extern "C" fn skx_upi_uncore_pci_init_box(box: *mut intel_uncore_box) -> c_int {
...
pub const SKX_UPI_REG_DID: c_uint = 0x2058;
pub const SKX_UPI_REGS_ADDR_DEVICE_LINK0: c_uint = 0x0e;
pub const SKX_UPI_REGS_ADDR_FUNCTION: c_uint = 0x00;
//
...
//
pub const SKX_KTILP0_OFFSET: c_uint = 0x94;
//
...
//
pub const SKX_KTIPCSTS_OFFSET: c_uint = 0x120;
    ...
    unsigned int devfn;
    struct pci_dev *dev = core::ptr::null_mut();
    let mut bus: u8 = cpu_bus_msr >> (3 * BUS_NUM_STRIDE);
    for (idx = 0; idx < type.num_boxes; idx++) {
...
#[no_mangle]
unsafe extern "C" fn skx_upi_get_topology(type: *mut intel_uncore_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skx_upi_set_mapping(type: *mut intel_uncore_type) {
    static void skx_upi_set_mapping(struct intel_uncore_type *type)
    {
    pmu_upi_set_mapping(type, &skx_upi_mapping_group);
    }
#[no_mangle]
unsafe extern "C" fn skx_upi_cleanup_mapping(type: *mut intel_uncore_type) {
...
#[no_mangle]
unsafe extern "C" fn skx_m2m_uncore_pci_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn skx_uncore_pci_init() -> c_int {
    int skx_uncore_pci_init(void)
    {
// need to double check pci address
    let mut ret: c_int = snbep_pci2phy_map_init(0x2014, SKX_CPUNODEID, SKX_GIDNIDMAP, false);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn snr_cha_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sad_cfg_iio_topology(type: *mut intel_uncore_type, sad_pmon_mapping: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snr_pcu_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snr_uncore_cpu_init() {
    void snr_uncore_cpu_init(void)
    {
    uncore_msr_uncores = snr_msr_uncores;
    }
#[no_mangle]
unsafe extern "C" fn snr_m2m_uncore_pci_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snr_uncore_pci_enable_event(box: *mut intel_uncore_box, event: *mut perf_event) {
...
#[no_mangle]
pub unsafe extern "C" fn snr_uncore_pci_init() -> c_int {
...
pub const SNR_MC_DEVICE_ID: c_uint = 0x3451;
...
#[no_mangle]
unsafe extern "C" fn snr_uncore_mmio_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snr_uncore_mmio_disable_box(box: *mut intel_uncore_box) {
...
#[no_mangle]
unsafe extern "C" fn snr_uncore_mmio_enable_box(box: *mut intel_uncore_box) {
...
#[no_mangle]
pub unsafe extern "C" fn snr_uncore_mmio_init() {
...
#[no_mangle]
unsafe extern "C" fn icx_cha_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
    static int icx_cha_hw_config(struct intel_uncore_box *box, struct perf_event *event)
    {
    struct hw_perf_event_extra *reg1 = &event.hw.extra_reg;
    let mut tie_en: bool = !!(event.hw.config & SNBEP_CBO_PMON_CTL_TID_EN);
    if (tie_en) {
...
#[no_mangle]
unsafe extern "C" fn icx_iio_get_topology(type: *mut intel_uncore_type) -> c_int {
    static int icx_iio_get_topology(struct intel_uncore_type *type)
    {
    return sad_cfg_iio_topology(type, icx_sad_pmon_mapping);
    }
#[no_mangle]
unsafe extern "C" fn icx_iio_set_mapping(type: *mut intel_uncore_type) {
...
#[no_mangle]
unsafe extern "C" fn icx_iio_cleanup_mapping(type: *mut intel_uncore_type) {
...
//
pub const ICX_CAPID6: c_uint = 0x9c;
pub const ICX_CAPID7: c_uint = 0xa0;
#[no_mangle]
unsafe extern "C" fn icx_count_chabox() -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn icx_uncore_cpu_init() {
    void icx_uncore_cpu_init(void)
    {
    let mut num_boxes: u64 = icx_count_chabox();
...
pub const ICX_UPI_REGS_ADDR_DEVICE_LINK0: c_uint = 0x02;
pub const ICX_UPI_REGS_ADDR_FUNCTION: c_uint = 0x01;
#[no_mangle]
unsafe extern "C" fn discover_upi_topology(type: *mut intel_uncore_type, ubox_did: c_int, dev_link0: c_int) -> c_int {
    static int discover_upi_topology(struct intel_uncore_type *type, int ubox_did, int dev_link0)
    {
    struct pci_dev *ubox = core::ptr::null_mut();
    struct pci_dev *dev = core::ptr::null_mut();
    u32 nid, gid;
...
#[no_mangle]
unsafe extern "C" fn icx_upi_get_topology(type: *mut intel_uncore_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icx_upi_set_mapping(type: *mut intel_uncore_type) {
    static void icx_upi_set_mapping(struct intel_uncore_type *type)
    {
    pmu_upi_set_mapping(type, &icx_upi_mapping_group);
    }
#[no_mangle]
unsafe extern "C" fn icx_upi_cleanup_mapping(type: *mut intel_uncore_type) {
...
#[no_mangle]
pub unsafe extern "C" fn icx_uncore_pci_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icx_uncore_imc_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icx_uncore_imc_freerunning_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn icx_uncore_mmio_init() {
...
#[no_mangle]
unsafe extern "C" fn spr_cha_hw_config(box: *mut intel_uncore_box, event: *mut perf_event) -> c_int {
    static int spr_cha_hw_config(struct intel_uncore_box *box, struct perf_event *event)
    {
    struct hw_perf_event_extra *reg1 = &event.hw.extra_reg;
    let mut tie_en: bool = !!(event.hw.config & SPR_CHA_PMON_CTL_TID_EN);
    struct intel_uncore_type *type = box.pmu.type;
    let mut id: c_int = intel_uncore_find_discovery_unit_id(type.boxes, -1, box.pmu.pmu_idx);
    if (tie_en) {
...
pub const SPR_UPI_REGS_ADDR_DEVICE_LINK0: c_uint = 0x01;
#[no_mangle]
unsafe extern "C" fn spr_upi_set_mapping(type: *mut intel_uncore_type) {
    static void spr_upi_set_mapping(struct intel_uncore_type *type)
    {
    pmu_upi_set_mapping(type, &spr_upi_mapping_group);
    }
#[no_mangle]
unsafe extern "C" fn spr_upi_cleanup_mapping(type: *mut intel_uncore_type) {
    static void spr_upi_cleanup_mapping(struct intel_uncore_type *type)
    {
    pmu_cleanup_mapping(type, &spr_upi_mapping_group);
    }
#[no_mangle]
unsafe extern "C" fn spr_upi_get_topology(type: *mut intel_uncore_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spr_uncore_mmio_offs8_init_box(box: *mut intel_uncore_box) -> c_int {
...
pub const UNCORE_SPR_NUM_UNCORE_TYPES: c_int = 15;
pub const UNCORE_SPR_CHA: c_int = 0;
pub const UNCORE_SPR_IIO: c_int = 1;
pub const UNCORE_SPR_IMC: c_int = 6;
pub const UNCORE_SPR_UPI: c_int = 8;
pub const UNCORE_SPR_M3UPI: c_int = 9;
//
...
//
pub const SPR_UNCORE_UPI_NUM_BOXES: c_int = 4;
    static u64 spr_upi_pci_offsets[SPR_UNCORE_UPI_NUM_BOXES] = {
    0, 0x8000, 0x10000, 0x18000
    };
#[no_mangle]
unsafe extern "C" fn spr_extra_boxes_cleanup(type: *mut intel_uncore_type) {
...
pub const SPR_MC_DEVICE_ID: c_uint = 0x3251;
#[no_mangle]
unsafe extern "C" fn spr_uncore_imc_freerunning_init_box(box: *mut intel_uncore_box) -> c_int {
    static int spr_uncore_imc_freerunning_init_box(struct intel_uncore_box *box)
    {
    let mut mem_offset: c_int = box.pmu.pmu_idx * ICX_IMC_MEM_STRIDE + SNR_IMC_MMIO_MEM0_OFFSET;
    return snr_uncore_mmio_map(box, uncore_mmio_box_ctl(box),
...
pub const UNCORE_SPR_MSR_EXTRA_UNCORES: c_int = 1;
pub const UNCORE_SPR_MMIO_EXTRA_UNCORES: c_int = 1;
pub const UNCORE_SPR_PCI_EXTRA_UNCORES: c_int = 2;
...
pub const SPR_MSR_UNC_CBO_CONFIG: c_uint = 0x2FFE;
#[no_mangle]
pub unsafe extern "C" fn spr_uncore_cpu_init() {
...
pub const SPR_UNCORE_UPI_PCIID: c_uint = 0x3241;
pub const SPR_UNCORE_UPI0_DEVFN: c_uint = 0x9;
pub const SPR_UNCORE_M3UPI_PCIID: c_uint = 0x3246;
pub const SPR_UNCORE_M3UPI0_DEVFN: c_uint = 0x29;
#[no_mangle]
unsafe extern "C" fn spr_update_device_location(type_id: c_int) {
...
// root = RB_ROOT;
    while ((dev = pci_get_device(PCI_VENDOR_ID_INTEL, device, dev)) != core::ptr::null_mut()) {
    die = uncore_pcibus_to_dieid(dev.bus);
    if (die < 0)
    continue;
    ...
    uncore_find_add_unit(unit, root, core::ptr::null_mut());
    }
    type.boxes = root;
    }
#[no_mangle]
pub unsafe extern "C" fn spr_uncore_pci_init() -> c_int {
    int spr_uncore_pci_init(void)
    {
    let mut ret: c_int = snbep_pci2phy_map_init(0x3250, SKX_CPUNODEID, SKX_GIDNIDMAP, true);
    if (ret)
    return ret;
//
...
#[no_mangle]
pub unsafe extern "C" fn spr_uncore_mmio_init() {
    void spr_uncore_mmio_init(void)
    {
    let mut ret: c_int = snbep_pci2phy_map_init(0x3250, SKX_CPUNODEID, SKX_GIDNIDMAP, true);
    if (ret) {
    uncore_mmio_uncores = uncore_get_uncores(UNCORE_ACCESS_MMIO, 0, core::ptr::null_mut(),
    UNCORE_SPR_NUM_UNCORE_TYPES,
    spr_uncores);
    } else {
...
// GNR uncore support
pub const UNCORE_GNR_NUM_UNCORE_TYPES: c_int = 23;
...
#[no_mangle]
pub unsafe extern "C" fn gnr_uncore_cpu_init() {
...
#[no_mangle]
pub unsafe extern "C" fn gnr_uncore_pci_init() -> c_int {
    int gnr_uncore_pci_init(void)
    {
    uncore_pci_uncores = uncore_get_uncores(UNCORE_ACCESS_PCI, 0, core::ptr::null_mut(),
    UNCORE_GNR_NUM_UNCORE_TYPES,
    gnr_uncores);
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn gnr_uncore_mmio_init() {
...
// DMR uncore support
pub const UNCORE_DMR_NUM_UNCORE_TYPES: c_int = 52;
...
#[no_mangle]
unsafe extern "C" fn dmr_uncore_freerunning_init_box(box: *mut intel_uncore_box) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dmr_uncore_mmio_init() {
