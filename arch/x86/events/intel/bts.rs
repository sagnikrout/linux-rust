...
//! Source: arch/x86/events/intel/bts.c
#![no_std]
...
pub const BTS_SAFETY_MARGIN: c_int = 4080;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bts_phys {
    pub page: *mut page,
...
pub struct bts_buffer {
    pub /: *mut *mut size_t real_size; / multiple of BTS_RECORD_SIZE,
    pub nr_pages: c_uint,
    pub nr_bufs: c_uint,
    pub cur_buf: c_uint,
    pub snapshot: bool,
    ...
    pub __counted_by(nr_bufs): bts_phys buf[],
}

    static struct pmu bts_pmu;
#[no_mangle]
unsafe extern "C" fn buf_nr_pages(page: *mut page) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn buf_size(page: *mut page) -> usize {
    ...
    struct page *page;
    let mut cpu: c_int = event.cpu;
    let mut node: c_int = (cpu == -1) ? cpu : cpu_to_node(cpu);
...
#[no_mangle]
unsafe extern "C" fn bts_buffer_free_aux(data: *mut c_void) {
    static void bts_buffer_free_aux(void *data)
    {
    kfree(data);
    }
#[no_mangle]
unsafe extern "C" fn bts_buffer_offset(bb: *mut bts_buffer, idx: c_uint) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn if(BTS_RECORD_SIZE: end - index >) -> else {
...
#[no_mangle]
unsafe extern "C" fn bts_buffer_pad_out(phys: *mut bts_phys, head: c_ulong) {
    static void bts_buffer_pad_out(struct bts_phys *phys, unsigned long head)
    {
    let mut index: c_ulong = head - phys.offset;
    memset(page_address(phys.page) + index, 0, phys.size - index);
    }
#[no_mangle]
unsafe extern "C" fn bts_update(bts: *mut bts_ctx) {
    static void bts_update(struct bts_ctx *bts)
    {
    let mut cpu: c_int = raw_smp_processor_id();
    struct debug_store *ds = per_cpu(cpu_hw_events, cpu).ds;
    struct bts_buffer *bb = perf_get_aux(&bts.handle);
    let mut index: c_ulong = ds.bts_index - ds.bts_buffer_base, old, head;
    if (!bb)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn __bts_event_start(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn bts_event_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __bts_event_stop(event: *mut perf_event, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bts_event_stop(event: *mut perf_event, flags: c_int) {
    static void bts_event_stop(struct perf_event *event, int flags)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    struct bts_ctx *bts = this_cpu_ptr(bts_ctx);
    struct bts_buffer *bb = core::ptr::null_mut();
    let mut state: c_int = READ_ONCE(bts.state);
...
#[no_mangle]
pub unsafe extern "C" fn intel_bts_enable_local() {
...
#[no_mangle]
pub unsafe extern "C" fn intel_bts_disable_local() {
...
#[no_mangle]
pub unsafe extern "C" fn intel_bts_interrupt() -> c_int {
    ...
    struct bts_buffer *bb;
    s64 old_head;
    let mut err: c_int = -ENOSPC, handled = 0;
    if (!bts_ctx)
    return 0;
    bts = this_cpu_ptr(bts_ctx);
...
#[no_mangle]
unsafe extern "C" fn bts_event_del(event: *mut perf_event, mode: c_int) {
    static void bts_event_del(struct perf_event *event, int mode)
    {
    bts_event_stop(event, PERF_EF_UPDATE);
    }
#[no_mangle]
unsafe extern "C" fn bts_event_add(event: *mut perf_event, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bts_event_destroy(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn bts_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bts_event_read(event: *mut perf_event) {
    static void bts_event_read(struct perf_event *event)
    {
    }
#[no_mangle]
unsafe extern "C" fn bts_init() -> __init int {
