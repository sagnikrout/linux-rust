...
//! Source: arch/x86/events/intel/ds.c
#![no_std]
...
pub const BTS_RECORD_SIZE: c_int = 24;

//
// pebs_record_32 for p4 and core not supported
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pebs_record_32 {
    pub ip: u32 flags,,
    pub dx: u32 ax, bc, cx,,
    pub sp: u32 si, di, bp,,
}
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_data_source_nhm() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __intel_pmu_pebs_data_source_skl(pmem: bool, data_source: *mut u64) -> void __init {
    static void __init __intel_pmu_pebs_data_source_skl(bool pmem, u64 *data_source)
    {
    let mut pmem_or_l4: u64 = pmem ? LEVEL(PMEM) : LEVEL(L4);
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_data_source_skl(pmem: bool) -> void __init {
    void __init intel_pmu_pebs_data_source_skl(bool pmem)
    {
    __intel_pmu_pebs_data_source_skl(pmem, pebs_data_source);
    }
#[no_mangle]
unsafe extern "C" fn __intel_pmu_pebs_data_source_grt(data_source: *mut u64) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_data_source_grt() -> void __init {
    void __init intel_pmu_pebs_data_source_grt(void)
    {
    __intel_pmu_pebs_data_source_grt(pebs_data_source);
    }
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_data_source_adl() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __intel_pmu_pebs_data_source_cmt(data_source: *mut u64) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_data_source_mtl() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_data_source_arl_h() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_data_source_cmt() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_data_source_lnl() -> void __init {
...
// L2 hit
pub const PNC_PEBS_DATA_SOURCE_MAX: c_int = 16;
...
// L2 hit
pub const ARW_PEBS_DATA_SOURCE_MAX: c_int = 16;
...
// L2 miss
pub const OMR_DATA_SOURCE_MAX: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn parse_omr_data_source(dse: u8) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x7: omr.omr_source >) -> else {
    else if (omr.omr_source > 0x7)
    val |= omr.omr_remote ? P(LVL, REM_RAM1) : P(LVL, LOC_RAM);
    if (omr.omr_remote)
    val |= REM;
    if (omr.omr_source == 0x2) {
    let mut snoop: u8 = omr.omr_snoop | (omr.omr_promoted << 1);
    if (omr.omr_hitm)
    val |= P(SNOOP, HITM);
#[no_mangle]
pub unsafe extern "C" fn if(0x0: snoop ==) -> else {
    else if (snoop == 0x0)
    val |= P(SNOOP, NA);
#[no_mangle]
pub unsafe extern "C" fn if(0x1: snoop ==) -> else {
    else if (snoop == 0x1)
    val |= P(SNOOP, MISS);
#[no_mangle]
pub unsafe extern "C" fn if(0x2: snoop ==) -> else {
    else if (snoop == 0x2)
    val |= P(SNOOP, HIT);
#[no_mangle]
pub unsafe extern "C" fn if(0x3: snoop ==) -> else {
    else if (snoop == 0x3)
    val |= P(SNOOP, NONE);
...
#[no_mangle]
unsafe extern "C" fn precise_store_data(status: u64) -> u64 {
    static u64 precise_store_data(u64 status)
    {
    union intel_x86_pebs_dse dse;
    let mut val: u64 = P(OP, STORE) | P(SNOOP, NA) | P(LVL, L1) | P(TLB, L2);
    dse.val = status;
//
// bit 4: TLB access
...
#[no_mangle]
unsafe extern "C" fn precise_datala_hsw(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn if(PERF_X86_EVENT_PEBS_LD_HSW: event->hw.flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn pebs_set_tlb_lock(val: *mut u64, tlb: bool, lock: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn grt_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn cmt_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arw_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn lnc_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn lnl_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn arl_h_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn pnc_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn nvl_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn load_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn store_latency_data(event: *mut perf_event, status: u64) -> u64 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pebs_record_core {
    pub ip: u64 flags,,
    pub dx: u64 ax, bx, cx,,
    pub sp: u64 si, di, bp,,
    pub r11: u64 r8, r9, r10,,
    pub r15: u64 r12, r13, r14,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pebs_record_nhm {
    pub ip: u64 flags,,
    pub dx: u64 ax, bx, cx,,
    pub sp: u64 si, di, bp,,
    pub r11: u64 r8, r9, r10,,
    pub r15: u64 r12, r13, r14,,
    pub lat: u64 status, dla, dse,,
}
...
pub const PEBS_HSW_TSX_FLAGS: c_uint = 0xff00000000ULL;
// Same as HSW, plus TSC
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pebs_record_skl {
    pub ip: u64 flags,,
    pub dx: u64 ax, bx, cx,,
    pub sp: u64 si, di, bp,,
    pub r11: u64 r8, r9, r10,,
...
#[no_mangle]
pub unsafe extern "C" fn init_debug_store_on_cpu(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn fini_debug_store_on_cpu(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ds_update_cea(cea: *mut c_void, addr: *mut c_void, size: usize, prot: pgprot_t) {
    static void ds_update_cea(void *cea, void *addr, size_t size, pgprot_t prot)
    {
    let mut start: c_ulong = (unsigned long)cea;
    phys_addr_t pa;
    let mut msz: usize = 0;
...
#[no_mangle]
unsafe extern "C" fn ds_clear_cea(cea: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn dsfree_pages(buffer: *const c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn alloc_pebs_buffer(cpu: c_int) -> c_int {
    static int alloc_pebs_buffer(int cpu)
    {
    struct cpu_hw_events *hwev = per_cpu_ptr(&cpu_hw_events, cpu);
    struct debug_store *ds = hwev.ds;
    let mut bsiz: usize = x86_pmu.pebs_buffer_size;
...
#[no_mangle]
unsafe extern "C" fn release_pebs_buffer(cpu: c_int) {
    ...
    per_cpu(insn_buffer, cpu) = core::ptr::null_mut();
// Clear the fixmap
    cea = &get_cpu_entry_area(cpu).cpu_debug_buffers.pebs_buffer;
    ds_clear_cea(cea, x86_pmu.pebs_buffer_size);
    }
    dsfree_pages(hwev.pebs_vaddr, x86_pmu.pebs_buffer_size);
    hwev.pebs_vaddr = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn alloc_bts_buffer(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_bts_buffer(cpu: c_int) {
...
// Clear the fixmap
    ...
    hwev.ds_bts_vaddr = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn alloc_ds_buffer(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_ds_buffer(cpu: c_int) {
    static void release_ds_buffer(int cpu)
    {
    per_cpu(cpu_hw_events, cpu).ds = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn release_ds_buffers() {
...
#[no_mangle]
pub unsafe extern "C" fn reserve_ds_buffers() {
    void reserve_ds_buffers(void)
    {
    let mut bts_err: c_int = 0, pebs_err = 0;
    int cpu;
...
#[no_mangle]
pub unsafe extern "C" fn alloc_arch_pebs_buf_on_cpu(cpu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn release_arch_pebs_buf_on_cpu(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn init_arch_pebs_on_cpu(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn fini_arch_pebs_on_cpu(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_enable_bts(config: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_disable_bts() {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_drain_bts_buffer() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_drain_pebs_buffer() {
    void intel_pmu_drain_pebs_buffer(void)
    {
    struct perf_sample_data data;
    static_call(x86_pmu_drain_pebs)(core::ptr::null_mut(), &data);
    }
//
// PEBS
//
...
//
#[no_mangle]
pub unsafe extern "C" fn pebs_needs_sched_cb(cpuc: *mut cpu_hw_events) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_sched_task(pmu_ctx: *mut perf_event_pmu_context, sched_in: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn pebs_update_threshold(cpuc: *mut cpu_hw_events) {
    static inline void pebs_update_threshold(struct cpu_hw_events *cpuc)
    {
    struct debug_store *ds = cpuc.ds;
    let mut max_pebs_events: c_int = intel_pmu_max_num_pebs(cpuc.pmu);
    u64 threshold;
    int reserved;
...
#[no_mangle]
unsafe extern "C" fn adaptive_pebs_record_size_update() {
    static void adaptive_pebs_record_size_update(void)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    let mut pebs_data_cfg: u64 = cpuc.pebs_data_cfg;
    let mut sz: c_int = sizeof(struct pebs_basic);
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_late_setup(cpuc: *mut cpu_hw_events) {
    void intel_pmu_pebs_late_setup(struct cpu_hw_events *cpuc)
    {
    struct perf_event *event;
    let mut pebs_data_cfg: u64 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn pebs_update_adaptive_cfg(event: *mut perf_event) -> u64 {
    static u64 pebs_update_adaptive_cfg(struct perf_event *event)
    {
    struct perf_event_attr *attr = &event.attr;
    let mut sample_type: u64 = attr.sample_type;
    let mut pebs_data_cfg: u64 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn intel_get_arch_pebs_data_config(event: *mut perf_event) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_add(event: *mut perf_event) {
    void intel_pmu_pebs_add(struct perf_event *event)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    struct hw_perf_event *hwc = &event.hw;
    let mut needed_cb: bool = pebs_needs_sched_cb(cpuc);
    cpuc.n_pebs++;
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_pebs_via_pt_disable(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_pebs_via_pt_enable(event: *mut perf_event) {
    static void intel_pmu_pebs_via_pt_enable(struct perf_event *event)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    struct hw_perf_event *hwc = &event.hw;
    struct debug_store *ds = cpuc.ds;
    let mut value: u64 = ds.pebs_event_reset[hwc.idx];
    let mut base: u32 = MSR_RELOAD_PMC0;
    let mut idx: c_uint = hwc.idx;
    if (!is_pebs_pt(event))
    return;
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_drain_large_pebs(cpuc: *mut cpu_hw_events) {
...
#[no_mangle]
unsafe extern "C" fn __intel_pmu_pebs_enable(event: *mut perf_event) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_enable(event: *mut perf_event) {
    void intel_pmu_pebs_enable(struct perf_event *event)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    let mut pebs_data_cfg: u64 = cpuc.pebs_data_cfg & ~PEBS_UPDATE_DS_SW;
    struct hw_perf_event *hwc = &event.hw;
    struct debug_store *ds = cpuc.ds;
    let mut idx: c_uint = hwc.idx;
...
#[no_mangle]
pub unsafe extern "C" fn if(PERF_X86_EVENT_PEBS_ST: event->hw.flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_del(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn __intel_pmu_pebs_disable(event: *mut perf_event) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_disable(event: *mut perf_event) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_enable_all() {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pmu_pebs_disable_all() {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_pebs_fixup_ip(regs: *mut pt_regs) -> c_int {
    static int intel_pmu_pebs_fixup_ip(struct pt_regs *regs)
    {
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    let mut from: c_ulong = cpuc.lbr_entries[0].from;
    unsigned long old_to, to = cpuc.lbr_entries[0].to;
    let mut ip: c_ulong = regs.ip;
    let mut is_64bit: c_int = 0;
    void *kaddr;
    int size;
//
...
#[no_mangle]
pub unsafe extern "C" fn intel_get_tsx_weight(tsx_tuning: u64) -> u64 {
    static inline u64 intel_get_tsx_weight(u64 tsx_tuning)
    {
    if (tsx_tuning) {
    let mut tsx: union hsw_tsx_tuning = { .value = tsx_tuning };
    return tsx.cycles_last_block;
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn intel_get_tsx_transaction(tsx_tuning: u64, ax: u64) -> u64 {
    static inline u64 intel_get_tsx_transaction(u64 tsx_tuning, u64 ax)
    {
    let mut txn: u64 = (tsx_tuning & PEBS_HSW_TSX_FLAGS) >> 32;
...
#[no_mangle]
pub unsafe extern "C" fn get_pebs_status(n: *mut c_void) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn get_data_src(event: *mut perf_event, aux: u64) -> u64 {
    static u64 get_data_src(struct perf_event *event, u64 aux)
    {
    let mut val: u64 = PERF_MEM_NA;
    let mut fl: c_int = event.hw.flags;
    let mut fst: bool = fl & (PERF_X86_EVENT_PEBS_ST | PERF_X86_EVENT_PEBS_HSW_PREC);
    if (fl & PERF_X86_EVENT_PEBS_LDLAT)
    val = load_latency_data(event, aux);
#[no_mangle]
pub unsafe extern "C" fn if(PERF_X86_EVENT_PEBS_STLAT: fl &) -> else {
    else if (fl & PERF_X86_EVENT_PEBS_STLAT)
    val = store_latency_data(event, aux);
#[no_mangle]
pub unsafe extern "C" fn if(PERF_X86_EVENT_PEBS_LAT_HYBRID: fl &) -> else {
    else if (fl & PERF_X86_EVENT_PEBS_LAT_HYBRID)
    val = x86_pmu.pebs_latency_data(event, aux);
#[no_mangle]
pub unsafe extern "C" fn if(PERF_X86_EVENT_PEBS_HSW_PREC): fst && (fl &) -> else {
    else if (fst && (fl & PERF_X86_EVENT_PEBS_HSW_PREC))
    val = precise_datala_hsw(event, aux);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fst) -> else {
    else if (fst)
...
#[no_mangle]
unsafe extern "C" fn intel_perf_event_update_pmc(event: *mut perf_event, pmc: u64) {
    static void intel_perf_event_update_pmc(struct perf_event *event, u64 pmc)
    {
    let mut shift: c_int = 64 - x86_pmu.cntval_bits;
...
pub const PEBS_LATENCY_MASK: c_uint = 0xffff;
...
// The ip in basic is EventingIP
    ...
    let mut tsx_latency: u64 = intel_get_tsx_weight(tsx_tuning);
...
//
    ...
    struct pebs_meminfo *meminfo = core::ptr::null_mut();
    struct pebs_gprs *gprs = core::ptr::null_mut();
    struct x86_perf_regs *perf_regs;
    u64 format_group;
    u16 retire;
    if (basic == core::ptr::null_mut())
    return;
    perf_regs = container_of(regs, struct x86_perf_regs, regs);
    perf_regs.xmm_regs = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn arch_pebs_record_continued(header: *mut arch_pebs_header) -> bool {
...
// Continue bit or null PEBS record indicates fragment follows.
    ...
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    let mut sample_type: u64 = event.attr.sample_type;
    struct arch_pebs_header *header = core::ptr::null_mut();
    struct arch_pebs_aux *meminfo = core::ptr::null_mut();
    struct arch_pebs_gprs *gprs = core::ptr::null_mut();
    struct x86_perf_regs *perf_regs;
    void *next_record;
    void *at = __pebs;
    if (at == core::ptr::null_mut())
    return;
    perf_regs = container_of(regs, struct x86_perf_regs, regs);
    perf_regs.xmm_regs = core::ptr::null_mut();
    __setup_perf_sample_data(event, iregs, data);
...
//
    ...
    let mut status: c_ulong = get_pebs_status(at);
...
//
    ...
    struct hw_perf_event *hwc = &event.hw;
    let mut shift: c_int = 64 - x86_pmu.cntval_bits;
    let mut period: u64 = hwc.sample_period;
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_drain_pebs_core(iregs: *mut pt_regs, data: *mut perf_sample_data) {
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_pebs_event_update_no_drain(cpuc: *mut cpu_hw_events, mask: u64) {
    static void intel_pmu_pebs_event_update_no_drain(struct cpu_hw_events *cpuc, u64 mask)
    {
    let mut pebs_enabled: u64 = cpuc.pebs_enabled & mask;
    struct perf_event *event;
    int bit;
//
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_drain_pebs_nhm(iregs: *mut pt_regs, data: *mut perf_sample_data) {
    ...
    let mut max_pebs_events: c_int = intel_pmu_max_num_pebs(core::ptr::null_mut());
    int bit, i, size;
    u64 mask;
    if (!x86_pmu.pebs_active)
    return;
    ...
    size = INTEL_PMC_IDX_FIXED + x86_pmu_max_num_counters_fixed(core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn intel_pmu_drain_pebs_icl(iregs: *mut pt_regs, data: *mut perf_sample_data) {
...
#[no_mangle]
unsafe extern "C" fn intel_arch_pebs_init() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn intel_ds_pebs_init() -> void __init {
...
//
    ...
    if (x86_pmu.ds_pebs) {
    let mut pebs_type: c_char = x86_pmu.intel_cap.pebs_trap ?  '+' : '-';
    char *pebs_qual = "";
    let mut format: c_int = x86_pmu.intel_cap.pebs_format;
    if (format < 4)
...
#[no_mangle]
pub unsafe extern "C" fn intel_pebs_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn perf_restore_debug_store() {
