...
pub const PERF_RAPL_CORE_EVENTS_MAX: c_int = 1;
    ...
    let mut __initconst: *const static char rapl_core_domain_name = "core";
//
// event code: LSB 8 bits, passed in attr->config
// any other bit is reserved
//
pub const RAPL_EVENT_MASK: c_uint = 0xFFULL;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rapl_pmus {
    pub pmu: pmu,
    pub nr_rapl_pmu: c_uint,
    pub cntr_mask: c_uint,
    pub __counted_by(nr_rapl_pmu): *mut *mut rapl_pmu rapl_pmu[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rapl_model {
    pub rapl_pkg_msrs: *mut perf_msr,
    pub rapl_core_msrs: *mut perf_msr,
    pub pkg_events: c_ulong,
    pub core_events: c_ulong,
    pub msr_power_unit: c_uint,
    pub unit_quirk: enum rapl_unit_quirk,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn get_rapl_pmu_idx(cpu: c_int, scope: c_int) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_read_counter(event: *mut perf_event) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_scale(v: u64, event: *mut perf_event) -> u64 {
    static inline u64 rapl_scale(u64 v, struct perf_event *event)
    {
    let mut hw_unit: c_int = rapl_pkg_hw_unit[event.hw.config - 1];
...
unsafe extern "C" fn rapl_event_update(event: *mut perf_event) -> u64 {
    ...
    s64 delta, sdelta;
    let mut shift: c_int = RAPL_CNTR_WIDTH;
...
#[no_mangle]
unsafe extern "C" fn rapl_start_hrtimer(pmu: *mut rapl_pmu) {
...
#[no_mangle]
unsafe extern "C" fn rapl_hrtimer_init(rapl_pmu: *mut rapl_pmu) {
...
#[no_mangle]
unsafe extern "C" fn test_msr(idx: c_int, data: *mut c_void) -> bool {
    static bool test_msr(int idx, void *data)
    {
    return test_bit(idx, (unsigned long *) data);
    }
// Only lower 32bits of the MSR represents the energy counter
pub const RAPL_MSR_MASK: c_uint = 0xFFFFFFFF;
...
//
    ...
    [PERF_RAPL_PP0]  = { 0, &rapl_events_cores_group, core::ptr::null_mut(), false, 0 },
    [PERF_RAPL_PKG]  = { MSR_AMD_PKG_ENERGY_STATUS,  &rapl_events_pkg_group,   test_msr, false, RAPL_MSR_MASK },
    [PERF_RAPL_RAM]  = { 0, &rapl_events_ram_group,   core::ptr::null_mut(), false, 0 },
    [PERF_RAPL_PP1]  = { 0, &rapl_events_gpu_group,   core::ptr::null_mut(), false, 0 },
    [PERF_RAPL_PSYS] = { 0, &rapl_events_psys_group,  core::ptr::null_mut(), false, 0 },
    };
...
#[no_mangle]
unsafe extern "C" fn rapl_check_hw_unit() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rapl_advertise() -> void __init {
    static void __init rapl_advertise(void)
    {
    int i;
    let mut num_counters: c_int = hweight32(rapl_pmus_pkg.cntr_mask);
    if (rapl_pmus_core)
...
#[no_mangle]
unsafe extern "C" fn cleanup_rapl_pmus(rapl_pmus: *mut rapl_pmus) {
...
#[no_mangle]
unsafe extern "C" fn init_rapl_pmu(rapl_pmus: *mut rapl_pmus) -> int __init {
    ...
    {
    let mut nr_rapl_pmu: c_int = topology_max_packages();
    struct rapl_pmus *rapl_pmus;
    int ret;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(PERF_PMU_SCOPE_CORE: rapl_pmu_scope ==) -> else {
    else if (rapl_pmu_scope == PERF_PMU_SCOPE_CORE)
    nr_rapl_pmu	*= topology_num_cores_per_package();
#[no_mangle]
pub unsafe extern "C" fn if(PERF_PMU_SCOPE_PKG: rapl_pmu_scope !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn rapl_pmu_init() -> int __init {
    static int __init rapl_pmu_init(void)
    {
    const struct x86_cpu_id *id;
    let mut rapl_pkg_pmu_scope: c_int = PERF_PMU_SCOPE_DIE;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn intel_rapl_exit() -> void __exit {
