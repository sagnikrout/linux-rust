...
//! Source: arch/x86/events/amd/power.c
#![no_std]
...
pub const AMD_POWER_EVENT_MASK: c_uint = 0xFFULL;
//
// Accumulated power status counters.
//
pub const AMD_POWER_EVENTSEL_PKG: c_int = 1;
//
...
#[no_mangle]
unsafe extern "C" fn event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn __pmu_event_start(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn pmu_event_start(event: *mut perf_event, mode: c_int) {
    static void pmu_event_start(struct perf_event *event, int mode)
    {
    __pmu_event_start(event);
    }
#[no_mangle]
unsafe extern "C" fn pmu_event_stop(event: *mut perf_event, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pmu_event_add(event: *mut perf_event, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_event_del(event: *mut perf_event, flags: c_int) {
    static void pmu_event_del(struct perf_event *event, int flags)
    {
    pmu_event_stop(event, PERF_EF_UPDATE);
    }
#[no_mangle]
unsafe extern "C" fn pmu_event_init(event: *mut perf_event) -> c_int {
    static int pmu_event_init(struct perf_event *event)
    {
    let mut cfg: u64 = event.attr.config & AMD_POWER_EVENT_MASK;
...
#[no_mangle]
unsafe extern "C" fn pmu_event_read(event: *mut perf_event) {
    ...
    static DEVICE_ATTR(cpumask, S_IRUGO, get_attr_cpumask, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn power_cpu_exit(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_cpu_init(cpu: c_uint) -> c_int {
...
//
    ...
    X86_MATCH_VENDOR_FAM(AMD, 0x15, core::ptr::null_mut()),
    {},
    };
#[no_mangle]
unsafe extern "C" fn amd_power_pmu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn amd_power_pmu_exit() -> void __exit {
