...
//! Source: arch/x86/events/amd/ibs.c
#![no_std]
...
// attr.config2
pub const IBS_SW_FILTER_MASK: c_int = 1;
// attr.config1
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpu_perf_ibs {
    pub event: *mut perf_event,
    pub state: [c_ulong; BITS_TO_LONGS(IBS_MAX_STATES)],
}
...
pub struct perf_ibs {
    ...
    pub cnt_mask: u64,
    pub enable_mask: u64,
    pub disable_mask: u64,
    pub valid_mask: u64,
    pub min_period: u16,
    pub max_period: u64,
    pub offset_mask: [c_ulong; 1],
    pub offset_max: c_int,
    pub 1: unsigned int fetch_count_reset_broken :,
    pub 1: unsigned int fetch_ignore_if_zero_rip :,
    pub pcpu: *mut cpu_perf_ibs __percpu,
    pub config): *mut *mut u64 (get_count)(u64,
}
...
//
    ...
    left = max;
#[no_mangle]
pub unsafe extern "C" fn if(min: left <) -> else {
    else if (left < min)
    left = min;
    }
// hw_period = (u64)left;
...
//
#[no_mangle]
unsafe extern "C" fn core_pmu_ibs_config(event: *mut perf_event, config: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_init(event: *mut perf_event) -> c_int {
...
// Silently mask off lower nibble. IBS hw mandates it.
    ...
    let mut ldlat: u64 = event.attr.config1 & IBS_OP_CONFIG1_LDLAT_MASK;
    ...
    let mut fetchlat: u64 = event.attr.config1 & IBS_FETCH_CONFIG1_FETCHLAT_MASK;
    ...
    let mut strmst: u64 = event.attr.config1 & IBS_OP_CONFIG1_STRMST_MASK;
...
#[no_mangle]
unsafe extern "C" fn get_ibs_fetch_count(config: u64) -> u64 {
    static u64 get_ibs_fetch_count(u64 config)
    {
    let mut fetch_ctl: union ibs_fetch_ctl = (union ibs_fetch_ctl)config;
...
unsafe extern "C" fn get_ibs_op_count(config: u64) -> u64 {
    ...
    {
    let mut op_ctl: union ibs_op_ctl = (union ibs_op_ctl)config;
    let mut count: u64 = 0;
//
...
//
    ...
    u64 *config)
    {
    let mut count: u64 = perf_ibs.get_count(*config);
//
...
//
    ...
    {
    let mut tmp: u64 = hwc.config | config;
...
//
#[no_mangle]
unsafe extern "C" fn perf_ibs_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_del(event: *mut perf_event, flags: c_int) {
    ...
    pcpu.event = core::ptr::null_mut();
    perf_event_update_userpage(event);
    }
    static void perf_ibs_read(struct perf_event *event) { }
#[no_mangle]
unsafe extern "C" fn perf_ibs_check_period(event: *mut perf_event, value: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: op_data3->st_op) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn perf_ibs_data_src(op_data2: *mut union ibs_op_data2) -> u8 {
    ...
    {
    union perf_mem_data_src *data_src = &data.data_src;
    let mut ibs_data_src: u8 = perf_ibs_data_src(op_data2);
    data_src.mem_lvl = 0;
...
//
    ...
    goto check_mab;
    if (ibs_caps & IBS_CAPS_ZEN4) {
    let mut val: u64 = g_zen4_data_src[ibs_data_src];
    if (!val)
    goto check_mab;
// HOPS_1 because IBS doesn't provide remote socket detail
    ...
    let mut val: u64 = g_data_src[ibs_data_src];
    if (!val)
    goto check_mab;
// HOPS_1 because IBS doesn't provide remote socket detail
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_cache_hit_st_valid() -> bool {
...
// 0: Uninitialized, 1: Valid, -1: Invalid
    ...
    let mut cache_hit_st_valid: return = = 1;
    }
...
// Be careful. Works only for contiguous MSRs.
    ...
    union ibs_op_data3 *op_data3)
    {
    let mut val: __u64 = ibs_data.regs[ibs_op_msr_idx(MSR_AMD64_IBSOPDATA2)];
// Erratum #1293
    if (boot_cpu_data.x86 == 0x19 && boot_cpu_data.x86_model <= 0xF &&
    (op_data3.sw_pf || op_data3.dc_miss_no_mab_alloc)) {
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: check_rip) -> else {
    else if (check_rip)
    return 3;
    return 1;
    }
    ...
    struct perf_ibs_data *ibs_data)
    {
    let mut sample_type_mask: u64 = PERF_SAMPLE_ADDR | PERF_SAMPLE_RAW;
    union ibs_op_data3 op_data3;
    u64 dc_lin_addr;
    op_data3.val = ibs_data.regs[ibs_op_msr_idx(MSR_AMD64_IBSOPDATA3)];
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_handle_irq(perf_ibs: *mut perf_ibs, iregs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_pmu_init(perf_ibs: *mut perf_ibs, name: *mut c_char) -> __init int {
    ...
    if (ret) {
    perf_ibs.pcpu = core::ptr::null_mut();
    free_percpu(pcpu);
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn perf_ibs_fetch_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_op_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn perf_event_ibs_init() -> __init int {
    ...
    perf_ibs_op.pcpu = core::ptr::null_mut();
    err_op:
    perf_pmu_unregister(&perf_ibs_fetch.pmu);
    free_percpu(perf_ibs_fetch.pcpu);
    perf_ibs_fetch.pcpu = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn __get_ibs_caps() -> __init u32 {
...
#[no_mangle]
pub unsafe extern "C" fn get_ibs_caps() -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn get_eilvt(offset: c_int) -> c_int {
    static inline int get_eilvt(int offset)
    {
    return !setup_APIC_eilvt(offset, 0, APIC_DELIVERY_MODE_NMI, 1);
    }
#[no_mangle]
pub unsafe extern "C" fn put_eilvt(offset: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibs_eilvt_valid() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_ibs_ctl(ibs_eilvt_off: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn force_ibs_eilvt_setup() {
...
#[no_mangle]
unsafe extern "C" fn ibs_eilvt_setup() {
...
#[no_mangle]
pub unsafe extern "C" fn get_ibs_lvt_offset() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_APIC_ibs() {
...
#[no_mangle]
unsafe extern "C" fn clear_APIC_ibs() {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_amd_ibs_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn perf_ibs_pm_init() {
...
#[no_mangle]
unsafe extern "C" fn x86_pmu_amd_ibs_dying_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_ibs_init() -> __init int {
