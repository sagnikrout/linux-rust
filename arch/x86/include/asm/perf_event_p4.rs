...
//! Source: arch/x86/include/asm/perf_event_p4.h
#![no_std]
...
pub const P4_ESCR_EVENT_MASK: c_uint = 0x7e000000ULL;
pub const P4_ESCR_EVENT_SHIFT: c_int = 25;
pub const P4_ESCR_EVENTMASK_MASK: c_uint = 0x01fffe00ULL;
pub const P4_ESCR_EVENTMASK_SHIFT: c_int = 9;
pub const P4_ESCR_TAG_MASK: c_uint = 0x000001e0ULL;
pub const P4_ESCR_TAG_SHIFT: c_int = 5;
pub const P4_ESCR_TAG_ENABLE: c_uint = 0x00000010ULL;
pub const P4_ESCR_T0_OS: c_uint = 0x00000008ULL;
pub const P4_ESCR_T0_USR: c_uint = 0x00000004ULL;
pub const P4_ESCR_T1_OS: c_uint = 0x00000002ULL;
pub const P4_ESCR_T1_USR: c_uint = 0x00000001ULL;

pub const P4_CCCR_OVF: c_uint = 0x80000000ULL;
pub const P4_CCCR_CASCADE: c_uint = 0x40000000ULL;
pub const P4_CCCR_OVF_PMI_T0: c_uint = 0x04000000ULL;
pub const P4_CCCR_OVF_PMI_T1: c_uint = 0x08000000ULL;
pub const P4_CCCR_FORCE_OVF: c_uint = 0x02000000ULL;
pub const P4_CCCR_EDGE: c_uint = 0x01000000ULL;
pub const P4_CCCR_THRESHOLD_MASK: c_uint = 0x00f00000ULL;
pub const P4_CCCR_THRESHOLD_SHIFT: c_int = 20;
pub const P4_CCCR_COMPLEMENT: c_uint = 0x00080000ULL;
pub const P4_CCCR_COMPARE: c_uint = 0x00040000ULL;
pub const P4_CCCR_ESCR_SELECT_MASK: c_uint = 0x0000e000ULL;
pub const P4_CCCR_ESCR_SELECT_SHIFT: c_int = 13;
pub const P4_CCCR_ENABLE: c_uint = 0x00001000ULL;
pub const P4_CCCR_THREAD_SINGLE: c_uint = 0x00010000ULL;
pub const P4_CCCR_THREAD_BOTH: c_uint = 0x00020000ULL;
pub const P4_CCCR_THREAD_ANY: c_uint = 0x00030000ULL;
pub const P4_CCCR_RESERVED: c_uint = 0x00000fffULL;
...
pub const P4_CONFIG_HT_SHIFT: c_int = 63;
...
extern "C" {
    pub fn p4_ht_config_thread(p4_ht_thread(cpu: config) ^) -> return;
}
//
...
pub const P4_PEBS_CONFIG_METRIC_MASK: c_uint = 0x3FLL;
pub const P4_PEBS_CONFIG_MASK: c_uint = 0xFFLL;
//
// mem: Only counters MSR_IQ_COUNTER4 (16) and
// MSR_IQ_COUNTER5 (17) are allowed for PEBS sampling
//
pub const P4_PEBS_ENABLE: c_uint = 0x02000000ULL;
pub const P4_PEBS_ENABLE_UOP_TAG: c_uint = 0x01000000ULL;

#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum P4_PEBS_METRIC {
