...
//! Source: arch/x86/realmode/init.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn reserve_real_mode() -> void __init {
    void __init reserve_real_mode(void)
    {
    phys_addr_t mem, limit = x86_init.resources.realmode_limit;
    let mut size: usize = real_mode_size_needed();
    if (!size)
    return;
...
#[no_mangle]
unsafe extern "C" fn sme_sev_setup_real_mode(th: *mut trampoline_header) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_real_mode() -> void __init {
    ...
    let mut size: usize = PAGE_ALIGN(real_mode_blob_end - real_mode_blob);
...
//
#[no_mangle]
unsafe extern "C" fn set_real_mode_permissions() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn init_real_mode() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn do_init_real_mode() -> int __init {
