...
//
pub const UMIP_DUMMY_GDT_BASE: c_uint = 0xfffffffffffe0000ULL;
pub const UMIP_DUMMY_IDT_BASE: c_uint = 0xffffffffffff0000ULL;
//
...
//
pub const UMIP_GDT_IDT_BASE_SIZE_64BIT: c_int = 8;
pub const UMIP_GDT_IDT_BASE_SIZE_32BIT: c_int = 4;
pub const UMIP_GDT_IDT_LIMIT_SIZE: c_int = 2;
...
//
#[no_mangle]
unsafe extern "C" fn identify_insn(insn: *mut insn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: X86_MODRM_REG(insn->modrm.value) ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn force_sig_info_umip_fault(addr: *mut void __user, regs: *mut pt_regs) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fixup_umip_exception(regs: *mut pt_regs) -> bool {
