...
//! Source: arch/x86/kernel/signal_32.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn fixup_rpl(sel: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn reload_segments(sc: *mut sigcontext_32) {
...
#[no_mangle]
pub unsafe extern "C" fn ia32_setup_frame(ksig: *mut ksignal, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ia32_setup_rt_frame(ksig: *mut ksignal, regs: *mut pt_regs) -> c_int {
