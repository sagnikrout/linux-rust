...
//! Source: arch/x86/kernel/apm_32.c
#![no_std]
...
//
pub const ALWAYS_CALL_BUSY: c_int = 1;
//
// Define to make the APM BIOS calls zero all data segment registers (so
// that an incorrect BIOS implementation will cause a kernel panic if it
// tries to write to arbitrary memory).
//
// Macro flag: #define APM_ZERO_SEGS
...
//
pub const APM_MAX_EVENTS: c_int = 20;
//
...
pub struct apm_user {
    pub magic: c_int,
    pub next: *mut apm_user,
    pub 1: unsigned int suser:,
    pub 1: unsigned int writer:,
    pub 1: unsigned int reader:,
    pub 1: unsigned int suspend_wait:,
    pub suspend_result: c_int,
    pub suspends_pending: c_int,
    pub standbys_pending: c_int,
    pub suspends_read: c_int,
    pub standbys_read: c_int,
    pub event_head: c_int,
    pub event_tail: c_int,
    pub events: [apm_event_t; APM_MAX_EVENTS],
}

//
// The magic number in apm_user
//
pub const APM_BIOS_MAGIC: c_uint = 0x4101;
//
// idle percentage above which bios idle calls are done
//

pub const DEFAULT_IDLE_THRESHOLD: c_int = 95;

pub const DEFAULT_IDLE_THRESHOLD: c_int = 100;
...
//
    ...
    let mut __read_mostly: static int idle_threshold = DEFAULT_IDLE_THRESHOLD;
    let mut __read_mostly: static int idle_period = DEFAULT_IDLE_PERIOD;
    static int suspends_pending;
    static int standbys_pending;
    static int ignore_sys_suspend;
    static int ignore_normal_resume;
    let mut __read_mostly: static int bounce_interval = DEFAULT_BOUNCE_INTERVAL;
    static bool debug __read_mostly;
    static bool smp __read_mostly;
    let mut apm_disabled: static int = -1;

    static bool power_off;

    let mut power_off: static bool = 1;

    static bool realmode_power_off;

    let mut allow_ints: static bool = 1;
...
//
#[no_mangle]
unsafe extern "C" fn apm_error(str: *mut c_char, err: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __apm_irq_save() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn apm_irq_restore(flags: c_ulong) {
    static inline void apm_irq_restore(unsigned long flags)
    {
    if (irqs_disabled_flags(flags))
    local_irq_disable();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: irqs_disabled()) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn __apm_bios_call(_call: *mut c_void) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn on_cpu0(): *mut *mut long (fn)(void, call: *mut apm_bios_call) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn apm_bios_call(call: *mut apm_bios_call) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __apm_bios_call_simple(_call: *mut c_void) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn apm_driver_version(val: *mut u_short) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn apm_get_event(event: *mut apm_event_t, info: *mut apm_eventinfo_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_power_state(what: u_short, state: u_short) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_system_power_state(state: u_short) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn apm_do_idle() -> c_int {
    static int apm_do_idle(void)
    {
    u32 eax;
    let mut ret: u8 = 0;
    let mut idled: c_int = 0;
    let mut err: c_int = 0;
    if (!need_resched()) {
    idled = 1;
...
//
#[no_mangle]
unsafe extern "C" fn apm_do_busy() {
...
pub const IDLE_LEAKY_MAX: c_int = 16;
//
...
//
    ...
    u64 stime, utime;
    let mut apm_idle_done: c_int = 0;
    let mut jiffies_since_last_check: c_uint = jiffies - last_jiffies;
    unsigned int bucket;
    recalc:
...
//
#[no_mangle]
unsafe extern "C" fn apm_power_off() {
...
//
#[no_mangle]
unsafe extern "C" fn apm_enable_power_management(enable: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn apm_get_power_status(status: *mut u_short, bat: *mut u_short, life: *mut u_short) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn apm_engage_power_management(device: u_short, enable: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn apm_console_blank(blank: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_empty(as: *mut apm_user) -> c_int {
    static int queue_empty(struct apm_user *as)
    {
    return as.event_head == as.event_tail;
    }
#[no_mangle]
unsafe extern "C" fn get_queued_event(as: *mut apm_user) -> apm_event_t {
...
#[no_mangle]
unsafe extern "C" fn queue_event(event: apm_event_t, sender: *mut apm_user) {
    static void queue_event(apm_event_t event, struct apm_user *sender)
    {
    struct apm_user *as;
    spin_lock(&user_list_lock);
    if (user_list == core::ptr::null_mut())
    goto out;
    for (as = user_list; as != core::ptr::null_mut(); as = as.next) {
...
#[no_mangle]
unsafe extern "C" fn reinit_timer() {
...
#[no_mangle]
unsafe extern "C" fn suspend(vetoable: c_int) -> c_int {
    ...
    queue_event(APM_NORMAL_RESUME, core::ptr::null_mut());
    spin_lock(&user_list_lock);
    for (as = user_list; as != core::ptr::null_mut(); as = as.next) {
    as.suspend_wait = 0;
...
#[no_mangle]
unsafe extern "C" fn get_event() -> apm_event_t {
...
#[no_mangle]
unsafe extern "C" fn check_events() {
    ...
    case APM_SYS_STANDBY:
    case APM_USER_STANDBY:
    queue_event(event, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn apm_event_handler() {
    static void apm_event_handler(void)
    {
    let mut pending_count: static int = 4;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn apm_mainloop() {
...
#[no_mangle]
unsafe extern "C" fn check_apm_user(as: *mut apm_user, func: *const c_char) -> c_int {
    static int check_apm_user(struct apm_user *as, const char *func)
    {
    if (as == core::ptr::null_mut() || as.magic != APM_BIOS_MAGIC) {
...
#[no_mangle]
unsafe extern "C" fn do_read(fp: *mut file, buf: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn do_poll(fp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn do_ioctl(filp: *mut file, cmd: u_int, arg: u_long) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn do_release(inode: *mut inode, filp: *mut file) -> c_int {
    ...
    struct apm_user *as1;
    for (as1 = user_list;
    (as1 != core::ptr::null_mut()) && (as1.next != as);
    as1 = as1.next)
    ;
    if (as1 == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn proc_apm_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    unsigned short	dx;
    int		error;
    let mut ac_line_status: c_ushort = 0xff;
    let mut battery_status: c_ushort = 0xff;
    let mut battery_flag: c_ushort = 0xff;
    let mut percentage: c_int = -1;
    let mut time_units: c_int = -1;
    char            *units         = "?";
...
#[no_mangle]
unsafe extern "C" fn apm(unused: *mut c_void) -> c_int {
...
// Install our power off handler..
    ...
    console_blank_hook = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn apm_setup(str: *mut c_char) -> int __init {
    ...
    bounce_interval = simple_strtol(str + 16, core::ptr::null_mut(), 0);
    if ((strncmp(str, "idle-threshold=", 15) == 0) ||
    (strncmp(str, "idle_threshold=", 15) == 0))
    idle_threshold = simple_strtol(str + 15, core::ptr::null_mut(), 0);
    if ((strncmp(str, "idle-period=", 12) == 0) ||
    (strncmp(str, "idle_period=", 12) == 0))
    idle_period = simple_strtol(str + 12, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn print_if_true(d: *const dmi_system_id) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn broken_ps2_resume(d: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_realmode_power_off(d: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_apm_ints(d: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apm_is_horked(d: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apm_is_horked_d850md(d: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apm_likes_to_melt(d: *const dmi_system_id) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn broken_apm_power(d: *const dmi_system_id) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn swab_apm_power_in_minutes(d: *const dmi_system_id) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn apm_init() -> int __init {
...
//
    ...
    proc_create_single("apm", 0, core::ptr::null_mut(), proc_apm_show);
    kapmd_task = kthread_create(apm, core::ptr::null_mut(), "kapmd");
    if (IS_ERR(kapmd_task)) {
    pr_err("disabled - Unable to start kernel thread\n");
    err = PTR_ERR(kapmd_task);
    kapmd_task = core::ptr::null_mut();
    remove_proc_entry("apm", core::ptr::null_mut());
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn apm_exit() -> void __exit {
