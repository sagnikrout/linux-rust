...
// For PCI or other memory-mapped resources
    let mut pci_mem_start: c_ulong = 0xaeedbabe;
...
#[no_mangle]
pub unsafe extern "C" fn e820__mapped_raw_any(start: u64, end: u64, type: enum e820_type) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn e820__mapped_any(start: u64, end: u64, type: enum e820_type) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__mapped_all(start: u64, end: u64, type: enum e820_type) -> __init bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn __e820__range_add(table: *mut e820_table, start: u64, size: u64, type: enum e820_type) -> __init static void {
    __init static void __e820__range_add(struct e820_table *table, u64 start, u64 size, enum e820_type type)
    {
    let mut idx: u32 = table.nr_entries;
...
#[no_mangle]
pub unsafe extern "C" fn e820__range_add(start: u64, size: u64, type: enum e820_type) -> __init void {
    __init void e820__range_add(u64 start, u64 size, enum e820_type type)
    {
    __e820__range_add(e820_table, start, size, type);
    }
#[no_mangle]
pub unsafe extern "C" fn e820_print_type(type: enum e820_type) -> __init static void {
...
#[no_mangle]
pub unsafe extern "C" fn e820__print_table(who: *const c_char) -> __init static void {
    __init static void e820__print_table(const char *who)
    {
    let mut range_end_prev: u64 = 0;
    u32 idx;
    for (idx = 0; idx < e820_table.nr_entries; idx++) {
    struct e820_entry *entry = e820_table.entries + idx;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct change_member {
// Pointer to the original entry:
    pub entry: *mut e820_entry,
...
#[no_mangle]
pub unsafe extern "C" fn cpcompare(a: *const c_void, b: *const c_void) -> __init static int {
...
//
#[no_mangle]
unsafe extern "C" fn e820_type_mergeable(type: enum e820_type) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn e820__update_table(table: *mut e820_table) -> __init int {
    __init int e820__update_table(struct e820_table *table)
    {
    struct e820_entry *entries = table.entries;
    let mut max_nr_entries: u32 = ARRAY_SIZE(table.entries);
...
// Sort change-point list by memory addresses (low -> high):
    sort(change_point, chg_nr, sizeof(*change_point), cpcompare, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn append_e820_table(entries: *mut boot_e820_entry, nr_entries: u32) -> __init static int {
...
// If there aren't any entries, we'll want to fall back to another source:
    ...
    return -ENOENT;
    while (nr_entries) {
    let mut start: u64 = entry.addr;
    let mut size: u64 = entry.size;
    let mut end: u64 = start + size-1;
    let mut type: u32 = entry.type;
// Ignore the remaining entries on 64-bit overflow:
    ...
    u64 end;
    u32 idx;
    let mut real_updated_size: u64 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn e820__range_update(start: u64, size: u64, old_type: enum e820_type, new_type: enum e820_type) -> __init u64 {
...
#[no_mangle]
pub unsafe extern "C" fn e820__range_remove(start: u64, size: u64, filter_type: enum e820_type) -> __init void {
...
#[no_mangle]
pub unsafe extern "C" fn e820__update_table_print() -> __init void {
...
#[no_mangle]
pub unsafe extern "C" fn e820__update_table_kexec() -> __init static void {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820_search_gap(max_gap_start: *mut c_ulong, max_gap_size: *mut c_ulong) -> __init static int {
...
// Process any gap before this entry:
    if (range_start > range_end_prev) {
    let mut gap_start: u64 = range_end_prev;
    let mut gap_end: u64 = range_start;
    u64 gap_size;
...
// Is there a usable gap beyond the last entry:
    ...
    let mut gap_start: u64 = entry.addr + entry.size;
    let mut gap_size: u64 = MAX_GAP_END-gap_start;
    if (gap_size >= *max_gap_size) {
// max_gap_start = gap_start;
// max_gap_size = gap_size;
    found = 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__setup_pci_gap() -> __init void {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__reallocate_tables() -> __init void {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__memory_setup_extended(phys_addr: u64, data_len: u32) -> __init void {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__register_nosave_regions(limit_pfn: c_ulong) -> __init void {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__register_nvs_regions() -> __init static int {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__memblock_alloc_reserved(size: u64, align: u64) -> __init u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__end_ram_pfn(limit_pfn: c_ulong) -> __init static unsigned long {
    __init static unsigned long e820__end_ram_pfn(unsigned long limit_pfn)
    {
    u32 idx;
    let mut last_pfn: c_ulong = 0;
    let mut max_arch_pfn: c_ulong = MAX_ARCH_PFN;
    for (idx = 0; idx < e820_table.nr_entries; idx++) {
    struct e820_entry *entry = &e820_table.entries[idx];
...
#[no_mangle]
pub unsafe extern "C" fn e820__end_of_ram_pfn() -> __init unsigned long {
    __init unsigned long e820__end_of_ram_pfn(void)
    {
    return e820__end_ram_pfn(MAX_ARCH_PFN);
    }
#[no_mangle]
pub unsafe extern "C" fn e820__end_of_low_ram_pfn() -> __init unsigned long {
...
#[no_mangle]
pub unsafe extern "C" fn parse_memopt(p: *mut c_char) -> __init static int {
...
#[no_mangle]
pub unsafe extern "C" fn parse_memmap_one(p: *mut c_char) -> __init static int {
    ...
    let mut from: enum e820_type = 0, to = 0;
    start_at = memparse(p + 1, &p);
    if (*p == '-')
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: to) -> else {
    else if (to)
...
#[no_mangle]
pub unsafe extern "C" fn parse_memmap_opt(str: *mut c_char) -> __init static int {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__finish_early_params() -> __init void {
...
#[no_mangle]
pub unsafe extern "C" fn e820_type_to_string(entry: *mut e820_entry) -> *const __init static char {
...
#[no_mangle]
pub unsafe extern "C" fn e820_type_to_iomem_type(entry: *mut e820_entry) -> __init static unsigned long {
...
#[no_mangle]
pub unsafe extern "C" fn e820_type_to_iores_desc(entry: *mut e820_entry) -> __init static unsigned long {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820_device_region(type: enum e820_type, res: *mut resource) -> __init static bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__reserve_resources() -> __init void {
...
//
#[no_mangle]
pub unsafe extern "C" fn ram_alignment(pos: resource_size_t) -> __init static unsigned long {
    __init static unsigned long ram_alignment(resource_size_t pos)
    {
    let mut mb: c_ulong = pos >> 20;
...
#[no_mangle]
pub unsafe extern "C" fn e820__reserve_resources_late() -> __init void {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__memory_setup_default() -> *mut __init char {
...
//
#[no_mangle]
pub unsafe extern "C" fn e820__memory_setup() -> __init void {
...
#[no_mangle]
pub unsafe extern "C" fn e820__memblock_setup() -> __init void {
