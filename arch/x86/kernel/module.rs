...
//! Source: arch/x86/kernel/module.c
#![no_std]
...
// This is the symbol it is referring to.  Note that all
    ...
    struct module *me)
    {
    const Elf_Shdr *s, *alt = core::ptr::null_mut(),
...
// calls = NULL, *cfi = NULL;
    ...
    its_init_mod(me);
    if (retpolines || cfi) {
    void *rseg = core::ptr::null_mut(), *cseg = core::ptr::null_mut();
    let mut rsize: c_uint = 0, csize = 0;
    if (retpolines) {
