...
//! Source: arch/x86/kernel/apic/apic.c
#![no_std]
...
// Processor that is doing the boot up
    let mut __ro_after_init: u32 boot_cpu_physical_apicid = BAD_APICID;
...
//
    let mut __ro_after_init: static int apic_extnmi = APIC_EXTNMI_BSP;
//
...
#[no_mangle]
pub unsafe extern "C" fn apic_accessible() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn imcr_pic_to_apic() {
...
#[no_mangle]
pub unsafe extern "C" fn imcr_apic_to_pic() {
...
//
#[no_mangle]
unsafe extern "C" fn parse_lapic(arg: *mut c_char) -> int __init {
    static int __init parse_lapic(char *arg)
    {
    if (IS_ENABLED(CONFIG_X86_32) && !arg)
    force_enable_local_apic = 1;
#[no_mangle]
pub unsafe extern "C" fn if(!strncmp(arg: arg &&, _arg: "notscdeadline", _arg: 13)) -> else {
...
#[no_mangle]
unsafe extern "C" fn setup_apicpmtimer(s: *mut c_char) -> __init int {
    static __init int setup_apicpmtimer(char *s)
    {
    apic_calibrate_pmtmr = 1;
    notsc_setup(core::ptr::null_mut());
    return 1;
    }
...
// Measured in ticks per HZ.
    let mut lapic_timer_period: c_uint = 0;
    static void apic_pm_activate(void);
//
// Get the LAPIC version
//
#[no_mangle]
pub unsafe extern "C" fn lapic_get_version() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lapic_is_integrated() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn modern_apic() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn apic_disable() -> void __init {
    static void __init apic_disable(void)
    {
    apic_install_driver(&apic_noop);
    }
#[no_mangle]
pub unsafe extern "C" fn native_apic_icr_write(low: u32, id: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn native_apic_icr_read() -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn lapic_get_maxlvt() -> c_int {
...
//
// Clock divisor
pub const APIC_DIVISOR: c_int = 16;
pub const TSC_DIVISOR: c_int = 8;
// i82489DX specific
...
//
#[no_mangle]
unsafe extern "C" fn __setup_APIC_LVTT(clocks: c_uint, oneshot: c_int, irqen: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_TSC_DEADLINE_TIMER)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn eilvt_entry_is_changeable(old: c_uint, new: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reserve_eilvt_offset(offset: c_int, new: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn setup_APIC_eilvt(offset: u8, vector: u8, msg_type: u8, mask: u8) -> c_int {
    int setup_APIC_eilvt(u8 offset, u8 vector, u8 msg_type, u8 mask)
    {
    let mut reg: c_ulong = APIC_EILVTn(offset);
...
//
#[no_mangle]
unsafe extern "C" fn lapic_next_event(delta: c_ulong, evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lapic_next_deadline(delta: c_ulong, evt: *mut clock_event_device) -> c_int {
...
//
    let mut tsc: u64 = rdtsc();
    native_wrmsrq(MSR_IA32_TSC_DEADLINE, tsc + (((u64) delta) * TSC_DIVISOR));
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn lapic_timer_shutdown(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lapic_timer_set_periodic(evt: *mut clock_event_device) -> c_int {
    static int lapic_timer_set_periodic(struct clock_event_device *evt)
    {
    return lapic_timer_set_periodic_oneshot(evt, false);
    }
#[no_mangle]
unsafe extern "C" fn lapic_timer_set_oneshot(evt: *mut clock_event_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lapic_timer_broadcast(mask: *const cpumask) {
...
#[no_mangle]
unsafe extern "C" fn apic_validate_deadline_timer() -> __init bool {
...
//
#[no_mangle]
unsafe extern "C" fn setup_APIC_timer() {
...
//
#[no_mangle]
unsafe extern "C" fn __lapic_update_tsc_freq(info: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn lapic_update_tsc_freq() {
...
//
    on_each_cpu(__lapic_update_tsc_freq, core::ptr::null_mut(), 0);
    }
//
...
//
    ...
    let mut lapic_cal_loops: static __initdata int = -1;
...
//
#[no_mangle]
unsafe extern "C" fn lapic_cal_handler(dev: *mut clock_event_device) -> void __init {
    static void __init lapic_cal_handler(struct clock_event_device *dev)
    {
    let mut tsc: c_ulonglong = 0;
    let mut tapic: c_long = apic_read(APIC_TMCCT);
    let mut pm: u32 = acpi_pm_read_early();
    ...
    {
    let mut pm_100ms: c_long = PMTMR_TICKS_PER_SEC / 10;
    let mut pm_thresh: c_long = pm_100ms / 100;
    unsigned long mult;
    u64 res;
...
#[no_mangle]
unsafe extern "C" fn lapic_init_clockevent() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn apic_needs_pit() -> bool __init {
...
//
    let mut lapic_timer_period: return = = 0;
    }
#[no_mangle]
unsafe extern "C" fn calibrate_APIC_clock() -> int __init {
    static int __init calibrate_APIC_clock(void)
    {
    struct clock_event_device *levt = this_cpu_ptr(&lapic_events);
    let mut tsc_perj: u64 = 0, tsc_start = 0;
    long delta_tsc_khz, bus_khz;
    unsigned long jif_start;
    unsigned long deltaj;
    long delta, deltatsc;
    let mut pm_referenced: c_int = 0;
    if (boot_cpu_has(X86_FEATURE_TSC_DEADLINE_TIMER))
    return 0;
//
...
// Wait for a tick to elapse
    while (1) {
    if (tsc_khz) {
    let mut tsc_now: u64 = rdtsc();
    if ((tsc_now - tsc_start) >= tsc_perj) {
    tsc_start += tsc_perj;
    break;
    }
    } else {
    let mut jif_now: c_ulong = READ_ONCE(jiffies);
...
// Invoke the calibration routine
    local_irq_disable();
    lapic_cal_handler(core::ptr::null_mut());
    local_irq_enable();
    }
    local_irq_disable();
...
//
#[no_mangle]
pub unsafe extern "C" fn setup_boot_APIC_clock() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_secondary_APIC_clock() {
...
//
#[no_mangle]
unsafe extern "C" fn local_apic_timer_interrupt() {
...
//
#[no_mangle]
pub unsafe extern "C" fn clear_local_APIC() {
...
//
#[no_mangle]
pub unsafe extern "C" fn apic_soft_disable() {
...
//
#[no_mangle]
pub unsafe extern "C" fn lapic_shutdown() {
...
//
#[no_mangle]
pub unsafe extern "C" fn sync_Arb_IDs() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __apic_intr_mode_select() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn apic_intr_mode_select() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn init_bsp_APIC() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn apic_intr_mode_init() -> void __init {
    void __init apic_intr_mode_init(void)
    {
    let mut upmode: bool = IS_ENABLED(CONFIG_UP_LATE_INIT);
...
#[no_mangle]
unsafe extern "C" fn lapic_setup_esr() {
...
#[no_mangle]
unsafe extern "C" fn apic_check_and_eoi_isr(isr: *mut union apic_ir) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn apic_clear_isr() {
...
//
#[no_mangle]
unsafe extern "C" fn setup_local_APIC() {
...
#[no_mangle]
unsafe extern "C" fn end_local_APIC_setup() {
...
//
#[no_mangle]
pub unsafe extern "C" fn apic_ap_setup() {
...
#[no_mangle]
unsafe extern "C" fn apic_read_boot_cpu_id(x2apic: bool) -> __init void {
...
#[no_mangle]
unsafe extern "C" fn x2apic_hw_locked() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __x2apic_disable() {
...
#[no_mangle]
unsafe extern "C" fn __x2apic_enable() {
...
#[no_mangle]
unsafe extern "C" fn setup_nox2apic(str: *mut c_char) -> int __init {
    static int __init setup_nox2apic(char *str)
    {
    if (x2apic_enabled()) {
    let mut apicid: u32 = native_apic_msr_read(APIC_ID);
    if (apicid >= 255) {
...
#[no_mangle]
pub unsafe extern "C" fn x2apic_setup() {
...
#[no_mangle]
unsafe extern "C" fn x2apic_disable() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn x2apic_enable() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn try_to_enable_x2apic(remap_mode: c_int) -> __init void {
    static __init void try_to_enable_x2apic(int remap_mode)
    {
    if (x2apic_state == X2APIC_DISABLED)
    return;
    if (remap_mode != IRQ_REMAP_X2APIC_MODE) {
    let mut apic_limit: u32 = 255;
//
...
#[no_mangle]
pub unsafe extern "C" fn check_x2apic() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn enable_IR_x2apic() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn detect_init_APIC() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn apic_verify(addr: c_ulong) -> bool __init {
...
#[no_mangle]
pub unsafe extern "C" fn apic_force_enable(addr: c_ulong) -> bool __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn init_apic_mappings() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn apic_set_fixmap(read_apic: bool) -> __init void {
    static __init void apic_set_fixmap(bool read_apic)
    {
...
#[no_mangle]
pub unsafe extern "C" fn register_lapic_address(address: c_ulong) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn handle_spurious_interrupt(vector: u8) -> noinline void {
...
//
#[no_mangle]
unsafe extern "C" fn connect_bsp_APIC() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn disconnect_bsp_APIC(virt_wire_setup: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x8000: virt_ext_dest_id && cfg->dest_apicid <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn x86_msi_msg_get_destid(msg: *mut msi_msg, extid: bool) -> u32 {
    u32 x86_msi_msg_get_destid(struct msi_msg *msg, bool extid)
    {
    let mut dest: u32 = msg.arch_addr_lo.destid_0_7;
    if (extid)
...
#[no_mangle]
unsafe extern "C" fn apic_bsp_up_setup() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn apic_bsp_setup(upmode: bool) -> void __init {
    static void __init apic_bsp_setup(bool upmode)
    {
    connect_bsp_APIC();
    if (upmode)
...
#[no_mangle]
pub unsafe extern "C" fn up_late_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn lapic_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lapic_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn apic_pm_activate() {
    static void apic_pm_activate(void)
    {
    apic_pm_state.active = 1;
    }
#[no_mangle]
unsafe extern "C" fn init_lapic_sysfs() -> int __init {
...
// local apic needs to resume before other devices access its registers.
    ...
    static int multi;
#[no_mangle]
unsafe extern "C" fn set_multi(d: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmi_check_multi() {
...
//
#[no_mangle]
pub unsafe extern "C" fn apic_is_clustered_box() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn setup_nolapic(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_lapic_timer_c2_ok(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_disable_apic_timer(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_nolapic_timer(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apic_set_verbosity(arg: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp("verbose", 0: arg) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn lapic_insert_resource() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apic_set_extnmi(arg: *mut c_char) -> int __init {
    ...
    apic_extnmi = APIC_EXTNMI_ALL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp("none", _arg: arg, _arg: 4)) -> else {
    else if (!strncmp("none", arg, 4))
    apic_extnmi = APIC_EXTNMI_NONE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp("bsp", _arg: arg, _arg: 3)) -> else {
