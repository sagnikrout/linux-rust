...
//! Source: arch/x86/kernel/apic/vector.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apic_chip_data {
    pub hw_irq_cfg: irq_cfg,
    pub vector: c_uint,
    pub prev_vector: c_uint,
    pub cpu: c_uint,
    pub prev_cpu: c_uint,
    pub irq: c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn lock_vector_lock() {
...
#[no_mangle]
pub unsafe extern "C" fn unlock_vector_lock() {
...
#[no_mangle]
pub unsafe extern "C" fn copy_irq_alloc_info(dst: *mut irq_alloc_info, src: *mut irq_alloc_info) {
...
// dst = *src;
    ...
    return apicd ? &apicd.hw_irq_cfg : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn free_apic_chip_data(apicd: *mut apic_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn apic_free_vector(cpu: c_uint, vector: c_uint, managed: bool) {
...
#[no_mangle]
unsafe extern "C" fn chip_data_update(irqd: *mut irq_data, newvec: c_uint, newcpu: c_uint) {
    static void chip_data_update(struct irq_data *irqd, unsigned int newvec, unsigned int newcpu)
    {
    struct apic_chip_data *apicd = apic_chip_data(irqd);
    struct irq_desc *desc = irq_data_to_desc(irqd);
    let mut managed: bool = irqd_affinity_is_managed(irqd);
    lockdep_assert_held(&vector_lock);
...
#[no_mangle]
unsafe extern "C" fn vector_assign_managed_shutdown(irqd: *mut irq_data) {
    static void vector_assign_managed_shutdown(struct irq_data *irqd)
    {
    let mut cpu: c_uint = cpumask_first(cpu_online_mask);
    apic_update_irq_cfg(irqd, MANAGED_IRQ_SHUTDOWN_VECTOR, cpu);
    }
#[no_mangle]
unsafe extern "C" fn reserve_managed_vector(irqd: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reserve_irq_vector_locked(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn reserve_irq_vector(irqd: *mut irq_data) -> c_int {
    ...
    {
    struct apic_chip_data *apicd = apic_chip_data(irqd);
    let mut resvd: bool = apicd.has_reserved;
    let mut cpu: c_uint = apicd.cpu;
    let mut vector: c_int = apicd.vector;
    lockdep_assert_held(&vector_lock);
//
...
#[no_mangle]
unsafe extern "C" fn assign_irq_vector(irqd: *mut irq_data, dest: *const cpumask) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn assign_irq_vector_any_locked(irqd: *mut irq_data) -> c_int {
    static int assign_irq_vector_any_locked(struct irq_data *irqd)
    {
// Get the affinity mask - either irq_default_affinity or (user) set
    const struct cpumask *affmsk = irq_data_get_affinity_mask(irqd);
    let mut node: c_int = irq_data_get_node(irqd);
...
#[no_mangle]
unsafe extern "C" fn clear_irq_vector(irqd: *mut irq_data) {
    static void clear_irq_vector(struct irq_data *irqd)
    {
    struct apic_chip_data *apicd = apic_chip_data(irqd);
    let mut managed: bool = irqd_affinity_is_managed(irqd);
    let mut vector: c_uint = apicd.vector;
    lockdep_assert_held(&vector_lock);
    if (!vector)
    return;
...
#[no_mangle]
unsafe extern "C" fn x86_vector_deactivate(dom: *mut irq_domain, irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn activate_reserved(irqd: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn activate_managed(irqd: *mut irq_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(irqd_is_managed_and_shutdown(irqd): reserve ||) -> else {
    else if (reserve || irqd_is_managed_and_shutdown(irqd))
    vector_assign_managed_shutdown(irqd);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: apicd->is_managed) -> else {
    else if (apicd.is_managed)
    ret = activate_managed(irqd);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: apicd->has_reserved) -> else {
...
#[no_mangle]
unsafe extern "C" fn vector_free_reserved_and_managed(irqd: *mut irq_data) {
...
#[no_mangle]
pub unsafe extern "C" fn x86_fwspec_is_ioapic(fwspec: *mut irq_fwspec) -> c_int {
    ...
    simple_strtol(fwname+8, core::ptr::null_mut(), 10) == fwspec.param[0];
    }
...
#[no_mangle]
pub unsafe extern "C" fn x86_fwspec_is_hpet(fwspec: *mut irq_fwspec) -> c_int {
    ...
    simple_strtol(fwname+9, core::ptr::null_mut(), 10) == fwspec.param[0];
    }
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn lapic_assign_legacy_vector(irq: c_uint, replace: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn lapic_update_legacy_vectors() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn lapic_assign_system_vectors() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn arch_early_irq_init() -> int __init {
    ...
    core::ptr::null_mut());
    BUG_ON(x86_vector_domain == core::ptr::null_mut());
...
//
    ...
    {
    let mut isairq: c_int = vector - ISA_IRQ_VECTOR(0);
...
#[no_mangle]
pub unsafe extern "C" fn lapic_online() {
...
#[no_mangle]
pub unsafe extern "C" fn lapic_offline() {
...
#[no_mangle]
unsafe extern "C" fn free_moved_vector(apicd: *mut apic_chip_data) {
    static void free_moved_vector(struct apic_chip_data *apicd)
    {
    let mut vector: c_uint = apicd.prev_vector;
    let mut cpu: c_uint = apicd.prev_cpu;
    let mut managed: bool = apicd.is_managed;
//
...
//
#[no_mangle]
unsafe extern "C" fn apic_force_complete_move(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn apic_retrigger_irq(irqd: *mut irq_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apic_ack_irq(irqd: *mut irq_data) {
...
#[no_mangle]
pub unsafe extern "C" fn apic_ack_edge(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn __vector_cleanup(cl: *mut vector_cleanup, check_irr: bool) {
    static void __vector_cleanup(struct vector_cleanup *cl, bool check_irr)
    {
    struct apic_chip_data *apicd;
    struct hlist_node *tmp;
    let mut rearm: bool = false;
    lockdep_assert_held(&vector_lock);
...
#[no_mangle]
unsafe extern "C" fn vector_cleanup_callback(tmr: *mut timer_list) {
    static void vector_cleanup_callback(struct timer_list *tmr)
    {
...
#[no_mangle]
unsafe extern "C" fn __vector_schedule_cleanup(apicd: *mut apic_chip_data) {
...
#[no_mangle]
pub unsafe extern "C" fn vector_schedule_cleanup(cfg: *mut irq_cfg) {
...
#[no_mangle]
pub unsafe extern "C" fn irq_complete_move(cfg: *mut irq_cfg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn lapic_can_unplug_cpu() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_APIC_field(base: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn print_local_APIC(dummy: *mut c_void) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn print_local_APICs(maxcpu: c_int) -> void __init {
    ...
    if (cpu >= maxcpu)
    break;
    smp_call_function_single(cpu, print_local_APIC, core::ptr::null_mut(), 1);
    }
    preempt_enable();
    }
#[no_mangle]
unsafe extern "C" fn print_PIC() -> void __init {
    ...
    let mut __initdata: static int show_lapic = 1;
#[no_mangle]
unsafe extern "C" fn setup_show_lapic(arg: *mut c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn print_ICs() -> int __init {
