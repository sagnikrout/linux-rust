...
//! Source: arch/x86/kernel/apic/init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn restore_override_callbacks() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn update_static_calls() -> __init void {
...
#[no_mangle]
pub unsafe extern "C" fn apic_setup_apic_calls() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn apic_install_driver(driver: *mut apic) -> void __init {
