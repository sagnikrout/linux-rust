...
//! Source: arch/x86/kernel/apic/msi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn irq_msi_update_msg(irqd: *mut irq_data, cfg: *mut irq_cfg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_dev_has_default_msi_parent_domain(dev: *mut pci_dev) -> bool {
    ...
    if (!domain)
    return false;
    let mut domain: return = = x86_vector_domain;
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn native_create_pci_msi_domain() -> *mut irq_domain  __init {
...
#[no_mangle]
pub unsafe extern "C" fn x86_create_pci_msi_domain() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn dmar_msi_compose_msg(data: *mut irq_data, msg: *mut msi_msg) {
    static void dmar_msi_compose_msg(struct irq_data *data, struct msi_msg *msg)
    {
    __irq_msi_compose_msg(irqd_cfg(data), msg, true);
    }
#[no_mangle]
unsafe extern "C" fn dmar_msi_write_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
pub unsafe extern "C" fn dmar_alloc_hwirq(id: c_int, node: c_int, arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dmar_free_hwirq(irq: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn arch_restore_msi_irqs(dev: *mut pci_dev) -> bool {
