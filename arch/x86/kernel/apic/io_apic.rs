...
#[no_mangle]
pub unsafe extern "C" fn mpc_ioapic_id(ioapic_idx: c_int) -> c_int {
    int mpc_ioapic_id(int ioapic_idx)
    {
    return ioapics[ioapic_idx].mp_config.apicid;
    }
#[no_mangle]
pub unsafe extern "C" fn mpc_ioapic_addr(ioapic_idx: c_int) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn mp_ioapic_pin_count(ioapic: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mp_pin_to_gsi(ioapic: c_int, pin: c_int) -> u32 {
    static inline u32 mp_pin_to_gsi(int ioapic, int pin)
    {
    return mp_ioapic_gsi_routing(ioapic).gsi_base + pin;
    }
#[no_mangle]
pub unsafe extern "C" fn mp_is_legacy_irq(irq: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn disable_ioapic_support() {
...
#[no_mangle]
unsafe extern "C" fn parse_noapic(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn mp_save_irq(m: *mut mpc_intsrc) {
...
#[no_mangle]
unsafe extern "C" fn alloc_ioapic_saved_registers(idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn free_ioapic_saved_registers(idx: c_int) {
    static void free_ioapic_saved_registers(int idx)
    {
    kfree(ioapics[idx].saved_registers);
    ioapics[idx].saved_registers = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn arch_early_ioapic_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn io_apic_eoi(apic: c_uint, vector: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn native_io_apic_read(apic: c_uint, reg: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn __ioapic_read_entry(apic: c_int, pin: c_int) -> IO_APIC_route_entry {
...
#[no_mangle]
unsafe extern "C" fn ioapic_read_entry(apic: c_int, pin: c_int) -> IO_APIC_route_entry {
...
//
#[no_mangle]
unsafe extern "C" fn __ioapic_write_entry(apic: c_int, pin: c_int, e: IO_APIC_route_entry) {
...
#[no_mangle]
unsafe extern "C" fn ioapic_write_entry(apic: c_int, pin: c_int, e: IO_APIC_route_entry) {
...
//
#[no_mangle]
unsafe extern "C" fn ioapic_mask_entry(apic: c_int, pin: c_int) {
    static void ioapic_mask_entry(int apic, int pin)
    {
    let mut e: IO_APIC_route_entry = { .masked = true };
    guard(raw_spinlock_irqsave)(&ioapic_lock);
    io_apic_write(apic, 0x10 + 2*pin, e.w1);
    io_apic_write(apic, 0x11 + 2*pin, e.w2);
    }
...
//
#[no_mangle]
unsafe extern "C" fn add_pin_to_irq_node(data: *mut mp_chip_data, node: c_int, apic: c_int, pin: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __remove_pin_from_irq(data: *mut mp_chip_data, apic: c_int, pin: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn io_apic_sync(entry: *mut irq_pin_list) {
...
#[no_mangle]
unsafe extern "C" fn mask_ioapic_irq(irq_data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn __unmask_ioapic(data: *mut mp_chip_data) {
    static void __unmask_ioapic(struct mp_chip_data *data)
    {
    io_apic_modify_irq(data, false, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn unmask_ioapic_irq(irq_data: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn __eoi_ioapic_pin(apic: c_int, pin: c_int, vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn eoi_ioapic_pin(vector: c_int, data: *mut mp_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn clear_IO_APIC_pin(apic: c_uint, pin: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_IO_APIC() {
...
//
pub const MAX_PIRQS: c_int = 8;
    static int pirq_entries[MAX_PIRQS] = {
    [0 ... MAX_PIRQS - 1] = -1
    };
#[no_mangle]
unsafe extern "C" fn ioapic_pirq_setup(str: *mut c_char) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn save_ioapic_entries() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mask_ioapic_entries() {
...
//
#[no_mangle]
pub unsafe extern "C" fn restore_ioapic_entries() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn find_irq_entry(ioapic_idx: c_int, pin: c_int, type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn find_isa_irq_pin(irq: c_int, type: c_int) -> int __init {
    static int __init find_isa_irq_pin(int irq, int type)
    {
    int i;
    for (i = 0; i < mp_irq_entries; i++) {
    let mut lbus: c_int = mp_irqs[i].srcbus;
...
#[no_mangle]
unsafe extern "C" fn find_isa_irq_apic(irq: c_int, type: c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn irq_active_low(idx: c_int) -> bool {
    static bool irq_active_low(int idx)
    {
    let mut bus: c_int = mp_irqs[idx].srcbus;
//
...
//
#[no_mangle]
unsafe extern "C" fn EISA_ELCR(irq: c_uint) -> bool {
    static bool EISA_ELCR(unsigned int irq)
    {
    if (irq < nr_legacy_irqs()) {
    let mut port: c_uint = PIC_ELCR1 + (irq >> 3);
...
//
#[no_mangle]
unsafe extern "C" fn eisa_irq_is_level(idx: c_int, bus: c_int, level: bool) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn eisa_irq_is_level(idx: c_int, bus: c_int, level: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irq_is_level(idx: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __acpi_get_override_irq(gsi: u32, trigger: *mut bool, polarity: *mut bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_get_override_irq(gsi: u32, is_level: *mut c_int, active_low: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioapic_alloc_attr_node(info: *mut irq_alloc_info) -> c_int {
    static int ioapic_alloc_attr_node(struct irq_alloc_info *info)
    {
    return (info && info.ioapic.valid) ? info.ioapic.node : NUMA_NO_NODE;
    }
#[no_mangle]
unsafe extern "C" fn mp_register_handler(irq: c_uint, level: bool) {
...
#[no_mangle]
unsafe extern "C" fn mp_check_pin_attr(irq: c_int, info: *mut irq_alloc_info) -> bool {
...
//
    ...
    {
    let mut type: c_int = ioapics[ioapic].irqdomain_cfg.type;
...
//
    ...
    let mut node: c_int = ioapic_alloc_attr_node(info);
...
//
    ...
    irq = __irq_domain_alloc_irqs(domain, irq, 1, node, info, true, core::ptr::null_mut());
    if (irq >= 0) {
...
//
    ...
    ioapic, pin, &tmp);
#[no_mangle]
pub unsafe extern "C" fn if(irq_find_mapping(domain: (irq =, 0: pin)) ==) -> else {
    else if ((irq = irq_find_mapping(domain, pin)) == 0)
    irq = alloc_irq_from_domain(domain, ioapic, gsi, &tmp);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !mp_check_pin_attr(irq, _arg: &tmp)) -> else {
...
#[no_mangle]
unsafe extern "C" fn pin_2_irq(idx: c_int, ioapic: c_int, pin: c_int, flags: c_uint) -> c_int {
    static int pin_2_irq(int idx, int ioapic, int pin, unsigned int flags)
    {
    let mut gsi: u32 = mp_pin_to_gsi(ioapic, pin);
...
// PCI IRQ command line redirection. Yes, limits are hardcoded.
    ...
    let mut irq: c_int = pirq_entries[pin-16];
    ...
    return  mp_map_pin_to_irq(gsi, idx, ioapic, pin, flags, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn mp_map_gsi_to_irq(gsi: u32, flags: c_uint, info: *mut irq_alloc_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mp_unmap_irq(irq: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn IO_APIC_get_PCI_irq_vector(bus: c_int, slot: c_int, pin: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_IO_APIC_irqs() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn ioapic_zap_locks() {
    void ioapic_zap_locks(void)
    {
    raw_spin_lock_init(&ioapic_lock);
    }
#[no_mangle]
unsafe extern "C" fn io_apic_print_entries(apic: c_uint, nr_entries: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn print_IO_APIC(ioapic_idx: c_int) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn print_IO_APICs() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn enable_IO_APIC() -> void __init {
...
// See if any of the pins is in ExtINT mode
    let mut entry: IO_APIC_route_entry = ioapic_read_entry(apic, pin);
//
...
#[no_mangle]
pub unsafe extern "C" fn native_restore_boot_irq_mode() {
...
//
    ...
    struct IO_APIC_route_entry entry;
    let mut apic_id: u32 = read_apic_id();
...
#[no_mangle]
pub unsafe extern "C" fn restore_boot_irq_mode() {
...
#[no_mangle]
pub unsafe extern "C" fn setup_ioapic_ids_from_mpc() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn notimercheck(s: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn delay_with_tsc() -> void __init {
    static void __init delay_with_tsc(void)
    {
    unsigned long long start, now;
    let mut end: c_ulong = jiffies + 4;
    start = rdtsc();
//
...
#[no_mangle]
unsafe extern "C" fn delay_without_tsc() -> void __init {
    static void __init delay_without_tsc(void)
    {
    let mut end: c_ulong = jiffies + 4;
    let mut band: c_int = 1;
//
...
//
#[no_mangle]
unsafe extern "C" fn timer_irq_works() -> int __init {
    static int __init timer_irq_works(void)
    {
    let mut t1: c_ulong = jiffies;
    if (no_timer_check)
    return 1;
    local_irq_enable();
...
//
#[no_mangle]
unsafe extern "C" fn startup_ioapic_irq(data: *mut irq_data) -> c_uint {
    static unsigned int startup_ioapic_irq(struct irq_data *data)
    {
    let mut was_pending: c_int = 0, irq = data.irq;
    guard(raw_spinlock_irqsave)(&ioapic_lock);
    if (irq < nr_legacy_irqs()) {
    legacy_pic.mask(irq);
...
#[no_mangle]
unsafe extern "C" fn io_apic_level_ack_pending(data: *mut mp_chip_data) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ioapic_prepare_move(data: *mut irq_data) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ioapic_finish_move(data: *mut irq_data, moveit: bool) {
...
#[no_mangle]
unsafe extern "C" fn ioapic_ack_level(irq_data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ioapic_ir_ack_level(irq_data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ioapic_configure_entry(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ioapic_set_affinity(irq_data: *mut irq_data, mask: *const cpumask, force: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn init_IO_APIC_traps() {
...
//
#[no_mangle]
unsafe extern "C" fn mask_lapic_irq(data: *mut irq_data) {
    static void mask_lapic_irq(struct irq_data *data)
    {
    let mut v: c_ulong = apic_read(APIC_LVT0);
    apic_write(APIC_LVT0, v | APIC_LVT_MASKED);
    }
#[no_mangle]
unsafe extern "C" fn unmask_lapic_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ack_lapic_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn lapic_register_intr(irq: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn unlock_ExtINT_logic() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn disable_timer_pin_setup(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mp_alloc_timer_irq(ioapic: c_int, pin: c_int) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn check_timer() -> void __init {
    static inline void __init check_timer(void)
    {
    struct irq_data *irq_data = irq_get_irq_data(0);
    struct mp_chip_data *data = irq_data.chip_data;
    struct irq_cfg *cfg = irqd_cfg(irq_data);
    let mut node: c_int = cpu_to_node(0);
    int apic1, pin1, apic2, pin2;
    let mut no_pin1: c_int = 0;
...
//
    let mut idx: c_int = find_irq_entry(apic1, pin1, mp_INT);
...
#[no_mangle]
unsafe extern "C" fn mp_irqdomain_create(ioapic: c_int) -> c_int {
    static int mp_irqdomain_create(int ioapic)
    {
    struct mp_ioapic_gsi *gsi_cfg = mp_ioapic_gsi_routing(ioapic);
    let mut hwirqs: c_int = mp_ioapic_pin_count(ioapic);
...
#[no_mangle]
unsafe extern "C" fn ioapic_destroy_irqdomain(idx: c_int) {
    ...
    if (!cfg.dev)
    irq_domain_free_fwnode(fn);
    ioapics[idx].irqdomain = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn setup_IO_APIC() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn resume_ioapic_id(ioapic_idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ioapic_suspend(data: *mut c_void) -> c_int {
    static int ioapic_suspend(void *data)
    {
    return save_ioapic_entries();
    }
#[no_mangle]
unsafe extern "C" fn ioapic_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ioapic_init_ops() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn io_apic_get_redir_entries(ioapic: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn io_apic_get_unique_id(ioapic: c_int, apic_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn io_apic_unique_id(idx: c_int, id: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn io_apic_get_version(ioapic: c_int) -> c_int {
...
//
pub const IOAPIC_RESOURCE_NAME_SIZE: c_int = 11;
    static struct resource *ioapic_resources;
#[no_mangle]
unsafe extern "C" fn ioapic_setup_resources() -> *mut resource  __init {
...
#[no_mangle]
unsafe extern "C" fn io_apic_set_fixmap(idx: enum fixed_addresses, phys: phys_addr_t) {
    static void io_apic_set_fixmap(enum fixed_addresses idx, phys_addr_t phys)
    {
    let mut flags: pgprot_t = FIXMAP_PAGE_NOCACHE;
//
...
#[no_mangle]
pub unsafe extern "C" fn io_apic_init_mappings() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn ioapic_insert_resources() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn mp_find_ioapic(gsi: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mp_find_ioapic_pin(ioapic: c_int, gsi: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bad_ioapic_register(idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_free_ioapic_entry() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mp_register_ioapic(id: c_int, address: u32, gsi_base: u32, cfg: *mut ioapic_domain_cfg) -> c_int {
    int mp_register_ioapic(int id, u32 address, u32 gsi_base, struct ioapic_domain_cfg *cfg)
    {
    let mut hotplug: bool = !!ioapic_initialized;
    struct mp_ioapic_gsi *gsi_cfg;
...
#[no_mangle]
pub unsafe extern "C" fn mp_unregister_ioapic(gsi_base: u32) -> c_int {
    ...
    let mut gsi: u32 = mp_pin_to_gsi(ioapic, pin);
    let mut irq: c_int = mp_map_gsi_to_irq(gsi, 0, core::ptr::null_mut());
    struct mp_chip_data *data;
    if (irq >= 0) {
    data = irq_get_chip_data(irq);
    if (data && data.count) {
...
#[no_mangle]
pub unsafe extern "C" fn mp_ioapic_registered(gsi_base: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mp_preconfigure_entry(data: *mut mp_chip_data) {
...
#[no_mangle]
pub unsafe extern "C" fn mp_irqdomain_activate(domain: *mut irq_domain, irq_data: *mut irq_data, reserve: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mp_irqdomain_ioapic_idx(domain: *mut irq_domain) -> c_int {
