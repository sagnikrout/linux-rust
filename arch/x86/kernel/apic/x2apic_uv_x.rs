...
//! Source: arch/x86/kernel/apic/x2apic_uv_x.c
#![no_std]
...
// Set this to use hardware error handler instead of kernel panic:
    let mut disable_uv_undefined_panic: static int = 1;
#[no_mangle]
pub unsafe extern "C" fn uv_undefined(str: *mut c_char) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn uv_early_read_mmr(addr: c_ulong) -> unsigned long __init {
...
#[no_mangle]
pub unsafe extern "C" fn is_GRU_range(start: u64, end: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn uv_is_untracked_pat_range(start: u64, end: u64) -> bool {
    static bool uv_is_untracked_pat_range(u64 start, u64 end)
    {
    return is_ISA_range(start, end) || is_GRU_range(start, end);
    }
#[no_mangle]
unsafe extern "C" fn early_get_pnodeid() -> void __init {
    ...
    let mut GAM_ADDR_MAP_CONFIG: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn early_set_hub_type() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn uv_tsc_check_sync() -> void __init {
...
// Selector for (4|4A|5) structs
    ...
    undef)
#[no_mangle]
unsafe extern "C" fn early_get_apic_socketid_shift() -> void __init {
    static void __init early_get_apic_socketid_shift(void)
    {
    let mut sid_shift: c_uint = topology_get_domain_shift(TOPO_PKG_DOMAIN);
...
#[no_mangle]
unsafe extern "C" fn uv_stringify(len: c_int, to: *mut c_char, from: *mut c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn early_find_archtype(st: *mut uv_systab) -> unsigned long __init {
    static unsigned long __init early_find_archtype(struct uv_systab *st)
    {
    int i;
    for (i = 0; st.entry[i].type != UV_SYSTAB_TYPE_UNUSED; i++) {
    let mut ptr: c_ulong = st.entry[i].offset;
    if (!ptr)
    continue;
...
#[no_mangle]
unsafe extern "C" fn early_get_arch_type() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn early_set_apic_mode() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn uv_set_system_type(_oem_id: *mut c_char, _oem_table_id: *mut c_char) -> int __init {
...
// UV4 Hubless: CH
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(uv_archtype, _arg: "NSGI4", 0: 5) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn uv_acpi_madt_oem_check(_oem_id: *mut c_char, _oem_table_id: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn get_uv_system_type() -> enum uv_system_type {
    enum uv_system_type get_uv_system_type(void)
    {
    return uv_system_type;
    }
#[no_mangle]
pub unsafe extern "C" fn uv_get_hubless_system() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uv_get_archtype(buf: *mut c_char, len: c_int) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn is_uv_system() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_uv_hubbed(uvtype: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_uv_hubless(uvtype: c_int) -> c_int {
...
// Default UV memory block size is 2GB
    let mut __initdata: static unsigned long mem_block_size = (2UL << 30);
// Kernel parameter to specify UV mem block size
#[no_mangle]
unsafe extern "C" fn parse_mem_block_size(ptr: *mut c_char) -> int __init {
    static int __init parse_mem_block_size(char *ptr)
    {
    let mut size: c_ulong = memparse(ptr, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn adj_blksize(lgre: u32) -> __init int {
    static __init int adj_blksize(u32 lgre)
    {
    let mut base: c_ulong = (unsigned long)lgre << UV_GAM_RANGE_SHFT;
    unsigned long size;
...
#[no_mangle]
unsafe extern "C" fn set_block_size() -> __init void {
    static __init void set_block_size(void)
    {
    let mut order: c_uint = ffs(mem_block_size);
    if (order) {
...
#[no_mangle]
unsafe extern "C" fn build_uv_gr_table() -> __init void {
    static __init void build_uv_gr_table(void)
    {
    struct uv_gam_range_entry *gre = uv_gre_table;
    struct uv_gam_range_s *grt;
    let mut last_limit: c_ulong = 0, ram_limit = 0;
...
#[no_mangle]
unsafe extern "C" fn uv_wakeup_secondary(phys_apicid: u32, start_rip: c_ulong, cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uv_send_IPI_one(cpu: c_int, vector: c_int) {
    static void uv_send_IPI_one(int cpu, int vector)
    {
    let mut apicid: c_ulong = per_cpu(x86_cpu_to_apicid, cpu);
    let mut pnode: c_int = uv_apicid_to_pnode(apicid);
...
#[no_mangle]
unsafe extern "C" fn uv_send_IPI_mask(mask: *const cpumask, vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uv_send_IPI_mask_allbutself(mask: *const cpumask, vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uv_send_IPI_allbutself(vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uv_send_IPI_all(vector: c_int) {
    static void uv_send_IPI_all(int vector)
    {
    uv_send_IPI_mask(cpu_online_mask, vector);
    }
#[no_mangle]
unsafe extern "C" fn uv_probe() -> c_int {
    static int uv_probe(void)
    {
    let mut apic: return = = &apic_x2apic_uv_x;
    }
...
pub const UVH_RH_GAM_ALIAS210_REDIRECT_CONFIG_LENGTH: c_int = 3;

#[no_mangle]
unsafe extern "C" fn get_lowmem_redirect(base: *mut c_ulong, size: *mut c_ulong) -> __init void {
...
#[no_mangle]
unsafe extern "C" fn map_high(id: *mut c_char, base: c_ulong, pshift: c_int, bshift: c_int, max_pnode: c_int, map_type: enum map_type) -> __init void {
    ...
    if (!paddr) {
    pr_info("UV: Map %s_HI base address core::ptr::null_mut()\n", id);
    return;
    }
    if (map_type == map_uc)
...
#[no_mangle]
unsafe extern "C" fn map_gru_high(max_pnode: c_int) -> __init void {
...
#[no_mangle]
unsafe extern "C" fn map_mmr_high(max_pnode: c_int) -> __init void {
...
// enum values chosen so (index mod 2) is MMIOH 0/1 (low/high)
    ...
    for (i = 0; i < n; i++) {
    let mut m_redirect: c_ulong = mmr + i * 8;
    let mut redirect: c_ulong = uv_read_local_mmr(m_redirect);
...
#[no_mangle]
unsafe extern "C" fn map_mmioh_high(min_pnode: c_int, max_pnode: c_int) -> __init void {
...
// UVX flavor
    ...
    let mut base: c_ulong = uvxy_field(mmioh0, base, 0);
    let mut m_io: c_int = uvxy_field(mmioh0, m_io, 0);
    let mut n_io: c_int = uvxy_field(mmioh0, n_io, 0);
    ...
    let mut base: c_ulong = uvxy_field(mmioh1, base, 0);
    let mut m_io: c_int = uvxy_field(mmioh1, m_io, 0);
    let mut n_io: c_int = uvxy_field(mmioh1, n_io, 0);
...
#[no_mangle]
unsafe extern "C" fn map_low_mmrs() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn uv_rtc_init() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn uv_set_vga_state(pdev: *mut pci_dev, decode: bool, command_bits: c_uint, flags: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_cpu_init() {
...
#[no_mangle]
unsafe extern "C" fn get_mn(mnp: *mut mn) {
...
#[no_mangle]
unsafe extern "C" fn uv_init_hub_info(hi: *mut uv_hub_info_s) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn decode_gam_params(ptr: c_ulong) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn decode_gam_rng_tbl(ptr: c_ulong) -> void __init {
    static void __init decode_gam_rng_tbl(unsigned long ptr)
    {
    struct uv_gam_range_entry *gre = (struct uv_gam_range_entry *)ptr;
    let mut lgre: c_ulong = 0, gend = 0;
    let mut index: c_int = 0;
    let mut sock_min: c_int = INT_MAX, pnode_min = INT_MAX;
    let mut sock_max: c_int = -1, pnode_max = -1;
    uv_gre_table = gre;
    for (; gre.type != UV_GAM_RANGE_TYPE_UNUSED; gre++) {
...
#[no_mangle]
unsafe extern "C" fn decode_uv_systab() -> int __init {
...
// If UVsystab is version 1, there is no extended UVsystab
    ...
    let mut rev: c_int = st ? st.revision : 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn blade_update_min_max(bits: c_ulong, base: c_int, mask: c_int, min: *mut c_int, max: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn boot_init_possible_blades(hub_info: *mut uv_hub_info_s) -> __init void {
    static __init void boot_init_possible_blades(struct uv_hub_info_s *hub_info)
    {
    unsigned long np;
    int i, uv_pb = 0;
    let mut sock_min: c_int = INT_MAX, sock_max = -1, s_mask;
...
#[no_mangle]
unsafe extern "C" fn alloc_conv_table(num_elem: c_int, table: *mut c_ushort) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn free_1_to_1_table(tp: *mut c_ushort, tname: *mut c_char, min: c_int, max: c_int, max2: c_int) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn build_socket_tables() -> void __init {
    static void __init build_socket_tables(void)
    {
    struct uv_gam_range_entry *gre = uv_gre_table;
    int nums, numn, nump;
    int i, lnid, apicid;
    let mut minsock: c_int = _min_socket;
    let mut maxsock: c_int = _max_socket;
    let mut minpnode: c_int = _min_pnode;
    let mut maxpnode: c_int = _max_pnode;
    if (!gre) {
    if (is_uv2_hub() || is_uv3_hub()) {
...
// Set socket -> node values:
    ...
    let mut nid: c_int = __apicid_to_node[apicid];
    int sockid;
...
#[no_mangle]
unsafe extern "C" fn check_efi_reboot() {
...
//
#[no_mangle]
unsafe extern "C" fn proc_hubbed_show(file: *mut seq_file, data: *mut c_void) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn proc_hubless_show(file: *mut seq_file, data: *mut c_void) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn proc_archtype_show(file: *mut seq_file, data: *mut c_void) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn uv_setup_proc_files(hubless: c_int) -> __init void {
    static __init void uv_setup_proc_files(int hubless)
    {
    struct proc_dir_entry *pde;
    pde = proc_mkdir(UV_PROC_NODE, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn uv_system_init_hubless() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn uv_system_init_hub() -> void __init {
    static void __init uv_system_init_hub(void)
    {
    let mut hub_info: uv_hub_info_s = {0};
    int bytes, cpu, nodeid, bid;
    let mut min_pnode: c_ushort = USHRT_MAX, max_pnode = 0;
    char *hub = is_uv5_hub() ? "UV500" :
    is_uv4_hub() ? "UV400" :
    is_uv3_hub() ? "UV300" :
    is_uv2_hub() ? "UV2000/3000" : core::ptr::null_mut();
...
// Initialize per CPU info:
    ...
    let mut apicid: c_int = per_cpu(x86_cpu_to_apicid, cpu);
    unsigned short bid;
    ...
    for_each_possible_blade(bid) {
    let mut pnode: c_ushort = uv_hub_info_list_blade[bid].pnode;
    if (pnode == 0xffff)
    continue;
    ...
    kfree(uv_hub_info_list_blade);
    uv_hub_info_list_blade = core::ptr::null_mut();
    uv_nmi_setup();
    uv_cpu_init();
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_system_init() -> void __init {
