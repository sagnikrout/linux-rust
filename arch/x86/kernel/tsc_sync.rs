...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsc_adjust {
    pub bootval: i64,
    pub adjusted: i64,
    pub nextcheck: c_ulong,
    pub warned: bool,
}
...
#[no_mangle]
pub unsafe extern "C" fn mark_tsc_async_resets(reason: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn tsc_verify_tsc_adjust(resume: bool) {
...
#[no_mangle]
unsafe extern "C" fn tsc_sync_check_timer_fn(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn start_sync_check_timer() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn tsc_store_and_check_tsc_adjust(bootcpu: bool) -> bool __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn tsc_store_and_check_tsc_adjust(bootcpu: bool) -> bool {
...
//
    let mut sync_lock: static arch_spinlock_t = __ARCH_SPIN_LOCK_UNLOCKED;
...
//
#[no_mangle]
unsafe extern "C" fn check_tsc_warp(timeout: c_uint) -> cycles_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn loop_timeout(cpu: c_int) -> c_uint {
    static inline unsigned int loop_timeout(int cpu)
    {
    return (cpumask_weight(topology_core_cpumask(cpu)) > 1) ? 2 : 20;
    }
#[no_mangle]
unsafe extern "C" fn tsc_sync_mark_tsc_unstable(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn check_tsc_sync_source(__cpu: *mut c_void) {
    static void check_tsc_sync_source(void *__cpu)
    {
    let mut cpu: c_uint = (unsigned long)__cpu;
    let mut cpus: c_int = 2;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn check_tsc_sync_target() {
