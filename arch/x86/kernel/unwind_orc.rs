...
//! Source: arch/x86/kernel/unwind_orc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn unwind_debug_cmdline(str: *mut c_char) -> int __init {
...
pub unsafe extern "C" fn unwind_next_frame(state: *mut unwind_state) -> bool {
    ...
    let mut prev_type: enum stack_type = state.stack_info.type;
    struct orc_entry *orc;
...
// Find IP, SP and possibly regs:
    ...
    state.prev_regs = core::ptr::null_mut();
    break;
    case ORC_TYPE_REGS:
