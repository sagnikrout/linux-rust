...
//
    ...
    let mut allow_writes: static enum allow_write_msrs = MSR_WRITES_DEFAULT;
    static ssize_t msr_read(struct file *file, char __user *buf,
    size_t count, loff_t *ppos)
    {
    u32 __user *tmp = (u32 __user *) buf;
    u64 data;
    let mut reg: u32 = *ppos;
    let mut cpu: c_int = iminor(file_inode(file));
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn filter_write(reg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msr_ioctl(file: *mut file, ioc: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn msr_open(inode: *mut inode, file: *mut file) -> c_int {
    static int msr_open(struct inode *inode, struct file *file)
    {
    let mut cpu: c_uint = iminor(file_inode(file));
...
#[no_mangle]
unsafe extern "C" fn msr_device_create(cpu: c_uint) -> c_int {
    static int msr_device_create(unsigned int cpu)
    {
    struct device *dev;
    dev = device_create(&msr_class, core::ptr::null_mut(), MKDEV(MSR_MAJOR, cpu), core::ptr::null_mut(),
    "msr%d", cpu);
    return PTR_ERR_OR_ZERO(dev);
    }
#[no_mangle]
unsafe extern "C" fn msr_device_destroy(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msr_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn set_allow_writes(val: *const c_char, cp: *const kernel_param) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(s, _arg: "off")) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_allow_writes(buf: *mut c_char, kp: *const kernel_param) -> c_int {
    ...
    module_param_cb(allow_writes, &allow_writes_ops, core::ptr::null_mut(), 0600);
