...
//! Source: arch/x86/kernel/acpi/cstate.c
#![no_std]
...
//
    ...
    flags.bm_check = 1;
#[no_mangle]
pub unsafe extern "C" fn if(X86_VENDOR_INTEL: c->x86_vendor ==) -> else {
//
...
pub struct cstate_entry {
    ...
    pub eax: c_uint,
    pub ecx: c_uint,
    pub states: [}; ACPI_PROCESSOR_MAX_POWER],
}
...
#[no_mangle]
unsafe extern "C" fn acpi_processor_ffh_cstate_probe_cpu(_cx: *mut c_void) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_processor_ffh_play_dead(cx: *mut acpi_processor_cx) -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_processor_ffh_cstate_enter(cx: *mut acpi_processor_cx) -> void __cpuidle {
...
#[no_mangle]
unsafe extern "C" fn ffh_cstate_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ffh_cstate_exit() -> void __exit {
