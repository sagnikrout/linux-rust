...
//! Source: arch/x86/kernel/acpi/madt_wakeup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn acpi_mp_cpu_die(cpu: c_uint) {
    static void acpi_mp_cpu_die(unsigned int cpu)
    {
    let mut apicid: u32 = per_cpu(x86_cpu_to_apicid, cpu);
...
#[no_mangle]
unsafe extern "C" fn free_pgt_page(pgt: *mut c_void, dummy: *mut c_void) -> void __init {
    static void __init free_pgt_page(void *pgt, void *dummy)
    {
    return memblock_free(pgt, PAGE_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn acpi_mp_setup_reset(reset_vector: u64) -> int __init {
    ...
    pgd_t *pgd;
    pgd = alloc_pgt_page(core::ptr::null_mut());
    if (!pgd)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn acpi_wakeup_cpu(apicid: u32, start_ip: c_ulong, cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_mp_disable_offlining(mp_wake: *mut acpi_madt_multiproc_wakeup) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_setup_mp_wakeup_mailbox(mailbox_paddr: u64) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_get_mp_wakeup_mailbox_paddr() -> u64 {
