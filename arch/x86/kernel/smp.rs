...
//
    let mut stopping_cpu: static atomic_t = ATOMIC_INIT(-1);
    let mut smp_no_nmi_ipi: static bool = false;
#[no_mangle]
unsafe extern "C" fn smp_stop_nmi_callback(val: c_uint, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_stop_handler() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn native_stop_other_cpus(wait: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nonmi_ipi_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn arch_cpu_rescan_dead_smt_siblings() -> c_int {
    int arch_cpu_rescan_dead_smt_siblings(void)
    {
    let mut old: enum cpuhp_smt_control = cpu_smt_control;
    int ret;
//
