...
//! Source: arch/x86/kernel/signal_64.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn force_valid_ss(regs: *mut pt_regs) {
...
// non-iBCS2 extensions..
    ...
    label)
#[no_mangle]
unsafe extern "C" fn frame_uc_flags(regs: *mut pt_regs) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn x64_setup_rt_frame(ksig: *mut ksignal, regs: *mut pt_regs) -> c_int {
    int x64_setup_rt_frame(struct ksignal *ksig, struct pt_regs *regs)
    {
    sigset_t *set = sigmask_to_save();
    struct rt_sigframe __user *frame;
    void __user *fp = core::ptr::null_mut();
    unsigned long uc_flags;
...
#[no_mangle]
pub unsafe extern "C" fn x32_setup_rt_frame(ksig: *mut ksignal, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sigaction_compat_abi(act: *mut k_sigaction, oact: *mut k_sigaction) {
