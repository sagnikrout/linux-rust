...
#[no_mangle]
pub unsafe extern "C" fn is_ia32_compat_frame(ksig: *mut ksignal) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_ia32_frame(ksig: *mut ksignal) -> c_int {
    static inline int is_ia32_frame(struct ksignal *ksig)
    {
    return IS_ENABLED(CONFIG_X86_32) || is_ia32_compat_frame(ksig);
    }
#[no_mangle]
pub unsafe extern "C" fn is_x32_frame(ksig: *mut ksignal) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sig_prepare_pkru() -> u32 {
    static inline u32 sig_prepare_pkru(void)
    {
    let mut orig_pkru: u32 = read_pkru();
    write_pkru(0);
    return orig_pkru;
    }
//
...
//
    ...
    let mut ia32_frame: c_int = is_ia32_frame(ksig);
// Default to using normal stack
    let mut nested_altstack: bool = on_sig_stack(regs.sp);
    let mut entering_altstack: bool = false;
    let mut math_size: c_ulong = 0;
    let mut sp: c_ulong = regs.sp;
    let mut buf_fx: c_ulong = 0;
    u32 pkru;
// redzone
    if (!ia32_frame)
    sp -= 128;
...
#[no_mangle]
unsafe extern "C" fn init_sigframe_size() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn get_sigframe_size() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn get_nr_restart_syscall(regs: *const pt_regs) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn signal_fault(regs: *mut pt_regs, frame: *mut void __user, where: *mut c_char) {
    ...
    let mut __ro_after_init: static bool strict_sigaltstack_size = true;

    let mut __ro_after_init: static bool strict_sigaltstack_size = false;

#[no_mangle]
unsafe extern "C" fn strict_sas_size(arg: *mut c_char) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn sigaltstack_size_valid(ss_size: usize) -> bool {
    bool sigaltstack_size_valid(size_t ss_size)
    {
    let mut fsize: c_ulong = max_frame_size - fpu_default_state_size;
    u64 mask;
