...
//! Source: arch/x86/kernel/ioport.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn io_bitmap_share(tsk: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn task_update_io_bitmap() {
...
#[no_mangle]
pub unsafe extern "C" fn io_bitmap_exit(tsk: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ksys_ioperm(from: c_ulong, num: c_ulong, turn_on: c_int) -> c_long {
