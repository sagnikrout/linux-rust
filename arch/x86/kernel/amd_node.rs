...
//! Source: arch/x86/kernel/amd_node.c
#![no_std]
...
pub const SMN_INDEX_OFFSET: c_uint = 0x60;
pub const SMN_DATA_OFFSET: c_uint = 0x64;
pub const HSMP_INDEX_OFFSET: c_uint = 0xc4;
pub const HSMP_DATA_OFFSET: c_uint = 0xc8;
//
...
//
#[no_mangle]
unsafe extern "C" fn __amd_smn_rw(i_off: u8, d_off: u8, node: u16, address: u32, value: *mut u32, write: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_smn_read(node: u16, address: u32, value: *mut u32) -> int __must_check {
    int __must_check amd_smn_read(u16 node, u32 address, u32 *value)
    {
    let mut err: c_int = __amd_smn_rw(SMN_INDEX_OFFSET, SMN_DATA_OFFSET, node, address, value, false);
...
#[no_mangle]
pub unsafe extern "C" fn amd_smn_write(node: u16, address: u32, value: u32) -> int __must_check {
...
#[no_mangle]
pub unsafe extern "C" fn amd_smn_hsmp_rdwr(node: u16, address: u32, value: *mut u32, write: bool) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn smn_node_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smn_address_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smn_value_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_smn_enable_dfs(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn amd_smn_init() -> int __init {
...
//
    if (!pci_request_config_region_exclusive(root, 0, PCI_CFG_SPACE_SIZE, core::ptr::null_mut())) {
...
// Use one root for each node and skip the rest.
    ...
    debugfs_create_file("node",	0600, debugfs_dir, core::ptr::null_mut(), &smn_node_fops);
    debugfs_create_file("address",	0600, debugfs_dir, core::ptr::null_mut(), &smn_address_fops);
    debugfs_create_file("value",	0600, debugfs_dir, core::ptr::null_mut(), &smn_value_fops);
    }
    smn_exclusive = true;
    return 0;
    }
