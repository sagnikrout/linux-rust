...
//! Source: arch/x86/kernel/process_64.c
#![no_std]
...
// Prints also some state that isn't saved in the pt_regs
    ...
    const char *log_lvl)
    {
    let mut cr0: c_ulong = 0L, cr2 = 0L, cr3 = 0L, cr4 = 0L, fs, gs, shadowgs;
...
#[no_mangle]
pub unsafe extern "C" fn release_thread(dead_task: *mut task_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn __rdgsbase_inactive() -> noinstr unsigned long {
...
//
#[no_mangle]
unsafe extern "C" fn __wrgsbase_inactive(gsbase: c_ulong) -> noinstr void {
...
#[no_mangle]
unsafe extern "C" fn save_fsgs(task: *mut task_struct) -> __always_inline void {
...
//
#[no_mangle]
pub unsafe extern "C" fn current_save_fsgs() {
...
// Update the bases.
    ...
    unsigned short selector)
    {
    let mut idx: c_ushort = selector >> 3;
    unsigned long base;
...
#[no_mangle]
pub unsafe extern "C" fn x86_gsbase_read_cpu_inactive() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn x86_gsbase_write_cpu_inactive(gsbase: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn x86_fsbase_read_task(task: *mut task_struct) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn x86_gsbase_read_task(task: *mut task_struct) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn x86_fsbase_write_task(task: *mut task_struct, fsbase: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn x86_gsbase_write_task(task: *mut task_struct, gsbase: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn compat_start_thread(regs: *mut pt_regs, new_ip: u32, new_sp: u32, x32: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn set_personality_64bit() {
...
#[no_mangle]
unsafe extern "C" fn __set_personality_x32() {
...
#[no_mangle]
unsafe extern "C" fn __set_personality_ia32() {
...
#[no_mangle]
pub unsafe extern "C" fn set_personality_ia32(x32: bool) {
...
#[no_mangle]
unsafe extern "C" fn prctl_map_vdso(image: *const vdso_image, addr: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn enable_lam_func(__mm: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mm_enable_lam(mm: *mut mm_struct) {
...
#[no_mangle]
unsafe extern "C" fn prctl_enable_tagged_addr(mm: *mut mm_struct, nr_bits: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn do_arch_prctl_64(task: *mut task_struct, option: c_int, arg2: c_ulong) -> c_long {
...
//
    ...
    case ARCH_GET_FS: {
    let mut base: c_ulong = x86_fsbase_read_task(task);
    ret = put_user(base, (unsigned long __user *)arg2);
    break;
    }
    case ARCH_GET_GS: {
    let mut base: c_ulong = x86_gsbase_read_task(task);
    ret = put_user(base, (unsigned long __user *)arg2);
    break;
    }
