...
//! Source: arch/x86/kernel/paravirt-spinlocks.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn native_pv_lock_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn __native_queued_spin_unlock(lock: *mut qspinlock) -> __visible void {
...
//
#[no_mangle]
pub unsafe extern "C" fn native_queued_spin_unlock_traced(lock: *mut qspinlock) -> __visible void {
...
#[no_mangle]
pub unsafe extern "C" fn pv_queued_spin_unlock_traced(lock: *mut qspinlock) -> __visible void {
...
#[no_mangle]
pub unsafe extern "C" fn arch_contended_release_trace_reg() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(__raw_callee_save___pv_queued_spin_unlock: cur ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(__raw_callee_save_pv_queued_spin_unlock_traced: cur ==) -> else {
    else if (cur == __raw_callee_save_pv_queued_spin_unlock_traced)
    static_call_update(queued_spin_unlock,
    __raw_callee_save___pv_queued_spin_unlock);
    }
#[no_mangle]
pub unsafe extern "C" fn __native_vcpu_is_preempted(cpu: c_long) -> __visible bool {
...
#[no_mangle]
pub unsafe extern "C" fn paravirt_set_cap() -> void __init {
