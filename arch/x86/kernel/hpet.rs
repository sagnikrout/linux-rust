...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpet_channel {
    pub evt: clock_event_device,
    pub num: c_uint,
    pub cpu: c_uint,
    pub irq: c_uint,
    pub in_use: c_uint,
    pub mode: enum hpet_mode,
    pub boot_cfg: c_uint,
    pub name: [c_char; 10],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpet_base {
    pub nr_channels: c_uint,
    pub nr_clockevents: c_uint,
    pub boot_cfg: c_uint,
    pub channels: *mut hpet_channel,
}

pub const HPET_MIN_CYCLES: c_int = 128;
...
#[no_mangle]
pub unsafe extern "C" fn hpet_readl(a: c_uint) -> c_uint {
    inline unsigned int hpet_readl(unsigned int a)
    {
    return readl(hpet_virt_address + a);
    }
#[no_mangle]
pub unsafe extern "C" fn hpet_writel(d: c_uint, a: c_uint) {
    static inline void hpet_writel(unsigned int d, unsigned int a)
    {
    writel(d, hpet_virt_address + a);
    }
#[no_mangle]
pub unsafe extern "C" fn hpet_set_mapping() {
    static inline void hpet_set_mapping(void)
    {
    hpet_virt_address = ioremap(hpet_address, HPET_MMAP_SIZE);
    }
#[no_mangle]
pub unsafe extern "C" fn hpet_clear_mapping() {
    static inline void hpet_clear_mapping(void)
    {
    iounmap(hpet_virt_address);
    hpet_virt_address = core::ptr::null_mut();
    }
//
// HPET command line enable / disable
//
#[no_mangle]
unsafe extern "C" fn hpet_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn disable_hpet(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn is_hpet_capable() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_hpet_enabled() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _hpet_print_config(function: *const c_char, line: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hpet_reserve_platform_timers() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hpet_select_device_channel() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hpet_stop_counter() {
    static void hpet_stop_counter(void)
    {
    let mut cfg: u32 = hpet_readl(HPET_CFG);
    cfg &= ~HPET_CFG_ENABLE;
    hpet_writel(cfg, HPET_CFG);
    }
#[no_mangle]
unsafe extern "C" fn hpet_reset_counter() {
...
#[no_mangle]
unsafe extern "C" fn hpet_start_counter() {
    static void hpet_start_counter(void)
    {
    let mut cfg: c_uint = hpet_readl(HPET_CFG);
    cfg |= HPET_CFG_ENABLE;
    hpet_writel(cfg, HPET_CFG);
    }
#[no_mangle]
unsafe extern "C" fn hpet_restart_counter() {
...
#[no_mangle]
unsafe extern "C" fn hpet_resume_device() {
    static void hpet_resume_device(void)
    {
    force_hpet_resume();
    }
#[no_mangle]
unsafe extern "C" fn hpet_resume_counter(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn hpet_enable_legacy_int() {
...
#[no_mangle]
unsafe extern "C" fn hpet_clkevt_set_state_periodic(evt: *mut clock_event_device) -> c_int {
    static int hpet_clkevt_set_state_periodic(struct clock_event_device *evt)
    {
    let mut channel: c_uint = clockevent_to_channel(evt).num;
...
#[no_mangle]
unsafe extern "C" fn hpet_clkevt_set_state_oneshot(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpet_clkevt_set_state_shutdown(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpet_clkevt_legacy_resume(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpet_init_clockevent(hc: *mut hpet_channel, rating: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn hpet_legacy_clockevent_register(hc: *mut hpet_channel) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hpet_msi_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn hpet_msi_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn hpet_msi_write(hc: *mut hpet_channel, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn hpet_msi_write_msg(data: *mut irq_data, msg: *mut msi_msg) {
    ...
    {
    irq_domain_set_info(domain, virq, arg.hwirq, info.chip, core::ptr::null_mut(),
    ...
    if (x86_vector_domain == core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn hpet_dev_id(domain: *mut irq_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpet_clkevt_msi_resume(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpet_msi_interrupt_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hpet_setup_msi_irq(hc: *mut hpet_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_one_hpet_msi_clockevent(hc: *mut hpet_channel, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hpet_cpuhp_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpet_cpuhp_dead(cpu: c_uint) -> c_int {
    ...
    free_irq(hc.irq, hc);
    hc.in_use = 0;
    per_cpu(cpu_hpet_channel, cpu) = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn hpet_select_clockevents() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn read_hpet(cs: *mut clocksource) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn hpet_cfg_working() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn hpet_counting() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn mwait_pc10_supported() -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn hpet_is_pc10_damaged() -> bool __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn hpet_enable() -> int __init {
...
//
    ...
    hpet_base.channels = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn hpet_late_init() -> __init int {
    ...
    hpet_cpuhp_online, core::ptr::null_mut());
    if (ret)
    return ret;
    ret = cpuhp_setup_state(CPUHP_X86_HPET_DEAD, "x86/hpet:dead", core::ptr::null_mut(),
    hpet_cpuhp_dead);
    if (ret)
    goto err_cpuhp;
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn hpet_disable() {
...
pub const DEFAULT_RTC_INT_FREQ: c_int = 64;
pub const DEFAULT_RTC_SHIFT: c_int = 6;
pub const RTC_NUM_INTS: c_int = 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn hpet_cnt_ahead(c1: u32, c2: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hpet_register_irq_handler(handler: rtc_irq_handler) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hpet_unregister_irq_handler(handler: rtc_irq_handler) {
    void hpet_unregister_irq_handler(rtc_irq_handler handler)
    {
    if (!is_hpet_enabled())
    return;
    irq_handler = core::ptr::null_mut();
    hpet_rtc_flags = 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn hpet_rtc_timer_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpet_disable_rtc_channel() {
    static void hpet_disable_rtc_channel(void)
    {
    let mut cfg: u32 = hpet_readl(HPET_T1_CFG);
    cfg &= ~HPET_TN_ENABLE;
    hpet_writel(cfg, HPET_T1_CFG);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn hpet_mask_rtc_irq_bit(bit_mask: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hpet_set_rtc_irq_bit(bit_mask: c_ulong) -> c_int {
    int hpet_set_rtc_irq_bit(unsigned long bit_mask)
    {
    let mut oldbits: c_ulong = hpet_rtc_flags;
    if (!is_hpet_enabled())
    return 0;
    hpet_rtc_flags |= bit_mask;
...
#[no_mangle]
pub unsafe extern "C" fn hpet_set_alarm_time(hrs: c_uchar, min: c_uchar, sec: c_uchar) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hpet_set_periodic_freq(freq: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpet_rtc_timer_reinit() {
    static void hpet_rtc_timer_reinit(void)
    {
    unsigned int delta;
    let mut lost_ints: c_int = -1;
    if (unlikely(!hpet_rtc_flags))
    hpet_disable_rtc_channel();
    if (!(hpet_rtc_flags & RTC_PIE) || hpet_pie_limit)
    delta = hpet_default_delta;
...
#[no_mangle]
pub unsafe extern "C" fn hpet_rtc_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    irqreturn_t hpet_rtc_interrupt(int irq, void *dev_id)
    {
    struct rtc_time curr_time;
    let mut rtc_int_flag: c_ulong = 0;
