...
//! Source: arch/x86/kernel/dumpstack_64.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn in_exception_stack(stack: *mut c_ulong, info: *mut stack_info) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn in_irq_stack(stack: *mut c_ulong, info: *mut stack_info) -> __always_inline bool {
