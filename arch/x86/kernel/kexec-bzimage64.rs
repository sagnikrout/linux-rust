...
//! Source: arch/x86/kernel/kexec-bzimage64.c
#![no_std]
...
// more insight.
//
pub const MIN_PURGATORY_ADDR: c_uint = 0x3000;
pub const MIN_BOOTPARAM_ADDR: c_uint = 0x3000;
pub const MIN_KERNEL_LOAD_ADDR: c_uint = 0x100000;
pub const MIN_INITRD_LOAD_ADDR: c_uint = 0x1000000;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bzimage64_data {
//
// Temporary buffer to hold bootparams buffer. This should be
// freed once the bootparam segment has been loaded.
//
    pub bootparams_buf: *mut c_void,
}
...
#[no_mangle]
unsafe extern "C" fn setup_e820_entries(params: *mut boot_params) -> c_int {
...
// TODO: Pass entries more than E820_MAX_ENTRIES_ZEROPAGE in bootparams setup data
    ...
    let mut efi_map_phys_addr: c_ulong = params_load_addr + efi_map_offset;
...
#[no_mangle]
pub unsafe extern "C" fn if(EFI_INVALID_TABLE_ADDR: efi.acpi !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn bzImage64_probe(buf: *const c_char, len: c_ulong) -> c_int {
...
// I've got a bzImage
    ...
    void *stack;
    let mut setup_hdr_offset: c_uint = offsetof(struct boot_params, hdr);
...
#[no_mangle]
unsafe extern "C" fn bzImage64_cleanup(loader_data: *mut c_void) -> c_int {
    ...
    ldata.bootparams_buf = core::ptr::null_mut();
    return 0;
    }
