...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct irq_stat_info {
    pub skip_vector: c_uint,
...
#[no_mangle]
unsafe extern "C" fn irq_init_stats() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn irq_stat_inc_and_enable(which: enum irq_stat_counts) {
...
#[no_mangle]
unsafe extern "C" fn call_irq_handler(vector: c_int, regs: *mut pt_regs) -> __always_inline bool {
...
// Function pointer for generic interrupt vector handling
    void (*x86_platform_ipi_callback)(void) __ro_after_init = core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn kvm_set_posted_intr_wakeup_handler((*handler)(void): *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_posted_msi_init() {
...
#[no_mangle]
pub unsafe extern "C" fn intel_ack_posted_msi_irq(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn handle_pending_pir(pir: *mut c_ulong, regs: *mut pt_regs) -> __always_inline bool {
    static __always_inline bool handle_pending_pir(unsigned long *pir, struct pt_regs *regs)
    {
    unsigned long pir_copy[NR_PIR_WORDS];
    let mut vec: c_int = FIRST_EXTERNAL_VECTOR;
...
//
pub const MAX_POSTED_MSI_COALESCING_LOOP: c_int = 3;
//
...
#[no_mangle]
pub unsafe extern "C" fn fixup_irqs() {
...
#[no_mangle]
unsafe extern "C" fn smp_thermal_vector() {
