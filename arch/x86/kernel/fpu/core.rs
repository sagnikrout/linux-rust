...
//! Source: arch/x86/kernel/fpu/core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn irq_fpu_usable() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn update_avx_timestamp(fpu: *mut fpu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn save_fpregs_to_fpstate(fpu: *mut fpu) {
...
#[no_mangle]
pub unsafe extern "C" fn restore_fpregs_from_fpstate(fpstate: *mut fpstate, mask: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn fpu_reset_from_exception_fixup() {
...
#[no_mangle]
unsafe extern "C" fn fpu_lock_guest_permissions() {
...
#[no_mangle]
pub unsafe extern "C" fn fpu_alloc_guest_fpstate(gfpu: *mut fpu_guest) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fpu_free_guest_fpstate(gfpu: *mut fpu_guest) {
    ...
    return;
    gfpu.fpstate = core::ptr::null_mut();
    vfree(fpstate);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn fpu_enable_guest_xfd_features(guest_fpu: *mut fpu_guest, xfeatures: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fpu_update_guest_xfd(guest_fpu: *mut fpu_guest, xfd: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpu_sync_guest_vmexit_xfd_state() {
...
#[no_mangle]
pub unsafe extern "C" fn fpu_swap_kvm_fpstate(guest_fpu: *mut fpu_guest, enter_guest: bool) -> c_int {
...
// Swap fpstate
    ...
    fpu.__task_fpstate = core::ptr::null_mut();
    }
    cur_fps = fpu.fpstate;
...
//
    ...
    let mut mb: membuf = { .p = buf, .left = size };
...
//
    ...
    vpkru = core::ptr::null_mut();
    return copy_uabi_from_kernel_to_xstate(kstate, ustate, vpkru);
    }
    EXPORT_SYMBOL_FOR_KVM(fpu_copy_uabi_to_guest_fpstate);

#[no_mangle]
pub unsafe extern "C" fn kernel_fpu_begin_mask(kfpu_mask: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpu_sync_fpstate(fpu: *mut fpu) {
...
#[no_mangle]
pub unsafe extern "C" fn init_fpstate_copy_size() -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn fpstate_init_fxstate(fpstate: *mut fpstate) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpstate_init_fstate(fpstate: *mut fpstate) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpstate_init_user(fpstate: *mut fpstate) {
...
#[no_mangle]
unsafe extern "C" fn __fpstate_reset(fpstate: *mut fpstate) {
    static void __fpstate_reset(struct fpstate *fpstate)
    {
//
...
#[no_mangle]
pub unsafe extern "C" fn fpstate_reset(fpu: *mut fpu) {
...
#[no_mangle]
pub unsafe extern "C" fn fpu_inherit_perms(dst_fpu: *mut fpu) {
...
#[no_mangle]
unsafe extern "C" fn update_fpu_shstk(dst: *mut task_struct, ssp: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpu_thread_struct_whitelist(offset: *mut c_ulong, size: *mut c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpu__drop(tsk: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn restore_fpregs_from_init_fpstate(features_mask: u64) {
    static inline void restore_fpregs_from_init_fpstate(u64 features_mask)
    {
    if (use_xsave())
    os_xrstor(&init_fpstate, features_mask);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: use_fxsr()) -> else {
    else if (use_fxsr())
...
//
#[no_mangle]
unsafe extern "C" fn fpu_reset_fpstate_regs() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpu__clear_user_states(fpu: *mut fpu) {
...
#[no_mangle]
pub unsafe extern "C" fn fpu_flush_thread() {
...
//
#[no_mangle]
pub unsafe extern "C" fn switch_fpu_return() {
...
#[no_mangle]
pub unsafe extern "C" fn fpregs_lock_and_load() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpregs_assert_state_consistent() {
...
#[no_mangle]
pub unsafe extern "C" fn fpregs_mark_activate() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpu__exception_code(fpu: *mut fpu, trap_nr: c_int) -> c_int {
...
//
    let mut mxcsr: c_ushort = MXCSR_DEFAULT;
...
//
#[no_mangle]
pub unsafe extern "C" fn fpu_idle_fpregs() -> noinstr void {
