...
pub struct nmi_desc {
    ...
    pub emerg_handler: nmi_handler_t,
    pub head: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nmi_stats {
    pub normal: c_uint,
    pub unknown: c_uint,
    pub external: c_uint,
    pub swallow: c_uint,
    pub recv_jiffies: c_ulong,
    pub idt_seq: c_ulong,
    pub idt_nmi_seq: c_ulong,
    pub idt_ignored: c_ulong,
    pub idt_calls: atomic_long_t,
    pub idt_seq_snap: c_ulong,
    pub idt_nmi_seq_snap: c_ulong,
    pub idt_ignored_snap: c_ulong,
    pub idt_calls_snap: c_long,
}
...
#[no_mangle]
unsafe extern "C" fn setup_unknown_nmi_panic(str: *mut c_char) -> int __init {
    ...
    let mut nmi_longest_ns: static u64 = 1 * NSEC_PER_MSEC;
#[no_mangle]
unsafe extern "C" fn nmi_warning_debugfs() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nmi_check_duration(action: *mut nmiaction, duration: u64) {
...
#[no_mangle]
unsafe extern "C" fn nmi_handle(type: c_uint, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __register_nmi_handler(type: c_uint, action: *mut nmiaction) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_nmi_handler(type: c_uint, name: *const c_char) {
    void unregister_nmi_handler(unsigned int type, const char *name)
    {
    struct nmi_desc *desc = nmi_to_desc(type);
    struct nmiaction *n, *found = core::ptr::null_mut();
    unsigned long flags;
    raw_spin_lock_irqsave(&desc.lock, flags);
...
//
#[no_mangle]
pub unsafe extern "C" fn set_emergency_nmi_handler(type: c_uint, handler: nmi_handler_t) {
...
#[no_mangle]
unsafe extern "C" fn default_do_nmi(regs: *mut pt_regs) -> noinstr void {
    static noinstr void default_do_nmi(struct pt_regs *regs)
    {
    let mut reason: c_uchar = 0;
    int handled;
    let mut b2b: bool = false;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(NMI_REASON_IOCHK: reason &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn nmi_backtrace_stall_snap(btp: *const cpumask) {
...
#[no_mangle]
pub unsafe extern "C" fn nmi_backtrace_stall_check(btp: *const cpumask) {
    void nmi_backtrace_stall_check(const struct cpumask *btp)
    {
    int cpu;
    int idx;
    unsigned long nmi_seq;
    let mut j: c_ulong = jiffies;
    char *modp;
    char *msgp;
    char *msghp;
    struct nmi_stats *nsp;
...
#[no_mangle]
pub unsafe extern "C" fn if(0x1: nmi_seq &) -> else {
    else if (nmi_seq & 0x1)
...
#[no_mangle]
pub unsafe extern "C" fn stop_nmi() {
    void stop_nmi(void)
    {
    ignore_nmis++;
    }
#[no_mangle]
pub unsafe extern "C" fn restart_nmi() {
...
#[no_mangle]
pub unsafe extern "C" fn local_touch_nmi() {
