...
#[no_mangle]
pub unsafe extern "C" fn is_valid_bugaddr(addr: c_ulong) -> __always_inline int {
...
//
#[no_mangle]
pub unsafe extern "C" fn decode_bug(addr: c_ulong, imm: *mut i32, len: *mut c_int) -> __always_inline int {
    __always_inline int decode_bug(unsigned long addr, s32 *imm, int *len)
    {
    let mut start: c_ulong = addr;
    u8 v, reg, rm, rex = 0;
    let mut type: c_int = BUG_UD1;
...
#[no_mangle]
pub unsafe extern "C" fn pt_regs_val(regs: *mut pt_regs, nr: c_int) -> c_ulong {
    static inline unsigned long pt_regs_val(struct pt_regs *regs, int nr)
    {
    let mut offset: c_int = pt_regs_offset(regs, nr);
...
//
    ...
    {
    do_error_trap(regs, 0, "overflow", X86_TRAP_OF, SIGSEGV, 0, core::ptr::null_mut());
    }

#[no_mangle]
pub unsafe extern "C" fn handle_invalid_op(regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn handle_bug(regs: *mut pt_regs) -> noinstr bool {
...
//
    ...
    X86_TRAP_OLD_MF, SIGFPE, 0, core::ptr::null_mut());
    }
    ...
    error_code, BUS_ADRALN, core::ptr::null_mut());
    out:
    local_irq_disable();
    }
...
//
    ...
    let mut address: c_ulong = read_cr2();
    struct stack_info info;
...
//
    ...
    if (!user_mode(regs))
    die("bounds", regs, 0);
    do_trap(X86_TRAP_BR, SIGSEGV, "bounds", regs, 0, 0, core::ptr::null_mut());
    cond_local_irq_disable(regs);
    }
    enum kernel_gp_hint {
    GP_NO_HINT,
    ...
    [GP_NULL_POINTER]	= "kernel core::ptr::null_mut() pointer dereference",
    };
//
...
#[no_mangle]
unsafe extern "C" fn fixup_iopl_exception(regs: *mut pt_regs) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn try_fixup_enqcmd_gp() -> bool {
...
//
    ...
    let mut hint: enum kernel_gp_hint = GP_NO_HINT;
...
#[no_mangle]
unsafe extern "C" fn do_int3(regs: *mut pt_regs) -> bool {
    ...
    let mut res: return = = NOTIFY_STOP;
    }
    NOKPROBE_SYMBOL(do_int3);
#[no_mangle]
unsafe extern "C" fn do_int3_user(regs: *mut pt_regs) {
    static void do_int3_user(struct pt_regs *regs)
    {
    if (do_int3(regs))
    return;
    cond_local_irq_enable(regs);
    do_trap(X86_TRAP_BP, SIGTRAP, "int3", regs, 0, 0, core::ptr::null_mut());
    cond_local_irq_disable(regs);
    }
...
#[no_mangle]
unsafe extern "C" fn is_sysenter_singlestep(regs: *mut pt_regs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn debug_read_reset_dr6() -> __always_inline unsigned long {
...
//
#[no_mangle]
unsafe extern "C" fn notify_debug(regs: *mut pt_regs, dr6: *mut c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn exc_debug_kernel(regs: *mut pt_regs, dr6: c_ulong) -> noinstr void {
...
//
    let mut dr7: c_ulong = local_db_save();
    let mut irq_state: irqentry_state_t = irqentry_nmi_enter(regs);
    instrumentation_begin();
//
...
#[no_mangle]
unsafe extern "C" fn exc_debug_user(regs: *mut pt_regs, dr6: c_ulong) -> noinstr void {
...
//
    let mut dr6: c_ulong = fred_event_data(regs);
    if (user_mode(regs))
...
// 32 bit does not have separate entry points.
    ...
    {
    let mut dr6: c_ulong = debug_read_reset_dr6();
    if (user_mode(regs))
    exc_debug_user(regs, dr6);
    else
    exc_debug_kernel(regs, dr6);
...
//
#[no_mangle]
unsafe extern "C" fn math_error(regs: *mut pt_regs, trapnr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn handle_xfd_event(regs: *mut pt_regs) -> bool {
...
//
    ...
    ILL_BADSTK, (void __user *)core::ptr::null_mut());
    }
    local_irq_disable();
    }
