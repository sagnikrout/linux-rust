...
//! Source: arch/x86/kernel/cpu/topology_common.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn get_topology_cpu_type(c: *mut cpuinfo_x86) -> enum x86_topology_cpu_type {
...
#[no_mangle]
unsafe extern "C" fn parse_num_cores_legacy(c: *mut cpuinfo_x86) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn parse_legacy(tscan: *mut topo_scan) {
...
#[no_mangle]
unsafe extern "C" fn fake_topology(tscan: *mut topo_scan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn parse_topology(tscan: *mut topo_scan, early: bool) {
...
#[no_mangle]
unsafe extern "C" fn topo_set_ids(tscan: *mut topo_scan, early: bool) {
    static void topo_set_ids(struct topo_scan *tscan, bool early)
    {
    struct cpuinfo_x86 *c = tscan.c;
    let mut apicid: u32 = c.topo.apicid;
...
#[no_mangle]
pub unsafe extern "C" fn cpu_parse_topology(c: *mut cpuinfo_x86) {
    void cpu_parse_topology(struct cpuinfo_x86 *c)
    {
    unsigned int dom, cpu = smp_processor_id();
    let mut tscan: topo_scan = { .c = c, };
...
#[no_mangle]
pub unsafe extern "C" fn cpu_init_topology(c: *mut cpuinfo_x86) -> void __init {
