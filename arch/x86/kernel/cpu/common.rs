...
// Number of siblings per CPU package
    let mut __ro_after_init: unsigned int __max_threads_per_core = 1;
    EXPORT_SYMBOL(__max_threads_per_core);
    let mut __ro_after_init: unsigned int __max_dies_per_package = 1;
    EXPORT_SYMBOL(__max_dies_per_package);
    let mut __ro_after_init: unsigned int __max_logical_packages = 1;
    EXPORT_SYMBOL(__max_logical_packages);
    let mut __ro_after_init: unsigned int __num_nodes_per_package = 1;
    EXPORT_SYMBOL(__num_nodes_per_package);
    let mut __ro_after_init: unsigned int __num_cores_per_package = 1;
    EXPORT_SYMBOL(__num_cores_per_package);
    let mut __ro_after_init: unsigned int __num_threads_per_package = 1;
...
#[no_mangle]
unsafe extern "C" fn ppin_init(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn default_init(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn if(3: c->x86 ==) -> else {
    else if (c.x86 == 3)
...
#[no_mangle]
unsafe extern "C" fn x86_nopcid_setup(s: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn x86_noinvpcid_setup(s: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn flag_is_changeable_p(flag: c_ulong) -> bool {
...
//
    ...
    let mut cachesize_override: static int = -1;
    let mut disable_x86_serial_nr: static int = 1;
#[no_mangle]
unsafe extern "C" fn cachesize_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn cpuid_feature() -> bool {
    bool cpuid_feature(void)
    {
    return flag_is_changeable_p(X86_EFLAGS_ID);
    }
#[no_mangle]
unsafe extern "C" fn squash_the_stupid_serial_number(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn x86_serial_nr_setup(s: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn squash_the_stupid_serial_number(c: *mut cpuinfo_x86) {
    static inline void squash_the_stupid_serial_number(struct cpuinfo_x86 *c)
    {
    }

#[no_mangle]
unsafe extern "C" fn setup_smep(c: *mut cpuinfo_x86) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn setup_smap(c: *mut cpuinfo_x86) -> __always_inline void {
    static __always_inline void setup_smap(struct cpuinfo_x86 *c)
    {
    let mut eflags: c_ulong = native_save_fl();
...
#[no_mangle]
unsafe extern "C" fn setup_umip(c: *mut cpuinfo_x86) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn enable_lass(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpu_finalize_pre_userspace() -> c_int {
    static int cpu_finalize_pre_userspace(void)
    {
    if (!cpu_feature_enabled(X86_FEATURE_LASS))
    return 0;
// Runs on all online CPUs and future CPUs that come online.
    cpuhp_setup_state(CPUHP_AP_ONLINE_DYN, "x86/lass:enable", enable_lass, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn native_write_cr0(val: c_ulong) {
    void native_write_cr0(unsigned long val)
    {
    let mut bits_missing: c_ulong = 0;
    set_register:
...
#[no_mangle]
pub unsafe extern "C" fn native_write_cr4(val: c_ulong) -> void __no_profile {
    void __no_profile native_write_cr4(unsigned long val)
    {
    let mut bits_changed: c_ulong = 0;
    set_register:
...
#[no_mangle]
pub unsafe extern "C" fn cr4_update_irqsoff(set: c_ulong, clear: c_ulong) {
...
// Read the CR4 shadow.
#[no_mangle]
pub unsafe extern "C" fn cr4_read_shadow() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn cr4_init() {
    void cr4_init(void)
    {
    let mut cr4: c_ulong = __read_cr4();
    if (boot_cpu_has(X86_FEATURE_PCID))
    cr4 |= X86_CR4_PCIDE;
    if (static_branch_likely(&cr_pinning))
...
//
#[no_mangle]
unsafe extern "C" fn setup_cr_pinning() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn x86_nofsgsbase_setup(arg: *mut c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn setup_pku(c: *mut cpuinfo_x86) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn setup_disable_pku(arg: *mut c_char) -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn ibt_save(disable: bool) -> __noendbr u64 {
...
#[no_mangle]
pub unsafe extern "C" fn ibt_restore(save: u64) -> __noendbr void {
...
#[no_mangle]
unsafe extern "C" fn setup_cet(c: *mut cpuinfo_x86) -> __always_inline void {
...
#[no_mangle]
pub unsafe extern "C" fn cet_disable() -> __noendbr void {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpuid_dependent_feature {
    pub feature: u32,
    pub level: u32,
}
...
#[no_mangle]
unsafe extern "C" fn filter_cpuid_features(c: *mut cpuinfo_x86, warn: bool) {
...
// Look up CPU names by table lookup.
    ...
    if (c.x86_model >= 16)
    return core::ptr::null_mut();	/* Range check */
    if (!this_cpu)
...
#[no_mangle]
pub unsafe extern "C" fn load_direct_gdt(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn load_fixmap_gdt(cpu: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn switch_gdt_and_percpu_base(cpu: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn get_model_name(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_detect_cache_sizes(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn cpu_detect_tlb(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn get_cpu_vendor(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_detect(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn apply_forced_caps(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_speculation_control(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn get_cpu_cap(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn get_cpu_address_sizes(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn identify_cpu_without_cpuid(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn cpu_matches(table: *const x86_cpu_id, which: c_ulong) -> bool __init {
...
#[no_mangle]
pub unsafe extern "C" fn x86_read_arch_cap_msr() -> u64 {
    u64 x86_read_arch_cap_msr(void)
    {
    let mut x86_arch_cap_msr: u64 = 0;
    if (boot_cpu_has(X86_FEATURE_ARCH_CAPABILITIES))
    rdmsrq(MSR_IA32_ARCH_CAPABILITIES, x86_arch_cap_msr);
    return x86_arch_cap_msr;
    }
#[no_mangle]
unsafe extern "C" fn arch_cap_mmio_immune(x86_arch_cap_msr: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vulnerable_to_rfds(x86_arch_cap_msr: u64) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn vulnerable_to_its(x86_arch_cap_msr: u64) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn cpu_has_old_microcode() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn cpu_set_bug_bits(c: *mut cpuinfo_x86) -> void __init {
    static void __init cpu_set_bug_bits(struct cpuinfo_x86 *c)
    {
    let mut x86_arch_cap_msr: u64 = x86_read_arch_cap_msr();
...
//
#[no_mangle]
unsafe extern "C" fn detect_nopl() {
...
#[no_mangle]
pub unsafe extern "C" fn parse_set_clear_cpuid(arg: *mut c_char, set: bool) -> bool {
    static inline bool parse_set_clear_cpuid(char *arg, bool set)
    {
    char *opt;
    let mut taint: c_int = 0;
    while (arg) {
...
//
#[no_mangle]
unsafe extern "C" fn cpu_parse_early_param() -> void __init {
    static void __init cpu_parse_early_param(void)
    {
    let mut cpuid_taint: bool = false;
    char arg[128];
    int arglen;
...
//
#[no_mangle]
unsafe extern "C" fn early_identify_cpu(c: *mut cpuinfo_x86) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn init_cpu_devs() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn early_cpu_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn detect_null_seg_behavior() -> bool {
...
//
    ...
    let mut tmp: return = = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn check_null_seg_clears_base(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn generic_identify(c: *mut cpuinfo_x86) {
...
//
#[no_mangle]
unsafe extern "C" fn identify_cpu(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn enable_sep_cpu() {
...
#[no_mangle]
unsafe extern "C" fn identify_boot_cpu() -> __init void {
...
#[no_mangle]
pub unsafe extern "C" fn identify_secondary_cpu(cpu: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn print_cpu_info(c: *mut cpuinfo_x86) {
    void print_cpu_info(struct cpuinfo_x86 *c)
    {
    const char *vendor = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn setup_clearcpuid(arg: *mut c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn setup_setcpuid(arg: *mut c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn wrmsrq_cstar(val: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn idt_syscall_init() {
...
pub unsafe extern "C" fn syscall_init() {
    ...
    {
    let mut val: msr = { .h = (__USER32_CS << 16) | __KERNEL_CS };
...
#[no_mangle]
unsafe extern "C" fn initialize_debug_regs() {
...
//
#[no_mangle]
unsafe extern "C" fn dbg_restore_debug_regs() {
...
// Macro flag: #define dbg_restore_debug_regs()

#[no_mangle]
pub unsafe extern "C" fn setup_getcpu(cpu: c_int) {
    static inline void setup_getcpu(int cpu)
    {
    let mut cpudata: c_ulong = vdso_encode_cpunode(cpu, early_cpu_to_node(cpu));
    let mut d: desc_struct = { };
...
#[no_mangle]
pub unsafe extern "C" fn tss_setup_ist(tss: *mut tss_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tss_setup_io_bitmap(tss: *mut tss_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpu_init_exception_handling(boot_cpu: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_init_replace_early_idt() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn store_cpu_caps(curr_info: *mut cpuinfo_x86) {
...
//
#[no_mangle]
pub unsafe extern "C" fn microcode_check(prev_info: *mut cpuinfo_x86) {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_smt_update() {
...
#[no_mangle]
pub unsafe extern "C" fn arch_cpu_finalize_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn tlbi_setup(str: *mut c_char) -> int __init {
