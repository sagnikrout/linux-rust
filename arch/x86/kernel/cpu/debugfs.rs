...
//! Source: arch/x86/kernel/cpu/debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cpu_debug_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dom_debug_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_init_debugfs() -> __init int {
    static __init int cpu_init_debugfs(void)
    {
    struct dentry *dir, *base = debugfs_create_dir("topo", arch_debugfs_dir);
    unsigned long id;
    char name[24];
    debugfs_create_file("domains", 0444, base, core::ptr::null_mut(), &dfs_dom_ops);
