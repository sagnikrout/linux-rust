...
//! Source: arch/x86/kernel/cpu/topology_amd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn parse_8000_0008(tscan: *mut topo_scan) -> bool {
...
#[no_mangle]
unsafe extern "C" fn store_node(tscan: *mut topo_scan, nr_nodes: u16, node_id: u16) {
...
#[no_mangle]
unsafe extern "C" fn parse_8000_001e(tscan: *mut topo_scan) -> bool {
...
// Update the SMT domain, but do not propagate it.
    let mut nthreads: c_uint = leaf.core_nthreads + 1;
...
#[no_mangle]
unsafe extern "C" fn parse_fam10h_node_id(tscan: *mut topo_scan) {
...
#[no_mangle]
unsafe extern "C" fn legacy_set_llc(tscan: *mut topo_scan) {
    static void legacy_set_llc(struct topo_scan *tscan)
    {
    let mut apicid: c_uint = tscan.c.topo.initial_apicid;
// If none of the parsers set LLC ID then use the die ID for it.
    if (tscan.c.topo.llc_id == BAD_APICID)
    tscan.c.topo.llc_id = apicid >> tscan.dom_shifts[TOPO_CORE_DOMAIN];
    }
#[no_mangle]
unsafe extern "C" fn topoext_fixup(tscan: *mut topo_scan) {
...
#[no_mangle]
unsafe extern "C" fn parse_topology_amd(tscan: *mut topo_scan) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_parse_topology_amd(tscan: *mut topo_scan) {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_topology_fixup_amd(tscan: *mut topo_scan) {
