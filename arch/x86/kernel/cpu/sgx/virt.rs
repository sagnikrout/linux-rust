...
//! Source: arch/x86/kernel/cpu/sgx/virt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sgx_vepc_remove_page(epc_page: *mut sgx_epc_page) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgx_vepc_free_page(epc_page: *mut sgx_epc_page) -> c_int {
    static int sgx_vepc_free_page(struct sgx_epc_page *epc_page)
    {
    let mut ret: c_int = sgx_vepc_remove_page(epc_page);
    if (ret) {
//
...
#[no_mangle]
unsafe extern "C" fn sgx_vepc_remove_all(vepc: *mut sgx_vepc) -> c_long {
    ...
    let mut ret: c_int = sgx_vepc_remove_page(entry);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn sgx_vepc_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sgx_vepc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sgx_vepc_init() -> int __init {
...
//
pub const SGX_EINITTOKEN_SIZE: c_int = 304;
