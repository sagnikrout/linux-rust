...
//! Source: arch/x86/kernel/cpu/sgx/ioctl.c
#![no_std]
...
// Copyright(c) 2016-20 Intel Corporation.
    ...
    {
    struct sgx_va_page *va_page = core::ptr::null_mut();
    void *err;
...
#[no_mangle]
pub unsafe extern "C" fn sgx_encl_shrink(encl: *mut sgx_encl, va_page: *mut sgx_va_page) {
...
#[no_mangle]
unsafe extern "C" fn sgx_encl_create(encl: *mut sgx_encl, secs: *mut sgx_secs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: va_page) -> else {
    else if (va_page)
...
// Set only after completion, as encl->lock has not been taken.
    ...
    err_out_backing:
    fput(encl.backing);
    encl.backing = core::ptr::null_mut();
    err_out_shrink:
...
//
#[no_mangle]
unsafe extern "C" fn sgx_ioc_enclave_create(encl: *mut sgx_encl, arg: *mut void __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn sgx_validate_secinfo(secinfo: *mut sgx_secinfo) -> c_int {
    static int sgx_validate_secinfo(struct sgx_secinfo *secinfo)
    {
    let mut perm: u64 = secinfo.flags & SGX_SECINFO_PERMISSION_MASK;
    let mut pt: u64 = secinfo.flags & SGX_SECINFO_PAGE_TYPE_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn sgx_ioc_enclave_add_pages(encl: *mut sgx_encl, arg: *mut void __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn sgx_ioc_enclave_init(encl: *mut sgx_encl, arg: *mut void __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn sgx_ioc_enclave_provision(encl: *mut sgx_encl, arg: *mut void __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn sgx_ioc_sgx2_ready(encl: *mut sgx_encl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sgx_enclave_etrack(encl: *mut sgx_encl) -> c_int {
...
// try ETRACK again.
//
    on_each_cpu_mask(sgx_encl_cpumask(encl), sgx_ipi_cb, core::ptr::null_mut(), 1);
    ret = __etrack(epc_virt);
    if (ret) {
...
//
    ...
    encl.secs_child_cnt--;
    entry.epc_page = core::ptr::null_mut();
    xa_erase(&encl.page_array, PFN_DOWN(entry.desc));
    sgx_encl_shrink(encl, core::ptr::null_mut());
    kfree(entry);
    mutex_unlock(&encl.lock);
    }
    ret = 0;
...
#[no_mangle]
pub unsafe extern "C" fn sgx_ioctl(filep: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
