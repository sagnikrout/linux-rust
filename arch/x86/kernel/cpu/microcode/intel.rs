...
//! Source: arch/x86/kernel/cpu/microcode/intel.c
#![no_std]
...
pub const MBOX_REG_NUM: c_int = 4;

pub const MBOX_CONTROL_OFFSET: c_uint = 0x0;
pub const MBOX_STATUS_OFFSET: c_uint = 0x4;
pub const MBOX_WRDATA_OFFSET: c_uint = 0x8;
pub const MBOX_RDDATA_OFFSET: c_uint = 0xc;

pub const MBOX_CMD_LOAD: c_uint = 0x3;
pub const MBOX_OBJ_STAGING: c_uint = 0xb;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct extended_sigtable {
    pub count: c_uint,
    pub cksum: c_uint,
    pub reserved: [c_uint; 3],
    pub sigs: [extended_signature; ],
}
...
#[no_mangle]
pub unsafe extern "C" fn get_totalsize(hdr: *mut microcode_header_intel) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn exttable_size(et: *mut extended_sigtable) -> c_uint {
    static inline unsigned int exttable_size(struct extended_sigtable *et)
    {
    return et.count * EXT_SIGNATURE_SIZE + EXT_HEADER_SIZE;
    }
#[no_mangle]
pub unsafe extern "C" fn intel_collect_cpu_info(sig: *mut cpu_signature) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_find_matching_signature(mc: *mut c_void, sig: *mut cpu_signature) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_microcode_sanity_check(mc: *mut c_void, print_err: bool, hdr_type: c_int) -> c_int {
    int intel_microcode_sanity_check(void *mc, bool print_err, int hdr_type)
    {
    unsigned long total_size, data_size, ext_table_size;
    struct microcode_header_intel *mc_header = mc;
    struct extended_sigtable *ext_header = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn update_ucode_pointer(mc: *mut microcode_intel) {
...
#[no_mangle]
unsafe extern "C" fn save_microcode_patch(patch: *mut microcode_intel) {
    static void save_microcode_patch(struct microcode_intel *patch)
    {
    let mut size: c_uint = get_totalsize(&patch.hdr);
...
// Scan blob for microcode matching the boot CPUs family, model, stepping
    ...
    struct microcode_intel *patch = core::ptr::null_mut();
    let mut cur_rev: u32 = uci.cpu_sig.rev;
...
//
    ...
    return size ? core::ptr::null_mut() : patch;
    }
#[no_mangle]
pub unsafe extern "C" fn read_mbox_dword(mmio_base: *mut void __iomem) -> u32 {
    static inline u32 read_mbox_dword(void __iomem *mmio_base)
    {
    let mut dword: u32 = readl(mmio_base + MBOX_RDDATA_OFFSET);
// Acknowledge read completion to the staging hardware
    writel(0, mmio_base + MBOX_RDDATA_OFFSET);
    return dword;
    }
#[no_mangle]
pub unsafe extern "C" fn write_mbox_dword(mmio_base: *mut void __iomem, dword: u32) {
    static inline void write_mbox_dword(void __iomem *mmio_base, u32 dword)
    {
    writel(dword, mmio_base + MBOX_WRDATA_OFFSET);
    }
#[no_mangle]
pub unsafe extern "C" fn read_mbox_header(mmio_base: *mut void __iomem) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn write_mbox_header(mmio_base: *mut void __iomem, value: u64) {
...
#[no_mangle]
unsafe extern "C" fn write_mbox_data(mmio_base: *mut void __iomem, chunk: *mut u32, chunk_bytes: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn init_stage(ss: *mut staging_state) {
...
//
#[no_mangle]
unsafe extern "C" fn can_send_next_chunk(ss: *mut staging_state, err: *mut c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_end_offset(offset: u32) -> bool {
    static inline bool is_end_offset(u32 offset)
    {
    let mut offset: return = = UINT_MAX;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn staging_is_complete(ss: *mut staging_state, err: *mut c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn wait_for_transaction(ss: *mut staging_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn send_data_chunk(ss: *mut staging_state, ucode_ptr: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fetch_next_offset(ss: *mut staging_state) -> c_int {
    static int fetch_next_offset(struct staging_state *ss)
    {
    let mut expected_header: u64 = MBOX_HEADER(MBOX_HEADER_SIZE + MBOX_RESPONSE_SIZE);
    u32 offset, status;
    u64 header;
//
...
//
#[no_mangle]
unsafe extern "C" fn do_stage(mmio_pa: u64) -> c_int {
    static int do_stage(u64 mmio_pa)
    {
    let mut ss: staging_state = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn stage_microcode() {
    static void stage_microcode(void)
    {
    let mut pkg_id: c_uint = UINT_MAX;
    int cpu, err;
    u64 mmio_pa;
...
#[no_mangle]
unsafe extern "C" fn apply_microcode_early(uci: *mut ucode_cpu_info) -> enum ucode_state {
...
#[no_mangle]
unsafe extern "C" fn load_builtin_intel_microcode(cp: *mut cpio_data) -> __init bool {
    static __init bool load_builtin_intel_microcode(struct cpio_data *cp)
    {
    let mut eax: c_uint = 1, ebx, ecx = 0, edx;
    struct firmware fw;
    char name[30];
...
//
#[no_mangle]
unsafe extern "C" fn save_builtin_microcode() -> int __init {
    static int __init save_builtin_microcode(void)
    {
    struct ucode_cpu_info uci;
    if (xchg(&ucode_patch_va, core::ptr::null_mut()) != UCODE_BSP_LOADED)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn load_ucode_intel_bsp(ed: *mut early_load_data) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn load_ucode_intel_ap() {
...
#[no_mangle]
pub unsafe extern "C" fn reload_ucode_intel() {
    void reload_ucode_intel(void)
    {
    let mut uci: ucode_cpu_info = { .mc = ucode_patch_va, };
    if (uci.mc)
    apply_microcode_early(&uci);
    }
#[no_mangle]
unsafe extern "C" fn collect_cpu_info(cpu_num: c_int, csig: *mut cpu_signature) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apply_microcode_late(cpu: c_int) -> enum ucode_state {
...
#[no_mangle]
unsafe extern "C" fn ucode_validate_minrev(mc_header: *mut microcode_header_intel) -> bool {
    static bool ucode_validate_minrev(struct microcode_header_intel *mc_header)
    {
    let mut cur_rev: c_int = boot_cpu_data.microcode;
//
...
#[no_mangle]
unsafe extern "C" fn parse_microcode_blobs(cpu: c_int, iter: *mut iov_iter) -> enum ucode_state {
    static enum ucode_state parse_microcode_blobs(int cpu, struct iov_iter *iter)
    {
    struct ucode_cpu_info *uci = ucode_cpu_info + cpu;
    bool is_safe, new_is_safe = false;
    let mut cur_rev: c_int = uci.cpu_sig.rev;
    let mut curr_mc_size: c_uint = 0;
    u8 *new_mc = core::ptr::null_mut(), *mc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn is_blacklisted(cpu: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn request_microcode_fw(cpu: c_int, device: *mut device) -> enum ucode_state {
...
#[no_mangle]
unsafe extern "C" fn finalize_late_load(result: c_int) {
    ...
    ucode_patch_late = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn calc_llc_size_per_core(c: *mut cpuinfo_x86) -> __init void {
    static __init void calc_llc_size_per_core(struct cpuinfo_x86 *c)
    {
    let mut llc_size: u64 = c.x86_cache_size * 1024ULL;
    do_div(llc_size, topology_num_cores_per_package());
    llc_size_per_core = (unsigned int)llc_size;
    }
#[no_mangle]
unsafe extern "C" fn staging_available() -> __init bool {
...
#[no_mangle]
pub unsafe extern "C" fn init_intel_microcode() -> *mut microcode_ops  __init {
