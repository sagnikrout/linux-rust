...
//! Source: arch/x86/kernel/cpu/microcode/core.c
#![no_std]
...
//
    ...
    let mut force_minrev: bool = IS_ENABLED(CONFIG_MICROCODE_LATE_FORCE_MINREV);
//
...
//
#[no_mangle]
unsafe extern "C" fn amd_check_current_patch_level() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn microcode_loader_disabled() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn early_parse_cmdline() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn load_ucode_bsp() -> void __init {
    void __init load_ucode_bsp(void)
    {
    unsigned int cpuid_1_eax;
    let mut intel: bool = true;
    early_parse_cmdline();
    if (!cpuid_feature())
    dis_ucode_ldr = true;
    else
...
#[no_mangle]
pub unsafe extern "C" fn load_ucode_ap() {
...
#[no_mangle]
pub unsafe extern "C" fn find_microcode_in_initrd(path: *const c_char) -> cpio_data __init {
...
//
    if (initrd_start)
    start = initrd_start;
    return find_cpio_data(path, (void *)start, size, core::ptr::null_mut());

    return (struct cpio_data){ core::ptr::null_mut(), 0, "" };

    }
#[no_mangle]
unsafe extern "C" fn reload_early_microcode(cpu: c_uint) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct microcode_ctrl {
    pub ctrl: enum sibling_ctrl,
    pub result: enum ucode_state,
    pub ctrl_cpu: c_uint,
...
#[no_mangle]
unsafe extern "C" fn wait_for_cpus(cnt: *mut core::sync::atomic::AtomicI32) -> noinstr bool {
...
#[no_mangle]
unsafe extern "C" fn wait_for_ctrl() -> noinstr bool {
...
//
#[no_mangle]
unsafe extern "C" fn load_secondary_wait(ctrl_cpu: c_uint) -> noinstr bool {
...
//
#[no_mangle]
unsafe extern "C" fn load_secondary(cpu: c_uint) -> noinstr void {
    static noinstr void load_secondary(unsigned int cpu)
    {
    let mut ctrl_cpu: c_uint = raw_cpu_read(ucode_ctrl.ctrl_cpu);
...
#[no_mangle]
unsafe extern "C" fn __load_primary(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn kick_offline_cpus(nr_offl: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn release_offline_cpus() {
...
#[no_mangle]
unsafe extern "C" fn load_primary(cpu: c_uint) {
    static void load_primary(unsigned int cpu)
    {
    let mut nr_offl: c_uint = cpumask_weight(&cpu_offline_mask);
...
//
#[no_mangle]
pub unsafe extern "C" fn microcode_offline_nmi_handler() -> void noinstr {
...
#[no_mangle]
unsafe extern "C" fn microcode_update_handler() -> noinstr bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn microcode_nmi_handler() -> bool noinstr {
...
#[no_mangle]
unsafe extern "C" fn load_cpus_stopped(unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn load_late_stop_cpus(is_safe: bool) -> c_int {
    static int load_late_stop_cpus(bool is_safe)
    {
    unsigned int cpu, updated = 0, failed = 0, timedout = 0, siblings = 0;
    unsigned int nr_offl, offline = 0;
    let mut old_rev: c_int = boot_cpu_data.microcode;
...
//
    ...
    stop_machine_cpuslocked(load_cpus_stopped, core::ptr::null_mut(), cpu_online_mask);
    if (microcode_ops.use_nmi)
...
//
#[no_mangle]
unsafe extern "C" fn setup_cpus() -> bool {
    static bool setup_cpus(void)
    {
    let mut ctrl: microcode_ctrl = { .ctrl = SCTRL_WAIT, .result = -1, };
...
#[no_mangle]
unsafe extern "C" fn load_late_locked() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microcode_fini_cpu(cpu: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn microcode_bsp_resume() {
...
#[no_mangle]
unsafe extern "C" fn microcode_bsp_syscore_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mc_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc_cpu_down_prep(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microcode_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(X86_VENDOR_AMD: c->x86_vendor ==) -> else {
    ...
    microcode_fdev = faux_device_create("microcode", core::ptr::null_mut(), core::ptr::null_mut());
    if (!microcode_fdev)
    return -ENODEV;
