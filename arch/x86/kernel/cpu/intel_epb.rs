...
//! Source: arch/x86/kernel/cpu/intel_epb.c
#![no_std]
...
pub const EPB_MASK: c_uint = 0x0fULL;
pub const EPB_SAVED: c_uint = 0x10ULL;
...
#[no_mangle]
unsafe extern "C" fn intel_epb_save(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_epb_restore(data: *mut c_void) {
    static void intel_epb_restore(void *data)
    {
    let mut val: u64 = this_cpu_read(saved_epb);
    u64 epb;
    rdmsrq(MSR_IA32_ENERGY_PERF_BIAS, epb);
    if (val) {
    val &= EPB_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: kstrtou64(buf, _arg: 0, MAX_EPB: &val) || val >) -> else {
...
#[no_mangle]
unsafe extern "C" fn intel_epb_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_epb_offline(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_epb_init() -> __init int {
