...
//! Source: arch/x86/kernel/cpu/amd.c
#![no_std]
...
// SPDX-License-Identifier: GPL-2.0-only
    ...
    let mut __ro_after_init: u16 invlpgb_count_max = 1;
#[no_mangle]
pub unsafe extern "C" fn rdmsrq_amd_safe(msr: unsigned, p: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wrmsrq_amd_safe(msr: unsigned, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_amd_k5(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_k6(c: *mut cpuinfo_x86) {
    static void init_amd_k6(struct cpuinfo_x86 *c)
    {

    struct msr val;
    let mut mbytes: c_int = get_num_physpages() >> (20-PAGE_SHIFT);
    if (c.x86_model < 6) {
// Based on AMD doc 20734R - June 2000
    ...
    let mut K6_BUG_LOOP: c_int = 1000000;
    int n;
    void (*f_vide)(void);
    u64 d, d2;
...
#[no_mangle]
unsafe extern "C" fn init_amd_k7(c: *mut cpuinfo_x86) {
...
//
#[no_mangle]
unsafe extern "C" fn nearby_node(apicid: c_int) -> c_int {
...
unsafe extern "C" fn srat_detect_node(c: *mut cpuinfo_x86) {
    ...
    int node;
    let mut apicid: unsigned = c.topo.apicid;
...
//
    let mut ht_nodeid: c_int = c.topo.initial_apicid;
...
#[no_mangle]
unsafe extern "C" fn bsp_determine_snp(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn tsa_init(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn bsp_init_amd(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn early_detect_mem_encrypt(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn early_init_amd(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0xf: c->x86 >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(!wrmsrq_safe(MSR_IA32_PRED_CMD: c->x86 >= 0x19 &&, _arg: PRED_CMD_SBPB)) -> else {
    setup_force_cpu_cap(X86_FEATURE_IBPB_BRTYPE);
...
#[no_mangle]
unsafe extern "C" fn init_amd_k8(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_gh(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_ln(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn rdrand_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn clear_rdrand_cpuid_bit(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_jg(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_bd(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn fix_erratum_1386(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn init_spectral_chicken(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_zen_common() {
...
#[no_mangle]
unsafe extern "C" fn init_amd_zen1(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn zen2_zenbleed_check(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_zen2(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_zen3(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_zen4(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd_zen5(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn init_amd(c: *mut cpuinfo_x86) {
...
//
    ...
    init_amd_zen1(c);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_ZEN2)) -> else {
    else if (boot_cpu_has(X86_FEATURE_ZEN2))
    init_amd_zen2(c);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_ZEN3)) -> else {
    else if (boot_cpu_has(X86_FEATURE_ZEN3))
    init_amd_zen3(c);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_ZEN4)) -> else {
    else if (boot_cpu_has(X86_FEATURE_ZEN4))
    init_amd_zen4(c);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_ZEN5)) -> else {
...
#[no_mangle]
unsafe extern "C" fn amd_size_cache(c: *mut cpuinfo_x86, size: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cpu_detect_tlb_amd(c: *mut cpuinfo_x86) {
    static void cpu_detect_tlb_amd(struct cpuinfo_x86 *c)
    {
    u32 ebx, eax, ecx, edx;
    let mut mask: u16 = 0xfff;
    if (c.x86 < 0xf)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn amd_set_dr_addr_mask(mask: c_ulong, dr: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_get_dr_addr_mask(dr: c_uint) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn zenbleed_check_cpu(unused: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_check_microcode() {
    void amd_check_microcode(void)
    {
    if (boot_cpu_data.x86_vendor != X86_VENDOR_AMD)
    return;
    if (cpu_feature_enabled(X86_FEATURE_ZEN2))
    on_each_cpu(zenbleed_check_cpu, core::ptr::null_mut(), 1);
    }
...
#[no_mangle]
unsafe extern "C" fn print_s5_reset_status_mmio() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn dmi_scan_additional(d: *const dmi_header, p: *mut c_void) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn print_dmi_agesa() -> __init int {
    static __init int print_dmi_agesa(void)
    {
    dmi_walk(dmi_scan_additional, core::ptr::null_mut());
    return 0;
    }
