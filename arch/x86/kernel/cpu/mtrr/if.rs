...
#[no_mangle]
unsafe extern "C" fn mtrr_close(ino: *mut inode, file: *mut file) -> c_int {
    ...
    kfree(fcount);
    FILE_FCOUNT(file) = core::ptr::null_mut();
    }
    return single_release(ino, file);
    }
#[no_mangle]
unsafe extern "C" fn mtrr_seq_show(seq: *mut seq_file, offset: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtrr_open(inode: *mut inode, file: *mut file) -> c_int {
    ...
    return -EPERM;
    return single_open(file, mtrr_seq_show, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn mtrr_if_init() -> int __init {
    ...
    return -ENODEV;
    proc_create("mtrr", S_IWUSR | S_IRUGO, core::ptr::null_mut(), &mtrr_proc_ops);
    return 0;
    }
