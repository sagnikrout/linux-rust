...
//! Source: arch/x86/kernel/cpu/mtrr/generic.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fixed_range_block {
    pub /: *mut *mut int base_msr; / start address of an MTRR block,
    pub /: *mut *mut int ranges; / number of MTRRs in this block,
}
...
pub struct cache_map {
    ...
    bool mtrr_debug;
#[no_mangle]
unsafe extern "C" fn mtrr_param_setup(str: *mut c_char) -> int __init {
...
//
    ...
    let mut __refdata: *mut static struct cache_map cache_map = init_cache_map;
    let mut cache_map_size: static unsigned int = CACHE_MAP_MAX;
...
//
#[no_mangle]
pub unsafe extern "C" fn k8_check_syscfg_dram_mod_en() {
...
#[no_mangle]
unsafe extern "C" fn get_mtrr_size(mask: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn get_var_mtrr_state(reg: c_uint, start: *mut u64, size: *mut u64) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn get_effective_type(type1: u8, type2: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rm_map_entry_at(idx: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn add_map_entry_at(start: u64, end: u64, type: u8, idx: c_int) -> c_int {
    static int add_map_entry_at(u64 start, u64 end, u8 type, int idx)
    {
    let mut merge_prev: bool = false, merge_next = false;
    if (start >= end)
    return 0;
    if (idx > 0) {
...
#[no_mangle]
unsafe extern "C" fn clr_map_range_at(start: u64, end: u64, idx: c_int) -> c_int {
    static int clr_map_range_at(u64 start, u64 end, int idx)
    {
    let mut ret: c_int = start != cache_map[idx].start;
    u64 tmp;
...
//
#[no_mangle]
unsafe extern "C" fn add_map_entry(start: u64, end: u64, type: u8) {
...
#[no_mangle]
unsafe extern "C" fn map_add_var() {
...
//
#[no_mangle]
pub unsafe extern "C" fn generic_rebuild_map() {
...
#[no_mangle]
unsafe extern "C" fn get_cache_map_size() -> unsigned int __init {
...
#[no_mangle]
pub unsafe extern "C" fn mtrr_build_map() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn mtrr_copy_map() -> void __init {
    void __init mtrr_copy_map(void)
    {
    let mut new_size: c_uint = get_cache_map_size();
    if (!mtrr_state.enabled || !new_size) {
    cache_map = core::ptr::null_mut();
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn type_merge(type: u8, new_type: u8, uniform: *mut u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn mtrr_type_lookup(start: u64, end: u64, uniform: *mut u8) -> u8 {
    u8 mtrr_type_lookup(u64 start, u64 end, u8 *uniform)
    {
    let mut type: u8 = MTRR_TYPE_INVALID;
    unsigned int i;
    if (!mtrr_state_set) {
...
#[no_mangle]
unsafe extern "C" fn get_fixed_ranges(frs: *mut mtrr_type) {
...
#[no_mangle]
pub unsafe extern "C" fn mtrr_save_fixed_ranges(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn print_fixed_last() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn print_mtrr_state() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn get_mtrr_state() -> bool __init {
...
#[no_mangle]
pub unsafe extern "C" fn mtrr_state_warn() -> void __init {
    void __init mtrr_state_warn(void)
    {
    let mut mask: c_ulong = smp_changes_mask;
    if (!mask)
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn mtrr_wrmsr(msr: unsigned, a: unsigned, b: unsigned) {
    void mtrr_wrmsr(unsigned msr, unsigned a, unsigned b)
    {
    let mut val: msr = { .l = a, .h = b };
...
//
#[no_mangle]
unsafe extern "C" fn set_fixed_range(msr: c_int, changed: *mut bool, msrwords: *mut c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn set_fixed_ranges(frs: *mut mtrr_type) -> c_int {
    static int set_fixed_ranges(mtrr_type *frs)
    {
    unsigned long long *saved = (unsigned long long *)frs;
    let mut changed: bool = false;
    let mut block: c_int = -1, range;
    k8_check_syscfg_dram_mod_en();
...
//
#[no_mangle]
unsafe extern "C" fn set_mtrr_var_ranges(index: c_uint, vr: *mut mtrr_var_range) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn set_mtrr_state() -> c_ulong {
    static unsigned long set_mtrr_state(void)
    {
    let mut change_mask: c_ulong = 0;
    unsigned int i;
    for (i = 0; i < num_var_ranges; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn mtrr_disable() {
...
#[no_mangle]
pub unsafe extern "C" fn mtrr_enable() {
...
#[no_mangle]
pub unsafe extern "C" fn mtrr_generic_set_state() {
...
#[no_mangle]
unsafe extern "C" fn generic_have_wrcomb() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn positive_have_wrcomb() -> c_int {
