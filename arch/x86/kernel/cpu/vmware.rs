...
pub const CPUID_VMWARE_INFO_LEAF: c_uint = 0x40000000;
pub const CPUID_VMWARE_FEATURES_LEAF: c_uint = 0x40000010;

pub const STEALCLOCK_DISABLED: c_int = 0;
pub const STEALCLOCK_ENABLED: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmware_steal_time {
    union {
    pub /: *mut *mut u64 clock; / stolen time counter in units of vtsc,
    struct {
...
#[no_mangle]
pub unsafe extern "C" fn __vmware_platform() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmware_get_tsc_khz() -> c_ulong {
    ...
    let mut __initdata: static bool vmw_sched_clock = true;
    static DEFINE_PER_CPU_DECRYPTED(struct vmware_steal_time, vmw_steal_time) __aligned(64);
    static bool has_steal_clock;
    static bool steal_acc __initdata = true; /* steal time accounting */
#[no_mangle]
unsafe extern "C" fn setup_vmw_sched_clock(s: *mut c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn parse_no_stealacc(arg: *mut c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn vmware_sched_clock() -> noinstr u64 {
...
#[no_mangle]
unsafe extern "C" fn vmware_cyc2ns_setup() -> void __init {
    static void __init vmware_cyc2ns_setup(void)
    {
    struct cyc2ns_data *d = &vmware_cyc2ns;
    let mut tsc_now: c_ulonglong = rdtsc();
...
#[no_mangle]
unsafe extern "C" fn vmware_cmd_stealclock(addr_hi: u32, addr_lo: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stealclock_enable(pa: phys_addr_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __stealclock_disable() -> c_int {
    static int __stealclock_disable(void)
    {
    return vmware_cmd_stealclock(0, 1);
    }
#[no_mangle]
unsafe extern "C" fn stealclock_disable() {
    static void stealclock_disable(void)
    {
    __stealclock_disable();
    }
#[no_mangle]
unsafe extern "C" fn vmware_is_stealclock_available() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn vmware_steal_clock(cpu: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vmware_register_steal_time() {
...
#[no_mangle]
unsafe extern "C" fn vmware_disable_steal_time() {
...
#[no_mangle]
unsafe extern "C" fn vmware_guest_cpu_init() {
...
#[no_mangle]
unsafe extern "C" fn vmware_pv_guest_cpu_reboot(unused: *mut c_void) {
    ...
    {
    if (code == SYS_RESTART)
    on_each_cpu(vmware_pv_guest_cpu_reboot, core::ptr::null_mut(), 1);
    return NOTIFY_DONE;
    }
...
#[no_mangle]
unsafe extern "C" fn vmware_smp_prepare_boot_cpu() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn vmware_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmware_cpu_down_prepare(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmware_paravirt_ops_setup() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn vmware_set_capabilities() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(CPUID_VMWARE_FEATURES_ECX_VMMCALL: vmware_hypercall_mode ==) -> else {
    else if (vmware_hypercall_mode == CPUID_VMWARE_FEATURES_ECX_VMMCALL)
    setup_force_cpu_cap(X86_FEATURE_VMW_VMMCALL);
    }
#[no_mangle]
unsafe extern "C" fn vmware_platform_setup() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn vmware_select_hypercall() -> u8 __init {
...
//
#[no_mangle]
unsafe extern "C" fn vmware_platform() -> u32 __init {
...
#[no_mangle]
unsafe extern "C" fn vmware_legacy_x2apic_available() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn vmware_sev_es_hcall_finish(ghcb: *mut ghcb, regs: *mut pt_regs) -> bool {
