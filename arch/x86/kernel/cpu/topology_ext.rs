...
//! Source: arch/x86/kernel/cpu/topology_ext.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn parse_topology_leaf(tscan: *mut topo_scan, leaf: u32) -> bool {
...
//
    ...
    let mut sft: c_uint = get_count_order(tscan.dom_ncpus[TOPO_SMT_DOMAIN]);
...
#[no_mangle]
pub unsafe extern "C" fn cpu_parse_topology_ext(tscan: *mut topo_scan) -> bool {
