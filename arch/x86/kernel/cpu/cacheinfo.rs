...
//! Source: arch/x86/kernel/cpu/cacheinfo.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _cpuid4_info {
    pub eax: union _cpuid4_leaf_eax,
    pub ebx: union _cpuid4_leaf_ebx,
    pub ecx: union _cpuid4_leaf_ecx,
    pub id: c_uint,
    pub size: c_ulong,
}
...
//
pub const AMD_CPUID4_FULLY_ASSOCIATIVE: c_uint = 0xffff;
pub const AMD_L2_L3_INVALID_ASSOC: c_uint = 0x9;
    union l1_cache {
    struct {
...
#[no_mangle]
unsafe extern "C" fn amd_fill_cpuid4_info(index: c_int, id4: *mut _cpuid4_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_fill_cpuid4_info(index: c_int, id4: *mut _cpuid4_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fill_cpuid4_info(index: c_int, id4: *mut _cpuid4_info) -> c_int {
    static int fill_cpuid4_info(int index, struct _cpuid4_info *id4)
    {
    let mut cpu_vendor: u8 = boot_cpu_data.x86_vendor;
    return (cpu_vendor == X86_VENDOR_AMD || cpu_vendor == X86_VENDOR_HYGON) ?
    amd_fill_cpuid4_info(index, id4) :
    intel_fill_cpuid4_info(index, id4);
    }
#[no_mangle]
unsafe extern "C" fn find_num_cache_leaves(c: *mut cpuinfo_x86) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_cache_id(apicid: u32, id4: *const _cpuid4_info) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn cacheinfo_amd_init_llc_id(c: *mut cpuinfo_x86, die_id: u16) {
...
//
    let mut llc_index: u32 = find_num_cache_leaves(c) - 1;
    let mut id4: _cpuid4_info = {};
    if (!amd_fill_cpuid4_info(llc_index, &id4))
    c.topo.llc_id = get_cache_id(c.topo.apicid, &id4);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn cacheinfo_hygon_init_llc_id(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn init_amd_cacheinfo(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x80000006: c->extended_cpuid_level >=) -> else {
    else if (c.extended_cpuid_level >= 0x80000006)
    ci.num_leaves = (cpuid_edx(0x80000006) & 0xf000) ? 4 : 3;
    }
#[no_mangle]
pub unsafe extern "C" fn init_hygon_cacheinfo(c: *mut cpuinfo_x86) {
...
//
#[no_mangle]
unsafe extern "C" fn intel_cacheinfo_0x2(c: *mut cpuinfo_x86) {
    static void intel_cacheinfo_0x2(struct cpuinfo_x86 *c)
    {
    let mut l1i: c_uint = 0, l1d = 0, l2 = 0, l3 = 0;
...
#[no_mangle]
unsafe extern "C" fn calc_cache_topo_id(c: *mut cpuinfo_x86, id4: *const _cpuid4_info) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn intel_cacheinfo_0x4(c: *mut cpuinfo_x86) -> bool {
    static bool intel_cacheinfo_0x4(struct cpuinfo_x86 *c)
    {
    struct cpu_cacheinfo *ci = get_cpu_cacheinfo(c.cpu_index);
    let mut l2_id: c_uint = BAD_APICID, l3_id = BAD_APICID;
    let mut l1d: c_uint = 0, l1i = 0, l2 = 0, l3 = 0;
    if (c.cpuid_level < 4)
    return false;
//
...
//
    ...
    l1d = id4.size / 1024;
#[no_mangle]
pub unsafe extern "C" fn if(CTYPE_INST: id4.eax.split.type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn init_intel_cacheinfo(c: *mut cpuinfo_x86) {
...
pub unsafe extern "C" fn populate_cache_leaves(cpu: c_uint) -> c_int {
    ...
    let mut cpu_vendor: u8 = boot_cpu_data.x86_vendor;
    let mut apicid: u32 = cpu_data(cpu).topo.apicid;
    struct amd_northbridge *nb = core::ptr::null_mut();
    let mut id4: _cpuid4_info = {};
    int idx, ret;
...
//
#[no_mangle]
unsafe extern "C" fn maybe_flush_caches() {
...
#[no_mangle]
pub unsafe extern "C" fn cache_disable(__acquires(cache_disable_lock: void)) {
...
#[no_mangle]
pub unsafe extern "C" fn cache_enable(__releases(cache_disable_lock: void)) {
...
#[no_mangle]
unsafe extern "C" fn cache_cpu_init() {
    ...
    let mut cache_aps_delayed_init: static bool = true;
#[no_mangle]
pub unsafe extern "C" fn set_cache_aps_delayed_init(val: bool) {
    void set_cache_aps_delayed_init(bool val)
    {
    cache_aps_delayed_init = val;
    }
#[no_mangle]
pub unsafe extern "C" fn get_cache_aps_delayed_init() -> bool {
    bool get_cache_aps_delayed_init(void)
    {
    return cache_aps_delayed_init;
    }
#[no_mangle]
unsafe extern "C" fn cache_rendezvous_handler(unused: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cache_bp_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn cache_bp_restore() {
...
#[no_mangle]
unsafe extern "C" fn cache_ap_online(cpu: c_uint) -> c_int {
...
//
    stop_machine_from_inactive_cpu(cache_rendezvous_handler, core::ptr::null_mut(),
    cpu_cacheinfo_mask);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cache_ap_offline(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_aps_init() {
    void cache_aps_init(void)
    {
    if (!memory_caching_control || !get_cache_aps_delayed_init())
    return;
    stop_machine(cache_rendezvous_handler, core::ptr::null_mut(), cpu_online_mask);
    set_cache_aps_delayed_init(false);
    }
#[no_mangle]
unsafe extern "C" fn cache_ap_register() -> int __init {
