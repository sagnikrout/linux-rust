...
//! Source: arch/x86/kernel/cpu/mce/intel.c
#![no_std]
...
pub const CMCI_THRESHOLD: c_int = 1;
//
...
//
pub const CMCI_STORM_THRESHOLD: c_int = 32749;
#[no_mangle]
unsafe extern "C" fn cmci_supported(banks: *mut c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lmce_supported() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn cmci_set_threshold(bank: c_int, thresh: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn mce_intel_handle_storm(bank: c_int, on: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn intel_threshold_interrupt() {
...
//
#[no_mangle]
unsafe extern "C" fn cmci_skip_bank(bank: c_int, val: *mut u64) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn cmci_pick_threshold(val: u64, bios_zero_thresh: *mut c_int) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn cmci_claim_bank(bank: c_int, val: u64, bios_zero_thresh: c_int, bios_wrong_thresh: *mut c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cmci_discover(banks: c_int) {
    static void cmci_discover(int banks)
    {
    let mut bios_wrong_thresh: c_int = 0;
    unsigned long flags;
    int i;
    raw_spin_lock_irqsave(&cmci_discover_lock, flags);
    for (i = 0; i < banks; i++) {
    u64 val;
    let mut bios_zero_thresh: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn cmci_recheck() {
...
#[no_mangle]
unsafe extern "C" fn __cmci_disable_bank(bank: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cmci_clear() {
...
#[no_mangle]
unsafe extern "C" fn cmci_rediscover_work_func(arg: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn cmci_rediscover() {
    void cmci_rediscover(void)
    {
    int banks;
    if (!cmci_supported(&banks))
    return;
    on_each_cpu(cmci_rediscover_work_func, core::ptr::null_mut(), 1);
    }
//
// Reenable CMCI on this CPU in case a CPU down failed.
//
#[no_mangle]
pub unsafe extern "C" fn cmci_reenable() {
...
#[no_mangle]
pub unsafe extern "C" fn cmci_disable_bank(bank: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cmci_mc_poll_banks() {
...
#[no_mangle]
pub unsafe extern "C" fn intel_init_cmci() {
...
#[no_mangle]
pub unsafe extern "C" fn intel_init_lmce() {
...
#[no_mangle]
pub unsafe extern "C" fn intel_clear_lmce() {
...
//
#[no_mangle]
unsafe extern "C" fn intel_imc_init(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn intel_apply_cpu_quirks(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn mce_intel_feature_init(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn mce_intel_feature_clear(c: *mut cpuinfo_x86) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_filter_mce(m: *mut mce) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_mce_usable_address(m: *mut mce) -> bool {
