...
//! Source: arch/x86/kernel/cpu/resctrl/pseudo_lock.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_get_prefetch_disable_bits() -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_pseudo_lock_fn(_plr: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_measure_cycles_lat_fn(_plr: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct residency_counts {
    pub hits_before: u64 miss_before,,
    pub hits_after: u64 miss_after,,
}
    ...
    {
    let mut hits_before: u64 = 0, hits_after = 0, miss_before = 0, miss_after = 0;
...
// one local read.
//
    if (perf_event_read_local(miss_event, &tmp, core::ptr::null_mut(), core::ptr::null_mut())) {
    local_irq_enable();
    goto out_hit;
    }
    if (perf_event_read_local(hit_event, &tmp, core::ptr::null_mut(), core::ptr::null_mut())) {
    local_irq_enable();
    goto out_hit;
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_measure_l2_residency(_plr: *mut c_void) -> c_int {
    int resctrl_arch_measure_l2_residency(void *_plr)
    {
    struct pseudo_lock_region *plr = _plr;
    let mut counts: residency_counts = {0};
//
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_measure_l3_residency(_plr: *mut c_void) -> c_int {
