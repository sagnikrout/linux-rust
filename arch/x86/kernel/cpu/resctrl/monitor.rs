...
//! Source: arch/x86/kernel/cpu/resctrl/monitor.c
#![no_std]
...
//
    ...
    let mut snc_nodes_per_l3_cache: static int = 1;
//
...
//
    ...
    let mut __read_mostly: static u32 mbm_cf_rmidthreshold = UINT_MAX;
    static u64 mbm_cf __read_mostly;
#[no_mangle]
pub unsafe extern "C" fn get_corrected_mbm_count(rmid: u32, val: c_ulong) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn logical_rmid_to_physical_rmid(cpu: c_int, lrmid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __rmid_read_phys(prmid: u32, eventid: enum resctrl_event_id, val: *mut u64) -> c_int {
    static int __rmid_read_phys(u32 prmid, enum resctrl_event_id eventid, u64 *val)
    {
    let mut msr_val: msr = { .l = eventid, .h = prmid };
//
...
// val = msr_val.q;
    ...
    return state ? &state[rmid] : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mbm_overflow_count(prev_msr: u64, cur_msr: u64, width: c_uint) -> u64 {
    static u64 mbm_overflow_count(u64 prev_msr, u64 cur_msr, unsigned int width)
    {
    let mut shift: u64 = 64 - width, chunks;
...
#[no_mangle]
unsafe extern "C" fn __cntr_id_read(cntr_id: u32, val: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_mon_domain_online(r: *mut rdt_resource, d: *mut rdt_l3_mon_domain) {
...
#[no_mangle]
unsafe extern "C" fn snc_get_config() -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn rdt_get_l3_mon_config(r: *mut rdt_resource) -> int __init {
    int __init rdt_get_l3_mon_config(struct rdt_resource *r)
    {
    let mut mbm_offset: c_uint = boot_cpu_data.x86_cache_mbm_width_offset;
    struct rdt_hw_resource *hw_res = resctrl_to_arch_res(r);
...
#[no_mangle]
pub unsafe extern "C" fn if(MBM_CNTR_WIDTH_OFFSET_MAX: mbm_offset >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn intel_rdt_mbm_apply_quirk() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn resctrl_abmc_set_one_amd(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn _resctrl_abmc_enable(r: *mut rdt_resource, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn resctrl_abmc_config_one_amd(info: *mut c_void) {
...
//
    ...
    {
    struct rdt_hw_l3_mon_domain *hw_dom = resctrl_to_arch_mon_dom(d);
    let mut abmc_cfg: union l3_qos_abmc_cfg = { 0 };
    struct arch_mbm_state *am;
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_mbm_cntr_assign_set_one(r: *mut rdt_resource) {
