...
//! Source: arch/x86/kernel/cpu/aperfmperf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_counter_refs(data: *mut c_void) {
...
//
    ...
    let mut arch_turbo_freq_ratio: static u64 = SCHED_CAPACITY_SCALE;
    let mut arch_max_freq_ratio: static u64 = SCHED_CAPACITY_SCALE;
#[no_mangle]
pub unsafe extern "C" fn arch_set_max_freq_ratio(turbo_disabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn turbo_disabled() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn slv_set_max_freq_ratio(base_freq: *mut u64, turbo_freq: *mut u64) -> bool __init {
...
// turbo_freq = *turbo_freq & 0x3F;           /* 1C turbo
    ...
    X86_MATCH_VFM_FEATURE(vfm, X86_FEATURE_APERFMPERF, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn skx_set_max_freq_ratio(base_freq: *mut u64, turbo_freq: *mut u64, size: c_int) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn core_set_max_freq_ratio(base_freq: *mut u64, turbo_freq: *mut u64) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_set_max_freq_ratio() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn register_freq_invariance_syscore() {
...
#[no_mangle]
unsafe extern "C" fn freq_invariance_enable() {
...
#[no_mangle]
pub unsafe extern "C" fn freq_invariance_set_perf_ratio(ratio: u64, turbo_disabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn bp_init_freq_invariance() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn disable_freq_invariance_workfn(work: *mut work_struct) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arch_hybrid_cpu_scale {
    pub capacity: c_ulong,
    pub freq_ratio: c_ulong,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_enable_hybrid_capacity_scale() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_scale_cpu_capacity(cpu: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn scale_freq_tick(acnt: u64, mcnt: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn arch_scale_freq_tick() {
...
#[no_mangle]
pub unsafe extern "C" fn arch_freq_get_on_cpu(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bp_init_aperfmperf() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ap_init_aperfmperf() {
