...
//
    ...
    let mut __ro_after_init: u64 x86_pred_cmd = PRED_CMD_IBPB;
    static u64 __ro_after_init x86_arch_cap_msr;
    static DEFINE_MUTEX(spec_ctrl_mutex);
    void (*x86_return_thunk)(void) __ro_after_init = __x86_return_thunk;
#[no_mangle]
unsafe extern "C" fn set_return_thunk(thunk: *mut c_void) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn update_spec_ctrl(val: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn update_spec_ctrl_cond(val: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn spec_ctrl_current() -> noinstr u64 {
...
#[no_mangle]
unsafe extern "C" fn cpu_print_attack_vectors() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn x86_amd_ssb_disable() {
    static void x86_amd_ssb_disable(void)
    {
    let mut msrval: u64 = x86_amd_ls_cfg_base | x86_amd_ls_cfg_ssbd_mask;
    if (boot_cpu_has(X86_FEATURE_VIRT_SSBD))
    wrmsrq(MSR_AMD64_VIRT_SPEC_CTRL, SPEC_CTRL_SSBD);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_LS_CFG_SSBD)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn should_mitigate_vuln(bug: c_uint) -> bool __init {
...
// Default mitigation for MDS-affected CPUs
    ...
    let mut __ro_after_init: static bool mds_nosmt = false;
...
#[no_mangle]
unsafe extern "C" fn mds_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mds_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mds_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mds_cmdline(str: *mut c_char) -> int __init {
    ...
    mds_mitigation = MDS_MITIGATION_OFF;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "full")) -> else {
    else if (!strcmp(str, "full"))
    mds_mitigation = MDS_MITIGATION_FULL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "full, _arg: nosmt")) -> else {
    mds_mitigation = MDS_MITIGATION_FULL;
    mds_nosmt = true;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn taa_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn taa_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn tsx_async_abort_parse_cmdline(str: *mut c_char) -> int __init {
    ...
    let mut __ro_after_init: static bool mmio_nosmt = false;
...
#[no_mangle]
unsafe extern "C" fn mmio_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mmio_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mmio_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mmio_stale_data_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn verw_clears_cpu_reg_file() -> bool __init {
    static inline bool __init verw_clears_cpu_reg_file(void)
    {
    return (x86_arch_cap_msr & ARCH_CAP_RFDS_CLEAR);
    }
#[no_mangle]
unsafe extern "C" fn rfds_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rfds_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rfds_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rfds_parse_cmdline(str: *mut c_char) -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn update_srbds_msr() {
...
#[no_mangle]
unsafe extern "C" fn srbds_select_mitigation() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_HYPERVISOR)) -> else {
    else if (boot_cpu_has(X86_FEATURE_HYPERVISOR))
    srbds_mitigation = SRBDS_MITIGATION_HYPERVISOR;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !boot_cpu_has(X86_FEATURE_SRBDS_CTRL)) -> else {
    else if (!boot_cpu_has(X86_FEATURE_SRBDS_CTRL))
    srbds_mitigation = SRBDS_MITIGATION_UCODE_NEEDED;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: srbds_off) -> else {
    else if (srbds_off)
    srbds_mitigation = SRBDS_MITIGATION_OFF;
    pr_info("%s\n", srbds_strings[srbds_mitigation]);
    }
#[no_mangle]
unsafe extern "C" fn srbds_apply_mitigation() -> void __init {
    static void __init srbds_apply_mitigation(void)
    {
    update_srbds_msr();
    }
#[no_mangle]
unsafe extern "C" fn srbds_parse_cmdline(str: *mut c_char) -> int __init {
    ...
    let mut __initdata: static enum l1d_flush_mitigations l1d_flush_mitigation = L1D_FLUSH_OFF;
#[no_mangle]
unsafe extern "C" fn l1d_flush_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn l1d_flush_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn gds_ucode_mitigated() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn update_gds_msr() {
...
#[no_mangle]
unsafe extern "C" fn gds_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn gds_apply_mitigation() -> void __init {
...
// Microcode is present
    ...
    update_gds_msr();
#[no_mangle]
pub unsafe extern "C" fn if(GDS_MITIGATION_FORCE: gds_mitigation ==) -> else {
//
...
#[no_mangle]
unsafe extern "C" fn gds_parse_cmdline(str: *mut c_char) -> int __init {
    ...
    gds_mitigation = GDS_MITIGATION_OFF;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "force")) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn smap_works_speculatively() -> bool {
...
#[no_mangle]
unsafe extern "C" fn spectre_v1_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v1_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn nospectre_v1_cmdline(str: *mut c_char) -> int __init {
    ...
    let mut __ro_after_init: enum spectre_v2_mitigation spectre_v2_enabled = SPECTRE_V2_NONE;
// Depends on spectre_v2 mitigation selected already
#[no_mangle]
pub unsafe extern "C" fn cdt_possible(mode: enum spectre_v2_mitigation) -> bool {
    ...
    let mut retbleed_nosmt: static int __ro_after_init = false;
    ...
    let mut __ro_after_init: static enum srso_mitigation srso_mitigation = SRSO_MITIGATION_AUTO;
#[no_mangle]
unsafe extern "C" fn retbleed_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn retbleed_select_mitigation() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_IBRS)) -> else {
...
#[no_mangle]
unsafe extern "C" fn retbleed_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn retbleed_apply_mitigation() -> void __init {
    static void __init retbleed_apply_mitigation(void)
    {
    let mut mitigate_smt: bool = false;
    switch (retbleed_mitigation) {
...
#[no_mangle]
unsafe extern "C" fn its_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn its_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn its_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn its_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn tsa_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "user")) -> else {
    else if (!strcmp(str, "user"))
    tsa_mitigation = TSA_MITIGATION_USER_KERNEL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "vm")) -> else {
...
#[no_mangle]
unsafe extern "C" fn tsa_select_mitigation() -> void __init {
    ...
    let mut vm: bool = false, uk = false;
    tsa_mitigation = TSA_MITIGATION_NONE;
    if (cpu_attack_vector_mitigated(CPU_MITIGATE_USER_KERNEL) ||
    cpu_attack_vector_mitigated(CPU_MITIGATE_USER_USER)) {
    tsa_mitigation = TSA_MITIGATION_USER_KERNEL;
...
#[no_mangle]
unsafe extern "C" fn tsa_apply_mitigation() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn retpoline_module_ok(has_retpoline: bool) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn retpoline_seq_enabled() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn unpriv_ebpf_notify(new_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_user_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "prctl")) -> else {
    else if (!strcmp(str, "prctl"))
    spectre_v2_user_cmd = SPECTRE_V2_USER_CMD_PRCTL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "prctl, _arg: ibpb")) -> else {
    else if (!strcmp(str, "prctl,ibpb"))
    spectre_v2_user_cmd = SPECTRE_V2_USER_CMD_PRCTL_IBPB;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "seccomp")) -> else {
    else if (!strcmp(str, "seccomp"))
    spectre_v2_user_cmd = SPECTRE_V2_USER_CMD_SECCOMP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "seccomp, _arg: ibpb")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn spectre_v2_in_ibrs_mode(mode: enum spectre_v2_mitigation) -> bool {
    static inline bool spectre_v2_in_ibrs_mode(enum spectre_v2_mitigation mode)
    {
    return spectre_v2_in_eibrs_mode(mode) || mode == SPECTRE_V2_IBRS;
    }
#[no_mangle]
unsafe extern "C" fn spectre_v2_user_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_user_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_user_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn nospectre_v2_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_select_retpoline() -> enum spectre_v2_mitigation __init {
...
#[no_mangle]
unsafe extern "C" fn spec_ctrl_disable_kernel_rrsba() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_select_rsb_mitigation(mode: enum spectre_v2_mitigation) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn spec_ctrl_bhi_dis() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_bhi_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "vmexit")) -> else {
    else if (!strcmp(str, "vmexit"))
...
#[no_mangle]
unsafe extern "C" fn bhi_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn bhi_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn bhi_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __bpf_arch_ibpb(unused: *mut c_void) {
    static void __bpf_arch_ibpb(void *unused)
    {
    write_ibpb();
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_arch_ibpb() {
    void bpf_arch_ibpb(void)
    {
    on_each_cpu(__bpf_arch_ibpb, core::ptr::null_mut(), 1);
    }
#[no_mangle]
unsafe extern "C" fn cpu_wants_ibpb_bpf() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn spectre_v2_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn update_stibp_msr(__unused: *mut *mut c_void) {
    static void update_stibp_msr(void * __unused)
    {
    let mut val: u64 = spec_ctrl_current() | (x86_spec_ctrl_base & SPEC_CTRL_STIBP);
    update_spec_ctrl(val);
    }
// Update x86_spec_ctrl_base in case SMT state changed.
#[no_mangle]
unsafe extern "C" fn update_stibp_strict() {
    static void update_stibp_strict(void)
    {
    let mut mask: u64 = x86_spec_ctrl_base & ~SPEC_CTRL_STIBP;
    if (sched_smt_active())
    ...
    on_each_cpu(update_stibp_msr, core::ptr::null_mut(), 1);
    }
// Update the static key controlling the evaluation of TIF_SPEC_IB
#[no_mangle]
unsafe extern "C" fn update_indir_branch_cond() {
...
#[no_mangle]
unsafe extern "C" fn update_mds_branch_idle() {
...
#[no_mangle]
unsafe extern "C" fn nossb_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ssb_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ssb_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn ssb_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn task_update_spec_tif(tsk: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn l1d_flush_prctl_set(task: *mut task_struct, ctrl: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssb_prctl_set(task: *mut task_struct, ctrl: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_spec_ib_user_controlled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn ib_prctl_set(task: *mut task_struct, ctrl: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arch_seccomp_spec_mitigate(task: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn l1d_flush_prctl_get(task: *mut task_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ib_prctl_get(task: *mut task_struct) -> c_int {
    ...
    return PR_SPEC_ENABLE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_spec_ib_user_controlled()) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn x86_spec_ctrl_setup_ap() {
...
// Default mitigation for L1TF-affected CPUs
    ...
    let mut l1tf_vmx_mitigation: enum vmx_l1d_flush_state = VMENTER_L1D_FLUSH_AUTO;
...
//
#[no_mangle]
unsafe extern "C" fn override_cache_bits(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn l1tf_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn l1tf_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn l1tf_cmdline(str: *mut c_char) -> int __init {
    ...
    l1tf_mitigation = L1TF_MITIGATION_OFF;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "flush, _arg: nowarn")) -> else {
    else if (!strcmp(str, "flush,nowarn"))
    l1tf_mitigation = L1TF_MITIGATION_FLUSH_NOWARN;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "flush")) -> else {
    else if (!strcmp(str, "flush"))
    l1tf_mitigation = L1TF_MITIGATION_FLUSH;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "flush, _arg: nosmt")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "full, _arg: force")) -> else {
...
#[no_mangle]
unsafe extern "C" fn srso_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "microcode")) -> else {
    else if (!strcmp(str, "microcode"))
    srso_mitigation = SRSO_MITIGATION_MICROCODE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "safe-ret")) -> else {
    else if (!strcmp(str, "safe-ret"))
    srso_mitigation = SRSO_MITIGATION_SAFE_RET;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "ibpb")) -> else {
    else if (!strcmp(str, "ibpb"))
    srso_mitigation = SRSO_MITIGATION_IBPB;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "ibpb-vmexit")) -> else {
...
#[no_mangle]
unsafe extern "C" fn srso_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn srso_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn srso_apply_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn vmscape_parse_cmdline(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vmscape_select_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn vmscape_update_mitigation() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn vmscape_apply_mitigation() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_bugs_smt_update() {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_select_mitigations() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn l1tf_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn itlb_multihit_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn if(X86_CR4_VMXE): !(cr4_read_shadow() &) -> else {
    else if (!(cr4_read_shadow() & X86_CR4_VMXE))
    return sysfs_emit(buf, "KVM: Mitigation: VMX disabled\n");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: itlb_multihit_kvm_mitigation) -> else {
...
#[no_mangle]
unsafe extern "C" fn mds_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tsx_async_abort_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mmio_stale_data_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn rfds_show_state(buf: *mut c_char) -> isize {
    static ssize_t rfds_show_state(char *buf)
    {
    return sysfs_emit(buf, "%s\n", rfds_strings[rfds_mitigation]);
    }
#[no_mangle]
unsafe extern "C" fn old_microcode_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn its_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_CLEAR_BHB_HW)) -> else {
    else if (boot_cpu_has(X86_FEATURE_CLEAR_BHB_HW))
    return "; BHI: BHI_DIS_S";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_CLEAR_BHB_LOOP)) -> else {
    else if (boot_cpu_has(X86_FEATURE_CLEAR_BHB_LOOP))
    return "; BHI: SW loop, KVM: SW loop";
#[no_mangle]
pub unsafe extern "C" fn if(rrsba_disabled: retpoline_seq_enabled() &&) -> else {
    else if (retpoline_seq_enabled() && rrsba_disabled)
    return "; BHI: Retpoline";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boot_cpu_has(X86_FEATURE_CLEAR_BHB_VMEXIT)) -> else {
    else if (boot_cpu_has(X86_FEATURE_CLEAR_BHB_VMEXIT))
    return "; BHI: Vulnerable, KVM: SW loop";
    return "; BHI: Vulnerable";
    }
#[no_mangle]
unsafe extern "C" fn spectre_v2_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn srbds_show_state(buf: *mut c_char) -> isize {
    static ssize_t srbds_show_state(char *buf)
    {
    return sysfs_emit(buf, "%s\n", srbds_strings[srbds_mitigation]);
    }
#[no_mangle]
unsafe extern "C" fn retbleed_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn srso_show_state(buf: *mut c_char) -> isize {
    static ssize_t srso_show_state(char *buf)
    {
    return sysfs_emit(buf, "%s\n", srso_strings[srso_mitigation]);
    }
#[no_mangle]
unsafe extern "C" fn gds_show_state(buf: *mut c_char) -> isize {
    static ssize_t gds_show_state(char *buf)
    {
    return sysfs_emit(buf, "%s\n", gds_strings[gds_mitigation]);
    }
#[no_mangle]
unsafe extern "C" fn tsa_show_state(buf: *mut c_char) -> isize {
    static ssize_t tsa_show_state(char *buf)
    {
    return sysfs_emit(buf, "%s\n", tsa_strings[tsa_mitigation]);
    }
#[no_mangle]
unsafe extern "C" fn vmscape_show_state(buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_show_mds(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_mds(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_MDS);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_tsx_async_abort(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_tsx_async_abort(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_TAA);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_itlb_multihit(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_itlb_multihit(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_ITLB_MULTIHIT);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_srbds(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_srbds(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_SRBDS);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_mmio_stale_data(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_mmio_stale_data(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_MMIO_STALE_DATA);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_retbleed(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_retbleed(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_RETBLEED);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_spec_rstack_overflow(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_spec_rstack_overflow(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_SRSO);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_gds(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_gds(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_GDS);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_reg_file_data_sampling(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_reg_file_data_sampling(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_RFDS);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_old_microcode(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn cpu_show_indirect_target_selection(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_indirect_target_selection(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_ITS);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_tsa(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ssize_t cpu_show_tsa(struct device *dev, struct device_attribute *attr, char *buf)
    {
    return cpu_show_common(dev, attr, buf, X86_BUG_TSA);
    }
#[no_mangle]
pub unsafe extern "C" fn cpu_show_vmscape(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn __warn_thunk() {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_interrupted_saferet(regs: *mut pt_regs) -> void noinstr {
    void noinstr handle_interrupted_saferet(struct pt_regs *regs)
    {
    let mut rip: c_ulong = regs.ip;
