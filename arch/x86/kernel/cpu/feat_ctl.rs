...
//! Source: arch/x86/kernel/cpu/feat_ctl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_vmx_capabilities(c: *mut cpuinfo_x86) {
...
#[no_mangle]
unsafe extern "C" fn nosgx(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn init_ia32_feat_ctl(c: *mut cpuinfo_x86) {
    void init_ia32_feat_ctl(struct cpuinfo_x86 *c)
    {
    let mut enable_sgx_kvm: bool = false, enable_sgx_driver = false;
    let mut tboot: bool = tboot_enabled();
    bool enable_vmx;
    u64 msr;
