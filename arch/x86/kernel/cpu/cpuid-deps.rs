...
#[no_mangle]
pub unsafe extern "C" fn clear_feature(c: *mut cpuinfo_x86, feature: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn do_clear_cpu_cap(c: *mut cpuinfo_x86, feature: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_cpu_cap(c: *mut cpuinfo_x86, feature: c_uint) {
    void clear_cpu_cap(struct cpuinfo_x86 *c, unsigned int feature)
    {
    do_clear_cpu_cap(c, feature);
    }
#[no_mangle]
pub unsafe extern "C" fn setup_clear_cpu_cap(feature: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn check_cpufeature_deps(c: *mut cpuinfo_x86) {
