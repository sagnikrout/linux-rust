...
//! Source: arch/x86/kernel/jump_label.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn arch_jump_entry_size(entry: *mut jump_entry) -> c_int {
...
//
    ...
    int init)
    {
    let mut jlp: jump_label_patch = __jump_label_patch(entry, type);
//
...
//
    ...
    smp_text_poke_single((void *)jump_entry_code(entry), jlp.code, jlp.size, core::ptr::null_mut());
    }
...
//
    ...
    smp_text_poke_batch_add((void *)jump_entry_code(entry), jlp.code, jlp.size, core::ptr::null_mut());
    mutex_unlock(&text_mutex);
    return true;
    }
#[no_mangle]
