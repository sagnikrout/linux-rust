...
//
    let mut host_supports_tls: static int = -1;
    int host_gdt_entry_tls_min;
#[no_mangle]
unsafe extern "C" fn do_set_thread_area(task: *mut *mut task_struct, info: *mut user_desc) -> c_int {
    ...
    return -EINVAL;
    if (using_seccomp) {
    let mut idx: c_int = info.entry_number - host_gdt_entry_tls_min;
...
//
#[no_mangle]
unsafe extern "C" fn get_free_idx(task: *mut *mut task_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn clear_user_desc(info: *mut *mut user_desc) {
...
pub const O_FORCE: c_int = 1;
#[no_mangle]
unsafe extern "C" fn load_TLS(flags: c_int, to: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn needs_TLS_update(task: *mut task_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_switch_tls(to: *mut task_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arch_set_tls(new: *mut task_struct, tls: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __setup_host_supports_tls() -> int __init {
