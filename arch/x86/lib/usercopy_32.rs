...
//! Source: arch/x86/lib/usercopy_32.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __movsl_is_ok(a1: c_ulong, a2: c_ulong, n: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __copy_user_ll(to: *mut c_void, from: *const c_void, n: c_ulong) -> c_ulong {
