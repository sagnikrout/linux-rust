...
//! Source: arch/x86/lib/insn-eval.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn is_string_insn(insn: *mut insn) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn get_seg_reg_override_idx(insn: *mut insn) -> c_int {
    static int get_seg_reg_override_idx(struct insn *insn)
    {
    let mut idx: c_int = INAT_SEG_REG_DEFAULT;
    let mut num_overrides: c_int = 0;
    insn_byte_t p;
    insn_get_prefixes(insn);
...
//
#[no_mangle]
unsafe extern "C" fn check_seg_overrides(insn: *mut insn, regoff: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn resolve_default_seg(insn: *mut insn, regs: *mut pt_regs, off: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn resolve_seg_reg(insn: *mut insn, regs: *mut pt_regs, regoff: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_segment_selector(regs: *mut pt_regs, seg_reg_idx: c_int) -> c_short {
...
#[no_mangle]
pub unsafe extern "C" fn pt_regs_offset(regs: *mut pt_regs, regno: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_regno(insn: *mut insn, type: enum reg_type) -> c_int {
    static int get_regno(struct insn *insn, enum reg_type type)
    {
    let mut nr_registers: c_int = ARRAY_SIZE(pt_regoff);
    let mut regno: c_int = 0;
//
...
//
    ...
    enum reg_type type)
    {
    let mut regno: c_int = get_regno(insn, type);
    if (regno < 0)
    return regno;
...
//
#[no_mangle]
unsafe extern "C" fn get_desc(out: *mut desc_struct, sel: c_ushort) -> bool {
    static bool get_desc(struct desc_struct *out, unsigned short sel)
    {
    let mut gdt_desc: desc_ptr = {0, 0};
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_seg_base(regs: *mut pt_regs, seg_reg_idx: c_int) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn get_seg_limit(regs: *mut pt_regs, seg_reg_idx: c_int) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_code_seg_params(regs: *mut pt_regs) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_modrm_rm_off(insn: *mut insn, regs: *mut pt_regs) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_get_modrm_reg_off(insn: *mut insn, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(4: insn->addr_bytes ==) -> else {
...
//
    ...
    let mut addr32: c_int = (int)(tmp & 0xffffffff) + insn.displacement.value;
...
//
    ...
    let mut addr1: c_short = 0, addr2 = 0, displacement;
    if (insn.addr_bytes != 2)
    return -EINVAL;
    insn_get_modrm(insn);
...
//
    ...
    base = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: *mut *mut base_offset <) -> else {
    ...
    indx = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: indx_offset <) -> else {
...
//
    ...
    {
    let mut linear_addr: c_ulong = -1L, seg_base, seg_limit;
    int ret, regoff;
    short eff_addr;
    long tmp;
...
//
    ...
    static void __user *get_addr_ref_64(struct insn *insn, struct pt_regs *regs)
    {
    let mut linear_addr: c_ulong = -1L, seg_base;
    int regoff, ret;
    long eff_addr;
    ...
    ret = get_seg_base_limit(insn, regs, regoff, &seg_base, core::ptr::null_mut());
    if (ret)
    goto out;
...
#[no_mangle]
pub unsafe extern "C" fn insn_get_effective_ip(regs: *mut pt_regs, ip: *mut c_ulong) -> c_int {
    int insn_get_effective_ip(struct pt_regs *regs, unsigned long *ip)
    {
    let mut seg_base: c_ulong = 0;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_fetch_from_user(regs: *mut pt_regs, buf[MAX_INSN_SIZE]: c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_fetch_from_user_inatomic(regs: *mut pt_regs, buf[MAX_INSN_SIZE]: c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_decode_mmio(insn: *mut insn, bytes: *mut c_int) -> enum insn_mmio_type {
    enum insn_mmio_type insn_decode_mmio(struct insn *insn, int *bytes)
    {
    let mut type: enum insn_mmio_type = INSN_MMIO_DECODE_FAILED;
// bytes = 0;
    if (insn_get_opcode(insn))
...
//
#[no_mangle]
pub unsafe extern "C" fn insn_is_nop(insn: *mut insn) -> bool {
    bool insn_is_nop(struct insn *insn)
    {
    let mut b3: u8 = 0, x3 = 0, r3 = 0;
    let mut b4: u8 = 0, x4 = 0, r4 = 0, m = 0;
    u8 modrm, modrm_mod, modrm_reg, modrm_rm;
    let mut sib: u8 = 0, sib_scale, sib_index, sib_base;
    u8 nrex, rex;
    u8 p, rep = 0;
