...
pub const GHCB_USAGE_HYPERV_CALL: c_int = 1;
    union hv_ghcb {
    struct ghcb ghcb;
    struct {
...
#[no_mangle]
pub unsafe extern "C" fn hv_ghcb_hypercall(control: u64, input: *mut c_void, output: *mut c_void, input_size: u32) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn rd_ghcb_msr() -> u64 {
    static inline u64 rd_ghcb_msr(void)
    {
    return native_rdmsrq(MSR_AMD64_SEV_ES_GHCB);
    }
#[no_mangle]
pub unsafe extern "C" fn wr_ghcb_msr(val: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_ghcb_terminate(set: c_uint, reason: c_uint) -> void __noreturn {
    void __noreturn hv_ghcb_terminate(unsigned int set, unsigned int reason)
    {
    let mut val: u64 = GHCB_MSR_TERM_REQ;
...
#[no_mangle]
pub unsafe extern "C" fn hv_ghcb_negotiate_protocol() -> bool {
...
#[no_mangle]
unsafe extern "C" fn hv_ghcb_msr_write(msr: u64, value: u64) {
...
#[no_mangle]
unsafe extern "C" fn hv_ghcb_msr_read(msr: u64, value: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn snp_set_vmsa(va: *mut c_void, vmsa: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn snp_cleanup_vmsa(vmsa: *mut sev_es_save_area) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_snp_boot_ap(apic_id: u32, start_ip: c_ulong, cpu: c_uint) -> c_int {
...
// (u64 *)&start_vp_input->vp_context = __pa(vmsa) | 1;
    ...
    start_vp_input, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn hv_snp_hypercall(control: u64, param1: u64, param2: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn hv_tdx_msr_write(msr: u64, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn hv_tdx_msr_read(msr: u64, val: *mut u64) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_tdx_hypercall(control: u64, param1: u64, param2: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn hv_ivm_msr_write(msr: u64, value: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hv_isolation_type_snp()) -> else {
    else if (hv_isolation_type_snp())
    hv_ghcb_msr_write(msr, value);
    }
#[no_mangle]
pub unsafe extern "C" fn hv_ivm_msr_read(msr: u64, value: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn hv_list_enc_add(pfn_list: *const u64, count: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_list_enc_remove(pfn_list: *const u64, count: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_vtom_kexec_begin() {
...
#[no_mangle]
unsafe extern "C" fn hv_vtom_kexec_finish() {
...
//
#[no_mangle]
unsafe extern "C" fn hv_vtom_clear_present(kbuffer: c_ulong, pagecount: c_int, enc: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hv_vtom_set_host_visibility(kbuffer: c_ulong, pagecount: c_int, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_vtom_tlb_flush_required(private: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hv_vtom_cache_flush_required() -> bool {
    static bool hv_vtom_cache_flush_required(void)
    {
    return false;
    }
#[no_mangle]
unsafe extern "C" fn hv_is_private_mmio(addr: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hv_vtom_init() -> void __init {
    void __init hv_vtom_init(void)
    {
    let mut type: enum hv_isolation_type = hv_get_isolation_type();
    switch (type) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_get_isolation_type() -> enum hv_isolation_type {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_is_isolation_supported() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_isolation_type_snp() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_isolation_type_tdx() -> bool {
