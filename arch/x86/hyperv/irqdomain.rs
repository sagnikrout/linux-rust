...
//! Source: arch/x86/hyperv/irqdomain.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hv_unmap_interrupt(id: u64, irq_entry: *mut hv_interrupt_entry) -> c_int {
...
#[derive(Copy, Clone)]
pub struct rid_data {
    pub bridge: *mut pci_dev,
    pub rid: u32,
}

#[no_mangle]
unsafe extern "C" fn get_rid_cb(pdev: *mut pci_dev, alias: u16, data: *mut c_void) -> c_int {
    static int get_rid_cb(struct pci_dev *pdev, u16 alias, void *data)
    {
    struct rid_data *rd = data;
    let mut bus: u8 = PCI_BUS_NUM(rd.rid);
...
#[no_mangle]
unsafe extern "C" fn hv_build_devid_type_pci(pdev: *mut pci_dev) -> union hv_device_id {
    ...
    if (data.bridge == core::ptr::null_mut())
    goto out;
//
...
#[no_mangle]
unsafe extern "C" fn hv_irq_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
    ...
    pdev = msi_desc_to_pci_dev(msidesc);
    if (!cfg) {
    pr_debug("%s: cfg is core::ptr::null_mut()", __func__);
    return;
    }
    if (data.chip_data) {
//
...
#[no_mangle]
unsafe extern "C" fn hv_teardown_msi_irq(pdev: *mut pci_dev, irqd: *mut irq_data) {
...
//
    ...
    core::ptr::null_mut(), handle_edge_irq, core::ptr::null_mut(), "edge");
    }
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn hv_create_pci_msi_domain() -> *mut irq_domain  __init {
...
#[no_mangle]
pub unsafe extern "C" fn hv_unmap_ioapic_interrupt(ioapic_id: c_int, entry: *mut hv_interrupt_entry) -> c_int {
