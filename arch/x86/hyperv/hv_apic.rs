...
//! Source: arch/x86/hyperv/hv_apic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hv_apic_icr_read() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn hv_apic_icr_write(low: u32, id: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_enable_coco_interrupt(cpu: c_uint, vector: c_uint, set: bool) {
    void hv_enable_coco_interrupt(unsigned int cpu, unsigned int vector, bool set)
    {
    apic_update_vector(cpu, vector, set);
    }
#[no_mangle]
unsafe extern "C" fn hv_apic_read(reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hv_apic_write(reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn hv_apic_eoi_write() {
...
#[no_mangle]
unsafe extern "C" fn cpu_is_self(cpu: c_int) -> bool {
    static bool cpu_is_self(int cpu)
    {
    let mut cpu: return = = smp_processor_id();
    }
//
...
//
    ...
    exclude_self ? cpu_is_self : core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn __send_ipi_one(cpu: c_int, vector: c_int) -> bool {
    static bool __send_ipi_one(int cpu, int vector)
    {
    let mut vp: c_int = hv_cpu_number_to_vp_number(cpu);
    u64 status;
...
#[no_mangle]
unsafe extern "C" fn hv_send_ipi(cpu: c_int, vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hv_send_ipi_mask(mask: *const cpumask, vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hv_send_ipi_mask_allbutself(mask: *const cpumask, vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hv_send_ipi_allbutself(vector: c_int) {
    static void hv_send_ipi_allbutself(int vector)
    {
    hv_send_ipi_mask_allbutself(cpu_online_mask, vector);
    }
#[no_mangle]
unsafe extern "C" fn hv_send_ipi_all(vector: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hv_send_ipi_self(vector: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_apic_init() -> void __init {
