...
//! Source: arch/x86/hyperv/hv_vtl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hv_vtl_msi_ext_dest_id() -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn hv_vtl_emergency_restart() -> void  __noreturn {
...
//
#[no_mangle]
unsafe extern "C" fn hv_vtl_restart(cmd: *mut char __maybe_unused) -> void  __noreturn {
    static void  __noreturn hv_vtl_restart(char __maybe_unused *cmd)
    {
    hv_vtl_emergency_restart();
    }
#[no_mangle]
pub unsafe extern "C" fn within_page(addr: u64, start: u64) -> bool {
    static inline bool within_page(u64 addr, u64 start)
    {
    return addr >= start && addr < (start + PAGE_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn hv_vtl_is_private_mmio_tdx(addr: u64) -> bool {
    static bool hv_vtl_is_private_mmio_tdx(u64 addr)
    {
    let mut mb_addr: u64 = acpi_get_mp_wakeup_mailbox_paddr();
    return mb_addr && within_page(addr, mb_addr);
    }
#[no_mangle]
pub unsafe extern "C" fn hv_vtl_init_platform() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn hv_vtl_system_desc_base(desc: *mut ldttss_desc) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn hv_vtl_system_desc_limit(desc: *mut ldttss_desc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hv_vtl_ap_entry() {
    static void hv_vtl_ap_entry(void)
    {
    ((secondary_startup_64_fn)secondary_startup_64)(&boot_params, &boot_params);
    }
#[no_mangle]
unsafe extern "C" fn hv_vtl_bringup_vcpu(target_vp_index: u32, cpu: c_int, eip_ignored: u64) -> c_int {
...
// System desc (128bit), present, TSS, 0x8b - busy, 0x89 -- default
    ...
    status = hv_do_hypercall(HVCALL_ENABLE_VP_VTL, input, core::ptr::null_mut());
    ...
    status = hv_do_hypercall(HVCALL_START_VP, input, core::ptr::null_mut());
    if (!hv_result_success(status)) {
...
#[no_mangle]
unsafe extern "C" fn hv_vtl_wakeup_secondary_cpu(apicid: u32, start_eip: c_ulong, cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hv_vtl_early_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_vtl_return_call_init(vtl_return_offset: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_vtl_return_call(vtl0: *mut mshv_vtl_cpu_context) {
