...
//! Source: arch/x86/hyperv/hv_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __hv_hyperfail(control: u64, param1: u64, param2: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn volatile(STATIC_CALL_TRAMP_STR(__hv_hypercall: "call ") -> asm {
...
#[no_mangle]
pub unsafe extern "C" fn hv_set_hypercall_pg(ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hyperv_init_ghcb() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_cpu_init(cpu: c_uint) -> c_int {
    static int hv_cpu_init(unsigned int cpu)
    {
    let mut msr: union hv_vp_assist_msr_contents = { 0 };
...
#[no_mangle]
unsafe extern "C" fn hv_reenlightenment_notify(dummy: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hyperv_stop_tsc_emulation() {
...
#[no_mangle]
pub unsafe extern "C" fn hv_reenlightenment_available() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn set_hv_tscchange_cb((*cb)(void): *mut c_void) {
    ...
    let mut emu_ctrl: hv_tsc_emulation_control = {.enabled = 1};
...
#[no_mangle]
pub unsafe extern "C" fn clear_hv_tscchange_cb() {
    ...
    re_ctrl.enabled = 0;
    wrmsrq(HV_X64_MSR_REENLIGHTENMENT_CONTROL, *(u64 *)&re_ctrl);
    hv_reenlightenment_cb = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(clear_hv_tscchange_cb);
#[no_mangle]
unsafe extern "C" fn hv_cpu_die(cpu: c_uint) -> c_int {
...
//
    ...
    hv_vp_assist_page[cpu] = core::ptr::null_mut();
    rdmsrq(HV_X64_MSR_VP_ASSIST_PAGE, msr.as_uint64);
    msr.enable = 0;
    }
    wrmsrq(HV_X64_MSR_VP_ASSIST_PAGE, msr.as_uint64);
    }
    if (hv_reenlightenment_cb == core::ptr::null_mut())
    return 0;
    rdmsrq(HV_X64_MSR_REENLIGHTENMENT_CONTROL, *((u64 *)&re_ctrl));
...
#[no_mangle]
unsafe extern "C" fn hv_pci_init() -> int __init {
    static int __init hv_pci_init(void)
    {
    let mut gen2vm: bool = efi_enabled(EFI_BOOT);
//
...
#[no_mangle]
unsafe extern "C" fn hv_suspend(data: *mut c_void) -> c_int {
...
//
    ...
    hv_set_hypercall_pg(core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hv_resume(data: *mut c_void) {
...
// Re-enable the hypercall page
    ...
    hv_hypercall_pg_saved = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn hv_stimer_setup_percpu_clockev() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn hyperv_init() -> void __init {
...
//
    ...
    hv_vp_assist_page = core::ptr::null_mut();
    else
...
// A TDX VM with no paravisor only uses TDX GHCI rather than hv_hypercall_pg
    ...
    if (hv_hypercall_pg == core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn hyperv_cleanup() {
...
//
    hv_hypercall_pg = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn hyperv_report_panic(regs: *mut pt_regs, err: c_long, in_die: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_is_hyperv_initialized() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hv_apicid_to_vp_index(apic_id: u32) -> c_int {
