...
//! Source: arch/x86/boot/compressed/acpi.c
#![no_std]
...
// for termination.
//
pub const MAX_ACPI_ARG_LENGTH: c_int = 10;
//
...
#[no_mangle]
unsafe extern "C" fn efi_get_rsdp_addr() -> acpi_physical_address {
...
#[no_mangle]
unsafe extern "C" fn compute_checksum(buffer: *mut u8, length: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn bios_get_rsdp_addr() -> acpi_physical_address {
...
#[no_mangle]
pub unsafe extern "C" fn get_rsdp_addr() -> acpi_physical_address {
...
//
pub const MAX_ADDR_LEN: c_int = 19;
#[no_mangle]
unsafe extern "C" fn get_cmdline_acpi_rsdp() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn get_acpi_srat_table() -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn count_immovable_mem_regions() -> c_int {
