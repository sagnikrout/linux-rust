...
// here.
//
// Macro flag: #define BOOT_CTYPE_H
...
#[no_mangle]
unsafe extern "C" fn get_boot_seed() -> c_ulong {
...
// Macro flag: #define KASLR_COMPRESSED_BOOT

// Only supporting at most 4 unusable memmap regions with kaslr
pub const MAX_MEMMAP_REGIONS: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn mem_overlaps(one: *mut mem_vector, two: *mut mem_vector) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mem_avoid_memmap(str: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn parse_gb_huge_pages(param: *mut c_char, val: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn handle_mem_options() {
...
//
    ...
    {
    let mut init_size: c_ulong = boot_params_ptr.hdr.init_size;
...
//
    ...
    let mut earliest: u64 = img.start + img.size;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct slot_area {
    pub addr: u64,
    pub num: c_ulong,
}

pub const MAX_SLOT_AREA: c_int = 100;
    static struct slot_area slot_areas[MAX_SLOT_AREA];
    static unsigned int slot_area_index;
    static unsigned long slot_max;
#[no_mangle]
unsafe extern "C" fn store_slot_info(region: *mut mem_vector, image_size: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn slots_fetch_random() -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn memory_type_is_free(md: *mut efi_memory_desc_t) -> bool {
...
//
    ...
    let mut efi_mirror_found: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn process_kho_entries(minimum: c_ulong, image_size: c_ulong) -> bool {
