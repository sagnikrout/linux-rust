...
//! Source: arch/x86/boot/compressed/idt_64.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_idt_entry(vector: c_int, (*handler)(void): *mut c_void) {
    static void set_idt_entry(int vector, void (*handler)(void))
    {
    let mut address: c_ulong = (unsigned long)handler;
    gate_desc entry;
...
#[no_mangle]
unsafe extern "C" fn load_boot_idt(dtr: *const desc_ptr) {
...
//
    ...
    set_idt_entry(X86_TRAP_VC, core::ptr::null_mut());
