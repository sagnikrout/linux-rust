...
//! Source: arch/x86/boot/compressed/mem.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn early_is_tdx_guest() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_accept_memory(start: phys_addr_t, end: phys_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn init_unaccepted_memory() -> bool {
    bool init_unaccepted_memory(void)
    {
    let mut guid: guid_t = LINUX_EFI_UNACCEPTED_MEM_TABLE_GUID;
