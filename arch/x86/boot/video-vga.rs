...
//! Source: arch/x86/boot/video-vga.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vga_set_basic_mode() -> u8 {
...
#[no_mangle]
unsafe extern "C" fn vga_set_8font() {
...
#[no_mangle]
unsafe extern "C" fn vga_set_14font() {
...
#[no_mangle]
unsafe extern "C" fn vga_set_80x43() {
...
#[no_mangle]
pub unsafe extern "C" fn vga_crtc() -> u16 {
    u16 vga_crtc(void)
    {
    return (inb(0x3cc) & 1) ? 0x3d4 : 0x3b4;
    }
#[no_mangle]
unsafe extern "C" fn vga_set_480_scanlines() {
...
#[no_mangle]
unsafe extern "C" fn vga_set_vertical_end(lines: c_int) {
    static void vga_set_vertical_end(int lines)
    {
    u16 crtc;		/* CRTC base address */
    u8  ovfw;		/* CRTC overflow register */
    let mut end: c_int = lines-1;
    crtc = vga_crtc();
...
#[no_mangle]
unsafe extern "C" fn vga_set_80x30() {
...
#[no_mangle]
unsafe extern "C" fn vga_set_80x34() {
...
#[no_mangle]
unsafe extern "C" fn vga_set_80x60() {
...
#[no_mangle]
unsafe extern "C" fn vga_set_mode(mode: *mut mode_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vga_probe() -> c_int {
