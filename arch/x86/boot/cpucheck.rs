...
//! Source: arch/x86/boot/cpucheck.c
#![no_std]
...
//
    ...
    let mut req_level: static int = CONFIG_X86_MINIMUM_CPU_FAMILY;
...
#[no_mangle]
unsafe extern "C" fn is_amd() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_centaur() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_transmeta() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_intel() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_cpuflags() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn check_cpu(cpu_level_ptr: *mut c_int, req_level_ptr: *mut c_int, err_flags_ptr: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn check_knl_erratum() -> c_int {
