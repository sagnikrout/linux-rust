...
//! Source: arch/x86/boot/startup/map_kernel.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn check_la57_support() -> bool {
...
//
    ...
    let mut physaddr: c_ulong = (unsigned long)rip_rel_ptr(_text);
...
//
    ...
    let mut idx: c_int = i + (physaddr >> PMD_SHIFT);
