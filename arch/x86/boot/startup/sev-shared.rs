...
//! Source: arch/x86/boot/startup/sev-shared.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn get_hv_features() -> u64 __init {
...
#[no_mangle]
pub unsafe extern "C" fn svsm_process_result_codes(call: *mut svsm_call) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn svsm_issue_call(call: *mut svsm_call, pending: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn svsm_perform_msr_protocol(call: *mut svsm_call) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sev_cpuid_hv(fn: u32, reg_idx: c_int, reg: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __sev_cpuid_hv_msr(leaf: *mut cpuid_leaf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn snp_cpuid_calc_xsave_size(xfeatures_en: u64, compacted: bool) -> u32 {
    static u32 snp_cpuid_calc_xsave_size(u64 xfeatures_en, bool compacted)
    {
    const struct snp_cpuid_table *cpuid_table = snp_cpuid_get_table();
    let mut xfeatures_found: u64 = 0;
    let mut xsave_size: u32 = 0x240;
    int i;
...
#[no_mangle]
unsafe extern "C" fn snp_cpuid_hv_msr(ctx: *mut c_void, leaf: *mut cpuid_leaf) {
    ...
    {
    let mut leaf_hv: cpuid_leaf = *leaf;
    switch (leaf.fn) {
    case 0x1:
...
// Get XSS value if XSAVES is enabled.
    ...
    unsigned long lo, hi;
#[no_mangle]
pub unsafe extern "C" fn volatile((lo): "rdmsr" : "=a", (hi: "=d") -> asm {
...
//
#[no_mangle]
pub unsafe extern "C" fn do_vc_no_ghcb(regs: *mut pt_regs, exit_code: c_ulong) {
    void do_vc_no_ghcb(struct pt_regs *regs, unsigned long exit_code)
    {
    let mut subfn: c_uint = lower_bits(regs.cx, 32);
    let mut fn: c_uint = lower_bits(regs.ax, 32);
    let mut opcode: u16 = *(unsigned short *)regs.ip;
...
//
    ret = snp_cpuid(snp_cpuid_hv_msr, core::ptr::null_mut(), &leaf);
    if (!ret)
    goto cpuid_done;
    if (ret != -EOPNOTSUPP)
    goto fail;
...
// SEV leaf check
    goto fail;
#[no_mangle]
pub unsafe extern "C" fn if(BIT(1))): (fn == 0x8000001f && !(regs->ax &) -> else {
...
//
    ...
    {
    struct cc_setup_data *sd = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn setup_cpuid_table(cc_info: *const cc_blob_sev_info) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x40000000: fn->eax_in ==) -> else {
    else if (fn.eax_in == 0x40000000)
    cpuid_hyp_range_max = fn.eax;
#[no_mangle]
pub unsafe extern "C" fn if(0x80000000: fn->eax_in ==) -> else {
    else if (fn.eax_in == 0x80000000)
    cpuid_ext_range_max = fn.eax;
    }
    }
#[no_mangle]
unsafe extern "C" fn svsm_call_msr_protocol(call: *mut svsm_call) -> c_int {
