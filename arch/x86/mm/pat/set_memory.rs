...
//! Source: arch/x86/mm/pat/set_memory.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct cpa_data {
    pub vaddr: *mut c_ulong,
    pub pgd: *mut pgd_t,
    pub mask_set: pgprot_t,
    pub mask_clr: pgprot_t,
    pub numpages: c_ulong,
    pub curpage: c_ulong,
    pub pfn: c_ulong,
    pub flags: c_uint,
    unsigned int	force_split		: 1,
    force_static_prot	: 1,
    pub 1: force_flush_all :,
    pub pages: *mut page,
}
    ...
    let mut cpa_warn_level: static int = CPA_PROTECT;
//
...
pub const CPA_FLUSHTLB: c_uint = 0x01;
pub const CPA_ARRAY: c_uint = 0x02;
pub const CPA_PAGES_ARRAY: c_uint = 0x04;
pub const CPA_NO_CHECK_ALIAS: c_uint = 0x08 /* Do not search for aliases */;
pub const CPA_COLLAPSE: c_uint = 0x10 /* try to collapse large pages */;
pub const CPA_DEBUG_PAGEALLOC: c_uint = 0x20;
#[no_mangle]
pub unsafe extern "C" fn cachemode2pgprot(pcm: enum page_cache_mode) -> pgprot_t {
...
#[no_mangle]
pub unsafe extern "C" fn update_page_count(level: c_int, pages: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn split_page_count(level: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PG_LEVEL_1G: level ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn collapse_page_count(level: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn cpa_inc_1g_checked() {
    static inline void cpa_inc_1g_checked(void)
    {
    cpa_1g_checked++;
    }
#[no_mangle]
pub unsafe extern "C" fn cpa_inc_2m_checked() {
    static inline void cpa_inc_2m_checked(void)
    {
    cpa_2m_checked++;
    }
#[no_mangle]
pub unsafe extern "C" fn cpa_inc_4k_install() {
    static inline void cpa_inc_4k_install(void)
    {
    data_race(cpa_4k_install++);
    }
#[no_mangle]
pub unsafe extern "C" fn cpa_inc_lp_sameprot(level: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn cpa_inc_lp_preserved(level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpastats_show(m: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpastats_open(inode: *mut inode, file: *mut file) -> c_int {
    static int cpastats_open(struct inode *inode, struct file *file)
    {
    return single_open(file, cpastats_show, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn cpa_stats_init() -> int __init {
    static int __init cpa_stats_init(void)
    {
    debugfs_create_file("cpa_stats", S_IRUSR, arch_debugfs_dir, core::ptr::null_mut(),
    &cpastats_fops);
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn highmap_start_pfn() -> c_ulong {
    static inline unsigned long highmap_start_pfn(void)
    {
    return __pa_symbol(_text) >> PAGE_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn highmap_end_pfn() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn __cpa_pfn_in_highmap(pfn: c_ulong) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fix_addr(addr: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn __cpa_addr(cpa: *mut cpa_data, idx: c_ulong) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn clflush_cache_range_opt(vaddr: *mut c_void, size: c_uint) {
    static void clflush_cache_range_opt(void *vaddr, unsigned int size)
    {
    let mut clflush_size: c_ulong = boot_cpu_data.x86_clflush_size;
...
//
#[no_mangle]
pub unsafe extern "C" fn clflush_cache_range(vaddr: *mut c_void, size: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn __cpa_flush_all(arg: *mut c_void) {
    static void __cpa_flush_all(void *arg)
    {
    let mut cache: c_ulong = (unsigned long)arg;
//
...
#[no_mangle]
unsafe extern "C" fn cpa_flush_all(cache: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn __cpa_flush_tlb(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cpa_collapse_large_pages(cpa: *mut cpa_data) {
    static void cpa_collapse_large_pages(struct cpa_data *cpa)
    {
    unsigned long start, addr, end;
    struct ptdesc *ptdesc, *tmp;
    LIST_HEAD(pgtables);
    let mut collapsed: c_int = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn cpa_flush(cpa: *mut cpa_data, cache: c_int) {
    ...
    mb();
    for (i = 0; i < cpa.numpages; i++) {
    let mut addr: c_ulong = __cpa_addr(cpa, i);
    unsigned int level;
...
#[no_mangle]
unsafe extern "C" fn protect_pci_bios(spfn: c_ulong, epfn: c_ulong) -> pgprotval_t {
...
//
#[no_mangle]
unsafe extern "C" fn protect_rodata(spfn: c_ulong, epfn: c_ulong) -> pgprotval_t {
...
//
#[no_mangle]
unsafe extern "C" fn protect_kernel_text(start: c_ulong, end: c_ulong) -> pgprotval_t {
    static pgprotval_t protect_kernel_text(unsigned long start, unsigned long end)
    {
    let mut t_end: c_ulong = (unsigned long)_etext - 1;
    let mut t_start: c_ulong = (unsigned long)_text;
...
//
    ...
    unsigned long end)
    {
    let mut t_end: c_ulong = (unsigned long)__end_rodata_hpage_align - 1;
    let mut t_start: c_ulong = (unsigned long)_text;
    unsigned int level;
...
#[no_mangle]
pub unsafe extern "C" fn conflicts(prot: pgprot_t, val: pgprotval_t) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn slow_virt_to_phys(__virt_addr: *mut c_void) -> phys_addr_t {
    phys_addr_t slow_virt_to_phys(void *__virt_addr)
    {
    let mut virt_addr: c_ulong = (unsigned long)__virt_addr;
...
//
#[no_mangle]
unsafe extern "C" fn __set_pmd_pte(kpte: *mut pte_t, address: c_ulong, pte: pte_t) {
...
#[no_mangle]
unsafe extern "C" fn pgprot_clear_protnone_bits(prot: pgprot_t) -> pgprot_t {
...
// All checks passed. Update the large page mapping.
    ...
    unsigned long size)
    {
    let mut npg: c_uint = PFN_DOWN(size);
    pgprot_t prot;
//
...
//
    ...
    let mut pfn: c_ulong = PFN_DOWN(__pa(address));
...
//
#[no_mangle]
unsafe extern "C" fn collapse_large_pages(addr: c_ulong, pgtables: *mut list_head) -> c_int {
    static int collapse_large_pages(unsigned long addr, struct list_head *pgtables)
    {
    int collapsed;
    pgd_t *pgd;
...
#[no_mangle]
unsafe extern "C" fn try_to_free_pte_page(pte: *mut pte_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn try_to_free_pmd_page(pmd: *mut pmd_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unmap_pte_range(pmd: *mut pmd_t, start: c_ulong, end: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unmap_pmd_range(pud: *mut pud_t, start: c_ulong, end: c_ulong) {
...
//
    if (start & (PMD_SIZE - 1)) {
    let mut next_page: c_ulong = (start + PMD_SIZE) & PMD_MASK;
    let mut pre_end: c_ulong = min_t(unsigned long, end, next_page);
...
#[no_mangle]
unsafe extern "C" fn unmap_pud_range(p4d: *mut p4d_t, start: c_ulong, end: c_ulong) {
...
//
    if (start & (PUD_SIZE - 1)) {
    let mut next_page: c_ulong = (start + PUD_SIZE) & PUD_MASK;
    let mut pre_end: c_ulong = min_t(unsigned long, end, next_page);
...
#[no_mangle]
unsafe extern "C" fn alloc_pte_page(pmd: *mut pmd_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alloc_pmd_page(pud: *mut pud_t) -> c_int {
...
//
    if (start & (PMD_SIZE - 1)) {
    let mut pre_end: c_ulong = start + (num_pages << PAGE_SHIFT);
    let mut next_page: c_ulong = (start + PMD_SIZE) & PMD_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn populate_pgd(cpa: *mut cpa_data, addr: c_ulong) -> c_int {
    static int populate_pgd(struct cpa_data *cpa, unsigned long addr)
    {
    let mut pgprot: pgprot_t = __pgprot(_KERNPG_TABLE);
    pud_t *pud = core::ptr::null_mut();	/* shut up gcc */
    p4d_t *p4d;
    pgd_t *pgd_entry;
    long ret;
...
#[no_mangle]
unsafe extern "C" fn __change_page_attr(cpa: *mut cpa_data, primary: c_int) -> c_int {
    ...
    pte_t new_pte;
    let mut old_prot: pgprot_t = pte_pgprot(old_pte);
    let mut new_prot: pgprot_t = pte_pgprot(old_pte);
    let mut pfn: c_ulong = pte_pfn(old_pte);
...
//
#[no_mangle]
unsafe extern "C" fn cpa_process_alias(cpa: *mut cpa_data) -> c_int {
    static int cpa_process_alias(struct cpa_data *cpa)
    {
    struct cpa_data alias_cpa;
    let mut laddr: c_ulong = (unsigned long)__va(cpa.pfn << PAGE_SHIFT);
    unsigned long vaddr;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn __change_page_attr_set_clr(cpa: *mut cpa_data, primary: c_int) -> c_int {
    static int __change_page_attr_set_clr(struct cpa_data *cpa, int primary)
    {
    let mut numpages: c_ulong = cpa.numpages;
    let mut rempages: c_ulong = numpages;
...
//
    ...
    (array ? CPA_ARRAY : 0), core::ptr::null_mut());
    }
    ...
    pgprot_t mask)
    {
    return change_page_attr_set_clr(core::ptr::null_mut(), numpages, mask, __pgprot(0), 0,
    CPA_PAGES_ARRAY, pages);
    }
    static inline int cpa_clear_pages_array(struct page **pages, int numpages,
    pgprot_t mask)
    {
    return change_page_attr_set_clr(core::ptr::null_mut(), numpages, __pgprot(0), mask, 0,
    CPA_PAGES_ARRAY, pages);
    }
#[no_mangle]
pub unsafe extern "C" fn _set_memory_uc(addr: c_ulong, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_memory_uc(addr: c_ulong, numpages: c_int) -> c_int {
...
//
    ...
    _PAGE_CACHE_MODE_UC_MINUS, core::ptr::null_mut());
    if (ret)
    goto out_err;
...
#[no_mangle]
pub unsafe extern "C" fn _set_memory_wc(addr: c_ulong, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_memory_wc(addr: c_ulong, numpages: c_int) -> c_int {
    int set_memory_wc(unsigned long addr, int numpages)
    {
    int ret;
    ret = memtype_reserve(__pa(addr), __pa(addr) + numpages * PAGE_SIZE,
    _PAGE_CACHE_MODE_WC, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn _set_memory_wt(addr: c_ulong, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn _set_memory_wb(addr: c_ulong, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_memory_wb(addr: c_ulong, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_mce_nospec(pfn: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn clear_mce_nospec(pfn: c_ulong) -> c_int {
    int clear_mce_nospec(unsigned long pfn)
    {
    let mut addr: c_ulong = (unsigned long) pfn_to_kaddr(pfn);
...
#[no_mangle]
pub unsafe extern "C" fn set_memory_rox(addr: c_ulong, numpages: c_int) -> c_int {
    int set_memory_rox(unsigned long addr, int numpages)
    {
    let mut clr: pgprot_t = __pgprot(_PAGE_RW | _PAGE_DIRTY);
    if (__supported_pte_mask & _PAGE_NX)
    clr.pgprot |= _PAGE_NX;
    return change_page_attr_set_clr(&addr, numpages, __pgprot(0), clr, 0,
    CPA_COLLAPSE, core::ptr::null_mut());
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn set_memory_np(addr: c_ulong, numpages: c_int) -> c_int {
    int set_memory_np(unsigned long addr, int numpages)
    {
    return change_page_attr_clear(&addr, numpages, __pgprot(_PAGE_PRESENT), 0);
    }
#[no_mangle]
pub unsafe extern "C" fn set_memory_np_noalias(addr: c_ulong, numpages: c_int) -> c_int {
    int set_memory_np_noalias(unsigned long addr, int numpages)
    {
    return change_page_attr_set_clr(&addr, numpages, __pgprot(0),
    __pgprot(_PAGE_PRESENT), 0,
    CPA_NO_CHECK_ALIAS, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn set_memory_p(addr: c_ulong, numpages: c_int) -> c_int {
    int set_memory_p(unsigned long addr, int numpages)
    {
    return change_page_attr_set(&addr, numpages, __pgprot(_PAGE_PRESENT), 0);
    }
#[no_mangle]
pub unsafe extern "C" fn set_memory_4k(addr: c_ulong, numpages: c_int) -> c_int {
    int set_memory_4k(unsigned long addr, int numpages)
    {
    return change_page_attr_set_clr(&addr, numpages,
    __pgprot(_PAGE_KERNEL_4K),
    __pgprot(0), 1, 0, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn set_memory_nonglobal(addr: c_ulong, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_memory_global(addr: c_ulong, numpages: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __set_memory_enc_pgtable(addr: c_ulong, numpages: c_int, enc: bool) -> c_int {
    static int __set_memory_enc_pgtable(unsigned long addr, int numpages, bool enc)
    {
    let mut empty: pgprot_t = __pgprot(0);
    struct cpa_data cpa;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn set_memory_enc_stop_conversion() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __set_memory_enc_dec(addr: c_ulong, numpages: c_int, enc: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_pages_uc(page: *mut page, numpages: c_int) -> c_int {
    ...
    if (memtype_reserve(start, end, new_type, core::ptr::null_mut()))
    goto err_out;
    }
// If WC, set to UC- first and then WC
    ...
    ret = change_page_attr_set_clr(core::ptr::null_mut(), numpages,
    cachemode2pgprot(
    _PAGE_CACHE_MODE_WC),
    __pgprot(_PAGE_CACHE_MASK),
...
#[no_mangle]
pub unsafe extern "C" fn set_pages_array_uc(pages: *mut page, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_pages_array_wc(pages: *mut page, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_pages_wb(page: *mut page, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_pages_array_wb(pages: *mut page, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_pages_ro(page: *mut page, numpages: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_pages_rw(page: *mut page, numpages: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __set_pages_p(page: *mut page, numpages: c_int, cpa_flags: c_uint) -> c_int {
    static int __set_pages_p(struct page *page, int numpages, unsigned int cpa_flags)
    {
    let mut tempaddr: c_ulong = (unsigned long) page_address(page);
...
#[no_mangle]
unsafe extern "C" fn __set_pages_np(page: *mut page, numpages: c_int, cpa_flags: c_uint) -> c_int {
