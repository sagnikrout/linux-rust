...
//! Source: arch/x86/mm/ident_map.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn free_pte(info: *mut x86_mapping_info, pmd: *mut pmd_t) {
...
#[no_mangle]
unsafe extern "C" fn free_pmd(info: *mut x86_mapping_info, pud: *mut pud_t) {
...
#[no_mangle]
unsafe extern "C" fn free_pud(info: *mut x86_mapping_info, p4d: *mut p4d_t) {
...
#[no_mangle]
unsafe extern "C" fn free_p4d(info: *mut x86_mapping_info, pgd: *mut pgd_t) {
...
// Never overwrite existing mappings
    ...
    {
    let mut addr: c_ulong = pstart + info.offset;
    let mut end: c_ulong = pend + info.offset;
    unsigned long next;
    int result;
