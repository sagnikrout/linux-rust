...
// Common code for 32 and 64-bit NUMA
    ...
    int numa_off;
#[no_mangle]
unsafe extern "C" fn numa_setup(opt: *mut c_char) -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn numa_cpu_node(cpu: c_int) -> c_int {
    int numa_cpu_node(int cpu)
    {
    let mut apicid: u32 = early_per_cpu(x86_cpu_to_apicid, cpu);
    if (apicid != BAD_APICID)
    return __apicid_to_node[apicid];
    return NUMA_NO_NODE;
    }
#[no_mangle]
pub unsafe extern "C" fn num_phys_nodes() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn numa_set_node(cpu: c_int, node: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn numa_clear_node(cpu: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn setup_node_to_cpumask_map() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn numa_init_array() -> void __init {
...
unsafe extern "C" fn numa_init((*init_func)(void): *mut c_int) -> int __init {
    ...
    return ret;
    for (i = 0; i < nr_cpu_ids; i++) {
    let mut nid: c_int = early_cpu_to_node(i);
    if (nid == NUMA_NO_NODE)
    continue;
    if (!node_online(nid))
    numa_clear_node(i);
...
//
#[no_mangle]
pub unsafe extern "C" fn x86_numa_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn init_gi_nodes() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn init_cpu_to_node() -> void __init {
    void __init init_cpu_to_node(void)
    {
    int cpu;
    u32 *cpu_to_apicid = early_per_cpu_ptr(x86_cpu_to_apicid);
    BUG_ON(cpu_to_apicid == core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn __cpu_to_node(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn numa_set_cpumask(cpu: c_int, enable: bool) {
