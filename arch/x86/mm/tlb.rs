...
//
pub const LAST_USER_MM_IBPB: c_uint = 0x1UL;
pub const LAST_USER_MM_L1D_FLUSH: c_uint = 0x2UL;
...
//
#[no_mangle]
pub unsafe extern "C" fn kern_pcid(asid: u16) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn user_pcid(asid: u16) -> u16 {
    static inline u16 user_pcid(u16 asid)
    {
    let mut ret: u16 = kern_pcid(asid);
...
#[no_mangle]
pub unsafe extern "C" fn build_cr3(pgd: *mut pgd_t, asid: u16, lam: c_ulong) -> c_ulong {
    static inline unsigned long build_cr3(pgd_t *pgd, u16 asid, unsigned long lam)
    {
    let mut cr3: c_ulong = __sme_pa(pgd) | lam;
...
//
#[no_mangle]
unsafe extern "C" fn clear_asid_other() {
...
//
    ...
    let mut last_mm_ctx_id: core::sync::atomic::AtomicI64 = ATOMIC64_INIT(1);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct new_asid {
    pub 16: unsigned int asid :,
    pub 1: unsigned int need_flush :,
}

#[no_mangle]
unsafe extern "C" fn choose_new_asid(next: *mut mm_struct, next_tlb_gen: u64) -> new_asid {
...
//
    ...
    let mut global_asid: u16 = mm_global_asid(next);
    if (global_asid) {
    ns.asid = global_asid;
    ns.need_flush = 0;
    return ns;
...
//
    ...
    let mut last_global_asid: static u16 = MAX_ASID_AVAILABLE;
    static DECLARE_BITMAP(global_asid_used, MAX_ASID_AVAILABLE);
    static DECLARE_BITMAP(global_asid_freed, MAX_ASID_AVAILABLE);
    let mut global_asid_available: static int = MAX_ASID_AVAILABLE - TLB_NR_DYN_ASIDS - 1;
//
...
//
#[no_mangle]
unsafe extern "C" fn reset_global_asid_space() {
...
#[no_mangle]
unsafe extern "C" fn allocate_global_asid() -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn mm_active_cpus_exceeds(mm: *mut mm_struct, threshold: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn use_global_asid(mm: *mut mm_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mm_free_global_asid(mm: *mut mm_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn mm_needs_global_asid(mm: *mut mm_struct, asid: u16) -> bool {
    static bool mm_needs_global_asid(struct mm_struct *mm, u16 asid)
    {
    let mut global_asid: u16 = mm_global_asid(mm);
    if (!cpu_feature_enabled(X86_FEATURE_INVLPGB))
    return false;
...
//
#[no_mangle]
unsafe extern "C" fn consider_global_asid(mm: *mut mm_struct) {
...
#[no_mangle]
unsafe extern "C" fn finish_asid_transition(info: *mut flush_tlb_info) {
    static void finish_asid_transition(struct flush_tlb_info *info)
    {
    struct mm_struct *mm = info.mm;
    let mut bc_asid: c_int = mm_global_asid(mm);
    int cpu;
...
#[no_mangle]
unsafe extern "C" fn broadcast_tlb_flush(info: *mut flush_tlb_info) {
    static void broadcast_tlb_flush(struct flush_tlb_info *info)
    {
    let mut pmd: bool = info.stride_shift == PMD_SHIFT;
    let mut asid: c_ulong = mm_global_asid(info.mm);
    let mut addr: c_ulong = info.start;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn invalidate_user_asid(asid: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn leave_mm() {
    void leave_mm(void)
    {
...
// Warn if we're not lazy.
    ...
    switch_mm(core::ptr::null_mut(), &init_mm, core::ptr::null_mut());
    }
    ...
    switch_mm_irqs_off(core::ptr::null_mut(), next, tsk);
...
//
#[no_mangle]
unsafe extern "C" fn l1d_flush_force_sigbus(ch: *mut callback_head) {
...
#[no_mangle]
unsafe extern "C" fn mm_mangle_tif_spec_bits(next: *mut task_struct) -> c_ulong {
    static unsigned long mm_mangle_tif_spec_bits(struct task_struct *next)
    {
    let mut next_tif: c_ulong = read_task_thread_flags(next);
    let mut spec_bits: c_ulong = (next_tif >> TIF_SPEC_IB) & LAST_USER_MM_SPEC_MASK;
//
...
#[no_mangle]
unsafe extern "C" fn cond_mitigation(next: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn cr4_update_pce_mm(mm: *mut mm_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn cr4_update_pce(ignored: *mut c_void) {
...
//
    ...
    let mut prev_asid: u16 = this_cpu_read(cpu_tlbstate.loaded_mm_asid);
    let mut was_lazy: bool = this_cpu_read(cpu_tlbstate_shared.is_lazy);
    let mut cpu: unsigned = smp_processor_id();
...
//
    ...
    switch_mm_irqs_off(core::ptr::null_mut(), temp_mm, current);
//
...
#[no_mangle]
pub unsafe extern "C" fn unuse_temporary_mm(prev_mm: *mut mm_struct) {
...
// Clear the cpumask, to indicate no TLB flushing is needed anywhere
    ...
    switch_mm_irqs_off(core::ptr::null_mut(), prev_mm, current);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn initialize_tlbstate_and_flush() {
    void initialize_tlbstate_and_flush(void)
    {
    int i;
    struct mm_struct *mm = this_cpu_read(cpu_tlbstate.loaded_mm);
    let mut tlb_gen: u64 = atomic64_read(&init_mm.context.tlb_gen);
    let mut lam: c_ulong = mm_lam_cr3_mask(mm);
    let mut cr3: c_ulong = __read_cr3();
...
//
#[no_mangle]
unsafe extern "C" fn flush_tlb_func(info: *mut c_void) {
...
//
    ...
    struct mm_struct *loaded_mm = this_cpu_read(cpu_tlbstate.loaded_mm);
    let mut loaded_mm_asid: u32 = this_cpu_read(cpu_tlbstate.loaded_mm_asid);
    u64 local_tlb_gen;
    let mut local: bool = smp_processor_id() == f.initiating_cpu;
    let mut nr_invalidate: c_ulong = 0;
    u64 mm_tlb_gen;
...
// Reload the ASID if transitioning into or out of a global ASID
    ...
    switch_mm_irqs_off(core::ptr::null_mut(), loaded_mm, core::ptr::null_mut());
...
//
    switch_mm_irqs_off(core::ptr::null_mut(), &init_mm, core::ptr::null_mut());
    return;
    }
...
// Partial flush must have valid mm
    VM_WARN_ON(f.mm == core::ptr::null_mut());
...
// Tracing is done in a unified manner to reduce the code size
    ...
    (f.mm == core::ptr::null_mut()) ? TLB_LOCAL_SHOOTDOWN :
    TLB_LOCAL_MM_SHOOTDOWN,
    nr_invalidate);
    }
#[no_mangle]
unsafe extern "C" fn should_flush_tlb(cpu: c_int, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn should_trim_cpumask(mm: *mut mm_struct) -> bool {
...
//
    let mut __read_mostly: unsigned long tlb_single_page_flush_ceiling = 33;
...
//
    ...
    let mut remote_flush: bool = false;
...
#[no_mangle]
unsafe extern "C" fn do_flush_tlb_all(info: *mut c_void) {
...
// Fall back to the IPI-based invalidation.
    on_each_cpu(do_flush_tlb_all, core::ptr::null_mut(), 1);
    }
// Flush an arbitrarily large range of memory with INVLPGB.
#[no_mangle]
unsafe extern "C" fn invlpgb_kernel_range_flush(info: *mut flush_tlb_info) {
...
#[no_mangle]
unsafe extern "C" fn do_kernel_range_flush(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kernel_tlb_flush_all(info: *mut flush_tlb_info) {
...
#[no_mangle]
unsafe extern "C" fn kernel_tlb_flush_range(info: *mut flush_tlb_info) {
...
pub unsafe extern "C" fn flush_tlb_kernel_range(start: c_ulong, end: c_ulong) {
    ...
    struct flush_tlb_info info;
    guard(preempt)();
    init_flush_tlb_info(&info, core::ptr::null_mut(), start, end, PAGE_SHIFT, false,
...
//
#[no_mangle]
pub unsafe extern "C" fn __get_current_cr3_fast() -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn flush_tlb_one_kernel(addr: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn native_flush_tlb_one_user(addr: c_ulong) -> STATIC_NOPV void {
...
#[no_mangle]
pub unsafe extern "C" fn flush_tlb_one_user(addr: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn native_flush_tlb_global() -> STATIC_NOPV void {
...
//
#[no_mangle]
pub unsafe extern "C" fn native_flush_tlb_local() -> STATIC_NOPV void {
...
#[no_mangle]
pub unsafe extern "C" fn flush_tlb_local() {
...
//
#[no_mangle]
pub unsafe extern "C" fn __flush_tlb_all() {
...
pub unsafe extern "C" fn arch_tlbbatch_flush(batch: *mut arch_tlbflush_unmap_batch) {
    ...
    let mut remote_flush: bool = false;
    let mut cpu: c_int = get_cpu();
    init_flush_tlb_info(&info, core::ptr::null_mut(), 0, TLB_FLUSH_ALL, 0, false,
    TLB_GENERATION_INVALID);
//
// flush_tlb_multi() is not optimized for the common case in which only
// a local TLB flush is needed. Optimize this use-case by calling
...
//
#[no_mangle]
pub unsafe extern "C" fn nmi_uaccess_okay() -> bool {
...
unsafe extern "C" fn create_tlb_single_page_flush_ceiling() -> int __init {
    ...
    arch_debugfs_dir, core::ptr::null_mut(), &fops_tlbflush);
    return 0;
    }
