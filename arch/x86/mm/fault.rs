...
//
    ...
    {
    let mut instr_hi: c_uchar = opcode & 0xf0;
    let mut instr_lo: c_uchar = opcode & 0x0f;
    switch (instr_hi) {
    case 0x20:
    case 0x30:
//
...
#[no_mangle]
unsafe extern "C" fn is_amd_k8_pre_npt() -> bool {
...
//
    ...
    {
    let mut index: unsigned = pgd_index(address);
    pgd_t *pgd_k;
    p4d_t *p4d, *p4d_k;
    pud_t *pud, *pud_k;
    pmd_t *pmd, *pmd_k;
...
//
#[no_mangle]
unsafe extern "C" fn vmalloc_fault(address: c_ulong) -> noinline int {
...
#[no_mangle]
unsafe extern "C" fn low_pfn(pfn: c_ulong) -> bool {
    static bool low_pfn(unsigned long pfn)
    {
    return pfn < max_low_pfn;
    }
#[no_mangle]
unsafe extern "C" fn dump_pagetable(address: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn bad_address(p: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn is_errata93(regs: *mut pt_regs, address: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn is_errata100(regs: *mut pt_regs, address: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_ldttss(gdt: *const desc_ptr, name: *const c_char, index: u16) {
    static void show_ldttss(const struct desc_ptr *gdt, const char *name, u16 index)
    {
    let mut offset: u32 = (index >> 3) * sizeof(struct desc_struct);
    unsigned long addr;
    struct ldttss_desc desc;
    if (index == 0) {
    pr_alert("%s: core::ptr::null_mut()\n", name);
    return;
    }
    ...
    pr_alert("BUG: kernel core::ptr::null_mut() pointer dereference, address: %px\n",
    (void *)address);
    else
...
#[no_mangle]
unsafe extern "C" fn spurious_kernel_fault_check(error_code: c_ulong, pte: *mut pte_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fault_in_kernel_space(address: c_ulong) -> bool {
...
//
    ...
    bad_area_access_error(regs, error_code, address, core::ptr::null_mut(), vma);
