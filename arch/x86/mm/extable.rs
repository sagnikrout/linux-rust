...
// SPDX-License-Identifier: GPL-2.0-only
    ...
    {
    let mut reg_offset: c_int = pt_regs_offset(regs, nr);
...
//
    ...
    {
    struct insn insn;
    let mut mask: c_ulong = sizeof(long) - 1;
...
//
#[no_mangle]
unsafe extern "C" fn gp_fault_address_ok(fault_address: c_ulong) -> bool {
...
// pt_regs_nr(regs, reg) = (long)imm;
    ...
    let mut ss: c_ushort = uregs.ss;
    let mut cs: c_ushort = uregs.cs;
//
...
#[no_mangle]
pub unsafe extern "C" fn ex_get_fixup_type(ip: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn early_fixup_exception(regs: *mut pt_regs, trapnr: c_int) -> void __init {
