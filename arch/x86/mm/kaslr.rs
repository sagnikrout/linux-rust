...
pub const TB_SHIFT: c_int = 40;
//
// The end address could depend on more configuration options to make the
// highest amount of space for randomization available, but that's too hard
// to keep straight and caused issues already.
//
    let mut vaddr_end: static unsigned long = CPU_ENTRY_AREA_BASE;
//
...
#[no_mangle]
pub unsafe extern "C" fn get_padding(region: *mut kaslr_memory_region) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn kernel_randomize_memory() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn init_trampoline_kaslr() -> void __meminit {
