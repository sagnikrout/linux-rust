...
//! Source: arch/x86/mm/mem_encrypt_amd.c
#![no_std]
...
//
    ...
    {
    let mut npages: c_ulong = PAGE_ALIGN(sz) >> PAGE_SHIFT;
    if (decrypt) {
//
...
#[no_mangle]
pub unsafe extern "C" fn sme_early_encrypt(paddr: resource_size_t, size: c_ulong) -> void __init {
    void __init sme_early_encrypt(resource_size_t paddr, unsigned long size)
    {
    __sme_early_enc_dec(paddr, size, true);
    }
#[no_mangle]
pub unsafe extern "C" fn sme_early_decrypt(paddr: resource_size_t, size: c_ulong) -> void __init {
    ...
    bool map)
    {
    let mut paddr: c_ulong = (unsigned long)vaddr - __PAGE_OFFSET;
...
#[no_mangle]
pub unsafe extern "C" fn sme_unmap_bootdata(real_mode_data: *mut c_char) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn sme_map_bootdata(real_mode_data: *mut c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pg_level_to_pfn(level: c_int, kpte: *mut pte_t, ret_prot: *mut pgprot_t) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn amd_enc_tlb_flush_required(enc: bool) -> bool {
    static bool amd_enc_tlb_flush_required(bool enc)
    {
    return true;
    }
#[no_mangle]
unsafe extern "C" fn amd_enc_cache_flush_required() -> bool {
    static bool amd_enc_cache_flush_required(void)
    {
    return !cpu_feature_enabled(X86_FEATURE_SME_COHERENT);
    }
#[no_mangle]
unsafe extern "C" fn enc_dec_hypercall(vaddr: c_ulong, size: c_ulong, enc: bool) {
    static void enc_dec_hypercall(unsigned long vaddr, unsigned long size, bool enc)
    {

    let mut vaddr_end: c_ulong = vaddr + size;
    ...
    pfn = pg_level_to_pfn(level, kpte, core::ptr::null_mut());
    if (!pfn)
    continue;
...
#[no_mangle]
unsafe extern "C" fn amd_enc_status_change_prepare(vaddr: c_ulong, npages: c_int, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_enc_status_change_finish(vaddr: c_ulong, npages: c_int, enc: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn prepare_pte_enc(d: *mut pte_enc_desc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_pte_enc_mask(kpte: *mut pte_t, pfn: c_ulong, new_prot: pgprot_t) {
...
#[no_mangle]
unsafe extern "C" fn __set_clr_pte_enc(kpte: *mut pte_t, level: c_int, enc: bool) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn early_set_memory_decrypted(vaddr: c_ulong, size: c_ulong) -> int __init {
    int __init early_set_memory_decrypted(unsigned long vaddr, unsigned long size)
    {
    return early_set_memory_enc_dec(vaddr, size, false);
    }
#[no_mangle]
pub unsafe extern "C" fn early_set_memory_encrypted(vaddr: c_ulong, size: c_ulong) -> int __init {
    int __init early_set_memory_encrypted(unsigned long vaddr, unsigned long size)
    {
    return early_set_memory_enc_dec(vaddr, size, true);
    }
#[no_mangle]
pub unsafe extern "C" fn early_set_mem_enc_dec_hypercall(vaddr: c_ulong, size: c_ulong, enc: bool) -> void __init {
    void __init early_set_mem_enc_dec_hypercall(unsigned long vaddr, unsigned long size, bool enc)
    {
    enc_dec_hypercall(vaddr, size, enc);
    }
#[no_mangle]
pub unsafe extern "C" fn sme_early_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn mem_encrypt_free_decrypted_mem() -> void __init {
