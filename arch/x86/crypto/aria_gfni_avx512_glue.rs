...
//! Source: arch/x86/crypto/aria_gfni_avx512_glue.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aria_avx512_request_ctx {
    pub keystream: [u8; ARIA_GFNI_AVX512_PARALLEL_BLOCK_SIZE],
}
...
#[no_mangle]
unsafe extern "C" fn aria_avx512_ecb_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aria_avx512_ecb_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aria_avx512_ctr_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aria_avx512_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aria_avx512_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aria_avx512_exit() -> void __exit {
