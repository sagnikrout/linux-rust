...
//! Source: arch/x86/crypto/aria_aesni_avx2_glue.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aria_avx2_ecb_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aria_avx2_ecb_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aria_avx2_ctr_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aria_avx2_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aria_avx2_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aria_avx2_exit() -> void __exit {
