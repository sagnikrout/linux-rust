...
//! Source: arch/x86/crypto/serpent_avx2_glue.c
#![no_std]
...
pub const SERPENT_AVX2_PARALLEL_BLOCKS: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn serpent_avx2_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn serpent_avx2_fini() -> void __exit {
