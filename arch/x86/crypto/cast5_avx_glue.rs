...
//! Source: arch/x86/crypto/cast5_avx_glue.c
#![no_std]
...
pub const CAST5_PARALLEL_BLOCKS: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn cast5_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cast5_exit() -> void __exit {
