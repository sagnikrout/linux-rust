...
//! Source: arch/x86/crypto/cast6_avx_glue.c
#![no_std]
...
pub const CAST6_PARALLEL_BLOCKS: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn cast6_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cast6_exit() -> void __exit {
