...
//! Source: arch/x86/crypto/aesni-intel_glue.c
#![no_std]
...
pub const AESNI_ALIGN: c_int = 16;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aesni_xts_ctx {
    pub AESNI_ALIGN_ATTR: crypto_aes_ctx tweak_ctx,
    pub AESNI_ALIGN_ATTR: crypto_aes_ctx crypt_ctx,
}
...
#[no_mangle]
unsafe extern "C" fn ctr_crypt_aesni(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xts_encrypt_aesni(req: *mut skcipher_request) -> c_int {
    static int xts_encrypt_aesni(struct skcipher_request *req)
    {
    return xts_crypt(req, aesni_xts_encrypt_iv, aesni_xts_encrypt);
    }
#[no_mangle]
unsafe extern "C" fn xts_decrypt_aesni(req: *mut skcipher_request) -> c_int {
...
//
    pub __aligned(16): u64 h_powers_xored[8],
//
// H^1 times x^64 (and also the usual extra factor of x^-1).  16-byte
// alignment is required by the assembly code.
//
    pub __aligned(16): u64 h_times_x64[2],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aes_gcm_key_vaes_avx2 {
//
...
//
    pub __aligned(32): u64 h_powers[8][2],
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aes_gcm_key_vaes_avx512 {
//
// Common part of the key.  The assembly code prefers 16-byte alignment
// for this.
//
...
//
    pub __aligned(64): u64 h_powers[16][2],
...
#[no_mangle]
pub unsafe extern "C" fn if(FLAG_VAES_AVX2: flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn aes_gcm_precompute(key: *mut aes_gcm_key, flags: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(FLAG_AVX: flags &) -> else {
...
//
    ...
    &walk, assoclen);
    let mut len_this_step: c_uint = orig_len_this_step;
    unsigned int len;
...
// Store the computed auth tag in the dst scatterlist.
    ...
    let mut datalen: c_uint = req.cryptlen - taglen;
    u8 tag[16];
...
#[no_mangle]
unsafe extern "C" fn register_avx_algs() -> int __init {
...
//
    ...
    XFEATURE_MASK_AVX512, core::ptr::null_mut()))
    return 0;
...
#[no_mangle]
unsafe extern "C" fn unregister_avx_algs() {
...
unsafe extern "C" fn unregister_avx_algs() {
    ...
    X86_MATCH_FEATURE(X86_FEATURE_AES, core::ptr::null_mut()),
    {}
    };
    MODULE_DEVICE_TABLE(x86cpu, aesni_cpu_id);
#[no_mangle]
unsafe extern "C" fn aesni_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aesni_exit() -> void __exit {
