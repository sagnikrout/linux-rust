...
//! Source: arch/x86/xen/enlighten_pvh.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn xen_pvh_setup_gsi(gsi: c_int, trigger: c_int, polarity: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pvh_reserve_extra_memory() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pvh_arch_setup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn xen_pvh_init(boot_params: *mut boot_params) -> void __init {
    ...
    let mut ret: c_int = HYPERVISOR_platform_op(&op);
    if (ret > 0)
...
#[no_mangle]
pub unsafe extern "C" fn mem_map_via_hcall(boot_params_p: *mut boot_params) -> void __init {
