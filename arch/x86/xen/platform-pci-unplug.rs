...
//! Source: arch/x86/xen/platform-pci-unplug.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_platform_magic() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __xen_has_pv_device(state: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn parse_xen_emul_unplug(arg: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(p, _arg: "ide-disks", _arg: l)) -> else {
    else if (!strncmp(p, "ide-disks", l))
    xen_emul_unplug |= XEN_UNPLUG_ALL_IDE_DISKS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(p, _arg: "aux-ide-disks", _arg: l)) -> else {
    else if (!strncmp(p, "aux-ide-disks", l))
    xen_emul_unplug |= XEN_UNPLUG_AUX_IDE_DISKS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(p, _arg: "nics", _arg: l)) -> else {
    else if (!strncmp(p, "nics", l))
    xen_emul_unplug |= XEN_UNPLUG_ALL_NICS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(p, _arg: "unnecessary", _arg: l)) -> else {
    else if (!strncmp(p, "unnecessary", l))
    xen_emul_unplug |= XEN_UNPLUG_UNNECESSARY;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(p, _arg: "never", _arg: l)) -> else {
