...
#[no_mangle]
pub unsafe extern "C" fn p2m_top_index(pfn: c_ulong) -> unsigned {
...
#[no_mangle]
pub unsafe extern "C" fn p2m_mid_index(pfn: c_ulong) -> unsigned {
    static inline unsigned p2m_mid_index(unsigned long pfn)
    {
    return (pfn / P2M_PER_PAGE) % P2M_MID_PER_PAGE;
    }
#[no_mangle]
unsafe extern "C" fn p2m_top_mfn_init(top: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn p2m_top_mfn_p_init(top: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn p2m_mid_mfn_init(mid: *mut c_ulong, leaf: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn p2m_init(p2m: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn p2m_init_identity(p2m: *mut c_ulong, pfn: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn alloc_p2m_page() -> *mut void  __ref {
...
#[no_mangle]
unsafe extern "C" fn free_p2m_page(p: *mut c_void) -> void __ref {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_build_mfn_list_list() -> void __ref {
...
// Pre-initialize p2m_top_mfn to be completely missing
    if (p2m_top_mfn == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn xen_setup_mfn_list_list() {
...
#[no_mangle]
pub unsafe extern "C" fn xen_build_dynamic_phys_to_machine() -> void __init {
...
pub const P2M_TYPE_IDENTITY: c_int = 0;
pub const P2M_TYPE_MISSING: c_int = 1;
pub const P2M_TYPE_PFN: c_int = 2;
pub const P2M_TYPE_UNKNOWN: c_int = 3;
#[no_mangle]
unsafe extern "C" fn xen_p2m_elem_type(pfn: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xen_rebuild_p2m_list(p2m: *mut c_ulong) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn xen_vmalloc_p2m_tree() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn get_phys_to_machine(pfn: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_alloc_p2m_entry(pfn: c_ulong) -> c_int {
    ...
    unsigned int level;
    unsigned long flags;
    let mut addr: c_ulong = (unsigned long)(xen_p2m_addr + pfn);
...
#[no_mangle]
pub unsafe extern "C" fn __set_phys_to_machine(pfn: c_ulong, mfn: c_ulong) -> bool {
...
// Only invalid entries allowed above the highest p2m covered frame.
    if (unlikely(pfn >= xen_p2m_size))
    let mut mfn: return = = INVALID_P2M_ENTRY;
//
...
//
    ...
    let mut mfn: return = = INVALID_P2M_ENTRY;
    if (pte_pfn(*ptep) == PFN_DOWN(__pa(p2m_identity)))
    let mut mfn: return = = IDENTITY_FRAME(pfn);
    return false;
    }
#[no_mangle]
pub unsafe extern "C" fn set_phys_to_machine(pfn: c_ulong, mfn: c_ulong) -> bool {
...
//
    ...
    return 0;
    for (i = 0; i < count; i++) {
    let mut mfn: c_ulong = __pfn_to_mfn(page_to_pfn(pages[i]));
...
pub const NR_NONRAM_REMAP: c_int = 4;
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_do_remap_nonram() -> void __init {
    void __init xen_do_remap_nonram(void)
    {
    unsigned int i;
    let mut remapped: c_uint = 0;
