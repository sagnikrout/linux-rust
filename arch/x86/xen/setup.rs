...
//
    ...
    let mut __initdata: static unsigned long xen_remap_mfn = INVALID_P2M_ENTRY;
    let mut __initdata: static bool xen_512gb_limit = IS_ENABLED(CONFIG_XEN_512GB);
#[no_mangle]
unsafe extern "C" fn xen_parse_512gb() -> void __init {
    ...
    val = true;
#[no_mangle]
pub unsafe extern "C" fn if(strlen("xen_512gb_limit="): kstrtobool(arg +, _arg: &val)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_chk_extra_mem(pfn: c_ulong) -> unsigned long __ref {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_inv_extra_mem() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn xen_find_pfn_range(min_pfn: *mut c_ulong) -> unsigned long __init {
...
#[no_mangle]
unsafe extern "C" fn xen_free_mfn(mfn: c_ulong) -> int __init {
...
// Release pages first.
    ...
    let mut mfn: c_ulong = pfn_to_mfn(pfn);
...
//
#[no_mangle]
unsafe extern "C" fn xen_update_mem_tables(pfn: c_ulong, mfn: c_ulong) -> void __init {
...
// Update m2p
    if (HYPERVISOR_mmu_update(&update, 1, core::ptr::null_mut(), DOMID_SELF) < 0) {
...
//
    ...
    {
    let mut buf: c_ulong = (unsigned long)&xen_remap_buf;
    unsigned long mfn_save, mfn;
    unsigned long ident_pfn_iter, remap_pfn_iter;
    let mut ident_end_pfn: c_ulong = start_pfn + size;
    let mut left: c_ulong = size;
...
//
    ...
    unsigned long pfn;
    let mut i: c_ulong = 0;
    let mut n: c_ulong = end_pfn - start_pfn;
    if (remap_pfn == 0)
    remap_pfn = ini_nr_pages;
    while (i < n) {
    let mut cur_pfn: c_ulong = start_pfn + i;
    let mut left: c_ulong = n - i;
    let mut size: c_ulong = left;
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_remap_memory() -> void __init {
    void __init xen_remap_memory(void)
    {
    let mut buf: c_ulong = (unsigned long)&xen_remap_buf;
    unsigned long mfn_save, pfn;
    let mut remapped: c_ulong = 0;
    unsigned int i;
    let mut pfn_s: c_ulong = ~0UL;
...
#[no_mangle]
unsafe extern "C" fn xen_get_pages_limit() -> unsigned long __init {
...
#[no_mangle]
unsafe extern "C" fn xen_get_max_pages() -> unsigned long __init {
    static unsigned long __init xen_get_max_pages(void)
    {
    unsigned long max_pages, limit;
    let mut domid: domid_t = DOMID_SELF;
    long ret;
...
#[no_mangle]
unsafe extern "C" fn xen_ignore_unusable() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn xen_is_e820_reserved(start: phys_addr_t, size: phys_addr_t) -> bool __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_find_free_area(size: phys_addr_t) -> phys_addr_t __init {
...
//
#[no_mangle]
unsafe extern "C" fn xen_e820_swap_entry_with_ram(swap_entry: *mut e820_entry) -> void __init {
    static void __init xen_e820_swap_entry_with_ram(struct e820_entry *swap_entry)
    {
    struct e820_entry *entry;
    unsigned int mapcnt;
    let mut mem_end: phys_addr_t = PFN_PHYS(ini_nr_pages);
...
//
#[no_mangle]
unsafe extern "C" fn xen_reserve_xen_mfnlist() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn xen_memory_setup() -> *mut char  __init {
...
#[no_mangle]
unsafe extern "C" fn register_callback(type: unsigned, func: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xen_enable_syscall() {
...
#[no_mangle]
unsafe extern "C" fn xen_pvmmu_arch_setup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn xen_arch_setup() -> void __init {
