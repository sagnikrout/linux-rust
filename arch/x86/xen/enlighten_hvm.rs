...
//! Source: arch/x86/xen/enlighten_hvm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn xen_hvm_init_shared_info() {
...
#[no_mangle]
unsafe extern "C" fn reserve_shared_info() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn xen_hvm_init_mem_mapping() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_hvm_pv_info() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn xen_hvm_shutdown() {
...
#[no_mangle]
unsafe extern "C" fn xen_hvm_crash_shutdown(regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn xen_cpu_up_prepare_hvm(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xen_cpu_dead_hvm(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xen_hvm_guest_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn xen_parse_nopv(arg: *mut c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn xen_parse_no_vector_callback(arg: *mut c_char) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn xen_x2apic_available() -> __init bool {
    static __init bool xen_x2apic_available(void)
    {
    return x2apic_supported();
    }
#[no_mangle]
unsafe extern "C" fn msi_ext_dest_id() -> bool __init {
    static bool __init msi_ext_dest_id(void)
    {
    return cpuid_eax(xen_cpuid_base() + 4) & XEN_HVM_CPUID_EXT_DEST_ID;
    }
#[no_mangle]
unsafe extern "C" fn xen_hvm_guest_late_init() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn xen_platform_hvm() -> uint32_t __init {
    static uint32_t __init xen_platform_hvm(void)
    {
    let mut xen_domain: u32 = xen_cpuid_base();
