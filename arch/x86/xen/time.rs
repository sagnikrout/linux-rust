...
pub const TIMER_SLOP: c_int = 1;
    static u64 xen_sched_clock_offset __read_mostly;
// Get the TSC speed from Xen
#[no_mangle]
unsafe extern "C" fn xen_tsc_khz() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn xen_clocksource_read() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn xen_clocksource_get_cycles(cs: *mut clocksource) -> u64 {
    static u64 xen_clocksource_get_cycles(struct clocksource *cs)
    {
    return xen_clocksource_read();
    }
#[no_mangle]
unsafe extern "C" fn xen_sched_clock() -> noinstr u64 {
...
#[no_mangle]
unsafe extern "C" fn xen_read_wallclock(ts: *mut timespec64) {
...
#[no_mangle]
unsafe extern "C" fn xen_get_wallclock(now: *mut timespec64) {
    static void xen_get_wallclock(struct timespec64 *now)
    {
    xen_read_wallclock(now);
    }
#[no_mangle]
unsafe extern "C" fn xen_set_wallclock(now: *const timespec64) -> c_int {
...
// Protected by the calling core code serialization
    ...
    let mut settime64_supported: static bool = true;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn xen_cs_enable(cs: *mut clocksource) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_abs_timeout(delta: c_ulong) -> i64 {
    static s64 get_abs_timeout(unsigned long delta)
    {
    return xen_clocksource_read() + delta;
    }
#[no_mangle]
unsafe extern "C" fn xen_timerop_shutdown(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xen_vcpuop_shutdown(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xen_vcpuop_set_oneshot(evt: *mut clock_event_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xen_clock_event_device {
...
#[no_mangle]
unsafe extern "C" fn xen_timer_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn xen_teardown_timer(cpu: c_int) {
    void xen_teardown_timer(int cpu)
    {
    struct clock_event_device *evt;
    evt = &per_cpu(xen_clock_events, cpu).evt;
    if (evt.irq >= 0) {
    unbind_from_irqhandler(evt.irq, core::ptr::null_mut());
    evt.irq = -1;
    }
    }
#[no_mangle]
pub unsafe extern "C" fn xen_setup_timer(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn xen_setup_cpu_clockevents() {
    void xen_setup_cpu_clockevents(void)
    {
    clockevents_register_device(this_cpu_ptr(&xen_clock_events.evt));
    }
#[no_mangle]
pub unsafe extern "C" fn xen_timer_resume() {
    ...
    xen_vcpu_nr(cpu), core::ptr::null_mut()))
    BUG();
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn xen_save_time_memory_area() {
...
#[no_mangle]
pub unsafe extern "C" fn xen_restore_time_memory_area() {
...
#[no_mangle]
unsafe extern "C" fn xen_setup_vsyscall_time_info() {
...
//
#[no_mangle]
unsafe extern "C" fn xen_tsc_safe_clocksource() -> int __init {
...
// Leaf 4, sub-leaf 0 (0x40000x03)
    ...
    let mut ebx: return = = XEN_CPUID_TSC_MODE_NEVER_EMULATE;
    }
#[no_mangle]
unsafe extern "C" fn xen_time_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: xen_tsc_safe_clocksource()) -> else {
...
#[no_mangle]
unsafe extern "C" fn xen_init_time_common() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn xen_init_time_ops() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn xen_hvm_setup_cpu_clockevents() {
...
#[no_mangle]
pub unsafe extern "C" fn xen_hvm_init_time_ops() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn parse_xen_timer_slop(ptr: *mut c_char) -> int __init {
    static int __init parse_xen_timer_slop(char *ptr)
    {
    let mut slop: c_ulong = memparse(ptr, core::ptr::null_mut());
