...
//! Source: arch/x86/xen/multicalls.c
#![no_std]
...
pub const MC_BATCH: c_int = 32;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mc_buffer {
    pub cbidx: unsigned mcidx, argidx,,
    pub entries: [multicall_entry; MC_BATCH],
    pub args: [c_uchar; MC_ARGS],
#[repr(C)]
#[derive(Copy, Clone)]
pub struct callback {
    pub ): *mut *mut void (fn)(void,
    pub data: *mut c_void,
    pub callbacks: [}; MC_BATCH],
}
...
#[no_mangle]
unsafe extern "C" fn get_mc_debug() -> *mut mc_debug_data  __ref {
...
#[no_mangle]
unsafe extern "C" fn xen_parse_mc_debug(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mc_debug_enable() -> int __init {
...
// Number of parameters of hypercalls used via multicalls.
    ...
    {
    unsigned int arg;
    let mut opidx: c_uint = mcdb.entries[idx].op & 0xff;
    let mut pars: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn xen_mc_flush() {
    void xen_mc_flush(void)
    {
    struct mc_buffer *b = this_cpu_ptr(&mc_buffer);
    struct multicall_entry *mc;
    struct mc_debug_data *mcdb = core::ptr::null_mut();
    let mut ret: c_int = 0;
    unsigned long flags;
    int i;
    BUG_ON(preemptible());
...
#[no_mangle]
pub unsafe extern "C" fn __xen_mc_entry(args: usize) -> multicall_space {
    struct multicall_space __xen_mc_entry(size_t args)
    {
    struct mc_buffer *b = this_cpu_ptr(&mc_buffer);
    struct multicall_space ret;
    let mut argidx: unsigned = roundup(b.argidx, sizeof(u64));
...
#[no_mangle]
pub unsafe extern "C" fn xen_mc_extend_args(op: c_ulong, size: usize) -> multicall_space {
    struct multicall_space xen_mc_extend_args(unsigned long op, size_t size)
    {
    struct mc_buffer *b = this_cpu_ptr(&mc_buffer);
    let mut ret: multicall_space = { core::ptr::null_mut(), core::ptr::null_mut() };
    BUG_ON(preemptible());
    BUG_ON(b.argidx >= MC_ARGS);
...
#[no_mangle]
pub unsafe extern "C" fn xen_mc_callback(): *mut *mut void (fn)(void, data: *mut c_void) {
