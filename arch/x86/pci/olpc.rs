...
//
    ...
    let mut ff_loc: static uint32_t = ~0;
    static uint32_t zero_loc;
    static int bar_probing;		/* Set after a write of ~0 to a BAR */
    static int is_lx;
pub const NB_SLOT: c_uint = 0x1	/* Northbridge - GX chip - Device 1 */;
pub const SB_SLOT: c_uint = 0xf	/* Southbridge - CS5536 chip - Device F */;
#[no_mangle]
unsafe extern "C" fn is_simulated(bus: c_uint, devfn: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_olpc_init() -> int __init {
