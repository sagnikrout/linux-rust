...
#[no_mangle]
unsafe extern "C" fn pci_fixup_i450nx(d: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_fixup_i450gx(d: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_fixup_umc_ide(d: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_fixup_latency(d: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_fixup_piix4_acpi(d: *mut pci_dev) {
...
//
pub const VIA_8363_KL133_REVISION_ID: c_uint = 0x81;
pub const VIA_8363_KM133_REVISION_ID: c_uint = 0x84;
#[no_mangle]
unsafe extern "C" fn pci_fixup_via_northbridge_bug(d: *mut pci_dev) {
    static void pci_fixup_via_northbridge_bug(struct pci_dev *d)
    {
    u8 v;
    let mut where: c_int = 0x55;
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_transparent_bridge(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_nforce2(dev: *mut pci_dev) {
...
pub const MAX_PCIEROOT: c_int = 6;
    static int quirk_aspm_offset[MAX_PCIEROOT << 3];

#[no_mangle]
unsafe extern "C" fn quirk_pcie_aspm_read(bus: *mut pci_bus, devfn: c_uint, where: c_int, size: c_int, value: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_pcie_aspm_write(bus: *mut pci_bus, devfn: c_uint, where: c_int, size: c_int, value: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcie_rootport_aspm_quirk(pdev: *mut pci_dev) {
    static void pcie_rootport_aspm_quirk(struct pci_dev *pdev)
    {
    int i;
    struct pci_bus  *pbus;
    struct pci_dev *dev;
    if ((pbus = pdev.subordinate) == core::ptr::null_mut())
    return;
//
...
//
#[no_mangle]
unsafe extern "C" fn limit_mrrs_to_128(b: *mut pci_host_bridge, pdev: *mut pci_dev) -> c_int {
    static int limit_mrrs_to_128(struct pci_host_bridge *b, struct pci_dev *pdev)
    {
    let mut readrq: c_int = pcie_get_readrq(pdev);
    if (readrq > 128)
    pcie_set_readrq(pdev, 128);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pci_xeon_x2_bifurc_quirk(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_video(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_msi_k8t_onboard_sound(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_pre_fixup_toshiba_ohci1394(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_post_fixup_toshiba_ohci1394(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_early_fixup_cyrix_5530(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_siemens_interrupt_controller(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn sb600_disable_hpet_bar(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn sb600_hpet_quirk(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn twinhead_reserve_killing_zone(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_invalid_bar(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_amd_ehci_pme(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_amd_fch_xhci_pme(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_apple_mbp_poweroff(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_no_aersid(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_intel_th_dnv(dev: *mut pci_dev) {
...
pub const AMD_141b_MMIO_HIGH_MMIOLIMIT_SHIFT: c_int = 16;
...
//
#[no_mangle]
unsafe extern "C" fn pci_amd_enable_64bit_bar(dev: *mut pci_dev) {
...
// Check that we are the only device of that type
    other = pci_get_device(dev.vendor, dev.device, core::ptr::null_mut());
    if (other != dev ||
...
pub const RS690_LOWER_TOP_OF_DRAM2: c_uint = 0x30;
pub const RS690_LOWER_TOP_OF_DRAM2_VALID: c_uint = 0x1;
pub const RS690_UPPER_TOP_OF_DRAM2: c_uint = 0x31;
pub const RS690_HTIU_NB_INDEX: c_uint = 0xA8;
pub const RS690_HTIU_NB_INDEX_WR_ENABLE: c_uint = 0x100;
pub const RS690_HTIU_NB_DATA: c_uint = 0xAC;
//
...
//
#[no_mangle]
unsafe extern "C" fn rs690_fix_64bit_dma(pdev: *mut pci_dev) {
    static void rs690_fix_64bit_dma(struct pci_dev *pdev)
    {
    let mut val: u32 = 0;
    let mut top_of_dram: phys_addr_t = __pa(high_memory - 1) + 1;
...
pub const AMD_15B8_RCC_DEV2_EPF0_STRAP2: c_uint = 0x10136008;
pub const AMD_15B8_RCC_DEV2_EPF0_STRAP2_NO_SOFT_RESET_DEV2_F0_MASK: c_uint = 0x00000080L;
#[no_mangle]
unsafe extern "C" fn quirk_clear_strap_no_soft_reset_dev2_f0(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn chromeos_save_apl_pci_l1ss_capability(dev: *mut pci_dev) {
    static void chromeos_save_apl_pci_l1ss_capability(struct pci_dev *dev)
    {
    let mut pos: c_int = PCI_CFG_SPACE_SIZE, prev = 0;
...
#[no_mangle]
unsafe extern "C" fn chromeos_fixup_apl_pci_l1ss_capability(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn asus_disable_nvme_d3cold(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn amd_rp_pme_suspend(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_rp_pme_resume(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_tuxeo_rp_d3(pdev: *mut pci_dev) {
