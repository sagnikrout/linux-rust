...
pub struct pci_root_info {
    ...
    let mut pci_use_e820: bool = true;
    let mut pci_use_crs: static bool = true;
    static bool pci_ignore_seg;
#[no_mangle]
unsafe extern "C" fn set_use_crs(id: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_nouse_crs(id: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_ignore_seg(id: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_no_e820(id: *const dmi_system_id) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn pci_acpi_crs_quirks() -> void __init {
    void __init pci_acpi_crs_quirks(void)
    {
    let mut year: c_int = dmi_get_bios_year();
...
//
    ...
    pci_use_crs = false;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_USE__CRS: pci_probe &) -> else {
...
// "pci=use_e820"/"pci=no_e820" on the kernel cmdline takes precedence
    ...
    pci_use_e820 = false;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_USE_E820: pci_probe &) -> else {
...
#[no_mangle]
unsafe extern "C" fn pcie_has_usb4_host_interface(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn arch_pci_dev_is_removable(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn check_segment(seg: u16, dev: *mut device, estr: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_mcfg_map(ci: *mut acpi_pci_root_info) -> c_int {
...
// enable MMCFG if it hasn't been enabled yet
    if (raw_pci_ext_ops == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn teardown_mcfg_map(ci: *mut acpi_pci_root_info) {
...
#[no_mangle]
unsafe extern "C" fn pci_acpi_root_get_node(root: *mut acpi_pci_root) -> c_int {
    static int pci_acpi_root_get_node(struct acpi_pci_root *root)
    {
    let mut busnum: c_int = root.secondary.start;
...
#[no_mangle]
unsafe extern "C" fn pci_acpi_root_init_info(ci: *mut acpi_pci_root_info) -> c_int {
    static int pci_acpi_root_init_info(struct acpi_pci_root_info *ci)
    {
    return setup_mcfg_map(ci);
    }
#[no_mangle]
unsafe extern "C" fn pci_acpi_root_release_info(ci: *mut acpi_pci_root_info) {
...
//
#[no_mangle]
unsafe extern "C" fn resource_is_pcicfg_ioport(res: *mut resource) -> bool {
...
unsafe extern "C" fn pci_acpi_root_prepare_resources(ci: *mut acpi_pci_root_info) -> c_int {
    ...
    let mut busnum: c_int = ci.root.secondary.start;
    ...
    {
    let mut domain: c_int = root.segment;
    let mut busnum: c_int = root.secondary.start;
    let mut node: c_int = pci_acpi_root_get_node(root);
    struct pci_bus *bus;
    if (pci_ignore_seg)
...
#[no_mangle]
pub unsafe extern "C" fn pci_acpi_init() -> int __init {
