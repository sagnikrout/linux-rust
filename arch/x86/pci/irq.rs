...
pub const PIRQ_VERSION: c_uint = 0x0100;
...
//
    let mut pcibios_irq_mask: c_uint = 0xfff8;
...
pub struct irq_router {
    pub name: *mut c_char,
    pub device: u16 vendor,,
    pub pirq): *mut *mut *mut *mut int (get)(struct pci_dev router, struct pci_dev dev, int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct irq_router_handler {
    pub vendor: u16,
    pub device): *mut *mut *mut *mut int (probe)(struct irq_router r, struct pci_dev router, u16,
}
...
//
#[no_mangle]
unsafe extern "C" fn pirq_find_routing_table() -> *mut irq_routing_table  __init {
    static struct irq_routing_table * __init pirq_find_routing_table(void)
    {
    let mut bios_start: *mut u8  const = (u8 *)__va(0xf0000);
    let mut bios_end: *mut u8  const = (u8 *)__va(0x100000);
    u8 *addr;
    struct irq_routing_table *rt;
    if (pirq_table_addr) {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_peer_trick() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn elcr_set_level_irq(irq: c_uint) {
    void elcr_set_level_irq(unsigned int irq)
    {
    let mut mask: c_uchar = 1 << (irq & 7);
...
// Inc., July 1997
//
pub const PC_CONF_FINALI_LOCK: c_uint = 0x03u;
pub const PC_CONF_FINALI_PCI_INTX_RT1: c_uint = 0x42u;
pub const PC_CONF_FINALI_PCI_INTX_RT2: c_uint = 0x43u;
pub const PC_CONF_FINALI_PCI_INTX_SENS: c_uint = 0x44u;
pub const PC_CONF_FINALI_LOCK_KEY: c_uint = 0xc5u;
#[no_mangle]
unsafe extern "C" fn read_pc_conf_nybble(base: u8, index: u8) -> u8 {
    static u8 read_pc_conf_nybble(u8 base, u8 index)
    {
    let mut reg: u8 = base + (index >> 1);
    u8 x;
    x = pc_conf_get(reg);
    return index & 1 ? x >> 4 : x & 0xf;
    }
#[no_mangle]
unsafe extern "C" fn write_pc_conf_nybble(base: u8, index: u8, val: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn read_config_nybble(router: *mut pci_dev, offset: unsigned, nr: unsigned) -> c_uint {
    static unsigned int read_config_nybble(struct pci_dev *router, unsigned offset, unsigned nr)
    {
    u8 x;
    let mut reg: unsigned = offset + (nr >> 1);
...
//
#[no_mangle]
unsafe extern "C" fn pirq_ali_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pirq_ali_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
    static int pirq_ali_set(struct pci_dev *router, struct pci_dev *dev, int pirq, int irq)
    {
    static const unsigned char irqmap[16] = { 0, 8, 0, 2, 4, 5, 7, 6, 0, 1, 3, 9, 11, 0, 13, 15 };
    let mut val: c_uint = irqmap[irq];
    WARN_ON_ONCE(pirq > 16);
    if (val) {
...
//
pub const PC_CONF_I82374_ESC_ID: c_uint = 0x02u;
pub const PC_CONF_I82374_PIRQ_ROUTE_CONTROL: c_uint = 0x60u;
pub const PC_CONF_I82374_ESC_ID_KEY: c_uint = 0x0fu;
#[no_mangle]
unsafe extern "C" fn pirq_esc_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_piix_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pirq_piix_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
...
//
pub const PCI_I82426EX_PIRQ_ROUTE_CONTROL: c_uint = 0x66u;
#[no_mangle]
unsafe extern "C" fn pirq_ib_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_via_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
    static int pirq_via_get(struct pci_dev *router, struct pci_dev *dev, int pirq)
    {
    return read_config_nybble(router, 0x55, pirq == 4 ? 5 : pirq);
    }
#[no_mangle]
unsafe extern "C" fn pirq_via_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_via586_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pirq_via586_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_ite_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pirq_ite_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_opti_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
    static int pirq_opti_get(struct pci_dev *router, struct pci_dev *dev, int pirq)
    {
    return read_config_nybble(router, 0xb8, pirq >> 4);
    }
#[no_mangle]
unsafe extern "C" fn pirq_opti_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_cyrix_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
    static int pirq_cyrix_get(struct pci_dev *router, struct pci_dev *dev, int pirq)
    {
    return read_config_nybble(router, 0x5C, (pirq-1)^1);
    }
#[no_mangle]
unsafe extern "C" fn pirq_cyrix_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
...
//
pub const PCI_SIS497_INTA_TO_IRQ_LINK: c_uint = 0xc0u;
pub const PIRQ_SIS497_IRQ_MASK: c_uint = 0x0fu;
pub const PIRQ_SIS497_IRQ_ENABLE: c_uint = 0x80u;
...
//
pub const PIRQ_SIS503_IRQ_MASK: c_uint = 0x0f;
pub const PIRQ_SIS503_IRQ_DISABLE: c_uint = 0x80;
pub const PIRQ_SIS503_USB_ENABLE: c_uint = 0x40;
...
//
#[no_mangle]
unsafe extern "C" fn pirq_vlsi_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pirq_vlsi_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_serverworks_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_amd756_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pirq_amd756_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pirq_pico_get(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pirq_bios_set(router: *mut pci_dev, dev: *mut pci_dev, pirq: c_int, irq: c_int) -> c_int {
    static int pirq_bios_set(struct pci_dev *router, struct pci_dev *dev, int pirq, int irq)
    {
    struct pci_dev *bridge;
    let mut pin: c_int = pci_get_interrupt_pin(dev, &bridge);
    return pcibios_set_irq_routing(bridge, pin - 1, irq);
    }

#[no_mangle]
unsafe extern "C" fn intel_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn vlsi_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn sis_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn cyrix_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn opti_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn ite_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn ali_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn amd_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn pico_router_probe(r: *mut irq_router, router: *mut pci_dev, device: u16) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn pirq_find_router(r: *mut irq_router) -> void __init {
...
// Default unless a driver reloads it
    r.name = "default";
    r.get = core::ptr::null_mut();
    r.set = core::ptr::null_mut();
...
//
    ...
    struct irq_info *slotinfo = core::ptr::null_mut();
...
//
    ...
    struct irq_info *info;
    let mut temp_pin: u8 = *pin;
    let mut dpin: u8 = temp_pin;
...
#[no_mangle]
unsafe extern "C" fn pcibios_lookup_irq(dev: *mut pci_dev, assign: c_int) -> c_int {
    ...
    struct pci_dev *dev2 = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_fixup_irqs() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn fix_broken_hp_bios_irq9(d: *const dmi_system_id) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn fix_acer_tm360_irqrouting(d: *const dmi_system_id) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_irq_init() -> void __init {
    void __init pcibios_irq_init(void)
    {
    struct irq_routing_table *rtable = core::ptr::null_mut();
    DBG(KERN_DEBUG "PCI: IRQ init\n");
    if (raw_pci_ops == core::ptr::null_mut())
    return;
...
#[no_mangle]
unsafe extern "C" fn pirq_penalize_isa_irq(irq: c_int, active: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_penalize_isa_irq(irq: c_int, active: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pirq_enable_irq(dev: *mut pci_dev) -> c_int {
    static int pirq_enable_irq(struct pci_dev *dev)
    {
    let mut pin: u8 = 0;
    pci_read_config_byte(dev, PCI_INTERRUPT_PIN, &pin);
...
#[no_mangle]
pub unsafe extern "C" fn mp_should_keep_irq(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pirq_disable_irq(dev: *mut pci_dev) {
    static void pirq_disable_irq(struct pci_dev *dev)
    {
