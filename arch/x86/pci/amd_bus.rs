...
pub const AMD_NB_F0_NODE_ID: c_uint = 0x60;
pub const AMD_NB_F0_UNIT_ID: c_uint = 0x64;
pub const AMD_NB_F1_CONFIG_MAP_REG: c_uint = 0xe0;
pub const RANGE_NUM: c_int = 16;
pub const AMD_NB_F1_CONFIG_MAP_RANGES: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_hostbridge {
    pub bus: u32,
    pub slot: u32,
    pub device: u32,
}
...
#[no_mangle]
pub unsafe extern "C" fn cap_resource(val: u64) -> resource_size_t {
...
//
#[no_mangle]
unsafe extern "C" fn early_root_info_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn amd_bus_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_enable_pci_io_ecs() -> void __init {
    static void __init pci_enable_pci_io_ecs(void)
    {

    unsigned int i, n;
    for (n = i = 0; !n && amd_nb_bus_dev_ranges[i].dev_limit; ++i) {
    let mut bus: u8 = amd_nb_bus_dev_ranges[i].bus;
    let mut slot: u8 = amd_nb_bus_dev_ranges[i].dev_base;
    let mut limit: u8 = amd_nb_bus_dev_ranges[i].dev_limit;
    for (; slot < limit; ++slot) {
    let mut val: u32 = read_pci_config(bus, slot, 3, 0);
...
#[no_mangle]
unsafe extern "C" fn pci_io_ecs_init() -> int __init {
...
// Try the PCI method first.
    ...
    amd_bus_cpu_online, core::ptr::null_mut());
    WARN_ON(ret < 0);
    pci_probe |= PCI_HAS_IO_ECS;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn amd_postcore_init() -> int __init {
