...
//! Source: arch/x86/virt/svm/sev.c
#![no_std]
...
//
pub const RMPTABLE_CPU_BOOKKEEPING_SZ: c_uint = 0x4000;
//
...
//
pub const RMPTABLE_NON_SEGMENTED_SHIFT: c_int = 52;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rmp_segment_desc {
    pub rmp_entry: *mut rmpentry_raw,
    pub max_index: u64,
    pub size: u64,
}
...
//
    ...
    let mut __ro_after_init: static unsigned int rst_max_index = 512;
...
#[no_mangle]
unsafe extern "C" fn mfd_reconfigure(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn snp_enable(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __snp_fixup_e820_tables(pa: u64) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fixup_e820_tables_for_segmented_rmp() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fixup_e820_tables_for_contiguous_rmp() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn snp_fixup_e820_tables() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn alloc_rmp_segment_desc(segment_pa: u64, segment_size: u64, pa: u64) -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn free_rmp_segment_table() -> void __init {
    ...
    rmp_segment_table = core::ptr::null_mut();
    }
// Allocate the table used to index into the RMP segments
#[no_mangle]
unsafe extern "C" fn alloc_rmp_segment_table() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn setup_contiguous_rmptable() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn setup_segmented_rmptable() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn setup_rmptable() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn clear_hsave_pa(arg: *mut c_void) {
    static void clear_hsave_pa(void *arg)
    {
    wrmsrq(MSR_VM_HSAVE_PA, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn snp_prepare() -> c_int {
...
//
    ...
    on_each_cpu(snp_enable, core::ptr::null_mut(), 1);
// SNP_INIT requires MSR_VM_HSAVE_PA to be cleared on all CPUs.
    on_each_cpu(clear_hsave_pa, core::ptr::null_mut(), 1);
    ret = 0;
    unlock:
    cpus_read_unlock();
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn snp_shutdown() {
    ...
    return;
    clear_rmp();
    on_each_cpu(mfd_reconfigure, core::ptr::null_mut(), 1);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn snp_rmptable_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_rmp_segment_info(segment_shift: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn probe_contiguous_rmptable_info() -> bool {
...
#[no_mangle]
unsafe extern "C" fn probe_segmented_rmptable_info() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn snp_probe_rmptable_info() -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_rmpentry(pfn: u64, e: *mut rmpentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __snp_lookup_rmpentry(pfn: u64, e: *mut rmpentry, level: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn snp_lookup_rmpentry(pfn: u64, assigned: *mut bool, level: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dump_rmpentry(pfn: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn snp_dump_hva_rmpentry(hva: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn psmash(pfn: u64) -> c_int {
    int psmash(u64 pfn)
    {
...
//
#[no_mangle]
unsafe extern "C" fn adjust_direct_map(pfn: u64, rmp_level: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rmpupdate(pfn: u64, state: *mut rmp_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rmp_make_private(pfn: u64, gpa: u64, level: enum pg_level, asid: u32, immutable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rmp_make_shared(pfn: u64, level: enum pg_level) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __snp_leak_pages(pfn: u64, npages: c_uint, dump_rmp: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn kdump_sev_callback() {
