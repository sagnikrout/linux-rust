...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct x86_virt_ops {
    pub feature: c_int,
    pub (*enable_virtualization_cpu)(void): *mut c_int,
    pub (*disable_virtualization_cpu)(void): *mut c_int,
    pub (*emergency_disable_virtualization_cpu)(void): *mut c_void,
}
...
#[no_mangle]
pub unsafe extern "C" fn x86_virt_register_emergency_callback(callback: *mut cpu_emergency_virt_cb) {
...
#[no_mangle]
pub unsafe extern "C" fn x86_virt_unregister_emergency_callback(callback: *mut cpu_emergency_virt_cb) {
    ...
    return;
    rcu_assign_pointer(kvm_emergency_callback, core::ptr::null_mut());
    synchronize_rcu();
    }
    EXPORT_SYMBOL_FOR_KVM(x86_virt_unregister_emergency_callback);
#[no_mangle]
unsafe extern "C" fn x86_virt_invoke_kvm_emergency_callback() {
...
#[no_mangle]
unsafe extern "C" fn x86_virt_cpu_vmxon() -> c_int {
    static int x86_virt_cpu_vmxon(void)
    {
    let mut vmxon_pointer: u64 = __pa(per_cpu(root_vmcs, raw_smp_processor_id()));
    u64 msr;
...
#[no_mangle]
unsafe extern "C" fn x86_vmx_enable_virtualization_cpu() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn x86_vmx_disable_virtualization_cpu() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_vmx_exit() -> __init void {
    static __init void x86_vmx_exit(void)
    {
    int cpu;
    for_each_possible_cpu(cpu) {
    free_page((unsigned long)per_cpu(root_vmcs, cpu));
    per_cpu(root_vmcs, cpu) = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn __x86_vmx_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn x86_vmx_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn x86_svm_enable_virtualization_cpu() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_svm_disable_virtualization_cpu() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x86_svm_init() -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn x86_virt_get_ref(feat: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn x86_virt_put_ref(feat: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn x86_virt_emergency_disable_virtualization_cpu() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn x86_virt_init() -> void __init {
...
//
    let mut has_vmx: bool = !x86_vmx_init();
    let mut has_svm: bool = !x86_svm_init();
