...
//! Source: arch/x86/kvm/svm/nested.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nested_svm_get_tdp_pdptr(vcpu: *mut kvm_vcpu, index: c_int) -> u64 {
    static u64 nested_svm_get_tdp_pdptr(struct kvm_vcpu *vcpu, int index)
    {
    struct vcpu_svm *svm = to_svm(vcpu);
    let mut cr3: u64 = svm.nested.ctl.nested_cr3;
    u64 pdpte;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn nested_svm_get_tdp_cr3(vcpu: *mut kvm_vcpu) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_init_mmu_context(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_uninit_mmu_context(vcpu: *mut kvm_vcpu) {
    static void nested_svm_uninit_mmu_context(struct kvm_vcpu *vcpu)
    {
    vcpu.arch.mmu = &vcpu.arch.root_mmu;
    }
#[no_mangle]
unsafe extern "C" fn nested_vmcb_needs_vls_intercept(svm: *mut vcpu_svm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nested_vmcb02_recalc_intercepts(svm: *mut vcpu_svm) {
...
#[no_mangle]
pub unsafe extern "C" fn nested_svm_init_msrpm_merge_offsets() -> int __init {
    ...
    let mut bit_nr: c_int = svm_msrpm_bit_nr(merge_msrs[i]);
    u32 offset;
    if (WARN_ON(bit_nr < 0))
    return -EIO;
//
...
//
#[no_mangle]
unsafe extern "C" fn nested_svm_merge_msrpm(vcpu: *mut kvm_vcpu) -> bool {
...
//
    ...
    let mut p: c_int = nested_svm_msrpm_merge_offsets[i];
...
//
#[no_mangle]
unsafe extern "C" fn nested_svm_check_bitmap_pa(vcpu: *mut kvm_vcpu, pa: u64, size: u32) -> bool {
    static bool nested_svm_check_bitmap_pa(struct kvm_vcpu *vcpu, u64 pa, u32 size)
    {
    let mut addr: u64 = PAGE_ALIGN(pa);
    return kvm_vcpu_is_legal_gpa(vcpu, addr) &&
    kvm_vcpu_is_legal_gpa(vcpu, addr + size - 1);
    }
#[no_mangle]
unsafe extern "C" fn nested_svm_event_inj_valid_exept(vcpu: *mut kvm_vcpu, vector: u8) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nested_svm_check_event_inj(vcpu: *mut kvm_vcpu, event_inj: u32) -> bool {
    static bool nested_svm_check_event_inj(struct kvm_vcpu *vcpu, u32 event_inj)
    {
    let mut type: u32 = event_inj & SVM_EVTINJ_TYPE_MASK;
    let mut vector: u8 = event_inj & SVM_EVTINJ_VEC_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn nested_svm_check_cached_vmcb12(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nested_sync_control_from_vmcb02(svm: *mut vcpu_svm) {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_transition_tlb_flush(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CC(!load_pdptrs(vcpu, _arg: cr3))) -> else {
...
#[no_mangle]
unsafe extern "C" fn nested_vmcb12_has_lbrv(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_evtinj_soft(evtinj: u32) -> bool {
    static inline bool is_evtinj_soft(u32 evtinj)
    {
    let mut type: u32 = evtinj & SVM_EVTINJ_TYPE_MASK;
    let mut vector: u8 = evtinj & SVM_EVTINJ_VEC_MASK;
    if (!(evtinj & SVM_EVTINJ_VALID))
    return false;
    if (type == SVM_EVTINJ_TYPE_SOFT)
    return true;
    let mut type: return = = SVM_EVTINJ_TYPE_EXEPT && kvm_exception_is_soft(vector);
    }
#[no_mangle]
unsafe extern "C" fn is_evtinj_nmi(evtinj: u32) -> bool {
    static bool is_evtinj_nmi(u32 evtinj)
    {
    let mut type: u32 = evtinj & SVM_EVTINJ_TYPE_MASK;
    if (!(evtinj & SVM_EVTINJ_VALID))
    return false;
    let mut type: return = = SVM_EVTINJ_TYPE_NMI;
    }
#[no_mangle]
unsafe extern "C" fn nested_vmcb02_prepare_control(svm: *mut vcpu_svm) {
    static void nested_vmcb02_prepare_control(struct vcpu_svm *svm)
    {
    let mut int_ctl_vmcb01_bits: u32 = V_INTR_MASKING_MASK;
    let mut int_ctl_vmcb12_bits: u32 = V_TPR_MASK | V_IRQ_INJECTION_BITS_MASK;
    struct vmcb_ctrl_area_cached *vmcb12_ctrl = &svm.nested.ctl;
    struct vmcb *vmcb02 = svm.nested.vmcb02.ptr;
    struct vmcb *vmcb01 = svm.vmcb01.ptr;
    struct kvm_vcpu *vcpu = &svm.vcpu;
...
#[no_mangle]
unsafe extern "C" fn nested_svm_copy_common_state(from_vmcb: *mut vmcb, to_vmcb: *mut vmcb) {
...
#[no_mangle]
pub unsafe extern "C" fn enter_svm_guest_mode(vcpu: *mut kvm_vcpu, vmcb12_gpa: u64, from_vmrun: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_copy_vmcb12_to_cache(vcpu: *mut kvm_vcpu, vmcb12_gpa: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nested_svm_vmrun(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svm_copy_vmloadsave_state(to_vmcb: *mut vmcb, from_vmcb: *mut vmcb) {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_vmexit_update_vmcb12(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nested_svm_vmexit(svm: *mut vcpu_svm) {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_triple_fault(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn svm_allocate_nested(svm: *mut vcpu_svm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svm_free_nested(svm: *mut vcpu_svm) {
...
#[no_mangle]
pub unsafe extern "C" fn svm_leave_nested(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_exit_handled_msr(svm: *mut vcpu_svm) -> c_int {
    static int nested_svm_exit_handled_msr(struct vcpu_svm *svm)
    {
    let mut base: gpa_t = svm.nested.ctl.msrpm_base_pa;
    int write, bit_nr;
    u8 value, mask;
    u32 msr;
    if (!(vmcb12_is_intercept(&svm.nested.ctl, INTERCEPT_MSR_PROT)))
...
#[no_mangle]
unsafe extern "C" fn nested_svm_intercept_ioio(svm: *mut vcpu_svm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_intercept(svm: *mut vcpu_svm) -> c_int {
    static int nested_svm_intercept(struct vcpu_svm *svm)
    {
    let mut exit_code: u64 = svm.vmcb.control.exit_code;
    let mut vmexit: c_int = NESTED_EXIT_HOST;
...
#[no_mangle]
pub unsafe extern "C" fn nested_svm_exit_handled(svm: *mut vcpu_svm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nested_svm_check_permissions(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nested_svm_inject_exception_vmexit(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn nested_exit_on_init(svm: *mut vcpu_svm) -> bool {
    static inline bool nested_exit_on_init(struct vcpu_svm *svm)
    {
    return vmcb12_is_intercept(&svm.nested.ctl, INTERCEPT_INIT);
    }
#[no_mangle]
unsafe extern "C" fn svm_check_nested_events(vcpu: *mut kvm_vcpu) -> c_int {
...
//
    let mut block_nested_exceptions: bool = vcpu.arch.nested_run_pending;
//
...
#[no_mangle]
pub unsafe extern "C" fn nested_svm_exit_special(svm: *mut vcpu_svm) -> c_int {
    int nested_svm_exit_special(struct vcpu_svm *svm)
    {
    let mut exit_code: u32 = svm.vmcb.control.exit_code;
    struct kvm_vcpu *vcpu = &svm.vcpu;
    switch (exit_code) {
    case SVM_EXIT_INTR:
    case SVM_EXIT_NMI:
    ...
    return NESTED_EXIT_HOST;
    case SVM_EXIT_EXCP_BASE ... SVM_EXIT_EXCP_BASE + 0x1f: {
    let mut excp_bits: u32 = 1 << (exit_code - SVM_EXIT_EXCP_BASE);
...
#[no_mangle]
pub unsafe extern "C" fn nested_svm_update_tsc_ratio_msr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn svm_get_nested_state_pages(vcpu: *mut kvm_vcpu) -> bool {
