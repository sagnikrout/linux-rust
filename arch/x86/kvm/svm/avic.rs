...
//! Source: arch/x86/kvm/svm/avic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn avic_param_set(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avic_param_get(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
...
//
    let mut avic: static int __ro_after_init = AVIC_AUTO_MODE;
...
// a particular vCPU.
//
pub const SVM_VM_DATA_HASH_BITS: c_int = 8;
    static DEFINE_HASHTABLE(svm_vm_data_hash, SVM_VM_DATA_HASH_BITS);
    let mut next_vm_id: static u32 = 0;
    let mut next_vm_id_wrapped: static bool = 0;
...
#[no_mangle]
unsafe extern "C" fn __avic_get_max_physical_id(kvm: *mut kvm, vcpu: *mut kvm_vcpu) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn avic_get_max_physical_id(vcpu: *mut kvm_vcpu) -> u32 {
    static u32 avic_get_max_physical_id(struct kvm_vcpu *vcpu)
    {
    return __avic_get_max_physical_id(vcpu.kvm, vcpu);
    }
#[no_mangle]
unsafe extern "C" fn avic_activate_vmcb(svm: *mut vcpu_svm) {
...
#[no_mangle]
unsafe extern "C" fn avic_deactivate_vmcb(svm: *mut vcpu_svm) {
...
//
#[no_mangle]
unsafe extern "C" fn avic_ga_log_notifier(ga_tag: u32) -> c_int {
    static int avic_ga_log_notifier(u32 ga_tag)
    {
    unsigned long flags;
    struct kvm_svm *kvm_svm;
    struct kvm_vcpu *vcpu = core::ptr::null_mut();
    let mut vm_id: u32 = AVIC_GATAG_TO_VMID(ga_tag);
    let mut vcpu_idx: u32 = AVIC_GATAG_TO_VCPUIDX(ga_tag);
...
#[no_mangle]
unsafe extern "C" fn avic_get_physical_id_table_order(kvm: *mut kvm) -> c_int {
    static int avic_get_physical_id_table_order(struct kvm *kvm)
    {
// Provision for the maximum physical ID supported in x2avic mode
    return get_order((__avic_get_max_physical_id(kvm, core::ptr::null_mut()) + 1) * sizeof(u64));
    }
#[no_mangle]
unsafe extern "C" fn avic_alloc_physical_id_table(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avic_alloc_logical_id_table(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn avic_add_vm_to_ga_log_list(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn avic_vcpu_precreate(kvm: *mut kvm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avic_vm_pre_destroy(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn avic_vm_destroy(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn avic_get_backing_page_address(svm: *mut vcpu_svm) -> phys_addr_t {
    static phys_addr_t avic_get_backing_page_address(struct vcpu_svm *svm)
    {
    return __sme_set(__pa(svm.vcpu.arch.apic.regs));
    }
#[no_mangle]
pub unsafe extern "C" fn avic_init_vmcb(svm: *mut vcpu_svm, vmcb: *mut vmcb) {
...
#[no_mangle]
unsafe extern "C" fn avic_init_backing_page(vcpu: *mut kvm_vcpu) -> c_int {
    static int avic_init_backing_page(struct kvm_vcpu *vcpu)
    {
    let mut max_id: u32 = x2avic_enabled ? x2avic_max_physical_id : AVIC_MAX_PHYSICAL_ID;
    struct kvm_svm *kvm_svm = to_kvm_svm(vcpu.kvm);
    struct vcpu_svm *svm = to_svm(vcpu);
    let mut id: u32 = vcpu.vcpu_id;
    u64 new_entry;
//
...
#[no_mangle]
pub unsafe extern "C" fn avic_ring_doorbell(vcpu: *mut kvm_vcpu) {
...
//
    let mut cpu: c_int = READ_ONCE(vcpu.cpu);
    if (cpu != get_cpu()) {
...
#[no_mangle]
unsafe extern "C" fn avic_kick_vcpu(vcpu: *mut kvm_vcpu, icrl: u32) {
...
// Once again, nothing to do if the target vCPU doesn't exist.
    ...
    let mut logid_entry: u32 = avic_logical_id_table[logid_index];
...
//
    ...
    {
    let mut dest_mode: c_int = icrl & APIC_DEST_MASK;
    let mut shorthand: c_int = icrl & APIC_SHORT_MASK;
    struct kvm_svm *kvm_svm = to_kvm_svm(kvm);
    u32 dest;
...
// Nothing to do if there are no destinations in the cluster.
    ...
    return 0;
    if (apic_x2apic_mode(source))
    avic_logical_id_table = core::ptr::null_mut();
    else
...
//
    ...
    u32 icrl, u32 icrh, u32 index)
    {
    let mut dest: u32 = apic_x2apic_mode(source) ? icrh : GET_XAPIC_DEST_FIELD(icrh);
    unsigned long i;
...
#[no_mangle]
pub unsafe extern "C" fn avic_incomplete_ipi_interception(vcpu: *mut kvm_vcpu) -> c_int {
    int avic_incomplete_ipi_interception(struct kvm_vcpu *vcpu)
    {
    struct vcpu_svm *svm = to_svm(vcpu);
    let mut icrh: u32 = svm.vmcb.control.exit_info_1 >> 32;
    let mut icrl: u32 = svm.vmcb.control.exit_info_1;
    let mut id: u32 = svm.vmcb.control.exit_info_2 >> 32;
    let mut index: u32 = svm.vmcb.control.exit_info_2 & AVIC_PHYSICAL_MAX_INDEX_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn avic_vcpu_get_apicv_inhibit_reasons(vcpu: *mut kvm_vcpu) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn avic_ldr_write(vcpu: *mut kvm_vcpu, g_physical_id: u8, ldr: u32) {
...
#[no_mangle]
unsafe extern "C" fn avic_invalidate_logical_id_entry(vcpu: *mut kvm_vcpu) {
    static void avic_invalidate_logical_id_entry(struct kvm_vcpu *vcpu)
    {
    struct vcpu_svm *svm = to_svm(vcpu);
    let mut flat: bool = svm.dfr_reg == APIC_DFR_FLAT;
    u32 *entry;
...
#[no_mangle]
unsafe extern "C" fn avic_handle_ldr_update(vcpu: *mut kvm_vcpu) {
    static void avic_handle_ldr_update(struct kvm_vcpu *vcpu)
    {
    struct vcpu_svm *svm = to_svm(vcpu);
    let mut ldr: u32 = kvm_lapic_get_reg(vcpu.arch.apic, APIC_LDR);
    let mut id: u32 = kvm_xapic_id(vcpu.arch.apic);
...
#[no_mangle]
unsafe extern "C" fn avic_handle_dfr_update(vcpu: *mut kvm_vcpu) {
    static void avic_handle_dfr_update(struct kvm_vcpu *vcpu)
    {
    struct vcpu_svm *svm = to_svm(vcpu);
    let mut dfr: u32 = kvm_lapic_get_reg(vcpu.arch.apic, APIC_DFR);
    if (svm.dfr_reg == dfr)
    return;
    avic_invalidate_logical_id_entry(vcpu);
    svm.dfr_reg = dfr;
...
#[no_mangle]
unsafe extern "C" fn avic_unaccel_trap_write(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_avic_unaccelerated_access_trap(offset: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn avic_unaccelerated_access_interception(vcpu: *mut kvm_vcpu) -> c_int {
    ...
    let mut trap: bool = is_avic_unaccelerated_access_trap(offset);
...
#[no_mangle]
pub unsafe extern "C" fn avic_init_vcpu(svm: *mut vcpu_svm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn avic_apicv_post_state_restore(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn svm_ir_list_del(irqfd: *mut kvm_kernel_irqfd) {
...
//
    ...
    irq_set_vcpu_affinity(host_irq, core::ptr::null_mut());
    return -EIO;
    }
    ...
    return irq_set_vcpu_affinity(host_irq, core::ptr::null_mut());
    }
...
//
    ...
    {
    let mut ga_log_intr: bool = (action & AVIC_START_BLOCKING);
    struct vcpu_svm *svm = to_svm(vcpu);
...
#[no_mangle]
pub unsafe extern "C" fn if(0: cpu >=) -> else {
    else if (cpu >= 0)
    ...
    {
    struct kvm_svm *kvm_svm = to_kvm_svm(vcpu.kvm);
    let mut h_physical_id: c_int = cpu_physical_id(cpu);
    struct vcpu_svm *svm = to_svm(vcpu);
    unsigned long flags;
    u64 entry;
...
#[no_mangle]
pub unsafe extern "C" fn avic_vcpu_load(vcpu: *mut kvm_vcpu, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn __avic_vcpu_put(vcpu: *mut kvm_vcpu, action: enum avic_vcpu_action) {
    static void __avic_vcpu_put(struct kvm_vcpu *vcpu, enum avic_vcpu_action action)
    {
    struct kvm_svm *kvm_svm = to_kvm_svm(vcpu.kvm);
    struct vcpu_svm *svm = to_svm(vcpu);
    unsigned long flags;
    let mut entry: u64 = svm.avic_physical_id_entry;
    lockdep_assert_preemption_disabled();
    if (WARN_ON_ONCE(vcpu.vcpu_id * sizeof(entry) >=
    PAGE_SIZE << avic_get_physical_id_table_order(vcpu.kvm)))
    return;
...
#[no_mangle]
pub unsafe extern "C" fn avic_vcpu_put(vcpu: *mut kvm_vcpu) {
...
// recursively.
//
    let mut entry: u64 = to_svm(vcpu).avic_physical_id_entry;
//
...
#[no_mangle]
pub unsafe extern "C" fn avic_refresh_virtual_apic_mode(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn avic_refresh_apicv_exec_ctrl(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn avic_vcpu_blocking(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn avic_vcpu_unblocking(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn avic_want_avic_enabled() -> bool __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn avic_hardware_setup() -> bool __init {
...
pub unsafe extern "C" fn avic_hardware_unsetup() {
    ...
    {
    if (avic)
    amd_iommu_register_ga_log_notifier(core::ptr::null_mut());
    }
