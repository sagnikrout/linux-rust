...
//! Source: arch/x86/platform/efi/efi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn setup_add_efi_memmap(arg: *mut c_char) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn do_add_efi_memmap() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(EFI_MEMORY_WB: md->attribute &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn do_efi_soft_reserve() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn efi_memblock_x86_reserve_range() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn efi_memmap_entry_valid(md: *const efi_memory_desc_t, i: c_int) -> bool __init {
    static bool __init efi_memmap_entry_valid(const efi_memory_desc_t *md, int i)
    {
    let mut end: u64 = (md.num_pages << EFI_PAGE_SHIFT) + md.phys_addr - 1;
    let mut end_hi: u64 = 0;
    char buf[64];
    if (md.num_pages == 0) {
    end = 0;
...
#[no_mangle]
unsafe extern "C" fn efi_clean_memmap() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn efi_remove_e820_mmio() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn efi_print_memmap() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn efi_systab_init(phys: c_ulong) -> int __init {
    static int __init efi_systab_init(unsigned long phys)
    {
    int size = efi_enabled(EFI_64BIT) ? sizeof(efi_system_table_64_t)
    : sizeof(efi_system_table_32_t);
    const efi_table_hdr_t *hdr;
    let mut over4g: bool = false;
    void *p;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn efi_config_init(arch_tables: *const efi_config_table_type_t) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn efi_merge_regions() -> void __init {
    static void __init efi_merge_regions(void)
    {
    efi_memory_desc_t *md, *prev_md = core::ptr::null_mut();
    for_each_efi_memory_desc(md) {
    u64 prev_size;
    if (!prev_md) {
    prev_md = md;
...
#[no_mangle]
unsafe extern "C" fn should_map_region(md: *mut efi_memory_desc_t) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn efi_map_regions(count: *mut c_int, pg_shift: *mut c_int) -> *mut void  __init {
    static void * __init efi_map_regions(int *count, int *pg_shift)
    {
    void *p, *new_memmap = core::ptr::null_mut();
    let mut left: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn kexec_enter_virtual_mode() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn __efi_enter_virtual_mode() -> void __init {
    static void __init __efi_enter_virtual_mode(void)
    {
    let mut count: c_int = 0, pg_shift = 0;
    void *new_memmap = core::ptr::null_mut();
    efi_status_t status;
    unsigned long pa;
    if (efi_alloc_page_tables()) {
    pr_err("Failed to allocate EFI page tables\n");
...
#[no_mangle]
pub unsafe extern "C" fn efi_enter_virtual_mode() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn efi_is_table_address(phys_addr: c_ulong) -> bool {
    ...
    let mut efi_attr_fw_vendor: kobj_attribute = __ATTR_RO(fw_vendor);
    let mut efi_attr_runtime: kobj_attribute = __ATTR_RO(runtime);
    let mut efi_attr_config_table: kobj_attribute = __ATTR_RO(config_table);
#[no_mangle]
pub unsafe extern "C" fn efi_attr_is_visible(kobj: *mut kobject, attr: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
pub unsafe extern "C" fn __x86_efi_boot_mode() -> enum efi_secureboot_mode {
