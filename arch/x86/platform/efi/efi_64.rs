...
//! Source: arch/x86/platform/efi/efi_64.c
#![no_std]
...
//
    let mut efi_va: static u64 = EFI_VA_START;
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_sync_low_kernel_mappings() {
...
#[no_mangle]
unsafe extern "C" fn __map_region(md: *mut efi_memory_desc_t, va: u64) -> void __init {
    static void __init __map_region(efi_memory_desc_t *md, u64 va)
    {
    let mut flags: c_ulong = _PAGE_RW;
    unsigned long pfn;
    pgd_t *pgd = efi_mm.pgd;
//
...
pub unsafe extern "C" fn efi_map_region(md: *mut efi_memory_desc_t) -> void __init {
    ...
    {
    let mut size: c_ulong = md.num_pages << PAGE_SHIFT;
...
// Is PA 2M-aligned?
    ...
    let mut pa_offset: u64 = pa & (PMD_SIZE - 1);
    let mut prev_va: u64 = efi_va;
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_map_region_fixed(md: *mut efi_memory_desc_t) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn parse_efi_setup(phys_addr: u64, data_len: u32) -> void __init {
    void __init parse_efi_setup(u64 phys_addr, u32 data_len)
    {
    efi_setup = phys_addr + sizeof(struct setup_data);
    }
#[no_mangle]
unsafe extern "C" fn efi_update_mappings(md: *mut efi_memory_desc_t, pf: c_ulong) -> int __init {
...
// Update the 1:1 mapping
    ...
    let mut __ro_after_init: bool efi_disable_ibt_for_runtime = true;
    static int __init efi_update_mem_attr(struct mm_struct *mm, efi_memory_desc_t *md,
    bool has_ibt)
    {
    let mut pf: c_ulong = 0;
...
pub unsafe extern "C" fn efi_runtime_update_mappings() -> void __init {
    ...
    efi_memattr_apply_permissions(core::ptr::null_mut(), efi_update_mem_attr);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn efi_dump_pagetable() -> void __init {
    ...
    ptdump_walk_pgd_level(core::ptr::null_mut(), &efi_mm);
...
//
#[no_mangle]
unsafe extern "C" fn efi_enter_mm() {
    static void efi_enter_mm(void)
    {
    efi_prev_mm = use_temporary_mm(&efi_mm);
    }
#[no_mangle]
unsafe extern "C" fn efi_leave_mm() {
...
//
#[no_mangle]
unsafe extern "C" fn efi_disable_lass() {
...
#[no_mangle]
unsafe extern "C" fn efi_enable_lass() {
...
#[no_mangle]
unsafe extern "C" fn efi_thunk_get_time(tm: *mut efi_time_t, tc: *mut efi_time_cap_t) -> efi_status_t {
    static efi_status_t efi_thunk_get_time(efi_time_t *tm, efi_time_cap_t *tc)
    {
    return EFI_UNSUPPORTED;
    }
#[no_mangle]
unsafe extern "C" fn efi_thunk_set_time(tm: *mut efi_time_t) -> efi_status_t {
...
#[no_mangle]
unsafe extern "C" fn efi_name_size(name: *mut efi_char16_t) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn efi_thunk_runtime_setup() -> void __init {
