...
//! Source: arch/x86/platform/efi/quirks.c
#![no_std]
...
pub const EFI_MIN_RESERVE: c_int = 5120;

    EFI_GUID(0x4424ac57, 0xbe4b, 0x47dd, 0x9e, 0x97, 0xed, 0x50, 0xf0, 0x9f, 0x92, 0xa9)
pub const QUARK_CSH_SIGNATURE: c_uint = 0x5f435348	/* _CSH */;
pub const QUARK_SECURITY_HEADER_SIZE: c_uint = 0x400;
//
...
//
#[no_mangle]
unsafe extern "C" fn setup_storage_paranoia(arg: *mut c_char) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_delete_dummy_variable() {
    ...
    EFI_VARIABLE_RUNTIME_ACCESS, 0, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn efivar_reserved_space() -> u64 {
...
//
    let mut dummy_size: c_ulong = remaining_size + 1024;
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_arch_mem_reserve(addr: phys_addr_t, size: u64) -> void __init {
    void __init efi_arch_mem_reserve(phys_addr_t addr, u64 size)
    {
    let mut data: efi_memory_map_data = { 0 };
...
//
#[no_mangle]
unsafe extern "C" fn can_free_region(start: u64, size: u64) -> __init bool {
...
#[no_mangle]
pub unsafe extern "C" fn efi_reserve_boot_services() -> void __init {
    ...
    let mut start: u64 = md.phys_addr;
...
//
#[no_mangle]
unsafe extern "C" fn efi_unmap_pages(md: *mut efi_memory_desc_t) -> void __init {
    static void __init efi_unmap_pages(efi_memory_desc_t *md)
    {
    pgd_t *pgd = efi_mm.pgd;
    let mut pa: u64 = md.phys_addr;
    let mut va: u64 = md.virt_addr;
//
...
#[no_mangle]
pub unsafe extern "C" fn efi_unmap_boot_services() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn efi_free_boot_services() -> int __init {
    ...
    free_reserved_area(start, end, -1, core::ptr::null_mut());
    freed += (end - start);
    range++;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_reuse_config(tables: u64, nr_tables: c_int) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn efi_apply_memmap_quirks() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn efi_reboot_required() -> bool {
