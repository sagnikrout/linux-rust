...
//! Source: arch/x86/platform/olpc/olpc-xo1-sci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn battery_status_changed() {
...
#[no_mangle]
unsafe extern "C" fn ac_status_changed() {
...
#[no_mangle]
unsafe extern "C" fn send_ebook_state() {
    static void send_ebook_state(void)
    {
    unsigned char state;
    if (olpc_ec_cmd(EC_READ_EB_MODE, core::ptr::null_mut(), 0, &state, 1)) {
...
#[no_mangle]
unsafe extern "C" fn flip_lid_inverter() {
...
#[no_mangle]
unsafe extern "C" fn detect_lid_state() {
...
#[no_mangle]
unsafe extern "C" fn send_lid_state() {
...
//
#[no_mangle]
unsafe extern "C" fn process_sci_queue(propagate_events: bool) {
...
#[no_mangle]
unsafe extern "C" fn process_sci_queue_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xo1_sci_intr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// event on the rtc device.
    ...
    &platform_bus_type, core::ptr::null_mut(), "rtc_cmos");
    if (rtc) {
...
#[no_mangle]
unsafe extern "C" fn xo1_sci_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xo1_sci_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_sci_interrupt(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_ec_sci() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_ec_sci() {
    static void free_ec_sci(void)
    {
    gpio_free(OLPC_GPIO_ECSCI);
    }
#[no_mangle]
unsafe extern "C" fn setup_lid_events() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_lid_events() {
    static void free_lid_events(void)
    {
    gpio_free(OLPC_GPIO_LID);
    }
#[no_mangle]
unsafe extern "C" fn setup_power_button(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_power_button() {
    static void free_power_button(void)
    {
    input_unregister_device(power_button_idev);
    }
#[no_mangle]
unsafe extern "C" fn setup_ebook_switch(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_ebook_switch() {
    static void free_ebook_switch(void)
    {
    input_unregister_device(ebook_switch_idev);
    }
#[no_mangle]
unsafe extern "C" fn setup_lid_switch(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_lid_switch() {
    static void free_lid_switch(void)
    {
    input_unregister_device(lid_switch_idev);
    }
#[no_mangle]
unsafe extern "C" fn xo1_sci_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xo1_sci_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn xo1_sci_init() -> int __init {
