...
//! Source: arch/x86/platform/olpc/olpc_dt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn olpc_dt_getsibling(node: phandle) -> phandle __init {
...
#[no_mangle]
unsafe extern "C" fn olpc_dt_getchild(node: phandle) -> phandle __init {
...
#[no_mangle]
unsafe extern "C" fn olpc_dt_getproplen(node: phandle, prop: *const c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn olpc_dt_nextprop(node: phandle, prev: *mut c_char, buf: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn prom_early_alloc(size: c_ulong) -> *mut void  __init {
    ...
    void *res;
    if (free_mem < size) {
    let mut chunk_size: usize = max(PAGE_SIZE, size);
//
...
#[no_mangle]
unsafe extern "C" fn olpc_dt_finddevice(path: *const c_char) -> phandle __init {
...
#[no_mangle]
unsafe extern "C" fn olpc_dt_interpret(words: *const c_char) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn olpc_dt_get_board_revision() -> u32 __init {
...
#[no_mangle]
unsafe extern "C" fn olpc_dt_compatible_match(node: phandle, compat: *const c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn olpc_dt_fixup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn olpc_dt_build_devicetree() -> void __init {
