...
//! Source: arch/x86/platform/olpc/olpc_ofw.c
#![no_std]
...
pub const MAXARGS: c_int = 10;
#[no_mangle]
pub unsafe extern "C" fn setup_olpc_ofw_pgd() -> void __init {
...
// fetch OFW's PDE
    ...
    olpc_ofw_cif = core::ptr::null_mut();
    return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn olpc_ofw_present() -> bool {
    bool olpc_ofw_present(void)
    {
    return olpc_ofw_cif != core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(olpc_ofw_present);
// OFW cif _should_ be above this address
pub const OFW_MIN: c_uint = 0xff000000;
// OFW starts on a 1MB boundary

#[no_mangle]
pub unsafe extern "C" fn olpc_ofw_detect() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn olpc_ofw_is_installed() -> bool __init {
