...
//! Source: arch/x86/platform/uv/uv_nmi.c
#![no_std]
...
// UV hubless values
pub const NMI_CONTROL_PORT: c_uint = 0x70;
pub const NMI_DUMMY_PORT: c_uint = 0x71;
pub const PAD_OWN_GPP_D_0: c_uint = 0x2c;
pub const GPI_NMI_STS_GPP_D_0: c_uint = 0x164;
pub const GPI_NMI_ENA_GPP_D_0: c_uint = 0x174;
pub const STS_GPP_D_0_MASK: c_uint = 0x1;
pub const PAD_CFG_DW0_GPP_D_0: c_uint = 0x4c0;

pub const PCH_PCR_GPIO_1_BASE: c_uint = 0xfdae0000ul;
    ...
    let mut uv_nmi_cpu: static atomic_t = ATOMIC_INIT(-1);
    let mut uv_nmi_cpus_in_nmi: static atomic_t = ATOMIC_INIT(-1);
    static atomic_t uv_nmi_slave_continue;
    static cpumask_var_t uv_nmi_cpu_mask;
    static atomic_t uv_nmi_kexec_failed;
// Values for uv_nmi_slave_continue
pub const SLAVE_CLEAR: c_int = 0;
pub const SLAVE_CONTINUE: c_int = 1;
pub const SLAVE_EXIT: c_int = 2;
//
// Default is all stack dumps go to the console and buffer.
// Lower level to send to log buffer only.
//
    let mut uv_nmi_loglevel: static int = CONSOLE_LOGLEVEL_DEFAULT;
...
//
#[no_mangle]
unsafe extern "C" fn param_get_local64(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    static int param_get_local64(char *buffer, const struct kernel_param *kp)
    {
    return sprintf(buffer, "%lu\n", local64_read((local64_t *)kp.arg));
    }
#[no_mangle]
unsafe extern "C" fn param_set_local64(val: *const c_char, kp: *const kernel_param) -> c_int {
...
// Valid NMI Actions
    ...
    let mut uv_nmi_action: static enum action_t = nmi_act_dump;
#[no_mangle]
unsafe extern "C" fn param_get_action(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    static int param_get_action(char *buffer, const struct kernel_param *kp)
    {
    return sprintf(buffer, "%s\n", actions[uv_nmi_action]);
    }
#[no_mangle]
unsafe extern "C" fn param_set_action(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_setup_mmrs() {
    static void uv_nmi_setup_mmrs(void)
    {
    let mut new_nmi_method_only: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn uv_nmi_test_mmr(hub_nmi: *mut uv_hub_nmi_s) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uv_local_mmr_clear_nmi() {
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_reassert_nmi() {
...
#[no_mangle]
unsafe extern "C" fn uv_init_hubless_pch_io(offset: c_int, mask: c_int, data: c_int) {
    static void uv_init_hubless_pch_io(int offset, int mask, int data)
    {
    int *addr = PCH_PCR_GPIO_ADDRESS(offset);
    let mut readd: c_int = readl(addr);
    if (mask) {			/* OR in new data */
    let mut writed: c_int = (readd & ~mask) | data;
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_setup_hubless_intr() {
...
#[no_mangle]
unsafe extern "C" fn uv_init_hubless_pch_d0() {
...
#[no_mangle]
unsafe extern "C" fn uv_test_nmi(hub_nmi: *mut uv_hub_nmi_s) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uv_set_in_nmi(cpu: c_int, hub_nmi: *mut uv_hub_nmi_s) -> c_int {
    static int uv_set_in_nmi(int cpu, struct uv_hub_nmi_s *hub_nmi)
    {
    let mut first: c_int = atomic_add_unless(&hub_nmi.in_nmi, 1, 1);
    if (first) {
...
#[no_mangle]
unsafe extern "C" fn uv_check_nmi(hub_nmi: *mut uv_hub_nmi_s) -> c_int {
    static int uv_check_nmi(struct uv_hub_nmi_s *hub_nmi)
    {
    let mut cpu: c_int = smp_processor_id();
    let mut nmi: c_int = 0;
    let mut nmi_detected: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: nmi_detected <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn uv_clear_nmi(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_nr_cpus_ping() {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_cleanup_mask() {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_wait_cpus(first: c_int) -> c_int {
    static int uv_nmi_wait_cpus(int first)
    {
    int i, j, k, n = num_online_cpus();
    let mut last_k: c_int = 0, waiting = 0;
    let mut cpu: c_int = smp_processor_id();
    if (first) {
...
// PCH NMI causes only one CPU to respond
    ...
    let mut loop_delay: c_int = uv_nmi_loop_delay;
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_wait(master: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_dump_cpu_ip_hdr() {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_dump_cpu_ip(cpu: c_int, regs: *mut pt_regs) {
...
//
#[no_mangle]
unsafe extern "C" fn uv_nmi_dump_state_cpu(cpu: c_int, regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_trigger_dump(cpu: c_int) {
    static void uv_nmi_trigger_dump(int cpu)
    {
    let mut retry: c_int = uv_nmi_trigger_delay;
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_sync_exit(master: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_action_health(cpu: c_int, regs: *mut pt_regs, master: c_int) {
    static void uv_nmi_action_health(int cpu, struct pt_regs *regs, int master)
    {
    if (master) {
    let mut in: c_int = atomic_read(&uv_nmi_cpus_in_nmi);
    let mut out: c_int = num_online_cpus() - in;
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_dump_state(cpu: c_int, regs: *mut pt_regs, master: c_int) {
    static void uv_nmi_dump_state(int cpu, struct pt_regs *regs, int master)
    {
    if (master) {
    int tcpu;
    let mut ignored: c_int = 0;
    let mut saved_console_loglevel: c_int = console_loglevel;
    ...
    ignored++;
#[no_mangle]
pub unsafe extern "C" fn if(cpu: tcpu ==) -> else {
    else if (tcpu == cpu)
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_touch_watchdogs() {
...
#[no_mangle]
unsafe extern "C" fn uv_nmi_kdump(cpu: c_int, main: c_int, regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn uv_nmi_kdb_reason() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uv_call_kgdb_kdb(cpu: c_int, regs: *mut pt_regs, master: c_int) {
    static void uv_call_kgdb_kdb(int cpu, struct pt_regs *regs, int master)
    {
    if (master) {
    let mut reason: c_int = uv_nmi_kdb_reason();
    int ret;
    if (reason < 0)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn uv_call_kgdb_kdb(cpu: c_int, regs: *mut pt_regs, master: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn uv_handle_nmi(reason: c_uint, regs: *mut pt_regs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uv_handle_nmi_ping(reason: c_uint, regs: *mut pt_regs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uv_register_nmi_notifier() {
...
#[no_mangle]
pub unsafe extern "C" fn uv_nmi_init() {
...
// Setup HUB NMI info
#[no_mangle]
unsafe extern "C" fn uv_nmi_setup_common(hubbed: bool) -> void __init {
    static void __init uv_nmi_setup_common(bool hubbed)
    {
    let mut size: c_int = sizeof(void *) * (1 << NODES_SHIFT);
    int cpu;
    ...
    if (uv_hub_nmi_list[nid] == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn uv_nmi_setup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn uv_nmi_setup_hubless() -> void __init {
