...
//! Source: arch/x86/platform/intel/iosf_mbi.c
#![no_std]
...
pub const PCI_DEVICE_ID_INTEL_BAYTRAIL: c_uint = 0x0F00;
pub const PCI_DEVICE_ID_INTEL_BRASWELL: c_uint = 0x2280;
pub const PCI_DEVICE_ID_INTEL_QUARK_X1000: c_uint = 0x0958;
pub const PCI_DEVICE_ID_INTEL_TANGIER: c_uint = 0x1170;
    static struct pci_dev *mbi_pdev;
    static DEFINE_SPINLOCK(iosf_mbi_lock);
// Generic iosf_mbi access helpers
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_form_mcr(op: u8, port: u8, offset: u8) -> u32 {
    static inline u32 iosf_mbi_form_mcr(u8 op, u8 port, u8 offset)
    {
    return (op << 24) | (port << 16) | (offset << 8) | MBI_ENABLE;
    }
#[no_mangle]
unsafe extern "C" fn iosf_mbi_pci_read_mdr(mcrx: u32, mcr: u32, mdr: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iosf_mbi_pci_write_mdr(mcrx: u32, mcr: u32, mdr: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_read(port: u8, opcode: u8, offset: u32, mdr: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_write(port: u8, opcode: u8, offset: u32, mdr: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_modify(port: u8, opcode: u8, offset: u32, mdr: u32, mask: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_available() -> bool {
...
//
pub const SEMAPHORE_TIMEOUT: c_int = 500;
pub const PUNIT_SEMAPHORE_BYT: c_uint = 0x7;
pub const PUNIT_SEMAPHORE_CHT: c_uint = 0x10e;
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_punit_acquire() {
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_punit_release() {
...
#[no_mangle]
unsafe extern "C" fn iosf_mbi_get_sem(sem: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iosf_mbi_reset_semaphore() {
    ...
    MBI_PMIC_BUS_ACCESS_END, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_block_punit_i2c_access() -> c_int {
    ...
    goto success;
    blocking_notifier_call_chain(&iosf_mbi_pmic_bus_access_notifier,
    MBI_PMIC_BUS_ACCESS_BEGIN, core::ptr::null_mut());
//
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_unblock_punit_i2c_access() {
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_register_pmic_bus_access_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iosf_mbi_assert_punit_acquired() {
...
// iosf_mbi debug code
    ...
    static u32	dbg_mcrx;
#[no_mangle]
unsafe extern "C" fn mcr_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcr_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iosf_sideband_debug_init() {
    static void iosf_sideband_debug_init(void)
    {
    iosf_dbg = debugfs_create_dir("iosf_sb", core::ptr::null_mut());
// mdr
...
#[no_mangle]
unsafe extern "C" fn iosf_debugfs_init() {
    static void iosf_debugfs_init(void)
    {
    iosf_sideband_debug_init();
    }
#[no_mangle]
unsafe extern "C" fn iosf_debugfs_remove() {
...
#[no_mangle]
unsafe extern "C" fn iosf_mbi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iosf_mbi_exit() -> void __exit {
    static void __exit iosf_mbi_exit(void)
    {
    iosf_debugfs_remove();
    pci_unregister_driver(&iosf_mbi_pci_driver);
    pci_dev_put(mbi_pdev);
    mbi_pdev = core::ptr::null_mut();
