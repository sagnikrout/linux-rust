...
//! Source: arch/x86/net/bpf_jit_comp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_imm8(value: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn is_imm8_jmp_offset(value: c_int) -> bool {
    static bool is_imm8_jmp_offset(int value)
    {
    return value <= 123 && value >= -128;
    }
#[no_mangle]
unsafe extern "C" fn is_simm32(value: i64) -> bool {
    static bool is_simm32(s64 value)
    {
    let mut value: return = = (s64)(s32)value;
    }
#[no_mangle]
unsafe extern "C" fn is_uimm32(value: u64) -> bool {
    static bool is_uimm32(u64 value)
    {
    let mut value: return = = (u64)(u32)value;
    }
// mov dst, src
...
#[no_mangle]
unsafe extern "C" fn bpf_size_to_x86_bytes(bpf_size: c_int) -> c_int {
    static int bpf_size_to_x86_bytes(int bpf_size)
    {
    if (bpf_size == BPF_W)
    return 4;
#[no_mangle]
pub unsafe extern "C" fn if(BPF_H: bpf_size ==) -> else {
    else if (bpf_size == BPF_H)
    return 2;
#[no_mangle]
pub unsafe extern "C" fn if(BPF_B: bpf_size ==) -> else {
    else if (bpf_size == BPF_B)
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(BPF_DW: bpf_size ==) -> else {
...
//
pub const X86_JB: c_uint = 0x72;
pub const X86_JAE: c_uint = 0x73;
pub const X86_JE: c_uint = 0x74;
pub const X86_JNE: c_uint = 0x75;
pub const X86_JBE: c_uint = 0x76;
pub const X86_JA: c_uint = 0x77;
pub const X86_JL: c_uint = 0x7C;
pub const X86_JGE: c_uint = 0x7D;
pub const X86_JLE: c_uint = 0x7E;
pub const X86_JG: c_uint = 0x7F;
...
//
#[no_mangle]
unsafe extern "C" fn is_ereg(reg: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn is_ereg_8l(reg: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_axreg(reg: u32) -> bool {
    static bool is_axreg(u32 reg)
    {
    let mut reg: return = = BPF_REG_0;
    }
// Add modifiers if 'reg' maps to x86-64 registers R8..R15
#[no_mangle]
unsafe extern "C" fn add_1mod(byte: u8, reg: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn add_2mod(byte: u8, r1: u32, r2: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn add_3mod(byte: u8, r1: u32, r2: u32, index: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn add_1reg(byte: u8, dst_reg: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn add_2reg(byte: u8, dst_reg: u32, src_reg: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn jit_fill_hole(area: *mut c_void, size: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_arch_text_invalidate(dst: *mut c_void, len: usize) -> c_int {
...
pub struct jit_context {
    pub /: *mut *mut int cleanup_addr; / Epilogue code offset,
//
// Program specific offsets of labels in the code; these rely on the
// JIT doing at least 2 passes, recording the position on the first
// pass, only to generate the correct offset on the second pass.
//
    pub tail_call_direct_label: c_int,
    pub tail_call_indirect_label: c_int,
}

// Maximum number of bytes emitted while JITing one eBPF insn
pub const BPF_MAX_INSN_SIZE: c_int = 128;
pub const BPF_INSN_SAFETY: c_int = 64;
// Number of bytes emit_patch() needs to generate instructions
pub const X86_PATCH_SIZE: c_int = 5;
// Number of bytes that will be skipped on tailcall

#[no_mangle]
unsafe extern "C" fn push_r9(pprog: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn pop_r9(pprog: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn push_r12(pprog: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn push_callee_regs(pprog: *mut u8, callee_regs_used: *mut bool) {
...
#[no_mangle]
unsafe extern "C" fn pop_r12(pprog: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn pop_callee_regs(pprog: *mut u8, callee_regs_used: *mut bool) {
...
// add rsp, depth
#[no_mangle]
unsafe extern "C" fn emit_add_rsp(pprog: *mut u8, depth: u16) {
...
// sub rsp, depth
#[no_mangle]
unsafe extern "C" fn emit_sub_rsp(pprog: *mut u8, depth: u16) {
...
#[no_mangle]
unsafe extern "C" fn emit_nops(pprog: *mut u8, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_fineibt(pprog: *mut u8, ip: *mut u8, hash: u32, arity: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_kcfi(pprog: *mut u8, hash: u32) {
...
#[no_mangle]
unsafe extern "C" fn emit_cfi(pprog: *mut u8, ip: *mut u8, hash: u32, arity: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_prologue_tail_call(pprog: *mut u8, is_subprog: bool) {
...
#[no_mangle]
unsafe extern "C" fn emit_patch(pprog: *mut u8, func: *mut c_void, ip: *mut c_void, opcode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emit_call(pprog: *mut u8, func: *mut c_void, ip: *mut c_void) -> c_int {
    static int emit_call(u8 **pprog, void *func, void *ip)
    {
    return emit_patch(pprog, func, ip, 0xE8);
    }
#[no_mangle]
unsafe extern "C" fn emit_rsb_call(pprog: *mut u8, func: *mut c_void, ip: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emit_jump(pprog: *mut u8, func: *mut c_void, ip: *mut c_void) -> c_int {
    ...
    smp_text_poke_single(ip, new_insn, X86_PATCH_SIZE, core::ptr::null_mut());
    ret = 0;
    }
    out:
...
#[no_mangle]
unsafe extern "C" fn __emit_indirect_jump(pprog: *mut u8, reg: c_int, ereg: bool) {
...
#[no_mangle]
unsafe extern "C" fn emit_indirect_jump(pprog: *mut u8, bpf_reg: c_int, ip: *mut u8) {
    static void emit_indirect_jump(u8 **pprog, int bpf_reg, u8 *ip)
    {
    u8 *prog = *pprog;
    let mut reg: c_int = reg2hex[bpf_reg];
    let mut ereg: bool = is_ereg(bpf_reg);
...
#[no_mangle]
unsafe extern "C" fn emit_return(pprog: *mut u8, ip: *mut u8) {
...
//
    ...
    {
    let mut tcc_ptr_off: c_int = BPF_TAIL_CALL_CNT_PTR_STACK_OFF(stack_depth);
...
#[no_mangle]
unsafe extern "C" fn bpf_tail_call_direct_fixup(prog: *mut bpf_prog) {
    ...
    X86_PATCH_SIZE, core::ptr::null_mut());
    BUG_ON(ret < 0);
    }
...
// pprog = prog;
    ...
    {
    let mut imm64: u64 = ((u64)imm32_hi << 32) | (u32)imm32_lo;
    u8 *prog = *pprog;
    if (is_uimm32(imm64)) {
//
...
#[no_mangle]
unsafe extern "C" fn emit_mov_reg(pprog: *mut u8, is64: bool, dst_reg: u32, src_reg: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(16: num_bits ==) -> else {
    else if (num_bits == 16)
    EMIT4(add_2mod(0x48, src_reg, dst_reg), 0x0f, 0xbf,
    add_2reg(0xC0, src_reg, dst_reg));
#[no_mangle]
pub unsafe extern "C" fn if(32: num_bits ==) -> else {
    else if (num_bits == 32)
...
#[no_mangle]
unsafe extern "C" fn emit_insn_suffix(pprog: *mut u8, ptr_reg: u32, val_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_insn_suffix_SIB(pprog: *mut u8, ptr_reg: u32, val_reg: u32, index_reg: u32, off: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn maybe_emit_mod(pprog: *mut u8, dst_reg: u32, src_reg: u32, is64: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(is_ereg(src_reg): is_ereg(dst_reg) ||) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn maybe_emit_1mod(pprog: *mut u8, reg: u32, is64: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_ereg(reg)) -> else {
    else if (is_ereg(reg))
...
#[no_mangle]
unsafe extern "C" fn emit_ldx(pprog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_ldsx(pprog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_ldx_index(pprog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, index_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_ldsx_index(pprog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, index_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_ldx_r12(pprog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_ldsx_r12(prog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_stx(pprog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_stx_index(pprog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, index_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_stx_r12(pprog: *mut u8, size: u32, dst_reg: u32, src_reg: u32, off: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_st_index(pprog: *mut u8, size: u32, dst_reg: u32, index_reg: u32, off: c_int, imm: c_int) {
...
#[no_mangle]
unsafe extern "C" fn emit_st_r12(pprog: *mut u8, size: u32, dst_reg: u32, off: c_int, imm: c_int) {
    static void emit_st_r12(u8 **pprog, u32 size, u32 dst_reg, int off, int imm)
    {
    emit_st_index(pprog, size, dst_reg, X86_REG_R12, off, imm);
    }
#[no_mangle]
unsafe extern "C" fn emit_store_stack_imm64(pprog: *mut u8, reg: c_int, stack_off: c_int, imm64: u64) {
...
//
pub const DONT_CLEAR: c_int = 1;

#[no_mangle]
pub unsafe extern "C" fn ex_handler_bpf(x: *const exception_table_entry, regs: *mut pt_regs) -> bool {
    bool ex_handler_bpf(const struct exception_table_entry *x, struct pt_regs *regs)
    {
    let mut reg: u32 = FIELD_GET(FIXUP_REG_MASK, x.fixup);
    let mut insn_len: u32 = FIELD_GET(FIXUP_INSN_LEN_MASK, x.fixup);
    let mut is_arena: bool = !!(x.fixup & FIXUP_ARENA_ACCESS);
    let mut is_write: bool = !!(x.fixup & FIXUP_ARENA_WRITE);
    unsigned long addr;
    s16 off;
    u32 arena_reg;
    if (is_arena) {
...
//
    ...
    u8 b1, b2;
    let mut vvvv: u8 = reg2hex[src_reg2];
...
#[no_mangle]
unsafe extern "C" fn emit_shiftx(pprog: *mut u8, dst_reg: u32, src_reg: u8, is64: bool, op: u8) {
    static void emit_shiftx(u8 **pprog, u32 dst_reg, u8 src_reg, bool is64, u8 op)
    {
    u8 *prog = *pprog;
    let mut r: bool = is_ereg(dst_reg);
...
#[no_mangle]
unsafe extern "C" fn emit_priv_frame_ptr(pprog: *mut u8, priv_frame_ptr: *mut void __percpu) {
...
pub const PRIV_STACK_GUARD_SZ: c_int = 8;
...
//
    ...
    let mut flags: u8 = fm.arg_flags[i];
    let mut reg: u32 = BPF_REG_1 + i;
...
// pprog = prog;
    ...
    {
    let mut tail_call_reachable: bool = bpf_prog.aux.tail_call_reachable;
    struct bpf_insn *insn = bpf_prog.insnsi;
    bool callee_regs_used[4] = {};
    let mut insn_cnt: c_int = bpf_prog.len;
    let mut seen_exit: bool = false;
    u8 temp[BPF_MAX_INSN_SIZE + BPF_INSN_SAFETY];
    void __percpu *priv_frame_ptr = core::ptr::null_mut();
...
//
    ...
    prog = temp;
    for (i = 1; i <= insn_cnt; i++, insn++) {
    let mut imm32: i32 = insn.imm;
    let mut dst_reg: u32 = insn.dst_reg;
    let mut src_reg: u32 = insn.src_reg;
    let mut b2: u8 = 0, b3 = 0;
    u8 *start_of_ldx;
    s64 jmp_offset;
    s32 insn_off;
    u8 jmp_cond;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_axreg(dst_reg)) -> else {
...
// shrx/sarx/shlx dst_reg, dst_reg, src_reg
    let mut w: bool = (BPF_CLASS(insn.code) == BPF_ALU64);
    u8 op;
    switch (BPF_OP(insn.code)) {
    case BPF_LSH:
    op = 1; /* prefix 0x66 */
...
//
    let mut load_reg: c_int = bpf_atomic_load_reg(insn);
...
//
    let mut limit: u64 = TASK_SIZE_MAX + PAGE_SIZE - VSYSCALL_ADDR;
    u8 *end_of_jmp;
...
//
    ...
    let mut is64: bool = BPF_SIZE(insn.code) == BPF_DW;
    let mut real_src_reg: u32 = src_reg;
    let mut real_dst_reg: u32 = dst_reg;
    u8 *branch_target;
//
...
#[no_mangle]
unsafe extern "C" fn get_nr_used_regs(m: *const btf_func_model) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn emit_arena_arg_conv(pprog: *mut u8, src_reg: u32, nullable: bool, base_lo: u32) {
...
// pprog = prog;
    ...
    let mut use_jmp: bool = bpf_trampoline_use_jmp(flags);
    let mut stack_args_off: c_int = (use_jmp || (flags & BPF_TRAMP_F_INDIRECT)) ? 16 : 24;
    int i, j;
...
//
    for (i = 0; i < min_t(int, m.nr_args, MAX_BPF_FUNC_ARGS); i++) {
    let mut arena_arg: bool = arena_base && (m.arg_flags[i] & BTF_FMODEL_ARENA_ARG);
    let mut nullable: bool = m.arg_flags[i] & BTF_FMODEL_NULLABLE_ARG;
    arg_regs = (m.arg_size[i] + 7) / 8;
...
// copy the arguments from regs into stack
    for (j = 0; j < arg_regs; j++) {
    let mut src: u32 = nr_regs == 5 ? X86_REG_R9 : BPF_REG_1 + nr_regs;
    if (arena_arg) {
...
//
    ...
    u8 *prog = *pprog;
    u8 *jmp_insn;
    let mut ctx_cookie_off: c_int = offsetof(struct bpf_tramp_run_ctx, bpf_cookie);
    struct bpf_prog *p = node.link.prog;
    let mut cookie: u64 = node.cookie;
// mov rdi, cookie
...
#[no_mangle]
unsafe extern "C" fn emit_align(pprog: *mut u8, align: u32) {
...
#[no_mangle]
unsafe extern "C" fn emit_cond_near_jump(pprog: *mut u8, func: *mut c_void, ip: *mut c_void, jmp_cond: u8) -> c_int {
...
// __fentry__ call.
//
    x86_call_depth_emit_accounting(&prog, core::ptr::null_mut(), image);
    }
    EMIT1(0x55);		 /* push rbp */
    EMIT3(0x48, 0x89, 0xE5); /* mov rbp, rsp */
    if (im)
...
#[no_mangle]
pub unsafe extern "C" fn arch_free_bpf_trampoline(image: *mut c_void, size: c_uint) {
    void arch_free_bpf_trampoline(void *image, unsigned int size)
    {
    bpf_prog_pack_free(image, size);
    }
#[no_mangle]
pub unsafe extern "C" fn arch_protect_bpf_trampoline(image: *mut c_void, size: c_uint) -> c_int {
    ...
    void *rw_image, *tmp;
    int ret;
    let mut size: u32 = image_end - image;
...
#[no_mangle]
unsafe extern "C" fn emit_bpf_dispatcher(pprog: *mut u8, a: c_int, b: c_int, progs: *mut i64, image: *mut u8, buf: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_ips(a: *const c_void, b: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arch_prepare_bpf_dispatcher(image: *mut c_void, buf: *mut c_void, funcs: *mut i64, num_funcs: c_int) -> c_int {
    int arch_prepare_bpf_dispatcher(void *image, void *buf, s64 *funcs, int num_funcs)
    {
    u8 *prog = buf;
    sort(funcs, num_funcs, sizeof(funcs[0]), cmp_ips, core::ptr::null_mut());
    return emit_bpf_dispatcher(&prog, 0, num_funcs - 1, funcs, image, buf);
    }
#[no_mangle]
unsafe extern "C" fn priv_stack_init_guard(priv_stack_ptr: *mut void __percpu, alloc_size: c_int) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct x64_jit_data {
    pub rw_header: *mut bpf_binary_header,
...
pub const MAX_PASSES: c_int = 20;

    struct bpf_prog *bpf_int_jit_compile(struct bpf_verifier_env *env, struct bpf_prog *prog)
    {
    struct bpf_binary_header *rw_header = core::ptr::null_mut();
    struct bpf_binary_header *header = core::ptr::null_mut();
    void __percpu *priv_stack_ptr = core::ptr::null_mut();
    struct x64_jit_data *jit_data;
    int priv_stack_alloc_sz;
    int proglen, oldproglen = 0;
    let mut ctx: jit_context = {};
    let mut extra_pass: bool = false;
    let mut padding: bool = false;
    u8 *rw_image = core::ptr::null_mut();
    u8 *image = core::ptr::null_mut();
    int *addrs;
    int pass;
    int i;
...
//
    let mut align: u32 = __alignof__(struct exception_table_entry);
...
//
    ...
    prog.aux.priv_stack_ptr = core::ptr::null_mut();
    }
    out_priv_stack:
    kfree(jit_data);
...
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_kfunc_call() -> bool {
    bool bpf_jit_supports_kfunc_call(void)
    {
    return true;
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_stack_args() -> bool {
    bool bpf_jit_supports_stack_args(void)
    {
    return true;
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_arena_args() -> bool {
    ...
    {
    if (text_poke_copy(dst, src, len) == core::ptr::null_mut())
    return ERR_PTR(-EINVAL);
    return dst;
    }
// Indicate the JIT backend supports mixing bpf2bpf and tailcalls.
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_subprog_tailcalls() -> bool {
    bool bpf_jit_supports_subprog_tailcalls(void)
    {
    return true;
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_percpu_insn() -> bool {
    bool bpf_jit_supports_percpu_insn(void)
    {
    return true;
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_free(prog: *mut bpf_prog) {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_exceptions() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_private_stack() -> bool {
    bool bpf_jit_supports_private_stack(void)
    {
    return true;
    }
#[no_mangle]
pub unsafe extern "C" fn arch_bpf_stack_walk(cookie: *mut *mut bool (consume_fn)(void, ip: u64, sp: u64, bp): u64, cookie: *mut c_void) {
    void arch_bpf_stack_walk(bool (*consume_fn)(void *cookie, u64 ip, u64 sp, u64 bp), void *cookie)
    {

    struct unwind_state state;
    unsigned long addr;
    for (unwind_start(&state, current, core::ptr::null_mut(), core::ptr::null_mut()); !unwind_done(&state);
    ...
    int ret;
    old_bypass_addr = old ? core::ptr::null_mut() : poke.bypass_addr;
    old_addr = old ? (u8 *)old.bpf_func + poke.adj_off : core::ptr::null_mut();
    new_addr = new ? (u8 *)new.bpf_func + poke.adj_off : core::ptr::null_mut();
//
...
//
    ...
    t = old_addr ? BPF_MOD_JUMP : BPF_MOD_NOP;
    ret = __bpf_arch_text_poke(poke.tailcall_target,
    t, BPF_MOD_NOP, old_addr, core::ptr::null_mut());
    BUG_ON(ret < 0);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_arena() -> bool {
    bool bpf_jit_supports_arena(void)
    {
    return true;
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_insn(insn: *mut bpf_insn, in_arena: bool) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_ptr_xchg() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bpf_arch_uaddress_limit() -> u64 {
    u64 bpf_arch_uaddress_limit(void)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_timed_may_goto() -> bool {
    bool bpf_jit_supports_timed_may_goto(void)
    {
    return true;
    }
#[no_mangle]
pub unsafe extern "C" fn bpf_jit_supports_fsession() -> bool {
