...
//! Source: arch/loongarch/kernel/perf_event.c
#![no_std]
...
pub const LOONGARCH_MAX_HWEVENTS: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpu_hw_events {
// Array of events on this cpu.
    pub events: [*mut perf_event; LOONGARCH_MAX_HWEVENTS],
//
// Set the bit (indexed by the counter number) when the counter
// is used for an event.
//
    pub used_mask: [c_ulong; BITS_TO_LONGS(LOONGARCH_MAX_HWEVENTS)],
//
// Software copy of the control register for each performance counter.
//
    pub saved_ctrl: [c_uint; LOONGARCH_MAX_HWEVENTS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongarch_perf_event {
    pub event_id: c_uint,
}
...
pub const HW_OP_UNSUPPORTED: c_uint = 0xffffffff;
pub const CACHE_OP_UNSUPPORTED: c_uint = 0xffffffff;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongarch_pmu {
    pub max_period: u64,
    pub valid_count: u64,
    pub overflow: u64,
    pub name: *const c_char,
    pub num_counters: c_uint,
    pub idx): *mut *mut u64 (read_counter)(unsigned int,
    pub val): *mut *mut void (write_counter)(unsigned int idx, u64,
    pub config): *const *const *const loongarch_perf_event (map_raw_event)(u64,
    pub (*general_event_map)[PERF_COUNT_HW_MAX]: *const loongarch_perf_event,
#[no_mangle]
pub unsafe extern "C" fn loongarch_perf_event(_arg: *mut cache_event_map) -> struct {
    ...
    CSR_PERFCTRL_PLV3 |	\
    CSR_PERFCTRL_IE)
pub const M_PERFCTL_CONFIG_MASK: c_uint = 0x1f0000;
    static void pause_local_counters(void);
    static void resume_local_counters(void);
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_read_counter(idx: c_uint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_write_counter(idx: c_uint, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_read_control(idx: c_uint) -> c_uint {
    static unsigned int loongarch_pmu_read_control(unsigned int idx)
    {
    let mut val: c_uint = -1;
    switch (idx) {
    case 0:
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_write_control(idx: c_uint, val: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_alloc_counter(cpuc: *mut cpu_hw_events, hwc: *mut hw_perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_enable_event(evt: *mut hw_perf_event, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_disable_event(idx: c_int) {
    ...
    {
    let mut ret: c_int = 0;
    let mut left: u64 = local64_read(&hwc.period_left);
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_del(event: *mut perf_event, flags: c_int) {
    ...
    cpuc.events[idx] = core::ptr::null_mut();
    clear_bit(idx, cpuc.used_mask);
    perf_event_update_userpage(event);
    }
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_read(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_enable(pmu: *mut pmu) {
    static void loongarch_pmu_enable(struct pmu *pmu)
    {
    resume_local_counters();
    }
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_disable(pmu: *mut pmu) {
    static void loongarch_pmu_disable(struct pmu *pmu)
    {
    pause_local_counters();
    }
    static DEFINE_MUTEX(pmu_reserve_mutex);
    let mut active_events: static atomic_t = ATOMIC_INIT(0);
...
unsafe extern "C" fn hw_perf_event_destroy(event: *mut perf_event) {
    ...
    on_each_cpu(reset_counters, core::ptr::null_mut(), 1);
...
#[no_mangle]
unsafe extern "C" fn pmu_handle_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongarch_pmu_perf_event_encode(pev: *const loongarch_perf_event) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn loongarch_pmu_event_requires_counter(event: *const perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn reset_counters(arg: *mut c_void) {
    static void reset_counters(void *arg)
    {
    int n;
    let mut counters: c_int = loongarch_pmu.num_counters;
...
#[no_mangle]
unsafe extern "C" fn pause_local_counters() {
    static void pause_local_counters(void)
    {
    unsigned long flags;
    let mut ctr: c_int = loongarch_pmu.num_counters;
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
    local_irq_save(flags);
    do {
    ctr--;
...
#[no_mangle]
unsafe extern "C" fn resume_local_counters() {
    static void resume_local_counters(void)
    {
    let mut ctr: c_int = loongarch_pmu.num_counters;
    struct cpu_hw_events *cpuc = this_cpu_ptr(&cpu_hw_events);
