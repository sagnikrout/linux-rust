...
//! Source: arch/loongarch/kernel/alternative.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn add_nops(insn: *mut union loongarch_instruction, count: c_int) -> void __init_or_module {
...
#[no_mangle]
pub unsafe extern "C" fn in_alt_jump(jump: c_ulong, start: *mut c_void, end: *mut c_void) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn apply_alternatives(start: *mut alt_instr, end: *mut alt_instr) -> void __init_or_module {
