...
//! Source: arch/loongarch/kernel/acpi.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn __acpi_map_table(phys: c_ulong, size: c_ulong) -> *mut void __init __iomem {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_add_early_pio() {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_remove_early_pio() {
...
#[no_mangle]
unsafe extern "C" fn set_processor_mask(id: u32, pass: u32) -> c_int {
    static int set_processor_mask(u32 id, u32 pass)
    {
    let mut cpu: c_int = -1, cpuid = id;
    ...
    {
    struct acpi_madt_core_pic *processor = core::ptr::null_mut();
    ...
    {
    let mut core: static int = 0;
    struct acpi_madt_eio_pic *eiointc = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn parse_acpi_topology() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_map_cpu2node(handle: acpi_handle, cpu: c_int, physid: c_int) -> int __ref {
