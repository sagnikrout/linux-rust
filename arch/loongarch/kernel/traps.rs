...
//! Source: arch/loongarch/kernel/traps.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn show_code(pc: *mut c_uint, user: bool) {
...
#[no_mangle]
unsafe extern "C" fn print_bool_fragment(key: *const c_char, val: c_ulong, first: bool) {
...
#[no_mangle]
unsafe extern "C" fn print_plv_fragment(key: *const c_char, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn print_memory_type_fragment(key: *const c_char, val: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn print_intr_fragment(key: *const c_char, val: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn print_crmd(x: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn print_prmd(x: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn print_euen(x: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn print_ecfg(x: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn print_estat(x: c_ulong) {
    static void print_estat(unsigned long x)
    {
    let mut ecode: c_uint = FIELD_GET(CSR_ESTAT_EXC, x);
    let mut esubcode: c_uint = FIELD_GET(CSR_ESTAT_ESUBCODE, x);
...
#[no_mangle]
unsafe extern "C" fn __show_regs(regs: *const pt_regs) {
    static void __show_regs(const struct pt_regs *regs)
    {
    let mut field: c_int = 2 * sizeof(unsigned long);
    let mut exccode: c_uint = FIELD_GET(CSR_ESTAT_EXC, regs.csr_estat);
...
#[no_mangle]
pub unsafe extern "C" fn die(str: *const c_char, regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn setup_vint_size(size: c_uint) {
...
//
    ...
    {
    let mut si_code: c_int = FPE_FLTUNK;
    if (fcsr & FPU_CSR_INV_X)
    si_code = FPE_FLTINV;
#[no_mangle]
pub unsafe extern "C" fn if(FPU_CSR_DIV_X: fcsr &) -> else {
    else if (fcsr & FPU_CSR_DIV_X)
    si_code = FPE_FLTDIV;
#[no_mangle]
pub unsafe extern "C" fn if(FPU_CSR_OVF_X: fcsr &) -> else {
    else if (fcsr & FPU_CSR_OVF_X)
    si_code = FPE_FLTOVF;
#[no_mangle]
pub unsafe extern "C" fn if(FPU_CSR_UDF_X: fcsr &) -> else {
    else if (fcsr & FPU_CSR_UDF_X)
    si_code = FPE_FLTUND;
#[no_mangle]
pub unsafe extern "C" fn if(FPU_CSR_INE_X: fcsr &) -> else {
    else if (fcsr & FPU_CSR_INE_X)
    si_code = FPE_FLTRES;
    force_sig_fault(SIGFPE, si_code, fault_addr);
    }
#[no_mangle]
unsafe extern "C" fn process_fpemu_return(sig: c_int, fault_addr: *mut void __user, fcsr: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn do_fpe(regs: *mut pt_regs, fcsr: c_ulong) -> asmlinkage void noinstr {
...
#[no_mangle]
pub unsafe extern "C" fn do_ade(regs: *mut pt_regs) -> asmlinkage void noinstr {
    asmlinkage void noinstr do_ade(struct pt_regs *regs)
    {
    let mut state: irqentry_state_t = irqentry_enter(regs);
    let mut esubcode: c_uint = FIELD_GET(CSR_ESTAT_ESUBCODE, regs.csr_estat);
...
#[no_mangle]
pub unsafe extern "C" fn do_ale(regs: *mut pt_regs) -> asmlinkage void noinstr {
    ...
    let mut pie: bool = regs_irqs_disabled(regs);
    unsigned int *pc;
    if (!pie)
    local_irq_enable();
...
#[no_mangle]
unsafe extern "C" fn bug_handler(regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn do_bce(regs: *mut pt_regs) -> asmlinkage void noinstr {
    asmlinkage void noinstr do_bce(struct pt_regs *regs)
    {
    let mut user: bool = user_mode(regs);
    let mut pie: bool = regs_irqs_disabled(regs);
    let mut era: c_ulong = exception_era(regs);
    let mut badv: c_ulong = 0, lower = 0, upper = ULONG_MAX;
...
#[no_mangle]
pub unsafe extern "C" fn do_bp(regs: *mut pt_regs) -> asmlinkage void noinstr {
...
#[no_mangle]
pub unsafe extern "C" fn do_watch(regs: *mut pt_regs) -> asmlinkage void noinstr {
    ...
    let mut llbit: c_int = (csr_read32(LOONGARCH_CSR_LLBCTL) & 0x1);
...
#[no_mangle]
pub unsafe extern "C" fn do_ri(regs: *mut pt_regs) -> asmlinkage void noinstr {
    asmlinkage void noinstr do_ri(struct pt_regs *regs)
    {
    let mut status: c_int = SIGILL;
...
#[no_mangle]
unsafe extern "C" fn init_restore_fp() {
...
#[no_mangle]
unsafe extern "C" fn init_restore_lsx() {
...
#[no_mangle]
unsafe extern "C" fn init_restore_lasx() {
...
#[no_mangle]
pub unsafe extern "C" fn do_fpu(regs: *mut pt_regs) -> asmlinkage void noinstr {
...
#[no_mangle]
pub unsafe extern "C" fn do_lsx(regs: *mut pt_regs) -> asmlinkage void noinstr {
...
#[no_mangle]
pub unsafe extern "C" fn do_lasx(regs: *mut pt_regs) -> asmlinkage void noinstr {
...
#[no_mangle]
unsafe extern "C" fn init_restore_lbt() {
...
#[no_mangle]
pub unsafe extern "C" fn do_lbt(regs: *mut pt_regs) -> asmlinkage void noinstr {
...
#[no_mangle]
pub unsafe extern "C" fn do_reserved(regs: *mut pt_regs) -> asmlinkage void noinstr {
...
#[no_mangle]
pub unsafe extern "C" fn cache_parity_error() -> asmlinkage void {
    asmlinkage void cache_parity_error(void)
    {
    let mut merrctl: u32 = csr_read32(LOONGARCH_CSR_MERRCTL);
    let mut merrera: c_ulong = csr_read(LOONGARCH_CSR_MERRERA);
...
#[no_mangle]
pub unsafe extern "C" fn handle_loongarch_irq(regs: *mut pt_regs) -> asmlinkage void noinstr {
...
#[no_mangle]
pub unsafe extern "C" fn do_vint(regs: *mut pt_regs, sp: c_ulong) -> asmlinkage void noinstr {
...
#[no_mangle]
unsafe extern "C" fn configure_exception_vector() {
...
#[no_mangle]
pub unsafe extern "C" fn per_cpu_trap_init(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn set_handler(offset: c_ulong, addr: *mut c_void, size: c_ulong) {
    ...
    "Trying to set core::ptr::null_mut() cache error exception handler\n";
//
...
//
#[no_mangle]
pub unsafe extern "C" fn set_merr_handler(offset: c_ulong, addr: *mut c_void, size: c_ulong) {
    void set_merr_handler(unsigned long offset, void *addr, unsigned long size)
    {
    let mut uncached_eentry: c_ulong = TO_UNCACHE(__pa(eentry));
    if (!addr)
