...
//! Source: arch/loongarch/kernel/kgdb.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn dbg_set_reg(regno: c_int, mem: *mut c_void, regs: *mut pt_regs) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sleeping_thread_to_gdb_regs(gdb_regs: *mut c_ulong, p: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn kgdb_arch_set_pc(regs: *mut pt_regs, pc: c_ulong) {
    void kgdb_arch_set_pc(struct pt_regs *regs, unsigned long pc)
    {
    regs.csr_era = pc;
    }
#[no_mangle]
pub unsafe extern "C" fn arch_kgdb_breakpoint() -> noinline void {
...
//
#[no_mangle]
unsafe extern "C" fn kgdb_loongarch_notify(self: *mut notifier_block, cmd: c_ulong, ptr: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kgdb_breakpoint_handler(regs: *mut pt_regs) -> bool {
    ...
    return (kgdb_loongarch_notify(core::ptr::null_mut(), DIE_TRAP, &args) == NOTIFY_STOP) ? true : false;
    }
...
#[no_mangle]
unsafe extern "C" fn get_step_address(regs: *mut pt_regs, next_addr: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_single_step(regs: *mut pt_regs) -> c_int {
...
// Undo a single step
#[no_mangle]
unsafe extern "C" fn undo_single_step(regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn hw_break_reserve_slot(breakno: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hw_break_release_slot(breakno: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_set_hw_break(addr: c_ulong, len: c_int, bptype: enum kgdb_bptype) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_remove_hw_break(addr: c_ulong, len: c_int, bptype: enum kgdb_bptype) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdb_disable_hw_break(regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn kgdb_remove_all_hw_break() {
...
#[no_mangle]
unsafe extern "C" fn kgdb_correct_hw_break() {
...
#[no_mangle]
pub unsafe extern "C" fn kgdb_arch_init() -> c_int {
    int kgdb_arch_init(void)
    {
    return register_die_notifier(&kgdb_notifier);
    }
#[no_mangle]
pub unsafe extern "C" fn kgdb_arch_late() {
    ...
    if (breakinfo[i].pev)
    continue;
    breakinfo[i].pev = register_wide_hw_breakpoint(&attr, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR_PCPU(breakinfo[i].pev)) {
    pr_err("kgdb: Could not allocate hw breakpoints.\n");
    breakinfo[i].pev = core::ptr::null_mut();
    return;
    }
    for_each_online_cpu(cpu) {
    pevent = per_cpu_ptr(breakinfo[i].pev, cpu);
    if (pevent[0].destroy) {
    pevent[0].destroy = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn kgdb_arch_exit() {
