...
//! Source: arch/loongarch/kernel/smp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn show_ipi_list(p: *mut seq_file, prec: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn set_cpu_core_map(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn set_cpu_llc_shared_map(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_cpu_llc_shared_map(cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_cpu_sibling_map(cpu: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn calculate_cpu_foreign_map() {
...
#[no_mangle]
unsafe extern "C" fn csr_mail_send(data: u64, cpu: c_int, mailbox: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ipi_read_clear(cpu: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ipi_write_action(cpu: c_int, action: u32) {
...
#[no_mangle]
unsafe extern "C" fn loongson_send_ipi_single(cpu: c_int, action: c_uint) {
    static void loongson_send_ipi_single(int cpu, unsigned int action)
    {
    ipi_write_action(cpu_logical_map(cpu), (u32)action);
    }
#[no_mangle]
unsafe extern "C" fn loongson_send_ipi_mask(mask: *const cpumask, action: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn loongson_ipi_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn loongson_init_ipi() {
...
#[no_mangle]
unsafe extern "C" fn fdt_smp_setup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn loongson_smp_setup() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn loongson_prepare_cpus(max_cpus: c_uint) -> void __init {
    void __init loongson_prepare_cpus(unsigned int max_cpus)
    {
    let mut i: c_int = 0;
    let mut threads_per_core: c_int = 0;
    parse_acpi_topology();
...
//
#[no_mangle]
pub unsafe extern "C" fn loongson_boot_secondary(cpu: c_int, idle: *mut task_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn loongson_init_secondary() {
...
#[no_mangle]
pub unsafe extern "C" fn loongson_smp_finish() {
...
#[no_mangle]
pub unsafe extern "C" fn loongson_cpu_disable() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn loongson_cpu_die(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn idle_play_dead() -> void __noreturn {
...
#[no_mangle]
unsafe extern "C" fn poll_play_dead() -> void __noreturn {
...
#[no_mangle]
unsafe extern "C" fn loongson_ipi_suspend(data: *mut c_void) -> c_int {
    static int loongson_ipi_suspend(void *data)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn loongson_ipi_resume(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn ipi_pm_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn start_secondary() -> asmlinkage void {
...
#[no_mangle]
unsafe extern "C" fn flush_tlb_all_ipi(info: *mut c_void) {
...
pub unsafe extern "C" fn flush_tlb_all() {
    ...
    {
    on_each_cpu(flush_tlb_all_ipi, core::ptr::null_mut(), 1);
    }
#[no_mangle]
unsafe extern "C" fn flush_tlb_mm_ipi(mm: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn flush_tlb_range_ipi(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn flush_tlb_kernel_range_ipi(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn flush_tlb_page_ipi(info: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn flush_tlb_page(vma: *mut vm_area_struct, page: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn flush_tlb_one_ipi(info: *mut c_void) {
    static void flush_tlb_one_ipi(void *info)
    {
    let mut vaddr: c_ulong = (unsigned long) info;
    local_flush_tlb_one(vaddr);
    }
#[no_mangle]
pub unsafe extern "C" fn flush_tlb_one(vaddr: c_ulong) {
