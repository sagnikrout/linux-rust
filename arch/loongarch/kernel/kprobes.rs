...
//! Source: arch/loongarch/kernel/kprobes.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn arch_prepare_ss_slot(p: *mut kprobe) {
...
#[no_mangle]
unsafe extern "C" fn arch_prepare_simulate(p: *mut kprobe) {
...
pub unsafe extern "C" fn arch_arm_kprobe(p: *mut kprobe) {
    ...
    {
    let mut insn: u32 = KPROBE_BP_INSN;
...
#[no_mangle]
unsafe extern "C" fn save_previous_kprobe(kcb: *mut kprobe_ctlblk) {
...
#[no_mangle]
unsafe extern "C" fn restore_previous_kprobe(kcb: *mut kprobe_ctlblk) {
...
#[no_mangle]
unsafe extern "C" fn set_current_kprobe(p: *mut kprobe) {
...
#[no_mangle]
pub unsafe extern "C" fn kprobe_breakpoint_handler(regs: *mut pt_regs) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kprobe_singlestep_handler(regs: *mut pt_regs) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kprobe_fault_handler(regs: *mut pt_regs, trapnr: c_int) -> bool {
