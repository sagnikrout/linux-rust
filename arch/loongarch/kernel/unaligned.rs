...
//! Source: arch/loongarch/kernel/unaligned.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn read_fpr(idx: c_uint) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn write_fpr(idx: c_uint, value: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn emulate_load_store_insn(regs: *mut pt_regs, addr: *mut void __user, pc: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_unaligned() -> int __init {
