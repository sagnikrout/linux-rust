...
//! Source: arch/loongarch/kernel/signal.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _ctx_layout {
    pub addr: *mut sctx_info,
    pub size: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn copy_fpu_to_sigcontext(ctx: *mut fpu_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_fpu_from_sigcontext(ctx: *mut fpu_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_lsx_to_sigcontext(ctx: *mut lsx_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_lsx_from_sigcontext(ctx: *mut lsx_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_lasx_to_sigcontext(ctx: *mut lasx_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_lasx_from_sigcontext(ctx: *mut lasx_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_lbt_to_sigcontext(ctx: *mut lbt_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_lbt_from_sigcontext(ctx: *mut lbt_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_ftop_to_sigcontext(ctx: *mut lbt_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn copy_ftop_from_sigcontext(ctx: *mut lbt_context __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn save_hw_fpu_context(ctx: *mut fpu_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_hw_fpu_context(ctx: *mut fpu_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn save_hw_lsx_context(ctx: *mut lsx_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_hw_lsx_context(ctx: *mut lsx_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn save_hw_lasx_context(ctx: *mut lasx_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_hw_lasx_context(ctx: *mut lasx_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn save_hw_lbt_context(ctx: *mut lbt_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_hw_lbt_context(ctx: *mut lbt_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn save_hw_ftop_context(ctx: *mut lbt_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_hw_ftop_context(ctx: *mut lbt_context __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fcsr_pending(fcsr: *mut unsigned int __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn protected_save_fpu_context(extctx: *mut extctx_layout) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn protected_restore_fpu_context(extctx: *mut extctx_layout) -> c_int {
    static int protected_restore_fpu_context(struct extctx_layout *extctx)
    {
    let mut err: c_int = 0, sig = 0, tmp __maybe_unused;
    struct sctx_info __user *info = extctx.fpu.addr;
    struct fpu_context __user *fpu_ctx = (struct fpu_context *)get_ctx_through_ctxinfo(info);
    uint64_t __user *regs	= (uint64_t *)&fpu_ctx.regs;
    uint64_t __user *fcc	= &fpu_ctx.fcc;
...
#[no_mangle]
unsafe extern "C" fn protected_save_lsx_context(extctx: *mut extctx_layout) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn protected_restore_lsx_context(extctx: *mut extctx_layout) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn protected_save_lasx_context(extctx: *mut extctx_layout) -> c_int {
    ...
    save_lsx(current);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_fpu_owner()) -> else {
...
#[no_mangle]
unsafe extern "C" fn protected_restore_lasx_context(extctx: *mut extctx_layout) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn protected_save_lbt_context(extctx: *mut extctx_layout) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn protected_restore_lbt_context(extctx: *mut extctx_layout) -> c_int {
    static int protected_restore_lbt_context(struct extctx_layout *extctx)
    {
    let mut err: c_int = 0, tmp __maybe_unused;
    struct sctx_info __user *info = extctx.lbt.addr;
    struct lbt_context __user *lbt_ctx =
    (struct lbt_context *)get_ctx_through_ctxinfo(info);
    uint64_t __user *regs	= (uint64_t *)&lbt_ctx.regs;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: extctx->lsx.addr) -> else {
    else if (extctx.lsx.addr)
    err |= protected_save_lsx_context(extctx);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: extctx->fpu.addr) -> else {
...
#[no_mangle]
unsafe extern "C" fn parse_extcontext(sc: *mut sigcontext __user, extctx: *mut extctx_layout) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_sigcontext(regs: *mut pt_regs, sc: *mut sigcontext __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_flags() -> c_uint {
    ...
    {
    let mut new_base: c_ulong = base - size;
...
#[no_mangle]
unsafe extern "C" fn setup_extcontext(extctx: *mut extctx_layout, sp: c_ulong) -> c_ulong {
    static unsigned long setup_extcontext(struct extctx_layout *extctx, unsigned long sp)
    {
    let mut new_sp: c_ulong = sp;
    memset(extctx, 0, sizeof(struct extctx_layout));
...
#[no_mangle]
pub unsafe extern "C" fn if(thread_lsx_context_live(): cpu_has_lsx &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpu_has_fpu) -> else {
    else if (cpu_has_fpu)
...
//
    ...
    goto badframe;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sig) -> else {
    else if (sig)
    force_sig(sig);
...
// Create the ucontext.
    ...
    err |= __put_user(core::ptr::null_mut(), &frame.rs_uctx.uc_link);
