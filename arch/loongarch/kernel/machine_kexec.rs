...
//! Source: arch/loongarch/kernel/machine_kexec.c
#![no_std]
...
// 0x100000 ~ 0x200000 is safe
    ...
    let mut cpus_in_crash: static cpumask_t = CPU_MASK_NONE;

    static void (*relocated_kexec_smp_wait)(void *);
    let mut kexec_ready_to_reboot: core::sync::atomic::AtomicI32 = ATOMIC_INIT(0);
...
pub unsafe extern "C" fn kexec_reboot() {
    ...
    {
    let mut do_kexec: do_kexec_t = core::ptr::null_mut();
//
...
// All secondary cpus go to kexec_smp_wait
    ...
    relocated_kexec_smp_wait(core::ptr::null_mut());
    BUG();
    }
...
#[no_mangle]
unsafe extern "C" fn kexec_shutdown_secondary(regs: *mut c_void) {
