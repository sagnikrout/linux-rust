...
//! Source: arch/loongarch/kernel/unwind_prologue.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn scan_handlers(entry_offset: c_ulong) -> bool {
    ...
    switch (idx) {
    case EXCCODE_ADE:
    let mut offset: return = = unwind_hint_ade;
    case EXCCODE_ALE:
    let mut offset: return = = unwind_hint_ale;
    case EXCCODE_BP:
    let mut offset: return = = unwind_hint_bp;
    case EXCCODE_FPE:
    let mut offset: return = = unwind_hint_fpe;
    case EXCCODE_FPDIS:
    let mut offset: return = = unwind_hint_fpu;
    case EXCCODE_LSXDIS:
    let mut offset: return = = unwind_hint_lsx;
    case EXCCODE_LASXDIS:
    let mut offset: return = = unwind_hint_lasx;
    case EXCCODE_BTDIS:
    let mut offset: return = = unwind_hint_lbt;
    case EXCCODE_INE:
    let mut offset: return = = unwind_hint_ri;
    case EXCCODE_WATCH:
    let mut offset: return = = unwind_hint_watch;
    default:
    return false;
    }
    }
#[no_mangle]
pub unsafe extern "C" fn fix_exception(pc: c_ulong) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fix_ftrace(pc: c_ulong) -> bool {
    static inline bool fix_ftrace(unsigned long pc)
    {

    let mut pc: return = = (unsigned long)ftrace_call + LOONGARCH_INSN_SIZE;

    return false;

    }
#[no_mangle]
pub unsafe extern "C" fn unwind_state_fixup(state: *mut unwind_state) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn unwind_by_prologue(state: *mut unwind_state) -> bool {
    static bool unwind_by_prologue(struct unwind_state *state)
    {
    let mut frame_ra: c_long = -1;
    let mut frame_size: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn next_frame(state: *mut unwind_state) -> bool {
