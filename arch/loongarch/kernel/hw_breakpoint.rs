...
//! Source: arch/loongarch/kernel/hw_breakpoint.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn read_wb_reg(reg: c_int, n: c_int, t: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn write_wb_reg(reg: c_int, n: c_int, t: c_int, val: u64) {
...
pub unsafe extern "C" fn flush_ptrace_hw_breakpoint(tsk: *mut task_struct) {
    ...
    t.hbp_break[i] = core::ptr::null_mut();
    }
    }
    for (i = 0; i < LOONGARCH_MAX_WRP; i++) {
    if (t.hbp_watch[i]) {
    unregister_hw_breakpoint(t.hbp_watch[i]);
    t.hbp_watch[i] = core::ptr::null_mut();
    }
    }
    }
...
#[no_mangle]
unsafe extern "C" fn update_bp_registers(regs: *mut pt_regs, enable: c_int, type: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn breakpoint_handler(regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn watchpoint_handler(regs: *mut pt_regs) {
