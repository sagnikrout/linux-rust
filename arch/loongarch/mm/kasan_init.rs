...
//! Source: arch/loongarch/mm/kasan_init.c
#![no_std]
...
//
    ...
    let mut maddr: c_ulong = (unsigned long)addr;
    let mut xrange: c_ulong = (maddr >> XRANGE_SHIFT) & 0xffff;
    ...
    {
    let mut addr: c_ulong = (unsigned long)shadow_addr;
...
#[no_mangle]
pub unsafe extern "C" fn if(XKPRANGE_WC_SHADOW_OFFSET: addr >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(XKPRANGE_UC_SHADOW_OFFSET: addr >=) -> else {
    else if (addr >= XKPRANGE_UC_SHADOW_OFFSET)
    return (void *)(((addr - XKPRANGE_UC_SHADOW_OFFSET) << KASAN_SHADOW_SCALE_SHIFT) + XKPRANGE_UC_START);
#[no_mangle]
pub unsafe extern "C" fn if(XKPRANGE_CC_SHADOW_OFFSET: addr >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn kasan_pte_offset(pmdp: *mut pmd_t, addr: c_ulong, node: c_int, early: bool) -> *mut pte_t __init {
    ...
    pmd_populate_kernel(core::ptr::null_mut(), pmdp, (pte_t *)__va(pte_phys));
    }
    return pte_offset_kernel(pmdp, addr);
    }
#[no_mangle]
unsafe extern "C" fn kasan_pmd_offset(pudp: *mut pud_t, addr: c_ulong, node: c_int, early: bool) -> *mut pmd_t __init {
...
#[no_mangle]
unsafe extern "C" fn kasan_pud_offset(p4dp: *mut p4d_t, addr: c_ulong, node: c_int, early: bool) -> *mut pud_t __init {
...
#[no_mangle]
unsafe extern "C" fn kasan_p4d_offset(pgdp: *mut pgd_t, addr: c_ulong, node: c_int, early: bool) -> *mut p4d_t __init {
...
#[no_mangle]
pub unsafe extern "C" fn kasan_set_pgd(pgdp: *mut pgd_t, pgdval: pgd_t) {
    static inline void kasan_set_pgd(pgd_t *pgdp, pgd_t pgdval)
    {
    WRITE_ONCE(*pgdp, pgdval);
    }
#[no_mangle]
unsafe extern "C" fn clear_pgds(start: c_ulong, end: c_ulong) -> void __init {
