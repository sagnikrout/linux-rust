...
//! Source: arch/loongarch/kvm/main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn get_gcsr_flag(csr: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn set_gcsr_sw_flag(csr: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn set_gcsr_hw_flag(csr: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_init_gcsr_flag() {
...
#[no_mangle]
unsafe extern "C" fn kvm_update_vpid(vcpu: *mut kvm_vcpu, cpu: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_check_vpid(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_init_vmcs(kvm: *mut kvm) {
...
// from vCPU SW state.
//
    this_cpu_ptr(vmcs).last_vcpu = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn kvm_loongarch_env_init() -> c_int {
...
// Register LoongArch DMSINTC interrupt contrroller interface
    ...
    kvm_loongarch_ops = core::ptr::null_mut();
    free_percpu(vmcs);
    vmcs = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn kvm_loongarch_env_exit() {
...
#[no_mangle]
unsafe extern "C" fn kvm_loongarch_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_loongarch_exit() {
