...
//! Source: arch/loongarch/kvm/intc/pch_pic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pch_pic_update_irq(s: *mut loongarch_pch_pic, irq: c_int, level: c_int) {
    static void pch_pic_update_irq(struct loongarch_pch_pic *s, int irq, int level)
    {
    let mut mask: u64 = BIT(irq);
//
...
#[no_mangle]
unsafe extern "C" fn pch_pic_update_batch_irqs(s: *mut loongarch_pch_pic, irq_mask: u64, level: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn pch_pic_set_irq(s: *mut loongarch_pch_pic, irq: c_int, level: c_int) {
...
// msi irq handler
#[no_mangle]
pub unsafe extern "C" fn pch_msi_set_irq(kvm: *mut kvm, e: *mut kvm_kernel_irq_routing_entry, level: c_int) -> c_int {
    int pch_msi_set_irq(struct kvm *kvm, struct kvm_kernel_irq_routing_entry *e, int level)
    {
    let mut msg_addr: u64 = (((u64)e.msi.address_hi) << 32) | e.msi.address_lo;
...
#[no_mangle]
unsafe extern "C" fn loongarch_pch_pic_read(s: *mut loongarch_pch_pic, addr: gpa_t, len: c_int, val: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_pch_pic_init(dev: *mut kvm_device, addr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_setup_default_irq_routing(kvm: *mut kvm) -> c_int {
    static int kvm_setup_default_irq_routing(struct kvm *kvm)
    {
    int i, ret;
    let mut nr: u32 = KVM_IRQCHIP_NUM_PINS;
...
#[no_mangle]
unsafe extern "C" fn kvm_pch_pic_create(dev: *mut kvm_device, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_pch_pic_destroy(dev: *mut kvm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_loongarch_register_pch_pic_device() -> c_int {
    int kvm_loongarch_register_pch_pic_device(void)
    {
    return kvm_register_device_ops(&kvm_pch_pic_dev_ops, KVM_DEV_TYPE_LOONGARCH_PCHPIC);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_loongarch_unregister_pch_pic_device() {
