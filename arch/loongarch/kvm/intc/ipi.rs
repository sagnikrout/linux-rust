...
//! Source: arch/loongarch/kvm/intc/ipi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipi_set(vcpu: *mut kvm_vcpu, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn ipi_send(kvm: *mut kvm, data: u64) {
    ...
    if (unlikely(vcpu == core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn ipi_clear(vcpu: *mut kvm_vcpu, data: u64) {
...
#[no_mangle]
unsafe extern "C" fn read_mailbox(vcpu: *mut kvm_vcpu, offset: c_int, len: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn write_mailbox(vcpu: *mut kvm_vcpu, offset: c_int, data: u64, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mail_send(kvm: *mut kvm, data: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_ipi_data(vcpu: *mut kvm_vcpu, addr: gpa_t, data: u64) -> c_int {
    static int send_ipi_data(struct kvm_vcpu *vcpu, gpa_t addr, uint64_t data)
    {
    int i, idx, ret;
    let mut val: u64 = 0, mask = 0;
//
...
#[no_mangle]
unsafe extern "C" fn any_send(kvm: *mut kvm, data: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongarch_ipi_readl(vcpu: *mut kvm_vcpu, addr: gpa_t, len: c_int, val: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongarch_ipi_writel(vcpu: *mut kvm_vcpu, addr: gpa_t, len: c_int, val: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_ipi_create(dev: *mut kvm_device, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_ipi_destroy(dev: *mut kvm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_loongarch_register_ipi_device() -> c_int {
    int kvm_loongarch_register_ipi_device(void)
    {
    return kvm_register_device_ops(&kvm_ipi_dev_ops, KVM_DEV_TYPE_LOONGARCH_IPI);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_loongarch_unregister_ipi_device() {
