...
//! Source: arch/loongarch/kvm/intc/eiointc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn eiointc_set_sw_coreisr(s: *mut loongarch_eiointc) {
...
#[no_mangle]
unsafe extern "C" fn eiointc_update_irq(s: *mut loongarch_eiointc, irq: c_int, level: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn eiointc_set_irq(s: *mut loongarch_eiointc, irq: c_int, level: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kvm_eiointc_create(dev: *mut kvm_device, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_eiointc_destroy(dev: *mut kvm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_loongarch_register_eiointc_device() -> c_int {
    int kvm_loongarch_register_eiointc_device(void)
    {
    return kvm_register_device_ops(&kvm_eiointc_dev_ops, KVM_DEV_TYPE_LOONGARCH_EIOINTC);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_loongarch_unregister_eiointc_device() {
