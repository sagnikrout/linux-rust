...
//! Source: arch/loongarch/kvm/interrupt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kvm_irq_deliver(vcpu: *mut kvm_vcpu, mask: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn kvm_irq_clear(vcpu: *mut kvm_vcpu, mask: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_deliver_intr(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_pending_timer(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_deliver_exception(vcpu: *mut kvm_vcpu) {
