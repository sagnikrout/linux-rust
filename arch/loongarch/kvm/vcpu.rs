...
//! Source: arch/loongarch/kvm/vcpu.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kvm_save_host_pmu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_restore_host_pmu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_save_guest_pmu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_restore_guest_pmu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_own_pmu(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_lose_pmu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_update_stolen_time(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_check_requests(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_late_check_requests(vcpu: *mut kvm_vcpu) {
    ...
    kvm_own_lasx(vcpu);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: kvm_guest_has_lsx(&vcpu->arch)) -> else {
    else if (kvm_guest_has_lsx(&vcpu.arch))
    kvm_own_lsx(vcpu);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: kvm_guest_has_fpu(&vcpu->arch)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_enter_guest_check(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_pre_enter_guest(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_exit(run: *mut kvm_run, vcpu: *mut kvm_vcpu) -> c_int {
    static int kvm_handle_exit(struct kvm_run *run, struct kvm_vcpu *vcpu)
    {
    let mut ret: c_int = RESUME_GUEST;
    let mut estat: c_ulong = vcpu.arch.host_estat;
    let mut intr: u32 = estat & CSR_ESTAT_IS;
    let mut ecode: u32 = (estat & CSR_ESTAT_EXC) >> CSR_ESTAT_EXC_SHIFT;
    smp_store_mb(vcpu.mode, OUTSIDE_GUEST_MODE);
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_runnable(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_pmi_in_guest(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_preempted_in_kernel(vcpu: *mut kvm_vcpu) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_dump_regs(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_set_cpuid(vcpu: *mut kvm_vcpu, val: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_drop_cpuid(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn _kvm_getcsr(vcpu: *mut kvm_vcpu, id: c_uint, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _kvm_setcsr(vcpu: *mut kvm_vcpu, id: c_uint, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _kvm_get_cpucfg_mask(id: c_int, v: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_check_cpucfg(id: c_int, val: u64) -> c_int {
...
//
    ...
    {
    int id, ret = 0;
    let mut type: u64 = reg.id & KVM_REG_LOONGARCH_MASK;
    switch (type) {
...
#[no_mangle]
unsafe extern "C" fn kvm_get_reg(vcpu: *mut kvm_vcpu, reg: *const kvm_one_reg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_set_reg(vcpu: *mut kvm_vcpu, reg: *const kvm_one_reg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ioctl_get_sregs(vcpu: *mut kvm_vcpu, sregs: *mut kvm_sregs) -> c_int {
    int kvm_arch_vcpu_ioctl_get_sregs(struct kvm_vcpu *vcpu, struct kvm_sregs *sregs)
    {
    return -ENOIOCTLCMD;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ioctl_set_sregs(vcpu: *mut kvm_vcpu, sregs: *mut kvm_sregs) -> c_int {
    int kvm_arch_vcpu_ioctl_set_sregs(struct kvm_vcpu *vcpu, struct kvm_sregs *sregs)
    {
    return -ENOIOCTLCMD;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ioctl_get_regs(vcpu: *mut kvm_vcpu, regs: *mut kvm_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ioctl_set_regs(vcpu: *mut kvm_vcpu, regs: *mut kvm_regs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ioctl_get_fpu(vcpu: *mut kvm_vcpu, fpu: *mut kvm_fpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_vcpu_ioctl_set_fpu(vcpu: *mut kvm_vcpu, fpu: *mut kvm_fpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_own_lbt(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_lose_lbt(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn kvm_check_fcsr(vcpu: *mut kvm_vcpu, fcsr: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn kvm_check_fcsr_alive(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_own_fpu(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_own_lsx(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_own_lasx(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_lose_fpu(vcpu: *mut kvm_vcpu) {
...
pub unsafe extern "C" fn kvm_vcpu_ioctl_interrupt(vcpu: *mut kvm_vcpu, irq: *mut kvm_interrupt) -> c_int {
    ...
    {
    let mut intr: c_int = (int)irq.irq;
    let mut vector: c_uint = abs(intr);
...
#[no_mangle]
pub unsafe extern "C" fn if(0: intr <) -> else {
    else if (intr < 0)
...
#[no_mangle]
unsafe extern "C" fn _kvm_vcpu_load(vcpu: *mut kvm_vcpu, cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _kvm_vcpu_put(vcpu: *mut kvm_vcpu, cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_vcpu_set_pv_preempted(vcpu: *mut kvm_vcpu) {
