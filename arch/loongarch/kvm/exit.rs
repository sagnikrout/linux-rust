...
//! Source: arch/loongarch/kvm/exit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kvm_emu_cpucfg(vcpu: *mut kvm_vcpu, inst: larch_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_emu_read_csr(vcpu: *mut kvm_vcpu, csrid: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn kvm_emu_write_csr(vcpu: *mut kvm_vcpu, csrid: c_int, val: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_csr(vcpu: *mut kvm_vcpu, inst: larch_inst) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_emu_iocsr(inst: larch_inst, run: *mut kvm_run, vcpu: *mut kvm_vcpu) -> c_int {
...
// Save data and let user space to write it
    ...
    ret = EMULATE_DO_IOCSR;
    trace_kvm_iocsr(KVM_TRACE_IOCSR_READ, run.iocsr_io.len, addr, core::ptr::null_mut());
    }
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_complete_iocsr_read(vcpu: *mut kvm_vcpu, run: *mut kvm_run) -> c_int {
    int kvm_complete_iocsr_read(struct kvm_vcpu *vcpu, struct kvm_run *run)
    {
    let mut er: enum emulation_result = EMULATE_DONE;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_emu_idle(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_trap_handle_gspr(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_gspr(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_emu_mmio_read(vcpu: *mut kvm_vcpu, inst: larch_inst) -> c_int {
    ...
    trace_kvm_mmio(KVM_TRACE_MMIO_READ, run.mmio.len, run.mmio.phys_addr, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn kvm_complete_mmio_read(vcpu: *mut kvm_vcpu, run: *mut kvm_run) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_emu_mmio_write(vcpu: *mut kvm_vcpu, inst: larch_inst) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_rdwr_fault(vcpu: *mut kvm_vcpu, write: bool, ecode: c_int) -> c_int {
    ...
    let mut er: enum emulation_result = EMULATE_DONE;
    struct kvm_run *run = vcpu.run;
    let mut badv: c_ulong = vcpu.arch.badv;
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_read_fault(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
    static int kvm_handle_read_fault(struct kvm_vcpu *vcpu, int ecode)
    {
    return kvm_handle_rdwr_fault(vcpu, false, ecode);
    }
#[no_mangle]
unsafe extern "C" fn kvm_handle_write_fault(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
    static int kvm_handle_write_fault(struct kvm_vcpu *vcpu, int ecode)
    {
    return kvm_handle_rdwr_fault(vcpu, true, ecode);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_complete_user_service(vcpu: *mut kvm_vcpu, run: *mut kvm_run) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_fpu_disabled(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_save_notify(vcpu: *mut kvm_vcpu) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_lsx_disabled(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_lasx_disabled(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_lbt_disabled(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_send_pv_ipi(vcpu: *mut kvm_vcpu) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_handle_service(vcpu: *mut kvm_vcpu) {
    static void kvm_handle_service(struct kvm_vcpu *vcpu)
    {
    let mut ret: c_long = KVM_HCALL_INVALID_CODE;
    let mut func: c_ulong = kvm_read_reg(vcpu, LOONGARCH_GPR_A0);
    switch (func) {
...
#[no_mangle]
unsafe extern "C" fn kvm_handle_hypercall(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_fault_ni(vcpu: *mut kvm_vcpu, ecode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_fault(vcpu: *mut kvm_vcpu, fault: c_int) -> c_int {
