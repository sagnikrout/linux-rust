...
//! Source: arch/loongarch/kvm/mmu.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn kvm_mkold_pte(pte: *mut kvm_pte_t, addr: phys_addr_t, ctx: *mut kvm_ptw_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_mkclean_pte(pte: *mut kvm_pte_t, addr: phys_addr_t, ctx: *mut kvm_ptw_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_flush_pte(pte: *mut kvm_pte_t, addr: phys_addr_t, ctx: *mut kvm_ptw_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _kvm_pte_init(addr: *mut c_void, val: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_ptw_leaf(dir: *mut kvm_pte_t, addr: phys_addr_t, end: phys_addr_t, ctx: *mut kvm_ptw_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_ptw_dir(dir: *mut kvm_pte_t, addr: phys_addr_t, end: phys_addr_t, ctx: *mut kvm_ptw_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_ptw_top(dir: *mut kvm_pte_t, addr: phys_addr_t, end: phys_addr_t, ctx: *mut kvm_ptw_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_flush_range(kvm: *mut kvm, start_gfn: gfn_t, end_gfn: gfn_t, lock: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn kvm_mkclean_gpa_pt(kvm: *mut kvm, start_gfn: gfn_t, end_gfn: gfn_t) -> c_int {
...
//
    ...
    {
    kvm_ptw_ctx ctx;
    let mut base_gfn: gfn_t = slot.base_gfn + gfn_offset;
    let mut start: gfn_t = base_gfn + __ffs(mask);
    let mut end: gfn_t = base_gfn + __fls(mask) + 1;
    ctx.ops = kvm_mkclean_pte;
...
//
    ...
    {
    int needs_flush;
    let mut old_flags: u32 = old ? old.flags : 0;
    let mut new_flags: u32 = new ? new.flags : 0;
    let mut log_dirty_pages: bool = new_flags & KVM_MEM_LOG_DIRTY_PAGES;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_arch_flush_shadow_memslot(kvm: *mut kvm, slot: *mut kvm_memory_slot) {
...
pub unsafe extern "C" fn kvm_test_age_gfn(kvm: *mut kvm, range: *mut kvm_gfn_range) -> bool {
    ...
    {
    let mut gpa: gpa_t = range.start << PAGE_SHIFT;
    kvm_pte_t *ptep = kvm_populate_gpa(kvm, core::ptr::null_mut(), gpa, 0);
    if (ptep && kvm_pte_present(core::ptr::null_mut(), ptep) && kvm_pte_young(*ptep))
    return true;
    return false;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn kvm_map_page_fast(vcpu: *mut kvm_vcpu, gpa: c_ulong, write: bool) -> c_int {
...
// Fast path - just check GPA page table for an existing entry
    ptep = kvm_populate_gpa(kvm, core::ptr::null_mut(), gpa, 0);
    if (!ptep || !kvm_pte_present(core::ptr::null_mut(), ptep)) {
    ret = -EFAULT;
    goto out;
    }
...
//
#[no_mangle]
unsafe extern "C" fn kvm_map_page(vcpu: *mut kvm_vcpu, gpa: c_ulong, write: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_mm_fault(vcpu: *mut kvm_vcpu, gpa: c_ulong, write: bool, ecode: c_int) -> c_int {
