...
//! Source: arch/s390/crypto/prng.c
#![no_std]
...
pub const PRNG_MODE_AUTO: c_int = 0;
pub const PRNG_MODE_TDES: c_int = 1;
pub const PRNG_MODE_SHA512: c_int = 2;
    let mut prng_mode: static unsigned int = PRNG_MODE_AUTO;
    module_param_named(mode, prng_mode, int, 0);
    MODULE_PARM_DESC(prng_mode, "PRNG mode: 0 - auto, 1 - TDES, 2 - SHA512");
pub const PRNG_CHUNKSIZE_TDES_MIN: c_int = 8;

pub const PRNG_CHUNKSIZE_SHA512_MIN: c_int = 64;

    let mut prng_chunk_size: static unsigned int = 256;
    module_param_named(chunksize, prng_chunk_size, int, 0);
    MODULE_PARM_DESC(prng_chunk_size, "PRNG read chunk size in bytes");
pub const PRNG_RESEED_LIMIT_TDES: c_int = 4096;
pub const PRNG_RESEED_LIMIT_TDES_LOWER: c_int = 4096;
pub const PRNG_RESEED_LIMIT_SHA512: c_int = 100000;
pub const PRNG_RESEED_LIMIT_SHA512_LOWER: c_int = 10000;
...
pub const PRNG_GEN_ENTROPY_FAILED: c_int = 1;
pub const PRNG_SELFTEST_FAILED: c_int = 2;
pub const PRNG_INSTANTIATE_FAILED: c_int = 3;
pub const PRNG_SEED_FAILED: c_int = 4;
pub const PRNG_RESEED_FAILED: c_int = 5;
pub const PRNG_GEN_FAILED: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prng_ws_s {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prng_data_s {
    pub mutex: mutex,
    union {
    pub prngws: prng_ws_s,
    pub prnows: prno_ws_s,
}
...
//
#[no_mangle]
unsafe extern "C" fn generate_entropy(ebuf: *mut u8, nbytes: usize) -> c_int {
...
// exor upper 2k with 512 stckf values, offset 4 bytes each
    for (n = 0; n < 512; n++) {
    let mut offset: c_int = (PAGE_SIZE / 2) + (n * 4) - 4;
    u64 *p = (u64 *)(pg + offset);
...
// tdes functions
#[no_mangle]
unsafe extern "C" fn prng_tdes_add_entropy() {
...
#[no_mangle]
unsafe extern "C" fn prng_tdes_seed(nbytes: c_int) {
...
#[no_mangle]
unsafe extern "C" fn prng_tdes_instantiate() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn prng_tdes_deinstantiate() {
...
// sha512 functions
#[no_mangle]
unsafe extern "C" fn prng_sha512_selftest() -> int __init {
...
// initial seed
    ...
    &ws, core::ptr::null_mut(), 0, seed, sizeof(seed));
...
// generate random bytes
    ...
    &ws, buf, sizeof(buf), core::ptr::null_mut(), 0);
    cpacf_prno(CPACF_PRNO_SHA512_DRNG_GEN,
    &ws, buf, sizeof(buf), core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn prng_sha512_instantiate() -> int __init {
...
//
    seedlen = 2 * 32;
    cpacf_trng(core::ptr::null_mut(), 0, seed, seedlen);
    } else {
//
...
// now initial seed of the prno drng
    cpacf_prno(CPACF_PRNO_SHA512_DRNG_SEED,
    &prng_data.prnows, core::ptr::null_mut(), 0, seed, seedlen);
...
// if fips mode is enabled, generate a first block of random
    ...
    cpacf_prno(CPACF_PRNO_SHA512_DRNG_GEN,
    &prng_data.prnows,
    prng_data.prev, prng_chunk_size, core::ptr::null_mut(), 0);
    }
    return 0;
    outfree:
    kfree(prng_data);
...
#[no_mangle]
unsafe extern "C" fn prng_sha512_deinstantiate() {
...
#[no_mangle]
unsafe extern "C" fn prng_sha512_reseed() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prng_sha512_generate(buf: *mut u8, nbytes: usize) -> c_int {
...
// PRNO generate
    cpacf_prno(CPACF_PRNO_SHA512_DRNG_GEN,
    &prng_data.prnows, buf, nbytes, core::ptr::null_mut(), 0);
...
// file io functions
#[no_mangle]
unsafe extern "C" fn prng_open(inode: *mut inode, file: *mut file) -> c_int {
...
// chunksize attribute (ro)
    ...
    static DEVICE_ATTR(chunksize, 0444, prng_chunksize_show, core::ptr::null_mut());
// counter attribute (ro)
    ...
    static DEVICE_ATTR(byte_counter, 0444, prng_counter_show, core::ptr::null_mut());
// errorflag attribute (ro)
    ...
    static DEVICE_ATTR(errorflag, 0444, prng_errorflag_show, core::ptr::null_mut());
// mode attribute (ro)
    ...
    static DEVICE_ATTR(mode, 0444, prng_mode_show, core::ptr::null_mut());
// reseed attribute (w)
    ...
    static DEVICE_ATTR(reseed, 0200, core::ptr::null_mut(), prng_reseed_store);
...
// strength attribute (ro)
    ...
    static DEVICE_ATTR(strength, 0444, prng_strength_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn prng_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(PRNG_RESEED_LIMIT_SHA512_LOWER: prng_reseed_limit <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PRNG_RESEED_LIMIT_TDES_LOWER: prng_reseed_limit <) -> else {
...
#[no_mangle]
unsafe extern "C" fn prng_exit() -> void __exit {
