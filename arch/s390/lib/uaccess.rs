...
//! Source: arch/s390/lib/uaccess.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn debug_user_asce(exit: c_int) {
...
pub const CMPXCHG_USER_KEY_MAX_LOOPS: c_int = 128;
...
// uval = prev;
    ...
    {
    let mut address: c_ulong = (unsigned long)addr;
