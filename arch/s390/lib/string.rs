...
//
pub const IN_ARCH_STRING_C: c_int = 1;
...
//
    ...
    {
    let mut len: usize = __strnend(src, n) - src;
...
pub unsafe extern "C" fn strcmp(s1: *const c_char, s2: *const c_char) -> c_int {
    ...
    {
    let mut r1: union register_pair = { .even = (unsigned long)s1, .odd = l1, };
    let mut r3: union register_pair = { .even = (unsigned long)s2, .odd = l2, };
    int cc;
    asm volatile(
    "0:	clcle	%[r1],%[r3],0\n"
    "	jo	0b\n"
