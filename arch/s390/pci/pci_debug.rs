...
//! Source: arch/s390/pci/pci_debug.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pci_sw_counter_show(m: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn pci_perf_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_perf_seq_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_debug_init_device(zdev: *mut zpci_dev, name: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_debug_init() -> int __init {
...
// error log
    ...
    debugfs_root = debugfs_create_dir("pci", core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
