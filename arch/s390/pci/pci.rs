...
#[no_mangle]
pub unsafe extern "C" fn zpci_zdev_put(zdev: *mut zpci_dev) {
    ...
    {
    struct zpci_dev *tmp, *zdev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn zpci_remove_reserved_devices() {
...
#[no_mangle]
pub unsafe extern "C" fn pci_domain_nr(bus: *mut pci_bus) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_proc_domain(bus: *mut pci_bus) -> c_int {
...
// Modify PCI: Register I/O address translation parameters
    ...
    {
    let mut req: u64 = ZPCI_CREATE_REQ(zdev.fh, dmaas, ZPCI_MOD_FC_REG_IOAT);
...
#[no_mangle]
pub unsafe extern "C" fn zpci_unregister_ioat(zdev: *mut zpci_dev, dmaas: u8) -> c_int {
    int zpci_unregister_ioat(struct zpci_dev *zdev, u8 dmaas)
    {
    let mut req: u64 = ZPCI_CREATE_REQ(zdev.fh, dmaas, ZPCI_MOD_FC_DEREG_IOAT);
    let mut fib: zpci_fib = {0};
    u8 cc, status;
    fib.gd = zdev.gisa;
    cc = zpci_mod_fc(req, &fib, &status);
...
#[no_mangle]
pub unsafe extern "C" fn zpci_fmb_enable_device(zdev: *mut zpci_dev) -> c_int {
    int zpci_fmb_enable_device(struct zpci_dev *zdev)
    {
    let mut req: u64 = ZPCI_CREATE_REQ(zdev.fh, 0, ZPCI_MOD_FC_SET_MEASURE);
...
// reset software counters
    ...
    zdev.fmb = core::ptr::null_mut();
    }
    return cc ? -EIO : 0;
    }
// Modify PCI: Disable PCI function measurement
#[no_mangle]
pub unsafe extern "C" fn zpci_fmb_disable_device(zdev: *mut zpci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zpci_cfg_load(zdev: *mut zpci_dev, offset: c_int, val: *mut u32, len: u8) -> c_int {
    static int zpci_cfg_load(struct zpci_dev *zdev, int offset, u32 *val, u8 len)
    {
    let mut req: u64 = ZPCI_CREATE_REQ(zdev.fh, ZPCI_PCIAS_CFGSPC, len);
...
#[no_mangle]
unsafe extern "C" fn zpci_cfg_store(zdev: *mut zpci_dev, offset: c_int, val: u32, len: u8) -> c_int {
    static int zpci_cfg_store(struct zpci_dev *zdev, int offset, u32 val, u8 len)
    {
    let mut req: u64 = ZPCI_CREATE_REQ(zdev.fh, ZPCI_PCIAS_CFGSPC, len);
    let mut rc: c_int = -ENODEV;
    let mut data: u64 = val;
    if (!zdev_enabled(zdev))
    return rc;
    data <<= (8 - len) * 8;
    data = ( u64) cpu_to_le64(data);
...
// Detect overrun
    ...
    unsigned long max)
    {
    let mut barsize: c_ulong = pci_resource_len(pdev, bar);
    struct zpci_dev *zdev = to_zpci(pdev);
    void __iomem *iova;
...
#[no_mangle]
unsafe extern "C" fn pci_iounmap_fh(pdev: *mut pci_dev, addr: *mut void __iomem) {
    static void pci_iounmap_fh(struct pci_dev *pdev, void __iomem *addr)
    {
    let mut idx: c_uint = ZPCI_IDX(addr);
    spin_lock(&zpci_iomap_lock);
// Detect underrun
    WARN_ON(!zpci_iomap_start[idx].count);
...
#[no_mangle]
unsafe extern "C" fn pci_iounmap_mio(pdev: *mut pci_dev, addr: *mut void __iomem) {
    static void pci_iounmap_mio(struct pci_dev *pdev, void __iomem *addr)
    {
    iounmap(addr);
    }
#[no_mangle]
pub unsafe extern "C" fn pci_iounmap(pdev: *mut pci_dev, addr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn zpci_map_resources(pdev: *mut pci_dev) {
    ...
    (resource_size_t ) zdev.bars[i].mio_wt;
    else
    pdev.resource[i].start = (resource_size_t )
...
#[no_mangle]
unsafe extern "C" fn zpci_unmap_resources(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn zpci_alloc_iomap(zdev: *mut zpci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zpci_free_iomap(zdev: *mut zpci_dev, entry: c_int) {
...
#[no_mangle]
unsafe extern "C" fn zpci_do_update_iomap_fh(zdev: *mut zpci_dev, fh: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_update_fh(zdev: *mut zpci_dev, fh: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_setup_bus_resources(zdev: *mut zpci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zpci_cleanup_bus_resources(zdev: *mut zpci_dev) {
    ...
    zdev.bars[i].res = core::ptr::null_mut();
    kfree(res);
    }
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_device_add(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_release_device(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_enable_device(pdev: *mut pci_dev, mask: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_disable_device(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn __zpci_register_domain(domain: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __zpci_alloc_domain() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_alloc_domain(domain: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_free_domain(domain: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_enable_device(zdev: *mut zpci_dev) -> c_int {
    int zpci_enable_device(struct zpci_dev *zdev)
    {
    let mut fh: u32 = zdev.fh;
    let mut rc: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn zpci_reenable_device(zdev: *mut zpci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_disable_device(zdev: *mut zpci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zpci_hot_reset_device(zdev: *mut zpci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zpci_add_device(zdev: *mut zpci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_is_device_configured(zdev: *mut zpci_dev) -> bool {
    bool zpci_is_device_configured(struct zpci_dev *zdev)
    {
    let mut state: enum zpci_state = zdev.state;
...
//
#[no_mangle]
pub unsafe extern "C" fn zpci_scan_configured_device(zdev: *mut zpci_dev, fh: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zpci_deconfigure_device(zdev: *mut zpci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zpci_device_reserved(zdev: *mut zpci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_release_device(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zpci_clear_error_state(zdev: *mut zpci_dev) -> c_int {
    int zpci_clear_error_state(struct zpci_dev *zdev)
    {
    let mut req: u64 = ZPCI_CREATE_REQ(zdev.fh, 0, ZPCI_MOD_FC_RESET_ERROR);
    let mut fib: zpci_fib = {0};
    u8 status;
    int cc;
    cc = zpci_mod_fc(req, &fib, &status);
...
//
#[no_mangle]
pub unsafe extern "C" fn zpci_reset_load_store_blocked(zdev: *mut zpci_dev) -> c_int {
    int zpci_reset_load_store_blocked(struct zpci_dev *zdev)
    {
    let mut req: u64 = ZPCI_CREATE_REQ(zdev.fh, 0, ZPCI_MOD_FC_RESET_BLOCK);
    let mut fib: zpci_fib = {0};
    u8 status;
    int cc;
    cc = zpci_mod_fc(req, &fib, &status);
...
#[no_mangle]
unsafe extern "C" fn zpci_mem_init() -> c_int {
    ...
    __alignof__(struct zpci_fmb), 0, core::ptr::null_mut());
    if (!zdev_fmb_cache)
    goto error_fmb;
...
#[no_mangle]
unsafe extern "C" fn zpci_mem_exit() {
    ...
    let mut __initdata: static unsigned int s390_pci_probe = 1;
...
#[no_mangle]
pub unsafe extern "C" fn zpci_is_enabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn zpci_add_devices(scan_list: *mut list_head) {
    static void zpci_add_devices(struct list_head *scan_list)
    {
    struct zpci_dev *zdev, *tmp;
    list_sort(core::ptr::null_mut(), scan_list, &zpci_cmp_rid);
...
#[no_mangle]
pub unsafe extern "C" fn zpci_scan_devices() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_base_init() -> int __init {
