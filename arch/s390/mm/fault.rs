...
//
#[no_mangle]
unsafe extern "C" fn is_kernel_fault(regs: *mut pt_regs) -> bool {
    static bool is_kernel_fault(struct pt_regs *regs)
    {
    let mut teid: union teid = { .val = regs.int_parm_long };
    if (user_mode(regs))
    return false;
...
#[no_mangle]
unsafe extern "C" fn get_fault_address(regs: *mut pt_regs) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn fault_is_write(regs: *mut pt_regs) -> __always_inline bool {
...
#[no_mangle]
unsafe extern "C" fn dump_pagetable(asce: c_ulong, address: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn dump_fault_info(regs: *mut pt_regs) {
    ...
    pr_cont(" ESOP-2");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: machine_has_esop()) -> else {
...
#[no_mangle]
unsafe extern "C" fn init_s390_fault_sysctls() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn report_user_fault(regs: *mut pt_regs, signr: c_long, is_mm_fault: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_sigsegv(regs: *mut pt_regs, si_code: c_int) {
...
#[no_mangle]
unsafe extern "C" fn handle_fault_error_nolock(regs: *mut pt_regs, si_code: c_int) {
...
#[no_mangle]
unsafe extern "C" fn handle_fault_error(regs: *mut pt_regs, si_code: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_sigbus(regs: *mut pt_regs) {
...
//
#[no_mangle]
unsafe extern "C" fn do_exception(regs: *mut pt_regs, access: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn do_protection_exception(regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn do_dat_exception(regs: *mut pt_regs) {
...
#[no_mangle]
pub unsafe extern "C" fn do_secure_storage_access(regs: *mut pt_regs) {
    void do_secure_storage_access(struct pt_regs *regs)
    __context_unsafe(/* folio_walk_end() not instrumented */)
    {
    let mut teid: union teid = { .val = regs.int_parm_long };
    let mut addr: c_ulong = get_fault_address(regs);
    struct mm_struct *mm = current.mm;
    struct vm_area_struct *vma;
