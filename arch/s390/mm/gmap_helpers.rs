...
//! Source: arch/s390/mm/gmap_helpers.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn gmap_helper_zap_one_page(mm: *mut mm_struct, vmaddr: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gmap_helper_discard(mm: *mut mm_struct, vmaddr: c_ulong, end: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gmap_helper_try_set_pte_unused(mm: *mut mm_struct, vmaddr: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn __gmap_helper_unshare_zeropages(mm: *mut mm_struct) -> c_int {
