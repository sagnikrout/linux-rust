...
#[no_mangle]
pub unsafe extern "C" fn crst_table_free(mm: *mut mm_struct, table: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn __crst_table_upgrade(arg: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn crst_table_upgrade(mm: *mut mm_struct, end: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn page_table_free(mm: *mut mm_struct, table: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn base_pgt_free(table: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn base_crst_free(table: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn base_lra(address: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn base_asce_free(asce: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn base_pgt_cache_init() -> c_int {
    static int base_pgt_cache_init(void)
    {
    static DEFINE_MUTEX(base_pgt_cache_mutex);
    let mut sz: c_ulong = _PAGE_TABLE_SIZE;
    if (base_pgt_cache)
    return 0;
    mutex_lock(&base_pgt_cache_mutex);
    if (!base_pgt_cache)
    base_pgt_cache = kmem_cache_create("base_pgt", sz, sz, 0, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn base_asce_alloc(addr: c_ulong, num_pages: c_ulong) -> c_ulong {
