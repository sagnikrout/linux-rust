...
//! Source: arch/s390/boot/physmem_info.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn add_physmem_online_range(start: u64, end: u64) {
...
#[no_mangle]
unsafe extern "C" fn __diag260(rx1: c_ulong, rx2: c_ulong) -> c_int {
    ...
    let mut cc: return = = 0 ? ry : -1;
    }
#[no_mangle]
unsafe extern "C" fn diag260() -> c_int {
...
pub const DIAG500_SC_STOR_LIMIT: c_int = 4;
#[no_mangle]
unsafe extern "C" fn diag500_storage_limit(max_physmem_end: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tprot(addr: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn search_mem_end() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn detect_max_physmem_end() -> c_ulong {
    unsigned long detect_max_physmem_end(void)
    {
    let mut max_physmem_end: c_ulong = 0;
...
#[no_mangle]
pub unsafe extern "C" fn detect_physmem_online_ranges(max_physmem_end: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn physmem_set_usable_limit(limit: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn die_oom(size: c_ulong, align: c_ulong, min: c_ulong, max: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn _physmem_reserve(type: enum reserved_range_type, addr: c_ulong, size: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn physmem_reserve(type: enum reserved_range_type, addr: c_ulong, size: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn physmem_free(type: enum reserved_range_type) {
...
// intersection_start = res_addr;
    ...
    bool die_on_oom)
    {
    let mut nranges: c_uint = from_ranges ?: physmem_info.range_count;
...
// ranges_left = nranges;
    ...
    addr = __physmem_alloc_range(size, align, min, max, 0, core::ptr::null_mut(), die_on_oom);
    if (addr)
    _physmem_reserve(type, addr, size);
    ...
    struct reserved_range *new_range = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn get_physmem_alloc_pos() -> c_ulong {
    unsigned long get_physmem_alloc_pos(void)
    {
    return physmem_alloc_pos;
    }
#[no_mangle]
pub unsafe extern "C" fn dump_physmem_reserved() {
