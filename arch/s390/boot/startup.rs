...
//! Source: arch/s390/boot/startup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn detect_machine_type() {
    static void detect_machine_type(void)
    {
    struct sysinfo_3_2_2 *vmms = (struct sysinfo_3_2_2 *)&sysinfo_page;
// Check current-configuration-level
    if (stsi(core::ptr::null_mut(), 0, 0, 0) <= 2) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !memcmp(vmms->vm[0].cpi, _arg: "\xa9\x61\xe5\xd4", _arg: 4)) -> else {
    else if (!memcmp(vmms.vm[0].cpi, "\xa9\x61\xe5\xd4", 4))
    set_machine_feature(MFEATURE_VM);
    }
#[no_mangle]
unsafe extern "C" fn detect_diag288() {
...
#[no_mangle]
unsafe extern "C" fn detect_diag9c() {
...
#[no_mangle]
unsafe extern "C" fn reset_tod_clock() {
...
#[no_mangle]
unsafe extern "C" fn detect_facilities() {
...
#[no_mangle]
unsafe extern "C" fn cmma_test_essa() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mem_safe_offset() -> c_ulong {
    static unsigned long mem_safe_offset(void)
    {
    return (unsigned long)_compressed_start;
    }
#[no_mangle]
unsafe extern "C" fn deploy_kernel(output: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rescue_initrd(min: c_ulong, max: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn copy_bootdata() {
...
#[no_mangle]
unsafe extern "C" fn kaslr_adjust_got(offset: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn setup_ident_map_size(max_physmem_end: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn setup_kernel_memory_layout(kernel_size: c_ulong) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn clear_bss_section(kernel_start: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn setup_vmalloc_size() {
...
#[no_mangle]
unsafe extern "C" fn kaslr_adjust_vmlinux_info(offset: c_long) {
...
#[no_mangle]
pub unsafe extern "C" fn startup_kernel() {
    void startup_kernel(void)
    {
    let mut vmlinux_size: c_ulong = vmlinux.image_size + vmlinux.bss_size;
    unsigned long nokaslr_text_lma, text_lma = 0, amode31_lma = 0;
    let mut kernel_size: c_ulong = TEXT_OFFSET + vmlinux_size;
...
//
    ...
    if (kaslr_enabled()) {
    let mut size: c_ulong = vmlinux_size + kaslr_large_page_offset;
