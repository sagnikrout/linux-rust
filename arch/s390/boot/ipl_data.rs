...
//! Source: arch/s390/boot/ipl_data.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipl_lowcore {
    pub /: *mut *mut psw32_t ipl_psw; / 0x0000,
    pub /: *mut *mut ccw0 ccwpgm[2]; / 0x0008,
    pub /: *mut *mut u8 fill[56]; / 0x0018,
    pub /: *mut *mut ccw0 ccwpgmcc[20]; / 0x0050,
    pub /: *mut *mut u8 pad_0xf0[0x0140-0x00f0]; / 0x00f0,
    pub /: *mut *mut psw_t svc_old_psw; / 0x0140,
    pub /: *mut *mut u8 pad_0x150[0x01a0-0x0150]; / 0x0150,
    pub /: *mut *mut psw_t restart_psw; / 0x01a0,
    pub /: *mut *mut psw_t external_new_psw; / 0x01b0,
    pub /: *mut *mut psw_t svc_new_psw; / 0x01c0,
    pub /: *mut *mut psw_t program_new_psw; / 0x01d0,
    pub /: *mut *mut psw_t mcck_new_psw; / 0x01e0,
    pub /: *mut *mut psw_t io_new_psw; / 0x01f0,
}
