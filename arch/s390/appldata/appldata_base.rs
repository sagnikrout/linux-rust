...
//! Source: arch/s390/appldata/appldata_base.c
#![no_std]
...
//
    ...
    milliseconds */
pub const TOD_MICRO: c_uint = 0x01000			/* nr. of TOD clock units;
    for 1 microsecond */
//
// /proc entries (sysctl)
//
...
//
    ...
    let mut appldata_interval: static int = APPLDATA_CPU_INTERVAL;
...
//
#[no_mangle]
unsafe extern "C" fn appldata_timer_function(data: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn appldata_work_fn(work: *mut work_struct) {
    static void appldata_work_fn(struct work_struct *work)
    {
    struct list_head *lh;
...
// timer, work, DIAG <END>
// /proc stuff
pub const APPLDATA_ADD_TIMER: c_int = 0;
pub const APPLDATA_DEL_TIMER: c_int = 1;
pub const APPLDATA_MOD_TIMER: c_int = 2;
//
...
//
#[no_mangle]
unsafe extern "C" fn __appldata_vtimer_setup(cmd: c_int) {
    static void __appldata_vtimer_setup(int cmd)
    {
    let mut timer_interval: u64 = (u64) appldata_interval * 1000 * TOD_MICRO;
    switch (cmd) {
...
//
    ...
    void *buffer, size_t *lenp, loff_t *ppos)
    {
    let mut timer_active: c_int = appldata_timer_active;
    int rc;
...
//
    ...
    void *buffer, size_t *lenp, loff_t *ppos)
    {
    let mut interval: c_int = appldata_interval;
    int rc;
    struct ctl_table ctl_entry = {
    .procname	= ctl.procname,
    .data		= &interval,
...
//
    ...
    void *buffer, size_t *lenp, loff_t *ppos)
    {
    struct appldata_ops *ops = core::ptr::null_mut(), *tmp_ops;
    struct list_head *lh;
    int rc, found;
    int active;
    struct ctl_table ctl_entry = {
...
//
#[no_mangle]
pub unsafe extern "C" fn appldata_register_ops(ops: *mut appldata_ops) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn appldata_unregister_ops(ops: *mut appldata_ops) {
...
//
#[no_mangle]
unsafe extern "C" fn appldata_init() -> int __init {
