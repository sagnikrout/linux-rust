...
//! Source: arch/s390/kvm/s390/pv.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_is_protected(kvm: *mut kvm) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_cpu_is_protected(vcpu: *mut kvm_vcpu) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn should_export_before_import(uvcb: *mut uv_cb_header, mm: *mut mm_struct) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __kvm_s390_pv_make_secure(f: *mut guest_fault, folio: *mut folio) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_make_secure(kvm: *mut kvm, gaddr: c_ulong, uvcb: *mut c_void) -> c_int {
    int kvm_s390_pv_make_secure(struct kvm *kvm, unsigned long gaddr, void *uvcb)
    {
    let mut priv: pv_make_secure = { .uvcb = uvcb, .kvm = kvm, };
    ...
    rc = kvm_s390_faultin_gfn(core::ptr::null_mut(), kvm, &f);
    if (!rc) {
    rc = priv.rc;
    if (priv.folio) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_convert_to_secure(kvm: *mut kvm, gaddr: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_destroy_page(kvm: *mut kvm, gaddr: c_ulong) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pv_vm_to_be_destroyed {
    pub list: list_head,
    pub old_gmap_table: c_ulong,
    pub handle: u64,
...
#[no_mangle]
unsafe extern "C" fn kvm_s390_clear_pv_state(kvm: *mut kvm) {
    static void kvm_s390_clear_pv_state(struct kvm *kvm)
    {
    kvm.arch.pv.handle = 0;
    kvm.arch.pv.guest_len = 0;
    kvm.arch.pv.stor_base = 0;
    kvm.arch.pv.stor_var = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn kvm_s390_pv_dispose_cpu(vcpu: *mut kvm_vcpu, free_stor_base: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_destroy_cpu(vcpu: *mut kvm_vcpu, rc: *mut u16, rrc: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_create_cpu(vcpu: *mut kvm_vcpu, rc: *mut u16, rrc: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_s390_pv_dealloc_vm(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn kvm_s390_pv_alloc_vm(kvm: *mut kvm) -> c_int {
    static int kvm_s390_pv_alloc_vm(struct kvm *kvm)
    {
    let mut base: c_ulong = uv_info.guest_base_stor_len;
    let mut virt: c_ulong = uv_info.guest_virt_var_stor_len;
    let mut npages: c_ulong = 0, vlen = 0;
    kvm.arch.pv.stor_var = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn kvm_s390_pv_deinit_vm_fast(kvm: *mut kvm, rc: *mut u16, rrc: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_destroy_fast_available() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_set_aside(kvm: *mut kvm, rc: *mut u16, rrc: *mut u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_deinit_vm(kvm: *mut kvm, rc: *mut u16, rrc: *mut u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_deinit_cleanup_all(kvm: *mut kvm, rc: *mut u16, rrc: *mut u16) -> c_int {
    int kvm_s390_pv_deinit_cleanup_all(struct kvm *kvm, u16 *rc, u16 *rrc)
    {
    struct pv_vm_to_be_destroyed *cur;
    let mut need_zap: bool = false;
    u16 _rc, _rrc;
    let mut cc: c_int = 0;
//
...
// If a previous protected VM was set aside, put it in the need_cleanup list
    ...
    kvm.arch.pv.set_aside = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_deinit_aside_vm(kvm: *mut kvm, rc: *mut u16, rrc: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_init_vm(kvm: *mut kvm, rc: *mut u16, rrc: *mut u16) -> c_int {
...
// The notifier will be unregistered when the VM is destroyed
    ...
    if (ret) {
    kvm.arch.pv.mmu_notifier.ops = core::ptr::null_mut();
    return ret;
    }
    }
...
// Outputs
    ...
    let mut cc: c_int = uv_call(0, (u64)&uvcb);
// rc = uvcb.header.rc;
// rrc = uvcb.header.rrc;
...
// rc, *rrc);
    ...
    let mut ret: c_int = kvm_s390_pv_make_secure(kvm, addr, &uvcb);
// rc = uvcb.header.rc;
// rrc = uvcb.header.rrc;
    if (ret == -ENXIO) {
    ret = kvm_s390_faultin_gfn_simple(core::ptr::null_mut(), kvm, gpa_to_gfn(addr), true);
    if (!ret)
    return -EAGAIN;
    }
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_set_cpu_state(vcpu: *mut kvm_vcpu, state: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_pv_dump_cpu(vcpu: *mut kvm_vcpu, buff: *mut c_void, rc: *mut u16, rrc: *mut u16) -> c_int {
...
//
    ...
    let mut increment_len: u64 = uv_info.conf_dump_storage_state_len;
    size_t buff_kvm_size;
    let mut size_done: usize = 0;
    u8 *buff_kvm = core::ptr::null_mut();
    int cc, ret;
    ret = -EINVAL;
