...
//! Source: arch/s390/kvm/s390/diag.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn do_discard_gfn_range(vcpu: *mut kvm_vcpu, gfn_start: gfn_t, gfn_end: gfn_t) {
...
#[no_mangle]
unsafe extern "C" fn diag_release_pages(vcpu: *mut kvm_vcpu) -> c_int {
    static int diag_release_pages(struct kvm_vcpu *vcpu)
    {
    unsigned long start, end;
    let mut prefix: c_ulong = kvm_s390_get_prefix(vcpu);
...
#[no_mangle]
unsafe extern "C" fn __diag_page_ref_service(vcpu: *mut kvm_vcpu) -> c_int {
...
pub struct prs_parm {
    ...
    int rc;
    let mut rx: u16 = (vcpu.arch.sie_block.ipa & 0xf0) >> 4;
    let mut ry: u16 = (vcpu.arch.sie_block.ipa & 0x0f);
...
#[no_mangle]
unsafe extern "C" fn __diag_time_slice_end(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn diag9c_forwarding_overrun() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __diag_time_slice_end_directed(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __diag_ipl_functions(vcpu: *mut kvm_vcpu) -> c_int {
    static int __diag_ipl_functions(struct kvm_vcpu *vcpu)
    {
    let mut reg: c_uint = vcpu.arch.sie_block.ipa & 0xf;
    let mut subcode: c_ulong = vcpu.run.s.regs.gprs[reg] & 0xffff;
...
#[no_mangle]
unsafe extern "C" fn __diag_virtio_hypercall(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_handle_diag(vcpu: *mut kvm_vcpu) -> c_int {
    int kvm_s390_handle_diag(struct kvm_vcpu *vcpu)
    {
    let mut code: c_int = kvm_s390_get_base_disp_rs(vcpu, core::ptr::null_mut()) & 0xffff;
