...
//! Source: arch/s390/kvm/s390/vsie.c
#![no_std]
...
pub struct vsie_page {
    pub /: *mut *mut kvm_s390_sie_block scb_s; / 0x0000,
...
//
    pub /: *mut *mut *mut kvm_s390_sie_block scb_o; / 0x0218,
//
// Flags: must be set/cleared atomically after the vsie page can be
// looked up by other CPUs.
//
    pub /: *mut *mut unsigned long flags; / 0x0220,
// address of the last reported fault to guest2
    pub /: *mut *mut unsigned long fault_addr; / 0x0228,
// calculated guest addresses of satellite control blocks
    pub /: *mut *mut gpa_t sca_gpa; / 0x0230,
    pub /: *mut *mut gpa_t itdba_gpa; / 0x0238,
    pub /: *mut *mut gpa_t gvrd_gpa; / 0x0240,
    pub /: *mut *mut gpa_t riccbd_gpa; / 0x0248,
    pub /: *mut *mut gpa_t sdnx_gpa; / 0x0250,
//
// guest address of the original SCB. Remains set for free vsie
// pages, so we can properly look them up in our addr_to_page
// radix tree.
//
    pub /: *mut *mut gpa_t scb_gpa; / 0x0258,
// the shadow gmap in use by the vsie_page
    pub /: *mut *mut gmap_cache gmap_cache; / 0x0260,
    pub /: *mut *mut __u8 reserved[0x06f8 - 0x0278]; / 0x0278,
    pub /: *mut *mut kvm_s390_crypto_cb crycb; / 0x06f8,
    pub /: *mut *mut __u8 fac[8 + S390_ARCH_FAC_LIST_SIZE_BYTE];/ 0x07f8,
}
...
#[no_mangle]
unsafe extern "C" fn prefix_unmapped(vsie_page: *mut vsie_page) {
...
#[no_mangle]
unsafe extern "C" fn prefix_unmapped_sync(vsie_page: *mut vsie_page) {
...
#[no_mangle]
unsafe extern "C" fn prefix_mapped(vsie_page: *mut vsie_page) {
...
#[no_mangle]
unsafe extern "C" fn prefix_is_mapped(vsie_page: *mut vsie_page) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_intervention_requests(vsie_page: *mut vsie_page) {
    static void update_intervention_requests(struct vsie_page *vsie_page)
    {
    let mut bits: c_int = CPUSTAT_STOP_INT | CPUSTAT_IO_INT | CPUSTAT_EXT_INT;
    int cpuflags;
...
#[no_mangle]
unsafe extern "C" fn prepare_cpuflags(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) -> c_int {
...
// we don't allow ESA/390 guests unless explicitly enabled
    ...
    return set_validity_icpt(scb_s, 0x0001U);
#[no_mangle]
pub unsafe extern "C" fn if(CPUSTAT_SLSR): cpuflags & (CPUSTAT_SLSV |) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn shadow_crycb(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) -> c_int {
    static int shadow_crycb(struct kvm_vcpu *vcpu, struct vsie_page *vsie_page)
    {
    struct kvm_s390_sie_block *scb_s = &vsie_page.scb_s;
    struct kvm_s390_sie_block *scb_o = vsie_page.scb_o;
    let mut crycbd_o: u32 = READ_ONCE(scb_o.crycbd);
    let mut crycb_addr: u32 = crycbd_o & 0x7ffffff8U;
    unsigned long *b1, *b2;
    u8 ecb3_flags;
    u32 ecd_flags;
    int apie_h;
    int apie_s;
    let mut key_msk: c_int = test_kvm_facility(vcpu.kvm, 76);
    let mut fmt_o: c_int = crycbd_o & CRYCB_FORMAT_MASK;
    let mut fmt_h: c_int = vcpu.arch.sie_block.crycbd & CRYCB_FORMAT_MASK;
    let mut ret: c_int = 0;
    scb_s.crycbd = 0;
...
#[no_mangle]
unsafe extern "C" fn shadow_esa(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) {
...
#[no_mangle]
unsafe extern "C" fn prepare_ibc(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) {
    static void prepare_ibc(struct kvm_vcpu *vcpu, struct vsie_page *vsie_page)
    {
    struct kvm_s390_sie_block *scb_s = &vsie_page.scb_s;
    struct kvm_s390_sie_block *scb_o = vsie_page.scb_o;
// READ_ONCE does not work on bitfields - use a temporary variable
    let mut __new_ibc: u32 = scb_o.ibc;
    let mut new_ibc: u32 = READ_ONCE(__new_ibc) & 0x0fffU;
    let mut min_ibc: __u64 = (sclp.ibc >> 16) & 0x0fffU;
    scb_s.ibc = 0;
...
#[no_mangle]
unsafe extern "C" fn unshadow_scb(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) {
...
//
#[no_mangle]
unsafe extern "C" fn shadow_scb(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) -> c_int {
    static int shadow_scb(struct kvm_vcpu *vcpu, struct vsie_page *vsie_page)
    {
    struct kvm_s390_sie_block *scb_o = vsie_page.scb_o;
    struct kvm_s390_sie_block *scb_s = &vsie_page.scb_s;
// READ_ONCE does not work on bitfields - use a temporary variable
    let mut __new_prefix: u32 = scb_o.prefix;
    let mut new_prefix: u32 = READ_ONCE(__new_prefix);
    let mut wants_tx: bool = READ_ONCE(scb_o.ecb) & ECB_TE;
    let mut had_tx: bool = scb_s.ecb & ECB_TE;
    let mut new_mso: c_ulong = 0;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_vsie_gmap_notifier(gmap: *mut gmap, start: gpa_t, end: gpa_t) {
...
//
#[no_mangle]
unsafe extern "C" fn map_prefix(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page, sg: *mut gmap) -> c_int {
    static int map_prefix(struct kvm_vcpu *vcpu, struct vsie_page *vsie_page, struct gmap *sg)
    {
    struct kvm_s390_sie_block *scb_s = &vsie_page.scb_s;
    let mut prefix: u64 = scb_s.prefix << GUEST_PREFIX_SHIFT;
    int rc;
...
// with mso/msl, the prefix lies at offset *mso*
    prefix += scb_s.mso;
    rc = gaccess_shadow_fault(vcpu, sg, prefix, core::ptr::null_mut(), true);
    if (!rc && (scb_s.ecb & ECB_TE))
    rc = gaccess_shadow_fault(vcpu, sg, prefix + PAGE_SIZE, core::ptr::null_mut(), true);
//
...
//
#[no_mangle]
unsafe extern "C" fn pin_guest_page(kvm: *mut kvm, gpa: gpa_t, hpa: *mut hpa_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unpin_guest_page(kvm: *mut kvm, gpa: gpa_t, hpa: hpa_t) {
...
#[no_mangle]
unsafe extern "C" fn unpin_blocks(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) {
...
//
#[no_mangle]
unsafe extern "C" fn pin_blocks(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(kvm_s390_get_prefix(vcpu): (gpa & ~0x1fffUL) ==) -> else {
...
// unpin the scb provided by guest 2, marking it as dirty
    ...
    gpa_t gpa)
    {
    let mut hpa: hpa_t = virt_to_phys(vsie_page.scb_o);
    if (hpa)
    unpin_guest_page(vcpu.kvm, gpa, hpa);
    vsie_page.scb_o = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn handle_fault(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page, sg: *mut gmap) -> c_int {
    static int handle_fault(struct kvm_vcpu *vcpu, struct vsie_page *vsie_page, struct gmap *sg)
    {
    let mut wr: bool = kvm_s390_cur_gmap_fault_is_write();
    int rc;
...
// we can directly forward all protection exceptions
    ...
    rc = gaccess_shadow_fault(vcpu, sg, current.thread.gmap_teid.addr * PAGE_SIZE, core::ptr::null_mut(), wr);
    if (rc > 0) {
...
//
#[no_mangle]
unsafe extern "C" fn handle_last_fault(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page, sg: *mut gmap) {
    static void handle_last_fault(struct kvm_vcpu *vcpu, struct vsie_page *vsie_page, struct gmap *sg)
    {
    if (vsie_page.fault_addr)
    gaccess_shadow_fault(vcpu, sg, vsie_page.fault_addr, core::ptr::null_mut(), true);
    vsie_page.fault_addr = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn clear_vsie_icpt(vsie_page: *mut vsie_page) {
...
#[no_mangle]
unsafe extern "C" fn retry_vsie_icpt(vsie_page: *mut vsie_page) {
    static void retry_vsie_icpt(struct vsie_page *vsie_page)
    {
    struct kvm_s390_sie_block *scb_s = &vsie_page.scb_s;
    let mut ilen: c_int = insn_length(scb_s.ipa >> 8);
...
#[no_mangle]
unsafe extern "C" fn handle_stfle_2(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page, fac_list_origin: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn handle_stfle(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) -> c_int {
    static int handle_stfle(struct kvm_vcpu *vcpu, struct vsie_page *vsie_page)
    {
    let mut has_astfleie2: bool = test_kvm_cpu_feat(vcpu.kvm, KVM_S390_VM_CPU_FEAT_ASTFLEIE2);
    let mut fac: u32 = READ_ONCE(vsie_page.scb_o.fac);
...
//
#[no_mangle]
unsafe extern "C" fn vsie_get_register(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page, reg: u8) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vsie_handle_mvpg(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page, sg: *mut gmap) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn do_vsie_run(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page, sg: *mut gmap) -> c_int {
    ...
    struct kvm_s390_sie_block *scb_s = &vsie_page.scb_s;
    struct kvm_s390_sie_block *scb_o = vsie_page.scb_o;
    let mut sie_return: c_ulong = SIE64_RETURN_NORMAL;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: current->thread.gmap_int_code) -> else {
...
#[no_mangle]
unsafe extern "C" fn release_gmap_shadow(vsie_page: *mut vsie_page) {
    ...
    vsie_page.gmap_cache.gmap = core::ptr::null_mut();
    prefix_unmapped(vsie_page);
...
//
#[no_mangle]
unsafe extern "C" fn unregister_shadow_scb(vcpu: *mut kvm_vcpu) {
    static void unregister_shadow_scb(struct kvm_vcpu *vcpu)
    {
    kvm_s390_clear_cpuflags(vcpu, CPUSTAT_WAIT);
    WRITE_ONCE(vcpu.arch.vsie_block, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn vsie_run(vcpu: *mut kvm_vcpu, vsie_page: *mut vsie_page) -> c_int {
    static int vsie_run(struct kvm_vcpu *vcpu, struct vsie_page *vsie_page)
    {
    struct kvm_s390_sie_block *scb_s = &vsie_page.scb_s;
    struct gmap *sg = core::ptr::null_mut();
    let mut rc: c_int = 0;
    while (1) {
...
#[no_mangle]
pub unsafe extern "C" fn try_get_vsie_page(vsie_page: *mut vsie_page) -> bool {
...
#[no_mangle]
unsafe extern "C" fn put_vsie_page(vsie_page: *mut vsie_page) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_handle_vsie(vcpu: *mut kvm_vcpu) -> c_int {
    ...
    scb_addr = kvm_s390_get_base_disp_s(vcpu, core::ptr::null_mut());
// 512 byte alignment
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_vsie_init(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_vsie_destroy(kvm: *mut kvm) {
    ...
    if (vsie_page.gmap_cache.gmap)
    release_gmap_shadow(vsie_page);
    kvm.arch.vsie.pages[i] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_vsie_kick(vcpu: *mut kvm_vcpu) {
