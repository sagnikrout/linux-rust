...
//! Source: arch/s390/kvm/s390/interrupt.c
#![no_std]
...
pub const PFAULT_INIT: c_uint = 0x0600;
pub const PFAULT_DONE: c_uint = 0x0680;
pub const VIRTIO_PARAM: c_uint = 0x0d00;
    static struct kvm_s390_gib *gib;
// handle external calls via sigp interpretation facility
#[no_mangle]
unsafe extern "C" fn sca_ext_call_pending(vcpu: *mut kvm_vcpu, src_id: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca_inject_ext_call(vcpu: *mut kvm_vcpu, src_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sca_clear_ext_call(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn psw_extint_disabled(vcpu: *mut kvm_vcpu) -> c_int {
    int psw_extint_disabled(struct kvm_vcpu *vcpu)
    {
    return !(vcpu.arch.sie_block.gpsw.mask & PSW_MASK_EXT);
    }
#[no_mangle]
unsafe extern "C" fn psw_ioint_disabled(vcpu: *mut kvm_vcpu) -> c_int {
    static int psw_ioint_disabled(struct kvm_vcpu *vcpu)
    {
    return !(vcpu.arch.sie_block.gpsw.mask & PSW_MASK_IO);
    }
#[no_mangle]
unsafe extern "C" fn psw_mchk_disabled(vcpu: *mut kvm_vcpu) -> c_int {
    static int psw_mchk_disabled(struct kvm_vcpu *vcpu)
    {
    return !(vcpu.arch.sie_block.gpsw.mask & PSW_MASK_MCHECK);
    }
#[no_mangle]
unsafe extern "C" fn psw_interrupts_disabled(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ckc_interrupts_enabled(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ckc_irq_pending(vcpu: *mut kvm_vcpu) -> c_int {
    static int ckc_irq_pending(struct kvm_vcpu *vcpu)
    {
    let mut now: u64 = kvm_s390_get_tod_clock_fast(vcpu.kvm);
    let mut ckc: u64 = vcpu.arch.sie_block.ckc;
...
#[no_mangle]
unsafe extern "C" fn cpu_timer_interrupts_enabled(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_timer_irq_pending(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isc_to_isc_bits(isc: c_int) -> u64 {
    static uint64_t isc_to_isc_bits(int isc)
    {
    return (0x80 >> isc) << 24;
    }
#[no_mangle]
pub unsafe extern "C" fn isc_to_int_word(isc: u8) -> u32 {
    static inline u32 isc_to_int_word(u8 isc)
    {
    return ((u32)isc << 27) | 0x80000000;
    }
#[no_mangle]
pub unsafe extern "C" fn int_word_to_isc(int_word: u32) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn gisa_set_iam(gisa: *mut kvm_s390_gisa, iam: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gisa_clear_ipm(gisa: *mut kvm_s390_gisa) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gisa_get_ipm_or_restore_iam(gi: *mut kvm_s390_gisa_interrupt) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn gisa_set_ipm_gisc(gisa: *mut kvm_s390_gisa, gisc: u32) {
    static inline void gisa_set_ipm_gisc(struct kvm_s390_gisa *gisa, u32 gisc)
    {
    set_bit_inv(IPM_BIT_OFFSET + gisc, (unsigned long *) gisa);
    }
#[no_mangle]
pub unsafe extern "C" fn gisa_get_ipm(gisa: *mut kvm_s390_gisa) -> u8 {
    static inline u8 gisa_get_ipm(struct kvm_s390_gisa *gisa)
    {
    return READ_ONCE(gisa.ipm);
    }
#[no_mangle]
pub unsafe extern "C" fn gisa_tac_ipm_gisc(gisa: *mut kvm_s390_gisa, gisc: u32) -> c_int {
    static inline int gisa_tac_ipm_gisc(struct kvm_s390_gisa *gisa, u32 gisc)
    {
    return test_and_clear_bit_inv(IPM_BIT_OFFSET + gisc, (unsigned long *) gisa);
    }
#[no_mangle]
pub unsafe extern "C" fn gisa_test_ipm_gisc(gisa: *mut kvm_s390_gisa, gisc: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pending_irqs_no_gisa(vcpu: *mut kvm_vcpu) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn pending_irqs(vcpu: *mut kvm_vcpu) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn isc_to_irq_type(isc: c_ulong) -> c_int {
    static inline int isc_to_irq_type(unsigned long isc)
    {
    return IRQ_PEND_IO_ISC_0 - isc;
    }
#[no_mangle]
pub unsafe extern "C" fn irq_type_to_isc(irq_type: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn deliverable_irqs(vcpu: *mut kvm_vcpu) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn __set_cpu_idle(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __unset_cpu_idle(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __reset_intercept_indicators(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn set_intercept_indicators_io(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn set_intercept_indicators_ext(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn set_intercept_indicators_mchk(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn set_intercept_indicators_stop(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn set_intercept_indicators(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn __deliver_cpu_timer(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_ckc(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_pfault_init(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_machine_check(vcpu: *mut kvm_vcpu) -> int __must_check {
    static int __must_check __deliver_machine_check(struct kvm_vcpu *vcpu)
    {
    struct kvm_s390_float_interrupt *fi = &vcpu.kvm.arch.float_int;
    struct kvm_s390_local_interrupt *li = &vcpu.arch.local_int;
    let mut mchk: kvm_s390_mchk_info = {};
    let mut deliver: c_int = 0;
    let mut rc: c_int = 0;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn __deliver_restart(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_set_prefix(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_emergency_signal(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_external_call(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_prog_pv(vcpu: *mut kvm_vcpu, code: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __deliver_prog(vcpu: *mut kvm_vcpu) -> int __must_check {
    static int __must_check __deliver_prog(struct kvm_vcpu *vcpu)
    {
    struct kvm_s390_local_interrupt *li = &vcpu.arch.local_int;
    struct kvm_s390_pgm_info pgm_info;
    let mut rc: c_int = 0, nullifying = false;
    u16 ilen;
    spin_lock(&li.lock);
    pgm_info = li.irq.pgm;
...
pub const SCCB_MASK: c_uint = 0xFFFFFFF8;
pub const SCCB_EVENT_PENDING: c_uint = 0x3;
#[no_mangle]
unsafe extern "C" fn write_sclp(vcpu: *mut kvm_vcpu, parm: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __deliver_service(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_service_ev(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_pfault_done(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __deliver_virtio(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __do_deliver_io(vcpu: *mut kvm_vcpu, io: *mut kvm_s390_io_info) -> c_int {
    ...
    struct kvm_s390_gisa_interrupt *gi = &vcpu.kvm.arch.gisa_int;
    struct kvm_s390_interrupt_info *inti = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_ext_call_pending(vcpu: *mut kvm_vcpu) -> c_int {
    int kvm_s390_ext_call_pending(struct kvm_vcpu *vcpu)
    {
    struct kvm_s390_local_interrupt *li = &vcpu.arch.local_int;
    if (!kvm_s390_use_sca_entries())
    return test_bit(IRQ_PEND_EXT_EXTERNAL, &li.pending_irqs);
    return sca_ext_call_pending(vcpu, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_vcpu_has_irq(vcpu: *mut kvm_vcpu, exclude_stop: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_cpu_has_pending_timer(vcpu: *mut kvm_vcpu) -> c_int {
    int kvm_cpu_has_pending_timer(struct kvm_vcpu *vcpu)
    {
    return ckc_irq_pending(vcpu) || cpu_timer_irq_pending(vcpu);
    }
#[no_mangle]
unsafe extern "C" fn __calculate_sltime(vcpu: *mut kvm_vcpu) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_handle_wait(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_vcpu_wakeup(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_idle_wakeup(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_clear_local_irqs(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_deliver_pending_interrupts(vcpu: *mut kvm_vcpu) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn __inject_prog(vcpu: *mut kvm_vcpu, irq: *mut kvm_s390_irq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __inject_pfault_init(vcpu: *mut kvm_vcpu, irq: *mut kvm_s390_irq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __inject_extcall(vcpu: *mut kvm_vcpu, irq: *mut kvm_s390_irq) -> c_int {
    static int __inject_extcall(struct kvm_vcpu *vcpu, struct kvm_s390_irq *irq)
    {
    struct kvm_s390_local_interrupt *li = &vcpu.arch.local_int;
    struct kvm_s390_extcall_info *extcall = &li.irq.extcall;
    let mut src_id: u16 = irq.u.extcall.code;
...
// sending vcpu invalid
    if (kvm_get_vcpu_by_id(vcpu.kvm, src_id) == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn __inject_set_prefix(vcpu: *mut kvm_vcpu, irq: *mut kvm_s390_irq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __inject_sigp_stop(vcpu: *mut kvm_vcpu, irq: *mut kvm_s390_irq, storestatus: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __inject_sigp_restart(vcpu: *mut kvm_vcpu) -> c_int {
    ...
    irq.u.emerg.code, 0);
// sending vcpu invalid
    if (kvm_get_vcpu_by_id(vcpu.kvm, irq.u.emerg.code) == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn __inject_mchk(vcpu: *mut kvm_vcpu, irq: *mut kvm_s390_irq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MCHK_REP_MASK: mchk->mcic &) -> else {
    else if (mchk.mcic & MCHK_REP_MASK)
    set_bit(IRQ_PEND_MCHK_REP,  &li.pending_irqs);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn __inject_ckc(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __inject_cpu_timer(vcpu: *mut kvm_vcpu) -> c_int {
    ...
    let mut id: u16 = (schid & 0xffff0000U) >> 16;
    let mut nr: u16 = schid & 0x0000ffffU;
    unsigned long flags;
    spin_lock_irqsave(&fi.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn get_top_gisa_isc(kvm: *mut kvm, isc_mask: u64, schid: u32) -> c_int {
...
pub const CR_PENDING_SUBCLASS: c_int = 28;
...
#[no_mangle]
unsafe extern "C" fn __inject_io(kvm: *mut kvm, inti: *mut kvm_s390_interrupt_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __floating_irq_kick(kvm: *mut kvm, type: u64) {
...
#[no_mangle]
unsafe extern "C" fn __inject_vm(kvm: *mut kvm, inti: *mut kvm_s390_interrupt_info) -> c_int {
    static int __inject_vm(struct kvm *kvm, struct kvm_s390_interrupt_info *inti)
    {
    let mut type: u64 = READ_ONCE(inti.type);
    int rc;
    switch (type) {
    case KVM_S390_MCHK:
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_is_stop_irq_pending(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_is_restart_irq_pending(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_clear_stop_irq(vcpu: *mut kvm_vcpu) {
...
#[no_mangle]
unsafe extern "C" fn do_inject_vcpu(vcpu: *mut kvm_vcpu, irq: *mut kvm_s390_irq, storestatus: *mut bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_inject_vcpu(vcpu: *mut kvm_vcpu, irq: *mut kvm_s390_irq) -> c_int {
    int kvm_s390_inject_vcpu(struct kvm_vcpu *vcpu, struct kvm_s390_irq *irq)
    {
    struct kvm_s390_local_interrupt *li = &vcpu.arch.local_int;
    let mut storestatus: bool = false;
    int rc;
    spin_lock(&li.lock);
...
#[no_mangle]
pub unsafe extern "C" fn clear_irq_list(_list: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_clear_float_irqs(kvm: *mut kvm) {
...
#[no_mangle]
unsafe extern "C" fn get_all_floating_irqs(kvm: *mut kvm, usrbuf: *mut u8 __user, len: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flic_ais_mode_get_all(kvm: *mut kvm, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flic_get_attr(dev: *mut kvm_device, attr: *mut kvm_device_attr) -> c_int {
    ...
    struct kvm_s390_interrupt_info *inti = core::ptr::null_mut();
    let mut r: c_int = 0;
    let mut len: c_int = attr.attr;
    if (len % sizeof(struct kvm_s390_irq) != 0)
    return -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(KVM_S390_FLIC_MAX_BUFFER: len >) -> else {
    ...
    if (dev.kvm.arch.adapters[adapter_info.id] != core::ptr::null_mut()) {
    rc = -EINVAL;
    goto out;
    }
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_mask_adapter(kvm: *mut kvm, id: c_uint, masked: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_s390_adapter_map(kvm: *mut kvm, id: c_uint, addr: __u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kvm_s390_adapter_unmap(kvm: *mut kvm, id: c_uint, addr: __u64) -> c_int {
    static int kvm_s390_adapter_unmap(struct kvm *kvm, unsigned int id, __u64 addr)
    {
    struct s390_io_adapter *adapter = get_io_adapter(kvm, id);
    struct s390_map_info *map, *tmp, *map_to_free;
    struct page *map_page_to_put = core::ptr::null_mut();
    let mut map_addr_to_mark: u64 = 0;
    let mut map_pinned: bool = false;
    unsigned long flags;
    let mut found: c_int = 0, idx;
    if (!adapter || !addr)
    return -EINVAL;
    spin_lock_irqsave(&adapter.maps_lock, flags);
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_unmap_all_adapters(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_destroy_adapters(kvm: *mut kvm) {
    ...
    kvm.arch.adapters[i] = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn clear_io_irq(kvm: *mut kvm, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn modify_ais_mode(kvm: *mut kvm, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flic_inject_airq(kvm: *mut kvm, attr: *mut kvm_device_attr) -> c_int {
    static int flic_inject_airq(struct kvm *kvm, struct kvm_device_attr *attr)
    {
    let mut id: c_uint = attr.attr;
    struct s390_io_adapter *adapter = get_io_adapter(kvm, id);
...
#[no_mangle]
unsafe extern "C" fn flic_ais_mode_set_all(kvm: *mut kvm, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flic_set_attr(dev: *mut kvm_device, attr: *mut kvm_device_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flic_create(dev: *mut kvm_device, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flic_destroy(dev: *mut kvm_device) {
    static void flic_destroy(struct kvm_device *dev)
    {
    dev.kvm.arch.flic = core::ptr::null_mut();
    kfree(dev);
    }
...
#[no_mangle]
unsafe extern "C" fn get_ind_bit(addr: __u64, bit_nr: c_ulong, swap: bool) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_set_irq_state(vcpu: *mut kvm_vcpu, irqstate: *mut void __user, len: c_int) -> c_int {
    int kvm_s390_set_irq_state(struct kvm_vcpu *vcpu, void __user *irqstate, int len)
    {
    struct kvm_s390_local_interrupt *li = &vcpu.arch.local_int;
    struct kvm_s390_irq *buf __free(kvfree) = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_get_irq_state(vcpu: *mut kvm_vcpu, buf: *mut __u8 __user, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __airqs_kick_single_vcpu(kvm: *mut kvm, deliverable_mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn gisa_vcpu_kicker(timer: *mut hrtimer) -> enum hrtimer_restart {
...
pub const NULL_GISA_ADDR: c_uint = 0x00000000UL;
pub const NONE_GISA_ADDR: c_uint = 0x00000001UL;
pub const GISA_ADDR_MASK: c_uint = 0xfffff000UL;
#[no_mangle]
unsafe extern "C" fn process_gib_alert_list() {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gisa_clear(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gisa_init(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gisa_enable(kvm: *mut kvm) {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gisa_destroy(kvm: *mut kvm) {
    ...
    hrtimer_cancel(&gi.timer);
    gi.origin = core::ptr::null_mut();
    VM_EVENT(kvm, 3, "gisa 0x%p destroyed", gisa);
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gisa_disable(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gisc_register(kvm: *mut kvm, gisc: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gisc_unregister(kvm: *mut kvm, gisc: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aen_host_forward(si: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn aen_process_gait(isc: u8) {
    static void aen_process_gait(u8 isc)
    {
    let mut found: bool = false, first = true;
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gib_destroy() {
    ...
    gib = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_gib_init(nisc: u8) -> int __init {
