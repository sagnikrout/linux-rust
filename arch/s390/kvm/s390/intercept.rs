...
//! Source: arch/s390/kvm/s390/intercept.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kvm_s390_get_ilen(vcpu: *mut kvm_vcpu) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn handle_stop(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_validity(vcpu: *mut kvm_vcpu) -> c_int {
    static int handle_validity(struct kvm_vcpu *vcpu)
    {
    let mut viwhy: c_int = vcpu.arch.sie_block.ipb >> 16;
...
#[no_mangle]
unsafe extern "C" fn handle_instruction(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inject_prog_on_prog_intercept(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn handle_itdb(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn should_handle_per_event(vcpu: *const kvm_vcpu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn handle_prog(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn handle_external_interrupt(vcpu: *mut kvm_vcpu) -> c_int {
    static int handle_external_interrupt(struct kvm_vcpu *vcpu)
    {
    let mut eic: u16 = vcpu.arch.sie_block.eic;
...
//
#[no_mangle]
unsafe extern "C" fn handle_mvpg_pei(vcpu: *mut kvm_vcpu) -> c_int {
...
// Ensure that the source is paged-in, no actual access -> no key checking
    ...
    do {
    rc = kvm_s390_faultin_gfn_simple(vcpu, core::ptr::null_mut(), gpa_to_gfn(srcaddr), false);
    } while (rc == -EAGAIN);
    if (rc)
    return rc;
// Ensure that the source is paged-in, no actual access -> no key checking
    ...
    return kvm_s390_inject_prog_cond(vcpu, rc);
    do {
    rc = kvm_s390_faultin_gfn_simple(vcpu, core::ptr::null_mut(), gpa_to_gfn(dstaddr), true);
    } while (rc == -EAGAIN);
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn handle_partial_execution(vcpu: *mut kvm_vcpu) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_sthyi(vcpu: *mut kvm_vcpu) -> c_int {
    int handle_sthyi(struct kvm_vcpu *vcpu)
    {
    int reg1, reg2, cc = 0, r = 0;
    u64 code, addr, rc = 0;
    struct sthyi_sctns *sctns = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn handle_operexc(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_pv_spx(vcpu: *mut kvm_vcpu) -> c_int {
    static int handle_pv_spx(struct kvm_vcpu *vcpu)
    {
    let mut pref: u32 = *(u32 *)sida_addr(vcpu.arch.sie_block);
    kvm_s390_set_prefix(vcpu, pref);
    trace_kvm_s390_handle_prefix(vcpu, 1, pref);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn handle_pv_sclp(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_pv_uvc(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_pv_notification(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn should_handle_per_ifetch(vcpu: *const kvm_vcpu, rc: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn kvm_handle_sie_intercept(vcpu: *mut kvm_vcpu) -> c_int {
