...
//! Source: arch/s390/hypfs/inode.c
#![no_std]
...
pub const HYPFS_MAGIC: c_uint = 0x687970	/* ASCII 'hyp' */;

    static struct dentry *hypfs_create_update_file(struct dentry *dir);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hypfs_sb_info {
    pub /: *mut *mut kuid_t uid; / uid used for files and dirs,
    pub /: *mut *mut kgid_t gid; / gid used for files and dirs,
    pub /: *mut *mut *mut dentry update_file; / file to trigger update,
    pub /: *mut *mut time64_t last_update; / last update, CLOCK_MONOTONIC time,
    pub /: *mut *mut mutex lock; / lock to protect update process,
}
...
#[no_mangle]
unsafe extern "C" fn hypfs_update_update(sb: *mut super_block) {
...
#[no_mangle]
unsafe extern "C" fn hypfs_add_dentry(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn hypfs_delete_tree() {
...
#[no_mangle]
unsafe extern "C" fn hypfs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn hypfs_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hypfs_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    static ssize_t hypfs_read_iter(struct kiocb *iocb, struct iov_iter *to)
    {
    struct file *file = iocb.ki_filp;
    char *data = file.private_data;
    let mut available: usize = strlen(data);
...
#[no_mangle]
unsafe extern "C" fn hypfs_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hypfs_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hypfs_parse_param(fc: *mut fs_context, param: *mut fs_parameter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hypfs_show_options(s: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hypfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hypfs_get_tree(fc: *mut fs_context) -> c_int {
    static int hypfs_get_tree(struct fs_context *fc)
    {
    return get_tree_single(fc, hypfs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn hypfs_free_fc(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn hypfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hypfs_kill_super(sb: *mut super_block) {
    ...
    {
    struct dentry *dentry;
    dentry = hypfs_create_file(parent, name, core::ptr::null_mut(), S_IFDIR | DIR_MODE);
    if (IS_ERR(dentry))
    return dentry;
    ...
    {
    struct dentry *dentry;
    dentry = hypfs_create_file(dir, "update", core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn hypfs_create_u64(dir: *mut dentry, name: *const c_char, value: __u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hypfs_create_str(dir: *mut dentry, name: *const c_char, string: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __hypfs_fs_init() -> int __init {
