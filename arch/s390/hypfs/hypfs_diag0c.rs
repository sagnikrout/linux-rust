...
//! Source: arch/s390/hypfs/hypfs_diag0c.c
#![no_std]
...
pub const DBFS_D0C_HDR_VERSION: c_int = 0;
//
// Get hypfs_diag0c_entry from CPU vector and store diag0c data
//
#[no_mangle]
unsafe extern "C" fn diag0c_fn(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn dbfs_diag0c_free(data: *const c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn dbfs_diag0c_create(data: *mut c_void, data_free_ptr: *mut c_void, size: *mut usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hypfs_diag0c_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn hypfs_diag0c_exit() {
