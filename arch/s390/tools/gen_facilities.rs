...
//! Source: arch/s390/tools/gen_facilities.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn print_facility_list(def: *mut facility_def) {
...
#[no_mangle]
unsafe extern "C" fn print_facility_lists() {
