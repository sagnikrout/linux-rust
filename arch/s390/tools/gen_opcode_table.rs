...
//! Source: arch/s390/tools/gen_opcode_table.c
#![no_std]
...
pub const STRING_SIZE_MAX: c_int = 20;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct insn_type {
    pub byte: c_uchar,
    pub mask: c_uchar,
...
#[derive(Copy, Clone)]
pub struct insn {
    pub type: *mut insn_type,
    pub opcode: [c_char; STRING_SIZE_MAX],
    pub name: [c_char; STRING_SIZE_MAX],
    pub upper: [c_char; STRING_SIZE_MAX],
    pub format: [c_char; STRING_SIZE_MAX],
    pub name_len: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct insn_group {
    pub type: *mut insn_type,
    pub offset: c_int,
    pub count: c_int,
    pub opcode: [c_char; 2],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gen_opcode {
    pub insn: *mut insn,
    pub nr: c_int,
    pub group: *mut insn_group,
    pub nr_groups: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn read_instructions(desc: *mut gen_opcode) {
...
#[no_mangle]
unsafe extern "C" fn cmpformat(a: *const c_void, b: *const c_void) -> c_int {
    static int cmpformat(const void *a, const void *b)
    {
    return strcmp(((struct insn *)a).format, ((struct insn *)b).format);
    }
#[no_mangle]
unsafe extern "C" fn print_formats(desc: *mut gen_opcode) {
...
#[no_mangle]
unsafe extern "C" fn cmp_long_insn(a: *const c_void, b: *const c_void) -> c_int {
    static int cmp_long_insn(const void *a, const void *b)
    {
    return strcmp(((struct insn *)a).name, ((struct insn *)b).name);
    }
#[no_mangle]
unsafe extern "C" fn print_insn_name(name: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn print_long_insn(desc: *mut gen_opcode) {
...
#[no_mangle]
unsafe extern "C" fn print_opcode(insn: *mut insn, nr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn add_to_group(desc: *mut gen_opcode, insn: *mut insn, offset: c_int) {
    static void add_to_group(struct gen_opcode *desc, struct insn *insn, int offset)
    {
    struct insn_group *group;
    group = desc.group ? &desc.group[desc.nr_groups - 1] : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cmpopcode(a: *const c_void, b: *const c_void) -> c_int {
    static int cmpopcode(const void *a, const void *b)
    {
    return strcmp(((struct insn *)a).opcode, ((struct insn *)b).opcode);
    }
#[no_mangle]
unsafe extern "C" fn print_opcode_table(desc: *mut gen_opcode) {
...
#[no_mangle]
unsafe extern "C" fn print_opcode_table_offsets(desc: *mut gen_opcode) {
