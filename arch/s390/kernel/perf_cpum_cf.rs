...
//! Source: arch/s390/kernel/perf_cpum_cf.c
#![no_std]
...
pub const PERF_CPUM_CF_MAX_CTR: c_uint = 0xffffUL  /* Max ctr for ECCTR */;
pub const PERF_EVENT_CPUM_CF_DIAG: c_uint = 0xBC000UL /* Event: Counter sets */;
    enum cpumf_ctr_set {
...
pub const CPUMF_LCCTL_ENABLE_SHIFT: c_int = 16;
pub const CPUMF_LCCTL_ACTCTL_SHIFT: c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn ctr_set_enable(state: *mut u64, ctrsets: u64) {
    static inline void ctr_set_enable(u64 *state, u64 ctrsets)
    {
// state |= ctrsets << CPUMF_LCCTL_ENABLE_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn ctr_set_disable(state: *mut u64, ctrsets: u64) {
    static inline void ctr_set_disable(u64 *state, u64 ctrsets)
    {
// state &= ~(ctrsets << CPUMF_LCCTL_ENABLE_SHIFT);
    }
#[no_mangle]
pub unsafe extern "C" fn ctr_set_start(state: *mut u64, ctrsets: u64) {
    static inline void ctr_set_start(u64 *state, u64 ctrsets)
    {
// state |= ctrsets << CPUMF_LCCTL_ACTCTL_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn ctr_set_stop(state: *mut u64, ctrsets: u64) {
    static inline void ctr_set_stop(u64 *state, u64 ctrsets)
    {
// state &= ~(ctrsets << CPUMF_LCCTL_ACTCTL_SHIFT);
    }
#[no_mangle]
pub unsafe extern "C" fn ctr_stcctm(set: enum cpumf_ctr_set, range: u64, dest: *mut u64) -> c_int {
...
pub struct cpu_cf_events {
    ...
    pub ctr_set: [core::sync::atomic::AtomicI32; CPUMF_CTR_SET_MAX],
    pub /: *mut *mut u64 state; / For perf_event_open SVC,
    pub /: *mut *mut u64 dev_state; / For /dev/hwctr,
    pub flags: c_uint,
    pub /: *mut *mut size_t used; / Bytes used in data,
    pub /: *mut *mut size_t usedss; / Bytes used in start/stop,
    pub /: *mut *mut unsigned char start[PAGE_SIZE]; / Counter set at event add,
    pub /: *mut *mut unsigned char stop[PAGE_SIZE]; / Counter set at event delete,
    pub /: *mut *mut unsigned char data[PAGE_SIZE]; / Counter set at /dev/hwctr,
    pub /: *mut *mut unsigned int sets; / # Counter set saved in memory,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpu_cf_ptr {
    pub cpucf: *mut cpu_cf_events,
}
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_reset_cpu(flags: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_free_root(num: c_uint) {
    static void cpum_cf_free_root(unsigned int num)
    {
    struct cpu_cf_ptr __percpu *p = cpu_cf_root.cfptr;
    if (!refcount_sub_and_test(num, &cpu_cf_root.refcnt))
    return;
    cpu_cf_root.cfptr = core::ptr::null_mut();
    free_percpu(p);
    irq_subclass_unregister(IRQ_SUBCLASS_MEASUREMENT_ALERT);
    on_each_cpu(cpum_cf_reset_cpu, core::ptr::null_mut(), 1);
...
//
#[no_mangle]
unsafe extern "C" fn cpum_cf_alloc_root(num: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpum_cf_free_cpu(cpu: c_int, num: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn cpum_cf_alloc_cpu(cpu: c_int, num: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpum_cf_alloc_cpuslocked(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_alloc(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_free_cpuslocked(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_free(cpu: c_int) {
...
pub const CF_DIAG_CTRSET_DEF: c_uint = 0xfeef	/* Counter set header mark */;
// interval in seconds
...
pub struct cf_ctrset_entry {
    ...
    pub /: *mut *mut unsigned int set:16; / 16-31 Counter set identifier,
    pub /: *mut *mut unsigned int ctr:16; / 32-47 Number of stored counters,
    pub /: *mut *mut unsigned int res1:16; / 48-63 Reserved,
}
...
// 0 - 7
    union {
    struct {
    pub /: *mut *mut unsigned int clock_base:1; / TOD clock base set,
    pub /: *mut *mut unsigned int speed:1; / CPU speed set,
// Measurement alerts
...
#[no_mangle]
unsafe extern "C" fn cfdiag_trailer(te: *mut cf_trailer_entry) {
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_make_setsize(ctrset: enum cpumf_ctr_set) {
    static void cpum_cf_make_setsize(enum cpumf_ctr_set ctrset)
    {
    let mut ctrset_size: usize = 0;
    switch (ctrset) {
    case CPUMF_CTR_SET_BASIC:
    ...
    ctrset_size = 6;
#[no_mangle]
pub unsafe extern "C" fn if(3: cpumf_ctr_info.cfvn >=) -> else {
    ...
    ctrset_size = 16;
#[no_mangle]
pub unsafe extern "C" fn if(6: cpumf_ctr_info.csvn >=) -> else {
    ...
    ctrset_size = 32;
#[no_mangle]
pub unsafe extern "C" fn if(2: cpumf_ctr_info.csvn ==) -> else {
    else if (cpumf_ctr_info.csvn == 2)
    ctrset_size = 48;
#[no_mangle]
pub unsafe extern "C" fn if(5: cpumf_ctr_info.csvn >= 3 && cpumf_ctr_info.csvn <=) -> else {
    else if (cpumf_ctr_info.csvn >= 3 && cpumf_ctr_info.csvn <= 5)
    ctrset_size = 128;
#[no_mangle]
pub unsafe extern "C" fn if(8: cpumf_ctr_info.csvn >= 6 && cpumf_ctr_info.csvn <=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn cpum_cf_read_setsize(ctrset: enum cpumf_ctr_set) -> usize {
...
#[no_mangle]
unsafe extern "C" fn cfdiag_diffctrset(pstart: *mut u64, pstop: *mut u64, counters: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cfdiag_diffctr(cpuhw: *mut cpu_cf_events, auth: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_counter_set(event: u64) -> enum cpumf_ctr_set {
    static enum cpumf_ctr_set get_counter_set(u64 event)
    {
    let mut set: c_int = CPUMF_CTR_SET_MAX;
    if (event < 32)
    set = CPUMF_CTR_SET_BASIC;
#[no_mangle]
pub unsafe extern "C" fn if(64: event <) -> else {
    else if (event < 64)
    set = CPUMF_CTR_SET_USER;
#[no_mangle]
pub unsafe extern "C" fn if(128: event <) -> else {
    else if (event < 128)
    set = CPUMF_CTR_SET_CRYPTO;
#[no_mangle]
pub unsafe extern "C" fn if(288: event <) -> else {
    else if (event < 288)
    set = CPUMF_CTR_SET_EXT;
#[no_mangle]
pub unsafe extern "C" fn if(496: event >= 448 && event <) -> else {
    else if (event >= 448 && event < 496)
    set = CPUMF_CTR_SET_MT_DIAG;
    return set;
    }
#[no_mangle]
unsafe extern "C" fn validate_ctr_version(config: u64, set: enum cpumf_ctr_set) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_enable(pmu: *mut pmu) {
...
//
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_disable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn is_userspace_event(ev: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __hw_perf_event_init(event: *mut perf_event, type: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_event_type(event: *mut perf_event) -> c_int {
    static int cpumf_pmu_event_type(struct perf_event *event)
    {
    let mut ev: u64 = event.attr.config;
...
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_event_init(event: *mut perf_event) -> c_int {
    static int cpumf_pmu_event_init(struct perf_event *event)
    {
    let mut type: c_uint = event.attr.type;
...
#[no_mangle]
pub unsafe extern "C" fn if(type: event->pmu->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn hw_perf_event_reset(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hw_perf_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_read(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_del(event: *mut perf_event, flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cpum_cf_prepare_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_dead_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_online_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpum_cf_offline_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stccm_avail() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpumf_pmu_init() -> int __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfset_call_on_cpu_parm {
    pub /: *mut *mut unsigned int sets; / Counter set bit mask,
    pub /: *mut *mut atomic_t cpus_ack; / # CPUs successfully executed func,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfset_request {
    pub /: *mut *mut unsigned long ctrset; / Bit mask of counter set to read,
    pub /: *mut *mut cpumask_t mask; / CPU mask to read from,
    pub /: *mut *mut list_head node; / Chain to cfset_session.head,
}

#[no_mangle]
unsafe extern "C" fn cfset_session_init() {
...
//
#[no_mangle]
unsafe extern "C" fn cfset_session_del(p: *mut cfset_request) {
...
//
#[no_mangle]
unsafe extern "C" fn cfset_session_add(p: *mut cfset_request) {
...
#[no_mangle]
unsafe extern "C" fn cfset_ioctl_off(parm: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cfset_ioctl_on(parm: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cfset_release_cpu(p: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn cfset_all_stop(req: *mut cfset_request) {
...
//
#[no_mangle]
unsafe extern "C" fn cfset_release(inode: *mut inode, file: *mut file) -> c_int {
...
// Open followed by close/exit has no private_data
    ...
    on_each_cpu(cfset_release_cpu, core::ptr::null_mut(), 1);
...
//
#[no_mangle]
unsafe extern "C" fn cfset_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfset_all_start(req: *mut cfset_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cfset_needspace(sets: c_uint) -> usize {
...
#[no_mangle]
unsafe extern "C" fn cfset_all_copy(arg: c_ulong, mask: *mut cpumask_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfset_cpu_read(parm: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cfset_all_read(arg: c_ulong, req: *mut cfset_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfset_ioctl_read(arg: c_ulong, req: *mut cfset_request) -> c_long {
    static long cfset_ioctl_read(unsigned long arg, struct cfset_request *req)
    {
    let mut ret: c_int = -ENODATA;
    if (req && req.ctrset)
    ret = cfset_all_read(arg, req);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn cfset_ioctl_stop(file: *mut file) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn cfset_ioctl_start(arg: c_ulong, file: *mut file) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn cfset_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn cfset_online_cpu(cpu: c_uint) -> c_int {
    static int cfset_online_cpu(unsigned int cpu)
    {
    struct cfset_call_on_cpu_parm p;
...
//
#[no_mangle]
unsafe extern "C" fn cfset_offline_cpu(cpu: c_uint) -> c_int {
    static int cfset_offline_cpu(unsigned int cpu)
    {
    struct cfset_call_on_cpu_parm p;
    struct cfset_request *rp;
...
#[no_mangle]
unsafe extern "C" fn cfdiag_read(event: *mut perf_event) {
    static void cfdiag_read(struct perf_event *event)
    {
    }
#[no_mangle]
unsafe extern "C" fn get_authctrsets() -> c_int {
    static int get_authctrsets(void)
    {
    let mut auth: c_ulong = 0;
...
//
#[no_mangle]
unsafe extern "C" fn cfdiag_event_init2(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfdiag_event_init(event: *mut perf_event) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cfdiag_maxsize(info: *mut cpumf_ctr_info) -> usize {
    static size_t cfdiag_maxsize(struct cpumf_ctr_info *info)
    {
    let mut max_size: usize = sizeof(struct cf_trailer_entry);
    enum cpumf_ctr_set i;
    for (i = CPUMF_CTR_SET_BASIC; i < CPUMF_CTR_SET_MAX; ++i) {
    let mut size: usize = cpum_cf_read_setsize(i);
    if (size)
...
#[no_mangle]
unsafe extern "C" fn cfdiag_get_cpu_speed() {
...
#[no_mangle]
unsafe extern "C" fn cfset_init() -> c_int {
    static int cfset_init(void)
    {
    size_t need;
    int rc;
