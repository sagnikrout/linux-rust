...
//
    ...
    let mut __initdata: static unsigned int smp_max_threads = -1U;
    cpumask_t cpu_setup_mask;
#[no_mangle]
unsafe extern "C" fn early_smt(s: *mut c_char) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn __pcpu_sigp_relax(addr: u16, order: u8, parm: c_ulong) -> c_int {
    static inline int __pcpu_sigp_relax(u16 addr, u8 order, unsigned long parm)
    {
    int cc;
    while (1) {
    cc = __pcpu_sigp(addr, order, parm, core::ptr::null_mut());
    if (cc != SIGP_CC_BUSY)
    return cc;
    cpu_relax();
    }
...
#[no_mangle]
unsafe extern "C" fn pcpu_sigp_retry(pcpu: *mut pcpu, order: u8, parm: u32) -> c_int {
    static int pcpu_sigp_retry(struct pcpu *pcpu, u8 order, u32 parm)
    {
    int cc, retry;
    for (retry = 0; ; retry++) {
    cc = __pcpu_sigp(pcpu.address, order, parm, core::ptr::null_mut());
    if (cc != SIGP_CC_BUSY)
    break;
    if (retry >= 3)
    udelay(10);
...
#[no_mangle]
pub unsafe extern "C" fn pcpu_stopped(pcpu: *mut pcpu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcpu_running(pcpu: *mut pcpu) -> c_int {
    static inline int pcpu_running(struct pcpu *pcpu)
    {
    if (__pcpu_sigp(pcpu.address, SIGP_SENSE_RUNNING,
    0, core::ptr::null_mut()) != SIGP_CC_STATUS_STORED)
    return 1;
...
#[no_mangle]
unsafe extern "C" fn pcpu_ec_call(pcpu: *mut pcpu, ec_bit: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcpu_alloc_lowcore(pcpu: *mut pcpu, cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcpu_free_lowcore(pcpu: *mut pcpu, cpu: c_int) {
    ...
    lowcore_ptr[cpu] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pcpu_prepare_secondary(pcpu: *mut pcpu, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcpu_attach_task(cpu: c_int, tsk: *mut task_struct) {
...
#[no_mangle]
unsafe extern "C" fn pcpu_start_fn(cpu: c_int, ): *mut *mut void (func)(void, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn __pcpu_delegate(func: *mut pcpu_delegate_fn, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn pcpu_set_smt(mtid: c_uint) -> c_int {
    static int pcpu_set_smt(unsigned int mtid)
    {
    int cc;
    if (smp_cpu_mtid == mtid)
    return 0;
    cc = __pcpu_sigp(0, SIGP_SET_MULTI_THREADING, mtid, core::ptr::null_mut());
    if (cc == 0) {
    smp_cpu_mtid = mtid;
    smp_cpu_mt_shift = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn smp_call_ipl_cpu(): *mut *mut void (func)(void, data: *mut c_void) -> void __noreturn {
...
#[no_mangle]
pub unsafe extern "C" fn smp_find_processor_id(address: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn schedule_mcck_handler() {
    void schedule_mcck_handler(void)
    {
    pcpu_ec_call(this_cpu_ptr(&pcpu_devices), ec_mcck_pending);
    }
#[no_mangle]
pub unsafe extern "C" fn arch_vcpu_is_preempted(cpu: c_int) -> bool notrace {
...
#[no_mangle]
pub unsafe extern "C" fn smp_yield_cpu(cpu: c_int) -> void notrace {
...
//
#[no_mangle]
pub unsafe extern "C" fn smp_emergency_stop() -> void notrace {
    void notrace smp_emergency_stop(void)
    {
    let mut lock: static arch_spinlock_t = __ARCH_SPIN_LOCK_UNLOCKED;
    ...
    0, core::ptr::null_mut()) == SIGP_CC_BUSY &&
...
//
#[no_mangle]
unsafe extern "C" fn smp_handle_ext_call() {
...
#[no_mangle]
pub unsafe extern "C" fn smp_store_status(cpu: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dump_available() -> bool {
    static bool dump_available(void)
    {
    return oldmem_data.start || is_ipl_type_dump();
    }
#[no_mangle]
pub unsafe extern "C" fn smp_save_dump_ipl_cpu() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn smp_save_dump_secondary_cpus() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn smp_cpu_set_polarization(cpu: c_int, val: c_int) {
    void smp_cpu_set_polarization(int cpu, int val)
    {
    per_cpu(pcpu_devices, cpu).polarization = val;
    }
#[no_mangle]
pub unsafe extern "C" fn smp_cpu_get_polarization(cpu: c_int) -> c_int {
    int smp_cpu_get_polarization(int cpu)
    {
    return per_cpu(pcpu_devices, cpu).polarization;
    }
#[no_mangle]
pub unsafe extern "C" fn smp_set_core_capacity(cpu: c_int, val: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn smp_cpu_get_cpu_address(cpu: c_int) -> c_int {
    int smp_cpu_get_cpu_address(int cpu)
    {
    return per_cpu(pcpu_devices, cpu).address;
    }
#[no_mangle]
unsafe extern "C" fn smp_get_core_info(info: *mut sclp_core_info, early: c_int) -> void __ref {
...
#[no_mangle]
unsafe extern "C" fn __smp_rescan_cpus(info: *mut sclp_core_info, early: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smp_detect_cpus() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn smp_start_secondary(cpuvoid: *mut c_void) {
...
//
    ...
    pcpu_start_fn(cpu, smp_start_secondary, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn _setup_possible_cpus(s: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn smp_fill_possible_mask() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn setup_profiling_timer(multiplier: c_uint) -> c_int {
...
// disallow configuration changes of online cpus
    ...
    static DEVICE_ATTR(address, 0444, show_cpu_address, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn smp_rescan_cpus(early: bool) -> int __ref {
...
#[no_mangle]
unsafe extern "C" fn s390_smp_init() -> int __init {
