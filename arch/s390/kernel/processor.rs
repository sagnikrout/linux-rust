...
//! Source: arch/s390/kernel/processor.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cpu_detect_mhz_feature() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn update_cpu_mhz(arg: *mut c_void) {
...
pub unsafe extern "C" fn s390_update_cpu_mhz() {
    ...
    on_each_cpu(update_cpu_mhz, core::ptr::null_mut(), 0);
    }
#[no_mangle]
pub unsafe extern "C" fn stop_machine_yield(cpumask: *const cpumask) -> void notrace {
...
pub unsafe extern "C" fn cpu_init() {
    ...
    get_cpu_id(id);
    if (machine_has_cpu_mhz)
    update_cpu_mhz(core::ptr::null_mut());
    mmgrab(&init_mm);
...
#[no_mangle]
unsafe extern "C" fn show_facilities(m: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn show_cpu_summary(m: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn setup_hwcaps() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn setup_elf_platform() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn show_cpu_topology(m: *mut seq_file, n: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn show_cpu_ids(m: *mut seq_file, n: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn show_cpu_mhz(m: *mut seq_file, n: c_ulong) {
...
unsafe extern "C" fn show_cpuinfo(m: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    let mut first: c_ulong = cpumask_first(cpu_online_mask);
    if (n == first)
...
// pos = cpumask_first(cpu_online_mask);
    return *pos < nr_cpu_ids ? (void *)*pos + 1 : core::ptr::null_mut();
    }
