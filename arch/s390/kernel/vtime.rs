...
//! Source: arch/s390/kernel/vtime.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn set_vtimer(expires: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn virt_timer_forward(elapsed: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_mt_scaling() {
...
#[no_mangle]
pub unsafe extern "C" fn update_tsk_timer(tsk_vtime: *mut c_ulong, new: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn scale_vtime(vtime: u64) -> u64 {
    static inline u64 scale_vtime(u64 vtime)
    {
    let mut mult: u64 = __this_cpu_read(mt_scaling_mult);
    let mut div: u64 = __this_cpu_read(mt_scaling_div);
    if (smp_cpu_mtid)
...
#[no_mangle]
pub unsafe extern "C" fn vtime_reset_last_update(lc: *mut lowcore) {
...
//
#[no_mangle]
unsafe extern "C" fn do_account_vtime(tsk: *mut task_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vtime_delta() -> u64 {
    static u64 vtime_delta(void)
    {
    struct lowcore *lc = get_lowcore();
    let mut timer: u64 = lc.last_update_timer;
...
//
#[no_mangle]
unsafe extern "C" fn list_add_sorted(timer: *mut vtimer_list, head: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn virt_timer_expire() {
    static void virt_timer_expire(void)
    {
...
#[no_mangle]
pub unsafe extern "C" fn init_virt_timer(timer: *mut vtimer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn vtimer_pending(timer: *mut vtimer_list) -> c_int {
    static inline int vtimer_pending(struct vtimer_list *timer)
    {
    return !list_empty(&timer.entry);
    }
#[no_mangle]
unsafe extern "C" fn internal_add_vtimer(timer: *mut vtimer_list) {
...
#[no_mangle]
unsafe extern "C" fn __add_vtimer(timer: *mut vtimer_list, periodic: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn add_virt_timer(timer: *mut vtimer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn add_virt_timer_periodic(timer: *mut vtimer_list) {
...
#[no_mangle]
unsafe extern "C" fn __mod_vtimer(timer: *mut vtimer_list, expires: u64, periodic: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mod_virt_timer(timer: *mut vtimer_list, expires: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mod_virt_timer_periodic(timer: *mut vtimer_list, expires: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn del_virt_timer(timer: *mut vtimer_list) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vtime_init() {
