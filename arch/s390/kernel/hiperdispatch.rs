...
//! Source: arch/s390/kernel/hiperdispatch.c
#![no_std]
...
pub const HD_STEAL_THRESHOLD: c_int = 10;
pub const HD_STEAL_AVG_WEIGHT: c_int = 16;
    ...
    let mut hd_steal_threshold: static unsigned int = HD_STEAL_THRESHOLD;
    let mut hd_delay_factor: static unsigned int = HD_DELAY_FACTOR;
...
#[no_mangle]
unsafe extern "C" fn hd_set_hiperdispatch_mode(enable: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hd_reset_state() {
...
#[no_mangle]
pub unsafe extern "C" fn hd_add_core(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hd_update_times() {
...
#[no_mangle]
unsafe extern "C" fn hd_update_capacities() {
...
#[no_mangle]
pub unsafe extern "C" fn hd_disable_hiperdispatch() {
...
#[no_mangle]
pub unsafe extern "C" fn hd_enable_hiperdispatch() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hd_steal_avg(new: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn hd_calculate_steal_percentage() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn hd_capacity_work_fn(work: *mut work_struct) {
    static void hd_capacity_work_fn(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn hd_greedy_time_get(unused: *mut c_void, val: *mut u64) -> c_int {
...
// val = hd_high_time;
    ...
    DEFINE_SIMPLE_ATTRIBUTE(hd_greedy_time_fops, hd_greedy_time_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn hd_conservative_time_get(unused: *mut c_void, val: *mut u64) -> c_int {
...
// val = hd_low_time;
    ...
    DEFINE_SIMPLE_ATTRIBUTE(hd_conservative_time_fops, hd_conservative_time_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn hd_adjustment_count_get(unused: *mut c_void, val: *mut u64) -> c_int {
    static int hd_adjustment_count_get(void *unused, u64 *val)
    {
// val = atomic64_read(&hd_adjustments);
    return 0;
    }
    DEFINE_SIMPLE_ATTRIBUTE(hd_adjustments_fops, hd_adjustment_count_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn hd_create_debugfs_counters() -> void __init {
    static void __init hd_create_debugfs_counters(void)
    {
    struct dentry *dir;
    dir = debugfs_create_dir("hiperdispatch", arch_debugfs_dir);
    debugfs_create_file("conservative_time_ms", 0400, dir, core::ptr::null_mut(), &hd_conservative_time_fops);
    debugfs_create_file("greedy_time_ms", 0400, dir, core::ptr::null_mut(), &hd_greedy_time_fops);
    debugfs_create_file("adjustment_count", 0400, dir, core::ptr::null_mut(), &hd_adjustments_fops);
    }
#[no_mangle]
unsafe extern "C" fn hd_create_attributes() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hd_init() -> int __init {
