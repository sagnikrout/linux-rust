...
//! Source: arch/s390/kernel/signal.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn store_sigregs() {
...
#[no_mangle]
unsafe extern "C" fn load_sigregs() {
...
#[no_mangle]
unsafe extern "C" fn save_sigregs(regs: *mut pt_regs, sregs: *mut _sigregs __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restore_sigregs(regs: *mut pt_regs, sregs: *mut _sigregs __user) -> c_int {
...
// Create struct sigcontext on the signal stack
    ...
    sc.sregs = (_sigregs __user  *) &frame.sregs;
...
// Create ucontext on the signal stack.
    ...
    __put_user(core::ptr::null_mut(), &frame.uc.uc_link) ||
