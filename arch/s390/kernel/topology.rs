...
//! Source: arch/s390/kernel/topology.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mask_info {
    pub next: *mut mask_info,
    pub id: c_uchar,
    pub mask: cpumask_t,
}

    let mut topology_mode: static int = TOPOLOGY_MODE_UNINITIALIZED;
...
#[no_mangle]
unsafe extern "C" fn cpu_group_map(dst: *mut cpumask_t, info: *mut mask_info, cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn cpu_thread_map(dst: *mut cpumask_t, cpu: c_uint) {
...
pub const TOPOLOGY_CORE_BITS: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn clear_masks() {
...
#[no_mangle]
unsafe extern "C" fn tl_to_masks(info: *mut sysinfo_15_1_x) {
...
#[no_mangle]
unsafe extern "C" fn topology_update_polarization_simple() {
...
#[no_mangle]
unsafe extern "C" fn ptf(fc: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn topology_set_cpu_management(fc: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn update_cpu_masks() {
...
#[no_mangle]
pub unsafe extern "C" fn store_topology(info: *mut sysinfo_15_1_x) {
    void store_topology(struct sysinfo_15_1_x *info)
    {
    stsi(info, 15, 1, topology_mnest_limit());
    }
#[no_mangle]
unsafe extern "C" fn __arch_update_dedicated_flag(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __arch_update_cpu_topology() -> c_int {
...
pub unsafe extern "C" fn arch_update_cpu_topology() -> c_int {
    ...
    on_each_cpu(__arch_update_dedicated_flag, core::ptr::null_mut(), 0);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn topology_work_fn(work: *mut work_struct) {
    static void topology_work_fn(struct work_struct *work)
    {
    rebuild_sched_domains();
    }
#[no_mangle]
pub unsafe extern "C" fn topology_schedule_update() {
    void topology_schedule_update(void)
    {
    schedule_work(&topology_work);
    }
#[no_mangle]
unsafe extern "C" fn topology_flush_work() {
    static void topology_flush_work(void)
    {
    flush_work(&topology_work);
    }
#[no_mangle]
unsafe extern "C" fn topology_timer_fn(unused: *mut timer_list) {
    ...
    let mut topology_poll: static atomic_t = ATOMIC_INIT(0);
#[no_mangle]
unsafe extern "C" fn set_topology_timer() {
    static void set_topology_timer(void)
    {
...
#[no_mangle]
pub unsafe extern "C" fn topology_expect_change() {
...
#[no_mangle]
unsafe extern "C" fn set_polarization(polarization: c_int) -> c_int {
    ...
    static DEVICE_ATTR(polarization, 0444, cpu_polarization_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(dedicated, 0444, cpu_dedicated_show, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn topology_cpu_init(cpu: *mut cpu) -> c_int {
    ...
    SDTL_INIT(tl_book_mask, core::ptr::null_mut(), BOOK),
    SDTL_INIT(tl_drawer_mask, core::ptr::null_mut(), DRAWER),
...
#[no_mangle]
unsafe extern "C" fn detect_polarization(tle: *mut union topology_entry) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn topology_init_early() -> void __init {
    ...
    __arch_update_dedicated_flag(core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn topology_get_mode(enabled: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn topology_is_enabled() -> c_int {
    static inline int topology_is_enabled(void)
    {
    return topology_mode != TOPOLOGY_MODE_SINGLE;
    }
#[no_mangle]
unsafe extern "C" fn topology_setup(str: *mut c_char) -> int __init {
    ...
    {
    let mut enabled: c_int = topology_is_enabled();
    int new_mode;
    int rc;
