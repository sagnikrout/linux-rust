...
//! Source: arch/s390/kernel/crash_dump.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn save_area_alloc(is_boot_cpu: bool) -> *mut save_area  __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn save_area_boot_cpu() -> *mut save_area  __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn save_area_add_regs(sa: *mut save_area, regs: *mut c_void) -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn save_area_add_vxrs(sa: *mut save_area, vxrs: *mut __vector128) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn copy_oldmem_iter(iter: *mut iov_iter, src: c_ulong, count: usize) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn copy_oldmem_kernel(dst: *mut c_void, src: c_ulong, count: usize) -> c_int {
...
//
    ...
    unsigned long size, pgprot_t prot)
    {
    let mut hsa_end: c_ulong = sclp.hsa_size;
...
//
#[no_mangle]
unsafe extern "C" fn nt_size_name(d_len: c_int, name: *const c_char) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn get_cpu_elf_notes_size() -> usize {
    static size_t get_cpu_elf_notes_size(void)
    {
    struct save_area *sa = core::ptr::null_mut();
    size_t size;
...
#[no_mangle]
unsafe extern "C" fn nt_vmcoreinfo_size() -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn get_cpu_cnt() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_mem_chunk_cnt() -> c_int {
    static int get_mem_chunk_cnt(void)
    {
    let mut cnt: c_int = 0;
    u64 idx;
    for_each_physmem_range(idx, &oldmem_type, core::ptr::null_mut(), core::ptr::null_mut())
    cnt++;
    return cnt;
    }
...
//
#[no_mangle]
unsafe extern "C" fn loads_init(phdr: *mut Elf64_Phdr, os_info_has_vm: bool) {
    static void loads_init(Elf64_Phdr *phdr, bool os_info_has_vm)
    {
    let mut old_identity_base: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn os_info_has_vm() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn text_init(phdr: *mut Elf64_Phdr) {
    static void text_init(Elf64_Phdr *phdr)
    {
    let mut start_phys: c_ulong = os_info_old_value(OS_INFO_IMAGE_PHYS);
    let mut start: c_ulong = os_info_old_value(OS_INFO_IMAGE_START);
    let mut end: c_ulong = os_info_old_value(OS_INFO_IMAGE_END);
    phdr.p_type = PT_LOAD;
    phdr.p_vaddr = start;
...
#[no_mangle]
unsafe extern "C" fn get_elfcorehdr_size(phdr_count: c_int) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn elfcorehdr_alloc(addr: *mut c_ulonglong, size: *mut c_ulonglong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn elfcorehdr_free(addr: c_ulonglong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn elfcorehdr_read_notes(buf: *mut c_char, count: usize, ppos: *mut u64) -> isize {
