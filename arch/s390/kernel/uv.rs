...
#[no_mangle]
unsafe extern "C" fn uv_init(stor_base: phys_addr_t, stor_len: c_ulong) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_uv() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_pin_shared(paddr: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uv_destroy(paddr: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_destroy_folio(folio: *mut folio) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_destroy_pte(pte: pte_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_convert_from_secure(paddr: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_convert_from_secure_folio(folio: *mut folio) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_convert_from_secure_pte(pte: pte_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uv_free_range_cb(ptep: *mut pte_t, addr: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uv_free_stor_var(stor_var: *mut c_void) {
    ...
    apply_to_existing_page_range(&init_mm, addr, size, uv_free_range_cb, core::ptr::null_mut());
    free_vm_area(area);
    }
    EXPORT_SYMBOL_FOR_MODULES(uv_free_stor_var, "kvm");
#[no_mangle]
unsafe extern "C" fn uv_alloc_range_cb(ptep: *mut pte_t, addr: c_ulong, data: *mut c_void) -> c_int {
    ...
    addr = (unsigned long)area.addr;
    if (apply_to_page_range(&init_mm, addr, size, uv_alloc_range_cb, core::ptr::null_mut()))
    goto out;
    return area.addr;
    out:
...
//
#[no_mangle]
unsafe extern "C" fn expected_folio_refs(folio: *mut folio) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __make_folio_secure(folio: *mut folio, uvcb: *mut uv_cb_header) -> c_int {
...
//
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(UVC_CC_PARTIAL: cc == UVC_CC_BUSY || cc ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn s390_wiggle_split_folio(mm: *mut mm_struct, folio: *mut folio) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn arch_make_folio_accessible(folio: *mut folio) -> c_int {
...
// Large folios cannot be secure.
    ...
    __ATTR(facilities, 0444, uv_query_facilities, core::ptr::null_mut());
    ...
    __ATTR(supp_se_hdr_ver, 0444, uv_query_supp_se_hdr_ver, core::ptr::null_mut());
    ...
    __ATTR(supp_se_hdr_pcf, 0444, uv_query_supp_se_hdr_pcf, core::ptr::null_mut());
    ...
    __ATTR(uv_query_dump_cpu_len, 0444, uv_query_dump_cpu_len, core::ptr::null_mut());
    ...
    __ATTR(dump_storage_state_len, 0444, uv_query_dump_storage_state_len, core::ptr::null_mut());
    ...
    __ATTR(dump_finalize_len, 0444, uv_query_dump_finalize_len, core::ptr::null_mut());
    ...
    __ATTR(feature_indications, 0444, uv_query_feature_indications, core::ptr::null_mut());
    ...
    __ATTR(max_cpus, 0444, uv_query_max_guest_cpus, core::ptr::null_mut());
    ...
    __ATTR(max_guests, 0444, uv_query_max_guest_vms, core::ptr::null_mut());
    ...
    __ATTR(max_address, 0444, uv_query_max_guest_addr, core::ptr::null_mut());
    ...
    __ATTR(supp_att_req_hdr_ver, 0444, uv_query_supp_att_req_hdr_ver, core::ptr::null_mut());
    ...
    __ATTR(supp_att_pflags, 0444, uv_query_supp_att_pflags, core::ptr::null_mut());
    ...
    __ATTR(supp_add_secret_req_ver, 0444, uv_query_supp_add_secret_req_ver, core::ptr::null_mut());
    ...
    __ATTR(supp_add_secret_pcf, 0444, uv_query_supp_add_secret_pcf, core::ptr::null_mut());
    ...
    __ATTR(supp_secret_types, 0444, uv_query_supp_secret_types, core::ptr::null_mut());
    ...
    __ATTR(max_secrets, 0444, uv_query_max_secrets, core::ptr::null_mut());
    ...
    __ATTR(max_retr_secrets, 0444, uv_query_max_retr_secrets, core::ptr::null_mut());
    ...
    __ATTR(max_assoc_secrets, 0444, uv_query_max_assoc_secrets, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn uv_query_keys() -> uv_cb_query_keys {
...
#[no_mangle]
pub unsafe extern "C" fn emit_hash(hash: *mut uv_key_hash, buf: *mut c_char, at: c_int) -> isize {
    ...
    __ATTR(backup_host_key, 0444, uv_keys_backup_host_key, core::ptr::null_mut());
    ...
    __ATTR(all, 0444, uv_keys_all, core::ptr::null_mut());
    ...
    __ATTR(prot_virt_guest, 0444, uv_is_prot_virt_guest, core::ptr::null_mut());
    static struct kobj_attribute uv_prot_virt_host =
    __ATTR(prot_virt_host, 0444, uv_is_prot_virt_host, core::ptr::null_mut());
    ...
    struct kset *kset;
    int rc;
    kset = kset_create_and_add(name, core::ptr::null_mut(), uv_kobj);
    if (!kset)
    return -ENOMEM;
// uv_dir_kset = kset;
...
//
    ...
    int ret;
    do {
    uv_list_secrets(list, start_idx, &list_rc, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn uv_retrieve_secret(secret_idx: u16, buf: *mut u8, buf_size: usize) -> c_int {
