...
//! Source: arch/s390/kernel/perf_cpum_sf.c
#![no_std]
...
pub const PERF_CPUM_SF_MAX_CTR: c_int = 2;
pub const PERF_EVENT_CPUM_SF: c_uint = 0xB0000UL /* Event: Basic-sampling */;
pub const PERF_EVENT_CPUM_SF_DIAG: c_uint = 0xBD000UL /* Event: Combined-sampling */;
pub const PERF_CPUM_SF_BASIC_MODE: c_uint = 0x0001	  /* Basic-sampling flag */;
pub const PERF_CPUM_SF_DIAG_MODE: c_uint = 0x0002	  /* Diagnostic-sampling flag */;
pub const PERF_CPUM_SF_FREQ_MODE: c_uint = 0x0008	  /* Sampling with frequency */;

// Minimum number of sample-data-block-tables:
// At least one table is required for the sampling buffer structure.
// A single table contains up to 511 pointers to sample-data-blocks.
//
pub const CPUM_SF_MIN_SDBT: c_int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn require_table_link(sdbt: *const c_void) -> c_int {
...
// 8176 pages for SDBs
//
    let mut CPUM_SF_MIN_SDB: static unsigned long __read_mostly = 15;
    let mut CPUM_SF_MAX_SDB: static unsigned long __read_mostly = 8176;
    let mut CPUM_SF_SDB_DIAG_FACTOR: static unsigned long __read_mostly = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sf_buffer {
    pub /: *mut *mut *mut unsigned long sdbt; / Sample-data-block-table origin,
// buffer characteristics (required for buffer increments)
    pub /: *mut *mut unsigned long num_sdb; / Number of sample-data-blocks,
    pub /: *mut *mut unsigned long num_sdbt; / Number of sample-data-block-tables,
    pub /: *mut *mut *mut unsigned long tail; / last sample-data-block-table,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aux_buffer {
    pub sfb: sf_buffer,
    pub /: *mut *mut unsigned long head; / index of SDB of buffer head,
    pub /: *mut *mut unsigned long alert_mark; / index of SDB of alert request position,
    pub /: *mut *mut unsigned long empty_mark; / mark of SDB not marked full,
    pub /: *mut *mut *mut unsigned long sdb_index; / SDB address for fast lookup,
    pub /: *mut *mut *mut unsigned long sdbt_index; / SDBT address for fast lookup,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpu_hw_sf {
// CPU-measurement sampling information block
    pub qsi: hws_qsi_info_block,
// CPU-measurement sampling control block
    pub lsctl: hws_lsctl_request_block,
    pub /: *mut *mut sf_buffer sfb; / Sampling buffer,
    pub /: *mut *mut unsigned int flags; / Status flags,
    pub /: *mut *mut *mut perf_event event; / Scheduled perf event,
    pub /: *mut *mut perf_output_handle handle; / AUX buffer output handle,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn is_link_entry(s: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sf_buffer_available(cpuhw: *mut cpu_hw_sf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn free_sampling_buffer(sfb: *mut sf_buffer) {
...
#[no_mangle]
unsafe extern "C" fn alloc_sample_data_block(sdbt: *mut c_ulong, gfp_flags: gfp_t) -> c_int {
...
//
    ...
    {
    int i, rc;
    unsigned long *new, *tail, *tail_prev = core::ptr::null_mut();
...
//
    ...
    sfb.num_sdb++;
    tail++;
    tail_prev = new = core::ptr::null_mut();	/* Allocated at least one SBD */
    }
...
//
#[no_mangle]
unsafe extern "C" fn alloc_sampling_buffer(sfb: *mut sf_buffer, num_sdb: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sfb_set_limits(min: c_ulong, max: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn sfb_max_limit(hwc: *mut hw_perf_event) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn sfb_account_allocs(num: c_ulong, hwc: *mut hw_perf_event) {
...
#[no_mangle]
unsafe extern "C" fn sfb_init_allocs(num: c_ulong, hwc: *mut hw_perf_event) {
...
#[no_mangle]
unsafe extern "C" fn deallocate_buffers(cpuhw: *mut cpu_hw_sf) {
...
#[no_mangle]
unsafe extern "C" fn allocate_buffers(cpuhw: *mut cpu_hw_sf, hwc: *mut hw_perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compute_sfb_extent(ratio: c_ulong, base: c_ulong) -> c_ulong {
...
pub const PMC_INIT: c_int = 0;
pub const PMC_RELEASE: c_int = 1;
#[no_mangle]
unsafe extern "C" fn setup_pmc_cpu(flags: *mut c_void) {
...
unsafe extern "C" fn release_pmc_hardware() {
    ...
    {
    let mut flags: c_int = PMC_RELEASE;
    irq_subclass_unregister(IRQ_SUBCLASS_MEASUREMENT_ALERT);
    on_each_cpu(setup_pmc_cpu, &flags, 1);
    }
#[no_mangle]
unsafe extern "C" fn reserve_pmc_hardware() {
    static void reserve_pmc_hardware(void)
    {
    let mut flags: c_int = PMC_INIT;
    on_each_cpu(setup_pmc_cpu, &flags, 1);
...
#[no_mangle]
unsafe extern "C" fn hw_init_period(hwc: *mut hw_perf_event, period: u64) {
...
#[no_mangle]
unsafe extern "C" fn is_callchain_event(event: *mut perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_enable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_disable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn perf_event_count_update(event: *mut perf_event, count: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_perf_event_update(event: *mut perf_event, flush_all: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn aux_sdb_num(start: c_ulong, end: c_ulong) -> c_ulong {
    static inline unsigned long aux_sdb_num(unsigned long start, unsigned long end)
    {
    return end >= start ? end - start + 1 : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn aux_sdb_num_alert(aux: *mut aux_buffer) -> c_ulong {
    static inline unsigned long aux_sdb_num_alert(struct aux_buffer *aux)
    {
    return aux_sdb_num(aux.head, aux.alert_mark);
    }
#[no_mangle]
pub unsafe extern "C" fn aux_sdb_num_empty(aux: *mut aux_buffer) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn aux_output_end(handle: *mut perf_output_handle) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_collect_aux(cpuhw: *mut cpu_hw_sf) {
    static void hw_collect_aux(struct cpu_hw_sf *cpuhw)
    {
    struct aux_buffer *aux;
    let mut done: c_int = 0;
    let mut range: c_ulong = 0, size;
    let mut overflow: c_ulonglong = 0;
...
//
#[no_mangle]
unsafe extern "C" fn aux_buffer_free(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn aux_sdb_init(sdb: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_read(event: *mut perf_event) {
...
//
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_check_period(event: *mut perf_event, value: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_start(event: *mut perf_event, flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpumsf_pmu_del(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cpusf_pmu_setup(cpu: c_uint, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s390_pmu_sf_online_cpu(cpu: c_uint) -> c_int {
    static int s390_pmu_sf_online_cpu(unsigned int cpu)
    {
    return cpusf_pmu_setup(cpu, PMC_INIT);
    }
#[no_mangle]
unsafe extern "C" fn s390_pmu_sf_offline_cpu(cpu: c_uint) -> c_int {
    static int s390_pmu_sf_offline_cpu(unsigned int cpu)
    {
    return cpusf_pmu_setup(cpu, PMC_RELEASE);
    }
#[no_mangle]
unsafe extern "C" fn param_get_sfb_size(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn param_set_sfb_size(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pr_cpumsf_err(reason: c_uint) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn init_cpum_sampling_pmu() -> int __init {
