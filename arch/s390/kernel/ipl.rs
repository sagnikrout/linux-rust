...
pub const IPL_PARM_BLOCK_VERSION: c_int = 0;
...
pub struct shutdown_action {
    pub name: *mut c_char,
    pub trigger): *mut *mut void (fn) (struct shutdown_trigger,
    ...
    let mut reipl_capabilities: static int = IPL_TYPE_UNKNOWN;
    let mut reipl_type: static enum ipl_type = IPL_TYPE_UNKNOWN;
    ...
    let mut dump_capabilities: static int = DUMP_TYPE_NONE;
    let mut dump_type: static enum dump_type = DUMP_TYPE_NONE;
...
#[no_mangle]
pub unsafe extern "C" fn __diag308(subcode: c_ulong, addr: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn diag308(subcode: c_ulong, addr: *mut c_void) -> c_int {
...
// SYSFS
    ...
    static struct kobj_attribute sys_##_prefix##_##_name##_attr =		\
    __ATTR(_name, 0444, sys_##_prefix##_##_name##_show, core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn get_ipl_type() -> __init enum ipl_type {
    ...
    let mut sys_ipl_type_attr: static struct kobj_attribute = __ATTR_RO(ipl_type);
    ...
    __ATTR(secure, 0444, ipl_secure_show, core::ptr::null_mut());
    ...
    __ATTR(has_secure, 0444, ipl_has_secure_show, core::ptr::null_mut());
    ...
    __ATTR(parm, 0444, ipl_vm_parm_show, core::ptr::null_mut());
    ...
    __ATTR(device, 0444, sys_ipl_device_show, core::ptr::null_mut());
    ...
    __BIN_ATTR(binary_parameter, 0444, sys_ipl_parameter_read, core::ptr::null_mut(),
    PAGE_SIZE);
...
// ECKD ipl device attributes
    ...
    char *p, *p1, *tmp = core::ptr::null_mut();					\
    int i, rc;							\
    \
    ...
    __ATTR(br_chr, 0644, eckd_ipl_br_chr_show, core::ptr::null_mut());
    ...
    __ATTR(loadparm, 0444, ipl_ccw_loadparm_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __ipl_run(unused: *mut c_void) {
    static void __ipl_run(void *unused)
    {
    diag308(DIAG308_LOAD_CLEAR, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ipl_run(trigger: *mut shutdown_trigger) {
    static void ipl_run(struct shutdown_trigger *trigger)
    {
    smp_call_ipl_cpu(__ipl_run, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ipl_init() -> int __init {
    static int __init ipl_init(void)
    {
    int rc;
    ipl_kset = kset_create_and_add("ipl", core::ptr::null_mut(), firmware_kobj);
    if (!ipl_kset) {
    rc = -ENOMEM;
    goto out;
    }
...
#[no_mangle]
pub unsafe extern "C" fn set_os_info_reipl_block() {
...
// reipl type
#[no_mangle]
unsafe extern "C" fn reipl_set_type(type: enum ipl_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: IPL_ECKD_STR, 0: strlen(IPL_ECKD_STR)) ==) -> else {
    else if (strncmp(buf, IPL_ECKD_STR, strlen(IPL_ECKD_STR)) == 0)
    rc = reipl_set_type(IPL_TYPE_ECKD);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: IPL_FCP_STR, 0: strlen(IPL_FCP_STR)) ==) -> else {
    else if (strncmp(buf, IPL_FCP_STR, strlen(IPL_FCP_STR)) == 0)
    rc = reipl_set_type(IPL_TYPE_FCP);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: IPL_NVME_STR, 0: strlen(IPL_NVME_STR)) ==) -> else {
    else if (strncmp(buf, IPL_NVME_STR, strlen(IPL_NVME_STR)) == 0)
    rc = reipl_set_type(IPL_TYPE_NVME);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: IPL_NSS_STR, 0: strlen(IPL_NSS_STR)) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn __reipl_run(unused: *mut c_void) {
    ...
    diag308(DIAG308_LOAD_NORMAL_DUMP, core::ptr::null_mut());
    break;
    case IPL_TYPE_ECKD:
    ...
    diag308(DIAG308_LOAD_NORMAL, core::ptr::null_mut());
    break;
    case IPL_TYPE_FCP:
...
#[no_mangle]
unsafe extern "C" fn reipl_run(trigger: *mut shutdown_trigger) {
    static void reipl_run(struct shutdown_trigger *trigger)
    {
    smp_call_ipl_cpu(__reipl_run, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn reipl_block_ccw_init(ipb: *mut ipl_parameter_block) {
...
#[no_mangle]
unsafe extern "C" fn reipl_block_ccw_fill_parms(ipb: *mut ipl_parameter_block) {
...
#[no_mangle]
unsafe extern "C" fn reipl_nss_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn reipl_ccw_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn reipl_fcp_init() -> int __init {
...
// sysfs: create fcp kset for mixing attr group and bin attrs
    reipl_fcp_kset = kset_create_and_add(IPL_FCP_STR, core::ptr::null_mut(),
    &reipl_kset.kobj);
    if (!reipl_fcp_kset) {
...
#[no_mangle]
unsafe extern "C" fn reipl_nvme_init() -> int __init {
...
// sysfs: create kset for mixing attr group and bin attrs
    reipl_nvme_kset = kset_create_and_add(IPL_NVME_STR, core::ptr::null_mut(),
    &reipl_kset.kobj);
    if (!reipl_nvme_kset) {
...
#[no_mangle]
unsafe extern "C" fn reipl_eckd_init() -> int __init {
    ...
    return -ENOMEM;
// sysfs: create kset for mixing attr group and bin attrs
    reipl_eckd_kset = kset_create_and_add(IPL_ECKD_STR, core::ptr::null_mut(),
    &reipl_kset.kobj);
    if (!reipl_eckd_kset) {
...
#[no_mangle]
unsafe extern "C" fn reipl_type_init() -> int __init {
    static int __init reipl_type_init(void)
    {
    let mut reipl_type: enum ipl_type = ipl_info.type;
...
#[no_mangle]
unsafe extern "C" fn reipl_init() -> int __init {
    static int __init reipl_init(void)
    {
    int rc;
    reipl_kset = kset_create_and_add("reipl", core::ptr::null_mut(), firmware_kobj);
    if (!reipl_kset)
    return -ENOMEM;
...
// dump type
#[no_mangle]
unsafe extern "C" fn dump_set_type(type: enum dump_type) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: DUMP_CCW_STR, 0: strlen(DUMP_CCW_STR)) ==) -> else {
    else if (strncmp(buf, DUMP_CCW_STR, strlen(DUMP_CCW_STR)) == 0)
    rc = dump_set_type(DUMP_TYPE_CCW);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: DUMP_ECKD_STR, 0: strlen(DUMP_ECKD_STR)) ==) -> else {
    else if (strncmp(buf, DUMP_ECKD_STR, strlen(DUMP_ECKD_STR)) == 0)
    rc = dump_set_type(DUMP_TYPE_ECKD);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: DUMP_FCP_STR, 0: strlen(DUMP_FCP_STR)) ==) -> else {
    else if (strncmp(buf, DUMP_FCP_STR, strlen(DUMP_FCP_STR)) == 0)
    rc = dump_set_type(DUMP_TYPE_FCP);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: DUMP_NVME_STR, 0: strlen(DUMP_NVME_STR)) ==) -> else {
    ...
    let mut dump_area_size_attr: static struct kobj_attribute = __ATTR_RO(dump_area_size);
...
#[no_mangle]
unsafe extern "C" fn diag308_dump(dump_block: *mut c_void) {
    static void diag308_dump(void *dump_block)
    {
    diag308(DIAG308_SET, dump_block);
    while (1) {
    if (diag308(DIAG308_LOAD_NORMAL_DUMP, core::ptr::null_mut()) != 0x302)
    break;
    udelay(USEC_PER_SEC);
    }
    }
#[no_mangle]
unsafe extern "C" fn __dump_run(unused: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dump_run(trigger: *mut shutdown_trigger) {
    static void dump_run(struct shutdown_trigger *trigger)
    {
    if (dump_type == DUMP_TYPE_NONE)
    return;
    smp_send_stop();
    smp_call_ipl_cpu(__dump_run, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn dump_ccw_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dump_fcp_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dump_nvme_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dump_eckd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dump_init() -> int __init {
    static int __init dump_init(void)
    {
    int rc;
    dump_kset = kset_create_and_add("dump", core::ptr::null_mut(), firmware_kobj);
    if (!dump_kset)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn dump_reipl_run(trigger: *mut shutdown_trigger) {
    static void dump_reipl_run(struct shutdown_trigger *trigger)
    {
    struct lowcore *abs_lc;
    let mut ipib: c_ulong = 0;
...
//
    ...
    csum = ( unsigned int)cksm(reipl_block_actual, reipl_block_actual.hdr.len, 0);
    }
...
//
pub const VMCMD_MAX_SIZE: c_int = 240;
...
#[no_mangle]
unsafe extern "C" fn vmcmd_run(trigger: *mut shutdown_trigger) {
    ...
    cmd = vmcmd_on_reboot;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(trigger->name, 0: ON_PANIC_STR) ==) -> else {
    else if (strcmp(trigger.name, ON_PANIC_STR) == 0)
    cmd = vmcmd_on_panic;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(trigger->name, 0: ON_HALT_STR) ==) -> else {
    else if (strcmp(trigger.name, ON_HALT_STR) == 0)
    cmd = vmcmd_on_halt;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(trigger->name, 0: ON_POFF_STR) ==) -> else {
    else if (strcmp(trigger.name, ON_POFF_STR) == 0)
    cmd = vmcmd_on_poff;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(trigger->name, 0: ON_RESTART_STR) ==) -> else {
    ...
    if (strlen(cmd) == 0)
    return;
    __cpcmd(cmd, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn vmcmd_init() -> c_int {
    static int vmcmd_init(void)
    {
    if (!machine_is_vm())
    return -EOPNOTSUPP;
    vmcmd_kset = kset_create_and_add("vmcmd", core::ptr::null_mut(), firmware_kobj);
    if (!vmcmd_kset)
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn stop_run(trigger: *mut shutdown_trigger) {
...
// on reipl
    ...
    let mut on_reboot_attr: static struct kobj_attribute = __ATTR_RW(on_reboot);
#[no_mangle]
unsafe extern "C" fn do_machine_restart(__unused: *mut c_char) {
    static void do_machine_restart(char *__unused)
    {
    smp_send_stop();
    on_reboot_trigger.action.fn(&on_reboot_trigger);
    reipl_run(core::ptr::null_mut());
    }
...
// on panic
    ...
    let mut on_panic_attr: static struct kobj_attribute = __ATTR_RW(on_panic);
#[no_mangle]
unsafe extern "C" fn do_panic() {
...
// on restart
    ...
    let mut on_restart_attr: static struct kobj_attribute = __ATTR_RW(on_restart);
#[no_mangle]
unsafe extern "C" fn __do_restart(ignore: *mut c_void) {
    static void __do_restart(void *ignore)
    {
    smp_send_stop();

    crash_kexec(core::ptr::null_mut());

    on_restart_trigger.action.fn(&on_restart_trigger);
    stop_run(&on_restart_trigger);
    }
#[no_mangle]
pub unsafe extern "C" fn do_restart(arg: *mut c_void) {
...
// on halt
    ...
    let mut on_halt_attr: static struct kobj_attribute = __ATTR_RW(on_halt);
#[no_mangle]
unsafe extern "C" fn do_machine_halt() {
...
// on power off
    ...
    let mut on_poff_attr: static struct kobj_attribute = __ATTR_RW(on_poff);
#[no_mangle]
unsafe extern "C" fn do_machine_power_off() {
...
#[no_mangle]
unsafe extern "C" fn shutdown_triggers_init() -> void __init {
    static void __init shutdown_triggers_init(void)
    {
    shutdown_actions_kset = kset_create_and_add("shutdown_actions", core::ptr::null_mut(),
    firmware_kobj);
...
#[no_mangle]
unsafe extern "C" fn shutdown_actions_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn s390_ipl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn strscpy_skip_quote(dst: *mut c_char, src: *mut c_char, n: c_int) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn vmcmd_on_reboot_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vmcmd_on_panic_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vmcmd_on_halt_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vmcmd_on_poff_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_ipl() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn s390_reset_system() -> void __no_stack_protector {
...
#[no_mangle]
pub unsafe extern "C" fn ipl_report_free(report: *mut ipl_report) -> c_int {
