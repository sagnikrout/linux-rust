...
//! Source: arch/s390/kernel/setup.c
#![no_std]
...
// Machine setup..
//
    let mut console_mode: c_uint = 0;
    EXPORT_SYMBOL(console_mode);
    let mut console_devno: c_uint = -1;
    EXPORT_SYMBOL(console_devno);
    let mut console_irq: c_uint = -1;
...
//
#[no_mangle]
unsafe extern "C" fn condev_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn set_preferred_console() -> void __init {
    static void __init set_preferred_console(void)
    {
    if (CONSOLE_IS_3215 || CONSOLE_IS_SCLP)
    add_preferred_console("ttyS", 0, core::ptr::null_mut());
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CONSOLE_IS_3270) -> else {
    else if (CONSOLE_IS_3270)
    add_preferred_console("tty3270", 0, core::ptr::null_mut());
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CONSOLE_IS_VT220) -> else {
    else if (CONSOLE_IS_VT220)
    add_preferred_console("ttysclp", 0, core::ptr::null_mut());
#[no_mangle]
pub unsafe extern "C" fn if(_arg: CONSOLE_IS_HVC) -> else {
    else if (CONSOLE_IS_HVC)
    add_preferred_console("hvc", 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn conmode_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn conmode_default() -> void __init {
    static void __init conmode_default(void)
    {
    char query_buffer[1024];
    char *ptr;
    if (machine_is_vm()) {
    cpcmd("QUERY CONSOLE", query_buffer, 1024, core::ptr::null_mut());
    console_devno = simple_strtoul(query_buffer + 5, core::ptr::null_mut(), 16);
    ptr = strstr(query_buffer, "SUBCHANNEL =");
    console_irq = simple_strtoul(ptr + 13, core::ptr::null_mut(), 16);
    cpcmd("QUERY TERM", query_buffer, 1024, core::ptr::null_mut());
...
//
    ...
    SET_CONSOLE_VT220;
#[no_mangle]
pub unsafe extern "C" fn if(IS_ENABLED(CONFIG_SCLP_CONSOLE): sclp.has_linemode &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn setup_zfcpdump() -> void __init {
...
//
    ...
    void *restart_stack;
#[no_mangle]
pub unsafe extern "C" fn stack_alloc() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn stack_free(stack: c_ulong) {
    void stack_free(unsigned long stack)
    {
    vfree((void *)stack);
    }
#[no_mangle]
unsafe extern "C" fn stack_alloc_early() -> unsigned long __init {
...
#[no_mangle]
unsafe extern "C" fn setup_lowcore() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_resources() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_memory_end() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn reserve_pgtables() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn reserve_crashkernel() -> void __init {
    ...
    &crash_size, &crash_base, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn reserve_certificate_list() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn reserve_physmem_info() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn free_physmem_info() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn memblock_add_physmem_info() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_high_memory() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn reserve_lowcore() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn reserve_kernel() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn setup_memory() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn relocate_amode31_section() -> void __init {
    static void __init relocate_amode31_section(void)
    {
    let mut amode31_size: c_ulong = __eamode31 - __samode31;
...
#[no_mangle]
unsafe extern "C" fn setup_cr() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn setup_randomness() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn setup_control_program_code() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn log_component_list() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn print_rb_entry(buf: *const c_char) -> void __init {
    static void __init print_rb_entry(const char *buf)
    {
    char fmt[] = KERN_SOH "0boot: %s";
    let mut level: c_int = printk_get_level(buf);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: machine_is_kvm()) -> else {
    else if (machine_is_kvm())
    pr_info("Linux is running under KVM in 64-bit mode\n");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: machine_is_lpar()) -> else {
