...
//! Source: arch/s390/kernel/diag/diag310.c
#![no_std]
...
pub const DIAG310_LEVELMIN: c_int = 1;
pub const DIAG310_LEVELMAX: c_int = 6;
    enum diag310_sc {
    DIAG310_SUBC_0 = 0,
    DIAG310_SUBC_1 = 1,
    DIAG310_SUBC_4 = 4,
...
#[no_mangle]
pub unsafe extern "C" fn diag310(subcode: c_ulong, size: c_ulong, addr: *mut c_void) -> c_ulong {
    static inline unsigned long diag310(unsigned long subcode, unsigned long size, void *addr)
    {
    let mut rp: union register_pair = { .even = (unsigned long)addr, .odd = size };
...
#[no_mangle]
unsafe extern "C" fn diag310_result_to_errno(result: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn diag310_get_subcode_mask(mask: *mut c_ulong) -> c_int {
    static int diag310_get_subcode_mask(unsigned long *mask)
    {
    union diag310_response res;
    res.response = diag310(DIAG310_SUBC_0, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn diag310_get_memtop_stride(stride: *mut c_ulong) -> c_int {
    static int diag310_get_memtop_stride(unsigned long *stride)
    {
    union diag310_response res;
    res.response = diag310(DIAG310_SUBC_1, 0, core::ptr::null_mut());
    if (res.rc != DIAG310_RET_SUCCESS)
    return diag310_result_to_errno(res.rc);
// stride = res.result;
    return 0;
...
#[no_mangle]
unsafe extern "C" fn diag310_get_memtop_size(pages: *mut c_ulong, level: c_ulong) -> c_int {
    static int diag310_get_memtop_size(unsigned long *pages, unsigned long level)
    {
    let mut req: union diag310_req_subcode = { .sc = DIAG310_SUBC_4, .st = level };
    union diag310_response res;
    res.response = diag310(req.subcode, 0, core::ptr::null_mut());
    switch (res.rc) {
...
#[no_mangle]
unsafe extern "C" fn diag310_store_topology_map(buf: *mut c_void, pages: c_ulong, level: c_ulong) -> c_int {
    static int diag310_store_topology_map(void *buf, unsigned long pages, unsigned long level)
    {
    let mut req_sc: union diag310_req_subcode = { .sc = DIAG310_SUBC_5, .st = level };
    let mut req_size: union diag310_req_size = { .page_count = pages };
    union diag310_response res;
...
#[no_mangle]
unsafe extern "C" fn diag310_check_features() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memtop_get_stride_len(res: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memtop_get_page_count(res: *mut c_ulong, level: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn diag310_memtop_stride(arg: c_ulong) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn diag310_memtop_len(arg: c_ulong) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn diag310_memtop_buf(arg: c_ulong) -> c_long {
