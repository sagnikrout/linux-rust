...
//! Source: arch/s390/kernel/debug.c
#![no_std]
...
// used by dump analysis tools to determine version of debug feature
    let mut debug_feature_version: static unsigned int __used = __DEBUG_FEATURE_VERSION;
// static globals
...
// functions
#[no_mangle]
unsafe extern "C" fn debug_get_param(name: *const c_char, level: *mut c_int, pages: *mut c_int) {
...
pub const LVL_LEN: c_int = 10;

#[no_mangle]
unsafe extern "C" fn s390dbf_parse_one(arg: *const c_char, param: *mut debug_param_t) -> bool __init {
    static bool __init s390dbf_parse_one(const char *arg, struct debug_param_t *param)
    {
    let mut p: debug_param_t = { { 0 }, PARAM_UNSET, PARAM_UNSET };
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: kstrtoint(level, _arg: 0, 0: &p.level) !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn s390dbf_parse(arg: *mut c_char) -> int __init {
...
//
    ...
    debug_get_param(id[i].name, &id[i].level, core::ptr::null_mut());
    return rc;
    }
...
//
#[no_mangle]
unsafe extern "C" fn debug_areas_free(db_info: *mut debug_info_t) {
    ...
    kfree(db_info.areas);
    db_info.areas = core::ptr::null_mut();
    }
//
// debug_info_free
...
//
#[no_mangle]
unsafe extern "C" fn debug_info_free(db_info: *mut debug_info_t) {
...
//
    ...
    int nr_areas, int buf_size, umode_t mode)
    {
    let mut level: c_int = DEBUG_DEFAULT_LEVEL;
    debug_info_t *rc;
...
//
#[no_mangle]
unsafe extern "C" fn debug_info_get(db_info: *mut debug_info_t) {
...
//
#[no_mangle]
unsafe extern "C" fn debug_info_put(db_info: *mut debug_info_t) {
...
//
#[no_mangle]
unsafe extern "C" fn debug_format_entry(p_info: *mut file_private_info_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_next_entry(p_info: *mut file_private_info_t) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn debug_to_act_entry(p_info: *mut file_private_info_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_prev_entry(p_info: *mut file_private_info_t) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn debug_move_entry(p_info: *mut file_private_info_t, reverse: bool) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn debug_open(inode: *mut inode, file: *mut file) -> c_int {
    static int debug_open(struct inode *inode, struct file *file)
    {
...
// find debug view
    ...
    continue;
#[no_mangle]
pub unsafe extern "C" fn if(file->f_path.dentry: debug_info->debugfs_entries[i] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn debug_file_private_free(p_info: *mut file_private_info_t) {
...
//
#[no_mangle]
unsafe extern "C" fn debug_close(inode: *mut inode, file: *mut file) -> c_int {
    static int debug_close(struct inode *inode, struct file *file)
    {
    file_private_info_t *p_info;
    p_info = (file_private_info_t *) file.private_data;
...
#[no_mangle]
unsafe extern "C" fn _debug_register(id: *mut debug_info_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_register_static(id: *mut debug_info_t, pages_per_area: c_int, nr_areas: c_int) {
...
// Clear pointers to prevent tracing into released initdata.
    ...
    id.areas = core::ptr::null_mut();
    id.active_pages = core::ptr::null_mut();
    id.active_entries = core::ptr::null_mut();
...
// Clear pointers to initdata and discard copy.
    copy.areas = core::ptr::null_mut();
    copy.active_pages = core::ptr::null_mut();
    copy.active_entries = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn _debug_unregister_debugfs(id: *mut debug_info_t) {
...
#[no_mangle]
unsafe extern "C" fn _debug_unregister(id: *mut debug_info_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_unregister(id: *mut debug_info_t) {
...
//
#[no_mangle]
unsafe extern "C" fn debug_set_size(id: *mut debug_info_t, nr_areas: c_int, pages_per_area: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _debug_set_level(id: *mut debug_info_t, new_level: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_set_level(id: *mut debug_info_t, new_level: c_int) {
    void debug_set_level(debug_info_t *id, int new_level)
    {
// Level specified via kernel parameter takes precedence
    debug_get_param(id.name, &new_level, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn proceed_active_entry(id: *mut debug_info_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn proceed_active_area(id: *mut debug_info_t) {
...
#[no_mangle]
unsafe extern "C" fn debug_areas_swap(a: *mut debug_info_t, b: *mut debug_info_t) {
    static void debug_areas_swap(debug_info_t *a, debug_info_t *b)
    {
...
#[no_mangle]
unsafe extern "C" fn debug_events_append(dest: *mut debug_info_t, src: *mut debug_info_t) {
    static void debug_events_append(debug_info_t *dest, debug_info_t *src)
    {
...
//
    ...
    let mut debug_stoppable: static int = 1;
    let mut debug_active: static int = 1;
pub const CTL_S390DBF_STOPPABLE: c_int = 5678;
pub const CTL_S390DBF_ACTIVE: c_int = 5679;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_stop_all() {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_set_critical() {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_count_numargs(string: *mut c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_register_view(id: *mut debug_info_t, view: *mut debug_view) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn debug_unregister_view(id: *mut debug_info_t, view: *mut debug_view) -> c_int {
    ...
    id.views[i] = core::ptr::null_mut();
    id.debugfs_entries[i] = core::ptr::null_mut();
    }
    raw_spin_unlock_irqrestore(&id.lock, flags);
...
#[no_mangle]
pub unsafe extern "C" fn debug_get_uint(buf: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn debug_flush(id: *mut debug_info_t, area: c_int) {
...
//
    ...
    let mut area: c_int = ((int) input_buf[0] - (int) '0');
    debug_flush(id, area);
    goto out;
    }
...
//
#[no_mangle]
unsafe extern "C" fn debug_init() -> int __init {
    static int __init debug_init(void)
    {
    register_sysctl("s390dbf", s390dbf_table);
    mutex_lock(&debug_mutex);
    debug_debugfs_root_entry = debugfs_create_dir(DEBUG_DIR_ROOT, core::ptr::null_mut());
    initialized = 1;
    mutex_unlock(&debug_mutex);
    return 0;
    }
