...
//! Source: drivers/hte/hte-tegra194-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn process_hw_ts(ts: *mut hte_ts_data, p: *mut c_void) -> enum hte_return {
...
#[no_mangle]
unsafe extern "C" fn gpio_timer_cb(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn tegra_hte_test_gpio_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_hte_test_probe(pdev: *mut platform_device) -> c_int {
...
// set.
//
    hte_init_line_attr(&hte.desc[i], 0, 0, core::ptr::null_mut(),
    hte.gpio_in);
    else
//
...
// line data.
//
    hte_init_line_attr(&hte.desc[i], 0, 0, core::ptr::null_mut(), core::ptr::null_mut());
    ret = hte_ts_get(hte.pdev, &hte.desc[i], i);
    if (ret)
    goto ts_put;
    ret = devm_hte_request_ts_ns(hte.pdev, &hte.desc[i],
    process_hw_ts, core::ptr::null_mut(),
    &hte.desc[i]);
...
#[no_mangle]
unsafe extern "C" fn tegra_hte_test_remove(pdev: *mut platform_device) {
