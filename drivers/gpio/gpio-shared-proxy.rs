...
//! Source: drivers/gpio/gpio-shared-proxy.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gpio_shared_proxy_request(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_shared_proxy_free(gc: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gpio_shared_proxy_to_irq(gc: *mut gpio_chip, offset: c_uint) -> c_int {
