...
//! Source: drivers/gpio/gpio-mvebu.c
#![no_std]
...
//
pub const GPIO_OUT_OFF: c_uint = 0x0000;
pub const GPIO_IO_CONF_OFF: c_uint = 0x0004;
pub const GPIO_BLINK_EN_OFF: c_uint = 0x0008;
pub const GPIO_IN_POL_OFF: c_uint = 0x000c;
pub const GPIO_DATA_IN_OFF: c_uint = 0x0010;
pub const GPIO_EDGE_CAUSE_OFF: c_uint = 0x0014;
pub const GPIO_EDGE_MASK_OFF: c_uint = 0x0018;
pub const GPIO_LEVEL_MASK_OFF: c_uint = 0x001c;
pub const GPIO_BLINK_CNT_SELECT_OFF: c_uint = 0x0020;
//
// PWM register offsets.
//
pub const PWM_BLINK_ON_DURATION_OFF: c_uint = 0x0;
pub const PWM_BLINK_OFF_DURATION_OFF: c_uint = 0x4;
pub const PWM_BLINK_COUNTER_B_OFF: c_uint = 0x8;
// Armada 8k variant gpios register offsets
pub const AP80X_GPIO0_OFF_A8K: c_uint = 0x1040;
pub const CP11X_GPIO0_OFF_A8K: c_uint = 0x100;
pub const CP11X_GPIO1_OFF_A8K: c_uint = 0x140;
...
pub const MVEBU_GPIO_SOC_VARIANT_ORION: c_uint = 0x1;
pub const MVEBU_GPIO_SOC_VARIANT_MV78200: c_uint = 0x2;
pub const MVEBU_GPIO_SOC_VARIANT_ARMADAXP: c_uint = 0x3;
pub const MVEBU_GPIO_SOC_VARIANT_A8K: c_uint = 0x4;
pub const MVEBU_MAX_GPIO_PER_BANK: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_pwm {
    pub regs: *mut regmap,
    pub offset: u32,
    pub clk_rate: c_ulong,
    pub gpiod: *mut gpio_desc,
    pub lock: spinlock_t,
    pub mvchip: *mut mvebu_gpio_chip,
// Used to preserve GPIO/PWM registers across suspend/resume
    pub blink_select: u32,
    pub blink_on_duration: u32,
    pub blink_off_duration: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_gpio_chip {
    pub chip: gpio_chip,
    pub regs: *mut regmap,
    pub offset: u32,
    pub percpu_regs: *mut regmap,
    pub bank_irq: [c_int; 4],
    pub domain: *mut irq_domain,
    pub soc_variant: c_int,
// Used for PWM support
    pub clk: *mut clk,
    pub mvpwm: *mut mvebu_pwm,
// Used to preserve GPIO registers across suspend/resume
    pub out_reg: u32,
    pub io_conf_reg: u32,
    pub blink_en_reg: u32,
    pub in_pol_reg: u32,
    pub edge_mask_regs: [u32; 4],
    pub level_mask_regs: [u32; 4],
}
...
//
#[no_mangle]
unsafe extern "C" fn mvebu_pwmreg_blink_on_duration(mvpwm: *mut mvebu_pwm) -> c_uint {
    static unsigned int mvebu_pwmreg_blink_on_duration(struct mvebu_pwm *mvpwm)
    {
    return mvpwm.offset + PWM_BLINK_ON_DURATION_OFF;
    }
#[no_mangle]
unsafe extern "C" fn mvebu_pwmreg_blink_off_duration(mvpwm: *mut mvebu_pwm) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_set(chip: *mut gpio_chip, pin: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_get(chip: *mut gpio_chip, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_direction_input(chip: *mut gpio_chip, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_get_direction(chip: *mut gpio_chip, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_to_irq(chip: *mut gpio_chip, pin: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_edge_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_edge_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_level_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_level_irq_unmask(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_irq_handler(desc: *mut irq_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_set_wake_irq(d: *mut irq_data, enable: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pwm_suspend(mvchip: *mut mvebu_gpio_chip) -> void __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pwm_resume(mvchip: *mut mvebu_gpio_chip) -> void __maybe_unused {
...
//
    ...
    set = 0;
#[no_mangle]
pub unsafe extern "C" fn if(1: id ==) -> else {
    else if (id == 1)
    set = U32_MAX;
    else
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_remove_irq_domain(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_gpio_probe(pdev: *mut platform_device) -> c_int {
...
// Some gpio controllers do not provide irq support
    ...
    mvchip.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
//
    ...
    let mut irq: c_int = platform_get_irq_optional(pdev, i);
    if (irq < 0)
    continue;
