...
//! Source: drivers/gpio/gpio-siox.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_siox_ddata {
    pub gchip: gpio_chip,
    pub lock: mutex,
    pub setdata: [u8; 1],
    pub getdata: [u8; 3],
    pub irqlock: raw_spinlock_t,
    pub irq_enable: u32,
    pub irq_status: u32,
    pub irq_type: [u32; 20],
}
...
//
#[no_mangle]
unsafe extern "C" fn gpio_siox_set_data(sdevice: *mut siox_device, status: u8, buf[]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_siox_get_data(sdevice: *mut siox_device, buf[]: u8) -> c_int {
    ...
    let mut bitpos: c_uint = 11 - offset;
    let mut gpiolevel: c_uint = buf[bitpos / 8] & (1 << bitpos % 8);
    unsigned int prev_level =
    ddata.getdata[bitpos / 8] & (1 << (bitpos % 8));
    let mut irq_type: u32 = ddata.irq_type[offset];
    if (gpiolevel) {
    ...
    let mut irq: c_uint = irq_find_mapping(irqdomain, offset);
//
...
#[no_mangle]
unsafe extern "C" fn gpio_siox_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gpio_siox_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gpio_siox_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gpio_siox_irq_set_type(d: *mut irq_data, type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_siox_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    mutex_lock(&ddata.lock);
    if (offset >= 12) {
    let mut bitpos: c_uint = 19 - offset;
...
#[no_mangle]
unsafe extern "C" fn gpio_siox_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_siox_probe(sdevice: *mut siox_device) -> c_int {
