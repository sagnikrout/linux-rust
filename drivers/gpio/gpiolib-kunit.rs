...
//! Source: drivers/gpio/gpiolib-kunit.c
#![no_std]
...
pub const GPIO_TEST_PROVIDER_NGPIO: c_int = 4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_test_provider_data {
    pub GPIO_TEST_PROVIDER_NGPIO): DECLARE_BITMAP(is_output,,
    pub GPIO_TEST_PROVIDER_NGPIO): DECLARE_BITMAP(values,,
}

#[no_mangle]
unsafe extern "C" fn gpio_test_provider_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_test_provider_direction_input(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_test_provider_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_test_provider_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_test_provider_probe(pdev: *mut platform_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_swnode_consumer_pdata {
    pub gpio_ok: bool,
    pub errno: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_swnode_consumer_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_swnode_register_drivers(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_swnode_lookup_by_primary(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn gpio_swnode_lookup_by_secondary(test: *mut kunit) {
...
//
    ...
    fwnode_init(primary, core::ptr::null_mut());
    pdevinfo = (struct platform_device_info){
    .name = GPIO_TEST_PROVIDER,
    .id = PLATFORM_DEVID_NONE,
    .fwnode = primary,
...
#[no_mangle]
unsafe extern "C" fn gpio_swnode_unregister_swnode(data: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_probe_order_pdata {
    pub probe_count: c_uint,
    pub gpio_ok: bool,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_probe_order_consumer_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gpio_swnode_probe_order(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_probe_defer_pdata {
    pub probe_count: c_uint,
    pub gpio_err: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_probe_defer_consumer_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gpio_swnode_probe_defer_on_unregistered(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn gpio_swnode_probe_order_test_init(test: *mut kunit) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_unbind_consumer_drvdata {
    pub dev: *mut device,
    pub desc: *mut gpio_desc,
    pub nb: notifier_block,
    pub set_retval: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_unbind_unregister_notifier(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_unbind_consumer_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_unbind_with_consumers(test: *mut kunit) {
...
//
    ...
    PLATFORM_DEVID_NONE);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, cons);
    ret = device_create_managed_software_node(&cons.dev, properties, core::ptr::null_mut());
    KUNIT_ASSERT_EQ(test, ret, 0);
...
// provider.
//
pub const GPIO_HOG_OUTPUT_HIGH_OFFSET: c_int = 0;
pub const GPIO_HOG_OUTPUT_LOW_OFFSET: c_int = 1;
pub const GPIO_HOG_INPUT_OFFSET: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn gpio_hog_output_high(test: *mut kunit) {
