...
//! Source: drivers/gpio/gpio-max732x.c
#![no_std]
...
//
pub const PORT_NONE: c_uint = 0x0	/* '/' No Port */;
pub const PORT_OUTPUT: c_uint = 0x1	/* 'O' Push-Pull, Output Only */;
pub const PORT_INPUT: c_uint = 0x2	/* 'I' Input Only */;
pub const PORT_OPENDRAIN: c_uint = 0x3	/* 'P' Open-Drain, I/O */;
pub const IO_4I4O: c_uint = 0x5AA5	/* O7 O6 I5 I4 I3 I2 O1 O0 */;
pub const IO_4P4O: c_uint = 0x5FF5	/* O7 O6 P5 P4 P3 P2 O1 O0 */;
pub const IO_8I: c_uint = 0xAAAA	/* I7 I6 I5 I4 I3 I2 I1 I0 */;
pub const IO_8P: c_uint = 0xFFFF	/* P7 P6 P5 P4 P3 P2 P1 P0 */;
pub const IO_8O: c_uint = 0x5555	/* O7 O6 O5 O4 O3 O2 O1 O0 */;

pub const INT_NONE: c_uint = 0x0	/* No interrupt capability */;
pub const INT_NO_MASK: c_uint = 0x1	/* Has interrupts, no mask */;
pub const INT_INDEP_MASK: c_uint = 0x2	/* Has interrupts, independent mask */;
pub const INT_MERGED_MASK: c_uint = 0x3	/* Has interrupts, merged mask */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max732x_chip {
    pub gpio_chip: gpio_chip,
    pub /: *mut *mut *mut i2c_client client; / "main" client,
    pub client_dummy: *mut i2c_client,
    pub client_group_a: *mut i2c_client,
    pub client_group_b: *mut i2c_client,
    pub mask_group_a: c_uint,
    pub dir_input: c_uint,
    pub dir_output: c_uint,
    pub lock: mutex,
    pub reg_out: [u8; 2],
    pub irq_lock: mutex,
    pub irq_mask: u8,
    pub irq_mask_cur: u8,
    pub irq_trig_raise: u8,
    pub irq_trig_fall: u8,
    pub irq_features: u8,

}

#[no_mangle]
unsafe extern "C" fn max732x_writeb(chip: *mut max732x_chip, group_a: c_int, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max732x_readb(chip: *mut max732x_chip, group_a: c_int, val: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_group_a(chip: *mut max732x_chip, off: unsigned) -> c_int {
    static inline int is_group_a(struct max732x_chip *chip, unsigned off)
    {
    return (1u << off) & chip.mask_group_a;
    }
#[no_mangle]
unsafe extern "C" fn max732x_gpio_get_value(gc: *mut gpio_chip, off: unsigned) -> c_int {
...
// update the shadow register then
    ...
    int val)
    {
    let mut base: unsigned = off & ~0x7;
    let mut mask: u8 = 1u << (off & 0x7);
    ...
    {
    let mut mask_lo: unsigned = mask[0] & 0xff;
    let mut mask_hi: unsigned = (mask[0] >> 8) & 0xff;
    if (mask_lo)
...
#[no_mangle]
unsafe extern "C" fn max732x_gpio_direction_input(gc: *mut gpio_chip, off: unsigned) -> c_int {
    static int max732x_gpio_direction_input(struct gpio_chip *gc, unsigned off)
    {
    struct max732x_chip *chip = gpiochip_get_data(gc);
    let mut mask: c_uint = 1u << off;
...
#[no_mangle]
unsafe extern "C" fn max732x_writew(chip: *mut max732x_chip, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max732x_readw(chip: *mut max732x_chip, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_update_mask(chip: *mut max732x_chip) {
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_bus_sync_unlock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    static int max732x_irq_set_type(struct irq_data *d, unsigned int type)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
    struct max732x_chip *chip = gpiochip_get_data(gc);
    let mut off: u16 = d.hwirq;
    let mut mask: u16 = 1 << off;
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_set_wake(data: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_pending(chip: *mut max732x_chip) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn max732x_irq_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
    ...
    let mut has_irq: c_int = max732x_features[id.driver_data] >> 32;
    ...
    core::ptr::null_mut(), max732x_irq_handler, IRQF_ONESHOT |
...
// This will let us handle the parent IRQ in the driver
    ...
    let mut id_data: u32 = (uint32_t)max732x_features[id.driver_data];
    int i, port = 0;
    for (i = 0; i < 16; i++, id_data >>= 2) {
    let mut mask: c_uint = 1 << port;
    switch (id_data & 0x3) {
    case PORT_OUTPUT:
...
#[no_mangle]
unsafe extern "C" fn max732x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max732x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max732x_exit() -> void __exit {
