...
//! Source: drivers/gpio/gpio-viperboard.c
#![no_std]
...
pub const VPRBRD_GPIOA_CLK_1MHZ: c_int = 0;
pub const VPRBRD_GPIOA_CLK_100KHZ: c_int = 1;
pub const VPRBRD_GPIOA_CLK_10KHZ: c_int = 2;
pub const VPRBRD_GPIOA_CLK_1KHZ: c_int = 3;
pub const VPRBRD_GPIOA_CLK_100HZ: c_int = 4;
pub const VPRBRD_GPIOA_CLK_10HZ: c_int = 5;
pub const VPRBRD_GPIOA_FREQ_DEFAULT: c_int = 1000;
pub const VPRBRD_GPIOA_CMD_CONT: c_uint = 0x00;
pub const VPRBRD_GPIOA_CMD_PULSE: c_uint = 0x01;
pub const VPRBRD_GPIOA_CMD_PWM: c_uint = 0x02;
pub const VPRBRD_GPIOA_CMD_SETOUT: c_uint = 0x03;
pub const VPRBRD_GPIOA_CMD_SETIN: c_uint = 0x04;
pub const VPRBRD_GPIOA_CMD_SETINT: c_uint = 0x05;
pub const VPRBRD_GPIOA_CMD_GETIN: c_uint = 0x06;
pub const VPRBRD_GPIOB_CMD_SETDIR: c_uint = 0x00;
pub const VPRBRD_GPIOB_CMD_SETVAL: c_uint = 0x01;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vprbrd_gpioa_msg {
    pub cmd: u8,
    pub clk: u8,
    pub offset: u8,
    pub t1: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vprbrd_gpio {
    pub /: *mut *mut gpio_chip gpioa; / gpio a related things,
    pub gpioa_out: u32,
    pub gpioa_val: u32,
    pub /: *mut *mut gpio_chip gpiob; / gpio b related things,
    pub gpiob_out: u32,
    pub gpiob_val: u32,
    pub vb: *mut vprbrd,
}
...
// gpioa sampling clock module parameter
    ...
    let mut gpioa_freq: static unsigned int = VPRBRD_GPIOA_FREQ_DEFAULT;
...
// ----- end of gpio b chip ----------------------------------------------
#[no_mangle]
unsafe extern "C" fn vprbrd_gpio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vprbrd_gpio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vprbrd_gpio_exit() -> void __exit {
