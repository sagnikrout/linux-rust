...
//! Source: drivers/gpio/gpio-altera-a10sr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn altr_a10sr_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn altr_a10sr_gpio_probe(pdev: *mut platform_device) -> c_int {
