...
//! Source: drivers/gpio/gpio-kempld.c
#![no_std]
...
pub const KEMPLD_GPIO_MAX_NUM: c_int = 16;

pub const KEMPLD_GPIO_DIR: c_uint = 0x40;
pub const KEMPLD_GPIO_LVL: c_uint = 0x42;
pub const KEMPLD_GPIO_STS: c_uint = 0x44;
pub const KEMPLD_GPIO_EVT_LVL_EDGE: c_uint = 0x46;
pub const KEMPLD_GPIO_EVT_LOW_HIGH: c_uint = 0x48;
pub const KEMPLD_GPIO_IEN: c_uint = 0x4A;
pub const KEMPLD_GPIO_OUT_LVL: c_uint = 0x4E;
...
#[no_mangle]
unsafe extern "C" fn kempld_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
// Try to reduce to a single 8 bits access if possible
    ...
    struct kempld_gpio_data *gpio = gpiochip_get_data(chip);
    struct kempld_device_data *pld = gpio.pld;
    let mut reg: u8 = gpio.out_lvl_reg;
    unsigned int shift;
    kempld_get_mutex(pld);
// Try to reduce to a single 8 bits access if possible
    for (shift = 0; shift < gpio.chip.ngpio; shift += 8, reg++) {
...
#[no_mangle]
unsafe extern "C" fn kempld_gpio_direction_input(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_gpio_get_direction(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_gpio_pincount(pld: *mut kempld_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn kempld_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn kempld_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_irq_bus_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn kempld_irq_bus_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn kempld_gpio_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    core::ptr::null_mut(), kempld_gpio_irq_handler,
...
#[no_mangle]
unsafe extern "C" fn kempld_gpio_probe(pdev: *mut platform_device) -> c_int {
