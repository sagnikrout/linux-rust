...
//! Source: drivers/gpio/gpio-aggregator.c
#![no_std]
...
pub const AGGREGATOR_MAX_GPIOS: c_int = 512;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_aggregator {
    pub pdev: *mut platform_device,
    pub group: config_group,
    pub lookups: *mut gpiod_lookup_table,
    pub lock: mutex,
    pub id: c_int,
// List of gpio_aggregator_line. Always added in order
    pub list_head: list_head,
// used by legacy sysfs interface only
    pub init_via_sysfs: bool,
    pub args: [c_char; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_aggregator_line {
    pub group: config_group,
    pub parent: *mut gpio_aggregator,
    pub entry: list_head,
...
// Can be negative to indicate lookup by line name
    pub offset: c_int,
    pub flags: enum gpio_lookup_flags,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_aggregator_pdev_meta {
    pub init_via_sysfs: bool,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_alloc(aggr: *mut gpio_aggregator, arg_size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_free(aggr: *mut gpio_aggregator) {
    ...
    if (!lookups)
    return -ENOMEM;
    lookups.table[*n] = GPIO_LOOKUP_IDX(key, hwnum, core::ptr::null_mut(), *n, 0);
    (*n)++;
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_is_active(aggr: *mut gpio_aggregator) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_is_activating(aggr: *mut gpio_aggregator) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_count_lines(aggr: *mut gpio_aggregator) -> usize {
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_free_lines(aggr: *mut gpio_aggregator) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpiochip_fwd_timing {
    pub ramp_up_us: u32,
    pub ramp_down_us: u32,
}
...
pub struct gpiochip_fwd {
    ...
    union {
    pub /: *mut *mut mutex mlock; / protects tmp[] if can_sleep,
    pub /: *mut *mut spinlock_t slock; / protects tmp[] if !can_sleep,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_fwd_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_fwd_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_fwd_direction_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_fwd_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    error = gpiod_get_array_value_cansleep(j, descs, core::ptr::null_mut(), values);
    else
    error = gpiod_get_array_value(j, descs, core::ptr::null_mut(), values);
    if (error)
    return error;
    j = 0;
    for_each_set_bit(i, mask, fwd.chip.ngpio)
...
#[no_mangle]
unsafe extern "C" fn gpio_fwd_delay(chip: *mut gpio_chip, offset: c_uint, value: c_int) {
    ...
    let mut is_active_low: bool = gpiod_is_active_low(fwd.descs[offset]);
    u32 delay_us;
...
#[no_mangle]
unsafe extern "C" fn gpio_fwd_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
    ...
    if (fwd.chip.can_sleep)
    ret = gpiod_set_array_value_cansleep(j, descs, core::ptr::null_mut(), values);
    else
    ret = gpiod_set_array_value(j, descs, core::ptr::null_mut(), values);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn gpio_fwd_to_irq(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpiochip_fwd_setup_delay_line(fwd: *mut gpiochip_fwd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpiochip_fwd_gpio_request(fwd: *mut gpiochip_fwd, offset: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpiochip_fwd_gpio_get_direction(fwd: *mut gpiochip_fwd, offset: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpiochip_fwd_gpio_direction_input(fwd: *mut gpiochip_fwd, offset: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpiochip_fwd_gpio_get(fwd: *mut gpiochip_fwd, offset: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpiochip_fwd_gpio_set(fwd: *mut gpiochip_fwd, offset: c_uint, value: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpiochip_fwd_gpio_to_irq(fwd: *mut gpiochip_fwd, offset: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpiochip_fwd_desc_free(fwd: *mut gpiochip_fwd, offset: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpiochip_fwd_register(fwd: *mut gpiochip_fwd, data: *mut c_void) -> c_int {
...
//
    ...
    error = gpiochip_fwd_register(fwd, core::ptr::null_mut());
    if (error)
    return ERR_PTR(error);
    return fwd;
    }
...
// The list is always sorted as new elements are inserted in order.
    ...
    return fwnode_create_software_node(properties, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_activate(aggr: *mut gpio_aggregator) -> c_int {
...
//
    ...
    ret = -EPERM;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: live) -> else {
    else if (live)
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_device_release(item: *mut config_item) {
...
//
    ...
    if (line.idx == idx)
    return ERR_PTR(-EINVAL);
    line = gpio_aggregator_line_alloc(aggr, idx, core::ptr::null_mut(), -1);
    if (IS_ERR(line))
...
//
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_parse(aggr: *mut gpio_aggregator) -> c_int {
...
// GPIO chip + offset(s)
    ...
    {
    let mut meta: gpio_aggregator_pdev_meta = { .init_via_sysfs = true };
    char name[CONFIGFS_ITEM_NAME_LEN];
    struct gpio_aggregator *aggr;
    struct platform_device *pdev;
    int res;
...
// Expose to configfs
    ...
    gpiod_add_lookup_table(aggr.lookups);
    pdev = platform_device_register_data(core::ptr::null_mut(), DRV_NAME, aggr.id, &meta, sizeof(meta));
    if (IS_ERR(pdev)) {
    res = PTR_ERR(pdev);
    goto remove_table;
    }
    ...
    __ATTR(new_device, 0200, core::ptr::null_mut(), gpio_aggregator_new_device_store);
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_destroy(aggr: *mut gpio_aggregator) {
...
//
    ...
    __ATTR(delete_device, 0200, core::ptr::null_mut(), gpio_aggregator_delete_device_store);
...
//
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_probe(pdev: *mut platform_device) -> c_int {
    static int gpio_aggregator_probe(struct platform_device *pdev)
    {
    struct gpio_aggregator_pdev_meta *meta;
    struct device *dev = &pdev.dev;
    let mut init_via_sysfs: bool = false;
    struct gpio_desc **descs;
    struct gpiochip_fwd *fwd;
    unsigned long features;
    int i, n;
    n = gpiod_count(dev, core::ptr::null_mut());
    if (n < 0)
    return n;
    ...
    init_via_sysfs = true;
    for (i = 0; i < n; i++) {
    descs[i] = devm_gpiod_get_index(dev, core::ptr::null_mut(), i, GPIOD_ASIS);
    if (IS_ERR(descs[i])) {
//
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_idr_remove(id: c_int, p: *mut c_void, data: *mut c_void) -> int __exit {
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_remove_all() -> void __exit {
...
// below.
//
    idr_for_each(&gpio_aggregator_idr, gpio_aggregator_idr_remove, core::ptr::null_mut());
    idr_destroy(&gpio_aggregator_idr);
    }
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gpio_aggregator_exit() -> void __exit {
