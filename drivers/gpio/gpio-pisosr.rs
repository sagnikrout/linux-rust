...
//! Source: drivers/gpio/gpio-pisosr.c
#![no_std]
...
pub const DEFAULT_NGPIO: c_int = 8;
//
...
#[no_mangle]
unsafe extern "C" fn pisosr_gpio_refresh(gpio: *mut pisosr_gpio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pisosr_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pisosr_gpio_probe(spi: *mut spi_device) -> c_int {
