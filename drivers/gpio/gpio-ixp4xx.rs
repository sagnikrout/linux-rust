...
//! Source: drivers/gpio/gpio-ixp4xx.c
#![no_std]
...
pub const IXP4XX_REG_GPOUT: c_uint = 0x00;
pub const IXP4XX_REG_GPOE: c_uint = 0x04;
pub const IXP4XX_REG_GPIN: c_uint = 0x08;
pub const IXP4XX_REG_GPIS: c_uint = 0x0C;
pub const IXP4XX_REG_GPIT1: c_uint = 0x10;
pub const IXP4XX_REG_GPIT2: c_uint = 0x14;
pub const IXP4XX_REG_GPCLK: c_uint = 0x18;
pub const IXP4XX_REG_GPDBSEL: c_uint = 0x1C;
//
...
//
pub const IXP4XX_GPIO_STYLE_ACTIVE_HIGH: c_uint = 0x0;
pub const IXP4XX_GPIO_STYLE_ACTIVE_LOW: c_uint = 0x1;
pub const IXP4XX_GPIO_STYLE_RISING_EDGE: c_uint = 0x2;
pub const IXP4XX_GPIO_STYLE_FALLING_EDGE: c_uint = 0x3;
pub const IXP4XX_GPIO_STYLE_TRANSITIONAL: c_uint = 0x4;

pub const IXP4XX_GPIO_STYLE_SIZE: c_int = 3;
//
// Clock output control register defines.
//
pub const IXP4XX_GPCLK_CLK0DC_SHIFT: c_int = 0;
pub const IXP4XX_GPCLK_CLK0TC_SHIFT: c_int = 4;

pub const IXP4XX_GPCLK_CLK1DC_SHIFT: c_int = 16;
pub const IXP4XX_GPCLK_CLK1TC_SHIFT: c_int = 20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ixp4xx_gpio {
    pub chip: gpio_generic_chip,
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub irq_edge: c_ulonglong,
}

#[no_mangle]
unsafe extern "C" fn ixp4xx_gpio_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_gpio_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    static int ixp4xx_gpio_irq_set_type(struct irq_data *d, unsigned int type)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
    struct ixp4xx_gpio *g = gpiochip_get_data(gc);
    let mut line: c_int = d.hwirq;
    u32 int_style;
    u32 int_reg;
    u32 val;
    switch (type) {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_gpio_probe(pdev: *mut platform_device) -> c_int {
