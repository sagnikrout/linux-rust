...
//! Source: drivers/gpio/gpio-rockchip.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn gpio_writel_v2(val: u32, reg: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn gpio_readl_v2(reg: *mut void __iomem) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rockchip_gpio_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rockchip_gpio_to_irq(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_irq_demux(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_irq_reqres(d: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_irq_relres(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_irq_suspend(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_irq_resume(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_irq_enable(d: *mut irq_data) {
    static void rockchip_irq_enable(struct irq_data *d)
    {
    irq_gc_mask_clr_bit(d);
    }
#[no_mangle]
unsafe extern "C" fn rockchip_irq_disable(d: *mut irq_data) {
    static void rockchip_irq_disable(struct irq_data *d)
    {
    irq_gc_mask_set_bit(d);
    }
#[no_mangle]
unsafe extern "C" fn rockchip_interrupts_register(bank: *mut rockchip_pin_bank) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_gpiolib_register(bank: *mut rockchip_pin_bank) -> c_int {
...
//
    ...
    struct pinctrl_dev *pctldev = core::ptr::null_mut();
    if (!pctlnp)
    return -ENODATA;
...
#[no_mangle]
unsafe extern "C" fn rockchip_clk_put(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_get_bank_data(bank: *mut rockchip_pin_bank) -> c_int {
    static int rockchip_get_bank_data(struct rockchip_pin_bank *bank)
    {
    struct platform_device *pdev = to_platform_device(bank.dev);
    let mut id: c_int = 0, ret;
    ...
    return ret;
    bank.irq = ret;
    bank.clk = devm_clk_get_enabled(bank.dev, core::ptr::null_mut());
    if (IS_ERR(bank.clk))
    ...
    return found ? bank : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn rockchip_gpio_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct pinctrl_dev *pctldev = core::ptr::null_mut();
    struct rockchip_pin_bank *bank = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rockchip_gpio_remove(pdev: *mut platform_device) {
    static void rockchip_gpio_remove(struct platform_device *pdev)
    {
    struct rockchip_pin_bank *bank = platform_get_drvdata(pdev);
    irq_set_chained_handler_and_data(bank.irq, core::ptr::null_mut(), core::ptr::null_mut());
    if (bank.domain) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_gpio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rockchip_gpio_exit() -> void __exit {
