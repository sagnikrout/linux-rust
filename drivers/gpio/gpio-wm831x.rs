...
//! Source: drivers/gpio/gpio-wm831x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm831x_gpio {
    pub wm831x: *mut wm831x,
    pub gpio_chip: gpio_chip,
}

#[no_mangle]
unsafe extern "C" fn wm831x_gpio_direction_in(chip: *mut gpio_chip, offset: unsigned) -> c_int {
    static int wm831x_gpio_direction_in(struct gpio_chip *chip, unsigned offset)
    {
    struct wm831x_gpio *wm831x_gpio = gpiochip_get_data(chip);
    struct wm831x *wm831x = wm831x_gpio.wm831x;
    let mut val: c_int = WM831X_GPN_DIR;
...
#[no_mangle]
unsafe extern "C" fn wm831x_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_gpio_to_irq(chip: *mut gpio_chip, offset: unsigned) -> c_int {
    ...
    unsigned debounce)
    {
    let mut reg: c_int = WM831X_GPIO1_CONTROL + offset;
    int ret, fn;
...
// Not in GPIO mode
    ...
    fn = 0;
#[no_mangle]
pub unsafe extern "C" fn if(8000: debounce >= 4000 && debounce <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn wm831x_gpio_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
...
#[no_mangle]
unsafe extern "C" fn wm831x_gpio_probe(pdev: *mut platform_device) -> c_int {
    ...
    GFP_KERNEL);
    if (wm831x_gpio == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn wm831x_gpio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wm831x_gpio_exit() -> void __exit {
