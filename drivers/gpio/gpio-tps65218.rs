...
//! Source: drivers/gpio/gpio-tps65218.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps65218_gpio {
    pub tps65218: *mut tps65218,
    pub gpio_chip: gpio_chip,
}

#[no_mangle]
unsafe extern "C" fn tps65218_gpio_get(gc: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65218_gpio_request(gc: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65218_gpio_probe(pdev: *mut platform_device) -> c_int {
