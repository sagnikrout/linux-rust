...
//! Source: drivers/gpio/gpiolib-devres.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_gpiod_put(dev: *mut device, desc: *mut gpio_desc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_gpiod_unhinge(dev: *mut device, desc: *mut gpio_desc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_gpiod_put_array(dev: *mut device, descs: *mut gpio_descs) {
