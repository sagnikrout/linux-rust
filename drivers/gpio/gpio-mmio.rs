...
//! Source: drivers/gpio/gpio-mmio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_write8(reg: *mut void __iomem, data: c_ulong) {
    static void gpio_mmio_write8(void __iomem *reg, unsigned long data)
    {
    writeb(data, reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_read8(reg: *mut void __iomem) -> c_ulong {
    static unsigned long gpio_mmio_read8(void __iomem *reg)
    {
    return readb(reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_write16(reg: *mut void __iomem, data: c_ulong) {
    static void gpio_mmio_write16(void __iomem *reg, unsigned long data)
    {
    writew(data, reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_read16(reg: *mut void __iomem) -> c_ulong {
    static unsigned long gpio_mmio_read16(void __iomem *reg)
    {
    return readw(reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_write32(reg: *mut void __iomem, data: c_ulong) {
    static void gpio_mmio_write32(void __iomem *reg, unsigned long data)
    {
    writel(data, reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_read32(reg: *mut void __iomem) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_write64(reg: *mut void __iomem, data: c_ulong) {
    static void gpio_mmio_write64(void __iomem *reg, unsigned long data)
    {
    writeq(data, reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_read64(reg: *mut void __iomem) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_write16be(reg: *mut void __iomem, data: c_ulong) {
    static void gpio_mmio_write16be(void __iomem *reg, unsigned long data)
    {
    iowrite16be(data, reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_read16be(reg: *mut void __iomem) -> c_ulong {
    static unsigned long gpio_mmio_read16be(void __iomem *reg)
    {
    return ioread16be(reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_write32be(reg: *mut void __iomem, data: c_ulong) {
    static void gpio_mmio_write32be(void __iomem *reg, unsigned long data)
    {
    iowrite32be(data, reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_read32be(reg: *mut void __iomem) -> c_ulong {
    static unsigned long gpio_mmio_read32be(void __iomem *reg)
    {
    return ioread32be(reg);
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_line2mask(gc: *mut gpio_chip, line: c_uint) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_get_set(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
    static int gpio_mmio_get_set(struct gpio_chip *gc, unsigned int gpio)
    {
    struct gpio_generic_chip *chip = to_gpio_generic_chip(gc);
    let mut pinmask: c_ulong = gpio_mmio_line2mask(gc, gpio);
    let mut dir: bool = !!(chip.sdir & pinmask);
    if (dir)
...
//
    ...
    {
    struct gpio_generic_chip *chip = to_gpio_generic_chip(gc);
    let mut get_mask: c_ulong = 0, set_mask = 0;
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_set_none(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
    static int gpio_mmio_set_none(struct gpio_chip *gc, unsigned int gpio, int val)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_set(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
    static int gpio_mmio_set(struct gpio_chip *gc, unsigned int gpio, int val)
    {
    struct gpio_generic_chip *chip = to_gpio_generic_chip(gc);
    let mut mask: c_ulong = gpio_mmio_line2mask(gc, gpio);
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_set_set(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_dir_in_err(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
    static int gpio_mmio_dir_in_err(struct gpio_chip *gc, unsigned int gpio)
    {
    return -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn gpio_mmio_simple_dir_in(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_dir_in(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_get_dir(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_dir_out(gc: *mut gpio_chip, gpio: c_uint, val: c_int) {
...
//
    ...
    gc.set_multiple = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_request(gc: *mut gpio_chip, gpio_pin: c_uint) -> c_int {
...
//
    ...
    {
    struct gpio_chip *gc = &chip.gc;
    let mut flags: c_ulong = cfg.flags;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: chip->reg_dir_in) -> else {
...
#[no_mangle]
unsafe extern "C" fn gpio_mmio_pdev_probe(pdev: *mut platform_device) -> c_int {
