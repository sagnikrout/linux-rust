...
//! Source: drivers/gpio/gpio-virtuser.c
#![no_std]
...
pub const GPIO_VIRTUSER_NAME_BUF_LEN: c_int = 32;
    static DEFINE_IDA(gpio_virtuser_ida);
    static struct dentry *gpio_virtuser_dbg_root;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_virtuser_attr_data {
    union {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_virtuser_line_array_data {
    pub ad: gpio_virtuser_attr_data,
}
...
pub struct gpio_virtuser_line_data {
    pub ad: gpio_virtuser_attr_data,
    pub consumer: [c_char; GPIO_VIRTUSER_NAME_BUF_LEN],
    pub consumer_lock: mutex,
    pub debounce: c_uint,
    pub irq: core::sync::atomic::AtomicI32,
    pub irq_count: core::sync::atomic::AtomicI32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_virtuser_dbgfs_attr_descr {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_virtuser_irq_work_context {
    pub work: irq_work,
    pub work_completion: completion,
    union {
    struct {
    pub desc: *mut gpio_desc,
    pub dir: c_int,
...
unsafe extern "C" fn gpio_virtuser_get_value_array_atomic(work: *mut irq_work) {
    ...
    clear_bit(i, values);
#[no_mangle]
pub unsafe extern "C" fn if('1': buf[i] ==) -> else {
    else if (buf[i] == '1')
    set_bit(i, values);
    else
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_do_get_direction_atomic(work: *mut irq_work) {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_get_direction_atomic(desc: *mut gpio_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_set_direction(desc: *mut gpio_desc, dir: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_do_set_direction_atomic(work: *mut irq_work) {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_value_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_value_set(data: *mut c_void, val: u64) -> c_int {
    ...
    "%llu\n");
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_get_value_atomic(work: *mut irq_work) {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_value_atomic_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_set_value_atomic(work: *mut irq_work) {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_value_atomic_set(data: *mut c_void, val: u64) -> c_int {
    ...
    "%llu\n");
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_debounce_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_debounce_set(data: *mut c_void, val: u64) -> c_int {
...
// Don't propagate errno unknown to user-space.
    let mut ret: return = = -ENOTSUPP ? -EOPNOTSUPP : ret;
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_interrupts_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_interrupts_set(data: *mut c_void, val: u64) -> c_int {
    ...
    if (irq < 0)
    return irq;
    ret = request_threaded_irq(irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_debugfs_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_prop_is_gpio(prop: *mut property) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_count_ids(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_probe(pdev: *mut platform_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_virtuser_device {
    pub pdev: *mut platform_device,
    pub group: config_group,
    pub id: c_int,
    pub lock: mutex,
    pub lookup_table: *mut gpiod_lookup_table,
    pub lookup_list: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_virtuser_lookup {
    pub group: config_group,
    pub parent: *mut gpio_virtuser_device,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_virtuser_lookup_entry {
    pub group: config_group,
    pub parent: *mut gpio_virtuser_lookup,
    pub siblings: list_head,
    pub key: *mut c_char,
...
//
    ...
    {
    let mut flags: enum gpio_lookup_flags = gpio_virtuser_lookup_get_flags(item);
    const char *repr;
    if (flags & GPIO_OPEN_DRAIN)
    repr = "open-drain";
#[no_mangle]
pub unsafe extern "C" fn if(GPIO_OPEN_SOURCE: flags &) -> else {
    ...
    repr = "pull-up";
#[no_mangle]
pub unsafe extern "C" fn if(GPIO_PULL_DOWN: flags &) -> else {
    else if (flags & GPIO_PULL_DOWN)
    repr = "pull-down";
#[no_mangle]
pub unsafe extern "C" fn if(GPIO_PULL_DISABLE: flags &) -> else {
    ...
    {
    let mut num_entries: usize = gpio_virtuser_get_lookup_count(dev);
    struct gpio_virtuser_lookup_entry *entry;
    struct gpio_virtuser_lookup *lookup;
    let mut i: c_uint = 0, idx;
    lockdep_assert_held(&dev.lock);
    ...
    dev.lookup_table = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_lookup_config_group_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_device_config_group_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_init() -> int __init {
    ...
    gpio_virtuser_dbg_root = debugfs_create_dir("gpio-virtuser", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gpio_virtuser_exit() -> void __exit {
