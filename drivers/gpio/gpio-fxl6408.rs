...
//! Source: drivers/gpio/gpio-fxl6408.c
#![no_std]
...
pub const FXL6408_REG_DEVICE_ID: c_uint = 0x01;

pub const FXL6408_MF_SHIFT: c_int = 5;
// Bits set here indicate that the GPIO is an output.
pub const FXL6408_REG_IO_DIR: c_uint = 0x03;
//
// Bits set here, when the corresponding bit of IO_DIR is set, drive
// the output high instead of low.
//
pub const FXL6408_REG_OUTPUT: c_uint = 0x05;
// Bits here make the output High-Z, instead of the OUTPUT value.
pub const FXL6408_REG_OUTPUT_HIGH_Z: c_uint = 0x07;
// Returns the current status (1 = HIGH) of the input pins.
pub const FXL6408_REG_INPUT_STATUS: c_uint = 0x0f;
//
...
//
pub const FXL6408_REG_INT_STS: c_uint = 0x13;
pub const FXL6408_NGPIO: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn fxl6408_identify(dev: *mut device, regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxl6408_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fxl6408_resume(dev: *mut device) -> c_int {
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(fxl6408_pm_ops, core::ptr::null_mut(), fxl6408_resume);
