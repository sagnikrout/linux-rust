...
//! Source: drivers/gpio/gpio-mxc.c
#![no_std]
...
pub const IMX_SCU_WAKEUP_OFF: c_int = 0;
pub const IMX_SCU_WAKEUP_LOW_LVL: c_int = 4;
pub const IMX_SCU_WAKEUP_FALL_EDGE: c_int = 5;
pub const IMX_SCU_WAKEUP_RISE_EDGE: c_int = 6;
pub const IMX_SCU_WAKEUP_HIGH_LVL: c_int = 7;
// device type dependent stuff
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxc_gpio_hwdata {
    pub dr_reg: unsigned,
    pub gdir_reg: unsigned,
    pub psr_reg: unsigned,
    pub icr1_reg: unsigned,
    pub icr2_reg: unsigned,
    pub imr_reg: unsigned,
    pub isr_reg: unsigned,
    pub edge_sel_reg: c_int,
    pub low_level: unsigned,
    pub high_level: unsigned,
    pub rise_edge: unsigned,
    pub fall_edge: unsigned,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxc_gpio_reg_saved {
    pub icr1: u32,
    pub icr2: u32,
    pub imr: u32,
    pub gdir: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxc_gpio_port {
    pub node: list_head,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub irq: c_int,
    pub irq_high: c_int,
    pub desc): *mut *mut void (mx_irq_handler)(struct irq_desc,
    pub domain: *mut irq_domain,
    pub gen_gc: gpio_generic_chip,
    pub dev: *mut device,
    pub both_edges: u32,
    pub gpio_saved_reg: mxc_gpio_reg_saved,
    pub power_off: bool,
    pub wakeup_pads: u32,
    pub is_pad_wakeup: bool,
    pub pad_type: [u32; 32],
    pub hwdata: *const mxc_gpio_hwdata,
}
...
pub const GPIO_INT_BOTH_EDGES: c_uint = 0x4;
...
#[no_mangle]
unsafe extern "C" fn gpio_set_irq_type(d: *mut irq_data, type: u32) -> c_int {
    static int gpio_set_irq_type(struct irq_data *d, u32 type)
    {
    struct irq_chip_generic *gc = irq_data_get_irq_chip_data(d);
    struct mxc_gpio_port *port = gc.private;
    u32 bit, val;
    let mut gpio_idx: u32 = d.hwirq;
    int edge;
...
#[no_mangle]
unsafe extern "C" fn mxc_flip_edge(port: *mut mxc_gpio_port, gpio: u32) {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_irq_handler(port: *mut mxc_gpio_port, irq_stat: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn gpio_set_wake_irq(d: *mut irq_data, enable: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_init_gc(port: *mut mxc_gpio_port, irq_base: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_to_irq(gc: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_free(chip: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mxc_update_irq_chained_handler(port: *mut mxc_gpio_port, enable: bool) {
...
// setup handler for GPIO 16 to 31
    ...
    irq_set_chained_handler_and_data(port.irq_high, core::ptr::null_mut(), core::ptr::null_mut());
    }
    }
#[no_mangle]
unsafe extern "C" fn mxc_gpio_probe(pdev: *mut platform_device) -> c_int {
...
// the controller clock is optional
    port.clk = devm_clk_get_optional_enabled(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(port.clk))
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_save_regs(port: *mut mxc_gpio_port) {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_restore_regs(port: *mut mxc_gpio_port) {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_set_pad_wakeup(port: *mut mxc_gpio_port, enable: bool) -> bool {
    static bool mxc_gpio_set_pad_wakeup(struct mxc_gpio_port *port, bool enable)
    {
    unsigned long config;
    let mut ret: bool = false;
    int i, type;
    let mut is_imx8qm: bool = of_device_is_compatible(port.dev.of_node, "fsl,imx8qm-gpio");
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_noirq_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_noirq_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(mxc_gpio_runtime_suspend, mxc_gpio_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn mxc_gpio_syscore_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_gpio_syscore_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_mxc_init() -> int __init {
