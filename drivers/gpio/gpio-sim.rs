...
//! Source: drivers/gpio/gpio-sim.c
#![no_std]
...
pub const GPIO_SIM_NGPIO_MAX: c_int = 1024;

pub const GPIO_SIM_HOG_PROP_MAX: c_int = 5;

    static DEFINE_IDA(gpio_sim_ida);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_sim_chip {
    pub gc: gpio_chip,
    pub dev: *mut device,
    pub request_map: *mut c_ulong,
    pub direction_map: *mut c_ulong,
    pub value_map: *mut c_ulong,
    pub pull_map: *mut c_ulong,
    pub irq_sim: *mut irq_domain,
    pub lock: mutex,
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_direction_input(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_to_irq(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_request(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_free(gc: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_dbg_show(seq: *mut seq_file, gc: *mut gpio_chip) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_put_device(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_dispose_mappings(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_sysfs_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_setup_sysfs(chip: *mut gpio_sim_chip) -> c_int {
    static int gpio_sim_setup_sysfs(struct gpio_sim_chip *chip)
    {
    struct device_attribute *val_dev_attr, *pull_dev_attr;
    struct gpio_sim_attribute *val_attr, *pull_attr;
    let mut num_lines: c_uint = chip.gc.ngpio;
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_add_bank(swnode: *mut fwnode_handle, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_probe(pdev: *mut platform_device) -> c_int {
...
//
    pub parent: *mut gpio_sim_device,
    pub siblings: list_head,
    pub label: *mut c_char,
    pub num_lines: c_uint,
    pub line_list: list_head,
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_bank_has_label(bank: *mut gpio_sim_bank) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_sim_line {
    pub group: config_group,
    pub parent: *mut gpio_sim_bank,
    pub siblings: list_head,
    pub offset: c_uint,
    pub name: *mut c_char,
    pub valid: bool,
// There can only be one hog per line.
    pub hog: *mut gpio_sim_hog,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_sim_hog {
    pub item: config_item,
    pub parent: *mut gpio_sim_line,
    pub name: *mut c_char,
    pub dir: c_int,
    pub active_low: bool,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_device_is_live(dev: *mut gpio_sim_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_get_line_names_size(bank: *mut gpio_sim_bank) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_get_reserved_ranges_size(bank: *mut gpio_sim_bank) -> c_uint {
    ...
    {
    let mut prop_idx: c_uint = 0, line_names_size, ranges_size;
    struct property_entry properties[GPIO_SIM_PROP_MAX];
    char **line_names __free(kfree) = core::ptr::null_mut();
    u32 *ranges __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_bank_add_hogs(bank: *mut gpio_sim_bank) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_remove_swnode_recursive(swnode: *mut fwnode_handle) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_bank_labels_non_unique(dev: *mut gpio_sim_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_device_activate(dev: *mut gpio_sim_device) -> c_int {
...
//
    ...
    swnode = fwnode_create_software_node(core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(swnode))
    return PTR_ERR(swnode);
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_device_deactivate(dev: *mut gpio_sim_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_sim_chip_name_ctx {
    pub swnode: *mut fwnode_handle,
    pub page: *mut c_char,
}

#[no_mangle]
unsafe extern "C" fn gpio_sim_emit_chip_name(dev: *mut device, data: *mut c_void) -> c_int {
...
// This would be the sysfs device exported in /sys/class/gpio.
    ...
    let mut ctx: gpio_sim_chip_name_ctx = { bank.swnode, page };
    guard(mutex)(&dev.lock);
...
// This would be a programmer bug.
    ...
    dir = GPIOD_IN;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(page, _arg: "output-high")) -> else {
    else if (sysfs_streq(page, "output-high"))
    dir = GPIOD_OUT_HIGH;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(page, _arg: "output-low")) -> else {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_hog_config_item_release(item: *mut config_item) {
    ...
    hog.dir = GPIOD_IN;
    hog.name = core::ptr::null_mut();
    hog.parent = line;
    line.hog = hog;
    return &hog.item;
    }
#[no_mangle]
unsafe extern "C" fn gpio_sim_line_config_group_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_bank_config_group_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_device_config_group_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gpio_sim_exit() -> void __exit {
