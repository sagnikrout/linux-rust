...
//! Source: drivers/gpio/gpio-virtio.c
#![no_std]
...
pub struct virtio_gpio_line {
    pub /: *mut *mut mutex lock; / Protects line operation,
...
pub struct virtio_gpio {
    ...
    pub /: *mut *mut mutex lock; / Protects virtqueue operation,
    pub gc: gpio_chip,
    pub lines: *mut virtio_gpio_line,
    pub request_vq: *mut virtqueue,
// irq support
    pub event_vq: *mut virtqueue,
    pub /: *mut *mut mutex irq_lock; / Protects irq operation,
    pub /: *mut *mut raw_spinlock_t eventq_lock; / Protects queuing of the buffer,
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_free(gc: *mut gpio_chip, gpio: c_uint) {
    ...
    VIRTIO_GPIO_DIRECTION_NONE, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn virtio_gpio_get_direction(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_direction_input(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
    ...
    VIRTIO_GPIO_DIRECTION_IN, core::ptr::null_mut());
    }
    ...
    struct virtio_gpio *vgpio = gpiochip_get_data(gc);
    int ret;
    ret = virtio_gpio_req(vgpio, VIRTIO_GPIO_MSG_SET_VALUE, gpio, value, core::ptr::null_mut());
    if (ret)
    return ret;
    return virtio_gpio_req(vgpio, VIRTIO_GPIO_MSG_SET_DIRECTION, gpio,
    VIRTIO_GPIO_DIRECTION_OUT, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn virtio_gpio_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_set(gc: *mut gpio_chip, gpio: c_uint, value: c_int) -> c_int {
...
// Interrupt handling
#[no_mangle]
unsafe extern "C" fn virtio_gpio_irq_prepare(vgpio: *mut virtio_gpio, gpio: u16) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_irq_enable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_irq_disable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_irq_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_irq_bus_sync_unlock(d: *mut irq_data) {
    static void virtio_gpio_irq_bus_sync_unlock(struct irq_data *d)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
    struct virtio_gpio *vgpio = gpiochip_get_data(gc);
    struct vgpio_irq_line *irq_line = &vgpio.irq_lines[d.hwirq];
    let mut type: u8 = irq_line.disabled ? VIRTIO_GPIO_IRQ_TYPE_NONE : irq_line.type;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_event_vq(vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_request_vq(vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_free_vqs(vdev: *mut virtio_device) {
    ...
    struct virtqueue *vqs[2] = { core::ptr::null_mut(), core::ptr::null_mut() };
    int ret;
    ...
    ret = _virtio_gpio_req(vgpio, VIRTIO_GPIO_MSG_GET_NAMES, 0, 0, core::ptr::null_mut(),
    res, len);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_probe(vdev: *mut virtio_device) -> c_int {
...
// The event comes from the outside so no parent handler
    vgpio.gc.irq.parent_handler	= core::ptr::null_mut();
    vgpio.gc.irq.num_parents	= 0;
    vgpio.gc.irq.parents		= core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn virtio_gpio_remove(vdev: *mut virtio_device) {
