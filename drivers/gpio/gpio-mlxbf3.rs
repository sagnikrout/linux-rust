...
//! Source: drivers/gpio/gpio-mlxbf3.c
#![no_std]
...
//
pub const MLXBF3_GPIO_MAX_PINS_PER_BLOCK: c_int = 32;
pub const MLXBF3_GPIO_MAX_PINS_BLOCK0: c_int = 32;
pub const MLXBF3_GPIO_MAX_PINS_BLOCK1: c_int = 24;
//
// fw_gpio[x] block registers and their offset
//
pub const MLXBF_GPIO_FW_OUTPUT_ENABLE_SET: c_uint = 0x00;
pub const MLXBF_GPIO_FW_DATA_OUT_SET: c_uint = 0x04;
pub const MLXBF_GPIO_FW_OUTPUT_ENABLE_CLEAR: c_uint = 0x00;
pub const MLXBF_GPIO_FW_DATA_OUT_CLEAR: c_uint = 0x04;
pub const MLXBF_GPIO_CAUSE_RISE_EN: c_uint = 0x00;
pub const MLXBF_GPIO_CAUSE_FALL_EN: c_uint = 0x04;
pub const MLXBF_GPIO_READ_DATA_IN: c_uint = 0x08;
pub const MLXBF_GPIO_CAUSE_OR_CAUSE_EVTEN0: c_uint = 0x00;
pub const MLXBF_GPIO_CAUSE_OR_EVTEN0: c_uint = 0x14;
pub const MLXBF_GPIO_CAUSE_OR_CLRCAUSE: c_uint = 0x18;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf3_gpio_context {
    pub chip: gpio_generic_chip,
// YU GPIO block address
    pub gpio_set_io: *mut void __iomem,
    pub gpio_clr_io: *mut void __iomem,
    pub gpio_io: *mut void __iomem,
// YU GPIO cause block address
    pub gpio_cause_io: *mut void __iomem,
}

#[no_mangle]
unsafe extern "C" fn mlxbf3_gpio_irq_enable(irqd: *mut irq_data) {
    static void mlxbf3_gpio_irq_enable(struct irq_data *irqd)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(irqd);
    struct mlxbf3_gpio_context *gs = gpiochip_get_data(gc);
    let mut offset: irq_hw_number_t = irqd_to_hwirq(irqd);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_gpio_irq_disable(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_gpio_irq_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_gpio_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_gpio_add_pin_ranges(chip: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_gpio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_gpio_shutdown(pdev: *mut platform_device) {
