...
//! Source: drivers/gpio/gpio-pch.c
#![no_std]
...
pub const PCH_EDGE_FALLING: c_int = 0;
pub const PCH_EDGE_RISING: c_int = 1;
pub const PCH_LEVEL_L: c_int = 2;
pub const PCH_LEVEL_H: c_int = 3;
pub const PCH_EDGE_BOTH: c_int = 4;

pub const PCH_IRQ_BASE: c_int = 24;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pch_regs {
    pub ien: u32,
...
pub const PCI_DEVICE_ID_INTEL_EG20T_PCH: c_uint = 0x8803;
pub const PCI_DEVICE_ID_ROHM_ML7223m_IOH: c_uint = 0x8014;
pub const PCI_DEVICE_ID_ROHM_ML7223n_IOH: c_uint = 0x8043;
pub const PCI_DEVICE_ID_ROHM_EG20T_PCH: c_uint = 0x8803;
    enum pch_type_t {
    INTEL_EG20T_PCH,
...
pub struct pch_gpio {
    ...
    pub reg: *mut pch_regs __iomem,
    pub dev: *mut device,
    pub gpio: gpio_chip,
    pub pch_gpio_reg: pch_gpio_reg_data,
    pub irq_base: c_int,
    pub ioh: enum pch_type_t,
    pub spinlock: raw_spinlock_t,
}

#[no_mangle]
unsafe extern "C" fn pch_gpio_set(gpio: *mut gpio_chip, nr: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_gpio_get(gpio: *mut gpio_chip, nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_gpio_direction_input(gpio: *mut gpio_chip, nr: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gpio_save_reg_conf(chip: *mut pch_gpio) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_gpio_restore_reg_conf(chip: *mut pch_gpio) {
...
#[no_mangle]
unsafe extern "C" fn pch_gpio_to_irq(gpio: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_gpio_setup(chip: *mut pch_gpio) {
...
#[no_mangle]
unsafe extern "C" fn pch_irq_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pch_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pch_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pch_gpio_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t pch_gpio_handler(int irq, void *dev_id)
    {
    struct pch_gpio *chip = dev_id;
    let mut reg_val: c_ulong = ioread32(&chip.reg.istatus);
    int i;
...
#[no_mangle]
unsafe extern "C" fn pch_gpio_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pch_gpio_resume(dev: *mut device) -> c_int {
