...
//! Source: drivers/gpio/gpio-pxa.c
#![no_std]
...
//
pub const GPLR_OFFSET: c_uint = 0x00;
pub const GPDR_OFFSET: c_uint = 0x0C;
pub const GPSR_OFFSET: c_uint = 0x18;
pub const GPCR_OFFSET: c_uint = 0x24;
pub const GRER_OFFSET: c_uint = 0x30;
pub const GFER_OFFSET: c_uint = 0x3C;
pub const GEDR_OFFSET: c_uint = 0x48;
pub const GAFR_OFFSET: c_uint = 0x54;
pub const ED_MASK_OFFSET: c_uint = 0x9C	/* GPIO edge detection for AP side */;
...
pub struct pxa_gpio_bank {
    ...
    pub irq_edge_rise: c_ulong,
    pub irq_edge_fall: c_ulong,

    pub saved_gplr: c_ulong,
    pub saved_gpdr: c_ulong,
    pub saved_grer: c_ulong,
    pub saved_gfer: c_ulong,

}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa_gpio_chip {
    pub dev: *mut device,
    pub chip: gpio_chip,
    pub banks: *mut pxa_gpio_bank,
    pub irqdomain: *mut irq_domain,
    pub irq0: c_int,
    pub irq1: c_int,
    pub on): *mut *mut int (set_wake)(unsigned int gpio, unsigned int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa_gpio_id {
    pub type: enum pxa_gpio_type,
    pub gpio_nums: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn gpio_is_mmp_type(type: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __gpio_is_inverted(gpio: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __gpio_is_occupied(pchip: *mut pxa_gpio_chip, gpio: unsigned) -> c_int {
    static inline int __gpio_is_occupied(struct pxa_gpio_chip *pchip, unsigned gpio)
    {
    void __iomem *base;
    let mut gafr: c_ulong = 0, gpdr = 0;
    int ret, af = 0, dir = 0;
...
#[no_mangle]
pub unsafe extern "C" fn pxa_irq_to_gpio(irq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_has_pinctrl() -> bool {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_to_irq(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_direction_input(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
    static int pxa_gpio_get(struct gpio_chip *chip, unsigned offset)
    {
    void __iomem *base = gpio_bank_base(chip, offset);
    let mut gplr: u32 = readl_relaxed(base + GPLR_OFFSET);
    return !!(gplr & GPIO_bit(offset));
    }
#[no_mangle]
unsafe extern "C" fn pxa_gpio_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_init_gpio_chip(pchip: *mut pxa_gpio_chip, ngpio: c_int, regbase: *mut void __iomem) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn update_edge_detect(c: *mut pxa_gpio_bank) {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_irq_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_demux_handler(in_irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_direct_handler(in_irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pxa_ack_muxed_gpio(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pxa_mask_muxed_gpio(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_unmask_muxed_gpio(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_nums(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_probe(pdev: *mut platform_device) -> c_int {
    ...
    int gpio, ret;
    let mut irq0: c_int = 0, irq1 = 0, irq_mux;
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_legacy_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_dt_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pxa_gpio_sysinit() -> int __init {
