...
//! Source: drivers/gpio/gpio-merrifield.c
#![no_std]
...
pub const MRFLD_NGPIO: c_int = 192;
    ...
    const char *name;
    adev = acpi_dev_get_first_match_dev("INTC1002", core::ptr::null_mut(), -1);
    if (adev) {
...
#[no_mangle]
unsafe extern "C" fn mrfld_gpio_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
