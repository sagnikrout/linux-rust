...
//! Source: drivers/gpio/gpio-uniphier.c
#![no_std]
...
pub const UNIPHIER_GPIO_IRQ_MAX_NUM: c_int = 24;
pub const UNIPHIER_GPIO_PORT_DATA: c_uint = 0x0	/* data */;
pub const UNIPHIER_GPIO_PORT_DIR: c_uint = 0x4	/* direction (1:in, 0:out) */;
pub const UNIPHIER_GPIO_IRQ_EN: c_uint = 0x90	/* irq enable */;
pub const UNIPHIER_GPIO_IRQ_MODE: c_uint = 0x94	/* irq mode (1: both edge) */;
pub const UNIPHIER_GPIO_IRQ_FLT_EN: c_uint = 0x98	/* noise filter enable */;
pub const UNIPHIER_GPIO_IRQ_FLT_CYC: c_uint = 0x9c	/* noise filter clock cycle */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_gpio_priv {
    pub chip: gpio_chip,
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_bank_to_reg(bank: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_to_irq(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_hw_init(priv: *mut uniphier_gpio_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_get_nbanks(ngpio: c_uint) -> c_uint {
    static unsigned int uniphier_gpio_get_nbanks(unsigned int ngpio)
    {
    return DIV_ROUND_UP(ngpio, UNIPHIER_GPIO_LINES_PER_BANK);
    }
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_suspend(dev: *mut device) -> c_int {
    static int uniphier_gpio_suspend(struct device *dev)
    {
    struct uniphier_gpio_priv *priv = dev_get_drvdata(dev);
    let mut nbanks: c_uint = uniphier_gpio_get_nbanks(priv.chip.ngpio);
...
#[no_mangle]
unsafe extern "C" fn uniphier_gpio_resume(dev: *mut device) -> c_int {
