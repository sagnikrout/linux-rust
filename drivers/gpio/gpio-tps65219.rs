...
//! Source: drivers/gpio/gpio-tps65219.c
#![no_std]
...
pub const TPS6521X_GPIO0_OFFSET: c_int = 2;
pub const TPS6521X_GPIO0_IDX: c_int = 0;
//
...
pub struct tps65219_gpio {
    pub dir): *mut *mut *mut int (change_dir)(struct gpio_chip gc, unsigned int offset, unsigned int,
    pub gpio_chip: gpio_chip,
    pub tps: *mut tps65219,
}

#[no_mangle]
unsafe extern "C" fn tps65214_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_gpio_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_gpio_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_gpio_direction_input(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_gpio_direction_output(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_gpio_probe(pdev: *mut platform_device) -> c_int {
