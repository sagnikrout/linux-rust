...
//! Source: drivers/gpio/gpio-tegra186.c
#![no_std]
...
// security registers
pub const TEGRA186_GPIO_CTL_SCR: c_uint = 0x0c;

pub const TEGRA186_GPIO_VM: c_uint = 0x00;
pub const TEGRA186_GPIO_VM_RW_MASK: c_uint = 0x03;
pub const TEGRA186_GPIO_SCR: c_uint = 0x04;
pub const TEGRA186_GPIO_SCR_PIN_SIZE: c_uint = 0x08;
pub const TEGRA186_GPIO_SCR_PORT_SIZE: c_uint = 0x40;

// control registers
pub const TEGRA186_GPIO_ENABLE_CONFIG: c_uint = 0x00;

pub const TEGRA186_GPIO_DEBOUNCE_CONTROL: c_uint = 0x04;

pub const TEGRA186_GPIO_INPUT: c_uint = 0x08;

pub const TEGRA186_GPIO_OUTPUT_CONTROL: c_uint = 0x0c;

pub const TEGRA186_GPIO_OUTPUT_VALUE: c_uint = 0x10;

pub const TEGRA186_GPIO_INTERRUPT_CLEAR: c_uint = 0x14;

// Tegra410 GPIOs implemented by the COMPUTE GPIO controller
pub const TEGRA410_COMPUTE_GPIO_PORT_A: c_int = 0;
pub const TEGRA410_COMPUTE_GPIO_PORT_B: c_int = 1;
pub const TEGRA410_COMPUTE_GPIO_PORT_C: c_int = 2;
pub const TEGRA410_COMPUTE_GPIO_PORT_D: c_int = 3;
pub const TEGRA410_COMPUTE_GPIO_PORT_E: c_int = 4;
// Tegra410 GPIOs implemented by the SYSTEM GPIO controller
pub const TEGRA410_SYSTEM_GPIO_PORT_A: c_int = 0;
pub const TEGRA410_SYSTEM_GPIO_PORT_B: c_int = 1;
pub const TEGRA410_SYSTEM_GPIO_PORT_C: c_int = 2;
pub const TEGRA410_SYSTEM_GPIO_PORT_D: c_int = 3;
pub const TEGRA410_SYSTEM_GPIO_PORT_E: c_int = 4;
pub const TEGRA410_SYSTEM_GPIO_PORT_I: c_int = 5;
pub const TEGRA410_SYSTEM_GPIO_PORT_J: c_int = 6;
pub const TEGRA410_SYSTEM_GPIO_PORT_K: c_int = 7;
pub const TEGRA410_SYSTEM_GPIO_PORT_L: c_int = 8;
pub const TEGRA410_SYSTEM_GPIO_PORT_M: c_int = 9;
pub const TEGRA410_SYSTEM_GPIO_PORT_N: c_int = 10;
pub const TEGRA410_SYSTEM_GPIO_PORT_P: c_int = 11;
pub const TEGRA410_SYSTEM_GPIO_PORT_Q: c_int = 12;
pub const TEGRA410_SYSTEM_GPIO_PORT_R: c_int = 13;
pub const TEGRA410_SYSTEM_GPIO_PORT_V: c_int = 14;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_gpio_port {
...
pub struct tegra_gpio_soc {
    pub ports: *const tegra_gpio_port,
    pub num_ports: c_uint,
    pub name: *const c_char,
    pub prefix: *const c_char,
    pub instance: c_uint,
    pub num_irqs_per_bank: c_uint,
    pub pin_ranges: *const tegra186_pin_range,
    pub num_pin_ranges: c_uint,
    pub pinmux: *const c_char,
    pub has_gte: bool,
    pub has_vm_support: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_gpio {
    pub gpio: gpio_chip,
    pub num_irq: c_uint,
    pub soc: *const tegra_gpio_soc,
    pub num_irqs_per_bank: c_uint,
    pub num_banks: c_uint,
    pub secure: *mut void __iomem,
    pub base: *mut void __iomem,
    pub __counted_by(num_irq): unsigned int irq[],
}

    static const struct tegra_gpio_port *
    tegra186_gpio_get_port(struct tegra_gpio *gpio, unsigned int *pin)
    {
    let mut start: c_uint = 0, i;
...
#[no_mangle]
pub unsafe extern "C" fn tegra186_gpio_is_accessible(gpio: *mut tegra_gpio, pin: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra186_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_gpio_add_pin_ranges(chip: *mut gpio_chip) -> c_int {
    ...
    return 0;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), gpio.soc.pinmux);
    if (!np)
    return -ENODEV;
    ...
    let mut pin: c_uint = gpio.soc.pin_ranges[i].offset, port;
...
#[no_mangle]
unsafe extern "C" fn tegra186_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_irq_set_wake(data: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_irq_print_chip(data: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_gpio_irq(desc: *mut irq_desc) {
...
// skip ports that are not associated with this bank
    ...
    let mut ret: c_int = generic_handle_domain_irq(domain, offset + pin);
...
#[no_mangle]
unsafe extern "C" fn tegra186_gpio_init_route_mapping(gpio: *mut tegra_gpio) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_gpio_irqs_per_bank(gpio: *mut tegra_gpio) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra186_gpio_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    if (!np)
    np = of_find_matching_node(core::ptr::null_mut(), tegra186_pmc_of_match);
    if (np) {
