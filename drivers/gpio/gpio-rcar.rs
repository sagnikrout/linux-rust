...
//! Source: drivers/gpio/gpio-rcar.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_rcar_bank_info {
    pub iointsel: u32,
    pub inoutsel: u32,
    pub outdt: u32,
    pub posneg: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_rcar_info {
    pub has_outdtsel: bool,
    pub has_both_edge_trigger: bool,
    pub has_always_in: bool,
    pub has_inen: bool,
}
...
pub struct gpio_rcar_priv {
    ...
    pub irq_parent: c_uint,
    pub wakeup_path: core::sync::atomic::AtomicI32,
    pub info: gpio_rcar_info,
    pub bank_info: gpio_rcar_bank_info,
}

pub const IOINTSEL: c_uint = 0x00	/* General IO/Interrupt Switching Register */;
pub const INOUTSEL: c_uint = 0x04	/* General Input/Output Switching Register */;
pub const OUTDT: c_uint = 0x08	/* General Output Register */;
pub const INDT: c_uint = 0x0c	/* General Input Register */;
pub const INTDT: c_uint = 0x10	/* Interrupt Display Register */;
pub const INTCLR: c_uint = 0x14	/* Interrupt Clear Register */;
pub const INTMSK: c_uint = 0x18	/* Interrupt Mask Register */;
pub const MSKCLR: c_uint = 0x1c	/* Interrupt Mask Clear Register */;
pub const POSNEG: c_uint = 0x20	/* Positive/Negative Logic Select Register */;
pub const EDGLEVEL: c_uint = 0x24	/* Edge/level Select Register */;
pub const OUTDTSEL: c_uint = 0x40	/* Output Data Select Register */;
pub const BOTHEDGE: c_uint = 0x4c	/* One Edge/Both Edge Select Register */;
pub const INEN: c_uint = 0x50	/* General Input Enable Register */;
pub const RCAR_MAX_GPIO_PER_BANK: c_int = 32;
#[no_mangle]
pub unsafe extern "C" fn gpio_rcar_read(p: *mut gpio_rcar_priv, offs: c_int) -> u32 {
    ...
    int bit, bool value)
    {
    let mut tmp: u32 = gpio_rcar_read(p, offs);
    if (value)
    tmp |= BIT(bit);
    else
    tmp &= ~BIT(bit);
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_irq_disable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_irq_enable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_irq_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_request(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_free(chip: *mut gpio_chip, offset: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_direction_input(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
//
    ...
    unsigned long *bits)
    {
    let mut bankmask: u32 = mask[0] & GENMASK(chip.ngpio - 1, 0);
    struct gpio_rcar_priv *p = gpiochip_get_data(chip);
    u32 outputs, m, val = 0;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_parse_dt(p: *mut gpio_rcar_priv, npins: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_enable_inputs(p: *mut gpio_rcar_priv) {
    static void gpio_rcar_enable_inputs(struct gpio_rcar_priv *p)
    {
    let mut mask: u32 = GENMASK(p.gpio_chip.ngpio - 1, 0);
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_rcar_resume(dev: *mut device) -> c_int {
