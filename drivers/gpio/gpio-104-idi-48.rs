...
//! Source: drivers/gpio/gpio-104-idi-48.c
#![no_std]
...
pub const IDI_48_EXTENT: c_int = 8;
...
pub const IDI48_IRQ_STATUS: c_uint = 0x7;
    ...
    let mut port: c_uint = (stride / 3) * 4;
    let mut port_stride: c_uint = stride % 3;
...
pub const IDI48_NGPIO: c_int = 48;
...
#[no_mangle]
unsafe extern "C" fn idi_48_probe(dev: *mut device, id: c_uint) -> c_int {
