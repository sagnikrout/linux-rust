...
//! Source: drivers/gpio/gpio-spacemit-k1.c
#![no_std]
...
pub const SPACEMIT_NR_BANKS: c_int = 4;
pub const SPACEMIT_NR_GPIOS_PER_BANK: c_int = 32;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spacemit_gpio_data {
    pub offsets: *const c_uint,
    pub bank_offsets: [u32; SPACEMIT_NR_BANKS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct spacemit_gpio_bank {
    pub chip: gpio_generic_chip,
    pub sg: *mut spacemit_gpio,
    pub base: *mut void __iomem,
    pub irq_mask: u32,
    pub irq_rising_edge: u32,
    pub irq_falling_edge: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct spacemit_gpio {
    pub dev: *mut device,
    pub data: *const spacemit_gpio_data,
    pub sgb: [spacemit_gpio_bank; SPACEMIT_NR_BANKS],
}
...
#[no_mangle]
unsafe extern "C" fn spacemit_gpio_bank_index(gb: *mut spacemit_gpio_bank) -> u32 {
    static u32 spacemit_gpio_bank_index(struct spacemit_gpio_bank *gb)
    {
    return (u32)(gb - gb.sg.sgb);
    }
#[no_mangle]
unsafe extern "C" fn spacemit_gpio_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn spacemit_gpio_irq_mask(d: *mut irq_data) {
    ...
    {
    struct spacemit_gpio_bank *gb = irq_data_get_irq_chip_data(d);
    let mut bit: u32 = BIT(irqd_to_hwirq(d));
    gb.irq_mask &= ~bit;
...
#[no_mangle]
unsafe extern "C" fn spacemit_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spacemit_of_node_instance_match(gc: *mut gpio_chip, i: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn spacemit_gpio_probe(pdev: *mut platform_device) -> c_int {
