...
//! Source: drivers/gpio/gpio-visconti.c
#![no_std]
...
pub const GPIO_IDATA: c_uint = 0x08;
pub const GPIO_ODATA: c_uint = 0x10;
pub const GPIO_OSET: c_uint = 0x18;
pub const GPIO_OCLR: c_uint = 0x20;
pub const GPIO_INTMODE: c_uint = 0x30;
pub const BASE_HW_IRQ: c_int = 24;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct visconti_gpio {
    pub base: *mut void __iomem,
    pub /: *mut *mut spinlock_t lock; / protect gpio register,
    pub chip: gpio_generic_chip,
    pub dev: *mut device,
}

#[no_mangle]
unsafe extern "C" fn visconti_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    ...
    let mut offset: u32 = irqd_to_hwirq(d);
    let mut bit: u32 = BIT(offset);
    let mut intc_type: u32 = IRQ_TYPE_EDGE_RISING;
    u32 intmode, odata;
    let mut ret: c_int = 0;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn visconti_gpio_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn visconti_gpio_unmask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn visconti_gpio_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn visconti_gpio_probe(pdev: *mut platform_device) -> c_int {
