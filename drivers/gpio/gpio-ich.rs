...
//! Source: drivers/gpio/gpio-ich.c
#![no_std]
...
// USE_SEL is bogus on some chipsets, eg 3100
    pub use_sel_ignore: [u32; 3],
// Some chipsets have quirks, let these use their own request/get
    pub offset): *mut *mut *mut int (request)(struct gpio_chip chip, unsigned int,
    pub offset): *mut *mut *mut int (get)(struct gpio_chip chip, unsigned int,
//
// Some chipsets don't let reading output values on GPIO_LVL register
// this option allows driver caching written output values
//
    pub use_outlvl_cache: bool,
}
...
#[no_mangle]
unsafe extern "C" fn ichx_write_bit(reg: c_int, nr: c_uint, val: c_int, verify: c_int) -> c_int {
    static int ichx_write_bit(int reg, unsigned int nr, int val, int verify)
    {
    unsigned long flags;
    u32 data, tmp;
    let mut reg_nr: c_int = nr / 32;
    let mut bit: c_int = nr & 0x1f;
...
#[no_mangle]
unsafe extern "C" fn ichx_read_bit(reg: c_int, nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ichx_gpio_check_available(gpio: *mut gpio_chip, nr: c_uint) -> bool {
    static bool ichx_gpio_check_available(struct gpio_chip *gpio, unsigned int nr)
    {
    return !!(ichx_priv.use_gpio & BIT(nr / 32));
    }
#[no_mangle]
unsafe extern "C" fn ichx_gpio_get_direction(gpio: *mut gpio_chip, nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ichx_gpio_direction_input(gpio: *mut gpio_chip, nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ichx_gpio_get(chip: *mut gpio_chip, nr: c_uint) -> c_int {
    static int ichx_gpio_get(struct gpio_chip *chip, unsigned int nr)
    {
    return ichx_read_bit(GPIO_LVL, nr);
    }
#[no_mangle]
unsafe extern "C" fn ich6_gpio_get(chip: *mut gpio_chip, nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ichx_gpio_request(chip: *mut gpio_chip, nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ich6_gpio_request(chip: *mut gpio_chip, nr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ichx_gpio_set(chip: *mut gpio_chip, nr: c_uint, val: c_int) -> c_int {
    static int ichx_gpio_set(struct gpio_chip *chip, unsigned int nr, int val)
    {
    return ichx_write_bit(GPIO_LVL, nr, val, 0);
    }
#[no_mangle]
unsafe extern "C" fn ichx_gpiolib_setup(chip: *mut gpio_chip) {
...
// Allow chip-specific overrides of request()/get()
    ...
    chip.dbg_show = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ichx_gpio_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    err = devm_gpiochip_add_data(dev, &ichx_priv.chip, core::ptr::null_mut());
    if (err) {
