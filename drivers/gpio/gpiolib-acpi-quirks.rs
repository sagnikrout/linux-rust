...
//! Source: drivers/gpio/gpiolib-acpi-quirks.c
#![no_std]
...
//
    ...
    let mut run_edge_events_on_boot: static int = -1;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_gpio_add_to_deferred_list(list: *mut list_head) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_gpio_remove_from_deferred_list(list: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_gpio_need_run_edge_events_on_boot() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_gpio_handle_deferred_request_irqs() -> int __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_gpiolib_dmi_quirk {
...
#[no_mangle]
unsafe extern "C" fn acpi_gpio_setup_params() -> int __init {
    static int __init acpi_gpio_setup_params(void)
    {
    const struct acpi_gpiolib_dmi_quirk *quirk = core::ptr::null_mut();
    ...
    if (ignore_wake == core::ptr::null_mut() && quirk && quirk.ignore_wake)
    ignore_wake = quirk.ignore_wake;
    if (ignore_interrupt == core::ptr::null_mut() && quirk && quirk.ignore_interrupt)
