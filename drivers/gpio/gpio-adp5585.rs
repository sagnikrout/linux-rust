...
//! Source: drivers/gpio/gpio-adp5585.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adp5585_gpio_chip {
    pub off): *mut *mut int (bank)(unsigned int,
    pub off): *mut *mut int (bit)(unsigned int,
    pub debounce_dis_a: c_uint,
    pub rpull_cfg_a: c_uint,
    pub gpo_data_a: c_uint,
    pub gpo_out_a: c_uint,
    pub gpio_dir_a: c_uint,
    pub gpi_stat_a: c_uint,
    pub gpi_int_lvl_a: c_uint,
    pub gpi_ev_a: c_uint,
    pub gpi_ev_min: c_uint,
    pub gpi_ev_max: c_uint,
    pub has_bias_hole: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct adp5585_gpio_dev {
    pub gpio_chip: gpio_chip,
    pub nb: notifier_block,
    pub info: *const adp5585_gpio_chip,
    pub regmap: *mut regmap,
    pub irq_mask: c_ulong,
    pub irq_en: c_ulong,
    pub irq_active_high: c_ulong,
// used for irqchip bus locking
    pub bus_lock: mutex,
}

#[no_mangle]
unsafe extern "C" fn adp5585_gpio_bank(off: c_uint) -> c_int {
    static int adp5585_gpio_bank(unsigned int off)
    {
    return ADP5585_BANK(off);
    }
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_bit(off: c_uint) -> c_int {
    static int adp5585_gpio_bit(unsigned int off)
    {
    return ADP5585_BIT(off);
    }
#[no_mangle]
unsafe extern "C" fn adp5589_gpio_bank(off: c_uint) -> c_int {
    static int adp5589_gpio_bank(unsigned int off)
    {
    return ADP5589_BANK(off);
    }
#[no_mangle]
unsafe extern "C" fn adp5589_gpio_bit(off: c_uint) -> c_int {
    static int adp5589_gpio_bit(unsigned int off)
    {
    return ADP5589_BIT(off);
    }
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_get_direction(chip: *mut gpio_chip, off: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_direction_input(chip: *mut gpio_chip, off: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_direction_output(chip: *mut gpio_chip, off: c_uint, val: c_int) -> c_int {
    static int adp5585_gpio_direction_output(struct gpio_chip *chip, unsigned int off, int val)
    {
    struct adp5585_gpio_dev *adp5585_gpio = gpiochip_get_data(chip);
    const struct adp5585_gpio_chip *info = adp5585_gpio.info;
    let mut bank: c_uint = info.bank(off);
    let mut bit: c_uint = info.bit(off);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_get_value(chip: *mut gpio_chip, off: c_uint) -> c_int {
...
//
    ...
    struct adp5585_gpio_dev *adp5585_gpio = gpiochip_get_data(chip);
    const struct adp5585_gpio_chip *info = adp5585_gpio.info;
    let mut bit: c_uint = adp5585_gpio.info.bit(off);
...
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_request(chip: *mut gpio_chip, off: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_free(chip: *mut gpio_chip, off: c_uint) {
    ...
    let mut key_press: c_ulong = (unsigned long)data;
...
#[no_mangle]
unsafe extern "C" fn adp5585_irq_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn adp5585_irq_bus_sync_unlock(d: *mut irq_data) {
    ...
    let mut active_high: bool = test_bit(hwirq, &adp5585_gpio.irq_active_high);
    let mut enabled: bool = test_bit(hwirq, &adp5585_gpio.irq_en);
    let mut masked: bool = test_bit(hwirq, &adp5585_gpio.irq_mask);
    let mut bank: c_uint = adp5585_gpio.info.bank(hwirq);
    let mut bit: c_uint = adp5585_gpio.info.bit(hwirq);
    if (masked && !enabled)
    goto out_unlock;
    if (!masked && enabled)
    goto out_unlock;
...
#[no_mangle]
unsafe extern "C" fn adp5585_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn adp5585_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn adp5585_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_unreg_notifier(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adp5585_gpio_probe(pdev: *mut platform_device) -> c_int {
