...
//! Source: drivers/gpio/gpio-eic-sprd.c
#![no_std]
...
pub const SPRD_EIC_DBNC_DATA: c_uint = 0x0;
pub const SPRD_EIC_DBNC_DMSK: c_uint = 0x4;
pub const SPRD_EIC_DBNC_IEV: c_uint = 0x14;
pub const SPRD_EIC_DBNC_IE: c_uint = 0x18;
pub const SPRD_EIC_DBNC_RIS: c_uint = 0x1c;
pub const SPRD_EIC_DBNC_MIS: c_uint = 0x20;
pub const SPRD_EIC_DBNC_IC: c_uint = 0x24;
pub const SPRD_EIC_DBNC_TRIG: c_uint = 0x28;
pub const SPRD_EIC_DBNC_CTRL0: c_uint = 0x40;
pub const SPRD_EIC_LATCH_INTEN: c_uint = 0x0;
pub const SPRD_EIC_LATCH_INTRAW: c_uint = 0x4;
pub const SPRD_EIC_LATCH_INTMSK: c_uint = 0x8;
pub const SPRD_EIC_LATCH_INTCLR: c_uint = 0xc;
pub const SPRD_EIC_LATCH_INTPOL: c_uint = 0x10;
pub const SPRD_EIC_LATCH_INTMODE: c_uint = 0x14;
pub const SPRD_EIC_ASYNC_INTIE: c_uint = 0x0;
pub const SPRD_EIC_ASYNC_INTRAW: c_uint = 0x4;
pub const SPRD_EIC_ASYNC_INTMSK: c_uint = 0x8;
pub const SPRD_EIC_ASYNC_INTCLR: c_uint = 0xc;
pub const SPRD_EIC_ASYNC_INTMODE: c_uint = 0x10;
pub const SPRD_EIC_ASYNC_INTBOTH: c_uint = 0x14;
pub const SPRD_EIC_ASYNC_INTPOL: c_uint = 0x18;
pub const SPRD_EIC_ASYNC_DATA: c_uint = 0x1c;
pub const SPRD_EIC_SYNC_INTIE: c_uint = 0x0;
pub const SPRD_EIC_SYNC_INTRAW: c_uint = 0x4;
pub const SPRD_EIC_SYNC_INTMSK: c_uint = 0x8;
pub const SPRD_EIC_SYNC_INTCLR: c_uint = 0xc;
pub const SPRD_EIC_SYNC_INTMODE: c_uint = 0x10;
pub const SPRD_EIC_SYNC_INTBOTH: c_uint = 0x14;
pub const SPRD_EIC_SYNC_INTPOL: c_uint = 0x18;
pub const SPRD_EIC_SYNC_DATA: c_uint = 0x1c;
//
// The digital-chip EIC controller can support maximum 3 banks, and each bank
// contains 8 EICs.
//
pub const SPRD_EIC_MAX_BANK: c_int = 3;
pub const SPRD_EIC_PER_BANK_NR: c_int = 8;
...
pub struct sprd_eic {
    ...
    pub base: [*mut void __iomem; SPRD_EIC_MAX_BANK],
    pub type: enum sprd_eic_type,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_eic_variant_data {
    pub type: enum sprd_eic_type,
}
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_read(chip: *mut gpio_chip, offset: c_uint, reg: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_free(chip: *mut gpio_chip, offset: c_uint) {
    static void sprd_eic_free(struct gpio_chip *chip, unsigned int offset)
    {
    sprd_eic_update(chip, offset, SPRD_EIC_DBNC_DMSK, 0);
    }
#[no_mangle]
unsafe extern "C" fn sprd_eic_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_direction_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
// EICs are always input, nothing need to do here.
    ...
    void __iomem *base =
    sprd_eic_offset_base(sprd_eic, offset / SPRD_EIC_PER_BANK_NR);
    let mut reg: u32 = SPRD_EIC_DBNC_CTRL0 + SPRD_EIC_BIT(offset) * 0x4;
    let mut value: u32 = readl_relaxed(base + reg) & ~SPRD_EIC_DBNC_MASK;
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_irq_set_type(data: *mut irq_data, flow_type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_handle_one_type(chip: *mut gpio_chip) {
    ...
    let mut offset: u32 = bank * SPRD_EIC_PER_BANK_NR + n;
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_irq_handler(desc: *mut irq_desc) {
...
//
    atomic_notifier_call_chain(&sprd_eic_irq_notifier, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_unregister_notifier(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sprd_eic_probe(pdev: *mut platform_device) -> c_int {
