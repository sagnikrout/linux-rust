...
//! Source: drivers/gpio/gpio-tegra.c
#![no_std]
...
pub const GPIO_INT_LVL_MASK: c_uint = 0x010101;
pub const GPIO_INT_LVL_EDGE_RISING: c_uint = 0x000101;
pub const GPIO_INT_LVL_EDGE_FALLING: c_uint = 0x000100;
pub const GPIO_INT_LVL_EDGE_BOTH: c_uint = 0x010100;
pub const GPIO_INT_LVL_LEVEL_HIGH: c_uint = 0x000001;
pub const GPIO_INT_LVL_LEVEL_LOW: c_uint = 0x000000;
...
// Lock for updating debounce count register
    pub dbc_lock: [spinlock_t; 4],    pub cnf: [u32; 4],
    pub out: [u32; 4],
    pub oe: [u32; 4],
    pub int_enb: [u32; 4],
    pub int_lvl: [u32; 4],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_gpio_soc_config {
    pub debounce_supported: bool,
    pub bank_stride: u32,
    pub upper_offset: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_gpio_info {
    pub dev: *mut device,
    pub regs: *mut void __iomem,
    pub bank_info: *mut tegra_gpio_bank,
    pub soc: *const tegra_gpio_soc_config,
    pub gc: gpio_chip,
    pub bank_count: u32,
    pub irqs: *mut c_uint,
}
...
#[no_mangle]
pub unsafe extern "C" fn tegra_gpio_readl(tgi: *mut tegra_gpio_info, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_enable(tgi: *mut tegra_gpio_info, gpio: c_uint) {
    static void tegra_gpio_enable(struct tegra_gpio_info *tgi, unsigned int gpio)
    {
    tegra_gpio_mask_write(tgi, GPIO_MSK_CNF(tgi, gpio), gpio, 1);
    }
#[no_mangle]
unsafe extern "C" fn tegra_gpio_disable(tgi: *mut tegra_gpio_info, gpio: c_uint) {
    static void tegra_gpio_disable(struct tegra_gpio_info *tgi, unsigned int gpio)
    {
    tegra_gpio_mask_write(tgi, GPIO_MSK_CNF(tgi, gpio), gpio, 0);
    }
#[no_mangle]
unsafe extern "C" fn tegra_gpio_free(chip: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    static int tegra_gpio_get(struct gpio_chip *chip, unsigned int offset)
    {
    struct tegra_gpio_info *tgi = gpiochip_get_data(chip);
    let mut bval: c_uint = BIT(GPIO_BIT(offset));
// If gpio is in output mode then read from the out value
    ...
    {
    struct tegra_gpio_info *tgi = gpiochip_get_data(chip);
    let mut pin_mask: u32 = BIT(GPIO_BIT(offset));
    u32 cnf, oe;
    ...
    let mut debounce_ms: c_uint = DIV_ROUND_UP(debounce, 1000);
    unsigned long flags;
    unsigned int port;
    if (!debounce_ms) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    static int tegra_gpio_irq_set_type(struct irq_data *d, unsigned int type)
    {
    let mut gpio: c_uint = d.hwirq, port = GPIO_PORT(gpio), lvl_type;
    struct gpio_chip *chip = irq_data_get_irq_chip_data(d);
    struct tegra_gpio_info *tgi = gpiochip_get_data(chip);
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_shutdown(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_handler(desc: *mut irq_desc) {
    ...
    struct tegra_gpio_bank *bank = core::ptr::null_mut();
    unsigned int port, pin, gpio, i;
    let mut unmasked: bool = false;
    unsigned long sta;
    u32 lvl;
    ...
    if (WARN_ON(bank == core::ptr::null_mut()))
    return;
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_set_wake(d: *mut irq_data, enable: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_request_resources(d: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_release_resources(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_irq_print_chip(d: *mut irq_data, s: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn tegra_dbg_gpio_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    for (i = 0; i < tgi.bank_count; i++) {
    for (j = 0; j < 4; j++) {
    let mut gpio: c_uint = tegra_gpio_compose(i, j, 0);
    seq_printf(s,
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_debuginit(tgi: *mut tegra_gpio_info) {
    static void tegra_gpio_debuginit(struct tegra_gpio_info *tgi)
    {
    debugfs_create_devm_seqfile(tgi.dev, "tegra_gpio", core::ptr::null_mut(),
    tegra_dbg_gpio_show);
    }

#[no_mangle]
pub unsafe extern "C" fn tegra_gpio_debuginit(tgi: *mut tegra_gpio_info) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gpio_probe(pdev: *mut platform_device) -> c_int {
    ...
    np = of_find_matching_node(core::ptr::null_mut(), tegra_pmc_of_match);
    if (np) {
    ...
    for (i = 0; i < tgi.bank_count; i++) {
    for (j = 0; j < 4; j++) {
    let mut gpio: c_int = tegra_gpio_compose(i, j, 0);
