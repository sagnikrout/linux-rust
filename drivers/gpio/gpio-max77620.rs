...
//! Source: drivers/gpio/gpio-max77620.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_gpio {
    pub gpio_chip: gpio_chip,
    pub rmap: *mut regmap,
    pub dev: *mut device,
    pub /: *mut *mut mutex buslock; / irq_bus_lock,
    pub irq_type: [c_uint; MAX77620_GPIO_NR],
    pub irq_enabled: [bool; MAX77620_GPIO_NR],
}

#[no_mangle]
unsafe extern "C" fn max77620_gpio_irqhandler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_set_irq_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_bus_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_bus_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_get_dir(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_dir_input(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_irq_init_hw(gc: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_gpio_probe(pdev: *mut platform_device) -> c_int {
...
// This will let us handle the parent IRQ in the driver
    ...
    ret = devm_request_threaded_irq(&pdev.dev, gpio_irq, core::ptr::null_mut(),
