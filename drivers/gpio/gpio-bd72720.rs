...
//! Source: drivers/gpio/gpio-bd72720.c
#![no_std]
...
pub const BD72720_GPIO_OPEN_DRAIN: c_int = 0;

pub const BD72720_INT_GPIO1_IN_SRC: c_int = 4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd72720_gpio {
// chip.parent points the MFD which provides DT node and regmap
    pub chip: gpio_chip,
// dev points to the platform device for devm and prints
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub gpio_is_input: c_int,
}

#[no_mangle]
unsafe extern "C" fn bd72720gpi_get(bdgpio: *mut bd72720_gpio, reg_offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd72720gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpo_bd72720_probe(pdev: *mut platform_device) -> c_int {
