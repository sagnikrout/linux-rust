...
//! Source: drivers/gpio/gpio-brcmstb.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmstb_gpio_bank {
    pub node: list_head,
    pub id: c_int,
    pub chip: gpio_generic_chip,
    pub parent_priv: *mut brcmstb_gpio_priv,
    pub width: u32,
    pub wake_active: u32,
    pub /: *mut *mut u32 saved_regs[GIO_REG_STAT]; / Don't save and restore GIO_REG_STAT,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmstb_gpio_priv {
    ...
    pub num_gpios: c_int,
    pub parent_wake_irq: c_int,
    pub suspended: bool,
}

pub const MAX_GPIO_PER_BANK: c_int = 32;
...
// assumes MAX_GPIO_PER_BANK is a multiple of 2
    ...
    let mut mask: u32 = BIT(brcmstb_gpio_hwirq_to_offset(hwirq, bank));
    u32 imask;
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_to_irq(gc: *mut gpio_chip, offset: unsigned) -> c_int {
    static int brcmstb_gpio_to_irq(struct gpio_chip *gc, unsigned offset)
    {
    struct brcmstb_gpio_priv *priv = brcmstb_gpio_gc_to_priv(gc);
// gc_offset is relative to this gpio_chip; want real offset
    let mut hwirq: c_int = offset + gc.offset;
...
// -------------------- IRQ chip functions --------------------
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_mask_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_ack(d: *mut irq_data) {
    static void brcmstb_gpio_irq_ack(struct irq_data *d)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
    struct brcmstb_gpio_bank *bank = gpiochip_get_data(gc);
    struct brcmstb_gpio_priv *priv = bank.parent_priv;
    let mut mask: u32 = BIT(brcmstb_gpio_hwirq_to_offset(irqd_to_hwirq(d), bank));
    gpio_generic_write_reg(&bank.chip,
    priv.reg_base + GIO_STAT(bank.id), mask);
    }
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_set_wake(d: *mut irq_data, enable: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_wake_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_bank_handler(bank: *mut brcmstb_gpio_bank) {
    static void brcmstb_gpio_irq_bank_handler(struct brcmstb_gpio_bank *bank)
    {
    struct brcmstb_gpio_priv *priv = bank.parent_priv;
    struct irq_domain *domain = priv.irq_domain;
    let mut hwbase: c_int = bank.chip.gc.offset;
    unsigned long status;
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_irq_unmap(d: *mut irq_domain, irq: c_uint) {
...
// Make sure that the number of banks matches up between properties
    ...
    {
    let mut res_num_banks: c_int = resource_size(res) / GIO_BANK_SIZE;
    int num_banks =
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_remove(pdev: *mut platform_device) {
    ...
    irq_set_chained_handler_and_data(priv.parent_irq, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_quiesce(priv: *mut brcmstb_gpio_priv, save: bool) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gpio_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct resource *res;
    u32 bank_width;
    let mut num_banks: c_int = 0;
    let mut num_gpios: c_int = 0;
    int err;
    let mut flags: c_ulong = 0;
    let mut need_wakeup_event: bool = false;
