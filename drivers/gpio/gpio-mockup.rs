...
//! Source: drivers/gpio/gpio-mockup.c
#![no_std]
...
pub const GPIO_MOCKUP_MAX_GC: c_int = 10;
//
...
pub const GPIO_MOCKUP_MAX_PROP: c_int = 5;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_mockup_line_status {
    pub dir: c_int,
    pub value: c_int,
    pub pull: c_int,
    pub requested: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_mockup_chip {
    pub gc: gpio_chip,
    pub lines: *mut gpio_mockup_line_status,
    pub irq_sim_domain: *mut irq_domain,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_mockup_dbgfs_private {
    pub chip: *mut gpio_mockup_chip,
    pub offset: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_range_base(index: c_uint) -> c_int {
    static int gpio_mockup_range_base(unsigned int index)
    {
    return gpio_mockup_ranges[index * 2];
    }
#[no_mangle]
unsafe extern "C" fn gpio_mockup_range_ngpio(index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_dirin(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_to_irq(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_request(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_free(gc: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_debugfs_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_debugfs_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_dispose_mappings(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_probe(pdev: *mut platform_device) -> c_int {
    ...
    chip.irq_sim_domain = devm_irq_domain_create_sim(dev, core::ptr::null_mut(),
    gc.ngpio);
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_unregister_pdevs() {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_register_chip(idx: c_int) -> int __init {
    ...
    struct platform_device *pdev;
    struct fwnode_handle *fwnode;
    char **line_names = core::ptr::null_mut();
    char chip_label[32];
    let mut prop: c_int = 0, base;
    u16 ngpio;
    ...
    fwnode = fwnode_create_software_node(properties, core::ptr::null_mut());
    if (IS_ERR(fwnode)) {
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_init() -> int __init {
...
//
    ...
    gpio_mockup_dbg_dir = debugfs_create_dir("gpio-mockup", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gpio_mockup_exit() -> void __exit {
