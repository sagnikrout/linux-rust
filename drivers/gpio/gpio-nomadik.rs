...
//! Source: drivers/gpio/gpio-nomadik.c
#![no_std]
...
// IRQ functions
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    static int nmk_gpio_irq_set_type(struct irq_data *d, unsigned int type)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
    struct nmk_gpio_chip *nmk_chip = gpiochip_get_data(gc);
    let mut enabled: bool = !irqd_irq_disabled(d);
    let mut wake: bool = irqd_is_wakeup_set(d);
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_startup(d: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_shutdown(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    let mut mask: c_ulong = GENMASK(chip.ngpio - 1, 0);
...
// I/O Functions
#[no_mangle]
unsafe extern "C" fn nmk_gpio_get_dir(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_make_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_get_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_get_mode(nmk_chip: *mut nmk_gpio_chip, offset: c_int) -> c_int {
...
// We don't support modes.
    ...
    let mut irq: c_int = chip.to_irq(chip, offset);
    let mut pullidx: c_int = pull ? 1 : 0;
    int val;
...
//
    ...
    trigger = "edge-rising";
#[no_mangle]
pub unsafe extern "C" fn if(BIT(offset): nmk_chip->edge_falling &) -> else {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
    static void nmk_gpio_dbg_show(struct seq_file *s, struct gpio_chip *chip)
    {
    unsigned int i;
    for (i = 0; i < chip.ngpio; i++) {
    nmk_gpio_dbg_show_one(s, core::ptr::null_mut(), chip, i);
    seq_puts(s, "\n");
    }
    }
...
// NOTE: do not use devm_ here!
    clk = clk_get_optional(gpio_dev, core::ptr::null_mut());
    if (IS_ERR(clk)) {
    ret = PTR_ERR(clk);
    ...
    nmk_chip.clk = clk;
// NOTE: do not use devm_ here!
    reset = reset_control_get_optional_shared(gpio_dev, core::ptr::null_mut());
    if (IS_ERR(reset)) {
    ret = PTR_ERR(reset);
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nmk_gpio_init() -> int __init {
