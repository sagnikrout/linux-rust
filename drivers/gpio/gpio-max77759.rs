...
//! Source: drivers/gpio/gpio-max77759.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77759_gpio_chip {
    pub map: *mut regmap,
    pub max77759: *mut max77759,
    pub gc: gpio_chip,
    pub /: *mut *mut mutex maxq_lock; / protect MaxQ r/m/w operations,
    pub /: *mut *mut mutex irq_lock; / protect irq bus,
    pub irq_mask: c_int,
    pub irq_mask_changed: c_int,
    pub irq_trig: c_int,
    pub irq_trig_changed: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_maxq_gpio_trigger_read(chip: *mut max77759_gpio_chip) -> c_int {
    ...
    cmd.cmd[1] = trigger;
    return max77759_maxq_command(chip.max77759, cmd, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn max77759_gpio_maxq_gpio_control_read(chip: *mut max77759_gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_get_value(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_set_irq_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_bus_sync_unlock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_irqhandler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max77759_gpio_probe(pdev: *mut platform_device) -> c_int {
