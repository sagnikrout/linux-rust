...
//! Source: drivers/gpio/gpio-74x164.c
#![no_std]
...
pub const GEN_74X164_NUMBER_GPIOS: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
...
//
    pub __counted_by(registers): u8 buffer[],
}

#[no_mangle]
unsafe extern "C" fn __gen_74x164_write_config(chip: *mut gen_74x164_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gen_74x164_get_value(gc: *mut gpio_chip, offset: unsigned) -> c_int {
    static int gen_74x164_get_value(struct gpio_chip *gc, unsigned offset)
    {
    struct gen_74x164_chip *chip = gpiochip_get_data(gc);
    let mut bank: u8 = chip.registers - 1 - offset / 8;
    let mut pin: u8 = offset % 8;
...
#[no_mangle]
unsafe extern "C" fn gen_74x164_activate(dev: *mut device, chip: *mut gen_74x164_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gen_74x164_probe(spi: *mut spi_device) -> c_int {
