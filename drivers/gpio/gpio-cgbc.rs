...
//! Source: drivers/gpio/gpio-cgbc.c
#![no_std]
...
pub const CGBC_GPIO_NGPIO: c_int = 14;
pub const CGBC_GPIO_CMD_GET: c_uint = 0x64;
pub const CGBC_GPIO_CMD_SET: c_uint = 0x65;
pub const CGBC_GPIO_CMD_DIR_GET: c_uint = 0x66;
pub const CGBC_GPIO_CMD_DIR_SET: c_uint = 0x67;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cgbc_gpio_data {
    pub chip: gpio_chip,
    ...
    return cgbc_command(cgbc, cmd, sizeof(cmd), value, 1, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn cgbc_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cgbc_gpio_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cgbc_gpio_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cgbc_gpio_probe(pdev: *mut platform_device) -> c_int {
