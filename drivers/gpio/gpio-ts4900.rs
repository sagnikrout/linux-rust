...
//! Source: drivers/gpio/gpio-ts4900.c
#![no_std]
...
pub const DEFAULT_PIN_NUMBER: c_int = 32;
//
// Register bits used by the GPIO device
// Some boards, such as TS-7970 do not have a separate input bit
//
pub const TS4900_GPIO_OE: c_uint = 0x01;
pub const TS4900_GPIO_OUT: c_uint = 0x02;
pub const TS4900_GPIO_IN: c_uint = 0x04;
pub const TS7970_GPIO_IN: c_uint = 0x02;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ts4900_gpio_priv {
    pub regmap: *mut regmap,
    pub gpio_chip: gpio_chip,
    pub input_bit: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ts4900_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ts4900_gpio_probe(client: *mut i2c_client) -> c_int {
