...
//! Source: drivers/gpio/gpio-aspeed.c
#![no_std]
...
pub const GPIO_G7_IRQ_STS_BASE: c_uint = 0x100;

pub const GPIO_G7_CTRL_REG_BASE: c_uint = 0x180;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_bank_props {
    pub bank: c_uint,
    pub input: u32,
    pub output: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_gpio_config {
    pub nr_gpios: c_uint,
    pub props: *const aspeed_bank_props,
    pub llops: *const aspeed_gpio_llops,
    pub debounce_timers_array: *const c_int,
    pub debounce_timers_num: c_int,
    pub require_dcache: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_gpio {
    pub chip: gpio_chip,
    pub dev: *mut device,
    pub lock: raw_spinlock_t,
    pub base: *mut void __iomem,
    pub irq: c_int,
    pub config: *const aspeed_gpio_config,
    pub offset_timer: *mut u8,
    pub timer_users: [c_uint; 4],
    pub clk: *mut clk,
    pub dcache: *mut u32,
    pub cf_copro_bankmap: *mut u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_gpio_bank {
    pub latch: *mut *mut uint16_t val_regs; / +0: Rd: read input value, Wr: set write,
// +4: Rd/Wr: Direction (0=in, 1=out)
//
    pub /: *mut *mut uint16_t rdata_reg; / Rd: read write latch, Wr: <none>,
    pub irq_regs: u16,
    pub debounce_regs: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_gpio_llops {
    void (*reg_bit_set)(struct aspeed_gpio *gpio, unsigned int offset,
    pub val): enum aspeed_gpio_reg reg, bool,
    bool (*reg_bit_get)(struct aspeed_gpio *gpio, unsigned int offset,
    pub reg): enum aspeed_gpio_reg,
    int (*reg_bank_get)(struct aspeed_gpio *gpio, unsigned int offset,
    pub reg): enum aspeed_gpio_reg,
    pub owner): *mut *mut *mut void (privilege_ctrl)(struct aspeed_gpio gpio, unsigned int offset, int,
    pub gpio): *mut *mut void (privilege_init)(struct aspeed_gpio,
    pub offset): *mut *mut *mut bool (copro_request)(struct aspeed_gpio gpio, unsigned int,
    pub offset): *mut *mut *mut void (copro_release)(struct aspeed_gpio gpio, unsigned int,
}

pub const GPIO_VAL_VALUE: c_uint = 0x00;
pub const GPIO_VAL_DIR: c_uint = 0x04;
...
pub const GPIO_DEBOUNCE_SEL1: c_uint = 0x00;
pub const GPIO_DEBOUNCE_SEL2: c_uint = 0x04;
pub const GPIO_CMDSRC_0: c_uint = 0x00;
pub const GPIO_CMDSRC_1: c_uint = 0x04;
pub const GPIO_CMDSRC_ARM: c_int = 0;
pub const GPIO_CMDSRC_LPC: c_int = 1;
pub const GPIO_CMDSRC_COLDFIRE: c_int = 2;
pub const GPIO_CMDSRC_RESERVED: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_g7_reg_mask(reg: enum aspeed_gpio_reg) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn is_bank_props_sentinel(props: *const aspeed_bank_props) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn have_gpio(gpio: *mut aspeed_gpio, offset: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn have_input(gpio: *mut aspeed_gpio, offset: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn have_output(gpio: *mut aspeed_gpio, offset: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_change_cmd_source(gpio: *mut aspeed_gpio, offset: c_uint, cmdsrc: c_int) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_support_copro(gpio: *mut aspeed_gpio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_set(gc: *mut gpio_chip, offset: c_uint, val: c_int) -> c_int {
    static int aspeed_gpio_set(struct gpio_chip *gc, unsigned int offset, int val)
    {
    struct aspeed_gpio *gpio = gpiochip_get_data(gc);
    let mut copro: bool = false;
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_dir_in(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_irq_set_mask(d: *mut irq_data, set: bool) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_irq_mask(d: *mut irq_data) {
    static void aspeed_gpio_irq_mask(struct irq_data *d)
    {
    aspeed_gpio_irq_set_mask(d, false);
    }
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_irq_unmask(d: *mut irq_data) {
    static void aspeed_gpio_irq_unmask(struct irq_data *d)
    {
    aspeed_gpio_irq_set_mask(d, true);
    }
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_irq_handler(desc: *mut irq_desc) {
    ...
    while (!is_bank_props_sentinel(props)) {
    unsigned int offset;
    let mut input: c_ulong = props.input;
// Pretty crummy approach, but similar to GPIO core
    for_each_clear_bit(offset, &input, 32) {
    let mut i: c_uint = props.bank * 32 + offset;
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_free(chip: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn disable_debounce(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
// Return -ENOTSUPP to trigger emulation, as per datasheet
    return -ENOTSUPP;
#[no_mangle]
pub unsafe extern "C" fn if(PIN_CONFIG_PERSIST_STATE: param ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn aspeed_gpio_copro_set_ops(ops: *const aspeed_gpio_copro_ops, data: *mut c_void) -> c_int {
...
//
    ...
    struct aspeed_gpio *gpio = gpiochip_get_data(chip);
    let mut rc: c_int = 0, bindex, offset = gpiod_hwgpio(desc);
...
//
#[no_mangle]
pub unsafe extern "C" fn aspeed_gpio_copro_release_gpio(desc: *mut gpio_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g4_privilege_ctrl(gpio: *mut aspeed_gpio, offset: c_uint, cmdsrc: c_int) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g4_privilege_init(gpio: *mut aspeed_gpio) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g4_copro_request(gpio: *mut aspeed_gpio, offset: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g4_copro_release(gpio: *mut aspeed_gpio, offset: c_uint) {
...
// Restart the coprocessor
    ...
    const enum aspeed_gpio_reg reg, bool val)
    {
    let mut mask: u32 = aspeed_gpio_g7_reg_mask(reg);
    ...
    .privilege_ctrl = core::ptr::null_mut(),
    .privilege_init = core::ptr::null_mut(),
    .copro_request = core::ptr::null_mut(),
    .copro_release = core::ptr::null_mut(),
    };
//
...
#[no_mangle]
unsafe extern "C" fn aspeed_gpio_probe(pdev: *mut platform_device) -> c_int {
