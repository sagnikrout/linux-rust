...
//! Source: drivers/gpio/gpio-stp-xway.c
#![no_std]
...
//
// control register 0
pub const XWAY_STP_CON0: c_uint = 0x00;
// control register 1
pub const XWAY_STP_CON1: c_uint = 0x04;
// data register 0
pub const XWAY_STP_CPU0: c_uint = 0x08;
// data register 1
pub const XWAY_STP_CPU1: c_uint = 0x0C;
// access register
pub const XWAY_STP_AR: c_uint = 0x10;
// software or hardware update select bit

// automatic update rates
pub const XWAY_STP_2HZ: c_int = 0;

// clock source for automatic update

// let the adsl core drive the 2 LSBs
pub const XWAY_STP_ADSL_SHIFT: c_int = 24;
pub const XWAY_STP_ADSL_MASK: c_uint = 0x3;
// 2 groups of 3 bits can be driven by the phys
pub const XWAY_STP_PHY_MASK: c_uint = 0x7;
pub const XWAY_STP_PHY1_SHIFT: c_int = 27;
pub const XWAY_STP_PHY2_SHIFT: c_int = 3;
pub const XWAY_STP_PHY3_SHIFT: c_int = 6;
pub const XWAY_STP_PHY4_SHIFT: c_int = 15;
...
pub struct xway_stp {
    ...
    pub /: *mut *mut u32 edge; / rising or falling edge triggered shift register,
    pub /: *mut *mut u32 shadow; / shadow the shift registers state,
    pub /: *mut *mut u8 groups; / we can drive 1-3 groups of 8bit each,
    pub /: *mut *mut u8 dsl; / the 2 LSBs can be driven by the dsl core,
    pub /: *mut *mut u8 phy1; / 3 bits can be driven by phy1,
    pub /: *mut *mut u8 phy2; / 3 bits can be driven by phy2,
    pub /: *mut *mut u8 phy3; / 3 bits can be driven by phy3,
    pub /: *mut *mut u8 phy4; / 3 bits can be driven by phy4,
    pub /: *mut *mut u8 reserved; / mask out the hw driven bits in gpio_request,
}
...
//
#[no_mangle]
unsafe extern "C" fn xway_stp_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xway_stp_set(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xway_stp_dir_out(gc: *mut gpio_chip, gpio: unsigned, val: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xway_stp_request(gc: *mut gpio_chip, gpio: unsigned) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xway_stp_hw_init(chip: *mut xway_stp) {
...
#[no_mangle]
unsafe extern "C" fn xway_stp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xway_stp_init() -> int __init {
