...
//! Source: drivers/gpio/gpio-zevio.c
#![no_std]
...
// 0xC0-0xFF: Section 3
//
pub const ZEVIO_GPIO_SECTION_SIZE: c_uint = 0x40;
// Offsets to various registers
pub const ZEVIO_GPIO_INT_MASKED_STATUS: c_uint = 0x00;
pub const ZEVIO_GPIO_INT_STATUS: c_uint = 0x04;
pub const ZEVIO_GPIO_INT_UNMASK: c_uint = 0x08;
pub const ZEVIO_GPIO_INT_MASK: c_uint = 0x0C;
pub const ZEVIO_GPIO_DIRECTION: c_uint = 0x10;
pub const ZEVIO_GPIO_OUTPUT: c_uint = 0x14;
pub const ZEVIO_GPIO_INPUT: c_uint = 0x18;
pub const ZEVIO_GPIO_INT_STICKY: c_uint = 0x20;
// Bit number of GPIO in its section

#[repr(C)]
#[derive(Copy, Clone)]
pub struct zevio_gpio {
    pub chip: gpio_chip,
    pub lock: spinlock_t,
    ...
    {
    let mut section_offset: unsigned = ((pin >> 3) & 3)*ZEVIO_GPIO_SECTION_SIZE;
...
#[no_mangle]
unsafe extern "C" fn zevio_gpio_get(chip: *mut gpio_chip, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zevio_gpio_set(chip: *mut gpio_chip, pin: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zevio_gpio_direction_input(chip: *mut gpio_chip, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zevio_gpio_to_irq(chip: *mut gpio_chip, pin: unsigned) -> c_int {
...
// Initialization
#[no_mangle]
unsafe extern "C" fn zevio_gpio_probe(pdev: *mut platform_device) -> c_int {
