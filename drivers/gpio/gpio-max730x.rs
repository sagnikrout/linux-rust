...
//! Source: drivers/gpio/gpio-max730x.c
#![no_std]
...
pub const PIN_NUMBER: c_int = 28;
#[no_mangle]
unsafe extern "C" fn max7301_direction_input(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __max7301_set(ts: *mut max7301, offset: unsigned, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max7301_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max7301_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __max730x_probe(ts: *mut max7301) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __max730x_remove(dev: *mut device) {
