...
//! Source: drivers/gpio/gpio-cros-ec.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cros_ec_gpio_set(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
    ...
    sizeof(params), core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_gpio_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_gpio_get_direction(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_gpio_init_names(cros_ec: *mut cros_ec_device, gc: *mut gpio_chip) -> c_int {
...
// EC may not NUL terminate
    let mut name_len: usize = strlen(cros_ec_gpio_prefix) + sizeof(response.get_info.name) + 1;
    ssize_t copied;
    const char **names;
    char *str;
...
#[no_mangle]
unsafe extern "C" fn cros_ec_gpio_ngpios(cros_ec: *mut cros_ec_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_gpio_probe(pdev: *mut platform_device) -> c_int {
