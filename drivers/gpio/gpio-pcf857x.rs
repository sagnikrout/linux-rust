...
//! Source: drivers/gpio/gpio-pcf857x.c
#![no_std]
...
pub struct pcf857x {
    ...
    pub /: *mut *mut mutex lock; / protect 'out',
    pub /: *mut *mut unsigned int out; / software latch,
    pub /: *mut *mut unsigned int status; / current status,
    pub /: *mut *mut unsigned int irq_enabled; / enabled irqs,
    pub data): *mut *mut *mut int (write)(struct i2c_client client, unsigned int,
    pub client): *mut *mut int (read)(struct i2c_client,
}
...
unsafe extern "C" fn i2c_write_le16(client: *mut i2c_client, word: c_uint) -> c_int {
    ...
    {
    let mut buf: __le16 = cpu_to_le16(word);
    int status;
...
unsafe extern "C" fn pcf857x_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    {
    struct pcf857x *gpio = gpiochip_get_data(chip);
    let mut value: c_int = gpio.read(gpio.client);
    if (value < 0)
    return value;
// bits &= ~*mask;
// bits |= value & *mask;
...
#[no_mangle]
unsafe extern "C" fn pcf857x_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf857x_irq_bus_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pcf857x_irq_bus_sync_unlock(data: *mut irq_data) {
...
// Enable irqchip if we have an interrupt
    ...
    core::ptr::null_mut(), pcf857x_irq, IRQF_ONESHOT |
...
#[no_mangle]
unsafe extern "C" fn pcf857x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pcf857x_exit() -> void __exit {
