...
//! Source: drivers/bcma/driver_pci_host.c
#![no_std]
...
pub const BCMA_PCI_SLOT_MAX: c_int = 16;
pub const PCI_CONFIG_SPACE_SIZE: c_int = 256;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn bcma_pcie_read_config(pc: *mut bcma_drv_pci, address: u32) -> u32 {
...
// ((u32 *)buf) = (u32)val;
    ...
    u32 addr, val;
    void __iomem *mmio = 0;
    let mut chipid: u16 = pc.core.bus.chipinfo.id;
    WARN_ON(!pc.hostmode);
    if (unlikely(len != 1 && len != 2 && len != 4))
    goto out;
    if (dev == 0) {
...
// found the caller requested capability
    if ((buf != core::ptr::null_mut()) && (buflen != core::ptr::null_mut())) {
    u8 cap_data;
    bufsize = *buflen;
    if (!bufsize)
    return cap_ptr;
...
//
#[no_mangle]
unsafe extern "C" fn bcma_core_pci_enable_crs(pc: *mut bcma_drv_pci) {
    ...
    u16 val16;
    int i;
    cap_ptr = bcma_find_pci_capability(pc, 0, 0, PCI_CAP_ID_EXP, core::ptr::null_mut(),
    core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn bcma_core_pci_fixup_pcibridge(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bcma_core_pci_fixup_addresses(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_core_pci_plat_dev_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_core_pci_pcibios_map_irq(dev: *const pci_dev) -> c_int {
