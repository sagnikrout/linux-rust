...
//! Source: drivers/bcma/driver_pcie2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bcma_core_pcie2_cfg_read(pcie2: *mut bcma_drv_pcie2, addr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bcma_core_pcie2_set_ltr_vals(pcie2: *mut bcma_drv_pcie2) {
...
#[no_mangle]
unsafe extern "C" fn bcma_core_pcie2_hw_ltr_war(pcie2: *mut bcma_drv_pcie2) {
    static void bcma_core_pcie2_hw_ltr_war(struct bcma_drv_pcie2 *pcie2)
    {
    let mut core_rev: u8 = pcie2.core.id.rev;
    u32 devstsctr2;
...
#[no_mangle]
unsafe extern "C" fn pciedev_crwlpciegen2(pcie2: *mut bcma_drv_pcie2) {
...
#[no_mangle]
unsafe extern "C" fn pciedev_crwlpciegen2_180(pcie2: *mut bcma_drv_pcie2) {
...
#[no_mangle]
unsafe extern "C" fn pciedev_crwlpciegen2_182(pcie2: *mut bcma_drv_pcie2) {
...
#[no_mangle]
unsafe extern "C" fn pciedev_reg_pm_clk_period(pcie2: *mut bcma_drv_pcie2) {
