...
//! Source: drivers/bcma/driver_chipcommon_pmu.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn bcma_chipco_pll_read(cc: *mut bcma_drv_cc, offset: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_chipco_pll_write(cc: *mut bcma_drv_cc, offset: u32, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn bcma_pmu_xtalfreq(cc: *mut bcma_drv_cc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bcma_pmu2_pll_init0(cc: *mut bcma_drv_cc, xtalfreq: u32) {
    static void bcma_pmu2_pll_init0(struct bcma_drv_cc *cc, u32 xtalfreq)
    {
    struct bcma_bus *bus = cc.core.bus;
    let mut freq_tgt_target: u32 = 0, freq_tgt_current;
    u32 pll0, mask;
...
#[no_mangle]
unsafe extern "C" fn bcma_pmu_pll_init(cc: *mut bcma_drv_cc) {
    static void bcma_pmu_pll_init(struct bcma_drv_cc *cc)
    {
    struct bcma_bus *bus = cc.core.bus;
    let mut xtalfreq: u32 = bcma_pmu_xtalfreq(cc);
    switch (bus.chipinfo.id) {
    case BCMA_CHIP_ID_BCM43142:
    if (xtalfreq == 0)
    xtalfreq = 20000;
...
#[no_mangle]
unsafe extern "C" fn bcma_pmu_resources_init(cc: *mut bcma_drv_cc) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: bus->chipinfo.rev >) -> else {
...
#[no_mangle]
unsafe extern "C" fn bcma_pmu_workarounds(cc: *mut bcma_drv_cc) {
...
//
#[no_mangle]
unsafe extern "C" fn bcma_pmu_pll_clock(cc: *mut bcma_drv_cc, pll0: u32, m: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bcma_pmu_pll_clock_bcm4706(cc: *mut bcma_drv_cc, pll0: u32, m: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_pmu_get_bus_clock(cc: *mut bcma_drv_cc) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_pmu_spuravoid_pllupdate(cc: *mut bcma_drv_cc, spuravoid: c_int) {
    void bcma_pmu_spuravoid_pllupdate(struct bcma_drv_cc *cc, int spuravoid)
    {
    let mut tmp: u32 = 0;
    let mut phypll_offset: u8 = 0;
