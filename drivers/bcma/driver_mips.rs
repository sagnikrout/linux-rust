...
//! Source: drivers/bcma/driver_mips.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn bcma_core_mips_bcm47162a0_quirk(dev: *mut bcma_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_core_mips_bcm5357b0_quirk(dev: *mut bcma_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bcma_core_mips_irqflag(dev: *mut bcma_device) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn bcma_core_mips_irq(dev: *mut bcma_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn bcma_core_mips_set_irq(dev: *mut bcma_device, irq: c_uint) {
    static void bcma_core_mips_set_irq(struct bcma_device *dev, unsigned int irq)
    {
    let mut oldirq: c_uint = bcma_core_mips_irq(dev);
...
#[no_mangle]
unsafe extern "C" fn bcma_core_mips_print_irq(dev: *mut bcma_device, irq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn bcma_core_mips_dump_irq(bus: *mut bcma_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_cpu_clock(mcore: *mut bcma_drv_mips) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bcma_boot_dev(bus: *mut bcma_bus) -> enum bcma_boot_dev {
    static enum bcma_boot_dev bcma_boot_dev(struct bcma_bus *bus)
    {
    struct bcma_drv_cc *cc = &bus.drv_cc;
    let mut cc_rev: u8 = cc.core.id.rev;
    if (cc_rev == 42) {
    struct bcma_device *core;
    ...
    return BCMA_BOOT_DEV_NAND;
#[no_mangle]
pub unsafe extern "C" fn if(BIT(5): cc->status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn bcma_core_mips_nvram_init(mcore: *mut bcma_drv_mips) {
...
#[no_mangle]
unsafe extern "C" fn bcma_fix_i2s_irqflag(bus: *mut bcma_bus) {
