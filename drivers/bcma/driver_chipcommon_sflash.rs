...
//! Source: drivers/bcma/driver_chipcommon_sflash.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bcma_sflash_cmd(cc: *mut bcma_drv_cc, opcode: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn bcma_sflash_init(cc: *mut bcma_drv_cc) -> c_int {
