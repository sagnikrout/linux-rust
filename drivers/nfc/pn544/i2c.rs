...
//! Source: drivers/nfc/pn544/i2c.c
#![no_std]
...
pub const PN544_I2C_FRAME_HEADROOM: c_int = 1;
pub const PN544_I2C_FRAME_TAILROOM: c_int = 2;
// GPIO names

// framing in HCI mode
pub const PN544_HCI_I2C_LLC_LEN: c_int = 1;
pub const PN544_HCI_I2C_LLC_CRC: c_int = 2;

    PN544_HCI_I2C_LLC_CRC)

pub const PN544_HCI_I2C_LLC_MAX_PAYLOAD: c_int = 29;
...
// SW RomLib.
//
pub const PN544_HW_VARIANT_C2: c_uint = 0xa;
pub const PN544_HW_VARIANT_C3: c_uint = 0xb;
pub const PN544_FW_CMD_RESET: c_uint = 0x01;
pub const PN544_FW_CMD_WRITE: c_uint = 0x08;
pub const PN544_FW_CMD_CHECK: c_uint = 0x06;
pub const PN544_FW_CMD_SECURE_WRITE: c_uint = 0x0C;
pub const PN544_FW_CMD_SECURE_CHUNK_WRITE: c_uint = 0x0D;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pn544_i2c_fw_frame_write {
    pub cmd: u8,
    pub be_length: u16,
    pub be_dest_addr: [u8; 3],
    pub be_datalen: u16,
    pub data: [u8; ],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pn544_i2c_fw_frame_check {
    pub cmd: u8,
    pub be_length: u16,
    pub be_start_addr: [u8; 3],
    pub be_datalen: u16,
    pub be_crc: u16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pn544_i2c_fw_frame_response {
    pub status: u8,
    pub be_length: u16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pn544_i2c_fw_blob {
    pub be_size: u32,
    pub be_destaddr: u32,
    pub data: [u8; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pn544_i2c_fw_secure_frame {
    pub cmd: u8,
    pub be_datalen: u16,
    pub data: [u8; ],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pn544_i2c_fw_secure_blob {
    pub header: u64,
    pub data: [u8; ],
}

pub const PN544_FW_CMD_RESULT_TIMEOUT: c_uint = 0x01;
pub const PN544_FW_CMD_RESULT_BAD_CRC: c_uint = 0x02;
pub const PN544_FW_CMD_RESULT_ACCESS_DENIED: c_uint = 0x08;
pub const PN544_FW_CMD_RESULT_PROTOCOL_ERROR: c_uint = 0x0B;
pub const PN544_FW_CMD_RESULT_INVALID_PARAMETER: c_uint = 0x11;
pub const PN544_FW_CMD_RESULT_UNSUPPORTED_COMMAND: c_uint = 0x13;
pub const PN544_FW_CMD_RESULT_INVALID_LENGTH: c_uint = 0x18;
pub const PN544_FW_CMD_RESULT_CRYPTOGRAPHIC_ERROR: c_uint = 0x19;
pub const PN544_FW_CMD_RESULT_VERSION_CONDITIONS_ERROR: c_uint = 0x1D;
pub const PN544_FW_CMD_RESULT_MEMORY_ERROR: c_uint = 0x20;
pub const PN544_FW_CMD_RESULT_CHUNK_OK: c_uint = 0x21;
pub const PN544_FW_CMD_RESULT_WRITE_FAILED: c_uint = 0x74;
pub const PN544_FW_CMD_RESULT_COMMAND_REJECTED: c_uint = 0xE0;
pub const PN544_FW_CMD_RESULT_CHUNK_ERROR: c_uint = 0xE6;
pub const PN544_FW_WRITE_BUFFER_MAX_LEN: c_uint = 0x9f7;

pub const PN544_FW_I2C_WRITE_FRAME_HEADER_LEN: c_int = 8;

    PN544_FW_I2C_WRITE_FRAME_HEADER_LEN),\
    PN544_FW_WRITE_BUFFER_MAX_LEN)
pub const PN544_FW_SECURE_CHUNK_WRITE_HEADER_LEN: c_int = 3;

    PN544_FW_SECURE_CHUNK_WRITE_HEADER_LEN)
pub const PN544_FW_SECURE_FRAME_HEADER_LEN: c_int = 3;
pub const PN544_FW_SECURE_BLOB_HEADER_LEN: c_int = 8;
pub const FW_WORK_STATE_IDLE: c_int = 1;
pub const FW_WORK_STATE_START: c_int = 2;
pub const FW_WORK_STATE_WAIT_WRITE_ANSWER: c_int = 3;
pub const FW_WORK_STATE_WAIT_CHECK_ANSWER: c_int = 4;
pub const FW_WORK_STATE_WAIT_SECURE_WRITE_ANSWER: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pn544_i2c_phy {
    pub i2c_dev: *mut i2c_client,
    pub hdev: *mut nfc_hci_dev,
    pub gpiod_en: *mut gpio_desc,
    pub gpiod_fw: *mut gpio_desc,
    pub en_polarity: c_uint,
    pub hw_variant: u8,
    pub fw_work: work_struct,
    pub fw_work_state: c_int,
    pub 1]: char firmware_name[NFC_FIRMWARE_NAME_MAXSIZE +,
    pub fw: *const firmware,
    pub fw_blob_dest_addr: u32,
    pub fw_blob_size: usize,
    pub fw_blob_data: *const u8,
    pub fw_written: usize,
    pub fw_size: usize,
    pub fw_cmd_result: c_int,
    pub powered: c_int,
    pub run_mode: c_int,
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_platform_init(phy: *mut pn544_i2c_phy) {
    static void pn544_hci_i2c_platform_init(struct pn544_i2c_phy *phy)
    {
    int polarity, retry, ret;
    static const char rset_cmd[] = { 0x05, 0xF9, 0x04, 0x00, 0xC3, 0xE5 };
    let mut count: c_int = sizeof(rset_cmd);
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_enable_mode(phy: *mut pn544_i2c_phy, run_mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_enable(phy_id: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_disable(phy_id: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_add_len_crc(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_remove_len_crc(skb: *mut sk_buff) {
...
//
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_write(phy_id: *mut c_void, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_read(phy: *mut pn544_i2c_phy, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_fw_read_status(phy: *mut pn544_i2c_phy) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_irq_thread_fn(irq: c_int, phy_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_fw_write_chunk(phy: *mut pn544_i2c_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_fw_secure_write_frame(phy: *mut pn544_i2c_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_fw_work(work: *mut work_struct) {
    ...
    let mut firmware_gpios: static struct acpi_gpio_params = { 2, 0, false };
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn544_hci_i2c_remove(client: *mut i2c_client) {
