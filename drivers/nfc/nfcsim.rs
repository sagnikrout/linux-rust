...
pub const NFCSIM_MODE_NONE: c_int = 0;
pub const NFCSIM_MODE_INITIATOR: c_int = 1;
pub const NFCSIM_MODE_TARGET: c_int = 2;
...
pub struct nfcsim {
    ...
    pub send_work: delayed_work,
    pub link_in: *mut nfcsim_link,
    pub link_out: *mut nfcsim_link,
    pub up: bool,
    pub mode: u8,
    pub rf_tech: u8,
...
#[no_mangle]
unsafe extern "C" fn nfcsim_link_free(link: *mut nfcsim_link) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_link_recv_wake(link: *mut nfcsim_link) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_link_recv_cancel(link: *mut nfcsim_link) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_link_shutdown(link: *mut nfcsim_link) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_send_wq(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_recv_wq(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_abort_cmd(ddev: *mut nfc_digital_dev) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_switch_rf(ddev: *mut nfc_digital_dev, on: bool) -> c_int {
    ...
    nfc_digital_cmd_complete_t cb, void *arg)
    {
    return nfcsim_send(ddev, core::ptr::null_mut(), timeout, cb, arg);
    }
...
#[no_mangle]
unsafe extern "C" fn nfcsim_debugfs_init() {
    static void nfcsim_debugfs_init(void)
    {
    nfcsim_debugfs_root = debugfs_create_dir("nfcsim", core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn nfcsim_debugfs_remove() {
    static void nfcsim_debugfs_remove(void)
    {
    debugfs_remove_recursive(nfcsim_debugfs_root);
    }
#[no_mangle]
unsafe extern "C" fn nfcsim_debugfs_init_dev(dev: *mut nfcsim) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_device_free(dev: *mut nfcsim) {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nfcsim_exit() -> void __exit {
