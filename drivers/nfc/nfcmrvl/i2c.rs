...
//! Source: drivers/nfc/nfcmrvl/i2c.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nfcmrvl_i2c_drv_data {
    pub flags: c_ulong,
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn nfcmrvl_i2c_int_irq_thread_fn(irq: c_int, drv_data_ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nfcmrvl_i2c_nci_open(priv: *mut nfcmrvl_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfcmrvl_i2c_nci_close(priv: *mut nfcmrvl_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfcmrvl_i2c_probe(client: *mut i2c_client) -> c_int {
...
// Request the read IRQ
    ...
    core::ptr::null_mut(), nfcmrvl_i2c_int_irq_thread_fn,
...
#[no_mangle]
unsafe extern "C" fn nfcmrvl_i2c_remove(client: *mut i2c_client) {
