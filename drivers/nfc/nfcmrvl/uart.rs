...
//! Source: drivers/nfc/nfcmrvl/uart.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn nfcmrvl_uart_nci_open(priv: *mut nfcmrvl_private) -> c_int {
    static int nfcmrvl_uart_nci_open(struct nfcmrvl_private *priv)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn nfcmrvl_uart_nci_close(priv: *mut nfcmrvl_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nfcmrvl_nci_uart_open(nu: *mut nci_uart) -> c_int {
    static int nfcmrvl_nci_uart_open(struct nci_uart *nu)
    {
    struct nfcmrvl_private *priv;
    struct nfcmrvl_platform_data config;
    const struct nfcmrvl_platform_data *pdata = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nfcmrvl_nci_uart_close(nu: *mut nci_uart) {
    static void nfcmrvl_nci_uart_close(struct nci_uart *nu)
    {
    nfcmrvl_nci_unregister_dev((struct nfcmrvl_private *)nu.drv_data);
    }
#[no_mangle]
unsafe extern "C" fn nfcmrvl_nci_uart_recv(nu: *mut nci_uart, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nfcmrvl_nci_uart_tx_start(nu: *mut nci_uart) {
...
#[no_mangle]
unsafe extern "C" fn nfcmrvl_nci_uart_tx_done(nu: *mut nci_uart) {
