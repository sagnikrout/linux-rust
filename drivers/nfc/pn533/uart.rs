...
//! Source: drivers/nfc/pn533/uart.c
#![no_std]
...
// no-op to the chip.
//
    pub send_wakeup: enum send_wakeup,
    pub cmd_timeout: timer_list,
    pub cur_out_buf: *mut sk_buff,
}
...
#[no_mangle]
unsafe extern "C" fn pn532_uart_send_ack(dev: *mut pn533, flags: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn532_uart_abort_cmd(dev: *mut pn533, flags: gfp_t) {
    static void pn532_uart_abort_cmd(struct pn533 *dev, gfp_t flags)
    {
// An ack will cancel the last issued command
    pn532_uart_send_ack(dev, flags);
// schedule cmd_complete_work to finish current command execution
    pn533_recv_frame(dev, core::ptr::null_mut(), -ENOENT);
    }
#[no_mangle]
unsafe extern "C" fn pn532_dev_up(dev: *mut pn533) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn532_dev_down(dev: *mut pn533) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pn532_cmd_timeout(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn pn532_uart_rx_is_frame(skb: *mut sk_buff) -> c_int {
...
// frame type
    ...
    dev.recv_skb = core::ptr::null_mut();
    }
    return i;
    }
...
#[no_mangle]
unsafe extern "C" fn pn532_uart_probe(serdev: *mut serdev_device) -> c_int {
    ...
    pn532, &uart_phy_ops, core::ptr::null_mut(),
    &pn532.serdev.dev);
    if (IS_ERR(priv)) {
    err = PTR_ERR(priv);
    goto err_serdev;
...
#[no_mangle]
unsafe extern "C" fn pn532_uart_remove(serdev: *mut serdev_device) {
