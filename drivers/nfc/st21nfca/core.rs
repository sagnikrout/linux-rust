...
//! Source: drivers/nfc/st21nfca/core.c
#![no_std]
...
pub const FULL_VERSION_LEN: c_int = 3;
// Proprietary gates, events, commands and registers
// Commands that apply to all RF readers
pub const ST21NFCA_RF_READER_CMD_PRESENCE_CHECK: c_uint = 0x30;
pub const ST21NFCA_RF_READER_ISO15693_GATE: c_uint = 0x12;
pub const ST21NFCA_RF_READER_ISO15693_INVENTORY: c_uint = 0x01;
//
// Reader gate for communication with contact-less cards using Type A
// protocol ISO14443-3 but not compliant with ISO14443-4
//
pub const ST21NFCA_RF_READER_14443_3_A_GATE: c_uint = 0x15;
pub const ST21NFCA_RF_READER_14443_3_A_UID: c_uint = 0x02;
pub const ST21NFCA_RF_READER_14443_3_A_ATQA: c_uint = 0x03;
pub const ST21NFCA_RF_READER_14443_3_A_SAK: c_uint = 0x04;
pub const ST21NFCA_RF_READER_F_DATARATE: c_uint = 0x01;
pub const ST21NFCA_RF_READER_F_DATARATE_106: c_uint = 0x01;
pub const ST21NFCA_RF_READER_F_DATARATE_212: c_uint = 0x02;
pub const ST21NFCA_RF_READER_F_DATARATE_424: c_uint = 0x04;
pub const ST21NFCA_RF_READER_F_POL_REQ: c_uint = 0x02;
pub const ST21NFCA_RF_READER_F_POL_REQ_DEFAULT: c_uint = 0xffff0000;
pub const ST21NFCA_RF_READER_F_NFCID2: c_uint = 0x03;
pub const ST21NFCA_RF_READER_F_NFCID1: c_uint = 0x04;
pub const ST21NFCA_RF_CARD_F_MODE: c_uint = 0x01;
pub const ST21NFCA_RF_CARD_F_NFCID2_LIST: c_uint = 0x04;
pub const ST21NFCA_RF_CARD_F_NFCID1: c_uint = 0x05;
pub const ST21NFCA_RF_CARD_F_SENS_RES: c_uint = 0x06;
pub const ST21NFCA_RF_CARD_F_SEL_RES: c_uint = 0x07;
pub const ST21NFCA_RF_CARD_F_DATARATE: c_uint = 0x08;
pub const ST21NFCA_RF_CARD_F_DATARATE_212_424: c_uint = 0x01;
pub const ST21NFCA_DEVICE_MGNT_PIPE: c_uint = 0x02;
pub const ST21NFCA_DM_GETINFO: c_uint = 0x13;
pub const ST21NFCA_DM_GETINFO_PIPE_LIST: c_uint = 0x02;
pub const ST21NFCA_DM_GETINFO_PIPE_INFO: c_uint = 0x01;
pub const ST21NFCA_DM_PIPE_CREATED: c_uint = 0x02;
pub const ST21NFCA_DM_PIPE_OPEN: c_uint = 0x04;
pub const ST21NFCA_DM_RF_ACTIVE: c_uint = 0x80;
pub const ST21NFCA_DM_DISCONNECT: c_uint = 0x30;

    ((p & 0x0f) == (ST21NFCA_DM_PIPE_CREATED | ST21NFCA_DM_PIPE_OPEN))
pub const ST21NFCA_NFC_MODE: c_uint = 0x03	/* NFC_MODE parameter*/;
pub const ST21NFCA_EVT_HOT_PLUG: c_uint = 0x03;

pub const ST21NFCA_SE_TO_PIPES: c_int = 2000;
...
pub const ST21NFCA_CMDS_HEADROOM: c_int = 7;
#[no_mangle]
unsafe extern "C" fn st21nfca_hci_load_session(hdev: *mut nfc_hci_dev) -> c_int {
    static int st21nfca_hci_load_session(struct nfc_hci_dev *hdev)
    {
    pub r: int i, j,,
    pub skb_pipe_info: *mut *mut sk_buff skb_pipe_list,,
    pub info: *mut st21nfca_pipe_info,
...
#[no_mangle]
unsafe extern "C" fn st21nfca_hci_open(hdev: *mut nfc_hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st21nfca_hci_close(hdev: *mut nfc_hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn st21nfca_hci_ready(hdev: *mut nfc_hci_dev) -> c_int {
...
// Set NFC_MODE in device management gate to enable
    ...
    NFC_HCI_EVT_END_OPERATION, core::ptr::null_mut(), 0);
    if (r < 0)
    return r;
...
#[no_mangle]
unsafe extern "C" fn st21nfca_hci_xmit(hdev: *mut nfc_hci_dev, skb: *mut sk_buff) -> c_int {
...
//
    ...
    &hdev.gb_len);
    if (hdev.gb == core::ptr::null_mut() || hdev.gb_len == 0) {
    ...
    r = nfc_hci_send_event(hdev, NFC_HCI_RF_READER_A_GATE,
    NFC_HCI_EVT_READER_REQUESTED, core::ptr::null_mut(), 0);
    if (r < 0)
...
// Configure NFCID1 Random uid
    r = nfc_hci_set_param(hdev, ST21NFCA_RF_CARD_F_GATE,
    ST21NFCA_RF_CARD_F_NFCID1, core::ptr::null_mut(), 0);
    if (r < 0)
    return r;
...
#[no_mangle]
unsafe extern "C" fn st21nfca_hci_stop_poll(hdev: *mut nfc_hci_dev) {
    static void st21nfca_hci_stop_poll(struct nfc_hci_dev *hdev)
    {
    nfc_hci_send_cmd(hdev, ST21NFCA_DEVICE_MGNT_GATE,
    ST21NFCA_DM_DISCONNECT, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn st21nfca_get_iso14443_3_atqa(hdev: *mut nfc_hci_dev, atqa: *mut u16) -> c_int {
    static int st21nfca_get_iso14443_3_atqa(struct nfc_hci_dev *hdev, u16 *atqa)
    {
    int r;
    struct sk_buff *atqa_skb = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn st21nfca_get_iso14443_3_sak(hdev: *mut nfc_hci_dev, sak: *mut u8) -> c_int {
    static int st21nfca_get_iso14443_3_sak(struct nfc_hci_dev *hdev, u8 *sak)
    {
    int r;
    struct sk_buff *sak_skb = core::ptr::null_mut();
    r = nfc_hci_get_param(hdev, ST21NFCA_RF_READER_14443_3_A_GATE,
...
// sak = sak_skb->data[0];
    ...
    {
    int r;
    struct sk_buff *uid_skb = core::ptr::null_mut();
    r = nfc_hci_get_param(hdev, ST21NFCA_RF_READER_14443_3_A_GATE,
...
// len = uid_skb->len;
    ...
    {
    int r;
    struct sk_buff *inventory_skb = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn st21nfca_hci_dep_link_down(hdev: *mut nfc_hci_dev) -> c_int {
...
// ISO14443-3 type 1 or 2 tags
    ...
    {
    int r;
    struct sk_buff *nfcid_skb = core::ptr::null_mut();
...
pub const ST21NFCA_CB_TYPE_READER_ISO15693: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn st21nfca_hci_tm_send(hdev: *mut nfc_hci_dev, skb: *mut sk_buff) -> c_int {
...
//
    ...
    ST21NFCA_WR_XCHG_DATA, &fwi, 1, core::ptr::null_mut());
    case ST21NFCA_RF_READER_14443_3_A_GATE:
    return nfc_hci_send_cmd(hdev, target.hci_reader_gate,
    ...
    {
    struct st21nfca_hci_info *info = nfc_hci_get_clientdata(hdev);
    let mut gate: u8 = hdev.pipes[pipe].gate;
    pr_debug("cmd: %x\n", cmd);
    switch (cmd) {
...
//
    ...
    {
    let mut gate: u8 = hdev.pipes[pipe].gate;
    let mut host: u8 = hdev.pipes[pipe].dest_host;
...
#[no_mangle]
pub unsafe extern "C" fn st21nfca_hci_remove(hdev: *mut nfc_hci_dev) {
