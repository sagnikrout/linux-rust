...
//! Source: drivers/nfc/st95hf/core.c
#![no_std]
...
pub const ECHO_CMD: c_uint = 0x55;
pub const WRITE_REGISTER_CMD: c_uint = 0x9;
pub const PROTOCOL_SELECT_CMD: c_uint = 0x2;
pub const SEND_RECEIVE_CMD: c_uint = 0x4;
// Select protocol codes
pub const ISO15693_PROTOCOL_CODE: c_uint = 0x1;
pub const ISO14443A_PROTOCOL_CODE: c_uint = 0x2;
pub const ISO14443B_PROTOCOL_CODE: c_uint = 0x3;
//
// head room len is 3
...
// 1 byte for size
//
pub const ST95HF_HEADROOM_LEN: c_int = 3;
//
...
// taken.
//
pub const ST95HF_TAILROOM_LEN: c_int = 1;
// Command Response interface
pub const MAX_RESPONSE_BUFFER_SIZE: c_int = 280;
pub const ECHORESPONSE: c_uint = 0x55;
pub const ST95HF_ERR_MASK: c_uint = 0xF;
pub const ST95HF_TIMEOUT_ERROR: c_uint = 0x87;
pub const ST95HF_NFCA_CRC_ERR_MASK: c_uint = 0x20;
pub const ST95HF_NFCB_CRC_ERR_MASK: c_uint = 0x01;
// ST95HF transmission flag values
pub const TRFLAG_NFCA_SHORT_FRAME: c_uint = 0x07;
pub const TRFLAG_NFCA_STD_FRAME: c_uint = 0x08;
pub const TRFLAG_NFCA_STD_FRAME_CRC: c_uint = 0x28;
// Misc defs
pub const HIGH: c_int = 1;
pub const LOW: c_int = 0;
pub const ISO14443A_RATS_REQ: c_uint = 0xE0;
pub const RATS_TB1_PRESENT_MASK: c_uint = 0x20;
pub const RATS_TA1_PRESENT_MASK: c_uint = 0x10;
pub const TB1_FWI_MASK: c_uint = 0xF0;
pub const WTX_REQ_FROM_TAG: c_uint = 0xF2;
pub const MAX_CMD_LEN: c_uint = 0x7;
pub const MAX_CMD_PARAMS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmd {
    pub cmd_len: c_int,
    pub cmd_id: c_uchar,
    pub no_cmd_params: c_uchar,
    pub cmd_params: [c_uchar; MAX_CMD_PARAMS],
    pub req: enum req_type,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct param_list {
    pub param_offset: c_int,
    pub new_param_val: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st95_digital_cmd_complete_arg {
    pub skb_resp: *mut sk_buff,
    pub complete_cb: nfc_digital_cmd_complete_t,
    pub cb_usrarg: *mut c_void,
    pub rats: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st95hf_context {
    pub spicontext: st95hf_spi_context,
    pub ddev: *mut nfc_digital_dev,
    pub nfcdev: *mut nfc_dev,
    pub enable_gpiod: *mut gpio_desc,
    pub complete_cb_arg: st95_digital_cmd_complete_arg,
    pub st95hf_supply: *mut regulator,
    pub sendrcv_trflag: c_uchar,
    pub exchange_lock: semaphore,
    pub rm_lock: mutex,
    pub nfcdev_free: bool,
    pub current_protocol: u8,
    pub current_rf_tech: u8,
    pub fwi: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn st95hf_echo_command(st95context: *mut st95hf_context) -> c_int {
    static int st95hf_echo_command(struct st95hf_context *st95context)
    {
    let mut result: c_int = 0;
    unsigned char echo_response;
    result = st95hf_send_recv_cmd(st95context, CMD_ECHO, 0, core::ptr::null_mut(), false);
    if (result)
    return result;
...
#[no_mangle]
unsafe extern "C" fn secondary_configuration_type4a(stcontext: *mut st95hf_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn secondary_configuration_type4b(stcontext: *mut st95hf_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st95hf_select_protocol(stcontext: *mut st95hf_context, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st95hf_send_st95enable_negativepulse(st95con: *mut st95hf_context) {
...
//
#[no_mangle]
unsafe extern "C" fn st95hf_send_spi_reset_sequence(st95context: *mut st95hf_context) -> c_int {
    static int st95hf_send_spi_reset_sequence(struct st95hf_context *st95context)
    {
    let mut result: c_int = 0;
    let mut reset_cmd: c_uchar = ST95HF_COMMAND_RESET;
...
#[no_mangle]
unsafe extern "C" fn st95hf_por_sequence(st95context: *mut st95hf_context) -> c_int {
    static int st95hf_por_sequence(struct st95hf_context *st95context)
    {
    let mut nth_attempt: c_int = 1;
    int result;
    st95hf_send_st95enable_negativepulse(st95context);
...
#[no_mangle]
unsafe extern "C" fn iso14443_config_fdt(st95context: *mut st95hf_context, wtxm: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(NFC_PROTO_ISO14443_B: nfcddev->curr_protocol ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn st95hf_irq_handler(irq: c_int, st95hfcontext: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn st95hf_irq_thread_handler(irq: c_int, st95hfcontext: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rf_off(stcontext: *mut st95hf_context) -> c_int {
    static int rf_off(struct st95hf_context *stcontext)
    {
    int rc;
    struct device *dev;
    dev = &stcontext.nfcdev.dev;
    rc = st95hf_send_recv_cmd(stcontext, CMD_FIELD_OFF, 0, core::ptr::null_mut(), true);
    if (rc)
    ...
    int rc;
    struct sk_buff *skb_resp;
    let mut len_data_to_tag: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn st95hf_tg_get_rf_tech(ddev: *mut nfc_digital_dev, rf_tech: *mut u8) -> c_int {
    static int st95hf_tg_get_rf_tech(struct nfc_digital_dev *ddev, u8 *rf_tech)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn st95hf_switch_rf(ddev: *mut nfc_digital_dev, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st95hf_abort_cmd(ddev: *mut nfc_digital_dev) {
...
#[no_mangle]
unsafe extern "C" fn st95hf_probe(nfc_spi_dev: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st95hf_remove(nfc_spi_dev: *mut spi_device) {
