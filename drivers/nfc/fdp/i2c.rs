...
pub const FDP_FRAME_HEADROOM: c_int = 2;
pub const FDP_FRAME_TAILROOM: c_int = 1;
pub const FDP_NCI_I2C_MIN_PAYLOAD: c_int = 5;
pub const FDP_NCI_I2C_MAX_PAYLOAD: c_int = 261;
pub const FDP_POWER_OFF: c_int = 0;
pub const FDP_POWER_ON: c_int = 1;

    print_hex_dump(KERN_DEBUG, prefix": ", DUMP_PREFIX_OFFSET,	\
    16, 1, (skb).data, (skb).len, 0)
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_reset(phy: *const fdp_i2c_phy) {
...
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_enable(phy_id: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_disable(phy_id: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_add_len_lrc(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_remove_len_lrc(skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_write(phy_id: *mut c_void, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_read(phy: *mut fdp_i2c_phy, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_irq_thread_fn(irq: c_int, phy_id: *mut c_void) -> irqreturn_t {
...
// clock_type, *clock_freq, *fw_vsc_cfg != NULL ? "yes" : "no");
    ...
    let mut power_gpios: static struct acpi_gpio_params = { 0, 0, false };
    static const struct acpi_gpio_mapping acpi_fdp_gpios[] = {
    { "power-gpios", &power_gpios, 1 },
    {},
    };
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_probe(client: *mut i2c_client) -> c_int {
...
// Checking if we have an irq
    ...
    core::ptr::null_mut(), fdp_nci_i2c_irq_thread_fn,
...
#[no_mangle]
unsafe extern "C" fn fdp_nci_i2c_remove(client: *mut i2c_client) {
