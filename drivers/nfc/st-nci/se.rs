...
//! Source: drivers/nfc/st-nci/se.c
#![no_std]
...
pub struct st_nci_pipe_info {
    ...
    pub __packed: },
// Hosts
pub const ST_NCI_HOST_CONTROLLER_ID: c_uint = 0x00;
pub const ST_NCI_TERMINAL_HOST_ID: c_uint = 0x01;
pub const ST_NCI_UICC_HOST_ID: c_uint = 0x02;
pub const ST_NCI_ESE_HOST_ID: c_uint = 0xc0;
// Gates
pub const ST_NCI_APDU_READER_GATE: c_uint = 0xf0;
pub const ST_NCI_CONNECTIVITY_GATE: c_uint = 0x41;
// Pipes
pub const ST_NCI_DEVICE_MGNT_PIPE: c_uint = 0x02;
// Connectivity pipe only
pub const ST_NCI_SE_COUNT_PIPE_UICC: c_uint = 0x01;
// Connectivity + APDU Reader pipe
pub const ST_NCI_SE_COUNT_PIPE_EMBEDDED: c_uint = 0x02;

pub const ST_NCI_SE_TO_PIPES: c_int = 2000;

pub const NCI_HCI_APDU_PARAM_ATR: c_uint = 0x01;
pub const NCI_HCI_ADMIN_PARAM_SESSION_IDENTITY: c_uint = 0x01;
pub const NCI_HCI_ADMIN_PARAM_WHITELIST: c_uint = 0x03;
pub const NCI_HCI_ADMIN_PARAM_HOST_LIST: c_uint = 0x04;
pub const ST_NCI_EVT_SE_HARD_RESET: c_uint = 0x20;
pub const ST_NCI_EVT_TRANSMIT_DATA: c_uint = 0x10;
pub const ST_NCI_EVT_WTX_REQUEST: c_uint = 0x11;
pub const ST_NCI_EVT_SE_SOFT_RESET: c_uint = 0x11;
pub const ST_NCI_EVT_SE_END_OF_APDU_TRANSFER: c_uint = 0x21;
pub const ST_NCI_EVT_HOT_PLUG: c_uint = 0x03;
pub const ST_NCI_SE_MODE_OFF: c_uint = 0x00;
pub const ST_NCI_SE_MODE_ON: c_uint = 0x01;
pub const ST_NCI_EVT_CONNECTIVITY: c_uint = 0x10;
pub const ST_NCI_EVT_TRANSACTION: c_uint = 0x12;
pub const ST_NCI_DM_GETINFO: c_uint = 0x13;
pub const ST_NCI_DM_GETINFO_PIPE_LIST: c_uint = 0x02;
pub const ST_NCI_DM_GETINFO_PIPE_INFO: c_uint = 0x01;
pub const ST_NCI_DM_PIPE_CREATED: c_uint = 0x02;
pub const ST_NCI_DM_PIPE_OPEN: c_uint = 0x04;
pub const ST_NCI_DM_RF_ACTIVE: c_uint = 0x80;
pub const ST_NCI_DM_DISCONNECT: c_uint = 0x30;

    ((p & 0x0f) == (ST_NCI_DM_PIPE_CREATED | ST_NCI_DM_PIPE_OPEN))
pub const ST_NCI_ATR_DEFAULT_BWI: c_uint = 0x04;
//
...
pub const ST_NCI_NUM_DEVICES: c_int = 256;
    pub ST_NCI_NUM_DEVICES): static DECLARE_BITMAP(dev_mask,,
...
#[no_mangle]
unsafe extern "C" fn st_nci_se_get_bwi(ndev: *mut nci_dev) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn st_nci_se_get_atr(ndev: *mut nci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn st_nci_hci_load_session(ndev: *mut nci_dev) -> c_int {
...
//
    ...
    u8 event, struct sk_buff *skb)
    {
    let mut gate: u8 = ndev.hci_dev.pipes[pipe].gate;
    let mut host: u8 = ndev.hci_dev.pipes[pipe].host;
    switch (gate) {
...
//
    ...
    return se_idx;
#[no_mangle]
pub unsafe extern "C" fn if(se_idx: state == ST_NCI_SE_MODE_OFF && host_id !=) -> else {
    else if (state == ST_NCI_SE_MODE_OFF && host_id != se_idx)
    return se_idx;
    return -1;
    }
#[no_mangle]
pub unsafe extern "C" fn st_nci_disable_se(ndev: *mut nci_dev, se_idx: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn st_nci_enable_se(ndev: *mut nci_dev, se_idx: u32) -> c_int {
...
//
    ...
    r = nci_hci_send_event(ndev, ST_NCI_APDU_READER_GATE,
    ST_NCI_EVT_SE_SOFT_RESET, core::ptr::null_mut(), 0);
    }
    if (r < 0) {
//
...
#[no_mangle]
unsafe extern "C" fn st_nci_hci_network_init(ndev: *mut nci_dev) -> c_int {
    ...
    if (dest_params == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn st_nci_discover_se(ndev: *mut nci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_nci_se_wt_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn st_nci_se_activation_timeout(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn st_nci_se_init(ndev: *mut nci_dev, se_status: *mut st_nci_se_status) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn st_nci_se_deinit(ndev: *mut nci_dev) {
