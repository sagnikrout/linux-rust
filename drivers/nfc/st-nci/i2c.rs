...
//! Source: drivers/nfc/st-nci/i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn st_nci_i2c_enable(phy_id: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_nci_i2c_disable(phy_id: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn st_nci_i2c_write(phy_id: *mut c_void, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_nci_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_nci_i2c_remove(client: *mut i2c_client) {
