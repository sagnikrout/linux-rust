...
pub const SPM_AUDIO_PWR_CON: c_uint = 0x029c	/* MT8173, MT2712 */;
pub const SPM_BDP_PWR_CON: c_uint = 0x029c	/* MT2701 */;
pub const SPM_ETH_PWR_CON: c_uint = 0x02a0;
pub const SPM_HIF_PWR_CON: c_uint = 0x02a4;
pub const SPM_IFR_MSC_PWR_CON: c_uint = 0x02a8;
...
pub const SPM_USB2_PWR_CON: c_uint = 0x02d4	/* MT2712 */;
pub const SPM_ETHSYS_PWR_CON: c_uint = 0x02e0	/* MT7622 */;
pub const SPM_HIF0_PWR_CON: c_uint = 0x02e4	/* MT7622 */;
pub const SPM_HIF1_PWR_CON: c_uint = 0x02e8	/* MT7622 */;
pub const SPM_WB_PWR_CON: c_uint = 0x02ec	/* MT7622 */;
...
pub struct scp_domain_data {
    ...
    pub clk_id: [enum clk_id; MAX_CLKS],
    pub caps: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scp_domain {
    pub genpd: generic_pm_domain,
    pub scp: *mut scp,
    pub clk: [*mut clk; MAX_CLKS],
    pub data: *const scp_domain_data,
    pub supply: *mut regulator,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scp_ctrl_reg {
...
#[derive(Copy, Clone)]
pub struct scp {
    pub domains: *mut scp_domain,
    pub pd_data: genpd_onecell_data,
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub infracfg: *mut regmap,
    pub ctrl_reg: scp_ctrl_reg,
    pub bus_prot_reg_update: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scp_subdomain {
    pub origin: c_int,
    pub subdomain: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scp_soc_data {
    pub domains: *const scp_domain_data,
    pub num_domains: c_int,
    pub subdomains: *const scp_subdomain,
    pub num_subdomains: c_int,
    pub regs: scp_ctrl_reg,
    pub bus_prot_reg_update: bool,
}

#[no_mangle]
unsafe extern "C" fn scpsys_domain_is_on(scpd: *mut scp_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpsys_regulator_enable(scpd: *mut scp_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpsys_regulator_disable(scpd: *mut scp_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpsys_clk_disable(clk[]: *mut clk, max_num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn scpsys_clk_enable(clk[]: *mut clk, max_num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpsys_sram_enable(scpd: *mut scp_domain, ctl_addr: *mut void __iomem) -> c_int {
    static int scpsys_sram_enable(struct scp_domain *scpd, void __iomem *ctl_addr)
    {
    u32 val;
    let mut pdn_ack: u32 = scpd.data.sram_pdn_ack_bits;
    int tmp;
    val = readl(ctl_addr);
...
#[no_mangle]
unsafe extern "C" fn scpsys_sram_disable(scpd: *mut scp_domain, ctl_addr: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpsys_bus_protect_enable(scpd: *mut scp_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpsys_bus_protect_disable(scpd: *mut scp_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpsys_power_on(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpsys_power_off(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_clks(pdev: *mut platform_device, clk: *mut clk) {
...
//
    ...
    pm_genpd_init(genpd, core::ptr::null_mut(), !on);
    }
//
...
pub const SPM_PWR_STATUS_MT6797: c_uint = 0x0180;
pub const SPM_PWR_STATUS_2ND_MT6797: c_uint = 0x0184;
...
#[no_mangle]
unsafe extern "C" fn scpsys_probe(pdev: *mut platform_device) -> c_int {
