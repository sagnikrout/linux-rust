...
//! Source: drivers/pmdomain/mediatek/airoha-cpu-pmdomain.c
#![no_std]
...
pub const AIROHA_SIP_AVS_HANDLE: c_uint = 0x82000301;
pub const AIROHA_AVS_OP_BASE: c_uint = 0xddddddd0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct airoha_cpu_pmdomain_priv {
    pub hw: clk_hw,
...
#[no_mangle]
unsafe extern "C" fn airoha_cpu_pmdomain_clk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airoha_cpu_pmdomain_probe(pdev: *mut platform_device) -> c_int {
...
// Init and register a PD for CPU
    ...
    ret = pm_genpd_init(pd, core::ptr::null_mut(), false);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn airoha_cpu_pmdomain_remove(pdev: *mut platform_device) {
