...
//! Source: drivers/pmdomain/amlogic/meson-secure-pwrc.c
#![no_std]
...
pub const PWRC_ON: c_int = 1;
pub const PWRC_OFF: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_secure_pwrc_domain {
    pub base: generic_pm_domain,
    pub index: c_uint,
    pub parent: c_uint,
    pub pwrc: *mut meson_secure_pwrc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_secure_pwrc {
    pub domains: *mut meson_secure_pwrc_domain,
    pub xlate: genpd_onecell_data,
    pub fw: *mut meson_sm_firmware,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_secure_pwrc_domain_desc {
    pub index: c_uint,
    pub parent: c_uint,
    pub flags: c_uint,
    pub name: *mut c_char,
    pub pwrc_domain): *mut *mut bool (is_off)(struct meson_secure_pwrc_domain,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_secure_pwrc_domain_data {
    pub count: c_uint,
    pub domains: *const meson_secure_pwrc_domain_desc,
}

#[no_mangle]
unsafe extern "C" fn pwrc_secure_is_off(pwrc_domain: *mut meson_secure_pwrc_domain) -> bool {
    static bool pwrc_secure_is_off(struct meson_secure_pwrc_domain *pwrc_domain)
    {
    let mut is_off: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn meson_secure_pwrc_off(domain: *mut generic_pm_domain) -> c_int {
    static int meson_secure_pwrc_off(struct generic_pm_domain *domain)
    {
    let mut ret: c_int = 0;
    struct meson_secure_pwrc_domain *pwrc_domain =
    container_of(domain, struct meson_secure_pwrc_domain, base);
    if (meson_sm_call(pwrc_domain.pwrc.fw, SM_A1_PWRC_SET, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn meson_secure_pwrc_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_secure_pwrc_probe(pdev: *mut platform_device) -> c_int {
    ...
    sm_np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "amlogic,meson-gxbb-sm");
    if (!sm_np) {
    ...
    pm_genpd_init(&dom.base, core::ptr::null_mut(), match.domains[i].is_off(dom));
