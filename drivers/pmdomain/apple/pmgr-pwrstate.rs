...
//! Source: drivers/pmdomain/apple/pmgr-pwrstate.c
#![no_std]
...
pub const APPLE_PMGR_PS_ACTIVE: c_uint = 0xf;
pub const APPLE_PMGR_PS_CLKGATE: c_uint = 0x4;
pub const APPLE_PMGR_PS_PWRGATE: c_uint = 0x0;
pub const APPLE_PMGR_PS_SET_TIMEOUT: c_int = 100;
pub const APPLE_PMGR_RESET_TIME: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_pmgr_ps {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn apple_pmgr_ps_set(genpd: *mut generic_pm_domain, pstate: u32, auto_enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_pmgr_ps_is_active(ps: *mut apple_pmgr_ps) -> bool {
...
#[no_mangle]
unsafe extern "C" fn apple_pmgr_ps_power_on(genpd: *mut generic_pm_domain) -> c_int {
    static int apple_pmgr_ps_power_on(struct generic_pm_domain *genpd)
    {
    return apple_pmgr_ps_set(genpd, APPLE_PMGR_PS_ACTIVE, true);
    }
#[no_mangle]
unsafe extern "C" fn apple_pmgr_ps_power_off(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_pmgr_reset_assert(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_pmgr_reset_deassert(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_pmgr_reset_reset(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_pmgr_reset_status(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_pmgr_ps_probe(pdev: *mut platform_device) -> c_int {
...
// Turn on auto-PM if the domain is already on
    ...
    ret = pm_genpd_init(&ps.genpd, core::ptr::null_mut(), !active);
    if (ret < 0) {
