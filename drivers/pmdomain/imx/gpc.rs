...
//! Source: drivers/pmdomain/imx/gpc.c
#![no_std]
...
pub const GPC_CNTR: c_uint = 0x000;
pub const GPC_PGC_CTRL_OFFS: c_uint = 0x0;
pub const GPC_PGC_PUPSCR_OFFS: c_uint = 0x4;
pub const GPC_PGC_PDNSCR_OFFS: c_uint = 0x8;
pub const GPC_PGC_SW2ISO_SHIFT: c_uint = 0x8;
pub const GPC_PGC_SW_SHIFT: c_uint = 0x0;
pub const GPC_PGC_PCI_PDN: c_uint = 0x200;
pub const GPC_PGC_PCI_SR: c_uint = 0x20c;
pub const GPC_PGC_GPU_PDN: c_uint = 0x260;
pub const GPC_PGC_GPU_PUPSCR: c_uint = 0x264;
pub const GPC_PGC_GPU_PDNSCR: c_uint = 0x268;
pub const GPC_PGC_GPU_SR: c_uint = 0x26c;
pub const GPC_PGC_DISP_PDN: c_uint = 0x240;
pub const GPC_PGC_DISP_SR: c_uint = 0x24c;

pub const GPC_CLK_MAX: c_int = 7;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_pm_domain {
    pub base: generic_pm_domain,
    pub regmap: *mut regmap,
    pub supply: *mut regulator,
    pub clk: [*mut clk; GPC_CLK_MAX],
    pub num_clks: c_int,
    pub reg_offs: c_uint,
    pub cntr_pdn_bit: signed char,
    pub ipg_rate_mhz: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn imx6_pm_domain_power_off(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx6_pm_domain_power_on(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pgc_get_clocks(dev: *mut device, domain: *mut imx_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pgc_put_clocks(domain: *mut imx_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn imx_pgc_parse_dt(dev: *mut device, domain: *mut imx_pm_domain) -> c_int {
...
// try to get the domain supply regulator
    ...
    domain.supply = core::ptr::null_mut();
    else
...
#[no_mangle]
unsafe extern "C" fn imx_pgc_power_domain_probe(pdev: *mut platform_device) -> c_int {
...
// initially power on the domain
    ...
    pm_genpd_init(&domain.base, core::ptr::null_mut(), false);
...
#[no_mangle]
unsafe extern "C" fn imx_pgc_power_domain_remove(pdev: *mut platform_device) {
...
pub const GPC_PGC_DOMAIN_ARM: c_int = 0;
pub const GPC_PGC_DOMAIN_PU: c_int = 1;
pub const GPC_PGC_DOMAIN_DISPLAY: c_int = 2;
pub const GPC_PGC_DOMAIN_PCI: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_gpc_dt_data {
    pub num_domains: c_int,
    pub err009619_present: bool,
    pub err006287_present: bool,
}
    ...
    for (i = 0; i < num_domains; i++)
    pm_genpd_init(&imx_gpc_domains[i].base, core::ptr::null_mut(), false);
    if (IS_ENABLED(CONFIG_PM_GENERIC_DOMAINS)) {
...
#[no_mangle]
unsafe extern "C" fn imx_gpc_probe(pdev: *mut platform_device) -> c_int {
    static int imx_gpc_probe(struct platform_device *pdev)
    {
    const struct imx_gpc_dt_data *of_id_data = device_get_match_data(&pdev.dev);
#[no_mangle]
pub unsafe extern "C" fn __free(_arg: device_node) -> *mut device_node pgc_node {
...
// bail out if DT too old and doesn't provide the necessary info
    ...
    if (IS_ERR(base))
    return PTR_ERR(base);
    regmap = devm_regmap_init_mmio_clk(&pdev.dev, core::ptr::null_mut(), base,
...
#[no_mangle]
unsafe extern "C" fn imx_gpc_remove(pdev: *mut platform_device) {
