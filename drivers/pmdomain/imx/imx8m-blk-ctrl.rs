...
//! Source: drivers/pmdomain/imx/imx8m-blk-ctrl.c
#![no_std]
...
pub const BLK_MIPI_RESET_DIV: c_uint = 0x8 /* Mini/Nano/Plus DISPLAY_BLK_CTRL only */;
    struct imx8m_blk_ctrl_domain;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8m_blk_ctrl {
    pub dev: *mut device,
    pub power_nb: notifier_block,
    pub bus_power_dev: *mut device,
    pub regmap: *mut regmap,
    pub domains: *mut imx8m_blk_ctrl_domain,
    pub onecell_data: genpd_onecell_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8m_blk_ctrl_domain_data {
...
// de-asserted by HW)
//
    pub is_errata_err050531: bool,
}

pub const DOMAIN_MAX_CLKS: c_int = 4;
pub const DOMAIN_MAX_PATHS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8m_blk_ctrl_domain {
    pub genpd: generic_pm_domain,
    pub data: *const imx8m_blk_ctrl_domain_data,
    pub clks: [clk_bulk_data; DOMAIN_MAX_CLKS],
    pub paths: [icc_bulk_data; DOMAIN_MAX_PATHS],
    pub power_dev: *mut device,
    pub bc: *mut imx8m_blk_ctrl,
    pub num_paths: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8m_blk_ctrl_data {
    pub max_reg: c_int,
    pub power_notifier_fn: notifier_fn_t,
    pub domains: *const imx8m_blk_ctrl_domain_data,
...
#[no_mangle]
unsafe extern "C" fn imx8m_blk_ctrl_power_on(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8m_blk_ctrl_power_off(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8m_blk_ctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8m_blk_ctrl_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx8m_blk_ctrl_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8m_blk_ctrl_resume(dev: *mut device) -> c_int {
...
pub const LCDIF_ARCACHE_CTRL: c_uint = 0x4c;

pub const ISI_CACHE_CTRL: c_uint = 0x50;
