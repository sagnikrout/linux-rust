...
//! Source: drivers/pmdomain/imx/scu-pd.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_sc_msg_req_set_resource_power_mode {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct req_get_resource_mode {
    pub resource: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct resp_get_resource_mode {
    pub mode: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_sc_msg_req_get_resource_power_mode {
    pub hdr: imx_sc_rpc_msg,
    union {
    pub req: req_get_resource_mode,
    pub resp: resp_get_resource_mode,
    pub data: },
    pub __aligned(4): } __packed,
pub const IMX_SCU_PD_NAME_SIZE: c_int = 20;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_sc_pm_domain {
    pub pd: generic_pm_domain,
    pub name: [c_char; IMX_SCU_PD_NAME_SIZE],
    pub rsrc: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_sc_pd_range {
    pub name: *mut c_char,
    pub rsrc: u32,
    pub num: u8,
// add domain index
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_sc_pd_soc {
    pub pd_ranges: *const imx_sc_pd_range,
    pub num_ranges: u8,
}
...
#[no_mangle]
unsafe extern "C" fn imx_sc_pd_get_console_rsrc() {
...
#[no_mangle]
unsafe extern "C" fn imx_sc_get_pd_power(dev: *mut device, rsrc: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_sc_pd_power(domain: *mut generic_pm_domain, power_on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_sc_pd_power_on(domain: *mut generic_pm_domain) -> c_int {
    static int imx_sc_pd_power_on(struct generic_pm_domain *domain)
    {
    return imx_sc_pd_power(domain, true);
    }
#[no_mangle]
unsafe extern "C" fn imx_sc_pd_power_off(domain: *mut generic_pm_domain) -> c_int {
    ...
    ret = pm_genpd_init(&sc_pd.pd, core::ptr::null_mut(), is_off);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn imx_sc_pd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_sc_pd_driver_init() -> int __init {
