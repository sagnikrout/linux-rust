...
//! Source: drivers/pmdomain/ti/ti_sci_pm_domains.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_sci_genpd_provider {
    pub ti_sci: *const ti_sci_handle,
    pub dev: *mut device,
    pub pd_list: list_head,
    pub data: genpd_onecell_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_sci_pm_domain {
    pub idx: c_int,
    pub exclusive: u8,
    pub pd: generic_pm_domain,
    pub node: list_head,
    pub parent: *mut ti_sci_genpd_provider,
}

#[no_mangle]
pub unsafe extern "C" fn ti_sci_pd_is_valid_constraint(val: i32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ti_sci_pd_set_lat_constraint(dev: *mut device, val: i32) {
...
#[no_mangle]
pub unsafe extern "C" fn ti_sci_pd_set_wkup_constraint(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_pd_power_off(domain: *mut generic_pm_domain) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_pd_power_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sci_pd_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sci_pm_idx_exists(pd_provider: *mut ti_sci_genpd_provider, idx: u32) -> bool {
    ...
    pd_idx, core::ptr::null_mut(), &is_on);
    if (ret)
    return false;
    return is_on;
    }
#[no_mangle]
unsafe extern "C" fn ti_sci_pm_domain_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    pd.idx);
    pm_genpd_init(&pd.pd, core::ptr::null_mut(), !is_on);
