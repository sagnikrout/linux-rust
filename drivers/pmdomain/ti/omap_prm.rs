...
//! Source: drivers/pmdomain/ti/omap_prm.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_prm_domain_map {
    pub /: *mut *mut unsigned int usable_modes; / Mask of hardware supported modes,
    pub /: *mut *mut unsigned long statechange:1; / Optional low-power state change,
    pub /: *mut *mut unsigned long logicretstate:1; / Optional logic off mode,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_prm_domain {
    pub dev: *mut device,
    pub prm: *mut omap_prm,
    pub pd: generic_pm_domain,
    pub pwrstctrl: u16,
    pub pwrstst: u16,
    pub cap: *const omap_prm_domain_map,
    pub pwrstctrl_saved: u32,
    pub uses_pm_clk:1: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_rst_map {
    pub rst: i8,
    pub st: i8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_prm_data {
    pub base: u32,
    pub name: *const c_char,
    pub clkdm_name: *const c_char,
    pub pwrstctrl: u16,
    pub pwrstst: u16,
    pub dmap: *const omap_prm_domain_map,
    pub rstctrl: u16,
    pub rstst: u16,
    pub rstmap: *const omap_rst_map,
    pub flags: u8,
}
...
#[derive(Copy, Clone)]
pub struct omap_prm {
    pub data: *const omap_prm_data,
    pub base: *mut void __iomem,
    pub prmd: *mut omap_prm_domain,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_reset_data {
...
pub const OMAP_MAX_RESETS: c_int = 8;
pub const OMAP_RESET_MAX_WAIT: c_int = 10000;

pub const PRM_STATE_MAX_WAIT: c_int = 10000;
...
#[no_mangle]
unsafe extern "C" fn omap_prm_domain_power_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_prm_domain_find_lowest(prmd: *mut omap_prm_domain) -> c_int {
    static int omap_prm_domain_find_lowest(struct omap_prm_domain *prmd)
    {
    return __ffs(prmd.cap.usable_modes);
    }
#[no_mangle]
unsafe extern "C" fn omap_prm_domain_power_off(domain: *mut generic_pm_domain) -> c_int {
...
//
    ...
    genpd_data.data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn omap_prm_domain_init(dev: *mut device, prm: *mut omap_prm) -> c_int {
    ...
    pm_genpd_init(&prmd.pd, core::ptr::null_mut(), true);
...
#[no_mangle]
unsafe extern "C" fn _is_valid_reset(reset: *mut omap_reset_data, id: c_ulong) -> bool {
    ...
    u32 v;
    let mut st_bit: c_int = omap_reset_get_st_bit(reset, id);
...
#[no_mangle]
unsafe extern "C" fn omap_prm_probe(pdev: *mut platform_device) -> c_int {
