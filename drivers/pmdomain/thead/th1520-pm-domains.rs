...
//! Source: drivers/pmdomain/thead/th1520-pm-domains.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct th1520_power_domain {
    pub aon_chan: *mut th1520_aon_chan,
...
#[no_mangle]
unsafe extern "C" fn th1520_pd_power_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn th1520_pd_power_off(domain: *mut generic_pm_domain) -> c_int {
    ...
    ret = pm_genpd_init(&pd.genpd, core::ptr::null_mut(), true);
    if (ret)
    return ERR_PTR(ret);
    return pd;
    }
...
#[no_mangle]
unsafe extern "C" fn th1520_pd_pwrseq_unregister_adev(adev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn th1520_pd_pwrseq_gpu_init(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn th1520_pd_probe(pdev: *mut platform_device) -> c_int {
