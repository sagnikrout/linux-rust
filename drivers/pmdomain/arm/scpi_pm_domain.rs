...
//! Source: drivers/pmdomain/arm/scpi_pm_domain.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scpi_pm_domain {
    pub genpd: generic_pm_domain,
    pub ops: *mut scpi_ops,
    pub domain: u32,
}
...
#[no_mangle]
unsafe extern "C" fn scpi_pd_power(pd: *mut scpi_pm_domain, power_on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpi_pd_power_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpi_pd_power_off(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scpi_pm_domain_probe(pdev: *mut platform_device) -> c_int {
...
//
    pm_genpd_init(&scpi_pd.genpd, core::ptr::null_mut(), true);
    }
