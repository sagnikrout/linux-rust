...
//! Source: drivers/pmdomain/rockchip/pm-domains.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_domain_info {
    pub name: *const c_char,
    pub pwr_mask: c_int,
    pub status_mask: c_int,
    pub req_mask: c_int,
    pub idle_mask: c_int,
    pub ack_mask: c_int,
    pub active_wakeup: bool,
    pub need_regulator: bool,
    pub pwr_w_mask: c_int,
    pub req_w_mask: c_int,
    pub clk_ungate_mask: c_int,
    pub mem_status_mask: c_int,
    pub repair_status_mask: c_int,
    pub pwr_offset: u32,
    pub mem_offset: u32,
    pub req_offset: u32,
}
...
pub struct rockchip_pmu_info {
    ...
    pub core_power_transition_time: c_uint,
    pub gpu_power_transition_time: c_uint,
    pub num_domains: c_int,
    pub domain_info: *const rockchip_domain_info,
}

pub const MAX_QOS_REGS_NUM: c_int = 5;
pub const QOS_PRIORITY: c_uint = 0x08;
pub const QOS_MODE: c_uint = 0x0c;
pub const QOS_BANDWIDTH: c_uint = 0x10;
pub const QOS_SATURATION: c_uint = 0x14;
pub const QOS_EXTCONTROL: c_uint = 0x18;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_pm_domain {
    pub genpd: generic_pm_domain,
    pub info: *const rockchip_domain_info,
    pub pmu: *mut rockchip_pmu,
    pub num_qos: c_int,
    pub qos_regmap: *mut regmap,
    pub qos_save_regs: [*mut u32; MAX_QOS_REGS_NUM],
    pub num_clks: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_pmu {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub info: *const rockchip_pmu_info,
    pub /: *mut *mut mutex mutex; / mutex lock for pmu,
...
//
#[no_mangle]
pub unsafe extern "C" fn rockchip_pmu_block() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rockchip_pmu_unblock() {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_domain_is_idle(pd: *mut rockchip_pm_domain) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_read_ack(pmu: *mut rockchip_pmu) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_ungate_clk(pd: *mut rockchip_pm_domain, ungate: bool) -> c_int {
    static int rockchip_pmu_ungate_clk(struct rockchip_pm_domain *pd, bool ungate)
    {
    const struct rockchip_domain_info *pd_info = pd.info;
    struct rockchip_pmu *pmu = pd.pmu;
    unsigned int val;
    let mut clk_ungate_w_mask: c_int = pd_info.clk_ungate_mask << 16;
    ...
    struct rockchip_pmu *pmu = pd.pmu;
    let mut pd_req_offset: u32 = pd_info.req_offset;
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pd_info->req_w_mask) -> else {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_save_qos(pd: *mut rockchip_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_restore_qos(pd: *mut rockchip_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_domain_is_on(pd: *mut rockchip_pm_domain) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_domain_is_mem_on(pd: *mut rockchip_pm_domain) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_domain_is_chain_on(pd: *mut rockchip_pm_domain) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pmu_domain_mem_reset(pd: *mut rockchip_pm_domain) -> c_int {
    ...
    struct rockchip_pmu *pmu = pd.pmu;
    struct generic_pm_domain *genpd = &pd.genpd;
    let mut pd_pwr_offset: u32 = pd.info.pwr_offset;
...
#[no_mangle]
unsafe extern "C" fn rockchip_pd_power(pd: *mut rockchip_pm_domain, power_on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pd_regulator_disable(pd: *mut rockchip_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pd_regulator_enable(pd: *mut rockchip_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pd_power_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pd_power_off(domain: *mut generic_pm_domain) -> c_int {
...
//
    ...
    pm_genpd_init(&pd.genpd, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rockchip_pm_remove_one_domain(pd: *mut rockchip_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pm_domain_cleanup(pmu: *mut rockchip_pmu) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pm_domain_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pm_domain_drv_register() -> int __init {
