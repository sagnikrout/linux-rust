...
//! Source: drivers/pmdomain/qcom/rpmhpd.c
#![no_std]
...
pub const RPMH_ARC_MAX_LEVELS: c_int = 32;
//
...
pub struct rpmhpd {
    ...
    pub corner: c_uint,
    pub active_corner: c_uint,
    pub enable_corner: c_uint,
    pub level: [u32; RPMH_ARC_MAX_LEVELS],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmhpd_desc {
    pub rpmhpds: *mut rpmhpd,
    pub num_pds: usize,
}
...
//
#[no_mangle]
unsafe extern "C" fn rpmhpd_aggregate_corner(pd: *mut rpmhpd, corner: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmhpd_power_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmhpd_power_off(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmhpd_update_level_mapping(rpmhpd: *mut rpmhpd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmhpd_probe(pdev: *mut platform_device) -> c_int {
    ...
    pm_genpd_init(&rpmhpds[i].pd, core::ptr::null_mut(), true);
...
#[no_mangle]
unsafe extern "C" fn rpmhpd_sync_state(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn rpmhpd_init() -> int __init {
