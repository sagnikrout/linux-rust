...
//! Source: drivers/pmdomain/qcom/cpr.c
#![no_std]
...
pub const REG_RBCPR_VERSION: c_int = 0;
pub const RBCPR_VER_2: c_uint = 0x02;

// RBCPR Gate Count and Target Registers

pub const RBCPR_GCNT_TARGET_TARGET_SHIFT: c_int = 0;

pub const RBCPR_GCNT_TARGET_GCNT_SHIFT: c_int = 12;

// RBCPR Timer Control
pub const REG_RBCPR_TIMER_INTERVAL: c_uint = 0x44;
pub const REG_RBIF_TIMER_ADJUST: c_uint = 0x4c;

pub const RBIF_TIMER_ADJ_CONS_UP_SHIFT: c_int = 0;

pub const RBIF_TIMER_ADJ_CONS_DOWN_SHIFT: c_int = 4;

pub const RBIF_TIMER_ADJ_CLAMP_INT_SHIFT: c_int = 8;
// RBCPR Config Register
pub const REG_RBIF_LIMIT: c_uint = 0x48;

pub const RBIF_LIMIT_CEILING_SHIFT: c_int = 6;
pub const RBIF_LIMIT_FLOOR_BITS: c_int = 6;

pub const RBIF_LIMIT_FLOOR_DEFAULT: c_int = 0;
pub const REG_RBIF_SW_VLEVEL: c_uint = 0x94;
pub const RBIF_SW_VLEVEL_DEFAULT: c_uint = 0x20;
pub const REG_RBCPR_STEP_QUOT: c_uint = 0x80;

pub const RBCPR_STEP_QUOT_IDLE_CLK_SHIFT: c_int = 8;
// RBCPR Control Register
pub const REG_RBCPR_CTL: c_uint = 0x90;

pub const RBCPR_CTL_UP_THRESHOLD_SHIFT: c_int = 24;

pub const RBCPR_CTL_DN_THRESHOLD_SHIFT: c_int = 28;
// RBCPR Ack/Nack Response
pub const REG_RBIF_CONT_ACK_CMD: c_uint = 0x98;
pub const REG_RBIF_CONT_NACK_CMD: c_uint = 0x9c;
// RBCPR Result status Register
pub const REG_RBCPR_RESULT_0: c_uint = 0xa0;
pub const RBCPR_RESULT0_BUSY_SHIFT: c_int = 19;

pub const RBCPR_RESULT0_ERROR_LT0_SHIFT: c_int = 18;
pub const RBCPR_RESULT0_ERROR_SHIFT: c_int = 6;

pub const RBCPR_RESULT0_ERROR_STEPS_SHIFT: c_int = 2;

pub const RBCPR_RESULT0_STEP_UP_SHIFT: c_int = 1;
// RBCPR Interrupt Control Register

pub const REG_RBIF_IRQ_CLEAR: c_uint = 0x110;
pub const REG_RBIF_IRQ_STATUS: c_uint = 0x114;

    CPR_INT_MID | CPR_INT_UP | CPR_INT_MAX | CPR_INT_CLAMP)

pub const CPR_NUM_RING_OSC: c_int = 8;
// CPR eFuse parameters

pub const CPR_FUSE_MIN_QUOT_DIFF: c_int = 50;
...
#[derive(Copy, Clone)]
pub struct cpr_fuse {
    pub ring_osc: *mut c_char,
    pub init_voltage: *mut c_char,
    pub quotient: *mut c_char,
    pub quotient_offset: *mut c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fuse_corner_data {
    pub ref_uV: c_int,
    pub max_uV: c_int,
    pub min_uV: c_int,
    pub max_volt_scale: c_int,
    pub max_quot_scale: c_int,
// fuse quot
    pub quot_offset: c_int,
    pub quot_scale: c_int,
    pub quot_adjust: c_int,
// fuse quot_offset
    pub quot_offset_scale: c_int,
    pub quot_offset_adjust: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpr_fuses {
    pub init_voltage_step: c_int,
    pub init_voltage_width: c_int,
    pub fuse_corner_data: *mut fuse_corner_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct corner_data {
    pub fuse_corner: c_uint,
    pub freq: c_ulong,
}
...
#[derive(Copy, Clone)]
pub struct cpr_desc {
    pub num_fuse_corners: c_uint,
    pub min_diff_quot: c_int,
    pub step_quot: *mut c_int,
    pub timer_delay_us: c_uint,
    pub timer_cons_up: c_uint,
    pub timer_cons_down: c_uint,
    pub up_threshold: c_uint,
    pub down_threshold: c_uint,
    pub idle_clocks: c_uint,
    pub gcnt_us: c_uint,
    pub vdd_apc_step_up_limit: c_uint,
    pub vdd_apc_step_down_limit: c_uint,
    pub clamp_timer_interval: c_uint,
    pub cpr_fuses: cpr_fuses,
    pub reduce_to_fuse_uV: bool,
    pub reduce_to_corner_uV: bool,
}
...
pub struct acc_desc {
    ...
    pub enable_mask: u32,
    pub config: *mut reg_sequence,
    pub settings: *mut reg_sequence,
    pub num_regs_per_fuse: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpr_acc_desc {
    pub cpr_desc: *const cpr_desc,
    pub acc_desc: *const acc_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fuse_corner {
    pub min_uV: c_int,
    pub max_uV: c_int,
    pub uV: c_int,
    pub quot: c_int,
    pub step_quot: c_int,
    pub accs: *const reg_sequence,
    pub num_accs: c_int,
...
pub struct corner {
    ...
    pub save_irq: u32,
    pub freq: c_ulong,
    pub fuse_corner: *mut fuse_corner,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpr_drv {
    pub num_corners: c_uint,
    pub ref_clk_khz: c_uint,
    pub pd: generic_pm_domain,
    pub dev: *mut device,
    pub attached_cpu_dev: *mut device,
    pub lock: mutex,
    pub base: *mut void __iomem,
    pub corner: *mut corner,
    pub vdd_apc: *mut regulator,
    pub cpu_clk: *mut clk,
    pub tcsr: *mut regmap,
    pub loop_disabled: bool,
    pub gcnt: u32,
    pub flags: c_ulong,
    pub corners: *mut corner,
    pub desc: *const cpr_desc,
    pub acc_desc: *const acc_desc,
    pub cpr_fuses: *const cpr_fuse,
    pub debugfs: *mut dentry,
    pub fuse_corners: [fuse_corner; ],
}

#[no_mangle]
unsafe extern "C" fn cpr_is_allowed(drv: *mut cpr_drv) -> bool {
    static bool cpr_is_allowed(struct cpr_drv *drv)
    {
    return !drv.loop_disabled;
    }
#[no_mangle]
unsafe extern "C" fn cpr_write(drv: *mut cpr_drv, offset: u32, value: u32) {
    static void cpr_write(struct cpr_drv *drv, u32 offset, u32 value)
    {
    writel_relaxed(value, drv.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn cpr_read(drv: *mut cpr_drv, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cpr_irq_clr(drv: *mut cpr_drv) {
    static void cpr_irq_clr(struct cpr_drv *drv)
    {
    cpr_write(drv, REG_RBIF_IRQ_CLEAR, CPR_INT_ALL);
    }
#[no_mangle]
unsafe extern "C" fn cpr_irq_clr_nack(drv: *mut cpr_drv) {
...
#[no_mangle]
unsafe extern "C" fn cpr_irq_clr_ack(drv: *mut cpr_drv) {
...
#[no_mangle]
unsafe extern "C" fn cpr_ctl_disable(drv: *mut cpr_drv) {
...
#[no_mangle]
unsafe extern "C" fn cpr_ctl_is_enabled(drv: *mut cpr_drv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpr_ctl_is_busy(drv: *mut cpr_drv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpr_corner_save(drv: *mut cpr_drv, corner: *mut corner) {
...
#[no_mangle]
unsafe extern "C" fn cpr_corner_restore(drv: *mut cpr_drv, corner: *mut corner) {
...
#[no_mangle]
unsafe extern "C" fn cpr_get_cur_perf_state(drv: *mut cpr_drv) -> c_uint {
    static unsigned int cpr_get_cur_perf_state(struct cpr_drv *drv)
    {
    return drv.corner ? drv.corner - drv.corners + 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn cpr_scale(drv: *mut cpr_drv, dir: enum voltage_change_dir) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpr_irq_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cpr_enable(drv: *mut cpr_drv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpr_disable(drv: *mut cpr_drv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpr_config(drv: *mut cpr_drv) -> c_int {
...
// Determine direction
    ...
    dir = DOWN;
#[no_mangle]
pub unsafe extern "C" fn if(corner: drv->corner <) -> else {
...
#[no_mangle]
unsafe extern "C" fn cpr_fuse_corner_init(drv: *mut cpr_drv) -> c_int {
...
//
    ...
    fuse.uV = fuse.max_uV;
#[no_mangle]
pub unsafe extern "C" fn if(fuse->min_uV: fuse->uV <) -> else {
...
#[no_mangle]
unsafe extern "C" fn cpr_get_fuse_corner(opp: *mut dev_pm_opp) -> c_uint {
    static unsigned int cpr_get_fuse_corner(struct dev_pm_opp *opp)
    {
    struct device_node *np;
    let mut fuse_corner: c_uint = 0;
    ...
    {
    struct device_node *ref_np __free(device_node) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cpr_corner_init(drv: *mut cpr_drv) -> c_int {
    ...
    unsigned long freq;
    let mut step_volt: c_int = regulator_get_linear_step(drv.vdd_apc);
...
#[no_mangle]
pub unsafe extern "C" fn if(corner->max_uV: desc->reduce_to_fuse_uV && fuse->uV <) -> else {
...
#[no_mangle]
unsafe extern "C" fn cpr_set_loop_allowed(drv: *mut cpr_drv) {
    static void cpr_set_loop_allowed(struct cpr_drv *drv)
    {
    drv.loop_disabled = false;
    }
#[no_mangle]
unsafe extern "C" fn cpr_init_parameters(drv: *mut cpr_drv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpr_find_initial_corner(drv: *mut cpr_drv) -> c_int {
    ...
    let mut i: c_uint = 0;
    if (!drv.cpu_clk) {
    dev_err(drv.dev, "cannot get rate from core::ptr::null_mut() clk\n");
    return -EINVAL;
    }
    end = &drv.corners[drv.num_corners - 1];
...
#[no_mangle]
unsafe extern "C" fn cpr_power_off(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpr_power_on(domain: *mut generic_pm_domain) -> c_int {
...
//
    drv.cpu_clk = devm_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cpr_debug_info_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpr_debugfs_init(drv: *mut cpr_drv) {
    static void cpr_debugfs_init(struct cpr_drv *drv)
    {
    drv.debugfs = debugfs_create_dir("qcom_cpr", core::ptr::null_mut());
    debugfs_create_file("debug_info", 0444, drv.debugfs,
    drv, &cpr_debug_info_fops);
    }
#[no_mangle]
unsafe extern "C" fn cpr_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct device_node *np;
    let mut cpr_rev: u32 = FUSE_REVISION_UNKNOWN;
...
//
    ...
    ret = pm_genpd_init(&drv.pd, core::ptr::null_mut(), true);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn cpr_remove(pdev: *mut platform_device) {
