...
//! Source: drivers/pmdomain/qcom/rpmpd.c
#![no_std]
...
pub const RPMPD_SMPA: c_uint = 0x61706d73;
pub const RPMPD_LDOA: c_uint = 0x616f646c;
pub const RPMPD_SMPB: c_uint = 0x62706d73;
pub const RPMPD_LDOB: c_uint = 0x626f646c;
pub const RPMPD_RWCX: c_uint = 0x78637772;
pub const RPMPD_RWMX: c_uint = 0x786d7772;
pub const RPMPD_RWLC: c_uint = 0x636c7772;
pub const RPMPD_RWLM: c_uint = 0x6d6c7772;
pub const RPMPD_RWSC: c_uint = 0x63737772;
pub const RPMPD_RWSM: c_uint = 0x6d737772;
pub const RPMPD_RWGX: c_uint = 0x78677772;
// Operation Keys
pub const KEY_CORNER: c_uint = 0x6e726f63 /* corn */;
pub const KEY_ENABLE: c_uint = 0x6e657773 /* swen */;
pub const KEY_FLOOR_CORNER: c_uint = 0x636676   /* vfc */;
pub const KEY_FLOOR_LEVEL: c_uint = 0x6c6676   /* vfl */;
pub const KEY_LEVEL: c_uint = 0x6c766c76 /* vlvl */;
pub const MAX_CORNER_RPMPD_STATE: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmpd_req {
    pub key: __le32,
    pub nbytes: __le32,
    pub value: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmpd_desc {
    pub rpmpds: *mut rpmpd,
    pub num_pds: usize,
    pub max_state: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn rpmpd_send_enable(pd: *mut rpmpd, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmpd_send_corner(pd: *mut rpmpd, state: c_int, corner: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmpd_aggregate_corner(pd: *mut rpmpd) -> c_int {
    static int rpmpd_aggregate_corner(struct rpmpd *pd)
    {
    int ret;
    struct rpmpd *peer = pd.peer;
    unsigned int active_corner, sleep_corner;
    let mut this_active_corner: c_uint = 0, this_sleep_corner = 0;
    let mut peer_active_corner: c_uint = 0, peer_sleep_corner = 0;
...
#[no_mangle]
unsafe extern "C" fn rpmpd_power_on(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmpd_power_off(domain: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmpd_probe(pdev: *mut platform_device) -> c_int {
    ...
    pm_genpd_init(&rpmpds[i].pd, core::ptr::null_mut(), true);
...
#[no_mangle]
unsafe extern "C" fn rpmpd_sync_state(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn rpmpd_init() -> int __init {
