...
//! Source: drivers/pmdomain/core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct genpd_lock_ops {
    pub genpd): *mut *mut void (lock)(struct generic_pm_domain,
    pub depth): *mut *mut *mut void (lock_nested)(struct generic_pm_domain genpd, int,
    pub genpd): *mut *mut int (lock_interruptible)(struct generic_pm_domain,
    pub genpd): *mut *mut void (unlock)(struct generic_pm_domain,
}

#[no_mangle]
unsafe extern "C" fn genpd_lock_mtx(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_lock_interruptible_mtx(genpd: *mut generic_pm_domain) -> c_int {
    static int genpd_lock_interruptible_mtx(struct generic_pm_domain *genpd)
    {
    return mutex_lock_interruptible(&genpd.mlock);
    }
#[no_mangle]
unsafe extern "C" fn genpd_unlock_mtx(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_lock_spin(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_lock_interruptible_spin(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genpd_unlock_spin(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_lock_raw_spin(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_lock_interruptible_raw_spin(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genpd_unlock_raw_spin(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_sd_counter_dec(genpd: *mut generic_pm_domain) -> bool {
...
#[no_mangle]
unsafe extern "C" fn genpd_sd_counter_inc(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_debug_remove(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_update_accounting(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_reflect_residency(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn _genpd_rollback_parent_state(link: *mut gpd_link, depth: c_int) {
...
// Find parent's performance state
    ...
    unsigned int state, int depth)
    {
    struct gpd_link *link = core::ptr::null_mut();
    int ret;
    if (state == genpd.performance_state)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn genpd_set_performance_state(dev: *mut device, state: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genpd_drop_performance_state(dev: *mut device) -> c_int {
    static int genpd_drop_performance_state(struct device *dev)
    {
    let mut prev_state: c_uint = dev_gpd_data(dev).performance_state;
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_set_performance_state(dev: *mut device, state: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_set_next_wakeup(dev: *mut device, next: ktime_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_get_next_hrtimer(dev: *mut device) -> ktime_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_synced_poweroff(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_set_hwmode(dev: *mut device, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_get_hwmode(dev: *mut device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_rpm_always_on(dev: *mut device, on: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_is_on(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn _genpd_power_on(genpd: *mut generic_pm_domain, timed: bool) -> c_int {
    static int _genpd_power_on(struct generic_pm_domain *genpd, bool timed)
    {
    let mut state_idx: c_uint = genpd.state_idx;
    ktime_t time_start;
    s64 elapsed_ns;
    int ret;
// Notify consumers that we are about to power on.
    ...
    GENPD_NOTIFY_PRE_ON,
    GENPD_NOTIFY_OFF, core::ptr::null_mut());
    ...
    out:
    raw_notifier_call_chain(&genpd.power_notifiers, GENPD_NOTIFY_ON, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn _genpd_power_off(genpd: *mut generic_pm_domain, timed: bool) -> c_int {
...
// Notify consumers that we are about to power off.
    ...
    GENPD_NOTIFY_ON, core::ptr::null_mut());
    ret = notifier_to_errno(ret);
    if (ret)
    return ret;
    if (!genpd.power_off)
...
//
#[no_mangle]
unsafe extern "C" fn genpd_queue_power_off_work(genpd: *mut generic_pm_domain) {
...
//
    ...
    struct pm_domain_data *pdd;
    struct gpd_link *link;
    let mut not_suspended: c_uint = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn genpd_power_on(genpd: *mut generic_pm_domain, depth: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genpd_dev_pm_start(dev: *mut device) -> c_int {
    ...
    dev.power.subsys_data.domain_data : core::ptr::null_mut();
    if (pdd) {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_power_off_work_fn(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn __genpd_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(dev->class->pm: dev->class &&) -> else {
    else if (dev.class && dev.class.pm)
    cb = dev.class.pm.runtime_suspend;
#[no_mangle]
pub unsafe extern "C" fn if(dev->bus->pm: dev->bus &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn __genpd_runtime_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_runtime_suspend(dev: *mut device) -> c_int {
    static int genpd_runtime_suspend(struct device *dev)
    {
    struct generic_pm_domain *genpd;
    ...
    let mut runtime_pm: bool = pm_runtime_enabled(dev);
    let mut time_start: ktime_t = 0;
    s64 elapsed_ns;
    int ret;
    dev_dbg(dev, "%s()\n", __func__);
    genpd = dev_to_genpd(dev);
...
//
    suspend_ok = genpd.gov ? genpd.gov.suspend_ok : core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn genpd_runtime_resume(dev: *mut device) -> c_int {
    static int genpd_runtime_resume(struct device *dev)
    {
    struct generic_pm_domain *genpd;
    struct generic_pm_domain_data *gpd_data = dev_gpd_data(dev);
    struct gpd_timing_data *td = gpd_data.td;
    let mut timed: bool = td && pm_runtime_enabled(dev);
    let mut time_start: ktime_t = 0;
    s64 elapsed_ns;
    int ret;
    dev_dbg(dev, "%s()\n", __func__);
...
#[no_mangle]
unsafe extern "C" fn pd_ignore_unused_setup(__unused: *mut c_char) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_power_off_unused() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_prepare(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_suspend_noirq(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_resume_noirq(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_freeze_noirq(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_thaw_noirq(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_poweroff_noirq(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_restore_noirq(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_complete(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn genpd_switch_state(dev: *mut device, suspend: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_suspend(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_resume(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn genpd_set_cpumask(genpd: *mut generic_pm_domain, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn genpd_clear_cpumask(genpd: *mut generic_pm_domain, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn genpd_get_cpu(genpd: *mut generic_pm_domain, dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pm_genpd_add_device(genpd: *mut generic_pm_domain, dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pm_genpd_remove_device(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_add_notifier(dev: *mut device, nb: *mut notifier_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_genpd_remove_notifier(dev: *mut device) -> c_int {
    ...
    gpd_data.power_nb = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn genpd_set_default_power_state(genpd: *mut generic_pm_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genpd_provider_release(dev: *mut device) {
    static void genpd_provider_release(struct device *dev)
    {
// nothing to be done here
    }
#[no_mangle]
unsafe extern "C" fn genpd_alloc_data(genpd: *mut generic_pm_domain) -> c_int {
    static int genpd_alloc_data(struct generic_pm_domain *genpd)
    {
    struct genpd_governor_data *gd = core::ptr::null_mut();
    int ret;
    if (genpd_is_cpu_domain(genpd) &&
...
// Use only one "off" state if there were no states declared
    ...
    kfree(genpd.states);
    genpd.states = core::ptr::null_mut();
    }
    free:
    if (genpd_is_cpu_domain(genpd))
...
#[no_mangle]
unsafe extern "C" fn genpd_free_data(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_lock_init(genpd: *mut generic_pm_domain) {
...
#[no_mangle]
unsafe extern "C" fn genpd_set_stay_on(genpd: *mut generic_pm_domain, is_off: bool) {
...
//
    ...
    genpd.provider = core::ptr::null_mut();
    genpd.device_id = -ENXIO;
    genpd.has_provider = false;
    genpd.opp_table = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn genpd_remove(genpd: *mut generic_pm_domain) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pm_genpd_remove(genpd: *mut generic_pm_domain) -> c_int {
...
//
    ...
    let mut idx: c_uint = genpdspec.args[0];
...
#[no_mangle]
unsafe extern "C" fn genpd_present(genpd: *const generic_pm_domain) -> bool {
...
#[no_mangle]
unsafe extern "C" fn genpd_sync_state(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_genpd_del_provider(np: *mut device_node) {
...
// Get the child domain
    ...
    if (!child_genpd) {
    pr_err("Child domain %u is core::ptr::null_mut() for %pOF\n", child_id, np);
    ret = -EINVAL;
    goto err_unwind;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn of_genpd_add_device(genpdspec: *const of_phandle_args, dev: *mut device) -> c_int {
...
//
    ...
    out:
    mutex_unlock(&gpd_list_lock);
    let mut ret: return = = -ENOENT ? -EPROBE_DEFER : ret;
    }
...
#[no_mangle]
unsafe extern "C" fn genpd_release_dev(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn genpd_dev_pm_detach(dev: *mut device, power_off: bool) {
...
#[no_mangle]
unsafe extern "C" fn genpd_dev_pm_sync(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn genpd_set_required_opp(dev: *mut device, index: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn genpd_dev_pm_attach(dev: *mut device) -> c_int {
...
//
    ...
    let mut i: c_int = 0;
    ret = of_count_phandle_with_args(dn, "domain-idle-states", core::ptr::null_mut());
    if (ret <= 0)
    let mut ret: return = = -ENOENT ? 0 : ret;
// Loop over the phandles until all the requested entry is found
    of_for_each_phandle(&it, ret, dn, "domain-idle-states", core::ptr::null_mut(), 0) {
    np = it.node;
...
//
    ...
    int ret;
    ret = genpd_iterate_idle_states(dn, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    if (!ret) {
// states = NULL;
...
//
#[no_mangle]
pub unsafe extern "C" fn of_genpd_sync_state(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn genpd_provider_probe(dev: *mut device) -> c_int {
    static int genpd_provider_probe(struct device *dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn genpd_provider_sync_state(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn genpd_bus_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn rtpm_status_str(s: *mut seq_file, dev: *mut device) {
...
pub unsafe extern "C" fn if(_arg: dev->power.disable_depth) -> else {
    ...
    p = "unsupported";
#[no_mangle]
pub unsafe extern "C" fn if(ARRAY_SIZE(status_lookup): dev->power.runtime_status <) -> else {
...
#[no_mangle]
unsafe extern "C" fn perf_status_str(s: *mut seq_file, dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn mode_status_str(s: *mut seq_file, dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn summary_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn status_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sub_domains_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idle_states_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn idle_states_desc_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn active_time_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn total_idle_time_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devices_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perf_state_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn genpd_debug_add(genpd: *mut generic_pm_domain) {
    static void genpd_debug_add(struct generic_pm_domain *genpd)
    {
    struct dentry *d;
    if (!genpd_debugfs_dir)
...
#[no_mangle]
unsafe extern "C" fn genpd_debug_init() -> int __init {
    static int __init genpd_debug_init(void)
    {
    struct generic_pm_domain *genpd;
    genpd_debugfs_dir = debugfs_create_dir("pm_genpd", core::ptr::null_mut());
    debugfs_create_file("pm_genpd_summary", S_IRUGO, genpd_debugfs_dir,
    core::ptr::null_mut(), &summary_fops);
    list_for_each_entry(genpd, &gpd_list, gpd_list_node)
    genpd_debug_add(genpd);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn genpd_debug_exit() -> void __exit {
