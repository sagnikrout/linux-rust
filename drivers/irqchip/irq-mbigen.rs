...
//! Source: drivers/irqchip/irq-mbigen.c
#![no_std]
...
pub const IRQS_PER_MBIGEN_NODE: c_int = 128;
// 64 irqs (Pin0-pin63) are reserved for each mbigen chip
pub const RESERVED_IRQ_PER_MBIGEN_CHIP: c_int = 64;
// The maximum IRQ pin number of mbigen chip(start from 0)
pub const MAXIMUM_IRQ_PIN_NUM: c_int = 1407;
//
// In mbigen vector register
// bit[21:12]:	event id value
// bit[11:0]:	device id
//
pub const IRQ_EVENT_ID_SHIFT: c_int = 12;
pub const IRQ_EVENT_ID_MASK: c_uint = 0x3ff;
// register range of each mbigen node
pub const MBIGEN_NODE_OFFSET: c_uint = 0x1000;
// offset of vector register in mbigen node
pub const REG_MBIGEN_VEC_OFFSET: c_uint = 0x200;
//
// offset of clear register in mbigen node
// This register is used to clear the status
// of interrupt
//
pub const REG_MBIGEN_CLEAR_OFFSET: c_uint = 0xa000;
//
// offset of interrupt type register
// This register is used to configure interrupt
// trigger type
//
pub const REG_MBIGEN_TYPE_OFFSET: c_uint = 0x0;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mbigen_device {
    pub pdev: *mut platform_device,
    pub base: *mut void __iomem,
}

#[no_mangle]
pub unsafe extern "C" fn get_mbigen_node_offset(nid: c_uint) -> c_uint {
    static inline unsigned int get_mbigen_node_offset(unsigned int nid)
    {
    let mut offset: c_uint = nid * MBIGEN_NODE_OFFSET;
//
...
#[no_mangle]
pub unsafe extern "C" fn get_mbigen_vec_reg(hwirq: irq_hw_number_t) -> c_uint {
...
// addr = ofst + get_mbigen_node_offset(nid) + REG_MBIGEN_TYPE_OFFSET;
    ...
    u32 *mask, u32 *addr)
    {
    let mut ofst: c_uint = (hwirq / 32) * 4;
// mask = 1 << (hwirq % 32);
// addr = ofst + REG_MBIGEN_CLEAR_OFFSET;
    }
#[no_mangle]
unsafe extern "C" fn mbigen_eoi_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mbigen_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbigen_write_msi_msg(d: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn mbigen_domain_set_desc(arg: *mut msi_alloc_info_t, desc: *mut msi_desc) {
    ...
    core::ptr::null_mut(), mgn_chip.base);
    }
    ...
    continue;
    child = of_platform_device_create(np, core::ptr::null_mut(), core::ptr::null_mut());
    if (!child)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn mbigen_device_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ACPI_COMPANION(&pdev->dev)) -> else {
