...
//! Source: drivers/irqchip/irq-ls-scfg-msi.c
#![no_std]
...
pub const MSI_IRQS_PER_MSIR: c_int = 32;
pub const MSI_MSIR_OFFSET: c_int = 4;
pub const MSI_LS1043V1_1_IRQS_PER_MSIR: c_int = 8;
pub const MSI_LS1043V1_1_MSIR_OFFSET: c_uint = 0x10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ls_scfg_msi_cfg {
    pub /: *mut *mut u32 ibs_shift; / Shift of interrupt bit select,
    pub /: *mut *mut u32 msir_irqs; / The irq number per MSIR,
    pub /: *mut *mut u32 msir_base; / The base address of MSIR,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ls_scfg_msir {
    pub msi_data: *mut ls_scfg_msi,
    pub index: c_uint,
    pub gic_irq: c_uint,
    pub bit_start: c_uint,
    pub bit_end: c_uint,
    pub /: *mut *mut unsigned int srs; / Shared interrupt register select,
    pub reg: *mut void __iomem,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ls_scfg_msi {
    pub lock: spinlock_t,
    pub pdev: *mut platform_device,
    pub parent: *mut irq_domain,
    pub regs: *mut void __iomem,
    pub msiir_addr: phys_addr_t,
    pub cfg: *mut ls_scfg_msi_cfg,
    pub msir_num: u32,
    pub msir: *mut ls_scfg_msir,
    pub irqs_num: u32,
    pub used: *mut c_ulong,
}
    ...
    let mut msi_affinity_flag: static int = 1;
#[no_mangle]
unsafe extern "C" fn early_parse_ls_scfg_msi(p: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ls_scfg_msi_compose_msg(data: *mut irq_data, msg: *mut msi_msg) {
    ...
    handle_simple_irq, core::ptr::null_mut(), core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn ls_scfg_msi_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn ls_scfg_msi_domains_init(msi_data: *mut ls_scfg_msi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ls_scfg_msi_setup_hwirq(msi_data: *mut ls_scfg_msi, index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ls_scfg_msi_teardown_hwirq(msir: *mut ls_scfg_msir) -> c_int {
    static int ls_scfg_msi_teardown_hwirq(struct ls_scfg_msir *msir)
    {
    struct ls_scfg_msi *msi_data = msir.msi_data;
    int i, hwirq;
    if (msir.gic_irq > 0)
    irq_set_chained_handler_and_data(msir.gic_irq, core::ptr::null_mut(), core::ptr::null_mut());
    for (i = 0; i < msi_data.cfg.msir_irqs; i++) {
    hwirq = i << msi_data.cfg.ibs_shift | msir.index;
...
#[no_mangle]
unsafe extern "C" fn ls_scfg_msi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ls_scfg_msi_remove(pdev: *mut platform_device) {
