...
//! Source: drivers/irqchip/irq-riscv-aplic-direct.c
#![no_std]
...
pub const APLIC_DISABLE_IDELIVERY: c_int = 0;
pub const APLIC_ENABLE_IDELIVERY: c_int = 1;
pub const APLIC_DISABLE_ITHRESHOLD: c_int = 1;
pub const APLIC_ENABLE_ITHRESHOLD: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aplic_direct {
    pub priv: aplic_priv,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aplic_idc {
    pub hart_index: u32,
    pub regs: *mut void __iomem,
    pub direct: *mut aplic_direct,
}

    static unsigned int aplic_direct_parent_irq;
    static DEFINE_PER_CPU(struct aplic_idc, aplic_idcs);
#[no_mangle]
unsafe extern "C" fn aplic_direct_irq_eoi(d: *mut irq_data) {
...
//
    ...
    priv, handle_fasteoi_irq, core::ptr::null_mut(), core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn aplic_direct_handle_irq(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn aplic_idc_set_delivery(idc: *mut aplic_idc, en: bool) {
    static void aplic_idc_set_delivery(struct aplic_idc *idc, bool en)
    {
    let mut de: u32 = (en) ? APLIC_ENABLE_IDELIVERY : APLIC_DISABLE_IDELIVERY;
    let mut th: u32 = (en) ? APLIC_ENABLE_ITHRESHOLD : APLIC_DISABLE_ITHRESHOLD;
...
#[no_mangle]
pub unsafe extern "C" fn aplic_direct_restore_states(priv: *mut aplic_priv) {
...
#[no_mangle]
unsafe extern "C" fn aplic_direct_dying_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aplic_direct_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aplic_direct_setup(dev: *mut device, regs: *mut void __iomem) -> c_int {
