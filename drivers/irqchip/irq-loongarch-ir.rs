...
//! Source: drivers/irqchip/irq-loongarch-ir.c
#![no_std]
...
pub const LOONGARCH_IOCSR_REDIRECT_CFG: c_uint = 0x15e0;
pub const LOONGARCH_IOCSR_REDIRECT_TBR: c_uint = 0x15e8  /* IRT BASE REG */;
pub const LOONGARCH_IOCSR_REDIRECT_CQB: c_uint = 0x15f0  /* IRT CACHE QUEUE BASE */;
pub const LOONGARCH_IOCSR_REDIRECT_CQH: c_uint = 0x15f8  /* IRT CACHE QUEUE HEAD, 32bit */;
pub const LOONGARCH_IOCSR_REDIRECT_CQT: c_uint = 0x15fc  /* IRT CACHE QUEUE TAIL, 32bit */;

pub const CQB_SIZE_MASK: c_uint = 0xf;

pub const GPID_ADDR_SHIFT: c_int = 6;
pub const INVALID_INDEX: c_int = 0;
pub const CFG_DISABLE_IDLE: c_int = 2;
pub const MAX_IR_ENGINES: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct redirect_entry {
    struct  {
    u64	valid	: 1,
    res1	: 5,
    gpid	: 42,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct redirect_gpid {
    pub /: *mut *mut u64 pir[4]; / Pending interrupt requested,
    u8	en	: 1, /* Doorbell */
    pub 7: res1 :,
    pub irqnum: u8,
    pub res2: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct redirect_table {
    pub table: *mut redirect_entry,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct redirect_queue {
    pub cmd_base: *mut redirect_cmd,
    pub head: c_int,
    pub tail: c_int,
    pub lock: raw_spinlock_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct redirect_desc {
    pub ird_table: redirect_table,
    pub inv_queue: redirect_queue,
    pub node: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct redirect_item {
    pub index: c_int,
    pub irde: *mut redirect_desc,
    pub gpid: *mut redirect_gpid,
}
    ...
    let mut redirect_reg_base: static phys_addr_t = LOONGSON_REG_BASE;
...
#[no_mangle]
pub unsafe extern "C" fn redirect_read_reg32(node: u32, reg: u32) -> u32 {
    static inline u32 redirect_read_reg32(u32 node, u32 reg)
    {
    return readl(REDIRECT_REG(reg, node));
    }
#[no_mangle]
pub unsafe extern "C" fn redirect_write_reg32(node: u32, val: u32, reg: u32) {
    static inline void redirect_write_reg32(u32 node, u32 val, u32 reg)
    {
    writel(val, REDIRECT_REG(reg, node));
    }
#[no_mangle]
pub unsafe extern "C" fn redirect_write_reg64(node: u32, val: u64, reg: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn invalid_queue_is_full(node: c_int, tail: *mut u32) -> bool {
    static inline bool invalid_queue_is_full(int node, u32 *tail)
    {
    let mut head: u32 = redirect_read_reg32(node, LOONGARCH_IOCSR_REDIRECT_CQH);
// tail = redirect_read_reg32(node, LOONGARCH_IOCSR_REDIRECT_CQT);
    let mut head: return = = ((*tail + 1) % INV_QUEUE_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn invalid_enqueue(item: *mut redirect_item, cmd: *mut redirect_cmd) {
...
#[no_mangle]
unsafe extern "C" fn irde_invalidate_entry(item: *mut redirect_item) {
...
#[no_mangle]
unsafe extern "C" fn redirect_table_alloc(node: c_int, nr_irqs: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn redirect_table_free(item: *mut redirect_item) {
...
#[no_mangle]
unsafe extern "C" fn redirect_set_affinity(data: *mut irq_data, dest: *const cpumask, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn redirect_compose_msi_msg(d: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn redirect_domain_free(domain: *mut irq_domain, virq: c_uint, nr_irqs: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn redirect_table_init(irde: *mut redirect_desc) -> c_int {
    ...
    folio_put(folio);
    ird_table.table = core::ptr::null_mut();
    return -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn redirect_queue_init(irde: *mut redirect_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn redirect_irde_cfg(irde: *mut redirect_desc) {
...
#[no_mangle]
unsafe extern "C" fn redirect_irde_free(irde: *mut redirect_desc) -> void __init {
    ...
    ird_table.bitmap = core::ptr::null_mut();
    }
    if (inv_queue.cmd_base) {
    folio_put(virt_to_folio(inv_queue.cmd_base));
    inv_queue.cmd_base = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn redirect_irde_init(node: c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pch_msi_parse_madt(header: *mut union acpi_subtable_headers, end: c_ulong) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn redirect_acpi_init(parent: *mut irq_domain) -> int __init {
    int __init redirect_acpi_init(struct irq_domain *parent)
    {
    struct fwnode_handle *fwnode;
    let mut ret: c_int = -EINVAL, node;
