...
//! Source: drivers/irqchip/spear-shirq.c
#![no_std]
...
pub const SPEAR300_INT_ENB_MASK_REG: c_uint = 0x54;
pub const SPEAR300_INT_STS_MASK_REG: c_uint = 0x58;
    static DEFINE_RAW_SPINLOCK(shirq_lock);
#[no_mangle]
unsafe extern "C" fn shirq_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn shirq_irq_unmask(d: *mut irq_data) {
...
pub const SPEAR310_INT_STS_MASK_REG: c_uint = 0x04;
...
pub const SPEAR320_INT_STS_MASK_REG: c_uint = 0x04;
pub const SPEAR320_INT_CLR_MASK_REG: c_uint = 0x04;
pub const SPEAR320_INT_ENB_MASK_REG: c_uint = 0x08;
...
#[no_mangle]
unsafe extern "C" fn shirq_handler(desc: *mut irq_desc) {
