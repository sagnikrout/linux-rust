...
//! Source: drivers/irqchip/irq-vf610-mscm-ir.c
#![no_std]
...
pub const MSCM_CPxNUM: c_uint = 0x4;

pub const MSCM_IRSPRC_CPEN_MASK: c_uint = 0x3;
pub const MSCM_IRSPRC_NUM: c_int = 112;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vf610_mscm_ir_chip_data {
    pub mscm_ir_base: *mut void __iomem,
    pub cpu_mask: u16,
    pub saved_irsprc: [u16; MSCM_IRSPRC_NUM],
    pub is_nvic: bool,
}

    static struct vf610_mscm_ir_chip_data *mscm_ir_data;
#[no_mangle]
pub unsafe extern "C" fn vf610_mscm_ir_save(data: *mut vf610_mscm_ir_chip_data) {
...
#[no_mangle]
pub unsafe extern "C" fn vf610_mscm_ir_restore(data: *mut vf610_mscm_ir_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn vf610_mscm_ir_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn vf610_mscm_ir_disable(data: *mut irq_data) {
