...
//! Source: drivers/irqchip/irq-al-fic.c
#![no_std]
...
// FIC Registers
pub const AL_FIC_CAUSE: c_uint = 0x00;
pub const AL_FIC_SET_CAUSE: c_uint = 0x08;
pub const AL_FIC_MASK: c_uint = 0x10;
pub const AL_FIC_CONTROL: c_uint = 0x28;

pub const NR_FIC_IRQS: c_int = 32;
...
pub struct al_fic {
    ...
    let mut control: u32 = readl_relaxed(fic.base + AL_FIC_CONTROL);
...
#[no_mangle]
unsafe extern "C" fn al_fic_irq_set_type(data: *mut irq_data, flow_type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn al_fic_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn al_fic_irq_retrigger(data: *mut irq_data) -> c_int {
...
//
    ...
    struct al_fic *fic;
    int ret;
    let mut control: u32 = CONTROL_MASK_MSI_X;
    fic = kzalloc_obj(*fic);
    if (!fic)
