...
//! Source: drivers/irqchip/irq-jcore-aic.c
#![no_std]
...
pub const JCORE_AIC_MAX_HWIRQ: c_int = 127;
pub const JCORE_AIC1_MIN_HWIRQ: c_int = 16;
pub const JCORE_AIC2_MIN_HWIRQ: c_int = 64;
pub const JCORE_AIC1_INTPRI_REG: c_int = 8;
...
//
#[no_mangle]
unsafe extern "C" fn handle_jcore_irq(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn noop(data: *mut irq_data) {
    ...
    {
    let mut min_irq: unsigned = JCORE_AIC2_MIN_HWIRQ;
    let mut dom_sz: unsigned = JCORE_AIC_MAX_HWIRQ+1;
