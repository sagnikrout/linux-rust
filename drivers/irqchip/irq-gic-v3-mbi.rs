...
//! Source: drivers/irqchip/irq-gic-v3-mbi.c
#![no_std]
...
//
    ...
    struct mbi_range *mbi = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mbi_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn mbi_compose_mbi_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn mbi_allocate_domain(parent: *mut irq_domain) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mbi_init(fwnode: *mut fwnode_handle, parent: *mut irq_domain) -> int __init {
    ...
    reg = of_get_property(np, "mbi-alias", core::ptr::null_mut());
    if (reg) {
