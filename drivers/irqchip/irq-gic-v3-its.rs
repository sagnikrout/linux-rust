...
pub struct its_node {
    ...
    pub dev_alloc_lock: mutex,
    pub entry: list_head,
    pub base: *mut void __iomem,
    pub sgir_base: *mut void __iomem,
    pub phys_base: phys_addr_t,
    pub cmd_base: *mut its_cmd_block,
    pub cmd_write: *mut its_cmd_block,
    pub tables: [its_baser; GITS_BASER_NR_REGS],
    pub collections: *mut its_collection,
    pub fwnode_handle: *mut fwnode_handle,
    pub its_dev): *mut *mut u64 (get_msi_base)(struct its_device,
    pub typer: u64,
    pub cbaser_save: u64,
    pub ctlr_save: u32,
    pub mpidr: u32,
    pub its_device_list: list_head,
    pub flags: u64,
    pub list_nr: c_ulong,
    pub numa_node: c_int,
    pub msi_domain_flags: c_uint,
    pub /: *mut *mut u32 pre_its_base; / for Socionext Synquacer,
    pub vlpi_redist_offset: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct event_lpi_map {
    pub lpi_map: *mut c_ulong,
    pub col_map: *mut u16,
    pub lpi_base: irq_hw_number_t,
    pub nr_lpis: c_int,
    pub vlpi_lock: raw_spinlock_t,
    pub vm: *mut its_vm,
    pub vlpi_maps: *mut its_vlpi_map,
    pub nr_vlpis: c_int,
}
...
pub struct its_device {
    pub entry: list_head,
    pub its: *mut its_node,
    pub event_map: event_lpi_map,
    pub itt: *mut c_void,
    pub itt_sz: u32,
    pub nr_ites: u32,
    pub device_id: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpu_lpi_count {
    pub managed: core::sync::atomic::AtomicI32,
    pub unmanaged: core::sync::atomic::AtomicI32,
}
...
#[no_mangle]
unsafe extern "C" fn its_free_pages(addr: *mut c_void, order: c_uint) {
...
//
    ...
    return page ? page_address(page) : core::ptr::null_mut();
    }
    do {
...
#[no_mangle]
unsafe extern "C" fn itt_free_pool(addr: *mut c_void, size: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn require_its_list_vmovp(vm: *mut its_vm, its: *mut its_node) -> bool {
    static bool require_its_list_vmovp(struct its_vm *vm, struct its_node *its)
    {
    return (gic_rdists.has_rvpeid || vm.vlpi_count[its.list_nr]);
    }
#[no_mangle]
unsafe extern "C" fn rdists_support_shareable() -> bool {
    static bool rdists_support_shareable(void)
    {
    return !(gic_rdists.flags & RDIST_FLAGS_FORCE_NON_SHAREABLE);
    }
#[no_mangle]
unsafe extern "C" fn get_its_list(vm: *mut its_vm) -> u16 {
    static u16 get_its_list(struct its_vm *vm)
    {
    struct its_node *its;
    let mut its_list: c_ulong = 0;
...
#[no_mangle]
pub unsafe extern "C" fn its_get_event_id(d: *mut irq_data) -> u32 {
    ...
    struct its_device *its_dev = irq_data_get_irq_chip_data(d);
    let mut event: u32 = its_get_event_id(d);
    return dev_event_to_vlpi_map(its_dev, event);
    }
    return core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn vpe_to_cpuid_lock(vpe: *mut its_vpe, flags: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpe_to_cpuid_unlock(vpe: *mut its_vpe, flags: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn irq_to_cpuid_lock(d: *mut irq_data, flags: *mut c_ulong) -> c_int {
    static int irq_to_cpuid_lock(struct irq_data *d, unsigned long *flags)
    {
    struct its_vpe *vpe = core::ptr::null_mut();
    int cpu;
...
#[no_mangle]
unsafe extern "C" fn irq_to_cpuid_unlock(d: *mut irq_data, flags: c_ulong) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct its_cmd_block {
    union {
    pub raw_cmd: [u64; 4],
    pub raw_cmd_le: [__le64; 4],
}
    ...
    struct its_cmd_desc *);
#[no_mangle]
unsafe extern "C" fn its_mask_encode(raw_cmd: *mut u64, val: u64, h: c_int, l: c_int) {
    static void its_mask_encode(u64 *raw_cmd, u64 val, int h, int l)
    {
    let mut mask: u64 = GENMASK_ULL(h, l);
// raw_cmd &= ~mask;
// raw_cmd |= (val << l) & mask;
    }
#[no_mangle]
unsafe extern "C" fn its_encode_cmd(cmd: *mut its_cmd_block, cmd_nr: u8) {
    static void its_encode_cmd(struct its_cmd_block *cmd, u8 cmd_nr)
    {
    its_mask_encode(&cmd.raw_cmd[0], cmd_nr, 7, 0);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_devid(cmd: *mut its_cmd_block, devid: u32) {
    static void its_encode_devid(struct its_cmd_block *cmd, u32 devid)
    {
    its_mask_encode(&cmd.raw_cmd[0], devid, 63, 32);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_event_id(cmd: *mut its_cmd_block, id: u32) {
    static void its_encode_event_id(struct its_cmd_block *cmd, u32 id)
    {
    its_mask_encode(&cmd.raw_cmd[1], id, 31, 0);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_phys_id(cmd: *mut its_cmd_block, phys_id: u32) {
    static void its_encode_phys_id(struct its_cmd_block *cmd, u32 phys_id)
    {
    its_mask_encode(&cmd.raw_cmd[1], phys_id, 63, 32);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_size(cmd: *mut its_cmd_block, size: u8) {
    static void its_encode_size(struct its_cmd_block *cmd, u8 size)
    {
    its_mask_encode(&cmd.raw_cmd[1], size, 4, 0);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_itt(cmd: *mut its_cmd_block, itt_addr: u64) {
    static void its_encode_itt(struct its_cmd_block *cmd, u64 itt_addr)
    {
    its_mask_encode(&cmd.raw_cmd[2], itt_addr >> 8, 51, 8);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_valid(cmd: *mut its_cmd_block, valid: c_int) {
    static void its_encode_valid(struct its_cmd_block *cmd, int valid)
    {
    its_mask_encode(&cmd.raw_cmd[2], !!valid, 63, 63);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_target(cmd: *mut its_cmd_block, target_addr: u64) {
    static void its_encode_target(struct its_cmd_block *cmd, u64 target_addr)
    {
    its_mask_encode(&cmd.raw_cmd[2], target_addr >> 16, 51, 16);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_collection(cmd: *mut its_cmd_block, col: u16) {
    static void its_encode_collection(struct its_cmd_block *cmd, u16 col)
    {
    its_mask_encode(&cmd.raw_cmd[2], col, 15, 0);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_vpeid(cmd: *mut its_cmd_block, vpeid: u16) {
    static void its_encode_vpeid(struct its_cmd_block *cmd, u16 vpeid)
    {
    its_mask_encode(&cmd.raw_cmd[1], vpeid, 47, 32);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_virt_id(cmd: *mut its_cmd_block, virt_id: u32) {
    static void its_encode_virt_id(struct its_cmd_block *cmd, u32 virt_id)
    {
    its_mask_encode(&cmd.raw_cmd[2], virt_id, 31, 0);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_db_phys_id(cmd: *mut its_cmd_block, db_phys_id: u32) {
    static void its_encode_db_phys_id(struct its_cmd_block *cmd, u32 db_phys_id)
    {
    its_mask_encode(&cmd.raw_cmd[2], db_phys_id, 63, 32);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_db_valid(cmd: *mut its_cmd_block, db_valid: bool) {
    static void its_encode_db_valid(struct its_cmd_block *cmd, bool db_valid)
    {
    its_mask_encode(&cmd.raw_cmd[2], db_valid, 0, 0);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_seq_num(cmd: *mut its_cmd_block, seq_num: u16) {
    static void its_encode_seq_num(struct its_cmd_block *cmd, u16 seq_num)
    {
    its_mask_encode(&cmd.raw_cmd[0], seq_num, 47, 32);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_its_list(cmd: *mut its_cmd_block, its_list: u16) {
    static void its_encode_its_list(struct its_cmd_block *cmd, u16 its_list)
    {
    its_mask_encode(&cmd.raw_cmd[1], its_list, 15, 0);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_vpt_addr(cmd: *mut its_cmd_block, vpt_pa: u64) {
    static void its_encode_vpt_addr(struct its_cmd_block *cmd, u64 vpt_pa)
    {
    its_mask_encode(&cmd.raw_cmd[3], vpt_pa >> 16, 51, 16);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_vpt_size(cmd: *mut its_cmd_block, vpt_size: u8) {
    static void its_encode_vpt_size(struct its_cmd_block *cmd, u8 vpt_size)
    {
    its_mask_encode(&cmd.raw_cmd[3], vpt_size, 4, 0);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_vconf_addr(cmd: *mut its_cmd_block, vconf_pa: u64) {
    static void its_encode_vconf_addr(struct its_cmd_block *cmd, u64 vconf_pa)
    {
    its_mask_encode(&cmd.raw_cmd[0], vconf_pa >> 16, 51, 16);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_alloc(cmd: *mut its_cmd_block, alloc: bool) {
    static void its_encode_alloc(struct its_cmd_block *cmd, bool alloc)
    {
    its_mask_encode(&cmd.raw_cmd[0], alloc, 8, 8);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_ptz(cmd: *mut its_cmd_block, ptz: bool) {
...
#[no_mangle]
unsafe extern "C" fn its_encode_db(cmd: *mut its_cmd_block, db: bool) {
    static void its_encode_db(struct its_cmd_block *cmd, bool db)
    {
    its_mask_encode(&cmd.raw_cmd[2], db, 63, 63);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_sgi_intid(cmd: *mut its_cmd_block, sgi: u8) {
    static void its_encode_sgi_intid(struct its_cmd_block *cmd, u8 sgi)
    {
    its_mask_encode(&cmd.raw_cmd[0], sgi, 35, 32);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_sgi_priority(cmd: *mut its_cmd_block, prio: u8) {
    static void its_encode_sgi_priority(struct its_cmd_block *cmd, u8 prio)
    {
    its_mask_encode(&cmd.raw_cmd[0], prio >> 4, 23, 20);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_sgi_group(cmd: *mut its_cmd_block, grp: bool) {
    static void its_encode_sgi_group(struct its_cmd_block *cmd, bool grp)
    {
    its_mask_encode(&cmd.raw_cmd[0], grp, 10, 10);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_sgi_clear(cmd: *mut its_cmd_block, clr: bool) {
    static void its_encode_sgi_clear(struct its_cmd_block *cmd, bool clr)
    {
    its_mask_encode(&cmd.raw_cmd[0], clr, 9, 9);
    }
#[no_mangle]
unsafe extern "C" fn its_encode_sgi_enable(cmd: *mut its_cmd_block, en: bool) {
    static void its_encode_sgi_enable(struct its_cmd_block *cmd, bool en)
    {
    its_mask_encode(&cmd.raw_cmd[0], en, 8, 8);
    }
#[no_mangle]
pub unsafe extern "C" fn its_fixup_cmd(cmd: *mut its_cmd_block) {
...
// Let's fixup BE commands
    ...
    let mut size: u8 = ilog2(desc.its_mapd_cmd.dev.nr_ites);
...
#[no_mangle]
unsafe extern "C" fn its_queue_full(its: *mut its_node) -> c_int {
...
// Clear command
    ...
    {
    let mut wr: u64 = its_cmd_ptr_to_offset(its, its.cmd_write);
    writel_relaxed(wr, its.base + GITS_CWRITER);
    return its.cmd_write;
    }
#[no_mangle]
unsafe extern "C" fn its_flush_cmd(its: *mut its_node, cmd: *mut its_cmd_block) {
...
#[no_mangle]
unsafe extern "C" fn its_send_int(dev: *mut its_device, event_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_clear(dev: *mut its_device, event_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_inv(dev: *mut its_device, event_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_mapd(dev: *mut its_device, valid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn its_send_mapti(dev: *mut its_device, irq_id: u32, id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_discard(dev: *mut its_device, id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_invall(its: *mut its_node, col: *mut its_collection) {
...
#[no_mangle]
unsafe extern "C" fn its_send_vmapti(dev: *mut its_device, id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_vmovi(dev: *mut its_device, id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_vmovp(vpe: *mut its_vpe) {
    static void its_send_vmovp(struct its_vpe *vpe)
    {
    let mut desc: its_cmd_desc = {};
    struct its_node *its;
    let mut col_id: c_int = vpe.col_idx;
...
#[no_mangle]
unsafe extern "C" fn its_send_vinvall(its: *mut its_node, vpe: *mut its_vpe) {
...
#[no_mangle]
unsafe extern "C" fn its_send_vinv(dev: *mut its_device, event_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_vint(dev: *mut its_device, event_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_vclear(dev: *mut its_device, event_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn its_send_invdb(its: *mut its_node, vpe: *mut its_vpe) {
...
//
#[no_mangle]
unsafe extern "C" fn lpi_write_config(d: *mut irq_data, clr: u8, set: u8) {
...
#[no_mangle]
unsafe extern "C" fn wait_for_syncr(rdbase: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn __direct_lpi_inv(d: *mut irq_data, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn direct_lpi_inv(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn lpi_update_config(d: *mut irq_data, clr: u8, set: u8) {
    ...
    direct_lpi_inv(d);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !irqd_is_forwarded_to_vcpu(d)) -> else {
...
#[no_mangle]
unsafe extern "C" fn its_vlpi_set_doorbell(d: *mut irq_data, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn its_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_unmask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_read_lpi_count(d: *mut irq_data, cpu: c_int) -> __maybe_unused u32 {
...
#[no_mangle]
unsafe extern "C" fn its_inc_lpi_count(d: *mut irq_data, cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn its_dec_lpi_count(d: *mut irq_data, cpu: c_int) {
    ...
    {
    let mut cpu: c_uint = nr_cpu_ids, tmp;
    let mut count: c_int = S32_MAX;
    for_each_cpu(tmp, cpu_mask) {
    let mut this_count: c_int = its_read_lpi_count(d, tmp);
    if (this_count < count) {
    cpu = tmp;
    count = this_count;
    }
...
// If we cannot cross sockets, limit the search to that node
    ...
    let mut id: u32 = its_get_event_id(d);
    int cpu, prev_cpu;
...
#[no_mangle]
unsafe extern "C" fn its_irq_get_msi_base(its_dev: *mut its_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn its_irq_compose_msi_msg(d: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn its_irq_retrigger(d: *mut irq_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gic_requires_eager_mapping() -> bool {
...
#[no_mangle]
unsafe extern "C" fn its_map_vm(its: *mut its_node, vm: *mut its_vm) {
...
#[no_mangle]
unsafe extern "C" fn its_unmap_vm(its: *mut its_node, vm: *mut its_vm) {
...
#[no_mangle]
unsafe extern "C" fn its_vlpi_map(d: *mut irq_data, info: *mut its_cmd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_vlpi_get(d: *mut irq_data, info: *mut its_cmd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_vlpi_unmap(d: *mut irq_data) -> c_int {
...
//
    ...
    its_dev.event_map.vm = core::ptr::null_mut();
    kfree(its_dev.event_map.vlpi_maps);
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn its_vlpi_prop_update(d: *mut irq_data, info: *mut its_cmd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_irq_set_vcpu_affinity(d: *mut irq_data, vcpu_info: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alloc_lpi_range(nr_lpis: u32, base: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn merge_lpi_ranges(a: *mut lpi_range, b: *mut lpi_range) {
...
#[no_mangle]
unsafe extern "C" fn free_lpi_range(base: u32, nr_lpis: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_lpi_init(id_bits: u32) -> int __init {
    static int __init its_lpi_init(u32 id_bits)
    {
    let mut lpis: u32 = (1UL << id_bits) - 8192;
    u32 numlpis;
    int err;
...
//
    ...
    {
    unsigned long *bitmap = core::ptr::null_mut();
    let mut err: c_int = 0;
    do {
...
#[no_mangle]
unsafe extern "C" fn its_lpi_free(bitmap: *mut c_ulong, base: u32, nr_ids: u32) {
...
#[no_mangle]
unsafe extern "C" fn gic_reset_prop_table(va: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn its_free_prop_table(prop_page: *mut page) {
    static void its_free_prop_table(struct page *prop_page)
    {
    its_free_pages(page_address(prop_page), get_order(LPI_PROPBASE_SZ));
    }
#[no_mangle]
unsafe extern "C" fn gic_check_reserved_range(addr: phys_addr_t, size: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_reserve_range(addr: phys_addr_t, size: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_setup_lpi_prop_table() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn its_read_baser(its: *mut its_node, baser: *mut its_baser) -> u64 {
    static u64 its_read_baser(struct its_node *its, struct its_baser *baser)
    {
    let mut idx: u32 = baser - its.tables;
    ...
    {
    let mut val: u64 = its_read_baser(its, baser);
    let mut esz: u64 = GITS_BASER_ENTRY_SIZE(val);
    let mut type: u64 = GITS_BASER_TYPE(val);
    u64 baser_phys, tmp;
    u32 alloc_pages, psz;
    struct page *page;
    void *base;
...
//
    ...
    u32 *order, u32 ids)
    {
    let mut tmp: u64 = its_read_baser(its, baser);
    let mut type: u64 = GITS_BASER_TYPE(tmp);
    let mut esz: u64 = GITS_BASER_ENTRY_SIZE(tmp);
    let mut val: u64 = GITS_BASER_InnerShareable | GITS_BASER_RaWaWb;
    let mut new_order: u32 = *order;
    let mut psz: u32 = baser.psz;
...
#[no_mangle]
unsafe extern "C" fn compute_common_aff(val: u64) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn compute_its_aff(its: *mut its_node) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn its_free_tables(its: *mut its_node) {
    ...
    its.tables[i].base = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn its_probe_baser_psz(its: *mut its_node, baser: *mut its_baser) -> c_int {
    static int its_probe_baser_psz(struct its_node *its, struct its_baser *baser)
    {
    let mut psz: u64 = SZ_64K;
    while (psz) {
    u64 val, gpsz;
...
#[no_mangle]
unsafe extern "C" fn its_alloc_tables(its: *mut its_node) -> c_int {
    static int its_alloc_tables(struct its_node *its)
    {
    let mut shr: u64 = GITS_BASER_InnerShareable;
    let mut cache: u64 = GITS_BASER_RaWaWb;
    int err, i;
...
#[no_mangle]
unsafe extern "C" fn inherit_vpe_l1_table_from_its() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn inherit_vpe_l1_table_from_rd(mask: *mut cpumask_t) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn allocate_vpe_l2_table(cpu: c_int, id: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn allocate_vpe_l1_table() -> c_int {
    static int allocate_vpe_l1_table(void)
    {
    void __iomem *vlpi_base = gic_data_rdist_vlpi_base();
    u64 val, gpsz, npg, pa;
    let mut psz: c_uint = SZ_64K;
...
#[no_mangle]
unsafe extern "C" fn its_alloc_collections(its: *mut its_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_free_pending_table(pt: *mut page) {
...
//
#[no_mangle]
unsafe extern "C" fn enabled_lpis_allowed() -> bool {
...
#[no_mangle]
unsafe extern "C" fn allocate_lpi_tables() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn read_vpend_dirty_clear(vlpi_base: *mut void __iomem) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn its_clear_vpend_valid(vlpi_base: *mut void __iomem, clr: u64, set: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn its_cpu_init_lpis() {
...
#[no_mangle]
unsafe extern "C" fn its_cpu_init_collection(its: *mut its_node) {
...
// avoid cross node collections and its mapping
    ...
    struct device_node *cpu_node __free(device_node) = of_get_cpu_node(cpu, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn its_cpu_init_collections() {
    ...
    {
    struct its_device *its_dev = core::ptr::null_mut(), *tmp;
    unsigned long flags;
    raw_spin_lock_irqsave(&its.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn its_alloc_device_table(its: *mut its_node, dev_id: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn its_alloc_vpe_table(vpe_id: u32) -> bool {
...
//
    ...
    {
    struct its_device *dev;
    unsigned long *lpi_map = core::ptr::null_mut();
    unsigned long flags;
    u16 *col_map = core::ptr::null_mut();
    void *itt;
    int lpi_base;
    int nr_lpis;
    int nr_ites;
...
#[no_mangle]
unsafe extern "C" fn its_free_device(its_dev: *mut its_device) {
...
#[no_mangle]
unsafe extern "C" fn its_alloc_device_irq(dev: *mut its_device, nvecs: c_int, hwirq: *mut irq_hw_number_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_msi_teardown(domain: *mut irq_domain, info: *mut msi_alloc_info_t) {
...
//
#[no_mangle]
unsafe extern "C" fn its_vpe_db_proxy_unmap_locked(vpe: *mut its_vpe) {
...
// Already unmapped?
    ...
    vpe_proxy.vpes[vpe.vpe_proxy_event] = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn its_vpe_db_proxy_unmap(vpe: *mut its_vpe) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_db_proxy_map_locked(vpe: *mut its_vpe) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_db_proxy_move(vpe: *mut its_vpe, from: c_int, to: c_int) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_4_1_invall_locked(cpu: c_int, vpe: *mut its_vpe) {
...
#[no_mangle]
unsafe extern "C" fn its_wait_vpt_parse_complete() {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_schedule(vpe: *mut its_vpe) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_deschedule(vpe: *mut its_vpe) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_invall(vpe: *mut its_vpe) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_set_vcpu_affinity(d: *mut irq_data, vcpu_info: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_send_inv(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_unmask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_retrigger(d: *mut irq_data) -> c_int {
...
// Oops?
    its = core::ptr::null_mut();
    }
    return its;
    }
#[no_mangle]
unsafe extern "C" fn its_vpe_4_1_send_inv(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_4_1_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_4_1_unmask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_4_1_invall(vpe: *mut its_vpe) {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_4_1_set_vcpu_affinity(d: *mut irq_data, vcpu_info: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_configure_sgi(d: *mut irq_data, clear: bool) {
...
#[no_mangle]
unsafe extern "C" fn its_sgi_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_sgi_unmask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn its_sgi_set_vcpu_affinity(d: *mut irq_data, vcpu_info: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_id_alloc() -> c_int {
    static int its_vpe_id_alloc(void)
    {
    return ida_alloc_max(&its_vpeid_ida, ITS_MAX_VPEID - 1, GFP_KERNEL);
    }
#[no_mangle]
unsafe extern "C" fn its_vpe_id_free(id: u16) {
    static void its_vpe_id_free(u16 id)
    {
    ida_free(&its_vpeid_ida, id);
    }
#[no_mangle]
unsafe extern "C" fn its_vpe_init(vpe: *mut its_vpe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_vpe_teardown(vpe: *mut its_vpe) {
...
//
    if (vpe.vpt_page == core::ptr::null_mut())
    return;
...
#[no_mangle]
unsafe extern "C" fn its_force_quiescent(base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_enable_quirk_cavium_22375(data: *mut c_void) -> bool __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn its_enable_quirk_cavium_23144(data: *mut c_void) -> bool __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn its_enable_quirk_qdf2400_e0065(data: *mut c_void) -> bool __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn its_irq_get_msi_base_pre_its(its_dev: *mut its_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn its_enable_quirk_socionext_synquacer(data: *mut c_void) -> bool __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn its_enable_quirk_hip07_161600802(data: *mut c_void) -> bool __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn its_enable_rk3588001(data: *mut c_void) -> bool __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn its_set_non_coherent(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn its_enable_quirk_hip09_162100801(data: *mut c_void) -> bool __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn its_enable_dma32(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn its_enable_quirks(its: *mut its_node) {
    static void its_enable_quirks(struct its_node *its)
    {
    let mut iidr: u32 = readl_relaxed(its.base + GITS_IIDR);
...
#[no_mangle]
unsafe extern "C" fn its_save_disable(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_restore_enable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn its_init_domain(its: *mut its_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_init_vpe_domain() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_compute_its_list_map(its: *mut its_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn its_probe_one(its: *mut its_node) -> int __init {
    ...
    if (is_v4_1(its)) {
    let mut svpet: u32 = FIELD_GET(GITS_TYPER_SVPET, its.typer);
...
#[no_mangle]
unsafe extern "C" fn gic_rdists_supports_plpis() -> bool {
    static bool gic_rdists_supports_plpis(void)
    {
    return !!(gic_read_typer(gic_data_rdist_rd_base() + GICR_TYPER) & GICR_TYPER_PLPIS);
    }
#[no_mangle]
unsafe extern "C" fn redist_disable_lpis() -> c_int {
    static int redist_disable_lpis(void)
    {
    void __iomem *rbase = gic_data_rdist_rd_base();
    let mut timeout: u64 = USEC_PER_SEC;
    u64 val;
...
#[no_mangle]
pub unsafe extern "C" fn its_cpu_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rdist_memreserve_cpuhp_cleanup_workfn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn its_cpu_memreserve_lpi(cpu: c_uint) -> c_int {
...
//
    ...
    gic_data_rdist().pend_page = core::ptr::null_mut();
    } else {
    let mut paddr: phys_addr_t = page_to_phys(pend_page);
...
#[no_mangle]
unsafe extern "C" fn its_reset_one(res: *mut resource) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn its_node_destroy(its: *mut its_node) {
...
#[no_mangle]
unsafe extern "C" fn its_of_probe(node: *mut device_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_get_its_numa_node(its_id: u32) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_parse_srat_its() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_its_srat_maps_free() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn its_acpi_probe() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn its_lpi_memreserve_init() -> int __init {
    ...
    struct its_node *its;
    let mut has_v4: bool = false;
    let mut has_v4_1: bool = false;
    int err;
