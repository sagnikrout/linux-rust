...
//! Source: drivers/irqchip/irq-brcmstb-l2.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmstb_intc_init_params {
    pub handler: irq_flow_handler_t,
    pub cpu_status: c_int,
    pub cpu_clear: c_int,
    pub cpu_mask_status: c_int,
    pub cpu_mask_set: c_int,
    pub cpu_mask_clear: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmstb_l2_intc_data {
    pub domain: *mut irq_domain,
    pub gc: *mut irq_chip_generic,
    pub status_offset: c_int,
    pub mask_offset: c_int,
    pub can_wake: bool,
    pub /: *mut *mut u32 saved_mask; / for suspend/resume,
}

#[no_mangle]
unsafe extern "C" fn brcmstb_l2_intc_irq_handle(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn __brcmstb_l2_intc_suspend(d: *mut irq_data, save: bool) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_l2_intc_shutdown(d: *mut irq_data) {
    static void brcmstb_l2_intc_shutdown(struct irq_data *d)
    {
    __brcmstb_l2_intc_suspend(d, false);
    }
#[no_mangle]
unsafe extern "C" fn brcmstb_l2_intc_suspend(d: *mut irq_data) {
    static void brcmstb_l2_intc_suspend(struct irq_data *d)
    {
    __brcmstb_l2_intc_suspend(d, true);
    }
#[no_mangle]
unsafe extern "C" fn brcmstb_l2_intc_resume(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_l2_edge_intc_probe(pdev: *mut platform_device, parent: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_l2_lvl_intc_probe(pdev: *mut platform_device, parent: *mut device_node) -> c_int {
