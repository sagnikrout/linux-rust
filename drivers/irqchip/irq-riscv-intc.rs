...
//! Source: drivers/irqchip/irq-riscv-intc.c
#![no_std]
...
//
    ...
    let mut __ro_after_init: static unsigned int riscv_intc_nr_irqs = BITS_PER_LONG;
    let mut __ro_after_init: static unsigned int riscv_intc_custom_base = BITS_PER_LONG;
    static unsigned int riscv_intc_custom_nr_irqs __ro_after_init;
#[no_mangle]
unsafe extern "C" fn riscv_intc_irq(regs: *mut pt_regs) {
    static void riscv_intc_irq(struct pt_regs *regs)
    {
    let mut cause: c_ulong = regs.cause & ~CAUSE_IRQ_FLAG;
    if (generic_handle_domain_irq(intc_domain, cause))
    pr_warn_ratelimited("Failed to handle interrupt (cause: %ld)\n", cause);
    }
#[no_mangle]
unsafe extern "C" fn riscv_intc_aia_irq(regs: *mut pt_regs) {
...
//
#[no_mangle]
unsafe extern "C" fn riscv_intc_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn riscv_intc_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn andes_intc_irq_mask(d: *mut irq_data) {
...
// of SLIE.
//
    let mut mask: c_uint = BIT(d.hwirq % BITS_PER_LONG);
...
#[no_mangle]
unsafe extern "C" fn andes_intc_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn riscv_intc_irq_eoi(d: *mut irq_data) {
...
//
    ...
    irq_domain_set_info(d, irq, hwirq, chip, core::ptr::null_mut(), handle_percpu_devid_irq,
...
#[no_mangle]
unsafe extern "C" fn riscv_intc_init_common(fn: *mut fwnode_handle, chip: *mut irq_chip) -> int __init {
    ...
    riscv_intc_nr_irqs,
    riscv_isa_extension_available(core::ptr::null_mut(), SxAIA) ? " using AIA" : "");
...
#[no_mangle]
pub unsafe extern "C" fn acpi_rintc_get_plic_nr_contexts(plic_id: c_uint) -> c_uint {
    unsigned int acpi_rintc_get_plic_nr_contexts(unsigned int plic_id)
    {
    let mut nctx: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_rintc_ext_parent_to_hartid(plic_id: c_uint, ctxt_idx: c_uint) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_rintc_get_plic_context(plic_id: c_uint, ctxt_idx: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_rintc_index_to_hartid(index: u32) -> c_ulong {
    unsigned long acpi_rintc_index_to_hartid(u32 index)
    {
    return index >= nr_rintc ? INVALID_HARTID : rintc_acpi_data[index].hart_id;
    }
#[no_mangle]
pub unsafe extern "C" fn acpi_rintc_get_imsic_mmio_info(index: u32, res: *mut resource) -> c_int {
...
//
    ...
    IRQCHIP_ACPI_DECLARE(riscv_intc, ACPI_MADT_TYPE_RINTC, core::ptr::null_mut(),
