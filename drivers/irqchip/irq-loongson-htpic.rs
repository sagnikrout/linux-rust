...
//! Source: drivers/irqchip/irq-loongson-htpic.c
#![no_std]
...
pub const HTPIC_MAX_PARENT_IRQ: c_int = 4;
pub const HTINT_NUM_VECTORS: c_int = 8;
pub const HTINT_EN_OFF: c_uint = 0x20;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson_htpic {
...
#[no_mangle]
unsafe extern "C" fn htpic_irq_dispatch(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn htpic_reg_init() {
...
#[no_mangle]
unsafe extern "C" fn htpic_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn htpic_of_init(node: *mut device_node, parent: *mut device_node) -> int __init {
