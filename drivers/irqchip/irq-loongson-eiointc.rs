...
//! Source: drivers/irqchip/irq-loongson-eiointc.c
#![no_std]
...
pub const EIOINTC_REG_NODEMAP: c_uint = 0x14a0;
pub const EIOINTC_REG_IPMAP: c_uint = 0x14c0;
pub const EIOINTC_REG_ENABLE: c_uint = 0x1600;
pub const EIOINTC_REG_BOUNCE: c_uint = 0x1680;
pub const EIOINTC_REG_ISR: c_uint = 0x1800;
pub const EIOINTC_REG_ROUTE: c_uint = 0x1c00;
pub const EXTIOI_VIRT_FEATURES: c_uint = 0x40000000;

pub const EXTIOI_VIRT_CONFIG: c_uint = 0x40000004;

pub const VEC_COUNT: c_int = 256;

pub const EIOINTC_ALL_ENABLE: c_uint = 0xffffffff;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eiointc_ip_route {
    pub priv: *mut eiointc_priv,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eiointc_priv {
    pub node: u32,
    pub vec_count: u32,
    pub node_map: nodemask_t,
    pub cpuspan_map: cpumask_t,
    pub domain_handle: *mut fwnode_handle,
    pub eiointc_domain: *mut irq_domain,
    pub flags: c_int,
    pub parent_hwirq: irq_hw_number_t,
    pub route_info: [eiointc_ip_route; VEC_REG_COUNT],
}

    static struct eiointc_priv *eiointc_priv[MAX_IO_PICS];
#[no_mangle]
unsafe extern "C" fn eiointc_enable() {
...
#[no_mangle]
unsafe extern "C" fn cpu_to_eio_node(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eiointc_set_irq_route(pos: c_int, cpu: c_uint, mnode: c_uint, node_map: *mut nodemask_t) {
...
#[no_mangle]
unsafe extern "C" fn veiointc_set_irq_route(vector: c_uint, cpu: c_uint) {
    static void veiointc_set_irq_route(unsigned int vector, unsigned int cpu)
    {
    let mut reg: c_ulong = EIOINTC_REG_ROUTE_VEC(vector);
    unsigned int data;
...
#[no_mangle]
unsafe extern "C" fn eiointc_set_irq_affinity(d: *mut irq_data, affinity: *const cpumask, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eiointc_index(node: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eiointc_router_init(cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: index ==) -> else {
    else if (index == 0)
...
#[no_mangle]
pub unsafe extern "C" fn read_isr(i: c_int) -> c_ulong {
    static inline unsigned long read_isr(int i)
    {
    return iocsr_read32(EIOINTC_REG_ISR + (i << 2));
    }
#[no_mangle]
pub unsafe extern "C" fn write_isr(i: c_int, val: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn eiointc_irq_dispatch(desc: *mut irq_desc) {
...
// Clear the IRQs
    ...
    let mut irq: c_int = bit + VEC_COUNT_PER_REG * i;
...
#[no_mangle]
unsafe extern "C" fn eiointc_ack_irq(d: *mut irq_data) {
    static void eiointc_ack_irq(struct irq_data *d)
    {
    }
#[no_mangle]
unsafe extern "C" fn eiointc_mask_irq(d: *mut irq_data) {
    static void eiointc_mask_irq(struct irq_data *d)
    {
    }
#[no_mangle]
unsafe extern "C" fn eiointc_unmask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn acpi_set_vec_parent(node: c_int, parent: *mut irq_domain, vec_group: *mut acpi_vector_group) {
...
#[no_mangle]
unsafe extern "C" fn eiointc_suspend(data: *mut c_void) -> c_int {
    static int eiointc_suspend(void *data)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn eiointc_resume(data: *mut c_void) {
    ...
    let mut node: c_uint = (pchpic_entry.address >> 44) & 0xf;
...
//
    ...
    eiointc_router_init, core::ptr::null_mut());
    }
    return 0;
    }
    ...
    priv.domain_handle = core::ptr::null_mut();
    out_free_priv:
    kfree(priv);
    return -ENOMEM;
    }
