...
//! Source: drivers/irqchip/irq-mvebu-odmi.c
#![no_std]
...
pub const GICP_ODMIN_SET: c_uint = 0x40;
pub const GICP_ODMI_INT_NUM_SHIFT: c_int = 12;
pub const GICP_ODMIN_GM_EP_R0: c_uint = 0x110;
pub const GICP_ODMIN_GM_EP_R1: c_uint = 0x114;
pub const GICP_ODMIN_GM_EA_R0: c_uint = 0x108;
pub const GICP_ODMIN_GM_EA_R1: c_uint = 0x118;
//
// We don't support the group events, so we simply have 8 interrupts
// per frame.
//
pub const NODMIS_SHIFT: c_int = 3;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct odmi_data {
    pub res: resource,
...
#[no_mangle]
unsafe extern "C" fn odmi_compose_msi_msg(d: *mut irq_data, msg: *mut msi_msg) {
    ...
    {
    struct odmi_data *odmi = core::ptr::null_mut();
...
// Configure the interrupt line to be edge
    ...
    &odmi_irq_chip, core::ptr::null_mut());
    return 0;
    }
