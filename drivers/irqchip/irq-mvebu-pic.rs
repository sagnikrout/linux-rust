...
//! Source: drivers/irqchip/irq-mvebu-pic.c
#![no_std]
...
pub const PIC_CAUSE: c_uint = 0x0;
pub const PIC_MASK: c_uint = 0x4;
pub const PIC_MAX_IRQS: c_int = 32;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_pic {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_reset(pic: *mut mvebu_pic) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_eoi_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_unmask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_handle_cascade_irq(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_enable_percpu_irq(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_disable_percpu_irq(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_pic_remove(pdev: *mut platform_device) {
