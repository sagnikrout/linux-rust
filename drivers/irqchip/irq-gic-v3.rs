...
//
    ...
    let mut __ro_after_init: static u8 dist_prio_irq = GICV3_PRIO_IRQ;
    let mut __ro_after_init: static u8 dist_prio_nmi = GICV3_PRIO_NMI;

    static struct cpumask broken_rdists __read_mostly __maybe_unused;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct redist_region {
    pub redist_base: *mut void __iomem,
    pub phys_base: phys_addr_t,
    pub single_redist: bool,
}
...
pub struct gic_chip_data {
    ...
    pub dist_phys_base: phys_addr_t,
    pub dist_base: *mut void __iomem,
    pub redist_regions: *mut redist_region,
    pub rdists: rdists,
    pub domain: *mut irq_domain,
    pub redist_stride: u64,
    pub nr_redist_regions: u32,
    pub flags: u64,
    pub has_rss: bool,
    pub ppi_nr: c_uint,
    pub parts: *mut partition_affinity,
    pub nr_parts: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct partition_affinity {
    pub mask: cpumask_t,
    pub partition_id: *mut fwnode_handle,
}
...
#[no_mangle]
unsafe extern "C" fn gic_get_pribits() -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gic_has_group0() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn gic_dist_security_disabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_prio_init() -> void __init {
...
pub const DEFAULT_PMR_VALUE: c_uint = 0xf0;
...
#[no_mangle]
unsafe extern "C" fn __get_intid_range(hwirq: irq_hw_number_t) -> enum gic_intid_range {
...
#[no_mangle]
unsafe extern "C" fn get_intid_range(d: *mut irq_data) -> enum gic_intid_range {
    static enum gic_intid_range get_intid_range(struct irq_data *d)
    {
    return __get_intid_range(d.hwirq);
    }
#[no_mangle]
pub unsafe extern "C" fn gic_irq_in_rdist(d: *mut irq_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_do_wait_for_rwp(base: *mut void __iomem, bit: u32) {
...
#[no_mangle]
unsafe extern "C" fn gic_dist_wait_for_rwp() {
...
#[no_mangle]
unsafe extern "C" fn gic_redist_wait_for_rwp() {
    static void gic_redist_wait_for_rwp(void)
    {
    gic_do_wait_for_rwp(gic_data_rdist_rd_base(), GICR_CTLR_RWP);
    }
#[no_mangle]
unsafe extern "C" fn gic_enable_redist(enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn convert_offset_index(d: *mut irq_data, offset: u32, index: *mut u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gic_peek_irq(d: *mut irq_data, offset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_poke_irq(d: *mut irq_data, offset: u32) {
...
#[no_mangle]
unsafe extern "C" fn gic_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_eoimode1_mask_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_unmask_irq(d: *mut irq_data) {
    static void gic_unmask_irq(struct irq_data *d)
    {
    gic_poke_irq(d, GICD_ISENABLER);
    }
#[no_mangle]
pub unsafe extern "C" fn gic_supports_nmi() -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_irq_set_prio(d: *mut irq_data, prio: u8) {
...
#[no_mangle]
unsafe extern "C" fn gic_irq_nmi_setup(d: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_irq_nmi_teardown(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_arm64_erratum_2941627_needed(d: *mut irq_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_eoi_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_eoimode1_eoi_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    static int gic_set_type(struct irq_data *d, unsigned int type)
    {
    let mut irq: irq_hw_number_t = irqd_to_hwirq(d);
    enum gic_intid_range range;
    void __iomem *base;
    u32 offset, index;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn gic_irq_set_vcpu_affinity(d: *mut irq_data, vcpu: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_cpu_to_affinity(cpu: c_int) -> u64 {
    static u64 gic_cpu_to_affinity(int cpu)
    {
    let mut mpidr: u64 = cpu_logical_map(cpu);
    u64 aff;
...
#[no_mangle]
unsafe extern "C" fn gic_deactivate_unhandled(irqnr: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gic_complete_ack(irqnr: u32) {
...
#[no_mangle]
unsafe extern "C" fn gic_rpr_is_nmi_prio() -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_irqnr_is_special(irqnr: u32) -> bool {
    static bool gic_irqnr_is_special(u32 irqnr)
    {
    return irqnr >= 1020 && irqnr <= 1023;
    }
#[no_mangle]
unsafe extern "C" fn __gic_handle_irq(irqnr: u32, regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn __gic_handle_nmi(irqnr: u32, regs: *mut pt_regs) {
...
//
#[no_mangle]
unsafe extern "C" fn __gic_handle_irq_from_irqson(regs: *mut pt_regs) {
...
//
#[no_mangle]
unsafe extern "C" fn __gic_handle_irq_from_irqsoff(regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn gic_handle_irq(regs: *mut pt_regs) -> void __exception_irq_entry {
...
#[no_mangle]
unsafe extern "C" fn gic_dist_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn gic_iterate_rdists(: *mut *mut int (fn)(struct redist_region, ): *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __gic_populate_rdist(region: *mut redist_region, ptr: *mut void __iomem) -> c_int {
...
//
    ...
    typer = gic_read_typer(ptr + GICR_TYPER);
    if ((typer >> 32) == aff) {
    let mut offset: u64 = ptr - region.redist_base;
...
#[no_mangle]
unsafe extern "C" fn gic_populate_rdist() -> c_int {
...
// We couldn't even deal with ourselves...
    ...
    void __iomem *ptr)
    {
    let mut typer: u64 = gic_read_typer(ptr + GICR_TYPER);
    let mut ctlr: u32 = readl_relaxed(ptr + GICR_CTLR);
// Boot-time cleanup
...
#[no_mangle]
unsafe extern "C" fn gic_update_rdist_properties() {
...
#[no_mangle]
unsafe extern "C" fn gic_cpu_sys_reg_enable() {
...
#[no_mangle]
unsafe extern "C" fn gic_cpu_sys_reg_init() {
    static void gic_cpu_sys_reg_init(void)
    {
    int i, cpu = smp_processor_id();
    let mut mpidr: u64 = gic_cpu_to_affinity(cpu);
    let mut need_rss: u64 = MPIDR_RS(mpidr);
    bool group0;
    u32 pribits;
...
// Check all the CPUs have capable of sending SGIs to other CPUs
    ...
    let mut have_rss: bool = per_cpu(has_rss, i) && per_cpu(has_rss, cpu);
...
#[no_mangle]
unsafe extern "C" fn gicv3_nolpi_cfg(buf: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gic_dist_supports_lpis() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_cpu_init() {
...
//
#[no_mangle]
unsafe extern "C" fn gic_check_rdist(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_send_sgi(cluster_id: u64, tlist: u16, irq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gic_ipi_send_mask(d: *mut irq_data, mask: *const cpumask) {
...
//
    ...
    let mut cluster_id: u64 = MPIDR_TO_SGI_CLUSTER_ID(gic_cpu_to_affinity(cpu));
    u16 tlist;
...
#[no_mangle]
unsafe extern "C" fn gic_smp_init() -> void __init {
    ...
    gic_check_rdist, core::ptr::null_mut());
    cpuhp_setup_state_nocalls(CPUHP_AP_IRQ_GIC_STARTING,
    "irqchip/arm/gicv3:starting",
    gic_starting_cpu, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gic_retrigger(data: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_cpu_pm_init() {
...
// If this is not DT, then we have a single domain
    ...
    if (WARN_ON_ONCE(ret))
    return 0;
    let mut d: return = = gic_data.domain;
    }
#[no_mangle]
unsafe extern "C" fn gic_irq_get_fwspec_info(fwspec: *mut irq_fwspec, info: *mut irq_fwspec_info) -> c_int {
    ...
    info.flags = 0;
    info.affinity = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gic_enable_quirk_msm8996(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_enable_quirk_cavium_38539(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_enable_quirk_hip06_07(data: *mut c_void) -> bool {
...
pub const T241_CHIP_GICDA_OFFSET: c_uint = 0x1580000;
pub const SMCCC_SOC_ID_T241: c_uint = 0x036b0241;
#[no_mangle]
unsafe extern "C" fn gic_enable_quirk_nvidia_t241(data: *mut c_void) -> bool {
    static bool gic_enable_quirk_nvidia_t241(void *data)
    {
    let mut soc_id: i32 = arm_smccc_get_soc_id_version();
    let mut chip_bmask: c_ulong = 0;
    phys_addr_t phys;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn gic_enable_quirk_asr8601(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_enable_quirk_arm64_2941627(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_enable_quirk_rk3399(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rd_set_non_coherent(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_enable_nmi_support() {
...
#[no_mangle]
unsafe extern "C" fn gic_validate_dist_version(dist_base: *mut void __iomem) -> int __init {
    static int __init gic_validate_dist_version(void __iomem *dist_base)
    {
    let mut reg: u32 = readl_relaxed(dist_base + GICD_PIDR2) & GIC_PIDR2_ARCH_MASK;
...
#[no_mangle]
unsafe extern "C" fn gic_populate_ppi_partitions(gic_node: *mut device_node) -> void __init {
    static void __init gic_populate_ppi_partitions(struct device_node *gic_node)
    {
    struct device_node *parts_node, *child_part;
    let mut part_idx: c_int = 0, i;
    int nr_parts;
...
#[no_mangle]
unsafe extern "C" fn gic_of_setup_kvm_info(node: *mut device_node, nr_redist_regions: u32) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn gic_of_init(node: *mut device_node, parent: *mut device_node) -> int __init {
    ...
    let mut reg: u32 = readl_relaxed(acpi_data.dist_base + GICD_PIDR2) & GIC_PIDR2_ARCH_MASK;
    let mut size: u32 = reg == GIC_PIDR2_ARCH_GICv4 ? SZ_64K * 4 : SZ_64K * 2;
    void __iomem *redist_base;
...
//
    ...
    let mut cpu: c_int = get_cpu_for_acpi_id(gicc.uid);
...
#[no_mangle]
unsafe extern "C" fn gic_acpi_collect_gicr_base() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gic_acpi_count_gicr_regions() -> int __init {
...
// We need to do that exercise anyway, the sooner the better
    ...
    (struct acpi_madt_generic_interrupt *)header;
    int maint_irq_mode;
    let mut first_madt: static int = true;
    if (!(gicc.flags &
...
#[no_mangle]
unsafe extern "C" fn gic_acpi_collect_virt_info() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn gic_acpi_setup_kvm_info() -> void __init {
    ...
    gic_v3_kvm_info.type = GIC_V3;
    irq = acpi_register_gsi(core::ptr::null_mut(), acpi_data.maint_irq,
...
// Get distributor base address
    ...
    acpi_set_irq_model(ACPI_IRQ_MODEL_GIC, gic_v3_get_gsi_domain_id, core::ptr::null_mut());
    if (static_branch_likely(&supports_deactivate_key))
