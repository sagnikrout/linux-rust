...
//! Source: drivers/irqchip/irq-dw-apb-ictl.c
#![no_std]
...
pub const APB_INT_ENABLE_L: c_uint = 0x00;
pub const APB_INT_ENABLE_H: c_uint = 0x04;
pub const APB_INT_MASK_L: c_uint = 0x08;
pub const APB_INT_MASK_H: c_uint = 0x0c;
pub const APB_INT_FINALSTATUS_L: c_uint = 0x30;
pub const APB_INT_FINALSTATUS_H: c_uint = 0x34;
pub const APB_INT_BASE_OFFSET: c_uint = 0x04;
// irq domain of the primary interrupt controller.
    static struct irq_domain *dw_apb_ictl_irq_domain;
#[no_mangle]
unsafe extern "C" fn dw_apb_ictl_handle_irq(regs: *mut pt_regs) -> void __irq_entry {
    ...
    let mut stat: u32 = readl_relaxed(gc.reg_base + APB_INT_FINALSTATUS_L);
    while (stat) {
...
#[no_mangle]
unsafe extern "C" fn dw_apb_ictl_handle_irq_cascaded(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn dw_apb_ictl_resume(d: *mut irq_data) {
...
// mask and enable all interrupts
    ...
    domain = irq_domain_create_linear(of_fwnode_handle(np), nrirqs, domain_ops, core::ptr::null_mut());
    if (!domain) {
