...
//! Source: drivers/irqchip/irq-ti-sci-inta.c
#![no_std]
...
pub const TI_SCI_DEV_ID_MASK: c_uint = 0xffff;
pub const TI_SCI_DEV_ID_SHIFT: c_int = 16;
pub const TI_SCI_IRQ_ID_MASK: c_uint = 0xffff;
pub const TI_SCI_IRQ_ID_SHIFT: c_int = 0;

    (TI_SCI_DEV_ID_MASK))

    TI_SCI_DEV_ID_SHIFT) | \
    ((index) & TI_SCI_IRQ_ID_MASK))
pub const MAX_EVENTS_PER_VINT: c_int = 64;
pub const VINT_ENABLE_SET_OFFSET: c_uint = 0x0;
pub const VINT_ENABLE_CLR_OFFSET: c_uint = 0x8;
pub const VINT_STATUS_OFFSET: c_uint = 0x18;
pub const VINT_STATUS_MASKED_OFFSET: c_uint = 0x20;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_sci_inta_event_desc {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_sci_inta_vint_desc {
    pub domain: *mut irq_domain,
    pub list: list_head,
    pub MAX_EVENTS_PER_VINT): DECLARE_BITMAP(event_map,,
    pub events: [ti_sci_inta_event_desc; MAX_EVENTS_PER_VINT],
    pub parent_virq: c_uint,
    pub vint_id: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_sci_inta_irq_domain {
    pub sci: *const ti_sci_handle,
    pub vint: *mut ti_sci_resource,
    pub global_event: *mut ti_sci_resource,
    pub vint_list: list_head,
// Mutex to protect vint list
    pub vint_mutex: mutex,
    pub base: *mut void __iomem,
    pub pdev: *mut platform_device,
    pub ti_sci_id: u32,
    pub unmapped_cnt: c_int,
    pub unmapped_dev_ids: *mut u16,
}

    events[i])
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_get_dev_id(inta: *mut ti_sci_inta_irq_domain, hwirq: u32) -> u16 {
    static u16 ti_sci_inta_get_dev_id(struct ti_sci_inta_irq_domain *inta, u32 hwirq)
    {
    let mut dev_id: u16 = HWIRQ_TO_DEVID(hwirq);
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_irq_handler(desc: *mut irq_desc) {
...
//
    ...
    {
    struct ti_sci_inta_irq_domain *inta = domain.host_data;
    struct ti_sci_inta_vint_desc *vint_desc = core::ptr::null_mut();
    struct ti_sci_inta_event_desc *event_desc;
    u16 free_bit;
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_request_resources(data: *mut irq_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_release_resources(data: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_manage_event(data: *mut irq_data, offset: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_mask_irq(data: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_unmask_irq(data: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_ack_irq(data: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
//
    ...
    core::ptr::null_mut(), handle_edge_irq, core::ptr::null_mut(), core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_get_unmapped_sources(inta: *mut ti_sci_inta_irq_domain) -> c_int {
    ...
    int count, err, ret, i;
    count = of_count_phandle_with_args(node, "ti,unmapped-event-sources", core::ptr::null_mut());
    if (count <= 0)
    return 0;
    ...
    return -ENOMEM;
    i = 0;
    of_for_each_phandle(&it, err, node, "ti,unmapped-event-sources", core::ptr::null_mut(), 0) {
    u32 dev_id;
...
#[no_mangle]
unsafe extern "C" fn ti_sci_inta_irq_domain_probe(pdev: *mut platform_device) -> c_int {
