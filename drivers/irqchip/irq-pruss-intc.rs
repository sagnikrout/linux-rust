...
//! Source: drivers/irqchip/irq-pruss-intc.c
#![no_std]
...
// INTC instance
//
pub const MAX_NUM_HOST_IRQS: c_int = 8;
// minimum starting host interrupt number for MPU
pub const FIRST_PRU_HOST_INT: c_int = 2;
// PRU_ICSS_INTC registers
pub const PRU_INTC_REVID: c_uint = 0x0000;
pub const PRU_INTC_CR: c_uint = 0x0004;
pub const PRU_INTC_GER: c_uint = 0x0010;
pub const PRU_INTC_GNLR: c_uint = 0x001c;
pub const PRU_INTC_SISR: c_uint = 0x0020;
pub const PRU_INTC_SICR: c_uint = 0x0024;
pub const PRU_INTC_EISR: c_uint = 0x0028;
pub const PRU_INTC_EICR: c_uint = 0x002c;
pub const PRU_INTC_HIEISR: c_uint = 0x0034;
pub const PRU_INTC_HIDISR: c_uint = 0x0038;
pub const PRU_INTC_GPIR: c_uint = 0x0080;

pub const PRU_INTC_HIER: c_uint = 0x1500;
// CMR register bit-field macros
pub const CMR_EVT_MAP_MASK: c_uint = 0xf;
pub const CMR_EVT_MAP_BITS: c_int = 8;
pub const CMR_EVT_PER_REG: c_int = 4;
// HMR register bit-field macros
pub const HMR_CH_MAP_MASK: c_uint = 0xf;
pub const HMR_CH_MAP_BITS: c_int = 8;
pub const HMR_CH_PER_REG: c_int = 4;
// HIPIR register bit-fields
pub const INTC_HIPIR_NONE_HINT: c_uint = 0x80000000;
pub const MAX_PRU_SYS_EVENTS: c_int = 160;
pub const MAX_PRU_CHANNELS: c_int = 20;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pruss_intc_map_record {
    pub value: u8,
    pub ref_count: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pruss_intc_match_data {
    pub num_system_events: u8,
    pub num_host_events: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pruss_intc {
    pub event_channel: [pruss_intc_map_record; MAX_PRU_SYS_EVENTS],
    pub channel_host: [pruss_intc_map_record; MAX_PRU_CHANNELS],
    pub irqs: [c_uint; MAX_NUM_HOST_IRQS],
    pub base: *mut void __iomem,
    pub domain: *mut irq_domain,
    pub soc_config: *const pruss_intc_match_data,
    pub dev: *mut device,
    pub /: *mut *mut mutex lock; / PRUSS INTC lock,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pruss_host_irq_data {
    pub intc: *mut pruss_intc,
    pub host_irq: u8,
}

#[no_mangle]
pub unsafe extern "C" fn pruss_intc_read_reg(intc: *mut pruss_intc, reg: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_update_hmr(intc: *mut pruss_intc, ch: u8, host: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn pruss_intc_map(intc: *mut pruss_intc, hwirq: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn pruss_intc_unmap(intc: *mut pruss_intc, hwirq: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_init(intc: *mut pruss_intc) {
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_irq_ack(data: *mut irq_data) {
    static void pruss_intc_irq_ack(struct irq_data *data)
    {
    struct pruss_intc *intc = irq_data_get_irq_chip_data(data);
    let mut hwirq: c_uint = data.hwirq;
    pruss_intc_write_reg(intc, PRU_INTC_SICR, hwirq);
    }
#[no_mangle]
unsafe extern "C" fn pruss_intc_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_irq_reqres(data: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_irq_relres(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_irq_domain_unmap(d: *mut irq_domain, virq: c_uint) {
    static void pruss_intc_irq_domain_unmap(struct irq_domain *d, unsigned int virq)
    {
    struct pruss_intc *intc = d.host_data;
    let mut hwirq: c_ulong = irqd_to_hwirq(irq_get_irq_data(virq));
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_irq_handler(desc: *mut irq_desc) {
    ...
    let mut host_irq: u8 = host_irq_data.host_irq + FIRST_PRU_HOST_INT;
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    while (--i >= 0) {
    if (intc.irqs[i])
    irq_set_chained_handler_and_data(intc.irqs[i], core::ptr::null_mut(),
    core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn pruss_intc_remove(pdev: *mut platform_device) {
    static void pruss_intc_remove(struct platform_device *pdev)
    {
    struct pruss_intc *intc = platform_get_drvdata(pdev);
    let mut max_system_events: u8 = intc.soc_config.num_system_events;
    unsigned int hwirq;
    int i;
    for (i = 0; i < MAX_NUM_HOST_IRQS; i++) {
    if (intc.irqs[i])
