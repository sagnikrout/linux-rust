...
//! Source: drivers/irqchip/irq-madera.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn madera_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn madera_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn madera_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn madera_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn madera_irq_probe(pdev: *mut platform_device) -> c_int {
    static int madera_irq_probe(struct platform_device *pdev)
    {
    struct madera *madera = dev_get_drvdata(pdev.dev.parent);
    struct irq_data *irq_data;
    let mut irq_flags: c_uint = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn madera_irq_remove(pdev: *mut platform_device) {
...
//
    madera.irq_dev = core::ptr::null_mut();
