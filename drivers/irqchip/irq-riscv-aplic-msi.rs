...
//! Source: drivers/irqchip/irq-riscv-aplic-msi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aplic_msi_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aplic_msi_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aplic_msi_irq_retrigger_level(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aplic_msi_irq_eoi(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aplic_msi_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    static int aplic_msi_irq_set_type(struct irq_data *d, unsigned int type)
    {
    let mut rc: c_int = aplic_irq_set_type(d, type);
    if (rc)
    return rc;
//
...
#[no_mangle]
unsafe extern "C" fn aplic_msi_write_msg(d: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn aplic_msi_set_desc(arg: *mut msi_alloc_info_t, desc: *mut msi_desc) {
...
#[no_mangle]
pub unsafe extern "C" fn aplic_msi_setup(dev: *mut device, regs: *mut void __iomem) -> c_int {
