...
//! Source: drivers/irqchip/irq-mtk-cirq.c
#![no_std]
...
pub const CIRQ_EN: c_uint = 0x1;
pub const CIRQ_EDGE: c_uint = 0x2;
pub const CIRQ_FLUSH: c_uint = 0x4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_cirq_chip_data {
    pub base: *mut void __iomem,
    pub ext_irq_start: c_uint,
    pub ext_irq_end: c_uint,
...
#[no_mangle]
unsafe extern "C" fn mtk_cirq_write_mask(data: *mut irq_data, idx: enum mtk_cirq_regoffs_index) {
    static void mtk_cirq_write_mask(struct irq_data *data, enum mtk_cirq_regoffs_index idx)
    {
    struct mtk_cirq_chip_data *chip_data = data.chip_data;
    let mut cirq_num: c_uint = data.hwirq;
    let mut mask: u32 = 1 << (cirq_num % 32);
    writel_relaxed(mask, mtk_cirq_irq_reg(chip_data, idx, cirq_num));
    }
#[no_mangle]
unsafe extern "C" fn mtk_cirq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cirq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cirq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
// type = fwspec->param[2] & IRQ_TYPE_SENSE_MASK;
    ...
    let mut parent_fwspec: irq_fwspec = *fwspec;
...
#[no_mangle]
unsafe extern "C" fn mtk_cirq_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cirq_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cirq_syscore_init() {
