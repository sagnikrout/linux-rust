...
//! Source: drivers/irqchip/irq-gic-v5.c
#![no_std]
...
//
    ...
    let mut __ro_after_init: static u8 pri_bits = 5;
pub const GICV5_IRQ_PRI_MASK: c_uint = 0x1f;

pub const PPI_NR: c_int = 128;
#[no_mangle]
unsafe extern "C" fn gicv5_cpuif_has_gcie() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_init_lpis(lpis: u32) -> void __init {
    void __init gicv5_init_lpis(u32 lpis)
    {
    num_lpis = lpis;
    }
#[no_mangle]
pub unsafe extern "C" fn gicv5_deinit_lpis() -> void __init {
    void __init gicv5_deinit_lpis(void)
    {
    num_lpis = 0;
    }
#[no_mangle]
unsafe extern "C" fn alloc_lpi() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_lpi(lpi: u32) {
    static void release_lpi(u32 lpi)
    {
    ida_free(&lpi_ida, lpi);
    }
#[no_mangle]
unsafe extern "C" fn gicv5_ppi_priority_init() {
...
#[no_mangle]
unsafe extern "C" fn gicv5_hwirq_init(hwirq: irq_hw_number_t, priority: u8, hwirq_type: u8) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_ppi_irq_mask(d: *mut irq_data) {
    static void gicv5_ppi_irq_mask(struct irq_data *d)
    {
    let mut hwirq_id_bit: u64 = BIT_ULL(d.hwirq % 64);
    if (d.hwirq < 64)
...
#[no_mangle]
unsafe extern "C" fn gicv5_iri_irq_mask(d: *mut irq_data, hwirq_type: u8) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_iri_irq_unmask(d: *mut irq_data, hwirq_type: u8) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_ppi_irq_eoi(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_spi_irq_eoi(d: *mut irq_data) {
    static void gicv5_spi_irq_eoi(struct irq_data *d)
    {
    gicv5_hwirq_eoi(d.hwirq, GICV5_HWIRQ_TYPE_SPI);
    }
#[no_mangle]
unsafe extern "C" fn gicv5_lpi_irq_eoi(d: *mut irq_data) {
    ...
    const enum ppi_reg which)
    {
    let mut bit: u64 = BIT_ULL(irq % 64);
    switch (which) {
    case PPI_PENDING:
    if (set) {
    if (irq < 64)
...
#[no_mangle]
unsafe extern "C" fn gicv5_spi_irq_write_pending_state(d: *mut irq_data, state: bool) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_lpi_irq_write_pending_state(d: *mut irq_data, state: bool) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_spi_irq_retrigger(data: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_lpi_irq_retrigger(data: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_ipi_send_single(d: *mut irq_data, cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_ppi_irq_is_level(hwirq: irq_hw_number_t) -> bool {
    static bool gicv5_ppi_irq_is_level(irq_hw_number_t hwirq)
    {
    let mut bit: u64 = BIT_ULL(hwirq % 64);
    return !!(read_ppi_sysreg_s(hwirq, PPI_HM) & bit);
    }
#[no_mangle]
unsafe extern "C" fn gicv5_ppi_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_ppi_irq_set_vcpu_affinity(d: *mut irq_data, vcpu: *mut c_void) -> c_int {
...
// type = hwirq_trigger & IRQ_TYPE_SENSE_MASK;
    ...
    irq_domain_set_info(domain, virq, hwirq, &gicv5_ppi_irq_chip, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn gicv5_lpi_config_reset(d: *mut irq_data) {
...
// Undo partial state first, then clean up the rest
    ...
    core::ptr::null_mut(), handle_fasteoi_irq, core::ptr::null_mut(), core::ptr::null_mut());
    irqd_set_single_target(irqd);
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_init_lpi_domain() -> void __init {
    void __init gicv5_init_lpi_domain(void)
    {
    struct irq_domain *d;
    d = irq_domain_create_tree(core::ptr::null_mut(), &gicv5_irq_lpi_domain_ops, core::ptr::null_mut());
    gicv5_global_data.lpi_domain = d;
    }
#[no_mangle]
pub unsafe extern "C" fn gicv5_free_lpi_domain() -> void __init {
    void __init gicv5_free_lpi_domain(void)
    {
    if (!gicv5_global_data.lpi_domain)
    return;
    irq_domain_remove(gicv5_global_data.lpi_domain);
    gicv5_global_data.lpi_domain = core::ptr::null_mut();
    }
    ...
    &gicv5_ipi_irq_chip, core::ptr::null_mut());
    irqd_set_single_target(irqd);
...
#[no_mangle]
unsafe extern "C" fn handle_irq_per_domain(hwirq: u32) {
    static void handle_irq_per_domain(u32 hwirq)
    {
    let mut hwirq_type: u8 = FIELD_GET(GICV5_HWIRQ_TYPE, hwirq);
    let mut hwirq_id: u32 = FIELD_GET(GICV5_HWIRQ_ID, hwirq);
...
#[no_mangle]
unsafe extern "C" fn gicv5_handle_irq(regs: *mut pt_regs) -> void __exception_irq_entry {
...
#[no_mangle]
unsafe extern "C" fn gicv5_cpu_disable_interrupts() {
...
#[no_mangle]
unsafe extern "C" fn gicv5_cpu_enable_interrupts() {
...
#[no_mangle]
unsafe extern "C" fn gicv5_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_smp_init() -> void __init {
    static void __init gicv5_smp_init(void)
    {
    let mut num_ipis: c_uint = GICV5_IPIS_PER_CPU * nr_cpu_ids;
    cpuhp_setup_state_nocalls(CPUHP_AP_IRQ_GIC_STARTING,
    "irqchip/arm/gicv5:starting",
    gicv5_starting_cpu, core::ptr::null_mut());
    base_ipi_virq = irq_domain_alloc_irqs(gicv5_global_data.ipi_domain,
    num_ipis, NUMA_NO_NODE, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gicv5_free_domains() -> void __init {
    ...
    gicv5_global_data.ppi_domain = core::ptr::null_mut();
    gicv5_global_data.spi_domain = core::ptr::null_mut();
    gicv5_global_data.ipi_domain = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn gicv5_init_domains(handle: *mut fwnode_handle) -> int __init {
    static int __init gicv5_init_domains(struct fwnode_handle *handle)
    {
    let mut spi_count: u32 = gicv5_global_data.global_spi_count;
    struct irq_domain *d;
    d = irq_domain_create_linear(handle, PPI_NR, &gicv5_irq_ppi_domain_ops, core::ptr::null_mut());
    if (!d)
    return -ENOMEM;
    ...
    &gicv5_irq_spi_domain_ops, core::ptr::null_mut());
    if (!d) {
    gicv5_free_domains();
    return -ENOMEM;
    }
    ...
    core::ptr::null_mut(), &gicv5_irq_ipi_domain_ops,
    core::ptr::null_mut());
    if (!d) {
    gicv5_free_domains();
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn gicv5_set_cpuif_pribits() {
    static void gicv5_set_cpuif_pribits(void)
    {
    let mut icc_idr0: u64 = read_sysreg_s(SYS_ICC_IDR0_EL1);
...
#[no_mangle]
unsafe extern "C" fn gicv5_set_cpuif_idbits() {
    static void gicv5_set_cpuif_idbits(void)
    {
    let mut icc_idr0: u32 = read_sysreg_s(SYS_ICC_IDR0_EL1);
...
#[no_mangle]
unsafe extern "C" fn gic_of_setup_kvm_info(node: *mut device_node) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn gic_of_setup_kvm_info(node: *mut device_node) -> void __init {
    static inline void __init gic_of_setup_kvm_info(struct device_node *node)
    {
    }

#[no_mangle]
unsafe extern "C" fn gicv5_init_common(parent_domain: *mut fwnode_handle) -> int __init {
    static int __init gicv5_init_common(struct fwnode_handle *parent_domain)
    {
    let mut ret: c_int = gicv5_init_domains(parent_domain);
    if (ret)
    return ret;
    ...
    return 0;
    out_handle:
    set_handle_irq(core::ptr::null_mut());
    out_int:
...
#[no_mangle]
unsafe extern "C" fn gicv5_of_init(node: *mut device_node, parent: *mut device_node) -> int __init {
    static int __init gicv5_of_init(struct device_node *node, struct device_node *parent)
    {
    let mut ret: c_int = gicv5_irs_of_probe(node);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn gic_v5_get_gsi_handle(gsi: u32) -> acpi_handle {
...
#[no_mangle]
unsafe extern "C" fn gic_acpi_init(header: *mut union acpi_subtable_headers, end: c_ulong) -> int __init {
