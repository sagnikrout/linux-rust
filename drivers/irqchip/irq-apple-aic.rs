...
//! Source: drivers/irqchip/irq-apple-aic.c
#![no_std]
...
//
pub const AIC_INFO: c_uint = 0x0004;

pub const AIC_CONFIG: c_uint = 0x0010;
pub const AIC_WHOAMI: c_uint = 0x2000;
pub const AIC_EVENT: c_uint = 0x2004;

pub const AIC_EVENT_TYPE_IRQ: c_int = 1;
pub const AIC_EVENT_TYPE_IPI: c_int = 4;
pub const AIC_EVENT_IPI_OTHER: c_int = 1;
pub const AIC_EVENT_IPI_SELF: c_int = 2;
pub const AIC_IPI_SEND: c_uint = 0x2008;
pub const AIC_IPI_ACK: c_uint = 0x200c;
pub const AIC_IPI_MASK_SET: c_uint = 0x2024;
pub const AIC_IPI_MASK_CLR: c_uint = 0x2028;

pub const AIC_TARGET_CPU: c_uint = 0x3000;

pub const AIC_MAX_IRQ: c_uint = 0x400;
//
// AIC v2 registers (MMIO)
//
pub const AIC2_VERSION: c_uint = 0x0000;

pub const AIC2_INFO1: c_uint = 0x0004;

pub const AIC2_INFO2: c_uint = 0x0008;
pub const AIC2_INFO3: c_uint = 0x000c;

pub const AIC2_RESET: c_uint = 0x0010;

pub const AIC2_CONFIG: c_uint = 0x0014;

pub const AIC2_TIMEOUT: c_uint = 0x0028;
pub const AIC2_CLUSTER_PRIO: c_uint = 0x0030;
pub const AIC2_DELAY_GROUPS: c_uint = 0x0100;
pub const AIC2_IRQ_CFG: c_uint = 0x2000;
// AIC v3 registers (MMIO)
pub const AIC3_IRQ_CFG: c_uint = 0x10000;
//
...
pub const IPI_RR_IMMEDIATE: c_int = 0;
pub const IPI_RR_RETRACT: c_int = 1;
pub const IPI_RR_DEFERRED: c_int = 2;
pub const IPI_RR_NOWAKE: c_int = 3;
// IPI status register
...
pub const UPMCR0_IMODE_OFF: c_int = 0;
pub const UPMCR0_IMODE_AIC: c_int = 2;
pub const UPMCR0_IMODE_HALT: c_int = 3;
pub const UPMCR0_IMODE_FIQ: c_int = 4;
...
pub const AIC_NR_SWIPI: c_int = 32;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aic_irq_chip {
    pub base: *mut void __iomem,
    pub event: *mut void __iomem,
    pub hw_domain: *mut irq_domain,
    struct {
    pub aff: cpumask_t,
    pub fiq_aff: [*mut }; AIC_NR_FIQ],
    pub nr_irq: c_int,
    pub max_irq: c_int,
    pub nr_die: c_int,
    pub max_die: c_int,
...
#[no_mangle]
unsafe extern "C" fn aic_ic_read(ic: *mut aic_irq_chip, reg: u32) -> u32 {
    static u32 aic_ic_read(struct aic_irq_chip *ic, u32 reg)
    {
    return readl_relaxed(ic.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn aic_ic_write(ic: *mut aic_irq_chip, reg: u32, val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn aic_irq_mask(d: *mut irq_data) {
    static void aic_irq_mask(struct irq_data *d)
    {
    let mut hwirq: irq_hw_number_t = irqd_to_hwirq(d);
    struct aic_irq_chip *ic = irq_data_get_irq_chip_data(d);
    let mut off: u32 = AIC_HWIRQ_DIE(hwirq) * ic.info.die_stride;
    let mut irq: u32 = AIC_HWIRQ_IRQ(hwirq);
    aic_ic_write(ic, ic.info.mask_set + off + MASK_REG(irq), MASK_BIT(irq));
    }
#[no_mangle]
unsafe extern "C" fn aic_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aic_irq_eoi(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aic_handle_irq(regs: *mut pt_regs) -> void __exception_irq_entry {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: type == AIC_EVENT_TYPE_IPI && irq ==) -> else {
    else if (type == AIC_EVENT_TYPE_IPI && irq == 1)
    aic_handle_ipi(regs);
#[no_mangle]
pub unsafe extern "C" fn if(0: event !=) -> else {
    else if (event != 0)
...
#[no_mangle]
unsafe extern "C" fn aic_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aic_fiq_get_idx(d: *mut irq_data) -> c_ulong {
    static unsigned long aic_fiq_get_idx(struct irq_data *d)
    {
    return AIC_HWIRQ_IRQ(irqd_to_hwirq(d));
    }
#[no_mangle]
unsafe extern "C" fn aic_fiq_set_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aic_fiq_clear_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aic_fiq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aic_fiq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aic_fiq_eoi(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aic_handle_fiq(regs: *mut pt_regs) -> void __exception_irq_entry {
...
//
    ...
    if (is_kernel_in_hyp_mode()) {
    let mut enabled: u64 = read_sysreg_s(SYS_IMP_APL_VM_TMR_FIQ_ENA_EL2);
...
#[no_mangle]
unsafe extern "C" fn aic_fiq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
//
    ...
    let mut type: u32 = FIELD_GET(AIC_EVENT_TYPE, hw);
...
#[no_mangle]
unsafe extern "C" fn aic_irq_get_fwspec_info(fwspec: *mut irq_fwspec, info: *mut irq_fwspec_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aic_ipi_send_fast(cpu: c_int) {
    static void aic_ipi_send_fast(int cpu)
    {
    let mut mpidr: u64 = cpu_logical_map(cpu);
    let mut my_mpidr: u64 = read_cpuid_mpidr();
    let mut cluster: u64 = MPIDR_CLUSTER(mpidr);
    let mut idx: u64 = MPIDR_CPU(mpidr);
...
#[no_mangle]
unsafe extern "C" fn aic_handle_ipi(regs: *mut pt_regs) {
    static void aic_handle_ipi(struct pt_regs *regs)
    {
//
...
#[no_mangle]
unsafe extern "C" fn aic_ipi_send_single(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn aic_init_smp(irqc: *mut aic_irq_chip, node: *mut device_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aic_init_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_fiq_affinity(ic: *mut aic_irq_chip, aff: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn aic_of_ic_init(node: *mut device_node, parent: *mut device_node) -> int __init {
    ...
    let mut config: u32 = aic_ic_read(irqc, AIC2_CONFIG);
    ...
    aic_init_cpu, core::ptr::null_mut());
    if (is_kernel_in_hyp_mode()) {
