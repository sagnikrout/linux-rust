...
//! Source: drivers/irqchip/irq-owl-sirq.c
#![no_std]
...
pub const NUM_SIRQ: c_int = 3;

pub const INTC_EXTCTL_TYPE_HIGH: c_int = 0;

// S500 & S700 SIRQ control register masks

// S900 SIRQ control register offsets, relative to controller base address
pub const INTC_EXTCTL0: c_uint = 0x0000;
pub const INTC_EXTCTL1: c_uint = 0x0328;
pub const INTC_EXTCTL2: c_uint = 0x032c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct owl_sirq_params {
// INTC_EXTCTL reg shared for all three SIRQ lines
    pub reg_shared: bool,
// INTC_EXTCTL reg offsets relative to controller base address
    pub reg_offset: [u16; NUM_SIRQ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct owl_sirq_chip_data {
    pub params: *const owl_sirq_params,
    pub base: *mut void __iomem,
    pub lock: raw_spinlock_t,
    pub ext_irqs: [u32; NUM_SIRQ],
}
...
#[no_mangle]
unsafe extern "C" fn owl_field_get(val: u32, index: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn owl_field_prep(val: u32, index: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn owl_sirq_read_extctl(data: *mut owl_sirq_chip_data, index: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn owl_sirq_eoi(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn owl_sirq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn owl_sirq_unmask(data: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn owl_sirq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
