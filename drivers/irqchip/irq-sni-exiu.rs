...
//! Source: drivers/irqchip/irq-sni-exiu.c
#![no_std]
...
pub const NUM_IRQS: c_int = 32;
pub const EIMASK: c_uint = 0x00;
pub const EISRCSEL: c_uint = 0x04;
pub const EIREQSTA: c_uint = 0x08;
pub const EIRAWREQSTA: c_uint = 0x0C;
pub const EIREQCLR: c_uint = 0x10;
pub const EILVL: c_uint = 0x14;
pub const EIEDG: c_uint = 0x18;
pub const EISIR: c_uint = 0x1C;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct exiu_irq_data {
    pub base: *mut void __iomem,
    pub spi_base: u32,
}

#[no_mangle]
unsafe extern "C" fn exiu_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn exiu_irq_eoi(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn exiu_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn exiu_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn exiu_irq_enable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn exiu_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exiu_acpi_probe(pdev: *mut platform_device) -> c_int {
