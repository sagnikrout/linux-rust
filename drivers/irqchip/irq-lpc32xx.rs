...
//! Source: drivers/irqchip/irq-lpc32xx.c
#![no_std]
...
pub const LPC32XX_INTC_MASK: c_uint = 0x00;
pub const LPC32XX_INTC_RAW: c_uint = 0x04;
pub const LPC32XX_INTC_STAT: c_uint = 0x08;
pub const LPC32XX_INTC_POL: c_uint = 0x0C;
pub const LPC32XX_INTC_TYPE: c_uint = 0x10;
pub const LPC32XX_INTC_FIQ: c_uint = 0x14;
pub const NR_LPC32XX_IC_IRQS: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc32xx_irq_chip {
...
#[no_mangle]
pub unsafe extern "C" fn lpc32xx_ic_read(ic: *mut lpc32xx_irq_chip, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_handle_irq(regs: *mut pt_regs) -> void __exception_irq_entry {
    static void __exception_irq_entry lpc32xx_handle_irq(struct pt_regs *regs)
    {
    struct lpc32xx_irq_chip *ic = lpc32xx_mic_irqc;
    let mut hwirq: u32 = lpc32xx_ic_read(ic, LPC32XX_INTC_STAT), irq;
    while (hwirq) {
    irq = __ffs(hwirq);
    hwirq &= ~BIT(irq);
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_sic_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_irq_domain_unmap(id: *mut irq_domain, virq: c_uint) {
    ...
    let mut is_mic: bool = of_device_is_compatible(node, "nxp,lpc3220-mic");
    const __be32 *reg = of_get_property(node, "reg", core::ptr::null_mut());
