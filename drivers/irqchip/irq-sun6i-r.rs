...
//! Source: drivers/irqchip/irq-sun6i-r.c
#![no_std]
...
pub const SUN6I_NMI_SRC_TYPE_LEVEL_LOW: c_int = 0;
pub const SUN6I_NMI_SRC_TYPE_EDGE_FALLING: c_int = 1;
pub const SUN6I_NMI_SRC_TYPE_LEVEL_HIGH: c_int = 2;
pub const SUN6I_NMI_SRC_TYPE_EDGE_RISING: c_int = 3;

pub const SUN6I_NR_TOP_LEVEL_IRQS: c_int = 64;
pub const SUN6I_NR_DIRECT_IRQS: c_int = 16;
pub const SUN6I_NR_MUX_BITS: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun6i_r_intc_variant {
    pub first_mux_irq: u32,
    pub nr_mux_irqs: u32,
    pub mux_valid: [u32; BITS_TO_U32(SUN6I_NR_MUX_BITS)],
}
...
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_ack_nmi() {
    static void sun6i_r_intc_ack_nmi(void)
    {
    writel_relaxed(SUN6I_NMI_BIT, base + SUN6I_IRQ_PENDING(0));
    }
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_nmi_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_nmi_eoi(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_nmi_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_nmi_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_irq_set_wake(data: *mut irq_data, on: c_uint) -> c_int {
    static int sun6i_r_intc_irq_set_wake(struct irq_data *data, unsigned int on)
    {
    let mut offset_from_nmi: c_ulong = data.hwirq - nmi_hwirq;
    if (offset_from_nmi < SUN6I_NR_DIRECT_IRQS)
    assign_bit(offset_from_nmi, wake_irq_enabled, on);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(data->hwirq, _arg: wake_mux_valid)) -> else {
...
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_r_intc_shutdown(data: *mut c_void) {
...
// Extract the NMI hwirq number from the OF node.
    ...
    sun6i_r_intc_ack_nmi();
    sun6i_r_intc_resume(core::ptr::null_mut());
    return 0;
    }
