...
//! Source: drivers/irqchip/irq-mips-gic.c
#![no_std]
...
pub const GIC_MAX_INTRS: c_int = 256;

// Add 2 to convert GIC CPU pin to core interrupt
pub const GIC_CPU_PIN_OFFSET: c_int = 2;
// Mapped interrupt to pin X, then GIC will generate the vector (X+1).
pub const GIC_PIN_TO_VEC_OFFSET: c_int = 1;
// Convert between local/shared IRQ number and GIC HW IRQ number.
pub const GIC_LOCAL_HWIRQ_BASE: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn __gic_with_next_online_cpu(prev: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gic_unlock_cluster() {
...
//
#[no_mangle]
unsafe extern "C" fn gic_irq_lock_cluster(d: *mut irq_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_clear_pcpu_masks(intr: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gic_local_irq_is_routable(intr: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_bind_eic_interrupt(irq: c_int, set: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gic_send_ipi(d: *mut irq_data, cpu: c_uint) {
    static void gic_send_ipi(struct irq_data *d, unsigned int cpu)
    {
    let mut hwirq: irq_hw_number_t = GIC_HWIRQ_TO_SHARED(irqd_to_hwirq(d));
...
#[no_mangle]
pub unsafe extern "C" fn gic_get_c0_compare_int() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gic_get_c0_perfcount_int() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gic_get_c0_fdc_int() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_handle_shared_int(chained: bool) {
...
unsafe extern "C" fn gic_mask_irq(d: *mut irq_data) {
    ...
    {
    let mut intr: c_uint = GIC_HWIRQ_TO_SHARED(d.hwirq);
    if (gic_irq_lock_cluster(d)) {
...
#[no_mangle]
unsafe extern "C" fn gic_ack_irq(d: *mut irq_data) {
    static void gic_ack_irq(struct irq_data *d)
    {
    let mut irq: c_uint = GIC_HWIRQ_TO_SHARED(d.hwirq);
    if (gic_irq_lock_cluster(d)) {
...
#[no_mangle]
unsafe extern "C" fn gic_handle_local_int(chained: bool) {
...
#[no_mangle]
unsafe extern "C" fn gic_mask_local_irq(d: *mut irq_data) {
    static void gic_mask_local_irq(struct irq_data *d)
    {
    let mut intr: c_int = GIC_HWIRQ_TO_LOCAL(d.hwirq);
    write_gic_vl_rmask(BIT(intr));
    }
#[no_mangle]
unsafe extern "C" fn gic_unmask_local_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_mask_local_irq_all_vpes(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_unmask_local_irq_all_vpes(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_all_vpes_irq_cpu_online() {
    ...
    let mut intr: c_uint = local_intrs[i];
    struct gic_all_vpes_chip_data *cd;
...
#[no_mangle]
unsafe extern "C" fn __gic_irq_dispatch() {
...
#[no_mangle]
unsafe extern "C" fn gic_irq_dispatch(desc: *mut irq_desc) {
    ...
    {
    let mut intr: c_int = GIC_HWIRQ_TO_SHARED(hw);
...
#[no_mangle]
pub unsafe extern "C" fn if(GIC_LOCAL: intspec[0] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn gic_register_ipi_domain(node: *mut device_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gic_register_ipi_domain(node: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_cpu_startup(cpu: c_uint) -> c_int {
...
// Always use vector 1 in EIC mode
    ...
    GIC_NUM_LOCAL_INTRS +
    gic_shared_intrs, 0,
    &gic_irq_domain_ops, core::ptr::null_mut());
    if (!gic_irq_domain) {
...
//
    ...
    gic_cpu_startup, core::ptr::null_mut());
    }
