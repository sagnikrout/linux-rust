...
//! Source: drivers/irqchip/qcom-irq-combiner.c
#![no_std]
...
pub const REG_SIZE: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct combiner_reg {
...
pub struct combiner {
    ...
    pub nirqs: u32,
    pub nregs: u32,
    pub regs: [combiner_reg; ],
}

#[no_mangle]
pub unsafe extern "C" fn irq_nr(reg: u32, bit: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn combiner_handle_irq(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn combiner_irq_chip_mask_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn combiner_irq_chip_unmask_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn combiner_irq_unmap(domain: *mut irq_domain, irq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn count_registers_cb(ares: *mut acpi_resource, context: *mut c_void) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn count_registers(pdev: *mut platform_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct get_registers_context {
    pub dev: *mut device,
    pub combiner: *mut combiner,
    pub err: c_int,
}

#[no_mangle]
unsafe extern "C" fn get_registers_cb(ares: *mut acpi_resource, context: *mut c_void) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn get_registers(pdev: *mut platform_device, comb: *mut combiner) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn combiner_probe(pdev: *mut platform_device) -> c_int {
