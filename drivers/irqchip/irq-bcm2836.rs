...
//! Source: drivers/irqchip/irq-bcm2836.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm2836_arm_irqchip_intc {
...
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_mask_timer_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_unmask_timer_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_mask_pmu_irq(d: *mut irq_data) {
    static void bcm2836_arm_irqchip_mask_pmu_irq(struct irq_data *d)
    {
    writel(1 << smp_processor_id(), intc.base + LOCAL_PM_ROUTING_CLR);
    }
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_unmask_pmu_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_mask_gpu_irq(d: *mut irq_data) {
    static void bcm2836_arm_irqchip_mask_gpu_irq(struct irq_data *d)
    {
    }
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_unmask_gpu_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_dummy_op(d: *mut irq_data) {
    ...
    static void
#[no_mangle]
pub unsafe extern "C" fn bcm2836_arm_irqchip_handle_irq(regs: *mut pt_regs) -> __exception_irq_entry {
...
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_handle_ipi(desc: *mut irq_desc) {
    ...
    if (mbox_val) {
    let mut hwirq: c_int = ffs(mbox_val) - 1;
    generic_handle_domain_irq(ipi_domain, hwirq);
    }
    chained_irq_exit(chip, desc);
    }
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_ipi_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn bcm2836_cpu_starting(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm2836_cpu_dying(cpu: c_uint) -> c_int {
...
pub const BITS_PER_MBOX: c_int = 32;
#[no_mangle]
unsafe extern "C" fn bcm2836_arm_irqchip_smp_init() -> void __init {
    ...
    base_ipi = irq_domain_alloc_irqs(ipi_domain, BITS_PER_MBOX, NUMA_NO_NODE, core::ptr::null_mut());
    if (WARN_ON(!base_ipi))
    return;
    set_smp_ipi_range(base_ipi, BITS_PER_MBOX);
    irq_set_chained_handler_and_data(mux_irq,
    bcm2836_arm_irqchip_handle_ipi, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn bcm2835_init_local_timer_frequency() {
