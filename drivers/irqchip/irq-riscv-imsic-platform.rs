...
//! Source: drivers/irqchip/irq-riscv-imsic-platform.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imsic_irq_mask(d: *mut irq_data) {
    static void imsic_irq_mask(struct irq_data *d)
    {
    imsic_vector_mask(irq_data_get_irq_chip_data(d));
    }
#[no_mangle]
unsafe extern "C" fn imsic_irq_unmask(d: *mut irq_data) {
    static void imsic_irq_unmask(struct irq_data *d)
    {
    imsic_vector_unmask(irq_data_get_irq_chip_data(d));
    }
#[no_mangle]
unsafe extern "C" fn imsic_irq_retrigger(d: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imsic_irq_ack(d: *mut irq_data) {
    static void imsic_irq_ack(struct irq_data *d)
    {
    irq_move_irq(d);
    }
#[no_mangle]
unsafe extern "C" fn imsic_irq_compose_vector_msg(vec: *mut imsic_vector, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn imsic_irq_compose_msg(d: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn imsic_msi_update_msg(d: *mut irq_data, vec: *mut imsic_vector) {
...
#[no_mangle]
unsafe extern "C" fn imsic_irq_force_complete_move(d: *mut irq_data) {
...
#[no_mangle]
pub unsafe extern "C" fn imsic_irqdomain_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imsic_platform_probe_common(fwnode: *mut fwnode_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imsic_platform_dt_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn imsic_platform_acpi_probe(fwnode: *mut fwnode_handle) -> c_int {
