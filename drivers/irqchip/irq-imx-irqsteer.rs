...
//! Source: drivers/irqchip/irq-imx-irqsteer.c
#![no_std]
...
pub const CHANCTRL: c_uint = 0x0;

pub const CHAN_MAX_OUTPUT_INT: c_uint = 0xF;
// SoC does not implement the CHANCTRL register

#[repr(C)]
#[derive(Copy, Clone)]
pub struct irqsteer_devtype_data {
    pub quirks: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct irqsteer_data {
    pub regs: *mut void __iomem,
    pub ipg_clk: *mut clk,
    pub irq: [c_int; CHAN_MAX_OUTPUT_INT],
    pub irq_count: c_int,
    pub lock: raw_spinlock_t,
    pub reg_num: c_int,
    pub channel: c_int,
    pub domain: *mut irq_domain,
    pub saved_reg: *mut u32,
    pub dev: *mut device,
    pub devtype_data: *const irqsteer_devtype_data,
}

    let mut imx_data: static struct irqsteer_devtype_data = { };
    static const struct irqsteer_devtype_data s32n79_data = {
    .quirks	= IRQSTEER_QUIRK_NO_CHANCTRL,
    };
#[no_mangle]
unsafe extern "C" fn irqsteer_has_chanctrl(data: *const irqsteer_devtype_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_irq_unmask(d: *mut irq_data) {
    static void imx_irqsteer_irq_unmask(struct irq_data *d)
    {
    struct irqsteer_data *data = d.chip_data;
    let mut idx: c_int = imx_irqsteer_get_reg_index(data, d.hwirq);
    unsigned long flags;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_irq_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_irq_bus_sync_unlock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_get_hwirq_base(data: *mut irqsteer_data, irq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_irq_handler(desc: *mut irq_desc) {
    ...
    let mut idx: c_int = imx_irqsteer_get_reg_index(data, hwirq);
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_save_regs(data: *mut irqsteer_data) {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_restore_regs(data: *mut irqsteer_data) {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_irqsteer_resume(dev: *mut device) -> c_int {
    ...
    imx_irqsteer_resume, core::ptr::null_mut())
    };
