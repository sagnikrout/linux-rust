...
//! Source: drivers/irqchip/irq-gic-v5-irs.c
#![no_std]
...
//
pub const LPI_ID_BITS_LINEAR: c_int = 12;
...
//
#[no_mangle]
unsafe extern "C" fn gicv5_irs_ist_synchronise(irs_data: *mut gicv5_irs_chip_data) -> c_int {
    ...
    GICV5_IRS_IST_STATUSR_IDLE, core::ptr::null_mut());
    }
...
//
    ...
    let mut lpi_id_cap: u8 = ilog2(KMALLOC_MAX_SIZE) - 2 + istsz;
...
//
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_iste_alloc(lpi: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gicv5_irs_l2_sz(idr2: u32) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gicv5_irs_init_ist(irs_data: *mut gicv5_irs_chip_data) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_cpu_to_iaffid(cpuid: c_int, iaffid: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_irs_wait_for_spi_op(irs_data: *mut gicv5_irs_chip_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_irs_wait_for_pe_selr(irs_data: *mut gicv5_irs_chip_data) -> c_int {
    static int gicv5_irs_wait_for_pe_selr(struct gicv5_irs_chip_data *irs_data)
    {
    return gicv5_irs_wait_for_irs_pe(irs_data, true);
    }
#[no_mangle]
unsafe extern "C" fn gicv5_irs_wait_for_pe_cr0(irs_data: *mut gicv5_irs_chip_data) -> c_int {
    static int gicv5_irs_wait_for_pe_cr0(struct gicv5_irs_chip_data *irs_data)
    {
    return gicv5_irs_wait_for_irs_pe(irs_data, false);
    }
#[no_mangle]
pub unsafe extern "C" fn gicv5_spi_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_irs_wait_for_idle(irs_data: *mut gicv5_irs_chip_data) -> c_int {
    ...
    GICV5_IRS_CR0_IDLE, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn gicv5_irs_disable(irs_data: *mut gicv5_irs_chip_data) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_syncr() {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_register_cpu(cpuid: c_int) -> c_int {
...
//
    let mut iaffid_mask: u16 = GENMASK(iaffid_bits - 1, 0);
    int ret, i, ncpus, niaffids;
    ncpus = of_count_phandle_with_args(node, "cpus", core::ptr::null_mut());
    if (ncpus < 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn gicv5_irs_clear_affinity(irs_data: *mut gicv5_irs_chip_data) -> void __init {
    ...
    per_cpu(per_cpu_irs_data, cpu) = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn irs_setup_pri_bits(idr1: u32) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_irs_init(irs_data: *mut gicv5_irs_chip_data) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gicv5_irs_of_init(node: *mut device_node) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_remove() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_enable() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_its_probe() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_of_probe(parent: *mut device_node) -> int __init {
    ...
    let mut __initdata: static int current_irsid = -1;
...
#[no_mangle]
unsafe extern "C" fn gicv5_irs_acpi_init_affinity(irsid: u32, irs_data: *mut gicv5_irs_chip_data) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_irs_acpi_probe() -> int __init {
