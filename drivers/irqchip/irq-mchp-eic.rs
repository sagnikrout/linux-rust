...
//! Source: drivers/irqchip/irq-mchp-eic.c
#![no_std]
...
pub struct mchp_eic {
    ...
    pub irqs: [u32; MCHP_EIC_NIRQ],
    pub scfg: [u32; MCHP_EIC_NIRQ],
    pub wakeup_source: u32,
}

    static struct mchp_eic *eic;
#[no_mangle]
unsafe extern "C" fn mchp_eic_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mchp_eic_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mchp_eic_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_eic_irq_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_eic_irq_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_eic_irq_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mchp_eic_probe(pdev: *mut platform_device, parent: *mut device_node) -> c_int {
