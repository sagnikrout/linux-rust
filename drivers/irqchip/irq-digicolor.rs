...
//! Source: drivers/irqchip/irq-digicolor.c
#![no_std]
...
pub const UC_IRQ_CONTROL: c_uint = 0x04;
pub const IC_FLAG_CLEAR_LO: c_uint = 0x00;
pub const IC_FLAG_CLEAR_XLO: c_uint = 0x04;
pub const IC_INT0ENABLE_LO: c_uint = 0x10;
pub const IC_INT0ENABLE_XLO: c_uint = 0x14;
pub const IC_INT0STATUS_LO: c_uint = 0x18;
pub const IC_INT0STATUS_XLO: c_uint = 0x1c;
    static struct irq_domain *digicolor_irq_domain;
#[no_mangle]
unsafe extern "C" fn digicolor_handle_irq(regs: *mut pt_regs) -> void __exception_irq_entry {
...
// channel 1, regular IRQs
    ...
    irq_domain_create_linear(of_fwnode_handle(node), 64, &irq_generic_chip_ops, core::ptr::null_mut());
