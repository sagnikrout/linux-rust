...
//! Source: drivers/irqchip/irq-riscv-imsic-early.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imsic_noipi_cfg(buf: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn imsic_ipi_send(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn imsic_ipi_starting_cpu() {
...
#[no_mangle]
unsafe extern "C" fn imsic_ipi_dying_cpu() {
...
#[no_mangle]
unsafe extern "C" fn imsic_ipi_domain_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn imsic_handle_irq(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn imsic_hw_states_init() {
...
#[no_mangle]
unsafe extern "C" fn imsic_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imsic_dying_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imsic_pm_notifier(self: *mut notifier_block, cmd: c_ulong, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imsic_early_probe(fwnode: *mut fwnode_handle) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn imsic_early_dt_init(node: *mut device_node, parent: *mut device_node) -> int __init {
    ...
    int rc;
// Setup IMSIC state
    rc = imsic_setup_state(fwnode, core::ptr::null_mut());
    if (rc) {
...
//
    ...
    imsic_acpi_fwnode = core::ptr::null_mut();
    return rc;
    }
    IRQCHIP_ACPI_DECLARE(riscv_imsic, ACPI_MADT_TYPE_IMSIC, core::ptr::null_mut(),
