...
//! Source: drivers/irqchip/irq-ti-sci-intr.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_sci_intr_irq_domain {
    pub sci: *const ti_sci_handle,
    pub out_irqs: *mut ti_sci_resource,
    pub dev: *mut device,
    pub ti_sci_id: u32,
    pub type: u32,
}
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_intr_xlate_irq(intr: *mut ti_sci_intr_irq_domain, irq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sci_intr_irq_domain_probe(pdev: *mut platform_device) -> c_int {
