...
//! Source: drivers/irqchip/irq-csky-apb-intc.c
#![no_std]
...
pub const INTC_IRQS: c_int = 64;
pub const CK_INTC_ICR: c_uint = 0x00;
pub const CK_INTC_PEN31_00: c_uint = 0x14;
pub const CK_INTC_PEN63_32: c_uint = 0x2c;
pub const CK_INTC_NEN31_00: c_uint = 0x10;
pub const CK_INTC_NEN63_32: c_uint = 0x28;
pub const CK_INTC_SOURCE: c_uint = 0x40;
pub const CK_INTC_DUAL_BASE: c_uint = 0x100;
pub const GX_INTC_PEN31_00: c_uint = 0x00;
pub const GX_INTC_PEN63_32: c_uint = 0x04;
pub const GX_INTC_NEN31_00: c_uint = 0x40;
pub const GX_INTC_NEN63_32: c_uint = 0x44;
pub const GX_INTC_NMASK31_00: c_uint = 0x50;
pub const GX_INTC_NMASK63_32: c_uint = 0x54;
pub const GX_INTC_SOURCE: c_uint = 0x60;
    static void __iomem *reg_base;
    static struct irq_domain *root_domain;
    let mut nr_irq: static int = INTC_IRQS;
//
...
//
#[no_mangle]
unsafe extern "C" fn irq_ck_mask_set_bit(d: *mut irq_data) {
    static void irq_ck_mask_set_bit(struct irq_data *d)
    {
    struct irq_chip_generic *gc = irq_data_get_irq_chip_data(d);
    struct irq_chip_type *ct = irq_data_get_chip_type(d);
    let mut ifr: c_ulong = ct.regs.mask - 8;
...
#[no_mangle]
pub unsafe extern "C" fn build_channel_val(idx: u32, magic: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn setup_irq_channel(magic: u32, reg_addr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn gx_irq_handler(regs: *mut pt_regs) {
...
//
#[no_mangle]
unsafe extern "C" fn ck_irq_handler(regs: *mut pt_regs) {
