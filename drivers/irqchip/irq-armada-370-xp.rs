...
//! Source: drivers/irqchip/irq-armada-370-xp.c
#![no_std]
...
pub const MPIC_INT_CONTROL: c_uint = 0x00;

pub const MPIC_SW_TRIG_INT: c_uint = 0x04;
pub const MPIC_INT_SET_ENABLE: c_uint = 0x30;
pub const MPIC_INT_CLEAR_ENABLE: c_uint = 0x34;

// Registers relative to mpic->per_cpu
pub const MPIC_IN_DRBEL_CAUSE: c_uint = 0x08;
pub const MPIC_IN_DRBEL_MASK: c_uint = 0x0c;
pub const MPIC_PPI_CAUSE: c_uint = 0x10;
pub const MPIC_CPU_INTACK: c_uint = 0x44;

pub const MPIC_INT_SET_MASK: c_uint = 0x48;
pub const MPIC_INT_CLEAR_MASK: c_uint = 0x4C;
pub const MPIC_INT_FABRIC_MASK: c_uint = 0x54;

pub const MPIC_PER_CPU_IRQS_NR: c_int = 29;
// IPI and MSI interrupt definitions for IPI platforms
pub const IPI_DOORBELL_NR: c_int = 8;

pub const PCI_MSI_DOORBELL_START: c_int = 16;
pub const PCI_MSI_DOORBELL_NR: c_int = 16;

// MSI interrupt definitions for non-IPI platforms
pub const PCI_MSI_FULL_DOORBELL_START: c_int = 0;
pub const PCI_MSI_FULL_DOORBELL_NR: c_int = 32;
...
pub struct mpic {
    ...
    pub PCI_MSI_FULL_DOORBELL_NR): DECLARE_BITMAP(msi_used,,
    pub msi_lock: mutex,
    pub msi_doorbell_addr: phys_addr_t,
    pub msi_doorbell_mask: u32,
    pub msi_doorbell_size: unsigned int msi_doorbell_start,,

    pub doorbell_mask: u32,
}

    static struct mpic *mpic_data __ro_after_init;
#[no_mangle]
pub unsafe extern "C" fn mpic_is_ipi_available(mpic: *mut mpic) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mpic_is_percpu_irq(hwirq: irq_hw_number_t) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mpic_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpic_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpic_compose_msi_msg(d: *mut irq_data, msg: *mut msi_msg) {
    static void mpic_compose_msi_msg(struct irq_data *d, struct msi_msg *msg)
    {
    let mut cpu: c_uint = cpumask_first(irq_data_get_effective_affinity_mask(d));
    struct mpic *mpic = irq_data_get_irq_chip_data(d);
...
#[no_mangle]
unsafe extern "C" fn mpic_msi_set_affinity(d: *mut irq_data, mask: *const cpumask, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpic_msi_free(domain: *mut irq_domain, virq: c_uint, nr_irqs: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mpic_msi_reenable_percpu(mpic: *mut mpic) {
...
#[no_mangle]
unsafe extern "C" fn mpic_perf_init(mpic: *mut mpic) {
...
#[no_mangle]
unsafe extern "C" fn mpic_ipi_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpic_ipi_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpic_ipi_send_mask(d: *mut irq_data, mask: *const cpumask) {
...
#[no_mangle]
unsafe extern "C" fn mpic_ipi_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mpic_ipi_resume(mpic: *mut mpic) {
    static void mpic_ipi_resume(struct mpic *mpic)
    {
    for (irq_hw_number_t i = 0; i < IPI_DOORBELL_NR; i++) {
    let mut virq: c_uint = irq_find_mapping(mpic.ipi_domain, i);
    struct irq_data *d;
...
#[no_mangle]
unsafe extern "C" fn mpic_ipi_init(mpic: *mut mpic, node: *mut device_node) -> int __init {
    ...
    base_ipi = irq_domain_alloc_irqs(mpic.ipi_domain, IPI_DOORBELL_NR, NUMA_NO_NODE, core::ptr::null_mut());
    if (WARN_ON(!base_ipi))
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn mpic_set_affinity(d: *mut irq_data, mask_val: *const cpumask, force: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpic_smp_cpu_init(mpic: *mut mpic) {
...
#[no_mangle]
unsafe extern "C" fn mpic_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpic_cascaded_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpic_irq_map(domain: *mut irq_domain, virq: c_uint, hwirq: irq_hw_number_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpic_handle_msi_irq(mpic: *mut mpic) {
...
#[no_mangle]
unsafe extern "C" fn mpic_handle_ipi_irq(mpic: *mut mpic) {
...
#[no_mangle]
unsafe extern "C" fn mpic_handle_cascade_irq(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn mpic_handle_irq(regs: *mut pt_regs) -> void __exception_irq_entry {
...
#[no_mangle]
unsafe extern "C" fn mpic_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpic_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mpic_of_init(node: *mut device_node, parent: *mut device_node) -> int __init {
    ...
    if (err)
    return err;
    err = mpic_map_region(node, 1, &mpic.per_cpu, core::ptr::null_mut());
    if (err)
    return err;
...
// Setup for the boot CPU
    ...
    mpic_starting_cpu, core::ptr::null_mut());

    } else {

    cpuhp_setup_state_nocalls(CPUHP_AP_IRQ_ARMADA_XP_STARTING,
    "irqchip/armada/cascade:starting",
    mpic_cascaded_starting_cpu, core::ptr::null_mut());
