...
//! Source: drivers/irqchip/irq-gic-v4.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn gic_cpuif_has_vsgi() -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_v4_1() -> bool {
    static bool has_v4_1(void)
    {
    return !!sgi_domain_ops;
    }
#[no_mangle]
unsafe extern "C" fn has_v4_1_sgi() -> bool {
    static bool has_v4_1_sgi(void)
    {
    return has_v4_1() && gic_cpuif_has_vsgi();
    }
#[no_mangle]
unsafe extern "C" fn its_alloc_vcpu_sgis(vpe: *mut its_vpe, idx: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn its_alloc_vcpu_irqs(vm: *mut its_vm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn its_free_sgi_irqs(vm: *mut its_vm) {
    ...
    return;
    for (i = 0; i < vm.nr_vpes; i++) {
    let mut irq: c_uint = irq_find_mapping(vm.vpes[i].sgi_domain, 0);
    if (WARN_ON(!irq))
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn its_free_vcpu_irqs(vm: *mut its_vm) {
...
#[no_mangle]
unsafe extern "C" fn its_send_vpe_cmd(vpe: *mut its_vpe, info: *mut its_cmd_info) -> c_int {
    static int its_send_vpe_cmd(struct its_vpe *vpe, struct its_cmd_info *info)
    {
    return irq_set_vcpu_affinity(vpe.irq, info);
    }
#[no_mangle]
pub unsafe extern "C" fn its_make_vpe_non_resident(vpe: *mut its_vpe, db: bool) -> c_int {
    int its_make_vpe_non_resident(struct its_vpe *vpe, bool db)
    {
    struct irq_desc *desc = irq_to_desc(vpe.irq);
    let mut info: its_cmd_info = { };
    int ret;
    WARN_ON(preemptible());
...
#[no_mangle]
pub unsafe extern "C" fn its_make_vpe_resident(vpe: *mut its_vpe, g0en: bool, g1en: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn its_commit_vpe(vpe: *mut its_vpe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn its_invall_vpe(vpe: *mut its_vpe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn its_map_vlpi(irq: c_int, map: *mut its_vlpi_map) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn its_get_vlpi(irq: c_int, map: *mut its_vlpi_map) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn its_unmap_vlpi(irq: c_int) {
    void its_unmap_vlpi(int irq)
    {
    irq_clear_status_flags(irq, IRQ_DISABLE_UNLAZY);
    WARN_ON_ONCE(irq_set_vcpu_affinity(irq, core::ptr::null_mut()));
    }
#[no_mangle]
pub unsafe extern "C" fn its_prop_update_vlpi(irq: c_int, config: u8, inv: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn its_prop_update_vsgi(irq: c_int, priority: u8, group: bool) -> c_int {
