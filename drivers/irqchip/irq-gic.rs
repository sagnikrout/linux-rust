...
#[no_mangle]
unsafe extern "C" fn gic_check_cpu_features() {
...
pub struct gic_chip_data {
    pub dist_base: union gic_base,
    pub cpu_base: union gic_base,
    pub raw_dist_base: *mut void __iomem,
    pub raw_cpu_base: *mut void __iomem,
    pub percpu_offset: u32,

    pub 32)]: u32 saved_spi_enable[DIV_ROUND_UP(1020,,
    pub 32)]: u32 saved_spi_active[DIV_ROUND_UP(1020,,
    pub 16)]: u32 saved_spi_conf[DIV_ROUND_UP(1020,,
    pub 4)]: u32 saved_spi_target[DIV_ROUND_UP(1020,,
    pub saved_ppi_enable: *mut u32 __percpu,
    pub saved_ppi_active: *mut u32 __percpu,
    pub saved_ppi_conf: *mut u32 __percpu,
...
// by the GIC itself.
//
pub const NR_GIC_CPU_IF: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn enable_frankengic() {
...
#[no_mangle]
pub unsafe extern "C" fn cascading_gic_irq(d: *mut irq_data) -> bool {
...
unsafe extern "C" fn gic_poke_irq(d: *mut irq_data, offset: u32) {
    ...
    {
    let mut mask: u32 = 1 << (irqd_to_hwirq(d) % 32);
...
unsafe extern "C" fn gic_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    ...
    {
    let mut gicirq: irq_hw_number_t = irqd_to_hwirq(d);
...
#[no_mangle]
unsafe extern "C" fn gic_handle_cascade_irq(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn gic_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
pub unsafe extern "C" fn gic_cascade_irq(gic_nr: c_uint, irq: c_uint) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn gic_get_cpumask(gic: *mut gic_chip_data) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn gic_check_gicv2(base: *mut void __iomem) -> bool {
    static bool gic_check_gicv2(void __iomem *base)
    {
    let mut val: u32 = readl_relaxed(base + GIC_CPU_IDENT);
    return (val & 0xff0fff) == 0x02043B;
    }
#[no_mangle]
unsafe extern "C" fn gic_cpu_if_up(gic: *mut gic_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_dist_init(gic: *mut gic_chip_data) {
    static void gic_dist_init(struct gic_chip_data *gic)
    {
    unsigned int i;
    u32 cpumask;
    let mut gic_irqs: c_uint = gic.gic_irqs;
    void __iomem *base = gic_data_dist_base(gic);
...
#[no_mangle]
unsafe extern "C" fn gic_cpu_init(gic: *mut gic_chip_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gic_cpu_if_down(gic_nr: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gic_dist_save(gic: *mut gic_chip_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gic_dist_restore(gic: *mut gic_chip_data) {
...
#[no_mangle]
pub unsafe extern "C" fn gic_cpu_save(gic: *mut gic_chip_data) {
...
#[no_mangle]
pub unsafe extern "C" fn gic_cpu_restore(gic: *mut gic_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn gic_notifier(self: *mut notifier_block, cmd: c_ulong, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_pm_init(gic: *mut gic_chip_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmw_writeb(bval: u8, addr: *mut void __iomem) {
    static void rmw_writeb(u8 bval, void __iomem *addr)
    {
    static DEFINE_RAW_SPINLOCK(rmw_lock);
    let mut offset: c_ulong = (unsigned long)addr & 3UL;
    let mut shift: c_ulong = offset * 8;
    unsigned long flags;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn gic_smp_init() -> __init void {
...
//
#[no_mangle]
pub unsafe extern "C" fn gic_send_sgi(cpu_id: c_uint, irq: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gic_get_cpu_id(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gic_migrate_target(new_cpu_id: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn gic_get_sgir_physaddr() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn gic_init_physaddr(node: *mut device_node) -> void __init {
...
// Frankein-GIC without banked registers...
    ...
    let mut mpidr: u32 = cpu_logical_map(cpu);
    let mut core_id: u32 = MPIDR_AFFINITY_LEVEL(mpidr, 0);
    let mut offset: c_ulong = gic.percpu_offset * core_id;
...
#[no_mangle]
unsafe extern "C" fn gic_teardown(gic: *mut gic_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn gicv2_force_probe_cfg(buf: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gic_check_eoimode(node: *mut device_node, base: *mut void __iomem) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_enable_rmw_access(data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gic_of_setup(gic: *mut gic_chip_data, node: *mut device_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gic_of_init_child(dev: *mut device, gic: *mut gic_chip_data, irq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_gic_redist_is_present() -> bool __init {
...
//
    ...
    acpi_set_irq_model(ACPI_IRQ_MODEL_GIC, gic_v2_get_gsi_domain_id, core::ptr::null_mut());
    if (IS_ENABLED(CONFIG_ARM_GIC_V2M))
    gicv2m_init(core::ptr::null_mut(), gic_data[0].domain);
    if (static_branch_likely(&supports_deactivate_key))
