...
//! Source: drivers/irqchip/irq-bcm7120-l2.c
#![no_std]
...
pub const IRQEN: c_uint = 0x00;
pub const IRQSTAT: c_uint = 0x04;
pub const MAX_WORDS: c_int = 4;

pub const IRQS_PER_WORD: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm7120_l1_intc_data {
    pub b: *mut bcm7120_l2_intc_data,
    pub irq_map_mask: [u32; MAX_WORDS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm7120_l2_intc_data {
    pub n_words: c_uint,
    pub map_base: [*mut void __iomem; MAX_MAPPINGS],
    pub pair_base: [*mut void __iomem; MAX_WORDS],
    pub en_offset: [c_int; MAX_WORDS],
    pub stat_offset: [c_int; MAX_WORDS],
    pub domain: *mut irq_domain,
    pub can_wake: bool,
    pub irq_fwd_mask: [u32; MAX_WORDS],
    pub l1_data: *mut bcm7120_l1_intc_data,
    pub num_parent_irqs: c_int,
    pub map_mask_prop: *const __be32,
}

#[no_mangle]
unsafe extern "C" fn bcm7120_l2_intc_irq_handle(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn bcm7120_l2_intc_suspend(gc: *mut irq_chip_generic) {
...
#[no_mangle]
unsafe extern "C" fn bcm7120_l2_intc_resume(gc: *mut irq_chip_generic) {
...
#[no_mangle]
unsafe extern "C" fn bcm7120_l2_intc_iomap_7120(dn: *mut device_node, data: *mut bcm7120_l2_intc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7120_l2_intc_iomap_3380(dn: *mut device_node, data: *mut bcm7120_l2_intc_data) -> c_int {
    ...
    let mut map_idx: c_uint = gc_idx * 2;
...
#[no_mangle]
unsafe extern "C" fn bcm7120_l2_intc_probe_7120(pdev: *mut platform_device, parent: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm7120_l2_intc_probe_3380(pdev: *mut platform_device, parent: *mut device_node) -> c_int {
