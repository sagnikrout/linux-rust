...
//! Source: drivers/irqchip/irq-gic-v5-its.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gicv5_its_chip_data {
    pub its_devices: xarray,
    pub dev_alloc_lock: mutex,
    pub fwnode: *mut fwnode_handle,
    pub devtab_cfgr: gicv5_its_devtab_cfg,
    pub its_base: *mut void __iomem,
    pub flags: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gicv5_its_dev {
    pub its_node: *mut gicv5_its_chip_data,
    pub itt_cfg: gicv5_its_itt_cfg,
    pub event_map: *mut c_ulong,
    pub device_id: u32,
    pub num_events: u32,
    pub its_trans_phys_base: phys_addr_t,
}

#[no_mangle]
unsafe extern "C" fn its_readl_relaxed(its_node: *mut gicv5_its_chip_data, reg_offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_cache_sync(its: *mut gicv5_its_chip_data) -> c_int {
    ...
    GICV5_ITS_STATUSR_IDLE, core::ptr::null_mut());
    }
...
pub const ITS_L2SZ_64K_L2_BITS: c_int = 13;
pub const ITS_L2SZ_16K_L2_BITS: c_int = 11;
pub const ITS_L2SZ_4K_L2_BITS: c_int = 9;
#[no_mangle]
unsafe extern "C" fn gicv5_its_l2sz_to_l2_bits(sz: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_free_itt_linear(its_dev: *mut gicv5_its_dev) {
    static void gicv5_its_free_itt_linear(struct gicv5_its_dev *its_dev)
    {
    kfree(its_dev.itt_cfg.linear.itt);
    }
#[no_mangle]
unsafe extern "C" fn gicv5_its_free_itt_two_level(its_dev: *mut gicv5_its_dev) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_free_itt(its_dev: *mut gicv5_its_dev) {
    ...
    {
    let mut num_ents: c_uint = BIT(event_id_bits);
    __le64 *itt;
...
//
#[no_mangle]
unsafe extern "C" fn gicv5_its_l2sz_two_level(devtab: bool, its_idr1: u32, id_bits: u8, sz: *mut u8) -> bool {
...
//
    ...
    {
    let mut str: u8 = devtab_cfgr_field(its, STRUCTURE);
...
//
    ...
    let mut device_id_cap: u8 = ilog2(KMALLOC_MAX_SIZE/sizeof(*devtab));
...
//
#[no_mangle]
unsafe extern "C" fn gicv5_its_init_devtab(its: *mut gicv5_its_chip_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_deinit_devtab(its: *mut gicv5_its_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_compose_msi_msg(d: *mut irq_data, msg: *mut msi_msg) {
    ...
    let mut addr: u64 = its_dev.its_trans_phys_base;
    ...
    {
    let mut dev_id: u32 = info.scratchpad[0].ul;
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_msi_teardown(domain: *mut irq_domain, info: *mut msi_alloc_info_t) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_map_event(its_dev: *mut gicv5_its_dev, event_id: u16, lpi: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_unmap_event(its_dev: *mut gicv5_its_dev, event_id: u16) {
...
// eventid = event_id_base;
    ...
    if (ret)
    goto out_eventid;
    ret = irq_domain_alloc_irqs_parent(domain, virq, nr_irqs, core::ptr::null_mut());
    if (ret)
    goto out_eventid;
    for (i = 0; i < nr_irqs; i++) {
//
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_write_cr0(its: *mut gicv5_its_chip_data, enable: bool) -> c_int {
    static int gicv5_its_write_cr0(struct gicv5_its_chip_data *its, bool enable)
    {
    let mut cr0: u32 = FIELD_PREP(GICV5_ITS_CR0_ITSEN, enable);
    its_writel_relaxed(its, cr0, GICV5_ITS_CR0);
    return gicv5_wait_for_op_atomic(its.its_base, GICV5_ITS_CR0,
    GICV5_ITS_CR0_IDLE, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn gicv5_its_enable(its: *mut gicv5_its_chip_data) -> c_int {
    static int gicv5_its_enable(struct gicv5_its_chip_data *its)
    {
    return gicv5_its_write_cr0(its, true);
    }
#[no_mangle]
unsafe extern "C" fn gicv5_its_disable(its: *mut gicv5_its_chip_data) -> c_int {
    static int gicv5_its_disable(struct gicv5_its_chip_data *its)
    {
    return gicv5_its_write_cr0(its, false);
    }
#[no_mangle]
unsafe extern "C" fn gicv5_its_print_info(its_node: *mut gicv5_its_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_init_domain(its: *mut gicv5_its_chip_data, parent: *mut irq_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gicv5_its_init(node: *mut device_node) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_its_of_probe(parent: *mut device_node) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn gicv5_its_acpi_probe() -> void __init {
