...
//! Source: drivers/irqchip/irq-imx-gpcv2.c
#![no_std]
...
pub const IMR_NUM: c_int = 4;

pub const GPC_IMR1_CORE0: c_uint = 0x30;
pub const GPC_IMR1_CORE1: c_uint = 0x40;
pub const GPC_IMR1_CORE2: c_uint = 0x1c0;
pub const GPC_IMR1_CORE3: c_uint = 0x1d0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpcv2_irqchip_data {
    pub rlock: raw_spinlock,
    pub gpc_base: *mut void __iomem,
    pub wakeup_sources: [u32; IMR_NUM],
    pub saved_irq_mask: [u32; IMR_NUM],
    pub cpu2wakeup: u32,
}
...
#[no_mangle]
unsafe extern "C" fn gpcv2_wakeup_source_save(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpcv2_wakeup_source_restore(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imx_gpcv2_irq_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
    static int imx_gpcv2_irq_set_wake(struct irq_data *d, unsigned int on)
    {
    struct gpcv2_irqchip_data *cd = d.chip_data;
    let mut idx: c_uint = d.hwirq / 32;
    unsigned long flags;
    u32 mask, val;
...
#[no_mangle]
unsafe extern "C" fn imx_gpcv2_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn imx_gpcv2_irq_mask(d: *mut irq_data) {
