...
pub const FSI_SLAVE_CONF_SLOTS_SHIFT: c_int = 16;

pub const FSI_SLAVE_CONF_VERSION_SHIFT: c_int = 12;

pub const FSI_SLAVE_CONF_TYPE_SHIFT: c_int = 4;
pub const FSI_SLAVE_CONF_CRC_SHIFT: c_int = 4;

pub const FSI_SLAVE_CONF_DATA_BITS: c_int = 28;
pub const FSI_PEEK_BASE: c_uint = 0x410;
    let mut engine_page_size: static int = 0x400;
pub const FSI_SLAVE_BASE: c_uint = 0x800;
//
// FSI slave engine control register offsets
//
pub const FSI_SMODE: c_uint = 0x0	/* R/W: Mode register */;
pub const FSI_SISC: c_uint = 0x8	/* R/W: Interrupt condition */;
pub const FSI_SSTAT: c_uint = 0x14	/* R  : Slave status */;
pub const FSI_SLBUS: c_uint = 0x30	/* W  : LBUS Ownership */;
pub const FSI_LLMODE: c_uint = 0x100	/* R/W: Link layer mode register */;
//
// SMODE fields
//
pub const FSI_SMODE_WSC: c_uint = 0x80000000	/* Warm start done */;
pub const FSI_SMODE_ECRC: c_uint = 0x20000000	/* Hw CRC check */;

pub const FSI_SMODE_ED_MASK: c_uint = 0xf		/* Echo delay mask */;

pub const FSI_SMODE_SD_MASK: c_uint = 0xf		/* Send delay mask */;

pub const FSI_SMODE_LBCRR_MASK: c_uint = 0xf		/* Clk ratio mask */;
//
// SLBUS fields
//
pub const FSI_SLBUS_FORCE: c_uint = 0x80000000	/* Force LBUS ownership */;
//
// LLMODE fields
//
pub const FSI_LLMODE_ASYNC: c_uint = 0x1;
pub const FSI_SLAVE_SIZE_23b: c_uint = 0x800000;
    static DEFINE_IDA(master_ida);
    let mut slave_retries: static int = 2;
    static int discard_errors;
    static dev_t fsi_base_dev;
    static DEFINE_IDA(fsi_minor_ida);
pub const FSI_CHAR_MAX_DEVICES: c_uint = 0x1000;
// Legacy /dev numbering: 4 devices per chip, 16 chips
pub const FSI_CHAR_LEGACY_TOP: c_int = 64;
...
#[no_mangle]
unsafe extern "C" fn fsi_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_remove(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn fsi_device_peek(dev: *mut fsi_device, val: *mut c_void) -> c_int {
    int fsi_device_peek(struct fsi_device *dev, void *val)
    {
    let mut addr: u32 = FSI_PEEK_BASE + ((dev.unit - 2) * sizeof(uint32_t));
    return fsi_slave_read(dev.slave, addr, val, sizeof(uint32_t));
    }
#[no_mangle]
unsafe extern "C" fn fsi_device_release(_device: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fsi_slave_report_and_clear_errors(slave: *mut fsi_slave) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fsi_smode_echodly(x: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn fsi_smode_senddly(x: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn fsi_smode_lbcrr(x: c_int) -> u32 {
...
// Encode slave ID
#[no_mangle]
pub unsafe extern "C" fn fsi_smode_sid(x: c_int) -> u32 {
    static inline uint32_t fsi_smode_sid(int x)
    {
    return (x & FSI_SMODE_SID_MASK) << FSI_SMODE_SID_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn fsi_slave_smode(id: c_int, t_senddly: u8, t_echodly: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fsi_slave_set_smode(slave: *mut fsi_slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_slave_scan(slave: *mut fsi_slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aligned_access_size(offset: usize, count: usize) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn fsi_slave_release(dev: *mut device) {
    ...
    {
    u64 addr;
    if (of_property_read_reg(np, 0, &addr, core::ptr::null_mut()))
    return false;
    let mut addr: return = = (((u64)link << 32) | id);
    }
...
#[no_mangle]
unsafe extern "C" fn cfam_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn cfam_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_adjust_index(index: c_int) -> c_int {
    ...
    {
    let mut cid: c_int = slave.chip_id;
    int id;
...
// out_dev = fsi_base_dev + id;
    ...
    {
    if (fdev.dev.of_node) {
    let mut aid: c_int = of_alias_get_id(fdev.dev.of_node, fsi_dev_type_names[type]);
    if (aid >= 0) {
// Use the same scheme as the legacy numbers.
    let mut id: c_int = (aid << 2) | type;
    id = ida_alloc_range(&fsi_minor_ida, id, id, GFP_KERNEL);
    if (id >= 0) {
// out_index = aid;
// out_dev = fsi_base_dev + id;
...
#[no_mangle]
pub unsafe extern "C" fn fsi_free_minor(dev: dev_t) {
...
#[no_mangle]
unsafe extern "C" fn fsi_slave_init(master: *mut fsi_master, link: c_int, id: u8) -> c_int {
...
// FSI master support
#[no_mangle]
unsafe extern "C" fn fsi_check_access(addr: u32, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_master_link_disable(master: *mut fsi_master, link: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_master_link_enable(master: *mut fsi_master, link: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsi_master_break(master: *mut fsi_master, link: c_int) -> c_int {
    static int fsi_master_break(struct fsi_master *master, int link)
    {
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn fsi_master_scan(master: *mut fsi_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_slave_remove_device(dev: *mut device, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_master_remove_slave(dev: *mut device, arg: *mut c_void) -> c_int {
    static int fsi_master_remove_slave(struct device *dev, void *arg)
    {
    struct fsi_slave *slave = to_fsi_slave(dev);
    device_for_each_child(dev, core::ptr::null_mut(), fsi_slave_remove_device);
    cdev_device_del(&slave.cdev, &slave.dev);
    put_device(dev);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn fsi_master_unscan(master: *mut fsi_master) {
    static void fsi_master_unscan(struct fsi_master *master)
    {
    trace_fsi_master_scan(master, false);
    device_for_each_child(&master.dev, core::ptr::null_mut(), fsi_master_remove_slave);
    }
#[no_mangle]
pub unsafe extern "C" fn fsi_master_rescan(master: *mut fsi_master) -> c_int {
    ...
    static DEVICE_ATTR(rescan, 0200, core::ptr::null_mut(), master_rescan_store);
    ...
    static DEVICE_ATTR(break, 0200, core::ptr::null_mut(), master_break_store);
...
#[no_mangle]
pub unsafe extern "C" fn fsi_master_register(master: *mut fsi_master) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fsi_master_unregister(master: *mut fsi_master) {
    void fsi_master_unregister(struct fsi_master *master)
    {
    let mut idx: c_int = master.idx;
...
#[no_mangle]
unsafe extern "C" fn fsi_legacy_probe(fsidev: *mut fsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsi_legacy_remove(fsidev: *mut fsi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn fsi_driver_register(fsi_drv: *mut fsi_driver) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fsi_driver_unregister(fsi_drv: *mut fsi_driver) {
...
#[no_mangle]
unsafe extern "C" fn fsi_init() -> int __init {
