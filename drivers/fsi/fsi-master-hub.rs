...
//! Source: drivers/fsi/fsi-master-hub.c
#![no_std]
...
pub const FSI_ENGID_HUB_MASTER: c_uint = 0x1c;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsi_master_hub {
    pub master: fsi_master,
    pub upstream: *mut fsi_device,
    pub /: *mut *mut uint32_t addr, size; / slave-relative addr of,
...
#[no_mangle]
unsafe extern "C" fn hub_master_break(master: *mut fsi_master, link: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hub_master_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn hub_master_init(hub: *mut fsi_master_hub) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hub_master_probe(fsi_dev: *mut fsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hub_master_remove(fsi_dev: *mut fsi_device) {
