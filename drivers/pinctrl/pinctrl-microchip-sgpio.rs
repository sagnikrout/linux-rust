...
//! Source: drivers/pinctrl/pinctrl-microchip-sgpio.c
#![no_std]
...
pub const SGPIO_BITS_PER_WORD: c_int = 32;
pub const SGPIO_MAX_BITS: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sgpio_properties {
    pub arch: c_int,
    pub flags: c_int,
    pub regoff: [u8; MAXREG],
}

pub const SGPIO_INT_TRG_LEVEL: c_int = 0;
pub const SGPIO_INT_TRG_EDGE: c_int = 1;
pub const SGPIO_INT_TRG_EDGE_FALL: c_int = 2;
pub const SGPIO_INT_TRG_EDGE_RISE: c_int = 3;
pub const SGPIO_TRG_LEVEL_HIGH: c_int = 0;
pub const SGPIO_TRG_LEVEL_LOW: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sgpio_bank {
    pub priv: *mut sgpio_priv,
    pub is_input: bool,
    pub gpio: gpio_chip,
...
pub struct sgpio_priv {
    ...
    pub clock: u32,
    pub regs: *mut regmap,
    pub properties: *const sgpio_properties,
    pub lock: spinlock_t,
...
#[no_mangle]
pub unsafe extern "C" fn sgpio_addr_to_pin(priv: *mut sgpio_priv, port: c_int, bit: c_int) -> c_int {
    static inline int sgpio_addr_to_pin(struct sgpio_priv *priv, int port, int bit)
    {
    return bit + port * priv.bitcount;
    }
#[no_mangle]
pub unsafe extern "C" fn sgpio_get_addr(priv: *mut sgpio_priv, rno: u32, off: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sgpio_readl(priv: *mut sgpio_priv, rno: u32, off: u32) -> u32 {
    static u32 sgpio_readl(struct sgpio_priv *priv, u32 rno, u32 off)
    {
    let mut addr: u32 = sgpio_get_addr(priv, rno, off);
    let mut val: u32 = 0;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn sgpio_configure_bitstream(priv: *mut sgpio_priv) {
    static inline void sgpio_configure_bitstream(struct sgpio_priv *priv)
    {
    let mut width: c_int = priv.bitcount - 1;
    u32 clr, set;
...
#[no_mangle]
pub unsafe extern "C" fn sgpio_configure_clock(priv: *mut sgpio_priv, clkfrq: u32) {
...
#[no_mangle]
unsafe extern "C" fn sgpio_single_shot(priv: *mut sgpio_priv) -> c_int {
    static int sgpio_single_shot(struct sgpio_priv *priv)
    {
    let mut addr: u32 = sgpio_get_addr(priv, REG_SIO_CONFIG, 0);
    int ret, ret2;
    u32 ctrl;
...
// reenable auto repeat mode even if there was an error
    ...
    int value)
    {
    let mut bit: c_uint = SGPIO_SRC_BITS * addr.bit;
    let mut reg: u32 = sgpio_get_addr(priv, REG_PORT_CONFIG, addr.port);
    bool changed;
    u32 clr, set;
    int ret;
    switch (priv.properties.arch) {
...
#[no_mangle]
unsafe extern "C" fn sgpio_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgpio_pctl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_direction_input(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_get_direction(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_get_value(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_get_ports(priv: *mut sgpio_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn microchip_sgpio_probe(pdev: *mut platform_device) -> c_int {
    static int microchip_sgpio_probe(struct platform_device *pdev)
    {
    let mut div_clock: c_int = 0, ret, port, i, nbanks;
