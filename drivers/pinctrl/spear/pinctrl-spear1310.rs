...
//! Source: drivers/pinctrl/spear/pinctrl-spear1310.c
#![no_std]
...
// registers
pub const PERIP_CFG: c_uint = 0x3B0;
pub const MCIF_SEL_SHIFT: c_int = 5;

pub const PCIE_SATA_CFG: c_uint = 0x3A4;

pub const PAD_FUNCTION_EN_0: c_uint = 0x650;

pub const PAD_FUNCTION_EN_1: c_uint = 0x654;

pub const PAD_FUNCTION_EN_2: c_uint = 0x658;

pub const PAD_DIRECTION_SEL_0: c_uint = 0x65C;
pub const PAD_DIRECTION_SEL_1: c_uint = 0x660;
pub const PAD_DIRECTION_SEL_2: c_uint = 0x664;
// combined macros
...
pub const PMX_MCIFALL_1_MASK: c_uint = 0xF8000000;
pub const PMX_MCIFALL_2_MASK: c_uint = 0x0FFFFFFF;
...
#[no_mangle]
unsafe extern "C" fn spear1310_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spear1310_pinctrl_init() -> int __init {
