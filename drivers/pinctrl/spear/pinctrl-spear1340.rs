...
//! Source: drivers/pinctrl/spear/pinctrl-spear1340.c
#![no_std]
...
pub const PAD_FUNCTION_EN_1: c_uint = 0x668;
pub const PAD_FUNCTION_EN_2: c_uint = 0x66C;
pub const PAD_FUNCTION_EN_3: c_uint = 0x670;
pub const PAD_FUNCTION_EN_4: c_uint = 0x674;
pub const PAD_FUNCTION_EN_5: c_uint = 0x690;
pub const PAD_FUNCTION_EN_6: c_uint = 0x694;
pub const PAD_FUNCTION_EN_7: c_uint = 0x698;
pub const PAD_FUNCTION_EN_8: c_uint = 0x69C;
// - If peripherals, then primary OR alternate peripheral
pub const PAD_SHARED_IP_EN_1: c_uint = 0x6A0;
pub const PAD_SHARED_IP_EN_2: c_uint = 0x6A4;
//
...
pub const PADS_AS_GPIO_REG0_MASK: c_uint = 0xFFFFFFFE;
pub const PADS_AS_GPIO_REGS_MASK: c_uint = 0xFFFFFFFF;
pub const PADS_AS_GPIO_REG7_MASK: c_uint = 0x07FFFFFF;
// macro's for making pads as peripherals
pub const FSMC_16_BIT_AND_KBD_ROW_COL_REG0_MASK: c_uint = 0x00000FFE;
pub const UART0_ENH_AND_GPT_REG0_MASK: c_uint = 0x0003F000;
pub const PWM1_AND_KBD_COL5_REG0_MASK: c_uint = 0x00040000;
pub const I2C1_REG0_MASK: c_uint = 0x01080000;
pub const SPDIF_IN_REG0_MASK: c_uint = 0x00100000;
pub const PWM2_AND_GPT0_TMR0_CPT_REG0_MASK: c_uint = 0x00400000;
pub const PWM3_AND_GPT0_TMR1_CLK_REG0_MASK: c_uint = 0x00800000;
pub const PWM0_AND_SSP0_CS1_REG0_MASK: c_uint = 0x02000000;
pub const VIP_AND_CAM3_REG0_MASK: c_uint = 0xFC200000;
pub const VIP_AND_CAM3_REG1_MASK: c_uint = 0x0000000F;
pub const VIP_REG1_MASK: c_uint = 0x00001EF0;
pub const VIP_AND_CAM2_REG1_MASK: c_uint = 0x007FE100;
pub const VIP_AND_CAM1_REG1_MASK: c_uint = 0xFF800000;
pub const VIP_AND_CAM1_REG2_MASK: c_uint = 0x00000003;
pub const VIP_AND_CAM0_REG2_MASK: c_uint = 0x00001FFC;
pub const SMI_REG2_MASK: c_uint = 0x0021E000;
pub const SSP0_REG2_MASK: c_uint = 0x001E0000;
pub const TS_AND_SSP0_CS2_REG2_MASK: c_uint = 0x00400000;
pub const UART0_REG2_MASK: c_uint = 0x01800000;
pub const UART1_REG2_MASK: c_uint = 0x06000000;
pub const I2S_IN_REG2_MASK: c_uint = 0xF8000000;
pub const DEVS_GRP_AND_MIPHY_DBG_REG3_MASK: c_uint = 0x000001FE;
pub const I2S_OUT_REG3_MASK: c_uint = 0x000001EF;
pub const I2S_IN_REG3_MASK: c_uint = 0x00000010;
pub const GMAC_REG3_MASK: c_uint = 0xFFFFFE00;
pub const GMAC_REG4_MASK: c_uint = 0x0000001F;
pub const DEVS_GRP_AND_MIPHY_DBG_REG4_MASK: c_uint = 0x7FFFFF20;
pub const SSP0_CS3_REG4_MASK: c_uint = 0x00000020;
pub const I2C0_REG4_MASK: c_uint = 0x000000C0;
pub const CEC0_REG4_MASK: c_uint = 0x00000100;
pub const CEC1_REG4_MASK: c_uint = 0x00000200;
pub const SPDIF_OUT_REG4_MASK: c_uint = 0x00000400;
pub const CLCD_REG4_MASK: c_uint = 0x7FFFF800;
pub const CLCD_AND_ARM_TRACE_REG4_MASK: c_uint = 0x80000000;
pub const CLCD_AND_ARM_TRACE_REG5_MASK: c_uint = 0xFFFFFFFF;
pub const CLCD_AND_ARM_TRACE_REG6_MASK: c_uint = 0x00000001;
pub const FSMC_PNOR_AND_MCIF_REG6_MASK: c_uint = 0x073FFFFE;
pub const MCIF_REG6_MASK: c_uint = 0xF8C00000;
pub const MCIF_REG7_MASK: c_uint = 0x000043FF;
pub const FSMC_8BIT_REG7_MASK: c_uint = 0x07FFBC00;
// other registers
pub const PERIP_CFG: c_uint = 0x42C;
// PERIP_CFG register masks
pub const SSP_CS_CTL_HW: c_int = 0;
pub const SSP_CS_CTL_SW: c_int = 1;
pub const SSP_CS_CTL_MASK: c_int = 1;
pub const SSP_CS_CTL_SHIFT: c_int = 21;
pub const SSP_CS_VAL_MASK: c_int = 1;
pub const SSP_CS_VAL_SHIFT: c_int = 20;
pub const SSP_CS_SEL_CS0: c_int = 0;
pub const SSP_CS_SEL_CS1: c_int = 1;
pub const SSP_CS_SEL_CS2: c_int = 2;
pub const SSP_CS_SEL_MASK: c_int = 3;
pub const SSP_CS_SEL_SHIFT: c_int = 18;

pub const SPDIF_OUT_ENB_SHIFT: c_int = 2;
pub const MCIF_SEL_SD: c_int = 1;
pub const MCIF_SEL_CF: c_int = 2;
pub const MCIF_SEL_XD: c_int = 3;
pub const MCIF_SEL_MASK: c_int = 3;
pub const MCIF_SEL_SHIFT: c_int = 0;
pub const GMAC_CLK_CFG: c_uint = 0x248;

pub const GMAC_PHY_INPUT_ENB_VAL: c_int = 0;
pub const GMAC_PHY_SYNT_ENB_VAL: c_int = 1;
pub const GMAC_PHY_CLK_MASK: c_int = 1;
pub const GMAC_PHY_CLK_SHIFT: c_int = 2;
pub const GMAC_PHY_125M_PAD_VAL: c_int = 0;
pub const GMAC_PHY_PLL2_VAL: c_int = 1;
pub const GMAC_PHY_OSC3_VAL: c_int = 2;
pub const GMAC_PHY_INPUT_CLK_MASK: c_int = 3;
pub const GMAC_PHY_INPUT_CLK_SHIFT: c_int = 0;
pub const PCIE_SATA_CFG: c_uint = 0x424;
// PCIE CFG MASks

pub const SATA_PCIE_CFG_MASK: c_uint = 0xF1F;
...
#[no_mangle]
unsafe extern "C" fn spear1340_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spear1340_pinctrl_init() -> int __init {
