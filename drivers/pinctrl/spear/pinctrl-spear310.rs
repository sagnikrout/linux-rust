...
//! Source: drivers/pinctrl/spear/pinctrl-spear310.c
#![no_std]
...
// addresses
pub const PMX_CONFIG_REG: c_uint = 0x08;
// emi_cs_0_to_5_pins
...
#[no_mangle]
unsafe extern "C" fn spear310_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spear310_pinctrl_init() -> int __init {
