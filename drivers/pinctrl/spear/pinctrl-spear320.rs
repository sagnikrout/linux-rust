...
//! Source: drivers/pinctrl/spear/pinctrl-spear320.c
#![no_std]
...
// addresses
pub const PMX_CONFIG_REG: c_uint = 0x0C;
pub const MODE_CONFIG_REG: c_uint = 0x10;
pub const MODE_EXT_CONFIG_REG: c_uint = 0x18;
// modes
...
pub const EXT_CTRL_REG: c_uint = 0x0018;

pub const MII_MDIO_10_11_VAL: c_int = 0;

pub const MAC_MODE_MII: c_int = 0;
pub const MAC_MODE_RMII: c_int = 1;
pub const MAC_MODE_SMII: c_int = 2;
pub const MAC_MODE_SS_SMII: c_int = 3;
pub const MAC_MODE_MASK: c_uint = 0x3;
pub const MAC1_MODE_SHIFT: c_int = 16;
pub const MAC2_MODE_SHIFT: c_int = 18;
pub const IP_SEL_PAD_0_9_REG: c_uint = 0x00A4;

pub const PMX_UART2_PL_0_1_VAL: c_uint = 0x0;

pub const PMX_I2C2_PL_2_3_VAL: c_uint = 0x0;

pub const PMX_TOUCH_Y_PL_5_VAL: c_uint = 0x0;

pub const IP_SEL_PAD_10_19_REG: c_uint = 0x00A8;

pub const PMX_SMII_PL_10_11_VAL: c_int = 0;

pub const PMX_PWM3_PL_12_VAL: c_int = 0;

pub const PMX_SSP2_PL_13_14_15_16_VAL: c_int = 0;

pub const PMX_SSP1_PL_17_18_19_20_VAL: c_int = 0;

pub const IP_SEL_PAD_20_29_REG: c_uint = 0x00AC;

pub const PMX_SMII_PL_21_TO_27_VAL: c_int = 0;

pub const PMX_UART1_PL_28_29_VAL: c_int = 0;

pub const IP_SEL_PAD_30_39_REG: c_uint = 0x00B0;

pub const PMX_CAN0_PL_32_33_VAL: c_int = 0;

pub const PMX_PWM2_PL_34_VAL: c_int = 0;

pub const PMX_I2S_REF_CLK_PL_35_VAL: c_int = 0;

pub const PMX_TOUCH_X_PL_36_VAL: c_int = 0;

pub const PMX_PWM0_1_PL_37_38_VAL: c_int = 0;

pub const PMX_I2S_PL_39_VAL: c_int = 0;

pub const IP_SEL_PAD_40_49_REG: c_uint = 0x00B4;

pub const PMX_I2S_PL_40_VAL: c_int = 0;

pub const PMX_I2S_PL_41_42_VAL: c_int = 0;

pub const PMX_SDHCI_PL_43_VAL: c_int = 0;

pub const PMX_SDHCI_PL_44_45_VAL: c_int = 0;

pub const PMX_SDHCI_PL_46_47_VAL: c_int = 0;

pub const PMX_SDHCI_PL_48_49_VAL: c_int = 0;

pub const IP_SEL_PAD_50_59_REG: c_uint = 0x00B8;

pub const PMX_SDHCI_PL_50_VAL: c_int = 0;
pub const PMX_SDHCI_CD_PL_51_VAL: c_int = 0;

pub const PMX_FSMC_PL_52_53_VAL: c_int = 0;

pub const PMX_FSMC_PL_57_VAL: c_int = 0;

pub const IP_SEL_PAD_60_69_REG: c_uint = 0x00BC;

pub const PMX_FSMC_PL_60_VAL: c_int = 0;

pub const IP_SEL_PAD_70_79_REG: c_uint = 0x00C0;

pub const IP_SEL_PAD_80_89_REG: c_uint = 0x00C4;

pub const PMX_CLCD_PL_80_TO_85_VAL: c_int = 0;

pub const PMX_CLCD_PL_86_87_VAL: c_int = 0;

pub const PMX_CLCD_PL_88_89_VAL: c_int = 0;

pub const IP_SEL_PAD_90_99_REG: c_uint = 0x00C8;

pub const PMX_CLCD_PL_90_91_VAL: c_int = 0;

pub const PMX_CLCD_PL_92_93_VAL: c_int = 0;

pub const PMX_CLCD_PL_94_95_VAL: c_int = 0;

pub const PMX_CLCD_PL_96_97_VAL: c_int = 0;

pub const PMX_CLCD_PL_98_VAL: c_int = 0;

pub const PMX_SDHCI_PL_99_VAL: c_int = 0;

pub const IP_SEL_MIX_PAD_REG: c_uint = 0x00CC;

pub const PMX_SDHCI_PL_100_101_VAL: c_int = 0;

pub const PMX_SSP1_PORT_94_TO_97_VAL: c_int = 0;

pub const PMX_SSP2_PORT_90_TO_93_VAL: c_int = 0;

pub const PMX_UART1_ENH_PORT_81_TO_85_VAL: c_int = 0;

pub const PMX_UART3_PORT_94_VAL: c_int = 0;

pub const PMX_UART4_PORT_92_VAL: c_int = 0;

pub const PMX_UART5_PORT_90_VAL: c_int = 0;

pub const PMX_UART6_PORT_88_VAL: c_int = 0;

pub const PMX_I2C1_PORT_8_9_VAL: c_int = 0;

pub const PMX_I2C2_PORT_96_97_VAL: c_int = 0;

pub const PMX_SDHCI_CD_PORT_12_VAL: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn spear320_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spear320_pinctrl_init() -> int __init {
