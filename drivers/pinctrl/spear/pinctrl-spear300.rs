...
//! Source: drivers/pinctrl/spear/pinctrl-spear300.c
#![no_std]
...
// addresses
pub const PMX_CONFIG_REG: c_uint = 0x00;
pub const MODE_CONFIG_REG: c_uint = 0x04;
// modes
...
#[no_mangle]
unsafe extern "C" fn spear300_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    ...
    spear3xx_machdata.gpio_pingroups = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn spear300_pinctrl_init() -> int __init {
