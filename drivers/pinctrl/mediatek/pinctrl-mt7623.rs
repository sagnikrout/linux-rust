...
//! Source: drivers/pinctrl/mediatek/pinctrl-mt7623.c
#![no_std]
...
pub const PIN_BOND_REG0: c_uint = 0xb10;
pub const PIN_BOND_REG1: c_uint = 0xf20;
pub const PIN_BOND_REG2: c_uint = 0xef0;

pub const BOND_I2S_CLR: c_uint = 0x3;
pub const BOND_MSDC0E_CLR: c_uint = 0x1;
...
//
#[no_mangle]
unsafe extern "C" fn mt7623_bonding_disable(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mt7623_pinctrl_probe(pdev: *mut platform_device) -> c_int {
