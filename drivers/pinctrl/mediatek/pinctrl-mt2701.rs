...
//! Source: drivers/pinctrl/mediatek/pinctrl-mt2701.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_spec_pinmux_set {
    pub pin: c_ushort,
    pub offset: c_ushort,
    pub bit: c_uchar,
}
...
// E8E4E2  2/4/6/8/10/12/14/16
    ...
    let mut info_num: c_uint = ARRAY_SIZE(mt2701_spec_pinmux);
...
#[no_mangle]
unsafe extern "C" fn mt2701_spec_dir_set(reg_addr: *mut c_uint, pin: c_uint) {
