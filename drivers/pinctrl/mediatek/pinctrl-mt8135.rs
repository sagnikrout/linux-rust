...
//! Source: drivers/pinctrl/mediatek/pinctrl-mt8135.c
#![no_std]
...
pub const DRV_BASE1: c_uint = 0x500;
pub const DRV_BASE2: c_uint = 0x510;
pub const PUPD_BASE1: c_uint = 0x400;
pub const PUPD_BASE2: c_uint = 0x450;
pub const R0_BASE1: c_uint = 0x4d0;
pub const R1_BASE1: c_uint = 0x200;
pub const R1_BASE2: c_uint = 0x250;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_spec_pull_set {
    pub pin: c_uchar,
    pub pupd_bit: c_uchar,
    pub pupd_offset: c_ushort,
    pub r0_offset: c_ushort,
    pub r1_offset: c_ushort,
    pub r0_bit: c_uchar,
    pub r1_bit: c_uchar,
}
...
// E16E8E4 4/8/12/16/20/24/28/32
    ...
    let mut align: c_uchar = devdata.port_align;
...
#[no_mangle]
unsafe extern "C" fn mtk_pinctrl_init() -> int __init {
