...
//! Source: drivers/pinctrl/mediatek/pinctrl-mt8173.c
#![no_std]
...
pub const DRV_BASE: c_uint = 0xb00;
...
#[no_mangle]
unsafe extern "C" fn mt8173_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int mt8173_pinctrl_probe(struct platform_device *pdev)
    {
    return mtk_pctrl_init(pdev, &mt8173_pinctrl_data, core::ptr::null_mut());
    }
