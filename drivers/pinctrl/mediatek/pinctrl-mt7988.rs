...
//! Source: drivers/pinctrl/mediatek/pinctrl-mt7988.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7988_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7988_pinctrl_init() -> int __init {
