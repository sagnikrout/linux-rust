...
//! Source: drivers/pinctrl/mediatek/pinctrl-mt7986.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt7986a_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int mt7986a_pinctrl_probe(struct platform_device *pdev)
    {
    return mtk_moore_pinctrl_probe(pdev, &mt7986a_data);
    }
#[no_mangle]
unsafe extern "C" fn mt7986b_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7986_pinctrl_init() -> int __init {
