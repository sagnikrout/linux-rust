...
//! Source: drivers/pinctrl/nuvoton/pinctrl-npcm7xx.c
#![no_std]
...
// GCR registers
pub const NPCM7XX_GCR_PDID: c_uint = 0x00;
pub const NPCM7XX_GCR_MFSEL1: c_uint = 0x0C;
pub const NPCM7XX_GCR_MFSEL2: c_uint = 0x10;
pub const NPCM7XX_GCR_MFSEL3: c_uint = 0x64;
pub const NPCM7XX_GCR_MFSEL4: c_uint = 0xb0;
pub const NPCM7XX_GCR_CPCTL: c_uint = 0xD0;
pub const NPCM7XX_GCR_CP2BST: c_uint = 0xD4;
pub const NPCM7XX_GCR_B2CPNT: c_uint = 0xD8;
pub const NPCM7XX_GCR_I2CSEGSEL: c_uint = 0xE0;
pub const NPCM7XX_GCR_I2CSEGCTL: c_uint = 0xE4;
pub const NPCM7XX_GCR_SRCNT: c_uint = 0x68;
pub const NPCM7XX_GCR_FLOCKR1: c_uint = 0x74;
pub const NPCM7XX_GCR_DSCNT: c_uint = 0x78;

// GPIO registers
pub const NPCM7XX_GP_N_TLOCK1: c_uint = 0x00;
pub const NPCM7XX_GP_N_DIN: c_uint = 0x04 /* Data IN */;
pub const NPCM7XX_GP_N_POL: c_uint = 0x08 /* Polarity */;
pub const NPCM7XX_GP_N_DOUT: c_uint = 0x0c /* Data OUT */;
pub const NPCM7XX_GP_N_OE: c_uint = 0x10 /* Output Enable */;
pub const NPCM7XX_GP_N_OTYP: c_uint = 0x14;
pub const NPCM7XX_GP_N_MP: c_uint = 0x18;
pub const NPCM7XX_GP_N_PU: c_uint = 0x1c /* Pull-up */;
pub const NPCM7XX_GP_N_PD: c_uint = 0x20 /* Pull-down */;
pub const NPCM7XX_GP_N_DBNC: c_uint = 0x24 /* Debounce */;
pub const NPCM7XX_GP_N_EVTYP: c_uint = 0x28 /* Event Type */;
pub const NPCM7XX_GP_N_EVBE: c_uint = 0x2c /* Event Both Edge */;
pub const NPCM7XX_GP_N_OBL0: c_uint = 0x30;
pub const NPCM7XX_GP_N_OBL1: c_uint = 0x34;
pub const NPCM7XX_GP_N_OBL2: c_uint = 0x38;
pub const NPCM7XX_GP_N_OBL3: c_uint = 0x3c;
pub const NPCM7XX_GP_N_EVEN: c_uint = 0x40 /* Event Enable */;
pub const NPCM7XX_GP_N_EVENS: c_uint = 0x44 /* Event Set (enable) */;
pub const NPCM7XX_GP_N_EVENC: c_uint = 0x48 /* Event Clear (disable) */;
pub const NPCM7XX_GP_N_EVST: c_uint = 0x4c /* Event Status */;
pub const NPCM7XX_GP_N_SPLCK: c_uint = 0x50;
pub const NPCM7XX_GP_N_MPLCK: c_uint = 0x54;
pub const NPCM7XX_GP_N_IEM: c_uint = 0x58 /* Input Enable */;
pub const NPCM7XX_GP_N_OSRC: c_uint = 0x5c;
pub const NPCM7XX_GP_N_ODSC: c_uint = 0x60;
pub const NPCM7XX_GP_N_DOS: c_uint = 0x68 /* Data OUT Set */;
pub const NPCM7XX_GP_N_DOC: c_uint = 0x6c /* Data OUT Clear */;
pub const NPCM7XX_GP_N_OES: c_uint = 0x70 /* Output Enable Set */;
pub const NPCM7XX_GP_N_OEC: c_uint = 0x74 /* Output Enable Clear */;
pub const NPCM7XX_GP_N_TLOCK2: c_uint = 0x7c;
pub const NPCM7XX_GPIO_PER_BANK: c_int = 32;
pub const NPCM7XX_GPIO_BANK_NUM: c_int = 8;
pub const NPCM7XX_GCR_NONE: c_int = 0;
// Structure for register banks
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_gpio {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_pinctrl {
    pub pctldev: *mut pinctrl_dev,
    pub dev: *mut device,
    pub gpio_bank: [npcm7xx_gpio; NPCM7XX_GPIO_BANK_NUM],
...
pub const DRIVE_STRENGTH_MASK: c_uint = 0x0000FF00;

    ((hi) << DRIVE_STRENGTH_HI_SHIFT))

pub const GPI: c_uint = 0x1 /* Not GPO */;
pub const GPO: c_uint = 0x2 /* Not GPI */;
pub const SLEW: c_uint = 0x4 /* Has Slew Control, NPCM7XX_GP_N_OSRC */;
pub const SLEWLPC: c_uint = 0x8 /* Has Slew Control, SRCNT.3 */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_pincfg {
    pub flag: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn ioread32(NPCM7XX_GP_N_OSRC: bank->base +) -> return {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// pinmux_ops
#[no_mangle]
unsafe extern "C" fn npcm7xx_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// config = pinconf_to_config_packed(param, rc);
    ...
    {
    let mut param: enum pin_config_param = pinconf_to_config_param(config);
    let mut arg: u16 = pinconf_to_config_argument(config);
    struct npcm7xx_gpio *bank =
    &npcm.gpio_bank[pin / NPCM7XX_GPIO_PER_BANK];
    let mut gpio: c_int = BIT(pin % bank.chip.gc.ngpio);
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_gpio_of(pctrl: *mut npcm7xx_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_gpio_register(pctrl: *mut npcm7xx_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_pinctrl_register() -> int __init {
