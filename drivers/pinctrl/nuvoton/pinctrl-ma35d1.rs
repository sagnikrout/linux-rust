...
//! Source: drivers/pinctrl/nuvoton/pinctrl-ma35d1.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ma35d1_get_pin_num(offset: c_int, shift: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ma35d1_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ma35d1_pinctrl_init() -> int __init {
