...
//! Source: drivers/pinctrl/nuvoton/pinctrl-wpcm450.c
#![no_std]
...
// GCR registers
pub const WPCM450_GCR_MFSEL1: c_uint = 0x0c;
pub const WPCM450_GCR_MFSEL2: c_uint = 0x10;
pub const WPCM450_GCR_NONE: c_int = 0;
// GPIO event (interrupt) registers
pub const WPCM450_GPEVTYPE: c_uint = 0x00;
pub const WPCM450_GPEVPOL: c_uint = 0x04;
pub const WPCM450_GPEVDBNC: c_uint = 0x08;
pub const WPCM450_GPEVEN: c_uint = 0x0c;
pub const WPCM450_GPEVST: c_uint = 0x10;
pub const WPCM450_NUM_BANKS: c_int = 8;
pub const WPCM450_NUM_GPIOS: c_int = 128;
pub const WPCM450_NUM_GPIO_IRQS: c_int = 4;
    struct wpcm450_pinctrl;
    struct wpcm450_bank;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wpcm450_gpio {
    pub chip: gpio_generic_chip,
    pub pctrl: *mut wpcm450_pinctrl,
    pub bank: *const wpcm450_bank,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct wpcm450_pinctrl {
    pub pctldev: *mut pinctrl_dev,
    pub dev: *mut device,
    pub domain: *mut irq_domain,
    pub gcr_regmap: *mut regmap,
    pub gpio_base: *mut void __iomem,
    pub gpio_bank: [wpcm450_gpio; WPCM450_NUM_BANKS],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wpcm450_bank {
// Range of GPIOs in this port
    pub base: u8,
    pub length: u8,
// Register offsets (0 = register doesn't exist in this port)
    pub cfg2: u8 cfg0, cfg1,,
    pub blink: u8,
    pub datain: u8 dataout,,
// Interrupt bit mapping
    pub /: *mut *mut u8 first_irq_bit; / First bit in GPEVST that belongs to this bank,
    pub /: *mut *mut u8 num_irqs; / Number of IRQ-capable GPIOs in this bank,
    pub /: *mut *mut u8 first_irq_gpio; / First IRQ-capable GPIO in this bank,
}
...
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_irq_bitnum(gpio: *mut wpcm450_gpio, d: *mut irq_data) -> c_int {
    static int wpcm450_gpio_irq_bitnum(struct wpcm450_gpio *gpio, struct irq_data *d)
    {
    const struct wpcm450_bank *bank = gpio.bank;
    let mut hwirq: c_int = irqd_to_hwirq(d);
...
#[no_mangle]
unsafe extern "C" fn wpcm450_irq_bitnum_to_gpio(gpio: *mut wpcm450_gpio, bitnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_irq_unmask(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_get(gpio: *mut wpcm450_gpio, offset: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_fix_evpol(gpio: *mut wpcm450_gpio, all: c_ulong) {
    static void wpcm450_gpio_fix_evpol(struct wpcm450_gpio *gpio, unsigned long all)
    {
    struct wpcm450_pinctrl *pctrl = gpio.pctrl;
    unsigned int bit;
    for_each_set_bit(bit, &all, 32) {
    let mut offset: c_int = wpcm450_irq_bitnum_to_gpio(gpio, bit);
    unsigned long evpol;
    unsigned long flags;
    int level;
    do {
...
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_set_irq_type(d: *mut irq_data, flow_type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_irqhandler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn wpcm450_update_mfsel(gcr_regmap: *mut regmap, reg: c_int, bit: c_int, fn: c_int, fn_selected: c_int) {
    static void wpcm450_update_mfsel(struct regmap *gcr_regmap, int reg, int bit, int fn, int fn_selected)
    {
    let mut value: bool = (fn == fn_selected);
    if (bit & INV) {
    value = !value;
    bit &= ~INV;
    }
...
#[no_mangle]
unsafe extern "C" fn wpcm450_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wpcm450_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debounce_bitnum(gpio: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wpcm450_gpio_add_pin_ranges(chip: *mut gpio_chip) -> c_int {
    ...
    void __iomem *dat = core::ptr::null_mut();
    void __iomem *set = core::ptr::null_mut();
    void __iomem *dirout = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn wpcm450_pinctrl_probe(pdev: *mut platform_device) -> c_int {
