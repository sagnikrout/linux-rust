...
//! Source: drivers/pinctrl/nuvoton/pinctrl-npcm8xx.c
#![no_std]
...
// GCR registers
pub const NPCM8XX_GCR_SRCNT: c_uint = 0x068;
pub const NPCM8XX_GCR_FLOCKR1: c_uint = 0x074;
pub const NPCM8XX_GCR_DSCNT: c_uint = 0x078;
pub const NPCM8XX_GCR_INTCR4: c_uint = 0x0c0;
pub const NPCM8XX_GCR_I2CSEGSEL: c_uint = 0x0e0;
pub const NPCM8XX_GCR_MFSEL1: c_uint = 0x260;
pub const NPCM8XX_GCR_MFSEL2: c_uint = 0x264;
pub const NPCM8XX_GCR_MFSEL3: c_uint = 0x268;
pub const NPCM8XX_GCR_MFSEL4: c_uint = 0x26c;
pub const NPCM8XX_GCR_MFSEL5: c_uint = 0x270;
pub const NPCM8XX_GCR_MFSEL6: c_uint = 0x274;
pub const NPCM8XX_GCR_MFSEL7: c_uint = 0x278;

// GPIO registers
pub const NPCM8XX_GP_N_TLOCK1: c_uint = 0x00;
pub const NPCM8XX_GP_N_DIN: c_uint = 0x04;
pub const NPCM8XX_GP_N_POL: c_uint = 0x08;
pub const NPCM8XX_GP_N_DOUT: c_uint = 0x0c;
pub const NPCM8XX_GP_N_OE: c_uint = 0x10;
pub const NPCM8XX_GP_N_OTYP: c_uint = 0x14;
pub const NPCM8XX_GP_N_MP: c_uint = 0x18;
pub const NPCM8XX_GP_N_PU: c_uint = 0x1c;
pub const NPCM8XX_GP_N_PD: c_uint = 0x20;
pub const NPCM8XX_GP_N_DBNC: c_uint = 0x24;
pub const NPCM8XX_GP_N_EVTYP: c_uint = 0x28;
pub const NPCM8XX_GP_N_EVBE: c_uint = 0x2c;
pub const NPCM8XX_GP_N_OBL0: c_uint = 0x30;
pub const NPCM8XX_GP_N_OBL1: c_uint = 0x34;
pub const NPCM8XX_GP_N_OBL2: c_uint = 0x38;
pub const NPCM8XX_GP_N_OBL3: c_uint = 0x3c;
pub const NPCM8XX_GP_N_EVEN: c_uint = 0x40;
pub const NPCM8XX_GP_N_EVENS: c_uint = 0x44;
pub const NPCM8XX_GP_N_EVENC: c_uint = 0x48;
pub const NPCM8XX_GP_N_EVST: c_uint = 0x4c;
pub const NPCM8XX_GP_N_SPLCK: c_uint = 0x50;
pub const NPCM8XX_GP_N_MPLCK: c_uint = 0x54;
pub const NPCM8XX_GP_N_IEM: c_uint = 0x58;
pub const NPCM8XX_GP_N_OSRC: c_uint = 0x5c;
pub const NPCM8XX_GP_N_ODSC: c_uint = 0x60;
pub const NPCM8XX_GP_N_DOS: c_uint = 0x68;
pub const NPCM8XX_GP_N_DOC: c_uint = 0x6c;
pub const NPCM8XX_GP_N_OES: c_uint = 0x70;
pub const NPCM8XX_GP_N_OEC: c_uint = 0x74;
pub const NPCM8XX_GP_N_DBNCS0: c_uint = 0x80;
pub const NPCM8XX_GP_N_DBNCS1: c_uint = 0x84;
pub const NPCM8XX_GP_N_DBNCP0: c_uint = 0x88;
pub const NPCM8XX_GP_N_DBNCP1: c_uint = 0x8c;
pub const NPCM8XX_GP_N_DBNCP2: c_uint = 0x90;
pub const NPCM8XX_GP_N_DBNCP3: c_uint = 0x94;
pub const NPCM8XX_GP_N_TLOCK2: c_uint = 0xac;
pub const NPCM8XX_GPIO_PER_BANK: c_int = 32;
pub const NPCM8XX_GPIO_BANK_NUM: c_int = 8;
pub const NPCM8XX_GCR_NONE: c_int = 0;

pub const NPCM8XX_GCR_DSCNT_RG2DS_SHIFT: c_int = 6;

pub const NPCM8XX_DEBOUNCE_MAX: c_int = 4;
pub const NPCM8XX_DEBOUNCE_NSEC: c_int = 40;

pub const NPCM8XX_DEBOUNCE_MAX_VAL: c_uint = 0xFFFFF7;
// Structure for register banks
#[repr(C)]
#[derive(Copy, Clone)]
pub struct debounce_time {
    pub set_val: [bool; NPCM8XX_DEBOUNCE_MAX],
    pub nanosec_val: [u32; NPCM8XX_DEBOUNCE_MAX],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm8xx_gpio {
    pub chip: gpio_generic_chip,
    pub base: *mut void __iomem,
    pub debounce: debounce_time,
    pub irqbase: c_int,
    pub irq: c_int,
    pub irq_chip: irq_chip,
    pub pinctrl_id: u32,
    pub offset): *mut *mut *mut int (direction_input)(struct gpio_chip chip, unsigned int,
    int (*direction_output)(struct gpio_chip *chip, unsigned int offset,
    pub value): c_int,
    pub offset): *mut *mut *mut int (request)(struct gpio_chip chip, unsigned int,
    pub offset): *mut *mut *mut void (free)(struct gpio_chip chip, unsigned int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm8xx_pinctrl {
    pub pctldev: *mut pinctrl_dev,
    pub dev: *mut device,
    pub gpio_bank: [npcm8xx_gpio; NPCM8XX_GPIO_BANK_NUM],
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_direction_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_gpio_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_set_irq_type(d: *mut irq_data, type: c_uint) -> c_int {
    static int npcmgpio_set_irq_type(struct irq_data *d, unsigned int type)
    {
    struct npcm8xx_gpio *bank =
    gpiochip_get_data(irq_data_get_irq_chip_data(d));
    let mut gpio: c_uint = BIT(irqd_to_hwirq(d));
    switch (type) {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_irq_ack(d: *mut irq_data) {
    static void npcmgpio_irq_ack(struct irq_data *d)
    {
    struct npcm8xx_gpio *bank =
    gpiochip_get_data(irq_data_get_irq_chip_data(d));
    let mut gpio: c_uint = irqd_to_hwirq(d);
    iowrite32(BIT(gpio), bank.base + NPCM8XX_GP_N_EVST);
    }
#[no_mangle]
unsafe extern "C" fn npcmgpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_irq_startup(d: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_irq_request_resources(d: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_irq_release_resources(d: *mut irq_data) {
...
pub const DRIVE_STRENGTH_LO_SHIFT: c_int = 8;
pub const DRIVE_STRENGTH_HI_SHIFT: c_int = 12;

    ((hi) << DRIVE_STRENGTH_HI_SHIFT))

#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm8xx_pincfg {
    pub flag: c_int,
    pub bit0: int fn0, reg0,,
    pub bit1: int fn1, reg1,,
    pub bit2: int fn2, reg2,,
    pub bit3: int fn3, reg3,,
    pub bit4: int fn4, reg4,,
}
...
#[no_mangle]
unsafe extern "C" fn npcm8xx_rmii_output_enable_mask(pin: c_uint) -> u32 {
...
// Enable mode in pin group
    ...
    {
    let mut gpio: c_int = pin % bank.chip.gc.ngpio;
    let mut pinmask: c_ulong = BIT(gpio);
    u32 val;
...
// LPC Slew rate in SRCNT register
    ...
    let mut gpio: c_int = BIT(pin % bank.chip.gc.ngpio);
    if (pincfg[pin].flag & SLEW) {
    switch (arg) {
    case 0:
...
#[no_mangle]
unsafe extern "C" fn npcm8xx_get_rg2_drive_strength(npcm: *mut npcm8xx_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm8xx_set_rg2_drive_strength(npcm: *mut npcm8xx_pinctrl, nval: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(nval: DSHI(v) ==) -> else {
    else if (DSHI(v) == nval)
...
// pinctrl_ops
#[no_mangle]
unsafe extern "C" fn npcm8xx_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm8xx_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// groups	 = npcm8xx_funcs[function].groups;
    ...
    let mut gpio: c_int = BIT(offset % bank.chip.gc.ngpio);
    if (input)
    ...
    (gpio / 16) * 4;
    let mut gpio_debounce: c_int = (gpio % 16) * 2, debounce_select, i;
...
pub unsafe extern "C" fn if(PIN_CONFIG_BIAS_PULL_DOWN: param ==) -> else {
    ...
    rc = (ie && !oe);
#[no_mangle]
pub unsafe extern "C" fn if(PIN_CONFIG_LEVEL: param ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn npcmgpio_add_pin_ranges(chip: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm8xx_gpio_fw(pctrl: *mut npcm8xx_pinctrl) -> c_int {
    ...
    ret = fwnode_property_get_reference_args(child, "gpio-ranges", core::ptr::null_mut(), 3, 0, &args);
    if (ret < 0)
    ...
    if (pctrl.gpio_bank[id].chip.gc.label == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn npcm8xx_gpio_register(pctrl: *mut npcm8xx_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm8xx_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm8xx_pinctrl_register() -> int __init {
