...
//! Source: drivers/pinctrl/pinctrl-apple-gpio.c
#![no_std]
...
pub const REG_GPIOx_OUT: c_int = 1;
pub const REG_GPIOx_IN_IRQ_HI: c_int = 2;
pub const REG_GPIOx_IN_IRQ_LO: c_int = 3;
pub const REG_GPIOx_IN_IRQ_UP: c_int = 4;
pub const REG_GPIOx_IN_IRQ_DN: c_int = 5;
pub const REG_GPIOx_IN_IRQ_ANY: c_int = 6;
pub const REG_GPIOx_IN_IRQ_OFF: c_int = 7;

pub const REG_GPIOx_PULL_OFF: c_int = 0;
pub const REG_GPIOx_PULL_DOWN: c_int = 1;
pub const REG_GPIOx_PULL_UP_STRONG: c_int = 2;
pub const REG_GPIOx_PULL_UP: c_int = 3;
...
// GPIO chip functions
#[no_mangle]
unsafe extern "C" fn apple_gpio_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    static int apple_gpio_get_direction(struct gpio_chip *chip, unsigned int offset)
    {
    struct apple_gpio_pinctrl *pctl = gpiochip_get_data(chip);
    let mut reg: c_uint = apple_gpio_get_reg(pctl, offset);
    if (FIELD_GET(REG_GPIOx_MODE, reg) == REG_GPIOx_OUT)
    return GPIO_LINE_DIRECTION_OUT;
    return GPIO_LINE_DIRECTION_IN;
    }
#[no_mangle]
unsafe extern "C" fn apple_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_gpio_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_gpio_direction_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
// IRQ chip functions
#[no_mangle]
unsafe extern "C" fn apple_gpio_irq_ack(data: *mut irq_data) {
    ...
    let mut irqgrp: c_uint = FIELD_GET(REG_GPIOx_GRP, apple_gpio_get_reg(pctl, data.hwirq));
    writel(BIT(data.hwirq % 32), pctl.base + REG_IRQ(irqgrp, data.hwirq));
    }
#[no_mangle]
unsafe extern "C" fn apple_gpio_irq_type(type: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn apple_gpio_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn apple_gpio_irq_unmask(data: *mut irq_data) {
    static void apple_gpio_irq_unmask(struct irq_data *data)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(data);
    struct apple_gpio_pinctrl *pctl = gpiochip_get_data(gc);
    let mut irqtype: c_uint = apple_gpio_irq_type(irqd_get_trigger_type(data));
    gpiochip_enable_irq(gc, data.hwirq);
    apple_gpio_set_reg(pctl, data.hwirq, REG_GPIOx_MODE,
    FIELD_PREP(REG_GPIOx_MODE, irqtype));
    }
#[no_mangle]
unsafe extern "C" fn apple_gpio_irq_startup(data: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn apple_gpio_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
    static int apple_gpio_irq_set_type(struct irq_data *data, unsigned int type)
    {
    struct apple_gpio_pinctrl *pctl = gpiochip_get_data(irq_data_get_irq_chip_data(data));
    let mut irqtype: c_uint = apple_gpio_irq_type(type);
...
#[no_mangle]
unsafe extern "C" fn apple_gpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn apple_gpio_pinctrl_probe(pdev: *mut platform_device) -> c_int {
