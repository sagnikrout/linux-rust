...
//! Source: drivers/pinctrl/pinctrl-loongson2.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson2_pmx_group {
    pub grp: pingroup,
    pub reg: c_uint,
    pub bit: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn loongson2_get_groups_count(pcdev: *mut pinctrl_dev) -> c_int {
...
// num_pins = loongson2_pmx_groups[selector].grp.npins;
    ...
    let mut mux_bit: c_uint = loongson2_pmx_groups[group_num].bit;
    unsigned int val;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn loongson2_pmx_get_funcs_count(pcdev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson2_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson2_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn loongson2_pinctrl_exit() -> void __exit {
