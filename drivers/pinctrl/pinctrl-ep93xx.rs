...
//! Source: drivers/pinctrl/pinctrl-ep93xx.c
#![no_std]
...
pub const PADS_MAXBIT: c_int = 30;
// Ordered by bit index
    ...
    "GonIDE",
    "HonIDE",
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    "A1onG",
    "A2onG",
...
#[no_mangle]
unsafe extern "C" fn ep93xx_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// Print changed states
    ...
    let mut enabled: bool = expected & BIT(i);
    dev_err(pmx.dev,
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pmx_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
