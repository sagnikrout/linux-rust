...
//! Source: drivers/pinctrl/pinctrl-scmi.c
#![no_std]
...
pub const SCMI_NUM_CONFIGS: c_int = 4;
    static const struct scmi_pinctrl_proto_ops *pinctrl_ops;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_pinctrl {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn pinctrl_scmi_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pinctrl_scmi_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pinctrl_scmi_free(pctldev: *mut pinctrl_dev, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_pinctrl_probe(sdev: *mut scmi_device) -> c_int {
