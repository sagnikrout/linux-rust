...
//! Source: drivers/pinctrl/pinctrl-artpec6.c
#![no_std]
...
pub const ARTPEC6_PINMUX_UDC0_MASK: c_uint = 0x00000001;
pub const ARTPEC6_PINMUX_UDC0_SHIFT: c_int = 0;
pub const ARTPEC6_PINMUX_UDC1_MASK: c_uint = 0x00000002;
pub const ARTPEC6_PINMUX_UDC1_SHIFT: c_int = 1;
pub const ARTPEC6_PINMUX_DRV_MASK: c_uint = 0x00000060;
pub const ARTPEC6_PINMUX_DRV_SHIFT: c_int = 5;
pub const ARTPEC6_PINMUX_SEL_MASK: c_uint = 0x00003000;
pub const ARTPEC6_PINMUX_SEL_SHIFT: c_int = 12;
// Pinmux configurations
pub const ARTPEC6_CONFIG_0: c_int = 0;
pub const ARTPEC6_CONFIG_1: c_int = 1;
pub const ARTPEC6_CONFIG_2: c_int = 2;
pub const ARTPEC6_CONFIG_3: c_int = 3;
// Pin drive strength options
pub const ARTPEC6_DRIVE_4mA: c_int = 4;
pub const ARTPEC6_DRIVE_4mA_SET: c_int = 0;
pub const ARTPEC6_DRIVE_6mA: c_int = 6;
pub const ARTPEC6_DRIVE_6mA_SET: c_int = 1;
pub const ARTPEC6_DRIVE_8mA: c_int = 8;
pub const ARTPEC6_DRIVE_8mA_SET: c_int = 2;
pub const ARTPEC6_DRIVE_9mA: c_int = 9;
pub const ARTPEC6_DRIVE_9mA_SET: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct artpec6_pmx {
    pub dev: *mut device,
    pub pctl: *mut pinctrl_dev,
    pub base: *mut void __iomem,
    pub pins: *mut pinctrl_pin_desc,
    pub num_pins: c_uint,
    pub pin_groups: *const artpec6_pin_group,
    pub num_pin_groups: c_uint,
    pub functions: *const artpec6_pmx_func,
    pub num_functions: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct artpec6_pin_group {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pmx_reg_offset(pin: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn artpec6_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pconf_drive_mA_to_field(mA: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pconf_drive_field_to_mA(field: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pmx_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// GPIO is always config 0
    ...
    {
    struct artpec6_pmx *pmx = pinctrl_dev_get_drvdata(pctldev);
    let mut reg: c_uint = artpec6_pmx_reg_offset(pin);
    u32 val;
    if (pin >= 32)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn artpec6_pmx_reset(pmx: *mut artpec6_pmx) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pmx_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pmx_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pmx_init() -> int __init {
