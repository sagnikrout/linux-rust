...
//! Source: drivers/pinctrl/pinctrl-pef2256.c
#![no_std]
...
pub const PEF2256_PC1: c_uint = 0x80;
pub const PEF2256_PC2: c_uint = 0x81;
pub const PEF2256_PC3: c_uint = 0x82;
pub const PEF2256_PC4: c_uint = 0x83;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pef2256_pinreg_desc {
    pub offset: c_int,
    pub mask: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pef2256_function_desc {
    pub name: *const c_char,
    pub const*groups: *const *const c_char,
    pub ngroups: c_uint,
    pub func_val: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pef2256_pinctrl {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub version: enum pef2256_version,
    pub pctrl_desc: pinctrl_desc,
    pub functions: *const pef2256_function_desc,
    pub nfunctions: c_uint,
}

#[no_mangle]
unsafe extern "C" fn pef2256_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pef2256_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pef2256_register_pinctrl(pef2256: *mut pef2256_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pef2256_reset_pinmux(pef2256: *mut pef2256_pinctrl) {
...
#[no_mangle]
unsafe extern "C" fn pef2256_pinctrl_probe(pdev: *mut platform_device) -> c_int {
