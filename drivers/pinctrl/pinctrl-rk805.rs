...
//! Source: drivers/pinctrl/pinctrl-rk805.c
#![no_std]
...
// generic gpio chip
#[no_mangle]
unsafe extern "C" fn rk805_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk805_gpio_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
// generic pinctrl
#[no_mangle]
unsafe extern "C" fn rk805_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk805_pinctrl_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = pci->functions[function].ngroups;
    ...
    {
    struct rk805_pctrl_info *pci = pinctrl_dev_get_drvdata(pctldev);
    let mut mux: c_int = pci.functions[function].mux_option;
    let mut offset: c_int = group;
...
// config = pinconf_to_config_packed(param, (u16)arg);
    ...
    rk805_pmx_gpio_set_direction(pctldev, core::ptr::null_mut(), pin, false);
    break;
    case PIN_CONFIG_INPUT_ENABLE:
    if (pci.rk808.variant != RK805_ID && arg) {
    rk805_pmx_gpio_set_direction(pctldev, core::ptr::null_mut(), pin, true);
    break;
    }
    fallthrough;
    default:
...
#[no_mangle]
unsafe extern "C" fn rk805_pinctrl_probe(pdev: *mut platform_device) -> c_int {
