...
//! Source: drivers/pinctrl/sophgo/pinctrl-sg2044.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sg2044_get_pull_up(sp: *const sophgo_pin, psmap: *const u32) -> c_int {
    static int sg2044_get_pull_up(const struct sophgo_pin *sp, const u32 *psmap)
    {
    return 19500;
    }
#[no_mangle]
unsafe extern "C" fn sg2044_get_pull_down(sp: *const sophgo_pin, psmap: *const u32) -> c_int {
