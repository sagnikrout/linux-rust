...
//! Source: drivers/pinctrl/sophgo/pinctrl-cv1800b.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cv1800b_get_pull_up(sp: *const sophgo_pin, psmap: *const u32) -> c_int {
    ...
    let mut pstate: u32 = psmap[pin.power_domain];
    let mut type: enum cv1800_pin_io_type = cv1800_pin_io_type(pin);
...
#[no_mangle]
unsafe extern "C" fn cv1800b_get_pull_down(sp: *const sophgo_pin, psmap: *const u32) -> c_int {
