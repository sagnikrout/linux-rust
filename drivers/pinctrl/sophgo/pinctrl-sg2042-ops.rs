...
//! Source: drivers/pinctrl/sophgo/pinctrl-sg2042-ops.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2042_priv {
    pub regs: *mut void __iomem,
}

#[no_mangle]
unsafe extern "C" fn sg2042_dt_get_pin_mux(value: u32) -> u8 {
    ...
    {
    let mut mux: u32 = sg2042_dt_get_pin_mux(config);
    ...
    arg = sophgo_pinctrl_typical_pull_down(pctrl, sp, core::ptr::null_mut());
    break;
    ...
    arg = sophgo_pinctrl_typical_pull_up(pctrl, sp, core::ptr::null_mut());
    break;
    case PIN_CONFIG_DRIVE_STRENGTH_UA:
    enabled = FIELD_GET(PIN_IO_OUTPUT_ENABLE, value) != 0;
    arg = FIELD_GET(PIN_IO_DRIVE, value);
    ret = sophgo_pinctrl_reg2oc(pctrl, sp, core::ptr::null_mut(), arg);
    if (ret < 0)
    return ret;
    arg = ret;
    break;
...
// config = pinconf_to_config_packed(param, arg);
    ...
    if (arg != 0) {
    ret = sophgo_pinctrl_oc2reg(pctrl, sp, core::ptr::null_mut(), arg);
    if (ret < 0)
    return ret;
