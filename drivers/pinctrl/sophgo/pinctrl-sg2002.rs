...
//! Source: drivers/pinctrl/sophgo/pinctrl-sg2002.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sg2002_get_pull_up(sp: *const sophgo_pin, psmap: *const u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sg2002_get_pull_down(sp: *const sophgo_pin, psmap: *const u32) -> c_int {
