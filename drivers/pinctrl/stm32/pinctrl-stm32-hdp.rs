...
//! Source: drivers/pinctrl/stm32/pinctrl-stm32-hdp.c
#![no_std]
...
pub const HDP_CTRL_ENABLE: c_int = 1;
pub const HDP_CTRL_DISABLE: c_int = 0;
pub const HDP_CTRL: c_uint = 0x000;
pub const HDP_MUX: c_uint = 0x004;
pub const HDP_VAL: c_uint = 0x010;
pub const HDP_GPOSET: c_uint = 0x014;
pub const HDP_GPOCLR: c_uint = 0x018;
pub const HDP_GPOVAL: c_uint = 0x01c;
pub const HDP_VERR: c_uint = 0x3f4;
pub const HDP_IPIDR: c_uint = 0x3f8;
pub const HDP_SIDR: c_uint = 0x3fc;

pub const HDP_PIN: c_int = 8;
pub const HDP_FUNC: c_int = 16;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_hdp {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub pctl_dev: *mut pinctrl_dev,
    pub firewall: *mut stm32_firewall,
    pub gpio_chip: gpio_generic_chip,
    pub mux_conf: u32,
    pub gposet_conf: u32,
    pub nb_firewall_entries: c_int,
    pub func_name: *const *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn stm32_hdp_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
    static int stm32_hdp_gpio_get_direction(struct gpio_chip *gc, unsigned int offset)
    {
    return GPIO_LINE_DIRECTION_OUT;
    }
#[no_mangle]
unsafe extern "C" fn stm32_hdp_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hdp_pinmux_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
    ...
    {
    let mut index: u32 = selector / HDP_FUNC;
...
// num_groups = 1;
    ...
    {
    struct stm32_hdp *hdp = pinctrl_dev_get_drvdata(pctldev);
    let mut pin: c_uint = stm32_hdp_pins[group_selector].number;
    u32 mux;
    ...
    .gpio_set_direction  = core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn stm32_hdp_probe(pdev: *mut platform_device) -> c_int {
    ...
    hdp.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(hdp.clk))
...
#[no_mangle]
unsafe extern "C" fn stm32_hdp_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_hdp_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hdp_resume(dev: *mut device) -> c_int {
