...
//! Source: drivers/pinctrl/visconti/pinctrl-tmpv7700.c
#![no_std]
...
pub const tmpv7700_MAGIC_NUM: c_uint = 0x4932f70e;
// register offset
pub const REG_KEY_CTRL: c_uint = 0x0000;
pub const REG_KEY_CMD: c_uint = 0x0004;
pub const REG_PINMUX1: c_uint = 0x3000;
pub const REG_PINMUX2: c_uint = 0x3004;
pub const REG_PINMUX3: c_uint = 0x3008;
pub const REG_PINMUX4: c_uint = 0x300c;
pub const REG_PINMUX5: c_uint = 0x3010;
pub const REG_IOSET: c_uint = 0x3014;
pub const REG_IO_VSEL: c_uint = 0x3018;
pub const REG_IO_DSEL1: c_uint = 0x301c;
pub const REG_IO_DSEL2: c_uint = 0x3020;
pub const REG_IO_DSEL3: c_uint = 0x3024;
pub const REG_IO_DSEL4: c_uint = 0x3028;
pub const REG_IO_DSEL5: c_uint = 0x302c;
pub const REG_IO_DSEL6: c_uint = 0x3030;
pub const REG_IO_DSEL7: c_uint = 0x3034;
pub const REG_IO_DSEL8: c_uint = 0x3038;
pub const REG_IO_PUDE1: c_uint = 0x303c;
pub const REG_IO_PUDE2: c_uint = 0x3040;
pub const REG_IO_PUDSEL1: c_uint = 0x3044;
pub const REG_IO_PUDSEL2: c_uint = 0x3048;
// PIN
...
#[no_mangle]
unsafe extern "C" fn tmpv7700_pinctrl_unlock(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn tmpv7700_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmpv7700_pinctrl_init() -> int __init {
