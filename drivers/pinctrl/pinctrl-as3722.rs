...
//! Source: drivers/pinctrl/pinctrl-as3722.c
#![no_std]
...
pub const AS3722_PIN_GPIO0: c_int = 0;
pub const AS3722_PIN_GPIO1: c_int = 1;
pub const AS3722_PIN_GPIO2: c_int = 2;
pub const AS3722_PIN_GPIO3: c_int = 3;
pub const AS3722_PIN_GPIO4: c_int = 4;
pub const AS3722_PIN_GPIO5: c_int = 5;
pub const AS3722_PIN_GPIO6: c_int = 6;
pub const AS3722_PIN_GPIO7: c_int = 7;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3722_pin_function {
    pub name: *const c_char,
    pub groups: *const *const c_char,
    pub ngroups: unsigned,
    pub mux_option: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3722_gpio_pin_control {
    pub mode_prop: unsigned,
    pub io_function: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3722_pingroup {
    pub name: *const c_char,
    pub pins: [unsigned; 1],
    pub npins: unsigned,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3722_pctrl_info {
    pub dev: *mut device,
    pub pctl: *mut pinctrl_dev,
    pub as3722: *mut as3722,
    pub gpio_chip: gpio_chip,
    pub pins_current_opt: [c_int; AS3722_PIN_NUM],
    pub functions: *const as3722_pin_function,
    pub num_functions: unsigned,
    pub pin_groups: *const as3722_pingroup,
    pub num_pin_groups: c_int,
    pub pins: *const pinctrl_pin_desc,
    pub num_pins: unsigned,
    pub gpio_control: [as3722_gpio_pin_control; AS3722_PIN_NUM],
}
...
#[no_mangle]
unsafe extern "C" fn as3722_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_pinctrl_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = as_pci->functions[function].ngroups;
    ...
    {
    struct as3722_pctrl_info *as_pci = pinctrl_dev_get_drvdata(pctldev);
    let mut gpio_cntr_reg: c_int = AS3722_GPIOn_CONTROL_REG(group);
    let mut val: u8 = AS3722_GPIO_IOSF_VAL(as_pci.functions[function].mux_option);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn as3722_pinctrl_gpio_get_mode(gpio_mode_prop: unsigned, input: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(AS3722_GPIO_MODE_PULL_DOWN: gpio_mode_prop &) -> else {
...
#[no_mangle]
unsafe extern "C" fn as3722_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_gpio_to_irq(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_pinctrl_probe(pdev: *mut platform_device) -> c_int {
