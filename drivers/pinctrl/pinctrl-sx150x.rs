...
//! Source: drivers/pinctrl/pinctrl-sx150x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sx150x_123_pri {
    pub reg_pld_mode: u8,
    pub reg_pld_table0: u8,
    pub reg_pld_table1: u8,
    pub reg_pld_table2: u8,
    pub reg_pld_table3: u8,
    pub reg_pld_table4: u8,
    pub reg_advanced: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sx150x_456_pri {
    pub reg_pld_mode: u8,
    pub reg_pld_table0: u8,
    pub reg_pld_table1: u8,
    pub reg_pld_table2: u8,
...
pub struct sx150x_device_data {
    ...
    pub ngpios: u8,
    union {
    pub x123: sx150x_123_pri,
    pub x456: sx150x_456_pri,
    pub x789: sx150x_789_pri,
    pub pri: },
...
pub struct sx150x_pinctrl {
    ...
    pub irq: },
    pub lock: mutex,
    pub data: *const sx150x_device_data,
}
...
#[no_mangle]
unsafe extern "C" fn sx150x_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx150x_pin_is_oscio(pctl: *mut sx150x_pinctrl, pin: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sx150x_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx150x_irq_mask(d: *mut irq_data) {
    static void sx150x_irq_mask(struct irq_data *d)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
    struct sx150x_pinctrl *pctl = gpiochip_get_data(gc);
    let mut n: c_uint = irqd_to_hwirq(d);
    pctl.irq.masked |= BIT(n);
    gpiochip_disable_irq(gc, n);
    }
#[no_mangle]
unsafe extern "C" fn sx150x_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sx150x_irq_set_type(d: *mut irq_data, flow_type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx150x_irq_thread_fn(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sx150x_irq_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sx150x_irq_bus_sync_unlock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn sx150x_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
    ...
    arg = 1;
#[no_mangle]
pub unsafe extern "C" fn if(0x10: (data & 0x1f) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sx150x_reset(pctl: *mut sx150x_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx150x_init_misc(pctl: *mut sx150x_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sx150x_init_hw(pctl: *mut sx150x_pinctrl) -> c_int {
...
//
    ...
    let mut width: c_int = sx150x_regmap_reg_width(pctl, reg);
...
#[no_mangle]
unsafe extern "C" fn sx150x_reg_volatile(dev: *mut device, reg: c_uint) -> bool {
    ...
    let mut reg: return = = pctl.data.reg_irq_src || reg == pctl.data.reg_data;
    }
...
#[no_mangle]
unsafe extern "C" fn sx150x_probe(client: *mut i2c_client) -> c_int {
    ...
    if (!pctl.data)
    return -EINVAL;
    pctl.regmap = devm_regmap_init(dev, core::ptr::null_mut(), pctl,
...
#[no_mangle]
unsafe extern "C" fn sx150x_init() -> int __init {
