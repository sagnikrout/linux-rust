...
//! Source: drivers/pinctrl/intel/pinctrl-lewisburg.c
#![no_std]
...
pub const LBG_PAD_OWN: c_uint = 0x020;
pub const LBG_PADCFGLOCK: c_uint = 0x060;
pub const LBG_HOSTSW_OWN: c_uint = 0x080;
pub const LBG_GPI_IS: c_uint = 0x100;
pub const LBG_GPI_IE: c_uint = 0x110;
