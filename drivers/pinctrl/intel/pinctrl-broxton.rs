...
//! Source: drivers/pinctrl/intel/pinctrl-broxton.c
#![no_std]
...
pub const BXT_PAD_OWN: c_uint = 0x020;
pub const BXT_PADCFGLOCK: c_uint = 0x060;
pub const BXT_HOSTSW_OWN: c_uint = 0x080;
pub const BXT_GPI_IS: c_uint = 0x100;
pub const BXT_GPI_IE: c_uint = 0x110;
...
#[no_mangle]
unsafe extern "C" fn bxt_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bxt_pinctrl_exit() -> void __exit {
