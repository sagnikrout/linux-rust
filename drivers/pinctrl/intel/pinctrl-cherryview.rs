...
//! Source: drivers/pinctrl/intel/pinctrl-cherryview.c
#![no_std]
...
pub const CHV_INTSTAT: c_uint = 0x300;
pub const CHV_INTMASK: c_uint = 0x380;
pub const FAMILY_PAD_REGS_OFF: c_uint = 0x4400;
pub const FAMILY_PAD_REGS_SIZE: c_uint = 0x400;
pub const MAX_FAMILY_PAD_GPIO_NO: c_int = 15;
pub const GPIO_REGS_SIZE: c_int = 8;
pub const CHV_PADCTRL0: c_uint = 0x000;
pub const CHV_PADCTRL0_INTSEL_SHIFT: c_int = 28;

pub const CHV_PADCTRL0_TERM_SHIFT: c_int = 20;

pub const CHV_PADCTRL0_TERM_20K: c_int = 1;
pub const CHV_PADCTRL0_TERM_5K: c_int = 2;
pub const CHV_PADCTRL0_TERM_1K: c_int = 4;
pub const CHV_PADCTRL0_PMODE_SHIFT: c_int = 16;

pub const CHV_PADCTRL0_GPIOCFG_SHIFT: c_int = 8;

pub const CHV_PADCTRL0_GPIOCFG_GPIO: c_int = 0;
pub const CHV_PADCTRL0_GPIOCFG_GPO: c_int = 1;
pub const CHV_PADCTRL0_GPIOCFG_GPI: c_int = 2;
pub const CHV_PADCTRL0_GPIOCFG_HIZ: c_int = 3;

pub const CHV_PADCTRL1: c_uint = 0x004;

pub const CHV_PADCTRL1_INVRXTX_SHIFT: c_int = 4;

pub const CHV_PADCTRL1_INTWAKECFG_FALLING: c_int = 1;
pub const CHV_PADCTRL1_INTWAKECFG_RISING: c_int = 2;
pub const CHV_PADCTRL1_INTWAKECFG_BOTH: c_int = 3;
pub const CHV_PADCTRL1_INTWAKECFG_LEVEL: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_pad_context {
    pub padctrl0: u32,
    pub padctrl1: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_community_context {
    pub intr_lines: [c_uint; 16],
    pub saved_intmask: u32,
}
...
#[no_mangle]
unsafe extern "C" fn chv_pctrl_readl(pctrl: *mut intel_pinctrl, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn chv_pctrl_writel(pctrl: *mut intel_pinctrl, offset: c_uint, value: u32) {
...
// Write and simple read back to confirm the bus transferring done
    ...
    {
    const struct intel_community *community = &pctrl.communities[0];
    let mut family_no: c_uint = offset / MAX_FAMILY_PAD_GPIO_NO;
    let mut pad_no: c_uint = offset % MAX_FAMILY_PAD_GPIO_NO;
    offset = FAMILY_PAD_REGS_SIZE * family_no + GPIO_REGS_SIZE * pad_no;
    return community.pad_regs + offset + reg;
    }
#[no_mangle]
unsafe extern "C" fn chv_readl(pctrl: *mut intel_pinctrl, pin: c_uint, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn chv_writel(pctrl: *mut intel_pinctrl, pin: c_uint, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn chv_pad_is_locked(ctrl1: u32) -> bool {
    static bool chv_pad_is_locked(u32 ctrl1)
    {
    return ctrl1 & CHV_PADCTRL1_CFGLOCK;
    }
#[no_mangle]
unsafe extern "C" fn chv_pad_locked(pctrl: *mut intel_pinctrl, offset: c_uint) -> bool {
...
// Check first that the pad is not locked
    ...
    for (i = 0; i < grp.grp.npins; i++) {
    let mut pin: c_int = grp.grp.pins[i];
    unsigned int mode;
    bool invert_oe;
    u32 value;
...
// Update for invert_oe
    ...
    unsigned int offset)
    {
    let mut invrxtx_mask: u32 = CHV_PADCTRL1_INVRXTX_MASK;
    u32 value;
//
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_direction_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_irq_mask_unmask(gc: *mut gpio_chip, hwirq: irq_hw_number_t, mask: bool) {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_irq_startup(d: *mut irq_data) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_set_intr_line(pctrl: *mut intel_pinctrl, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_irq_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IRQ_TYPE_EDGE_RISING: type &) -> else {
    else if (type & IRQ_TYPE_EDGE_RISING)
    value |= CHV_PADCTRL1_INTWAKECFG_RISING;
#[no_mangle]
pub unsafe extern "C" fn if(IRQ_TYPE_EDGE_FALLING: type &) -> else {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_irq_init_hw(chip: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_gpio_probe(pctrl: *mut intel_pinctrl, irq: c_int) -> c_int {
    ...
    struct device *dev = pctrl.dev;
    let mut need_valid_mask: bool = !dmi_check_system(chv_no_valid_mask);
    int ret, i, irq_base;
// chip = chv_gpio_chip;
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_READ: function ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn chv_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_pinctrl_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn chv_pinctrl_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_pinctrl_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chv_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn chv_pinctrl_exit() -> void __exit {
