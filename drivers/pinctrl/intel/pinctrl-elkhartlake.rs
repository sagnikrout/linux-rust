...
//! Source: drivers/pinctrl/intel/pinctrl-elkhartlake.c
#![no_std]
...
pub const EHL_PAD_OWN: c_uint = 0x020;
pub const EHL_PADCFGLOCK: c_uint = 0x080;
pub const EHL_HOSTSW_OWN: c_uint = 0x0b0;
pub const EHL_GPI_IS: c_uint = 0x100;
pub const EHL_GPI_IE: c_uint = 0x120;
