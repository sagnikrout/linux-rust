...
//! Source: drivers/pinctrl/intel/pinctrl-cedarfork.c
#![no_std]
...
pub const CDF_PAD_OWN: c_uint = 0x020;
pub const CDF_PADCFGLOCK: c_uint = 0x0c0;
pub const CDF_HOSTSW_OWN: c_uint = 0x120;
pub const CDF_GPI_IS: c_uint = 0x200;
pub const CDF_GPI_IE: c_uint = 0x230;
...
#[no_mangle]
unsafe extern "C" fn cdf_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cdf_pinctrl_exit() -> void __exit {
