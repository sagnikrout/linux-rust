...
//! Source: drivers/pinctrl/intel/pinctrl-cannonlake.c
#![no_std]
...
pub const CNL_LP_PAD_OWN: c_uint = 0x020;
pub const CNL_LP_PADCFGLOCK: c_uint = 0x080;
pub const CNL_LP_HOSTSW_OWN: c_uint = 0x0b0;
pub const CNL_LP_GPI_IS: c_uint = 0x100;
pub const CNL_LP_GPI_IE: c_uint = 0x120;
pub const CNL_H_PAD_OWN: c_uint = 0x020;
pub const CNL_H_PADCFGLOCK: c_uint = 0x080;
pub const CNL_H_HOSTSW_OWN: c_uint = 0x0c0;
pub const CNL_H_GPI_IS: c_uint = 0x100;
pub const CNL_H_GPI_IE: c_uint = 0x120;
