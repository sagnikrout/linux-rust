...
//! Source: drivers/pinctrl/intel/pinctrl-geminilake.c
#![no_std]
...
pub const GLK_PAD_OWN: c_uint = 0x020;
pub const GLK_PADCFGLOCK: c_uint = 0x080;
pub const GLK_HOSTSW_OWN: c_uint = 0x0b0;
pub const GLK_GPI_IS: c_uint = 0x100;
pub const GLK_GPI_IE: c_uint = 0x110;
...
#[no_mangle]
unsafe extern "C" fn glk_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn glk_pinctrl_exit() -> void __exit {
