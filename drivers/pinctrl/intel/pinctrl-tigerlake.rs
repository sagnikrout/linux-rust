...
//! Source: drivers/pinctrl/intel/pinctrl-tigerlake.c
#![no_std]
...
pub const TGL_LP_PAD_OWN: c_uint = 0x020;
pub const TGL_LP_PADCFGLOCK: c_uint = 0x080;
pub const TGL_LP_HOSTSW_OWN: c_uint = 0x0b0;
pub const TGL_LP_GPI_IS: c_uint = 0x100;
pub const TGL_LP_GPI_IE: c_uint = 0x120;
pub const TGL_H_PAD_OWN: c_uint = 0x020;
pub const TGL_H_PADCFGLOCK: c_uint = 0x090;
pub const TGL_H_HOSTSW_OWN: c_uint = 0x0c0;
pub const TGL_H_GPI_IS: c_uint = 0x100;
pub const TGL_H_GPI_IE: c_uint = 0x120;
