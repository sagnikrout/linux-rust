...
//! Source: drivers/pinctrl/intel/pinctrl-lakefield.c
#![no_std]
...
pub const LKF_PAD_OWN: c_uint = 0x020;
pub const LKF_PADCFGLOCK: c_uint = 0x070;
pub const LKF_HOSTSW_OWN: c_uint = 0x090;
pub const LKF_GPI_IS: c_uint = 0x100;
pub const LKF_GPI_IE: c_uint = 0x110;
