...
//! Source: drivers/pinctrl/intel/pinctrl-jasperlake.c
#![no_std]
...
pub const JSL_PAD_OWN: c_uint = 0x020;
pub const JSL_PADCFGLOCK: c_uint = 0x080;
pub const JSL_HOSTSW_OWN: c_uint = 0x0c0;
pub const JSL_GPI_IS: c_uint = 0x100;
pub const JSL_GPI_IE: c_uint = 0x120;
