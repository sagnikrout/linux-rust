...
//! Source: drivers/pinctrl/intel/pinctrl-emmitsburg.c
#![no_std]
...
pub const EBG_PAD_OWN: c_uint = 0x0a0;
pub const EBG_PADCFGLOCK: c_uint = 0x100;
pub const EBG_HOSTSW_OWN: c_uint = 0x130;
pub const EBG_GPI_IS: c_uint = 0x200;
pub const EBG_GPI_IE: c_uint = 0x210;
