...
//! Source: drivers/pinctrl/intel/pinctrl-denverton.c
#![no_std]
...
pub const DNV_PAD_OWN: c_uint = 0x020;
pub const DNV_PADCFGLOCK: c_uint = 0x090;
pub const DNV_HOSTSW_OWN: c_uint = 0x0C0;
pub const DNV_GPI_IS: c_uint = 0x100;
pub const DNV_GPI_IE: c_uint = 0x120;
...
#[no_mangle]
unsafe extern "C" fn dnv_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dnv_pinctrl_exit() -> void __exit {
