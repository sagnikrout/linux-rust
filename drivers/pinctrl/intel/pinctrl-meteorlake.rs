...
//! Source: drivers/pinctrl/intel/pinctrl-meteorlake.c
#![no_std]
...
pub const MTL_P_PAD_OWN: c_uint = 0x0b0;
pub const MTL_P_PADCFGLOCK: c_uint = 0x110;
pub const MTL_P_HOSTSW_OWN: c_uint = 0x140;
pub const MTL_P_GPI_IS: c_uint = 0x200;
pub const MTL_P_GPI_IE: c_uint = 0x210;
pub const MTL_S_PAD_OWN: c_uint = 0x0b0;
pub const MTL_S_PADCFGLOCK: c_uint = 0x0f0;
pub const MTL_S_HOSTSW_OWN: c_uint = 0x110;
pub const MTL_S_GPI_IS: c_uint = 0x200;
pub const MTL_S_GPI_IE: c_uint = 0x210;
