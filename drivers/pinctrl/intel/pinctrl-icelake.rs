...
//! Source: drivers/pinctrl/intel/pinctrl-icelake.c
#![no_std]
...
pub const ICL_LP_PAD_OWN: c_uint = 0x020;
pub const ICL_LP_PADCFGLOCK: c_uint = 0x080;
pub const ICL_LP_HOSTSW_OWN: c_uint = 0x0b0;
pub const ICL_LP_GPI_IS: c_uint = 0x100;
pub const ICL_LP_GPI_IE: c_uint = 0x110;
pub const ICL_N_PAD_OWN: c_uint = 0x020;
pub const ICL_N_PADCFGLOCK: c_uint = 0x080;
pub const ICL_N_HOSTSW_OWN: c_uint = 0x0b0;
pub const ICL_N_GPI_IS: c_uint = 0x100;
pub const ICL_N_GPI_IE: c_uint = 0x120;
