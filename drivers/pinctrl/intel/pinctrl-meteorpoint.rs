...
//! Source: drivers/pinctrl/intel/pinctrl-meteorpoint.c
#![no_std]
...
pub const MTP_PAD_OWN: c_uint = 0x0b0;
pub const MTP_PADCFGLOCK: c_uint = 0x110;
pub const MTP_HOSTSW_OWN: c_uint = 0x150;
pub const MTP_GPI_IS: c_uint = 0x200;
pub const MTP_GPI_IE: c_uint = 0x220;
