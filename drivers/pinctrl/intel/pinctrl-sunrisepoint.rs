...
//! Source: drivers/pinctrl/intel/pinctrl-sunrisepoint.c
#![no_std]
...
pub const SPT_H_PAD_OWN: c_uint = 0x020;
pub const SPT_H_PADCFGLOCK: c_uint = 0x090;
pub const SPT_H_HOSTSW_OWN: c_uint = 0x0d0;
pub const SPT_H_GPI_IS: c_uint = 0x100;
pub const SPT_H_GPI_IE: c_uint = 0x120;
pub const SPT_LP_PAD_OWN: c_uint = 0x020;
pub const SPT_LP_PADCFGLOCK: c_uint = 0x0a0;
pub const SPT_LP_HOSTSW_OWN: c_uint = 0x0d0;
pub const SPT_LP_GPI_IS: c_uint = 0x100;
pub const SPT_LP_GPI_IE: c_uint = 0x120;
...
#[no_mangle]
unsafe extern "C" fn spt_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn spt_pinctrl_exit() -> void __exit {
