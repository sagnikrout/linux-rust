...
//! Source: drivers/pinctrl/freescale/pinctrl-imx27.c
#![no_std]
...
pub const MX27_PA: c_int = 0;
pub const MX27_PB: c_int = 1;
pub const MX27_PC: c_int = 2;
pub const MX27_PD: c_int = 3;
pub const MX27_PE: c_int = 4;
pub const MX27_PF: c_int = 5;
    enum imx27_pads {
...
#[no_mangle]
unsafe extern "C" fn imx27_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx27_pinctrl_init() -> int __init {
