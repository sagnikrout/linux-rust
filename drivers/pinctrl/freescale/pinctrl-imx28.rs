...
//! Source: drivers/pinctrl/freescale/pinctrl-imx28.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx28_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx28_pinctrl_init() -> int __init {
