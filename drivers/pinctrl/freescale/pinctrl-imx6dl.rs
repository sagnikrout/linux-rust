...
//! Source: drivers/pinctrl/freescale/pinctrl-imx6dl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx6dl_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx6dl_pinctrl_init() -> int __init {
