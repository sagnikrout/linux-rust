...
//! Source: drivers/pinctrl/freescale/pinctrl-imx8dxl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx8dxl_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8dxl_pinctrl_init() -> int __init {
