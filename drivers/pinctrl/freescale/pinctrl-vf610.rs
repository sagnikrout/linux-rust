...
//! Source: drivers/pinctrl/freescale/pinctrl-vf610.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vf610_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vf610_pinctrl_init() -> int __init {
