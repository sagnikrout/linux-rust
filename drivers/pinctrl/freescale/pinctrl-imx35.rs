...
//! Source: drivers/pinctrl/freescale/pinctrl-imx35.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx35_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx35_pinctrl_init() -> int __init {
