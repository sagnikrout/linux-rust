...
//! Source: drivers/pinctrl/freescale/pinctrl-imx7d.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx7d_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7d_pinctrl_init() -> int __init {
