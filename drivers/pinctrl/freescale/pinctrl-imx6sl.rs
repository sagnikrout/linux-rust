...
//! Source: drivers/pinctrl/freescale/pinctrl-imx6sl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx6sl_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx6sl_pinctrl_init() -> int __init {
