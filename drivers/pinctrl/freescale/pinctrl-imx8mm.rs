...
//! Source: drivers/pinctrl/freescale/pinctrl-imx8mm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx8mm_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mm_pinctrl_init() -> int __init {
