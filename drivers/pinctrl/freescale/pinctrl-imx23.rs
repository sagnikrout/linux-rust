...
//! Source: drivers/pinctrl/freescale/pinctrl-imx23.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx23_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx23_pinctrl_init() -> int __init {
