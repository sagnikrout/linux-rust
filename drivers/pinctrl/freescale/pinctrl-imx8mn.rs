...
//! Source: drivers/pinctrl/freescale/pinctrl-imx8mn.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx8mn_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mn_pinctrl_init() -> int __init {
