...
//! Source: drivers/pinctrl/freescale/pinctrl-imx7ulp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx7ulp_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7ulp_pinctrl_init() -> int __init {
