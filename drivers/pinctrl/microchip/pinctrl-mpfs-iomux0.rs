...
//! Source: drivers/pinctrl/microchip/pinctrl-mpfs-iomux0.c
#![no_std]
...
pub const MPFS_IOMUX0_REG: c_uint = 0x200;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpfs_iomux0_pinctrl {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpfs_iomux0_pin_group {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpfs_iomux0_function {
    pub name: *const c_char,
...
#[no_mangle]
unsafe extern "C" fn mpfs_iomux0_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_iomux0_pinmux_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_iomux0_probe(pdev: *mut platform_device) -> c_int {
