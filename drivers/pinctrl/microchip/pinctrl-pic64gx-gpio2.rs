...
//! Source: drivers/pinctrl/microchip/pinctrl-pic64gx-gpio2.c
#![no_std]
...
pub const PIC64GX_PINMUX_REG: c_uint = 0x0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pic64gx_gpio2_pinctrl {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pic64gx_gpio2_pin_group {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pic64gx_gpio2_function {
    pub name: *const c_char,
...
#[no_mangle]
unsafe extern "C" fn pic64gx_gpio2_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pic64gx_gpio2_pinmux_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pic64gx_gpio2_probe(pdev: *mut platform_device) -> c_int {
