...
//! Source: drivers/pinctrl/pinctrl-mlxbf3.c
#![no_std]
...
pub const MLXBF3_NGPIOS_GPIO0: c_int = 32;
pub const MLXBF3_MAX_GPIO_PINS: c_int = 56;
    enum {
    MLXBF3_GPIO_HW_MODE,
    MLXBF3_GPIO_SW_MODE,
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf3_pinctrl {
    pub fw_ctrl_set0: *mut void __iomem,
    pub fw_ctrl_clr0: *mut void __iomem,
    pub fw_ctrl_set1: *mut void __iomem,
    pub fw_ctrl_clr1: *mut void __iomem,
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_pmx_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf3_pinctrl_probe(pdev: *mut platform_device) -> c_int {
