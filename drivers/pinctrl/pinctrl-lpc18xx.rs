...
//! Source: drivers/pinctrl/pinctrl-lpc18xx.c
#![no_std]
...
pub const LPC18XX_SCU_REG_ENAIO0: c_uint = 0xc88;
pub const LPC18XX_SCU_REG_ENAIO1: c_uint = 0xc8c;
pub const LPC18XX_SCU_REG_ENAIO2: c_uint = 0xc90;

// LPC18XX SCU pin register definitions
pub const LPC18XX_SCU_PIN_MODE_MASK: c_uint = 0x7;

pub const LPC18XX_SCU_PIN_EHD_MASK: c_uint = 0x300;
pub const LPC18XX_SCU_PIN_EHD_POS: c_int = 8;

pub const LPC18XX_SCU_I2C0_SCL_SHIFT: c_int = 0;
pub const LPC18XX_SCU_I2C0_SDA_SHIFT: c_int = 8;
pub const LPC18XX_SCU_FUNC_PER_PIN: c_int = 8;
// LPC18XX SCU pin interrupt select registers
pub const LPC18XX_SCU_PINTSEL0: c_uint = 0xe00;
pub const LPC18XX_SCU_PINTSEL1: c_uint = 0xe04;
pub const LPC18XX_SCU_PINTSEL_VAL_MASK: c_uint = 0xff;
pub const LPC18XX_SCU_PINTSEL_PORT_SHIFT: c_int = 5;
pub const LPC18XX_SCU_IRQ_PER_PINTSEL: c_int = 4;
pub const LPC18XX_GPIO_PINS_PER_PORT: c_int = 32;
pub const LPC18XX_GPIO_PIN_INT_MAX: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc18xx_scu_data {
    pub pctl: *mut pinctrl_dev,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub func: [lpc18xx_pmx_func; FUNC_MAX],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc18xx_pin_caps {
    pub offset: c_uint,
    pub functions: [c_uchar; LPC18XX_SCU_FUNC_PER_PIN],
    pub analog: c_uchar,
    pub type: c_uchar,
}

// Analog pins are required to have both bias and input disabled
pub const LPC18XX_SCU_ANALOG_PIN_CFG: c_uint = 0x10;
// Macros to maniupluate analog member in lpc18xx_pin_caps

pub const LPC18XX_ANALOG_BIT_MASK: c_uint = 0x1f;
...
// PIN_CONFIG_GPIO_PIN_INT: route gpio to the gpio pin interrupt controller
    ...
    PCONFDUMP(PIN_CONFIG_GPIO_PIN_INT, "gpio pin int", core::ptr::null_mut(), true),
    };

#[no_mangle]
unsafe extern "C" fn lpc18xx_pconf_get_usb1(param: enum pin_config_param, arg: *mut c_int, reg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pin_to_gpio(pctldev: *mut pinctrl_dev, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_get_pintsel(addr: *mut void __iomem, val: u32, arg: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_gpio_to_pintsel_val(gpio: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(TYPE_USB1: pin_cap->type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(50: param_val ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pmx_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pctl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_valid_pin_function(pin: unsigned, function: unsigned) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_scu_probe(pdev: *mut platform_device) -> c_int {
    ...
    scu.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(scu.clk)) {
