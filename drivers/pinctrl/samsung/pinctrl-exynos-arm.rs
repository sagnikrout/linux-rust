...
//! Source: drivers/pinctrl/samsung/pinctrl-exynos-arm.c
#![no_std]
...
pub const S5P_OTHERS: c_uint = 0xE000;

pub const S5P_PIN_PULL_DISABLE: c_int = 0;
pub const S5P_PIN_PULL_DOWN: c_int = 1;
pub const S5P_PIN_PULL_UP: c_int = 2;
#[no_mangle]
unsafe extern "C" fn s5pv210_pud_value_init(drvdata: *mut samsung_pinctrl_drv_data) {
...
#[no_mangle]
unsafe extern "C" fn s5pv210_retention_disable(drvdata: *mut samsung_pinctrl_drv_data) {
