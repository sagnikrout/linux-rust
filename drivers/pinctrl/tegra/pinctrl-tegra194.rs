...
//! Source: drivers/pinctrl/tegra/pinctrl-tegra194.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tegra194_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra194_pinctrl_init() -> int __init {
