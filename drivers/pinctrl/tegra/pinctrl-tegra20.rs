...
//! Source: drivers/pinctrl/tegra/pinctrl-tegra20.c
#![no_std]
...
pub const TRISTATE_REG_A: c_uint = 0x14;
pub const PIN_MUX_CTL_REG_A: c_uint = 0x80;
pub const PULLUPDOWN_REG_A: c_uint = 0xa0;
pub const PINGROUP_REG_A: c_uint = 0x868;
...
#[no_mangle]
unsafe extern "C" fn tegra20_pinctrl_register_clock_muxes(pdev: *mut platform_device) {
    static void tegra20_pinctrl_register_clock_muxes(struct platform_device *pdev)
    {
    struct tegra_pmx *pmx = platform_get_drvdata(pdev);
    clk_register_mux(core::ptr::null_mut(), "cdev1_mux", cdev1_parents, 4, 0,
    pmx.regs[1] + 0x8, 2, 2, CLK_MUX_READ_ONLY, core::ptr::null_mut());
    clk_register_mux(core::ptr::null_mut(), "cdev2_mux", cdev2_parents, 4, 0,
    pmx.regs[1] + 0x8, 4, 2, CLK_MUX_READ_ONLY, core::ptr::null_mut());
    clk_register_mux(core::ptr::null_mut(), "csus_mux", csus_parents, 4, 0,
    pmx.regs[1] + 0x8, 6, 2, CLK_MUX_READ_ONLY, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tegra20_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra20_pinctrl_init() -> int __init {
