...
//! Source: drivers/pinctrl/tegra/pinctrl-tegra234.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tegra234_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra234_pinctrl_init() -> int __init {
