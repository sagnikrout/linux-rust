...
//! Source: drivers/pinctrl/tegra/pinctrl-tegra124.c
#![no_std]
...
pub const DRV_PINGROUP_REG_A: c_uint = 0x868	/* bank 0 */;
pub const PINGROUP_REG_A: c_uint = 0x3000	/* bank 1 */;
pub const MIPI_PAD_CTRL_PINGROUP_REG_A: c_uint = 0x820	/* bank 2 */;
...
#[no_mangle]
unsafe extern "C" fn tegra124_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_pinctrl_init() -> int __init {
