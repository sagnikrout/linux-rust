...
//! Source: drivers/pinctrl/tegra/pinctrl-tegra186.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tegra186_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_pinctrl_init() -> int __init {
