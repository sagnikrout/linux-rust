...
//! Source: drivers/pinctrl/tegra/pinctrl-tegra210.c
#![no_std]
...
pub const DRV_PINGROUP_REG_A: c_uint = 0x8d4	/* bank 0 */;
...
#[no_mangle]
unsafe extern "C" fn tegra210_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pinctrl_init() -> int __init {
