...
//! Source: drivers/pinctrl/pinctrl-pistachio.c
#![no_std]
...
pub const PADS_SCHMITT_EN0: c_uint = 0x000;

pub const PADS_PU_PD0: c_uint = 0x040;

pub const PADS_PU_PD_MASK: c_uint = 0x3;
pub const PADS_PU_PD_HIGHZ: c_uint = 0x0;
pub const PADS_PU_PD_UP: c_uint = 0x1;
pub const PADS_PU_PD_DOWN: c_uint = 0x2;
pub const PADS_PU_PD_BUS: c_uint = 0x3;
pub const PADS_FUNCTION_SELECT0: c_uint = 0x0c0;
pub const PADS_FUNCTION_SELECT1: c_uint = 0x0c4;
pub const PADS_FUNCTION_SELECT2: c_uint = 0x0c8;
pub const PADS_SCENARIO_SELECT: c_uint = 0x0f8;
pub const PADS_SLEW_RATE0: c_uint = 0x100;

pub const PADS_DRIVE_STRENGTH0: c_uint = 0x120;

    (PADS_DRIVE_STRENGTH0 + 0x4 * ((pin) / 16))

pub const PADS_DRIVE_STRENGTH_MASK: c_uint = 0x3;
pub const PADS_DRIVE_STRENGTH_2MA: c_uint = 0x0;
pub const PADS_DRIVE_STRENGTH_4MA: c_uint = 0x1;
pub const PADS_DRIVE_STRENGTH_8MA: c_uint = 0x2;
pub const PADS_DRIVE_STRENGTH_12MA: c_uint = 0x3;

pub const GPIO_BIT_EN: c_uint = 0x00;
pub const GPIO_OUTPUT_EN: c_uint = 0x04;
pub const GPIO_OUTPUT: c_uint = 0x08;
pub const GPIO_INPUT: c_uint = 0x0c;
pub const GPIO_INPUT_POLARITY: c_uint = 0x10;
pub const GPIO_INTERRUPT_TYPE: c_uint = 0x14;
pub const GPIO_INTERRUPT_TYPE_LEVEL: c_uint = 0x0;
pub const GPIO_INTERRUPT_TYPE_EDGE: c_uint = 0x1;
pub const GPIO_INTERRUPT_EDGE: c_uint = 0x18;
pub const GPIO_INTERRUPT_EDGE_SINGLE: c_uint = 0x0;
pub const GPIO_INTERRUPT_EDGE_DUAL: c_uint = 0x1;
pub const GPIO_INTERRUPT_EN: c_uint = 0x1c;
pub const GPIO_INTERRUPT_STATUS: c_uint = 0x20;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pistachio_function {
    pub name: *const c_char,
    pub groups: *const *const c_char,
    pub ngroups: c_uint,
    pub scenarios: *const c_int,
    pub nscenarios: c_uint,
    pub scenario_reg: c_uint,
    pub scenario_shift: c_uint,
    pub scenario_mask: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pistachio_pin_group {
    pub name: *const c_char,
    pub pin: c_uint,
    pub mux_option: [c_int; 3],
    pub mux_reg: c_int,
    pub mux_shift: c_int,
    pub mux_mask: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pistachio_gpio_bank {
    pub pctl: *mut pistachio_pinctrl,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pistachio_pinctrl {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub pctldev: *mut pinctrl_dev,
    pub pins: *const pinctrl_pin_desc,
    pub npins: c_uint,
    pub functions: *const pistachio_function,
    pub nfunctions: c_uint,
    pub groups: *const pistachio_pin_group,
    pub ngroups: c_uint,
    pub gpio_banks: *mut pistachio_gpio_bank,
    pub nbanks: c_uint,
}

pub const PISTACHIO_PIN_TCK: c_int = 90;
pub const PISTACHIO_PIN_TRSTN: c_int = 91;
pub const PISTACHIO_PIN_TDI: c_int = 92;
pub const PISTACHIO_PIN_TMS: c_int = 93;
pub const PISTACHIO_PIN_TDO: c_int = 94;
pub const PISTACHIO_PIN_JTAG_COMPLY: c_int = 95;
pub const PISTACHIO_PIN_SAFE_MODE: c_int = 96;
pub const PISTACHIO_PIN_POR_DISABLE: c_int = 97;
pub const PISTACHIO_PIN_RESETN: c_int = 98;
...
#[no_mangle]
pub unsafe extern "C" fn pctl_readl(pctl: *mut pistachio_pinctrl, reg: u32) -> u32 {
    static inline u32 pctl_readl(struct pistachio_pinctrl *pctl, u32 reg)
    {
    return readl(pctl.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn pctl_writel(pctl: *mut pistachio_pinctrl, val: u32, reg: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn gpio_readl(bank: *mut pistachio_gpio_bank, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pistachio_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pistachio_pinmux_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_get_direction(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_irq_startup(data: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn pistachio_gpio_register(pctl: *mut pistachio_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pistachio_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pistachio_pinctrl_register() -> int __init {
