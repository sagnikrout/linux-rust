...
//! Source: drivers/pinctrl/pinctrl-tps6594.c
#![no_std]
...
pub const TPS6594_PINCTRL_GPIO_FUNCTION: c_int = 0;
pub const TPS6594_PINCTRL_SCL_I2C2_CS_SPI_FUNCTION: c_int = 1;
pub const TPS6594_PINCTRL_TRIG_WDOG_FUNCTION: c_int = 1;
pub const TPS6594_PINCTRL_CLK32KOUT_FUNCTION: c_int = 1;
pub const TPS6594_PINCTRL_SCLK_SPMI_FUNCTION: c_int = 1;
pub const TPS6594_PINCTRL_SDATA_SPMI_FUNCTION: c_int = 1;
pub const TPS6594_PINCTRL_NERR_MCU_FUNCTION: c_int = 1;
pub const TPS6594_PINCTRL_PDOG_FUNCTION: c_int = 1;
pub const TPS6594_PINCTRL_SYNCCLKIN_FUNCTION: c_int = 1;
pub const TPS6594_PINCTRL_NRSTOUT_SOC_FUNCTION: c_int = 2;
pub const TPS6594_PINCTRL_SYNCCLKOUT_FUNCTION: c_int = 2;
pub const TPS6594_PINCTRL_SDA_I2C2_SDO_SPI_FUNCTION: c_int = 2;
pub const TPS6594_PINCTRL_NERR_SOC_FUNCTION: c_int = 2;
pub const TPS6594_PINCTRL_DISABLE_WDOG_FUNCTION: c_int = 3;
pub const TPS6594_PINCTRL_NSLEEP1_FUNCTION: c_int = 4;
pub const TPS6594_PINCTRL_NSLEEP2_FUNCTION: c_int = 5;
pub const TPS6594_PINCTRL_WKUP1_FUNCTION: c_int = 6;
pub const TPS6594_PINCTRL_WKUP2_FUNCTION: c_int = 7;
// Special muxval for recalcitrant pins
pub const TPS6594_PINCTRL_DISABLE_WDOG_FUNCTION_GPIO8: c_int = 2;
pub const TPS6594_PINCTRL_SYNCCLKOUT_FUNCTION_GPIO8: c_int = 3;
pub const TPS6594_PINCTRL_CLK32KOUT_FUNCTION_GPIO9: c_int = 3;
// TPS65224 pin muxval
pub const TPS65224_PINCTRL_SDA_I2C2_SDO_SPI_FUNCTION: c_int = 1;
pub const TPS65224_PINCTRL_SCL_I2C2_CS_SPI_FUNCTION: c_int = 1;
pub const TPS65224_PINCTRL_VMON1_FUNCTION: c_int = 1;
pub const TPS65224_PINCTRL_VMON2_FUNCTION: c_int = 1;
pub const TPS65224_PINCTRL_WKUP_FUNCTION: c_int = 1;
pub const TPS65224_PINCTRL_NSLEEP2_FUNCTION: c_int = 2;
pub const TPS65224_PINCTRL_NSLEEP1_FUNCTION: c_int = 2;
pub const TPS65224_PINCTRL_SYNCCLKIN_FUNCTION: c_int = 2;
pub const TPS65224_PINCTRL_NERR_MCU_FUNCTION: c_int = 2;
pub const TPS65224_PINCTRL_NINT_FUNCTION: c_int = 3;
pub const TPS65224_PINCTRL_TRIG_WDOG_FUNCTION: c_int = 3;
pub const TPS65224_PINCTRL_PB_FUNCTION: c_int = 3;
pub const TPS65224_PINCTRL_ADC_IN_FUNCTION: c_int = 3;
// TPS65224 Special muxval for recalcitrant pins
pub const TPS65224_PINCTRL_NSLEEP2_FUNCTION_GPIO5: c_int = 1;
pub const TPS65224_PINCTRL_WKUP_FUNCTION_GPIO5: c_int = 4;
pub const TPS65224_PINCTRL_SYNCCLKIN_FUNCTION_GPIO5: c_int = 3;
pub const TPS6594_OFFSET_GPIO_SEL: c_int = 5;
pub const TPS65224_NGPIO_PER_REG: c_int = 6;
pub const TPS6594_NGPIO_PER_REG: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6594_pinctrl_function {
    pub pinfunction: pinfunction,
    pub muxval: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct muxval_remap {
    pub group: c_uint,
    pub muxval: u8,
    pub remap: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6594_pinctrl {
    pub tps: *mut tps6594,
    pub gpio_regmap: *mut gpio_regmap,
    pub pctl_dev: *mut pinctrl_dev,
    pub funcs: *const tps6594_pinctrl_function,
    pub pins: *const pinctrl_pin_desc,
    pub func_cnt: c_int,
    pub num_pins: c_int,
    pub mux_sel_mask: u8,
    pub remap_cnt: c_uint,
    pub remap: *mut muxval_remap,
}
    ...
    {
    let mut line: c_uint = offset % 8;
    let mut stride: c_uint = offset / 8;
    switch (base) {
...
#[no_mangle]
unsafe extern "C" fn tps6594_pmx_func_cnt(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = pinctrl->funcs[selector].pinfunction.ngroups;
    ...
    u8 muxval)
    {
    let mut mux_sel_val: u8 = muxval << TPS6594_OFFSET_GPIO_SEL;
    let mut mux_sel_mask: u8 = pinctrl.mux_sel_mask;
...
// GPIO6 has a different mask in TPS65224
    ...
    {
    struct tps6594_pinctrl *pinctrl = pinctrl_dev_get_drvdata(pctldev);
    let mut muxval: u8 = pinctrl.funcs[function].muxval;
    let mut remap_cnt: c_uint = pinctrl.remap_cnt;
    ...
    {
    struct tps6594_pinctrl *pinctrl = pinctrl_dev_get_drvdata(pctldev);
    let mut muxval: u8 = pinctrl.funcs[TPS6594_PINCTRL_GPIO_FUNCTION].muxval;
...
#[no_mangle]
unsafe extern "C" fn tps6594_groups_cnt(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_pinctrl_probe(pdev: *mut platform_device) -> c_int {
