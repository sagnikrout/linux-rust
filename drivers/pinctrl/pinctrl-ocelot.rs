...
//! Source: drivers/pinctrl/pinctrl-ocelot.c
#![no_std]
...
pub const OCELOT_GPIO_OUT_SET: c_uint = 0x0;
pub const OCELOT_GPIO_OUT_CLR: c_uint = 0x4;
pub const OCELOT_GPIO_OUT: c_uint = 0x8;
pub const OCELOT_GPIO_IN: c_uint = 0xc;
pub const OCELOT_GPIO_OE: c_uint = 0x10;
pub const OCELOT_GPIO_INTR: c_uint = 0x14;
pub const OCELOT_GPIO_INTR_ENA: c_uint = 0x18;
pub const OCELOT_GPIO_INTR_IDENT: c_uint = 0x1c;
pub const OCELOT_GPIO_ALT0: c_uint = 0x20;
pub const OCELOT_GPIO_ALT1: c_uint = 0x24;
pub const OCELOT_GPIO_SD_MAP: c_uint = 0x28;
pub const OCELOT_FUNC_PER_PIN: c_int = 4;
    enum {
    FUNC_CAN0_a,
    FUNC_CAN0_b,
    FUNC_CAN1,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocelot_pin_caps {
    pub pin: c_uint,
    pub functions: [c_uchar; OCELOT_FUNC_PER_PIN],
    pub /: *mut *mut unsigned char a_functions[OCELOT_FUNC_PER_PIN]; / Additional functions,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocelot_pincfg_data {
    pub pd_bit: u8,
    pub pu_bit: u8,
    pub drive_bits: u8,
    pub schmitt_bit: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocelot_pinctrl {
    pub dev: *mut device,
    pub pctl: *mut pinctrl_dev,
    pub gpio_chip: gpio_chip,
    pub map: *mut regmap,
    pub pincfg: *mut regmap,
    pub desc: *mut pinctrl_desc,
    pub pincfg_data: *const ocelot_pincfg_data,
    pub func: [ocelot_pmx_func; FUNC_MAX],
    pub stride: u8,
    pub altm_stride: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocelot_match_data {
    pub desc: pinctrl_desc,
    pub pincfg_data: ocelot_pincfg_data,
    pub n_alt_modes: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocelot_irq_work {
    pub irq_work: work_struct,
    pub irq_desc: *mut irq_desc,
}
...
#[no_mangle]
unsafe extern "C" fn ocelot_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocelot_pctl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocelot_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    {
    struct ocelot_pinctrl *info = gpiochip_get_data(chip);
    let mut pin: c_uint = BIT(offset % 32);
    if (value)
...
#[no_mangle]
unsafe extern "C" fn ocelot_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_irq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_irq_unmask_level(data: *mut irq_data) {
    ...
    let mut gpio: c_uint = irqd_to_hwirq(data);
    let mut bit: c_uint = BIT(gpio % 32);
    let mut ack: bool = false, active = false;
    u8 trigger_level;
    int val;
...
#[no_mangle]
unsafe extern "C" fn ocelot_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ocelot_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
    static int ocelot_irq_set_type(struct irq_data *data, unsigned int type)
    {
...
unsafe extern "C" fn ocelot_irq_handler(desc: *mut irq_desc) {
    ...
    struct ocelot_pinctrl *info = gpiochip_get_data(chip);
    let mut id_reg: c_uint = OCELOT_GPIO_INTR_IDENT * info.stride;
    let mut reg: c_uint = 0, irq, i;
    unsigned long irqs;
...
#[no_mangle]
unsafe extern "C" fn ocelot_destroy_workqueue(data: *mut c_void) {
    static void ocelot_destroy_workqueue(void *data)
    {
    destroy_workqueue(data);
    }
#[no_mangle]
unsafe extern "C" fn ocelot_pinctrl_probe(pdev: *mut platform_device) -> c_int {
