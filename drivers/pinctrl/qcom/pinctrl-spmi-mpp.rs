...
//! Source: drivers/pinctrl/qcom/pinctrl-spmi-mpp.c
#![no_std]
...
pub const PMIC_MPP_ADDRESS_RANGE: c_uint = 0x100;
//
...
//
pub const PMIC_MPP_PULL_UP_0P6KOHM: c_int = 0;
pub const PMIC_MPP_PULL_UP_10KOHM: c_int = 1;
pub const PMIC_MPP_PULL_UP_30KOHM: c_int = 2;
pub const PMIC_MPP_PULL_UP_OPEN: c_int = 3;
// type registers base address bases
pub const PMIC_MPP_REG_TYPE: c_uint = 0x4;
pub const PMIC_MPP_REG_SUBTYPE: c_uint = 0x5;
// mpp peripheral type and subtype values
pub const PMIC_MPP_TYPE: c_uint = 0x11;
pub const PMIC_MPP_SUBTYPE_4CH_NO_ANA_OUT: c_uint = 0x3;
pub const PMIC_MPP_SUBTYPE_ULT_4CH_NO_ANA_OUT: c_uint = 0x4;
pub const PMIC_MPP_SUBTYPE_4CH_NO_SINK: c_uint = 0x5;
pub const PMIC_MPP_SUBTYPE_ULT_4CH_NO_SINK: c_uint = 0x6;
pub const PMIC_MPP_SUBTYPE_4CH_FULL_FUNC: c_uint = 0x7;
pub const PMIC_MPP_SUBTYPE_8CH_FULL_FUNC: c_uint = 0xf;
...
pub const PMIC_MPP_REG_MODE_CTL: c_uint = 0x40;
pub const PMIC_MPP_REG_DIG_VIN_CTL: c_uint = 0x41;
pub const PMIC_MPP_REG_DIG_PULL_CTL: c_uint = 0x42;
pub const PMIC_MPP_REG_DIG_IN_CTL: c_uint = 0x43;
pub const PMIC_MPP_REG_EN_CTL: c_uint = 0x46;
pub const PMIC_MPP_REG_AOUT_CTL: c_uint = 0x48;
pub const PMIC_MPP_REG_AIN_CTL: c_uint = 0x4a;
pub const PMIC_MPP_REG_SINK_CTL: c_uint = 0x4c;
// PMIC_MPP_REG_MODE_CTL
pub const PMIC_MPP_REG_MODE_VALUE_MASK: c_uint = 0x1;
pub const PMIC_MPP_REG_MODE_FUNCTION_SHIFT: c_int = 1;
pub const PMIC_MPP_REG_MODE_FUNCTION_MASK: c_uint = 0x7;
pub const PMIC_MPP_REG_MODE_DIR_SHIFT: c_int = 4;
pub const PMIC_MPP_REG_MODE_DIR_MASK: c_uint = 0x7;
// PMIC_MPP_REG_DIG_VIN_CTL
pub const PMIC_MPP_REG_VIN_SHIFT: c_int = 0;
pub const PMIC_MPP_REG_VIN_MASK: c_uint = 0x7;
// PMIC_MPP_REG_DIG_PULL_CTL
pub const PMIC_MPP_REG_PULL_SHIFT: c_int = 0;
pub const PMIC_MPP_REG_PULL_MASK: c_uint = 0x7;
// PMIC_MPP_REG_EN_CTL
pub const PMIC_MPP_REG_MASTER_EN_SHIFT: c_int = 7;
// PMIC_MPP_REG_AIN_CTL
pub const PMIC_MPP_REG_AIN_ROUTE_SHIFT: c_int = 0;
pub const PMIC_MPP_REG_AIN_ROUTE_MASK: c_uint = 0x7;
pub const PMIC_MPP_MODE_DIGITAL_INPUT: c_int = 0;
pub const PMIC_MPP_MODE_DIGITAL_OUTPUT: c_int = 1;
pub const PMIC_MPP_MODE_DIGITAL_BIDIR: c_int = 2;
pub const PMIC_MPP_MODE_ANALOG_BIDIR: c_int = 3;
pub const PMIC_MPP_MODE_ANALOG_INPUT: c_int = 4;
pub const PMIC_MPP_MODE_ANALOG_OUTPUT: c_int = 5;
pub const PMIC_MPP_MODE_CURRENT_SINK: c_int = 6;
pub const PMIC_MPP_SELECTOR_NORMAL: c_int = 0;
pub const PMIC_MPP_SELECTOR_PAIRED: c_int = 1;
pub const PMIC_MPP_SELECTOR_DTEST_FIRST: c_int = 4;
pub const PMIC_MPP_PHYSICAL_OFFSET: c_int = 1;
...
pub struct pmic_mpp_pad {
    ...
    pub amux_input: c_uint,
    pub aout_level: c_uint,
    pub pullup: c_uint,
    pub function: c_uint,
...
pub struct pmic_mpp_state {
    ...
    PCONFDUMP(PMIC_MPP_CONF_AMUX_ROUTE, "analog mux", core::ptr::null_mut(), true),
    PCONFDUMP(PMIC_MPP_CONF_ANALOG_LEVEL, "analog level", core::ptr::null_mut(), true),
    PCONFDUMP(PMIC_MPP_CONF_DTEST_SELECTOR, "dtest", core::ptr::null_mut(), true),
    PCONFDUMP(PMIC_MPP_CONF_PAIRED, "paired", core::ptr::null_mut(), false),
    };

    static const char *const pmic_mpp_groups[] = {
    "mpp1", "mpp2", "mpp3", "mpp4", "mpp5", "mpp6", "mpp7", "mpp8",
    };
pub const PMIC_MPP_DIGITAL: c_int = 0;
pub const PMIC_MPP_ANALOG: c_int = 1;
pub const PMIC_MPP_SINK: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pad->input_enabled) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pad->paired) -> else {
    else if (pad.paired)
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_direction_input(chip: *mut gpio_chip, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_get(chip: *mut gpio_chip, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_set(chip: *mut gpio_chip, pin: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
    ...
    pad.dtest = sel + 1;
#[no_mangle]
pub unsafe extern "C" fn if(PMIC_MPP_SELECTOR_PAIRED: sel ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_mpp_remove(pdev: *mut platform_device) {
