...
//! Source: drivers/pinctrl/qcom/pinctrl-spmi-gpio.c
#![no_std]
...
pub const PMIC_GPIO_ADDRESS_RANGE: c_uint = 0x100;
// type and subtype registers base address offsets
pub const PMIC_GPIO_REG_TYPE: c_uint = 0x4;
pub const PMIC_GPIO_REG_SUBTYPE: c_uint = 0x5;
// GPIO peripheral type and subtype out_values
pub const PMIC_GPIO_TYPE: c_uint = 0x10;
pub const PMIC_GPIO_SUBTYPE_GPIO_4CH: c_uint = 0x1;
pub const PMIC_GPIO_SUBTYPE_GPIOC_4CH: c_uint = 0x5;
pub const PMIC_GPIO_SUBTYPE_GPIO_8CH: c_uint = 0x9;
pub const PMIC_GPIO_SUBTYPE_GPIOC_8CH: c_uint = 0xd;
pub const PMIC_GPIO_SUBTYPE_GPIO_LV: c_uint = 0x10;
pub const PMIC_GPIO_SUBTYPE_GPIO_MV: c_uint = 0x11;
pub const PMIC_GPIO_SUBTYPE_GPIO_LV_VIN2: c_uint = 0x12;
pub const PMIC_GPIO_SUBTYPE_GPIO_MV_VIN3: c_uint = 0x13;
pub const PMIC_GPIO_SUBTYPE_GPIO_LV_VIN2_CLK: c_uint = 0x14;
pub const PMIC_GPIO_SUBTYPE_GPIO_MV_VIN3_CLK: c_uint = 0x15;
pub const PMIC_MPP_REG_RT_STS: c_uint = 0x10;
pub const PMIC_MPP_REG_RT_STS_VAL_MASK: c_uint = 0x1;
// control register base address offsets
pub const PMIC_GPIO_REG_MODE_CTL: c_uint = 0x40;
pub const PMIC_GPIO_REG_DIG_VIN_CTL: c_uint = 0x41;
pub const PMIC_GPIO_REG_DIG_PULL_CTL: c_uint = 0x42;
pub const PMIC_GPIO_REG_LV_MV_DIG_OUT_SOURCE_CTL: c_uint = 0x44;
pub const PMIC_GPIO_REG_DIG_IN_CTL: c_uint = 0x43;
pub const PMIC_GPIO_REG_DIG_OUT_CTL: c_uint = 0x45;
pub const PMIC_GPIO_REG_EN_CTL: c_uint = 0x46;
pub const PMIC_GPIO_REG_LV_MV_ANA_PASS_THRU_SEL: c_uint = 0x4A;
// PMIC_GPIO_REG_MODE_CTL
pub const PMIC_GPIO_REG_MODE_VALUE_SHIFT: c_uint = 0x1;
pub const PMIC_GPIO_REG_MODE_FUNCTION_SHIFT: c_int = 1;
pub const PMIC_GPIO_REG_MODE_FUNCTION_MASK: c_uint = 0x7;
pub const PMIC_GPIO_REG_MODE_DIR_SHIFT: c_int = 4;
pub const PMIC_GPIO_REG_MODE_DIR_MASK: c_uint = 0x7;
pub const PMIC_GPIO_MODE_DIGITAL_INPUT: c_int = 0;
pub const PMIC_GPIO_MODE_DIGITAL_OUTPUT: c_int = 1;
pub const PMIC_GPIO_MODE_DIGITAL_INPUT_OUTPUT: c_int = 2;
pub const PMIC_GPIO_MODE_ANALOG_PASS_THRU: c_int = 3;
pub const PMIC_GPIO_REG_LV_MV_MODE_DIR_MASK: c_uint = 0x3;
// PMIC_GPIO_REG_DIG_VIN_CTL
pub const PMIC_GPIO_REG_VIN_SHIFT: c_int = 0;
pub const PMIC_GPIO_REG_VIN_MASK: c_uint = 0x7;
// PMIC_GPIO_REG_DIG_PULL_CTL
pub const PMIC_GPIO_REG_PULL_SHIFT: c_int = 0;
pub const PMIC_GPIO_REG_PULL_MASK: c_uint = 0x7;
pub const PMIC_GPIO_PULL_DOWN: c_int = 4;
pub const PMIC_GPIO_PULL_DISABLE: c_int = 5;
// PMIC_GPIO_REG_LV_MV_DIG_OUT_SOURCE_CTL for LV/MV
pub const PMIC_GPIO_LV_MV_OUTPUT_INVERT: c_uint = 0x80;
pub const PMIC_GPIO_LV_MV_OUTPUT_INVERT_SHIFT: c_int = 7;
pub const PMIC_GPIO_LV_MV_OUTPUT_SOURCE_SEL_MASK: c_uint = 0xF;
// PMIC_GPIO_REG_DIG_IN_CTL
pub const PMIC_GPIO_LV_MV_DIG_IN_DTEST_EN: c_uint = 0x80;
pub const PMIC_GPIO_LV_MV_DIG_IN_DTEST_SEL_MASK: c_uint = 0x7;
pub const PMIC_GPIO_DIG_IN_DTEST_SEL_MASK: c_uint = 0xf;
// PMIC_GPIO_REG_DIG_OUT_CTL
pub const PMIC_GPIO_REG_OUT_STRENGTH_SHIFT: c_int = 0;
pub const PMIC_GPIO_REG_OUT_STRENGTH_MASK: c_uint = 0x3;
pub const PMIC_GPIO_REG_OUT_TYPE_SHIFT: c_int = 4;
pub const PMIC_GPIO_REG_OUT_TYPE_MASK: c_uint = 0x3;
//
// Output type - indicates pin should be configured as push-pull,
// open drain or open source.
//
pub const PMIC_GPIO_OUT_BUF_CMOS: c_int = 0;
pub const PMIC_GPIO_OUT_BUF_OPEN_DRAIN_NMOS: c_int = 1;
pub const PMIC_GPIO_OUT_BUF_OPEN_DRAIN_PMOS: c_int = 2;
pub const PMIC_GPIO_OUT_STRENGTH_LOW: c_int = 1;
pub const PMIC_GPIO_OUT_STRENGTH_HIGH: c_int = 3;
// PMIC_GPIO_REG_EN_CTL
pub const PMIC_GPIO_REG_MASTER_EN_SHIFT: c_int = 7;
pub const PMIC_GPIO_PHYSICAL_OFFSET: c_int = 1;
// PMIC_GPIO_REG_LV_MV_ANA_PASS_THRU_SEL
pub const PMIC_GPIO_LV_MV_ANA_MUX_SEL_MASK: c_uint = 0x3;
...
pub struct pmic_gpio_pad {
    ...
    pub analog_pass: bool,
    pub lv_mv_type: bool,
    pub num_sources: c_uint,
    pub power_source: c_uint,
    pub buffer_type: c_uint,
    pub pullup: c_uint,
    pub strength: c_uint,
    pub function: c_uint,
    pub atest: c_uint,
    pub dtest_buffer: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmic_gpio_state {
    pub dev: *mut device,
    pub map: *mut regmap,
    ...
    PCONFDUMP(PMIC_GPIO_CONF_PULL_UP,  "pull up strength", core::ptr::null_mut(), true),
    PCONFDUMP(PMIC_GPIO_CONF_STRENGTH, "drive-strength", core::ptr::null_mut(), true),
    PCONFDUMP(PMIC_GPIO_CONF_ATEST, "atest", core::ptr::null_mut(), true),
    PCONFDUMP(PMIC_GPIO_CONF_ANALOG_PASS, "analog-pass", core::ptr::null_mut(), true),
    PCONFDUMP(PMIC_GPIO_CONF_DTEST_BUFFER, "dtest-buffer", core::ptr::null_mut(), true),
    };
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(pad->input_enabled: pad->output_enabled &&) -> else {
    else if (pad.output_enabled && pad.input_enabled)
    val = PMIC_GPIO_MODE_DIGITAL_INPUT_OUTPUT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pad->output_enabled) -> else {
    ...
    {
    let mut param: unsigned = pinconf_to_config_param(*config);
    struct pmic_gpio_pad *pad;
    unsigned arg;
    pad = pctldev.desc.pins[pin].drv_data;
    switch (param) {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_get_direction(chip: *mut gpio_chip, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_direction_input(chip: *mut gpio_chip, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_get(chip: *mut gpio_chip, pin: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_set(chip: *mut gpio_chip, pin: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !pad->lv_mv_type) -> else {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_probe(pdev: *mut platform_device) -> c_int {
    ...
    state.dev = &pdev.dev;
    state.map = dev_get_regmap(dev.parent, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pmic_gpio_remove(pdev: *mut platform_device) {
