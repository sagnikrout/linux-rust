...
//! Source: drivers/pinctrl/qcom/pinctrl-sdm845.c
#![no_std]
...
pub const EAST: c_uint = 0x00100000;
...
#[no_mangle]
unsafe extern "C" fn sdm845_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdm845_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sdm845_pinctrl_exit() -> void __exit {
