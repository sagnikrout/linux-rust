...
//! Source: drivers/pinctrl/qcom/pinctrl-sc7180.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sc7180_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc7180_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sc7180_pinctrl_exit() -> void __exit {
