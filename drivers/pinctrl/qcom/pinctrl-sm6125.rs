...
//! Source: drivers/pinctrl/qcom/pinctrl-sm6125.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sm6125_tlmm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm6125_tlmm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sm6125_tlmm_exit() -> void __exit {
