...
//! Source: drivers/pinctrl/qcom/pinctrl-qcs8300.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qcs8300_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcs8300_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qcs8300_pinctrl_exit() -> void __exit {
