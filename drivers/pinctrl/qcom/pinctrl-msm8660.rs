...
//! Source: drivers/pinctrl/qcom/pinctrl-msm8660.c
#![no_std]
...
pub const NUM_GPIO_PINGROUPS: c_int = 173;
...
#[no_mangle]
unsafe extern "C" fn msm8660_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm8660_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn msm8660_pinctrl_exit() -> void __exit {
