...
//! Source: drivers/pinctrl/qcom/pinctrl-ipq9650.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipq9650_tlmm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq9650_tlmm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipq9650_tlmm_exit() -> void __exit {
