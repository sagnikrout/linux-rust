...
//! Source: drivers/pinctrl/qcom/pinctrl-x1e80100.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn x1e80100_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x1e80100_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn x1e80100_pinctrl_exit() -> void __exit {
