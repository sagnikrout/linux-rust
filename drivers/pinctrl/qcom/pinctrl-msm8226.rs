...
//! Source: drivers/pinctrl/qcom/pinctrl-msm8226.c
#![no_std]
...
pub const NUM_GPIO_PINGROUPS: c_int = 117;
...
#[no_mangle]
unsafe extern "C" fn msm8226_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm8226_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn msm8226_pinctrl_exit() -> void __exit {
