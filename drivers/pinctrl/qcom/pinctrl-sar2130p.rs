...
//! Source: drivers/pinctrl/qcom/pinctrl-sar2130p.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sar2130p_tlmm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sar2130p_tlmm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sar2130p_tlmm_exit() -> void __exit {
