...
//! Source: drivers/pinctrl/qcom/pinctrl-msm8917.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn msm8917_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm8917_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn msm8917_pinctrl_exit() -> void __exit {
