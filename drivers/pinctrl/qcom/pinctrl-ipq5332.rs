...
//! Source: drivers/pinctrl/qcom/pinctrl-ipq5332.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipq5332_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq5332_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipq5332_pinctrl_exit() -> void __exit {
