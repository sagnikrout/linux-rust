...
//! Source: drivers/pinctrl/qcom/pinctrl-hawi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hawi_tlmm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hawi_tlmm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hawi_tlmm_exit() -> void __exit {
