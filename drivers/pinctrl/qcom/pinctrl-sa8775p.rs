...
//! Source: drivers/pinctrl/qcom/pinctrl-sa8775p.c
#![no_std]
...
pub const REG_BASE: c_uint = 0x100000;
pub const REG_SIZE: c_uint = 0x1000;
...
pub const QUP_I3C_6_MODE_OFFSET: c_uint = 0xAF000;
pub const QUP_I3C_7_MODE_OFFSET: c_uint = 0xB0000;
pub const QUP_I3C_13_MODE_OFFSET: c_uint = 0xB1000;
pub const QUP_I3C_14_MODE_OFFSET: c_uint = 0xB2000;
...
#[no_mangle]
unsafe extern "C" fn sa8775p_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sa8775p_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sa8775p_pinctrl_exit() -> void __exit {
