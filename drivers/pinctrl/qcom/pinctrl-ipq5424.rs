...
//! Source: drivers/pinctrl/qcom/pinctrl-ipq5424.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipq5424_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq5424_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipq5424_pinctrl_exit() -> void __exit {
