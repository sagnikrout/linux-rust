...
//! Source: drivers/pinctrl/qcom/pinctrl-ssbi-gpio.c
#![no_std]
...
pub const PM8XXX_GPIO_MODE_INPUT: c_int = 0;
pub const PM8XXX_GPIO_MODE_OUTPUT: c_int = 2;
// output buffer
pub const PM8XXX_GPIO_PUSH_PULL: c_int = 0;
pub const PM8XXX_GPIO_OPEN_DRAIN: c_int = 1;
// bias
pub const PM8XXX_GPIO_BIAS_PU_30: c_int = 0;
pub const PM8XXX_GPIO_BIAS_PU_1P5: c_int = 1;
pub const PM8XXX_GPIO_BIAS_PU_31P5: c_int = 2;
pub const PM8XXX_GPIO_BIAS_PU_1P5_30: c_int = 3;
pub const PM8XXX_GPIO_BIAS_PD: c_int = 4;
pub const PM8XXX_GPIO_BIAS_NP: c_int = 5;
// GPIO registers
pub const SSBI_REG_ADDR_GPIO_BASE: c_uint = 0x150;

pub const PM8XXX_MAX_GPIOS: c_int = 44;
pub const PM8XXX_GPIO_PHYSICAL_OFFSET: c_int = 1;
...
pub struct pm8xxx_gpio {
    ...
    PCONFDUMP(PM8XXX_QCOM_DRIVE_STRENGTH, "drive-strength", core::ptr::null_mut(), true),
    PCONFDUMP(PM8XXX_QCOM_PULL_UP_STRENGTH,  "pull up strength", core::ptr::null_mut(), true),
    };
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_gpio_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
    static void pm8xxx_gpio_dbg_show(struct seq_file *s, struct gpio_chip *chip)
    {
    let mut gpio: unsigned = chip.base;
    unsigned i;
    for (i = 0; i < chip.ngpio; i++, gpio++) {
    pm8xxx_gpio_dbg_show_one(s, core::ptr::null_mut(), chip, i, gpio);
    seq_puts(s, "\n");
    }
    }
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_irq_disable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_irq_enable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_gpio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_gpio_remove(pdev: *mut platform_device) {
