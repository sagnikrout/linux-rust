...
//! Source: drivers/pinctrl/qcom/pinctrl-msm8998.c
#![no_std]
...
pub const NORTH: c_uint = 0x500000;
pub const WEST: c_uint = 0x100000;
pub const EAST: c_uint = 0x900000;
...
#[no_mangle]
unsafe extern "C" fn msm8998_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm8998_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn msm8998_pinctrl_exit() -> void __exit {
