...
//! Source: drivers/pinctrl/qcom/pinctrl-apq8084.c
#![no_std]
...
pub const NUM_GPIO_PINGROUPS: c_int = 147;
...
#[no_mangle]
unsafe extern "C" fn apq8084_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apq8084_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apq8084_pinctrl_exit() -> void __exit {
