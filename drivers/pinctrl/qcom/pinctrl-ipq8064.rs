...
//! Source: drivers/pinctrl/qcom/pinctrl-ipq8064.c
#![no_std]
...
pub const NUM_GPIO_PINGROUPS: c_int = 69;
...
#[no_mangle]
unsafe extern "C" fn ipq8064_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq8064_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipq8064_pinctrl_exit() -> void __exit {
