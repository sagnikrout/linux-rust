...
//! Source: drivers/pinctrl/qcom/pinctrl-msm8960.c
#![no_std]
...
pub const NUM_GPIO_PINGROUPS: c_int = 152;
...
#[no_mangle]
unsafe extern "C" fn msm8960_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm8960_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn msm8960_pinctrl_exit() -> void __exit {
