...
//! Source: drivers/pinctrl/qcom/pinctrl-qcm2290.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qcm2290_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcm2290_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qcm2290_pinctrl_exit() -> void __exit {
