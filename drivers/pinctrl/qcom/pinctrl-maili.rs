...
//! Source: drivers/pinctrl/qcom/pinctrl-maili.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn maili_tlmm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn maili_tlmm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn maili_tlmm_exit() -> void __exit {
