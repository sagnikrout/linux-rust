...
//! Source: drivers/pinctrl/qcom/pinctrl-mdm9615.c
#![no_std]
...
pub const NUM_GPIO_PINGROUPS: c_int = 88;
...
#[no_mangle]
unsafe extern "C" fn mdm9615_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdm9615_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mdm9615_pinctrl_exit() -> void __exit {
