...
//! Source: drivers/pinctrl/qcom/pinctrl-ssbi-mpp.c
#![no_std]
...
// MPP registers
pub const SSBI_REG_ADDR_MPP_BASE: c_uint = 0x50;

// MPP Type: type
pub const PM8XXX_MPP_TYPE_D_INPUT: c_int = 0;
pub const PM8XXX_MPP_TYPE_D_OUTPUT: c_int = 1;
pub const PM8XXX_MPP_TYPE_D_BI_DIR: c_int = 2;
pub const PM8XXX_MPP_TYPE_A_INPUT: c_int = 3;
pub const PM8XXX_MPP_TYPE_A_OUTPUT: c_int = 4;
pub const PM8XXX_MPP_TYPE_SINK: c_int = 5;
pub const PM8XXX_MPP_TYPE_DTEST_SINK: c_int = 6;
pub const PM8XXX_MPP_TYPE_DTEST_OUTPUT: c_int = 7;
// Digital Input: control
pub const PM8XXX_MPP_DIN_TO_INT: c_int = 0;
pub const PM8XXX_MPP_DIN_TO_DBUS1: c_int = 1;
pub const PM8XXX_MPP_DIN_TO_DBUS2: c_int = 2;
pub const PM8XXX_MPP_DIN_TO_DBUS3: c_int = 3;
// Digital Output: control
pub const PM8XXX_MPP_DOUT_CTRL_LOW: c_int = 0;
pub const PM8XXX_MPP_DOUT_CTRL_HIGH: c_int = 1;
pub const PM8XXX_MPP_DOUT_CTRL_MPP: c_int = 2;
pub const PM8XXX_MPP_DOUT_CTRL_INV_MPP: c_int = 3;
// Bidirectional: control
pub const PM8XXX_MPP_BI_PULLUP_1KOHM: c_int = 0;
pub const PM8XXX_MPP_BI_PULLUP_OPEN: c_int = 1;
pub const PM8XXX_MPP_BI_PULLUP_10KOHM: c_int = 2;
pub const PM8XXX_MPP_BI_PULLUP_30KOHM: c_int = 3;
// Analog Output: control
pub const PM8XXX_MPP_AOUT_CTRL_DISABLE: c_int = 0;
pub const PM8XXX_MPP_AOUT_CTRL_ENABLE: c_int = 1;
pub const PM8XXX_MPP_AOUT_CTRL_MPP_HIGH_EN: c_int = 2;
pub const PM8XXX_MPP_AOUT_CTRL_MPP_LOW_EN: c_int = 3;
// Current Sink: control
pub const PM8XXX_MPP_CS_CTRL_DISABLE: c_int = 0;
pub const PM8XXX_MPP_CS_CTRL_ENABLE: c_int = 1;
pub const PM8XXX_MPP_CS_CTRL_MPP_HIGH_EN: c_int = 2;
pub const PM8XXX_MPP_CS_CTRL_MPP_LOW_EN: c_int = 3;
// DTEST Current Sink: control
pub const PM8XXX_MPP_DTEST_CS_CTRL_EN1: c_int = 0;
pub const PM8XXX_MPP_DTEST_CS_CTRL_EN2: c_int = 1;
pub const PM8XXX_MPP_DTEST_CS_CTRL_EN3: c_int = 2;
pub const PM8XXX_MPP_DTEST_CS_CTRL_EN4: c_int = 3;
// DTEST Digital Output: control
pub const PM8XXX_MPP_DTEST_DBUS1: c_int = 0;
pub const PM8XXX_MPP_DTEST_DBUS2: c_int = 1;
pub const PM8XXX_MPP_DTEST_DBUS3: c_int = 2;
pub const PM8XXX_MPP_DTEST_DBUS4: c_int = 3;
...
pub struct pm8xxx_mpp {
    ...
    PCONFDUMP(PM8XXX_CONFIG_AMUX, "analog mux", core::ptr::null_mut(), true),
    PCONFDUMP(PM8XXX_CONFIG_ALEVEL, "analog level", core::ptr::null_mut(), true),
    PCONFDUMP(PM8XXX_CONFIG_DTEST_SELECTOR, "dtest", core::ptr::null_mut(), true),
    PCONFDUMP(PM8XXX_CONFIG_PAIRED, "paired", core::ptr::null_mut(), false),
    };

pub const PM8XXX_MAX_MPPS: c_int = 12;
pub const PM8XXX_MPP_PHYSICAL_OFFSET: c_int = 1;
    static const char * const pm8xxx_groups[PM8XXX_MAX_MPPS] = {
    "mpp1", "mpp2", "mpp3", "mpp4", "mpp5", "mpp6", "mpp7", "mpp8",
    "mpp9", "mpp10", "mpp11", "mpp12",
    };
pub const PM8XXX_MPP_DIGITAL: c_int = 0;
pub const PM8XXX_MPP_ANALOG: c_int = 1;
pub const PM8XXX_MPP_SINK: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn if(600: pin->pullup ==) -> else {
    else if (pin.pullup == 600)
    ctrl = PM8XXX_MPP_BI_PULLUP_1KOHM;
#[no_mangle]
pub unsafe extern "C" fn if(10000: pin->pullup ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_mpp_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_mpp_dbg_show(s: *mut seq_file, chip: *mut gpio_chip) {
    static void pm8xxx_mpp_dbg_show(struct seq_file *s, struct gpio_chip *chip)
    {
    let mut gpio: unsigned = chip.base;
    unsigned i;
    for (i = 0; i < chip.ngpio; i++, gpio++) {
    pm8xxx_mpp_dbg_show_one(s, core::ptr::null_mut(), chip, i, gpio);
    seq_puts(s, "\n");
    }
    }
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_mpp_irq_disable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_mpp_irq_enable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_mpp_probe(pdev: *mut platform_device) -> c_int {
    ...
    pctrl.regmap = dev_get_regmap(pdev.dev.parent, core::ptr::null_mut());
    if (!pctrl.regmap) {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_mpp_remove(pdev: *mut platform_device) {
