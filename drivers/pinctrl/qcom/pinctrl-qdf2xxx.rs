...
//! Source: drivers/pinctrl/qcom/pinctrl-qdf2xxx.c
#![no_std]
...
pub const MAX_GPIOS: c_int = 256;
// maximum size of each gpio name (enough room for "gpioXXX" + null)
pub const NAME_SIZE: c_int = 8;
#[no_mangle]
unsafe extern "C" fn qdf2xxx_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qdf2xxx_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qdf2xxx_pinctrl_exit() -> void __exit {
