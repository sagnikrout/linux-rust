...
//! Source: drivers/pinctrl/qcom/pinctrl-msm8953.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn msm8953_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm8953_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn msm8953_pinctrl_exit() -> void __exit {
