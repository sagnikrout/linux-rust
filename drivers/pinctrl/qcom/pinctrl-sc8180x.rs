...
//! Source: drivers/pinctrl/qcom/pinctrl-sc8180x.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn sc8180x_pinctrl_add_tile_resources(pdev: *mut platform_device) -> c_int {
    static int sc8180x_pinctrl_add_tile_resources(struct platform_device *pdev)
    {
    let mut nres_num: c_int = pdev.num_resources + ARRAY_SIZE(sc8180x_tiles) - 1;
    struct resource *mres = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sc8180x_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc8180x_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sc8180x_pinctrl_exit() -> void __exit {
