...
//! Source: drivers/pinctrl/qcom/pinctrl-sm8750.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sm8750_tlmm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm8750_tlmm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sm8750_tlmm_exit() -> void __exit {
