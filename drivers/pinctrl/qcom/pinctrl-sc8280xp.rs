...
//! Source: drivers/pinctrl/qcom/pinctrl-sc8280xp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sc8280xp_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc8280xp_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sc8280xp_pinctrl_exit() -> void __exit {
