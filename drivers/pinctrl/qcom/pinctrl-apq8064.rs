...
//! Source: drivers/pinctrl/qcom/pinctrl-apq8064.c
#![no_std]
...
pub const NUM_GPIO_PINGROUPS: c_int = 90;
...
#[no_mangle]
unsafe extern "C" fn apq8064_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apq8064_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn apq8064_pinctrl_exit() -> void __exit {
