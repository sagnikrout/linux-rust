...
//! Source: drivers/pinctrl/qcom/pinctrl-ipq9574.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipq9574_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq9574_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipq9574_pinctrl_exit() -> void __exit {
