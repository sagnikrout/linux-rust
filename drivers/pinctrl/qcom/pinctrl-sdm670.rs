...
//! Source: drivers/pinctrl/qcom/pinctrl-sdm670.c
#![no_std]
...
pub const NORTH: c_uint = 0x00500000;
pub const SOUTH: c_uint = 0x00900000;
pub const WEST: c_uint = 0x00100000;
...
#[no_mangle]
unsafe extern "C" fn sdm670_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdm670_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sdm670_pinctrl_exit() -> void __exit {
