...
//! Source: drivers/pinctrl/bcm/pinctrl-nsp-gpio.c
#![no_std]
...
pub const NSP_CHIP_A_INT_STATUS: c_uint = 0x00;
pub const NSP_CHIP_A_INT_MASK: c_uint = 0x04;
pub const NSP_GPIO_DATA_IN: c_uint = 0x40;
pub const NSP_GPIO_DATA_OUT: c_uint = 0x44;
pub const NSP_GPIO_OUT_EN: c_uint = 0x48;
pub const NSP_GPIO_INT_POLARITY: c_uint = 0x50;
pub const NSP_GPIO_INT_MASK: c_uint = 0x54;
pub const NSP_GPIO_EVENT: c_uint = 0x58;
pub const NSP_GPIO_EVENT_INT_MASK: c_uint = 0x5c;
pub const NSP_GPIO_EVENT_INT_POLARITY: c_uint = 0x64;
pub const NSP_CHIP_A_GPIO_INT_BIT: c_uint = 0x01;
// I/O parameters offset for chipcommon A GPIO
pub const NSP_GPIO_DRV_CTRL: c_uint = 0x00;
pub const NSP_GPIO_HYSTERESIS_EN: c_uint = 0x10;
pub const NSP_GPIO_SLEW_RATE_EN: c_uint = 0x14;
pub const NSP_PULL_UP_EN: c_uint = 0x18;
pub const NSP_PULL_DOWN_EN: c_uint = 0x1c;
pub const GPIO_DRV_STRENGTH_BITS: c_uint = 0x03;
//
// nsp GPIO core
//
...
//
#[no_mangle]
pub unsafe extern "C" fn nsp_pin_to_gpio(pin: unsigned) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn nsp_gpio_irq_set_mask(d: *mut irq_data, unmask: bool) {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_direction_input(gc: *mut gpio_chip, gpio: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_get_direction(gc: *mut gpio_chip, gpio: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_set(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_get(gc: *mut gpio_chip, gpio: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsp_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_set_slew(chip: *mut nsp_gpio, gpio: unsigned, slew: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nsp_gpio_register_pinconf(chip: *mut nsp_gpio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nsp_gpio_init() -> int __init {
