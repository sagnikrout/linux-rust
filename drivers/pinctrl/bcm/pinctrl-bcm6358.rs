...
//! Source: drivers/pinctrl/bcm/pinctrl-bcm6358.c
#![no_std]
...
pub const BCM6358_NUM_GPIOS: c_int = 40;
pub const BCM6358_MODE_REG: c_uint = 0x18;
pub const BCM6358_MODE_MUX_NONE: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm6358_pingroup {
    pub grp: pingroup,
    pub mode_val: u16,
...
#[no_mangle]
unsafe extern "C" fn bcm6358_pinctrl_get_group_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm6358_pinctrl_get_func_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = bcm6358_funcs[selector].num_groups;
    ...
    let mut val: c_uint = pg.mode_val;
    let mut mask: c_uint = val;
    unsigned pin;
    ...
    let mut hw_gpio: c_uint = bcm6358_pins[pin].number;
...
#[no_mangle]
unsafe extern "C" fn bcm6358_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int bcm6358_pinctrl_probe(struct platform_device *pdev)
    {
    let mut overlays: reg_field = REG_FIELD(BCM6358_MODE_REG, 0, 15);
