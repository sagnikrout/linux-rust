...
//! Source: drivers/pinctrl/bcm/pinctrl-bcm63268.c
#![no_std]
...
pub const BCM63268_NUM_GPIOS: c_int = 52;
pub const BCM63268_NUM_LEDS: c_int = 24;
pub const BCM63268_LED_REG: c_uint = 0x10;
pub const BCM63268_MODE_REG: c_uint = 0x18;
pub const BCM63268_CTRL_REG: c_uint = 0x1c;
pub const BCM63268_BASEMODE_REG: c_uint = 0x38;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm63268_function {
    pub name: *const c_char,
    pub groups: *const *const c_char,
    pub num_groups: unsigned,
    pub reg: enum bcm63268_pinctrl_reg,
    pub mask: u32,
}
...
#[no_mangle]
unsafe extern "C" fn bcm63268_pinctrl_get_group_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm63268_pinctrl_get_func_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm63268_set_gpio(pc: *mut bcm63xx_pinctrl, pin: unsigned) {
    static void bcm63268_set_gpio(struct bcm63xx_pinctrl *pc, unsigned pin)
    {
    const struct pinctrl_pin_desc *desc = &bcm63268_pins[pin];
    let mut basemode: c_uint = (unsigned long) desc.drv_data;
    let mut mask: c_uint = BIT(bcm63xx_bank_pin(pin));
    if (basemode)
...
#[no_mangle]
unsafe extern "C" fn bcm63268_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int bcm63268_pinctrl_probe(struct platform_device *pdev)
    {
    return bcm63xx_pinctrl_probe(pdev, &bcm63268_soc, core::ptr::null_mut());
    }
