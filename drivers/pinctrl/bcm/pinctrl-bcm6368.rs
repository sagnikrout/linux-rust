...
//! Source: drivers/pinctrl/bcm/pinctrl-bcm6368.c
#![no_std]
...
pub const BCM6368_NUM_GPIOS: c_int = 38;
pub const BCM6368_MODE_REG: c_uint = 0x18;
pub const BCM6368_BASEMODE_REG: c_uint = 0x38;
pub const BCM6368_BASEMODE_MASK: c_uint = 0x7;
pub const BCM6368_BASEMODE_GPIO: c_uint = 0x0;
pub const BCM6368_BASEMODE_UART1: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm6368_function {
    pub name: *const c_char,
    pub groups: *const *const c_char,
    pub num_groups: unsigned,
    pub dir_out:16: unsigned,
    pub basemode:3: unsigned,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm6368_priv {
    pub overlays: *mut regmap_field,
}
...
#[no_mangle]
unsafe extern "C" fn bcm6368_pinctrl_get_group_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm6368_pinctrl_get_func_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = bcm6368_funcs[selector].num_groups;
    ...
    let mut hw_gpio: c_int = bcm6368_pins[pin].number;
...
#[no_mangle]
unsafe extern "C" fn bcm6368_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int bcm6368_pinctrl_probe(struct platform_device *pdev)
    {
    let mut overlays: reg_field = REG_FIELD(BCM6368_BASEMODE_REG, 0, 15);
