...
//! Source: drivers/pinctrl/bcm/pinctrl-bcm6362.c
#![no_std]
...
pub const BCM6362_BANK_GPIOS: c_int = 32;
pub const BCM6362_NUM_GPIOS: c_int = 48;
pub const BCM6362_NUM_LEDS: c_int = 24;
pub const BCM6362_LED_REG: c_uint = 0x10;
pub const BCM6362_MODE_REG: c_uint = 0x18;
pub const BCM6362_CTRL_REG: c_uint = 0x1c;
pub const BCM6362_BASEMODE_REG: c_uint = 0x38;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm6362_function {
    pub name: *const c_char,
    pub groups: *const *const c_char,
    pub num_groups: unsigned,
    pub reg: enum bcm6362_pinctrl_reg,
    pub basemode_mask: u32,
}
...
#[no_mangle]
unsafe extern "C" fn bcm6362_pinctrl_get_group_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm6362_pinctrl_get_func_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm6362_set_gpio(pc: *mut bcm63xx_pinctrl, pin: unsigned) {
    static void bcm6362_set_gpio(struct bcm63xx_pinctrl *pc, unsigned pin)
    {
    const struct pinctrl_pin_desc *desc = &bcm6362_pins[pin];
    let mut basemode: c_uint = (uintptr_t)desc.drv_data;
    let mut mask: c_uint = bcm63xx_bank_pin(pin);
    if (basemode)
...
#[no_mangle]
unsafe extern "C" fn bcm6362_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int bcm6362_pinctrl_probe(struct platform_device *pdev)
    {
    return bcm63xx_pinctrl_probe(pdev, &bcm6362_soc, core::ptr::null_mut());
    }
