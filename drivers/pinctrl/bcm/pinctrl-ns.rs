...
//! Source: drivers/pinctrl/bcm/pinctrl-ns.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ns_pinctrl {
    pub dev: *mut device,
    pub chipset_flag: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ns_pinctrl_function {
    pub name: *const c_char,
...
#[no_mangle]
unsafe extern "C" fn ns_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
// Set pinctrl properties
    ...
    let mut chipsets: c_uint = (uintptr_t)src.drv_data;
...
// Register
    ...
    group.pins, group.num_pins, core::ptr::null_mut());
    }
