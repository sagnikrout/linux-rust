...
//! Source: drivers/pinctrl/bcm/pinctrl-iproc-gpio.c
#![no_std]
...
pub const IPROC_GPIO_DATA_IN_OFFSET: c_uint = 0x00;
pub const IPROC_GPIO_DATA_OUT_OFFSET: c_uint = 0x04;
pub const IPROC_GPIO_OUT_EN_OFFSET: c_uint = 0x08;
pub const IPROC_GPIO_INT_TYPE_OFFSET: c_uint = 0x0c;
pub const IPROC_GPIO_INT_DE_OFFSET: c_uint = 0x10;
pub const IPROC_GPIO_INT_EDGE_OFFSET: c_uint = 0x14;
pub const IPROC_GPIO_INT_MSK_OFFSET: c_uint = 0x18;
pub const IPROC_GPIO_INT_STAT_OFFSET: c_uint = 0x1c;
pub const IPROC_GPIO_INT_MSTAT_OFFSET: c_uint = 0x20;
pub const IPROC_GPIO_INT_CLR_OFFSET: c_uint = 0x24;
pub const IPROC_GPIO_PAD_RES_OFFSET: c_uint = 0x34;
pub const IPROC_GPIO_RES_EN_OFFSET: c_uint = 0x38;
// drive strength control for ASIU GPIO
pub const IPROC_GPIO_ASIU_DRV0_CTRL_OFFSET: c_uint = 0x58;
// pinconf for CCM GPIO
pub const IPROC_GPIO_PULL_DN_OFFSET: c_uint = 0x10;
pub const IPROC_GPIO_PULL_UP_OFFSET: c_uint = 0x14;
// pinconf for CRMU(aon) GPIO and CCM GPIO
pub const IPROC_GPIO_DRV_CTRL_OFFSET: c_uint = 0x00;
pub const GPIO_BANK_SIZE: c_uint = 0x200;
pub const NGPIOS_PER_BANK: c_int = 32;

pub const GPIO_DRV_STRENGTH_BIT_SHIFT: c_int = 20;
pub const GPIO_DRV_STRENGTH_BITS: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iproc_gpio {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub io_ctrl: *mut void __iomem,
    pub io_ctrl_type: enum iproc_pinconf_ctrl_type,
    pub lock: raw_spinlock_t,
    pub gc: gpio_chip,
    pub num_banks: unsigned,
    pub pinmux_is_supported: bool,
    pub pinconf_disable: *mut enum pin_config_param,
    pub nr_pinconf_disable: c_uint,
...
//
#[no_mangle]
pub unsafe extern "C" fn iproc_pin_to_gpio(pin: unsigned) -> unsigned {
...
//
    ...
    {
    let mut offset: c_uint = IPROC_GPIO_REG(gpio, reg);
    let mut shift: c_uint = IPROC_GPIO_SHIFT(gpio);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn iproc_gpio_irq_handler(desc: *mut irq_desc) {
...
// go through the entire GPIO banks and handle all interrupts
    ...
    let mut pin: unsigned = NGPIOS_PER_BANK * i + bit;
//
...
//
#[no_mangle]
unsafe extern "C" fn iproc_gpio_irq_set_mask(d: *mut irq_data, unmask: bool) {
    static void iproc_gpio_irq_set_mask(struct irq_data *d, bool unmask)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
    struct iproc_gpio *chip = gpiochip_get_data(gc);
    let mut gpio: unsigned = irqd_to_hwirq(d);
...
#[no_mangle]
unsafe extern "C" fn iproc_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
    static int iproc_gpio_irq_set_type(struct irq_data *d, unsigned int type)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
    struct iproc_gpio *chip = gpiochip_get_data(gc);
    let mut gpio: unsigned = d.hwirq;
    let mut level_triggered: bool = false;
    let mut dual_edge: bool = false;
    let mut rising_or_high: bool = false;
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn iproc_gpio_request(gc: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iproc_gpio_free(gc: *mut gpio_chip, offset: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn iproc_gpio_direction_input(gc: *mut gpio_chip, gpio: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iproc_gpio_get_direction(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
    static int iproc_gpio_get_direction(struct gpio_chip *gc, unsigned int gpio)
    {
    struct iproc_gpio *chip = gpiochip_get_data(gc);
    let mut offset: c_uint = IPROC_GPIO_REG(gpio, IPROC_GPIO_OUT_EN_OFFSET);
    let mut shift: c_uint = IPROC_GPIO_SHIFT(gpio);
...
#[no_mangle]
unsafe extern "C" fn iproc_gpio_set(gc: *mut gpio_chip, gpio: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iproc_gpio_get(gc: *mut gpio_chip, gpio: unsigned) -> c_int {
...
//
    ...
    {
    let mut map_size: c_uint = ARRAY_SIZE(iproc_pinconf_disable_map);
...
#[no_mangle]
unsafe extern "C" fn iproc_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// strength = (*strength + 1) * 2;
    ...
    let mut gpio: unsigned = iproc_pin_to_gpio(pin);
    u16 arg;
...
//
#[no_mangle]
unsafe extern "C" fn iproc_gpio_register_pinconf(chip: *mut iproc_gpio) -> c_int {
...
unsafe extern "C" fn iproc_gpio_probe(pdev: *mut platform_device) -> c_int {
    ...
    int irq, ret;
    let mut no_pinconf: bool = false;
    let mut io_ctrl_type: enum iproc_pinconf_ctrl_type = IOCTRL_TYPE_INVALID;
...
#[no_mangle]
unsafe extern "C" fn iproc_gpio_init() -> int __init {
