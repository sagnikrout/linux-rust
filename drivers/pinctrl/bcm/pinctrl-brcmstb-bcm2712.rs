...
//! Source: drivers/pinctrl/bcm/pinctrl-brcmstb-bcm2712.c
#![no_std]
...
pub const BRCMSTB_FSEL_COUNT: c_int = 8;
pub const BRCMSTB_FSEL_MASK: c_uint = 0xf;
...
#[no_mangle]
unsafe extern "C" fn bcm2712_pinctrl_probe(pdev: *mut platform_device) -> c_int {
