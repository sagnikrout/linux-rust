...
//! Source: drivers/pinctrl/bcm/pinctrl-ns2-mux.c
#![no_std]
...
pub const NS2_NUM_IOMUX: c_int = 19;
pub const NS2_NUM_PWM_MUX: c_int = 4;
pub const NS2_PIN_MUX_BASE0: c_uint = 0x00;
pub const NS2_PIN_MUX_BASE1: c_uint = 0x01;
pub const NS2_PIN_CONF_BASE: c_uint = 0x02;
pub const NS2_MUX_PAD_FUNC1_OFFSET: c_uint = 0x04;
pub const NS2_PIN_SRC_MASK: c_uint = 0x01;
pub const NS2_PIN_PULL_MASK: c_uint = 0x03;
pub const NS2_PIN_DRIVE_STRENGTH_MASK: c_uint = 0x07;
pub const NS2_PIN_PULL_UP: c_uint = 0x01;
pub const NS2_PIN_PULL_DOWN: c_uint = 0x02;
pub const NS2_PIN_INPUT_EN_MASK: c_uint = 0x01;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ns2_pinctrl {
    pub pctl: *mut pinctrl_dev,
    pub dev: *mut device,
    pub base0: *mut void __iomem,
    pub base1: *mut void __iomem,
    pub pinconf_base: *mut void __iomem,
    pub groups: *const ns2_pin_group,
    pub num_groups: c_uint,
    pub functions: *const ns2_pin_function,
    pub num_functions: c_uint,
    pub mux_log: *mut ns2_mux_log,
    pub lock: spinlock_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ns2_pinconf {
    pub base: c_uint,
    pub offset: c_uint,
    pub src_shift: c_uint,
    pub input_en: c_uint,
    pub pull_shift: c_uint,
    pub drive_shift: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ns2_get_groups_count(pctrl_dev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns2_get_functions_count(pctrl_dev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns2_pin_get_enable(pctrldev: *mut pinctrl_dev, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns2_mux_log_init(pinctrl: *mut ns2_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns2_pinmux_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns2_pinmux_init() -> int __init {
