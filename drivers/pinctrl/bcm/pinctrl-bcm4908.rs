...
//! Source: drivers/pinctrl/bcm/pinctrl-bcm4908.c
#![no_std]
...
pub const BCM4908_NUM_PINS: c_int = 86;
pub const BCM4908_TEST_PORT_BLOCK_EN_LSB: c_uint = 0x00;
pub const BCM4908_TEST_PORT_BLOCK_DATA_MSB: c_uint = 0x04;
pub const BCM4908_TEST_PORT_BLOCK_DATA_LSB: c_uint = 0x08;
pub const BCM4908_TEST_PORT_LSB_PINMUX_DATA_SHIFT: c_int = 12;
pub const BCM4908_TEST_PORT_COMMAND: c_uint = 0x0c;
pub const BCM4908_TEST_PORT_CMD_LOAD_MUX_REG: c_uint = 0x00000021;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4908_pinctrl {
    pub dev: *mut device,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4908_pinctrl_pin_setup {
    pub number: c_uint,
    pub function: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4908_pinctrl_grp {
    pub name: *const c_char,
    pub pins: *const bcm4908_pinctrl_pin_setup,
    pub num_pins: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4908_pinctrl_function {
    pub name: *const c_char,
...
#[no_mangle]
unsafe extern "C" fn bcm4908_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
// Functions
    ...
    function.name,
    function.groups,
    function.num_groups, core::ptr::null_mut());
    }
    return 0;
    }
