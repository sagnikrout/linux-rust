...
//! Source: drivers/pinctrl/bcm/pinctrl-bcm2835.c
#![no_std]
...
pub const BCM2835_NUM_GPIOS: c_int = 54;
pub const BCM2711_NUM_GPIOS: c_int = 58;
pub const BCM2835_NUM_BANKS: c_int = 2;
pub const BCM2835_NUM_IRQS: c_int = 3;
// GPIO register offsets
pub const GPFSEL0: c_uint = 0x0	/* Function Select */;
pub const GPSET0: c_uint = 0x1c	/* Pin Output Set */;
pub const GPCLR0: c_uint = 0x28	/* Pin Output Clear */;
pub const GPLEV0: c_uint = 0x34	/* Pin Level */;
pub const GPEDS0: c_uint = 0x40	/* Pin Event Detect Status */;
pub const GPREN0: c_uint = 0x4c	/* Pin Rising Edge Detect Enable */;
pub const GPFEN0: c_uint = 0x58	/* Pin Falling Edge Detect Enable */;
pub const GPHEN0: c_uint = 0x64	/* Pin High Detect Enable */;
pub const GPLEN0: c_uint = 0x70	/* Pin Low Detect Enable */;
pub const GPAREN0: c_uint = 0x7c	/* Pin Async Rising Edge Detect */;
pub const GPAFEN0: c_uint = 0x88	/* Pin Async Falling Edge Detect */;
pub const GPPUD: c_uint = 0x94	/* Pin Pull-up/down Enable */;
pub const GPPUDCLK0: c_uint = 0x98	/* Pin Pull-up/down Enable Clock */;
pub const GP_GPIO_PUP_PDN_CNTRL_REG0: c_uint = 0xe4 /* 2711 Pin Pull-up/down select */;

pub const PUD_2711_MASK: c_uint = 0x3;

// argument: bcm2835_pinconf_pull

pub const BCM2711_PULL_NONE: c_uint = 0x0;
pub const BCM2711_PULL_UP: c_uint = 0x1;
pub const BCM2711_PULL_DOWN: c_uint = 0x2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm2835_pinctrl {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub wake_irq: *mut c_int,
// note: locking assumes each bank will have its own unsigned long
    pub enabled_irq_map: [c_ulong; BCM2835_NUM_BANKS],
    pub irq_type: [c_uint; BCM2711_NUM_GPIOS],
    pub pctl_dev: *mut pinctrl_dev,
    pub gpio_chip: gpio_chip,
    pub pctl_desc: pinctrl_desc,
    pub gpio_range: pinctrl_gpio_range,
    pub irq_lock: [raw_spinlock_t; BCM2835_NUM_BANKS],
// Protect FSEL registers
    pub fsel_lock: spinlock_t,
}
...
#[no_mangle]
pub unsafe extern "C" fn bcm2835_gpio_rd(pc: *mut bcm2835_pinctrl, reg: unsigned) -> u32 {
...
// note NOT a read/modify/write cycle
    ...
    {
    let mut val: u32 = bcm2835_gpio_rd(pc, FSEL_REG(pin));
    let mut status: enum bcm2835_fsel = (val >> FSEL_SHIFT(pin)) & BCM2835_FSEL_MASK;
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_direction_input(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    static int bcm2835_gpio_get_direction(struct gpio_chip *chip, unsigned int offset)
    {
    struct bcm2835_pinctrl *pc = gpiochip_get_data(chip);
    let mut fsel: enum bcm2835_fsel = bcm2835_pinctrl_fsel_get(pc, offset);
...
#[no_mangle]
unsafe extern "C" fn bcm2835_add_pin_ranges_fallback(gc: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_wake_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_irq_unmask(data: *mut irq_data) {
    static void bcm2835_gpio_irq_unmask(struct irq_data *data)
    {
    struct gpio_chip *chip = irq_data_get_irq_chip_data(data);
    struct bcm2835_pinctrl *pc = gpiochip_get_data(chip);
    let mut gpio: unsigned = irqd_to_hwirq(data);
    let mut offset: unsigned = GPIO_REG_SHIFT(gpio);
    let mut bank: unsigned = GPIO_REG_OFFSET(gpio);
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_gpio_irq_set_wake(data: *mut irq_data, on: c_uint) -> c_int {
    ...
    irqgroup = 0;
#[no_mangle]
pub unsafe extern "C" fn if(45: gpio >= 28 && gpio <=) -> else {
    else if (gpio >= 28 && gpio <= 45)
    irqgroup = 1;
#[no_mangle]
pub unsafe extern "C" fn if(57: gpio >= 46 && gpio <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn bcm2835_pctl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_pins = 1;
    ...
    let mut value: c_int = bcm2835_gpio_get_bit(pc, GPLEV0, offset);
...
#[no_mangle]
unsafe extern "C" fn bcm2835_pmx_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = BCM2835_NUM_GPIOS;
    ...
    struct bcm2835_pinctrl *pc = pinctrl_dev_get_drvdata(pctldev);
    let mut fsel: enum bcm2835_fsel = bcm2835_pinctrl_fsel_get(pc, pin);
    u32 val;
...
// convert legacy brcm,pull
    ...
    arg = BCM2711_PULL_UP;
#[no_mangle]
pub unsafe extern "C" fn if(BCM2835_PUD_DOWN: arg ==) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm_plat_data {
    pub gpio_chip: *const gpio_chip,
...
#[no_mangle]
unsafe extern "C" fn bcm2835_pinctrl_probe(pdev: *mut platform_device) -> c_int {
