...
//! Source: drivers/pinctrl/bcm/pinctrl-cygnus-mux.c
#![no_std]
...
pub const CYGNUS_NUM_IOMUX_REGS: c_int = 8;
pub const CYGNUS_NUM_MUX_PER_REG: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cygnus_pin_function {
    pub name: *const c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cygnus_pinctrl {
    pub pctl: *mut pinctrl_dev,
    pub dev: *mut device,
    pub base0: *mut void __iomem,
    pub base1: *mut void __iomem,
    pub groups: *const cygnus_pin_group,
    pub num_groups: unsigned,
    pub functions: *const cygnus_pin_function,
    pub num_functions: unsigned,
    pub mux_log: *mut cygnus_mux_log,
    pub lock: spinlock_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cygnus_pin {
    pub pin: unsigned,
    pub name: *mut c_char,
    pub gpio_mux: cygnus_gpio_mux,
}
...
#[no_mangle]
unsafe extern "C" fn cygnus_get_groups_count(pctrl_dev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cygnus_get_functions_count(pctrl_dev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cygnus_mux_log_init(pinctrl: *mut cygnus_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cygnus_pinmux_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cygnus_pinmux_init() -> int __init {
