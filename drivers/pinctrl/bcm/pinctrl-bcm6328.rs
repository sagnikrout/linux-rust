...
//! Source: drivers/pinctrl/bcm/pinctrl-bcm6328.c
#![no_std]
...
pub const BCM6328_NUM_GPIOS: c_int = 32;
pub const BCM6328_MODE_REG: c_uint = 0x18;
pub const BCM6328_MUX_HI_REG: c_uint = 0x1c;
pub const BCM6328_MUX_LO_REG: c_uint = 0x20;
pub const BCM6328_MUX_OTHER_REG: c_uint = 0x24;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm6328_function {
...
#[no_mangle]
pub unsafe extern "C" fn bcm6328_mux_off(pin: c_uint) -> c_uint {
    static inline unsigned int bcm6328_mux_off(unsigned int pin)
    {
    return bcm6328_mux[pin / 16];
    }
#[no_mangle]
unsafe extern "C" fn bcm6328_pinctrl_get_group_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm6328_pinctrl_get_func_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm6328_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int bcm6328_pinctrl_probe(struct platform_device *pdev)
    {
    return bcm63xx_pinctrl_probe(pdev, &bcm6328_soc, core::ptr::null_mut());
    }
