...
//! Source: drivers/pinctrl/bcm/pinctrl-bcm6318.c
#![no_std]
...
pub const BCM6318_NUM_GPIOS: c_int = 50;
pub const BCM6318_NUM_MUX: c_int = 48;
pub const BCM6318_MODE_REG: c_uint = 0x18;
pub const BCM6318_MUX_REG: c_uint = 0x1c;

pub const BCM6318_PAD_REG: c_uint = 0x54;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm6318_function {
    pub name: *const c_char,
    pub groups: *const *const c_char,
    pub num_groups: unsigned,
    pub mode_val:1: unsigned,
    pub mux_val:2: unsigned,
}
...
#[no_mangle]
pub unsafe extern "C" fn bcm6318_mux_off(pin: c_uint) -> c_uint {
    static inline unsigned int bcm6318_mux_off(unsigned int pin)
    {
    return BCM6318_MUX_REG + (pin / 16) * 4;
    }
#[no_mangle]
pub unsafe extern "C" fn bcm6318_pad_off(pin: c_uint) -> c_uint {
    static inline unsigned int bcm6318_pad_off(unsigned int pin)
    {
    return BCM6318_PAD_REG + (pin / 8) * 4;
    }
#[no_mangle]
unsafe extern "C" fn bcm6318_pinctrl_get_group_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm6318_pinctrl_get_func_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm6318_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int bcm6318_pinctrl_probe(struct platform_device *pdev)
    {
    return bcm63xx_pinctrl_probe(pdev, &bcm6318_soc, core::ptr::null_mut());
    }
