...
//! Source: drivers/pinctrl/sunxi/pinctrl-sun4i-a10.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun4i_a10_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    static int sun4i_a10_pinctrl_probe(struct platform_device *pdev)
    {
    let mut variant: c_ulong = (unsigned long)of_device_get_match_data(&pdev.dev);
