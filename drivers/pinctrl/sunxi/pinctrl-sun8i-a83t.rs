...
//! Source: drivers/pinctrl/sunxi/pinctrl-sun8i-a83t.c
#![no_std]
...
// Hole
    ...
    SUNXI_FUNCTION(0x4, "gmac")),	/* RGMII-core::ptr::null_mut() / MII-CRS */
...
#[no_mangle]
unsafe extern "C" fn sun8i_a83t_pinctrl_probe(pdev: *mut platform_device) -> c_int {
