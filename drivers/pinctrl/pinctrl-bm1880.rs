...
//! Source: drivers/pinctrl/pinctrl-bm1880.c
#![no_std]
...
pub const BM1880_REG_MUX: c_uint = 0x20;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bm1880_pinctrl {
    pub base: *mut void __iomem,
    pub pctrldev: *mut pinctrl_dev,
    pub groups: *const bm1880_pctrl_group,
    pub ngroups: c_uint,
    pub funcs: *const bm1880_pinmux_function,
    pub nfuncs: c_uint,
    pub pinconf: *const bm1880_pinconf_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bm1880_pinmux_function {
    pub name: *const c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bm1880_pinconf_data {
    pub drv_bits: u32,
}
...
#[no_mangle]
unsafe extern "C" fn bm1880_pctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// pinmux
#[no_mangle]
unsafe extern "C" fn bm1880_pmux_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = pctrl->funcs[selector].ngroups;
    ...
    let mut offset: u32 = (pin >> 1) << 2;
    let mut mux_offset: u32 = ((!((pin + 1) & 1) << 4) + 4);
...
#[no_mangle]
unsafe extern "C" fn bm1880_pinconf_drv_get(width: u32, drv: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1880_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm1880_pinctrl_init() -> int __init {
