...
//! Source: drivers/pinctrl/sunplus/sppctl_sp7021.c
#![no_std]
...
//
    ...
    let mut sppctl_gpio_list_sz: usize = ARRAY_SIZE(sppctl_gpio_list_s);
...
// gpio and iop only
    ...
    let mut sppctl_pins_all_sz: usize = ARRAY_SIZE(sppctl_pins_all);
    ...
    let mut sppctl_pmux_list_sz: usize = ARRAY_SIZE(sppctl_pmux_list_s);
...
// MOON1 register
    ...
    let mut sppctl_list_funcs_sz: usize = ARRAY_SIZE(sppctl_list_funcs);
