...
//! Source: drivers/pinctrl/pinctrl-keembay.c
#![no_std]
...
pub const KEEMBAY_GPIO_DATA_OUT: c_uint = 0x000;
pub const KEEMBAY_GPIO_DATA_IN: c_uint = 0x020;
pub const KEEMBAY_GPIO_DATA_IN_RAW: c_uint = 0x040;
pub const KEEMBAY_GPIO_DATA_HIGH: c_uint = 0x060;
pub const KEEMBAY_GPIO_DATA_LOW: c_uint = 0x080;
// GPIO Interrupt and mode registers' offsets
pub const KEEMBAY_GPIO_INT_CFG: c_uint = 0x000;
pub const KEEMBAY_GPIO_MODE: c_uint = 0x070;
// GPIO mode register bit fields

pub const KEEMBAY_GPIO_MODE_DEFAULT: c_uint = 0x7;
pub const KEEMBAY_GPIO_MODE_INV_VAL: c_uint = 0x3;
pub const KEEMBAY_GPIO_DISABLE: c_int = 0;
pub const KEEMBAY_GPIO_PULL_UP: c_int = 1;
pub const KEEMBAY_GPIO_PULL_DOWN: c_int = 2;
pub const KEEMBAY_GPIO_BUS_HOLD: c_int = 3;
pub const KEEMBAY_GPIO_NUM_IRQ: c_int = 8;
pub const KEEMBAY_GPIO_MAX_PER_IRQ: c_int = 4;
pub const KEEMBAY_GPIO_MAX_PER_REG: c_int = 32;
pub const KEEMBAY_GPIO_MIN_STRENGTH: c_int = 2;
pub const KEEMBAY_GPIO_MAX_STRENGTH: c_int = 12;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct keembay_gpio_irq {
    pub source: c_uint,
    pub line: c_uint,
    pub pins: [c_uint; KEEMBAY_GPIO_MAX_PER_IRQ],
    pub trigger: c_uint,
    pub num_share: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct keembay_pinctrl {
    pub pctrl: *mut pinctrl_dev,
    pub base0: *mut void __iomem,
    pub base1: *mut void __iomem,
    pub dev: *mut device,
    pub chip: gpio_chip,
    pub soc: *const keembay_pin_soc,
    pub lock: raw_spinlock_t,
    pub ngroups: c_uint,
    pub nfuncs: c_uint,
    pub npins: c_uint,
    pub irq: [keembay_gpio_irq; KEEMBAY_GPIO_NUM_IRQ],
    pub max_gpios_level_type: c_int,
    pub max_gpios_edge_type: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct keembay_pin_soc {
    pub pins: *const pinctrl_pin_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct keembay_pinfunction {
...
#[no_mangle]
pub unsafe extern "C" fn keembay_read_reg(base: *mut void __iomem, pin: c_uint) -> u32 {
    static inline u32 keembay_read_reg(void __iomem *base, unsigned int pin)
    {
    return readl(base + KEEMBAY_GPIO_REG_OFFSET(pin));
    }
#[no_mangle]
pub unsafe extern "C" fn keembay_read_gpio_reg(base: *mut void __iomem, pin: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn keembay_read_pin(base: *mut void __iomem, pin: c_uint) -> u32 {
    static inline u32 keembay_read_pin(void __iomem *base, unsigned int pin)
    {
    let mut val: u32 = keembay_read_gpio_reg(base, pin);
    return !!(val & BIT(pin % KEEMBAY_GPIO_MAX_PER_REG));
    }
#[no_mangle]
pub unsafe extern "C" fn keembay_write_reg(val: u32, base: *mut void __iomem, pin: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn keembay_write_gpio_reg(val: u32, base: *mut void __iomem, pin: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_invert(kpc: *mut keembay_pinctrl, pin: c_uint) {
    static void keembay_gpio_invert(struct keembay_pinctrl *kpc, unsigned int pin)
    {
    let mut val: c_uint = keembay_read_reg(kpc.base1 + KEEMBAY_GPIO_MODE, pin);
//
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_restore_default(kpc: *mut keembay_pinctrl, pin: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn keembay_pinconf_get_pull(kpc: *mut keembay_pinctrl, pin: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn keembay_pinconf_get_drive(kpc: *mut keembay_pinctrl, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_pinconf_get_slew_rate(kpc: *mut keembay_pinctrl, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_pinconf_get_schmitt(kpc: *mut keembay_pinctrl, pin: c_uint) -> c_int {
    ...
    {
    struct keembay_pinctrl *kpc = pinctrl_dev_get_drvdata(pctldev);
    let mut param: c_uint = pinconf_to_config_param(*cfg);
    unsigned int val;
    if (pin >= kpc.npins)
    return -EINVAL;
    switch (param) {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_get(gc: *mut gpio_chip, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_set(gc: *mut gpio_chip, pin: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_get_direction(gc: *mut gpio_chip, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_set_direction_in(gc: *mut gpio_chip, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_irq_handler(desc: *mut irq_desc) {
    static void keembay_gpio_irq_handler(struct irq_desc *desc)
    {
    struct gpio_chip *gc = irq_desc_get_handler_data(desc);
    let mut kmb_irq: c_uint = irq_desc_get_irq(desc);
...
// Checks if the interrupt is enabled
    ...
    struct keembay_pinctrl *kpc = gpiochip_get_data(gc);
    let mut trig: c_ulong = irqd_get_trigger_type(data);
...
#[no_mangle]
pub unsafe extern "C" fn if(IRQ_TYPE_EDGE_RISING: irq->trigger ==) -> else {
    else if (irq.trigger == IRQ_TYPE_EDGE_RISING)
    kpc.max_gpios_edge_type++;
    }
#[no_mangle]
unsafe extern "C" fn keembay_find_free_slot(kpc: *mut keembay_pinctrl, src: c_uint) -> c_int {
    static int keembay_find_free_slot(struct keembay_pinctrl *kpc, unsigned int src)
    {
    let mut val: c_ulong = keembay_read_reg(kpc.base1 + KEEMBAY_GPIO_INT_CFG, src);
    return bitmap_find_free_region(&val, KEEMBAY_GPIO_MAX_PER_REG, 3) / KEEMBAY_GPIO_NUM_IRQ;
    }
#[no_mangle]
unsafe extern "C" fn keembay_find_free_src(kpc: *mut keembay_pinctrl, trig: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IRQ_TYPE_EDGE_BOTH: trig &) -> else {
    ...
    {
    let mut val: c_ulong = pin | KEEMBAY_GPIO_IRQ_ENABLE;
    struct keembay_gpio_irq *irq = &kpc.irq[src];
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_irq_enable(data: *mut irq_data) {
    static void keembay_gpio_irq_enable(struct irq_data *data)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(data);
    struct keembay_pinctrl *kpc = gpiochip_get_data(gc);
    let mut trig: c_uint = irqd_get_trigger_type(data);
    let mut pin: irq_hw_number_t = irqd_to_hwirq(data);
    int src, slot;
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_irq_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_gpio_add_pin_ranges(chip: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_build_groups(kpc: *mut keembay_pinctrl) -> c_int {
...
// Each pin is categorised as one group
    ...
    kmb_grp.pins, 1, core::ptr::null_mut());
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn keembay_pinctrl_reg(kpc: *mut keembay_pinctrl, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_build_functions(kpc: *mut keembay_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keembay_pinctrl_probe(pdev: *mut platform_device) -> c_int {
