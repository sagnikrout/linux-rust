...
//! Source: drivers/pinctrl/pinctrl-zynqmp.c
#![no_std]
...
pub const PINCTRL_GET_FUNC_NAME_RESP_LEN: c_int = 16;
pub const MAX_FUNC_NAME_LEN: c_int = 16;
pub const MAX_GROUP_PIN: c_int = 50;
pub const MAX_PIN_GROUPS: c_int = 50;

pub const NUM_GROUPS_PER_RESP: c_int = 6;
pub const PINCTRL_GET_FUNC_GROUPS_RESP_LEN: c_int = 12;
pub const PINCTRL_GET_PIN_GROUPS_RESP_LEN: c_int = 12;
pub const NA_GROUP: c_uint = 0xFFFF;
pub const RESERVED_GROUP: c_uint = 0xFFFE;
pub const DRIVE_STRENGTH_2MA: c_int = 2;
pub const DRIVE_STRENGTH_4MA: c_int = 4;
pub const DRIVE_STRENGTH_8MA: c_int = 8;
pub const DRIVE_STRENGTH_12MA: c_int = 12;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_pmux_function {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_pinctrl {
    pub pctrl: *mut pinctrl_dev,
    pub groups: *const zynqmp_pctrl_group,
    pub ngroups: c_uint,
    pub funcs: *const zynqmp_pmux_function,
    pub nfuncs: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_pctrl_group {
    pub name: *const c_char,
    pub pins: [c_uint; MAX_GROUP_PIN],
    pub npins: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pmux_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pinctrl_get_function_groups(fid: u32, index: u32, groups: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pinctrl_get_func_num_groups(fid: u32, ngroups: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pinctrl_get_function_name(fid: u32, name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pinctrl_get_num_functions(nfuncs: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pinctrl_get_pin_groups(pin: u32, index: u32, groups: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pinctrl_get_num_pins(npins: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn versal_pinctrl_get_attributes(pin_idx: u32, response: *mut u32) -> c_int {
    ...
    unsigned int *npins)
    {
    let mut lpd_mio_pins: u32 = 0, attr, nodetype;
    struct pinctrl_pin_desc *pins, *pin;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn zynqmp_pinctrl_probe(pdev: *mut platform_device) -> c_int {
