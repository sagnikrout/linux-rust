...
//! Source: drivers/pinctrl/pinctrl-cy8c95x0.c
#![no_std]
...
pub const CY8C95X0_INPUT: c_uint = 0x00;
pub const CY8C95X0_OUTPUT: c_uint = 0x08;
pub const CY8C95X0_INTSTATUS: c_uint = 0x10;

// Port Select configures the port
pub const CY8C95X0_PORTSEL: c_uint = 0x18;
// Port settings, write PORTSEL first
pub const CY8C95X0_INTMASK: c_uint = 0x19;
pub const CY8C95X0_SELPWM: c_uint = 0x1A;
pub const CY8C95X0_INVERT: c_uint = 0x1B;
pub const CY8C95X0_DIRECTION: c_uint = 0x1C;
// Drive mode register change state on writing '1'
pub const CY8C95X0_DRV_PU: c_uint = 0x1D;
pub const CY8C95X0_DRV_PD: c_uint = 0x1E;
pub const CY8C95X0_DRV_ODH: c_uint = 0x1F;
pub const CY8C95X0_DRV_ODL: c_uint = 0x20;
pub const CY8C95X0_DRV_PP_FAST: c_uint = 0x21;
pub const CY8C95X0_DRV_PP_SLOW: c_uint = 0x22;
pub const CY8C95X0_DRV_HIZ: c_uint = 0x23;
// Internal device configuration
pub const CY8C95X0_ENABLE_WDE: c_uint = 0x2D;
pub const CY8C95X0_DEVID: c_uint = 0x2E;
pub const CY8C95X0_WATCHDOG: c_uint = 0x2F;
pub const CY8C95X0_COMMAND: c_uint = 0x30;

pub const MAX_BANK: c_int = 8;
pub const BANK_SZ: c_int = 8;

pub const MUXED_STRIDE: c_int = 16;

pub const CY8C95X0_VIRTUAL: c_uint = 0x40;

    (CY8C95X0_VIRTUAL + (x) - CY8C95X0_PORTSEL + (p) * MUXED_STRIDE)
    let mut cy8c95x0_irq_gpios: static struct acpi_gpio_params = { 0, 0, true };
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_acpi_get_irq(dev: *mut device) -> c_int {
...
pub struct cy8c95x0_pinctrl {
    ...
    pub MAX_LINE): DECLARE_BITMAP(irq_trig_low,,
    pub MAX_LINE): DECLARE_BITMAP(irq_trig_high,,
    pub MAX_LINE): DECLARE_BITMAP(push_pull,,
    pub MAX_LINE): DECLARE_BITMAP(map,,
    pub nport: c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn cypress_get_port(chip: *mut cy8c95x0_pinctrl, pin: c_uint) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn cypress_get_pin_mask(chip: *mut cy8c95x0_pinctrl, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_writeable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_precious_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_muxed_register(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_wc_register(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_quick_path_register(reg: c_uint) -> bool {
    ...
    .ranges	= core::ptr::null_mut(),			/* Updated at runtime */
    .num_ranges = 1,
...
//
    ...
    {
    return cy8c95x0_regmap_update_bits_base(chip, reg, port, mask, val, core::ptr::null_mut(), false, true);
    }
//
...
//
    ...
    unsigned int port, unsigned int mask, unsigned int val)
    {
    return cy8c95x0_regmap_update_bits_base(chip, reg, port, mask, val, core::ptr::null_mut(), false, false);
    }
//
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_pinmux_direction(chip: *mut cy8c95x0_pinctrl, pin: c_uint, input: bool) -> c_int {
    static int cy8c95x0_pinmux_direction(struct cy8c95x0_pinctrl *chip, unsigned int pin, bool input)
    {
    let mut port: u8 = cypress_get_port(chip, pin);
    let mut bit: u8 = cypress_get_pin_mask(chip, pin);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_gpio_direction_input(gc: *mut gpio_chip, off: c_uint) -> c_int {
    ...
    let mut port: u8 = cypress_get_port(chip, off);
    let mut bit: u8 = cypress_get_pin_mask(chip, off);
    int ret;
// Set output level
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_gpio_get_value(gc: *mut gpio_chip, off: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_gpio_get_direction(gc: *mut gpio_chip, off: c_uint) -> c_int {
...
// config = pinconf_to_config_packed(param, arg);
    ...
    let mut arg: c_ulong = pinconf_to_config_argument(config);
    unsigned int reg;
    switch (param) {
    case PIN_CONFIG_BIAS_PULL_UP:
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_add_pin_ranges(gc: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_setup_gpiochip(chip: *mut cy8c95x0_pinctrl) -> c_int {
    ...
    gc.names = core::ptr::null_mut();
    gc.label = dev_name(chip.dev);
    return devm_gpiochip_add_data(chip.dev, gc, chip);
    }
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_bus_sync_unlock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_shutdown(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_pending(chip: *mut cy8c95x0_pinctrl, pending: *mut c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(level, _arg: chip->irq_trig_high)) -> else {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_set_mode(chip: *mut cy8c95x0_pinctrl, off: c_uint, mode: bool) -> c_int {
    ...
    {
    let mut port: u8 = cypress_get_port(chip, group);
    let mut bit: u8 = cypress_get_pin_mask(chip, group);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_irq_setup(chip: *mut cy8c95x0_pinctrl, irq: c_int) -> c_int {
...
// This will let us handle the parent IRQ in the driver
    ...
    girq.threaded = true;
    return devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), cy8c95x0_irq_handler,
    IRQF_ONESHOT | IRQF_SHARED,
    dev_name(chip.dev), chip);
    }
#[no_mangle]
unsafe extern "C" fn cy8c95x0_setup_pinctrl(chip: *mut cy8c95x0_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8c95x0_probe(client: *mut i2c_client) -> c_int {
