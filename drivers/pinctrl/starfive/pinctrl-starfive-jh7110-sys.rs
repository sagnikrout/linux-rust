...
//! Source: drivers/pinctrl/starfive/pinctrl-starfive-jh7110-sys.c
#![no_std]
...
pub const JH7110_SYS_NGPIO: c_int = 64;
pub const JH7110_SYS_REGS_NUM: c_int = 174;
// registers
pub const JH7110_SYS_DOEN: c_uint = 0x000;
pub const JH7110_SYS_DOUT: c_uint = 0x040;
pub const JH7110_SYS_GPI: c_uint = 0x080;
pub const JH7110_SYS_GPIOIN: c_uint = 0x118;
pub const JH7110_SYS_GPIOEN: c_uint = 0x0dc;
pub const JH7110_SYS_GPIOIS0: c_uint = 0x0e0;
pub const JH7110_SYS_GPIOIS1: c_uint = 0x0e4;
pub const JH7110_SYS_GPIOIC0: c_uint = 0x0e8;
pub const JH7110_SYS_GPIOIC1: c_uint = 0x0ec;
pub const JH7110_SYS_GPIOIBE0: c_uint = 0x0f0;
pub const JH7110_SYS_GPIOIBE1: c_uint = 0x0f4;
pub const JH7110_SYS_GPIOIEV0: c_uint = 0x0f8;
pub const JH7110_SYS_GPIOIEV1: c_uint = 0x0fc;
pub const JH7110_SYS_GPIOIE0: c_uint = 0x100;
pub const JH7110_SYS_GPIOIE1: c_uint = 0x104;
pub const JH7110_SYS_GPIORIS0: c_uint = 0x108;
pub const JH7110_SYS_GPIORIS1: c_uint = 0x10c;
pub const JH7110_SYS_GPIOMIS0: c_uint = 0x110;
pub const JH7110_SYS_GPIOMIS1: c_uint = 0x114;
pub const JH7110_SYS_GPO_PDA_0_74_CFG: c_uint = 0x120;
pub const JH7110_SYS_GPO_PDA_89_94_CFG: c_uint = 0x284;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct jh7110_vin_group_sel {
    pub offset: u16,
    pub shift: u8,
    pub group: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(PAD_QSPI_DATA3: pin > PAD_GMAC1_TXC && pin <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn jh7110_sys_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn jh7110_sys_init_hw(gc: *mut gpio_chip) -> c_int {
