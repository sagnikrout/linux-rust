...
//! Source: drivers/pinctrl/starfive/pinctrl-starfive-jh7100.c
#![no_std]
...
// single edge.
//
pub const GPIOIBE: c_uint = 0x018;
//
...
// (level-triggered).
//
pub const GPIOIEV: c_uint = 0x020;
//
...
//
pub const GPON_DOUT_CFG: c_uint = 0x050;
pub const GPON_DOEN_CFG: c_uint = 0x054;
//
...
//
pub const GPI_CFG_OFFSET: c_uint = 0x250;
//
...
pub const PAD_SLEW_RATE_POS: c_int = 9;

    (PAD_BIAS_STRONG_PULL_UP | \
    PAD_BIAS_DISABLE | \
    PAD_BIAS_PULL_DOWN)

pub const PAD_DRIVE_STRENGTH_POS: c_int = 0;
//
...
//
pub const IO_PADSHARE_SEL: c_uint = 0x1a0;
//
...
//
pub const PAD_INVALID_GPIO: c_uint = 0x10000;
//
...
//
#[no_mangle]
unsafe extern "C" fn starfive_pinmux_to_gpio(v: u32) -> c_uint {
    static unsigned int starfive_pinmux_to_gpio(u32 v)
    {
    return v & (NR_GPIOS - 1);
    }
#[no_mangle]
unsafe extern "C" fn starfive_pinmux_to_dout(v: u32) -> u32 {
    static u32 starfive_pinmux_to_dout(u32 v)
    {
    return ((v & BIT(7)) << (31 - 7)) | ((v >> 24) & GENMASK(7, 0));
    }
#[no_mangle]
unsafe extern "C" fn starfive_pinmux_to_doen(v: u32) -> u32 {
    static u32 starfive_pinmux_to_doen(u32 v)
    {
    return ((v & BIT(6)) << (31 - 6)) | ((v >> 16) & GENMASK(7, 0));
    }
#[no_mangle]
unsafe extern "C" fn starfive_pinmux_to_din(v: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn starfive_drive_strength_to_max_mA(ds: u16) -> u32 {
    static u32 starfive_drive_strength_to_max_mA(u16 ds)
    {
    return 7 * ds + 14;
    }
#[no_mangle]
unsafe extern "C" fn starfive_drive_strength_from_max_mA(i: u32) -> u16 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct starfive_pinctrl {
    pub gc: gpio_chip,
    pub gpios: pinctrl_gpio_range,
    pub lock: raw_spinlock_t,
    pub base: *mut void __iomem,
    pub padctl: *mut void __iomem,
    ...
    let mut gpio: c_uint = starfive_pin_to_gpio(sfp, pin);
    void __iomem *reg;
    u32 dout, doen;
    if (gpio >= NR_GPIOS)
    return;
    ...
    let mut npinmux: c_int = of_property_count_u32_elems(child, "pinmux");
    let mut npins: c_int = of_property_count_u32_elems(child, "pins");
    ...
    goto free_map;
    for (i = 0; i < npins; i++) {
    let mut gpio: c_uint = starfive_pinmux_to_gpio(pinmux[i]);
...
// don't create a map if there are no pinconf settings
    ...
    ret = pinmux_generic_add_function(pctldev, np.name, pgnames, ngroups, core::ptr::null_mut());
    if (ret < 0) {
...
// num_maps = nmaps;
    ...
    let mut v: u32 = pinmux[i];
    let mut gpio: c_uint = starfive_pinmux_to_gpio(v);
    let mut dout: u32 = starfive_pinmux_to_dout(v);
    let mut doen: u32 = starfive_pinmux_to_doen(v);
    let mut din: u32 = starfive_pinmux_to_din(v);
    ...
    void __iomem *reg = sfp.padctl + 4 * (pin / 2);
    let mut shift: c_int = 16 * (pin % 2);
    let mut mask: u32 = (u32)_mask << shift;
    let mut value: u32 = (u32)_value << shift;
    unsigned long flags;
    ...
    PCONFDUMP(PIN_CONFIG_STARFIVE_STRONG_PULL_UP, "input bias strong pull-up", core::ptr::null_mut(), false),
    };
    ...
    let mut value: u16 = starfive_padctl_get(sfp, pin);
    bool enabled;
    u32 arg;
    switch (param) {
...
// config = pinconf_to_config_packed(param, arg);
    ...
    let mut param: c_int = pinconf_to_config_param(configs[i]);
...
#[no_mangle]
unsafe extern "C" fn starfive_gpio_get_direction(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_gpio_get(gc: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_gpio_add_pin_ranges(gc: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn starfive_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn starfive_irq_mask_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn starfive_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn starfive_irq_set_type(d: *mut irq_data, trigger: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_gpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn starfive_gpio_init_hw(gc: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_disable_clock(data: *mut c_void) {
    static void starfive_disable_clock(void *data)
    {
    clk_disable_unprepare(data);
    }
#[no_mangle]
unsafe extern "C" fn starfive_probe(pdev: *mut platform_device) -> c_int {
