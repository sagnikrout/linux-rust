...
//! Source: drivers/pinctrl/cirrus/pinctrl-lochnagar.c
#![no_std]
...
pub const LN2_NUM_GPIO_CHANNELS: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lochnagar_pin {
    pub name: [c_char; 20],
    pub type: enum lochnagar_pin_type,
    pub reg: c_uint,
    pub shift: c_int,
    pub invert: bool,
}
...
pub const LN2_OP_AIF: c_uint = 0x00;
pub const LN2_OP_GPIO: c_uint = 0xFE;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lochnagar_func {
    pub name: *const *const c_char,
    pub type: enum lochnagar_func_type,
    pub op: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lochnagar_func_groups {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lochnagar_pin_priv {
    pub lochnagar: *mut lochnagar,
    pub dev: *mut device,
    pub funcs: *const lochnagar_func,
    pub nfuncs: c_uint,
    pub pins: *const pinctrl_pin_desc,
    pub npins: c_uint,
    pub groups: *const lochnagar_group,
    pub ngroups: c_uint,
    pub func_groups: [lochnagar_func_groups; LN_FTYPE_COUNT],
    pub gpio_chip: gpio_chip,
}

#[no_mangle]
unsafe extern "C" fn lochnagar_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lochnagar_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// The GPIOs only support output
    ...
    let mut param: c_uint = pinconf_to_config_param(*configs);
    switch (param) {
...
#[no_mangle]
unsafe extern "C" fn lochnagar_fill_func_groups(priv: *mut lochnagar_pin_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lochnagar_pin_probe(pdev: *mut platform_device) -> c_int {
