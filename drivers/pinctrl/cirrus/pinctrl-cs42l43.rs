...
//! Source: drivers/pinctrl/cirrus/pinctrl-cs42l43.c
#![no_std]
...
pub const CS42L43_NUM_GPIOS: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs42l43_pin {
    pub gpio_chip: gpio_chip,
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub shutters_locked: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs42l43_pin_data {
    pub reg: c_uint,
    pub shift: c_uint,
    pub mask: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn cs42l43_pin_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_pin_get_func_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = cs42l43_pin_func_groups[func_idx].ngroups;
    ...
    {
    struct cs42l43_pin *priv = pinctrl_dev_get_drvdata(pctldev);
    let mut shift: c_uint = offset + CS42L43_GPIO1_DIR_SHIFT;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cs42l43_pin_get_drv_str(priv: *mut cs42l43_pin, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_pin_get_db(priv: *mut cs42l43_pin, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    {
    struct cs42l43_pin *priv = gpiochip_get_data(chip);
    let mut shift: c_uint = offset + CS42L43_GPIO1_LVL_SHIFT;
    int ret;
    dev_dbg(priv.dev, "Setting gpio%d to %s\n",
...
#[no_mangle]
unsafe extern "C" fn cs42l43_gpio_add_pin_ranges(chip: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_fwnode_put(data: *mut c_void) {
    static void cs42l43_fwnode_put(void *data)
    {
    fwnode_handle_put(data);
    }
#[no_mangle]
unsafe extern "C" fn cs42l43_pin_probe(pdev: *mut platform_device) -> c_int {
