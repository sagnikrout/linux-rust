...
//! Source: drivers/pinctrl/pinctrl-aw9523.c
#![no_std]
...
pub const AW9523_MAX_FUNCS: c_int = 2;
pub const AW9523_NUM_PORTS: c_int = 2;
pub const AW9523_PINS_PER_PORT: c_int = 8;
//
...
//
pub const AW9523_HW_RESET_US: c_int = 50;
pub const AW9523_HW_RESET_RECOVERY_US: c_int = 20;
// Port 0: P0_0...P0_7 - Port 1: P1_0...P1_7

pub const AW9523_REG_CHIPID: c_uint = 0x10;
pub const AW9523_VAL_EXPECTED_CHIPID: c_uint = 0x23;
pub const AW9523_REG_GCR: c_uint = 0x11;

pub const AW9523_REG_SOFT_RESET: c_uint = 0x7f;
pub const AW9523_VAL_RESET: c_uint = 0x00;
//
...
#[no_mangle]
unsafe extern "C" fn aw9523_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_pmx_get_funcs_count(pctl: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_pcfg_param_to_reg(pcp: enum pin_config_param, pin: c_int, r: *mut u8) -> c_int {
...
// r = reg;
    ...
    let mut regbit: c_int = pin % AW9523_PINS_PER_PORT;
    unsigned int val;
    u8 reg;
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn aw9523_get_pin_direction(regmap: *mut regmap, pin: u8, n: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_gpio_irq_type(d: *mut irq_data, type: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aw9523_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn aw9523_irq_thread_func(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn aw9523_irq_bus_lock(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn aw9523_irq_bus_sync_unlock(d: *mut irq_data) {
    ...
    let mut regbit: u8 = offset % AW9523_PINS_PER_PORT;
    int ret;
    mutex_lock(&awi.i2c_lock);
...
#[no_mangle]
unsafe extern "C" fn aw9523_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_direction_input(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_drive_reset_gpio(awi: *mut aw9523) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_hw_reset(awi: *mut aw9523) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_init_gpiochip(awi: *mut aw9523, npins: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_init_irq(awi: *mut aw9523, irq: c_int) -> c_int {
    ...
    ret = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), aw9523_irq_thread_func,
...
#[no_mangle]
unsafe extern "C" fn aw9523_is_reg_hole(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aw9523_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aw9523_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aw9523_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool aw9523_writeable_reg(struct device *dev, unsigned int reg)
    {
    return !aw9523_is_reg_hole(reg) && reg != AW9523_REG_CHIPID;
    }
#[no_mangle]
unsafe extern "C" fn aw9523_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aw9523_hw_init(awi: *mut aw9523) -> c_int {
    static int aw9523_hw_init(struct aw9523 *awi)
    {
    let mut p1_pin: u8 = AW9523_PINS_PER_PORT;
    unsigned int val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn aw9523_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw9523_remove(client: *mut i2c_client) {
