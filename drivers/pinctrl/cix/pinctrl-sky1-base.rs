...
//! Source: drivers/pinctrl/cix/pinctrl-sky1-base.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sky1_pctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sky1_pmx_get_funcs_cnt(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sky1_ds_to_index(driving: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sky1_pctrl_build_state(pdev: *mut platform_device) -> c_int {
