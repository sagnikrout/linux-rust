...
//! Source: drivers/pinctrl/pinctrl-zynq.c
#![no_std]
...
pub const ZYNQ_NUM_MIOS: c_int = 54;
pub const ZYNQ_PCTRL_MIO_MST_TRI0: c_uint = 0x10c;
pub const ZYNQ_PCTRL_MIO_MST_TRI1: c_uint = 0x110;
pub const ZYNQ_PINMUX_MUX_SHIFT: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynq_pinctrl {
    pub pctrl: *mut pinctrl_dev,
    pub syscon: *mut regmap,
    pub pctrl_offset: u32,
    pub groups: *const zynq_pctrl_group,
    pub ngroups: c_uint,
    pub funcs: *const zynq_pinmux_function,
    pub nfuncs: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynq_pctrl_group {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynq_pinmux_function {
    pub name: *const c_char,
...
pub const ZYNQ_SDIO_WP_SHIFT: c_int = 0;

pub const ZYNQ_SDIO_CD_SHIFT: c_int = 16;
...
// pinctrl
#[no_mangle]
unsafe extern "C" fn zynq_pctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// pinmux
#[no_mangle]
unsafe extern "C" fn zynq_pmux_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
//
    ...
    let mut pin: c_uint = pgrp.pins[i];
...
pub const ZYNQ_PINCONF_IOTYPE_SHIFT: c_int = 9;
...
//
    ...
    = { PCONFDUMP(PIN_CONFIG_IOSTANDARD, "IO-standard", core::ptr::null_mut(), true),
    };

#[no_mangle]
unsafe extern "C" fn zynq_pinconf_iostd_get(reg: u32) -> c_uint {
    ...
    {
    let mut iostd: enum zynq_io_standards = zynq_pinconf_iostd_get(reg);
...
// config = pinconf_to_config_packed(param, arg);
    ...
    int i, ret;
    u32 reg;
    let mut pullup: u32 = 0;
    let mut tristate: u32 = 0;
    struct zynq_pinctrl *pctrl = pinctrl_dev_get_drvdata(pctldev);
    if (pin >= ZYNQ_NUM_MIOS)
    return -ENOTSUPP;
    ret = regmap_read(pctrl.syscon, pctrl.pctrl_offset + (4 * pin), &reg);
...
#[no_mangle]
unsafe extern "C" fn zynq_pinctrl_probe(pdev: *mut platform_device) -> c_int {
