...
//! Source: drivers/pinctrl/pinctrl-palmas.c
#![no_std]
...
pub const PALMAS_PIN_GPIO0_ID: c_int = 0;
pub const PALMAS_PIN_GPIO1_VBUS_LED1_PWM1: c_int = 1;
pub const PALMAS_PIN_GPIO2_REGEN_LED2_PWM2: c_int = 2;
pub const PALMAS_PIN_GPIO3_CHRG_DET: c_int = 3;
pub const PALMAS_PIN_GPIO4_SYSEN1: c_int = 4;
pub const PALMAS_PIN_GPIO5_CLK32KGAUDIO_USB_PSEL: c_int = 5;
pub const PALMAS_PIN_GPIO6_SYSEN2: c_int = 6;
pub const PALMAS_PIN_GPIO7_MSECURE_PWRHOLD: c_int = 7;
pub const PALMAS_PIN_GPIO8_SIM1RSTI: c_int = 8;
pub const PALMAS_PIN_GPIO9_LOW_VBAT: c_int = 9;
pub const PALMAS_PIN_GPIO10_WIRELESS_CHRG1: c_int = 10;
pub const PALMAS_PIN_GPIO11_RCM: c_int = 11;
pub const PALMAS_PIN_GPIO12_SIM2RSTO: c_int = 12;
pub const PALMAS_PIN_GPIO13: c_int = 13;
pub const PALMAS_PIN_GPIO14: c_int = 14;
pub const PALMAS_PIN_GPIO15_SIM2RSTI: c_int = 15;
pub const PALMAS_PIN_VAC: c_int = 16;
pub const PALMAS_PIN_POWERGOOD_USB_PSEL: c_int = 17;
pub const PALMAS_PIN_NRESWARM: c_int = 18;
pub const PALMAS_PIN_PWRDOWN: c_int = 19;
pub const PALMAS_PIN_GPADC_START: c_int = 20;
pub const PALMAS_PIN_RESET_IN: c_int = 21;
pub const PALMAS_PIN_NSLEEP: c_int = 22;
pub const PALMAS_PIN_ENABLE1: c_int = 23;
pub const PALMAS_PIN_ENABLE2: c_int = 24;
pub const PALMAS_PIN_INT: c_int = 25;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pin_function {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pctrl_chip_info {
    pub dev: *mut device,
    pub pctl: *mut pinctrl_dev,
    pub palmas: *mut palmas,
    pub pins_current_opt: [c_int; PALMAS_PIN_NUM],
    pub functions: *const palmas_pin_function,
    pub num_functions: unsigned,
    pub pin_groups: *const palmas_pingroup,
    pub num_pin_groups: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pins_pullup_dn_info {
    pub pullup_dn_reg_base: c_int,
    pub pullup_dn_reg_add: c_int,
    pub pullup_dn_mask: c_int,
    pub normal_val: c_int,
    pub pull_up_val: c_int,
    pub pull_dn_val: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pins_od_info {
    pub od_reg_base: c_int,
    pub od_reg_add: c_int,
    pub od_mask: c_int,
    pub od_enable: c_int,
    pub od_disable: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pin_info {
    pub mux_opt: enum palmas_pinmux,
    pub pud_info: *const palmas_pins_pullup_dn_info,
    pub od_info: *const palmas_pins_od_info,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pingroup {
    pub name: *const c_char,
    pub pins: [unsigned; 1],
    pub npins: unsigned,
    pub mux_reg_base: unsigned,
    pub mux_reg_add: unsigned,
    pub mux_reg_mask: unsigned,
    pub mux_bit_shift: unsigned,
    pub opt: [*const palmas_pin_info; 4],
}
    ...
    PIN_INFO(gpio0,		GPIO,		&pud_gpio0_info,	core::ptr::null_mut());
    PIN_INFO(gpio1,		GPIO,		&pud_gpio1_info,	&od_gpio1_info);
    PIN_INFO(gpio2,		GPIO,		&pud_gpio2_info,	&od_gpio2_info);
    PIN_INFO(gpio3,		GPIO,		&pud_gpio3_info,	core::ptr::null_mut());
    PIN_INFO(gpio4,		GPIO,		&pud_gpio4_info,	core::ptr::null_mut());
    PIN_INFO(gpio5,		GPIO,		&pud_gpio5_info,	&od_gpio5_info);
    PIN_INFO(gpio6,		GPIO,		&pud_gpio6_info,	core::ptr::null_mut());
    PIN_INFO(gpio7,		GPIO,		&pud_gpio7_info,	core::ptr::null_mut());
    PIN_INFO(gpio8,		GPIO,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(gpio9,		GPIO,		&pud_gpio9_info,	core::ptr::null_mut());
    PIN_INFO(gpio10,	GPIO,		&pud_gpio10_info,	&od_gpio10_info);
    PIN_INFO(gpio11,	GPIO,		&pud_gpio11_info,	core::ptr::null_mut());
    PIN_INFO(gpio12,	GPIO,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(gpio13,	GPIO,		&pud_gpio13_info,	&od_gpio13_info);
    PIN_INFO(gpio14,	GPIO,		&pud_gpio14_info,	core::ptr::null_mut());
    PIN_INFO(gpio15,	GPIO,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(id,		ID,		&pud_id_info,		core::ptr::null_mut());
    PIN_INFO(led1,		LED,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(led2,		LED,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(regen,		REGEN,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(sysen1,	SYSEN,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(sysen2,	SYSEN,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(int,		INT,		core::ptr::null_mut(),			&od_int_info);
    PIN_INFO(pwm1,		PWM,		core::ptr::null_mut(),			&od_pwm1_info);
    PIN_INFO(pwm2,		PWM,		core::ptr::null_mut(),			&od_pwm2_info);
    PIN_INFO(vacok,		VACOK,		&pud_vacok_info,	core::ptr::null_mut());
    PIN_INFO(chrg_det,	CHRG_DET,	&pud_chrg_det_info,	core::ptr::null_mut());
    PIN_INFO(pwrhold,	PWRHOLD,	&pud_pwrhold_info,	core::ptr::null_mut());
    PIN_INFO(msecure,	MSECURE,	&pud_msecure_info,	core::ptr::null_mut());
    PIN_INFO(nreswarm,	NA,		&pud_nreswarm_info,	core::ptr::null_mut());
    PIN_INFO(pwrdown,	NA,		&pud_pwrdown_info,	core::ptr::null_mut());
    PIN_INFO(gpadc_start,	NA,		&pud_gpadc_start_info,	core::ptr::null_mut());
    PIN_INFO(reset_in,	NA,		&pud_reset_in_info,	core::ptr::null_mut());
    PIN_INFO(nsleep,	NA,		&pud_nsleep_info,	core::ptr::null_mut());
    PIN_INFO(enable1,	NA,		&pud_enable1_info,	core::ptr::null_mut());
    PIN_INFO(enable2,	NA,		&pud_enable2_info,	core::ptr::null_mut());
    PIN_INFO(clk32kgaudio,	CLK32KGAUDIO,	core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(usb_psel,	USB_PSEL,	core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(vac,		VAC,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(powergood,	POWERGOOD,	core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(vbus_det,	VBUS_DET,	core::ptr::null_mut(),			&od_vbus_det_info);
    PIN_INFO(sim1rsti,	SIMRSTI,	core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(low_vbat,	LOW_VBAT,	core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(rcm,		RCM,		core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(sim2rsto,	SIMRSTO,	core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(sim2rsti,	SIMRSTI,	core::ptr::null_mut(),			core::ptr::null_mut());
    PIN_INFO(wireless_chrg1,	WIRELESS_CHRG1,	core::ptr::null_mut(),		core::ptr::null_mut());
pub const PALMAS_PRIMARY_SECONDARY_NONE: c_int = 0;
pub const PALMAS_NONE_BASE: c_int = 0;
    ...
    PALMAS_PINGROUP(gpio0,	GPIO0_ID,			PU_PD_OD,	PAD1,	0x4,	0x2,	&pin_gpio0_info,	&pin_id_info,		core::ptr::null_mut(),		core::ptr::null_mut()),
    ...
    PALMAS_PINGROUP(gpio3,	GPIO3_CHRG_DET,			PU_PD_OD,	PAD1,	0x80,	0x7,	&pin_gpio3_info,	&pin_chrg_det_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio4,	GPIO4_SYSEN1,			PU_PD_OD,	PAD1,	0x01,	0x0,	&pin_gpio4_info,	&pin_sysen1_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio5,	GPIO5_CLK32KGAUDIO_USB_PSEL,	PU_PD_OD,	PAD2,	0x6,	0x1,	&pin_gpio5_info,	&pin_clk32kgaudio_info,	&pin_usb_psel_info,	core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio6,	GPIO6_SYSEN2,			PU_PD_OD,	PAD2,	0x08,	0x3,	&pin_gpio6_info,	&pin_sysen2_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio7,	GPIO7_MSECURE_PWRHOLD,		PU_PD_OD,	PAD2,	0x30,	0x4,	&pin_gpio7_info,	&pin_msecure_info,	&pin_pwrhold_info,	core::ptr::null_mut()),
    PALMAS_PINGROUP(vac,	VAC,				PU_PD_OD,	PAD1,	0x02,	0x1,	&pin_vac_info,		&pin_vacok_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(powergood,	POWERGOOD_USB_PSEL,	PU_PD_OD,	PAD1,	0x01,	0x0,	&pin_powergood_info,	&pin_usb_psel_info,	core::ptr::null_mut(),	core::ptr::null_mut()),
    PALMAS_PINGROUP(nreswarm,	NRESWARM,		NONE,		NONE,	0x0,	0x0,	&pin_nreswarm_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(pwrdown,	PWRDOWN,		NONE,		NONE,	0x0,	0x0,	&pin_pwrdown_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpadc_start,	GPADC_START,		NONE,		NONE,	0x0,	0x0,	&pin_gpadc_start_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(reset_in,	RESET_IN,		NONE,		NONE,	0x0,	0x0,	&pin_reset_in_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(nsleep,		NSLEEP,			NONE,		NONE,	0x0,	0x0,	&pin_nsleep_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(enable1,	ENABLE1,		NONE,		NONE,	0x0,	0x0,	&pin_enable1_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(enable2,	ENABLE2,		NONE,		NONE,	0x0,	0x0,	&pin_enable2_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(int,		INT,			NONE,		NONE,	0x0,	0x0,	&pin_int_info,		core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    };
    ...
    PALMAS_PINGROUP(gpio6,	GPIO6_SYSEN2,			PU_PD_OD,	PAD2,	0x08,	0x3,	&pin_gpio6_info,	&pin_sysen2_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio7,	GPIO7_MSECURE_PWRHOLD,		PU_PD_OD,	PAD2,	0x30,	0x4,	&pin_gpio7_info,	&pin_msecure_info,	&pin_pwrhold_info,	core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio8,	GPIO8_SIM1RSTI,			PU_PD_OD,	PAD4,	0x01,	0x0,	&pin_gpio8_info,	&pin_sim1rsti_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio9,	GPIO9_LOW_VBAT,			PU_PD_OD,	PAD4,	0x02,	0x1,	&pin_gpio9_info,	&pin_low_vbat_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio10,	GPIO10_WIRELESS_CHRG1,		PU_PD_OD,	PAD4,	0x04,	0x2,	&pin_gpio10_info,	&pin_wireless_chrg1_info,	core::ptr::null_mut(),	core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio11,	GPIO11_RCM,			PU_PD_OD,	PAD4,	0x08,	0x3,	&pin_gpio11_info,	&pin_rcm_info,		core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio12,	GPIO12_SIM2RSTO,		PU_PD_OD,	PAD4,	0x10,	0x4,	&pin_gpio12_info,	&pin_sim2rsto_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio13,	GPIO13,				NONE,		NONE,	0x00,	0x0,	&pin_gpio13_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio14,	GPIO14,				NONE,		NONE,	0x00,	0x0,	&pin_gpio14_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(gpio15,	GPIO15_SIM2RSTI,		PU_PD_OD,	PAD4,	0x80,	0x7,	&pin_gpio15_info,	&pin_sim2rsti_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(vac,	VAC,				PU_PD_OD,	PAD1,	0x02,	0x1,	&pin_vac_info,		&pin_vacok_info,	core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(powergood,	POWERGOOD_USB_PSEL,	PU_PD_OD,	PAD1,	0x01,	0x0,	&pin_powergood_info,	&pin_usb_psel_info,	core::ptr::null_mut(),	core::ptr::null_mut()),
    PALMAS_PINGROUP(nreswarm,	NRESWARM,		NONE,		NONE,	0x0,	0x0,	&pin_nreswarm_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
    PALMAS_PINGROUP(pwrdown,	PWRDOWN,		NONE,		NONE,	0x0,	0x0,	&pin_pwrdown_info,	core::ptr::null_mut(),			core::ptr::null_mut(),		core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn palmas_pinctrl_get_pin_mux(pci: *mut palmas_pctrl_chip_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_pinctrl_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PIN_CONFIG_BIAS_PULL_UP: param ==) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pinctrl_data {
    pub pin_groups: *const palmas_pingroup,
    pub num_pin_groups: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn palmas_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    ...
    int ret;
    let mut enable_dvfs1: bool = false;
    let mut enable_dvfs2: bool = false;
    if (pdev.dev.of_node) {
