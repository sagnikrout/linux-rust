...
//! Source: drivers/pinctrl/pinctrl-single.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcs_conf_vals {
    pub param: enum pin_config_param,
    pub val: unsigned,
    pub enable: unsigned,
    pub disable: unsigned,
    pub mask: unsigned,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcs_function {
    pub name: *const c_char,
    pub vals: *mut pcs_func_vals,
    pub nvals: unsigned,
    pub conf: *mut pcs_conf_vals,
    pub nconfs: c_int,
    pub node: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcs_gpiofunc_range {
    pub offset: unsigned,
    pub npins: unsigned,
    pub gpiofunc: unsigned,
    pub node: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcs_soc_data {
    pub flags: unsigned,
    pub irq: c_int,
    pub irq_enable_mask: unsigned,
    pub irq_status_mask: unsigned,
    pub (*rearm)(void): *mut c_void,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcs_device {
    pub res: *mut resource,
    pub base: *mut void __iomem,
    pub saved_vals: *mut c_void,
    pub size: unsigned,
    pub dev: *mut device,
    ...
    pub missing_nr_pinctrl_cells: *mut property,
    pub socdata: pcs_soc_data,
    ...
    pub foff: unsigned,
    pub fmax: unsigned,
    pub bits_per_mux: bool,
    pub bits_per_pin: unsigned,
    pub pins: pcs_data,
    pub gpiofuncs: list_head,
    pub irqs: list_head,
    pub chip: irq_chip,
    pub domain: *mut irq_domain,
    pub desc: pinctrl_desc,
    pub reg): *mut *mut unsigned (read)(void __iomem,
    pub reg): *mut *mut void (write)(unsigned val, void __iomem,
}
...
//
#[no_mangle]
unsafe extern "C" fn pcs_readb(reg: *mut void __iomem) -> c_uint {
    static unsigned int pcs_readb(void __iomem *reg)
    {
    return readb(reg);
    }
#[no_mangle]
unsafe extern "C" fn pcs_readw(reg: *mut void __iomem) -> c_uint {
    static unsigned int pcs_readw(void __iomem *reg)
    {
    return readw(reg);
    }
#[no_mangle]
unsafe extern "C" fn pcs_readl(reg: *mut void __iomem) -> c_uint {
    static unsigned int pcs_readl(void __iomem *reg)
    {
    return readl(reg);
    }
#[no_mangle]
unsafe extern "C" fn pcs_writeb(val: c_uint, reg: *mut void __iomem) {
    static void pcs_writeb(unsigned int val, void __iomem *reg)
    {
    writeb(val, reg);
    }
#[no_mangle]
unsafe extern "C" fn pcs_writew(val: c_uint, reg: *mut void __iomem) {
    static void pcs_writew(unsigned int val, void __iomem *reg)
    {
    writew(val, reg);
    }
#[no_mangle]
unsafe extern "C" fn pcs_writel(val: c_uint, reg: *mut void __iomem) {
    ...
    unsigned int pin)
    {
    let mut mux_bytes: c_uint = pcs.width / BITS_PER_BYTE;
    if (pcs.bits_per_mux) {
...
// If function mask is null, needn't enable it.
    ...
    {
    struct pcs_device *pcs = pinctrl_dev_get_drvdata(pctldev);
    struct pcs_gpiofunc_range *frange = core::ptr::null_mut();
...
// If function mask is null, return directly.
    ...
    offset = pcs_pin_reg_offset_get(pcs, pin);
    if (pcs.bits_per_mux) {
    let mut pin_shift: c_int = pcs_pin_shift_reg_get(pcs, pin);
...
// Clear BIAS value
#[no_mangle]
unsafe extern "C" fn pcs_pinconf_clear_bias(pctldev: *mut pinctrl_dev, pin: unsigned) {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_pinconf_bias_disable(pctldev: *mut pinctrl_dev, pin: unsigned) -> bool {
    ...
    let mut offset: unsigned = 0, data = 0, i, j;
    int ret;
...
// config = data;
    ...
    struct pcs_device *pcs = pinctrl_dev_get_drvdata(pctldev);
    struct pcs_function *func;
    let mut offset: unsigned = 0, shift = 0, i, data;
    u32 arg;
    int j, ret;
    enum pin_config_param param;
    ret = pcs_get_function(pctldev, pin, &func);
...
//
#[no_mangle]
unsafe extern "C" fn pcs_add_pin(pcs: *mut pcs_device, offset: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_allocate_pin_table(pcs: *mut pcs_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_get_pin_by_offset(pcs: *mut pcs_device, offset: unsigned) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_config_match(data: unsigned, enable: unsigned, disable: unsigned) -> c_int {
    ...
    ret = 1;
#[no_mangle]
pub unsafe extern "C" fn if(disable: data ==) -> else {
...
// value to set, enable, disable, mask
    ...
    let mut i: c_int = 0, nconfs = 0;
    unsigned long *settings = core::ptr::null_mut(), *s = core::ptr::null_mut();
    struct pcs_conf_vals *conf = core::ptr::null_mut();
...
//
    ...
    struct pcs_function *function = core::ptr::null_mut();
...
// num_maps = 2;
#[no_mangle]
pub unsafe extern "C" fn if(-ENOTSUPP: res ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_irq_free(pcs: *mut pcs_device) {
    ...
    irq_set_chained_handler(pcs_soc.irq, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn pcs_free_resources(pcs: *mut pcs_device) {
...
#[no_mangle]
unsafe extern "C" fn pcs_add_gpio_func(node: *mut device_node, pcs: *mut pcs_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_irq_mask(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_irq_unmask(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_irq_set_wake(d: *mut irq_data, state: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_irq_handle(pcs_soc: *mut pcs_soc_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_irq_handler(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn pcs_irq_chain_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn pcs_save_context(pcs: *mut pcs_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcs_restore_context(pcs: *mut pcs_device) {
...
#[no_mangle]
unsafe extern "C" fn pinctrl_single_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pinctrl_single_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcs_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcs_remove(pdev: *mut platform_device) {
