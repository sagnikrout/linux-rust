...
//! Source: drivers/pinctrl/renesas/pfc-r8a7790.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn r8a7790_pin_to_pocctrl(pin: c_uint, pocctrl: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r8a7790_pinmux_soc_init(pfc: *mut sh_pfc) -> c_int {
