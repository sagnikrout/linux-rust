...
//! Source: drivers/pinctrl/renesas/pinctrl-rza1.c
#![no_std]
...
pub const RZA1_P_REG: c_uint = 0x0000;
pub const RZA1_PPR_REG: c_uint = 0x0200;
pub const RZA1_PM_REG: c_uint = 0x0300;
pub const RZA1_PMC_REG: c_uint = 0x0400;
pub const RZA1_PFC_REG: c_uint = 0x0500;
pub const RZA1_PFCE_REG: c_uint = 0x0600;
pub const RZA1_PFCEA_REG: c_uint = 0x0a00;
pub const RZA1_PIBC_REG: c_uint = 0x4000;
pub const RZA1_PBDC_REG: c_uint = 0x4100;
pub const RZA1_PIPC_REG: c_uint = 0x4200;

pub const RZA1_NPORTS: c_int = 12;
pub const RZA1_PINS_PER_PORT: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rza1_bidir_entry {
    pub npins: c_uint,
    pub pins: *const rza1_bidir_pin,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rza1_swio_entry {
    pub npins: c_uint,
    pub pins: *const rza1_swio_pin,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rza1_pinmux_conf {
    pub bidir_entries: *const rza1_bidir_entry,
    pub swio_entries: *const rza1_swio_entry,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rza1_pinctrl {
    pub dev: *mut device,
    pub mutex: mutex,
    pub base: *mut void __iomem,
    pub nport: c_uint,
    pub ports: *mut rza1_port,
    pub pins: *mut pinctrl_pin_desc,
...
//
#[no_mangle]
unsafe extern "C" fn rza1_pin_reset(port: *mut rza1_port, pin: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn rza1_pin_get(port: *mut rza1_port, pin: c_uint) -> c_int {
...
//
    ...
    let mut pin: c_uint = mux_conf.pin;
    let mut mux_func: u8 = mux_conf.mux_func;
    let mut mux_flags: u8 = mux_conf.mux_flags;
...
//
#[no_mangle]
unsafe extern "C" fn rza1_gpio_request(chip: *mut gpio_chip, gpio: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rza1_gpio_free(chip: *mut gpio_chip, gpio: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rza1_gpio_get_direction(chip: *mut gpio_chip, gpio: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rza1_gpio_get(chip: *mut gpio_chip, gpio: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rza1_gpio_set(chip: *mut gpio_chip, gpio: c_uint, value: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rza1_dt_node_pin_count(np: *mut device_node) -> c_int {
    ...
    of_pins = of_find_property(child, "pinmux", core::ptr::null_mut());
    if (!of_pins)
    return -EINVAL;
...
//
    ...
    unsigned int i;
    int ret;
    of_pins = of_find_property(np, prop_name, core::ptr::null_mut());
    if (!of_pins) {
...
//
    ...
    u32 pinctrl_base;
    int ret;
    ret = fwnode_property_get_reference_args(fwnode, list_name, core::ptr::null_mut(), 3, 0, &args);
    if (ret) {
...
//
#[no_mangle]
unsafe extern "C" fn rza1_gpio_register(rza1_pctl: *mut rza1_pinctrl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rza1_pinctrl_register(rza1_pctl: *mut rza1_pinctrl) -> c_int {
    ...
    let mut pin: c_uint = RZA1_PIN_ID_TO_PIN(i);
    let mut port: c_uint = RZA1_PIN_ID_TO_PORT(i);
    pins[i].number = i;
...
//
    let mut port_id: c_uint = RZA1_PIN_ID_TO_PORT(i);
...
#[no_mangle]
unsafe extern "C" fn rza1_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rza1_pinctrl_init() -> int __init {
