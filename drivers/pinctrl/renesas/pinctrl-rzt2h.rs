...
//! Source: drivers/pinctrl/renesas/pinctrl-rzt2h.c
#![no_std]
...
pub const PFC_FUNC_INTERRUPT: c_int = 0;

pub const DRCTL_PUD_NONE: c_int = 0;
pub const DRCTL_PUD_PULL_UP: c_int = 1;
pub const DRCTL_PUD_PULL_DOWN: c_int = 2;
//
// Use 16 lower bits [15:0] for pin identifier
// Use 8 higher bits [23:16] for pin mux function
//

pub const RZT2H_MAX_SAFETY_PORTS: c_int = 12;
pub const RZT2H_INTERRUPTS_START: c_int = 16;
pub const RZT2H_INTERRUPTS_NUM: c_int = 17;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzt2h_pinctrl_data {
    pub n_port_pins: c_uint,
    pub port_pin_configs: *const u8,
    pub n_ports: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzt2h_pinctrl {
    pub pctl: *mut pinctrl_dev,
    pub desc: pinctrl_desc,
    pub pins: *mut pinctrl_pin_desc,
    pub data: *const rzt2h_pinctrl_data,
    pub base1: *mut *mut void __iomem base0,,
    pub dev: *mut device,
    pub gpio_chip: gpio_chip,
    pub gpio_range: pinctrl_gpio_range,
    pub RZT2H_INTERRUPTS_NUM): DECLARE_BITMAP(used_irqs,,
    pub /: *mut *mut raw_spinlock_t lock; / lock read/write registers,
    pub /: *mut *mut mutex mutex; / serialize adding groups and functions,
    pub safety_port_enabled: bool,
...
#[no_mangle]
unsafe extern "C" fn rzt2h_drive_strength_ua_to_idx(ua: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_drive_strength_idx_to_ua(idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_validate_pin(pctrl: *mut rzt2h_pinctrl, offset: c_uint) -> c_int {
    static int rzt2h_validate_pin(struct rzt2h_pinctrl *pctrl, unsigned int offset)
    {
    let mut port: u8 = RZT2H_PIN_ID_TO_PORT(offset);
    let mut pin: u8 = RZT2H_PIN_ID_TO_PIN(offset);
    u8 pincfg;
    ...
    {
    let mut reg: u8 = rzt2h_pinctrl_readb(pctrl, port, PMC(port));
    if (en)
    reg &= ~BIT(pin);
    else
    reg |= BIT(pin);
...
// num_maps = 0;
    ...
    if (*num_maps == 0) {
    ret = rzt2h_dt_subnode_to_map(pctldev, np, core::ptr::null_mut(), map,
    num_maps, &index);
    if (ret < 0)
    goto done;
    }
...
#[no_mangle]
unsafe extern "C" fn rzt2h_gpio_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_gpio_free(chip: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_gpio_irq_disable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_gpio_irq_enable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_gpio_irq_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
...
//
    ...
    let mut port: u8 = RZT2H_PIN_ID_TO_PORT(child);
    let mut pin: u8 = RZT2H_PIN_ID_TO_PIN(child);
    u8 parent_irq;
...
// parent_type = child_type;
    ...
    let mut port: u8 = RZT2H_PIN_ID_TO_PORT(hwirq);
    let mut pin: u8 = RZT2H_PIN_ID_TO_PIN(hwirq);
...
#[no_mangle]
unsafe extern "C" fn rzt2h_gpio_register(pctrl: *mut rzt2h_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_pinctrl_register(pctrl: *mut rzt2h_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzt2h_pinctrl_suspend_noirq(dev: *mut device) -> c_int {
    ...
    NOIRQ_SYSTEM_SLEEP_PM_OPS(rzt2h_pinctrl_suspend_noirq, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn rzt2h_pinctrl_init() -> int __init {
