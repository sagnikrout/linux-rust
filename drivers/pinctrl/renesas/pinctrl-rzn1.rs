...
//! Source: drivers/pinctrl/renesas/pinctrl-rzn1.c
#![no_std]
...
pub const RZN1_L1_PIN_DRIVE_STRENGTH: c_int = 10;
pub const RZN1_L1_PIN_DRIVE_STRENGTH_4MA: c_int = 0;
pub const RZN1_L1_PIN_DRIVE_STRENGTH_6MA: c_int = 1;
pub const RZN1_L1_PIN_DRIVE_STRENGTH_8MA: c_int = 2;
pub const RZN1_L1_PIN_DRIVE_STRENGTH_12MA: c_int = 3;
pub const RZN1_L1_PIN_PULL: c_int = 8;
pub const RZN1_L1_PIN_PULL_NONE: c_int = 0;
pub const RZN1_L1_PIN_PULL_UP: c_int = 1;
pub const RZN1_L1_PIN_PULL_DOWN: c_int = 3;
pub const RZN1_L1_FUNCTION: c_int = 0;
pub const RZN1_L1_FUNC_MASK: c_uint = 0xf;
pub const RZN1_L1_FUNCTION_L2: c_uint = 0xf;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzn1_pinctrl_regs {
    pub conf: [u32; 170],
    pub pad0: [u32; 86],
    pub /: *mut *mut u32 status_protect; / 0x400,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzn1_pinctrl {
    pub dev: *mut device,
    pub clk: *mut clk,
    pub pctl: *mut pinctrl_dev,
    pub lev1: *mut rzn1_pinctrl_regs __iomem,
    pub lev2: *mut rzn1_pinctrl_regs __iomem,
    pub lev1_protect_phys: u32,
    pub lev2_protect_phys: u32,
    pub mdio_func: [c_int; 2],
    pub groups: *mut rzn1_pin_group,
    pub ngroups: c_uint,
    pub functions: *mut rzn1_pmx_func,
...
#[no_mangle]
unsafe extern "C" fn rzn1_hw_set_lock(ipctl: *mut rzn1_pinctrl, lock: u8, value: u8) {
...
//
    if (lock & LOCK_LEVEL1) {
    let mut val: u32 = ipctl.lev1_protect_phys | !(value & LOCK_LEVEL1);
    writel(val, &ipctl.lev1.status_protect);
    }
    if (lock & LOCK_LEVEL2) {
    let mut val: u32 = ipctl.lev2_protect_phys | !(value & LOCK_LEVEL2);
...
#[no_mangle]
unsafe extern "C" fn rzn1_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
//
    ...
    let mut reserved_maps: c_uint = *num_maps;
    let mut num_configs: c_uint = 0;
    let mut reserve: c_uint = 1;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rzn1_pmx_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
//
    ...
    return -ENOMEM;
    for (i = 0; i < grp.npins; i++) {
    let mut pin_id: u32 = be32_to_cpu(*list++);
...
#[no_mangle]
unsafe extern "C" fn rzn1_pinctrl_count_function_groups(np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
// Create state holders etc for this driver
    ...
    ipctl.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(ipctl.clk))
...
#[no_mangle]
unsafe extern "C" fn rzn1_pinctrl_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn _pinctrl_drv_register() -> int __init {
