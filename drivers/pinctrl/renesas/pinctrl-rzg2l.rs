...
//! Source: drivers/pinctrl/renesas/pinctrl-rzg2l.c
#![no_std]
...
pub const PM_MASK: c_uint = 0x03;
pub const PFC_MASK: c_uint = 0x0f;
pub const IEN_MASK: c_uint = 0x01;
pub const IOLH_MASK: c_uint = 0x03;
pub const SR_MASK: c_uint = 0x01;
pub const PUPD_MASK: c_uint = 0x03;
pub const NOD_MASK: c_uint = 0x01;
pub const SMT_MASK: c_uint = 0x01;
pub const PM_INPUT: c_uint = 0x1;
pub const PM_OUTPUT: c_uint = 0x2;

pub const RZG2L_TINT_MAX_INTERRUPT: c_int = 32;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_register_offsets {
    pub pwpr: u16,
    pub sd_ch: u16,
    pub eth_poc: u16,
    pub oen: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_hwcfg {
    pub regs: rzg2l_register_offsets,
    pub iolh_groupa_ua: [u16; RZG2L_IOLH_IDX_MAX],
    pub iolh_groupb_ua: [u16; RZG2L_IOLH_IDX_MAX],
    pub iolh_groupc_ua: [u16; RZG2L_IOLH_IDX_MAX],
    pub iolh_groupb_oi: [u16; 4],
    pub tint_start_index: u16,
    pub drive_strength_ua: bool,
    pub oen_pwpr_lock: bool,
    pub func_base: u8,
    pub oen_max_pin: u8,
    pub oen_max_port: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_dedicated_configs {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_pinctrl_data {
    pub port_pins: *const *const c_char,
    pub port_pin_configs: *const u64,
    pub n_ports: c_uint,
    pub dedicated_pins: *const rzg2l_dedicated_configs,
    pub n_port_pins: c_uint,
    pub n_dedicated_pins: c_uint,
    pub clone_channel_data: *const u32,
    pub n_clone_channel_data: c_uint,
    pub hwcfg: *const rzg2l_hwcfg,
    pub variable_pin_cfg: *const u64,
    pub n_variable_pin_cfg: c_uint,
    pub num_custom_params: c_uint,
    pub custom_params: *const pinconf_generic_params,

    pub custom_conf_items: *const pin_config_item,

    pub lock): *mut *mut *mut void (pwpr_pfc_lock_unlock)(struct rzg2l_pinctrl pctrl, bool,
    pub offset): *mut *mut *mut void (pmc_writeb)(struct rzg2l_pinctrl pctrl, u8 val, u16,
    pub _pin): *mut *mut *mut int (pin_to_oen_bit)(struct rzg2l_pinctrl pctrl, unsigned int,
    pub val): *mut *mut int (hw_to_bias_param)(unsigned int,
    pub param): *mut *mut int (bias_param_to_hw)(enum pin_config_param,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_pinctrl_pin_settings {
    pub power_source: u16,
    pub drive_strength_ua: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_pinctrl_reg_cache {
    pub p: *mut u8,
    pub pm: *mut u16,
    pub pmc: *mut u8,
    pub pfc: *mut u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg2l_pinctrl {
    pub pctl: *mut pinctrl_dev,
    pub desc: pinctrl_desc,
    pub pins: *mut pinctrl_pin_desc,
    pub data: *const rzg2l_pinctrl_data,
    ...
    pub RZG2L_TINT_MAX_INTERRUPT): DECLARE_BITMAP(tint_slot,,
    pub /: *mut *mut spinlock_t bitmap_lock; / protect tint_slot bitmap,
    pub hwirq: [c_uint; RZG2L_TINT_MAX_INTERRUPT],
    pub /: *mut *mut raw_spinlock_t lock; / lock read/write registers,
    pub /: *mut *mut mutex mutex; / serialize adding groups and functions,
    pub settings: *mut rzg2l_pinctrl_pin_settings,
    pub cache: *mut rzg2l_pinctrl_reg_cache,
    pub dedicated_cache: *mut rzg2l_pinctrl_reg_cache,
    pub wakeup_path: core::sync::atomic::AtomicI32,
    pub clone_offset: u32,
}
    ...
    let mut cfg: u64 = pctrl.data.variable_pin_cfg[i];
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pmc_writeb(pctrl: *mut rzg2l_pinctrl, val: u8, offset: u16) {
    static void rzg2l_pmc_writeb(struct rzg2l_pinctrl *pctrl, u8 val, u16 offset)
    {
    writeb(val, pctrl.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn rzv2h_pmc_writeb(pctrl: *mut rzg2l_pinctrl, val: u8, offset: u16) {
    ...
    {
    let mut pinmap: u8 = FIELD_GET(PIN_CFG_PIN_MAP_MASK, cfg);
    let mut off: u32 = RZG2L_PIN_CFG_TO_PORT_OFFSET(cfg);
    u64 data;
    ...
    let mut pin_data: u32 = pctrl.data.clone_channel_data[i];
    let mut pin_func_mask: c_uint = FIELD_GET(RZG3L_CLONE_CHANNEL_PFC_MASK, pin_data);
    let mut pin_mask: c_uint = FIELD_GET(RZG3L_CLONE_CHANNEL_PIN_MASK, pin_data);
    u32 bit, val;
...
// Switch to Peripheral pin function with PMC register
    ...
    let mut off: u32 = RZG2L_PIN_CFG_TO_PORT_OFFSET(*pin_data);
    let mut port: u32 = RZG2L_PIN_ID_TO_PORT(pins[i]);
    let mut pin: u32 = RZG2L_PIN_ID_TO_PIN(pins[i]);
    unsigned int func;
    ...
    let mut nmaps: c_uint = *num_maps;
    unsigned long *configs = core::ptr::null_mut();
    unsigned int *pins, *psel_val;
    let mut num_pinmux: c_uint = 0;
    let mut idx: c_uint = *index;
    ...
    const char *name;
    const char *pin;
    pinmux = of_find_property(np, "pinmux", core::ptr::null_mut());
    if (pinmux)
...
// Register a single pin group listing all the pins we read from DT
    gsel = pinctrl_generic_add_group(pctldev, name, pins, num_pinmux, core::ptr::null_mut());
    if (gsel < 0) {
    ret = gsel;
    goto unlock;
    }
...
// num_maps = 0;
    ...
    if (*num_maps == 0) {
    ret = rzg2l_dt_subnode_to_map(pctldev, np, core::ptr::null_mut(), map,
    num_maps, &index);
    if (ret < 0)
    goto done;
    }
...
// mask = BIT(0);
#[no_mangle]
pub unsafe extern "C" fn if(PIN_CFG_PVDD1833_OTH_ISO_POC: caps &) -> else {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_get_power_source(pctrl: *mut rzg2l_pinctrl, pin: u32, caps: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_set_power_source(pctrl: *mut rzg2l_pinctrl, pin: u32, caps: u32, ps: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_ps_is_supported(ps: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_ps_to_iolh_idx(ps: u16) -> enum rzg2l_iolh_index {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_iolh_val_to_ua(hwcfg: *const rzg2l_hwcfg, caps: u32, val: u8) -> u16 {
...
// Should not happen.
    ...
    {
    const u16 *array = core::ptr::null_mut();
    unsigned int i;
    if (caps & PIN_CFG_IOLH_A)
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pin_to_oen_bit(pctrl: *mut rzg2l_pinctrl, _pin: c_uint) -> c_int {
    static int rzg2l_pin_to_oen_bit(struct rzg2l_pinctrl *pctrl, unsigned int _pin)
    {
    u64 *pin_data = pctrl.desc.pins[_pin].drv_data;
    let mut caps: u64 = FIELD_GET(PIN_CFG_MASK, *pin_data);
    let mut pin: u8 = RZG2L_PIN_ID_TO_PIN(_pin);
...
#[no_mangle]
unsafe extern "C" fn rzg2l_read_oen(pctrl: *mut rzg2l_pinctrl, _pin: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rzg2l_oen_write_with_pwpr(pctrl: *mut rzg2l_pinctrl, val: u8) {
    static void rzg2l_oen_write_with_pwpr(struct rzg2l_pinctrl *pctrl, u8 val)
    {
    const struct rzg2l_register_offsets *regs = &pctrl.data.hwcfg.regs;
    let mut oen_offset: u16 = pctrl.data.hwcfg.regs.oen;
    u8 pwpr;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_write_oen(pctrl: *mut rzg2l_pinctrl, _pin: c_uint, oen: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pin_to_oen_bit(pctrl: *mut rzg2l_pinctrl, _pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_hw_to_bias_param(bias: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_bias_param_to_hw(param: enum pin_config_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_hw_to_bias_param(bias: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_bias_param_to_hw(param: enum pin_config_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_pin_to_oen_bit(pctrl: *mut rzg2l_pinctrl, _pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_pin_to_oen_bit(pctrl: *mut rzg2l_pinctrl, _pin: c_uint) -> c_int {
    ...
    let mut param: u32 = pinconf_to_config_param(*config);
...
// config = pinconf_to_config_packed(param, arg);
    ...
    const struct pinctrl_pin_desc *pin = &pctrl.desc.pins[_pin];
    const struct rzg2l_hwcfg *hwcfg = pctrl.data.hwcfg;
    let mut settings: rzg2l_pinctrl_pin_settings = pctrl.settings[_pin];
    u64 *pin_data = pin.drv_data;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    let mut off: u32 = RZG2L_PIN_CFG_TO_PORT_OFFSET(*pin_data);
    let mut port: u32 = RZG2L_PIN_ID_TO_PORT(offset);
    let mut bit: u8 = RZG2L_PIN_ID_TO_PIN(offset);
    unsigned long flags;
    u8 reg8;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PM_OUTPUT: reg16 ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_free(chip: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_get_gpioint(virq: c_uint, pctrl: *mut rzg2l_pinctrl) -> c_int {
    ...
    u64 *pin_data = pin_desc.drv_data;
    let mut off: u32 = RZG2L_PIN_CFG_TO_PORT_OFFSET(*pin_data);
    let mut bit: u8 = RZG2L_PIN_ID_TO_PIN(hwirq);
    void __iomem *addr;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_irq_disable(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn __rzg2l_gpio_irq_enable(d: *mut irq_data, lock: bool) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_irq_enable(d: *mut irq_data) {
    static void rzg2l_gpio_irq_enable(struct irq_data *d)
    {
    __rzg2l_gpio_irq_enable(d, true);
    }
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_irq_print_chip(data: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_irq_set_wake(data: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_interrupt_input_mode(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_irq_restore(pctrl: *mut rzg2l_pinctrl) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_reg_cache_alloc(pctrl: *mut rzg2l_pinctrl) -> c_int {
    static int rzg2l_pinctrl_reg_cache_alloc(struct rzg2l_pinctrl *pctrl)
    {
    let mut nports: u32 = pctrl.data.n_port_pins / RZG2L_PINS_PER_PORT;
    ...
    return -ENOMEM;
    for (u8 i = 0; i < 2; i++) {
    let mut n_dedicated_pins: u32 = pctrl.data.n_dedicated_pins;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_gpio_register(pctrl: *mut rzg2l_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_register(pctrl: *mut rzg2l_pinctrl) -> c_int {
    ...
    let mut index: c_uint = pctrl.data.n_port_pins + i;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    ...
    pctrl.clk = devm_clk_get_enabled(pctrl.dev, core::ptr::null_mut());
    if (IS_ERR(pctrl.clk)) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_pm_setup_regs(pctrl: *mut rzg2l_pinctrl, suspend: bool) {
    ...
    let mut pin: c_uint = port * RZG2L_PINS_PER_PORT;
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_pm_setup_dedicated_regs(pctrl: *mut rzg2l_pinctrl, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_pm_setup_pfc(pctrl: *mut rzg2l_pinctrl) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pwpr_pfc_lock_unlock(pctrl: *mut rzg2l_pinctrl, lock: bool) {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_pwpr_pfc_lock_unlock(pctrl: *mut rzg2l_pinctrl, lock: bool) {
...
#[no_mangle]
unsafe extern "C" fn rzg2l_pinctrl_init() -> int __init {
