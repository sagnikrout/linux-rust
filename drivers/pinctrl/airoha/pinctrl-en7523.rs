...
//! Source: drivers/pinctrl/airoha/pinctrl-en7523.c
#![no_std]
...
// MUX
pub const REG_GPIO_2ND_I2C_MODE: c_uint = 0x0210;

pub const REG_GPIO_SPI_CS1_MODE: c_uint = 0x0214;

pub const REG_GPIO_PON_MODE: c_uint = 0x0218;

pub const REG_NPU_UART_EN: c_uint = 0x0220;

pub const REG_FORCE_GPIO_EN: c_uint = 0x0224;

// LED MAP
pub const REG_LAN_LED0_MAPPING: c_uint = 0x0278;
pub const REG_LAN_LED1_MAPPING: c_uint = 0x027c;
