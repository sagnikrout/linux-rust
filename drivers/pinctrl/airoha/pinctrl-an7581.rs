...
//! Source: drivers/pinctrl/airoha/pinctrl-an7581.c
#![no_std]
...
// MUX
pub const REG_GPIO_2ND_I2C_MODE: c_uint = 0x0214;

pub const REG_GPIO_SPI_CS1_MODE: c_uint = 0x0218;

pub const REG_GPIO_PON_MODE: c_uint = 0x021c;

pub const REG_NPU_UART_EN: c_uint = 0x0224;

pub const REG_FORCE_GPIO_EN: c_uint = 0x0228;

// LED MAP
pub const REG_LAN_LED0_MAPPING: c_uint = 0x027c;
pub const REG_LAN_LED1_MAPPING: c_uint = 0x0280;

// CONF
pub const REG_I2C_SDA_E2: c_uint = 0x001c;

pub const REG_I2C_SDA_E4: c_uint = 0x0020;

pub const REG_GPIO_L_E2: c_uint = 0x0024;
pub const REG_GPIO_L_E4: c_uint = 0x0028;
pub const REG_GPIO_H_E2: c_uint = 0x002c;
pub const REG_GPIO_H_E4: c_uint = 0x0030;
pub const REG_I2C_SDA_PU: c_uint = 0x0044;

pub const REG_I2C_SDA_PD: c_uint = 0x0048;

pub const REG_GPIO_L_PU: c_uint = 0x004c;
pub const REG_GPIO_L_PD: c_uint = 0x0050;
pub const REG_GPIO_H_PU: c_uint = 0x0054;
pub const REG_GPIO_H_PD: c_uint = 0x0058;
pub const REG_PCIE_RESET_OD: c_uint = 0x018c;

// PWM MODE CONF
pub const REG_GPIO_FLASH_MODE_CFG: c_uint = 0x0034;

// PWM MODE CONF EXT
pub const REG_GPIO_FLASH_MODE_CFG_EXT: c_uint = 0x0068;
