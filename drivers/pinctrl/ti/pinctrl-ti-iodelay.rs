...
//! Source: drivers/pinctrl/ti/pinctrl-ti-iodelay.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_iodelay_reg_data {
    pub signature_mask: u32,
    pub signature_value: u32,
    pub lock_mask: u32,
    pub lock_val: u32,
    pub unlock_val: u32,
    pub binary_data_coarse_mask: u32,
    pub binary_data_fine_mask: u32,
    pub reg_refclk_offset: u32,
    pub refclk_period_mask: u32,
    pub reg_coarse_offset: u32,
    pub coarse_delay_count_mask: u32,
    pub coarse_ref_count_mask: u32,
    pub reg_fine_offset: u32,
    pub fine_delay_count_mask: u32,
    pub fine_ref_count_mask: u32,
    pub reg_global_lock_offset: u32,
    pub global_lock_mask: u32,
    pub global_unlock_val: u32,
    pub global_lock_val: u32,
    pub reg_start_offset: u32,
    pub reg_nr_per_pin: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_iodelay_reg_values {
    pub coarse_ref_count: u16,
    pub coarse_delay_count: u16,
    pub fine_ref_count: u16,
    pub fine_delay_count: u16,
    pub ref_clk_period: u16,
    pub cdpe: u32,
    pub fdpe: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_iodelay_pingroup {
    pub cfg: *mut ti_iodelay_cfg,
    pub ncfg: c_int,
    pub config: c_ulong,
}
...
pub struct ti_iodelay_device {
    ...
    pub reg_data: *const ti_iodelay_reg_data,
    pub reg_init_conf_values: ti_iodelay_reg_values,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_iodelay_extract(val: u32, mask: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn ti_iodelay_pinconf_deinit_dev(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_iodelay_pinconf_init_dev(iod: *mut ti_iodelay_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_iodelay_probe(pdev: *mut platform_device) -> c_int {
