...
//! Source: drivers/pinctrl/pinctrl-ingenic.c
#![no_std]
...
pub const GPIO_PIN: c_uint = 0x00;
pub const GPIO_MSK: c_uint = 0x20;
pub const JZ4730_GPIO_DATA: c_uint = 0x00;
pub const JZ4730_GPIO_GPDIR: c_uint = 0x04;
pub const JZ4730_GPIO_GPPUR: c_uint = 0x0c;
pub const JZ4730_GPIO_GPALR: c_uint = 0x10;
pub const JZ4730_GPIO_GPAUR: c_uint = 0x14;
pub const JZ4730_GPIO_GPIDLR: c_uint = 0x18;
pub const JZ4730_GPIO_GPIDUR: c_uint = 0x1c;
pub const JZ4730_GPIO_GPIER: c_uint = 0x20;
pub const JZ4730_GPIO_GPIMR: c_uint = 0x24;
pub const JZ4730_GPIO_GPFR: c_uint = 0x28;
pub const JZ4740_GPIO_DATA: c_uint = 0x10;
pub const JZ4740_GPIO_PULL_DIS: c_uint = 0x30;
pub const JZ4740_GPIO_FUNC: c_uint = 0x40;
pub const JZ4740_GPIO_SELECT: c_uint = 0x50;
pub const JZ4740_GPIO_DIR: c_uint = 0x60;
pub const JZ4740_GPIO_TRIG: c_uint = 0x70;
pub const JZ4740_GPIO_FLAG: c_uint = 0x80;
pub const JZ4770_GPIO_INT: c_uint = 0x10;
pub const JZ4770_GPIO_PAT1: c_uint = 0x30;
pub const JZ4770_GPIO_PAT0: c_uint = 0x40;
pub const JZ4770_GPIO_FLAG: c_uint = 0x50;
pub const JZ4770_GPIO_PEN: c_uint = 0x70;
pub const X1600_GPIO_PU: c_uint = 0x80;
pub const X1830_GPIO_PEL: c_uint = 0x110;
pub const X1830_GPIO_PEH: c_uint = 0x120;
pub const X1830_GPIO_SR: c_uint = 0x150;
pub const X1830_GPIO_SMT: c_uint = 0x160;
pub const X2000_GPIO_EDG: c_uint = 0x70;
pub const X2000_GPIO_PEPU: c_uint = 0x80;
pub const X2000_GPIO_PEPD: c_uint = 0x90;
pub const X2000_GPIO_SR: c_uint = 0xd0;
pub const X2000_GPIO_SMT: c_uint = 0xe0;

pub const GPIO_PULL_DIS: c_int = 0;
pub const GPIO_PULL_UP: c_int = 1;
pub const GPIO_PULL_DOWN: c_int = 2;
pub const PINS_PER_GPIO_CHIP: c_int = 32;
pub const JZ4730_PINS_PER_PAIRED_REG: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_chip_info {
    pub num_chips: c_uint,
    pub reg_offset: c_uint,
    pub version: enum jz_version,
    pub groups: *const group_desc,
    pub num_groups: c_uint,
    pub functions: *const pinfunction,
    pub num_functions: c_uint,
    pub pull_downs: *const *const u32 pull_ups,,
    pub access_table: *const regmap_access_table,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_pinctrl {
    pub dev: *mut device,
    pub map: *mut regmap,
    pub pctl: *mut pinctrl_dev,
    pub pdesc: *mut pinctrl_pin_desc,
    pub info: *const ingenic_chip_info,
    pub gc: *mut gpio_chip,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_gpio_chip {
    pub jzpc: *mut ingenic_pinctrl,
    pub gc: gpio_chip,
    pub reg_base: unsigned int irq,,
}
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_read_reg(jzgc: *mut ingenic_gpio_chip, reg: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_shadow_set_bit_load(jzgc: *mut ingenic_gpio_chip) {
...
//
    let mut reg: u8 = offset < JZ4730_PINS_PER_PAIRED_REG ? reg_lower : reg_upper;
    let mut idx: c_uint = offset % JZ4730_PINS_PER_PAIRED_REG;
    let mut mask: c_uint = GENMASK(1, 0) << idx * 2;
    regmap_update_bits(jzgc.jzpc.map, jzgc.reg_base + reg, mask, value << (idx * 2));
    }
    static inline bool ingenic_gpio_get_value(struct ingenic_gpio_chip *jzgc,
    u8 offset)
    {
    let mut val: c_uint = ingenic_gpio_read_reg(jzgc, GPIO_PIN);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_soc_or_above(jzgc->jzpc, _arg: ID_JZ4740)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_mask(irqd: *mut irq_data) {
    static void ingenic_gpio_irq_mask(struct irq_data *irqd)
    {
    struct gpio_chip *gc = irq_data_get_irq_chip_data(irqd);
    struct ingenic_gpio_chip *jzgc = gpiochip_get_data(gc);
    let mut irq: irq_hw_number_t = irqd_to_hwirq(irqd);
    if (is_soc_or_above(jzgc.jzpc, ID_JZ4740))
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_unmask(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_enable(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_disable(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_ack(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_set_type(irqd: *mut irq_data, type: c_uint) -> c_int {
...
//
    let mut high: bool = ingenic_gpio_get_value(jzgc, irq);
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_set_wake(irqd: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
    ...
    {
    let mut idx: c_uint = pin % PINS_PER_GPIO_CHIP;
    let mut offt: c_uint = pin / PINS_PER_GPIO_CHIP;
    if (set) {
...
// definitions, split into two groups of 16.
//
    let mut idx: c_uint = pin % JZ4730_PINS_PER_PAIRED_REG;
    let mut mask: c_uint = GENMASK(1, 0) << idx * 2;
    let mut offt: c_uint = pin / PINS_PER_GPIO_CHIP;
    let mut reg: u8 = (pin % PINS_PER_GPIO_CHIP) < JZ4730_PINS_PER_PAIRED_REG ? reg_lower : reg_upper;
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
    static int ingenic_gpio_get_direction(struct gpio_chip *gc, unsigned int offset)
    {
    struct ingenic_gpio_chip *jzgc = gpiochip_get_data(gc);
    struct ingenic_pinctrl *jzpc = jzgc.jzpc;
    let mut pin: c_uint = gc.base + offset;
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_request(data: *mut irq_data) -> c_int {
    static int ingenic_gpio_irq_request(struct irq_data *data)
    {
    struct gpio_chip *gpio_chip = irq_data_get_irq_chip_data(data);
    let mut irq: irq_hw_number_t = irqd_to_hwirq(data);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_release(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_gpio_irq_print_chip(data: *mut irq_data, p: *mut seq_file) {
    ...
    let mut half: c_uint = PINS_PER_GPIO_CHIP / 2;
    let mut idxh: c_uint = (pin % half) * 2;
    if (idx < half)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_soc_or_above(jzpc, _arg: ID_JZ4770)) -> else {
    else if (is_soc_or_above(jzpc, ID_JZ4770))
    pull = !ingenic_get_pin_config(jzpc, pin, JZ4770_GPIO_PEN);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_soc_or_above(jzpc, _arg: ID_JZ4740)) -> else {
    else if (is_soc_or_above(jzpc, ID_JZ4740))
    ...
    reg = X2000_GPIO_SMT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_soc_or_above(jzpc, _arg: ID_X1830)) -> else {
    else if (is_soc_or_above(jzpc, ID_X1830))
    reg = X1830_GPIO_SMT;
    else
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ingenic_pinctrl_probe(pdev: *mut platform_device) -> int __init {
...
// fill in pinctrl_desc structure
    ...
    err = pinmux_generic_add_pinfunction(jzpc.pctl, func, core::ptr::null_mut());
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_pinctrl_drv_register() -> int __init {
