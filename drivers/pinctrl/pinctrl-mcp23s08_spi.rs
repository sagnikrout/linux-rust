...
//! Source: drivers/pinctrl/pinctrl-mcp23s08_spi.c
#![no_std]
...
pub const MCP_MAX_DEV_PER_CS: c_int = 8;
pub const MCP23S08_SPI_BASE: c_uint = 0x40;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mcp23s08_driver_data {
    pub ngpio: unsigned,
    pub mcp: [*mut mcp23s08; 8],
    pub chip: [mcp23s08; ],
}

#[no_mangle]
unsafe extern "C" fn mcp23sxx_spi_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp23s08_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp23s08_spi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mcp23s08_spi_exit() {
