...
//! Source: drivers/pinctrl/pinctrl-axp209.c
#![no_std]
...
pub const AXP20X_GPIO_FUNCTIONS: c_uint = 0x7;
pub const AXP20X_GPIO_FUNCTION_OUT_LOW: c_int = 0;
pub const AXP20X_GPIO_FUNCTION_OUT_HIGH: c_int = 1;
pub const AXP20X_GPIO_FUNCTION_INPUT: c_int = 2;

pub const AXP20X_GPIO3_FUNCTION_OUT_LOW: c_int = 0;
pub const AXP20X_GPIO3_FUNCTION_OUT_HIGH: c_int = 2;
pub const AXP20X_GPIO3_FUNCTION_INPUT: c_int = 4;
pub const AXP20X_FUNC_GPIO_OUT: c_int = 0;
pub const AXP20X_FUNC_GPIO_IN: c_int = 1;
pub const AXP20X_FUNC_LDO: c_int = 2;
pub const AXP20X_FUNC_ADC: c_int = 3;
pub const AXP20X_FUNCS_NB: c_int = 4;
pub const AXP20X_MUX_GPIO_OUT: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct axp20x_pctrl_desc {
...
// Stores the pins supporting ADC function. Bit offset is pin number.
    pub adc_mask: u8,
    pub gpio_status_offset: u8,
    pub adc_mux: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct axp20x_pinctrl_function {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axp20x_pctl {
    pub chip: gpio_chip,
    pub regmap: *mut regmap,
    pub pctl_dev: *mut pinctrl_dev,
    pub dev: *mut device,
    pub desc: *const axp20x_pctrl_desc,
    pub funcs: [axp20x_pinctrl_function; AXP20X_FUNCS_NB],
}
...
#[no_mangle]
unsafe extern "C" fn axp20x_gpio_get_reg(offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_pmx_func_cnt(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_groups_cnt(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_pins = 1;
    ...
    {
    let mut mask_cpy: unsigned long int = mask;
    const char **group;
    let mut ngroups: c_uint = hweight8(mask);
    int bit;
...
#[no_mangle]
unsafe extern "C" fn axp20x_build_funcs_groups(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_pctl_probe(pdev: *mut platform_device) -> c_int {
