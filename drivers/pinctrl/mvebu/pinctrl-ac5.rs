...
//! Source: drivers/pinctrl/mvebu/pinctrl-ac5.c
#![no_std]
...
//
    ...
    MPP_MODE(18,
    MPP_FUNCTION(0, "gpio",  core::ptr::null_mut()),
    MPP_FUNCTION(1, "tsen_int", core::ptr::null_mut()),
    MPP_FUNCTION(2, "uart2", "rxd"),
    MPP_FUNCTION(3, "wd_int", core::ptr::null_mut())),
    MPP_MODE(19,
    MPP_FUNCTION(0, "gpio",  core::ptr::null_mut()),
    MPP_FUNCTION(1, "dev_init_done", core::ptr::null_mut()),
    ...
    MPP_MODE(24,
    MPP_FUNCTION(0, "gpio",  core::ptr::null_mut()),
    MPP_FUNCTION(1, "wd_int", core::ptr::null_mut()),
    MPP_FUNCTION(2, "uart2", "txd"),
    MPP_FUNCTION(3, "uartsd", "txd")),
    MPP_MODE(25,
    MPP_FUNCTION(0, "gpio",  core::ptr::null_mut()),
    MPP_FUNCTION(1, "int_out", core::ptr::null_mut()),
    MPP_FUNCTION(2, "uart2", "rxd"),
    ...
    MPP_FUNCTION(2, "wd_int", core::ptr::null_mut())),
    MPP_MODE(38,
    MPP_FUNCTION(0, "gpio",  core::ptr::null_mut()),
    ...
    MPP_FUNC_CTRL(0, 45, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl), };
    static struct pinctrl_gpio_range ac5_mpp_gpio_ranges[] = {
    MPP_GPIO_RANGE(0,   0,  0, 46), };
#[no_mangle]
unsafe extern "C" fn ac5_pinctrl_probe(pdev: *mut platform_device) -> c_int {
