...
//! Source: drivers/pinctrl/mvebu/pinctrl-dove.c
#![no_std]
...
pub const MPP4_REGS_OFFS: c_uint = 0xd0440;
pub const PMU_REGS_OFFS: c_uint = 0xd802c;
pub const GC_REGS_OFFS: c_uint = 0xe802c;
// MPP Base registers
pub const PMU_MPP_GENERAL_CTRL: c_uint = 0x10;

// MPP Control 4 register

// PMU Signal Select registers
pub const PMU_SIGNAL_SELECT_0: c_uint = 0x00;
pub const PMU_SIGNAL_SELECT_1: c_uint = 0x04;
// Global Config regmap registers
pub const GLOBAL_CONFIG_1: c_uint = 0x00;

pub const GLOBAL_CONFIG_2: c_uint = 0x04;

pub const SSP_CTRL_STATUS_1: c_uint = 0x08;

pub const MPP_GENERAL_CONFIG: c_uint = 0x10;
    ...
    let mut pmu: c_ulong = readl(data.base + PMU_MPP_GENERAL_CTRL);
    unsigned long func;
    if ((pmu & BIT(pid)) == 0)
...
// config |= CONFIG_PMU;
    ...
    {
    let mut mpp4: c_ulong = readl(mpp4_base);
    unsigned long mask;
    switch (pid) {
    case 24: /* mpp_camera */
    mask = CAM_GPIO_SEL;
...
// config = ((pmu & AU0_AC97_SEL) != 0);
    ...
    unsigned long *config)
    {
    let mut mpp4: c_uint = readl(mpp4_base);
    unsigned int sspc1;
    unsigned int gmpp;
    unsigned int gcfg2;
...
// config = 1;
#[no_mangle]
pub unsafe extern "C" fn if(TWSI_ENABLE_OPTION2: gcfg2 &) -> else {
    else if (gcfg2 & TWSI_ENABLE_OPTION2)
// config = 2;
#[no_mangle]
pub unsafe extern "C" fn if(TWSI_ENABLE_OPTION3: gcfg2 &) -> else {
...
// config = 3;
    ...
    unsigned long config)
    {
    let mut gcfg1: c_uint = 0;
    let mut gcfg2: c_uint = 0;
    switch (config) {
    case 1:
    ...
    MPP_FUNC_CTRL(0, 15, core::ptr::null_mut(), dove_pmu_mpp_ctrl),
    MPP_FUNC_CTRL(16, 23, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    ...
    MPP_MODE(0,
    MPP_FUNCTION(0x00, "gpio", core::ptr::null_mut()),
    MPP_FUNCTION(0x02, "uart2", "rts"),
    MPP_FUNCTION(0x03, "sdio0", "cd"),
    MPP_FUNCTION(0x0f, "lcd0", "pwm"),
    MPP_FUNCTION(CONFIG_PMU | 0x0, "pmu-nc", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0x1, "pmu-low", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0x2, "pmu-high", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0x3, "pmic", "sdi"),
    MPP_FUNCTION(CONFIG_PMU | 0x4, "cpu-pwr-down", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0x5, "standby-pwr-down", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0x8, "core-pwr-good", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xa, "bat-fault", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xb, "ext0-wakeup", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xc, "ext1-wakeup", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xd, "ext2-wakeup", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xe, "pmu-blink", core::ptr::null_mut())),
    MPP_MODE(1,
    MPP_FUNCTION(0x00, "gpio", core::ptr::null_mut()),
    ...
    MPP_FUNCTION(CONFIG_PMU | 0x4, "cpu-pwr-down", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0x5, "standby-pwr-down", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0x8, "cpu-pwr-good", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xa, "bat-fault", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xb, "ext0-wakeup", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xc, "ext1-wakeup", core::ptr::null_mut()),
    MPP_FUNCTION(CONFIG_PMU | 0xd, "ext2-wakeup", core::ptr::null_mut()),
    ...
    MPP_MODE(24,
    MPP_FUNCTION(0x00, "camera", core::ptr::null_mut()),
    MPP_FUNCTION(0x01, "gpio", core::ptr::null_mut())),
    MPP_MODE(40,
    MPP_FUNCTION(0x00, "sdio0", core::ptr::null_mut()),
    MPP_FUNCTION(0x01, "gpio", core::ptr::null_mut())),
    MPP_MODE(46,
    MPP_FUNCTION(0x00, "sdio1", core::ptr::null_mut()),
    MPP_FUNCTION(0x01, "gpio", core::ptr::null_mut())),
    MPP_MODE(52,
    MPP_FUNCTION(0x00, "i2s1/spdifo", core::ptr::null_mut()),
    MPP_FUNCTION(0x02, "i2s1", core::ptr::null_mut()),
    MPP_FUNCTION(0x08, "spdifo", core::ptr::null_mut()),
    MPP_FUNCTION(0x0a, "gpio", core::ptr::null_mut()),
    MPP_FUNCTION(0x0b, "twsi", core::ptr::null_mut()),
    MPP_FUNCTION(0x0c, "ssp/spdifo", core::ptr::null_mut()),
    MPP_FUNCTION(0x0e, "ssp", core::ptr::null_mut()),
    MPP_FUNCTION(0x0f, "ssp/twsi", core::ptr::null_mut())),
    MPP_MODE(58,
    MPP_FUNCTION(0x00, "spi0", core::ptr::null_mut()),
    MPP_FUNCTION(0x01, "gpio", core::ptr::null_mut())),
    MPP_MODE(62,
    MPP_FUNCTION(0x00, "uart1", core::ptr::null_mut()),
    MPP_FUNCTION(0x01, "gpio", core::ptr::null_mut())),
    MPP_MODE(64,
    MPP_FUNCTION(0x00, "nand", core::ptr::null_mut()),
    MPP_FUNCTION(0x01, "gpo", core::ptr::null_mut())),
    MPP_MODE(72,
    MPP_FUNCTION(0x00, "i2s", core::ptr::null_mut()),
    MPP_FUNCTION(0x01, "ac97", core::ptr::null_mut())),
    MPP_MODE(73,
    MPP_FUNCTION(0x00, "twsi-none", core::ptr::null_mut()),
    MPP_FUNCTION(0x01, "twsi-opt1", core::ptr::null_mut()),
    MPP_FUNCTION(0x02, "twsi-opt2", core::ptr::null_mut()),
    MPP_FUNCTION(0x03, "twsi-opt3", core::ptr::null_mut())),
    };
...
#[no_mangle]
unsafe extern "C" fn dove_pinctrl_probe(pdev: *mut platform_device) -> c_int {
