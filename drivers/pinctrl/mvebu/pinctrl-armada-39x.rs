...
//! Source: drivers/pinctrl/mvebu/pinctrl-armada-39x.c
#![no_std]
...
//
    ...
    MPP_MODE(0,
    MPP_VAR_FUNCTION(0, "gpio",    core::ptr::null_mut(),       V_88F6920_PLUS),
...
#[no_mangle]
unsafe extern "C" fn armada_39x_pinctrl_probe(pdev: *mut platform_device) -> c_int {
