...
//! Source: drivers/pinctrl/mvebu/pinctrl-armada-xp.c
#![no_std]
...
//
    ...
    MPP_MODE(0,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),        V_MV78230_PLUS),
    ...
    MPP_MODE(49,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),        V_MV78260_PLUS),
    ...
    MPP_MODE(0,
    MPP_VAR_FUNCTION(0x0, "gpo", core::ptr::null_mut(),          V_98DX3236_PLUS),
    MPP_VAR_FUNCTION(0x2, "spi0", "mosi",       V_98DX3236_PLUS),
    MPP_VAR_FUNCTION(0x4, "dev", "ad8",         V_98DX3236_PLUS)),
    MPP_MODE(1,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),         V_98DX3236_PLUS),
    ...
    MPP_FUNC_CTRL(0, 48, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
    ...
    MPP_FUNC_CTRL(0, 66, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
    ...
    MPP_FUNC_CTRL(0, 32, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
...
#[no_mangle]
unsafe extern "C" fn armada_xp_pinctrl_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_xp_pinctrl_probe(pdev: *mut platform_device) -> c_int {
