...
//! Source: drivers/pinctrl/mvebu/pinctrl-armada-37xx.c
#![no_std]
...
pub const OUTPUT_EN: c_uint = 0x0;
pub const INPUT_VAL: c_uint = 0x10;
pub const OUTPUT_VAL: c_uint = 0x18;
pub const OUTPUT_CTL: c_uint = 0x20;
pub const SELECTION: c_uint = 0x30;
pub const IRQ_EN: c_uint = 0x0;
pub const IRQ_POL: c_uint = 0x08;
pub const IRQ_STATUS: c_uint = 0x10;
pub const IRQ_WKUP: c_uint = 0x18;
pub const NB_FUNCS: c_int = 3;
pub const GPIO_PER_REG: c_int = 32;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_37xx_pin_group {
    pub name: *const c_char,
    pub start_pin: c_uint,
    pub npins: c_uint,
    pub reg_mask: u32,
    pub val: [u32; NB_FUNCS],
    pub extra_pin: c_uint,
    pub extra_npins: c_uint,
    pub funcs: [*const c_char; NB_FUNCS],
    pub pins: *mut c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_37xx_pin_data {
    pub nr_pins: u8,
    pub name: *mut c_char,
    pub groups: *mut armada_37xx_pin_group,
    pub ngroups: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_37xx_pmx_func {
    pub name: *const c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_37xx_pm_state {
    pub out_en_l: u32,
    pub out_en_h: u32,
    pub out_val_l: u32,
    pub out_val_h: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_37xx_pinctrl {
    pub regmap: *mut regmap,
    pub base: *mut void __iomem,
    pub data: *const armada_37xx_pin_data,
    pub dev: *mut device,
    ...
    pub groups: *mut armada_37xx_pin_group,
    pub ngroups: c_uint,
    pub funcs: *mut armada_37xx_pmx_func,
    pub nfuncs: c_uint,
    pub pm: armada_37xx_pm_state,
}
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn armada_37xx_pmx_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = info->funcs[selector].ngroups;
    ...
    let mut reg: c_uint = SELECTION;
    let mut mask: c_uint = grp.reg_mask;
    int func, val;
    ...
    {
    struct armada_37xx_pinctrl *info = gpiochip_get_data(chip);
    let mut en_offset: c_uint = offset;
    let mut reg: c_uint = OUTPUT_VAL;
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
    static int armada_37xx_gpio_get(struct gpio_chip *chip, unsigned int offset)
    {
    struct armada_37xx_pinctrl *info = gpiochip_get_data(chip);
    let mut reg: c_uint = INPUT_VAL;
    unsigned int val, mask;
    int ret;
    armada_37xx_update_reg(&reg, &offset);
    mask = BIT(offset);
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_irq_ack(d: *mut irq_data) {
    static void armada_37xx_irq_ack(struct irq_data *d)
    {
    struct gpio_chip *chip = irq_data_get_irq_chip_data(d);
    struct armada_37xx_pinctrl *info = gpiochip_get_data(chip);
    let mut reg: u32 = IRQ_STATUS;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_irq_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
// Set initial polarity based on current input level.
    ...
    u32 pin_idx)
    {
    let mut reg_idx: u32 = pin_idx / GPIO_PER_REG;
    let mut bit_num: u32 = pin_idx % GPIO_PER_REG;
    unsigned long flags;
    u32 p, l;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_irq_handler(desc: *mut irq_desc) {
...
// Manage only the interrupt that was enabled
    ...
    raw_spin_unlock_irqrestore(&info.irq_lock, flags);
    while (status) {
    let mut hwirq: u32 = ffs(status) - 1;
    u32 virq = irq_find_mapping(d, hwirq +
    i * GPIO_PER_REG);
    let mut t: u32 = irq_get_trigger_type(virq);
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_irq_startup(d: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
//
    ...
    let mut irq: c_int = irq_of_parse_and_map(np, i);
    if (!irq)
    continue;
    girq.parents[i] = irq;
    }
...
//
#[no_mangle]
unsafe extern "C" fn armada_37xx_fill_group(info: *mut armada_37xx_pinctrl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn armada_37xx_fill_func(info: *mut armada_37xx_pinctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_3700_pinctrl_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada_3700_pinctrl_resume(dev: *mut device) -> c_int {
...
//
    ...
    let mut irq_bit: u32 = BIT(i % GPIO_PER_REG);
...
#[no_mangle]
unsafe extern "C" fn armada_37xx_pinctrl_probe(pdev: *mut platform_device) -> int __init {
