...
//! Source: drivers/pinctrl/mvebu/pinctrl-armada-cp110.c
#![no_std]
...
//
    ...
    MPP_FUNCTION(3,	"mss_gpio4",	core::ptr::null_mut()),
    ...
    MPP_FUNCTION(3,	"mss_gpio5",	core::ptr::null_mut()),
    ...
    MPP_FUNCTION(3,	"mss_gpio6",	core::ptr::null_mut()),
    ...
    MPP_FUNCTION(3,	"mss_gpio7",	core::ptr::null_mut()),
    ...
    MPP_FUNCTION(10,	"mss_gpio0",	core::ptr::null_mut())),
    MPP_MODE(33,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    ...
    MPP_FUNCTION(10,	"mss_gpio1",	core::ptr::null_mut())),
    MPP_MODE(34,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    ...
    MPP_FUNCTION(10,	"mss_gpio2",	core::ptr::null_mut())),
    MPP_MODE(35,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    ...
    MPP_FUNCTION(10,	"mss_gpio3",	core::ptr::null_mut())),
    MPP_MODE(36,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    ...
    MPP_FUNCTION(8,	"ge",		"mdc"),
    MPP_FUNCTION(9,	"pcie2",	"clkreq"),
    MPP_FUNCTION(10,	"mss_gpio5",	core::ptr::null_mut())),
    MPP_MODE(37,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    ...
    MPP_FUNCTION(9,	"pcie1",	"clkreq"),
    MPP_FUNCTION(10,	"mss_gpio6",	core::ptr::null_mut()),
    ...
    MPP_FUNCTION(10,	"mss_gpio7",	core::ptr::null_mut()),
    MPP_FUNCTION(11,	"ptp",		"pulse_cp2cp")),
    MPP_MODE(39,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    ...
    MPP_FUNCTION(8,	"xg",		"mdc"),
    MPP_FUNCTION(9,	"sata0",	"present_act"),
    MPP_FUNCTION(10,	"mss_gpio4",	core::ptr::null_mut())),
    MPP_MODE(43,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    ...
    MPP_MODE(59,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    MPP_FUNCTION(1,	"mss_gpio7",	core::ptr::null_mut()),
    MPP_FUNCTION(2,	"synce2",	"clk"),
    MPP_FUNCTION(4,	"tdm",		"fsync"),
    MPP_FUNCTION(5,	"au",		"i2slrclk"),
    MPP_FUNCTION(6,	"spi0",		"csn0"),
    ...
    MPP_MODE(60,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    MPP_FUNCTION(1,	"mss_gpio6",	core::ptr::null_mut()),
    MPP_FUNCTION(3,	"ptp",		"pulse"),
    MPP_FUNCTION(4,	"tdm",		"dtx"),
    MPP_FUNCTION(5,	"au",		"i2smclk"),
    MPP_FUNCTION(6,	"spi0",		"csn1"),
    ...
    MPP_MODE(61,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    MPP_FUNCTION(1,	"mss_gpio5",	core::ptr::null_mut()),
    MPP_FUNCTION(3,	"ptp",		"clk"),
    MPP_FUNCTION(4,	"tdm",		"pclk"),
    MPP_FUNCTION(5,	"au",		"i2sextclk"),
    ...
    MPP_MODE(62,
    MPP_FUNCTION(0,	"gpio",		core::ptr::null_mut()),
    MPP_FUNCTION(1,	"mss_gpio4",	core::ptr::null_mut()),
    MPP_FUNCTION(2,	"synce1",	"clk"),
    MPP_FUNCTION(3,	"ptp",		"pclk_out"),
    ...
    MPP_FUNC_CTRL(0, 62, core::ptr::null_mut(), mvebu_regmap_mpp_ctrl),
    };
...
#[no_mangle]
unsafe extern "C" fn armada_cp110_pinctrl_probe(pdev: *mut platform_device) -> c_int {
