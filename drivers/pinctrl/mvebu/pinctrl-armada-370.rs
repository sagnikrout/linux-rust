...
//! Source: drivers/pinctrl/mvebu/pinctrl-armada-370.c
#![no_std]
...
//
    ...
    MPP_MODE(0,
    MPP_FUNCTION(0x0, "gpio", core::ptr::null_mut()),
    MPP_FUNCTION(0x1, "uart0", "rxd")),
    MPP_MODE(1,
    MPP_FUNCTION(0x0, "gpo", core::ptr::null_mut()),
    ...
    MPP_MODE(31,
    MPP_FUNCTION(0x0, "gpio", core::ptr::null_mut()),
    MPP_FUNCTION(0x3, "tclk", core::ptr::null_mut()),
    ...
    MPP_FUNCTION(0x2, "tclk", core::ptr::null_mut())),
    MPP_MODE(64,
    MPP_FUNCTION(0x0, "gpio", core::ptr::null_mut()),
    ...
    MPP_FUNC_CTRL(0, 65, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
...
#[no_mangle]
unsafe extern "C" fn armada_370_pinctrl_probe(pdev: *mut platform_device) -> c_int {
