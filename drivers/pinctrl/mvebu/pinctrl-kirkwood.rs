...
//! Source: drivers/pinctrl/mvebu/pinctrl-kirkwood.c
#![no_std]
...
//
    ...
    MPP_MODE(0,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(1, 1, 1, 1, 1, 1, 1)),
    MPP_VAR_FUNCTION(0x1, "nand", "io2",     V(1, 1, 1, 1, 1, 1, 1)),
    MPP_VAR_FUNCTION(0x2, "spi", "cs",       V(1, 1, 1, 1, 1, 1, 1))),
    MPP_MODE(1,
    MPP_VAR_FUNCTION(0x0, "gpo", core::ptr::null_mut(),       V(1, 1, 1, 1, 1, 1, 1)),
    ...
    MPP_VAR_FUNCTION(0x5, "sata0", "act",    V(0, 1, 1, 1, 1, 0, 0))),
    MPP_MODE(12,
    MPP_VAR_FUNCTION(0x0, "gpo", core::ptr::null_mut(),       V(1, 1, 1, 0, 1, 0, 0)),
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(0, 0, 0, 1, 0, 0, 0)),
    ...
    MPP_VAR_FUNCTION(0xd, "mii", "crs",      V(1, 1, 1, 1, 1, 0, 0))),
    MPP_MODE(17,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(1, 1, 1, 1, 1, 0, 0)),
    ...
    MPP_MODE(20,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(0, 1, 1, 1, 1, 0, 1)),
    ...
    MPP_MODE(28,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(0, 1, 1, 1, 1, 0, 0)),
    ...
    MPP_MODE(33,
    MPP_VAR_FUNCTION(0x0, "gpo", core::ptr::null_mut(),       V(0, 1, 1, 1, 1, 0, 1)),
    ...
    MPP_MODE(34,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(0, 1, 1, 1, 1, 1, 1)),
    ...
    MPP_MODE(36,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(1, 0, 0, 1, 1, 1, 1)),
    ...
    MPP_MODE(45,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(0, 0, 0, 1, 1, 1, 1)),
    ...
    MPP_MODE(46,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(0, 0, 0, 1, 1, 0, 0)),
    ...
    MPP_MODE(49,
    MPP_VAR_FUNCTION(0x0, "gpio", core::ptr::null_mut(),      V(0, 0, 0, 1, 0, 1, 1)),
    MPP_VAR_FUNCTION(0x0, "gpo", core::ptr::null_mut(),       V(0, 0, 0, 0, 1, 0, 0)),
    ...
    MPP_FUNC_CTRL(0, 44, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
    ...
    MPP_FUNC_CTRL(0, 35, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
    ...
    MPP_FUNC_CTRL(0, 49, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
...
#[no_mangle]
unsafe extern "C" fn kirkwood_pinctrl_probe(pdev: *mut platform_device) -> c_int {
