...
//! Source: drivers/pinctrl/mvebu/pinctrl-armada-375.c
#![no_std]
...
//
    ...
    MPP_FUNC_CTRL(0, 69, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
...
#[no_mangle]
unsafe extern "C" fn armada_375_pinctrl_probe(pdev: *mut platform_device) -> c_int {
