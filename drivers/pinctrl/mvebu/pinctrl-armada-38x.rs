...
//! Source: drivers/pinctrl/mvebu/pinctrl-armada-38x.c
#![no_std]
...
//
    ...
    MPP_MODE(0,
    MPP_VAR_FUNCTION(0, "gpio",  core::ptr::null_mut(),         V_88F6810_PLUS),
    ...
    MPP_FUNC_CTRL(0, 59, core::ptr::null_mut(), mvebu_mmio_mpp_ctrl),
    };
...
#[no_mangle]
unsafe extern "C" fn armada_38x_pinctrl_probe(pdev: *mut platform_device) -> c_int {
