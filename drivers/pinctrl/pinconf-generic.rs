...
//! Source: drivers/pinctrl/pinconf-generic.c
#![no_std]
...
//
    ...
    PCONFDUMP(PIN_CONFIG_BIAS_BUS_HOLD, "input bias bus hold", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_BIAS_DISABLE, "input bias disabled", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_BIAS_HIGH_IMPEDANCE, "input bias high impedance", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_BIAS_PULL_DOWN, "input bias pull down", "ohms", true),
    PCONFDUMP(PIN_CONFIG_BIAS_PULL_PIN_DEFAULT,
    "input bias pull to pin specific state", "ohms", true),
    PCONFDUMP(PIN_CONFIG_BIAS_PULL_UP, "input bias pull up", "ohms", true),
    PCONFDUMP(PIN_CONFIG_DRIVE_OPEN_DRAIN, "output drive open drain", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_DRIVE_OPEN_SOURCE, "output drive open source", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_DRIVE_PUSH_PULL, "output drive push pull", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_DRIVE_STRENGTH, "output drive strength", "mA", true),
    PCONFDUMP(PIN_CONFIG_DRIVE_STRENGTH_UA, "output drive strength", "uA", true),
    PCONFDUMP(PIN_CONFIG_INPUT_DEBOUNCE, "input debounce", "usec", true),
    PCONFDUMP(PIN_CONFIG_INPUT_ENABLE, "input enabled", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_INPUT_SCHMITT, "input schmitt trigger", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_INPUT_SCHMITT_UV, "input schmitt threshold", "uV", true),
    PCONFDUMP(PIN_CONFIG_INPUT_SCHMITT_ENABLE, "input schmitt enabled", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_MODE_LOW_POWER, "pin low power", "mode", true),
    PCONFDUMP(PIN_CONFIG_OUTPUT_ENABLE, "output enabled", core::ptr::null_mut(), false),
    ...
    PCONFDUMP(PIN_CONFIG_SLEEP_HARDWARE_STATE, "sleep hardware state", core::ptr::null_mut(), false),
    PCONFDUMP(PIN_CONFIG_SLEW_RATE, "slew rate", core::ptr::null_mut(), true),
    PCONFDUMP(PIN_CONFIG_SKEW_DELAY, "skew delay", core::ptr::null_mut(), true),
...
// Print unit if available
    if (item.has_arg) {
    let mut val: u32 = pinconf_to_config_argument(config);
    if (item.format)
