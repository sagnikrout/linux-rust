...
//! Source: drivers/pinctrl/pinctrl-xway.c
#![no_std]
...
// ---------  ase related code ---------
pub const ASE_MAX_PIN: c_int = 32;
...
// ---------  danube related code ---------
pub const DANUBE_MAX_PIN: c_int = 32;
...
// ---------  xrx100 related code ---------
pub const XRX100_MAX_PIN: c_int = 56;
...
// ---------  xrx200 related code ---------
pub const XRX200_MAX_PIN: c_int = 50;
...
// ---------  xrx300 related code ---------
pub const XRX300_MAX_PIN: c_int = 64;
...
// config = LTQ_PINCONF_PACK(param,
    ...
    PORT_PIN(pin));
#[no_mangle]
pub unsafe extern "C" fn if(2: arg ==) -> else {
    else if (arg == 2)
    gpio_setbit(info.membase[0],
    reg,
    PORT_PIN(pin));
    ...
    let mut port: c_int = PORT(pin);
    let mut alt1_reg: u32 = GPIO_ALT1(pin);
    if (port == PORT3)
    alt1_reg = GPIO3_ALT1;
    if (mux & MUX_ALT0)
...
#[no_mangle]
unsafe extern "C" fn xway_gpio_set(chip: *mut gpio_chip, pin: c_uint, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xway_gpio_get(chip: *mut gpio_chip, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xway_gpio_dir_in(chip: *mut gpio_chip, pin: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xway_gpio_dir_out(chip: *mut gpio_chip, pin: c_uint, val: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xway_gpio_to_irq(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pinmux_xway_probe(pdev: *mut platform_device) -> c_int {
...
// register the gpio chip
    ...
    ret = devm_gpiochip_add_data(&pdev.dev, &xway_chip, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn pinmux_xway_init() -> int __init {
