...
//! Source: drivers/pinctrl/pinctrl-da850-pupd.c
#![no_std]
...
pub const DA850_PUPD_ENA: c_uint = 0x00;
pub const DA850_PUPD_SEL: c_uint = 0x04;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da850_pupd_data {
...
#[no_mangle]
unsafe extern "C" fn da850_pupd_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da850_pupd_probe(pdev: *mut platform_device) -> c_int {
