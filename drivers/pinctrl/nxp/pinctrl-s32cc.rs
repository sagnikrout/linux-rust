...
//! Source: drivers/pinctrl/nxp/pinctrl-s32cc.c
#![no_std]
...
pub const S32_PIN_ID_SHIFT: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn get_pin_no(pinmux: u32) -> u32 {
    static u32 get_pin_no(u32 pinmux)
    {
    return (pinmux & S32_PIN_ID_MASK) >> S32_PIN_ID_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn get_pin_func(pinmux: u32) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s32_pinctrl_mem_region {
    pub map: *mut regmap,
    pub pin_range: *const s32_pin_range,
    pub name: [c_char; 8],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s32_pinctrl_context {
    pub pads: *mut c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s32_pinctrl {
    pub dev: *mut device,
    pub pctl: *mut pinctrl_dev,
    pub regions: *mut s32_pinctrl_mem_region,
    pub info: *mut s32_pinctrl_soc_info,
    pub gpio_configs: list_head,
    pub gpio_configs_lock: spinlock_t,

    pub saved_context: s32_pinctrl_context,
    ...
    let mut mem_regions: c_uint = ipctl.info.soc_data.mem_regions;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn s32_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// npins = info->groups[selector].data.npins;
    ...
    unsigned long *cfgs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn s32_pmx_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
//
    let mut config: c_uint = S32_MSCR_IBE;
    let mut mask: c_uint = S32_MSCR_IBE | S32_MSCR_OBE;
...
#[no_mangle]
unsafe extern "C" fn s32_get_slew_regval(arg: c_int) -> c_int {
...
// mask |= S32_MSCR_ODE | S32_MSCR_OBE | S32_MSCR_IBE;
    ...
    {
    struct s32_pinctrl *ipctl = pinctrl_dev_get_drvdata(pctldev);
    let mut config: c_uint = 0, mask = 0;
    int i, ret;
...
#[no_mangle]
pub unsafe extern "C" fn s32_pinctrl_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn s32_pinctrl_resume(dev: *mut device) -> c_int {
...
// Initialise function
    ...
    struct regmap *map;
    void __iomem *base;
    let mut mem_regions: c_uint = info.soc_data.mem_regions;
    int ret;
