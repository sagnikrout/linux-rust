...
//! Source: drivers/pinctrl/aspeed/pinctrl-aspeed-g7-soc1.c
#![no_std]
...
pub const ASPEED_G7_SOC1_NR_PINS: c_int = 220;
pub const ASPEED_G7_SOC1_REG_WIDTH: c_int = 32;
pub const ASPEED_G7_SOC1_REG_STRIDE: c_int = 4;
pub const ASPEED_G7_SOC1_MUX_BASE: c_uint = 0x400;
pub const ASPEED_G7_SOC1_BIAS_BASE: c_uint = 0x480;
pub const ASPEED_G7_SOC1_DRV_BASE: c_uint = 0x4C0;
pub const ASPEED_G7_SOC1_PCIE_REG: c_uint = 0x908;
pub const ASPEED_G7_SOC1_USB_MODE_REG: c_uint = 0x3B0;
pub const ASPEED_G7_SOC1_SGMII_REG: c_uint = 0x47C;
//
...
//
pub const ASPEED_G7_SOC1_MUX_FUNC_MASK: c_uint = 0x7;
pub const ASPEED_G7_SOC1_MUX_BITS_PER_PIN: c_int = 4;

    (ASPEED_G7_SOC1_REG_WIDTH / ASPEED_G7_SOC1_MUX_BITS_PER_PIN)
pub const ASPEED_G7_SOC1_BIAS_FUNC_MASK: c_uint = 0x1;
pub const ASPEED_G7_SOC1_BIAS_BITS_PER_PIN: c_int = 1;

    (ASPEED_G7_SOC1_REG_WIDTH / ASPEED_G7_SOC1_BIAS_BITS_PER_PIN)
pub const ASPEED_G7_SOC1_DRV_FUNC_MASK: c_uint = 0x3;
pub const ASPEED_G7_SOC1_DRV_BITS_PER_PIN: c_int = 2;

    (ASPEED_G7_SOC1_REG_WIDTH / ASPEED_G7_SOC1_DRV_BITS_PER_PIN)
pub const ASPEED_G7_SOC1_DRV_STRENGTH_STEP_MA: c_int = 4;
pub const ASPEED_G7_SOC1_DRV_STRENGTH_HW_BASE: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_g7_soc1_pinctrl {
    pub dev: *mut device,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_g7_soc1_function {
    pub pinfunction: pinfunction,
    pub muxvals: *const u8,
}
...
// val = (strength / ASPEED_G7_SOC1_DRV_STRENGTH_STEP_MA) -
    ...
    let mut val: c_uint = soc1_func.muxvals[g_idx];
...
#[no_mangle]
unsafe extern "C" fn aspeed_g7_soc1_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g7_soc1_pinctrl_init() -> int __init {
