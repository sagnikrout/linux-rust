...
//! Source: drivers/pinctrl/aspeed/pinctrl-aspeed-g4.c
#![no_std]
...
//
pub const ASPEED_G4_NR_PINS: c_int = 224;
...
#[no_mangle]
unsafe extern "C" fn aspeed_g4_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g4_pinctrl_init() -> c_int {
