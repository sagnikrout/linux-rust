...
//! Source: drivers/pinctrl/aspeed/pinctrl-aspeed-g7-soc0.c
#![no_std]
...
pub const SCU200: c_uint = 0x200 /* System Reset Control #1  */;
pub const SCU010: c_uint = 0x010 /* Hardware Strap Register */;
pub const SCU400: c_uint = 0x400 /* Multi-function Pin Control #1  */;
pub const SCU404: c_uint = 0x404 /* Multi-function Pin Control #2  */;
pub const SCU408: c_uint = 0x408 /* Multi-function Pin Control #3  */;
pub const SCU40C: c_uint = 0x40C /* Multi-function Pin Control #3  */;
pub const SCU410: c_uint = 0x410 /* USB Multi-function Control Register  */;
pub const SCU414: c_uint = 0x414 /* VGA Function Control Register  */;
pub const SCU480: c_uint = 0x480 /* GPIO18A0 IO Control Register */;
pub const SCU484: c_uint = 0x484 /* GPIO18A1 IO Control Register */;
pub const SCU488: c_uint = 0x488 /* GPIO18A2 IO Control Register */;
pub const SCU48C: c_uint = 0x48c /* GPIO18A3 IO Control Register */;
pub const SCU490: c_uint = 0x490 /* GPIO18A4 IO Control Register */;
pub const SCU494: c_uint = 0x494 /* GPIO18A5 IO Control Register */;
pub const SCU498: c_uint = 0x498 /* GPIO18A6 IO Control Register */;
pub const SCU49C: c_uint = 0x49c /* GPIO18A7 IO Control Register */;
pub const SCU4A0: c_uint = 0x4A0 /* GPIO18B0 IO Control Register */;
pub const SCU4A4: c_uint = 0x4A4 /* GPIO18B1 IO Control Register */;
pub const SCU4A8: c_uint = 0x4A8 /* GPIO18B2 IO Control Register */;
pub const SCU4AC: c_uint = 0x4AC /* GPIO18B3 IO Control Register */;
    enum {
    AC14,
    AE15,
    AD14,
...
#[no_mangle]
unsafe extern "C" fn aspeed_g7_soc0_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g7_soc0_pinctrl_init() -> int __init {
