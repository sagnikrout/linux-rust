...
//! Source: drivers/pinctrl/aspeed/pinctrl-aspeed-g5.c
#![no_std]
...
//
pub const SCU2C: c_uint = 0x2C /* Misc. Control Register */;
pub const SCU3C: c_uint = 0x3C /* System Reset Control/Status Register */;
pub const SCU48: c_uint = 0x48 /* MAC Interface Clock Delay Setting */;
pub const HW_STRAP1: c_uint = 0x70 /* AST2400 strapping is 33 bits, is split */;
pub const HW_REVISION_ID: c_uint = 0x7C /* Silicon revision ID register */;
pub const SCU80: c_uint = 0x80 /* Multi-function Pin Control #1 */;
pub const SCU84: c_uint = 0x84 /* Multi-function Pin Control #2 */;
pub const SCU88: c_uint = 0x88 /* Multi-function Pin Control #3 */;
pub const SCU8C: c_uint = 0x8C /* Multi-function Pin Control #4 */;
pub const SCU90: c_uint = 0x90 /* Multi-function Pin Control #5 */;
pub const SCU94: c_uint = 0x94 /* Multi-function Pin Control #6 */;
pub const SCUA0: c_uint = 0xA0 /* Multi-function Pin Control #7 */;
pub const SCUA4: c_uint = 0xA4 /* Multi-function Pin Control #8 */;
pub const SCUA8: c_uint = 0xA8 /* Multi-function Pin Control #9 */;
pub const SCUAC: c_uint = 0xAC /* Multi-function Pin Control #10 */;
pub const HW_STRAP2: c_uint = 0xD0 /* Strapping */;
pub const ASPEED_G5_NR_PINS: c_int = 236;

// LHCR0 is offset from the end of the H8S/2168-compatible registers
pub const LHCR0: c_uint = 0xa0;
pub const GFX064: c_uint = 0x64;
pub const B14: c_int = 0;
    SSSF_PIN_DECL(B14, GPIOA0, MAC1LINK, SIG_DESC_SET(SCU80, 0));
pub const D14: c_int = 1;
    SSSF_PIN_DECL(D14, GPIOA1, MAC2LINK, SIG_DESC_SET(SCU80, 1));
pub const D13: c_int = 2;
...
// On AST2500, Set bits in SCU70 are cleared from SCU7C
    if (desc.ip == ASPEED_IP_SCU && desc.reg == HW_STRAP1) {
    let mut value: u32 = ~val & desc.mask;
    if (value) {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g5_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g5_pinctrl_init() -> c_int {
