...
//! Source: drivers/pinctrl/aspeed/pinctrl-aspeed-g6.c
#![no_std]
...
pub const SCU040: c_uint = 0x040 /* Reset Control Set 1  */;
pub const SCU400: c_uint = 0x400 /* Multi-function Pin Control #1  */;
pub const SCU404: c_uint = 0x404 /* Multi-function Pin Control #2  */;
pub const SCU40C: c_uint = 0x40C /* Multi-function Pin Control #3  */;
pub const SCU410: c_uint = 0x410 /* Multi-function Pin Control #4  */;
pub const SCU414: c_uint = 0x414 /* Multi-function Pin Control #5  */;
pub const SCU418: c_uint = 0x418 /* Multi-function Pin Control #6  */;
pub const SCU41C: c_uint = 0x41C /* Multi-function Pin Control #7  */;
pub const SCU430: c_uint = 0x430 /* Multi-function Pin Control #8  */;
pub const SCU434: c_uint = 0x434 /* Multi-function Pin Control #9  */;
pub const SCU438: c_uint = 0x438 /* Multi-function Pin Control #10 */;
pub const SCU440: c_uint = 0x440 /* USB Multi-function Pin Control #12 */;
pub const SCU450: c_uint = 0x450 /* Multi-function Pin Control #14 */;
pub const SCU454: c_uint = 0x454 /* Multi-function Pin Control #15 */;
pub const SCU458: c_uint = 0x458 /* Multi-function Pin Control #16 */;
pub const SCU4B0: c_uint = 0x4B0 /* Multi-function Pin Control #17 */;
pub const SCU4B4: c_uint = 0x4B4 /* Multi-function Pin Control #18 */;
pub const SCU4B8: c_uint = 0x4B8 /* Multi-function Pin Control #19 */;
pub const SCU4BC: c_uint = 0x4BC /* Multi-function Pin Control #20 */;
pub const SCU4D4: c_uint = 0x4D4 /* Multi-function Pin Control #22 */;
pub const SCU4D8: c_uint = 0x4D8 /* Multi-function Pin Control #23 */;
pub const SCU500: c_uint = 0x500 /* Hardware Strap 1 */;
pub const SCU510: c_uint = 0x510 /* Hardware Strap 2 */;
pub const SCU610: c_uint = 0x610 /* Disable GPIO Internal Pull-Down #0 */;
pub const SCU614: c_uint = 0x614 /* Disable GPIO Internal Pull-Down #1 */;
pub const SCU618: c_uint = 0x618 /* Disable GPIO Internal Pull-Down #2 */;
pub const SCU61C: c_uint = 0x61c /* Disable GPIO Internal Pull-Down #3 */;
pub const SCU630: c_uint = 0x630 /* Disable GPIO Internal Pull-Down #4 */;
pub const SCU634: c_uint = 0x634 /* Disable GPIO Internal Pull-Down #5 */;
pub const SCU638: c_uint = 0x638 /* Disable GPIO Internal Pull-Down #6 */;
pub const SCU690: c_uint = 0x690 /* Multi-function Pin Control #24 */;
pub const SCU694: c_uint = 0x694 /* Multi-function Pin Control #25 */;
pub const SCU69C: c_uint = 0x69C /* Multi-function Pin Control #27 */;
pub const SCU6D0: c_uint = 0x6D0 /* Multi-function Pin Control #29 */;
pub const SCUC20: c_uint = 0xC20 /* PCIE configuration Setting Control */;
pub const ASPEED_G6_NR_PINS: c_int = 258;
pub const M24: c_int = 0;
...
pub const D22: c_int = 40;
    SIG_EXPR_LIST_DECL_SESG(D22, SD1CLK, SD1, SIG_DESC_SET(SCU414, 8));
    SIG_EXPR_LIST_DECL_SEMG(D22, PWM8, PWM8G0, PWM8, SIG_DESC_SET(SCU4B4, 8));
    PIN_DECL_2(D22, GPIOF0, SD1CLK, PWM8);
    GROUP_DECL(PWM8G0, D22);
pub const E22: c_int = 41;
...
//
    ...
    let mut pattern: u32 = enable ? desc.enable : desc.disable;
    let mut val: u32 = (pattern << __ffs(desc.mask));
    bool is_strap;
    if (!ctx.maps[desc.ip])
    return -ENODEV;
...
//
    let mut clear: u32 = ~val & desc.mask;
    let mut w1c: u32 = desc.reg + 4;
    if (clear)
...
#[no_mangle]
unsafe extern "C" fn aspeed_g6_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_g6_pinctrl_init() -> c_int {
