...
//! Source: drivers/pinctrl/aspeed/pinmux-aspeed.h
#![no_std]
...
//
pub const ASPEED_IP_SCU: c_int = 0;
pub const ASPEED_IP_GFX: c_int = 1;
pub const ASPEED_IP_LPC: c_int = 2;
pub const ASPEED_NR_PINMUX_IPS: c_int = 3;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_sig_expr {
    pub signal: *const c_char,
    pub function: *const c_char,
    pub ndescs: c_int,
    pub descs: *const aspeed_sig_desc,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_pin_desc {
    pub name: *const c_char,
    pub prios: *const aspeed_sig_expr,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_pin_function {
    pub name: *const c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_pinmux_ops {
    pub enabled): *const *const aspeed_sig_expr expr, bool,
    pub enabled): *const *const aspeed_sig_expr expr, bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_pinmux_data {
    pub dev: *mut device,
    pub maps: [*mut regmap; ASPEED_NR_PINMUX_IPS],
    pub ops: *const aspeed_pinmux_ops,
    pub groups: *const aspeed_pin_group,
    pub ngroups: c_uint,
    pub functions: *const aspeed_pin_function,
