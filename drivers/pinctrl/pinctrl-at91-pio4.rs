...
//! Source: drivers/pinctrl/pinctrl-at91-pio4.c
#![no_std]
...
//
pub const ATMEL_PIO_MSKR: c_uint = 0x0000;
pub const ATMEL_PIO_CFGR: c_uint = 0x0004;

pub const ATMEL_PIO_DRVSTR_OFFSET: c_int = 16;

pub const ATMEL_PIO_PDSR: c_uint = 0x0008;
pub const ATMEL_PIO_LOCKSR: c_uint = 0x000C;
pub const ATMEL_PIO_SODR: c_uint = 0x0010;
pub const ATMEL_PIO_CODR: c_uint = 0x0014;
pub const ATMEL_PIO_ODSR: c_uint = 0x0018;
pub const ATMEL_PIO_IER: c_uint = 0x0020;
pub const ATMEL_PIO_IDR: c_uint = 0x0024;
pub const ATMEL_PIO_IMR: c_uint = 0x0028;
pub const ATMEL_PIO_ISR: c_uint = 0x002C;
pub const ATMEL_PIO_IOFR: c_uint = 0x003C;
pub const ATMEL_PIO_NPINS_PER_BANK: c_int = 32;

pub const ATMEL_PIO_BANK_OFFSET: c_uint = 0x40;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_pioctrl_data {
    pub nbanks: c_uint,
    pub last_bank_count: c_uint,
    pub slew_rate_support: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_group {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_pioctrl {
    pub reg_base: *mut void __iomem,
    pub clk: *mut clk,
    pub nbanks: c_uint,
    pub pinctrl_dev: *mut pinctrl_dev,
    pub groups: *mut atmel_group,
    pub group_names: *const *const c_char,
    pub pins: *mut atmel_pin,
    pub npins: c_uint,
    pub gpio_chip: *mut gpio_chip,
    pub irq_domain: *mut irq_domain,
    pub irqs: *mut c_int,
    pub pm_wakeup_sources: *mut c_uint,
    struct {
    pub imr: u32,
    pub odsr: u32,
    pub cfgr: [u32; ATMEL_PIO_NPINS_PER_BANK],
    pub pm_suspend_backup: *mut },
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_irq_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
    static int atmel_gpio_irq_set_wake(struct irq_data *d, unsigned int on)
    {
    struct atmel_pioctrl *atmel_pioctrl = irq_data_get_irq_chip_data(d);
    let mut bank: c_int = ATMEL_PIO_BANK(d.hwirq);
    let mut line: c_int = ATMEL_PIO_LINE(d.hwirq);
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_to_irq(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_gpio_set(chip: *mut gpio_chip, offset: c_uint, val: c_int) -> c_int {
...
// --- PINCTRL ---
    ...
    let mut bank: c_uint = atmel_pioctrl.pins[pin_id].bank;
    let mut line: c_uint = atmel_pioctrl.pins[pin_id].line;
...
#[no_mangle]
unsafe extern "C" fn atmel_pctl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// Want the device name not the group one.
    ...
    u32 pinfunc;
    int ret, i;
    pins = of_find_property(np, "pinmux", core::ptr::null_mut());
    if (!pins)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn atmel_pmx_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = atmel_pioctrl->npins;
    ...
    {
    struct atmel_pioctrl *atmel_pioctrl = pinctrl_dev_get_drvdata(pctldev);
    let mut param: c_uint = pinconf_to_config_param(*config), arg = 0;
    struct atmel_group *grp = atmel_pioctrl.groups + group;
    let mut pin_id: c_uint = grp.pin;
    u32 res;
...
// Keep slew rate enabled by default.
    ...
    let mut param: c_uint = pinconf_to_config_param(configs[i]);
    let mut arg: c_uint = pinconf_to_config_argument(configs[i]);
...
#[no_mangle]
unsafe extern "C" fn atmel_pctrl_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn atmel_pctrl_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn atmel_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
// if last bank has limited number of pins, adjust accordingly
    ...
    atmel_pioctrl.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
...
// One pin is one group since a pin can achieve all functions.
    ...
    let mut bank: c_uint = ATMEL_PIO_BANK(i);
    let mut line: c_uint = ATMEL_PIO_LINE(i);
...
// There is one controller but each bank has its own irq line.
    ...
    for (i = 0; i < atmel_pioctrl.npins; i++) {
    let mut irq: c_int = irq_create_mapping(atmel_pioctrl.irq_domain, i);
