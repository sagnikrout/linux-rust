...
//! Source: drivers/pinctrl/pinctrl-max77620.c
#![no_std]
...
pub const MAX77620_PIN_NUM: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_pin_function {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_pingroup {
    pub name: *const c_char,
    pub pins: [c_uint; 1],
    pub npins: c_uint,
    pub alt_option: enum max77620_alternate_pinmux_option,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_pin_info {
    pub drv_type: enum max77620_pin_ppdrv,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_fps_config {
    pub active_fps_src: c_int,
    pub active_power_up_slots: c_int,
    pub active_power_down_slots: c_int,
    pub suspend_fps_src: c_int,
    pub suspend_power_up_slots: c_int,
    pub suspend_power_down_slots: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_pctrl_info {
    pub dev: *mut device,
    pub pctl: *mut pinctrl_dev,
    pub rmap: *mut regmap,
    pub functions: *const max77620_pin_function,
    pub num_functions: c_uint,
    pub pin_groups: *const max77620_pingroup,
    pub num_pin_groups: c_int,
    pub pins: *const pinctrl_pin_desc,
    pub num_pins: c_uint,
    pub pin_info: [max77620_pin_info; MAX77620_PIN_NUM],
    pub fps_config: [max77620_fps_config; MAX77620_PIN_NUM],
}
...
#[no_mangle]
unsafe extern "C" fn max77620_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_pinctrl_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MAX77620_ACTIVE_FPS_POWER_ON_SLOTS: param ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(MAX77620_SUSPEND_FPS_POWER_ON_SLOTS: param ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn max77620_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_pinctrl_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_pinctrl_resume(dev: *mut device) -> c_int {
