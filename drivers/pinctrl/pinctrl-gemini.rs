...
//! Source: drivers/pinctrl/pinctrl-gemini.c
#![no_std]
...
pub struct gemini_pmx {
    ...
    pub is_3516: bool,
    pub flash_pin: bool,
    pub confs: *const gemini_pin_conf,
    pub nconfs: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gemini_pin_group {
    pub name: *const c_char,
    pub pins: *const c_uint,
    pub num_pins: c_uint,
    pub mask: u32,
    pub value: u32,
    pub driving_mask: u32,
}

// Some straight-forward control registers
pub const GLOBAL_WORD_ID: c_uint = 0x00;
pub const GLOBAL_STATUS: c_uint = 0x04;

pub const GLOBAL_IODRIVE: c_uint = 0x10;
pub const GLOBAL_GMAC_CTRL_SKEW: c_uint = 0x1c;
pub const GLOBAL_GMAC0_DATA_SKEW: c_uint = 0x20;
pub const GLOBAL_GMAC1_DATA_SKEW: c_uint = 0x24;
//
...
//
pub const GLOBAL_MISC_CTRL: c_uint = 0x30;
...
pub const GEMINI_GMAC_IOSEL_GMAC0_RGMII_GMAC1_GPIO2: c_int = 0;

pub const PADS_MAXBIT: c_int = 27;
...
#[no_mangle]
unsafe extern "C" fn gemini_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pmx->is_3516) -> else {
    else if (pmx.is_3516)
...
#[no_mangle]
unsafe extern "C" fn gemini_pmx_get_funcs_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// config = pinconf_to_config_packed(PIN_CONFIG_SKEW_DELAY, val);
    ...
    {
    struct gemini_pmx *pmx = pinctrl_dev_get_drvdata(pctldev);
    const struct gemini_pin_group *grp = core::ptr::null_mut();
    enum pin_config_param param;
    u32 arg;
    u32 val;
    int i;
...
#[no_mangle]
unsafe extern "C" fn gemini_pmx_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gemini_pmx_init() -> int __init {
