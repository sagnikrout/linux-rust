...
//! Source: drivers/pinctrl/actions/pinctrl-s700.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn s700_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s700_pinctrl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn s700_pinctrl_exit() -> void __exit {
