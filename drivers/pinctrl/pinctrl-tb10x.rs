...
//! Source: drivers/pinctrl/pinctrl-tb10x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tb10x_pinctrl {
    pub pctl: *mut pinctrl_dev,
    pub base: *mut void __iomem,
    pub pingroups: *const tb10x_pinfuncgrp,
    pub pinfuncgrpcnt: c_uint,
    pub pinfuncnt: c_uint,
    pub mutex: mutex,
    pub ports: [tb10x_port; TB10X_PORTS],
    pub 1): DECLARE_BITMAP(gpios, MAX_PIN +,
    pub pinfuncs: [tb10x_of_pinfunc; ],
}
...
#[no_mangle]
unsafe extern "C" fn tb10x_get_groups_count(pctl: *mut pinctrl_dev) -> c_int {
...
// num_pins = state->pingroups[n].pincnt;
    ...
    {
    const char *string;
    let mut reserved_maps: unsigned = 0;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn tb10x_get_functions_count(pctl: *mut pinctrl_dev) -> c_int {
...
// num_groups = 1;
    ...
    {
    struct tb10x_pinctrl *state = pinctrl_dev_get_drvdata(pctl);
    let mut muxport: c_int = -1;
    let mut muxmode: c_int = -1;
    int i;
...
#[no_mangle]
unsafe extern "C" fn tb10x_pinctrl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb10x_pinctrl_remove(pdev: *mut platform_device) {
