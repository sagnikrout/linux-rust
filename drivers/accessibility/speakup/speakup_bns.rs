...
//! Source: drivers/accessibility/speakup/speakup_bns.c
#![no_std]
...
pub const SYNTH_CLEAR: c_uint = 0x18;
    ...
    [RATE_ID] = { RATE, .u.n = {"\x05%dE", 8, 1, 16, 0, 0, core::ptr::null_mut() } },
    [PITCH_ID] = { PITCH, .u.n = {"\x05%dP", 8, 0, 16, 0, 0, core::ptr::null_mut() } },
    [VOL_ID] = { VOL, .u.n = {"\x05%dV", 8, 0, 16, 0, 0, core::ptr::null_mut() } },
    [TONE_ID] = { TONE, .u.n = {"\x05%dT", 8, 0, 16, 0, 0, core::ptr::null_mut() } },
