...
//! Source: drivers/accessibility/speakup/i18n.h
#![no_std]
...
extern "C" {
    pub fn spk_msg_set(index: msg_index_t, text: *mut c_char, length: usize) -> isize;
}
extern "C" {
    pub fn spk_reset_msg_group(group: *mut msg_group_t);
}
extern "C" {
    pub fn spk_initialize_msgs();
}
extern "C" {
    pub fn spk_free_user_msgs();
}
