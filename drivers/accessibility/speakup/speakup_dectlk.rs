...
//! Source: drivers/accessibility/speakup/speakup_dectlk.c
#![no_std]
...
pub const PROCSPEECH: c_uint = 0x0b;
    static int xoff;
#[no_mangle]
pub unsafe extern "C" fn synth_full() -> c_int {
    ...
    [RATE_ID] = { RATE, .u.n = {"[:ra %d] ", 180, 75, 650, 0, 0, core::ptr::null_mut() } },
    [PITCH_ID] = { PITCH, .u.n = {"[:dv ap %d] ", 122, 50, 350, 0, 0, core::ptr::null_mut() } },
    [INFLECTION_ID] = { INFLECTION, .u.n = {"[:dv pr %d] ", 100, 0, 10000, 0, 0, core::ptr::null_mut() } },
    [VOL_ID] = { VOL, .u.n = {"[:dv g5 %d] ", 86, 60, 86, 0, 0, core::ptr::null_mut() } },
...
#[no_mangle]
unsafe extern "C" fn is_indnum(ch: *mut u_char) -> c_int {
...
unsafe extern "C" fn do_catch_up(synth: *mut spk_synth) {
    static void do_catch_up(struct spk_synth *synth)
    {
    let mut synth_full_val: c_int = 0;
    static u_char ch;
    let mut last: static u_char = '\0';
    unsigned long flags;
