...
//! Source: drivers/accessibility/speakup/speakup_audptr.c
#![no_std]
...
pub const SYNTH_CLEAR: c_uint = 0x18 /* flush synth buffer */;
    ...
    [RATE_ID] = { RATE, .u.n = {"\x05[r%d]", 10, 0, 20, 100, -10, core::ptr::null_mut() } },
    [PITCH_ID] = { PITCH, .u.n = {"\x05[f%d]", 80, 39, 4500, 0, 0, core::ptr::null_mut() } },
    [VOL_ID] = { VOL, .u.n = {"\x05[g%d]", 21, 0, 40, 0, 0, core::ptr::null_mut() } },
    [TONE_ID] = { TONE, .u.n = {"\x05[s%d]", 9, 0, 63, 0, 0, core::ptr::null_mut() } },
...
#[no_mangle]
unsafe extern "C" fn synth_version(synth: *mut spk_synth) {
