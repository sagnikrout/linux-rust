...
//! Source: drivers/accessibility/speakup/speakup_apollo.c
#![no_std]
...
pub const SYNTH_CLEAR: c_uint = 0x18;
    ...
    [RATE_ID] = { RATE, .u.n = {"@W%d", 6, 1, 9, 0, 0, core::ptr::null_mut() } },
    [PITCH_ID] = { PITCH, .u.n = {"@F%x", 10, 0, 15, 0, 0, core::ptr::null_mut() } },
    [VOL_ID] = { VOL, .u.n = {"@A%x", 10, 0, 15, 0, 0, core::ptr::null_mut() } },
    [VOICE_ID] = { VOICE, .u.n = {"@V%d", 1, 1, 6, 0, 0, core::ptr::null_mut() } },
    [LANG_ID] = { LANG, .u.n = {"@=%d,", 1, 1, 4, 0, 0, core::ptr::null_mut() } },
