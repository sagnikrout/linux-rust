...
//! Source: drivers/accessibility/speakup/main.c
#![no_std]
...
// Speakup Cursor Track Variables
    let mut cursor_track: static enum cursor_track = 1, prev_cursor_track = 1;
...
#[no_mangle]
unsafe extern "C" fn get_attributes(vc: *mut vc_data, pos: *mut u16) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn speakup_date(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn bleep(val: u16) {
    ...
    short freq;
    let mut time: c_int = spk_bleep_time;
    freq = vals[val % 12];
    if (val > 11)
    freq *= (1 << (val / 12));
...
#[no_mangle]
unsafe extern "C" fn speakup_shut_up(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speech_kill(vc: *mut vc_data) {
    static void speech_kill(struct vc_data *vc)
    {
    let mut val: c_char = synth.is_alive(synth);
    if (val == 0)
    return;
...
#[no_mangle]
unsafe extern "C" fn speakup_off(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speakup_parked(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speakup_cut(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speakup_paste(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn say_attributes(vc: *mut vc_data) {
    static void say_attributes(struct vc_data *vc)
    {
    let mut fg: c_int = spk_attr & 0x0f;
    let mut bg: c_int = spk_attr >> 4;
...
#[no_mangle]
unsafe extern "C" fn announce_edge(vc: *mut vc_data, msg_id: enum edge) {
...
#[no_mangle]
unsafe extern "C" fn speak_char(ch: u16) {
    ...
    if (!cp) {
    pr_info("%s: cp == core::ptr::null_mut()!\n", __func__);
    return;
    }
    if (IS_CHAR(ch, B_CAP)) {
    spk_pitch_shift++;
...
#[no_mangle]
unsafe extern "C" fn get_char(vc: *mut vc_data, pos: *mut u16, attribs: *mut u_char) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn say_char(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn say_phonetic_char(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn say_prev_char(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn say_next_char(vc: *mut vc_data) {
...
//
#[no_mangle]
unsafe extern "C" fn get_word(vc: *mut vc_data) -> u_long {
    static u_long get_word(struct vc_data *vc)
    {
    let mut cnt: u_long = 0, tmpx = spk_x, tmp_pos = spk_pos;
    u16 ch;
    u16 attr_ch;
    u_char temp;
    spk_old_attr = spk_attr;
...
#[no_mangle]
unsafe extern "C" fn say_word(vc: *mut vc_data) {
    static void say_word(struct vc_data *vc)
    {
    let mut cnt: u_long = get_word(vc);
    let mut saved_punc_mask: u16 = spk_punc_mask;
    if (cnt == 0)
    return;
    spk_punc_mask = PUNC;
    buf[cnt++] = SPACE;
...
#[no_mangle]
unsafe extern "C" fn say_prev_word(vc: *mut vc_data) {
    static void say_prev_word(struct vc_data *vc)
    {
    u_char temp;
    u16 ch;
    let mut edge_said: enum edge = edge_none;
    let mut last_state: u16 = 0, state = 0;
    spk_parked |= 0x01;
    if (spk_x == 0) {
    if (spk_y == 0) {
    ...
    state = 0;
#[no_mangle]
pub unsafe extern "C" fn if(IS_WDLM(ch): ch < 0x100 &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn say_next_word(vc: *mut vc_data) {
    static void say_next_word(struct vc_data *vc)
    {
    u_char temp;
    u16 ch;
    let mut edge_said: enum edge = edge_none;
    let mut last_state: u16 = 2, state = 0;
    spk_parked |= 0x01;
...
#[no_mangle]
unsafe extern "C" fn spell_word(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn get_line(vc: *mut vc_data) -> c_int {
    static int get_line(struct vc_data *vc)
    {
    let mut tmp: u_long = spk_pos - (spk_x * 2);
    let mut i: c_int = 0;
    u_char tmp2;
    spk_old_attr = spk_attr;
    spk_attr = get_attributes(vc, (u16 *)spk_pos);
...
#[no_mangle]
unsafe extern "C" fn say_line(vc: *mut vc_data) {
    static void say_line(struct vc_data *vc)
    {
    let mut i: c_int = get_line(vc);
    u16 *cp;
    let mut saved_punc_mask: u16 = spk_punc_mask;
    if (i == 0) {
...
#[no_mangle]
unsafe extern "C" fn say_prev_line(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn say_next_line(vc: *mut vc_data) {
    ...
    int read_punc)
    {
    let mut start: u_long = vc.vc_origin + (spk_y * vc.vc_size_row);
    let mut end: u_long = start + (to * 2);
    start += from * 2;
...
#[no_mangle]
unsafe extern "C" fn say_sentence_num(num: c_int, prev: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_sentence_buf(vc: *mut vc_data, read_punc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn say_screen_from_to(vc: *mut vc_data, from: u_long, to: u_long) {
    static void say_screen_from_to(struct vc_data *vc, u_long from, u_long to)
    {
    let mut start: u_long = vc.vc_origin, end;
    if (from > 0)
...
#[no_mangle]
unsafe extern "C" fn say_screen(vc: *mut vc_data) {
    static void say_screen(struct vc_data *vc)
    {
    say_screen_from_to(vc, 0, vc.vc_rows);
    }
#[no_mangle]
unsafe extern "C" fn speakup_win_say(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn top_edge(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn bottom_edge(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn left_edge(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn right_edge(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn say_first_char(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn say_last_char(vc: *mut vc_data) {
    static void say_last_char(struct vc_data *vc)
    {
    let mut len: c_int = get_line(vc);
    u16 ch;
    spk_parked |= 0x01;
    if (len == 0) {
    synth_printf("%s\n", spk_msg_get(MSG_BLANK));
...
#[no_mangle]
unsafe extern "C" fn say_position(vc: *mut vc_data) {
...
// Added by brianb
#[no_mangle]
unsafe extern "C" fn say_char_num(vc: *mut vc_data) {
    static void say_char_num(struct vc_data *vc)
    {
    u_char tmp;
    let mut ch: u16 = get_char(vc, (u16 *)spk_pos, &tmp);
    synth_printf(spk_msg_get(MSG_CHAR_INFO), ch, ch);
    }
// these are stub functions to keep keyboard.c happy.
#[no_mangle]
unsafe extern "C" fn say_from_top(vc: *mut vc_data) {
    static void say_from_top(struct vc_data *vc)
    {
    say_screen_from_to(vc, 0, spk_y);
    }
#[no_mangle]
unsafe extern "C" fn say_to_bottom(vc: *mut vc_data) {
    static void say_to_bottom(struct vc_data *vc)
    {
    say_screen_from_to(vc, spk_y, vc.vc_rows);
    }
#[no_mangle]
unsafe extern "C" fn say_from_left(vc: *mut vc_data) {
    static void say_from_left(struct vc_data *vc)
    {
    say_line_from_to(vc, 0, spk_x, 1);
    }
#[no_mangle]
unsafe extern "C" fn say_to_right(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn spkup_write(in_buf: *const u16, count: c_int) {
    static void spkup_write(const u16 *in_buf, int count)
    {
    static int rep_count;
    let mut ch: static u16 = '\0', old_ch = '\0';
    static u16 char_type, last_type;
    let mut in_count: c_int = count;
    spk_keydown = 0;
    while (count--) {
    if (cursor_track == read_all_mode) {
...
// send space and record position, if next is num overwrite space
    ...
    let mut NUM_CTL_LABELS: static int = (MSG_CTL_END - MSG_CTL_START + 1);
    static void read_all_doc(struct vc_data *vc);
    static void cursor_done(struct timer_list *unused);
    static DEFINE_TIMER(cursor_timer, cursor_done);
#[no_mangle]
unsafe extern "C" fn do_handle_shift(vc: *mut vc_data, value: u_char, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn do_handle_latin(vc: *mut vc_data, value: u_char, up_flag: c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn spk_set_key_info(key_info: *const u_char, k_buffer: *mut u_char) -> c_int {
    int spk_set_key_info(const u_char *key_info, u_char *k_buffer)
    {
    let mut i: c_int = 0, states, key_data_len;
...
// bell must be first to set high limit
    [BELL_POS_ID] = { BELL_POS, .u.n = {core::ptr::null_mut(), 0, 0, 0, 0, 0, core::ptr::null_mut()} },
    [SPELL_DELAY_ID] = { SPELL_DELAY, .u.n = {core::ptr::null_mut(), 0, 0, 4, 0, 0, core::ptr::null_mut()} },
    [ATTRIB_BLEEP_ID] = { ATTRIB_BLEEP, .u.n = {core::ptr::null_mut(), 1, 0, 3, 0, 0, core::ptr::null_mut()} },
    [BLEEPS_ID] = { BLEEPS, .u.n = {core::ptr::null_mut(), 3, 0, 3, 0, 0, core::ptr::null_mut()} },
    [BLEEP_TIME_ID] = { BLEEP_TIME, .u.n = {core::ptr::null_mut(), 30, 1, 200, 0, 0, core::ptr::null_mut()} },
    [PUNC_LEVEL_ID] = { PUNC_LEVEL, .u.n = {core::ptr::null_mut(), 1, 0, 4, 0, 0, core::ptr::null_mut()} },
    [READING_PUNC_ID] = { READING_PUNC, .u.n = {core::ptr::null_mut(), 1, 0, 4, 0, 0, core::ptr::null_mut()} },
    [CURSOR_TIME_ID] = { CURSOR_TIME, .u.n = {core::ptr::null_mut(), 120, 50, 600, 0, 0, core::ptr::null_mut()} },
    [SAY_CONTROL_ID] = { SAY_CONTROL, TOGGLE_0},
    [SAY_WORD_CTL_ID] = {SAY_WORD_CTL, TOGGLE_0},
    [NO_INTERRUPT_ID] = { NO_INTERRUPT, TOGGLE_0},
    [KEY_ECHO_ID] = { KEY_ECHO, .u.n = {core::ptr::null_mut(), 1, 0, 2, 0, 0, core::ptr::null_mut()} },
    [CUR_PHONETIC_ID] = { CUR_PHONETIC, .u.n = {core::ptr::null_mut(), 0, 0, 1, 0, 0, core::ptr::null_mut()} },
    V_LAST_VAR
    };
#[no_mangle]
unsafe extern "C" fn toggle_cursoring(vc: *mut vc_data) {
...
#[no_mangle]
pub unsafe extern "C" fn spk_reset_default_chars() {
...
#[no_mangle]
pub unsafe extern "C" fn spk_reset_default_chartab() {
...
#[no_mangle]
unsafe extern "C" fn edit_bits(vc: *mut vc_data, type: u_char, ch: u_char, key: u16) -> c_int {
    static int edit_bits(struct vc_data *vc, u_char type, u_char ch, u16 key)
    {
    let mut mask: u16 = pb_edit.mask, ch_type = spk_chartab[ch];
    if (type != KT_LATIN || (ch_type & B_NUM) || ch < SPACE)
    return -1;
    if (ch == SPACE) {
    synth_printf("%s\n", spk_msg_get(MSG_EDIT_DONE));
    spk_special_handler = core::ptr::null_mut();
    return 1;
    }
...
#[no_mangle]
unsafe extern "C" fn speakup_allocate(vc: *mut vc_data, gfp_flags: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn speakup_deallocate(vc: *mut vc_data) {
    static void speakup_deallocate(struct vc_data *vc)
    {
    int vc_num;
    vc_num = vc.vc_num;
    kfree(speakup_console[vc_num]);
    speakup_console[vc_num] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn kbd_fakekey2(vc: *mut vc_data, command: enum read_all_command) {
...
#[no_mangle]
unsafe extern "C" fn read_all_doc(vc: *mut vc_data) {
    static void read_all_doc(struct vc_data *vc)
    {
...
#[no_mangle]
unsafe extern "C" fn stop_read_all(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn start_read_all_timer(vc: *mut vc_data, command: enum read_all_command) {
    static void start_read_all_timer(struct vc_data *vc, enum read_all_command command)
    {
...
#[no_mangle]
unsafe extern "C" fn handle_cursor_read_all(vc: *mut vc_data, command: enum read_all_command) {
...
#[no_mangle]
unsafe extern "C" fn pre_handle_cursor(vc: *mut vc_data, value: u_char, up_flag: c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_handle_cursor(vc: *mut vc_data, value: u_char, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn update_color_buffer(vc: *mut vc_data, ic: *const u16, len: c_int) {
    static void update_color_buffer(struct vc_data *vc, const u16 *ic, int len)
    {
    int i, bi, hi;
    let mut vc_num: c_int = vc.vc_num;
...
#[no_mangle]
unsafe extern "C" fn reset_highlight_buffers(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn count_highlight_color(vc: *mut vc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_highlight_color(vc: *mut vc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn speak_highlight(vc: *mut vc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cursor_done(unused: *mut timer_list) {
    static void cursor_done(struct timer_list *unused)
    {
    ...
    speakup_win_say(vc);
#[no_mangle]
pub unsafe extern "C" fn if(4: is_cursor == 1 || is_cursor ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn speakup_bs(vc: *mut vc_data) {
...
// called by: vt_notifier_call()
#[no_mangle]
unsafe extern "C" fn speakup_con_write(vc: *mut vc_data, str: *mut u16, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn speakup_con_update(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn do_handle_spec(vc: *mut vc_data, value: u_char, up_flag: c_char) {
    static void do_handle_spec(struct vc_data *vc, u_char value, char up_flag)
    {
    unsigned long flags;
    let mut on_off: c_int = 2;
    char *label;
    if (!synth || up_flag || spk_killed)
    return;
    spin_lock_irqsave(&speakup_info.spinlock, flags);
...
#[no_mangle]
unsafe extern "C" fn inc_dec_var(value: u_char) -> c_int {
    ...
    char *cp = num_buf;
    char *pn;
    let mut var_id: c_int = (int)value - VAR_START;
    let mut how: c_int = (var_id & 1) ? E_INC : E_DEC;
...
#[no_mangle]
unsafe extern "C" fn speakup_win_set(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speakup_win_clear(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speakup_win_enable(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speakup_bits(vc: *mut vc_data) {
    static void speakup_bits(struct vc_data *vc)
    {
    let mut val: c_int = this_speakup_key - (FIRST_EDIT_BITS - 1);
...
#[no_mangle]
unsafe extern "C" fn handle_goto(vc: *mut vc_data, type: u_char, ch: u_char, key: u16) -> c_int {
...
// Do not replace with kstrtoul: here we need cp to be updated
    ...
    goto_pos += spk_x;
#[no_mangle]
pub unsafe extern "C" fn if(0: goto_pos >) -> else {
    else if (goto_pos > 0)
    goto_pos--;
...
#[no_mangle]
unsafe extern "C" fn speakup_goto(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speakup_help(vc: *mut vc_data) {
    static void speakup_help(struct vc_data *vc)
    {
    spk_handle_help(vc, KT_SPKUP, SPEAKUP_HELP, 0);
    }
#[no_mangle]
unsafe extern "C" fn do_nothing(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn speakup_lock(vc: *mut vc_data) {
...
// must be ordered same as defines in speakup.h
    ...
    speakup_lock, speakup_help, toggle_cursoring, read_all_doc, core::ptr::null_mut()
    };
#[no_mangle]
unsafe extern "C" fn do_spkup(vc: *mut vc_data, value: u_char) {
    ...
    int kh;
    u_char *key_info;
    let mut type: u_char = KTYP(keysym), value = KVAL(keysym), new_key = 0;
...
// not used yet
    ...
    ret = NOTIFY_STOP;
#[no_mangle]
pub unsafe extern "C" fn if(KT_CUR: KTYP(param->value) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn speakup_exit() -> void __exit {
    ...
    speakup_task = core::ptr::null_mut();
...
// call by: module_init()
#[no_mangle]
unsafe extern "C" fn speakup_init() -> int __init {
...
// These first few initializations cannot fail.
    ...
    spk_set_mask_bits(core::ptr::null_mut(), i, 2);
...
//
    ...
    speakup_task = kthread_create(speakup_thread, core::ptr::null_mut(), "speakup");
