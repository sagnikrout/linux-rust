...
//! Source: drivers/accessibility/speakup/spk_ttyio.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spk_ldisc_data {
    pub buf: c_char,
    pub completion: completion,
    pub buf_free: bool,
    pub synth: *mut spk_synth,
}
...
#[no_mangle]
unsafe extern "C" fn ser_to_dev(ser: c_int, dev_no: *mut dev_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_dev_to_use(synth: *mut spk_synth, dev_no: *mut dev_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spk_ttyio_ldisc_open(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spk_ttyio_ldisc_close(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn spk_ttyio_initialise_ldisc(synth: *mut spk_synth) -> c_int {
    ...
    return PTR_ERR(tty);
    if (tty.ops.open)
    ret = tty.ops.open(tty, core::ptr::null_mut());
    else
    ret = -ENODEV;
    if (ret) {
    tty_unlock(tty);
...
#[no_mangle]
pub unsafe extern "C" fn spk_ttyio_unregister_ldisc() {
    void spk_ttyio_unregister_ldisc(void)
    {
    tty_unregister_ldisc(&spk_ttyio_ldisc_ops);
    }
#[no_mangle]
unsafe extern "C" fn spk_ttyio_out(in_synth: *mut spk_synth, ch: c_char) -> c_int {
    static int spk_ttyio_out(struct spk_synth *in_synth, const char ch)
    {
...
#[no_mangle]
unsafe extern "C" fn spk_ttyio_out_unicode(in_synth: *mut spk_synth, ch: u16) -> c_int {
    static int spk_ttyio_out_unicode(struct spk_synth *in_synth, u16 ch)
    {
    int ret;
    if (ch < 0x80) {
...
#[no_mangle]
unsafe extern "C" fn spk_ttyio_send_xchar(in_synth: *mut spk_synth, ch: c_char) {
    static void spk_ttyio_send_xchar(struct spk_synth *in_synth, char ch)
    {
    struct tty_struct *tty = in_synth.dev;
...
#[no_mangle]
unsafe extern "C" fn spk_ttyio_tiocmset(in_synth: *mut spk_synth, set: c_uint, clear: c_uint) {
    static void spk_ttyio_tiocmset(struct spk_synth *in_synth, unsigned int set, unsigned int clear)
    {
    struct tty_struct *tty = in_synth.dev;
    if (tty.ops.tiocmset)
...
#[no_mangle]
unsafe extern "C" fn spk_ttyio_wait_for_xmitr(in_synth: *mut spk_synth) -> c_int {
    static int spk_ttyio_wait_for_xmitr(struct spk_synth *in_synth)
    {
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn ttyio_in(in_synth: *mut spk_synth, timeout: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn spk_ttyio_in(in_synth: *mut spk_synth) -> c_uchar {
    static unsigned char spk_ttyio_in(struct spk_synth *in_synth)
    {
    return ttyio_in(in_synth, SPK_SYNTH_TIMEOUT);
    }
#[no_mangle]
unsafe extern "C" fn spk_ttyio_in_nowait(in_synth: *mut spk_synth) -> c_uchar {
    static unsigned char spk_ttyio_in_nowait(struct spk_synth *in_synth)
    {
    let mut rv: u8 = ttyio_in(in_synth, 0);
    return (rv == 0xff) ? 0 : rv;
    }
#[no_mangle]
unsafe extern "C" fn spk_ttyio_flush_buffer(in_synth: *mut spk_synth) {
    static void spk_ttyio_flush_buffer(struct spk_synth *in_synth)
    {
    struct tty_struct *tty = in_synth.dev;
...
#[no_mangle]
pub unsafe extern "C" fn spk_ttyio_synth_probe(synth: *mut spk_synth) -> c_int {
    int spk_ttyio_synth_probe(struct spk_synth *synth)
    {
    let mut rv: c_int = spk_ttyio_initialise_ldisc(synth);
    if (rv)
    return rv;
    synth.alive = 1;
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn spk_ttyio_release(in_synth: *mut spk_synth) {
    ...
    tty_unlock(tty);
    tty_kclose(tty);
    in_synth.dev = core::ptr::null_mut();
    }
