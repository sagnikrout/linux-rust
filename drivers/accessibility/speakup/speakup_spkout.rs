...
//! Source: drivers/accessibility/speakup/speakup_spkout.c
#![no_std]
...
pub const SYNTH_CLEAR: c_uint = 0x18;
    ...
    [RATE_ID] = { RATE, .u.n = {"\x05R%d", 7, 0, 9, 0, 0, core::ptr::null_mut() } },
    [PITCH_ID] = { PITCH, .u.n = {"\x05P%d", 3, 0, 9, 0, 0, core::ptr::null_mut() } },
    [VOL_ID] = { VOL, .u.n = {"\x05V%d", 9, 0, 9, 0, 0, core::ptr::null_mut() } },
    [TONE_ID] = { TONE, .u.n = {"\x05T%c", 8, 0, 25, 65, 0, core::ptr::null_mut() } },
