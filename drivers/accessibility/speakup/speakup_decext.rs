...
//! Source: drivers/accessibility/speakup/speakup_decext.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn read_buff_add(ch: u_char) {
...
pub unsafe extern "C" fn synth_full() -> bool {
    ...
    [RATE_ID] = { RATE, .u.n = {"[:ra %d]", 7, 0, 9, 150, 25, core::ptr::null_mut() } },
    [PITCH_ID] = { PITCH, .u.n = {"[:dv ap %d]", 100, 0, 100, 0, 0, core::ptr::null_mut() } },
    [INFLECTION_ID] = { INFLECTION, .u.n = {"[:dv pr %d] ", 100, 0, 10000, 0, 0, core::ptr::null_mut() } },
    [VOL_ID] = { VOL, .u.n = {"[:dv gv %d]", 13, 0, 16, 0, 5, core::ptr::null_mut() } },
