...
//! Source: drivers/accessibility/speakup/keyhelp.c
#![no_std]
...
pub const MAXFUNCS: c_int = 130;
pub const MAXKEYS: c_int = 256;
    let mut num_key_names: static int = MSG_KEYNAMES_END - MSG_KEYNAMES_START + 1;
...
#[no_mangle]
unsafe extern "C" fn build_key_data() {
...
#[no_mangle]
unsafe extern "C" fn say_key(key: c_int) {
...
#[no_mangle]
unsafe extern "C" fn help_init() {
    static void help_init(void)
    {
    let mut start: c_char = SPACE;
    int i;
    let mut num_funcs: c_int = MSG_FUNCNAMES_END - MSG_FUNCNAMES_START + 1;
...
#[no_mangle]
pub unsafe extern "C" fn spk_handle_help(vc: *mut vc_data, type: u_char, ch: u_char, key: u16) -> c_int {
    ...
    cur_item++;
#[no_mangle]
pub unsafe extern "C" fn if(0: ch == 3 && cur_item >) -> else {
