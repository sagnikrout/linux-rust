...
//! Source: drivers/mtd/tests/nandbiterrs.c
#![no_std]
...
//
    ...
    let mut max_overwrite: static unsigned = 10000;
...
#[no_mangle]
unsafe extern "C" fn hash(offset: unsigned) -> u8 {
    static uint8_t hash(unsigned offset)
    {
    let mut v: unsigned = offset;
    unsigned char c;
    v ^= 0x7f7edfd3;
    v = v ^ (v >> 3);
    v = v ^ (v >> 5);
...
#[no_mangle]
unsafe extern "C" fn write_page(log: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rewrite_page(log: c_int) -> c_int {
...
// or error (<0)
#[no_mangle]
unsafe extern "C" fn read_page(log: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verify_page(log: c_int) -> c_int {
...
// and sets it to '0'.
#[no_mangle]
unsafe extern "C" fn insert_biterror(byte: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn incremental_errors_test() -> c_int {
    static int incremental_errors_test(void)
    {
    let mut err: c_int = 0;
    unsigned i;
    let mut errs_per_subpage: unsigned = 0;
...
#[no_mangle]
unsafe extern "C" fn overwrite_test() -> c_int {
    static int overwrite_test(void)
    {
    let mut err: c_int = 0;
    unsigned i;
    let mut max_corrected: unsigned = 0;
    let mut opno: unsigned = 0;
// We don't expect more than this many correctable bit errors per
// page.
pub const MAXBITS: c_int = 512;
...
#[no_mangle]
unsafe extern "C" fn mtd_nandbiterrs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mtd_nandbiterrs_exit() -> void __exit {
