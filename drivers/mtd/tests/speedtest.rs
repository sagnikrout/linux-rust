...
//! Source: drivers/mtd/tests/speedtest.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn multiblock_erase(ebnum: c_int, blocks: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_eraseblock_by_page(ebnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_eraseblock_by_2pages(ebnum: c_int) -> c_int {
    static int write_eraseblock_by_2pages(int ebnum)
    {
    let mut sz: usize = pgsize * 2;
...
#[no_mangle]
unsafe extern "C" fn read_eraseblock(ebnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_eraseblock_by_2pages(ebnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_speed() -> c_long {
...
#[no_mangle]
unsafe extern "C" fn mtd_speedtest_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mtd_speedtest_exit() -> void __exit {
