...
//! Source: drivers/mtd/tests/pagetest.c
#![no_std]
...
// Check boundary between eraseblocks
    ...
    let mut old_state: rnd_state = rnd_state;
// Do a read to set the internal dataRAMs to different data
    err = mtdtest_read(mtd, addr0, bufsize, twopages);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn crosstest() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erasecrosstest() -> c_int {
    static int erasecrosstest(void)
    {
    let mut err: c_int = 0, i, ebnum, ebnum2;
    loff_t addr0;
...
#[no_mangle]
unsafe extern "C" fn erasetest() -> c_int {
    static int erasetest(void)
    {
    let mut err: c_int = 0, i, ebnum, ok = 1;
    loff_t addr0;
    pr_info("erasetest\n");
    ebnum = 0;
    addr0 = 0;
...
#[no_mangle]
unsafe extern "C" fn mtd_pagetest_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mtd_pagetest_exit() -> void __exit {
