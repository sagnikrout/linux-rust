...
//! Source: drivers/mtd/tests/oobtest.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn do_vary_offset() {
...
#[no_mangle]
unsafe extern "C" fn write_whole_device() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn verify_eraseblock_in_one_go(ebnum: c_int) -> c_int {
    static int verify_eraseblock_in_one_go(int ebnum)
    {
    let mut ops: mtd_oob_ops = { };
    let mut err: c_int = 0;
    let mut addr: loff_t = (loff_t)ebnum * mtd.erasesize;
    let mut len: usize = mtd.oobavail * pgcnt;
    let mut oobavail: usize = mtd.oobavail;
    size_t bitflips;
    int i;
...
#[no_mangle]
unsafe extern "C" fn verify_all_eraseblocks() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtd_oobtest_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mtd_oobtest_exit() -> void __exit {
