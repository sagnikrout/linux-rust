...
//! Source: drivers/mtd/mtdpstore.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_block_isbad(cxt: *mut mtdpstore_context, off: loff_t) -> c_int {
    ...
    {
    struct mtd_info *mtd = cxt.mtd;
    let mut zonenum: u64 = div_u64(off, cxt.info.kmsg_size);
    ...
    {
    struct mtd_info *mtd = cxt.mtd;
    let mut zonecnt: u32 = mtd.erasesize / cxt.info.kmsg_size;
    u64 zonenum;
    off = ALIGN_DOWN(off, mtd.erasesize);
...
#[no_mangle]
pub unsafe extern "C" fn mtdpstore_is_used(cxt: *mut mtdpstore_context, off: loff_t) -> c_int {
    static inline int mtdpstore_is_used(struct mtdpstore_context *cxt, loff_t off)
    {
    let mut zonenum: u64 = div_u64(off, cxt.info.kmsg_size);
    let mut blknum: u64 = div_u64(off, cxt.mtd.erasesize);
    if (test_bit(blknum, cxt.badmap))
    return true;
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_mark_removed(cxt: *mut mtdpstore_context, off: loff_t) {
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_erase_do(cxt: *mut mtdpstore_context, off: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mtdpstore_erase(size: usize, off: loff_t) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn mtdpstore_security(cxt: *mut mtdpstore_context, off: loff_t) -> c_int {
    static int mtdpstore_security(struct mtdpstore_context *cxt, loff_t off)
    {
    let mut ret: c_int = 0, i;
    struct mtd_info *mtd = cxt.mtd;
    let mut zonenum: u32 = (u32)div_u64(off, cxt.info.kmsg_size);
    let mut zonecnt: u32 = (u32)div_u64(cxt.mtd.size, cxt.info.kmsg_size);
    let mut blkcnt: u32 = (u32)div_u64(cxt.mtd.size, cxt.mtd.erasesize);
    let mut erasesize: u32 = cxt.mtd.erasesize;
    for (i = 0; i < zonecnt; i++) {
    let mut num: u32 = (zonenum + i) % zonecnt;
// found empty zone
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_write(buf: *const c_char, size: usize, off: loff_t) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn mtdpstore_is_io_error(ret: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mtdpstore_read(buf: *mut c_char, size: usize, off: loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_panic_write(buf: *const c_char, size: usize, off: loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_notify_add(mtd: *mut mtd_info) {
...
// 3rd. write back
    while (size) {
    let mut zonesize: c_uint = cxt.info.kmsg_size;
...
//
#[no_mangle]
unsafe extern "C" fn mtdpstore_flush_removed(cxt: *mut mtdpstore_context) -> c_int {
    static int mtdpstore_flush_removed(struct mtdpstore_context *cxt)
    {
    struct mtd_info *mtd = cxt.mtd;
    int ret;
    loff_t off;
    let mut blkcnt: u32 = (u32)div_u64(mtd.size, mtd.erasesize);
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_notify_remove(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mtdpstore_exit() -> void __exit {
