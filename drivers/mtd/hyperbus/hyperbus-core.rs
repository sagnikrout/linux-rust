...
//! Source: drivers/mtd/hyperbus/hyperbus-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hyperbus_read16(map: *mut map_info, addr: c_ulong) -> map_word {
...
#[no_mangle]
pub unsafe extern "C" fn hyperbus_register_device(hbdev: *mut hyperbus_device) -> c_int {
    ...
    ret = mtd_device_register(hbdev.mtd, core::ptr::null_mut(), 0);
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn hyperbus_unregister_device(hbdev: *mut hyperbus_device) {
