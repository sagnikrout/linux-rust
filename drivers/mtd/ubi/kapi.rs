...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_do_get_device_info(ubi: *mut ubi_device, di: *mut ubi_device_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_get_device_info(ubi_num: c_int, di: *mut ubi_device_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_get_num_by_path(pathname: *const c_char, ubi_num: *mut c_int, vol_id: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_close_volume(desc: *mut ubi_volume_desc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_leb_erase(desc: *mut ubi_volume_desc, lnum: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_leb_unmap(desc: *mut ubi_volume_desc, lnum: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_leb_map(desc: *mut ubi_volume_desc, lnum: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_is_mapped(desc: *mut ubi_volume_desc, lnum: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_sync(ubi_num: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_unregister_volume_notifier(nb: *mut notifier_block) -> c_int {
