...
//! Source: drivers/mtd/ubi/attach.c
#![no_std]
...
//
    ...
    struct rb_node **p = &ai.volumes.rb_node, *parent = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_free_aeb(ai: *mut ubi_attach_info, aeb: *mut ubi_ainf_peb) {
...
//
#[no_mangle]
unsafe extern "C" fn add_corrupted(ai: *mut ubi_attach_info, pnum: c_int, ec: c_int) -> c_int {
...
//
    ...
    struct ubi_vid_io_buf *vidb = core::ptr::null_mut();
    let mut sqnum2: c_ulonglong = be64_to_cpu(vid_hdr.sqnum);
    if (sqnum2 == aeb.sqnum) {
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_remove_av(ai: *mut ubi_attach_info, av: *mut ubi_ainf_volume) {
...
#[no_mangle]
unsafe extern "C" fn vol_ignored(vol_id: c_int) -> bool {
...
// This is an unexpected corruption
    ...
    let mut lnum: c_int = be32_to_cpu(vidh.lnum);
...
//
#[no_mangle]
unsafe extern "C" fn late_analysis(ubi: *mut ubi_device, ai: *mut ubi_attach_info) -> c_int {
...
//
    ...
    this = this.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: this->rb_right) -> else {
    ...
    this.rb_left = core::ptr::null_mut();
    else
    this.rb_right = core::ptr::null_mut();
    }
    if (list)
    list_add_tail(&aeb.u.list, list);
    else
...
//
#[no_mangle]
unsafe extern "C" fn destroy_ai(ai: *mut ubi_attach_info) {
...
// Destroy the volume RB-tree
    ...
    rb = rb.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rb->rb_right) -> else {
    else if (rb.rb_right)
    rb = rb.rb_right;
    else {
    ...
    if (rb) {
    if (rb.rb_left == &av.rb)
    rb.rb_left = core::ptr::null_mut();
    else
    rb.rb_right = core::ptr::null_mut();
    }
    destroy_av(ai, av, core::ptr::null_mut());
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn scan_fast(ubi: *mut ubi_device, ai: *mut ubi_attach_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_attach(ubi: *mut ubi_device, force_scan: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn self_check_ai(ubi: *mut ubi_device, ai: *mut ubi_attach_info) -> c_int {
    static int self_check_ai(struct ubi_device *ubi, struct ubi_attach_info *ai)
    {
    struct ubi_vid_io_buf *vidb = ai.vidb;
    struct ubi_vid_hdr *vidh = ubi_get_vid_hdr(vidb);
