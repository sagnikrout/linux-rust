...
//! Source: drivers/mtd/ubi/fastmap-wl.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn update_fastmap_work_fn(wrk: *mut work_struct) {
...
//
    ...
    {
    struct rb_node *p;
    struct ubi_wl_entry *e, *victim = core::ptr::null_mut();
    let mut max_ec: c_int = UBI_MAX_ERASECOUNTER;
...
//
    ...
    {
    struct ubi_wl_entry *e = core::ptr::null_mut();
    if (!ubi.free.rb_node)
    goto out;
    if (anchor)
...
//
#[no_mangle]
unsafe extern "C" fn wait_free_pebs_for_pool(ubi: *mut ubi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn left_free_count(ubi: *mut ubi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn can_fill_pools(ubi: *mut ubi_device, free: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_refill_pools_and_lock(ubi: *mut ubi_device) {
...
//
    ...
    let mut left_free: c_int = left_free_count(ubi);
    if (left_free <= 0)
    break;
...
//
#[no_mangle]
unsafe extern "C" fn produce_free_peb(ubi: *mut ubi_device) -> c_int {
    static int produce_free_peb(struct ubi_device *ubi)
    {
    int err;
    while (!ubi.free.rb_node && ubi.works_count) {
    dbg_wl("do one work synchronously");
    err = do_work(ubi, core::ptr::null_mut());
    if (err)
    return err;
    }
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_wl_get_peb(ubi: *mut ubi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn need_wear_leveling(ubi: *mut ubi_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_ensure_anchor_pebs(ubi: *mut ubi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_is_erase_work(wrk: *mut ubi_work) -> c_int {
    int ubi_is_erase_work(struct ubi_work *wrk)
    {
    return wrk.func == erase_worker;
    }
#[no_mangle]
unsafe extern "C" fn ubi_fastmap_close(ubi: *mut ubi_device) {
