...
//! Source: drivers/mtd/ubi/gluebi.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn gluebi_get_device(mtd: *mut mtd_info) -> c_int {
    static int gluebi_get_device(struct mtd_info *mtd)
    {
    struct gluebi_device *gluebi;
    let mut ubi_mode: c_int = UBI_READONLY;
...
//
#[no_mangle]
unsafe extern "C" fn gluebi_put_device(mtd: *mut mtd_info) {
...
//
    ...
    {
    let mut err: c_int = 0, lnum, offs, bytes_left;
    struct gluebi_device *gluebi;
    gluebi = container_of(mtd, struct gluebi_device, mtd);
    lnum = div_u64_rem(from, mtd.erasesize, &offs);
    bytes_left = len;
    while (bytes_left) {
    let mut to_read: usize = mtd.erasesize - offs;
...
//
    ...
    bytes_left = len;
    while (bytes_left) {
    let mut to_write: usize = mtd.erasesize - offs;
...
//
#[no_mangle]
unsafe extern "C" fn gluebi_erase(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gluebi_remove(vi: *mut ubi_volume_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gluebi_updated(vi: *mut ubi_volume_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gluebi_resized(vi: *mut ubi_volume_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ubi_gluebi_init() -> int __init {
    static int __init ubi_gluebi_init(void)
    {
    return ubi_register_volume_notifier(&gluebi_notifier, 0);
    }
#[no_mangle]
unsafe extern "C" fn ubi_gluebi_exit() -> void __exit {
