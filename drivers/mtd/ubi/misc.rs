...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_check_volume(ubi: *mut ubi_device, vol_id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_update_reserved(ubi: *mut ubi_device) {
    void ubi_update_reserved(struct ubi_device *ubi)
    {
    let mut need: c_int = ubi.beb_rsvd_level - ubi.beb_rsvd_pebs;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_calculate_reserved(ubi: *mut ubi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_check_pattern(buf: *const c_void, patt: u8, size: c_int) -> c_int {
...
// Normal UBI messages
#[no_mangle]
pub unsafe extern "C" fn ubi_msg(ubi: *const ubi_device, fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn ubi_warn(ubi: *const ubi_device, fmt: *const c_char, ...) {
...
// UBI error messages
#[no_mangle]
pub unsafe extern "C" fn ubi_err(ubi: *const ubi_device, fmt: *const c_char, ...) {
