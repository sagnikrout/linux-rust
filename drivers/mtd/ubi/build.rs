...
//! Source: drivers/mtd/ubi/build.c
#![no_std]
...
pub const MTD_PARAM_LEN_MAX: c_int = 64;
// Maximum number of comma-separated items in the 'mtd=' parameter
pub const MTD_PARAM_MAX_COUNT: c_int = 7;
// Maximum value for the number of bad PEBs per 1024 PEBs
pub const MAX_MTD_UBI_BEB_LIMIT: c_int = 768;

pub const ubi_is_module(): c_int = 1;

pub const ubi_is_module(): c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtd_dev_param {
    pub name: [c_char; MTD_PARAM_LEN_MAX],
    pub ubi_num: c_int,
    pub vid_hdr_offs: c_int,
    pub max_beb_per1024: c_int,
    pub enable_fm: c_int,
    pub need_resv_pool: c_int,
...
// UBI device attributes (correspond to files in '/<sysfs>/class/ubi/ubiX')
    ...
    __ATTR(eraseblock_size, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_avail_eraseblocks =
    __ATTR(avail_eraseblocks, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_total_eraseblocks =
    __ATTR(total_eraseblocks, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_volumes_count =
    __ATTR(volumes_count, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_max_ec =
    __ATTR(max_ec, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_reserved_for_bad =
    __ATTR(reserved_for_bad, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_bad_peb_count =
    __ATTR(bad_peb_count, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_max_vol_count =
    __ATTR(max_vol_count, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_min_io_size =
    __ATTR(min_io_size, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_bgt_enabled =
    __ATTR(bgt_enabled, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_mtd_num =
    __ATTR(mtd_num, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
    static struct device_attribute dev_ro_mode =
    __ATTR(ro_mode, S_IRUGO, dev_attribute_show, core::ptr::null_mut());
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_volume_notify(ubi: *mut ubi_device, vol: *mut ubi_volume, ntype: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_notify_all(ubi: *mut ubi_device, ntype: c_int, nb: *mut notifier_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_enumerate_volumes(nb: *mut notifier_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_put_device(ubi: *mut ubi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_major2num(major: c_int) -> c_int {
...
//
    ...
    ret = sprintf(buf, "%d\n", ubi.leb_size);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_avail_eraseblocks: attr ==) -> else {
    else if (attr == &dev_avail_eraseblocks)
    ret = sprintf(buf, "%d\n", ubi.avail_pebs);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_total_eraseblocks: attr ==) -> else {
    else if (attr == &dev_total_eraseblocks)
    ret = sprintf(buf, "%d\n", ubi.good_peb_count);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_volumes_count: attr ==) -> else {
    else if (attr == &dev_volumes_count)
    ret = sprintf(buf, "%d\n", ubi.vol_count - UBI_INT_VOL_COUNT);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_max_ec: attr ==) -> else {
    else if (attr == &dev_max_ec)
    ret = sprintf(buf, "%d\n", ubi.max_ec);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_reserved_for_bad: attr ==) -> else {
    else if (attr == &dev_reserved_for_bad)
    ret = sprintf(buf, "%d\n", ubi.beb_rsvd_pebs);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_bad_peb_count: attr ==) -> else {
    else if (attr == &dev_bad_peb_count)
    ret = sprintf(buf, "%d\n", ubi.bad_peb_count);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_max_vol_count: attr ==) -> else {
    else if (attr == &dev_max_vol_count)
    ret = sprintf(buf, "%d\n", ubi.vtbl_slots);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_min_io_size: attr ==) -> else {
    else if (attr == &dev_min_io_size)
    ret = sprintf(buf, "%d\n", ubi.min_io_size);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_bgt_enabled: attr ==) -> else {
    else if (attr == &dev_bgt_enabled)
    ret = sprintf(buf, "%d\n", ubi.thread_enabled);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_mtd_num: attr ==) -> else {
    else if (attr == &dev_mtd_num)
    ret = sprintf(buf, "%d\n", ubi.mtd.index);
#[no_mangle]
pub unsafe extern "C" fn if(&dev_ro_mode: attr ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dev_release(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn kill_volumes(ubi: *mut ubi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn uif_init(ubi: *mut ubi_device) -> c_int {
...
//
    ...
    ubi.volumes[i] = core::ptr::null_mut();
    goto out_volumes;
    }
    }
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn uif_close(ubi: *mut ubi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ubi_free_volumes_from(ubi: *mut ubi_device, from: c_int) {
    ...
    continue;
    ubi_eba_replace_table(ubi.volumes[i], core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_free_all_volumes(ubi: *mut ubi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_free_internal_volumes(ubi: *mut ubi_device) {
    void ubi_free_internal_volumes(struct ubi_device *ubi)
    {
    ubi_free_volumes_from(ubi, ubi.vtbl_slots);
    }
#[no_mangle]
unsafe extern "C" fn get_bad_peb_limit(ubi: *const ubi_device, max_beb_per1024: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn io_init(ubi: *mut ubi_device, max_beb_per1024: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn autoresize(ubi: *mut ubi_device, vol_id: c_int) -> c_int {
...
//
    ...
    ubi_notify_all(ubi, UBI_VOLUME_ADDED, core::ptr::null_mut());
    return ubi_num;
    out_debugfs:
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_detach_mtd_dev(ubi_num: c_int, anyway: c_int) -> c_int {
...
// This may only happen if there is a bug
    ...
    ubi.is_dead = true;
    spin_unlock(&ubi_devices_lock);
    ubi_notify_all(ubi, UBI_VOLUME_SHUTDOWN, core::ptr::null_mut());
    spin_lock(&ubi_devices_lock);
    put_device(&ubi.dev);
    ubi_devices[ubi_num] = core::ptr::null_mut();
    spin_unlock(&ubi_devices_lock);
    ubi_assert(ubi_num == ubi.ubi_num);
    ubi_notify_all(ubi, UBI_VOLUME_REMOVED, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn open_mtd_by_chdev(mtd_dev: *const c_char) -> *mut mtd_info  __init {
...
//
    return ERR_PTR(-EINVAL);
    return get_mtd_device(core::ptr::null_mut(), minor / 2);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn open_mtd_device(mtd_dev: *const c_char) -> *mut mtd_info  __init {
...
// Probably this is an MTD character device node path
    ...
    mtd = get_mtd_device(core::ptr::null_mut(), mtd_num);
    return mtd;
    }
#[no_mangle]
unsafe extern "C" fn ubi_notify_add(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn ubi_notify_remove(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn ubi_init_attach() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ubi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ubi_exit() -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn bytes_str_to_int(str: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ubi_mtd_param_parse(val: *const c_char, kp: *const kernel_param) -> c_int {
...
// Get rid of the final newline
    ...
    token = tokens[2];
    if (token) {
    let mut err: c_int = kstrtoint(token, 10, &p.max_beb_per1024);
    if (err) {
    ...
    token = tokens[3];
    if (token) {
    let mut err: c_int = kstrtoint(token, 10, &p.ubi_num);
    ...
    token = tokens[4];
    if (token) {
    let mut err: c_int = kstrtoint(token, 10, &p.enable_fm);
    if (err) {
    ...
    token = tokens[5];
    if (token) {
    let mut err: c_int = kstrtoint(token, 10, &p.need_resv_pool);
    if (err) {
    ...
    token = tokens[6];
    if (token) {
    let mut err: c_int = kstrtoint(token, 10, &p.wl_threshold);
    if (err) {
    ...
    module_param_call(mtd, ubi_mtd_param_parse, core::ptr::null_mut(), core::ptr::null_mut(), 0400);
