...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ubi_eba_table {
    pub entries: *mut ubi_eba_entry,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_next_sqnum(ubi: *mut ubi_device) -> c_ulonglong {
...
//
#[no_mangle]
unsafe extern "C" fn ubi_get_compat(ubi: *const ubi_device, vol_id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_eba_destroy_table(tbl: *mut ubi_eba_table) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_eba_replace_table(vol: *mut ubi_volume, tbl: *mut ubi_eba_table) {
...
//
    ...
    p = p.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(le->vol_id: vol_id >) -> else {
    ...
    p = p.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(le->lnum: lnum >) -> else {
...
//
    ...
    p = &(*p).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(le1->vol_id: vol_id >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn leb_read_lock(ubi: *mut ubi_device, vol_id: c_int, lnum: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn leb_read_unlock(ubi: *mut ubi_device, vol_id: c_int, lnum: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn leb_write_lock(ubi: *mut ubi_device, vol_id: c_int, lnum: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn leb_write_trylock(ubi: *mut ubi_device, vol_id: c_int, lnum: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn leb_write_unlock(ubi: *mut ubi_device, vol_id: c_int, lnum: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_eba_is_mapped(vol: *mut ubi_volume, lnum: c_int) -> bool {
...
//
    ...
    scrub = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mtd_is_eccerr(err)) -> else {
    if (vol.vol_type == UBI_DYNAMIC_VOLUME)
    goto out_unlock;
    scrub = 1;
    if (!check) {
    ...
    if (check) {
    let mut crc1: u32 = crc32(UBI_CRC32_INIT, buf, len);
    if (crc1 != crc) {
...
//
    ...
    if (err)
    return err;
    return ubi_eba_write_leb(ubi, vol, lnum, core::ptr::null_mut(), 0, 0);
    }
    vidb = ubi_alloc_vid_buf(ubi, GFP_NOFS);
    if (!vidb)
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn is_error_sane(err: c_int) -> c_int {
...
//
    ...
    let mut min: c_int = ubi.beb_rsvd_level / 10;
    if (!min)
    min = 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_eba_init(ubi: *mut ubi_device, ai: *mut ubi_attach_info) -> c_int {
