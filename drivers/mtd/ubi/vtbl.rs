...
//
#[no_mangle]
unsafe extern "C" fn ubi_update_layout_vol(ubi: *mut ubi_device) -> c_int {
...
// Checks that all names are unique
    ...
    let mut len1: c_int = be16_to_cpu(vtbl[i].name_len);
    let mut len2: c_int = be16_to_cpu(vtbl[n].name_len);
    if (len1 > 0 && len1 == len2 &&
...
//
    ...
    struct ubi_vtbl_record *leb[UBI_LAYOUT_VOLUME_EBS] = { core::ptr::null_mut(), core::ptr::null_mut() };
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_read_volume_table(ubi: *mut ubi_device, ai: *mut ubi_attach_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn self_vtbl_check(ubi: *const ubi_device) {
    static void self_vtbl_check(const struct ubi_device *ubi)
    {
