...
//! Source: drivers/mtd/ubi/fastmap.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn free_seen(seen: *mut c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_seen(ubi: *mut ubi_device, pnum: c_int, seen: *mut c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn self_check_seen(ubi: *mut ubi_device, seen: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_calc_fm_size(ubi: *mut ubi_device) -> usize {
...
//
    ...
    struct rb_node **p = &av.root.rb_node, *parent = core::ptr::null_mut();
    while (*p) {
    parent = *p;
...
//
    ...
    struct ubi_ainf_peb *new_aeb)
    {
    let mut vol_id: c_int = be32_to_cpu(new_vh.vol_id);
    struct ubi_ainf_volume *av;
...
//
#[no_mangle]
unsafe extern "C" fn unmap_peb(ai: *mut ubi_attach_info, pnum: c_int) {
...
//
    ...
    let mut ec: c_ulonglong = be64_to_cpu(ech.ec);
    unmap_peb(ai, pnum);
...
//
#[no_mangle]
unsafe extern "C" fn count_fastmap_pebs(ai: *mut ubi_attach_info) -> c_int {
...
//
    ...
    let mut fm_pos: usize = 0, fm_size = ubi.fm_size;
    let mut max_sqnum: c_ulonglong = 0;
...
// Iterate over all volumes and read their EBA table
    ...
    let mut pnum: c_int = be32_to_cpu(fm_eba.pnum[j]);
    if (pnum < 0)
    continue;
    aeb = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn find_fm_anchor(ai: *mut ubi_attach_info) -> c_int {
...
// Copy all (possible) fastmap blocks into our new attach structure.
    ...
    goto free_fm_sb;
#[no_mangle]
pub unsafe extern "C" fn if(UBI_IO_BITFLIPS: ret ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ubi_fastmap_init_checkmap(vol: *mut ubi_volume, leb_count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ubi_fastmap_destroy_checkmap(vol: *mut ubi_volume) {
...
//
#[no_mangle]
unsafe extern "C" fn invalidate_fastmap(ubi: *mut ubi_device) -> c_int {
    static int invalidate_fastmap(struct ubi_device *ubi)
    {
    int ret;
    struct ubi_fastmap_layout *fm;
    struct ubi_wl_entry *e;
    struct ubi_vid_io_buf *vb = core::ptr::null_mut();
    struct ubi_vid_hdr *vh;
    if (!ubi.fm)
    return 0;
    ubi.fm = core::ptr::null_mut();
    ret = -ENOMEM;
...
//
#[no_mangle]
pub unsafe extern "C" fn ubi_update_fastmap(ubi: *mut ubi_device) -> c_int {
    ...
    j, 0);
    new_fm.e[j] = core::ptr::null_mut();
    }
    goto err;
    }
    new_fm.e[i] = old_fm.e[i];
    old_fm.e[i] = core::ptr::null_mut();
    } else {
...
// Old fastmap is larger than the new one
    ...
    spin_lock(&ubi.wl_lock);
    tmp_e = ubi.fm_anchor;
    ubi.fm_anchor = core::ptr::null_mut();
    spin_unlock(&ubi.wl_lock);
    if (old_fm) {
// no fresh anchor PEB was found, reuse the old one
    ...
    i, 0);
    new_fm.e[i] = core::ptr::null_mut();
    }
    goto err;
    }
    new_fm.e[0] = old_fm.e[0];
    old_fm.e[0] = core::ptr::null_mut();
    } else {
