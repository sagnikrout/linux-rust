...
#[no_mangle]
unsafe extern "C" fn nftl_add_mtd(tr: *mut mtd_blktrans_ops, mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn nftl_remove_dev(dev: *mut mtd_blktrans_dev) {
...
//
    ...
    {
    let mut mask: loff_t = mtd.writesize - 1;
...
//
#[no_mangle]
unsafe extern "C" fn NFTL_findfreeblock(nftl: *mut NFTLrecord, desperate: c_int) -> u16 {
...
// We're passed the number of the last EUN in the chain, to save us from
    ...
    let mut pot: u16 = nftl.LastFreeEUN;
    let mut silly: c_int = nftl.nb_blocks;
...
#[no_mangle]
unsafe extern "C" fn NFTL_move_block(mtd: *mut mtd_info, src: loff_t, dst: loff_t) -> noinline_for_stack void {
...
#[no_mangle]
unsafe extern "C" fn NFTL_foldchain(nftl: *mut NFTLrecord, thisVUC: unsigned, pendingblock: unsigned) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn NFTL_makefreeblock(nftl: *mut NFTLrecord, pendingblock: unsigned) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn NFTL_findwriteunit(nftl: *mut NFTLrecord, block: unsigned) -> u16 {
    static inline u16 NFTL_findwriteunit(struct NFTLrecord *nftl, unsigned block)
    {
    u16 lastEUN;
    let mut thisVUC: u16 = block / (nftl.EraseSize / 512);
    struct mtd_info *mtd = nftl.mbd.mtd;
    unsigned int writeEUN;
    let mut blockofs: c_ulong = (block * 512) & (nftl.EraseSize -1);
    size_t retlen;
    int silly, silly2 = 3;
    struct nftl_oob oob;
    do {
...
// If we _still_ haven't got a block to use, we're screwed
    ...
    struct mtd_info *mtd = nftl.mbd.mtd;
    u16 lastgoodEUN;
    let mut thisEUN: u16 = nftl.EUNtable[block / (nftl.EraseSize / 512)];
    let mut blockofs: c_ulong = (block * 512) & (nftl.EraseSize - 1);
    unsigned int status;
...
// the requested block is not on the media, return all 0x00
    ...
    let mut ptr: loff_t = (lastgoodEUN * nftl.EraseSize) + blockofs;
    size_t retlen;
    let mut res: c_int = mtd_read(mtd, ptr, 512, &retlen, buffer);
...
#[no_mangle]
unsafe extern "C" fn nftl_getgeo(dev: *mut mtd_blktrans_dev, geo: *mut hd_geometry) -> c_int {
