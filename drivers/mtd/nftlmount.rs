...
//! Source: drivers/mtd/nftlmount.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn find_boot_record(nftl: *mut NFTLrecord) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memcmpb(a: *mut c_void, c: c_int, n: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn NFTL_formatblock(nftl: *mut NFTLrecord, block: c_int) -> c_int {
...
// case.
#[no_mangle]
unsafe extern "C" fn check_sectors_in_chain(nftl: *mut NFTLrecord, first_block: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn calc_chain_length(nftl: *mut NFTLrecord, first_block: c_uint) -> c_int {
    static int calc_chain_length(struct NFTLrecord *nftl, unsigned int first_block)
    {
    let mut length: c_uint = 0, block = first_block;
    for (;;) {
    length++;
...
//
#[no_mangle]
unsafe extern "C" fn format_chain(nftl: *mut NFTLrecord, first_block: c_uint) {
    static void format_chain(struct NFTLrecord *nftl, unsigned int first_block)
    {
    let mut block: c_uint = first_block, block1;
...
// 1.
#[no_mangle]
unsafe extern "C" fn check_and_mark_free_block(nftl: *mut NFTLrecord, block: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_fold_mark(nftl: *mut NFTLrecord, block: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn NFTL_mount(s: *mut NFTLrecord) -> c_int {
