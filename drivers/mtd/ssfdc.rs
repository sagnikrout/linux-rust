...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssfdcr_record {
    pub mbd: mtd_blktrans_dev,
    pub heads: c_uchar,
    pub sectors: c_uchar,
    pub cylinders: c_ushort,
    pub /: *mut *mut int cis_block; / block n. containing CIS/IDI,
    pub /: *mut *mut int erase_size; / phys_block_size,
    pub on: *mut *mut *mut unsigned short logic_block_map; / all zones (max 8192 phys blocks,
    the 128MiB) */
    pub /: *mut *mut int map_len; / n. phys_blocks on the card,
}

pub const SSFDCR_MAJOR: c_int = 257;
pub const SSFDCR_PARTN_BITS: c_int = 3;
pub const SECTOR_SIZE: c_int = 512;
pub const SECTOR_SHIFT: c_int = 9;
pub const OOB_SIZE: c_int = 16;
pub const MAX_LOGIC_BLK_PER_ZONE: c_int = 1000;
pub const MAX_PHYS_BLK_PER_ZONE: c_int = 1024;
...
#[no_mangle]
unsafe extern "C" fn get_valid_cis_sector(mtd: *mut mtd_info) -> c_int {
...
// Read physical sector (wrapper to MTD_READ)
    ...
    int ret;
    size_t retlen;
    let mut offset: loff_t = (loff_t)sect_no << SECTOR_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn read_raw_oob(mtd: *mut mtd_info, offs: loff_t, buf: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_parity(number: c_int, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_logical_address(oob_buf: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn build_logical_block_map(ssfdc: *mut ssfdcr_record) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssfdcr_add_mtd(tr: *mut mtd_blktrans_ops, mtd: *mut mtd_info) {
...
// Set geometry
    ssfdc.heads = 16;
    ssfdc.sectors = 32;
    get_chs(mtd.size, core::ptr::null_mut(), &ssfdc.heads, &ssfdc.sectors);
...
#[no_mangle]
unsafe extern "C" fn ssfdcr_remove_dev(dev: *mut mtd_blktrans_dev) {
...
#[no_mangle]
unsafe extern "C" fn ssfdcr_getgeo(dev: *mut mtd_blktrans_dev, geo: *mut hd_geometry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_ssfdcr() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cleanup_ssfdcr() -> void __exit {
