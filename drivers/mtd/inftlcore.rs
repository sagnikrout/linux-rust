...
//! Source: drivers/mtd/inftlcore.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn inftl_add_mtd(tr: *mut mtd_blktrans_ops, mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn inftl_remove_dev(dev: *mut mtd_blktrans_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn INFTL_findfreeblock(inftl: *mut INFTLrecord, desperate: c_int) -> u16 {
    static u16 INFTL_findfreeblock(struct INFTLrecord *inftl, int desperate)
    {
    let mut pot: u16 = inftl.LastFreeEUN;
    let mut silly: c_int = inftl.nb_blocks;
...
#[no_mangle]
unsafe extern "C" fn INFTL_foldchain(inftl: *mut INFTLrecord, thisVUC: unsigned, pendingblock: unsigned) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn INFTL_makefreeblock(inftl: *mut INFTLrecord, pendingblock: unsigned) -> u16 {
...
//
    let mut LongestChain: u16 = 0;
    let mut ChainLength: u16 = 0, thislen;
    u16 chain, EUN;
...
#[no_mangle]
unsafe extern "C" fn nrbits(val: c_uint, bitcount: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn INFTL_findwriteunit(inftl: *mut INFTLrecord, block: unsigned) -> u16 {
    static inline u16 INFTL_findwriteunit(struct INFTLrecord *inftl, unsigned block)
    {
    let mut thisVUC: c_uint = block / (inftl.EraseSize / SECTORSIZE);
    unsigned int thisEUN, writeEUN, prev_block, status;
    let mut blockofs: c_ulong = (block * SECTORSIZE) & (inftl.EraseSize -1);
    struct mtd_info *mtd = inftl.mbd.mtd;
    struct inftl_oob oob;
...
//
#[no_mangle]
unsafe extern "C" fn INFTL_trydeletechain(inftl: *mut INFTLrecord, thisVUC: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn INFTL_deleteblock(inftl: *mut INFTLrecord, block: unsigned) -> c_int {
    static int INFTL_deleteblock(struct INFTLrecord *inftl, unsigned block)
    {
    let mut thisEUN: c_uint = inftl.VUtable[block / (inftl.EraseSize / SECTORSIZE)];
    let mut blockofs: c_ulong = (block * SECTORSIZE) & (inftl.EraseSize - 1);
    struct mtd_info *mtd = inftl.mbd.mtd;
    unsigned int status;
    let mut silly: c_int = MAX_LOOPS;
    size_t retlen;
    struct inftl_bci bci;
    ...
    foundit:
    if (thisEUN != BLOCK_NIL) {
    let mut ptr: loff_t = (thisEUN * inftl.EraseSize) + blockofs;
...
// The requested block is not on the media, return all 0x00
    ...
    size_t retlen;
    let mut ptr: loff_t = (thisEUN * inftl.EraseSize) + blockofs;
    let mut ret: c_int = mtd_read(mtd, ptr, SECTORSIZE, &retlen, buffer);
...
#[no_mangle]
unsafe extern "C" fn inftl_getgeo(dev: *mut mtd_blktrans_dev, geo: *mut hd_geometry) -> c_int {
