...
//! Source: drivers/mtd/maps/scb2_flash.c
#![no_std]
...
pub const SCB2_ADDR: c_uint = 0xfff00000;
pub const SCB2_WINDOW: c_uint = 0x00100000;
...
#[no_mangle]
unsafe extern "C" fn scb2_fixup_mtd(mtd: *mut mtd_info) -> c_int {
...
pub const CSB5_FCR: c_uint = 0x41;
pub const CSB5_FCR_DECODE_ALL: c_uint = 0x0e;
...
// try to find a chip
    ...
    mtd_device_register(scb2_mtd, core::ptr::null_mut(), 0);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn scb2_flash_remove(dev: *mut pci_dev) {
