...
//! Source: drivers/mtd/maps/ck804xrom.c
#![no_std]
...
pub const DEV_CK804: c_int = 1;
pub const DEV_MCP55: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ck804xrom_window {
...
//
    let mut win_size_bits: static uint = 0;
...
#[no_mangle]
unsafe extern "C" fn ck804xrom_cleanup(window: *mut ck804xrom_window) {
...
// Free all of the mtd devices
    ...
    struct ck804xrom_map_info *map = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ck804xrom_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn init_ck804xrom() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cleanup_ck804xrom() -> void __exit {
