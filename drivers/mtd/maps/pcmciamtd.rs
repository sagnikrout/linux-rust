...
//! Source: drivers/mtd/maps/pcmciamtd.c
#![no_std]
...
pub const MAX_PCMCIA_ADDR: c_uint = 0x4000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcmciamtd_dev {
    pub p_dev: *mut pcmcia_device,
    pub /: *mut *mut *mut void __iomem win_base; / ioremapped address of PCMCIA window,
    pub /: *mut *mut unsigned int win_size; / size of window,
    pub /: *mut *mut unsigned int offset; / offset into card the window currently points at,
    pub pcmcia_map: map_info,
    pub mtd_info: *mut mtd_info,
    pub vpp: c_int,
    pub cistpl_vers_1_t)]: char mtd_name[sizeof(struct,
}

// Module parameters
// 2 = do 16-bit transfers, 1 = do 8-bit transfers
    let mut bankwidth: static int = 2;
...
#[no_mangle]
unsafe extern "C" fn pcmcia_read8_remap(map: *mut map_info, ofs: c_ulong) -> map_word {
    static map_word pcmcia_read8_remap(struct map_info *map, unsigned long ofs)
    {
    void __iomem *addr;
    let mut d: map_word = {{0}};
...
#[no_mangle]
unsafe extern "C" fn pcmcia_read16_remap(map: *mut map_info, ofs: c_ulong) -> map_word {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_copy_from_remap(map: *mut map_info, to: *mut c_void, from: c_ulong, len: isize) {
    static void pcmcia_copy_from_remap(struct map_info *map, void *to, unsigned long from, ssize_t len)
    {
    struct pcmciamtd_dev *dev = (struct pcmciamtd_dev *)map.map_priv_1;
    let mut win_size: c_ulong = dev.win_size;
    pr_debug("to = %p from = %lu len = %zd\n", to, from, len);
    while(len) {
    let mut toread: c_int = win_size - (from & (win_size-1));
    void __iomem *addr;
    if(toread > len)
    toread = len;
...
#[no_mangle]
unsafe extern "C" fn pcmcia_write8_remap(map: *mut map_info, d: map_word, adr: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_write16_remap(map: *mut map_info, d: map_word, adr: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_copy_to_remap(map: *mut map_info, to: c_ulong, from: *const c_void, len: isize) {
    ...
    while(len) {
    let mut towrite: c_int = win_size - (to & (win_size-1));
    void __iomem *addr;
    if(towrite > len)
    towrite = len;
...
#[no_mangle]
unsafe extern "C" fn pcmcia_read8(map: *mut map_info, ofs: c_ulong) -> map_word {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_read16(map: *mut map_info, ofs: c_ulong) -> map_word {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_copy_from(map: *mut map_info, to: *mut c_void, from: c_ulong, len: isize) {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_write8(map: *mut map_info, d: map_word, adr: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_write16(map: *mut map_info, d: map_word, adr: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_copy_to(map: *mut map_info, to: c_ulong, from: *const c_void, len: isize) {
...
#[no_mangle]
unsafe extern "C" fn pcmciamtd_set_vpp(map: *mut map_info, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcmciamtd_release(link: *mut pcmcia_device) {
    ...
    dev.win_base = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn card_settings(dev: *mut pcmciamtd_dev, p_dev: *mut pcmcia_device, new_name: *mut c_int) {
    ...
    pcmcia_loop_tuple(p_dev, CISTPL_FORMAT, pcmciamtd_cistpl_format, core::ptr::null_mut());
    pcmcia_loop_tuple(p_dev, CISTPL_JEDEC_C, pcmciamtd_cistpl_jedec, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pcmciamtd_config(link: *mut pcmcia_device) -> c_int {
...
// If the memory found is fits completely into the mapped PCMCIA window,
    ...
    map_destroy(mtd);
    dev.mtd_info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pcmciamtd_suspend(dev: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmciamtd_resume(dev: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmciamtd_detach(link: *mut pcmcia_device) {
...
#[no_mangle]
unsafe extern "C" fn pcmciamtd_probe(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_pcmciamtd() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_pcmciamtd() -> void __exit {
