...
//! Source: drivers/mtd/parsers/cmdlinepart.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmdline_mtd_partition {
    pub next: *mut cmdline_mtd_partition,
    pub num_parts: c_int,
...
//
#[no_mangle]
unsafe extern "C" fn mtdpart_setup_real(s: *mut c_char) -> c_int {
    static int mtdpart_setup_real(char *s)
    {
    cmdline_parsed = 1;
    for( ; s != core::ptr::null_mut(); )
    {
...
//
#[no_mangle]
unsafe extern "C" fn mtdpart_setup(s: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cmdline_parser_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cmdline_parser_exit() -> void __exit {
