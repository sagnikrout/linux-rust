...
//! Source: drivers/mtd/parsers/sharpslpart.c
#![no_std]
...
// oob structure
pub const NAND_NOOB_LOGADDR_00: c_int = 8;
pub const NAND_NOOB_LOGADDR_01: c_int = 9;
pub const NAND_NOOB_LOGADDR_10: c_int = 10;
pub const NAND_NOOB_LOGADDR_11: c_int = 11;
pub const NAND_NOOB_LOGADDR_20: c_int = 12;
pub const NAND_NOOB_LOGADDR_21: c_int = 13;
pub const BLOCK_IS_RESERVED: c_uint = 0xffff;
pub const BLOCK_UNMASK_COMPLEMENT: c_int = 1;
// factory defaults
pub const SHARPSL_NAND_PARTS: c_int = 3;

pub const SHARPSL_PARTINFO1_LADDR: c_uint = 0x00060000;
pub const SHARPSL_PARTINFO2_LADDR: c_uint = 0x00064000;
pub const BOOT_MAGIC: c_uint = 0x424f4f54;
pub const FSRO_MAGIC: c_uint = 0x4653524f;
pub const FSRW_MAGIC: c_uint = 0x46535257;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sharpsl_ftl {
    pub logmax: c_uint,
    pub log2phy: *mut c_uint,
}

// verify that the OOB bytes 8 to 15 are free and available for the FTL
#[no_mangle]
unsafe extern "C" fn sharpsl_nand_check_ooblayout(mtd: *mut mtd_info) -> c_int {
    static int sharpsl_nand_check_ooblayout(struct mtd_info *mtd)
    {
    let mut freebytes: u8 = 0;
    let mut section: c_int = 0;
    while (true) {
    let mut oobfree: mtd_oob_region = { };
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn sharpsl_nand_read_oob(mtd: *mut mtd_info, offs: loff_t, buf: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sharpsl_nand_get_logical_num(oob: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharpsl_nand_init_ftl(mtd: *mut mtd_info, ftl: *mut sharpsl_ftl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sharpsl_nand_cleanup_ftl(ftl: *mut sharpsl_ftl) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sharpsl_nand_partinfo {
    pub start: __le32,
    pub end: __le32,
    pub magic: __be32,
    pub reserved: u32,
