...
//! Source: drivers/mtd/chips/cfi_probe.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfi_early_fixup {
    pub mfr: u16,
    pub id: u16,
    pub cfi): *mut *mut void (fixup)(struct cfi_private,
}
...
#[no_mangle]
unsafe extern "C" fn fixup_s70gl02gs_chips(cfi: *mut cfi_private) {
...
//
    ...
    let mut base: __u32 = 0;
    let mut num_erase_regions: c_int = cfi_read_query(map, base + (0x10 + 28)*ofs_factor);
    int i;
    let mut addr_unlock1: c_int = 0x555, addr_unlock2 = 0x2AA;
    xip_enable(base, map, cfi);
...
//
    ...
    cfi_send_gen_cmd(0xaa, addr_unlock1, base, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0x55, addr_unlock2, base, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0x90, addr_unlock1, base, map, cfi, cfi.device_type, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn print_cfi_ident(cfip: *mut cfi_ident) {
...
#[no_mangle]
unsafe extern "C" fn cfi_probe_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cfi_probe_exit() -> void __exit {
