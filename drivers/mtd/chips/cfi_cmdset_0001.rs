...
//! Source: drivers/mtd/chips/cfi_cmdset_0001.c
#![no_std]
...
pub const PF38F4476: c_uint = 0x881c;
pub const M28F00AP30: c_uint = 0x8963;
// STMicroelectronics chips
pub const M50LPW080: c_uint = 0x002F;
pub const M50FLW080A: c_uint = 0x0080;
pub const M50FLW080B: c_uint = 0x0081;
// Atmel chips
pub const AT49BV640D: c_uint = 0x02de;
pub const AT49BV640DT: c_uint = 0x02db;
// Sharp chips
pub const LH28F640BFHE_PTTL90: c_uint = 0x00b0;
pub const LH28F640BFHE_PBTL90: c_uint = 0x00b1;
pub const LH28F640BFHE_PTTL70A: c_uint = 0x00b2;
pub const LH28F640BFHE_PBTL70A: c_uint = 0x00b3;
...
#[no_mangle]
unsafe extern "C" fn cfi_tell_features(extp: *mut cfi_pri_intelext) {
...
#[no_mangle]
unsafe extern "C" fn fixup_at49bv640dx_lock(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_intel_strataflash(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_no_write_suspend(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_st_m28w320ct(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_st_m28w320cb(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn is_LH28F640BF(cfi: *mut cfi_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fixup_LH28F640BF(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_use_point(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_unlock_powerup_lock(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn cfi_is_micron_28F00AP30(cfi: *mut cfi_private, chip: *mut flchip) -> c_int {
...
//
    ...
    struct cfi_private *cfi = map.fldrv_priv;
    struct cfi_pri_intelext *extp;
    let mut extra_size: c_uint = 0;
    let mut extp_size: c_uint = sizeof(*extp);
    again:
...
//
#[no_mangle]
unsafe extern "C" fn chip_ready(map: *mut map_info, chip: *mut flchip, adr: c_ulong, mode: c_int) -> c_int {
    static int chip_ready (struct map_info *map, struct flchip *chip, unsigned long adr, int mode)
    {
    ...
    struct cfi_pri_intelext *cfip = cfi.cmdset_priv;
    let mut timeo: c_ulong = jiffies + HZ;
...
// Macro flag: #define XIP_INVAL_CACHED_RANGE(x...)
    ...
    let mut chip_state: c_int = chip.state;
...
#[no_mangle]
unsafe extern "C" fn do_point_onechip(map: *mut map_info, chip: *mut flchip, adr: loff_t, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(last_end: cfi->chips[chipnum].start !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_unpoint(mtd: *mut mtd_info, from: loff_t, len: usize) -> c_int {
    static int cfi_intelext_unpoint(struct mtd_info *mtd, loff_t from, size_t len)
    {
    struct map_info *map = mtd.priv;
    struct cfi_private *cfi = map.fldrv_priv;
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_read(mtd: *mut mtd_info, from: loff_t, len: usize, retlen: *mut usize, buf: *mut u_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_write_words(mtd: *mut mtd_info, to: loff_t, len: usize, retlen: *mut usize, buf: *const u_char) -> c_int {
...
// If it's not bus-aligned, do the first byte write
    ...
    let mut datum: map_word = map_word_load(map, buf);
    ret = do_write_oneword(map, &cfi.chips[chipnum],
...
// Argh. Not ready for write to buffer
    let mut Xstatus: map_word = map_read(map, cmd_adr);
    map_write(map, CMD(0x70), cmd_adr);
    chip.state = FL_STATUS;
    status = map_read(map, cmd_adr);
    map_write(map, CMD(0x50), cmd_adr);
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_erase_varsize(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_sync(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_lock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
    static int cfi_intelext_lock(struct mtd_info *mtd, loff_t ofs, uint64_t len)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_unlock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
    static int cfi_intelext_unlock(struct mtd_info *mtd, loff_t ofs, uint64_t len)
    {
    int ret;
...
// then ensure we don't keep OTP data in the cache
    ...
    int ret;
    while (size) {
    let mut bus_ofs: c_ulong = offset & ~(map_bankwidth(map)-1);
    let mut gap: c_int = offset - bus_ofs;
    let mut n: c_int = min_t(int, size, map_bankwidth(map)-gap);
...
// next OTP region
    ...
    size_t retlen;
    return cfi_intelext_otp_walk(mtd, from, len, &retlen,
    core::ptr::null_mut(), do_otp_lock, 1);
    }
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_save_locks(mtd: *mut mtd_info) {
    ...
    do_getlockstatus_oneblock, adr, len, core::ptr::null_mut());
    if (status)
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_suspend(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_restore_locks(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_resume(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_reset(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_intelext_destroy(mtd: *mut mtd_info) {
