...
//! Source: drivers/mtd/chips/cfi_cmdset_0002.c
#![no_std]
...
// Macro flag: #define AMD_BOOTLOC_BUG
pub const FORCE_WORD_WRITE: c_int = 0;
...
pub const AT49BV6416: c_uint = 0x00d6;
pub const S29GL064N_MN12: c_uint = 0x0c01;
//
...
//
    ...
    .probe		= core::ptr::null_mut(), /* Not usable directly */
...
//
#[no_mangle]
unsafe extern "C" fn cfi_use_status_reg(cfi: *mut cfi_private) -> c_int {
    static int cfi_use_status_reg(struct cfi_private *cfi)
    {
    struct cfi_pri_amdstd *extp = cfi.cmdset_priv;
    let mut poll_mask: u8 = CFI_POLL_STATUS_REG | CFI_POLL_DQ;
    ...
    cfi.device_type, core::ptr::null_mut());
    status = map_read(map, adr);
// The error bits are invalid while the chip's busy
    if (!map_word_bitsset(map, status, CMD(CFI_SR_DRB)))
    return 0;
    if (map_word_bitsset(map, status, CMD(0x3a))) {
    let mut chipstatus: c_ulong = MERGESTATUS(status);
...
#[no_mangle]
unsafe extern "C" fn cfi_tell_features(extp: *mut cfi_pri_amdstd) {
...
#[no_mangle]
unsafe extern "C" fn fixup_amd_bootblock(mtd: *mut mtd_info) {
    static void fixup_amd_bootblock(struct mtd_info *mtd)
    {
    struct map_info *map = mtd.priv;
    struct cfi_private *cfi = map.fldrv_priv;
    struct cfi_pri_amdstd *extp = cfi.cmdset_priv;
    let mut major: __u8 = extp.MajorVersion;
    let mut minor: __u8 = extp.MinorVersion;
...
#[no_mangle]
unsafe extern "C" fn fixup_use_write_buffers(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_convert_atmel_pri(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_use_secsi(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_use_erase_chip(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_use_atmel_lock(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_old_sst_eraseregion(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_sst39vf(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_sst39vf_rev_b(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_sst38vf640x_sectorsize(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_s29gl064n_sectors(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_s29gl032n_sectors(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_s29ns512p_sectors(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn fixup_quirks(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn is_m29ew(cfi: *mut cfi_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cfi_fixup_m29ew_delay_after_resume(cfi: *mut cfi_private) {
...
// Fill in the default mtd operations
    ...
    let mut adr: __u16 = primary?cfi.cfiq.P_ADR:cfi.cfiq.A_ADR;
    struct cfi_pri_amdstd *extp;
...
// Tell the user about it in lots of lovely detail
    ...
    let mut j: c_int = (cfi.cfiq.NumEraseRegions-1)-i;
...
#[no_mangle]
pub unsafe extern "C" fn if(CFI_MODE_JEDEC: cfi->cfi_mode ==) -> else {
...
//
    ...
    struct map_info *map = mtd.priv;
    struct cfi_private *cfi = map.fldrv_priv;
    let mut devsize: c_ulong = (1<<cfi.cfiq.DevSize) * cfi.interleave;
...
//
    ...
    int ret;
    if (cfi_use_status_reg(cfi)) {
    let mut ready: map_word = CMD(CFI_SR_DRB);
//
...
#[no_mangle]
unsafe extern "C" fn get_chip(map: *mut map_info, chip: *mut flchip, adr: c_ulong, mode: c_int) -> c_int {
    static int get_chip(struct map_info *map, struct flchip *chip, unsigned long adr, int mode)
    {
    ...
    case FL_STATUS:
    for (;;) {
    if (chip_ready(map, chip, adr, core::ptr::null_mut()))
    break;
...
#[no_mangle]
unsafe extern "C" fn put_chip(map: *mut map_info, chip: *mut flchip, adr: c_ulong) {
    static void put_chip(struct map_info *map, struct flchip *chip, unsigned long adr)
    {
    struct cfi_private *cfi = map.fldrv_priv;
...
// Macro flag: #define XIP_INVAL_CACHED_RANGE(x...)
...
#[no_mangle]
pub unsafe extern "C" fn do_read_onechip(map: *mut map_info, chip: *mut flchip, adr: loff_t, len: usize, buf: *mut u_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_read(mtd: *mut mtd_info, from: loff_t, len: usize, retlen: *mut usize, buf: *mut u_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_secsi_read(mtd: *mut mtd_info, from: loff_t, len: usize, retlen: *mut usize, buf: *mut u_char) -> c_int {
...
// retlen += thislen;
    ...
    int ret;
    while (len) {
    let mut bus_ofs: c_ulong = adr & ~(map_bankwidth(map)-1);
    let mut gap: c_int = adr - bus_ofs;
    let mut n: c_int = min_t(int, len, map_bankwidth(map) - gap);
    let mut datum: map_word = map_word_ff(map);
...
// exit protection commands
    ...
    struct map_info *map = mtd.priv;
    struct cfi_private *cfi = map.fldrv_priv;
    let mut ofs_factor: c_int = cfi.interleave * cfi.device_type;
    unsigned long base;
    int chipnum;
    struct flchip *chip;
    uint8_t otp, lockreg;
    ...
    let mut user_locked: c_int = 0, otplocked;
// retlen = 0;
...
// retlen += size;
    ...
    {
    size_t retlen;
    return cfi_amdstd_otp_walk(mtd, from, len, &retlen, core::ptr::null_mut(),
    do_otp_lock, 1);
    }
...
//
    let mut uWriteTimeout: c_ulong = (HZ / 1000) + 1;
    let mut ret: c_int = 0;
    cfi_send_gen_cmd(0xAA, cfi.addr_unlock1, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0x55, cfi.addr_unlock2, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0xA0, cfi.addr_unlock1, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
...
// If it's not bus-aligned, do the first byte write
    ...
    let mut bus_ofs: c_ulong = ofs & ~(map_bankwidth(map)-1);
    let mut i: c_int = ofs - bus_ofs;
    let mut n: c_int = 0;
    map_word tmp_buf;
    retry:
...
// Write Buffer Program Confirm: GO GO GO
    ...
    struct map_info *map = mtd.priv;
    struct cfi_private *cfi = map.fldrv_priv;
    let mut wbufsize: c_int = cfi_interleave(cfi) << cfi.cfiq.MaxBufWriteSize;
    int ret;
    int chipnum;
    unsigned long ofs;
    chipnum = to >> cfi.chipshift;
...
// If it's not bus-aligned, do the first word write
    if (ofs & (map_bankwidth(map)-1)) {
    let mut local_len: usize = (-ofs)&(map_bankwidth(map)-1);
    if (local_len > len)
    local_len = len;
...
//
    if (chip.state == FL_READY && chip_ready(map, chip, adr, core::ptr::null_mut()))
    return 0;
//
...
//
    while (retries > 0) {
    let mut timeo: c_ulong = (HZ / 1000) + 1;
...
//
#[no_mangle]
unsafe extern "C" fn do_erase_chip(map: *mut map_info, chip: *mut flchip) -> int __xipram {
    ...
    cfi_send_gen_cmd(0xAA, cfi.addr_unlock1, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0x55, cfi.addr_unlock2, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0x80, cfi.addr_unlock1, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0xAA, cfi.addr_unlock1, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0x55, cfi.addr_unlock2, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
    cfi_send_gen_cmd(0x10, cfi.addr_unlock1, chip.start, map, cfi, cfi.device_type, core::ptr::null_mut());
    chip.state = FL_ERASING;
...
#[no_mangle]
unsafe extern "C" fn do_erase_oneblock(map: *mut map_info, chip: *mut flchip, adr: c_ulong, len: c_int, thunk: *mut c_void) -> int __xipram {
...
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_erase_varsize(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
    static int cfi_amdstd_erase_varsize(struct mtd_info *mtd, struct erase_info *instr)
    {
    return cfi_varsize_frob(mtd, do_erase_oneblock, instr.addr,
    instr.len, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_erase_chip(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_atmel_lock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
    static int cfi_atmel_lock(struct mtd_info *mtd, loff_t ofs, uint64_t len)
    {
    return cfi_varsize_frob(mtd, do_atmel_lock, ofs, len, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn cfi_atmel_unlock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
    static int cfi_atmel_unlock(struct mtd_info *mtd, loff_t ofs, uint64_t len)
    {
    return cfi_varsize_frob(mtd, do_atmel_unlock, ofs, len, core::ptr::null_mut());
    }
//
...
//
    ...
    length = mtd.size;
    while (length) {
    let mut size: c_int = regions[i].erasesize;
//
...
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_sync(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_suspend(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_resume(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_reset(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cfi_amdstd_destroy(mtd: *mut mtd_info) {
