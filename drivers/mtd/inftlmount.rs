...
//! Source: drivers/mtd/inftlmount.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn find_boot_record(inftl: *mut INFTLrecord) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn INFTL_formatblock(inftl: *mut INFTLrecord, block: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn format_chain(inftl: *mut INFTLrecord, first_block: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn INFTL_dumptables(s: *mut INFTLrecord) {
...
#[no_mangle]
pub unsafe extern "C" fn INFTL_dumpVUchains(s: *mut INFTLrecord) {
...
#[no_mangle]
pub unsafe extern "C" fn INFTL_mount(s: *mut INFTLrecord) -> c_int {
