...
//! Source: drivers/mtd/devices/mchp48l640.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp48_caps {
    pub size: c_uint,
    pub page_size: c_uint,
    pub auto_disable_wel: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp48l640_flash {
    pub spi: *mut spi_device,
    pub lock: mutex,
    pub mtd: mtd_info,
    pub caps: *const mchp48_caps,
}

pub const MCHP48L640_CMD_WREN: c_uint = 0x06;
pub const MCHP48L640_CMD_WRDI: c_uint = 0x04;
pub const MCHP48L640_CMD_WRITE: c_uint = 0x02;
pub const MCHP48L640_CMD_READ: c_uint = 0x03;
pub const MCHP48L640_CMD_WRSR: c_uint = 0x01;
pub const MCHP48L640_CMD_RDSR: c_uint = 0x05;
pub const MCHP48L640_STATUS_RDY: c_uint = 0x01;
pub const MCHP48L640_STATUS_WEL: c_uint = 0x02;
pub const MCHP48L640_STATUS_BP0: c_uint = 0x04;
pub const MCHP48L640_STATUS_BP1: c_uint = 0x08;
pub const MCHP48L640_STATUS_SWM: c_uint = 0x10;
pub const MCHP48L640_STATUS_PRO: c_uint = 0x20;
pub const MCHP48L640_STATUS_ASE: c_uint = 0x40;
pub const MCHP48L640_TIMEOUT: c_int = 100;
pub const MAX_CMD_SIZE: c_uint = 0x10;

#[no_mangle]
unsafe extern "C" fn mchp48l640_mkcmd(flash: *mut mchp48l640_flash, cmd: u8, addr: loff_t, buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp48l640_read_status(flash: *mut mchp48l640_flash, status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp48l640_waitforbit(flash: *mut mchp48l640_flash, bit: c_int, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp48l640_write_prepare(flash: *mut mchp48l640_flash, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp48l640_set_mode(flash: *mut mchp48l640_flash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp48l640_wait_rdy(flash: *mut mchp48l640_flash) -> c_int {
...
// retlen += len;
    ...
    let mut woff: loff_t = to;
    size_t ws;
    let mut page_sz: usize = flash.caps.page_size;
//
...
#[no_mangle]
unsafe extern "C" fn mchp48l640_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp48l640_remove(spi: *mut spi_device) {
