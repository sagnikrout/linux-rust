...
//! Source: drivers/mtd/devices/mtd_dataflash.c
#![no_std]
...
pub const OP_READ_CONTINUOUS: c_uint = 0xE8;
pub const OP_READ_PAGE: c_uint = 0xD2;
// group B requests can run even while status reports "busy"
pub const OP_READ_STATUS: c_uint = 0xD7	/* group B */;
// move data between host and buffer
pub const OP_READ_BUFFER1: c_uint = 0xD4	/* group B */;
pub const OP_READ_BUFFER2: c_uint = 0xD6	/* group B */;
pub const OP_WRITE_BUFFER1: c_uint = 0x84	/* group B */;
pub const OP_WRITE_BUFFER2: c_uint = 0x87	/* group B */;
// erasing flash
pub const OP_ERASE_PAGE: c_uint = 0x81;
pub const OP_ERASE_BLOCK: c_uint = 0x50;
// move data between buffer and flash
pub const OP_TRANSFER_BUF1: c_uint = 0x53;
pub const OP_TRANSFER_BUF2: c_uint = 0x55;
pub const OP_MREAD_BUFFER1: c_uint = 0xD4;
pub const OP_MREAD_BUFFER2: c_uint = 0xD6;
pub const OP_MWERASE_BUFFER1: c_uint = 0x83;
pub const OP_MWERASE_BUFFER2: c_uint = 0x86;
pub const OP_MWRITE_BUFFER1: c_uint = 0x88	/* sector must be pre-erased */;
pub const OP_MWRITE_BUFFER2: c_uint = 0x89	/* sector must be pre-erased */;
// write to buffer, then write-erase to flash
pub const OP_PROGRAM_VIA_BUF1: c_uint = 0x82;
pub const OP_PROGRAM_VIA_BUF2: c_uint = 0x85;
// compare buffer to flash
pub const OP_COMPARE_BUF1: c_uint = 0x60;
pub const OP_COMPARE_BUF2: c_uint = 0x61;
// read flash to buffer, then write-erase to flash
pub const OP_REWRITE_VIA_BUF1: c_uint = 0x58;
pub const OP_REWRITE_VIA_BUF2: c_uint = 0x59;
// newer chips report JEDEC manufacturer and device IDs; chip
// serial number and OTP bits; and per-sector writeprotect.
//
pub const OP_READ_ID: c_uint = 0x9F;
pub const OP_READ_SECURITY: c_uint = 0x77;
pub const OP_WRITE_SECURITY_REVC: c_uint = 0x9A;
pub const OP_WRITE_SECURITY: c_uint = 0x9B	/* revision D */;
pub const CFI_MFR_ATMEL: c_uint = 0x1F;
pub const DATAFLASH_SHIFT_EXTID: c_int = 24;
pub const DATAFLASH_SHIFT_ID: c_int = 40;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dataflash {
    pub command: [u8; 4],
    pub name: [c_char; 24],
    pub /: *mut *mut unsigned short page_offset; / offset in flash address,
    pub /: *mut *mut unsigned int page_size; / of bytes per page,
    pub lock: mutex,
...
//
#[no_mangle]
pub unsafe extern "C" fn dataflash_status(spi: *mut spi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dataflash_waitready(spi: *mut spi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dataflash_erase(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
    static int dataflash_erase(struct mtd_info *mtd, struct erase_info *instr)
    {
    struct dataflash	*priv = mtd.priv;
    struct spi_device	*spi = priv.spi;
    let mut x: spi_transfer = { };
    struct spi_message	msg;
    let mut blocksize: unsigned = priv.page_size << 3;
    u8			*command;
    u32			rem;
...
// name must be usable with cmdlinepart
    ...
    pdata ? pdata.parts : core::ptr::null_mut(),
...
// The size listed here is what works with OP_ERASE_PAGE.
    ...
    pub pageoffset: u16,
    pub flags: u16,
pub const SUP_EXTID: c_uint = 0x0004		/* supports extended ID data */;
pub const SUP_POW2PS: c_uint = 0x0002		/* supports 2^N byte pages */;
pub const IS_POW2PS: c_uint = 0x0001		/* uses 2^N byte pages */;
}
...
//
    ...
    {
    int ret;
    let mut code: u8 = OP_READ_ID;
    u64 jedec;
    u8 id[sizeof(jedec)] = {0};
    let mut id_size: c_uint = 5;
    struct flash_info *info;
//
...
//
#[no_mangle]
unsafe extern "C" fn dataflash_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dataflash_remove(spi: *mut spi_device) {
