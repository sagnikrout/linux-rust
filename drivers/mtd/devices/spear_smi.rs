...
//! Source: drivers/mtd/devices/spear_smi.c
#![no_std]
...
// registers of smi
pub const SMI_CR1: c_uint = 0x0	/* SMI control register 1 */;
pub const SMI_CR2: c_uint = 0x4	/* SMI control register 2 */;
pub const SMI_SR: c_uint = 0x8	/* SMI status register */;
pub const SMI_TR: c_uint = 0xC	/* SMI transmit register */;
pub const SMI_RR: c_uint = 0x10	/* SMI receive register */;
// defines for control_reg 1

// defines for control_reg 2

pub const TX_LEN_SHIFT: c_int = 0;
pub const RX_LEN_SHIFT: c_int = 4;
pub const BANK_SHIFT: c_int = 12;
// defines for status register
pub const SR_WIP: c_uint = 0x1	/* Write in progress */;
pub const SR_WEL: c_uint = 0x2	/* Write enable latch */;
pub const SR_BP0: c_uint = 0x4	/* Block protect 0 */;
pub const SR_BP1: c_uint = 0x8	/* Block protect 1 */;
pub const SR_BP2: c_uint = 0x10	/* Block protect 2 */;
pub const SR_SRWD: c_uint = 0x80	/* SR write protect */;
pub const TFF: c_uint = 0x100	/* Transfer Finished Flag */;
pub const WCF: c_uint = 0x200	/* Transfer Finished Flag */;
pub const ERF1: c_uint = 0x400	/* Forbidden Write Request */;
pub const ERF2: c_uint = 0x800	/* Forbidden Access */;
pub const WM_SHIFT: c_int = 12;
// flash opcodes
pub const OPCODE_RDID: c_uint = 0x9f	/* Read JEDEC ID */;
...
pub struct flash_device {
    ...
    pub device_id: u32,
    pub pagesize: u32,
    pub sectorsize: c_ulong,
    pub size_in_bytes: c_ulong,
}
...
pub struct spear_smi {
    ...
    pub cmd_complete: wait_queue_head_t,
    pub num_flashes: u32,
    pub flash: [*mut spear_snor_flash; MAX_NUM_FLASH_CHIP],
}
...
//
#[no_mangle]
unsafe extern "C" fn spear_smi_read_sr(dev: *mut spear_smi, bank: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spear_smi_int_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn spear_smi_hw_init(dev: *mut spear_smi) {
...
//
#[no_mangle]
unsafe extern "C" fn get_flash_index(flash_id: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spear_smi_write_enable(dev: *mut spear_smi, bank: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spear_mtd_erase(mtd: *mut mtd_info, e_info: *mut erase_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spear_smi_probe_flash(dev: *mut spear_smi, bank: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn spear_smi_probe(pdev: *mut platform_device) -> c_int {
    static int spear_smi_probe(struct platform_device *pdev)
    {
    struct device_node *np = pdev.dev.of_node;
    struct spear_smi_plat_data *pdata = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn spear_smi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn spear_smi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spear_smi_resume(dev: *mut device) -> c_int {
