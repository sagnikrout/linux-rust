...
//! Source: drivers/mtd/devices/pmc551.c
#![no_std]
...
pub const PCI_VENDOR_ID_V3_SEMI: c_uint = 0x11b0;
pub const PCI_DEVICE_ID_V3_SEMI_V370PDC: c_uint = 0x0200;
pub const PMC551_PCI_MEM_MAP0: c_uint = 0x50;
pub const PMC551_PCI_MEM_MAP1: c_uint = 0x54;
pub const PMC551_PCI_MEM_MAP_MAP_ADDR_MASK: c_uint = 0x3ff00000;
pub const PMC551_PCI_MEM_MAP_APERTURE_MASK: c_uint = 0x000000f0;
pub const PMC551_PCI_MEM_MAP_REG_EN: c_uint = 0x00000002;
pub const PMC551_PCI_MEM_MAP_ENABLE: c_uint = 0x00000001;
pub const PMC551_SDRAM_MA: c_uint = 0x60;
pub const PMC551_SDRAM_CMD: c_uint = 0x62;
pub const PMC551_DRAM_CFG: c_uint = 0x64;
pub const PMC551_SYS_CTRL_REG: c_uint = 0x78;
pub const PMC551_DRAM_BLK0: c_uint = 0x68;
pub const PMC551_DRAM_BLK1: c_uint = 0x6c;
pub const PMC551_DRAM_BLK2: c_uint = 0x70;
pub const PMC551_DRAM_BLK3: c_uint = 0x74;
...
#[no_mangle]
unsafe extern "C" fn pmc551_erase(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc551_unpoint(mtd: *mut mtd_info, from: loff_t, len: usize) -> c_int {
    ...
    eoff_hi = end & ~(priv.asize - 1);
    eoff_lo = end & (priv.asize - 1);
    pmc551_point(mtd, from, len, retlen, (void **)&ptr, core::ptr::null_mut());
    if (soff_hi == eoff_hi) {
// The whole thing fits within one access, so just one shot
    will do it. */
...
// retlen = copyto - buf;
    ...
    eoff_hi = end & ~(priv.asize - 1);
    eoff_lo = end & (priv.asize - 1);
    pmc551_point(mtd, to, len, retlen, (void **)&ptr, core::ptr::null_mut());
    if (soff_hi == eoff_hi) {
// The whole thing fits within one access, so just one shot
    will do it. */
...
//
#[no_mangle]
unsafe extern "C" fn fixup_pmc551(dev: *mut pci_dev) -> int __init {
...
//
    let mut msize: static int = 0;
    let mut asize: static int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn init_pmc551() -> int __init {
    static int __init init_pmc551(void)
    {
    struct pci_dev *PCI_Device = core::ptr::null_mut();
    struct mypriv *priv;
...
//
#[no_mangle]
unsafe extern "C" fn cleanup_pmc551() -> void __exit {
