...
//! Source: drivers/mtd/devices/powernv_flash.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn powernv_flash_erase(mtd: *mut mtd_info, erase: *mut erase_info) -> c_int {
    static int powernv_flash_erase(struct mtd_info *mtd, struct erase_info *erase)
    {
    int rc;
    rc =  powernv_flash_async_op(mtd, FLASH_OP_ERASE, erase.addr,
    erase.len, core::ptr::null_mut(), core::ptr::null_mut());
    if (rc)
...
//
#[no_mangle]
unsafe extern "C" fn powernv_flash_probe(pdev: *mut platform_device) -> c_int {
...
//
    return mtd_device_register(&data.mtd, core::ptr::null_mut(), 0);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn powernv_flash_release(pdev: *mut platform_device) {
