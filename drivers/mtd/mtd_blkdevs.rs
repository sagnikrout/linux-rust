...
//! Source: drivers/mtd/mtd_blkdevs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn blktrans_dev_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn blktrans_dev_put(dev: *mut mtd_blktrans_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mtd_blktrans_cease_background(dev: *mut mtd_blktrans_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtd_blktrans_work(dev: *mut mtd_blktrans_dev) {
    ...
    let mut background_done: c_int = 0;
    while (1) {
    blk_status_t res;
    dev.bg_stop = false;
...
#[no_mangle]
unsafe extern "C" fn blktrans_open(disk: *mut gendisk, mode: blk_mode_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn blktrans_release(disk: *mut gendisk) {
...
#[no_mangle]
unsafe extern "C" fn blktrans_getgeo(disk: *mut gendisk, geo: *mut hd_geometry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn add_mtd_blktrans_dev(new: *mut mtd_blktrans_dev) -> c_int {
    int add_mtd_blktrans_dev(struct mtd_blktrans_dev *new)
    {
    struct mtd_blktrans_ops *tr = new.tr;
    struct mtd_blktrans_dev *d;
    let mut lim: queue_limits = { };
    let mut last_devnum: c_int = -1;
    struct gendisk *gd;
    int ret;
...
// Create the request queue
    ...
    if (new.readonly)
    set_disk_ro(gd, 1);
    ret = device_add_disk(&new.mtd.dev, gd, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
pub unsafe extern "C" fn del_mtd_blktrans_dev(old: *mut mtd_blktrans_dev) -> c_int {
...
// Kill current requests
    ...
    old.rq.queuedata = core::ptr::null_mut();
...
// If the device is currently open, tell trans driver to close it,
    ...
    old.mtd = core::ptr::null_mut();
    mutex_unlock(&old.lock);
    blktrans_dev_put(old);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn blktrans_notify_remove(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn blktrans_notify_add(mtd: *mut mtd_info) {
...
#[no_mangle]
pub unsafe extern "C" fn register_mtd_blktrans(tr: *mut mtd_blktrans_ops) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn deregister_mtd_blktrans(tr: *mut mtd_blktrans_ops) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtd_blktrans_exit() -> void __exit {
