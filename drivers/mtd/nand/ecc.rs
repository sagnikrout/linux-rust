...
//
#[no_mangle]
pub unsafe extern "C" fn nand_ecc_init_ctx(nand: *mut nand_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_ecc_cleanup_ctx(nand: *mut nand_device) {
...
#[no_mangle]
unsafe extern "C" fn of_get_nand_ecc_placement(np: *mut device_node) -> enum nand_ecc_placement {
...
#[no_mangle]
unsafe extern "C" fn of_get_nand_ecc_algo(np: *mut device_node) -> enum nand_ecc_algo {
...
#[no_mangle]
unsafe extern "C" fn of_get_nand_ecc_step_size(np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_get_nand_ecc_strength(np: *mut device_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn of_get_nand_ecc_user_config(nand: *mut nand_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_ecc_is_strong_enough(nand: *mut nand_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nand_ecc_cleanup_req_tweaking(ctx: *mut nand_ecc_req_tweak_ctx) {
...
// req = *orig;
    ...
    {
    let mut algo: c_uint = nand.ecc.user_conf.algo;
...
#[no_mangle]
pub unsafe extern "C" fn nand_ecc_register_on_host_hw_engine(engine: *mut nand_ecc_engine) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nand_ecc_unregister_on_host_hw_engine(engine: *mut nand_ecc_engine) -> c_int {
    ...
    {
    struct nand_ecc_engine *engine = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn nand_ecc_put_on_host_hw_engine(nand: *mut nand_device) {
