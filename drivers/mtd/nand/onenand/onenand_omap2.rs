...
//! Source: drivers/mtd/nand/onenand/onenand_omap2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn omap2_onenand_dma_complete_func(completion: *mut c_void) {
    static void omap2_onenand_dma_complete_func(void *completion)
    {
    complete(completion);
    }
#[no_mangle]
unsafe extern "C" fn omap2_onenand_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn read_reg(c: *mut omap2_onenand, reg: c_int) -> c_ushort {
    ...
    {
    let mut reg: c_ushort = ONENAND_SYS_CFG1_RDY | ONENAND_SYS_CFG1_INT;
...
#[no_mangle]
unsafe extern "C" fn omap2_onenand_get_freq(ver: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_err(msg: *mut c_char, state: c_int, ctrl: c_uint, intr: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn omap2_onenand_wait(mtd: *mut mtd_info, state: c_int) -> c_int {
    ...
    let mut i: c_int = 21;
    let mut intr_flags: c_uint = ONENAND_INT_MASTER;
    switch (state) {
    case FL_RESETTING:
...
//
    ...
    let mut ecc: c_int = read_reg(c, ONENAND_REG_ECC_STATUS);
    if (ecc) {
...
#[no_mangle]
pub unsafe extern "C" fn omap2_onenand_bufferram_offset(mtd: *mut mtd_info, area: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap2_onenand_shutdown(pdev: *mut platform_device) {
...
// soft reset.
//
    memset(( void *)c.onenand.base, 0, ONENAND_BUFRAM_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn omap2_onenand_probe(pdev: *mut platform_device) -> c_int {
...
// Just try again if this happens
    ...
    c.dma_chan = dma_request_channel(mask, core::ptr::null_mut(), core::ptr::null_mut());
    if (c.dma_chan) {
    ...
    r = mtd_device_register(&c.mtd, core::ptr::null_mut(), 0);
    if (r)
    goto err_release_onenand;
...
#[no_mangle]
unsafe extern "C" fn omap2_onenand_remove(pdev: *mut platform_device) {
