...
//! Source: drivers/mtd/nand/onenand/onenand_base.c
#![no_std]
...
//
pub const MB_ERASE_MIN_BLK_COUNT: c_int = 2;
pub const MB_ERASE_MAX_BLK_COUNT: c_int = 64;
// Default Flex-OneNAND boundary and lock respectively
    static int flex_bdry[MAX_DIES * 2] = { -1, 0, -1, 0 };
    module_param_array(flex_bdry, int, core::ptr::null_mut(), 0400);
...
//
    ...
    struct mtd_oob_region *oobregion)
    {
    let mut sections: c_int = (mtd.oobsize / 32) * 2;
    if (section >= sections)
    return -ERANGE;
    if (section & 1) {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_readw(addr: *mut void __iomem) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_writew(value: c_ushort, addr: *mut void __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_block_address(this: *mut onenand_chip, block: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_bufferram_address(this: *mut onenand_chip, block: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_page_address(page: c_int, sector: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_buffer_address(dataram1: c_int, sectors: c_int, count: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn flexonenand_block(this: *mut onenand_chip, addr: loff_t) -> unsigned {
...
#[no_mangle]
pub unsafe extern "C" fn onenand_block(this: *mut onenand_chip, addr: loff_t) -> unsigned {
...
//
#[no_mangle]
unsafe extern "C" fn flexonenand_addr(this: *mut onenand_chip, block: c_int) -> loff_t {
    static loff_t flexonenand_addr(struct onenand_chip *this, int block)
    {
    let mut ofs: loff_t = 0;
    let mut die: c_int = 0, boundary;
...
#[no_mangle]
pub unsafe extern "C" fn onenand_addr(this: *mut onenand_chip, block: c_int) -> loff_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn onenand_get_density(dev_id: c_int) -> c_int {
    static inline int onenand_get_density(int dev_id)
    {
    let mut density: c_int = dev_id >> ONENAND_DEVICE_DENSITY_SHIFT;
...
//
#[no_mangle]
pub unsafe extern "C" fn flexonenand_region(mtd: *mut mtd_info, addr: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_command(mtd: *mut mtd_info, cmd: c_int, addr: loff_t, len: usize) -> c_int {
...
// Now we use page size operation
    let mut sectors: c_int = 0, count = 0;
    int dataram;
    switch (cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn onenand_read_ecc(this: *mut onenand_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_wait(mtd: *mut mtd_info, state: c_int) -> c_int {
    static int onenand_wait(struct mtd_info *mtd, int state)
    {
    let mut this: *mut onenand_chip = mtd.priv;
    unsigned long timeout;
    let mut flags: c_uint = ONENAND_INT_MASTER;
...
//
    ...
    let mut ecc: c_int = onenand_read_ecc(this);
    if (ecc) {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_interrupt_wait(mtd: *mut mtd_info, state: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_try_interrupt_wait(mtd: *mut mtd_info, state: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_setup_wait(mtd: *mut mtd_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn onenand_bufferram_offset(mtd: *mut mtd_info, area: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_get_2x_blockpage(mtd: *mut mtd_info, addr: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_check_bufferram(mtd: *mut mtd_info, addr: loff_t) -> c_int {
...
// Select DataRAM for DDP
    let mut block: c_int = onenand_block(this, addr);
    let mut value: c_int = onenand_bufferram_address(this, block);
    this.write_word(value, this.base + ONENAND_REG_START_ADDRESS2);
    }
    return found;
    }
...
//
    ...
    struct onenand_chip *this = mtd.priv;
    int i;
    let mut end_addr: loff_t = addr + len;
// Invalidate BufferRAM
    for (i = 0; i < MAX_BUFFERRAM; i++) {
    let mut buf_addr: loff_t = this.bufferram[i].blockpage << this.page_shift;
...
//
#[no_mangle]
unsafe extern "C" fn onenand_get_device(mtd: *mut mtd_info, new_state: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_release_device(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_recover_lsb(mtd: *mut mtd_info, addr: loff_t, status: c_int) -> c_int {
...
//
    ...
    let mut len: usize = ops.len;
    let mut ooblen: usize = ops.ooblen;
    u_char *buf = ops.datbuf;
    u_char *oobbuf = ops.oobbuf;
    let mut read: c_int = 0, column, thislen;
    let mut oobread: c_int = 0, oobcolumn, thisooblen, oobsize;
    let mut ret: c_int = 0;
    let mut writesize: c_int = this.writesize;
...
//
    ...
    let mut read: c_int = 0, column, thislen;
    let mut oobread: c_int = 0, oobcolumn, thisooblen, oobsize;
    let mut ret: c_int = 0, boundary = 0;
    let mut writesize: c_int = this.writesize;
    pr_debug("%s: from = 0x%08x, len = %i\n", __func__, (unsigned int)from,
    (int)len);
    oobsize = mtd_oobavail(mtd, ops);
...
//
    ...
    struct onenand_chip *this = mtd.priv;
    struct mtd_ecc_stats stats;
    let mut read: c_int = 0, thislen, column, oobsize;
    let mut len: usize = ops.ooblen;
    let mut mode: c_uint = ops.mode;
    u_char *buf = ops.oobbuf;
    let mut ret: c_int = 0, readcmd;
    from += ops.ooboffs;
    pr_debug("%s: from = 0x%08x, len = %i\n", __func__, (unsigned int)from,
    (int)len);
...
//
#[no_mangle]
unsafe extern "C" fn onenand_bbt_wait(mtd: *mut mtd_info, state: c_int) -> c_int {
...
//
    ...
    {
    struct onenand_chip *this = mtd.priv;
    let mut read: c_int = 0, thislen, column;
    let mut ret: c_int = 0, readcmd;
    let mut len: usize = ops.ooblen;
    u_char *buf = ops.oobbuf;
...
//
#[no_mangle]
unsafe extern "C" fn onenand_verify_oob(mtd: *mut mtd_info, buf: *const u_char, to: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_verify(mtd: *mut mtd_info, buf: *const u_char, addr: loff_t, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn onenand_panic_wait(mtd: *mut mtd_info) {
...
// Loop until all data write
    while (written < len) {
    let mut thislen: c_int = min_t(int, mtd.writesize - column, len - written);
...
//
    ...
    {
    struct onenand_chip *this = mtd.priv;
    let mut written: c_int = 0, column, thislen = 0, subpage = 0;
    let mut prev: c_int = 0, prevlen = 0, prev_subpage = 0, first = 1;
    let mut oobwritten: c_int = 0, oobcolumn, thisooblen, oobsize;
    let mut len: usize = ops.len;
    let mut ooblen: usize = ops.ooblen;
...
//
    ...
    let mut written: c_int = 0, oobcmd;
    u_char *oobbuf;
    let mut len: usize = ops.ooblen;
...
// Loop until all data write
    while (written < len) {
    let mut thislen: c_int = min_t(int, oobsize, len - written);
    cond_resched();
...
//
#[no_mangle]
unsafe extern "C" fn onenand_block_isbad_nolock(mtd: *mut mtd_info, ofs: loff_t, allowbbt: c_int) -> c_int {
...
// Return info from the table
    ...
    {
    struct onenand_chip *this = mtd.priv;
    let mut addr: loff_t = instr.addr;
    let mut len: c_int = instr.len;
    let mut block_size: c_uint = (1 << this.erase_shift);
    let mut ret: c_int = 0;
    while (len) {
...
//
    ...
    let mut addr: loff_t = instr.addr;
    let mut len: c_int = instr.len;
    let mut eb_count: c_int = 0;
    let mut ret: c_int = 0;
    let mut bdry_block: c_int = 0;
    if (ONENAND_IS_DDP(this)) {
    let mut bdry_addr: loff_t = this.chipsize >> 1;
...
// loop over 64 eb batches
    while (len) {
    let mut verify_instr: erase_info = *instr;
    let mut max_eb_count: c_int = MB_ERASE_MAX_BLK_COUNT;
    verify_instr.addr = addr;
    verify_instr.len = 0;
// do not cross chip boundary
    if (bdry_block) {
    let mut this_block: c_int = (addr >> this.erase_shift);
...
//
#[no_mangle]
unsafe extern "C" fn onenand_erase(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
    static int onenand_erase(struct mtd_info *mtd, struct erase_info *instr)
    {
    struct onenand_chip *this = mtd.priv;
    unsigned int block_size;
    let mut addr: loff_t = instr.addr;
    let mut len: loff_t = instr.len;
    let mut ret: c_int = 0;
    struct mtd_erase_region_info *region = core::ptr::null_mut();
    let mut region_offset: loff_t = 0;
    pr_debug("%s: start=0x%012llx, len=%llu\n", __func__,
    (unsigned long long)instr.addr,
    (unsigned long long)instr.len);
    if (FLEXONENAND(this)) {
// Find the eraseregion of this address
    let mut i: c_int = flexonenand_region(mtd, addr);
...
//
#[no_mangle]
unsafe extern "C" fn onenand_sync(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_block_isbad(mtd: *mut mtd_info, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_default_block_markbad(mtd: *mut mtd_info, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_block_markbad(mtd: *mut mtd_info, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_do_lock_cmd(mtd: *mut mtd_info, ofs: loff_t, len: usize, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_lock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_unlock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_check_lock_status(this: *mut onenand_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_unlock_all(mtd: *mut mtd_info) {
    static void onenand_unlock_all(struct mtd_info *mtd)
    {
    struct onenand_chip *this = mtd.priv;
    let mut ofs: loff_t = 0;
    let mut len: loff_t = mtd.size;
...
// Write 'DFS, FBA' of Flash
    ...
    if (page != -1) {
// Now we use page size operation
    let mut sectors: c_int = 4, count = 4;
    int dataram;
    switch (cmd) {
    default:
    if (ONENAND_IS_2PLANE(this) && cmd == ONENAND_CMD_PROG)
...
//
    ...
    {
    return onenand_otp_walk(mtd, 0, len, retlen, (u_char *) buf, core::ptr::null_mut(),
    MTD_OTP_FACTORY);
    }
//
...
//
    ...
    size_t retlen;
    int ret;
    let mut otp_lock_offset: c_uint = ONENAND_OTP_LOCK_OFFSET;
...
#[no_mangle]
pub unsafe extern "C" fn if(2: otp ==) -> else {
    else if (otp == 2)
    buf[otp_lock_offset] = 0xF3;
#[no_mangle]
pub unsafe extern "C" fn if(3: otp ==) -> else {
    else if (otp == 3)
    buf[otp_lock_offset] = 0xF0;
#[no_mangle]
pub unsafe extern "C" fn if(0: otp !=) -> else {
    else if (otp != 0)
...
//
#[no_mangle]
unsafe extern "C" fn onenand_check_features(mtd: *mut mtd_info) {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: numbufs ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_print_device_info(device: c_int, version: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_check_maf(manuf: c_int) -> c_int {
    static int onenand_check_maf(int manuf)
    {
    let mut size: c_int = ARRAY_SIZE(onenand_manuf_ids);
    char *name;
    int i;
    for (i = 0; i < size; i++)
...
//
#[no_mangle]
unsafe extern "C" fn flexonenand_get_boundary(mtd: *mut mtd_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn flexonenand_get_size(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn flexonenand_check_blocks_erased(mtd: *mut mtd_info, start: c_int, end: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_chip_probe(mtd: *mut mtd_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_probe(mtd: *mut mtd_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_suspend(mtd: *mut mtd_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn onenand_resume(mtd: *mut mtd_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn onenand_scan(mtd: *mut mtd_info, maxchips: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn onenand_release(mtd: *mut mtd_info) {
