...
//! Source: drivers/mtd/nand/ecc-mxic.c
#![no_std]
...
// DPE Configuration
pub const DP_CONFIG: c_uint = 0x00;

// DPE Interrupt Status
pub const INTRPT_STS: c_uint = 0x04;

// DPE Interrupt Status Enable
pub const INTRPT_STS_EN: c_uint = 0x08;
// DPE Interrupt Signal Enable
pub const INTRPT_SIG_EN: c_uint = 0x0C;
// Host Controller Configuration
pub const HC_CONFIG: c_uint = 0x10;

pub const BURST_TYP_FIXED: c_int = 0;

// Host Controller Slave Address
pub const HC_SLV_ADDR: c_uint = 0x14;
// ECC Chunk Size
pub const CHUNK_SIZE: c_uint = 0x20;
// Main Data Size
pub const MAIN_SIZE: c_uint = 0x24;
// Spare Data Size
pub const SPARE_SIZE: c_uint = 0x28;

// ECC Chunk Count
pub const CHUNK_CNT: c_uint = 0x30;
// SDMA Control
pub const SDMA_CTRL: c_uint = 0x40;
pub const WRITE_NAND: c_int = 0;

// SDMA Address of Main Data
pub const SDMA_MAIN_ADDR: c_uint = 0x44;
// SDMA Address of Spare Data
pub const SDMA_SPARE_ADDR: c_uint = 0x48;
// DPE Version Number
pub const DP_VER: c_uint = 0xD0;
pub const DP_VER_OFFSET: c_int = 16;
// Status bytes between each chunk of spare data
pub const STAT_BYTES: c_int = 4;
pub const NO_ERR: c_uint = 0x00;
pub const MAX_CORR_ERR: c_uint = 0x28;
pub const UNCORR_ERR: c_uint = 0xFE;
pub const ERASED_CHUNK: c_uint = 0xFF;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxic_ecc_engine {
    ...
    pub external_engine: nand_ecc_engine,
    pub pipelined_engine: nand_ecc_engine,
    pub lock: mutex,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxic_ecc_ctx {
// ECC machinery
    pub data_step_sz: c_uint,
    pub oob_step_sz: c_uint,
    pub parity_sz: c_uint,
    pub meta_sz: c_uint,
    pub status: *mut u8,
    pub steps: c_int,
// DMA boilerplate
    pub req_ctx: nand_ecc_req_tweak_ctx,
    pub oobwithstat: *mut u8,
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_disable_engine(mxic: *mut mxic_ecc_engine) {
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_enable_engine(mxic: *mut mxic_ecc_engine) {
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_disable_int(mxic: *mut mxic_ecc_engine) {
    static void mxic_ecc_disable_int(struct mxic_ecc_engine *mxic)
    {
    writel(0, mxic.regs + INTRPT_SIG_EN);
    }
#[no_mangle]
unsafe extern "C" fn mxic_ecc_enable_int(mxic: *mut mxic_ecc_engine) {
    static void mxic_ecc_enable_int(struct mxic_ecc_engine *mxic)
    {
    writel(TRANS_CMPLT, mxic.regs + INTRPT_SIG_EN);
    }
#[no_mangle]
unsafe extern "C" fn mxic_ecc_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_init_ctx(nand: *mut nand_device, dev: *mut device) -> c_int {
    ...
    let mut step_size: c_int = 0, strength = 0, desired_correction = 0, steps, idx;
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_init_ctx_external(nand: *mut nand_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_init_ctx_pipelined(nand: *mut nand_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_cleanup_ctx(nand: *mut nand_device) {
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_data_xfer_wait_for_completion(mxic: *mut mxic_ecc_engine) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_extract_status_bytes(ctx: *mut mxic_ecc_ctx) {
...
// Add some space in the OOB buffer for the status bytes
    ...
    let mut max_bf: c_uint = 0;
    let mut failure: bool = false;
    int step;
    for (step = 0; step < ctx.steps; step++) {
    let mut stat: u8 = ctx.status[step];
    if (stat == NO_ERR) {
...
#[no_mangle]
pub unsafe extern "C" fn mxic_ecc_put_pipelined_engine(eng: *mut nand_ecc_engine) {
...
//
#[no_mangle]
unsafe extern "C" fn mxic_ecc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxic_ecc_remove(pdev: *mut platform_device) {
