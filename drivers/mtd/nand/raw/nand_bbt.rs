...
//! Source: drivers/mtd/nand/raw/nand_bbt.c
#![no_std]
...
pub const BBT_BLOCK_GOOD: c_uint = 0x00;
pub const BBT_BLOCK_WORN: c_uint = 0x01;
pub const BBT_BLOCK_RESERVED: c_uint = 0x02;
pub const BBT_BLOCK_FACTORY_BAD: c_uint = 0x03;
pub const BBT_ENTRY_MASK: c_uint = 0x03;
pub const BBT_ENTRY_SHIFT: c_int = 2;
#[no_mangle]
pub unsafe extern "C" fn bbt_get_entry(chip: *mut nand_chip, block: c_int) -> u8 {
    static inline uint8_t bbt_get_entry(struct nand_chip *chip, int block)
    {
    let mut entry: u8 = chip.bbt[block >> BBT_ENTRY_SHIFT];
    ...
    uint8_t mark)
    {
    let mut msk: u8 = (mark & BBT_ENTRY_MASK) << ((block & BBT_ENTRY_MASK) * 2);
    chip.bbt[block >> BBT_ENTRY_SHIFT] |= msk;
    }
#[no_mangle]
unsafe extern "C" fn check_pattern_no_oob(buf: *mut u8, td: *mut nand_bbt_descr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_pattern(buf: *mut u8, len: c_int, paglen: c_int, td: *mut nand_bbt_descr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_short_pattern(buf: *mut u8, td: *mut nand_bbt_descr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_marker_len(td: *mut nand_bbt_descr) -> u32 {
...
//
    ...
    loff_t from;
    let mut bits: c_int = td.options & NAND_BBT_NRBITS_MSK;
    let mut msk: u8 = (uint8_t)((1 << bits) - 1);
    u32 marker_len;
    let mut reserved_block_code: c_int = td.reserved_block_code;
    totlen = (num * bits) >> 3;
...
// Analyse data
    for (i = 0; i < len; i++) {
    let mut dat: u8 = buf[i];
    for (j = 0; j < 8; j += bits, act++) {
    let mut tmp: u8 = (dat >> j) & msk;
    if (tmp == msk)
    continue;
...
//
    ...
    {
    struct mtd_info *mtd = nand_to_mtd(this);
    let mut targetsize: u64 = nanddev_target_size(&this.base);
...
//
    ...
    return res;
#[no_mangle]
pub unsafe extern "C" fn if(!ret: mtd_is_eccerr(res) ||) -> else {
...
#[no_mangle]
unsafe extern "C" fn bbt_get_ver_offs(this: *mut nand_chip, td: *mut nand_bbt_descr) -> u32 {
    static u32 bbt_get_ver_offs(struct nand_chip *this, struct nand_bbt_descr *td)
    {
    struct mtd_info *mtd = nand_to_mtd(this);
    let mut ver_offs: u32 = td.veroffs;
    if (!(td.options & NAND_BBT_NO_OOB))
...
//
    ...
    let mut scanlen: c_int = mtd.writesize + mtd.oobsize;
    int bbtblocks;
    let mut blocktopage: c_int = this.bbt_erase_shift - this.page_shift;
...
// Scan the maximum number of blocks
    ...
    let mut actblock: c_int = startblock + dir * block;
    let mut offs: loff_t = (loff_t)actblock << this.bbt_erase_shift;
...
//
    ...
    let mut block: c_int = startblock + dir * i;
...
//
    ...
    uint8_t msk[4];
    let mut rcode: u8 = td.reserved_block_code;
    size_t retlen, len = 0;
    loff_t to;
    let mut ops: mtd_oob_ops = { };
    ops.ooblen = mtd.oobsize;
...
// Walk through the memory table
    ...
    uint8_t dat;
    let mut sftcnt: c_int = (i << (3 - sft)) & sftmsk;
...
// Do we have a bbt per chip?
    ...
    writeops = 0;
    create = 0;
    rd = core::ptr::null_mut();
    rd2 = core::ptr::null_mut();
    res = res2 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn nand_update_bbt(this: *mut nand_chip, offs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mark_bbt_region(this: *mut nand_chip, td: *mut nand_bbt_descr) {
...
//
#[no_mangle]
unsafe extern "C" fn verify_bbt_descr(this: *mut nand_chip, bd: *mut nand_bbt_descr) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_scan_bbt(this: *mut nand_chip, bd: *mut nand_bbt_descr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_create_badblock_pattern(this: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_create_bbt(this: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_isreserved_bbt(this: *mut nand_chip, offs: loff_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_isbad_bbt(this: *mut nand_chip, offs: loff_t, allowbbt: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_markbad_bbt(this: *mut nand_chip, offs: loff_t) -> c_int {
