...
//! Source: drivers/mtd/nand/raw/nandsim.c
#![no_std]
...
pub const CONFIG_NANDSIM_FIRST_ID_BYTE: c_uint = 0x98;
pub const CONFIG_NANDSIM_SECOND_ID_BYTE: c_uint = 0x39;
pub const CONFIG_NANDSIM_THIRD_ID_BYTE: c_uint = 0xFF /* No byte */;
pub const CONFIG_NANDSIM_FOURTH_ID_BYTE: c_uint = 0xFF /* No byte */;

pub const CONFIG_NANDSIM_ACCESS_DELAY: c_int = 25;

pub const CONFIG_NANDSIM_PROGRAMM_DELAY: c_int = 200;

pub const CONFIG_NANDSIM_ERASE_DELAY: c_int = 2;

pub const CONFIG_NANDSIM_OUTPUT_CYCLE: c_int = 40;

pub const CONFIG_NANDSIM_INPUT_CYCLE: c_int = 50;

pub const CONFIG_NANDSIM_BUS_WIDTH: c_int = 8;

pub const CONFIG_NANDSIM_DO_DELAYS: c_int = 0;

pub const CONFIG_NANDSIM_LOG: c_int = 0;

pub const CONFIG_NANDSIM_DBG: c_int = 0;

pub const CONFIG_NANDSIM_MAX_PARTS: c_int = 32;

    let mut access_delay: static uint = CONFIG_NANDSIM_ACCESS_DELAY;
    let mut programm_delay: static uint = CONFIG_NANDSIM_PROGRAMM_DELAY;
    let mut erase_delay: static uint = CONFIG_NANDSIM_ERASE_DELAY;
    let mut output_cycle: static uint = CONFIG_NANDSIM_OUTPUT_CYCLE;
    let mut input_cycle: static uint = CONFIG_NANDSIM_INPUT_CYCLE;
    let mut bus_width: static uint = CONFIG_NANDSIM_BUS_WIDTH;
    let mut do_delays: static uint = CONFIG_NANDSIM_DO_DELAYS;
    let mut log: static uint = CONFIG_NANDSIM_LOG;
    let mut dbg: static uint = CONFIG_NANDSIM_DBG;
    static unsigned long parts[CONFIG_NANDSIM_MAX_PARTS];
    static unsigned int parts_num;
    static char *badblocks = core::ptr::null_mut();
    static char *weakblocks = core::ptr::null_mut();
    static char *weakpages = core::ptr::null_mut();
    let mut bitflips: static unsigned int = 0;
    static char *gravepages = core::ptr::null_mut();
    let mut overridesize: static unsigned int = 0;
    static char *cache_file = core::ptr::null_mut();
    ...
    module_param_array(id_bytes, byte, core::ptr::null_mut(), 0400);
...
pub const NS_LARGEST_PAGE_SIZE: c_int = 4096;
...
pub const STATE_CMD_READ0: c_uint = 0x00000001 /* read data from the beginning of page */;
pub const STATE_CMD_READ1: c_uint = 0x00000002 /* read data from the second half of page */;
pub const STATE_CMD_READSTART: c_uint = 0x00000003 /* read data second command (large page devices) */;
pub const STATE_CMD_PAGEPROG: c_uint = 0x00000004 /* start page program */;
pub const STATE_CMD_READOOB: c_uint = 0x00000005 /* read OOB area */;
pub const STATE_CMD_ERASE1: c_uint = 0x00000006 /* sector erase first command */;
pub const STATE_CMD_STATUS: c_uint = 0x00000007 /* read status */;
pub const STATE_CMD_SEQIN: c_uint = 0x00000009 /* sequential data input */;
pub const STATE_CMD_READID: c_uint = 0x0000000A /* read ID */;
pub const STATE_CMD_ERASE2: c_uint = 0x0000000B /* sector erase second command */;
pub const STATE_CMD_RESET: c_uint = 0x0000000C /* reset */;
pub const STATE_CMD_RNDOUT: c_uint = 0x0000000D /* random output command */;
pub const STATE_CMD_RNDOUTSTART: c_uint = 0x0000000E /* random output start command */;
pub const STATE_CMD_MASK: c_uint = 0x0000000F /* command states mask */;
// After an address is input, the simulator goes to one of these states
pub const STATE_ADDR_PAGE: c_uint = 0x00000010 /* full (row, column) address is accepted */;
pub const STATE_ADDR_SEC: c_uint = 0x00000020 /* sector address was accepted */;
pub const STATE_ADDR_COLUMN: c_uint = 0x00000030 /* column address was accepted */;
pub const STATE_ADDR_ZERO: c_uint = 0x00000040 /* one byte zero address was accepted */;
pub const STATE_ADDR_MASK: c_uint = 0x00000070 /* address states mask */;
// During data input/output the simulator is in these states
pub const STATE_DATAIN: c_uint = 0x00000100 /* waiting for data input */;
pub const STATE_DATAIN_MASK: c_uint = 0x00000100 /* data input states mask */;
pub const STATE_DATAOUT: c_uint = 0x00001000 /* waiting for page data output */;
pub const STATE_DATAOUT_ID: c_uint = 0x00002000 /* waiting for ID bytes output */;
pub const STATE_DATAOUT_STATUS: c_uint = 0x00003000 /* waiting for status output */;
pub const STATE_DATAOUT_MASK: c_uint = 0x00007000 /* data output states mask */;
// Previous operation is done, ready to accept new requests
pub const STATE_READY: c_uint = 0x00000000;
// This state is used to mark that the next state isn't known yet
pub const STATE_UNKNOWN: c_uint = 0x10000000;
// Simulator's actions bit masks
pub const ACTION_CPY: c_uint = 0x00100000 /* copy page/OOB to the internal buffer */;
pub const ACTION_PRGPAGE: c_uint = 0x00200000 /* program the internal buffer to flash */;
pub const ACTION_SECERASE: c_uint = 0x00300000 /* erase sector */;
pub const ACTION_ZEROOFF: c_uint = 0x00400000 /* don't add any offset to address */;
pub const ACTION_HALFOFF: c_uint = 0x00500000 /* add to address half of page */;
pub const ACTION_OOBOFF: c_uint = 0x00600000 /* add to address OOB offset */;
pub const ACTION_MASK: c_uint = 0x00700000 /* action mask */;

pub const OPT_ANY: c_uint = 0xFFFFFFFF /* any chip supports this operation */;
pub const OPT_PAGE512: c_uint = 0x00000002 /* 512-byte  page chips */;
pub const OPT_PAGE2048: c_uint = 0x00000008 /* 2048-byte page chips */;
pub const OPT_PAGE512_8BIT: c_uint = 0x00000040 /* 512-byte page chips with 8-bit bus width */;
pub const OPT_PAGE4096: c_uint = 0x00000080 /* 4096-byte page chips */;
...
//
pub const NS_MAX_PREVSTATES: c_int = 1;
// Maximum page cache pages needed to read or write a NAND page to the cache_file
pub const NS_MAX_HELD_PAGES: c_int = 16;
//
...
pub struct nandsim {
    ...
    pub partitions: [mtd_partition; CONFIG_NANDSIM_MAX_PARTS],
    pub nbparts: c_uint,
    pub /: *mut *mut uint busw; / flash chip bus width (8 or 16),
    pub /: *mut *mut u_char ids[8]; / chip's ID bytes,
    pub /: *mut *mut uint32_t options; / chip's characteristic bits,
    pub /: *mut *mut uint32_t state; / current chip state,
    pub /: *mut *mut uint32_t nxstate; / next expected state,
    pub /: *mut *mut *mut uint32_t op; / current operation, NULL operations isn't known yet,
    pub /: *mut *mut uint32_t pstates[NS_MAX_PREVSTATES]; / previous states,
    pub /: *mut *mut uint16_t npstates; / number of previous states saved,
    pub /: *mut *mut uint16_t stateidx; / current state index,
// The simulated NAND flash pages array
    pub pages: *mut union ns_mem,
// Slab allocator for nand pages
    pub nand_pages_slab: *mut kmem_cache,
// Internal buffer of page + OOB size bytes
    pub buf: union ns_mem,
// NAND flash "geometry"
    struct {
    pub /: *mut *mut uint64_t totsz; / total flash size, bytes,
    pub /: *mut *mut uint32_t secsz; / flash sector (erase block) size, bytes,
    pub /: *mut *mut uint pgsz; / NAND flash page size, bytes,
    pub /: *mut *mut uint oobsz; / page OOB area size, bytes,
    pub /: *mut *mut uint64_t totszoob; / total flash size including OOB, bytes,
    pub bytes*/: *mut *mut uint pgszoob; / page size including OOB ,,
    pub /: *mut *mut uint secszoob; / sector size including OOB, bytes,
    pub /: *mut *mut uint pgnum; / total number of pages,
    pub /: *mut *mut uint pgsec; / number of pages per sector,
    pub /: *mut *mut uint secshift; / bits number in sector size,
    pub /: *mut *mut uint pgshift; / bits number in page size,
    pub /: *mut *mut uint pgaddrbytes; / bytes per page address,
    pub /: *mut *mut uint secaddrbytes; / bytes per sector address,
    pub /: *mut *mut uint idbytes; / the number ID bytes that this chip outputs,
    pub geom: },
// NAND flash internal registers
    struct {
    pub /: *mut *mut unsigned command; / the command register,
    pub /: *mut *mut u_char status; / the status register,
    pub /: *mut *mut uint row; / the page number,
    pub /: *mut *mut uint column; / the offset within page,
    pub /: *mut *mut uint count; / internal counter,
    pub /: *mut *mut uint num; / number of bytes which must be processed,
    pub /: *mut *mut uint off; / fixed page offset,
    pub regs: },
// NAND flash lines state
    struct {
    pub /: *mut *mut int ce; / chip Enable,
    pub /: *mut *mut int cle; / command Latch Enable,
    pub /: *mut *mut int ale; / address Latch Enable,
    pub /: *mut *mut int wp; / write Protect,
    pub lines: },
// Fields needed when using a cache file
    pub /: *mut *mut *mut file cfile; / Open file,
    pub /: *mut *mut *mut unsigned long pages_written; / Which pages have been written,
    pub file_buf: *mut c_void,
    pub held_pages: [*mut page; NS_MAX_HELD_PAGES],
    pub held_cnt: c_int,
// debugfs entry
    pub dent: *mut dentry,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct weak_block {
    pub list: list_head,
    pub erase_block_no: c_uint,
    pub max_erases: c_uint,
    pub erases_done: c_uint,
}

    static LIST_HEAD(weak_blocks);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct weak_page {
    pub list: list_head,
    pub page_no: c_uint,
    pub max_writes: c_uint,
    pub writes_done: c_uint,
}

    static LIST_HEAD(weak_pages);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct grave_page {
    pub list: list_head,
    pub page_no: c_uint,
    pub max_reads: c_uint,
    pub reads_done: c_uint,
}

    static LIST_HEAD(grave_pages);
    static unsigned long *erase_block_wear = core::ptr::null_mut();
    let mut wear_eb_count: static unsigned int = 0;
    let mut total_wear: static unsigned long = 0;
// MTD structure for NAND controller
    static struct mtd_info *nsmtd;
#[no_mangle]
unsafe extern "C" fn ns_show(m: *mut seq_file, private: *mut c_void) -> c_int {
    static int ns_show(struct seq_file *m, void *private)
    {
    let mut wmin: c_ulong = -1, wmax = 0, avg;
    unsigned long deciles[10], decile_max[10], tot = 0;
    unsigned int i;
// Calc wear stats
    for (i = 0; i < wear_eb_count; ++i) {
    let mut wear: c_ulong = erase_block_wear[i];
    if (wear < wmin)
    wmin = wear;
    if (wear > wmax)
    wmax = wear;
...
// Output wear report
    ...
    for (i = 0; i < 10; ++i) {
    let mut from: c_ulong = (i ? decile_max[i - 1] + 1 : 0);
...
//
#[no_mangle]
unsafe extern "C" fn ns_debugfs_create(ns: *mut nandsim) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_debugfs_remove(ns: *mut nandsim) {
...
//
#[no_mangle]
unsafe extern "C" fn ns_alloc_device(ns: *mut nandsim) -> int __init {
    ...
    err_close_filp:
    filp_close(cfile, core::ptr::null_mut());
    return err;
    }
    ...
    ns.pages[i].byte = core::ptr::null_mut();
    }
    ns.nand_pages_slab = kmem_cache_create("nandsim",
    ns.geom.pgszoob, 0, 0, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn ns_free_device(ns: *mut nandsim) {
    ...
    kfree(ns.file_buf);
    vfree(ns.pages_written);
    filp_close(ns.cfile, core::ptr::null_mut());
    return;
    }
    if (ns.pages) {
    for (i = 0; i < ns.geom.pgnum; i++) {
...
//
#[no_mangle]
unsafe extern "C" fn ns_init(mtd: *mut mtd_info) -> int __init {
...
// Fill the partition_info structure
    ...
    let mut part_sz: u64 = (uint64_t)parts[i] * ns.geom.secsz;
...
//
#[no_mangle]
unsafe extern "C" fn ns_free(ns: *mut nandsim) {
...
#[no_mangle]
unsafe extern "C" fn ns_parse_badblocks(ns: *mut nandsim, mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_parse_weakblocks() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_erase_error(erase_block_no: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_parse_weakpages() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_write_error(page_no: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_parse_gravepages() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_read_error(page_no: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_setup_wear_reporting(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ns_update_wear(erase_block_no: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn ns_check_command(cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ns_get_state_by_command(command: unsigned) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ns_accept_addr_byte(ns: *mut nandsim, bt: u_char) {
    static inline void ns_accept_addr_byte(struct nandsim *ns, u_char bt)
    {
    let mut byte: c_uint = (uint)bt;
...
//
#[no_mangle]
pub unsafe extern "C" fn ns_switch_to_ready_state(ns: *mut nandsim, status: u_char) {
...
//
#[no_mangle]
unsafe extern "C" fn ns_find_operation(ns: *mut nandsim, flag: u32) -> c_int {
    static int ns_find_operation(struct nandsim *ns, uint32_t flag)
    {
    let mut opsfound: c_int = 0;
    int i, j, idx = 0;
...
#[no_mangle]
unsafe extern "C" fn ns_put_pages(ns: *mut nandsim) {
...
#[no_mangle]
unsafe extern "C" fn ns_do_read_error(ns: *mut nandsim, num: c_int) -> c_int {
    static int ns_do_read_error(struct nandsim *ns, int num)
    {
    let mut page_no: c_uint = ns.regs.row;
...
#[no_mangle]
unsafe extern "C" fn ns_do_bit_flips(ns: *mut nandsim, num: c_int) {
    static void ns_do_bit_flips(struct nandsim *ns, int num)
    {
    if (bitflips && get_random_u16() < (1 << 6)) {
    let mut flips: c_int = 1;
    if (bitflips > 1)
    flips = get_random_u32_inclusive(1, bitflips);
    while (flips--) {
    let mut pos: c_int = get_random_u32_below(num * 8);
...
//
#[no_mangle]
unsafe extern "C" fn ns_read_page(ns: *mut nandsim, num: c_int) {
    ...
    if (mypage.byte == core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn ns_erase_sector(ns: *mut nandsim) {
...
//
#[no_mangle]
unsafe extern "C" fn ns_prog_page(ns: *mut nandsim, num: c_int) -> c_int {
    ...
    if (all) {
    let mut pos: loff_t = (loff_t)ns.regs.row * ns.geom.pgszoob;
...
//
#[no_mangle]
unsafe extern "C" fn ns_do_state_action(ns: *mut nandsim, action: u32) -> c_int {
    static int ns_do_state_action(struct nandsim *ns, uint32_t action)
    {
    int num;
    let mut busdiv: c_int = ns.busw == 8 ? 1 : 2;
...
// Column shouldn't be very large
    ...
    NS_LOG("read page %d\n", ns.regs.row);
#[no_mangle]
pub unsafe extern "C" fn if(ns->geom.pgsz: ns->regs.off <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ns_switch_state(ns: *mut nandsim) {
...
//
    let mut status: u_char = NS_STATUS_OK(ns);
...
#[no_mangle]
unsafe extern "C" fn ns_nand_read_byte(chip: *mut nand_chip) -> u_char {
    static u_char ns_nand_read_byte(struct nand_chip *chip)
    {
    struct nandsim *ns = nand_get_controller_data(chip);
    let mut outb: u_char = 0x00;
...
#[no_mangle]
unsafe extern "C" fn ns_nand_write_byte(chip: *mut nand_chip, byte: u_char) {
...
#[no_mangle]
unsafe extern "C" fn ns_nand_read_buf(chip: *mut nand_chip, buf: *mut u_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ns_attach_chip(chip: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ns_init_module() -> int __init {
...
//
    ...
    ns.geom.idbytes = 8;
#[no_mangle]
pub unsafe extern "C" fn if(0xFF: id_bytes[4] != 0xFF || id_bytes[5] !=) -> else {
    else if (id_bytes[4] != 0xFF || id_bytes[5] != 0xFF)
    ns.geom.idbytes = 6;
#[no_mangle]
pub unsafe extern "C" fn if(0xFF: id_bytes[2] != 0xFF || id_bytes[3] !=) -> else {
    ...
    if (overridesize) {
    let mut new_size: u64 = (uint64_t)nsmtd.erasesize << overridesize;
...
//
#[no_mangle]
unsafe extern "C" fn ns_cleanup_module() -> void __exit {
