...
//! Source: drivers/mtd/nand/raw/nand_legacy.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn nand_read_byte(chip: *mut nand_chip) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn nand_read_byte16(chip: *mut nand_chip) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn nand_select_chip(chip: *mut nand_chip, chipnr: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_write_byte(chip: *mut nand_chip, byte: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_write_byte16(chip: *mut nand_chip, byte: u8) {
    static void nand_write_byte16(struct nand_chip *chip, uint8_t byte)
    {
    let mut word: u16 = byte;
//
...
//
#[no_mangle]
unsafe extern "C" fn nand_write_buf(chip: *mut nand_chip, buf: *const u8, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_read_buf(chip: *mut nand_chip, buf: *mut u8, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_read_buf16(chip: *mut nand_chip, buf: *mut u8, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn panic_nand_wait_ready(chip: *mut nand_chip, timeo: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_wait_ready(chip: *mut nand_chip) {
    void nand_wait_ready(struct nand_chip *chip)
    {
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut timeo: c_ulong = 400;
...
//
#[no_mangle]
unsafe extern "C" fn nand_wait_status_ready(chip: *mut nand_chip, timeo: c_ulong) {
...
//
    ...
    {
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut ctrl: c_int = NAND_CTRL_CLE | NAND_CTRL_CHANGE;
...
#[no_mangle]
unsafe extern "C" fn nand_ccs_delay(chip: *mut nand_chip) {
...
// Command latch cycle
    ...
    if (column != -1 || page_addr != -1) {
    let mut ctrl: c_int = NAND_CTRL_CHANGE | NAND_NCE | NAND_ALE;
// Serially input address
    if (column != -1) {
// Adjust columns for 16 bit buswidth
    if (chip.options & NAND_BUSWIDTH_16 &&
...
//
#[no_mangle]
unsafe extern "C" fn nand_wait(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nand_legacy_set_defaults(chip: *mut nand_chip) {
    void nand_legacy_set_defaults(struct nand_chip *chip)
    {
    let mut busw: c_uint = chip.options & NAND_BUSWIDTH_16;
...
// check, if a user supplied wait function given
    if (chip.legacy.waitfunc == core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn nand_legacy_adjust_cmdfunc(chip: *mut nand_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn nand_legacy_check_hooks(chip: *mut nand_chip) -> c_int {
