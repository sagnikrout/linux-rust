...
//! Source: drivers/mtd/nand/raw/fsl_elbc_nand.c
#![no_std]
...
pub const MAX_BANKS: c_int = 8;
pub const ERR_BYTE: c_uint = 0xFF /* Value returned for read bytes when read failed */;

// mtd information per set
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_elbc_mtd {
    pub chip: nand_chip,
    pub ctrl: *mut fsl_lbc_ctrl,
    pub dev: *mut device,
    pub /: *mut *mut int bank; / Chip select bank number,
    pub /: *mut *mut *mut u8 __iomem vbase; / Chip select base virtual address,
    pub /: *mut *mut int page_size; / NAND page size (0=512, 1=2048),
    pub /: *mut *mut unsigned int fmr; / FCM Flash Mode Register value,
}

// Freescale eLBC FCM controller information
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_elbc_fcm_ctrl {
    pub controller: nand_controller,
    pub chips: [*mut fsl_elbc_mtd; MAX_BANKS],
    pub /: *mut *mut *mut u8 __iomem addr; / Address of assigned FCM buffer,
    ...
    pub /: *mut *mut unsigned int status; / status read from LTESR after last op,
    pub /: *mut *mut unsigned int mdr; / UPM/FCM Data Register value,
    pub /: *mut *mut unsigned int use_mdr; / Non zero if the MDR is to be set,
...
//
#[no_mangle]
unsafe extern "C" fn fsl_elbc_run_command(mtd: *mut mtd_info) -> c_int {
...
// store mdr value in case it was needed
    ...
    let mut lteccr: u32 = in_be32(&lbc.lteccr);
//
...
#[no_mangle]
unsafe extern "C" fn fsl_elbc_do_read(chip: *mut nand_chip, oob: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fsl_elbc_select_chip(chip: *mut nand_chip, cs: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_elbc_write_buf(chip: *mut nand_chip, buf: *const u8, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_elbc_read_byte(chip: *mut nand_chip) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_elbc_read_buf(chip: *mut nand_chip, buf: *mut u8, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_elbc_wait(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_elbc_chip_init(priv: *mut fsl_elbc_mtd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_elbc_attach_chip(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_elbc_chip_remove(priv: *mut fsl_elbc_mtd) -> c_int {
    ...
    if (priv.vbase)
    iounmap(priv.vbase);
    elbc_fcm_ctrl.chips[priv.bank] = core::ptr::null_mut();
    kfree(priv);
    return 0;
    }
    static DEFINE_MUTEX(fsl_elbc_nand_mutex);
#[no_mangle]
unsafe extern "C" fn fsl_elbc_nand_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_elbc_nand_remove(pdev: *mut platform_device) {
    ...
    fsl_lbc_ctrl_dev.nand = core::ptr::null_mut();
    kfree(elbc_fcm_ctrl);
    }
    mutex_unlock(&fsl_elbc_nand_mutex);
    }
