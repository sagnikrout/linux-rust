...
//! Source: drivers/mtd/nand/raw/au1550nd.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn au_read_buf16(this: *mut nand_chip, buf: *mut c_void, len: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn find_nand_cs(nand_base: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1550nd_waitrdy(this: *mut nand_chip, timeout_ms: c_uint) -> c_int {
    static int au1550nd_waitrdy(struct nand_chip *this, unsigned int timeout_ms)
    {
    let mut timeout_jiffies: c_ulong = jiffies;
...
#[no_mangle]
unsafe extern "C" fn au1550nd_attach_chip(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1550nd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1550nd_remove(pdev: *mut platform_device) {
