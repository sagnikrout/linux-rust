...
//! Source: drivers/mtd/nand/raw/lpc32xx_slc.c
#![no_std]
...
// during runtime.
//
pub const LPC32XX_DMA_DATA_SIZE: c_int = 4096;

// Number of bytes used for ECC stored in NAND per 256 bytes
pub const LPC32XX_SLC_DEV_ECC_BYTES: c_int = 3;
//
...
//
pub const LPC32XX_DEF_BUS_RATE: c_int = 133250000;
// Milliseconds for DMA FIFO timeout (unlikely anyway)
pub const LPC32XX_DMA_TIMEOUT: c_int = 100;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc32xx_nand_cfg_slc {
    pub wdr_clks: u32,
    pub wwidth: u32,
    pub whold: u32,
    pub wsetup: u32,
...
pub struct lpc32xx_nand_host {
    ...
    pub pdata: *mut lpc32xx_slc_platform_data,
    pub clk: *mut clk,
    pub wp_gpio: *mut gpio_desc,
    pub io_base: *mut void __iomem,
    pub ncfg: *mut lpc32xx_nand_cfg_slc,
    pub comp: completion,
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_device_ready(chip: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_ecc_enable(chip: *mut nand_chip, mode: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_read_byte(chip: *mut nand_chip) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_read_buf(chip: *mut nand_chip, buf: *mut u_char, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_read_oob_syndrome(chip: *mut nand_chip, page: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_write_oob_syndrome(chip: *mut nand_chip, page: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_slc_ecc_copy(spare: *mut u8, ecc: *const u32, count: c_int) {
    static void lpc32xx_slc_ecc_copy(uint8_t *spare, const uint32_t *ecc, int count)
    {
    int i;
    for (i = 0; i < (count * 3); i += 3) {
    let mut ce: u32 = ecc[i / 3];
    ce = ~(ce << 2) & 0xFFFFFF;
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_dma_setup(host: *mut lpc32xx_nand_host) -> c_int {
...
// Start with WP disabled, if available
    host.wp_gpio = devm_gpiod_get_optional(&pdev.dev, core::ptr::null_mut(), GPIOD_OUT_LOW);
...
//
    ...
    GFP_KERNEL);
    if (host.data_buf == core::ptr::null_mut()) {
    res = -ENOMEM;
    goto enable_wp;
    }
