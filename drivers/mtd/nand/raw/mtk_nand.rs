...
//! Source: drivers/mtd/nand/raw/mtk_nand.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_nfc_caps {
    pub spare_size: *const u8,
    pub num_spare_size: u8,
    pub pageformat_spare_shift: u8,
    pub nfi_clk_div: u8,
    pub max_sector: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_nfc_bad_mark_ctl {
    pub raw): *mut *mut *mut *mut void (bm_swap)(struct mtd_info , u8 buf, int,
    pub sec: u32,
    pub pos: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_nfc_nand_chip {
    pub node: list_head,
    pub nand: nand_chip,
    pub bad_mark: mtk_nfc_bad_mark_ctl,
    pub fdm: mtk_nfc_fdm,
    pub spare_per_sector: u32,
    pub nsels: c_int,
...
pub struct mtk_nfc {
    ...
    pub ecc_cfg: mtk_ecc_config,
    pub clk: mtk_nfc_clk,
    pub ecc: *mut mtk_ecc,
    pub dev: *mut device,
    pub caps: *const mtk_nfc_caps,
...
#[no_mangle]
pub unsafe extern "C" fn if(mtk_nand->bad_mark.sec: i ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_data_len(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nfi_writel(nfc: *mut mtk_nfc, val: u32, reg: u32) {
    static inline void nfi_writel(struct mtk_nfc *nfc, u32 val, u32 reg)
    {
    writel(val, nfc.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn nfi_writew(nfc: *mut mtk_nfc, val: u16, reg: u32) {
    static inline void nfi_writew(struct mtk_nfc *nfc, u16 val, u32 reg)
    {
    writew(val, nfc.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn nfi_writeb(nfc: *mut mtk_nfc, val: u8, reg: u32) {
    static inline void nfi_writeb(struct mtk_nfc *nfc, u8 val, u32 reg)
    {
    writeb(val, nfc.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn nfi_readl(nfc: *mut mtk_nfc, reg: u32) -> u32 {
    static inline u32 nfi_readl(struct mtk_nfc *nfc, u32 reg)
    {
    return readl_relaxed(nfc.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn nfi_readw(nfc: *mut mtk_nfc, reg: u32) -> u16 {
    static inline u16 nfi_readw(struct mtk_nfc *nfc, u32 reg)
    {
    return readw_relaxed(nfc.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn nfi_readb(nfc: *mut mtk_nfc, reg: u32) -> u8 {
    static inline u8 nfi_readb(struct mtk_nfc *nfc, u32 reg)
    {
    return readb_relaxed(nfc.regs + reg);
    }
#[no_mangle]
unsafe extern "C" fn mtk_nfc_hw_reset(nfc: *mut mtk_nfc) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_send_command(nfc: *mut mtk_nfc, command: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_send_address(nfc: *mut mtk_nfc, addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_hw_runtime_config(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_nfc_wait_ioready(nfc: *mut mtk_nfc) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_nfc_read_byte(chip: *mut nand_chip) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_read_buf(chip: *mut nand_chip, buf: *mut u8, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_write_byte(chip: *mut nand_chip, byte: u8) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_write_buf(chip: *mut nand_chip, buf: *const u8, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_select_target(nand: *mut nand_chip, cs: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_sector_encode(chip: *mut nand_chip, data: *mut u8) -> c_int {
    static int mtk_nfc_sector_encode(struct nand_chip *chip, u8 *data)
    {
    struct mtk_nfc *nfc = nand_get_controller_data(chip);
    struct mtk_nfc_nand_chip *mtk_nand = to_mtk_nand(chip);
    let mut size: c_int = chip.ecc.size + mtk_nand.fdm.reg_size;
    nfc.ecc_cfg.mode = ECC_DMA_MODE;
    nfc.ecc_cfg.op = ECC_ENCODE;
    return mtk_ecc_encode(nfc.ecc, &nfc.ecc_cfg, data, size);
    }
#[no_mangle]
unsafe extern "C" fn mtk_nfc_no_bad_mark_swap(a: *mut mtd_info, b: *mut u8, c: c_int) {
    static void mtk_nfc_no_bad_mark_swap(struct mtd_info *a, u8 *b, int c)
    {
// nop
    }
#[no_mangle]
unsafe extern "C" fn mtk_nfc_bad_mark_swap(mtd: *mut mtd_info, buf: *mut u8, raw: c_int) {
    static void mtk_nfc_bad_mark_swap(struct mtd_info *mtd, u8 *buf, int raw)
    {
    struct nand_chip *chip = mtd_to_nand(mtd);
    struct mtk_nfc_nand_chip *nand = to_mtk_nand(chip);
    let mut bad_pos: u32 = nand.bad_mark.pos;
    if (raw)
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_format_page(mtd: *mut mtd_info, buf: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn mtk_nfc_write_fdm(chip: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_write_oob_std(chip: *mut nand_chip, page: c_int) -> c_int {
    static int mtk_nfc_write_oob_std(struct nand_chip *chip, int page)
    {
    return mtk_nfc_write_page_raw(chip, core::ptr::null_mut(), 1, page);
    }
    ...
    let mut reg_size: u32 = mtk_nand.fdm.reg_size;
    int rc, i;
    ...
    struct mtk_nfc *nfc = nand_get_controller_data(chip);
    struct mtk_nfc_nand_chip *mtk_nand = to_mtk_nand(chip);
    let mut spare: u32 = mtk_nand.spare_per_sector;
    u32 column, sectors, start, end, reg;
    dma_addr_t addr;
    let mut bitflips: c_int = 0;
    size_t len;
    u8 *buf;
    int rc;
    mtk_nfc_select_target(chip, chip.cur_cs);
    ...
    nand_read_page_op(chip, page, column, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_read_oob_std(chip: *mut nand_chip, page: c_int) -> c_int {
    static int mtk_nfc_read_oob_std(struct nand_chip *chip, int page)
    {
    return mtk_nfc_read_page_raw(chip, core::ptr::null_mut(), 1, page);
    }
#[no_mangle]
pub unsafe extern "C" fn mtk_nfc_hw_init(nfc: *mut mtk_nfc) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_irq(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_set_fdm(fdm: *mut mtk_nfc_fdm, mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_set_spare_per_sector(sps: *mut u32, mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_ecc_init(dev: *mut device, mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_attach_chip(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_nand_chips_cleanup(nfc: *mut mtk_nfc) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_nand_chips_init(dev: *mut device, nfc: *mut mtk_nfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !nfc->ecc) -> else {
    else if (!nfc.ecc)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_nfc_resume(dev: *mut device) -> c_int {
