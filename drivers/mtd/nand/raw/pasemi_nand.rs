...
//! Source: drivers/mtd/nand/raw/pasemi_nand.c
#![no_std]
...
pub const LBICTRL_LPCCTL_NR: c_uint = 0x00004000;
pub const CLE_PIN_CTL: c_int = 15;
pub const ALE_PIN_CTL: c_int = 14;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pasemi_ddata {
    pub chip: nand_chip,
    pub lpcctl: c_uint,
...
#[no_mangle]
unsafe extern "C" fn pasemi_read_buf(chip: *mut nand_chip, buf: *mut u_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pasemi_device_ready(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pasemi_attach_chip(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pasemi_nand_probe(ofdev: *mut platform_device) -> c_int {
...
// Link the private data with the MTD structure
    ...
    pdev = pci_get_device(PCI_VENDOR_ID_PASEMI, 0xa008, core::ptr::null_mut());
    if (!pdev) {
    err = -ENODEV;
    goto out_ior;
    }
...
// Scan to find existence of the device
    ...
    if (err)
    goto out_lpc;
    if (mtd_device_register(pasemi_nand_mtd, core::ptr::null_mut(), 0)) {
...
#[no_mangle]
unsafe extern "C" fn pasemi_nand_remove(ofdev: *mut platform_device) {
