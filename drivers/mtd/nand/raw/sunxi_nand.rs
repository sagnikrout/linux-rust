...
//! Source: drivers/mtd/nand/raw/sunxi_nand.c
#![no_std]
...
pub const NFC_REG_CTL: c_uint = 0x0000;
pub const NFC_REG_ST: c_uint = 0x0004;
pub const NFC_REG_INT: c_uint = 0x0008;
pub const NFC_REG_TIMING_CTL: c_uint = 0x000C;
pub const NFC_REG_TIMING_CFG: c_uint = 0x0010;
pub const NFC_REG_ADDR_LOW: c_uint = 0x0014;
pub const NFC_REG_ADDR_HIGH: c_uint = 0x0018;
pub const NFC_REG_SECTOR_NUM: c_uint = 0x001C;
pub const NFC_REG_CNT: c_uint = 0x0020;
pub const NFC_REG_CMD: c_uint = 0x0024;
pub const NFC_REG_RCMD_SET: c_uint = 0x0028;
pub const NFC_REG_WCMD_SET: c_uint = 0x002C;
pub const NFC_REG_A10_IO_DATA: c_uint = 0x0030;
pub const NFC_REG_A23_IO_DATA: c_uint = 0x0300;
pub const NFC_REG_ECC_CTL: c_uint = 0x0034;
pub const NFC_REG_ECC_ST: c_uint = 0x0038;
pub const NFC_REG_H6_PAT_FOUND: c_uint = 0x003C;
pub const NFC_REG_A10_ECC_ERR_CNT: c_uint = 0x0040;
pub const NFC_REG_H6_ECC_ERR_CNT: c_uint = 0x0050;

pub const NFC_REG_H6_RDATA_CTL: c_uint = 0x0044;
pub const NFC_REG_H6_RDATA_0: c_uint = 0x0048;
pub const NFC_REG_H6_RDATA_1: c_uint = 0x004C;
pub const NFC_REG_A10_USER_DATA: c_uint = 0x0050;
pub const NFC_REG_H6_USER_DATA: c_uint = 0x0080;

pub const NFC_REG_H6_USER_DATA_LEN: c_uint = 0x0070;
// A USER_DATA_LEN register can hold the length of 8 USER_DATA registers
pub const NFC_REG_USER_DATA_LEN_CAPACITY: c_int = 8;

    (nfc.caps.reg_user_data_len + \
    ((step) / NFC_REG_USER_DATA_LEN_CAPACITY) * 4)

pub const NFC_REG_A10_SPARE_AREA: c_uint = 0x00A0;

pub const NFC_REG_A10_PAT_ID: c_uint = 0x00A4;
pub const NFC_REG_MDMA_ADDR: c_uint = 0x00C0;
pub const NFC_REG_MDMA_CNT: c_uint = 0x00C4;
pub const NFC_REG_H6_EFNAND_STATUS: c_uint = 0x0110;
pub const NFC_REG_H6_SPARE_AREA: c_uint = 0x0114;
pub const NFC_REG_H6_PAT_ID: c_uint = 0x0118;
pub const NFC_REG_H6_DDR2_SPEC_CTL: c_uint = 0x011C;
pub const NFC_REG_H6_NDMA_MODE_CTL: c_uint = 0x0120;
pub const NFC_REG_H6_MDMA_DLBA_REG: c_uint = 0x0200;
pub const NFC_REG_H6_MDMA_STA: c_uint = 0x0204;
pub const NFC_REG_H6_MDMA_INT_MAS: c_uint = 0x0208;
pub const NFC_REG_H6_MDMA_DESC_ADDR: c_uint = 0x020C;
pub const NFC_REG_H6_MDMA_BUF_ADDR: c_uint = 0x0210;
pub const NFC_REG_H6_MDMA_CNT: c_uint = 0x0214;

pub const NFC_RAM0_BASE: c_uint = 0x0400;
pub const NFC_RAM1_BASE: c_uint = 0x0800;
...
pub const NFC_DEFAULT_TIMEOUT_MS: c_int = 1000;
pub const NFC_MAX_CS: c_int = 7;
//
...
//
pub const USER_DATA_SZ: c_int = 4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_nand_chip_sel {
    pub cs: u8,
    pub rb: i8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_nand_hw_ecc {
    pub ecc_ctl: u32,
}

pub const SUNXI_NFC_TIMING_STEPS: c_int = 4;
// Delay arrays contain internal NDFC clock cycles for field values 0 to 3.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_nfc_timings {
// Internal clock cycles used by T1-T4, T7 and T11.
    pub setup_cycles: u8,
    pub tWB: [i32; SUNXI_NFC_TIMING_STEPS],
    pub tADL: [i32; SUNXI_NFC_TIMING_STEPS],
    pub tWHR: [i32; SUNXI_NFC_TIMING_STEPS],
    pub tRHW: [i32; SUNXI_NFC_TIMING_STEPS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_nand_chip {
    pub node: list_head,
    pub nand: nand_chip,
    pub ecc: sunxi_nand_hw_ecc,
    pub clk_rate: c_ulong,
    pub timing_cfg: u32,
    pub timing_ctl: u32,
    pub user_data_bytes: *mut u8,
    pub nsels: c_int,
    pub __counted_by(nsels): sunxi_nand_chip_sel sels[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_nfc_mdma_desc {
    pub config: __le32,
    pub size: __le32,
    pub buf: __le32,
    pub next: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_nfc_caps {
    pub has_mdma: bool,
    pub has_mdma_desc: bool,
    pub has_ecc_block_512: bool,
    pub has_ecc_clk: bool,
    pub has_mbus_clk: bool,
    pub legacy_max_strength: bool,
    pub reg_io_data: c_uint,
    pub reg_ecc_err_cnt: c_uint,
    pub reg_user_data: c_uint,
    pub reg_user_data_len: c_uint,
    pub reg_spare_area: c_uint,
    pub reg_pat_id: c_uint,
    pub reg_pat_found: c_uint,
    pub random_en_mask: c_uint,
    pub random_dir_mask: c_uint,
    pub ecc_mode_mask: c_uint,
    pub ecc_err_mask: c_uint,
    pub pat_found_mask: c_uint,
    pub dma_maxburst: c_uint,
    pub ecc_strengths: *const u8,
    pub nstrengths: c_uint,
    pub user_data_len_tab: *const u8,
    pub nuser_data_tab: c_uint,
    pub max_ecc_steps: c_uint,
    pub sram_size: c_int,
    pub timings: *const sunxi_nfc_timings,
}
...
pub struct sunxi_nfc {
    ...
    pub use_mdma: bool,
    pub mdma_desc: *mut sunxi_nfc_mdma_desc,
    pub mdma_desc_dma: dma_addr_t,
    pub caps: *const sunxi_nfc_caps,
}
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t sunxi_nfc_interrupt(int irq, void *dev_id)
    {
    struct sunxi_nfc *nfc = dev_id;
    let mut st: u32 = readl(nfc.regs + NFC_REG_ST);
    let mut ien: u32 = readl(nfc.regs + NFC_REG_INT);
    if (!(ien & st))
    return IRQ_NONE;
    if ((ien & st) == ien)
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_wait_cmd_fifo_empty(nfc: *mut sunxi_nfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_rst(nfc: *mut sunxi_nfc) -> c_int {
    ...
    dma_addr_t buf_dma;
    dma_cookie_t dmat;
    let mut len: c_int = chunksize * nchunks;
    let mut data_blocks: u32 = nchunks;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_dma_op_abort(nfc: *mut sunxi_nfc) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_select_chip(nand: *mut nand_chip, cs: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_read_buf(nand: *mut nand_chip, buf: *mut u8, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_randomizer_step(state: u16, count: c_int) -> u16 {
...
//
    ...
    let mut mod: c_int = mtd_div_by_ws(mtd.erasesize, mtd);
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_randomizer_enable(nand: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_randomizer_disable(nand: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_randomize_bbm(nand: *mut nand_chip, page: c_int, bbm: *mut u8) {
    static void sunxi_nfc_randomize_bbm(struct nand_chip *nand, int page, u8 *bbm)
    {
    let mut state: u16 = sunxi_nfc_randomizer_state(nand, page, true);
    bbm[0] ^= state;
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_hw_ecc_enable(nand: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_hw_ecc_disable(nand: *mut nand_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn sunxi_nfc_user_data_to_buf(user_data: u32, buf: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn sunxi_nfc_buf_to_user_data(buf: *const u8) -> u32 {
    static inline u32 sunxi_nfc_buf_to_user_data(const u8 *buf)
    {
    return buf[0] | (buf[1] << 8) | (buf[2] << 16) | (buf[3] << 24);
    }
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_user_data_sz(sunxi_nand: *mut sunxi_nand_chip, step: c_int) -> u8 {
...
//
    let mut user_data_off: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_reset_user_data_len(nfc: *mut sunxi_nfc) {
    static void sunxi_nfc_reset_user_data_len(struct sunxi_nfc *nfc)
    {
    let mut loop_step: c_int = NFC_REG_USER_DATA_LEN_CAPACITY;
...
// not all SoCs have this register
    ...
    struct sunxi_nfc *nfc = to_sunxi_nfc(nand.controller);
    struct sunxi_nand_chip *sunxi_nand = to_sunxi_nand(nand);
    let mut user_data_sz: c_uint = sunxi_nfc_user_data_sz(sunxi_nand, step);
    u8 *user_data = core::ptr::null_mut();
...
// erased = true;
    ...
    u32 pattern_found;
    let mut bbm: bool = !step;
    bool erased;
    int ret;
// From the controller point of view, we are at step 0
    let mut nfc_step: c_int = 0;
    if (*cur_off != data_off)
    nand_change_read_column_op(nand, data_off, core::ptr::null_mut(), 0, false);
    sunxi_nfc_randomizer_read_buf(nand, core::ptr::null_mut(), ecc.size, false, page);
    if (data_off + ecc.size != oob_off)
    nand_change_read_column_op(nand, oob_off, core::ptr::null_mut(), 0, false);
    ret = sunxi_nfc_wait_cmd_fifo_empty(nfc);
    if (ret)
    return ret;
...
// cur_off = oob_off + ecc->bytes + user_data_sz;
    ...
    ret = sunxi_nfc_hw_ecc_correct(nand, data, oob_required ? oob : core::ptr::null_mut(),
...
//
    ...
    core::ptr::null_mut(), 0, ecc.strength);
    if (ret >= 0)
    raw_mode = 1;
    } else {
    memcpy_fromio(data, nfc.regs + NFC_RAM0_BASE, ecc.size);
    if (oob_required) {
    nand_change_read_column_op(nand, oob_off, core::ptr::null_mut(), 0,
    false);
...
//
    ...
    {
    let mut ecc_off: c_int = step * ecc.bytes;
    int i;
    for (i = 0; i < step; i++)
...
//
    ...
    struct mtd_info *mtd = nand_to_mtd(nand);
    struct nand_ecc_ctrl *ecc = &nand.ecc;
    let mut offset: c_int = sunxi_get_oob_offset(sunxi_nand, ecc, ecc.steps);
    let mut len: c_int = mtd.oobsize - offset;
    if (len <= 0)
    return;
...
// cur_off = mtd->oobsize + mtd->writesize;
    ...
    int nchunks)
    {
    let mut randomized: bool = nand.options & NAND_NEED_SCRAMBLING;
    struct sunxi_nand_chip *sunxi_nand = to_sunxi_nand(nand);
    struct sunxi_nfc *nfc = to_sunxi_nfc(nand.controller);
    struct mtd_info *mtd = nand_to_mtd(nand);
    struct nand_ecc_ctrl *ecc = &nand.ecc;
    ...
    pattern_found = field_get(NFC_ECC_PAT_FOUND_MSK(nfc), pattern_found);
    for (i = 0; i < nchunks; i++) {
    let mut data_off: c_int = i * ecc.size;
    let mut user_data_sz: c_uint = sunxi_nfc_user_data_sz(sunxi_nand, i);
    let mut oob_off: c_int = sunxi_get_oob_offset(sunxi_nand, ecc, i);
    u8 *data = buf + data_off;
    u8 *oob = nand.oob_poi + oob_off;
    bool erased;
    ret = sunxi_nfc_hw_ecc_correct(nand, randomized ? data : core::ptr::null_mut(),
    oob_required ? oob : core::ptr::null_mut(),
...
// From the controller point of view, we are at step 0
    let mut nfc_step: c_int = 0;
    if (data_off != *cur_off)
    nand_change_write_column_op(nand, data_off, core::ptr::null_mut(), 0, false);
    sunxi_nfc_randomizer_write_buf(nand, data, ecc.size, false, page);
    if (data_off + ecc.size != oob_off)
    nand_change_write_column_op(nand, oob_off, core::ptr::null_mut(), 0, false);
    ret = sunxi_nfc_wait_cmd_fifo_empty(nfc);
    if (ret)
    return ret;
    sunxi_nfc_randomizer_config(nand, page, false);
...
// cur_off = mtd->oobsize + mtd->writesize;
    ...
    let mut max_bitflips: c_uint = 0;
    int ret, i, cur_off = 0;
    let mut raw_mode: bool = false;
    sunxi_nfc_select_chip(nand, nand.cur_cs);
    nand_read_page_op(nand, page, 0, core::ptr::null_mut(), 0);
    sunxi_nfc_hw_ecc_enable(nand);
    sunxi_nfc_reset_user_data_len(nfc);
...
// Fallback to PIO mode
    ...
    u8 *buf, int page)
    {
    let mut nchunks: c_int = DIV_ROUND_UP(data_offs + readlen, nand.ecc.size);
    int ret;
    sunxi_nfc_select_chip(nand, nand.cur_cs);
    nand_read_page_op(nand, page, 0, core::ptr::null_mut(), 0);
...
// Fallback to PIO mode
    ...
    int ret, i, cur_off = 0;
    sunxi_nfc_select_chip(nand, nand.cur_cs);
    nand_prog_page_begin_op(nand, page, 0, core::ptr::null_mut(), 0);
    sunxi_nfc_hw_ecc_enable(nand);
    sunxi_nfc_reset_user_data_len(nfc);
    for (i = 0; i < ecc.steps; i++) {
    let mut data_off: c_int = i * ecc.size;
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_hw_ecc_read_oob(nand: *mut nand_chip, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_hw_ecc_write_oob(nand: *mut nand_chip, page: c_int) -> c_int {
...
// Send command to program the OOB data
    ...
    u32 clk_period)
    {
    let mut clk_cycles: u32 = DIV_ROUND_UP(duration, clk_period);
    int i;
...
//
    ...
    struct nand_ecc_ctrl *ecc = &nand.ecc;
    struct sunxi_nand_chip *sunxi_nand = to_sunxi_nand(nand);
    let mut user_data_sz: c_uint = sunxi_nfc_user_data_sz(sunxi_nand, section);
//
...
#[no_mangle]
unsafe extern "C" fn sunxi_nand_detach_chip(nand: *mut nand_chip) {
    static void sunxi_nand_detach_chip(struct nand_chip *nand)
    {
    struct sunxi_nand_chip *sunxi_nand = to_sunxi_nand(nand);
    struct sunxi_nfc *nfc = to_sunxi_nfc(nand.controller);
    devm_kfree(nfc.dev, sunxi_nand.user_data_bytes);
    sunxi_nand.user_data_bytes = core::ptr::null_mut();
    }
    ...
    let mut remaining_bytes: c_int = oobsize - (ecc_bytes * nsectors);
    int i, step;
    ...
    let mut total_user_data_sz: c_int = 0;
    int nsectors;
    int ecc_mode;
    int i;
    if (nanddev.ecc.user_conf.flags & NAND_ECC_MAXIMIZE_STRENGTH) {
    let mut bytes: c_int = mtd.oobsize;
    ecc.size = 1024;
...
#[no_mangle]
unsafe extern "C" fn sunxi_nand_attach_chip(nand: *mut nand_chip) -> c_int {
    ...
    {
    struct sunxi_nfc *nfc = to_sunxi_nfc(nand.controller);
    let mut cmd: u32 = 0, extcmd = 0, cnt = 0, addrs[2] = { };
    unsigned int i, j, remaining, start;
    void *inbuf = core::ptr::null_mut();
    int ret;
    ...
    let mut addr: u32 = instr.ctx.addr.addrs[j + start];
...
#[no_mangle]
unsafe extern "C" fn sunxi_nand_chips_cleanup(nfc: *mut sunxi_nfc) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nand_chips_init(dev: *mut device, nfc: *mut sunxi_nfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_dma_init(nfc: *mut sunxi_nfc, r: *mut resource) -> c_int {
...
// Ignore errors to fall back to PIO mode
    ...
    nfc.dmac = core::ptr::null_mut();
    } else {
    let mut dmac_cfg: dma_slave_config = { };
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_nfc_remove(pdev: *mut platform_device) {
