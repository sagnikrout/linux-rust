...
//! Source: drivers/mtd/nand/raw/atmel/nand-controller.c
#![no_std]
...
pub const ATMEL_HSMC_NFC_CFG: c_uint = 0x0;

pub const ATMEL_HSMC_NFC_CTRL: c_uint = 0x4;

pub const ATMEL_HSMC_NFC_SR: c_uint = 0x8;
pub const ATMEL_HSMC_NFC_IER: c_uint = 0xc;
pub const ATMEL_HSMC_NFC_IDR: c_uint = 0x10;
pub const ATMEL_HSMC_NFC_IMR: c_uint = 0x14;

    ATMEL_HSMC_NFC_SR_UNDEF | \
    ATMEL_HSMC_NFC_SR_AWB | \
    ATMEL_HSMC_NFC_SR_NFCASE)

pub const ATMEL_HSMC_NFC_ADDR: c_uint = 0x18;
pub const ATMEL_HSMC_NFC_BANK: c_uint = 0x1c;
pub const ATMEL_NFC_MAX_RB_ID: c_int = 7;
pub const ATMEL_NFC_SRAM_SIZE: c_uint = 0x2400;

pub const ATMEL_NFC_MAX_ADDR_CYCLES: c_int = 5;

pub const DEFAULT_TIMEOUT_MS: c_int = 1000;
pub const MIN_DMA_LEN: c_int = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_nand_rb {
    pub type: enum atmel_nand_rb_type,
    union {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_nand_cs {
    pub id: c_int,
    pub rb: atmel_nand_rb,
    pub csgpio: *mut gpio_desc,
    struct {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_nand {
    pub node: list_head,
    pub dev: *mut device,
    pub base: nand_chip,
    pub activecs: *mut atmel_nand_cs,
    pub pmecc: *mut atmel_pmecc_user,
    pub cdgpio: *mut gpio_desc,
    pub numcs: c_int,
    pub __counted_by(numcs): atmel_nand_cs cs[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_nfc_op {
    pub cs: u8,
    pub ncmds: u8,
    pub cmds: [u8; 2],
    pub naddrs: u8,
    pub addrs: [u8; 5],
    pub data: enum atmel_nfc_data_xfer,
    pub wait: u32,
    pub errors: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_nand_controller_ops {
    int (*probe)(struct platform_device *pdev,
    pub caps): *const atmel_nand_controller_caps,
    pub nc): *mut *mut int (remove)(struct atmel_nand_controller,
    void (*nand_init)(struct atmel_nand_controller *nc,
    pub nand): *mut atmel_nand,
    pub chip): *mut *mut int (ecc_init)(struct nand_chip,
    ...
    pub check_only): *const *const nand_operation op, bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_nand_controller_caps {
    pub has_dma: bool,
    pub legacy_of_bindings: bool,
    pub ale_offs: u32,
    pub cle_offs: u32,
    pub ebi_csa_regmap_name: *const c_char,
    pub ops: *const atmel_nand_controller_ops,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_nand_controller {
    pub base: nand_controller,
    pub caps: *const atmel_nand_controller_caps,
    pub dev: *mut device,
    pub smc: *mut regmap,
    pub dmac: *mut dma_chan,
    pub pmecc: *mut atmel_pmecc,
    pub chips: list_head,
    pub mck: *mut clk,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_smc_nand_ebi_csa_cfg {
    pub offs: u32,
    pub nfd0_on_d16: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_smc_nand_controller {
    pub base: atmel_nand_controller,
    pub ebi_csa_regmap: *mut regmap,
    pub ebi_csa: *mut atmel_smc_nand_ebi_csa_cfg,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_hsmc_nand_controller {
    pub base: atmel_nand_controller,
    struct {
    ...
    pub dma: dma_addr_t,
    pub sram: },
    pub hsmc_layout: *const atmel_hsmc_reg_layout,
    pub io: *mut regmap,
    pub op: atmel_nfc_op,
...
#[no_mangle]
unsafe extern "C" fn atmel_nfc_op_done(op: *mut atmel_nfc_op, status: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn atmel_nfc_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_dma_transfer_finished(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn atmel_nfc_exec_op(nc: *mut atmel_hsmc_nand_controller, poll: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_waitrdy(nand: *mut atmel_nand, timeout_ms: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_nfc_set_op_addr(chip: *mut nand_chip, page: c_int, column: c_int) {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_pmecc_enable(chip: *mut nand_chip, op: c_int, raw: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_pmecc_disable(chip: *mut nand_chip, raw: bool) {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_pmecc_generate_eccbytes(chip: *mut nand_chip, raw: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_pmecc_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: chip->ecc.strength) -> else {
    else if (chip.ecc.strength)
    req.ecc.strength = chip.ecc.strength;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: requirements->strength) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: requirements->step_size) -> else {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_ecc_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_hsmc_nand_ecc_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATMEL_SMC_MODE_TDF_MIN: ncycles <) -> else {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_controller_remove_nand(nand: *mut atmel_nand) -> c_int {
...
//
    nand.cs[0].id = 3;
// R/B GPIO.
    gpio = devm_gpiod_get_index_optional(dev, core::ptr::null_mut(), 0,  GPIOD_IN);
    if (IS_ERR(gpio)) {
...
// CS GPIO.
    gpio = devm_gpiod_get_index_optional(dev, core::ptr::null_mut(), 1, GPIOD_OUT_HIGH);
    if (IS_ERR(gpio)) {
...
// Card detect GPIO.
    gpio = devm_gpiod_get_index_optional(nc.dev, core::ptr::null_mut(), 2, GPIOD_IN);
    if (IS_ERR(gpio)) {
    dev_err(dev,
    "Failed to get detect gpio (err = %ld)\n",
    PTR_ERR(gpio));
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_controller_add_nands(nc: *mut atmel_nand_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_controller_cleanup(nc: *mut atmel_nand_controller) {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_attach_chip(chip: *mut nand_chip) -> c_int {
...
//
    ...
    nc.dmac = dma_request_channel(mask, core::ptr::null_mut(), core::ptr::null_mut());
    if (nc.dmac)
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_controller_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_controller_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn atmel_nand_controller_resume(dev: *mut device) -> __maybe_unused int {
    ...
    static SIMPLE_DEV_PM_OPS(atmel_nand_controller_pm_ops, core::ptr::null_mut(),
