...
//! Source: drivers/mtd/nand/raw/sh_flctl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn empty_fifo(flctl: *mut sh_flctl) {
...
#[no_mangle]
unsafe extern "C" fn start_translation(flctl: *mut sh_flctl) {
    static void start_translation(struct sh_flctl *flctl)
    {
    writeb(TRSTRT, FLTRCR(flctl));
    }
#[no_mangle]
unsafe extern "C" fn timeout_error(flctl: *mut sh_flctl, str: *const c_char) {
    static void timeout_error(struct sh_flctl *flctl, const char *str)
    {
    dev_err(&flctl.pdev.dev, "Timeout occurred in %s\n", str);
    }
#[no_mangle]
unsafe extern "C" fn wait_completion(flctl: *mut sh_flctl) {
    static void wait_completion(struct sh_flctl *flctl)
    {
    let mut timeout: u32 = LOOP_TIMEOUT_MAX;
    while (timeout--) {
...
#[no_mangle]
unsafe extern "C" fn flctl_dma_complete(param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn flctl_release_dma(flctl: *mut sh_flctl) {
    static void flctl_release_dma(struct sh_flctl *flctl)
    {
    if (flctl.chan_fifo0_rx) {
    dma_release_channel(flctl.chan_fifo0_rx);
    flctl.chan_fifo0_rx = core::ptr::null_mut();
    }
    if (flctl.chan_fifo0_tx) {
    dma_release_channel(flctl.chan_fifo0_tx);
    flctl.chan_fifo0_tx = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn flctl_setup_dma(flctl: *mut sh_flctl) {
...
#[no_mangle]
unsafe extern "C" fn wait_rfifo_ready(flctl: *mut sh_flctl) {
...
#[no_mangle]
unsafe extern "C" fn wait_wfifo_ready(flctl: *mut sh_flctl) {
...
// check FIFO
    ...
    int i;
    let mut state: c_int = FL_SUCCESS;
    uint32_t data, size;
//
...
#[no_mangle]
unsafe extern "C" fn wait_wecfifo_ready(flctl: *mut sh_flctl) {
...
#[no_mangle]
unsafe extern "C" fn read_datareg(flctl: *mut sh_flctl, offset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn read_fiforeg(flctl: *mut sh_flctl, rlen: c_int, offset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_cmd_regs(mtd: *mut mtd_info, cmd: u32, flcmcdr_val: u32) {
    static void set_cmd_regs(struct mtd_info *mtd, uint32_t cmd, uint32_t flcmcdr_val)
    {
    struct sh_flctl *flctl = mtd_to_flctl(mtd);
    let mut flcmncr_val: u32 = flctl.flcmncr_base & ~SEL_16BIT;
...
#[no_mangle]
unsafe extern "C" fn execmd_read_page_sector(mtd: *mut mtd_info, page_addr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn execmd_read_oob(mtd: *mut mtd_info, page_addr: c_int) {
    static void execmd_read_oob(struct mtd_info *mtd, int page_addr)
    {
    struct sh_flctl *flctl = mtd_to_flctl(mtd);
    let mut page_sectors: c_int = flctl.page_size ? 4 : 1;
    int i;
    set_cmd_regs(mtd, NAND_CMD_READ0,
    (NAND_CMD_READSTART << 8) | NAND_CMD_READ0);
    empty_fifo(flctl);
...
#[no_mangle]
unsafe extern "C" fn execmd_write_page_sector(mtd: *mut mtd_info) {
    static void execmd_write_page_sector(struct mtd_info *mtd)
    {
    struct sh_flctl *flctl = mtd_to_flctl(mtd);
    let mut page_addr: c_int = flctl.seqin_page_addr;
    int sector, page_sectors;
    page_sectors = flctl.page_size ? 4 : 1;
...
#[no_mangle]
unsafe extern "C" fn execmd_write_oob(mtd: *mut mtd_info) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !flctl->seqin_column) -> else {
...
#[no_mangle]
unsafe extern "C" fn flctl_select_chip(chip: *mut nand_chip, chipnr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn flctl_write_buf(chip: *mut nand_chip, buf: *const u8, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn flctl_read_byte(chip: *mut nand_chip) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn flctl_read_buf(chip: *mut nand_chip, buf: *mut u8, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn flctl_chip_attach_chip(chip: *mut nand_chip) -> c_int {
    static int flctl_chip_attach_chip(struct nand_chip *chip)
    {
    let mut targetsize: u64 = nanddev_target_size(&chip.base);
    struct mtd_info *mtd = nand_to_mtd(chip);
    struct sh_flctl *flctl = mtd_to_flctl(mtd);
//
...
#[no_mangle]
unsafe extern "C" fn flctl_handle_flste(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn flctl_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flctl_remove(pdev: *mut platform_device) {
