...
//! Source: drivers/mtd/nand/raw/denali_dt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct denali_dt {
    pub controller: denali_controller,
    pub /: *mut *mut *mut clk clk; / core clock,
    pub /: *mut *mut *mut clk clk_x; / bus interface clock,
    pub /: *mut *mut *mut clk clk_ecc; / ECC circuit clock,
    pub /: *mut *mut *mut reset_control rst; / core reset,
    pub /: *mut *mut *mut reset_control rst_reg; / register reset,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct denali_dt_data {
    pub revision: c_uint,
    pub caps: c_uint,
    pub oob_skip_bytes: c_uint,
...
#[no_mangle]
unsafe extern "C" fn denali_dt_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn denali_dt_remove(pdev: *mut platform_device) {
