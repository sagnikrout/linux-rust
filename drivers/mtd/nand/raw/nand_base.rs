...
//! Source: drivers/mtd/nand/raw/nand_base.c
#![no_std]
...
//
    ...
    {
    let mut lastpage: c_int = (mtd.erasesize / mtd.writesize) - 1;
    let mut dist: c_int = 3;
    if (page == lastpage)
    dist = 2;
    if (!page || (page & 1)) {
    info.group = 0;
    ...
    {
    let mut lastpair: c_int = ((mtd.erasesize / mtd.writesize) - 1) / 2;
    let mut page: c_int = info.pair * 2;
    let mut dist: c_int = 3;
    ...
    page--;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: info->pair) -> else {
    else if (info.pair)
    page += dist - 1;
...
#[no_mangle]
unsafe extern "C" fn check_offs_len(chip: *mut nand_chip, ofs: loff_t, len: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_select_target(chip: *mut nand_chip, cs: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_deselect_target(chip: *mut nand_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_release_device(chip: *mut nand_chip) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_bbm_get_next_page(chip: *mut nand_chip, page: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_block_bad(chip: *mut nand_chip, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_region_is_secured(chip: *mut nand_chip, offset: loff_t, size: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nand_isbad_bbm(chip: *mut nand_chip, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_get_device(chip: *mut nand_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_check_wp(chip: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_default_block_markbad(chip: *mut nand_chip, ofs: loff_t) -> c_int {
    static int nand_default_block_markbad(struct nand_chip *chip, loff_t ofs)
    {
    struct mtd_info *mtd = nand_to_mtd(chip);
    struct mtd_oob_ops ops;
    uint8_t buf[2] = { 0, 0 };
    let mut ret: c_int = 0, res, page_offset;
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_markbad_bbm(chip: *mut nand_chip, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_block_markbad_lowlevel(chip: *mut nand_chip, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_block_isreserved(mtd: *mut mtd_info, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_block_checkbad(chip: *mut nand_chip, ofs: loff_t, allowbbt: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_soft_waitrdy(chip: *mut nand_chip, timeout_ms: c_ulong) -> c_int {
...
// Wait tWB before polling the STATUS reg.
    ...
    ret = nand_status_op(chip, core::ptr::null_mut());
    if (ret)
    return ret;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn panic_nand_wait(chip: *mut nand_chip, timeo: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn nand_supports_get_features(chip: *mut nand_chip, addr: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nand_supports_set_features(chip: *mut nand_chip, addr: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nand_reset_interface(chip: *mut nand_chip, chipnr: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_setup_interface(chip: *mut nand_chip, chipnr: c_int) -> c_int {
...
//
    ...
    {
    const struct nand_controller_ops *ops = chip.controller.ops;
    let mut best_mode: c_int = 0, mode, ret = -EOPNOTSUPP;
...
// Try the fastest timings: NV-DDR
    ret = nand_choose_best_nvddr_timings(chip, iface, core::ptr::null_mut());
    if (!ret)
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn nand_choose_interface_config(chip: *mut nand_chip) -> c_int {
...
//
    ...
    {
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut ident_stage: bool = !mtd.writesize;
...
//
    ...
    let mut op: nand_operation = NAND_OPERATION(chip.cur_cs, instrs);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rawnand_last_page_of_block(ppb: c_uint, block: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rawnand_cap_cont_reads(chip: *mut nand_chip) {
...
// Prevent sequential cache reads across block boundaries
    ...
    let mut start_op: nand_operation = NAND_OPERATION(chip.cur_cs, start_instrs);
    let mut cont_op: nand_operation = NAND_OPERATION(chip.cur_cs, cont_instrs);
    int ret;
    if (!len) {
    start_op.ninstrs--;
    cont_op.ninstrs--;
...
#[no_mangle]
unsafe extern "C" fn rawnand_cont_read_ongoing(chip: *mut nand_chip, page: c_uint) -> bool {
...
//
    ...
    instrs);
    let mut naddrs: c_int = nand_fill_column_cycles(chip, addrs, offset_in_page);
    if (naddrs < 0)
    return naddrs;
    addrs[naddrs++] = page;
    addrs[naddrs++] = page >> 8;
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_prog_page_end_op(chip: *mut nand_chip) -> c_int {
...
//
    ...
    {
    unsigned int i;
    u8 *id = buf, *ddrbuf = core::ptr::null_mut();
    if (len && !buf)
    return -EINVAL;
    if (nand_has_exec_op(chip)) {
    const struct nand_interface_config *conf =
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_status_op(chip: *mut nand_chip, status: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_exit_status_op(chip: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_erase_op(chip: *mut nand_chip, eraseblock: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_reset_op(chip: *mut nand_chip) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nand_op_parser_ctx {
    pub instrs: *const nand_op_instr,
    pub ninstrs: c_uint,
    pub subop: nand_subop,
}
...
//
    ...
    {
    let mut instr_offset: c_uint = ctx.subop.first_instr_start_off;
...
#[no_mangle]
unsafe extern "C" fn nand_op_parser_trace(ctx: *const nand_op_parser_ctx) {
...
// NOP
    ...
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(b->subop.ninstrs: a->subop.ninstrs >) -> else {
    else if (a.subop.ninstrs > b.subop.ninstrs)
    return 1;
    if (a.subop.last_instr_end_off < b.subop.last_instr_end_off)
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(b->subop.last_instr_end_off: a->subop.last_instr_end_off >) -> else {
...
//
    ...
    let mut test_ctx: nand_op_parser_ctx = ctx;
...
#[no_mangle]
unsafe extern "C" fn nand_instr_is_data(instr: *const nand_op_instr) -> bool {
...
//
    ...
    unsigned int instr_idx)
    {
    let mut start_off: c_int = 0, end_off;
    if (WARN_ON(!nand_subop_instr_is_valid(subop, instr_idx) ||
    !nand_instr_is_data(&subop.instrs[instr_idx])))
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_reset(chip: *mut nand_chip, chipnr: c_int) -> c_int {
...
//
    ...
    {
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut size: c_uint = mtd.writesize;
    u8 *read_buf = buf;
    int ret;
    if (oob_required) {
    size += mtd.oobsize;
...
//
    ...
    let mut busw: c_int = (chip.options & NAND_BUSWIDTH_16) ? 2 : 1;
    int index, section = 0;
    let mut max_bitflips: c_uint = 0;
    let mut oobregion: mtd_oob_region = { };
...
// Move read cursor to start of page
    ret = nand_change_read_column_op(chip, 0, core::ptr::null_mut(), 0, false);
    if (ret)
    return ret;
    ret = mtd_ooblayout_get_eccbytes(mtd, ecc_code, chip.oob_poi, 0,
    chip.ecc.total);
    ...
    if (ret)
    return ret;
    stat = chip.ecc.correct(chip, p, &ecc_code[i], core::ptr::null_mut());
    if (stat == -EBADMSG &&
    (chip.ecc.options & NAND_ECC_GENERIC_ERASED_CHECK)) {
// check for empty pages with bitflips
    stat = nand_check_erased_ecc_chunk(p, eccsize,
    &ecc_code[i],
    eccbytes, core::ptr::null_mut(), 0,
    chip.ecc.strength);
    }
    if (stat < 0) {
    mtd.ecc_stats.failed++;
...
//
    ...
    let mut eccbytes: c_int = chip.ecc.bytes;
    let mut eccsteps: c_int = chip.ecc.steps;
    let mut eccpadbytes: c_int = eccbytes + chip.ecc.prepad + chip.ecc.postpad;
    uint8_t *p = buf;
    uint8_t *oob = chip.oob_poi;
    let mut max_bitflips: c_uint = 0;
    ret = nand_read_page_op(chip, page, 0, core::ptr::null_mut(), 0);
    ...
    if (ret)
    return ret;
    stat = chip.ecc.correct(chip, p, oob, core::ptr::null_mut());
    oob += eccbytes;
    if (chip.ecc.postpad) {
    ret = nand_read_data_op(chip, oob, chip.ecc.postpad,
    false, false);
...
#[no_mangle]
unsafe extern "C" fn rawnand_cont_read_skip_first_page(chip: *mut nand_chip, page: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_setup_read_retry(chip: *mut nand_chip, retry_mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nand_wait_readrdy(chip: *mut nand_chip) {
...
//
    ...
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut ret: c_int = 0;
    let mut readlen: u32 = ops.len;
    let mut oobreadlen: u32 = ops.ooblen;
    let mut max_oobsize: u32 = mtd_oobavail(mtd, ops);
    uint8_t *bufpoi, *oob, *buf;
    int use_bounce_buf;
    let mut max_bitflips: c_uint = 0;
    let mut retry_mode: c_int = 0;
    let mut ecc_fail: bool = false;
// Check if the region is secured
    ...
    while (1) {
    let mut ecc_stats: mtd_ecc_stats = mtd.ecc_stats;
    bytes = min(mtd.writesize - col, readlen);
    aligned = (bytes == mtd.writesize);
    if (!aligned)
    use_bounce_buf = 1;
#[no_mangle]
pub unsafe extern "C" fn if(NAND_USES_DMA: chip->options &) -> else {
...
// Invalidate page cache
    ...
    if (unlikely(oob)) {
    let mut toread: c_int = min(oobreadlen, max_oobsize);
    if (toread) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_read_oob_std(chip: *mut nand_chip, page: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_read_oob_syndrome(chip: *mut nand_chip, page: c_int) -> c_int {
    static int nand_read_oob_syndrome(struct nand_chip *chip, int page)
    {
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut length: c_int = mtd.oobsize;
    let mut chunk: c_int = chip.ecc.bytes + chip.ecc.prepad + chip.ecc.postpad;
    let mut eccsize: c_int = chip.ecc.size;
    uint8_t *bufpoi = chip.oob_poi;
    int i, toread, sndrnd = 0, pos, ret;
    ret = nand_read_page_op(chip, page, chip.ecc.size, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    ...
    ret = nand_read_page_op(chip, page, pos, core::ptr::null_mut(),
    0);
    if (ret)
    return ret;
    } else
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_write_oob_std(chip: *mut nand_chip, page: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_write_oob_syndrome(chip: *mut nand_chip, page: c_int) -> c_int {
    static int nand_write_oob_syndrome(struct nand_chip *chip, int page)
    {
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut chunk: c_int = chip.ecc.bytes + chip.ecc.prepad + chip.ecc.postpad;
    let mut eccsize: c_int = chip.ecc.size, length = mtd.oobsize;
...
//
    ...
    pos = eccsize;
    ret = nand_prog_page_begin_op(chip, page, pos, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    for (i = 0; i < steps; i++) {
    if (sndcmd) {
    if (mtd.writesize <= 512) {
    let mut fill: u32 = 0xFFFFFFFF;
    len = eccsize;
    while (len > 0) {
    let mut num: c_int = min_t(int, len, 4);
...
//
    ...
    let mut readlen: c_int = ops.ooblen;
    int len;
...
//
    ...
    uint8_t *oob = chip.oob_poi;
    int steps, size, ret;
    ret = nand_prog_page_begin_op(chip, page, 0, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    for (steps = chip.ecc.steps; steps > 0; steps--) {
...
//
    ...
    uint8_t *ecc_calc = chip.ecc.calc_buf;
    let mut ecc_size: c_int = chip.ecc.size;
    let mut ecc_bytes: c_int = chip.ecc.bytes;
    let mut ecc_steps: c_int = chip.ecc.steps;
    let mut start_step: u32 = offset / ecc_size;
    let mut end_step: u32 = (offset + data_len - 1) / ecc_size;
    let mut oob_bytes: c_int = mtd.oobsize / ecc_steps;
    int step, ret;
    ret = nand_prog_page_begin_op(chip, page, 0, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
...
//
    ...
    page);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: subpage) -> else {
    else if (subpage)
...
//
    ...
    let mut writelen: u32 = ops.len;
    let mut oobwritelen: u32 = ops.ooblen;
    let mut oobmaxlen: u32 = mtd_oobavail(mtd, ops);
    uint8_t *oob = ops.oobbuf;
    uint8_t *buf = ops.datbuf;
    int ret;
    let mut oob_required: c_int = oob ? 1 : 0;
    ops.retlen = 0;
    if (!writelen)
    return 0;
...
// Don't allow multipage oob writes with offset
    ...
    while (1) {
    let mut bytes: c_int = mtd.writesize;
    uint8_t *wbuf = buf;
    int use_bounce_buf;
    let mut part_pagewr: c_int = (column || writelen < mtd.writesize);
    if (part_pagewr)
    use_bounce_buf = 1;
#[no_mangle]
pub unsafe extern "C" fn if(NAND_USES_DMA: chip->options &) -> else {
...
//
    ...
    if (unlikely(oob)) {
    let mut len: usize = min(oobwritelen, oobmaxlen);
...
//
    ...
    {
    struct nand_chip *chip = mtd_to_nand(mtd);
    let mut chipnr: c_int = (int)(to >> chip.chip_shift);
    struct mtd_oob_ops ops;
    int ret;
    nand_select_target(chip, chipnr);
...
//
#[no_mangle]
unsafe extern "C" fn nand_erase(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
...
// Loop through the pages
    len = instr.len;
    while (len) {
    let mut ofs: loff_t = (loff_t)page << chip.page_shift;
...
//
#[no_mangle]
unsafe extern "C" fn nand_sync(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_block_isbad(mtd: *mut mtd_info, offs: loff_t) -> c_int {
    static int nand_block_isbad(struct mtd_info *mtd, loff_t offs)
    {
    struct nand_chip *chip = mtd_to_nand(mtd);
    let mut chipnr: c_int = (int)(offs >> chip.chip_shift);
    int ret;
// Select the NAND device
    nand_get_device(chip);
    nand_select_target(chip, chipnr);
...
//
#[no_mangle]
unsafe extern "C" fn nand_block_markbad(mtd: *mut mtd_info, ofs: loff_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_suspend(mtd: *mut mtd_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_resume(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_shutdown(mtd: *mut mtd_info) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_lock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_unlock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nand_set_defaults(chip: *mut nand_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn sanitize_string(s: *mut u8, len: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_id_has_period(id_data: *mut u8, arrlen: c_int, period: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_id_len(id_data: *mut u8, arrlen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nand_get_bits_per_cell(cellinfo: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_decode_ext_id(chip: *mut nand_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_decode_id(chip: *mut nand_chip, type: *mut nand_flash_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_decode_bbm_options(chip: *mut nand_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn is_full_id_nand(type: *mut nand_flash_dev) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nand_manufacturer_detect(chip: *mut nand_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_manufacturer_init(chip: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nand_manufacturer_cleanup(chip: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn rawnand_check_data_only_read_support(chip: *mut nand_chip) {
    static void rawnand_check_data_only_read_support(struct nand_chip *chip)
    {
// Use an arbitrary size for the check
    if (!nand_read_data_op(chip, core::ptr::null_mut(), SZ_512, true, true))
    chip.controller.supported_op.data_only_read = 1;
    }
#[no_mangle]
unsafe extern "C" fn rawnand_early_check_supported_ops(chip: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn rawnand_check_cont_read_support(chip: *mut nand_chip) {
    ...
    return;
    if (!nand_lp_exec_cont_read_page_op(chip, 0, 0, core::ptr::null_mut(),
    mtd.writesize, true))
    chip.controller.supported_op.cont_read = 1;
    }
#[no_mangle]
unsafe extern "C" fn rawnand_late_check_supported_ops(chip: *mut nand_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_detect(chip: *mut nand_chip, type: *mut nand_flash_dev) -> c_int {
...
//
    chip.options &= ~NAND_BUSWIDTH_16;
    for (; type.name != core::ptr::null_mut(); type++) {
...
#[no_mangle]
unsafe extern "C" fn of_get_rawnand_ecc_algo_legacy(np: *mut device_node) -> enum nand_ecc_algo {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcasecmp(pm, _arg: "soft_bch")) -> else {
...
#[no_mangle]
unsafe extern "C" fn of_get_nand_ecc_legacy_user_config(chip: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn of_get_nand_bus_width(chip: *mut nand_chip) -> c_int {
...
pub unsafe extern "C" fn if(_arg: ret) -> else {
    ...
    chip.options |= NAND_BUSWIDTH_16;
#[no_mangle]
pub unsafe extern "C" fn if(8: val !=) -> else {
    else if (val != 8)
    return -EINVAL;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn of_get_nand_secure_regions(chip: *mut nand_chip) -> c_int {
...
// Only proceed if the "secure-regions" property is present in DT
    prop = of_find_property(dn, "secure-regions", core::ptr::null_mut());
    if (!prop)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn rawnand_dt_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nand_scan_ident_cleanup(chip: *mut nand_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn rawnand_sw_hamming_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rawnand_sw_hamming_cleanup(chip: *mut nand_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn rawnand_sw_bch_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rawnand_sw_bch_cleanup(chip: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn nand_set_ecc_on_host_ops(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nand_set_ecc_soft_ops(chip: *mut nand_chip) -> c_int {
...
//
    ...
    let mut preset_step: c_int = chip.ecc.size;
    let mut preset_strength: c_int = chip.ecc.strength;
...
//
    ...
    struct mtd_info *mtd = nand_to_mtd(chip);
    const struct nand_ecc_step_info *stepinfo;
    let mut req_step: c_int = requirements.step_size;
    let mut req_strength: c_int = requirements.strength;
    int req_corr, step_size, strength, nsteps, ecc_bytes, ecc_bytes_total;
    let mut best_step: c_int = 0, best_strength = 0, best_ecc_bytes = 0;
    let mut best_ecc_bytes_total: c_int = INT_MAX;
    int i, j;
...
//
    ...
    let mut best_corr: c_int = 0;
    let mut best_step: c_int = 0;
    let mut best_strength: c_int = 0, best_ecc_bytes = 0;
    int i, j;
    for (i = 0; i < caps.nstepinfos; i++) {
    stepinfo = &caps.stepinfos[i];
    step_size = stepinfo.stepsize;
...
#[no_mangle]
unsafe extern "C" fn rawnand_erase(nand: *mut nand_device, pos: *const nand_pos) -> c_int {
    static int rawnand_erase(struct nand_device *nand, const struct nand_pos *pos)
    {
    struct nand_chip *chip = container_of(nand, struct nand_chip,
    base);
    let mut eb: c_uint = nanddev_pos_to_row(nand, pos);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rawnand_isbad(nand: *mut nand_device, pos: *const nand_pos) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn nand_scan_tail(chip: *mut nand_chip) -> c_int {
...
// Fill in remaining MTD driver data
    ...
    mtd._point = core::ptr::null_mut();
    mtd._unpoint = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn nand_attach(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nand_detach(chip: *mut nand_chip) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_cleanup(chip: *mut nand_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn if(NAND_ECC_ALGO_BCH: chip->ecc.algo ==) -> else {
