...
//! Source: drivers/mtd/nand/raw/mxc_nand.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxc_nand_devtype_data {
    pub ): *mut *mut void (preset)(struct mtd_info,
    pub chip): *mut *mut int (read_page)(struct nand_chip,
    pub int): *mut *mut *mut void (send_cmd)(struct mxc_nand_host , uint16_t,,
    pub int): *mut *mut *mut void (send_addr)(struct mxc_nand_host , uint16_t,,
    pub int): *mut *mut *mut void (send_page)(struct mtd_info , unsigned,
    pub ): *mut *mut void (send_read_id)(struct mxc_nand_host,
    pub ): *mut *mut uint16_t (get_dev_status)(struct mxc_nand_host,
    pub ): *mut *mut int (check_int)(struct mxc_nand_host,
    pub int): *mut *mut *mut void (irq_control)(struct mxc_nand_host ,,
    pub ): *mut *mut u32 (get_ecc_status)(struct nand_chip,
    ...
    pub enable): *mut *mut *mut void (enable_hwecc)(struct nand_chip chip, bool,
//
// On i.MX21 the CONFIG2:INT bit cannot be read if interrupts are masked
// (CONFIG1:INT_MSK is set). To handle this the driver uses
// enable_irq/disable_irq_nosync instead of CONFIG1:INT_MSK
//
    pub irqpending_quirk: c_int,
    pub needs_ip: c_int,
    pub regs_offset: usize,
    pub spare0_offset: usize,
    pub axi_offset: usize,
    pub spare_len: c_int,
    pub eccbytes: c_int,
    pub eccsize: c_int,
    pub ppb_shift: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxc_nand_host {
    pub nand: nand_chip,
    pub dev: *mut device,
    pub spare0: *mut void __iomem,
    pub main_area0: *mut void __iomem,
    pub base: *mut void __iomem,
    pub regs: *mut void __iomem,
    pub regs_axi: *mut void __iomem,
    pub regs_ip: *mut void __iomem,
    pub status_request: c_int,
    pub clk: *mut clk,
    pub clk_act: c_int,
    pub irq: c_int,
    pub eccsize: c_int,
    pub used_oobsize: c_int,
    pub active_cs: c_int,
    pub ecc_stats_v1: c_uint,
    pub op_completion: completion,
    pub data_buf: *mut c_void,
    pub devtype_data: *const mxc_nand_devtype_data,
}

    static const char * const part_probes[] = {
    "cmdlinepart", "RedBoot", "ofpart", core::ptr::null_mut() };
#[no_mangle]
unsafe extern "C" fn memcpy32_fromio(trg: *mut c_void, src: *const void __iomem, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn memcpy16_fromio(trg: *mut c_void, src: *const void __iomem, size: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn memcpy32_toio(trg: *mut void __iomem, src: *const c_void, size: c_int) {
...
#[no_mangle]
unsafe extern "C" fn memcpy16_toio(trg: *mut void __iomem, src: *const c_void, size: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn copy_spare(mtd: *mut mtd_info, bfrom: bool, buf: *mut c_void) {
    static void copy_spare(struct mtd_info *mtd, bool bfrom, void *buf)
    {
    struct nand_chip *this = mtd_to_nand(mtd);
    struct mxc_nand_host *host = nand_get_controller_data(this);
    u16 i, oob_chunk_size;
    let mut num_chunks: u16 = mtd.writesize / 512;
    u8 *d = buf;
    u8 __iomem *s = host.spare0;
    let mut sparebuf_size: u16 = host.devtype_data.spare_len;
...
#[no_mangle]
unsafe extern "C" fn check_int_v3(host: *mut mxc_nand_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_int_v1_v2(host: *mut mxc_nand_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irq_control_v1_v2(host: *mut mxc_nand_host, activate: c_int) {
...
#[no_mangle]
unsafe extern "C" fn irq_control_v3(host: *mut mxc_nand_host, activate: c_int) {
...
#[no_mangle]
unsafe extern "C" fn irq_control(host: *mut mxc_nand_host, activate: c_int) {
...
#[no_mangle]
unsafe extern "C" fn get_ecc_status_v1(chip: *mut nand_chip) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_ecc_status_v2_v3(chip: *mut nand_chip, ecc_stat: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_ecc_status_v2(chip: *mut nand_chip) -> u32 {
    static u32 get_ecc_status_v2(struct nand_chip *chip)
    {
    struct mxc_nand_host *host = nand_get_controller_data(chip);
    let mut ecc_stat: u32 = readl(NFC_V1_V2_ECC_STATUS_RESULT);
    return get_ecc_status_v2_v3(chip, ecc_stat);
    }
#[no_mangle]
unsafe extern "C" fn get_ecc_status_v3(chip: *mut nand_chip) -> u32 {
    static u32 get_ecc_status_v3(struct nand_chip *chip)
    {
    struct mxc_nand_host *host = nand_get_controller_data(chip);
    let mut ecc_stat: u32 = readl(NFC_V3_ECC_STATUS_RESULT);
    return get_ecc_status_v2_v3(chip, ecc_stat);
    }
#[no_mangle]
unsafe extern "C" fn mxc_nfc_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn wait_op_done(host: *mut mxc_nand_host, useirq: c_int) -> c_int {
...
//
    ...
    let mut max_retries: c_int = 8000;
    int done;
    do {
    udelay(1);
...
#[no_mangle]
unsafe extern "C" fn send_cmd_v3(host: *mut mxc_nand_host, cmd: u16, useirq: c_int) {
...
#[no_mangle]
unsafe extern "C" fn send_cmd_v1_v2(host: *mut mxc_nand_host, cmd: u16, useirq: c_int) {
...
#[no_mangle]
unsafe extern "C" fn send_addr_v3(host: *mut mxc_nand_host, addr: u16, islast: c_int) {
...
// a NAND command.
#[no_mangle]
unsafe extern "C" fn send_addr_v1_v2(host: *mut mxc_nand_host, addr: u16, islast: c_int) {
...
#[no_mangle]
unsafe extern "C" fn send_page_v3(mtd: *mut mtd_info, ops: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn send_page_v2(mtd: *mut mtd_info, ops: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn send_page_v1(mtd: *mut mtd_info, ops: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn send_read_id_v3(host: *mut mxc_nand_host) {
...
#[no_mangle]
unsafe extern "C" fn send_read_id_v1_v2(host: *mut mxc_nand_host) {
...
#[no_mangle]
unsafe extern "C" fn get_dev_status_v3(host: *mut mxc_nand_host) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn get_dev_status_v1_v2(host: *mut mxc_nand_host) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mxc_nand_enable_hwecc_v1_v2(chip: *mut nand_chip, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxc_nand_enable_hwecc_v3(chip: *mut nand_chip, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxc_nand_read_page_v1(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_nand_read_page_v2_v3(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_nand_read_oob(chip: *mut nand_chip, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_nand_write_oob(chip: *mut nand_chip, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_nand_select_chip_v1_v3(nand_chip: *mut nand_chip, chip: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mxc_nand_select_chip_v2(nand_chip: *mut nand_chip, chip: c_int) {
...
pub const MXC_V1_ECCBYTES: c_int = 5;
    ...
    {
    struct nand_chip *nand_chip = mtd_to_nand(mtd);
    let mut stepsize: c_int = nand_chip.ecc.bytes == 9 ? 16 : 26;
    if (section >= nand_chip.ecc.steps)
    return -ERANGE;
...
//
#[no_mangle]
unsafe extern "C" fn get_eccsize(mtd: *mut mtd_info) -> c_int {
    static int get_eccsize(struct mtd_info *mtd)
    {
    let mut oobbytes_per_512: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn preset_v1(mtd: *mut mtd_info) {
    static void preset_v1(struct mtd_info *mtd)
    {
    struct nand_chip *nand_chip = mtd_to_nand(mtd);
    struct mxc_nand_host *host = nand_get_controller_data(nand_chip);
    let mut config1: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn preset_v2(mtd: *mut mtd_info) {
    ...
    config1 |= NFC_V1_V2_CONFIG1_INT_MSK;
    if (mtd.writesize) {
    let mut pages_per_block: u16 = mtd.erasesize / mtd.writesize;
    if (nand_chip.ecc.engine_type == NAND_ECC_ENGINE_TYPE_ON_HOST)
    config1 |= NFC_V1_V2_CONFIG1_ECC_EN;
...
#[no_mangle]
unsafe extern "C" fn preset_v3(mtd: *mut mtd_info) {
...
#[no_mangle]
pub unsafe extern "C" fn is_imx21_nfc(host: *mut mxc_nand_host) -> c_int {
    static inline int is_imx21_nfc(struct mxc_nand_host *host)
    {
    return host.devtype_data == &imx21_nand_devtype_data;
    }
#[no_mangle]
pub unsafe extern "C" fn is_imx27_nfc(host: *mut mxc_nand_host) -> c_int {
    static inline int is_imx27_nfc(struct mxc_nand_host *host)
    {
    return host.devtype_data == &imx27_nand_devtype_data;
    }
#[no_mangle]
pub unsafe extern "C" fn is_imx25_nfc(host: *mut mxc_nand_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxcnd_attach_chip(chip: *mut nand_chip) -> c_int {
...
// Call preset again, with correct writesize chip time
    ...
    chip.ecc.bytes = 18;
#[no_mangle]
pub unsafe extern "C" fn if(4: host->eccsize ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn memff16_toio(buf: *mut c_void, n: c_int) {
...
#[no_mangle]
unsafe extern "C" fn copy_page_to_sram(mtd: *mut mtd_info, buf: *const c_void, buf_len: c_int) {
    static void copy_page_to_sram(struct mtd_info *mtd, const void *buf, int buf_len)
    {
    struct nand_chip *this = mtd_to_nand(mtd);
    struct mxc_nand_host *host = nand_get_controller_data(this);
    let mut no_subpages: c_uint = mtd.writesize / 512;
...
//
    for (i = 0; i < no_subpages; i++) {
    let mut now: c_int = min(buf_len, 512);
    if (now)
...
#[no_mangle]
unsafe extern "C" fn copy_page_from_sram(mtd: *mut mtd_info) {
...
// mtd->writesize is not set during ident scanning
    ...
    struct mtd_info *mtd = nand_to_mtd(chip);
    int i, j, buf_len;
    void *buf_read = core::ptr::null_mut();
    const void *buf_write = core::ptr::null_mut();
    const struct nand_op_instr *instr;
    let mut readid: bool = false;
    let mut statusreq: bool = false;
...
// NFC handles R/B internally, nothing to do here
    ...
    let mut islast: bool = j == instr.ctx.addr.naddrs - 1;
...
#[no_mangle]
unsafe extern "C" fn mxcnd_probe(pdev: *mut platform_device) -> c_int {
...
// 50 us command delay time
    ...
    of_get_next_child_with_prefix(pdev.dev.of_node, core::ptr::null_mut(), "nand");
    if (np)
...
#[no_mangle]
unsafe extern "C" fn mxcnd_remove(pdev: *mut platform_device) {
