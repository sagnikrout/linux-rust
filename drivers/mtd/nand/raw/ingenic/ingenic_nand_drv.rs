...
//! Source: drivers/mtd/nand/raw/ingenic/ingenic_nand_drv.c
#![no_std]
...
pub struct jz_soc_info {
    ...
    pub addr_offset: c_ulong,
    pub cmd_offset: c_ulong,
    pub oob_layout: *const mtd_ooblayout_ops,
    pub oob_first: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_nand_cs {
    pub bank: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_nfc {
    pub dev: *mut device,
    pub ecc: *mut ingenic_ecc,
    pub soc_info: *const jz_soc_info,
    pub controller: nand_controller,
    pub num_banks: c_uint,
    pub chips: list_head,
    pub __counted_by(num_banks): ingenic_nand_cs cs[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_nand {
    pub chip: nand_chip,
    pub chip_list: list_head,
    pub busy_gpio: *mut gpio_desc,
    pub wp_gpio: *mut gpio_desc,
    pub 1: unsigned int reading:,
}
...
#[no_mangle]
unsafe extern "C" fn ingenic_nand_ecc_hwctl(chip: *mut nand_chip, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_nand_attach_chip(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nfc->soc_info->oob_layout) -> else {
...
#[no_mangle]
unsafe extern "C" fn ingenic_nand_cleanup_chips(nfc: *mut ingenic_nfc) {
    ...
    let mut i: c_int = 0;
    int ret;
    let mut num_chips: c_int = of_get_child_count(dev.of_node);
...
#[no_mangle]
unsafe extern "C" fn ingenic_nand_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_nand_remove(pdev: *mut platform_device) {
