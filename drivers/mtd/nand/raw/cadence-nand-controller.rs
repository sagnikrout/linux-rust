...
//! Source: drivers/mtd/nand/raw/cadence-nand-controller.c
#![no_std]
...
//
pub const MAX_ADDRESS_CYC: c_int = 6;
pub const MAX_ERASE_ADDRESS_CYC: c_int = 3;
pub const MAX_DATA_SIZE: c_uint = 0xFFFC;
pub const DMA_DATA_SIZE_ALIGN: c_int = 8;
// Register definition.
//
// Command register 0.
...
//
pub const CMD_REG0: c_uint = 0x0000;
...
// Command register 2.
pub const CMD_REG2: c_uint = 0x0008;
// Command register 3.
pub const CMD_REG3: c_uint = 0x000C;
// Pointer register to select which thread status will be selected.
pub const CMD_STATUS_PTR: c_uint = 0x0010;
// Command status register for selected thread.
pub const CMD_STATUS: c_uint = 0x0014;
// Interrupt status register.
pub const INTR_STATUS: c_uint = 0x0110;

// Interrupt enable register.
pub const INTR_ENABLE: c_uint = 0x0114;

// Controller internal state.
pub const CTRL_STATUS: c_uint = 0x0118;

// Command Engine threads state.
pub const TRD_STATUS: c_uint = 0x0120;
// Command Engine interrupt thread error status.
pub const TRD_ERR_INT_STATUS: c_uint = 0x0128;
// Command Engine interrupt thread error enable.
pub const TRD_ERR_INT_STATUS_EN: c_uint = 0x0130;
// Command Engine interrupt thread complete status.
pub const TRD_COMP_INT_STATUS: c_uint = 0x0138;
//
// Transfer config 0 register.
// Configures data transfer parameters.
//
pub const TRAN_CFG_0: c_uint = 0x0400;
...
pub const ECC_CONFIG_1: c_uint = 0x042C;
// Multiplane settings register.
pub const MULTIPLANE_CFG: c_uint = 0x0434;
// Cache operation settings.
pub const CACHE_CFG: c_uint = 0x0438;
// DMA settings register.
pub const DMA_SETINGS: c_uint = 0x043C;
// Enable SDMA error report on access unprepared slave DMA interface.

// Transferred data block size for the slave DMA module.
pub const SDMA_SIZE: c_uint = 0x0440;
// Thread number associated with transferred data block
// for the slave DMA module.
//
pub const SDMA_TRD_NUM: c_uint = 0x0444;
// Thread number mask.

pub const CONTROL_DATA_CTRL: c_uint = 0x0494;
// Thread number mask.

pub const CTRL_VERSION: c_uint = 0x800;

// Available hardware features of the controller.
pub const CTRL_FEATURES: c_uint = 0x804;
...
pub const BCH_CFG_0: c_uint = 0x838;

// BCH Engine identification register 1 - correction strengths.
pub const BCH_CFG_1: c_uint = 0x83C;

// BCH Engine identification register 2 - sector sizes.
pub const BCH_CFG_2: c_uint = 0x840;

// BCH Engine identification register 3.
pub const BCH_CFG_3: c_uint = 0x844;

// Ready/Busy# line status.
pub const RBN_SETINGS: c_uint = 0x1004;
// Common settings.
pub const COMMON_SET: c_uint = 0x1008;

// 16 bit device connected to the NAND Flash interface.

// Skip_bytes registers.
pub const SKIP_BYTES_CONF: c_uint = 0x100C;

pub const SKIP_BYTES_OFFSET: c_uint = 0x1010;

// Timings configuration.
pub const TOGGLE_TIMINGS_0: c_uint = 0x1014;
pub const TOGGLE_TIMINGS_1: c_uint = 0x1018;
pub const ASYNC_TOGGLE_TIMINGS: c_uint = 0x101c;

pub const SYNC_TIMINGS: c_uint = 0x1020;

pub const TIMINGS0: c_uint = 0x1024;

pub const TIMINGS1: c_uint = 0x1028;

pub const TIMINGS2: c_uint = 0x102c;

// Configuration of the resynchronization of slave DLL of PHY.
pub const DLL_PHY_CTRL: c_uint = 0x1034;

// Register controlling DQ related timing.
pub const PHY_DQ_TIMING: c_uint = 0x2000;

// Register controlling DSQ related timing.
pub const PHY_DQS_TIMING: c_uint = 0x2004;

// Register controlling the gate and loopback control related timing.
pub const PHY_GATE_LPBK_CTRL: c_uint = 0x2008;

// Register holds the control for the master DLL logic.
pub const PHY_DLL_MASTER_CTRL: c_uint = 0x200C;

// Register holds the control for the slave DLL logic.
pub const PHY_DLL_SLAVE_CTRL: c_uint = 0x2010;
// Register controls the DQS related timing.
pub const PHY_IE_TIMING: c_uint = 0x2014;

// This register handles the global control settings for the PHY.
pub const PHY_CTRL: c_uint = 0x2080;

//
// This register handles the global control settings
// for the termination selects for reads.
//
pub const PHY_TSEL: c_uint = 0x2084;
...
pub const GCMD_LAY_INSTR_CMD: c_int = 0;
// Generic ADDR sequence type.
pub const GCMD_LAY_INSTR_ADDR: c_int = 1;
// Generic data transfer sequence type.
pub const GCMD_LAY_INSTR_DATA: c_int = 2;
...
pub const GCMD_DIR_READ: c_int = 0;
// Write transfer direction of generic command data sequence.
pub const GCMD_DIR_WRITE: c_int = 1;
...
pub const CDMA_CT_ERASE: c_uint = 0x1000;
// Program page command type of CDMA descriptor.
pub const CDMA_CT_WR: c_uint = 0x2100;
// Read page command type of CDMA descriptor.
pub const CDMA_CT_RD: c_uint = 0x2200;
// Flash pointer memory shift.
pub const CDMA_CFPTR_MEM_SHIFT: c_int = 24;
...
pub const STAT_OK: c_int = 0;
// Status of operation - FAIL.
pub const STAT_FAIL: c_int = 2;
// Status of operation - uncorrectable ECC error.
pub const STAT_ECC_UNCORR: c_int = 3;
// Status of operation - page erased.
pub const STAT_ERASED: c_int = 5;
// Status of operation - correctable ECC error.
pub const STAT_ECC_CORR: c_int = 6;
// Status of operation - unsuspected state.
pub const STAT_UNKNOWN: c_int = 7;
// Status of operation - operation is not completed yet.
pub const STAT_BUSY: c_uint = 0xFF;
pub const BCH_MAX_NUM_CORR_CAPS: c_int = 8;
pub const BCH_MAX_NUM_SECTOR_SIZES: c_int = 2;
// NVDDR mode specific parameters and register values based on cadence specs
pub const NVDDR_PHY_RD_DELAY: c_int = 29;
pub const NVDDR_PHY_RD_DELAY_MAX: c_int = 31;
pub const NVDDR_GATE_CFG_OPT: c_int = 14;
pub const NVDDR_GATE_CFG_STD: c_int = 7;
pub const NVDDR_GATE_CFG_MAX: c_int = 15;
pub const NVDDR_DATA_SEL_OE_START: c_int = 1;
pub const NVDDR_DATA_SEL_OE_START_MAX: c_int = 7;
pub const NVDDR_DATA_SEL_OE_END: c_int = 6;
pub const NVDDR_DATA_SEL_OE_END_MIN: c_int = 4;
pub const NVDDR_DATA_SEL_OE_END_MAX: c_int = 15;
pub const NVDDR_RS_HIGH_WAIT_CNT: c_int = 7;
pub const NVDDR_RS_IDLE_CNT: c_int = 7;
pub const NVDDR_TCWAW_DELAY: c_int = 250000;
pub const NVDDR_TVDLY_DELAY: c_int = 500000;
pub const NVDDR_TOGGLE_TIMINGS_0: c_uint = 0x00000301;
pub const NVDDR_TOGGLE_TIMINGS_1: c_uint = 0x0a060102;
pub const NVDDR_ASYNC_TOGGLE_TIMINGS: c_int = 0;
pub const NVDDR_PHY_CTRL: c_uint = 0x00004000;
pub const NVDDR_PHY_TSEL: c_int = 0;
pub const NVDDR_PHY_DLL_MASTER_CTRL: c_uint = 0x00140004;
pub const NVDDR_PHY_DLL_SLAVE_CTRL: c_uint = 0x00003c3c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cadence_nand_timings {
    pub async_toggle_timings: u32,
    pub sync_timings: u32,
    pub timings0: u32,
    pub timings1: u32,
    pub timings2: u32,
    pub dll_phy_ctrl: u32,
    pub phy_ctrl: u32,
    pub phy_dq_timing: u32,
    pub phy_dqs_timing: u32,
    pub phy_gate_lpbk_ctrl: u32,
    pub phy_ie_timing: u32,
}

// Command DMA descriptor.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cadence_nand_cdma_desc {
// Next descriptor address.
    pub next_pointer: u64,
// Flash address is a 32-bit address comprising of BANK and ROW ADDR.
    pub flash_pointer: u32,
...
// System/host memory address required for data DMA commands.
    pub memory_pointer: u64,
// Status of operation.
    pub status: u32,
    pub rsvd3: u32,
// Address pointer to sync buffer location.
    pub sync_flag_pointer: u64,
// Controls the buffer sync mechanism.
    pub sync_arguments: u32,
    pub rsvd4: u32,
// Control data pointer.
    pub ctrl_data_ptr: u64,
}

// Interrupt status.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cadence_nand_irq_status {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cadence_nand_dt_devdata {
// Skew value of the output signals of the NAND Flash interface.
    pub if_skew: u32,
// It informs if slave DMA interface is connected to DMA engine.
    pub has_dma:1: c_uint,
}

// Cadence NAND flash controller capabilities read from registers.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_nand_caps {
// Maximum number of banks supported by hardware.
    pub max_banks: u8,
// Slave and Master DMA data width in bytes (4 or 8).
    pub data_dma_width: u8,
// Control Data feature supported.
    pub data_control_supp: bool,
// Is PHY type DLL.
    pub is_phy_type_dll: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_nand_ctrl {
    pub dev: *mut device,
    pub controller: nand_controller,
    pub cdma_desc: *mut cadence_nand_cdma_desc,
// IP capability.
    pub caps1: *const cadence_nand_dt_devdata,
    pub caps2: cdns_nand_caps,
    pub ctrl_rev: u8,
    pub dma_cdma_desc: dma_addr_t,
    pub buf: *mut u8,
    pub buf_size: u32,
    pub curr_corr_str_idx: u8,
// Register interface.
    pub reg: *mut void __iomem,
    struct {
    pub virt: *mut void __iomem,
    pub dma: dma_addr_t,
    pub iova_dma: dma_addr_t,
    pub size: u32,
    pub io: },
    pub irq: c_int,
// Interrupts that have happened.
    pub irq_status: cadence_nand_irq_status,
// Interrupts we are waiting for.
    pub irq_mask: cadence_nand_irq_status,
    pub complete: completion,
// Protect irq_mask and irq_status.
    pub irq_lock: spinlock_t,
    pub ecc_strengths: [c_int; BCH_MAX_NUM_CORR_CAPS],
    pub ecc_stepinfos: [nand_ecc_step_info; BCH_MAX_NUM_SECTOR_SIZES],
    pub ecc_caps: nand_ecc_caps,
    pub curr_trans_type: c_int,
    pub dmac: *mut dma_chan,
    pub nf_clk_rate: u32,
//
...
//
    ...
    pub chips: list_head,
    pub bch_metadata_size: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_nand_chip {
    pub timings: cadence_nand_timings,
    pub chip: nand_chip,
    pub nsels: u8,
    pub node: list_head,
//
...
// ECC strength index.
    ...
    u32 buf_len)
    {
    let mut data_dma_width: u8 = cdns_ctrl.caps2.data_dma_width;
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_reset_irq(cdns_ctrl: *mut cdns_nand_ctrl) {
...
//
#[no_mangle]
unsafe extern "C" fn cadence_nand_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Tell the OS that we've handled this.
    ...
    struct cadence_nand_irq_status *irq_status)
    {
    let mut timeout: c_ulong = msecs_to_jiffies(10000);
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_get_caps(cdns_ctrl: *mut cdns_nand_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_cdma_finish(cdns_ctrl: *mut cdns_nand_ctrl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cadence_nand_calc_ecc_bytes(max_step_size: c_int, strength: c_int) -> c_int {
    static int cadence_nand_calc_ecc_bytes(int max_step_size, int strength)
    {
    let mut nbytes: c_int = DIV_ROUND_UP(fls(8 * max_step_size) * strength, 8);
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_read_bch_caps(cdns_ctrl: *mut cdns_nand_ctrl) -> c_int {
    static int cadence_nand_read_bch_caps(struct cdns_nand_ctrl *cdns_ctrl)
    {
    struct nand_ecc_caps *ecc_caps = &cdns_ctrl.ecc_caps;
    let mut max_step_size: c_int = 0, nstrengths, i;
    u32 reg;
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_hw_init(cdns_ctrl: *mut cdns_nand_ctrl) -> c_int {
...
pub const TT_MAIN_OOB_AREAS: c_int = 2;
pub const TT_RAW_PAGE: c_int = 3;
pub const TT_BBM: c_int = 4;
pub const TT_MAIN_OOB_AREA_EXT: c_int = 5;
// Prepare size of data to transfer.
    ...
    let mut sec_size: u32 = 0, offset = 0, sec_cnt = 1;
    let mut last_sec_size: u32 = cdns_chip.sector_size;
    let mut data_ctrl_size: u32 = 0;
    let mut reg: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_select_target(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_erase(chip: *mut nand_chip, page: u32) -> c_int {
    static int cadence_nand_erase(struct nand_chip *chip, u32 page)
    {
    struct cdns_nand_ctrl *cdns_ctrl = to_cdns_nand_ctrl(chip.controller);
    struct cdns_nand_chip *cdns_chip = to_cdns_nand_chip(chip);
    int status;
    let mut thread_nr: u8 = cdns_chip.cs[chip.cur_cs];
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_read_bbm(chip: *mut nand_chip, page: c_int, buf: *mut u8) -> c_int {
...
//
    ...
    cdns_chip.cs[chip.cur_cs],
    page, cdns_ctrl.buf, core::ptr::null_mut(),
    mtd.oobsize,
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_write_oob(chip: *mut nand_chip, page: c_int) -> c_int {
    ...
    struct cdns_nand_chip *cdns_chip = to_cdns_nand_chip(chip);
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut writesize: c_int = mtd.writesize;
    let mut oobsize: c_int = mtd.oobsize;
    ...
    let mut oob_skip: c_int = cdns_chip.bbm_len;
    let mut size: usize = writesize + oobsize;
    int i, pos, len;
...
// Arrange the buffer for syndrome payload/ecc layout.
    ...
    pos += oob_skip;
#[no_mangle]
pub unsafe extern "C" fn if(writesize: pos + len >) -> else {
...
pub unsafe extern "C" fn if(writesize: pos + len >) -> else {
    ...
    int page)
    {
    return cadence_nand_write_page_raw(chip, core::ptr::null_mut(), true, page);
    }
...
// Otherwise use bounce buffer.
    ...
    cdns_chip.cs[chip.cur_cs],
    page, cdns_ctrl.buf,
    core::ptr::null_mut(), mtd.writesize
    + cdns_chip.avail_oob_size,
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_read_oob(chip: *mut nand_chip, page: c_int) -> c_int {
...
pub unsafe extern "C" fn if(writesize: pos + len >) -> else {
    ...
    int page)
    {
    return cadence_nand_read_page_raw(chip, core::ptr::null_mut(), true, page);
    }
#[no_mangle]
unsafe extern "C" fn cadence_nand_slave_dma_transfer_finished(data: *mut c_void) {
...
// Wait until slave DMA interface is ready to data transfer.
    ...
    let mut data_dma_width: u8 = cdns_ctrl.caps2.data_dma_width;
    let mut len_in_words: c_int = (data_dma_width == 4) ? len >> 2 : len >> 3;
// read alignment data
    if (data_dma_width == 4)
...
//
    ...
    let mut op_id: c_uint = 0;
    let mut mini_ctrl_cmd: u64 = 0;
    int ret;
...
//
    ...
    let mut timeout_us: u32 = instr.ctx.waitrdy.timeout_ms * 1000;
    ...
    {
    if (!check_only) {
    let mut status: c_int = cadence_nand_select_target(chip);
    if (status)
    return status;
    }
...
#[no_mangle]
unsafe extern "C" fn calc_cycl(timing: u32, clock: u32) -> c_int {
...
// Calculate data valid window.
    ...
    u32 reg;
    let mut board_delay: u32 = cdns_ctrl.board_delay;
    ...
    let mut twp_cnt: u32 = 0, trp_cnt = 0, trh_cnt = 0;
    let mut if_skew: u32 = cdns_ctrl.caps1.if_skew;
    let mut board_delay_skew_min: u32 = board_delay - if_skew;
    let mut board_delay_skew_max: u32 = board_delay + if_skew;
    u32 dqs_sampl_res, phony_dqs_mod;
    u32 tdvw, tdvw_min, tdvw_max;
    u32 ext_rd_mode, ext_wr_mode;
    let mut dll_phy_dqs_timing: u32 = 0, phony_dqs_timing = 0, rd_del_sel = 0;
    u32 sampling_point;
    memset(t, 0, sizeof(*t));
...
//
    ...
    u32 clk_period = DIV_ROUND_DOWN_ULL(1000000000000ULL,
    cdns_ctrl.nf_clk_rate);
    let mut ddr_clk_ctrl_period: u32 = clk_period * 2;
    let mut if_skew: u32 = cdns_ctrl.caps1.if_skew;
    u32 tceh_cnt, tcs_cnt, tadl_cnt, tccs_cnt;
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_attach_chip(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_chips_cleanup(cdns_ctrl: *mut cdns_nand_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_chips_init(cdns_ctrl: *mut cdns_nand_ctrl) -> c_int {
    static int cadence_nand_chips_init(struct cdns_nand_ctrl *cdns_ctrl)
    {
    struct device_node *np = cdns_ctrl.dev.of_node;
    let mut max_cs: c_int = cdns_ctrl.caps2.max_banks;
    int nchips, ret;
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_init(cdns_ctrl: *mut cdns_nand_ctrl) -> c_int {
...
// Driver exit point.
#[no_mangle]
unsafe extern "C" fn cadence_nand_remove(cdns_ctrl: *mut cdns_nand_ctrl) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cadence_nand_dt {
    pub cdns_ctrl: cdns_nand_ctrl,
    pub clk: *mut clk,
}
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_dt_probe(ofdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cadence_nand_dt_remove(ofdev: *mut platform_device) {
