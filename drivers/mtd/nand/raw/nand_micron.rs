...
//! Source: drivers/mtd/nand/raw/nand_micron.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nand_onfi_vendor_micron {
    pub two_plane_read: u8,
    pub read_cache: u8,
    pub read_unique_id: u8,
    pub dq_imped: u8,
    pub dq_imped_num_settings: u8,
    pub dq_imped_feat_addr: u8,
    pub rb_pulldown_strength: u8,
    pub rb_pulldown_strength_feat_addr: u8,
    pub rb_pulldown_strength_num_settings: u8,
    pub otp_mode: u8,
    pub otp_page_start: u8,
    pub otp_data_prot_addr: u8,
    pub otp_num_pages: u8,
    pub otp_feat_addr: u8,
    pub read_retry_options: u8,
    pub reserved: [u8; 72],
    pub param_revision: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct micron_on_die_ecc {
    pub forced: bool,
    pub enabled: bool,
    pub rawbuf: *mut c_void,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct micron_nand {
    pub ecc: micron_on_die_ecc,
}

#[no_mangle]
unsafe extern "C" fn micron_nand_setup_read_retry(chip: *mut nand_chip, retry_mode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn micron_nand_onfi_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micron_nand_on_die_ecc_setup(chip: *mut nand_chip, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micron_nand_on_die_ecc_status_8(chip: *mut nand_chip, status: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn micron_supports_on_die_ecc(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micron_nand_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micron_nand_cleanup(chip: *mut nand_chip) {
