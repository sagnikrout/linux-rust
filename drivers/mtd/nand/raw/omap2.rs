...
//! Source: drivers/mtd/nand/raw/omap2.c
#![no_std]
...
pub const OMAP_NAND_TIMEOUT_MS: c_int = 5000;

pub const PREFETCH_CONFIG1_CS_SHIFT: c_int = 24;
pub const ECC_CONFIG_CS_SHIFT: c_int = 1;
pub const CS_MASK: c_uint = 0x7;

pub const DMA_MPU_MODE_SHIFT: c_int = 2;
pub const ECCSIZE0_SHIFT: c_int = 12;
pub const ECCSIZE1_SHIFT: c_int = 22;
pub const ECC1RESULTSIZE: c_uint = 0x1;
pub const ECCCLEAR: c_uint = 0x100;
pub const ECC1: c_uint = 0x1;
pub const PREFETCH_FIFOTHRESHOLD_MAX: c_uint = 0x40;

pub const STATUS_BUFF_EMPTY: c_uint = 0x00000001;
pub const SECTOR_BYTES: c_int = 512;
// 4 bit padding to make byte aligned, 56 = 52 + 4
pub const BCH4_BIT_PAD: c_int = 4;
// GPMC ecc engine settings for read

pub const BCH8R_ECC_SIZE0: c_uint = 0x1a	/* ecc_size0 = 26 */;
pub const BCH8R_ECC_SIZE1: c_uint = 0x2	/* ecc_size1 = 2 */;
pub const BCH4R_ECC_SIZE0: c_uint = 0xd	/* ecc_size0 = 13 */;
pub const BCH4R_ECC_SIZE1: c_uint = 0x3	/* ecc_size1 = 3 */;
// GPMC ecc engine settings for write

pub const BCH_ECC_SIZE0: c_uint = 0x0	/* ecc_size0 = 0, no oob protection */;
pub const BCH_ECC_SIZE1: c_uint = 0x20	/* ecc_size1 = 32 */;
pub const BBM_LEN: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_nand_info {
    pub nand: nand_chip,
    pub pdev: *mut platform_device,
    pub gpmc_cs: c_int,
    pub dev_ready: bool,
    pub xfer_type: enum nand_io,
    pub ecc_opt: enum omap_ecc,
    pub elm_of_node: *mut device_node,
    pub phys_base: c_ulong,
    pub comp: completion,
    pub dma: *mut dma_chan,
    pub gpmc_irq_fifo: c_int,
    pub gpmc_irq_count: c_int,
    enum {
...
// Interface to GPMC
    ...
    pub reg: gpmc_nand_regs,
    pub ops: *mut gpmc_nand_ops,
    pub flash_bbt: bool,
// fields specific for BCHx_HW ECC scheme
    pub elm_dev: *mut device,
// NAND ready gpio
    pub ready_gpiod: *mut gpio_desc,
    pub neccpg: c_uint,
    pub nsteps_per_eccpg: c_uint,
    pub eccpg_size: c_uint,
    pub eccpg_bytes: c_uint,
    void (*data_in)(struct nand_chip *chip, void *buf,
    pub force_8bit): unsigned int len, bool,
...
//
#[no_mangle]
unsafe extern "C" fn omap_prefetch_reset(cs: c_int, info: *mut omap_nand_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omap_nand_dma_callback(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn omap_nand_irq(this_irq: c_int, dev: *mut c_void) -> irqreturn_t {
    ...
    bytes = info.buf_len;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !info->buf_len) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn gen_true_ecc(ecc_buf: *mut u8) {
...
//
    ...
    u8	ecc_bit[24];
    let mut ecc_sum: u8 = 0;
    let mut find_bit: u8 = 0;
    let mut find_byte: c_uint = 0;
    int	isEccFF;
...
//
    ...
    {
    struct omap_nand_info *info = mtd_to_omap(nand_to_mtd(chip));
    let mut blockCnt: c_int = 0, i = 0, ret = 0;
...
//
#[no_mangle]
unsafe extern "C" fn omap_enable_hwecc(chip: *mut nand_chip, mode: c_int) {
    static void omap_enable_hwecc(struct nand_chip *chip, int mode)
    {
    struct omap_nand_info *info = mtd_to_omap(nand_to_mtd(chip));
    let mut dev_width: c_uint = (chip.options & NAND_BUSWIDTH_16) ? 1 : 0;
    u32 val;
...
//
    ...
    struct omap_nand_info *info = mtd_to_omap(nand_to_mtd(chip));
    let mut ecc_opt: enum omap_ecc = info.ecc_opt;
    u32 val, wr_mode;
...
//
    ...
    let mut eccbytes: c_int = info.nand.ecc.bytes;
...
//
    ...
    let mut eccsteps: c_int = info.nsteps_per_eccpg;
    int i , j, stat = 0;
    ...
    u_char *buf;
    int bitflip_count;
    let mut is_error_reported: bool = false;
...
// Write data
    ...
    let mut base_step: c_uint = eccpg * info.nsteps_per_eccpg;
...
//
    ...
    let mut max_bitflips: c_uint = 0, eccpg;
    int stat, ret;
...
#[no_mangle]
unsafe extern "C" fn omap2_nand_ecc_check(info: *mut omap_nand_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn omap_get_dt_info(dev: *mut device, info: *mut omap_nand_info) -> c_int {
...
// select data transfer mode
    ...
    let mut nsteps: c_uint = nanddev_get_ecc_nsteps(nand);
    let mut ecc_bytes: c_uint = nanddev_get_ecc_bytes_per_step(nand);
    let mut off: c_int = BBM_LEN;
    if (section >= nsteps)
    return -ERANGE;
//
...
#[no_mangle]
unsafe extern "C" fn omap_nand_attach_chip(chip: *mut nand_chip) -> c_int {
    static int omap_nand_attach_chip(struct nand_chip *chip)
    {
    struct mtd_info *mtd = nand_to_mtd(chip);
    struct omap_nand_info *info = mtd_to_omap(mtd);
    struct device *dev = &info.pdev.dev;
    let mut min_oobbytes: c_int = BBM_LEN;
    let mut elm_bch_strength: c_int = -1;
...
#[no_mangle]
unsafe extern "C" fn omap_nand_detach_chip(chip: *mut nand_chip) {
    ...
    {
    struct omap_nand_info *info = mtd_to_omap(nand_to_mtd(chip));
    let mut alignment: u32 = ((uintptr_t)buf | len) & 3;
    if (force_8bit || (alignment & 1))
    ioread8_rep(info.fifo, buf, len);
#[no_mangle]
pub unsafe extern "C" fn if(3: alignment &) -> else {
    else if (alignment & 3)
...
#[no_mangle]
unsafe extern "C" fn omap_nand_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_nand_remove(pdev: *mut platform_device) {
