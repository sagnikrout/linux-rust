...
//! Source: drivers/mtd/nand/raw/lpc32xx_mlc.c
#![no_std]
...
//
pub const MLCCMD_RESET: c_uint = 0xFF;
//
...
//
pub const MLCLOCKPR_MAGIC: c_uint = 0xA25E;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc32xx_nand_cfg_mlc {
    pub tcea_delay: u32,
    pub busy_delay: u32,
    pub nand_ta: u32,
    pub rd_high: u32,
...
//
    static int use_dma;
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_setup(host: *mut lpc32xx_nand_host) {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_device_ready(nand_chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc3xxx_nand_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_waitfunc_nand(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_waitfunc_controller(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_waitfunc(chip: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_wp_enable(host: *mut lpc32xx_nand_host) {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_wp_disable(host: *mut lpc32xx_nand_host) {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_dma_complete_func(completion: *mut c_void) {
    ...
    let mut flags: c_int = DMA_CTRL_ACK | DMA_PREP_INTERRUPT;
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_read_oob(chip: *mut nand_chip, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_write_oob(chip: *mut nand_chip, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_ecc_enable(chip: *mut nand_chip, mode: c_int) {
    static void lpc32xx_ecc_enable(struct nand_chip *chip, int mode)
    {
// Always enabled!
    }
#[no_mangle]
unsafe extern "C" fn lpc32xx_dma_setup(host: *mut lpc32xx_nand_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_attach_chip(chip: *mut nand_chip) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_probe(pdev: *mut platform_device) -> c_int {
...
// Start with WP disabled, if available
    host.wp_gpio = gpiod_get_optional(&pdev.dev, core::ptr::null_mut(), GPIOD_OUT_LOW);
...
// Get NAND clock
    host.clk = clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(host.clk)) {
...
//
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_nand_suspend(pdev: *mut platform_device, pm: pm_message_t) -> c_int {
