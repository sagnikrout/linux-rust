...
//! Source: drivers/mtd/nand/raw/davinci_nand.c
#![no_std]
...
pub const NANDFCR_OFFSET: c_uint = 0x60;
pub const NANDFSR_OFFSET: c_uint = 0x64;
pub const NANDF1ECC_OFFSET: c_uint = 0x70;
// 4-bit ECC syndrome registers
pub const NAND_4BIT_ECC_LOAD_OFFSET: c_uint = 0xbc;
pub const NAND_4BIT_ECC1_OFFSET: c_uint = 0xc0;
pub const NAND_4BIT_ECC2_OFFSET: c_uint = 0xc4;
pub const NAND_4BIT_ECC3_OFFSET: c_uint = 0xc8;
pub const NAND_4BIT_ECC4_OFFSET: c_uint = 0xcc;
pub const NAND_ERR_ADD1_OFFSET: c_uint = 0xd0;
pub const NAND_ERR_ADD2_OFFSET: c_uint = 0xd4;
pub const NAND_ERR_ERRVAL1_OFFSET: c_uint = 0xd8;
pub const NAND_ERR_ERRVAL2_OFFSET: c_uint = 0xdc;
// NOTE:  boards don't need to use these address bits
// for ALE/CLE unless they support booting from NAND.
// They're used unless platform data overrides them.
//
pub const MASK_ALE: c_uint = 0x08;
pub const MASK_CLE: c_uint = 0x10;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct davinci_nand_pdata {
    pub mask_ale: u32,
    pub mask_cle: u32,
//
...
//
    pub core_chipsel: u32,
// for packages using two chipselects
    pub mask_chipsel: u32,
...
//
    pub engine_type: enum nand_ecc_engine_type,
    pub ecc_placement: enum nand_ecc_placement,
    pub ecc_bits: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct davinci_nand_info {
    pub controller: nand_controller,
    pub chip: nand_chip,
    pub pdev: *mut platform_device,
    pub is_readmode: bool,
    pub base: *mut void __iomem,
    pub vaddr: *mut void __iomem,
    pub current_cs: *mut void __iomem,
    pub mask_chipsel: u32,
    pub mask_ale: u32,
    pub mask_cle: u32,
    pub core_chipsel: u32,
    pub clk: *mut clk,
    pub aemif: *mut aemif_device,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_davinci_readecc_1bit(mtd: *mut mtd_info) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nand_davinci_hwctl_1bit(chip: *mut nand_chip, mode: c_int) {
...
//
    ...
    {
    let mut ecc_val: c_uint = nand_davinci_readecc_1bit(nand_to_mtd(chip));
    let mut ecc24: c_uint = (ecc_val & 0x0fff) | ((ecc_val & 0x0fff0000) >> 4);
// invert so that erased block ecc is correct
    ...
    (calc_ecc[2] << 16);
    let mut diff: u32 = eccCalc ^ eccNand;
    if (diff) {
...
//
#[no_mangle]
unsafe extern "C" fn nand_davinci_hwctl_4bit(chip: *mut nand_chip, mode: c_int) {
...
//
    ...
    for (;;) {
    let mut fsr: u32 = davinci_nand_readl(info, NANDFSR_OFFSET);
    switch ((fsr >> 8) & 0x0f) {
...
//
    ...
    let mut total_ecc_bytes: c_uint = nand.ecc.ctx.total;
...
#[no_mangle]
unsafe extern "C" fn davinci_nand_attach_chip(chip: *mut nand_chip) -> c_int {
...
//
    ...
    if (pdata.ecc_bits == 4) {
    let mut chunks: c_int = mtd.writesize / 512;
...
#[no_mangle]
unsafe extern "C" fn nand_davinci_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nand_davinci_remove(pdev: *mut platform_device) {
