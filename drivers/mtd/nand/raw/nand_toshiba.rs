...
//! Source: drivers/mtd/nand/raw/nand_toshiba.c
#![no_std]
...
pub const TOSHIBA_NAND_CMD_ECC_STATUS_READ: c_uint = 0x7A;
// ECC Status Mask for BENAND
pub const TOSHIBA_NAND_ECC_STATUS_MASK: c_uint = 0x0F;
// Uncorrectable Error for BENAND
pub const TOSHIBA_NAND_ECC_STATUS_UNCORR: c_uint = 0x0F;
// Max ECC Steps for BENAND
pub const TOSHIBA_NAND_MAX_ECC_STEPS: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn toshiba_nand_benand_eccstatus(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn toshiba_nand_benand_init(chip: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn toshiba_nand_decode_id(chip: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn tc58teg5dclta00_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc58nvg0s3e_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn th58nvg2s3hbai4_init(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn toshiba_nand_init(chip: *mut nand_chip) -> c_int {
