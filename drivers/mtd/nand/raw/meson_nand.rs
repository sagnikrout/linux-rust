...
//! Source: drivers/mtd/nand/raw/meson_nand.c
#![no_std]
...
pub const NFC_REG_CMD: c_uint = 0x00;

pub const NFC_CMD_SCRAMBLER_DISABLE: c_int = 0;
pub const NFC_CMD_SHORTMODE_ENABLE: c_int = 1;
pub const NFC_CMD_SHORTMODE_DISABLE: c_int = 0;

pub const NFC_REG_CFG: c_uint = 0x04;
pub const NFC_REG_DADR: c_uint = 0x08;
pub const NFC_REG_IADR: c_uint = 0x0c;
pub const NFC_REG_BUF: c_uint = 0x10;
pub const NFC_REG_INFO: c_uint = 0x14;
pub const NFC_REG_DC: c_uint = 0x18;
pub const NFC_REG_ADR: c_uint = 0x1c;
pub const NFC_REG_DL: c_uint = 0x20;
pub const NFC_REG_DH: c_uint = 0x24;
pub const NFC_REG_CADR: c_uint = 0x28;
pub const NFC_REG_SADR: c_uint = 0x2c;
pub const NFC_REG_PINS: c_uint = 0x30;
pub const NFC_REG_VER: c_uint = 0x38;

pub const CLK_DIV_SHIFT: c_int = 0;
pub const CLK_DIV_WIDTH: c_int = 6;
...
pub const NFC_SHORT_MODE_ECC_SZ: c_int = 384;

pub const DMA_BUSY_TIMEOUT: c_uint = 0x100000;
pub const CMD_FIFO_EMPTY_TIMEOUT: c_int = 1000;
pub const MAX_CE_NUM: c_int = 2;
// eMMC clock register, misc control

pub const NFC_CLK_CYCLE: c_int = 6;
// nand flash controller delay 3 ns
pub const NFC_DEFAULT_DELAY: c_int = 3000;

pub const MAX_CYCLE_ADDRS: c_int = 5;
pub const DIRREAD: c_int = 1;
pub const DIRWRITE: c_int = 0;
pub const ECC_PARITY_BCH8_512B: c_int = 14;

pub const ECC_UNCORRECTABLE: c_uint = 0x3f;
pub const PER_INFO_BYTE: c_int = 8;

pub const NFC_COLUMN_ADDR_0: c_int = 0;
pub const NFC_COLUMN_ADDR_1: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_nfc_nand_chip {
    pub node: list_head,
    pub nand: nand_chip,
    pub clk_rate: c_ulong,
    pub level1_divider: c_ulong,
    pub bus_timing: u32,
    pub twb: u32,
    pub tadl: u32,
    pub tbers_max: u32,
    pub boot_pages: u32,
    pub boot_page_step: u32,
    pub bch_mode: u32,
    pub data_buf: *mut u8,
    pub info_buf: *mut __le64,
    pub nsels: u32,
    pub __counted_by(nsels): u8 sels[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_nand_ecc {
    pub bch: u32,
    pub strength: u32,
    pub size: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_nfc_data {
    pub ecc_caps: *const nand_ecc_caps,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_nfc_param {
    pub chip_select: u32,
    pub rb_select: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nand_rw_cmd {
    pub cmd0: u32,
    pub addrs: [u32; MAX_CYCLE_ADDRS],
    pub cmd1: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nand_timing {
    pub twb: u32,
    pub tadl: u32,
    pub tbers_max: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_nfc {
    pub controller: nand_controller,
    pub core_clk: *mut clk,
    pub device_clk: *mut clk,
    pub nand_clk: *mut clk,
    pub nand_divider: clk_divider,
    pub clk_rate: c_ulong,
    pub bus_timing: u32,
    pub dev: *mut device,
    pub reg_base: *mut void __iomem,
    pub reg_clk: *mut void __iomem,
    pub completion: completion,
    pub chips: list_head,
    pub data: *const meson_nfc_data,
    pub param: meson_nfc_param,
    pub timing: nand_timing,
    union {
    pub cmd: [c_int; 32],
    pub rw: nand_rw_cmd,
    pub cmdfifo: },
...
#[no_mangle]
unsafe extern "C" fn meson_nand_calc_ecc_bytes(step_size: c_int, strength: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_select_chip(nand: *mut nand_chip, chip: c_int) {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_cmd_idle(nfc: *mut meson_nfc, time: u32) {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_cmd_seed(nfc: *mut meson_nfc, seed: u32) {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_is_boot_page(nand: *mut nand_chip, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_cmd_access(nand: *mut nand_chip, raw: c_int, dir: bool, page: c_int) {
    static void meson_nfc_cmd_access(struct nand_chip *nand, int raw, bool dir, int page)
    {
    const struct meson_nfc_nand_chip *meson_chip = to_meson_nand(nand);
    struct mtd_info *mtd = nand_to_mtd(nand);
    struct meson_nfc *nfc = nand_get_controller_data(mtd_to_nand(mtd));
    let mut len: c_int = mtd.writesize, pagesize, pages;
    int scrambler;
    u32 cmd;
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_drain_cmd(nfc: *mut meson_nfc) {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_wait_dma_finish(nfc: *mut meson_nfc) -> c_int {
    ...
    nand_status_op(nand, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_wait_rb_pin(nfc: *mut meson_nfc, timeout_ms: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_set_user_byte(nand: *mut nand_chip, oob_buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_get_user_byte(nand: *mut nand_chip, oob_buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_read_buf(nand: *mut nand_chip, buf: *mut u8, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_write_buf(nand: *mut nand_chip, buf: *mut u8, len: c_int) -> c_int {
    static int meson_nfc_write_buf(struct nand_chip *nand, u8 *buf, int len)
    {
    struct meson_nfc *nfc = nand_get_controller_data(nand);
    let mut ret: c_int = 0;
    u32 cmd;
    ret = meson_nfc_dma_buffer_setup(nand, buf, len, core::ptr::null_mut(),
    0, DMA_TO_DEVICE);
    if (ret)
    return ret;
    cmd = NFC_CMD_M2N | len;
    ...
    let mut cs: u32 = nfc.param.chip_select;
...
// info is updated by nfc dma engine
    ...
    let mut correct_bitmap: u64 = 0;
    let mut bitflips: u32 = 0;
    u8 *oob_buf = nand.oob_poi;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_read_oob_raw(nand: *mut nand_chip, page: c_int) -> c_int {
    static int meson_nfc_read_oob_raw(struct nand_chip *nand, int page)
    {
    return meson_nfc_read_page_raw(nand, core::ptr::null_mut(), 1, page);
    }
#[no_mangle]
unsafe extern "C" fn meson_nfc_read_oob(nand: *mut nand_chip, page: c_int) -> c_int {
    static int meson_nfc_read_oob(struct nand_chip *nand, int page)
    {
    return meson_nfc_read_page_hwecc(nand, core::ptr::null_mut(), 1, page);
    }
#[no_mangle]
unsafe extern "C" fn meson_nfc_is_buffer_dma_safe(buffer: *const c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_clk_init(nfc: *mut meson_nfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_disable_clk(nfc: *mut meson_nfc) {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_free_buffer(nand: *mut nand_chip) {
...
#[no_mangle]
unsafe extern "C" fn meson_chip_buffer_init(nand: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nand_bch_mode(nand: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nand_detach_chip(nand: *mut nand_chip) {
    static void meson_nand_detach_chip(struct nand_chip *nand)
    {
    meson_nfc_free_buffer(nand);
    }
#[no_mangle]
unsafe extern "C" fn meson_nand_attach_chip(nand: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_nand_chips_cleanup(nfc: *mut meson_nfc) {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_irq(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_nfc_remove(pdev: *mut platform_device) {
