...
//! Source: drivers/mtd/nand/raw/loongson-nand-controller.c
#![no_std]
...
pub const LOONGSON_NAND_CMD: c_uint = 0x0;
pub const LOONGSON_NAND_ADDR1: c_uint = 0x4;
pub const LOONGSON_NAND_ADDR2: c_uint = 0x8;
pub const LOONGSON_NAND_TIMING: c_uint = 0xc;
pub const LOONGSON_NAND_IDL: c_uint = 0x10;
pub const LOONGSON_NAND_IDH_STATUS: c_uint = 0x14;
pub const LOONGSON_NAND_PARAM: c_uint = 0x18;
pub const LOONGSON_NAND_OP_NUM: c_uint = 0x1c;
pub const LOONGSON_NAND_CS_RDY_MAP: c_uint = 0x20;
...
pub const LOONGSON_NAND_READ_ID_SLEEP_US: c_int = 1000;
pub const LOONGSON_NAND_READ_ID_TIMEOUT_US: c_int = 5000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson_nand_op {
    pub addrs: [c_char; LOONGSON_NAND_MAX_ADDR_CYC],
    pub naddrs: c_uint,
    pub addrs_offset: c_uint,
    pub aligned_offset: c_uint,
    pub cmd_reg: c_uint,
    pub row_start: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson_nand_data {
    pub max_id_cycle: c_uint,
    pub id_cycle_field: c_uint,
    pub status_field: c_uint,
    pub op_scope_field: c_uint,
    pub hold_cycle: c_uint,
    pub wait_cycle: c_uint,
    pub nand_cs: c_uint,
    pub dma_bits: c_uint,
    pub dev): *mut *mut int (dma_config)(struct device,
    pub op): *mut *mut *mut void (set_addr)(struct loongson_nand_host host, struct loongson_nand_op,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson_nand_host {
    pub dev: *mut device,
    pub chip: nand_chip,
    pub controller: nand_controller,
    pub data: *const loongson_nand_data,
    pub addr_cs_field: c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn if(NAND_OP_DATA_OUT_INSTR: instr->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_set_addr_cs(host: *mut loongson_nand_host) {
...
#[no_mangle]
unsafe extern "C" fn ls1b_nand_set_addr(host: *mut loongson_nand_host, op: *mut loongson_nand_op) {
...
#[no_mangle]
unsafe extern "C" fn ls1c_nand_set_addr(host: *mut loongson_nand_host, op: *mut loongson_nand_op) {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_trigger_op(host: *mut loongson_nand_host, op: *mut loongson_nand_op) {
    static void loongson_nand_trigger_op(struct loongson_nand_host *host, struct loongson_nand_op *op)
    {
    struct nand_chip *chip = &host.chip;
    struct mtd_info *mtd = nand_to_mtd(chip);
    let mut col0: c_int = op.addrs[0];
    short col;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: op->is_erase) -> else {
    else if (op.is_erase)
    op.len = 1;
    else
    op.len = op.orig_len;
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_dma_callback(data: *mut c_void) {
    ...
    status = dmaengine_tx_status(chan, host.dma_cookie, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_dma_transfer(host: *mut loongson_nand_host, op: *mut loongson_nand_op) -> c_int {
    ...
    let mut data_dir: enum dma_data_direction = op.is_write ? DMA_TO_DEVICE : DMA_FROM_DEVICE;
    let mut xfer_dir: enum dma_transfer_direction = op.is_write ? DMA_MEM_TO_DEV : DMA_DEV_TO_MEM;
    void *buf = op.buf;
    char *dma_buf = core::ptr::null_mut();
    dma_addr_t dma_addr;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_data_type_exec(chip: *mut nand_chip, subop: *const nand_subop) -> c_int {
    static int loongson_nand_data_type_exec(struct nand_chip *chip, const struct nand_subop *subop)
    {
    struct loongson_nand_host *host = nand_get_controller_data(chip);
    let mut op: loongson_nand_op = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_zerolen_type_exec(chip: *mut nand_chip, subop: *const nand_subop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_read_id_type_exec(chip: *mut nand_chip, subop: *const nand_subop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_is_valid_cmd(opcode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_is_valid_cmd_seq(opcode1: u8, opcode2: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_check_op(chip: *mut nand_chip, op: *const nand_operation) -> c_int {
    static int loongson_nand_check_op(struct nand_chip *chip, const struct nand_operation *op)
    {
    const struct nand_op_instr *instr1 = core::ptr::null_mut(), *instr2 = core::ptr::null_mut();
    int op_id;
    ...
    instr1 = instr;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !instr2) -> else {
    else if (!instr2)
    instr2 = instr;
    else
    break;
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_get_chip_capacity(chip: *mut nand_chip) -> c_int {
    static int loongson_nand_get_chip_capacity(struct nand_chip *chip)
    {
    struct loongson_nand_host *host = nand_get_controller_data(chip);
    let mut chipsize: u64 = nanddev_target_size(&chip.base);
    struct mtd_info *mtd = nand_to_mtd(chip);
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_attach_chip(chip: *mut nand_chip) -> c_int {
    static int loongson_nand_attach_chip(struct nand_chip *chip)
    {
    struct loongson_nand_host *host = nand_get_controller_data(chip);
    let mut cell_size: c_int = loongson_nand_get_chip_capacity(chip);
    if (cell_size < 0)
    return cell_size;
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_controller_cleanup(host: *mut loongson_nand_host) {
...
#[no_mangle]
unsafe extern "C" fn ls2k1000_nand_apbdma_config(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_controller_init(host: *mut loongson_nand_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_chip_init(host: *mut loongson_nand_host) -> c_int {
    static int loongson_nand_chip_init(struct loongson_nand_host *host)
    {
    struct device *dev = host.dev;
    let mut nchips: c_int = of_get_child_count(dev.of_node);
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_nand_remove(pdev: *mut platform_device) {
