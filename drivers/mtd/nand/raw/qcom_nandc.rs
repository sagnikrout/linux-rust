...
//! Source: drivers/mtd/nand/raw/qcom_nandc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_nand_boot_partition {
    pub page_offset: u32,
    pub page_size: u32,
}
...
pub struct qcom_op {
    ...
    pub addr1_reg: __le32,
    pub addr2_reg: __le32,
    pub cmd_reg: __le32,
    pub flag: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_nand_host {
    pub boot_partitions: *mut qcom_nand_boot_partition,
    pub chip: nand_chip,
    pub node: list_head,
    pub nr_boot_partitions: c_int,
    pub cs: c_int,
    pub cw_size: c_int,
    pub cw_data: c_int,
    pub ecc_bytes_hw: c_int,
    pub spare_bytes: c_int,
    pub bbm_size: c_int,
    pub last_command: c_int,
    pub cfg1: u32 cfg0,,
    pub cfg1_raw: u32 cfg0_raw,,
    pub ecc_buf_cfg: u32,
    pub ecc_bch_cfg: u32,
    pub clrflashstatus: u32,
    pub clrreadstatus: u32,
    pub status: u8,
    pub codeword_fixup: bool,
    pub use_ecc: bool,
    pub bch_enabled: bool,
}
...
#[no_mangle]
unsafe extern "C" fn nandc_read(nandc: *mut qcom_nand_controller, offset: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_is_last_cw(ecc: *mut nand_ecc_ctrl, cw: c_int) -> bool {
    static bool qcom_nandc_is_last_cw(struct nand_ecc_ctrl *ecc, int cw)
    {
    let mut cw: return = = (ecc.steps - 1);
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn if(NAND_READ_LOCATION_1: reg_base ==) -> else {
    else if (reg_base == NAND_READ_LOCATION_1)
    nandc.regs.read_location1 = locreg_val;
#[no_mangle]
pub unsafe extern "C" fn if(NAND_READ_LOCATION_2: reg_base ==) -> else {
    else if (reg_base == NAND_READ_LOCATION_2)
    nandc.regs.read_location2 = locreg_val;
#[no_mangle]
pub unsafe extern "C" fn if(NAND_READ_LOCATION_3: reg_base ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(NAND_READ_LOCATION_LAST_CW_1: reg_base ==) -> else {
    else if (reg_base == NAND_READ_LOCATION_LAST_CW_1)
    nandc.regs.read_location_last1 = locreg_val;
#[no_mangle]
pub unsafe extern "C" fn if(NAND_READ_LOCATION_LAST_CW_2: reg_base ==) -> else {
    else if (reg_base == NAND_READ_LOCATION_LAST_CW_2)
    nandc.regs.read_location_last2 = locreg_val;
#[no_mangle]
pub unsafe extern "C" fn if(NAND_READ_LOCATION_LAST_CW_3: reg_base ==) -> else {
...
// helper to configure location register values
    ...
    let mut reg_base: c_int = NAND_READ_LOCATION_0;
...
#[no_mangle]
unsafe extern "C" fn set_address(host: *mut qcom_nand_host, column: u16, page: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn update_rw_regs(host: *mut qcom_nand_host, num_cw: c_int, read: bool, cw: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn config_nand_page_read(chip: *mut nand_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn config_nand_page_write(chip: *mut nand_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn config_nand_cw_write(chip: *mut nand_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn erased_chunk_check_and_fixup(data_buf: *mut u8, data_len: c_int) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct read_stats {
    pub flash: __le32,
    pub buffer: __le32,
    pub erased_cw: __le32,
}

// reads back FLASH_STATUS register set by the controller
#[no_mangle]
unsafe extern "C" fn check_flash_errors(host: *mut qcom_nand_host, cw_cnt: c_int) -> c_int {
    ...
    for (i = 0; i < cw_cnt; i++) {
    let mut flash: u32 = le32_to_cpu(nandc.reg_read_buf[i]);
...
//
    ...
    struct mtd_info *mtd = nand_to_mtd(chip);
    struct nand_ecc_ctrl *ecc = &chip.ecc;
    let mut max_bitflips: c_uint = 0, uncorrectable_cws = 0;
    struct read_stats *buf;
    let mut flash_op_err: bool = false, erased;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn copy_last_cw(host: *mut qcom_nand_host, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_is_boot_partition(host: *mut qcom_nand_host, page: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_codeword_fixup(host: *mut qcom_nand_host, page: c_int) {
    static void qcom_nandc_codeword_fixup(struct qcom_nand_host *host, int page)
    {
    let mut codeword_fixup: bool = qcom_nandc_is_boot_partition(host, page);
...
// implements ecc->read_page()
    ...
    struct qcom_nand_controller *nandc = get_qcom_nand_controller(chip);
    struct nand_ecc_ctrl *ecc = &chip.ecc;
    u8 *data_buf, *oob_buf = core::ptr::null_mut();
    ...
    data_buf = buf;
    oob_buf = oob_required ? chip.oob_poi : core::ptr::null_mut();
    qcom_clear_bam_transaction(nandc);
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_read_oob(chip: *mut nand_chip, page: c_int) -> c_int {
    ...
    set_address(host, 0, page);
    update_rw_regs(host, ecc.steps, true, 0);
    return read_page_ecc(host, core::ptr::null_mut(), chip.oob_poi, page);
    }
...
// implements ecc->write_page_raw()
    ...
    for (i = 0; i < ecc.steps; i++) {
    int data_size1, data_size2, oob_size1, oob_size2;
    let mut reg_off: c_int = FLASH_BUF_ACC;
    data_size1 = mtd.writesize - host.cw_size * (ecc.steps - 1);
    oob_size1 = host.bbm_size;
    if (qcom_nandc_is_last_cw(ecc, i) && !host.codeword_fixup) {
    data_size2 = ecc.size - data_size1 -
...
//
#[no_mangle]
unsafe extern "C" fn qcom_nandc_write_oob(chip: *mut nand_chip, page: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_block_bad(chip: *mut nand_chip, ofs: loff_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_block_markbad(chip: *mut nand_chip, ofs: loff_t) -> c_int {
...
//
    ...
    {
    let mut strength: return = = 4 ? 12 : 16;
    }
    NAND_ECC_CAPS_SINGLE(qcom_nandc_ecc_caps, qcom_nandc_calc_ecc_bytes,
    NANDC_STEP_SIZE, 4, 8);
#[no_mangle]
unsafe extern "C" fn qcom_nand_attach_chip(chip: *mut nand_chip) -> c_int {
    ...
    bool wide_bus;
    let mut ecc_mode: c_int = ECC_MODE_8BIT;
...
#[no_mangle]
unsafe extern "C" fn qcom_delay_ns(ns: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn qcom_wait_rdy_poll(chip: *mut nand_chip, time_ms: c_uint) -> c_int {
    static int qcom_wait_rdy_poll(struct nand_chip *chip, unsigned int time_ms)
    {
    struct qcom_nand_controller *nandc = get_qcom_nand_controller(chip);
    let mut start: c_ulong = jiffies + msecs_to_jiffies(time_ms);
    u32 flash;
    qcom_nandc_dev_to_mem(nandc, true);
    do {
...
#[no_mangle]
unsafe extern "C" fn qcom_read_id_type_exec(chip: *mut nand_chip, subop: *const nand_subop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_misc_cmd_type_exec(chip: *mut nand_chip, subop: *const nand_subop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_param_page_type_exec(chip: *mut nand_chip, subop: *const nand_subop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_setup(nandc: *mut qcom_nand_controller) -> c_int {
...
// save the original values of these registers
    ...
    static const char * const probes[] = { "cmdlinepart", "ofpart", "qcomsmem", core::ptr::null_mut() };
...
// set up initial status value
    ...
    if (ret)
    return ret;
    ret = mtd_device_parse_register(mtd, probes, core::ptr::null_mut(), core::ptr::null_mut(), 0);
    if (ret)
    goto err;
...
#[no_mangle]
unsafe extern "C" fn qcom_probe_nand_devices(nandc: *mut qcom_nand_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_parse_dt(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_nandc_remove(pdev: *mut platform_device) {
