...
//! Source: drivers/mtd/nand/raw/nand_samsung.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn samsung_nand_decode_id(chip: *mut nand_chip) {
...
// New Samsung (6 byte ID): Samsung K9GAG08U0F (p.44)
    ...
    chip.id.data[5] != 0x00) {
    let mut extid: u8 = chip.id.data[3];
// Get pagesize
...
#[no_mangle]
unsafe extern "C" fn samsung_nand_init(chip: *mut nand_chip) -> c_int {
