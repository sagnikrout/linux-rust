...
//! Source: drivers/mtd/nand/raw/diskonchip.c
#![no_std]
...
pub const CONFIG_MTD_NAND_DISKONCHIP_PROBE_ADDRESS: c_int = 0;
    ...
    static struct mtd_info *doclist = core::ptr::null_mut();
#[repr(C)]
#[derive(Copy, Clone)]
pub struct doc_priv {
    ...
    pub physadr: c_ulong,
    pub ChipID: u_char,
    pub CDSNControl: u_char,
    pub /: *mut *mut int chips_per_floor; / The number of chips detected on each floor,
    pub curfloor: c_int,
    pub curchip: c_int,
    pub mh0_page: c_int,
    pub mh1_page: c_int,
    ...
    pub supports_32b_reads: bool,
// Handle the last stage of initialization (BBT scan, partitioning)
    pub mtd): *mut *mut int (late_init)(struct mtd_info,
}

// This is the ecc value computed by the HW ecc generator upon writing an empty
    page, one with all 0xff for data. */
    static u_char empty_write_ecc[6] = { 0x4b, 0x00, 0xe2, 0x0e, 0x93, 0xf7 };
pub const INFTL_BBT_RESERVED_BLOCKS: c_int = 4;

    let mut debug: static int = 0;
    module_param(debug, int, 0);
    let mut try_dword: static int = 1;
    module_param(try_dword, int, 0);
    let mut no_ecc_failures: static int = 0;
    module_param(no_ecc_failures, int, 0);
    let mut no_autopart: static int = 0;
    module_param(no_autopart, int, 0);
    let mut show_firmware_partition: static int = 0;
    module_param(show_firmware_partition, int, 0);

    let mut inftl_bbt_write: static int = 1;

    let mut inftl_bbt_write: static int = 0;

    module_param(inftl_bbt_write, int, 0);
    let mut doc_config_location: static unsigned long = CONFIG_MTD_NAND_DISKONCHIP_PROBE_ADDRESS;
...
// Number of roots
pub const NROOTS: c_int = 4;
// First consective root
pub const FCR: c_int = 510;
// Number of symbols
pub const NN: c_int = 1023;
//
...
//
#[no_mangle]
unsafe extern "C" fn doc_ecc_decode(rs: *mut rs_control, data: *mut u8, ecc: *mut u8) -> c_int {
...
// Call the decoder library
    nerr = decode_rs16(rs, core::ptr::null_mut(), core::ptr::null_mut(), 1019, syn, 0, errpos, 0, errval);
...
#[no_mangle]
unsafe extern "C" fn DoC_Delay(doc: *mut doc_priv, cycles: c_ushort) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: DoC_is_MillenniumPlus(doc)) -> else {
...
#[no_mangle]
unsafe extern "C" fn _DoC_WaitReady(doc: *mut doc_priv) -> c_int {
    static int _DoC_WaitReady(struct doc_priv *doc)
    {
    void __iomem *docptr = doc.virtadr;
    let mut timeo: c_ulong = jiffies + (HZ * 10);
    if (debug)
...
#[no_mangle]
pub unsafe extern "C" fn DoC_WaitReady(doc: *mut doc_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn doc2000_write_byte(this: *mut nand_chip, datum: u_char) {
...
#[no_mangle]
unsafe extern "C" fn doc2000_readbuf(this: *mut nand_chip, buf: *mut u_char, len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn doc200x_readid(this: *mut nand_chip, cs: c_uint, id: *mut u8) {
    ...
    let mut op: nand_operation = NAND_OPERATION(cs, instrs);
    if (!id)
    op.ninstrs--;
    this.controller.ops.exec_op(this, &op, false);
    }
#[no_mangle]
unsafe extern "C" fn doc200x_ident_chip(mtd: *mut mtd_info, nr: c_int) -> uint16_t __init {
...
// First chip probe. See if we get same results by 32-bit access
    ...
    void __iomem *docptr = doc.virtadr;
    doc200x_readid(this, nr, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn doc2000_count_chips(mtd: *mut mtd_info) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn doc2001_write_byte(this: *mut nand_chip, datum: u_char) {
...
#[no_mangle]
unsafe extern "C" fn doc2001_writebuf(this: *mut nand_chip, buf: *const u_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn doc2001_readbuf(this: *mut nand_chip, buf: *mut u_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn doc2001plus_writebuf(this: *mut nand_chip, buf: *const u_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn doc2001plus_readbuf(this: *mut nand_chip, buf: *mut u_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn doc200x_write_control(doc: *mut doc_priv, value: u8) {
...
// 11.4.3 -- 4 NOPs after CSDNControl write
    ...
    let mut addr: u8 = instr.ctx.addr.addrs[i];
    if (DoC_is_2000(doc))
...
#[no_mangle]
unsafe extern "C" fn doc2001plus_write_pipe_term(doc: *mut doc_priv) {
...
#[no_mangle]
unsafe extern "C" fn doc200x_enable_hwecc(this: *mut nand_chip, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn doc2001plus_enable_hwecc(this: *mut nand_chip, mode: c_int) {
...
// This code is only called on write
    ...
    void __iomem *docptr = doc.virtadr;
    int i;
    let mut emptymatch: int __always_unused = 1;
// flush the pipeline
    if (DoC_is_2000(doc)) {
...
#[no_mangle]
unsafe extern "C" fn find_media_headers(mtd: *mut mtd_info, buf: *mut u_char, id: *const c_char, findmirror: c_int) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn nftl_partscan(mtd: *mut mtd_info, parts: *mut mtd_partition) -> int __init {
    ...
    let mut psize: unsigned = 1 << this.page_shift;
    let mut numparts: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn inftl_partscan(mtd: *mut mtd_info, parts: *mut mtd_partition) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nftl_scan_bbt(mtd: *mut mtd_info) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn inftl_scan_bbt(mtd: *mut mtd_info) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn doc2000_init(mtd: *mut mtd_info) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn doc2001_init(mtd: *mut mtd_info) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn doc2001plus_init(mtd: *mut mtd_info) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn doc200x_attach_chip(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn doc_probe(physadr: c_ulong) -> int __init {
    static int __init doc_probe(unsigned long physadr)
    {
    struct nand_chip *nand = core::ptr::null_mut();
    struct doc_priv *doc = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(DOC_ChipID_DocMilPlus16: ChipID ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn release_nanddoc() {
...
#[no_mangle]
unsafe extern "C" fn init_nanddoc() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cleanup_nanddoc() -> void __exit {
