...
//! Source: drivers/mtd/nand/raw/bcm47xxnflash/ops_bcm4706.c
#![no_std]
...
pub const NFLASH_READY_RETRIES: c_int = 10000;
pub const NFLASH_SECTOR_SIZE: c_int = 512;
pub const NCTL_CMD0: c_uint = 0x00010000;
pub const NCTL_COL: c_uint = 0x00020000	/* Update column with value from BCMA_CC_NFLASH_COL_ADDR */;
pub const NCTL_ROW: c_uint = 0x00040000	/* Update row (page) with value from BCMA_CC_NFLASH_ROW_ADDR */;
pub const NCTL_CMD1W: c_uint = 0x00080000;
pub const NCTL_READ: c_uint = 0x00100000;
pub const NCTL_WRITE: c_uint = 0x00200000;
pub const NCTL_SPECADDR: c_uint = 0x01000000;
pub const NCTL_READY: c_uint = 0x04000000;
pub const NCTL_ERR: c_uint = 0x08000000;
pub const NCTL_CSA: c_uint = 0x40000000;
pub const NCTL_START: c_uint = 0x80000000;
//
// Various helpers
//
#[no_mangle]
pub unsafe extern "C" fn bcm47xxnflash_ops_bcm4706_ns_to_cycle(ns: u16, clock: u16) -> u8 {
    static inline u8 bcm47xxnflash_ops_bcm4706_ns_to_cycle(u16 ns, u16 clock)
    {
    return ((ns * 1000 * clock) / 1000000) + 1;
    }
#[no_mangle]
unsafe extern "C" fn bcm47xxnflash_ops_bcm4706_ctl_cmd(cc: *mut bcma_drv_cc, code: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm47xxnflash_ops_bcm4706_poll(cc: *mut bcma_drv_cc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm47xxnflash_ops_bcm4706_dev_ready(nand_chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm47xxnflash_ops_bcm4706_read_byte(nand_chip: *mut nand_chip) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn bcm47xxnflash_ops_bcm4706_init(b47n: *mut bcm47xxnflash) -> c_int {
