...
//! Source: drivers/mtd/nand/raw/nand_onfi.c
#![no_std]
...
pub const ONFI_PARAM_PAGES: c_int = 3;
#[no_mangle]
pub unsafe extern "C" fn onfi_crc16(crc: u16, p: *const u8, len: usize) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn nand_onfi_detect(chip: *mut nand_chip) -> c_int {
    int nand_onfi_detect(struct nand_chip *chip)
    {
    struct nand_device *base = &chip.base;
    struct mtd_info *mtd = nand_to_mtd(chip);
    struct nand_memory_organization *memorg;
    struct nand_onfi_params *p = core::ptr::null_mut(), *pbuf;
    struct onfi_params *onfi;
    let mut use_datain: bool = false;
    let mut onfi_version: c_int = 0;
    char id[4];
    int i, ret, val;
    u16 crc;
...
// Check version
    ...
    onfi_version = 23;
#[no_mangle]
pub unsafe extern "C" fn if(ONFI_VERSION_2_2: val &) -> else {
    else if (val & ONFI_VERSION_2_2)
    onfi_version = 22;
#[no_mangle]
pub unsafe extern "C" fn if(ONFI_VERSION_2_1: val &) -> else {
    else if (val & ONFI_VERSION_2_1)
    onfi_version = 21;
#[no_mangle]
pub unsafe extern "C" fn if(ONFI_VERSION_2_0: val &) -> else {
    else if (val & ONFI_VERSION_2_0)
    onfi_version = 20;
#[no_mangle]
pub unsafe extern "C" fn if(ONFI_VERSION_1_0: val &) -> else {
