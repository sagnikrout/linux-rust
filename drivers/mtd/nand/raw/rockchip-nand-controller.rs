...
//! Source: drivers/mtd/nand/raw/rockchip-nand-controller.c
#![no_std]
...
pub const FMCTL_CE_SEL_M: c_uint = 0xFF;

    (((x) >> (e).high) & (e).high_mask) << (e).low_bn)

pub const NFC_MAX_OOB_PER_STEP: c_int = 128;
pub const NFC_MIN_OOB_PER_STEP: c_int = 64;
pub const MAX_DATA_SIZE: c_uint = 0xFFFC;
pub const MAX_ADDRESS_CYC: c_int = 6;
pub const NFC_ECC_MAX_MODES: c_int = 4;
...
#[derive(Copy, Clone)]
pub struct nfc_cfg {
    pub type: enum nfc_type,
    pub ecc_strengths: [u8; NFC_ECC_MAX_MODES],
    pub ecc_cfgs: [u32; NFC_ECC_MAX_MODES],
    pub flctl_off: u32,
    pub bchctl_off: u32,
    pub dma_cfg_off: u32,
    pub dma_data_buf_off: u32,
    pub dma_oob_buf_off: u32,
    pub dma_st_off: u32,
    pub bch_st_off: u32,
    pub randmz_off: u32,
    pub int_en_off: u32,
    ...
    pub oob0_off: u32,
    pub oob1_off: u32,
    pub ecc0: rk_ecc_cnt_status,
    pub ecc1: rk_ecc_cnt_status,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_nfc_nand_chip {
    pub node: list_head,
    pub chip: nand_chip,
    pub boot_blks: u16,
...
pub struct rk_nfc {
    ...
    pub page_buf: *mut u8,
    pub oob_buf: *mut u32,
    pub page_buf_size: u32,
    pub oob_buf_size: u32,
...
#[no_mangle]
pub unsafe extern "C" fn rk_nfc_data_len(chip: *mut nand_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_hw_ecc_setup(chip: *mut nand_chip, strength: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_select_chip(chip: *mut nand_chip, cs: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn rk_nfc_wait_ioready(nfc: *mut rk_nfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_read_buf(nfc: *mut rk_nfc, buf: *mut u8, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_write_buf(nfc: *mut rk_nfc, buf: *const u8, len: c_int) {
    ...
    let mut reg_offset: c_int = nfc.band_offset;
    u8 *inbuf = core::ptr::null_mut();
    const u8 *outbuf;
    let mut cnt: u32 = 0;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_wait_for_xfer_done(nfc: *mut rk_nfc) -> c_int {
...
// Copy ECC data to the NFC buffer.
    ...
    let mut pages_per_blk: c_int = mtd.erasesize / mtd.writesize;
    let mut ret: c_int = 0, i, boot_rom_mode = 0;
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_write_oob(chip: *mut nand_chip, page: c_int) -> c_int {
    static int rk_nfc_write_oob(struct nand_chip *chip, int page)
    {
    return rk_nfc_write_page_hwecc(chip, core::ptr::null_mut(), 1, page);
    }
...
// Copy data from the NFC buffer.
    ...
    let mut pages_per_blk: c_int = mtd.erasesize / mtd.writesize;
    dma_addr_t dma_data, dma_oob;
    let mut ret: c_int = 0, i, cnt, boot_rom_mode = 0;
    let mut max_bitflips: c_int = 0, bch_st, ecc_fail = 0;
    u8 *oob;
    u32 tmp;
    nand_read_page_op(chip, page, 0, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_read_oob(chip: *mut nand_chip, page: c_int) -> c_int {
    static int rk_nfc_read_oob(struct nand_chip *chip, int page)
    {
    return rk_nfc_read_page_hwecc(chip, core::ptr::null_mut(), 1, page);
    }
#[no_mangle]
pub unsafe extern "C" fn rk_nfc_hw_init(nfc: *mut rk_nfc) {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_irq(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_enable_clks(dev: *mut device, nfc: *mut rk_nfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_disable_clks(nfc: *mut rk_nfc) {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_ecc_init(dev: *mut device, mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_attach_chip(chip: *mut nand_chip) -> c_int {
...
// Check buffer first, avoid duplicate alloc buffer.
    ...
    if (!buf) {
    kfree(nfc.page_buf);
    nfc.page_buf = core::ptr::null_mut();
    return -ENOMEM;
    }
    nfc.oob_buf = buf;
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_chips_cleanup(nfc: *mut rk_nfc) {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_nand_chips_init(dev: *mut device, nfc: *mut rk_nfc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rk_nfc_resume(dev: *mut device) -> int __maybe_unused {
