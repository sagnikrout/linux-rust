...
//! Source: drivers/mtd/nand/qpic_common.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_free_bam_transaction(nandc: *mut qcom_nand_controller) {
...
//
    ...
    size_t bam_txn_size;
    let mut num_cw: c_uint = nandc.max_cwperpage;
    void *bam_txn_buf;
    bam_txn_size =
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_clear_bam_transaction(nandc: *mut qcom_nand_controller) {
    ...
    bam_txn.last_data_desc = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_qpic_bam_dma_done(data: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_nandc_dev_to_mem(nandc: *mut qcom_nand_controller, is_cpu: bool) {
...
//
    ...
    struct dma_async_tx_descriptor *dma_desc;
    let mut slave_conf: dma_slave_config = {0};
    enum dma_transfer_direction dir_eng;
    struct desc_info *desc;
    struct scatterlist *sgl;
    int ret;
...
//
    ...
    {
    let mut flow_control: bool = false;
    void *vaddr;
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_submit_descs(nandc: *mut qcom_nand_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_clear_read_regs(nandc: *mut qcom_nand_controller) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_nandc_unalloc(nandc: *mut qcom_nand_controller) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_nandc_alloc(nandc: *mut qcom_nand_controller) -> c_int {
...
//
    ...
    nandc.tx_chan = core::ptr::null_mut();
    ...
    nandc.rx_chan = core::ptr::null_mut();
    dev_err_probe(nandc.dev, ret,
    ...
    nandc.cmd_chan = core::ptr::null_mut();
    dev_err_probe(nandc.dev, ret,
