...
//! Source: drivers/mtd/nand/spi/foresee.c
#![no_std]
...
pub const SPINAND_MFR_FORESEE: c_uint = 0xCD;
...
#[no_mangle]
unsafe extern "C" fn f35sqa002g_ecc_get_status(spinand: *mut spinand_device, status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f35sqb002g_ecc_get_status(spinand: *mut spinand_device, status: u8) -> c_int {
