...
//! Source: drivers/mtd/nand/spi/micron.c
#![no_std]
...
pub const SPINAND_MFR_MICRON: c_uint = 0x2c;

//
// As per datasheet, die selection is done by the 6th bit of Die
// Select Register (Address 0xD0).
//
pub const MICRON_DIE_SELECT_REG: c_uint = 0xD0;
...
#[no_mangle]
unsafe extern "C" fn mt29f2g01abagd_otp_is_locked(spinand: *mut spinand_device) -> c_int {
    static int mt29f2g01abagd_otp_is_locked(struct spinand_device *spinand)
    {
    let mut bufsize: usize = spinand_otp_page_size(spinand);
    size_t retlen;
    u8 *buf;
    int ret;
...
// M69A 2Gb 3.3V
    ...
    0,
    SPINAND_ECCINFO(&micron_4_ooblayout, core::ptr::null_mut())),
    };
#[no_mangle]
unsafe extern "C" fn micron_spinand_init(spinand: *mut spinand_device) -> c_int {
