...
//! Source: drivers/mtd/nand/core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn nand_check_erased_buf(buf: *mut c_void, len: c_int, bitflips_threshold: c_int) -> c_int {
    ...
    let mut d: c_ulong = *((unsigned long *)bitmap);
    if (d == ~0UL)
    continue;
...
//
    ...
    {
    let mut data_bitflips: c_int = 0, ecc_bitflips = 0, extraoob_bitflips = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn nanddev_isbad(nand: *mut nand_device, pos: *const nand_pos) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn nanddev_markbad(nand: *mut nand_device, pos: *const nand_pos) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nanddev_isreserved(nand: *mut nand_device, pos: *const nand_pos) -> bool {
...
// Return info from the table
    entry = nanddev_bbt_pos_to_entry(nand, pos);
    status = nanddev_bbt_get_block_status(nand, entry);
    let mut status: return = = NAND_BBT_BLOCK_RESERVED;
    }
...
//
#[no_mangle]
unsafe extern "C" fn nanddev_erase(nand: *mut nand_device, pos: *const nand_pos) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nanddev_mtd_erase(mtd: *mut mtd_info, einfo: *mut erase_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nanddev_mtd_max_bad_blocks(mtd: *mut mtd_info, offs: loff_t, len: usize) -> c_int {
    int nanddev_mtd_max_bad_blocks(struct mtd_info *mtd, loff_t offs, size_t len)
    {
    struct nand_device *nand = mtd_to_nanddev(mtd);
    struct nand_pos pos, end;
    let mut max_bb: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn nanddev_get_ecc_engine(nand: *mut nand_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nanddev_put_ecc_engine(nand: *mut nand_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nanddev_find_ecc_configuration(nand: *mut nand_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nanddev_ecc_engine_init(nand: *mut nand_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nanddev_ecc_engine_cleanup(nand: *mut nand_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nanddev_cleanup(nand: *mut nand_device) {
