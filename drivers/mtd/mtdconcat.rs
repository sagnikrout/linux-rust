...
//! Source: drivers/mtd/mtdconcat.c
#![no_std]
...
// retlen += retsize;
    ...
    {
    struct mtd_concat *concat = CONCAT(mtd);
    let mut devops: mtd_oob_ops = *ops;
    int i, err, ret = 0;
...
#[no_mangle]
unsafe extern "C" fn concat_erase(mtd: *mut mtd_info, instr: *mut erase_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn concat_lock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
    static int concat_lock(struct mtd_info *mtd, loff_t ofs, uint64_t len)
    {
    return concat_xxlock(mtd, ofs, len, true);
    }
#[no_mangle]
unsafe extern "C" fn concat_unlock(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
    static int concat_unlock(struct mtd_info *mtd, loff_t ofs, uint64_t len)
    {
    return concat_xxlock(mtd, ofs, len, false);
    }
#[no_mangle]
unsafe extern "C" fn concat_is_locked(mtd: *mut mtd_info, ofs: loff_t, len: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn concat_sync(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn concat_suspend(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn concat_resume(mtd: *mut mtd_info) {
...
#[no_mangle]
unsafe extern "C" fn concat_block_isbad(mtd: *mut mtd_info, ofs: loff_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn concat_block_markbad(mtd: *mut mtd_info, ofs: loff_t) -> c_int {
...
//
    ...
    struct mtd_info *subdev_master = core::ptr::null_mut();
    uint32_t max_erasesize, curr_erasesize;
    int num_erase_region;
    let mut max_writebufsize: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn mtd_concat_destroy(mtd: *mut mtd_info) {
