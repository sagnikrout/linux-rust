...
//! Source: drivers/mtd/spi-nor/macronix.c
#![no_std]
...
pub const MXIC_NOR_OP_RD_CR2: c_uint = 0x71		/* Read configuration register 2 opcode */;
pub const MXIC_NOR_OP_WR_CR2: c_uint = 0x72		/* Write configuration register 2 opcode */;
pub const MXIC_NOR_ADDR_CR2_MODE: c_uint = 0x00000000	/* CR2 address for setting spi/sopi/dopi mode */;
pub const MXIC_NOR_ADDR_CR2_DC: c_uint = 0x00000300	/* CR2 address for setting dummy cycles */;
pub const MXIC_NOR_REG_DOPI_EN: c_uint = 0x2		/* Enable Octal DTR */;
pub const MXIC_NOR_REG_SPI_EN: c_uint = 0x0		/* Enable SPI */;
...
#[no_mangle]
unsafe extern "C" fn macronix_nor_octal_dtr_en(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macronix_nor_octal_dtr_dis(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macronix_nor_set_octal_dtr(nor: *mut spi_nor, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macronix_nor_default_init(nor: *mut spi_nor) {
    static void macronix_nor_default_init(struct spi_nor *nor)
    {
    nor.params.quad_enable = spi_nor_sr1_bit6_quad_enable;
    }
#[no_mangle]
unsafe extern "C" fn macronix_nor_late_init(nor: *mut spi_nor) -> c_int {
