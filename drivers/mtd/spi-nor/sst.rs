...
//! Source: drivers/mtd/spi-nor/sst.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sst26vf_nor_lock(nor: *mut spi_nor, ofs: loff_t, len: u64) -> c_int {
    static int sst26vf_nor_lock(struct spi_nor *nor, loff_t ofs, u64 len)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn sst26vf_nor_unlock(nor: *mut spi_nor, ofs: loff_t, len: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sst26vf_nor_is_locked(nor: *mut spi_nor, ofs: loff_t, len: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sst26vf_nor_late_init(nor: *mut spi_nor) -> c_int {
    ...
    const u_char *buf)
    {
    let mut op: u8 = (len == 1) ? SPINOR_OP_BP : SPINOR_OP_AAI_WP;
    int ret;
...
// Start write from odd address.
    if (to % 2) {
    let mut needs_write_enable: bool = (len > 1);
// write one byte.
...
#[no_mangle]
unsafe extern "C" fn sst_nor_late_init(nor: *mut spi_nor) -> c_int {
