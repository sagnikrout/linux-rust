...
//! Source: drivers/mtd/spi-nor/issi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pm25lv_nor_late_init(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn issi_nor_default_init(nor: *mut spi_nor) {
