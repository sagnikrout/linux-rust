...
pub const SPINOR_OP_MT_DIE_ERASE: c_uint = 0xc4	/* Chip (die) erase opcode */;
pub const SPINOR_OP_RDFSR: c_uint = 0x70	/* Read flag status register */;
pub const SPINOR_OP_CLFSR: c_uint = 0x50	/* Clear flag status register */;
pub const SPINOR_OP_MT_DTR_RD: c_uint = 0xfd	/* Fast Read opcode in DTR mode */;
pub const SPINOR_OP_MT_RD_ANY_REG: c_uint = 0x85	/* Read volatile register */;
pub const SPINOR_OP_MT_WR_ANY_REG: c_uint = 0x81	/* Write volatile register */;
pub const SPINOR_REG_MT_CFR0V: c_uint = 0x00	/* For setting octal DTR mode */;
pub const SPINOR_REG_MT_CFR1V: c_uint = 0x01	/* For setting dummy cycles */;
pub const SPINOR_REG_MT_CFR1V_DEF: c_uint = 0x1f	/* Default dummy cycles */;
pub const SPINOR_MT_OCT_DTR: c_uint = 0xe7	/* Enable Octal DTR. */;
pub const SPINOR_MT_EXSPI: c_uint = 0xff	/* Enable Extended SPI (default) */;
...
// Micron ST SPI NOR flash operations.
    ...
    SPI_MEM_OP_NO_DATA)
#[no_mangle]
unsafe extern "C" fn micron_st_nor_octal_dtr_en(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micron_st_nor_octal_dtr_dis(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micron_st_nor_set_octal_dtr(nor: *mut spi_nor, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micron_st_nor_four_die_late_init(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micron_st_nor_two_die_late_init(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt35xu512aba_post_sfdp_fixup(nor: *mut spi_nor) -> c_int {
...
// disable it.
//
    nor.params.quad_enable = core::ptr::null_mut();
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn micron_st_nor_read_fsr(nor: *mut spi_nor, fsr: *mut u8) -> c_int {
    static int micron_st_nor_read_fsr(struct spi_nor *nor, u8 *fsr)
    {
    int ret;
    if (nor.spimem) {
    let mut op: spi_mem_op = MICRON_ST_RDFSR_OP(fsr);
...
//
#[no_mangle]
unsafe extern "C" fn micron_st_nor_clear_fsr(nor: *mut spi_nor) {
    static void micron_st_nor_clear_fsr(struct spi_nor *nor)
    {
    int ret;
    if (nor.spimem) {
    let mut op: spi_mem_op = MICRON_ST_CLFSR_OP;
    spi_nor_spimem_setup_op(nor, &op, nor.reg_proto);
    ret = spi_mem_exec_op(nor.spimem, &op);
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn micron_st_nor_ready(nor: *mut spi_nor) -> c_int {
...
//
    let mut ret: return = = -EOPNOTSUPP ? sr_ready : ret;
    }
...
#[no_mangle]
unsafe extern "C" fn micron_st_nor_default_init(nor: *mut spi_nor) {
...
#[no_mangle]
unsafe extern "C" fn micron_st_nor_late_init(nor: *mut spi_nor) -> c_int {
