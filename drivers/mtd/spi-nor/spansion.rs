...
//! Source: drivers/mtd/spi-nor/spansion.c
#![no_std]
...
pub const SPINOR_OP_CLSR: c_uint = 0x30	/* Clear status register 1 */;
pub const SPINOR_OP_CLPEF: c_uint = 0x82	/* Clear program/erase failure flags */;
pub const SPINOR_OP_CYPRESS_EX4B: c_uint = 0xB8	/* Exit 4-byte address mode */;
pub const SPINOR_OP_CYPRESS_DIE_ERASE: c_uint = 0x61	/* Chip (die) erase */;
pub const SPINOR_OP_RD_ANY_REG: c_uint = 0x65	/* Read any register */;
pub const SPINOR_OP_WR_ANY_REG: c_uint = 0x71	/* Write any register */;
pub const SPINOR_REG_CYPRESS_VREG: c_uint = 0x00800000;
pub const SPINOR_REG_CYPRESS_STR1: c_uint = 0x0;

    (SPINOR_REG_CYPRESS_VREG + SPINOR_REG_CYPRESS_STR1)
pub const SPINOR_REG_CYPRESS_CFR1: c_uint = 0x2;

pub const SPINOR_REG_CYPRESS_CFR2: c_uint = 0x3;

    (SPINOR_REG_CYPRESS_VREG + SPINOR_REG_CYPRESS_CFR2)

pub const SPINOR_REG_CYPRESS_CFR2_MEMLAT_11_24: c_uint = 0xb;

pub const SPINOR_REG_CYPRESS_CFR3: c_uint = 0x4;

pub const SPINOR_REG_CYPRESS_CFR5: c_uint = 0x6;

    (SPINOR_REG_CYPRESS_CFR5_BIT6 |	SPINOR_REG_CYPRESS_CFR5_DDR |	\
    SPINOR_REG_CYPRESS_CFR5_OPI)

pub const SPINOR_OP_CYPRESS_RD_FAST: c_uint = 0xee;
pub const SPINOR_REG_CYPRESS_ARCFN: c_uint = 0x00000006;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spansion_nor_params {
    pub clsr: u8,
}
...
//
#[no_mangle]
unsafe extern "C" fn spansion_nor_clear_sr(nor: *mut spi_nor) {
    static void spansion_nor_clear_sr(struct spi_nor *nor)
    {
    const struct spansion_nor_params *priv_params = nor.params.priv;
    int ret;
    if (nor.spimem) {
    let mut op: spi_mem_op = SPANSION_OP(priv_params.clsr);
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_sr_ready_and_clear_reg(nor: *mut spi_nor, addr: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cypress_nor_sr_ready_and_clear(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_set_memlat(nor: *mut spi_nor, addr: u64) -> c_int {
    static int cypress_nor_set_memlat(struct spi_nor *nor, u64 addr)
    {
    struct spi_mem_op op;
    u8 *buf = nor.bouncebuf;
    int ret;
    let mut addr_mode_nbytes: u8 = nor.params.addr_mode_nbytes;
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_set_octal_dtr_bits(nor: *mut spi_nor, addr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_octal_dtr_en(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_set_single_spi_bits(nor: *mut spi_nor, addr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_octal_dtr_dis(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_quad_enable_volatile_reg(nor: *mut spi_nor, addr: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cypress_nor_quad_enable_volatile(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_set_4byte_addr_mode(nor: *mut spi_nor, enable: bool) -> c_int {
    static int cypress_nor_set_4byte_addr_mode(struct spi_nor *nor, bool enable)
    {
    int ret;
    let mut op: spi_mem_op = CYPRESS_NOR_EN4B_EX4B_OP(enable);
    spi_nor_spimem_setup_op(nor, &op, nor.reg_proto);
    ret = spi_mem_exec_op(nor.spimem, &op);
    if (ret)
...
//
#[no_mangle]
unsafe extern "C" fn cypress_nor_set_addr_mode_nbytes(nor: *mut spi_nor) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cypress_nor_get_page_size(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cypress_nor_ecc_init(nor: *mut spi_nor) {
...
#[no_mangle]
unsafe extern "C" fn s25fs256t_post_sfdp_fixup(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s25fs256t_late_init(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s25hx_t_post_sfdp_fixup(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s25hx_t_late_init(nor: *mut spi_nor) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cypress_nor_set_octal_dtr(nor: *mut spi_nor, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s28hx_t_post_sfdp_fixup(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s28hx_t_late_init(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s25fs_s_nor_smpt_map_id_dummy(nor: *const spi_nor, map_id: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn spansion_nor_sr_ready_and_clear(nor: *mut spi_nor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spansion_nor_late_init(nor: *mut spi_nor) -> c_int {
    static int spansion_nor_late_init(struct spi_nor *nor)
    {
    struct spi_nor_flash_parameter *params = nor.params;
    struct spansion_nor_params *priv_params;
    let mut mfr_flags: u8 = nor.info.mfr_flags;
...
#[no_mangle]
pub unsafe extern "C" fn if(USE_CLPEF: mfr_flags &) -> else {
