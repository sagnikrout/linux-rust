...
//
#[no_mangle]
pub unsafe extern "C" fn free_partition(mtd: *mut mtd_info) {
...
#[no_mangle]
pub unsafe extern "C" fn release_mtd_partition(mtd: *mut mtd_info) {
...
// Deal with variable erase size stuff
    ...
    let mut end: u64 = child.part.offset + child.part.size;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mtd_block_isbad(child, _arg: offs)) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtd_add_partition_attrs(new: *mut mtd_info) -> c_int {
    static int mtd_add_partition_attrs(struct mtd_info *new)
    {
    let mut ret: c_int = sysfs_create_files(&new.dev.kobj, mtd_partition_attrs);
    if (ret)
    printk(KERN_WARNING
...
//
#[no_mangle]
unsafe extern "C" fn __mtd_del_partition(mtd: *mut mtd_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __del_mtd_partitions(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn del_mtd_partitions(mtd: *mut mtd_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mtd_del_partition(mtd: *mut mtd_info, partno: c_int) -> c_int {
...
// Look for subpartitions (skip if no maching parser found)
    ret = parse_mtd_partitions(child, parts[i].types, core::ptr::null_mut());
    if (ret < 0 && ret == -ENOENT) {
    ...
    {
    struct mtd_part_parser *p, *ret = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mtd_part_parser_put(p: *const mtd_part_parser) {
...
#[no_mangle]
pub unsafe extern "C" fn __register_mtd_parser(p: *mut mtd_part_parser, owner: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn deregister_mtd_parser(p: *mut mtd_part_parser) {
...
//
    ...
    if (!parser)
    continue;
    ret = mtd_part_do_parse(parser, master, pparts, core::ptr::null_mut());
    if (ret > 0) {
    of_platform_populate(np, core::ptr::null_mut(), core::ptr::null_mut(), dev);
    of_node_put(np);
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mtd_part_parser_cleanup(parts: *mut mtd_partitions) {
...
#[no_mangle]
pub unsafe extern "C" fn mtd_get_device_size(mtd: *const mtd_info) -> u64 {
