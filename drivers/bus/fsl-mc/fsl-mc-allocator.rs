...
//! Source: drivers/bus/fsl-mc/fsl-mc-allocator.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_is_allocatable(mc_dev: *mut fsl_mc_device) -> bool __must_check {
...
//
    ...
    mc_dev.resource = core::ptr::null_mut();
    error = 0;
    out_unlock:
    mutex_unlock(&res_pool.mutex);
    out:
...
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_resource_free(resource: *mut fsl_mc_resource) {
...
//
    ...
    let mut error: c_int = -EINVAL;
    struct fsl_mc_resource *resource = core::ptr::null_mut();
// new_mc_adev = NULL;
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_object_free(mc_adev: *mut fsl_mc_device) {
    ...
    return;
    fsl_mc_resource_free(resource);
    mc_adev.consumer_link = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_cleanup_irq_pool(mc_bus_dev: *mut fsl_mc_device) {
    ...
    mc_bus.irq_resources = core::ptr::null_mut();
    fsl_mc_msi_domain_free_irqs(&mc_bus_dev.dev);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_allocate_irqs(mc_dev: *mut fsl_mc_device) -> int __must_check {
    int __must_check fsl_mc_allocate_irqs(struct fsl_mc_device *mc_dev)
    {
    int i;
    int irq_count;
    let mut res_allocated_count: c_int = 0;
    let mut error: c_int = -EINVAL;
    struct fsl_mc_device_irq **irqs = core::ptr::null_mut();
    struct fsl_mc_bus *mc_bus;
    struct fsl_mc_resource_pool *res_pool;
    if (mc_dev.irqs)
    return -EINVAL;
    ...
    irqs[i].mc_dev = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_free_irqs(mc_dev: *mut fsl_mc_device) {
    ...
    mc_dev.irqs = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(fsl_mc_free_irqs);
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_init_all_resource_pools(mc_bus_dev: *mut fsl_mc_device) {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_mc_allocator_probe(mc_dev: *mut fsl_mc_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_mc_allocator_remove(mc_dev: *mut fsl_mc_device) {
...
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_allocator_driver_init() -> int __init {
