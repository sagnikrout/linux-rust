...
//! Source: drivers/bus/fsl-mc/mc-sys.c
#![no_std]
...
//
pub const MC_CMD_COMPLETION_TIMEOUT_MS: c_int = 15000;
//
// usleep_range() min and max values used to throttle down polling
// iterations while waiting for MC command completion
//
pub const MC_CMD_COMPLETION_POLLING_MIN_SLEEP_USECS: c_int = 10;
pub const MC_CMD_COMPLETION_POLLING_MAX_SLEEP_USECS: c_int = 500;
#[no_mangle]
unsafe extern "C" fn mc_cmd_hdr_read_status(cmd: *mut fsl_mc_command) -> enum mc_cmd_status {
...
#[no_mangle]
pub unsafe extern "C" fn mc_cmd_hdr_read_cmdid(cmd: *mut fsl_mc_command) -> u16 {
    u16 mc_cmd_hdr_read_cmdid(struct fsl_mc_command *cmd)
    {
    struct mc_cmd_header *hdr = (struct mc_cmd_header *)&cmd.header;
    let mut cmd_id: u16 = le16_to_cpu(hdr.cmd_id);
    return cmd_id;
    }
#[no_mangle]
unsafe extern "C" fn mc_status_to_error(status: enum mc_cmd_status) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mc_send_command(mc_io: *mut fsl_mc_io, cmd: *mut fsl_mc_command) -> c_int {
