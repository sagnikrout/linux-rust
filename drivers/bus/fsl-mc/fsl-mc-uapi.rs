...
//! Source: drivers/bus/fsl-mc/fsl-mc-uapi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uapi_priv_data {
    pub uapi: *mut fsl_mc_uapi,
    pub mc_io: *mut fsl_mc_io,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_mc_cmd_desc {
    pub cmdid_value: u16,
    pub cmdid_mask: u16,
    pub size: c_int,
    pub token: bool,
...
pub const FSL_MC_MAX_MODULE_ID: c_uint = 0x10;
    static int fsl_mc_command_check(struct fsl_mc_device *mc_dev,
    struct fsl_mc_command *mc_cmd)
    {
    struct fsl_mc_cmd_desc *desc = core::ptr::null_mut();
    int mc_cmd_max_size, i;
    bool token_provided;
    u16 cmdid, module_id;
    char *mc_cmd_end;
    let mut sum: c_char = 0;
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_uapi_dev_open(inode: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_uapi_dev_release(inode: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_uapi_create_device_file(mc_bus: *mut fsl_mc_bus) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_uapi_remove_device_file(mc_bus: *mut fsl_mc_bus) {
