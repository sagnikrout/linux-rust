...
//! Source: drivers/bus/fsl-mc/obj-api.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_get_open_cmd_id(type: *const c_char) -> c_int {
    ...
    let mut err: c_int = 0;
    let mut cmd_id: c_int = fsl_mc_get_open_cmd_id(obj_type);
    if (cmd_id == -1)
    return -ENODEV;
// prepare command
