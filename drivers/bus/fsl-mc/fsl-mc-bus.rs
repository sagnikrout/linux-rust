...
#[derive(Copy, Clone)]
pub struct fsl_mc {
    pub root_mc_bus_dev: *mut fsl_mc_device,
    pub num_translation_ranges: u8,
    pub translation_ranges: *mut fsl_mc_addr_translation_range,
    pub fsl_mc_regs: *mut void __iomem,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_mc_addr_translation_range {
    pub mc_region_type: enum dprc_region_type,
    pub start_mc_offset: u64,
    pub end_mc_offset: u64,
    pub start_phys_addr: phys_addr_t,
}

pub const FSL_MC_GCR1: c_uint = 0x0;

pub const FSL_MC_GSR: c_uint = 0x8;

pub const FSL_MC_GSR_BC_SHIFT: c_int = 8;
pub const FSL_MC_FAPR: c_uint = 0x28;
...
//
#[no_mangle]
unsafe extern "C" fn fsl_mc_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_mc_bus_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_shutdown(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_dma_configure(dev: *mut device) -> c_int {
    static int fsl_mc_dma_configure(struct device *dev)
    {
    const struct device_driver *drv = READ_ONCE(dev.driver);
    struct device *dma_dev = dev;
    struct fsl_mc_device *mc_dev = to_fsl_mc_device(dev);
    let mut input_id: u32 = mc_dev.icid;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_dma_cleanup(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn scan_fsl_mc_bus(dev: *mut device, data: *mut c_void) -> c_int {
    ...
    return -EINVAL;
    if (val)
    bus_for_each_dev(bus, core::ptr::null_mut(), core::ptr::null_mut(), scan_fsl_mc_bus);
    return count;
    }
    static BUS_ATTR_WO(rescan);
#[no_mangle]
unsafe extern "C" fn fsl_mc_bus_set_autorescan(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_bus_get_autorescan(dev: *mut device, data: *mut c_void) -> c_int {
    ...
    const char *buf, size_t count)
    {
    bus_for_each_dev(bus, core::ptr::null_mut(), (void *)buf, fsl_mc_bus_set_autorescan);
    return count;
    }
#[no_mangle]
unsafe extern "C" fn autorescan_show(bus: *const bus_type, buf: *mut c_char) -> isize {
    static ssize_t autorescan_show(const struct bus_type *bus, char *buf)
    {
    bus_for_each_dev(bus, core::ptr::null_mut(), (void *)buf, fsl_mc_bus_get_autorescan);
    return strlen(buf);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_driver_unregister(mc_driver: *mut fsl_mc_driver) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_is_root_dprc(dev: *mut device) -> bool {
    ...
    if (!root_dprc_dev)
    return false;
    let mut dev: return = = root_dprc_dev;
    }
#[no_mangle]
unsafe extern "C" fn fsl_mc_device_release(dev: *mut device) {
...
//
    ...
    {
    int error;
    struct fsl_mc_device *mc_dev = core::ptr::null_mut();
    struct fsl_mc_bus *mc_bus = core::ptr::null_mut();
    struct fsl_mc_device *parent_mc_dev;
    if (dev_is_fsl_mc(parent_dev))
    parent_mc_dev = to_fsl_mc_device(parent_dev);
    else
    parent_mc_dev = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_device_remove(mc_dev: *mut fsl_mc_device) {
...
//
    ...
    let mut endpoint_desc: fsl_mc_obj_desc = {{ 0 }};
    let mut endpoint1: dprc_endpoint = {{ 0 }};
    let mut endpoint2: dprc_endpoint = {{ 0 }};
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_read_gsr(mc: *mut fsl_mc) -> u32 {
    static u32 fsl_mc_read_gsr(struct fsl_mc *mc)
    {
    return readl(mc.fsl_mc_regs + FSL_MC_GSR);
    }
#[no_mangle]
unsafe extern "C" fn fsl_mc_firmware_check(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_mc_bus_probe(pdev: *mut platform_device) -> c_int {
    static int fsl_mc_bus_probe(struct platform_device *pdev)
    {
    struct fsl_mc_obj_desc obj_desc;
    int error;
    struct fsl_mc *mc;
    struct fsl_mc_device *mc_bus_dev = core::ptr::null_mut();
    struct fsl_mc_io *mc_io = core::ptr::null_mut();
    int container_id;
...
//
    ...
    mc_portal_size, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn fsl_mc_bus_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_bus_driver_init() -> int __init {
