...
//! Source: drivers/bus/fsl-mc/mc-io.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fsl_mc_io_unset_dpmcp(mc_io: *mut fsl_mc_io) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_destroy_mc_io(mc_io: *mut fsl_mc_io) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_mc_portal_free(mc_io: *mut fsl_mc_io) {
...
//
    ...
    fsl_destroy_mc_io(mc_io);
    fsl_mc_resource_free(resource);
    dpmcp_dev.consumer_link = core::ptr::null_mut();
    }
