...
//! Source: drivers/bus/qcom-ebi2.c
#![no_std]
...
pub const EBI2_XMEM_CFG: c_uint = 0x0000 /* Power management etc */;
//
// SLOW CSn CFG
//
...
// so 1 thru 16 cycles.
//
pub const EBI2_XMEM_CS0_SLOW_CFG: c_uint = 0x0008;
pub const EBI2_XMEM_CS1_SLOW_CFG: c_uint = 0x000C;
pub const EBI2_XMEM_CS2_SLOW_CFG: c_uint = 0x0010;
pub const EBI2_XMEM_CS3_SLOW_CFG: c_uint = 0x0014;
pub const EBI2_XMEM_CS4_SLOW_CFG: c_uint = 0x0018;
pub const EBI2_XMEM_CS5_SLOW_CFG: c_uint = 0x001C;
pub const EBI2_XMEM_RECOVERY_SHIFT: c_int = 28;
pub const EBI2_XMEM_WR_HOLD_SHIFT: c_int = 24;
pub const EBI2_XMEM_WR_DELTA_SHIFT: c_int = 16;
pub const EBI2_XMEM_RD_DELTA_SHIFT: c_int = 8;
pub const EBI2_XMEM_WR_WAIT_SHIFT: c_int = 4;
pub const EBI2_XMEM_RD_WAIT_SHIFT: c_int = 0;
//
// FAST CSn CFG
// Bits 31-28: ?
...
//
pub const EBI2_XMEM_CS0_FAST_CFG: c_uint = 0x0028;
pub const EBI2_XMEM_CS1_FAST_CFG: c_uint = 0x002C;
pub const EBI2_XMEM_CS2_FAST_CFG: c_uint = 0x0030;
pub const EBI2_XMEM_CS3_FAST_CFG: c_uint = 0x0034;
pub const EBI2_XMEM_CS4_FAST_CFG: c_uint = 0x0038;
pub const EBI2_XMEM_CS5_FAST_CFG: c_uint = 0x003C;
pub const EBI2_XMEM_RD_HOLD_SHIFT: c_int = 24;
pub const EBI2_XMEM_ADV_OE_RECOVERY_SHIFT: c_int = 16;
pub const EBI2_XMEM_ADDR_HOLD_ENA_SHIFT: c_int = 5;
//
...
#[no_mangle]
unsafe extern "C" fn qcom_ebi2_probe(pdev: *mut platform_device) -> c_int {
