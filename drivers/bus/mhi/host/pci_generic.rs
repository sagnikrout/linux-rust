...
//! Source: drivers/bus/mhi/host/pci_generic.c
#![no_std]
...
pub const MHI_PCI_DEFAULT_BAR_NUM: c_int = 0;
pub const MHI_POST_RESET_DELAY_MS: c_int = 2000;

// PCI VID definitions
pub const PCI_VENDOR_ID_THALES: c_uint = 0x1269;
pub const PCI_VENDOR_ID_QUECTEL: c_uint = 0x1eac;
pub const PCI_VENDOR_ID_NETPRISMA: c_uint = 0x203e;
pub const MHI_EDL_DB: c_int = 91;
pub const MHI_EDL_COOKIE: c_uint = 0xEDEDEDED;
//
...
pub struct mhi_pci_dev_info {
    ...
    pub fw: *const c_char,
    pub edl: *const c_char,
    pub edl_trigger: bool,
    pub bar_num: c_uint,
    pub dma_data_width: c_uint,
    pub vf_dma_data_width: c_uint,
    pub mru_default: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mhi_pci_device {
    pub mhi_cntrl: mhi_controller,
    pub pci_state: *mut pci_saved_state,
    pub recovery_work: work_struct,
    pub health_check_timer: timer_list,
    pub status: c_ulong,
    pub reset_on_remove: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_wake_get_nop(mhi_cntrl: *mut mhi_controller, force: bool) {
    static void mhi_pci_wake_get_nop(struct mhi_controller *mhi_cntrl, bool force)
    {
// no-op
    }
#[no_mangle]
unsafe extern "C" fn mhi_pci_wake_put_nop(mhi_cntrl: *mut mhi_controller, override: bool) {
    static void mhi_pci_wake_put_nop(struct mhi_controller *mhi_cntrl, bool override)
    {
// no-op
    }
#[no_mangle]
unsafe extern "C" fn mhi_pci_wake_toggle_nop(mhi_cntrl: *mut mhi_controller) {
    static void mhi_pci_wake_toggle_nop(struct mhi_controller *mhi_cntrl)
    {
// no-op
    }
#[no_mangle]
unsafe extern "C" fn mhi_pci_is_alive(mhi_cntrl: *mut mhi_controller) -> bool {
...
// Patch msi vectors, use only one (shared)
    ...
    let mut vector: c_int = i >= nr_vectors ? (nr_vectors - 1) : i;
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_runtime_get(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_runtime_put(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_recovery_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn health_check(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_generic_edl_trigger(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_reset_prepare(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_reset_done(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_io_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_runtime_suspend(dev: *mut device) -> int  __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_suspend(dev: *mut device) -> int  __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_freeze(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mhi_pci_restore(dev: *mut device) -> int __maybe_unused {
...
// Reinitialize the device
    ...
    SET_RUNTIME_PM_OPS(mhi_pci_runtime_suspend, mhi_pci_runtime_resume, core::ptr::null_mut())
