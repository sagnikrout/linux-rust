...
//! Source: drivers/bus/mhi/host/main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ring_er_db(mhi_event: *mut mhi_event) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ring_cmd_db(mhi_cntrl: *mut mhi_controller, mhi_cmd: *mut mhi_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_get_exec_env(mhi_cntrl: *mut mhi_controller) -> enum mhi_ee_type {
    enum mhi_ee_type mhi_get_exec_env(struct mhi_controller *mhi_cntrl)
    {
    u32 exec;
    let mut ret: c_int = mhi_read_reg(mhi_cntrl, mhi_cntrl.bhi, BHI_EXECENV, &exec);
    return (ret) ? MHI_EE_MAX : exec;
    }
    EXPORT_SYMBOL_GPL(mhi_get_exec_env);
#[no_mangle]
pub unsafe extern "C" fn mhi_get_mhi_state(mhi_cntrl: *mut mhi_controller) -> enum mhi_state {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_soc_reset(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
unsafe extern "C" fn is_valid_ring_ptr(ring: *mut mhi_ring, addr: dma_addr_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_destroy_device(dev: *mut device, data: *mut c_void) -> c_int {
    int mhi_destroy_device(struct device *dev, void *data)
    {
    struct mhi_chan *ul_chan, *dl_chan;
    struct mhi_device *mhi_dev;
    struct mhi_controller *mhi_cntrl;
    let mut ee: enum mhi_ee_type = MHI_EE_MAX;
...
#[no_mangle]
pub unsafe extern "C" fn mhi_notify(mhi_dev: *mut mhi_device, cb_reason: enum mhi_callback) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_create_devices(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_irq_handler(irq_number: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_intvec_threaded_handler(irq_number: c_int, priv: *mut c_void) -> irqreturn_t {
    irqreturn_t mhi_intvec_threaded_handler(int irq_number, void *priv)
    {
    struct mhi_controller *mhi_cntrl = priv;
    struct device *dev = &mhi_cntrl.mhi_dev.dev;
    enum mhi_state state;
    let mut pm_state: enum mhi_pm_state = 0;
    enum mhi_ee_type ee;
...
#[no_mangle]
pub unsafe extern "C" fn mhi_intvec_handler(irq_number: c_int, dev: *mut c_void) -> irqreturn_t {
...
//
    ...
    case MHI_EV_CC_EOT:
    {
    let mut ptr: dma_addr_t = MHI_TRE_GET_EV_PTR(event);
...
//
    ...
    {
    let mut ptr: dma_addr_t = MHI_TRE_GET_EV_PTR(tre);
    ...
    let mut ptr: dma_addr_t = le64_to_cpu(er_ctxt.rp);
//
...
//
    ...
    let mut type: enum mhi_pkt_type = MHI_TRE_GET_EV_TYPE(local_rp);
    ...
    {
    let mut st: enum dev_st_transition = DEV_ST_TRANSITION_MAX;
    let mut event: enum mhi_ee_type = MHI_TRE_GET_EV_EXECENV(local_rp);
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ev_task(data: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ctrl_ev_task(data: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_queue_is_full(mhi_dev: *mut mhi_device, dir: enum dma_data_direction) -> bool {
    ...
    {
    struct mhi_ring_element *cmd_tre = core::ptr::null_mut();
...
// queue to hardware
    ...
    let mut cmd: enum mhi_cmd_type = MHI_CMD_NOP;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn mhi_reset_chan(mhi_cntrl: *mut mhi_controller, mhi_chan: *mut mhi_chan) {
    void mhi_reset_chan(struct mhi_controller *mhi_cntrl, struct mhi_chan *mhi_chan)
    {
    struct mhi_event *mhi_event;
    struct mhi_event_ctxt *er_ctxt;
    let mut chan: c_int = mhi_chan.chan;
...
#[no_mangle]
unsafe extern "C" fn __mhi_prepare_for_transfer(mhi_dev: *mut mhi_device, flags: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_prepare_for_transfer(mhi_dev: *mut mhi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_unprepare_from_transfer(mhi_dev: *mut mhi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_get_channel_doorbell_offset(mhi_cntrl: *mut mhi_controller, chdb_offset: *mut u32) -> c_int {
