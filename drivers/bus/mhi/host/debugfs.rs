...
//! Source: drivers/bus/mhi/host/debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_states_show(m: *mut seq_file, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_events_show(m: *mut seq_file, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_channels_show(m: *mut seq_file, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_device_info_show(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_devices_show(m: *mut seq_file, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_regdump_show(m: *mut seq_file, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_device_wake_show(m: *mut seq_file, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_timeout_ms_show(m: *mut seq_file, d: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_states_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_events_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_channels_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_devices_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_regdump_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_device_wake_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_debugfs_timeout_ms_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_create_debugfs(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_destroy_debugfs(mhi_cntrl: *mut mhi_controller) {
    void mhi_destroy_debugfs(struct mhi_controller *mhi_cntrl)
    {
    debugfs_remove_recursive(mhi_cntrl.debugfs_dentry);
    mhi_cntrl.debugfs_dentry = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn mhi_debugfs_init() {
    void mhi_debugfs_init(void)
    {
    mhi_debugfs_root = debugfs_create_dir(mhi_bus_type.name, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn mhi_debugfs_exit() {
