...
//! Source: drivers/bus/mhi/host/pm.c
#![no_std]
...
// L3 States
    ...
    {
    let mut cur_state: c_ulong = mhi_cntrl.pm_state;
    let mut index: c_int = find_last_bit(&cur_state, 32);
...
#[no_mangle]
pub unsafe extern "C" fn mhi_set_mhi_state(mhi_cntrl: *mut mhi_controller, state: enum mhi_state) {
...
#[no_mangle]
unsafe extern "C" fn mhi_toggle_dev_wake_nop(mhi_cntrl: *mut mhi_controller) {
    static void mhi_toggle_dev_wake_nop(struct mhi_controller *mhi_cntrl)
    {
    }
#[no_mangle]
unsafe extern "C" fn mhi_toggle_dev_wake(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ready_state_transition(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_pm_m0_transition(mhi_cntrl: *mut mhi_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mhi_pm_m1_transition(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_pm_m3_transition(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_pm_mission_mode_transition(mhi_cntrl: *mut mhi_controller) -> c_int {
    static int mhi_pm_mission_mode_transition(struct mhi_controller *mhi_cntrl)
    {
    struct mhi_event *mhi_event;
    struct device *dev = &mhi_cntrl.mhi_dev.dev;
    let mut ee: enum mhi_ee_type = MHI_EE_MAX, current_ee = mhi_cntrl.ee;
    int i, ret;
...
//
    ...
    device_for_each_child(&mhi_cntrl.mhi_dev.dev, core::ptr::null_mut(), mhi_destroy_device);
    }
    mutex_lock(&mhi_cntrl.pm_mutex);
...
#[no_mangle]
unsafe extern "C" fn mhi_pm_sys_error_transition(mhi_cntrl: *mut mhi_controller) {
    ...
    struct mhi_event_ctxt *er_ctxt;
    struct device *dev = &mhi_cntrl.mhi_dev.dev;
    let mut reset_device: bool = false;
    int ret, i;
...
//
    let mut cur_state: enum mhi_state = mhi_get_mhi_state(mhi_cntrl);
    let mut cur_ee: enum mhi_ee_type = mhi_get_exec_env(mhi_cntrl);
    if (cur_state == MHI_STATE_SYS_ERR)
    reset_device = true;
#[no_mangle]
pub unsafe extern "C" fn if(MHI_EE_SBL: cur_ee != MHI_EE_PBL && cur_ee !=) -> else {
...
// SYS_ERR worker
#[no_mangle]
pub unsafe extern "C" fn mhi_pm_sys_err_handler(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_pm_st_worker(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_pm_suspend(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mhi_pm_resume(mhi_cntrl: *mut mhi_controller, force: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_pm_resume(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_pm_resume_force(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __mhi_device_get_sync(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_assert_dev_wake(mhi_cntrl: *mut mhi_controller, force: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_async_power_up(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_power_down(mhi_cntrl: *mut mhi_controller, graceful: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_sync_power_up(mhi_cntrl: *mut mhi_controller) -> c_int {
    int mhi_sync_power_up(struct mhi_controller *mhi_cntrl)
    {
    let mut ret: c_int = mhi_async_power_up(mhi_cntrl);
    u32 timeout_ms;
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn mhi_force_rddm_mode(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_device_get_sync(mhi_dev: *mut mhi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_device_put(mhi_dev: *mut mhi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_uevent_notify(mhi_cntrl: *mut mhi_controller, ee: enum mhi_ee_type) {
