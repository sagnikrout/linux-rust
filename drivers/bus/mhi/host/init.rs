...
//! Source: drivers/bus/mhi/host/init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mhi_deinit_free_irq(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
unsafe extern "C" fn mhi_init_irq_setup(mhi_cntrl: *mut mhi_controller) -> c_int {
    static int mhi_init_irq_setup(struct mhi_controller *mhi_cntrl)
    {
    struct mhi_event *mhi_event = mhi_cntrl.mhi_event;
    let mut irq_flags: c_ulong = IRQF_SHARED | IRQF_NO_SUSPEND;
    int i, ret;
...
#[no_mangle]
unsafe extern "C" fn mhi_deinit_dev_ctxt(mhi_cntrl: *mut mhi_controller) {
    ...
    kfree(mhi_ctxt);
    mhi_cntrl.mhi_ctxt = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mhi_init_dev_ctxt(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_init_mmio(mhi_cntrl: *mut mhi_controller) -> c_int {
...
// Write to MMIO registers
    ...
    vfree(buf_ring.base);
    buf_ring.base = tre_ring.base = core::ptr::null_mut();
    tre_ring.ctxt_wp = core::ptr::null_mut();
    chan_ctxt.rbase = 0;
    chan_ctxt.rlen = 0;
    chan_ctxt.rp = 0;
    chan_ctxt.wp = 0;
...
#[no_mangle]
pub unsafe extern "C" fn mhi_unregister_controller(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_free_controller(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_prepare_for_power_up(mhi_cntrl: *mut mhi_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_unprepare_after_power_down(mhi_cntrl: *mut mhi_controller) {
    void mhi_unprepare_after_power_down(struct mhi_controller *mhi_cntrl)
    {
    if (mhi_cntrl.fbc_image) {
    mhi_free_bhie_table(mhi_cntrl, mhi_cntrl.fbc_image);
    mhi_cntrl.fbc_image = core::ptr::null_mut();
    }
    if (mhi_cntrl.rddm_image) {
    mhi_free_bhie_table(mhi_cntrl, mhi_cntrl.rddm_image);
    mhi_cntrl.rddm_image = core::ptr::null_mut();
    }
    mhi_cntrl.bhi = core::ptr::null_mut();
    mhi_cntrl.bhie = core::ptr::null_mut();
    mhi_deinit_dev_ctxt(mhi_cntrl);
    }
    EXPORT_SYMBOL_GPL(mhi_unprepare_after_power_down);
#[no_mangle]
unsafe extern "C" fn mhi_release_device(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn mhi_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_remove(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn __mhi_driver_register(mhi_drv: *mut mhi_driver, owner: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_driver_unregister(mhi_drv: *mut mhi_driver) {
...
#[no_mangle]
unsafe extern "C" fn mhi_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mhi_exit() -> void __exit {
