...
//! Source: drivers/bus/mhi/host/boot.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __mhi_download_rddm_in_panic(mhi_cntrl: *mut mhi_controller) -> c_int {
    static int __mhi_download_rddm_in_panic(struct mhi_controller *mhi_cntrl)
    {
    int ret;
    u32 rx_status;
    enum mhi_ee_type ee;
    let mut delayus: u32 = 2000;
    let mut retry: u32 = (mhi_cntrl.timeout_ms * 1000) / delayus;
    let mut rddm_timeout_us: u32 = 200000;
    let mut rddm_retry: c_int = rddm_timeout_us / delayus;
    void __iomem *base = mhi_cntrl.bhie;
    struct device *dev = &mhi_cntrl.mhi_dev.dev;
...
#[no_mangle]
pub unsafe extern "C" fn mhi_download_rddm_image(mhi_cntrl: *mut mhi_controller, in_panic: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_fw_load_error_dump(mhi_cntrl: *mut mhi_controller) {
...
// Allocate and populate vector table
    ...
    img_info.bhi_vec = core::ptr::null_mut();
    img_info.entries = 1;
// image_info = img_info;
    return 0;
    error_alloc_segment:
    ...
    size_t alloc_size)
    {
    let mut seg_size: usize = mhi_cntrl.seg_len;
    let mut segments: c_int = DIV_ROUND_UP(alloc_size, seg_size) + 1;
    int i;
    struct image_info *img_info;
    struct mhi_buf *mhi_buf;
...
// Allocate and populate vector table
    ...
    let mut vec_size: usize = seg_size;
...
#[no_mangle]
unsafe extern "C" fn mhi_fw_load_type_get(mhi_cntrl: *const mhi_controller) -> enum mhi_fw_load_type {
...
#[no_mangle]
unsafe extern "C" fn mhi_load_image_bhi(mhi_cntrl: *mut mhi_controller, fw_data: *const u8, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_load_image_bhie(mhi_cntrl: *mut mhi_controller, fw_data: *const u8, size: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_fw_load_handler(mhi_cntrl: *mut mhi_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_download_amss_image(mhi_cntrl: *mut mhi_controller) -> c_int {
