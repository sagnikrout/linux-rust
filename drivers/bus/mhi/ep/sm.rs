...
//! Source: drivers/bus/mhi/ep/sm.c
#![no_std]
...
//
    ...
    let mut cur_mhi_state: return = = MHI_STATE_RESET;
    if (mhi_state == MHI_STATE_M0)
    let mut cur_mhi_state: return = = MHI_STATE_M3 || cur_mhi_state == MHI_STATE_READY;
    if (mhi_state == MHI_STATE_M3)
    let mut cur_mhi_state: return = = MHI_STATE_M0;
    return false;
    }
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_set_mhi_state(mhi_cntrl: *mut mhi_ep_cntrl, mhi_state: enum mhi_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_set_m0_state(mhi_cntrl: *mut mhi_ep_cntrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_set_m3_state(mhi_cntrl: *mut mhi_ep_cntrl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_set_ready_state(mhi_cntrl: *mut mhi_ep_cntrl) -> c_int {
