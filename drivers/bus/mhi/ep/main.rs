...
//! Source: drivers/bus/mhi/ep/main.c
#![no_std]
...
pub const M0_WAIT_DELAY_MS: c_int = 100;
pub const M0_WAIT_COUNT: c_int = 100;
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_send_state_change_event(mhi_cntrl: *mut mhi_ep_cntrl, state: enum mhi_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_send_ee_event(mhi_cntrl: *mut mhi_ep_cntrl, exec_env: enum mhi_ee_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_send_cmd_comp_event(mhi_cntrl: *mut mhi_ep_cntrl, code: enum mhi_ev_ccs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_process_cmd_ring(ring: *mut mhi_ep_ring, el: *mut mhi_ring_element) -> c_int {
    static int mhi_ep_process_cmd_ring(struct mhi_ep_ring *ring, struct mhi_ring_element *el)
    {
    struct mhi_ep_cntrl *mhi_cntrl = ring.mhi_cntrl;
    struct device *dev = &mhi_cntrl.mhi_dev.dev;
    let mut result: mhi_result = {};
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_queue_is_empty(mhi_dev: *mut mhi_ep_device, dir: enum dma_data_direction) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_read_completion(buf_info: *mut mhi_ep_buf_info) {
...
//
    ...
    let mut len: u32 = MHI_EP_DEFAULT_MTU;
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_process_ch_ring(ring: *mut mhi_ep_ring) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_skb_completion(buf_info: *mut mhi_ep_buf_info) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_queue_skb(mhi_dev: *mut mhi_ep_device, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_cache_host_cfg(mhi_cntrl: *mut mhi_ep_cntrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_free_host_cfg(mhi_cntrl: *mut mhi_ep_cntrl) {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_enable_int(mhi_cntrl: *mut mhi_ep_cntrl) {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_enable(mhi_cntrl: *mut mhi_ep_cntrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_cmd_ring_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_ch_ring_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_state_worker(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn mhi_ep_check_channel_interrupt(mhi_cntrl: *mut mhi_ep_cntrl) {
...
//
#[no_mangle]
unsafe extern "C" fn mhi_ep_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_abort_transfer(mhi_cntrl: *mut mhi_ep_cntrl) {
...
// Destroy devices associated with all channels
    device_for_each_child(&mhi_cntrl.mhi_dev.dev, core::ptr::null_mut(), mhi_ep_destroy_device);
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_reset_worker(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_power_up(mhi_cntrl: *mut mhi_ep_cntrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_release_device(dev: *mut device) {
    static void mhi_ep_release_device(struct device *dev)
    {
    struct mhi_ep_device *mhi_dev = to_mhi_ep_device(dev);
    if (mhi_dev.dev_type == MHI_DEVICE_CONTROLLER)
    mhi_dev.mhi_cntrl.mhi_dev = core::ptr::null_mut();
//
...
//
    if (mhi_dev.ul_chan)
    mhi_dev.ul_chan.mhi_dev = core::ptr::null_mut();
    if (mhi_dev.dl_chan)
    mhi_dev.dl_chan.mhi_dev = core::ptr::null_mut();
    kfree(mhi_dev);
    }
...
//
#[no_mangle]
unsafe extern "C" fn mhi_ep_create_device(mhi_cntrl: *mut mhi_ep_cntrl, ch_id: u32) -> c_int {
    static int mhi_ep_create_device(struct mhi_ep_cntrl *mhi_cntrl, u32 ch_id)
    {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_destroy_device(dev: *mut device, data: *mut c_void) -> c_int {
    static int mhi_ep_destroy_device(struct device *dev, void *data)
    {
    struct mhi_ep_device *mhi_dev;
...
//
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_unregister_controller(mhi_cntrl: *mut mhi_ep_cntrl) {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_remove(dev: *mut device) {
...
// Send channel disconnect status to the client driver
    ...
    mhi_chan.xfer_cb = core::ptr::null_mut();
    mutex_unlock(&mhi_chan.lock);
    }
...
#[no_mangle]
pub unsafe extern "C" fn __mhi_ep_driver_register(mhi_drv: *mut mhi_ep_driver, owner: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mhi_ep_driver_unregister(mhi_drv: *mut mhi_ep_driver) {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mhi_ep_init() -> int __init {
    static int __init mhi_ep_init(void)
    {
    return bus_register(&mhi_ep_bus_type);
    }
#[no_mangle]
unsafe extern "C" fn mhi_ep_exit() -> void __exit {
