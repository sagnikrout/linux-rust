...
#[no_mangle]
pub unsafe extern "C" fn mox_module_known(id: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RO(_arg: module_##name) -> static {
...
#[no_mangle]
unsafe extern "C" fn moxtet_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn moxtet_dev_check(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn moxtet_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn moxtet_add_device(dev: *mut moxtet_device) -> c_int {
    ...
    ret = bus_for_each_dev(&moxtet_bus_type, core::ptr::null_mut(), dev,
    moxtet_dev_check);
    if (ret)
    goto done;
...
#[no_mangle]
unsafe extern "C" fn of_register_moxtet_devices(moxtet: *mut moxtet) {
...
//
#[no_mangle]
unsafe extern "C" fn moxtet_set_irq(moxtet: *mut moxtet, idx: c_int, id: c_int, nsame: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn moxtet_find_topology(moxtet: *mut moxtet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn moxtet_spi_read(moxtet: *mut moxtet, buf: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn moxtet_device_read(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn moxtet_device_write(dev: *mut device, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn moxtet_device_written(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn moxtet_debug_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn moxtet_register_debugfs(moxtet: *mut moxtet) -> c_int {
    static int moxtet_register_debugfs(struct moxtet *moxtet)
    {
    struct dentry *root, *entry;
    root = debugfs_create_dir("moxtet", core::ptr::null_mut());
    if (IS_ERR(root))
    return PTR_ERR(root);
...
#[no_mangle]
unsafe extern "C" fn moxtet_unregister_debugfs(moxtet: *mut moxtet) {
...
#[no_mangle]
pub unsafe extern "C" fn moxtet_register_debugfs(moxtet: *mut moxtet) -> c_int {
    static inline int moxtet_register_debugfs(struct moxtet *moxtet)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn moxtet_unregister_debugfs(moxtet: *mut moxtet) {
...
#[no_mangle]
unsafe extern "C" fn moxtet_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn moxtet_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn moxtet_irq_print_chip(d: *mut irq_data, p: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn moxtet_irq_read(moxtet: *mut moxtet, map: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn moxtet_irq_thread_fn(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t moxtet_irq_thread_fn(int irq, void *data)
    {
    struct moxtet *moxtet = data;
    unsigned long set;
    let mut nhandled: c_int = 0, i, sub_irq, ret;
...
#[no_mangle]
unsafe extern "C" fn moxtet_irq_free(moxtet: *mut moxtet) {
...
#[no_mangle]
unsafe extern "C" fn moxtet_irq_setup(moxtet: *mut moxtet) -> c_int {
    ...
    if (moxtet.irq.domain == core::ptr::null_mut()) {
    ...
    moxtet.irq.masked = ~0;
    ret = request_threaded_irq(moxtet.dev_irq, core::ptr::null_mut(), moxtet_irq_thread_fn,
...
#[no_mangle]
unsafe extern "C" fn moxtet_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn moxtet_remove(spi: *mut spi_device) {
    ...
    device_for_each_child(moxtet.dev, core::ptr::null_mut(), __unregister);
...
#[no_mangle]
unsafe extern "C" fn moxtet_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn moxtet_exit() -> void __exit {
