...
//! Source: drivers/bus/uniphier-system-bus.c
#![no_std]
...
pub const UNIPHIER_SBC_BASE: c_uint = 0x100	/* base address of bank0 space */;

pub const UNIPHIER_SBC_CTRL0: c_uint = 0x200	/* timing parameter 0 of bank0 */;
pub const UNIPHIER_SBC_CTRL1: c_uint = 0x204	/* timing parameter 1 of bank0 */;
pub const UNIPHIER_SBC_CTRL2: c_uint = 0x208	/* timing parameter 2 of bank0 */;
pub const UNIPHIER_SBC_CTRL3: c_uint = 0x20c	/* timing parameter 3 of bank0 */;
pub const UNIPHIER_SBC_CTRL4: c_uint = 0x300	/* timing parameter 4 of bank0 */;
pub const UNIPHIER_SBC_STRIDE: c_uint = 0x10	/* register stride to next bank */;

pub const UNIPHIER_SBC_BASE_DUMMY: c_uint = 0xffffffff	/* data to squash bank 0, 1 */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_system_bus_bank {
    pub base: u32,
    pub end: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_system_bus_priv {
    pub dev: *mut device,
    pub membase: *mut void __iomem,
    pub bank: [uniphier_system_bus_bank; UNIPHIER_SBC_NR_BANKS],
}
...
#[no_mangle]
unsafe extern "C" fn uniphier_system_bus_probe(pdev: *mut platform_device) -> c_int {
...
// Now, the bus is configured.  Populate platform_devices below it
    return of_platform_default_populate(dev.of_node, core::ptr::null_mut(), dev);
    }
#[no_mangle]
unsafe extern "C" fn uniphier_system_bus_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), uniphier_system_bus_resume)
    };
