...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_weim_devtype {
    pub cs_count: c_uint,
    pub cs_regs_count: c_uint,
    pub cs_stride: c_uint,
    pub wcr_offset: c_uint,
    pub wcr_bcm: c_uint,
    pub wcr_cont_bclk: c_uint,
}
...
pub const MAX_CS_REGS_COUNT: c_int = 6;
pub const MAX_CS_COUNT: c_int = 6;
pub const OF_REG_SIZE: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs_timing {
    pub is_applied: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs_timing_state {
    pub cs: [cs_timing; MAX_CS_COUNT],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct weim_priv {
    pub base: *mut void __iomem,
    pub timing_state: cs_timing_state,
}
...
#[no_mangle]
unsafe extern "C" fn imx_weim_gpr_setup(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn weim_parse_dt(pdev: *mut platform_device) -> c_int {
    static int weim_parse_dt(struct platform_device *pdev)
    {
    const struct imx_weim_devtype *devtype = device_get_match_data(&pdev.dev);
    let mut ret: c_int = 0, have_child = 0;
...
#[no_mangle]
unsafe extern "C" fn weim_probe(pdev: *mut platform_device) -> c_int {
...
// parse the device node
    ...
    if (!of_platform_device_create(rd.dn, core::ptr::null_mut(), &pdev.dev)) {
    dev_err(&pdev.dev,
...
#[no_mangle]
unsafe extern "C" fn weim_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn weim_exit() -> void __exit {
