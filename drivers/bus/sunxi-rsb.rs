...
//! Source: drivers/bus/sunxi-rsb.c
#![no_std]
...
// RSB registers
pub const RSB_CTRL: c_uint = 0x0	/* Global control */;
pub const RSB_CCR: c_uint = 0x4	/* Clock control */;
pub const RSB_INTE: c_uint = 0x8	/* Interrupt controls */;
pub const RSB_INTS: c_uint = 0xc	/* Interrupt status */;
pub const RSB_ADDR: c_uint = 0x10	/* Address to send with read/write command */;
pub const RSB_DATA: c_uint = 0x1c	/* Data to read/write */;
pub const RSB_LCR: c_uint = 0x24	/* Line control */;
pub const RSB_DMCR: c_uint = 0x28	/* Device mode (init) control */;
pub const RSB_CMD: c_uint = 0x2c	/* RSB Command */;
pub const RSB_DAR: c_uint = 0x30	/* Device address / runtime address */;
// CTRL fields

// CLK CTRL fields

pub const RSB_CCR_MAX_CLK_DIV: c_uint = 0xff;
...
pub const RSB_DMCR_DEV_ADDR: c_uint = 0x00;
// CMD values
pub const RSB_CMD_RD8: c_uint = 0x8b;
pub const RSB_CMD_RD16: c_uint = 0x9c;
pub const RSB_CMD_RD32: c_uint = 0xa6;
pub const RSB_CMD_WR8: c_uint = 0x4e;
pub const RSB_CMD_WR16: c_uint = 0x59;
pub const RSB_CMD_WR32: c_uint = 0x63;
pub const RSB_CMD_STRA: c_uint = 0xe8;
// DAR fields

pub const RSB_MAX_FREQ: c_int = 20000000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_rsb_addr_map {
    pub hwaddr: u16,
    pub rtaddr: u8,
}
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_device_match(dev: *mut device, drv: *const device_driver) -> c_int {
    static int sunxi_rsb_device_match(struct device *dev, const struct device_driver *drv)
    {
    return of_driver_match_device(dev, drv);
    }
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_device_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_device_modalias(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_dev_release(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_device_unregister(rdev: *mut sunxi_rsb_device) {
    static void sunxi_rsb_device_unregister(struct sunxi_rsb_device *rdev)
    {
    device_unregister(&rdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_remove_devices(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sunxi_rsb_driver_register(rdrv: *mut sunxi_rsb_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _sunxi_rsb_run_xfer(rsb: *mut sunxi_rsb) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunxi_rsb_ctx {
    pub rdev: *mut sunxi_rsb_device,
    pub size: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn regmap_sunxi_rsb_free_ctx(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_init_device_mode(rsb: *mut sunxi_rsb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_get_rtaddr(hwaddr: u16) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn of_rsb_register_devices(rsb: *mut sunxi_rsb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_hw_init(rsb: *mut sunxi_rsb) -> c_int {
...
//
    ...
    clk_div = 1;
#[no_mangle]
pub unsafe extern "C" fn if(1: clk_div > RSB_CCR_MAX_CLK_DIV +) -> else {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_hw_exit(rsb: *mut sunxi_rsb) {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_probe(pdev: *mut platform_device) -> c_int {
    static int sunxi_rsb_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct device_node *np = dev.of_node;
    struct sunxi_rsb *rsb;
    let mut clk_freq: u32 = 3000000;
    int irq, ret;
    ...
    if (irq < 0)
    return irq;
    rsb.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(rsb.clk))
    return dev_err_probe(dev, PTR_ERR(rsb.clk),
    "failed to retrieve clk\n");
    rsb.rstc = devm_reset_control_get(dev, core::ptr::null_mut());
    if (IS_ERR(rsb.rstc))
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_remove(pdev: *mut platform_device) {
    static void sunxi_rsb_remove(struct platform_device *pdev)
    {
    struct sunxi_rsb *rsb = platform_get_drvdata(pdev);
    device_for_each_child(rsb.dev, core::ptr::null_mut(), sunxi_rsb_remove_devices);
    pm_runtime_disable(&pdev.dev);
    sunxi_rsb_hw_exit(rsb);
    }
    static const struct dev_pm_ops sunxi_rsb_dev_pm_ops = {
    SET_RUNTIME_PM_OPS(sunxi_rsb_runtime_suspend,
    sunxi_rsb_runtime_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sunxi_rsb_exit() -> void __exit {
