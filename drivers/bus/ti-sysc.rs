...
pub const MAX_MODULE_SOFTRESET_WAIT: c_int = 10000;
    enum sysc_soc {
    SOC_UNKNOWN,
    SOC_2420,
    SOC_2430,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sysc_soc_info {
    pub general_purpose:1: c_ulong,
    pub soc: enum sysc_soc,
    pub /: *mut *mut mutex list_lock; / disabled and restored modules list lock,
    pub disabled_modules: list_head,
    pub restored_modules: list_head,
...
pub const SYSC_IDLEMODE_MASK: c_int = 3;
pub const SYSC_CLOCKACTIVITY_MASK: c_int = 3;
//
...
pub struct sysc {
    ...
    pub module_pa: u64,
    pub module_size: u32,
    pub module_va: *mut void __iomem,
    pub offsets: [c_int; SYSC_MAX_REGS],
    pub mdata: *mut ti_sysc_module_data,
    pub clocks: *mut clk,
    pub clock_roles: *const c_char,
    pub nr_clocks: c_int,
    pub rsts: *mut reset_control,
    pub legacy_mode: *const c_char,
    pub cap: *const sysc_capabilities,
    pub cfg: sysc_config,
    pub cookie: ti_sysc_cookie,
    ...
    pub child_needs_resume:1: c_uint,
    pub idle_work: delayed_work,
    pub sysc): *mut *mut void (pre_reset_quirk)(struct sysc,
    pub sysc): *mut *mut void (post_reset_quirk)(struct sysc,
    pub sysc): *mut *mut void (reset_done_quirk)(struct sysc,
    pub sysc): *mut *mut void (module_enable_quirk)(struct sysc,
    pub sysc): *mut *mut void (module_disable_quirk)(struct sysc,
    pub sysc): *mut *mut void (module_unlock_quirk)(struct sysc,
    pub sysc): *mut *mut void (module_lock_quirk)(struct sysc,
}
...
#[no_mangle]
unsafe extern "C" fn sysc_write(ddata: *mut sysc, offset: c_int, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn sysc_read(ddata: *mut sysc, offset: c_int) -> u32 {
...
// Only i2c revision has LO and HI register with stride of 4
    if (ddata.offsets[SYSC_REVISION] >= 0 &&
    offset == ddata.offsets[SYSC_REVISION]) {
    let mut tmp: u16 = readw_relaxed(ddata.module_va + offset + 4);
    val |= tmp << 16;
    }
    return val;
    }
...
#[no_mangle]
unsafe extern "C" fn sysc_opt_clks_needed(ddata: *mut sysc) -> bool {
    static bool sysc_opt_clks_needed(struct sysc *ddata)
    {
    return !!(ddata.cfg.quirks & SYSC_QUIRK_OPT_CLKS_NEEDED);
    }
#[no_mangle]
unsafe extern "C" fn sysc_read_revision(ddata: *mut sysc) -> u32 {
    static u32 sysc_read_revision(struct sysc *ddata)
    {
    let mut offset: c_int = ddata.offsets[SYSC_REVISION];
    if (offset < 0)
    return 0;
    return sysc_read(ddata, offset);
    }
#[no_mangle]
unsafe extern "C" fn sysc_read_sysconfig(ddata: *mut sysc) -> u32 {
    static u32 sysc_read_sysconfig(struct sysc *ddata)
    {
    let mut offset: c_int = ddata.offsets[SYSC_SYSCONFIG];
    if (offset < 0)
    return 0;
    return sysc_read(ddata, offset);
    }
#[no_mangle]
unsafe extern "C" fn sysc_read_sysstatus(ddata: *mut sysc) -> u32 {
    static u32 sysc_read_sysstatus(struct sysc *ddata)
    {
    let mut offset: c_int = ddata.offsets[SYSC_SYSSTATUS];
    if (offset < 0)
    return 0;
    return sysc_read(ddata, offset);
    }
#[no_mangle]
unsafe extern "C" fn sysc_poll_reset_sysstatus(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_poll_reset_sysconfig(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_wait_softreset(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SYSC_QUIRK_RESET_STATUS: ddata->cfg.quirks &) -> else {
...
#[no_mangle]
unsafe extern "C" fn sysc_init_ext_opt_clock(ddata: *mut sysc, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_get_one_clock(ddata: *mut sysc, name: *const c_char) -> c_int {
    ...
    index = SYSC_FCK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(clock_names[SYSC_ICK], _arg: name, _arg: 3)) -> else {
...
#[no_mangle]
unsafe extern "C" fn sysc_get_clocks(ddata: *mut sysc) -> c_int {
    static int sysc_get_clocks(struct sysc *ddata)
    {
    struct device_node *np = ddata.dev.of_node;
    struct property *prop;
    const char *name;
    let mut nr_fck: c_int = 0, nr_ick = 0, i, error = 0;
    ...
    error = sysc_init_ext_opt_clock(ddata, core::ptr::null_mut());
    if (error)
    return error;
    }
...
#[no_mangle]
unsafe extern "C" fn sysc_enable_main_clocks(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_disable_main_clocks(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_enable_opt_clocks(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_disable_opt_clocks(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_clkdm_deny_idle(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_clkdm_allow_idle(ddata: *mut sysc) {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_init_resets(ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_parse_and_check_child_range(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_init_stdout_path(ddata: *mut sysc) {
    ...
    if (!chosen)
    goto err;
    uart = of_get_property(chosen, "stdout-path", core::ptr::null_mut());
    if (!uart) {
    of_node_put(chosen);
    goto err;
    }
...
//
    ...
    {
    const char *name;
    name = of_get_property(np, "ti,hwmods", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sysc_check_children(ddata: *mut sysc) {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_check_quirk_16bit(ddata: *mut sysc, res: *mut resource) {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_parse_one(ddata: *mut sysc, reg: enum sysc_registers) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_parse_registers(ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_check_registers(ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_ioremap(ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_map_and_check_registers(ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_show_rev(bufp: *mut c_char, ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_show_name(bufp: *mut c_char, ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_show_registers(ddata: *mut sysc) {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_write_sysconfig(ddata: *mut sysc, value: u32) {
...
pub const SYSC_CLOCACT_ICK: c_int = 2;
// Caller needs to manage sysc_clkdm_deny_idle() and sysc_clkdm_allow_idle()
#[no_mangle]
unsafe extern "C" fn sysc_enable_module(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_best_idle_mode(idlemodes: u32, best_mode: *mut u32) -> c_int {
    static int sysc_best_idle_mode(u32 idlemodes, u32 *best_mode)
    {
    if (idlemodes & BIT(SYSC_IDLE_SMART_WKUP))
// best_mode = SYSC_IDLE_SMART_WKUP;
#[no_mangle]
pub unsafe extern "C" fn if(BIT(SYSC_IDLE_SMART): idlemodes &) -> else {
    else if (idlemodes & BIT(SYSC_IDLE_SMART))
// best_mode = SYSC_IDLE_SMART;
#[no_mangle]
pub unsafe extern "C" fn if(BIT(SYSC_IDLE_FORCE): idlemodes &) -> else {
...
// Caller needs to manage sysc_clkdm_deny_idle() and sysc_clkdm_allow_idle()
#[no_mangle]
unsafe extern "C" fn sysc_disable_module(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sysc_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_check_context(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_reinit_module(ddata: *mut sysc, leave_enabled: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_noirq_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sysc_noirq_resume(dev: *mut device) -> int __maybe_unused {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sysc_revision_quirk {
    pub name: *const c_char,
    pub base: u32,
    pub rev_offset: c_int,
    pub sysc_offset: c_int,
    pub syss_offset: c_int,
    pub revision: u32,
...
//
#[no_mangle]
unsafe extern "C" fn sysc_init_early_quirks(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_init_revision_quirks(ddata: *mut sysc) {
...
//
    ...
    let mut lcd_en_mask: c_int = BIT(0), digit_en_mask = BIT(1);
    int manager_count;
    let mut framedonetv_irq: bool = true;
    u32 val, irq_mask = 0;
    switch (sysc_soc.soc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_pre_reset_quirk_dss(ddata: *mut sysc) {
    static void sysc_pre_reset_quirk_dss(struct sysc *ddata)
    {
    let mut dispc_offset: c_int = 0x1000;
    int error;
    u32 irq_mask, val;
// Get enabled outputs
...
#[no_mangle]
unsafe extern "C" fn sysc_pre_reset_quirk_hdq1w(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_module_enable_quirk_aess(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_clk_quirk_i2c(ddata: *mut sysc, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sysc_pre_reset_quirk_i2c(ddata: *mut sysc) {
    static void sysc_pre_reset_quirk_i2c(struct sysc *ddata)
    {
    sysc_clk_quirk_i2c(ddata, false);
    }
#[no_mangle]
unsafe extern "C" fn sysc_post_reset_quirk_i2c(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_quirk_rtc(ddata: *mut sysc, lock: bool) {
...
#[no_mangle]
unsafe extern "C" fn sysc_module_unlock_quirk_rtc(ddata: *mut sysc) {
    static void sysc_module_unlock_quirk_rtc(struct sysc *ddata)
    {
    sysc_quirk_rtc(ddata, false);
    }
#[no_mangle]
unsafe extern "C" fn sysc_module_lock_quirk_rtc(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_module_enable_quirk_otg(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_module_disable_quirk_otg(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_module_enable_quirk_sgx(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_reset_done_quirk_wdt(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_module_disable_quirk_pruss(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_module_enable_quirk_pruss(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_init_module_quirks(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_clockdomain_init(ddata: *mut sysc) -> c_int {
    static int sysc_clockdomain_init(struct sysc *ddata)
    {
    struct ti_sysc_platform_data *pdata = dev_get_platdata(ddata.dev);
    struct clk *fck = core::ptr::null_mut(), *ick = core::ptr::null_mut();
    int error;
...
//
#[no_mangle]
unsafe extern "C" fn sysc_legacy_init(ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_reset(ddata: *mut sysc) -> c_int {
    static int sysc_reset(struct sysc *ddata)
    {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_init_module(ddata: *mut sysc) -> c_int {
    static int sysc_init_module(struct sysc *ddata)
    {
    let mut rstctrl_deasserted: bool = false;
    let mut error: c_int = sysc_clockdomain_init(ddata);
    if (error)
    return error;
    sysc_clkdm_deny_idle(ddata);
//
...
#[no_mangle]
unsafe extern "C" fn sysc_init_sysc_mask(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_init_idlemodes(ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_init_syss_mask(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_child_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sysc_child_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sysc_reinit_modules(soc: *mut sysc_soc_info) {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_add_restored(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_init_dts_quirks(ddata: *mut sysc) -> c_int {
    static int sysc_init_dts_quirks(struct sysc *ddata)
    {
    struct device_node *np = ddata.dev.of_node;
    int error;
    u32 val;
    ddata.legacy_mode = of_get_property(np, "ti,hwmods", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sysc_unprepare(ddata: *mut sysc) {
...
#[no_mangle]
unsafe extern "C" fn sysc_init_pdata(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_init_match(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sysc_idle(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sysc_add_disabled(base: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_init_static_data(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_cleanup_static_data() {
...
#[no_mangle]
unsafe extern "C" fn sysc_check_disabled_devices(ddata: *mut sysc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sysc_check_active_timer(ddata: *mut sysc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sysc_probe(pdev: *mut platform_device) -> c_int {
...
// Balance use counts as PM runtime should have enabled these all
    ...
    sysc_match_table,
    pdata ? pdata.auxdata : core::ptr::null_mut(),
    ddata.dev);
    if (error)
    goto err;
    }
...
#[no_mangle]
unsafe extern "C" fn sysc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sysc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sysc_exit() -> void __exit {
