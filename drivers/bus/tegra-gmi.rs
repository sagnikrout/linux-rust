...
//! Source: drivers/bus/tegra-gmi.c
#![no_std]
...
pub const TEGRA_GMI_CONFIG: c_uint = 0x00;

pub const TEGRA_GMI_TIMING0: c_uint = 0x10;

pub const TEGRA_GMI_TIMING1: c_uint = 0x14;

pub const TEGRA_GMI_MAX_CHIP_SELECT: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_gmi {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub rst: *mut reset_control,
    pub snor_config: u32,
    pub snor_timing0: u32,
    pub snor_timing1: u32,
}

#[no_mangle]
unsafe extern "C" fn tegra_gmi_enable(gmi: *mut tegra_gmi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gmi_disable(gmi: *mut tegra_gmi) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gmi_parse_dt(gmi: *mut tegra_gmi) -> c_int {
    static int tegra_gmi_parse_dt(struct tegra_gmi *gmi)
    {
    struct device_node *child;
    u32 property, ranges[4];
    int err;
    child = of_get_next_available_child(gmi.dev.of_node, core::ptr::null_mut());
    if (!child) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gmi_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (err < 0)
    return err;
    err = of_platform_default_populate(dev.of_node, core::ptr::null_mut(), dev);
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gmi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_gmi_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra_gmi_runtime_suspend(dev: *mut device) -> int __maybe_unused {
