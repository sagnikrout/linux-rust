...
//! Source: drivers/bus/qcom-ssc-block-bus.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_ssc_block_bus_data {
    pub pd_names: *const *const c_char,
    pub pds: [*mut device; ARRAY_SIZE(qcom_ssc_block_pd_names)],
    pub reg_mpm_sscaon_config0: *mut char __iomem,
    pub reg_mpm_sscaon_config1: *mut char __iomem,
    pub halt_map: *mut regmap,
    pub xo_clk: *mut clk,
    pub aggre2_clk: *mut clk,
    pub gcc_im_sleep_clk: *mut clk,
    pub aggre2_north_clk: *mut clk,
    pub ssc_xo_clk: *mut clk,
    pub ssc_ahbs_clk: *mut clk,
    pub ssc_bcr: *mut reset_control,
    pub ssc_reset: *mut reset_control,
    pub ssc_axi_halt: u32,
    pub num_pds: c_int,
}

#[no_mangle]
unsafe extern "C" fn reg32_set_bits(reg: *mut char __iomem, value: u32) {
    static void reg32_set_bits(char __iomem *reg, u32 value)
    {
    let mut tmp: u32 = ioread32(reg);
    iowrite32(tmp | value, reg);
    }
#[no_mangle]
unsafe extern "C" fn reg32_clear_bits(reg: *mut char __iomem, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn qcom_ssc_block_bus_init(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ssc_block_bus_deinit(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn qcom_ssc_block_bus_pds_detach(dev: *mut device, pds: *mut device, num_pds: usize) {
...
#[no_mangle]
unsafe extern "C" fn qcom_ssc_block_bus_pds_enable(pds: *mut device, num_pds: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ssc_block_bus_pds_disable(pds: *mut device, num_pds: usize) {
...
#[no_mangle]
unsafe extern "C" fn qcom_ssc_block_bus_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ssc_block_bus_remove(pdev: *mut platform_device) {
