...
//! Source: drivers/bus/brcmstb_gisb.c
#![no_std]
...
pub const ARB_BP_CAP_STATUS_PROT_SHIFT: c_int = 14;

pub const ARB_BP_CAP_STATUS_RSP_SHIFT: c_int = 10;

pub const ARB_BP_CAP_STATUS_BS_SHIFT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmstb_gisb_arb_device {
    pub base: *mut void __iomem,
    pub gisb_offsets: *const c_int,
    pub big_endian: bool,
    pub lock: mutex,
    pub next: list_head,
    pub valid_mask: u32,
    pub BITS_PER_BYTE]: *const *const *const char master_names[sizeof(u32),
    pub saved_timeout: u32,
}

    static LIST_HEAD(brcmstb_gisb_arb_device_list);
#[no_mangle]
unsafe extern "C" fn gisb_read(gdev: *mut brcmstb_gisb_arb_device, reg: c_int) -> u32 {
    static u32 gisb_read(struct brcmstb_gisb_arb_device *gdev, int reg)
    {
    let mut offset: c_int = gdev.gisb_offsets[reg];
    if (offset < 0) {
...
#[no_mangle]
unsafe extern "C" fn gisb_read_address(gdev: *mut brcmstb_gisb_arb_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gisb_read_bp_address(gdev: *mut brcmstb_gisb_arb_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gisb_write(gdev: *mut brcmstb_gisb_arb_device, val: u32, reg: c_int) {
    ...
    u32 masters)
    {
    let mut mask: u32 = gdev.valid_mask & masters;
...
#[no_mangle]
unsafe extern "C" fn brcmstb_bus_error_handler(regs: *mut pt_regs, is_fixup: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gisb_timeout_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gisb_tea_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gisb_bp_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gisb_arb_probe(pdev: *mut platform_device) -> int __init {
    ...
    gdev.base = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    if (IS_ERR(gdev.base))
...
#[no_mangle]
unsafe extern "C" fn brcmstb_gisb_arb_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn brcmstb_gisb_arb_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_gisb_driver_init() -> int __init {
