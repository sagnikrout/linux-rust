...
//! Source: drivers/i3c/master/svc-i3c-master.c
#![no_std]
...
pub const SVC_I3C_MCONFIG: c_uint = 0x000;

pub const SVC_I3C_MCTRL: c_uint = 0x084;

pub const SVC_I3C_MCTRL_REQUEST_NONE: c_int = 0;
pub const SVC_I3C_MCTRL_REQUEST_START_ADDR: c_int = 1;
pub const SVC_I3C_MCTRL_REQUEST_STOP: c_int = 2;
pub const SVC_I3C_MCTRL_REQUEST_FORCE_EXIT: c_int = 6;
pub const SVC_I3C_MCTRL_REQUEST_IBI_ACKNACK: c_int = 3;
pub const SVC_I3C_MCTRL_REQUEST_PROC_DAA: c_int = 4;
pub const SVC_I3C_MCTRL_REQUEST_AUTO_IBI: c_int = 7;
pub const SVC_I3C_MCTRL_TYPE_I3C: c_int = 0;

pub const SVC_I3C_MCTRL_IBIRESP_AUTO: c_int = 0;
pub const SVC_I3C_MCTRL_IBIRESP_ACK_WITHOUT_BYTE: c_int = 0;

pub const SVC_I3C_MCTRL_DIR_WRITE: c_int = 0;
pub const SVC_I3C_MCTRL_DIR_READ: c_int = 1;

pub const SVC_I3C_MSTATUS: c_uint = 0x088;

pub const SVC_I3C_MSTATUS_IBITYPE_IBI: c_int = 1;
pub const SVC_I3C_MSTATUS_IBITYPE_MASTER_REQUEST: c_int = 2;
pub const SVC_I3C_MSTATUS_IBITYPE_HOT_JOIN: c_int = 3;

pub const SVC_I3C_IBIRULES: c_uint = 0x08C;

    ((addr) & 0x3F) << ((slot) * 6))
pub const SVC_I3C_IBIRULES_ADDRS: c_int = 5;

pub const SVC_I3C_IBIRULES_MANDBYTE: c_int = 0;
pub const SVC_I3C_MINTSET: c_uint = 0x090;
pub const SVC_I3C_MINTCLR: c_uint = 0x094;
pub const SVC_I3C_MINTMASKED: c_uint = 0x098;
pub const SVC_I3C_MERRWARN: c_uint = 0x09C;

pub const SVC_I3C_MDMACTRL: c_uint = 0x0A0;
pub const SVC_I3C_MDATACTRL: c_uint = 0x0AC;

pub const SVC_I3C_MDATACTRL_RXTRIG_FIFO_NOT_EMPTY: c_int = 0;

pub const SVC_I3C_MWDATAB: c_uint = 0x0B0;

pub const SVC_I3C_MWDATABE: c_uint = 0x0B4;
pub const SVC_I3C_MWDATAH: c_uint = 0x0B8;
pub const SVC_I3C_MWDATAHE: c_uint = 0x0BC;
pub const SVC_I3C_MRDATAB: c_uint = 0x0C0;
pub const SVC_I3C_MRDATAH: c_uint = 0x0C8;
pub const SVC_I3C_MWDATAB1: c_uint = 0x0CC;
pub const SVC_I3C_MWMSG_SDR: c_uint = 0x0D0;
pub const SVC_I3C_MRMSG_SDR: c_uint = 0x0D4;
pub const SVC_I3C_MWMSG_DDR: c_uint = 0x0D8;
pub const SVC_I3C_MRMSG_DDR: c_uint = 0x0DC;
pub const SVC_I3C_MDYNADDR: c_uint = 0x0E4;

pub const SVC_I3C_MAX_DEVS: c_int = 32;
pub const SVC_I3C_PM_TIMEOUT_MS: c_int = 1000;
// This parameter depends on the implementation and may be tuned
pub const SVC_I3C_FIFO_SIZE: c_int = 16;
pub const SVC_I3C_PPBAUD_MAX: c_int = 15;
pub const SVC_I3C_QUICK_I2C_CLK: c_int = 4170000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct svc_i3c_xfer {
    pub node: list_head,
    pub comp: completion,
    pub ret: c_int,
    pub type: c_uint,
    pub ncmds: c_uint,
    pub __counted_by(ncmds): svc_i3c_cmd cmds[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct svc_i3c_regs_save {
    pub mconfig: u32,
    pub mdynaddr: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct svc_i3c_master {
    pub base: i3c_master_controller,
    pub dev: *mut device,
    pub regs: *mut void __iomem,
    pub saved_regs: svc_i3c_regs_save,
    pub free_slots: u32,
    pub addrs: [u8; SVC_I3C_MAX_DEVS],
    pub descs: [*mut i3c_dev_desc; SVC_I3C_MAX_DEVS],
    pub irq: c_int,
    pub num_clks: c_int,
    pub fclk: *mut clk,
...
// Prevent races between transfers
    ...
    pub tbq_slot: *mut i3c_ibi_slot,
// Prevent races within IBI handlers
    pub lock: spinlock_t,
    pub ibi: },
    pub lock: mutex,
    pub drvdata: *const svc_i3c_drvdata,
    pub enabled_events: u32,
    pub mctrl_config: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct svc_i3c_i2c_dev_data {
    pub index: u8,
    pub ibi: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn svc_has_quirk(master: *mut svc_i3c_master, quirk: u32) -> bool {
    static inline bool svc_has_quirk(struct svc_i3c_master *master, u32 quirk)
    {
    return (master.drvdata.quirks & quirk);
    }
#[no_mangle]
pub unsafe extern "C" fn svc_has_daa_corrupt(master: *mut svc_i3c_master) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_events_enabled(master: *mut svc_i3c_master, mask: u32) -> bool {
    static inline bool is_events_enabled(struct svc_i3c_master *master, u32 mask)
    {
    return !!(master.enabled_events & mask);
    }
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_error(master: *mut svc_i3c_master) -> bool {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_enable_interrupts(master: *mut svc_i3c_master, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_disable_interrupts(master: *mut svc_i3c_master) {
    static void svc_i3c_master_disable_interrupts(struct svc_i3c_master *master)
    {
    let mut mask: u32 = readl(master.regs + SVC_I3C_MINTSET);
    writel(mask, master.regs + SVC_I3C_MINTCLR);
    }
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_clear_merrwarn(master: *mut svc_i3c_master) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_flush_fifo(master: *mut svc_i3c_master) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_reset_fifo_trigger(master: *mut svc_i3c_master) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_reset(master: *mut svc_i3c_master) {
...
#[no_mangle]
unsafe extern "C" fn svc_cmd_is_read(rnw_cmd: u32, type: u32) -> bool {
    static bool svc_cmd_is_read(u32 rnw_cmd, u32 type)
    {
    return (type == SVC_I3C_MCTRL_TYPE_DDR) ? (rnw_cmd & 0x80) : rnw_cmd;
    }
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_emit_force_exit(master: *mut svc_i3c_master) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_emit_stop(master: *mut svc_i3c_master) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_nack_ibi(master: *mut svc_i3c_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_handle_ibi_won(master: *mut svc_i3c_master, mstatus: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_ibi_isr(master: *mut svc_i3c_master) {
    static void svc_i3c_master_ibi_isr(struct svc_i3c_master *master)
    {
    struct svc_i3c_i2c_dev_data *data;
    struct i3c_dev_desc *dev = core::ptr::null_mut();
...
//
    ...
    master.ibi.tbq_slot);
    master.ibi.tbq_slot = core::ptr::null_mut();
    }
    svc_i3c_master_emit_stop(master);
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t svc_i3c_master_irq_handler(int irq, void *dev_id)
    {
    struct svc_i3c_master *master = (struct svc_i3c_master *)dev_id;
    let mut active: u32 = readl(master.regs + SVC_I3C_MSTATUS);
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_bus_init(m: *mut i3c_master_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_bus_cleanup(m: *mut i3c_master_controller) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_reserve_slot(master: *mut svc_i3c_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_attach_i3c_dev(dev: *mut i3c_dev_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_detach_i3c_dev(dev: *mut i3c_dev_desc) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_attach_i2c_dev(dev: *mut i2c_dev_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_detach_i2c_dev(dev: *mut i2c_dev_desc) {
    ...
    let mut dev_nb: c_uint = 0, last_addr = 0, dyn_addr = 0;
    u32 reg;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_update_ibirules(master: *mut svc_i3c_master) -> c_int {
    static int svc_i3c_update_ibirules(struct svc_i3c_master *master)
    {
    struct i3c_dev_desc *dev;
    let mut reg_mbyte: u32 = 0, reg_nobyte = SVC_I3C_IBIRULES_NOBYTE;
    unsigned int mbyte_addr_ok = 0, mbyte_addr_ko = 0, nobyte_addr_ok = 0,
    nobyte_addr_ko = 0;
    let mut list_mbyte: bool = false, list_nobyte = false;
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_do_daa(m: *mut i3c_master_controller) -> c_int {
...
//
    ...
    {
    let mut rnw: bool = svc_cmd_is_read(rnw_cmd, xfer_type);
    let mut retry: c_int = repeat_start ? 1 : 2;
    u32 reg;
    int ret;
// clean SVC_I3C_MINT_IBIWON w1c bits
    writel(SVC_I3C_MINT_IBIWON, master.regs + SVC_I3C_MSTATUS);
...
#[no_mangle]
pub unsafe extern "C" fn if(SVC_I3C_MCTRL_TYPE_DDR: xfer_type !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_free_xfer(xfer: *mut svc_i3c_xfer) {
...
#[no_mangle]
unsafe extern "C" fn i3c_mode_to_svc_type(mode: enum i3c_xfer_mode) -> c_int {
    static int i3c_mode_to_svc_type(enum i3c_xfer_mode mode)
    {
    return (mode == I3C_SDR) ? SVC_I3C_MCTRL_TYPE_I3C : SVC_I3C_MCTRL_TYPE_DDR;
    }
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_start_xfer_locked(master: *mut svc_i3c_master) {
...
// No software support for CCC commands targeting more than one slave
    ...
    {
    let mut xfer_len: c_uint = ccc.dests[0].payload.len + 1;
    struct svc_i3c_xfer *xfer;
    ...
    struct i3c_ccc_cmd *ccc)
    {
    let mut xfer_len: c_uint = ccc.dests[0].payload.len;
    let mut actual_len: c_uint = ccc.rnw ? xfer_len : 0;
    struct svc_i3c_xfer *xfer;
    struct svc_i3c_cmd *cmd;
    int ret;
...
// Directed message
    ...
    cmd.addr = ccc.dests[0].addr;
    cmd.rnw = ccc.rnw;
    cmd.in = ccc.rnw ? ccc.dests[0].payload.data : core::ptr::null_mut();
    cmd.out = ccc.rnw ? core::ptr::null_mut() : ccc.dests[0].payload.data;
    cmd.len = xfer_len;
    ...
    {
    struct svc_i3c_master *master = to_svc_i3c_master(m);
    let mut broadcast: bool = cmd.id < 0x80;
    int ret;
    if (broadcast)
...
//
    ...
    for (i = 0; i < nxfers; i++) {
    let mut rnw_cmd: u32 = (mode == I3C_SDR) ? xfers[i].rnw : xfers[i].cmd;
    let mut rnw: bool = svc_cmd_is_read(rnw_cmd, xfer.type);
    struct svc_i3c_cmd *cmd = &xfer.cmds[i];
    cmd.xfer = &xfers[i];
    cmd.addr = master.addrs[data.index];
    cmd.rnw_cmd = rnw_cmd;
    cmd.in = rnw ? xfers[i].data.in : core::ptr::null_mut();
    cmd.out = rnw ? core::ptr::null_mut() : xfers[i].data.out;
    cmd.len = xfers[i].len;
    ...
    cmd.in = cmd.rnw ? xfers[i].buf : core::ptr::null_mut();
    cmd.out = cmd.rnw ? core::ptr::null_mut() : xfers[i].buf;
    cmd.len = xfers[i].len;
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_free_ibi(dev: *mut i3c_dev_desc) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_enable_ibi(dev: *mut i3c_dev_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_disable_ibi(dev: *mut i3c_dev_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_enable_hotjoin(m: *mut i3c_master_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_disable_hotjoin(m: *mut i3c_master_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_master_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_save_regs(master: *mut svc_i3c_master) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_restore_regs(master: *mut svc_i3c_master) {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn svc_i3c_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    svc_i3c_runtime_resume, core::ptr::null_mut())
    };
    ...
    let mut svc_default_drvdata: static struct svc_i3c_drvdata = {};
