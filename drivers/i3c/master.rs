...
//
#[no_mangle]
unsafe extern "C" fn i3c_bus_maintenance_lock(bus: *mut i3c_bus) {
...
//
#[no_mangle]
unsafe extern "C" fn i3c_bus_maintenance_unlock(bus: *mut i3c_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_bus_normaluse_lock(bus: *mut i3c_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_bus_normaluse_unlock(bus: *mut i3c_bus) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_rpm_get(master: *mut i3c_master_controller) -> int __must_check {
    static int __must_check i3c_master_rpm_get(struct i3c_master_controller *master)
    {
    let mut ret: c_int = master.rpm_allowed ? pm_runtime_resume_and_get(master.dev.parent) : 0;
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_rpm_put(master: *mut i3c_master_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn i3c_bus_rpm_get(bus: *mut i3c_bus) -> c_int {
    int i3c_bus_rpm_get(struct i3c_bus *bus)
    {
    return i3c_master_rpm_get(i3c_bus_to_i3c_master(bus));
    }
#[no_mangle]
pub unsafe extern "C" fn i3c_bus_rpm_put(bus: *mut i3c_bus) {
    void i3c_bus_rpm_put(struct i3c_bus *bus)
    {
    i3c_master_rpm_put(i3c_bus_to_i3c_master(bus));
    }
#[no_mangle]
pub unsafe extern "C" fn i3c_bus_rpm_ibi_allowed(bus: *mut i3c_bus) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i3c_device_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_device_match(dev: *mut device, drv: *const device_driver) -> c_int {
    static int i3c_device_match(struct device *dev, const struct device_driver *drv)
    {
    struct i3c_device *i3cdev;
    const struct i3c_driver *i3cdrv;
    let mut static_addr_method: u8 = 0;
    if (dev.type != &i3c_device_type)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn i3c_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_device_remove(dev: *mut device) {
    ...
    let mut bitpos: c_int = addr * I3C_ADDR_SLOT_STATUS_BITS;
...
#[no_mangle]
unsafe extern "C" fn i3c_bus_dev_addr_is_avail(bus: *mut i3c_bus, addr: u8) -> bool {
    static bool i3c_bus_dev_addr_is_avail(struct i3c_bus *bus, u8 addr)
    {
    enum i3c_addr_slot_status status;
    status = i3c_bus_get_addr_slot_status(bus, addr);
    let mut status: return = = I3C_ADDR_SLOT_FREE;
    }
//
// ┌────┬─────────────┬───┬─────────┬───┐
...
//
#[no_mangle]
unsafe extern "C" fn i3c_bus_get_free_addr(bus: *mut i3c_bus, start_addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_bus_init_addrslots(bus: *mut i3c_bus) {
...
#[no_mangle]
unsafe extern "C" fn i3c_bus_cleanup(i3cbus: *mut i3c_bus) {
...
#[no_mangle]
unsafe extern "C" fn i3c_bus_init(i3cbus: *mut i3c_bus, fwnode: *mut fwnode_handle) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i3c_register_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i3c_unregister_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_bus_notify(bus: *mut i3c_bus, action: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_hj_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn i3c_set_hotjoin(master: *mut i3c_master_controller, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_enable_hotjoin(master: *mut i3c_master_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_disable_hotjoin(master: *mut i3c_master_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_queue_hotjoin(master: *mut i3c_master_controller) {
...
#[no_mangle]
unsafe extern "C" fn hotjoin_show(dev: *mut device, da: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_free_i3c_dev(dev: *mut i3c_dev_desc) {
    static void i3c_master_free_i3c_dev(struct i3c_dev_desc *dev)
    {
    kfree(dev);
    }
#[no_mangle]
unsafe extern "C" fn i3c_masterdev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_shutdown(master: *mut i3c_master_controller) {
...
#[no_mangle]
unsafe extern "C" fn i3c_device_shutdown(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_free_i2c_dev(dev: *mut i2c_dev_desc) {
    ...
    dest.payload.data = core::ptr::null_mut();
    return dest.payload.data;
    }
#[no_mangle]
unsafe extern "C" fn i3c_ccc_cmd_dest_cleanup(dest: *mut i3c_ccc_cmd_dest) {
...
#[no_mangle]
unsafe extern "C" fn i3c_ccc_validate_payload_len(cmd: *mut i3c_ccc_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_device_release(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn i3c_master_setaasa_locked(master: *mut i3c_master_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_entdaa_locked(master: *mut i3c_master_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_defslvs_locked(master: *mut i3c_master_controller) -> c_int {
...
//
    ...
    let mut sft: c_int = (sizeof(getpid.pid) - i - 1) * 8;
...
#[no_mangle]
unsafe extern "C" fn i3c_master_retrieve_dev_info(dev: *mut i3c_dev_desc) -> c_int {
...
pub const I3C_DEV_PROBE_INITIAL_DELAY_US: c_int = 20;
pub const I3C_DEV_PROBE_DELAY_FACTOR: c_int = 2;
pub const I3C_DEV_PROBE_CNT: c_int = 5;
#[no_mangle]
unsafe extern "C" fn i3c_master_i3c_dev_present(master: *mut i3c_master_controller, addr: c_uint) -> bool {
    static bool i3c_master_i3c_dev_present(struct i3c_master_controller *master, unsigned int addr)
    {
    let mut delay: c_int = I3C_DEV_PROBE_INITIAL_DELAY_US;
    for (int i = 0; i < I3C_DEV_PROBE_CNT; i++) {
    if (i) {
    fsleep(delay);
    delay *= I3C_DEV_PROBE_DELAY_FACTOR;
    }
    if (!i3c_master_getstatus_locked(master, addr, core::ptr::null_mut()))
    return true;
    }
    return false;
    }
#[no_mangle]
unsafe extern "C" fn i3c_master_put_i3c_addrs(dev: *mut i3c_dev_desc) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_get_i3c_addrs(dev: *mut i3c_dev_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_detach_i3c_dev(dev: *mut i3c_dev_desc) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_detach_i2c_dev(dev: *mut i2c_dev_desc) {
...
// If the device has IBI capability, set as wakeup capable
    ...
    desc = i3cdev.desc;
    i3cdev.desc = core::ptr::null_mut();
    put_device(&i3cdev.dev);
    desc.dev = core::ptr::null_mut();
    }
    i3c_bus_maintenance_unlock(&master.bus);
    }
#[no_mangle]
unsafe extern "C" fn i3c_master_reg_work_fn(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_has_wakeup_enabled_devs(master: *mut i3c_master_controller) -> bool {
...
//
    ...
    {
    void *bounce __free(kfree) = core::ptr::null_mut();
    void *dma_buf = buf;
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_dma_unmap_single(dma_xfer: *mut i3c_dma) {
...
//
    ...
    return 0;
    err_free_dev:
    master.bus.cur_master = core::ptr::null_mut();
    master.this = core::ptr::null_mut();
    i3c_master_free_i3c_dev(i3cdev);
    return ret;
    }
    EXPORT_SYMBOL_GPL(i3c_master_set_info);
#[no_mangle]
unsafe extern "C" fn i3c_master_detach_free_devs(master: *mut i3c_master_controller) {
...
//
#[no_mangle]
unsafe extern "C" fn i3c_master_bus_init(master: *mut i3c_master_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_bus_cleanup(master: *mut i3c_master_controller) {
    static void i3c_master_bus_cleanup(struct i3c_master_controller *master)
    {
    if (master.ops.bus_cleanup) {
    let mut ret: c_int = i3c_master_rpm_get(master);
    if (ret) {
    dev_err(&master.dev,
...
#[no_mangle]
unsafe extern "C" fn i3c_master_attach_boardinfo(i3cdev: *mut i3c_dev_desc) {
...
//
    ...
    u8 addr, bool probe)
    {
    let mut info: i3c_device_info = { .dyn_addr = addr };
    struct i3c_dev_desc *newdev, *olddev;
    let mut old_dyn_addr: u8 = addr, expected_dyn_addr;
    let mut ibireq: i3c_ibi_setup = { };
    let mut enable_ibi: bool = false;
    let mut no_dev: bool = false;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(newdev->boardinfo->init_dyn_addr: newdev->boardinfo &&) -> else {
...
//
    ...
    newdev.dev.desc = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_add_i3c_dev_locked(master: *mut i3c_master_controller, addr: u8) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_reconcile_dyn_addrs(master: *mut i3c_master_controller) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_do_daa_ext(master: *mut i3c_master_controller, rstdaa: bool) -> c_int {
    int i3c_master_do_daa_ext(struct i3c_master_controller *master, bool rstdaa)
    {
    let mut rstret: c_int = 0;
    int ret;
    ret = i3c_master_rpm_get(master);
    if (ret)
    return ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_do_daa(master: *mut i3c_master_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_acpi_get_i2c_resource(ares: *mut acpi_resource, data: *mut c_void) -> c_int {
...
//
    ...
    let mut init_dyn_addr: u32 = 0, static_addr_method = 0;
    boardinfo = devm_kzalloc(dev, sizeof(*boardinfo), GFP_KERNEL);
    if (!boardinfo)
    return -ENOMEM;
    if (reg[0]) {
...
#[no_mangle]
pub unsafe extern "C" fn i3c_acpi_i2c_get_lvr(client: *mut i2c_client) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn fwnode_populate_i3c_bus(master: *mut i3c_master_controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_acpi_device_node(child)) -> else {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_i2c_funcs(adapter: *mut i2c_adapter) -> u32 {
    static u32 i3c_master_i2c_funcs(struct i2c_adapter *adapter)
    {
    return I2C_FUNC_SMBUS_EMUL | I2C_FUNC_I2C;
    }
#[no_mangle]
unsafe extern "C" fn i3c_master_i2c_get_lvr(client: *mut i2c_client) -> u8 {
    static u8 i3c_master_i2c_get_lvr(struct i2c_client *client)
    {
// Fall back to no spike filters and FM bus mode.
    let mut lvr: u8 = I3C_LVR_I2C_INDEX(2) | I3C_LVR_I2C_FM_MODE;
    u32 reg[3];
...
#[no_mangle]
unsafe extern "C" fn i3c_master_i2c_attach(adap: *mut i2c_adapter, client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_i2c_detach(adap: *mut i2c_adapter, client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_i2c_adapter_init(master: *mut i3c_master_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_i2c_adapter_cleanup(master: *mut i3c_master_controller) {
    static void i3c_master_i2c_adapter_cleanup(struct i3c_master_controller *master)
    {
    struct i2c_dev_desc *i2cdev;
    i2c_del_adapter(&master.i2c);
    i3c_bus_for_each_i2cdev(&master.bus, i2cdev)
    i2cdev.dev = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn i3c_master_unregister_i3c_devs(master: *mut i3c_master_controller) {
    ...
    i3cdev.dev.desc = core::ptr::null_mut();
    put_device(&i3cdev.dev.dev);
    i3cdev.dev = core::ptr::null_mut();
    }
    }
// Approximate time for IBI handler to run
pub const I3C_WAKEUP_PROCESSING_TIME_MS: c_int = 100;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_queue_ibi(dev: *mut i3c_dev_desc, slot: *mut i3c_ibi_slot) {
...
#[no_mangle]
unsafe extern "C" fn i3c_master_handle_ibi(work: *mut work_struct) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i3c_generic_ibi_slot {
    pub node: list_head,
    pub base: i3c_ibi_slot,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i3c_generic_ibi_pool {
    pub lock: spinlock_t,
    pub num_slots: c_uint,
    pub payload_buf: *mut c_void,
    pub free_slots: list_head,
    pub pending: list_head,
    pub __counted_by(num_slots): i3c_generic_ibi_slot slots[],
}
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_generic_ibi_free_pool(pool: *mut i3c_generic_ibi_pool) {
    void i3c_generic_ibi_free_pool(struct i3c_generic_ibi_pool *pool)
    {
    struct i3c_generic_ibi_slot *slot;
    let mut nslots: c_uint = 0;
...
//
    ...
    return slot ? &slot.base : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn i3c_master_check_ops(ops: *const i3c_master_controller_ops) -> c_int {
...
//
    ...
    bool secondary)
    {
    let mut i2c_scl_rate: c_ulong = I3C_BUS_I2C_FM_PLUS_SCL_MAX_RATE;
    struct i3c_bus *i3cbus = i3c_master_get_bus(master);
    let mut mode: enum i3c_bus_mode = I3C_BUS_MODE_PURE;
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_master_unregister(master: *mut i3c_master_controller) {
...
#[no_mangle]
pub unsafe extern "C" fn i3c_dev_setdasa_locked(dev: *mut i3c_dev_desc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_dev_disable_ibi_locked(dev: *mut i3c_dev_desc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_dev_enable_ibi_locked(dev: *mut i3c_dev_desc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i3c_dev_free_ibi_locked(dev: *mut i3c_dev_desc) {
...
#[no_mangle]
unsafe extern "C" fn i3c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn i3c_exit() -> void __exit {
