...
//! Source: drivers/pwm/pwm-lp3943.c
#![no_std]
...
pub const LP3943_MAX_DUTY: c_int = 255;
pub const LP3943_MIN_PERIOD: c_int = 6250;
pub const LP3943_MAX_PERIOD: c_int = 1600000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp3943_pwm {
    pub lp3943: *mut lp3943,
    pub pdata: *mut lp3943_platform_data,
    pub pwm_map: [lp3943_pwm_map; LP3943_NUM_PWMS],
}
...
#[no_mangle]
unsafe extern "C" fn lp3943_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3943_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn lp3943_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3943_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn lp3943_pwm_probe(pdev: *mut platform_device) -> c_int {
