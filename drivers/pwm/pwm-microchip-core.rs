...
//! Source: drivers/pwm/pwm-microchip-core.c
#![no_std]
...
pub const MCHPCOREPWM_PRESCALE_MAX: c_uint = 0xff;
pub const MCHPCOREPWM_PERIOD_STEPS_MAX: c_uint = 0xfe;
pub const MCHPCOREPWM_PERIOD_MAX: c_uint = 0xff00;
pub const MCHPCOREPWM_PRESCALE: c_uint = 0x00;
pub const MCHPCOREPWM_PERIOD: c_uint = 0x04;

pub const MCHPCOREPWM_SYNC_UPD: c_uint = 0xe4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp_core_pwm_chip {
    pub clk: *mut clk,
    pub base: *mut void __iomem,
    pub update_timestamp: ktime_t,
    pub sync_update_mask: u32,
...
//
    ...
    struct mchp_core_pwm_chip *mchp_core_pwm = to_mchp_core_pwm(chip);
    u8 posedge, negedge;
    let mut first_edge: u8 = 0, second_edge = duty_steps;
//
...
#[no_mangle]
unsafe extern "C" fn mchp_core_pwm_probe(pdev: *mut platform_device) -> c_int {
    ...
    mchp_core_pwm.clk = devm_clk_get_enabled(&pdev.dev, core::ptr::null_mut());
