...
//! Source: drivers/pwm/pwm-xilinx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn xilinx_timer_pwm_enabled(tcsr0: u32, tcsr1: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pwm_probe(pdev: *mut platform_device) -> c_int {
