...
//! Source: drivers/pwm/pwm-mediatek.c
#![no_std]
...
pub const PWMCON: c_uint = 0x00;

pub const PWMHDUR: c_uint = 0x04;
pub const PWMLDUR: c_uint = 0x08;
pub const PWMGDUR: c_uint = 0x0c;
pub const PWMWAVENUM: c_uint = 0x28;
pub const PWMDWIDTH: c_uint = 0x2c;

pub const PWM45DWIDTH_FIXUP: c_uint = 0x30;
pub const PWMTHRES: c_uint = 0x30;

pub const PWM45THRES_FIXUP: c_uint = 0x34;
pub const PWM_CK_26M_SEL_V3: c_uint = 0x74;
pub const PWM_CK_26M_SEL: c_uint = 0x210;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_mediatek_of_data {
    pub num_pwms: c_uint,
    pub clksel_fixup: bool,
    pub pwm45_fixup: bool,
    pub pwm_ck_26m_sel_reg: u16,
    pub chanreg_base: c_uint,
    pub chanreg_width: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_mediatek_chip {
    pub regs: *mut void __iomem,
    pub clk_top: *mut clk,
    pub clk_main: *mut clk,
    pub soc: *const pwm_mediatek_of_data,
    struct {
    pub clk: *mut clk,
    pub rate: c_ulong,
    pub clk_pwms: [}; ],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_mediatek_waveform {
    pub enable: u32,
    pub con: u32,
    pub width: u32,
    pub thres: u32,
...
// wf = (typeof(*wf)){
    ...
    let mut reg_width: u32 = PWMDWIDTH, reg_thres = PWMTHRES;
    int ret;
...
// wfhw = (typeof(*wfhw)){
    ...
    if (wfhw.enable) {
    let mut reg_width: u32 = PWMDWIDTH, reg_thres = PWMTHRES;
    let mut con_val: u32 = PWMCON_OLD_PWM_MODE | wfhw.con;
    if (pc.soc.pwm45_fixup && pwm.hwpwm > 2) {
//
// PWM[4,5] has distinct offset for PWMDWIDTH and PWMTHRES
// from the other PWMs on MT7623.
...
#[no_mangle]
unsafe extern "C" fn pwm_mediatek_init_used_clks(pc: *mut pwm_mediatek_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_mediatek_probe(pdev: *mut platform_device) -> c_int {
