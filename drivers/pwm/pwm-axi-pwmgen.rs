...
//! Source: drivers/pwm/pwm-axi-pwmgen.c
#![no_std]
...
pub const AXI_PWMGEN_REG_ID: c_uint = 0x04;
pub const AXI_PWMGEN_REG_SCRATCHPAD: c_uint = 0x08;
pub const AXI_PWMGEN_REG_CORE_MAGIC: c_uint = 0x0C;
pub const AXI_PWMGEN_REG_RSTN: c_uint = 0x10;

pub const AXI_PWMGEN_REG_NPWM: c_uint = 0x14;
pub const AXI_PWMGEN_REG_CONFIG: c_uint = 0x18;

pub const AXI_PWMGEN_REG_CORE_MAGIC_VAL: c_uint = 0x601A3471 /* Identification number to test during setup */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_pwmgen_ddata {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_pwmgen_waveform {
    pub period_cnt: u32,
    pub duty_cycle_cnt: u32,
    pub duty_offset_cnt: u32,
}
...
#[no_mangle]
unsafe extern "C" fn axi_pwmgen_setup(regmap: *mut regmap, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_pwmgen_probe(pdev: *mut platform_device) -> c_int {
...
//
    axi_clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(axi_clk))
