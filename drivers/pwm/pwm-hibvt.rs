...
//! Source: drivers/pwm/pwm-hibvt.c
#![no_std]
...
pub const PWM_ENABLE_SHIFT: c_int = 0;

pub const PWM_POLARITY_SHIFT: c_int = 1;

pub const PWM_KEEP_SHIFT: c_int = 2;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hibvt_pwm_chip {
    pub clk: *mut clk,
    pub base: *mut void __iomem,
    pub rstc: *mut reset_control,
    pub soc: *const hibvt_pwm_soc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hibvt_pwm_soc {
    pub num_pwms: u32,
    pub quirk_force_enable: bool,
}
...
#[no_mangle]
unsafe extern "C" fn hibvt_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn hibvt_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn hibvt_pwm_probe(pdev: *mut platform_device) -> c_int {
    ...
    hi_pwm_chip.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    ...
    if (ret < 0)
    return ret;
    hi_pwm_chip.rstc = devm_reset_control_get_exclusive(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hibvt_pwm_remove(pdev: *mut platform_device) {
