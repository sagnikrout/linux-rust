...
//! Source: drivers/pwm/pwm-argon-fan-hat.c
#![no_std]
...
pub const ARGON40_FAN_HAT_REG_DUTY_CYCLE: c_uint = 0x80;
...
#[no_mangle]
unsafe extern "C" fn argon_fan_hat_i2c_probe(i2c: *mut i2c_client) -> c_int {
