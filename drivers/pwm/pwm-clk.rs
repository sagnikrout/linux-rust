...
pub struct pwm_clk_chip {
    ...
    int ret;
    u32 rate;
    let mut period: u64 = state.period;
    let mut duty_cycle: u64 = state.duty_cycle;
    if (!state.enabled) {
...
#[no_mangle]
unsafe extern "C" fn pwm_clk_probe(pdev: *mut platform_device) -> c_int {
    ...
    pcchip.clk = devm_clk_get_prepared(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pwm_clk_remove(pdev: *mut platform_device) {
