...
//! Source: drivers/pwm/pwm-imx27.c
#![no_std]
...
pub const MX3_PWMCR: c_uint = 0x00    /* PWM Control Register */;
pub const MX3_PWMSR: c_uint = 0x04    /* PWM Status Register */;
pub const MX3_PWMSAR: c_uint = 0x0C    /* PWM Sample Register */;
pub const MX3_PWMPR: c_uint = 0x10    /* PWM Period Register */;
pub const MX3_PWMCNR: c_uint = 0x14    /* PWM Counter Register */;

pub const MX3_PWMCR_POUTC_NORMAL: c_int = 0;
pub const MX3_PWMCR_POUTC_INVERTED: c_int = 1;
pub const MX3_PWMCR_POUTC_OFF: c_int = 2;

pub const MX3_PWMCR_CLKSRC_OFF: c_int = 0;
pub const MX3_PWMCR_CLKSRC_IPG: c_int = 1;
pub const MX3_PWMCR_CLKSRC_IPG_HIGH: c_int = 2;
pub const MX3_PWMCR_CLKSRC_IPG_32K: c_int = 3;

pub const MX3_PWMCR_REPEAT_1X: c_int = 0;
pub const MX3_PWMCR_REPEAT_2X: c_int = 1;
pub const MX3_PWMCR_REPEAT_4X: c_int = 2;
pub const MX3_PWMCR_REPEAT_8X: c_int = 3;

pub const MX3_PWMSR_FIFOAV_EMPTY: c_int = 0;
pub const MX3_PWMSR_FIFOAV_1WORD: c_int = 1;
pub const MX3_PWMSR_FIFOAV_2WORDS: c_int = 2;
pub const MX3_PWMSR_FIFOAV_3WORDS: c_int = 3;
pub const MX3_PWMSR_FIFOAV_4WORDS: c_int = 4;

    (x)) + 1)
pub const MX3_PWM_SWR_LOOP: c_int = 5;
// PWMPR register value of 0xffff has the same effect as 0xfffe
pub const MX3_PWMPR_MAX: c_uint = 0xfffe;
    static const char * const pwm_imx27_clks[] = {"ipg", "per"};
pub const PWM_IMX27_PER: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_imx27_chip {
    pub clks: [clk_bulk_data; ARRAY_SIZE(pwm_imx27_clks)],
    pub clks_cnt: c_int,
...
#[no_mangle]
unsafe extern "C" fn pwm_imx27_sw_reset(chip: *mut pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn pwm_imx27_probe(pdev: *mut platform_device) -> c_int {
