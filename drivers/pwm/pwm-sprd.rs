...
pub const SPRD_PWM_PRESCALE: c_uint = 0x0;
pub const SPRD_PWM_MOD: c_uint = 0x4;
pub const SPRD_PWM_DUTY: c_uint = 0x8;
pub const SPRD_PWM_ENABLE: c_uint = 0x18;

pub const SPRD_PWM_CHN_NUM: c_int = 4;
pub const SPRD_PWM_REGS_SHIFT: c_int = 5;
pub const SPRD_PWM_CHN_CLKS_NUM: c_int = 2;
pub const SPRD_PWM_CHN_OUTPUT_CLK: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_pwm_chn {
    pub clks: [clk_bulk_data; SPRD_PWM_CHN_CLKS_NUM],
    pub clk_rate: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_pwm_chip {
    pub base: *mut void __iomem,
    pub chn: [sprd_pwm_chn; SPRD_PWM_CHN_NUM],
}

#[no_mangle]
pub unsafe extern "C" fn sprd_pwm_from_chip(chip: *mut pwm_chip) -> *mut sprd_pwm_chip {
...
#[no_mangle]
unsafe extern "C" fn sprd_pwm_read(spc: *mut sprd_pwm_chip, hwid: u32, reg: u32) -> u32 {
    static u32 sprd_pwm_read(struct sprd_pwm_chip *spc, u32 hwid, u32 reg)
    {
    let mut offset: u32 = reg + (hwid << SPRD_PWM_REGS_SHIFT);
...
#[no_mangle]
unsafe extern "C" fn sprd_pwm_probe(pdev: *mut platform_device) -> c_int {
