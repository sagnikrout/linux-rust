...
pub const STI_PWM_CTRL: c_uint = 0x50	/* Control/Config register */;
pub const STI_INT_EN: c_uint = 0x54	/* Interrupt Enable/Disable register */;
pub const STI_INT_STA: c_uint = 0x58	/* Interrupt Status register */;
pub const PWM_INT_ACK: c_uint = 0x5c;
pub const PWM_PRESCALE_LOW_MASK: c_uint = 0x0f;
pub const PWM_PRESCALE_HIGH_MASK: c_uint = 0xf0;
pub const PWM_CPT_EDGE_MASK: c_uint = 0x03;
pub const PWM_INT_ACK_MASK: c_uint = 0x1ff;
pub const STI_MAX_CPT_DEVS: c_int = 4;
pub const CPT_DC_MAX: c_uint = 0xff;
// Regfield IDs
    enum {
// Bits in PWM_CTRL
    PWMCLK_PRESCALE_LOW,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sti_pwm_chip {
    pub dev: *mut device,
    pub pwm_clk: *mut clk,
    pub cpt_clk: *mut clk,
    pub regmap: *mut regmap,
    pub pwm_num_devs: c_uint,
    pub cpt_num_devs: c_uint,
    pub max_pwm_cnt: c_uint,
    pub max_prescale: c_uint,
    pub ddata: *mut sti_cpt_ddata,
    pub prescale_low: *mut regmap_field,
    pub prescale_high: *mut regmap_field,
    pub pwm_out_en: *mut regmap_field,
    pub pwm_cpt_en: *mut regmap_field,
    pub pwm_cpt_int_en: *mut regmap_field,
    pub pwm_cpt_int_stat: *mut regmap_field,
    pub cur: *mut pwm_device,
    pub configured: c_ulong,
    pub en_count: c_uint,
...
//
    ...
    let mut period_same: bool = false;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sti_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sti_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn sti_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn sti_pwm_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sti_pwm_probe_regmap(pc: *mut sti_pwm_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sti_pwm_probe(pdev: *mut platform_device) -> c_int {
    static int sti_pwm_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct device_node *np = dev.of_node;
    u32 num_devs;
    let mut pwm_num_devs: c_uint = 0;
    let mut cpt_num_devs: c_uint = 0;
