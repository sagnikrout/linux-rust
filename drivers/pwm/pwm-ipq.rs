...
pub const IPQ_PWM_MIN_PERIOD_NS: c_int = 10;
//
// Two 32-bit registers for each PWM: REG0, and REG1.
// Base offset for PWM #i is at 8 * #i.
//
pub const IPQ_PWM_REG0: c_int = 0;

pub const IPQ_PWM_REG1: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn ipq_pwm_reg_read(pwm: *mut pwm_device, reg: c_uint) -> c_uint {
    static unsigned int ipq_pwm_reg_read(struct pwm_device *pwm, unsigned int reg)
    {
    struct ipq_pwm_chip *ipq_chip = ipq_pwm_from_chip(pwm.chip);
    let mut off: c_uint = 8 * pwm.hwpwm + reg;
...
#[no_mangle]
unsafe extern "C" fn ipq_pwm_probe(pdev: *mut platform_device) -> c_int {
