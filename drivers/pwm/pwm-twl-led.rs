...
//! Source: drivers/pwm/pwm-twl-led.c
#![no_std]
...
//
pub const TWL4030_LED_MAX: c_uint = 0x7f;
pub const TWL6030_LED_MAX: c_uint = 0xff;
// Registers, bits and macro for TWL4030
pub const TWL4030_LEDEN_REG: c_uint = 0x00;
pub const TWL4030_PWMA_REG: c_uint = 0x01;

// Register, bits and macro for TWL6030
pub const TWL6030_LED_PWM_CTRL1: c_uint = 0xf4;
pub const TWL6030_LED_PWM_CTRL2: c_uint = 0xf5;
pub const TWL6040_LED_MODE_HW: c_uint = 0x00;
pub const TWL6040_LED_MODE_ON: c_uint = 0x01;
pub const TWL6040_LED_MODE_OFF: c_uint = 0x02;
pub const TWL6040_LED_MODE_MASK: c_uint = 0x03;
    ...
    {
    let mut duty_cycle: c_int = DIV_ROUND_UP(duty_ns * TWL4030_LED_MAX, period_ns) + 1;
    u8 pwm_config[2] = { 1, 0 };
    int base, ret;
//
...
//
    ...
    duty_cycle = 2;
#[no_mangle]
pub unsafe extern "C" fn if(TWL4030_LED_MAX: duty_cycle >) -> else {
...
#[no_mangle]
unsafe extern "C" fn twl4030_pwmled_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
//
    ...
    int duty_ns, int period_ns)
    {
    let mut duty_cycle: c_int = (duty_ns * TWL6030_LED_MAX) / period_ns;
    u8 on_time;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn twl6030_pwmled_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6030_pwmled_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6030_pwmled_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn twl_pwmled_probe(pdev: *mut platform_device) -> c_int {
