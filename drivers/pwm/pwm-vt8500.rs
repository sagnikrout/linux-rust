...
//! Source: drivers/pwm/pwm-vt8500.c
#![no_std]
...
//
pub const VT8500_NR_PWMS: c_int = 2;

pub const REG_STATUS: c_uint = 0x40;

pub const STATUS_ALL_UPDATE: c_uint = 0x0F;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vt8500_chip {
...
#[no_mangle]
pub unsafe extern "C" fn vt8500_pwm_busy_wait(chip: *mut pwm_chip, nr: c_int, bitmask: u8) {
...
#[no_mangle]
unsafe extern "C" fn vt8500_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt8500_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn vt8500_pwm_probe(pdev: *mut platform_device) -> c_int {
    ...
    vt8500.clk = devm_clk_get_prepared(&pdev.dev, core::ptr::null_mut());
