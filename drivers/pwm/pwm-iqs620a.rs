...
//! Source: drivers/pwm/pwm-iqs620a.c
#![no_std]
...
pub const IQS620_PWR_SETTINGS: c_uint = 0xd2;

pub const IQS620_PWM_DUTY_CYCLE: c_uint = 0xd8;
pub const IQS620_PWM_PERIOD_NS: c_int = 1000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs620_pwm_private {
    pub iqs62x: *mut iqs62x_core,
    pub dev: *mut device,
    pub notifier: notifier_block,
    pub lock: mutex,
    pub duty_scale: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn iqs620_pwm_notifier_unregister(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iqs620_pwm_probe(pdev: *mut platform_device) -> c_int {
