...
pub const PWM_MINOR_COUNT: c_int = 256;
// protects access to pwm_chips
    static DEFINE_MUTEX(pwm_lock);
    static DEFINE_IDR(pwm_chips);
#[no_mangle]
unsafe extern "C" fn pwmchip_lock(chip: *mut pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn pwmchip_unlock(chip: *mut pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn pwm_wf_valid(wf: *const pwm_waveform) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pwm_wf2state(wf: *const pwm_waveform, state: *mut pwm_state) {
...
#[no_mangle]
unsafe extern "C" fn pwm_state2wf(state: *const pwm_state, wf: *mut pwm_waveform) {
...
#[no_mangle]
unsafe extern "C" fn pwmwfcmp(a: *const pwm_waveform, b: *const pwm_waveform) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pwm_read_waveform(chip: *mut pwm_chip, pwm: *mut pwm_device, wfhw: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pwm_write_waveform(chip: *mut pwm_chip, pwm: *mut pwm_device, wfhw: *const c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_round_waveform_might_sleep(pwm: *mut pwm_device, wf: *mut pwm_waveform) -> c_int {
    int pwm_round_waveform_might_sleep(struct pwm_device *pwm, struct pwm_waveform *wf)
    {
    struct pwm_chip *chip = pwm.chip;
    const struct pwm_ops *ops = chip.ops;
    let mut wf_req: pwm_waveform = *wf;
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_get_waveform_might_sleep(pwm: *mut pwm_device, wf: *mut pwm_waveform) -> c_int {
...
//
    ...
    err = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(1: exact && err ==) -> else {
    else if (exact && err == 1)
    err = -EDOM;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn pwm_state_valid(state: *const pwm_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __pwm_apply(pwm: *mut pwm_device, state: *const pwm_state) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_apply_might_sleep(pwm: *mut pwm_device, state: *const pwm_state) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_apply_atomic(pwm: *mut pwm_device, state: *const pwm_state) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_get_state_hw(pwm: *mut pwm_device, state: *mut pwm_state) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_adjust_config(pwm: *mut pwm_device) -> c_int {
...
//
    ...
    let mut dutycycle: u64 = (u64)state.duty_cycle * pargs.period;
...
#[no_mangle]
unsafe extern "C" fn pwm_device_request(pwm: *mut pwm_device, label: *const c_char) -> c_int {
...
// period in the second cell and flags in the third cell are optional
    ...
    return ERR_PTR(-EINVAL);
    pwm = pwm_request_from_chip(chip, args.args[0], core::ptr::null_mut());
    if (IS_ERR(pwm))
    return pwm;
    if (args.args_count > 1)
...
//
    ...
    pwm = pwm_request_from_chip(chip, 0, core::ptr::null_mut());
    if (IS_ERR(pwm))
    return pwm;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_export {
    pub pwm_dev: device,
    pub pwm: *mut pwm_device,
    pub lock: mutex,
    pub suspend: pwm_state,
}
    ...
    polarity = PWM_POLARITY_NORMAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "inversed")) -> else {
...
#[no_mangle]
unsafe extern "C" fn pwm_export_release(pwm_dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn pwm_export_child(pwmchip_dev: *mut device, pwm: *mut pwm_device) -> c_int {
    ...
    export = core::ptr::null_mut();
    return ret;
    }
    pwm_prop[0] = kasprintf(GFP_KERNEL, "EXPORT=pwm%u", pwm.hwpwm);
    pwm_prop[1] = core::ptr::null_mut();
    kobject_uevent_env(&pwmchip_dev.kobj, KOBJ_CHANGE, pwm_prop);
    kfree(pwm_prop[0]);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pwm_unexport_match(pwm_dev: *mut device, data: *const c_void) -> c_int {
    static int pwm_unexport_match(struct device *pwm_dev, const void *data)
    {
    return pwm_from_dev(pwm_dev) == data;
    }
#[no_mangle]
unsafe extern "C" fn pwm_unexport_child(pwmchip_dev: *mut device, pwm: *mut pwm_device) -> c_int {
...
// takes export->lock on success
    ...
    struct pwm_state *state)
    {
    let mut ret: c_int = pwm_apply_might_sleep(pwm, state);
// release lock taken in pwm_class_get_state
    mutex_unlock(&export.lock);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn pwm_class_resume_npwm(pwmchip_dev: *mut device, npwm: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_class_suspend(pwmchip_dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_class_resume(pwmchip_dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwmchip_sysfs_unexport(chip: *mut pwm_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn pwmchip_put(chip: *mut pwm_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn pwmchip_release(pwmchip_dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn devm_pwmchip_put(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn of_pwmchip_add(chip: *mut pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn of_pwmchip_remove(chip: *mut pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn pwm_ops_check(chip: *const pwm_chip) -> bool {
...
//
    ...
    const char *con_id)
    {
    struct pwm_device *pwm = core::ptr::null_mut();
...
//
    ...
    {
    const struct fwnode_handle *fwnode = dev ? dev_fwnode(dev) : core::ptr::null_mut();
    const char *dev_id = dev ? dev_name(dev) : core::ptr::null_mut();
    struct pwm_device *pwm;
    struct pwm_chip *chip;
    struct device_link *dl;
    let mut best: c_uint = 0;
    struct pwm_lookup *p, *chosen = core::ptr::null_mut();
    unsigned int match;
    int err;
...
#[no_mangle]
unsafe extern "C" fn __pwm_put(pwm: *mut pwm_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_put(pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn devm_pwm_release(pwm: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_cdev_data {
    pub chip: *mut pwm_chip,
    pub pwm: [*mut pwm_device; ],
}

#[no_mangle]
unsafe extern "C" fn pwm_cdev_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_cdev_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_cdev_request(cdata: *mut pwm_cdev_data, hwpwm: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_cdev_free(cdata: *mut pwm_cdev_data, hwpwm: c_uint) -> c_int {
    ...
    __pwm_put(pwm);
    kfree(label);
    cdata.pwm[hwpwm] = core::ptr::null_mut();
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn pwm_cdev_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn pwm_gpio_request(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_gpio_free(gc: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pwm_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
    static int pwm_gpio_get_direction(struct gpio_chip *gc, unsigned int offset)
    {
    return GPIO_LINE_DIRECTION_OUT;
    }
#[no_mangle]
unsafe extern "C" fn pwm_gpio_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __pwmchip_add(chip: *mut pwm_chip, owner: *mut module) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwmchip_remove(chip: *mut pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn devm_pwmchip_remove(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn __devm_pwmchip_add(dev: *mut device, chip: *mut pwm_chip, owner: *mut module) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_add_table(table: *mut pwm_lookup, num: usize) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwm_remove_table(table: *mut pwm_lookup, num: usize) {
...
#[no_mangle]
unsafe extern "C" fn pwm_dbg_show(chip: *mut pwm_chip, s: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn pwm_seq_stop(s: *mut seq_file, v: *mut c_void) {
    static void pwm_seq_stop(struct seq_file *s, void *v)
    {
    mutex_unlock(&pwm_lock);
    }
#[no_mangle]
unsafe extern "C" fn pwm_seq_show(s: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_init() -> int __init {
    ...
    debugfs_create_file("pwm", 0444, core::ptr::null_mut(), core::ptr::null_mut(), &pwm_debugfs_fops);
    return 0;
    }
