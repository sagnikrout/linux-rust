...
//! Source: drivers/pwm/pwm-sifive.c
#![no_std]
...
// Register offsets
pub const PWM_SIFIVE_PWMCFG: c_uint = 0x0;
pub const PWM_SIFIVE_PWMCOUNT: c_uint = 0x8;
pub const PWM_SIFIVE_PWMS: c_uint = 0x10;

// PWMCFG fields

pub const PWM_SIFIVE_CMPWIDTH: c_int = 16;
pub const PWM_SIFIVE_DEFAULT_PERIOD: c_int = 10000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_sifive_ddata {
    pub parent: *mut device,
    pub /: *mut *mut mutex lock; / lock to protect user_count and approx_period,
    pub notifier: notifier_block,
    pub clk: *mut clk,
    pub regs: *mut void __iomem,
    pub real_period: c_uint,
    pub approx_period: c_uint,
    pub user_count: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn pwm_sifive_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_sifive_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn pwm_sifive_probe(pdev: *mut platform_device) -> c_int {
    ...
    int ret;
    u32 val;
    let mut enabled_pwms: c_uint = 0, enabled_clks = 1;
    ...
    ddata.clk = devm_clk_get_prepared(dev, core::ptr::null_mut());
    if (IS_ERR(ddata.clk))
...
#[no_mangle]
unsafe extern "C" fn pwm_sifive_remove(dev: *mut platform_device) {
