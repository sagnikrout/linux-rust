...
//! Source: drivers/pwm/pwm-sl28cpld.c
#![no_std]
...
//
pub const SL28CPLD_PWM_CTRL: c_uint = 0x00;

pub const SL28CPLD_PWM_CYCLE: c_uint = 0x01;
...
#[no_mangle]
unsafe extern "C" fn sl28cpld_pwm_probe(pdev: *mut platform_device) -> c_int {
