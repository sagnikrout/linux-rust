...
//! Source: drivers/pwm/pwm-meson.c
#![no_std]
...
pub const REG_PWM_A: c_uint = 0x0;
pub const REG_PWM_B: c_uint = 0x4;

pub const REG_MISC_AB: c_uint = 0x8;
pub const MISC_B_CLK_EN_SHIFT: c_int = 23;
pub const MISC_A_CLK_EN_SHIFT: c_int = 15;
pub const MISC_CLK_DIV_WIDTH: c_int = 7;
pub const MISC_B_CLK_DIV_SHIFT: c_int = 16;
pub const MISC_A_CLK_DIV_SHIFT: c_int = 8;
pub const MISC_B_CLK_SEL_SHIFT: c_int = 6;
pub const MISC_A_CLK_SEL_SHIFT: c_int = 4;
pub const MISC_CLK_SEL_MASK: c_uint = 0x3;

pub const MESON_NUM_PWMS: c_int = 2;
pub const MESON_NUM_MUX_PARENTS: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_pwm_data {
    pub parent_names: [*const *const c_char; MESON_NUM_MUX_PARENTS],
    pub chip): *mut *mut int (channels_init)(struct pwm_chip,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_pwm {
    pub data: *const meson_pwm_data,
    pub channels: [meson_pwm_channel; MESON_NUM_PWMS],
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_cnt_to_ns(fin_freq: c_ulong, cnt: u32) -> u64 {
    ...
    let mut div_parent: clk_parent_data = {}, gate_parent = {};
    ...
    channel.mux.table = core::ptr::null_mut();
    ...
    channel.clk = devm_clk_hw_get_clk(dev, &channel.gate.hw, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_init_channels_meson8b_legacy(chip: *mut pwm_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_init_channels_meson8b_v2(chip: *mut pwm_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_s4_put_clk(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_init_channels_s4(chip: *mut pwm_chip) -> c_int {
    ...
    .parent_names = { "xtal", core::ptr::null_mut(), "fclk_div4", "fclk_div3" },
...
//
    ...
    .parent_names = { "xtal", "clk81", core::ptr::null_mut(), core::ptr::null_mut() },
    .channels_init = meson_pwm_init_channels_meson8b_legacy,
    };
    ...
    .parent_names = { "xtal", "g12a_ao_clk81", core::ptr::null_mut(), core::ptr::null_mut() },
    .channels_init = meson_pwm_init_channels_meson8b_legacy,
    .has_constant = true,
    .has_polarity = true,
    };
...
#[no_mangle]
unsafe extern "C" fn meson_pwm_probe(pdev: *mut platform_device) -> c_int {
