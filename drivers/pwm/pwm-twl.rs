...
//
pub const TWL_PWM_MAX: c_uint = 0x7f;
// Registers, bits and macro for TWL4030
pub const TWL4030_GPBR1_REG: c_uint = 0x0c;
...
pub const TWL6030_TOGGLE3_REG: c_uint = 0x92;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl_pwm_chip {
    pub mutex: mutex,
    pub twl6030_toggle3: u8,
    pub twl4030_pwm_mux: u8,
}
    ...
    {
    let mut duty_cycle: c_int = DIV64_U64_ROUND_UP(duty_ns * TWL_PWM_MAX, period_ns) + 1;
    u8 pwm_config[2] = { 1, 0 };
    int base, ret;
//
...
//
    ...
    duty_cycle = 2;
#[no_mangle]
pub unsafe extern "C" fn if(TWL_PWM_MAX: duty_cycle >) -> else {
...
#[no_mangle]
unsafe extern "C" fn twl4030_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn twl4030_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn twl6030_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6030_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn twl_pwm_probe(pdev: *mut platform_device) -> c_int {
