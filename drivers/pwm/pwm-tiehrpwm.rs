...
//! Source: drivers/pwm/pwm-tiehrpwm.c
#![no_std]
...
pub const TBCTL: c_uint = 0x00;
pub const TBPRD: c_uint = 0x0A;

pub const TBCTL_PRDLD_SHDW: c_int = 0;

    BIT(8) | BIT(7))

pub const TBCTL_CTRMODE_UP: c_int = 0;

pub const TBCTL_HSPCLKDIV_SHIFT: c_int = 7;
pub const TBCTL_CLKDIV_SHIFT: c_int = 10;
pub const CLKDIV_MAX: c_int = 7;
pub const HSPCLKDIV_MAX: c_int = 7;
pub const PERIOD_MAX: c_uint = 0x10000;
// compare module registers
pub const CMPA: c_uint = 0x12;
pub const CMPB: c_uint = 0x14;
// Action qualifier module registers
pub const AQCTLA: c_uint = 0x16;
pub const AQCTLB: c_uint = 0x18;
pub const AQSFRC: c_uint = 0x1A;
pub const AQCSFRC: c_uint = 0x1C;

pub const AQSFRC_RLDCSF_ZRO: c_int = 0;

pub const AQCSFRC_CSFB_FRCDIS: c_int = 0;

pub const AQCSFRC_CSFA_FRCDIS: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ehrpwm_context {
    pub tbctl: u16,
    pub tbprd: u16,
    pub cmpa: u16,
    pub cmpb: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ehrpwm_pwm_chip {
    pub clk_rate: c_ulong,
    pub mmio_base: *mut void __iomem,
    pub period_cycles: [c_ulong; NUM_PWM_CHANNEL],
    pub tbclk: *mut clk,
    pub ctx: ehrpwm_context,
}
...
#[no_mangle]
pub unsafe extern "C" fn ehrpwm_read(base: *mut void __iomem, offset: c_uint) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_save_context(chip: *mut pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_restore_context(chip: *mut pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ehrpwm_pwm_resume(dev: *mut device) -> c_int {
