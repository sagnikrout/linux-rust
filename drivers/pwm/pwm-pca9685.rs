...
//! Source: drivers/pwm/pwm-pca9685.c
#![no_std]
...
//
pub const PCA9685_MODE1: c_uint = 0x00;
pub const PCA9685_MODE2: c_uint = 0x01;
pub const PCA9685_SUBADDR1: c_uint = 0x02;
pub const PCA9685_SUBADDR2: c_uint = 0x03;
pub const PCA9685_SUBADDR3: c_uint = 0x04;
pub const PCA9685_ALLCALLADDR: c_uint = 0x05;
pub const PCA9685_LEDX_ON_L: c_uint = 0x06;
pub const PCA9685_LEDX_ON_H: c_uint = 0x07;
pub const PCA9685_LEDX_OFF_L: c_uint = 0x08;
pub const PCA9685_LEDX_OFF_H: c_uint = 0x09;
pub const PCA9685_ALL_LED_ON_L: c_uint = 0xFA;
pub const PCA9685_ALL_LED_ON_H: c_uint = 0xFB;
pub const PCA9685_ALL_LED_OFF_L: c_uint = 0xFC;
pub const PCA9685_ALL_LED_OFF_H: c_uint = 0xFD;
pub const PCA9685_PRESCALE: c_uint = 0xFE;
pub const PCA9685_PRESCALE_MIN: c_uint = 0x03	/* => max. frequency of 1526 Hz */;
pub const PCA9685_PRESCALE_MAX: c_uint = 0xFF	/* => min. frequency of 24 Hz */;
pub const PCA9685_COUNTER_RANGE: c_int = 4096;
...
pub const PCA9685_NUMREGS: c_uint = 0xFF;
pub const PCA9685_MAXCHAN: c_uint = 0x10;
...
pub struct pca9685 {
    ...
    pub lock: mutex,
    pub 1): DECLARE_BITMAP(pwms_enabled, PCA9685_MAXCHAN +,
}
...
#[no_mangle]
unsafe extern "C" fn pca9685_prescaler_can_change(pca: *mut pca9685, channel: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pca9685_read_reg(chip: *mut pwm_chip, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9685_write_reg(chip: *mut pwm_chip, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9685_write_4reg(chip: *mut pwm_chip, reg: c_uint, val[4]: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9685_set_sleep_mode(chip: *mut pwm_chip, enable: bool) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pca9685_waveform {
    pub onoff: [u8; 4],
    pub prescale: u8,
}

#[no_mangle]
unsafe extern "C" fn pca9685_round_waveform_tohw(chip: *mut pwm_chip, pwm: *mut pwm_device, wf: *const pwm_waveform, _wfhw: *mut c_void) -> c_int {
...
// wfhw = (typeof(*wfhw)){
    ...
    let mut on: c_uint = wfhw.onoff[0] | (wfhw.onoff[1] & 0xf) << 8;
    let mut off: c_uint = wfhw.onoff[2] | (wfhw.onoff[3] & 0xf) << 8;
...
#[no_mangle]
unsafe extern "C" fn pca9685_read_waveform(chip: *mut pwm_chip, pwm: *mut pwm_device, _wfhw: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9685_write_waveform(chip: *mut pwm_chip, pwm: *mut pwm_device, _wfhw: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9685_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9685_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn pca9685_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pca9685_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool pca9685_writeable_reg(struct device *dev, unsigned int reg)
    {
    return reg <= REG_OFF_H(15) || reg >= PCA9685_ALL_LED_ON_L;
    }
#[no_mangle]
unsafe extern "C" fn pca9685_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pca9685_pwm_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9685_pwm_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn pca9685_pwm_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn pca9685_pwm_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    pca9685_pwm_runtime_resume, core::ptr::null_mut())
    };
