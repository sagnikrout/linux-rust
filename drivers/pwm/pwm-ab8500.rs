...
//! Source: drivers/pwm/pwm-ab8500.c
#![no_std]
...
// Bank: 0x10
//
pub const AB8500_PWM_OUT_CTRL1_REG: c_uint = 0x60;
pub const AB8500_PWM_OUT_CTRL2_REG: c_uint = 0x61;
pub const AB8500_PWM_OUT_CTRL7_REG: c_uint = 0x66;
pub const AB8500_PWM_CLKRATE: c_int = 9600000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_pwm_chip {
    pub hwid: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ab8500_pwm_probe(pdev: *mut platform_device) -> c_int {
