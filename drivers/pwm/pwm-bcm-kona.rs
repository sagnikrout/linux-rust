...
//! Source: drivers/pwm/pwm-bcm-kona.c
#![no_std]
...
//
pub const PWM_CONTROL_OFFSET: c_uint = 0x00000000;

pub const PRESCALE_OFFSET: c_uint = 0x00000004;

pub const PRESCALE_MIN: c_uint = 0x00000000;
pub const PRESCALE_MAX: c_uint = 0x00000007;

pub const PERIOD_COUNT_MIN: c_uint = 0x00000002;
pub const PERIOD_COUNT_MAX: c_uint = 0x00ffffff;

pub const DUTY_CYCLE_HIGH_MIN: c_uint = 0x00000000;
pub const DUTY_CYCLE_HIGH_MAX: c_uint = 0x00ffffff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kona_pwmc {
...
//
    ...
    unsigned int chan)
    {
    let mut value: c_uint = readl(kp.base + PWM_CONTROL_OFFSET);
...
#[no_mangle]
unsafe extern "C" fn kona_pwmc_apply_settings(kp: *mut kona_pwmc, chan: c_uint) {
...
// Trigger bit must be held high for at least 400 ns.
    ...
    u64 div, rate;
    let mut prescale: c_ulong = PRESCALE_MIN, pc, dc;
...
#[no_mangle]
unsafe extern "C" fn kona_pwmc_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kona_pwmc_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn kona_pwmc_probe(pdev: *mut platform_device) -> c_int {
    ...
    kp.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(kp.clk)) {
