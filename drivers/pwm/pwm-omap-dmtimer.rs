...
//! Source: drivers/pwm/pwm-omap-dmtimer.c
#![no_std]
...
pub const DM_TIMER_LOAD_MIN: c_uint = 0xfffffffe;
pub const DM_TIMER_MAX: c_uint = 0xffffffff;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_omap_dmtimer_chip {
// Mutex to protect pwm apply state
    pub dm_timer: *mut omap_dm_timer,
    pub pdata: *const omap_dm_timer_ops,
    pub dm_timer_pdev: *mut platform_device,
}
...
//
#[no_mangle]
unsafe extern "C" fn pwm_omap_dmtimer_get_clock_cycles(clk_rate: c_ulong, ns: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn pwm_omap_dmtimer_start(omap: *mut pwm_omap_dmtimer_chip) {
...
//
#[no_mangle]
unsafe extern "C" fn pwm_omap_dmtimer_is_enabled(omap: *mut pwm_omap_dmtimer_chip) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pwm_omap_dmtimer_polarity(omap: *mut pwm_omap_dmtimer_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_omap_dmtimer_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!timer_pdata) {
    dev_dbg(&pdev.dev,
    "dmtimer pdata structure core::ptr::null_mut(), deferring probe\n");
    ret = -EPROBE_DEFER;
    goto err_platdata;
    }
...
#[no_mangle]
unsafe extern "C" fn pwm_omap_dmtimer_remove(pdev: *mut platform_device) {
