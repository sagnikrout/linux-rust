...
//! Source: drivers/pwm/pwm-mc33xs2410.c
#![no_std]
...
pub const MC33XS2410_GLB_CTRL: c_uint = 0x00;

pub const MC33XS2410_PWM_CTRL1: c_uint = 0x05;
// chan in { 1 ... 4 }

pub const MC33XS2410_PWM_CTRL3: c_uint = 0x07;
// chan in { 1 ... 4 }
...
pub const MC33XS2410_WDT: c_uint = 0x14;
pub const MC33XS2410_PWM_MIN_PERIOD: c_int = 488282;
// step in { 0 ... 3 }

pub const MC33XS2410_MAX_TRANSFERS: c_int = 5;
...
#[no_mangle]
unsafe extern "C" fn mc33xs2410_write_reg(spi: *mut spi_device, reg: u8, val: u8) -> c_int {
    static int mc33xs2410_write_reg(struct spi_device *spi, u8 reg, u8 val)
    {
    return mc33xs2410_write_regs(spi, &reg, &val, 1);
    }
#[no_mangle]
unsafe extern "C" fn mc33xs2410_read_reg(spi: *mut spi_device, reg: u8, val: *mut u16, flag: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc33xs2410_read_reg_ctrl(spi: *mut spi_device, reg: u8, val: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc33xs2410_read_reg_diag(spi: *mut spi_device, reg: u8, val: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc33xs2410_modify_reg(spi: *mut spi_device, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc33xs2410_pwm_get_freq(period: u64) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mc33xs2410_pwm_get_period(reg: u8) -> u64 {
...
// Duty cycle
    ...
    wr_val[1] = rel_dc;
#[no_mangle]
pub unsafe extern "C" fn if(PWM_POLARITY_NORMAL: state->polarity ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mc33xs2410_reset(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc33xs2410_probe(spi: *mut spi_device) -> c_int {
...
// Transition to normal mode
    ...
    adev = devm_auxiliary_device_create(dev, "hwmon", core::ptr::null_mut());
    if (!adev)
