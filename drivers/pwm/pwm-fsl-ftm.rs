...
//! Source: drivers/pwm/pwm-fsl-ftm.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_ftm_soc {
    pub has_enable_bits: bool,
    pub has_flt_reg: bool,
    pub npwm: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_pwm_periodcfg {
    pub clk_select: enum fsl_pwm_clk,
    pub clk_ps: c_uint,
    pub mod_period: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_pwm_chip {
    pub regmap: *mut regmap,
// This value is valid iff a pwm is running
    pub period: fsl_pwm_periodcfg,
    pub ipg_clk: *mut clk,
    pub clk: [*mut clk; FSL_PWM_CLK_MAX],
    pub soc: *const fsl_ftm_soc,
}
...
#[no_mangle]
unsafe extern "C" fn ftm_clear_write_protection(fpc: *mut fsl_pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn ftm_set_write_protection(fpc: *mut fsl_pwm_chip) {
...
#[no_mangle]
unsafe extern "C" fn fsl_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
    ...
    let mut period: c_uint = fpc.period.mod_period + 1;
    let mut period_ns: c_uint = fsl_pwm_ticks_to_ns(fpc, period);
    if (!period_ns)
    return 0;
    ...
    u32 reg_polarity;
    struct fsl_pwm_periodcfg periodcfg;
    let mut do_write_period: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !fsl_pwm_periodcfg_are_equal(&fpc->period, _arg: &periodcfg)) -> else {
    ...
    int ret;
    let mut oldclk: enum fsl_pwm_clk = fpc.period.clk_select;
    let mut newclk: enum fsl_pwm_clk = periodcfg.clk_select;
...
#[no_mangle]
unsafe extern "C" fn fsl_pwm_init(fpc: *mut fsl_pwm_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_pwm_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fsl_pwm_is_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fsl_pwm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_pwm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_pwm_resume(dev: *mut device) -> c_int {
