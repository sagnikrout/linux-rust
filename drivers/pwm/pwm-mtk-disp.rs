...
//! Source: drivers/pwm/pwm-mtk-disp.c
#![no_std]
...
pub const DISP_PWM_EN: c_uint = 0x00;
pub const PWM_CLKDIV_SHIFT: c_int = 16;
pub const PWM_CLKDIV_MAX: c_uint = 0x3ff;

pub const PWM_PERIOD_BIT_WIDTH: c_int = 12;

pub const PWM_HIGH_WIDTH_SHIFT: c_int = 16;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_pwm_data {
    pub enable_mask: u32,
    pub con0: c_uint,
    pub con0_sel: u32,
    pub con1: c_uint,
    pub has_commit: bool,
    pub commit: c_uint,
    pub commit_mask: c_uint,
    pub bls_debug: c_uint,
    pub bls_debug_mask: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_disp_pwm {
    pub data: *const mtk_pwm_data,
...
#[no_mangle]
unsafe extern "C" fn mtk_disp_pwm_probe(pdev: *mut platform_device) -> c_int {
