...
//! Source: drivers/pwm/pwm-ep93xx.c
#![no_std]
...
pub const EP93XX_PWMx_TERM_COUNT: c_uint = 0x00;
pub const EP93XX_PWMx_DUTY_CYCLE: c_uint = 0x04;
pub const EP93XX_PWMx_ENABLE: c_uint = 0x08;
pub const EP93XX_PWMx_INVERT: c_uint = 0x0c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ep93xx_pwm {
    ...
    let mut enabled: bool = state.enabled;
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pwm_probe(pdev: *mut platform_device) -> c_int {
