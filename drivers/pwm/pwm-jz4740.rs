...
//! Source: drivers/pwm/pwm-jz4740.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn jz4740_pwm_can_use_chn(chip: *mut pwm_chip, channel: c_uint) -> bool {
    static bool jz4740_pwm_can_use_chn(struct pwm_chip *chip, unsigned int channel)
    {
// Enable all TCU channels for PWM use by default except channels 0/1
    let mut pwm_channels_mask: u32 = GENMASK(chip.npwm - 1, 2);
...
#[no_mangle]
unsafe extern "C" fn jz4740_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
// Stop counter
    ...
    {
    struct jz4740_pwm_chip *jz = to_jz4740(chip);
    let mut tmp: c_ulonglong = 0xffffull * NSEC_PER_SEC;
    struct clk *clk = jz.clk[pwm.hwpwm];
...
#[no_mangle]
unsafe extern "C" fn jz4740_pwm_probe(pdev: *mut platform_device) -> c_int {
