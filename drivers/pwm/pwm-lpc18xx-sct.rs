...
//! Source: drivers/pwm/pwm-lpc18xx-sct.c
#![no_std]
...
pub const LPC18XX_PWM_CONFIG: c_uint = 0x000;

pub const LPC18XX_PWM_CTRL: c_uint = 0x004;

pub const LPC18XX_PWM_PRE_SHIFT: c_int = 5;

pub const LPC18XX_PWM_LIMIT: c_uint = 0x008;
pub const LPC18XX_PWM_RES_BASE: c_uint = 0x058;

pub const LPC18XX_PWM_MATCH_BASE: c_uint = 0x100;

pub const LPC18XX_PWM_MATCHREL_BASE: c_uint = 0x200;

pub const LPC18XX_PWM_EVSTATEMSK_BASE: c_uint = 0x300;

pub const LPC18XX_PWM_EVSTATEMSK_ALL: c_uint = 0xffffffff;
pub const LPC18XX_PWM_EVCTRL_BASE: c_uint = 0x304;

pub const LPC18XX_PWM_EVCTRL_COMB_SHIFT: c_int = 12;

pub const LPC18XX_PWM_OUTPUTSET_BASE: c_uint = 0x500;

pub const LPC18XX_PWM_OUTPUTCL_BASE: c_uint = 0x504;

// LPC18xx SCT unified counter
pub const LPC18XX_PWM_TIMER_MAX: c_uint = 0xffffffff;
// LPC18xx SCT events
pub const LPC18XX_PWM_EVENT_PERIOD: c_int = 0;
pub const LPC18XX_PWM_EVENT_MAX: c_int = 16;
pub const LPC18XX_NUM_PWMS: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc18xx_pwm_data {
    pub duty_event: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc18xx_pwm_chip {
    pub base: *mut void __iomem,
    pub pwm_clk: *mut clk,
    pub clk_rate: c_ulong,
    pub period_ns: c_uint,
    pub min_period_ns: c_uint,
    pub max_period_ns: u64,
    pub period_event: c_uint,
    pub event_map: c_ulong,
    pub channeldata: [lpc18xx_pwm_data; LPC18XX_NUM_PWMS],
}
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pwm_config_period(chip: *mut pwm_chip, period_ns: u64) {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pwm_enable(chip: *mut pwm_chip, pwm: *mut pwm_device, polarity: enum pwm_polarity) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pwm_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pwm_free(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pwm_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pwm_remove(pdev: *mut platform_device) {
