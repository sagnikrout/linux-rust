...
//! Source: drivers/pwm/pwm-max7360.c
#![no_std]
...
pub const MAX7360_NUM_PWMS: c_int = 8;
pub const MAX7360_PWM_MAX: c_int = 255;
pub const MAX7360_PWM_STEPS: c_int = 256;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max7360_pwm_waveform {
    pub duty_steps: u8,
    pub enabled: bool,
}

#[no_mangle]
unsafe extern "C" fn max7360_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max7360_pwm_probe(pdev: *mut platform_device) -> c_int {
