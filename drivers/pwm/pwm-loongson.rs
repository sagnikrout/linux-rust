...
//! Source: drivers/pwm/pwm-loongson.c
#![no_std]
...
pub const LOONGSON_PWM_REG_DUTY: c_uint = 0x4 /* Low Pulse Buffer Register */;
pub const LOONGSON_PWM_REG_PERIOD: c_uint = 0x8 /* Pulse Period Buffer Register */;
pub const LOONGSON_PWM_REG_CTRL: c_uint = 0xc /* Control Register */;
...
#[no_mangle]
pub unsafe extern "C" fn pwm_loongson_readl(ddata: *mut pwm_loongson_ddata, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pwm_loongson_disable(chip: *mut pwm_chip, pwm: *mut pwm_device) {
...
#[no_mangle]
unsafe extern "C" fn pwm_loongson_enable(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_loongson_probe(pdev: *mut platform_device) -> c_int {
    ...
    ddata.clk = devm_clk_get_optional_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(ddata.clk))
...
#[no_mangle]
unsafe extern "C" fn pwm_loongson_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_loongson_resume(dev: *mut device) -> c_int {
