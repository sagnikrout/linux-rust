...
#[no_mangle]
pub unsafe extern "C" fn read_pmtmr() -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pmtmr_register_suspend_resume_callback(data: *mut *mut void (cb)(void, suspend): bool, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_pm_resume(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn acpi_pm_read(cs: *mut clocksource) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn acpi_pm_good_setup(__str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_pm_read_slow(cs: *mut clocksource) -> u64 {
    static u64 acpi_pm_read_slow(struct clocksource *cs)
    {
    return (u64)acpi_pm_read_verified();
    }
#[no_mangle]
pub unsafe extern "C" fn acpi_pm_need_workaround() {
...
#[no_mangle]
unsafe extern "C" fn acpi_pm_check_graylist(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn verify_pmtmr_rate() -> c_int {
...
pub const ACPI_PM_MONOTONICITY_CHECKS: c_int = 10;
// Number of reads we try to get two different values
pub const ACPI_PM_READ_CHECKS: c_int = 10000;
#[no_mangle]
unsafe extern "C" fn init_acpi_pm_clocksource() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn parse_pmtmr(arg: *mut c_char) -> int __init {
