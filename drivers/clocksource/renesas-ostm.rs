...
//! Source: drivers/clocksource/renesas-ostm.c
#![no_std]
...
// OSTM REGISTERS
pub const OSTM_CMP: c_uint = 0x000	/* RW,32 */;
pub const OSTM_CNT: c_uint = 0x004	/* R,32 */;
pub const OSTM_TE: c_uint = 0x010	/* R,8 */;
pub const OSTM_TS: c_uint = 0x014	/* W,8 */;
pub const OSTM_TT: c_uint = 0x018	/* W,8 */;
pub const OSTM_CTL: c_uint = 0x020	/* RW,8 */;
pub const TE: c_uint = 0x01;
pub const TS: c_uint = 0x01;
pub const TT: c_uint = 0x01;
pub const CTL_PERIODIC: c_uint = 0x00;
pub const CTL_ONESHOT: c_uint = 0x02;
pub const CTL_FREERUN: c_uint = 0x02;
#[no_mangle]
unsafe extern "C" fn ostm_timer_stop(to: *mut timer_of) {
...
#[no_mangle]
unsafe extern "C" fn ostm_init_clksrc(to: *mut timer_of) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ostm_read_sched_clock() -> u64 notrace {
    static u64 notrace ostm_read_sched_clock(void)
    {
    return readl(system_clock);
    }
#[no_mangle]
unsafe extern "C" fn ostm_init_sched_clock(to: *mut timer_of) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn ostm_shutdown(ced: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ostm_set_periodic(ced: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ostm_set_oneshot(ced: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ostm_timer_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ostm_init_clkevt(to: *mut timer_of) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ostm_init(np: *mut device_node) -> int __init {
    ...
    if (!to)
    return -ENOMEM;
    rstc = of_reset_control_get_optional_exclusive(np, core::ptr::null_mut());
    if (IS_ERR(rstc)) {
    ret = PTR_ERR(rstc);
    goto err_free;
    }
...
#[no_mangle]
unsafe extern "C" fn ostm_probe(pdev: *mut platform_device) -> int __init {
