...
//! Source: drivers/clocksource/timer-fsl-ftm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ftm_readl(addr: *mut void __iomem) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_writel(val: u32, addr: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_counter_enable(base: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_counter_disable(base: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_irq_acknowledge(base: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_irq_enable(base: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_irq_disable(base: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_reset_counter(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn ftm_read_sched_clock() -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn ftm_set_oneshot(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ftm_set_periodic(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ftm_evt_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ftm_clockevent_init(freq: c_ulong, irq: c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ftm_clocksource_init(freq: c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ftm_clk_init(np: *mut device_node) -> unsigned long __init {
...
#[no_mangle]
unsafe extern "C" fn ftm_calc_closest_round_cyc(freq: c_ulong) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ftm_timer_init(np: *mut device_node) -> int __init {
