...
//! Source: drivers/clocksource/ingenic-timer.c
#![no_std]
...
pub struct ingenic_tcu {
    ...
    pub cs_clk: *mut clk,
    pub cs_channel: c_uint,
    pub cs: clocksource,
    pub pwm_channels_mask: c_ulong,
    pub timers: [ingenic_tcu_timer; ],
}

    static struct ingenic_tcu *ingenic_tcu;
#[no_mangle]
unsafe extern "C" fn ingenic_tcu_timer_read() -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn ingenic_tcu_timer_cs_read(cs: *mut clocksource) -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn ingenic_tcu_cevt_cb(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn ingenic_tcu_setup_cevt(cpu: c_uint) -> c_int {
    ...
    {
    let mut channel: c_uint = tcu.cs_channel;
...
#[no_mangle]
unsafe extern "C" fn ingenic_tcu_init(np: *mut device_node) -> int __init {
...
// Setup clock events on each CPU core
    ...
    ingenic_tcu_setup_cevt, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_tcu_probe(pdev: *mut platform_device) -> int __init {
