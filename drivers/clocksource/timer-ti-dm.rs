...
//! Source: drivers/clocksource/timer-ti-dm.c
#![no_std]
...
//
pub const OMAP_TIMER_ERRATA_I103_I767: c_uint = 0x80000000;
// posted mode types
pub const OMAP_TIMER_NONPOSTED: c_uint = 0x00;
pub const OMAP_TIMER_POSTED: c_uint = 0x01;
// register offsets with the write pending bit encoded
pub const WPSHIFT: c_int = 16;
...
#[derive(Copy, Clone)]
pub struct dmtimer {
    pub cookie: omap_dm_timer,
    pub id: c_int,
    pub irq: c_int,
    pub fclk: *mut clk,
    pub io_base: *mut void __iomem,
    pub /: *mut *mut int irq_stat; / TISR/IRQSTATUS interrupt status,
    pub /: *mut *mut int irq_ena; / irq enable,
    pub /: *mut *mut int irq_dis; / irq disable, only on v2 ip,
    pub /: *mut *mut *mut void __iomem pend; / write pending,
    pub /: *mut *mut *mut void __iomem func_base; / function register base,
    pub enabled: core::sync::atomic::AtomicI32,
    pub reserved:1: unsigned,
    pub posted:1: unsigned,
    pub omap1:1: unsigned,
    pub context: timer_regs,
    pub revision: c_int,
    pub capability: u32,
    pub errata: u32,
    ...
    pub fclk_nb: notifier_block,
    pub fclk_rate: c_ulong,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmtimer_clocksource {
    pub dev: clocksource,
    pub timer: *mut dmtimer,
    pub loadval: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_dm_timer_clockevent {
    pub dev: clock_event_device,
    pub timer: *mut dmtimer,
    pub period: u32,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn dmtimer_read(timer: *mut dmtimer, reg: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn dmtimer_write(timer: *mut dmtimer, reg: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn __omap_dm_timer_init_regs(timer: *mut dmtimer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __omap_dm_timer_enable_posted(timer: *mut dmtimer) {
...
#[no_mangle]
pub unsafe extern "C" fn __omap_dm_timer_stop(timer: *mut dmtimer) {
...
#[no_mangle]
unsafe extern "C" fn omap_timer_restore_context(timer: *mut dmtimer) {
...
#[no_mangle]
unsafe extern "C" fn omap_timer_save_context(timer: *mut dmtimer) {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_reset(timer: *mut dmtimer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_set_source(cookie: *mut omap_dm_timer, source: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_enable(cookie: *mut omap_dm_timer) {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_disable(cookie: *mut omap_dm_timer) {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_prepare(timer: *mut dmtimer) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn omap_dm_timer_reserved_systimer(id: c_int) -> u32 {
    ...
    {
    struct dmtimer *timer = core::ptr::null_mut(), *t;
...
// REQUEST_ANY
    ...
    {
    struct dmtimer *timer;
    timer = _omap_dm_timer_request(REQUEST_ANY, core::ptr::null_mut());
    if (!timer)
    return core::ptr::null_mut();
    return &timer.cookie;
    }
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_free(cookie: *mut omap_dm_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_get_irq(cookie: *mut omap_dm_timer) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap_dm_timer_modify_idlect_mask(inputmask: __u32) -> __u32 {
    __u32 omap_dm_timer_modify_idlect_mask(__u32 inputmask)
    {
    let mut i: c_int = 0;
    struct dmtimer *timer = core::ptr::null_mut();
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_start(cookie: *mut omap_dm_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_stop(cookie: *mut omap_dm_timer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_get_pwm_status(cookie: *mut omap_dm_timer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_set_int_disable(cookie: *mut omap_dm_timer, mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_read_status(cookie: *mut omap_dm_timer) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_write_status(cookie: *mut omap_dm_timer, value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_read_counter(cookie: *mut omap_dm_timer) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn __omap_dm_timer_cap(timer: *mut dmtimer, idx: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_write_counter(cookie: *mut omap_dm_timer, value: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_cap_counter(cookie: *mut omap_dm_timer, is_period: bool) -> c_uint {
    static unsigned int omap_dm_timer_cap_counter(struct omap_dm_timer *cookie,	bool is_period)
    {
    struct dmtimer *timer;
    let mut cap1: c_uint = 0;
    let mut cap2: c_uint = 0;
    u32 l, ret;
    timer = to_dmtimer(cookie);
    if (unlikely(!timer || !atomic_read(&timer.enabled))) {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    omap_dm_timer_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_read_cycles(cs: *mut clocksource) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_read_sched_clock() -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_clocksource_suspend(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_clocksource_resume(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_clocksource_unregister(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_setup_clocksource(timer: *mut dmtimer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_evt_shutdown(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_evt_set_periodic(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_evt_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_setup_clockevent(timer: *mut dmtimer) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omap_dm_timer_remove(pdev: *mut platform_device) {
