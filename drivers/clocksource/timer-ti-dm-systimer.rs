...
//! Source: drivers/clocksource/timer-ti-dm-systimer.c
#![no_std]
...
pub const DMTIMER_RESET_WAIT: c_int = 100000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmtimer_clockevent {
    pub dev: clock_event_device,
    pub t: dmtimer_systimer,
    pub period: u32,
}
...
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_revision1(t: *mut dmtimer_systimer) -> bool {
    static bool dmtimer_systimer_revision1(struct dmtimer_systimer *t)
    {
    let mut tidr: u32 = readl_relaxed(t.base);
    return !(tidr >> 16);
    }
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_enable(t: *mut dmtimer_systimer) {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_disable(t: *mut dmtimer_systimer) {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_type1_reset(t: *mut dmtimer_systimer) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_type2_reset(t: *mut dmtimer_systimer) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_reset(t: *mut dmtimer_systimer) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_check_counter32k() -> void __init {
    static void __init dmtimer_systimer_check_counter32k(void)
    {
    struct device_node *np;
    if (counter_32k)
    return;
    np = of_find_matching_node(core::ptr::null_mut(), counter_match_table);
    if (!np) {
    counter_32k = -ENODEV;
    return;
    }
...
//
#[no_mangle]
unsafe extern "C" fn dmtimer_is_preferred(np: *mut device_node) -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_assign_alwon() -> void __init {
    static void __init dmtimer_systimer_assign_alwon(void)
    {
    struct device_node *np;
    let mut pa: u32 = 0;
    let mut quirk_unreliable_oscillator: bool = false;
...
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_find_first_available() -> u32 __init {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_select_best() -> void __init {
...
// Interface clocks are only available on some SoCs variants
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_ERR(clock)) -> else {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_clockevent_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_clockevent_shutdown(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_set_periodic(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_clockevent_idle(evt: *mut clock_event_device) {
...
#[no_mangle]
unsafe extern "C" fn omap_clockevent_unidle(evt: *mut clock_event_device) {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_clockevent_init(np: *mut device_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_percpu_timer_init(np: *mut device_node, cpu: c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn omap_dmtimer_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_percpu_timer_startup() -> int __init {
    ...
    omap_dmtimer_starting_cpu, core::ptr::null_mut());
    }
    return 0;
    }
    subsys_initcall(dmtimer_percpu_timer_startup);
#[no_mangle]
unsafe extern "C" fn dmtimer_percpu_quirk_init(np: *mut device_node, pa: u32) -> int __init {
    static int __init dmtimer_percpu_quirk_init(struct device_node *np, u32 pa)
    {
    struct device_node *arm_timer __free(device_node) =
    of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "arm,armv7-timer");
...
#[no_mangle]
unsafe extern "C" fn dmtimer_clocksource_read_cycles(cs: *mut clocksource) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_read_sched_clock() -> u64 notrace {
    static u64 notrace dmtimer_read_sched_clock(void)
    {
    return readl_relaxed(dmtimer_sched_clock_counter);
    }
#[no_mangle]
unsafe extern "C" fn dmtimer_clocksource_suspend(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_clocksource_resume(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn dmtimer_clocksource_init(np: *mut device_node) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn dmtimer_systimer_init(np: *mut device_node) -> int __init {
