...
//! Source: drivers/clocksource/hyperv_timer.c
#![no_std]
...
// Note: offset can hold negative values after hibernation.
    ...
    let mut stimer0_irq: static int = -1;
    static __maybe_unused DEFINE_PER_CPU(long, stimer0_evt);
#[no_mangle]
unsafe extern "C" fn hv_stimer0_isr() {
...
//
#[no_mangle]
unsafe extern "C" fn hv_stimer0_percpu_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn hv_ce_shutdown(evt: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_ce_set_oneshot(evt: *mut clock_event_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hv_stimer_init(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_stimer_cleanup(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_setup_stimer0_handler((*handler)(void): *mut c_void) -> void __weak {
    void __weak hv_setup_stimer0_handler(void (*handler)(void))
    {
    };
#[no_mangle]
pub unsafe extern "C" fn hv_remove_stimer0_handler() -> void __weak {
...
#[no_mangle]
unsafe extern "C" fn hv_setup_stimer0_irq() -> c_int {
    static int hv_setup_stimer0_irq(void)
    {
    int ret;
    ret = acpi_register_gsi(core::ptr::null_mut(), HYPERV_STIMER0_VECTOR,
...
#[no_mangle]
unsafe extern "C" fn hv_remove_stimer0_irq() {
...
#[no_mangle]
pub unsafe extern "C" fn hv_stimer_alloc(have_percpu_irqs: bool) -> c_int {
...
//
    ...
    hv_clock_event = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn read_hv_clock_msr() -> __always_inline u64 {
...
#[no_mangle]
pub unsafe extern "C" fn hv_get_tsc_pfn() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn read_hv_clock_tsc() -> __always_inline u64 {
...
#[no_mangle]
unsafe extern "C" fn read_hv_clock_tsc_cs(arg: *mut clocksource) -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn read_hv_sched_clock_tsc() -> u64 noinstr {
...
#[no_mangle]
unsafe extern "C" fn suspend_hv_clock_tsc(arg: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn resume_hv_clock_tsc(arg: *mut clocksource) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_adj_sched_clock_offset(offset: u64) {
...
#[no_mangle]
unsafe extern "C" fn hv_cs_enable(cs: *mut clocksource) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_hv_clock_msr_cs(arg: *mut clocksource) -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn hv_setup_sched_clock(sched_clock: *mut c_void) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn hv_init_tsc_clocksource() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn hv_init_clocksource() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn hv_remap_tsc_clocksource() -> void __init {
