...
//! Source: drivers/clocksource/timer-rockchip.c
#![no_std]
...
pub const TIMER_LOAD_COUNT0: c_uint = 0x00;
pub const TIMER_LOAD_COUNT1: c_uint = 0x04;
pub const TIMER_CURRENT_VALUE0: c_uint = 0x08;
pub const TIMER_CURRENT_VALUE1: c_uint = 0x0C;
pub const TIMER_CONTROL_REG3288: c_uint = 0x10;
pub const TIMER_CONTROL_REG3399: c_uint = 0x1c;
pub const TIMER_INT_STATUS: c_uint = 0x18;
pub const TIMER_DISABLE: c_uint = 0x0;
pub const TIMER_ENABLE: c_uint = 0x1;
...
#[no_mangle]
pub unsafe extern "C" fn rk_timer_disable(timer: *mut rk_timer) {
    static inline void rk_timer_disable(struct rk_timer *timer)
    {
    writel_relaxed(TIMER_DISABLE, timer.ctrl);
    }
#[no_mangle]
pub unsafe extern "C" fn rk_timer_enable(timer: *mut rk_timer, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn rk_timer_interrupt_clear(timer: *mut rk_timer) {
...
#[no_mangle]
unsafe extern "C" fn rk_timer_shutdown(ce: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_timer_set_periodic(ce: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_timer_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rk_timer_sched_read() -> u64 notrace {
    ...
    struct clk *pclk;
    let mut ret: c_int = -EINVAL, irq;
    let mut ctrl_reg: u32 = TIMER_CONTROL_REG3288;
...
#[no_mangle]
unsafe extern "C" fn rk_timer_cleanup(timer: *mut rk_timer) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rk_clkevt_init(np: *mut device_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rk_clksrc_init(np: *mut device_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rk_timer_init(np: *mut device_node) -> int __init {
