...
//! Source: drivers/clocksource/timer-davinci.c
#![no_std]
...
pub const DAVINCI_TIMER_REG_TIM12: c_uint = 0x10;
pub const DAVINCI_TIMER_REG_TIM34: c_uint = 0x14;
pub const DAVINCI_TIMER_REG_PRD12: c_uint = 0x18;
pub const DAVINCI_TIMER_REG_PRD34: c_uint = 0x1c;
pub const DAVINCI_TIMER_REG_TCR: c_uint = 0x20;
pub const DAVINCI_TIMER_REG_TGCR: c_uint = 0x24;

pub const DAVINCI_TIMER_ENAMODE_DISABLED: c_uint = 0x00;

pub const DAVINCI_TIMER_ENAMODE_SHIFT_TIM12: c_int = 6;
pub const DAVINCI_TIMER_ENAMODE_SHIFT_TIM34: c_int = 22;
pub const DAVINCI_TIMER_MIN_DELTA: c_uint = 0x01;
pub const DAVINCI_TIMER_MAX_DELTA: c_uint = 0xfffffffe;
pub const DAVINCI_TIMER_CLKSRC_BITS: c_int = 32;

    (DAVINCI_TIMER_TIMMODE_32BIT_UNCHAINED | DAVINCI_TIMER_UNRESET)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct davinci_clockevent {
...
#[no_mangle]
unsafe extern "C" fn davinci_tim12_shutdown(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn davinci_tim12_set_oneshot(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn davinci_clockevent_shutdown(dev: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_clockevent_set_oneshot(dev: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_timer_irq_timer(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn davinci_timer_read_sched_clock() -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn davinci_clocksource_read(dev: *mut clocksource) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn davinci_clocksource_init_tim34(base: *mut void __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn davinci_clocksource_init_tim12(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn davinci_timer_init(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn of_davinci_timer_register(np: *mut device_node) -> int __init {
    static int __init of_davinci_timer_register(struct device_node *np)
    {
    let mut timer_cfg: davinci_timer_cfg = { };
    struct clk *clk;
    int rv;
