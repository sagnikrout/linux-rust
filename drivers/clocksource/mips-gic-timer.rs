...
//! Source: drivers/clocksource/mips-gic-timer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gic_read_count_2x32() -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn gic_read_count_64() -> u64 notrace {
    static u64 notrace gic_read_count_64(void)
    {
    return read_gic_counter();
    }
#[no_mangle]
unsafe extern "C" fn gic_read_count() -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn gic_next_event(delta: c_ulong, evt: *mut clock_event_device) -> c_int {
    static int gic_next_event(unsigned long delta, struct clock_event_device *evt)
    {
    let mut cpu: c_int = cpumask_first(evt.cpumask);
    u64 cnt;
    int res;
    cnt = gic_read_count();
    cnt += (u64)delta;
...
#[no_mangle]
unsafe extern "C" fn gic_compare_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gic_clockevent_cpu_exit(cd: *mut clock_event_device) {
    static void gic_clockevent_cpu_exit(struct clock_event_device *cd)
    {
    disable_percpu_irq(gic_timer_irq);
    }
#[no_mangle]
unsafe extern "C" fn gic_update_frequency(data: *mut c_void) {
    static void gic_update_frequency(void *data)
    {
    let mut rate: c_ulong = (unsigned long)data;
...
#[no_mangle]
unsafe extern "C" fn gic_dying_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_clockevent_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gic_hpt_read(cs: *mut clocksource) -> u64 {
    static u64 gic_hpt_read(struct clocksource *cs)
    {
    return gic_read_count();
    }
#[no_mangle]
unsafe extern "C" fn gic_hpt_read_multicluster(cs: *mut clocksource) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gic_clocksource_unstable(reason: *mut c_char) {
    static void gic_clocksource_unstable(char *reason)
    {
...
#[no_mangle]
unsafe extern "C" fn __gic_clocksource_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gic_clocksource_of_init(node: *mut device_node) -> int __init {
