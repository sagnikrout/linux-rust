...
//! Source: drivers/clocksource/timer-imx-gpt.c
#![no_std]
...
pub const MXC_TCTL: c_uint = 0x00;

pub const MXC_TPRER: c_uint = 0x04;
// MX1, MX21, MX27

pub const MX1_2_TCMP: c_uint = 0x08;
pub const MX1_2_TCN: c_uint = 0x10;
pub const MX1_2_TSTAT: c_uint = 0x14;
// MX21, MX27

// MX31, MX35, MX25, MX5, MX6

pub const V2_TPRER_PRE24M: c_int = 12;
pub const V2_IR: c_uint = 0x0c;
pub const V2_TSTAT: c_uint = 0x08;

pub const V2_TCN: c_uint = 0x24;
pub const V2_TCMP: c_uint = 0x10;
pub const V2_TIMER_RATE_OSC_DIV8: c_int = 3000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_timer {
    pub type: enum imx_gpt_type,
...
pub struct imx_gpt_data {
    ...
    pub reg_tcn: c_int,
    pub reg_tcmp: c_int,
    pub imxtm): *mut *mut void (gpt_setup_tctl)(struct imx_timer,
    pub imxtm): *mut *mut void (gpt_irq_enable)(struct imx_timer,
    pub imxtm): *mut *mut void (gpt_irq_disable)(struct imx_timer,
    pub imxtm): *mut *mut void (gpt_irq_acknowledge)(struct imx_timer,
    int (*set_next_event)(unsigned long evt,
    pub ced): *mut clock_event_device,
}
...
#[no_mangle]
unsafe extern "C" fn imx1_gpt_irq_disable(imxtm: *mut imx_timer) {
...
#[no_mangle]
unsafe extern "C" fn imx31_gpt_irq_disable(imxtm: *mut imx_timer) {
    static void imx31_gpt_irq_disable(struct imx_timer *imxtm)
    {
    writel_relaxed(0, imxtm.base + V2_IR);
    }
#[no_mangle]
unsafe extern "C" fn imx1_gpt_irq_enable(imxtm: *mut imx_timer) {
...
#[no_mangle]
unsafe extern "C" fn imx31_gpt_irq_enable(imxtm: *mut imx_timer) {
    static void imx31_gpt_irq_enable(struct imx_timer *imxtm)
    {
    writel_relaxed(1<<0, imxtm.base + V2_IR);
    }
#[no_mangle]
unsafe extern "C" fn imx1_gpt_irq_acknowledge(imxtm: *mut imx_timer) {
    static void imx1_gpt_irq_acknowledge(struct imx_timer *imxtm)
    {
    writel_relaxed(0, imxtm.base + MX1_2_TSTAT);
    }
#[no_mangle]
unsafe extern "C" fn imx21_gpt_irq_acknowledge(imxtm: *mut imx_timer) {
...
#[no_mangle]
unsafe extern "C" fn imx31_gpt_irq_acknowledge(imxtm: *mut imx_timer) {
...
#[no_mangle]
unsafe extern "C" fn mxc_read_sched_clock() -> u64 notrace {
...
#[no_mangle]
unsafe extern "C" fn imx_read_current_timer() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn mxc_clocksource_init(imxtm: *mut imx_timer) -> int __init {
    static int __init mxc_clocksource_init(struct imx_timer *imxtm)
    {
    let mut c: c_uint = clk_get_rate(imxtm.clk_per);
...
#[no_mangle]
unsafe extern "C" fn mxc_shutdown(ced: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxc_set_oneshot(ced: *mut clock_event_device) -> c_int {
...
// Disable interrupt in GPT module
    ...
    let mut tcn: u32 = readl_relaxed(imxtm.base + imxtm.gpt.reg_tcn);
// Set event time into far-far future
    writel_relaxed(tcn - 3, imxtm.base + imxtm.gpt.reg_tcmp);
// Clear pending interrupt
    imxtm.gpt.gpt_irq_acknowledge(imxtm);
...
//
#[no_mangle]
unsafe extern "C" fn mxc_timer_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mxc_clockevent_init(imxtm: *mut imx_timer) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn imx1_gpt_setup_tctl(imxtm: *mut imx_timer) {
...
#[no_mangle]
unsafe extern "C" fn imx31_gpt_setup_tctl(imxtm: *mut imx_timer) {
...
#[no_mangle]
unsafe extern "C" fn imx6dl_gpt_setup_tctl(imxtm: *mut imx_timer) {
...
#[no_mangle]
unsafe extern "C" fn _mxc_timer_init(imxtm: *mut imx_timer) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mxc_timer_init_dt(np: *mut device_node, type: enum imx_gpt_type) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn imx1_timer_init_dt(np: *mut device_node) -> int __init {
    static int __init imx1_timer_init_dt(struct device_node *np)
    {
    return mxc_timer_init_dt(np, GPT_TYPE_IMX1);
    }
#[no_mangle]
unsafe extern "C" fn imx21_timer_init_dt(np: *mut device_node) -> int __init {
    static int __init imx21_timer_init_dt(struct device_node *np)
    {
    return mxc_timer_init_dt(np, GPT_TYPE_IMX21);
    }
#[no_mangle]
unsafe extern "C" fn imx31_timer_init_dt(np: *mut device_node) -> int __init {
    static int __init imx31_timer_init_dt(struct device_node *np)
    {
    let mut type: enum imx_gpt_type = GPT_TYPE_IMX31;
//
...
#[no_mangle]
unsafe extern "C" fn imx6dl_timer_init_dt(np: *mut device_node) -> int __init {
