...
//! Source: drivers/clocksource/timer-nxp-stm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_module_enable(stm_timer: *mut stm_timer) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_module_disable(stm_timer: *mut stm_timer) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_module_put(stm_timer: *mut stm_timer) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_module_get(stm_timer: *mut stm_timer) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clocksource_enable(cs: *mut clocksource) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clocksource_disable(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clocksource_suspend(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clocksource_resume(cs: *mut clocksource) {
...
#[no_mangle]
unsafe extern "C" fn devm_clocksource_unregister(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_read_counter(stm_timer: *mut stm_timer) -> c_int {
    static int nxp_stm_clockevent_read_counter(struct stm_timer *stm_timer)
    {
    return readl(STM_CNT(stm_timer.base));
    }
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_disable(stm_timer: *mut stm_timer) {
    static void nxp_stm_clockevent_disable(struct stm_timer *stm_timer)
    {
    writel(0, STM_CCR0(stm_timer.base));
    }
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_enable(stm_timer: *mut stm_timer) {
    static void nxp_stm_clockevent_enable(struct stm_timer *stm_timer)
    {
    writel(STM_CCR_CEN, STM_CCR0(stm_timer.base));
    }
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_shutdown(ced: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_set_next_event(delta: c_ulong, ced: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_set_periodic(ced: *mut clock_event_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_suspend(ced: *mut clock_event_device) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_resume(ced: *mut clock_event_device) {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_clockevent_starting_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_module_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nxp_stm_timer_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    return 0;
    base = devm_of_iomap(dev, np, 0, core::ptr::null_mut());
    if (IS_ERR(base))
...
//
    ...
    nxp_stm_clockevent_starting_cpu, core::ptr::null_mut());
    if (ret < 0)
    return ret;
    }
    return 0;
