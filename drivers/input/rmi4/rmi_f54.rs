...
//! Source: drivers/input/rmi4/rmi_f54.c
#![no_std]
...
// F54 data offsets
pub const F54_REPORT_DATA_OFFSET: c_int = 3;
pub const F54_FIFO_OFFSET: c_int = 1;
pub const F54_NUM_TX_OFFSET: c_int = 1;
pub const F54_NUM_RX_OFFSET: c_int = 0;
//
// The smbus protocol can read only 32 bytes max at a time.
// But this should be fine for i2c/spi as well.
//
pub const F54_REPORT_DATA_SIZE: c_int = 32;
// F54 commands
pub const F54_GET_REPORT: c_int = 1;
pub const F54_FORCE_CAL: c_int = 2;
// F54 capabilities
...
// V4L2 support
    ...
    pub sequence: u32,
    pub input: c_int,
    pub inputs: [enum rmi_f54_report_type; F54_MAX_REPORT_TYPE],
}
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_create_input_map(f54: *mut f54_data) {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_request_report(fn: *mut rmi_function, report_type: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_get_report_size(f54: *mut f54_data) -> usize {
    static size_t rmi_f54_get_report_size(struct f54_data *f54)
    {
    struct rmi_device *rmi_dev = f54.fn.rmi_dev;
    struct rmi_driver_data *drv_data = dev_get_drvdata(&rmi_dev.dev);
    let mut rx: u8 = drv_data.num_rx_electrodes ? : f54.num_rx_electrodes;
    let mut tx: u8 = drv_data.num_tx_electrodes ? : f54.num_tx_electrodes;
    size_t size;
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_get_pixel_fmt(reptype: enum rmi_f54_report_type, pixfmt: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_buffer_queue(vb: *mut vb2_buffer) {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_stop_streaming(q: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_set_input(f54: *mut f54_data, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_vidioc_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_work(work: *mut work_struct) {
...
//
    ...
    let mut size: c_int = min(F54_REPORT_DATA_SIZE, report_size - i);
    fifo[0] = i & 0xff;
    fifo[1] = i >> 8;
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_config(fn: *mut rmi_function) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_detect(fn: *mut rmi_function) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_probe(fn: *mut rmi_function) -> c_int {
    ...
    GFP_KERNEL);
    if (f54.report_data == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn rmi_f54_remove(fn: *mut rmi_function) {
