...
//! Source: drivers/input/rmi4/rmi_f34v7.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_read_flash_status(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_wait_for_idle(f34: *mut f34_data, timeout_ms: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_check_command_status(f34: *mut f34_data, timeout_ms: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_command(f34: *mut f34_data, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_partition_id(f34: *mut f34_data, cmd: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(v7_DP_CONFIG_AREA: f34->v7.config_area ==) -> else {
    else if (f34.v7.config_area == v7_DP_CONFIG_AREA)
    partition = DISPLAY_CONFIG_PARTITION;
#[no_mangle]
pub unsafe extern "C" fn if(v7_PM_CONFIG_AREA: f34->v7.config_area ==) -> else {
    else if (f34.v7.config_area == v7_PM_CONFIG_AREA)
    partition = GUEST_SERIALIZATION_PARTITION;
#[no_mangle]
pub unsafe extern "C" fn if(v7_BL_CONFIG_AREA: f34->v7.config_area ==) -> else {
    else if (f34.v7.config_area == v7_BL_CONFIG_AREA)
    partition = GLOBAL_PARAMETERS_PARTITION;
#[no_mangle]
pub unsafe extern "C" fn if(v7_FLASH_CONFIG_AREA: f34->v7.config_area ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_read_partition_table(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_read_queries_bl_version(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_read_queries(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_check_bl_config_size(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_erase_all(f34: *mut f34_data) -> c_int {
    ...
    u16 transfer;
    u16 max_transfer;
    let mut remaining: u16 = block_cnt;
    let mut block_number: u16 = 0;
    let mut index: u16 = 0;
    base = f34.fn.fd.data_base_addr;
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_config(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_ui_config(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_dp_config(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_guest_code(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_flash_config(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_partition_table(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_write_firmware(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_parse_image_header_10(f34: *mut f34_data) {
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_parse_image_info(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rmi_f34v7_do_reflash(f34: *mut f34_data, fw: *const firmware) -> c_int {
...
//
    ret = rmi_scan_pdt(f34.fn.rmi_dev, core::ptr::null_mut(), rmi_initial_reset);
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn rmi_f34v7_enter_flash_prog(f34: *mut f34_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rmi_f34v7_start_reflash(f34: *mut f34_data, fw: *const firmware) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rmi_f34v7_probe(f34: *mut f34_data) -> c_int {
