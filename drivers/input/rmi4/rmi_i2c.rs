...
//! Source: drivers/input/rmi4/rmi_i2c.c
#![no_std]
...
pub const RMI_PAGE_SELECT_REGISTER: c_uint = 0xff;
...
//
#[no_mangle]
unsafe extern "C" fn rmi_set_page(rmi_i2c: *mut rmi_i2c_xport, page: u8) -> c_int {
    ...
    retval = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: retval >=) -> else {
    else if (retval >= 0)
    retval = -EIO;
    exit:
    ...
    container_of(xport, struct rmi_i2c_xport, xport);
    struct i2c_client *client = rmi_i2c.client;
    let mut addr_offset: u8 = addr & 0xff;
    int retval;
    struct i2c_msg msgs[] = {
    {
    .addr	= client.addr,
...
#[no_mangle]
unsafe extern "C" fn rmi_i2c_regulator_bulk_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rmi_i2c_unregister_transport(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rmi_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_i2c_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_i2c_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rmi_i2c_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(rmi_i2c_runtime_suspend, rmi_i2c_runtime_resume, core::ptr::null_mut())
    };
