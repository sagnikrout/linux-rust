...
//! Source: drivers/input/keyboard/atakbd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn atakbd_interrupt(scancode: c_uchar, down: c_char) {
...
#[no_mangle]
unsafe extern "C" fn atakbd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn atakbd_exit() -> void __exit {
    static void __exit atakbd_exit(void)
    {
    atari_input_keyboard_interrupt_hook = core::ptr::null_mut();
