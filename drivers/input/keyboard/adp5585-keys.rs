...
//! Source: drivers/input/keyboard/adp5585-keys.c
#![no_std]
...
pub const ADP5589_MAX_KEYMAPSIZE: c_int = 123;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adp5585_kpad_chip {
    pub key_ev_min: u8,
    pub key_ev_max: u8,
    pub max_rows: u8,
    pub max_cols: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adp5585_kpad {
    pub info: *const adp5585_kpad_chip,
    pub nb: notifier_block,
    pub input: *mut input_dev,
    pub keycode: [c_ushort; ADP5589_MAX_KEYMAPSIZE],
    pub dev: *mut device,
    pub keypad: c_ulong,
    pub row_shift: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn adp5585_keys_pins_free(data: *mut c_void) {
...
//
    ...
    let mut i: c_uint = 0, max_cols = kpad.info.max_cols;
    int error;
//
...
#[no_mangle]
unsafe extern "C" fn adp5585_keys_unreg_notifier(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adp5585_keys_probe(pdev: *mut platform_device) -> c_int {
