...
//! Source: drivers/input/keyboard/max7360-keypad.c
#![no_std]
...
pub struct max7360_keypad {
    ...
    pub MAX7360_MAX_KEY_COLS]: *mut *mut unsigned short keycodes[MAX7360_MAX_KEY_ROWS,
}

#[no_mangle]
unsafe extern "C" fn max7360_keypad_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max7360_keypad_open(pdev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max7360_keypad_close(pdev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn max7360_keypad_hw_init(max7360_keypad: *mut max7360_keypad) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max7360_keypad_build_keymap(max7360_keypad: *mut max7360_keypad) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max7360_keypad_probe(pdev: *mut platform_device) -> c_int {
    ...
    error = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), max7360_keypad_irq,
    IRQF_ONESHOT,
...
#[no_mangle]
unsafe extern "C" fn max7360_keypad_remove(pdev: *mut platform_device) {
