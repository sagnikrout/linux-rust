...
//! Source: drivers/input/keyboard/lkkbd.c
#![no_std]
...
// LED control
pub const LK_LED_WAIT: c_uint = 0x81;
pub const LK_LED_COMPOSE: c_uint = 0x82;
pub const LK_LED_SHIFTLOCK: c_uint = 0x84;
pub const LK_LED_SCROLLLOCK: c_uint = 0x88;
pub const LK_CMD_LED_ON: c_uint = 0x13;
pub const LK_CMD_LED_OFF: c_uint = 0x11;
// Mode control
pub const LK_MODE_DOWN: c_uint = 0x80;
pub const LK_MODE_AUTODOWN: c_uint = 0x82;
pub const LK_MODE_UPDOWN: c_uint = 0x86;

// Misc commands
pub const LK_CMD_ENABLE_KEYCLICK: c_uint = 0x1b;
pub const LK_CMD_DISABLE_KEYCLICK: c_uint = 0x99;
pub const LK_CMD_DISABLE_BELL: c_uint = 0xa1;
pub const LK_CMD_SOUND_BELL: c_uint = 0xa7;
pub const LK_CMD_ENABLE_BELL: c_uint = 0x23;
pub const LK_CMD_DISABLE_CTRCLICK: c_uint = 0xb9;
pub const LK_CMD_ENABLE_CTRCLICK: c_uint = 0xbb;
pub const LK_CMD_SET_DEFAULTS: c_uint = 0xd3;
pub const LK_CMD_POWERCYCLE_RESET: c_uint = 0xfd;
pub const LK_CMD_ENABLE_LK401: c_uint = 0xe9;
pub const LK_CMD_REQUEST_ID: c_uint = 0xab;
// Misc responses from keyboard
pub const LK_STUCK_KEY: c_uint = 0x3d;
pub const LK_SELFTEST_FAILED: c_uint = 0x3e;
pub const LK_ALL_KEYS_UP: c_uint = 0xb3;
pub const LK_METRONOME: c_uint = 0xb4;
pub const LK_OUTPUT_ERROR: c_uint = 0xb5;
pub const LK_INPUT_ERROR: c_uint = 0xb6;
pub const LK_KBD_LOCKED: c_uint = 0xb7;
pub const LK_KBD_TEST_MODE_ACK: c_uint = 0xb8;
pub const LK_PREFIX_KEY_DOWN: c_uint = 0xb9;
pub const LK_MODE_CHANGE_ACK: c_uint = 0xba;
pub const LK_RESPONSE_RESERVED: c_uint = 0xbb;
pub const LK_NUM_KEYCODES: c_int = 256;
pub const LK_NUM_IGNORE_BYTES: c_int = 6;
...
#[derive(Copy, Clone)]
pub struct lkkbd {
    pub keycode: [c_ushort; LK_NUM_KEYCODES],
    pub ignore_bytes: c_int,
    pub id: [c_uchar; LK_NUM_IGNORE_BYTES],
    ...
    pub phys: [c_char; 32],
    pub type: c_char,
    pub bell_volume: c_int,
    pub keyclick_volume: c_int,
    pub ctrlclick_volume: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn volume_to_hw(volume_percent: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn lkkbd_detection_done(lk: *mut lkkbd) {
...
#[no_mangle]
unsafe extern "C" fn lkkbd_toggle_leds(lk: *mut lkkbd) {
    static void lkkbd_toggle_leds(struct lkkbd *lk)
    {
    struct serio *serio = lk.serio;
    let mut leds_on: c_uchar = 0;
    let mut leds_off: c_uchar = 0;
...
#[no_mangle]
unsafe extern "C" fn lkkbd_toggle_keyclick(lk: *mut lkkbd, on: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn lkkbd_reinit(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn lkkbd_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lkkbd_disconnect(serio: *mut serio) {
