...
//! Source: drivers/input/keyboard/atkbd.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
    let mut atkbd_set: static int = 2;
    module_param_named(set, atkbd_set, int, 0);
    MODULE_PARM_DESC(set, "Select keyboard code set (2 = default, 3 = PS/2 native)");

    static bool atkbd_reset;

    let mut atkbd_reset: static bool = true;
    ...
    let mut atkbd_softraw: static bool = true;
...
//
pub const ATKBD_KEYMAP_SIZE: c_int = 512;
...
pub const ATKBD_CMD_SETLEDS: c_uint = 0x10ed;
pub const ATKBD_CMD_GSCANSET: c_uint = 0x11f0;
pub const ATKBD_CMD_SSCANSET: c_uint = 0x10f0;
pub const ATKBD_CMD_GETID: c_uint = 0x02f2;
pub const ATKBD_CMD_SETREP: c_uint = 0x10f3;
pub const ATKBD_CMD_ENABLE: c_uint = 0x00f4;
pub const ATKBD_CMD_RESET_DIS: c_uint = 0x00f5	/* Reset to defaults and disable */;
pub const ATKBD_CMD_RESET_DEF: c_uint = 0x00f6	/* Reset to defaults */;
pub const ATKBD_CMD_SETALL_MB: c_uint = 0x00f8	/* Set all keys to give break codes */;
pub const ATKBD_CMD_SETALL_MBR: c_uint = 0x00fa  /* ... and repeat */;
pub const ATKBD_CMD_RESET_BAT: c_uint = 0x02ff;
pub const ATKBD_CMD_RESEND: c_uint = 0x00fe;
pub const ATKBD_CMD_EX_ENABLE: c_uint = 0x10ea;
pub const ATKBD_CMD_EX_SETLEDS: c_uint = 0x20eb;
pub const ATKBD_CMD_OK_GETID: c_uint = 0x02e8;
pub const ATKBD_RET_ACK: c_uint = 0xfa;
pub const ATKBD_RET_NAK: c_uint = 0xfe;
pub const ATKBD_RET_BAT: c_uint = 0xaa;
pub const ATKBD_RET_EMUL0: c_uint = 0xe0;
pub const ATKBD_RET_EMUL1: c_uint = 0xe1;
pub const ATKBD_RET_RELEASE: c_uint = 0xf0;
pub const ATKBD_RET_HANJA: c_uint = 0xf1;
pub const ATKBD_RET_HANGEUL: c_uint = 0xf2;
pub const ATKBD_RET_ERR: c_uint = 0xff;
pub const ATKBD_KEY_UNKNOWN: c_int = 0;
pub const ATKBD_KEY_NULL: c_int = 255;
pub const ATKBD_SCR_1: c_uint = 0xfffe;
pub const ATKBD_SCR_2: c_uint = 0xfffd;
pub const ATKBD_SCR_4: c_uint = 0xfffc;
pub const ATKBD_SCR_8: c_uint = 0xfffb;
pub const ATKBD_SCR_CLICK: c_uint = 0xfffa;
pub const ATKBD_SCR_LEFT: c_uint = 0xfff9;
pub const ATKBD_SCR_RIGHT: c_uint = 0xfff8;

pub const ATKBD_LED_EVENT_BIT: c_int = 0;
pub const ATKBD_REP_EVENT_BIT: c_int = 1;
pub const ATKBD_XL_ERR: c_uint = 0x01;
pub const ATKBD_XL_BAT: c_uint = 0x02;
pub const ATKBD_XL_ACK: c_uint = 0x04;
pub const ATKBD_XL_NAK: c_uint = 0x08;
pub const ATKBD_XL_HANGEUL: c_uint = 0x10;
pub const ATKBD_XL_HANJA: c_uint = 0x20;
    static const struct {
...
// Written only during init
    ...
    pub phys: [c_char; 32],
    pub id: c_ushort,
    pub keycode: [c_ushort; ATKBD_KEYMAP_SIZE],
    pub ATKBD_KEYMAP_SIZE): DECLARE_BITMAP(force_release_mask,,
    pub set: u8,
    pub translated: bool,
    pub extra: bool,
    pub write: bool,
...
// Accessed only from interrupt
    ...
    pub last: c_uint,
    pub time: c_ulong,
    pub err_count: c_ulong,
    pub event_work: delayed_work,
    pub event_jiffies: c_ulong,
    pub event_mask: c_ulong,
// Serializes reconnect(), attr->set() and event work
    pub mutex: mutex,
    pub vdata: vivaldi_data,
}
...
//
    ...
    static struct device_attribute atkbd_attr_##_name =				\
    __ATTR(_name, S_IRUGO, atkbd_do_show_##_name, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn atkbd_show_function_row_physmap(atkbd: *mut atkbd, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_need_xlate(xl_bit: c_ulong, code: u8) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_calculate_xl_bit(atkbd: *mut atkbd, code: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_compat_scancode(atkbd: *mut atkbd, code: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn atkbd_receive_byte(ps2dev: *mut ps2dev, data: u8) {
    static void atkbd_receive_byte(struct ps2dev *ps2dev, u8 data)
    {
    struct serio *serio = ps2dev.serio;
    struct atkbd *atkbd = container_of(ps2dev, struct atkbd, ps2dev);
    struct input_dev *dev = atkbd.dev;
    let mut code: c_uint = data;
    let mut scroll: c_int = 0, hscroll = 0, click = -1;
    int value;
    unsigned short keycode;
...
#[no_mangle]
unsafe extern "C" fn atkbd_set_repeat_rate(atkbd: *mut atkbd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atkbd_set_leds(atkbd: *mut atkbd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_event_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_schedule_event_work(atkbd: *mut atkbd, event_bit: c_int) {
    static void atkbd_schedule_event_work(struct atkbd *atkbd, int event_bit)
    {
    let mut delay: c_ulong = msecs_to_jiffies(50);
...
//
#[no_mangle]
pub unsafe extern "C" fn atkbd_enable(atkbd: *mut atkbd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atkbd_disable(atkbd: *mut atkbd) {
...
#[no_mangle]
unsafe extern "C" fn atkbd_activate(atkbd: *mut atkbd) -> c_int {
...
//
    if (ps2_command(ps2dev, core::ptr::null_mut(), ATKBD_CMD_ENABLE)) {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_deactivate(atkbd: *mut atkbd) {
    static void atkbd_deactivate(struct atkbd *atkbd)
    {
    struct ps2dev *ps2dev = &atkbd.ps2dev;
    if (ps2_command(ps2dev, core::ptr::null_mut(), ATKBD_CMD_RESET_DIS))
    dev_err(&ps2dev.serio.dev,
...
#[no_mangle]
unsafe extern "C" fn atkbd_is_portable_device() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_skip_getid(atkbd: *mut atkbd) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_probe(atkbd: *mut atkbd) -> c_int {
...
//
    if (atkbd_reset)
    if (ps2_command(ps2dev, core::ptr::null_mut(), ATKBD_CMD_RESET_BAT))
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_select_set(atkbd: *mut atkbd, target_set: c_int, allow_extra: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atkbd_reset_state(atkbd: *mut atkbd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_cleanup(serio: *mut serio) {
    static void atkbd_cleanup(struct serio *serio)
    {
    struct atkbd *atkbd = atkbd_from_serio(serio);
    atkbd_disable(atkbd);
    ps2_command(&atkbd.ps2dev, core::ptr::null_mut(), ATKBD_CMD_RESET_DEF);
    }
//
// atkbd_disconnect() closes and frees.
//
#[no_mangle]
unsafe extern "C" fn atkbd_disconnect(serio: *mut serio) {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_apply_forced_release_keylist(atkbd: *mut atkbd, data: *const c_void) {
...
#[no_mangle]
unsafe extern "C" fn atkbd_get_keymap_from_fwnode(atkbd: *mut atkbd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_set_keycode_table(atkbd: *mut atkbd) {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_set_device_attrs(atkbd: *mut atkbd) {
...
#[no_mangle]
unsafe extern "C" fn atkbd_parse_fwnode_data(serio: *mut serio) {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atkbd_reconnect(serio: *mut serio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atkbd_show_extra(atkbd: *mut atkbd, buf: *mut c_char) -> isize {
    static ssize_t atkbd_show_extra(struct atkbd *atkbd, char *buf)
    {
    return sprintf(buf, "%d\n", atkbd.extra ? 1 : 0);
    }
#[no_mangle]
unsafe extern "C" fn atkbd_set_extra(atkbd: *mut atkbd, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn atkbd_show_force_release(atkbd: *mut atkbd, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn atkbd_show_scroll(atkbd: *mut atkbd, buf: *mut c_char) -> isize {
    static ssize_t atkbd_show_scroll(struct atkbd *atkbd, char *buf)
    {
    return sprintf(buf, "%d\n", atkbd.scroll ? 1 : 0);
    }
#[no_mangle]
unsafe extern "C" fn atkbd_set_scroll(atkbd: *mut atkbd, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn atkbd_show_set(atkbd: *mut atkbd, buf: *mut c_char) -> isize {
    static ssize_t atkbd_show_set(struct atkbd *atkbd, char *buf)
    {
    return sprintf(buf, "%d\n", atkbd.set);
    }
#[no_mangle]
unsafe extern "C" fn atkbd_set_set(atkbd: *mut atkbd, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn atkbd_show_softrepeat(atkbd: *mut atkbd, buf: *mut c_char) -> isize {
    static ssize_t atkbd_show_softrepeat(struct atkbd *atkbd, char *buf)
    {
    return sprintf(buf, "%d\n", atkbd.softrepeat ? 1 : 0);
    }
#[no_mangle]
unsafe extern "C" fn atkbd_set_softrepeat(atkbd: *mut atkbd, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn atkbd_show_softraw(atkbd: *mut atkbd, buf: *mut c_char) -> isize {
    static ssize_t atkbd_show_softraw(struct atkbd *atkbd, char *buf)
    {
    return sprintf(buf, "%d\n", atkbd.softraw ? 1 : 0);
    }
#[no_mangle]
unsafe extern "C" fn atkbd_set_softraw(atkbd: *mut atkbd, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn atkbd_show_err_count(atkbd: *mut atkbd, buf: *mut c_char) -> isize {
    static ssize_t atkbd_show_err_count(struct atkbd *atkbd, char *buf)
    {
    return sprintf(buf, "%lu\n", atkbd.err_count);
    }
#[no_mangle]
unsafe extern "C" fn atkbd_setup_forced_release(id: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn atkbd_setup_scancode_fixup(id: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn atkbd_deactivate_fixup(id: *const dmi_system_id) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn atkbd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn atkbd_exit() -> void __exit {
