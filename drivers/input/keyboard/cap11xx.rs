...
//! Source: drivers/input/keyboard/cap11xx.c
#![no_std]
...
pub const CAP1114_REG_BUTTON_STATUS1: c_uint = 0x03;
pub const CAP1114_REG_BUTTON_STATUS2: c_uint = 0x04;
pub const CAP1114_REG_CONFIG2: c_uint = 0x40;

pub const CAP1114_REG_LED_OUTPUT_CONTROL1: c_uint = 0x73;
pub const CAP11XX_REG_MAIN_CONTROL: c_uint = 0x00;

pub const CAP11XX_REG_SENSOR_INPUT: c_uint = 0x03;
pub const CAP1114_REG_BUTTON_STATUS2: c_uint = 0x04;

pub const CAP11XX_REG_SENSITIVITY_CONTROL: c_uint = 0x1f;
pub const CAP11XX_REG_SENSITIVITY_CONTROL_DELTA_SENSE_MASK: c_uint = 0x70;
pub const CAP11XX_REG_REPEAT_RATE: c_uint = 0x28;
pub const CAP11XX_REG_SIGNAL_GUARD_ENABLE: c_uint = 0x29;

pub const CAP11XX_REG_CONFIG2: c_uint = 0x44;

pub const CAP11XX_REG_LED_OUTPUT_CONTROL: c_uint = 0x74;
pub const CAP11XX_REG_CALIB_SENSITIVITY_CONFIG: c_uint = 0x80;
pub const CAP11XX_REG_CALIB_SENSITIVITY_CONFIG2: c_uint = 0x81;
pub const CAP11XX_REG_LED_DUTY_CYCLE_4: c_uint = 0x93;

pub const CAP11XX_REG_PRODUCT_ID: c_uint = 0xfd;
pub const CAP11XX_REG_MANUFACTURER_ID: c_uint = 0xfe;
pub const CAP11XX_REG_REVISION: c_uint = 0xff;
pub const CAP11XX_MANUFACTURER_ID: c_uint = 0x5d;
pub const CAP11XX_T_RST_FILT_MIN_US: c_int = 10000;
pub const CAP11XX_T_RST_ON_MIN_MS: c_int = 400;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cap11xx_led {
    pub priv: *mut cap11xx_priv,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cap11xx_priv {
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub idev: *mut input_dev,
    pub reset_gpio: *mut gpio_desc,
    pub model: *const cap11xx_hw_model,
    pub leds: *mut cap11xx_led,
    pub num_leds: c_int,
// config
    pub analog_gain: u8,
    pub sensitivity_delta_sense: u8,
    pub signal_guard_inputs_mask: u8,
    pub thresholds: [u32; 8],
    pub calib_sensitivities: [u32; 8],
    pub keycodes: [u32; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cap11xx_hw_model {
    pub product_id: u8,
    pub led_output_control_reg_base: u8,
    pub sensor_input_reg_base: u8,
    pub num_channels: c_uint,
    pub num_leds: c_uint,
    pub num_sensor_thresholds: c_uint,
    pub has_gain: bool,
    pub has_grouped_sensors: bool,
    pub has_irq_config: bool,
    pub has_repeat_en: bool,
    pub has_sensitivity_control: bool,
    pub has_signal_guard: bool,
}
...
#[no_mangle]
unsafe extern "C" fn cap11xx_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cap11xx_write_calib_sens_config_1(priv: *mut cap11xx_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cap11xx_write_calib_sens_config_2(priv: *mut cap11xx_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cap11xx_init_keys(priv: *mut cap11xx_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cap11xx_thread_func(irq_num: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cap11xx_set_sleep(priv: *mut cap11xx_priv, sleep: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cap11xx_input_open(idev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cap11xx_input_close(idev: *mut input_dev) {
...
//
    ...
    let mut cnt: c_int = of_get_child_count(node);
    int error;
    u32 duty_val;
    if (!num_leds || !cnt)
    return 0;
...
// Set all LEDs to off
    ...
    u32 reg;
    led.cdev.name =
    of_get_property(child, "label", core::ptr::null_mut()) ? : child.name;
    led.cdev.default_trigger =
    of_get_property(child, "linux,default-trigger", core::ptr::null_mut());
    led.cdev.flags = 0;
...
#[no_mangle]
unsafe extern "C" fn cap11xx_i2c_probe(i2c_client: *mut i2c_client) -> c_int {
...
//
    ...
    core::ptr::null_mut(), cap11xx_thread_func,
