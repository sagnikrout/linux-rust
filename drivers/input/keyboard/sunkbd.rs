...
//! Source: drivers/input/keyboard/sunkbd.c
#![no_std]
...
pub const SUNKBD_CMD_RESET: c_uint = 0x1;
pub const SUNKBD_CMD_BELLON: c_uint = 0x2;
pub const SUNKBD_CMD_BELLOFF: c_uint = 0x3;
pub const SUNKBD_CMD_CLICK: c_uint = 0xa;
pub const SUNKBD_CMD_NOCLICK: c_uint = 0xb;
pub const SUNKBD_CMD_SETLED: c_uint = 0xe;
pub const SUNKBD_CMD_LAYOUT: c_uint = 0xf;
pub const SUNKBD_RET_RESET: c_uint = 0xff;
pub const SUNKBD_RET_ALLUP: c_uint = 0x7f;
pub const SUNKBD_RET_LAYOUT: c_uint = 0xfe;
pub const SUNKBD_LAYOUT_5_MASK: c_uint = 0x20;
pub const SUNKBD_RELEASE: c_uint = 0x80;
pub const SUNKBD_KEY: c_uint = 0x7f;
//
// Per-keyboard data.
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunkbd {
    pub keycode: [c_uchar; ARRAY_SIZE(sunkbd_keycode)],
    ...
    pub type: c_char,
    pub enabled: bool,
    pub reset: volatile s8,
    pub layout: volatile s8,
}
...
//
#[no_mangle]
unsafe extern "C" fn sunkbd_initialize(sunkbd: *mut sunkbd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sunkbd_set_leds_beeps(sunkbd: *mut sunkbd) {
...
//
#[no_mangle]
unsafe extern "C" fn sunkbd_reinit(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sunkbd_enable(sunkbd: *mut sunkbd, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn sunkbd_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sunkbd_disconnect(serio: *mut serio) {
