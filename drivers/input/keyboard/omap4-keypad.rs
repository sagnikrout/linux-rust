...
//! Source: drivers/input/keyboard/omap4-keypad.c
#![no_std]
...
// OMAP4 registers
pub const OMAP4_KBD_REVISION: c_uint = 0x00;
pub const OMAP4_KBD_SYSCONFIG: c_uint = 0x10;
pub const OMAP4_KBD_SYSSTATUS: c_uint = 0x14;
pub const OMAP4_KBD_IRQSTATUS: c_uint = 0x18;
pub const OMAP4_KBD_IRQENABLE: c_uint = 0x1C;
pub const OMAP4_KBD_WAKEUPENABLE: c_uint = 0x20;
pub const OMAP4_KBD_PENDING: c_uint = 0x24;
pub const OMAP4_KBD_CTRL: c_uint = 0x28;
pub const OMAP4_KBD_DEBOUNCINGTIME: c_uint = 0x2C;
pub const OMAP4_KBD_LONGKEYTIME: c_uint = 0x30;
pub const OMAP4_KBD_TIMEOUT: c_uint = 0x34;
pub const OMAP4_KBD_STATEMACHINE: c_uint = 0x38;
pub const OMAP4_KBD_ROWINPUTS: c_uint = 0x3C;
pub const OMAP4_KBD_COLUMNOUTPUTS: c_uint = 0x40;
pub const OMAP4_KBD_FULLCODE31_0: c_uint = 0x44;
pub const OMAP4_KBD_FULLCODE63_32: c_uint = 0x48;
// OMAP4 bit definitions

pub const OMAP4_DEF_CTRL_PTV_SHIFT: c_int = 2;
// OMAP4 values
pub const OMAP4_VAL_IRQDISABLE: c_uint = 0x0;
//
...
//
pub const OMAP4_KEYPAD_PTV_DIV_128: c_uint = 0x6;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap4_keypad {
    pub input: *mut input_dev,
    pub base: *mut void __iomem,
    pub irq: c_uint,
    pub /: *mut *mut mutex lock; / for key scan,
    pub rows: c_uint,
    pub cols: c_uint,
    pub reg_offset: u32,
    pub irqreg_offset: u32,
...
#[no_mangle]
unsafe extern "C" fn kbd_readl(keypad_data: *mut omap4_keypad, offset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_writel(keypad_data: *mut omap4_keypad, offset: u32, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn kbd_read_irqreg(keypad_data: *mut omap4_keypad, offset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap4_keypad_scan_keys(keypad_data: *mut omap4_keypad, keys: u64) {
...
// Interrupt handlers
#[no_mangle]
unsafe extern "C" fn omap4_keypad_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn omap4_keypad_irq_thread_fn(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn omap4_keypad_open(input: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap4_keypad_stop(keypad_data: *mut omap4_keypad) {
...
#[no_mangle]
unsafe extern "C" fn omap4_keypad_close(input: *mut input_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn omap4_keypad_runtime_suspend(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(omap4_keypad_runtime_suspend, core::ptr::null_mut(), core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn omap4_disable_pm(d: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn omap4_keypad_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap4_keypad_remove(pdev: *mut platform_device) {
