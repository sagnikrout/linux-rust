...
//! Source: drivers/input/keyboard/jornada720_kbd.c
#![no_std]
...
pub struct jornadakbd {
    pub keymap: [c_ushort; ARRAY_SIZE(jornada_std_keymap)],
    pub input: *mut input_dev,
}

#[no_mangle]
unsafe extern "C" fn jornada720_kbd_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn jornada720_kbd_probe(pdev: *mut platform_device) -> c_int {
