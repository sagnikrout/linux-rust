...
//! Source: drivers/input/keyboard/sun4i-lradc-keys.c
#![no_std]
...
pub const LRADC_CTRL: c_uint = 0x00;
pub const LRADC_INTC: c_uint = 0x04;
pub const LRADC_INTS: c_uint = 0x08;
pub const LRADC_DATA0: c_uint = 0x0c;
pub const LRADC_DATA1: c_uint = 0x10;
// LRADC_CTRL bits
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lradc_variant {
    pub divisor_numerator: u8,
    pub divisor_denominator: u8,
    pub has_clock_reset: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_lradc_data {
    pub dev: *mut device,
    pub input: *mut input_dev,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub reset: *mut reset_control,
    pub vref_supply: *mut regulator,
    pub chan0_map: *mut sun4i_lradc_keymap,
    pub variant: *const lradc_variant,
    pub chan0_map_count: u32,
    pub chan0_keycode: u32,
    pub vref: u32,
}

#[no_mangle]
unsafe extern "C" fn sun4i_lradc_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sun4i_lradc_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_lradc_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn sun4i_lradc_probe(pdev: *mut platform_device) -> c_int {
    ...
    lradc.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(lradc.clk))
    return PTR_ERR(lradc.clk);
    lradc.reset = devm_reset_control_get_exclusive(dev, core::ptr::null_mut());
