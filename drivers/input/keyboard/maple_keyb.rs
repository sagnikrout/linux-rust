...
//! Source: drivers/input/keyboard/maple_keyb.c
#![no_std]
...
pub const NR_SCANCODES: c_int = 256;
...
pub struct dc_kbd {
    ...
    pub keycode: [c_ushort; NR_SCANCODES],
    pub new: [c_uchar; 8],
    pub old: [c_uchar; 8],
}
...
#[no_mangle]
unsafe extern "C" fn dc_scan_kbd(kbd: *mut dc_kbd) {
    ...
    code = kbd.old[i];
    if (code > 3 && ptr == core::ptr::null_mut()) {
    keycode = kbd.keycode[code];
    if (keycode) {
    input_event(dev, EV_MSC, MSC_SCAN, code);
...
#[no_mangle]
unsafe extern "C" fn dc_kbd_callback(mq: *mut mapleq) {
...
#[no_mangle]
unsafe extern "C" fn probe_maple_kbd(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_maple_kbd(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dc_kbd_init() -> int __init {
    static int __init dc_kbd_init(void)
    {
    return maple_driver_register(&dc_kbd_driver);
    }
#[no_mangle]
unsafe extern "C" fn dc_kbd_exit() -> void __exit {
