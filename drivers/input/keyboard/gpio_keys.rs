...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_button_data {
    pub button: *const gpio_keys_button,
    pub input: *mut input_dev,
    pub gpiod: *mut gpio_desc,
    pub code: *mut c_ushort,
    pub release_timer: hrtimer,
    pub /: *mut *mut unsigned int release_delay; / in msecs, for IRQ-only buttons,
    pub work: delayed_work,
    pub debounce_timer: hrtimer,
    pub /: *mut *mut unsigned int software_debounce; / in msecs, for GPIO-driven buttons,
    pub irq: c_uint,
    pub wakeirq: c_uint,
    pub wakeup_trigger_type: c_uint,
    pub lock: spinlock_t,
    pub disabled: bool,
    pub key_pressed: bool,
    pub suspended: bool,
    pub debounce_use_hrtimer: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_keys_drvdata {
    pub pdata: *const gpio_keys_platform_data,
    pub input: *mut input_dev,
    pub disable_lock: mutex,
    pub keymap: *mut c_ushort,
    pub data: [gpio_button_data; ],
}
...
//
#[no_mangle]
unsafe extern "C" fn get_n_events_by_type(type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_quiesce_key(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bdata->debounce_use_hrtimer) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn gpio_keys_disable_button(bdata: *mut gpio_button_data) {
...
//
#[no_mangle]
unsafe extern "C" fn gpio_keys_enable_button(bdata: *mut gpio_button_data) {
...
//
    ...
    bool only_disabled)
    {
    let mut n_events: c_int = get_n_events_by_type(type);
    unsigned long *bits;
    ssize_t ret;
    int i;
...
//
    static DEVICE_ATTR(keys, S_IRUGO, gpio_keys_show_keys, core::ptr::null_mut());
    static DEVICE_ATTR(switches, S_IRUGO, gpio_keys_show_switches, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_gpio_report_event(bdata: *mut gpio_button_data) {
    static void gpio_keys_gpio_report_event(struct gpio_button_data *bdata)
    {
    const struct gpio_keys_button *button = bdata.button;
    struct input_dev *input = bdata.input;
    let mut type: c_uint = button.type ?: EV_KEY;
    int state;
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_debounce_event(bdata: *mut gpio_button_data) {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_gpio_work_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_debounce_timer(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_gpio_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_irq_timer(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_irq_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    core::ptr::null_mut(), GPIOD_IN, desc);
...
//
    ...
    if (bdata.gpiod) {
    let mut active_low: bool = gpiod_is_active_low(bdata.gpiod);
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_report_state(ddata: *mut gpio_keys_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_open(input: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_close(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_init() -> int __init {
    static int __init gpio_keys_init(void)
    {
    return platform_driver_register(&gpio_keys_device_driver);
    }
#[no_mangle]
unsafe extern "C" fn gpio_keys_exit() -> void __exit {
