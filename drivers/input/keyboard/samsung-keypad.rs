...
//! Source: drivers/input/keyboard/samsung-keypad.c
#![no_std]
...
pub const SAMSUNG_KEYIFCON: c_uint = 0x00;
pub const SAMSUNG_KEYIFSTSCLR: c_uint = 0x04;
pub const SAMSUNG_KEYIFCOL: c_uint = 0x08;
pub const SAMSUNG_KEYIFROW: c_uint = 0x0c;
pub const SAMSUNG_KEYIFFC: c_uint = 0x10;
// SAMSUNG_KEYIFCON

// SAMSUNG_KEYIFSTSCLR

pub const SAMSUNG_KEYIFSTSCLR_R_INT_OFFSET: c_int = 8;

pub const S5PV210_KEYIFSTSCLR_R_INT_OFFSET: c_int = 16;
// SAMSUNG_KEYIFCOL
pub const SAMSUNG_KEYIFCOL_MASK: c_uint = 0xff;
// SAMSUNG_KEYIFROW
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct samsung_chip_info {
    pub column_shift: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct samsung_keypad {
    pub chip: *const samsung_chip_info,
    ...
    pub rows: c_uint,
    pub cols: c_uint,
    pub row_state: [c_uint; SAMSUNG_MAX_COLS],
    pub keycodes: [c_ushort; ],
}
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_start(keypad: *mut samsung_keypad) {
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_stop(keypad: *mut samsung_keypad) {
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_open(input_dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_close(input_dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_probe(pdev: *mut platform_device) -> c_int {
...
// initialize the gpio
    ...
    error = devm_request_threaded_irq(&pdev.dev, keypad.irq, core::ptr::null_mut(),
    samsung_keypad_irq,
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn samsung_keypad_resume(dev: *mut device) -> c_int {
    ...
    samsung_keypad_runtime_resume, core::ptr::null_mut())
    };
