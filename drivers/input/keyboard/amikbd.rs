...
//! Source: drivers/input/keyboard/amikbd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn amikbd_init_console_keymaps() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn amikbd_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn amikbd_probe(pdev: *mut platform_device) -> int __init {
