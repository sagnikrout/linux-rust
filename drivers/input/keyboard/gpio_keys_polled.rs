...
//! Source: drivers/input/keyboard/gpio_keys_polled.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_keys_button_data {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_keys_polled_dev {
    pub input: *mut input_dev,
    pub dev: *mut device,
    pub pdata: *const gpio_keys_platform_data,
    pub rel_axis_seen: [c_ulong; BITS_TO_LONGS(REL_CNT)],
    pub abs_axis_seen: [c_ulong; BITS_TO_LONGS(ABS_CNT)],
    pub data: [gpio_keys_button_data; ],
}
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_polled_poll(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_polled_open(input: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_polled_close(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn gpio_keys_polled_probe(pdev: *mut platform_device) -> c_int {
