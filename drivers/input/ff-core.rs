...
//! Source: drivers/input/ff-core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn compat_effect(ff: *mut ff_device, effect: *mut ff_effect) -> c_int {
...
//
    ...
    ff.effect_owners[effect_id] = core::ptr::null_mut();
    }
    if (ff.erase) {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_ff_erase(dev: *mut input_dev, effect_id: c_int, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_ff_flush(dev: *mut input_dev, file: *mut file) -> c_int {
...
//
    ...
    break;
    default:
    if (check_effect_access(ff, code, core::ptr::null_mut()) == 0)
...
//
#[no_mangle]
pub unsafe extern "C" fn input_ff_create(dev: *mut input_dev, max_effects: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_ff_destroy(dev: *mut input_dev) {
