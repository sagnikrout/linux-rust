...
//
    ...
    MODULE_LICENSE("GPL");
pub const INPUT_MAX_CHAR_DEVICES: c_int = 1024;
pub const INPUT_FIRST_DYNAMIC_DEV: c_int = 256;
...
//
    ...
    let mut input_value_sync: static struct input_value = { EV_SYN, SYN_REPORT, 1 };
...
#[no_mangle]
unsafe extern "C" fn input_defuzz_abs_event(value: c_int, old_val: c_int, fuzz: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_start_autorepeat(dev: *mut input_dev, code: c_int) {
...
#[no_mangle]
unsafe extern "C" fn input_stop_autorepeat(dev: *mut input_dev) {
...
pub const INPUT_IGNORE_EVENT: c_int = 0;
pub const INPUT_PASS_TO_HANDLERS: c_int = 1;
pub const INPUT_PASS_TO_DEVICE: c_int = 2;
pub const INPUT_SLOT: c_int = 4;
pub const INPUT_FLUSH: c_int = 8;

    static int input_handle_abs_event(struct input_dev *dev,
    unsigned int code, int *pval)
    {
    struct input_mt *mt = dev.mt;
    let mut is_new_slot: bool = false;
    bool is_mt_event;
    int *pold;
    if (code == ABS_MT_SLOT) {
//
...
// Flush pending "slot" event
    ...
    {
    let mut disposition: c_int = INPUT_IGNORE_EVENT;
    let mut value: c_int = *pval;
...
//
#[no_mangle]
pub unsafe extern "C" fn input_alloc_absinfo(dev: *mut input_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_grab_device(handle: *mut input_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __input_release_device(handle: *mut input_handle) {
    ...
    if (grabber == handle) {
    rcu_assign_pointer(dev.grab, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn input_release_device(handle: *mut input_handle) {
...
//
#[no_mangle]
unsafe extern "C" fn input_dev_toggle(dev: *mut input_dev, activate: bool) {
...
#[no_mangle]
unsafe extern "C" fn input_start_device(dev: *mut input_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_open_device(handle: *mut input_handle) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn input_flush_device(handle: *mut input_handle, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_close_device(handle: *mut input_handle) {
...
//
#[no_mangle]
unsafe extern "C" fn input_dev_release_keys(dev: *mut input_dev) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn input_disconnect_device(dev: *mut input_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_get_keycode(dev: *mut input_dev, ke: *mut input_keymap_entry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_attach_handler(dev: *mut input_dev, handler: *mut input_handler) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn input_wakeup_procfs_readers() {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct input_seq_state {
    pub pos: c_ushort,
    pub mutex_acquired: bool,
    pub input_devices_state: c_int,
}

#[no_mangle]
unsafe extern "C" fn input_proc_devices_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn input_seq_stop(seq: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn input_devices_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_proc_devices_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_handlers_seq_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_proc_handlers_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_proc_init() -> int __init {
    static int __init input_proc_init(void)
    {
    struct proc_dir_entry *entry;
    proc_bus_input_dir = proc_mkdir("bus/input", core::ptr::null_mut());
    ...
    fail1: remove_proc_entry("bus/input", core::ptr::null_mut());
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn input_proc_exit() {
    static void input_proc_exit(void)
    {
    remove_proc_entry("devices", proc_bus_input_dir);
    remove_proc_entry("handlers", proc_bus_input_dir);
    remove_proc_entry("bus/input", core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR(_arg: name, _arg: S_IRUGO, _arg: input_dev_show_##name, _arg: NULL) -> static {
    static DEVICE_ATTR(name, S_IRUGO, input_dev_show_##name, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn input_print_modalias(buf: *mut c_char, size: c_int, id: *const input_dev) -> c_int {
...
//
    full_len = input_print_modalias_parts(core::ptr::null_mut(), 0, 0, id);
    ...
    static DEVICE_ATTR(modalias, S_IRUGO, input_dev_show_modalias, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(properties, S_IRUGO, input_dev_show_properties, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR(_arg: name, _arg: S_IRUGO, _arg: input_dev_show_id_##name, _arg: NULL) -> static {
    static DEVICE_ATTR(name, S_IRUGO, input_dev_show_id_##name, core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR(_arg: bm, _arg: S_IRUGO, _arg: input_dev_show_cap_##bm, _arg: NULL) -> static {
    static DEVICE_ATTR(bm, S_IRUGO, input_dev_show_cap_##bm, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn input_dev_release(device: *mut device) {
...
//
pub const UEVENT_ENV_EXTRA_LEN: c_int = 96;
...
#[no_mangle]
unsafe extern "C" fn input_dev_uevent(device: *const device, env: *mut kobj_uevent_env) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_reset_device(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn input_inhibit_device(dev: *mut input_dev) -> c_int {
    static int input_inhibit_device(struct input_dev *dev)
    {
    guard(mutex)(&dev.mutex);
    if (dev.going_away)
...
#[no_mangle]
unsafe extern "C" fn input_uninhibit_device(dev: *mut input_dev) -> c_int {
    static int input_uninhibit_device(struct input_dev *dev)
    {
    struct input_handle *handle;
    int error;
...
#[no_mangle]
unsafe extern "C" fn input_dev_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_dev_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_dev_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_dev_poweroff(dev: *mut device) -> c_int {
...
//
    ...
    {
    let mut input_no: static atomic_t = ATOMIC_INIT(-1);
    struct input_dev *dev;
    dev = kzalloc_obj(*dev);
    if (!dev)
    return core::ptr::null_mut();
...
//
    ...
    timer_setup(&dev.timer, core::ptr::null_mut(), 0);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct input_devres {
    pub input: *mut input_dev,
}

#[no_mangle]
unsafe extern "C" fn devm_input_device_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_input_device_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_free_device(dev: *mut input_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_set_timestamp(dev: *mut input_dev, timestamp: ktime_t) {
...
//
    ...
    {
    let mut invalid_timestamp: ktime_t = ktime_set(0, 0);
...
//
#[no_mangle]
pub unsafe extern "C" fn input_set_capability(dev: *mut input_dev, type: c_uint, code: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn input_estimate_events_per_packet(dev: *mut input_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn input_cleanse_bitmasks(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn __input_unregister_device(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn devm_input_device_unregister(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn input_repeat_key(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_enable_softrepeat(dev: *mut input_dev, delay: c_int, period: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn input_device_enabled(dev: *mut input_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn input_device_tune_vals(dev: *mut input_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_register_device(dev: *mut input_dev) -> c_int {
    int input_register_device(struct input_dev *dev)
    {
    struct input_devres *devres = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn input_unregister_device(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn input_handler_check_methods(handler: *const input_handler) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_register_handler(handler: *mut input_handler) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_unregister_handler(handler: *mut input_handler) {
...
//
#[no_mangle]
unsafe extern "C" fn input_handle_setup_event_handler(handle: *mut input_handle) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: handler->event) -> else {
    else if (handler.event)
    handle.handle_events = input_handle_events_default;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: handler->events) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_register_handle(handle: *mut input_handle) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_unregister_handle(handle: *mut input_handle) {
...
//
#[no_mangle]
pub unsafe extern "C" fn input_free_minor(minor: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn input_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn input_exit() -> void __exit {
