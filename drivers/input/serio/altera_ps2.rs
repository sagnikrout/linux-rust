...
//! Source: drivers/input/serio/altera_ps2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn altera_ps2_rxint(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn altera_ps2_write(io: *mut serio, val: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn altera_ps2_open(io: *mut serio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn altera_ps2_close(io: *mut serio) {
...
//
#[no_mangle]
unsafe extern "C" fn altera_ps2_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!ps2if)
    return -ENOMEM;
    ps2if.base = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn altera_ps2_remove(pdev: *mut platform_device) {
