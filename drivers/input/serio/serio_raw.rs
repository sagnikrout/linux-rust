...
//! Source: drivers/input/serio/serio_raw.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const SERIO_RAW_QUEUE_LEN: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serio_raw {
    pub queue: [c_uchar; SERIO_RAW_QUEUE_LEN],
    pub head: unsigned int tail,,
    pub name: [c_char; 20],
    pub kref: kref,
    pub serio: *mut serio,
    pub dev: miscdevice,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serio_raw_client {
    pub fasync: *mut fasync_struct,
    pub serio_raw: *mut serio_raw,
    pub node: list_head,
}
...
//
#[no_mangle]
unsafe extern "C" fn serio_raw_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serio_raw_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serio_raw_free(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn serio_raw_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serio_raw_fetch_byte(serio_raw: *mut serio_raw, c: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn serio_raw_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
    ...
    struct serio_raw_client *client;
    let mut head: c_uint = serio_raw.head;
...
#[no_mangle]
unsafe extern "C" fn serio_raw_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
    static int serio_raw_connect(struct serio *serio, struct serio_driver *drv)
    {
    let mut serio_raw_no: static atomic_t = ATOMIC_INIT(-1);
    struct serio_raw *serio_raw;
    int err;
...
#[no_mangle]
unsafe extern "C" fn serio_raw_reconnect(serio: *mut serio) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn serio_raw_hangup(serio_raw: *mut serio_raw) {
...
#[no_mangle]
unsafe extern "C" fn serio_raw_disconnect(serio: *mut serio) {
