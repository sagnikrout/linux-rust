...
//! Source: drivers/input/serio/gscps2.c
#![no_std]
...
pub const GSC_DINO_OFFSET: c_uint = 0x0800	/* offset for DINO controller versus LASI one */;
// PS/2 IO port offsets
pub const GSC_ID: c_uint = 0x00	/* device ID offset (see: GSC_ID_XXX) */;
pub const GSC_RESET: c_uint = 0x00	/* reset port offset */;
pub const GSC_RCVDATA: c_uint = 0x04	/* receive port offset */;
pub const GSC_XMTDATA: c_uint = 0x04	/* transmit port offset */;
pub const GSC_CONTROL: c_uint = 0x08	/* see: Control register bits */;
pub const GSC_STATUS: c_uint = 0x0C	/* see: Status register bits */;
// Control register bits
pub const GSC_CTRL_ENBL: c_uint = 0x01	/* enable interface */;
pub const GSC_CTRL_LPBXR: c_uint = 0x02	/* loopback operation */;
pub const GSC_CTRL_DIAG: c_uint = 0x20	/* directly control clock/data line */;
pub const GSC_CTRL_DATDIR: c_uint = 0x40	/* data line direct control */;
pub const GSC_CTRL_CLKDIR: c_uint = 0x80	/* clock line direct control */;
// Status register bits
pub const GSC_STAT_RBNE: c_uint = 0x01	/* Receive Buffer Not Empty */;
pub const GSC_STAT_TBNE: c_uint = 0x02	/* Transmit Buffer Not Empty */;
pub const GSC_STAT_TERR: c_uint = 0x04	/* Timeout Error */;
pub const GSC_STAT_PERR: c_uint = 0x08	/* Parity Error */;
pub const GSC_STAT_CMPINTR: c_uint = 0x10	/* Composite Interrupt = irq on any port */;
pub const GSC_STAT_DATSHD: c_uint = 0x40	/* Data Line Shadow */;
pub const GSC_STAT_CLKSHD: c_uint = 0x80	/* Clock Line Shadow */;
// IDs returned by GSC_ID port register

pub const GSC_ID_MOUSE: c_int = 1;
...
pub const BUFFER_SIZE: c_uint = 0x0f;
// GSC PS/2 port device struct
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gscps2port {
    pub node: list_head,
    pub padev: *mut parisc_device,
    pub port: *mut serio,
    pub lock: spinlock_t,
    pub addr: *mut char __iomem,
    pub /: *mut *mut u8 act, append; / position in buffer[],
    struct {
    pub data: u8,
    pub str: u8,
    pub buffer: [}; BUFFER_SIZE+1],
    pub id: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn wait_TBE(addr: *mut char __iomem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_flush(ps2port: *mut gscps2port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gscps2_writeb_output(ps2port: *mut gscps2port, data: u8) -> c_int {
...
// this is important e.g. when we set the LEDs on the keyboard
    gscps2_interrupt(0, core::ptr::null_mut());
    return 1;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_enable(ps2port: *mut gscps2port, enable: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_reset(ps2port: *mut gscps2port) {
...
#[no_mangle]
unsafe extern "C" fn gscps2_read_data(ps2port: *mut gscps2port) {
...
#[no_mangle]
unsafe extern "C" fn gscps2_report_data(ps2port: *mut gscps2port) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t gscps2_interrupt(int irq, void *dev)
    {
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_write(port: *mut serio, data: c_uchar) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_open(port: *mut serio) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_close(port: *mut serio) {
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_probe(dev: *mut parisc_device) -> int __init {
    static int __init gscps2_probe(struct parisc_device *dev)
    {
    struct gscps2port *ps2port;
    struct serio *serio;
    let mut hpa: c_ulong = dev.hpa.start;
    int ret;
    if (!dev.irq)
    return -ENODEV;
...
//
#[no_mangle]
unsafe extern "C" fn gscps2_remove(dev: *mut parisc_device) -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn gscps2_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gscps2_exit() -> void __exit {
