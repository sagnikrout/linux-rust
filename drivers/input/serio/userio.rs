...
//! Source: drivers/input/serio/userio.c
#![no_std]
...
pub const USERIO_BUFSIZE: c_int = 16;
    static struct miscdevice userio_misc;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct userio_device {
    pub serio: *mut serio,
    pub mutex: mutex,
    pub running: bool,
    pub head: u8,
    ...
    pub buf: [c_uchar; USERIO_BUFSIZE],
...
//
#[no_mangle]
unsafe extern "C" fn userio_device_write(id: *mut serio, val: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userio_char_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userio_char_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userio_char_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
