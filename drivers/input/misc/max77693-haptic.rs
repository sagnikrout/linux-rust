...
//! Source: drivers/input/misc/max77693-haptic.c
#![no_std]
...
pub const MAX_MAGNITUDE_SHIFT: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77693_haptic {
    pub dev_type: enum max77693_types,
    pub regmap_pmic: *mut regmap,
    pub regmap_haptic: *mut regmap,
    pub dev: *mut device,
    pub input_dev: *mut input_dev,
    pub pwm_dev: *mut pwm_device,
    pub motor_reg: *mut regulator,
    pub enabled: bool,
    pub suspend_state: bool,
    pub magnitude: c_uint,
    pub pwm_duty: c_uint,
    pub type: enum max77693_haptic_motor_type,
    pub mode: enum max77693_haptic_pulse_mode,
    pub work: work_struct,
}

#[no_mangle]
unsafe extern "C" fn max77693_haptic_set_duty_cycle(haptic: *mut max77693_haptic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77843_haptic_bias(haptic: *mut max77693_haptic, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_lowsys(haptic: *mut max77693_haptic, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_enable(haptic: *mut max77693_haptic) {
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_disable(haptic: *mut max77693_haptic) {
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_play_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: haptic->enabled) -> else {
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_probe(pdev: *mut platform_device) -> c_int {
...
// Get pwm and regulatot for haptic device
    haptic.pwm_dev = devm_pwm_get(&pdev.dev, core::ptr::null_mut());
...
// Initialize input device for haptic device
    ...
    error = input_ff_create_memless(haptic.input_dev, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_haptic_resume(dev: *mut device) -> c_int {
