...
//! Source: drivers/input/misc/da9063_onkey.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da906x_chip_config {
// REGS
    pub onkey_status: c_int,
    pub onkey_pwr_signalling: c_int,
    pub onkey_fault_log: c_int,
    pub onkey_shutdown: c_int,
// MASKS
    pub onkey_nonkey_mask: c_int,
    pub onkey_nonkey_lock_mask: c_int,
    pub onkey_key_reset_mask: c_int,
    pub onkey_shutdown_mask: c_int,
// NAMES
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_onkey {
    pub work: delayed_work,
    pub input: *mut input_dev,
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub config: *const da906x_chip_config,
    pub phys: [c_char; 32],
    pub key_power: bool,
}
...
#[no_mangle]
unsafe extern "C" fn da9063_poll_on(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn da9063_onkey_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da9063_onkey_probe(pdev: *mut platform_device) -> c_int {
    ...
    return -ENXIO;
    onkey.dev = &pdev.dev;
    onkey.regmap = dev_get_regmap(pdev.dev.parent, core::ptr::null_mut());
    if (!onkey.regmap)
    ...
    core::ptr::null_mut(), da9063_onkey_irq_handler,
