...
//! Source: drivers/input/misc/palmas-pwrbutton.c
#![no_std]
...
pub const PALMAS_LPK_TIME_MASK: c_uint = 0x0c;
pub const PALMAS_PWRON_DEBOUNCE_MASK: c_uint = 0x03;
pub const PALMAS_PWR_KEY_Q_TIME_MS: c_int = 20;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pwron {
    pub palmas: *mut palmas,
    pub input_dev: *mut input_dev,
    pub input_work: delayed_work,
    pub irq: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct palmas_pwron_config {
    pub long_press_time_val: u8,
    pub pwron_debounce_val: u8,
}
...
//
#[no_mangle]
unsafe extern "C" fn palmas_power_button_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn pwron_irq(irq: c_int, palmas_pwron: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn palmas_pwron_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    error = request_threaded_irq(pwron.irq, core::ptr::null_mut(), pwron_irq,
    IRQF_TRIGGER_HIGH |
    IRQF_TRIGGER_LOW |
    IRQF_ONESHOT,
    dev_name(dev), pwron);
...
//
#[no_mangle]
unsafe extern "C" fn palmas_pwron_remove(pdev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn palmas_pwron_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn palmas_pwron_resume(dev: *mut device) -> c_int {
