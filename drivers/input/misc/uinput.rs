...
//! Source: drivers/input/misc/uinput.c
#![no_std]
...
pub const UINPUT_BUFFER_SIZE: c_int = 16;
pub const UINPUT_NUM_REQUESTS: c_int = 16;
pub const UINPUT_TIMESTAMP_ALLOWED_OFFSET_SECS: c_int = 10;
    enum uinput_state { UIST_NEW_DEVICE, UIST_SETUP_COMPLETE, UIST_CREATED };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uinput_request {
    pub id: c_uint,
    pub /: *mut *mut unsigned int code; / UI_FF_UPLOAD, UI_FF_ERASE,
    pub retval: c_int,
    pub done: completion,
    union {
    pub effect_id: c_uint,
    struct {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uinput_device {
    pub dev: *mut input_dev,
    pub mutex: mutex,
    pub state: enum uinput_state,
    pub state_lock: spinlock_t,
    pub waitq: wait_queue_head_t,
    pub ready: c_uchar,
    pub head: c_uchar,
    pub tail: c_uchar,
    pub buff: [input_event; UINPUT_BUFFER_SIZE],
    pub ff_effects_max: c_uint,
    pub requests: [*mut uinput_request; UINPUT_NUM_REQUESTS],
    pub requests_waitq: wait_queue_head_t,
    pub requests_lock: spinlock_t,
}
...
// Mark slot as available
    spin_lock(&udev.requests_lock);
    udev.requests[id] = core::ptr::null_mut();
    spin_unlock(&udev.requests_lock);
...
//
#[no_mangle]
unsafe extern "C" fn uinput_flush_requests(udev: *mut uinput_device) {
...
#[no_mangle]
unsafe extern "C" fn uinput_dev_set_gain(dev: *mut input_dev, gain: u16) {
    static void uinput_dev_set_gain(struct input_dev *dev, u16 gain)
    {
    uinput_dev_event(dev, EV_FF, FF_GAIN, gain);
    }
#[no_mangle]
unsafe extern "C" fn uinput_dev_set_autocenter(dev: *mut input_dev, magnitude: u16) {
    static void uinput_dev_set_autocenter(struct input_dev *dev, u16 magnitude)
    {
    uinput_dev_event(dev, EV_FF, FF_AUTOCENTER, magnitude);
    }
#[no_mangle]
unsafe extern "C" fn uinput_dev_playback(dev: *mut input_dev, effect_id: c_int, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uinput_dev_erase_effect(dev: *mut input_dev, effect_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uinput_dev_flush(dev: *mut input_dev, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uinput_destroy_device(udev: *mut uinput_device) {
    static void uinput_destroy_device(struct uinput_device *udev)
    {
    const char *name, *phys;
    struct input_dev *dev = udev.dev;
    let mut old_state: enum uinput_state = udev.state;
//
...
//
    ...
    kfree(name);
    kfree(phys);
    udev.dev = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn uinput_create_device(udev: *mut uinput_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uinput_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uinput_validate_absbits(dev: *mut input_dev) -> c_int {
...
//
    ...
    {
    let mut setup: uinput_abs_setup = {};
    struct input_dev *dev;
    int error;
...
//
#[no_mangle]
unsafe extern "C" fn is_valid_timestamp(timestamp: ktime_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn uinput_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn uinput_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uinput_ff_upload_compat {
    pub request_id: __u32,
    pub retval: __s32,
    pub effect: ff_effect_compat,
    pub old: ff_effect_compat,
}
...
#[no_mangle]
unsafe extern "C" fn uinput_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
