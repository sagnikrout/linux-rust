...
//! Source: drivers/input/misc/xen-kbdfront.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xenkbd_info {
    pub kbd: *mut input_dev,
    pub ptr: *mut input_dev,
    pub mtouch: *mut input_dev,
    pub page: *mut xenkbd_page,
    pub gref: c_int,
    pub irq: c_int,
    pub xbdev: *mut xenbus_device,
    pub phys: [c_char; 32],
// current MT slot/contact ID we are injecting events in
    pub mtouch_cur_contact_id: c_int,
}

    enum { KPARAM_X, KPARAM_Y, KPARAM_CNT };
    static int ptr_size[KPARAM_CNT] = { XENFB_WIDTH, XENFB_HEIGHT };
    module_param_array(ptr_size, int, core::ptr::null_mut(), 0444);
...
//
    ...
    let mut value: c_int = key.pressed;
...
#[no_mangle]
unsafe extern "C" fn input_handler(rq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xenkbd_resume(dev: *mut xenbus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xenkbd_remove(dev: *mut xenbus_device) {
    ...
    error_grant:
    gnttab_end_foreign_access(info.gref, core::ptr::null_mut());
    info.gref = -1;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn xenkbd_disconnect_backend(info: *mut xenkbd_info) {
...
#[no_mangle]
unsafe extern "C" fn xenkbd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xenkbd_cleanup() -> void __exit {
