...
//! Source: drivers/input/misc/pf1550-onkey.c
#![no_std]
...
pub const PF1550_ONKEY_IRQ_NR: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct onkey_drv_data {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn pf1550_onkey_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pf1550_onkey_probe(pdev: *mut platform_device) -> c_int {
    static int pf1550_onkey_probe(struct platform_device *pdev)
    {
    struct onkey_drv_data *onkey;
    struct input_dev *input;
    let mut key_power: bool = false;
    int i, irq, error;
...
#[no_mangle]
unsafe extern "C" fn pf1550_onkey_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf1550_onkey_resume(dev: *mut device) -> c_int {
