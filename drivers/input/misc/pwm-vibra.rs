...
//! Source: drivers/input/misc/pwm-vibra.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwm_vibrator {
    pub input: *mut input_dev,
    pub enable_gpio: *mut gpio_desc,
    pub pwm: *mut pwm_device,
    pub pwm_dir: *mut pwm_device,
    pub vcc: *mut regulator,
    pub play_work: work_struct,
    pub level: u16,
    pub direction_duty_cycle: u32,
    pub vcc_on: bool,
}

#[no_mangle]
unsafe extern "C" fn pwm_vibrator_start(vibrator: *mut pwm_vibrator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_vibrator_stop(vibrator: *mut pwm_vibrator) {
...
#[no_mangle]
unsafe extern "C" fn pwm_vibrator_play_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pwm_vibrator_close(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn pwm_vibrator_probe(pdev: *mut platform_device) -> c_int {
...
// Direction PWM is optional
    vibrator.pwm_dir = core::ptr::null_mut();
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn pwm_vibrator_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwm_vibrator_resume(dev: *mut device) -> c_int {
