...
//! Source: drivers/input/misc/keyspan_remote.c
#![no_std]
...
pub const USB_KEYSPAN_VENDOR_ID: c_uint = 0x06CD;
pub const USB_KEYSPAN_PRODUCT_UIA11: c_uint = 0x0202;
// Defines for converting the data from the remote.
pub const ZERO: c_uint = 0x18;
pub const ZERO_MASK: c_uint = 0x1F	/* 5 bits for a 0 */;
pub const ONE: c_uint = 0x3C;
pub const ONE_MASK: c_uint = 0x3F	/* 6 bits for a 1 */;
pub const SYNC: c_uint = 0x3F80;
pub const SYNC_MASK: c_uint = 0x3FFF	/* 14 bits for a SYNC sequence */;
pub const STOP: c_uint = 0x00;
pub const STOP_MASK: c_uint = 0x1F	/* 5 bits for the STOP sequence */;
pub const GAP: c_uint = 0xFF;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usb_keyspan {
    pub name: [c_char; 128],
    pub phys: [c_char; 64],
    pub keymap: [c_ushort; ARRAY_SIZE(keyspan_key_table)],
    pub udev: *mut usb_device,
    pub input: *mut input_dev,
    pub interface: *mut usb_interface,
    pub in_endpoint: *mut usb_endpoint_descriptor,
    pub irq_urb: *mut *mut urb,
    pub open: c_int,
    pub in_dma: dma_addr_t,
    pub in_buffer: *mut c_uchar,
...
//
#[no_mangle]
unsafe extern "C" fn keyspan_load_tester(dev: *mut *mut usb_keyspan, bits_needed: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keyspan_report_button(remote: *mut usb_keyspan, button: c_int, press: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn keyspan_check_data(remote: *mut usb_keyspan) {
...
//
#[no_mangle]
unsafe extern "C" fn keyspan_setup(dev: *mut *mut usb_device) -> c_int {
    static int keyspan_setup(struct usb_device* dev)
    {
    let mut retval: c_int = 0;
    retval = usb_control_msg(dev, usb_sndctrlpipe(dev, 0),
    0x11, 0x40, 0x5601, 0x0, core::ptr::null_mut(), 0,
    ...
    retval = usb_control_msg(dev, usb_sndctrlpipe(dev, 0),
    0x44, 0x40, 0x0, 0x0, core::ptr::null_mut(), 0,
    USB_CTRL_SET_TIMEOUT);
    if (retval) {
    ...
    retval = usb_control_msg(dev, usb_sndctrlpipe(dev, 0),
    0x22, 0x40, 0x0, 0x0, core::ptr::null_mut(), 0,
    USB_CTRL_SET_TIMEOUT);
    if (retval) {
...
//
#[no_mangle]
unsafe extern "C" fn keyspan_irq_recv(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn keyspan_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keyspan_close(dev: *mut input_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn keyspan_probe(interface: *mut usb_interface, id: *const usb_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn keyspan_disconnect(interface: *mut usb_interface) {
