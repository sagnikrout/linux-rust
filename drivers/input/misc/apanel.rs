...
//! Source: drivers/input/misc/apanel.c
#![no_std]
...
pub const POLL_INTERVAL_DEFAULT: c_int = 1000;
...
pub const MAX_PANEL_KEYS: c_int = 12;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apanel {
    pub idev: *mut input_dev,
    pub client: *mut i2c_client,
    pub keymap: [c_ushort; MAX_PANEL_KEYS],
    pub nkeys: u16,
    pub mail_led: led_classdev,
}
...
#[no_mangle]
unsafe extern "C" fn report_key(input: *mut input_dev, keycode: unsigned) {
...
//
#[no_mangle]
unsafe extern "C" fn apanel_poll(idev: *mut input_dev) {
    static void apanel_poll(struct input_dev *idev)
    {
    struct apanel *ap = input_get_drvdata(idev);
    let mut cmd: u8 = device_chip[APANEL_DEV_APPBTN] == CHIP_OZ992C ? 0 : 8;
    s32 data;
    int i;
...
// write back to clear latch
    ...
    let mut led_bits: u16 = value != LED_OFF ? 0x8000 : 0x0000;
    return i2c_smbus_write_word_data(ap.client, 0x10, led_bits);
    }
#[no_mangle]
unsafe extern "C" fn apanel_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apanel_shutdown(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn apanel_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(CHIP_NONE: device_chip[devno] !=) -> else {
    else if (device_chip[devno] != CHIP_NONE)
    pr_warn(APANEL ": duplicate entry for devno %u\n",
    devno);
#[no_mangle]
pub unsafe extern "C" fn if(4: method != 1 && method != 2 && method !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn apanel_cleanup() -> void __exit {
