...
//! Source: drivers/input/misc/iqs269a.c
#![no_std]
...
pub const IQS269_VER_INFO: c_uint = 0x00;
pub const IQS269_VER_INFO_PROD_NUM: c_uint = 0x4F;
pub const IQS269_VER_INFO_FW_NUM_2: c_uint = 0x03;
pub const IQS269_VER_INFO_FW_NUM_3: c_uint = 0x10;
pub const IQS269_SYS_FLAGS: c_uint = 0x02;

pub const IQS269_SYS_FLAGS_PWR_MODE_SHIFT: c_int = 11;

pub const IQS269_CHx_COUNTS: c_uint = 0x08;
pub const IQS269_SLIDER_X: c_uint = 0x30;
pub const IQS269_CAL_DATA_A: c_uint = 0x35;

pub const IQS269_CAL_DATA_A_HALL_BIN_L_SHIFT: c_int = 12;

pub const IQS269_CAL_DATA_A_HALL_BIN_R_SHIFT: c_int = 8;
pub const IQS269_SYS_SETTINGS: c_uint = 0x80;

pub const IQS269_SYS_SETTINGS_PWR_MODE_SHIFT: c_int = 11;
pub const IQS269_SYS_SETTINGS_PWR_MODE_MAX: c_int = 3;

pub const IQS269_SYS_SETTINGS_ULP_UPDATE_SHIFT: c_int = 8;
pub const IQS269_SYS_SETTINGS_ULP_UPDATE_MAX: c_int = 7;

pub const IQS269_FILT_STR_LP_LTA_SHIFT: c_int = 6;

pub const IQS269_FILT_STR_LP_CNT_SHIFT: c_int = 4;

pub const IQS269_FILT_STR_NP_LTA_SHIFT: c_int = 2;

pub const IQS269_FILT_STR_MAX: c_int = 3;

pub const IQS269_RATE_NP_MS_MAX: c_int = 255;
pub const IQS269_RATE_LP_MS_MAX: c_int = 255;
pub const IQS269_RATE_ULP_MS_MAX: c_int = 4080;
pub const IQS269_TIMEOUT_PWR_MS_MAX: c_int = 130560;
pub const IQS269_TIMEOUT_LTA_MS_MAX: c_int = 130560;

pub const IQS269_MISC_A_GPIO3_SELECT_SHIFT: c_int = 8;

pub const IQS269_MISC_A_TX_FREQ_SHIFT: c_int = 4;
pub const IQS269_MISC_A_TX_FREQ_MAX: c_int = 3;

pub const IQS269_MISC_B_RESEED_UI_SEL_SHIFT: c_int = 6;
pub const IQS269_MISC_B_RESEED_UI_SEL_MAX: c_int = 3;

pub const IQS269_TOUCH_HOLD_SLIDER_SEL: c_uint = 0x89;
pub const IQS269_TOUCH_HOLD_DEFAULT: c_uint = 0x14;
pub const IQS269_TOUCH_HOLD_MS_MIN: c_int = 256;
pub const IQS269_TOUCH_HOLD_MS_MAX: c_int = 65280;
pub const IQS269_TIMEOUT_TAP_MS_MAX: c_int = 4080;
pub const IQS269_TIMEOUT_SWIPE_MS_MAX: c_int = 4080;
pub const IQS269_THRESH_SWIPE_MAX: c_int = 255;

pub const IQS269_CHx_ENG_A_ATI_MODE_SHIFT: c_int = 8;
pub const IQS269_CHx_ENG_A_ATI_MODE_MAX: c_int = 3;

pub const IQS269_CHx_ENG_A_PROJ_BIAS_SHIFT: c_int = 5;
pub const IQS269_CHx_ENG_A_PROJ_BIAS_MAX: c_int = 3;

pub const IQS269_CHx_ENG_A_SENSE_MODE_MAX: c_int = 15;

pub const IQS269_CHx_ENG_B_SENSE_FREQ_SHIFT: c_int = 9;
pub const IQS269_CHx_ENG_B_SENSE_FREQ_MAX: c_int = 3;

pub const IQS269_CHx_ENG_B_ATI_BASE_75: c_uint = 0x00;
pub const IQS269_CHx_ENG_B_ATI_BASE_100: c_uint = 0x40;
pub const IQS269_CHx_ENG_B_ATI_BASE_150: c_uint = 0x80;
pub const IQS269_CHx_ENG_B_ATI_BASE_200: c_uint = 0xC0;

pub const IQS269_CHx_ENG_B_ATI_TARGET_MAX: c_int = 2016;
pub const IQS269_CHx_WEIGHT_MAX: c_int = 255;
pub const IQS269_CHx_THRESH_MAX: c_int = 255;

pub const IQS269_CHx_HYST_DEEP_SHIFT: c_int = 4;

pub const IQS269_CHx_HYST_MAX: c_int = 15;
pub const IQS269_CHx_HALL_INACTIVE: c_int = 6;
pub const IQS269_CHx_HALL_ACTIVE: c_int = 7;

pub const IQS269_HALL_UI: c_uint = 0xF5;

pub const IQS269_MAX_REG: c_uint = 0xFF;
pub const IQS269_OTP_OPTION_DEFAULT: c_uint = 0x00;
pub const IQS269_OTP_OPTION_TWS: c_uint = 0xD0;

pub const IQS269_NUM_CH: c_int = 8;
pub const IQS269_NUM_SL: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs269_event_desc {
    pub name: *const c_char,
    pub st_offs: enum iqs269_st_offs,
    pub th_offs: enum iqs269_th_offs,
    pub dir_up: bool,
    pub mask: u8,
}
...
pub struct iqs269_sys_reg {
    ...
    pub blocking: u8,
    pub padding: u8,
    pub slider_select: [u8; IQS269_NUM_SL],
    pub timeout_tap: u8,
    pub timeout_swipe: u8,
    pub thresh_swipe: u8,
    pub redo_ati: u8,
    pub ch_reg: [iqs269_ch_reg; IQS269_NUM_CH],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs269_flags {
    pub system: __be16,
    pub gesture: u8,
    pub padding: u8,
    pub states: [u8; 4],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs269_private {
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub lock: mutex,
    pub switches: [iqs269_switch_desc; ARRAY_SIZE(iqs269_events)],
    pub ver_info: iqs269_ver_info,
    pub sys_reg: iqs269_sys_reg,
    pub ati_done: completion,
    pub keypad: *mut input_dev,
    pub slider: [*mut input_dev; IQS269_NUM_SL],
    pub IQS269_NUM_CH]: *mut *mut unsigned int keycode[ARRAY_SIZE(iqs269_events),
    pub sl_code: [c_uint; IQS269_NUM_SL][IQS269_NUM_GESTURES],
    pub otp_option: c_uint,
    pub ch_num: c_uint,
    pub hall_enable: bool,
    pub ati_current: bool,
}
...
#[no_mangle]
unsafe extern "C" fn iqs269_parse_prop(iqs269: *mut iqs269_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs269_dev_init(iqs269: *mut iqs269_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs269_input_init(iqs269: *mut iqs269_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs269_report(iqs269: *mut iqs269_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs269_irq(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn iqs269_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), iqs269_irq, IRQF_ONESHOT,
    client.name, iqs269);
    if (error) {
...
#[no_mangle]
unsafe extern "C" fn iqs269_general_get(iqs269: *mut iqs269_private) -> u16 {
    static u16 iqs269_general_get(struct iqs269_private *iqs269)
    {
    let mut general: u16 = be16_to_cpu(iqs269.sys_reg.general);
    general &= ~IQS269_SYS_SETTINGS_REDO_ATI;
    general &= ~IQS269_SYS_SETTINGS_ACK_RESET;
    return general | IQS269_SYS_SETTINGS_DIS_AUTO;
    }
#[no_mangle]
unsafe extern "C" fn iqs269_suspend(dev: *mut device) -> c_int {
    static int iqs269_suspend(struct device *dev)
    {
    struct iqs269_private *iqs269 = dev_get_drvdata(dev);
    struct i2c_client *client = iqs269.client;
    int error;
    let mut general: u16 = iqs269_general_get(iqs269);
...
#[no_mangle]
unsafe extern "C" fn iqs269_resume(dev: *mut device) -> c_int {
