...
//! Source: drivers/input/misc/da7280.c
#![no_std]
...
// Registers
pub const DA7280_IRQ_EVENT1: c_uint = 0x03;
pub const DA7280_IRQ_EVENT_WARNING_DIAG: c_uint = 0x04;
pub const DA7280_IRQ_EVENT_SEQ_DIAG: c_uint = 0x05;
pub const DA7280_IRQ_STATUS1: c_uint = 0x06;
pub const DA7280_IRQ_MASK1: c_uint = 0x07;
pub const DA7280_FRQ_LRA_PER_H: c_uint = 0x0A;
pub const DA7280_FRQ_LRA_PER_L: c_uint = 0x0B;
pub const DA7280_ACTUATOR1: c_uint = 0x0C;
pub const DA7280_ACTUATOR2: c_uint = 0x0D;
pub const DA7280_ACTUATOR3: c_uint = 0x0E;
pub const DA7280_CALIB_V2I_H: c_uint = 0x0F;
pub const DA7280_CALIB_V2I_L: c_uint = 0x10;
pub const DA7280_TOP_CFG1: c_uint = 0x13;
pub const DA7280_TOP_CFG2: c_uint = 0x14;
pub const DA7280_TOP_CFG4: c_uint = 0x16;
pub const DA7280_TOP_INT_CFG1: c_uint = 0x17;
pub const DA7280_TOP_CTL1: c_uint = 0x22;
pub const DA7280_TOP_CTL2: c_uint = 0x23;
pub const DA7280_SEQ_CTL2: c_uint = 0x28;
pub const DA7280_GPI_0_CTL: c_uint = 0x29;
pub const DA7280_GPI_1_CTL: c_uint = 0x2A;
pub const DA7280_GPI_2_CTL: c_uint = 0x2B;
pub const DA7280_MEM_CTL1: c_uint = 0x2C;
pub const DA7280_MEM_CTL2: c_uint = 0x2D;
pub const DA7280_TOP_CFG5: c_uint = 0x6E;
pub const DA7280_IRQ_MASK2: c_uint = 0x83;
pub const DA7280_SNP_MEM_99: c_uint = 0xE7;
// Register field
...
// Controls
pub const DA7280_VOLTAGE_RATE_MAX: c_int = 6000000;
pub const DA7280_VOLTAGE_RATE_STEP: c_int = 23400;
pub const DA7280_NOMMAX_DFT: c_uint = 0x6B;
pub const DA7280_ABSMAX_DFT: c_uint = 0x78;
pub const DA7280_IMPD_MAX: c_int = 1500000000;
pub const DA7280_IMPD_DEFAULT: c_int = 22000000;
pub const DA7280_IMAX_DEFAULT: c_uint = 0x0E;
pub const DA7280_IMAX_STEP: c_int = 7200;
pub const DA7280_IMAX_LIMIT: c_int = 252000;
pub const DA7280_RESONT_FREQH_DFT: c_uint = 0x39;
pub const DA7280_RESONT_FREQL_DFT: c_uint = 0x32;
pub const DA7280_MIN_RESONAT_FREQ_HZ: c_int = 50;
pub const DA7280_MAX_RESONAT_FREQ_HZ: c_int = 300;
pub const DA7280_SEQ_ID_MAX: c_int = 15;
pub const DA7280_SEQ_LOOP_MAX: c_int = 15;
pub const DA7280_GPI_SEQ_ID_DFT: c_int = 0;
pub const DA7280_GPI_SEQ_ID_MAX: c_int = 2;
pub const DA7280_SNP_MEM_SIZE: c_int = 100;

pub const DA7280_IRQ_NUM: c_int = 3;
pub const DA7280_SKIP_INIT: c_uint = 0x100;
pub const DA7280_FF_EFFECT_COUNT_MAX: c_int = 15;
// Maximum gain is 0x7fff for PWM mode
pub const DA7280_MAX_MAGNITUDE_SHIFT: c_int = 15;
...
pub const DA7280_FF_CONSTANT_DRO: c_int = 1;
pub const DA7280_FF_PERIODIC_PWM: c_int = 2;
pub const DA7280_FF_PERIODIC_RTWM: c_int = 1;
pub const DA7280_FF_PERIODIC_ETWM: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da7280_haptic {
    pub regmap: *mut regmap,
    pub input_dev: *mut input_dev,
    pub dev: *mut device,
    pub client: *mut i2c_client,
    pub pwm_dev: *mut pwm_device,
    ...
    pub dev_type: u8,
    pub op_mode: u8,
    pub const_op_mode: u8,
    pub periodic_op_mode: u8,
    pub nommax: u16,
    pub absmax: u16,
    pub imax: u32,
    pub impd: u32,
    pub resonant_freq_h: u32,
    pub resonant_freq_l: u32,
    ...
    pub ps_seq_id: u8,
    pub ps_seq_loop: u8,
    pub gpi_ctl: [da7280_gpi_ctl; 3],
    pub mem_update: bool,
    pub snp_mem: [u8; DA7280_SNP_MEM_SIZE],
    pub active: bool,
    pub suspended: bool,
}

#[no_mangle]
unsafe extern "C" fn da7280_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_mem_update(haptics: *mut da7280_haptic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_set_pwm(haptics: *mut da7280_haptic, enabled: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_activate(haptics: *mut da7280_haptic) {
...
// the valid range check when acc_en is enabled
    ...
    haptics.level = 0x7F;
#[no_mangle]
pub unsafe extern "C" fn if(0xFF: haptics->level >) -> else {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_deactivate(haptics: *mut da7280_haptic) {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_start(haptics: *mut da7280_haptic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_stop(haptics: *mut da7280_haptic) {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn da7280_haptic_of_volt_rating_set(val: u32) -> u8 {
    static u8 da7280_haptic_of_volt_rating_set(u32 val)
    {
    let mut voltage: u32 = val / DA7280_VOLTAGE_RATE_STEP + 1;
...
#[no_mangle]
unsafe extern "C" fn da7280_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da7280_init(haptics: *mut da7280_haptic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da7280_probe(client: *mut i2c_client) -> c_int {
    ...
    haptics.pwm_dev = devm_pwm_get(dev, core::ptr::null_mut());
...
// Initialize input device for haptic device
    ...
    core::ptr::null_mut(), da7280_irq_handler,
    IRQF_ONESHOT,
...
#[no_mangle]
unsafe extern "C" fn da7280_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da7280_resume(dev: *mut device) -> c_int {
