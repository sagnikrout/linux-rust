...
//! Source: drivers/input/misc/ims-pcu.c
#![no_std]
...
pub const IMS_PCU_KEYMAP_LEN: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ims_pcu_buttons {
    pub input: *mut input_dev,
    pub name: [c_char; 32],
    pub phys: [c_char; 32],
    pub keymap: [c_ushort; IMS_PCU_KEYMAP_LEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ims_pcu_gamepad {
    pub input: *mut input_dev,
    pub name: [c_char; 32],
    pub phys: [c_char; 32],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ims_pcu_backlight {
    pub cdev: led_classdev,
    pub name: [c_char; 32],
}

pub const IMS_PCU_PART_NUMBER_LEN: c_int = 15;
pub const IMS_PCU_SERIAL_NUMBER_LEN: c_int = 8;
pub const IMS_PCU_DOM_LEN: c_int = 8;
pub const IMS_PCU_FW_VERSION_LEN: c_int = 16;
pub const IMS_PCU_BL_VERSION_LEN: c_int = 16;

pub const IMS_PCU_PCU_B_DEVICE_ID: c_int = 5;
pub const IMS_PCU_BUF_SIZE: c_int = 128;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ims_pcu {
    pub udev: *mut usb_device,
    pub /: *mut *mut *mut device dev; / control interface's device, used for logging,
    pub device_no: c_uint,
    pub bootloader_mode: bool,
    pub part_number: [c_char; IMS_PCU_PART_NUMBER_LEN],
    pub serial_number: [c_char; IMS_PCU_SERIAL_NUMBER_LEN],
    pub date_of_manufacturing: [c_char; IMS_PCU_DOM_LEN],
    pub fw_version: [c_char; IMS_PCU_FW_VERSION_LEN],
    pub bl_version: [c_char; IMS_PCU_BL_VERSION_LEN],
    pub reset_reason: [c_char; IMS_PCU_BL_RESET_REASON_LEN],
    pub update_firmware_status: c_int,
    pub device_id: u8,
    pub ofn_reg_addr: u8,
    pub ctrl_intf: *mut usb_interface,
    pub ep_ctrl: *mut usb_endpoint_descriptor,
    pub urb_ctrl: *mut urb,
    pub urb_ctrl_buf: *mut u8,
    pub ctrl_dma: dma_addr_t,
    pub max_ctrl_size: usize,
    pub data_intf: *mut usb_interface,
    pub ep_in: *mut usb_endpoint_descriptor,
    pub urb_in: *mut urb,
    pub urb_in_buf: *mut u8,
    pub read_dma: dma_addr_t,
    pub max_in_size: usize,
    pub ep_out: *mut usb_endpoint_descriptor,
    pub urb_out_buf: *mut u8,
    pub max_out_size: usize,
    pub read_buf: [u8; IMS_PCU_BUF_SIZE],
    pub read_pos: u8,
    pub check_sum: u8,
    pub have_stx: bool,
    pub have_dle: bool,
    pub cmd_buf: [u8; IMS_PCU_BUF_SIZE],
    pub ack_id: u8,
    ...
    pub fw_end_addr: u32,
    pub async_firmware_done: completion,
    pub buttons: ims_pcu_buttons,
    pub gamepad: *mut ims_pcu_gamepad,
    pub backlight: ims_pcu_backlight,
    pub /: *mut *mut bool setup_complete; / Input and LED devices have been created,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ims_pcu_device_info {
    pub keymap: *const c_ushort,
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_buttons_report(pcu: *mut ims_pcu, data: u32) {
    ...
    int i;
    for (i = 0; i < 32; i++) {
    let mut keycode: c_ushort = buttons.keymap[i];
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_destroy_buttons(pcu: *mut ims_pcu) {
...
//
#[no_mangle]
unsafe extern "C" fn ims_pcu_gamepad_report(pcu: *mut ims_pcu, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_setup_gamepad(pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_destroy_gamepad(pcu: *mut ims_pcu) {
...
//
pub const IMS_PCU_PROTOCOL_STX: c_uint = 0x02;
pub const IMS_PCU_PROTOCOL_ETX: c_uint = 0x03;
pub const IMS_PCU_PROTOCOL_DLE: c_uint = 0x10;
// PCU commands
pub const IMS_PCU_CMD_STATUS: c_uint = 0xa0;
pub const IMS_PCU_CMD_PCU_RESET: c_uint = 0xa1;
pub const IMS_PCU_CMD_RESET_REASON: c_uint = 0xa2;
pub const IMS_PCU_CMD_SEND_BUTTONS: c_uint = 0xa3;
pub const IMS_PCU_CMD_JUMP_TO_BTLDR: c_uint = 0xa4;
pub const IMS_PCU_CMD_GET_INFO: c_uint = 0xa5;
pub const IMS_PCU_CMD_SET_BRIGHTNESS: c_uint = 0xa6;
pub const IMS_PCU_CMD_EEPROM: c_uint = 0xa7;
pub const IMS_PCU_CMD_GET_FW_VERSION: c_uint = 0xa8;
pub const IMS_PCU_CMD_GET_BL_VERSION: c_uint = 0xa9;
pub const IMS_PCU_CMD_SET_INFO: c_uint = 0xab;
pub const IMS_PCU_CMD_GET_BRIGHTNESS: c_uint = 0xac;
pub const IMS_PCU_CMD_GET_DEVICE_ID: c_uint = 0xae;
pub const IMS_PCU_CMD_SPECIAL_INFO: c_uint = 0xb0;
pub const IMS_PCU_CMD_BOOTLOADER: c_uint = 0xb1	/* Pass data to bootloader */;
pub const IMS_PCU_CMD_OFN_SET_CONFIG: c_uint = 0xb3;
pub const IMS_PCU_CMD_OFN_GET_CONFIG: c_uint = 0xb4;
// PCU responses
pub const IMS_PCU_RSP_STATUS: c_uint = 0xc0;

pub const IMS_PCU_RSP_RESET_REASON: c_uint = 0xc2;
pub const IMS_PCU_RSP_SEND_BUTTONS: c_uint = 0xc3;

pub const IMS_PCU_RSP_GET_INFO: c_uint = 0xc5;
pub const IMS_PCU_RSP_SET_BRIGHTNESS: c_uint = 0xc6;
pub const IMS_PCU_RSP_EEPROM: c_uint = 0xc7;
pub const IMS_PCU_RSP_GET_FW_VERSION: c_uint = 0xc8;
pub const IMS_PCU_RSP_GET_BL_VERSION: c_uint = 0xc9;
pub const IMS_PCU_RSP_SET_INFO: c_uint = 0xcb;
pub const IMS_PCU_RSP_GET_BRIGHTNESS: c_uint = 0xcc;
pub const IMS_PCU_RSP_CMD_INVALID: c_uint = 0xcd;
pub const IMS_PCU_RSP_GET_DEVICE_ID: c_uint = 0xce;
pub const IMS_PCU_RSP_SPECIAL_INFO: c_uint = 0xd0;
pub const IMS_PCU_RSP_BOOTLOADER: c_uint = 0xd1	/* Bootloader response */;
pub const IMS_PCU_RSP_OFN_SET_CONFIG: c_uint = 0xd2;
pub const IMS_PCU_RSP_OFN_GET_CONFIG: c_uint = 0xd3;
pub const IMS_PCU_RSP_EVNT_BUTTONS: c_uint = 0xe0	/* Unsolicited, button state */;
pub const IMS_PCU_GAMEPAD_MASK: c_uint = 0x0001ff80UL	/* Bits 7 through 16 */;
pub const IMS_PCU_MIN_PACKET_LEN: c_int = 3;
pub const IMS_PCU_DATA_OFFSET: c_int = 2;

#[no_mangle]
unsafe extern "C" fn ims_pcu_report_events(pcu: *mut ims_pcu) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_handle_response(pcu: *mut ims_pcu) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_reset_packet(pcu: *mut ims_pcu) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_process_data(pcu: *mut ims_pcu, urb: *mut urb) {
    static void ims_pcu_process_data(struct ims_pcu *pcu, struct urb *urb)
    {
    int i;
    for (i = 0; i < urb.actual_length; i++) {
    let mut data: u8 = pcu.urb_in_buf[i];
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_byte_needs_escape(byte: u8) -> bool {
    ...
    pcu.urb_out_buf, len,
    core::ptr::null_mut(), IMS_PCU_CMD_WRITE_TIMEOUT);
    if (error < 0) {
    dev_dbg(pcu.dev,
...
// We know the command need not be escaped
    ...
    ims_pcu_execute_command(pcu, code, core::ptr::null_mut(), 0)
// Bootloader commands
pub const IMS_PCU_BL_CMD_QUERY_DEVICE: c_uint = 0xa1;
pub const IMS_PCU_BL_CMD_UNLOCK_CONFIG: c_uint = 0xa2;
pub const IMS_PCU_BL_CMD_ERASE_APP: c_uint = 0xa3;
pub const IMS_PCU_BL_CMD_PROGRAM_DEVICE: c_uint = 0xa4;
pub const IMS_PCU_BL_CMD_PROGRAM_COMPLETE: c_uint = 0xa5;
pub const IMS_PCU_BL_CMD_READ_APP: c_uint = 0xa6;
pub const IMS_PCU_BL_CMD_RESET_DEVICE: c_uint = 0xa7;
pub const IMS_PCU_BL_CMD_LAUNCH_APP: c_uint = 0xa8;
// Bootloader commands
pub const IMS_PCU_BL_RSP_QUERY_DEVICE: c_uint = 0xc1;
pub const IMS_PCU_BL_RSP_UNLOCK_CONFIG: c_uint = 0xc2;
pub const IMS_PCU_BL_RSP_ERASE_APP: c_uint = 0xc3;
pub const IMS_PCU_BL_RSP_PROGRAM_DEVICE: c_uint = 0xc4;
pub const IMS_PCU_BL_RSP_PROGRAM_COMPLETE: c_uint = 0xc5;
pub const IMS_PCU_BL_RSP_READ_APP: c_uint = 0xc6;

pub const IMS_PCU_BL_DATA_OFFSET: c_int = 3;
...
pub const IMS_PCU_INFO_PART_OFFSET: c_int = 2;
pub const IMS_PCU_INFO_DOM_OFFSET: c_int = 17;
pub const IMS_PCU_INFO_SERIAL_OFFSET: c_int = 25;
pub const IMS_PCU_SET_INFO_SIZE: c_int = 31;
#[no_mangle]
unsafe extern "C" fn ims_pcu_get_info(pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_set_info(pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_switch_to_bootloader(pcu: *mut ims_pcu) -> c_int {
    static int ims_pcu_switch_to_bootloader(struct ims_pcu *pcu)
    {
    int error;
// Execute jump to the bootloader
    error = ims_pcu_execute_command(pcu, JUMP_TO_BTLDR, core::ptr::null_mut(), 0);
    if (error) {
    dev_err(pcu.dev,
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_count_fw_records(fw: *const firmware) -> c_uint {
    ...
    fragment.len = len;
    error = ims_pcu_execute_bl_command(pcu, READ_APP, core::ptr::null_mut(), 5,
    IMS_PCU_CMD_RESPONSE_TIMEOUT);
    if (error) {
    dev_err(pcu.dev,
    ...
    u8 len;
    int error;
    error = ims_pcu_execute_bl_command(pcu, ERASE_APP, core::ptr::null_mut(), 0, 2000);
    if (error) {
    dev_err(pcu.dev,
...
//
    ...
    if (retval)
    goto out;
    retval = ims_pcu_execute_bl_command(pcu, LAUNCH_APP, core::ptr::null_mut(), 0, 0);
    if (retval)
    dev_err(pcu.dev,
    ...
    sysfs_notify(&pcu.dev.kobj, core::ptr::null_mut(), "update_firmware_status");
    return retval;
    }
...
//
pub const IMS_PCU_MAX_BRIGHTNESS: c_int = 31998;
    ...
    let mut br_val: __le16 = cpu_to_le16(value);
    int error;
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_setup_backlight(pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_destroy_backlight(pcu: *mut ims_pcu) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ims_pcu_attribute {
    pub dattr: device_attribute,
    pub field_offset: usize,
    pub field_length: c_int,
}
...
//
    ...
    .field_length = sizeof(((struct ims_pcu *)core::ptr::null_mut())._field),	\
    }
    ...
    const char *buf, size_t count)
    {
    let mut reset_byte: static u8 = 1;
    struct usb_interface *intf = to_usb_interface(dev);
    struct ims_pcu *pcu = usb_get_intfdata(intf);
    int value;
    int error;
    ...
    static DEVICE_ATTR(reset_device, S_IWUSR, core::ptr::null_mut(), ims_pcu_reset_device);
...
//
    ...
    core::ptr::null_mut(), ims_pcu_update_firmware_store);
    static ssize_t
    ...
    ims_pcu_update_firmware_status_show, core::ptr::null_mut());
...
pub const OFN_REG_RESULT_OFFSET: c_int = 2;
#[no_mangle]
unsafe extern "C" fn ims_pcu_read_ofn_config(pcu: *mut ims_pcu, addr: u8, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_write_ofn_config(pcu: *mut ims_pcu, addr: u8, data: u8) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ims_pcu_ofn_bit_attribute {
    pub dattr: device_attribute,
    pub addr: u8,
    pub nr: u8,
}
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_irq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_buffers_alloc(pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_buffers_free(pcu: *mut ims_pcu) {
    ...
    let mut buflen: usize = intf.altsetting.extralen;
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_parse_cdc_data(intf: *mut usb_interface, pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_start_io(pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_stop_io(pcu: *mut ims_pcu) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_line_setup(pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_get_device_info(pcu: *mut ims_pcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_identify_type(pcu: *mut ims_pcu, device_id: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_init_application_mode(pcu: *mut ims_pcu) -> c_int {
    static int ims_pcu_init_application_mode(struct ims_pcu *pcu)
    {
    let mut device_no: static atomic_t = ATOMIC_INIT(-1);
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_destroy_application_mode(pcu: *mut ims_pcu) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_init_bootloader_mode(pcu: *mut ims_pcu) -> c_int {
    static int ims_pcu_init_bootloader_mode(struct ims_pcu *pcu)
    {
    int error;
    error = ims_pcu_execute_bl_command(pcu, QUERY_DEVICE, core::ptr::null_mut(), 0,
    IMS_PCU_CMD_RESPONSE_TIMEOUT);
    if (error) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_destroy_bootloader_mode(pcu: *mut ims_pcu) {
...
pub const IMS_PCU_APPLICATION_MODE: c_int = 0;
pub const IMS_PCU_BOOTLOADER_MODE: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn ims_pcu_resume(intf: *mut usb_interface) -> c_int {
