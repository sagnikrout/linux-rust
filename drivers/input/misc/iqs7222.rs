...
//! Source: drivers/input/misc/iqs7222.c
#![no_std]
...
pub const IQS7222_PROD_NUM: c_uint = 0x00;
pub const IQS7222_PROD_NUM_A: c_int = 840;
pub const IQS7222_PROD_NUM_B: c_int = 698;
pub const IQS7222_PROD_NUM_C: c_int = 863;
pub const IQS7222_PROD_NUM_D: c_int = 1046;
pub const IQS7222_SYS_STATUS: c_uint = 0x10;

pub const IQS7222_SLDR_SETUP_2_RES_SHIFT: c_int = 8;

pub const IQS7222_SYS_SETUP: c_uint = 0xD0;

pub const IQS7222_COMMS_ERROR: c_uint = 0xEEEE;
pub const IQS7222_COMMS_RETRY_MS: c_int = 50;
pub const IQS7222_COMMS_TIMEOUT_MS: c_int = 100;
pub const IQS7222_RESET_TIMEOUT_MS: c_int = 250;
pub const IQS7222_ATI_TIMEOUT_MS: c_int = 2000;
pub const IQS7222_MAX_COLS_STAT: c_int = 8;
pub const IQS7222_MAX_COLS_CYCLE: c_int = 3;
pub const IQS7222_MAX_COLS_GLBL: c_int = 3;
pub const IQS7222_MAX_COLS_BTN: c_int = 3;
pub const IQS7222_MAX_COLS_CHAN: c_int = 6;
pub const IQS7222_MAX_COLS_FILT: c_int = 2;
pub const IQS7222_MAX_COLS_SLDR: c_int = 11;
pub const IQS7222_MAX_COLS_TPAD: c_int = 24;
pub const IQS7222_MAX_COLS_GPIO: c_int = 3;
pub const IQS7222_MAX_COLS_SYS: c_int = 13;
pub const IQS7222_MAX_CHAN: c_int = 20;
pub const IQS7222_MAX_SLDR: c_int = 2;
pub const IQS7222_NUM_RETRIES: c_int = 5;
pub const IQS7222_REG_OFFSET: c_uint = 0x100;
...
pub struct iqs7222_event_desc {
    ...
    pub strict: u16,
    pub enable: u16,
    pub reg_key: enum iqs7222_reg_key_id,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7222_reg_grp_desc {
    pub base: u16,
    pub val_len: u16,
    pub num_row: c_int,
    pub num_col: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7222_dev_desc {
    pub prod_num: u16,
    pub fw_major: u16,
    pub fw_minor: u16,
    pub sldr_res: u16,
    pub touch_link: u16,
    pub wheel_enable: u16,
    pub allow_offset: c_int,
    pub event_offset: c_int,
    pub comms_offset: c_int,
    pub ext_chan: c_int,
    pub legacy_gesture: bool,
    pub reg_grps: [iqs7222_reg_grp_desc; IQS7222_NUM_REG_GRPS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7222_prop_desc {
    pub name: *const c_char,
    pub reg_grp: enum iqs7222_reg_grp_id,
    pub reg_key: enum iqs7222_reg_key_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7222_private {
    pub dev_desc: *const iqs7222_dev_desc,
    pub reset_gpio: *mut gpio_desc,
    pub irq_gpio: *mut gpio_desc,
    pub client: *mut i2c_client,
    pub keypad: *mut input_dev,
    pub prop: touchscreen_properties,
    pub kp_type: [c_uint; IQS7222_MAX_CHAN][ARRAY_SIZE(iqs7222_kp_events)],
    pub kp_code: [c_uint; IQS7222_MAX_CHAN][ARRAY_SIZE(iqs7222_kp_events)],
    pub sl_code: [c_uint; IQS7222_MAX_SLDR][ARRAY_SIZE(iqs7222_sl_events)],
    pub sl_axis: [c_uint; IQS7222_MAX_SLDR],
    pub tp_code: [c_uint; ARRAY_SIZE(iqs7222_tp_events)],
    pub 2][IQS7222_MAX_COLS_CYCLE]: u16 cycle_setup[IQS7222_MAX_CHAN /,
    pub glbl_setup: [u16; IQS7222_MAX_COLS_GLBL],
    pub btn_setup: [u16; IQS7222_MAX_CHAN][IQS7222_MAX_COLS_BTN],
    pub chan_setup: [u16; IQS7222_MAX_CHAN][IQS7222_MAX_COLS_CHAN],
    pub filt_setup: [u16; IQS7222_MAX_COLS_FILT],
    pub sldr_setup: [u16; IQS7222_MAX_SLDR][IQS7222_MAX_COLS_SLDR],
    pub tpad_setup: [u16; IQS7222_MAX_COLS_TPAD],
    pub gpio_setup: [u16; ARRAY_SIZE(iqs7222_gpio_links)][IQS7222_MAX_COLS_GPIO],
    pub sys_setup: [u16; IQS7222_MAX_COLS_SYS],
}
...
#[no_mangle]
unsafe extern "C" fn iqs7222_irq_poll(iqs7222: *mut iqs7222_private, timeout_ms: u16) -> c_int {
    static int iqs7222_irq_poll(struct iqs7222_private *iqs7222, u16 timeout_ms)
    {
    let mut irq_timeout: ktime_t = ktime_add_ms(ktime_get(), timeout_ms);
    int ret;
    do {
...
#[no_mangle]
unsafe extern "C" fn iqs7222_hard_reset(iqs7222: *mut iqs7222_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7222_force_comms(iqs7222: *mut iqs7222_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7222_read_word(iqs7222: *mut iqs7222_private, reg: u16, val: *mut u16) -> c_int {
...
// val = le16_to_cpu(val_buf);
    ...
    {
    let mut reg_len: c_int = reg > U8_MAX ? sizeof(reg) : sizeof(u8);
    let mut msg_len: c_int = reg_len + val_len;
    int ret, i;
    struct i2c_client *client = iqs7222.client;
    u8 *msg_buf;
...
#[no_mangle]
unsafe extern "C" fn iqs7222_write_word(iqs7222: *mut iqs7222_private, reg: u16, val: u16) -> c_int {
    static int iqs7222_write_word(struct iqs7222_private *iqs7222, u16 reg, u16 val)
    {
    let mut val_buf: __le16 = cpu_to_le16(val);
    return iqs7222_write_burst(iqs7222, reg, &val_buf, sizeof(val_buf));
    }
#[no_mangle]
unsafe extern "C" fn iqs7222_ati_trigger(iqs7222: *mut iqs7222_private) -> c_int {
    static int iqs7222_ati_trigger(struct iqs7222_private *iqs7222)
    {
    struct i2c_client *client = iqs7222.client;
    ktime_t ati_timeout;
    let mut sys_status: u16 = 0;
    u16 sys_setup;
    int error, i;
//
...
#[no_mangle]
unsafe extern "C" fn iqs7222_dev_init(iqs7222: *mut iqs7222_private, dir: c_int) -> c_int {
    static int iqs7222_dev_init(struct iqs7222_private *iqs7222, int dir)
    {
    const struct iqs7222_dev_desc *dev_desc = iqs7222.dev_desc;
    let mut comms_offset: c_int = dev_desc.comms_offset;
    int error, i, j, k;
//
...
//
    ...
    let mut num_row: c_int = dev_desc.reg_grps[i].num_row;
    let mut num_col: c_int = dev_desc.reg_grps[i].num_col;
    let mut reg: u16 = dev_desc.reg_grps[i].base;
    __le16 *val_buf;
    let mut val_len: u16 = dev_desc.reg_grps[i].val_len ? : num_col * sizeof(*val_buf);
    u16 *val;
    if (!num_col)
    continue;
...
#[no_mangle]
unsafe extern "C" fn iqs7222_dev_info(iqs7222: *mut iqs7222_private) -> c_int {
    static int iqs7222_dev_info(struct iqs7222_private *iqs7222)
    {
    struct i2c_client *client = iqs7222.client;
    let mut prod_num_valid: bool = false;
    __le16 dev_id[3];
    int error, i;
    ...
    const struct iqs7222_dev_desc *dev_desc = iqs7222.dev_desc;
    struct i2c_client *client = iqs7222.client;
    let mut num_gpio: c_int = dev_desc.reg_grps[IQS7222_REG_GRP_GPIO].num_row;
    int error, count, i;
    ...
    let mut reg_offset: c_int = iqs7222_props[i].reg_offset;
    let mut reg_shift: c_int = iqs7222_props[i].reg_shift;
    let mut reg_width: c_int = iqs7222_props[i].reg_width;
    let mut val_pitch: c_int = iqs7222_props[i].val_pitch ? : 1;
    let mut val_min: c_int = iqs7222_props[i].val_min;
    let mut val_max: c_int = iqs7222_props[i].val_max;
    let mut invert: bool = iqs7222_props[i].invert;
...
//
    ...
    const struct iqs7222_dev_desc *dev_desc = iqs7222.dev_desc;
    struct i2c_client *client = iqs7222.client;
    let mut num_chan: c_int = dev_desc.reg_grps[IQS7222_REG_GRP_CHAN].num_row;
    let mut ext_chan: c_int = dev_desc.ext_chan ? : num_chan;
    int error, i;
...
//
    ...
    for (i = 0; i < count; i++) {
    let mut min_crx: c_int = chan_index < ext_chan / 2 ? 0 : 4;
    ...
    let mut event_enable: u16 = iqs7222_kp_events[i].enable;
...
//
    ...
    if (!error) {
    let mut sldr_max: u16 = sldr_setup[3] - 1;
    if (!reg_offset) {
...
#[no_mangle]
pub unsafe extern "C" fn if(dev_desc->touch_link: sldr_setup[4 + reg_offset] ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(dev_desc->touch_link: tpad_setup[7] ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn int(_arg: *mut iqs7222_parse_extra[IQS7222_NUM_REG_GRPS]) -> static {
    ...
    struct i2c_client *client = iqs7222.client;
    int error;
    struct fwnode_handle *reg_grp_node __free(fwnode_handle) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn iqs7222_parse_all(iqs7222: *mut iqs7222_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7222_report(iqs7222: *mut iqs7222_private) -> c_int {
    static int iqs7222_report(struct iqs7222_private *iqs7222)
    {
    const struct iqs7222_dev_desc *dev_desc = iqs7222.dev_desc;
    struct i2c_client *client = iqs7222.client;
    let mut num_chan: c_int = dev_desc.reg_grps[IQS7222_REG_GRP_CHAN].num_row;
    let mut num_stat: c_int = dev_desc.reg_grps[IQS7222_REG_GRP_STAT].num_col;
    int error, i, j;
...
//
    let mut k: c_int = 2 + j * (num_chan > 16 ? 2 : 1);
    let mut state: u16 = le16_to_cpu(status[k + i / 16]);
    ...
    u16 *sldr_setup = iqs7222.sldr_setup[i];
    let mut sldr_pos: u16 = le16_to_cpu(status[4 + i]);
    let mut state: u16 = le16_to_cpu(status[6 + i]);
...
//
    ...
    let mut mask: u16 = iqs7222_sl_events[j].mask;
    let mut val: u16 = iqs7222_sl_events[j].val;
    ...
    let mut tpad_pos_x: u16 = le16_to_cpu(status[4]);
    let mut tpad_pos_y: u16 = le16_to_cpu(status[5]);
    let mut state: u16 = le16_to_cpu(status[6]);
...
//
    ...
    let mut mask: u16 = iqs7222_tp_events[j].mask;
    let mut val: u16 = iqs7222_tp_events[j].val;
    input_report_key(iqs7222.keypad,
    iqs7222.tp_code[j],
    (state & mask) == val);
    }
...
#[no_mangle]
unsafe extern "C" fn iqs7222_irq(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn iqs7222_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    error = devm_request_threaded_irq(&client.dev, irq, core::ptr::null_mut(), iqs7222_irq,
