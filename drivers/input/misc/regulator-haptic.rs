...
//! Source: drivers/input/misc/regulator-haptic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn regulator_haptic_toggle(haptic: *mut regulator_haptic, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_haptic_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn regulator_haptic_close(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn regulator_haptic_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_haptic_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_haptic_resume(dev: *mut device) -> c_int {
