...
//! Source: drivers/input/misc/bma150.c
#![no_std]
...
pub const ABSMAX_ACC_VAL: c_uint = 0x01FF;

// Each axis is represented by a 2-byte data word
pub const BMA150_XYZ_DATA_SIZE: c_int = 6;
// Input poll interval in milliseconds
pub const BMA150_POLL_INTERVAL: c_int = 10;
pub const BMA150_POLL_MAX: c_int = 200;
pub const BMA150_POLL_MIN: c_int = 0;
pub const BMA150_MODE_NORMAL: c_int = 0;
pub const BMA150_MODE_SLEEP: c_int = 2;
pub const BMA150_MODE_WAKE_UP: c_int = 3;
// Data register addresses
pub const BMA150_DATA_0_REG: c_uint = 0x00;
pub const BMA150_DATA_1_REG: c_uint = 0x01;
pub const BMA150_DATA_2_REG: c_uint = 0x02;
// Control register addresses
pub const BMA150_CTRL_0_REG: c_uint = 0x0A;
pub const BMA150_CTRL_1_REG: c_uint = 0x0B;
pub const BMA150_CTRL_2_REG: c_uint = 0x14;
pub const BMA150_CTRL_3_REG: c_uint = 0x15;
// Configuration/Setting register addresses
pub const BMA150_CFG_0_REG: c_uint = 0x0C;
pub const BMA150_CFG_1_REG: c_uint = 0x0D;
pub const BMA150_CFG_2_REG: c_uint = 0x0E;
pub const BMA150_CFG_3_REG: c_uint = 0x0F;
pub const BMA150_CFG_4_REG: c_uint = 0x10;
pub const BMA150_CFG_5_REG: c_uint = 0x11;
pub const BMA150_CHIP_ID: c_int = 2;

pub const BMA150_SLEEP_POS: c_int = 0;
pub const BMA150_SLEEP_MSK: c_uint = 0x01;

pub const BMA150_BANDWIDTH_POS: c_int = 0;
pub const BMA150_BANDWIDTH_MSK: c_uint = 0x07;

pub const BMA150_RANGE_POS: c_int = 3;
pub const BMA150_RANGE_MSK: c_uint = 0x18;

pub const BMA150_WAKE_UP_POS: c_int = 0;
pub const BMA150_WAKE_UP_MSK: c_uint = 0x01;

pub const BMA150_SW_RES_POS: c_int = 1;
pub const BMA150_SW_RES_MSK: c_uint = 0x02;

// Any-motion interrupt register fields
pub const BMA150_ANY_MOTION_EN_POS: c_int = 6;
pub const BMA150_ANY_MOTION_EN_MSK: c_uint = 0x40;

pub const BMA150_ANY_MOTION_DUR_POS: c_int = 6;
pub const BMA150_ANY_MOTION_DUR_MSK: c_uint = 0xC0;

// Advanced interrupt register fields
pub const BMA150_ADV_INT_EN_POS: c_int = 6;
pub const BMA150_ADV_INT_EN_MSK: c_uint = 0x40;

// High-G interrupt register fields
pub const BMA150_HIGH_G_EN_POS: c_int = 1;
pub const BMA150_HIGH_G_EN_MSK: c_uint = 0x02;

pub const BMA150_HIGH_G_HYST_POS: c_int = 3;
pub const BMA150_HIGH_G_HYST_MSK: c_uint = 0x38;

// Low-G interrupt register fields
pub const BMA150_LOW_G_EN_POS: c_int = 0;
pub const BMA150_LOW_G_EN_MSK: c_uint = 0x01;

pub const BMA150_LOW_G_HYST_POS: c_int = 0;
pub const BMA150_LOW_G_HYST_MSK: c_uint = 0x07;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bma150_data {
...
#[no_mangle]
unsafe extern "C" fn bma150_write_byte(client: *mut i2c_client, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma150_set_mode(bma150: *mut bma150_data, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma150_soft_reset(bma150: *mut bma150_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma150_set_range(bma150: *mut bma150_data, range: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma150_set_bandwidth(bma150: *mut bma150_data, bw: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma150_report_xyz(bma150: *mut bma150_data) {
...
#[no_mangle]
unsafe extern "C" fn bma150_irq_thread(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bma150_poll(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn bma150_open(input: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bma150_close(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn bma150_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), bma150_irq_thread,
...
#[no_mangle]
unsafe extern "C" fn bma150_remove(client: *mut i2c_client) {
    static void bma150_remove(struct i2c_client *client)
    {
    pm_runtime_disable(&client.dev);
    }
#[no_mangle]
unsafe extern "C" fn bma150_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn bma150_resume(dev: *mut device) -> int __maybe_unused {
    ...
    static UNIVERSAL_DEV_PM_OPS(bma150_pm, bma150_suspend, bma150_resume, core::ptr::null_mut());
