...
//! Source: drivers/input/misc/aw86927.c
#![no_std]
...
pub const AW86927_RSTCFG_REG: c_uint = 0x00;
pub const AW86927_RSTCFG_SOFTRST: c_uint = 0xaa;
pub const AW86927_SYSINT_REG: c_uint = 0x02;

pub const AW86927_SYSINTM_REG: c_uint = 0x03;

pub const AW86927_PLAYCFG1_REG: c_uint = 0x06;

pub const AW86927_PLAYCFG1_BST_MODE_BYPASS: c_int = 0;

pub const AW86927_PLAYCFG1_BST_8500MV: c_uint = 0x50;
pub const AW86938_PLAYCFG1_REG: c_uint = 0x06;

pub const AW86938_PLAYCFG1_BST_MODE_BYPASS: c_int = 0;

pub const AW86938_PLAYCFG1_BST_7000MV: c_uint = 0x11;
pub const AW86927_PLAYCFG2_REG: c_uint = 0x07;
pub const AW86927_PLAYCFG3_REG: c_uint = 0x08;

pub const AW86927_PLAYCFG3_AUTO_BST_ENABLE: c_int = 1;
pub const AW86927_PLAYCFG3_AUTO_BST_DISABLE: c_int = 0;

pub const AW86927_PLAYCFG3_PLAY_MODE_RAM: c_int = 0;
pub const AW86927_PLAYCFG4_REG: c_uint = 0x09;

pub const AW86927_WAVCFG1_REG: c_uint = 0x0a;

pub const AW86927_WAVCFG2_REG: c_uint = 0x0b;

pub const AW86927_WAVCFG9_REG: c_uint = 0x12;

pub const AW86927_WAVCFG9_SEQ1LOOP_INFINITELY: c_uint = 0x0f;
pub const AW86927_CONTCFG1_REG: c_uint = 0x18;

pub const AW86927_CONTCFG5_REG: c_uint = 0x1c;

pub const AW86927_CONTCFG10_REG: c_uint = 0x21;

pub const AW86927_CONTCFG10_BRK_TIME_DEFAULT: c_int = 8;
pub const AW86927_CONTCFG13_REG: c_uint = 0x24;

pub const AW86927_BASEADDRH_REG: c_uint = 0x2d;
pub const AW86927_BASEADDRL_REG: c_uint = 0x2e;
pub const AW86927_GLBRD5_REG: c_uint = 0x3f;

pub const AW86927_GLBRD5_STATE_STANDBY: c_int = 0;
pub const AW86927_RAMADDRH_REG: c_uint = 0x40;
pub const AW86927_RAMADDRL_REG: c_uint = 0x41;
pub const AW86927_RAMDATA_REG: c_uint = 0x42;
pub const AW86927_SYSCTRL3_REG: c_uint = 0x45;

pub const AW86927_SYSCTRL3_STANDBY_ON: c_int = 1;
pub const AW86927_SYSCTRL3_STANDBY_OFF: c_int = 0;

pub const AW86927_SYSCTRL3_EN_RAMINIT_ON: c_int = 1;
pub const AW86927_SYSCTRL3_EN_RAMINIT_OFF: c_int = 0;
pub const AW86927_SYSCTRL4_REG: c_uint = 0x46;

pub const AW86927_SYSCTRL4_WAVDAT_24K: c_int = 0;

pub const AW86927_SYSCTRL4_INT_EDGE_MODE_POS: c_int = 0;

pub const AW86927_SYSCTRL4_INT_MODE_EDGE: c_int = 1;

pub const AW86927_PWMCFG1_REG: c_uint = 0x48;

pub const AW86927_PWMCFG1_PRC_DISABLE: c_int = 0;
pub const AW86927_PWMCFG3_REG: c_uint = 0x4a;

pub const AW86927_PWMCFG4_REG: c_uint = 0x4b;

pub const AW86927_VBATCTRL_REG: c_uint = 0x4c;

pub const AW86927_VBATCTRL_VBAT_MODE_SW: c_int = 0;
pub const AW86927_DETCFG1_REG: c_uint = 0x4d;

pub const AW86927_DETCFG1_DET_GO_DET_SEQ0: c_int = 1;
pub const AW86927_DETCFG1_DET_GO_NA: c_int = 0;
pub const AW86927_DETCFG2_REG: c_uint = 0x4e;

pub const AW86927_DETCFG2_DET_SEQ0_VBAT: c_int = 0;

pub const AW86927_DETCFG2_D2S_GAIN_10: c_int = 4;
pub const AW86927_CHIPIDH_REG: c_uint = 0x57;
pub const AW86927_CHIPIDL_REG: c_uint = 0x58;
pub const AW86927_CHIPID: c_uint = 0x9270;
pub const AW86938_CHIPID: c_uint = 0x9380;
pub const AW86927_TMCFG_REG: c_uint = 0x5b;
pub const AW86927_TMCFG_UNLOCK: c_uint = 0x7d;
pub const AW86927_TMCFG_LOCK: c_uint = 0x00;
pub const AW86927_ANACFG11_REG: c_uint = 0x70;
pub const AW86927_ANACFG12_REG: c_uint = 0x71;

pub const AW86927_ANACFG12_BST_SKIP_SHUTDOWN: c_int = 1;
pub const AW86927_ANACFG13_REG: c_uint = 0x72;

pub const AW86927_ANACFG13_BST_PEAKCUR_3P45A: c_int = 6;
pub const AW86927_ANACFG15_REG: c_uint = 0x74;

pub const AW86927_ANACFG15_BST_PEAK_BACK: c_int = 1;
pub const AW86927_ANACFG16_REG: c_uint = 0x75;

pub const AW86927_ANACFG16_BST_SRC_3NS: c_int = 0;
// default value of base addr
pub const AW86927_RAM_BASE_ADDR: c_uint = 0x800;
pub const AW86927_BASEADDRH_VAL: c_uint = 0x08;
pub const AW86927_BASEADDRL_VAL: c_uint = 0x00;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aw86927_data {
    pub model: enum aw86927_model,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aw86927_sram_waveform_header {
    pub version: u8,
    pub start_address: __be16,
    pub end_address: __be16,
    pub __packed: },
...
#[no_mangle]
unsafe extern "C" fn aw86927_wait_enter_standby(haptics: *mut aw86927_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw86927_play_mode(haptics: *mut aw86927_data, play_mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw86927_stop(haptics: *mut aw86927_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw86927_haptics_play(dev: *mut input_dev, data: *mut c_void, effect: *mut ff_effect) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw86927_play_sine(haptics: *mut aw86927_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw86927_close(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn aw86927_haptics_play_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn aw86927_hw_reset(haptics: *mut aw86927_data) {
...
#[no_mangle]
unsafe extern "C" fn aw86927_haptic_init(haptics: *mut aw86927_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw86927_ram_init(haptics: *mut aw86927_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw86927_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn aw86927_detect(haptics: *mut aw86927_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw86927_probe(client: *mut i2c_client) -> c_int {
...
// IRQ config
    ...
    err = devm_request_threaded_irq(haptics.dev, client.irq, core::ptr::null_mut(),
    aw86927_irq, IRQF_ONESHOT, core::ptr::null_mut(), haptics);
    if (err)
    ...
    err = input_ff_create_memless(haptics.input_dev, core::ptr::null_mut(), aw86927_haptics_play);
    if (err)
