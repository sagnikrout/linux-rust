...
//! Source: drivers/input/misc/ati_remote2.c
#![no_std]
...
// (unsigned int *)kp->arg = mask;
    ...
    let mut channel_mask: static unsigned int = ATI_REMOTE2_MAX_CHANNEL_MASK;
    ...
    let mut mode_mask: static unsigned int = ATI_REMOTE2_MAX_MODE_MASK;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ati_remote2 {
    pub idev: *mut input_dev,
    pub udev: *mut usb_device,
    pub intf: [*mut usb_interface; 2],
    pub ep: [*mut usb_endpoint_descriptor; 2],
    pub urb: [*mut urb; 2],
    pub buf: [*mut c_void; 2],
    pub buf_dma: [dma_addr_t; 2],
    pub jiffies: c_ulong,
    pub mode: c_int,
    pub name: [c_char; 64],
    pub phys: [c_char; 64],
// Each mode (AUX1-AUX4 and PC) can have an independent keymap.
    pub keycode: [u16; ATI_REMOTE2_MODES][ARRAY_SIZE(ati_remote2_key_table)],
    pub flags: c_uint,
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_submit_urbs(ar2: *mut ati_remote2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_kill_urbs(ar2: *mut ati_remote2) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_open(idev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_close(idev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_input_mouse(ar2: *mut ati_remote2) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_lookup(hw_code: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_input_key(ar2: *mut ati_remote2) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_complete_mouse(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_complete_key(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_input_init(ar2: *mut ati_remote2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_urb_init(ar2: *mut ati_remote2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_urb_cleanup(ar2: *mut ati_remote2) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_setup(ar2: *mut ati_remote2, ch_mask: c_uint) -> c_int {
...
//
    ...
    channel, 0x0, core::ptr::null_mut(), 0, USB_CTRL_SET_TIMEOUT);
    if (r) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_probe(interface: *mut usb_interface, id: *const usb_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_disconnect(interface: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_resume(interface: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_reset_resume(interface: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_pre_reset(interface: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_remote2_post_reset(interface: *mut usb_interface) -> c_int {
