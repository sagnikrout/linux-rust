...
//! Source: drivers/input/misc/cm109.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cm109_ctl_packet {
    pub byte: [u8; 4],
// C attribute field omitted
    pub }: enum { USB_PKT_LEN = sizeof(struct cm109_ctl_packet),
// CM109 device structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cm109_dev {
    pub /: *mut *mut *mut input_dev idev; / input device,
    pub /: *mut *mut *mut usb_device udev; / usb device,
    pub intf: *mut usb_interface,
// irq input channel
    pub irq_data: *mut cm109_ctl_packet,
    pub irq_dma: dma_addr_t,
    pub urb_irq: *mut urb,
// control output channel
    pub ctl_data: *mut cm109_ctl_packet,
    pub ctl_dma: dma_addr_t,
    pub ctl_req: *mut usb_ctrlrequest,
    pub urb_ctl: *mut urb,
//
...
// context.
//
    pub /: *mut *mut unsigned irq_urb_pending:1; / irq_urb is in flight,
    pub /: *mut *mut unsigned ctl_urb_pending:1; / ctl_urb is in flight,
    pub /: *mut *mut unsigned buzzer_pending:1; / need to issue buzz command,
    pub ctl_submit_lock: spinlock_t,
    pub /: *mut *mut unsigned char buzzer_state; / on/off,
// flags
    pub open:1: unsigned,
    pub resetting:1: unsigned,
    pub shutdown:1: unsigned,
// This mutex protects writes to the above flags
    pub pm_mutex: mutex,
    pub keymap: [c_ushort; KEYMAP_SIZE],
    pub /: *mut *mut char phys[64]; / physical device path,
    pub /: *mut *mut int key_code; / last reported key,
    pub /: *mut *mut int keybit; / 0=new scan 1,2,4,8=scan columns,
    pub /: *mut *mut u8 gpi; / Cached value of GPI (high nibble),
}
...
//
#[no_mangle]
unsafe extern "C" fn special_keymap(code: c_int) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn keymap_kip1000(scancode: c_int) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn keymap_gtalk(scancode: c_int) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn keymap_usbph01(scancode: c_int) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn keymap_atcom(scancode: c_int) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn report_key(dev: *mut cm109_dev, key: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cm109_report_special(dev: *mut cm109_dev) {
    static void cm109_report_special(struct cm109_dev *dev)
    {
    let mut autorelease: static u8 = RECORD_MUTE | PLAYBACK_MUTE;
    struct input_dev *idev = dev.idev;
    let mut data: u8 = dev.irq_data.byte[HID_IR0];
...
//
#[no_mangle]
unsafe extern "C" fn cm109_submit_buzz_toggle(dev: *mut cm109_dev) {
...
#[no_mangle]
unsafe extern "C" fn cm109_submit_ctl(dev: *mut cm109_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn cm109_urb_irq_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn cm109_urb_ctl_callback(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn cm109_toggle_buzzer_async(dev: *mut cm109_dev) {
...
#[no_mangle]
unsafe extern "C" fn cm109_toggle_buzzer_sync(dev: *mut cm109_dev, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cm109_stop_traffic(dev: *mut cm109_dev) {
...
#[no_mangle]
unsafe extern "C" fn cm109_restore_state(dev: *mut cm109_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn cm109_input_open(idev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm109_input_close(idev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn cm109_usb_cleanup(dev: *mut cm109_dev) {
...
#[no_mangle]
unsafe extern "C" fn cm109_usb_disconnect(interface: *mut usb_interface) {
    ...
    struct input_dev *input_dev = core::ptr::null_mut();
    int ret, pipe, i;
...
#[no_mangle]
unsafe extern "C" fn cm109_usb_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm109_usb_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm109_usb_pre_reset(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm109_usb_post_reset(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm109_select_keymap() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cm109_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cm109_exit() -> void __exit {
