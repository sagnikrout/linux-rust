...
//! Source: drivers/input/touchscreen/touchit213.c
#![no_std]
...
// right to left.
//
pub const T213_FORMAT_TOUCH_BIT: c_uint = 0x01;
pub const T213_FORMAT_STATUS_BYTE: c_uint = 0x80;
...
//
pub const T213_MIN_XC: c_int = 0;
pub const T213_MAX_XC: c_uint = 0x07ff;
pub const T213_MIN_YC: c_int = 0;
pub const T213_MAX_YC: c_uint = 0x07ff;
//
// Per-touchscreen data.
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct touchit213 {
...
//
#[no_mangle]
unsafe extern "C" fn touchit213_disconnect(serio: *mut serio) {
...
//
#[no_mangle]
unsafe extern "C" fn touchit213_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
