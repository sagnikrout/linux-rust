...
//! Source: drivers/input/touchscreen/edt-ft5x06.c
#![no_std]
...
pub const WORK_REGISTER_THRESHOLD: c_uint = 0x00;
pub const WORK_REGISTER_REPORT_RATE: c_uint = 0x08;
pub const WORK_REGISTER_GAIN: c_uint = 0x30;
pub const WORK_REGISTER_OFFSET: c_uint = 0x31;
pub const WORK_REGISTER_NUM_X: c_uint = 0x33;
pub const WORK_REGISTER_NUM_Y: c_uint = 0x34;
pub const PMOD_REGISTER_ACTIVE: c_uint = 0x00;
pub const PMOD_REGISTER_HIBERNATE: c_uint = 0x03;
pub const M09_REGISTER_THRESHOLD: c_uint = 0x80;
pub const M09_REGISTER_GAIN: c_uint = 0x92;
pub const M09_REGISTER_OFFSET: c_uint = 0x93;
pub const M09_REGISTER_NUM_X: c_uint = 0x94;
pub const M09_REGISTER_NUM_Y: c_uint = 0x95;
pub const M12_REGISTER_REPORT_RATE: c_uint = 0x88;
pub const EV_REGISTER_THRESHOLD: c_uint = 0x40;
pub const EV_REGISTER_GAIN: c_uint = 0x41;
pub const EV_REGISTER_OFFSET_Y: c_uint = 0x45;
pub const EV_REGISTER_OFFSET_X: c_uint = 0x46;
pub const NO_REGISTER: c_uint = 0xff;
pub const WORK_REGISTER_OPMODE: c_uint = 0x3c;
pub const FACTORY_REGISTER_OPMODE: c_uint = 0x01;
pub const PMOD_REGISTER_OPMODE: c_uint = 0xa5;
pub const TOUCH_EVENT_DOWN: c_uint = 0x00;
pub const TOUCH_EVENT_UP: c_uint = 0x01;
pub const TOUCH_EVENT_ON: c_uint = 0x02;
pub const TOUCH_EVENT_RESERVED: c_uint = 0x03;
pub const EDT_NAME_LEN: c_int = 23;
pub const EDT_SWITCH_MODE_RETRIES: c_int = 10;

pub const EDT_RAW_DATA_RETRIES: c_int = 100;

pub const EDT_DEFAULT_NUM_X: c_int = 1024;
pub const EDT_DEFAULT_NUM_Y: c_int = 1024;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct edt_reg_addr {
    pub reg_threshold: c_int,
    pub reg_report_rate: c_int,
    pub reg_gain: c_int,
    pub reg_offset: c_int,
    pub reg_offset_x: c_int,
    pub reg_offset_y: c_int,
    pub reg_num_x: c_int,
    pub reg_num_y: c_int,
}
...
pub struct edt_ft5x06_ts_data {
    ...
    pub raw_buffer: *mut u8,
    pub raw_bufsize: usize,

    pub mutex: mutex,
    pub factory_mode: bool,
    pub suspend_mode: enum edt_pmode,
    pub threshold: c_int,
    pub gain: c_int,
    pub offset: c_int,
    pub offset_x: c_int,
    pub offset_y: c_int,
    pub report_rate: c_int,
    pub max_support_points: c_int,
    pub point_len: c_int,
    pub tdata_cmd: u8,
    pub tdata_len: c_int,
    pub tdata_offset: c_int,
    pub name: [c_char; EDT_NAME_LEN],
    pub fw_version: [c_char; EDT_NAME_LEN],
    pub reg_addr: edt_reg_addr,
    pub version: enum edt_ver,
    pub crc_errors: c_uint,
    pub header_errors: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct edt_i2c_chip_data {
    pub max_support_points: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn edt_M06_i2c_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct edt_ft5x06_attribute {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_restore_reg_parameters(tsdata: *mut edt_ft5x06_ts_data) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_factory_mode(tsdata: *mut edt_ft5x06_ts_data) -> c_int {
    static int edt_ft5x06_factory_mode(struct edt_ft5x06_ts_data *tsdata)
    {
    struct i2c_client *client = tsdata.client;
    let mut retries: c_int = EDT_SWITCH_MODE_RETRIES;
    unsigned int val;
    int error;
...
// mode register is 0x01 when in factory mode
    ...
    tsdata.raw_buffer = core::ptr::null_mut();
    tsdata.factory_mode = false;
    enable_irq(client.irq);
    return error;
    }
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_work_mode(tsdata: *mut edt_ft5x06_ts_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_debugfs_mode_get(data: *mut c_void, mode: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_debugfs_mode_set(data: *mut c_void, mode: u64) -> c_int {
    ...
    struct i2c_client *client = tsdata.client;
    let mut retries: c_int = EDT_RAW_DATA_RETRIES;
    unsigned int val;
    int i, error;
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_prepare_debugfs(tsdata: *mut edt_ft5x06_ts_data) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_teardown_debugfs(tsdata: *mut edt_ft5x06_ts_data) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_get_parameters(tsdata: *mut edt_ft5x06_ts_data) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_set_tdata_parameters(tsdata: *mut edt_ft5x06_ts_data) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_set_regs(tsdata: *mut edt_ft5x06_ts_data) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_exit_regmap(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_disable_regulators(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tsdata->wake_gpio) -> else {
...
//
    ...
    core::ptr::null_mut(), edt_ft5x06_ts_isr, irq_flags,
    client.name, tsdata);
    if (error) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn edt_ft5x06_ts_resume(dev: *mut device) -> c_int {
