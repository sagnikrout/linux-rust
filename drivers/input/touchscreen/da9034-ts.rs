...
//! Source: drivers/input/touchscreen/da9034-ts.c
#![no_std]
...
pub const DA9034_MANUAL_CTRL: c_uint = 0x50;

pub const DA9034_AUTO_CTRL1: c_uint = 0x51;
pub const DA9034_AUTO_CTRL2: c_uint = 0x52;

pub const DA9034_TSI_CTRL1: c_uint = 0x53;
pub const DA9034_TSI_CTRL2: c_uint = 0x54;
pub const DA9034_TSI_X_MSB: c_uint = 0x6c;
pub const DA9034_TSI_Y_MSB: c_uint = 0x6d;
pub const DA9034_TSI_XY_LSB: c_uint = 0x6e;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9034_touch {
    pub da9034_dev: *mut device,
    pub input_dev: *mut input_dev,
    pub tsi_work: delayed_work,
    pub notifier: notifier_block,
    pub state: c_int,
    pub interval_ms: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn is_pen_down(touch: *mut da9034_touch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn detect_pen_down(touch: *mut da9034_touch, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_tsi(touch: *mut da9034_touch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn start_tsi(touch: *mut da9034_touch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stop_tsi(touch: *mut da9034_touch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn report_pen_down(touch: *mut da9034_touch) {
    static inline void report_pen_down(struct da9034_touch *touch)
    {
    let mut x: c_int = touch.last_x;
    let mut y: c_int = touch.last_y;
    x &= 0xfff;
    if (touch.x_inverted)
    x = 1024 - x;
    y &= 0xfff;
...
#[no_mangle]
pub unsafe extern "C" fn report_pen_up(touch: *mut da9034_touch) {
...
#[no_mangle]
unsafe extern "C" fn da9034_event_handler(touch: *mut da9034_touch, event: c_int) {
...
#[no_mangle]
unsafe extern "C" fn da9034_tsi_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn da9034_touch_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9034_touch_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn da9034_touch_probe(pdev: *mut platform_device) -> c_int {
