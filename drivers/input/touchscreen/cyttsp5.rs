...
//! Source: drivers/input/touchscreen/cyttsp5.c
#![no_std]
...
pub const HID_VERSION: c_uint = 0x0100;
pub const CY_MAX_INPUT: c_int = 512;
pub const CYTTSP5_PREALLOCATED_CMD_BUFFER: c_int = 32;
pub const CY_BITS_PER_BTN: c_int = 1;

pub const MAX_AREA: c_int = 255;
pub const HID_OUTPUT_BL_SOP: c_uint = 0x1;
pub const HID_OUTPUT_BL_EOP: c_uint = 0x17;
pub const HID_OUTPUT_BL_LAUNCH_APP: c_uint = 0x3B;
pub const HID_OUTPUT_BL_LAUNCH_APP_SIZE: c_int = 11;
pub const HID_OUTPUT_GET_SYSINFO: c_uint = 0x2;
pub const HID_OUTPUT_GET_SYSINFO_SIZE: c_int = 5;
pub const HID_OUTPUT_MAX_CMD_SIZE: c_int = 12;
pub const HID_DESC_REG: c_uint = 0x1;
pub const HID_INPUT_REG: c_uint = 0x3;
pub const HID_OUTPUT_REG: c_uint = 0x4;
pub const HID_COMMAND_REG: c_uint = 0x5;
pub const REPORT_ID_TOUCH: c_uint = 0x1;
pub const REPORT_ID_BTN: c_uint = 0x3;
pub const REPORT_SIZE_5: c_int = 5;
pub const REPORT_SIZE_8: c_int = 8;
pub const REPORT_SIZE_16: c_int = 16;
// Touch reports offsets
// Header offsets
pub const TOUCH_REPORT_DESC_HDR_CONTACTCOUNT: c_int = 16;
// Record offsets
pub const TOUCH_REPORT_DESC_CONTACTID: c_int = 8;
pub const TOUCH_REPORT_DESC_X: c_int = 16;
pub const TOUCH_REPORT_DESC_Y: c_int = 32;
pub const TOUCH_REPORT_DESC_P: c_int = 48;
pub const TOUCH_REPORT_DESC_MAJ: c_int = 56;
pub const TOUCH_REPORT_DESC_MIN: c_int = 64;
// HID
pub const HID_TOUCH_REPORT_ID: c_uint = 0x1;
pub const HID_BTN_REPORT_ID: c_uint = 0x3;
pub const HID_APP_RESPONSE_REPORT_ID: c_uint = 0x1F;
pub const HID_APP_OUTPUT_REPORT_ID: c_uint = 0x2F;
pub const HID_BL_RESPONSE_REPORT_ID: c_uint = 0x30;
pub const HID_BL_OUTPUT_REPORT_ID: c_uint = 0x40;
pub const HID_RESPONSE_REPORT_ID: c_uint = 0xF0;
pub const HID_OUTPUT_RESPONSE_REPORT_OFFSET: c_int = 2;
pub const HID_OUTPUT_RESPONSE_CMD_OFFSET: c_int = 4;

pub const HID_SYSINFO_SENSING_OFFSET: c_int = 33;
pub const HID_SYSINFO_BTN_OFFSET: c_int = 48;

pub const HID_SYSINFO_MAX_BTN: c_int = 8;
pub const HID_CMD_SET_POWER: c_uint = 0x8;
pub const HID_POWER_ON: c_uint = 0x0;
pub const HID_POWER_SLEEP: c_uint = 0x1;
pub const CY_HID_OUTPUT_TIMEOUT_MS: c_int = 200;
pub const CY_HID_OUTPUT_GET_SYSINFO_TIMEOUT_MS: c_int = 3000;
pub const CY_HID_GET_HID_DESCRIPTOR_TIMEOUT_MS: c_int = 4000;
pub const CY_HID_SET_POWER_TIMEOUT: c_int = 500;
// maximum number of concurrent tracks
pub const TOUCH_REPORT_SIZE: c_int = 10;
pub const TOUCH_INPUT_HEADER_SIZE: c_int = 7;
pub const BTN_REPORT_SIZE: c_int = 9;
pub const BTN_INPUT_HEADER_SIZE: c_int = 5;
pub const MAX_CY_TCH_T_IDS: c_int = 32;
// All usage pages for Touch Report
pub const TOUCH_REPORT_USAGE_PG_X: c_uint = 0x00010030;
pub const TOUCH_REPORT_USAGE_PG_Y: c_uint = 0x00010031;
pub const TOUCH_REPORT_USAGE_PG_P: c_uint = 0x000D0030;
pub const TOUCH_REPORT_USAGE_PG_CONTACTID: c_uint = 0x000D0051;
pub const TOUCH_REPORT_USAGE_PG_CONTACTCOUNT: c_uint = 0x000D0054;
pub const TOUCH_REPORT_USAGE_PG_MAJ: c_uint = 0xFF010062;
pub const TOUCH_REPORT_USAGE_PG_MIN: c_uint = 0xFF010063;
pub const TOUCH_COL_USAGE_PG: c_uint = 0x000D0022;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyttsp5_sensing_conf_data_dev {
    pub electrodes_x: u8,
    pub electrodes_y: u8,
    pub len_x: __le16,
    pub len_y: __le16,
    ...
    pub btn: u8,
    pub scan_mode: u8,
    pub max_num_of_tch_per_refresh_cycle: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyttsp5_sensing_conf_data {
    pub res_x: u16,
    pub res_y: u16,
    pub max_z: u16,
    pub len_x: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyttsp5_tch_abs_params {
    pub /: *mut *mut size_t ofs; / abs byte offset,
    pub /: *mut *mut size_t size; / size in bits,
    pub /: *mut *mut size_t min; / min value,
    pub /: *mut *mut size_t max; / max value,
    pub /: *mut *mut size_t bofs; / bit offset,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyttsp5_touch {
    pub abs: [c_int; CY_TCH_NUM_ABS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyttsp5_sysinfo {
    pub sensing_conf_data: cyttsp5_sensing_conf_data,
    pub num_btns: c_int,
    pub tch_hdr: cyttsp5_tch_abs_params,
    pub tch_abs: [cyttsp5_tch_abs_params; CY_TCH_NUM_ABS],
    pub key_code: [u32; HID_SYSINFO_MAX_BTN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyttsp5_hid_desc {
    pub hid_desc_len: __le16,
    pub packet_id: u8,
    pub reserved_byte: u8,
    pub bcd_version: __le16,
    pub report_desc_len: __le16,
    pub report_desc_register: __le16,
    pub input_register: __le16,
    pub max_input_len: __le16,
    pub output_register: __le16,
    pub max_output_len: __le16,
    pub command_register: __le16,
    pub data_register: __le16,
...
pub struct cyttsp5 {
    ...
    pub sysinfo: cyttsp5_sysinfo,
    pub hid_desc: cyttsp5_hid_desc,
    pub cmd_buf: [u8; CYTTSP5_PREALLOCATED_CMD_BUFFER],
    pub input_buf: [u8; CY_MAX_INPUT],
    pub response_buf: [u8; CY_MAX_INPUT],
    pub reset_gpio: *mut gpio_desc,
    pub input: *mut input_dev,
    pub phys: [c_char; NAME_MAX],
    pub num_prv_rec: c_int,
...
//
#[no_mangle]
unsafe extern "C" fn cyttsp5_read(ts: *mut cyttsp5, buf: *mut u8, max: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_mt_attention(dev: *mut device) -> c_int {
    static int cyttsp5_mt_attention(struct device *dev)
    {
    struct cyttsp5 *ts = dev_get_drvdata(dev);
    struct cyttsp5_sysinfo *si = &ts.sysinfo;
    let mut max_tch: c_int = si.sensing_conf_data.max_tch;
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_setup_input_device(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_parse_dt_key_code(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_btn_attention(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_validate_cmd_response(ts: *mut cyttsp5, code: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_si_get_btn_data(ts: *mut cyttsp5) {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_get_sysinfo_regs(ts: *mut cyttsp5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_hid_output_get_sysinfo(ts: *mut cyttsp5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_power_control(ts: *mut cyttsp5, on: bool) -> c_int {
    static int cyttsp5_power_control(struct cyttsp5 *ts, bool on)
    {
    let mut state: u8 = on ? HID_POWER_ON : HID_POWER_SLEEP;
    u8 cmd[2] = { 0 };
    int rc;
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_hid_output_bl_launch_app(ts: *mut cyttsp5) -> c_int {
    ...
    int rc;
    rc = cyttsp5_write(ts, HID_DESC_REG, core::ptr::null_mut(), 0);
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_handle_irq(irq: c_int, handle: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_deassert_int(ts: *mut cyttsp5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_fill_all_touch(ts: *mut cyttsp5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_startup(ts: *mut cyttsp5) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_cleanup(data: *mut c_void) {
...
// Need a delay to have device up
    msleep(20);
    error = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), cyttsp5_handle_irq,
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cyttsp5_resume(dev: *mut device) -> int __maybe_unused {
