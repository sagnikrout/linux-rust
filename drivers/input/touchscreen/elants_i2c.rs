...
//! Source: drivers/input/touchscreen/elants_i2c.c
#![no_std]
...
pub const FW_HDR_TYPE: c_int = 0;
pub const FW_HDR_COUNT: c_int = 1;
pub const FW_HDR_LENGTH: c_int = 2;
// Buffer mode Queue Header information
pub const QUEUE_HEADER_SINGLE: c_uint = 0x62;

pub const QUEUE_HEADER_WAIT: c_uint = 0x64;
pub const QUEUE_HEADER_NORMAL2: c_uint = 0x66;
// Command header definition
pub const CMD_HEADER_WRITE: c_uint = 0x54;
pub const CMD_HEADER_READ: c_uint = 0x53;
pub const CMD_HEADER_6B_READ: c_uint = 0x5B;
pub const CMD_HEADER_ROM_READ: c_uint = 0x96;
pub const CMD_HEADER_RESP: c_uint = 0x52;
pub const CMD_HEADER_6B_RESP: c_uint = 0x9B;
pub const CMD_HEADER_ROM_RESP: c_uint = 0x95;
pub const CMD_HEADER_HELLO: c_uint = 0x55;
pub const CMD_HEADER_REK: c_uint = 0x66;
// FW position data
pub const PACKET_SIZE_OLD: c_int = 40;
pub const PACKET_SIZE: c_int = 55;
pub const MAX_CONTACT_NUM: c_int = 10;
pub const FW_POS_HEADER: c_int = 0;
pub const FW_POS_STATE: c_int = 1;
pub const FW_POS_TOTAL: c_int = 2;
pub const FW_POS_XY: c_int = 3;
pub const FW_POS_TOOL_TYPE: c_int = 33;
pub const FW_POS_CHECKSUM: c_int = 34;
pub const FW_POS_WIDTH: c_int = 35;
pub const FW_POS_PRESSURE: c_int = 45;
pub const HEADER_REPORT_10_FINGER: c_uint = 0x62;
// Header (4 bytes) plus 3 full 10-finger packets
pub const MAX_PACKET_SIZE: c_int = 169;
pub const BOOT_TIME_DELAY_MS: c_int = 50;
// FW read command, 0x53 0x?? 0x0, 0x01
pub const E_ELAN_INFO_FW_VER: c_uint = 0x00;
pub const E_ELAN_INFO_BC_VER: c_uint = 0x10;
pub const E_ELAN_INFO_X_RES: c_uint = 0x60;
pub const E_ELAN_INFO_Y_RES: c_uint = 0x63;
pub const E_ELAN_INFO_REK: c_uint = 0xD0;
pub const E_ELAN_INFO_TEST_VER: c_uint = 0xE0;
pub const E_ELAN_INFO_FW_ID: c_uint = 0xF0;
pub const E_INFO_OSR: c_uint = 0xD6;
pub const E_INFO_PHY_SCAN: c_uint = 0xD7;
pub const E_INFO_PHY_DRIVER: c_uint = 0xD8;
// FW write command, 0x54 0x?? 0x0, 0x01
pub const E_POWER_STATE_SLEEP: c_uint = 0x50;
pub const E_POWER_STATE_RESUME: c_uint = 0x58;
pub const MAX_RETRIES: c_int = 3;
pub const MAX_FW_UPDATE_RETRIES: c_int = 30;
pub const ELAN_FW_PAGESIZE: c_int = 132;
// calibration timeout definition
pub const ELAN_CALI_TIMEOUT_MSEC: c_int = 12000;
pub const ELAN_POWERON_DELAY_USEC: c_int = 5000;
pub const ELAN_RESET_DELAY_MSEC: c_int = 20;
// FW boot code version
pub const BC_VER_H_BYTE_FOR_EKTH3900x1_I2C: c_uint = 0x72;
pub const BC_VER_H_BYTE_FOR_EKTH3900x2_I2C: c_uint = 0x82;
pub const BC_VER_H_BYTE_FOR_EKTH3900x3_I2C: c_uint = 0x92;
pub const BC_VER_H_BYTE_FOR_EKTH5312x1_I2C: c_uint = 0x6D;
pub const BC_VER_H_BYTE_FOR_EKTH5312x2_I2C: c_uint = 0x6E;
pub const BC_VER_H_BYTE_FOR_EKTH5312cx1_I2C: c_uint = 0x77;
pub const BC_VER_H_BYTE_FOR_EKTH5312cx2_I2C: c_uint = 0x78;
pub const BC_VER_H_BYTE_FOR_EKTH5312x1_I2C_USB: c_uint = 0x67;
pub const BC_VER_H_BYTE_FOR_EKTH5312x2_I2C_USB: c_uint = 0x68;
pub const BC_VER_H_BYTE_FOR_EKTH5312cx1_I2C_USB: c_uint = 0x74;
pub const BC_VER_H_BYTE_FOR_EKTH5312cx2_I2C_USB: c_uint = 0x75;
    enum elants_chip_id {
    EKTH3500,
    EKTF3624,
    };
...
pub struct elants_data {
    ...
    pub fw_version: u16,
    pub test_version: u8,
    pub solution_version: u8,
    pub bc_version: u8,
    pub iap_version: u8,
    pub hw_version: u16,
    pub major_res: u8,
    pub /: *mut *mut unsigned int x_res; / resolution in units/mm,
    pub y_res: c_uint,
    pub x_max: c_uint,
    pub y_max: c_uint,
    pub phy_x: c_uint,
    ...
    pub state: enum elants_state,
    pub chip_id: enum elants_chip_id,
    pub iap_mode: enum elants_iap_mode,
// Guards against concurrent access to the device via sysfs
    pub sysfs_mutex: mutex,
    pub cmd_resp: [u8; HEADER_SIZE],
    pub cmd_done: completion,
    pub keep_power_in_suspend: bool,
// Must be last to be used for DMA operations
    pub ____cacheline_aligned: u8 buf[MAX_PACKET_SIZE],
}
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_read(client: *mut i2c_client, data: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_calibrate(ts: *mut elants_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_sw_reset(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_parse_version(buf: *mut u8) -> u16 {
    static u16 elants_i2c_parse_version(u8 *buf)
    {
    return get_unaligned_be32(buf) >> 4;
    }
#[no_mangle]
unsafe extern "C" fn elants_i2c_query_hw_version(ts: *mut elants_data) -> c_int {
    static int elants_i2c_query_hw_version(struct elants_data *ts)
    {
    struct i2c_client *client = ts.client;
    let mut retry_cnt: c_int = MAX_RETRIES;
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_query_fw_version(ts: *mut elants_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_query_test_version(ts: *mut elants_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_query_bc_version(ts: *mut elants_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_query_ts_info_ektf(ts: *mut elants_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_query_ts_info_ekth(ts: *mut elants_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_fastboot(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_initialize(ts: *mut elants_data) -> c_int {
...
//
    ...
    u8 resp[6] = { 0 };
    let mut ts_remark_id: u16 = 0;
    let mut fw_remark_id: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_should_check_remark_id(ts: *mut elants_data) -> bool {
    static bool elants_i2c_should_check_remark_id(struct elants_data *ts)
    {
    struct i2c_client *client = ts.client;
    let mut bootcode_version: u8 = ts.iap_version;
    bool check;
// I2C eKTH3900 and eKTH5312 are NOT support Remark ID
    ...
    int page, n_fw_pages;
    int error;
    let mut check_remark_id: bool = elants_i2c_should_check_remark_id(ts);
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_fw_update(ts: *mut elants_data) -> c_int {
    ...
    scoped_guard(disable_irq, &client.irq) {
    let mut force_update: bool = ts.iap_mode == ELAN_IAP_RECOVERY;
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_calculate_checksum(buf: *mut u8) -> u8 {
    ...
    size_t packet_size)
    {
    let mut checksum: u8 = elants_i2c_calculate_checksum(buf);
...
#[no_mangle]
pub unsafe extern "C" fn if(HEADER_REPORT_10_FINGER): unlikely(buf[FW_POS_HEADER] !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_irq(irq: c_int, _dev: *mut c_void) -> irqreturn_t {
...
//
    ...
    static DEVICE_ATTR(iap_mode, S_IRUGO, show_iap_mode, core::ptr::null_mut());
    static DEVICE_ATTR(calibration_count, S_IRUGO, show_calibration_count, core::ptr::null_mut());
    static DEVICE_ATTR(update_fw, S_IWUSR, core::ptr::null_mut(), write_update_fw);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct elants_version_attribute {
    pub dattr: device_attribute,
    pub field_offset: usize,
    pub field_size: usize,
}

    sizeof(((struct elants_data *)core::ptr::null_mut())._field)
    ...
    elants_version_attribute_show, core::ptr::null_mut()),	\
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_power_on(ts: *mut elants_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_power_off(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn elants_acpi_is_hid_device(dev: *mut device) -> bool {
    ...
    return false;
    obj = acpi_evaluate_dsm_typed(handle, &i2c_hid_guid, 1, 1, core::ptr::null_mut(), ACPI_TYPE_INTEGER);
    if (obj) {
    ACPI_FREE(obj);
    return true;
    }
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    core::ptr::null_mut(), elants_i2c_irq,
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn elants_i2c_resume(dev: *mut device) -> c_int {
