...
//! Source: drivers/input/touchscreen/wm9713.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn wm9713_phy_init(wm: *mut wm97xx) {
    static void wm9713_phy_init(struct wm97xx *wm)
    {
    let mut dig1: u16 = 0, dig2, dig3;
// default values
...
#[no_mangle]
unsafe extern "C" fn wm9713_dig_enable(wm: *mut wm97xx, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wm9713_dig_restore(wm: *mut wm97xx) {
...
#[no_mangle]
unsafe extern "C" fn wm9713_aux_prepare(wm: *mut wm97xx) {
...
//
#[no_mangle]
unsafe extern "C" fn wm9713_poll_sample(wm: *mut wm97xx, adcsel: c_int, sample: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm9713_poll_coord(wm: *mut wm97xx, data: *mut wm97xx_data) -> c_int {
    static int wm9713_poll_coord(struct wm97xx *wm, struct wm97xx_data *data)
    {
    u16 dig1;
    let mut timeout: c_int = 5 * delay;
    if (!wm.pen_probably_down) {
    let mut val: u16 = wm97xx_reg_read(wm, AC97_WM97XX_DIGITISER_RD);
...
//
#[no_mangle]
unsafe extern "C" fn wm9713_poll_touch(wm: *mut wm97xx, data: *mut wm97xx_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm9713_acc_enable(wm: *mut wm97xx, enable: c_int) -> c_int {
