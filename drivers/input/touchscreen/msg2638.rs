...
//! Source: drivers/input/touchscreen/msg2638.c
#![no_std]
...
pub const MODE_DATA_RAW: c_uint = 0x5A;
pub const MSG2138_MAX_FINGERS: c_int = 2;
pub const MSG2638_MAX_FINGERS: c_int = 5;
pub const MAX_BUTTONS: c_int = 4;
pub const CHIP_ON_DELAY_MS: c_int = 15;
pub const FIRMWARE_ON_DELAY_MS: c_int = 50;
pub const RESET_DELAY_MIN_US: c_int = 10000;
pub const RESET_DELAY_MAX_US: c_int = 11000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msg_chip_data {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msg2138_packet {
    pub /: *mut *mut u8 xy_hi; / higher bits of x and y coordinates,
    pub x_low: u8,
    pub y_low: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msg2138_touch_event {
    pub magic: u8,
    pub pkt: [msg2138_packet; MSG2138_MAX_FINGERS],
    pub checksum: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct msg2638_packet {
    pub /: *mut *mut u8 xy_hi; / higher bits of x and y coordinates,
    pub x_low: u8,
    pub y_low: u8,
    pub pressure: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msg2638_touch_event {
    pub mode: u8,
    pub pkt: [msg2638_packet; MSG2638_MAX_FINGERS],
    pub proximity: u8,
    pub checksum: u8,
}
...
pub struct msg2638_ts_data {
    ...
    pub max_fingers: c_int,
    pub keycodes: [u32; MAX_BUTTONS],
    pub num_keycodes: c_int,
}

#[no_mangle]
unsafe extern "C" fn msg2638_checksum(data: *mut u8, length: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn msg2138_report_keys(msg2638: *mut msg2638_ts_data, keys: u8) {
...
#[no_mangle]
unsafe extern "C" fn msg2138_ts_irq_handler(irq: c_int, msg2638_handler: *mut c_void) -> irqreturn_t {
    ...
    let mut len: u32 = sizeof(touch_event);
    struct i2c_msg msg[] = {
    {
    .addr	= client.addr,
    .flags	= I2C_M_RD,
...
#[no_mangle]
unsafe extern "C" fn msg2638_ts_irq_handler(irq: c_int, msg2638_handler: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn msg2638_reset(msg2638: *mut msg2638_ts_data) {
...
#[no_mangle]
unsafe extern "C" fn msg2638_start(msg2638: *mut msg2638_ts_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msg2638_stop(msg2638: *mut msg2638_ts_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msg2638_input_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msg2638_input_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn msg2638_init_input_dev(msg2638: *mut msg2638_ts_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msg2638_ts_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), chip_data.irq_handler,
...
#[no_mangle]
unsafe extern "C" fn msg2638_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msg2638_resume(dev: *mut device) -> c_int {
