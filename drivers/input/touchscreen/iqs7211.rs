...
//! Source: drivers/input/touchscreen/iqs7211.c
#![no_std]
...
pub const IQS7211_PROD_NUM: c_uint = 0x00;

pub const IQS7211_COMMS_ERROR: c_uint = 0xEEEE;
pub const IQS7211_COMMS_RETRY_MS: c_int = 50;
pub const IQS7211_COMMS_SLEEP_US: c_int = 100;

pub const IQS7211_RESET_TIMEOUT_MS: c_int = 150;

pub const IQS7211_NUM_RETRIES: c_int = 5;
pub const IQS7211_NUM_CRX: c_int = 8;
pub const IQS7211_MAX_CTX: c_int = 13;
pub const IQS7211_MAX_CONTACTS: c_int = 2;
pub const IQS7211_MAX_CYCLES: c_int = 21;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7211_reg_field_desc {
    pub list: list_head,
    pub addr: u8,
    pub mask: u16,
    pub val: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7211_event_desc {
    pub name: *const c_char,
    pub mask: u16,
    pub enable: u16,
    pub reg_grp: enum iqs7211_reg_grp_id,
    pub reg_key: enum iqs7211_reg_key_id,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7211_dev_desc {
    pub tp_name: *const c_char,
    pub kp_name: *const c_char,
    pub prod_num: u16,
    pub show_reset: u16,
    pub ati_error: [u16; IQS7211_NUM_REG_GRPS],
    pub ati_start: [u16; IQS7211_NUM_REG_GRPS],
    pub suspend: u16,
    pub ack_reset: u16,
    pub comms_end: u16,
    pub comms_req: u16,
    pub charge_shift: c_int,
    pub info_offs: c_int,
    pub gesture_offs: c_int,
    pub contact_offs: c_int,
    pub sys_stat: u8,
    pub sys_ctrl: u8,
    pub alp_config: u8,
    pub tp_config: u8,
    pub exp_file: u8,
    pub kp_enable: [u8; IQS7211_NUM_REG_GRPS],
    pub gesture_angle: u8,
    pub rx_tx_map: u8,
    pub cycle_alloc: [u8; 2],
    pub cycle_limit: [u8; 2],
    pub kp_events: *const iqs7211_event_desc,
    pub num_kp_events: c_int,
    pub min_crx_alp: c_int,
    pub num_ctx: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7211_prop_desc {
    pub name: *const c_char,
    pub reg_key: enum iqs7211_reg_key_id,
    pub reg_addr: [u8; IQS7211_NUM_REG_GRPS][ARRAY_SIZE(iqs7211_devs)],
    pub reg_shift: c_int,
    pub reg_width: c_int,
    pub val_pitch: c_int,
    pub val_min: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs7211_private {
    pub dev_desc: *const iqs7211_dev_desc,
    pub reset_gpio: *mut gpio_desc,
    pub irq_gpio: *mut gpio_desc,
    pub client: *mut i2c_client,
    pub tp_idev: *mut input_dev,
    pub kp_idev: *mut input_dev,
    pub ver_info: iqs7211_ver_info,
    pub tp_config: iqs7211_tp_config,
    pub prop: touchscreen_properties,
    pub reg_field_head: list_head,
    pub comms_init: enum iqs7211_comms_mode,
    pub comms_mode: enum iqs7211_comms_mode,
    pub num_contacts: c_uint,
    pub kp_code: [c_uint; ARRAY_SIZE(iqs7211e_kp_events)],
    pub 1]: u8 rx_tx_map[IQS7211_MAX_CTX +,
    pub cycle_alloc: [u8; 2][33],
    pub exp_file: [u8; 2],
    pub event_mask: u16,
    pub ati_start: u16,
    pub gesture_cache: u16,
}

#[no_mangle]
unsafe extern "C" fn iqs7211_irq_poll(iqs7211: *mut iqs7211_private, timeout_us: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_hard_reset(iqs7211: *mut iqs7211_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_force_comms(iqs7211: *mut iqs7211_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_read_word(iqs7211: *mut iqs7211_private, reg: u8, val: *mut u16) -> c_int {
...
// val = le16_to_cpu(val_buf);
    ...
    {
    let mut msg_len: c_int = sizeof(reg) + val_len;
    int ret, i;
    struct i2c_client *client = iqs7211.client;
    u8 *msg_buf;
...
#[no_mangle]
unsafe extern "C" fn iqs7211_write_word(iqs7211: *mut iqs7211_private, reg: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_start_comms(iqs7211: *mut iqs7211_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_init_device(iqs7211: *mut iqs7211_private) -> c_int {
...
//
    ...
    let mut new_val: u16 = reg_field.val;
...
// sys_ctrl = cpu_to_le16(iqs7211->ati_start);
    ...
    [iqs7211.dev_desc -
    iqs7211_devs];
    let mut reg_shift: c_int = iqs7211_props[i].reg_shift;
    let mut reg_width: c_int = iqs7211_props[i].reg_width ? : 16;
    let mut val_pitch: c_int = iqs7211_props[i].val_pitch ? : 1;
    let mut val_min: c_int = iqs7211_props[i].val_min;
    let mut val_max: c_int = iqs7211_props[i].val_max;
...
pub unsafe extern "C" fn if(_arg: error) -> else {
    ...
    const struct iqs7211_dev_desc *dev_desc = iqs7211.dev_desc;
    struct i2c_client *client = iqs7211.client;
    let mut num_cycles: c_int = dev_desc.cycle_limit[0] + dev_desc.cycle_limit[1];
    int error, count, i, j, k, cycle_start;
    unsigned int cycle_alloc[IQS7211_MAX_CYCLES][2];
    let mut total_rx: u8 = iqs7211.tp_config.total_rx;
    let mut total_tx: u8 = iqs7211.tp_config.total_tx;
...
//
    ...
    let mut cycle_stop: c_int = 0;
    for (j = 0; j < total_rx; j++) {
//
// Channels formed by CRx0-3 and CRx4-7 are
// bound to slots 0 and 1, respectively.
//
    let mut slot: c_int = iqs7211.rx_tx_map[j] < 4 ? 0 : 1;
    let mut chan: c_int = i * total_rx + j;
...
//
    ...
    for (i = 0; i < count; i++) {
    let mut chan: c_int = *(cycle_alloc[0] + i);
    if (chan == U8_MAX)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn int(_arg: *mut iqs7211_parse_extra[IQS7211_NUM_REG_GRPS]) -> static {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_register_kp(iqs7211: *mut iqs7211_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_register_tp(iqs7211: *mut iqs7211_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_report(iqs7211: *mut iqs7211_private) -> c_int {
...
//
    ...
    for (i = 0; i < dev_desc.num_kp_events; i++) {
    let mut reg_key: enum iqs7211_reg_key_id = dev_desc.kp_events[i].reg_key;
    let mut mask: u16 = dev_desc.kp_events[i].mask;
...
#[no_mangle]
unsafe extern "C" fn iqs7211_irq(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs7211_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    error = devm_request_threaded_irq(&client.dev, irq, core::ptr::null_mut(), iqs7211_irq,
