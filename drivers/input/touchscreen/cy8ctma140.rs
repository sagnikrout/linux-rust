...
//! Source: drivers/input/touchscreen/cy8ctma140.c
#![no_std]
...
pub const CY8CTMA140_MAX_FINGERS: c_int = 4;
pub const CY8CTMA140_GET_FINGERS: c_uint = 0x00;
pub const CY8CTMA140_GET_FW_INFO: c_uint = 0x19;
// This message also fits some bytes for touchkeys, if used
pub const CY8CTMA140_PACKET_SIZE: c_int = 31;
pub const CY8CTMA140_INVALID_BUFFER_BIT: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cy8ctma140 {
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_report(ts: *mut cy8ctma140, data: *mut u8, n_fingers: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_irq_thread(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_init(ts: *mut cy8ctma140) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_power_up(ts: *mut cy8ctma140) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_power_down(ts: *mut cy8ctma140) {
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_power_off_action(d: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    core::ptr::null_mut(), cy8ctma140_irq_thread,
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cy8ctma140_resume(dev: *mut device) -> c_int {
