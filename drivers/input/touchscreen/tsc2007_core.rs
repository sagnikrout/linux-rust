...
//! Source: drivers/input/touchscreen/tsc2007_core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tsc2007_xfer(tsc: *mut tsc2007, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsc2007_read_values(tsc: *mut tsc2007, tc: *mut ts_event) {
...
#[no_mangle]
pub unsafe extern "C" fn tsc2007_calculate_resistance(tsc: *mut tsc2007, tc: *mut ts_event) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn tsc2007_is_pen_down(ts: *mut tsc2007) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsc2007_soft_irq(irq: c_int, handle: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tsc2007_stop(ts: *mut tsc2007) {
...
#[no_mangle]
unsafe extern "C" fn tsc2007_open(input_dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsc2007_close(input_dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn tsc2007_get_pendown_state_gpio(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tsc2007_probe_properties(dev: *mut device, ts: *mut tsc2007) -> c_int {
    ...
    ts.gpiod = devm_gpiod_get_optional(dev, core::ptr::null_mut(), GPIOD_IN);
    if (IS_ERR(ts.gpiod))
...
#[no_mangle]
unsafe extern "C" fn tsc2007_call_exit_platform_hw(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tsc2007_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), tsc2007_soft_irq,
    IRQF_ONESHOT,
