...
//! Source: drivers/input/touchscreen/wm9712.c
#![no_std]
...
//
    let mut pressure: static int = DEFAULT_PRESSURE & 0xfff;
...
//
#[no_mangle]
pub unsafe extern "C" fn poll_delay(d: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn wm9712_phy_init(wm: *mut wm97xx) {
    static void wm9712_phy_init(struct wm97xx *wm)
    {
    let mut dig1: u16 = 0;
    let mut dig2: u16 = WM97XX_RPR | WM9712_RPU(1);
// WM9712 rpu
    if (rpu) {
    dig2 &= 0xffc0;
    dig2 |= WM9712_RPU(rpu);
...
#[no_mangle]
unsafe extern "C" fn wm9712_dig_enable(wm: *mut wm97xx, enable: c_int) {
    static void wm9712_dig_enable(struct wm97xx *wm, int enable)
    {
    let mut dig2: u16 = wm.dig[2];
    if (enable) {
...
#[no_mangle]
unsafe extern "C" fn wm9712_aux_prepare(wm: *mut wm97xx) {
...
#[no_mangle]
unsafe extern "C" fn wm9712_dig_restore(wm: *mut wm97xx) {
...
#[no_mangle]
pub unsafe extern "C" fn is_pden(wm: *mut wm97xx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm9712_poll_sample(wm: *mut wm97xx, adcsel: c_int, sample: *mut c_int) -> c_int {
    static int wm9712_poll_sample(struct wm97xx *wm, int adcsel, int *sample)
    {
    let mut timeout: c_int = 5 * delay;
    let mut wants_pen: bool = adcsel & WM97XX_PEN_DOWN;
    if (wants_pen && !wm.pen_probably_down) {
    let mut data: u16 = wm97xx_reg_read(wm, AC97_WM97XX_DIGITISER_RD);
...
//
#[no_mangle]
unsafe extern "C" fn wm9712_poll_coord(wm: *mut wm97xx, data: *mut wm97xx_data) -> c_int {
    static int wm9712_poll_coord(struct wm97xx *wm, struct wm97xx_data *data)
    {
    let mut timeout: c_int = 5 * delay;
    if (!wm.pen_probably_down) {
    let mut data_rd: u16 = wm97xx_reg_read(wm, AC97_WM97XX_DIGITISER_RD);
...
//
#[no_mangle]
unsafe extern "C" fn wm9712_poll_touch(wm: *mut wm97xx, data: *mut wm97xx_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm9712_acc_enable(wm: *mut wm97xx, enable: c_int) -> c_int {
