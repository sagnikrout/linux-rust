...
//! Source: drivers/input/touchscreen/resistive-adc-touch.c
#![no_std]
...
pub const GRTS_DEFAULT_PRESSURE_MIN: c_int = 50000;
pub const GRTS_DEFAULT_PRESSURE_MAX: c_int = 65535;

pub const GRTS_MAX_CHANNELS: c_int = 4;
    enum grts_ch_type {
    GRTS_CH_X,
    GRTS_CH_Y,
    GRTS_CH_PRESSURE,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct grts_state {
    pub x_plate_ohms: u32,
    pub pressure_min: u32,
    pub pressure: bool,
    pub iio_chans: *mut iio_channel,
    pub iio_cb: *mut iio_cb_buffer,
    pub input: *mut input_dev,
    pub prop: touchscreen_properties,
    pub ch_map: [u8; GRTS_CH_MAX],
}

#[no_mangle]
unsafe extern "C" fn grts_cb(data: *const c_void, private: *mut c_void) -> c_int {
    ...
    let mut z1: c_uint = touch_info[st.ch_map[GRTS_CH_Z1]];
    let mut z2: c_uint = touch_info[st.ch_map[GRTS_CH_Z2]];
    unsigned int Rt;
    if (likely(x && z1)) {
    Rt = z2;
    Rt -= z1;
...
#[no_mangle]
unsafe extern "C" fn grts_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn grts_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn grts_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn grts_get_properties(st: *mut grts_state, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn grts_probe(pdev: *mut platform_device) -> c_int {
