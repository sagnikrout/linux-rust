...
//! Source: drivers/input/touchscreen/wm831x-ts.c
#![no_std]
...
//
pub const WM831X_TCH_ENA: c_uint = 0x8000  /* TCH_ENA */;
pub const WM831X_TCH_CVT_ENA: c_uint = 0x4000  /* TCH_CVT_ENA */;
pub const WM831X_TCH_SLPENA: c_uint = 0x1000  /* TCH_SLPENA */;
pub const WM831X_TCH_Z_ENA: c_uint = 0x0400  /* TCH_Z_ENA */;
pub const WM831X_TCH_Y_ENA: c_uint = 0x0200  /* TCH_Y_ENA */;
pub const WM831X_TCH_X_ENA: c_uint = 0x0100  /* TCH_X_ENA */;
pub const WM831X_TCH_DELAY_MASK: c_uint = 0x00E0  /* TCH_DELAY - [7:5] */;

pub const WM831X_TCH_RATE_MASK: c_uint = 0x001F  /* TCH_RATE - [4:0] */;

//
// R16425 (0x4029) - Touch Control 2
//
pub const WM831X_TCH_PD_WK: c_uint = 0x2000  /* TCH_PD_WK */;
pub const WM831X_TCH_5WIRE: c_uint = 0x1000  /* TCH_5WIRE */;
pub const WM831X_TCH_PDONLY: c_uint = 0x0800  /* TCH_PDONLY */;
pub const WM831X_TCH_ISEL: c_uint = 0x0100  /* TCH_ISEL */;
pub const WM831X_TCH_RPU_MASK: c_uint = 0x000F  /* TCH_RPU - [3:0] */;

//
// R16426-8 (0x402A-C) - Touch Data X/Y/X
//
pub const WM831X_TCH_PD: c_uint = 0x8000  /* TCH_PD1 */;
pub const WM831X_TCH_DATA_MASK: c_uint = 0x0FFF  /* TCH_DATA - [11:0] */;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm831x_ts {
    ...
    pub pressure: bool,
    pub pen_down: bool,
    pub pd_data_work: work_struct,
}

#[no_mangle]
unsafe extern "C" fn wm831x_pd_data_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn wm831x_ts_data_irq(irq: c_int, irq_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm831x_ts_pen_down_irq(irq: c_int, irq_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm831x_ts_input_open(idev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_ts_input_close(idev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn wm831x_ts_probe(pdev: *mut platform_device) -> c_int {
    static int wm831x_ts_probe(struct platform_device *pdev)
    {
    struct wm831x_ts *wm831x_ts;
    struct wm831x *wm831x = dev_get_drvdata(pdev.dev.parent);
    struct wm831x_pdata *core_pdata = dev_get_platdata(pdev.dev.parent);
    struct wm831x_touch_pdata *pdata = core::ptr::null_mut();
...
// Default to 96 samples/sec
    ...
    core::ptr::null_mut(), wm831x_ts_data_irq,
    ...
    core::ptr::null_mut(), wm831x_ts_pen_down_irq,
    irqf | IRQF_ONESHOT,
...
#[no_mangle]
unsafe extern "C" fn wm831x_ts_remove(pdev: *mut platform_device) {
