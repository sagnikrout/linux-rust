...
//! Source: drivers/input/touchscreen/fujitsu_ts.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const FUJITSU_LENGTH: c_int = 5;
//
...
pub struct fujitsu {
    ...
    pub serio: *mut serio,
    pub idx: c_int,
    pub data: [c_uchar; FUJITSU_LENGTH],
    pub phys: [c_char; 32],
}
...
//
#[no_mangle]
unsafe extern "C" fn fujitsu_disconnect(serio: *mut serio) {
...
//
#[no_mangle]
unsafe extern "C" fn fujitsu_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
