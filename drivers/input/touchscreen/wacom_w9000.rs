...
//! Source: drivers/input/touchscreen/wacom_w9000.c
#![no_std]
...
pub const CMD_QUERY_RETRIES: c_int = 8;
// Message length
pub const CMD_QUERY_NUM_MAX: c_int = 9;
pub const MSG_COORD_NUM_MAX: c_int = 12;
// Commands
pub const CMD_QUERY: c_uint = 0x2a;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wacom_w9000_variant {
    pub cmd_query_num: u8,
    pub msg_coord_num: u8,
    pub name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct wacom_w9000_data {
    pub client: *mut i2c_client,
    pub input_dev: *mut input_dev,
    pub variant: *const wacom_w9000_variant,
    pub fw_version: u16,
    pub prop: touchscreen_properties,
    pub max_pressure: u16,
    pub regulator: *mut regulator,
    pub flash_mode_gpio: *mut gpio_desc,
    pub reset_gpio: *mut gpio_desc,
    pub irq: c_uint,
    pub pen_proximity: bool,
}

#[no_mangle]
unsafe extern "C" fn wacom_w9000_read(client: *mut i2c_client, command: u8, len: u8, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_query(wacom_data: *mut wacom_w9000_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_power_on(wacom_data: *mut wacom_w9000_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_power_off(wacom_data: *mut wacom_w9000_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_coord(wacom_data: *mut wacom_w9000_data) {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_probe(client: *mut i2c_client) -> c_int {
    ...
    error = devm_request_threaded_irq(dev, wacom_data.irq, core::ptr::null_mut(), wacom_w9000_interrupt,
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_w9000_resume(dev: *mut device) -> c_int {
