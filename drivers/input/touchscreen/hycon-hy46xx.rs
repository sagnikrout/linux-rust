...
//! Source: drivers/input/touchscreen/hycon-hy46xx.c
#![no_std]
...
pub const HY46XX_CHKSUM_CODE: c_uint = 0x1;
pub const HY46XX_FINGER_NUM: c_uint = 0x2;
pub const HY46XX_CHKSUM_LEN: c_uint = 0x7;
pub const HY46XX_THRESHOLD: c_uint = 0x80;
pub const HY46XX_GLOVE_EN: c_uint = 0x84;
pub const HY46XX_REPORT_SPEED: c_uint = 0x88;
pub const HY46XX_PWR_NOISE_EN: c_uint = 0x89;
pub const HY46XX_FILTER_DATA: c_uint = 0x8A;
pub const HY46XX_GAIN: c_uint = 0x92;
pub const HY46XX_EDGE_OFFSET: c_uint = 0x93;
pub const HY46XX_RX_NR_USED: c_uint = 0x94;
pub const HY46XX_TX_NR_USED: c_uint = 0x95;
pub const HY46XX_PWR_MODE: c_uint = 0xA5;
pub const HY46XX_FW_VERSION: c_uint = 0xA6;
pub const HY46XX_LIB_VERSION: c_uint = 0xA7;
pub const HY46XX_TP_INFO: c_uint = 0xA8;
pub const HY46XX_TP_CHIP_ID: c_uint = 0xA9;
pub const HY46XX_BOOT_VER: c_uint = 0xB0;
pub const HY46XX_TPLEN: c_uint = 0x6;
pub const HY46XX_REPORT_PKT_LEN: c_uint = 0x44;
pub const HY46XX_MAX_SUPPORTED_POINTS: c_int = 11;
pub const TOUCH_EVENT_DOWN: c_uint = 0x00;
pub const TOUCH_EVENT_UP: c_uint = 0x01;
pub const TOUCH_EVENT_CONTACT: c_uint = 0x02;
pub const TOUCH_EVENT_RESERVED: c_uint = 0x03;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hycon_hy46xx_data {
    ...
    pub threshold: c_int,
    pub glove_enable: bool,
    pub report_speed: c_int,
    pub noise_filter_enable: bool,
    pub filter_data: c_int,
    pub gain: c_int,
    pub edge_offset: c_int,
    pub rx_number_used: c_int,
    pub tx_number_used: c_int,
    pub power_mode: c_int,
    pub fw_version: c_int,
    pub lib_version: c_int,
    pub tp_information: c_int,
    pub tp_chip_id: c_int,
...
#[no_mangle]
unsafe extern "C" fn hycon_hy46xx_check_checksum(tsdata: *mut hycon_hy46xx_data, buf: *mut u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hycon_hy46xx_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hycon_hy46xx_attribute {
...
#[no_mangle]
unsafe extern "C" fn hycon_hy46xx_get_defaults(dev: *mut device, tsdata: *mut hycon_hy46xx_data) {
...
#[no_mangle]
unsafe extern "C" fn hycon_hy46xx_get_parameters(tsdata: *mut hycon_hy46xx_data) {
...
#[no_mangle]
unsafe extern "C" fn hycon_hy46xx_disable_regulator(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hycon_hy46xx_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), hycon_hy46xx_isr, IRQF_ONESHOT,
    client.name, tsdata);
    if (error) {
