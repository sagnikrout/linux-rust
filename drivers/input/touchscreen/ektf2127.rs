...
//! Source: drivers/input/touchscreen/ektf2127.c
#![no_std]
...
pub const EKTF2127_NOISE: c_uint = 0x40;
pub const EKTF2127_RESPONSE: c_uint = 0x52;
pub const EKTF2127_REQUEST: c_uint = 0x53;
pub const EKTF2127_HELLO: c_uint = 0x55;
pub const EKTF2127_REPORT2: c_uint = 0x5a;
pub const EKTF2127_REPORT: c_uint = 0x5d;
pub const EKTF2127_CALIB_DONE: c_uint = 0x66;
// Register defines (second byte of data send / received)
pub const EKTF2127_ENV_NOISY: c_uint = 0x41;
pub const EKTF2127_HEIGHT: c_uint = 0x60;
pub const EKTF2127_WIDTH: c_uint = 0x63;
// 2 bytes header + 5 * 3 bytes coordinates + 3 bytes pressure info + footer
pub const EKTF2127_TOUCH_REPORT_SIZE: c_int = 21;
pub const EKTF2127_MAX_TOUCHES: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ektf2127_ts {
    pub client: *mut i2c_client,
    pub input: *mut input_dev,
    pub power_gpios: *mut gpio_desc,
    pub prop: touchscreen_properties,
    pub status_shift: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ektf2127_i2c_chip_data {
    pub status_shift: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn ektf2127_report_event(ts: *mut ektf2127_ts, buf: *const u8) {
    ...
    if (active) {
    let mut x: c_int = (buf[0] & 0xf0) << 4 | buf[1];
    let mut y: c_int = (buf[0] & 0x0f) << 8 | buf[2];
    touchscreen_report_pos(ts.input, &ts.prop, x, y, true);
    }
    }
#[no_mangle]
unsafe extern "C" fn ektf2127_report2_event(ts: *mut ektf2127_ts, buf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn ektf2127_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ektf2127_start(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ektf2127_stop(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn ektf2127_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ektf2127_resume(dev: *mut device) -> c_int {
    ...
    ektf2127_resume);
#[no_mangle]
unsafe extern "C" fn ektf2127_query_dimension(client: *mut i2c_client, width: bool) -> c_int {
    static int ektf2127_query_dimension(struct i2c_client *client, bool width)
    {
    struct device *dev = &client.dev;
    const char *what = width ? "width" : "height";
    let mut what_code: u8 = width ? EKTF2127_WIDTH : EKTF2127_HEIGHT;
    u8 buf[4];
    int ret;
    int error;
// Request dimension
...
#[no_mangle]
unsafe extern "C" fn ektf2127_probe(client: *mut i2c_client) -> c_int {
...
// Read resolution from chip
    ...
    core::ptr::null_mut(), ektf2127_irq,
