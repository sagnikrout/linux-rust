...
//! Source: drivers/input/touchscreen/raydium_i2c_ts.c
#![no_std]
...
// Slave I2C mode
pub const RM_BOOT_BLDR: c_uint = 0x02;
pub const RM_BOOT_MAIN: c_uint = 0x03;
// I2C bootoloader commands
pub const RM_CMD_BOOT_PAGE_WRT: c_uint = 0x0B		/* send bl page write */;
pub const RM_CMD_BOOT_WRT: c_uint = 0x11		/* send bl write */;
pub const RM_CMD_BOOT_ACK: c_uint = 0x22		/* send ack*/;
pub const RM_CMD_BOOT_CHK: c_uint = 0x33		/* send data check */;
pub const RM_CMD_BOOT_READ: c_uint = 0x44		/* send wait bl data ready*/;
pub const RM_BOOT_RDY: c_uint = 0xFF		/* bl data ready */;
pub const RM_BOOT_CMD_READHWID: c_uint = 0x0E		/* read hwid */;
// I2C main commands
pub const RM_CMD_QUERY_BANK: c_uint = 0x2B;
pub const RM_CMD_DATA_BANK: c_uint = 0x4D;
pub const RM_CMD_ENTER_SLEEP: c_uint = 0x4E;
pub const RM_CMD_BANK_SWITCH: c_uint = 0xAA;
pub const RM_RESET_MSG_ADDR: c_uint = 0x40000004;
pub const RM_MAX_READ_SIZE: c_int = 56;
pub const RM_PACKET_CRC_SIZE: c_int = 2;
// Touch relative info
pub const RM_MAX_RETRIES: c_int = 3;
pub const RM_RETRY_DELAY_MS: c_int = 20;
pub const RM_MAX_TOUCH_NUM: c_int = 10;
pub const RM_BOOT_DELAY_MS: c_int = 100;
// Offsets in contact data
pub const RM_CONTACT_STATE_POS: c_int = 0;
pub const RM_CONTACT_X_POS: c_int = 1;
pub const RM_CONTACT_Y_POS: c_int = 3;
pub const RM_CONTACT_PRESSURE_POS: c_int = 5;
pub const RM_CONTACT_WIDTH_X_POS: c_int = 6;
pub const RM_CONTACT_WIDTH_Y_POS: c_int = 7;
// Bootloader relative info

pub const RM_FW_PAGE_SIZE: c_int = 128;
pub const RM_MAX_FW_RETRIES: c_int = 30;
pub const RM_MAX_FW_SIZE: c_uint = 0xD000;
pub const RM_POWERON_DELAY_USEC: c_int = 500;
pub const RM_RESET_DELAY_MSEC: c_int = 50;
    enum raydium_bl_cmd {
    BL_HEADER = 0,
    BL_PAGE_STR,
    BL_PKG_IDX,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct raydium_data_info {
    pub data_bank_addr: __le32,
    pub pkg_size: u8,
    pub tp_info_size: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct raydium_info {
    pub /: *mut *mut __le32 hw_ver; /device version,
    pub main_ver: u8,
    pub sub_ver: u8,
    pub /: *mut *mut __le16 ft_ver; / test version,
    pub x_num: u8,
    pub y_num: u8,
    pub x_max: __le16,
    pub y_max: __le16,
    pub /: *mut *mut u8 x_res; / units/mm,
    pub /: *mut *mut u8 y_res; / units/mm,
}

// struct raydium_data - represents state of Raydium touchscreen device
#[repr(C)]
#[derive(Copy, Clone)]
pub struct raydium_data {
    pub client: *mut i2c_client,
    pub input: *mut input_dev,
    pub avdd: *mut regulator,
    pub vccio: *mut regulator,
    pub reset_gpio: *mut gpio_desc,
    pub info: raydium_info,
    pub sysfs_mutex: mutex,
    pub report_data: *mut u8,
    pub data_bank_addr: u32,
    pub report_size: u8,
    pub contact_size: u8,
    pub pkg_size: u8,
    pub boot_mode: enum raydium_boot_mode,
}
...
//
    let mut xfer_start_idx: c_int = (addr > 0xff) ? 0 : 1;
...
//
    ...
    let mut xfer_len: usize = min_t(size_t, len, RM_MAX_READ_SIZE);
//
// Perform as a single i2c_transfer transaction to ensure that
// no other I2C transactions are initiated on the bus to any
// other device in between. Initiating transacations to other
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_sw_reset(client: *mut i2c_client) -> c_int {
    static int raydium_i2c_sw_reset(struct i2c_client *client)
    {
    let mut soft_rst_cmd: u8 = 0x01;
    int error;
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_query_ts_bootloader_info(ts: *mut raydium_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_query_ts_info(ts: *mut raydium_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_check_fw_status(ts: *mut raydium_data) -> c_int {
    static int raydium_i2c_check_fw_status(struct raydium_data *ts)
    {
    struct i2c_client *client = ts.client;
    let mut bl_ack: static u8 = 0x62;
    let mut main_ack: static u8 = 0x66;
    u8 buf[4];
    int error;
...
#[no_mangle]
pub unsafe extern "C" fn if(main_ack: buf[0] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_initialize(ts: *mut raydium_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_boot_trigger(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_fw_trigger(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_check_path(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_enter_bl(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_leave_bl(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_disable_watch_dog(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_calc_chksum(buf: *const u8, len: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_fw_update(ts: *mut raydium_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_mt_event(ts: *mut raydium_data) {
    static void raydium_mt_event(struct raydium_data *ts)
    {
    int i;
    for (i = 0; i < ts.report_size / ts.contact_size; i++) {
    u8 *contact = &ts.report_data[ts.contact_size * i];
    let mut state: bool = contact[RM_CONTACT_STATE_POS];
    u8 wx, wy;
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_irq(irq: c_int, _dev: *mut c_void) -> irqreturn_t {
    ...
    static DEVICE_ATTR(fw_version, S_IRUGO, raydium_i2c_fw_ver_show, core::ptr::null_mut());
    static DEVICE_ATTR(hw_version, S_IRUGO, raydium_i2c_hw_ver_show, core::ptr::null_mut());
    static DEVICE_ATTR(boot_mode, S_IRUGO, raydium_i2c_boot_mode_show, core::ptr::null_mut());
    static DEVICE_ATTR(update_fw, S_IWUSR, core::ptr::null_mut(), raydium_i2c_update_fw_store);
    static DEVICE_ATTR(calibrate, S_IWUSR, core::ptr::null_mut(), raydium_i2c_calibrate_store);
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_power_on(ts: *mut raydium_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_power_off(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_probe(client: *mut i2c_client) -> c_int {
...
// Make sure there is something at this address
    ...
    core::ptr::null_mut(), raydium_i2c_irq,
...
#[no_mangle]
unsafe extern "C" fn raydium_enter_sleep(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raydium_i2c_resume(dev: *mut device) -> c_int {
