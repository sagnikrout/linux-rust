...
//! Source: drivers/input/touchscreen/tps6507x-ts.c
#![no_std]
...
pub const TPS_DEFAULT_MIN_PRESSURE: c_uint = 0x30;
...
#[no_mangle]
unsafe extern "C" fn tps6507x_read_u8(tsc: *mut tps6507x_ts, reg: u8, data: *mut u8) -> c_int {
    static int tps6507x_read_u8(struct tps6507x_ts *tsc, u8 reg, u8 *data)
    {
    return tsc.mfd.read_dev(tsc.mfd, reg, 1, data);
    }
#[no_mangle]
unsafe extern "C" fn tps6507x_write_u8(tsc: *mut tps6507x_ts, reg: u8, data: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tps6507x_adc_standby(tsc: *mut tps6507x_ts) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_ts_poll(input_dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_ts_probe(pdev: *mut platform_device) -> c_int {
