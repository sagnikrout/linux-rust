...
//! Source: drivers/input/touchscreen/hynitron_cstxxx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hynitron_ts_chip_data {
    pub max_touch_num: c_uint,
    pub ic_chkcode: u32,
    pub client): *mut *mut int (firmware_info)(struct i2c_client,
    pub client): *mut *mut int (bootloader_enter)(struct i2c_client,
    pub client): *mut *mut int (init_input)(struct i2c_client,
    pub client): *mut *mut void (report_touch)(struct i2c_client,
}

// Data generic to all (supported and non-supported) controllers.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hynitron_ts_data {
    pub chip: *const hynitron_ts_chip_data,
...
//
pub const CST3XX_FIRMWARE_INFO_START_CMD: c_uint = 0x01d1;
pub const CST3XX_FIRMWARE_INFO_END_CMD: c_uint = 0x09d1;
pub const CST3XX_FIRMWARE_CHK_CODE_REG: c_uint = 0xfcd1;
pub const CST3XX_FIRMWARE_VERSION_REG: c_uint = 0x08d2;
pub const CST3XX_FIRMWARE_VER_INVALID_VAL: c_uint = 0xa5a5a5a5;
pub const CST3XX_BOOTLDR_PROG_CMD: c_uint = 0xaa01a0;
pub const CST3XX_BOOTLDR_PROG_CHK_REG: c_uint = 0x02a0;
pub const CST3XX_BOOTLDR_CHK_VAL: c_uint = 0xac;
pub const CST3XX_TOUCH_DATA_PART_REG: c_uint = 0x00d0;
pub const CST3XX_TOUCH_DATA_FULL_REG: c_uint = 0x07d0;
pub const CST3XX_TOUCH_DATA_CHK_VAL: c_uint = 0xab;
pub const CST3XX_TOUCH_DATA_TOUCH_VAL: c_uint = 0x03;
pub const CST3XX_TOUCH_DATA_STOP_CMD: c_uint = 0xab00d0;
...
//
#[no_mangle]
unsafe extern "C" fn hyn_reset_proc(client: *mut i2c_client, delay: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hyn_interrupt_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    ...
    u8 *val, u16 len)
    {
    let mut buf: __le16 = cpu_to_le16(reg);
    struct i2c_msg msgs[] = {
    {
    .addr = client.addr,
    .flags = 0,
...
#[no_mangle]
unsafe extern "C" fn cst3xx_firmware_info(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cst3xx_bootloader_enter(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cst3xx_finish_touch_read(client: *mut i2c_client) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cst3xx_touch_report(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn cst3xx_input_dev_int(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hyn_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), hyn_interrupt_handler,
    IRQF_ONESHOT,
