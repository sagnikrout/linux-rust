...
//! Source: drivers/input/touchscreen/ti_am335x_tsc.c
#![no_std]
...
pub const ADCFSM_STEPID: c_uint = 0x10;
pub const SEQ_SETTLE: c_int = 275;
...
pub struct titsc {
    ...
    pub irq: c_uint,
    pub wires: c_uint,
    pub x_plate_resistance: c_uint,
    pub pen_down: bool,
    pub coordinate_readouts: c_int,
    pub config_inp: [u32; 4],
    pub bit_yn: u32 bit_xp, bit_xn, bit_yp,,
    pub inp_yn: u32 inp_xp, inp_xn, inp_yp,,
    pub step_mask: u32,
    pub charge_delay: u32,
}

#[no_mangle]
unsafe extern "C" fn titsc_readl(ts: *mut titsc, reg: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn titsc_config_wires(ts_dev: *mut titsc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn titsc_step_config(ts_dev: *mut titsc) {
...
#[no_mangle]
unsafe extern "C" fn titsc_cmp_coord(a: *const c_void, b: *const c_void) -> c_int {
    ...
    let mut creads: c_uint = ts_dev.coordinate_readouts;
    for (i = 0; i < creads; i++) {
...
//
    ...
    titsc_cmp_coord, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn titsc_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t titsc_irq(int irq, void *dev)
    {
    struct titsc *ts_dev = dev;
    struct input_dev *input_dev = ts_dev.input;
    unsigned int fsm, status, irqclr = 0;
    let mut x: c_uint = 0, y = 0;
...
//
#[no_mangle]
unsafe extern "C" fn titsc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn titsc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn titsc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn titsc_resume(dev: *mut device) -> c_int {
