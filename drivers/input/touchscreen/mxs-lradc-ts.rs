...
//! Source: drivers/input/touchscreen/mxs-lradc-ts.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxs_lradc_ts {
    pub lradc: *mut mxs_lradc,
    pub dev: *mut device,
...
//
pub const TOUCHSCREEN_VCHANNEL1: c_int = 7;
pub const TOUCHSCREEN_VCHANNEL2: c_int = 6;
    pub ts_input: *mut input_dev,
    pub /: *mut *mut enum mxs_lradc_ts_plate cur_plate; / state machine,
    pub ts_valid: bool,
    pub ts_x_pos: c_uint,
    pub ts_y_pos: c_uint,
    pub ts_pressure: c_uint,
// handle touchscreen's physical behaviour
// samples per coordinate
    pub over_sample_cnt: c_uint,
// time clocks between samples
    pub over_sample_delay: c_uint,
// time in clocks to wait after the plates where switched
    pub settling_delay: c_uint,
    pub lock: spinlock_t,
}
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_check_touch_event(ts: *mut mxs_lradc_ts) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_setup_ts_channel(ts: *mut mxs_lradc_ts, ch: c_uint) {
...
pub const TS_CH_XP: c_int = 2;
pub const TS_CH_YP: c_int = 3;
pub const TS_CH_XM: c_int = 4;
pub const TS_CH_YM: c_int = 5;
//
// YP(open)--+-------------+
// |		   |--+
// |		   |  |
...
//
#[no_mangle]
unsafe extern "C" fn mxs_lradc_setup_touch_detection(ts: *mut mxs_lradc_ts) {
...
//
#[no_mangle]
unsafe extern "C" fn mxs_lradc_prepare_x_pos(ts: *mut mxs_lradc_ts) {
...
//
#[no_mangle]
unsafe extern "C" fn mxs_lradc_prepare_y_pos(ts: *mut mxs_lradc_ts) {
...
//
#[no_mangle]
unsafe extern "C" fn mxs_lradc_prepare_pressure(ts: *mut mxs_lradc_ts) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_enable_touch_detection(ts: *mut mxs_lradc_ts) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_start_touch_event(ts: *mut mxs_lradc_ts) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_report_ts_event(ts: *mut mxs_lradc_ts) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_complete_touch_event(ts: *mut mxs_lradc_ts) {
...
//
#[no_mangle]
unsafe extern "C" fn mxs_lradc_finish_touch_event(ts: *mut mxs_lradc_ts, valid: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_handle_touch(ts: *mut mxs_lradc_ts) {
...
// IRQ Handling
#[no_mangle]
unsafe extern "C" fn mxs_lradc_ts_handle_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t mxs_lradc_ts_handle_irq(int irq, void *data)
    {
    struct mxs_lradc_ts *ts = data;
    struct mxs_lradc *lradc = ts.lradc;
    let mut reg: c_ulong = readl(ts.base + LRADC_CTRL1);
    let mut clr_irq: u32 = mxs_lradc_irq_mask(lradc);
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_ts_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_ts_stop(ts: *mut mxs_lradc_ts) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_ts_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_ts_hw_init(ts: *mut mxs_lradc_ts) {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_ts_register(ts: *mut mxs_lradc_ts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_lradc_ts_probe(pdev: *mut platform_device) -> c_int {
