...
//! Source: drivers/input/touchscreen/fsl-imx25-tcq.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mx25_tcq_priv {
    pub regs: *mut regmap,
    pub core_regs: *mut regmap,
    pub idev: *mut input_dev,
    pub mode: enum mx25_tcq_mode,
    pub pen_threshold: c_uint,
    pub sample_count: c_uint,
    pub expected_samples: c_uint,
    pub pen_debounce: c_uint,
...
pub const TSC_4WIRE_PRE_INDEX: c_int = 0;
pub const TSC_4WIRE_X_INDEX: c_int = 1;
pub const TSC_4WIRE_Y_INDEX: c_int = 2;
pub const TSC_4WIRE_POST_INDEX: c_int = 3;
pub const TSC_4WIRE_LEAVE: c_int = 4;
pub const MX25_TSC_DEF_THRESHOLD: c_int = 80;
pub const TSC_MAX_SAMPLES: c_int = 16;
pub const MX25_TSC_REPEAT_WAIT: c_int = 14;
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_disable_touch_irq(priv: *mut mx25_tcq_priv) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_enable_touch_irq(priv: *mut mx25_tcq_priv) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_disable_fifo_irq(priv: *mut mx25_tcq_priv) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_enable_fifo_irq(priv: *mut mx25_tcq_priv) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_force_queue_start(priv: *mut mx25_tcq_priv) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_force_queue_stop(priv: *mut mx25_tcq_priv) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_fifo_reset(priv: *mut mx25_tcq_priv) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_re_enable_touch_detection(priv: *mut mx25_tcq_priv) {
...
// lets fire the next IRQ if someone touches the touchscreen
    ...
    {
    let mut x_pos: c_uint = 0;
    let mut y_pos: c_uint = 0;
    let mut touch_pre: c_uint = 0;
    let mut touch_post: c_uint = 0;
    unsigned int i;
    for (i = 0; i < samples; i++) {
    let mut index: c_uint = MX25_ADCQ_FIFO_ID(sample_buf[i]);
    let mut val: c_uint = MX25_ADCQ_FIFO_DATA(sample_buf[i]);
    switch (index) {
    case 1:
    touch_pre = val;
    break;
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_init(priv: *mut mx25_tcq_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_open(idev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_close(idev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tcq_probe(pdev: *mut platform_device) -> c_int {
