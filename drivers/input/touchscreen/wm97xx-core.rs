...
//! Source: drivers/input/touchscreen/wm97xx-core.c
#![no_std]
...
pub const DEFAULT_PRESSURE: c_uint = 0xb0c0;
//
...
//
    ...
    module_param_array(abs_x, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(abs_x, "Touchscreen absolute X min, max, fuzz");
    static int abs_y[3] = {200, 4000, 40};
    module_param_array(abs_y, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(abs_y, "Touchscreen absolute Y min, max, fuzz");
    static int abs_p[3] = {0, 150, 4};
    module_param_array(abs_p, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(abs_p, "Touchscreen absolute Pressure min, max, fuzz");
//
// wm97xx IO access, all IO locking done by AC97 layer
//
#[no_mangle]
pub unsafe extern "C" fn wm97xx_reg_read(wm: *mut wm97xx, reg: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm97xx_reg_write(wm: *mut wm97xx, reg: u16, val: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wm97xx_read_aux_adc(wm: *mut wm97xx, adcsel: u16) -> c_int {
    int wm97xx_read_aux_adc(struct wm97xx *wm, u16 adcsel)
    {
    let mut power_adc: c_int = 0, auxval;
    let mut power: u16 = 0;
    let mut rc: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn wm97xx_get_gpio(wm: *mut wm97xx, gpio: u32) -> enum wm97xx_gpio_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn wm97xx_set_suspend_mode(wm: *mut wm97xx, mode: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn wm97xx_pen_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t wm97xx_pen_interrupt(int irq, void *dev_id)
    {
    struct wm97xx *wm = dev_id;
    let mut pen_was_down: c_int = wm.pen_is_down;
...
//
#[no_mangle]
unsafe extern "C" fn wm97xx_init_pen_irq(wm: *mut wm97xx) -> c_int {
    static int wm97xx_init_pen_irq(struct wm97xx *wm)
    {
    u16 reg;
    if (request_threaded_irq(wm.pen_irq, core::ptr::null_mut(), wm97xx_pen_interrupt,
...
#[no_mangle]
unsafe extern "C" fn wm97xx_read_samples(wm: *mut wm97xx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm97xx_ts_reader(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn wm97xx_ts_input_open(idev: *mut input_dev) -> c_int {
    static int wm97xx_ts_input_open(struct input_dev *idev)
    {
    struct wm97xx *wm = input_get_drvdata(idev);
    wm.ts_workq = alloc_ordered_workqueue("kwm97xx", 0);
    if (wm.ts_workq == core::ptr::null_mut()) {
    dev_err(wm.dev,
...
//
#[no_mangle]
unsafe extern "C" fn wm97xx_ts_input_close(idev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_register_touch(wm: *mut wm97xx) -> c_int {
    ...
    if (wm.input_dev == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn wm97xx_unregister_touch(wm: *mut wm97xx) {
    static void wm97xx_unregister_touch(struct wm97xx *wm)
    {
    platform_device_unregister(wm.touch_dev);
    }
#[no_mangle]
unsafe extern "C" fn _wm97xx_probe(wm: *mut wm97xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_remove_battery(wm: *mut wm97xx) {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_probe(dev: *mut device) -> c_int {
    ...
    if (ret)
    return ret;
    ret = wm97xx_add_battery(wm, pdata ? pdata.batt_pdata : core::ptr::null_mut());
    if (ret < 0)
    goto batt_err;
    return ret;
    batt_err:
...
#[no_mangle]
unsafe extern "C" fn wm97xx_remove(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_mfd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_mfd_remove(pdev: *mut platform_device) {
    static void wm97xx_mfd_remove(struct platform_device *pdev)
    {
    wm97xx_remove(&pdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn wm97xx_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm97xx_unregister_mach_ops(wm: *mut wm97xx) {
    void wm97xx_unregister_mach_ops(struct wm97xx *wm)
    {
    guard(mutex)(&wm.codec_mutex);
    wm.mach_ops = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn wm97xx_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_exit() -> void __exit {
