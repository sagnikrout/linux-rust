...
//! Source: drivers/input/touchscreen/sur40.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sur40_header {
    pub /: *mut *mut __le16 type; / always 0x0001,
    pub /: *mut *mut __le16 count; / count of blobs (if 0: continue prev. packet),
    pub /: *mut *mut __le32 packet_id; / unique ID for all packets in one frame,
    pub /: *mut *mut __le32 timestamp; / milliseconds (inc. by 16 or 17 each frame),
    pub /: *mut *mut __le32 unknown; / "epoch?" always 02/03 00 00 00,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sur40_blob {
    pub blob_id: __le16,
    pub /: *mut *mut u8 action; / 0x02 = enter/exit, 0x03 = update (?),
    pub /: *mut *mut u8 type; / bitmask (0x01 blob, 0x02 touch, 0x04 tag),
    pub /: *mut *mut __le16 bb_pos_x; / upper left corner of bounding box,
    pub bb_pos_y: __le16,
    pub /: *mut *mut __le16 bb_size_x; / size of bounding box,
    pub bb_size_y: __le16,
    pub /: *mut *mut __le16 pos_x; / finger tip position,
    pub pos_y: __le16,
    pub /: *mut *mut __le16 ctr_x; / centroid position,
    pub ctr_y: __le16,
    pub /: *mut *mut __le16 axis_x; / somehow related to major/minor axis, mostly:,
    pub /: *mut *mut __le16 axis_y; / axis_x == bb_size_y && axis_y == bb_size_x,
    pub -: *mut *mut __le32 angle; / orientation in radians relative to x axis,
    actually an IEEE754 float, don't use in kernel */
    pub /: *mut *mut __le32 area; / size in pixels/pressure (?),
    pub padding: [u8; 24],
    pub /: *mut *mut __le32 tag_id; / valid when type == 0x04 (SUR40_TAG),
    pub unknown: __le32,
    pub __packed: },
// combined header/blob data
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sur40_data {
    pub header: sur40_header,
    pub blobs: [sur40_blob; ],
    pub __packed: },
// read 512 bytes from endpoint 0x82 -> get header below
// continue reading 16k blocks until header.size bytes read
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sur40_image_header {
    pub /: *mut *mut __le32 magic; / "SUBF",
    pub packet_id: __le32,
    pub /: *mut *mut __le32 size; / always 0x0007e900 = 960x540,
    pub /: *mut *mut __le32 timestamp; / milliseconds (increases by 16 or 17 each frame),
    pub /: *mut *mut __le32 unknown; / "epoch?" always 02/03 00 00 00,
    pub __packed: },
// version information

// vendor and device IDs
pub const ID_MICROSOFT: c_uint = 0x045e;
pub const ID_SUR40: c_uint = 0x0775;
// sensor resolution
pub const SENSOR_RES_X: c_int = 1920;
pub const SENSOR_RES_Y: c_int = 1080;
// touch data endpoint
pub const TOUCH_ENDPOINT: c_uint = 0x86;
// video data endpoint
pub const VIDEO_ENDPOINT: c_uint = 0x82;
// video header fields
pub const VIDEO_HEADER_MAGIC: c_uint = 0x46425553;
pub const VIDEO_PACKET_SIZE: c_int = 16384;
// polling interval (ms)
pub const POLL_INTERVAL: c_int = 1;
// maximum number of contacts
pub const MAX_CONTACTS: c_int = 52;
// control commands
pub const SUR40_GET_VERSION: c_uint = 0xb0 /* 12 bytes string    */;
pub const SUR40_ACCEL_CAPS: c_uint = 0xb3 /*  5 bytes           */;
pub const SUR40_SENSOR_CAPS: c_uint = 0xc1 /* 24 bytes           */;
pub const SUR40_POKE: c_uint = 0xc5 /* poke register byte */;
pub const SUR40_PEEK: c_uint = 0xc4 /* 48 bytes registers */;
pub const SUR40_GET_STATE: c_uint = 0xc5 /*  4 bytes state (?) */;
pub const SUR40_GET_SENSORS: c_uint = 0xb1 /*  8 bytes sensors   */;
pub const SUR40_BLOB: c_uint = 0x01;
pub const SUR40_TOUCH: c_uint = 0x02;
pub const SUR40_TAG: c_uint = 0x04;
// video controls
pub const SUR40_BRIGHTNESS_MAX: c_uint = 0xff;
pub const SUR40_BRIGHTNESS_MIN: c_uint = 0x00;
pub const SUR40_BRIGHTNESS_DEF: c_uint = 0xff;
pub const SUR40_CONTRAST_MAX: c_uint = 0x0f;
pub const SUR40_CONTRAST_MIN: c_uint = 0x00;
pub const SUR40_CONTRAST_DEF: c_uint = 0x0a;
pub const SUR40_GAIN_MAX: c_uint = 0x09;
pub const SUR40_GAIN_MIN: c_uint = 0x00;
pub const SUR40_GAIN_DEF: c_uint = 0x08;
pub const SUR40_BACKLIGHT_MAX: c_uint = 0x01;
pub const SUR40_BACKLIGHT_MIN: c_uint = 0x00;
pub const SUR40_BACKLIGHT_DEF: c_uint = 0x01;

// module parameters
    pub SUR40_BRIGHTNESS_DEF: static uint brightness =,
    pub 0644): module_param(brightness, uint,,
    MODULE_PARM_DESC(brightness, "set initial brightness"
    pub SUR40_BRIGHTNESS_MAX)): SUR40_PARAM_RANGE(SUR40_BRIGHTNESS_MIN,,
    pub SUR40_CONTRAST_DEF: static uint contrast =,
    pub 0644): module_param(contrast, uint,,
    MODULE_PARM_DESC(contrast, "set initial contrast"
    pub SUR40_CONTRAST_MAX)): SUR40_PARAM_RANGE(SUR40_CONTRAST_MIN,,
    pub SUR40_GAIN_DEF: static uint gain =,
    pub 0644): module_param(gain, uint,,
    MODULE_PARM_DESC(gain, "set initial gain"
    pub SUR40_GAIN_MAX)): SUR40_PARAM_RANGE(SUR40_GAIN_MIN,,
...
pub struct sur40_state {
    ...
    pub sequence: c_int,
    pub bulk_in_buffer: *mut sur40_data,
    pub bulk_in_size: usize,
    pub bulk_in_epaddr: u8,
    pub vsvideo: u8,
    pub phys: [c_char; 64],
}
...
#[no_mangle]
unsafe extern "C" fn sur40_poke(dev: *mut sur40_state, offset: u8, value: u8) -> c_int {
    ...
    0x32, index, core::ptr::null_mut(), 0, 1000);
    if (result < 0)
    goto error;
    msleep(5);
    result = usb_control_msg(dev.usbdev, usb_sndctrlpipe(dev.usbdev, 0),
    SUR40_POKE, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_DIR_OUT,
    0x72, offset, core::ptr::null_mut(), 0, 1000);
    if (result < 0)
    goto error;
    msleep(5);
    result = usb_control_msg(dev.usbdev, usb_sndctrlpipe(dev.usbdev, 0),
    SUR40_POKE, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_DIR_OUT,
    0xb2, value, core::ptr::null_mut(), 0, 1000);
    if (result < 0)
    goto error;
    msleep(5);
    error:
...
#[no_mangle]
unsafe extern "C" fn sur40_set_preprocessor(dev: *mut sur40_state, value: u8) -> c_int {
    ...
    result = usb_control_msg(dev.usbdev, usb_sndctrlpipe(dev.usbdev, 0),
    SUR40_POKE, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_DIR_OUT,
    0x07, setting_07[value], core::ptr::null_mut(), 0, 1000);
    if (result < 0)
    goto error;
    msleep(5);
    result = usb_control_msg(dev.usbdev, usb_sndctrlpipe(dev.usbdev, 0),
    SUR40_POKE, USB_TYPE_VENDOR | USB_RECIP_DEVICE | USB_DIR_OUT,
    0x17, setting_17[value], core::ptr::null_mut(), 0, 1000);
    if (result < 0)
    goto error;
    msleep(5);
    error:
...
#[no_mangle]
unsafe extern "C" fn sur40_set_vsvideo(handle: *mut sur40_state, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn sur40_set_irlevel(handle: *mut sur40_state, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn sur40_init(dev: *mut sur40_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sur40_open(input: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sur40_close(input: *mut input_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn sur40_report_blob(blob: *mut sur40_blob, input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn sur40_poll(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn sur40_process_video(sur40: *mut sur40_state) {
    static void sur40_process_video(struct sur40_state *sur40)
    {
...
#[no_mangle]
unsafe extern "C" fn sur40_input_setup_events(input_dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sur40_disconnect(interface: *mut usb_interface) {
...
//
#[no_mangle]
unsafe extern "C" fn sur40_buffer_prepare(vb: *mut vb2_buffer) -> c_int {
    static int sur40_buffer_prepare(struct vb2_buffer *vb)
    {
    struct sur40_state *sur40 = vb2_get_drv_priv(vb.vb2_queue);
    let mut size: c_ulong = sur40.pix_fmt.sizeimage;
...
//
#[no_mangle]
unsafe extern "C" fn sur40_buffer_queue(vb: *mut vb2_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn sur40_start_streaming(vq: *mut vb2_queue, count: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sur40_stop_streaming(vq: *mut vb2_queue) {
...
#[no_mangle]
unsafe extern "C" fn sur40_vidioc_s_input(file: *mut file, priv: *mut c_void, i: c_uint) -> c_int {
    static int sur40_vidioc_s_input(struct file *file, void *priv, unsigned int i)
    {
    return (i == 0) ? 0 : -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn sur40_vidioc_g_input(file: *mut file, priv: *mut c_void, i: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sur40_s_ctrl(ctrl: *mut v4l2_ctrl) -> c_int {
    static int sur40_s_ctrl(struct v4l2_ctrl *ctrl)
    {
    struct sur40_state *sur40  = container_of(ctrl.handler,
    struct sur40_state, hdl);
    let mut value: u8 = sur40.vsvideo;
    switch (ctrl.id) {
