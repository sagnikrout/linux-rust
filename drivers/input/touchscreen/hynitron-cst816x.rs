...
//! Source: drivers/input/touchscreen/hynitron-cst816x.c
#![no_std]
...
pub const CST816X_RD_REG: c_uint = 0x01;
pub const CST816X_NUM_KEYS: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cst816x_touch {
    pub gest: u8,
    pub active: u8,
    pub abs_x: u16,
    pub abs_y: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cst816x_priv {
    pub client: *mut i2c_client,
    pub reset: *mut gpio_desc,
    pub input: *mut input_dev,
    pub keycode: [c_uint; CST816X_NUM_KEYS],
    pub keycodemax: c_uint,
}

#[no_mangle]
unsafe extern "C" fn cst816x_parse_keycodes(dev: *mut device, priv: *mut cst816x_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cst816x_gest_idx(gest: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn cst816x_register_input(priv: *mut cst816x_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cst816x_reset(priv: *mut cst816x_priv) {
...
#[no_mangle]
unsafe extern "C" fn cst816x_irq_cb(irq: c_int, cookie: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cst816x_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), cst816x_irq_cb, IRQF_ONESHOT,
