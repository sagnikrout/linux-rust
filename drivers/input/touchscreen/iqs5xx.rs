...
//! Source: drivers/input/touchscreen/iqs5xx.c
#![no_std]
...
pub const IQS5XX_FW_FILE_LEN: c_int = 64;
pub const IQS5XX_NUM_RETRIES: c_int = 10;
pub const IQS5XX_NUM_CONTACTS: c_int = 5;
pub const IQS5XX_WR_BYTES_MAX: c_int = 2;
pub const IQS5XX_PROD_NUM_IQS550: c_int = 40;
pub const IQS5XX_PROD_NUM_IQS572: c_int = 58;
pub const IQS5XX_PROD_NUM_IQS525: c_int = 52;

pub const IQS5XX_RESUME: c_int = 0;

pub const IQS5XX_PROD_NUM: c_uint = 0x0000;
pub const IQS5XX_SYS_INFO0: c_uint = 0x000F;
pub const IQS5XX_SYS_INFO1: c_uint = 0x0010;
pub const IQS5XX_SYS_CTRL0: c_uint = 0x0431;
pub const IQS5XX_SYS_CTRL1: c_uint = 0x0432;
pub const IQS5XX_SYS_CFG0: c_uint = 0x058E;
pub const IQS5XX_SYS_CFG1: c_uint = 0x058F;
pub const IQS5XX_X_RES: c_uint = 0x066E;
pub const IQS5XX_Y_RES: c_uint = 0x0670;
pub const IQS5XX_EXP_FILE: c_uint = 0x0677;
pub const IQS5XX_CHKSM: c_uint = 0x83C0;
pub const IQS5XX_APP: c_uint = 0x8400;
pub const IQS5XX_CSTM: c_uint = 0xBE00;
pub const IQS5XX_PMAP_END: c_uint = 0xBFFF;
pub const IQS5XX_END_COMM: c_uint = 0xEEEE;

// Length of firmware header in hexadecimal characters

    4 /* addr */ + 2 /* type */)

pub const IQS5XX_REC_TYPE_DATA: c_uint = 0x00;
pub const IQS5XX_REC_TYPE_EOF: c_uint = 0x01;
pub const IQS5XX_BL_ADDR_MASK: c_uint = 0x40;
pub const IQS5XX_BL_CMD_VER: c_uint = 0x00;
pub const IQS5XX_BL_CMD_READ: c_uint = 0x01;
pub const IQS5XX_BL_CMD_EXEC: c_uint = 0x02;
pub const IQS5XX_BL_CMD_CRC: c_uint = 0x03;
pub const IQS5XX_BL_BLK_LEN_MAX: c_int = 64;
pub const IQS5XX_BL_ID: c_uint = 0x0200;
pub const IQS5XX_BL_STATUS_NONE: c_uint = 0xEE;
pub const IQS5XX_BL_CRC_PASS: c_uint = 0x00;
pub const IQS5XX_BL_CRC_FAIL: c_uint = 0x01;
pub const IQS5XX_BL_ATTEMPTS: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs5xx_dev_id_info {
    pub prod_num: __be16,
    pub proj_num: __be16,
    pub major_ver: u8,
    pub minor_ver: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs5xx_status {
    pub sys_info: [u8; 2],
    pub num_active: u8,
    pub rel_x: __be16,
    pub rel_y: __be16,
    pub touch_data: [iqs5xx_touch_data; IQS5XX_NUM_CONTACTS],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iqs5xx_private {
    pub client: *mut i2c_client,
    pub input: *mut input_dev,
    pub reset_gpio: *mut gpio_desc,
    pub prop: touchscreen_properties,
    pub lock: mutex,
    pub dev_id_info: iqs5xx_dev_id_info,
    pub exp_file: [u8; 2],
}
    ...
    {
    let mut reg_buf: __be16 = cpu_to_be16(reg);
    int ret, i;
    struct i2c_msg msg[] = {
    {
    .addr = client.addr,
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_read_word(client: *mut i2c_client, reg: u16, val: *mut u16) -> c_int {
...
// val = be16_to_cpu(val_buf);
    ...
    {
    int ret, i;
    let mut mlen: u16 = sizeof(reg) + len;
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_write_word(client: *mut i2c_client, reg: u16, val: u16) -> c_int {
    static int iqs5xx_write_word(struct i2c_client *client, u16 reg, u16 val)
    {
    let mut val_buf: __be16 = cpu_to_be16(val);
    return iqs5xx_write_burst(client, reg, &val_buf, sizeof(val_buf));
    }
#[no_mangle]
unsafe extern "C" fn iqs5xx_write_byte(client: *mut i2c_client, reg: u16, val: u8) -> c_int {
    static int iqs5xx_write_byte(struct i2c_client *client, u16 reg, u8 val)
    {
    return iqs5xx_write_burst(client, reg, &val, sizeof(val));
    }
#[no_mangle]
unsafe extern "C" fn iqs5xx_reset(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_bl_cmd(client: *mut i2c_client, bl_cmd: u8, bl_addr: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_bl_open(client: *mut i2c_client) -> c_int {
...
//
    ...
    usleep_range(10000, 10100);
#[no_mangle]
pub unsafe extern "C" fn if(-EINVAL: error !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_set_state(client: *mut i2c_client, state: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_open(input: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_close(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_axis_init(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_dev_init(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    let mut pressure: u16 = be16_to_cpu(touch_data.strength);
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_update_firmware(iqs5xx: *mut iqs5xx_private, pmap: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_fw_file_write(client: *mut i2c_client, fw_file: *const c_char) -> c_int {
...
//
    ...
    let mut input_reg: bool = !iqs5xx.input;
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iqs5xx_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), iqs5xx_irq, IRQF_ONESHOT,
    client.name, iqs5xx);
    if (error) {
