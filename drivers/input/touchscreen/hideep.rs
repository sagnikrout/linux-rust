...
//! Source: drivers/input/touchscreen/hideep.c
#![no_std]
...
pub const HIDEEP_MT_MAX: c_int = 10;
pub const HIDEEP_KEY_MAX: c_int = 3;
// count(2) + touch data(100) + key data(6)

pub const HIDEEP_TOUCH_EVENT_INDEX: c_int = 2;
pub const HIDEEP_KEY_EVENT_INDEX: c_int = 102;
// Touch & key event
pub const HIDEEP_EVENT_ADDR: c_uint = 0x240;
// command list
pub const HIDEEP_WORK_MODE: c_uint = 0x081e;
pub const HIDEEP_RESET_CMD: c_uint = 0x9800;
// event bit

    HIDEEP_KEY_FIRST_PRESSED)
pub const HIDEEP_KEY_IDX_MASK: c_uint = 0x0f;
// For NVM
pub const HIDEEP_YRAM_BASE: c_uint = 0x40000000;
pub const HIDEEP_PERIPHERAL_BASE: c_uint = 0x50000000;

pub const HIDEEP_PERASE: c_uint = 0x00040000;
pub const HIDEEP_WRONLY: c_uint = 0x00100000;
pub const HIDEEP_NVM_MASK_OFS: c_uint = 0x0000000C;
pub const HIDEEP_NVM_DEFAULT_PAGE: c_int = 0;
pub const HIDEEP_NVM_SFR_WPAGE: c_int = 1;
pub const HIDEEP_NVM_SFR_RPAGE: c_int = 2;
pub const HIDEEP_PIO_SIG: c_uint = 0x00400000;
pub const HIDEEP_PROT_MODE: c_uint = 0x03400000;
pub const HIDEEP_NVM_PAGE_SIZE: c_int = 128;
pub const HIDEEP_DWZ_INFO: c_uint = 0x000002C0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hideep_event {
    pub x: __le16,
    pub y: __le16,
    pub z: __le16,
    pub w: u8,
...
#[derive(Copy, Clone)]
pub struct dwz_info {
    pub code_start: __be32,
    pub code_crc: [u8; 12],
    pub c_code_start: __be32,
    pub gen_ver: __be16,
    pub c_code_len: __be16,
    pub vr_start: __be32,
    pub rsv0: __be16,
    pub vr_len: __be16,
    pub ft_start: __be32,
    pub vr_version: __be16,
    pub ft_len: __be16,
    pub core_ver: __be16,
    pub boot_ver: __be16,
    pub release_ver: __be16,
    pub custom_ver: __be16,
    pub factory_id: u8,
    pub panel_type: u8,
    pub model_name: [u8; 6],
    pub extra_option: __be16,
    pub product_code: __be16,
    pub vendor_id: __be16,
    pub product_id: __be16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pgm_packet {
    struct {
    pub unused: [u8; 3],
    pub len: u8,
    pub addr: __be32,
    pub header: },
    pub sizeof(__be32)]: __be32 payload[HIDEEP_NVM_PAGE_SIZE /,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hideep_ts {
    pub client: *mut i2c_client,
    pub input_dev: *mut input_dev,
    pub reg: *mut regmap,
    pub prop: touchscreen_properties,
    pub reset_gpio: *mut gpio_desc,
    pub vcc_vdd: *mut regulator,
    pub vcc_vid: *mut regulator,
    pub dev_mutex: mutex,
    pub tch_count: u32,
    pub lpm_count: u32,
//
...
// packet aligned.
//
    pub __aligned(4): u8 xfer_buf[HIDEEP_XFER_BUF_SIZE],
    pub key_num: c_int,
    pub key_codes: [u32; HIDEEP_KEY_MAX],
    pub dwz_info: dwz_info,
    pub fw_size: c_uint,
    pub nvm_mask: u32,
}
    ...
    let mut len: usize = count * sizeof(*data);
    struct i2c_msg msg = {
    .addr	= ts.client.addr,
...
#[no_mangle]
unsafe extern "C" fn hideep_pgm_r_reg(ts: *mut hideep_ts, addr: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hideep_pgm_w_reg(ts: *mut hideep_ts, addr: u32, val: u32) -> c_int {
    static int hideep_pgm_w_reg(struct hideep_ts *ts, u32 addr, u32 val)
    {
    let mut data: __be32 = cpu_to_be32(val);
    int error;
...
#[no_mangle]
unsafe extern "C" fn hideep_pgm_set(ts: *mut hideep_ts) {
...
#[no_mangle]
unsafe extern "C" fn hideep_pgm_get_pattern(ts: *mut hideep_ts, pattern: *mut u32) -> c_int {
    static int hideep_pgm_get_pattern(struct hideep_ts *ts, u32 *pattern)
    {
    let mut p1: u16 = 0xAF39;
    let mut p2: u16 = 0xDF9D;
    int error;
...
#[no_mangle]
unsafe extern "C" fn hideep_enter_pgm(ts: *mut hideep_ts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hideep_nvm_unlock(ts: *mut hideep_ts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hideep_check_status(ts: *mut hideep_ts) -> c_int {
    static int hideep_check_status(struct hideep_ts *ts)
    {
    let mut time_out: c_int = 100;
    int status;
    int error;
    while (time_out--) {
...
#[no_mangle]
unsafe extern "C" fn hideep_load_dwz(ts: *mut hideep_ts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hideep_power_on(ts: *mut hideep_ts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hideep_power_off(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hideep_parse_and_report(ts: *mut hideep_ts) {
    ...
    let mut touch_count: c_int = ts.xfer_buf[0];
    let mut key_count: c_int = ts.xfer_buf[1] & 0x0f;
    let mut lpm_count: c_int = ts.xfer_buf[1] & 0xf0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn hideep_irq(irq: c_int, handle: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hideep_get_axis_info(ts: *mut hideep_ts) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hideep_init_input(ts: *mut hideep_ts) -> c_int {
    ...
    static DEVICE_ATTR(version, 0664, hideep_fw_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(product_id, 0664, hideep_product_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(update_fw, 0664, core::ptr::null_mut(), hideep_update_fw);
...
#[no_mangle]
unsafe extern "C" fn hideep_set_work_mode(ts: *mut hideep_ts) {
...
#[no_mangle]
unsafe extern "C" fn hideep_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hideep_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hideep_probe(client: *mut i2c_client) -> c_int {
...
// check i2c bus
    ...
    core::ptr::null_mut(), hideep_irq, IRQF_ONESHOT,
    client.name, ts);
    if (error) {
