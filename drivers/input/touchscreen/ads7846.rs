...
//! Source: drivers/input/touchscreen/ads7846.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads7846_buf {
    pub cmd: u8,
    pub data: __be16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads7846_buf_layout {
    pub offset: c_uint,
    pub count: c_uint,
    pub skip: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads7846_packet {
    pub count: c_uint,
    pub count_skip: c_uint,
    pub cmds: c_uint,
    pub last_cmd_idx: c_uint,
    pub l: [ads7846_buf_layout; 5],
    pub rx: *mut ads7846_buf,
    pub tx: *mut ads7846_buf,
    pub pwrdown_cmd: ads7846_buf,
    pub ignore: bool,
    pub z2: u16 x, y, z1,,
}
...
pub struct ads7846 {
    ...
    pub packet: *mut ads7846_packet,
    pub xfer: [spi_transfer; 18],
    pub msg: [spi_message; 5],
    pub msg_count: c_int,
    ...
    pub read_rep: c_int,
    pub last_read: c_int,
    pub debounce_max: u16,
    pub debounce_tol: u16,
    pub debounce_rep: u16,
    pub penirq_recheck_delay_usecs: u16,
    pub core_prop: touchscreen_properties,
    pub lock: mutex,
    pub /: *mut *mut bool stopped; / P: lock,
    pub /: *mut *mut bool disabled; / P: lock,
    pub /: *mut *mut bool suspended; / P: lock,
    int			(*setup_spi_msg)(struct ads7846 *ts,
    pub pdata): *const ads7846_platform_data,
    pub ts): *mut *mut void (read_state)(struct ads7846,
    pub val): *mut *mut *mut int (filter)(void data, int data_idx, int,
    pub filter_data: *mut c_void,
    pub (*get_pendown_state)(void): *mut c_int,
    pub gpio_pendown: *mut gpio_desc,
    pub gpio_hsync: *mut gpio_desc,
...
#[no_mangle]
unsafe extern "C" fn get_pendown_state(ts: *mut ads7846) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7846_report_pen_up(ts: *mut ads7846) {
...
#[no_mangle]
unsafe extern "C" fn ads7846_stop(ts: *mut ads7846) {
...
// Must be called with ts->lock held
#[no_mangle]
unsafe extern "C" fn ads7846_restart(ts: *mut ads7846) {
...
// Must be called with ts->lock held
#[no_mangle]
unsafe extern "C" fn __ads7846_disable(ts: *mut ads7846) {
...
// Must be called with ts->lock held
#[no_mangle]
unsafe extern "C" fn __ads7846_enable(ts: *mut ads7846) {
...
#[no_mangle]
unsafe extern "C" fn ads7846_disable(ts: *mut ads7846) {
...
#[no_mangle]
unsafe extern "C" fn ads7846_enable(ts: *mut ads7846) {
...
pub struct ser_req {
    ...
    pub ref_off: u8,
    pub msg: spi_message,
    pub xfer: [spi_transfer; 8],
//
// DMA (thus cache coherency maintenance) requires the
// transfer buffers to live in their own cache lines.
//
    pub ____cacheline_aligned: __be16 sample,
    pub scratch: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ads7845_ser_req {
    pub command: [u8; 3],
    pub msg: spi_message,
...
// transfer buffers to live in their own cache lines.
//
    pub ____cacheline_aligned: u8 sample[3],
}

#[no_mangle]
unsafe extern "C" fn ads7846_read12_ser(dev: *mut device, command: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7845_read12_ser(dev: *mut device, command: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn null_adjust(ts: *mut ads7846, v: isize) -> unsigned {
...
//
#[no_mangle]
pub unsafe extern "C" fn vaux_adjust(ts: *mut ads7846, v: isize) -> unsigned {
    static inline unsigned vaux_adjust(struct ads7846 *ts, ssize_t v)
    {
    let mut retval: unsigned = v;
...
#[no_mangle]
pub unsafe extern "C" fn vbatt_adjust(ts: *mut ads7846, v: isize) -> unsigned {
    static inline unsigned vbatt_adjust(struct ads7846 *ts, ssize_t v)
    {
    let mut retval: unsigned = vaux_adjust(ts, v);
...
#[no_mangle]
unsafe extern "C" fn ads784x_hwmon_register(spi: *mut spi_device, ts: *mut ads7846) -> c_int {
...
// hwmon sensors need a reference voltage
    ...
    static DEVICE_ATTR(pen_down, S_IRUGO, ads7846_pen_down_show, core::ptr::null_mut());
...
// --------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ads7846_debounce_filter(ads: *mut c_void, data_idx: c_int, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7846_no_filter(ads: *mut c_void, data_idx: c_int, val: *mut c_int) -> c_int {
    static int ads7846_no_filter(void *ads, int data_idx, int *val)
    {
    return ADS7846_FILTER_OK;
    }
#[no_mangle]
unsafe extern "C" fn ads7846_get_value(buf: *mut ads7846_buf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7846_get_cmd(cmd_idx: enum ads7846_cmds, vref: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ads7846_cmd_need_settle(cmd_idx: enum ads7846_cmds) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ads7846_filter(ts: *mut ads7846) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7846_filter_one(ts: *mut ads7846, cmd_idx: c_uint) -> c_int {
    ...
    return -EAGAIN;
#[no_mangle]
pub unsafe extern "C" fn if(ADS7846_FILTER_OK: action !=) -> else {
    else if (action != ADS7846_FILTER_OK)
    return -EIO;
    ads7846_set_cmd_val(ts, cmd_idx, val);
    return 0;
...
#[no_mangle]
unsafe extern "C" fn ads7846_wait_for_hsync(ts: *mut ads7846) {
...
#[no_mangle]
unsafe extern "C" fn ads7846_halfd_read_state(ts: *mut ads7846) {
    static void ads7846_halfd_read_state(struct ads7846 *ts)
    {
    struct ads7846_packet *packet = ts.packet;
    let mut msg_idx: c_int = 0;
    packet.ignore = false;
...
#[no_mangle]
unsafe extern "C" fn ads7846_read_state(ts: *mut ads7846) {
...
#[no_mangle]
unsafe extern "C" fn ads7846_report_state(ts: *mut ads7846) {
...
#[no_mangle]
unsafe extern "C" fn ads7846_hard_irq(irq: c_int, handle: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads7846_irq(irq: c_int, handle: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ads7846_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7846_resume(dev: *mut device) -> c_int {
...
//
    ...
    struct ads7846_packet *packet = ts.packet;
    let mut vref: c_int = pdata.keep_vref_on;
...
#[no_mangle]
unsafe extern "C" fn ads7846_regulator_disable(regulator: *mut c_void) {
    static void ads7846_regulator_disable(void *regulator)
    {
    regulator_disable(regulator);
    }
#[no_mangle]
unsafe extern "C" fn ads7846_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ads7846_remove(spi: *mut spi_device) {
