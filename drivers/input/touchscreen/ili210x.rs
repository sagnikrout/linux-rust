...
//! Source: drivers/input/touchscreen/ili210x.c
#![no_std]
...
pub const ILI2XXX_POLL_PERIOD: c_int = 15;
pub const ILI210X_DATA_SIZE: c_int = 64;
pub const ILI211X_DATA_SIZE: c_int = 43;
pub const ILI251X_DATA_SIZE1: c_int = 31;
pub const ILI251X_DATA_SIZE2: c_int = 20;
// Touchscreen commands
pub const REG_TOUCHDATA: c_uint = 0x10;
pub const REG_PANEL_INFO: c_uint = 0x20;
pub const REG_FIRMWARE_VERSION: c_uint = 0x40;
pub const REG_PROTOCOL_VERSION: c_uint = 0x42;
pub const REG_KERNEL_VERSION: c_uint = 0x61;
pub const REG_IC_BUSY: c_uint = 0x80;
pub const REG_IC_BUSY_NOT_BUSY: c_uint = 0x50;
pub const REG_GET_MODE: c_uint = 0xc0;
pub const REG_GET_MODE_AP: c_uint = 0x5a;
pub const REG_GET_MODE_BL: c_uint = 0x55;
pub const REG_SET_MODE_AP: c_uint = 0xc1;
pub const REG_SET_MODE_BL: c_uint = 0xc2;
pub const REG_WRITE_DATA: c_uint = 0xc3;
pub const REG_WRITE_ENABLE: c_uint = 0xc4;
pub const REG_READ_DATA_CRC: c_uint = 0xc7;
pub const REG_CALIBRATE: c_uint = 0xcc;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ili2xxx_chip {
    int (*read_reg)(struct i2c_client *client, u8 reg,
    pub len): *mut *mut void buf, size_t,
    pub data): *mut *mut *mut int (get_touch_data)(struct i2c_client client, u8,
    bool (*parse_touch_data)(const u8 *data, unsigned int finger,
    unsigned int *x, unsigned int *y,
    pub z): *mut c_uint,
    pub touch): *const *const *const bool (continue_polling)(u8 data, bool,
    pub max_touches: c_uint,
    pub resolution: c_uint,
    pub has_calibrate_reg: bool,
    pub has_firmware_proto: bool,
    pub has_pressure_reg: bool,
}
...
pub struct ili210x {
    ...
    pub chip: *const ili2xxx_chip,
    pub version_firmware: [u8; 8],
    pub version_kernel: [u8; 5],
    pub version_proto: [u8; 2],
    pub ic_mode: [u8; 2],
    pub stop: bool,
}
...
#[no_mangle]
unsafe extern "C" fn ili210x_read_touch_data(client: *mut i2c_client, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili210x_check_continue_polling(data: *const u8, touch: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ili211x_read_touch_data(client: *mut i2c_client, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili211x_decline_polling(data: *const u8, touch: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ili212x_check_continue_polling(data: *const u8, touch: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ili251x_read_touch_data(client: *mut i2c_client, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili251x_check_continue_polling(data: *const u8, touch: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ili210x_report_events(priv: *mut ili210x, touchdata: *mut u8) -> bool {
    static bool ili210x_report_events(struct ili210x *priv, u8 *touchdata)
    {
    struct input_dev *input = priv.input;
    int i;
    let mut contact: bool = false, touch;
    let mut x: c_uint = 0, y = 0, z = 0;
...
#[no_mangle]
unsafe extern "C" fn ili210x_process_events(priv: *mut ili210x) {
...
#[no_mangle]
unsafe extern "C" fn ili210x_irq(irq: c_int, irq_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ili210x_work_i2c_poll(input: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn ili251x_firmware_update_resolution(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili251x_firmware_update_firmware_version(dev: *mut device) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ili251x_firmware_update_kernel_version(dev: *mut device) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ili251x_firmware_update_protocol_version(dev: *mut device) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ili251x_firmware_update_ic_mode(dev: *mut device) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ili251x_firmware_update_cached_state(dev: *mut device) -> c_int {
...
// Firmware does report valid information.
    ...
    static DEVICE_ATTR(firmware_version, 0444, ili251x_firmware_version_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(kernel_version, 0444, ili251x_kernel_version_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(protocol_version, 0444, ili251x_protocol_version_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(mode, 0444, ili251x_mode_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(calibrate, S_IWUSR, core::ptr::null_mut(), ili210x_calibrate);
...
#[no_mangle]
unsafe extern "C" fn ili251x_switch_ic_mode(client: *mut i2c_client, cmd_mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili251x_firmware_busy(client: *mut i2c_client) -> c_int {
...
// The read_reg already contains suitable delay
    ...
    struct i2c_client *client = to_i2c_client(dev);
    struct ili210x *priv = i2c_get_clientdata(client);
    let mut cmd_crc: u8 = REG_READ_DATA_CRC;
    u8 crcrb[4] = { 0 };
    u8 fw_data[33];
    u16 fw_addr;
    int error;
...
#[no_mangle]
unsafe extern "C" fn ili251x_firmware_reset(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ili210x_hardware_reset(reset_gpio: *mut gpio_desc) {
...
//
    ...
    static DEVICE_ATTR(firmware_update, 0200, core::ptr::null_mut(), ili210x_firmware_update_store);
...
#[no_mangle]
unsafe extern "C" fn ili210x_power_down(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ili210x_stop(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ili210x_i2c_probe(client: *mut i2c_client) -> c_int {
...
// Multi touch
    ...
    if (client.irq > 0) {
    error = devm_request_threaded_irq(dev, client.irq, core::ptr::null_mut(), ili210x_irq,
