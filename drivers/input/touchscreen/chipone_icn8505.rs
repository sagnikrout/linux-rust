...
//! Source: drivers/input/touchscreen/chipone_icn8505.c
#![no_std]
...
pub const ICN8505_REG_ADDR_WIDTH: c_int = 16;
pub const ICN8505_REG_POWER: c_uint = 0x0004;
pub const ICN8505_REG_TOUCHDATA: c_uint = 0x1000;
pub const ICN8505_REG_CONFIGDATA: c_uint = 0x8000;
// ICN8505_REG_POWER commands
pub const ICN8505_POWER_ACTIVE: c_uint = 0x00;
pub const ICN8505_POWER_MONITOR: c_uint = 0x01;
pub const ICN8505_POWER_HIBERNATE: c_uint = 0x02;
//
...
//
pub const ICN8505_POWER_ENA_CHARGER_MODE: c_uint = 0x55;
pub const ICN8505_POWER_DIS_CHARGER_MODE: c_uint = 0x66;
pub const ICN8505_MAX_TOUCHES: c_int = 10;
// Programming mode defines
pub const ICN8505_PROG_I2C_ADDR: c_uint = 0x30;
pub const ICN8505_PROG_REG_ADDR_WIDTH: c_int = 24;
pub const MAX_FW_UPLOAD_TRIES: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icn8505_touch {
    pub slot: u8,
    pub x: [u8; 2],
    pub y: [u8; 2],
    pub /: *mut *mut u8 pressure; / Seems more like finger width then pressure really,
    pub event: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icn8505_touch_data {
    pub softbutton: u8,
    pub touch_count: u8,
    pub touches: [icn8505_touch; ICN8505_MAX_TOUCHES],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icn8505_data {
...
#[no_mangle]
unsafe extern "C" fn icn8505_read_reg_silent(icn8505: *mut icn8505_data, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icn8505_write_reg(icn8505: *mut icn8505_data, reg: c_int, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icn8505_write_prog_reg(icn8505: *mut icn8505_data, reg: c_int, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icn8505_upload_fw(icn8505: *mut icn8505_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icn8505_touch_active(event: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn icn8505_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    let mut act: bool = icn8505_touch_active(touch.event);
...
#[no_mangle]
unsafe extern "C" fn icn8505_probe_acpi(icn8505: *mut icn8505_data, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icn8505_probe(client: *mut i2c_client) -> c_int {
    ...
    if (error)
    return error;
    error = devm_request_threaded_irq(dev, client.irq, core::ptr::null_mut(), icn8505_irq,
...
#[no_mangle]
unsafe extern "C" fn icn8505_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icn8505_resume(dev: *mut device) -> c_int {
