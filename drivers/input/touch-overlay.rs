...
//! Source: drivers/input/touch-overlay.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct touch_overlay_segment {
    pub list: list_head,
    pub x_origin: u32,
    pub y_origin: u32,
    pub x_size: u32,
...
//
#[no_mangle]
pub unsafe extern "C" fn touch_overlay_map(list: *mut list_head, input: *mut input_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn touch_overlay_get_touchscreen_abs(list: *mut list_head, x: *mut u16, y: *mut u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn touch_overlay_mapped_touchscreen(list: *mut list_head) -> bool {
...
// ignore touch events outside the defined area
    ...
    let mut button_contact: bool = touch_overlay_segment_event(segment, pos);
...
//
#[no_mangle]
pub unsafe extern "C" fn touch_overlay_sync_frame(list: *mut list_head, input: *mut input_dev) {
