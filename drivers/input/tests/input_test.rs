...
//! Source: drivers/input/tests/input_test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn input_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn input_test_exit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn input_test_polling(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn input_test_timestamp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn input_test_match_device_id(test: *mut kunit) {
    static void input_test_match_device_id(struct kunit *test)
    {
    struct input_dev *input_dev = test.priv;
    let mut id: input_device_id = { 0 };
//
...
#[no_mangle]
unsafe extern "C" fn input_test_grab(test: *mut kunit) {
