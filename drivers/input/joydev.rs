...
//
    ...
    MODULE_LICENSE("GPL");
pub const JOYDEV_MINOR_BASE: c_int = 0;
pub const JOYDEV_MINORS: c_int = 16;
pub const JOYDEV_BUFFER_SIZE: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct joydev {
    pub open: c_int,
    ...
    pub cdev: cdev,
    pub exist: bool,
    pub corr: [js_corr; ABS_CNT],
    pub glue: JS_DATA_SAVE_TYPE,
    pub nabs: c_int,
    pub nkey: c_int,
    pub 1]: __u16 keymap[KEY_MAX - BTN_MISC +,
    pub 1]: __u16 keypam[KEY_MAX - BTN_MISC +,
    pub absmap: [__u8; ABS_CNT],
    pub abspam: [__u8; ABS_CNT],
    pub abs: [__s16; ABS_CNT],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct joydev_client {
    pub buffer: [js_event; JOYDEV_BUFFER_SIZE],
    pub head: c_int,
    pub tail: c_int,
    pub startup: c_int,
    pub /: *mut *mut spinlock_t buffer_lock; / protects access to buffer, head and tail,
    pub fasync: *mut fasync_struct,
    pub joydev: *mut joydev,
    pub node: list_head,
}

#[no_mangle]
unsafe extern "C" fn joydev_correct(value: c_int, corr: *mut js_corr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joydev_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joydev_free(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn joydev_refresh_state(joydev: *mut joydev) {
...
#[no_mangle]
unsafe extern "C" fn joydev_open_device(joydev: *mut joydev) -> c_int {
    ...
    retval = -ENODEV;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !joydev->open++) -> else {
...
#[no_mangle]
unsafe extern "C" fn joydev_close_device(joydev: *mut joydev) {
...
//
#[no_mangle]
unsafe extern "C" fn joydev_hangup(joydev: *mut joydev) {
...
#[no_mangle]
unsafe extern "C" fn joydev_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn joydev_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn joydev_data_pending(client: *mut joydev_client) -> c_int {
...
// No kernel lock - fine
#[no_mangle]
unsafe extern "C" fn joydev_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
// Process fixed-sized commands.
    ...
    return -EFAULT;
    for (i = 0; i < joydev.nabs; i++) {
    let mut val: c_int = input_abs_get_val(dev, joydev.abspam[i]);
    joydev.abs[i] = joydev_correct(val, &joydev.corr[i]);
    }
    return 0;
    case JSIOCGCORR:
...
//
#[no_mangle]
unsafe extern "C" fn joydev_mark_dead(joydev: *mut joydev) {
...
#[no_mangle]
unsafe extern "C" fn joydev_cleanup(joydev: *mut joydev) {
...
#[no_mangle]
unsafe extern "C" fn joydev_dev_is_blacklisted(dev: *mut input_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn joydev_dev_is_absolute_mouse(dev: *mut input_dev) -> bool {
    static bool joydev_dev_is_absolute_mouse(struct input_dev *dev)
    {
    DECLARE_BITMAP(jd_scratch, KEY_CNT);
    let mut ev_match: bool = false;
...
#[no_mangle]
unsafe extern "C" fn joydev_match(handler: *mut input_handler, dev: *mut input_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn joydev_disconnect(handle: *mut input_handle) {
...
#[no_mangle]
unsafe extern "C" fn joydev_init() -> int __init {
    static int __init joydev_init(void)
    {
    return input_register_handler(&joydev_handler);
    }
#[no_mangle]
unsafe extern "C" fn joydev_exit() -> void __exit {
