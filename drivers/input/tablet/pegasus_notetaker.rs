...
//! Source: drivers/input/tablet/pegasus_notetaker.c
#![no_std]
...
pub const USB_VENDOR_ID_PEGASUSTECH: c_uint = 0x0e20;
pub const USB_DEVICE_ID_PEGASUS_NOTETAKER_EN100: c_uint = 0x0101;
// device specific defines
pub const NOTETAKER_REPORT_ID: c_uint = 0x02;
pub const NOTETAKER_SET_CMD: c_uint = 0x80;
pub const NOTETAKER_SET_MODE: c_uint = 0xb5;
pub const NOTETAKER_LED_MOUSE: c_uint = 0x02;
pub const PEN_MODE_XY: c_uint = 0x01;
pub const SPECIAL_COMMAND: c_uint = 0x80;
pub const BUTTON_PRESSED: c_uint = 0xb5;
pub const COMMAND_VERSION: c_uint = 0xa9;
// 1 Status + 1 Color + 2 X + 2 Y = 6 bytes
pub const NOTETAKER_PACKET_SIZE: c_int = 6;
// in xy data packet
pub const BATTERY_NO_REPORT: c_uint = 0x40;
pub const BATTERY_LOW: c_uint = 0x41;
pub const BATTERY_GOOD: c_uint = 0x42;
...
// serialize access to open/suspend
    ...
    pub name: [c_char; 128],
    pub phys: [c_char; 64],
    pub init: work_struct,
}

#[no_mangle]
unsafe extern "C" fn pegasus_control_msg(pegasus: *mut pegasus, data: *mut u8, len: c_int) -> c_int {
    static int pegasus_control_msg(struct pegasus *pegasus, u8 *data, int len)
    {
    let mut sizeof_buf: c_int = len + 2;
    int result;
    int error;
    u8 *cmd_buf;
...
#[no_mangle]
unsafe extern "C" fn pegasus_set_mode(pegasus: *mut pegasus, mode: u8, led: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pegasus_parse_packet(pegasus: *mut pegasus) {
...
#[no_mangle]
unsafe extern "C" fn pegasus_irq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn pegasus_init(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __pegasus_open(pegasus: *mut pegasus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pegasus_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pegasus_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn pegasus_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn pegasus_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pegasus_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pegasus_reset_resume(intf: *mut usb_interface) -> c_int {
