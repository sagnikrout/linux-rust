...
//! Source: drivers/input/tablet/aiptek.c
#![no_std]
...
// PointerMode codes
//
pub const AIPTEK_POINTER_ONLY_MOUSE_MODE: c_int = 0;
pub const AIPTEK_POINTER_ONLY_STYLUS_MODE: c_int = 1;
pub const AIPTEK_POINTER_EITHER_MODE: c_int = 2;
...
// CoordinateMode code
//
pub const AIPTEK_COORDINATE_RELATIVE_MODE: c_int = 0;
pub const AIPTEK_COORDINATE_ABSOLUTE_MODE: c_int = 1;
// XTilt and YTilt values
//

pub const AIPTEK_TILT_MAX: c_int = 127;

// Wheel values
//
pub const AIPTEK_WHEEL_MIN: c_int = 0;
pub const AIPTEK_WHEEL_MAX: c_int = 1024;
...
//
pub const AIPTEK_DIAGNOSTIC_NA: c_int = 0;
pub const AIPTEK_DIAGNOSTIC_SENDING_RELATIVE_IN_ABSOLUTE: c_int = 1;
pub const AIPTEK_DIAGNOSTIC_SENDING_ABSOLUTE_IN_RELATIVE: c_int = 2;
pub const AIPTEK_DIAGNOSTIC_TOOL_DISALLOWED: c_int = 3;
// Time to wait (in ms) to help mask hand jittering
// when pressing the stylus buttons.
//
pub const AIPTEK_JITTER_DELAY_DEFAULT: c_int = 50;
...
//
pub const AIPTEK_PROGRAMMABLE_DELAY_25: c_int = 25;
pub const AIPTEK_PROGRAMMABLE_DELAY_50: c_int = 50;
pub const AIPTEK_PROGRAMMABLE_DELAY_100: c_int = 100;
pub const AIPTEK_PROGRAMMABLE_DELAY_200: c_int = 200;
pub const AIPTEK_PROGRAMMABLE_DELAY_300: c_int = 300;
pub const AIPTEK_PROGRAMMABLE_DELAY_400: c_int = 400;

// Mouse button programming
//
pub const AIPTEK_MOUSE_LEFT_BUTTON: c_uint = 0x04;
pub const AIPTEK_MOUSE_RIGHT_BUTTON: c_uint = 0x08;
pub const AIPTEK_MOUSE_MIDDLE_BUTTON: c_uint = 0x10;
// Stylus button programming
//
pub const AIPTEK_STYLUS_LOWER_BUTTON: c_uint = 0x08;
pub const AIPTEK_STYLUS_UPPER_BUTTON: c_uint = 0x10;
// Length of incoming packet from the tablet
//
pub const AIPTEK_PACKET_LENGTH: c_int = 8;
...
//
pub const AIPTEK_REPORT_TOOL_UNKNOWN: c_uint = 0x10;
pub const AIPTEK_REPORT_TOOL_STYLUS: c_uint = 0x20;
pub const AIPTEK_REPORT_TOOL_MOUSE: c_uint = 0x40;
    let mut programmableDelay: static int = AIPTEK_PROGRAMMABLE_DELAY_DEFAULT;
    let mut jitterDelay: static int = AIPTEK_JITTER_DELAY_DEFAULT;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aiptek_features {
    pub /: *mut *mut int odmCode; / Tablet manufacturer code,
    pub /: *mut *mut int modelCode; / Tablet model code (not unique),
    pub /: *mut *mut int firmwareCode; / prom/eeprom version,
    pub /: *mut *mut char usbPath[64 + 1]; / device's physical usb path,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aiptek_settings {
    pub /: *mut *mut int pointerMode; / stylus-, mouse-only or either,
    pub /: *mut *mut int coordinateMode; / absolute/relative coords,
    pub /: *mut *mut int toolMode; / pen, pencil, brush, etc. tool,
    pub /: *mut *mut int xTilt; / synthetic xTilt amount,
    pub /: *mut *mut int yTilt; / synthetic yTilt amount,
    pub /: *mut *mut int wheel; / synthetic wheel amount,
    pub /: *mut *mut int stylusButtonUpper; / stylus upper btn delivers...,
    pub /: *mut *mut int stylusButtonLower; / stylus lower btn delivers...,
    pub /: *mut *mut int mouseButtonLeft; / mouse left btn delivers...,
    pub /: *mut *mut int mouseButtonMiddle; / mouse middle btn delivers...,
    pub /: *mut *mut int mouseButtonRight; / mouse right btn delivers...,
    pub /: *mut *mut int programmableDelay; / delay for tablet programming,
    pub /: *mut *mut int jitterDelay; / delay for hand jittering,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aiptek {
    pub /: *mut *mut *mut input_dev inputdev; / input device struct,
    pub /: *mut *mut *mut usb_interface intf; / usb interface struct,
    pub /: *mut *mut *mut urb urb; / urb for incoming reports,
    pub /: *mut *mut dma_addr_t data_dma; / our dma stuffage,
    pub /: *mut *mut aiptek_features features; / tablet's array of features,
    pub /: *mut *mut aiptek_settings curSetting; / tablet's current programmable,
    pub /: *mut *mut aiptek_settings newSetting; / ... and new param settings,
    pub /: *mut *mut unsigned int ifnum; / interface number for IO,
    pub /: *mut *mut int diagnostic; / tablet diagnostic codes,
    pub /: *mut *mut unsigned long eventCount; / event count,
    pub /: *mut *mut int inDelay; / jitter: in jitter delay?,
    pub /: *mut *mut unsigned long endDelay; / jitter: time when delay ends,
    pub /: *mut *mut int previousJitterable; / jitterable prev value,
    pub /: *mut *mut int lastMacro; / macro key to reset,
    pub /: *mut *mut int previousToolMode; / pen, pencil, brush, etc. tool,
    pub /: *mut *mut *mut unsigned char data; / incoming packet data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aiptek_map {
    pub string: *const c_char,
    pub value: c_int,
}

#[no_mangle]
unsafe extern "C" fn map_str_to_val(map: *const aiptek_map, str: *const c_char, count: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aiptek_irq(urb: *mut urb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(2: data[0] ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(3: data[0] ==) -> else {
    if (aiptek.curSetting.coordinateMode == AIPTEK_COORDINATE_RELATIVE_MODE) {
    aiptek.diagnostic = AIPTEK_DIAGNOSTIC_SENDING_ABSOLUTE_IN_RELATIVE;
...
//
#[no_mangle]
pub unsafe extern "C" fn if(4: data[0] ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(5: data[0] ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(6: data[0] ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn aiptek_open(inputdev: *mut input_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aiptek_close(inputdev: *mut input_dev) {
...
//
    ...
    {
    let mut sizeof_buf: c_int = 3 * sizeof(u8);
    int ret;
    u8 *buf;
...
//
#[no_mangle]
unsafe extern "C" fn aiptek_program_tablet(aiptek: *mut aiptek) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletSize(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
// to it.
//
    static DEVICE_ATTR(size, S_IRUGO, show_tabletSize, core::ptr::null_mut());
//
...
//
    ...
    { core::ptr::null_mut(),		AIPTEK_INVALID_VALUE }
    };
#[no_mangle]
unsafe extern "C" fn show_tabletPointerMode(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    let mut new_mode: c_int = map_str_to_val(pointer_mode_map, buf, count);
...
#[no_mangle]
unsafe extern "C" fn show_tabletCoordinateMode(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    let mut new_mode: c_int = map_str_to_val(coordinate_mode_map, buf, count);
    if (new_mode == AIPTEK_INVALID_VALUE)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn show_tabletToolMode(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    let mut new_mode: c_int = map_str_to_val(tool_mode_map, buf, count);
    if (new_mode == AIPTEK_INVALID_VALUE)
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletXtilt(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletYtilt(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletJitterDelay(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletProgrammableDelay(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletEventsReceived(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    static ssize_t show_tabletEventsReceived(struct device *dev, struct device_attribute *attr, char *buf)
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    return sysfs_emit(buf, "%ld\n", aiptek.eventCount);
    }
    static DEVICE_ATTR(event_count, S_IRUGO, show_tabletEventsReceived, core::ptr::null_mut());
//
// support routines for the 'diagnostic' file. Note that this file
// only displays current setting.
//
#[no_mangle]
unsafe extern "C" fn show_tabletDiagnosticMessage(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    static DEVICE_ATTR(diagnostic, S_IRUGO, show_tabletDiagnosticMessage, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn show_tabletStylusUpper(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    let mut new_button: c_int = map_str_to_val(stylus_button_map, buf, count);
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletStylusLower(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn show_tabletMouseLeft(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    let mut new_button: c_int = map_str_to_val(mouse_button_map, buf, count);
    if (new_button == AIPTEK_INVALID_VALUE)
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletMouseMiddle(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletMouseRight(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletWheel(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletExecute(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_tabletODMCode(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    static ssize_t show_tabletODMCode(struct device *dev, struct device_attribute *attr, char *buf)
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    return sysfs_emit(buf, "0x%04x\n", aiptek.features.odmCode);
    }
    static DEVICE_ATTR(odm_code, S_IRUGO, show_tabletODMCode, core::ptr::null_mut());
//
// support routines for the 'model_code' file. Note that this file
// only displays current setting.
//
#[no_mangle]
unsafe extern "C" fn show_tabletModelCode(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    static ssize_t show_tabletModelCode(struct device *dev, struct device_attribute *attr, char *buf)
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    return sysfs_emit(buf, "0x%04x\n", aiptek.features.modelCode);
    }
    static DEVICE_ATTR(model_code, S_IRUGO, show_tabletModelCode, core::ptr::null_mut());
//
// support routines for the 'firmware_code' file. Note that this file
// only displays current setting.
//
#[no_mangle]
unsafe extern "C" fn show_firmwareCode(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    static ssize_t show_firmwareCode(struct device *dev, struct device_attribute *attr, char *buf)
    {
    struct aiptek *aiptek = dev_get_drvdata(dev);
    return sysfs_emit(buf, "%04x\n", aiptek.features.firmwareCode);
    }
    static DEVICE_ATTR(firmware_code, S_IRUGO, show_firmwareCode, core::ptr::null_mut());
...
//
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), &endpoint, core::ptr::null_mut());
    if (err) {
    dev_err(&intf.dev,
...
//
    ...
    aiptek.data_dma);
    fail1: usb_set_intfdata(intf, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn aiptek_disconnect(intf: *mut usb_interface) {
