...
//! Source: drivers/input/tablet/hanwang.c
#![no_std]
...
pub const HANWANG_TABLET_INT_CLASS: c_uint = 0x0003;
pub const HANWANG_TABLET_INT_SUB_CLASS: c_uint = 0x0001;
pub const HANWANG_TABLET_INT_PROTOCOL: c_uint = 0x0002;
pub const ART_MASTER_PKGLEN_MAX: c_int = 10;
// device IDs
...
pub struct hanwang {
    ...
    pub irq: *mut urb,
    pub features: *const hanwang_features,
    pub current_tool: c_uint,
    pub current_id: c_uint,
    pub name: [c_char; 64],
    pub phys: [c_char; 32],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hanwang_features {
    pub pid: c_ushort,
    pub name: *mut c_char,
    pub type: enum hanwang_tablet_type,
    pub pkg_len: c_int,
    pub max_x: c_int,
    pub max_y: c_int,
    pub max_tilt_x: c_int,
    pub max_tilt_y: c_int,
    pub max_pressure: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn hanwang_parse_packet(hanwang: *mut hanwang) {
    static void hanwang_parse_packet(struct hanwang *hanwang)
    {
    unsigned char *data = hanwang.data;
    struct input_dev *input_dev = hanwang.dev;
    struct usb_device *dev = hanwang.usbdev;
    let mut type: enum hanwang_tablet_type = hanwang.features.type;
    int i;
    u16 p;
...
#[no_mangle]
unsafe extern "C" fn hanwang_irq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn hanwang_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hanwang_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn get_features(dev: *mut usb_device, hanwang: *mut hanwang) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hanwang_probe(intf: *mut usb_interface, id: *const usb_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hanwang_disconnect(intf: *mut usb_interface) {
