...
//! Source: drivers/input/tablet/wacom_serial4.c
#![no_std]
...
pub const PACKET_LENGTH: c_int = 7;
pub const DATA_SIZE: c_int = 32;
// flags
pub const F_COVERS_SCREEN: c_uint = 0x01;
pub const F_HAS_STYLUS2: c_uint = 0x02;
pub const F_HAS_SCROLLWHEEL: c_uint = 0x04;
// device IDs
...
pub struct wacom {
    ...
    pub expect: u8,
    pub eraser_mask: u8,
    pub extra_z_bits: c_uint,
    pub flags: c_uint,
    pub res_y: unsigned int res_x,,
    pub max_y: unsigned int max_x,,
    pub tool: c_uint,
    pub idx: c_uint,
...
#[no_mangle]
unsafe extern "C" fn wacom_handle_model_response(wacom: *mut wacom) {
...
#[no_mangle]
unsafe extern "C" fn wacom_handle_configuration_response(wacom: *mut wacom) {
...
#[no_mangle]
unsafe extern "C" fn wacom_handle_coordinates_response(wacom: *mut wacom) {
...
#[no_mangle]
unsafe extern "C" fn wacom_handle_response(wacom: *mut wacom) {
...
#[no_mangle]
unsafe extern "C" fn wacom_handle_packet(wacom: *mut wacom) {
...
#[no_mangle]
unsafe extern "C" fn wacom_clear_data_buf(wacom: *mut wacom) {
...
#[no_mangle]
unsafe extern "C" fn wacom_disconnect(serio: *mut serio) {
...
#[no_mangle]
unsafe extern "C" fn wacom_send(serio: *mut serio, command: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_send_setup_string(wacom: *mut wacom, serio: *mut serio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_setup(wacom: *mut wacom, serio: *mut serio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wacom_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
