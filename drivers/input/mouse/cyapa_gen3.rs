...
//! Source: drivers/input/mouse/cyapa_gen3.c
#![no_std]
...
pub const GEN3_MAX_FINGERS: c_int = 5;

pub const BLK_HEAD_BYTES: c_int = 32;
// Macro for register map group offset.
pub const PRODUCT_ID_SIZE: c_int = 16;
pub const QUERY_DATA_SIZE: c_int = 27;
pub const REG_PROTOCOL_GEN_QUERY_OFFSET: c_int = 20;
pub const REG_OFFSET_DATA_BASE: c_uint = 0x0000;
pub const REG_OFFSET_COMMAND_BASE: c_uint = 0x0028;
pub const REG_OFFSET_QUERY_BASE: c_uint = 0x002a;

pub const OP_RECALIBRATION_MASK: c_uint = 0x80;
pub const OP_REPORT_BASELINE_MASK: c_uint = 0x40;
pub const REG_OFFSET_MAX_BASELINE: c_uint = 0x0026;
pub const REG_OFFSET_MIN_BASELINE: c_uint = 0x0027;

pub const SET_POWER_MODE_TRIES: c_int = 5;
pub const GEN3_BL_CMD_CHECKSUM_SEED: c_uint = 0xff;
pub const GEN3_BL_CMD_INITIATE_BL: c_uint = 0x38;
pub const GEN3_BL_CMD_WRITE_BLOCK: c_uint = 0x39;
pub const GEN3_BL_CMD_VERIFY_BLOCK: c_uint = 0x3a;
pub const GEN3_BL_CMD_TERMINATE_BL: c_uint = 0x3b;
pub const GEN3_BL_CMD_LAUNCH_APP: c_uint = 0xa5;
//
// CYAPA trackpad device states.
// Used in register 0x00, bit1-0, DeviceStatus field.
// Other values indicate device is in an abnormal state and must be reset.
//
pub const CYAPA_DEV_NORMAL: c_uint = 0x03;
pub const CYAPA_DEV_BUSY: c_uint = 0x01;
pub const CYAPA_FW_BLOCK_SIZE: c_int = 64;
pub const CYAPA_FW_READ_SIZE: c_int = 16;
pub const CYAPA_FW_HDR_START: c_uint = 0x0780;
pub const CYAPA_FW_HDR_BLOCK_COUNT: c_int = 2;

    CYAPA_FW_BLOCK_SIZE)
pub const CYAPA_FW_DATA_START: c_uint = 0x0800;
pub const CYAPA_FW_DATA_BLOCK_COUNT: c_int = 480;

    CYAPA_FW_BLOCK_SIZE)

pub const CYAPA_CMD_LEN: c_int = 16;
pub const GEN3_BL_IDLE_FW_MAJ_VER_OFFSET: c_uint = 0x0b;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyapa_touch {
//
...
//
    pub xy_hi: u8,
    pub /: *mut *mut u8 x_lo; / low 8 bits of x position value.,
    pub /: *mut *mut u8 y_lo; / low 8 bits of y position value.,
    pub pressure: u8,
...
// CYAPA reports up to 5 touches per packet.
    pub touches: [cyapa_touch; 5],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gen3_write_block_cmd {
    pub /: *mut *mut u8 checksum_seed; / Always be 0xff,
    pub /: *mut *mut u8 cmd_code; / command code: 0x39,
    pub /: *mut *mut u8 key[8]; / 8-byte security key,
    pub block_num: __be16,
    pub block_data: [u8; CYAPA_FW_BLOCK_SIZE],
    pub /: *mut *mut u8 block_checksum; / Calculated using bytes 12 - 75,
    pub /: *mut *mut u8 cmd_checksum; / Calculated using bytes 0-76,
    pub __packed: },
    static const u8 security_key[] = {
    pub }: 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    static const u8 bl_activate[] = { 0x00, 0xff, 0x38, 0x00, 0x01, 0x02, 0x03,
    pub }: 0x04, 0x05, 0x06, 0x07,
    static const u8 bl_deactivate[] = { 0x00, 0xff, 0x3b, 0x00, 0x01, 0x02, 0x03,
    pub }: 0x04, 0x05, 0x06, 0x07,
    static const u8 bl_exit[] = { 0x00, 0xff, 0xa5, 0x00, 0x01, 0x02, 0x03, 0x04,
    pub }: 0x05, 0x06, 0x07,
// for byte read/write command
pub const CMD_RESET: c_int = 0;
pub const CMD_POWER_MODE: c_int = 1;
pub const CMD_DEV_STATUS: c_int = 2;
pub const CMD_REPORT_MAX_BASELINE: c_int = 3;
pub const CMD_REPORT_MIN_BASELINE: c_int = 4;

// for group registers read/write command
pub const REG_GROUP_DATA: c_int = 0;
pub const REG_GROUP_CMD: c_int = 2;
pub const REG_GROUP_QUERY: c_int = 3;

// for register block read/write command
pub const CMD_BL_STATUS: c_int = 0;
pub const CMD_BL_HEAD: c_int = 1;
pub const CMD_BL_CMD: c_int = 2;
pub const CMD_BL_DATA: c_int = 3;
pub const CMD_BL_ALL: c_int = 4;
pub const CMD_BLK_PRODUCT_ID: c_int = 5;
pub const CMD_BLK_HEAD: c_int = 6;
...
#[no_mangle]
unsafe extern "C" fn cyapa_read_byte(cyapa: *mut cyapa, cmd_idx: u8) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn cyapa_write_byte(cyapa: *mut cyapa, cmd_idx: u8, value: u8) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_read_block(cyapa: *mut cyapa, cmd_idx: u8, values: *mut u8) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_state_parse(cyapa: *mut cyapa, reg_data: *mut u8, len: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_bl_enter(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_bl_activate(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_bl_deactivate(cyapa: *mut cyapa) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_bl_exit(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_csum(buf: *const u8, count: usize) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_check_fw(cyapa: *mut cyapa, fw: *const firmware) -> c_int {
...
// Ignore WATCHDOG bit and reserved bits.
    ...
    let mut block: usize = start_block + i;
    let mut addr: usize = i * CYAPA_FW_BLOCK_SIZE;
...
//
#[no_mangle]
unsafe extern "C" fn cyapa_get_wait_time_for_pwr_cmd(pwr_mode: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_set_proximity(cyapa: *mut cyapa, enable: bool) -> c_int {
    static int cyapa_gen3_set_proximity(struct cyapa *cyapa, bool enable)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_get_query_data(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_bl_query_data(cyapa: *mut cyapa) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_do_operational_check(cyapa: *mut cyapa) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_irq_cmd_handler(cyapa: *mut cyapa) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_irq_handler(cyapa: *mut cyapa) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cyapa_gen3_try_poll_handler(cyapa: *mut cyapa) -> c_int {
    static int cyapa_gen3_try_poll_handler(struct cyapa *cyapa)
    {
    struct cyapa_reg_data data;
    int ret;
