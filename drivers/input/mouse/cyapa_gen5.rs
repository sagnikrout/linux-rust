...
//! Source: drivers/input/mouse/cyapa_gen5.c
#![no_std]
...
pub const CYAPA_TSG_FLASH_MAP_BLOCK_SIZE: c_uint = 0x80;
pub const CYAPA_TSG_IMG_FW_HDR_SIZE: c_int = 13;

pub const CYAPA_TSG_IMG_START_ROW_NUM: c_uint = 0x002e;
pub const CYAPA_TSG_IMG_END_ROW_NUM: c_uint = 0x01fe;
pub const CYAPA_TSG_IMG_APP_INTEGRITY_ROW_NUM: c_uint = 0x01ff;

    CYAPA_TSG_IMG_START_ROW_NUM + 1 + 1)

pub const CYAPA_TSG_START_OF_APPLICATION: c_uint = 0x1700;
pub const CYAPA_TSG_APP_INTEGRITY_SIZE: c_int = 60;
pub const CYAPA_TSG_FLASH_MAP_METADATA_SIZE: c_int = 60;
pub const CYAPA_TSG_BL_KEY_SIZE: c_int = 8;
pub const CYAPA_TSG_MAX_CMD_SIZE: c_int = 256;
// Macro of PIP interface
pub const PIP_BL_INITIATE_RESP_LEN: c_int = 11;
pub const PIP_BL_FAIL_EXIT_RESP_LEN: c_int = 11;
pub const PIP_BL_FAIL_EXIT_STATUS_CODE: c_uint = 0x0c;
pub const PIP_BL_VERIFY_INTEGRITY_RESP_LEN: c_int = 12;
pub const PIP_BL_INTEGRITY_CHEKC_PASS: c_uint = 0x00;
pub const PIP_BL_BLOCK_WRITE_RESP_LEN: c_int = 11;
pub const PIP_TOUCH_REPORT_ID: c_uint = 0x01;
pub const PIP_BTN_REPORT_ID: c_uint = 0x03;
pub const PIP_WAKEUP_EVENT_REPORT_ID: c_uint = 0x04;
pub const PIP_PUSH_BTN_REPORT_ID: c_uint = 0x06;
pub const GEN5_OLD_PUSH_BTN_REPORT_ID: c_uint = 0x05  /* Special for old Gen5 TP. */;
pub const PIP_PROXIMITY_REPORT_ID: c_uint = 0x07;
pub const PIP_PROXIMITY_REPORT_SIZE: c_int = 6;
pub const PIP_PROXIMITY_DISTANCE_OFFSET: c_uint = 0x05;
pub const PIP_PROXIMITY_DISTANCE_MASK: c_uint = 0x01;
pub const PIP_TOUCH_REPORT_HEAD_SIZE: c_int = 7;
pub const PIP_TOUCH_REPORT_MAX_SIZE: c_int = 127;
pub const PIP_BTN_REPORT_HEAD_SIZE: c_int = 6;
pub const PIP_BTN_REPORT_MAX_SIZE: c_int = 14;
pub const PIP_WAKEUP_EVENT_SIZE: c_int = 4;
pub const PIP_NUMBER_OF_TOUCH_OFFSET: c_int = 5;
pub const PIP_NUMBER_OF_TOUCH_MASK: c_uint = 0x1f;
pub const PIP_BUTTONS_OFFSET: c_int = 5;
pub const PIP_BUTTONS_MASK: c_uint = 0x0f;

pub const PIP_TOUCH_TYPE_FINGER: c_uint = 0x00;
pub const PIP_TOUCH_TYPE_PROXIMITY: c_uint = 0x01;
pub const PIP_TOUCH_TYPE_HOVER: c_uint = 0x02;

pub const RECORD_EVENT_NONE: c_int = 0;
pub const RECORD_EVENT_TOUCHDOWN: c_int = 1;
pub const RECORD_EVENT_DISPLACE: c_int = 2;
pub const RECORD_EVENT_LIFTOFF: c_int = 3;
pub const PIP_SENSING_MODE_MUTUAL_CAP_FINE: c_uint = 0x00;
pub const PIP_SENSING_MODE_SELF_CAP: c_uint = 0x02;
pub const PIP_SET_PROXIMITY: c_uint = 0x49;
// Macro of Gen5
pub const GEN5_BL_MAX_OUTPUT_LENGTH: c_uint = 0x0100;
pub const GEN5_APP_MAX_OUTPUT_LENGTH: c_uint = 0x00fe;
pub const GEN5_POWER_STATE_ACTIVE: c_uint = 0x01;
pub const GEN5_POWER_STATE_LOOK_FOR_TOUCH: c_uint = 0x02;
pub const GEN5_POWER_STATE_READY: c_uint = 0x03;
pub const GEN5_POWER_STATE_IDLE: c_uint = 0x04;
pub const GEN5_POWER_STATE_BTN_ONLY: c_uint = 0x05;
pub const GEN5_POWER_STATE_OFF: c_uint = 0x06;

pub const GEN5_CMD_GET_PARAMETER: c_uint = 0x05;
pub const GEN5_CMD_SET_PARAMETER: c_uint = 0x06;
pub const GEN5_PARAMETER_ACT_INTERVL_ID: c_uint = 0x4d;
pub const GEN5_PARAMETER_ACT_INTERVL_SIZE: c_int = 1;
pub const GEN5_PARAMETER_ACT_LFT_INTERVL_ID: c_uint = 0x4f;
pub const GEN5_PARAMETER_ACT_LFT_INTERVL_SIZE: c_int = 2;
pub const GEN5_PARAMETER_LP_INTRVL_ID: c_uint = 0x4c;
pub const GEN5_PARAMETER_LP_INTRVL_SIZE: c_int = 2;
pub const GEN5_PARAMETER_DISABLE_PIP_REPORT: c_uint = 0x08;
pub const GEN5_BL_REPORT_DESCRIPTOR_SIZE: c_uint = 0x1d;
pub const GEN5_BL_REPORT_DESCRIPTOR_ID: c_uint = 0xfe;
pub const GEN5_APP_REPORT_DESCRIPTOR_SIZE: c_uint = 0xee;
pub const GEN5_APP_CONTRACT_REPORT_DESCRIPTOR_SIZE: c_uint = 0xfa;
pub const GEN5_APP_REPORT_DESCRIPTOR_ID: c_uint = 0xf6;
pub const GEN5_RETRIEVE_MUTUAL_PWC_DATA: c_uint = 0x00;
pub const GEN5_RETRIEVE_SELF_CAP_PWC_DATA: c_uint = 0x01;
pub const GEN5_RETRIEVE_DATA_ELEMENT_SIZE_MASK: c_uint = 0x07;
pub const GEN5_CMD_EXECUTE_PANEL_SCAN: c_uint = 0x2a;
pub const GEN5_CMD_RETRIEVE_PANEL_SCAN: c_uint = 0x2b;
pub const GEN5_PANEL_SCAN_MUTUAL_RAW_DATA: c_uint = 0x00;
pub const GEN5_PANEL_SCAN_MUTUAL_BASELINE: c_uint = 0x01;
pub const GEN5_PANEL_SCAN_MUTUAL_DIFFCOUNT: c_uint = 0x02;
pub const GEN5_PANEL_SCAN_SELF_RAW_DATA: c_uint = 0x03;
pub const GEN5_PANEL_SCAN_SELF_BASELINE: c_uint = 0x04;
pub const GEN5_PANEL_SCAN_SELF_DIFFCOUNT: c_uint = 0x05;
// The offset only valid for retrieve PWC and panel scan commands
pub const GEN5_RESP_DATA_STRUCTURE_OFFSET: c_int = 10;
pub const GEN5_PWC_DATA_ELEMENT_SIZE_MASK: c_uint = 0x07;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyapa_pip_touch_record {
//
// Bit 7 - 3: reserved
// Bit 2 - 0: touch type;
// 0 : standard finger;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyapa_pip_report_data {
    pub report_head: [u8; PIP_TOUCH_REPORT_HEAD_SIZE],
    pub touch_records: [cyapa_pip_touch_record; 10],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyapa_tsg_bin_image_head {
    pub /: *mut *mut u8 head_size; / Unit: bytes, including itself.,
    pub /: *mut *mut u8 ttda_driver_major_version; / Reserved as 0.,
    pub /: *mut *mut u8 ttda_driver_minor_version; / Reserved as 0.,
    pub fw_major_version: u8,
    pub fw_minor_version: u8,
    pub fw_revision_control_number: [u8; 8],
    pub silicon_id_hi: u8,
    pub silicon_id_lo: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyapa_tsg_bin_image_data_record {
    pub flash_array_id: u8,
    pub row_number: __be16,
// The number of bytes of flash data contained in this record.
    pub record_len: __be16,
// The flash program data.
    pub record_data: [u8; CYAPA_TSG_FW_ROW_SIZE],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cyapa_tsg_bin_image {
    pub image_head: cyapa_tsg_bin_image_head,
    pub records: [cyapa_tsg_bin_image_data_record; ],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pip_bl_packet_start {
    pub /: *mut *mut u8 sop; / Start of packet, must be 01h,
    pub cmd_code: u8,
    pub /: *mut *mut __le16 data_length; / Size of data parameter start from data[0],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pip_bl_packet_end {
    pub crc: __le16,
    pub /: *mut *mut u8 eop; / End of packet, must be 17h,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pip_bl_cmd_head {
    pub /: *mut *mut __le16 addr; / Output report register address, must be 0004h,
// Size of packet not including output report register address
    pub length: __le16,
    pub /: *mut *mut u8 report_id; / Bootloader output report id, must be 40h,
    pub /: *mut *mut u8 rsvd; / Reserved, must be 0,
    pub packet_start: pip_bl_packet_start,
    pub /: *mut *mut u8 data[]; / Command data variable based on commands,
    pub __packed: },
// Initiate bootload command data structure.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pip_bl_initiate_cmd_data {
// Key must be "A5h 01h 02h 03h FFh FEh FDh 5Ah"
    pub key: [u8; CYAPA_TSG_BL_KEY_SIZE],
    pub metadata_raw_parameter: [u8; CYAPA_TSG_FLASH_MAP_METADATA_SIZE],
    pub metadata_crc: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsg_bl_metadata_row_params {
    pub size: __le16,
    pub maximum_size: __le16,
    pub app_start: __le32,
    pub app_len: __le16,
    pub app_crc: __le16,
    pub app_entry: __le32,
    pub upgrade_start: __le32,
    pub upgrade_len: __le16,
    pub entry_row_crc: __le16,
    pub /: *mut *mut u8 padding[36]; / Padding data must be 0,
    pub /: *mut *mut __le16 metadata_crc; / CRC starts at offset of 60,
    pub __packed: },
// Bootload program and verify row command data structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsg_bl_flash_row_head {
    pub flash_array_id: u8,
    pub flash_row_id: __le16,
    pub flash_data: [u8; ],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
...
// Size of packet not including output report register address
    pub length: __le16,
    pub /: *mut *mut u8 report_id; / Application output report id, must be 2Fh,
    pub /: *mut *mut u8 rsvd; / Reserved, must be 0,
//
...
//
    pub cmd_code: u8,
    pub /: *mut *mut u8 parameter_data[]; / Parameter data variable based on cmd_code,
    pub __packed: },
// Application get/set parameter command data structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gen5_app_set_parameter_data {
    pub parameter_id: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gen5_app_get_parameter_data {
    pub parameter_id: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gen5_retrieve_panel_scan_data {
    pub read_offset: __le16,
    pub read_elements: __le16,
    pub data_id: u8,
    pub __packed: },
    pub }: u8 pip_read_sys_info[] = { 0x04, 0x00, 0x05, 0x00, 0x2f, 0x00, 0x02,
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_cmd_state_initialize(cyapa: *mut cyapa) -> c_int {
    ...
    pip.resp_sort_func = core::ptr::null_mut();
    pip.in_progress_cmd = PIP_INVALID_CMD;
    pip.resp_data = core::ptr::null_mut();
    pip.resp_len = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_i2c_pip_read(cyapa: *mut cyapa, buf: *mut u8, size: usize) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn cyapa_i2c_pip_write(cyapa: *mut cyapa, buf: *mut u8, size: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn cyapa_reset_pip_pm_state(cyapa: *mut cyapa) {
...
#[no_mangle]
unsafe extern "C" fn cyapa_get_pip_pm_state(cyapa: *mut cyapa) -> enum cyapa_pm_stage {
...
//
    ...
    struct cyapa_pip_cmd_states *pip = &cyapa.cmd_states.pip;
    let mut pm_stage: enum cyapa_pm_stage = cyapa_get_pip_pm_state(cyapa);
    int length;
    int report_count;
    int empty_count;
    int buf_len;
...
// Correct command response received
    ...
    u8 *buf, int len)
    {
    if (buf == core::ptr::null_mut() || len < PIP_RESP_LENGTH_SIZE)
    return false;
//
...
#[no_mangle]
unsafe extern "C" fn gen5_idle_state_parse(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gen5_hid_description_header_parse(cyapa: *mut cyapa, reg_data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gen5_report_data_header_parse(cyapa: *mut cyapa, reg_data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gen5_cmd_resp_header_parse(cyapa: *mut cyapa, reg_data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen5_state_parse(cyapa: *mut cyapa, reg_data: *mut u8, len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_bl_initiate(cyapa: *mut cyapa, fw: *const firmware) -> c_int {
    ...
    int cmd_len;
    u16 cmd_data_len;
    let mut cmd_crc: u16 = 0;
    let mut meta_data_crc: u16 = 0;
    u8 resp_data[11];
    int resp_len;
    int records_num;
    u8 *data;
...
#[no_mangle]
unsafe extern "C" fn cyapa_sort_pip_bl_exit_data(cyapa: *mut cyapa, buf: *mut u8, len: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_bl_exit(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_bl_enter(cyapa: *mut cyapa) -> c_int {
...
// Already in bootloader mode, Skipping exit.
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !cyapa_is_pip_app_mode(cyapa)) -> else {
...
//
    ...
    cyapa.state = CYAPA_STATE_GEN5_BL;
#[no_mangle]
pub unsafe extern "C" fn if(CYAPA_GEN6: cyapa->gen ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_check_fw(cyapa: *mut cyapa, fw: *const firmware) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen5_change_power_state(cyapa: *mut cyapa, power_state: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen5_disable_pip_report(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_set_proximity(cyapa: *mut cyapa, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_deep_sleep(cyapa: *mut cyapa, state: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_resume_scanning(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_suspend_scanning(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twos_complement_to_s32(value: i32, num_bits: c_int) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn cyapa_parse_structure_data(data_format: u8, buf: *mut u8, buf_len: c_int) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen5_execute_panel_scan(cyapa: *mut cyapa) -> isize {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen5_bl_query_data(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen5_get_query_data(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cyapa_gen5_do_operational_check(cyapa: *mut cyapa) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_irq_cmd_handler(cyapa: *mut cyapa) -> bool {
...
// pip->resp_len);
    ...
    {
    struct input_dev *input = cyapa.input;
    let mut buttons: u8 = report_data.report_head[PIP_BUTTONS_OFFSET];
    ...
    {
    struct input_dev *input = cyapa.input;
    let mut event_id: u8 = PIP_GET_EVENT_ID(touch.touch_tip_event_id);
    let mut slot: c_int = PIP_GET_TOUCH_ID(touch.touch_tip_event_id);
    int x, y;
...
#[no_mangle]
pub unsafe extern "C" fn cyapa_pip_irq_handler(cyapa: *mut cyapa) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PIP_PROXIMITY_REPORT_ID: report_id ==) -> else {
