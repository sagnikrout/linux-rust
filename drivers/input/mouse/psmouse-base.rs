...
//! Source: drivers/input/mouse/psmouse-base.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
    let mut psmouse_max_proto: static unsigned int = PSMOUSE_AUTO;
    ...
    let mut psmouse_resolution: static unsigned int = 200;
    module_param_named(resolution, psmouse_resolution, uint, 0644);
    MODULE_PARM_DESC(resolution, "Resolution, in dpi.");
    let mut psmouse_rate: static unsigned int = 100;
    module_param_named(rate, psmouse_rate, uint, 0644);
    MODULE_PARM_DESC(rate, "Report rate, in reports per second.");
    let mut psmouse_smartscroll: static bool = true;
    ...
    let mut psmouse_resetafter: static unsigned int = 5;
...
#[no_mangle]
pub unsafe extern "C" fn psmouse_report_standard_buttons(dev: *mut input_dev, buttons: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn psmouse_report_standard_motion(dev: *mut input_dev, packet: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn psmouse_report_standard_packet(dev: *mut input_dev, packet: *mut u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn psmouse_process_byte(psmouse: *mut psmouse) -> psmouse_ret_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn __psmouse_set_state(psmouse: *mut psmouse, new_state: enum psmouse_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn psmouse_set_state(psmouse: *mut psmouse, new_state: enum psmouse_state) {
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_handle_byte(psmouse: *mut psmouse) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psmouse_handle_oob_data(psmouse: *mut psmouse, data: u8) {
...
#[no_mangle]
unsafe extern "C" fn psmouse_receive_byte(ps2dev: *mut ps2dev, data: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn psmouse_reset(psmouse: *mut psmouse) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn psmouse_set_resolution(psmouse: *mut psmouse, resolution: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_set_rate(psmouse: *mut psmouse, rate: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_set_scale(psmouse: *mut psmouse, scale: enum psmouse_scale) {
    static void psmouse_set_scale(struct psmouse *psmouse, enum psmouse_scale scale)
    {
    ps2_command(&psmouse.ps2dev, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_poll(psmouse: *mut psmouse) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psmouse_check_pnp_id(p: *const c_char, ids[]: *const *const c_char) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn psmouse_matches_pnp_id(psmouse: *mut psmouse, ids[]: *const *const c_char) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn genius_detect(psmouse: *mut psmouse, set_properties: bool) -> c_int {
    ...
    ps2_command(ps2dev,  core::ptr::null_mut(), PSMOUSE_CMD_SETSCALE11);
    ps2_command(ps2dev,  core::ptr::null_mut(), PSMOUSE_CMD_SETSCALE11);
    ps2_command(ps2dev,  core::ptr::null_mut(), PSMOUSE_CMD_SETSCALE11);
...
//
#[no_mangle]
unsafe extern "C" fn intellimouse_detect(psmouse: *mut psmouse, set_properties: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn im_explorer_detect(psmouse: *mut psmouse, set_properties: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn thinking_detect(psmouse: *mut psmouse, set_properties: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ps2bare_detect(psmouse: *mut psmouse, set_properties: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cortron_detect(psmouse: *mut psmouse, set_properties: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_apply_defaults(psmouse: *mut psmouse) {
    ...
    psmouse.pktsize = 3;
    psmouse.reconnect = core::ptr::null_mut();
    psmouse.fast_reconnect = core::ptr::null_mut();
    psmouse.disconnect = core::ptr::null_mut();
    psmouse.cleanup = core::ptr::null_mut();
    psmouse.pt_activate = core::ptr::null_mut();
    psmouse.pt_deactivate = core::ptr::null_mut();
    }
...
//
    ...
    {
    let mut synaptics_hardware: bool = false;
    int ret;
//
...
// Try ALPS TouchPad
    if (max_proto > PSMOUSE_IMEX) {
    ps2_command(&psmouse.ps2dev, core::ptr::null_mut(), PSMOUSE_CMD_RESET_DIS);
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_probe(psmouse: *mut psmouse) -> c_int {
...
// events.
//
    error = ps2_command(ps2dev, core::ptr::null_mut(), PSMOUSE_CMD_RESET_DIS);
    if (error)
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_initialize(psmouse: *mut psmouse) {
...
//
#[no_mangle]
pub unsafe extern "C" fn psmouse_activate(psmouse: *mut psmouse) -> c_int {
    int psmouse_activate(struct psmouse *psmouse)
    {
    if (ps2_command(&psmouse.ps2dev, core::ptr::null_mut(), PSMOUSE_CMD_ENABLE)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn psmouse_deactivate(psmouse: *mut psmouse) -> c_int {
    int psmouse_deactivate(struct psmouse *psmouse)
    {
    int error;
    error = ps2_command(&psmouse.ps2dev, core::ptr::null_mut(), PSMOUSE_CMD_DISABLE);
    if (error) {
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_resync(work: *mut work_struct) {
    static void psmouse_resync(struct work_struct *work)
    {
    struct psmouse *parent = core::ptr::null_mut(), *psmouse =
    container_of(work, struct psmouse, resync_work);
    struct serio *serio = psmouse.ps2dev.serio;
    let mut rc: psmouse_ret_t = PSMOUSE_GOOD_DATA;
    let mut failed: bool = false, enabled = false;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_cleanup(serio: *mut serio) {
    static void psmouse_cleanup(struct serio *serio)
    {
    struct psmouse *psmouse = psmouse_from_serio(serio);
    struct psmouse *parent = core::ptr::null_mut();
    guard(mutex)(&psmouse_mutex);
    if (serio.parent && serio.id.type == SERIO_PS_PSTHRU) {
    parent = psmouse_from_serio(serio.parent);
    psmouse_deactivate(parent);
...
//
    if (ps2_command(&psmouse.ps2dev, core::ptr::null_mut(), PSMOUSE_CMD_DISABLE))
...
//
    ps2_command(&psmouse.ps2dev, core::ptr::null_mut(), PSMOUSE_CMD_ENABLE);
    if (parent) {
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_disconnect(serio: *mut serio) {
    ...
    psmouse.protocol_handler = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
    static int psmouse_connect(struct serio *serio, struct serio_driver *drv)
    {
    struct psmouse *psmouse, *parent = core::ptr::null_mut();
    struct input_dev *input_dev;
    let mut retval: c_int = 0, error = -ENOMEM;
...
// give PT device some time to settle down before probing
    ...
    psmouse_switch_protocol(psmouse, core::ptr::null_mut());
...
// Smbus companion will be reporting events, not us.
    ...
    psmouse.dev = input_dev = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn __psmouse_reconnect(serio: *mut serio, fast_reconnect: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psmouse_reconnect(serio: *mut serio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psmouse_fast_reconnect(serio: *mut serio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psmouse_show_int_attr(psmouse: *mut psmouse, offset: *mut c_void, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn psmouse_set_int_attr(psmouse: *mut psmouse, offset: *mut c_void, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn psmouse_attr_show_protocol(psmouse: *mut psmouse, data: *mut c_void, buf: *mut c_char) -> isize {
    static ssize_t psmouse_attr_show_protocol(struct psmouse *psmouse, void *data, char *buf)
    {
    return sprintf(buf, "%s\n", psmouse.protocol.name);
    }
#[no_mangle]
unsafe extern "C" fn psmouse_attr_set_protocol(psmouse: *mut psmouse, data: *mut c_void, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn psmouse_attr_set_rate(psmouse: *mut psmouse, data: *mut c_void, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn psmouse_attr_set_resolution(psmouse: *mut psmouse, data: *mut c_void, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn psmouse_set_maxproto(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psmouse_get_maxproto(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    static int psmouse_get_maxproto(char *buffer, const struct kernel_param *kp)
    {
    let mut type: c_int = *((unsigned int *)kp.arg);
    return sprintf(buffer, "%s\n", psmouse_protocol_by_type(type).name);
    }
#[no_mangle]
unsafe extern "C" fn psmouse_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn psmouse_exit() -> void __exit {
