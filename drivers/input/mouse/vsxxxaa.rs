...
//! Source: drivers/input/mouse/vsxxxaa.c
#![no_std]
...
pub const VSXXXAA_INTRO_MASK: c_uint = 0x80;
pub const VSXXXAA_INTRO_HEAD: c_uint = 0x80;

    (((x) & VSXXXAA_INTRO_MASK) == VSXXXAA_INTRO_HEAD)
pub const VSXXXAA_PACKET_MASK: c_uint = 0xe0;
pub const VSXXXAA_PACKET_REL: c_uint = 0x80;
pub const VSXXXAA_PACKET_ABS: c_uint = 0xc0;
pub const VSXXXAA_PACKET_POR: c_uint = 0xa0;
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_drop_bytes(mouse: *mut vsxxxaa, num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_queue_byte(mouse: *mut vsxxxaa, byte: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_detection_done(mouse: *mut vsxxxaa) {
...
//
#[no_mangle]
unsafe extern "C" fn vsxxxaa_check_packet(mouse: *mut vsxxxaa, packet_len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_handle_REL_packet(mouse: *mut vsxxxaa) {
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_handle_ABS_packet(mouse: *mut vsxxxaa) {
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_handle_POR_packet(mouse: *mut vsxxxaa) {
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_parse_buffer(mouse: *mut vsxxxaa) {
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_disconnect(serio: *mut serio) {
...
#[no_mangle]
unsafe extern "C" fn vsxxxaa_connect(serio: *mut serio, drv: *mut serio_driver) -> c_int {
