...
//! Source: drivers/input/mouse/psmouse-smbus.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psmouse_smbus_dev {
    pub board: i2c_board_info,
    pub psmouse: *mut psmouse,
    pub client: *mut i2c_client,
    pub node: list_head,
    pub dead: bool,
    pub need_deactivate: bool,
}
...
#[no_mangle]
unsafe extern "C" fn psmouse_smbus_check_adapter(adapter: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn psmouse_smbus_detach_i2c_client(client: *mut i2c_client) {
    ...
    client.dev.platform_data = core::ptr::null_mut();
    if (!smbdev.dead) {
    psmouse_dbg(smbdev.psmouse,
...
#[no_mangle]
unsafe extern "C" fn psmouse_smbus_process_byte(psmouse: *mut psmouse) -> psmouse_ret_t {
    static psmouse_ret_t psmouse_smbus_process_byte(struct psmouse *psmouse)
    {
    return PSMOUSE_FULL_PACKET;
    }
#[no_mangle]
unsafe extern "C" fn psmouse_smbus_reconnect(psmouse: *mut psmouse) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psmouse_smbus_removal_work {
    pub work: work_struct,
    pub client: *mut i2c_client,
}

#[no_mangle]
unsafe extern "C" fn psmouse_smbus_remove_i2c_device(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn psmouse_smbus_schedule_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn psmouse_smbus_disconnect(psmouse: *mut psmouse) {
    ...
    psmouse.private = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn psmouse_smbus_create_companion(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn psmouse_smbus_cleanup(psmouse: *mut psmouse) {
...
//
    ...
    smbdev.board.platform_data = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn psmouse_smbus_module_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn psmouse_smbus_module_exit() {
