...
#[no_mangle]
unsafe extern "C" fn cdx_msi_write_msg(irq_data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cdx_msi_write_irq_lock(irq_data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cdx_msi_write_irq_unlock(irq_data: *mut irq_data) {
...
#[no_mangle]
pub unsafe extern "C" fn cdx_enable_msi(cdx_dev: *mut cdx_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cdx_disable_msi(cdx_dev: *mut cdx_device) {
...
#[no_mangle]
unsafe extern "C" fn cdx_msi_set_desc(arg: *mut msi_alloc_info_t, desc: *mut msi_desc) {
...
// Retrieve device ID from requestor ID using parent device
    ret = of_map_msi_id(parent.of_node, cdx_dev.msi_dev_id, core::ptr::null_mut(), &msi_spec);
    if (ret) {
