...
//! Source: drivers/interconnect/imx/imx8mp.c
#![no_std]
...
// Describe bus masters, slaves and connections between them
    ...
    DEFINE_BUS_SLAVE("OCRAM", IMX8MP_ICS_OCRAM, core::ptr::null_mut()),
    DEFINE_BUS_SLAVE("DRAM", IMX8MP_ICS_DRAM, core::ptr::null_mut()),
    ...
    DEFINE_BUS_INTERCONNECT("NOC_AUDIO", IMX8MP_ICN_AUDIO, core::ptr::null_mut(), IMX8MP_ICN_NOC),
    ...
    DEFINE_BUS_INTERCONNECT("NOC_GPU", IMX8MP_ICN_GPU, core::ptr::null_mut(), IMX8MP_ICN_NOC),
    DEFINE_BUS_MASTER("GPU 2D", IMX8MP_ICM_GPU2D, IMX8MP_ICN_GPU),
    DEFINE_BUS_MASTER("GPU 3D", IMX8MP_ICM_GPU3D, IMX8MP_ICN_GPU),
    DEFINE_BUS_INTERCONNECT("NOC_HDMI", IMX8MP_ICN_HDMI, core::ptr::null_mut(), IMX8MP_ICN_NOC),
    ...
    DEFINE_BUS_INTERCONNECT("NOC_HSIO", IMX8MP_ICN_HSIO, core::ptr::null_mut(), IMX8MP_ICN_NOC),
    ...
    DEFINE_BUS_INTERCONNECT("NOC_MEDIA", IMX8MP_ICN_MEDIA, core::ptr::null_mut(), IMX8MP_ICN_NOC),
    ...
    DEFINE_BUS_INTERCONNECT("NOC_VIDEO", IMX8MP_ICN_VIDEO, core::ptr::null_mut(), IMX8MP_ICN_NOC),
    ...
    DEFINE_BUS_INTERCONNECT("PL301_MAIN", IMX8MP_ICN_MAIN, core::ptr::null_mut(),
    IMX8MP_ICN_NOC, IMX8MP_ICS_OCRAM),
    };
#[no_mangle]
unsafe extern "C" fn imx8mp_icc_probe(pdev: *mut platform_device) -> c_int {
