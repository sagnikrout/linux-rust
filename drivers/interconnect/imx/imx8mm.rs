...
//! Source: drivers/interconnect/imx/imx8mm.c
#![no_std]
...
//
    ...
    DEFINE_BUS_SLAVE("OCRAM", IMX8MM_ICS_OCRAM, core::ptr::null_mut()),
...
// VPUMIX
    ...
    DEFINE_BUS_INTERCONNECT("PL301_VIDEO", IMX8MM_ICN_VIDEO, core::ptr::null_mut(), IMX8MM_ICN_NOC),
// GPUMIX
    DEFINE_BUS_MASTER("GPU 2D", IMX8MM_ICM_GPU2D, IMX8MM_ICN_GPU),
    DEFINE_BUS_MASTER("GPU 3D", IMX8MM_ICM_GPU3D, IMX8MM_ICN_GPU),
    DEFINE_BUS_INTERCONNECT("PL301_GPU", IMX8MM_ICN_GPU, core::ptr::null_mut(), IMX8MM_ICN_NOC),
// DISPLAYMIX
    DEFINE_BUS_MASTER("CSI", IMX8MM_ICM_CSI, IMX8MM_ICN_MIPI),
    DEFINE_BUS_MASTER("LCDIF", IMX8MM_ICM_LCDIF, IMX8MM_ICN_MIPI),
    DEFINE_BUS_INTERCONNECT("PL301_MIPI", IMX8MM_ICN_MIPI, core::ptr::null_mut(), IMX8MM_ICN_NOC),
// HSIO
    ...
    DEFINE_BUS_INTERCONNECT("PL301_HSIO", IMX8MM_ICN_HSIO, core::ptr::null_mut(), IMX8MM_ICN_NOC),
// Audio
    DEFINE_BUS_MASTER("SDMA2", IMX8MM_ICM_SDMA2, IMX8MM_ICN_AUDIO),
    DEFINE_BUS_MASTER("SDMA3", IMX8MM_ICM_SDMA3, IMX8MM_ICN_AUDIO),
    DEFINE_BUS_INTERCONNECT("PL301_AUDIO", IMX8MM_ICN_AUDIO, core::ptr::null_mut(), IMX8MM_ICN_MAIN),
// Ethernet
    DEFINE_BUS_MASTER("ENET", IMX8MM_ICM_ENET, IMX8MM_ICN_ENET),
    DEFINE_BUS_INTERCONNECT("PL301_ENET", IMX8MM_ICN_ENET, core::ptr::null_mut(), IMX8MM_ICN_MAIN),
// Other
    ...
    DEFINE_BUS_INTERCONNECT("PL301_MAIN", IMX8MM_ICN_MAIN, core::ptr::null_mut(),
    IMX8MM_ICN_NOC, IMX8MM_ICS_OCRAM),
    };
#[no_mangle]
unsafe extern "C" fn imx8mm_icc_probe(pdev: *mut platform_device) -> c_int {
