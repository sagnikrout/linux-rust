...
//! Source: drivers/interconnect/icc-clk.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct icc_clk_provider {
    pub provider: icc_provider,
    pub num_clocks: c_int,
    pub __counted_by(num_clocks): icc_clk_node clocks[],
}

    container_of(_provider, struct icc_clk_provider, provider)
#[no_mangle]
unsafe extern "C" fn icc_clk_set(src: *mut icc_node, dst: *mut icc_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icc_clk_get_bw(node: *mut icc_node, avg: *mut u32, peak: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_icc_release(res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_clk_unregister(provider: *mut icc_provider) {
