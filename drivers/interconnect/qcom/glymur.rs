...
//! Source: drivers/interconnect/qcom/glymur.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn glymur_qnoc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnoc_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qnoc_driver_exit() -> void __exit {
