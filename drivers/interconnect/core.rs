...
//! Source: drivers/interconnect/core.c
#![no_std]
...
pub const ICC_DYN_ID_START: c_int = 100000;
...
#[no_mangle]
unsafe extern "C" fn icc_summary_show_one(s: *mut seq_file, n: *mut icc_node) {
...
#[no_mangle]
unsafe extern "C" fn icc_summary_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    let mut avg_bw: u32 = 0, peak_bw = 0;
    if (!r.dev)
    continue;
    if (r.enabled) {
    avg_bw = r.avg_bw;
...
#[no_mangle]
unsafe extern "C" fn icc_graph_show_node(s: *mut seq_file, n: *mut icc_node) {
...
#[no_mangle]
unsafe extern "C" fn icc_graph_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    static int icc_graph_show(struct seq_file *s, void *data)
    {
    struct icc_provider *provider;
    struct icc_node *n;
    let mut cluster_index: c_int = 0;
    int i;
    seq_puts(s, "digraph {\n\trankdir = LR\n\tnode [shape = record]\n");
    mutex_lock(&icc_lock);
...
// reference to previous node was saved during path traversal
    ...
    struct icc_node *n, *node = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn aggregate_requests(node: *mut icc_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apply_constraints(path: *mut icc_path) -> c_int {
    static int apply_constraints(struct icc_path *path)
    {
    struct icc_node *next, *prev = core::ptr::null_mut();
...
//
    ...
    let mut idx: c_uint = spec.args[0];
...
//
    ...
    struct icc_node_data *data = core::ptr::null_mut();
    struct icc_provider *provider;
    if (!spec)
    return ERR_PTR(-EINVAL);
    mutex_lock(&icc_lock);
...
#[no_mangle]
unsafe extern "C" fn devm_icc_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_set_tag(path: *mut icc_path, tag: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_set_bw(path: *mut icc_path, avg_bw: u32, peak_bw: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __icc_enable(path: *mut icc_path, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn icc_enable(path: *mut icc_path) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn icc_disable(path: *mut icc_path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_put(path: *mut icc_path) {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_node_destroy(id: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_node_set_name(node: *mut icc_node, provider: *const icc_provider, name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_link_nodes(src_node: *mut icc_node, dst_node: *mut icc_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_link_create(node: *mut icc_node, dst_id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_node_add(node: *mut icc_node, provider: *mut icc_provider) {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_node_del(node: *mut icc_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_nodes_remove(provider: *mut icc_provider) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_provider_init(provider: *mut icc_provider) {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_provider_register(provider: *mut icc_provider) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn icc_provider_deregister(provider: *mut icc_provider) {
...
#[no_mangle]
unsafe extern "C" fn of_count_icc_providers(np: *mut device_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn icc_sync_state(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn icc_init() -> int __init {
...
// Teach lockdep about lock ordering wrt. shrinker:
    ...
    of_node_put(root);
    icc_debugfs_dir = debugfs_create_dir("interconnect", core::ptr::null_mut());
    debugfs_create_file("interconnect_summary", 0444,
    icc_debugfs_dir, core::ptr::null_mut(), &icc_summary_fops);
    debugfs_create_file("interconnect_graph", 0444,
    icc_debugfs_dir, core::ptr::null_mut(), &icc_graph_fops);
