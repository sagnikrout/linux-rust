...
//! Source: drivers/interconnect/icc-kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn icc_test_get_bw(node: *mut icc_node, avg: *mut u32, peak: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icc_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icc_test_exit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn icc_test_destroy_path(test: *mut kunit, path: *mut icc_path) {
...
#[no_mangle]
unsafe extern "C" fn icc_test_topology_integrity(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn icc_test_set_bw(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn icc_test_aggregation(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn icc_test_bulk_ops(test: *mut kunit) {
