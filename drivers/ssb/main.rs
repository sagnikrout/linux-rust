...
//
    let mut ssb_is_early_boot: static bool = 1;
...
#[no_mangle]
unsafe extern "C" fn ssb_device_put(dev: *mut ssb_device) {
...
#[no_mangle]
unsafe extern "C" fn ssb_device_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssb_device_suspend(dev: *mut device, state: pm_message_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_bus_resume(bus: *mut ssb_bus) -> c_int {
...
//
    bus.mapped_device = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ssb_bus_suspend(bus: *mut ssb_bus) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ssb_devices_freeze(bus: *mut ssb_bus, ctx: *mut ssb_freeze_context) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ssb_devices_thaw(ctx: *mut ssb_freeze_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssb_device_shutdown(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ssb_device_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ssb_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssb_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssb_device_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssb_buses_lock() {
    static void ssb_buses_lock(void)
    {
...
#[no_mangle]
unsafe extern "C" fn ssb_buses_unlock() {
    static void ssb_buses_unlock(void)
    {
// See the comment at the ssb_is_early_boot definition
    if (!ssb_is_early_boot)
...
#[no_mangle]
unsafe extern "C" fn ssb_devices_unregister(bus: *mut ssb_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_bus_unregister(bus: *mut ssb_bus) {
...
#[no_mangle]
unsafe extern "C" fn ssb_release_dev(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ssb_devices_register(bus: *mut ssb_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssb_attach_queued_buses() -> c_int {
    static int ssb_attach_queued_buses(void)
    {
    struct ssb_bus *bus, *n;
    let mut err: c_int = 0;
    let mut drop_them_all: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ssb_bus_pcibus_register(bus: *mut ssb_bus, host_pci: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_bus_host_soc_register(bus: *mut ssb_bus, baseaddr: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __ssb_driver_register(drv: *mut ssb_driver, owner: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_driver_unregister(drv: *mut ssb_driver) {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_set_devtypedata(dev: *mut ssb_device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn clkfactor_f6_resolve(v: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_calc_clock_rate(plltype: u32, n: u32, m: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_clockspeed(bus: *mut ssb_bus) -> u32 {
    ...
    &clkctl_n, &clkctl_m);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bus->chipco.dev) -> else {
...
#[no_mangle]
unsafe extern "C" fn ssb_tmslow_reject_bitmask(dev: *mut ssb_device) -> u32 {
    static u32 ssb_tmslow_reject_bitmask(struct ssb_device *dev)
    {
    let mut rev: u32 = ssb_read32(dev, SSB_IDLOW) & SSB_IDLOW_SSBREV;
...
#[no_mangle]
pub unsafe extern "C" fn ssb_device_is_enabled(dev: *mut ssb_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssb_flush_tmslow(dev: *mut ssb_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_device_enable(dev: *mut ssb_device, core_specific_flags: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_device_disable(dev: *mut ssb_device, core_specific_flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn ssb_dma_translation_special_bit(dev: *mut ssb_device) -> bool {
    static bool ssb_dma_translation_special_bit(struct ssb_device *dev)
    {
    let mut chip_id: u16 = dev.bus.chip_id;
...
#[no_mangle]
pub unsafe extern "C" fn ssb_dma_translation(dev: *mut ssb_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_bus_may_powerdown(bus: *mut ssb_bus) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_bus_powerup(bus: *mut ssb_bus, dynamic_pctl: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_commit_settings(bus: *mut ssb_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_admatch_base(adm: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_admatch_size(adm: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ssb_modinit() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ssb_modexit() -> void __exit {
