...
//! Source: drivers/ssb/driver_chipcommon_sflash.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ssb_sflash_cmd(cc: *mut ssb_chipcommon, opcode: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_sflash_init(cc: *mut ssb_chipcommon) -> c_int {
