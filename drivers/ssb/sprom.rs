...
// Common sprom device-attribute show-handler
    ...
    let mut sprom_size_words: usize = bus.sprom_size;
...
// Common sprom device-attribute store-handler
    ...
    {
    u16 *sprom;
    let mut res: c_int = 0, err = -ENOMEM;
    let mut sprom_size_words: usize = bus.sprom_size;
...
#[no_mangle]
pub unsafe extern "C" fn ssb_fill_sprom_with_fallback(bus: *mut ssb_bus, out: *mut ssb_sprom) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_is_sprom_available(bus: *mut ssb_bus) -> bool {
