...
//! Source: drivers/ssb/driver_chipcommon_pmu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ssb_chipco_pll_read(cc: *mut ssb_chipcommon, offset: u32) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmu0_plltab_entry {
    pub kHz.*/: *mut *mut u16 freq; / Crystal frequency in,
    pub /: *mut *mut u8 xf; / Crystal frequency value for PMU control,
    pub wb_int: u8,
    pub wb_frac: u32,
}
...
pub const SSB_PMU0_DEFAULT_XTALFREQ: c_int = 20000;
#[no_mangle]
unsafe extern "C" fn pmu0_plltab_find_entry(crystalfreq: u32) -> *const pmu0_plltab_entry {
...
// Tune the PLL to the crystal speed. crystalfreq is in kHz.
    ...
    const struct pmu0_plltab_entry *e = core::ptr::null_mut();
...
pub const SSB_PMU1_DEFAULT_XTALFREQ: c_int = 15360;
#[no_mangle]
unsafe extern "C" fn pmu1_plltab_find_entry(crystalfreq: u32) -> *const pmu1_plltab_entry {
...
// Tune the PLL to the crystal speed. crystalfreq is in kHz.
    ...
    {
    struct ssb_bus *bus = cc.dev.bus;
    const struct pmu1_plltab_entry *e = core::ptr::null_mut();
    let mut buffer_strength: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn ssb_pmu_pll_init(cc: *mut ssb_chipcommon) {
    ...
    crystalfreq = simple_strtoul(buf, core::ptr::null_mut(), 0);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmu_res_updown_tab_entry {
    pub /: *mut *mut u8 resource; / The resource number,
    pub /: *mut *mut u16 updown; / The updown value,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmu_res_depend_tab_entry {
    pub /: *mut *mut u8 resource; / The resource number,
    pub /: *mut *mut u8 task; / SET | ADD | REMOVE,
    pub /: *mut *mut u32 depend; / The depend mask,
}
...
#[no_mangle]
unsafe extern "C" fn ssb_pmu_resources_init(cc: *mut ssb_chipcommon) {
    static void ssb_pmu_resources_init(struct ssb_chipcommon *cc)
    {
    struct ssb_bus *bus = cc.dev.bus;
    let mut min_msk: u32 = 0, max_msk = 0;
    unsigned int i;
    const struct pmu_res_updown_tab_entry *updown_tab = core::ptr::null_mut();
    let mut updown_tab_size: c_uint = 0;
    const struct pmu_res_depend_tab_entry *depend_tab = core::ptr::null_mut();
    let mut depend_tab_size: c_uint = 0;
    switch (bus.chip_id) {
    case 0x4312:
    min_msk = 0xCBB;
    break;
...
#[no_mangle]
pub unsafe extern "C" fn ssb_pmu_init(cc: *mut ssb_chipcommon) {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_pmu_set_ldo_paref(cc: *mut ssb_chipcommon, on: bool) {
...
#[no_mangle]
unsafe extern "C" fn ssb_pmu_get_alp_clock_clk0(cc: *mut ssb_chipcommon) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_pmu_get_alp_clock(cc: *mut ssb_chipcommon) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_pmu_get_cpu_clock(cc: *mut ssb_chipcommon) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_pmu_get_controlclock(cc: *mut ssb_chipcommon) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn ssb_pmu_spuravoid_pllupdate(cc: *mut ssb_chipcommon, spuravoid: c_int) {
    void ssb_pmu_spuravoid_pllupdate(struct ssb_chipcommon *cc, int spuravoid)
    {
    let mut pmu_ctl: u32 = 0;
