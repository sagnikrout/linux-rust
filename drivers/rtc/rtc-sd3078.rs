...
//! Source: drivers/rtc/rtc-sd3078.c
#![no_std]
...
pub const SD3078_REG_SC: c_uint = 0x00;
pub const SD3078_REG_MN: c_uint = 0x01;
pub const SD3078_REG_HR: c_uint = 0x02;
pub const SD3078_REG_DW: c_uint = 0x03;
pub const SD3078_REG_DM: c_uint = 0x04;
pub const SD3078_REG_MO: c_uint = 0x05;
pub const SD3078_REG_YR: c_uint = 0x06;
pub const SD3078_REG_CTRL1: c_uint = 0x0f;
pub const SD3078_REG_CTRL2: c_uint = 0x10;
pub const SD3078_REG_CTRL3: c_uint = 0x11;
pub const KEY_WRITE1: c_uint = 0x80;
pub const KEY_WRITE2: c_uint = 0x04;
pub const KEY_WRITE3: c_uint = 0x80;
...
//
pub const WRITE_PROTECT_EN: c_int = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn sd3078_enable_reg_write(regmap: *mut regmap) {
...
//
#[no_mangle]
unsafe extern "C" fn sd3078_disable_reg_write(regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn sd3078_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd3078_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd3078_probe(client: *mut i2c_client) -> c_int {
