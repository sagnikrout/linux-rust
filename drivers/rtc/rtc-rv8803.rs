...
//! Source: drivers/rtc/rtc-rv8803.c
#![no_std]
...
pub const RV8803_I2C_TRY_COUNT: c_int = 4;
pub const RV8803_SEC: c_uint = 0x00;
pub const RV8803_MIN: c_uint = 0x01;
pub const RV8803_HOUR: c_uint = 0x02;
pub const RV8803_WEEK: c_uint = 0x03;
pub const RV8803_DAY: c_uint = 0x04;
pub const RV8803_MONTH: c_uint = 0x05;
pub const RV8803_YEAR: c_uint = 0x06;
pub const RV8803_RAM: c_uint = 0x07;
pub const RV8803_ALARM_MIN: c_uint = 0x08;
pub const RV8803_ALARM_HOUR: c_uint = 0x09;
pub const RV8803_ALARM_WEEK_OR_DAY: c_uint = 0x0A;
pub const RV8803_EXT: c_uint = 0x0D;
pub const RV8803_FLAG: c_uint = 0x0E;
pub const RV8803_CTRL: c_uint = 0x0F;
pub const RV8803_OSC_OFFSET: c_uint = 0x2C;

pub const RX8900_BACKUP_CTRL: c_uint = 0x18;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rv8803_data {
    pub client: *mut i2c_client,
    pub rtc: *mut rtc_device,
    pub flags_lock: mutex,
    pub ctrl: u8,
    pub backup: u8,
    pub alarm_invalid:1: u8,
    pub type: enum rv8803_type,
}

#[no_mangle]
unsafe extern "C" fn rv8803_read_reg(client: *const i2c_client, reg: u8) -> c_int {
    static int rv8803_read_reg(const struct i2c_client *client, u8 reg)
    {
    let mut try: c_int = RV8803_I2C_TRY_COUNT;
    s32 ret;
//
...
#[no_mangle]
unsafe extern "C" fn rv8803_write_reg(client: *const i2c_client, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_regs_init(rv8803: *mut rv8803_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_regs_reset(rv8803: *mut rv8803_data, full: bool) -> c_int {
...
//
    ...
    let mut ret: c_int = rv8803_regs_init(rv8803);
    if (ret)
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn rv8803_handle_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rv8803_get_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_get_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_ioctl(dev: *mut device, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx8900_trickle_charger_init(rv8803: *mut rv8803_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_regs_configure(rv8803: *mut rv8803_data) -> c_int {
    static int rv8803_regs_configure(struct rv8803_data *rv8803)
    {
    int err;
...
#[no_mangle]
unsafe extern "C" fn rv8803_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv8803_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), rv8803_handle_irq,
