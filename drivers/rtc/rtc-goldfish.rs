...
//! Source: drivers/rtc/rtc-goldfish.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn goldfish_rtc_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn goldfish_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goldfish_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goldfish_rtc_probe(pdev: *mut platform_device) -> c_int {
