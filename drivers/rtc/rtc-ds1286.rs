...
//! Source: drivers/rtc/rtc-ds1286.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ds1286_priv {
    pub rtc: *mut rtc_device,
    pub rtcregs: *mut u32 __iomem,
    pub lock: spinlock_t,
}

#[no_mangle]
pub unsafe extern "C" fn ds1286_rtc_read(priv: *mut ds1286_priv, reg: c_int) -> u8 {
    static inline u8 ds1286_rtc_read(struct ds1286_priv *priv, int reg)
    {
    return __raw_readl(&priv.rtcregs[reg]) & 0xff;
    }
#[no_mangle]
pub unsafe extern "C" fn ds1286_rtc_write(priv: *mut ds1286_priv, data: u8, reg: c_int) {
    static inline void ds1286_rtc_write(struct ds1286_priv *priv, u8 data, int reg)
    {
    __raw_writel(data, &priv.rtcregs[reg]);
    }
#[no_mangle]
unsafe extern "C" fn ds1286_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1286_ioctl(dev: *mut device, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1286_proc(dev: *mut device, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1286_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
    static int ds1286_read_time(struct device *dev, struct rtc_time *tm)
    {
    struct ds1286_priv *priv = dev_get_drvdata(dev);
    unsigned char save_control;
    unsigned long flags;
    let mut uip_watchdog: c_ulong = jiffies;
//
...
#[no_mangle]
unsafe extern "C" fn ds1286_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1286_read_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1286_set_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1286_probe(pdev: *mut platform_device) -> c_int {
