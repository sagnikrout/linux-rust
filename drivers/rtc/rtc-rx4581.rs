...
//! Source: drivers/rtc/rtc-rx4581.c
#![no_std]
...
pub const RX4581_REG_SC: c_uint = 0x00 /* Second in BCD */;
pub const RX4581_REG_MN: c_uint = 0x01 /* Minute in BCD */;
pub const RX4581_REG_HR: c_uint = 0x02 /* Hour in BCD */;
pub const RX4581_REG_DW: c_uint = 0x03 /* Day of Week */;
pub const RX4581_REG_DM: c_uint = 0x04 /* Day of Month in BCD */;
pub const RX4581_REG_MO: c_uint = 0x05 /* Month in BCD */;
pub const RX4581_REG_YR: c_uint = 0x06 /* Year in BCD */;
pub const RX4581_REG_RAM: c_uint = 0x07 /* RAM */;
pub const RX4581_REG_AMN: c_uint = 0x08 /* Alarm Min in BCD*/;
pub const RX4581_REG_AHR: c_uint = 0x09 /* Alarm Hour in BCD */;
pub const RX4581_REG_ADM: c_uint = 0x0A;
pub const RX4581_REG_ADW: c_uint = 0x0A;
pub const RX4581_REG_TMR0: c_uint = 0x0B;
pub const RX4581_REG_TMR1: c_uint = 0x0C;
pub const RX4581_REG_EXT: c_uint = 0x0D /* Extension Register */;
pub const RX4581_REG_FLAG: c_uint = 0x0E /* Flag Register */;
pub const RX4581_REG_CTRL: c_uint = 0x0F /* Control Register */;
// Flag Register bit definitions
pub const RX4581_FLAG_UF: c_uint = 0x20 /* Update */;
pub const RX4581_FLAG_TF: c_uint = 0x10 /* Timer */;
pub const RX4581_FLAG_AF: c_uint = 0x08 /* Alarm */;
pub const RX4581_FLAG_VLF: c_uint = 0x02 /* Voltage Low */;
// Control Register bit definitions
pub const RX4581_CTRL_UIE: c_uint = 0x20 /* Update Interrupt Enable */;
pub const RX4581_CTRL_TIE: c_uint = 0x10 /* Timer Interrupt Enable */;
pub const RX4581_CTRL_AIE: c_uint = 0x08 /* Alarm Interrupt Enable */;
pub const RX4581_CTRL_STOP: c_uint = 0x02 /* STOP bit */;
pub const RX4581_CTRL_RESET: c_uint = 0x01 /* RESET bit */;
...
//
#[no_mangle]
unsafe extern "C" fn rx4581_get_datetime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx4581_set_datetime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
// write register's data
    err = spi_write_then_read(spi, buf, 8, core::ptr::null_mut(), 0);
    if (err != 0) {
...
#[no_mangle]
unsafe extern "C" fn rx4581_probe(spi: *mut spi_device) -> c_int {
