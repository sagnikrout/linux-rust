...
//! Source: drivers/rtc/rtc-tps65910.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_read_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_set_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_set_calibration(dev: *mut device, calibration: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_get_calibration(dev: *mut device, calibration: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_read_offset(dev: *mut device, offset: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_set_offset(dev: *mut device, offset: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_interrupt(irq: c_int, rtc: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_probe(pdev: *mut platform_device) -> c_int {
    static int tps65910_rtc_probe(struct platform_device *pdev)
    {
    struct tps65910 *tps65910 = core::ptr::null_mut();
    struct tps65910_rtc *tps_rtc = core::ptr::null_mut();
    int ret;
    int irq;
    u32 rtc_reg;
...
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_rtc_resume(dev: *mut device) -> c_int {
