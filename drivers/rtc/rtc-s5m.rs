...
// been transferred.
//
pub const UDR_READ_RETRY_CNT: c_int = 5;
    enum {
    RTC_SEC = 0,
    RTC_MIN,
    RTC_HOUR,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s5m_rtc_reg_config {
// Number of registers used for setting time/alarm0/alarm1
    pub regs_count: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s5m_rtc_info {
    pub dev: *mut device,
    pub s5m87xx: *mut sec_pmic_dev,
    pub regmap: *mut regmap,
    pub rtc_dev: *mut rtc_device,
    pub irq: c_int,
    pub device_type: enum sec_device_type,
    pub rtc_24hr_mode: c_int,
    pub regs: *const s5m_rtc_reg_config,
}
...
#[no_mangle]
unsafe extern "C" fn s5m8767_tm_to_data(tm: *mut rtc_time, data: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5m8767_wait_for_udr_update(info: *mut s5m_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m8767_rtc_set_time_reg(info: *mut s5m_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m8767_rtc_set_alarm_reg(info: *mut s5m_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_stop_alarm(info: *mut s5m_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_start_alarm(info: *mut s5m_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_alarm_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn s5m8767_rtc_init_reg(info: *mut s5m_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_restart_s2mpg10(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_probe(pdev: *mut platform_device) -> c_int {
    ...
    info.irq = alarm_irq;
#[no_mangle]
pub unsafe extern "C" fn if(-ENXIO: alarm_irq ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5m_rtc_suspend(dev: *mut device) -> c_int {
