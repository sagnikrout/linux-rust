...
//! Source: drivers/rtc/rtc-isl12022.c
#![no_std]
...
pub const ISL12022_REG_SC: c_uint = 0x00;
pub const ISL12022_REG_MN: c_uint = 0x01;
pub const ISL12022_REG_HR: c_uint = 0x02;
pub const ISL12022_REG_DT: c_uint = 0x03;
pub const ISL12022_REG_MO: c_uint = 0x04;
pub const ISL12022_REG_YR: c_uint = 0x05;
pub const ISL12022_REG_DW: c_uint = 0x06;
// CSR - Control and status registers
pub const ISL12022_REG_SR: c_uint = 0x07;
pub const ISL12022_REG_INT: c_uint = 0x08;
pub const ISL12022_REG_PWR_VBAT: c_uint = 0x0a;
pub const ISL12022_REG_BETA: c_uint = 0x0d;
// ALARM - Alarm registers
pub const ISL12022_REG_SCA0: c_uint = 0x10;
pub const ISL12022_REG_MNA0: c_uint = 0x11;
pub const ISL12022_REG_HRA0: c_uint = 0x12;
pub const ISL12022_REG_DTA0: c_uint = 0x13;
pub const ISL12022_REG_MOA0: c_uint = 0x14;
pub const ISL12022_REG_DWA0: c_uint = 0x15;

// TEMP - Temperature sensor registers
pub const ISL12022_REG_TEMP_L: c_uint = 0x28;
// ISL register bits

pub const ISL12022_INT_FO_OFF: c_uint = 0x0;
pub const ISL12022_INT_FO_32K: c_uint = 0x1;
...
//
#[no_mangle]
unsafe extern "C" fn isl12022_hwmon_read_temp(dev: *mut device, mC: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12022_hwmon_register(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn isl12022_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12022_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12022_rtc_read_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12022_rtc_set_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12022_rtc_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn isl12022_setup_irq(dev: *mut device, irq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12022_rtc_ioctl(dev: *mut device, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12022_register_clock(dev: *mut device) -> c_int {
...
//
    ...
    if (ret)
    return ret;
    hw = devm_clk_hw_register_fixed_rate(dev, "isl12022", core::ptr::null_mut(), 0, 32768);
    if (IS_ERR(hw))
    return PTR_ERR(hw);
...
#[no_mangle]
unsafe extern "C" fn isl12022_set_trip_levels(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn isl12022_probe(client: *mut i2c_client) -> c_int {
