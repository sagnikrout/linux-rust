...
//! Source: drivers/rtc/rtc-rs5c372.c
#![no_std]
...
//
pub const RS5C372_REG_SECS: c_int = 0;
pub const RS5C372_REG_MINS: c_int = 1;
pub const RS5C372_REG_HOURS: c_int = 2;
pub const RS5C372_REG_WDAY: c_int = 3;
pub const RS5C372_REG_DAY: c_int = 4;
pub const RS5C372_REG_MONTH: c_int = 5;
pub const RS5C372_REG_YEAR: c_int = 6;
pub const RS5C372_REG_TRIM: c_int = 7;

pub const RS5C_REG_ALARM_A_HOURS: c_int = 9;
pub const RS5C_REG_ALARM_A_WDAY: c_int = 10;

pub const RS5C_REG_ALARM_B_HOURS: c_int = 12;

pub const RS5C_REG_CTRL1: c_int = 14;

pub const RS5C_REG_CTRL2: c_int = 15;
...
pub struct rs5c372 {
    ...
    pub type: enum rtc_type,
    pub time24:1: unsigned,
    pub has_irq:1: unsigned,
    pub smbus:1: unsigned,
    pub buf: [c_char; 17],
    pub regs: *mut c_char,
}

#[no_mangle]
unsafe extern "C" fn rs5c_get_regs(rs5c: *mut rs5c372) -> c_int {
...
//
    if (rs5c.smbus) {
    let mut addr: c_int = RS5C_ADDR(RS5C372_REG_SECS);
    let mut size: c_int = sizeof(rs5c.buf) - 1;
...
#[no_mangle]
unsafe extern "C" fn rs5c_reg2hr(rs5c: *mut rs5c372, reg: unsigned) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn rs5c_hr2reg(rs5c: *mut rs5c372, hour: unsigned) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn rs5c372_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
    static int rs5c372_rtc_read_time(struct device *dev, struct rtc_time *tm)
    {
    struct i2c_client *client = to_i2c_client(dev);
    struct rs5c372	*rs5c = i2c_get_clientdata(client);
    let mut status: c_int = rs5c_get_regs(rs5c);
    let mut ctrl2: c_uchar = rs5c.regs[RS5C_REG_CTRL2];
    if (status < 0)
    return status;
    switch (rs5c.type) {
    case rtc_r2025sd:
...
#[no_mangle]
unsafe extern "C" fn rs5c372_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
// Macro flag: #define	NEED_TRIM

// Macro flag: #define	NEED_TRIM

#[no_mangle]
unsafe extern "C" fn rs5c372_get_trim(client: *mut i2c_client, osc: *mut c_int, trim: *mut c_int) -> c_int {
    static int rs5c372_get_trim(struct i2c_client *client, int *osc, int *trim)
    {
    struct rs5c372 *rs5c372 = i2c_get_clientdata(client);
    let mut tmp: u8 = rs5c372.regs[RS5C372_REG_TRIM];
    if (osc) {
...
#[no_mangle]
unsafe extern "C" fn rs5c_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rs5c_read_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs5c_set_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs5c372_rtc_proc(dev: *mut device, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs5c372_ioctl(dev: *mut device, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs5c372_read_offset(dev: *mut device, offset: *mut c_long) -> c_int {
    static int rs5c372_read_offset(struct device *dev, long *offset)
    {
    struct rs5c372 *rs5c = i2c_get_clientdata(to_i2c_client(dev));
    let mut val: u8 = rs5c.regs[RS5C372_REG_TRIM];
    let mut ppb_per_step: c_long = 0;
    let mut decr: bool = val & RS5C372_TRIM_DECR;
    switch (rs5c.type) {
    case rtc_r2221tl:
...
#[no_mangle]
unsafe extern "C" fn rs5c372_set_offset(dev: *mut device, offset: c_long) -> c_int {
    static int rs5c372_set_offset(struct device *dev, long offset)
    {
    struct rs5c372 *rs5c = i2c_get_clientdata(to_i2c_client(dev));
    let mut addr: c_int = RS5C_ADDR(RS5C372_REG_TRIM);
    let mut val: u8 = 0;
    let mut tmp: u8 = 0;
    let mut ppb_per_step: c_long = 3051;
    let mut steps: c_long = LONG_MIN;
    switch (rs5c.type) {
    case rtc_rs5c372a:
    case rtc_rs5c372b:
...
//
    ...
    {
    int err, trim;
    err = rs5c372_get_trim(to_i2c_client(dev), core::ptr::null_mut(), &trim);
    if (err)
    return err;
    return sprintf(buf, "%d\n", trim);
    }
    static DEVICE_ATTR(trim, S_IRUGO, rs5c372_sysfs_show_trim, core::ptr::null_mut());
    static ssize_t rs5c372_sysfs_show_osc(struct device *dev,
    struct device_attribute *attr, char *buf)
    {
    int err, osc;
    err = rs5c372_get_trim(to_i2c_client(dev), &osc, core::ptr::null_mut());
    if (err)
    return err;
    return sprintf(buf, "%d.%03d KHz\n", osc / 1000, osc % 1000);
    }
    static DEVICE_ATTR(osc, S_IRUGO, rs5c372_sysfs_show_osc, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn rs5c_sysfs_register(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs5c_sysfs_unregister(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn rs5c_oscillator_setup(rs5c372: *mut rs5c372) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs5c372_probe(client: *mut i2c_client) -> c_int {
    static int rs5c372_probe(struct i2c_client *client)
    {
    let mut err: c_int = 0;
    let mut smbus_mode: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn rs5c372_remove(client: *mut i2c_client) {
