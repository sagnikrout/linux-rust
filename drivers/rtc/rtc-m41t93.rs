...
//! Source: drivers/rtc/rtc-m41t93.c
#![no_std]
...
pub const M41T93_REG_SSEC: c_int = 0;
pub const M41T93_REG_ST_SEC: c_int = 1;
pub const M41T93_REG_MIN: c_int = 2;
pub const M41T93_REG_CENT_HOUR: c_int = 3;
pub const M41T93_REG_WDAY: c_int = 4;
pub const M41T93_REG_DAY: c_int = 5;
pub const M41T93_REG_MON: c_int = 6;
pub const M41T93_REG_YEAR: c_int = 7;
pub const M41T93_REG_AL1_MONTH: c_uint = 0xa;
pub const M41T93_REG_AL1_DATE: c_uint = 0xb;
pub const M41T93_REG_AL1_HOUR: c_uint = 0xc;
pub const M41T93_REG_AL1_MIN: c_uint = 0xd;
pub const M41T93_REG_AL1_SEC: c_uint = 0xe;

pub const M41T93_SRAM_BASE: c_uint = 0x19;
pub const M41T93_REG_SQW: c_uint = 0x13;
pub const M41T93_SQW_RS_MASK: c_uint = 0xf0;
pub const M41T93_SQW_RS_SHIFT: c_int = 4;

pub const M41T93_REG_WATCHDOG: c_uint = 0x9;
pub const M41T93_WDT_RB_MASK: c_uint = 0x3;
pub const M41T93_WDT_BMB_MASK: c_uint = 0x7c;
pub const M41T93_WDT_BMB_SHIFT: c_int = 2;
pub const M41T93_REG_ALM_HOUR_HT: c_uint = 0xc;
pub const M41T93_REG_FLAGS: c_uint = 0xf;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct m41t93_data {
...
#[no_mangle]
unsafe extern "C" fn m41t93_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
// restarted.
    let mut reset_osc: u8 = buf[M41T93_REG_ST_SEC] | M41T93_FLAG_ST;
    dev_warn(dev,
...
#[no_mangle]
unsafe extern "C" fn m41t93_get_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_get_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_clk_sqw_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_clk_sqw_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn m41t93_clk_sqw_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtc_m41t93_clks_register(dev: *mut device, m41t93: *mut m41t93_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_wdt_start(wdd: *mut watchdog_device) -> c_int {
    static int m41t93_wdt_start(struct watchdog_device *wdd)
    {
    return m41t93_wdt_ping(wdd);
    }
#[no_mangle]
unsafe extern "C" fn m41t93_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_watchdog_register(dev: *mut device, m41t93: *mut m41t93_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t93_probe(spi: *mut spi_device) -> c_int {
