...
//
#[no_mangle]
unsafe extern "C" fn rtc_does_wakealarm(rtc: *mut rtc_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn rtc_add_groups(rtc: *mut rtc_device, grps: *const attribute_group) -> c_int {
    int rtc_add_groups(struct rtc_device *rtc, const struct attribute_group **grps)
    {
    let mut old_cnt: usize = 0, add_cnt = 0, new_cnt;
...
// No need to modify current groups if nothing new is provided
    ...
    groups[old_cnt + add_cnt] = core::ptr::null_mut();
    old = rtc.dev.groups;
...
#[no_mangle]
pub unsafe extern "C" fn rtc_add_group(rtc: *mut rtc_device, grp: *const attribute_group) -> c_int {
    int rtc_add_group(struct rtc_device *rtc, const struct attribute_group *grp)
    {
    const struct attribute_group *groups[] = { grp, core::ptr::null_mut() };
