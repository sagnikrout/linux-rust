...
//! Source: drivers/rtc/rtc-ac100.c
#![no_std]
...
pub const AC100_CLKOUT_PRE_DIV_SHIFT: c_int = 5;
pub const AC100_CLKOUT_PRE_DIV_WIDTH: c_int = 3;
pub const AC100_CLKOUT_MUX_SHIFT: c_int = 4;
pub const AC100_CLKOUT_MUX_WIDTH: c_int = 1;
pub const AC100_CLKOUT_DIV_SHIFT: c_int = 1;
pub const AC100_CLKOUT_DIV_WIDTH: c_int = 3;
...
// driver.
//
pub const AC100_YEAR_MIN: c_int = 1970;
pub const AC100_YEAR_MAX: c_int = 2069;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ac100_clkout {
    pub hw: clk_hw,
    pub regmap: *mut regmap,
    pub offset: u8,
}

pub const AC100_RTC_32K_RATE: c_int = 32768;
pub const AC100_CLKOUT_NUM: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ac100_rtc_dev {
    pub rtc: *mut rtc_device,
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub irq: c_int,
    pub alarm: c_ulong,
    pub rtc_32k_clk: *mut clk_hw,
    pub clks: [ac100_clkout; AC100_CLKOUT_NUM],
...
// Handle pre-divider first
    ...
    return divider_recalc_rate(hw, prate, div, core::ptr::null_mut(),
...
//
    ...
    if (prate == AC100_RTC_32K_RATE) {
    let mut div_req: clk_rate_request = *req;
    div_req.best_parent_rate = prate;
    ret = divider_determine_rate(hw, &div_req, core::ptr::null_mut(),
    AC100_CLKOUT_DIV_WIDTH,
    CLK_DIVIDER_POWER_OF_TWO);
    ...
    {
    struct ac100_clkout *clk = to_ac100_clkout(hw);
    let mut div: c_int = 0, pre_div = 0;
    do {
    div = divider_get_val(rate * ac100_clkout_prediv[pre_div].div,
    prate, core::ptr::null_mut(), AC100_CLKOUT_DIV_WIDTH,
    CLK_DIVIDER_POWER_OF_TWO);
    if (div >= 0)
    break;
...
#[no_mangle]
unsafe extern "C" fn ac100_clkout_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_clkout_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ac100_clkout_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_clkout_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ac100_clkout_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_register_clks(chip: *mut ac100_rtc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_unregister_clks(chip: *mut ac100_rtc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ac100_rtc_get_time(dev: *mut device, rtc_tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_set_time(dev: *mut device, rtc_tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_alarm_irq_enable(dev: *mut device, en: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_get_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = devm_request_threaded_irq(&pdev.dev, chip.irq, core::ptr::null_mut(),
    ac100_rtc_irq,
...
#[no_mangle]
unsafe extern "C" fn ac100_rtc_remove(pdev: *mut platform_device) {
