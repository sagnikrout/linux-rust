...
//! Source: drivers/rtc/rtc-max6916.c
#![no_std]
...
pub const MAX6916_SECONDS_REG: c_uint = 0x01;
pub const MAX6916_MINUTES_REG: c_uint = 0x02;
pub const MAX6916_HOURS_REG: c_uint = 0x03;
pub const MAX6916_DATE_REG: c_uint = 0x04;
pub const MAX6916_MONTH_REG: c_uint = 0x05;
pub const MAX6916_DAY_REG: c_uint = 0x06;
pub const MAX6916_YEAR_REG: c_uint = 0x07;
pub const MAX6916_CONTROL_REG: c_uint = 0x08;
pub const MAX6916_STATUS_REG: c_uint = 0x0C;
pub const MAX6916_CLOCK_BURST: c_uint = 0x3F;
...
#[no_mangle]
unsafe extern "C" fn max6916_read_time(dev: *mut device, dt: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max6916_set_time(dev: *mut device, dt: *mut rtc_time) -> c_int {
...
// write the rtc settings
    return spi_write_then_read(spi, buf, 9, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn max6916_probe(spi: *mut spi_device) -> c_int {
