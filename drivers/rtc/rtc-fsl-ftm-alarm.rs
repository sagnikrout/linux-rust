...
// of FlexTimer Module
//
pub const FTM_SC_CLKS_FIXED_FREQ: c_uint = 0x02;
pub const FIXED_FREQ_CLK: c_int = 32000;
// Select 128 (2^7) as divider factor

// Maximum counter value in FlexTimer's CNT registers
pub const MAX_COUNT_VAL: c_uint = 0xffff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ftm_rtc {
...
#[no_mangle]
pub unsafe extern "C" fn rtc_readl(dev: *mut ftm_rtc, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn rtc_writel(dev: *mut ftm_rtc, reg: u32, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_counter_enable(rtc: *mut ftm_rtc) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_counter_disable(rtc: *mut ftm_rtc) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_irq_acknowledge(rtc: *mut ftm_rtc) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_irq_enable(rtc: *mut ftm_rtc) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_irq_disable(rtc: *mut ftm_rtc) {
...
#[no_mangle]
pub unsafe extern "C" fn ftm_reset_counter(rtc: *mut ftm_rtc) {
...
#[no_mangle]
unsafe extern "C" fn ftm_clean_alarm(rtc: *mut ftm_rtc) {
...
#[no_mangle]
unsafe extern "C" fn ftm_rtc_alarm_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ftm_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ftm_rtc_read_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ftm_rtc_set_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ftm_rtc_probe(pdev: *mut platform_device) -> c_int {
