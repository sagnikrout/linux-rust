...
//! Source: drivers/rtc/rtc-mc13xxx.c
#![no_std]
...
pub const MC13XXX_RTCTOD: c_int = 20;
pub const MC13XXX_RTCTODA: c_int = 21;
pub const MC13XXX_RTCDAY: c_int = 22;
pub const MC13XXX_RTCDAYA: c_int = 23;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mc13xxx_rtc {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_rtc_read_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_rtc_set_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_rtc_alarm_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_rtc_reset_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_rtc_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_rtc_remove(pdev: *mut platform_device) {
