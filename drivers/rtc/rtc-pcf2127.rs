...
// Control register 1
pub const PCF2127_REG_CTRL1: c_uint = 0x00;

// Control register 2
pub const PCF2127_REG_CTRL2: c_uint = 0x01;

// Control register 3
pub const PCF2127_REG_CTRL3: c_uint = 0x02;

// Time and date registers
pub const PCF2127_REG_TIME_BASE: c_uint = 0x03;

// Alarm registers
pub const PCF2127_REG_ALARM_BASE: c_uint = 0x0A;

// CLKOUT control register
pub const PCF2127_REG_CLKOUT: c_uint = 0x0f;

// Watchdog registers
pub const PCF2127_REG_WD_CTL: c_uint = 0x10;

pub const PCF2127_REG_WD_VAL: c_uint = 0x11;
// Tamper timestamp1 registers
pub const PCF2127_REG_TS1_BASE: c_uint = 0x12;
...
//
pub const PCF2127_REG_RAM_ADDR_MSB: c_uint = 0x1A;
pub const PCF2127_REG_RAM_WRT_CMD: c_uint = 0x1C;
pub const PCF2127_REG_RAM_RD_CMD: c_uint = 0x1D;
// Watchdog timer value constants
pub const PCF2127_WD_VAL_STOP: c_int = 0;
// PCF2127/29 watchdog timer value constants

pub const PCF2127_WD_MIN_HW_HEARTBEAT_MS: c_int = 500;
// PCF2131 watchdog timer value constants

pub const PCF2131_WD_MIN_HW_HEARTBEAT_MS: c_int = 4000;
pub const PCF2127_WD_DEFAULT_TIMEOUT_S: c_int = 60;
...
pub const PCF2127_MAX_TS_SUPPORTED: c_int = 4;
// Control register 4
pub const PCF2131_REG_CTRL4: c_uint = 0x03;

// Control register 5
pub const PCF2131_REG_CTRL5: c_uint = 0x04;

// Software reset register
pub const PCF2131_REG_SR_RESET: c_uint = 0x05;

// Time and date registers
pub const PCF2131_REG_TIME_BASE: c_uint = 0x07;
// Alarm registers
pub const PCF2131_REG_ALARM_BASE: c_uint = 0x0E;
// CLKOUT control register
pub const PCF2131_REG_CLKOUT: c_uint = 0x13;
// Watchdog registers
pub const PCF2131_REG_WD_CTL: c_uint = 0x35;
pub const PCF2131_REG_WD_VAL: c_uint = 0x36;
// Tamper timestamp1 registers
pub const PCF2131_REG_TS1_BASE: c_uint = 0x14;
// Tamper timestamp2 registers
pub const PCF2131_REG_TS2_BASE: c_uint = 0x1B;
// Tamper timestamp3 registers
pub const PCF2131_REG_TS3_BASE: c_uint = 0x22;
// Tamper timestamp4 registers
pub const PCF2131_REG_TS4_BASE: c_uint = 0x29;
// Interrupt mask registers
pub const PCF2131_REG_INT_A_MASK1: c_uint = 0x31;
pub const PCF2131_REG_INT_A_MASK2: c_uint = 0x32;
pub const PCF2131_REG_INT_B_MASK1: c_uint = 0x33;
pub const PCF2131_REG_INT_B_MASK2: c_uint = 0x34;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcf21xx_ts_config {
    pub /: *mut *mut u8 reg_base; / Base register to read timestamp values.,
//
// If the TS input pin is driven to GND, an interrupt can be generated
// (supported by all variants).
//
    pub /: *mut *mut u8 gnd_detect_reg; / Interrupt control register address.,
    pub /: *mut *mut u8 gnd_detect_bit; / Interrupt bit.,
//
...
// on variant).
//
    pub /: *mut *mut u8 inter_detect_reg; / Interrupt control register address.,
    pub /: *mut *mut u8 inter_detect_bit; / Interrupt bit.,
    pub /: *mut *mut u8 ie_reg; / Interrupt enable control register.,
    pub /: *mut *mut u8 ie_bit; / Interrupt enable bit.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcf21xx_config {
    pub /: *mut *mut int type; / IC variant,
    pub max_register: c_int,
    pub has_nvmem:1: c_uint,
    pub has_bit_wd_ctl_cd0:1: c_uint,
    pub /: *mut *mut unsigned int wd_val_reg_readable:1; / If watchdog value register can be read.,
    pub /: *mut *mut unsigned int has_int_a_b:1; / PCF2131 supports two interrupt outputs.,
    pub /: *mut *mut u8 reg_time_base; / Time/date base register.,
    pub /: *mut *mut u8 regs_alarm_base; / Alarm function base registers.,
    pub /: *mut *mut u8 reg_wd_ctl; / Watchdog control register.,
    pub /: *mut *mut u8 reg_wd_val; / Watchdog value register.,
    pub /: *mut *mut u8 reg_clkout; / Clkout register.,
    pub /: *mut *mut int wdd_clock_hz_x1000; / Watchdog clock in Hz multiplicated by 1000,
    pub wdd_min_hw_heartbeat_ms: c_int,
    pub ts_count: c_uint,
    pub ts: [pcf21xx_ts_config; PCF2127_MAX_TS_SUPPORTED],
    pub attribute_group: attribute_group,
}
...
pub struct pcf2127 {
    ...
    pub cfg: *const pcf21xx_config,
    pub irq_enabled: bool,
    pub /: *mut *mut time64_t ts[PCF2127_MAX_TS_SUPPORTED]; / Timestamp values.,
    pub /: *mut *mut bool ts_valid[PCF2127_MAX_TS_SUPPORTED]; / Timestamp valid indication.,
}
...
//
#[no_mangle]
unsafe extern "C" fn pcf2127_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_param_get(dev: *mut device, param: *mut rtc_param) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x6: value <) -> else {
    else if (value < 0x6)
...
#[no_mangle]
unsafe extern "C" fn pcf2127_param_set(dev: *mut device, param: *mut rtc_param) -> c_int {
...
// watchdog driver
#[no_mangle]
unsafe extern "C" fn pcf2127_wdt_ping(wdd: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcf2127_wdt_active_ping(wdd: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_wdt_start(wdd: *mut watchdog_device) -> c_int {
    static int pcf2127_wdt_start(struct watchdog_device *wdd)
    {
    return pcf2127_wdt_ping(wdd);
    }
#[no_mangle]
unsafe extern "C" fn pcf2127_wdt_stop(wdd: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcf2127_watchdog_get_period(n: c_int, f1000: c_int) -> c_int {
    static int pcf2127_watchdog_get_period(int n, int f1000)
    {
    return (1000 * (n - 1)) / f1000;
    }
#[no_mangle]
unsafe extern "C" fn pcf2127_watchdog_init(dev: *mut device, pcf2127: *mut pcf2127) -> c_int {
...
// Alarm
#[no_mangle]
unsafe extern "C" fn pcf2127_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_rtc_alarm_irq_enable(dev: *mut device, enable: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_rtc_ts_snapshot(dev: *mut device, ts_id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_rtc_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
// Clear intermediate level interrupt bit if supported.
    ...
    let mut valid_low: u8 = 0;
    let mut valid_inter: u8 = 0;
    unsigned int ctrl;
...
//
#[no_mangle]
unsafe extern "C" fn pcf2127_enable_ts(dev: *mut device, ts_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_configure_interrupt_pins(dev: *mut device) -> c_int {
...
//
    ...
    ret = devm_request_threaded_irq(dev, alarm_irq, core::ptr::null_mut(),
    pcf2127_rtc_irq,
    flags | IRQF_ONESHOT,
    dev_name(dev), dev);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_i2c_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_i2c_register_driver() -> c_int {
    static int pcf2127_i2c_register_driver(void)
    {
    return i2c_add_driver(&pcf2127_i2c_driver);
    }
#[no_mangle]
unsafe extern "C" fn pcf2127_i2c_unregister_driver() {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_spi_probe(spi: *mut spi_device) -> c_int {
    ...
    let mut type: enum pcf21xx_type = spi_get_device_id(spi).driver_data;
...
#[no_mangle]
unsafe extern "C" fn pcf2127_spi_register_driver() -> c_int {
    static int pcf2127_spi_register_driver(void)
    {
    return spi_register_driver(&pcf2127_spi_driver);
    }
#[no_mangle]
unsafe extern "C" fn pcf2127_spi_unregister_driver() {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pcf2127_exit() -> void __exit {
