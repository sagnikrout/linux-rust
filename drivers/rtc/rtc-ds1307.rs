...
//! Source: drivers/rtc/rtc-ds1307.c
#![no_std]
...
pub const DS1307_REG_SECS: c_uint = 0x00	/* 00-59 */;

pub const DS1307_REG_MIN: c_uint = 0x01	/* 00-59 */;

pub const DS1307_REG_HOUR: c_uint = 0x02	/* 00-23, or 1-12{am,pm} */;

pub const DS1307_REG_WDAY: c_uint = 0x03	/* 01-07 */;

pub const DS1307_REG_MDAY: c_uint = 0x04	/* 01-31 */;
pub const DS1307_REG_MONTH: c_uint = 0x05	/* 01-12 */;

pub const DS1307_REG_YEAR: c_uint = 0x06	/* 00-99 */;
//
// Other registers (control, status, alarms, trickle charge, NVRAM, etc)
// start at 7, and they differ a LOT. Only control and status matter for
// basic RTC date and time functionality; be careful using them.
//
pub const DS1307_REG_CONTROL: c_uint = 0x07		/* or ds1338 */;

pub const DS1337_REG_CONTROL: c_uint = 0x0e;

pub const DS1340_REG_CONTROL: c_uint = 0x07;

pub const DS1340_REG_FLAG: c_uint = 0x09;

pub const DS1337_REG_STATUS: c_uint = 0x0f;

pub const DS1339_REG_ALARM1_SECS: c_uint = 0x07;
pub const DS13XX_TRICKLE_CHARGER_MAGIC: c_uint = 0xa0;
pub const RX8025_REG_CTRL1: c_uint = 0x0e;

pub const RX8025_REG_CTRL2: c_uint = 0x0f;

pub const RX8130_REG_ALARM_MIN: c_uint = 0x17;
pub const RX8130_REG_ALARM_HOUR: c_uint = 0x18;
pub const RX8130_REG_ALARM_WEEK_OR_DAY: c_uint = 0x19;
pub const RX8130_REG_EXTENSION: c_uint = 0x1c;

pub const RX8130_REG_FLAG: c_uint = 0x1d;

pub const RX8130_REG_CONTROL0: c_uint = 0x1e;

pub const RX8130_REG_CONTROL1: c_uint = 0x1f;

pub const MCP794XX_REG_CONTROL: c_uint = 0x07;

pub const MCP794XX_REG_ALARM0_BASE: c_uint = 0x0a;
pub const MCP794XX_REG_ALARM0_CTRL: c_uint = 0x0d;
pub const MCP794XX_REG_ALARM1_BASE: c_uint = 0x11;
pub const MCP794XX_REG_ALARM1_CTRL: c_uint = 0x14;

    MCP794XX_BIT_ALMX_C1 | \
    MCP794XX_BIT_ALMX_C2)
pub const M41TXX_REG_CONTROL: c_uint = 0x07;

pub const DS1388_REG_WDOG_HUN_SECS: c_uint = 0x08;
pub const DS1388_REG_WDOG_SECS: c_uint = 0x09;
pub const DS1388_REG_FLAG: c_uint = 0x0b;

pub const DS1388_REG_CONTROL: c_uint = 0x0c;

// negative offset step is -2.034ppm
pub const M41TXX_NEG_OFFSET_STEP_PPB: c_int = 2034;
// positive offset step is +4.068ppm
pub const M41TXX_POS_OFFSET_STEP_PPB: c_int = 4068;
// Min and max values supported with 'offset' interface by M41TXX

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ds1307 {
    pub type: enum ds_type,
    pub dev: *mut device,
...
pub struct chip_desc {
    pub alarm:1: unsigned,
    pub nvram_offset: u16,
    pub nvram_size: u16,
    pub /: *mut *mut u8 offset; / register's offset,
    pub century_reg: u8,
    pub century_enable_bit: u8,
    pub century_bit: u8,
    pub bbsqi_bit: u8,
    pub irq_handler: irq_handler_t,
    pub rtc_ops: *const rtc_class_ops,
    pub trickle_charger_reg: u16,
    u8			(*do_trickle_setup)(struct ds1307 *, u32,
// Does the RTC require trickle-resistor-ohms to select the value of
// the resistor between Vcc and Vbackup?
//
    pub requires_trickle_resistor: bool,
...
//
    pub charge_default: bool,
}

    static const struct chip_desc chips[last_ds_type];
#[no_mangle]
unsafe extern "C" fn ds1307_get_time(dev: *mut device, t: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1307_set_time(dev: *mut device, t: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1337_read_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1337_set_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1307_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_trickle_setup_ds1339(ds1307: *mut ds1307, ohms: u32, diode: bool) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn do_trickle_setup_rx8130(ds1307: *mut ds1307, ohms: u32, diode: bool) -> u8 {
    static u8 do_trickle_setup_rx8130(struct ds1307 *ds1307, u32 ohms, bool diode)
    {
// make sure that the backup battery is enabled
    let mut setup: u8 = RX8130_REG_CONTROL1_INIEN;
    if (diode)
    setup |= RX8130_REG_CONTROL1_CHGEN;
    return setup;
    }
#[no_mangle]
unsafe extern "C" fn rx8130_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rx8130_read_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx8130_set_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx8130_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp794xx_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mcp794xx_read_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcp794xx_alm_weekday(dev: *mut device, tm_alarm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp794xx_set_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp794xx_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41txx_rtc_read_offset(dev: *mut device, offset: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41txx_rtc_set_offset(dev: *mut device, offset: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1388_wdt_start(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1388_wdt_stop(wdt_dev: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1388_wdt_ping(wdt_dev: *mut watchdog_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ds1307_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ds1307_add_frequency_test(ds1307: *mut ds1307) -> c_int {
...
// ----------------------------------------------------------------------
    ...
    {
    u32 ohms, chargeable;
    let mut diode: bool = chip.charge_default;
...
//
pub const DS3231_REG_TEMPERATURE: c_uint = 0x11;
//
// A user-initiated temperature conversion is not started by this function,
// so the temperature is updated once every 64 seconds.
//
#[no_mangle]
unsafe extern "C" fn ds3231_hwmon_read_temp(dev: *mut device, mC: *mut i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1307_hwmon_register(ds1307: *mut ds1307) {
...
#[no_mangle]
unsafe extern "C" fn ds1337_write_control(ds1307: *mut ds1307, mask: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3231_clk_sqw_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3231_clk_sqw_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ds3231_clk_sqw_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3231_clk_32khz_control(ds1307: *mut ds1307, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3231_clk_32khz_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3231_clk_32khz_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ds3231_clk_32khz_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3231_clks_register(ds1307: *mut ds1307) -> c_int {
...
// optional override of the clockname
    ...
    let mut init: clk_init_data = ds3231_clks_init[i];
//
...
#[no_mangle]
unsafe extern "C" fn ds1307_clk_sqw_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1307_clk_sqw_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ds1307_clk_sqw_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtc_ds1307_clks_register(ds1307: *mut ds1307) -> c_int {
    static int rtc_ds1307_clks_register(struct ds1307 *ds1307)
    {
    struct device_node *node = ds1307.dev.of_node;
    struct clk *clk;
    let mut init: clk_init_data = {0};
...
#[no_mangle]
unsafe extern "C" fn ds1307_clks_register(ds1307: *mut ds1307) {
...
#[no_mangle]
unsafe extern "C" fn ds1307_wdt_register(ds1307: *mut ds1307) {
...
#[no_mangle]
unsafe extern "C" fn ds1307_probe(client: *mut i2c_client) -> c_int {
    ...
    const struct chip_desc	*chip;
    bool			want_irq;
    let mut ds1307_can_wakeup_device: bool = false;
    unsigned char		regs[8];
    struct ds1307_platform_data *pdata = dev_get_platdata(&client.dev);
    let mut trickle_charger_setup: u8 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pdata->trickle_charger_setup) -> else {
...
// We cannot support UIE mode if we do not have an IRQ line
    ...
    if (want_irq) {
    err = devm_request_threaded_irq(ds1307.dev, client.irq, core::ptr::null_mut(),
