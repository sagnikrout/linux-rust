...
//! Source: drivers/rtc/rtc-m48t86.c
#![no_std]
...
pub const M48T86_SEC: c_uint = 0x00;
pub const M48T86_SECALRM: c_uint = 0x01;
pub const M48T86_MIN: c_uint = 0x02;
pub const M48T86_MINALRM: c_uint = 0x03;
pub const M48T86_HOUR: c_uint = 0x04;
pub const M48T86_HOURALRM: c_uint = 0x05;
pub const M48T86_DOW: c_uint = 0x06 /* 1 = sunday */;
pub const M48T86_DOM: c_uint = 0x07;
pub const M48T86_MONTH: c_uint = 0x08 /* 1 - 12 */;
pub const M48T86_YEAR: c_uint = 0x09 /* 0 - 99 */;
pub const M48T86_A: c_uint = 0x0a;
pub const M48T86_B: c_uint = 0x0b;

pub const M48T86_C: c_uint = 0x0c;
pub const M48T86_D: c_uint = 0x0d;

pub const M48T86_NVRAM_LEN: c_int = 114;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m48t86_rtc_info {
    pub index_reg: *mut void __iomem,
    pub data_reg: *mut void __iomem,
}

#[no_mangle]
unsafe extern "C" fn m48t86_readb(dev: *mut device, addr: c_ulong) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn m48t86_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m48t86_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m48t86_rtc_proc(dev: *mut device, seq: *mut seq_file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn m48t86_verify_chip(pdev: *mut platform_device) -> bool {
    static bool m48t86_verify_chip(struct platform_device *pdev)
    {
    let mut offset0: c_uint = M48T86_NVRAM(M48T86_NVRAM_LEN - 2);
    let mut offset1: c_uint = M48T86_NVRAM(M48T86_NVRAM_LEN - 1);
...
#[no_mangle]
unsafe extern "C" fn m48t86_rtc_probe(pdev: *mut platform_device) -> c_int {
