...
//! Source: drivers/rtc/rtc-max77686.c
#![no_std]
...
pub const MAX77620_I2C_ADDR_RTC: c_uint = 0x68;
pub const MAX77714_I2C_ADDR_RTC: c_uint = 0x48;
...
pub const RTC_UDR_SHIFT: c_int = 0;

pub const RTC_RBUDR_SHIFT: c_int = 4;

// RTC Alarm Enable
pub const ALARM_ENABLE_SHIFT: c_int = 7;

pub const REG_RTC_NONE: c_uint = 0xdeadbeef;
//
...
//
pub const MAX77802_ALARM_ENABLE_VALUE: c_uint = 0x77;
    enum {
    RTC_SEC = 0,
    RTC_MIN,
    RTC_HOUR,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77686_rtc_driver_data {
    pub delay: c_ulong,
    pub mask: u8,
    pub map: *const c_uint,
    pub alarm_enable_reg: bool,
    pub rtc_i2c_addr: c_int,
    pub rtc_irq_from_platform: bool,
    pub alarm_pending_status_reg: c_int,
    pub rtc_irq_chip: *const regmap_irq_chip,
    pub regmap_config: *const regmap_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77686_rtc_info {
    pub dev: *mut device,
    pub rtc_dev: *mut rtc_device,
    pub lock: mutex,
    pub regmap: *mut regmap,
    pub rtc_regmap: *mut regmap,
    pub drv_data: *const max77686_rtc_driver_data,
    pub rtc_irq_data: *mut regmap_irq_chip_data,
    pub rtc_irq: c_int,
    pub virq: c_int,
}
...
// On MAX77714 RTCA1 is BIT 1 of RTCINT (0x00). Not supported by this driver.
    ...
    {
    let mut mask: u8 = info.drv_data.mask;
...
//
    ...
    int ret;
    unsigned int data;
    let mut delay: c_ulong = info.drv_data.delay;
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_stop_alarm(info: *mut max77686_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_start_alarm(info: *mut max77686_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_alarm_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_init_reg(info: *mut max77686_rtc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_release_dev(client: *mut c_void) {
    static void max77686_rtc_release_dev(void *client)
    {
    i2c_unregister_device(client);
    }
#[no_mangle]
unsafe extern "C" fn max77686_init_rtc_regmap(info: *mut max77686_rtc_info) -> c_int {
    ...
    info.regmap = dev_get_regmap(parent, core::ptr::null_mut());
    if (!info.regmap)
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = request_threaded_irq(info.virq, core::ptr::null_mut(), max77686_rtc_alarm_irq, 0,
    "rtc-alarm1", info);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_rtc_resume(dev: *mut device) -> c_int {
