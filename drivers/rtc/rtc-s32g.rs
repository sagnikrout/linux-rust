...
pub const RTCC_OFFSET: c_uint = 0x4ul;
pub const RTCS_OFFSET: c_uint = 0x8ul;
pub const APIVAL_OFFSET: c_uint = 0x10ul;
// RTCC fields
...
pub struct rtc_priv {
    ...
    pub ipg: *mut clk,
    pub clk_src: *mut clk,
    pub rtc_data: *const rtc_soc_data,
    pub rtc_hz: u64,
    pub sleep_sec: time64_t,
    pub irq: c_int,
    pub clk_src_idx: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtc_soc_data {
    pub clk_div: u32,
    pub reserved_clk_mask: u32,
}
...
#[no_mangle]
unsafe extern "C" fn s32g_rtc_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn s32g_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s32g_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s32g_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s32g_rtc_disable(priv: *mut rtc_priv) {
    static void s32g_rtc_disable(struct rtc_priv *priv)
    {
    let mut rtcc: u32 = readl(priv.rtc_base + RTCC_OFFSET);
    rtcc &= ~RTCC_CNTEN;
    writel(rtcc, priv.rtc_base + RTCC_OFFSET);
    }
#[no_mangle]
unsafe extern "C" fn s32g_rtc_enable(priv: *mut rtc_priv) {
...
#[no_mangle]
unsafe extern "C" fn rtc_clk_src_setup(priv: *mut rtc_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s32g_rtc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s32g_rtc_suspend(dev: *mut device) -> c_int {
    static int s32g_rtc_suspend(struct device *dev)
    {
    struct rtc_priv *priv = dev_get_drvdata(dev);
    let mut apival: u32 = readl(priv.rtc_base + APIVAL_OFFSET);
...
#[no_mangle]
unsafe extern "C" fn s32g_rtc_resume(dev: *mut device) -> c_int {
