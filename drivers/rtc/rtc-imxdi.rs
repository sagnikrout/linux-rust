...
//! Source: drivers/rtc/rtc-imxdi.c
#![no_std]
...
pub const DTCMR: c_uint = 0x00           /* Time Counter MSB Reg */;
pub const DTCLR: c_uint = 0x04           /* Time Counter LSB Reg */;
pub const DCAMR: c_uint = 0x08           /* Clock Alarm MSB Reg */;
pub const DCALR: c_uint = 0x0c           /* Clock Alarm LSB Reg */;
pub const DCAMR_UNSET: c_uint = 0xFFFFFFFF  /* doomsday - 1 sec */;
pub const DCR: c_uint = 0x10           /* Control Reg */;

pub const DSR: c_uint = 0x14           /* Status Reg */;

pub const DIER: c_uint = 0x18           /* Interrupt Enable Reg (synchronous) */;

pub const DMCR: c_uint = 0x1c           /* DryIce Monotonic Counter Reg */;
pub const DTCR: c_uint = 0x28           /* DryIce Tamper Configuration Reg */;

pub const DGPR: c_uint = 0x3c           /* DryIce General Purpose Reg */;
//
...
#[no_mangle]
unsafe extern "C" fn di_report_tamper_info(imxdi: *mut imxdi_dev, dsr: u32) {
...
#[no_mangle]
unsafe extern "C" fn di_handle_failure_state(imxdi: *mut imxdi_dev, dsr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn di_handle_valid_state(imxdi: *mut imxdi_dev, dsr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn di_handle_invalid_state(imxdi: *mut imxdi_dev, dsr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn di_handle_invalid_and_failure_state(imxdi: *mut imxdi_dev, dsr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn di_handle_state(imxdi: *mut imxdi_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn di_int_enable(imxdi: *mut imxdi_dev, intr: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn di_int_disable(imxdi: *mut imxdi_dev, intr: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn clear_write_error(imxdi: *mut imxdi_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn di_write_wait(imxdi: *mut imxdi_dev, val: u32, reg: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dryice_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dryice_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dryice_rtc_read_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dryice_rtc_set_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dryice_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn dryice_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn dryice_rtc_probe(pdev: *mut platform_device) -> int __init {
...
//
    ...
    imxdi.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(imxdi.clk))
...
#[no_mangle]
unsafe extern "C" fn dryice_rtc_remove(pdev: *mut platform_device) -> void __exit {
