...
//! Source: drivers/rtc/rtc-wm831x.c
#![no_std]
...
//
pub const WM831X_RTC_WR_CNT_MASK: c_uint = 0xFFFF  /* RTC_WR_CNT - [15:0] */;

//
// R16417 (0x4021) - RTC Time 1
//
pub const WM831X_RTC_TIME_MASK: c_uint = 0xFFFF  /* RTC_TIME - [15:0] */;
...
//
pub const WM831X_RTC_ALM_MASK: c_uint = 0xFFFF  /* RTC_ALM - [15:0] */;
...
//
pub const WM831X_RTC_VALID: c_uint = 0x8000  /* RTC_VALID */;
pub const WM831X_RTC_VALID_MASK: c_uint = 0x8000  /* RTC_VALID */;

pub const WM831X_RTC_SYNC_BUSY: c_uint = 0x4000  /* RTC_SYNC_BUSY */;
pub const WM831X_RTC_SYNC_BUSY_MASK: c_uint = 0x4000  /* RTC_SYNC_BUSY */;

pub const WM831X_RTC_ALM_ENA: c_uint = 0x0400  /* RTC_ALM_ENA */;
pub const WM831X_RTC_ALM_ENA_MASK: c_uint = 0x0400  /* RTC_ALM_ENA */;

pub const WM831X_RTC_PINT_FREQ_MASK: c_uint = 0x0070  /* RTC_PINT_FREQ - [6:4] */;

//
// R16422 (0x4026) - RTC Trim
//
pub const WM831X_RTC_TRIM_MASK: c_uint = 0x03FF  /* RTC_TRIM - [9:0] */;

pub const WM831X_SET_TIME_RETRIES: c_int = 5;
pub const WM831X_GET_TIME_RETRIES: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm831x_rtc {
    pub wm831x: *mut wm831x,
    pub rtc: *mut rtc_device,
    pub alarm_enabled:1: c_uint,
}

#[no_mangle]
unsafe extern "C" fn wm831x_rtc_add_randomness(wm831x: *mut wm831x) {
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_readtime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
    ...
    let mut time: u32 = (time1[0] << 16) | time1[1];
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_settime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_readalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_stop_alarm(wm831x_rtc: *mut wm831x_rtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_start_alarm(wm831x_rtc: *mut wm831x_rtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_setalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_alm_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_rtc_probe(pdev: *mut platform_device) -> c_int {
    static int wm831x_rtc_probe(struct platform_device *pdev)
    {
    struct wm831x *wm831x = dev_get_drvdata(pdev.dev.parent);
    struct wm831x_rtc *wm831x_rtc;
    let mut alm_irq: c_int = wm831x_irq(wm831x, platform_get_irq_byname(pdev, "ALM"));
    let mut ret: c_int = 0;
    wm831x_rtc = devm_kzalloc(&pdev.dev, sizeof(*wm831x_rtc), GFP_KERNEL);
    if (wm831x_rtc == core::ptr::null_mut())
    return -ENOMEM;
    ...
    if (ret)
    return ret;
    ret = devm_request_threaded_irq(&pdev.dev, alm_irq, core::ptr::null_mut(),
    wm831x_alm_irq,
