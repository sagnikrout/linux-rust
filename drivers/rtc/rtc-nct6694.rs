...
//! Source: drivers/rtc/rtc-nct6694.c
#![no_std]
...
//
pub const NCT6694_RTC_MOD: c_uint = 0x08;
// Command 00h - RTC Time
pub const NCT6694_RTC_TIME: c_uint = 0x0000;
pub const NCT6694_RTC_TIME_SEL: c_uint = 0x00;
// Command 01h - RTC Alarm
pub const NCT6694_RTC_ALARM: c_uint = 0x01;
pub const NCT6694_RTC_ALARM_SEL: c_uint = 0x00;
// Command 02h - RTC Status
pub const NCT6694_RTC_STATUS: c_uint = 0x02;
pub const NCT6694_RTC_STATUS_SEL: c_uint = 0x00;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nct6694_rtc_data {
    pub nct6694: *mut nct6694,
    pub rtc: *mut rtc_device,
    pub msg: *mut union nct6694_rtc_msg,
    pub irq: c_int,
}

#[no_mangle]
unsafe extern "C" fn nct6694_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nct6694_rtc_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = devm_request_threaded_irq(&pdev.dev, data.irq, core::ptr::null_mut(),
