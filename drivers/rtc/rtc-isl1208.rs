...
//! Source: drivers/rtc/rtc-isl1208.c
#![no_std]
...
// Register map
// rtc section
pub const ISL1208_REG_SC: c_uint = 0x00;
pub const ISL1208_REG_MN: c_uint = 0x01;
pub const ISL1208_REG_HR: c_uint = 0x02;

pub const ISL1208_REG_DT: c_uint = 0x03;
pub const ISL1208_REG_MO: c_uint = 0x04;
pub const ISL1208_REG_YR: c_uint = 0x05;
pub const ISL1208_REG_DW: c_uint = 0x06;
pub const ISL1208_RTC_SECTION_LEN: c_int = 7;
// control/status section
pub const ISL1208_REG_SR: c_uint = 0x07;

pub const ISL1208_REG_INT: c_uint = 0x08;

pub const ISL1219_REG_EV: c_uint = 0x09;

pub const ISL1208_REG_ATR: c_uint = 0x0a;
pub const ISL1208_REG_DTR: c_uint = 0x0b;
// alarm section
pub const ISL1208_REG_SCA: c_uint = 0x0c;
pub const ISL1208_REG_MNA: c_uint = 0x0d;
pub const ISL1208_REG_HRA: c_uint = 0x0e;
pub const ISL1208_REG_DTA: c_uint = 0x0f;
pub const ISL1208_REG_MOA: c_uint = 0x10;
pub const ISL1208_REG_DWA: c_uint = 0x11;
pub const ISL1208_ALARM_SECTION_LEN: c_int = 6;
// user section
pub const ISL1208_REG_USR1: c_uint = 0x12;
pub const ISL1208_REG_USR2: c_uint = 0x13;
pub const ISL1208_USR_SECTION_LEN: c_int = 2;
// event section
pub const ISL1219_REG_SCT: c_uint = 0x14;
pub const ISL1219_REG_MNT: c_uint = 0x15;
pub const ISL1219_REG_HRT: c_uint = 0x16;
pub const ISL1219_REG_DTT: c_uint = 0x17;
pub const ISL1219_REG_MOT: c_uint = 0x18;
pub const ISL1219_REG_YRT: c_uint = 0x19;
pub const ISL1219_EVT_SECTION_LEN: c_int = 6;
    static struct i2c_driver isl1208_driver;
// Chip capabilities table
#[repr(C)]
#[derive(Copy, Clone)]
pub struct isl1208_config {
    pub nvmem_length: c_uint,
    pub has_tamper:1: unsigned,
    pub has_timestamp:1: unsigned,
    pub has_inverted_osc_bit:1: unsigned,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct isl1208_state {
    pub nvmem_config: nvmem_config,
    pub rtc: *mut rtc_device,
    pub config: *const isl1208_config,
}
...
#[no_mangle]
unsafe extern "C" fn isl1208_set_xtoscb(client: *mut i2c_client, sr: c_int, xtosb_val: c_int) -> c_int {
...
// Do nothing if bit is already set to desired value
    ...
    {
    let mut atr: c_int = i2c_smbus_read_byte_data(client, ISL1208_REG_ATR);
    if (atr < 0)
    return atr;
...
// returns adjustment value + 100
    ...
    {
    let mut dtr: c_int = i2c_smbus_read_byte_data(client, ISL1208_REG_DTR);
    if (dtr < 0)
    return -EIO;
// dtr encodes adjustments of {-60,-40,-20,0,20,40,60} ppm
    ...
    {
    let mut icr: c_int = i2c_smbus_read_byte_data(client, ISL1208_REG_INT);
    if (icr < 0) {
    ...
    {
    let mut client: *mut i2c_client const = to_i2c_client(dev);
    int sr, dtr, atr, usr;
...
// HR field has a more complex interpretation
    {
    let mut _hr: u8 = regs[ISL1208_REG_HR];
...
// The alarm doesn't store the year so get it from the rtc section
    ...
    u8 regs[ISL1208_ALARM_SECTION_LEN] = { 0, };
    let mut offs: c_int = ISL1208_REG_SCA;
...
// MSB of each alarm register is an enable bit
    ...
    let mut handled: c_int = 0, sr, err;
...
// Clear the alarm
    ...
    sysfs_notify(&isl1208.rtc.dev.kobj, core::ptr::null_mut(),
...
// sysfs interface
    ...
    struct device_attribute *attr, char *buf)
    {
    let mut atr: c_int = isl1208_i2c_get_atr(to_i2c_client(dev.parent));
    if (atr < 0)
    return atr;
    return sprintf(buf, "%d.%.2d pF\n", atr >> 2, (atr & 0x3) * 25);
    }
    static DEVICE_ATTR(atrim, S_IRUGO, isl1208_sysfs_show_atrim, core::ptr::null_mut());
    static ssize_t
    isl1208_sysfs_show_dtrim(struct device *dev,
    struct device_attribute *attr, char *buf)
    {
    let mut dtr: c_int = isl1208_i2c_get_dtr(to_i2c_client(dev.parent));
    if (dtr < 0)
    return dtr;
    return sprintf(buf, "%d ppm\n", dtr - 100);
    }
    static DEVICE_ATTR(dtrim, S_IRUGO, isl1208_sysfs_show_dtrim, core::ptr::null_mut());
    static ssize_t
    isl1208_sysfs_show_usr(struct device *dev,
    struct device_attribute *attr, char *buf)
    {
    let mut usr: c_int = isl1208_i2c_get_usr(to_i2c_client(dev.parent));
    if (usr < 0)
    return usr;
...
#[no_mangle]
unsafe extern "C" fn isl1208_disable_irq_wake_action(data: *mut c_void) {
    static void isl1208_disable_irq_wake_action(void *data)
    {
    disable_irq_wake((unsigned long)data);
    }
#[no_mangle]
unsafe extern "C" fn isl1208_setup_irq(client: *mut i2c_client, irq: c_int) -> c_int {
    static int isl1208_setup_irq(struct i2c_client *client, int irq)
    {
    int rc = devm_request_threaded_irq(&client.dev, irq, core::ptr::null_mut(),
    ...
    let mut evdet_irq: c_int = -1;
    let mut xtosb_val: c_int = 0;
    let mut rc: c_int = 0;
    int sr;
