...
//! Source: drivers/rtc/rtc-loongson.c
#![no_std]
...
pub const TOY_TRIM_REG: c_uint = 0x20 /* Must be initialized to 0 */;
pub const TOY_WRITE0_REG: c_uint = 0x24 /* TOY low 32-bits value (write-only) */;
pub const TOY_WRITE1_REG: c_uint = 0x28 /* TOY high 32-bits value (write-only) */;
pub const TOY_READ0_REG: c_uint = 0x2c /* TOY low 32-bits value (read-only) */;
pub const TOY_READ1_REG: c_uint = 0x30 /* TOY high 32-bits value (read-only) */;
pub const TOY_MATCH0_REG: c_uint = 0x34 /* TOY timing interrupt 0 */;
pub const TOY_MATCH1_REG: c_uint = 0x38 /* TOY timing interrupt 1 */;
pub const TOY_MATCH2_REG: c_uint = 0x3c /* TOY timing interrupt 2 */;
// RTC counters registers
pub const RTC_CTRL_REG: c_uint = 0x40 /* TOY and RTC control register */;
pub const RTC_TRIM_REG: c_uint = 0x60 /* Must be initialized to 0 */;
pub const RTC_WRITE0_REG: c_uint = 0x64 /* RTC counters value (write-only) */;
pub const RTC_READ0_REG: c_uint = 0x68 /* RTC counters value (read-only) */;
pub const RTC_MATCH0_REG: c_uint = 0x6c /* RTC timing interrupt 0 */;
pub const RTC_MATCH1_REG: c_uint = 0x70 /* RTC timing interrupt 1 */;
pub const RTC_MATCH2_REG: c_uint = 0x74 /* RTC timing interrupt 2 */;
...
// PM domain registers
pub const PM1_STS_REG: c_uint = 0x0c	/* Power management 1 status register */;

pub const PM1_EN_REG: c_uint = 0x10	/* Power management 1 enable register */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson_rtc_config {
    pub /: *mut *mut u32 pm_offset; / Offset of PM domain, for RTC alarm wakeup,
    pub /: *mut *mut u32 flags; / Workaround bits,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson_rtc_priv {
    pub /: *mut *mut spinlock_t lock; / protects PM registers access,
    pub /: *mut *mut u32 fix_year; / RTC alarm year compensation value,
    pub rtcdev: *mut rtc_device,
    pub regmap: *mut regmap,
    pub /: *mut *mut *mut void __iomem pm_base; / PM domain base, for RTC alarm wakeup,
    pub config: *const loongson_rtc_config,
}
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_isr(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_handler(id: *mut c_void) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_set_enabled(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_get_enabled(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_alarm_setting(pdev: *mut platform_device, regs: *mut void __iomem) -> c_int {
    static int loongson_rtc_alarm_setting(struct platform_device *pdev, void __iomem *regs)
    {
    let mut ret: c_int = 0, alarm_irq;
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_rtc_remove(pdev: *mut platform_device) {
