...
#[no_mangle]
unsafe extern "C" fn rtc_dev_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rtc_uie_task(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rtc_uie_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn clear_uie(rtc: *mut rtc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_uie(rtc: *mut rtc_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtc_dev_update_irq_enable_emul(rtc: *mut rtc_device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtc_dev_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn rtc_dev_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtc_dev_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtc_dev_prepare(rtc: *mut rtc_device) {
...
#[no_mangle]
pub unsafe extern "C" fn rtc_dev_init() -> void __init {
