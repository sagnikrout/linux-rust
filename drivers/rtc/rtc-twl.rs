...
pub const BIT_RTC_CTRL_REG_STOP_RTC_M: c_uint = 0x01;
pub const BIT_RTC_CTRL_REG_ROUND_30S_M: c_uint = 0x02;
pub const BIT_RTC_CTRL_REG_AUTO_COMP_M: c_uint = 0x04;
pub const BIT_RTC_CTRL_REG_MODE_12_24_M: c_uint = 0x08;
pub const BIT_RTC_CTRL_REG_TEST_MODE_M: c_uint = 0x10;
pub const BIT_RTC_CTRL_REG_SET_32_COUNTER_M: c_uint = 0x20;
pub const BIT_RTC_CTRL_REG_GET_TIME_M: c_uint = 0x40;
pub const BIT_RTC_CTRL_REG_RTC_V_OPT: c_uint = 0x80;
// RTC_STATUS_REG bitfields
pub const BIT_RTC_STATUS_REG_RUN_M: c_uint = 0x02;
pub const BIT_RTC_STATUS_REG_1S_EVENT_M: c_uint = 0x04;
pub const BIT_RTC_STATUS_REG_1M_EVENT_M: c_uint = 0x08;
pub const BIT_RTC_STATUS_REG_1H_EVENT_M: c_uint = 0x10;
pub const BIT_RTC_STATUS_REG_1D_EVENT_M: c_uint = 0x20;
pub const BIT_RTC_STATUS_REG_ALARM_M: c_uint = 0x40;
pub const BIT_RTC_STATUS_REG_POWER_UP_M: c_uint = 0x80;
// RTC_INTERRUPTS_REG bitfields
pub const BIT_RTC_INTERRUPTS_REG_EVERY_M: c_uint = 0x03;
pub const BIT_RTC_INTERRUPTS_REG_IT_TIMER_M: c_uint = 0x04;
pub const BIT_RTC_INTERRUPTS_REG_IT_ALARM_M: c_uint = 0x08;
// REG_SECONDS_REG through REG_YEARS_REG is how many registers?
pub const ALL_TIME_REGS: c_int = 6;
// ----------------------------------------------------------------------
#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl_rtc {
...
//
    pub rtc_irq_bits: c_uchar,
    pub wake_enabled: bool,

    pub irqstat: c_uchar,

    pub class: enum twl_class,
}
...
//
#[no_mangle]
unsafe extern "C" fn twl_rtc_read_u8(twl_rtc: *mut twl_rtc, data: *mut u8, reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn twl_rtc_write_u8(twl_rtc: *mut twl_rtc, data: u8, reg: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_rtc_irq_bit(twl_rtc: *mut twl_rtc, bit: c_uchar) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mask_rtc_irq_bit(twl_rtc: *mut twl_rtc, bit: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl_rtc_alarm_irq_enable(dev: *mut device, enabled: unsigned) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn twl_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn twl_rtc_read_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl_rtc_set_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl_rtc_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// ----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn twl_rtc_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn twl_rtc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn twl_rtc_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn twl_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl_rtc_resume(dev: *mut device) -> c_int {
