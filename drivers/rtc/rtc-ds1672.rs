...
//! Source: drivers/rtc/rtc-ds1672.c
#![no_std]
...
// Registers
pub const DS1672_REG_CNT_BASE: c_int = 0;
pub const DS1672_REG_CONTROL: c_int = 4;
pub const DS1672_REG_TRICKLE: c_int = 5;
pub const DS1672_REG_CONTROL_EOSC: c_uint = 0x80;
//
...
//
#[no_mangle]
unsafe extern "C" fn ds1672_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
    static int ds1672_read_time(struct device *dev, struct rtc_time *tm)
    {
    struct i2c_client *client = to_i2c_client(dev);
    unsigned long time;
    let mut addr: c_uchar = DS1672_REG_CONTROL;
    unsigned char buf[4];
    struct i2c_msg msgs[] = {
    {/* setup read ptr */
    .addr = client.addr,
...
#[no_mangle]
unsafe extern "C" fn ds1672_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1672_probe(client: *mut i2c_client) -> c_int {
