...
//! Source: drivers/rtc/rtc-at91sam9.c
#![no_std]
...
//
pub const AT91_RTT_MR: c_uint = 0x00		/* Real-time Mode Register */;

pub const AT91_RTT_AR: c_uint = 0x04		/* Real-time Alarm Register */;

pub const AT91_RTT_VR: c_uint = 0x08		/* Real-time Value Register */;

pub const AT91_RTT_SR: c_uint = 0x0c		/* Real-time Status Register */;
...
#[derive(Copy, Clone)]
pub struct sam9_rtc {
    pub rtt: *mut void __iomem,
    pub rtcdev: *mut rtc_device,
    pub imr: u32,
    pub gpbr: *mut regmap,
    pub gpbr_offset: c_uint,
    pub irq: c_int,
    pub sclk: *mut clk,
    pub suspended: bool,
    pub events: c_ulong,
...
#[no_mangle]
pub unsafe extern "C" fn gpbr_readl(rtc: *mut sam9_rtc) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn gpbr_writel(rtc: *mut sam9_rtc, val: c_uint) {
...
unsafe extern "C" fn at91_rtc_readalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
    ...
    let mut alarm: u32 = rtt_readl(rtc, AR);
    u32 offset;
    offset = gpbr_readl(rtc);
    if (offset == 0)
    return -EILSEQ;
...
unsafe extern "C" fn at91_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
    ...
    {
    struct sam9_rtc *rtc = dev_get_drvdata(dev);
    let mut mr: u32 = rtt_readl(rtc, MR);
...
//
#[no_mangle]
unsafe extern "C" fn at91_rtc_proc(dev: *mut device, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91_rtc_cache_events(rtc: *mut sam9_rtc) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn at91_rtc_flush_events(rtc: *mut sam9_rtc) {
...
//
#[no_mangle]
unsafe extern "C" fn at91_rtc_interrupt(irq: c_int, _rtc: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn at91_rtc_probe(pdev: *mut platform_device) -> c_int {
...
// platform setup code should have handled this; sigh
    ...
    rtc.sclk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(rtc.sclk))
...
//
#[no_mangle]
unsafe extern "C" fn at91_rtc_remove(pdev: *mut platform_device) {
