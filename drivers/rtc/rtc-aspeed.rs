...
//! Source: drivers/rtc/rtc-aspeed.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aspeed_rtc {
    pub base: *mut void __iomem,
}

pub const RTC_TIME: c_uint = 0x00;
pub const RTC_YEAR: c_uint = 0x04;
pub const RTC_CTRL: c_uint = 0x10;

#[no_mangle]
unsafe extern "C" fn aspeed_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_rtc_probe(pdev: *mut platform_device) -> c_int {
