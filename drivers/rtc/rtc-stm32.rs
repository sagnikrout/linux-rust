...
//! Source: drivers/rtc/rtc-stm32.c
#![no_std]
...
pub const STM32_RTC_TR_SEC_SHIFT: c_int = 0;

pub const STM32_RTC_TR_MIN_SHIFT: c_int = 8;

pub const STM32_RTC_TR_HOUR_SHIFT: c_int = 16;

// STM32_RTC_DR bit fields
pub const STM32_RTC_DR_DATE_SHIFT: c_int = 0;

pub const STM32_RTC_DR_MONTH_SHIFT: c_int = 8;

pub const STM32_RTC_DR_WDAY_SHIFT: c_int = 13;

pub const STM32_RTC_DR_YEAR_SHIFT: c_int = 16;
...
pub const STM32_RTC_PRER_PRED_S_SHIFT: c_int = 0;

pub const STM32_RTC_PRER_PRED_A_SHIFT: c_int = 16;

// STM32_RTC_ALRMAR and STM32_RTC_ALRMBR bit fields
pub const STM32_RTC_ALRMXR_SEC_SHIFT: c_int = 0;

pub const STM32_RTC_ALRMXR_MIN_SHIFT: c_int = 8;

pub const STM32_RTC_ALRMXR_HOUR_SHIFT: c_int = 16;

pub const STM32_RTC_ALRMXR_DATE_SHIFT: c_int = 24;

pub const STM32_RTC_ALRMXR_WDAY_SHIFT: c_int = 24;

// STM32_RTC_SR/_SCR bit fields

// STM32_RTC_CFGR bit fields

pub const STM32_RTC_CFGR_LSCOEN_OUT1: c_int = 1;
pub const STM32_RTC_CFGR_LSCOEN_OUT2_RMP: c_int = 2;
// STM32_RTC_VERR bit fields
pub const STM32_RTC_VERR_MINREV_SHIFT: c_int = 0;

pub const STM32_RTC_VERR_MAJREV_SHIFT: c_int = 4;

// STM32_RTC_SECCFGR bit fields
pub const STM32_RTC_SECCFGR: c_uint = 0x20;

// STM32_RTC_RXCIDCFGR bit fields

pub const STM32_RTC_RXCIDCFGR_CID1: c_int = 1;
// STM32_RTC_WPR key constants
pub const RTC_WPR_1ST_KEY: c_uint = 0xCA;
pub const RTC_WPR_2ND_KEY: c_uint = 0x53;
pub const RTC_WPR_WRONG_KEY: c_uint = 0xFF;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rtc_registers {
    pub tr: u16,
    pub dr: u16,
    pub cr: u16,
    pub isr: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rtc_events {
    pub alra: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rtc_data {
    pub regs: stm32_rtc_registers,
    pub events: stm32_rtc_events,
    pub flags): *mut *mut *mut void (clear_events)(struct stm32_rtc rtc, unsigned int,
    pub has_pclk: bool,
    pub need_dbp: bool,
    pub need_accuracy: bool,
    pub rif_protected: bool,
    pub has_lsco: bool,
    pub has_alarm_out: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rtc {
    ...
    pub pclk: *mut clk,
    pub rtc_ck: *mut clk,
    pub data: *const stm32_rtc_data,
    pub irq_alarm: c_int,
    pub clk_lsco: *mut clk,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rtc_rif_resource {
    pub num: c_uint,
    pub bit: u32,
}

    let mut STM32_RTC_RES_ALRA: static struct stm32_rtc_rif_resource = {0, STM32_RTC_SECCFGR_ALRA_SEC};
    let mut STM32_RTC_RES_INIT: static struct stm32_rtc_rif_resource = {5, STM32_RTC_SECCFGR_INIT_SEC};
#[no_mangle]
unsafe extern "C" fn stm32_rtc_wpr_unlock(rtc: *mut stm32_rtc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_wpr_lock(rtc: *mut stm32_rtc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_pinctrl_get_groups_count(pctldev: *mut pinctrl_dev) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rtc_pinmux_func {
    pub name: *const c_char,
    pub groups: *const *const c_char,
    pub num_groups: c_uint,
    pub pin): *mut *mut *mut int (action)(struct pinctrl_dev pctl_dev, unsigned int,
}

#[no_mangle]
unsafe extern "C" fn stm32_rtc_pinmux_action_alarm(pctldev: *mut pinctrl_dev, pin: c_uint) -> c_int {
    ...
    let mut regs: stm32_rtc_registers = rtc.data.regs;
    let mut cr: c_uint = readl_relaxed(rtc.base + regs.cr);
    let mut cfgr: c_uint = readl_relaxed(rtc.base + regs.cfgr);
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_pinmux_lsco_available(pctldev: *mut pinctrl_dev, pin: c_uint) -> c_int {
    ...
    let mut cr: c_uint = readl_relaxed(rtc.base + regs.cr);
    let mut cfgr: c_uint = readl_relaxed(rtc.base + regs.cfgr);
    let mut calib: c_uint = STM32_RTC_CR_COE;
    let mut tampalrm: c_uint = STM32_RTC_CR_TAMPOE | STM32_RTC_CR_OSEL;
    switch (pin) {
    case OUT1:
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_pinmux_action_lsco(pctldev: *mut pinctrl_dev, pin: c_uint) -> c_int {
    ...
    rtc.base + regs.cfgr, lscoen, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_pinmux_get_functions_count(pctldev: *mut pinctrl_dev) -> c_int {
...
// num_groups = stm32_rtc_pinmux_functions[selector].num_groups;
    ...
    unsigned int group)
    {
    let mut selected_func: stm32_rtc_pinmux_func = stm32_rtc_pinmux_functions[selector];
    let mut pin: pinctrl_pin_desc = stm32_rtc_pinctrl_pins[group];
// Call action
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_enter_init_mode(rtc: *mut stm32_rtc) -> c_int {
    static int stm32_rtc_enter_init_mode(struct stm32_rtc *rtc)
    {
    const struct stm32_rtc_registers *regs = &rtc.data.regs;
    let mut isr: c_uint = readl_relaxed(rtc.base + regs.isr);
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_exit_init_mode(rtc: *mut stm32_rtc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_wait_sync(rtc: *mut stm32_rtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_alarm_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_valid_alrm(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_clean_outs(rtc: *mut stm32_rtc) {
    ...
    {
    let mut rxcidcfgr: u32 = readl_relaxed(stm32_rtc.base + STM32_RTC_RXCIDCFGR(res.num));
    u32 seccfgr;
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_probe(pdev: *mut platform_device) -> c_int {
    ...
    rtc.pclk = core::ptr::null_mut();
    rtc.rtc_ck = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    } else {
...
// Handle RTC alarm interrupts
    ret = devm_request_threaded_irq(&pdev.dev, rtc.irq_alarm, core::ptr::null_mut(),
...
//
    ...
    let mut ver: u32 = readl_relaxed(rtc.base + regs.verr);
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rtc_resume(dev: *mut device) -> c_int {
