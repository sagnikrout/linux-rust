...
//! Source: drivers/rtc/rtc-armada38x.c
#![no_std]
...
pub const RTC_STATUS: c_uint = 0x0;

pub const RTC_IRQ1_CONF: c_uint = 0x4;
pub const RTC_IRQ2_CONF: c_uint = 0x8;

pub const RTC_CCR: c_uint = 0x18;

pub const RTC_CONF_TEST: c_uint = 0x1C;

pub const RTC_TIME: c_uint = 0xC;
pub const RTC_ALARM1: c_uint = 0x10;
pub const RTC_ALARM2: c_uint = 0x14;
// Armada38x SoC registers
pub const RTC_38X_BRIDGE_TIMING_CTL: c_uint = 0x0;
pub const RTC_38X_PERIOD_OFFS: c_int = 0;

pub const RTC_38X_READ_DELAY_OFFS: c_int = 26;

// Armada 7K/8K registers
pub const RTC_8K_BRIDGE_TIMING_CTL0: c_uint = 0x0;
pub const RTC_8K_WRCLK_PERIOD_OFFS: c_int = 0;

pub const RTC_8K_WRCLK_SETUP_OFFS: c_int = 16;

pub const RTC_8K_BRIDGE_TIMING_CTL1: c_uint = 0x4;
pub const RTC_8K_READ_DELAY_OFFS: c_int = 0;

pub const RTC_8K_ISR: c_uint = 0x10;
pub const RTC_8K_IMR: c_uint = 0x14;

pub const SOC_RTC_INTERRUPT: c_uint = 0x8;

pub const SAMPLE_NR: c_int = 100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct value_to_freq {
    pub value: u32,
    pub freq: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada38x_rtc {
    pub rtc_dev: *mut rtc_device,
    pub regs: *mut void __iomem,
    pub regs_soc: *mut void __iomem,
    pub lock: spinlock_t,
    pub irq: c_int,
    pub initialized: bool,
    pub data: *const armada38x_rtc_data,
    pub val_to_freq: [value_to_freq; ],
}

pub const ALARM1: c_int = 0;
pub const ALARM2: c_int = 1;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada38x_rtc_data {
// Initialize the RTC-MBUS bridge timing
    pub rtc): *mut *mut void (update_mbus_timing)(struct armada38x_rtc,
    pub rtc_reg): *mut *mut *mut u32 (read_rtc_reg)(struct armada38x_rtc rtc, u8,
    pub rtc): *mut *mut void (clear_isr)(struct armada38x_rtc,
    pub rtc): *mut *mut void (unmask_interrupt)(struct armada38x_rtc,
    pub alarm: u32,
}
...
//
#[no_mangle]
unsafe extern "C" fn rtc_delayed_write(val: u32, rtc: *mut armada38x_rtc, offset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rtc_update_38x_mbus_timing_params(rtc: *mut armada38x_rtc) {
...
#[no_mangle]
unsafe extern "C" fn rtc_update_8k_mbus_timing_params(rtc: *mut armada38x_rtc) {
...
#[no_mangle]
unsafe extern "C" fn read_rtc_register(rtc: *mut armada38x_rtc, rtc_reg: u8) -> u32 {
    static u32 read_rtc_register(struct armada38x_rtc *rtc, u8 rtc_reg)
    {
    return readl(rtc.regs + rtc_reg);
    }
#[no_mangle]
unsafe extern "C" fn read_rtc_register_38x_wa(rtc: *mut armada38x_rtc, rtc_reg: u8) -> u32 {
    ...
    for (i = 0; i < SAMPLE_NR; i++) {
    let mut j: c_int = 0;
    let mut value: u32 = rtc.val_to_freq[i].value;
...
#[no_mangle]
unsafe extern "C" fn armada38x_clear_isr(rtc: *mut armada38x_rtc) {
    static void armada38x_clear_isr(struct armada38x_rtc *rtc)
    {
    let mut val: u32 = readl(rtc.regs_soc + SOC_RTC_INTERRUPT);
    writel(val & ~SOC_RTC_ALARM1, rtc.regs_soc + SOC_RTC_INTERRUPT);
    }
#[no_mangle]
unsafe extern "C" fn armada38x_unmask_interrupt(rtc: *mut armada38x_rtc) {
...
#[no_mangle]
unsafe extern "C" fn armada8k_clear_isr(rtc: *mut armada38x_rtc) {
    static void armada8k_clear_isr(struct armada38x_rtc *rtc)
    {
    writel(RTC_8K_ALARM2, rtc.regs_soc + RTC_8K_ISR);
    }
#[no_mangle]
unsafe extern "C" fn armada8k_unmask_interrupt(rtc: *mut armada38x_rtc) {
    static void armada8k_unmask_interrupt(struct armada38x_rtc *rtc)
    {
    writel(RTC_8K_ALARM2, rtc.regs_soc + RTC_8K_IMR);
    }
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_reset(rtc: *mut armada38x_rtc) {
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
    static int armada38x_rtc_read_alarm(struct device *dev, struct rtc_wkalrm *alrm)
    {
    struct armada38x_rtc *rtc = dev_get_drvdata(dev);
    unsigned long time, flags;
    let mut reg: u32 = ALARM_REG(RTC_ALARM1, rtc.data.alarm);
    let mut reg_irq: u32 = ALARM_REG(RTC_IRQ1_CONF, rtc.data.alarm);
    u32 val;
    spin_lock_irqsave(&rtc.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_alarm_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t armada38x_rtc_alarm_irq(int irq, void *data)
    {
    struct armada38x_rtc *rtc = data;
    u32 val;
    let mut event: c_int = RTC_IRQF | RTC_AF;
    let mut reg_irq: u32 = ALARM_REG(RTC_IRQ1_CONF, rtc.data.alarm);
...
//
#[no_mangle]
unsafe extern "C" fn armada38x_ppb_convert(ppb: c_long) -> c_long {
    static long armada38x_ppb_convert(long ppb)
    {
    let mut div: c_long = ppb + 1000000000L;
    return div_s64(1000000000000000000LL + div / 2, div) - 1000000000L;
    }
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_read_offset(dev: *mut device, offset: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_set_offset(dev: *mut device, offset: c_long) -> c_int {
    static int armada38x_rtc_set_offset(struct device *dev, long offset)
    {
    struct armada38x_rtc *rtc = dev_get_drvdata(dev);
    let mut ccr: c_ulong = 0;
    long ppb_cor, off;
//
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_probe(pdev: *mut platform_device) -> __init int {
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada38x_rtc_resume(dev: *mut device) -> c_int {
