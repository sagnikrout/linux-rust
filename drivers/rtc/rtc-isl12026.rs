...
//! Source: drivers/rtc/rtc-isl12026.c
#![no_std]
...
// register offsets
pub const ISL12026_REG_PWR: c_uint = 0x14;

pub const ISL12026_REG_SC: c_uint = 0x30;
pub const ISL12026_REG_HR: c_uint = 0x32;

pub const ISL12026_REG_SR: c_uint = 0x3f;

// The EEPROM array responds at i2c address 0x57
pub const ISL12026_EEPROM_ADDR: c_uint = 0x57;
pub const ISL12026_PAGESIZE: c_int = 16;
pub const ISL12026_NVMEM_WRITE_TIME: c_int = 20;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct isl12026 {
    pub rtc: *mut rtc_device,
    pub nvm_client: *mut i2c_client,
}

#[no_mangle]
unsafe extern "C" fn isl12026_read_reg(client: *mut i2c_client, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12026_arm_write(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12026_disarm_write(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12026_write_reg(client: *mut i2c_client, reg: c_int, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12026_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12026_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12026_force_power_modes(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn isl12026_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl12026_remove(client: *mut i2c_client) {
