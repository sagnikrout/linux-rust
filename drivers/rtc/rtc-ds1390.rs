...
//! Source: drivers/rtc/rtc-ds1390.c
#![no_std]
...
pub const DS1390_REG_100THS: c_uint = 0x00;
pub const DS1390_REG_SECONDS: c_uint = 0x01;
pub const DS1390_REG_MINUTES: c_uint = 0x02;
pub const DS1390_REG_HOURS: c_uint = 0x03;
pub const DS1390_REG_DAY: c_uint = 0x04;
pub const DS1390_REG_DATE: c_uint = 0x05;
pub const DS1390_REG_MONTH_CENT: c_uint = 0x06;
pub const DS1390_REG_YEAR: c_uint = 0x07;
pub const DS1390_REG_ALARM_100THS: c_uint = 0x08;
pub const DS1390_REG_ALARM_SECONDS: c_uint = 0x09;
pub const DS1390_REG_ALARM_MINUTES: c_uint = 0x0A;
pub const DS1390_REG_ALARM_HOURS: c_uint = 0x0B;
pub const DS1390_REG_ALARM_DAY_DATE: c_uint = 0x0C;
pub const DS1390_REG_CONTROL: c_uint = 0x0D;
pub const DS1390_REG_STATUS: c_uint = 0x0E;
pub const DS1390_REG_TRICKLE: c_uint = 0x0F;
pub const DS1390_TRICKLE_CHARGER_ENABLE: c_uint = 0xA0;
pub const DS1390_TRICKLE_CHARGER_250_OHM: c_uint = 0x01;
pub const DS1390_TRICKLE_CHARGER_2K_OHM: c_uint = 0x02;
pub const DS1390_TRICKLE_CHARGER_4K_OHM: c_uint = 0x03;
pub const DS1390_TRICKLE_CHARGER_NO_DIODE: c_uint = 0x04;
pub const DS1390_TRICKLE_CHARGER_DIODE: c_uint = 0x08;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ds1390 {
    pub rtc: *mut rtc_device,
    pub /: *mut *mut u8 txrx_buf[9]; / cmd + 8 registers,
}
...
#[no_mangle]
unsafe extern "C" fn ds1390_trickle_of_init(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn ds1390_read_time(dev: *mut device, dt: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1390_set_time(dev: *mut device, dt: *mut rtc_time) -> c_int {
...
// do the i/o
    return spi_write_then_read(spi, chip.txrx_buf, 8, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn ds1390_probe(spi: *mut spi_device) -> c_int {
