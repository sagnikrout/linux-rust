...
//! Source: drivers/rtc/rtc-tegra.c
#![no_std]
...
pub const TEGRA_RTC_REG_BUSY: c_uint = 0x004;
pub const TEGRA_RTC_REG_SECONDS: c_uint = 0x008;
// When msec is read, the seconds are buffered into shadow seconds.
pub const TEGRA_RTC_REG_SHADOW_SECONDS: c_uint = 0x00c;
pub const TEGRA_RTC_REG_MILLI_SECONDS: c_uint = 0x010;
pub const TEGRA_RTC_REG_SECONDS_ALARM0: c_uint = 0x014;
pub const TEGRA_RTC_REG_SECONDS_ALARM1: c_uint = 0x018;
pub const TEGRA_RTC_REG_MILLI_SECONDS_ALARM0: c_uint = 0x01c;
pub const TEGRA_RTC_REG_INTR_MASK: c_uint = 0x028;
// write 1 bits to clear status bits
pub const TEGRA_RTC_REG_INTR_STATUS: c_uint = 0x02c;
// bits in INTR_MASK
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_rtc_info {
    pub pdev: *mut platform_device,
    pub rtc: *mut rtc_device,
    pub /: *mut *mut *mut void __iomem base; / NULL if not initialized,
    pub clk: *mut clk,
    pub /: *mut *mut int irq; / alarm and periodic IRQ,
    pub lock: spinlock_t,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra_rtc_check_busy(info: *mut tegra_rtc_info) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn tegra_rtc_wait_while_busy(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_read_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_set_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_proc(dev: *mut device, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_probe(pdev: *mut platform_device) -> c_int {
    ...
    info.clk = devm_clk_get_enabled(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(info.clk))
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_rtc_shutdown(pdev: *mut platform_device) {
