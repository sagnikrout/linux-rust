...
//! Source: drivers/rtc/rtc-renesas-rtca3.c
#![no_std]
...
// Counter registers.
pub const RTCA3_RSECCNT: c_uint = 0x2;

pub const RTCA3_RMINCNT: c_uint = 0x4;

pub const RTCA3_RHRCNT: c_uint = 0x6;

pub const RTCA3_RWKCNT: c_uint = 0x8;

pub const RTCA3_RDAYCNT: c_uint = 0xa;

pub const RTCA3_RMONCNT: c_uint = 0xc;

pub const RTCA3_RYRCNT: c_uint = 0xe;

// Alarm registers.
pub const RTCA3_RSECAR: c_uint = 0x10;

pub const RTCA3_RMINAR: c_uint = 0x12;

pub const RTCA3_RHRAR: c_uint = 0x14;

pub const RTCA3_RWKAR: c_uint = 0x16;

pub const RTCA3_RDAYAR: c_uint = 0x18;

pub const RTCA3_RMONAR: c_uint = 0x1a;

pub const RTCA3_RYRAR: c_uint = 0x1c;

pub const RTCA3_RYRAREN: c_uint = 0x1e;
// Alarm enable bit (for all alarm registers).

// Control registers.
pub const RTCA3_RCR1: c_uint = 0x22;

pub const RTCA3_RCR1_PES_1_64_SEC: c_uint = 0x8;
pub const RTCA3_RCR2: c_uint = 0x24;

pub const RTCA3_RSR: c_uint = 0x20;

pub const RTCA3_RADJ: c_uint = 0x2e;

pub const RTCA3_RADJ_ADJ_MAX: c_uint = 0x3f;

pub const RTCA3_RADJ_PMADJ_NONE: c_int = 0;
pub const RTCA3_RADJ_PMADJ_ADD: c_int = 1;
pub const RTCA3_RADJ_PMADJ_SUB: c_int = 2;
// Polling operation timeouts.
pub const RTCA3_DEFAULT_TIMEOUT_US: c_int = 150;
pub const RTCA3_IRQSET_TIMEOUT_US: c_int = 5000;
pub const RTCA3_START_TIMEOUT_US: c_int = 150000;
pub const RTCA3_RESET_TIMEOUT_US: c_int = 200000;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtca3_ppb_per_cycle {
    pub ten_sec: c_int,
    pub sixty_sec: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtca3_priv {
    pub base: *mut void __iomem,
    pub rtc_dev: *mut rtc_device,
    pub rstc: *mut reset_control,
    pub set_alarm_completion: completion,
    pub alrm_sstep: core::sync::atomic::AtomicI32,
    pub lock: spinlock_t,
    pub ppb: rtca3_ppb_per_cycle,
    pub wakeup_irq: c_int,
}

#[no_mangle]
unsafe extern "C" fn rtca3_byte_update_bits(priv: *mut rtca3_priv, off: u8, mask: u8, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtca3_alarm_handler_helper(priv: *mut rtca3_priv) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rtca3_alarm_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rtca3_periodic_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rtca3_decode_year(mask: u8, year: u16) -> u32 {
    static u32 rtca3_decode_year(u8 mask, u16 year)
    {
    let mut y: u8 = FIELD_GET(mask, year);
    let mut century: u32 = bcd2bin((y == 0x99) ? 0x19 : 0x20);
    return (century * 100 + bcd2bin(y)) - 1900;
    }
#[no_mangle]
unsafe extern "C" fn rtca3_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_read_alarm(dev: *mut device, wkalrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_set_alarm(dev: *mut device, wkalrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_read_offset(dev: *mut device, offset: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_set_offset(dev: *mut device, offset: c_long) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: cycles >) -> else {
    else if (cycles > 0)
...
#[no_mangle]
unsafe extern "C" fn rtca3_initial_setup(clk: *mut clk, priv: *mut rtca3_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_request_irqs(pdev: *mut platform_device, priv: *mut rtca3_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rtca3_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rtca3_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_clean_alarm(priv: *mut rtca3_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtca3_resume(dev: *mut device) -> c_int {
