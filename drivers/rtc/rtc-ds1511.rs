...
//! Source: drivers/rtc/rtc-ds1511.c
#![no_std]
...
pub const DS1511_SEC: c_uint = 0x0;
pub const DS1511_MIN: c_uint = 0x1;
pub const DS1511_HOUR: c_uint = 0x2;
pub const DS1511_DOW: c_uint = 0x3;
pub const DS1511_DOM: c_uint = 0x4;
pub const DS1511_MONTH: c_uint = 0x5;
pub const DS1511_YEAR: c_uint = 0x6;
pub const DS1511_CENTURY: c_uint = 0x7;
pub const DS1511_AM1_SEC: c_uint = 0x8;
pub const DS1511_AM2_MIN: c_uint = 0x9;
pub const DS1511_AM3_HOUR: c_uint = 0xa;
pub const DS1511_AM4_DATE: c_uint = 0xb;
pub const DS1511_WD_MSEC: c_uint = 0xc;
pub const DS1511_WD_SEC: c_uint = 0xd;
pub const DS1511_CONTROL_A: c_uint = 0xe;
pub const DS1511_CONTROL_B: c_uint = 0xf;
pub const DS1511_RAMADDR_LSB: c_uint = 0x10;
pub const DS1511_RAMDATA: c_uint = 0x13;
pub const DS1511_BLF1: c_uint = 0x80;
pub const DS1511_BLF2: c_uint = 0x40;
pub const DS1511_PRS: c_uint = 0x20;
pub const DS1511_PAB: c_uint = 0x10;
pub const DS1511_TDF: c_uint = 0x08;
pub const DS1511_KSF: c_uint = 0x04;
pub const DS1511_WDF: c_uint = 0x02;
pub const DS1511_IRQF: c_uint = 0x01;
pub const DS1511_TE: c_uint = 0x80;
pub const DS1511_CS: c_uint = 0x40;
pub const DS1511_BME: c_uint = 0x20;
pub const DS1511_TPE: c_uint = 0x10;
pub const DS1511_TIE: c_uint = 0x08;
pub const DS1511_KIE: c_uint = 0x04;
pub const DS1511_WDE: c_uint = 0x02;
pub const DS1511_WDS: c_uint = 0x01;
pub const DS1511_RAM_MAX: c_uint = 0x100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ds1511_data {
    pub rtc: *mut rtc_device,
    pub /: *mut *mut *mut void __iomem ioaddr; / virtual base address,
    pub irq: c_int,
    pub lock: spinlock_t,
}
    ...
    let mut reg_spacing: static u32 = 1;
#[no_mangle]
unsafe extern "C" fn rtc_write(val: u8, reg: u32) {
    static void rtc_write(uint8_t val, uint32_t reg)
    {
    writeb(val, ds1511_base + (reg * reg_spacing));
    }
#[no_mangle]
unsafe extern "C" fn rtc_read(reg: u32) -> u8 {
    static uint8_t rtc_read(uint32_t reg)
    {
    return readb(ds1511_base + (reg * reg_spacing));
    }
#[no_mangle]
unsafe extern "C" fn rtc_disable_update() {
    static void rtc_disable_update(void)
    {
    rtc_write((rtc_read(DS1511_CONTROL_B) & ~DS1511_TE), DS1511_CONTROL_B);
    }
#[no_mangle]
unsafe extern "C" fn rtc_enable_update() {
    static void rtc_enable_update(void)
    {
    rtc_write((rtc_read(DS1511_CONTROL_B) | DS1511_TE), DS1511_CONTROL_B);
    }
#[no_mangle]
unsafe extern "C" fn ds1511_rtc_set_time(dev: *mut device, rtc_tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1511_rtc_read_time(dev: *mut device, rtc_tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1511_rtc_alarm_enable(enabled: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ds1511_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1511_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1511_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ds1511_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1511_rtc_probe(pdev: *mut platform_device) -> c_int {
