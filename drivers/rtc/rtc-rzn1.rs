...
pub const RZN1_RTC_CTL0: c_uint = 0x00;

pub const RZN1_RTC_CTL1: c_uint = 0x04;

pub const RZN1_RTC_CTL2: c_uint = 0x08;

pub const RZN1_RTC_TIME: c_uint = 0x30;

pub const RZN1_RTC_CAL: c_uint = 0x34;

pub const RZN1_RTC_SUBU: c_uint = 0x38;

pub const RZN1_RTC_SCMP: c_uint = 0x3c;
pub const RZN1_RTC_ALM: c_uint = 0x40;
pub const RZN1_RTC_ALH: c_uint = 0x44;
pub const RZN1_RTC_ALW: c_uint = 0x48;
pub const RZN1_RTC_SECC: c_uint = 0x4c;
pub const RZN1_RTC_TIMEC: c_uint = 0x68;
pub const RZN1_RTC_CALC: c_uint = 0x6c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzn1_rtc_data {
    pub has_subu: bool,
}
...
// of potential sleeps
//
    pub ctl1_access_lock: spinlock_t,
    pub tm_alarm: rtc_time,
    pub sync_time: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn rzn1_rtc_get_time_snapshot(rtc: *mut rzn1_rtc, tm: *mut rtc_time) {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_alarm_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_1s_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_alarm_irq_enable(dev: *mut device, enable: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_read_offset(dev: *mut device, offset: *mut c_long) -> c_int {
...
// offset = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: subtract) -> else {
    else if (subtract)
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_set_offset(dev: *mut device, offset: c_long) -> c_int {
    static int rzn1_rtc_set_offset(struct device *dev, long offset)
    {
    struct rzn1_rtc *rtc = dev_get_drvdata(dev);
    int stepsh, stepsl, steps;
    let mut subu: u32 = 0, ctl2;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_disable_hardware(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rzn1_rtc_probe(pdev: *mut platform_device) -> c_int {
    static int rzn1_rtc_probe(struct platform_device *pdev)
    {
    const struct rzn1_rtc_data *data;
    struct device *dev = &pdev.dev;
    let mut rate: c_ulong = 32768;
    struct rzn1_rtc *rtc;
    u32 val, scmp_val = 0;
    struct clk *xtal;
    int irq, ret;
