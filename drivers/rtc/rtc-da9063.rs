...
//! Source: drivers/rtc/rtc-da9063.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_compatible_rtc_regmap {
// REGS
    pub rtc_enable_reg: c_int,
    pub rtc_enable_32k_crystal_reg: c_int,
    pub rtc_alarm_secs_reg: c_int,
    pub rtc_alarm_year_reg: c_int,
    pub rtc_count_secs_reg: c_int,
    pub rtc_count_year_reg: c_int,
    pub rtc_event_reg: c_int,
// MASKS
    pub rtc_enable_mask: c_int,
    pub rtc_crystal_mask: c_int,
    pub rtc_event_alarm_mask: c_int,
    pub rtc_alarm_on_mask: c_int,
    pub rtc_alarm_status_mask: c_int,
    pub rtc_tick_on_mask: c_int,
    pub rtc_ready_to_read_mask: c_int,
    pub rtc_count_sec_mask: c_int,
    pub rtc_count_min_mask: c_int,
    pub rtc_count_hour_mask: c_int,
    pub rtc_count_day_mask: c_int,
    pub rtc_count_month_mask: c_int,
    pub rtc_count_year_mask: c_int,
// ALARM CONFIG
    pub rtc_data_start: c_int,
    pub rtc_alarm_len: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_compatible_rtc {
    pub rtc_dev: *mut rtc_device,
    pub alarm_time: rtc_time,
    pub regmap: *mut regmap,
    pub config: *const da9063_compatible_rtc_regmap,
    pub rtc_sync: bool,
}
...
// ALARM CONFIG
    ...
    const struct da9063_compatible_rtc_regmap *config = rtc.config;
    let mut set_bit: u8 = enabled ? config.rtc_alarm_on_mask : 0;
...
#[no_mangle]
unsafe extern "C" fn da9063_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_alarm_event(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da9063_rtc_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    if (irq_alarm >= 0) {
    ret = devm_request_threaded_irq(&pdev.dev, irq_alarm, core::ptr::null_mut(),
    da9063_alarm_event,
