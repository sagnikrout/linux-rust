...
#[no_mangle]
pub unsafe extern "C" fn cmos_use_acpi_alarm() -> c_int {
...
pub struct cmos_rtc {
    ...
    pub dev: *mut device,
    pub irq: c_int,
    pub iomem: *mut resource,
    pub alarm_expires: time64_t,
    pub ): *mut *mut void (wake_on)(struct device,
    pub ): *mut *mut void (wake_off)(struct device,
    pub enabled_wake: u8,
    pub suspend_ctrl: u8,
...
#[no_mangle]
pub unsafe extern "C" fn is_intr(rtc_intr: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hpet_mask_rtc_irq_bit(mask: c_ulong) -> c_int {
    static inline int hpet_mask_rtc_irq_bit(unsigned long mask)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn hpet_set_rtc_irq_bit(mask: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hpet_register_irq_handler(handler: irq_handler_t) -> c_int {
    static inline int hpet_register_irq_handler(irq_handler_t handler)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn hpet_unregister_irq_handler(handler: irq_handler_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn use_hpet_alarm() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cmos_read_bank2(addr: c_uchar) -> c_uchar {
...
#[no_mangle]
pub unsafe extern "C" fn cmos_write_bank2(val: c_uchar, addr: c_uchar) {
...
// ----------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cmos_no_alarm(cmos: *mut cmos_rtc) -> bool {
    static bool cmos_no_alarm(struct cmos_rtc *cmos)
    {
    return !is_valid_irq(cmos.irq) && !cmos_use_acpi_alarm();
    }
#[no_mangle]
unsafe extern "C" fn cmos_read_time(dev: *mut device, t: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmos_set_time(dev: *mut device, t: *mut rtc_time) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmos_read_alarm_callback_param {
    pub cmos: *mut cmos_rtc,
    pub time: *mut rtc_time,
    pub rtc_control: c_uchar,
}
...
#[no_mangle]
unsafe extern "C" fn cmos_read_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmos_checkintr(cmos: *mut cmos_rtc, rtc_control: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn cmos_irq_enable(cmos: *mut cmos_rtc, mask: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn cmos_irq_disable(cmos: *mut cmos_rtc, mask: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn cmos_validate_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmos_set_alarm_callback_param {
    pub cmos: *mut cmos_rtc,
    pub sec: unsigned char mon, mday, hrs, min,,
    pub t: *mut rtc_wkalrm,
}
...
#[no_mangle]
unsafe extern "C" fn cmos_set_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmos_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmos_procfs(dev: *mut device, seq: *mut seq_file) -> c_int {
...
// buf = CMOS_READ(off);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: can_bank2) -> else {
    else if (can_bank2)
...
#[no_mangle]
unsafe extern "C" fn cmos_interrupt(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rtc_handler(context: *mut c_void) -> u32 {
    static u32 rtc_handler(void *context)
    {
    struct device *dev = context;
    struct cmos_rtc *cmos = dev_get_drvdata(dev);
    let mut rtc_control: c_uchar = 0;
    unsigned char rtc_intr;
    unsigned long flags;
//
...
#[no_mangle]
unsafe extern "C" fn acpi_rtc_event_setup(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn acpi_rtc_event_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn use_acpi_alarm_quirks() {
...
#[no_mangle]
unsafe extern "C" fn acpi_cmos_wake_setup(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_rtc_event_setup(dev: *mut device) {
    static inline void acpi_rtc_event_setup(struct device *dev)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn acpi_rtc_event_cleanup() {
    static inline void acpi_rtc_event_cleanup(void)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn acpi_cmos_wake_setup(dev: *mut device) {
...
// Macro flag: #define	INITSECTION
    ...
    let mut flags: u32 = 0;
    let mut hpet_registered: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cmos_rtc.day_alrm) -> else {
...
//
    ...
    cmos_rtc.dev = core::ptr::null_mut();
    cleanup0:
    if (RTC_IOMAPPED)
...
#[no_mangle]
unsafe extern "C" fn cmos_do_shutdown(rtc_irq: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cmos_do_remove(dev: *mut device) {
    ...
    cmos.rtc = core::ptr::null_mut();
    ports = cmos.iomem;
    if (RTC_IOMAPPED)
    release_region(ports.start, resource_size(ports));
    else
    release_mem_region(ports.start, resource_size(ports));
    cmos.iomem = core::ptr::null_mut();
    cmos.dev = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cmos_aie_poweroff(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmos_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cmos_poweroff(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmos_check_wkalrm(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn cmos_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cmos_of_init(pdev: *mut platform_device) -> __init void {
    ...
    if (!node)
    return;
    val = of_get_property(node, "ctrl-reg", core::ptr::null_mut());
    if (val)
    CMOS_WRITE(be32_to_cpup(val), RTC_CONTROL);
    val = of_get_property(node, "freq-reg", core::ptr::null_mut());
    if (val)
...
//
#[no_mangle]
unsafe extern "C" fn cmos_platform_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cmos_platform_remove(pdev: *mut platform_device) {
    static void cmos_platform_remove(struct platform_device *pdev)
    {
    cmos_do_remove(&pdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn cmos_platform_shutdown(pdev: *mut platform_device) {
    static void cmos_platform_shutdown(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct cmos_rtc	*cmos = dev_get_drvdata(dev);
    if (system_state == SYSTEM_POWER_OFF) {
    let mut retval: c_int = cmos_poweroff(dev);
...
#[no_mangle]
unsafe extern "C" fn cmos_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cmos_exit() -> void __exit {
