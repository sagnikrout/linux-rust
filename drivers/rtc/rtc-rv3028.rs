...
//! Source: drivers/rtc/rtc-rv3028.c
#![no_std]
...
pub const RV3028_SEC: c_uint = 0x00;
pub const RV3028_MIN: c_uint = 0x01;
pub const RV3028_HOUR: c_uint = 0x02;
pub const RV3028_WDAY: c_uint = 0x03;
pub const RV3028_DAY: c_uint = 0x04;
pub const RV3028_MONTH: c_uint = 0x05;
pub const RV3028_YEAR: c_uint = 0x06;
pub const RV3028_ALARM_MIN: c_uint = 0x07;
pub const RV3028_ALARM_HOUR: c_uint = 0x08;
pub const RV3028_ALARM_DAY: c_uint = 0x09;
pub const RV3028_STATUS: c_uint = 0x0E;
pub const RV3028_CTRL1: c_uint = 0x0F;
pub const RV3028_CTRL2: c_uint = 0x10;
pub const RV3028_EVT_CTRL: c_uint = 0x13;
pub const RV3028_TS_COUNT: c_uint = 0x14;
pub const RV3028_TS_SEC: c_uint = 0x15;
pub const RV3028_RAM1: c_uint = 0x1F;
pub const RV3028_EEPROM_ADDR: c_uint = 0x25;
pub const RV3028_EEPROM_DATA: c_uint = 0x26;
pub const RV3028_EEPROM_CMD: c_uint = 0x27;
pub const RV3028_CLKOUT: c_uint = 0x35;
pub const RV3028_OFFSET: c_uint = 0x36;
pub const RV3028_BACKUP: c_uint = 0x37;

pub const RV3028_EEPROM_CMD_UPDATE: c_uint = 0x11;
pub const RV3028_EEPROM_CMD_WRITE: c_uint = 0x21;
pub const RV3028_EEPROM_CMD_READ: c_uint = 0x22;
pub const RV3028_EEBUSY_POLL: c_int = 10000;
pub const RV3028_EEBUSY_TIMEOUT: c_int = 100000;

pub const RV3028_BACKUP_BSM_DSM: c_uint = 0x1;
pub const RV3028_BACKUP_BSM_LSM: c_uint = 0x3;
pub const OFFSET_STEP_PPT: c_int = 953674;
    enum rv3028_type {
    rv_3028,
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rv3028_data {
    pub regmap: *mut regmap,
    pub rtc: *mut rtc_device,
    pub type: enum rv3028_type,
...
#[no_mangle]
unsafe extern "C" fn rv3028_exit_eerd(rv3028: *mut rv3028_data, eerd: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_enter_eerd(rv3028: *mut rv3028_data, eerd: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_update_eeprom(rv3028: *mut rv3028_data, eerd: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_handle_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    sysfs_notify(&rv3028.rtc.dev.kobj, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rv3028_get_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_get_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
// The alarm has no seconds, round up to nearest minute
    if (alrm.time.tm_sec) {
    let mut alarm_time: time64_t = rtc_tm_to_time64(&alrm.time);
...
#[no_mangle]
unsafe extern "C" fn rv3028_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_read_offset(dev: *mut device, offset: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_set_offset(dev: *mut device, offset: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_param_get(dev: *mut device, param: *mut rtc_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_param_set(dev: *mut device, param: *mut rtc_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_ioctl(dev: *mut device, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_clkout_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_clkout_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn rv3028_clkout_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rv3028_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    core::ptr::null_mut(), rv3028_handle_irq,
    flags | IRQF_ONESHOT,
    "rv3028", rv3028);
    if (ret) {
