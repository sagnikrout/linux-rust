...
//! Source: drivers/rtc/rtc-rx8010.c
#![no_std]
...
pub const RX8010_SEC: c_uint = 0x10;
pub const RX8010_MIN: c_uint = 0x11;
pub const RX8010_HOUR: c_uint = 0x12;
pub const RX8010_WDAY: c_uint = 0x13;
pub const RX8010_MDAY: c_uint = 0x14;
pub const RX8010_MONTH: c_uint = 0x15;
pub const RX8010_YEAR: c_uint = 0x16;
pub const RX8010_RESV17: c_uint = 0x17;
pub const RX8010_ALMIN: c_uint = 0x18;
pub const RX8010_ALHOUR: c_uint = 0x19;
pub const RX8010_ALWDAY: c_uint = 0x1A;
pub const RX8010_TCOUNT0: c_uint = 0x1B;
pub const RX8010_TCOUNT1: c_uint = 0x1C;
pub const RX8010_EXT: c_uint = 0x1D;
pub const RX8010_FLAG: c_uint = 0x1E;
pub const RX8010_CTRL: c_uint = 0x1F;
// 0x20 to 0x2F are user registers
pub const RX8010_RESV30: c_uint = 0x30;
pub const RX8010_RESV31: c_uint = 0x31;
pub const RX8010_IRQ: c_uint = 0x32;
...
#[no_mangle]
unsafe extern "C" fn rx8010_irq_1_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rx8010_get_time(dev: *mut device, dt: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx8010_set_time(dev: *mut device, dt: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx8010_init(dev: *mut device) -> c_int {
    static int rx8010_init(struct device *dev)
    {
    struct rx8010_data *rx8010 = dev_get_drvdata(dev);
    u8 ctrl[2];
    let mut need_clear: c_int = 0, err;
...
#[no_mangle]
unsafe extern "C" fn rx8010_read_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx8010_set_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx8010_ioctl(dev: *mut device, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx8010_probe(client: *mut i2c_client) -> c_int {
