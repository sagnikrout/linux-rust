...
//! Source: drivers/rtc/rtc-pl030.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pl030_rtc {
    pub base: *mut void __iomem,
}

#[no_mangle]
unsafe extern "C" fn pl030_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pl030_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl030_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl030_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pl030_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl030_probe(dev: *mut amba_device, id: *const amba_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl030_remove(dev: *mut amba_device) {
