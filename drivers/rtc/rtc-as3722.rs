...
//! Source: drivers/rtc/rtc-as3722.c
#![no_std]
...
pub const AS3722_RTC_START_YEAR: c_int = 2000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3722_rtc {
...
#[no_mangle]
unsafe extern "C" fn as3722_time_to_reg(rbuff: *mut u8, tm: *mut rtc_time) {
...
#[no_mangle]
unsafe extern "C" fn as3722_reg_to_time(rbuff: *mut u8, tm: *mut rtc_time) {
...
#[no_mangle]
unsafe extern "C" fn as3722_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_alarm_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn as3722_rtc_probe(pdev: *mut platform_device) -> c_int {
...
// Enable the RTC to make sure it is running.
    ...
    ret = devm_request_threaded_irq(&pdev.dev, as3722_rtc.alarm_irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn as3722_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_rtc_resume(dev: *mut device) -> c_int {
