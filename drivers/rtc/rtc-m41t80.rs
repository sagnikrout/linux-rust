...
//! Source: drivers/rtc/rtc-m41t80.c
#![no_std]
...
pub const M41T80_REG_SSEC: c_uint = 0x00;
pub const M41T80_REG_SEC: c_uint = 0x01;
pub const M41T80_REG_MIN: c_uint = 0x02;
pub const M41T80_REG_HOUR: c_uint = 0x03;
pub const M41T80_REG_WDAY: c_uint = 0x04;
pub const M41T80_REG_DAY: c_uint = 0x05;
pub const M41T80_REG_MON: c_uint = 0x06;
pub const M41T80_REG_YEAR: c_uint = 0x07;
pub const M41T80_REG_ALARM_MON: c_uint = 0x0a;
pub const M41T80_REG_ALARM_DAY: c_uint = 0x0b;
pub const M41T80_REG_ALARM_HOUR: c_uint = 0x0c;
pub const M41T80_REG_ALARM_MIN: c_uint = 0x0d;
pub const M41T80_REG_ALARM_SEC: c_uint = 0x0e;
pub const M41T80_REG_FLAGS: c_uint = 0x0f;
pub const M41T80_REG_SQW: c_uint = 0x13;

    (M41T80_REG_ALARM_SEC + 1 - M41T80_REG_ALARM_MON)
pub const M41T80_SQW_MAX_FREQ: c_int = 32768;
...
#[no_mangle]
unsafe extern "C" fn m41t80_handle_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn m41t80_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t80_rtc_set_time(dev: *mut device, in_tm: *mut rtc_time) -> c_int {
    static int m41t80_rtc_set_time(struct device *dev, struct rtc_time *in_tm)
    {
    struct i2c_client *client = to_i2c_client(dev);
    struct m41t80_data *clientdata = i2c_get_clientdata(client);
    let mut tm: rtc_time = *in_tm;
    unsigned char buf[8];
    int err, flags;
    let mut time: time64_t = 0;
    flags = i2c_smbus_read_byte_data(client, M41T80_REG_FLAGS);
    if (flags < 0)
    return flags;
    if (flags & M41T80_FLAGS_OF) {
...
#[no_mangle]
unsafe extern "C" fn m41t80_rtc_proc(dev: *mut device, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t80_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t80_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t80_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t80_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t80_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m41t80_decode_freq(setting: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn m41t80_get_freq(m41t80: *mut m41t80_data) -> c_ulong {
    static unsigned long m41t80_get_freq(struct m41t80_data *m41t80)
    {
    struct i2c_client *client = m41t80.client;
    int reg_sqw = (m41t80.features & M41T80_FEATURE_SQ_ALT) ?
    M41T80_REG_WDAY : M41T80_REG_SQW;
    let mut ret: c_int = i2c_smbus_read_byte_data(client, reg_sqw);
    if (ret < 0)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(4: req->rate >= M41T80_SQW_MAX_FREQ /) -> else {
    else if (req.rate >= M41T80_SQW_MAX_FREQ / 4)
    req.rate = M41T80_SQW_MAX_FREQ / 4;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: req->rate) -> else {
    else if (req.rate)
    ...
    val = 1;
#[no_mangle]
pub unsafe extern "C" fn if(4: rate >= M41T80_SQW_MAX_FREQ /) -> else {
...
#[no_mangle]
unsafe extern "C" fn m41t80_sqw_control(hw: *mut clk_hw, enable: bool) -> c_int {
    static int m41t80_sqw_control(struct clk_hw *hw, bool enable)
    {
    struct m41t80_data *m41t80 = sqw_to_m41t80_data(hw);
    struct i2c_client *client = m41t80.client;
    let mut ret: c_int = i2c_smbus_read_byte_data(client, M41T80_REG_ALARM_MON);
    if (ret < 0)
    return ret;
    if (enable)
...
#[no_mangle]
unsafe extern "C" fn m41t80_sqw_prepare(hw: *mut clk_hw) -> c_int {
    static int m41t80_sqw_prepare(struct clk_hw *hw)
    {
    return m41t80_sqw_control(hw, 1);
    }
#[no_mangle]
unsafe extern "C" fn m41t80_sqw_unprepare(hw: *mut clk_hw) {
    static void m41t80_sqw_unprepare(struct clk_hw *hw)
    {
    m41t80_sqw_control(hw, 0);
    }
#[no_mangle]
unsafe extern "C" fn m41t80_sqw_is_prepared(hw: *mut clk_hw) -> c_int {
...
// Default margin
    ...
    let mut wdt_margin: static int = WD_TIMO;
...
//
#[no_mangle]
unsafe extern "C" fn m41t80_probe(client: *mut i2c_client) -> c_int {
    static int m41t80_probe(struct i2c_client *client)
    {
    struct i2c_adapter *adapter = client.adapter;
    let mut rc: c_int = 0;
    struct rtc_time tm;
    struct m41t80_data *m41t80_data = core::ptr::null_mut();
    ...
    core::ptr::null_mut(), m41t80_handle_irq,
...
#[no_mangle]
unsafe extern "C" fn m41t80_remove(client: *mut i2c_client) {
