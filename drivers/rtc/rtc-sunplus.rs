...
//! Source: drivers/rtc/rtc-sunplus.c
#![no_std]
...
pub const RTC_TIMER_OUT: c_uint = 0x44;
pub const RTC_DIVIDER: c_uint = 0x48;
pub const RTC_TIMER_SET: c_uint = 0x4c;
pub const RTC_ALARM_SET: c_uint = 0x50;
pub const RTC_USER_DATA: c_uint = 0x54;
pub const RTC_RESET_RECORD: c_uint = 0x58;
pub const RTC_BATT_CHARGE_CTRL: c_uint = 0x5c;

pub const RTC_TRIM_CTRL: c_uint = 0x60;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sunplus_rtc {
...
#[no_mangle]
unsafe extern "C" fn sp_get_seconds(dev: *mut device, secs: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn sp_set_seconds(dev: *mut device, secs: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn sp_rtc_set_trickle_charger(dev: device) {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_probe(plat_dev: *mut platform_device) -> c_int {
    ...
    sp_rtc.rtcclk = devm_clk_get(&plat_dev.dev, core::ptr::null_mut());
    if (IS_ERR(sp_rtc.rtcclk))
    return dev_err_probe(&plat_dev.dev, PTR_ERR(sp_rtc.rtcclk),
    "devm_clk_get fail\n");
    sp_rtc.rstc = devm_reset_control_get_exclusive(&plat_dev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_remove(plat_dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sp_rtc_resume(dev: *mut device) -> c_int {
