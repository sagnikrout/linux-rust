...
//
#[no_mangle]
pub unsafe extern "C" fn rtc_month_days(month: c_uint, year: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtc_year_days(day: c_uint, month: c_uint, year: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtc_time64_to_tm(time: time64_t, tm: *mut rtc_time) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtc_valid_tm(tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtc_tm_to_time64(tm: *mut rtc_time) -> time64_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtc_tm_to_ktime(tm: rtc_time) -> ktime_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn rtc_ktime_to_tm(kt: ktime_t) -> rtc_time {
