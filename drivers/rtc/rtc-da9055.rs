...
//! Source: drivers/rtc/rtc-da9055.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9055_rtc {
    pub rtc: *mut rtc_device,
    pub da9055: *mut da9055,
    pub alarm_enable: c_int,
}

#[no_mangle]
unsafe extern "C" fn da9055_rtc_enable_alarm(rtc: *mut da9055_rtc, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_alm_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da9055_read_alarm(da9055: *mut da9055, rtc_tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_set_alarm(da9055: *mut da9055, rtc_tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_get_alarm_status(da9055: *mut da9055) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_read_time(dev: *mut device, rtc_tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_probe(pdev: *mut platform_device) -> c_int {
    static int da9055_rtc_probe(struct platform_device *pdev)
    {
    struct da9055_rtc *rtc;
    struct da9055_pdata *pdata = core::ptr::null_mut();
    int ret, alm_irq;
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn da9055_rtc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_rtc_freeze(dev: *mut device) -> c_int {
