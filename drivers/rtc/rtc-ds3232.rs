...
//! Source: drivers/rtc/rtc-ds3232.c
#![no_std]
...
pub const DS3232_REG_SECONDS: c_uint = 0x00;
pub const DS3232_REG_MINUTES: c_uint = 0x01;
pub const DS3232_REG_HOURS: c_uint = 0x02;
pub const DS3232_REG_AMPM: c_uint = 0x02;
pub const DS3232_REG_DAY: c_uint = 0x03;
pub const DS3232_REG_DATE: c_uint = 0x04;
pub const DS3232_REG_MONTH: c_uint = 0x05;
pub const DS3232_REG_CENTURY: c_uint = 0x05;
pub const DS3232_REG_YEAR: c_uint = 0x06;
pub const DS3232_REG_ALARM1: c_uint = 0x07       /* Alarm 1 BASE */;
pub const DS3232_REG_ALARM2: c_uint = 0x0B       /* Alarm 2 BASE */;
pub const DS3232_REG_CR: c_uint = 0x0E       /* Control register */;

pub const DS3232_REG_SR: c_uint = 0x0F       /* control/status register */;

pub const DS3232_REG_TEMPERATURE: c_uint = 0x11;
pub const DS3232_REG_SRAM_START: c_uint = 0x14;
pub const DS3232_REG_SRAM_END: c_uint = 0xFF;
pub const DS3232_REG_SRAM_SIZE: c_int = 236;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ds3232 {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn ds3232_check_rtc_status(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3232_read_time(dev: *mut device, time: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3232_set_time(dev: *mut device, time: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ds3232_read_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ds3232_set_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3232_update_alarm(dev: *mut device, enabled: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ds3232_hwmon_read_temp(dev: *mut device, mC: *mut long int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3232_hwmon_register(dev: *mut device, name: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn ds3232_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3232_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// clear the alarm pend flag
    ...
    return ret;
    if (ds3232.irq > 0) {
    ret = devm_request_threaded_irq(dev, ds3232.irq, core::ptr::null_mut(),
    ds3232_irq,
...
#[no_mangle]
unsafe extern "C" fn ds3232_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3232_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3232_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3232_register_driver() -> c_int {
    static int ds3232_register_driver(void)
    {
    return i2c_add_driver(&ds3232_driver);
    }
#[no_mangle]
unsafe extern "C" fn ds3232_unregister_driver() {
...
#[no_mangle]
unsafe extern "C" fn ds3234_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds3234_register_driver() -> c_int {
    static int ds3234_register_driver(void)
    {
    return spi_register_driver(&ds3234_driver);
    }
#[no_mangle]
unsafe extern "C" fn ds3234_unregister_driver() {
...
#[no_mangle]
unsafe extern "C" fn ds323x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ds323x_exit() -> void __exit {
