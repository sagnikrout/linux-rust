...
//! Source: drivers/rtc/rtc-ftrtc010.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ftrtc010_rtc_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ftrtc010_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ftrtc010_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ftrtc010_rtc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ftrtc010_rtc_remove(pdev: *mut platform_device) {
