...
//! Source: drivers/rtc/rtc-pm8xxx.c
#![no_std]
...
pub const NUM_8_BIT_RTC_REGS: c_uint = 0x4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pm8xxx_rtc_regs {
    pub ctrl: c_uint,
    pub write: c_uint,
    pub read: c_uint,
    pub alarm_ctrl: c_uint,
    pub alarm_ctrl2: c_uint,
    pub alarm_rw: c_uint,
    pub alarm_en: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_uefi_rtc_info {
    pub offset_gps: __le32,
    pub reserved: [u8; 8],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pm8xxx_rtc {
    pub rtc: *mut rtc_device,
    pub regmap: *mut regmap,
    pub allow_set_time: bool,
    pub use_uefi: bool,
    pub alarm_irq: c_int,
    pub regs: *const pm8xxx_rtc_regs,
    pub dev: *mut device,
    pub rtc_info: qcom_uefi_rtc_info,
    pub nvmem_cell: *mut nvmem_cell,
    pub offset: u32,
...
unsafe extern "C" fn pm8xxx_rtc_read_uefi_offset(rtc_dd: *mut pm8xxx_rtc) -> c_int {
    ...
    if (rc)
    return rc;
    status = efivar_get_variable(QCOM_UEFI_NAME, &QCOM_UEFI_GUID, core::ptr::null_mut(),
    &size, rtc_info);
    efivar_unlock();
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_write_uefi_offset(rtc_dd: *mut pm8xxx_rtc, offset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_read_nvmem_offset(rtc_dd: *mut pm8xxx_rtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_write_nvmem_offset(rtc_dd: *mut pm8xxx_rtc, offset: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_read_raw(rtc_dd: *mut pm8xxx_rtc, secs: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_update_offset(rtc_dd: *mut pm8xxx_rtc, secs: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __pm8xxx_rtc_set_time(rtc_dd: *mut pm8xxx_rtc, secs: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_set_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_read_alarm(dev: *mut device, alarm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_alarm_irq_enable(dev: *mut device, enable: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_alarm_trigger(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_enable(rtc_dd: *mut pm8xxx_rtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_probe_offset(rtc_dd: *mut pm8xxx_rtc) -> c_int {
    ...
    if (rc != -ENOENT)
    return rc;
    rtc_dd.nvmem_cell = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_rtc_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (rtc_dd == core::ptr::null_mut())
    return -ENOMEM;
    rtc_dd.regs = match.data;
    rtc_dd.dev = &pdev.dev;
    rtc_dd.regmap = dev_get_regmap(pdev.dev.parent, core::ptr::null_mut());
    if (!rtc_dd.regmap)
    return -ENXIO;
...
#[no_mangle]
unsafe extern "C" fn pm8xxx_shutdown(pdev: *mut platform_device) {
