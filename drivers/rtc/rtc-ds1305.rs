...
//! Source: drivers/rtc/rtc-ds1305.c
#![no_std]
...
//
pub const DS1305_WRITE: c_uint = 0x80;
...
pub const DS1305_SEC: c_uint = 0x00		/* register addresses */;
pub const DS1305_MIN: c_uint = 0x01;
pub const DS1305_HOUR: c_uint = 0x02;

pub const DS1305_WDAY: c_uint = 0x03;
pub const DS1305_MDAY: c_uint = 0x04;
pub const DS1305_MON: c_uint = 0x05;
pub const DS1305_YEAR: c_uint = 0x06;
...
pub const DS1305_ALM_DISABLE: c_uint = 0x80;

// three control registers

pub const DS1305_CONTROL: c_uint = 0x0f		/* register addresses */;

pub const DS1305_STATUS: c_uint = 0x10;
// status has just AEIx bits, mirrored as IRQFx
pub const DS1305_TRICKLE: c_uint = 0x11;
// trickle bits are defined in <linux/spi/ds1305.h>
// a bunch of NVRAM

pub const DS1305_NVRAM: c_uint = 0x20		/* register addresses */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ds1305 {
    ...
    pub flags: c_ulong,
pub const FLAG_EXITING: c_int = 0;
    pub hr12: bool,
    pub ctrl: [u8; DS1305_CONTROL_LEN],
}
...
//
#[no_mangle]
unsafe extern "C" fn bcd2hour(bcd: u8) -> unsigned {
    static unsigned bcd2hour(u8 bcd)
    {
    if (bcd & DS1305_HR_12) {
    let mut hour: unsigned = 0;
    bcd &= ~DS1305_HR_12;
    if (bcd & DS1305_HR_PM) {
    hour = 12;
    bcd &= ~DS1305_HR_PM;
...
#[no_mangle]
unsafe extern "C" fn hour2bcd(hr12: bool, hour: c_int) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn ds1305_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
    ...
    err = spi_write_then_read(ds1305.spi, buf, sizeof(buf), core::ptr::null_mut(), 0);
    if (err >= 0)
    ds1305.ctrl[0] = buf[1];
    done:
    return err;
...
//
#[no_mangle]
unsafe extern "C" fn ds1305_get_time(dev: *mut device, time: *mut rtc_time) -> c_int {
    static int ds1305_get_time(struct device *dev, struct rtc_time *time)
    {
    struct ds1305	*ds1305 = dev_get_drvdata(dev);
    let mut addr: u8 = DS1305_SEC;
...
#[no_mangle]
unsafe extern "C" fn ds1305_set_time(dev: *mut device, time: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ds1305_get_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ds1305_set_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
// disable alarm if needed
    ...
    buf[0] = DS1305_WRITE | DS1305_CONTROL;
    buf[1] = ds1305.ctrl[0];
    status = spi_write_then_read(ds1305.spi, buf, 2, core::ptr::null_mut(), 0);
    if (status < 0)
    return status;
    }
// write alarm
    ...
    status = spi_write_then_read(spi, buf, sizeof(buf), core::ptr::null_mut(), 0);
    if (status < 0)
    return status;
...
#[no_mangle]
unsafe extern "C" fn ds1305_proc(dev: *mut device, seq: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1305_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ds1305_irq(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
    ...
    msg_init(&m, x, &addr, count, core::ptr::null_mut(), buf);
    ...
    msg_init(&m, x, &addr, count, buf, core::ptr::null_mut());
    return spi_sync(spi, &m);
    }
// ----------------------------------------------------------------------
//
...
//
#[no_mangle]
unsafe extern "C" fn ds1305_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1305_remove(spi: *mut spi_device) {
