...
//! Source: drivers/rtc/rtc-abx80x.c
#![no_std]
...
pub const ABX8XX_REG_HTH: c_uint = 0x00;
pub const ABX8XX_REG_SC: c_uint = 0x01;
pub const ABX8XX_REG_MN: c_uint = 0x02;
pub const ABX8XX_REG_HR: c_uint = 0x03;
pub const ABX8XX_REG_DA: c_uint = 0x04;
pub const ABX8XX_REG_MO: c_uint = 0x05;
pub const ABX8XX_REG_YR: c_uint = 0x06;
pub const ABX8XX_REG_WD: c_uint = 0x07;
pub const ABX8XX_REG_AHTH: c_uint = 0x08;
pub const ABX8XX_REG_ASC: c_uint = 0x09;
pub const ABX8XX_REG_AMN: c_uint = 0x0a;
pub const ABX8XX_REG_AHR: c_uint = 0x0b;
pub const ABX8XX_REG_ADA: c_uint = 0x0c;
pub const ABX8XX_REG_AMO: c_uint = 0x0d;
pub const ABX8XX_REG_AWD: c_uint = 0x0e;
pub const ABX8XX_REG_STATUS: c_uint = 0x0f;

pub const ABX8XX_REG_CTRL1: c_uint = 0x10;

pub const ABX8XX_REG_CTRL2: c_uint = 0x11;

pub const ABX8XX_REG_IRQ: c_uint = 0x12;

pub const ABX8XX_REG_CD_TIMER_CTL: c_uint = 0x18;
pub const ABX8XX_REG_OSC: c_uint = 0x1c;

pub const ABX8XX_REG_OSS: c_uint = 0x1d;

pub const ABX8XX_REG_WDT: c_uint = 0x1b;

pub const ABX8XX_WDT_BMB_MASK: c_uint = 0x7c;
pub const ABX8XX_WDT_BMB_SHIFT: c_int = 2;

pub const ABX8XX_WDT_WRB_MASK: c_uint = 0x03;
pub const ABX8XX_WDT_WRB_1HZ: c_uint = 0x02;
pub const ABX8XX_REG_CFG_KEY: c_uint = 0x1f;
pub const ABX8XX_CFG_KEY_OSC: c_uint = 0xa1;
pub const ABX8XX_CFG_KEY_MISC: c_uint = 0x9d;
pub const ABX8XX_REG_ID0: c_uint = 0x28;
pub const ABX8XX_REG_OUT_CTRL: c_uint = 0x30;

pub const ABX8XX_REG_TRICKLE: c_uint = 0x20;
pub const ABX8XX_TRICKLE_CHARGE_ENABLE: c_uint = 0xa0;
pub const ABX8XX_TRICKLE_STANDARD_DIODE: c_uint = 0x8;
pub const ABX8XX_TRICKLE_SCHOTTKY_DIODE: c_uint = 0x4;
pub const ABX8XX_REG_EXTRAM: c_uint = 0x3f;

pub const ABX8XX_SRAM_BASE: c_uint = 0x40;
pub const ABX8XX_SRAM_WIN_SIZE: c_uint = 0x40;
pub const ABX8XX_RAM_SIZE: c_int = 256;
...
#[no_mangle]
unsafe extern "C" fn abx80x_write_config_key(client: *mut i2c_client, key: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_is_rc_mode(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_handle_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn abx80x_read_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_set_alarm(dev: *mut device, t: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_rtc_get_autocalibration(dev: *mut device) -> c_int {
    static int abx80x_rtc_get_autocalibration(struct device *dev)
    {
    struct i2c_client *client = to_i2c_client(dev);
    let mut flags: c_int = 0, autocalibration;
    flags =  i2c_smbus_read_byte_data(client, ABX8XX_REG_OSC);
    if (flags < 0)
    return flags;
    ...
    autocalibration = 512;
#[no_mangle]
pub unsafe extern "C" fn if(ABX8XX_OSC_ACAL_1024: flags &) -> else {
    ...
    {
    int retval;
    let mut autocalibration: c_ulong = 0;
    ...
    {
    let mut autocalibration: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn abx80x_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_ioctl(dev: *mut device, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_dt_trickle_cfg(client: *mut i2c_client) -> c_int {
    static int abx80x_dt_trickle_cfg(struct i2c_client *client)
    {
    struct device_node *np = client.dev.of_node;
    const char *diode;
    let mut trickle_cfg: c_int = 0;
    int i, ret;
    u32 tmp;
...
#[no_mangle]
pub unsafe extern "C" fn timeout_bits(timeout: c_uint) -> u8 {
    ...
    let mut val: u8 = ABX8XX_WDT_WDS | timeout_bits(timeout);
//
...
#[no_mangle]
unsafe extern "C" fn abx80x_wdog_ping(wdog: *mut watchdog_device) -> c_int {
    static int abx80x_wdog_ping(struct watchdog_device *wdog)
    {
    return __abx80x_wdog_set_timeout(wdog, wdog.timeout);
    }
#[no_mangle]
unsafe extern "C" fn abx80x_wdog_start(wdog: *mut watchdog_device) -> c_int {
    static int abx80x_wdog_start(struct watchdog_device *wdog)
    {
    return __abx80x_wdog_set_timeout(wdog, wdog.timeout);
    }
#[no_mangle]
unsafe extern "C" fn abx80x_wdog_stop(wdog: *mut watchdog_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_setup_watchdog(priv: *mut abx80x_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_setup_nvmem(priv: *mut abx80x_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx80x_probe(client: *mut i2c_client) -> c_int {
    ...
    char buf[7];
    let mut part: c_uint = (uintptr_t)i2c_get_match_data(client);
