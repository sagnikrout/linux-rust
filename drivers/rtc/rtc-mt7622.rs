...
//! Source: drivers/rtc/rtc-mt7622.c
#![no_std]
...
pub const MTK_RTC_PWRCHK1: c_uint = 0x4;
pub const RTC_PWRCHK1_MAGIC: c_uint = 0xc6;
pub const MTK_RTC_PWRCHK2: c_uint = 0x8;
pub const RTC_PWRCHK2_MAGIC: c_uint = 0x9a;
pub const MTK_RTC_KEY: c_uint = 0xc;
pub const RTC_KEY_MAGIC: c_uint = 0x59;
pub const MTK_RTC_PROT1: c_uint = 0x10;
pub const RTC_PROT1_MAGIC: c_uint = 0xa3;
pub const MTK_RTC_PROT2: c_uint = 0x14;
pub const RTC_PROT2_MAGIC: c_uint = 0x57;
pub const MTK_RTC_PROT3: c_uint = 0x18;
pub const RTC_PROT3_MAGIC: c_uint = 0x67;
pub const MTK_RTC_PROT4: c_uint = 0x1c;
pub const RTC_PROT4_MAGIC: c_uint = 0xd2;
pub const MTK_RTC_CTL: c_uint = 0x20;

pub const MTK_RTC_DEBNCE: c_uint = 0x2c;

pub const MTK_RTC_INT: c_uint = 0x30;
...
pub const MTK_RTC_AL_CTL: c_uint = 0x7c;
...
//
pub const MTK_RTC_TM_YR_OFFSET: c_int = 100;
//
...
//
pub const MTK_RTC_HW_YR_LIMIT: c_int = 99;
...
#[no_mangle]
unsafe extern "C" fn mtk_w32(rtc: *mut mtk_rtc, reg: u32, val: u32) {
    static void mtk_w32(struct mtk_rtc *rtc, u32 reg, u32 val)
    {
    writel_relaxed(val, rtc.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn mtk_r32(rtc: *mut mtk_rtc, reg: u32) -> u32 {
    static u32 mtk_r32(struct mtk_rtc *rtc, u32 reg)
    {
    return readl_relaxed(rtc.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn mtk_rmw(rtc: *mut mtk_rtc, reg: u32, mask: u32, set: u32) {
...
#[no_mangle]
unsafe extern "C" fn mtk_set(rtc: *mut mtk_rtc, reg: u32, val: u32) {
    static void mtk_set(struct mtk_rtc *rtc, u32 reg, u32 val)
    {
    mtk_rmw(rtc, reg, 0, val);
    }
#[no_mangle]
unsafe extern "C" fn mtk_clr(rtc: *mut mtk_rtc, reg: u32, val: u32) {
    static void mtk_clr(struct mtk_rtc *rtc, u32 reg, u32 val)
    {
    mtk_rmw(rtc, reg, val, 0);
    }
#[no_mangle]
unsafe extern "C" fn mtk_rtc_hw_init(hw: *mut mtk_rtc) {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_alarmirq(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_gettime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_settime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_getalarm(dev: *mut device, wkalrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_setalarm(dev: *mut device, wkalrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_rtc_resume(dev: *mut device) -> c_int {
