...
//! Source: drivers/rtc/rtc-palmas.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_alarm_irq_enable(dev: *mut device, enabled: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_read_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_set_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_clear_interrupts(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_interrupt(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_probe(pdev: *mut platform_device) -> c_int {
    static int palmas_rtc_probe(struct platform_device *pdev)
    {
    struct palmas *palmas = dev_get_drvdata(pdev.dev.parent);
    struct palmas_rtc *palmas_rtc = core::ptr::null_mut();
    int ret;
    let mut enable_bb_charging: bool = false;
    let mut high_bb_charging: bool = false;
    if (pdev.dev.of_node) {
...
// Clear pending interrupts
    ...
    let mut reg: unsigned = PALMAS_BACKUP_BATTERY_CTRL_BBS_BBC_LOW_ICHRG;
    if (high_bb_charging)
    reg = 0;
...
// Start RTC
    ...
    ret = devm_request_threaded_irq(&pdev.dev, palmas_rtc.irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_rtc_resume(dev: *mut device) -> c_int {
