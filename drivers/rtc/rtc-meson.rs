...
//! Source: drivers/rtc/rtc-meson.c
#![no_std]
...
pub const RTC_ADDR0: c_uint = 0x00;

pub const RTC_ADDR1: c_uint = 0x04;

pub const RTC_ADDR2: c_uint = 0x08;
pub const RTC_ADDR3: c_uint = 0x0c;
pub const RTC_REG4: c_uint = 0x10;

// rtc registers accessed via rtc-serial interface

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_rtc {
    pub /: *mut *mut *mut device dev; / device we bound from,
    pub /: *mut *mut *mut reset_control reset; / reset source,
    pub /: *mut *mut *mut regulator vdd; / voltage input,
    pub /: *mut *mut *mut regmap peripheral; / peripheral registers,
    pub /: *mut *mut *mut regmap serial; / serial registers,
}
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_sclk_pulse(rtc: *mut meson_rtc) {
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_send_bit(rtc: *mut meson_rtc, bit: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_set_dir(rtc: *mut meson_rtc, mode: u32) {
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_get_data(rtc: *mut meson_rtc) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_get_bus(rtc: *mut meson_rtc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_write_static(rtc: *mut meson_rtc, data: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_gettime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_settime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_rtc_probe(pdev: *mut platform_device) -> c_int {
    ...
    rtc.reset = devm_reset_control_get(dev, core::ptr::null_mut());
    if (IS_ERR(rtc.reset)) {
