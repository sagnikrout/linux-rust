...
//! Source: drivers/rtc/rtc-hid-sensor-time.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hid_time_state {
    pub callbacks: hid_sensor_hub_callbacks,
    pub common_attributes: hid_sensor_common,
    pub info: [hid_sensor_hub_attribute_info; TIME_RTC_CHANNEL_MAX],
    pub last_time: rtc_time,
    pub lock_last_time: spinlock_t,
    pub comp_last_time: completion,
    pub time_buf: rtc_time,
...
#[no_mangle]
unsafe extern "C" fn hid_time_value(raw_len: usize, raw_data: *mut c_char) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hid_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hid_time_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (time_state == core::ptr::null_mut())
    return -ENOMEM;
...
//
    ...
    time_state.rtc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hid_time_remove(pdev: *mut platform_device) {
