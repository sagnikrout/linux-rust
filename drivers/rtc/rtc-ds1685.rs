...
//! Source: drivers/rtc/rtc-ds1685.c
#![no_std]
...
// Call the platform pre-poweroff function. Else, shutdown.
    if (rtc.prepare_poweroff != core::ptr::null_mut())
...
// Call the platform wake_alarm function if defined.
    if (rtc.wake_alarm != core::ptr::null_mut())
    rtc.wake_alarm();
    else
    dev_warn(&pdev.dev,
...
// Call the platform post_ram_clear function if defined.
    if (rtc.post_ram_clear != core::ptr::null_mut())
    rtc.post_ram_clear();
    else
    dev_warn(&pdev.dev,
...
//
    ...
    static DEVICE_ATTR(battery, S_IRUGO, ds1685_rtc_sysfs_battery_show, core::ptr::null_mut());
//
...
//
    ...
    static DEVICE_ATTR(auxbatt, S_IRUGO, ds1685_rtc_sysfs_auxbatt_show, core::ptr::null_mut());
//
...
//
    ...
    static DEVICE_ATTR(serial, S_IRUGO, ds1685_rtc_sysfs_serial_show, core::ptr::null_mut());
//
...
// Request an IRQ.
    ...
    core::ptr::null_mut(), ds1685_rtc_irq_handler,
