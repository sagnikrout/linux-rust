...
//! Source: drivers/rtc/rtc-stk17ta8.c
#![no_std]
...
pub const RTC_REG_SIZE: c_uint = 0x20000;
pub const RTC_OFFSET: c_uint = 0x1fff0;

pub const RTC_SECONDS_MASK: c_uint = 0x7f;
pub const RTC_DAY_MASK: c_uint = 0x07;
pub const RTC_CAL_MASK: c_uint = 0x3f;
// Bits in the Calibration register
pub const RTC_STOP: c_uint = 0x80;
// Bits in the Flags register
pub const RTC_FLAGS_AF: c_uint = 0x40;
pub const RTC_FLAGS_PF: c_uint = 0x20;
pub const RTC_WRITE: c_uint = 0x02;
pub const RTC_READ: c_uint = 0x01;
// Bits in the Interrupts register
pub const RTC_INTS_AIE: c_uint = 0x40;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn stk17ta8_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk17ta8_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk17ta8_rtc_update_alarm(pdata: *mut rtc_plat_data) {
...
#[no_mangle]
unsafe extern "C" fn stk17ta8_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk17ta8_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stk17ta8_rtc_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stk17ta8_rtc_probe(pdev: *mut platform_device) -> c_int {
