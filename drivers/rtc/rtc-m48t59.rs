...
//! Source: drivers/rtc/rtc-m48t59.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m48t59_private {
    pub ioaddr: *mut void __iomem,
    pub irq: c_int,
    pub rtc: *mut rtc_device,
    pub /: *mut *mut spinlock_t lock; / serialize the NVRAM and RTC access,
}
...
//
#[no_mangle]
unsafe extern "C" fn m48t59_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m48t59_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
    ...
    unsigned long flags;
    let mut val: u8 = 0;
    let mut year: c_int = tm.tm_year - pdata.yy_offset;
...
//
#[no_mangle]
unsafe extern "C" fn m48t59_rtc_readalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn m48t59_rtc_setalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn m48t59_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m48t59_rtc_proc(dev: *mut device, seq: *mut seq_file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn m48t59_rtc_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn m48t59_rtc_probe(pdev: *mut platform_device) -> c_int {
    static int m48t59_rtc_probe(struct platform_device *pdev)
    {
    struct m48t59_plat_data *pdata = dev_get_platdata(&pdev.dev);
    struct m48t59_private *m48t59 = core::ptr::null_mut();
    struct resource *res;
