...
//! Source: drivers/rtc/rtc-88pm80x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pm80x_rtc_info {
    pub chip: *mut pm80x_chip,
    pub map: *mut regmap,
...
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_suspend(dev: *mut device) -> c_int {
    static int pm80x_rtc_suspend(struct device *dev)
    {
    return pm80x_dev_suspend(dev);
    }
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm80x_rtc_remove(pdev: *mut platform_device) {
