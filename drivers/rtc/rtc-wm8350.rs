...
//! Source: drivers/rtc/rtc-wm8350.c
#![no_std]
...
pub const WM8350_SET_ALM_RETRIES: c_int = 5;
pub const WM8350_SET_TIME_RETRIES: c_int = 5;
pub const WM8350_GET_TIME_RETRIES: c_int = 5;
//
// Read current time and date in RTC
//
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_readtime(dev: *mut device, tm: *mut rtc_time) -> c_int {
    static int wm8350_rtc_readtime(struct device *dev, struct rtc_time *tm)
    {
    struct wm8350 *wm8350 = dev_get_drvdata(dev);
    u16 time1[4], time2[4];
    let mut retries: c_int = WM8350_GET_TIME_RETRIES, ret;
//
...
//
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_settime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_readalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_stop_alarm(wm8350: *mut wm8350) -> c_int {
    static int wm8350_rtc_stop_alarm(struct wm8350 *wm8350)
    {
    let mut retries: c_int = WM8350_SET_ALM_RETRIES;
    u16 rtc_ctrl;
    int ret;
// Set RTC_SET to stop the clock
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_start_alarm(wm8350: *mut wm8350) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_setalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_alarm_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_update_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_rtc_remove(pdev: *mut platform_device) {
