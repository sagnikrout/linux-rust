...
//! Source: drivers/rtc/rtc-rc5t619.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rc5t619_rtc {
    pub irq: c_int,
    pub rtc: *mut rtc_device,
    pub rn5t618: *mut rn5t618,
}

pub const CTRL1_ALARM_ENABLED: c_uint = 0x40;
pub const CTRL1_24HR: c_uint = 0x20;
pub const CTRL1_PERIODIC_MASK: c_uint = 0xf;
pub const CTRL2_PON: c_uint = 0x10;
pub const CTRL2_ALARM_STATUS: c_uint = 0x80;
pub const CTRL2_CTFG: c_uint = 0x4;
pub const CTRL2_CTC: c_uint = 0x1;
pub const MONTH_CENTFLAG: c_uint = 0x80;
pub const HOUR_PMFLAG: c_uint = 0x20;
pub const MDAY_DAL_EXT: c_uint = 0x80;
#[no_mangle]
unsafe extern "C" fn rtc5t619_12hour_bcd2bin(hour: u8) -> u8 {
    static uint8_t rtc5t619_12hour_bcd2bin(uint8_t hour)
    {
    if (hour & HOUR_PMFLAG) {
    hour = bcd2bin(hour & ~HOUR_PMFLAG);
    let mut hour: return = = 12 ? 12 : 12 + hour;
    }
    hour = bcd2bin(hour);
    let mut hour: return = = 12 ? 0 : hour;
    }
#[no_mangle]
unsafe extern "C" fn rtc5t619_12hour_bin2bcd(hour: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_periodic_disable(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_pon_setup(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
// 0-disable, 1-enable
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_alarm_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_alarm_flag_clr(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rc5t619_rtc_probe(pdev: *mut platform_device) -> c_int {
...
// set interrupt and enable it
    if (rtc.irq != -1) {
    err = devm_request_threaded_irq(&pdev.dev, rtc.irq, core::ptr::null_mut(),
    rc5t619_rtc_irq,
    IRQF_ONESHOT,
    "rtc-rc5t619",
    &pdev.dev);
