...
pub const CONTROL_REG: c_uint = 0x00;
pub const MODE_REG: c_uint = 0x04;
pub const PRESCALER_REG: c_uint = 0x08;
pub const ALARM_LOWER_REG: c_uint = 0x0c;
pub const ALARM_UPPER_REG: c_uint = 0x10;
pub const COMPARE_LOWER_REG: c_uint = 0x14;
pub const COMPARE_UPPER_REG: c_uint = 0x18;
pub const DATETIME_LOWER_REG: c_uint = 0x20;
pub const DATETIME_UPPER_REG: c_uint = 0x24;

pub const UPLOAD_TIMEOUT_US: c_int = 50;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpfs_rtc_dev {
    pub rtc: *mut rtc_device,
    pub base: *mut void __iomem,
}

#[no_mangle]
unsafe extern "C" fn mpfs_rtc_start(rtcdev: *mut mpfs_rtc_dev) {
...
#[no_mangle]
unsafe extern "C" fn mpfs_rtc_clear_irq(rtcdev: *mut mpfs_rtc_dev) {
    static void mpfs_rtc_clear_irq(struct mpfs_rtc_dev *rtcdev)
    {
    let mut val: u32 = readl(rtcdev.base + CONTROL_REG);
...
#[no_mangle]
unsafe extern "C" fn mpfs_rtc_readtime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_rtc_settime(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_rtc_readalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
    static int mpfs_rtc_readalarm(struct device *dev, struct rtc_wkalrm *alrm)
    {
    struct mpfs_rtc_dev *rtcdev = dev_get_drvdata(dev);
    let mut mode: u32 = readl(rtcdev.base + MODE_REG);
    u64 time;
...
#[no_mangle]
unsafe extern "C" fn mpfs_rtc_setalarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_rtc_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpfs_rtc_wakeup_irq_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpfs_rtc_probe(pdev: *mut platform_device) -> c_int {
