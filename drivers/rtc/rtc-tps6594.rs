...
//! Source: drivers/rtc/rtc-tps6594.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_shadow_timestamp(dev: *mut device, tps: *mut tps6594) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_set_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_read_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_set_alarm(dev: *mut device, alm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_set_calibration(dev: *mut device, calibration: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_get_calibration(dev: *mut device, calibration: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_read_offset(dev: *mut device, offset: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_set_offset(dev: *mut device, offset: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_probe(pdev: *mut platform_device) -> c_int {
...
// Stop RTC until first call to `tps6594_rtc_set_time`.
    ...
    rtc.irq = irq;
    ret = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), tps6594_rtc_interrupt,
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6594_rtc_suspend(dev: *mut device) -> c_int {
