...
//! Source: drivers/opp/ti-opp-supply.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_opp_supply_optimum_voltage_table {
    pub reference_uv: c_uint,
    pub optimized_uv: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_opp_supply_data {
    pub vdd_table: *mut ti_opp_supply_optimum_voltage_table,
    pub num_vdd_table: u32,
    pub vdd_absolute_max_voltage_uv: u32,
    pub old_supplies: [dev_pm_opp_supply; 2],
    pub new_supplies: [dev_pm_opp_supply; 2],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_opp_supply_of_data {

    pub flags: u8,
    pub efuse_voltage_mask: u32,
    pub efuse_voltage_uv: bool,
}
...
// Fetch efuse-settings.
    prop = of_find_property(dev.of_node, "ti,efuse-settings", core::ptr::null_mut());
    if (!prop) {
...
//
    ...
    data.vdd_table = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ti_opp_supply_probe(pdev: *mut platform_device) -> c_int {
