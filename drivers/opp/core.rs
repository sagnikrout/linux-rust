...
#[no_mangle]
unsafe extern "C" fn _find_opp_dev(dev: *const device, opp_table: *mut opp_table) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_bw(opp: *mut dev_pm_opp, peak: bool, index: c_int) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_voltage(opp: *mut dev_pm_opp) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_power(opp: *mut dev_pm_opp) -> c_ulong {
    unsigned long dev_pm_opp_get_power(struct dev_pm_opp *opp)
    {
    let mut opp_power: c_ulong = 0;
    int i;
    if (IS_ERR_OR_NULL(opp)) {
    pr_err("%s: Invalid parameters\n", __func__);
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_freq_indexed(opp: *mut dev_pm_opp, index: u32) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_level(opp: *mut dev_pm_opp) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_is_turbo(opp: *mut dev_pm_opp) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_max_clock_latency(dev: *mut device) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_max_volt_latency(dev: *mut device) -> c_ulong {
    unsigned long dev_pm_opp_get_max_volt_latency(struct device *dev)
    {
    struct dev_pm_opp *opp;
    struct regulator *reg;
    let mut latency_ns: c_ulong = 0;
    int ret, i, count;
    struct {
    unsigned long min;
    unsigned long max;
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_max_transition_latency(dev: *mut device) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_suspend_opp_freq(dev: *mut device) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn _get_opp_count(opp_table: *mut opp_table) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_get_opp_count(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _read_freq(opp: *mut dev_pm_opp, index: c_int) -> c_ulong {
    static unsigned long _read_freq(struct dev_pm_opp *opp, int index)
    {
    return opp.rates[index];
    }
#[no_mangle]
unsafe extern "C" fn _read_level(opp: *mut dev_pm_opp, index: c_int) -> c_ulong {
    static unsigned long _read_level(struct dev_pm_opp *opp, int index)
    {
    return opp.level;
    }
#[no_mangle]
unsafe extern "C" fn _read_bw(opp: *mut dev_pm_opp, index: c_int) -> c_ulong {
...
// opp = temp_opp;
    ...
    struct dev_pm_opp_key *key)
    {
    let mut level_match: bool = (key.level == OPP_LEVEL_UNSET || opp_key.level == key.level);
    let mut freq_match: bool = (key.freq == 0 || opp_key.freq == key.freq);
    let mut bw_match: bool = (key.bw == 0 || opp_key.bw == key.bw);
...
//
    ...
    unsigned int level)
    {
    return _find_key_exact(dev, level, 0, true, _read_level, core::ptr::null_mut());
    }
...
//
    ...
    unsigned int *level)
    {
    let mut temp: c_ulong = *level;
    struct dev_pm_opp *opp;
    opp = _find_key_ceil(dev, &temp, 0, true, _read_level, core::ptr::null_mut());
    if (IS_ERR(opp))
    return opp;
// False match
...
//
    ...
    let mut temp: c_ulong = *level;
    struct dev_pm_opp *opp;
    opp = _find_key_floor(dev, &temp, 0, true, _read_level, core::ptr::null_mut());
// level = temp;
    return opp;
    }
...
#[no_mangle]
unsafe extern "C" fn _set_opp_level(dev: *mut device, opp: *mut dev_pm_opp) -> c_int {
...
// Scaling up? Set required OPPs in normal order, else reverse
    ...
    while (index != target) {
    if (devs[index]) {
    required_opp = opp ? opp.required_opps[index] : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn _find_current_opp(dev: *mut device, opp_table: *mut opp_table) {
...
#[no_mangle]
unsafe extern "C" fn _disable_opp_table(dev: *mut device, opp_table: *mut opp_table) -> c_int {
...
//
    ...
    return 0;
    ret = _set_opp_bw(opp_table, core::ptr::null_mut(), dev);
    if (ret)
    return ret;
    if (opp_table.regulators)
    regulator_disable(opp_table.regulators[0]);
    ret = _set_opp_level(dev, core::ptr::null_mut());
    if (ret)
    goto out;
    ret = _set_required_opps(dev, opp_table, core::ptr::null_mut(), false);
    out:
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_set_rate(dev: *mut device, target_freq: c_ulong) -> c_int {
    int dev_pm_opp_set_rate(struct device *dev, unsigned long target_freq)
    {
    struct opp_table *opp_table __free(put_opp_table) =
    _find_opp_table(dev);
    struct dev_pm_opp *opp __free(put_opp) = core::ptr::null_mut();
    let mut freq: c_ulong = 0, temp_freq;
...
//
    if (!_get_opp_count(opp_table)) {
    return opp_table.config_clks(dev, opp_table, core::ptr::null_mut(),
    &target_freq, false);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_set_opp(dev: *mut device, opp: *mut dev_pm_opp) -> c_int {
    ...
    return _set_opp(dev, opp_table, opp, core::ptr::null_mut(), false);
    }
...
//
    opp_table.clk = clk_get_optional(dev, core::ptr::null_mut());
    if (IS_ERR(opp_table.clk)) {
...
#[no_mangle]
unsafe extern "C" fn _opp_table_kref_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_put_opp_table(opp_table: *mut opp_table) {
...
#[no_mangle]
pub unsafe extern "C" fn _opp_free(opp: *mut dev_pm_opp) {
    void _opp_free(struct dev_pm_opp *opp)
    {
    kfree(opp);
    }
#[no_mangle]
unsafe extern "C" fn _opp_kref_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_put(opp: *mut dev_pm_opp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_remove(dev: *mut device, freq: c_ulong) {
    void dev_pm_opp_remove(struct device *dev, unsigned long freq)
    {
    struct dev_pm_opp *opp = core::ptr::null_mut(), *iter;
    struct opp_table *opp_table __free(put_opp_table) =
    _find_opp_table(dev);
    if (IS_ERR(opp_table))
    return;
...
//
#[no_mangle]
unsafe extern "C" fn _opp_remove_all(opp_table: *mut opp_table, dynamic: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn _opp_remove_all_static(opp_table: *mut opp_table) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_remove_all_dynamic(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn _required_opps_available(opp: *mut dev_pm_opp, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn _opp_put_supported_hw(opp_table: *mut opp_table) {
    static void _opp_put_supported_hw(struct opp_table *opp_table)
    {
    if (opp_table.supported_hw) {
    kfree(opp_table.supported_hw);
    opp_table.supported_hw = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn _opp_set_prop_name(opp_table: *mut opp_table, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _opp_put_prop_name(opp_table: *mut opp_table) {
    static void _opp_put_prop_name(struct opp_table *opp_table)
    {
    if (opp_table.prop_name) {
    kfree(opp_table.prop_name);
    opp_table.prop_name = core::ptr::null_mut();
    }
    }
//
...
// Set generic config_regulators() for single regulators here
    ...
    opp_table.regulators = core::ptr::null_mut();
    opp_table.regulator_count = -1;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn _opp_put_regulators(opp_table: *mut opp_table) {
...
#[no_mangle]
unsafe extern "C" fn _put_clks(opp_table: *mut opp_table, count: c_int) {
    ...
    opp_table.clks = core::ptr::null_mut();
    }
//
...
#[no_mangle]
unsafe extern "C" fn _opp_put_clknames(opp_table: *mut opp_table) {
    static void _opp_put_clknames(struct opp_table *opp_table)
    {
    if (!opp_table.clks)
    return;
    opp_table.config_clks = core::ptr::null_mut();
    opp_table.clk = ERR_PTR(-ENODEV);
...
#[no_mangle]
unsafe extern "C" fn _opp_put_config_regulators_helper(opp_table: *mut opp_table) {
    static void _opp_put_config_regulators_helper(struct opp_table *opp_table)
    {
    if (opp_table.config_regulators)
    opp_table.config_regulators = core::ptr::null_mut();
    }
...
//
    ...
    unsigned int index)
    {
    opp_table.required_devs[index] = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn _opp_clear_config(data: *mut opp_config_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_set_config(dev: *mut device, config: *mut dev_pm_opp_config) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_clear_config(token: c_int) {
...
#[no_mangle]
unsafe extern "C" fn devm_pm_opp_config_release(token: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_pm_opp_set_config(dev: *mut device, config: *mut dev_pm_opp_config) -> c_int {
    int devm_pm_opp_set_config(struct device *dev, struct dev_pm_opp_config *config)
    {
    let mut token: c_int = dev_pm_opp_set_config(dev, config);
    if (token < 0)
    return token;
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_add_dynamic(dev: *mut device, data: *mut dev_pm_opp_data) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_sync_regulators(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_enable(dev: *mut device, freq: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_disable(dev: *mut device, freq: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_register_notifier(dev: *mut device, nb: *mut notifier_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_opp_remove_table(dev: *mut device) {
...
// Check for existing table for 'dev'
    ...
    _find_opp_table(dev);
    if (IS_ERR(opp_table)) {
    let mut error: c_int = PTR_ERR(opp_table);
    if (error != -ENODEV)
