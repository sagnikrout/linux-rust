...
#[no_mangle]
unsafe extern "C" fn opp_set_dev_name(dev: *const device, name: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn opp_debug_remove_one(opp: *mut dev_pm_opp) {
...
#[no_mangle]
pub unsafe extern "C" fn opp_debug_create_one(opp: *mut dev_pm_opp, opp_table: *mut opp_table) {
    void opp_debug_create_one(struct dev_pm_opp *opp, struct opp_table *opp_table)
    {
    struct dentry *pdentry = opp_table.dentry;
    struct dentry *d;
    char name[36];	/* "opp:"(4) + u64(20) + "-" (1) + u32(10) + core::ptr::null_mut()(1) */
//
...
//
#[no_mangle]
pub unsafe extern "C" fn opp_debug_register(opp_dev: *mut opp_device, opp_table: *mut opp_table) {
    ...
    struct opp_table *opp_table)
    {
    struct opp_device *new_dev = core::ptr::null_mut(), *iter;
...
// Move the real dentry object under another device
    ...
    opp_table.dentry = core::ptr::null_mut();
    }
    debugfs_remove_recursive(opp_dev.dentry);
    out:
    opp_dev.dentry = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn opp_debug_init() -> int __init {
    static int __init opp_debug_init(void)
    {
// Create /sys/kernel/debug/opp directory
    rootdir = debugfs_create_dir("opp", core::ptr::null_mut());
    return 0;
    }
