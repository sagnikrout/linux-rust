...
#[no_mangle]
unsafe extern "C" fn nvdimm_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdimm_remove(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_init() -> int __init {
    int __init nvdimm_init(void)
    {
    return nd_driver_register(&nvdimm_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn nvdimm_exit() {
