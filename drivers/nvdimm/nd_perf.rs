...
//! Source: drivers/nvdimm/nd_perf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nvdimm_pmu_cpu_offline(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdimm_pmu_cpu_online(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_cpumask_attr_group(nd_pmu: *mut nvdimm_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvdimm_pmu_free_hotplug_memory(nd_pmu: *mut nvdimm_pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn register_nvdimm_pmu(nd_pmu: *mut nvdimm_pmu, pdev: *mut platform_device) -> c_int {
...
// Fill attribute groups for the nvdimm pmu device
    ...
    nd_pmu.pmu.attr_groups[NVDIMM_PMU_NULL_ATTR] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn unregister_nvdimm_pmu(nd_pmu: *mut nvdimm_pmu) {
