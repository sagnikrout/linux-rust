...
//! Source: drivers/nvdimm/dimm_devs.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn nvdimm_check_config_data(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_dimm(ndd: *mut nvdimm_drvdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nvdimm_init_nsarea(ndd: *mut nvdimm_drvdata) -> c_int {
    int nvdimm_init_nsarea(struct nvdimm_drvdata *ndd)
    {
    struct nd_cmd_get_config_size *cmd = &ndd.nsarea;
    struct nvdimm_bus *nvdimm_bus = walk_to_nvdimm_bus(ndd.dev);
    struct nvdimm_bus_descriptor *nd_desc;
    let mut rc: c_int = validate_dimm(ndd);
    let mut cmd_rc: c_int = 0;
    if (rc)
    return rc;
    if (cmd.config_size)
    ...
    let mut rc: c_int = validate_dimm(ndd), cmd_rc = 0;
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_set_labeling(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_set_locked(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_clear_locked(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn nvdimm_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_drvdata_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn get_ndd(ndd: *mut nvdimm_drvdata) {
    void get_ndd(struct nvdimm_drvdata *ndd)
    {
    kref_get(&ndd.kref);
    }
#[no_mangle]
pub unsafe extern "C" fn put_ndd(ndd: *mut nvdimm_drvdata) {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_cmd_mask(nvdimm: *mut nvdimm) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn sprintf(_arg: buf, _arg: "%s\n", _arg: atomic_read(&nvdimm->busy) -> return {
    return sprintf(buf, "%s\n", atomic_read(&nvdimm.busy)
    ? "active" : "idle");
    }
    static DEVICE_ATTR_RO(state);
#[no_mangle]
unsafe extern "C" fn __available_slots_show(ndd: *mut nvdimm_drvdata, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nvdimm_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn result_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn activate_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    arg = NVDIMM_FWA_ARM;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "disarm")) -> else {
...
#[no_mangle]
unsafe extern "C" fn nvdimm_firmware_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
pub unsafe extern "C" fn is_nvdimm(dev: *const device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_delete(nvdimm: *mut nvdimm) {
    void nvdimm_delete(struct nvdimm *nvdimm)
    {
    struct device *dev = &nvdimm.dev;
    let mut dev_put: bool = false;
...
#[no_mangle]
unsafe extern "C" fn shutdown_security_notify(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_security_setup_events(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_in_overwrite(nvdimm: *mut nvdimm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_security_freeze(nvdimm: *mut nvdimm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpa_align(nd_region: *mut nd_region) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_free_dpa(ndd: *mut nvdimm_drvdata, res: *mut resource) {
...
//
    ...
    {
    let mut allocated: resource_size_t = 0;
    struct resource *res;
    for_each_dpa_resource(ndd, res)
...
#[no_mangle]
unsafe extern "C" fn count_dimms(dev: *mut device, c: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_bus_check_dimm_count(nvdimm_bus: *mut nvdimm_bus, dimm_count: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_devs_exit() -> void __exit {
