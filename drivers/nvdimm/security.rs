...
//! Source: drivers/nvdimm/security.c
#![no_std]
...
pub const NVDIMM_BASE_KEY: c_int = 0;
pub const NVDIMM_NEW_KEY: c_int = 1;
    let mut key_revalidate: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn nvdimm_put_key(key: *mut key) {
...
#[no_mangle]
unsafe extern "C" fn nvdimm_key_revalidate(nvdimm: *mut nvdimm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __nvdimm_security_unlock(nvdimm: *mut nvdimm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_security_unlock(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_security_state(nvdimm: *mut nvdimm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn security_overwrite(nvdimm: *mut nvdimm, keyid: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __nvdimm_security_overwrite_query(nvdimm: *mut nvdimm) {
...
#[no_mangle]
pub unsafe extern "C" fn nvdimm_security_overwrite_query(work: *mut work_struct) {
...
pub const SEC_CMD_SIZE: c_int = 32;
pub const KEY_ID_SIZE: c_int = 10;
#[no_mangle]
pub unsafe extern "C" fn nvdimm_security_store(dev: *mut device, buf: *const c_char, len: usize) -> isize {
