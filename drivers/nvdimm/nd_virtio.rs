...
//! Source: drivers/nvdimm/nd_virtio.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_pmem_flush_work {
...
#[no_mangle]
unsafe extern "C" fn virtio_pmem_req_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn virtio_pmem_signal_done(req: *mut virtio_pmem_request) {
...
#[no_mangle]
unsafe extern "C" fn virtio_pmem_req_done(req: *mut virtio_pmem_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn virtio_pmem_complete_err(req: *mut virtio_pmem_request) {
...
#[no_mangle]
unsafe extern "C" fn virtio_pmem_wake_one_waiter(vpmem: *mut virtio_pmem) {
...
#[no_mangle]
unsafe extern "C" fn virtio_pmem_wake_all_waiters(vpmem: *mut virtio_pmem) {
    ...
    vpmem.req_inflight = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn virtio_pmem_wake_inflight(vpmem: *mut virtio_pmem) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_pmem_mark_broken(vpmem: *mut virtio_pmem) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_pmem_drain(vpmem: *mut virtio_pmem) {
    ...
    if (!vpmem.req_vq)
    return;
    while ((req = virtqueue_get_buf(vpmem.req_vq, &len)) != core::ptr::null_mut()) {
    virtio_pmem_clear_inflight(vpmem, req);
    virtio_pmem_complete_err(req);
    kref_put(&req.kref, virtio_pmem_req_release);
    }
    while ((req = virtqueue_detach_unused_buf(vpmem.req_vq)) != core::ptr::null_mut()) {
    virtio_pmem_clear_inflight(vpmem, req);
    virtio_pmem_complete_err(req);
    kref_put(&req.kref, virtio_pmem_req_release);
    }
...
#[no_mangle]
pub unsafe extern "C" fn virtio_pmem_host_ack(vq: *mut virtqueue) {
    ...
    while ((req_data = virtqueue_get_buf(vq, &len)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn virtio_pmem_flush(nd_region: *mut nd_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_pmem_flush_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn async_pmem_flush(nd_region: *mut nd_region, bio: *mut bio) -> c_int {
