...
//! Source: drivers/nvdimm/of_pmem.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct of_pmem_private {
    pub bus_desc: nvdimm_bus_descriptor,
    pub bus: *mut nvdimm_bus,
}

#[no_mangle]
unsafe extern "C" fn of_pmem_region_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_pmem_region_remove(pdev: *mut platform_device) {
