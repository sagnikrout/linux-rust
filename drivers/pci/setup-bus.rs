...
//! Source: drivers/pci/setup-bus.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_dev_resource {
    pub list: list_head,
    pub res: *mut resource,
    pub dev: *mut pci_dev,
    pub start: resource_size_t,
    pub end: resource_size_t,
    pub add_size: resource_size_t,
    pub min_align: resource_size_t,
    pub flags: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn pci_dev_res_free_list(head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn pci_dev_res_restore(dev_res: *mut pci_dev_resource) {
    static void pci_dev_res_restore(struct pci_dev_resource *dev_res)
    {
    struct resource *res = dev_res.res;
    struct pci_dev *dev = dev_res.dev;
    let mut idx: c_int = pci_resource_num(dev, res);
...
//
    ...
    unsigned long type)
    {
    struct resource *r, *r_assigned = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pdev_resources_assignable(dev: *mut pci_dev) -> bool {
    static bool pdev_resources_assignable(struct pci_dev *dev)
    {
    let mut class: u16 = dev.class >> 8, command;
...
#[no_mangle]
unsafe extern "C" fn pdev_resource_assignable(dev: *mut pci_dev, res: *mut resource) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pdev_resource_should_fit(dev: *mut pci_dev, res: *mut resource) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pdev_sort_resources(dev: *mut pci_dev, head: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_resource_is_optional(dev: *const pci_dev, resno: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn reset_resource(dev: *mut pci_dev, res: *mut resource) {
...
#[no_mangle]
unsafe extern "C" fn pci_fail_res_type_mask(fail_head: *mut list_head) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn pci_need_to_release(mask: c_ulong, res: *mut resource) -> bool {
...
// Return: @true if assignment of a required resource failed.
    ...
    list_for_each_entry(fail_res, fail_head, list) {
    let mut idx: c_int = pci_resource_num(fail_res.dev, fail_res.res);
...
// Satisfy the must-have resource requests
    assign_requested_resources_sorted(head, core::ptr::null_mut(), false);
...
//
#[no_mangle]
unsafe extern "C" fn pci_setup_bridge_io(bridge: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_setup_bridge_mmio(bridge: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_setup_bridge_mmio_pref(bridge: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn __pci_setup_bridge(bus: *mut pci_bus, type: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn pci_setup_one_bridge_window(bridge: *mut pci_dev, resno: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_setup_bridge(bus: *mut pci_bus, type: c_ulong) -> void __weak {
    void __weak pcibios_setup_bridge(struct pci_bus *bus, unsigned long type)
    {
    }
#[no_mangle]
unsafe extern "C" fn pci_setup_bridge(bus: *mut pci_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_claim_bridge_resource(bridge: *mut pci_dev, i: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_bridge_check_ranges(bus: *mut pci_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_min_window_alignment(bus: *mut pci_bus, type: c_ulong) -> resource_size_t {
    resource_size_t pci_min_window_alignment(struct pci_bus *bus, unsigned long type)
    {
    let mut align: resource_size_t = 1, arch_align;
    if (type & IORESOURCE_MEM)
    align = PCI_P2P_DEFAULT_MEM_ALIGN;
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_IO: type &) -> else {
//
...
//
    ...
    let mut size: resource_size_t = 0, size0 = 0, size1 = 0;
    let mut children_add_size: resource_size_t = 0;
...
// Might be re-aligned for ISA
    ...
    int max_order)
    {
    let mut align: resource_size_t = 0;
    let mut min_align: resource_size_t = 0;
    int order;
    for (order = 0; order <= max_order; order++) {
    let mut align1: resource_size_t = 1;
    align1 <<= order + __ffs(SZ_1M);
    if (!align)
    min_align = align1;
#[no_mangle]
pub unsafe extern "C" fn if(min_align: ALIGN(align +, align1: min_align) <) -> else {
...
//
    ...
    int max_order)
    {
    let mut head_align: resource_size_t = 1;
    let mut remainder: resource_size_t = 0;
    int order;
...
//
    ...
    let mut optional: bool = pci_resource_is_optional(dev, resno);
    let mut r_size: resource_size_t = resource_size(res);
    struct pci_dev_resource *dev_res = core::ptr::null_mut();
    if (!realloc_head)
    return false;
//
...
//
    ...
    int order, max_order;
    let mut children_add_size: resource_size_t = 0;
    let mut add_align: resource_size_t = 0;
    if (!b_res)
    return;
// If resource is already assigned, nothing more to do
    if (resource_assigned(b_res))
...
#[no_mangle]
pub unsafe extern "C" fn __pci_bus_size_bridges(bus: *mut pci_bus, realloc_head: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_bus_size_bridges(bus: *mut pci_bus) {
    void pci_bus_size_bridges(struct pci_bus *bus)
    {
    __pci_bus_size_bridges(bus, core::ptr::null_mut());
    }
    EXPORT_SYMBOL(pci_bus_size_bridges);
#[no_mangle]
unsafe extern "C" fn assign_fixed_resource_on_bus(b: *mut pci_bus, r: *mut resource) {
...
//
#[no_mangle]
unsafe extern "C" fn pdev_assign_fixed_resources(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_bus_assign_resources(bus: *const pci_bus) {
    void pci_bus_assign_resources(const struct pci_bus *bus)
    {
    __pci_bus_assign_resources(bus, core::ptr::null_mut(), core::ptr::null_mut());
    }
    EXPORT_SYMBOL(pci_bus_assign_resources);
#[no_mangle]
unsafe extern "C" fn pci_claim_device_resources(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_claim_bridge_resources(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_bus_allocate_dev_resources(b: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn pci_bus_allocate_resources(b: *mut pci_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_bus_claim_resources(b: *mut pci_bus) {
...
//
    ...
    {
    struct pci_dev *dev;
    let mut is_leaf_bridge: bool = true;
    list_for_each_entry(dev, &bus.devices, bus_list) {
    struct pci_bus *b = dev.subordinate;
    struct resource *res;
    if (!b)
...
#[no_mangle]
unsafe extern "C" fn pci_bus_dump_res(bus: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn pci_bus_dump_resources(bus: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn pci_bus_get_depth(bus: *mut pci_bus) -> c_int {
...
//
    ...
    let mut pci_realloc_enable: static enum enable_type = undefined;
#[no_mangle]
pub unsafe extern "C" fn pci_realloc_get_opt(str: *mut c_char) -> void __init {
    void __init pci_realloc_get_opt(char *str)
    {
    if (!strncmp(str, "off", 3))
    pci_realloc_enable = user_disabled;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(str, _arg: "on", _arg: 2)) -> else {
    else if (!strncmp(str, "on", 2))
    pci_realloc_enable = user_enabled;
    }
#[no_mangle]
unsafe extern "C" fn pci_realloc_enabled(enable: enum enable_type) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iov_resources_unassigned(dev: *mut pci_dev, data: *mut c_void) -> c_int {
    static int iov_resources_unassigned(struct pci_dev *dev, void *data)
    {
    int i;
    bool *unassigned = data;
    for (i = 0; i < PCI_SRIOV_NUM_BARS; i++) {
    let mut idx: c_int = pci_resource_num_from_vf_bar(i);
...
// unassigned = true;
    ...
    let mut idx: c_int = pci_resource_num(bridge, res);
//
...
//
    ...
    {
    struct resource available[PCI_P2P_BRIDGE_RESOURCE_NUM];
    let mut normal_bridges: c_uint = 0, hotplug_bridges = 0;
...
#[no_mangle]
unsafe extern "C" fn pci_bridge_resources_not_assigned(dev: *mut pci_dev) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_assign_unassigned_root_bus_resources(bus: *mut pci_bus) {
    void pci_assign_unassigned_root_bus_resources(struct pci_bus *bus)
    {
    LIST_HEAD(realloc_head);
// List of resources that want additional resources
    struct list_head *add_list = core::ptr::null_mut();
    let mut tried_times: c_int = 0;
    let mut rel_type: enum release_type = leaf_only;
    LIST_HEAD(fail_head);
    let mut pci_try_num: c_int = 1;
    enum enable_type enable_local;
// Don't realloc if asked to do so
    enable_local = pci_realloc_detect(bus, pci_realloc_enable);
    if (pci_realloc_enabled(enable_local)) {
    let mut max_depth: c_int = pci_bus_get_depth(bus);
...
#[no_mangle]
pub unsafe extern "C" fn pci_assign_unassigned_resources() {
...
#[no_mangle]
pub unsafe extern "C" fn pci_assign_unassigned_bridge_resources(bridge: *mut pci_dev) {
...
//
    ...
    {
    let mut type: c_ulong = res.flags;
    struct pci_dev_resource *dev_res;
...
#[no_mangle]
pub unsafe extern "C" fn pci_assign_unassigned_bus_resources(bus: *mut pci_bus) {
