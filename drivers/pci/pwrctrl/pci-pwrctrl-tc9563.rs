...
//! Source: drivers/pci/pwrctrl/pci-pwrctrl-tc9563.c
#![no_std]
...
pub const TC9563_GPIO_CONFIG: c_uint = 0x801208;
pub const TC9563_RESET_GPIO: c_uint = 0x801210;
pub const TC9563_PORT_L0S_DELAY: c_uint = 0x82496c;
pub const TC9563_PORT_L1_DELAY: c_uint = 0x824970;
pub const TC9563_EMBEDDED_ETH_DELAY: c_uint = 0x8200d8;

pub const TC9563_NFTS_2_5_GT: c_uint = 0x824978;
pub const TC9563_NFTS_5_GT: c_uint = 0x82497c;
pub const TC9563_PORT_LANE_ACCESS_ENABLE: c_uint = 0x828000;
pub const TC9563_PHY_RATE_CHANGE_OVERRIDE: c_uint = 0x828040;
pub const TC9563_PHY_RATE_CHANGE: c_uint = 0x828050;
pub const TC9563_TX_MARGIN: c_uint = 0x828234;
pub const TC9563_DFE_ENABLE: c_uint = 0x828a04;
pub const TC9563_DFE_EQ0_MODE: c_uint = 0x828a08;
pub const TC9563_DFE_EQ1_MODE: c_uint = 0x828a0c;
pub const TC9563_DFE_EQ2_MODE: c_uint = 0x828a14;
pub const TC9563_DFE_PD_MASK: c_uint = 0x828254;
pub const TC9563_PORT_SELECT: c_uint = 0x82c02c;
pub const TC9563_PORT_ACCESS_ENABLE: c_uint = 0x82c030;
pub const TC9563_POWER_CONTROL: c_uint = 0x82b09c;
pub const TC9563_POWER_CONTROL_OVREN: c_uint = 0x82b2c8;
pub const TC9563_GPIO_MASK: c_uint = 0xfffffff3;
pub const TC9563_GPIO_DEASSERT_BITS: c_uint = 0xc  /* Clear to deassert GPIO */;
pub const TC9563_TX_MARGIN_MIN_UA: c_int = 400000;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tc9563_pwrctrl_reg_setting {
    pub offset: c_uint,
    pub val: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tc9563_pwrctrl_cfg {
    pub l0s_delay: u32,
    pub l1_delay: u32,
    pub tx_amp: u32,
    pub /: *mut *mut u8 nfts[2]; / GEN1 & GEN2,
    pub disable_dfe: bool,
    pub disable_port: bool,
}

pub const TC9563_PWRCTL_MAX_SUPPLY: c_int = 6;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tc9563_pwrctrl {
    pub pwrctrl: pci_pwrctrl,
    pub supplies: [regulator_bulk_data; TC9563_PWRCTL_MAX_SUPPLY],
    pub cfg: [tc9563_pwrctrl_cfg; TC9563_MAX],
    pub ep_cfg: tc9563_pwrctrl_cfg,
...
// convert to units of 256ns
    ...
    let mut amp: u32 = tc9563.cfg[port].tx_amp;
    int port_access;
...
#[no_mangle]
unsafe extern "C" fn tc9563_pwrctrl_power_off(pwrctrl: *mut pci_pwrctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc9563_pwrctrl_power_on(pwrctrl: *mut pci_pwrctrl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc9563_pwrctrl_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    of_get_next_available_child(child, core::ptr::null_mut());
    if (eth) {
...
#[no_mangle]
unsafe extern "C" fn tc9563_pwrctrl_remove(pdev: *mut platform_device) {
