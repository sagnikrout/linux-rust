...
#[no_mangle]
pub unsafe extern "C" fn is_dsm(pdev: *mut pci_dev) -> bool {
    static inline bool is_dsm(struct pci_dev *pdev)
    {
    return pdev.tsm && pdev.tsm.dsm_dev == pdev;
    }
#[no_mangle]
pub unsafe extern "C" fn has_tee(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tsm_remove(tsm: *mut pci_tsm) {
...
#[no_mangle]
unsafe extern "C" fn link_sysfs_disable(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn link_sysfs_enable(pdev: *mut pci_dev) {
    static void link_sysfs_enable(struct pci_dev *pdev)
    {
    let mut tee: bool = has_tee(pdev);
...
#[no_mangle]
unsafe extern "C" fn probe_fn(pdev: *mut pci_dev, dsm: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_tsm_connect(pdev: *mut pci_dev, tsm_dev: *mut tsm_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_link_tsm(tsm_dev: *mut tsm_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_devsec_tsm(tsm_dev: *mut tsm_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn remove_fn(pdev: *mut pci_dev, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __pci_tsm_unbind(pdev: *mut pci_dev, data: *mut c_void) -> c_int {
    ...
    pdev.tsm.tdi = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn pci_tsm_unbind(pdev: *mut pci_dev) {
    void pci_tsm_unbind(struct pci_dev *pdev)
    {
    guard(rwsem_read)(&pci_tsm_rwsem);
    __pci_tsm_unbind(pdev, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_tsm_bind(pdev: *mut pci_dev, kvm: *mut kvm, tdi_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_tsm_unbind_all(pdev: *mut pci_dev) {
    static void pci_tsm_unbind_all(struct pci_dev *pdev)
    {
    pci_tsm_walk_fns_reverse(pdev, __pci_tsm_unbind, core::ptr::null_mut());
    __pci_tsm_unbind(pdev, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn __pci_tsm_disconnect(pdev: *mut pci_dev) {
...
//
    guard(mutex)(&tsm_pf0.lock);
    pci_tsm_walk_fns_reverse(pdev, remove_fn, core::ptr::null_mut());
    ops.disconnect(pdev);
    }
#[no_mangle]
unsafe extern "C" fn pci_tsm_disconnect(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_tsm_link_group_visible(kobj: *mut kobject) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_tsm_group_visible(kobj: *mut kobject) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pci_tsm_pf0_destructor(pf0_tsm: *mut pci_tsm_pf0) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_tsm_register(tsm_dev: *mut tsm_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_tsm_fn_exit(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn __pci_tsm_destroy(pdev: *mut pci_dev, tsm_dev: *mut tsm_dev) {
...
// Now lookup the tsm_dev to destroy TSM context
    ...
    tsm_dev = tsm.tsm_dev;
#[no_mangle]
pub unsafe extern "C" fn if(tsm->tsm_dev: tsm_dev !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn pci_tsm_destroy(pdev: *mut pci_dev) {
    void pci_tsm_destroy(struct pci_dev *pdev)
    {
    guard(rwsem_write)(&pci_tsm_rwsem);
    __pci_tsm_destroy(pdev, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn pci_tsm_init(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_tsm_unregister(tsm_dev: *mut tsm_dev) {
