...
pub const TPH_ST_DSM_FUNC_INDEX: c_uint = 0xF;
...
#[no_mangle]
unsafe extern "C" fn set_ctrl_reg_req_en(pdev: *mut pci_dev, req_type: u8) {
...
#[no_mangle]
unsafe extern "C" fn get_st_modes(pdev: *mut pci_dev) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_tph_get_st_table_loc(pdev: *mut pci_dev) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_tph_get_st_table_size(pdev: *mut pci_dev) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn get_rp_completer_type(pdev: *mut pci_dev) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn write_tag_to_st_table(pdev: *mut pci_dev, index: c_int, tag: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_tph_set_st_entry(pdev: *mut pci_dev, index: c_uint, tag: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_disable_tph(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_enable_tph(pdev: *mut pci_dev, mode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_restore_tph_state(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_save_tph_state(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_no_tph() {
...
#[no_mangle]
pub unsafe extern "C" fn pci_tph_init(pdev: *mut pci_dev) {
