...
//! Source: drivers/pci/switch/switchtec.c
#![no_std]
...
//
    ...
    let mut max_devices: static int = 16;
    module_param(max_devices, int, 0644);
    MODULE_PARM_DESC(max_devices, "max number of switchtec device instances");
    let mut use_dma_mrpc: static bool = true;
    module_param(use_dma_mrpc, bool, 0644);
    MODULE_PARM_DESC(use_dma_mrpc,
    "Enable the use of the DMA MRPC feature");
    let mut nirqs: static int = 32;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct switchtec_user {
    pub stdev: *mut switchtec_dev,
    pub state: enum mrpc_state,
    pub cmd_comp: wait_queue_head_t,
    pub kref: kref,
    pub list: list_head,
    pub cmd_done: bool,
    pub cmd: u32,
    ...
    pub data_len: usize,
    pub read_len: usize,
    pub data: [c_uchar; SWITCHTEC_MRPC_PAYLOAD_SIZE],
    pub event_cnt: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn is_firmware_running(stdev: *mut switchtec_dev) -> c_int {
    static int is_firmware_running(struct switchtec_dev *stdev)
    {
    let mut device: u32 = ioread32(&stdev.mmio_sys_info.device_id);
...
#[no_mangle]
unsafe extern "C" fn stuser_free(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn stuser_put(stuser: *mut switchtec_user) {
...
#[no_mangle]
unsafe extern "C" fn flush_wc_buf(stdev: *mut switchtec_dev) {
...
#[no_mangle]
unsafe extern "C" fn mrpc_cmd_submit(stdev: *mut switchtec_dev) {
...
#[no_mangle]
unsafe extern "C" fn mrpc_queue_cmd(stuser: *mut switchtec_user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mrpc_cleanup_cmd(stdev: *mut switchtec_dev) {
...
#[no_mangle]
unsafe extern "C" fn mrpc_complete_cmd(stdev: *mut switchtec_dev) {
    static void mrpc_complete_cmd(struct switchtec_dev *stdev)
    {
// requires the mrpc_mutex to already be held when called
    struct switchtec_user *stuser;
...
#[no_mangle]
unsafe extern "C" fn mrpc_event_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mrpc_error_complete_cmd(stdev: *mut switchtec_dev) {
...
#[no_mangle]
unsafe extern "C" fn mrpc_timeout_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn io_string_show(buf: *mut c_char, attr: *mut void __iomem, len: usize) -> isize {
...
// component_vendor field not supported after gen3
    ...
    {
    struct switchtec_dev *stdev = to_stdev(dev);
    let mut id: c_int = ioread16(&stdev.mmio_sys_info.gen3.component_id);
// component_id field not supported after gen3
    ...
    {
    struct switchtec_dev *stdev = to_stdev(dev);
    let mut rev: c_int = ioread8(&stdev.mmio_sys_info.gen3.component_revision);
...
#[no_mangle]
unsafe extern "C" fn switchtec_dev_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn switchtec_dev_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lock_mutex_and_test_alive(stdev: *mut switchtec_dev) -> c_int {
    ...
    return size;
#[no_mangle]
pub unsafe extern "C" fn if(SWITCHTEC_MRPC_STATUS_INTERRUPTED: stuser->status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn switchtec_dev_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
    ...
    {
    let mut info: switchtec_ioctl_flash_info = {0};
    ...
    {
    int ret;
    let mut info: switchtec_ioctl_flash_part_info = {0};
...
#[no_mangle]
pub unsafe extern "C" fn if(stdev->partition_count: index < 0 || index >=) -> else {
    ...
    nr_idxs = 1;
#[no_mangle]
pub unsafe extern "C" fn if(part_ev_reg: event_regs[ctl.event_id].map_reg ==) -> else {
    else if (event_regs[ctl.event_id].map_reg == part_ev_reg)
    nr_idxs = stdev.partition_count;
#[no_mangle]
pub unsafe extern "C" fn if(pff_ev_reg: event_regs[ctl.event_id].map_reg ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(stdev->partition_count: p.partition <) -> else {
...
#[no_mangle]
unsafe extern "C" fn link_event_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn check_link_state_events(stdev: *mut switchtec_dev) {
    static void check_link_state_events(struct switchtec_dev *stdev)
    {
    int idx;
    u32 reg;
    int count;
    let mut occurred: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn enable_link_state_events(stdev: *mut switchtec_dev) {
...
#[no_mangle]
unsafe extern "C" fn enable_dma_mrpc(stdev: *mut switchtec_dev) {
...
#[no_mangle]
unsafe extern "C" fn stdev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn stdev_kill(stdev: *mut switchtec_dev) {
...
#[no_mangle]
unsafe extern "C" fn mask_event(stdev: *mut switchtec_dev, eid: c_int, idx: c_int) -> c_int {
    static int mask_event(struct switchtec_dev *stdev, int eid, int idx)
    {
    let mut off: usize = event_regs[eid].offset;
    u32 __iomem *hdr_reg;
    u32 hdr;
...
#[no_mangle]
unsafe extern "C" fn mask_all_events(stdev: *mut switchtec_dev, eid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn switchtec_event_isr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn switchtec_dma_mrpc_isr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn switchtec_init_isr(stdev: *mut switchtec_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_pff(stdev: *mut switchtec_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(SWITCHTEC_GEN4: stdev->gen >=) -> else {
    else if (stdev.gen >= SWITCHTEC_GEN4)
    ...
    GFP_KERNEL);
    if (stdev.dma_mrpc == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn switchtec_exit_pci(stdev: *mut switchtec_dev) {
    ...
    stdev.dma_mrpc = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn switchtec_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn switchtec_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn switchtec_exit() -> void __exit {
