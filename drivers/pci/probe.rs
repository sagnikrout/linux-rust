...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_domain_busn_res {
    pub list: list_head,
    pub res: resource,
    pub domain_nr: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn release_pcibus_dev(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn pcibus_class_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pci_size(base: u64, maxbase: u64, mask: u64) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn decode_bar(dev: *mut pci_dev, bar: u32) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn __pci_size_rom(dev: *mut pci_dev, pos: c_uint, sizes: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn pci_read_bridge_windows(bridge: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_read_bridge_bases(child: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn pci_release_host_bridge_dev(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn pci_init_host_bridge(bridge: *mut pci_host_bridge) {
...
#[no_mangle]
unsafe extern "C" fn devm_pci_alloc_host_bridge_release(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_free_host_bridge(bridge: *mut pci_host_bridge) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_get_link_speed(speed: c_uint) -> c_uchar {
...
// Indexed by the pci_bus_speed enum
    ...
    "100 MHz PCI-X",		/* 0x03 */
    "133 MHz PCI-X",		/* 0x04 */
    core::ptr::null_mut(),			/* 0x05 */
    core::ptr::null_mut(),			/* 0x06 */
    core::ptr::null_mut(),			/* 0x07 */
    core::ptr::null_mut(),			/* 0x08 */
...
#[no_mangle]
unsafe extern "C" fn agp_speed(agp3: c_int, agpstat: c_int) -> enum pci_bus_speed {
    ...
    index = 3;
#[no_mangle]
pub unsafe extern "C" fn if(2: agpstat &) -> else {
    else if (agpstat & 2)
    index = 2;
#[no_mangle]
pub unsafe extern "C" fn if(1: agpstat &) -> else {
    else if (agpstat & 1)
    index = 1;
    else
    goto out;
...
#[no_mangle]
unsafe extern "C" fn pci_set_bus_speed(bus: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn pci_set_bus_msi_domain(bus: *mut pci_bus) {
...
//
    for (b = bus, d = core::ptr::null_mut(); !d && !pci_is_root_bus(b); b = b.parent) {
    if (b.self)
...
#[no_mangle]
unsafe extern "C" fn pci_preserve_config(host_bridge: *mut pci_host_bridge) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_register_host_bridge(bridge: *mut pci_host_bridge) -> c_int {
    ...
    let mut bus_registered: bool = false;
    char addr[64], *fmt;
    const char *name;
    int err;
    bus = pci_alloc_bus(core::ptr::null_mut());
    if (!bus)
    return -ENOMEM;
    bridge.bus = bus;
...
#[no_mangle]
unsafe extern "C" fn pci_bridge_child_ext_cfg_accessible(bridge: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_enable_rrs_sv(pdev: *mut pci_dev) {
    static void pci_enable_rrs_sv(struct pci_dev *pdev)
    {
    let mut root_cap: u16 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn pbus_validate_busn(bus: *mut pci_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ea_fixed_busnrs(dev: *mut pci_dev, sec: *mut u8, sub: *mut u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_scan_bridge(bus: *mut pci_bus, dev: *mut pci_dev, max: c_int, pass: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_read_irq(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn set_pcie_port_type(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn set_pcie_hotplug_bridge(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn set_pcie_thunderbolt(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn set_pcie_cxl(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn set_pcie_untrusted(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_set_removable(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_ext_cfg_is_aliased(dev: *mut pci_dev) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pci_cfg_space_size_ext(dev: *mut pci_dev) -> c_int {
    static int pci_cfg_space_size_ext(struct pci_dev *dev)
    {
    u32 status;
    let mut pos: c_int = PCI_CFG_SPACE_SIZE;
...
#[no_mangle]
pub unsafe extern "C" fn pci_cfg_space_size(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_class(dev: *mut pci_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pci_subsystem_ids(dev: *mut pci_dev, vendor: *mut u16, device: *mut u16) {
...
#[no_mangle]
unsafe extern "C" fn pci_hdr_type(dev: *mut pci_dev) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn pci_intx_mask_broken(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn early_dump_pci_device(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_setup_device(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_configure_mps(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_configure_extended_tags(dev: *mut pci_dev, ign: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_dev3_init(pdev: *mut pci_dev) {
    static void pci_dev3_init(struct pci_dev *pdev)
    {
    let mut cap: u16 = pci_find_ext_capability(pdev, PCI_EXT_CAP_ID_DEV3);
    let mut val: u32 = 0;
    if (!cap)
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_relaxed_ordering_enabled(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_configure_relaxed_ordering(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_configure_eetlp_prefix(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_configure_serr(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_configure_rcb(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_configure_device(dev: *mut pci_dev) {
    static void pci_configure_device(struct pci_dev *dev)
    {
    pci_configure_mps(dev);
    pci_configure_extended_tags(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pci_release_capabilities(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_release_dev(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_report_downtraining(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_imm_ready_init(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_init_capabilities(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_set_msi_domain(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_device_add(dev: *mut pci_dev, bus: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn next_ari_fn(bus: *mut pci_bus, dev: *mut pci_dev, fn: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn next_fn(bus: *mut pci_bus, dev: *mut pci_dev, fn: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn only_one_child(bus: *mut pci_bus) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_scan_slot(bus: *mut pci_bus, devfn: c_int) -> c_int {
    int pci_scan_slot(struct pci_bus *bus, int devfn)
    {
    struct pci_dev *dev;
    let mut fn: c_int = 0, nr = 0;
...
#[no_mangle]
unsafe extern "C" fn pcie_find_smpss(dev: *mut pci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcie_write_mps(dev: *mut pci_dev, mps: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcie_write_mrrs(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pcie_bus_configure_set(dev: *mut pci_dev, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_bus_configure_settings(bus: *mut pci_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcibios_fixup_bus(bus: *mut pci_bus) -> void __weak {
...
//
    ...
    let mut start: c_uint = bus.busn_res.start;
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_scan_child_bus(bus: *mut pci_bus) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcibios_root_bridge_prepare(bridge: *mut pci_host_bridge) -> int __weak {
    int __weak pcibios_root_bridge_prepare(struct pci_host_bridge *bridge)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn pcibios_add_bus(bus: *mut pci_bus) -> void __weak {
    void __weak pcibios_add_bus(struct pci_bus *bus)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn pcibios_remove_bus(bus: *mut pci_bus) -> void __weak {
...
#[no_mangle]
pub unsafe extern "C" fn pci_host_probe(bridge: *mut pci_host_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_bus_insert_busn_res(b: *mut pci_bus, bus: c_int, bus_max: c_int) -> c_int {
    ...
    let mut conflict: return = = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn pci_bus_update_busn_res_end(b: *mut pci_bus, bus_max: c_int) -> c_int {
    int pci_bus_update_busn_res_end(struct pci_bus *b, int bus_max)
    {
    struct resource *res = &b.busn_res;
    let mut old_res: resource = *res;
...
#[no_mangle]
pub unsafe extern "C" fn pci_bus_release_busn_res(b: *mut pci_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_scan_root_bus_bridge(bridge: *mut pci_host_bridge) -> c_int {
    ...
    b = pci_create_root_bus(core::ptr::null_mut(), bus, ops, sysdata, &resources);
    if (b) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rescan_bus_bridge_resize(bridge: *mut pci_dev) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rescan_bus(bus: *mut pci_bus) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn pci_lock_rescan_remove() {
...
#[no_mangle]
pub unsafe extern "C" fn pci_unlock_rescan_remove() {
...
#[no_mangle]
pub unsafe extern "C" fn pci_sort_breadthfirst() -> void __init {
    void __init pci_sort_breadthfirst(void)
    {
    bus_sort_breadthfirst(&pci_bus_type, &pci_sort_bf_cmp);
    }
#[no_mangle]
pub unsafe extern "C" fn pci_hp_add_bridge(dev: *mut pci_dev) -> c_int {
    int pci_hp_add_bridge(struct pci_dev *dev)
    {
    struct pci_bus *parent = dev.bus;
    int busnr, start = parent.busn_res.start;
    let mut available_buses: c_uint = 0;
    let mut end: c_int = parent.busn_res.end;
