...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcim_iomap_devres {
    pub table: [*mut void __iomem; PCI_NUM_RESOURCES],
}

// Used to restore the old INTx state on driver detach.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcim_intx_devres {
    pub orig_intx: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcim_addr_devres {
    pub type: enum pcim_addr_devres_type,
...
#[no_mangle]
pub unsafe extern "C" fn pcim_addr_devres_clear(res: *mut pcim_addr_devres) {
...
#[no_mangle]
unsafe extern "C" fn pcim_addr_resource_release(dev: *mut device, resource_raw: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn pcim_addr_devres_free(res: *mut pcim_addr_devres) {
...
#[no_mangle]
unsafe extern "C" fn devm_pci_unmap_iospace(dev: *mut device, ptr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __pcim_clear_mwi(pdev_raw: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_set_mwi(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mask_contains_bar(mask: c_int, bar: c_int) -> bool {
    static inline bool mask_contains_bar(int mask, int bar)
    {
    return mask & BIT(bar);
    }
#[no_mangle]
unsafe extern "C" fn pcim_intx_restore(dev: *mut device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn save_orig_intx(pdev: *mut pci_dev, res: *mut pcim_intx_devres) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_intx(pdev: *mut pci_dev, enable: c_int) -> c_int {
...
// first time.
//
    res = devres_find(dev, pcim_intx_restore, core::ptr::null_mut(), core::ptr::null_mut());
    if (!res) {
...
#[no_mangle]
unsafe extern "C" fn pcim_disable_device(pdev_raw: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_enable_device(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_pin_device(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pcim_iomap_release(gendev: *mut device, res: *mut c_void) {
...
//
    ...
    dr = devres_find(&pdev.dev, pcim_iomap_release, core::ptr::null_mut(), core::ptr::null_mut());
    if (dr)
    return dr.table;
    ...
    if (!new_dr)
    return core::ptr::null_mut();
    dr = devres_get(&pdev.dev, new_dr, core::ptr::null_mut(), core::ptr::null_mut());
    return dr.table;
    }
...
//
    ...
    legacy_iomap_table[bar] = core::ptr::null_mut();
    return;
    }
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn pcim_remove_bar_from_legacy_table(pdev: *mut pci_dev, bar: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_iounmap(pdev: *mut pci_dev, addr: *mut void __iomem) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_iounmap_region(pdev: *mut pci_dev, bar: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_iomap_regions(pdev: *mut pci_dev, mask: c_int, name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_request_region(pdev: *mut pci_dev, bar: c_int, name: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcim_release_region(pdev: *mut pci_dev, bar: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pcim_release_all_regions(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_request_all_regions(pdev: *mut pci_dev, name: *const c_char) -> c_int {
