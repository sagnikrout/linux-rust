...
//! Source: drivers/pci/msi/irqdomain.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pci_msi_setup_msi_irqs(dev: *mut pci_dev, nvec: c_int, type: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_msi_teardown_msi_irqs(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_msi_domain_write_msg(irq_data: *mut irq_data, msg: *mut msi_msg) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_device_domain_set_desc(arg: *mut msi_alloc_info_t, desc: *mut msi_desc) {
...
#[no_mangle]
unsafe extern "C" fn cond_shutdown_parent(data: *mut irq_data) {
...
#[no_mangle]
pub unsafe extern "C" fn if(MSI_FLAG_PCI_MSI_MASK_PARENT): unlikely(info->flags &) -> else {
    else if (unlikely(info.flags & MSI_FLAG_PCI_MSI_MASK_PARENT))
    irq_chip_mask_parent(data);
    }
#[no_mangle]
unsafe extern "C" fn cond_startup_parent(data: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pci_irq_shutdown_msi(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pci_irq_startup_msi(data: *mut irq_data) -> c_uint {
    static unsigned int pci_irq_startup_msi(struct irq_data *data)
    {
    struct msi_desc *desc = irq_data_get_msi_desc(data);
    let mut ret: c_uint = cond_startup_parent(data);
    pci_msi_unmask(desc, BIT(data.irq - desc.irq));
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn pci_irq_mask_msi(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pci_irq_unmask_msi(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pci_irq_shutdown_msix(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pci_irq_startup_msix(data: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pci_irq_mask_msix(data: *mut irq_data) {
    static void pci_irq_mask_msix(struct irq_data *data)
    {
    pci_msix_mask(irq_data_get_msi_desc(data));
    }
#[no_mangle]
unsafe extern "C" fn pci_irq_unmask_msix(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pci_match_device_domain(pdev: *mut pci_dev, bus_token: enum irq_domain_bus_token) -> bool {
    ...
    hwsize, core::ptr::null_mut(), core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_setup_msi_device_domain(pdev: *mut pci_dev, hwsize: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_setup_msix_device_domain(pdev: *mut pci_dev, hwsize: c_uint) -> bool {
...
//
    ...
    let mut mode: return = = ALLOW_LEGACY;
    return false;
    }
...
//
#[no_mangle]
unsafe extern "C" fn get_msi_id_cb(pdev: *mut pci_dev, alias: u16, data: *mut c_void) -> c_int {
    static int get_msi_id_cb(struct pci_dev *pdev, u16 alias, void *data)
    {
    u32 *pa = data;
    let mut bus: u8 = PCI_BUS_NUM(*pa);
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_msi_domain_get_msi_rid(domain: *mut irq_domain, pdev: *mut pci_dev) -> u32 {
...
// Check whether the domain fwnode is an OF node
    ...
    struct device_node *msi_ctlr_node = core::ptr::null_mut();
