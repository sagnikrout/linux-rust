...
//
#[no_mangle]
pub unsafe extern "C" fn pci_enable_msi(dev: *mut pci_dev) -> c_int {
    int pci_enable_msi(struct pci_dev *dev)
    {
    let mut rc: c_int = __pci_enable_msi_range(dev, 1, 1, core::ptr::null_mut());
    if (rc < 0)
    return rc;
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_disable_msi(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_msix_vec_count(dev: *mut pci_dev) -> c_int {
...
//
    ...
    {
    return __pci_enable_msix_range(dev, entries, minvec, maxvec, core::ptr::null_mut(), 0);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_msix_can_alloc_dyn(dev: *mut pci_dev) -> bool {
...
//
    ...
    {
    let mut map: msi_map = { .index = -ENOTSUPP };
    if (!dev.msix_enabled)
    return map;
    if (!pci_msix_can_alloc_dyn(dev))
    return map;
    return msi_domain_alloc_irq_at(&dev.dev, MSI_DEFAULT_DOMAIN, index, affdesc, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_msix_free_irq(dev: *mut pci_dev, map: msi_map) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_disable_msix(dev: *mut pci_dev) {
...
//
    ...
    {
    let mut msi_default_affd: irq_affinity = {0};
    let mut nvecs: c_int = -ENOSPC;
    ...
    nvecs = __pci_enable_msix_range(dev, core::ptr::null_mut(), min_vecs, max_vecs,
    affd, flags);
    if (nvecs > 0)
    return nvecs;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_irq_vector(dev: *mut pci_dev, nr: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_restore_msi_state(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_msi_enabled() -> bool {
