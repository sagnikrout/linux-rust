...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rebar_bytes_to_size(bytes: u64) -> c_int {
    int pci_rebar_bytes_to_size(u64 bytes)
    {
    let mut rebar_minsize: c_int = ilog2(PCI_REBAR_MIN_SIZE);
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rebar_size_to_bytes(size: c_int) -> resource_size_t {
...
#[no_mangle]
pub unsafe extern "C" fn pci_rebar_init(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_rebar_find_pos(pdev: *mut pci_dev, bar: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rebar_get_possible_sizes(pdev: *mut pci_dev, bar: c_int) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rebar_size_supported(pdev: *mut pci_dev, bar: c_int, size: c_int) -> bool {
    bool pci_rebar_size_supported(struct pci_dev *pdev, int bar, int size)
    {
    let mut sizes: u64 = pci_rebar_get_possible_sizes(pdev, bar);
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rebar_get_max_size(pdev: *mut pci_dev, bar: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rebar_get_current_size(pdev: *mut pci_dev, bar: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_rebar_set_size(pdev: *mut pci_dev, bar: c_int, size: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_restore_rebar_state(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_resize_resource_set_size(dev: *mut pci_dev, resno: c_int, size: c_int) {
    void pci_resize_resource_set_size(struct pci_dev *dev, int resno, int size)
    {
    let mut res_size: resource_size_t = pci_rebar_size_to_bytes(size);
