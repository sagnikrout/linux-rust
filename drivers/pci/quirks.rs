...
#[no_mangle]
unsafe extern "C" fn pcie_lbms_seen(dev: *mut pci_dev, lnksta: u16) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_failed_link_retrain(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_fixup_device(pass: enum pci_fixup_pass, dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_apply_final_quirks() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_mmio_always_on(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_passive_release(dev: *mut pci_dev) {
    static void quirk_passive_release(struct pci_dev *dev)
    {
    struct pci_dev *d = core::ptr::null_mut();
    unsigned char dlc;
//
...
//
#[no_mangle]
unsafe extern "C" fn quirk_isa_dma_hangs(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_tigerpoint_bm_sts(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_nopcipci(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_nopciamd(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_triton(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_vialatency(dev: *mut pci_dev) {
...
// a buggy southbridge.
//
    p = pci_get_device(PCI_VENDOR_ID_VIA, PCI_DEVICE_ID_VIA_82C686, core::ptr::null_mut());
...
//
    ...
    p = pci_get_device(PCI_VENDOR_ID_VIA, PCI_DEVICE_ID_VIA_8231, core::ptr::null_mut());
    if (p == core::ptr::null_mut())	/* No problem parts */
    goto exit;
// Check for buggy part revisions
...
#[no_mangle]
unsafe extern "C" fn quirk_viaetbf(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_vsfx(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_alimagik(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_natoma(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_citrine(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_nfp6000(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_extend_bar_to_page(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_s3_64M(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_cs5536_vsa(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_ati_exploding_mce(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_amd_dwc_class(pdev: *mut pci_dev) {
    static void quirk_amd_dwc_class(struct pci_dev *pdev)
    {
    let mut class: u32 = pdev.class;
...
//
#[no_mangle]
unsafe extern "C" fn quirk_synopsys_haps(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_ali7101_acpi(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn piix4_io_quirk(dev: *mut pci_dev, name: *const c_char, port: c_uint, enable: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn piix4_mem_quirk(dev: *mut pci_dev, name: *const c_char, port: c_uint, enable: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_piix4_acpi(dev: *mut pci_dev) {
...
pub const ICH_PMBASE: c_uint = 0x40;
pub const ICH_ACPI_CNTL: c_uint = 0x44;
pub const ICH4_ACPI_EN: c_uint = 0x10;
pub const ICH6_ACPI_EN: c_uint = 0x80;
pub const ICH4_GPIOBASE: c_uint = 0x58;
pub const ICH4_GPIO_CNTL: c_uint = 0x5c;
pub const ICH4_GPIO_EN: c_uint = 0x10;
pub const ICH6_GPIOBASE: c_uint = 0x48;
pub const ICH6_GPIO_CNTL: c_uint = 0x4c;
pub const ICH6_GPIO_EN: c_uint = 0x10;
//
...
//
#[no_mangle]
unsafe extern "C" fn quirk_ich4_lpc_acpi(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ich6_lpc_acpi_gpio(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_ich6_lpc(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_ich7_lpc(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_vt82c586_acpi(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_vt82c686_acpi(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_vt8235_acpi(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_xio2000a(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_via_ioapic(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_via_vt8237_bypass_apic_deassert(dev: *mut pci_dev) {
    static void quirk_via_vt8237_bypass_apic_deassert(struct pci_dev *dev)
    {
    u8 misc_control2;
pub const BYPASS_APIC_DEASSERT: c_int = 8;
...
//
#[no_mangle]
unsafe extern "C" fn quirk_amd_ioapic(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_cavium_sriov_rnm_link(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_amd_8131_mmrbc(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_via_acpi(d: *mut pci_dev) {
...
// VIA bridges which have VLink
    let mut via_vlink_dev_lo: static int = -1, via_vlink_dev_hi = 18;
#[no_mangle]
unsafe extern "C" fn quirk_via_bridge(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_via_vlink(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_vt82c598_id(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_cardbus_legacy(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_amd_ordering(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_dunord(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_transparent_bridge(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_p45_bw_notifications(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_mediagx_master(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_disable_pxb(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_amd_ide_mode(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_svwks_csb5ide(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_ide_samemode(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_no_ata_d3(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_eisa_bridge(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn asus_hides_smbus_hostbridge(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82845G_HB: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82850_HB: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_7205_0: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_E7501_MCH: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82855GM_HB: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82855PM_HB: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82865_HB: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82915GM_HB: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82875_HB: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82810_IG3: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82801DB_2: dev->device ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVICE_ID_INTEL_82815_CGC: dev->device ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn asus_hides_smbus_lpc(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn asus_hides_smbus_lpc_ich6_suspend(dev: *mut pci_dev) {
...
// use bits 31:14, 16 kB aligned
    ...
    if (asus_rcba_base == core::ptr::null_mut())
    return;
    }
#[no_mangle]
unsafe extern "C" fn asus_hides_smbus_lpc_ich6_resume_early(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn asus_hides_smbus_lpc_ich6_resume(dev: *mut pci_dev) {
    static void asus_hides_smbus_lpc_ich6_resume(struct pci_dev *dev)
    {
    if (likely(!asus_hides_smbus || !asus_rcba_base))
    return;
    iounmap(asus_rcba_base);
    asus_rcba_base = core::ptr::null_mut();
    pci_info(dev, "Enabled ICH6/i801 SMBus device\n");
    }
#[no_mangle]
unsafe extern "C" fn asus_hides_smbus_lpc_ich6(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_sis_96x_smbus(dev: *mut pci_dev) {
...
//
pub const SIS_DETECT_REGISTER: c_uint = 0x40;
#[no_mangle]
unsafe extern "C" fn quirk_sis_503(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn asus_hides_ac97_lpc(dev: *mut pci_dev) {
    static void asus_hides_ac97_lpc(struct pci_dev *dev)
    {
    u8 val;
    let mut asus_hides_ac97: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn quirk_jmicron_ata(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_jmicron_async_suspend(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_alder_ioapic(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_no_msi(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_pcie_mch(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_huawei_pcie_sva(pdev: *mut pci_dev) {
...
//
    if (!pdev.dev.of_node &&
    device_create_managed_software_node(&pdev.dev, properties, core::ptr::null_mut()))
...
//
#[no_mangle]
unsafe extern "C" fn quirk_pcie_pxh(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_intel_pcie_pm(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_radeon_pm(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_nvidia_hda_pm(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_ryzen_xhci_d3hot(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn dmi_disable_ioapicreroute(d: *const dmi_system_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_reroute_to_boot_interrupts_intel(dev: *mut pci_dev) {
...
//
pub const INTEL_6300_IOAPIC_ABAR: c_uint = 0x40	/* Bus 0, Dev 29, Func 5 */;

pub const INTEL_CIPINTRC_CFG_OFFSET: c_uint = 0x14C	/* Bus 0, Dev 5, Func 0 */;

#[no_mangle]
unsafe extern "C" fn quirk_disable_intel_boot_interrupt(dev: *mut pci_dev) {
...
pub const BC_HT1000_FEATURE_REG: c_uint = 0x64;

pub const BC_HT1000_MAP_IDX: c_uint = 0xC00;
pub const BC_HT1000_MAP_DATA: c_uint = 0xC01;
#[no_mangle]
unsafe extern "C" fn quirk_disable_broadcom_boot_interrupt(dev: *mut pci_dev) {
...
// (due to an erratum).
//
pub const AMD_813X_MISC: c_uint = 0x40;

pub const AMD_813X_REV_B1: c_uint = 0x12;
pub const AMD_813X_REV_B2: c_uint = 0x13;
#[no_mangle]
unsafe extern "C" fn quirk_disable_amd_813x_boot_interrupt(dev: *mut pci_dev) {
...
pub const AMD_8111_PCI_IRQ_ROUTING: c_uint = 0x56;
#[no_mangle]
unsafe extern "C" fn quirk_disable_amd_8111_boot_interrupt(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_tc86c001_ide(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_plx_pci9050(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_netmos(dev: *mut pci_dev) {
    static void quirk_netmos(struct pci_dev *dev)
    {
    let mut num_parallel: c_uint = (dev.subsystem_device & 0xf0) >> 4;
    let mut num_serial: c_uint = dev.subsystem_device & 0xf;
//
...
#[no_mangle]
unsafe extern "C" fn quirk_e100_interrupt(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_disable_aspm_l0s(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_disable_aspm_l0s_l1(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_enable_clear_retrain_link(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn fixup_rev1_53c810(dev: *mut pci_dev) {
    static void fixup_rev1_53c810(struct pci_dev *dev)
    {
    let mut class: u32 = dev.class;
//
...
#[no_mangle]
unsafe extern "C" fn quirk_p64h2_1k_io(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_nvidia_ck804_pcie_aer_ext_cap(dev: *mut pci_dev) {
    ...
    quirk_nvidia_ck804_pcie_aer_ext_cap);
#[no_mangle]
unsafe extern "C" fn quirk_via_cx700_pci_parking_caching(dev: *mut pci_dev) {
...
// Count VT6212L instances
    ...
    PCI_DEVICE_ID_VIA_8235_USB_2, core::ptr::null_mut());
    uint8_t b;
//
...
#[no_mangle]
unsafe extern "C" fn quirk_brcm_5719_limit_mrrs(dev: *mut pci_dev) {
...
// Only CAP the MRRS if the device is a 5719 A0
    if (rev == 0x05719000) {
    let mut readrq: c_int = pcie_get_readrq(dev);
    if (readrq > 2048)
...
//
#[no_mangle]
unsafe extern "C" fn quirk_unhide_mch_dev6(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_disable_all_msi(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_disable_msi(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_amd_780_apc_msi(host_bridge: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn msi_ht_cap_enabled(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quirk_msi_ht_cap(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_nvidia_ck804_msi_ht_cap(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ht_enable_msi_mapping(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn nvenet_msi_disable(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_quirk_nvidia_tegra_disable_rp_msi(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn nvbridge_check_legacy_irq_routing(dev: *mut pci_dev) {
    ...
    nvbridge_check_legacy_irq_routing);
#[no_mangle]
unsafe extern "C" fn ht_check_msi_mapping(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn host_bridge_with_leaf(host_bridge: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_end_of_ht_chain(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nv_ht_enable_msi_mapping(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ht_disable_msi_mapping(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn __nv_msi_ht_cap_quirk(dev: *mut pci_dev, all: c_int) {
...
//
    ...
    PCI_DEVFN(0, 0));
    if (host_bridge == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn nv_msi_ht_cap_quirk_all(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nv_msi_ht_cap_quirk_leaf(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_msi_intx_disable_bug(dev: *mut pci_dev) {
    static void quirk_msi_intx_disable_bug(struct pci_dev *dev)
    {
    dev.dev_flags |= PCI_DEV_FLAGS_MSI_INTX_DISABLE_BUG;
    }
#[no_mangle]
unsafe extern "C" fn quirk_msi_intx_disable_ati_bug(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_msi_intx_disable_qca_bug(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_al_msi_disable(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_hotplug_bridge(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ricoh_mmc_fixup_rl5c476(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ricoh_mmc_fixup_r5c832(dev: *mut pci_dev) {
...
pub const VTUNCERRMSK_REG: c_uint = 0x1ac;
...
//
#[no_mangle]
unsafe extern "C" fn vtd_mask_spec_errors(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn fixup_ti816x_class(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn fixup_mpss_256(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_intel_mc_errata(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_intel_ntb(dev: *mut pci_dev) {
...
//
pub const I915_DEIER_REG: c_uint = 0x4400c;
#[no_mangle]
unsafe extern "C" fn disable_igfx_irq(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_remove_d3hot_delay(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_broken_intx_masking(dev: *mut pci_dev) {
...
pub const CONNECTX_4_CURR_MAX_MINOR: c_int = 99;
pub const CONNECTX_4_INTX_SUPPORT_MINOR: c_int = 14;
//
...
//
#[no_mangle]
unsafe extern "C" fn mellanox_check_broken_intx_masking(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_no_bus_reset(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_nvidia_no_bus_reset(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_no_pm_reset(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_thunderbolt_hotplug_msi(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_apple_poweroff_thunderbolt(dev: *mut pci_dev) {
...
// magic sequence
    acpi_execute_simple_method(SXIO, core::ptr::null_mut(), 1);
    acpi_execute_simple_method(SXFP, core::ptr::null_mut(), 0);
    msleep(300);
    acpi_execute_simple_method(SXLV, core::ptr::null_mut(), 0);
    acpi_execute_simple_method(SXIO, core::ptr::null_mut(), 0);
    acpi_execute_simple_method(SXLV, core::ptr::null_mut(), 0);
    }
...
//
#[no_mangle]
unsafe extern "C" fn reset_intel_82599_sfp_virtfn(dev: *mut pci_dev, probe: bool) -> c_int {
...
pub const SOUTH_CHICKEN2: c_uint = 0xc2004;
pub const PCH_PP_STATUS: c_uint = 0xc7200;
pub const PCH_PP_CONTROL: c_uint = 0xc7204;
pub const MSG_CTL: c_uint = 0x45010;
pub const NSDE_PWR_STATE: c_uint = 0xd0100;

#[no_mangle]
unsafe extern "C" fn reset_ivb_igd(dev: *mut pci_dev, probe: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_chelsio_generic_dev(dev: *mut pci_dev, probe: bool) -> c_int {
...
pub const PCI_DEVICE_ID_INTEL_82599_SFP_VF: c_uint = 0x10ed;
pub const PCI_DEVICE_ID_INTEL_IVB_M_VGA: c_uint = 0x0156;
pub const PCI_DEVICE_ID_INTEL_IVB_M2_VGA: c_uint = 0x0166;
//
...
//
#[no_mangle]
unsafe extern "C" fn nvme_disable_and_flr(dev: *mut pci_dev, probe: bool) -> c_int {
...
// Disable controller if enabled
    ...
    let mut cap: u32 = readl(bar + NVME_REG_CAP);
    unsigned long timeout;
//
...
// Cap register provides max timeout in 500ms increments
    ...
    for (;;) {
    let mut status: u32 = readl(bar + NVME_REG_CSTS);
...
//
#[no_mangle]
unsafe extern "C" fn delay_250ms_after_flr(dev: *mut pci_dev, probe: bool) -> c_int {
...
pub const PCI_DEVICE_ID_HINIC_VF: c_uint = 0x375E;
pub const HINIC_VF_FLR_TYPE: c_uint = 0x1000;

pub const HINIC_VF_OP: c_uint = 0xE80;

// Device-specific reset method for Huawei Intelligent NIC virtual functions
#[no_mangle]
unsafe extern "C" fn reset_hinic_vf_dev(pdev: *mut pci_dev, probe: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_dev_specific_reset(dev: *mut pci_dev, probe: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quirk_dma_func0_alias(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_dma_func1_alias(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_fixed_dma_alias(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_use_pcie_bridge_dma_alias(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_mic_x200_dma_alias(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_pex_vca_alias(pdev: *mut pci_dev) {
    static void quirk_pex_vca_alias(struct pci_dev *pdev)
    {
    let mut num_pci_slots: c_uint = 0x20;
    unsigned int slot;
...
//
#[no_mangle]
unsafe extern "C" fn quirk_bridge_cavm_thrx2_pcie_root(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_aspeed_pci_bridge_no_alias(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_tw686x_class(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_relaxedordering_disable(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_disable_root_port_attributes(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_chelsio_T5_disable_root_port_attributes(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_acs_ctrl_enabled(acs_ctrl_req: u16, acs_ctrl_ena: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_quirk_amd_sb_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
    static int pci_quirk_amd_sb_acs(struct pci_dev *dev, u16 acs_flags)
    {

    struct acpi_table_header *header = core::ptr::null_mut();
    acpi_status status;
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_cavium_acs_match(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_cavium_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_xgene_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_quirk_zhaoxin_pcie_ports_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_intel_pch_acs_match(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_intel_pch_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_quirk_qcom_rp_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_quirk_nxp_rp_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_al_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_quirk_intel_spt_pch_acs_match(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_intel_spt_pch_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_mf_endpoint_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_rciep_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_brcm_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_loongson_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_quirk_wangxun_nic_acs(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_dev_specific_acs_enabled(dev: *mut pci_dev, acs_flags: u16) -> c_int {
...
pub const INTEL_LPC_RCBA_REG: c_uint = 0xf0;
// 31:14 RCBA address
pub const INTEL_LPC_RCBA_MASK: c_uint = 0xffffc000;
// RCBA Enable

// Backbone Scratch Pad Register
pub const INTEL_BSPR_REG: c_uint = 0x1104;
// Backbone Peer Non-Posted Disable

// Backbone Peer Posted Disable

// Upstream Peer Decode Configuration Register
pub const INTEL_UPDCR_REG: c_uint = 0x1014;
// 5:0 Peer Decode Enable bits
pub const INTEL_UPDCR_REG_MASK: c_uint = 0x3f;
#[no_mangle]
unsafe extern "C" fn pci_quirk_enable_intel_lpc_acs(dev: *mut pci_dev) -> c_int {
...
pub const INTEL_MPC_REG: c_uint = 0xd8;
// MPC: Invalid Receive Bus Number Check Enable

#[no_mangle]
unsafe extern "C" fn pci_quirk_enable_intel_rp_mpc_acs(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_quirk_enable_intel_pch_acs(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_enable_intel_spt_pch_acs(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quirk_disable_intel_spt_pch_acs_redir(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_dev_specific_enable_acs(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_dev_specific_disable_acs_redir(dev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_intel_qat_vf_cap(pdev: *mut pci_dev) {
...
pub const PCI_EXP_SAVE_REGS: c_int = 7;

    let mut size: c_int = PCI_EXP_SAVE_REGS * sizeof(u16);
    pdev.pcie_cap = pos;
...
//
#[no_mangle]
unsafe extern "C" fn quirk_no_flr(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_no_flr_snet(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_no_ext_tags(pdev: *mut pci_dev) {
    ...
    pci_walk_bus(bridge.bus, pci_configure_extended_tags, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn quirk_no_ats(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_amd_harvest_no_ats(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_intel_e2000_no_ats(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_nvidia_gpu_ats_required(pdev: *mut pci_dev) -> bool {
...
// NVIDIA CX10 Family NVlink-C2C
    { PCI_VENDOR_ID_MELLANOX, 0x2101, core::ptr::null_mut() },
    { 0 }
    };
//
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_dev_specific_ats_required(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn quirk_fsl_no_msi(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_gpu_hda(hda: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_gpu_usb(usb: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_gpu_usb_typec_ucsi(ucsi: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_nvidia_hda(gpu: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_disable_broken_acs_cap(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_switchtec_ntb_dma_alias(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_plx_ntb_dma_alias(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_reset_lenovo_thinkpad_p50_nvgpu(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_no_d0_pme(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_no_msi_no_pme(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn apex_pci_fixup_class(pdev: *mut pci_dev) {
...
// forward mode.
//
pub const PI7C9X2Gxxx_MODE_REG: c_uint = 0x74;

#[no_mangle]
unsafe extern "C" fn pci_fixup_pericom_acs_store_forward(pdev: *mut pci_dev) {
...
//
    ...
    pci_fixup_pericom_acs_store_forward);
#[no_mangle]
unsafe extern "C" fn nvidia_ion_ahci_fixup(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn rom_bar_overlap_defect(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn aspm_l1_acceptable_latency(dev: *mut pci_dev) {
    static void aspm_l1_acceptable_latency(struct pci_dev *dev)
    {
    let mut l1_lat: u32 = FIELD_GET(PCI_EXP_DEVCAP_L1, dev.devcap);
    if (l1_lat < 7) {
...
//
#[no_mangle]
unsafe extern "C" fn dpc_log_size(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_fixup_d3cold_delay_1sec(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_mask_replay_timer_timeout(pdev: *mut pci_dev) {
