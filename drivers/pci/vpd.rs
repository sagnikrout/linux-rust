...
pub const PCI_VPD_LRDT_TAG_SIZE: c_int = 3;
pub const PCI_VPD_SRDT_LEN_MASK: c_uint = 0x07;
pub const PCI_VPD_SRDT_TAG_SIZE: c_int = 1;
pub const PCI_VPD_STIN_END: c_uint = 0x0f;
pub const PCI_VPD_INFO_FLD_HDR_SIZE: c_int = 3;
#[no_mangle]
unsafe extern "C" fn pci_vpd_lrdt_size(lrdt: *const u8) -> u16 {
    static u16 pci_vpd_lrdt_size(const u8 *lrdt)
    {
    return get_unaligned_le16(lrdt + 1);
    }
#[no_mangle]
unsafe extern "C" fn pci_vpd_srdt_tag(srdt: *const u8) -> u8 {
    static u8 pci_vpd_srdt_tag(const u8 *srdt)
    {
    return *srdt >> 3;
    }
#[no_mangle]
unsafe extern "C" fn pci_vpd_srdt_size(srdt: *const u8) -> u8 {
    static u8 pci_vpd_srdt_size(const u8 *srdt)
    {
    return *srdt & PCI_VPD_SRDT_LEN_MASK;
    }
#[no_mangle]
unsafe extern "C" fn pci_vpd_info_field_size(info_field: *const u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn pci_vpd_size(dev: *mut pci_dev) -> usize {
    static size_t pci_vpd_size(struct pci_dev *dev)
    {
    let mut off: usize = 0, size;
...
#[no_mangle]
unsafe extern "C" fn pci_vpd_available(dev: *mut pci_dev, check_size: bool) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pci_vpd_wait(dev: *mut pci_dev, set: bool) -> c_int {
    static int pci_vpd_wait(struct pci_dev *dev, bool set)
    {
    struct pci_vpd *vpd = &dev.vpd;
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(125);
    let mut max_sleep: c_ulong = 16;
    u16 status;
    int ret;
    do {
...
#[no_mangle]
pub unsafe extern "C" fn pci_vpd_init(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_vpd_find_tag(buf: *const u8, len: c_uint, rdt: u8, size: *mut c_uint) -> c_int {
...
// look for LRDT tags only, end tag is the only SRDT tag
    ...
    let mut lrdt_len: c_uint = pci_vpd_lrdt_size(buf + i);
    let mut tag: u8 = buf[i];
...
#[no_mangle]
pub unsafe extern "C" fn pci_vpd_find_id_string(buf: *const u8, len: c_uint, size: *mut c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_read_vpd(dev: *mut pci_dev, pos: loff_t, count: usize, buf: *mut c_void) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn pci_read_vpd_any(dev: *mut pci_dev, pos: loff_t, count: usize, buf: *mut c_void) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_write_vpd(dev: *mut pci_dev, pos: loff_t, count: usize, buf: *const c_void) -> isize {
...
// Same, but allow to access any address
#[no_mangle]
pub unsafe extern "C" fn pci_write_vpd_any(dev: *mut pci_dev, pos: loff_t, count: usize, buf: *const c_void) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn pci_vpd_check_csum(buf: *const c_void, len: c_uint) -> c_int {
    ...
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(0: rv_start <) -> else {
    else if (rv_start < 0)
    return rv_start;
    if (!size)
    return -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn quirk_f0_vpd_link(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_blacklist_vpd(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn quirk_chelsio_extend_vpd(dev: *mut pci_dev) {
    static void quirk_chelsio_extend_vpd(struct pci_dev *dev)
    {
    let mut chip: c_int = (dev.device & 0xf000) >> 12;
    let mut func: c_int = (dev.device & 0x0f00) >>  8;
    let mut prod: c_int = (dev.device & 0x00ff) >>  0;
//
...
//
    ...
    dev.vpd.len = 8192;
#[no_mangle]
pub unsafe extern "C" fn if(0x8: chip >= 0x4 && func <) -> else {
