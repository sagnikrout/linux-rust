...
//
#[no_mangle]
pub unsafe extern "C" fn pci_set_of_node(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_release_of_node(dev: *mut pci_dev) {
    void pci_release_of_node(struct pci_dev *dev)
    {
    of_node_put(dev.dev.of_node);
    device_set_node(&dev.dev, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn pci_set_bus_of_node(bus: *mut pci_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_release_bus_of_node(bus: *mut pci_bus) {
    void pci_release_bus_of_node(struct pci_bus *bus)
    {
    of_node_put(bus.dev.of_node);
    device_set_node(&bus.dev, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn pcibios_get_phb_of_node(bus: *mut pci_bus) -> *mut device_node  __weak {
...
#[no_mangle]
pub unsafe extern "C" fn pci_host_of_has_msi_map(dev: *mut device) -> bool {
    bool pci_host_of_has_msi_map(struct device *dev)
    {
    if (dev && dev.of_node)
    return of_get_property(dev.of_node, "msi-map", core::ptr::null_mut());
    return false;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn of_pci_get_devfn(np: *mut device_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_get_pci_domain_nr(node: *mut device_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_pci_preserve_config(node: *mut device_node) -> bool {
    bool of_pci_preserve_config(struct device_node *node)
    {
    let mut val: u32 = 0;
    int ret;
    if (!node) {
    pr_warn("device node is core::ptr::null_mut(), trying with of_chosen\n");
    node = of_chosen;
    }
    retry:
...
//
#[no_mangle]
pub unsafe extern "C" fn of_pci_check_probe_only() {
...
// Read next ranges element
    ...
    range_type = "IO";
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_MEM: (range.flags & IORESOURCE_TYPE_BITS) ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn of_irq_parse_pci(pdev: *const pci_dev, out_irq: *mut of_phandle_args) -> c_int {
    static int of_irq_parse_pci(const struct pci_dev *pdev, struct of_phandle_args *out_irq)
    {
    struct device_node *dn, *ppnode = core::ptr::null_mut();
...
// Ouch, it's a host bridge...
    if (ppdev == core::ptr::null_mut()) {
    ppnode = pci_bus_to_OF_node(pdev.bus);
// No node for host bridge ? give up
    if (ppnode == core::ptr::null_mut()) {
    rc = -EINVAL;
    goto err;
    }
    } else {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_irq_parse_and_map_pci(dev: *const pci_dev, slot: u8, pin: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_configure_wake_irq(pdev: *mut pci_dev, wake: *mut gpio_desc) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_configure_of_wake_gpio(dev: *mut pci_dev) {
...
//
    gpio = fwnode_gpiod_get(of_fwnode_handle(dn), "wake", GPIOD_IN, core::ptr::null_mut());
    if (!IS_ERR(gpio)) {
    dev.wake = gpio;
...
#[no_mangle]
pub unsafe extern "C" fn pci_remove_of_wake_gpio(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn devm_of_pci_bridge_init(dev: *mut device, bridge: *mut pci_host_bridge) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn of_pci_remove_node(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn of_pci_make_dev_node(pdev: *mut pci_dev) {
    void of_pci_make_dev_node(struct pci_dev *pdev)
    {
    struct device_node *ppnode, *np = core::ptr::null_mut();
    const char *pci_type;
...
#[no_mangle]
pub unsafe extern "C" fn of_pci_remove_host_bridge_node(bridge: *mut pci_host_bridge) {
...
#[no_mangle]
pub unsafe extern "C" fn of_pci_make_host_bridge_node(bridge: *mut pci_host_bridge) {
...
// Check if there is a DT root node to attach the created node
    if (!of_root) {
    pr_debug("of_root node is core::ptr::null_mut(), cannot create PCI host bridge node\n");
    return;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn of_pci_supply_present(np: *mut device_node) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_pci_get_max_link_speed(node: *mut device_node) -> c_int {
