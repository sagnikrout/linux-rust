...
//! Source: drivers/pci/hotplug/shpchp_ctrl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn queue_interrupt_event(p_slot: *mut slot, event_type: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn shpchp_handle_attention_button(hp_slot: u8, ctrl: *mut controller) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn shpchp_handle_switch_change(hp_slot: u8, ctrl: *mut controller) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn shpchp_handle_presence_change(hp_slot: u8, ctrl: *mut controller) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn shpchp_handle_power_fault(hp_slot: u8, ctrl: *mut controller) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn board_added(p_slot: *mut slot) -> c_int {
    static int board_added(struct slot *p_slot)
    {
    u8 hp_slot;
    let mut slots_not_empty: u8 = 0;
    let mut rc: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn remove_board(p_slot: *mut slot) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pushbutton_work_info {
    pub p_slot: *mut slot,
...
//
#[no_mangle]
unsafe extern "C" fn shpchp_pushbutton_thread(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn shpchp_queue_pushbutton_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn update_slot_info(slot: *mut slot) {
...
//
#[no_mangle]
unsafe extern "C" fn handle_button_press_event(p_slot: *mut slot) {
...
#[no_mangle]
unsafe extern "C" fn interrupt_event_handler(work: *mut work_struct) {
    static void interrupt_event_handler(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn shpchp_enable_slot(p_slot: *mut slot) -> c_int {
    static int shpchp_enable_slot (struct slot *p_slot)
    {
    let mut getstatus: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn shpchp_disable_slot(p_slot: *mut slot) -> c_int {
    static int shpchp_disable_slot (struct slot *p_slot)
    {
    let mut getstatus: u8 = 0;
    int rc, retval = -ENODEV;
...
#[no_mangle]
pub unsafe extern "C" fn shpchp_sysfs_enable_slot(p_slot: *mut slot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn shpchp_sysfs_disable_slot(p_slot: *mut slot) -> c_int {
