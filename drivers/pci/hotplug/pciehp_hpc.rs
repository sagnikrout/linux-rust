...
//! Source: drivers/pci/hotplug/pciehp_hpc.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_request_irq(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_free_irq(ctrl: *mut controller) {
...
#[no_mangle]
unsafe extern "C" fn pcie_poll_cmd(ctrl: *mut controller, timeout: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcie_wait_cmd(ctrl: *mut controller) {
    static void pcie_wait_cmd(struct controller *ctrl)
    {
    let mut msecs: c_uint = pciehp_poll_mode ? 2500 : 1000;
    let mut duration: c_ulong = msecs_to_jiffies(msecs);
    let mut cmd_timeout: c_ulong = ctrl.cmd_started + duration;
...
//
#[no_mangle]
unsafe extern "C" fn pcie_write_cmd(ctrl: *mut controller, cmd: u16, mask: u16) {
...
#[no_mangle]
unsafe extern "C" fn pcie_write_cmd_nowait(ctrl: *mut controller, cmd: u16, mask: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_check_link_active(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_bus_check_dev(bus: *mut pci_bus, devfn: c_int) -> bool {
    static bool pci_bus_check_dev(struct pci_bus *bus, int devfn)
    {
    u32 l;
    let mut count: c_int = 0;
    let mut delay: c_int = 1000, step = 20;
...
#[no_mangle]
unsafe extern "C" fn pcie_wait_for_presence(pdev: *mut pci_dev) {
    static void pcie_wait_for_presence(struct pci_dev *pdev)
    {
    let mut timeout: c_int = 1250;
    u16 slot_status;
    do {
    pcie_capability_read_word(pdev, PCI_EXP_SLTSTA, &slot_status);
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_check_link_status(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pciehp_link_set(ctrl: *mut controller, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pciehp_link_enable(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_get_attention_status(hotplug_slot: *mut hotplug_slot, status: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_get_power_status(ctrl: *mut controller, status: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_get_latch_status(ctrl: *mut controller, status: *mut u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_card_present(ctrl: *mut controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_card_present_or_link_active(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_query_power_fault(ctrl: *mut controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_set_indicators(ctrl: *mut controller, pwr: c_int, attn: c_int) {
    void pciehp_set_indicators(struct controller *ctrl, int pwr, int attn)
    {
    let mut cmd: u16 = 0, mask = 0;
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_power_on_slot(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_power_off_slot(ctrl: *mut controller) {
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_device_replaced(ctrl: *mut controller) -> bool {
    bool pciehp_device_replaced(struct controller *ctrl)
    {
    struct pci_dev *pdev __free(pci_dev_put) = core::ptr::null_mut();
    u32 reg;
...
#[no_mangle]
unsafe extern "C" fn pciehp_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t pciehp_isr(int irq, void *dev_id)
    {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_EXP_SLTSTA_PFD: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn pciehp_ist(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t pciehp_ist(int irq, void *dev_id)
    {
    struct controller *ctrl = (struct controller *)dev_id;
    struct pci_dev *pdev = ctrl_dev(ctrl);
...
//
    ...
    ctrl.state == ON_STATE) {
    let mut ignored_events: u16 = PCI_EXP_SLTSTA_DLLSC;
    if (!ctrl.inband_presence_disabled)
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_EXP_SLTSTA_DLLSC): events & (PCI_EXP_SLTSTA_PDC |) -> else {
...
#[no_mangle]
unsafe extern "C" fn pciehp_poll(data: *mut c_void) -> c_int {
    static int pciehp_poll(void *data)
    {
...
#[no_mangle]
unsafe extern "C" fn pcie_enable_notification(ctrl: *mut controller) {
...
#[no_mangle]
unsafe extern "C" fn pcie_disable_notification(ctrl: *mut controller) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_clear_hotplug_events(ctrl: *mut controller) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_enable_interrupt(ctrl: *mut controller) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_disable_interrupt(ctrl: *mut controller) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_slot_reset(dev: *mut pcie_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_reset_slot(hotplug_slot: *mut hotplug_slot, probe: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_init_notification(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_shutdown_notification(ctrl: *mut controller) {
...
#[no_mangle]
pub unsafe extern "C" fn dbg_ctrl(ctrl: *mut controller) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_hotplug_depth(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pciehp_release_ctrl(ctrl: *mut controller) {
...
#[no_mangle]
unsafe extern "C" fn quirk_cmd_compl(pdev: *mut pci_dev) {
