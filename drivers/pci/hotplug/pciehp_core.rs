...
//! Source: drivers/pci/hotplug/pciehp_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_slot(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_slot(ctrl: *mut controller) {
...
//
#[no_mangle]
unsafe extern "C" fn pciehp_check_presence(ctrl: *mut controller) {
...
#[no_mangle]
unsafe extern "C" fn pciehp_probe(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pciehp_remove(dev: *mut pcie_device) {
...
#[no_mangle]
unsafe extern "C" fn pme_is_native(dev: *mut pcie_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pciehp_disable_interrupt(dev: *mut pcie_device) {
...
#[no_mangle]
unsafe extern "C" fn pciehp_suspend(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pciehp_resume_noirq(dev: *mut pcie_device) -> c_int {
...
//
    ...
    pci_dev_set_disconnected, core::ptr::null_mut());
    pciehp_request(ctrl, PCI_EXP_SLTSTA_PDC);
    }
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn pciehp_resume(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pciehp_runtime_suspend(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pciehp_runtime_resume(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_hp_init() -> int __init {
