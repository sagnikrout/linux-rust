...
//! Source: drivers/pci/hotplug/cpqphp_core.c
#![no_std]
...
// Global variables
    ...
    struct controller *cpqhp_ctrl_list;	/* = core::ptr::null_mut() */
...
pub const CPQHPC_MODULE_MINOR: c_int = 208;
#[no_mangle]
pub unsafe extern "C" fn is_slot64bit(slot: *mut slot) -> c_int {
    static inline int is_slot64bit(struct slot *slot)
    {
    return (readb(slot.p_sm_slot + SMBIOS_SLOT_WIDTH) == 0x06) ? 1 : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn is_slot66mhz(slot: *mut slot) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_SERR(ctrl: *mut controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_cpqhp_routing_table() -> c_int {
    static int init_cpqhp_routing_table(void)
    {
    int len;
    cpqhp_routing_table = pcibios_get_irq_routing_table();
    if (cpqhp_routing_table == core::ptr::null_mut())
    return -ENOMEM;
    len = cpqhp_routing_table_length();
    if (len == 0) {
    kfree(cpqhp_routing_table);
    cpqhp_routing_table = core::ptr::null_mut();
    return -1;
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn pci_print_IRQ_route() {
...
#[no_mangle]
unsafe extern "C" fn ctrl_slot_cleanup(ctrl: *mut controller) -> c_int {
    static int ctrl_slot_cleanup(struct controller *ctrl)
    {
    struct slot *old_slot, *next_slot;
    old_slot = ctrl.slot;
    ctrl.slot = core::ptr::null_mut();
    while (old_slot) {
...
#[no_mangle]
unsafe extern "C" fn process_SI(hotplug_slot: *mut hotplug_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_SS(hotplug_slot: *mut hotplug_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hardware_test(hotplug_slot: *mut hotplug_slot, value: u32) -> c_int {
...
pub const SLOT_NAME_SIZE: c_int = 10;
    ...
    void __iomem *slot_entry = core::ptr::null_mut();
    int result;
    dbg("%s\n", __func__);
...
#[no_mangle]
unsafe extern "C" fn one_time_init() -> c_int {
    ...
    cpqhp_slot_list[loop] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cpqhpc_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int cpqhpc_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    let mut num_of_slots: u8 = 0;
    let mut hp_slot: u8 = 0;
    u8 device;
    u8 bus_cap;
    u16 temp_word;
    u16 vendor_id;
...
#[no_mangle]
unsafe extern "C" fn unload_cpqphpd() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn cpqhpc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cpqhpc_cleanup() -> void __exit {
