...
//! Source: drivers/pci/hotplug/ibmphp_pci.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn assign_alt_irq(cur_func: *mut pci_func, class_code: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibmphp_configure_card(func: *mut pci_func, slotno: u8) -> c_int {
...
// For every function on the card
    ...
    let mut devfn: c_uint = PCI_DEVFN(device, function);
...
// We need to do this in case some other BARs were properly inserted
    ...
    cur_func.next = core::ptr::null_mut();
    function = 0x8;
    break;
...
// We need to do this in case some other BARs were properly inserted
    ...
    cur_func.io[i] = core::ptr::null_mut();
    } else if (cur_func.pfmem[i]) {
    ibmphp_remove_resource(cur_func.pfmem[i]);
    cur_func.pfmem[i] = core::ptr::null_mut();
    } else if (cur_func.mem[i]) {
    ibmphp_remove_resource(cur_func.mem[i]);
    cur_func.mem[i] = core::ptr::null_mut();
    }
    }
    return rc;
    }
...
//
#[no_mangle]
unsafe extern "C" fn configure_device(func: *mut pci_func) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn configure_bridge(func_passed: *mut pci_func, slotno: u8) -> c_int {
    ...
    u32 bar[2];
    u32 len[2];
    let mut flag_io: u8 = 0;
    let mut flag_mem: u8 = 0;
    let mut flag_pfmem: u8 = 0;
    let mut need_io_upper: u8 = 0;
    let mut need_pfmem_upper: u8 = 0;
    struct res_needed *amount_needed = core::ptr::null_mut();
    struct resource_node *io = core::ptr::null_mut();
    struct resource_node *bus_io[2] = {core::ptr::null_mut(), core::ptr::null_mut()};
    struct resource_node *mem = core::ptr::null_mut();
    struct resource_node *bus_mem[2] = {core::ptr::null_mut(), core::ptr::null_mut()};
    struct resource_node *mem_tmp = core::ptr::null_mut();
    struct resource_node *pfmem = core::ptr::null_mut();
    struct resource_node *bus_pfmem[2] = {core::ptr::null_mut(), core::ptr::null_mut()};
    struct bus_node *bus;
    static const u32 address[] = {
    PCI_BASE_ADDRESS_0,
    PCI_BASE_ADDRESS_1,
...
// Now need to see how much space the devices behind the bridge needed
    ...
    if (amount_needed == core::ptr::null_mut())
    return -ENOMEM;
    ibmphp_pci_bus.number = func.busno;
...
//
    ...
    func.io[i] = core::ptr::null_mut();
    } else if (bus_pfmem[i]) {
    ibmphp_remove_resource(bus_pfmem[i]);
    func.pfmem[i] = core::ptr::null_mut();
    } else if (bus_mem[i]) {
    ibmphp_remove_resource(bus_mem[i]);
    func.mem[i] = core::ptr::null_mut();
    }
    }
    return retval;
    }
...
//
#[no_mangle]
unsafe extern "C" fn unconfigure_boot_device(busno: u8, device: u8, function: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unconfigure_boot_bridge(busno: u8, device: u8, function: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unconfigure_boot_card(slot_cur: *mut slot) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibmphp_unconfigure_card(slot_cur: *mut slot, the_end: c_int) -> c_int {
    ...
    struct pci_func *cur_func = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn add_new_bus(bus: *mut bus_node, io: *mut resource_node, mem: *mut resource_node, pfmem: *mut resource_node, parent_busno: u8) -> c_int {
    static int add_new_bus(struct bus_node *bus, struct resource_node *io, struct resource_node *mem, struct resource_node *pfmem, u8 parent_busno)
    {
    struct range_node *io_range = core::ptr::null_mut();
    struct range_node *mem_range = core::ptr::null_mut();
    struct range_node *pfmem_range = core::ptr::null_mut();
    struct bus_node *cur_bus = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn find_sec_number(primary_busno: u8, slotno: u8) -> u8 {
    static u8 find_sec_number(u8 primary_busno, u8 slotno)
    {
    int min, max;
    u8 busno;
