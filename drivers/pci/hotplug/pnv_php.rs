...
//! Source: drivers/pci/hotplug/pnv_php.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pnv_php_event {
    pub added: bool,
    pub php_slot: *mut pnv_php_slot,
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pdev->msi_enabled) -> else {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_free_slot(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn pnv_php_put_slot(php_slot: *mut pnv_php_slot) {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_php_rmv_pdns(dn: *mut device_node) {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_php_detach_device_nodes(parent: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_rmv_devtree(php_slot: *mut pnv_php_slot) {
...
//
    ...
    kfree(php_slot.dt);
    kfree(php_slot.fdt);
    php_slot.dt        = core::ptr::null_mut();
    php_slot.dn.child = core::ptr::null_mut();
    php_slot.fdt       = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn pnv_php_reverse_nodes(parent: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_add_pdns(slot: *mut pnv_php_slot) {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_add_devtree(php_slot: *mut pnv_php_slot) -> c_int {
...
// Unflatten device tree blob
    dt = of_fdt_unflatten_tree(fdt, php_slot.dn, core::ptr::null_mut());
    if (!dt) {
    ret = -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn pnv_php_get_power_state(slot: *mut hotplug_slot, state: *mut u8) -> c_int {
    static int pnv_php_get_power_state(struct hotplug_slot *slot, u8 *state)
    {
    struct pnv_php_slot *php_slot = to_pnv_php_slot(slot);
    let mut power_state: u8 = OPAL_PCI_SLOT_POWER_ON;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn pcie_check_link_active(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_get_adapter_state(slot: *mut hotplug_slot, state: *mut u8) -> c_int {
    static int pnv_php_get_adapter_state(struct hotplug_slot *slot, u8 *state)
    {
    struct pnv_php_slot *php_slot = to_pnv_php_slot(slot);
    let mut presence: u8 = OPAL_PCI_SLOT_EMPTY;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn pnv_php_get_raw_indicator_status(slot: *mut hotplug_slot, state: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_get_attention_state(slot: *mut hotplug_slot, state: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_set_attention_state(slot: *mut hotplug_slot, state: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_enable(php_slot: *mut pnv_php_slot, rescan: bool) -> c_int {
    static int pnv_php_enable(struct pnv_php_slot *php_slot, bool rescan)
    {
    struct hotplug_slot *slot = &php_slot.slot;
    let mut presence: u8 = OPAL_PCI_SLOT_EMPTY;
    let mut power_status: u8 = OPAL_PCI_SLOT_POWER_ON;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn pnv_php_reset_slot(slot: *mut hotplug_slot, probe: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_enable_slot(slot: *mut hotplug_slot) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_php_disable_all_irqs(bus: *mut pci_bus) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pnv_php_disable_all_downstream_irqs(bus: *mut pci_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_disable_slot(slot: *mut hotplug_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_release(php_slot: *mut pnv_php_slot) {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_register_slot(php_slot: *mut pnv_php_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_enable_msix(php_slot: *mut pnv_php_slot) -> c_int {
...
//
    ...
    pe = edev ? edev.pe : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pnv_php_event_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// Freeze the removed PE to avoid unexpected error reporting
    ...
    edev = pchild ? pci_dev_to_eeh_dev(pchild) : core::ptr::null_mut();
    pe = edev ? edev.pe : core::ptr::null_mut();
    if (pe) {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_init_irq(php_slot: *mut pnv_php_slot, irq: c_int) {
    static void pnv_php_init_irq(struct pnv_php_slot *php_slot, int irq)
    {
    struct pci_dev *pdev = php_slot.pdev;
    let mut broken_pdc: u32 = 0;
    u16 sts, ctrl;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn pnv_php_enable_irq(php_slot: *mut pnv_php_slot) {
    static void pnv_php_enable_irq(struct pnv_php_slot *php_slot)
    {
    struct pci_dev *pdev = php_slot.pdev;
    int irq, ret;
...
#[no_mangle]
unsafe extern "C" fn pnv_php_register_one(dn: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pnv_php_register(dn: *mut device_node) {
    static void pnv_php_register(struct device_node *dn)
    {
    struct device_node *child;
//
...
#[no_mangle]
unsafe extern "C" fn pnv_php_unregister_one(dn: *mut device_node) {
    static void pnv_php_unregister_one(struct device_node *dn)
    {
    struct pnv_php_slot *php_slot;
...
#[no_mangle]
unsafe extern "C" fn pnv_php_unregister(dn: *mut device_node) {
    static void pnv_php_unregister(struct device_node *dn)
    {
    struct device_node *child;
...
#[no_mangle]
unsafe extern "C" fn pnv_php_init() -> int __init {
    static int __init pnv_php_init(void)
    {
    struct device_node *dn;
    pr_info(DRIVER_DESC " version: " DRIVER_VERSION "\n");
    for_each_compatible_node(dn, core::ptr::null_mut(), "ibm,ioda2-phb")
    pnv_php_register(dn);
    for_each_compatible_node(dn, core::ptr::null_mut(), "ibm,ioda3-phb")
    pnv_php_register(dn);
    for_each_compatible_node(dn, core::ptr::null_mut(), "ibm,ioda2-npu2-opencapi-phb")
    pnv_php_register_one(dn); /* slot directly under the PHB */
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pnv_php_exit() -> void __exit {
