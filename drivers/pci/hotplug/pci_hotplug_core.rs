...
//! Source: drivers/pci/hotplug/pci_hotplug_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn power_read_file(pci_slot: *mut pci_slot, buf: *mut c_char) -> isize {
    ...
    lpower = simple_strtoul(buf, core::ptr::null_mut(), 10);
...
#[no_mangle]
unsafe extern "C" fn attention_read_file(pci_slot: *mut pci_slot, buf: *mut c_char) -> isize {
    ...
    u8 attention;
    let mut retval: c_int = 0;
    lattention = simple_strtoul(buf, core::ptr::null_mut(), 10);
...
#[no_mangle]
unsafe extern "C" fn latch_read_file(pci_slot: *mut pci_slot, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn presence_read_file(pci_slot: *mut pci_slot, buf: *mut c_char) -> isize {
    ...
    u32 test;
    let mut retval: c_int = 0;
    ltest = simple_strtoul(buf, core::ptr::null_mut(), 10);
...
#[no_mangle]
unsafe extern "C" fn has_power_file(slot: *mut hotplug_slot) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_attention_file(slot: *mut hotplug_slot) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_latch_file(slot: *mut hotplug_slot) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_adapter_file(slot: *mut hotplug_slot) -> bool {
...
#[no_mangle]
unsafe extern "C" fn has_test_file(slot: *mut hotplug_slot) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fs_add_slot(slot: *mut hotplug_slot, pci_slot: *mut pci_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs_remove_slot(slot: *mut hotplug_slot, pci_slot: *mut pci_slot) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_hp_add(slot: *mut hotplug_slot) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_hp_deregister(slot: *mut hotplug_slot) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_hp_del(slot: *mut hotplug_slot) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_hp_destroy(slot: *mut hotplug_slot) {
    void pci_hp_destroy(struct hotplug_slot *slot)
    {
    struct pci_slot *pci_slot = slot.pci_slot;
    slot.pci_slot = core::ptr::null_mut();
    pci_slot.hotplug = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_hp_ignore_link_change(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_hp_unignore_link_change(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_hp_spurious_link_change(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_hotplug_init() -> int __init {
