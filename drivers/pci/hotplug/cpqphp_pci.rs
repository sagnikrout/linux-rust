...
//! Source: drivers/pci/hotplug/cpqphp_pci.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cpqhp_configure_device(ctrl: *mut controller, func: *mut pci_func) -> c_int {
    int cpqhp_configure_device(struct controller *ctrl, struct pci_func *func)
    {
    struct pci_bus *child;
    int num;
    pci_lock_rescan_remove();
    if (func.pci_dev == core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn cpqhp_unconfigure_device(func: *mut pci_func) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_set_irq(bus_num: u8, dev_num: u8, int_pin: u8, irq_num: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn PCI_ScanBusForNonBridge(ctrl: *mut controller, bus_num: u8, dev_num: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn PCI_GetBusDevHelper(ctrl: *mut controller, bus_num: *mut u8, dev_num: *mut u8, slot: u8, nobridge: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpqhp_get_bus_dev(ctrl: *mut controller, bus_num: *mut u8, dev_num: *mut u8, slot: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_save_config(ctrl: *mut controller, busnumber: c_int, is_hot_plug: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_save_slot_config(ctrl: *mut controller, new_slot: *mut pci_func) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_save_base_addr_length(ctrl: *mut controller, func: *mut pci_func) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_save_used_resources(ctrl: *mut controller, func: *mut pci_func) -> c_int {
    ...
    unsigned int devfn;
    func = cpqhp_slot_find(func.bus, func.device, index++);
    while ((func != core::ptr::null_mut()) && func.is_a_board) {
    pci_bus.number = func.bus;
    devfn = PCI_DEVFN(func.device, func.function);
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_configure_board(ctrl: *mut controller, func: *mut pci_func) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_valid_replace(ctrl: *mut controller, func: *mut pci_func) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCI_HEADER_TYPE_NORMAL: (header_type & PCI_HEADER_TYPE_MASK) ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_find_available_resources(ctrl: *mut controller, rom_start: *mut void __iomem) -> c_int {
    ...
    struct pci_func *func = core::ptr::null_mut();
    let mut i: c_int = 10, index;
    u32 temp_dword, rc;
    struct pci_resource *mem_node;
    struct pci_resource *p_mem_node;
    struct pci_resource *io_node;
    ...
    if (rom_resource_table == core::ptr::null_mut())
    return -ENODEV;
// Sum all resources and setup resource maps
    ...
    let mut dev_func: u8 = readb(one_slot + DEV_FUNC);
    let mut primary_bus: u8 = readb(one_slot + PRIMARY_BUS);
    let mut secondary_bus: u8 = readb(one_slot + SECONDARY_BUS);
    let mut max_bus: u8 = readb(one_slot + MAX_BUS);
    let mut io_base: u16 = readw(one_slot + IO_BASE);
    let mut io_length: u16 = readw(one_slot + IO_LENGTH);
    let mut mem_base: u16 = readw(one_slot + MEM_BASE);
    let mut mem_length: u16 = readw(one_slot + MEM_LENGTH);
    let mut pre_mem_base: u16 = readw(one_slot + PRE_MEM_BASE);
    let mut pre_mem_length: u16 = readw(one_slot + PRE_MEM_LENGTH);
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_return_board_resources(func: *mut pci_func, resources: *mut resource_lists) -> c_int {
    ...
    return 1;
    node = func.io_head;
    func.io_head = core::ptr::null_mut();
    while (node) {
    t_node = node.next;
    ...
    node = func.mem_head;
    func.mem_head = core::ptr::null_mut();
    while (node) {
    t_node = node.next;
    ...
    func.p_mem_head = core::ptr::null_mut();
    while (node) {
    t_node = node.next;
    ...
    node = func.bus_head;
    func.bus_head = core::ptr::null_mut();
    while (node) {
    t_node = node.next;
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_destroy_resource_list(resources: *mut resource_lists) {
    void cpqhp_destroy_resource_list(struct resource_lists *resources)
    {
    struct pci_resource *res, *tres;
    res = resources.io_head;
    resources.io_head = core::ptr::null_mut();
    while (res) {
    tres = res;
    res = res.next;
    kfree(tres);
    ...
    resources.mem_head = core::ptr::null_mut();
    while (res) {
    tres = res;
    res = res.next;
    kfree(tres);
    ...
    resources.p_mem_head = core::ptr::null_mut();
    while (res) {
    tres = res;
    res = res.next;
    kfree(tres);
    ...
    resources.bus_head = core::ptr::null_mut();
    while (res) {
    tres = res;
    res = res.next;
    kfree(tres);
...
//
#[no_mangle]
pub unsafe extern "C" fn cpqhp_destroy_board_resources(func: *mut pci_func) {
