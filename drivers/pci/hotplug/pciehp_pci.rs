...
//! Source: drivers/pci/hotplug/pciehp_pci.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_configure_device(ctrl: *mut controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_unconfigure_device(ctrl: *mut controller, presence: bool) {
    ...
    if (!presence)
    pci_walk_bus(parent, pci_dev_set_disconnected, core::ptr::null_mut());
    pci_lock_rescan_remove();
//
