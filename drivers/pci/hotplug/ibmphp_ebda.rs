...
//! Source: drivers/pci/hotplug/ibmphp_ebda.c
#![no_std]
...
// Local variables
    ...
    static struct rio_table_hdr *rio_table_ptr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn alloc_ebda_hpc_list() -> *mut ebda_hpc_list  __init {
...
#[no_mangle]
unsafe extern "C" fn free_ebda_hpc(controller: *mut controller) {
...
#[no_mangle]
unsafe extern "C" fn alloc_ebda_rsrc_list() -> *mut ebda_rsrc_list  __init {
...
#[no_mangle]
unsafe extern "C" fn print_bus_info() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn print_lo_info() {
...
#[no_mangle]
unsafe extern "C" fn print_vg_info() {
...
#[no_mangle]
unsafe extern "C" fn print_ebda_pci_rsrc() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn print_ibm_slot() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn print_opt_vg() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn print_ebda_hpc() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn ibmphp_access_ebda() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn ebda_rio_table() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(7: rio_detail_ptr->rio_type == 6 || rio_detail_ptr->rio_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn combine_wpg_for_chassis() -> int __init {
    static int __init combine_wpg_for_chassis(void)
    {
    struct opt_rio *opt_rio_ptr = core::ptr::null_mut();
    struct rio_detail *rio_detail_ptr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn combine_wpg_for_expansion() -> c_int {
    static int combine_wpg_for_expansion(void)
    {
    struct opt_rio_lo *opt_rio_lo_ptr = core::ptr::null_mut();
    struct rio_detail *rio_detail_ptr = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn first_slot_num(slot_num: u8, first_slot: u8, var: u8) -> c_int {
    static int first_slot_num(u8 slot_num, u8 first_slot, u8 var)
    {
    struct opt_rio *opt_vg_ptr = core::ptr::null_mut();
    struct opt_rio_lo *opt_lo_ptr = core::ptr::null_mut();
    let mut rc: c_int = 0;
    if (!var) {
...
//
#[no_mangle]
unsafe extern "C" fn calculate_first_slot(slot_num: u8) -> u8 {
    static u8 calculate_first_slot(u8 slot_num)
    {
    let mut first_slot: u8 = 1;
...
pub const SLOT_NAME_SIZE: c_int = 30;
...
#[no_mangle]
unsafe extern "C" fn fillslotinfo(hotplug_slot: *mut hotplug_slot) -> c_int {
    static int fillslotinfo(struct hotplug_slot *hotplug_slot)
    {
    struct slot *slot;
    let mut rc: c_int = 0;
    slot = to_slot(hotplug_slot);
    rc = ibmphp_hpc_readslot(slot, READ_ALLSTAT, core::ptr::null_mut());
    return rc;
    }
...
//
#[no_mangle]
unsafe extern "C" fn ebda_rsrc_controller() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(EBDA_SLOT_100_MAX: (hpc_ptr->slots[index].slot_cap & EBDA_SLOT_100_MAX) ==) -> else {
    else if ((hpc_ptr.slots[index].slot_cap & EBDA_SLOT_100_MAX) == EBDA_SLOT_100_MAX)
    tmp_slot.supported_speed =  2;
#[no_mangle]
pub unsafe extern "C" fn if(EBDA_SLOT_66_MAX: (hpc_ptr->slots[index].slot_cap & EBDA_SLOT_66_MAX) ==) -> else {
    ...
    bus_info_ptr1 = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ebda_rsrc_rsrc() -> int __init {
    ...
    kfree(rsrc_list_ptr);
    rsrc_list_ptr = core::ptr::null_mut();
    print_ebda_pci_rsrc();
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn ibmphp_get_total_controllers() -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibmphp_get_bus_index(num: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibmphp_free_bus_info_queue() {
...
#[no_mangle]
pub unsafe extern "C" fn ibmphp_free_ebda_hpc_queue() {
    void ibmphp_free_ebda_hpc_queue(void)
    {
    struct controller *controller = core::ptr::null_mut(), *next;
    let mut pci_flag: c_int = 0;
    list_for_each_entry_safe(controller, next, &ebda_hpc_head,
    ebda_hpc_list) {
    if (controller.ctlr_type == 0)
    release_region(controller.u.isa_ctlr.io_start, (controller.u.isa_ctlr.io_end - controller.u.isa_ctlr.io_start + 1));
#[no_mangle]
pub unsafe extern "C" fn if((!pci_flag): (controller->ctlr_type == 1) &&) -> else {
    ++pci_flag;
...
#[no_mangle]
pub unsafe extern "C" fn ibmphp_free_ebda_pci_rsrc_queue() {
...
#[no_mangle]
pub unsafe extern "C" fn ibmphp_register_pci() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ibmphp_probe(dev: *mut pci_dev, ids: *const pci_device_id) -> c_int {
