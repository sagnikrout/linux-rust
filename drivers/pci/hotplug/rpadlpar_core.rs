...
//! Source: drivers/pci/hotplug/rpadlpar_core.c
#![no_std]
...
pub const NODE_TYPE_VIO: c_int = 1;
pub const NODE_TYPE_SLOT: c_int = 2;
pub const NODE_TYPE_PHB: c_int = 3;
    static struct device_node *find_vio_slot_node(char *drc_name)
    {
    struct device_node *parent = of_find_node_by_name(core::ptr::null_mut(), "vdevice");
    struct device_node *dn;
    int rc;
    if (!parent)
    return core::ptr::null_mut();
    for_each_child_of_node(parent, dn) {
    rc = rpaphp_check_drc_props(dn, drc_name, core::ptr::null_mut());
    if (rc == 0)
    break;
    }
    of_node_put(parent);
...
#[no_mangle]
unsafe extern "C" fn dlpar_pci_add_bus(dn: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn dlpar_add_pci_slot(drc_name: *mut c_char, dn: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_remove_phb(drc_name: *mut c_char, dn: *mut device_node) -> c_int {
...
// If pci slot is hotpluggable, use hotplug to remove it
    ...
    if (rc < 0)
    return rc;
    pdn.phb = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn dlpar_add_phb(drc_name: *mut c_char, dn: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dlpar_add_vio_slot(drc_name: *mut c_char, dn: *mut device_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dlpar_add_slot(drc_name: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dlpar_remove_vio_slot(drc_name: *mut c_char, dn: *mut device_node) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dlpar_remove_pci_slot(drc_name: *mut c_char, dn: *mut device_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dlpar_remove_slot(drc_name: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_dlpar_capable() -> c_int {
    static inline int is_dlpar_capable(void)
    {
    let mut rc: c_int = rtas_token("ibm,configure-connector");
    return (int) (rc != RTAS_UNKNOWN_SERVICE);
    }
#[no_mangle]
unsafe extern "C" fn rpadlpar_io_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rpadlpar_io_exit() -> void __exit {
