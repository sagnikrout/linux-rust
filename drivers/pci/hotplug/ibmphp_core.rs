...
//! Source: drivers/pci/hotplug/ibmphp_core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn get_cur_bus_info(sl: *mut slot) -> c_int {
    ...
    rc = ibmphp_hpc_readslot(slot_cur, READ_BUSSTATUS, core::ptr::null_mut());
    if (rc)
    return rc;
...
#[no_mangle]
pub unsafe extern "C" fn slot_update(sl: *mut slot) -> c_int {
    static inline int slot_update(struct slot **sl)
    {
    int rc;
    rc = ibmphp_hpc_readslot(*sl, READ_ALLSTAT, core::ptr::null_mut());
    if (rc)
    return rc;
    if (!init_flag)
...
#[no_mangle]
unsafe extern "C" fn get_max_slots() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibmphp_init_devno(cur_slot: *mut slot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn power_on(slot_cur: *mut slot) -> c_int {
    static inline int power_on(struct slot *slot_cur)
    {
    let mut cmd: u8 = HPC_SLOT_ON;
    int retval;
...
#[no_mangle]
pub unsafe extern "C" fn power_off(slot_cur: *mut slot) -> c_int {
    static inline int power_off(struct slot *slot_cur)
    {
    let mut cmd: u8 = HPC_SLOT_OFF;
    int retval;
    retval = ibmphp_hpc_writeslot(slot_cur, cmd);
    if (retval) {
...
#[no_mangle]
unsafe extern "C" fn get_adapter_present(hotplug_slot: *mut hotplug_slot, value: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_max_bus_speed(slot: *mut slot) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_ops() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn validate(slot_cur: *mut slot, opn: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibmphp_update_slot_info(slot_cur: *mut slot) -> c_int {
    ...
    bus_speed += 0x01;
#[no_mangle]
pub unsafe extern "C" fn if(BUS_MODE_PCI: mode ==) -> else {
...
unsafe extern "C" fn free_slots() {
    ...
    slot_cur.ctrl = core::ptr::null_mut();
    slot_cur.bus_on = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn ibm_unconfigure_device(func: *mut pci_func) {
...
//
#[no_mangle]
unsafe extern "C" fn bus_structure_fixup(busno: u8) -> u8 {
    ...
    __func__);
    b = pci_scan_bus(busno, ibmphp_pci_bus.ops, core::ptr::null_mut());
    if (!b)
    continue;
...
#[no_mangle]
unsafe extern "C" fn ibm_configure_device(func: *mut pci_func) -> c_int {
    ...
    PCI_DEVFN(func.device, func.function));
    if (func.dev == core::ptr::null_mut()) {
    err("ERROR... : pci_dev still core::ptr::null_mut()\n");
    goto out;
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn is_bus_empty(slot_cur: *mut slot) -> c_int {
    static int is_bus_empty(struct slot *slot_cur)
    {
    int rc;
    struct slot *tmp_slot;
    let mut i: u8 = slot_cur.bus_on.slot_min;
...
//
#[no_mangle]
unsafe extern "C" fn set_bus(slot_cur: *mut slot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !SLOT_BUS_MODE(slot_cur->ext_status)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn check_limitations(slot_cur: *mut slot) -> c_int {
    static int check_limitations(struct slot *slot_cur)
    {
    u8 i;
    struct slot *tmp_slot;
    let mut count: u8 = 0;
    let mut limitation: u8 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn print_card_capability(slot_cur: *mut slot) {
    ...
    info("   133 MHz PCI-X\n");
#[no_mangle]
pub unsafe extern "C" fn if(PCIX66: (slot_cur->ext_status & CARD_INFO) ==) -> else {
    else if ((slot_cur.ext_status & CARD_INFO) == PCIX66)
    info("    66 MHz PCI-X\n");
#[no_mangle]
pub unsafe extern "C" fn if(PCI66: (slot_cur->ext_status & CARD_INFO) ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn enable_slot(hs: *mut hotplug_slot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: SLOT_BUS_SPEED(slot_cur->status)) -> else {
...
// just remove references
    ...
    slot_cur.func = core::ptr::null_mut();
    rc = -ENOMEM;
    goto error_power;
    }
    function = 0x00;
...
//
#[no_mangle]
unsafe extern "C" fn ibmphp_disable_slot(hotplug_slot: *mut hotplug_slot) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibmphp_do_disable_slot(slot_cur: *mut slot) -> c_int {
    int ibmphp_do_disable_slot(struct slot *slot_cur)
    {
    int rc;
    u8 flag;
    debug("DISABLING SLOT...\n");
    if ((slot_cur == core::ptr::null_mut()) || (slot_cur.ctrl == core::ptr::null_mut()))
    return -ENODEV;
    flag = slot_cur.flag;
    slot_cur.flag = 1;
    if (flag == 1) {
...
// checking if powered off already & valid slot #
    ...
    attn_LED_blink(slot_cur);
    if (slot_cur.func == core::ptr::null_mut()) {
...
// Need to turn off if was blinking b4
    ...
    .hardware_test =		core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ibmphp_unload() {
...
#[no_mangle]
unsafe extern "C" fn ibmphp_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ibmphp_exit() -> void __exit {
