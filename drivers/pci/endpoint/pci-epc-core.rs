...
//! Source: drivers/pci/endpoint/pci-epc-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn devm_pci_epc_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_put(epc: *mut pci_epc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_stop(epc: *mut pci_epc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_start(epc: *mut pci_epc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_get_msi(epc: *mut pci_epc, func_no: u8, vfunc_no: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_set_msi(epc: *mut pci_epc, func_no: u8, vfunc_no: u8, nr_irqs: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_get_msix(epc: *mut pci_epc, func_no: u8, vfunc_no: u8) -> c_int {
...
//
    ...
    {
    let mut map_size: usize = pci_size;
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_bar_size_to_rebar_cap(size: usize, cap: *mut u32) -> c_int {
...
//
    ...
    func_no = epf.func_no;
    list = &epf.list;
    epf.epc = core::ptr::null_mut();
    } else {
    func_no = epf.sec_epc_func_no;
    list = &epf.sec_epc_list;
    epf.sec_epc = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_linkup(epc: *mut pci_epc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_linkdown(epc: *mut pci_epc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_init_notify(epc: *mut pci_epc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_notify_pending_init(epc: *mut pci_epc, epf: *mut pci_epf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_deinit_notify(epc: *mut pci_epc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_bus_master_enable_notify(epc: *mut pci_epc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_destroy(epc: *mut pci_epc) {
...
#[no_mangle]
unsafe extern "C" fn pci_epc_release(dev: *mut device) {
...
//
    ...
    epc.domain_nr = pci_bus_find_domain_nr(core::ptr::null_mut(), dev);
...
#[no_mangle]
unsafe extern "C" fn pci_epc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pci_epc_exit() -> void __exit {
