...
//! Source: drivers/pci/endpoint/functions/pci-epf-mhi.c
#![no_std]
...
pub const MHI_VERSION_1_0: c_uint = 0x01000000;

// Platform specific flags

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_epf_mhi_dma_transfer {
    pub epf_mhi: *mut pci_epf_mhi,
    pub buf_info: mhi_ep_buf_info,
    pub node: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_epf_mhi_ep_info {
    pub config: *const mhi_ep_cntrl_config,
    pub epf_header: *mut pci_epf_header,
    pub bar_num: enum pci_barno,
    pub epf_flags: u32,
    pub msi_count: u32,
    pub mru: u32,
    pub flags: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_epf_mhi {
    pub epc_features: *const pci_epc_features,
    pub info: *const pci_epf_mhi_ep_info,
    pub mhi_cntrl: mhi_ep_cntrl,
    pub epf: *mut pci_epf,
    pub lock: mutex,
    pub mmio: *mut void __iomem,
    pub mmio_phys: resource_size_t,
    pub dma_chan_tx: *mut dma_chan,
    pub dma_chan_rx: *mut dma_chan,
    pub dma_wq: *mut workqueue_struct,
    pub dma_work: work_struct,
    pub dma_list: list_head,
...
#[no_mangle]
unsafe extern "C" fn get_align_offset(epf_mhi: *mut pci_epf_mhi, addr: u64) -> usize {
...
// vaddr = *vaddr + offset;
    ...
    {
    struct pci_epf_mhi *epf_mhi = to_epf_mhi(mhi_cntrl);
    let mut offset: usize = get_align_offset(epf_mhi, pci_addr);
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_raise_irq(mhi_cntrl: *mut mhi_ep_cntrl, vector: u32) {
...
//
    ...
    {
    struct pci_epf_mhi *epf_mhi = to_epf_mhi(mhi_cntrl);
    let mut offset: usize = get_align_offset(epf_mhi, buf_info.host_addr);
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_dma_callback(param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_dma_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_dma_async_callback(param: *mut c_void) {
    ...
    struct pci_epf_mhi *epf_mhi = to_epf_mhi(mhi_cntrl);
    struct device *dma_dev = epf_mhi.epf.epc.dev.parent;
    struct pci_epf_mhi_dma_transfer *transfer = core::ptr::null_mut();
    struct dma_chan *chan = epf_mhi.dma_chan_rx;
    struct device *dev = &epf_mhi.epf.dev;
    DECLARE_COMPLETION_ONSTACK(complete);
    struct dma_async_tx_descriptor *desc;
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_edma_flush_async(mhi_cntrl: *mut mhi_ep_cntrl) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_filter(chan: *mut dma_chan, node: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_dma_init(epf_mhi: *mut pci_epf_mhi) -> c_int {
    ...
    epf_mhi.dma_chan_rx = core::ptr::null_mut();
    err_release_tx:
    dma_release_channel(epf_mhi.dma_chan_tx);
    epf_mhi.dma_chan_tx = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_dma_deinit(epf_mhi: *mut pci_epf_mhi) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_epc_init(epf: *mut pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_epc_deinit(epf: *mut pci_epf) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_link_up(epf: *mut pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_link_down(epf: *mut pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_bus_master_enable(epf: *mut pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_bind(epf: *mut pci_epf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_unbind(epf: *mut pci_epf) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_mhi_exit() -> void __exit {
