...
//! Source: drivers/pci/endpoint/functions/pci-epf-vntb.c
#![no_std]
...
pub const COMMAND_CONFIGURE_DOORBELL: c_int = 1;
pub const COMMAND_TEARDOWN_DOORBELL: c_int = 2;
pub const COMMAND_CONFIGURE_MW: c_int = 3;
pub const COMMAND_TEARDOWN_MW: c_int = 4;
pub const COMMAND_LINK_UP: c_int = 5;
pub const COMMAND_LINK_DOWN: c_int = 6;
pub const COMMAND_STATUS_OK: c_int = 1;
pub const COMMAND_STATUS_ERROR: c_int = 2;

pub const SPAD_COUNT: c_int = 64;
pub const DB_COUNT: c_int = 4;
pub const NTB_MW_OFFSET: c_int = 2;

pub const MAX_MW: c_int = 4;
// Limit per-work execution to avoid monopolizing kworker on doorbell storms.
pub const VNTB_PEER_DB_WORK_BUDGET: c_int = 5;
    enum epf_ntb_bar {
    BAR_CONFIG,
    BAR_DB,
    BAR_MW1,
...
pub const MAX_DB_COUNT: c_int = 32;
//
// +--------------------------------------------------+ Base
// |                                                  |
...
pub struct epf_ntb_ctrl {
    ...
    pub spad_offset: u32,
    pub spad_count: u32,
    pub db_entry_size: u32,
    pub db_data: [u32; MAX_DB_COUNT],
    pub db_offset: [u32; MAX_DB_COUNT],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct epf_ntb {
    ...
    pub db_count: u32,
    pub spad_count: u32,
    pub mws_size: [u64; MAX_MW],
    pub db: core::sync::atomic::AtomicI64,
    pub peer_db_pending: core::sync::atomic::AtomicI64,
    pub peer_db_work: work_struct,
    pub vbus_number: u32,
    pub vntb_pid: u16,
    pub vntb_vid: u16,
    pub linkup: bool,
...
// when polled.
//
    pub msi_doorbell: bool,
    pub spad_size: u32,
    pub epf_ntb_bar: [enum pci_barno; VNTB_BAR_NUM],
    pub reg: *mut epf_ntb_ctrl,
    pub epf_db: *mut u32,
    pub vpci_mw_phy: [phys_addr_t; MAX_MW],
    pub vpci_mw_addr: [*mut void __iomem; MAX_MW],
    pub cmd_handler: delayed_work,
}
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_link_up(ntb: *mut epf_ntb, link_up: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_configure_mw(ntb: *mut epf_ntb, mw: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_teardown_mw(ntb: *mut epf_ntb, mw: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_cmd_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn epf_ntb_doorbell_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_config_sspad_bar_clear(ntb: *mut epf_ntb) {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_config_sspad_bar_set(ntb: *mut epf_ntb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_config_spad_bar_free(ntb: *mut epf_ntb) {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_config_spad_bar_alloc(ntb: *mut epf_ntb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_configure_interrupt(ntb: *mut epf_ntb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn epf_ntb_db_irq_is_duplicated(epf: *const pci_epf, idx: c_uint) -> bool {
...
// Program inbound mapping for the doorbell
    ...
    let mut addr: dma_addr_t = (u64)msg.address_hi << 32 | msg.address_lo;
    low = min(low, addr);
    high = max(high, addr);
    }
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_db_bar_init(ntb: *mut epf_ntb) -> c_int {
    ...
    void *mw_addr;
    enum pci_barno barno;
    let mut size: usize = sizeof(u32) * ntb.db_count;
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_db_bar_clear(ntb: *mut epf_ntb) {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_mw_bar_init(ntb: *mut epf_ntb) -> c_int {
    ...
    ntb.epf.bar[barno].addr = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_mw_bar_clear(ntb: *mut epf_ntb, num_mws: c_int) {
    static void epf_ntb_mw_bar_clear(struct epf_ntb *ntb, int num_mws)
    {
    enum pci_barno barno;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_init_epc_bar(ntb: *mut epf_ntb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_epc_init(ntb: *mut epf_ntb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_epc_cleanup(ntb: *mut epf_ntb) {
...
#[no_mangle]
unsafe extern "C" fn epf_ntb_epc_attached(ntb: *mut epf_ntb) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pci_read(bus: *mut pci_bus, devfn: c_uint, where: c_int, size: c_int, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_write(bus: *mut pci_bus, devfn: c_uint, where: c_int, size: c_int, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vpci_scan_bus(sysdata: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_mw_count(ntb: *mut ntb_dev, pidx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_spad_count(ntb: *mut ntb_dev) -> c_int {
    static int vntb_epf_spad_count(struct ntb_dev *ntb)
    {
    return ntb_ndev(ntb).spad_count;
    }
#[no_mangle]
unsafe extern "C" fn vntb_epf_peer_mw_count(ntb: *mut ntb_dev) -> c_int {
    static int vntb_epf_peer_mw_count(struct ntb_dev *ntb)
    {
    return ntb_ndev(ntb).num_mws;
    }
#[no_mangle]
unsafe extern "C" fn vntb_epf_db_vector_count(ntb: *mut ntb_dev) -> c_int {
    static int vntb_epf_db_vector_count(struct ntb_dev *ntb)
    {
    struct epf_ntb *ndev = ntb_ndev(ntb);
    let mut db_count: u32 = READ_ONCE(ndev.db_count);
//
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_db_valid_mask(ntb: *mut ntb_dev) -> u64 {
    static u64 vntb_epf_db_valid_mask(struct ntb_dev *ntb)
    {
    let mut nr_vec: c_int = vntb_epf_db_vector_count(ntb);
    if (!nr_vec)
    return 0;
    return GENMASK_ULL(nr_vec - 1, 0);
    }
#[no_mangle]
unsafe extern "C" fn vntb_epf_db_vector_mask(ntb: *mut ntb_dev, db_vector: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_db_set_mask(ntb: *mut ntb_dev, db_bits: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_mw_clear_trans(ntb: *mut ntb_dev, pidx: c_int, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_spad_read(ndev: *mut ntb_dev, idx: c_int) -> u32 {
    static u32 vntb_epf_spad_read(struct ntb_dev *ndev, int idx)
    {
    struct epf_ntb *ntb = ntb_ndev(ndev);
    let mut off: c_int = ntb.reg.spad_offset, ct = ntb.reg.spad_count * sizeof(u32);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_spad_write(ndev: *mut ntb_dev, idx: c_int, val: u32) -> c_int {
    static int vntb_epf_spad_write(struct ntb_dev *ndev, int idx, u32 val)
    {
    struct epf_ntb *ntb = ntb_ndev(ndev);
    struct epf_ntb_ctrl *ctrl = ntb.reg;
    let mut off: c_int = ctrl.spad_offset, ct = ctrl.spad_count * sizeof(u32);
    void __iomem *base = (void __iomem *)ntb.reg;
    writel(val, base + off + ct + idx * sizeof(u32));
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vntb_epf_peer_spad_read(ndev: *mut ntb_dev, pidx: c_int, idx: c_int) -> u32 {
    static u32 vntb_epf_peer_spad_read(struct ntb_dev *ndev, int pidx, int idx)
    {
    struct epf_ntb *ntb = ntb_ndev(ndev);
    struct epf_ntb_ctrl *ctrl = ntb.reg;
    let mut off: c_int = ctrl.spad_offset;
    void __iomem *base = (void __iomem *)ntb.reg;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_peer_spad_write(ndev: *mut ntb_dev, pidx: c_int, idx: c_int, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_peer_db_work(work: *mut work_struct) {
    ...
    struct pci_epf *epf = ntb.epf;
    let mut budget: c_uint = VNTB_PEER_DB_WORK_BUDGET;
    u8 func_no, vfunc_no;
    unsigned int db_bit;
    u32 interrupt_num;
    u64 db_bits;
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_peer_db_set(ndev: *mut ntb_dev, db_bits: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_db_read(ndev: *mut ntb_dev) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_db_clear_mask(ndev: *mut ntb_dev, db_bits: u64) -> c_int {
    static int vntb_epf_db_clear_mask(struct ntb_dev *ndev, u64 db_bits)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vntb_epf_db_clear(ndev: *mut ntb_dev, db_bits: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vntb_epf_link_disable(ntb: *mut ntb_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_vntb_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_bind(epf: *mut pci_epf) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_unbind(epf: *mut pci_epf) {
...
#[no_mangle]
unsafe extern "C" fn epf_ntb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn epf_ntb_exit() -> void __exit {
