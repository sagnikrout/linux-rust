...
//! Source: drivers/pci/endpoint/functions/pci-epf-ntb.c
#![no_std]
...
pub struct epf_ntb {
    ...
    pub epc: [*mut epf_ntb_epc; 2],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct epf_ntb_epc {
    pub func_no: u8,
    pub vfunc_no: u8,
    pub linkup: bool,
    pub is_msix: bool,
    ...
    pub spad_size: u32,
    pub epc: *mut pci_epc,
    pub epf_ntb: *mut epf_ntb,
    pub mw_addr: [*mut void __iomem; 6],
    pub msix_table_offset: usize,
    pub reg: *mut epf_ntb_ctrl,
    pub epf_bar: *mut pci_epf_bar,
    pub epf_ntb_bar: [enum pci_barno; 6],
    pub cmd_handler: delayed_work,
    pub type: enum pci_epc_interface_type,
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_peer_spad_bar_clear(ntb_epc: *mut epf_ntb_epc) {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_config_sspad_bar_clear(ntb_epc: *mut epf_ntb_epc) {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_config_sspad_bar_set(ntb_epc: *mut epf_ntb_epc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(spad_size: size < ctrl_size +) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_config_spad_bar_alloc_interface(ntb: *mut epf_ntb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_free_peer_mem(ntb_epc: *mut epf_ntb_epc) {
    ...
    ntb_epc.mw_addr[barno] = core::ptr::null_mut();
    }
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_db_mw_bar_clear(ntb_epc: *mut epf_ntb_epc) {
...
//
#[no_mangle]
unsafe extern "C" fn epf_ntb_epc_create(ntb: *mut epf_ntb) -> c_int {
