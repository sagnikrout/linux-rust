...
//! Source: drivers/pci/endpoint/pci-ep-msi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pci_epf_write_msi_msg(desc: *mut msi_desc, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_alloc_doorbell_embedded(epf: *mut pci_epf, num_db: u16) -> c_int {
    static int pci_epf_alloc_doorbell_embedded(struct pci_epf *epf, u16 num_db)
    {
    const struct pci_epc_aux_resource *doorbell = core::ptr::null_mut();
    struct pci_epf_doorbell_msg *msg;
    struct pci_epc *epc = epf.epc;
    let mut map_size: usize = 0, off = 0;
    let mut iova_base: dma_addr_t = 0;
...
#[no_mangle]
unsafe extern "C" fn pci_epf_alloc_doorbell_msi(epf: *mut pci_epf, num_db: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_epf_alloc_doorbell(epf: *mut pci_epf, num_db: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_epf_free_doorbell(epf: *mut pci_epf) {
...
#[no_mangle]
pub unsafe extern "C" fn if(msg0->iova_size: msg0->type == PCI_EPF_DOORBELL_EMBEDDED &&) -> else {
