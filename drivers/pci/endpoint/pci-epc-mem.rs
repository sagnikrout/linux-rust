...
//! Source: drivers/pci/endpoint/pci-epc-mem.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn pci_epc_mem_get_order(mem: *mut pci_epc_mem, size: usize) -> c_int {
    static int pci_epc_mem_get_order(struct pci_epc_mem *mem, size_t size)
    {
    int order;
    let mut page_shift: c_uint = ilog2(mem.window.page_size);
    size--;
    size >>= page_shift;
...
//
    ...
    {
    struct pci_epc_mem *mem = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_epc_mem_exit(epc: *mut pci_epc) {
    ...
    kfree(epc.windows);
    epc.windows = core::ptr::null_mut();
    epc.mem = core::ptr::null_mut();
    epc.num_windows = 0;
    }
