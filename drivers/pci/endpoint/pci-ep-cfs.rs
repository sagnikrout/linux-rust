...
//! Source: drivers/pci/endpoint/pci-ep-cfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_epf_group {
    pub group: config_group,
    pub primary_epc_group: config_group,
    pub secondary_epc_group: config_group,
    pub epf: *mut pci_epf,
    pub index: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn pci_epc_start_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn pci_ep_cfs_remove_epc_group(group: *mut config_group) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn pci_ep_cfs_add_type_group(epf_group: *mut pci_epf_group) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_cfs_add_sub_groups(epf_group: *mut pci_epf_group) {
...
#[no_mangle]
unsafe extern "C" fn pci_epf_drop(group: *mut config_group, item: *mut config_item) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_ep_cfs_remove_epf_group(group: *mut config_group) {
...
#[no_mangle]
unsafe extern "C" fn pci_ep_cfs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pci_ep_cfs_exit() -> void __exit {
