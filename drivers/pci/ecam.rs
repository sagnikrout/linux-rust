...
//
    let mut per_bus_mapping: static bool = !IS_ENABLED(CONFIG_64BIT);
//
...
//
    ...
    {
    let mut bus_shift: c_uint = ops.bus_shift;
...
#[no_mangle]
pub unsafe extern "C" fn pci_ecam_free(cfg: *mut pci_config_window) {
...
#[no_mangle]
unsafe extern "C" fn pci_ecam_add_bus(bus: *mut pci_bus) -> c_int {
    static int pci_ecam_add_bus(struct pci_bus *bus)
    {
    struct pci_config_window *cfg = bus.sysdata;
    let mut bsz: c_uint = 1 << cfg.bus_shift;
...
#[no_mangle]
unsafe extern "C" fn pci_ecam_remove_bus(bus: *mut pci_bus) {
    ...
    cfg.winp[busn] = core::ptr::null_mut();
    }
    }
//
...
//
    ...
    {
    struct pci_config_window *cfg = bus.sysdata;
    let mut bus_shift: c_uint = cfg.ops.bus_shift;
    let mut devfn_shift: c_uint = cfg.ops.bus_shift - 8;
    let mut busn: c_uint = bus.number;
    void __iomem *base;
