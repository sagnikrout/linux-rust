...
//! Source: drivers/pci/setup-res.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pci_std_update_resource(dev: *mut pci_dev, resno: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_update_resource(dev: *mut pci_dev, resno: c_int) {
    void pci_update_resource(struct pci_dev *dev, int resno)
    {
    if (resno <= PCI_ROM_RESOURCE)
    pci_std_update_resource(dev, resno);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pci_resource_is_iov(resno)) -> else {
    else if (pci_resource_is_iov(resno))
    pci_iov_update_resource(dev, resno);
    }
#[no_mangle]
pub unsafe extern "C" fn pci_claim_resource(dev: *mut pci_dev, resource: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_disable_bridge_window(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcibios_retrieve_fw_addr(dev: *mut pci_dev, idx: c_int) -> resource_size_t __weak {
...
//
    ...
    {
    let mut resno: c_int = pci_resource_num(dev, res);
...
#[no_mangle]
pub unsafe extern "C" fn pci_assign_resource(dev: *mut pci_dev, resno: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_release_resource(dev: *mut pci_dev, resno: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_enable_resources(dev: *mut pci_dev, mask: c_int) -> c_int {
