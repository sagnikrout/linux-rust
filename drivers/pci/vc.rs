...
//
#[no_mangle]
unsafe extern "C" fn pci_vc_load_arb_table(dev: *mut pci_dev, pos: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_vc_load_port_arb_table(dev: *mut pci_dev, pos: c_int, res: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_vc_enable(dev: *mut pci_dev, pos: c_int, res: c_int) {
    ...
    struct pci_dev *link = core::ptr::null_mut();
...
//
    ...
    int i, len = 0;
    u8 *buf = save_state ? (u8 *)save_state.cap.data : core::ptr::null_mut();
// Sanity check buffer size for save/restore
    if (buf && save_state.cap.size !=
    pci_vc_do_save_buffer(dev, pos, core::ptr::null_mut(), save)) {
...
//
    ...
    vcarb_phases = 128;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_VC_CAP2_64_PHASE: cap2 &) -> else {
    else if (cap2 & PCI_VC_CAP2_64_PHASE)
    vcarb_phases = 64;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_VC_CAP2_32_PHASE: cap2 &) -> else {
...
//
    ...
    parb_phases = 128;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_VC_RES_CAP_64_PHASE: cap &) -> else {
    else if (cap & PCI_VC_RES_CAP_64_PHASE)
    parb_phases = 64;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_VC_RES_CAP_32_PHASE: cap &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_save_vc_state(dev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_restore_vc_state(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_allocate_vc_save_buffers(dev: *mut pci_dev) {
    ...
    if (!pos)
    continue;
    len = pci_vc_do_save_buffer(dev, pos, core::ptr::null_mut(), false);
