...
#[no_mangle]
unsafe extern "C" fn acpi_get_rc_addr(adev: *mut acpi_device, res: *mut resource) -> c_int {
...
// res = *entry->res;
    ...
    acpi_status status;
    status = acpi_evaluate_integer(handle, METHOD_NAME__UID, core::ptr::null_mut(), &uid);
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_root_get_mcfg_addr(handle: acpi_handle) -> phys_addr_t {
    ...
    core::ptr::null_mut(), &mcfg_addr);
    if (ACPI_FAILURE(status))
    return 0;
    return (phys_addr_t)mcfg_addr;
    }
#[no_mangle]
pub unsafe extern "C" fn pci_acpi_preserve_config(host_bridge: *mut pci_host_bridge) -> bool {
...
//
    ...
    core::ptr::null_mut(), ACPI_TYPE_INTEGER);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpx_type0 {
    pub /: *mut *mut u32 revision; / Not present in _HPP,
    pub /: *mut *mut u8 cache_line_size; / Not applicable to PCIe,
    pub /: *mut *mut u8 latency_timer; / Not applicable to PCIe,
    pub enable_serr: u8,
    pub enable_perr: u8,
}
...
#[no_mangle]
unsafe extern "C" fn program_hpx_type0(dev: *mut pci_dev, hpx: *mut hpx_type0) {
...
// Program bridge control value
    ...
    let mut revision: u32 = fields[1].integer.value;
    switch (revision) {
    case 1:
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpx_type1 {
    pub revision: u32,
    pub max_mem_read: u8,
    pub avg_max_split: u8,
    pub tot_max_split: u16,
}

#[no_mangle]
unsafe extern "C" fn program_hpx_type1(dev: *mut pci_dev, hpx: *mut hpx_type1) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpx_type2 {
    pub revision: u32,
    pub unc_err_mask_and: u32,
    pub unc_err_mask_or: u32,
    pub unc_err_sever_and: u32,
    pub unc_err_sever_or: u32,
    pub cor_err_mask_and: u32,
    pub cor_err_mask_or: u32,
    pub adv_err_cap_and: u32,
    pub adv_err_cap_or: u32,
    pub pci_exp_devctl_and: u16,
    pub pci_exp_devctl_or: u16,
    pub pci_exp_lnkctl_and: u16,
    pub pci_exp_lnkctl_or: u16,
    pub sec_unc_err_sever_and: u32,
    pub sec_unc_err_sever_or: u32,
    pub sec_unc_err_mask_and: u32,
    pub sec_unc_err_mask_or: u32,
}

#[no_mangle]
unsafe extern "C" fn program_hpx_type2(dev: *mut pci_dev, hpx: *mut hpx_type2) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpx_type3 {
    pub device_type: u16,
    pub function_type: u16,
    pub config_space_location: u16,
    pub pci_exp_cap_id: u16,
    pub pci_exp_cap_ver: u16,
    pub pci_exp_vendor_id: u16,
    pub dvsec_id: u16,
    pub dvsec_rev: u16,
    pub match_offset: u16,
    pub match_mask_and: u32,
    pub match_value: u32,
    pub reg_offset: u16,
    pub reg_mask_and: u32,
    pub reg_mask_or: u32,
}
...
#[no_mangle]
unsafe extern "C" fn hpx3_device_type(dev: *mut pci_dev) -> u16 {
    static u16 hpx3_device_type(struct pci_dev *dev)
    {
    let mut pcie_type: u16 = pci_pcie_type(dev);
...
#[no_mangle]
unsafe extern "C" fn hpx3_function_type(dev: *mut pci_dev) -> u8 {
    static u8 hpx3_function_type(struct pci_dev *dev)
    {
    if (dev.is_virtfn)
    return HPX_FN_SRIOV_VIRT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pci_find_ext_capability(dev, 0: PCI_EXT_CAP_ID_SRIOV) >) -> else {
...
#[no_mangle]
unsafe extern "C" fn hpx3_cap_ver_matches(pcie_cap_id: u8, hpx3_cap_id: u8) -> bool {
    static bool hpx3_cap_ver_matches(u8 pcie_cap_id, u8 hpx3_cap_id)
    {
    let mut cap_ver: u8 = hpx3_cap_id & 0xf;
    if ((hpx3_cap_id & BIT(4)) && cap_ver >= pcie_cap_id)
    return true;
#[no_mangle]
pub unsafe extern "C" fn if(pcie_cap_id: cap_ver ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn program_hpx_type3(dev: *mut pci_dev, hpx: *mut hpx_type3) {
...
#[no_mangle]
unsafe extern "C" fn acpi_run_hpx(dev: *mut pci_dev, handle: acpi_handle) -> acpi_status {
    ...
    u32 type;
    int i;
    status = acpi_evaluate_object(handle, "_HPX", core::ptr::null_mut(), &buffer);
    if (ACPI_FAILURE(status))
    return status;
...
#[no_mangle]
unsafe extern "C" fn acpi_run_hpp(dev: *mut pci_dev, handle: acpi_handle) -> acpi_status {
    ...
    int i;
    memset(&hpx0, 0, sizeof(hpx0));
    status = acpi_evaluate_object(handle, "_HPP", core::ptr::null_mut(), &buffer);
    if (ACPI_FAILURE(status))
    return status;
    package = (union acpi_object *) buffer.pointer;
    if (package.type != ACPI_TYPE_PACKAGE ||
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_acpi_program_hp_params(dev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pciehp_is_native(bridge: *mut pci_dev) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn shpchp_is_native(bridge: *mut pci_dev) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pci_acpi_wake_bus(context: *mut acpi_device_wakeup_context) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_acpi_wake_dev(context: *mut acpi_device_wakeup_context) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_choose_state(pdev: *mut pci_dev) -> pci_power_t {
    ...
    acpi_state = acpi_pm_device_sleep_state(&pdev.dev, core::ptr::null_mut(), d_max);
    if (acpi_state < 0)
...
#[no_mangle]
pub unsafe extern "C" fn pci_set_acpi_fwnode(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_dev_acpi_reset(dev: *mut pci_dev, probe: bool) -> c_int {
    int pci_dev_acpi_reset(struct pci_dev *dev, bool probe)
    {
    let mut handle: acpi_handle = ACPI_HANDLE(&dev.dev);
    int ret;
    ...
    if (ACPI_FAILURE(acpi_evaluate_object(handle, "_RST", core::ptr::null_mut(), core::ptr::null_mut()))) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_power_manageable(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_bridge_d3(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acpi_pci_config_space_access(dev: *mut pci_dev, enable: bool) {
    static void acpi_pci_config_space_access(struct pci_dev *dev, bool enable)
    {
    let mut val: c_int = enable ? ACPI_REG_CONNECT : ACPI_REG_DISCONNECT;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_set_power_state(dev: *mut pci_dev, state: pci_power_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_get_power_state(dev: *mut pci_dev) -> pci_power_t {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_refresh_power_state(dev: *mut pci_dev) {
    void acpi_pci_refresh_power_state(struct pci_dev *dev)
    {
    struct acpi_device *adev = ACPI_COMPANION(&dev.dev);
    if (adev && acpi_device_power_manageable(adev))
    acpi_device_update_power(adev, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn acpi_pci_propagate_wakeup(bus: *mut pci_bus, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_wakeup(dev: *mut pci_dev, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_need_resume(dev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_add_bus(bus: *mut pci_bus) {
...
//
    ...
    DSM_PCI_POWER_ON_RESET_DELAY, core::ptr::null_mut(), ACPI_TYPE_INTEGER);
    if (!obj)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pci_remove_bus(bus: *mut pci_bus) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_acpi_set_companion_lookup_hook(): *mut *mut *mut acpi_device (func)(pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_acpi_clear_companion_lookup_hook() {
    void pci_acpi_clear_companion_lookup_hook(void)
    {
    down_write(&pci_acpi_companion_lookup_sem);
    pci_acpi_find_companion_hook = core::ptr::null_mut();
    up_write(&pci_acpi_companion_lookup_sem);
    }
    ...
    pci_acpi_find_companion_hook(pci_dev) : core::ptr::null_mut();
...
//
    ...
    DSM_PCI_DEVICE_READINESS_DURATIONS, core::ptr::null_mut(),
    ACPI_TYPE_PACKAGE);
    if (!obj)
    return;
...
#[no_mangle]
unsafe extern "C" fn pci_acpi_set_external_facing(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_acpi_setup(dev: *mut device, adev: *mut acpi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_acpi_cleanup(dev: *mut device, adev: *mut acpi_device) {
...
#[no_mangle]
unsafe extern "C" fn acpi_pci_init() -> int __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_pci_generic_root_info {
    pub common: acpi_pci_root_info,
    pub /: *mut *mut *mut pci_config_window cfg; / config space mapping,
}

#[no_mangle]
pub unsafe extern "C" fn acpi_pci_bus_find_domain_nr(bus: *mut pci_bus) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcibios_root_bridge_prepare(bridge: *mut pci_host_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_acpi_root_prepare_resources(ci: *mut acpi_pci_root_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_acpi_generic_release_info(ci: *mut acpi_pci_root_info) {
