...
//! Source: drivers/pci/controller/pcie-rockchip-host.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_enable_bw_int(rockchip: *mut rockchip_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_clr_bw_int(rockchip: *mut rockchip_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_update_txcredit_mui(rockchip: *mut rockchip_pcie) {
...
//
    ...
    let mut dev: return = = 0;
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_lane_map(rockchip: *mut rockchip_pcie) -> u8 {
...
pub unsafe extern "C" fn if(2: size ==) -> else {
    ...
    writew(val, addr);
#[no_mangle]
pub unsafe extern "C" fn if(1: size ==) -> else {
    else if (size == 1)
    writeb(val, addr);
    else
    return PCIBIOS_BAD_REGISTER_NUMBER;
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_set_power_limit(rockchip: *mut rockchip_pcie) {
...
//
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_host_init_port(rockchip: *mut rockchip_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_subsys_irq_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_client_irq_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_setup_irq(rockchip: *mut rockchip_pcie) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_parse_host_dt(rockchip: *mut rockchip_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_set_vpcie(rockchip: *mut rockchip_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_enable_interrupts(rockchip: *mut rockchip_pcie) {
...
unsafe extern "C" fn rockchip_pcie_init_irq_domain(rockchip: *mut rockchip_pcie) -> c_int {
    ...
    {
    struct device *dev = rockchip.dev;
    struct device_node *intc = of_get_next_child(dev.of_node, core::ptr::null_mut());
    if (!intc) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_cfg_atu(rockchip: *mut rockchip_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_wait_l2(rockchip: *mut rockchip_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_remove(pdev: *mut platform_device) {
