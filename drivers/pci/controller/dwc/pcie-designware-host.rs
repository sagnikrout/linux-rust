...
//! Source: drivers/pci/controller/dwc/pcie-designware-host.c
#![no_std]
...
// MSI int handler
#[no_mangle]
pub unsafe extern "C" fn dw_handle_msi_irq(pp: *mut dw_pcie_rp) {
    ...
    let mut reg_off: c_uint = i * MSI_REG_CTRL_BLOCK_SIZE;
    let mut irq_off: c_uint = i * MAX_MSI_IRQS_PER_CTRL;
...
#[no_mangle]
unsafe extern "C" fn dw_chained_msi_isr(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn dw_pci_setup_msi_msg(d: *mut irq_data, msg: *mut msi_msg) {
    static void dw_pci_setup_msi_msg(struct irq_data *d, struct msi_msg *msg)
    {
    struct dw_pcie_rp *pp = irq_data_get_irq_chip_data(d);
    struct dw_pcie *pci = to_dw_pcie_from_pp(pp);
    let mut msi_target: u64 = (u64)pp.msi_data;
...
#[no_mangle]
unsafe extern "C" fn dw_pci_bottom_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn dw_pci_bottom_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn dw_pci_bottom_ack(d: *mut irq_data) {
    ...
    pp, handle_edge_irq, core::ptr::null_mut(), core::ptr::null_mut());
    }
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_allocate_domains(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_free_msi(pp: *mut dw_pcie_rp) {
    void dw_pcie_free_msi(struct dw_pcie_rp *pp)
    {
    u32 ctrl;
    for (ctrl = 0; ctrl < MAX_MSI_CTRLS; ctrl++) {
    if (pp.msi_irq[ctrl] > 0)
    irq_set_chained_handler_and_data(pp.msi_irq[ctrl], core::ptr::null_mut(), core::ptr::null_mut());
    }
    irq_domain_remove(pp.irq_domain);
    }
    EXPORT_SYMBOL_GPL(dw_pcie_free_msi);
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_msi_init(pp: *mut dw_pcie_rp) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_parse_split_msi_irq(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_msi_host_init(pp: *mut dw_pcie_rp) -> c_int {
    int dw_pcie_msi_host_init(struct dw_pcie_rp *pp)
    {
    struct dw_pcie *pci = to_dw_pcie_from_pp(pp);
    struct device *dev = pci.dev;
    struct platform_device *pdev = to_platform_device(dev);
    u64 *msi_vaddr = core::ptr::null_mut();
    int ret;
    u32 ctrl, num_ctrls;
    for (ctrl = 0; ctrl < MAX_MSI_CTRLS; ctrl++)
    pp.irq_mask[ctrl] = ~0;
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_host_request_msg_tlp_res(pp: *mut dw_pcie_rp) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_config_ecam_iatu(pp: *mut dw_pcie_rp) -> c_int {
    static int dw_pcie_config_ecam_iatu(struct dw_pcie_rp *pp)
    {
    struct dw_pcie *pci = to_dw_pcie_from_pp(pp);
    let mut atu: dw_pcie_ob_atu_cfg = {0};
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_create_ecam_window(pp: *mut dw_pcie_rp, res: *mut resource) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ecam_enabled(pp: *mut dw_pcie_rp, config_res: *mut resource) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_host_get_resources(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_host_deinit(pp: *mut dw_pcie_rp) {
...
//
    ...
    struct dw_pcie *pci = to_dw_pcie_from_pp(pp);
    let mut busn: c_uint = bus.number;
    if (busn > 0)
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_iatu_setup(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_program_presets(pp: *mut dw_pcie_rp, speed: enum pci_bus_speed) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_config_presets(pp: *mut dw_pcie_rp) {
    static void dw_pcie_config_presets(struct dw_pcie_rp *pp)
    {
    struct dw_pcie *pci = to_dw_pcie_from_pp(pp);
    let mut speed: enum pci_bus_speed = pcie_get_link_speed(pci.max_link_speed);
//
...
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_setup_rc(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_pme_turn_off(pci: *mut dw_pcie) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_suspend_noirq(pci: *mut dw_pcie) -> c_int {
    int dw_pcie_suspend_noirq(struct dw_pcie *pci)
    {
    let mut pme_capable: bool = false;
    let mut ret: c_int = 0;
    u32 val;
    if (!dw_pcie_link_up(pci))
    goto stop_link;
...
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_resume_noirq(pci: *mut dw_pcie) -> c_int {
