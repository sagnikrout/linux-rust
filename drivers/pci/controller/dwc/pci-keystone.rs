...
//! Source: drivers/pci/controller/dwc/pci-keystone.c
#![no_std]
...
pub const PCIE_VENDORID_MASK: c_uint = 0xffff;
pub const PCIE_DEVICEID_SHIFT: c_int = 16;
// Application registers
pub const PID: c_uint = 0x000;

pub const RTL_SHIFT: c_int = 11;
pub const AM6_PCI_PG1_RTL_VER: c_uint = 0x15;
pub const CMD_STATUS: c_uint = 0x004;

pub const CFG_SETUP: c_uint = 0x008;

pub const OB_SIZE: c_uint = 0x030;

pub const PCIE_EP_IRQ_SET: c_uint = 0x64;
pub const PCIE_EP_IRQ_CLR: c_uint = 0x68;

// IRQ register defines
pub const IRQ_EOI: c_uint = 0x050;
pub const MSI_IRQ: c_uint = 0x054;

pub const MSI_IRQ_OFFSET: c_int = 4;

pub const ERR_IRQ_STATUS: c_uint = 0x1c4;
pub const ERR_IRQ_ENABLE_SET: c_uint = 0x1c8;

    ERR_NONFATAL | ERR_FATAL | ERR_SYS)
// PCIE controller device IDs
pub const PCIE_RC_K2HK: c_uint = 0xb008;
pub const PCIE_RC_K2E: c_uint = 0xb009;
pub const PCIE_RC_K2L: c_uint = 0xb00a;
pub const PCIE_RC_K2G: c_uint = 0xb00b;

pub const EP: c_uint = 0x0;
pub const LEG_EP: c_uint = 0x1;
pub const RC: c_uint = 0x2;

pub const AM654_PCIE_DEV_TYPE_MASK: c_uint = 0x3;

pub const PCI_DEVICE_ID_TI_AM654X: c_uint = 0xb00c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ks_pcie_of_data {
    pub mode: enum dw_pcie_device_mode,
    pub host_ops: *const dw_pcie_host_ops,
    pub ep_ops: *const dw_pcie_ep_ops,
    pub version: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct keystone_pcie {
    pub pci: *mut dw_pcie,
// PCI Device ID
    pub device_id: u32,
    pub intx_host_irqs: [c_int; PCI_NUM_INTX],
    pub msi_host_irq: c_int,
    pub num_lanes: c_int,
    pub num_viewport: u32,
    pub phy: *mut phy,
    pub link: *mut device_link,
    pub msi_intc_np: *mut device_node,
    pub intx_irq_domain: *mut irq_domain,
    pub np: *mut device_node,
// Application register space
    pub /: *mut *mut *mut void __iomem va_app_base; / DT 1st resource,
    pub app: resource,
    pub is_am6: bool,
}

#[no_mangle]
unsafe extern "C" fn ks_pcie_app_readl(ks_pcie: *mut keystone_pcie, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_msi_irq_ack(data: *mut irq_data) {
    static void ks_pcie_msi_irq_ack(struct irq_data *data)
    {
    struct dw_pcie_rp *pp  = irq_data_get_irq_chip_data(data);
    struct keystone_pcie *ks_pcie;
    let mut irq: u32 = data.hwirq;
    struct dw_pcie *pci;
    u32 reg_offset;
    u32 bit_pos;
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_msi_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_msi_unmask(data: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ks_pcie_set_dbi_mode(ks_pcie: *mut keystone_pcie) {
...
//
#[no_mangle]
unsafe extern "C" fn ks_pcie_clear_dbi_mode(ks_pcie: *mut keystone_pcie) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_msi_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_enable_error_irq(ks_pcie: *mut keystone_pcie) {
    static void ks_pcie_enable_error_irq(struct keystone_pcie *ks_pcie)
    {
    ks_pcie_app_writel(ks_pcie, ERR_IRQ_ENABLE_SET, ERR_IRQ_ALL);
    }
#[no_mangle]
unsafe extern "C" fn ks_pcie_handle_error_irq(ks_pcie: *mut keystone_pcie) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_ack_intx_irq(d: *mut irq_data) {
    static void ks_pcie_ack_intx_irq(struct irq_data *d)
    {
    }
#[no_mangle]
unsafe extern "C" fn ks_pcie_mask_intx_irq(d: *mut irq_data) {
    static void ks_pcie_mask_intx_irq(struct irq_data *d)
    {
    }
#[no_mangle]
unsafe extern "C" fn ks_pcie_unmask_intx_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_setup_rc_app_regs(ks_pcie: *mut keystone_pcie) -> c_int {
    static int ks_pcie_setup_rc_app_regs(struct keystone_pcie *ks_pcie)
    {
    u32 val;
    let mut num_viewport: u32 = ks_pcie.num_viewport;
    struct dw_pcie *pci = ks_pcie.pci;
...
//
#[no_mangle]
unsafe extern "C" fn ks_pcie_link_up(pci: *mut dw_pcie) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_stop_link(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_start_link(pci: *mut dw_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_quirk(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_msi_irq_handler(desc: *mut irq_desc) {
    static void ks_pcie_msi_irq_handler(struct irq_desc *desc)
    {
    let mut irq: c_uint = desc.irq_data.hwirq;
    struct keystone_pcie *ks_pcie = irq_desc_get_handler_data(desc);
    let mut offset: u32 = irq - ks_pcie.msi_host_irq;
    struct dw_pcie *pci = ks_pcie.pci;
    struct dw_pcie_rp *pp = &pci.pp;
    struct device *dev = pci.dev;
...
//
#[no_mangle]
unsafe extern "C" fn ks_pcie_intx_irq_handler(desc: *mut irq_desc) {
    ...
    struct dw_pcie *pci = ks_pcie.pci;
    struct device *dev = pci.dev;
    let mut irq_offset: u32 = irq - ks_pcie.intx_host_irqs[0];
    struct irq_chip *chip = irq_desc_get_chip(desc);
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_config_msi_irq(ks_pcie: *mut keystone_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_config_intx_irq(ks_pcie: *mut keystone_pcie) -> c_int {
...
//
    ...
    &ks_pcie_intx_irq_domain_ops, core::ptr::null_mut());
    if (!intx_irq_domain) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_init_id(ks_pcie: *mut keystone_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_err_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_am654_ep_init(ep: *mut dw_pcie_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_am654_raise_intx_irq(ks_pcie: *mut keystone_pcie) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_disable_phy(ks_pcie: *mut keystone_pcie) {
    static void ks_pcie_disable_phy(struct keystone_pcie *ks_pcie)
    {
    let mut num_lanes: c_int = ks_pcie.num_lanes;
    while (num_lanes--) {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_enable_phy(ks_pcie: *mut keystone_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_set_mode(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_remove(pdev: *mut platform_device) {
...
//
    ...
    struct pt_regs *regs)
    {
    let mut instr: c_ulong = *(unsigned long *)instruction_pointer(regs);
...
#[no_mangle]
unsafe extern "C" fn ks_pcie_init() -> int __init {
...
// "External aborts"
//
    np = of_find_matching_node(core::ptr::null_mut(), ks_pcie_of_match);
    if (np) {
    of_node_put(np);
