...
//! Source: drivers/pci/controller/dwc/pcie-artpec6.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct artpec6_pcie {
    pub pci: *mut dw_pcie,
    pub /: *mut *mut *mut regmap regmap; / DT axis,syscon-pcie,
    pub /: *mut *mut *mut void __iomem phy_base; / DT phy,
    pub variant: enum artpec_pcie_variants,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct artpec_pcie_of_data {
    pub variant: enum artpec_pcie_variants,
...
pub const PCIECFG: c_uint = 0x18;

// ARTPEC-7 specific fields

pub const PCIESTAT: c_uint = 0x1c;
// ARTPEC-7 specific fields

pub const NOCCFG: c_uint = 0x40;

pub const PHY_STATUS: c_uint = 0x118;

pub const PHY_TX_ASIC_OUT: c_uint = 0x4040;

pub const PHY_RX_ASIC_OUT: c_uint = 0x405c;

#[no_mangle]
unsafe extern "C" fn artpec6_pcie_readl(artpec6_pcie: *mut artpec6_pcie, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_writel(artpec6_pcie: *mut artpec6_pcie, offset: u32, val: u32) {
    static void artpec6_pcie_writel(struct artpec6_pcie *artpec6_pcie, u32 offset, u32 val)
    {
    regmap_write(artpec6_pcie.regmap, offset, val);
    }
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_cpu_addr_fixup(pci: *mut dw_pcie, cpu_addr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_establish_link(pci: *mut dw_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_stop_link(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_wait_for_phy_a6(artpec6_pcie: *mut artpec6_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_wait_for_phy_a7(artpec6_pcie: *mut artpec6_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_wait_for_phy(artpec6_pcie: *mut artpec6_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_init_phy_a6(artpec6_pcie: *mut artpec6_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_init_phy_a7(artpec6_pcie: *mut artpec6_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_init_phy(artpec6_pcie: *mut artpec6_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_assert_core_reset(artpec6_pcie: *mut artpec6_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_deassert_core_reset(artpec6_pcie: *mut artpec6_pcie) {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_ep_init(ep: *mut dw_pcie_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn artpec6_pcie_probe(pdev: *mut platform_device) -> c_int {
