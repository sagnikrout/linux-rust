...
//! Source: drivers/pci/controller/dwc/pcie-stm32-ep.c
#![no_std]
...
pub struct stm32_pcie {
    ...
    pub perst_irq: c_uint,
}

#[no_mangle]
unsafe extern "C" fn stm32_pcie_start_link(pci: *mut dw_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_pcie_stop_link(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn stm32_pcie_enable_resources(stm32_pcie: *mut stm32_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_pcie_disable_resources(stm32_pcie: *mut stm32_pcie) {
...
#[no_mangle]
unsafe extern "C" fn stm32_pcie_perst_assert(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn stm32_pcie_perst_deassert(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn stm32_pcie_ep_perst_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_pcie_probe(pdev: *mut platform_device) -> c_int {
    ...
    "No syscfg specified\n");
    stm32_pcie.phy = devm_phy_get(dev, core::ptr::null_mut());
    if (IS_ERR(stm32_pcie.phy))
    return dev_err_probe(dev, PTR_ERR(stm32_pcie.phy),
    "failed to get pcie-phy\n");
    stm32_pcie.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(stm32_pcie.clk))
    return dev_err_probe(dev, PTR_ERR(stm32_pcie.clk),
    "Failed to get PCIe clock source\n");
    stm32_pcie.rst = devm_reset_control_get_exclusive(dev, core::ptr::null_mut());
...
// Will be enabled in start_link when device is initialized.
    ...
    ret = devm_request_threaded_irq(dev, stm32_pcie.perst_irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn stm32_pcie_remove(pdev: *mut platform_device) {
