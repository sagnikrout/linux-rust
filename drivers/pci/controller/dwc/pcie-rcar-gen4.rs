...
//! Source: drivers/pci/controller/dwc/pcie-rcar-gen4.c
#![no_std]
...
pub const PCIEMSR0: c_uint = 0x0000;

pub const DEVICE_TYPE_EP: c_int = 0;

// MSI Capability
pub const MSICAP0: c_uint = 0x0050;

// PCIe Interrupt Status 0
pub const PCIEINTSTS0: c_uint = 0x0084;
// PCIe Interrupt Status 0 Enable
pub const PCIEINTSTS0EN: c_uint = 0x0310;

// PCIe DMA Interrupt Status Enable
pub const PCIEDMAINTSTSEN: c_uint = 0x0314;

// Port Logic Registers 89
pub const PRTLGC89: c_uint = 0x0b70;
// Port Logic Registers 90
pub const PRTLGC90: c_uint = 0x0b74;
// PCIe Reset Control Register 1
pub const PCIERSTCTRL1: c_uint = 0x0014;

// INTC address
pub const AXIINTCADDR: c_uint = 0x0a00;
// INTC control & mask
pub const AXIINTCCONT: c_uint = 0x0a04;

// PCIe Power Management Control
pub const PCIEPWRMNGCTRL: c_uint = 0x0070;

pub const RCAR_NUM_SPEED_CHANGE_RETRIES: c_int = 10;
pub const RCAR_MAX_LINK_SPEED: c_int = 4;
pub const RCAR_GEN4_PCIE_EP_FUNC_DBI_OFFSET: c_uint = 0x1000;
pub const RCAR_GEN4_PCIE_EP_FUNC_DBI2_OFFSET: c_uint = 0x800;

pub const RCAR_GEN4_PCIE_FIRMWARE_BASE_ADDR: c_uint = 0xc000;
    MODULE_FIRMWARE(RCAR_GEN4_PCIE_FIRMWARE_NAME);
    struct rcar_gen4_pcie;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_gen4_pcie_drvdata {
    pub rcar): *mut *mut void (additional_common_init)(struct rcar_gen4_pcie,
    pub enable): *mut *mut *mut int (ltssm_control)(struct rcar_gen4_pcie rcar, bool,
    pub mode: enum dw_pcie_device_mode,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_gen4_pcie {
    pub dw: dw_pcie,
    pub base: *mut void __iomem,
    pub phy_base: *mut void __iomem,
    pub pdev: *mut platform_device,
    pub drvdata: *const rcar_gen4_pcie_drvdata,
}

// Common
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_link_up(dw: *mut dw_pcie) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_speed_change(dw: *mut dw_pcie) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_start_link(dw: *mut dw_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_stop_link(dw: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_common_init(rcar: *mut rcar_gen4_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_common_deinit(rcar: *mut rcar_gen4_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_prepare(rcar: *mut rcar_gen4_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_unprepare(rcar: *mut rcar_gen4_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_get_resources(rcar: *mut rcar_gen4_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_host_msi_addr(pp: *mut dw_pcie_rp, msi_addr: *mut u32) -> c_int {
    static int rcar_gen4_pcie_host_msi_addr(struct dw_pcie_rp *pp, u32 *msi_addr)
    {
    struct dw_pcie *dw = to_dw_pcie_from_pp(pp);
    struct device_node *msi_node = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_host_msi_init(pp: *mut dw_pcie_rp) -> c_int {
...
// Host mode
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_host_deinit(pp: *mut dw_pcie_rp) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_add_dw_pcie_rp(rcar: *mut rcar_gen4_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_remove_dw_pcie_rp(rcar: *mut rcar_gen4_pcie) {
...
// Endpoint mode
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_ep_pre_init(ep: *mut dw_pcie_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_ep_deinit(rcar: *mut rcar_gen4_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_add_dw_pcie_ep(rcar: *mut rcar_gen4_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_remove_dw_pcie_ep(rcar: *mut rcar_gen4_pcie) {
...
// Common
#[no_mangle]
unsafe extern "C" fn rcar_gen4_add_dw_pcie(rcar: *mut rcar_gen4_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_remove_dw_pcie(rcar: *mut rcar_gen4_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn r8a779f0_pcie_ltssm_control(rcar: *mut rcar_gen4_pcie, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_additional_common_init(rcar: *mut rcar_gen4_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_download_phy_firmware(rcar: *mut rcar_gen4_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_gen4_pcie_ltssm_control(rcar: *mut rcar_gen4_pcie, enable: bool) -> c_int {
