...
//! Source: drivers/pci/controller/dwc/pcie-uniphier-ep.c
#![no_std]
...
// Link Glue registers
pub const PCL_RSTCTRL0: c_uint = 0x0010;

pub const PCL_RSTCTRL1: c_uint = 0x0020;

pub const PCL_RSTCTRL2: c_uint = 0x0024;
...
pub const PCL_APP_CLK_CTRL: c_uint = 0x8004;

pub const PCL_APP_READY_CTRL: c_uint = 0x8008;

pub const PCL_APP_MSI0: c_uint = 0x8040;

pub const PCL_APP_MSI1: c_uint = 0x8044;

pub const PCL_APP_INTX: c_uint = 0x8074;

pub const PCL_APP_PM0: c_uint = 0x8078;

// assertion time of INTx in usec
pub const PCL_INTX_WIDTH_USEC: c_int = 30;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_pcie_ep_priv {
    pub base: *mut void __iomem,
    pub pci: dw_pcie,
    pub clk_gio: *mut *mut clk clk,,
    pub rst_gio: *mut *mut reset_control rst,,
    pub phy: *mut phy,
    pub data: *const uniphier_pcie_ep_soc_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_pcie_ep_soc_data {
    pub has_gio: bool,
    pub priv): *mut *mut void (init)(struct uniphier_pcie_ep_priv,
    pub priv): *mut *mut int (wait)(struct uniphier_pcie_ep_priv,
    pub features: pci_epc_features,
}
...
#[no_mangle]
unsafe extern "C" fn uniphier_pcie_pro5_init_ep(priv: *mut uniphier_pcie_ep_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_pcie_nx1_init_ep(priv: *mut uniphier_pcie_ep_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_pcie_nx1_wait_ep(priv: *mut uniphier_pcie_ep_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_pcie_ep_raise_intx_irq(ep: *mut dw_pcie_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_pcie_ep_enable(priv: *mut uniphier_pcie_ep_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_pcie_ep_probe(pdev: *mut platform_device) -> c_int {
