...
//! Source: drivers/pci/controller/dwc/pcie-spacemit-k1.c
#![no_std]
...
pub const K1_PHY_AHB_IRQ_EN: c_uint = 0x0000;

pub const K1_PHY_AHB_LINK_STS: c_uint = 0x0004;

pub const INTR_ENABLE: c_uint = 0x0014;

// Some controls require APMU regmap access

// Offsets and field definitions for APMU registers
pub const PCIE_CLK_RESET_CONTROL: c_uint = 0x0000;

pub const PCIE_CONTROL_LOGIC: c_uint = 0x0004;
...
pub struct k1_pcie {
    ...
    pub /: *mut *mut *mut regmap pmu; / Errors ignored; MMIO-backed regmap,
    pub pmu_off: u32,
}

    platform_get_drvdata(to_platform_device((dw_pcie).dev))
#[no_mangle]
unsafe extern "C" fn k1_pcie_toggle_soft_reset(k1: *mut k1_pcie) {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_enable_resources(k1: *mut k1_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_disable_resources(k1: *mut k1_pcie) {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_disable_aspm_l1(k1: *mut k1_pcie) {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_deinit(pp: *mut dw_pcie_rp) {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_link_up(pci: *mut dw_pcie) -> bool {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_start_link(pci: *mut dw_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_stop_link(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_parse_port(k1: *mut k1_pcie) -> c_int {
...
// We assume only one root port
    root_port = of_get_next_available_child(dev_of_node(dev), core::ptr::null_mut());
    if (!root_port)
    return -EINVAL;
    phy = devm_of_phy_get(dev, root_port, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k1_pcie_remove(pdev: *mut platform_device) {
