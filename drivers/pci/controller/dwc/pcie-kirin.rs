...
//! Source: drivers/pci/controller/dwc/pcie-kirin.c
#![no_std]
...
// PCIe ELBI registers
pub const SOC_PCIECTRL_CTRL0_ADDR: c_uint = 0x000;
pub const SOC_PCIECTRL_CTRL1_ADDR: c_uint = 0x004;

// info located in APB
pub const PCIE_APP_LTSSM_ENABLE: c_uint = 0x01c;
pub const PCIE_APB_PHY_STATUS0: c_uint = 0x400;
...
//
pub const MAX_PCI_SLOTS: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kirin_pcie {
    pub type: enum pcie_kirin_phy_type,
    pub pci: *mut dw_pcie,
    pub apb: *mut regmap,
    pub phy: *mut phy,
    pub /: *mut *mut *mut void phy_priv; / only for PCIE_KIRIN_INTERNAL_PHY,
// DWC PERST#
    pub id_dwc_perst_gpio: *mut gpio_desc,
// Per-slot PERST#
    pub num_slots: c_int,
    pub id_reset_gpio: [*mut gpio_desc; MAX_PCI_SLOTS],
    pub reset_names: [*const c_char; MAX_PCI_SLOTS],
// Per-slot clkreq
    pub n_gpio_clkreq: c_int,
    pub id_clkreq_gpio: [*mut gpio_desc; MAX_PCI_SLOTS],
    pub clkreq_names: [*const c_char; MAX_PCI_SLOTS],
}
...
pub const PCIE_APB_PHY_CTRL0: c_uint = 0x0;
pub const PCIE_APB_PHY_CTRL1: c_uint = 0x4;
pub const PCIE_APB_PHY_STATUS0: c_uint = 0x400;
...
// Time for delay
pub const REF_2_PERST_MIN: c_int = 21000;
pub const REF_2_PERST_MAX: c_int = 25000;
pub const PERST_2_ACCESS_MIN: c_int = 10000;
pub const PERST_2_ACCESS_MAX: c_int = 12000;
pub const PIPE_CLK_WAIT_MIN: c_int = 550;
pub const PIPE_CLK_WAIT_MAX: c_int = 600;
pub const TIME_CMOS_MIN: c_int = 100;
pub const TIME_CMOS_MAX: c_int = 105;
pub const TIME_PHY_PD_MIN: c_int = 10;
pub const TIME_PHY_PD_MAX: c_int = 11;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi3660_pcie_phy {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn hi3660_pcie_phy_get_clk(phy: *mut hi3660_pcie_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3660_pcie_phy_get_resource(phy: *mut hi3660_pcie_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3660_pcie_phy_start(phy: *mut hi3660_pcie_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3660_pcie_phy_oe_enable(phy: *mut hi3660_pcie_phy) {
...
#[no_mangle]
unsafe extern "C" fn hi3660_pcie_phy_clk_ctrl(phy: *mut hi3660_pcie_phy, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3660_pcie_phy_power_on(pcie: *mut kirin_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3660_pcie_phy_power_off(pcie: *mut kirin_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kirin_pcie_add_bus(bus: *mut pci_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kirin_pcie_link_up(pci: *mut dw_pcie) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kirin_pcie_start_link(pci: *mut dw_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kirin_pcie_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kirin_pcie_power_off(kirin_pcie: *mut kirin_pcie) -> c_int {
    ...
    kirin_pcie.phy = devm_of_phy_get(dev, dev.of_node, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn kirin_pcie_remove(pdev: *mut platform_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kirin_pcie_data {
    pub phy_type: enum pcie_kirin_phy_type,
}
...
#[no_mangle]
unsafe extern "C" fn kirin_pcie_probe(pdev: *mut platform_device) -> c_int {
