...
//! Source: drivers/pci/controller/dwc/pcie-fu740.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fu740_pcie {
    pub pci: dw_pcie,
    pub mgmt_base: *mut void __iomem,
    pub reset: *mut gpio_desc,
    pub pwren: *mut gpio_desc,
    pub pcie_aux: *mut clk,
    pub rst: *mut reset_control,
}

pub const SIFIVE_DEVICESRESETREG: c_uint = 0x28;
pub const PCIEX8MGMT_PERST_N: c_uint = 0x0;
pub const PCIEX8MGMT_APP_LTSSM_ENABLE: c_uint = 0x10;
pub const PCIEX8MGMT_APP_HOLD_PHY_RST: c_uint = 0x18;
pub const PCIEX8MGMT_DEVICE_TYPE: c_uint = 0x708;
pub const PCIEX8MGMT_PHY0_CR_PARA_ADDR: c_uint = 0x860;
pub const PCIEX8MGMT_PHY0_CR_PARA_RD_EN: c_uint = 0x870;
pub const PCIEX8MGMT_PHY0_CR_PARA_RD_DATA: c_uint = 0x878;
pub const PCIEX8MGMT_PHY0_CR_PARA_SEL: c_uint = 0x880;
pub const PCIEX8MGMT_PHY0_CR_PARA_WR_DATA: c_uint = 0x888;
pub const PCIEX8MGMT_PHY0_CR_PARA_WR_EN: c_uint = 0x890;
pub const PCIEX8MGMT_PHY0_CR_PARA_ACK: c_uint = 0x898;
pub const PCIEX8MGMT_PHY1_CR_PARA_ADDR: c_uint = 0x8a0;
pub const PCIEX8MGMT_PHY1_CR_PARA_RD_EN: c_uint = 0x8b0;
pub const PCIEX8MGMT_PHY1_CR_PARA_RD_DATA: c_uint = 0x8b8;
pub const PCIEX8MGMT_PHY1_CR_PARA_SEL: c_uint = 0x8c0;
pub const PCIEX8MGMT_PHY1_CR_PARA_WR_DATA: c_uint = 0x8c8;
pub const PCIEX8MGMT_PHY1_CR_PARA_WR_EN: c_uint = 0x8d0;
pub const PCIEX8MGMT_PHY1_CR_PARA_ACK: c_uint = 0x8d8;

    PCIEX8MGMT_PHY_LOS_THRSHLD|\
    PCIEX8MGMT_PHY_TERM_EN|\
    PCIEX8MGMT_PHY_TERM_ACDC|\
    PCIEX8MGMT_PHY_EN)
pub const PCIEX8MGMT_PHY_LANEN_DIG_ASIC_RX_OVRD_IN_3: c_uint = 0x1008;
pub const PCIEX8MGMT_PHY_LANE_OFF: c_uint = 0x100;

#[no_mangle]
unsafe extern "C" fn fu740_pcie_assert_reset(afp: *mut fu740_pcie) {
...
#[no_mangle]
unsafe extern "C" fn fu740_pcie_deassert_reset(afp: *mut fu740_pcie) {
...
#[no_mangle]
unsafe extern "C" fn fu740_pcie_power_on(afp: *mut fu740_pcie) {
...
#[no_mangle]
unsafe extern "C" fn fu740_pcie_drive_reset(afp: *mut fu740_pcie) {
...
#[no_mangle]
unsafe extern "C" fn fu740_pcie_init_phy(afp: *mut fu740_pcie) {
...
#[no_mangle]
unsafe extern "C" fn fu740_pcie_start_link(pci: *mut dw_pcie) -> c_int {
    static int fu740_pcie_start_link(struct dw_pcie *pci)
    {
    struct device *dev = pci.dev;
    struct fu740_pcie *afp = dev_get_drvdata(dev);
    let mut cap_exp: u8 = dw_pcie_find_capability(pci, PCI_CAP_ID_EXP);
    int ret;
    u32 orig, tmp;
//
...
#[no_mangle]
unsafe extern "C" fn fu740_pcie_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fu740_pcie_probe(pdev: *mut platform_device) -> c_int {
...
// Fetch reset
    afp.rst = devm_reset_control_get_exclusive(dev, core::ptr::null_mut());
    if (IS_ERR(afp.rst))
...
#[no_mangle]
unsafe extern "C" fn fu740_pcie_shutdown(pdev: *mut platform_device) {
