...
//! Source: drivers/pci/controller/dwc/pcie-dw-rockchip.c
#![no_std]
...
pub const PCIE_CLIENT_GENERAL_CON: c_uint = 0x0;

pub const PCIE_CLIENT_MODE_EP: c_uint = 0x0UL;
pub const PCIE_CLIENT_MODE_RC: c_uint = 0x4UL;

// Interrupt Status Register Related to Legacy Interrupt
pub const PCIE_CLIENT_INTR_STATUS_LEGACY: c_uint = 0x8;
// Interrupt Status Register Related to Miscellaneous Operation
pub const PCIE_CLIENT_INTR_STATUS_MISC: c_uint = 0x10;

// Interrupt Mask Register Related to Legacy Interrupt
pub const PCIE_CLIENT_INTR_MASK_LEGACY: c_uint = 0x1c;

    (PCIE_INTR_CLAMP((x)) << 16))

// Interrupt Mask Register Related to Miscellaneous Operation
pub const PCIE_CLIENT_INTR_MASK_MISC: c_uint = 0x24;
// Power Management Control Register
pub const PCIE_CLIENT_POWER_CON: c_uint = 0x2c;

// RASDES TBA information
pub const PCIE_CLIENT_CDM_RASDES_TBA_INFO_CMN: c_uint = 0x154;

// Debug FIFO information
pub const PCIE_CLIENT_DBG_FIFO_MODE_CON: c_uint = 0x310;
pub const PCIE_CLIENT_DBG_EN: c_uint = 0xffff0007;
pub const PCIE_CLIENT_DBG_DIS: c_uint = 0xffff0000;
pub const PCIE_CLIENT_DBG_FIFO_PTN_HIT_D0: c_uint = 0x320;
pub const PCIE_CLIENT_DBG_FIFO_PTN_HIT_D1: c_uint = 0x324;
pub const PCIE_CLIENT_DBG_FIFO_TRN_HIT_D0: c_uint = 0x328;
pub const PCIE_CLIENT_DBG_FIFO_TRN_HIT_D1: c_uint = 0x32c;
pub const PCIE_CLIENT_DBG_TRANSITION_DATA: c_uint = 0xffff0000;
pub const PCIE_CLIENT_DBG_FIFO_STATUS: c_uint = 0x350;

pub const PCIE_DBG_LTSSM_HISTORY_CNT: c_int = 64;
// Hot Reset Control Register
pub const PCIE_CLIENT_HOT_RESET_CTRL: c_uint = 0x180;

// LTSSM Status Register
pub const PCIE_CLIENT_LTSSM_STATUS: c_uint = 0x300;
pub const PCIE_LINKUP: c_uint = 0x3;

pub const PCIE_TYPE0_HDR_DBI2_OFFSET: c_uint = 0x100000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_pcie {
    ...
    pub data: *const rockchip_pcie_of_data,
    pub supports_clkreq: bool,
    pub trace_work: delayed_work,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_pcie_of_data {
    ...
    struct pci_dev *pdev);
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_readl_apb(rockchip: *mut rockchip_pcie, reg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_intx_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_intx_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_intx_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_init_irq_domain(rockchip: *mut rockchip_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_get_ltssm_reg(rockchip: *mut rockchip_pcie) -> u32 {
    static u32 rockchip_pcie_get_ltssm_reg(struct rockchip_pcie *rockchip)
    {
    return rockchip_pcie_readl_apb(rockchip, PCIE_CLIENT_LTSSM_STATUS);
    }
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_get_ltssm(pci: *mut dw_pcie) -> enum dw_pcie_ltssm {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_ltssm_trace_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: l1ss ==) -> else {
    else if (l1ss == 1)
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_enable_ltssm(rockchip: *mut rockchip_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_disable_ltssm(rockchip: *mut rockchip_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_link_up(pci: *mut dw_pcie) -> bool {
    static bool rockchip_pcie_link_up(struct dw_pcie *pci)
    {
    struct rockchip_pcie *rockchip = to_rockchip_pcie(pci);
    let mut val: u32 = rockchip_pcie_get_ltssm_reg(rockchip);
...
//
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_configure_l1ss(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_enable_l0s(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_start_link(pci: *mut dw_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_stop_link(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_ep_hide_broken_ats_cap_rk3588(ep: *mut dw_pcie_ep) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_ep_init(ep: *mut dw_pcie_ep) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_clk_init(rockchip: *mut rockchip_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_phy_init(rockchip: *mut rockchip_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_phy_deinit(rockchip: *mut rockchip_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_rc_sys_irq_thread(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_ep_sys_irq_thread(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rockchip_pcie_probe(pdev: *mut platform_device) -> c_int {
