...
//! Source: drivers/pci/controller/dwc/pcie-designware-debugfs.c
#![no_std]
...
pub const SD_STATUS_L1LANE_REG: c_uint = 0xb0;

pub const ERR_INJ0_OFF: c_uint = 0x34;

pub const EINJ_TYPE_SHIFT: c_int = 8;

pub const ERR_INJ_ENABLE_REG: c_uint = 0x30;
pub const RAS_DES_EVENT_COUNTER_DATA_REG: c_uint = 0xc;
pub const RAS_DES_EVENT_COUNTER_CTRL_REG: c_uint = 0x8;

pub const PER_EVENT_ON: c_uint = 0x3;
pub const PER_EVENT_OFF: c_uint = 0x1;
pub const DWC_DEBUGFS_BUF_MAX: c_int = 128;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc_pcie_rasdes_info {
    pub ras_cap_offset: u32,
    pub reg_event_lock: mutex,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc_pcie_rasdes_priv {
    pub pci: *mut dw_pcie,
    pub idx: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc_pcie_err_inj {
    pub name: *const c_char,
    pub err_inj_group: u32,
    pub err_inj_type: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dwc_pcie_event_counter {
    pub name: *const c_char,
    pub group_no: u32,
    pub event_no: u32,
}
...
#[no_mangle]
unsafe extern "C" fn dwc_pcie_rasdes_debugfs_deinit(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn dwc_pcie_rasdes_debugfs_init(pci: *mut dw_pcie, dir: *mut dentry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dwc_pcie_ltssm_debugfs_init(pci: *mut dw_pcie, dir: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_check_capability(drvdata: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_context_update_write(drvdata: *mut c_void, mode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_context_update_read(drvdata: *mut c_void, mode: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_context_valid_write(drvdata: *mut c_void, valid: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_context_valid_read(drvdata: *mut c_void, valid: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_local_clock_read(drvdata: *mut c_void, clock: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_master_clock_read(drvdata: *mut c_void, clock: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_t1_read(drvdata: *mut c_void, clock: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_t2_read(drvdata: *mut c_void, clock: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_t3_read(drvdata: *mut c_void, clock: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_t4_read(drvdata: *mut c_void, clock: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_context_update_visible(drvdata: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_context_valid_visible(drvdata: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_local_clock_visible(drvdata: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_master_clock_visible(drvdata: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_t1_visible(drvdata: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_t2_visible(drvdata: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_t3_visible(drvdata: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ptm_t4_visible(drvdata: *mut c_void) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn dwc_pcie_debugfs_deinit(pci: *mut dw_pcie) {
...
#[no_mangle]
pub unsafe extern "C" fn dwc_pcie_debugfs_init(pci: *mut dw_pcie, mode: enum dw_pcie_device_mode) {
...
// Create main directory for each platform driver.
    ...
    dir = debugfs_create_dir(dirname, core::ptr::null_mut());
