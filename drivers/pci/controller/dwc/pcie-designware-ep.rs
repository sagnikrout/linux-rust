...
//! Source: drivers/pci/controller/dwc/pcie-designware-ep.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_ep_reset_bar(pci: *mut dw_pcie, bar: enum pci_barno) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_find_capability(ep: *mut dw_pcie_ep, func_no: u8, cap: u8) -> u8 {
    static u8 dw_pcie_ep_find_capability(struct dw_pcie_ep *ep, u8 func_no, u8 cap)
    {
    return PCI_FIND_NEXT_CAP(dw_pcie_ep_read_cfg, PCI_CAPABILITY_LIST,
    cap, core::ptr::null_mut(), ep, func_no);
    }
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_clear_ib_maps(ep: *mut dw_pcie_ep, func_no: u8, bar: enum pci_barno) {
...
// Tear down all Address Match Mode mappings, if any.
    ...
    ep_func.ib_atu_indexes[bar] = core::ptr::null_mut();
    ...
    enum pci_barno bar, int flags)
    {
    let mut reg: u32 = PCI_BASE_ADDRESS_0 + (4 * bar);
    u32 lo, hi;
    u64 addr;
    ...
    {
    struct dw_pcie *pci = to_dw_pcie_from_ep(ep);
    let mut align: u32 = pci.region_align;
    let mut off: usize = 0;
    unsigned int i;
    size_t size;
...
// Address Match Mode inbound iATU mapping
    ...
    dw_pcie_ep_clear_ib_maps(ep, func_no, bar);
    ep_func.epf_bar[bar] = core::ptr::null_mut();
    }
    ...
    struct dw_pcie *pci = to_dw_pcie_from_ep(ep);
    let mut bar: enum pci_barno = epf_bar.barno;
    let mut size: usize = epf_bar.size;
...
// atu_index = index;
    ...
    struct dw_pcie_ep *ep = epc_get_drvdata(epc);
    struct dw_pcie *pci = to_dw_pcie_from_ep(ep);
    let mut mask: u64 = pci.region_align - 1;
    let mut ofst: usize = pci_addr & mask;
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_get_msi(epc: *mut pci_epc, func_no: u8, vfunc_no: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_get_msix(epc: *mut pci_epc, func_no: u8, vfunc_no: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_stop(epc: *mut pci_epc) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_start(epc: *mut pci_epc) -> c_int {
...
// bar_offset = r->offset;
    ...
    struct dw_edma_chip *edma = &pci.edma;
    let mut dma_ctrl_bar: enum pci_barno = NO_BAR;
    let mut db_offset: resource_size_t = edma.db_offset;
    let mut dma_ctrl_bar_offset: resource_size_t = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_ep_raise_intx_irq(ep: *mut dw_pcie_ep, func_no: u8) -> c_int {
...
//
    ...
    let mut map_size: usize = sizeof(u32);
    size_t offset;
...
//
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_ep_cleanup(ep: *mut dw_pcie_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_ep_deinit(ep: *mut dw_pcie_ep) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_init_rebar_registers(ep: *mut dw_pcie_ep, func_no: u8) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_init_non_sticky_registers(pci: *mut dw_pcie) {
    static void dw_pcie_ep_init_non_sticky_registers(struct dw_pcie *pci)
    {
    struct dw_pcie_ep *ep = &pci.ep;
    let mut funcs: u8 = ep.epc.max_functions;
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_disable_bars(ep: *mut dw_pcie_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_ep_init_registers(ep: *mut dw_pcie_ep) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_ep_linkup(ep: *mut dw_pcie_ep) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_ep_linkdown(ep: *mut dw_pcie_ep) {
...
#[no_mangle]
unsafe extern "C" fn dw_pcie_ep_get_resources(ep: *mut dw_pcie_ep) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dw_pcie_ep_init(ep: *mut dw_pcie_ep) -> c_int {
