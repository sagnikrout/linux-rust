...
//! Source: drivers/pci/controller/dwc/pci-imx6.c
#![no_std]
...
pub const IMX95_PCIE_PHY_GEN_CTRL: c_uint = 0x0;

pub const IMX95_PCIE_PHY_MPLLA_CTRL: c_uint = 0x10;

pub const IMX95_PCIE_SS_RW_REG_0: c_uint = 0xf0;

pub const IMX95_PCIE_SS_RW_REG_1: c_uint = 0xf4;

pub const IMX95_PE0_GEN_CTRL_1: c_uint = 0x1050;

pub const IMX95_PE0_GEN_CTRL_3: c_uint = 0x1058;

pub const IMX95_PE0_LUT_ACSCTRL: c_uint = 0x1008;

pub const IMX95_PE0_LUT_DATA1: c_uint = 0x100c;

pub const IMX95_PE0_LUT_DATA2: c_uint = 0x1010;

pub const IMX95_MAX_LUT: c_int = 32;
pub const IMX95_PCIE_RST_CTRL: c_uint = 0x3010;
...
pub const IMX_PCIE_MAX_INSTANCES: c_int = 2;
    struct imx_pcie;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_pcie_drvdata {
    pub variant: enum imx_pcie_variants,
    pub mode: enum dw_pcie_device_mode,
    pub flags: u32,
    pub dbi_length: c_int,
    pub gpr: *const c_char,
    pub ltssm_off: u32,
    pub ltssm_mask: u32,
    pub mode_off: [u32; IMX_PCIE_MAX_INSTANCES],
    pub mode_mask: [u32; IMX_PCIE_MAX_INSTANCES],
    pub epc_features: *const pci_epc_features,
    pub pcie): *mut *mut int (select_ref_clk_src)(struct imx_pcie,
    pub pcie): *mut *mut int (init_phy)(struct imx_pcie,
    pub enable): *mut *mut *mut int (enable_ref_clk)(struct imx_pcie pcie, bool,
    pub assert): *mut *mut *mut int (core_reset)(struct imx_pcie pcie, bool,
    pub pcie): *mut *mut int (wait_pll_lock)(struct imx_pcie,
    pub pcie): *mut *mut void (clr_clkreq_override)(struct imx_pcie,
    pub ops: *const dw_pcie_host_ops,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_lut_data {
    pub data1: u32,
    pub data2: u32,
}
...
pub struct imx_pcie {
    ...
    pub pciephy_reset: *mut reset_control,
    pub apps_reset: *mut reset_control,
    pub tx_deemph_gen1: u32,
    pub tx_deemph_gen2_3p5db: u32,
    pub tx_deemph_gen2_6db: u32,
    pub tx_swing_full: u32,
    pub tx_swing_low: u32,
    pub vpcie: *mut regulator,
    pub vpcie_aux: *mut regulator,
    pub vpcie_aux_enabled: bool,
    pub vph: *mut regulator,
    pub phy_base: *mut void __iomem,
// LUT data for pcie
    pub luts: [imx_lut_data; IMX95_MAX_LUT],
// power domain for pcie
    pub pd_pcie: *mut device,
// power domain for pcie phy
    pub pd_pcie_phy: *mut device,
    pub phy: *mut phy,
    pub drvdata: *const imx_pcie_drvdata,
// Ensure that only one device's LUT is configured at any given time
    pub lock: mutex,
}

// Parameters for the waiting for PCIe PHY PLL to lock on i.MX7
pub const PHY_PLL_LOCK_WAIT_USLEEP_MAX: c_int = 200;

// PCIe Port Logic registers (memory-mapped)
pub const PL_OFFSET: c_uint = 0x700;

// PHY registers (not memory-mapped)
pub const PCIE_PHY_ATEOVRD: c_uint = 0x10;

pub const PCIE_PHY_ATEOVRD_REF_CLKDIV_SHIFT: c_int = 0;
pub const PCIE_PHY_ATEOVRD_REF_CLKDIV_MASK: c_uint = 0x1;
pub const PCIE_PHY_MPLL_OVRD_IN_LO: c_uint = 0x11;
pub const PCIE_PHY_MPLL_MULTIPLIER_SHIFT: c_int = 2;
pub const PCIE_PHY_MPLL_MULTIPLIER_MASK: c_uint = 0x7f;

pub const PCIE_PHY_RX_ASIC_OUT: c_uint = 0x100D;

// iMX7 PCIe PHY registers
pub const PCIE_PHY_CMN_REG4: c_uint = 0x14;
// These are probably the bits that *aren't* DCC_FB_EN
pub const PCIE_PHY_CMN_REG4_DCC_FB_EN: c_uint = 0x29;
pub const PCIE_PHY_CMN_REG15: c_uint = 0x54;

pub const PCIE_PHY_CMN_REG24: c_uint = 0x90;

pub const PCIE_PHY_CMN_REG26: c_uint = 0x98;
pub const PCIE_PHY_CMN_REG26_ATT_MODE: c_uint = 0xBC;
pub const PHY_RX_OVRD_IN_LO: c_uint = 0x1005;

#[no_mangle]
unsafe extern "C" fn imx_pcie_grp_offset(imx_pcie: *const imx_pcie) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn imx95_pcie_select_ref_clk_src(imx_pcie: *mut imx_pcie) -> c_int {
    static int imx95_pcie_select_ref_clk_src(struct imx_pcie *imx_pcie)
    {
    let mut ext: bool = imx_pcie.enable_ext_refclk;
//
...
#[no_mangle]
unsafe extern "C" fn imx95_pcie_init_phy(imx_pcie: *mut imx_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_configure_type(imx_pcie: *mut imx_pcie) {
...
#[no_mangle]
unsafe extern "C" fn pcie_phy_poll_ack(imx_pcie: *mut imx_pcie, exp_val: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcie_phy_wait_ack(imx_pcie: *mut imx_pcie, addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcie_phy_read(imx_pcie: *mut imx_pcie, addr: c_int, data: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcie_phy_write(imx_pcie: *mut imx_pcie, addr: c_int, data: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mq_pcie_init_phy(imx_pcie: *mut imx_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_init_phy(imx_pcie: *mut imx_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx6sx_pcie_init_phy(imx_pcie: *mut imx_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7d_pcie_wait_for_phy_pll_lock(imx_pcie: *mut imx_pcie) {
...
#[no_mangle]
unsafe extern "C" fn imx95_pcie_wait_for_phy_pll_lock(imx_pcie: *mut imx_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_setup_phy_mpll(imx_pcie: *mut imx_pcie) -> c_int {
    static int imx_setup_phy_mpll(struct imx_pcie *imx_pcie)
    {
    let mut phy_rate: c_ulong = 0;
    int mult, div;
    u16 val;
    int i;
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_reset_phy(imx_pcie: *mut imx_pcie) {
...
// Added for PCI abort handling
    ...
    let mut instr: c_ulong = *(unsigned long *)pc;
    let mut reg: c_int = (instr >> 12) & 15;
//
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_attach_pd(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx6q_pcie_enable_ref_clk(imx_pcie: *mut imx_pcie, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8mm_pcie_clkreq_override(imx_pcie: *mut imx_pcie, enable: bool) {
    static void imx8mm_pcie_clkreq_override(struct imx_pcie *imx_pcie, bool enable)
    {
    let mut offset: c_int = imx_pcie_grp_offset(imx_pcie);
...
#[no_mangle]
unsafe extern "C" fn imx8mm_pcie_enable_ref_clk(imx_pcie: *mut imx_pcie, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7d_pcie_enable_ref_clk(imx_pcie: *mut imx_pcie, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx95_pcie_clkreq_override(imx_pcie: *mut imx_pcie, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn imx95_pcie_enable_ref_clk(imx_pcie: *mut imx_pcie, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_clk_disable(imx_pcie: *mut imx_pcie) {
...
#[no_mangle]
unsafe extern "C" fn imx6sx_pcie_core_reset(imx_pcie: *mut imx_pcie, assert: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx6qp_pcie_core_reset(imx_pcie: *mut imx_pcie, assert: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx6q_pcie_core_reset(imx_pcie: *mut imx_pcie, assert: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx7d_pcie_core_reset(imx_pcie: *mut imx_pcie, assert: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx95_pcie_core_reset(imx_pcie: *mut imx_pcie, assert: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_assert_core_reset(imx_pcie: *mut imx_pcie) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_deassert_core_reset(imx_pcie: *mut imx_pcie) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_wait_for_speed_change(imx_pcie: *mut imx_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_ltssm_enable(dev: *mut device) {
    static void imx_pcie_ltssm_enable(struct device *dev)
    {
    struct imx_pcie *imx_pcie = dev_get_drvdata(dev);
    const struct imx_pcie_drvdata *drvdata = imx_pcie.drvdata;
    let mut offset: u8 = dw_pcie_find_capability(imx_pcie.pci, PCI_CAP_ID_EXP);
    u32 tmp;
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_ltssm_disable(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_start_link(pci: *mut dw_pcie) -> c_int {
    static int imx_pcie_start_link(struct dw_pcie *pci)
    {
    struct imx_pcie *imx_pcie = to_imx_pcie(pci);
    struct device *dev = pci.dev;
    let mut offset: u8 = dw_pcie_find_capability(pci, PCI_CAP_ID_EXP);
    u32 tmp;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_stop_link(pci: *mut dw_pcie) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_add_lut(imx_pcie: *mut imx_pcie, rid: u16, sid: u8) -> c_int {
    static int imx_pcie_add_lut(struct imx_pcie *imx_pcie, u16 rid, u8 sid)
    {
    struct dw_pcie *pci = imx_pcie.pci;
    struct device *dev = pci.dev;
    u32 data1, data2;
    let mut free: c_int = -1;
    int i;
    if (sid >= 64) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_remove_lut(imx_pcie: *mut imx_pcie, rid: u16) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_add_lut_by_rid(imx_pcie: *mut imx_pcie, rid: u32) -> c_int {
    static int imx_pcie_add_lut_by_rid(struct imx_pcie *imx_pcie, u32 rid)
    {
    let mut iommu_spec: of_phandle_args = {};
    let mut msi_spec: of_phandle_args = {};
    struct device *dev = imx_pcie.pci.dev;
    struct device_node *msi_filter = core::ptr::null_mut();
    u32 sid_i, sid_m;
    int err_i, err_m;
    let mut sid: u32 = 0;
...
//
    ...
    sid = sid_i;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !err_m) -> else {
    else if (!err_m)
    sid = sid_m & IMX95_SID_MASK;
    return imx_pcie_add_lut(imx_pcie, rid, sid);
    }
#[no_mangle]
unsafe extern "C" fn imx_pcie_enable_device(bridge: *mut pci_host_bridge, pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_parse_legacy_binding(pcie: *mut imx_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_vpcie_aux_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_assert_perst(imx_pcie: *mut imx_pcie, assert: bool) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_perst_found(bridge: *mut pci_host_bridge) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_host_init(pp: *mut dw_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_host_exit(pp: *mut dw_pcie_rp) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_host_post_init(pp: *mut dw_pcie_rp) {
...
//
#[no_mangle]
unsafe extern "C" fn imx_pcie_pme_turn_off(pp: *mut dw_pcie_rp) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_msi_save_restore(imx_pcie: *mut imx_pcie, save: bool) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_lut_save(imx_pcie: *mut imx_pcie) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_lut_restore(imx_pcie: *mut imx_pcie) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_probe(pdev: *mut platform_device) -> c_int {
...
// Limit link speed
    ...
    imx_pcie.vpcie_aux = core::ptr::null_mut();
    }
    imx_pcie.vpcie = devm_regulator_get_optional(&pdev.dev, "vpcie");
    if (IS_ERR(imx_pcie.vpcie)) {
    if (PTR_ERR(imx_pcie.vpcie) != -ENODEV)
    return PTR_ERR(imx_pcie.vpcie);
    imx_pcie.vpcie = core::ptr::null_mut();
    }
    ...
    imx_pcie.vph = core::ptr::null_mut();
    }
...
//
    ...
    goto err_pwrctrl_destroy;
    if (pci_msi_enabled()) {
    let mut offset: u8 = dw_pcie_find_capability(pci, PCI_CAP_ID_MSI);
    val = dw_pcie_readw_dbi(pci, offset + PCI_MSI_FLAGS);
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_quirk(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn imx_pcie_init() -> int __init {
    static int __init imx_pcie_init(void)
    {

    struct device_node *np;
    np = of_find_matching_node(core::ptr::null_mut(), imx_pcie_of_match);
    if (!np)
    return -ENODEV;
    of_node_put(np);
//
