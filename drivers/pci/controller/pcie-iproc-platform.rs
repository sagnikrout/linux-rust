...
//! Source: drivers/pci/controller/pcie-iproc-platform.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn iproc_pltfm_pcie_probe(pdev: *mut platform_device) -> c_int {
...
// PAXC doesn't support legacy IRQs, skip mapping
    ...
    bridge.map_irq = core::ptr::null_mut();
    break;
    default:
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn iproc_pltfm_pcie_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn iproc_pltfm_pcie_shutdown(pdev: *mut platform_device) {
