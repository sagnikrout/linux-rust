...
//! Source: drivers/pci/controller/cadence/pcie-cadence-host.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_disable_ptm_response(pcie: *mut cdns_pcie) {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_enable_ptm_response(pcie: *mut cdns_pcie) {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_deinit_root_port(rc: *mut cdns_pcie_rc) {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_init_root_port(rc: *mut cdns_pcie_rc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_unmap_dma_ranges(rc: *mut cdns_pcie_rc) {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_deinit_address_translation(rc: *mut cdns_pcie_rc) {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_init_address_translation(rc: *mut cdns_pcie_rc) -> c_int {
    ...
    struct resource_entry *entry;
    let mut cpu_addr: u64 = cfg_res.start;
...
//
    ...
    let mut pci_addr: u64 = res.start - entry.offset;
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_deinit(rc: *mut cdns_pcie_rc) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_host_init(rc: *mut cdns_pcie_rc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_host_link_disable(rc: *mut cdns_pcie_rc) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_host_link_setup(rc: *mut cdns_pcie_rc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_host_disable(rc: *mut cdns_pcie_rc) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_host_setup(rc: *mut cdns_pcie_rc) -> c_int {
