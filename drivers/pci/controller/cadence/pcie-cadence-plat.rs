...
//! Source: drivers/pci/controller/cadence/pcie-cadence-plat.c
#![no_std]
...
pub const CDNS_PLAT_CPU_TO_BUS_ADDR: c_uint = 0x0FFFFFFF;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdns_plat_pcie {
    pub pcie: *mut cdns_pcie,
}

    static const struct of_device_id cdns_plat_pcie_of_match[];
#[no_mangle]
unsafe extern "C" fn cdns_plat_cpu_addr_fixup(pcie: *mut cdns_pcie, cpu_addr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn cdns_plat_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_plat_pcie_shutdown(pdev: *mut platform_device) {
