...
//! Source: drivers/pci/controller/cadence/pcie-cadence-hpa.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_hpa_link_up(pcie: *mut cdns_pcie) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_hpa_detect_quiet_min_delay_set(pcie: *mut cdns_pcie) {
    void cdns_pcie_hpa_detect_quiet_min_delay_set(struct cdns_pcie *pcie)
    {
    let mut delay: u32 = 0x3;
...
// for 64bit values
//
    let mut sz: u64 = 1ULL << fls64(size - 1);
    let mut nbits: c_int = ilog2(sz);
