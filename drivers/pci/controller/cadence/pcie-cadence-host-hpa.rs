...
//! Source: drivers/pci/controller/cadence/pcie-cadence-host-hpa.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_hpa_host_enable_ptm_response(pcie: *mut cdns_pcie) {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_hpa_host_init_root_port(rc: *mut cdns_pcie_rc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_hpa_create_region_for_cfg(rc: *mut cdns_pcie_rc) {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_hpa_host_init_address_translation(rc: *mut cdns_pcie_rc) -> c_int {
    static int cdns_pcie_hpa_host_init_address_translation(struct cdns_pcie_rc *rc)
    {
    struct cdns_pcie *pcie = &rc.pcie;
    struct pci_host_bridge *bridge = pci_host_bridge_from_priv(rc);
    struct resource_entry *entry;
    let mut r: c_int = 0, busnr = 0;
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_hpa_host_init(rc: *mut cdns_pcie_rc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_hpa_host_link_setup(rc: *mut cdns_pcie_rc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_hpa_host_disable(rc: *mut cdns_pcie_rc) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_hpa_host_setup(rc: *mut cdns_pcie_rc) -> c_int {
