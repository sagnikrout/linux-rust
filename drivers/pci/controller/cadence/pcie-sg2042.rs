...
//! Source: drivers/pci/controller/cadence/pcie-sg2042.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sg2042_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sg2042_pcie_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sg2042_pcie_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sg2042_pcie_resume_noirq(dev: *mut device) -> c_int {
