...
//! Source: drivers/pci/controller/cadence/pcie-cadence-ep.c
#![no_std]
...
pub const CDNS_PCIE_EP_IRQ_PCI_ADDR_NONE: c_uint = 0x1;
pub const CDNS_PCIE_EP_IRQ_PCI_ADDR_LEGACY: c_uint = 0x3;
#[no_mangle]
unsafe extern "C" fn cdns_pcie_get_fn_from_vfn(pcie: *mut cdns_pcie, fn: u8, vfn: u8) -> u8 {
...
pub unsafe extern "C" fn if(_arg: is_64bits) -> else {
    ...
    if (vfn > 0)
    epf = &epf.epf[vfn - 1];
    epf.epf_bar[bar] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_ep_set_msi(epc: *mut pci_epc, fn: u8, vfn: u8, nr_irqs: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_ep_get_msi(epc: *mut pci_epc, fn: u8, vfn: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_ep_get_msix(epc: *mut pci_epc, func_no: u8, vfunc_no: u8) -> c_int {
...
// msi_addr_offset = pci_addr & pci_addr_mask;
    ...
    let mut pci_addr_mask: u64 = 0xff;
    u64 msg_addr;
    u8 bir, cap;
    u16 flags;
    cap = cdns_pcie_find_capability(pcie, PCI_CAP_ID_MSIX);
...
#[no_mangle]
unsafe extern "C" fn cdns_pcie_ep_start(epc: *mut pci_epc) -> c_int {
    static int cdns_pcie_ep_start(struct pci_epc *epc)
    {
    struct cdns_pcie_ep *ep = epc_get_drvdata(epc);
    struct cdns_pcie *pcie = &ep.pcie;
    struct device *dev = pcie.dev;
    let mut max_epfs: c_int = sizeof(epc.function_num_map) * 8;
    int ret, epf, last_fn;
    u32 reg, value;
    u8 cap;
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_ep_disable(ep: *mut cdns_pcie_ep) {
...
#[no_mangle]
pub unsafe extern "C" fn cdns_pcie_ep_setup(ep: *mut cdns_pcie_ep) -> c_int {
