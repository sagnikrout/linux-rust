...
//! Source: drivers/pci/controller/pcie-rcar-host.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_pcie_host {
    pub pcie: rcar_pcie,
    pub phy: *mut phy,
    pub bus_clk: *mut clk,
    pub msi: rcar_msi,
    pub host): *mut *mut int (phy_init_fn)(struct rcar_pcie_host,
}

#[no_mangle]
unsafe extern "C" fn rcar_pcie_wakeup(pcie_dev: *mut device, pcie_base: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_read_conf(pcie: *mut rcar_pcie, where: c_int) -> u32 {
    static u32 rcar_read_conf(struct rcar_pcie *pcie, int where)
    {
    let mut shift: c_uint = BITS_PER_BYTE * (where & 3);
    let mut val: u32 = rcar_pci_read_reg(pcie, where & ~3);
    return val >> shift;
    }
    ...
    unsigned int reg)
    {
    let mut error: c_int = PCIBIOS_SUCCESSFUL;
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_force_speedup(pcie: *mut rcar_pcie) {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_hw_enable(host: *mut rcar_pcie_host) {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_enable(host: *mut rcar_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phy_wait_for_ack(pcie: *mut rcar_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_hw_init(pcie: *mut rcar_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_phy_init_h1(host: *mut rcar_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_phy_init_gen2(host: *mut rcar_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_phy_init_gen3(host: *mut rcar_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_msi_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// MSI & INTx share an interrupt - we only handle MSI here
    ...
    return IRQ_NONE;
    while (reg) {
    let mut index: c_uint = find_first_bit(&reg, 32);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rcar_msi_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rcar_msi_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rcar_msi_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rcar_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn rcar_allocate_domains(msi: *mut rcar_msi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_free_domains(msi: *mut rcar_msi) {
    static void rcar_free_domains(struct rcar_msi *msi)
    {
    irq_domain_remove(msi.domain);
    }
#[no_mangle]
unsafe extern "C" fn rcar_pcie_enable_msi(host: *mut rcar_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_teardown_msi(host: *mut rcar_pcie_host) {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_get_resources(host: *mut rcar_pcie_host) -> c_int {
    ...
    int *index)
    {
    let mut restype: u64 = entry.res.flags;
    let mut cpu_addr: u64 = entry.res.start;
    let mut cpu_end: u64 = entry.res.end;
    let mut pci_addr: u64 = entry.res.start - entry.offset;
    let mut flags: u32 = LAM_64BIT | LAR_ENABLE;
    u64 mask;
    let mut size: u64 = resource_size(entry.res);
    let mut idx: c_int = *index;
...
//
    if (cpu_addr > 0) {
    let mut nr_zeros: c_ulong = __ffs64(cpu_addr);
    let mut alignment: u64 = 1ULL << nr_zeros;
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_parse_map_dma_ranges(host: *mut rcar_pcie_host) -> c_int {
    static int rcar_pcie_parse_map_dma_ranges(struct rcar_pcie_host *host)
    {
    struct pci_host_bridge *bridge = pci_host_bridge_from_priv(host);
    struct resource_entry *entry;
    let mut index: c_int = 0, err = 0;
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_resume_noirq(dev: *mut device) -> c_int {
...
// Re-establish the PCIe link
    ...
    SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), rcar_pcie_resume)
...
#[no_mangle]
unsafe extern "C" fn rcar_pcie_init() -> int __init {
    static int __init rcar_pcie_init(void)
    {
    if (of_find_matching_node(core::ptr::null_mut(), rcar_pcie_abort_handler_of_match)) {
