...
//! Source: drivers/pci/controller/pci-v3-semi.c
#![no_std]
...
pub const V3_PCI_VENDOR: c_uint = 0x00000000;
pub const V3_PCI_DEVICE: c_uint = 0x00000002;
pub const V3_PCI_CMD: c_uint = 0x00000004;
pub const V3_PCI_STAT: c_uint = 0x00000006;
pub const V3_PCI_CC_REV: c_uint = 0x00000008;
pub const V3_PCI_HDR_CFG: c_uint = 0x0000000C;
pub const V3_PCI_IO_BASE: c_uint = 0x00000010;
pub const V3_PCI_BASE0: c_uint = 0x00000014;
pub const V3_PCI_BASE1: c_uint = 0x00000018;
pub const V3_PCI_SUB_VENDOR: c_uint = 0x0000002C;
pub const V3_PCI_SUB_ID: c_uint = 0x0000002E;
pub const V3_PCI_ROM: c_uint = 0x00000030;
pub const V3_PCI_BPARAM: c_uint = 0x0000003C;
pub const V3_PCI_MAP0: c_uint = 0x00000040;
pub const V3_PCI_MAP1: c_uint = 0x00000044;
pub const V3_PCI_INT_STAT: c_uint = 0x00000048;
pub const V3_PCI_INT_CFG: c_uint = 0x0000004C;
pub const V3_LB_BASE0: c_uint = 0x00000054;
pub const V3_LB_BASE1: c_uint = 0x00000058;
pub const V3_LB_MAP0: c_uint = 0x0000005E;
pub const V3_LB_MAP1: c_uint = 0x00000062;
pub const V3_LB_BASE2: c_uint = 0x00000064;
pub const V3_LB_MAP2: c_uint = 0x00000066;
pub const V3_LB_SIZE: c_uint = 0x00000068;
pub const V3_LB_IO_BASE: c_uint = 0x0000006E;
pub const V3_FIFO_CFG: c_uint = 0x00000070;
pub const V3_FIFO_PRIORITY: c_uint = 0x00000072;
pub const V3_FIFO_STAT: c_uint = 0x00000074;
pub const V3_LB_ISTAT: c_uint = 0x00000076;
pub const V3_LB_IMASK: c_uint = 0x00000077;
pub const V3_SYSTEM: c_uint = 0x00000078;
pub const V3_LB_CFG: c_uint = 0x0000007A;
pub const V3_PCI_CFG: c_uint = 0x0000007C;
pub const V3_DMA_PCI_ADR0: c_uint = 0x00000080;
pub const V3_DMA_PCI_ADR1: c_uint = 0x00000090;
pub const V3_DMA_LOCAL_ADR0: c_uint = 0x00000084;
pub const V3_DMA_LOCAL_ADR1: c_uint = 0x00000094;
pub const V3_DMA_LENGTH0: c_uint = 0x00000088;
pub const V3_DMA_LENGTH1: c_uint = 0x00000098;
pub const V3_DMA_CSR0: c_uint = 0x0000008B;
pub const V3_DMA_CSR1: c_uint = 0x0000009B;
pub const V3_DMA_CTLB_ADR0: c_uint = 0x0000008C;
pub const V3_DMA_CTLB_ADR1: c_uint = 0x0000009C;
pub const V3_DMA_DELAY: c_uint = 0x000000E0;
pub const V3_MAIL_DATA: c_uint = 0x000000C0;
pub const V3_PCI_MAIL_IEWR: c_uint = 0x000000D0;
pub const V3_PCI_MAIL_IERD: c_uint = 0x000000D2;
pub const V3_LB_MAIL_IEWR: c_uint = 0x000000D4;
pub const V3_LB_MAIL_IERD: c_uint = 0x000000D6;
pub const V3_MAIL_WR_STAT: c_uint = 0x000000D8;
pub const V3_MAIL_RD_STAT: c_uint = 0x000000DA;
pub const V3_QBA_MAP: c_uint = 0x000000DC;
// PCI STATUS bits
...
pub const V3_SYSTEM_UNLOCK: c_uint = 0xa05f;
// PCI CFG bits
...
// during DMA access.
//
pub const V3_PCI_CFG_M_RTYPE_SHIFT: c_int = 5;
pub const V3_PCI_CFG_M_WTYPE_SHIFT: c_int = 1;
pub const V3_PCI_CFG_TYPE_DEFAULT: c_uint = 0x3;
// PCI BASE bits (PCI -> Local Bus)
pub const V3_PCI_BASE_M_ADR_BASE: c_uint = 0xFFF00000U;
pub const V3_PCI_BASE_M_ADR_BASEL: c_uint = 0x000FFF00U;

// PCI MAP bits (PCI -> Local bus)
pub const V3_PCI_MAP_M_MAP_ADR: c_uint = 0xFFF00000U;

pub const V3_PCI_MAP_M_ADR_SIZE: c_uint = 0x000000F0U;

// LB_BASE0,1 bits (Local bus -> PCI)
pub const V3_LB_BASE_ADR_BASE: c_uint = 0xfff00000U;

// LB_MAP0,1 bits (Local bus -> PCI)
pub const V3_LB_MAP_MAP_ADR: c_uint = 0xfff0U;

// LB_BASE2 bits (Local bus -> PCI IO)
pub const V3_LB_BASE2_ADR_BASE: c_uint = 0xff00U;

// LB_MAP2 bits (Local bus -> PCI IO)
pub const V3_LB_MAP2_MAP_ADR: c_uint = 0xff00U;

// FIFO priority bits

// Local bus configuration bits
pub const V3_LB_CFG_LB_TO_64_CYCLES: c_uint = 0x0000;

// ARM Integrator-specific extended control registers
pub const INTEGRATOR_SC_PCI_OFFSET: c_uint = 0x18;

pub const INTEGRATOR_SC_LBFADDR_OFFSET: c_uint = 0x20;
pub const INTEGRATOR_SC_LBFCODE_OFFSET: c_uint = 0x24;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v3_pci {
    pub dev: *mut device,
    ...
    pub non_pre_mem: u32,
    pub pre_mem: u32,
    pub non_pre_bus_addr: phys_addr_t,
    pub pre_bus_addr: phys_addr_t,
    pub map: *mut regmap,
}
...
//
    ...
    busnr = bus.number;
    if (busnr == 0) {
    let mut slot: c_int = PCI_SLOT(devfn);
//
...
#[no_mangle]
unsafe extern "C" fn v3_unmap_bus(v3: *mut v3_pci) {
...
#[no_mangle]
unsafe extern "C" fn v3_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn v3_integrator_init(v3: *mut v3_pci) -> c_int {
...
// Setup window 0 - PCI non-prefetchable memory
    ...
    let mut pci_end: u64 = cpu_end - entry.offset;
...
#[no_mangle]
unsafe extern "C" fn v3_pci_probe(pdev: *mut platform_device) -> c_int {
