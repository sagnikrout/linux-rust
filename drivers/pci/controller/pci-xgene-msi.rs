...
//! Source: drivers/pci/controller/pci-xgene-msi.c
#![no_std]
...
pub const MSI_IR0: c_uint = 0x000000;
pub const MSI_INT0: c_uint = 0x800000;
pub const IDX_PER_GROUP: c_int = 8;
pub const IRQS_PER_IDX: c_int = 16;
pub const NR_HW_IRQS: c_int = 16;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_msi {
    pub inner_domain: *mut irq_domain,
    pub msi_addr: u64,
    pub msi_regs: *mut void __iomem,
    pub bitmap: *mut c_ulong,
    pub bitmap_lock: mutex,
    pub gic_irq: [c_uint; NR_HW_IRQS],
}
...
// MSInIRx read helper
#[no_mangle]
unsafe extern "C" fn xgene_msi_ir_read(msi: *mut xgene_msi, msi_grp: u32, msir_idx: u32) -> u32 {
...
// MSIINTn read helper
#[no_mangle]
unsafe extern "C" fn xgene_msi_int_read(msi: *mut xgene_msi, msi_grp: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn compute_hwirq(frame: u8, index: u8, data: u8) -> irq_hw_number_t {
...
#[no_mangle]
unsafe extern "C" fn xgene_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn xgene_msi_init_allocator(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_msi_isr(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn xgene_msi_remove(pdev: *mut platform_device) {
    static void xgene_msi_remove(struct platform_device *pdev)
    {
    for (int i = 0; i < NR_HW_IRQS; i++) {
    let mut irq: c_uint = xgene_msi_ctrl.gic_irq[i];
    if (!irq)
    continue;
...
#[no_mangle]
unsafe extern "C" fn xgene_msi_handler_setup(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_msi_probe(pdev: *mut platform_device) -> c_int {
