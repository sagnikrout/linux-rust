...
//! Source: drivers/pci/controller/pcie-tegra264.c
#![no_std]
...
// XAL registers
pub const XAL_RC_ECAM_BASE_HI: c_uint = 0x00;
pub const XAL_RC_ECAM_BASE_LO: c_uint = 0x04;
pub const XAL_RC_ECAM_BUSMASK: c_uint = 0x08;
pub const XAL_RC_IO_BASE_HI: c_uint = 0x0c;
pub const XAL_RC_IO_BASE_LO: c_uint = 0x10;
pub const XAL_RC_IO_LIMIT_HI: c_uint = 0x14;
pub const XAL_RC_IO_LIMIT_LO: c_uint = 0x18;
pub const XAL_RC_MEM_32BIT_BASE_HI: c_uint = 0x1c;
pub const XAL_RC_MEM_32BIT_BASE_LO: c_uint = 0x20;
pub const XAL_RC_MEM_32BIT_LIMIT_HI: c_uint = 0x24;
pub const XAL_RC_MEM_32BIT_LIMIT_LO: c_uint = 0x28;
pub const XAL_RC_MEM_64BIT_BASE_HI: c_uint = 0x2c;
pub const XAL_RC_MEM_64BIT_BASE_LO: c_uint = 0x30;
pub const XAL_RC_MEM_64BIT_LIMIT_HI: c_uint = 0x34;
pub const XAL_RC_MEM_64BIT_LIMIT_LO: c_uint = 0x38;
pub const XAL_RC_BAR_CNTL_STANDARD: c_uint = 0x40;

// XTL registers
pub const XTL_RC_PCIE_CFG_LINK_CAPS: c_uint = 0x56;
pub const XTL_RC_PCIE_CFG_LINK_STATUS: c_uint = 0x5a;
pub const XTL_RC_MGMT_PERST_CONTROL: c_uint = 0x218;

pub const XTL_RC_MGMT_CLOCK_CONTROL: c_uint = 0x47c;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra264_pcie {
    pub dev: *mut device,
// I/O memory
    pub xal: *mut void __iomem,
    pub xtl: *mut void __iomem,
    pub ecam: *mut void __iomem,
...
#[no_mangle]
unsafe extern "C" fn tegra264_pcie_power_off(pcie: *mut tegra264_pcie) {
    static void tegra264_pcie_power_off(struct tegra264_pcie *pcie)
    {
    let mut msg: tegra_bpmp_message = {};
    let mut req: mrq_pcie_request = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn tegra264_pcie_icc_set(pcie: *mut tegra264_pcie) {
...
//
#[no_mangle]
unsafe extern "C" fn tegra264_pcie_valid_ranges(pdev: *mut platform_device) -> bool {
    ...
    let mut type: c_ulong = range.flags & IORESOURCE_TYPE_BITS;
    phys_addr_t start, end, mask;
    const char *region = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tegra264_pcie_supports_hotplug(pcie: *mut tegra264_pcie) -> bool {
    static bool tegra264_pcie_supports_hotplug(struct tegra264_pcie *pcie)
    {
    let mut value: u32 = readl(pcie.xtl + XTL_RC_MGMT_CLOCK_CONTROL);
    ...
    {
    let mut value: u16 = readw(pcie.ecam + XTL_RC_PCIE_CFG_LINK_STATUS);
...
#[no_mangle]
unsafe extern "C" fn tegra264_pcie_init(pcie: *mut tegra264_pcie) {
...
// bring the endpoint out of reset
    ...
    if (tegra264_pcie_link_up(pcie, core::ptr::null_mut()))
    break;
...
#[no_mangle]
unsafe extern "C" fn tegra264_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra264_pcie_remove(pdev: *mut platform_device) {
