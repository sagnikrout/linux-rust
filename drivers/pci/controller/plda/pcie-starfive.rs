...
//! Source: drivers/pci/controller/plda/pcie-starfive.c
#![no_std]
...
pub const PCIE_FUNC_NUM: c_int = 4;
// system control
pub const STG_SYSCON_PCIE0_BASE: c_uint = 0x48;
pub const STG_SYSCON_PCIE1_BASE: c_uint = 0x1f8;
pub const STG_SYSCON_AR_OFFSET: c_uint = 0x78;

pub const STG_SYSCON_AW_OFFSET: c_uint = 0x7c;

pub const STG_SYSCON_RP_NEP_OFFSET: c_uint = 0xe8;

pub const STG_SYSCON_LNKSTA_OFFSET: c_uint = 0x170;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct starfive_jh7110_pcie {
    pub plda: plda_pcie_rp,
    pub resets: *mut reset_control,
    pub clks: *mut clk_bulk_data,
    pub reg_syscon: *mut regmap,
    pub vpcie3v3: *mut regulator,
    pub reset_gpio: *mut gpio_desc,
    pub phy: *mut phy,
    pub stg_pcie_base: c_uint,
    pub num_clks: c_int,
}
...
// value = 0;
    ...
    pcie.phy = devm_phy_optional_get(dev, core::ptr::null_mut());
    if (IS_ERR(pcie.phy))
...
//
    ...
    pcie.vpcie3v3 = core::ptr::null_mut();
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_clk_rst_init(pcie: *mut starfive_jh7110_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_clk_rst_deinit(pcie: *mut starfive_jh7110_pcie) {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_link_up(plda: *mut plda_pcie_rp) -> bool {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_host_wait_for_link(pcie: *mut starfive_jh7110_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_disable_phy(pcie: *mut starfive_jh7110_pcie) {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_host_deinit(plda: *mut plda_pcie_rp) {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_host_init(plda: *mut plda_pcie_rp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_pcie_resume_noirq(dev: *mut device) -> c_int {
