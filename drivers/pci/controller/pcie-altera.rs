...
//! Source: drivers/pci/controller/pcie-altera.c
#![no_std]
...
pub const RP_TX_REG0: c_uint = 0x2000;
pub const RP_TX_REG1: c_uint = 0x2004;
pub const RP_TX_CNTRL: c_uint = 0x2008;
pub const RP_TX_EOP: c_uint = 0x2;
pub const RP_TX_SOP: c_uint = 0x1;
pub const RP_RXCPL_STATUS: c_uint = 0x2010;
pub const RP_RXCPL_EOP: c_uint = 0x2;
pub const RP_RXCPL_SOP: c_uint = 0x1;
pub const RP_RXCPL_REG0: c_uint = 0x2014;
pub const RP_RXCPL_REG1: c_uint = 0x2018;
pub const P2A_INT_STATUS: c_uint = 0x3060;
pub const P2A_INT_STS_ALL: c_uint = 0xf;
pub const P2A_INT_ENABLE: c_uint = 0x3070;
pub const P2A_INT_ENA_ALL: c_uint = 0xf;
pub const RP_LTSSM: c_uint = 0x3c64;
pub const RP_LTSSM_MASK: c_uint = 0x1f;
pub const LTSSM_L0: c_uint = 0xf;
pub const S10_RP_TX_CNTRL: c_uint = 0x2004;
pub const S10_RP_RXCPL_REG: c_uint = 0x2008;
pub const S10_RP_RXCPL_STATUS: c_uint = 0x200C;

    (((pcie).hip_base) + (reg) + (1 << 20))

    readb(S10_RP_CFG_ADDR(pcie, PCI_SECONDARY_BUS))
// TLP configuration type 0 and 1
pub const TLP_FMTTYPE_CFGRD0: c_uint = 0x04	/* Configuration Read Type 0 */;
pub const TLP_FMTTYPE_CFGWR0: c_uint = 0x44	/* Configuration Write Type 0 */;
pub const TLP_FMTTYPE_CFGRD1: c_uint = 0x05	/* Configuration Read Type 1 */;
pub const TLP_FMTTYPE_CFGWR1: c_uint = 0x45	/* Configuration Write Type 1 */;
pub const TLP_PAYLOAD_SIZE: c_uint = 0x01;
pub const TLP_READ_TAG: c_uint = 0x1d;
pub const TLP_WRITE_TAG: c_uint = 0x10;
pub const RP_DEVFN: c_int = 0;
...
pub const TLP_HDR_SIZE: c_int = 3;
pub const TLP_LOOP: c_int = 500;

pub const DWORD_MASK: c_int = 3;
pub const S10_TLP_FMTTYPE_CFGRD0: c_uint = 0x05;
pub const S10_TLP_FMTTYPE_CFGRD1: c_uint = 0x04;
pub const S10_TLP_FMTTYPE_CFGWR0: c_uint = 0x45;
pub const S10_TLP_FMTTYPE_CFGWR1: c_uint = 0x44;

    readb(AGLX_RP_CFG_ADDR(pcie, PCI_SECONDARY_BUS))
pub const AGLX_BDF_REG: c_uint = 0x00002004;
pub const AGLX_ROOT_PORT_IRQ_STATUS: c_uint = 0x14c;
pub const AGLX_ROOT_PORT_IRQ_ENABLE: c_uint = 0x150;

pub const AGLX_CFG_TARGET_TYPE0: c_int = 0;
pub const AGLX_CFG_TARGET_TYPE1: c_int = 1;
pub const AGLX_CFG_TARGET_LOCAL_2000: c_int = 2;
pub const AGLX_CFG_TARGET_LOCAL_3000: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct altera_pcie {
    pub pdev: *mut platform_device,
    pub cra_base: *mut void __iomem,
    pub hip_base: *mut void __iomem,
    pub irq: c_int,
    pub root_bus_nr: u8,
    pub irq_domain: *mut irq_domain,
    pub bus_range: resource,
    pub pcie_data: *const altera_pcie_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct altera_pcie_ops {
    pub value): *mut *mut *mut int (tlp_read_pkt)(struct altera_pcie pcie, u32,
    void (*tlp_write_pkt)(struct altera_pcie *pcie, u32 *headers,
    pub align): u32 data, bool,
    pub pcie): *mut *mut bool (get_link_status)(struct altera_pcie,
    int (*rp_read_cfg)(struct altera_pcie *pcie, int where,
    pub value): *mut int size, u32,
    int (*rp_write_cfg)(struct altera_pcie *pcie, u8 busno,
    pub value): int where, int size, u32,
    int (*ep_read_cfg)(struct altera_pcie *pcie, u8 busno,
    pub value): *mut unsigned int devfn, int where, int size, u32,
    int (*ep_write_cfg)(struct altera_pcie *pcie, u8 busno,
    pub value): unsigned int devfn, int where, int size, u32,
    pub desc): *mut *mut void (rp_isr)(struct irq_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct altera_pcie_data {
    pub ops: *const altera_pcie_ops,
    pub version: enum altera_pcie_version,
    pub /: *mut *mut u32 cap_offset; / PCIe capability structure register offset,
    pub cfgrd0: u32,
    pub cfgrd1: u32,
    pub cfgwr0: u32,
    pub cfgwr1: u32,
    pub port_conf_offset: u32,
    pub port_irq_status_offset: u32,
    pub port_irq_enable_offset: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tlp_rp_regpair_t {
    pub ctrl: u32,
    pub reg0: u32,
    pub reg1: u32,
}
...
#[no_mangle]
pub unsafe extern "C" fn cra_readl(pcie: *mut altera_pcie, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn cra_readw(pcie: *mut altera_pcie, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn cra_readb(pcie: *mut altera_pcie, reg: u32) -> u32 {
    static inline u32 cra_readb(struct altera_pcie *pcie, const u32 reg)
    {
    return readb_relaxed(pcie.cra_base + reg);
    }
#[no_mangle]
unsafe extern "C" fn altera_pcie_link_up(pcie: *mut altera_pcie) -> bool {
    static bool altera_pcie_link_up(struct altera_pcie *pcie)
    {
    return !!((cra_readl(pcie, RP_LTSSM) & RP_LTSSM_MASK) == LTSSM_L0);
    }
#[no_mangle]
unsafe extern "C" fn s10_altera_pcie_link_up(pcie: *mut altera_pcie) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aglx_altera_pcie_link_up(pcie: *mut altera_pcie) -> bool {
...
#[no_mangle]
unsafe extern "C" fn s10_tlp_write_tx(pcie: *mut altera_pcie, reg0: u32, ctrl: u32) {
...
#[no_mangle]
unsafe extern "C" fn tlp_read_packet(pcie: *mut altera_pcie, value: *mut u32) -> c_int {
    static int tlp_read_packet(struct altera_pcie *pcie, u32 *value)
    {
    int i;
    let mut sop: bool = false;
    u32 ctrl;
    u32 reg0, reg1;
    let mut comp_status: u32 = 1;
//
...
#[no_mangle]
unsafe extern "C" fn s10_tlp_read_packet(pcie: *mut altera_pcie, value: *mut u32) -> c_int {
...
// value = dw[3];
    ...
    {
    u8 cfg;
    let mut cfg0: u8 = read ? pcie.pcie_data.cfgrd0 : pcie.pcie_data.cfgwr0;
    let mut cfg1: u8 = read ? pcie.pcie_data.cfgrd1 : pcie.pcie_data.cfgwr1;
    let mut tag: u8 = read ? TLP_READ_TAG : TLP_WRITE_TAG;
...
// check alignment to Qword
    ...
    pcie.pcie_data.ops.tlp_write_pkt(pcie, headers,
    value, false);
    ret = pcie.pcie_data.ops.tlp_read_pkt(pcie, core::ptr::null_mut());
...
// value = 0x01;
#[no_mangle]
pub unsafe extern "C" fn if(0xff00): *mut *mut where == PCI_INTERRUPT_LINE && !(value &) -> else {
...
#[no_mangle]
unsafe extern "C" fn altera_wait_link_retrain(pcie: *mut altera_pcie) {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_retrain(pcie: *mut altera_pcie) {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_isr(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn aglx_isr(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_init_irq_domain(pcie: *mut altera_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_disable_irq(pcie: *mut altera_pcie) {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_irq_teardown(pcie: *mut altera_pcie) {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_parse_dt(pcie: *mut altera_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_host_init(pcie: *mut altera_pcie) {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn altera_pcie_remove(pdev: *mut platform_device) {
