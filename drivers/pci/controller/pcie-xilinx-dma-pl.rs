...
//! Source: drivers/pci/controller/pcie-xilinx-dma-pl.c
#![no_std]
...
pub const XILINX_PCIE_DMA_REG_IDR: c_uint = 0x00000138;
pub const XILINX_PCIE_DMA_REG_IMR: c_uint = 0x0000013c;
pub const XILINX_PCIE_DMA_REG_PSCR: c_uint = 0x00000144;
pub const XILINX_PCIE_DMA_REG_RPSC: c_uint = 0x00000148;
pub const XILINX_PCIE_DMA_REG_MSIBASE1: c_uint = 0x0000014c;
pub const XILINX_PCIE_DMA_REG_MSIBASE2: c_uint = 0x00000150;
pub const XILINX_PCIE_DMA_REG_RPEFR: c_uint = 0x00000154;
pub const XILINX_PCIE_DMA_REG_IDRN: c_uint = 0x00000160;
pub const XILINX_PCIE_DMA_REG_IDRN_MASK: c_uint = 0x00000164;
pub const XILINX_PCIE_DMA_REG_MSI_LOW: c_uint = 0x00000170;
pub const XILINX_PCIE_DMA_REG_MSI_HI: c_uint = 0x00000174;
pub const XILINX_PCIE_DMA_REG_MSI_LOW_MASK: c_uint = 0x00000178;
pub const XILINX_PCIE_DMA_REG_MSI_HI_MASK: c_uint = 0x0000017c;
...
pub const XILINX_PCIE_DMA_IMR_ALL_MASK: c_uint = 0x0ff30fe9;
pub const XILINX_PCIE_DMA_IDR_ALL_MASK: c_uint = 0xffffffff;

// Root Port Error Register definitions

pub const XILINX_PCIE_DMA_RPEFR_ALL_MASK: c_uint = 0xffffffff;
// Root Port Interrupt Register definitions
pub const XILINX_PCIE_DMA_IDRN_SHIFT: c_int = 16;
// Root Port Status/control Register definitions

// Phy Status/Control Register definitions

pub const QDMA_BRIDGE_BASE_OFF: c_uint = 0xcd8;
// Number of MSI IRQs
pub const XILINX_NUM_MSI_IRQS: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_pl_dma_variant {
    pub version: enum xilinx_pl_dma_version,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_msi {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pl_dma_pcie {
    pub dev: *mut device,
    pub reg_base: *mut void __iomem,
    pub cfg_base: *mut void __iomem,
    pub irq: c_int,
    pub cfg: *mut pci_config_window,
    pub phys_reg_base: phys_addr_t,
    pub intx_domain: *mut irq_domain,
    pub pldma_domain: *mut irq_domain,
    pub resources: list_head,
    pub msi: xilinx_msi,
    pub intx_irq: c_int,
    pub lock: raw_spinlock_t,
    pub variant: *const xilinx_pl_dma_variant,
}

#[no_mangle]
pub unsafe extern "C" fn pcie_read(port: *mut pl_dma_pcie, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_write(port: *mut pl_dma_pcie, val: u32, reg: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn xilinx_pl_dma_pcie_link_up(port: *mut pl_dma_pcie) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_clear_err_interrupts(port: *mut pl_dma_pcie) {
    static void xilinx_pl_dma_pcie_clear_err_interrupts(struct pl_dma_pcie *port)
    {
    let mut val: c_ulong = pcie_read(port, XILINX_PCIE_DMA_REG_RPEFR);
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_enable_msi(port: *mut pl_dma_pcie) {
    static void xilinx_pl_dma_pcie_enable_msi(struct pl_dma_pcie *port)
    {
    let mut msi_addr: phys_addr_t = port.phys_reg_base;
...
#[no_mangle]
unsafe extern "C" fn xilinx_mask_intx_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xilinx_unmask_intx_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_msi_handler_high(irq: c_int, args: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_msi_handler_low(irq: c_int, args: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_event_flow(irq: c_int, args: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_intr_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn xilinx_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
    ...
    let mut msi_addr: phys_addr_t = pcie.phys_reg_base;
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_free_irq_domains(port: *mut pl_dma_pcie) {
    ...
    msi.dev_domain = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_init_msi_irq_domain(port: *mut pl_dma_pcie) -> c_int {
    static int xilinx_pl_dma_pcie_init_msi_irq_domain(struct pl_dma_pcie *port)
    {
    struct device *dev = port.dev;
    struct xilinx_msi *msi = &port.msi;
    let mut size: c_int = BITS_TO_LONGS(XILINX_NUM_MSI_IRQS) * sizeof(long);
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_intx_flow(irq: c_int, args: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_mask_event_irq(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_unmask_event_irq(d: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_init_irq_domain(port: *mut pl_dma_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_setup_irq(port: *mut pl_dma_pcie) -> c_int {
    ...
    IRQF_SHARED | IRQF_NO_THREAD, core::ptr::null_mut(), port);
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_init_port(port: *mut pl_dma_pcie) {
...
#[no_mangle]
unsafe extern "C" fn xilinx_request_msi_irq(port: *mut pl_dma_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xilinx_pl_dma_pcie_probe(pdev: *mut platform_device) -> c_int {
