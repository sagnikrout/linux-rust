...
//! Source: drivers/pci/controller/pci-ixp4xx.c
#![no_std]
...
// Register offsets
pub const IXP4XX_PCI_NP_AD: c_uint = 0x00;
pub const IXP4XX_PCI_NP_CBE: c_uint = 0x04;
pub const IXP4XX_PCI_NP_WDATA: c_uint = 0x08;
pub const IXP4XX_PCI_NP_RDATA: c_uint = 0x0c;
pub const IXP4XX_PCI_CRP_AD_CBE: c_uint = 0x10;
pub const IXP4XX_PCI_CRP_WDATA: c_uint = 0x14;
pub const IXP4XX_PCI_CRP_RDATA: c_uint = 0x18;
pub const IXP4XX_PCI_CSR: c_uint = 0x1c;
pub const IXP4XX_PCI_ISR: c_uint = 0x20;
pub const IXP4XX_PCI_INTEN: c_uint = 0x24;
pub const IXP4XX_PCI_DMACTRL: c_uint = 0x28;
pub const IXP4XX_PCI_AHBMEMBASE: c_uint = 0x2c;
pub const IXP4XX_PCI_AHBIOBASE: c_uint = 0x30;
pub const IXP4XX_PCI_PCIMEMBASE: c_uint = 0x34;
pub const IXP4XX_PCI_AHBDOORBELL: c_uint = 0x38;
pub const IXP4XX_PCI_PCIDOORBELL: c_uint = 0x3c;
pub const IXP4XX_PCI_ATPDMA0_AHBADDR: c_uint = 0x40;
pub const IXP4XX_PCI_ATPDMA0_PCIADDR: c_uint = 0x44;
pub const IXP4XX_PCI_ATPDMA0_LENADDR: c_uint = 0x48;
pub const IXP4XX_PCI_ATPDMA1_AHBADDR: c_uint = 0x4c;
pub const IXP4XX_PCI_ATPDMA1_PCIADDR: c_uint = 0x50;
pub const IXP4XX_PCI_ATPDMA1_LENADDR: c_uint = 0x54;
// CSR bit definitions
...
pub const IXP4XX_PCI_NP_CBE_BESL: c_int = 4;
// PCI commands supported by NP access unit
pub const NP_CMD_IOREAD: c_uint = 0x2;
pub const NP_CMD_IOWRITE: c_uint = 0x3;
pub const NP_CMD_CONFIGREAD: c_uint = 0xa;
pub const NP_CMD_CONFIGWRITE: c_uint = 0xb;
pub const NP_CMD_MEMREAD: c_uint = 0x6;
pub const NP_CMD_MEMWRITE: c_uint = 0x7;
// Constants for CRP access into local config space
pub const CRP_AD_CBE_BESL: c_int = 20;
pub const CRP_AD_CBE_WRITE: c_uint = 0x00010000;
// Special PCI configuration space registers for this controller
pub const IXP4XX_PCI_RTOTTO: c_uint = 0x40;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ixp4xx_pci {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub errata_hammer: bool,
    pub host_mode: bool,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn ixp4xx_readl(p: *mut ixp4xx_pci, reg: u32) -> u32 {
    static inline u32 ixp4xx_readl(struct ixp4xx_pci *p, u32 reg)
    {
    return __raw_readl(p.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn ixp4xx_writel(p: *mut ixp4xx_pci, reg: u32, val: u32) {
    static inline void ixp4xx_writel(struct ixp4xx_pci *p, u32 reg, u32 val)
    {
    __raw_writel(val, p.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn ixp4xx_pci_check_master_abort(p: *mut ixp4xx_pci) -> c_int {
    static int ixp4xx_pci_check_master_abort(struct ixp4xx_pci *p)
    {
    let mut isr: u32 = ixp4xx_readl(p, IXP4XX_PCI_ISR);
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_pci_read_indirect(p: *mut ixp4xx_pci, addr: u32, cmd: u32, data: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_pci_write_indirect(p: *mut ixp4xx_pci, addr: u32, cmd: u32, data: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_config_addr(bus_num: u8, devfn: u16, where: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn ixp4xx_crp_byte_lane_enable_bits(n: u32, size: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn ixp4xx_byte_lane_enable_bits(n: u32, size: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_pci_addr_to_64mconf(addr: phys_addr_t) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_pci_parse_map_ranges(p: *mut ixp4xx_pci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_pci_parse_map_dma_ranges(p: *mut ixp4xx_pci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_pci_probe(pdev: *mut platform_device) -> int __init {
