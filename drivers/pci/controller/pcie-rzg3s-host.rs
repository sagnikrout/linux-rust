...
//! Source: drivers/pci/controller/pcie-rzg3s-host.c
#![no_std]
...
pub const RZG3S_PCI_REQRCVDAT: c_uint = 0x8c;
pub const RZG3S_PCI_REQADR1: c_uint = 0x90;

pub const RZG3S_PCI_REQBE: c_uint = 0x98;

pub const RZG3S_PCI_REQISS: c_uint = 0x9c;

pub const RZG3S_PCI_MSIRCVWADRL: c_uint = 0x100;

pub const RZG3S_PCI_MSIRCVWADRU: c_uint = 0x104;
pub const RZG3S_PCI_MSIRCVWMSKL: c_uint = 0x108;

pub const RZG3S_PCI_PINTRCVIE: c_uint = 0x110;

// Register is R/W1C, it doesn't require locking.
pub const RZG3S_PCI_PINTRCVIS: c_uint = 0x114;

pub const RZG3S_PCI_MSGRCVIE: c_uint = 0x120;

pub const RZG3S_PCI_MSGRCVIS: c_uint = 0x124;

pub const RZG3S_PCI_PEIE0: c_uint = 0x200;
pub const RZG3S_PCI_PEIS0: c_uint = 0x204;

pub const RZG3S_PCI_PEIE1: c_uint = 0x208;
pub const RZG3S_PCI_PEIS1: c_uint = 0x20c;
pub const RZG3S_PCI_AMEIS: c_uint = 0x214;
pub const RZG3S_PCI_ASEIS1: c_uint = 0x224;
pub const RZG3S_PCI_PCSTAT1: c_uint = 0x408;

pub const RZG3S_PCI_PCCTRL2: c_uint = 0x410;

pub const RZG3S_PCI_PCSTAT2: c_uint = 0x414;

pub const RZG3S_PCI_PERM: c_uint = 0x300;

pub const RZG3S_PCI_RESET: c_uint = 0x310;

// Register is R/W1C, it doesn't require locking.

// PHY control registers

pub const RZG3S_PCI_PHY_XCFGD_NUM: c_int = 39;

pub const RZG3S_PCI_PHY_XCFGA_CMN_NUM: c_int = 16;

pub const RZG3S_PCI_PHY_XCFGA_RX_NUM: c_int = 13;
pub const RZG3S_PCI_PHY_XCFGA_TX: c_uint = 0x25d0;
pub const RZG3S_PCI_PHY_XCFG_CTRL: c_uint = 0x2a20;

// PCIe registers
pub const RZG3S_PCI_CFG_BASE: c_uint = 0x6000;
pub const RZG3S_PCI_CFG_BARMSK00L: c_uint = 0xa0;
pub const RZG3S_PCI_CFG_BARMSK00U: c_uint = 0xa4;
pub const RZG3S_PCI_CFG_PCIEC: c_uint = 0x60;
// Maximum number of windows
pub const RZG3S_MAX_WINDOWS: c_int = 8;
// Number of MSI interrupts per register
pub const RZG3S_PCI_MSI_INT_PER_REG: c_int = 32;
// The number of MSI interrupts

// Timeouts experimentally determined
pub const RZG3S_REQ_ISSUE_TIMEOUT_US: c_int = 2500;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg3s_sysc_function {
    pub offset: u32,
    pub mask: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg3s_sysc_info {
    pub functions: [rzg3s_sysc_function; RZG3S_SYSC_FUNC_ID_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg3s_sysc {
    pub regmap: *mut regmap,
    pub info: *const rzg3s_sysc_info,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg3s_pcie_msi {
    pub domain: *mut irq_domain,
    pub RZG3S_PCI_MSI_INT_NR): DECLARE_BITMAP(map,,
    pub dma_addr: dma_addr_t,
    pub window_base: dma_addr_t,
    pub pages: c_ulong,
    pub map_lock: mutex,
    pub irq: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg3s_pcie_soc_data {
    pub host): *mut *mut int (init_phy)(struct rzg3s_pcie_host,
    pub host): *mut *mut void (config_pre_init)(struct rzg3s_pcie_host,
    pub host): *mut *mut int (config_post_init)(struct rzg3s_pcie_host,
    pub host): *mut *mut int (config_deinit)(struct rzg3s_pcie_host,
    pub host): *mut *mut int (setup_lanes)(struct rzg3s_pcie_host,
    pub power_resets: *const *const c_char,
    pub cfg_resets: *const *const c_char,
    pub sysc_info: [rzg3s_sysc_info; RZG3S_PCIE_CONTROLLER_ID_MAX],
    pub num_power_resets: u8,
    pub num_cfg_resets: u8,
    pub num_pcie_controllers: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzg3s_pcie_host {
    pub axi: *mut void __iomem,
    pub pcie: *mut void __iomem,
    pub dev: *mut device,
    pub power_resets: *mut reset_control_bulk_data,
    pub cfg_resets: *mut reset_control_bulk_data,
    pub sysc: *mut rzg3s_sysc,
    pub intx_domain: *mut irq_domain,
    pub data: *const rzg3s_pcie_soc_data,
    pub msi: rzg3s_pcie_msi,
    pub port: rzg3s_pcie_port,
    pub hw_lock: raw_spinlock_t,
    pub intx_irqs: [c_int; PCI_NUM_INTX],
    pub max_link_speed: c_int,
    pub controller_id: enum rzg3s_pcie_controller_id,
    pub num_lanes: u8,
}
...
//
pub const RZV2H_PCIE_MAX_LANES: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_child_issue_request(host: *mut rzg3s_pcie_host) -> c_int {
...
// Set byte enable
    ...
    int where, u32 *data)
    {
    let mut type0: bool = pci_is_root_bus(bus.parent) ? true : false;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_intx_irq_handler(desc: *mut irq_desc) {
    ...
    let mut intx: u32 = irq - host.intx_irqs[0];
    chained_irq_enter(chip, desc);
    generic_handle_domain_irq(host.intx_domain, intx);
    chained_irq_exit(chip, desc);
    }
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_msi_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t rzg3s_pcie_msi_irq(int irq, void *data)
    {
    let mut regs: u8 = RZG3S_PCI_MSI_INT_NR / RZG3S_PCI_MSI_INT_PER_REG;
...
// Clear the MSI
    ...
    if (ret) {
    let mut reg_bit: u8 = bit % RZG3S_PCI_MSI_INT_PER_REG;
    let mut reg_id: u8 = bit / RZG3S_PCI_MSI_INT_PER_REG;
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_msi_irq_ack(d: *mut irq_data) {
    static void rzg3s_pcie_msi_irq_ack(struct irq_data *d)
    {
    struct rzg3s_pcie_msi *msi = irq_data_get_irq_chip_data(d);
    struct rzg3s_pcie_host *host = rzg3s_msi_to_host(msi);
    let mut reg_bit: u8 = d.hwirq % RZG3S_PCI_MSI_INT_PER_REG;
    let mut reg_id: u8 = d.hwirq / RZG3S_PCI_MSI_INT_PER_REG;
    writel_relaxed(BIT(reg_bit), host.axi + RZG3S_PCI_MSIRS(reg_id));
    }
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_msi_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_msi_irq_unmask(d: *mut irq_data) {
...
//
    ...
    domain.host_data, handle_edge_irq, core::ptr::null_mut(),
    core::ptr::null_mut());
    }
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_msi_allocate_domains(msi: *mut rzg3s_pcie_msi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_msi_hw_setup(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_msi_setup(host: *mut rzg3s_pcie_host) -> c_int {
    static int rzg3s_pcie_msi_setup(struct rzg3s_pcie_host *host)
    {
    let mut size: usize = RZG3S_PCI_MSI_INT_NR * sizeof(u32);
    struct rzg3s_pcie_msi *msi = &host.msi;
    struct device *dev = host.dev;
    int id, ret;
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_msi_hw_teardown(host: *mut rzg3s_pcie_host) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_teardown_msi(host: *mut rzg3s_pcie_host) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_init_msi(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_intx_irq_ack(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_intx_irq_mask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_intx_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_init_irqdomain(host: *mut rzg3s_pcie_host) -> c_int {
    ...
    let mut ret: c_int = rzg3s_pcie_init_msi(host);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_teardown_irqdomain(host: *mut rzg3s_pcie_host) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_set_max_link_speed(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_config_init(host: *mut rzg3s_pcie_host) -> c_int {
    static int rzg3s_pcie_config_init(struct rzg3s_pcie_host *host)
    {
    struct pci_host_bridge *bridge = pci_host_bridge_from_priv(host);
    let mut mask: u32 = GENMASK(31, 8);
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_config_post_init(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_config_deinit(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_pcie_config_pre_init(host: *mut rzg3s_pcie_host) {
    static void rzg3e_pcie_config_pre_init(struct rzg3s_pcie_host *host)
    {
    let mut mask: u32 = RZG3S_PCI_RESET_RST_LOAD_B | RZG3S_PCI_RESET_RST_CFG_B;
// De-assert LOAD_B and CFG_B
    rzg3s_pcie_update_bits(host.axi, RZG3S_PCI_RESET, mask, mask);
    }
#[no_mangle]
unsafe extern "C" fn rzg3e_pcie_config_deinit(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3e_pcie_config_post_init(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_irq_init(host: *mut rzg3s_pcie_host) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_power_resets_deassert(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_resets_prepare_and_get(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_host_parse_port(host: *mut rzg3s_pcie_host) -> c_int {
    static int rzg3s_pcie_host_parse_port(struct rzg3s_pcie_host *host)
    {
    struct device_node *of_port __free(device_node) =
    of_get_next_child(host.dev.of_node, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_host_init_port(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_host_init(host: *mut rzg3s_pcie_host) -> c_int {
...
// Set PCIe window base address and enable the window
    ...
    let mut cpu_addr: u64 = entry.res.start;
    let mut cpu_end: u64 = entry.res.end;
    let mut id: c_int = *index;
    u64 size;
//
...
//
    ...
    let mut remaining_size: u64 = cpu_end - cpu_addr + 1;
    u64 align_limit;
    if (id >= RZG3S_MAX_WINDOWS)
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_parse_map_dma_ranges(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_parse_map_ranges(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_soc_pcie_init_phy(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_get_controller_id(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_pcie_setup_lanes(host: *mut rzg3s_pcie_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2h_pcie_release_lanes(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzg3s_pcie_resume_noirq(dev: *mut device) -> c_int {
