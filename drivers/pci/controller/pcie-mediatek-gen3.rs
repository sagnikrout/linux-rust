...
//! Source: drivers/pci/controller/pcie-mediatek-gen3.c
#![no_std]
...
pub const PCIE_BASE_CFG_REG: c_uint = 0x14;

pub const PCIE_SETTING_REG: c_uint = 0x80;

pub const PCIE_PCI_IDS_1: c_uint = 0x9c;

pub const PCIE_EQ_PRESET_01_REG: c_uint = 0x100;

pub const PCIE_CFGNUM_REG: c_uint = 0x140;

pub const PCIE_CFG_OFFSET_ADDR: c_uint = 0x1000;

    (PCIE_CFG_BUS(bus) | PCIE_CFG_DEVFN(devfn))
pub const PCIE_RST_CTRL_REG: c_uint = 0x148;
...
//
pub const PCIE_BRG_RST_RDY_MS: c_int = 10;
pub const PCIE_LTSSM_STATUS_REG: c_uint = 0x150;

pub const PCIE_LTSSM_STATE_L2_IDLE: c_uint = 0x14;
pub const PCIE_LINK_STATUS_REG: c_uint = 0x154;

pub const PCIE_MSI_SET_NUM: c_int = 8;
pub const PCIE_MSI_IRQS_PER_SET: c_int = 32;

    (PCIE_MSI_IRQS_PER_SET * PCIE_MSI_SET_NUM)
pub const PCIE_INT_ENABLE_REG: c_uint = 0x180;

pub const PCIE_MSI_SHIFT: c_int = 8;
pub const PCIE_INTX_SHIFT: c_int = 24;

    GENMASK(PCIE_INTX_SHIFT + PCI_NUM_INTX - 1, PCIE_INTX_SHIFT)
pub const PCIE_INT_STATUS_REG: c_uint = 0x184;
pub const PCIE_MSI_SET_ENABLE_REG: c_uint = 0x190;

pub const PCIE_PIPE4_PIE8_REG: c_uint = 0x338;

pub const PCIE_MSI_SET_BASE_REG: c_uint = 0xc00;
pub const PCIE_MSI_SET_OFFSET: c_uint = 0x10;
pub const PCIE_MSI_SET_STATUS_OFFSET: c_uint = 0x04;
pub const PCIE_MSI_SET_ENABLE_OFFSET: c_uint = 0x08;
pub const PCIE_MSI_SET_ADDR_HI_BASE: c_uint = 0xc80;
pub const PCIE_MSI_SET_ADDR_HI_OFFSET: c_uint = 0x04;
pub const PCIE_RESOURCE_CTRL_REG: c_uint = 0xd2c;

pub const PCIE_ICMD_PM_REG: c_uint = 0x198;

pub const PCIE_MISC_CTRL_REG: c_uint = 0x348;

pub const PCIE_TRANS_TABLE_BASE_REG: c_uint = 0x800;
pub const PCIE_ATR_SRC_ADDR_MSB_OFFSET: c_uint = 0x4;
pub const PCIE_ATR_TRSL_ADDR_LSB_OFFSET: c_uint = 0x8;
pub const PCIE_ATR_TRSL_ADDR_MSB_OFFSET: c_uint = 0xc;
pub const PCIE_ATR_TRSL_PARAM_OFFSET: c_uint = 0x10;
pub const PCIE_ATR_TLB_SET_OFFSET: c_uint = 0x20;
pub const PCIE_MAX_TRANS_TABLES: c_int = 8;

    (((((size) - 1) << 1) & GENMASK(6, 1)) | PCIE_ATR_EN)

pub const MAX_NUM_PHY_RESETS: c_int = 3;
pub const PCIE_MTK_RESET_TIME_US: c_int = 10;
// Time in ms needed to complete PCIe reset on EN7581 SoC
pub const PCIE_EN7581_RESET_TIME_MS: c_int = 100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_gen3_pcie_pdata {
    pub pcie): *mut *mut int (power_up)(struct mtk_gen3_pcie,
    struct {
    pub id: [*const c_char; MAX_NUM_PHY_RESETS],
    pub num_resets: c_int,
    pub phy_resets: },
    pub sys_clk_rdy_time_us: u8,
    pub flags: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_msi_set {
    pub base: *mut void __iomem,
    pub msg_addr: phys_addr_t,
    pub saved_irq_state: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_gen3_pcie {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub reg_base: phys_addr_t,
    pub mac_reset: *mut reset_control,
    pub phy_resets: [reset_control_bulk_data; MAX_NUM_PHY_RESETS],
    pub phy: *mut phy,
    ...
    pub msi_bottom_domain: *mut irq_domain,
    pub msi_sets: [mtk_msi_set; PCIE_MSI_SET_NUM],
    pub lock: mutex,
    pub PCIE_MSI_IRQS_NUM): DECLARE_BITMAP(msi_irq_in_use,,
    pub soc: *const mtk_gen3_pcie_pdata,
}
...
//
    ...
    {
    let mut remaining: resource_size_t = size;
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_enable_msi(pcie: *mut mtk_gen3_pcie) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_devices_power_up(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_devices_power_down(pcie: *mut mtk_gen3_pcie) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_startup_port(pcie: *mut mtk_gen3_pcie) -> c_int {
    static int mtk_pcie_startup_port(struct mtk_gen3_pcie *pcie)
    {
    struct resource_entry *entry;
    struct pci_host_bridge *host = pci_host_bridge_from_priv(pcie);
    let mut table_index: c_uint = 0;
    int err;
    u32 val;
...
// Set PCIe translation windows
    ...
    let mut type: c_ulong = resource_type(res);
    resource_size_t cpu_addr;
    resource_size_t pci_addr;
    resource_size_t size;
    if (type == IORESOURCE_IO)
...
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_MEM: type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn mtk_msi_bottom_irq_ack(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mtk_msi_bottom_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mtk_msi_bottom_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mtk_intx_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mtk_intx_unmask(data: *mut irq_data) {
...
//
#[no_mangle]
unsafe extern "C" fn mtk_intx_eoi(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_init_irq_domains(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_irq_teardown(pcie: *mut mtk_gen3_pcie) {
    static void mtk_pcie_irq_teardown(struct mtk_gen3_pcie *pcie)
    {
    irq_set_chained_handler_and_data(pcie.irq, core::ptr::null_mut(), core::ptr::null_mut());
    if (pcie.intx_domain)
    irq_domain_remove(pcie.intx_domain);
    if (pcie.msi_bottom_domain)
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_msi_handler(pcie: *mut mtk_gen3_pcie, set_idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_irq_handler(desc: *mut irq_desc) {
    static void mtk_pcie_irq_handler(struct irq_desc *desc)
    {
    struct mtk_gen3_pcie *pcie = irq_desc_get_handler_data(desc);
    struct irq_chip *irqchip = irq_desc_get_chip(desc);
    unsigned long status;
    let mut irq_bit: irq_hw_number_t = PCIE_INTX_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_setup_irq(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_parse_port(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_en7581_power_up(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_power_up(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_power_down(pcie: *mut mtk_gen3_pcie) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_get_controller_max_link_speed(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_setup(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_irq_save(pcie: *mut mtk_gen3_pcie) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_irq_restore(pcie: *mut mtk_gen3_pcie) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_turn_off_link(pcie: *mut mtk_gen3_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_resume_noirq(dev: *mut device) -> c_int {
