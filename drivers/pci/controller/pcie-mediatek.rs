...
//! Source: drivers/pci/controller/pcie-mediatek.c
#![no_std]
...
pub const PCIE_SYS_CFG: c_uint = 0x00;
pub const PCIE_INT_ENABLE: c_uint = 0x0c;
pub const PCIE_CFG_ADDR: c_uint = 0x20;
pub const PCIE_CFG_DATA: c_uint = 0x24;
// PCIe per port registers
pub const PCIE_BAR0_SETUP: c_uint = 0x10;
pub const PCIE_CLASS: c_uint = 0x34;
pub const PCIE_LINK_STATUS: c_uint = 0x50;
...
pub const PCIE_FC_CREDIT: c_uint = 0x73c;

// PCIe V2 share registers
pub const PCIE_SYS_CFG_V2: c_uint = 0x0;

// PCIe V2 per-port registers
pub const PCIE_MSI_VECTOR: c_uint = 0x0c0;
pub const PCIE_CONF_VEND_ID: c_uint = 0x100;
pub const PCIE_CONF_DEVICE_ID: c_uint = 0x102;
pub const PCIE_CONF_REV_CLASS: c_uint = 0x104;
pub const PCIE_CONF_CLASS_ID: c_uint = 0x106;
pub const PCIE_INT_MASK: c_uint = 0x420;

pub const INTX_SHIFT: c_int = 16;
pub const PCIE_INT_STATUS: c_uint = 0x424;

pub const PCIE_IMSI_STATUS: c_uint = 0x42c;
pub const PCIE_IMSI_ADDR: c_uint = 0x430;

pub const MTK_MSI_IRQS_NUM: c_int = 32;
pub const EN7528_HOST_MODE: c_uint = 0x00804201;
pub const EN7528_LINKUP_REG: c_uint = 0x50;

pub const PCIE_AHB_TRANS_BASE0_L: c_uint = 0x438;
pub const PCIE_AHB_TRANS_BASE0_H: c_uint = 0x43c;

pub const PCIE_AXI_WINDOW0: c_uint = 0x448;
...
//
pub const PCIE2AHB_SIZE: c_uint = 0x21;
// PCIe V2 configuration transaction header
pub const PCIE_CFG_HEADER0: c_uint = 0x460;
pub const PCIE_CFG_HEADER1: c_uint = 0x464;
pub const PCIE_CFG_HEADER2: c_uint = 0x468;
pub const PCIE_CFG_WDATA: c_uint = 0x470;
pub const PCIE_APP_TLP_REQ: c_uint = 0x488;
pub const PCIE_CFG_RDATA: c_uint = 0x48c;
...
pub const PCIE_RST_CTRL: c_uint = 0x510;

pub const PCIE_LINK_STATUS_V2: c_uint = 0x804;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_pcie_soc {
    pub device_id: c_uint,
    pub ops: *mut pci_ops,
    pub port): *mut *mut int (startup)(struct mtk_pcie_port,
    pub node): *mut *mut *mut int (setup_irq)(struct mtk_pcie_port port, struct device_node,
    pub quirks: enum mtk_pcie_quirks,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_pcie_port {
    pub base: *mut void __iomem,
    pub phys_base: phys_addr_t,
    pub list: list_head,
    pub pcie: *mut mtk_pcie,
    ...
    pub lock: mutex,
    pub MTK_MSI_IRQS_NUM): DECLARE_BITMAP(msi_irq_in_use,,
}
...
pub struct mtk_pcie {
    ...
    pub free_ck: *mut clk,
    pub ports: list_head,
    pub soc: *const mtk_pcie_soc,
}

#[no_mangle]
unsafe extern "C" fn mtk_pcie_subsys_powerdown(pcie: *mut mtk_pcie) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_port_free(port: *mut mtk_pcie_port) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_put_resources(pcie: *mut mtk_pcie) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_check_cfg_cpld(port: *mut mtk_pcie_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_msi_ack_irq(data: *mut irq_data) {
    static void mtk_msi_ack_irq(struct irq_data *data)
    {
    struct mtk_pcie_port *port = irq_data_get_irq_chip_data(data);
    let mut hwirq: u32 = data.hwirq;
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_allocate_msi_domains(port: *mut mtk_pcie_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_enable_msi(port: *mut mtk_pcie_port) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_irq_teardown_port(port: *mut mtk_pcie_port) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_irq_teardown(pcie: *mut mtk_pcie) {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_intr_handler(desc: *mut irq_desc) {
    static void mtk_pcie_intr_handler(struct irq_desc *desc)
    {
    struct mtk_pcie_port *port = irq_desc_get_handler_data(desc);
    struct irq_chip *irqchip = irq_desc_get_chip(desc);
    unsigned long status;
    let mut bit: u32 = INTX_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_startup_port_v2(port: *mut mtk_pcie_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_startup_port_en7528(port: *mut mtk_pcie_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mtk_pcie_retrain(dev: *mut device, host: *mut pci_host_bridge) -> c_int {
    static int mtk_pcie_retrain(struct device *dev, struct pci_host_bridge *host)
    {
    struct pci_dev *rp;
    let mut ret: c_int = -ENOENT;
    let mut lnksta: u16 = 0;
    u32 speed;
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_startup_port(port: *mut mtk_pcie_port) -> c_int {
    static int mtk_pcie_startup_port(struct mtk_pcie_port *port)
    {
    struct mtk_pcie *pcie = port.pcie;
    let mut func: u32 = PCI_FUNC(port.slot);
    let mut slot: u32 = PCI_SLOT(port.slot << 3);
    u32 val;
    int err;
// assert port PERST_N
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_startup_port_an7583(port: *mut mtk_pcie_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_enable_port(port: *mut mtk_pcie_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_subsys_powerup(pcie: *mut mtk_pcie) -> c_int {
...
// get shared registers, which are optional
    ...
    cfg_node = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(),
    ...
    return -EPROBE_DEFER;
    pcie.free_ck = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_setup(pcie: *mut mtk_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pcie_free_resources(pcie: *mut mtk_pcie) {
