...
//! Source: drivers/pci/controller/vmd.c
#![no_std]
...
pub const VMD_CFGBAR: c_int = 0;
pub const VMD_MEMBAR1: c_int = 2;
pub const VMD_MEMBAR2: c_int = 4;
pub const PCI_REG_VMCAP: c_uint = 0x40;

pub const PCI_REG_VMCONFIG: c_uint = 0x44;

pub const VMCONFIG_MSI_REMAP: c_uint = 0x2;
pub const PCI_REG_VMLOCK: c_uint = 0x70;

pub const MB2_SHADOW_OFFSET: c_uint = 0x2000;
pub const MB2_SHADOW_SIZE: c_int = 16;
// DMR BAR4 register offsets
pub const SHADOW_MEMBAR1_28C1: c_uint = 0x2818 /* MEMBAR1 physical address */;
pub const SHADOW_MEMBAR2_28C1: c_uint = 0x2820 /* MEMBAR2 physical address */;
pub const BASE_ID_REG_28C1: c_uint = 0x2840;
pub const MEMBAR2_OFFSET_28C1: c_uint = 0x30d0;
    enum vmd_features {
//
...
pub const VMD_BIOS_PM_QUIRK_LTR: c_uint = 0x1003	/* 3145728 ns */;
...
pub struct vmd_dev {
    pub dev: *mut pci_dev,
    pub cfg_lock: raw_spinlock_t,
    pub cfgbar: *mut void __iomem,
    pub msix_count: c_int,
    pub irqs: *mut vmd_irq_list,
...
//
#[no_mangle]
unsafe extern "C" fn vmd_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn vmd_irq_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn vmd_pci_msi_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn vmd_pci_msi_startup(data: *mut irq_data) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn vmd_irq_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn vmd_pci_msi_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn vmd_pci_msi_shutdown(data: *mut irq_data) {
...
//
    ...
    handle_untracked_irq, vmd, core::ptr::null_mut());
    }
    return 0;
    }
    static void vmd_msi_free(struct irq_domain *domain, unsigned int virq,
...
#[no_mangle]
unsafe extern "C" fn vmd_create_irq_domain(vmd: *mut vmd_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmd_set_msi_remapping(vmd: *mut vmd_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn vmd_remove_irq_domain(vmd: *mut vmd_dev) {
...
#[no_mangle]
unsafe extern "C" fn vmd_bus_to_ecam(vmd: *mut vmd_dev, busnr: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn vmd_acpi_begin() {
...
#[no_mangle]
unsafe extern "C" fn vmd_acpi_end() {
...
#[no_mangle]
unsafe extern "C" fn vmd_cfgbar_ecam_space(vmd: *mut vmd_dev) -> resource_size_t {
...
#[no_mangle]
unsafe extern "C" fn vmd_domain_reset(vmd: *mut vmd_dev) {
...
#[no_mangle]
unsafe extern "C" fn vmd_attach_resources(vmd: *mut vmd_dev) {
...
#[no_mangle]
unsafe extern "C" fn vmd_detach_resources(vmd: *mut vmd_dev) {
    static void vmd_detach_resources(struct vmd_dev *vmd)
    {
    vmd.dev.resource[VMD_MEMBAR1].child = core::ptr::null_mut();
    vmd.dev.resource[VMD_MEMBAR2].child = core::ptr::null_mut();
    }
...
// Hypervisor-Emulated Vendor-Specific Capability
    let mut pos: c_int = pci_find_capability(dev, PCI_CAP_ID_VNDR);
    u32 reg, regu;
...
#[no_mangle]
unsafe extern "C" fn vmd_get_bus_number_start(vmd: *mut vmd_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmd_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vmd_alloc_irqs(vmd: *mut vmd_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmd_pm_enable_quirk(pdev: *mut pci_dev, userdata: *mut c_void) -> c_int {
    static int vmd_pm_enable_quirk(struct pci_dev *pdev, void *userdata)
    {
    let mut features: c_ulong = *(unsigned long *)userdata;
    let mut ltr: u16 = VMD_BIOS_PM_QUIRK_LTR;
    u32 ltr_reg;
    int pos;
...
#[no_mangle]
unsafe extern "C" fn vmd_enable_domain(vmd: *mut vmd_dev, features: c_ulong) -> c_int {
    ...
    let mut membar2_offset: resource_size_t = 0x2000;
...
#[no_mangle]
unsafe extern "C" fn vmd_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int vmd_probe(struct pci_dev *dev, const struct pci_device_id *id)
    {
    let mut features: c_ulong = (unsigned long) id.driver_data;
    struct vmd_dev *vmd;
    int err;
    if (xen_domain()) {
//
...
#[no_mangle]
unsafe extern "C" fn vmd_cleanup_srcu(vmd: *mut vmd_dev) {
...
#[no_mangle]
unsafe extern "C" fn vmd_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn vmd_shutdown(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn vmd_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmd_resume(dev: *mut device) -> c_int {
