...
//! Source: drivers/pci/controller/pcie-brcmstb.c
#![no_std]
...
pub const BRCM_PCIE_CAP_REGS: c_uint = 0x00ac;
// Broadcom STB PCIe Register Offsets
pub const PCIE_RC_CFG_VENDOR_VENDOR_SPECIFIC_REG1: c_uint = 0x0188;
pub const PCIE_RC_CFG_VENDOR_VENDOR_SPECIFIC_REG1_ENDIAN_MODE_BAR2_MASK: c_uint = 0xc;
pub const PCIE_RC_CFG_VENDOR_SPECIFIC_REG1_LITTLE_ENDIAN: c_uint = 0x0;
pub const PCIE_RC_CFG_PRIV1_ID_VAL3: c_uint = 0x043c;
pub const PCIE_RC_CFG_PRIV1_ID_VAL3_CLASS_CODE_MASK: c_uint = 0xffffff;
pub const PCIE_RC_CFG_PRIV1_LINK_CAPABILITY: c_uint = 0x04dc;
pub const PCIE_RC_CFG_PRIV1_LINK_CAPABILITY_MAX_LINK_WIDTH_MASK: c_uint = 0x1f0;
pub const PCIE_RC_CFG_PRIV1_ROOT_CAP: c_uint = 0x4f8;
pub const PCIE_RC_CFG_PRIV1_ROOT_CAP_L1SS_MODE_MASK: c_uint = 0xf8;
pub const PCIE_RC_DL_MDIO_ADDR: c_uint = 0x1100;
pub const PCIE_RC_DL_MDIO_WR_DATA: c_uint = 0x1104;
pub const PCIE_RC_DL_MDIO_RD_DATA: c_uint = 0x1108;
pub const PCIE_RC_PL_REG_PHY_CTL_1: c_uint = 0x1804;
pub const PCIE_RC_PL_REG_PHY_CTL_1_REG_P2_POWERDOWN_ENA_NOSYNC_MASK: c_uint = 0x8;
pub const PCIE_RC_PL_PHY_CTL_15: c_uint = 0x184c;
pub const PCIE_RC_PL_PHY_CTL_15_DIS_PLL_PD_MASK: c_uint = 0x400000;
pub const PCIE_RC_PL_PHY_CTL_15_PM_CLK_PERIOD_MASK: c_uint = 0xff;
pub const PCIE_MISC_MISC_CTRL: c_uint = 0x4008;
pub const PCIE_MISC_MISC_CTRL_PCIE_RCB_64B_MODE_MASK: c_uint = 0x80;
pub const PCIE_MISC_MISC_CTRL_PCIE_RCB_MPS_MODE_MASK: c_uint = 0x400;
pub const PCIE_MISC_MISC_CTRL_SCB_ACCESS_EN_MASK: c_uint = 0x1000;
pub const PCIE_MISC_MISC_CTRL_CFG_READ_UR_MODE_MASK: c_uint = 0x2000;
pub const PCIE_MISC_MISC_CTRL_MAX_BURST_SIZE_MASK: c_uint = 0x300000;
pub const PCIE_MISC_MISC_CTRL_SCB0_SIZE_MASK: c_uint = 0xf8000000;
pub const PCIE_MISC_MISC_CTRL_SCB1_SIZE_MASK: c_uint = 0x07c00000;
pub const PCIE_MISC_MISC_CTRL_SCB2_SIZE_MASK: c_uint = 0x0000001f;

pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_LO: c_uint = 0x400c;

    PCIE_MISC_CPU_2_PCIE_MEM_WIN0_LO + ((win) * 8)
pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_HI: c_uint = 0x4010;
...
//
pub const PCIE_BRCM_MAX_INBOUND_WINS: c_int = 16;
pub const PCIE_MISC_RC_BAR1_CONFIG_LO: c_uint = 0x402c;
pub const PCIE_MISC_RC_BAR1_CONFIG_LO_SIZE_MASK: c_uint = 0x1f;
pub const PCIE_MISC_RC_BAR4_CONFIG_LO: c_uint = 0x40d4;
pub const PCIE_MISC_MSI_BAR_CONFIG_LO: c_uint = 0x4044;
pub const PCIE_MISC_MSI_BAR_CONFIG_HI: c_uint = 0x4048;
pub const PCIE_MISC_MSI_DATA_CONFIG: c_uint = 0x404c;
pub const PCIE_MISC_MSI_DATA_CONFIG_VAL_32: c_uint = 0xffe06540;
pub const PCIE_MISC_MSI_DATA_CONFIG_VAL_8: c_uint = 0xfff86540;
pub const PCIE_MISC_PCIE_CTRL: c_uint = 0x4064;
pub const PCIE_MISC_PCIE_CTRL_PCIE_L23_REQUEST_MASK: c_uint = 0x1;
pub const PCIE_MISC_PCIE_CTRL_PCIE_PERSTB_MASK: c_uint = 0x4;
pub const PCIE_MISC_PCIE_STATUS: c_uint = 0x4068;
pub const PCIE_MISC_PCIE_STATUS_PCIE_PORT_MASK: c_uint = 0x80;
pub const PCIE_MISC_PCIE_STATUS_PCIE_DL_ACTIVE_MASK: c_uint = 0x20;
pub const PCIE_MISC_PCIE_STATUS_PCIE_PHYLINKUP_MASK: c_uint = 0x10;
pub const PCIE_MISC_PCIE_STATUS_PCIE_LINK_IN_L23_MASK: c_uint = 0x40;
pub const PCIE_MISC_REVISION: c_uint = 0x406c;
pub const BRCM_PCIE_HW_REV_33: c_uint = 0x0303;
pub const BRCM_PCIE_HW_REV_3_20: c_uint = 0x0320;
pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_BASE_LIMIT: c_uint = 0x4070;
pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_BASE_LIMIT_LIMIT_MASK: c_uint = 0xfff00000;
pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_BASE_LIMIT_BASE_MASK: c_uint = 0xfff0;

    PCIE_MISC_CPU_2_PCIE_MEM_WIN0_BASE_LIMIT + ((win) * 4)
pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_BASE_HI: c_uint = 0x4080;
pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_BASE_HI_BASE_MASK: c_uint = 0xff;

    PCIE_MISC_CPU_2_PCIE_MEM_WIN0_BASE_HI + ((win) * 8)
pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_LIMIT_HI: c_uint = 0x4084;
pub const PCIE_MISC_CPU_2_PCIE_MEM_WIN0_LIMIT_HI_LIMIT_MASK: c_uint = 0xff;

    PCIE_MISC_CPU_2_PCIE_MEM_WIN0_LIMIT_HI + ((win) * 8)
pub const PCIE_MISC_HARD_PCIE_HARD_DEBUG_CLKREQ_DEBUG_ENABLE_MASK: c_uint = 0x2;
pub const PCIE_MISC_HARD_PCIE_HARD_DEBUG_L1SS_ENABLE_MASK: c_uint = 0x200000;
pub const PCIE_MISC_HARD_PCIE_HARD_DEBUG_SERDES_IDDQ_MASK: c_uint = 0x08000000;
pub const PCIE_BMIPS_MISC_HARD_PCIE_HARD_DEBUG_SERDES_IDDQ_MASK: c_uint = 0x00800000;

    (PCIE_MISC_HARD_PCIE_HARD_DEBUG_CLKREQ_DEBUG_ENABLE_MASK | \
    PCIE_MISC_HARD_PCIE_HARD_DEBUG_L1SS_ENABLE_MASK)
pub const PCIE_MISC_UBUS_BAR1_CONFIG_REMAP: c_uint = 0x40ac;

pub const PCIE_MISC_UBUS_BAR4_CONFIG_REMAP: c_uint = 0x410c;
pub const PCIE_MSI_INTR2_BASE: c_uint = 0x4500;
// Offsets from INTR2_CPU and MSI_INTR2 BASE offsets
pub const MSI_INT_STATUS: c_uint = 0x0;
pub const MSI_INT_CLR: c_uint = 0x8;
pub const MSI_INT_MASK_SET: c_uint = 0x10;
pub const MSI_INT_MASK_CLR: c_uint = 0x14;
// Error report registers
pub const PCIE_OUTB_ERR_TREAT: c_uint = 0x6000;
pub const PCIE_OUTB_ERR_TREAT_CONFIG: c_uint = 0x1;
pub const PCIE_OUTB_ERR_TREAT_MEM: c_uint = 0x2;
pub const PCIE_OUTB_ERR_VALID: c_uint = 0x6004;
pub const PCIE_OUTB_ERR_CLEAR: c_uint = 0x6008;
pub const PCIE_OUTB_ERR_ACC_INFO: c_uint = 0x600c;

pub const PCIE_OUTB_ERR_ACC_INFO_BYTE_LANES: c_uint = 0xff00;
pub const PCIE_OUTB_ERR_ACC_ADDR: c_uint = 0x6010;
pub const PCIE_OUTB_ERR_ACC_ADDR_BUS: c_uint = 0xff00000;
pub const PCIE_OUTB_ERR_ACC_ADDR_DEV: c_uint = 0xf8000;
pub const PCIE_OUTB_ERR_ACC_ADDR_FUNC: c_uint = 0x7000;
pub const PCIE_OUTB_ERR_ACC_ADDR_REG: c_uint = 0xfff;
pub const PCIE_OUTB_ERR_CFG_CAUSE: c_uint = 0x6014;

pub const PCIE_OUTB_ERR_MEM_ADDR_LO: c_uint = 0x6018;
pub const PCIE_OUTB_ERR_MEM_ADDR_HI: c_uint = 0x601c;
pub const PCIE_OUTB_ERR_MEM_CAUSE: c_uint = 0x6020;

pub const PCIE_RGR1_SW_INIT_1_PERST_MASK: c_uint = 0x1;
pub const RGR1_SW_INIT_1_INIT_GENERIC_MASK: c_uint = 0x2;
pub const RGR1_SW_INIT_1_INIT_GENERIC_SHIFT: c_uint = 0x1;
pub const RGR1_SW_INIT_1_INIT_7278_MASK: c_uint = 0x1;
pub const RGR1_SW_INIT_1_INIT_7278_SHIFT: c_uint = 0x0;
// PCIe parameters
pub const BRCM_NUM_PCIE_OUT_WINS: c_uint = 0x4;
pub const BRCM_INT_PCI_MSI_NR: c_int = 32;
pub const BRCM_INT_PCI_MSI_LEGACY_NR: c_int = 8;
pub const BRCM_INT_PCI_MSI_SHIFT: c_int = 0;

    32 - BRCM_INT_PCI_MSI_LEGACY_NR)
// MSI target addresses
pub const BRCM_MSI_TARGET_ADDR_LT_4GB: c_uint = 0x0fffffffcULL;
pub const BRCM_MSI_TARGET_ADDR_GT_4GB: c_uint = 0xffffffffcULL;
// MDIO registers
pub const MDIO_PORT0: c_uint = 0x0;
pub const MDIO_DATA_MASK: c_uint = 0x7fffffff;
pub const MDIO_PORT_MASK: c_uint = 0xf0000;
pub const MDIO_PORT_EXT_MASK: c_uint = 0x200000;
pub const MDIO_REGAD_MASK: c_uint = 0xffff;
pub const MDIO_CMD_MASK: c_uint = 0x00100000;
pub const MDIO_CMD_READ: c_uint = 0x1;
pub const MDIO_CMD_WRITE: c_uint = 0x0;
pub const MDIO_DATA_DONE_MASK: c_uint = 0x80000000;

pub const SSC_REGS_ADDR: c_uint = 0x1100;
pub const SET_ADDR_OFFSET: c_uint = 0x1f;
pub const SSC_CNTL_OFFSET: c_uint = 0x2;
pub const SSC_CNTL_OVRD_EN_MASK: c_uint = 0x8000;
pub const SSC_CNTL_OVRD_VAL_MASK: c_uint = 0x4000;
pub const SSC_STATUS_OFFSET: c_uint = 0x1;
pub const SSC_STATUS_SSC_MASK: c_uint = 0x400;
pub const SSC_STATUS_PLL_LOCK_MASK: c_uint = 0x800;
pub const PCIE_BRCM_MAX_MEMC: c_int = 3;

// Rescal registers
pub const PCIE_DVT_PMU_PCIE_PHY_CTRL: c_uint = 0xc700;
pub const PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_NFLDS: c_uint = 0x3;
pub const PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_DIG_RESET_MASK: c_uint = 0x4;
pub const PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_DIG_RESET_SHIFT: c_uint = 0x2;
pub const PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_RESET_MASK: c_uint = 0x2;
pub const PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_RESET_SHIFT: c_uint = 0x1;
pub const PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_PWRDN_MASK: c_uint = 0x1;
pub const PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_PWRDN_SHIFT: c_uint = 0x0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcie_cfg_data {
    pub offsets: *const c_int,
    pub soc_base: enum pcie_soc_base,
    pub has_phy: bool,
    pub quirks: u32,
    pub num_inbound_wins: u8,
    pub val): *mut *mut *mut int (perst_set)(struct brcm_pcie pcie, u32,
    pub val): *mut *mut *mut int (bridge_sw_init_set)(struct brcm_pcie pcie, u32,
    pub pcie): *mut *mut int (post_setup)(struct brcm_pcie,
    pub has_err_report: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct subdev_regulators {
    pub num_supplies: c_uint,
    pub supplies: [regulator_bulk_data; ],
}
...
pub struct brcm_msi {
    ...
    pub /: *mut *mut mutex lock; / guards the alloc/free operations,
    pub target_addr: u64,
    pub irq: c_int,
    pub BRCM_INT_PCI_MSI_NR): DECLARE_BITMAP(used,,
    pub legacy: bool,
// Some chips have MSIs in bits [31..24] of a shared register.
    pub legacy_shift: c_int,
    pub /: *mut *mut int nr; / No. of MSI available, depends on chip,
// This is the base pointer for interrupt status/set/clr regs
    pub intr_base: *mut void __iomem,
}

// Internal PCIe Host Controller Information.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcm_pcie {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub clk: *mut clk,
    pub np: *mut device_node,
    pub ssc: bool,
    pub gen: c_int,
    pub msi_target_addr: u64,
    pub msi: *mut brcm_msi,
    pub rescal: *mut reset_control,
    pub perst_reset: *mut reset_control,
    pub bridge_reset: *mut reset_control,
    pub swinit_reset: *mut reset_control,
    pub num_memc: c_int,
    pub memc_size: [u64; PCIE_BRCM_MAX_MEMC],
    pub hw_rev: u32,
    pub sr: *mut subdev_regulators,
    pub ep_wakeup_capable: bool,
    pub cfg: *const pcie_cfg_data,
    pub bridge_in_reset: bool,
    pub die_notifier: notifier_block,
    pub panic_notifier: notifier_block,
    pub bridge_lock: spinlock_t,
}

#[no_mangle]
pub unsafe extern "C" fn is_bmips(pcie: *const brcm_pcie) -> bool {
    static inline bool is_bmips(const struct brcm_pcie *pcie)
    {
    return pcie.cfg.soc_base == BCM7435 || pcie.cfg.soc_base == BCM7425;
    }
#[no_mangle]
unsafe extern "C" fn brcm_pcie_bridge_sw_init_set(pcie: *mut brcm_pcie, val: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn brcm_pcie_encode_ibar_size(size: u64) -> c_int {
    static int brcm_pcie_encode_ibar_size(u64 size)
    {
    let mut log2_in: c_int = ilog2(size);
    if (log2_in >= 12 && log2_in <= 15)
// Covers 4KB to 32KB (inclusive)
    return (log2_in - 12) + 0x1c;
#[no_mangle]
pub unsafe extern "C" fn if(36: log2_in >= 16 && log2_in <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_mdio_form_pkt(port: c_int, regad: c_int, cmd: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_mdio_read(base: *mut void __iomem, port: u8, regad: u8, val: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn brcm_pcie_set_ssc(pcie: *mut brcm_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_set_gen(pcie: *mut brcm_pcie, gen: c_int) {
    static void brcm_pcie_set_gen(struct brcm_pcie *pcie, int gen)
    {
    let mut lnkctl2: u16 = readw(pcie.base + BRCM_PCIE_CAP_REGS + PCI_EXP_LNKCTL2);
    let mut lnkcap: u32 = readl(pcie.base + PCIE_RC_CFG_PRIV1_LINK_CAPABILITY);
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_msi_isr(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn brcm_msi_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn brcm_msi_ack_irq(data: *mut irq_data) {
    static void brcm_msi_ack_irq(struct irq_data *data)
    {
    struct brcm_msi *msi = irq_data_get_irq_chip_data(data);
    let mut shift_amt: c_int = data.hwirq + msi.legacy_shift;
...
#[no_mangle]
unsafe extern "C" fn brcm_msi_alloc(msi: *mut brcm_msi, nr_irqs: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_allocate_domains(msi: *mut brcm_msi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_free_domains(msi: *mut brcm_msi) {
    static void brcm_free_domains(struct brcm_msi *msi)
    {
    irq_domain_remove(msi.inner_domain);
    }
#[no_mangle]
unsafe extern "C" fn brcm_msi_remove(pcie: *mut brcm_pcie) {
...
#[no_mangle]
unsafe extern "C" fn brcm_msi_set_regs(msi: *mut brcm_msi) {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_enable_msi(pcie: *mut brcm_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_rc_mode(pcie: *mut brcm_pcie) -> bool {
    static bool brcm_pcie_rc_mode(struct brcm_pcie *pcie)
    {
    void __iomem *base = pcie.base;
    let mut val: u32 = readl(base + PCIE_MISC_PCIE_STATUS);
    return !!FIELD_GET(PCIE_MISC_PCIE_STATUS_PCIE_PORT_MASK, val);
    }
#[no_mangle]
unsafe extern "C" fn brcm_pcie_link_up(pcie: *mut brcm_pcie) -> bool {
    static bool brcm_pcie_link_up(struct brcm_pcie *pcie)
    {
    let mut val: u32 = readl(pcie.base + PCIE_MISC_PCIE_STATUS);
    let mut dla: u32 = FIELD_GET(PCIE_MISC_PCIE_STATUS_PCIE_DL_ACTIVE_MASK, val);
    let mut plu: u32 = FIELD_GET(PCIE_MISC_PCIE_STATUS_PCIE_PHYLINKUP_MASK, val);
    return dla && plu;
    }
...
// Accesses to the RC go right to the RC registers if !devfn
    ...
    return devfn ? core::ptr::null_mut() : base + PCIE_ECAM_REG(where);
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_bridge_sw_init_set_generic(pcie: *mut brcm_pcie, val: u32) -> c_int {
    static int brcm_pcie_bridge_sw_init_set_generic(struct brcm_pcie *pcie, u32 val)
    {
    u32 tmp, mask = RGR1_SW_INIT_1_INIT_GENERIC_MASK;
    let mut shift: u32 = RGR1_SW_INIT_1_INIT_GENERIC_SHIFT;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_bridge_sw_init_set_7278(pcie: *mut brcm_pcie, val: u32) -> c_int {
    static int brcm_pcie_bridge_sw_init_set_7278(struct brcm_pcie *pcie, u32 val)
    {
    u32 tmp, mask =  RGR1_SW_INIT_1_INIT_7278_MASK;
    let mut shift: u32 = RGR1_SW_INIT_1_INIT_7278_SHIFT;
    tmp = readl(pcie.base + PCIE_RGR1_SW_INIT_1(pcie));
    tmp = (tmp & ~mask) | ((val << shift) & mask);
    writel(tmp, pcie.base + PCIE_RGR1_SW_INIT_1(pcie));
    return 0;
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_perst_set_4908(pcie: *mut brcm_pcie, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_perst_set_7278(pcie: *mut brcm_pcie, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_perst_set_generic(pcie: *mut brcm_pcie, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_post_setup_bcm2712(pcie: *mut brcm_pcie) -> c_int {
...
//
    ...
    struct device *dev = pcie.dev;
    let mut lowest_pcie_addr: u64 = ~(u64)0;
    int ret, i = 0;
    let mut n: u8 = 0;
//
...
//
    ...
    let mut pcie_start: u64 = entry.res.start - entry.offset;
    let mut cpu_start: u64 = entry.res.start;
...
#[no_mangle]
unsafe extern "C" fn brcm_bar_reg_offset(bar: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn brcm_ubus_reg_offset(bar: c_int) -> u32 {
    ...
    let mut pci_offset: u64 = inbound_wins[i].pci_offset;
    let mut cpu_addr: u64 = inbound_wins[i].cpu_addr;
    let mut size: u64 = inbound_wins[i].size;
    let mut reg_offset: u32 = brcm_bar_reg_offset(i);
    let mut tmp: u32 = lower_32_bits(pci_offset);
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_setup(pcie: *mut brcm_pcie) -> c_int {
    ...
    let mut num_out_wins: u8 = 0;
    let mut num_inbound_wins: c_int = 0;
    int memc, ret;
// Reset the bridge
...
//
    ...
    burst = 0x1; /* 256 bytes */
#[no_mangle]
pub unsafe extern "C" fn if(BCM2711: pcie->cfg->soc_base ==) -> else {
    else if (pcie.cfg.soc_base == BCM2711)
    burst = 0x0; /* 128 bytes */
#[no_mangle]
pub unsafe extern "C" fn if(BCM7278: pcie->cfg->soc_base ==) -> else {
...
//
    ...
    let mut scb_size_val: u32 = ilog2(pcie.memc_size[memc]) - 15;
    if (memc == 0)
    u32p_replace_bits(&tmp, scb_size_val, SCB_SIZE_MASK(0));
#[no_mangle]
pub unsafe extern "C" fn if(1: memc ==) -> else {
    else if (memc == 1)
    u32p_replace_bits(&tmp, scb_size_val, SCB_SIZE_MASK(1));
#[no_mangle]
pub unsafe extern "C" fn if(2: memc ==) -> else {
    else if (memc == 2)
...
//
#[no_mangle]
unsafe extern "C" fn brcm_extend_rbus_timeout(pcie: *mut brcm_pcie) {
    static void brcm_extend_rbus_timeout(struct brcm_pcie *pcie)
    {
// TIMEOUT register is two registers before RGR1_SW_INIT_1
    let mut REG_OFFSET: c_uint = PCIE_RGR1_SW_INIT_1(pcie) - 8;
...
#[no_mangle]
unsafe extern "C" fn brcm_config_clkreq(pcie: *mut brcm_pcie) {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_start_link(pcie: *mut brcm_pcie) -> c_int {
    static int brcm_pcie_start_link(struct brcm_pcie *pcie)
    {
    struct device *dev = pcie.dev;
    void __iomem *base = pcie.base;
    u16 nlw, cls, lnksta;
    let mut ssc_good: bool = false;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_add_bus(bus: *mut pci_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_remove_bus(bus: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_enter_l23(pcie: *mut brcm_pcie) {
...
#[no_mangle]
unsafe extern "C" fn brcm_phy_cntl(pcie: *mut brcm_pcie, start: c_int) -> c_int {
    ...
    let mut beg: c_int = start ? 0 : PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_NFLDS - 1;
    let mut end: c_int = start ? PCIE_DVT_PMU_PCIE_PHY_CTRL_DAST_NFLDS : -1;
...
#[no_mangle]
pub unsafe extern "C" fn brcm_phy_start(pcie: *mut brcm_pcie) -> c_int {
    static inline int brcm_phy_start(struct brcm_pcie *pcie)
    {
    return pcie.cfg.has_phy ? brcm_phy_cntl(pcie, 1) : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn brcm_phy_stop(pcie: *mut brcm_pcie) -> c_int {
    static inline int brcm_phy_stop(struct brcm_pcie *pcie)
    {
    return pcie.cfg.has_phy ? brcm_phy_cntl(pcie, 0) : 0;
    }
#[no_mangle]
unsafe extern "C" fn brcm_pcie_turn_off(pcie: *mut brcm_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_dev_may_wakeup(dev: *mut pci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_resume_noirq(dev: *mut device) -> c_int {
...
// We've got all of the info, clear the error
    ...
    if (is_cfg_err) {
    let mut bus: c_int = FIELD_GET(PCIE_OUTB_ERR_ACC_ADDR_BUS, cfg_addr);
    let mut dev: c_int = FIELD_GET(PCIE_OUTB_ERR_ACC_ADDR_DEV, cfg_addr);
    let mut func: c_int = FIELD_GET(PCIE_OUTB_ERR_ACC_ADDR_FUNC, cfg_addr);
    let mut reg: c_int = FIELD_GET(PCIE_OUTB_ERR_ACC_ADDR_REG, cfg_addr);
    ...
    if (is_mem_err) {
    let mut addr: u64 = ((u64)hi << 32) | (u64)lo;
...
#[no_mangle]
unsafe extern "C" fn brcm_register_die_notifiers(pcie: *mut brcm_pcie) {
...
#[no_mangle]
unsafe extern "C" fn brcm_unregister_die_notifiers(pcie: *mut brcm_pcie) {
...
#[no_mangle]
unsafe extern "C" fn __brcm_pcie_remove(pcie: *mut brcm_pcie) {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn brcm_pcie_probe(pdev: *mut platform_device) -> c_int {
