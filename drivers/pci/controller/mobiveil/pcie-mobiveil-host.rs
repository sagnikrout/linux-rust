...
//! Source: drivers/pci/controller/mobiveil/pcie-mobiveil-host.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mobiveil_pcie_valid_device(bus: *mut pci_bus, devfn: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_pcie_isr(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_pcie_parse_dt(pcie: *mut mobiveil_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_pcie_enable_msi(pcie: *mut mobiveil_pcie) {
    static void mobiveil_pcie_enable_msi(struct mobiveil_pcie *pcie)
    {
    let mut msg_addr: phys_addr_t = pcie.pcie_reg_base;
...
#[no_mangle]
pub unsafe extern "C" fn mobiveil_host_init(pcie: *mut mobiveil_pcie, reinit: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_IO: resource_type(win->res) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_mask_intx_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_unmask_intx_irq(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_compose_msi_msg(data: *mut irq_data, msg: *mut msi_msg) {
    static void mobiveil_compose_msi_msg(struct irq_data *data, struct msi_msg *msg)
    {
    struct mobiveil_pcie *pcie = irq_data_get_irq_chip_data(data);
    let mut addr: phys_addr_t = pcie.pcie_reg_base + (data.hwirq * sizeof(int));
...
#[no_mangle]
unsafe extern "C" fn mobiveil_allocate_msi_domains(pcie: *mut mobiveil_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_pcie_init_irq_domain(pcie: *mut mobiveil_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_pcie_integrated_interrupt_init(pcie: *mut mobiveil_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_pcie_interrupt_init(pcie: *mut mobiveil_pcie) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mobiveil_pcie_is_bridge(pcie: *mut mobiveil_pcie) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn mobiveil_pcie_host_probe(pcie: *mut mobiveil_pcie) -> c_int {
