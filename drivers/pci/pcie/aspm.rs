...
//! Source: drivers/pci/pcie/aspm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn pci_save_ltr_state(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_restore_ltr_state(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_configure_aspm_l1ss(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_save_aspm_l1ss_state(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_restore_aspm_l1ss_state(pdev: *mut pci_dev) {
...
pub struct pcie_link_state {
    pub /: *mut *mut *mut pci_dev pdev; / Upstream component of the Link,
    pub /: *mut *mut *mut pci_dev downstream; / Downstream component, function 0,
    pub /: *mut *mut *mut pcie_link_state root; / pointer to the root port link,
    pub /: *mut *mut *mut pcie_link_state parent; / pointer to the parent Link state,
    pub /: *mut *mut list_head sibling; / node in link_list,
// ASPM state
    pub /: *mut *mut u32 aspm_support:7; / Supported ASPM state,
    pub /: *mut *mut u32 aspm_enabled:7; / Enabled ASPM state,
    pub /: *mut *mut u32 aspm_capable:7; / Capable ASPM state with latency,
    pub or: *mut *mut u32 aspm_default:7; / Default ASPM state by BIOS,
    override */
    pub /: *mut *mut u32 aspm_disable:7; / Disabled ASPM state,
// Clock PM state
    pub /: *mut *mut u32 clkpm_capable:1; / Clock PM capable?,
    pub /: *mut *mut u32 clkpm_enabled:1; / Current Clock PM state,
    pub /: *mut *mut u32 clkpm_default:1; / Default Clock PM state by BIOS,
    pub /: *mut *mut u32 clkpm_disable:1; / Clock PM disabled,
}

    static bool aspm_disabled, aspm_force;
    let mut aspm_support_enabled: static bool = true;
    static DEFINE_MUTEX(aspm_lock);
    static LIST_HEAD(link_list);

    let mut aspm_policy: static int = POLICY_PERFORMANCE;

    let mut aspm_policy: static int = POLICY_POWERSAVE;

    let mut aspm_policy: static int = POLICY_POWER_SUPERSAVE;
...
#[no_mangle]
unsafe extern "C" fn policy_to_aspm_state(link: *mut pcie_link_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn policy_to_clkpm_state(link: *mut pcie_link_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_update_aspm_saved_state(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pcie_set_clkpm_nocheck(link: *mut pcie_link_state, enable: c_int) {
    static void pcie_set_clkpm_nocheck(struct pcie_link_state *link, int enable)
    {
    struct pci_dev *child;
    struct pci_bus *linkbus = link.pdev.subordinate;
    let mut val: u32 = enable ? PCI_EXP_LNKCTL_CLKREQ_EN : 0;
    list_for_each_entry(child, &linkbus.devices, bus_list) {
...
#[no_mangle]
unsafe extern "C" fn pcie_set_clkpm(link: *mut pcie_link_state, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcie_clkpm_cap_init(link: *mut pcie_link_state, blacklist: c_int) {
    static void pcie_clkpm_cap_init(struct pcie_link_state *link, int blacklist)
    {
    let mut capable: c_int = 1, enabled = 1;
    u32 reg32;
    u16 reg16;
    struct pci_dev *child;
    struct pci_bus *linkbus = link.pdev.subordinate;
...
//
#[no_mangle]
unsafe extern "C" fn pcie_aspm_configure_common_clock(link: *mut pcie_link_state) {
    static void pcie_aspm_configure_common_clock(struct pcie_link_state *link)
    {
    let mut same_clock: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn calc_l0s_latency(lnkcap: u32) -> u32 {
    static u32 calc_l0s_latency(u32 lnkcap)
    {
    let mut encoding: u32 = FIELD_GET(PCI_EXP_LNKCAP_L0SEL, lnkcap);
    if (encoding == 0x7)
...
#[no_mangle]
unsafe extern "C" fn calc_l0s_acceptable(encoding: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn calc_l1_latency(lnkcap: u32) -> u32 {
    static u32 calc_l1_latency(u32 lnkcap)
    {
    let mut encoding: u32 = FIELD_GET(PCI_EXP_LNKCAP_L1EL, lnkcap);
    if (encoding == 0x7)
...
#[no_mangle]
unsafe extern "C" fn calc_l1_acceptable(encoding: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn calc_l12_pwron(pdev: *mut pci_dev, scale: u32, val: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_encode_t_power_on(t_power_on_us: u32, scale: *mut u8, value: *mut u8) {
    void pcie_encode_t_power_on(u32 t_power_on_us, u8 *scale, u8 *value)
    {
    let mut maxv: u8 = FIELD_MAX(PCI_L1SS_CAP_P_PWR_ON_VALUE);
...
//
#[no_mangle]
unsafe extern "C" fn encode_l12_threshold(threshold_us: u32, scale: *mut u32, value: *mut u32) {
    static void encode_l12_threshold(u32 threshold_us, u32 *scale, u32 *value)
    {
    let mut threshold_ns: u64 = (u64)threshold_us * NSEC_PER_USEC;
//
...
#[no_mangle]
unsafe extern "C" fn pcie_aspm_check_latency(endpoint: *mut pci_dev) {
    static void pcie_aspm_check_latency(struct pci_dev *endpoint)
    {
    u32 latency, encoding, lnkcap_up, lnkcap_dw;
    let mut l1_switch_latency: u32 = 0, latency_up_l0s;
...
#[no_mangle]
unsafe extern "C" fn aspm_l1ss_init(link: *mut pcie_link_state) {
    static void aspm_l1ss_init(struct pcie_link_state *link)
    {
    struct pci_dev *child = link.downstream, *parent = link.pdev;
    u32 parent_l1ss_cap, child_l1ss_cap;
    let mut parent_l1ss_ctl1: u32 = 0, child_l1ss_ctl1 = 0;
...
#[no_mangle]
unsafe extern "C" fn pcie_config_aspm_l1ss(link: *mut pcie_link_state, state: u32) {
...
#[no_mangle]
unsafe extern "C" fn pcie_aspm_override_default_link_state(link: *mut pcie_link_state) {
...
// For devicetree platforms, enable L0s and L1 by default
    ...
    let mut no_l0s: bool = pcie_link_has_aspm_override(link, "aspm-no-l0s");
    let mut no_l1: bool = pcie_link_has_aspm_override(link, "aspm-no-l1");
    let mut no_l1ss: bool = pcie_link_has_aspm_override(link, "aspm-no-l1ss");
    if (no_l0s) {
...
#[no_mangle]
unsafe extern "C" fn pcie_aspm_cap_init(link: *mut pcie_link_state, blacklist: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pcie_config_aspm_dev(pdev: *mut pci_dev, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn pcie_config_aspm_link(link: *mut pcie_link_state, state: u32) {
    static void pcie_config_aspm_link(struct pcie_link_state *link, u32 state)
    {
    let mut upstream: u32 = 0, dwstream = 0;
    struct pci_dev *child = link.downstream, *parent = link.pdev;
    struct pci_bus *linkbus = parent.subordinate;
...
#[no_mangle]
unsafe extern "C" fn pcie_config_aspm_path(link: *mut pcie_link_state) {
...
#[no_mangle]
unsafe extern "C" fn free_link_state(link: *mut pcie_link_state) {
    static void free_link_state(struct pcie_link_state *link)
    {
    link.pdev.link_state = core::ptr::null_mut();
    kfree(link);
    }
#[no_mangle]
unsafe extern "C" fn pcie_aspm_sanity_check(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcie_aspm_update_sysfs_visibility(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_aspm_init_link_state(pdev: *mut pci_dev) {
    void pcie_aspm_init_link_state(struct pci_dev *pdev)
    {
    struct pcie_link_state *link;
    let mut blacklist: c_int = !!pcie_aspm_sanity_check(pdev);
...
#[no_mangle]
pub unsafe extern "C" fn pci_bridge_reconfigure_ltr(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_configure_ltr(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pcie_update_aspm_capable(root: *mut pcie_link_state) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_aspm_exit_link_state(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_aspm_pm_state_change(pdev: *mut pci_dev, locked: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_aspm_powersave_config_link(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_calc_aspm_disable_mask(state: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn pci_calc_aspm_enable_mask(state: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn __pci_disable_link_state(pdev: *mut pci_dev, state: c_int, locked: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_disable_link_state_locked(pdev: *mut pci_dev, state: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_disable_link_state(pdev: *mut pci_dev, state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pci_enable_link_state(pdev: *mut pci_dev, state: c_int, locked: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_enable_link_state(pdev: *mut pci_dev, state: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_enable_link_state_locked(pdev: *mut pci_dev, state: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_aspm_remove_cap(pdev: *mut pci_dev, lnkcap: u32) {
...
#[no_mangle]
unsafe extern "C" fn pcie_aspm_get_policy(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_aspm_enabled(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pcie_aspm_disable(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_no_aspm() {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_aspm_support_enabled() -> bool {
