...
pub const AER_ERROR_SOURCES_MAX: c_int = 128;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aer_err_source {
    pub /: *mut *mut u32 status; / PCI_ERR_ROOT_STATUS,
    pub /: *mut *mut u32 id; / PCI_ERR_ROOT_ERR_SRC,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aer_rpc {
    pub /: *mut *mut *mut pci_dev rpd; / Root Port device,
    pub AER_ERROR_SOURCES_MAX): DECLARE_KFIFO(aer_fifo, struct aer_err_source,,
}
...
// Counters for different type of correctable errors
    pub dev_cor_errs: [u64; AER_MAX_TYPEOF_COR_ERRS],
// Counters for different type of fatal uncorrectable errors
    pub dev_fatal_errs: [u64; AER_MAX_TYPEOF_UNCOR_ERRS],
// Counters for different type of nonfatal uncorrectable errors
    pub dev_nonfatal_errs: [u64; AER_MAX_TYPEOF_UNCOR_ERRS],
// Total number of ERR_COR sent by this device
    pub dev_total_cor_errs: u64,
// Total number of ERR_FATAL sent by this device
    pub dev_total_fatal_errs: u64,
// Total number of ERR_NONFATAL sent by this device
    pub dev_total_nonfatal_errs: u64,
//
...
//
    pub rootport_total_cor_errs: u64,
    pub rootport_total_fatal_errs: u64,
    pub rootport_total_nonfatal_errs: u64,
// Ratelimits for errors
    pub correctable_ratelimit: ratelimit_state,
    pub nonfatal_ratelimit: ratelimit_state,
}
...
#[no_mangle]
pub unsafe extern "C" fn pci_no_aer() {
    void pci_no_aer(void)
    {
    pcie_aer_disable = true;
    }
#[no_mangle]
pub unsafe extern "C" fn pci_aer_available() -> bool {
    bool pci_aer_available(void)
    {
    return !pcie_aer_disable && pci_msi_enabled();
    }

    let mut ecrc_policy: static int = ECRC_POLICY_DEFAULT;
...
//
#[no_mangle]
unsafe extern "C" fn enable_ecrc_checking(dev: *mut pci_dev) -> c_int {
    static int enable_ecrc_checking(struct pci_dev *dev)
    {
    let mut aer: c_int = dev.aer_cap;
    u32 reg32;
    if (!aer)
    return -ENODEV;
...
//
#[no_mangle]
unsafe extern "C" fn disable_ecrc_checking(dev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_set_ecrc_checking(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_ecrc_get_policy(str: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_aer_is_native(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_enable_pcie_error_reporting(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_aer_clear_nonfatal_status(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_aer_clear_fatal_status(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_aer_raw_clear_status(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_aer_clear_status(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pci_save_aer_state(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_restore_aer_state(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_aer_init(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_aer_exit(dev: *mut pci_dev) {
    void pci_aer_exit(struct pci_dev *dev)
    {
    kfree(dev.aer_info);
    dev.aer_info = core::ptr::null_mut();
    }
pub const AER_AGENT_RECEIVER: c_int = 0;
pub const AER_AGENT_REQUESTER: c_int = 1;
pub const AER_AGENT_COMPLETER: c_int = 2;
pub const AER_AGENT_TRANSMITTER: c_int = 3;
pub const AER_AGENT_COMPONENT: c_int = 4;
pub const AER_AGENT_UNDEF: c_int = 5;
    ...
    AER_AGENT_RECEIVER)
pub const AER_PHYSICAL_LAYER_ERROR: c_int = 0;
pub const AER_DATA_LINK_LAYER_ERROR: c_int = 1;
pub const AER_TRANSACTION_LAYER_ERROR: c_int = 2;
pub const AER_GENERAL_ERROR: c_int = 3;
pub const AER_UNDEF_ERROR: c_int = 4;
...
//
    ...
    core::ptr::null_mut(),				/* Bit Position 16	*/
    core::ptr::null_mut(),				/* Bit Position 17	*/
    core::ptr::null_mut(),				/* Bit Position 18	*/
    core::ptr::null_mut(),				/* Bit Position 19	*/
    core::ptr::null_mut(),				/* Bit Position 20	*/
    core::ptr::null_mut(),				/* Bit Position 21	*/
    core::ptr::null_mut(),				/* Bit Position 22	*/
    core::ptr::null_mut(),				/* Bit Position 23	*/
    core::ptr::null_mut(),				/* Bit Position 24	*/
    core::ptr::null_mut(),				/* Bit Position 25	*/
    core::ptr::null_mut(),				/* Bit Position 26	*/
    core::ptr::null_mut(),				/* Bit Position 27	*/
    core::ptr::null_mut(),				/* Bit Position 28	*/
    core::ptr::null_mut(),				/* Bit Position 29	*/
    core::ptr::null_mut(),				/* Bit Position 30	*/
    core::ptr::null_mut(),				/* Bit Position 31	*/
    };
...
//
    ...
    {
    let mut status: c_ulong = info.status & ~info.mask;
    int i, max = -1;
    u64 *counter = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn aer_ratelimit(dev: *mut pci_dev, severity: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aer_get_anfe_status(dev: *mut pci_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tlp_header_logged(status: u32, capctl: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __aer_print_error(dev: *mut pci_dev, info: *mut aer_err_info) {
...
#[no_mangle]
pub unsafe extern "C" fn aer_print_error(info: *mut aer_err_info, i: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn cper_severity_to_aer(cper_severity: c_int) -> c_int {
    ...
    let mut tlp_header_valid: c_int = 0;
    u32 status, mask;
    struct aer_err_info info = {
    .level = level,
...
//
    let mut ratelimit_print: bool = aer_ratelimit(dev, aer_severity);
...
//
#[no_mangle]
unsafe extern "C" fn add_error_device(e_info: *mut aer_err_info, dev: *mut pci_dev) -> c_int {
    static int add_error_device(struct aer_err_info *e_info, struct pci_dev *dev)
    {
    let mut i: c_int = e_info.error_dev_num;
...
//
#[no_mangle]
unsafe extern "C" fn is_error_source(dev: *mut pci_dev, e_info: *mut aer_err_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn find_device_iter(dev: *mut pci_dev, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_aer_unmask_internal_errors(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn is_aer_internal_error(info: *mut aer_err_info) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pci_aer_handle_error(dev: *mut pci_dev, info: *mut aer_err_info) {
...
#[no_mangle]
unsafe extern "C" fn handle_error_source(dev: *mut pci_dev, info: *mut aer_err_info) {
...
pub const AER_RECOVER_RING_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aer_recover_entry {
    pub bus: u8,
    pub devfn: u8,
    pub domain: u16,
    pub severity: c_int,
    pub regs: *mut aer_capability_regs,
}

    static DEFINE_KFIFO(aer_recover_ring, struct aer_recover_entry,
    AER_RECOVER_RING_SIZE);
#[no_mangle]
unsafe extern "C" fn aer_recover_work_func(work: *mut work_struct) {
...
//
    ...
    aer_root_reset);
#[no_mangle]
pub unsafe extern "C" fn if(AER_FATAL: entry.severity ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn aer_get_device_error_info(info: *mut aer_err_info, i: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aer_process_err_devices(e_info: *mut aer_err_info) {
...
//
    ...
    struct aer_err_source *e_src)
    {
    let mut status: u32 = e_src.status;
...
//
    ...
    let mut multi: c_int = status & PCI_ERR_ROOT_MULTI_COR_RCV;
    struct aer_err_info e_info = {
    ...
    let mut fatal: c_int = status & PCI_ERR_ROOT_FATAL_RCV;
    let mut multi: c_int = status & PCI_ERR_ROOT_MULTI_UNCOR_RCV;
    struct aer_err_info e_info = {
...
//
#[no_mangle]
unsafe extern "C" fn aer_isr(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn aer_irq(irq: c_int, context: *mut c_void) -> irqreturn_t {
    static irqreturn_t aer_irq(int irq, void *context)
    {
    struct pcie_device *pdev = (struct pcie_device *)context;
    struct aer_rpc *rpc = get_service_data(pdev);
    struct pci_dev *rp = rpc.rpd;
    let mut aer: c_int = rp.aer_cap;
    let mut e_src: aer_err_source = {};
...
#[no_mangle]
unsafe extern "C" fn aer_enable_irq(pdev: *mut pci_dev) {
    static void aer_enable_irq(struct pci_dev *pdev)
    {
    let mut aer: c_int = pdev.aer_cap;
    u32 reg32;
...
#[no_mangle]
unsafe extern "C" fn aer_disable_irq(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn clear_status_iter(dev: *mut pci_dev, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aer_enable_rootport(rpc: *mut aer_rpc) {
...
// Clear error status of agents reporting to this Root Port or RCEC
    ...
    pcie_walk_rcec(pdev, clear_status_iter, core::ptr::null_mut());
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pdev->subordinate) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn aer_disable_rootport(rpc: *mut aer_rpc) {
...
//
#[no_mangle]
unsafe extern "C" fn aer_remove(dev: *mut pcie_device) {
...
//
#[no_mangle]
unsafe extern "C" fn aer_probe(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aer_suspend(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aer_resume(dev: *mut pcie_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aer_root_reset(dev: *mut pci_dev) -> pci_ers_result_t {
    static pci_ers_result_t aer_root_reset(struct pci_dev *dev)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_aer_init() -> int __init {
