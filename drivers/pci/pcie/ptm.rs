...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ptm_init(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(dev->ptm_granularity: ups->ptm_granularity >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn pci_save_ptm_state(dev: *mut pci_dev) {
    void pci_save_ptm_state(struct pci_dev *dev)
    {
    let mut ptm: u16 = dev.ptm_cap;
...
#[no_mangle]
pub unsafe extern "C" fn pci_restore_ptm_state(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn __pci_enable_ptm(dev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_enable_ptm(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pci_disable_ptm(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_disable_ptm(dev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_suspend_ptm(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_resume_ptm(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_ptm_enabled(dev: *mut pci_dev) -> bool {
...
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "manual")) -> else {
    ...
    {
    struct pci_ptm_debugfs *ptm_debugfs = file.private_data;
    char buf[8]; /* Extra space for core::ptr::null_mut() termination at the end */
    ssize_t pos;
    u8 mode;
...
#[no_mangle]
unsafe extern "C" fn context_valid_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn context_valid_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn local_clock_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = clock;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(local_clock_fops, local_clock_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn master_clock_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = clock;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(master_clock_fops, master_clock_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn t1_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = clock;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(t1_fops, t1_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn t2_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = clock;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(t2_fops, t2_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn t3_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = clock;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(t3_fops, t3_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn t4_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = clock;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(t4_fops, t4_get, core::ptr::null_mut(), "%llu\n");
...
// Check for PTM capability before creating debugfs attributes
    ...
    ptm_debugfs.debugfs = debugfs_create_dir(dirname, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_ptm_destroy_debugfs(ptm_debugfs: *mut pci_ptm_debugfs) {
