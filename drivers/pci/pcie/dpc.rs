...
#[no_mangle]
pub unsafe extern "C" fn pci_save_dpc_state(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_restore_dpc_state(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn dpc_completed(pdev: *mut pci_dev) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_dpc_recovered(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dpc_wait_rp_inactive(pdev: *mut pci_dev) -> c_int {
    static int dpc_wait_rp_inactive(struct pci_dev *pdev)
    {
    let mut timeout: c_ulong = jiffies + HZ;
    let mut cap: u16 = pdev.dpc_cap, status;
...
#[no_mangle]
pub unsafe extern "C" fn dpc_reset_link(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn dpc_process_rp_pio_error(pdev: *mut pci_dev) {
    static void dpc_process_rp_pio_error(struct pci_dev *pdev)
    {
    let mut cap: u16 = pdev.dpc_cap, dpc_status, first_error;
...
#[no_mangle]
pub unsafe extern "C" fn dpc_process_error(pdev: *mut pci_dev) {
    void dpc_process_error(struct pci_dev *pdev)
    {
    let mut cap: u16 = pdev.dpc_cap, status, source, reason, ext_reason;
    let mut info: aer_err_info = {};
    pci_read_config_word(pdev, cap + PCI_EXP_DPC_STATUS, &status);
...
#[no_mangle]
unsafe extern "C" fn pci_clear_surpdn_errors(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn dpc_handle_surprise_removal(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn dpc_is_surprise_removal(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dpc_handler(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dpc_irq(irq: c_int, context: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn pci_dpc_init(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn dpc_enable(dev: *mut pcie_device) {
    static void dpc_enable(struct pcie_device *dev)
    {
    struct pci_dev *pdev = dev.port;
    let mut dpc: c_int = pdev.dpc_cap;
    u16 ctl;
//
...
#[no_mangle]
unsafe extern "C" fn dpc_disable(dev: *mut pcie_device) {
...
#[no_mangle]
unsafe extern "C" fn dpc_probe(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpc_suspend(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpc_resume(dev: *mut pcie_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dpc_remove(dev: *mut pcie_device) {
...
#[no_mangle]
pub unsafe extern "C" fn pcie_dpc_init() -> int __init {
