...
//! Source: drivers/pci/of_property.c
#![no_std]
...
pub const OF_PCI_ADDRESS_CELLS: c_int = 3;
pub const OF_PCI_SIZE_CELLS: c_int = 2;
pub const OF_PCI_MAX_INT_PIN: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct of_pci_addr_pair {
    pub phys_addr: [u32; OF_PCI_ADDRESS_CELLS],
    pub size: [u32; OF_PCI_SIZE_CELLS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct of_pci_range_entry {
    pub child_addr: [u32; OF_PCI_ADDRESS_CELLS],
    pub parent_addr: [u32; OF_PCI_ADDRESS_CELLS],
    pub size: [u32; OF_PCI_SIZE_CELLS],
}

pub const OF_PCI_ADDR_SPACE_IO: c_uint = 0x1;
pub const OF_PCI_ADDR_SPACE_MEM32: c_uint = 0x2;
pub const OF_PCI_ADDR_SPACE_MEM64: c_uint = 0x3;
...
#[no_mangle]
unsafe extern "C" fn of_pci_get_addr_flags(res: *const resource, flags: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_MEM_64: res->flags &) -> else {
...
//
    ...
    struct device_node *np)
    {
    let mut reg: of_pci_addr_pair = { 0 };
// configuration space
    ...
    if (ret) {
    out_irq[i].np = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn of_pci_is_range_resource(res: *const resource, flags: *mut u32) -> bool {
    ...
    let mut ranges_sz: c_uint = 0;
    let mut n_range: c_uint = 0;
    struct resource *res;
    int n_addr_cells;
    u32 *ranges;
    u64 val64;
...
// PCI bus address
    val64 = res.start;
    of_pci_set_address(core::ptr::null_mut(), &ranges[ranges_sz],
