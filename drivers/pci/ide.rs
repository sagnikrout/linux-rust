...
#[no_mangle]
unsafe extern "C" fn reserve_stream_index(pdev: *mut pci_dev, idx: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn reserve_stream_id(hb: *mut pci_host_bridge, id: u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pci_ide_init(pdev: *mut pci_dev) {
...
//
    ...
    let mut pos: c_int = __sel_ide_offset(ide_cap, nr_link_ide, i, nr_ide_mem);
    int nr_assoc;
    u32 val;
    u8 id;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stream_index {
    pub ida: *mut ida,
    pub stream_index: u8,
}

#[no_mangle]
unsafe extern "C" fn free_stream_index(stream: *mut stream_index) {
...
// EP, RP, + HB Stream allocation
    ...
    let mut pref_assoc: pci_bus_region = { 0, -1 };
    let mut mem_assoc: pci_bus_region = { 0, -1 };
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_stream_free(ide: *mut pci_ide) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_stream_release(ide: *mut pci_ide) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_ide_stream_id {
    pub hb: *mut pci_host_bridge,
    pub stream_id: u8,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_stream_register(ide: *mut pci_ide) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_stream_unregister(ide: *mut pci_ide) {
    ...
    ide.name = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(pci_ide_stream_unregister);
#[no_mangle]
unsafe extern "C" fn pci_ide_domain(pdev: *mut pci_dev) -> c_int {
...
// convert to u64 range for bitfield size checks
    let mut r: range = { region.start, region.end };
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_stream_setup(pdev: *mut pci_dev, ide: *mut pci_ide) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_stream_teardown(pdev: *mut pci_dev, ide: *mut pci_ide) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_stream_enable(pdev: *mut pci_dev, ide: *mut pci_ide) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_stream_disable(pdev: *mut pci_dev, ide: *mut pci_ide) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_ide_init_host_bridge(hb: *mut pci_host_bridge) {
    ...
    let mut nr: c_int = READ_ONCE(hb.nr_ide_streams);
    let mut avail: c_int = nr;
    if (!nr)
    return -ENXIO;
//
...
#[no_mangle]
unsafe extern "C" fn pci_ide_attr_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_ide_set_nr_streams(hb: *mut pci_host_bridge, nr: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_ide_destroy(pdev: *mut pci_dev) {
