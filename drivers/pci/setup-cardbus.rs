...
//! Source: drivers/pci/setup-cardbus.c
#![no_std]
...
pub const CARDBUS_RESERVE_BUSNR: c_int = 3;

// pci=cbmemsize=nnM,cbiosize=nn can override this
    let mut pci_cardbus_io_size: static unsigned long = DEFAULT_CARDBUS_IO_SIZE;
    let mut pci_cardbus_mem_size: static unsigned long = DEFAULT_CARDBUS_MEM_SIZE;
#[no_mangle]
pub unsafe extern "C" fn pci_cardbus_resource_alignment(res: *const resource) -> c_ulong {
    ...
    let mut b_res_3_size: resource_size_t = pci_cardbus_mem_size * 2;
    u16 ctrl;
...
#[no_mangle]
pub unsafe extern "C" fn pci_setup_cardbus_bridge(bus: *mut pci_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_setup_cardbus(str: *mut c_char) -> c_int {
