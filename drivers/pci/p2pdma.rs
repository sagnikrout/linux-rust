...
pub struct pci_p2pdma {
    ...
    pub p2pmem_published: bool,
    pub map_types: xarray,
    pub mem: [p2pdma_provider; PCI_STD_NUM_BARS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_p2pdma_pagemap {
    ...
    let mut len: usize = vma.vm_end - vma.vm_start;
    struct pci_p2pdma *p2pdma;
...
#[no_mangle]
unsafe extern "C" fn p2pdma_folio_free(folio: *mut folio) {
...
#[no_mangle]
unsafe extern "C" fn pci_p2pdma_release(data: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcim_p2pdma_init(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_p2pdma_setup_pool(pdev: *mut pci_dev) -> c_int {
...
// We already setup pools, do nothing,
    ...
    out_pool_destroy:
    gen_pool_destroy(p2pdma.pool);
    p2pdma.pool = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn pci_p2pdma_unmap_mappings(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn pci_bridge_has_acs_redir(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_buf_print_bus_devfn(buf: *mut seq_buf, pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cpu_supports_p2pdma() -> bool {
...
#[no_mangle]
unsafe extern "C" fn map_types_idx(client: *mut pci_dev) -> c_ulong {
...
//
    ...
    {
    let mut map_type: enum pci_p2pdma_map_type = PCI_P2PDMA_MAP_THRU_HOST_BRIDGE;
    struct pci_dev *a = provider, *b = client, *bb;
    let mut acs_redirects: bool = false;
    struct pci_p2pdma *p2pdma;
    struct seq_buf acs_list;
    let mut acs_cnt: c_int = 0;
    let mut dist_a: c_int = 0;
    let mut dist_b: c_int = 0;
    char buf[128];
...
//
    ...
    let mut not_supported: bool = false;
    struct pci_dev *pci_client;
    let mut total_dist: c_int = 0;
    int i, distance;
    if (num_clients == 0)
    return -1;
...
//
#[no_mangle]
unsafe extern "C" fn pci_has_p2pmem(pdev: *mut pci_dev) -> bool {
...
//
    ...
    int distance;
    let mut closest_distance: c_int = INT_MAX;
    struct pci_dev **closest_pdevs;
    let mut dev_cnt: c_int = 0;
    let mut max_devs: c_int = PAGE_SIZE / sizeof(*closest_pdevs);
    int i;
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_free_p2pmem(pdev: *mut pci_dev, addr: *mut c_void, size: usize) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_p2pmem_virt_to_bus(pdev: *mut pci_dev, addr: *mut c_void) -> pci_bus_addr_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_p2pmem_free_sgl(pdev: *mut pci_dev, sgl: *mut scatterlist) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_p2pmem_publish(pdev: *mut pci_dev, publish: bool) {
...
//
    ...
    struct device *dev)
    {
    let mut type: enum pci_p2pdma_map_type = PCI_P2PDMA_MAP_NOT_SUPPORTED;
...
//
    ...
    {
    struct device *dev;
    dev = bus_find_device_by_name(&pci_bus_type, core::ptr::null_mut(), page);
    if (dev) {
// use_p2pdma = true;
