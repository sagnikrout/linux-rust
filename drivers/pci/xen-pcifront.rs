...
//! Source: drivers/pci/xen-pcifront.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcifront_device {
    pub xdev: *mut xenbus_device,
    pub root_buses: list_head,
    pub evtchn: c_int,
    pub gnt_ref: grant_ref_t,
    pub irq: c_int,
// Lock this when doing any operations in sh_info
    pub sh_info_lock: spinlock_t,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcifront_sd {
    pub sd: pci_sysdata,
    pub pdev: *mut pcifront_device,
}
...
#[no_mangle]
unsafe extern "C" fn errno_to_pcibios_err(errno: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn schedule_pcifront_aer_op(pdev: *mut pcifront_device) {
...
#[no_mangle]
unsafe extern "C" fn do_pci_op(pdev: *mut pcifront_device, op: *mut xen_pci_op) -> c_int {
    static int do_pci_op(struct pcifront_device *pdev, struct xen_pci_op *op)
    {
    let mut err: c_int = 0;
    struct xen_pci_op *active_op = &pdev.sh_info.op;
    unsigned long irq_flags;
    let mut port: evtchn_port_t = pdev.evtchn;
    let mut irq: c_uint = pdev.irq;
    s64 ns, ns_timeout;
...
#[no_mangle]
unsafe extern "C" fn pci_frontend_disable_msix(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_frontend_enable_msi(dev: *mut pci_dev, vector[]: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_frontend_disable_msi(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_frontend_registrar(enable: c_int) {
    static void pci_frontend_registrar(int enable)
    {
    if (enable)
    xen_pci_frontend = &pci_frontend_ops;
    else
    xen_pci_frontend = core::ptr::null_mut();
    };
...
#[no_mangle]
unsafe extern "C" fn pcifront_claim_resource(dev: *mut pci_dev, data: *mut c_void) -> c_int {
...
// Device is already known.
    ...
    struct pci_bus *b;
    LIST_HEAD(resources);
    struct pcifront_sd *sd = core::ptr::null_mut();
    struct pci_bus_entry *bus_entry = core::ptr::null_mut();
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn free_root_bus_devs(bus: *mut pci_bus) {
...
#[no_mangle]
unsafe extern "C" fn pcifront_free_roots(pdev: *mut pcifront_device) {
    ...
    let mut bus: c_int = pdev.sh_info.aer_op.bus;
    let mut devfn: c_int = pdev.sh_info.aer_op.devfn;
    let mut domain: c_int = pdev.sh_info.aer_op.domain;
    ...
    dev_err(&pdev.xdev.dev, "device or AER driver is core::ptr::null_mut()\n");
    pci_dev_put(pcidev);
...
#[no_mangle]
unsafe extern "C" fn pcifront_handler_aer(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pcifront_connect_and_init_dma(pdev: *mut pcifront_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcifront_disconnect(pdev: *mut pcifront_device) {
    ...
    pcifront_dev = core::ptr::null_mut();
    }
    spin_unlock(&pcifront_dev_lock);
    }
...
#[no_mangle]
unsafe extern "C" fn free_pdev(pdev: *mut pcifront_device) {
    ...
    dev_set_drvdata(&pdev.xdev.dev, core::ptr::null_mut());
    kfree(pdev);
    }
#[no_mangle]
unsafe extern "C" fn pcifront_publish_info(pdev: *mut pcifront_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcifront_connect(pdev: *mut pcifront_device) {
...
#[no_mangle]
unsafe extern "C" fn pcifront_try_connect(pdev: *mut pcifront_device) {
...
#[no_mangle]
unsafe extern "C" fn pcifront_try_disconnect(pdev: *mut pcifront_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcifront_attach_devices(pdev: *mut pcifront_device) {
...
#[no_mangle]
unsafe extern "C" fn pcifront_detach_devices(pdev: *mut pcifront_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcifront_xenbus_remove(xdev: *mut xenbus_device) {
...
#[no_mangle]
unsafe extern "C" fn pcifront_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pcifront_cleanup() -> void __exit {
