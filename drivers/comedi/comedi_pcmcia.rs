...
//! Source: drivers/comedi/comedi_pcmcia.c
#![no_std]
...
//
    ...
    {
    return dev.hw_dev ? to_pcmcia_dev(dev.hw_dev) : core::ptr::null_mut();
    }
...
//
    ...
    ret = pcmcia_loop_config(link, conf_check, core::ptr::null_mut());
    if (ret)
    return ret;
