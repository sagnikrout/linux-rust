...
//! Source: drivers/comedi/kcomedilib/kcomedilib_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kcomedilib_set_link_from_to(from: c_uint, to: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kcomedilib_clear_link_from_to(from: c_uint, to: c_uint) {
...
//
    ...
    {
    struct comedi_device *dev, *retval = core::ptr::null_mut();
    unsigned int minor;
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_close_from(dev: *mut comedi_device, from: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn comedi_get_n_channels(dev: *mut comedi_device, subdevice: c_uint) -> c_int {
