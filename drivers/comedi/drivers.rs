...
//! Source: drivers/comedi/drivers.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_set_hw_dev(dev: *mut comedi_device, hw_dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comedi_clear_hw_dev(dev: *mut comedi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_alloc_subdevices(dev: *mut comedi_device, num_subdevices: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_alloc_subdev_readback(s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comedi_device_detach_cleanup(dev: *mut comedi_device) {
    ...
    if (!IS_ERR(dev.pacer))
    kfree(dev.pacer);
    dev.private = core::ptr::null_mut();
    dev.pacer = core::ptr::null_mut();
    dev.driver = core::ptr::null_mut();
    dev.board_name = core::ptr::null_mut();
    dev.board_ptr = core::ptr::null_mut();
    dev.mmio = core::ptr::null_mut();
    dev.iobase = 0;
    dev.iolen = 0;
    dev.ioenabled = false;
    dev.irq = 0;
    dev.read_subdev = core::ptr::null_mut();
    dev.write_subdev = core::ptr::null_mut();
    dev.open = core::ptr::null_mut();
    dev.close = core::ptr::null_mut();
    comedi_clear_hw_dev(dev);
    }
#[no_mangle]
pub unsafe extern "C" fn comedi_device_detach_locked(dev: *mut comedi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn comedi_device_detach(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn poll_invalid(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
//
    ...
    unsigned long context)
    {
    let mut timeout: c_ulong = jiffies + msecs_to_jiffies(COMEDI_TIMEOUT_MS);
    int ret;
...
//
    ...
    : 0xffffffff;
    let mut mask: c_uint = data[0] & chanmask;
    let mut bits: c_uint = data[1];
    if (mask) {
    s.state &= ~mask;
    s.state |= (bits & mask);
    }
...
#[no_mangle]
unsafe extern "C" fn _comedi_bytes_per_scan(s: *mut comedi_subdevice) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_bytes_per_scan(s: *mut comedi_subdevice) -> c_uint {
...
// Use nomimal, single sample scan length.
    ...
    {
    if (nscans == 0) {
    let mut nbytes: c_uint = _comedi_buf_read_n_available(s);
...
//
    ...
    struct comedi_async *async = s.async;
    struct comedi_cmd *cmd = &async.cmd;
    let mut scan_length: c_uint = _comedi_bytes_per_scan(s);
// track the 'cur_chan' for non-SDF_PACKED subdevices
    ...
    let mut nscans: c_uint = async.scan_progress / scan_length;
...
//
    ...
    struct comedi_subdevice *s)
    {
    let mut events: c_uint = s.async.events;
    if (events == 0)
    return events;
...
//
    ...
    let mut chan: c_uint = CR_CHAN(insn.chanspec);
    let mut base_chan: c_uint = (chan < 32) ? 0 : chan;
...
#[no_mangle]
unsafe extern "C" fn __comedi_device_postconfig(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comedi_device_postconfig(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comedi_report_boards(driv: *mut comedi_driver) {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_legacy_detach(dev: *mut comedi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn comedi_device_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
...
//
    ...
    int ret;
    if (!hardware_device) {
    pr_warn("BUG! %s called with core::ptr::null_mut() hardware_device\n", __func__);
    return -EINVAL;
    }
    if (!driver) {
    dev_warn(hardware_device,
    "BUG! %s called with core::ptr::null_mut() comedi driver\n", __func__);
    return -EINVAL;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_auto_unconfig(hardware_device: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_driver_register(driver: *mut comedi_driver) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_driver_unregister(driver: *mut comedi_driver) {
