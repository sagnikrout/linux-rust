...
//! Source: drivers/comedi/drivers/ni_atmio16d.c
#![no_std]
...
pub const COM_REG_1: c_uint = 0x00	/* wo 16 */;
pub const STAT_REG: c_uint = 0x00	/* ro 16 */;
pub const COM_REG_2: c_uint = 0x02	/* wo 16 */;
// Event Strobe Registers
pub const START_CONVERT_REG: c_uint = 0x08	/* wo 16 */;
pub const START_DAQ_REG: c_uint = 0x0A	/* wo 16 */;
pub const AD_CLEAR_REG: c_uint = 0x0C	/* wo 16 */;
pub const EXT_STROBE_REG: c_uint = 0x0E	/* wo 16 */;
// Analog Output Registers
pub const DAC0_REG: c_uint = 0x10	/* wo 16 */;
pub const DAC1_REG: c_uint = 0x12	/* wo 16 */;
pub const INT2CLR_REG: c_uint = 0x14	/* wo 16 */;
// Analog Input Registers
pub const MUX_CNTR_REG: c_uint = 0x04	/* wo 16 */;
pub const MUX_GAIN_REG: c_uint = 0x06	/* wo 16 */;
pub const AD_FIFO_REG: c_uint = 0x16	/* ro 16 */;
pub const DMA_TC_INT_CLR_REG: c_uint = 0x16	/* wo 16 */;
// AM9513A Counter/Timer Registers
pub const AM9513A_DATA_REG: c_uint = 0x18	/* rw 16 */;
pub const AM9513A_COM_REG: c_uint = 0x1A	/* wo 16 */;
pub const AM9513A_STAT_REG: c_uint = 0x1A	/* ro 16 */;
// MIO-16 Digital I/O Registers
pub const MIO_16_DIG_IN_REG: c_uint = 0x1C	/* ro 16 */;
pub const MIO_16_DIG_OUT_REG: c_uint = 0x1C	/* wo 16 */;
// RTSI Switch Registers
pub const RTSI_SW_SHIFT_REG: c_uint = 0x1E	/* wo 8 */;
pub const RTSI_SW_STROBE_REG: c_uint = 0x1F	/* wo 8 */;
// DIO-24 Registers
pub const DIO_24_PORTA_REG: c_uint = 0x00	/* rw 8 */;
pub const DIO_24_PORTB_REG: c_uint = 0x01	/* rw 8 */;
pub const DIO_24_PORTC_REG: c_uint = 0x02	/* rw 8 */;
pub const DIO_24_CNFG_REG: c_uint = 0x03	/* wo 8 */;
// Command Register bits
pub const COMREG1_2SCADC: c_uint = 0x0001;
pub const COMREG1_1632CNT: c_uint = 0x0002;
pub const COMREG1_SCANEN: c_uint = 0x0008;
pub const COMREG1_DAQEN: c_uint = 0x0010;
pub const COMREG1_DMAEN: c_uint = 0x0020;
pub const COMREG1_CONVINTEN: c_uint = 0x0080;
pub const COMREG2_SCN2: c_uint = 0x0010;
pub const COMREG2_INTEN: c_uint = 0x0080;
pub const COMREG2_DOUTEN0: c_uint = 0x0100;
pub const COMREG2_DOUTEN1: c_uint = 0x0200;
// Status Register bits
pub const STAT_AD_OVERRUN: c_uint = 0x0100;
pub const STAT_AD_OVERFLOW: c_uint = 0x0200;
pub const STAT_AD_DAQPROG: c_uint = 0x0800;
pub const STAT_AD_CONVAVAIL: c_uint = 0x2000;
pub const STAT_AD_DAQSTOPINT: c_uint = 0x4000;
// AM9513A Counter/Timer defines
pub const CLOCK_1_MHZ: c_uint = 0x8B25;
pub const CLOCK_100_KHZ: c_uint = 0x8C25;
pub const CLOCK_10_KHZ: c_uint = 0x8D25;
pub const CLOCK_1_KHZ: c_uint = 0x8E25;
pub const CLOCK_100_HZ: c_uint = 0x8F25;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmio16_board_t {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmio16d_private {
    pub adc_mux: enum { adc_diff, adc_singleended },
    pub adc_range: enum { adc_bipolar10, adc_bipolar5, adc_unipolar10 },
    pub adc_coding: enum { adc_2comp, adc_straight },
    pub dac1_range: enum { dac_bipolar, dac_unipolar } dac0_range,,
    pub dac1_reference: enum { dac_internal, dac_external } dac0_reference,,
    pub dac1_coding: enum { dac_2comp, dac_straight } dac0_coding,,
    pub ao_range_type_list: [*const comedi_lrange; 2],
    pub /: *mut *mut unsigned int com_reg_1_state; / current state of command register 1,
    pub /: *mut *mut unsigned int com_reg_2_state; / current state of command register 2,
}

#[no_mangle]
unsafe extern "C" fn reset_counters(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn reset_atmio16d(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn atmio16d_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
// change to two's complement if need be
    ...
    let mut reg: c_uint = (chan) ? DAC1_REG : DAC0_REG;
    let mut munge: bool = false;
    int i;
...
#[no_mangle]
unsafe extern "C" fn atmio16d_detach(dev: *mut comedi_device) {
