...
//! Source: drivers/comedi/drivers/das16m1.c
#![no_std]
...
//
pub const DAS16M1_AI_REG: c_uint = 0x00	/* 16-bit register */;

pub const DAS16M1_CS_REG: c_uint = 0x02;

pub const DAS16M1_DI_REG: c_uint = 0x03;
pub const DAS16M1_DO_REG: c_uint = 0x03;
pub const DAS16M1_CLR_INTR_REG: c_uint = 0x04;
pub const DAS16M1_INTR_CTRL_REG: c_uint = 0x05;

pub const DAS16M1_Q_ADDR_REG: c_uint = 0x06;
pub const DAS16M1_Q_REG: c_uint = 0x07;

pub const DAS16M1_8254_IOBASE1: c_uint = 0x08;
pub const DAS16M1_8254_IOBASE2: c_uint = 0x0c;
pub const DAS16M1_8255_IOBASE: c_uint = 0x400;
pub const DAS16M1_8254_IOBASE3: c_uint = 0x404;
pub const DAS16M1_SIZE2: c_uint = 0x08;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct das16m1_private {
    pub counter: *mut comedi_8254,
    pub intr_ctrl: c_uint,
    pub adc_count: c_uint,
    pub initial_hw_count: u16,
    pub ai_buffer: [c_ushort; DAS16M1_AI_FIFO_SZ],
    ...
    unsigned int i;
    for (i = 0; i < len; i++) {
    let mut chan: c_uint = CR_CHAN(chanspec[i]);
    let mut range: c_uint = CR_RANGE(chanspec[i]);
...
#[no_mangle]
unsafe extern "C" fn das16m1_handler(dev: *mut comedi_device, status: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn das16m1_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn das16m1_irq_bits(irq: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn das16m1_detach(dev: *mut comedi_device) {
