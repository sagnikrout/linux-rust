...
//! Source: drivers/comedi/drivers/tests/ni_routes_test.c
#![no_std]
...
// *** BEGIN fake board data ***
    ...
    let mut bad_dest: static int = O(8), dest0 = O(0), desti = O(5);
    let mut ith_dest_index: static int = 2;
    let mut no_val_dest: static int = O(7), no_val_index = 4;
...
#[no_mangle]
unsafe extern "C" fn init_private() {
    static void init_private(void)
    {
    memset(&private, 0, sizeof(struct ni_private));
    }
#[no_mangle]
unsafe extern "C" fn init_pci_6070e() {
...
#[no_mangle]
unsafe extern "C" fn init_pci_6220() {
...
#[no_mangle]
unsafe extern "C" fn init_pci_fake() {
...
#[no_mangle]
unsafe extern "C" fn route_set_dests_in_order(devroutes: *const ni_device_routes) -> bool {
    static bool route_set_dests_in_order(const struct ni_device_routes *devroutes)
    {
    int i;
    let mut last: c_int = NI_NAMES_BASE - 1;
...
#[no_mangle]
unsafe extern "C" fn route_set_sources_in_order(devroutes: *const ni_device_routes) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_ni_assign_device_routes() {
    static void test_ni_assign_device_routes(void)
    {
    const struct ni_device_routes *devroutes;
    const u8 *table, *oldtable;
    init_pci_6070e();
    ni_assign_device_routes(ni_eseries, pci_6070e, core::ptr::null_mut(),
    ...
    oldtable = table;
    init_pci_6220();
    ni_assign_device_routes(ni_mseries, pci_6220, core::ptr::null_mut(),
    &private.routing_tables);
    devroutes = private.routing_tables.valid_routes;
    table = private.routing_tables.route_values;
...
#[no_mangle]
unsafe extern "C" fn test_ni_sort_device_routes() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_find_route_set() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_route_set_has_source() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_route_to_register() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_lookup_route_register() {
...
#[no_mangle]
unsafe extern "C" fn test_route_is_valid() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_is_cmd_dest() {
...
#[no_mangle]
unsafe extern "C" fn test_channel_is_pfi() {
...
#[no_mangle]
unsafe extern "C" fn test_channel_is_rtsi() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_count_valid_routes() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_get_valid_routes() {
    static void test_ni_get_valid_routes(void)
    {
    const struct ni_route_tables *T = &private.routing_tables;
    unsigned int pair_data[2];
    init_pci_fake();
    unittest(ni_get_valid_routes(T, 0, core::ptr::null_mut()) == 57,
...
#[no_mangle]
unsafe extern "C" fn test_ni_find_route_source() {
...
#[no_mangle]
unsafe extern "C" fn test_route_register_is_valid() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_check_trigger_arg() {
...
#[no_mangle]
unsafe extern "C" fn test_ni_get_reg_value() {
...
#[no_mangle]
unsafe extern "C" fn ni_routes_unittest() -> int __init {
