...
//! Source: drivers/comedi/drivers/amplc_dio200_pci.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dio200_pcie_board_setup(dev: *mut comedi_device) -> c_int {
...
// Enable "enhanced" features of board.
    ...
    const struct dio200_board *board = core::ptr::null_mut();
    unsigned int bar;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn dio200_pci_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
