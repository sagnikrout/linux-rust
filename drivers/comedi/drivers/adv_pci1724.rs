...
//! Source: drivers/comedi/drivers/adv_pci1724.c
#![no_std]
...
//
pub const PCI1724_DAC_CTRL_REG: c_uint = 0x00;

pub const PCI1724_SYNC_CTRL_REG: c_uint = 0x04;

pub const PCI1724_EEPROM_CTRL_REG: c_uint = 0x08;
pub const PCI1724_SYNC_TRIG_REG: c_uint = 0x0c  /* any value works */;
pub const PCI1724_BOARD_ID_REG: c_uint = 0x10;
    ...
    unsigned int *data)
    {
    let mut mode: c_ulong = (unsigned long)s.private;
