...
//! Source: drivers/comedi/drivers/pcl730.c
#![no_std]
...
pub struct pcl730_board {
    ...
    pub io_range: c_ushort,
    pub min_io_start: c_ushort,
    pub align_io_start: c_ushort,
    pub is_pcl725:1: unsigned,
    pub is_acl7225b:1: unsigned,
    pub is_ir104:1: unsigned,
    pub has_readback:1: unsigned,
    pub has_ttl_io:1: unsigned,
    pub n_subdevs: c_int,
    pub n_iso_out_chan: c_int,
    pub n_iso_in_chan: c_int,
    pub n_ttl_chan: c_int,
}
