...
//! Source: drivers/comedi/drivers/das1800.c
#![no_std]
...
pub const DMA_BUF_SIZE: c_uint = 0x1ff00	/*  size in bytes of dma buffers */;
// Registers for the das1800
pub const DAS1800_FIFO: c_uint = 0x0;
pub const DAS1800_QRAM: c_uint = 0x0;
pub const DAS1800_DAC: c_uint = 0x0;
pub const DAS1800_SELECT: c_uint = 0x2;
pub const ADC: c_uint = 0x0;
pub const QRAM: c_uint = 0x1;

pub const DAS1800_DIGITAL: c_uint = 0x3;
pub const DAS1800_CONTROL_A: c_uint = 0x4;
pub const FFEN: c_uint = 0x1;
pub const CGEN: c_uint = 0x4;
pub const CGSL: c_uint = 0x8;
pub const TGEN: c_uint = 0x10;
pub const TGSL: c_uint = 0x20;
pub const TGPL: c_uint = 0x40;
pub const ATEN: c_uint = 0x80;
pub const DAS1800_CONTROL_B: c_uint = 0x5;
pub const DMA_CH5: c_uint = 0x1;
pub const DMA_CH6: c_uint = 0x2;
pub const DMA_CH7: c_uint = 0x3;
pub const DMA_CH5_CH6: c_uint = 0x5;
pub const DMA_CH6_CH7: c_uint = 0x6;
pub const DMA_CH7_CH5: c_uint = 0x7;
pub const DMA_ENABLED: c_uint = 0x3;
pub const DMA_DUAL: c_uint = 0x4;
pub const IRQ3: c_uint = 0x8;
pub const IRQ5: c_uint = 0x10;
pub const IRQ7: c_uint = 0x18;
pub const IRQ10: c_uint = 0x28;
pub const IRQ11: c_uint = 0x30;
pub const IRQ15: c_uint = 0x38;
pub const FIMD: c_uint = 0x40;

pub const IPCLK: c_uint = 0x1;
pub const XPCLK: c_uint = 0x3;
pub const BMDE: c_uint = 0x4;
pub const CMEN: c_uint = 0x8;
pub const UQEN: c_uint = 0x10;
pub const SD: c_uint = 0x40;
pub const UB: c_uint = 0x80;
pub const DAS1800_STATUS: c_uint = 0x7;
pub const INT: c_uint = 0x1;
pub const DMATC: c_uint = 0x2;
pub const CT0TC: c_uint = 0x8;
pub const OVF: c_uint = 0x10;
pub const FHF: c_uint = 0x20;
pub const FNE: c_uint = 0x40;
pub const CVEN: c_uint = 0x80;
pub const CVEN_MASK: c_uint = 0x40;

pub const DAS1800_BURST_LENGTH: c_uint = 0x8;
pub const DAS1800_BURST_RATE: c_uint = 0x9;
pub const DAS1800_QRAM_ADDRESS: c_uint = 0xa;
pub const DAS1800_COUNTER: c_uint = 0xc;
pub const IOBASE2: c_uint = 0x400;
...
pub const DAS1800_ID_ST_DA: c_uint = 0x3;
pub const DAS1800_ID_HR_DA: c_uint = 0x4;
pub const DAS1800_ID_AO: c_uint = 0x5;
pub const DAS1800_ID_HR: c_uint = 0x6;
pub const DAS1800_ID_ST: c_uint = 0x7;
pub const DAS1800_ID_HC: c_uint = 0x8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct das1800_board {
    pub name: *const c_char,
    pub id: c_uchar,
    pub ai_speed: c_uint,
    pub is_01_series:1: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct das1800_private {
    pub dma: *mut comedi_isadma,
    pub irq_dma_bits: c_int,
    pub dma_bits: c_int,
    pub fifo_buf: *mut c_ushort,
    pub iobase2: c_ulong,
    pub ai_is_unipolar: bool,
}
    ...
    {
    struct das1800_private *devpriv = dev.private;
    let mut nsamples: c_uint = comedi_nsamples_left(s, FIFO_SIZE / 2);
    ...
    {
    let mut residue: c_uint = comedi_isadma_disable(desc.chan);
    let mut nbytes: c_uint = desc.size - residue;
...
// figure out how many points to read
    ...
    let mut dual_dma: c_int = devpriv.irq_dma_bits & DMA_DUAL;
...
#[no_mangle]
unsafe extern "C" fn das1800_ai_handler(dev: *mut comedi_device) {
    ...
    let mut status: c_uint = inb(dev.iobase + DAS1800_STATUS);
...
#[no_mangle]
pub unsafe extern "C" fn if(FHF: status &) -> else {
    else if (status & FHF)
    das1800_handle_fifo_half_full(dev, s);
#[no_mangle]
pub unsafe extern "C" fn if(FNE: status &) -> else {
    else if (status & FNE)
    das1800_handle_fifo_not_empty(dev, s);
...
#[no_mangle]
unsafe extern "C" fn das1800_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
//
    ...
    struct comedi_cmd *cmd)
    {
    let mut range: c_uint = CR_RANGE(cmd.chanlist[0]);
    let mut unipolar0: bool = comedi_range_is_unipolar(s, range);
    int i;
...
// Step 5: check channel list if it exists
    ...
    {
    struct comedi_cmd *cmd = &s.async.cmd;
    let mut max_samples: c_uint = comedi_bytes_to_samples(s, maxbytes);
...
// enable and start conversions
    ...
    let mut is_unipolar: bool = comedi_range_is_unipolar(s, range);
    let mut ret: c_int = 0;
    int n;
    unsigned short dpnt;
    unsigned long flags;
...
// trigger conversion
    ...
    let mut update_chan: c_uint = s.n_chan - 1;
    unsigned long flags;
    int i;
// protects the indirect addressing selected by DAS1800_SELECT
    spin_lock_irqsave(&dev.spinlock, flags);
...
#[no_mangle]
unsafe extern "C" fn das1800_free_dma(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn das1800_probe(dev: *mut comedi_device) -> c_int {
...
// das-1801hc, das-1802hc
    ...
    struct comedi_subdevice *s;
    let mut irq: c_uint = it.options[1];
    bool is_16bit;
    int ret;
    int i;
...
// waveform 'ao' boards have additional io ports
    ...
    let mut iobase2: c_ulong = dev.iobase + IOBASE2;
...
#[no_mangle]
unsafe extern "C" fn das1800_detach(dev: *mut comedi_device) {
