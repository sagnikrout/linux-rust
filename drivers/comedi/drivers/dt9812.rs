...
//! Source: drivers/comedi/drivers/dt9812.c
#![no_std]
...
pub const DT9812_DIAGS_BOARD_INFO_ADDR: c_uint = 0xFBFF;
pub const DT9812_MAX_WRITE_CMD_PIPE_SIZE: c_int = 32;
pub const DT9812_MAX_READ_CMD_PIPE_SIZE: c_int = 32;
// usb_bulk_msg() timeout in milliseconds
pub const DT9812_USB_TIMEOUT: c_int = 1000;
//
// See Silican Laboratories C8051F020/1/2/3 manual
//
pub const F020_SFR_P4: c_uint = 0x84;
pub const F020_SFR_P1: c_uint = 0x90;
pub const F020_SFR_P2: c_uint = 0xa0;
pub const F020_SFR_P3: c_uint = 0xb0;
pub const F020_SFR_AMX0CF: c_uint = 0xba;
pub const F020_SFR_AMX0SL: c_uint = 0xbb;
pub const F020_SFR_ADC0CF: c_uint = 0xbc;
pub const F020_SFR_ADC0L: c_uint = 0xbe;
pub const F020_SFR_ADC0H: c_uint = 0xbf;
pub const F020_SFR_DAC0L: c_uint = 0xd2;
pub const F020_SFR_DAC0H: c_uint = 0xd3;
pub const F020_SFR_DAC0CN: c_uint = 0xd4;
pub const F020_SFR_DAC1L: c_uint = 0xd5;
pub const F020_SFR_DAC1H: c_uint = 0xd6;
pub const F020_SFR_DAC1CN: c_uint = 0xd7;
pub const F020_SFR_ADC0CN: c_uint = 0xe8;
pub const F020_MASK_ADC0CF_AMP0GN0: c_uint = 0x01;
pub const F020_MASK_ADC0CF_AMP0GN1: c_uint = 0x02;
pub const F020_MASK_ADC0CF_AMP0GN2: c_uint = 0x04;
pub const F020_MASK_ADC0CN_AD0EN: c_uint = 0x80;
pub const F020_MASK_ADC0CN_AD0INT: c_uint = 0x20;
pub const F020_MASK_ADC0CN_AD0BUSY: c_uint = 0x10;
pub const F020_MASK_DACXCN_DACXEN: c_uint = 0x80;
    enum {
// A/D  D/A  DI  DO  CT
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt9812_read_multi {
    pub count: u8,
    pub address: [u8; DT9812_MAX_NUM_MULTI_BYTE_RDS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt9812_write_byte {
    pub address: u8,
    pub value: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt9812_write_multi {
    pub count: u8,
    pub write: [dt9812_write_byte; DT9812_MAX_NUM_MULTI_BYTE_WRTS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt9812_rmw_byte {
    pub address: u8,
    pub and_mask: u8,
    pub or_value: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt9812_rmw_multi {
    pub count: u8,
    pub rmw: [dt9812_rmw_byte; DT9812_MAX_NUM_MULTI_BYTE_RMWS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt9812_usb_cmd {
    pub cmd: __le32,
    union {
    pub flash_data_info: dt9812_flash_data,
    pub read_multi_info: dt9812_read_multi,
    pub write_multi_info: dt9812_write_multi,
    pub rmw_multi_info: dt9812_rmw_multi,
    pub u: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt9812_private {
    pub mut: mutex,
    struct {
    pub addr: __u8,
    pub size: usize,
...
#[no_mangle]
unsafe extern "C" fn dt9812_digital_in(dev: *mut comedi_device, bits: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt9812_digital_out(dev: *mut comedi_device, bits: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt9812_analog_out(dev: *mut comedi_device, channel: c_int, value: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt9812_find_endpoints(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt9812_reset_device(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt9812_detach(dev: *mut comedi_device) {
