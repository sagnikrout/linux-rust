...
//! Source: drivers/comedi/drivers/addi_apci_3120.c
#![no_std]
...
//
pub const APCI3120_AI_FIFO_REG: c_uint = 0x00;
pub const APCI3120_CTRL_REG: c_uint = 0x00;

pub const APCI3120_AI_SOFTTRIG_REG: c_uint = 0x02;
pub const APCI3120_STATUS_REG: c_uint = 0x02;

pub const APCI3120_TIMER_REG: c_uint = 0x04;
pub const APCI3120_CHANLIST_REG: c_uint = 0x06;

pub const APCI3120_TIMER_MODE_REG: c_uint = 0x0c;

pub const APCI3120_CTR0_REG: c_uint = 0x0d;

pub const APCI3120_MODE_REG: c_uint = 0x0e;

//
// PCI BAR 2 register map (devpriv->addon)
//
pub const APCI3120_ADDON_ADDR_REG: c_uint = 0x00;
pub const APCI3120_ADDON_DATA_REG: c_uint = 0x02;
pub const APCI3120_ADDON_CTRL_REG: c_uint = 0x04;

//
// Board revisions
//
pub const APCI3120_REVA: c_uint = 0xa;
pub const APCI3120_REVB: c_uint = 0xb;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apci3120_dmabuf {
    pub virt: *mut c_ushort,
    pub hw: dma_addr_t,
    pub size: c_uint,
    pub use_size: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apci3120_private {
    pub amcc: c_ulong,
    pub addon: c_ulong,
    pub osc_base: c_uint,
    pub use_dma:1: c_uint,
    pub use_double_buffer:1: c_uint,
    pub cur_dmabuf:1: c_uint,
    pub dmabuf: [apci3120_dmabuf; 2],
    pub do_bits: c_uchar,
    pub timer_mode: c_uchar,
    pub mode: c_uchar,
    pub ctrl: c_ushort,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(dmalen0): *mut *mut dmalen1 > (cmd->stop_arg  scan_bytes -) -> else {
...
//
    ...
    {
    struct apci3120_private *devpriv = dev.private;
    let mut prescale: c_uint = (timer == 0) ? 10 : 1000;
    let mut timer_base: c_uint = devpriv.osc_base * prescale;
...
#[no_mangle]
unsafe extern "C" fn apci3120_clr_timer2_interrupt(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn apci3120_exttrig_enable(dev: *mut comedi_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn apci3120_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn apci3120_dma_alloc(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn apci3120_dma_free(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn apci3120_reset(dev: *mut comedi_device) {
...
// clear interrupt status
    ...
    const struct apci3120_board *board = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn apci3120_detach(dev: *mut comedi_device) {
