...
//! Source: drivers/comedi/drivers/multiq3.c
#![no_std]
...
// Register map
//
pub const MULTIQ3_DI_REG: c_uint = 0x00;
pub const MULTIQ3_DO_REG: c_uint = 0x00;
pub const MULTIQ3_AO_REG: c_uint = 0x02;
pub const MULTIQ3_AI_REG: c_uint = 0x04;
pub const MULTIQ3_AI_CONV_REG: c_uint = 0x04;
pub const MULTIQ3_STATUS_REG: c_uint = 0x06;

pub const MULTIQ3_CTRL_REG: c_uint = 0x06;

pub const MULTIQ3_CLK_REG: c_uint = 0x08;
pub const MULTIQ3_ENC_DATA_REG: c_uint = 0x0c;
pub const MULTIQ3_ENC_CTRL_REG: c_uint = 0x0e;
//
// Encoder chip commands (from the programming manual)
//
pub const MULTIQ3_CLOCK_DATA: c_uint = 0x00	/* FCK frequency divider */;
pub const MULTIQ3_CLOCK_SETUP: c_uint = 0x18	/* xfer PR0 to PSC */;
pub const MULTIQ3_INPUT_SETUP: c_uint = 0x41	/* enable inputs A and B */;
pub const MULTIQ3_QUAD_X4: c_uint = 0x38	/* quadrature */;
pub const MULTIQ3_BP_RESET: c_uint = 0x01	/* reset byte pointer */;
pub const MULTIQ3_CNTR_RESET: c_uint = 0x02	/* reset counter */;
pub const MULTIQ3_TRSFRPR_CTR: c_uint = 0x08	/* xfre preset reg to counter */;
pub const MULTIQ3_TRSFRCNTR_OL: c_uint = 0x10	/* xfer CNTR to OL (x and y) */;
pub const MULTIQ3_EFLAG_RESET: c_uint = 0x06	/* reset E bit of flag reg */;
//
// Limit on the number of optional encoder channels
//
pub const MULTIQ3_MAX_ENC_CHANS: c_int = 8;
#[no_mangle]
unsafe extern "C" fn multiq3_set_ctrl(dev: *mut comedi_device, bits: c_uint) {
