...
//! Source: drivers/comedi/drivers/ni_pcimio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn m_series_init_eeprom_buffer(dev: *mut comedi_device) {
    static void m_series_init_eeprom_buffer(struct comedi_device *dev)
    {
    struct ni_private *devpriv = dev.private;
    struct mite *mite = devpriv.mite;
    resource_size_t daq_phys_addr;
    let mut start_cal_eeprom: static int = 0x400;
    let mut window_size: static unsigned int = 10;
...
#[no_mangle]
unsafe extern "C" fn init_6143(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcimio_detach(dev: *mut comedi_device) {
    ...
    const struct ni_board_struct *board = core::ptr::null_mut();
