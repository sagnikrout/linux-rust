...
//! Source: drivers/comedi/drivers/dt2801.c
#![no_std]
...
pub const DT2801_TIMEOUT: c_int = 1000;
...
// ======================
// Commands
pub const DT_C_RESET: c_uint = 0x0;
pub const DT_C_CLEAR_ERR: c_uint = 0x1;
pub const DT_C_READ_ERRREG: c_uint = 0x2;
pub const DT_C_SET_CLOCK: c_uint = 0x3;
pub const DT_C_TEST: c_uint = 0xb;
pub const DT_C_STOP: c_uint = 0xf;
pub const DT_C_SET_DIGIN: c_uint = 0x4;
pub const DT_C_SET_DIGOUT: c_uint = 0x5;
pub const DT_C_READ_DIG: c_uint = 0x6;
pub const DT_C_WRITE_DIG: c_uint = 0x7;
pub const DT_C_WRITE_DAIM: c_uint = 0x8;
pub const DT_C_SET_DA: c_uint = 0x9;
pub const DT_C_WRITE_DA: c_uint = 0xa;
pub const DT_C_READ_ADIM: c_uint = 0xc;
pub const DT_C_SET_AD: c_uint = 0xd;
pub const DT_C_READ_AD: c_uint = 0xe;
//
...
// registers
pub const DT2801_DATA: c_int = 0;
pub const DT2801_STATUS: c_int = 1;
pub const DT2801_CMD: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt2801_board {
    pub name: *const c_char,
    pub boardcode: c_int,
    pub ad_diff: c_int,
    pub ad_chan: c_int,
    pub adbits: c_int,
    pub adrangetype: c_int,
    pub dabits: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt2801_private {
    pub dac_range_types: [*const comedi_lrange; 2],
}
...
//
#[no_mangle]
unsafe extern "C" fn dt2801_readdata(dev: *mut comedi_device, data: *mut c_int) -> c_int {
    static int dt2801_readdata(struct comedi_device *dev, int *data)
    {
    let mut stat: c_int = 0;
    let mut timeout: c_int = DT2801_TIMEOUT;
    do {
...
#[no_mangle]
unsafe extern "C" fn dt2801_readdata2(dev: *mut comedi_device, data: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt2801_writedata(dev: *mut comedi_device, data: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt2801_writedata2(dev: *mut comedi_device, data: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt2801_wait_for_ready(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt2801_writecmd(dev: *mut comedi_device, command: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dt2801_reset(dev: *mut comedi_device) -> c_int {
    static int dt2801_reset(struct comedi_device *dev)
    {
    let mut board_code: c_int = 0;
    unsigned int stat;
    int timeout;
...
#[no_mangle]
unsafe extern "C" fn probe_number_of_ai_chans(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt2801_error(dev: *mut comedi_device, stat: c_int) -> c_int {
    ...
    unsigned int *data)
    {
    let mut which: c_int = (s == &dev.subdevices[3]) ? 1 : 0;
...
//
#[no_mangle]
unsafe extern "C" fn dt2801_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
