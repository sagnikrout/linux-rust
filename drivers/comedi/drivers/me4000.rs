...
//! Source: drivers/comedi/drivers/me4000.c
#![no_std]
...
pub const ME4000_AI_CTRL_REG: c_uint = 0x74;
pub const ME4000_AI_STATUS_REG: c_uint = 0x74;

pub const ME4000_AI_CHANNEL_LIST_REG: c_uint = 0x78;

pub const ME4000_AI_DATA_REG: c_uint = 0x7c;
pub const ME4000_AI_CHAN_TIMER_REG: c_uint = 0x80;
pub const ME4000_AI_CHAN_PRE_TIMER_REG: c_uint = 0x84;
pub const ME4000_AI_SCAN_TIMER_LOW_REG: c_uint = 0x88;
pub const ME4000_AI_SCAN_TIMER_HIGH_REG: c_uint = 0x8c;
pub const ME4000_AI_SCAN_PRE_TIMER_LOW_REG: c_uint = 0x90;
pub const ME4000_AI_SCAN_PRE_TIMER_HIGH_REG: c_uint = 0x94;
pub const ME4000_AI_START_REG: c_uint = 0x98;
pub const ME4000_IRQ_STATUS_REG: c_uint = 0x9c;

pub const ME4000_DIO_PORT_0_REG: c_uint = 0xa0;
pub const ME4000_DIO_PORT_1_REG: c_uint = 0xa4;
pub const ME4000_DIO_PORT_2_REG: c_uint = 0xa8;
pub const ME4000_DIO_PORT_3_REG: c_uint = 0xac;
pub const ME4000_DIO_DIR_REG: c_uint = 0xb0;
pub const ME4000_AO_LOADSETREG_XX: c_uint = 0xb4;
pub const ME4000_DIO_CTRL_REG: c_uint = 0xb8;

pub const ME4000_AO_DEMUX_ADJUST_REG: c_uint = 0xbc;
pub const ME4000_AO_DEMUX_ADJUST_VALUE: c_uint = 0x4c;
pub const ME4000_AI_SAMPLE_COUNTER_REG: c_uint = 0xc0;
pub const ME4000_AI_FIFO_COUNT: c_int = 2048;
pub const ME4000_AI_MIN_TICKS: c_int = 66;
pub const ME4000_AI_MIN_SAMPLE_TIME: c_int = 2000;
pub const ME4000_AI_CHANNEL_LIST_COUNT: c_int = 1024;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct me4000_private {
    pub plx_regbase: c_ulong,
    pub ai_ctrl_mode: c_uint,
    pub ai_init_ticks: c_uint,
    pub ai_scan_ticks: c_uint,
    pub ai_chan_ticks: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct me4000_board {
    pub name: *const c_char,
    pub ai_nchan: c_int,
    pub can_do_diff_ai:1: c_uint,
    pub /: *mut *mut unsigned int can_do_sh_ai:1; / sample & hold (8 channels),
    pub ex_trig_analog:1: c_uint,
    pub has_ao:1: c_uint,
    pub has_ao_fifo:1: c_uint,
    pub has_counter:1: c_uint,
}
...
//
    ...
    let mut xilinx_iobase: c_ulong = pci_resource_start(pcidev, 5);
...
#[no_mangle]
unsafe extern "C" fn me4000_ai_reset(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn me4000_reset(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn me4000_ai_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    ...
    {
    struct pci_dev *pcidev = comedi_to_pci_dev(dev);
    const struct me4000_board *board = core::ptr::null_mut();
...
// Counter subdevice (8254)
    ...
    let mut timer_base: c_ulong = pci_resource_start(pcidev, 3);
    if (!timer_base)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn me4000_detach(dev: *mut comedi_device) {
