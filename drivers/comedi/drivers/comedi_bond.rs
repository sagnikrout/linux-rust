...
//! Source: drivers/comedi/drivers/comedi_bond.c
#![no_std]
...
//
    ...
    let mut minor: c_int = it.options[i];
    struct comedi_device *d;
    let mut sdev: c_int = -1, nchans;
    struct bonded_device *bdev;
    struct bonded_device **devs;
...
unsafe extern "C" fn bonding_detach(dev: *mut comedi_device) {
    ...
    kfree(devpriv.devs);
    devpriv.devs = core::ptr::null_mut();
    }
    }
