...
//! Source: drivers/comedi/drivers/das6402.c
#![no_std]
...
// Register I/O map
//
pub const DAS6402_AI_DATA_REG: c_uint = 0x00;
pub const DAS6402_AI_MUX_REG: c_uint = 0x02;

pub const DAS6402_DI_DO_REG: c_uint = 0x03;

pub const DAS6402_STATUS_REG: c_uint = 0x08;

pub const DAS6402_CTRL_REG: c_uint = 0x09;

pub const DAS6402_TRIG_REG: c_uint = 0x0a;

pub const DAS6402_MODE_REG: c_uint = 0x0b;

pub const DAS6402_TIMER_BASE: c_uint = 0x0c;
...
#[no_mangle]
unsafe extern "C" fn das6402_clear_all_interrupts(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn das6402_ai_clear_eoc(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn das6402_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
    ...
    let mut chan_lo: c_uint = CR_CHAN(cmd.chanlist[0]);
    let mut chan_hi: c_uint = CR_CHAN(cmd.chanlist[cmd.chanlist_len - 1]);
...
#[no_mangle]
unsafe extern "C" fn das6402_ai_soft_trig(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn das6402_reset(dev: *mut comedi_device) {
