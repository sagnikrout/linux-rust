...
//! Source: drivers/comedi/drivers/pcl726.c
#![no_std]
...
pub const PCL726_DO_MSB_REG: c_uint = 0x0c;
pub const PCL726_DO_LSB_REG: c_uint = 0x0d;
pub const PCL726_DI_MSB_REG: c_uint = 0x0e;
pub const PCL726_DI_LSB_REG: c_uint = 0x0f;
pub const PCL727_DI_MSB_REG: c_uint = 0x00;
pub const PCL727_DI_LSB_REG: c_uint = 0x01;
pub const PCL727_DO_MSB_REG: c_uint = 0x18;
pub const PCL727_DO_LSB_REG: c_uint = 0x19;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcl726_board {
    pub name: *const c_char,
    pub io_len: c_uint,
    pub min_io_start: c_uint,
    pub irq_mask: c_uint,
    pub ao_ranges: *const *const comedi_lrange,
    pub ao_num_ranges: c_int,
    pub ao_nchan: c_int,
    pub have_dio:1: c_uint,
    pub is_pcl727:1: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcl726_private {
    pub rangelist: [*const comedi_lrange; 12],
    pub cmd_running:1: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn pcl726_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
// setup the per-channel analog output range_table_list
    for (i = 0; i < 12; i++) {
    let mut opt: c_uint = it.options[2 + i];
