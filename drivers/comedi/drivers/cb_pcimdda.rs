...
//! Source: drivers/comedi/drivers/cb_pcimdda.c
#![no_std]
...
pub const PCI_ID_PCIM_DDA06_16: c_uint = 0x0053;
//
// Register map, 8-bit access only
//

pub const PCIMDDA_8255_BASE_REG: c_uint = 0x0c;
    ...
    let mut offset: c_ulong = dev.iobase + PCIMDDA_DA_CHAN(chan);
