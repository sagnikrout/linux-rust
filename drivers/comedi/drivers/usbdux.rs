...
//! Source: drivers/comedi/drivers/usbdux.c
#![no_std]
...
pub const USBDUX_FIRMWARE_MAX_LEN: c_uint = 0x2000;
pub const USBDUX_FIRMWARE_CMD: c_uint = 0xa0;
pub const VENDOR_DIR_IN: c_uint = 0xc0;
pub const VENDOR_DIR_OUT: c_uint = 0x40;
pub const USBDUX_CPU_CS: c_uint = 0xe600;
// usbdux bulk transfer commands
pub const USBDUX_CMD_MULT_AI: c_int = 0;
pub const USBDUX_CMD_AO: c_int = 1;
pub const USBDUX_CMD_DIO_CFG: c_int = 2;
pub const USBDUX_CMD_DIO_BITS: c_int = 3;
pub const USBDUX_CMD_SINGLE_AI: c_int = 4;
pub const USBDUX_CMD_TIMER_RD: c_int = 5;
pub const USBDUX_CMD_TIMER_WR: c_int = 6;
pub const USBDUX_CMD_PWM_ON: c_int = 7;
pub const USBDUX_CMD_PWM_OFF: c_int = 8;
...
// input buffer for the ISO-transfer
    pub in_buf: *mut __le16,
// input buffer for single insn
    pub insn_buf: *mut __le16,
    pub high_speed:1: c_uint,
    pub ai_cmd_running:1: c_uint,
    pub ao_cmd_running:1: c_uint,
    pub pwm_cmd_running:1: c_uint,
...
#[no_mangle]
unsafe extern "C" fn usbdux_unlink_urbs(urbs: *mut urb, num_urbs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn usbdux_ai_stop(dev: *mut comedi_device, do_unlink: c_int) {
...
// get the data from the USB bus and hand it over to comedi
    ...
    let mut val: u16 = le16_to_cpu(devpriv.in_buf[i]);
...
#[no_mangle]
unsafe extern "C" fn usbduxsub_ai_isoc_irq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usbdux_ao_stop(dev: *mut comedi_device, do_unlink: c_int) {
...
#[no_mangle]
unsafe extern "C" fn usbduxsub_ao_isoc_irq(urb: *mut urb) {
...
// full speed does 1kHz scans every USB frame
    let mut arg: c_uint = 1000000;
    let mut min_arg: c_uint = arg;
    if (devpriv.high_speed) {
//
...
//
#[no_mangle]
unsafe extern "C" fn create_adc_command(chan: c_uint, range: c_uint) -> u8 {
    static u8 create_adc_command(unsigned int chan, unsigned int range)
    {
    let mut p: u8 = (range <= 1);
    let mut r: u8 = ((range % 2) == 0);
    return (chan << 4) | ((p == 1) << 2) | ((r == 1) << 3);
    }
#[no_mangle]
unsafe extern "C" fn send_dux_commands(dev: *mut comedi_device, cmd_type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_dux_commands(dev: *mut comedi_device, command: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbdux_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
    static int usbdux_ai_cmd(struct comedi_device *dev, struct comedi_subdevice *s)
    {
    struct usbdux_private *devpriv = dev.private;
    struct comedi_cmd *cmd = &s.async.cmd;
    let mut len: c_int = cmd.chanlist_len;
...
#[no_mangle]
unsafe extern "C" fn usbdux_ao_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbduxsub_unlink_pwm_urbs(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn usbdux_pwm_stop(dev: *mut comedi_device, do_unlink: c_int) {
...
#[no_mangle]
unsafe extern "C" fn usbduxsub_pwm_irq(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn usbduxsub_submit_pwm_urbs(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbdux_alloc_usb_buffers(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usbdux_free_usb_buffers(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn usbdux_detach(dev: *mut comedi_device) {
