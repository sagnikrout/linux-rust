...
//! Source: drivers/comedi/drivers/ni_mio_cs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mio_pcmcia_config_loop(p_dev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mio_cs_detach(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn cs_attach(link: *mut pcmcia_device) -> c_int {
