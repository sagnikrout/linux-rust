...
//! Source: drivers/comedi/drivers/pcl818.c
#![no_std]
...
// Register I/O map
//
pub const PCL818_AI_LSB_REG: c_uint = 0x00;
pub const PCL818_AI_MSB_REG: c_uint = 0x01;
pub const PCL818_RANGE_REG: c_uint = 0x01;
pub const PCL818_MUX_REG: c_uint = 0x02;

pub const PCL818_DO_DI_LSB_REG: c_uint = 0x03;

pub const PCL818_STATUS_REG: c_uint = 0x08;

pub const PCL818_CTRL_REG: c_uint = 0x09;

pub const PCL818_CNTENABLE_REG: c_uint = 0x0a;

pub const PCL818_DO_DI_MSB_REG: c_uint = 0x0b;
pub const PCL818_TIMER_BASE: c_uint = 0x0c;
// W: fifo enable/disable
pub const PCL818_FI_ENABLE: c_int = 6;
// W: fifo interrupt clear
pub const PCL818_FI_INTCLR: c_int = 20;
// W: fifo interrupt clear
pub const PCL818_FI_FLUSH: c_int = 25;
// R: fifo status
pub const PCL818_FI_STATUS: c_int = 25;
// R: one record from FIFO
pub const PCL818_FI_DATALO: c_int = 23;
pub const PCL818_FI_DATAHI: c_int = 24;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcl818_board {
    pub name: *const c_char,
    pub ns_min: c_uint,
    pub n_aochan: c_int,
    pub ai_range_type: *const comedi_lrange,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcl818_private {
    pub dma: *mut comedi_isadma,
// manimal allowed delay between samples (in us) for actual card
    pub ns_min: c_uint,
// MUX setting for actual AI operations
    pub act_chanlist: [c_uint; 16],
    pub /: *mut *mut unsigned int act_chanlist_len; / how long is actual MUX list,
    pub /: *mut *mut unsigned int act_chanlist_pos; / actual position in MUX list,
    pub usefifo:1: c_uint,
...
#[no_mangle]
unsafe extern "C" fn pcl818_ai_clear_eoc(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcl818_ai_soft_trig(dev: *mut comedi_device) {
...
// chan = val & 0xf;
    ...
    unsigned int chan;
    unsigned int val;
    if (pcl818_ai_eoc(dev, s, core::ptr::null_mut(), 0)) {
    ...
    let mut nsamples: c_uint = comedi_bytes_to_samples(s, desc.size);
    unsigned int chan;
    unsigned int val;
    int i;
...
#[no_mangle]
unsafe extern "C" fn pcl818_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: devpriv->usefifo) -> else {
...
#[no_mangle]
unsafe extern "C" fn check_single_ended(port: c_uint) -> c_int {
...
//
    ...
    if (ret)
    break;
    data[i] = pcl818_ai_get_sample(dev, s, core::ptr::null_mut());
    }
    pcl818_ai_clear_eoc(dev);
...
#[no_mangle]
unsafe extern "C" fn pcl818_reset(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcl818_alloc_dma(dev: *mut comedi_device, dma_chan: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pcl818_free_dma(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcl818_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
    static int pcl818_attach(struct comedi_device *dev, struct comedi_devconfig *it)
    {
    const struct pcl818_board *board = dev.board_ptr;
    struct pcl818_private *devpriv;
    struct comedi_subdevice *s;
    let mut io_base: c_uint = it.options[0];
    let mut fifo_is_supported: bool = board.has_fifo && !(io_base & 0x10);
    let mut fifo_is_wanted: bool = board.has_fifo && it.options[2] == -1;
    let mut io_len: c_uint = fifo_is_supported ? 0x20 : 0x10;
...
#[no_mangle]
unsafe extern "C" fn pcl818_detach(dev: *mut comedi_device) {
