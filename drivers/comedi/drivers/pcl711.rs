...
//! Source: drivers/comedi/drivers/pcl711.c
#![no_std]
...
//
pub const PCL711_TIMER_BASE: c_uint = 0x00;
pub const PCL711_AI_LSB_REG: c_uint = 0x04;
pub const PCL711_AI_MSB_REG: c_uint = 0x05;

pub const PCL711_DI_LSB_REG: c_uint = 0x06;
pub const PCL711_DI_MSB_REG: c_uint = 0x07;
pub const PCL711_INT_STAT_REG: c_uint = 0x08;

pub const PCL711_AI_GAIN_REG: c_uint = 0x09;

pub const PCL711_MUX_REG: c_uint = 0x0a;

pub const PCL711_MODE_REG: c_uint = 0x0b;

pub const PCL711_SOFTTRIG_REG: c_uint = 0x0c;

pub const PCL711_DO_LSB_REG: c_uint = 0x0d;
pub const PCL711_DO_MSB_REG: c_uint = 0x0e;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcl711_board {
    pub name: *const c_char,
    pub n_aichan: c_int,
    pub n_aochan: c_int,
    pub maxirq: c_int,
    pub min_io_start: c_uint,
...
#[no_mangle]
unsafe extern "C" fn pcl711_ai_set_mode(dev: *mut comedi_device, mode: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pcl711_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
pub const MAX_SPEED: c_int = 1000;
...
#[no_mangle]
unsafe extern "C" fn pcl711_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcl711_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
