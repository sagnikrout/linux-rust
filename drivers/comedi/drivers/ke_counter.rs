...
//! Source: drivers/comedi/drivers/ke_counter.c
#![no_std]
...
pub const KE_OSC_SEL_REG: c_uint = 0xf8;

pub const KE_DO_REG: c_uint = 0xfc;
...
#[no_mangle]
unsafe extern "C" fn ke_counter_reset(dev: *mut comedi_device) {
