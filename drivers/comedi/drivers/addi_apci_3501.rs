...
//! Source: drivers/comedi/drivers/addi_apci_3501.c
#![no_std]
...
//
pub const APCI3501_AO_CTRL_STATUS_REG: c_uint = 0x00;

pub const APCI3501_AO_DATA_REG: c_uint = 0x04;

pub const APCI3501_AO_TRIG_SCS_REG: c_uint = 0x08;
pub const APCI3501_TIMER_BASE: c_uint = 0x20;
pub const APCI3501_DO_REG: c_uint = 0x40;
pub const APCI3501_DI_REG: c_uint = 0x50;
//
// AMCC S5933 NVRAM
//
pub const NVRAM_USER_DATA_START: c_uint = 0x100;

//
// Function types stored in the eeprom
//
pub const EEPROM_DIGITALINPUT: c_int = 0;
pub const EEPROM_DIGITALOUTPUT: c_int = 1;
pub const EEPROM_ANALOGINPUT: c_int = 2;
pub const EEPROM_ANALOGOUTPUT: c_int = 3;
pub const EEPROM_TIMER: c_int = 4;
pub const EEPROM_WATCHDOG: c_int = 5;
pub const EEPROM_TIMER_WATCHDOG_COUNTER: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apci3501_private {
    pub amcc: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn apci3501_wait_for_dac(dev: *mut comedi_device) -> c_int {
    ...
    let mut cfg: c_uint = APCI3501_AO_DATA_CHAN(chan);
    int ret;
    int i;
//
...
#[no_mangle]
unsafe extern "C" fn apci3501_eeprom_wait(iobase: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn apci3501_eeprom_get_ao_n_chan(dev: *mut comedi_device) -> c_int {
...
// Read functionality details
    ...
    {
    struct apci3501_private *devpriv = dev.private;
    let mut addr: c_ushort = CR_CHAN(insn.chanspec);
    unsigned int val;
    unsigned int i;
    if (insn.n) {
...
#[no_mangle]
unsafe extern "C" fn apci3501_reset(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apci3501_detach(dev: *mut comedi_device) {
