...
//! Source: drivers/comedi/drivers/8255_pci.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_8255_boardinfo {
    pub name: *const c_char,
    pub dio_badr: c_int,
    pub n_8255: c_int,
    pub has_mite:1: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn pci_8255_mite_init(pcidev: *mut pci_dev) -> c_int {
...
// finished with MITE registers
    ...
    const struct pci_8255_boardinfo *board = core::ptr::null_mut();
