...
//! Source: drivers/comedi/drivers/addi_apci_1032.c
#![no_std]
...
// I/O Register Map
//
pub const APCI1032_DI_REG: c_uint = 0x00;
pub const APCI1032_MODE1_REG: c_uint = 0x04;
pub const APCI1032_MODE2_REG: c_uint = 0x08;
pub const APCI1032_STATUS_REG: c_uint = 0x0c;
pub const APCI1032_CTRL_REG: c_uint = 0x10;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct apci1032_private {
    pub /: *mut *mut unsigned long amcc_iobase; / base of AMCC I/O registers,
...
#[no_mangle]
unsafe extern "C" fn apci1032_reset(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apci1032_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn apci1032_detach(dev: *mut comedi_device) {
