...
//! Source: drivers/comedi/drivers/ni_daq_700.c
#![no_std]
...
pub const DIO_W: c_uint = 0x04	/* WO 8bit */;
pub const DIO_R: c_uint = 0x05	/* RO 8bit */;
pub const CMD_R1: c_uint = 0x00	/* WO 8bit */;
pub const CMD_R2: c_uint = 0x07	/* RW 8bit */;
pub const CMD_R3: c_uint = 0x05	/* W0 8bit */;
pub const STA_R1: c_uint = 0x00	/* RO 8bit */;
pub const STA_R2: c_uint = 0x01	/* RO 8bit */;
pub const ADFIFO_R: c_uint = 0x02	/* RO 16bit */;
pub const ADCLEAR_R: c_uint = 0x01	/* WO 8bit */;
pub const CDA_R0: c_uint = 0x08	/* RW 8bit */;
pub const CDA_R1: c_uint = 0x09	/* RW 8bit */;
pub const CDA_R2: c_uint = 0x0A	/* RW 8bit */;
pub const CMO_R: c_uint = 0x0B	/* RO 8bit */;
pub const TIC_R: c_uint = 0x06	/* WO 8bit */;
// daqcard700 modes
pub const CMD_R3_DIFF: c_uint = 0x04    /* diff mode */;
...
#[no_mangle]
unsafe extern "C" fn daq700_cs_attach(link: *mut pcmcia_device) -> c_int {
