...
//! Source: drivers/comedi/drivers/ni_660x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ni_660x_register_data {
    pub /: *mut *mut int offset; / Offset from base address from GPCT chip,
    pub /: *mut *mut char size; / 2 or 4 bytes,
}
...
pub const NI660X_CHIP_OFFSET: c_uint = 0x800;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ni_660x_board {
    pub name: *const c_char,
    pub /: *mut *mut unsigned int n_chips; / total number of TIO chips,
}
...
pub const NI660X_NUM_PFI_CHANNELS: c_int = 40;
// there are only up to 3 dma channels, but the register layout allows for 4
pub const NI660X_MAX_DMA_CHANNEL: c_int = 4;
pub const NI660X_COUNTERS_PER_CHIP: c_int = 4;
pub const NI660X_MAX_CHIPS: c_int = 2;

    NI660X_COUNTERS_PER_CHIP)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ni_660x_private {
    pub mite: *mut mite,
    pub counter_dev: *mut ni_gpct_device,
    pub ring: [*mut mite_ring; NI660X_MAX_CHIPS][NI660X_COUNTERS_PER_CHIP],
...
// prevents races between interrupt and comedi_poll
    ...
    pub dma_cfg: [c_uint; NI660X_MAX_CHIPS],
    pub io_cfg: [c_uint; NI660X_NUM_PFI_CHANNELS],
    pub io_dir: u64,
    ...
    let mut chip: c_uint = counter.chip_index;
    ...
    ni_tio_set_mite_channel(counter, core::ptr::null_mut());
    mite_release_channel(mite_chan);
    }
    spin_unlock_irqrestore(&devpriv.mite_channel_lock, flags);
    }
#[no_mangle]
unsafe extern "C" fn ni_660x_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_660x_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tio_counterswap(dev: *mut comedi_device, chip: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ni_660x_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ni_660x_allocate_private(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_660x_alloc_mite_rings(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_660x_free_mite_rings(dev: *mut comedi_device) {
    ...
    unsigned int *data)
    {
    let mut shift: c_uint = CR_CHAN(insn.chanspec);
    let mut mask: c_uint = data[0] << shift;
    let mut bits: c_uint = data[1] << shift;
//
...
//
    ...
    {
    const struct ni_660x_board *board = dev.board_ptr;
    let mut active_chip: c_uint = 0;
    let mut idle_chip: c_uint = 0;
    unsigned int bits;
    if (chan >= NI_PFI(0))
...
#[no_mangle]
unsafe extern "C" fn ni_660x_get_pfi_routing(dev: *mut comedi_device, chan: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_output_select_source(dest: c_int, dev: *mut comedi_device) -> c_int {
...
// init ioconfig registers
    ...
    const struct ni_660x_board *board = core::ptr::null_mut();
    struct ni_660x_private *devpriv;
    struct comedi_subdevice *s;
...
// prepare the device for globally-named routes.
    if (ni_assign_device_routes("ni_660x", board.name, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ni_660x_detach(dev: *mut comedi_device) {
