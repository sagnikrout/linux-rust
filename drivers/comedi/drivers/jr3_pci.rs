...
//! Source: drivers/comedi/drivers/jr3_pci.h
#![no_std]
...
pub struct le_struct {
    pub latch_bits: i32,
    pub number_of_ge_thresholds: i32,
    pub number_of_le_thresholds: i32,
...
// the sensor.
//
    pub /: *mut *mut raw_channel raw_channels[16]; / offset 0x0000,
//
// Copyright is a null terminated ASCII string containing the JR3
// copyright notice.
//
    pub /: *mut *mut u32 copyright[0x0018]; / offset 0x0040,
    pub /: *mut *mut s32 reserved1[0x0008]; / offset 0x0058,
//
...
//
    pub /: *mut *mut six_axis_array shunts; / offset 0x0060,
    pub /: *mut *mut s32 reserved2[2]; / offset 0x0066,
//
// Default_FS contains the full scale that is used if the user does
// not set a full scale.
//
    pub /: *mut *mut six_axis_array default_FS; / offset 0x0068,
    pub /: *mut *mut s32 reserved3; / offset 0x006e,
//
// Load_envelope_num is the load envelope number that is currently
// in use. This value is set by the user after one of the load
// envelopes has been initialized.
//
    pub /: *mut *mut s32 load_envelope_num; / offset 0x006f,
...
//
    pub /: *mut *mut six_axis_array min_full_scale; / offset 0x0070,
    pub /: *mut *mut s32 reserved4; / offset 0x0076,
//
// Transform_num is the transform number that is currently in use.
// This value is set by the JR3 DSP after the user has used command
// (5) use transform # (pg. 33).
//
    pub /: *mut *mut s32 transform_num; / offset 0x0077,
//
// Max_full_scale is the recommended maximum full scale.
// See min_full_scale (pg. 9) for more details.
//
    pub /: *mut *mut six_axis_array max_full_scale; / offset 0x0078,
    pub /: *mut *mut s32 reserved5; / offset 0x007e,
//
...
//
    pub /: *mut *mut s32 peak_address; / offset 0x007f,
//
...
//
    pub /: *mut *mut force_array full_scale; / offset 0x0080,
//
...
//
    pub /: *mut *mut six_axis_array offsets; / offset 0x0088,
//
...
//
    pub /: *mut *mut s32 offset_num; / offset 0x008e,
//
// Vect_axes is a bit map showing which of the axes are being used
// in the vector calculations. This value is set by the JR3 DSP
// after the user has executed the set vector axes command (pg. 37).
//
    pub /: *mut *mut u32 vect_axes; / offset 0x008f,
//
...
//
    pub /: *mut *mut force_array rate_data; / offset 0x00c8,
//
...
//
    pub /: *mut *mut force_array minimum_data; / offset 0x00d0,
    pub /: *mut *mut force_array maximum_data; / offset 0x00d8,
//
...
//
    pub /: *mut *mut s32 near_sat_value; / offset 0x00e0,
    pub /: *mut *mut s32 sat_value; / offset 0x00e1,
//
...
//
    pub /: *mut *mut s32 rate_address; / offset 0x00e2,
    pub /: *mut *mut u32 rate_divisor; / offset 0x00e3,
    pub /: *mut *mut u32 rate_count; / offset 0x00e4,
//
...
// command_word1).
//
    pub /: *mut *mut s32 command_word2; / offset 0x00e5,
    pub /: *mut *mut s32 command_word1; / offset 0x00e6,
    pub /: *mut *mut s32 command_word0; / offset 0x00e7,
//
...
// once.
//
    pub /: *mut *mut u32 count1; / offset 0x00e8,
    pub /: *mut *mut u32 count2; / offset 0x00e9,
    pub /: *mut *mut u32 count3; / offset 0x00ea,
    pub /: *mut *mut u32 count4; / offset 0x00eb,
    pub /: *mut *mut u32 count5; / offset 0x00ec,
    pub /: *mut *mut u32 count6; / offset 0x00ed,
//
...
//
    pub /: *mut *mut u32 error_count; / offset 0x00ee,
//
...
//
    pub /: *mut *mut u32 count_x; / offset 0x00ef,
//
// Warnings & errors contain the warning and error bits
// respectively. The format of these two words is discussed on page
// 21 under the headings warnings_bits and error_bits.
//
    pub /: *mut *mut u32 warnings; / offset 0x00f0,
    pub /: *mut *mut u32 errors; / offset 0x00f1,
//
// Threshold_bits is a word containing the bits that are set by the
// load envelopes. See load_envelopes (pg. 17) and thresh_struct
// (pg. 23) for more details.
//
    pub /: *mut *mut s32 threshold_bits; / offset 0x00f2,
//
...
//
    pub /: *mut *mut s32 last_CRC; / offset 0x00f3,
//
...
//
    pub /: *mut *mut s32 eeprom_ver_no; / offset 0x00f4,
    pub /: *mut *mut s32 software_ver_no; / offset 0x00f5,
//
...
// years.
//
    pub /: *mut *mut s32 software_day; / offset 0x00f6,
    pub /: *mut *mut s32 software_year; / offset 0x00f7,
//
...
//
    pub /: *mut *mut u32 serial_no; / offset 0x00f8,
    pub /: *mut *mut u32 model_no; / offset 0x00f9,
//
// Cal_day & cal_year are the sensor calibration date. Day is the
// day of the year, with January 1 being 1, and December 31, being
// 366 for leap years.
//
    pub /: *mut *mut s32 cal_day; / offset 0x00fa,
    pub /: *mut *mut s32 cal_year; / offset 0x00fb,
//
...
// received.
//
    pub /: *mut *mut u32 units; / offset 0x00fc,
    pub /: *mut *mut s32 bits; / offset 0x00fd,
    pub /: *mut *mut s32 channels; / offset 0x00fe,
//
...
//
    pub /: *mut *mut s32 thickness; / offset 0x00ff,
//
...
//
    pub /: *mut *mut le_load_envelopes[0x10]; / offset 0x0100,
//
...
//
    pub /: *mut *mut intern_transform transforms[0x10]; / offset 0x0200,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct jr3_block {
    pub /: *mut *mut u32 program_lo[0x4000]; / 0x00000 - 0x10000,
    pub /: *mut *mut jr3_sensor sensor; / 0x10000 - 0x10c00,
    pub /: *mut *mut char pad2[0x30000 - 0x00c00]; / 0x10c00 - 0x40000,
    pub /: *mut *mut u32 program_hi[0x8000]; / 0x40000 - 0x60000,
    pub /: *mut *mut u32 reset; / 0x60000 - 0x60004,
    pub /: *mut *mut char pad3[0x20000 - 0x00004]; / 0x60004 - 0x80000,
}
