...
//! Source: drivers/comedi/drivers/addi_apci_2032.c
#![no_std]
...
//
pub const APCI2032_DO_REG: c_uint = 0x00;
pub const APCI2032_INT_CTRL_REG: c_uint = 0x04;

pub const APCI2032_INT_STATUS_REG: c_uint = 0x08;

pub const APCI2032_STATUS_REG: c_uint = 0x0c;

pub const APCI2032_WDOG_REG: c_uint = 0x10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apci2032_int_private {
    pub /: *mut *mut spinlock_t spinlock; / protects the following members,
    pub /: *mut *mut bool active; / an async command is running,
    pub /: *mut *mut unsigned char enabled_isns; / mask of enabled interrupt channels,
}
...
#[no_mangle]
unsafe extern "C" fn apci2032_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn apci2032_reset(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apci2032_detach(dev: *mut comedi_device) {
