...
//! Source: drivers/comedi/drivers/cb_pcidas64.c
#![no_std]
...
//
pub const PRESCALED_TIMER_BASE: c_int = 10000;
pub const DMA_BUFFER_SIZE: c_uint = 0x1000;
pub const DAC_FIFO_SIZE: c_uint = 0x2000;
// maximum value that can be loaded into board's 24-bit counters
    let mut max_counter_value: static int = 0xffffff;
...
#[no_mangle]
pub unsafe extern "C" fn dac_convert_reg(channel: c_uint) -> c_uint {
    static inline unsigned int dac_convert_reg(unsigned int channel)
    {
    return 0x70 + (2 * (channel & 0x1));
    }
#[no_mangle]
pub unsafe extern "C" fn dac_lsb_4020_reg(channel: c_uint) -> c_uint {
    static inline unsigned int dac_lsb_4020_reg(unsigned int channel)
    {
    return 0x70 + (4 * (channel & 0x1));
    }
#[no_mangle]
pub unsafe extern "C" fn dac_msb_4020_reg(channel: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn adc_lo_chan_4020_bits(channel: c_uint) -> u16 {
    static inline u16 adc_lo_chan_4020_bits(unsigned int channel)
    {
    return (channel & 0x3) << 8;
    };
#[no_mangle]
pub unsafe extern "C" fn adc_hi_chan_4020_bits(channel: c_uint) -> u16 {
    static inline u16 adc_hi_chan_4020_bits(unsigned int channel)
    {
    return (channel & 0x3) << 10;
    };
#[no_mangle]
pub unsafe extern "C" fn adc_mode_bits(mode: c_uint) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn adc_src_bits(source: c_uint) -> u16 {
    static inline u16 adc_src_bits(unsigned int source)
    {
    return (source & 0xf) << 3;
    };
#[no_mangle]
pub unsafe extern "C" fn adc_convert_chan_4020_bits(channel: c_uint) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn adc_chan_bits(channel: c_uint) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn pipe_full_bits(hw_status_bits: u16) -> u16 {
    static inline u16 pipe_full_bits(u16 hw_status_bits)
    {
    return (hw_status_bits >> 10) & 0x3;
    };
#[no_mangle]
pub unsafe extern "C" fn adc_upper_read_ptr_code(prepost_bits: u16) -> c_uint {
    static inline unsigned int adc_upper_read_ptr_code(u16 prepost_bits)
    {
    return (prepost_bits >> 12) & 0x3;
    }
#[no_mangle]
pub unsafe extern "C" fn adc_upper_write_ptr_code(prepost_bits: u16) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn adc_src_4020_bits(source: c_uint) -> u8 {
    static inline u8 adc_src_4020_bits(unsigned int source)
    {
    return (source << 4) & ADC_SRC_4020_MASK;
    };
#[no_mangle]
pub unsafe extern "C" fn attenuate_bit(channel: c_uint) -> u8 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hw_fifo_info {
    pub num_segments: c_uint,
    pub max_segment_length: c_uint,
    pub sample_packing_ratio: c_uint,
    pub fifo_size_reg_mask: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcidas64_board {
    pub name: *const c_char,
    pub /: *mut *mut int ai_se_chans; / number of ai inputs in single-ended mode,
    pub /: *mut *mut int ai_bits; / analog input resolution,
    pub /: *mut *mut int ai_speed; / fastest conversion period in ns,
    pub ai_range_table: *const comedi_lrange,
    pub ai_range_code: *const u8,
    pub /: *mut *mut int ao_nchan; / number of analog out channels,
    pub /: *mut *mut int ao_bits; / analog output resolution,
    pub /: *mut *mut int ao_scan_speed; / analog output scan speed,
    pub ao_range_table: *const comedi_lrange,
    pub ao_range_code: *const c_int,
    pub ai_fifo: *const *const hw_fifo_info,
// different board families have slightly different registers
    pub layout: enum register_layout,
    pub has_8255:1: unsigned,
}
...
#[no_mangle]
pub unsafe extern "C" fn ai_dma_ring_count(board: *const pcidas64_board) -> c_uint {
    ...
    let mut bytes_in_sample: static int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcidas64_private {
// base addresses (physical)
    pub main_phys_iobase: resource_size_t,
    pub dio_counter_phys_iobase: resource_size_t,
// base addresses (ioremapped)
    pub plx9080_iobase: *mut void __iomem,
    pub main_iobase: *mut void __iomem,
// local address (used by dma controller)
    pub local0_iobase: u32,
    pub local1_iobase: u32,
// dma buffers for analog input
    pub ai_buffer: [*mut u16; MAX_AI_DMA_RING_COUNT],
// physical addresses of ai dma buffers
    pub ai_buffer_bus_addr: [dma_addr_t; MAX_AI_DMA_RING_COUNT],
//
// array of ai dma descriptors read by plx9080,
// allocated to get proper alignment
//
    pub ai_dma_desc: *mut plx_dma_desc,
// physical address of ai dma descriptor array
    pub ai_dma_desc_bus_addr: dma_addr_t,
//
// index of the ai dma descriptor/buffer
// that is currently being used
//
    pub ai_dma_index: c_uint,
// dma buffers for analog output
    pub ao_buffer: [*mut u16; AO_DMA_RING_COUNT],
// physical addresses of ao dma buffers
    pub ao_buffer_bus_addr: [dma_addr_t; AO_DMA_RING_COUNT],
    pub ao_dma_desc: *mut plx_dma_desc,
    pub ao_dma_desc_bus_addr: dma_addr_t,
// keeps track of buffer where the next ao sample should go
    pub ao_dma_index: c_uint,
    pub /: *mut *mut unsigned int hw_revision; / stc chip hardware revision number,
// last bits sent to INTR_ENABLE_REG register
    pub intr_enable_bits: c_uint,
// last bits sent to ADC_CONTROL1_REG register
    pub adc_control1_bits: u16,
// last bits sent to FIFO_SIZE_REG register
    pub fifo_size_bits: u16,
// last bits sent to HW_CONFIG_REG register
    pub hw_config_bits: u16,
    pub dac_control1_bits: u16,
// last bits written to plx9080 control register
    pub plx_control_bits: u32,
// last bits written to plx interrupt control and status register
    pub plx_intcsr_bits: u32,
// index of calibration source readable through ai ch0
    pub calibration_source: c_int,
// bits written to i2c calibration/range register
    pub i2c_cal_range_bits: u8,
// configure digital triggers to trigger on falling edge
    pub ext_trig_falling: c_uint,
    pub ai_cmd_running: c_short,
    pub ai_fifo_segment_length: c_uint,
    pub ext_clock: ext_clock_info,
    pub ao_bounce_buffer: [c_ushort; DAC_FIFO_SIZE],
}
    ...
    {
    const struct pcidas64_board *board = dev.board_ptr;
    let mut code: c_uint = board.ao_range_code[range];
    if (channel > 1)
...
#[no_mangle]
pub unsafe extern "C" fn ao_cmd_is_supported(board: *const pcidas64_board) -> c_int {
    static inline int ao_cmd_is_supported(const struct pcidas64_board *board)
    {
    return board.ao_nchan && board.layout != LAYOUT_4020;
    }
#[no_mangle]
unsafe extern "C" fn abort_dma(dev: *mut comedi_device, channel: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn disable_plx_interrupts(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn disable_ai_interrupts(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn init_plx9080(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn disable_ai_pacing(dev: *mut comedi_device) {
...
// disable pacing, triggering, etc
    ...
    const struct pcidas64_board *board = dev.board_ptr;
    struct pcidas64_private *devpriv = dev.private;
    let mut increment_size: static int = 0x100;
    let mut fifo: *const hw_fifo_info const = board.ai_fifo;
...
//
#[no_mangle]
unsafe extern "C" fn set_ai_fifo_size(dev: *mut comedi_device, num_samples: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ai_fifo_size(dev: *mut comedi_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn init_stc_registers(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn alloc_and_init_dma_members(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cb_pcidas64_free_dma(dev: *mut comedi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn warn_external_queue(dev: *mut comedi_device) {
...
//
    let mut i2c_high_udelay: static int = 1000;
    let mut i2c_low_udelay: static int = 10;
// set i2c data line high or low
#[no_mangle]
unsafe extern "C" fn i2c_set_sda(dev: *mut comedi_device, state: c_int) {
    static void i2c_set_sda(struct comedi_device *dev, int state)
    {
    struct pcidas64_private *devpriv = dev.private;
    let mut data_bit: static int = PLX_CNTRL_EEWB;
...
#[no_mangle]
unsafe extern "C" fn i2c_set_scl(dev: *mut comedi_device, state: c_int) {
    static void i2c_set_scl(struct comedi_device *dev, int state)
    {
    struct pcidas64_private *devpriv = dev.private;
    let mut clock_bit: static int = PLX_CNTRL_USERO;
    void __iomem *plx_control_addr = devpriv.plx9080_iobase +
    PLX_REG_CNTRL;
...
#[no_mangle]
unsafe extern "C" fn i2c_write_byte(dev: *mut comedi_device, byte: u8) {
    static void i2c_write_byte(struct comedi_device *dev, u8 byte)
    {
    u8 bit;
    let mut num_bits: c_uint = 8;
...
#[no_mangle]
unsafe extern "C" fn i2c_read_ack(dev: *mut comedi_device) -> c_int {
...
// send start bit
#[no_mangle]
unsafe extern "C" fn i2c_start(dev: *mut comedi_device) {
...
// send stop bit
#[no_mangle]
unsafe extern "C" fn i2c_stop(dev: *mut comedi_device) {
    ...
    unsigned int i;
    u8 bitstream;
    let mut read_bit: static int = 0x1;
//
...
// set start channel, and rest of settings
    ...
    let mut old_cal_range_bits: u8 = devpriv.i2c_cal_range_bits;
...
//
    ...
    let mut i2c_data: u8 = devpriv.i2c_cal_range_bits;
...
#[no_mangle]
unsafe extern "C" fn ai_config_block_size(dev: *mut comedi_device, data: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ai_config_master_clock(dev: *mut comedi_device, data: *mut c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_divisor(ns: c_uint, flags: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn check_adc_timing(dev: *mut comedi_device, cmd: *mut comedi_cmd) {
    static void check_adc_timing(struct comedi_device *dev, struct comedi_cmd *cmd)
    {
    const struct pcidas64_board *board = dev.board_ptr;
    let mut convert_divisor: c_ulonglong = 0;
    unsigned int scan_divisor;
    let mut min_convert_divisor: static int = 3;
    static const int max_convert_divisor =
    max_counter_value + min_convert_divisor;
    let mut min_scan_divisor_4020: static int = 2;
    ...
    {
    const struct pcidas64_board *board = dev.board_ptr;
    let mut aref0: c_uint = CR_AREF(cmd.chanlist[0]);
    int i;
    for (i = 1; i < cmd.chanlist_len; i++) {
    let mut aref: c_uint = CR_AREF(cmd.chanlist[i]);
    if (aref != aref0) {
...
#[no_mangle]
unsafe extern "C" fn use_hw_sample_counter(cmd: *mut comedi_cmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dma_transfer_size(dev: *mut comedi_device) -> c_uint {
...
// select internal/external master clock
    ...
    let mut chanspec: c_int = devpriv.ext_clock.chanspec;
    if (CR_CHAN(chanspec))
...
#[no_mangle]
unsafe extern "C" fn set_ai_pacing(dev: *mut comedi_device, cmd: *mut comedi_cmd) {
    static void set_ai_pacing(struct comedi_device *dev, struct comedi_cmd *cmd)
    {
    const struct pcidas64_board *board = dev.board_ptr;
    struct pcidas64_private *devpriv = dev.private;
    let mut convert_counter: u32 = 0, scan_counter = 0;
    check_adc_timing(dev, cmd);
...
#[no_mangle]
unsafe extern "C" fn use_internal_queue_6xxx(cmd: *const comedi_cmd) -> c_int {
...
// prime queue holding register
    ...
    let mut old_cal_range_bits: c_ushort = devpriv.i2c_cal_range_bits;
    devpriv.i2c_cal_range_bits &= ~ADC_SRC_4020_MASK;
// select BNC inputs
    devpriv.i2c_cal_range_bits |= adc_src_4020_bits(4);
// select ranges
    for (i = 0; i < cmd.chanlist_len; i++) {
    let mut channel: c_uint = CR_CHAN(cmd.chanlist[i]);
...
#[no_mangle]
unsafe extern "C" fn ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: cmd->chanlist_len ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pio_drain_ai_fifo_16(dev: *mut comedi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn pio_drain_ai_fifo_32(dev: *mut comedi_device) {
...
// empty fifo
#[no_mangle]
unsafe extern "C" fn pio_drain_ai_fifo(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn drain_dma_buffers(dev: *mut comedi_device, channel: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn prev_ao_dma_index(dev: *mut comedi_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn last_ao_dma_load_completed(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn restart_ao_dma(dev: *mut comedi_device) {
    ...
    {
    let mut nsamples: c_uint = comedi_bytes_to_samples(s, max_bytes);
    ...
    let mut buffer_index: c_uint = devpriv.ao_dma_index;
    let mut prev_buffer_index: c_uint = prev_ao_dma_index(dev);
    unsigned int nsamples;
    unsigned int nbytes;
...
#[no_mangle]
unsafe extern "C" fn load_ao_dma(dev: *mut comedi_device, cmd: *const comedi_cmd) {
...
#[no_mangle]
unsafe extern "C" fn handle_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ai_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ao_divisor(ns: c_uint, flags: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn prep_ao_dma(dev: *mut comedi_device, cmd: *const comedi_cmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn external_ai_queue_in_use(dev: *mut comedi_device) -> c_int {
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: use_internal_queue_6xxx(&dev->read_subdev->async->cmd)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ao_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ao_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
//
    ...
    {
    struct pcidas64_private *devpriv = dev.private;
    let mut num_caldac_channels: static int = 8;
    let mut bitstream_length: static int = 11;
    let mut bitstream: c_uint = ((address & 0x7) << 8) | value;
    unsigned int bit, register_bits;
    let mut caldac_8800_udelay: static int = 1;
...
//
    ...
    {
    struct pcidas64_private *devpriv = dev.private;
    let mut bitstream_length: static int = 10;
    unsigned int bit, register_bits;
    let mut bitstream: c_uint = ((channel & 0x3) << 8) | (value & 0xff);
    let mut ad8402_udelay: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn read_eeprom(dev: *mut comedi_device, address: u8) -> u16 {
    static u16 read_eeprom(struct comedi_device *dev, u8 address)
    {
    struct pcidas64_private *devpriv = dev.private;
    let mut bitstream_length: static int = 11;
    let mut read_command: static int = 0x6;
    let mut bitstream: c_uint = (read_command << 8) | address;
    unsigned int bit;
    void __iomem * const plx_control_addr =
    devpriv.plx9080_iobase + PLX_REG_CNTRL;
    u16 value;
    let mut value_length: static int = 16;
    let mut eeprom_udelay: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn setup_subdevices(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(LAYOUT_64XX: board->layout ==) -> else {
...
// user counter subd XXX
    ...
    {
    struct pci_dev *pcidev = comedi_to_pci_dev(dev);
    const struct pcidas64_board *board = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn detach(dev: *mut comedi_device) {
