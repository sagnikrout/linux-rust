...
//! Source: drivers/comedi/drivers/pcmuio.c
#![no_std]
...
pub const PCMUIO_INT_PENDING_REG: c_uint = 0x06;
pub const PCMUIO_PAGE_LOCK_REG: c_uint = 0x07;

pub const PCMUIO_PAGE_POL: c_int = 1;
pub const PCMUIO_PAGE_ENAB: c_int = 2;
pub const PCMUIO_PAGE_INT_ID: c_int = 3;

pub const PCMUIO_ASIC_IOSIZE: c_uint = 0x10;
pub const PCMUIO_MAX_ASICS: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcmuio_board {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcmuio_asic {
    pub /: *mut *mut spinlock_t pagelock; / protects the page registers,
    pub /: *mut *mut spinlock_t spinlock; / protects member variables,
    pub enabled_mask: c_uint,
    pub active:1: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcmuio_private {
    pub asics: [pcmuio_asic; PCMUIO_MAX_ASICS],
    pub irq2: c_uint,
}
...
#[no_mangle]
pub unsafe extern "C" fn pcmuio_subdevice_to_asic(s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pcmuio_subdevice_to_port(s: *mut comedi_subdevice) -> c_int {
...
//
    ...
    let mut iobase: c_ulong = pcmuio_asic_iobase(dev, asic);
    unsigned long flags;
...
//
    ...
    unsigned int *data)
    {
    let mut asic: c_int = pcmuio_subdevice_to_asic(s);
    let mut port: c_int = pcmuio_subdevice_to_port(s);
    let mut chanmask: c_uint = (1 << s.n_chan) - 1;
    unsigned int mask;
    unsigned int val;
...
#[no_mangle]
unsafe extern "C" fn pcmuio_reset(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcmuio_handle_asic_interrupt(dev: *mut comedi_device, asic: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmuio_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pcmuio_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcmuio_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmuio_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
    static int pcmuio_attach(struct comedi_device *dev, struct comedi_devconfig *it)
    {
    const struct pcmuio_board *board = dev.board_ptr;
    struct comedi_subdevice *s;
    struct pcmuio_private *devpriv;
    let mut io_len: c_uint = board.num_asics * PCMUIO_ASIC_IOSIZE;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn pcmuio_detach(dev: *mut comedi_device) {
