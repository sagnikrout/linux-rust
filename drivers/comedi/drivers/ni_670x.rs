...
//! Source: drivers/comedi/drivers/ni_670x.c
#![no_std]
...
pub const AO_VALUE_OFFSET: c_uint = 0x00;
pub const AO_CHAN_OFFSET: c_uint = 0x0c;
pub const AO_STATUS_OFFSET: c_uint = 0x10;
pub const AO_CONTROL_OFFSET: c_uint = 0x10;
pub const DIO_PORT0_DIR_OFFSET: c_uint = 0x20;
pub const DIO_PORT0_DATA_OFFSET: c_uint = 0x24;
pub const DIO_PORT1_DIR_OFFSET: c_uint = 0x28;
pub const DIO_PORT1_DATA_OFFSET: c_uint = 0x2c;
pub const MISC_STATUS_OFFSET: c_uint = 0x14;
pub const MISC_CONTROL_OFFSET: c_uint = 0x14;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ni_670x_board {
    pub name: *const c_char,
    pub ao_chans: c_ushort,
}
...
#[no_mangle]
unsafe extern "C" fn ni_670x_mite_init(pcidev: *mut pci_dev) -> c_int {
...
// finished with MITE registers
    ...
    const struct ni_670x_board *board = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ni_670x_detach(dev: *mut comedi_device) {
