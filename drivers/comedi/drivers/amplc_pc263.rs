...
//! Source: drivers/comedi/drivers/amplc_pc263.c
#![no_std]
...
// PC263 registers
pub const PC263_DO_0_7_REG: c_uint = 0x00;
pub const PC263_DO_8_15_REG: c_uint = 0x01;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pc263_board {
...
#[no_mangle]
unsafe extern "C" fn pc263_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
