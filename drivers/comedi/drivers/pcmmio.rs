...
//! Source: drivers/comedi/drivers/pcmmio.c
#![no_std]
...
// Register I/O map
//
pub const PCMMIO_AI_LSB_REG: c_uint = 0x00;
pub const PCMMIO_AI_MSB_REG: c_uint = 0x01;
pub const PCMMIO_AI_CMD_REG: c_uint = 0x02;

pub const PCMMIO_RESOURCE_REG: c_uint = 0x02;

pub const PCMMIO_AI_STATUS_REG: c_uint = 0x03;

pub const PCMMIO_AI_RES_ENA_REG: c_uint = 0x03;

pub const PCMMIO_AI_2ND_ADC_OFFSET: c_uint = 0x04;
pub const PCMMIO_AO_LSB_REG: c_uint = 0x08;

pub const PCMMIO_AO_MSB_REG: c_uint = 0x09;
pub const PCMMIO_AO_CMD_REG: c_uint = 0x0a;

pub const PCMMIO_AO_STATUS_REG: c_uint = 0x0b;

pub const PCMMIO_AO_RESOURCE_ENA_REG: c_uint = 0x0b;
pub const PCMMIO_AO_2ND_DAC_OFFSET: c_uint = 0x04;
//
// WinSystems WS16C48
//
...
pub const PCMMIO_INT_PENDING_REG: c_uint = 0x16;
pub const PCMMIO_PAGE_LOCK_REG: c_uint = 0x17;

pub const PCMMIO_PAGE_POL: c_int = 1;
pub const PCMMIO_PAGE_ENAB: c_int = 2;
pub const PCMMIO_PAGE_INT_ID: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcmmio_private {
    pub /: *mut *mut spinlock_t pagelock; / protects the page registers,
    pub /: *mut *mut spinlock_t spinlock; / protects the member variables,
    ...
    let mut iobase: c_ulong = dev.iobase;
    unsigned long flags;
...
// subdevice 2 uses ports 0-2, subdevice 3 uses ports 3-5
    let mut port: c_int = s.index == 2 ? 0 : 3;
...
#[no_mangle]
unsafe extern "C" fn pcmmio_reset(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn interrupt_pcmmio(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pcmmio_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcmmio_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcmmio_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
