...
//! Source: drivers/comedi/drivers/cb_pcimdas.c
#![no_std]
...
//
pub const PCIMDAS_AI_REG: c_uint = 0x00;
pub const PCIMDAS_AI_SOFTTRIG_REG: c_uint = 0x00;

//
// PCI Bar 3 Register map (devpriv->BADR3)
//
pub const PCIMDAS_MUX_REG: c_uint = 0x00;

pub const PCIMDAS_DI_DO_REG: c_uint = 0x01;
pub const PCIMDAS_STATUS_REG: c_uint = 0x02;

pub const PCIMDAS_CONV_STATUS_REG: c_uint = 0x03;

pub const PCIMDAS_IRQ_REG: c_uint = 0x04;

pub const PCIMDAS_PACER_REG: c_uint = 0x05;

pub const PCIMDAS_BURST_REG: c_uint = 0x06;

pub const PCIMDAS_GAIN_REG: c_uint = 0x07;
pub const PCIMDAS_8254_BASE: c_uint = 0x08;
pub const PCIMDAS_USER_CNTR_REG: c_uint = 0x0c;

pub const PCIMDAS_RESIDUE_MSB_REG: c_uint = 0x0d;
pub const PCIMDAS_RESIDUE_LSB_REG: c_uint = 0x0e;
//
// PCI Bar 4 Register map (dev->iobase)
//
pub const PCIMDAS_8255_BASE: c_uint = 0x00;
...
#[no_mangle]
unsafe extern "C" fn cb_pcimdas_pacer_clk(dev: *mut comedi_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cb_pcimdas_is_ai_se(dev: *mut comedi_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cb_pcimdas_is_ai_uni(dev: *mut comedi_device) -> bool {
