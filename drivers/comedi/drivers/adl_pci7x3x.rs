...
//! Source: drivers/comedi/drivers/adl_pci7x3x.c
#![no_std]
...
//
pub const PCI7X3X_DIO_REG: c_uint = 0x0000	/* in the DigIO Port area */;
pub const PCI743X_DIO_REG: c_uint = 0x0004;
pub const ADL_PT_CLRIRQ: c_uint = 0x0040	/* in the DigIO Port area */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adl_pci7x3x_boardinfo {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adl_pci7x3x_dev_private_data {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adl_pci7x3x_sd_private_data {
...
#[no_mangle]
unsafe extern "C" fn adl_pci7x3x_interrupt(irq: c_int, p_device: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adl_pci7x3x_reset(dev: *mut comedi_device) -> c_int {
...
// disable Interrupts
    ...
    const struct adl_pci7x3x_boardinfo *board = core::ptr::null_mut();
    struct comedi_subdevice *s;
...
#[no_mangle]
unsafe extern "C" fn adl_pci7x3x_detach(dev: *mut comedi_device) {
