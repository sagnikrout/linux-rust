...
//! Source: drivers/comedi/drivers/mpc624.c
#![no_std]
...
// but my MPC-624 actually seems to have a range of 20.2
    ...
    let mut data_out: c_uint = devpriv.ai_speed;
    let mut data_in: c_uint = 0;
    unsigned int bit;
    int i;
// Start reading data
    udelay(1);
...
#[no_mangle]
unsafe extern "C" fn mpc624_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
