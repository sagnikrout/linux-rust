...
//! Source: drivers/comedi/drivers/dt2815.c
#![no_std]
...
pub const DT2815_DATA: c_int = 0;
pub const DT2815_STATUS: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt2815_private {
    pub range_type_list: [*const comedi_lrange; 8],
    pub ao_readback: [c_uint; 8],
}
...
//
#[no_mangle]
unsafe extern "C" fn dt2815_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
