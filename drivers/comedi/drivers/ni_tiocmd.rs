...
//! Source: drivers/comedi/drivers/ni_tiocmd.c
#![no_std]
...
//
    ...
    let mut cidx: c_uint = counter.counter_index;
    unsigned int mask;
    unsigned int bits;
...
#[no_mangle]
unsafe extern "C" fn ni_tio_input_cmd(s: *mut comedi_subdevice) -> c_int {
...
// write alloc the entire buffer
    ...
    ret = ni_tio_arm(counter, true, NI_GPCT_ARM_IMMEDIATE);
#[no_mangle]
pub unsafe extern "C" fn if(TRIG_EXT: cmd->start_src ==) -> else {
    let mut reg: c_int = CR_CHAN(cmd.start_arg);
...
#[no_mangle]
unsafe extern "C" fn ni_tio_output_cmd(s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_tio_cmd_setup(s: *mut comedi_subdevice) -> c_int {
    ...
    let mut set_gate_source: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ni_tio_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ni_tio_cancel(counter: *mut ni_gpct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn should_ack_gate(counter: *mut ni_gpct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ni_tio_acknowledge(counter: *mut ni_gpct) {
    void ni_tio_acknowledge(struct ni_gpct *counter)
    {
    ni_tio_acknowledge_and_confirm(counter, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    }
