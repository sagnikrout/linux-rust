...
//! Source: drivers/comedi/drivers/ni_6527.c
#![no_std]
...
pub const NI6527_ID_REG: c_uint = 0x06;
pub const NI6527_CLR_REG: c_uint = 0x07;

pub const NI6527_STATUS_REG: c_uint = 0x14;

pub const NI6527_CTRL_REG: c_uint = 0x15;

pub const NI6527_CTRL_DISABLE_IRQS: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ni6527_private {
    pub filter_interval: c_uint,
    pub filter_enable: c_uint,
}
...
// Outputs are inverted
    let mut val: c_uint = s.state ^ 0xffffff;
    if (mask & 0x0000ff)
...
#[no_mangle]
unsafe extern "C" fn ni6527_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
// update falling-edge detection channels
    ...
    unsigned int *data)
    {
    let mut mask: c_uint = 0xffffffff;
...
#[no_mangle]
unsafe extern "C" fn ni6527_reset(dev: *mut comedi_device) {
...
// disable edge detection
    ...
    const struct ni6527_board *board = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ni6527_detach(dev: *mut comedi_device) {
