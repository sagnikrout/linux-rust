...
//! Source: drivers/comedi/drivers/dt282x.c
#![no_std]
...
// Register map
//
pub const DT2821_ADCSR_REG: c_uint = 0x00;

pub const DT2821_CHANCSR_REG: c_uint = 0x02;

pub const DT2821_ADDAT_REG: c_uint = 0x04;
pub const DT2821_DACSR_REG: c_uint = 0x06;

pub const DT2821_DADAT_REG: c_uint = 0x08;
pub const DT2821_DIODAT_REG: c_uint = 0x0a;
pub const DT2821_SUPCSR_REG: c_uint = 0x0c;

pub const DT2821_TMRCTR_REG: c_uint = 0x0e;

// Pacer Clock

pub const DT2821_PRESCALE_MAX: c_int = 15;
pub const DT2821_DIVIDER_MAX: c_int = 255;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt282x_private {
    pub dma: *mut comedi_isadma,
    pub ad_2scomp:1: c_uint,
    pub divisor: c_uint,
    pub /: *mut *mut int dacsr; / software copies of registers,
    pub adcsr: c_int,
    pub supcsr: c_int,
    pub ntrig: c_int,
    pub nread: c_int,
...
#[no_mangle]
unsafe extern "C" fn dt282x_prep_ai_dma(dev: *mut comedi_device, dma_index: c_int, n: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt282x_prep_ao_dma(dev: *mut comedi_device, dma_index: c_int, n: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt282x_disable_dma(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn dt282x_ns_to_timer(ns: *mut c_uint, flags: c_uint) -> c_uint {
...
// ns = divider * base;
    ...
    let mut nsamples: c_uint = comedi_bytes_to_samples(s, desc.maxsize);
    unsigned int nbytes;
...
#[no_mangle]
unsafe extern "C" fn dt282x_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dt282x_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
    ...
    outw(devpriv.supcsr | DT2821_SUPCSR_PRLD,
    dev.iobase + DT2821_SUPCSR_REG);
    ret = comedi_timeout(dev, s, core::ptr::null_mut(),
    dt282x_ai_timeout, DT2821_ADCSR_MUXBUSY);
    if (ret)
    return ret;
    if (cmd.scan_begin_src == TRIG_FOLLOW) {
...
#[no_mangle]
unsafe extern "C" fn dt282x_ao_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt282x_free_dma(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn dt282x_initialize(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt282x_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt282x_detach(dev: *mut comedi_device) {
