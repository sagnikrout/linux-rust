...
//! Source: drivers/comedi/drivers/dt2814.c
#![no_std]
...
pub const DT2814_CSR: c_int = 0;
pub const DT2814_DATA: c_int = 1;
//
// flags
//
pub const DT2814_FINISH: c_uint = 0x80;
pub const DT2814_ERR: c_uint = 0x40;
pub const DT2814_BUSY: c_uint = 0x20;
pub const DT2814_ENB: c_uint = 0x10;
pub const DT2814_CHANMASK: c_uint = 0x0f;
pub const DT2814_TIMEOUT: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn dt2814_ai_clear(dev: *mut comedi_device) -> c_int {
...
// Wait until not busy and get status register value.
    ret = comedi_timeout(dev, core::ptr::null_mut(), core::ptr::null_mut(), dt2814_ai_notbusy,
...
#[no_mangle]
unsafe extern "C" fn dt2814_ns_to_timer(ns: *mut c_uint, flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt2814_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt2814_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dt2814_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt2814_detach(dev: *mut comedi_device) {
