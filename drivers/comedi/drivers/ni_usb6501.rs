...
//! Source: drivers/comedi/drivers/ni_usb6501.c
#![no_std]
...
pub const NI6501_TIMEOUT: c_int = 1000;
...
// Largest supported packets
    let mut TX_MAX_SIZE: static size_t = sizeof(SET_PORT_DIR_REQUEST);
    let mut RX_MAX_SIZE: static size_t = sizeof(READ_PORT_RESPONSE);
    enum commands {
    READ_PORT,
    WRITE_PORT,
    SET_PORT_DIR,
...
// mask counter value for comparing
    ...
    if (ret)
    return ret;
    ret = ni6501_port_command(dev, SET_PORT_DIR, s.io_bits, core::ptr::null_mut());
    if (ret)
    return ret;
    return insn.n;
    }
    ...
    ret = ni6501_counter_command(dev, START_COUNTER, core::ptr::null_mut());
    break;
    case INSN_CONFIG_DISARM:
    ret = ni6501_counter_command(dev, STOP_COUNTER, core::ptr::null_mut());
    break;
...
#[no_mangle]
unsafe extern "C" fn ni6501_alloc_usb_buffers(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni6501_find_endpoints(dev: *mut comedi_device) -> c_int {
    ...
    &devpriv.ep_tx, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn ni6501_detach(dev: *mut comedi_device) {
