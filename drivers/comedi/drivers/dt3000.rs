...
//! Source: drivers/comedi/drivers/dt3000.c
#![no_std]
...
pub const DPR_SUBSYS_AI: c_int = 0;
pub const DPR_SUBSYS_AO: c_int = 1;
pub const DPR_SUBSYS_DIN: c_int = 2;
pub const DPR_SUBSYS_DOUT: c_int = 3;
pub const DPR_SUBSYS_MEM: c_int = 4;
pub const DPR_SUBSYS_CT: c_int = 5;

pub const DPR_AI_FIFO_DEPTH: c_int = 2003;
pub const DPR_AO_FIFO_DEPTH: c_int = 2048;
pub const DPR_EXTERNAL_CLOCK: c_int = 1;
pub const DPR_RISING_EDGE: c_int = 2;
pub const DPR_TMODE_MASK: c_uint = 0x1c;
pub const DPR_CMD_TIMEOUT: c_int = 100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt3k_boardtype {
    pub name: *const c_char,
    pub adchan: c_int,
    pub ai_speed: c_int,
    pub adrange: *const comedi_lrange,
...
#[no_mangle]
unsafe extern "C" fn dt3k_send_cmd(dev: *mut comedi_device, cmd: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn dt3k_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dt3k_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dt3k_dio_config(dev: *mut comedi_device, bits: c_int) {
...
// XXX write 0 to DPR_PARAMS(1) and DPR_PARAMS(2) ?
    ...
    unsigned int *data)
    {
    let mut addr: c_uint = CR_CHAN(insn.chanspec);
    int i;
    for (i = 0; i < insn.n; i++) {
    ...
    const struct dt3k_boardtype *board = core::ptr::null_mut();
