...
//! Source: drivers/comedi/drivers/ni_mio_common.c
#![no_std]
...
pub const IS_PCIMIO: c_int = 1;

pub const IS_PCIMIO: c_int = 0;

// A timeout count
pub const NI_TIMEOUT: c_int = 1000;
...
pub const SERIAL_DISABLED: c_int = 0;
pub const SERIAL_600NS: c_int = 600;
pub const SERIAL_1_2US: c_int = 1200;
pub const SERIAL_10US: c_int = 10000;
    let mut num_adc_stages_611x: static int = 3;

#[no_mangle]
unsafe extern "C" fn ni_writel(dev: *mut comedi_device, data: c_uint, reg: c_int) {
    static void ni_writel(struct comedi_device *dev, unsigned int data, int reg)
    {
    writel(data, dev.mmio + reg);
    }
#[no_mangle]
unsafe extern "C" fn ni_writew(dev: *mut comedi_device, data: c_uint, reg: c_int) {
    static void ni_writew(struct comedi_device *dev, unsigned int data, int reg)
    {
    writew(data, dev.mmio + reg);
    }
#[no_mangle]
unsafe extern "C" fn ni_writeb(dev: *mut comedi_device, data: c_uint, reg: c_int) {
    static void ni_writeb(struct comedi_device *dev, unsigned int data, int reg)
    {
    writeb(data, dev.mmio + reg);
    }
#[no_mangle]
unsafe extern "C" fn ni_readl(dev: *mut comedi_device, reg: c_int) -> c_uint {
    static unsigned int ni_readl(struct comedi_device *dev, int reg)
    {
    return readl(dev.mmio + reg);
    }
#[no_mangle]
unsafe extern "C" fn ni_readw(dev: *mut comedi_device, reg: c_int) -> c_uint {
    static unsigned int ni_readw(struct comedi_device *dev, int reg)
    {
    return readw(dev.mmio + reg);
    }
#[no_mangle]
unsafe extern "C" fn ni_readb(dev: *mut comedi_device, reg: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ni_stc_readw(dev: *mut comedi_device, reg: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ni_stc_readl(dev: *mut comedi_device, reg: c_int) -> c_uint {
...
// DMA channel setup
#[no_mangle]
unsafe extern "C" fn ni_request_ai_mite_channel(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_request_ao_mite_channel(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_request_cdo_mite_channel(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_release_ai_mite_channel(dev: *mut comedi_device) {
    ...
    devpriv.ai_mite_chan = core::ptr::null_mut();
    }
    spin_unlock_irqrestore(&devpriv.mite_channel_lock, flags);

    }
#[no_mangle]
unsafe extern "C" fn ni_release_ao_mite_channel(dev: *mut comedi_device) {
    ...
    devpriv.ao_mite_chan = core::ptr::null_mut();
    }
    spin_unlock_irqrestore(&devpriv.mite_channel_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn ni_release_cdo_mite_channel(dev: *mut comedi_device) {
    ...
    devpriv.cdo_mite_chan = core::ptr::null_mut();
    }
    spin_unlock_irqrestore(&devpriv.mite_channel_lock, flags);
    }
...
#[no_mangle]
unsafe extern "C" fn ni_clear_ai_fifo(dev: *mut comedi_device) {
    static void ni_clear_ai_fifo(struct comedi_device *dev)
    {
    struct ni_private *devpriv = dev.private;
    let mut timeout: static int = 10000;
    int i;
    if (devpriv.is_6143) {
...
#[no_mangle]
pub unsafe extern "C" fn ni_ao_win_inw(dev: *mut comedi_device, addr: c_int) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn ni_sync_ai_dma(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn ni_ai_drain_dma(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_ao_wait_for_dma_load(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_handle_fifo_half_full(dev: *mut comedi_device) {
...
// Empties the AI fifo
#[no_mangle]
unsafe extern "C" fn ni_handle_fifo_dregs(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn get_last_sample_611x(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn get_last_sample_6143(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn shutdown_ai_command(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn ni_handle_eos(dev: *mut comedi_device, s: *mut comedi_subdevice) {
...
#[no_mangle]
unsafe extern "C" fn ack_a_interrupt(dev: *mut comedi_device, a_status: c_ushort) {
    static void ack_a_interrupt(struct comedi_device *dev, unsigned short a_status)
    {
    let mut ack: c_ushort = 0;
...
#[no_mangle]
unsafe extern "C" fn ack_b_interrupt(dev: *mut comedi_device, b_status: c_ushort) {
    ...
    let mut nsamples: c_uint = comedi_bytes_to_samples(s, num_bytes);
...
#[no_mangle]
unsafe extern "C" fn ni_ai_setup_MITE_dma(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: devpriv->is_628x) -> else {
...
#[no_mangle]
unsafe extern "C" fn ni_ao_setup_MITE_dma(dev: *mut comedi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ni_ai_reset(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_ai_poll(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_prime_channelgain_list(dev: *mut comedi_device) {
...
//
    ...
    const struct ni_board_struct *board = dev.board_ptr;
    struct ni_private *devpriv = dev.private;
    let mut offset: c_uint = (s.maxdata + 1) >> 1;
    unsigned int chan, range, aref;
    unsigned int i;
    unsigned int hi, lo;
    unsigned int dither;
...
// fix the external/internal range differences
    ...
    aref = AREF_DIFF;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: devpriv->is_6143) -> else {
    else if (devpriv.is_6143)
    aref = AREF_OTHER;
    switch (aref) {
    case AREF_DIFF:
...
#[no_mangle]
unsafe extern "C" fn ni_timer_to_ns(dev: *const comedi_device, timer: c_int) -> c_uint {
    ...
    let mut nbytes: c_uint = max_count;
...
// external trigger
    ...
    cmd.chanlist_len);
    if (cmd.stop_src == TRIG_COUNT) {
    let mut max_count: c_uint = 0x01000000;
    if (devpriv.is_611x)
...
// step 4: fix up any arguments
    if (cmd.scan_begin_src == TRIG_TIMER) {
    let mut tmp: c_uint = cmd.scan_begin_arg;
    cmd.scan_begin_arg =
    ...
    if (cmd.convert_src == TRIG_TIMER) {
    if (!devpriv.is_611x && !devpriv.is_6143) {
    let mut tmp: c_uint = cmd.convert_arg;
    cmd.convert_arg =
    ni_timer_to_ns(dev, ni_ns_to_timer(dev,
    cmd.convert_arg,
    cmd.flags));
...
#[no_mangle]
unsafe extern "C" fn ni_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
    ...
    let mut mode2: c_int = 0;
    let mut start_stop_select: c_int = 0;
    unsigned int stop_count;
    let mut interrupt_a_enable: c_int = 0;
...
// end configuration
    ...
    {
    let mut retval: c_int = ni_ai_setup_MITE_dma(dev);
    if (retval)
    return retval;
    }
...
// data[3] : chanlist_len
    ...
    for (i = 0; i < nsamples; i++) {
    let mut range: c_uint = CR_RANGE(cmd.chanlist[chan_index]);
    let mut val: c_ushort = array[i];
//
...
// We are not using UPDATE2-->don't have to set DACx_Source_Select
    ...
    let mut chan: c_int = CR_CHAN(cmd.chanlist[i]);
    bits |= 1 << chan;
...
#[no_mangle]
unsafe extern "C" fn ni_ao_cmd_set_fifo_mode(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn ni_ao_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_ao_reset(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_cdio_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_cdio_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_cdio_interrupt(dev: *mut comedi_device) {
...
// data_in = input;
    ...
    {
    struct ni_private *devpriv = dev.private;
    let mut clk_fout: c_uint = devpriv.clock_and_fout;
    let mut err: c_int = insn.n;
...
#[no_mangle]
unsafe extern "C" fn init_ao_67xx(dev: *mut comedi_device, s: *mut comedi_subdevice) {
    ...
    let mut stc_register: c_uint = ni_gpct_to_stc_register(dev, reg);
    if (stc_register == 0)
    return;
    switch (reg) {
...
// 16 bit registers
    ...
    {
    struct ni_private *devpriv = dev.private;
    let mut val: c_uint = NISTC_CLK_FOUT_TO_DIVIDER(devpriv.clock_and_fout);
    int i;
    for (i = 0; i < insn.n; i++)
    data[i] = val;
    return insn.n;
...
#[no_mangle]
unsafe extern "C" fn ni_get_pwm_config(dev: *mut comedi_device, data: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pack_mb88341(addr: c_int, val: c_int, bitstring: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pack_dac8800(addr: c_int, val: c_int, bitstring: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pack_dac8043(addr: c_int, val: c_int, bitstring: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pack_ad8522(addr: c_int, val: c_int, bitstring: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pack_ad8804(addr: c_int, val: c_int, bitstring: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pack_ad8842(addr: c_int, val: c_int, bitstring: *mut c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct caldac_struct {
    pub n_chans: c_int,
    pub n_bits: c_int,
    pub bitstring): *mut *mut int (packbits)(int address, int value, int,
}
...
#[no_mangle]
unsafe extern "C" fn ni_write_caldac(dev: *mut comedi_device, addr: c_int, val: c_int) {
    static void ni_write_caldac(struct comedi_device *dev, int addr, int val)
    {
    const struct ni_board_struct *board = dev.board_ptr;
    struct ni_private *devpriv = dev.private;
    let mut loadbit: c_uint = 0, bits = 0, bit, bitstring = 0;
    unsigned int cmd;
    int i;
    int type;
...
#[no_mangle]
unsafe extern "C" fn caldac_setup(dev: *mut comedi_device, s: *mut comedi_subdevice) {
    ...
    int i, j;
    int n_dacs;
    let mut n_chans: c_int = 0;
    int n_bits;
    let mut diffbits: c_int = 0;
    int type;
    int chan;
    type = board.caldac[0];
    if (type == caldac_none)
...
#[no_mangle]
unsafe extern "C" fn ni_read_eeprom(dev: *mut comedi_device, addr: c_int) -> c_int {
    static int ni_read_eeprom(struct comedi_device *dev, int addr)
    {
    let mut cmd: c_uint = NI_E_SERIAL_CMD_EEPROM_CS;
    int bit;
    int bitstring;
...
// pre-m-series boards have fixed signals on pfi pins
    ...
    {
    struct ni_private *devpriv = dev.private;
    let mut array_offset: c_uint = chan / 3;
    ...
    {
    struct ni_private *devpriv = dev.private;
    let mut index: c_uint = chan / 3;
    let mut val: c_ushort = devpriv.pfi_output_select_reg[index];
...
#[no_mangle]
unsafe extern "C" fn ni_get_pfi_direction(dev: *mut comedi_device, chan: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs5529_wait_for_idle(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs5529_command(dev: *mut comedi_device, value: c_ushort) {
    static void cs5529_command(struct comedi_device *dev, unsigned short value)
    {
    let mut timeout: static int = 100;
    int i;
...
// data ^= BIT(15);
    ...
    let mut INTERNAL_REF: c_uint = 0x1000;
//
...
#[no_mangle]
unsafe extern "C" fn init_cs5529(dev: *mut comedi_device) -> c_int {
...
// need to force a conversion for calibration to run
    cs5529_do_conversion(dev, core::ptr::null_mut());
...
//
    ...
    {
    unsigned int div;
    let mut best_div: c_uint = 1;
    unsigned int mult;
    let mut best_mult: c_uint = 1;
    let mut pico_per_nano: static unsigned int = 1000;
...
//
    let mut target_picosec: static unsigned int = 12500;
    let mut best_period_picosec: c_int = 0;
...
// actual_period_ns = DIV_ROUND_CLOSEST(best_period_picosec * 4,
    ...
    {
    struct ni_private *devpriv = dev.private;
    let mut min_period_ns: static unsigned int = 50;
    let mut max_period_ns: static unsigned int = 1000;
    let mut timeout: static unsigned int = 1000;
...
// allow new and old names of rtsi channels to work.
    ...
    {
    struct ni_private *devpriv = dev.private;
    let mut max_chan: c_uint = NISTC_RTSI_TRIG_NUM_CHAN(devpriv.is_m_series);
    if (chan >= TRIGGER_LINE(0))
// allow new and old names of rtsi channels to work.
    chan -= TRIGGER_LINE(0);
...
#[no_mangle]
unsafe extern "C" fn ni_get_rtsi_direction(dev: *mut comedi_device, chan: c_int) -> c_int {
...
// allow new and old names of rtsi channels to work.
    ...
    break;
    case INSN_CONFIG_DIO_QUERY: {
    let mut ret: c_int = ni_get_rtsi_direction(dev, chan);
    if (ret < 0)
    return ret;
    data[1] = ret;
    return 2;
    ...
    case INSN_CONFIG_GET_ROUTING: {
    let mut ret: c_int = ni_get_rtsi_routing(dev, chan);
    if (ret < 0)
    return ret;
    data[1] = ret;
    return 2;
...
//
#[no_mangle]
unsafe extern "C" fn set_rgout0_reg(reg: c_int, dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn get_rgout0_reg(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_rgout0_src(dev: *mut comedi_device) -> c_int {
    static inline int get_rgout0_src(struct comedi_device *dev)
    {
    struct ni_private *devpriv = dev.private;
    let mut reg: c_int = get_rgout0_reg(dev);
...
//
#[no_mangle]
unsafe extern "C" fn incr_rgout0_src_use(src: c_int, dev: *mut comedi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn decr_rgout0_src_use(src: c_int, dev: *mut comedi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_ith_rtsi_brd_reg(i: c_int, reg: c_int, dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn get_ith_rtsi_brd_reg(i: c_int, dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_rtsi_brd_src(brd: c_int, dev: *mut comedi_device) -> c_int {
    static inline int get_rtsi_brd_src(int brd, struct comedi_device *dev)
    {
    struct ni_private *devpriv = dev.private;
    let mut brd_index: c_int = brd;
    int reg;
...
//
#[no_mangle]
unsafe extern "C" fn incr_rtsi_brd_src_use(src: c_int, dev: *mut comedi_device) -> c_int {
    static int incr_rtsi_brd_src_use(int src, struct comedi_device *dev)
    {
    struct ni_private *devpriv = dev.private;
    let mut first_available: c_int = -1;
...
//
    ...
    &devpriv.routing_tables);
    let mut i: c_int = rtsi_brd - NI_RTSI_BRD(0);
...
#[no_mangle]
unsafe extern "C" fn ni_rtsi_init(dev: *mut comedi_device) {
...
// Get route of GPFO_i/CtrOut pins
    ...
    {
    struct ni_private *devpriv = dev.private;
    let mut reg: c_uint = devpriv.an_trig_etc_reg;
    switch (dest) {
    case 0:
...
//
#[no_mangle]
unsafe extern "C" fn get_output_select_source(dest: c_int, dev: *mut comedi_device) -> c_int {
    ...
    let mut i: c_int = reg - NI_RTSI_OUTPUT_RTSI_BRD(0);
...
// set routing source, then open output
    ...
    if (reg == NI_RTSI_OUTPUT_RGOUT0) {
    let mut ret: c_int = incr_rgout0_src_use(src, dev);
    if (ret < 0)
    return ret;
    } else if (ni_rtsi_route_requires_mux(reg)) {
// Attempt to allocate and  route (src->brd)
    let mut brd: c_int = incr_rtsi_brd_src_use(src, dev);
    if (brd < 0)
    return brd;
...
// set the pfi to high impedance, and disconnect
    ...
    if (reg == NI_RTSI_OUTPUT_RGOUT0) {
    let mut ret: c_int = decr_rgout0_src_use(src, dev);
    if (ret < 0)
    return ret;
    } else if (ni_rtsi_route_requires_mux(reg)) {
...
#[no_mangle]
unsafe extern "C" fn ni_gpct_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_gpct_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni_E_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ni_alloc_private(dev: *mut comedi_device) -> c_int {
...
// one channel for each analog output channel
    ...
    s.insn_config = core::ptr::null_mut();
    init_cs5529(dev);
    } else {
    s.type = COMEDI_SUBD_UNUSED;
    }
...
#[no_mangle]
unsafe extern "C" fn mio_common_detach(dev: *mut comedi_device) {
