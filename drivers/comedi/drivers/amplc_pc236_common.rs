...
//! Source: drivers/comedi/drivers/amplc_pc236_common.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pc236_intr_update(dev: *mut comedi_device, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn pc236_intr_check(dev: *mut comedi_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pc236_intr_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pc236_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
