...
//! Source: drivers/comedi/drivers/adl_pci9111.c
#![no_std]
...
pub const PCI9111_FIFO_HALF_SIZE: c_int = 512;
pub const PCI9111_AI_ACQUISITION_PERIOD_MIN_NS: c_int = 10000;
pub const PCI9111_RANGE_SETTING_DELAY: c_int = 10;
pub const PCI9111_AI_INSTANT_READ_UDELAY_US: c_int = 2;
//
// IO address map and bit defines
//
pub const PCI9111_AI_FIFO_REG: c_uint = 0x00;
pub const PCI9111_AO_REG: c_uint = 0x00;
pub const PCI9111_DIO_REG: c_uint = 0x02;
pub const PCI9111_EDIO_REG: c_uint = 0x04;
pub const PCI9111_AI_CHANNEL_REG: c_uint = 0x06;
pub const PCI9111_AI_RANGE_STAT_REG: c_uint = 0x08;

pub const PCI9111_AI_TRIG_CTRL_REG: c_uint = 0x0a;

pub const PCI9111_INT_CTRL_REG: c_uint = 0x0c;

pub const PCI9111_SOFT_TRIG_REG: c_uint = 0x0e;
pub const PCI9111_8254_BASE_REG: c_uint = 0x40;
pub const PCI9111_INT_CLR_REG: c_uint = 0x48;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci9111_private_data {
    pub lcr_io_base: c_ulong,
    pub scan_delay: c_uint,
    pub chunk_counter: c_uint,
    pub chunk_num_samples: c_uint,
    pub PCI9111_FIFO_HALF_SIZE]: *mut *mut unsigned short ai_bounce_buffer[2,
}
...
#[no_mangle]
unsafe extern "C" fn pci9111_fifo_reset(dev: *mut comedi_device) {
    static void pci9111_fifo_reset(struct comedi_device *dev)
    {
    let mut int_ctrl_reg: c_ulong = dev.iobase + PCI9111_INT_CTRL_REG;
...
// Set timer pacer
    ...
    let mut maxdata: c_uint = s.maxdata;
    let mut invert: c_uint = (maxdata + 1) >> 1;
    let mut shift: c_uint = (maxdata == 0xffff) ? 0 : 4;
...
#[no_mangle]
unsafe extern "C" fn pci9111_interrupt(irq: c_int, p_device: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pci9111_reset(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci9111_detach(dev: *mut comedi_device) {
