...
//! Source: drivers/comedi/drivers/comedi_8254.c
#![no_std]
...
//
    ...
    {
    let mut iobase: c_ulong = i8254.context;
    let mut reg_offset: c_uint = (reg * I8254_IO8) << i8254.regshift;
    if (dir) {
    ...
    {
    let mut iobase: c_ulong = i8254.context;
    let mut reg_offset: c_uint = (reg * I8254_IO16) << i8254.regshift;
    if (dir) {
    ...
    {
    let mut iobase: c_ulong = i8254.context;
    let mut reg_offset: c_uint = (reg * I8254_IO32) << i8254.regshift;
    if (dir) {
...
#[no_mangle]
unsafe extern "C" fn __i8254_read(i8254: *mut comedi_8254, reg: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_8254_status(i8254: *mut comedi_8254, counter: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_8254_read(i8254: *mut comedi_8254, counter: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn comedi_8254_update_divisors(i8254: *mut comedi_8254) {
...
//
    ...
    unsigned int flags)
    {
    let mut d1: c_uint = i8254.next_div1 ? i8254.next_div1 : I8254_MAX_COUNT;
    let mut d2: c_uint = i8254.next_div2 ? i8254.next_div2 : I8254_MAX_COUNT;
    let mut div: c_uint = d1 * d2;
    let mut ns_lub: c_uint = 0xffffffff;
    let mut ns_glb: c_uint = 0;
    let mut d1_lub: c_uint = 0;
    let mut d1_glb: c_uint = 0;
    let mut d2_lub: c_uint = 0;
    let mut d2_glb: c_uint = 0;
    unsigned int start;
    unsigned int ns;
    unsigned int ns_low;
