...
//! Source: drivers/comedi/drivers/amplc_pci224.c
#![no_std]
...
//
pub const PCI224_Z2_BASE: c_uint = 0x14	/* 82C54 counter/timer */;
pub const PCI224_ZCLK_SCE: c_uint = 0x1A	/* Group Z Clock Configuration Register */;
pub const PCI224_ZGAT_SCE: c_uint = 0x1D	/* Group Z Gate Configuration Register */;
pub const PCI224_INT_SCE: c_uint = 0x1E	/* ISR Interrupt source mask register */;
// /Interrupt status
//
// PCI224/234 i/o space 2 (PCIBAR3) 16-bit registers.
//
pub const PCI224_DACDATA: c_uint = 0x00	/* (w-o) DAC FIFO data. */;
pub const PCI224_SOFTTRIG: c_uint = 0x00	/* (r-o) DAC software scan trigger. */;
pub const PCI224_DACCON: c_uint = 0x02	/* (r/w) DAC status/configuration. */;
pub const PCI224_FIFOSIZ: c_uint = 0x04	/* (w-o) FIFO size for wraparound mode. */;
pub const PCI224_DACCEN: c_uint = 0x06	/* (w-o) DAC channel enable register. */;
//
// DACCON values.
//
// (r/w) Scan trigger.
...
// DAC FIFO size.
//
pub const PCI224_FIFO_SIZE: c_int = 4096;
//
...
pub const PCI224_FIFO_ROOM_HALFTOFULL: c_int = 1;
pub const PCI224_FIFO_ROOM_FULL: c_int = 0;
//
// Counter/timer clock input configuration sources.
//

#[no_mangle]
unsafe extern "C" fn pci224_clk_config(chan: c_uint, src: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pci224_gat_config(chan: c_uint, src: c_uint) -> c_uint {
...
//
pub const PCI224_INTR_EXT: c_uint = 0x01	/* rising edge on external input */;
pub const PCI224_INTR_DAC: c_uint = 0x04	/* DAC (FIFO) interrupt */;
pub const PCI224_INTR_Z2CT1: c_uint = 0x20	/* rising edge on Z2-CT1 output */;
...
pub const AO_CMD_STARTED: c_int = 0;
//
// Range tables.
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci224_board {
    pub name: *const c_char,
    pub ao_chans: c_uint,
    pub ao_bits: c_uint,
    pub ao_range: *const comedi_lrange,
    pub ao_hwrange: *const c_ushort,
    pub ao_range_check: *const c_uchar,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci224_private {
    pub iobase1: c_ulong,
    pub state: c_ulong,
    pub /: *mut *mut spinlock_t ao_spinlock; / spinlock for AO command handling,
    pub ao_scan_vals: *mut c_ushort,
    pub ao_scan_order: *mut c_uchar,
    pub intr_cpuid: c_int,
    pub intr_running: c_short,
    pub daccon: c_ushort,
    pub /: *mut *mut unsigned short ao_enab; / max 16 channels so 'short' will do,
    pub intsce: c_uchar,
}
...
pub const MAX_SCAN_PERIOD: c_uint = 0xFFFFFFFFU;
pub const MIN_SCAN_PERIOD: c_int = 2500;
pub const CONVERT_PERIOD: c_int = 625;
//
...
#[no_mangle]
unsafe extern "C" fn pci224_ao_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
//
    ...
    let mut length: c_uint = num_bytes / sizeof(*array);
    unsigned int offset;
    unsigned int shift;
    unsigned int i;
...
//
#[no_mangle]
unsafe extern "C" fn pci224_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
// Temporarily disable interrupt sources.
    ...
    pci224_ao_start(dev, s);
#[no_mangle]
pub unsafe extern "C" fn if(TRIG_EXT: cmd->stop_src ==) -> else {
...
// Reenable interrupt sources.
    ...
    const struct pci224_board *board = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pci224_detach(dev: *mut comedi_device) {
