...
//! Source: drivers/comedi/drivers/das16.c
#![no_std]
...
pub const DAS16_DMA_SIZE: c_uint = 0xff00	/*  size in bytes of allocated dma buffer */;
//
// Register I/O map
//
pub const DAS16_TRIG_REG: c_uint = 0x00;
pub const DAS16_AI_LSB_REG: c_uint = 0x00;
pub const DAS16_AI_MSB_REG: c_uint = 0x01;
pub const DAS16_MUX_REG: c_uint = 0x02;
pub const DAS16_DIO_REG: c_uint = 0x03;

pub const DAS16_STATUS_REG: c_uint = 0x08;

pub const DAS16_CTRL_REG: c_uint = 0x09;

pub const DAS16_PACER_REG: c_uint = 0x0a;

pub const DAS16_GAIN_REG: c_uint = 0x0b;
pub const DAS16_TIMER_BASE_REG: c_uint = 0x0c	/* to 0x0f */;
pub const DAS1600_CONV_REG: c_uint = 0x404;

pub const DAS1600_BURST_REG: c_uint = 0x405;

pub const DAS1600_ENABLE_REG: c_uint = 0x406;

pub const DAS1600_STATUS_REG: c_uint = 0x407;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct das16_board {
    pub name: *const c_char,
    pub ai_maxdata: c_uint,
    pub /: *mut *mut unsigned int ai_speed; / max conversion speed in nanosec,
    pub ai_pg: c_uint,
    pub has_ao:1: c_uint,
...
//
#[no_mangle]
pub unsafe extern "C" fn timer_period() -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct das16_private_struct {
    pub dma: *mut comedi_isadma,
    pub dev: *mut comedi_device,
    pub clockbase: c_uint,
    pub ctrl_reg: c_uint,
    pub divisor1: c_uint,
    pub divisor2: c_uint,
    pub timer: timer_list,
    pub extra_iobase: c_ulong,
    pub can_burst:1: c_uint,
...
#[no_mangle]
unsafe extern "C" fn das16_interrupt(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn das16_timer_interrupt(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn das16_cmd_exec(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
    ...
    struct comedi_async *async = s.async;
    struct comedi_cmd *cmd = &async.cmd;
    let mut first_chan: c_uint = CR_CHAN(cmd.chanlist[0]);
    let mut last_chan: c_uint = CR_CHAN(cmd.chanlist[cmd.chanlist_len - 1]);
...
#[no_mangle]
unsafe extern "C" fn das16_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn das16_probe(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn das16_reset(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn das16_alloc_dma(dev: *mut comedi_device, dma_chan: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn das16_free_dma(dev: *mut comedi_device) {
    ...
    unsigned int status)
    {
    let mut min: c_uint = it.options[4];
    let mut max: c_uint = it.options[5];
...
// use software programmable range
    ...
    struct comedi_devconfig *it)
    {
    let mut min: c_uint = it.options[6];
    let mut max: c_uint = it.options[7];
...
#[no_mangle]
unsafe extern "C" fn das16_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
...
// check that clock setting is valid
    ...
    devpriv.dev = dev;
    if (board.size < 0x400) {
    let mut size: c_uint = board.size;
...
#[no_mangle]
unsafe extern "C" fn das16_detach(dev: *mut comedi_device) {
