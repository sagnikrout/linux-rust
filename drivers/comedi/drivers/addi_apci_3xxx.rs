...
//! Source: drivers/comedi/drivers/addi_apci_3xxx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apci3xxx_boardinfo {
    pub name: *const c_char,
    pub ai_subdev_flags: c_int,
    pub ai_n_chan: c_int,
    pub ai_maxdata: c_uint,
    pub ai_conv_units: c_uchar,
    pub ai_min_acq_ns: c_uint,
    pub has_ao:1: c_uint,
    pub has_dig_in:1: c_uint,
    pub has_dig_out:1: c_uint,
    pub has_ttl_io:1: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apci3xxx_private {
    pub ai_timer: c_uint,
    pub ai_time_base: c_uchar,
}

#[no_mangle]
unsafe extern "C" fn apci3xxx_irq_handler(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn apci3xxx_ai_started(dev: *mut comedi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apci3xxx_ai_setup(dev: *mut comedi_device, chanspec: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apci3xxx_reset(dev: *mut comedi_device) -> c_int {
...
// Enable the interrupt
    ...
    const struct apci3xxx_boardinfo *board = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn apci3xxx_detach(dev: *mut comedi_device) {
