...
//! Source: drivers/comedi/drivers/pcm3724.c
#![no_std]
...
//
pub const PCM3724_8255_0_BASE: c_uint = 0x00;
pub const PCM3724_8255_1_BASE: c_uint = 0x04;
pub const PCM3724_DIO_DIR_REG: c_uint = 0x08;

pub const PCM3724_GATE_CTRL_REG: c_uint = 0x09;
...
#[no_mangle]
unsafe extern "C" fn compute_buffer(config: c_int, devno: c_int, s: *mut comedi_subdevice) -> c_int {
