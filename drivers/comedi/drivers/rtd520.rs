...
//! Source: drivers/comedi/drivers/rtd520.c
#![no_std]
...
//
pub const LAS0_USER_IO: c_uint = 0x0008	/* User I/O */;
pub const LAS0_ADC: c_uint = 0x0010	/* FIFO Status/Software A/D Start */;

pub const LAS0_DAC: c_uint = 0x0024	/* Software Simultaneous Update (w) */;
pub const LAS0_PACER: c_uint = 0x0028	/* Software Pacer Start/Stop */;
pub const LAS0_TIMER: c_uint = 0x002c	/* Timer Status/HDIN Software Trig. */;
pub const LAS0_IT: c_uint = 0x0030	/* Interrupt Status/Enable */;

pub const LAS0_CLEAR: c_uint = 0x0034	/* Clear/Set Interrupt Clear Mask */;
pub const LAS0_OVERRUN: c_uint = 0x0038	/* Pending interrupts/Clear Overrun */;
pub const LAS0_PCLK: c_uint = 0x0040	/* Pacer Clock (24bit) */;
pub const LAS0_BCLK: c_uint = 0x0044	/* Burst Clock (10bit) */;
pub const LAS0_ADC_SCNT: c_uint = 0x0048	/* A/D Sample counter (10bit) */;
pub const LAS0_DAC1_UCNT: c_uint = 0x004c	/* D/A1 Update counter (10 bit) */;
pub const LAS0_DAC2_UCNT: c_uint = 0x0050	/* D/A2 Update counter (10 bit) */;
pub const LAS0_DCNT: c_uint = 0x0054	/* Delay counter (16 bit) */;
pub const LAS0_ACNT: c_uint = 0x0058	/* About counter (16 bit) */;
pub const LAS0_DAC_CLK: c_uint = 0x005c	/* DAC clock (16bit) */;
pub const LAS0_8254_TIMER_BASE: c_uint = 0x0060	/* 8254 timer/counter base */;
pub const LAS0_DIO0: c_uint = 0x0070	/* Digital I/O Port 0 */;
pub const LAS0_DIO1: c_uint = 0x0074	/* Digital I/O Port 1 */;
pub const LAS0_DIO0_CTRL: c_uint = 0x0078	/* Digital I/O Control */;
pub const LAS0_DIO_STATUS: c_uint = 0x007c	/* Digital I/O Status */;
pub const LAS0_BOARD_RESET: c_uint = 0x0100	/* Board reset */;
pub const LAS0_DMA0_SRC: c_uint = 0x0104	/* DMA 0 Sources select */;
pub const LAS0_DMA1_SRC: c_uint = 0x0108	/* DMA 1 Sources select */;
pub const LAS0_ADC_CONVERSION: c_uint = 0x010c	/* A/D Conversion Signal select */;
pub const LAS0_BURST_START: c_uint = 0x0110	/* Burst Clock Start Trigger select */;
pub const LAS0_PACER_START: c_uint = 0x0114	/* Pacer Clock Start Trigger select */;
pub const LAS0_PACER_STOP: c_uint = 0x0118	/* Pacer Clock Stop Trigger select */;
pub const LAS0_ACNT_STOP_ENABLE: c_uint = 0x011c	/* About Counter Stop Enable */;
pub const LAS0_PACER_REPEAT: c_uint = 0x0120	/* Pacer Start Trigger Mode select */;
pub const LAS0_DIN_START: c_uint = 0x0124	/* HiSpd DI Sampling Signal select */;
pub const LAS0_DIN_FIFO_CLEAR: c_uint = 0x0128	/* Digital Input FIFO Clear */;
pub const LAS0_ADC_FIFO_CLEAR: c_uint = 0x012c	/* A/D FIFO Clear */;
pub const LAS0_CGT_WRITE: c_uint = 0x0130	/* Channel Gain Table Write */;
pub const LAS0_CGL_WRITE: c_uint = 0x0134	/* Channel Gain Latch Write */;
pub const LAS0_CG_DATA: c_uint = 0x0138	/* Digital Table Write */;
pub const LAS0_CGT_ENABLE: c_uint = 0x013c	/* Channel Gain Table Enable */;
pub const LAS0_CG_ENABLE: c_uint = 0x0140	/* Digital Table Enable */;
pub const LAS0_CGT_PAUSE: c_uint = 0x0144	/* Table Pause Enable */;
pub const LAS0_CGT_RESET: c_uint = 0x0148	/* Reset Channel Gain Table */;
pub const LAS0_CGT_CLEAR: c_uint = 0x014c	/* Clear Channel Gain Table */;

pub const LAS0_ADC_SCNT_SRC: c_uint = 0x0178	/* A/D Sample Counter Source select */;
pub const LAS0_PACER_SELECT: c_uint = 0x0180	/* Pacer Clock select */;
pub const LAS0_SBUS0_SRC: c_uint = 0x0184	/* SyncBus 0 Source select */;
pub const LAS0_SBUS0_ENABLE: c_uint = 0x0188	/* SyncBus 0 enable */;
pub const LAS0_SBUS1_SRC: c_uint = 0x018c	/* SyncBus 1 Source select */;
pub const LAS0_SBUS1_ENABLE: c_uint = 0x0190	/* SyncBus 1 enable */;
pub const LAS0_SBUS2_SRC: c_uint = 0x0198	/* SyncBus 2 Source select */;
pub const LAS0_SBUS2_ENABLE: c_uint = 0x019c	/* SyncBus 2 enable */;
pub const LAS0_ETRG_POLARITY: c_uint = 0x01a4	/* Ext. Trigger polarity select */;
pub const LAS0_EINT_POLARITY: c_uint = 0x01a8	/* Ext. Interrupt polarity select */;

pub const LAS0_UOUT0_SELECT: c_uint = 0x01c4	/* User Output 0 source select */;
pub const LAS0_UOUT1_SELECT: c_uint = 0x01c8	/* User Output 1 source select */;
pub const LAS0_DMA0_RESET: c_uint = 0x01cc	/* DMA0 Request state machine reset */;
pub const LAS0_DMA1_RESET: c_uint = 0x01d0	/* DMA1 Request state machine reset */;
//
// Local Address Space 1 Offsets
//
pub const LAS1_ADC_FIFO: c_uint = 0x0000	/* A/D FIFO (16bit) */;
pub const LAS1_HDIO_FIFO: c_uint = 0x0004	/* HiSpd DI FIFO (16bit) */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtd_boardinfo {
    pub name: *const c_char,
    pub /: *mut *mut int range_bip10; / start of +-10V range,
    pub /: *mut *mut int range_uni10; / start of +10V range,
    pub ai_range: *const comedi_lrange,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtd_private {
// memory mapped board structures
    pub las1: *mut void __iomem,
    pub lcfg: *mut void __iomem,
    pub /: *mut *mut long ai_count; / total transfer size (samples),
    pub /: *mut *mut int xfer_count; / # to transfer data. 0->1/2FIFO,
    pub /: *mut *mut int flags; / flag event modes,
    pub fifosz: c_uint,
// 8254 Timer/Counter gate and clock sources
    pub timer_gate_src: [c_uchar; 3],
    pub timer_clk_src: [c_uchar; 3],
}

// bit defines for "flags"
pub const SEND_EOS: c_uint = 0x01	/* send End Of Scan events */;
pub const DMA0_ACTIVE: c_uint = 0x02	/* DMA0 is active */;
pub const DMA1_ACTIVE: c_uint = 0x04	/* DMA1 is active */;
//
...
//
#[no_mangle]
unsafe extern "C" fn rtd_ns_to_timer(ns: *mut c_uint, flags: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rtd520_probe_fifo_depth(dev: *mut comedi_device) -> c_int {
    static int rtd520_probe_fifo_depth(struct comedi_device *dev)
    {
    let mut chanspec: c_uint = CR_PACK(0, 0, AREF_GROUND);
    unsigned int i;
    let mut limit: static unsigned int = 0x2000;
...
// return the number of samples read/written
    ...
    let mut range: c_uint = CR_RANGE(cmd.chanlist[async.cur_chan]);
    unsigned short d;
...
#[no_mangle]
unsafe extern "C" fn rtd_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rtd_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtd_ai_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
// pacer stop source: SOFTWARE
    ...
    let mut bit: c_uint = (chan == 0) ? FS_DAC1_NOT_EMPTY : FS_DAC2_NOT_EMPTY;
    unsigned int status;
    status = readl(dev.mmio + LAS0_ADC);
    if (status & bit)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn rtd_reset(dev: *mut comedi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rtd_init_board(dev: *mut comedi_device) {
...
// The RTD driver does this
    ...
    const struct rtd_boardinfo *board = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rtd_detach(dev: *mut comedi_device) {
