...
//! Source: drivers/comedi/drivers/pcl812.c
#![no_std]
...
// Register I/O map
//
pub const PCL812_TIMER_BASE: c_uint = 0x00;
pub const PCL812_AI_LSB_REG: c_uint = 0x04;
pub const PCL812_AI_MSB_REG: c_uint = 0x05;

pub const PCL812_DI_LSB_REG: c_uint = 0x06;
pub const PCL812_DI_MSB_REG: c_uint = 0x07;
pub const PCL812_STATUS_REG: c_uint = 0x08;

pub const PCL812_RANGE_REG: c_uint = 0x09;
pub const PCL812_MUX_REG: c_uint = 0x0a;

pub const PCL812_CTRL_REG: c_uint = 0x0b;

pub const PCL812_SOFTTRIG_REG: c_uint = 0x0c;
pub const PCL812_DO_LSB_REG: c_uint = 0x0d;
pub const PCL812_DO_MSB_REG: c_uint = 0x0e;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcl812_board {
    pub name: *const c_char,
    pub board_type: enum pcl812_boardtype,
    pub min_io_start: c_ushort,
    pub n_aichan: c_int,
    pub n_aochan: c_int,
    pub ai_ns_min: c_uint,
    pub rangelist_ai: *const comedi_lrange,
    pub irq_bits: c_uint,
    pub has_dma:1: c_uint,
    pub has_16bit_ai:1: c_uint,
    pub has_mpc508_mux:1: c_uint,
    pub has_dio:1: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pcl812_private {
    pub dma: *mut comedi_isadma,
    pub /: *mut *mut unsigned char range_correction; / =1 we must add 1 to range number,
    pub last_ai_chanspec: c_uint,
    pub /: *mut *mut unsigned char mode_reg_int; / stored INT number for some cards,
    pub /: *mut *mut unsigned int ai_poll_ptr; / how many samples transfer poll,
    pub /: *mut *mut unsigned int max_812_ai_mode0_rangewait; / settling time for gain,
    pub use_diff:1: c_uint,
    pub use_mpc508:1: c_uint,
    pub use_ext_trg:1: c_uint,
    pub ai_dma:1: c_uint,
    pub ai_eos:1: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn pcl812_ai_clear_eoc(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcl812_ai_soft_trig(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcl812_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
// setup and enable dma for the first buffer
    ...
    {
    struct comedi_cmd *cmd = &s.async.cmd;
    let mut chan: c_uint = s.async.cur_chan;
    unsigned int next_chan;
    unsigned short val;
    if (pcl812_ai_eoc(dev, s, core::ptr::null_mut(), 0)) {
...
#[no_mangle]
unsafe extern "C" fn pcl812_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pcl812_ai_poll(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcl812_reset(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcl812_alloc_dma(dev: *mut comedi_device, dma_chan: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pcl812_free_dma(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn pcl812_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pcl812_detach(dev: *mut comedi_device) {
