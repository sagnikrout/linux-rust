...
//! Source: drivers/comedi/drivers/ni_at_a2150.c
#![no_std]
...
pub const A2150_DMA_BUFFER_SIZE: c_uint = 0xff00	/*  size in bytes of dma buffer */;
// Registers and bits
pub const CONFIG_REG: c_uint = 0x0;

pub const CHANNEL_MASK: c_uint = 0x7;

// enable (don't internally ground) channels 0 and 1
pub const ENABLE0_BIT: c_uint = 0x80;
// enable (don't internally ground) channels 2 and 3
pub const ENABLE1_BIT: c_uint = 0x100;
pub const AC0_BIT: c_uint = 0x200	/* ac couple channels 0,1 */;
pub const AC1_BIT: c_uint = 0x400	/* ac couple channels 2,3 */;
pub const APD_BIT: c_uint = 0x800	/* analog power down */;
pub const DPD_BIT: c_uint = 0x1000	/* digital power down */;
pub const TRIGGER_REG: c_uint = 0x2	/* trigger config register */;
pub const POST_TRIGGER_BITS: c_uint = 0x2;
pub const DELAY_TRIGGER_BITS: c_uint = 0x3;
pub const HW_TRIG_EN: c_uint = 0x10	/* enable hardware trigger */;
pub const FIFO_START_REG: c_uint = 0x6	/* software start aquistion trigger */;
pub const FIFO_RESET_REG: c_uint = 0x8	/* clears fifo + fifo flags */;
pub const FIFO_DATA_REG: c_uint = 0xa	/* read data */;
pub const DMA_TC_CLEAR_REG: c_uint = 0xe	/* clear dma terminal count interrupt */;
pub const STATUS_REG: c_uint = 0x12	/* read only */;
pub const FNE_BIT: c_uint = 0x1	/* fifo not empty */;
pub const OVFL_BIT: c_uint = 0x8	/* fifo overflow */;
pub const EDAQ_BIT: c_uint = 0x10	/* end of acquisition interrupt */;
pub const DCAL_BIT: c_uint = 0x20	/* offset calibration in progress */;
pub const INTR_BIT: c_uint = 0x40	/* interrupt has occurred */;
// dma terminal count interrupt has occurred
pub const DMA_TC_BIT: c_uint = 0x80;

pub const IRQ_DMA_CNTRL_REG: c_uint = 0x12			/* write only */;

pub const DMA_EN_BIT: c_uint = 0x8			/* enables dma */;

pub const FIFO_INTR_EN_BIT: c_uint = 0x100	/* enable fifo interrupts */;
pub const FIFO_INTR_FHF_BIT: c_uint = 0x200	/* interrupt fifo half full */;
// enable interrupt on dma terminal count
pub const DMA_INTR_EN_BIT: c_uint = 0x800;
pub const DMA_DEM_EN_BIT: c_uint = 0x1000	/* enables demand mode dma */;
pub const I8253_BASE_REG: c_uint = 0x14;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct a2150_board {
    pub name: *const c_char,
    pub /: *mut *mut int clock[4]; / master clock periods, in nanoseconds,
    pub /: *mut *mut int num_clocks; / number of available master clock speeds,
    pub /: *mut *mut int ai_speed; / maximum conversion rate in nanoseconds,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct a2150_private {
    pub dma: *mut comedi_isadma,
    pub /: *mut *mut unsigned int count; / number of data points left to be taken,
    pub /: *mut *mut int irq_dma_bits; / irq/dma register bits,
    pub /: *mut *mut int config_bits; / config register bits,
}

// interrupt service routine
#[no_mangle]
unsafe extern "C" fn a2150_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn a2150_cancel(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(2: start_channel ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn a2150_ai_cmd(dev: *mut comedi_device, s: *mut comedi_subdevice) -> c_int {
    ...
    let mut old_config_bits: c_uint = devpriv.config_bits;
...
pub const ONE_THIRD_SECOND: c_int = 333333333;
...
#[no_mangle]
unsafe extern "C" fn a2150_free_dma(dev: *mut comedi_device) {
    ...
    {
    let mut id: c_int = ID_BITS(inw(dev.iobase + STATUS_REG));
    if (id >= ARRAY_SIZE(a2150_boards))
    return core::ptr::null_mut();
    return &a2150_boards[id];
    }
#[no_mangle]
unsafe extern "C" fn a2150_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
    static int a2150_attach(struct comedi_device *dev, struct comedi_devconfig *it)
    {
    const struct a2150_board *board;
    struct a2150_private *devpriv;
    struct comedi_subdevice *s;
    let mut timeout: static int = 2000;
    int i;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn a2150_detach(dev: *mut comedi_device) {
