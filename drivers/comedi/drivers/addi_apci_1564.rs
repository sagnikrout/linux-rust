...
//! Source: drivers/comedi/drivers/addi_apci_1564.c
#![no_std]
...
//
pub const APCI1564_EEPROM_REG: c_uint = 0x00;

pub const APCI1564_REV1_TIMER_IOBASE: c_uint = 0x04;
pub const APCI1564_REV2_MAIN_IOBASE: c_uint = 0x04;
pub const APCI1564_REV2_TIMER_IOBASE: c_uint = 0x48;
//
// PCI BAR 1
//
// PLD Revision 1.0 I/O Mapping
...
// 0x30         Counter_3
//
pub const APCI1564_REV1_MAIN_IOBASE: c_uint = 0x00;
//
// dev->iobase Register Map
// PLD Revision 1.0 - PCI BAR 1 + 0x00
// PLD Revision 2.x - PCI BAR 0 + 0x04
//
pub const APCI1564_DI_REG: c_uint = 0x00;
pub const APCI1564_DI_INT_MODE1_REG: c_uint = 0x04;
pub const APCI1564_DI_INT_MODE2_REG: c_uint = 0x08;
pub const APCI1564_DI_INT_MODE_MASK: c_uint = 0x000ffff0 /* chans [19:4] */;
pub const APCI1564_DI_INT_STATUS_REG: c_uint = 0x0c;
pub const APCI1564_DI_IRQ_REG: c_uint = 0x10;

pub const APCI1564_DO_REG: c_uint = 0x14;
pub const APCI1564_DO_INT_CTRL_REG: c_uint = 0x18;

pub const APCI1564_DO_INT_STATUS_REG: c_uint = 0x1c;

pub const APCI1564_DO_IRQ_REG: c_uint = 0x20;

pub const APCI1564_WDOG_IOBASE: c_uint = 0x24;
//
...
pub const APCI1564_EVENT_MASK: c_uint = 0xfff0000f /* all but [19:4] */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apci1564_private {
    pub /: *mut *mut unsigned long eeprom; / base address of EEPROM register,
    pub /: *mut *mut unsigned long timer; / base address of 12-bit timer,
    pub /: *mut *mut unsigned long counters; / base address of 32-bit counters,
    pub /: *mut *mut unsigned int mode1; / rising-edge/high level channels,
    pub /: *mut *mut unsigned int mode2; / falling-edge/low level channels,
    pub /: *mut *mut unsigned int ctrl; / interrupt mode OR (edge) . AND (level),
}

#[no_mangle]
unsafe extern "C" fn apci1564_reset(dev: *mut comedi_device) -> c_int {
...
// Reset the timer registers
    ...
    if (devpriv.counters) {
    let mut iobase: c_ulong = devpriv.counters + ADDI_TCW_CTRL_REG;
...
#[no_mangle]
unsafe extern "C" fn apci1564_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
// return the actual value of the timer
    ...
    let mut iobase: c_ulong = devpriv.counters + APCI1564_COUNTER(chan);
    unsigned int val;
    switch (data[0]) {
    case INSN_CONFIG_ARM:
...
#[no_mangle]
unsafe extern "C" fn apci1564_detach(dev: *mut comedi_device) {
