...
//! Source: drivers/comedi/drivers/comedi_8255.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct subdev_8255_private {
    pub context: c_ulong,
    ...
    let mut context: c_ulong = spriv.context;
    unsigned int mask;
    unsigned int v;
...
//
#[no_mangle]
pub unsafe extern "C" fn subdev_8255_regbase(s: *mut comedi_subdevice) -> c_ulong {
