...
//! Source: drivers/comedi/drivers/dt2811.c
#![no_std]
...
// Register I/O map
//
pub const DT2811_ADCSR_REG: c_uint = 0x00	/* r/w  A/D Control/Status */;

pub const DT2811_ADGCR_REG: c_uint = 0x01	/* r/w  A/D Gain/Channel */;

pub const DT2811_ADDATA_LO_REG: c_uint = 0x02	/* r   A/D Data low byte */;
pub const DT2811_ADDATA_HI_REG: c_uint = 0x03	/* r   A/D Data high byte */;

pub const DT2811_DI_REG: c_uint = 0x06	/* r   Digital Input Port 0 */;
pub const DT2811_DO_REG: c_uint = 0x06	/* w   Digital Output Port 1 */;
pub const DT2811_TMRCTR_REG: c_uint = 0x07	/* r/w  Timer/Counter */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dt2811_private {
    pub ai_divisor: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn dt2811_interrupt(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
// load chanspec - enables timer
    ...
    let mut ns_lo: c_uint = COMEDI_MIN_SPEED;
    let mut ns_hi: c_uint = 0;
    let mut divisor_hi: c_uint = 0;
    let mut divisor_lo: c_uint = 0;
    unsigned int _div;
    unsigned int _mult;
//
...
//
    ...
    let mut div: c_uint = dt2811_clk_dividers[_div];
    let mut mult: c_uint = dt2811_clk_multipliers[_mult];
    let mut divider: c_ulonglong = div * mult;
...
#[no_mangle]
unsafe extern "C" fn dt2811_reset(dev: *mut comedi_device) {
...
#[no_mangle]
unsafe extern "C" fn dt2811_attach(dev: *mut comedi_device, it: *mut comedi_devconfig) -> c_int {
