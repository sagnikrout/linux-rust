...
//! Source: drivers/accel/habanalabs/gaudi2/gaudi2_security.c
#![no_std]
...
// LBW RR
pub const SFT_NUM_OF_LBW_RTR: c_int = 1;
pub const SFT_LBW_RTR_OFFSET: c_int = 0;
pub const RR_LBW_LONG_MASK: c_uint = 0x7FFFFFFull;
pub const RR_LBW_SHORT_MASK: c_uint = 0x7FFF000ull;
// HBW RR
pub const SFT_NUM_OF_HBW_RTR: c_int = 2;
pub const RR_HBW_SHORT_LO_MASK: c_uint = 0xFFFFFFFF000ull;
pub const RR_HBW_SHORT_HI_MASK: c_uint = 0xF00000000000ull;
pub const RR_HBW_LONG_LO_MASK: c_uint = 0xFFFFFFFF000ull;
pub const RR_HBW_LONG_HI_MASK: c_uint = 0xFFFFF00000000000ull;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rr_config {
    pub min: u64,
    pub max: u64,
    pub index: u32,
    pub type: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_atypical_bp_blocks {
    pub mm_block_base_addr: u32,
    pub block_size: u32,
    pub glbl_sec_offset: u32,
    pub glbl_sec_length: u32,
}
...
pub const mmNIC0_QPC0_SPECIAL_GLBL_SPARE: c_uint = 0x541FF60;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_tpc_pb_data {
    pub glbl_sec: *mut hl_block_glbl_sec,
    pub block_array_size: u32,
}
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_pb_tpc(hdev: *mut hl_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_tpc_arc_pb_data {
    pub unsecured_regs_arr_size: u32,
    pub arc_regs_arr_size: u32,
}
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_pb_tpc_arc(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_pb_sm_objs(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_write_lbw_range_register(hdev: *mut hl_device, base: u64, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_lbw_range_registers_secure(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_lbw_range_registers(hdev: *mut hl_device) {
    static void gaudi2_init_lbw_range_registers(struct hl_device *hdev)
    {
    gaudi2_init_lbw_range_registers_secure(hdev);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_write_hbw_range_register(hdev: *mut hl_device, base: u64, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_hbw_range_registers(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_mmu_range_registers(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn gaudi2_init_range_registers(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn gaudi2_init_protection_bits(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gaudi2_init_security(hdev: *mut hl_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_ack_pb_tpc_data {
    pub tpc_regs_array_size: u32,
    pub arc_tpc_regs_array_size: u32,
}
...
#[no_mangle]
unsafe extern "C" fn gaudi2_ack_pb_tpc(hdev: *mut hl_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gaudi2_ack_protection_bits_errors(hdev: *mut hl_device) {
