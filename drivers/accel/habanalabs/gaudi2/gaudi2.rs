...
//! Source: drivers/accel/habanalabs/gaudi2/gaudi2.c
#![no_std]
...
pub const GAUDI2_RESET_POLL_CNT: c_int = 3;

pub const GAUDI2_CB_POOL_CB_CNT: c_int = 512;

pub const GAUDI2_ALLOC_CPU_MEM_RETRY_CNT: c_int = 3;
//
...
//
pub const MAX_CLUSTER_BINNING_FAULTY_TPCS: c_int = 1;
pub const MAX_FAULTY_XBARS: c_int = 1;
pub const MAX_FAULTY_EDMAS: c_int = 1;
pub const MAX_FAULTY_DECODERS: c_int = 1;
pub const GAUDI2_TPC_FULL_MASK: c_uint = 0x1FFFFFF;
pub const GAUDI2_HIF_HMMU_FULL_MASK: c_uint = 0xFFFF;
pub const GAUDI2_DECODER_FULL_MASK: c_uint = 0x3FF;
pub const GAUDI2_NA_EVENT_CAUSE: c_uint = 0xFF;
pub const GAUDI2_NUM_OF_QM_ERR_CAUSE: c_int = 18;
pub const GAUDI2_NUM_OF_LOWER_QM_ERR_CAUSE: c_int = 25;
pub const GAUDI2_NUM_OF_QM_ARB_ERR_CAUSE: c_int = 3;
pub const GAUDI2_NUM_OF_ARC_SEI_ERR_CAUSE: c_int = 14;
pub const GAUDI2_NUM_OF_CPU_SEI_ERR_CAUSE: c_int = 3;
pub const GAUDI2_NUM_OF_QM_SEI_ERR_CAUSE: c_int = 2;
pub const GAUDI2_NUM_OF_ROT_ERR_CAUSE: c_int = 22;
pub const GAUDI2_NUM_OF_TPC_INTR_CAUSE: c_int = 31;
pub const GAUDI2_NUM_OF_DEC_ERR_CAUSE: c_int = 25;
pub const GAUDI2_NUM_OF_MME_ERR_CAUSE: c_int = 16;
pub const GAUDI2_NUM_OF_MME_WAP_ERR_CAUSE: c_int = 7;
pub const GAUDI2_NUM_OF_DMA_CORE_INTR_CAUSE: c_int = 8;
pub const GAUDI2_NUM_OF_MMU_SPI_SEI_CAUSE: c_int = 19;
pub const GAUDI2_NUM_OF_HBM_SEI_CAUSE: c_int = 9;
pub const GAUDI2_NUM_OF_SM_SEI_ERR_CAUSE: c_int = 3;
pub const GAUDI2_NUM_OF_PCIE_ADDR_DEC_ERR_CAUSE: c_int = 3;
pub const GAUDI2_NUM_OF_PMMU_FATAL_ERR_CAUSE: c_int = 2;
pub const GAUDI2_NUM_OF_HIF_FATAL_ERR_CAUSE: c_int = 2;
pub const GAUDI2_NUM_OF_AXI_DRAIN_ERR_CAUSE: c_int = 2;
pub const GAUDI2_NUM_OF_HBM_MC_SPI_CAUSE: c_int = 5;
...
pub const PCIE_DEC_EN_MASK: c_uint = 0x300;
pub const DEC_WORK_STATE_IDLE: c_int = 0;
pub const DEC_WORK_STATE_PEND: c_int = 3;
...
pub const GAUDI2_HBM_MMU_SCRM_DIV_SHIFT: c_int = 26;
pub const GAUDI2_HBM_MMU_SCRM_MOD_SHIFT: c_int = 0;

pub const GAUDI2_COMPENSATE_TLB_PAGE_SIZE_FACTOR: c_int = 16;
pub const MMU_RANGE_INV_VA_LSB_SHIFT: c_int = 12;
pub const MMU_RANGE_INV_VA_MSB_SHIFT: c_int = 44;
pub const MMU_RANGE_INV_EN_SHIFT: c_int = 0;
pub const MMU_RANGE_INV_ASID_EN_SHIFT: c_int = 1;
pub const MMU_RANGE_INV_ASID_SHIFT: c_int = 2;
...
pub const GAUDI2_MAX_STRING_LEN: c_int = 64;
...
// RAZWI initiator coordinates
    ...
    ((x & 0x00001FF0) >> 4)
pub const RAZWI_INITIATOR_AXUER_L_X_SHIFT: c_int = 0;
pub const RAZWI_INITIATOR_AXUER_L_X_MASK: c_uint = 0x1F;
pub const RAZWI_INITIATOR_AXUER_L_Y_SHIFT: c_int = 5;
pub const RAZWI_INITIATOR_AXUER_L_Y_MASK: c_uint = 0xF;
pub const RAZWI_INITIATOR_AXUER_H_X_SHIFT: c_int = 23;
pub const RAZWI_INITIATOR_AXUER_H_X_MASK: c_uint = 0x1F;
...
pub const PSOC_RAZWI_ENG_STR_SIZE: c_int = 128;
pub const PSOC_RAZWI_MAX_ENG_PER_RTR: c_int = 5;
// HW scrambles only bits 0-25

pub const GAUDI2_GLBL_ERR_MAX_CAUSE_NUM: c_int = 17;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_razwi_info {
    pub axuser_xy: u32,
    pub rtr_ctrl: u32,
    pub eng_id: u16,
    pub eng_name: *mut c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_sm_sei_cause_data {
    pub cause_name: *const c_char,
    pub log_name: *const c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mme_initiators_rtr_id {
    pub wap0: u32,
    pub wap1: u32,
    pub write: u32,
    pub read: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hbm_mc_error_causes {
    pub mask: u32,
    pub cause: [c_char; 50],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_cache_invld_params {
    pub start_va: u64,
    pub end_va: u64,
    pub inv_start_val: u32,
    pub flags: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_tpc_idle_data {
    pub e: *mut engines_data,
    pub mask: *mut c_ulong,
    pub is_idle: *mut bool,
    pub tpc_fmt: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_tpc_mmu_data {
    pub rw_asid: u32,
}
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_scrambler_hbm(hdev: *mut hl_device) {
    static void gaudi2_init_scrambler_hbm(struct hl_device *hdev)
    {
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_get_signal_cb_size(hdev: *mut hl_device) -> u32 {
    static u32 gaudi2_get_signal_cb_size(struct hl_device *hdev)
    {
    return sizeof(struct packet_msg_short);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_get_wait_cb_size(hdev: *mut hl_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_iterate_tpcs(hdev: *mut hl_device, ctx: *mut iterate_module_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_host_phys_addr_valid(addr: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn set_number_of_functional_hbms(hdev: *mut hl_device) -> c_int {
    static int set_number_of_functional_hbms(struct hl_device *hdev)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut faulty_hbms: u8 = hweight64(hdev.dram_binning);
...
#[no_mangle]
unsafe extern "C" fn gaudi2_is_edma_queue_id(queue_id: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_dram_properties(hdev: *mut hl_device) -> c_int {
    static int gaudi2_set_dram_properties(struct hl_device *hdev)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut hbm_drv_base_offset: u64 = 0, edma_pq_base_addr;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_fixed_properties(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_pci_bars_map(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_hbm_bar_base(hdev: *mut hl_device, addr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_iatu(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_get_hw_state(hdev: *mut hl_device) -> enum hl_device_hw_state {
    static enum hl_device_hw_state gaudi2_get_hw_state(struct hl_device *hdev)
    {
    return RREG32(mmHW_STATE);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_tpc_binning_init_prop(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_tpc_binning_masks(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_dec_binning_masks(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_dram_binning_masks(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_edma_binning_masks(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_xbar_edge_enable_mask(hdev: *mut hl_device, xbar_edge_iso_mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_cluster_binning_masks_common(hdev: *mut hl_device, xbar_edge_iso_mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_cluster_binning_masks(hdev: *mut hl_device) -> c_int {
...
// if we have DRAM binning reported by FW we should perform cluster config
    ...
    let mut cluster_seq: u8 = __ffs((unsigned long)prop.faulty_dram_cluster_map);
    prop.hmmu_hif_enabled_mask = cluster_hmmu_hif_enabled_mask[cluster_seq];
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_set_binning_masks(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_cpucp_info_get(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_fetch_psoc_frequency(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_mmu_clear_pgt_range(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_early_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_early_fini(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_is_arc_nic_owned(arc_id: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_is_arc_tpc_owned(arc_id: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_arcs(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_scrub_arc_dccm(hdev: *mut hl_device, cpu_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_scrub_arcs_dccm(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_late_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_late_fini(hdev: *mut hl_device) {
    static void gaudi2_late_fini(struct hl_device *hdev)
    {
    hl_hwmon_release_resources(hdev);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_user_mapped_dec_init(gaudi2: *mut gaudi2_device, start_idx: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_user_mapped_blocks_init(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_alloc_cpu_accessible_dma_mem(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_pci_memory_regions(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_user_interrupt_setup(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_get_non_zero_random_int() -> c_int {
    static inline int gaudi2_get_non_zero_random_int(void)
    {
    let mut rand: c_int = get_random_u32();
    return rand ? rand : 1;
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_special_blocks_free(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_special_blocks_iterator_free(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_special_blocks_config(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_special_blocks_iterator_config(hdev: *mut hl_device) -> c_int {
    static int gaudi2_special_blocks_iterator_config(struct hl_device *hdev)
    {
    return gaudi2_special_blocks_config(hdev);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_test_queues_msgs_free(hdev: *mut hl_device) {
...
// bail-out if this is an allocation failure point
    ...
    msg_info[i].kern_addr = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_test_queues_msgs_alloc(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_sw_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_sw_fini(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_qman_common(hdev: *mut hl_device, reg_base: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_flush_qman_common(hdev: *mut hl_device, reg_base: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_flush_qman_arc_common(hdev: *mut hl_device, reg_base: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_qman_manual_flush_common(hdev: *mut hl_device, queue_id: u32) {
    static void gaudi2_qman_manual_flush_common(struct hl_device *hdev, u32 queue_id)
    {
    let mut reg_base: u32 = gaudi2_qm_blocks_bases[queue_id];
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_dma_qmans(hdev: *mut hl_device) {
...
// Stop CPs of PDMA QMANs
    ...
    let mut seq: u8 = dcore * NUM_OF_EDMA_PER_DCORE + inst;
    u32 qm_base;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_mme_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_tpc_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_rot_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_nic_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stall_dma_common(hdev: *mut hl_device, reg_base: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_dma_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_mme_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_tpc_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_rotator_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_disable_qman_common(hdev: *mut hl_device, reg_base: u32) {
    static void gaudi2_disable_qman_common(struct hl_device *hdev, u32 reg_base)
    {
    WREG32(reg_base + QM_GLBL_CFG0_OFFSET, 0);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_disable_dma_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_disable_mme_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_disable_tpc_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_disable_rot_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_disable_nic_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_enable_timestamp(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_disable_timestamp(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_dec_disable_msix(hdev: *mut hl_device, max_irq_num: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_dec_enable_msix(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_enable_msix(hdev: *mut hl_device) -> c_int {
    ...
    rc = request_threaded_irq(irq, core::ptr::null_mut(), hl_irq_user_interrupt_thread_handler, IRQF_ONESHOT,
    ...
    rc = request_threaded_irq(irq, core::ptr::null_mut(), hl_irq_eq_error_interrupt_thread_handler,
    ...
    irq = pci_irq_vector(hdev.pdev, i);
    irq_set_affinity_and_hint(irq, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gaudi2_sync_irqs(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_disable_msix(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_dcore_dec(hdev: *mut hl_device, dcore_id: c_int) {
    static void gaudi2_stop_dcore_dec(struct hl_device *hdev, int dcore_id)
    {
    let mut reg_val: u32 = FIELD_PREP(DCORE0_VDEC0_BRDG_CTRL_GRACEFUL_STOP_MASK, 0x1);
    let mut graceful_pend_mask: u32 = DCORE0_VDEC0_BRDG_CTRL_GRACEFUL_PEND_MASK;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_pcie_dec(hdev: *mut hl_device) {
    static void gaudi2_stop_pcie_dec(struct hl_device *hdev)
    {
    let mut reg_val: u32 = FIELD_PREP(DCORE0_VDEC0_BRDG_CTRL_GRACEFUL_STOP_MASK, 0x1);
    let mut graceful_pend_mask: u32 = PCIE_VDEC0_BRDG_CTRL_GRACEFUL_PEND_MASK;
    u32 timeout_usec, dec_id, dec_bit, offset, graceful;
    int rc;
    if (hdev.pldm)
    timeout_usec = GAUDI2_PLDM_VDEC_TIMEOUT_USEC;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_stop_dec(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_arc_running_mode(hdev: *mut hl_device, cpu_id: u32, run_mode: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_halt_arcs(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_verify_arc_running_mode(hdev: *mut hl_device, cpu_id: u32, run_mode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_reset_arcs(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_nic_qmans_manual_flush(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_tpc_engine_mode(hdev: *mut hl_device, engine_id: u32, engine_command: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_mme_engine_mode(hdev: *mut hl_device, engine_id: u32, engine_command: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_edma_engine_mode(hdev: *mut hl_device, engine_id: u32, engine_command: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_halt_engines(hdev: *mut hl_device, hard_reset: bool, fw_reset: bool) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_firmware_preload_params(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_firmware_loader(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_cpu(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_cpu_queues(hdev: *mut hl_device, cpu_timeout: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_qman_cp(hdev: *mut hl_device, reg_base: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_get_dyn_sp_reg(hdev: *mut hl_device, queue_id_base: u32) -> u32 {
    ...
    u32 queue_id_base)
    {
    let mut glbl_prot: u32 = QMAN_MAKE_TRUSTED, irq_handler_offset;
    int map_table_entry;
...
#[no_mangle]
pub unsafe extern "C" fn if(gaudi2_qm_blocks_bases[GAUDI2_QUEUE_ID_PDMA_0_0]: reg_base ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_kdma(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_pdma(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_edma_instance(hdev: *mut hl_device, seq: u8) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_edma(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_prepare_sm_for_virt_msix_db(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_sm(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_mme_acc(hdev: *mut hl_device, reg_base: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_mme(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_tpc_cfg(hdev: *mut hl_device, reg_base: u32) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gaudi2_tpc_init_cfg_data {
    pub dcore_tpc_qid_base: [enum gaudi2_queue_id; NUM_OF_DCORES],
}
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_tpc(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_rotator(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_vdec_brdg_ctrl(hdev: *mut hl_device, base_addr: u64, decoder_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_init_dec(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_is_hmmu_enabled(hdev: *mut hl_device, dcore_id: c_int, hmmu_id: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn get_hmmu_stlb_base(dcore_id: c_int, hmmu_id: c_int) -> u32 {
...
//
    let mut start: u64 = inv_params.start_va - 1;
    ...
    struct gaudi2_cache_invld_params *inv_params)
    {
    let mut stlb_base: u32 = get_hmmu_stlb_base(dcore_id, hmmu_id);
...
#[no_mangle]
unsafe extern "C" fn gaudi2_mmu_invalidate_cache(hdev: *mut hl_device, is_hard: bool, flags: u32) -> c_int {
    ...
    {
    let mut invld_params: gaudi2_cache_invld_params = {0};
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    u64 start_va, end_va;
    u32 inv_start_val;
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_pci_mmu_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_hbm_mmu_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_mmu_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_hw_init(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gaudi2_send_hard_reset_cmd(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn gaudi2_execute_hard_reset(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_poll_btm_indication(hdev: *mut hl_device, poll_timeout_us: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_hw_fini(hdev: *mut hl_device, hard_reset: bool, fw_reset: bool) -> c_int {
    static int gaudi2_hw_fini(struct hl_device *hdev, bool hard_reset, bool fw_reset)
    {
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    u32 poll_timeout_us, reset_sleep_ms;
    let mut driver_performs_reset: bool = false;
    int rc;
    if (hdev.pldm) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_is_queue_enabled(hdev: *mut hl_device, hw_queue_id: u32) -> bool {
    static bool gaudi2_is_queue_enabled(struct hl_device *hdev, u32 hw_queue_id)
    {
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    let mut hw_cap_mask: u64 = 0;
    let mut hw_tpc_cap_bit: u64 = 0;
    let mut hw_nic_cap_bit: u64 = 0;
    let mut hw_test_cap_bit: u64 = 0;
    switch (hw_queue_id) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_is_arc_enabled(hdev: *mut hl_device, arc_id: u64) -> bool {
    static bool gaudi2_is_arc_enabled(struct hl_device *hdev, u64 arc_id)
    {
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    switch (arc_id) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_clr_arc_id_cap(hdev: *mut hl_device, arc_id: u64) {
    static void gaudi2_clr_arc_id_cap(struct hl_device *hdev, u64 arc_id)
    {
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    switch (arc_id) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_set_arc_id_cap(hdev: *mut hl_device, arc_id: u64) {
    static void gaudi2_set_arc_id_cap(struct hl_device *hdev, u64 arc_id)
    {
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    switch (arc_id) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_ring_doorbell(hdev: *mut hl_device, hw_queue_id: u32, pi: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_pqe_write(hdev: *mut hl_device, pqe: *mut __le64, bd: *mut hl_bd) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_dma_pool_free(hdev: *mut hl_device, vaddr: *mut c_void, dma_addr: dma_addr_t) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_cpu_accessible_dma_pool_free(hdev: *mut hl_device, size: usize, vaddr: *mut c_void) {
    static void gaudi2_cpu_accessible_dma_pool_free(struct hl_device *hdev, size_t size, void *vaddr)
    {
    hl_fw_cpu_accessible_dma_pool_free(hdev, size, vaddr);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_validate_cb_address(hdev: *mut hl_device, parser: *mut hl_cs_parser) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_cs_parser(hdev: *mut hl_device, parser: *mut hl_cs_parser) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_send_heartbeat(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_memset_device_lbw(hdev: *mut hl_device, addr: u32, size: u32, val: u32) {
    static void gaudi2_memset_device_lbw(struct hl_device *hdev, u32 addr, u32 size, u32 val)
    {
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_qman_set_test_mode(hdev: *mut hl_device, hw_queue_id: u32, enable: bool) {
    static void gaudi2_qman_set_test_mode(struct hl_device *hdev, u32 hw_queue_id, bool enable)
    {
    let mut reg_base: u32 = gaudi2_qm_blocks_bases[hw_queue_id];
    if (enable) {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_test_queue_hw_queue_id_to_sob_id(hdev: *mut hl_device, hw_queue_id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_test_queue_clear(hdev: *mut hl_device, hw_queue_id: u32) {
    static void gaudi2_test_queue_clear(struct hl_device *hdev, u32 hw_queue_id)
    {
    let mut sob_offset: u32 = gaudi2_test_queue_hw_queue_id_to_sob_id(hdev, hw_queue_id) * 4;
    let mut sob_addr: u32 = mmDCORE0_SYNC_MNGR_OBJS_SOB_OBJ_0 + sob_offset;
// Reset the SOB value
    WREG32(sob_addr, 0);
    }
    ...
    let mut pkt_size: usize = sizeof(struct packet_msg_short);
    int rc;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_test_queue_wait_completion(hdev: *mut hl_device, hw_queue_id: u32, sob_val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_test_cpu_queue(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_test_queues(hdev: *mut hl_device) -> c_int {
    static int gaudi2_test_queues(struct hl_device *hdev)
    {
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    struct gaudi2_queues_test_info *msg_info;
    let mut sob_val: u32 = 0x5a5a;
    int i, rc;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_compute_reset_late_init(hdev: *mut hl_device) -> c_int {
...
// Unmask all IRQs since some could have been received during the soft reset
    ...
    let mut seq: c_int = i * NUM_OF_EDMA_PER_DCORE + j;
    if (!(prop.edma_enabled_mask & BIT(seq)))
    continue;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_hw_queues_lock(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_hw_queues_unlock(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_get_pci_id(hdev: *mut hl_device) -> u32 {
    static u32 gaudi2_get_pci_id(struct hl_device *hdev)
    {
    return hdev.pdev.device;
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_get_eeprom_data(hdev: *mut hl_device, data: *mut c_void, max_size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_update_eq_ci(hdev: *mut hl_device, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_mmu_dcore_prepare(hdev: *mut hl_device, dcore_id: c_int, asid: u32) {
    ...
    (asid << ARC_FARM_KDMA_CTX_AXUSER_HB_ASID_WR_SHIFT);
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut dcore_offset: u32 = dcore_id * DCORE_OFFSET;
...
//
    ...
    {
    let mut offset: u32 = (mmPCIE_VDEC1_BRDG_CTRL_BASE - mmPCIE_VDEC0_BRDG_CTRL_BASE) * shared_vdec_id;
    ...
    {
    let mut offset: u32 = (mmARC_FARM_ARC1_DUP_ENG_BASE - mmARC_FARM_ARC0_DUP_ENG_BASE) * arc_farm_id;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_arc_mmu_prepare(hdev: *mut hl_device, cpu_id: u32, asid: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_arc_mmu_prepare_all(hdev: *mut hl_device, asid: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_mmu_shared_prepare(hdev: *mut hl_device, asid: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_mmu_prepare(hdev: *mut hl_device, asid: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_info_event(event: u32) -> bool {
...
//
    ...
    {
    let mut ecc_address: u64 = 0, ecc_syndrome = 0;
    let mut memory_wrapper_idx: u8 = 0;
    let mut has_block_id: bool = false;
    u16 block_id;
...
#[no_mangle]
unsafe extern "C" fn handle_lower_qman_data_on_err(hdev: *mut hl_device, qman_base: u64, engine_id: u32) {
...
// event_mask |= HL_NOTIFIER_EVENT_UNDEFINED_OPCODE;
    ...
    enum gaudi2_engine_id id, u64 *event_mask)
    {
    let mut razwi_addr: u64 = CFG_BASE;
    u32 razwi_xy;
    let mut eng_id: u16 = id;
    u8 rd_wr_flag;
    if (is_write) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_check_if_razwi_happened(hdev: *mut hl_device) {
...
// check all TPCs
    ...
    gaudi2_ack_module_razwi_event_handler(hdev, RAZWI_TPC, mod_idx, 0, core::ptr::null_mut());
    }
// check all MMEs
    ...
    sub_mod, core::ptr::null_mut());
// check all EDMAs
    for (mod_idx = 0 ; mod_idx < (NUM_OF_EDMA_PER_DCORE * NUM_OF_DCORES) ; mod_idx++)
    if (prop.edma_enabled_mask & BIT(mod_idx))
    gaudi2_ack_module_razwi_event_handler(hdev, RAZWI_EDMA, mod_idx, 0, core::ptr::null_mut());
// check all PDMAs
    for (mod_idx = 0 ; mod_idx < NUM_OF_PDMA ; mod_idx++)
    gaudi2_ack_module_razwi_event_handler(hdev, RAZWI_PDMA, mod_idx, 0, core::ptr::null_mut());
// check all NICs
...
// check all DECs
    ...
    gaudi2_ack_module_razwi_event_handler(hdev, RAZWI_DEC, mod_idx, 0, core::ptr::null_mut());
// check all ROTs
    for (mod_idx = 0 ; mod_idx < NUM_OF_ROT ; mod_idx++)
    gaudi2_ack_module_razwi_event_handler(hdev, RAZWI_ROT, mod_idx, 0, core::ptr::null_mut());
    }
    ...
    u64 *event_mask)
    {
    let mut axuser_xy: u32 = RAZWI_GET_AXUSER_XY(razwi_reg), addr_hi = 0, addr_lo = 0;
    ...
    let mut razwi_happened: bool = false;
    u64 addr;
    int i;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_ack_psoc_razwi_event_handler(hdev: *mut hl_device, event_mask: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _gaudi2_handle_qm_sei_err(hdev: *mut hl_device, qman_base: u64, event_type: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_qman_err(hdev: *mut hl_device, event_type: u16, event_mask: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_arc_farm_sei_err(hdev: *mut hl_device, event_type: u16, event_mask: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_cpu_sei_err(hdev: *mut hl_device, event_type: u16) -> c_int {
    ...
    u64 *event_mask)
    {
    let mut intr_cause_data: u64 = le64_to_cpu(razwi_with_intr_cause.intr_cause.intr_cause_data);
    let mut error_count: u32 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_mme_sbte_err(hdev: *mut hl_device, event_type: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_dma_core_event(hdev: *mut hl_device, event_type: u16, intr_cause: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_print_pcie_mstr_rr_mstr_if_razwi_info(hdev: *mut hl_device, event_mask: *mut u64) {
    static void gaudi2_print_pcie_mstr_rr_mstr_if_razwi_info(struct hl_device *hdev, u64 *event_mask)
    {
    let mut mstr_if_base_addr: u32 = mmPCIE_MSTR_RR_MSTR_IF_RR_SHRD_HBW_BASE, razwi_happened_addr;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_hif_fatal(hdev: *mut hl_device, event_type: u16, intr_cause_data: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_access_error(hdev: *mut hl_device, mmu_base: u64, is_pmmu: bool) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_sm_err(hdev: *mut hl_device, event_type: u16, sm_index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_hmmu_base(event_type: u16) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_mmu_spi_sei_err(hdev: *mut hl_device, event_type: u16, event_mask: *mut u64) -> c_int {
    static int gaudi2_handle_mmu_spi_sei_err(struct hl_device *hdev, u16 event_type, u64 *event_mask)
    {
    let mut is_pmmu: bool = false;
    let mut error_count: u32 = 0;
    u64 mmu_base;
    switch (event_type) {
...
// returns true if hard reset is required (ECC DERR or Read parity), false otherwise (ECC SERR)
    ...
    {
    let mut require_hard_reset: bool = false;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_hbm_mc_spi(hdev: *mut hl_device, intr_cause_data: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_print_clk_change_info(hdev: *mut hl_device, event_type: u16, event_mask: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_pcie_p2p_msix(hdev: *mut hl_device, event_type: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_psoc_drain(hdev: *mut hl_device, intr_cause_data: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn event_id_to_engine_id(hdev: *mut hl_device, event_type: u16) -> u16 {
    static u16 event_id_to_engine_id(struct hl_device *hdev, u16 event_type)
    {
    let mut type: enum gaudi2_block_types = GAUDI2_BLOCK_TYPE_MAX;
    u16 index;
    switch (event_type) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_handle_eqe(hdev: *mut hl_device, eq_entry: *mut hl_eq_entry) {
    static void gaudi2_handle_eqe(struct hl_device *hdev, struct hl_eq_entry *eq_entry)
    {
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    let mut reset_required: bool = false, is_critical = false;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: error_count ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_memset_device_memory(hdev: *mut hl_device, addr: u64, size: u64, val: u64) -> c_int {
    static int gaudi2_memset_device_memory(struct hl_device *hdev, u64 addr, u64 size, u64 val)
    {
    ...
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut rc: c_int = 0, dma_num = 0, i;
...
//
    ...
    let mut edma_offset: u32 = dcore * DCORE_OFFSET + edma_idx * DCORE_EDMA_OFFSET;
    let mut edma_bit: u32 = dcore * NUM_OF_EDMA_PER_DCORE + edma_idx;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_scrub_device_dram(hdev: *mut hl_device, val: u64) -> c_int {
    static int gaudi2_scrub_device_dram(struct hl_device *hdev, u64 val)
    {
    int rc;
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut size: u64 = prop.dram_end_address - prop.dram_user_base_address;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_scrub_device_mem(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_restore_user_sm_registers(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_restore_user_qm_registers(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_restore_nic_qm_registers(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_context_switch(hdev: *mut hl_device, asid: u32) -> c_int {
    static int gaudi2_context_switch(struct hl_device *hdev, u32 asid)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_restore_phase_topology(hdev: *mut hl_device) {
    ...
    {
    let mut block_base: u64 = cfg_ctx.base + block_idx * cfg_ctx.block_off;
    u8 seq;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_init_blocks(hdev: *mut hl_device, cfg_ctx: *mut dup_block_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_debugfs_read_dma(hdev: *mut hl_device, addr: u64, size: u32, blob_addr: *mut c_void) -> c_int {
...
// Allocate buffers for read and for poll
    ...
    if (host_mem_virtual_addr == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_internal_cb_pool_init(hdev: *mut hl_device, ctx: *mut hl_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_internal_cb_pool_fini(hdev: *mut hl_device, ctx: *mut hl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_restore_user_registers(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_map_virtual_msix_doorbell_memory(ctx: *mut hl_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_unmap_virtual_msix_doorbell_memory(ctx: *mut hl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_ctx_init(ctx: *mut hl_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_ctx_fini(ctx: *mut hl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_pre_schedule_cs(cs: *mut hl_cs) -> c_int {
    static int gaudi2_pre_schedule_cs(struct hl_cs *cs)
    {
    struct hl_device *hdev = cs.ctx.hdev;
    let mut index: c_int = cs.sequence & (hdev.asic_prop.max_pending_cs - 1);
...
#[no_mangle]
unsafe extern "C" fn gaudi2_get_queue_id_for_cq(hdev: *mut hl_device, cq_idx: u32) -> u32 {
    static u32 gaudi2_get_queue_id_for_cq(struct hl_device *hdev, u32 cq_idx)
    {
    return HL_INVALID_QUEUE;
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_gen_signal_cb(hdev: *mut hl_device, data: *mut c_void, sob_id: u16, size: u32, eb: bool) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_add_mon_msg_short(pkt: *mut packet_msg_short, value: u32, addr: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_add_fence_pkt(pkt: *mut packet_fence) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_gen_wait_cb(hdev: *mut hl_device, prop: *mut hl_gen_wait_properties) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_reset_sob(hdev: *mut hl_device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_reset_sob_group(hdev: *mut hl_device, sob_group: u16) {
    static void gaudi2_reset_sob_group(struct hl_device *hdev, u16 sob_group)
    {
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_get_device_time(hdev: *mut hl_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_collective_wait_init_cs(cs: *mut hl_cs) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gaudi2_mmu_scramble_addr(hdev: *mut hl_device, raw_addr: u64) -> u64 {
    static u64 gaudi2_mmu_scramble_addr(struct hl_device *hdev, u64 raw_addr)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    u32 divisor, mod_va;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_mmu_descramble_addr(hdev: *mut hl_device, scrambled_addr: u64) -> u64 {
    static u64 gaudi2_mmu_descramble_addr(struct hl_device *hdev, u64 scrambled_addr)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    u32 divisor, mod_va;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_get_dec_base_addr(hdev: *mut hl_device, core_id: u32) -> u32 {
    static u32 gaudi2_get_dec_base_addr(struct hl_device *hdev, u32 core_id)
    {
    let mut base: u32 = 0, dcore_id, dec_id;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_enable_events_from_fw(hdev: *mut hl_device) {
    static void gaudi2_enable_events_from_fw(struct hl_device *hdev)
    {
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    struct cpu_dyn_regs *dyn_regs = &hdev.fw_loader.dynamic_loader.comm_desc.cpu_dyn_regs;
    let mut irq_handler_offset: u32 = le32_to_cpu(dyn_regs.gic_host_ints_irq);
    if (gaudi2.hw_cap_initialized & HW_CAP_CPU_Q)
    WREG32(irq_handler_offset,
    gaudi2_irq_map_table[GAUDI2_EVENT_CPU_INTS_REGISTER].cpu_id);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_get_mmu_base(hdev: *mut hl_device, mmu_id: u64, mmu_base: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_ack_mmu_error(hdev: *mut hl_device, mmu_id: u64) {
    static void gaudi2_ack_mmu_error(struct hl_device *hdev, u64 mmu_id)
    {
    let mut is_pmmu: bool = (mmu_id == HW_CAP_PMMU);
    struct gaudi2_device *gaudi2 = hdev.asic_specific;
    u32 mmu_base;
    ...
    return;
    gaudi2_handle_page_error(hdev, mmu_base, is_pmmu, core::ptr::null_mut());
    gaudi2_handle_access_error(hdev, mmu_base, is_pmmu);
    }
#[no_mangle]
unsafe extern "C" fn gaudi2_ack_mmu_page_fault_or_access_error(hdev: *mut hl_device, mmu_cap_mask: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_get_msi_info(table: *mut __le32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_map_pll_idx_to_fw_idx(pll_idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_gen_sync_to_engine_map(hdev: *mut hl_device, map: *mut hl_sync_to_engine_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_monitor_valid(mon: *mut hl_mon_state_dump) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_state_dump_init(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_get_sob_addr(hdev: *mut hl_device, sob_id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_get_monitor_dump(hdev: *mut hl_device, data: *mut c_void) -> c_int {
    static int gaudi2_get_monitor_dump(struct hl_device *hdev, void *data)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
pub unsafe extern "C" fn gaudi2_send_device_activity(hdev: *mut hl_device, open: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_read_pte(hdev: *mut hl_device, addr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_write_pte(hdev: *mut hl_device, addr: u64, val: u64) {
    ...
    .get_int_queue_base = core::ptr::null_mut(),
    ...
    .add_end_of_cb_packets = core::ptr::null_mut(),
    ...
    .load_firmware_to_device = core::ptr::null_mut(),
    .load_boot_fit_to_device = core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_set_asic_funcs(hdev: *mut hl_device) {
