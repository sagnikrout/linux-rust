...
//! Source: drivers/accel/habanalabs/gaudi2/gaudi2_coresight.c
#![no_std]
...
pub const MAX_BMONS_PER_UNIT: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct component_config_offsets {
    pub funnel_id: u32,
    pub etf_id: u32,
    pub stm_id: u32,
    pub spmu_id: u32,
...
#[no_mangle]
unsafe extern "C" fn gaudi2_config_stm(hdev: *mut hl_device, params: *mut hl_debug_params) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_config_etf(hdev: *mut hl_device, params: *mut hl_debug_params) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_etr_validate_address(hdev: *mut hl_device, addr: u64, size: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_config_funnel(hdev: *mut hl_device, params: *mut hl_debug_params) -> c_int {
    static int gaudi2_config_funnel(struct hl_device *hdev, struct hl_debug_params *params)
    {
    u64 base_reg;
    let mut val: u32 = params.enable ? 0xFFF : 0;
    u32 read_reg;
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn gaudi2_config_bmon(hdev: *mut hl_device, params: *mut hl_debug_params) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi2_config_spmu(hdev: *mut hl_device, params: *mut hl_debug_params) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_debug_coresight(hdev: *mut hl_device, ctx: *mut hl_ctx, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_halt_coresight(hdev: *mut hl_device, ctx: *mut hl_ctx) {
...
// set the disable bits on disabled mask
    ...
    while (disabled_mask) {
    let mut component_mask: u32 = 1 << component_idx;
...
#[no_mangle]
pub unsafe extern "C" fn gaudi2_coresight_init(hdev: *mut hl_device) -> c_int {
