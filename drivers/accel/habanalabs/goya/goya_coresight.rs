...
//! Source: drivers/accel/habanalabs/goya/goya_coresight.c
#![no_std]
...
pub const SPMU_EVENT_TYPES_OFFSET: c_uint = 0x400;
pub const SPMU_MAX_COUNTERS: c_int = 6;
...
#[no_mangle]
pub unsafe extern "C" fn goya_debug_coresight(hdev: *mut hl_device, ctx: *mut hl_ctx, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_halt_coresight(hdev: *mut hl_device, ctx: *mut hl_ctx) {
    void goya_halt_coresight(struct hl_device *hdev, struct hl_ctx *ctx)
    {
    let mut params: hl_debug_params = {};
    int i, rc;
