...
//! Source: drivers/accel/habanalabs/goya/goya_security.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn goya_pb_set_block(hdev: *mut hl_device, base: u64) {
    static void goya_pb_set_block(struct hl_device *hdev, u64 base)
    {
    let mut pb_addr: u32 = base - CFG_BASE + PROT_BITS_OFFS;
    while (pb_addr & 0xFFF) {
    WREG32(pb_addr, 0);
    pb_addr += 4;
    }
...
#[no_mangle]
unsafe extern "C" fn goya_init_mme_protection_bits(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_dma_protection_bits(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_tpc_protection_bits(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_init_protection_bits(hdev: *mut hl_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn goya_init_security(hdev: *mut hl_device) {
    void goya_init_security(struct hl_device *hdev)
    {
    struct goya_device *goya = hdev.asic_specific;
    let mut dram_addr_lo: u32 = lower_32_bits(DRAM_PHYS_BASE);
    let mut dram_addr_hi: u32 = upper_32_bits(DRAM_PHYS_BASE);
    let mut lbw_rng0_base: u32 = 0xFC440000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng0_mask: u32 = 0xFFFF0000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng1_base: u32 = 0xFC480000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng1_mask: u32 = 0xFFF80000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng2_base: u32 = 0xFC600000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng2_mask: u32 = 0xFFE00000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng3_base: u32 = 0xFC800000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng3_mask: u32 = 0xFFF00000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng4_base: u32 = 0xFCC02000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng4_mask: u32 = 0xFFFFF000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng5_base: u32 = 0xFCC40000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng5_mask: u32 = 0xFFFF8000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng6_base: u32 = 0xFCC48000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng6_mask: u32 = 0xFFFFF000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng7_base: u32 = 0xFCC4A000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng7_mask: u32 = 0xFFFFE000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng8_base: u32 = 0xFCC4C000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng8_mask: u32 = 0xFFFFC000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng9_base: u32 = 0xFCC50000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng9_mask: u32 = 0xFFFF0000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng10_base: u32 = 0xFCC60000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng10_mask: u32 = 0xFFFE0000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng11_base: u32 = 0xFCE02000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng11_mask: u32 = 0xFFFFE000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng12_base: u32 = 0xFE484000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng12_mask: u32 = 0xFFFFF000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng13_base: u32 = 0xFEC43000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
    let mut lbw_rng13_mask: u32 = 0xFFFFF000 & DMA_MACRO_LBW_RANGE_BASE_R_MASK;
...
#[no_mangle]
pub unsafe extern "C" fn goya_ack_protection_bits_errors(hdev: *mut hl_device) {
