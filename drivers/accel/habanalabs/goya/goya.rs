...
//! Source: drivers/accel/habanalabs/goya/goya.c
#![no_std]
...
pub const GOYA_MMU_REGS_NUM: c_int = 63;
pub const GOYA_DMA_POOL_BLK_SIZE: c_uint = 0x100		/* 256 bytes */;

pub const GOYA_QMAN0_FENCE_VAL: c_uint = 0xD169B243;
pub const GOYA_MAX_STRING_LEN: c_int = 20;
pub const GOYA_CB_POOL_CB_CNT: c_int = 512;
pub const GOYA_CB_POOL_CB_SIZE: c_uint = 0x20000		/* 128KB */;
...
#[no_mangle]
pub unsafe extern "C" fn goya_set_fixed_properties(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn goya_pci_bars_map(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_set_ddr_bar_base(hdev: *mut hl_device, addr: u64) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn goya_init_iatu(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_get_hw_state(hdev: *mut hl_device) -> enum hl_device_hw_state {
...
//
#[no_mangle]
unsafe extern "C" fn goya_early_init(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn goya_early_fini(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_mmu_prepare_reg(hdev: *mut hl_device, reg: u64, asid: u32) {
...
#[no_mangle]
unsafe extern "C" fn goya_qman0_set_security(hdev: *mut hl_device, secure: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_fetch_psoc_frequency(hdev: *mut hl_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn goya_set_frequency(hdev: *mut hl_device, freq: enum hl_pll_frequency) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_set_freq_to_low_job(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn goya_late_init(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn goya_late_fini(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_set_pci_memory_regions(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_sw_init(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn goya_sw_fini(hdev: *mut hl_device) -> c_int {
    ...
    let mut reg_off: u32 = dma_id * (mmDMA_QM_1_PQ_PI - mmDMA_QM_0_PQ_PI);
    let mut dma_err_cfg: u32 = QMAN_DMA_ERR_MSG_EN;
...
#[no_mangle]
unsafe extern "C" fn goya_init_dma_ch(hdev: *mut hl_device, dma_id: c_int) {
    static void goya_init_dma_ch(struct hl_device *hdev, int dma_id)
    {
    u32 gic_base_lo, gic_base_hi;
    u64 sob_addr;
    let mut reg_off: u32 = dma_id * (mmDMA_CH_1_CFG1 - mmDMA_CH_0_CFG1);
    gic_base_lo =
    lower_32_bits(CFG_BASE + mmGIC_DISTRIBUTOR__5_GICD_SETSPI_NSR);
    gic_base_hi =
    upper_32_bits(CFG_BASE + mmGIC_DISTRIBUTOR__5_GICD_SETSPI_NSR);
...
//
#[no_mangle]
pub unsafe extern "C" fn goya_init_dma_qmans(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_disable_external_queues(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_stop_external_queues(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn goya_init_cpu_queues(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_set_pll_refclk(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_disable_clk_rlx(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn _goya_tpc_mbist_workaround(hdev: *mut hl_device, tpc_id: u8) {
...
#[no_mangle]
unsafe extern "C" fn goya_tpc_mbist_workaround(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_init_golden_registers(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_mme_qman(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_mme_cmdq(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn goya_init_mme_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_tpc_qman(hdev: *mut hl_device, base_off: u32, tpc_id: c_int) {
    ...
    u32 gic_base_lo, gic_base_hi;
    u64 qman_base_addr;
    let mut reg_off: u32 = tpc_id * (mmTPC1_QM_PQ_PI - mmTPC0_QM_PQ_PI);
    mtr_base_lo = lower_32_bits(CFG_BASE + mmSYNC_MNGR_MON_PAY_ADDRL_0);
    mtr_base_hi = upper_32_bits(CFG_BASE + mmSYNC_MNGR_MON_PAY_ADDRL_0);
    so_base_lo = lower_32_bits(CFG_BASE + mmSYNC_MNGR_SOB_OBJ_0);
    so_base_hi = upper_32_bits(CFG_BASE + mmSYNC_MNGR_SOB_OBJ_0);
...
#[no_mangle]
unsafe extern "C" fn goya_init_tpc_cmdq(hdev: *mut hl_device, tpc_id: c_int) {
    static void goya_init_tpc_cmdq(struct hl_device *hdev, int tpc_id)
    {
    u32 mtr_base_lo, mtr_base_hi;
    u32 so_base_lo, so_base_hi;
    u32 gic_base_lo, gic_base_hi;
    let mut reg_off: u32 = tpc_id * (mmTPC1_CMDQ_CQ_CFG1 - mmTPC0_CMDQ_CQ_CFG1);
    mtr_base_lo = lower_32_bits(CFG_BASE + mmSYNC_MNGR_MON_PAY_ADDRL_0);
    mtr_base_hi = upper_32_bits(CFG_BASE + mmSYNC_MNGR_MON_PAY_ADDRL_0);
    so_base_lo = lower_32_bits(CFG_BASE + mmSYNC_MNGR_SOB_OBJ_0);
    so_base_hi = upper_32_bits(CFG_BASE + mmSYNC_MNGR_SOB_OBJ_0);
...
#[no_mangle]
pub unsafe extern "C" fn goya_init_tpc_qmans(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_disable_internal_queues(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_stop_internal_queues(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_dma_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_tpc_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_mme_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_enable_msix(hdev: *mut hl_device) -> c_int {
    static int goya_enable_msix(struct hl_device *hdev)
    {
    struct goya_device *goya = hdev.asic_specific;
    let mut cq_cnt: c_int = hdev.asic_prop.completion_queues_count;
...
#[no_mangle]
unsafe extern "C" fn goya_sync_irqs(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_disable_msix(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_enable_timestamp(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_disable_timestamp(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_halt_engines(hdev: *mut hl_device, hard_reset: bool, fw_reset: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn goya_load_firmware_to_device(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn goya_load_boot_fit_to_device(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_init_dynamic_firmware_loader(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_static_firmware_loader(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_firmware_preload_params(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_firmware_loader(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_init_cpu(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_mmu_init(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn goya_hw_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_hw_fini(hdev: *mut hl_device, hard_reset: bool, fw_reset: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_suspend(hdev: *mut hl_device) -> c_int {
    int goya_suspend(struct hl_device *hdev)
    {
    return hl_fw_send_pci_access_msg(hdev, CPUCP_PACKET_DISABLE_PCI_ACCESS, 0x0);
    }
#[no_mangle]
pub unsafe extern "C" fn goya_resume(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_ring_doorbell(hdev: *mut hl_device, hw_queue_id: u32, pi: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn goya_pqe_write(hdev: *mut hl_device, pqe: *mut __le64, bd: *mut hl_bd) {
...
#[no_mangle]
pub unsafe extern "C" fn goya_scrub_device_mem(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_send_job_on_qman0(hdev: *mut hl_device, job: *mut hl_cs_job) -> c_int {
    ...
    if (!hdev.asic_funcs.is_device_idle(hdev, core::ptr::null_mut(), 0, core::ptr::null_mut())) {
...
#[no_mangle]
pub unsafe extern "C" fn goya_test_queue(hdev: *mut hl_device, hw_queue_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_test_cpu_queue(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_test_queues(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_get_dma_desc_list_size(hdev: *mut hl_device, sgt: *mut sg_table) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn goya_cs_parser(hdev: *mut hl_device, parser: *mut hl_cs_parser) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_update_eq_ci(hdev: *mut hl_device, val: u32) {
    void goya_update_eq_ci(struct hl_device *hdev, u32 val)
    {
    WREG32(mmCPU_EQ_CI, val);
    }
#[no_mangle]
pub unsafe extern "C" fn goya_restore_phase_topology(hdev: *mut hl_device) {
    void goya_restore_phase_topology(struct hl_device *hdev)
    {
    }
#[no_mangle]
unsafe extern "C" fn goya_clear_sm_regs(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_debugfs_read_dma(hdev: *mut hl_device, addr: u64, size: u32, blob_addr: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_read_pte(hdev: *mut hl_device, addr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn goya_write_pte(hdev: *mut hl_device, addr: u64, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn goya_get_event_desc(event_type: u16, desc: *mut c_char, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn goya_print_razwi_info(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_print_mmu_error_info(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_compute_reset_late_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_unmask_irq(hdev: *mut hl_device, event_type: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_print_clk_change_info(hdev: *mut hl_device, event_type: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn goya_handle_eqe(hdev: *mut hl_device, eq_entry: *mut hl_eq_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn goya_context_switch(hdev: *mut hl_device, asid: u32) -> c_int {
    int goya_context_switch(struct hl_device *hdev, u32 asid)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut addr: u64 = prop.sram_base_address, sob_addr;
    let mut size: u32 = hdev.pldm ? 0x10000 : prop.sram_size;
    let mut val: u64 = 0x7777777777777777ull;
    int rc, dma_id;
...
#[no_mangle]
unsafe extern "C" fn goya_mmu_clear_pgt_range(hdev: *mut hl_device) -> c_int {
    static int goya_mmu_clear_pgt_range(struct hl_device *hdev)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    struct goya_device *goya = hdev.asic_specific;
    let mut addr: u64 = prop.mmu_pgt_addr;
...
#[no_mangle]
unsafe extern "C" fn goya_mmu_set_dram_default_page(hdev: *mut hl_device) -> c_int {
    static int goya_mmu_set_dram_default_page(struct hl_device *hdev)
    {
    struct goya_device *goya = hdev.asic_specific;
    let mut addr: u64 = hdev.asic_prop.mmu_dram_default_page_addr;
    let mut size: u32 = MMU_DRAM_DEFAULT_PAGE_SIZE;
    let mut val: u64 = 0x9999999999999999ull;
    if (!(goya.hw_cap_initialized & HW_CAP_MMU))
    return 0;
    return goya_memset_device_memory(hdev, addr, size, val, true);
    }
#[no_mangle]
unsafe extern "C" fn goya_mmu_add_mappings_for_device_cpu(hdev: *mut hl_device) -> c_int {
    static int goya_mmu_add_mappings_for_device_cpu(struct hl_device *hdev)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    struct goya_device *goya = hdev.asic_specific;
...
#[no_mangle]
pub unsafe extern "C" fn goya_mmu_remove_device_cpu_mappings(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_mmu_prepare(hdev: *mut hl_device, asid: u32) {
    static void goya_mmu_prepare(struct hl_device *hdev, u32 asid)
    {
    struct goya_device *goya = hdev.asic_specific;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn goya_send_heartbeat(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn goya_cpucp_info_get(hdev: *mut hl_device) -> c_int {
    ...
    mme_arch_sts;
    let mut is_idle: bool = true, is_eng_idle;
    u64 offset;
    int i;
    if (e)
...
#[no_mangle]
unsafe extern "C" fn goya_hw_queues_lock(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_hw_queues_unlock(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_get_pci_id(hdev: *mut hl_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn goya_cpu_init_scrambler_dram(hdev: *mut hl_device) {
    static void goya_cpu_init_scrambler_dram(struct hl_device *hdev)
    {
    }
#[no_mangle]
unsafe extern "C" fn goya_ctx_init(ctx: *mut hl_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_pre_schedule_cs(cs: *mut hl_cs) -> c_int {
    static int goya_pre_schedule_cs(struct hl_cs *cs)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn goya_get_queue_id_for_cq(hdev: *mut hl_device, cq_idx: u32) -> u32 {
    u32 goya_get_queue_id_for_cq(struct hl_device *hdev, u32 cq_idx)
    {
    return cq_idx;
    }
#[no_mangle]
unsafe extern "C" fn goya_get_signal_cb_size(hdev: *mut hl_device) -> u32 {
    static u32 goya_get_signal_cb_size(struct hl_device *hdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn goya_get_wait_cb_size(hdev: *mut hl_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn goya_reset_sob(hdev: *mut hl_device, data: *mut c_void) {
    static void goya_reset_sob(struct hl_device *hdev, void *data)
    {
    }
#[no_mangle]
unsafe extern "C" fn goya_reset_sob_group(hdev: *mut hl_device, sob_group: u16) {
    static void goya_reset_sob_group(struct hl_device *hdev, u16 sob_group)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn goya_get_device_time(hdev: *mut hl_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn goya_collective_wait_init_cs(cs: *mut hl_cs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_ctx_fini(ctx: *mut hl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn goya_enable_events_from_fw(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_ack_mmu_page_fault_or_access_error(hdev: *mut hl_device, mmu_cap_mask: u64) -> c_int {
    static int goya_ack_mmu_page_fault_or_access_error(struct hl_device *hdev, u64 mmu_cap_mask)
    {
    return -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn goya_map_pll_idx_to_fw_idx(pll_idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_monitor_valid(mon: *mut hl_mon_state_dump) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goya_state_dump_init(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn goya_get_sob_addr(hdev: *mut hl_device, sob_id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn goya_get_monitor_dump(hdev: *mut hl_device, data: *mut c_void) -> c_int {
    static int goya_get_monitor_dump(struct hl_device *hdev, void *data)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn goya_check_if_razwi_happened(hdev: *mut hl_device) {
    static void goya_check_if_razwi_happened(struct hl_device *hdev)
    {
    }
#[no_mangle]
unsafe extern "C" fn goya_scrub_device_dram(hdev: *mut hl_device, val: u64) -> c_int {
    static int goya_scrub_device_dram(struct hl_device *hdev, u64 val)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn goya_set_dram_properties(hdev: *mut hl_device) -> c_int {
    static int goya_set_dram_properties(struct hl_device *hdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn goya_set_binning_masks(hdev: *mut hl_device) -> c_int {
    static int goya_set_binning_masks(struct hl_device *hdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn goya_send_device_activity(hdev: *mut hl_device, open: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn goya_set_asic_funcs(hdev: *mut hl_device) {
