...
//! Source: drivers/accel/habanalabs/common/command_submission.c
#![no_std]
...
pub const MAX_TS_ITER_NUM: c_int = 100;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wait_interrupt_data {
...
#[no_mangle]
unsafe extern "C" fn hl_sob_reset(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_sob_reset_error(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_sob_put(hw_sob: *mut hl_hw_sob) {
...
#[no_mangle]
unsafe extern "C" fn hw_sob_put_err(hw_sob: *mut hl_hw_sob) {
...
#[no_mangle]
pub unsafe extern "C" fn hw_sob_get(hw_sob: *mut hl_hw_sob) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_gen_sob_mask(sob_base: u16, sob_mask: u8, mask: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hl_fence_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fence_put(fence: *mut hl_fence) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fences_put(fence: *mut hl_fence, len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fence_get(fence: *mut hl_fence) {
...
#[no_mangle]
unsafe extern "C" fn hl_fence_init(fence: *mut hl_fence, sequence: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn cs_get(cs: *mut hl_cs) {
    void cs_get(struct hl_cs *cs)
    {
    kref_get(&cs.refcount);
    }
#[no_mangle]
unsafe extern "C" fn cs_get_unless_zero(cs: *mut hl_cs) -> c_int {
    static int cs_get_unless_zero(struct hl_cs *cs)
    {
    return kref_get_unless_zero(&cs.refcount);
    }
#[no_mangle]
unsafe extern "C" fn cs_put(cs: *mut hl_cs) {
    static void cs_put(struct hl_cs *cs)
    {
    kref_put(&cs.refcount, cs_do_release);
    }
#[no_mangle]
unsafe extern "C" fn cs_job_do_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn hl_cs_job_put(job: *mut hl_cs_job) {
    static void hl_cs_job_put(struct hl_cs_job *job)
    {
    kref_put(&job.refcount, cs_job_do_release);
    }
#[no_mangle]
pub unsafe extern "C" fn cs_needs_completion(cs: *mut hl_cs) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cs_needs_timeout(cs: *mut hl_cs) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_cb_patched(hdev: *mut hl_device, job: *mut hl_cs_job) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn cs_parser(hpriv: *mut hl_fpriv, job: *mut hl_cs_job) -> c_int {
    ...
    parser.patched_cb = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hl_complete_job(hdev: *mut hl_device, job: *mut hl_cs_job) {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_staged_cs_last_exists(hdev: *mut hl_device, cs: *mut hl_cs) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn staged_cs_get(hdev: *mut hl_device, cs: *mut hl_cs) {
...
//
#[no_mangle]
unsafe extern "C" fn staged_cs_put(hdev: *mut hl_device, cs: *mut hl_cs) {
...
#[no_mangle]
unsafe extern "C" fn cs_handle_tdr(hdev: *mut hl_device, cs: *mut hl_cs) {
    static void cs_handle_tdr(struct hl_device *hdev, struct hl_cs *cs)
    {
    struct hl_cs *next = core::ptr::null_mut(), *iter, *first_cs;
...
//
#[no_mangle]
unsafe extern "C" fn force_complete_multi_cs(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn complete_multi_cs(hdev: *mut hl_device, cs: *mut hl_cs) {
...
#[no_mangle]
unsafe extern "C" fn cs_do_release(ref: *mut kref) {
    static void cs_do_release(struct kref *ref)
    {
...
//
    ...
    hdev.shadow_cs_queue[cs.sequence & (hdev.asic_prop.max_pending_cs - 1)] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cs->aborted) -> else {
    else if (cs.aborted)
    cs.fence.error = -EIO;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !cs->submitted) -> else {
...
// Save only the first CS timeout parameters
    ...
    struct hl_fence *other = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cs_rollback(hdev: *mut hl_device, cs: *mut hl_cs) {
...
//
#[no_mangle]
unsafe extern "C" fn release_reserved_encaps_signals(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_cs_rollback_all(hdev: *mut hl_device, skip_wq_flush: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_release_pending_user_interrupts(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn force_complete_cs(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_abort_waiting_for_cs_completions(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn job_wq_completion(work: *mut work_struct) {
    static void job_wq_completion(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn cs_completion(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_get_active_cs_num(hdev: *mut hl_device) -> u32 {
    u32 hl_get_active_cs_num(struct hl_device *hdev)
    {
    let mut active_cs_num: u32 = 0;
    struct hl_cs *cs;
    spin_lock(&hdev.cs_mirror_lock);
    list_for_each_entry(cs, &hdev.cs_mirror_list, mirror_node)
    if (!cs.completed)
...
#[no_mangle]
unsafe extern "C" fn hl_cs_get_cs_type(cs_type_flags: u32) -> enum hl_cs_type {
    static enum hl_cs_type hl_cs_get_cs_type(u32 cs_type_flags)
    {
    if (cs_type_flags & HL_CS_FLAGS_SIGNAL)
    return CS_TYPE_SIGNAL;
#[no_mangle]
pub unsafe extern "C" fn if(HL_CS_FLAGS_WAIT: cs_type_flags &) -> else {
    else if (cs_type_flags & HL_CS_FLAGS_WAIT)
    return CS_TYPE_WAIT;
#[no_mangle]
pub unsafe extern "C" fn if(HL_CS_FLAGS_COLLECTIVE_WAIT: cs_type_flags &) -> else {
    else if (cs_type_flags & HL_CS_FLAGS_COLLECTIVE_WAIT)
    return CS_TYPE_COLLECTIVE_WAIT;
#[no_mangle]
pub unsafe extern "C" fn if(HL_CS_FLAGS_RESERVE_SIGNALS_ONLY: cs_type_flags &) -> else {
    else if (cs_type_flags & HL_CS_FLAGS_RESERVE_SIGNALS_ONLY)
    return CS_RESERVE_SIGNALS;
#[no_mangle]
pub unsafe extern "C" fn if(HL_CS_FLAGS_UNRESERVE_SIGNALS_ONLY: cs_type_flags &) -> else {
    else if (cs_type_flags & HL_CS_FLAGS_UNRESERVE_SIGNALS_ONLY)
    return CS_UNRESERVE_SIGNALS;
#[no_mangle]
pub unsafe extern "C" fn if(HL_CS_FLAGS_ENGINE_CORE_COMMAND: cs_type_flags &) -> else {
    else if (cs_type_flags & HL_CS_FLAGS_ENGINE_CORE_COMMAND)
    return CS_TYPE_ENGINE_CORE;
#[no_mangle]
pub unsafe extern "C" fn if(HL_CS_FLAGS_ENGINES_COMMAND: cs_type_flags &) -> else {
    else if (cs_type_flags & HL_CS_FLAGS_ENGINES_COMMAND)
    return CS_TYPE_ENGINES;
#[no_mangle]
pub unsafe extern "C" fn if(HL_CS_FLAGS_FLUSH_PCI_HBW_WRITES: cs_type_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn hl_cs_sanity_checks(hpriv: *mut hl_fpriv, args: *mut union hl_cs_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_stream_master_qid_mask(hdev: *mut hl_device, qid: u32) -> u32 {
    ...
    struct hl_cb *cb;
    u64 user_sequence;
    let mut stream_master_qid_map: u8 = 0;
    int rc, i;
    cntr = &hdev.aggregated_cs_counters;
...
// We finished with the CS in this function, so put the ref
    ...
    struct hl_device *hdev = hpriv.hdev;
    struct hl_ctx *ctx = hpriv.ctx;
    let mut need_soft_reset: bool = false;
    let mut rc: c_int = 0, do_ctx_switch = 0;
    void __user *chunks;
    u32 num_chunks, tmp;
    u16 sob_count;
    int ret;
...
// set reset indication for the sob
    ...
    bool encaps_signals)
    {
    u64 *signal_seq_arr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cs_ioctl_unreserve_signals(hpriv: *mut hl_fpriv, handle_id: u32) -> c_int {
...
// unlock before calling ctx_put, where we might sleep
    ...
    {
    struct hl_cs_encaps_sig_handle *encaps_sig_hdl = core::ptr::null_mut();
    bool handle_found = false, is_wait_cs = false,
    wait_cs_submitted = false,
    cs_encaps_signals = false;
    struct hl_cs_chunk *cs_chunk_array, *chunk;
    let mut staged_cs_with_encaps_signals: bool = false;
    struct hw_queue_properties *hw_queue_prop;
    struct hl_device *hdev = hpriv.hdev;
    struct hl_cs_compl *sig_waitcs_cmpl;
    u32 q_idx, collective_engine_id = 0;
    struct hl_cs_counters_atomic *cntr;
    struct hl_fence *sig_fence = core::ptr::null_mut();
    struct hl_ctx *ctx = hpriv.ctx;
...
#[no_mangle]
pub unsafe extern "C" fn if(CS_TYPE_COLLECTIVE_WAIT: cs_type ==) -> else {
...
//
    ...
    rc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(-EAGAIN: rc !=) -> else {
    else if (rc != -EAGAIN)
    dev_err(hdev.dev,
    "Failed to submit CS %d.%llu to H/W queues, error %d\n",
...
#[no_mangle]
unsafe extern "C" fn cs_ioctl_flush_pci_hbw_writes(hpriv: *mut hl_fpriv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_cs_ioctl(ddev: *mut drm_device, data: *mut c_void, file_priv: *mut drm_file) -> c_int {
    int hl_cs_ioctl(struct drm_device *ddev, void *data, struct drm_file *file_priv)
    {
    struct hl_fpriv *hpriv = file_priv.driver_priv;
    union hl_cs_args *args = data;
    let mut cs_type: enum hl_cs_type = 0;
    let mut cs_seq: u64 = ULONG_MAX;
    void __user *chunks;
    u32 num_chunks, flags, timeout,
    signals_count = 0, sob_addr = 0, handle_id = 0;
    let mut sob_initial_count: u16 = 0;
    int rc;
...
// status = CS_WAIT_STATUS_BUSY;
    ...
    rc = completion_rc;
#[no_mangle]
pub unsafe extern "C" fn if(-EIO: error == -ETIMEDOUT || error ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn hl_cs_poll_fences(mcs_data: *mut multi_cs_data, mcs_compl: *mut multi_cs_completion) -> c_int {
...
// poll the fence)
//
    rc = hl_wait_for_fence(mcs_data.ctx, seq_arr[i], fence, &status, 0, core::ptr::null_mut());
    if (rc) {
    dev_err(hdev.dev,
...
#[no_mangle]
pub unsafe extern "C" fn hl_usecs64_to_jiffies(usecs: u64) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_multi_cs_completion_init(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_multi_cs_wait_ioctl(hpriv: *mut hl_fpriv, data: *mut c_void) -> c_int {
    static int hl_multi_cs_wait_ioctl(struct hl_fpriv *hpriv, void *data)
    {
    struct multi_cs_completion *mcs_compl;
    struct hl_device *hdev = hpriv.hdev;
    let mut mcs_data: multi_cs_data = {};
...
#[no_mangle]
unsafe extern "C" fn hl_cs_wait_ioctl(hpriv: *mut hl_fpriv, data: *mut c_void) -> c_int {
    static int hl_cs_wait_ioctl(struct hl_fpriv *hpriv, void *data)
    {
    struct hl_device *hdev = hpriv.hdev;
    union hl_wait_cs_args *args = data;
    enum hl_cs_wait_status status;
    let mut seq: u64 = args.in.seq;
    s64 timestamp;
    int rc;
...
// Validate ts_offset not exceeding last max
    ...
    let mut ts_rec_found: bool = false;
    unsigned long flags;
    if (need_lock)
    spin_lock_irqsave(&interrupt.ts_list_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn hl_interrupt_wait_ioctl(hpriv: *mut hl_fpriv, data: *mut c_void) -> c_int {
    ...
    struct hl_user_interrupt *interrupt;
    union hl_wait_cs_args *args = data;
    let mut status: u32 = HL_WAIT_CS_STATUS_BUSY;
...
// Check if the requested core is enabled
    ...
    let mut wait_intr_data: wait_interrupt_data = {0};
...
#[no_mangle]
pub unsafe extern "C" fn hl_wait_ioctl(ddev: *mut drm_device, data: *mut c_void, file_priv: *mut drm_file) -> c_int {
    int hl_wait_ioctl(struct drm_device *ddev, void *data, struct drm_file *file_priv)
    {
    struct hl_fpriv *hpriv = file_priv.driver_priv;
    struct hl_device *hdev = hpriv.hdev;
    union hl_wait_cs_args *args = data;
    let mut flags: u32 = args.in.flags;
    int rc;
...
//
    if (!hl_device_operational(hpriv.hdev, core::ptr::null_mut()) || hdev.reset_info.watchdog_active)
    return -EBUSY;
    if (flags & HL_WAIT_CS_FLAGS_INTERRUPT)
    rc = hl_interrupt_wait_ioctl(hpriv, data);
#[no_mangle]
pub unsafe extern "C" fn if(HL_WAIT_CS_FLAGS_MULTI_CS: flags &) -> else {
