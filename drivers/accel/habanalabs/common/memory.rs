...
//! Source: drivers/accel/habanalabs/common/memory.c
#![no_std]
...
pub const HL_MMU_DEBUG: c_int = 0;
// use small pages for supporting non-pow2 (32M/40M/48M) DRAM phys page sizes

    static int allocate_timestamps_buffers(struct hl_fpriv *hpriv,
    struct hl_mem_in *args, u64 *handle);
#[no_mangle]
unsafe extern "C" fn set_alloc_page_size(hdev: *mut hl_device, args: *mut hl_mem_in, page_size: *mut u32) -> c_int {
...
//
    ...
    let mut paddr: u64 = 0, total_size, num_pgs, i;
    ...
    total_size, core::ptr::null_mut(), page_size);
    else
...
//
#[no_mangle]
unsafe extern "C" fn dram_pg_pool_do_release(ref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn free_device_memory(ctx: *mut hl_ctx, args: *mut hl_mem_in) -> c_int {
    static int free_device_memory(struct hl_ctx *ctx, struct hl_mem_in *args)
    {
    struct hl_device *hdev = ctx.hdev;
    struct hl_vm *vm = &hdev.vm;
    struct hl_vm_phys_pg_pack *phys_pg_pack;
    let mut handle: u32 = args.free.handle;
    spin_lock(&vm.idr_lock);
...
//
    ...
    {
    struct hl_vm_va_block *va_block, *res = core::ptr::null_mut();
    let mut size: u64 = end - start + 1;
...
#[no_mangle]
pub unsafe extern "C" fn if(HL_VA_RANGE_TYPE_HOST: range_type ==) -> else {
...
//
    ...
    u32 flags)
    {
    struct hl_vm_va_block *va_block, *new_va_block = core::ptr::null_mut();
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    ...
    let mut add_prev: bool = false;
    let mut is_align_pow_2: bool = is_power_of_2(va_range.page_size);
    let mut is_hint_dram_addr: bool = hl_is_dram_va(hdev, hint_addr);
    let mut force_hint: bool = flags & HL_MEM_FORCE_HINT;
    int rc;
    if (is_align_pow_2)
...
//
    ...
    let mut pgs_in_huge_page: u32 = huge_page_size >> __ffs(page_size);
    struct hl_vm_phys_pg_pack *phys_pg_pack;
    let mut first: bool = true, is_huge_page_opt;
...
//
    ...
    {
    struct hl_device *hdev = ctx.hdev;
    let mut next_vaddr: u64 = vaddr, paddr, mapped_pg_cnt = 0, i;
    let mut page_size: u32 = phys_pg_pack.page_size;
    let mut rc: c_int = 0;
    bool is_host_addr;
    for (i = 0 ; i < phys_pg_pack.npages ; i++) {
...
//
#[no_mangle]
unsafe extern "C" fn map_device_va(ctx: *mut hl_ctx, args: *mut hl_mem_in, device_addr: *mut u64) -> c_int {
    static int map_device_va(struct hl_ctx *ctx, struct hl_mem_in *args, u64 *device_addr)
    {
    struct hl_vm_phys_pg_pack *phys_pg_pack;
    let mut va_range_type: enum hl_va_range_type = 0;
    struct hl_device *hdev = ctx.hdev;
    struct hl_userptr *userptr = core::ptr::null_mut();
    let mut handle: u32 = 0, va_block_align;
...
//
    ...
    let mut vaddr: u64 = args.unmap.device_virt_addr;
...
#[no_mangle]
unsafe extern "C" fn map_block(hdev: *mut hl_device, address: u64, handle: *mut u64, size: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hw_block_vm_close(vma: *mut vm_area_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_hw_block_mmap(hpriv: *mut hl_fpriv, vma: *mut vm_area_struct) -> c_int {
...
// Driver only allows mapping of a complete HW block
    ...
    if (rc)
    return rc;
    sg_set_page(sg, core::ptr::null_mut(), chunk_size, 0);
...
#[no_mangle]
unsafe extern "C" fn memhash_node_export_put(ctx: *mut hl_ctx, hnode: *mut hl_vm_hash_node) {
...
#[no_mangle]
unsafe extern "C" fn hl_release_dmabuf(dmabuf: *mut dma_buf) {
...
#[no_mangle]
unsafe extern "C" fn validate_export_params_common(hdev: *mut hl_device, addr: u64, size: u64, offset: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_export_params_no_mmu(hdev: *mut hl_device, device_addr: u64, size: u64) -> c_int {
...
//
    ...
    {
    struct hl_vm_phys_pg_pack *phys_pg_pack = core::ptr::null_mut();
    struct hl_vm_hash_node *hnode = core::ptr::null_mut();
    struct asic_fixed_properties *prop;
    struct hl_dmabuf_priv *hl_dmabuf;
    struct hl_device *hdev;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn ts_buff_release(buf: *mut hl_mmap_mem_buf) {
...
#[no_mangle]
unsafe extern "C" fn hl_ts_mmap(buf: *mut hl_mmap_mem_buf, vma: *mut vm_area_struct, args: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hl_ts_alloc_buf(buf: *mut hl_mmap_mem_buf, gfp: gfp_t, args: *mut c_void) -> c_int {
    static int hl_ts_alloc_buf(struct hl_mmap_mem_buf *buf, gfp_t gfp, void *args)
    {
    struct hl_ts_buff *ts_buff = core::ptr::null_mut();
    u32 num_elements;
    size_t size;
    void *p;
...
//
#[no_mangle]
unsafe extern "C" fn allocate_timestamps_buffers(hpriv: *mut hl_fpriv, args: *mut hl_mem_in, handle: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_mem_ioctl(ddev: *mut drm_device, data: *mut c_void, file_priv: *mut drm_file) -> c_int {
    ...
    let mut handle: u32 = 0, block_size;
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_unpin_host_memory(hdev: *mut hl_device, userptr: *mut hl_userptr) {
...
//
#[no_mangle]
unsafe extern "C" fn va_range_fini(hdev: *mut hl_device, va_range: *mut hl_va_range) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_vm_ctx_init(ctx: *mut hl_ctx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_vm_ctx_fini(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_vm_init(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_vm_fini(hdev: *mut hl_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_hw_block_mem_init(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_hw_block_mem_fini(ctx: *mut hl_ctx) {
