...
//! Source: drivers/accel/habanalabs/common/sysfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_max_freq_mhz_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn clk_cur_freq_mhz_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vrm_ver_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    infineon_second_stage_third_instance);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpucp_info->infineon_second_stage_version) -> else {
    ...
    infineon_second_stage_third_instance);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpucp_info->infineon_version) -> else {
...
#[no_mangle]
unsafe extern "C" fn parent_device_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn hl_sysfs_add_dev_clk_attr(hdev: *mut hl_device, dev_clk_attr_grp: *mut attribute_group) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_sysfs_add_dev_vrm_attr(hdev: *mut hl_device, dev_vrm_attr_grp: *mut attribute_group) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_sysfs_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_sysfs_fini(hdev: *mut hl_device) {
