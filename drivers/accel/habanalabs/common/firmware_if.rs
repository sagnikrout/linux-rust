...
//! Source: drivers/accel/habanalabs/common/firmware_if.c
#![no_std]
...
pub const FW_FILE_MAX_SIZE: c_uint = 0x1400000 /* maximum size of 20MB */;
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_fw_version_cmp(hdev: *mut hl_device, major: u32, minor: u32, subminor: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_get_sw_major_minor_subminor(hdev: *mut hl_device, fw_str: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_get_preboot_major_minor(hdev: *mut hl_device, preboot_ver: *mut c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_release_firmware(fw: *const firmware) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_send_pci_access_msg(hdev: *mut hl_device, opcode: u32, value: u64) -> c_int {
    int hl_fw_send_pci_access_msg(struct hl_device *hdev, u32 opcode, u64 value)
    {
    let mut pkt: cpucp_packet = {};
    int rc;
...
//
    if (!hl_device_operational(hdev, core::ptr::null_mut()) && !hdev.reset_info.in_compute_reset) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_unmask_irq(hdev: *mut hl_device, event_type: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_test_cpu_queue(hdev: *mut hl_device) -> c_int {
    int hl_fw_test_cpu_queue(struct hl_device *hdev)
    {
    let mut test_pkt: cpucp_packet = {};
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_send_soft_reset(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_send_device_activity(hdev: *mut hl_device, open: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_send_heartbeat(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fw_report_boot_dev0(hdev: *mut hl_device, err_val: u32, sts_val: u32) -> bool {
    static bool fw_report_boot_dev0(struct hl_device *hdev, u32 err_val, u32 sts_val)
    {
    let mut err_exists: bool = false;
...
#[no_mangle]
unsafe extern "C" fn hl_fw_send_msi_info_msg(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_get_eeprom_data(hdev: *mut hl_device, data: *mut c_void, max_size: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_get_monitor_dump(hdev: *mut hl_device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_cpucp_total_energy_get(hdev: *mut hl_device, total_energy: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_cpucp_power_get(hdev: *mut hl_device, power: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_dram_pending_row_get(hdev: *mut hl_device, pend_rows_num: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_cpucp_engine_core_asid_set(hdev: *mut hl_device, asid: u32) -> c_int {
    ...
    rc = hdev.asic_funcs.send_cpu_message(hdev, (u32 *) &pkt, sizeof(pkt),
    HL_CPUCP_INFO_TIMEOUT_USEC, core::ptr::null_mut());
    if (rc)
    dev_err(hdev.dev,
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_ask_hard_reset_without_linux(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_ask_halt_machine_without_linux(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn detect_cpu_boot_status(hdev: *mut hl_device, status: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_wait_preboot_ready(hdev: *mut hl_device) -> c_int {
    int hl_fw_wait_preboot_ready(struct hl_device *hdev)
    {
    struct pre_fw_load_props *pre_fw_load = &hdev.fw_loader.pre_fw_load;
    let mut status: u32 = 0, timeout;
...
#[no_mangle]
unsafe extern "C" fn hl_fw_read_preboot_caps(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_fw_preboot_update_state(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn hl_fw_static_read_preboot_status(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_read_preboot_status(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_fw_compat_crc32(data: *mut u8, size: usize) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hl_fw_dynamic_update_linux_interrupt_if(hdev: *mut hl_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_fw_init_cpu(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_set_pll_profile(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_get_clk_rate(hdev: *mut hl_device, cur_clk: *mut u32, max_clk: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_get_frequency(hdev: *mut hl_device, pll_index: u32, curr: bool) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_set_frequency(hdev: *mut hl_device, pll_index: u32, freq: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_get_max_power(hdev: *mut hl_device) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn hl_fw_set_max_power(hdev: *mut hl_device) {
...
// TODO: remove this after simulator supports this packet
    ...
    rc = hdev.asic_funcs.send_cpu_message(hdev, (u32 *) &pkt, sizeof(pkt), timeout, core::ptr::null_mut());
    if (rc) {
    if (rc != -EAGAIN)
    dev_err(hdev.dev,
