...
//! Source: drivers/accel/habanalabs/common/command_buffer.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cb_map_mem(ctx: *mut hl_ctx, cb: *mut hl_cb) -> c_int {
    static int cb_map_mem(struct hl_ctx *ctx, struct hl_cb *cb)
    {
    struct hl_device *hdev = ctx.hdev;
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut page_size: u32 = prop.pmmu.page_size;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn cb_unmap_mem(ctx: *mut hl_ctx, cb: *mut hl_cb) {
...
#[no_mangle]
unsafe extern "C" fn cb_fini(hdev: *mut hl_device, cb: *mut hl_cb) {
...
#[no_mangle]
unsafe extern "C" fn cb_do_release(hdev: *mut hl_device, cb: *mut hl_cb) {
    ...
    {
    struct hl_cb *cb = core::ptr::null_mut();
    u32 cb_offset;
    void *p;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hl_cb_mmap_mem_alloc_args {
    pub hdev: *mut hl_device,
    pub ctx: *mut hl_ctx,
    pub cb_size: u32,
    pub internal_cb: bool,
    pub map_cb: bool,
}

#[no_mangle]
unsafe extern "C" fn hl_cb_mmap_mem_release(buf: *mut hl_mmap_mem_buf) {
...
#[no_mangle]
unsafe extern "C" fn hl_cb_mmap_mem_alloc(buf: *mut hl_mmap_mem_buf, gfp: gfp_t, args: *mut c_void) -> c_int {
    ...
    let mut alloc_new_cb: bool = true;
...
#[no_mangle]
pub unsafe extern "C" fn hl_cb_destroy(mmg: *mut hl_mem_mgr, cb_handle: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_cb_ioctl(ddev: *mut drm_device, data: *mut c_void, file_priv: *mut drm_file) -> c_int {
    int hl_cb_ioctl(struct drm_device *ddev, void *data, struct drm_file *file_priv)
    {
    struct hl_fpriv *hpriv = file_priv.driver_priv;
    struct hl_device *hdev = hpriv.hdev;
    union hl_cb_args *args = data;
    let mut handle: u64 = 0, device_va = 0;
    enum hl_device_status status;
    let mut usage_cnt: u32 = 0;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn hl_cb_put(cb: *mut hl_cb) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_cb_pool_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_cb_pool_fini(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_cb_va_pool_init(ctx: *mut hl_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_cb_va_pool_fini(ctx: *mut hl_ctx) {
