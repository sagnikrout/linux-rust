...
//! Source: drivers/accel/habanalabs/common/context.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hl_encaps_release_handle_and_put_ctx(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn hl_encaps_release_handle_and_put_sob(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_encaps_release_handle_and_put_sob_ctx(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn hl_encaps_sig_mgr_init(mgr: *mut hl_encaps_signals_mgr) {
...
#[no_mangle]
unsafe extern "C" fn hl_encaps_sig_mgr_fini(hdev: *mut hl_device, mgr: *mut hl_encaps_signals_mgr) {
...
#[no_mangle]
unsafe extern "C" fn hl_ctx_fini(ctx: *mut hl_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_ctx_do_release(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_ctx_create(hdev: *mut hl_device, hpriv: *mut hl_fpriv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_ctx_init(hdev: *mut hl_device, ctx: *mut hl_ctx, is_kernel_ctx: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hl_ctx_get_unless_zero(ctx: *mut hl_ctx) -> c_int {
    static int hl_ctx_get_unless_zero(struct hl_ctx *ctx)
    {
    return kref_get_unless_zero(&ctx.refcount);
    }
#[no_mangle]
pub unsafe extern "C" fn hl_ctx_get(ctx: *mut hl_ctx) {
    void hl_ctx_get(struct hl_ctx *ctx)
    {
    kref_get(&ctx.refcount);
    }
#[no_mangle]
pub unsafe extern "C" fn hl_ctx_put(ctx: *mut hl_ctx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_ctx_mgr_init(ctx_mgr: *mut hl_ctx_mgr) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_ctx_mgr_fini(hdev: *mut hl_device, ctx_mgr: *mut hl_ctx_mgr) {
