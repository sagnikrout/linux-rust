...
//! Source: drivers/accel/habanalabs/common/memory_mgr.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmap_mem_buf_destroy(buf: *mut hl_mmap_mem_buf) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmap_mem_buf_release(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmap_mem_buf_remove_idr_locked(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mmap_mem_buf_put(buf: *mut hl_mmap_mem_buf) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mmap_mem_buf_put_handle(mmg: *mut hl_mem_mgr, handle: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmap_mem_buf_vm_close(vma: *mut vm_area_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mem_mgr_init(dev: *mut device, mmg: *mut hl_mem_mgr) {
...
#[no_mangle]
unsafe extern "C" fn hl_mem_mgr_fini_stats_reset(stats: *mut hl_mem_mgr_fini_stats) {
...
#[no_mangle]
unsafe extern "C" fn hl_mem_mgr_fini_stats_inc(mem_id: u64, stats: *mut hl_mem_mgr_fini_stats) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mem_mgr_fini(mmg: *mut hl_mem_mgr, stats: *mut hl_mem_mgr_fini_stats) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mem_mgr_idr_destroy(mmg: *mut hl_mem_mgr) {
