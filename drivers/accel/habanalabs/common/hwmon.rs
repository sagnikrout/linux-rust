...
//! Source: drivers/accel/habanalabs/common/hwmon.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fixup_attr_legacy_fw(attr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn adjust_hwmon_flags(hdev: *mut hl_device, type: enum hwmon_sensor_types, cpucp_flags: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hl_build_hwmon_channel_info(hdev: *mut hl_device, sensors_arr: *mut cpucp_sensor) -> c_int {
    ...
    u32 *sensors_by_type[HWMON_NR_SENSOR_TYPES] = {core::ptr::null_mut()};
...
#[no_mangle]
pub unsafe extern "C" fn hl_hwmon_init(hdev: *mut hl_device) -> c_int {
    ...
    hdev.hl_chip_info, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn hl_hwmon_fini(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_hwmon_release_resources(hdev: *mut hl_device) {
    ...
    hdev.hl_chip_info.info = core::ptr::null_mut();
    }
