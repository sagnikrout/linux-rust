...
//! Source: drivers/accel/habanalabs/common/habanalabs_ioctl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn device_status_info(hdev: *mut hl_device, args: *mut hl_info_args) -> c_int {
    static int device_status_info(struct hl_device *hdev, struct hl_info_args *args)
    {
    let mut dev_stat: hl_info_device_status = {0};
    let mut size: u32 = args.return_size;
...
#[no_mangle]
unsafe extern "C" fn hw_ip_info(hdev: *mut hl_device, args: *mut hl_info_args) -> c_int {
    static int hw_ip_info(struct hl_device *hdev, struct hl_info_args *args)
    {
    let mut hw_ip: hl_info_hw_ip_info = {0};
    let mut size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
...
#[no_mangle]
unsafe extern "C" fn events_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int events_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    let mut max_size: u32 = args.return_size;
    u64 events_mask;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
...
#[no_mangle]
unsafe extern "C" fn dram_usage_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int dram_usage_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut dram_usage: hl_info_dram_usage = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    u64 dram_kmd_size;
...
#[no_mangle]
unsafe extern "C" fn hw_idle(hdev: *mut hl_device, args: *mut hl_info_args) -> c_int {
    static int hw_idle(struct hl_device *hdev, struct hl_info_args *args)
    {
    let mut hw_idle: hl_info_hw_idle = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn debug_coresight(hdev: *mut hl_device, ctx: *mut hl_ctx, args: *mut hl_debug_args) -> c_int {
    static int debug_coresight(struct hl_device *hdev, struct hl_ctx *ctx, struct hl_debug_args *args)
    {
    struct hl_debug_params *params;
    void *input = core::ptr::null_mut(), *output = core::ptr::null_mut();
    int rc;
...
#[no_mangle]
unsafe extern "C" fn device_utilization(hdev: *mut hl_device, args: *mut hl_info_args) -> c_int {
    static int device_utilization(struct hl_device *hdev, struct hl_info_args *args)
    {
    let mut device_util: hl_info_device_utilization = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    int rc;
    if ((!max_size) || (!out))
...
#[no_mangle]
unsafe extern "C" fn get_clk_rate(hdev: *mut hl_device, args: *mut hl_info_args) -> c_int {
    static int get_clk_rate(struct hl_device *hdev, struct hl_info_args *args)
    {
    let mut clk_rate: hl_info_clk_rate = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    int rc;
    if ((!max_size) || (!out))
    ...
    return rc;
#[no_mangle]
pub unsafe extern "C" fn copy_to_user(_arg: out, _arg: &clk_rate, _arg: min_t(size_t, _arg: max_size, _arg: sizeof(clk_rate))) -> return {
    return copy_to_user(out, &clk_rate, min_t(size_t, max_size, sizeof(clk_rate)))
    ? -EFAULT : 0;
    }
#[no_mangle]
unsafe extern "C" fn get_reset_count(hdev: *mut hl_device, args: *mut hl_info_args) -> c_int {
    static int get_reset_count(struct hl_device *hdev, struct hl_info_args *args)
    {
    let mut reset_count: hl_info_reset_count = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn time_sync_info(hdev: *mut hl_device, args: *mut hl_info_args) -> c_int {
    static int time_sync_info(struct hl_device *hdev, struct hl_info_args *args)
    {
    let mut time_sync: hl_info_time_sync = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn pci_counters_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int pci_counters_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut pci_counters: hl_info_pci_counters = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    int rc;
    if ((!max_size) || (!out))
...
#[no_mangle]
unsafe extern "C" fn clk_throttle_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int clk_throttle_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    struct hl_device *hdev = hpriv.hdev;
    let mut clk_throttle: hl_info_clk_throttle = {0};
...
#[no_mangle]
unsafe extern "C" fn cs_counters_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int cs_counters_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    let mut cs_counters: hl_info_cs_counters = {0};
    struct hl_device *hdev = hpriv.hdev;
...
#[no_mangle]
unsafe extern "C" fn sync_manager_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int sync_manager_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut sm_info: hl_info_sync_manager = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    if ((!max_size) || (!out))
    return -EINVAL;
    ...
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut total_energy: hl_info_energy = {0};
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    int rc;
    if ((!max_size) || (!out))
...
#[no_mangle]
unsafe extern "C" fn pll_frequency_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int pll_frequency_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut freq_info: hl_pll_frequency_info = { {0} };
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    int rc;
    if ((!max_size) || (!out))
...
#[no_mangle]
unsafe extern "C" fn power_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int power_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut max_size: u32 = args.return_size;
    let mut power_info: hl_power_info = {0};
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    int rc;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn open_stats_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int open_stats_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut max_size: u32 = args.return_size;
    let mut open_stats_info: hl_open_stats_info = {0};
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn dram_pending_rows_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int dram_pending_rows_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut max_size: u32 = args.return_size;
    let mut pend_rows_num: u32 = 0;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    int rc;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn dram_replaced_rows_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int dram_replaced_rows_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut max_size: u32 = args.return_size;
    let mut info: cpucp_hbm_row_info = {0};
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    int rc;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn last_err_open_dev_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int last_err_open_dev_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    let mut info: hl_info_last_err_open_dev_time = {0};
    struct hl_device *hdev = hpriv.hdev;
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    if ((!max_size) || (!out))
...
#[no_mangle]
unsafe extern "C" fn cs_timeout_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int cs_timeout_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    let mut info: hl_info_cs_timeout_event = {0};
    struct hl_device *hdev = hpriv.hdev;
    let mut max_size: u32 = args.return_size;
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    if ((!max_size) || (!out))
...
#[no_mangle]
unsafe extern "C" fn razwi_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn undefined_opcode_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int undefined_opcode_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    struct hl_device *hdev = hpriv.hdev;
    let mut max_size: u32 = args.return_size;
    let mut info: hl_info_undefined_opcode_event = {0};
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn dev_mem_alloc_page_sizes_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int dev_mem_alloc_page_sizes_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    let mut info: hl_info_dev_memalloc_page_sizes = {0};
    struct hl_device *hdev = hpriv.hdev;
    let mut max_size: u32 = args.return_size;
    if ((!max_size) || (!out))
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn sec_attest_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dev_info_signed(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eventfd_register(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
// check if there is already a registered on that process
    ...
    hpriv.notifier_event.eventfd = core::ptr::null_mut();
    mutex_unlock(&hpriv.notifier_event.lock);
    return rc;
    }
    mutex_unlock(&hpriv.notifier_event.lock);
...
#[no_mangle]
unsafe extern "C" fn eventfd_unregister(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn engine_status_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int engine_status_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    let mut status_buf_size: u32 = args.return_size;
    struct hl_device *hdev = hpriv.hdev;
    ...
    if (!eng_data.buf)
    return -ENOMEM;
    hdev.asic_funcs.is_device_idle(hdev, core::ptr::null_mut(), 0, &eng_data);
...
#[no_mangle]
unsafe extern "C" fn page_fault_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn user_mappings_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
    static int user_mappings_info(struct hl_fpriv *hpriv, struct hl_info_args *args)
    {
    void __user *out = (void __user *) (uintptr_t) args.return_pointer;
    let mut user_buf_size: u32 = args.return_size;
    struct hl_device *hdev = hpriv.hdev;
    struct page_fault_info *pgf_info;
    u64 actual_size;
    if (!out)
...
#[no_mangle]
unsafe extern "C" fn hw_err_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fw_err_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn engine_err_info(hpriv: *mut hl_fpriv, args: *mut hl_info_args) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_fw_generic_request(hdev: *mut hl_device, info_args: *mut hl_info_args) -> c_int {
    static int send_fw_generic_request(struct hl_device *hdev, struct hl_info_args *info_args)
    {
    void __user *buff = (void __user *) (uintptr_t) info_args.return_pointer;
    let mut size: u32 = info_args.return_size;
...
#[no_mangle]
pub unsafe extern "C" fn hl_info_ioctl(ddev: *mut drm_device, data: *mut c_void, file_priv: *mut drm_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hl_info_ioctl_control(hpriv: *mut hl_fpriv, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debug_ioctl(ddev: *mut drm_device, data: *mut c_void, file_priv: *mut drm_file) -> c_int {
    ...
    {
    let mut nr: c_uint = _IOC_NR(cmd);
    char stack_kdata[128] = {0};
    char *kdata = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn hl_ioctl_control(filep: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    long hl_ioctl_control(struct file *filep, unsigned int cmd, unsigned long arg)
    {
    struct hl_fpriv *hpriv = filep.private_data;
    struct hl_device *hdev = hpriv.hdev;
    const struct hl_ioctl_desc *ioctl = core::ptr::null_mut();
    let mut nr: c_uint = _IOC_NR(cmd);
    if (!hdev) {
