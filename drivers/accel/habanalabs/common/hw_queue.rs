...
//! Source: drivers/accel/habanalabs/common/hw_queue.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_hw_queue_add_ptr(ptr: u32, val: u16) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn queue_ci_get(ci: *mut core::sync::atomic::AtomicI32, queue_len: u32) -> c_int {
    static inline int queue_ci_get(atomic_t *ci, u32 queue_len)
    {
    return atomic_read(ci) & ((queue_len << 1) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn queue_free_slots(q: *mut hl_hw_queue, queue_len: u32) -> c_int {
    static inline int queue_free_slots(struct hl_hw_queue *q, u32 queue_len)
    {
    let mut delta: c_int = (q.pi - queue_ci_get(&q.ci, queue_len));
    if (delta >= 0)
...
#[no_mangle]
pub unsafe extern "C" fn hl_hw_queue_update_ci(cs: *mut hl_cs) {
...
//
#[no_mangle]
unsafe extern "C" fn ext_queue_schedule_job(job: *mut hl_cs_job) {
...
//
#[no_mangle]
unsafe extern "C" fn int_queue_schedule_job(job: *mut hl_cs_job) {
...
//
#[no_mangle]
unsafe extern "C" fn hw_queue_schedule_job(job: *mut hl_cs_job) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: job->is_kernel_allocated_cb) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn init_signal_wait_cs(cs: *mut hl_cs) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CS_TYPE_WAIT: cs->type &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_hw_queue_schedule_cs(cs: *mut hl_cs) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_hw_queue_inc_ci_kernel(hdev: *mut hl_device, hw_queue_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn int_queue_init(hdev: *mut hl_device, q: *mut hl_hw_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_queue_init(hdev: *mut hl_device, q: *mut hl_hw_queue) -> c_int {
    static int cpu_queue_init(struct hl_device *hdev, struct hl_hw_queue *q)
    {
    return ext_and_cpu_queue_init(hdev, q, true);
    }
#[no_mangle]
unsafe extern "C" fn ext_queue_init(hdev: *mut hl_device, q: *mut hl_hw_queue) -> c_int {
    static int ext_queue_init(struct hl_device *hdev, struct hl_hw_queue *q)
    {
    return ext_and_cpu_queue_init(hdev, q, false);
    }
#[no_mangle]
unsafe extern "C" fn hw_queue_init(hdev: *mut hl_device, q: *mut hl_hw_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sync_stream_queue_init(hdev: *mut hl_device, q_idx: u32) {
...
#[no_mangle]
unsafe extern "C" fn sync_stream_queue_reset(hdev: *mut hl_device, q_idx: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn queue_fini(hdev: *mut hl_device, q: *mut hl_hw_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_hw_queues_create(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hl_hw_queues_destroy(hdev: *mut hl_device) {
    void hl_hw_queues_destroy(struct hl_device *hdev)
    {
    struct hl_hw_queue *q;
    let mut max_queues: u32 = hdev.asic_prop.max_queues;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn hl_hw_queue_reset(hdev: *mut hl_device, hard_reset: bool) {
