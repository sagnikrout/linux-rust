...
//! Source: drivers/accel/habanalabs/common/mmu/mmu_v1.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dram_default_mapping_init(ctx: *mut hl_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dram_default_mapping_fini(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v1_ctx_init(ctx: *mut hl_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v1_ctx_fini(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v1_swap_out(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v1_swap_in(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mmu_v1_set_funcs(hdev: *mut hl_device, mmu: *mut hl_mmu_funcs) {
