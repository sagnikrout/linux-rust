...
//! Source: drivers/accel/habanalabs/common/mmu/mmu_v2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_ctx_init(ctx: *mut hl_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_ctx_fini(ctx: *mut hl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_unmap(ctx: *mut hl_ctx, virt_addr: u64, is_dram_addr: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_swap_out(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_swap_in(ctx: *mut hl_ctx) {
    static void hl_mmu_v2_swap_in(struct hl_ctx *ctx)
    {
    }
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_get_tlb_info(ctx: *mut hl_ctx, virt_addr: u64, hops: *mut hl_mmu_hop_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mmu_v2_set_funcs(hdev: *mut hl_device, mmu: *mut hl_mmu_funcs) {
