...
//! Source: drivers/accel/habanalabs/common/mmu/mmu_v2_hr.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mmu_v2_hr_init(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mmu_v2_hr_fini(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_hr_ctx_init(ctx: *mut hl_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_hr_ctx_fini(ctx: *mut hl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_get_last_hop(mmu_prop: *mut hl_mmu_properties, page_size: u32) -> c_int {
...
//
    ...
    mmu_prop = &prop.dmmu;
#[no_mangle]
pub unsafe extern "C" fn if(prop->pmmu_huge.page_size: page_size ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_hr_swap_out(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn hl_mmu_v2_hr_swap_in(ctx: *mut hl_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_mmu_v2_hr_set_funcs(hdev: *mut hl_device, mmu: *mut hl_mmu_funcs) {
