...
//! Source: drivers/accel/habanalabs/common/irq.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_cq_inc_ptr(ptr: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_eq_inc_ptr(ptr: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn irq_handle_eqe(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn job_finish(hdev: *mut hl_device, cs_seq: u32, cq: *mut hl_cq, timestamp: ktime_t) {
...
//
#[no_mangle]
unsafe extern "C" fn cs_finish(hdev: *mut hl_device, cs_seq: u16, timestamp: ktime_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_irq_handler_cq(irq: c_int, arg: *mut c_void) -> irqreturn_t {
    ...
    let mut timestamp: ktime_t = ktime_get();
    if (hdev.disabled) {
    dev_dbg(hdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn hl_ts_free_objects(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn handle_user_interrupt_ts_list(hdev: *mut hl_device, intr: *mut hl_user_interrupt) {
    static void handle_user_interrupt_ts_list(struct hl_device *hdev, struct hl_user_interrupt *intr)
    {
    struct list_head *ts_reg_free_list_head = core::ptr::null_mut(), *dynamic_alloc_list_head = core::ptr::null_mut();
    struct hl_user_pending_interrupt *pend, *temp_pend;
    struct timestamp_reg_work_obj *job;
    let mut reg_node_handle_fail: bool = false;
    unsigned long flags;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn handle_user_interrupt_wait_list(hdev: *mut hl_device, intr: *mut hl_user_interrupt) {
...
#[no_mangle]
unsafe extern "C" fn handle_tpc_interrupt(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn handle_unexpected_user_interrupt(hdev: *mut hl_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_irq_user_interrupt_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_irq_user_interrupt_thread_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn hl_irq_eq_error_interrupt_thread_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_irq_handler_eq(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_irq_handler_dec_abnrm(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_cq_init(hdev: *mut hl_device, q: *mut hl_cq, hw_queue_id: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_cq_fini(hdev: *mut hl_device, q: *mut hl_cq) {
    void hl_cq_fini(struct hl_device *hdev, struct hl_cq *q)
    {
    hl_asic_dma_free_coherent(hdev, HL_CQ_SIZE_IN_BYTES, q.kernel_address, q.bus_address);
    }
#[no_mangle]
pub unsafe extern "C" fn hl_cq_reset(hdev: *mut hl_device, q: *mut hl_cq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_eq_init(hdev: *mut hl_device, q: *mut hl_eq) -> c_int {
    int hl_eq_init(struct hl_device *hdev, struct hl_eq *q)
    {
    let mut size: u32 = hdev.asic_prop.fw_event_queue_size ? : HL_EQ_SIZE_IN_BYTES;
    void *p;
...
//
#[no_mangle]
pub unsafe extern "C" fn hl_eq_fini(hdev: *mut hl_device, q: *mut hl_eq) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_eq_reset(hdev: *mut hl_device, q: *mut hl_eq) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_eq_dump(hdev: *mut hl_device, q: *mut hl_eq) {
