...
//! Source: drivers/accel/habanalabs/common/debugfs.c
#![no_std]
...
pub const MMU_ADDR_BUF_SIZE: c_int = 40;
pub const MMU_ASID_BUF_SIZE: c_int = 10;

pub const I2C_MAX_TRANSACTION_LEN: c_int = 8;
    ...
    rc = hdev.asic_funcs.send_cpu_message(hdev, (u32 *) &pkt, sizeof(pkt), 0, core::ptr::null_mut());
    if (rc && rc != -EAGAIN)
    dev_err(hdev.dev, "Failed to write to I2C, error %d\n", rc);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn hl_debugfs_led_set(hdev: *mut hl_device, led: u8, state: u8) {
...
#[no_mangle]
unsafe extern "C" fn command_buffers_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn command_submission_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn command_submission_jobs_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userptr_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vm_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn userptr_lookup_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmu_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    struct hl_ctx *ctx;
    let mut hops_info: hl_mmu_hop_info = {0};
    let mut virt_addr: u64 = dev_entry.mmu_addr, phys_addr;
    int i;
...
#[no_mangle]
unsafe extern "C" fn mmu_ack_error(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn engines_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dio_ssd2hl_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    char kbuf[128];
    let mut device_va: u64 = 0, off_bytes = 0, len_bytes = 0;
    let mut fd: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn dio_hl2ssd_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dio_stats_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    let mut avg_bytes_per_op: u64 = 0, success_rate = 0;
    if (!hdev.asic_prop.supports_nvme) {
    seq_puts(s, "NVMe Direct I/O not supported\\n");
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn dio_reset_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    let mut val: u64 = hdev.memory_scrub_val;
    int rc;
    if (!hl_device_operational(hdev, core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn hl_is_device_va(hdev: *mut hl_device, addr: u64) -> bool {
...
// found = true;
    ...
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut offset: u64 = prop.device_dma_offset_for_host_access;
    switch (acc_type) {
    case DEBUGFS_READ32:
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_cfg_access_history_dump(hdev: *mut hl_device) {
...
// print single entry under lock
    {
    let mut entry: hl_debugfs_cfg_access_entry = dbgfs.cfg_access_list[i];
//
...
// Check if address is in config memory
    ...
    size_t acc_size = (acc_type == DEBUGFS_READ64 || acc_type == DEBUGFS_WRITE64) ?
    sizeof(u64) : sizeof(u32);
    let mut host_start: u64 = hdev.asic_prop.host_base_address;
    let mut host_end: u64 = hdev.asic_prop.host_end_address;
...
// Free the previous allocation, if there was any
    ...
    vfree(entry.data_dma_blob_desc.data);
    entry.data_dma_blob_desc.data = core::ptr::null_mut();
    return -EIO;
    }
...
// Free the previous allocation, if there was any
    ...
    vfree(entry.mon_dump_blob_desc.data);
    entry.mon_dump_blob_desc.data = core::ptr::null_mut();
    return -EIO;
    }
    ...
    i = 1;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_D3hot: hdev->pdev->current_state ==) -> else {
...
// don't allow partial writes
    ...
    entry.state_dump[entry.state_dump_head] = core::ptr::null_mut();
    ...
    {"command_buffers", command_buffers_show, core::ptr::null_mut()},
    {"command_submission", command_submission_show, core::ptr::null_mut()},
    {"command_submission_jobs", command_submission_jobs_show, core::ptr::null_mut()},
    {"userptr", userptr_show, core::ptr::null_mut()},
    {"vm", vm_show, core::ptr::null_mut()},
    {"userptr_lookup", userptr_lookup_show, userptr_lookup_write},
    {"mmu", mmu_show, mmu_asid_va_write},
    {"mmu_error", mmu_ack_error, mmu_ack_error_value_write},
    {"engines", engines_show, core::ptr::null_mut()},

// DIO entries - only created if NVMe is supported
    {"dio_ssd2hl", dio_ssd2hl_show, dio_ssd2hl_write},
    {"dio_stats", dio_stats_show, core::ptr::null_mut()},
    {"dio_reset", dio_reset_show, dio_reset_write},
    {"dio_hl2ssd", dio_hl2ssd_show, dio_hl2ssd_write},

    };
#[no_mangle]
unsafe extern "C" fn hl_debugfs_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_secured_nodes(dev_entry: *mut hl_dbg_device_entry, root: *mut dentry) {
    ...
    struct dentry *root)
    {
    let mut count: c_int = ARRAY_SIZE(hl_debugfs_list);
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_device_init(hdev: *mut hl_device) -> c_int {
    ...
    dev_entry.data_dma_blob_desc.data = core::ptr::null_mut();
    dev_entry.mon_dump_blob_desc.size = 0;
    dev_entry.mon_dump_blob_desc.data = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_device_fini(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_add_device(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_add_file(hpriv: *mut hl_fpriv) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_remove_file(hpriv: *mut hl_fpriv) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_add_cb(cb: *mut hl_cb) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_remove_cb(cb: *mut hl_cb) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_add_cs(cs: *mut hl_cs) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_remove_cs(cs: *mut hl_cs) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_add_job(hdev: *mut hl_device, job: *mut hl_cs_job) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_remove_job(hdev: *mut hl_device, job: *mut hl_cs_job) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_add_userptr(hdev: *mut hl_device, userptr: *mut hl_userptr) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_add_ctx_mem_hash(hdev: *mut hl_device, ctx: *mut hl_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn hl_debugfs_remove_ctx_mem_hash(hdev: *mut hl_device, ctx: *mut hl_ctx) {
