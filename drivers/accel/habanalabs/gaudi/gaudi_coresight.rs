...
//! Source: drivers/accel/habanalabs/gaudi/gaudi_coresight.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn gaudi_debug_coresight(hdev: *mut hl_device, ctx: *mut hl_ctx, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi_halt_coresight(hdev: *mut hl_device, ctx: *mut hl_ctx) {
