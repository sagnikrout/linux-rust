...
//! Source: drivers/accel/habanalabs/gaudi/gaudi_security.c
#![no_std]
...
pub const GAUDI_NUMBER_OF_LBW_RR_REGS: c_int = 28;
pub const GAUDI_NUMBER_OF_HBW_RR_REGS: c_int = 24;
pub const GAUDI_NUMBER_OF_LBW_RANGES: c_int = 10;
...
//
#[no_mangle]
unsafe extern "C" fn gaudi_pb_set_block(hdev: *mut hl_device, base: u64) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_mme_protection_bits(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_dma_protection_bits(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_nic_protection_bits(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_tpc_protection_bits(hdev: *mut hl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn gaudi_init_protection_bits(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_range_registers_lbw(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_range_registers_hbw(hdev: *mut hl_device) {
    ...
    let mut sram_addr_lo: u32 = lower_32_bits(SRAM_BASE_ADDR);
    let mut sram_addr_hi: u32 = upper_32_bits(SRAM_BASE_ADDR);
    let mut scratch_addr_lo: u32 = lower_32_bits(PSOC_SCRATCHPAD_ADDR);
    let mut scratch_addr_hi: u32 = upper_32_bits(PSOC_SCRATCHPAD_ADDR);
    let mut pcie_fw_addr_lo: u32 = lower_32_bits(PCIE_FW_SRAM_ADDR);
    let mut pcie_fw_addr_hi: u32 = upper_32_bits(PCIE_FW_SRAM_ADDR);
    let mut spi_addr_lo: u32 = lower_32_bits(SPI_FLASH_BASE_ADDR);
    let mut spi_addr_hi: u32 = upper_32_bits(SPI_FLASH_BASE_ADDR);
    int i;
// Configure HBW RR:
...
//
#[no_mangle]
pub unsafe extern "C" fn gaudi_init_security(hdev: *mut hl_device) {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi_ack_protection_bits_errors(hdev: *mut hl_device) {
