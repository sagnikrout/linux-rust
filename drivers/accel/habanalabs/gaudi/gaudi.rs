...
//! Source: drivers/accel/habanalabs/gaudi/gaudi.c
#![no_std]
...
pub const GAUDI_DMA_POOL_BLK_SIZE: c_uint = 0x100 /* 256 bytes */;

pub const GAUDI_QMAN0_FENCE_VAL: c_uint = 0x72E91AB9;
pub const GAUDI_MAX_STRING_LEN: c_int = 20;
pub const GAUDI_CB_POOL_CB_CNT: c_int = 512;
pub const GAUDI_CB_POOL_CB_SIZE: c_uint = 0x20000 /* 128KB */;
pub const GAUDI_ALLOC_CPU_MEM_RETRY_CNT: c_int = 3;
pub const GAUDI_NUM_OF_TPC_INTR_CAUSE: c_int = 20;
pub const GAUDI_NUM_OF_QM_ERR_CAUSE: c_int = 16;
pub const GAUDI_NUM_OF_QM_ARB_ERR_CAUSE: c_int = 3;
pub const GAUDI_ARB_WDT_TIMEOUT: c_uint = 0xEE6b27FF /* 8 seconds */;

pub const MONITOR_SOB_STRING_SIZE: c_int = 256;
...
#[no_mangle]
pub unsafe extern "C" fn validate_packet_id(id: enum packet_id) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ecc_info_extract_params {
...
#[no_mangle]
pub unsafe extern "C" fn set_default_power_values(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_set_fixed_properties(hdev: *mut hl_device) -> c_int {
    static int gaudi_set_fixed_properties(struct hl_device *hdev)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut num_sync_stream_queues: u32 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn gaudi_pci_bars_map(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_set_hbm_bar_base(hdev: *mut hl_device, addr: u64) -> u64 {
    static u64 gaudi_set_hbm_bar_base(struct hl_device *hdev, u64 addr)
    {
    struct gaudi_device *gaudi = hdev.asic_specific;
    struct hl_inbound_pci_region pci_region;
    let mut old_addr: u64 = addr;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_iatu(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_hw_state(hdev: *mut hl_device) -> enum hl_device_hw_state {
    static enum hl_device_hw_state gaudi_get_hw_state(struct hl_device *hdev)
    {
    return RREG32(mmHW_STATE);
    }
#[no_mangle]
unsafe extern "C" fn gaudi_early_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_early_fini(hdev: *mut hl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gaudi_fetch_psoc_frequency(hdev: *mut hl_device) -> c_int {
    static int gaudi_fetch_psoc_frequency(struct hl_device *hdev)
    {
    let mut nr: u32 = 0, nf = 0, od = 0, div_fctr = 0, pll_clk, div_sel;
    struct asic_fixed_properties *prop = &hdev.asic_prop;
...
//
#[no_mangle]
unsafe extern "C" fn gaudi_init_tpc_mem(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_collective_map_sobs(hdev: *mut hl_device, stream: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_sob_group_hw_reset(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_sob_group_reset_error(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_collective_mstr_sob_mask_set(gaudi: *mut gaudi_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_collective_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_reset_sob_group(hdev: *mut hl_device, sob_group: u16) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_collective_wait_init_cs(cs: *mut hl_cs) -> c_int {
...
// only two SOBs are currently in use
    ...
    cs.signal_fence = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gaudi_get_patched_cb_extra_size(user_cb_size: u32) -> u32 {
...
//
    ...
    job.patched_cb = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn gaudi_late_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_late_fini(hdev: *mut hl_device) {
    static void gaudi_late_fini(struct hl_device *hdev)
    {
    hl_hwmon_release_resources(hdev);
    }
#[no_mangle]
unsafe extern "C" fn gaudi_alloc_cpu_accessible_dma_mem(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_free_internal_qmans_pq_mem(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_alloc_internal_qmans_pq_mem(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_set_pci_memory_regions(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_sw_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_sw_fini(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_irq_handler_single(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gaudi_enable_msi_single(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_enable_msi(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_sync_irqs(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_disable_msi(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_scrambler_sram(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_scrambler_hbm(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_e2e(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_hbm_cred(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_golden_registers(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_dma_core(hdev: *mut hl_device, dma_id: c_int) {
    static void gaudi_init_dma_core(struct hl_device *hdev, int dma_id)
    {
    struct cpu_dyn_regs *dyn_regs =
    &hdev.fw_loader.dynamic_loader.comm_desc.cpu_dyn_regs;
    let mut dma_err_cfg: u32 = 1 << DMA0_CORE_ERR_CFG_ERR_MSG_EN_SHIFT;
    let mut dma_offset: u32 = dma_id * DMA_CORE_OFFSET;
...
// If the channel is secured, it should be in MMU bypass mode
    ...
    u32 enable_mask)
    {
    let mut dma_qm_offset: u32 = dma_id * DMA_QMAN_OFFSET;
    WREG32(mmDMA0_QM_GLBL_CFG0 + dma_qm_offset, enable_mask);
    }
#[no_mangle]
unsafe extern "C" fn gaudi_init_pci_dma_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_hbm_dma_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_mme_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_tpc_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_nic_qmans(hdev: *mut hl_device) {
    static void gaudi_init_nic_qmans(struct hl_device *hdev)
    {
    struct gaudi_device *gaudi = hdev.asic_specific;
    struct gaudi_internal_qman_info *q;
    u64 qman_base_addr;
    let mut nic_offset: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn gaudi_disable_pci_dma_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_disable_hbm_dma_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_disable_mme_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_disable_tpc_qmans(hdev: *mut hl_device) {
    static void gaudi_disable_tpc_qmans(struct hl_device *hdev)
    {
    struct gaudi_device *gaudi = hdev.asic_specific;
    let mut tpc_offset: u32 = 0;
    int tpc_id;
    if (!(gaudi.hw_cap_initialized & HW_CAP_TPC_MASK))
    return;
    for (tpc_id = 0 ; tpc_id < TPC_NUMBER_OF_ENGINES ; tpc_id++) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_disable_nic_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_stop_pci_dma_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_stop_hbm_dma_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_stop_mme_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_stop_tpc_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_stop_nic_qmans(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_pci_dma_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_hbm_dma_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_mme_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_tpc_stall(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_disable_clock_gating(hdev: *mut hl_device) {
    static void gaudi_disable_clock_gating(struct hl_device *hdev)
    {
    u32 qman_offset;
    int i;
...
#[no_mangle]
unsafe extern "C" fn gaudi_enable_timestamp(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_disable_timestamp(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_halt_engines(hdev: *mut hl_device, hard_reset: bool, fw_reset: bool) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_mmu_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_load_firmware_to_device(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_load_boot_fit_to_device(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_dynamic_firmware_loader(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_static_firmware_loader(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_firmware_preload_params(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_firmware_loader(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_cpu(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_init_cpu_queues(hdev: *mut hl_device, cpu_timeout: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_pre_hw_init(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_hw_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_hw_fini(hdev: *mut hl_device, hard_reset: bool, fw_reset: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_suspend(hdev: *mut hl_device) -> c_int {
    static int gaudi_suspend(struct hl_device *hdev)
    {
    return hl_fw_send_pci_access_msg(hdev, CPUCP_PACKET_DISABLE_PCI_ACCESS, 0x0);
    }
#[no_mangle]
unsafe extern "C" fn gaudi_resume(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_ring_doorbell(hdev: *mut hl_device, hw_queue_id: u32, pi: u32) {
    ...
    struct gaudi_device *gaudi = hdev.asic_specific;
    let mut invalid_queue: bool = false;
    int dma_id;
    switch (hw_queue_id) {
...
// Cancel the device's base physical address of host memory
    let mut fixed_dma_handle: dma_addr_t = dma_handle - HOST_PHYS_BASE;
    dma_free_coherent(&hdev.pdev.dev, size, cpu_addr, fixed_dma_handle);
    }
#[no_mangle]
unsafe extern "C" fn gaudi_scrub_device_dram(hdev: *mut hl_device, val: u64) -> c_int {
    static int gaudi_scrub_device_dram(struct hl_device *hdev, u64 val)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut cur_addr: u64 = prop.dram_user_base_address;
    u32 chunk_size, busy;
    int rc, dma_id;
...
#[no_mangle]
unsafe extern "C" fn gaudi_scrub_device_mem(hdev: *mut hl_device) -> c_int {
    static int gaudi_scrub_device_mem(struct hl_device *hdev)
    {
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    let mut wait_to_idle_time: u64 = HBM_SCRUBBING_TIMEOUT_US;
    ...
    while (!hdev.asic_funcs.is_device_idle(hdev, core::ptr::null_mut(), 0, core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_test_queue(hdev: *mut hl_device, hw_queue_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_test_cpu_queue(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_test_queues(hdev: *mut hl_device) -> c_int {
...
// dma_handle += HOST_PHYS_BASE;
    ...
    {
// Cancel the device's base physical address of host memory
    let mut fixed_dma_addr: dma_addr_t = dma_addr - HOST_PHYS_BASE;
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_dma_desc_list_size(hdev: *mut hl_device, sgt: *mut sg_table) -> u32 {
    ...
    let mut skip_host_mem_pin: bool = false, user_memset;
    u64 addr;
    let mut rc: c_int = 0;
    ...
    struct packet_lin_dma *user_dma_pkt)
    {
    let mut src_in_host: bool = false;
...
//
    ...
    {
    let mut cb_parsed_length: u32 = 0;
    let mut rc: c_int = 0;
...
//
    ...
    struct sg_table *sgt;
    let mut src_in_host: bool = false;
    let mut skip_host_mem_pin: bool = false;
    bool user_memset;
...
// new_dma_pkt_size = dma_desc_cnt * sizeof(struct packet_lin_dma);
    ...
    {
    let mut cb_parsed_length: u32 = 0;
    let mut cb_patched_cur_length: u32 = 0;
    let mut rc: c_int = 0;
// cb_user_size is more than 0 so loop will always be executed
    while (cb_parsed_length < parser.user_cb_size) {
    enum packet_id pkt_id;
    u16 pkt_size;
    let mut new_pkt_size: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn gaudi_cs_parser(hdev: *mut hl_device, parser: *mut hl_cs_parser) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_update_eq_ci(hdev: *mut hl_device, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_restore_sm_registers(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_restore_dma_registers(hdev: *mut hl_device) {
    ...
    mmSYNC_MNGR_E_N_SYNC_MNGR_OBJS_SOB_OBJ_0 +
    (i * sob_delta);
    let mut dma_offset: u32 = i * DMA_CORE_OFFSET;
...
#[no_mangle]
unsafe extern "C" fn gaudi_restore_qm_registers(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_restore_user_registers(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_context_switch(hdev: *mut hl_device, asid: u32) -> c_int {
    static int gaudi_context_switch(struct hl_device *hdev, u32 asid)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gaudi_mmu_clear_pgt_range(hdev: *mut hl_device) -> c_int {
    static int gaudi_mmu_clear_pgt_range(struct hl_device *hdev)
    {
    u32 size = hdev.asic_prop.mmu_pgt_size +
    hdev.asic_prop.mmu_cache_mng_size;
    struct gaudi_device *gaudi = hdev.asic_specific;
    let mut addr: u64 = hdev.asic_prop.mmu_pgt_addr;
    if (!(gaudi.hw_cap_initialized & HW_CAP_MMU))
    return 0;
    return gaudi_memset_device_memory(hdev, addr, size, 0);
    }
#[no_mangle]
unsafe extern "C" fn gaudi_restore_phase_topology(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_read_pte(hdev: *mut hl_device, addr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn gaudi_write_pte(hdev: *mut hl_device, addr: u64, val: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn gaudi_mmu_prepare_reg(hdev: *mut hl_device, reg: u64, asid: u32) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_mmu_prepare(hdev: *mut hl_device, asid: u32) {
    static void gaudi_mmu_prepare(struct hl_device *hdev, u32 asid)
    {
    struct gaudi_device *gaudi = hdev.asic_specific;
    if (!(gaudi.hw_cap_initialized & HW_CAP_MMU))
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_event_desc(event_type: u16, desc: *mut c_char, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_print_and_get_mmu_error_info(hdev: *mut hl_device, addr: *mut u64, event_mask: *mut u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gaudi_queue_idx_dec(idx: u32, q_len: u32) -> u32 {
    static inline u32 gaudi_queue_idx_dec(u32 idx, u32 q_len)
    {
    let mut mask: u32 = q_len - 1;
//
...
// get previous ci, wrap if needed
    ...
    let mut arr_idx: u32 = undef_opcode.cb_addr_streams_len;
    if (arr_idx == 0) {
...
// Write 1 clear errors
    ...
    {
    let mut index: u32 = event_type - GAUDI_EVENT_DMA_IF_SEI_0;
// Flip the bits as the enum is ordered in the opposite way
    ...
    let mut ecc_address: u64 = 0, ecc_syndrom = 0;
...
#[no_mangle]
unsafe extern "C" fn gaudi_handle_qman_err(hdev: *mut hl_device, event_type: u16, event_mask: *mut u64) {
...
// skip GAUDI_QUEUE_ID_CPU_PQ if necessary
    ...
    {
    let mut is_read: bool = false, is_write = false;
    u16 engine_id[2], num_of_razwi_eng = 0;
    char desc[64] = "";
    let mut razwi_addr: u64 = 0;
    let mut razwi_flags: u8 = 0;
//
...
//
    ...
    let mut nic_id: u16 = event_type - GAUDI_EVENT_NIC_SEI_0;
...
#[no_mangle]
unsafe extern "C" fn gaudi_compute_reset_late_init(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_hbm_event_to_dev(hbm_event_type: u16) -> c_int {
...
// Should never happen
    ...
    char *interrupt_name)
    {
    let mut tpc_offset: u32 = tpc_id * TPC_CFG_OFFSET, tpc_interrupts_cause, i;
    let mut soft_reset_required: bool = false;
...
#[no_mangle]
unsafe extern "C" fn gaudi_handle_eqe(hdev: *mut hl_device, eq_entry: *mut hl_eq_entry) {
    static void gaudi_handle_eqe(struct hl_device *hdev, struct hl_eq_entry *eq_entry)
    {
    struct gaudi_device *gaudi = hdev.asic_specific;
    struct hl_info_fw_err_info fw_err_info;
    let mut data: u64 = le64_to_cpu(eq_entry.data[0]), event_mask = 0;
    let mut ctl: u32 = le32_to_cpu(eq_entry.hdr.ctl);
    let mut fw_fatal_err_flag: u32 = 0, flags = 0;
...
#[no_mangle]
unsafe extern "C" fn gaudi_mmu_invalidate_cache(hdev: *mut hl_device, is_hard: bool, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_mmu_update_asid_hop0_addr(hdev: *mut hl_device, asid: u32, phys_addr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_send_heartbeat(hdev: *mut hl_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_cpucp_info_get(hdev: *mut hl_device) -> c_int {
    static int gaudi_cpucp_info_get(struct hl_device *hdev)
    {
    struct gaudi_device *gaudi = hdev.asic_specific;
    struct asic_fixed_properties *prop = &hdev.asic_prop;
    ...
    let mut is_idle: bool = true, is_eng_idle, is_slave;
    u64 offset;
    int i, dma_id, port;
    if (e)
...
#[no_mangle]
unsafe extern "C" fn gaudi_hw_queues_lock(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_hw_queues_unlock(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_pci_id(hdev: *mut hl_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_monitor_dump(hdev: *mut hl_device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn gaudi_run_tpc_kernel(hdev: *mut hl_device, tpc_kernel: u64, tpc_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_ctx_init(ctx: *mut hl_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_ctx_fini(ctx: *mut hl_ctx) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_pre_schedule_cs(cs: *mut hl_cs) -> c_int {
    static int gaudi_pre_schedule_cs(struct hl_cs *cs)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gaudi_get_queue_id_for_cq(hdev: *mut hl_device, cq_idx: u32) -> u32 {
    static u32 gaudi_get_queue_id_for_cq(struct hl_device *hdev, u32 cq_idx)
    {
    return gaudi_cq_assignment[cq_idx];
    }
#[no_mangle]
unsafe extern "C" fn gaudi_get_signal_cb_size(hdev: *mut hl_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_wait_cb_size(hdev: *mut hl_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_sob_addr(hdev: *mut hl_device, sob_id: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi_add_fence_pkt(pkt: *mut packet_fence) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_fence_addr(hdev: *mut hl_device, queue_id: u32, addr: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_add_mon_pkts(buf: *mut c_void, mon_id: u16, fence_addr: u64) -> u32 {
...
//
    ...
    let mut fence_addr: u64 = 0;
    let mut size: u32 = prop.size;
...
#[no_mangle]
unsafe extern "C" fn gaudi_reset_sob(hdev: *mut hl_device, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_get_device_time(hdev: *mut hl_device) -> u64 {
    static u64 gaudi_get_device_time(struct hl_device *hdev)
    {
    let mut device_time: u64 = ((u64) RREG32(mmPSOC_TIMESTAMP_CNTCVU)) << 32;
...
#[no_mangle]
unsafe extern "C" fn gaudi_enable_events_from_fw(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_ack_mmu_page_fault_or_access_error(hdev: *mut hl_device, mmu_cap_mask: u64) -> c_int {
    static int gaudi_ack_mmu_page_fault_or_access_error(struct hl_device *hdev, u64 mmu_cap_mask)
    {
    return -EINVAL;
    }
#[no_mangle]
unsafe extern "C" fn gaudi_map_pll_idx_to_fw_idx(pll_idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_monitor_valid(mon: *mut hl_mon_state_dump) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gaudi_fill_sobs_from_mon(sobs: *mut c_char, mon: *mut hl_mon_state_dump) {
    static void gaudi_fill_sobs_from_mon(char *sobs, struct hl_mon_state_dump *mon)
    {
    let mut max_write: usize = 10;
    u32 gid, mask, sob;
    int i, offset;
...
#[no_mangle]
unsafe extern "C" fn gaudi_state_dump_init(hdev: *mut hl_device) {
...
#[no_mangle]
unsafe extern "C" fn gaudi_set_dram_properties(hdev: *mut hl_device) -> c_int {
    static int gaudi_set_dram_properties(struct hl_device *hdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gaudi_set_binning_masks(hdev: *mut hl_device) -> c_int {
    static int gaudi_set_binning_masks(struct hl_device *hdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gaudi_check_if_razwi_happened(hdev: *mut hl_device) {
    static void gaudi_check_if_razwi_happened(struct hl_device *hdev)
    {
    }
#[no_mangle]
unsafe extern "C" fn infineon_ver_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn gaudi_send_device_activity(hdev: *mut hl_device, open: bool) -> c_int {
    ...
    .mmu_prefetch_cache_range = core::ptr::null_mut(),
    ...
    .pb_print_security_errors = core::ptr::null_mut(),
    .collective_wait_init_cs = gaudi_collective_wait_init_cs,
    .collective_wait_create_jobs = gaudi_collective_wait_create_jobs,
    .get_dec_base_addr = core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn gaudi_set_asic_funcs(hdev: *mut hl_device) {
