...
//! Source: drivers/accel/qaic/qaic_drv.c
#![no_std]
...
pub const PCI_DEVICE_ID_QCOM_AIC080: c_uint = 0xa080;
pub const PCI_DEVICE_ID_QCOM_AIC100: c_uint = 0xa100;
pub const PCI_DEVICE_ID_QCOM_AIC200: c_uint = 0xa110;

pub const CNTL_MAJOR: c_int = 5;
pub const CNTL_MINOR: c_int = 0;
pub const DBC_NUM: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qaic_device_config {
...
// An index value used to identify the MHI controller BAR
    pub mhi_bar_idx: c_uint,
// An index value used to identify the DBCs BAR
    pub dbc_bar_idx: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn qaicm_wq_release(dev: *mut drm_device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qaicm_srcu_release(dev: *mut drm_device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qaicm_srcu_init(dev: *mut drm_device, lock: *mut srcu_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qaicm_pci_release(dev: *mut drm_device, res: *mut c_void) {
    static void qaicm_pci_release(struct drm_device *dev, void *res)
    {
    struct qaic_device *qdev = to_qaic_device(dev);
    pci_set_drvdata(qdev.pdev, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn free_usr(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn qaic_open(dev: *mut drm_device, file: *mut drm_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qaic_postclose(dev: *mut drm_device, file: *mut drm_file) {
    ...
    file.driver_priv = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn qaic_create_drm_device(qdev: *mut qaic_device, partition_id: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qaic_destroy_drm_device(qdev: *mut qaic_device, partition_id: i32) {
...
#[no_mangle]
unsafe extern "C" fn qaic_mhi_probe(mhi_dev: *mut mhi_device, id: *const mhi_device_id) -> c_int {
    static int qaic_mhi_probe(struct mhi_device *mhi_dev, const struct mhi_device_id *id)
    {
    let mut major: u16 = -1, minor = -1;
    struct qaic_device *qdev;
    int ret;
//
...
//
    ...
    ret = get_cntl_version(qdev, core::ptr::null_mut(), &major, &minor);
...
#[no_mangle]
unsafe extern "C" fn qaic_mhi_remove(mhi_dev: *mut mhi_device) {
    static void qaic_mhi_remove(struct mhi_device *mhi_dev)
    {
// This is redundant since we have already observed the device crash
    }
#[no_mangle]
unsafe extern "C" fn qaic_notify_reset(qdev: *mut qaic_device) {
...
#[no_mangle]
pub unsafe extern "C" fn qaic_dev_reset_clean_local_state(qdev: *mut qaic_device) {
...
// start tearing things down
    ...
    if (ret)
    return core::ptr::null_mut();
    ret = drmm_add_action_or_reset(drm, qaicm_pci_release, core::ptr::null_mut());
    if (ret)
    return core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn init_msi(qdev: *mut qaic_device, pdev: *mut pci_dev) -> c_int {
    static int init_msi(struct qaic_device *qdev, struct pci_dev *pdev)
    {
    let mut irq_count: c_int = qdev.num_dbc + 1;
    int mhi_irq;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn qaic_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qaic_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qaic_pci_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qaic_pci_error_detected(pdev: *mut pci_dev, error: pci_channel_state_t) -> pci_ers_result_t {
    static pci_ers_result_t qaic_pci_error_detected(struct pci_dev *pdev, pci_channel_state_t error)
    {
    return PCI_ERS_RESULT_NEED_RESET;
    }
#[no_mangle]
unsafe extern "C" fn qaic_pci_reset_prepare(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qaic_pci_reset_done(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qaic_is_under_reset(qdev: *mut qaic_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qaic_data_path_busy(qdev: *mut qaic_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qaic_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qaic_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qaic_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qaic_exit() -> void __exit {
