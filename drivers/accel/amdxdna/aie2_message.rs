...
//! Source: drivers/accel/amdxdna/aie2_message.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn aie2_suspend_fw(ndev: *mut amdxdna_dev_hdl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_resume_fw(ndev: *mut amdxdna_dev_hdl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_set_runtime_cfg(ndev: *mut amdxdna_dev_hdl, type: u32, value: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_get_runtime_cfg(ndev: *mut amdxdna_dev_hdl, type: u32, value: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_assign_mgmt_pasid(ndev: *mut amdxdna_dev_hdl, pasid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aie2_destroy_context_req(ndev: *mut amdxdna_dev_hdl, id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_create_context(ndev: *mut amdxdna_dev_hdl, hwctx: *mut amdxdna_hwctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_destroy_context(ndev: *mut amdxdna_dev_hdl, hwctx: *mut amdxdna_hwctx) -> c_int {
    ...
    hwctx.priv.mbox_chann = core::ptr::null_mut();
    hwctx.fw_ctx_id = -1;
    ndev.hwctx_num--;
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn aie2_map_host_buf(ndev: *mut amdxdna_dev_hdl, context_id: u32, addr: u64, size: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_add_host_buf(ndev: *mut amdxdna_dev_hdl, context_id: u32, addr: u64, size: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amdxdna_hwctx_col_map(hwctx: *mut amdxdna_hwctx, arg: *mut c_void) -> c_int {
...
// cols_filled = aie_bitmap;
    ...
    {
    let mut req: async_event_msg_req = { 0 };
    ...
    let mut shift: u32 = xdna.dev_info.dev_mem_buf_shift;
    let mut req: config_cu_req = { 0 };
    struct xdna_mailbox_msg msg;
...
#[no_mangle]
unsafe extern "C" fn aie2_init_exec_chain_req(req: *mut c_void, slot_addr: u64, size: usize, cmd_cnt: u32) {
...
#[no_mangle]
unsafe extern "C" fn aie2_init_npu_chain_req(req: *mut c_void, slot_addr: u64, size: usize, cmd_cnt: u32) {
...
#[no_mangle]
unsafe extern "C" fn aie2_cmdlist_unsupp(cmd_bo: *mut amdxdna_gem_obj, slot: *mut c_void, size: *mut usize) -> c_int {
    static int aie2_cmdlist_unsupp(struct amdxdna_gem_obj *cmd_bo, void *slot, size_t *size)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn aie2_get_chain_msg_op(cmd_op: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn aie2_get_npu_chain_msg_op(cmd_op: u32) -> u32 {
...
// cmd_op = op;
#[no_mangle]
pub unsafe extern "C" fn if(cmd_op: *mut op !=) -> else {
    else if (op != *cmd_op)
    return -EINVAL;
    switch (op) {
    case ERT_START_CU:
...
#[no_mangle]
pub unsafe extern "C" fn aie2_msg_init(ndev: *mut amdxdna_dev_hdl) {
    ...
    {
    let mut idx: c_int = get_job_idx(job.seq);
    ...
    op = ERT_INVALID_CMD;
    for (i = 0; i < ccnt; i++) {
    let mut boh: u32 = (u32)(payload.data[i]);
    struct amdxdna_gem_obj *abo;
...
// The offset is the accumulated total size of the cmd buffer
    ...
    struct xdna_mailbox_msg msg;
    union exec_chain_req req;
    let mut op: u32 = ERT_INVALID_CMD;
    size_t size;
    int ret;
    if (!cmd_buf)
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn aie2_update_prop_time_quota(ndev: *mut amdxdna_dev_hdl, us: u32) -> c_int {
    int aie2_update_prop_time_quota(struct amdxdna_dev_hdl *ndev, u32 us)
    {
    struct amdxdna_dev *xdna = ndev.aie.xdna;
    int ret;
    ret = aie2_runtime_update_ctx_prop(ndev, core::ptr::null_mut(), UPDATE_PROPERTY_TIME_QUOTA, us);
    if (ret == -EOPNOTSUPP) {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_get_dev_revision(ndev: *mut amdxdna_dev_hdl, rev: *mut enum aie2_dev_revision) -> c_int {
