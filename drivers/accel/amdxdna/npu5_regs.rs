...
//! Source: drivers/accel/amdxdna/npu5_regs.c
#![no_std]
...
pub const NPU5_REG_BAR_INDEX: c_int = 0;
pub const NPU5_MBOX_BAR_INDEX: c_int = 0;
pub const NPU5_PSP_BAR_INDEX: c_int = 4;
pub const NPU5_SMU_BAR_INDEX: c_int = 5;
pub const NPU5_SRAM_BAR_INDEX: c_int = 2;
