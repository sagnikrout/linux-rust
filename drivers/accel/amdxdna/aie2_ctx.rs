...
//! Source: drivers/accel/amdxdna/aie2_ctx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aie2_ctx_health {
    pub header: amdxdna_ctx_health,
    pub txn_op_idx: u32,
    pub ctx_pc: u32,
...
#[no_mangle]
pub unsafe extern "C" fn aie2_tdr_signal(xdna: *mut amdxdna_dev) {
    static inline void aie2_tdr_signal(struct amdxdna_dev *xdna)
    {
    WRITE_ONCE(xdna.dev_handle.last_signal_ts, jiffies);
    }
#[no_mangle]
unsafe extern "C" fn aie2_tdr_detect(xdna: *mut amdxdna_dev) -> bool {
    static bool aie2_tdr_detect(struct amdxdna_dev *xdna)
    {
    struct amdxdna_dev_hdl *ndev = xdna.dev_handle;
    let mut last: c_ulong = READ_ONCE(ndev.last_signal_ts);
    if (!tdr_timeout_ms)
    return false;
...
#[no_mangle]
unsafe extern "C" fn aie2_cmd_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn aie2_cmd_put(drv_cmd: *mut amdxdna_drv_cmd) {
    static void aie2_cmd_put(struct amdxdna_drv_cmd *drv_cmd)
    {
    kref_put(&drv_cmd.refcnt, aie2_cmd_release);
    }
#[no_mangle]
unsafe extern "C" fn aie2_job_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn aie2_job_put(job: *mut amdxdna_sched_job) {
...
#[no_mangle]
unsafe extern "C" fn aie2_hwctx_restart(xdna: *mut amdxdna_dev, hwctx: *mut amdxdna_hwctx) -> c_int {
    ...
    {
    struct dma_fence *fence, *out_fence = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn aie2_hwctx_wait_for_idle(hwctx: *mut amdxdna_hwctx) {
...
#[no_mangle]
unsafe extern "C" fn aie2_hwctx_suspend_cb(hwctx: *mut amdxdna_hwctx, arg: *mut c_void) -> c_int {
    static int aie2_hwctx_suspend_cb(struct amdxdna_hwctx *hwctx, void *arg)
    {
    struct amdxdna_dev *xdna = hwctx.client.xdna;
    aie2_hwctx_wait_for_idle(hwctx);
    aie2_hwctx_stop(xdna, hwctx, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn aie2_hwctx_suspend(client: *mut amdxdna_client) {
...
//
    ...
    amdxdna_hwctx_walk(client, core::ptr::null_mut(), aie2_hwctx_suspend_cb);
    }
#[no_mangle]
unsafe extern "C" fn aie2_hwctx_resume_cb(hwctx: *mut amdxdna_hwctx, arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_hwctx_resume(client: *mut amdxdna_client) -> c_int {
...
//
    return amdxdna_hwctx_walk(client, core::ptr::null_mut(), aie2_hwctx_resume_cb);
    }
    static void
...
unsafe extern "C" fn aie2_set_cmd_timeout(job: *mut amdxdna_sched_job) {
    ...
    amdxdna_cmd_set_error(cmd_abo, job, 0, ERT_CMD_STATE_ABORT, core::ptr::null_mut(), 0);
    ret = -EINVAL;
    goto out;
    }
    status = readl(data);
    ...
    amdxdna_cmd_set_error(cmd_abo, job, 0, ERT_CMD_STATE_ERROR, core::ptr::null_mut(), 0);
    out:
...
// Slow path to handle error, read from ringbuf on BAR
    ...
    amdxdna_cmd_set_error(cmd_abo, job, fail_cmd_idx, ERT_CMD_STATE_ABORT, core::ptr::null_mut(), 0);
    ret = -EINVAL;
    } else {
    amdxdna_cmd_set_error(cmd_abo, job, fail_cmd_idx, ERT_CMD_STATE_ERROR, core::ptr::null_mut(), 0);
    }
    out:
    aie2_sched_notify(job);
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: force_cmdlist) -> else {
...
#[no_mangle]
unsafe extern "C" fn aie2_sched_job_free(sched_job: *mut drm_sched_job) {
...
#[no_mangle]
unsafe extern "C" fn aie2_hwctx_col_list(hwctx: *mut amdxdna_hwctx) -> c_int {
    static int aie2_hwctx_col_list(struct amdxdna_hwctx *hwctx)
    {
    struct amdxdna_dev *xdna = hwctx.client.xdna;
    struct amdxdna_dev_hdl *ndev;
    int start, end, first, last;
    let mut width: u32 = 1, entries = 0;
    int i;
    if (!hwctx.num_tiles) {
...
#[no_mangle]
unsafe extern "C" fn aie2_alloc_resource(hwctx: *mut amdxdna_hwctx) -> c_int {
    static int aie2_alloc_resource(struct amdxdna_hwctx *hwctx)
    {
    struct amdxdna_dev *xdna = hwctx.client.xdna;
    struct alloc_requests *xrs_req;
    let mut temporal_only_col: u32 = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn aie2_release_resource(hwctx: *mut amdxdna_hwctx) {
...
#[no_mangle]
unsafe extern "C" fn aie2_ctx_syncobj_create(hwctx: *mut amdxdna_hwctx) -> c_int {
    ...
    ret = drm_syncobj_create(&syncobj, 0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn aie2_ctx_syncobj_destroy(hwctx: *mut amdxdna_hwctx) {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_hwctx_init(hwctx: *mut amdxdna_hwctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_hwctx_fini(hwctx: *mut amdxdna_hwctx) {
...
// Request fw to destroy hwctx and cancel the rest pending requests
    drm_sched_stop(&hwctx.priv.sched, core::ptr::null_mut());
    aie2_release_resource(hwctx);
    drm_sched_start(&hwctx.priv.sched, 0);
...
#[no_mangle]
unsafe extern "C" fn aie2_config_cu_resp_handler(handle: *mut c_void, data: *mut void __iomem, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aie2_hwctx_cu_config(hwctx: *mut amdxdna_hwctx, buf: *mut c_void, size: u32) -> c_int {
    ...
    free_cus:
    kfree(hwctx.cus);
    hwctx.cus = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn aie2_cmd_wait(hwctx: *mut amdxdna_hwctx, seq: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_hwctx_config(hwctx: *mut amdxdna_hwctx, type: u32, value: u64, buf: *mut c_void, size: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aie2_hwctx_sync_debug_bo(hwctx: *mut amdxdna_hwctx, debug_bo_hdl: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aie2_populate_range(abo: *mut amdxdna_gem_obj) -> c_int {
...
//
    ...
    amdxdna_umap_put(mapp);
    mmput(mm);
    let mut ret: return = = -EBUSY ? -ETIME : ret;
    }
#[no_mangle]
pub unsafe extern "C" fn aie2_cmd_submit(hwctx: *mut amdxdna_hwctx, job: *mut amdxdna_sched_job, seq: *mut u64) -> c_int {
