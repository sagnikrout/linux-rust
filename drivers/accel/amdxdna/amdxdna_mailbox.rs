...
//! Source: drivers/accel/amdxdna/amdxdna_mailbox.h
#![no_std]
...
pub struct xdna_mailbox_msg {
    ...
    pub size): *mut *mut *mut *mut int (notify_cb)(void handle, void __iomem data, size_t,
...
pub struct xdna_mailbox_res {
    pub ringbuf_base: *mut void __iomem,
