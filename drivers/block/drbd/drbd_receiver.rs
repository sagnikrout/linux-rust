...
//! Source: drivers/block/drbd/drbd_receiver.c
#![no_std]
...
pub struct packet_info {
    ...
    struct page *tmp = core::ptr::null_mut();
    let mut i: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn drbd_free_pages(device: *mut drbd_device, page: *mut page) {
...
// trim: payload_size == 0
    ...
    struct page *page = core::ptr::null_mut();
    let mut nr_pages: c_uint = PFN_UP(payload_size);
...
#[no_mangle]
pub unsafe extern "C" fn drbd_free_peer_req(device: *mut drbd_device, peer_req: *mut drbd_peer_request) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_free_peer_reqs(device: *mut drbd_device, list: *mut list_head) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drbd_finish_peer_reqs(device: *mut drbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drbd_recv_short(sock: *mut socket, buf: *mut c_void, size: usize, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drbd_recv(connection: *mut drbd_connection, buf: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(-ERESTARTSYS: rv !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn drbd_recv_all(connection: *mut drbd_connection, buf: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drbd_recv_all_warn(connection: *mut drbd_connection, buf: *mut c_void, size: usize) -> c_int {
...
// open coded SO_SNDBUF, SO_RCVBUF
    ...
    let mut disconnect_on_error: c_int = 1;
    rcu_read_lock();
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct accept_wait_data {
    pub connection: *mut drbd_connection,
    pub s_listen: *mut socket,
    pub door_bell: completion,
    pub sk): *mut *mut void (original_sk_state_change)(struct sock,
}

#[no_mangle]
unsafe extern "C" fn drbd_incoming_connection(sk: *mut sock) {
...
#[no_mangle]
unsafe extern "C" fn prepare_listen_socket(connection: *mut drbd_connection, ad: *mut accept_wait_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unregister_state_change(sk: *mut sock, ad: *mut accept_wait_data) {
    ...
    struct socket *s_estab = core::ptr::null_mut();
    struct net_conf *nc;
    rcu_read_lock();
    nc = rcu_dereference(connection.net_conf);
    if (!nc) {
...
// 28.5% random jitter
    ...
    return -EIO;
    return conn_send_command(connection, sock, cmd, 0, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn receive_first_packet(connection: *mut drbd_connection, sock: *mut socket) -> c_int {
    static int receive_first_packet(struct drbd_connection *connection, struct socket *sock)
    {
    let mut header_size: c_uint = drbd_header_size(connection);
...
//
#[no_mangle]
unsafe extern "C" fn drbd_socket_okay(sock: *mut socket) -> bool {
...
// Gets called if a connection is established, or if a new minor gets created
    in a connection */
#[no_mangle]
pub unsafe extern "C" fn drbd_connected(peer_device: *mut drbd_peer_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn conn_connect(connection: *mut drbd_connection) -> c_int {
    ...
    sock.socket = core::ptr::null_mut();
    mutex_init(&msock.mutex);
    msock.sbuf = connection.meta.sbuf;
    msock.rbuf = connection.meta.rbuf;
    msock.socket = core::ptr::null_mut();
// Assume that the peer only understands protocol 80 until we know better.
    ...
    if (s) {
    let mut fp: c_int = receive_first_packet(connection, s);
...
#[no_mangle]
unsafe extern "C" fn decode_header(connection: *mut drbd_connection, header: *mut c_void, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drbd_unplug_all_devices(connection: *mut drbd_connection) {
...
#[no_mangle]
unsafe extern "C" fn drbd_recv_header(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drbd_recv_header_maybe_unplug(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    static int drbd_recv_header_maybe_unplug(struct drbd_connection *connection, struct packet_info *pi)
    {
    void *buffer = connection.data.rbuf;
    let mut size: c_uint = drbd_header_size(connection);
    int err;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct issue_flush_context {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct one_flush_context {
    pub device: *mut drbd_device,
    pub ctx: *mut issue_flush_context,
}

#[no_mangle]
unsafe extern "C" fn one_flush_endio(bio: *mut bio) {
...
#[no_mangle]
unsafe extern "C" fn submit_one_flush(device: *mut drbd_device, ctx: *mut issue_flush_context) {
...
#[no_mangle]
unsafe extern "C" fn drbd_flush(connection: *mut drbd_connection) {
...
// Any error is already reported by bio_endio callback.
    drbd_bump_write_ordering(connection.resource, core::ptr::null_mut(), WO_DRAIN_IO);
    }
    }
    }
//
...
//
    ...
    let mut rv: enum finish_epoch = FE_STILL_LIVE;
    spin_lock(&connection.epoch_lock);
    do {
    next_epoch = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn drbd_issue_discard_or_zero_out(device: *mut drbd_device, start: sector_t, nr_sectors: c_uint, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn can_do_reliable_discards(device: *mut drbd_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn drbd_issue_peer_discard_or_zero_out(device: *mut drbd_device, peer_req: *mut drbd_peer_request) {
...
#[no_mangle]
unsafe extern "C" fn peer_request_fault_type(peer_req: *mut drbd_peer_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_submit_peer_request(peer_req: *mut drbd_peer_request) -> c_int {
    int drbd_submit_peer_request(struct drbd_peer_request *peer_req)
    {
    struct drbd_device *device = peer_req.peer_device.device;
    struct bio *bios = core::ptr::null_mut();
    struct bio *bio;
    struct page *page = peer_req.pages;
    let mut sector: sector_t = peer_req.i.sector;
    let mut data_size: c_uint = peer_req.i.size;
    let mut n_bios: c_uint = 0;
    let mut nr_pages: c_uint = PFN_UP(data_size);
...
// > peer_req->i.sector, unless this is the first bio
    ...
    let mut len: unsigned = min_t(unsigned, data_size, PAGE_SIZE);
    ...
    D_ASSERT(device, page == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn conn_wait_active_ee_empty(connection: *mut drbd_connection) {
    static void conn_wait_active_ee_empty(struct drbd_connection *connection)
    {
    struct drbd_peer_device *peer_device;
    int vnr;
...
#[no_mangle]
unsafe extern "C" fn receive_Barrier(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
//
    ...
    {
    struct drbd_device *device = peer_device.device;
    let mut capacity: sector_t = get_capacity(device.vdisk);
    struct drbd_peer_request *peer_req;
    struct page *page;
    int digest_size, err;
    let mut data_size: c_uint = pi.size, ds;
    void *dig_in = peer_device.connection.int_dig_in;
    void *dig_vv = peer_device.connection.int_dig_vv;
    unsigned long *data;
    struct p_trim *trim = (pi.cmd == P_TRIM) ? pi.data : core::ptr::null_mut();
    struct p_trim *zeroes = (pi.cmd == P_ZEROES) ? pi.data : core::ptr::null_mut();
    digest_size = 0;
...
// receive payload size bytes into page chain
    ...
    page = peer_req.pages;
    page_chain_for_each(page) {
    let mut len: unsigned = min_t(int, ds, PAGE_SIZE);
...
//
#[no_mangle]
unsafe extern "C" fn drbd_drain_block(peer_device: *mut drbd_peer_device, data_size: c_int) -> c_int {
    ...
    data = kmap_local_page(page);
    while (data_size) {
    let mut len: c_uint = min_t(int, data_size, PAGE_SIZE);
    err = drbd_recv_all_warn(peer_device.connection, data, len);
    if (err)
    break;
    data_size -= len;
...
//
#[no_mangle]
unsafe extern "C" fn e_end_resync_block(w: *mut drbd_work, unused: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_DataReply(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_RSDataReply(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
// be queued on the retry workqueue.
    __req_mod(req, CONFLICT_RESOLVED, core::ptr::null_mut(), core::ptr::null_mut());
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn e_end_block(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e_send_ack(w: *mut drbd_work, ack: enum drbd_packet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e_send_superseded(w: *mut drbd_work, unused: c_int) -> c_int {
    static int e_send_superseded(struct drbd_work *w, int unused)
    {
    return e_send_ack(w, P_SUPERSEDED);
    }
#[no_mangle]
unsafe extern "C" fn e_send_retry_write(w: *mut drbd_work, unused: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn seq_greater(a: u32, b: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn seq_max(a: u32, b: u32) -> u32 {
    static u32 seq_max(u32 a, u32 b)
    {
    return seq_greater(a, b) ? a : b;
    }
#[no_mangle]
unsafe extern "C" fn update_peer_seq(peer_device: *mut drbd_peer_device, peer_seq: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn overlaps(s1: sector_t, l1: c_int, s2: sector_t, l2: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn overlapping_resync_write(device: *mut drbd_device, peer_req: *mut drbd_peer_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wait_for_and_update_peer_seq(peer_device: *mut drbd_peer_device, peer_seq: u32) -> c_int {
    static int wait_for_and_update_peer_seq(struct drbd_peer_device *peer_device, const u32 peer_seq)
    {
    struct drbd_device *device = peer_device.device;
    DEFINE_WAIT(wait);
    long timeout;
    let mut ret: c_int = 0, tp;
    if (!test_bit(RESOLVE_CONFLICTS, &peer_device.connection.flags))
    return 0;
    spin_lock(&device.peer_seq_lock);
    for (;;) {
...
#[no_mangle]
unsafe extern "C" fn wire_flags_to_bio_op(dpf: u32) -> enum req_op {
...
#[no_mangle]
unsafe extern "C" fn wire_flags_to_bio(connection: *mut drbd_connection, dpf: u32) -> blk_opf_t {
    ...
    {
    struct drbd_connection *connection = peer_req.peer_device.connection;
    let mut resolve_conflicts: bool = test_bit(RESOLVE_CONFLICTS, &connection.flags);
    let mut sector: sector_t = peer_req.i.sector;
    let mut size: c_uint = peer_req.i.size;
    struct drbd_interval *i;
    bool equal;
    int err;
//
...
// mirrored write
#[no_mangle]
unsafe extern "C" fn receive_Data(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    ...
    struct drbd_peer_request *peer_req;
    struct p_data *p = pi.data;
    let mut peer_seq: u32 = be32_to_cpu(p.seq_num);
    u32 dp_flags;
    int err, tp;
    peer_device = conn_peer_device(connection, pi.vnr);
    if (!peer_device)
...
//
    ...
    D_ASSERT(peer_device, peer_req.pages == core::ptr::null_mut());
...
// Do (not) pass down BLKDEV_ZERO_NOUNMAP?
    ...
    peer_req.flags |= EE_TRIM;
    } else if (peer_req.pages == core::ptr::null_mut()) {
...
//
    ...
    let mut throttle: bool = drbd_rs_c_min_rate_throttle(device);
...
#[no_mangle]
pub unsafe extern "C" fn drbd_rs_c_min_rate_throttle(device: *mut drbd_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn receive_DataRequest(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    ...
    sector_t capacity;
    struct drbd_peer_request *peer_req;
    struct digest_info *di = core::ptr::null_mut();
    int size, verb;
...
//
#[no_mangle]
unsafe extern "C" fn drbd_asb_recover_0p(__must_hold(local: *mut *mut drbd_peer_device peer_device)) -> c_int {
...
// Else fall through to one of the other strategies...
    ...
    rv = -1;
#[no_mangle]
pub unsafe extern "C" fn if(ch_peer: ch_self >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn drbd_asb_recover_1p(__must_hold(local: *mut *mut drbd_peer_device peer_device)) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drbd_asb_recover_2p(__must_hold(local: *mut *mut drbd_peer_device peer_device)) -> c_int {
...
//
    ...
    {
    let mut connection: *mut drbd_connection const = peer_device.connection;
    struct drbd_device *device = peer_device.device;
    u64 self, peer;
    int i, j;
...
//
    ...
    {
    struct drbd_device *device = peer_device.device;
    let mut rv: enum drbd_conns = C_MASK;
    ...
    let mut f: c_int = (hg == -100) || abs(hg) == 2;
...
#[no_mangle]
unsafe extern "C" fn convert_after_sb(peer: enum drbd_after_sb_p) -> enum drbd_after_sb_p {
...
#[no_mangle]
unsafe extern "C" fn receive_protocol(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    static int receive_protocol(struct drbd_connection *connection, struct packet_info *pi)
    {
    struct p_protocol *p = pi.data;
    enum drbd_after_sb_p p_after_sb_0p, p_after_sb_1p, p_after_sb_2p;
    int p_proto, p_discard_my_data, p_two_primaries, cf;
    struct net_conf *nc, *old_net_conf, *new_net_conf = core::ptr::null_mut();
    char integrity_alg[SHARED_SECRET_MAX] = "";
    struct crypto_shash *peer_integrity_tfm = core::ptr::null_mut();
    void *int_dig_in = core::ptr::null_mut(), *int_dig_vv = core::ptr::null_mut();
...
//
    ...
    peer_integrity_tfm = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ignore_remaining_packet(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    static int ignore_remaining_packet(struct drbd_connection *connection, struct packet_info *pi)
    {
    void *buffer = connection.data.rbuf;
    let mut size: c_int = pi.size;
    while (size) {
    let mut s: c_int = min_t(int, size, DRBD_SOCKET_BUFFER_SIZE);
...
//
#[no_mangle]
unsafe extern "C" fn config_unknown_volume(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_SyncParam(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    ...
    struct crypto_shash *verify_tfm = core::ptr::null_mut();
    struct crypto_shash *csums_tfm = core::ptr::null_mut();
    struct net_conf *old_net_conf, *new_net_conf = core::ptr::null_mut();
    struct disk_conf *old_disk_conf = core::ptr::null_mut(), *new_disk_conf = core::ptr::null_mut();
    let mut apv: c_int = connection.agreed_pro_version;
    struct fifo_buffer *old_plan = core::ptr::null_mut(), *new_plan = core::ptr::null_mut();
    let mut fifo_size: c_uint = 0;
    int err;
    peer_device = conn_peer_device(connection, pi.vnr);
    if (!peer_device)
...
#[no_mangle]
unsafe extern "C" fn receive_sizes(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    static int receive_sizes(struct drbd_connection *connection, struct packet_info *pi)
    {
    struct drbd_peer_device *peer_device;
    struct drbd_device *device;
    struct p_sizes *p = pi.data;
    struct o_qlim *o = (connection.agreed_features & DRBD_FF_WSAME) ? p.qlim : core::ptr::null_mut();
    let mut dd: enum determine_dev_size = DS_UNCHANGED;
...
// Leave drbd_reconsider_queue_parameters() before drbd_determine_dev_size().
    ...
    dd = drbd_determine_dev_size(device, ddsf, core::ptr::null_mut());
    put_ldev(device);
    if (dd == DS_ERROR)
    return -EIO;
    drbd_md_sync(device);
...
//
    let mut new_size: sector_t = p_csize ?: p_usize ?: p_size;
    drbd_reconsider_queue_parameters(device, core::ptr::null_mut(), o);
    if (new_size == 0) {
...
#[no_mangle]
unsafe extern "C" fn receive_uuids(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    ...
    BM_LOCKED_TEST_ALLOWED, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn convert_state(ps: union drbd_state) -> union drbd_state {
...
#[no_mangle]
unsafe extern "C" fn receive_req_state(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_req_conn_state(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_state(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
// Do not allow tl_restart(RESEND) for a rebooted peer. We can only allow this
    ...
    rv = _drbd_set_state(device, ns, cs_flags, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn receive_sync_uuid(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
//
    ...
    let mut want: c_uint = num_words * sizeof(*p);
    int err;
    if (want != size) {
...
#[no_mangle]
unsafe extern "C" fn dcbp_get_code(p: *mut p_compressed_bm) -> enum drbd_bitmap_code {
    static enum drbd_bitmap_code dcbp_get_code(struct p_compressed_bm *p)
    {
    return (enum drbd_bitmap_code)(p.encoding & 0x0f);
    }
#[no_mangle]
unsafe extern "C" fn dcbp_get_start(p: *mut p_compressed_bm) -> c_int {
    static int dcbp_get_start(struct p_compressed_bm *p)
    {
    return (p.encoding & 0x80) != 0;
    }
#[no_mangle]
unsafe extern "C" fn dcbp_get_pad_bits(p: *mut p_compressed_bm) -> c_int {
...
//
    ...
    u64 rl;
    u64 tmp;
    let mut s: c_ulong = c.bit_offset;
    unsigned long e;
    let mut toggle: c_int = dcbp_get_start(p);
    int have;
    int bits;
...
// what would it take to transfer it "plaintext"
    ...
    let mut data_size: c_uint = DRBD_SOCKET_BUFFER_SIZE - header_size;
    unsigned int plain =
    header_size * (DIV_ROUND_UP(c.bm_words, data_size) + 1) +
    c.bm_words * sizeof(unsigned long);
    let mut total: c_uint = c.bytes[0] + c.bytes[1];
    unsigned int r;
...
#[no_mangle]
unsafe extern "C" fn receive_bitmap(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(P_COMPRESSED_BITMAP: pi->cmd ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn receive_skip(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_UnplugRemote(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_out_of_sync(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn receive_rs_deallocated(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[derive(Copy, Clone)]
pub struct data_cmd {
    pub expect_payload: c_int,
    pub pkt_size: c_uint,
    pub ): *mut *mut *mut int (fn)(struct drbd_connection , struct packet_info,
}
...
#[no_mangle]
unsafe extern "C" fn drbdd(connection: *mut drbd_connection) {
...
#[no_mangle]
unsafe extern "C" fn conn_disconnect(connection: *mut drbd_connection) {
...
// ack_receiver does not clean up anything. it must not interfere, either
    ...
    connection.ack_sender = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn drbd_disconnected(peer_device: *mut drbd_peer_device) -> c_int {
...
// again via drbd_try_clear_on_disk_bm().
    drbd_rs_cancel_all(device);
    kfree(device.p_uuid);
    device.p_uuid = core::ptr::null_mut();
    if (!drbd_suspended(device))
    tl_clear(peer_device.connection);
    drbd_md_sync(device);
    if (get_ldev(device)) {
    drbd_bitmap_io(device, &drbd_bm_write_copy_pages,
    "write from disconnected", BM_LOCKED_CHANGE_ALLOWED, core::ptr::null_mut());
    put_ldev(device);
    }
...
//
#[no_mangle]
unsafe extern "C" fn drbd_send_features(connection: *mut drbd_connection) -> c_int {
    ...
    return conn_send_command(connection, sock, P_CONNECTION_FEATURES, sizeof(*p), core::ptr::null_mut(), 0);
    }
//
// return values:
// 1 yes, we have a valid connection
...
//
#[no_mangle]
unsafe extern "C" fn drbd_do_features(connection: *mut drbd_connection) -> c_int {
    static int drbd_do_features(struct drbd_connection *connection)
    {
// ASSERT current == connection->receiver ...
    struct p_connection_features *p;
    let mut expect: c_int = sizeof(struct p_connection_features);
    struct packet_info pi;
    int err;
...
#[no_mangle]
unsafe extern "C" fn drbd_do_auth(connection: *mut drbd_connection) -> c_int {
    static int drbd_do_auth(struct drbd_connection *connection)
    {
...
pub const CHALLENGE_LEN: c_int = 64;
// Return value:
    1 - auth succeeded,
...
unsafe extern "C" fn drbd_do_auth(connection: *mut drbd_connection) -> c_int {
    ...
    char *response = core::ptr::null_mut();
    char *right_response = core::ptr::null_mut();
    char *peers_ch = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn drbd_receiver(thi: *mut drbd_thread) -> c_int {
...
// ********* acknowledge sender ********
#[no_mangle]
unsafe extern "C" fn got_conn_RqSReply(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    static int got_conn_RqSReply(struct drbd_connection *connection, struct packet_info *pi)
    {
    struct p_req_state_reply *p = pi.data;
    let mut retcode: c_int = be32_to_cpu(p.retcode);
...
#[no_mangle]
unsafe extern "C" fn got_RqSReply(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn got_Ping(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    static int got_Ping(struct drbd_connection *connection, struct packet_info *pi)
    {
    return drbd_send_ping_ack(connection);
    }
#[no_mangle]
unsafe extern "C" fn got_PingAck(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn got_IsInSync(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    static int got_IsInSync(struct drbd_connection *connection, struct packet_info *pi)
    {
    struct drbd_peer_device *peer_device;
    struct drbd_device *device;
    struct p_block_ack *p = pi.data;
    let mut sector: sector_t = be64_to_cpu(p.sector);
    let mut blksize: c_int = be32_to_cpu(p.blksize);
    peer_device = conn_peer_device(connection, pi.vnr);
    if (!peer_device)
    return -EIO;
    device = peer_device.device;
...
#[no_mangle]
unsafe extern "C" fn got_BlockAck(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn got_NegAck(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
    ...
    struct p_block_ack *p = pi.data;
    let mut sector: sector_t = be64_to_cpu(p.sector);
    let mut size: c_int = be32_to_cpu(p.blksize);
    int err;
    peer_device = conn_peer_device(connection, pi.vnr);
    if (!peer_device)
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn got_NegDReply(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn got_NegRSDReply(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn got_BarrierAck(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn got_OVResult(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn got_skip(connection: *mut drbd_connection, pi: *mut packet_info) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meta_sock_cmd {
    pub pkt_size: usize,
    pub ): *mut *mut *mut int (fn)(struct drbd_connection connection, struct packet_info,
}

#[no_mangle]
unsafe extern "C" fn set_rcvtimeo(connection: *mut drbd_connection, ping_timeout: bool) {
...
#[no_mangle]
unsafe extern "C" fn set_ping_timeout(connection: *mut drbd_connection) {
    static void set_ping_timeout(struct drbd_connection *connection)
    {
    set_rcvtimeo(connection, 1);
    }
#[no_mangle]
unsafe extern "C" fn set_idle_timeout(connection: *mut drbd_connection) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_ack_receiver(thi: *mut drbd_thread) -> c_int {
    int drbd_ack_receiver(struct drbd_thread *thi)
    {
    struct drbd_connection *connection = thi.connection;
    struct meta_sock_cmd *cmd = core::ptr::null_mut();
    struct packet_info pi;
    ...
    let mut header_size: c_uint = drbd_header_size(connection);
    let mut expect: c_int = header_size;
    let mut ping_timeout_active: bool = false;
...
// and change the rcvtimeo
    ...
    if (received == expect && cmd == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_send_acks_wf(ws: *mut work_struct) {
