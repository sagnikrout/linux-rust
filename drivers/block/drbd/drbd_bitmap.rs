...
//! Source: drivers/block/drbd/drbd_bitmap.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct drbd_bitmap {
    pub bm_pages: *mut page,
    pub bm_lock: spinlock_t,
// exclusively to be used by __al_write_transaction(),
// drbd_bm_mark_for_writeout() and
// and drbd_bm_write_hinted() -> bm_rw() called from there.
//
    pub n_bitmap_hints: c_uint,
    pub al_bitmap_hints: [c_uint; AL_UPDATES_PER_TRANSACTION],
// see LIMITATIONS: above
    pub /: *mut *mut unsigned long bm_set; / nr of set bits; THINK maybe atomic_t?,
    pub bm_bits: c_ulong,
    pub bm_words: usize,
    pub bm_number_of_pages: usize,
    pub bm_dev_capacity: sector_t,
    pub /: *mut *mut mutex bm_change; / serializes resize operations,
    pub /: *mut *mut wait_queue_head_t bm_io_wait; / used to serialize IO of single pages,
    pub bm_flags: enum bm_flag,
// debugging aid, in case we are still racy somewhere
    pub bm_why: *mut c_char,
    pub bm_task: *mut task_struct,
}

#[no_mangle]
unsafe extern "C" fn __bm_print_lock_info(device: *mut drbd_device, func: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_lock(device: *mut drbd_device, why: *mut c_char, flags: enum bm_flag) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_unlock(device: *mut drbd_device) {
    ...
    b.bm_why  = core::ptr::null_mut();
    b.bm_task = core::ptr::null_mut();
...
pub const BM_PAGE_IO_LOCK: c_int = 31;
// if there has been an IO error for this page
pub const BM_PAGE_IO_ERROR: c_int = 30;
// this is to be able to intelligently skip disk IO,
// set if bits have been set since last IO.
pub const BM_PAGE_NEED_WRITEOUT: c_int = 29;
// to mark for lazy writeout once syncer cleared all clearable bits,
// we if bits have been cleared since last IO.
pub const BM_PAGE_LAZY_WRITEOUT: c_int = 28;
// pages marked with this "HINT" will be considered for writeout
// on activity log transactions
pub const BM_PAGE_HINT_WRITEOUT: c_int = 27;
...
#[no_mangle]
unsafe extern "C" fn bm_store_page_idx(page: *mut page, idx: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn bm_page_to_idx(page: *mut page) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn bm_page_lock_io(device: *mut drbd_device, page_nr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bm_page_unlock_io(device: *mut drbd_device, page_nr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bm_set_page_unchanged(page: *mut page) {
...
#[no_mangle]
unsafe extern "C" fn bm_set_page_need_writeout(page: *mut page) {
    static void bm_set_page_need_writeout(struct page *page)
    {
    set_bit(BM_PAGE_NEED_WRITEOUT, &page_private(page));
    }
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_reset_al_hints(device: *mut drbd_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_mark_for_writeout(device: *mut drbd_device, page_nr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bm_test_page_unchanged(page: *mut page) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm_set_page_io_err(page: *mut page) {
    static void bm_set_page_io_err(struct page *page)
    {
    set_bit(BM_PAGE_IO_ERROR, &page_private(page));
    }
#[no_mangle]
unsafe extern "C" fn bm_clear_page_io_err(page: *mut page) {
    static void bm_clear_page_io_err(struct page *page)
    {
    clear_bit(BM_PAGE_IO_ERROR, &page_private(page));
    }
#[no_mangle]
unsafe extern "C" fn bm_set_page_lazy_writeout(page: *mut page) {
    static void bm_set_page_lazy_writeout(struct page *page)
    {
    set_bit(BM_PAGE_LAZY_WRITEOUT, &page_private(page));
    }
#[no_mangle]
unsafe extern "C" fn bm_test_page_lazy_writeout(page: *mut page) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm_word_to_page_idx(b: *mut drbd_bitmap, long_nr: c_ulong) -> c_uint {
    static unsigned int bm_word_to_page_idx(struct drbd_bitmap *b, unsigned long long_nr)
    {
// page_nr = (word*sizeof(long)) >> PAGE_SHIFT;
    let mut page_nr: c_uint = long_nr >> (PAGE_SHIFT - LN2_BPL + 3);
    BUG_ON(page_nr >= b.bm_number_of_pages);
    return page_nr;
    }
#[no_mangle]
unsafe extern "C" fn bm_bit_to_page_idx(b: *mut drbd_bitmap, bitnr: u64) -> c_uint {
    static unsigned int bm_bit_to_page_idx(struct drbd_bitmap *b, u64 bitnr)
    {
// page_nr = (bitnr/8) >> PAGE_SHIFT;
    let mut page_nr: c_uint = bitnr >> (PAGE_SHIFT + 3);
    BUG_ON(page_nr >= b.bm_number_of_pages);
    return page_nr;
    }
...
#[no_mangle]
unsafe extern "C" fn __bm_unmap(p_addr: *mut c_ulong) {
    static void __bm_unmap(unsigned long *p_addr)
    {
    kunmap_atomic(p_addr);
    };
#[no_mangle]
unsafe extern "C" fn bm_unmap(p_addr: *mut c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn bm_free_pages(pages: *mut page, number: c_ulong) {
    ...
    for (i = 0; i < number; i++) {
    if (!pages[i]) {
    pr_alert("bm_free_pages tried to free a core::ptr::null_mut() pointer; i=%lu n=%lu\n",
    i, number);
    continue;
    }
    __free_page(pages[i]);
...
#[no_mangle]
pub unsafe extern "C" fn bm_vk_free(ptr: *mut c_void) {
...
//
    ...
    let mut have: c_ulong = b.bm_number_of_pages;
    BUG_ON(have == 0 && old_pages != core::ptr::null_mut());
    BUG_ON(have != 0 && old_pages == core::ptr::null_mut());
    if (have == want)
    return old_pages;
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_init(device: *mut drbd_device) -> c_int {
    int drbd_bm_init(struct drbd_device *device)
    {
    struct drbd_bitmap *b = device.bitmap;
    WARN_ON(b != core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_capacity(device: *mut drbd_device) -> sector_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_cleanup(device: *mut drbd_device) {
    ...
    kfree(device.bitmap);
    device.bitmap = core::ptr::null_mut();
    }
//
...
#[no_mangle]
unsafe extern "C" fn bm_clear_surplus(b: *mut drbd_bitmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bm_set_surplus(b: *mut drbd_bitmap) {
...
#[no_mangle]
unsafe extern "C" fn bm_count_bits(b: *mut drbd_bitmap) -> c_ulong {
    static unsigned long bm_count_bits(struct drbd_bitmap *b)
    {
    unsigned long *p_addr;
    let mut bits: c_ulong = 0;
    let mut mask: c_ulong = (1UL << (b.bm_bits & BITS_PER_LONG_MASK)) -1;
    int idx, last_word;
// all but last page
...
#[no_mangle]
unsafe extern "C" fn bm_memset(b: *mut drbd_bitmap, offset: usize, c: c_int, len: usize) {
...
#[no_mangle]
unsafe extern "C" fn drbd_md_on_disk_bits(ldev: *mut drbd_backing_dev) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_resize(device: *mut drbd_device, capacity: sector_t, set_new_bits: c_int) -> c_int {
    int drbd_bm_resize(struct drbd_device *device, sector_t capacity, int set_new_bits)
    {
    struct drbd_bitmap *b = device.bitmap;
    unsigned long bits, words, owords, obits;
    unsigned long want, have, onpages; /* number of pages */
    struct page **npages, **opages = core::ptr::null_mut();
    let mut err: c_int = 0;
    bool growing;
    if (!expect(device, b))
    return -ENOMEM;
...
//
    ...
    if (get_ldev(device)) {
    let mut bits_on_disk: u64 = drbd_md_on_disk_bits(device.ldev);
    put_ldev(device);
    ...
    if (want == have) {
    D_ASSERT(device, b.bm_pages != core::ptr::null_mut());
    npages = b.bm_pages;
    } else {
    if (drbd_insert_fault(device, DRBD_FAULT_BM_ALLOC))
    npages = core::ptr::null_mut();
    else
...
//
#[no_mangle]
pub unsafe extern "C" fn _drbd_bm_total_weight(device: *mut drbd_device) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_total_weight(device: *mut drbd_device) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_words(device: *mut drbd_device) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_bits(device: *mut drbd_device) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_set_all(device: *mut drbd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_clear_all(device: *mut drbd_device) {
...
#[no_mangle]
unsafe extern "C" fn drbd_bm_aio_ctx_destroy(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn drbd_bm_endio(bio: *mut bio) {
    static void drbd_bm_endio(struct bio *bio)
    {
    struct drbd_bm_aio_ctx *ctx = bio.bi_private;
    struct drbd_device *device = ctx.device;
    struct drbd_bitmap *b = device.bitmap;
    let mut idx: c_uint = bm_page_to_idx(bio_first_page_all(bio));
...
// For the layout, see comment above drbd_md_set_sector_offsets().
#[no_mangle]
pub unsafe extern "C" fn drbd_md_last_bitmap_sector(bdev: *mut drbd_backing_dev) -> sector_t {
...
#[no_mangle]
unsafe extern "C" fn bm_page_io_async(ctx: *mut drbd_bm_aio_ctx, __must_hold(local: int page_nr)) {
    static void bm_page_io_async(struct drbd_bm_aio_ctx *ctx, int page_nr) __must_hold(local)
    {
    struct drbd_device *device = ctx.device;
    let mut op: enum req_op = ctx.flags & BM_AIO_READ ? REQ_OP_READ : REQ_OP_WRITE;
    struct drbd_bitmap *b = device.bitmap;
    struct bio *bio;
    struct page *page;
...
// or with PAGE_SIZE > 4k
    ...
    let mut len_sect: sector_t = last_bm_sect - on_disk_sector + 1;
...
//
#[no_mangle]
unsafe extern "C" fn bm_rw(device: *mut drbd_device, flags: c_uint, __must_hold(local: unsigned lazy_writeout_upper_idx)) -> c_int {
...
// summary for global bitmap IO
    if (flags == 0) {
    let mut ms: c_uint = jiffies_to_msecs(jiffies - now);
    if (ms > 5) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_write_lazy(device: *mut drbd_device, __must_hold(local: unsigned upper_idx)) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_write_hinted(__must_hold(local: *mut *mut drbd_device device)) -> c_int {
...
// bit offset of the first bit in the page
    ...
    {
    struct drbd_bitmap *b = device.bitmap;
    let mut i: c_ulong = DRBD_END_OF_BITMAP;
    if (!expect(device, b))
    return i;
    if (!expect(device, b.bm_pages))
    return i;
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_find_next(device: *mut drbd_device, bm_fo: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_find_next_zero(device: *mut drbd_device, bm_fo: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn _drbd_bm_find_next(device: *mut drbd_device, bm_fo: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn _drbd_bm_find_next_zero(device: *mut drbd_device, bm_fo: c_ulong) -> c_ulong {
...
// Must hold bitmap lock already.
    ...
    {
    struct drbd_bitmap *b = device.bitmap;
    unsigned long *p_addr = core::ptr::null_mut();
    unsigned long bitnr;
    let mut last_page_nr: c_uint = -1U;
    let mut c: c_int = 0;
    let mut changed_total: c_int = 0;
    if (e >= b.bm_bits) {
    ...
    let mut page_nr: c_uint = bm_bit_to_page_idx(b, bitnr);
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_set_bits(device: *mut drbd_device, s: c_ulong, e: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_clear_bits(device: *mut drbd_device, s: c_ulong, e: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn _drbd_bm_set_bits(device: *mut drbd_device, s: c_ulong, e: c_ulong) {
...
//
    struct drbd_bitmap *b = device.bitmap;
    let mut sl: c_ulong = ALIGN(s,BITS_PER_LONG);
    let mut el: c_ulong = (e+1) & ~((unsigned long)BITS_PER_LONG-1);
    int first_page;
    int last_page;
    int page_nr;
    int first_word;
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_test_bit(device: *mut drbd_device, bitnr: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_count_bits(device: *mut drbd_device, s: c_ulong, e: c_ulong) -> c_int {
...
// local read there (no bitmap probably implies no disk)
    ...
    bm_print_lock_info(device);
    for (bitnr = s; bitnr <= e; bitnr++) {
    let mut idx: c_uint = bm_bit_to_page_idx(b, bitnr);
    if (page_nr != idx) {
    page_nr = idx;
    if (p_addr)
    bm_unmap(p_addr);
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_bm_e_weight(device: *mut drbd_device, enr: c_ulong) -> c_int {
