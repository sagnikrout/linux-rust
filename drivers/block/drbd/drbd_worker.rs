...
//! Source: drivers/block/drbd/drbd_worker.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_md_endio(bio: *mut bio) {
...
//
#[no_mangle]
unsafe extern "C" fn drbd_endio_read_sec_final(__releases(local: *mut *mut drbd_peer_request peer_req)) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_endio_write_sec_final(__releases(local: *mut *mut drbd_peer_request peer_req)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_peer_request_endio(bio: *mut bio) {
    void drbd_peer_request_endio(struct bio *bio)
    {
    struct drbd_peer_request *peer_req = bio.bi_private;
    struct drbd_device *device = peer_req.peer_device.device;
    let mut is_write: bool = bio_data_dir(bio) == WRITE;
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_request_endio(bio: *mut bio) {
...
// not req_mod(), we need irqsave here!
    spin_lock_irqsave(&device.resource.req_lock, flags);
    __req_mod(req, what, core::ptr::null_mut(), &m);
    spin_unlock_irqrestore(&device.resource.req_lock, flags);
    put_ldev(device);
    if (m.bio)
...
#[no_mangle]
pub unsafe extern "C" fn drbd_csum_ee(tfm: *mut crypto_shash, peer_req: *mut drbd_peer_request, digest: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_csum_bio(tfm: *mut crypto_shash, bio: *mut bio, digest: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn w_e_send_csum(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_for_csum(peer_device: *mut drbd_peer_device, sector: sector_t, size: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w_resync_timer(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn resync_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn fifo_set(fb: *mut fifo_buffer, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fifo_push(fb: *mut fifo_buffer, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fifo_add_val(fb: *mut fifo_buffer, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn drbd_rs_controller(peer_device: *mut drbd_peer_device, sect_in: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drbd_rs_number_requests(peer_device: *mut drbd_peer_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn make_resync_request(peer_device: *const *const drbd_peer_device, cancel: c_int) -> c_int {
    static int make_resync_request(struct drbd_peer_device *const peer_device, int cancel)
    {
    let mut device: *mut drbd_device const = peer_device.device;
    ...
    int align, requeue = 0;
    let mut i: c_int = 0;
    let mut discard_granularity: c_int = 0;
    if (unlikely(cancel))
    return 0;
...
// but notify TCP that we'd like to have more space.
    ...
    let mut queued: c_int = sk.sk_wmem_queued;
    let mut sndbuf: c_int = sk.sk_sndbuf;
    if (queued > sndbuf / 2) {
    requeue = 1;
    if (sk.sk_socket)
...
#[no_mangle]
unsafe extern "C" fn make_ov_request(peer_device: *mut drbd_peer_device, cancel: c_int) -> c_int {
    ...
    sector_t sector;
    let mut capacity: sector_t = get_capacity(device.vdisk);
    let mut stop_sector_reached: bool = false;
    if (unlikely(cancel))
    return 1;
    number = drbd_rs_number_requests(peer_device);
...
#[no_mangle]
pub unsafe extern "C" fn w_ov_finished(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w_resync_finished(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ping_peer(device: *mut drbd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_resync_finished(peer_device: *mut drbd_peer_device) -> c_int {
    ...
    struct drbd_device_work *dw;
    char *khelper_cmd = core::ptr::null_mut();
    let mut verify_done: c_int = 0;
...
// This protects us against multiple calls (that can happen in the presence
    ...
    let mut s: c_ulong = device.rs_same_csum;
    let mut t: c_ulong = device.rs_total;
    const int ratio =
    (t == 0)     ? 0 :
    ...
    drbd_err(device, "device.p_uuid is core::ptr::null_mut()! BUG\n");
    }
    }
    if (!(os.conn == C_VERIFY_S || os.conn == C_VERIFY_T)) {
...
// know of the peer.
    ...
    _drbd_set_state(device, ns, CS_VERBOSE, core::ptr::null_mut());
    out_unlock:
    spin_unlock_irq(&device.resource.req_lock);
...
// once *all* volumes are back in sync, call "unfence".
    ...
    let mut disk_state: enum drbd_disk_state = D_MASK;
    let mut pdsk_state: enum drbd_disk_state = D_MASK;
    let mut fp: enum drbd_fencing_p = FP_DONT_CARE;
    rcu_read_lock();
...
//
#[no_mangle]
pub unsafe extern "C" fn w_e_end_data_req(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn all_zero(peer_req: *mut drbd_peer_request) -> bool {
    static bool all_zero(struct drbd_peer_request *peer_req)
    {
    struct page *page = peer_req.pages;
    let mut len: c_uint = peer_req.i.size;
    page_chain_for_each(page) {
    let mut l: c_uint = min_t(unsigned int, len, PAGE_SIZE);
...
//
#[no_mangle]
pub unsafe extern "C" fn w_e_end_rsdata_req(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w_e_end_csum_rs_req(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w_e_end_ov_req(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_ov_out_of_sync_found(peer_device: *mut drbd_peer_device, sector: sector_t, size: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn w_e_end_ov_reply(w: *mut drbd_work, cancel: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drbd_send_barrier(connection: *mut drbd_connection) -> c_int {
    ...
    return conn_send_command(connection, sock, P_BARRIER, sizeof(*p), core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn pd_send_unplug_remote(pd: *mut drbd_peer_device) -> c_int {
    ...
    return -EIO;
    return drbd_send_command(pd, sock, P_UNPLUG_REMOTE, 0, core::ptr::null_mut(), 0);
    }
#[no_mangle]
pub unsafe extern "C" fn w_send_write_hint(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn re_init_if_first_write(connection: *mut drbd_connection, epoch: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn maybe_send_barrier(connection: *mut drbd_connection, epoch: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn w_send_out_of_sync(w: *mut drbd_work, cancel: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn w_send_dblock(w: *mut drbd_work, cancel: c_int) -> c_int {
    ...
    let mut peer_device: *mut drbd_peer_device const = first_peer_device(device);
    struct drbd_connection *connection = peer_device.connection;
    let mut do_send_unplug: bool = req.rq_state & RQ_UNPLUG;
    int err;
    if (unlikely(cancel)) {
    req_mod(req, SEND_CANCELED, peer_device);
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn w_send_read_req(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w_restart_disk_io(w: *mut drbd_work, cancel: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _drbd_may_sync_now(device: *mut drbd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn drbd_pause_after(device: *mut drbd_device) -> bool {
    ...
    CS_HARD, core::ptr::null_mut()) != SS_NOTHING_TO_DO)
    changed = true;
    }
    rcu_read_unlock();
    return changed;
...
//
#[no_mangle]
unsafe extern "C" fn drbd_resume_next(device: *mut drbd_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn resume_next_sg(device: *mut drbd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn suspend_other_sg(device: *mut drbd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_resync_after_valid(device: *mut drbd_device, o_minor: c_int) -> enum drbd_ret_code {
...
// caller must lock_all_resources()
#[no_mangle]
pub unsafe extern "C" fn drbd_resync_after_changed(device: *mut drbd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn drbd_rs_controller_reset(peer_device: *mut drbd_peer_device) {
...
#[no_mangle]
pub unsafe extern "C" fn start_resync_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn do_start_resync(device: *mut drbd_device) {
...
#[no_mangle]
unsafe extern "C" fn use_checksum_based_resync(connection: *mut drbd_connection, device: *mut drbd_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn drbd_start_resync(device: *mut drbd_device, side: enum drbd_conns) {
    void drbd_start_resync(struct drbd_device *device, enum drbd_conns side)
    {
    struct drbd_peer_device *peer_device = first_peer_device(device);
    struct drbd_connection *connection = peer_device ? peer_device.connection : core::ptr::null_mut();
    union drbd_state ns;
    int r;
...
// Did some connection breakage or IO error race with us?
    ...
    ns.pdsk = D_INCONSISTENT;
    r = _drbd_set_state(device, ns, CS_VERBOSE, core::ptr::null_mut());
    ns = drbd_read_state(device);
    if (ns.conn < C_CONNECTED)
    r = SS_UNKNOWN_ERROR;
    if (r == SS_SUCCESS) {
    let mut tw: c_ulong = drbd_bm_total_weight(device);
...
#[no_mangle]
unsafe extern "C" fn update_on_disk_bitmap(peer_device: *mut drbd_peer_device, resync_done: bool) {
    static void update_on_disk_bitmap(struct drbd_peer_device *peer_device, bool resync_done)
    {
    struct drbd_device *device = peer_device.device;
    let mut sib: sib_info = { .sib_reason = SIB_SYNC_PROGRESS, };
...
#[no_mangle]
unsafe extern "C" fn drbd_ldev_destroy(device: *mut drbd_device) {
    static void drbd_ldev_destroy(struct drbd_device *device)
    {
    lc_destroy(device.resync);
    device.resync = core::ptr::null_mut();
    lc_destroy(device.act_log);
    device.act_log = core::ptr::null_mut();
    __acquire(local);
...
#[no_mangle]
unsafe extern "C" fn go_diskless(device: *mut drbd_device) {
...
#[no_mangle]
unsafe extern "C" fn do_md_sync(device: *mut drbd_device) -> c_int {
...
// only called from drbd_worker thread, no locking
    ...
    {
    let mut i: c_uint = *cb_nr % DRBD_THREAD_DETAILS_HIST;
...
#[no_mangle]
unsafe extern "C" fn do_device_work(device: *mut drbd_device, todo: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn get_work_bits(flags: *mut c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn do_unqueued_work(connection: *mut drbd_connection) {
    ...
    idr_for_each_entry(&connection.peer_devices, peer_device, vnr) {
    struct drbd_device *device = peer_device.device;
    let mut todo: c_ulong = get_work_bits(&device.flags);
    if (!todo)
    continue;
...
#[no_mangle]
unsafe extern "C" fn dequeue_work_batch(queue: *mut drbd_work_queue, work_list: *mut list_head) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wait_for_work(connection: *mut drbd_connection, work_list: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !uncork) -> else {
    else if (!uncork)
    tcp_sock_set_cork(connection.data.socket.sk, false);
    }
    mutex_unlock(&connection.data.mutex);
...
#[no_mangle]
pub unsafe extern "C" fn drbd_worker(thi: *mut drbd_thread) -> c_int {
    int drbd_worker(struct drbd_thread *thi)
    {
    struct drbd_connection *connection = thi.connection;
    struct drbd_work *w = core::ptr::null_mut();
    struct drbd_peer_device *peer_device;
    LIST_HEAD(work_list);
    int vnr;
