...
//! Source: drivers/block/virtio_blk.c
#![no_std]
...
pub const VQ_NAME_LEN: c_int = 16;

// The maximum number of sg elements that fit into a virtqueue
pub const VIRTIO_BLK_MAX_SG_ELEMS: c_int = 32768;

pub const VIRTIO_BLK_INLINE_SG_CNT: c_int = 0;

pub const VIRTIO_BLK_INLINE_SG_CNT: c_int = 2;
...
// num of vqs
    ...
    pub vqs: *mut virtio_blk_vq,
// For zoned device
    pub zone_sectors: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtblk_req {
// Out header
    pub out_hdr: virtio_blk_outhdr,
// In header
    union {
    pub status: u8,
//
...
//
    ...
    pub zone_append: },
    pub in_hdr: },
    pub in_hdr_len: usize,
    pub sg_table: sg_table,
    pub sg: [scatterlist; ],
}

#[no_mangle]
pub unsafe extern "C" fn virtblk_result(status: u8) -> blk_status_t {
...
#[no_mangle]
unsafe extern "C" fn virtblk_add_req(vq: *mut virtqueue, vbr: *mut virtblk_req) -> c_int {
    static int virtblk_add_req(struct virtqueue *vq, struct virtblk_req *vbr)
    {
    struct scatterlist out_hdr, in_hdr, *sgs[3];
    let mut num_out: c_uint = 0, num_in = 0;
...
#[no_mangle]
unsafe extern "C" fn virtblk_setup_discard_write_zeroes_erase(req: *mut request, unmap: bool) -> c_int {
    static int virtblk_setup_discard_write_zeroes_erase(struct request *req, bool unmap)
    {
    let mut segments: c_ushort = blk_rq_nr_discard_segments(req);
    let mut n: c_ushort = 0;
...
//
    ...
    let mut sector: u64 = bio.bi_iter.bi_sector;
    let mut num_sectors: u32 = bio.bi_iter.bi_size >> SECTOR_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn virtblk_unmap_data(req: *mut request, vbr: *mut virtblk_req) {
...
#[no_mangle]
unsafe extern "C" fn virtblk_cleanup_cmd(req: *mut request) {
    ...
    struct virtblk_req *vbr)
    {
    let mut in_hdr_len: usize = sizeof(vbr.in_hdr.status);
...
//
#[no_mangle]
pub unsafe extern "C" fn virtblk_vbr_status(vbr: *mut virtblk_req) -> u8 {
    static inline u8 virtblk_vbr_status(struct virtblk_req *vbr)
    {
    return *((u8 *)&vbr.in_hdr + vbr.in_hdr_len - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn virtblk_request_done(req: *mut request) {
    static inline void virtblk_request_done(struct request *req)
    {
    struct virtblk_req *vbr = blk_mq_rq_to_pdu(req);
    let mut status: blk_status_t = virtblk_result(virtblk_vbr_status(vbr));
...
#[no_mangle]
unsafe extern "C" fn virtblk_done(vq: *mut virtqueue) {
    static void virtblk_done(struct virtqueue *vq)
    {
    struct virtio_blk *vblk = vq.vdev.priv;
    let mut req_done: bool = false;
    let mut qid: c_int = vq.index;
    struct virtblk_req *vbr;
    unsigned long flags;
    unsigned int len;
    ...
    while ((vbr = virtqueue_get_buf(vblk.vqs[qid].vq, &len)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn virtio_commit_rqs(hctx: *mut blk_mq_hw_ctx) {
...
#[no_mangle]
unsafe extern "C" fn virtblk_fail_to_queue(req: *mut request, rc: c_int) -> blk_status_t {
...
#[no_mangle]
unsafe extern "C" fn virtblk_prep_rq_batch(req: *mut request) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn virtblk_get_id(disk: *mut gendisk, id_str: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtblk_getgeo(disk: *mut gendisk, geo: *mut hd_geometry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtblk_free_disk(disk: *mut gendisk) {
...
#[no_mangle]
unsafe extern "C" fn index_to_minor(index: c_int) -> c_int {
    static int index_to_minor(int index)
    {
    return index << PART_BITS;
    }
#[no_mangle]
unsafe extern "C" fn minor_to_index(minor: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtblk_update_capacity(vblk: *mut virtio_blk, resize: bool) {
...
#[no_mangle]
unsafe extern "C" fn virtblk_config_changed_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn virtblk_config_changed(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn init_vq(vblk: *mut virtio_blk) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn virtblk_name_format(prefix: *mut c_char, index: c_int, buf: *mut c_char, buflen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtblk_get_cache_mode(vdev: *mut virtio_device) -> c_int {
...
//
    ...
    struct gendisk *disk = dev_to_disk(dev);
    struct virtio_blk *vblk = disk.private_data;
    let mut writeback: u8 = virtblk_get_cache_mode(vblk.vdev);
...
#[no_mangle]
unsafe extern "C" fn virtblk_map_queues(set: *mut blk_mq_tag_set) {
...
#[no_mangle]
unsafe extern "C" fn virtblk_complete_batch(iob: *mut io_comp_batch) {
...
#[no_mangle]
unsafe extern "C" fn virtblk_poll(hctx: *mut blk_mq_hw_ctx, iob: *mut io_comp_batch) -> c_int {
    ...
    spin_lock_irqsave(&vq.lock, flags);
    while ((vbr = virtqueue_get_buf(vq.vq, &len)) != core::ptr::null_mut()) {
    struct request *req = blk_mq_rq_from_pdu(vbr);
    let mut status: u8 = virtblk_vbr_status(vbr);
    found++;
    ...
    let mut max_discard_segs: u32 = 0;
    let mut discard_granularity: u32 = 0;
    u16 min_io_size;
...
#[no_mangle]
unsafe extern "C" fn virtblk_probe(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtblk_remove(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtblk_freeze_priv(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtblk_restore_priv(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtblk_freeze(vdev: *mut virtio_device) -> c_int {
    static int virtblk_freeze(struct virtio_device *vdev)
    {
    return virtblk_freeze_priv(vdev);
    }
#[no_mangle]
unsafe extern "C" fn virtblk_restore(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtblk_reset_prepare(vdev: *mut virtio_device) -> c_int {
    static int virtblk_reset_prepare(struct virtio_device *vdev)
    {
    return virtblk_freeze_priv(vdev);
    }
#[no_mangle]
unsafe extern "C" fn virtblk_reset_done(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_blk_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn virtio_blk_fini() -> void __exit {
