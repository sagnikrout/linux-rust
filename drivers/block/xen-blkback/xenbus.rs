...
//! Source: drivers/block/xen-blkback/xenbus.c
#![no_std]
...
pub struct backend_info {
    ...
    pub backend_watch: xenbus_watch,
    pub major: unsigned,
    pub minor: unsigned,
    pub mode: *mut c_char,
}
...
//
#[no_mangle]
unsafe extern "C" fn xen_blkif_deferred_free(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn blkback_name(blkif: *mut xen_blkif, buf: *mut c_char) -> c_int {
    static int blkback_name(struct xen_blkif *blkif, char *buf)
    {
    char *devpath, *devname;
    struct xenbus_device *dev = blkif.be.dev;
    devpath = xenbus_read(XBT_NIL, dev.nodename, "dev", core::ptr::null_mut());
    if (IS_ERR(devpath))
...
#[no_mangle]
unsafe extern "C" fn xen_update_blkif_status(blkif: *mut xen_blkif) {
...
#[no_mangle]
unsafe extern "C" fn xen_blkif_alloc_rings(blkif: *mut xen_blkif) -> c_int {
...
// Already connected through?
    ...
    ring.blk_rings.common.sring = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn xen_blkif_disconnect(blkif: *mut xen_blkif) -> c_int {
...
//
    kfree(blkif.rings);
    blkif.rings = core::ptr::null_mut();
    blkif.nr_rings = 0;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn xen_blkif_free(blkif: *mut xen_blkif) {
    static void xen_blkif_free(struct xen_blkif *blkif)
    {
...
#[no_mangle]
pub unsafe extern "C" fn xen_blkif_interface_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn xen_blkif_interface_fini() {
    void xen_blkif_interface_fini(void)
    {
    kmem_cache_destroy(xen_blkif_cachep);
    xen_blkif_cachep = core::ptr::null_mut();
    }
//
...
pub unsafe extern "C" fn DEVICE_ATTR(_arg: name, _arg: 0444, _arg: show_##name, _arg: NULL) -> static {
    ...
    VBD_SHOW(mode, "%s\n", be.mode);
#[no_mangle]
unsafe extern "C" fn xenvbd_sysfs_addif(dev: *mut xenbus_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xenvbd_sysfs_delif(dev: *mut xenbus_device) {
...
#[no_mangle]
unsafe extern "C" fn xen_vbd_free(vbd: *mut xen_vbd) {
    static void xen_vbd_free(struct xen_vbd *vbd)
    {
    if (vbd.bdev_file)
    fput(vbd.bdev_file);
    vbd.bdev_file = core::ptr::null_mut();
    }
    ...
    BLK_OPEN_READ : BLK_OPEN_WRITE, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(bdev_file)) {
    ...
    if (file_bdev(vbd.bdev_file).bd_disk == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn xen_blkbk_remove(dev: *mut xenbus_device) {
    ...
    be.backend_watch.node = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn xen_blkbk_discard(xbt: xenbus_transaction, be: *mut backend_info) {
...
// setup back pointer
    be.blkif.be = be;
    err = xenbus_watch_pathfmt(dev, &be.backend_watch, core::ptr::null_mut(),
    backend_changed,
...
//
    ...
    be.mode = xenbus_read(XBT_NIL, dev.nodename, "mode", core::ptr::null_mut());
    if (IS_ERR(be.mode)) {
    err = PTR_ERR(be.mode);
    be.mode = core::ptr::null_mut();
    xenbus_dev_fatal(dev, err, "reading mode");
    return;
    }
    device_type = xenbus_read(XBT_NIL, dev.otherend, "device-type", core::ptr::null_mut());
...
// Once a memory pressure is detected, squeeze free page pools for a while.
    let mut buffer_squeeze_duration_ms: static unsigned int = 10;
...
//
#[no_mangle]
unsafe extern "C" fn reclaim_memory(dev: *mut xenbus_device) {
...
//
#[no_mangle]
unsafe extern "C" fn connect(be: *mut backend_info) {
...
//
#[no_mangle]
unsafe extern "C" fn read_per_ring_refs(ring: *mut xen_blkif_ring, dir: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn connect_ring(be: *mut backend_info) -> c_int {
    ...
    let mut requested_num_queues: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(protocol: 0 ==, _arg: XEN_IO_PROTO_ABI_NATIVE)) -> else {
    else if (0 == strcmp(protocol, XEN_IO_PROTO_ABI_NATIVE))
    blkif.blk_protocol = BLKIF_PROTOCOL_NATIVE;
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(protocol: 0 ==, _arg: XEN_IO_PROTO_ABI_X86_32)) -> else {
    else if (0 == strcmp(protocol, XEN_IO_PROTO_ABI_X86_32))
    blkif.blk_protocol = BLKIF_PROTOCOL_X86_32;
#[no_mangle]
pub unsafe extern "C" fn if(strcmp(protocol: 0 ==, _arg: XEN_IO_PROTO_ABI_X86_64)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn xen_blkif_xenbus_init() -> c_int {
    int xen_blkif_xenbus_init(void)
    {
    return xenbus_register_backend(&xen_blkbk_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn xen_blkif_xenbus_fini() {
