...
//
#[no_mangle]
unsafe extern "C" fn atomic_inc_return_safe(v: *mut core::sync::atomic::AtomicI32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atomic_dec_return_safe(v: *mut core::sync::atomic::AtomicI32) -> c_int {
...
pub const RBD_MINORS_PER_MAJOR: c_int = 256;
pub const RBD_SINGLE_MAJOR_PART_SHIFT: c_int = 4;
pub const RBD_MAX_PARENT_CHAIN_LEN: c_int = 16;

    (NAME_MAX - (sizeof (RBD_SNAP_DEV_NAME_PREFIX) - 1))

// This allows a single page to hold an image name sent by OSD

pub const RBD_IMAGE_ID_LEN_MAX: c_int = 64;
pub const RBD_OBJ_PREFIX_LEN_MAX: c_int = 64;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rbd_image_header {
// These six fields never change for a given rbd image
    pub object_prefix: *mut c_char,
    pub obj_order: __u8,
    pub stripe_unit: u64,
    pub stripe_count: u64,
    pub data_pool_id: i64,
    pub /: *mut *mut u64 features; / Might be changeable someday?,
// The remaining fields need to be updated occasionally
    pub image_size: u64,
    pub snapc: *mut ceph_snap_context,
    pub /: *mut *mut *mut char snap_names; / format 1 only,
    pub /: *mut *mut *mut u64 snap_sizes; / format 1 only,
}
...
pub struct rbd_spec {
    ...
    pub /: *const *const *const char pool_ns; / NULL if default, never "",
    pub image_id: *const c_char,
    pub image_name: *const c_char,
    pub snap_id: u64,
    pub snap_name: *const c_char,
    pub kref: kref,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pending_result {
    pub /: *mut *mut int result; / first nonzero result,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rbd_obj_request {
    pub ex: ceph_object_extent,
    pub /: *mut *mut *mut unsigned int flags; / RBD_OBJ_FLAG_,
    union {
    pub /: *mut *mut enum rbd_obj_read_state read_state; / for reads,
    pub /: *mut *mut enum rbd_obj_write_state write_state; / for writes,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rbd_img_request {
    pub rbd_dev: *mut rbd_device,
    pub op_type: enum obj_operation_type,
    pub data_type: enum obj_request_type,
    pub flags: c_ulong,
    pub state: enum rbd_img_state,
    union {
    pub /: *mut *mut u64 snap_id; / for reads,
    pub /: *mut *mut *mut ceph_snap_context snapc; / for writes,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rbd_device {
    pub /: *mut *mut int dev_id; / blkdev unique id,
    pub /: *mut *mut int major; / blkdev assigned major,
    pub minor: c_int,
    pub /: *mut *mut *mut gendisk disk; / blkdev's gendisk and rq,
    pub /: *mut *mut u32 image_format; / Either 1 or 2,
    pub rbd_client: *mut rbd_client,
    pub /: *mut *mut char name[DEV_NAME_LEN]; / blkdev name, e.g. rbd3,
    pub /: *mut *mut spinlock_t lock; / queue, flags, open_count,
    pub header: rbd_image_header,
    pub /: *mut *mut unsigned long flags; / possibly lock protected,
    pub spec: *mut rbd_spec,
    pub opts: *mut rbd_options,
    pub /: *mut *mut *mut char config_info; / add{,_single_major} string,
    pub header_oid: ceph_object_id,
    pub header_oloc: ceph_object_locator,
    pub /: *mut *mut ceph_file_layout layout; / used for all rbd requests,
    pub watch_mutex: mutex,
    pub watch_state: enum rbd_watch_state,
    pub watch_handle: *mut ceph_osd_linger_request,
    pub watch_cookie: u64,
    pub watch_dwork: delayed_work,
    pub lock_rwsem: rw_semaphore,
    pub lock_state: enum rbd_lock_state,
    pub lock_cookie: [c_char; 32],
    pub owner_cid: rbd_client_id,
    pub acquired_lock_work: work_struct,
    pub released_lock_work: work_struct,
    pub lock_dwork: delayed_work,
    pub unlock_work: work_struct,
    pub lock_lists_lock: spinlock_t,
    pub acquiring_list: list_head,
    pub running_list: list_head,
    pub acquire_wait: completion,
    pub acquire_err: c_int,
    pub quiescing_wait: completion,
    pub object_map_lock: spinlock_t,
    pub object_map: *mut u8,
    pub /: *mut *mut u64 object_map_size; / in objects,
    pub object_map_flags: u64,
    pub task_wq: *mut workqueue_struct,
    pub parent_spec: *mut rbd_spec,
    pub parent_overlap: u64,
    pub parent_ref: core::sync::atomic::AtomicI32,
    pub parent: *mut rbd_device,
// Block layer tags.
    pub tag_set: blk_mq_tag_set,
// protects updating the header
    pub header_rwsem: rw_semaphore,
    pub mapping: rbd_mapping,
    pub node: list_head,
// sysfs related
    pub dev: device,
    pub /: *mut *mut unsigned long open_count; / protected by lock,
}
...
//
    let mut single_major: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_id_to_minor(dev_id: c_int) -> c_int {
    static int rbd_dev_id_to_minor(int dev_id)
    {
    return dev_id << RBD_SINGLE_MAJOR_PART_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn minor_to_rbd_dev_id(minor: c_int) -> c_int {
    static int minor_to_rbd_dev_id(int minor)
    {
    return minor >> RBD_SINGLE_MAJOR_PART_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn rbd_is_ro(rbd_dev: *mut rbd_device) -> bool {
    static bool rbd_is_ro(struct rbd_device *rbd_dev)
    {
    return test_bit(RBD_DEV_FLAG_READONLY, &rbd_dev.flags);
    }
#[no_mangle]
unsafe extern "C" fn rbd_is_snap(rbd_dev: *mut rbd_device) -> bool {
    static bool rbd_is_snap(struct rbd_device *rbd_dev)
    {
    return rbd_dev.spec.snap_id != CEPH_NOSNAP;
    }
#[no_mangle]
unsafe extern "C" fn __rbd_is_lock_owner(rbd_dev: *mut rbd_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_is_lock_owner(rbd_dev: *mut rbd_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn supported_features_show(bus: *const bus_type, buf: *mut c_char) -> isize {
...
pub unsafe extern "C" fn __printf(_arg: 2, _arg: 3) -> static {
    static __printf(2, 3)
#[no_mangle]
pub unsafe extern "C" fn rbd_warn(rbd_dev: *mut rbd_device, fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rbd_dev->disk) -> else {
    else if (rbd_dev.disk)
    printk(KERN_WARNING "%s: %s: %pV\n",
    RBD_DRV_NAME, rbd_dev.disk.disk_name, &vaf);
#[no_mangle]
pub unsafe extern "C" fn if(rbd_dev->spec->image_name: rbd_dev->spec &&) -> else {
    else if (rbd_dev.spec && rbd_dev.spec.image_name)
    printk(KERN_WARNING "%s: image %s: %pV\n",
    RBD_DRV_NAME, rbd_dev.spec.image_name, &vaf);
#[no_mangle]
pub unsafe extern "C" fn if(rbd_dev->spec->image_id: rbd_dev->spec &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn pending_result_dec(pending: *mut pending_result, result: *mut c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_open(disk: *mut gendisk, mode: blk_mode_t) -> c_int {
    static int rbd_open(struct gendisk *disk, blk_mode_t mode)
    {
    struct rbd_device *rbd_dev = disk.private_data;
    let mut removing: bool = false;
...
#[no_mangle]
unsafe extern "C" fn rbd_release(disk: *mut gendisk) {
...
//
    ...
    goto out_rbdc;
    ceph_opts = core::ptr::null_mut(); /* Now rbdc.client is responsible for ceph_opts */
...
//
    ...
    {
    struct rbd_client *rbdc = core::ptr::null_mut(), *iter;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rbd_options {
    pub queue_depth: c_int,
    pub alloc_size: c_int,
    pub lock_timeout: c_ulong,
    pub read_only: bool,
    pub lock_on_read: bool,
    pub exclusive: bool,
    pub trim: bool,
    pub /: *mut *mut *mut u32 alloc_hint_flags; / CEPH_OSD_OP_ALLOC_HINT_FLAG_,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rbd_parse_opts_ctx {
    pub spec: *mut rbd_spec,
    pub copts: *mut ceph_options,
    pub opts: *mut rbd_options,
}

#[no_mangle]
unsafe extern "C" fn obj_op_name(op_type: enum obj_operation_type) -> *mut c_char {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_client_release(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_put_client(rbdc: *mut rbd_client) {
...
//
    ...
    if (ret) {
    rbd_warn(core::ptr::null_mut(), "failed to get latest osdmap: %d", ret);
    rbd_put_client(rbdc);
    rbdc = ERR_PTR(ret);
    }
    } else {
...
#[no_mangle]
unsafe extern "C" fn rbd_image_format_valid(image_format: u32) -> bool {
    static bool rbd_image_format_valid(u32 image_format)
    {
    let mut image_format: return = = 1 || image_format == 2;
    }
#[no_mangle]
unsafe extern "C" fn rbd_dev_ondisk_valid(ondisk: *mut rbd_image_header_ondisk) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_obj_bytes(header: *mut rbd_image_header) -> u32 {
    static u32 rbd_obj_bytes(struct rbd_image_header *header)
    {
    return 1U << header.obj_order;
    }
#[no_mangle]
unsafe extern "C" fn rbd_init_layout(rbd_dev: *mut rbd_device) {
    ...
    RCU_INIT_POINTER(rbd_dev.layout.pool_ns, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rbd_image_header_cleanup(header: *mut rbd_image_header) {
...
//
    ...
    char *object_prefix = core::ptr::null_mut();
    char *snap_names = core::ptr::null_mut();
    u64 *snap_sizes = core::ptr::null_mut();
    u32 snap_count;
    let mut ret: c_int = -ENOMEM;
    u32 i;
...
// Allocate the snapshot context and fill it in
    ...
    let mut snap_names_len: u64 = le64_to_cpu(ondisk.snap_names_len);
...
//
#[no_mangle]
unsafe extern "C" fn snapid_compare_reverse(s1: *const c_void, s2: *const c_void) -> c_int {
    static int snapid_compare_reverse(const void *s1, const void *s2)
    {
    let mut snap_id1: u64 = *(u64 *)s1;
    let mut snap_id2: u64 = *(u64 *)s2;
    if (snap_id1 < snap_id2)
    return 1;
    let mut snap_id1: return = = snap_id2 ? 0 : -1;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_snap_index(rbd_dev: *mut rbd_device, snap_id: u64) -> u32 {
...
// snap_size = rbd_dev->header.snap_sizes[which];
    ...
    let mut size: u64 = 0;
    int ret;
    ret = _rbd_dev_v2_snap_size(rbd_dev, snap_id, core::ptr::null_mut(), &size);
    if (ret)
    return ret;
// snap_size = size;
    }
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_mapping_set(rbd_dev: *mut rbd_device) -> c_int {
    static int rbd_dev_mapping_set(struct rbd_device *rbd_dev)
    {
    let mut snap_id: u64 = rbd_dev.spec.snap_id;
    let mut size: u64 = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_mapping_clear(rbd_dev: *mut rbd_device) {
    static void rbd_dev_mapping_clear(struct rbd_device *rbd_dev)
    {
    rbd_dev.mapping.size = 0;
    }
#[no_mangle]
unsafe extern "C" fn zero_bios(bio_pos: *mut ceph_bio_iter, off: u32, bytes: u32) {
    static void zero_bios(struct ceph_bio_iter *bio_pos, u32 off, u32 bytes)
    {
    let mut it: ceph_bio_iter = *bio_pos;
...
#[no_mangle]
unsafe extern "C" fn zero_bvecs(bvec_pos: *mut ceph_bvec_iter, off: u32, bytes: u32) {
    static void zero_bvecs(struct ceph_bvec_iter *bvec_pos, u32 off, u32 bytes)
    {
    let mut it: ceph_bvec_iter = *bvec_pos;
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_request_put(obj_request: *mut rbd_obj_request) {
    static void rbd_obj_request_put(struct rbd_obj_request *obj_request)
    {
    rbd_assert(obj_request != core::ptr::null_mut());
    ...
    {
    rbd_assert(obj_request.img_request == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rbd_osd_submit(osd_req: *mut ceph_osd_request) {
...
//
#[no_mangle]
unsafe extern "C" fn img_request_layered_set(img_request: *mut rbd_img_request) {
    static void img_request_layered_set(struct rbd_img_request *img_request)
    {
    set_bit(IMG_REQ_LAYERED, &img_request.flags);
    }
#[no_mangle]
unsafe extern "C" fn img_request_layered_test(img_request: *mut rbd_img_request) -> bool {
    static bool img_request_layered_test(struct rbd_img_request *img_request)
    {
    return test_bit(IMG_REQ_LAYERED, &img_request.flags) != 0;
    }
#[no_mangle]
unsafe extern "C" fn rbd_obj_is_entire(obj_req: *mut rbd_obj_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_is_tail(obj_req: *mut rbd_obj_request) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_obj_set_copyup_enabled(obj_req: *mut rbd_obj_request) {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_img_extents_bytes(obj_req: *mut rbd_obj_request) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn rbd_img_is_write(img_req: *mut rbd_img_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_osd_req_callback(osd_req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn rbd_osd_format_read(osd_req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn rbd_osd_format_write(osd_req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_request_destroy(kref: *mut kref) {
    static void rbd_obj_request_destroy(struct kref *kref)
    {
    struct rbd_obj_request *obj_request;
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_unparent(rbd_dev: *mut rbd_device) {
    static void rbd_dev_unparent(struct rbd_device *rbd_dev)
    {
    rbd_dev_remove_parent(rbd_dev);
    rbd_spec_put(rbd_dev.parent_spec);
    rbd_dev.parent_spec = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_parent_put(rbd_dev: *mut rbd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_parent_get(rbd_dev: *mut rbd_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_img_capture_header(img_req: *mut rbd_img_request) {
...
#[no_mangle]
unsafe extern "C" fn rbd_img_request_destroy(img_request: *mut rbd_img_request) {
...
pub const BITS_PER_OBJ: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn __rbd_object_map_get(rbd_dev: *mut rbd_device, objno: u64) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn __rbd_object_map_set(rbd_dev: *mut rbd_device, objno: u64, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn rbd_object_map_get(rbd_dev: *mut rbd_device, objno: u64) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn use_object_map(rbd_dev: *mut rbd_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_object_map_may_exist(rbd_dev: *mut rbd_device, objno: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_object_map_lock(rbd_dev: *mut rbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_object_map_unlock(rbd_dev: *mut rbd_device) {
...
#[no_mangle]
unsafe extern "C" fn decode_object_map_header(p: *mut c_void, end: *mut c_void, object_map_size: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __rbd_object_map_load(rbd_dev: *mut rbd_device) -> c_int {
    ...
    core::ptr::null_mut(), 0, pages, &reply_len);
    if (ret)
    goto out;
...
#[no_mangle]
unsafe extern "C" fn rbd_object_map_free(rbd_dev: *mut rbd_device) {
    static void rbd_object_map_free(struct rbd_device *rbd_dev)
    {
    kvfree(rbd_dev.object_map);
    rbd_dev.object_map = core::ptr::null_mut();
    rbd_dev.object_map_size = 0;
    }
#[no_mangle]
unsafe extern "C" fn rbd_object_map_load(rbd_dev: *mut rbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_object_map_open(rbd_dev: *mut rbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_object_map_close(rbd_dev: *mut rbd_device) {
...
#[no_mangle]
unsafe extern "C" fn rbd_object_map_callback(osd_req: *mut ceph_osd_request) {
...
#[no_mangle]
unsafe extern "C" fn update_needed(rbd_dev: *mut rbd_device, objno: u64, new_state: u8) -> bool {
    static bool update_needed(struct rbd_device *rbd_dev, u64 objno, u8 new_state)
    {
    let mut state: u8 = rbd_object_map_get(rbd_dev, objno);
    if (state == new_state ||
...
//
    ...
    req = ceph_osdc_alloc_request(osdc, core::ptr::null_mut(), num_ops, false, GFP_NOIO);
    if (!req)
    return -ENOMEM;
    list_add_tail(&req.r_private_item, &obj_req.osd_reqs);
...
//
    ...
    {
    let mut cnt: u32 = *num_img_extents;
...
#[no_mangle]
unsafe extern "C" fn rbd_osd_setup_data(osd_req: *mut ceph_osd_request, which: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rbd_osd_setup_stat(osd_req: *mut ceph_osd_request, which: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_init_read(obj_req: *mut rbd_obj_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_init_write(obj_req: *mut rbd_obj_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn truncate_or_zero_opcode(obj_req: *mut rbd_obj_request) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_init_discard(obj_req: *mut rbd_obj_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_init_zeroout(obj_req: *mut rbd_obj_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn count_write_ops(obj_req: *mut rbd_obj_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __rbd_img_fill_request(img_req: *mut rbd_img_request) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rbd_img_fill_ctx {
    pub pos_type: enum obj_request_type,
    pub pos: *mut union rbd_img_fill_iter,
    pub iter: union rbd_img_fill_iter,
    pub set_pos_fn: ceph_object_extent_fn_t,
    pub count_fn: ceph_object_extent_fn_t,
    pub copy_fn: ceph_object_extent_fn_t,
}
...
//
#[no_mangle]
unsafe extern "C" fn rbd_layout_is_fancy(l: *mut ceph_file_layout) -> bool {
...
//
    ...
    u64 off, u64 len)
    {
    let mut ex: ceph_file_extent = { off, len };
    let mut dummy: union rbd_img_fill_iter = {};
    struct rbd_img_fill_ctx fctx = {
...
#[no_mangle]
unsafe extern "C" fn set_bio_pos(ex: *mut ceph_object_extent, bytes: u32, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn count_bio_bvecs(ex: *mut ceph_object_extent, bytes: u32, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn copy_bio_bvecs(ex: *mut ceph_object_extent, bytes: u32, arg: *mut c_void) {
    ...
    {
    let mut ex: ceph_file_extent = { off, len };
    let mut it: ceph_bio_iter = { .bio = bio, .iter = bio.bi_iter };
    return __rbd_img_fill_from_bio(img_req, &ex, 1, &it);
    }
#[no_mangle]
unsafe extern "C" fn set_bvec_pos(ex: *mut ceph_object_extent, bytes: u32, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn count_bvecs(ex: *mut ceph_object_extent, bytes: u32, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn copy_bvecs(ex: *mut ceph_object_extent, bytes: u32, arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rbd_img_handle_request_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rbd_img_schedule(img_req: *mut rbd_img_request, result: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_may_exist(obj_req: *mut rbd_obj_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_read_object(obj_req: *mut rbd_obj_request) -> c_int {
    static int rbd_obj_read_object(struct rbd_obj_request *obj_req)
    {
    struct ceph_osd_request *osd_req;
    int ret;
    osd_req = __rbd_obj_add_osd_request(obj_req, core::ptr::null_mut(), 1);
    if (IS_ERR(osd_req))
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_read_from_parent(obj_req: *mut rbd_obj_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_advance_read(obj_req: *mut rbd_obj_request, result: *mut c_int) -> bool {
...
//
    if (!*result) {
    let mut obj_overlap: u32 = rbd_obj_img_extents_bytes(obj_req);
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_write_is_noop(obj_req: *mut rbd_obj_request) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_obj_write_pre_object_map(obj_req: *mut rbd_obj_request) -> c_int {
    ...
    return rbd_object_map_update(obj_req, CEPH_NOSNAP, new_state, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rbd_obj_write_object(obj_req: *mut rbd_obj_request) -> c_int {
    static int rbd_obj_write_object(struct rbd_obj_request *obj_req)
    {
    struct ceph_osd_request *osd_req;
    let mut num_ops: c_int = count_write_ops(obj_req);
    let mut which: c_int = 0;
    int ret;
    if (obj_req.flags & RBD_OBJ_FLAG_COPYUP_ENABLED)
    num_ops++; /* stat */
...
//
#[no_mangle]
unsafe extern "C" fn is_zero_bvecs(bvecs: *mut bio_vec, bytes: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn setup_copyup_bvecs(obj_req: *mut rbd_obj_request, obj_overlap: u64) -> c_int {
    ...
    let mut len: c_uint = min(obj_overlap, (u64)PAGE_SIZE);
...
//
#[no_mangle]
unsafe extern "C" fn rbd_obj_copyup_read_parent(obj_req: *mut rbd_obj_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_copyup_object_maps(obj_req: *mut rbd_obj_request) {
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_copyup_write_object(obj_req: *mut rbd_obj_request) {
    static void rbd_obj_copyup_write_object(struct rbd_obj_request *obj_req)
    {
    let mut bytes: u32 = rbd_obj_img_extents_bytes(obj_req);
    int ret;
    rbd_assert(!obj_req.pending.result && !obj_req.pending.num_pending);
//
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_advance_copyup(obj_req: *mut rbd_obj_request, result: *mut c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_obj_write_post_object_map(obj_req: *mut rbd_obj_request) -> c_int {
    static int rbd_obj_write_post_object_map(struct rbd_obj_request *obj_req)
    {
    struct rbd_device *rbd_dev = obj_req.img_request.rbd_dev;
    let mut current_state: u8 = OBJECT_PENDING;
    if (!(rbd_dev.header.features & RBD_FEATURE_OBJECT_MAP))
    return 1;
    if (!(obj_req.flags & RBD_OBJ_FLAG_DELETION))
    return 1;
...
#[no_mangle]
unsafe extern "C" fn rbd_obj_advance_write(obj_req: *mut rbd_obj_request, result: *mut c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_obj_handle_request(obj_req: *mut rbd_obj_request, result: c_int) {
    static void rbd_obj_handle_request(struct rbd_obj_request *obj_req, int result)
    {
...
#[no_mangle]
unsafe extern "C" fn need_exclusive_lock(img_req: *mut rbd_img_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_lock_add_request(img_req: *mut rbd_img_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_lock_del_request(img_req: *mut rbd_img_request) {
    static void rbd_lock_del_request(struct rbd_img_request *img_req)
    {
    struct rbd_device *rbd_dev = img_req.rbd_dev;
    let mut need_wakeup: bool = false;
    lockdep_assert_held(&rbd_dev.lock_rwsem);
    spin_lock(&rbd_dev.lock_lists_lock);
...
#[no_mangle]
unsafe extern "C" fn rbd_img_exclusive_lock(img_req: *mut rbd_img_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_img_object_requests(img_req: *mut rbd_img_request) {
    ...
    let mut off: u64 = (u64)blk_rq_pos(rq) << SECTOR_SHIFT;
    let mut len: u64 = blk_rq_bytes(rq);
    u64 mapping_size;
...
#[no_mangle]
unsafe extern "C" fn rbd_img_advance(img_req: *mut rbd_img_request, result: *mut c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_img_handle_request(img_req: *mut rbd_img_request, result: c_int) {
    static void rbd_img_handle_request(struct rbd_img_request *img_req, int result)
    {
    again:
...
#[no_mangle]
unsafe extern "C" fn rbd_get_cid(rbd_dev: *mut rbd_device) -> rbd_client_id {
...
#[no_mangle]
unsafe extern "C" fn format_lock_cookie(rbd_dev: *mut rbd_device, buf: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn __rbd_lock(rbd_dev: *mut rbd_device, cookie: *const c_char) {
    static void __rbd_lock(struct rbd_device *rbd_dev, const char *cookie)
    {
    let mut cid: rbd_client_id = rbd_get_cid(rbd_dev);
...
//
#[no_mangle]
unsafe extern "C" fn rbd_lock(rbd_dev: *mut rbd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_unlock(rbd_dev: *mut rbd_device) {
...
// treat errors as the image is unlocked
    ...
    let mut buf_size: c_int = sizeof(buf);
    void *p = buf;
...
// encode *LockPayload NotifyMessage (op + ClientId)
    ...
    enum rbd_notify_op notify_op)
    {
    __rbd_notify_op_lock(rbd_dev, notify_op, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn rbd_notify_acquired_lock(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rbd_notify_released_lock(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rbd_request_lock(rbd_dev: *mut rbd_device) -> c_int {
    static int rbd_request_lock(struct rbd_device *rbd_dev)
    {
    struct page **reply_pages;
    size_t reply_len;
    let mut lock_owner_responded: bool = false;
    int ret;
    dout("%s rbd_dev %p\n", __func__, rbd_dev);
    ...
    let mut end: *mut void const = p + reply_len;
    u32 n;
...
//
#[no_mangle]
unsafe extern "C" fn wake_lock_waiters(rbd_dev: *mut rbd_device, result: c_int) {
...
#[no_mangle]
unsafe extern "C" fn free_locker(locker: *mut ceph_locker) {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_try_lock(rbd_dev: *mut rbd_device) -> c_int {
    ...
    int ret;
    for (;;) {
    locker = refreshed_locker = core::ptr::null_mut();
...
// determine if the current lock holder is still alive
    ...
    refreshed_locker = core::ptr::null_mut();
    goto out;
    }
    if (!refreshed_locker ||
...
#[no_mangle]
unsafe extern "C" fn rbd_post_acquire_action(rbd_dev: *mut rbd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_try_acquire_lock(rbd_dev: *mut rbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_acquire_lock(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rbd_quiesce_lock(rbd_dev: *mut rbd_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rbd_pre_release_action(rbd_dev: *mut rbd_device) {
...
#[no_mangle]
unsafe extern "C" fn __rbd_release_lock(rbd_dev: *mut rbd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_release_lock(rbd_dev: *mut rbd_device) {
...
#[no_mangle]
unsafe extern "C" fn rbd_release_lock_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn maybe_kick_acquire(rbd_dev: *mut rbd_device) {
...
//
    ...
    void **p)
    {
    let mut my_cid: rbd_client_id = rbd_get_cid(rbd_dev);
    let mut cid: rbd_client_id = { 0 };
...
// encode ResponseMessage
    ...
    {
    dout("%s rbd_dev %p\n", __func__, rbd_dev);
    __rbd_acknowledge_notify(rbd_dev, notify_id, cookie, core::ptr::null_mut());
    }
    ...
    void *p = data;
    let mut end: *mut void const = p + data_len;
...
#[no_mangle]
unsafe extern "C" fn rbd_watch_errcb(arg: *mut c_void, cookie: u64, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn __rbd_register_watch(rbd_dev: *mut rbd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __rbd_unregister_watch(rbd_dev: *mut rbd_device) {
    static void __rbd_unregister_watch(struct rbd_device *rbd_dev)
    {
    struct ceph_osd_client *osdc = &rbd_dev.rbd_client.client.osdc;
    int ret;
    ...
    rbd_dev.watch_handle = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn rbd_register_watch(rbd_dev: *mut rbd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_unregister_watch(rbd_dev: *mut rbd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_reacquire_lock(rbd_dev: *mut rbd_device) {
...
#[no_mangle]
unsafe extern "C" fn rbd_reregister_watch(work: *mut work_struct) {
...
//
    ...
    {
    struct ceph_osd_client *osdc = &rbd_dev.rbd_client.client.osdc;
    struct page *req_page = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rbd_queue_workfn(work: *mut work_struct) {
    static void rbd_queue_workfn(struct work_struct *work)
    {
    struct rbd_img_request *img_request =
    container_of(work, struct rbd_img_request, work);
    struct rbd_device *rbd_dev = img_request.rbd_dev;
    let mut op_type: enum obj_operation_type = img_request.op_type;
    struct request *rq = blk_mq_rq_from_pdu(img_request);
    let mut offset: u64 = (u64)blk_rq_pos(rq) << SECTOR_SHIFT;
    let mut length: u64 = blk_rq_bytes(rq);
    int result;
...
#[no_mangle]
unsafe extern "C" fn rbd_free_disk(rbd_dev: *mut rbd_device) {
    static void rbd_free_disk(struct rbd_device *rbd_dev)
    {
    put_disk(rbd_dev.disk);
    blk_mq_free_tag_set(&rbd_dev.tag_set);
    rbd_dev.disk = core::ptr::null_mut();
    }
    ...
    struct ceph_osd_request *req;
    struct page **pages;
    let mut num_pages: c_int = calc_pages_for(0, buf_len);
    int ret;
    req = ceph_osdc_alloc_request(osdc, core::ptr::null_mut(), 1, false, GFP_KERNEL);
    if (!req)
    return -ENOMEM;
...
//
    ...
    bool first_time)
    {
    struct rbd_image_header_ondisk *ondisk = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_update_size(rbd_dev: *mut rbd_device) {
...
#[no_mangle]
unsafe extern "C" fn rbd_init_disk(rbd_dev: *mut rbd_device) -> c_int {
...
//
    ...
    static DEVICE_ATTR(size, 0444, rbd_size_show, core::ptr::null_mut());
    static DEVICE_ATTR(features, 0444, rbd_features_show, core::ptr::null_mut());
    static DEVICE_ATTR(major, 0444, rbd_major_show, core::ptr::null_mut());
    static DEVICE_ATTR(minor, 0444, rbd_minor_show, core::ptr::null_mut());
    static DEVICE_ATTR(client_addr, 0444, rbd_client_addr_show, core::ptr::null_mut());
    static DEVICE_ATTR(client_id, 0444, rbd_client_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(cluster_fsid, 0444, rbd_cluster_fsid_show, core::ptr::null_mut());
    static DEVICE_ATTR(config_info, 0400, rbd_config_info_show, core::ptr::null_mut());
    static DEVICE_ATTR(pool, 0444, rbd_pool_show, core::ptr::null_mut());
    static DEVICE_ATTR(pool_id, 0444, rbd_pool_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(pool_ns, 0444, rbd_pool_ns_show, core::ptr::null_mut());
    static DEVICE_ATTR(name, 0444, rbd_name_show, core::ptr::null_mut());
    static DEVICE_ATTR(image_id, 0444, rbd_image_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(refresh, 0200, core::ptr::null_mut(), rbd_image_refresh);
    static DEVICE_ATTR(current_snap, 0444, rbd_snap_show, core::ptr::null_mut());
    static DEVICE_ATTR(snap_id, 0444, rbd_snap_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(parent, 0444, rbd_parent_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rbd_spec_put(spec: *mut rbd_spec) {
    static void rbd_spec_put(struct rbd_spec *spec)
    {
    if (spec)
...
#[no_mangle]
unsafe extern "C" fn rbd_spec_free(kref: *mut kref) {
    static void rbd_spec_free(struct kref *kref)
    {
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_free(rbd_dev: *mut rbd_device) {
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_release(dev: *mut device) {
    static void rbd_dev_release(struct device *dev)
    {
    struct rbd_device *rbd_dev = dev_to_rbd_dev(dev);
    let mut need_put: bool = !!rbd_dev.opts;
    if (need_put) {
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_destroy(rbd_dev: *mut rbd_device) {
...
//
    ...
    u8 *order, u64 *snap_size)
    {
    let mut snapid: __le64 = cpu_to_le64(snap_id);
    int ret;
    struct {
    u8 order;
    __le64 size;
...
// Response will be an encoded string, which includes a length
    ...
    core::ptr::null_mut(), 0, reply_buf, size);
    dout("%s: rbd_obj_method_sync returned %d\n", __func__, ret);
    if (ret < 0)
    goto out;
    p = reply_buf;
    object_prefix = ceph_extract_encoded_string(&p, p + ret, core::ptr::null_mut(),
    GFP_NOIO);
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_v2_get_flags(rbd_dev: *mut rbd_device) -> c_int {
    static int rbd_dev_v2_get_flags(struct rbd_device *rbd_dev)
    {
    let mut snapid: __le64 = cpu_to_le64(rbd_dev.spec.snap_id);
    __le64 flags;
    int ret;
    ret = rbd_obj_method_sync(rbd_dev, &rbd_dev.header_oid,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct parent_image_info {
    pub pool_id: u64,
    pub pool_ns: *const c_char,
    pub image_id: *const c_char,
    pub snap_id: u64,
...
#[no_mangle]
unsafe extern "C" fn rbd_parent_info_cleanup(pii: *mut parent_image_info) {
...
//
    ...
    pii.pool_ns = ceph_extract_encoded_string(p, end, core::ptr::null_mut(), GFP_KERNEL);
    if (IS_ERR(pii.pool_ns)) {
    ret = PTR_ERR(pii.pool_ns);
    pii.pool_ns = core::ptr::null_mut();
    return ret;
    }
    pii.image_id = ceph_extract_encoded_string(p, end, core::ptr::null_mut(), GFP_KERNEL);
    if (IS_ERR(pii.image_id)) {
    ret = PTR_ERR(pii.image_id);
    pii.image_id = core::ptr::null_mut();
    return ret;
    }
    ...
    if (ret)
    let mut ret: return = = -EOPNOTSUPP ? 1 : ret;
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_setup_parent(rbd_dev: *mut rbd_device) -> c_int {
    static int rbd_dev_setup_parent(struct rbd_device *rbd_dev)
    {
    struct rbd_spec *parent_spec;
    let mut pii: parent_image_info = { 0 };
    int ret;
...
// The ceph file layout needs to fit pool id in 32 bits
    ...
    rbd_warn(core::ptr::null_mut(), "parent pool id too large (%llu > %u)",
...
//
    ...
    parent_spec = core::ptr::null_mut();	/* rbd_dev now owns this */
//
...
//
    ...
    let mut size: usize = sizeof (striping_info_buf);
    int ret;
    ret = rbd_obj_method_sync(rbd_dev, &rbd_dev.header_oid,
    &rbd_dev.header_oloc, "get_stripe_unit_count",
    core::ptr::null_mut(), 0, &striping_info_buf, size);
    dout("%s: rbd_obj_method_sync returned %d\n", __func__, ret);
    if (ret < 0)
    return ret;
    if (ret < size)
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_v2_data_pool(rbd_dev: *mut rbd_device, data_pool_id: *mut i64) -> c_int {
    ...
    core::ptr::null_mut(), 0, &data_pool_buf,
...
// data_pool_id = le64_to_cpu(data_pool_buf);
    ...
    void *end;
    size_t size;
    void *reply_buf = core::ptr::null_mut();
    let mut len: usize = 0;
    char *image_name = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rbd_v1_snap_id_by_name(rbd_dev: *mut rbd_device, name: *const c_char) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn rbd_v2_snap_id_by_name(rbd_dev: *mut rbd_device, name: *const c_char) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_snap_id_by_name(rbd_dev: *mut rbd_device, name: *const c_char) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_spec_fill_snap_id(rbd_dev: *mut rbd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_spec_fill_names(rbd_dev: *mut rbd_device) -> c_int {
...
// psnapc = snapc;
    ...
    snap_name = ceph_extract_encoded_string(&p, end, core::ptr::null_mut(), GFP_KERNEL);
    if (IS_ERR(snap_name))
    goto out;
    ...
    first_time ? &header.obj_order : core::ptr::null_mut(),
    &header.image_size);
    if (ret)
    return ret;
    if (first_time) {
...
//
#[no_mangle]
pub unsafe extern "C" fn next_token(buf: *const c_char) -> usize {
...
// lenp = len;
    ...
    let mut log: p_log = {.prefix = "rbd"};
    int token, ret;
    ret = ceph_parse_param(param, pctx.copts, core::ptr::null_mut());
    if (ret != -ENOPARAM)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn rbd_parse_options(options: *mut c_char, pctx: *mut rbd_parse_opts_ctx) -> c_int {
    static int rbd_parse_options(char *options, struct rbd_parse_opts_ctx *pctx)
    {
    char *key;
    let mut ret: c_int = 0;
    dout("%s '%s'\n", __func__, options);
    while ((key = strsep(&options, ",")) != core::ptr::null_mut()) {
    if (*key) {
...
//
    ...
    let mut pctx: rbd_parse_opts_ctx = { 0 };
    int ret;
// The first four tokens are required
    len = next_token(&buf);
    if (!len) {
    rbd_warn(core::ptr::null_mut(), "no monitor address(es) provided");
    return -EINVAL;
    }
    mon_addrs = buf;
    mon_addrs_size = len;
    buf += len;
    ret = -EINVAL;
    options = dup_token(&buf, core::ptr::null_mut());
    if (!options)
    return -ENOMEM;
    if (!*options) {
    rbd_warn(core::ptr::null_mut(), "no options provided");
    goto out_err;
    }
    pctx.spec = rbd_spec_alloc();
    if (!pctx.spec)
    goto out_mem;
    pctx.spec.pool_name = dup_token(&buf, core::ptr::null_mut());
    if (!pctx.spec.pool_name)
    goto out_mem;
    if (!*pctx.spec.pool_name) {
    rbd_warn(core::ptr::null_mut(), "no pool name provided");
    goto out_err;
    }
    pctx.spec.image_name = dup_token(&buf, core::ptr::null_mut());
    if (!pctx.spec.image_name)
    goto out_mem;
    if (!*pctx.spec.image_name) {
    rbd_warn(core::ptr::null_mut(), "no image name provided");
    goto out_err;
    }
//
...
// Initialize all rbd options to the defaults
    ...
    ret = ceph_parse_mon_ips(mon_addrs, mon_addrs_size, pctx.copts, core::ptr::null_mut(),
    ',');
    if (ret)
    goto out_err;
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_image_unlock(rbd_dev: *mut rbd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_add_acquire_lock(rbd_dev: *mut rbd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_image_id(rbd_dev: *mut rbd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_unprobe(rbd_dev: *mut rbd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_probe_parent(rbd_dev: *mut rbd_device, depth: c_int) -> c_int {
    static int rbd_dev_probe_parent(struct rbd_device *rbd_dev, int depth)
    {
    struct rbd_device *parent = core::ptr::null_mut();
    int ret;
    if (!rbd_dev.parent_spec)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_device_release(rbd_dev: *mut rbd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_device_setup(rbd_dev: *mut rbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_header_name(rbd_dev: *mut rbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rbd_print_dne(rbd_dev: *mut rbd_device, is_snap: bool) {
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_image_release(rbd_dev: *mut rbd_device) {
    ...
    rbd_dev.spec.image_id = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn rbd_dev_image_probe(rbd_dev: *mut rbd_device, depth: c_int) -> c_int {
    static int rbd_dev_image_probe(struct rbd_device *rbd_dev, int depth)
    {
    let mut need_watch: bool = !rbd_is_ro(rbd_dev);
    int ret;
//
...
//
    ...
    header.snapc = core::ptr::null_mut();
    if (rbd_dev.image_format == 1) {
    kfree(rbd_dev.header.snap_names);
    rbd_dev.header.snap_names = header.snap_names;
    header.snap_names = core::ptr::null_mut();
    kfree(rbd_dev.header.snap_sizes);
    rbd_dev.header.snap_sizes = header.snap_sizes;
    header.snap_sizes = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_refresh(rbd_dev: *mut rbd_device) -> c_int {
    static int rbd_dev_refresh(struct rbd_device *rbd_dev)
    {
    let mut header: rbd_image_header = { 0 };
    let mut pii: parent_image_info = { 0 };
    int ret;
    dout("%s rbd_dev %p\n", __func__, rbd_dev);
...
#[no_mangle]
unsafe extern "C" fn do_rbd_add(buf: *const c_char, count: usize) -> isize {
    static ssize_t do_rbd_add(const char *buf, size_t count)
    {
    struct rbd_device *rbd_dev = core::ptr::null_mut();
    struct ceph_options *ceph_opts = core::ptr::null_mut();
    struct rbd_options *rbd_opts = core::ptr::null_mut();
    struct rbd_spec *spec = core::ptr::null_mut();
    struct rbd_client *rbdc;
    int rc;
    if (!capable(CAP_SYS_ADMIN))
    return -EPERM;
...
// pick the pool
    ...
    rbdc = core::ptr::null_mut();		/* rbd_dev now owns this */
    spec = core::ptr::null_mut();		/* rbd_dev now owns this */
    rbd_opts = core::ptr::null_mut();	/* rbd_dev now owns this */
...
// Everything's ready.  Announce the disk to the world.
    ...
    if (rc)
    goto err_out_image_lock;
    rc = device_add_disk(&rbd_dev.dev, rbd_dev.disk, core::ptr::null_mut());
    if (rc)
    goto err_out_device;
...
#[no_mangle]
unsafe extern "C" fn add_store(bus: *const bus_type, buf: *const c_char, count: usize) -> isize {
    static ssize_t add_store(const struct bus_type *bus, const char *buf, size_t count)
    {
    if (single_major)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn rbd_dev_remove_parent(rbd_dev: *mut rbd_device) {
    static void rbd_dev_remove_parent(struct rbd_device *rbd_dev)
    {
...
//
    ...
    first.parent = core::ptr::null_mut();
    first.parent_overlap = 0;
    rbd_assert(first.parent_spec);
    rbd_spec_put(first.parent_spec);
    first.parent_spec = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn do_rbd_remove(buf: *const c_char, count: usize) -> isize {
...
// IO to complete/fail.
//
    let mut memflags: c_uint = blk_mq_freeze_queue(rbd_dev.disk.queue);
...
#[no_mangle]
unsafe extern "C" fn remove_store(bus: *const bus_type, buf: *const c_char, count: usize) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn rbd_sysfs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rbd_sysfs_cleanup() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn rbd_slab_init() -> int __init {
    ...
    rbd_img_request_cache = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn rbd_slab_exit() {
    static void rbd_slab_exit(void)
    {
    rbd_assert(rbd_obj_request_cache);
    kmem_cache_destroy(rbd_obj_request_cache);
    rbd_obj_request_cache = core::ptr::null_mut();
    rbd_assert(rbd_img_request_cache);
    kmem_cache_destroy(rbd_img_request_cache);
    rbd_img_request_cache = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn rbd_init() -> int __init {
    static int __init rbd_init(void)
    {
    int rc;
    if (!libceph_compatible(core::ptr::null_mut())) {
    rbd_warn(core::ptr::null_mut(), "libceph incompatibility (quitting)");
    return -EINVAL;
    }
    rc = rbd_slab_init();
    if (rc)
...
#[no_mangle]
unsafe extern "C" fn rbd_exit() -> void __exit {
