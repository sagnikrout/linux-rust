...
//! Source: drivers/block/aoe/aoechr.c
#![no_std]
...
//
    ...
    for (i = 0; i < ARRAY_SIZE(chardevs); ++i)
    device_create(&aoe_class, core::ptr::null_mut(),
    MKDEV(AOE_MAJOR, chardevs[i].minor), core::ptr::null_mut(),
    chardevs[i].name);
    return 0;
    }
    void
