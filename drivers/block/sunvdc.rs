...
pub const VDC_TX_RING_SIZE: c_int = 512;
pub const VDC_DEFAULT_BLK_SIZE: c_int = 512;

pub const WAITING_FOR_LINK_UP: c_uint = 0x01;
pub const WAITING_FOR_TX_SPACE: c_uint = 0x02;
pub const WAITING_FOR_GEN_CMD: c_uint = 0x04;

pub const VDC_MAX_RETRIES: c_int = 10;
    static struct workqueue_struct *sunvdc_wq;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdc_req_entry {
    pub req: *mut request,
}
...
pub struct vdc_port {
    ...
    pub cmp: *mut vdc_completion,
    pub req_id: u64,
    pub seq: u64,
    pub rq_arr: [vdc_req_entry; VDC_TX_RING_SIZE],
    pub ring_cookies: c_ulong,
    pub max_xfer_size: u64,
    pub vdisk_block_size: u32,
    pub drain: u32,
    pub ldc_timeout: u64,
    pub ldc_reset_timer_work: delayed_work,
    pub ldc_reset_work: work_struct,
...
//
    ...
    pub vdisk_type: u8,
    pub vdisk_mtype: u8,
    pub vdisk_phys_blksz: u32,
    pub tag_set: blk_mq_tag_set,
    pub disk_name: [c_char; 32],
}
...
pub const PARTITION_SHIFT: c_int = 3;
#[no_mangle]
pub unsafe extern "C" fn vdc_tx_dring_avail(dr: *mut vio_dring_state) -> u32 {
    static inline u32 vdc_tx_dring_avail(struct vio_dring_state *dr)
    {
    return vio_dring_avail(dr, VDC_TX_RING_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn vdc_getgeo(disk: *mut gendisk, geo: *mut hd_geometry) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdc_blk_queue_start(port: *mut vdc_port) {
...
#[no_mangle]
unsafe extern "C" fn vdc_finish(vio: *mut vio_driver_state, err: c_int, waiting_for: c_int) {
    ...
    vio.cmp = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn vdc_handshake_complete(vio: *mut vio_driver_state) {
...
#[no_mangle]
unsafe extern "C" fn vdc_handle_unknown(port: *mut vdc_port, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdc_send_attr(vio: *mut vio_driver_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdc_handle_attr(vio: *mut vio_driver_state, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdc_end_special(port: *mut vdc_port, desc: *mut vio_disk_desc) {
    static void vdc_end_special(struct vdc_port *port, struct vio_disk_desc *desc)
    {
    let mut err: c_int = desc.status;
    ...
    rqe.req = core::ptr::null_mut();
    blk_mq_end_request(req, desc.status ? BLK_STS_IOERR : 0);
    vdc_blk_queue_start(port);
    }
#[no_mangle]
unsafe extern "C" fn vdc_ack(port: *mut vdc_port, msgbuf: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdc_nack(port: *mut vdc_port, msgbuf: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdc_event(arg: *mut c_void, event: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(VIO_SUBTYPE_NACK: msgbuf.tag.stype ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn __vdc_tx_trigger(port: *mut vdc_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __send_request(req: *mut request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn generic_request(port: *mut vdc_port, op: u8, buf: *mut c_void, len: c_int) -> c_int {
...
//
    ...
    port.vio.cmp = core::ptr::null_mut();
    spin_unlock_irqrestore(&port.vio.lock, flags);
    }
...
#[no_mangle]
unsafe extern "C" fn vdc_alloc_tx_ring(port: *mut vdc_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdc_free_tx_ring(port: *mut vdc_port) {
...
#[no_mangle]
unsafe extern "C" fn vdc_port_up(port: *mut vdc_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vdc_port_down(port: *mut vdc_port) {
...
#[no_mangle]
unsafe extern "C" fn probe_disk(port: *mut vdc_port) -> c_int {
...
//
    ...
    err = device_add_disk(&port.vio.vdev.dev, g, core::ptr::null_mut());
    if (err)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vdc_check_port_data {
    pub dev_no: c_int,
    pub type: *mut c_char,
}

#[no_mangle]
unsafe extern "C" fn vdc_device_probed(dev: *mut device, arg: *const c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vdc_port_mpgroup_check(vdev: *mut vio_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vdc_port_probe(vdev: *mut vio_dev, id: *const vio_device_id) -> c_int {
...
// single page.
//
    ldc_timeout = mdesc_get_property(hp, vdev.mp, "vdc-timeout", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vdc_port_remove(vdev: *mut vio_dev) {
    ...
    vdc_free_tx_ring(port);
    vio_ldc_free(&port.vio);
    dev_set_drvdata(&vdev.dev, core::ptr::null_mut());
    kfree(port);
    }
    }
#[no_mangle]
unsafe extern "C" fn vdc_requeue_inflight(port: *mut vdc_port) {
...
#[no_mangle]
unsafe extern "C" fn vdc_queue_drain(port: *mut vdc_port) {
...
#[no_mangle]
unsafe extern "C" fn vdc_ldc_reset_timer_work(work: *mut work_struct) {
    static void vdc_ldc_reset_timer_work(struct work_struct *work)
    {
    struct vdc_port *port;
...
#[no_mangle]
unsafe extern "C" fn vdc_ldc_reset_work(work: *mut work_struct) {
    static void vdc_ldc_reset_work(struct work_struct *work)
    {
    struct vdc_port *port;
    struct vio_driver_state *vio;
...
#[no_mangle]
unsafe extern "C" fn vdc_ldc_reset(port: *mut vdc_port) {
    static void vdc_ldc_reset(struct vdc_port *port)
    {
    int err;
...
#[no_mangle]
unsafe extern "C" fn vdc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vdc_exit() -> void __exit {
