...
//! Source: drivers/block/null_blk/zoned.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mb_to_sects(mb: c_ulong) -> sector_t {
    static inline sector_t mb_to_sects(unsigned long mb)
    {
    return ((sector_t)mb * SZ_1M) >> SECTOR_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn null_zone_no(dev: *mut nullb_device, sect: sector_t) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn null_register_zoned_dev(nullb: *mut nullb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn null_free_zoned_dev(dev: *mut nullb_device) {
...
//
    ...
    let mut nr_sectors: c_uint = DIV_ROUND_UP(len, SECTOR_SIZE);
...
#[no_mangle]
unsafe extern "C" fn null_close_imp_open_zone(dev: *mut nullb_device) {
...
#[no_mangle]
unsafe extern "C" fn null_check_active(dev: *mut nullb_device) -> blk_status_t {
...
#[no_mangle]
unsafe extern "C" fn null_check_open(dev: *mut nullb_device) -> blk_status_t {
...
// Should never be called for other states
    ...
    let mut zno: c_uint = null_zone_no(dev, sector);
...
#[no_mangle]
pub unsafe extern "C" fn if(BLK_ZONE_COND_IMP_OPEN: zone->cond ==) -> else {
