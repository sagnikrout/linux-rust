...
//! Source: drivers/block/null_blk/main.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn mb_per_tick(mbps: c_int) -> u64 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nullb_page {
    pub page: *mut page,
    pub MAP_SZ): DECLARE_BITMAP(bitmap,,
}
    ...
    let mut g_submit_queues: static int = 1;
    module_param_named(submit_queues, g_submit_queues, int, 0444);
    MODULE_PARM_DESC(submit_queues, "Number of submission queues");
    let mut g_poll_queues: static int = 1;
    module_param_named(poll_queues, g_poll_queues, int, 0444);
    MODULE_PARM_DESC(poll_queues, "Number of IOPOLL submission queues");
    let mut g_home_node: static int = NUMA_NO_NODE;
...
//
    ...
    let mut g_queue_mode: static int = NULL_Q_MQ;
#[no_mangle]
unsafe extern "C" fn null_param_store_val(str: *const c_char, val: *mut c_int, min: c_int, max: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn null_set_queue_mode(str: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    let mut g_gb: static int = 250;
    module_param_named(gb, g_gb, int, 0444);
    MODULE_PARM_DESC(gb, "Size in GB");
    let mut g_bs: static int = 512;
    module_param_named(bs, g_bs, int, 0444);
    MODULE_PARM_DESC(bs, "Block size (in bytes)");
    static int g_max_sectors;
    module_param_named(max_sectors, g_max_sectors, int, 0444);
    MODULE_PARM_DESC(max_sectors, "Maximum size of a command (in 512B sectors)");
    let mut nr_devices: static unsigned int = 1;
    ...
    let mut g_irqmode: static int = NULL_IRQ_SOFTIRQ;
#[no_mangle]
unsafe extern "C" fn null_set_irqmode(str: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    let mut g_completion_nsec: static unsigned long = 10000;
    module_param_named(completion_nsec, g_completion_nsec, ulong, 0444);
    MODULE_PARM_DESC(completion_nsec, "Time in ns to complete a request in hardware. Default: 10,000ns");
    let mut g_hw_queue_depth: static int = 64;
    ...
    let mut g_fua: static bool = true;
    ...
    let mut g_zone_size: static unsigned long = 256;
    ...
    let mut g_zone_append_max_sectors: static int = INT_MAX;
    ...
    {
    return item ? container_of(to_config_group(item), struct nullb_device, group) : core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn nullb_device_uint_attr_show(val: c_uint, page: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn nullb_device_bool_attr_show(val: bool, page: *mut c_char) -> isize {
...
// on error, revert the queue numbers
    ...
    NULLB_DEVICE_ATTR(size, ulong, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(completion_nsec, ulong, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(submit_queues, uint, nullb_apply_submit_queues);
    NULLB_DEVICE_ATTR(poll_queues, uint, nullb_apply_poll_queues);
    NULLB_DEVICE_ATTR(home_node, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(queue_mode, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(blocksize, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(max_sectors, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(irqmode, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(hw_queue_depth, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(index, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(blocking, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(use_per_node_hctx, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(memory_backed, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(discard, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(mbps, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(cache_size, ulong, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(zoned, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(zone_size, ulong, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(zone_capacity, ulong, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(zone_nr_conv, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(zone_max_open, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(zone_max_active, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(zone_append_max_sectors, uint, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(zone_full, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(virt_boundary, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(no_sched, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(shared_tags, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(shared_tag_bitmap, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(fua, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(rotational, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(badblocks_once, bool, core::ptr::null_mut());
    NULLB_DEVICE_ATTR(badblocks_partial_io, bool, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn nullb_device_power_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nullb_device_badblocks_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn nullb_device_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn nullb_add_fault_config(dev: *mut nullb_device) {
...
#[no_mangle]
unsafe extern "C" fn nullb_del_fault_config(dev: *mut nullb_device) {
...
#[no_mangle]
unsafe extern "C" fn memb_group_features_show(item: *mut config_item, page: *mut c_char) -> isize {
    static ssize_t memb_group_features_show(struct config_item *item, char *page)
    {
    struct configfs_attribute **entry;
    let mut delimiter: c_char = ',';
    let mut left: usize = PAGE_SIZE;
...
#[no_mangle]
pub unsafe extern "C" fn null_cache_active(nullb: *mut nullb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn null_free_dev(dev: *mut nullb_device) {
    static void null_free_dev(struct nullb_device *dev)
    {
    if (!dev)
    return;
...
#[no_mangle]
unsafe extern "C" fn null_cmd_timer_expired(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn null_cmd_end_timer(cmd: *mut nullb_cmd) {
    static void null_cmd_end_timer(struct nullb_cmd *cmd)
    {
    let mut kt: ktime_t = cmd.nq.dev.completion_nsec;
    hrtimer_start(&cmd.timer, kt, HRTIMER_MODE_REL);
    }
#[no_mangle]
unsafe extern "C" fn null_complete_rq(rq: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn null_free_page(t_page: *mut nullb_page) {
...
#[no_mangle]
unsafe extern "C" fn null_page_empty(page: *mut nullb_page) -> bool {
    static bool null_page_empty(struct nullb_page *page)
    {
    let mut size: c_int = MAP_SZ - 2;
...
#[no_mangle]
unsafe extern "C" fn null_free_device_storage(dev: *mut nullb_device, is_cache: bool) {
    static void null_free_device_storage(struct nullb_device *dev, bool is_cache)
    {
    ...
    {
    struct nullb_page *page = core::ptr::null_mut();
    if (!ignore_cache)
...
#[no_mangle]
unsafe extern "C" fn null_flush_cache_page(nullb: *mut nullb, c_page: *mut nullb_page) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn null_make_cache_space(nullb: *mut nullb, n: c_ulong) -> c_int {
    static int null_make_cache_space(struct nullb *nullb, unsigned long n)
    {
    int i, err, nr_pages;
    struct nullb_page *c_pages[FREE_BATCH];
    let mut flushed: c_ulong = 0, one_round;
    again:
...
//
    ...
    c_pages[i] = core::ptr::null_mut();
    else
    __set_bit(NULLB_PAGE_LOCK, c_pages[i].bitmap);
    }
    one_round = 0;
    for (i = 0; i < nr_pages; i++) {
    if (c_pages[i] == core::ptr::null_mut())
    continue;
...
// give other threads a chance
    ...
    let mut n: usize = nr_sectors << SECTOR_SHIFT;
    size_t temp;
    spin_lock_irq(&nullb.lock);
    while (n > 0) {
...
#[no_mangle]
unsafe extern "C" fn null_handle_flush(nullb: *mut nullb) -> blk_status_t {
    ...
    let mut err: blk_status_t = BLK_STS_OK;
    let mut valid_len: c_uint = len;
    void *p;
...
//
    ...
    let mut err: blk_status_t = BLK_STS_OK;
    unsigned int len;
    let mut pos: loff_t = blk_rq_pos(rq) << SECTOR_SHIFT;
    let mut max_bytes: c_uint = nr_sectors << SECTOR_SHIFT;
    let mut transferred_bytes: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn null_handle_throttled(cmd: *mut nullb_cmd) -> blk_status_t {
    static inline blk_status_t null_handle_throttled(struct nullb_cmd *cmd)
    {
    struct nullb_device *dev = cmd.nq.dev;
    struct nullb *nullb = dev.nullb;
    let mut sts: blk_status_t = BLK_STS_OK;
    struct request *rq = blk_mq_rq_from_pdu(cmd);
...
//
    ...
    struct nullb_device *dev = cmd.nq.dev;
    let mut block_sectors: c_uint = dev.blocksize >> SECTOR_SHIFT;
    sector_t first_bad, bad_sectors;
    let mut partial_io_sectors: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn nullb_zero_read_cmd_buffer(cmd: *mut nullb_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn nullb_complete_cmd(cmd: *mut nullb_cmd) {
...
// Complete IO by inline, softirq or timer
    ...
    {
    struct nullb_device *dev = cmd.nq.dev;
    let mut badblocks_ret: blk_status_t = BLK_STS_OK;
    blk_status_t ret;
...
#[no_mangle]
unsafe extern "C" fn nullb_bwtimer_fn(timer: *mut hrtimer) -> enum hrtimer_restart {
    static enum hrtimer_restart nullb_bwtimer_fn(struct hrtimer *timer)
    {
    struct nullb *nullb = container_of(timer, struct nullb, bw_timer);
    let mut timer_interval: ktime_t = ktime_set(0, TIMER_INTERVAL);
    let mut mbps: c_uint = nullb.dev.mbps;
...
#[no_mangle]
unsafe extern "C" fn nullb_setup_bwtimer(nullb: *mut nullb) {
...
#[no_mangle]
unsafe extern "C" fn should_timeout_request(rq: *mut request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn should_requeue_request(rq: *mut request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn should_init_hctx_fail(dev: *mut nullb_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn null_map_queues(set: *mut blk_mq_tag_set) {
    static void null_map_queues(struct blk_mq_tag_set *set)
    {
    struct nullb *nullb = set.driver_data;
    int i, qoff;
    let mut submit_queues: c_uint = g_submit_queues;
    let mut poll_queues: c_uint = g_poll_queues;
    if (nullb) {
    struct nullb_device *dev = nullb.dev;
//
...
#[no_mangle]
unsafe extern "C" fn null_poll(hctx: *mut blk_mq_hw_ctx, iob: *mut io_comp_batch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn null_timeout_rq(rq: *mut request) -> enum blk_eh_timer_return {
...
//
    ...
    struct nullb_cmd *cmd = blk_mq_rq_to_pdu(rq);
    struct nullb_queue *nq = hctx.driver_data;
    let mut nr_sectors: sector_t = blk_rq_sectors(rq);
    let mut sector: sector_t = blk_rq_pos(rq);
    let mut is_poll: bool = hctx.type == HCTX_TYPE_POLL;
...
//
    ...
    let mut sts: blk_status_t = null_handle_throttled(cmd);
    if (sts != BLK_STS_OK)
    return sts;
    }
...
#[no_mangle]
unsafe extern "C" fn null_queue_rqs(rqlist: *mut rq_list) {
    static void null_queue_rqs(struct rq_list *rqlist)
    {
    let mut requeue_list: rq_list = {};
    let mut bd: blk_mq_queue_data = { };
    blk_status_t ret;
    do {
...
#[no_mangle]
unsafe extern "C" fn null_init_queue(nullb: *mut nullb, nq: *mut nullb_queue) {
...
#[no_mangle]
unsafe extern "C" fn null_del_dev(nullb: *mut nullb) {
    static void null_del_dev(struct nullb *nullb)
    {
    struct nullb_device *dev;
    if (!nullb)
    ...
    kfree(nullb);
    dev.nullb = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn null_config_discard(nullb: *mut nullb, lim: *mut queue_limits) {
...
#[no_mangle]
unsafe extern "C" fn setup_queues(nullb: *mut nullb) -> c_int {
    static int setup_queues(struct nullb *nullb)
    {
    let mut nqueues: c_int = nr_cpu_ids;
    if (g_poll_queues)
...
#[no_mangle]
unsafe extern "C" fn null_init_tag_set(set: *mut blk_mq_tag_set, poll_queues: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn null_init_global_tag_set() -> c_int {
    ...
    if (error)
    tag_set.ops = core::ptr::null_mut();
    return error;
    }
#[no_mangle]
unsafe extern "C" fn null_setup_tagset(nullb: *mut nullb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn null_validate_conf(dev: *mut nullb_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: dev->submit_queues ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn __null_setup_fault(attr: *mut fault_attr, str: *mut c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn null_setup_fault() -> bool {
...
#[no_mangle]
unsafe extern "C" fn null_add_dev(dev: *mut nullb_device) -> c_int {
    static int null_add_dev(struct nullb_device *dev)
    {
...
// Use configfs dir name as the device name
    ...
    static struct nullb *null_find_dev_by_name(const char *name)
    {
    struct nullb *nullb = core::ptr::null_mut(), *nb;
    guard(mutex)(&lock);
...
#[no_mangle]
unsafe extern "C" fn null_create_dev() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn null_destroy_dev(nullb: *mut nullb) {
...
#[no_mangle]
unsafe extern "C" fn null_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn null_exit() -> void __exit {
