...
//! Source: drivers/block/ublk_drv.c
#![no_std]
...
pub const UBLK_MAX_IO_DESC_SIZE: c_int = 256;
// ublk batch fetch uring_cmd
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ublk_batch_fetch_cmd {
    pub node: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ublk_batch_io_data {
    pub ub: *mut ublk_device,
    pub cmd: *mut io_uring_cmd,
    pub header: ublk_batch_io,
    pub issue_flags: c_uint,
    pub iob: *mut io_comp_batch,
}
...
// ublk server.
//
pub const UBLK_IO_FLAG_ACTIVE: c_uint = 0x01;
//
...
// cross verification
//
pub const UBLK_IO_FLAG_OWNED_BY_SRV: c_uint = 0x02;
//
...
//
pub const UBLK_IO_FLAG_NEED_GET_DATA: c_uint = 0x08;
//
...
//
pub const UBLK_IO_FLAG_AUTO_BUF_REG: c_uint = 0x10;
// atomic RW with ubq->cancel_lock
pub const UBLK_IO_FLAG_CANCELED: c_uint = 0x80000000;
//
...
pub struct ublk_queue {
    pub q_id: u16,
    pub q_depth: u16,
    pub io_desc_size: u16,
    pub flags: c_ulong,
    pub io_cmd_buf: *mut ublksrv_io_desc,
    pub force_abort: bool,
    pub canceling: bool,
    pub /: *mut *mut bool fail_io; / copy of dev->state == UBLK_S_DEV_FAIL_IO,
    pub cancel_lock: spinlock_t,
    pub dev: *mut ublk_device,
    pub nr_io_ready: u16,
//
...
//
    struct {
    pub short): DECLARE_KFIFO_PTR(evts_fifo, unsigned,
    pub evts_lock: spinlock_t,
// List of fetch commands available to process events
    pub fcmd_head: list_head,
// Currently active fetch command (NULL = none active)
    pub active_fcmd: *mut ublk_batch_fetch_cmd,
    pub __counted_by(q_depth): ublk_io ios[],
}

// Maple tree value: maps a PFN range to buffer location
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ublk_buf_range {
    pub buf_index: c_ushort,
    pub flags: c_ushort,
    pub /: *mut *mut unsigned int base_offset; / byte offset within buffer,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ublk_device {
    pub ub_disk: *mut gendisk,
    pub dev_info: ublksrv_ctrl_dev_info,
    pub tag_set: blk_mq_tag_set,
    pub cdev: cdev,
    pub cdev_dev: device,
pub const UB_STATE_OPEN: c_int = 0;
pub const UB_STATE_USED: c_int = 1;
pub const UB_STATE_DELETED: c_int = 2;
    pub state: c_ulong,
    pub ub_number: c_int,
    pub mutex: mutex,
    pub lock: spinlock_t,
    ...
    pub nr_queue_ready: u16,
    pub unprivileged_daemons: bool,
    pub cancel_mutex: mutex,
    pub canceling: bool,
    pub ublksrv_tgid: pid_t,
    pub exit_work: delayed_work,
    pub partition_scan_work: work_struct,
    pub /: *mut *mut bool block_open; / protected by open_mutex,
// shared memory zero copy
    pub buf_tree: maple_tree,
    pub buf_ida: ida,
    pub queues: [*mut ublk_queue; ],
}

// header of ublk_params
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ublk_params_header {
    pub len: __u32,
    pub types: __u32,
}
...
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_support_batch_io(ub: *const ublk_device) -> bool {
    static inline bool ublk_dev_support_batch_io(const struct ublk_device *ub)
    {
    return ub.dev_info.flags & UBLK_F_BATCH_IO;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_support_batch_io(ubq: *const ublk_queue) -> bool {
    static inline bool ublk_support_batch_io(const struct ublk_queue *ubq)
    {
    return ubq.flags & UBLK_F_BATCH_IO;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_io_lock(io: *mut ublk_io) {
    static inline void ublk_io_lock(struct ublk_io *io)
    {
    spin_lock(&io.lock);
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_io_unlock(io: *mut ublk_io) {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_io_evts_empty(q: *const ublk_queue) -> bool {
    static inline bool ublk_io_evts_empty(const struct ublk_queue *q)
    {
    return kfifo_is_empty(&q.evts_fifo);
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_io_evts_deinit(q: *mut ublk_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_support_zero_copy(ubq: *const ublk_queue) -> bool {
    static inline bool ublk_support_zero_copy(const struct ublk_queue *ubq)
    {
    return ubq.flags & UBLK_F_SUPPORT_ZERO_COPY;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_support_zero_copy(ub: *const ublk_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_support_shmem_zc(ubq: *const ublk_queue) -> bool {
    static inline bool ublk_support_shmem_zc(const struct ublk_queue *ubq)
    {
    return ubq.flags & UBLK_F_SHMEM_ZC;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_iod_is_shmem_zc(ubq: *const ublk_queue, tag: u16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_support_shmem_zc(ub: *const ublk_device) -> bool {
    static inline bool ublk_dev_support_shmem_zc(const struct ublk_device *ub)
    {
    return ub.dev_info.flags & UBLK_F_SHMEM_ZC;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_support_auto_buf_reg(ubq: *const ublk_queue) -> bool {
    static inline bool ublk_support_auto_buf_reg(const struct ublk_queue *ubq)
    {
    return ubq.flags & UBLK_F_AUTO_BUF_REG;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_support_auto_buf_reg(ub: *const ublk_device) -> bool {
    static inline bool ublk_dev_support_auto_buf_reg(const struct ublk_device *ub)
    {
    return ub.dev_info.flags & UBLK_F_AUTO_BUF_REG;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_support_user_copy(ubq: *const ublk_queue) -> bool {
    static inline bool ublk_support_user_copy(const struct ublk_queue *ubq)
    {
    return ubq.flags & UBLK_F_USER_COPY;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_support_user_copy(ub: *const ublk_device) -> bool {
    static inline bool ublk_dev_support_user_copy(const struct ublk_device *ub)
    {
    return ub.dev_info.flags & UBLK_F_USER_COPY;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_is_zoned(ub: *const ublk_device) -> bool {
    static inline bool ublk_dev_is_zoned(const struct ublk_device *ub)
    {
    return ub.dev_info.flags & UBLK_F_ZONED;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_queue_is_zoned(ubq: *const ublk_queue) -> bool {
    static inline bool ublk_queue_is_zoned(const struct ublk_queue *ubq)
    {
    return ubq.flags & UBLK_F_ZONED;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_support_integrity(ub: *const ublk_device) -> bool {
    static inline bool ublk_dev_support_integrity(const struct ublk_device *ub)
    {
    return ub.dev_info.flags & UBLK_F_INTEGRITY;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_req_build_flags(req: *mut request) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ublk_zoned_report_desc {
    pub sector: __u64,
    pub nr_zones: __u32,
}
...
#[no_mangle]
unsafe extern "C" fn ublk_get_nr_zones(ub: *const ublk_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_revalidate_disk_zones(ub: *mut ublk_device) -> c_int {
    static int ublk_revalidate_disk_zones(struct ublk_device *ub)
    {
    return blk_revalidate_disk_zones(ub.ub_disk);
    }
#[no_mangle]
unsafe extern "C" fn ublk_dev_param_zoned_validate(ub: *const ublk_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_dev_param_zoned_apply(ub: *mut ublk_device) {
...
// buflen = 0;
    ...
    let mut zone_size_sectors: c_uint = disk.queue.limits.chunk_sectors;
    let mut first_zone: c_uint = sector >> ilog2(zone_size_sectors);
    let mut done_zones: c_uint = 0;
    ...
    let mut remaining_zones: c_uint = nr_zones - done_zones;
...
#[no_mangle]
unsafe extern "C" fn ublk_validate_req_zoned(req: *const request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ublk_setup_iod_zoned(ubq: *mut ublk_queue, req: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn ublk_batch_free_fcmd(fcmd: *mut ublk_batch_fetch_cmd) {
    static void ublk_batch_free_fcmd(struct ublk_batch_fetch_cmd *fcmd)
    {
    kfree(fcmd);
    }
#[no_mangle]
unsafe extern "C" fn __ublk_release_fcmd(ubq: *mut ublk_queue) {
    static void __ublk_release_fcmd(struct ublk_queue *ubq)
    {
    WRITE_ONCE(ubq.active_fcmd, core::ptr::null_mut());
    }
//
...
// by cgroup.
//
    let mut unprivileged_ublks_max: static unsigned int = 64;
    static unsigned int unprivileged_ublks_added; /* protected by ublk_ctl_mutex */
    static struct miscdevice ublk_misc;
#[no_mangle]
pub unsafe extern "C" fn ublk_pos_to_hwq(pos: loff_t) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_pos_to_buf_off(pos: loff_t) -> unsigned {
    static inline unsigned ublk_pos_to_buf_off(loff_t pos)
    {
    return (pos - UBLKSRV_IO_BUF_OFFSET) & UBLK_IO_BUF_BITS_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_pos_to_tag(pos: loff_t) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ublk_dev_param_basic_apply(ub: *mut ublk_device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_integrity_flags(flags: u32) -> c_int {
    static int ublk_integrity_flags(u32 flags)
    {
    let mut ret_flags: c_int = BLK_SPLIT_INTERVAL_CAPABLE;
...
#[no_mangle]
unsafe extern "C" fn ublk_integrity_pi_tuple_size(csum_type: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_integrity_csum_type(csum_type: u8) -> enum blk_integrity_checksum {
...
#[no_mangle]
unsafe extern "C" fn ublk_validate_params(ub: *const ublk_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ublk_dev_is_zoned(ub)) -> else {
    ...
    let mut pi_tuple_size: c_int = ublk_integrity_pi_tuple_size(p.csum_type);
    let mut flags: c_int = ublk_integrity_flags(p.flags);
...
#[no_mangle]
unsafe extern "C" fn ublk_apply_params(ub: *mut ublk_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_need_map_io(ubq: *const ublk_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_need_map_io(ub: *const ublk_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_need_req_ref(ubq: *const ublk_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_need_req_ref(ub: *const ublk_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_get_req_ref(io: *mut ublk_io) -> bool {
    static inline bool ublk_get_req_ref(struct ublk_io *io)
    {
    return refcount_inc_not_zero(&io.ref);
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_put_req_ref(io: *mut ublk_io, req: *mut request) {
...
// ublk_need_map_io() and ublk_need_req_ref() are mutually exclusive
    __ublk_complete_rq(req, io, false, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_sub_req_ref(io: *mut ublk_io) -> bool {
    static inline bool ublk_sub_req_ref(struct ublk_io *io)
    {
    let mut sub_refs: unsigned = UBLK_REFCOUNT_INIT - io.task_registered_buffers;
    io.task_registered_buffers = 0;
    return refcount_sub_and_test(sub_refs, &io.ref);
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_need_get_data(ubq: *const ublk_queue) -> bool {
    static inline bool ublk_need_get_data(const struct ublk_queue *ubq)
    {
    return ubq.flags & UBLK_F_NEED_GET_DATA;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_need_get_data(ub: *const ublk_device) -> bool {
...
// Called in slow path only, keep it noinline for trace purpose
#[no_mangle]
unsafe extern "C" fn ublk_put_device(ub: *mut ublk_device) -> noinline void {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_queue_cmd_buf_size(ub: *const ublk_device) -> usize {
...
#[no_mangle]
unsafe extern "C" fn ublk_max_cmd_buf_size(ub: *const ublk_device) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn ublk_nosrv_should_reissue_outstanding(ub: *mut ublk_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ublk_nosrv_dev_should_queue_io(ub: *mut ublk_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ublk_nosrv_should_queue_io(ubq: *mut ublk_queue) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ublk_nosrv_should_stop_dev(ub: *mut ublk_device) -> bool {
    static inline bool ublk_nosrv_should_stop_dev(struct ublk_device *ub)
    {
    return !(ub.dev_info.flags & UBLK_F_USER_RECOVERY);
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_in_recoverable_state(ub: *mut ublk_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ublk_free_disk(disk: *mut gendisk) {
...
#[no_mangle]
unsafe extern "C" fn ublk_open(disk: *mut gendisk, mode: blk_mode_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_need_map_req(req: *const request) -> bool {
    static inline bool ublk_need_map_req(const struct request *req)
    {
    return blk_rq_has_data(req) && req_op(req) == REQ_OP_WRITE;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_need_unmap_req(req: *const request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ublk_setup_iod(ubq: *mut ublk_queue, req: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn ublk_end_request(req: *mut request, error: blk_status_t) {
...
// todo: handle partial completion
    ...
    let mut res: blk_status_t = BLK_STS_OK;
    bool requeue;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: likely(!blk_should_fake_timeout(req->q))) -> else {
...
pub const UBLK_REQUEUE_DELAY_MS: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn ublk_dispatch_req(ubq: *mut ublk_queue, req: *mut request) {
    static void ublk_dispatch_req(struct ublk_queue *ubq, struct request *req)
    {
    let mut issue_flags: c_uint = IO_URING_CMD_TASK_WORK_ISSUE_FLAGS;
    let mut tag: u16 = req.tag;
...
//
    ...
    let mut res: enum auto_buf_reg_res = AUTO_BUF_REG_FALLBACK;
    ...
    unsigned int len)
    {
    let mut has_unused: bool = false;
    unsigned int i;
    for (i = 0; i < len; i++) {
    let mut tag: c_ushort = tag_buf[i];
...
pub const MAX_NR_TAG: c_int = 128;
    static int __ublk_batch_dispatch(struct ublk_queue *ubq,
    const struct ublk_batch_io_data *data,
    struct ublk_batch_fetch_cmd *fcmd)
    {
    let mut tag_sz: c_uint = sizeof(unsigned short);
...
// Filter out unused tags before posting to userspace
    ...
    let mut new_len: c_int = ublk_filter_unused_tags(tag_buf, len);
...
#[no_mangle]
unsafe extern "C" fn ublk_batch_tw_cb(tw_req: io_tw_req, tw: io_tw_token_t) {
...
#[no_mangle]
unsafe extern "C" fn ublk_cmd_tw_cb(tw_req: io_tw_req, tw: io_tw_token_t) {
...
#[no_mangle]
unsafe extern "C" fn ublk_batch_queue_cmd(ubq: *mut ublk_queue, rq: *mut request, last: bool) {
    static void ublk_batch_queue_cmd(struct ublk_queue *ubq, struct request *rq, bool last)
    {
    let mut tag: c_ushort = rq.tag;
    struct ublk_batch_fetch_cmd *fcmd = core::ptr::null_mut();
    spin_lock(&ubq.evts_lock);
...
#[no_mangle]
unsafe extern "C" fn ublk_queue_cmd(ubq: *mut ublk_queue, rq: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn ublk_cmd_list_tw_cb(tw_req: io_tw_req, tw: io_tw_token_t) {
    ...
    do {
    next = rq.rq_next;
    rq.rq_next = core::ptr::null_mut();
    ublk_dispatch_req(rq.mq_hctx.driver_data, rq);
    rq = next;
    } while (rq);
    }
#[no_mangle]
unsafe extern "C" fn ublk_queue_cmd_list(io: *mut ublk_io, l: *mut rq_list) {
...
#[no_mangle]
unsafe extern "C" fn ublk_timeout(rq: *mut request) -> enum blk_eh_timer_return {
    static enum blk_eh_timer_return ublk_timeout(struct request *rq)
    {
    struct ublk_queue *ubq = rq.mq_hctx.driver_data;
    let mut tgid: pid_t = ubq.dev.ublksrv_tgid;
...
#[no_mangle]
unsafe extern "C" fn ublk_commit_rqs(hctx: *mut blk_mq_hw_ctx) {
...
#[no_mangle]
unsafe extern "C" fn ublk_queue_rqs(rqlist: *mut rq_list) {
    static void ublk_queue_rqs(struct rq_list *rqlist)
    {
    let mut requeue_list: rq_list = { };
    let mut submit_list: rq_list = { };
    struct ublk_io *io = core::ptr::null_mut();
    struct request *req;
...
#[no_mangle]
unsafe extern "C" fn ublk_batch_queue_cmd_list(ubq: *mut ublk_queue, l: *mut rq_list) {
...
#[no_mangle]
unsafe extern "C" fn ublk_batch_queue_rqs(rqlist: *mut rq_list) {
    static void ublk_batch_queue_rqs(struct rq_list *rqlist)
    {
    let mut requeue_list: rq_list = { };
    let mut submit_list: rq_list = { };
    struct ublk_queue *ubq = core::ptr::null_mut();
    struct request *req;
    while ((req = rq_list_pop(rqlist))) {
    struct ublk_queue *this_q = req.mq_hctx.driver_data;
    if (ublk_prep_req(this_q, req, true) != BLK_STS_OK) {
...
#[no_mangle]
unsafe extern "C" fn ublk_queue_reinit(ub: *mut ublk_device, ubq: *mut ublk_queue) {
...
#[no_mangle]
unsafe extern "C" fn ublk_ch_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_reset_ch_dev(ub: *mut ublk_device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_put_disk(disk: *mut gendisk) {
...
#[no_mangle]
unsafe extern "C" fn ublk_partition_scan_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ublk_set_canceling(ub: *mut ublk_device, canceling: bool) {
...
#[no_mangle]
unsafe extern "C" fn ublk_check_and_reset_active_ref(ub: *mut ublk_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ublk_ch_release_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ublk_ch_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_ch_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
    static int ublk_ch_mmap(struct file *filp, struct vm_area_struct *vma)
    {
    struct ublk_device *ub = filp.private_data;
    let mut sz: usize = vma.vm_end - vma.vm_start;
    let mut max_sz: usize = ublk_max_cmd_buf_size(ub);
...
//
    ...
    io.res = -EIO;
    __ublk_complete_rq(req, io, ublk_dev_need_map_io(ub), core::ptr::null_mut());
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ublk_abort_queue(ub: *mut ublk_device, ubq: *mut ublk_queue) {
    static void ublk_abort_queue(struct ublk_device *ub, struct ublk_queue *ubq)
    {
    u16 i;
    for (i = 0; i < ubq.q_depth; i++) {
...
#[no_mangle]
unsafe extern "C" fn ublk_start_cancel(ub: *mut ublk_device) {
...
//
    ...
    struct io_uring_cmd *cmd = core::ptr::null_mut();
    struct request *req;
    bool done;
...
#[no_mangle]
unsafe extern "C" fn ublk_batch_cancel_queue(ubq: *mut ublk_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_queue_ready(ubq: *const ublk_queue) -> bool {
    static inline bool ublk_queue_ready(const struct ublk_queue *ubq)
    {
    return ubq.nr_io_ready == ubq.q_depth;
    }
#[no_mangle]
pub unsafe extern "C" fn ublk_dev_ready(ub: *const ublk_device) -> bool {
    static inline bool ublk_dev_ready(const struct ublk_device *ub)
    {
    return ub.nr_queue_ready == ub.dev_info.nr_hw_queues;
    }
#[no_mangle]
unsafe extern "C" fn ublk_cancel_queue(ubq: *mut ublk_queue) {
...
#[no_mangle]
unsafe extern "C" fn ublk_cancel_dev(ub: *mut ublk_device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_check_inflight_rq(rq: *mut request, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ublk_wait_tagset_rqs_idle(ub: *mut ublk_device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_force_abort_dev(ub: *mut ublk_device) {
...
// Sync with ublk_abort_queue() by holding the lock
    ...
    ub.ub_disk = core::ptr::null_mut();
    spin_unlock(&ub.lock);
    return disk;
    }
#[no_mangle]
unsafe extern "C" fn ublk_stop_dev_unlocked(ub: *mut ublk_device) {
    static void ublk_stop_dev_unlocked(struct ublk_device *ub)
...
#[no_mangle]
unsafe extern "C" fn ublk_stop_dev(ub: *mut ublk_device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_reset_io_flags(ubq: *mut ublk_queue, io: *mut ublk_io) {
...
#[no_mangle]
unsafe extern "C" fn ublk_queue_reset_io_flags(ubq: *mut ublk_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_check_cmd_op(cmd_op: u32) -> c_int {
    static inline int ublk_check_cmd_op(u32 cmd_op)
    {
    let mut ioc_type: u32 = _IOC_TYPE(cmd_op);
...
#[no_mangle]
unsafe extern "C" fn ublk_io_release(priv: *mut c_void) {
    static void ublk_io_release(void *priv)
    {
...
#[no_mangle]
unsafe extern "C" fn ublk_check_fetch_buf(ub: *const ublk_device, buf_addr: __u64) -> c_int {
...
// allow each command to be FETCHed at most once
    ...
    WRITE_ONCE(io.task, core::ptr::null_mut());
    else
...
//
    ...
    if (!ret) {
    ublk_apply_io_buf(ub, io, cmd, buf_addr, &auto_buf, core::ptr::null_mut());
...
// May point to userspace-mapped memory
    ...
    let mut buf_idx: u16 = UBLK_INVALID_BUF_IDX;
    struct ublk_device *ub = cmd.file.private_data;
    struct ublk_queue *ubq;
    struct ublk_io *io = core::ptr::null_mut();
    let mut cmd_op: u32 = cmd.cmd_op;
    let mut q_id: u16 = READ_ONCE(ub_src.q_id);
    let mut tag: u16 = READ_ONCE(ub_src.tag);
    let mut result: i32 = READ_ONCE(ub_src.result);
...
#[no_mangle]
unsafe extern "C" fn ublk_ch_uring_cmd_cb(tw_req: io_tw_req, tw: io_tw_token_t) {
    static void ublk_ch_uring_cmd_cb(struct io_tw_req tw_req, io_tw_token_t tw)
    {
    let mut issue_flags: c_uint = IO_URING_CMD_TASK_WORK_ISSUE_FLAGS;
    struct io_uring_cmd *cmd = io_uring_cmd_from_tw(tw_req);
    let mut ret: c_int = -ECANCELED;
    if (!tw.cancel)
...
#[no_mangle]
unsafe extern "C" fn ublk_ch_uring_cmd(cmd: *mut io_uring_cmd, issue_flags: c_uint) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ublk_batch_io_iter {
    pub uaddr: *mut void __user,
    pub kaddr: *const u8,
    pub total: unsigned done,,
    pub elem_bytes: c_uchar,
// copy to this buffer from user space
    pub buf: [c_uchar; UBLK_CMD_BATCH_TMP_BUF_SZ],
}
    ...
    let mut len: c_uint = min(sizeof(iter.buf), iter.total - iter.done);
    if (iter.kaddr) {
...
// Re-process only what we've already processed, starting from beginning
    ...
    let mut buf: union ublk_io_buf = { 0 };
    int ret;
    if (ublk_dev_support_auto_buf_reg(data.ub))
    buf.auto_reg = ublk_batch_auto_buf_reg(uc, elem);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ublk_dev_need_map_io(data->ub)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ublk_handle_batch_prep_cmd(data: *const ublk_batch_io_data) -> c_int {
...
// BATCH_IO doesn't support UBLK_F_NEED_GET_DATA
    ...
    let mut buf_idx: u16 = UBLK_INVALID_BUF_IDX;
    let mut buf: union ublk_io_buf = { 0 };
    struct request *req = core::ptr::null_mut();
    let mut auto_reg: bool = false;
    let mut compl: bool = false;
    int ret;
    if (ublk_dev_support_auto_buf_reg(data.ub)) {
    buf.auto_reg = ublk_batch_auto_buf_reg(uc, elem);
    auto_reg = true;
...
#[no_mangle]
unsafe extern "C" fn ublk_handle_batch_commit_cmd(data: *mut ublk_batch_io_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_check_batch_cmd_flags(uc: *const ublk_batch_io) -> c_int {
    static int ublk_check_batch_cmd_flags(const struct ublk_batch_io *uc)
    {
    let mut elem_bytes: unsigned = sizeof(struct ublk_elem_header);
...
#[no_mangle]
unsafe extern "C" fn ublk_check_batch_cmd(data: *const ublk_batch_io_data) -> c_int {
    ...
    struct ublk_batch_fetch_cmd *fcmd)
    {
    struct ublk_batch_fetch_cmd *new_fcmd = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ublk_handle_batch_fetch_cmd(data: *mut ublk_batch_io_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_validate_batch_fetch_cmd(data: *mut ublk_batch_io_data) -> c_int {
    ...
    struct ublksrv_io_cmd);
    struct ublk_device *ub = cmd.file.private_data;
    let mut tag: u16 = READ_ONCE(ub_cmd.tag);
    let mut q_id: u16 = READ_ONCE(ub_cmd.q_id);
    let mut index: unsigned = READ_ONCE(ub_cmd.addr);
    struct ublk_queue *ubq;
    struct ublk_io *io;
...
#[no_mangle]
unsafe extern "C" fn ublk_ch_read_iter(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    static ssize_t ublk_ch_read_iter(struct kiocb *iocb, struct iov_iter *to)
    {
    return ublk_user_copy(iocb, to, ITER_DEST);
    }
#[no_mangle]
unsafe extern "C" fn ublk_ch_write_iter(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn __ublk_deinit_queue(ub: *mut ublk_device, ubq: *mut ublk_queue) {
...
#[no_mangle]
unsafe extern "C" fn ublk_deinit_queue(ub: *mut ublk_device, q_id: u16) {
    ...
    ub.queues[q_id] = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ublk_get_queue_numa_node(ub: *mut ublk_device, q_id: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_init_queue(ub: *mut ublk_device, q_id: u16) -> c_int {
    static int ublk_init_queue(struct ublk_device *ub, u16 q_id)
    {
    let mut depth: u16 = ub.dev_info.queue_depth;
    let mut gfp_flags: gfp_t = GFP_KERNEL | __GFP_ZERO;
    struct ublk_queue *ubq;
    struct page *page;
    int numa_node;
    size_t size;
...
#[no_mangle]
unsafe extern "C" fn ublk_deinit_queues(ub: *mut ublk_device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_init_queues(ub: *mut ublk_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_alloc_dev_number(ub: *mut ublk_device, idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_free_dev_number(ub: *mut ublk_device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_cdev_rel(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_add_chdev(ub: *mut ublk_device) -> c_int {
    static int ublk_add_chdev(struct ublk_device *ub)
    {
    struct device *dev = &ub.cdev_dev;
    let mut minor: c_int = ub.ub_number;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ublk_align_max_io_size(ub: *mut ublk_device) {
    static void ublk_align_max_io_size(struct ublk_device *ub)
    {
    let mut max_io_bytes: c_uint = ub.dev_info.max_io_buf_bytes;
    ub.dev_info.max_io_buf_bytes =
    round_down(max_io_bytes, PAGE_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn ublk_add_tag_set(ub: *mut ublk_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_remove(ub: *mut ublk_device) {
    ...
    {
    struct ublk_device *ub = core::ptr::null_mut();
    if (idx < 0)
    return core::ptr::null_mut();
    spin_lock(&ublk_idr_lock);
...
#[no_mangle]
unsafe extern "C" fn ublk_validate_user_pid(ub: *mut ublk_device, ublksrv_pid: pid_t) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ublk_wait_dev_ready_and_lock(ub: *mut ublk_device) -> c_int {
    ...
    {
    const struct ublk_param_basic *p = &ub.params.basic;
    let mut ublksrv_pid: c_int = (int)header.data[0];
    ...
    disk = blk_mq_alloc_disk(&ub.tag_set, &lim, core::ptr::null_mut());
    if (IS_ERR(disk)) {
    ret = PTR_ERR(disk);
    goto out_unlock;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ublk_dump_dev_info(info: *mut ublksrv_ctrl_dev_info) {
...
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_add_dev(header: *const ublksrv_ctrl_cmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(UBLK_F_UNPRIVILEGED_DEV): !(info.flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ublk_idr_freed(id: c_int) -> bool {
    ...
    spin_unlock(&ublk_idr_lock);
    let mut ptr: return = = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_del_dev(p_ub: *mut ublk_device, wait: bool) -> c_int {
    static int ublk_ctrl_del_dev(struct ublk_device **p_ub, bool wait)
    {
    struct ublk_device *ub = *p_ub;
    let mut idx: c_int = ub.ub_number;
    int ret;
    ret = mutex_lock_killable(&ublk_ctl_mutex);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_stop_dev(ub: *mut ublk_device) {
    static void ublk_ctrl_stop_dev(struct ublk_device *ub)
    {
    ublk_stop_dev(ub);
    }
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_try_stop_dev(ub: *mut ublk_device) -> c_int {
...
// release open_mutex as del_gendisk() will reacquire it
    ...
    let mut init_ublksrv_tgid: pid_t = ub.dev_info.ublksrv_pid;
    void __user *argp = (void __user *)(unsigned long)header.addr;
    ...
    if (p) {
    let mut vnr: c_int = task_tgid_vnr(p);
    if (vnr)
...
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_fill_params_devt(ub: *mut ublk_device) {
...
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_start_recovery(ub: *mut ublk_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_get_features(header: *const ublksrv_ctrl_cmd) -> c_int {
    static int ublk_ctrl_get_features(const struct ublksrv_ctrl_cmd *header)
    {
    void __user *argp = (void __user *)(unsigned long)header.addr;
    let mut features: u64 = UBLK_F_ALL;
...
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_set_size(ub: *mut ublk_device, header: *const ublksrv_ctrl_cmd) -> c_int {
    static int ublk_ctrl_set_size(struct ublk_device *ub, const struct ublksrv_ctrl_cmd *header)
    {
    struct ublk_param_basic *p = &ub.params.basic;
    let mut new_size: u64 = header.data[0];
    let mut ret: c_int = 0;
    mutex_lock(&ub.mutex);
    if (!ub.ub_disk) {
    ret = -ENODEV;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct count_busy {
    pub ubq: *const ublk_queue,
    pub nr_busy: u16,
}

#[no_mangle]
unsafe extern "C" fn ublk_count_busy_req(rq: *mut request, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ubq_has_idle_io(ubq: *const ublk_queue) -> bool {
...
//
    ...
    ret = -EINTR;
#[no_mangle]
pub unsafe extern "C" fn if(timeout_ms: elapsed >=) -> else {
...
// zero means wait forever
    let mut timeout_ms: u64 = header.data[0];
    struct gendisk *disk;
...
//
#[no_mangle]
unsafe extern "C" fn ublk_lock_buf_tree(ub: *mut ublk_device) -> c_uint {
    static unsigned int ublk_lock_buf_tree(struct ublk_device *ub)
    {
    let mut memflags: c_uint = 0;
    mutex_lock(&ub.mutex);
    if (ub.ub_disk)
...
#[no_mangle]
unsafe extern "C" fn ublk_unlock_buf_tree(ub: *mut ublk_device, memflags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ublk_buf_erase_ranges(ub: *mut ublk_device, buf_index: c_int) {
    ...
    let mut pfn: c_ulong = page_to_pfn(pages[i]);
    let mut start: c_ulong = i;
    struct ublk_buf_range *range;
...
// Pin pages before any locks (may sleep)
    ...
    unsigned long nr_pages)
    {
pub const UBLK_UNPIN_BATCH: c_int = 32;
...
//
pub const UBLK_REMOVE_BATCH: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ublk_unpin_range {
...
//
#[no_mangle]
unsafe extern "C" fn ublk_shmem_remove_ranges(ub: *mut ublk_device, buf_index: c_int) -> c_int {
    ...
    struct ublksrv_ctrl_cmd *header)
    {
    let mut index: c_int = (int)header.data[0];
    unsigned int memflags;
    int ret;
    if (!ublk_dev_support_shmem_zc(ub))
    return -EOPNOTSUPP;
...
#[no_mangle]
unsafe extern "C" fn ublk_buf_cleanup(ub: *mut ublk_device) {
    static void ublk_buf_cleanup(struct ublk_device *ub)
    {
...
// Check if request pages match a registered shared memory buffer
    ...
    struct bio_vec bv;
    let mut index: c_int = -1;
    let mut expected_offset: c_ulong = 0;
    let mut first: bool = true;
    rq_for_each_bvec(bv, rq, iter) {
    let mut pfn: c_ulong = page_to_pfn(bv.bv_page);
...
// buf_idx = index;
    ...
    {
    let mut unprivileged: bool = ub.dev_info.flags & UBLK_F_UNPRIVILEGED_DEV;
    void __user *argp = (void __user *)(unsigned long)header.addr;
    char *dev_path = core::ptr::null_mut();
    let mut ret: c_int = 0;
    int mask;
    if (!unprivileged) {
    if (!capable(CAP_SYS_ADMIN))
...
#[no_mangle]
unsafe extern "C" fn ublk_ctrl_uring_cmd_may_sleep(cmd_op: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ublk_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ublk_exit() -> void __exit {
