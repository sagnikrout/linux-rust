...
//! Source: drivers/block/n64cart.c
#![no_std]
...
pub const CART_DOMAIN: c_uint = 0x10000000;
pub const CART_MAX: c_uint = 0x1FFFFFFF;
pub const MIN_ALIGNMENT: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn n64cart_write_reg(reg: u8, value: u32) {
    static void n64cart_write_reg(const u8 reg, const u32 value)
    {
    writel(value, reg_base + reg);
    }
#[no_mangle]
unsafe extern "C" fn n64cart_read_reg(reg: u8) -> u32 {
    static u32 n64cart_read_reg(const u8 reg)
    {
    return readl(reg_base + reg);
    }
#[no_mangle]
unsafe extern "C" fn n64cart_wait_dma() {
...
//
#[no_mangle]
unsafe extern "C" fn n64cart_do_bvec(dev: *mut device, bv: *mut bio_vec, pos: u32) -> bool {
    static bool n64cart_do_bvec(struct device *dev, struct bio_vec *bv, u32 pos)
    {
    dma_addr_t dma_addr;
    let mut bstart: u32 = pos + start;
// Alignment check
...
#[no_mangle]
unsafe extern "C" fn n64cart_submit_bio(bio: *mut bio) {
    static void n64cart_submit_bio(struct bio *bio)
    {
    struct bio_vec bvec;
    struct bvec_iter iter;
    struct device *dev = bio.bi_bdev.bd_disk.private_data;
    let mut pos: u32 = bio.bi_iter.bi_sector << SECTOR_SHIFT;
...
//
#[no_mangle]
unsafe extern "C" fn n64cart_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn n64cart_init() -> int __init {
