...
//
    ...
    { ZLOOP_OPT_ERR,		core::ptr::null_mut()			}
    };
// Default values for the "add" operation.

pub const ZLOOP_DEF_NR_ZONES: c_int = 64;
pub const ZLOOP_DEF_NR_CONV_ZONES: c_int = 8;
pub const ZLOOP_DEF_MAX_OPEN_ZONES: c_int = 0;

pub const ZLOOP_DEF_NR_QUEUES: c_int = 1;
pub const ZLOOP_DEF_QUEUE_DEPTH: c_int = 128;

// Arbitrary limit on the zone size (16GB).
pub const ZLOOP_MAX_ZONE_SIZE_MB: c_int = 16384;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct zloop_device {
    ...
    pub data_dir: *mut file,
    pub zone_shift: c_uint,
    pub zone_size: sector_t,
    pub zone_capacity: sector_t,
    pub nr_zones: c_uint,
    pub nr_conv_zones: c_uint,
    ...
    pub dio_mem_align: c_uint,
    pub open_zones_lock: spinlock_t,
    pub open_zones_lru_list: list_head,
    pub nr_open_zones: c_uint,
    pub __counted_by(nr_zones): zloop_zone zones[],
}
...
#[no_mangle]
unsafe extern "C" fn rq_zone_no(rq: *mut request) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn zloop_can_open_zone(zlo: *mut zloop_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn zloop_close_imp_open_zone(zlo: *mut zloop_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn zloop_mark_full(zlo: *mut zloop_device, zone: *mut zloop_zone) {
...
#[no_mangle]
unsafe extern "C" fn zloop_mark_empty(zlo: *mut zloop_device, zone: *mut zloop_zone) {
...
#[no_mangle]
unsafe extern "C" fn zloop_update_seq_zone(zlo: *mut zloop_device, zone_no: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_open_zone(zlo: *mut zloop_device, zone_no: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_close_zone(zlo: *mut zloop_device, zone_no: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_reset_zone(zlo: *mut zloop_device, zone_no: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_reset_all_zones(zlo: *mut zloop_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_finish_zone(zlo: *mut zloop_device, zone_no: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_put_cmd(cmd: *mut zloop_cmd) {
...
#[no_mangle]
unsafe extern "C" fn zloop_rw_complete(iocb: *mut kiocb, ret: c_long) {
...
#[no_mangle]
unsafe extern "C" fn zloop_do_rw(cmd: *mut zloop_cmd) -> c_int {
    static int zloop_do_rw(struct zloop_cmd *cmd)
    {
    struct request *rq = blk_mq_rq_from_pdu(cmd);
    let mut rw: c_int = req_op(rq) == REQ_OP_READ ? ITER_DEST : ITER_SOURCE;
    let mut nr_bvec: c_uint = blk_rq_nr_bvec(rq);
    struct zloop_device *zlo = rq.q.queuedata;
...
#[no_mangle]
unsafe extern "C" fn zloop_seq_write_prep(cmd: *mut zloop_cmd) -> c_int {
    static int zloop_seq_write_prep(struct zloop_cmd *cmd)
    {
    struct request *rq = blk_mq_rq_from_pdu(cmd);
    struct zloop_device *zlo = rq.q.queuedata;
    let mut zone_no: c_uint = rq_zone_no(rq);
    let mut nr_sectors: sector_t = blk_rq_sectors(rq);
    let mut is_append: bool = req_op(rq) == REQ_OP_ZONE_APPEND;
    struct zloop_zone *zone = &zlo.zones[zone_no];
    let mut zone_end: sector_t = zone.start + zlo.zone_capacity;
    let mut ret: c_int = 0;
    spin_lock(&zone.wp_lock);
//
...
#[no_mangle]
unsafe extern "C" fn zloop_rw(cmd: *mut zloop_cmd) {
    ...
    let mut nr_sectors: sector_t = blk_rq_sectors(rq);
    let mut is_append: bool = req_op(rq) == REQ_OP_ZONE_APPEND;
    let mut is_write: bool = req_op(rq) == REQ_OP_WRITE || is_append;
    struct zloop_zone *zone;
...
#[no_mangle]
pub unsafe extern "C" fn zloop_zone_is_active(zone: *mut zloop_zone) -> bool {
...
#[no_mangle]
unsafe extern "C" fn zloop_record_safe_wps(zlo: *mut zloop_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zloop_flush(zlo: *mut zloop_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_handle_cmd(cmd: *mut zloop_cmd) {
...
#[no_mangle]
unsafe extern "C" fn zloop_cmd_workfn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn zloop_complete_rq(rq: *mut request) {
    static void zloop_complete_rq(struct request *rq)
    {
    struct zloop_cmd *cmd = blk_mq_rq_to_pdu(rq);
    struct zloop_device *zlo = rq.q.queuedata;
    let mut zone_no: c_uint = cmd.sector >> zlo.zone_shift;
    struct zloop_zone *zone = &zlo.zones[zone_no];
...
#[no_mangle]
unsafe extern "C" fn zloop_set_zone_append_sector(rq: *mut request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn zloop_open(disk: *mut gendisk, mode: blk_mode_t) -> c_int {
    ...
    let mut zone_no: c_uint = first + i;
    struct zloop_zone *zone = &zlo.zones[zone_no];
    mutex_lock(&zone.lock);
    if (test_and_clear_bit(ZLOOP_ZONE_SEQ_ERROR, &zone.flags)) {
    ret = zloop_update_seq_zone(zlo, zone_no);
...
#[no_mangle]
unsafe extern "C" fn zloop_free_disk(disk: *mut gendisk) {
...
#[no_mangle]
unsafe extern "C" fn zloop_dev_exists(zlo: *mut zloop_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn zloop_ctl_add(opts: *mut zloop_options) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_forget_cache(zlo: *mut zloop_device) {
...
#[no_mangle]
unsafe extern "C" fn zloop_ctl_remove(opts: *mut zloop_options) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_parse_options(opts: *mut zloop_options, buf: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_ctl_show(seq_file: *mut seq_file, private: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_ctl_open(inode: *mut inode, file: *mut file) -> c_int {
    static int zloop_ctl_open(struct inode *inode, struct file *file)
    {
    file.private_data = core::ptr::null_mut();
    return single_open(file, zloop_ctl_show, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn zloop_ctl_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zloop_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn zloop_exit() -> void __exit {
