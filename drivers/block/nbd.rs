...
// Macro flag: #define CREATE_TRACE_POINTS
    ...
    let mut nbd_total_devices: static int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nbd_sock {
    pub sock: *mut socket,
    pub tx_lock: mutex,
    pub pending: *mut request,
    pub sent: c_int,
    pub dead: bool,
    pub fallback_index: c_int,
    pub cookie: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct recv_thread_args {
    pub work: work_struct,
    pub nbd: *mut nbd_device,
    pub nsock: *mut nbd_sock,
    pub index: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct link_dead_args {
    pub work: work_struct,
    pub index: c_int,
}

pub const NBD_RT_TIMEDOUT: c_int = 0;
pub const NBD_RT_DISCONNECT_REQUESTED: c_int = 1;
pub const NBD_RT_DISCONNECTED: c_int = 2;
pub const NBD_RT_HAS_PID_FILE: c_int = 3;
pub const NBD_RT_HAS_CONFIG_REF: c_int = 4;
pub const NBD_RT_BOUND: c_int = 5;
pub const NBD_RT_DISCONNECT_ON_CLOSE: c_int = 6;
pub const NBD_RT_HAS_BACKEND_FILE: c_int = 7;
pub const NBD_DESTROY_ON_DISCONNECT: c_int = 0;
pub const NBD_DISCONNECT_REQUESTED: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nbd_config {
    pub flags: u32,
    pub runtime_flags: c_ulong,
    pub dead_conn_timeout: u64,
    pub socks: *mut nbd_sock,
    pub num_connections: c_int,
    pub live_connections: core::sync::atomic::AtomicI32,
    pub conn_wait: wait_queue_head_t,
    pub recv_threads: core::sync::atomic::AtomicI32,
    pub recv_wq: wait_queue_head_t,
    pub blksize_bits: c_uint,
    pub bytesize: loff_t,
...
#[no_mangle]
pub unsafe extern "C" fn nbd_blksize(config: *mut nbd_config) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nbd_device {
    pub tag_set: blk_mq_tag_set,
    pub index: c_int,
    pub config_refs: refcount_t,
    pub refs: refcount_t,
    pub config: *mut nbd_config,
    pub config_lock: mutex,
    pub disk: *mut gendisk,
    pub recv_workq: *mut workqueue_struct,
    pub remove_work: work_struct,
    pub list: list_head,
    pub task_setup: *mut task_struct,
    pub flags: c_ulong,
    pub /: *mut *mut pid_t pid; / pid of nbd-client, if attached,
    pub backend: *mut c_char,
}

pub const NBD_CMD_REQUEUED: c_int = 1;
//
...
// by cmd->lock.
//
pub const NBD_CMD_INFLIGHT: c_int = 2;
// Just part of request header or data payload is sent successfully
pub const NBD_CMD_PARTIAL_SEND: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nbd_cmd {
    pub nbd: *mut nbd_device,
...
pub const NBD_DEF_BLKSIZE_BITS: c_int = 10;
    let mut nbds_max: static unsigned int = 16;
    let mut max_part: static int = 16;
    let mut pre_defined_connections: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn nbd_requeue_cmd(cmd: *mut nbd_cmd) {
...
pub const NBD_COOKIE_BITS: c_int = 32;
#[no_mangle]
unsafe extern "C" fn nbd_cmd_handle(cmd: *mut nbd_cmd) -> u64 {
    static u64 nbd_cmd_handle(struct nbd_cmd *cmd)
    {
    struct request *req = blk_mq_rq_from_pdu(cmd);
    let mut tag: u32 = blk_mq_unique_tag(req);
    let mut cookie: u64 = cmd.cmd_cookie;
    return (cookie << NBD_COOKIE_BITS) | tag;
    }
#[no_mangle]
unsafe extern "C" fn nbd_handle_to_tag(handle: u64) -> u32 {
    static u32 nbd_handle_to_tag(u64 handle)
    {
    return (u32)handle;
    }
#[no_mangle]
unsafe extern "C" fn nbd_handle_to_cookie(handle: u64) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nbd_dev_remove(nbd: *mut nbd_device) {
...
#[no_mangle]
unsafe extern "C" fn nbd_dev_remove_work(work: *mut work_struct) {
    static void nbd_dev_remove_work(struct work_struct *work)
    {
    nbd_dev_remove(container_of(work, struct nbd_device, remove_work));
    }
#[no_mangle]
unsafe extern "C" fn nbd_put(nbd: *mut nbd_device) {
...
#[no_mangle]
unsafe extern "C" fn nbd_disconnected(config: *mut nbd_config) -> c_int {
    ...
    nsock.dead = true;
    nsock.pending = core::ptr::null_mut();
    nsock.sent = 0;
    }
#[no_mangle]
unsafe extern "C" fn nbd_apply_limits(lim: *mut queue_limits, flags: u32) {
...
#[no_mangle]
unsafe extern "C" fn nbd_set_size(nbd: *mut nbd_device, bytesize: loff_t, blksize: loff_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_complete_rq(req: *mut request) {
...
//
#[no_mangle]
unsafe extern "C" fn sock_shutdown(nbd: *mut nbd_device) {
...
#[no_mangle]
unsafe extern "C" fn req_to_nbd_cmd_type(req: *mut request) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nbd_xmit_timeout(req: *mut request) -> enum blk_eh_timer_return {
...
//
#[no_mangle]
pub unsafe extern "C" fn was_interrupted(result: c_int) -> c_int {
    static inline int was_interrupted(int result)
    {
    let mut result: return = = -ERESTARTSYS || result == -EINTR;
    }
//
...
//
    ...
    int result;
    let mut request: nbd_request = {.magic = htonl(NBD_REQUEST_MAGIC)};
    let mut iov: kvec = {.iov_base = &request, .iov_len = sizeof(request)};
    struct iov_iter from;
    struct bio *bio;
    u64 handle;
    u32 type;
    let mut nbd_cmd_flags: u32 = 0;
    let mut sent: c_int = nsock.sent, skip = 0;
    lockdep_assert_held(&cmd.lock);
...
//
    ...
    let mut is_last: bool = !next && bio_iter_last(bvec, iter);
    let mut flags: c_int = is_last ? 0 : MSG_MORE;
...
#[no_mangle]
unsafe extern "C" fn nbd_pending_cmd_work(work: *mut work_struct) {
    ...
    struct nbd_cmd *cmd = blk_mq_rq_to_pdu(req);
    struct nbd_device *nbd = cmd.nbd;
    let mut deadline: c_ulong = READ_ONCE(req.deadline);
    let mut wait_ms: c_uint = 2;
    mutex_lock(&cmd.lock);
...
// don't bother timeout handler for partial sending
    ...
    {
    let mut iov: kvec = {.iov_base = reply, .iov_len = sizeof(*reply)};
    struct iov_iter to;
    int result;
    reply.magic = 0;
    iov_iter_kvec(&to, ITER_DEST, &iov, 1, sizeof(*reply));
    result = __sock_xmit(nbd, sock, 0, &to, MSG_WAITALL, core::ptr::null_mut());
    if (result < 0) {
...
// NULL returned = something went wrong, inform userspace
    ...
    result = sock_xmit(nbd, index, 0, &to, MSG_WAITALL, core::ptr::null_mut());
    if (result < 0) {
...
#[no_mangle]
unsafe extern "C" fn recv_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn nbd_clear_req(req: *mut request, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nbd_clear_que(nbd: *mut nbd_device) {
    static void nbd_clear_que(struct nbd_device *nbd)
    {
    blk_mq_quiesce_queue(nbd.disk.queue);
    blk_mq_tagset_busy_iter(&nbd.tag_set, nbd_clear_req, core::ptr::null_mut());
    blk_mq_unquiesce_queue(nbd.disk.queue);
    dev_dbg(disk_to_dev(nbd.disk), "queue cleared\n");
    }
#[no_mangle]
unsafe extern "C" fn find_fallback(nbd: *mut nbd_device, index: c_int) -> c_int {
    static int find_fallback(struct nbd_device *nbd, int index)
    {
    struct nbd_config *config = nbd.config;
    let mut new_index: c_int = -1;
    struct nbd_sock *nsock = config.socks[index];
    let mut fallback: c_int = nsock.fallback_index;
    int i;
...
#[no_mangle]
unsafe extern "C" fn wait_for_reconnect(nbd: *mut nbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_handle_cmd(cmd: *mut nbd_cmd, index: c_int) -> blk_status_t {
...
#[no_mangle]
unsafe extern "C" fn nbd_reclassify_socket(sock: *mut socket) {
...
#[no_mangle]
unsafe extern "C" fn nbd_genl_reconnect_sock_cb(nbd: *mut nbd_device, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_bdev_reset(nbd: *mut nbd_device) {
...
#[no_mangle]
unsafe extern "C" fn nbd_parse_flags(nbd: *mut nbd_device) {
...
#[no_mangle]
unsafe extern "C" fn send_disconnects(nbd: *mut nbd_device) {
    ...
    iov_iter_kvec(&from, ITER_SOURCE, &iov, 1, sizeof(request));
    mutex_lock(&nsock.tx_lock);
    ret = sock_xmit(nbd, i, 1, &from, 0, core::ptr::null_mut());
    if (ret < 0)
    dev_err(disk_to_dev(nbd.disk),
...
#[no_mangle]
unsafe extern "C" fn nbd_disconnect(nbd: *mut nbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_clear_sock(nbd: *mut nbd_device) {
    static void nbd_clear_sock(struct nbd_device *nbd)
    {
    sock_shutdown(nbd);
    nbd_clear_que(nbd);
    nbd.task_setup = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn nbd_config_put(nbd: *mut nbd_device) {
    static void nbd_config_put(struct nbd_device *nbd)
    {
...
#[no_mangle]
unsafe extern "C" fn nbd_start_device(nbd: *mut nbd_device) -> c_int {
    static int nbd_start_device(struct nbd_device *nbd)
    {
    struct nbd_config *config = nbd.config;
    let mut num_connections: c_int = config.num_connections;
...
#[no_mangle]
unsafe extern "C" fn nbd_start_device_ioctl(nbd: *mut nbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_clear_sock_ioctl(nbd: *mut nbd_device) {
...
#[no_mangle]
unsafe extern "C" fn nbd_set_cmd_timeout(nbd: *mut nbd_device, timeout: u64) {
...
#[no_mangle]
unsafe extern "C" fn nbd_alloc_and_init_config(nbd: *mut nbd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_open(disk: *mut gendisk, mode: blk_mode_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_release(disk: *mut gendisk) {
...
#[no_mangle]
unsafe extern "C" fn nbd_free_disk(disk: *mut gendisk) {
...
#[no_mangle]
unsafe extern "C" fn nbd_dbg_tasks_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_dbg_flags_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int nbd_dbg_flags_show(struct seq_file *s, void *unused)
    {
    struct nbd_device *nbd = s.private;
    let mut flags: u32 = nbd.config.flags;
...
#[no_mangle]
unsafe extern "C" fn nbd_dev_dbg_init(nbd: *mut nbd_device) -> c_int {
    static int nbd_dev_dbg_init(struct nbd_device *nbd)
    {
    struct dentry *dir;
    struct nbd_config *config = nbd.config;
...
#[no_mangle]
unsafe extern "C" fn nbd_dev_dbg_close(nbd: *mut nbd_device) {
    static void nbd_dev_dbg_close(struct nbd_device *nbd)
    {
    debugfs_remove_recursive(nbd.config.dbg_dir);
    }
#[no_mangle]
unsafe extern "C" fn nbd_dbg_init() -> c_int {
    static int nbd_dbg_init(void)
    {
    struct dentry *dbg_dir;
    dbg_dir = debugfs_create_dir("nbd", core::ptr::null_mut());
    if (IS_ERR(dbg_dir))
    return -EIO;
    nbd_dbg_dir = dbg_dir;
    return 0;
...
#[no_mangle]
unsafe extern "C" fn nbd_dbg_close() {
...
unsafe extern "C" fn nbd_dbg_close() {
    ...
    if (err < 0)
    goto out_free_tags;
    disk = blk_mq_alloc_disk(&nbd.tag_set, &lim, core::ptr::null_mut());
    if (IS_ERR(disk)) {
    err = PTR_ERR(disk);
    goto out_free_idr;
    }
...
//
#[no_mangle]
unsafe extern "C" fn __attribute__(_arg: (unused)) -> nla_policy {
...
#[no_mangle]
unsafe extern "C" fn nbd_genl_size_set(info: *mut genl_info, nbd: *mut nbd_device) -> c_int {
    static int nbd_genl_size_set(struct genl_info *info, struct nbd_device *nbd)
    {
    struct nbd_config *config = nbd.config;
    let mut bsize: u64 = nbd_blksize(config);
    let mut bytes: u64 = config.bytesize;
...
#[no_mangle]
unsafe extern "C" fn nbd_genl_connect_sock_cb(nbd: *mut nbd_device, fd: c_ulong) -> c_int {
    static int nbd_genl_connect_sock_cb(struct nbd_device *nbd, unsigned long fd)
    {
    return nbd_add_socket(nbd, fd, true);
    }
#[no_mangle]
unsafe extern "C" fn nbd_genl_connect(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
//
    ...
    mutex_unlock(&nbd_index_mutex);
    if (!nbd) {
    ret = nbd_genl_foreach_sock(info, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret < 0)
    return ret;
    ...
    let mut flags: u64 = nla_get_u64(info.attrs[NBD_ATTR_CLIENT_FLAGS]);
...
#[no_mangle]
unsafe extern "C" fn nbd_disconnect_and_put(nbd: *mut nbd_device) {
    static void nbd_disconnect_and_put(struct nbd_device *nbd)
    {
    mutex_lock(&nbd.config_lock);
    nbd_disconnect(nbd);
...
#[no_mangle]
unsafe extern "C" fn nbd_genl_disconnect(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_genl_reconfigure(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int nbd_genl_reconfigure(struct sk_buff *skb, struct genl_info *info)
    {
    struct nbd_device *nbd = core::ptr::null_mut();
    struct nbd_config *config;
    int index;
    let mut ret: c_int = 0;
    let mut put_dev: bool = false;
...
#[no_mangle]
unsafe extern "C" fn populate_nbd_status(nbd: *mut nbd_device, reply: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn status_cb(id: c_int, ptr: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_genl_status(skb: *mut sk_buff, info: *mut genl_info) -> c_int {
    static int nbd_genl_status(struct sk_buff *skb, struct genl_info *info)
    {
...
#[no_mangle]
unsafe extern "C" fn nbd_connect_reply(info: *mut genl_info, index: c_int) {
    static void nbd_connect_reply(struct genl_info *info, int index)
    {
    struct sk_buff *skb;
    void *msg_head;
...
#[no_mangle]
unsafe extern "C" fn nbd_mcast_index(index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nbd_dead_link_work(work: *mut work_struct) {
    static void nbd_dead_link_work(struct work_struct *work)
    {
...
#[no_mangle]
unsafe extern "C" fn nbd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nbd_exit_cb(id: c_int, ptr: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nbd_cleanup() -> void __exit {
