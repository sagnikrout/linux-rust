...
//! Source: drivers/ufs/core/ufshcd.c
#![no_std]
...
pub const NOP_OUT_RETRIES: c_int = 10;
// Timeout after 50 msecs if NOP OUT hangs without response

// Query request retries
pub const QUERY_REQ_RETRIES: c_int = 3;
...
pub const UFS_UIC_COMMAND_RETRIES: c_int = 3;
// maximum number of link-startup retries
pub const DME_LINKSTARTUP_RETRIES: c_int = 3;
// maximum number of reset retries before giving up
pub const MAX_HOST_RESET_RETRIES: c_int = 5;
// Maximum number of error handler retries before giving up
pub const MAX_ERR_HANDLER_RETRIES: c_int = 5;
// Expose the flag value from utp_upiu_query.value
pub const MASK_QUERY_UPIU_FLAG_LOC: c_uint = 0xFF;
// Interrupt aggregation default timeout, unit: 40us
pub const INT_AGGR_DEF_TO: c_uint = 0x02;
// default delay of autosuspend: 2000 ms
pub const RPM_AUTOSUSPEND_DELAY_MS: c_int = 2000;
// Default delay of RPM device flush delayed work
pub const RPM_DEV_FLUSH_RECHECK_WORK_DELAY_MS: c_int = 5000;
// Default value of wait time before gating device ref clock
pub const UFSHCD_REF_CLK_GATING_WAIT_US: c_uint = 0xFF /* microsecs */;
// Polling time to wait for fDeviceInit

// Default RTC update every 10 seconds

// bMaxNumOfRTT is equal to two after device manufacturing
pub const DEFAULT_MAX_NUM_RTT: c_int = 2;
// UFSHC 4.0 compliant HC support this mode.
    let mut use_mcq_mode: static bool = true;
#[no_mangle]
unsafe extern "C" fn is_mcq_supported(hba: *mut ufs_hba) -> bool {
    ...
    let mut uic_cmd_timeout: static unsigned int = UIC_CMD_TIMEOUT_DEFAULT;
#[no_mangle]
unsafe extern "C" fn uic_cmd_timeout_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    let mut dev_cmd_timeout: static unsigned int = QUERY_REQ_TIMEOUT_DEFAULT;
#[no_mangle]
unsafe extern "C" fn dev_cmd_timeout_set(val: *const c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_has_pending_tasks(hba: *mut ufs_hba) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_is_ufs_dev_busy(hba: *mut ufs_hba) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_enable_irq(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_disable_irq(hba: *mut ufs_hba) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_enable_intr(hba: *mut ufs_hba, intrs: u32) {
    void ufshcd_enable_intr(struct ufs_hba *hba, u32 intrs)
    {
    let mut old_val: u32 = ufshcd_readl(hba, REG_INTERRUPT_ENABLE);
    let mut new_val: u32 = old_val | intrs;
    if (new_val != old_val)
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_disable_intr(hba: *mut ufs_hba, intrs: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_configure_wb(hba: *mut ufs_hba) {
    ...
    {
    let mut lba: u64 = 0;
    let mut opcode: u8 = 0, group_id = 0;
    let mut doorbell: u32 = 0;
    u32 intr;
    let mut hwq_id: u32 = 0;
    struct request *rq = scsi_cmd_to_rq(cmd);
    let mut tag: c_uint = rq.tag;
    struct ufshcd_lrb *lrbp = scsi_cmd_priv(cmd);
    let mut transfer_len: c_int = -1;
// trace UPIU also
...
#[no_mangle]
unsafe extern "C" fn ufshcd_print_clk_freqs(hba: *mut ufs_hba) {
    ...
    let mut p: c_int = (i + e.pos) % UFS_EVENT_HIST_LENGTH;
    if (e.tstamp[p] == 0)
    continue;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_print_evt_hist(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_print_tr_iter(req: *mut request, priv: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_print_trs_all(hba: *mut ufs_hba, pr_prdt: bool) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_print_tmrs(hba: *mut ufs_hba, bitmap: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_print_host_state(hba: *mut ufs_hba) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_print_pwr_info(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_device_reset(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_delay_us(us: c_ulong, tolerance: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_get_intr_mask(hba: *mut ufs_hba) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_get_ufs_version(hba: *mut ufs_hba) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_is_device_present(hba: *mut ufs_hba) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_utrl_clear(hba: *mut ufs_hba, mask: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_utmrl_clear(hba: *mut ufs_hba, pos: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_get_lists_status(reg: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_is_exception_event(ucd_rsp_ptr: *mut utp_upiu_rsp) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_disable_intr_aggr(hba: *mut ufs_hba) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_enable_run_stop_reg(hba: *mut ufs_hba) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_hba_start(hba: *mut ufs_hba) {
    static inline void ufshcd_hba_start(struct ufs_hba *hba)
    {
    let mut val: u32 = CONTROLLER_ENABLE;
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_is_hba_active(hba: *mut ufs_hba) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_pm_qos_init(hba: *mut ufs_hba) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_pm_qos_exit(hba: *mut ufs_hba) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_pm_qos_update(hba: *mut ufs_hba, on: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_set_clk_freq(hba: *mut ufs_hba, scale_up: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_opp_set_rate(hba: *mut ufs_hba, freq: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_scale_clks(hba: *mut ufs_hba, freq: c_ulong, scale_up: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_pending_cmds(hba: *mut ufs_hba) -> u32 {
...
//
    ...
    u32 tm_doorbell;
    u32 tr_pending;
    let mut timeout: bool = false, do_last_check = false;
    ktime_t start;
    ufshcd_hold(hba);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_pause_command_processing(hba: *mut ufs_hba, timeout_us: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_resume_command_processing(hba: *mut ufs_hba) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_scale_gear(hba: *mut ufs_hba, target_gear: u32, scale_up: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_clock_scaling_prepare(hba: *mut ufs_hba, timeout_us: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clock_scaling_unprepare(hba: *mut ufs_hba, err: c_int) {
...
//
    ...
    bool scale_up)
    {
    let mut old_gear: u32 = hba.pwr_info.gear_rx;
    let mut new_gear: u32 = 0;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clk_scaling_suspend_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clk_scaling_resume_work(work: *mut work_struct) {
    ...
    struct ufs_hba *hba = dev_get_drvdata(dev);
    ktime_t start;
    let mut scale_up: bool = false, sched_clk_scaling_suspend_work = false;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_devfreq_init(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_devfreq_remove(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_suspend_clkscaling(hba: *mut ufs_hba) {
    static void ufshcd_suspend_clkscaling(struct ufs_hba *hba)
    {
    let mut suspend: bool = false;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_resume_clkscaling(hba: *mut ufs_hba) {
    static void ufshcd_resume_clkscaling(struct ufs_hba *hba)
    {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_init_clk_scaling_sysfs(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_remove_clk_scaling_sysfs(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_init_clk_scaling(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_exit_clk_scaling(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_ungate_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_hold(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_gate_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __ufshcd_release(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_release(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_clkgate_delay_set(dev: *mut device, value: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_init_clk_gating_sysfs(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_remove_clk_gating_sysfs(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_init_clk_gating(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_exit_clk_gating(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clk_scaling_start_busy(hba: *mut ufs_hba) {
    static void ufshcd_clk_scaling_start_busy(struct ufs_hba *hba)
    {
    let mut queue_resume_work: bool = false;
    ktime_t curr_t;
    if (!ufshcd_is_clkscaling_supported(hba))
    return;
    curr_t = ktime_get();
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clk_scaling_update_busy(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_monitor_opcode2dir(opcode: u8) -> c_int {
    static inline int ufshcd_monitor_opcode2dir(u8 opcode)
    {
    if (opcode == READ_6 || opcode == READ_10 || opcode == READ_16)
    return READ;
#[no_mangle]
pub unsafe extern "C" fn if(WRITE_16: opcode == WRITE_6 || opcode == WRITE_10 || opcode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_start_monitor(hba: *mut ufs_hba, cmd: *mut scsi_cmnd) {
    static void ufshcd_start_monitor(struct ufs_hba *hba, struct scsi_cmnd *cmd)
    {
    let mut dir: c_int = ufshcd_monitor_opcode2dir(cmd.cmnd[0]);
    unsigned long flags;
    spin_lock_irqsave(hba.host.host_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn ufshcd_update_monitor(hba: *mut ufs_hba, cmd: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_is_scsi_cmd(cmd: *mut scsi_cmnd) -> bool {
...
//
    ...
    if (hba.mcq_enabled) {
    let mut utrd_size: c_int = sizeof(struct utp_transfer_req_desc);
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_copy_sense_data(cmd: *mut scsi_cmnd) {
    static inline void ufshcd_copy_sense_data(struct scsi_cmnd *cmd)
    {
    struct ufshcd_lrb *lrbp = scsi_cmd_priv(cmd);
    let mut sense_buffer: *mut u8 const = cmd.sense_buffer;
    u16 resp_len;
    int len;
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn ufshcd_copy_query_response(hba: *mut ufs_hba, lrbp: *mut ufshcd_lrb) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_hba_capabilities(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_ready_for_uic_cmd(hba: *mut ufs_hba) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_get_upmcrs(hba: *mut ufs_hba) -> u8 {
...
//
    ...
    spin_lock_irqsave(hba.host.host_lock, flags);
    hba.active_uic_cmd = core::ptr::null_mut();
    spin_unlock_irqrestore(hba.host.host_lock, flags);
    return ret;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_send_uic_cmd(hba: *mut ufs_hba, uic_cmd: *mut uic_command) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_map_sg(hba: *mut ufs_hba, cmd: *mut scsi_cmnd) -> c_int {
    static int ufshcd_map_sg(struct ufs_hba *hba, struct scsi_cmnd *cmd)
    {
    struct ufshcd_lrb *lrbp = scsi_cmd_priv(cmd);
    let mut sg_segments: c_int = scsi_dma_map(cmd);
    if (sg_segments < 0)
    return sg_segments;
...
//
    ...
    let mut len: u16 = be16_to_cpu(query.request.upiu_req.length);
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_prepare_utp_nop_upiu(cmd: *mut scsi_cmnd) {
...
#[no_mangle]
pub unsafe extern "C" fn if(DEV_CMD_TYPE_NOP: hba->dev_cmd.type ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_comp_scsi_upiu(hba: *mut ufs_hba, cmd: *mut scsi_cmnd) {
    static void ufshcd_comp_scsi_upiu(struct ufs_hba *hba, struct scsi_cmnd *cmd)
    {
    struct ufshcd_lrb *lrbp = scsi_cmd_priv(cmd);
    struct request *rq = scsi_cmd_to_rq(cmd);
    let mut ioprio_class: c_uint = IOPRIO_PRIO_CLASS(req_get_ioprio(rq));
    u8 upiu_flags;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_init_lrb(hba: *mut ufs_hba, cmd: *mut scsi_cmnd) {
    static void ufshcd_init_lrb(struct ufs_hba *hba, struct scsi_cmnd *cmd)
    {
    let mut i: c_int = scsi_cmd_to_rq(cmd).tag;
    struct utp_transfer_req_desc *utrdlp = hba.utrdl_base_addr;
    let mut response_offset: u16 = le16_to_cpu(utrdlp[i].response_upiu_offset);
    let mut prdt_offset: u16 = le16_to_cpu(utrdlp[i].prd_table_offset);
...
// The reserved tag uses a dedicated UCD outside the pool.
    ...
    let mut slot: c_int = i - UFSHCD_NUM_RESERVED;
...
// Non-reserved tags start at UFSHCD_NUM_RESERVED, so slot >= 0.
    ...
    scsi_cmd_to_rq(cmd) : core::ptr::null_mut(), lrbp);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_upiu_wlun_to_scsi_wlun(upiu_wlun_id: u8) -> u16 {
    static inline u16 ufshcd_upiu_wlun_to_scsi_wlun(u8 upiu_wlun_id)
    {
    return (upiu_wlun_id & ~UFS_UPIU_WLUN_ID) | SCSI_W_LUN_BASE;
    }
#[no_mangle]
pub unsafe extern "C" fn is_device_wlun(sdev: *mut scsi_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_map_queues(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_init_cmd_priv(host: *mut Scsi_Host, cmd: *mut scsi_cmnd) -> c_int {
...
//
    ...
    let mut tag: c_int = scsi_cmd_to_rq(cmd).tag;
    let mut err: c_int = 0;
    struct ufs_hw_queue *hwq = core::ptr::null_mut();
...
//
    ...
    struct ufs_hba *hba = shost_priv(host);
    struct ufs_hw_queue *hwq =
    hba.mcq_enabled ? ufshcd_mcq_req_to_hwq(hba, rq) : core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_cmd_inflight(cmd: *mut scsi_cmnd) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_clear_cmd(hba: *mut ufs_hba, task_tag: u32) -> c_int {
...
//
    ...
    let mut response: u8 = lrbp.ucd_rsp_ptr.header.response;
    if (response == 0) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_dev_man_lock(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_dev_man_unlock(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_put_dev_mgmt_cmd(cmd: *mut scsi_cmnd) {
...
//
    ...
    {
    struct ufs_query_req *request = core::ptr::null_mut();
    struct ufs_query_res *response = core::ptr::null_mut();
    int err, selector = 0;
    let mut timeout: c_int = dev_cmd_timeout;
    BUG_ON(!hba);
...
// buf_len = be16_to_cpu(response->upiu_res.length);
    out_unlock:
    hba.dev_cmd.query.descriptor = core::ptr::null_mut();
    ufshcd_dev_man_unlock(hba);
    return err;
    }
//
...
//
    ...
    int ret;
    u8 *desc_buf;
    let mut buff_len: c_int = QUERY_DESC_MAX_SIZE;
    let mut is_kmalloc: bool = true;
// Safety check
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_remove_non_printable(ch: u8) -> c_char {
    static inline char ufshcd_remove_non_printable(u8 ch)
    {
    pub ': return (ch >= 0x20 && ch <= 0x7e) ? ch : ',
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_read_string_desc(hba: *mut ufs_hba, desc_index: u8, buf: *mut u8, fmt: enum ufs_descr_fmt) -> c_int {
    int ufshcd_read_string_desc(struct ufs_hba *hba, u8 desc_index, u8 **buf, enum ufs_descr_fmt fmt)
    {
    pub uc_str: *mut uc_string_id,
    pub str: *mut u8,
    pub uc_len: int ret,,
    if (!buf)
    pub -EINVAL: return,
    pub GFP_KERNEL): uc_str = kzalloc(QUERY_DESC_MAX_SIZE,,
    if (!uc_str)
    pub -ENOMEM: return,
    ret = ufshcd_read_desc_param(hba, QUERY_DESC_IDN_STRING, desc_index, 0,
    pub QUERY_DESC_MAX_SIZE): *mut *mut (u8 )uc_str,,
    if (ret < 0) {
    dev_err(hba.dev, "Reading String Desc failed after %d retries. err = %d\n",
    pub ret): QUERY_REQ_RETRIES,,
    pub NULL: str =,
    pub out: goto,
    }
    if (uc_str.len <= QUERY_DESC_HDR_SIZE) {
    pub length\n"): dev_dbg(hba->dev, "String Desc is of zero,
    pub NULL: str =,
    pub 0: ret =,
    pub out: goto,
    }
    pub QUERY_DESC_HDR_SIZE: uc_len = uc_str->len -,
    if (uc_len % sizeof(*uc_str.uc)) {
    pub length\n"): dev_err(hba->dev, "String Desc has an odd UTF-16 payload,
    pub NULL: str =,
    pub -EINVAL: ret =,
    pub out: goto,
    }
...
// Allow up to three UTF-8 bytes per UTF-16 code unit plus a NUL.
    pub 1: *mut *mut *mut ascii_len = uc_len / sizeof(uc_str->uc)  3 +,
    pub GFP_KERNEL): str = kzalloc(ascii_len,,
    if (!str) {
    pub -ENOMEM: ret =,
    pub out: goto,
    }
...
//
    ...
    pub 1): UTF16_BIG_ENDIAN, str, ascii_len -,
// replace non-printable or non-ASCII characters with spaces
    pub i++): for (i = 0; i < ret;,
    pub ufshcd_remove_non_printable(str[i]): str[i] =,
    pub '\0': str[ret++] =,
    } else {
//
...
//
    pub GFP_KERNEL): str = kzalloc(uc_str->len,,
    if (!str) {
    pub -ENOMEM: ret =,
    pub out: goto,
    }
    pub uc_len): memcpy(str, uc_str->uc,,
    pub uc_str->len: ret =,
    }
    out:
// buf = str;
...
//
    ...
    pub param_size): param_offset, param_read_buf,,
    }
#[no_mangle]
unsafe extern "C" fn ufshcd_get_ref_clk_gating_wait(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_get_ref_clk_gating_wait(struct ufs_hba *hba)
    {
    pub 0: int err =,
    pub UFSHCD_REF_CLK_GATING_WAIT_US: u32 gating_wait =,
    ...
    pub gating_wait): err,,
    if (gating_wait == 0) {
    pub UFSHCD_REF_CLK_GATING_WAIT_US: gating_wait =,
    dev_err(hba.dev, "Undefined ref clk gating wait time, use default %uus\n",
    }
    pub gating_wait: hba->dev_info.clk_gating_wait_us =,
    }
    pub err: return,
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_memory_alloc(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_memory_alloc(struct ufs_hba *hba)
    {
    pub ucdl_size: size_t utmrdl_size, utrdl_size,,
// The reserved tag uses the dedicated UCD below, not this pool.
    pub UFSHCD_NUM_RESERVED): *mut *mut ucdl_size = ufshcd_get_ucd_size(hba)  (hba->nutrs -,
...
//
    ...
    dev_err(hba.dev,
    pub failed\n"): "Command Descriptor Memory allocation,
    pub out: goto,
    }
// Dedicated UCD for the reserved tag; allocate once (survives MCQ re-init).
    ...
    dev_err(hba.dev,
    pub failed\n"): "Devman Command Descriptor Memory allocation,
    pub out: goto,
    }
    }
//
...
//
    pub hba->nutrs): *mut *mut utrdl_size = (sizeof(struct utp_transfer_req_desc),
    ...
    dev_err(hba.dev,
    pub failed\n"): "Transfer Descriptor Memory allocation,
    pub out: goto,
    }
//
...
//
    ...
    pub skip_utmrdl: goto,
//
// Allocate memory for UTP Task Management descriptors
// UFSHCI requires 1KB alignment of UTMRD
//
    pub hba->nutmrs: *mut *mut utmrdl_size = sizeof(struct utp_task_req_desc),
    ...
    dev_err(hba.dev,
    pub failed\n"): "Task Management Descriptor Memory allocation,
    pub out: goto,
    }
    skip_utmrdl:
    pub 0: return,
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_host_memory_configure(hba: *mut ufs_hba) {
    static void ufshcd_host_memory_configure(struct ufs_hba *hba)
    {
    pub utrdlp: *mut utp_transfer_req_desc,
    pub cmd_desc_dma_addr: dma_addr_t,
    pub cmd_desc_element_addr: dma_addr_t,
    pub response_offset: u16,
    pub prdt_offset: u16,
    pub response_len: u16,
    pub cmd_desc_size: c_int,
    pub i: c_int,
    pub hba->utrdl_base_addr: utrdlp =,
    pub ufshcd_get_ucd_size(hba): cmd_desc_size =,
    pub hba->ucdl_dma_addr: cmd_desc_dma_addr =,
    pub {: for (i = 0; i < hba->nutrs; i++),
//
...
// Response upiu and prdt offset should be in double words
    ...
    utrdlp[i].response_upiu_offset =
    pub 2): cpu_to_le16(response_offset >>,
    utrdlp[i].prd_table_offset =
    pub 2): cpu_to_le16(prdt_offset >>,
    utrdlp[i].response_upiu_length =
    pub 2): cpu_to_le16(response_len >>,
    }
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_dme_link_startup(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_dme_reset(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_dme_enable(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_add_delay_before_dme_cmd(hba: *mut ufs_hba) {
    static inline void ufshcd_add_delay_before_dme_cmd(struct ufs_hba *hba)
    {
pub const MIN_DELAY_BEFORE_DME_CMDS_US: c_int = 1000;
...
//
    ...
    int ret;
    let mut retries: c_int = UFS_UIC_COMMAND_RETRIES;
    do {
...
//
    ...
    let mut pwr_mode_change: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_uic_pwr_ctrl(hba: *mut ufs_hba, cmd: *mut uic_command) -> c_int {
    ...
    spin_lock_irqsave(hba.host.host_lock, flags);
    hba.active_uic_cmd = core::ptr::null_mut();
    hba.uic_async_done = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_uic_tx_eqtr(hba: *mut ufs_hba, gear: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_send_bsg_uic_cmd(hba: *mut ufs_hba, uic_cmd: *mut uic_command) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_uic_change_pwr_mode(hba: *mut ufs_hba, mode: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_link_recovery(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_uic_hibern8_enter(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_uic_hibern8_exit(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_configure_auto_hibern8(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_auto_hibern8_update(hba: *mut ufs_hba, ahit: u32) {
    void ufshcd_auto_hibern8_update(struct ufs_hba *hba, u32 ahit)
    {
    let mut cur_ahit: u32 = READ_ONCE(hba.ahit);
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_init_pwr_info(hba: *mut ufs_hba) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_get_max_pwr_mode(hba: *mut ufs_hba) -> c_int {
...
//
    ...
    enum ufshcd_pmc_policy pmc_policy)
    {
    let mut final_params: ufs_pa_layer_attr = { 0 };
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_complete_dev_init(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_complete_dev_init(struct ufs_hba *hba)
    {
    int err;
    let mut flag_res: bool = true;
    ktime_t timeout;
    err = ufshcd_query_flag_retry(hba, UPIU_QUERY_OPCODE_SET_FLAG,
    QUERY_FLAG_IDN_FDEVICEINIT, 0, core::ptr::null_mut());
    if (err) {
    dev_err(hba.dev,
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_make_hba_operational(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_hba_stop(hba: *mut ufs_hba) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_hba_execute_hce(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_hba_enable(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_disable_tx_lcc(hba: *mut ufs_hba, peer: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_disable_device_tx_lcc(hba: *mut ufs_hba) -> c_int {
    static inline int ufshcd_disable_device_tx_lcc(struct ufs_hba *hba)
    {
    return ufshcd_disable_tx_lcc(hba, true);
    }
#[no_mangle]
pub unsafe extern "C" fn ufshcd_update_evt_hist(hba: *mut ufs_hba, id: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_validate_link_params(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_link_startup(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_link_startup(struct ufs_hba *hba)
    {
    int ret;
    let mut retries: c_int = DME_LINKSTARTUP_RETRIES;
    let mut link_startup_again: bool = false;
//
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_verify_dev_init(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_setup_links(hba: *mut ufs_hba, sdev: *mut scsi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_lu_init(hba: *mut ufs_hba, sdev: *mut scsi_device) {
    static void ufshcd_lu_init(struct ufs_hba *hba, struct scsi_device *sdev)
    {
    let mut len: c_int = QUERY_DESC_MAX_SIZE;
    let mut lun: u8 = ufshcd_scsi_to_upiu_lun(sdev.lun);
    let mut lun_qdepth: u8 = hba.nutrs;
    u8 *desc_buf;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_sdev_init(sdev: *mut scsi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_change_queue_depth(sdev: *mut scsi_device, depth: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ufshcd_is_rpm_autosuspend_allowed(hba)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_sdev_destroy(sdev: *mut scsi_device) {
...
// Drop the reference as it won't be needed anymore
    ...
    spin_lock_irqsave(hba.host.host_lock, flags);
    hba.ufs_device_wlun = core::ptr::null_mut();
    spin_unlock_irqrestore(hba.host.host_lock, flags);
    } else if (hba.ufs_device_wlun) {
    struct device *supplier = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_scsi_cmd_status(cmd: *mut scsi_cmnd, scsi_status: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_uic_cmd_compl(hba: *mut ufs_hba, intr_status: u32) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_release_scsi_cmd(hba: *mut ufs_hba, cmd: *mut scsi_cmnd) {
...
//
    ...
    ufshcd_compl_one_cqe(hba, tag, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_poll(shost: *mut Scsi_Host, queue_num: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_mcq_force_compl_one(rq: *mut request, priv: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_mcq_compl_one(rq: *mut request, priv: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_transfer_req_compl(hba: *mut ufs_hba) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn __ufshcd_write_ee_control(hba: *mut ufs_hba, ee_ctrl_mask: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_write_ee_control(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_disable_ee(hba: *mut ufs_hba, mask: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_enable_ee(hba: *mut ufs_hba, mask: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_enable_auto_bkops(hba: *mut ufs_hba) -> c_int {
    ...
    goto out;
    err = ufshcd_query_flag_retry(hba, UPIU_QUERY_OPCODE_SET_FLAG,
    QUERY_FLAG_IDN_BKOPS_EN, 0, core::ptr::null_mut());
    if (err) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_disable_auto_bkops(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_force_reset_auto_bkops(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_get_bkops_status(hba: *mut ufs_hba, status: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_bkops_ctrl(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_bkops_ctrl(struct ufs_hba *hba)
    {
    let mut status: enum bkops_status = hba.urgent_bkops_lvl;
    let mut curr_status: u32 = 0;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_get_ee_status(hba: *mut ufs_hba, status: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_bkops_exception_event_handler(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn __ufshcd_wb_toggle(hba: *mut ufs_hba, set: bool, idn: enum flag_idn) -> c_int {
    ...
    return ufshcd_query_flag_retry(hba, opcode, idn, index, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn ufshcd_wb_toggle(hba: *mut ufs_hba, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_wb_toggle_buf_flush(hba: *mut ufs_hba, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_wb_set_resize_en(hba: *mut ufs_hba, en_mode: enum wb_resize_en) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wb_force_disable(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_is_wb_buf_lifetime_available(hba: *mut ufs_hba) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wb_need_flush(hba: *mut ufs_hba) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_rpm_dev_flush_recheck_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_exception_event_handler(work: *mut work_struct) {
    ...
    sysfs_notify(&hba.dev.kobj, core::ptr::null_mut(), "critical_health");
    }
    if (status & hba.ee_drv_mask & MASK_EE_DEV_LVL_EXCEPTION) {
    atomic_inc(&hba.dev_lvl_exception_count);
    sysfs_notify(&hba.dev.kobj, core::ptr::null_mut(), "device_lvl_exception_count");
    }
    ufs_debugfs_exception_event(hba, status);
    }
// Complete requests that have door-bell cleared
#[no_mangle]
unsafe extern "C" fn ufshcd_complete_requests(hba: *mut ufs_hba, force_compl: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_quirk_dl_nac_errors(hba: *mut ufs_hba) -> bool {
    static bool ufshcd_quirk_dl_nac_errors(struct ufs_hba *hba)
    {
    unsigned long flags;
    let mut err_handling: bool = true;
    spin_lock_irqsave(hba.host.host_lock, flags);
//
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_is_saved_err_fatal(hba: *mut ufs_hba) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_schedule_eh_work(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_force_error_recovery(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clk_scaling_allow(hba: *mut ufs_hba, allow: bool) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clk_scaling_suspend(hba: *mut ufs_hba, suspend: bool) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_err_handling_prepare(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_err_handling_unprepare(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_err_handling_should_stop(hba: *mut ufs_hba) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_recover_pm_error(hba: *mut ufs_hba) {
    ...
    let mut resume_sdev_queues: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_recover_pm_error(hba: *mut ufs_hba) {
    static inline void ufshcd_recover_pm_error(struct ufs_hba *hba)
    {
    }

#[no_mangle]
unsafe extern "C" fn ufshcd_is_pwr_mode_restore_needed(hba: *mut ufs_hba) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_abort_one(rq: *mut request, priv: *mut c_void) -> bool {
    static bool ufshcd_abort_one(struct request *rq, void *priv)
    {
    int *ret = priv;
    let mut tag: u32 = rq.tag;
    struct scsi_cmnd *cmd = blk_mq_rq_to_pdu(rq);
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_abort_all(hba: *mut ufs_hba) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_err_handler(work: *mut work_struct) {
    static void ufshcd_err_handler(struct work_struct *work)
    {
    let mut retries: c_int = MAX_ERR_HANDLER_RETRIES;
    struct ufs_hba *hba;
    unsigned long flags;
    bool needs_restore;
    bool needs_reset;
...
// release the lock as ufshcd_quirk_dl_nac_errors() may sleep
    ...
    let mut pr_prdt: bool = !!(hba.saved_err & SYSTEM_BUS_FATAL_ERROR);
    spin_unlock_irqrestore(hba.host.host_lock, flags);
    ufshcd_print_host_state(hba);
    ufshcd_print_pwr_info(hba);
    ufshcd_print_tx_eq_params(hba);
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_update_uic_error(hba: *mut ufs_hba) -> irqreturn_t {
...
// Got a LINERESET indication.
    ...
    struct uic_command *cmd = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(UIC_DATA_LINK_LAYER_ERROR_TCx_REPLAY_TIMEOUT: reg &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_check_errors(hba: *mut ufs_hba, intr_status: u32) -> irqreturn_t {
    static irqreturn_t ufshcd_check_errors(struct ufs_hba *hba, u32 intr_status)
    {
    let mut queue_eh_work: bool = false;
    let mut retval: irqreturn_t = IRQ_NONE;
    guard(spinlock_irqsave)(hba.host.host_lock);
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_tmc_handler(hba: *mut ufs_hba) -> irqreturn_t {
    static irqreturn_t ufshcd_tmc_handler(struct ufs_hba *hba)
    {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_handle_mcq_cq_events(hba: *mut ufs_hba, reset_iag: bool) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_sl_intr(hba: *mut ufs_hba, intr_status: u32) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_intr(irq: c_int, __hba: *mut c_void) -> irqreturn_t {
    static irqreturn_t ufshcd_intr(int irq, void *__hba)
    {
    u32 last_intr_status, intr_status, enabled_intr_status = 0;
    let mut retval: irqreturn_t = IRQ_NONE;
    struct ufs_hba *hba = __hba;
    let mut retries: c_int = hba.nutrs;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clear_tm_cmd(hba: *mut ufs_hba, tag: c_int) -> c_int {
    static int ufshcd_clear_tm_cmd(struct ufs_hba *hba, int tag)
    {
    let mut err: c_int = 0;
    let mut mask: u32 = 1 << tag;
...
// wait until the task management command is completed
    ...
    spin_lock_irqsave(hba.host.host_lock, flags);
    hba.tmf_rqs[req.tag] = core::ptr::null_mut();
...
//
    ...
    {
    let mut treq: utp_task_req_desc = { };
...
//
    ...
    __func__, ocs_value);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tm_response) -> else {
    else if (tm_response)
...
//
    ...
    {
    int err;
    let mut cmd_type: enum dev_cmd_type = DEV_CMD_TYPE_QUERY;
    let mut treq: utp_task_req_desc = { };
    enum utp_ocs ocs_value;
    let mut tm_f: u8 = req_upiu.header.tm_function;
    switch (msgcode) {
...
//
    ...
    u8 *ehs_data;
    u16 ehs_len;
    let mut ehs: c_int = (hba.capabilities & MASK_EHSLUTRD_SUPPORTED) ? 2 : 0;
    ufshcd_dev_man_lock(hba);
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clear_lu_cmds(req: *mut request, priv: *mut c_void) -> bool {
    ...
    struct Scsi_Host *shost = sdev.host;
    struct ufs_hba *hba = shost_priv(shost);
    let mut lun: u64 = *(u64 *)priv;
    let mut tag: u32 = req.tag;
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_eh_device_reset_handler(cmd: *mut scsi_cmnd) -> c_int {
    static int ufshcd_eh_device_reset_handler(struct scsi_cmnd *cmd)
    {
    struct Scsi_Host *host;
    struct ufs_hba *hba;
    int err;
    let mut resp: u8 = 0xF, lun;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_set_req_abort_skip(hba: *mut ufs_hba, bitmap: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_try_to_abort_task(hba: *mut ufs_hba, tag: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_abort(cmd: *mut scsi_cmnd) -> c_int {
    static int ufshcd_abort(struct scsi_cmnd *cmd)
    {
    struct Scsi_Host *host = cmd.device.host;
    struct ufs_hba *hba = shost_priv(host);
    struct request *rq = scsi_cmd_to_rq(cmd);
    let mut tag: c_int = rq.tag;
    struct ufshcd_lrb *lrbp = scsi_cmd_priv(cmd);
    unsigned long flags;
    let mut err: c_int = FAILED;
    bool outstanding;
    u32 reg;
    ufshcd_hold(hba);
    if (!hba.mcq_enabled) {
...
//
    ...
    hba.ufshcd_state = UFSHCD_STATE_ERROR;
#[no_mangle]
pub unsafe extern "C" fn if(UFSHCD_STATE_RESET: hba->ufshcd_state ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_host_reset_and_restore(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_host_reset_and_restore(struct ufs_hba *hba)
    {
    int err;
//
...
// Establish the link again and restore the device
    if (!err) {
    let mut probe_start: ktime_t = ktime_get();
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_reset_and_restore(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_reset_and_restore(struct ufs_hba *hba)
    {
    let mut saved_err: u32 = 0;
    let mut saved_uic_err: u32 = 0;
    let mut err: c_int = 0;
    unsigned long flags;
    let mut retries: c_int = MAX_HOST_RESET_RETRIES;
    spin_lock_irqsave(hba.host.host_lock, flags);
    do {
//
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_eh_host_reset_handler(cmd: *mut scsi_cmnd) -> c_int {
    static int ufshcd_eh_host_reset_handler(struct scsi_cmnd *cmd)
    {
    let mut err: c_int = SUCCESS;
    unsigned long flags;
    struct ufs_hba *hba;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_set_active_icc_lvl(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_blk_pm_runtime_init(sdev: *mut scsi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_scsi_add_wlus(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_scsi_add_wlus(struct ufs_hba *hba)
    {
    let mut ret: c_int = 0;
    struct scsi_device *sdev_boot, *sdev_rpmb;
    hba.ufs_device_wlun = __scsi_add_device(hba.host, 0, 0,
    ufshcd_upiu_wlun_to_scsi_wlun(UFS_UPIU_UFS_DEVICE_WLUN), core::ptr::null_mut());
    ...
    ufshcd_upiu_wlun_to_scsi_wlun(UFS_UPIU_RPMB_WLUN), core::ptr::null_mut());
    if (IS_ERR(sdev_rpmb)) {
    ret = PTR_ERR(sdev_rpmb);
    hba.ufs_rpmb_wlun = core::ptr::null_mut();
    ...
    ufshcd_upiu_wlun_to_scsi_wlun(UFS_UPIU_BOOT_WLUN), core::ptr::null_mut());
    if (IS_ERR(sdev_boot)) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wb_probe(hba: *mut ufs_hba, desc_buf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_temp_notif_probe(hba: *mut ufs_hba, desc_buf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_device_lvl_exception_probe(hba: *mut ufs_hba, desc_buf: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_set_rtt(hba: *mut ufs_hba) {
    static void ufshcd_set_rtt(struct ufs_hba *hba)
    {
    struct ufs_dev_info *dev_info = &hba.dev_info;
    let mut rtt: u32 = 0;
    let mut dev_rtt: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn ufs_fixup_device_setup(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_update_rtc(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn if(UFS_RTC_RELATIVE: hba->dev_info.rtc_type ==) -> else {
    else if (hba.dev_info.rtc_type == UFS_RTC_RELATIVE)
    hba.dev_info.rtc_time_baseline = ts64.tv_sec;
    }
#[no_mangle]
unsafe extern "C" fn ufshcd_rtc_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ufs_init_rtc(hba: *mut ufs_hba, desc_buf: *mut u8) {
    static void ufs_init_rtc(struct ufs_hba *hba, u8 *desc_buf)
    {
    let mut periodic_rtc_update: u16 = get_unaligned_be16(&desc_buf[DEVICE_DESC_PARAM_FRQ_RTC]);
    struct ufs_dev_info *dev_info = &hba.dev_info;
...
#[no_mangle]
unsafe extern "C" fn ufs_get_device_desc(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_put_device_desc(hba: *mut ufs_hba) {
    static void ufs_put_device_desc(struct ufs_hba *hba)
    {
    struct ufs_dev_info *dev_info = &hba.dev_info;
    kfree(dev_info.model);
    dev_info.model = core::ptr::null_mut();
    kfree(dev_info.device_id);
    dev_info.device_id = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_quirk_tune_host_pa_tactivate(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_quirk_override_pa_h8time(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_tune_unipro_params(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_clear_dbg_ufs_stats(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_device_geo_params_init(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: desc_buf[GEOMETRY_DESC_PARAM_MAX_NUM_LUN] ==) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ufs_ref_clk {
    pub freq_hz: c_ulong,
    pub val: enum ufs_ref_clk_freq,
}
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_parse_dev_ref_clk_freq(hba: *mut ufs_hba, refclk: *mut clk) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_set_dev_ref_clk(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_set_dev_ref_clk(struct ufs_hba *hba)
    {
    int err;
    u32 ref_clk;
    let mut freq: u32 = hba.dev_ref_clk_freq;
    err = ufshcd_query_attr_retry(hba, UPIU_QUERY_OPCODE_READ_ATTR,
...
#[no_mangle]
unsafe extern "C" fn ufshcd_device_params_init(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_set_timestamp_attr(hba: *mut ufs_hba) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_add_lus(hba: *mut ufs_hba) -> c_int {
...
// SDB - Single Doorbell
#[no_mangle]
unsafe extern "C" fn ufshcd_release_sdb_queue(hba: *mut ufs_hba, nutrs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_alloc_mcq(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_alloc_mcq(struct ufs_hba *hba)
    {
    int ret;
    let mut old_nutrs: c_int = hba.nutrs;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_config_mcq(hba: *mut ufs_hba) {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_get_op_mode(hba: *mut ufs_hba) -> enum ufs_op_mode {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_post_device_init(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_device_init(hba: *mut ufs_hba, init_dev_params: bool) -> c_int {
    static int ufshcd_device_init(struct ufs_hba *hba, bool init_dev_params)
    {
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_probe_hba(hba: *mut ufs_hba, init_dev_params: bool) -> c_int {
    static int ufshcd_probe_hba(struct ufs_hba *hba, bool init_dev_params)
    {
    int ret;
    if (!hba.pm_op_in_progress &&
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_async_scan(data: *mut c_void, cookie: async_cookie_t) {
    static void ufshcd_async_scan(void *data, async_cookie_t cookie)
    {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_eh_timed_out(scmd: *mut scsi_cmnd) -> enum scsi_timeout_action {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_enable_vreg(dev: *mut device, vreg: *mut ufs_vreg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_disable_vreg(dev: *mut device, vreg: *mut ufs_vreg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_setup_vreg(hba: *mut ufs_hba, on: bool) -> c_int {
    static int ufshcd_setup_vreg(struct ufs_hba *hba, bool on)
    {
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_setup_hba_vreg(hba: *mut ufs_hba, on: bool) -> c_int {
    static int ufshcd_setup_hba_vreg(struct ufs_hba *hba, bool on)
    {
    struct ufs_vreg_info *info = &hba.vreg_info;
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_get_vreg(dev: *mut device, vreg: *mut ufs_vreg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_init_vreg(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_init_hba_vreg(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_setup_clocks(hba: *mut ufs_hba, on: bool) -> c_int {
    static int ufshcd_setup_clocks(struct ufs_hba *hba, bool on)
    {
    let mut ret: c_int = 0;
    struct ufs_clk_info *clki;
    struct list_head *head = &hba.clk_list_head;
    let mut start: ktime_t = ktime_get();
    let mut clk_state_changed: bool = false;
    if (list_empty(head))
    goto out;
...
#[no_mangle]
unsafe extern "C" fn ufshcd_parse_ref_clk_property(hba: *mut ufs_hba) -> enum ufs_ref_clk_freq {
    static enum ufs_ref_clk_freq ufshcd_parse_ref_clk_property(struct ufs_hba *hba)
    {
    u32 freq;
    let mut ret: c_int = device_property_read_u32(hba.dev, "ref-clk-freq", &freq);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_init_clocks(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_variant_hba_init(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_variant_hba_init(struct ufs_hba *hba)
    {
    let mut err: c_int = ufshcd_vops_init(hba);
    if (err)
...
#[no_mangle]
unsafe extern "C" fn ufshcd_hba_init(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_hba_exit(hba: *mut ufs_hba) {
    static void ufshcd_hba_exit(struct ufs_hba *hba)
    {
    if (hba.is_powered) {
    ...
    return scsi_execute_cmd(sdev, cdb, REQ_OP_DRV_IN, /*buffer=*/core::ptr::null_mut(),
...
//
    ...
    scsi_print_sense_hdr(sdp, core::ptr::null_mut(), &sshdr);
    ret = -EIO;
    }
    } else {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_vreg_set_lpm(hba: *mut ufs_hba) {
    static void ufshcd_vreg_set_lpm(struct ufs_hba *hba)
    {
    let mut vcc_off: bool = false;
//
...
#[no_mangle]
unsafe extern "C" fn ufshcd_vreg_set_hpm(hba: *mut ufs_hba) -> c_int {
    static int ufshcd_vreg_set_hpm(struct ufs_hba *hba)
    {
    let mut vcc_on: bool = false;
    let mut ret: c_int = 0;
    if (ufshcd_is_ufs_dev_poweroff(hba) && ufshcd_is_link_off(hba) &&
    !hba.dev_info.is_lu_power_on_wp) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_hba_vreg_set_lpm(hba: *mut ufs_hba) {
    static void ufshcd_hba_vreg_set_lpm(struct ufs_hba *hba)
    {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_hba_vreg_set_hpm(hba: *mut ufs_hba) {
    static void ufshcd_hba_vreg_set_hpm(struct ufs_hba *hba)
    {
    if (ufshcd_is_link_off(hba) || ufshcd_can_aggressive_pc(hba))
    ufshcd_setup_hba_vreg(hba, true);
...
#[no_mangle]
unsafe extern "C" fn __ufshcd_wl_suspend(hba: *mut ufs_hba, pm_op: enum ufs_pm_op) -> c_int {
...
//
    ...
    ufshcd_set_link_active(hba);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ufshcd_is_link_off(hba)) -> else {
...
#[no_mangle]
unsafe extern "C" fn __ufshcd_wl_resume(hba: *mut ufs_hba, pm_op: enum ufs_pm_op) -> c_int {
    static int __ufshcd_wl_resume(struct ufs_hba *hba, enum ufs_pm_op pm_op)
    {
    int ret;
    let mut old_link_state: enum uic_link_state = hba.uic_link_state;
    hba.pm_op_in_progress = true;
//
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wl_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wl_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wl_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wl_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_suspend(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_resume(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_system_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_system_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_runtime_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wl_shutdown(sdev: *mut scsi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_remove(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_system_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_system_restore(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_system_thaw(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_set_dma_mask(hba: *mut ufs_hba) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_devres_release(host: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_alloc_host(dev: *mut device, hba_handle: *mut ufs_hba) -> c_int {
    ...
    if (!dev) {
    dev_err(dev,
    "Invalid memory reference for dev is core::ptr::null_mut()\n");
    err = -ENODEV;
    goto out_error;
    }
...
#[no_mangle]
unsafe extern "C" fn ufshcd_add_scsi_host(hba: *mut ufs_hba) -> c_int {
...
// Continue with SDB mode
    ...
    hba.tmf_queue = blk_mq_alloc_queue(&hba.tmf_tag_set, core::ptr::null_mut(), core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_init(hba: *mut ufs_hba, mmio_base: *mut void __iomem, irq: c_uint) -> c_int {
...
//
    ...
    if (!mmio_base) {
    dev_err(hba.dev,
    "Invalid memory reference for mmio_base is core::ptr::null_mut()\n");
    err = -ENODEV;
    goto out_error;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_resume_complete(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_rpm_ok_for_spm(hba: *mut ufs_hba) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn __ufshcd_suspend_prepare(dev: *mut device, rpm_ok_for_spm: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_suspend_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wl_poweroff(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wl_probe(sdev: *mut scsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_wl_remove(sdev: *mut scsi_device) {
    ...
    SET_RUNTIME_PM_OPS(ufshcd_wl_runtime_suspend, ufshcd_wl_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn ufshcd_check_header_layout() {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_core_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ufshcd_core_exit() -> void __exit {
