...
//! Source: drivers/ufs/core/ufs-txeq.c
#![no_std]
...
pub const TX_EQ_SETTING_MASK: c_uint = 0x7;
...
#[no_mangle]
unsafe extern "C" fn txeq_gear_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    let mut adaptive_txeq_gear: static unsigned int = UFS_HS_G6;
    ...
    module_param_array(txeq_presets_selected, bool, core::ptr::null_mut(), 0644);
    MODULE_PARM_DESC(txeq_presets_selected, "Use only the selected Presets out of the 8 TX Equalization Presets for TX EQTR");
#[no_mangle]
unsafe extern "C" fn txeq_setting_sel_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    let mut retrieve_txeq_setting: static bool = true;
    ...
    let mut store_txeq_setting: static bool = true;
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_device_preshoot_decode(eq: u64, lane: u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_device_deemphasis_decode(eq: u64, lane: u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_host_preshoot_decode(eq: u64, lane: u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_host_deemphasis_decode(eq: u64, lane: u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_device_precode_en_decode(eq_ext: u16, lane: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_host_precode_en_decode(eq_ext: u16, lane: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_device_preshoot_encode(val: u64, lane: u8) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_device_deemphasis_encode(val: u64, lane: u8) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_host_preshoot_encode(val: u64, lane: u8) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_host_deemphasis_encode(val: u64, lane: u8) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_device_precode_en_encode(en: bool, lane: u8) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn tx_eq_host_precode_en_encode(en: bool, lane: u8) -> u16 {
...
//
    ...
    let mut local_precode_en: u32 = 0;
    let mut peer_precode_en: u32 = 0;
    int lane, ret;
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_print_tx_eq_params(hba: *mut ufs_hba) {
    void ufshcd_print_tx_eq_params(struct ufs_hba *hba)
    {
    struct ufs_pa_layer_attr *pwr_info = &hba.max_pwr_info.info;
    struct ufshcd_tx_eq_params *params;
    let mut gear: u32 = hba.pwr_info.gear_tx;
    int lane;
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_is_txeq_presets_used(hba: *mut ufs_hba) -> bool {
    bool ufshcd_is_txeq_presets_used(struct ufs_hba *hba)
    {
    return use_txeq_presets;
    }
#[no_mangle]
pub unsafe extern "C" fn ufshcd_is_txeq_preset_selected(preshoot: u8, deemphasis: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn adapt_cap_to_t_adapt(adapt_cap: u32) -> u64 {
    static inline u64 adapt_cap_to_t_adapt(u32 adapt_cap)
    {
    u64 tadapt;
    let mut adapt_length: u8 = adapt_cap & ADAPT_LENGTH_MASK;
...
//
#[no_mangle]
pub unsafe extern "C" fn adapt_cap_to_t_adapt_l0l3(adapt_cap: u32) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn adapt_cap_to_t_adapt_l0l1l2l3(adapt_cap: u32) -> u64 {
...
//
    ...
    let mut h_iter: tx_eqtr_iter = {};
    let mut d_iter: tx_eqtr_iter = {};
    let mut gear: u32 = pwr_mode.gear_tx;
...
// Use the target power mode's HS rate
    ...
    let mut rate: u32 = pwr_mode.hs_rate;
    int ret;
...
//
    ...
    if (!pwr_mode) {
    dev_err(hba.dev, "Target power mode is core::ptr::null_mut()\n");
    return -EINVAL;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_apply_valid_tx_eq_settings(hba: *mut ufs_hba) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ufshcd_retrain_tx_eq(hba: *mut ufs_hba, gear: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_extract_tx_eq_settings_attrs(hba: *mut ufs_hba, gear: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_retrieve_tx_eq_settings(hba: *mut ufs_hba) {
    void ufshcd_retrieve_tx_eq_settings(struct ufs_hba *hba)
    {
    let mut gear: u8 = (u8)adaptive_txeq_gear;
...
//
#[no_mangle]
unsafe extern "C" fn ufshcd_update_tx_eq_settings_attrs(hba: *mut ufs_hba, gear: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn ufshcd_store_tx_eq_settings(hba: *mut ufs_hba) {
