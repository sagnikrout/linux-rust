...
//! Source: drivers/ufs/host/ufs-amd-versal2.c
#![no_std]
...
// PHY modes
pub const UFSHCD_DWC_PHY_MODE_ROM: c_int = 0;

pub const TIMEOUT_MICROSEC: c_int = 1000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ufs_versal2_host {
    pub hba: *mut ufs_hba,
    pub rstc: *mut reset_control,
    pub rstphy: *mut reset_control,
    pub phy_mode: u32,
    pub host_clk: c_ulong,
    pub attcompval0: u8,
    pub attcompval1: u8,
    pub ctlecompval0: u8,
    pub ctlecompval1: u8,
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_phy_reg_write(hba: *mut ufs_hba, addr: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_phy_reg_read(hba: *mut ufs_hba, addr: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_enable_phy(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_setup_phy(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_phy_init(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_init(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_phy_ratesel(hba: *mut ufs_hba, activelanes: u32, rx_req: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_versal2_remove(pdev: *mut platform_device) {
