...
//! Source: drivers/ufs/host/tc-dwc-g210-pci.c
#![no_std]
...
pub const TC_G210_20BIT: c_int = 20;
pub const TC_G210_40BIT: c_int = 40;
pub const TC_G210_INV: c_int = 0;
    let mut tc_type: static int = TC_G210_INV;
...
//
#[no_mangle]
unsafe extern "C" fn tc_dwc_g210_pci_remove(pdev: *mut pci_dev) {
