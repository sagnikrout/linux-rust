...
//! Source: drivers/ufs/host/ufs-renesas.c
#![no_std]
...
pub const EFUSE_CALIB_SIZE: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ufs_renesas_priv {
    pub fw: *const firmware,
    pub hba): *mut *mut void (pre_init)(struct ufs_hba,
    pub /: *mut *mut bool initialized; / The hardware needs initialization once,
    pub calib: [u8; EFUSE_CALIB_SIZE],
}

    MODULE_FIRMWARE(UFS_RENESAS_FIRMWARE_NAME);
#[no_mangle]
unsafe extern "C" fn ufs_renesas_dbg_register_dump(hba: *mut ufs_hba) {
    static void ufs_renesas_dbg_register_dump(struct ufs_hba *hba)
    {
    ufshcd_dump_regs(hba, 0xc0, 0x40, "regs: 0xc0 + ");
    }
#[no_mangle]
unsafe extern "C" fn ufs_renesas_poll(hba: *mut ufs_hba, reg: u32, expected: u32, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_read(hba: *mut ufs_hba, reg: u32) -> u32 {
    static u32 ufs_renesas_read(struct ufs_hba *hba, u32 reg)
    {
    return ufshcd_readl(hba, reg);
    }
#[no_mangle]
unsafe extern "C" fn ufs_renesas_write(hba: *mut ufs_hba, reg: u32, value: u32) {
    static void ufs_renesas_write(struct ufs_hba *hba, u32 reg, u32 value)
    {
    ufshcd_writel(hba, value, reg);
    }
#[no_mangle]
unsafe extern "C" fn ufs_renesas_write_d0_d4(hba: *mut ufs_hba, data_d0: u32, data_d4: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_write_804_80c_poll(hba: *mut ufs_hba, addr: u32, data_804: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_write_828_82c_poll(hba: *mut ufs_hba, data_828: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_write_phy(hba: *mut ufs_hba, addr16: u32, data16: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_set_phy(hba: *mut ufs_hba, addr16: u32, data16: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_reset_indirect_update(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_init_step1_to_3(hba: *mut ufs_hba, init108: bool) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_init_step4_to_6(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_init_disable_timer(hba: *mut ufs_hba) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_init_enable_timer(hba: *mut ufs_hba, timer_val: u32) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_init_compensation_and_slicers(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_r8a779f0_es10_pre_init(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_r8a779f0_init_step3_add(hba: *mut ufs_hba, assert: bool) {
    static void ufs_renesas_r8a779f0_init_step3_add(struct ufs_hba *hba, bool assert)
    {
    let mut val_2x: u32 = 0, val_3x = 0, val_4x = 0;
    if (assert) {
    val_2x = 0x0001;
    val_3x = 0x0003;
    val_4x = 0x0001;
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_r8a779f0_pre_init(hba: *mut ufs_hba) {
...
#[no_mangle]
pub unsafe extern "C" fn if(POST_CHANGE: !on && status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_init(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_exit(hba: *mut ufs_hba) {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_set_dma_mask(hba: *mut ufs_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ufs_renesas_probe(pdev: *mut platform_device) -> c_int {
    static int ufs_renesas_probe(struct platform_device *pdev)
    {
    return ufshcd_pltfrm_init(pdev, &ufs_renesas_vops);
    }
#[no_mangle]
unsafe extern "C" fn ufs_renesas_remove(pdev: *mut platform_device) {
