...
#[no_mangle]
unsafe extern "C" fn clear_exclusive(mds: *mut c_void) {
    static void clear_exclusive(void *mds)
    {
    clear_exclusive_cxl_commands(mds, exclusive_cmds);
    }
#[no_mangle]
unsafe extern "C" fn unregister_nvdimm(nvdimm: *mut c_void) {
    static void unregister_nvdimm(void *nvdimm)
    {
    nvdimm_delete(nvdimm);
    }
#[no_mangle]
unsafe extern "C" fn provider_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn cxl_nvdimm_arm_dirty_shutdown_tracking(cxl_nvd: *mut cxl_nvdimm) {
...
#[no_mangle]
unsafe extern "C" fn cxl_nvdimm_probe(dev: *mut device) -> c_int {
...
//
    ...
    cmd_mask, 0, core::ptr::null_mut(), cxl_nvd.dev_id,
    cxl_security_ops, core::ptr::null_mut());
    if (!nvdimm)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn detach_nvdimm(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unregister_nvdimm_bus(_cxl_nvb: *mut c_void) {
    static void unregister_nvdimm_bus(void *_cxl_nvb)
    {
    struct cxl_nvdimm_bridge *cxl_nvb = _cxl_nvb;
    struct nvdimm_bus *nvdimm_bus = cxl_nvb.nvdimm_bus;
    bus_for_each_dev(&cxl_bus_type, core::ptr::null_mut(), cxl_nvb, detach_nvdimm);
    cxl_nvb.nvdimm_bus = core::ptr::null_mut();
    nvdimm_bus_unregister(nvdimm_bus);
    }
#[no_mangle]
unsafe extern "C" fn cxl_nvdimm_bridge_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unregister_nvdimm_region(nd_region: *mut c_void) {
    static void unregister_nvdimm_region(void *nd_region)
    {
    nvdimm_region_delete(nd_region);
    }
#[no_mangle]
unsafe extern "C" fn cxlr_pmem_remove_resource(res: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_pmem_region_info {
    pub offset: u64,
    pub serial: u64,
}

#[no_mangle]
unsafe extern "C" fn cxl_pmem_region_probe(dev: *mut device) -> c_int {
    ...
    struct cxl_pmem_region_info *info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cxl_pmem_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmem_exit() -> __exit void {
