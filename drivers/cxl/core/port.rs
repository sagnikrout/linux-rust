...
//! Source: drivers/cxl/core/port.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn is_cxl_host_bridge(dev: *mut device) -> bool {
    static bool is_cxl_host_bridge(struct device *dev)
    {
    return (!dev || dev == &platform_bus);
    }
#[no_mangle]
pub unsafe extern "C" fn cxl_num_decoders_committed(port: *mut cxl_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_device_id(dev: *const device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emit_target_list(cxlsd: *mut cxl_switch_decoder, buf: *mut c_char) -> isize {
    ...
    struct cxl_dport *next = core::ptr::null_mut();
    if (!dport)
    break;
...
// without @cxl_rwsem.dpa, make sure @part is not reloaded
    let mut part: c_int = READ_ONCE(cxled.part);
    const char *desc;
    if (part < 0)
    desc = "none";
    else
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "ram")) -> else {
    ...
    {
    struct cxl_endpoint_decoder *cxled = to_cxl_endpoint_decoder(dev);
    let mut size: resource_size_t = cxl_dpa_size(cxled);
...
#[no_mangle]
unsafe extern "C" fn can_create_pmem(cxlrd: *mut cxl_root_decoder) -> bool {
    static bool can_create_pmem(struct cxl_root_decoder *cxlrd)
    {
    let mut flags: c_ulong = CXL_DECODER_F_TYPE3 | CXL_DECODER_F_PMEM;
    return (cxlrd.cxlsd.cxld.flags & flags) == flags;
    }
#[no_mangle]
unsafe extern "C" fn can_create_ram(cxlrd: *mut cxl_root_decoder) -> bool {
    static bool can_create_ram(struct cxl_root_decoder *cxlrd)
    {
    let mut flags: c_ulong = CXL_DECODER_F_TYPE3 | CXL_DECODER_F_RAM;
    return (cxlrd.cxlsd.cxld.flags & flags) == flags;
    }
#[no_mangle]
unsafe extern "C" fn cxl_root_decoder_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn __cxl_decoder_release(cxld: *mut cxl_decoder) {
...
#[no_mangle]
unsafe extern "C" fn cxl_endpoint_decoder_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn cxl_switch_decoder_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn cxl_root_decoder_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn is_endpoint_decoder(dev: *mut device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_root_decoder(dev: *mut device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_switch_decoder(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_ep_release(ep: *mut cxl_ep) {
...
#[no_mangle]
unsafe extern "C" fn cxl_ep_remove(port: *mut cxl_port, ep: *mut cxl_ep) {
...
#[no_mangle]
unsafe extern "C" fn cxl_port_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn is_cxl_port(dev: *const device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unregister_port(_port: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cxl_unlink_uport(_port: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_cxl_link_uport(host: *mut device, port: *mut cxl_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_unlink_parent_dport(_port: *mut c_void) {
    ...
    struct cxl_dport *parent_dport)
    {
    struct cxl_root *cxl_root __free(kfree) = core::ptr::null_mut();
    struct cxl_port *port, *_port __free(kfree) = core::ptr::null_mut();
    struct device *dev;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: parent_dport->rch) -> else {
...
#[no_mangle]
unsafe extern "C" fn cxl_einj_inject(data: *mut c_void, type: u64) -> c_int {
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(cxl_einj_inject_fops, core::ptr::null_mut(), cxl_einj_inject,
    "0x%llx\n");
#[no_mangle]
unsafe extern "C" fn cxl_debugfs_create_dport_dir(dport: *mut cxl_dport) {
...
//
    ...
    parent_dport);
    parent_port = parent_dport ? parent_dport.port : core::ptr::null_mut();
    if (IS_ERR(port)) {
    ...
    {
    struct cxl_port *port;
    port = devm_cxl_add_port(host, host, CXL_RESOURCE_NONE, core::ptr::null_mut());
    if (IS_ERR(port))
...
#[no_mangle]
unsafe extern "C" fn unregister_pci_bus(uport_dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dev_is_cxl_root_child(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_dport(port: *mut cxl_port, dport: *mut cxl_dport) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cond_cxl_root_lock(port: *mut cxl_port) {
...
#[no_mangle]
unsafe extern "C" fn cond_cxl_root_unlock(port: *mut cxl_port) {
...
#[no_mangle]
unsafe extern "C" fn cxl_dport_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cxl_dport_unlink(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn free_dport(dport: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cxl_dport_close_dr_group(dport: *mut cxl_dport, group: *mut c_void) {
    static void cxl_dport_close_dr_group(struct cxl_dport *dport, void *group)
    {
    devres_close_group(dport_to_host(dport), group);
    }
#[no_mangle]
unsafe extern "C" fn del_dport(dport: *mut cxl_dport) {
...
// memdev
//
    rc = cxl_dport_setup_regs(core::ptr::null_mut(), dport, component_reg_phys);
    if (rc)
    return ERR_PTR(rc);
    dport.rch = true;
    }
...
#[no_mangle]
unsafe extern "C" fn add_ep(new: *mut cxl_ep) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_add_ep(dport: *mut cxl_dport, ep_dev: *mut device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_find_port_ctx {
    pub dport_dev: *const device,
    pub parent_port: *const cxl_port,
    pub dport: *mut cxl_dport,
}

#[no_mangle]
unsafe extern "C" fn match_port_by_dport(dev: *mut device, data: *const c_void) -> c_int {
    ...
    if (ctx.dport)
// ctx->dport = dport;
    return dport != core::ptr::null_mut();
    }
    ...
    if (!ctx.dport_dev)
    return core::ptr::null_mut();
    dev = bus_find_device(&cxl_bus_type, core::ptr::null_mut(), ctx, match_port_by_dport);
    if (dev)
...
#[no_mangle]
unsafe extern "C" fn delete_endpoint(data: *mut c_void) {
    ...
    cxlmd.endpoint = core::ptr::null_mut();
    }
    put_device(&endpoint.dev);
    put_device(host);
    }
#[no_mangle]
pub unsafe extern "C" fn cxl_endpoint_autoremove(cxlmd: *mut cxl_memdev, endpoint: *mut cxl_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn delete_switch_port(port: *mut cxl_port) {
...
#[no_mangle]
unsafe extern "C" fn del_dports(port: *mut cxl_port) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct detach_ctx {
    pub cxlmd: *mut cxl_memdev,
    pub depth: c_int,
}

#[no_mangle]
unsafe extern "C" fn port_has_memdev(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_detach_ep(data: *mut c_void) {
    ...
    bus_find_device(&cxl_bus_type, core::ptr::null_mut(), &ctx, port_has_memdev);
    if (!dev)
    continue;
    port = to_cxl_port(dev);
...
#[no_mangle]
unsafe extern "C" fn find_component_registers(dev: *mut device) -> resource_size_t {
...
#[no_mangle]
unsafe extern "C" fn match_port_by_uport(dev: *mut device, data: *const c_void) -> c_int {
...
// Endpoint ports are hosted by memdevs
    if (is_cxl_memdev(port.uport_dev))
    let mut uport_dev: return = = port.uport_dev.parent;
    let mut uport_dev: return = = port.uport_dev;
    }
//
...
//
    ...
    {
    struct device *dev;
    dev = bus_find_device(&cxl_bus_type, core::ptr::null_mut(), uport_dev, match_port_by_uport);
    if (dev)
    return to_cxl_port(dev);
    return core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn update_decoder_targets(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dport_exists(port: *mut cxl_port, dport_dev: *mut device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn devm_cxl_enumerate_ports(cxlmd: *mut cxl_memdev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_decoder_init(port: *mut cxl_port, cxld: *mut cxl_decoder) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cxl_decoder_add_locked(cxld: *mut cxl_decoder) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cxl_decoder_add(cxld: *mut cxl_decoder) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxld_unregister(dev: *mut c_void) {
    static void cxld_unregister(void *dev)
    {
    if (is_endpoint_decoder(dev))
    cxl_decoder_detach(core::ptr::null_mut(), to_cxl_endpoint_decoder(dev), -1,
    DETACH_INVALIDATE);
...
#[no_mangle]
pub unsafe extern "C" fn cxl_decoder_autoremove(host: *mut device, cxld: *mut cxl_decoder) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_driver_unregister(cxl_drv: *mut cxl_driver) {
...
#[no_mangle]
unsafe extern "C" fn cxl_bus_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
    static int cxl_bus_match(struct device *dev, const struct device_driver *drv)
    {
    return cxl_device_id(dev) == to_cxl_drv(drv).id;
    }
#[no_mangle]
unsafe extern "C" fn cxl_bus_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_bus_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn cxl_rescan_attach(dev: *mut device, data: *mut c_void) -> c_int {
    static int cxl_rescan_attach(struct device *dev, void *data)
    {
    let mut rc: c_int = device_attach(dev);
    dev_vdbg(dev, "rescan: %s\n", rc ? "attach" : "detached");
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cxl_bus_rescan_queue(w: *mut work_struct) {
    static void cxl_bus_rescan_queue(struct work_struct *w)
    {
    bus_for_each_dev(&cxl_bus_type, core::ptr::null_mut(), core::ptr::null_mut(), cxl_rescan_attach);
    }
#[no_mangle]
pub unsafe extern "C" fn cxl_bus_rescan() {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_bus_drain() {
...
#[no_mangle]
pub unsafe extern "C" fn schedule_cxl_memdev_detach(cxlmd: *mut cxl_memdev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_latency(c: *mut access_coordinate, latency: c_long) {
...
#[no_mangle]
unsafe extern "C" fn coordinates_valid(c: *mut access_coordinate) -> bool {
...
#[no_mangle]
unsafe extern "C" fn set_min_bandwidth(c: *mut access_coordinate, bw: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn parent_port_is_cxl_root(port: *mut cxl_port) -> bool {
...
// Get the calculated PCI paths bandwidth
    pdev = to_pci_dev(dev);
    bw = pcie_bandwidth_available(pdev, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    if (bw == 0)
    return -ENXIO;
    bw /= BITS_PER_BYTE;
...
#[no_mangle]
unsafe extern "C" fn flush_store(bus: *const bus_type, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn cxl_core_init() -> __init int {
    static __init int cxl_core_init(void)
    {
    int rc;
    cxl_debugfs = debugfs_create_dir("cxl", core::ptr::null_mut());
    if (einj_cxl_is_initialized())
    debugfs_create_file("einj_types", 0400, cxl_debugfs, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn cxl_core_exit() {
