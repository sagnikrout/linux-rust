...
//! Source: drivers/cxl/core/memdev.c
#![no_std]
...
// config
//
pub const CXL_MEM_MAX_DEVS: c_int = 65536;
    static int cxl_mem_major;
    static DEFINE_IDA(cxl_memdev_ida);
#[no_mangle]
unsafe extern "C" fn cxl_memdev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn cxl_ram_size(cxlds: *mut cxl_dev_state) -> resource_size_t {
...
// Static RAM is only expected at partition 0.
    ...
    struct cxl_memdev *cxlmd = to_cxl_memdev(dev);
    struct cxl_dev_state *cxlds = cxlmd.cxlds;
    let mut len: c_ulonglong = cxl_ram_size(cxlds);
    return sysfs_emit(buf, "%#llx\n", len);
    }
    static struct device_attribute dev_attr_ram_size =
    __ATTR(size, 0444, ram_size_show, core::ptr::null_mut());
    static ssize_t pmem_size_show(struct device *dev, struct device_attribute *attr,
    char *buf)
    {
    struct cxl_memdev *cxlmd = to_cxl_memdev(dev);
    struct cxl_dev_state *cxlds = cxlmd.cxlds;
    let mut len: c_ulonglong = cxl_pmem_size(cxlds);
    return sysfs_emit(buf, "%#llx\n", len);
    }
    static struct device_attribute dev_attr_pmem_size =
    __ATTR(size, 0444, pmem_size_show, core::ptr::null_mut());
    ...
    struct cxl_memdev_state *mds = to_cxl_memdev_state(cxlds);
    let mut state: c_ulong = mds.security.state;
    let mut rc: c_int = 0;
// sync with latest submission state
    ...
    __ATTR(state, 0444, security_state_show, core::ptr::null_mut());
    ...
    __ATTR(sanitize, 0200, core::ptr::null_mut(), security_sanitize_store);
    ...
    __ATTR(erase, 0200, core::ptr::null_mut(), security_erase_store);
...
#[no_mangle]
unsafe extern "C" fn cxl_get_poison_by_memdev(cxlmd: *mut cxl_memdev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_trigger_poison_list(cxlmd: *mut cxl_memdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_validate_poison_dpa(cxlmd: *mut cxl_memdev, dpa: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_inject_poison_locked(cxlmd: *mut cxl_memdev, dpa: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_inject_poison(cxlmd: *mut cxl_memdev, dpa: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_clear_poison_locked(cxlmd: *mut cxl_memdev, dpa: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_clear_poison(cxlmd: *mut cxl_memdev, dpa: u64) -> c_int {
    ...
    __ATTR(qos_class, 0444, pmem_qos_class_show, core::ptr::null_mut());
    ...
    __ATTR(qos_class, 0444, ram_qos_class_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cxl_ram_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmem_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_memdev_update_perf(cxlmd: *mut cxl_memdev) {
...
#[no_mangle]
pub unsafe extern "C" fn is_cxl_memdev(dev: *const device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn add_part(info: *mut cxl_dpa_info, start: u64, size: u64, mode: enum cxl_partition_mode) {
    static void add_part(struct cxl_dpa_info *info, u64 start, u64 size, enum cxl_partition_mode mode)
    {
    let mut i: c_int = info.nr_partitions;
    if (size == 0)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn cxl_mem_dpa_fetch(mds: *mut cxl_memdev_state, info: *mut cxl_dpa_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cxl_set_capacity(cxlds: *mut cxl_dev_state, capacity: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_memdev_shutdown(dev: *mut device) {
    static void cxl_memdev_shutdown(struct device *dev)
    {
    struct cxl_memdev *cxlmd = to_cxl_memdev(dev);
    guard(rwsem_write)(&cxl_memdev_rwsem);
    cxlmd.cxlds = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cxl_memdev_unregister(_cxlmd: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn detach_memdev(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cxl_memdev_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_memdev_release_file(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_mem_get_fw_info(mds: *mut cxl_memdev_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_mem_activate_fw(mds: *mut cxl_memdev_state, slot: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_mem_abort_fw_xfer(mds: *mut cxl_memdev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_fw_cleanup(fwl: *mut fw_upload) {
...
#[no_mangle]
unsafe extern "C" fn cxl_fw_do_cancel(fwl: *mut fw_upload) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_fw_poll_complete(fwl: *mut fw_upload) -> enum fw_upload_err {
...
#[no_mangle]
unsafe extern "C" fn cxl_fw_cancel(fwl: *mut fw_upload) {
...
#[no_mangle]
unsafe extern "C" fn cxl_remove_fw_upload(fwl: *mut c_void) {
    static void cxl_remove_fw_upload(void *fwl)
    {
    firmware_upload_unregister(fwl);
    }
#[no_mangle]
pub unsafe extern "C" fn devm_cxl_setup_fw_upload(host: *mut device, mds: *mut cxl_memdev_state) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cxlmd_add(cxlmd: *mut cxl_memdev, cxlds: *mut cxl_dev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_memdev_attach_failed(cxlmd: *mut cxl_memdev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sanitize_teardown_notifier(data: *mut c_void) {
...
//
    ...
    mds.security.sanitize_node = core::ptr::null_mut();
    mutex_unlock(&cxl_mbox.mbox_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn cxl_memdev_init() -> __init int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_memdev_exit() {
