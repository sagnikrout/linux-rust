...
//! Source: drivers/cxl/core/pmem.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn unregister_nvb(_cxl_nvb: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cxl_nvdimm_bridge_failed_attach(cxl_nvb: *mut cxl_nvdimm_bridge) -> bool {
...
// If the device has no driver, then it failed to attach.
    return dev.driver == core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn cxlmd_release_nvdimm(_cxlmd: *mut c_void) {
    static void cxlmd_release_nvdimm(void *_cxlmd)
    {
    struct cxl_memdev *cxlmd = _cxlmd;
    struct cxl_nvdimm *cxl_nvd = cxlmd.cxl_nvd;
    struct cxl_nvdimm_bridge *cxl_nvb = cxlmd.cxl_nvb;
    cxl_nvd.cxlmd = core::ptr::null_mut();
    cxlmd.cxl_nvd = core::ptr::null_mut();
    cxlmd.cxl_nvb = core::ptr::null_mut();
