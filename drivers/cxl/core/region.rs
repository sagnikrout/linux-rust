...
//! Source: drivers/cxl/core/region.c
#![no_std]
...
//
    let mut nodemask_region_seen: static nodemask_t = NODE_MASK_NONE;
...
#[no_mangle]
pub unsafe extern "C" fn ACCESS_DEVICE_ATTR_RO(_arg: level, _arg: attrib) -> static {
...
#[no_mangle]
unsafe extern "C" fn is_dup(match: *mut device, data: *mut c_void) -> c_int {
    ...
    return -EBUSY;
    rc = bus_for_each_dev(&cxl_bus_type, core::ptr::null_mut(), &temp, is_dup);
    if (rc < 0)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn cxl_region_invalidate_memregion(cxlr: *mut cxl_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_region_decode_reset(cxlr: *mut cxl_region, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn commit_decoder(cxld: *mut cxl_decoder) -> c_int {
    static int commit_decoder(struct cxl_decoder *cxld)
    {
    struct cxl_switch_decoder *cxlsd = core::ptr::null_mut();
    if (cxld.commit)
...
#[no_mangle]
unsafe extern "C" fn cxl_region_decode_commit(cxlr: *mut cxl_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_reset(cxlr: *mut cxl_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __commit(cxlr: *mut cxl_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_interleave_ways(cxlr: *mut cxl_region, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_interleave_granularity(cxlr: *mut cxl_region, val: c_int) -> c_int {
...
//
    ...
    desc = "ram";
#[no_mangle]
pub unsafe extern "C" fn if(CXL_PARTMODE_PMEM: cxlr->mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn alloc_hpa(cxlr: *mut cxl_region, size: resource_size_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_region_iomem_release(cxlr: *mut cxl_region) {
...
//
    ...
    kfree(p.res);
    p.res = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn free_hpa(cxlr: *mut cxl_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_targetN(cxlr: *mut cxl_region, buf: *mut c_char, pos: c_int) -> usize {
...
#[no_mangle]
unsafe extern "C" fn check_commit_order(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn match_free_decoder(dev: *mut device, data: *const c_void) -> c_int {
    ...
    rc = device_for_each_child_reverse_from(dev.parent, dev, core::ptr::null_mut(),
    check_commit_order);
    if (rc) {
    dev_dbg(dev.parent,
...
#[no_mangle]
unsafe extern "C" fn match_auto_decoder(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    dev = device_find_child(&port.dev, core::ptr::null_mut(), match_free_decoder);
    if (!dev)
...
#[no_mangle]
unsafe extern "C" fn cxl_rr_free_decoder(cxl_rr: *mut cxl_region_ref) {
    ...
    if (cxld.region == cxlr) {
    cxld.region = core::ptr::null_mut();
    put_device(&cxlr.dev);
    }
    }
#[no_mangle]
unsafe extern "C" fn free_region_ref(cxl_rr: *mut cxl_region_ref) {
...
//
    ...
    struct cxl_region_ref *cxl_rr;
    let mut nr_targets_inc: bool = false;
    struct cxl_decoder *cxld;
    unsigned long index;
...
//
    ...
    {
    struct cxl_region_ref *cxl_rr;
    struct cxl_ep *ep = core::ptr::null_mut();
    lockdep_assert_held_write(&cxl_rwsem.region);
    cxl_rr = cxl_rr_load(port, cxlr);
    if (!cxl_rr)
    return;
...
#[no_mangle]
unsafe extern "C" fn check_interleave_cap(cxld: *mut cxl_decoder, iw: c_int, ig: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_region_teardown_targets(cxlr: *mut cxl_region) {
...
#[no_mangle]
unsafe extern "C" fn cxl_region_setup_targets(cxlr: *mut cxl_region) -> c_int {
...
//
    ...
    let mut iw: c_int = cxld.interleave_ways;
    struct cxl_port *iter;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn cmp_interleave_pos(a: *const c_void, b: *const c_void) -> c_int {
...
//
    ...
    struct cxl_memdev *cxlmd = cxled_to_memdev(cxled);
    let mut parent_ways: c_int = 0, parent_pos = 0, pos = 0;
    int rc;
//
...
#[no_mangle]
unsafe extern "C" fn cxl_region_sort_targets(cxlr: *mut cxl_region) -> c_int {
...
// Keep the cxlr target list in interleave position order
    ...
    cmp_interleave_pos, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cxl_region_remove_target(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_cancel_auto_attach(cxled: *mut cxl_endpoint_decoder) {
    static void cxl_cancel_auto_attach(struct cxl_endpoint_decoder *cxled)
    {
    if (cxled.state != CXL_DECODER_STATE_AUTO_STAGED)
    return;
    bus_for_each_dev(&cxl_bus_type, core::ptr::null_mut(), cxled, cxl_region_remove_target);
    }
    ...
    p.targets[cxled.pos] = core::ptr::null_mut();
    p.nr_targets--;
    cxled.cxld.hpa_range = (struct range) {
    .start = 0,
    .end = -1,
...
// when the decoder is being destroyed lock unconditionally
    ...
    unsigned int state)
    {
    let mut rc: c_int = __attach_target(cxlr, cxled, pos, state);
    if (rc == 0)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn detach_target(cxlr: *mut cxl_region, pos: c_int) -> c_int {
    static int detach_target(struct cxl_region *cxlr, int pos)
    {
    return cxl_decoder_detach(cxlr, core::ptr::null_mut(), pos, DETACH_ONLY);
    }
    ...
    struct device *dev;
    dev = bus_find_device_by_name(&cxl_bus_type, core::ptr::null_mut(), buf);
    if (!dev)
    return -ENODEV;
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RW(_arg: target##n) -> static {
...
#[no_mangle]
unsafe extern "C" fn cxl_region_release(dev: *mut device) {
    static void cxl_region_release(struct device *dev)
    {
    struct cxl_region *cxlr = to_cxl_region(dev);
    struct cxl_root_decoder *cxlrd = cxlr.cxlrd;
    let mut id: c_int = atomic_read(&cxlrd.region_id);
//
...
#[no_mangle]
pub unsafe extern "C" fn is_cxl_region(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn unregister_region(cxlr: *mut cxl_region) {
...
#[no_mangle]
unsafe extern "C" fn endpoint_unregister_region(_cxlr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cxl_region_update_coordinates(cxlr: *mut cxl_region, nid: c_int) -> bool {
    static bool cxl_region_update_coordinates(struct cxl_region *cxlr, int nid)
    {
    let mut cset: c_int = 0;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn kill_regions(cxlrd: *mut cxl_root_decoder) {
...
#[no_mangle]
unsafe extern "C" fn __create_region_show(cxlrd: *mut cxl_root_decoder, buf: *mut c_char) -> isize {
...
//
    ...
    for (p = res.child, last = core::ptr::null_mut(); p; p = p.sibling)
    last = p;
    if (last)
    offset = last.end + 1;
    else
    ...
    if (!length)
    break;
    rc = cxl_mem_get_poison(cxlmd, offset, length, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn poison_by_decoder(dev: *mut device, arg: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_get_poison_by_endpoint(port: *mut cxl_port) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_dpa_to_region_context {
    pub cxlr: *mut cxl_region,
    pub dpa: u64,
}

#[no_mangle]
unsafe extern "C" fn __cxl_dpa_to_region(dev: *mut device, arg: *mut c_void) -> c_int {
    static int __cxl_dpa_to_region(struct device *dev, void *arg)
    {
    struct cxl_dpa_to_region_context *ctx = arg;
    struct cxl_endpoint_decoder *cxled;
    struct cxl_region *cxlr;
    let mut dpa: u64 = ctx.dpa;
    if (!is_endpoint_decoder(dev))
    return 0;
    cxled = to_cxl_endpoint_decoder(dev);
...
#[no_mangle]
unsafe extern "C" fn cxl_is_hpa_in_chunk(hpa: u64, cxlr: *mut cxl_region, pos: c_int) -> bool {
    static bool cxl_is_hpa_in_chunk(u64 hpa, struct cxl_region *cxlr, int pos)
    {
    struct cxl_region_params *p = &cxlr.params;
    let mut gran: c_int = p.interleave_granularity;
    let mut ways: c_int = p.interleave_ways;
    u64 offset;
...
//
#[no_mangle]
pub unsafe extern "C" fn cxl_validate_translation_params(eiw: u8, eig: u16, pos: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_calculate_dpa_offset(hpa_offset: u64, eiw: u8, eig: u16) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_calculate_position(hpa_offset: u64, eiw: u8, eig: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_calculate_hpa_offset(dpa_offset: u64, pos: c_int, eiw: u8, eig: u16) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn restore_parent(addr: u64, pos: u64, gran: u64, ways: u64) -> u64 {
    static u64 restore_parent(u64 addr, u64 pos, u64 gran, u64 ways)
    {
    let mut mask: u64 = gran - 1;
...
//
    ...
    {
    let mut ways_port: c_int = p.interleave_ways / cxld.interleave_ways;
    let mut gran_port: c_int = p.interleave_granularity;
    let mut gran_hb: c_int = cxld.interleave_granularity;
    let mut ways_hb: c_int = cxld.interleave_ways;
    int pos_port, pos_hb, gran_shift;
    let mut hpa_port: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn region_is_unaligned_mod3(cxlr: *mut cxl_region) -> bool {
    static bool region_is_unaligned_mod3(struct cxl_region *cxlr)
    {
    struct cxl_root_decoder *cxlrd = to_cxl_root_decoder(cxlr.dev.parent);
    struct cxl_decoder *cxld = &cxlrd.cxlsd.cxld;
    struct cxl_region_params *p = &cxlr.params;
    let mut hbiw: c_int = cxld.interleave_ways;
    u64 rem;
    ...
    struct cxl_decoder *cxld = &cxlrd.cxlsd.cxld;
    struct cxl_region_params *p = &cxlr.params;
    struct cxl_endpoint_decoder *cxled = core::ptr::null_mut();
    u64 base, dpa_offset, hpa_offset, hpa;
    let mut unaligned: bool = false;
    let mut eig: u16 = 0;
    let mut eiw: u8 = 0;
    int pos;
//
...
pub struct dpa_result {
    ...
    let mut hpa: u64 = p.res.start + offset;
    let mut tmp: u64 = offset;
//
...
#[no_mangle]
unsafe extern "C" fn match_root_decoder(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn match_region_by_range(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_add_to_region(cxled: *mut cxl_endpoint_decoder) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_system_ram(res: *mut resource, arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn shutdown_notifiers(_cxlr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn remove_debugfs(dentry: *mut c_void) {
    static void remove_debugfs(void *dentry)
    {
    debugfs_remove_recursive(dentry);
    }
#[no_mangle]
unsafe extern "C" fn validate_region_offset(cxlr: *mut cxl_region, offset: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_region_debugfs_poison_inject(data: *mut c_void, offset: u64) -> c_int {
    static int cxl_region_debugfs_poison_inject(void *data, u64 offset)
    {
    let mut result: dpa_result = { .dpa = ULLONG_MAX, .cxlmd = core::ptr::null_mut() };
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(cxl_poison_inject_fops, core::ptr::null_mut(),
    cxl_region_debugfs_poison_inject, "%llx\n");
#[no_mangle]
unsafe extern "C" fn cxl_region_debugfs_poison_clear(data: *mut c_void, offset: u64) -> c_int {
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(cxl_poison_clear_fops, core::ptr::null_mut(),
    cxl_region_debugfs_poison_clear, "%llx\n");
#[no_mangle]
unsafe extern "C" fn cxl_region_setup_poison(cxlr: *mut cxl_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn region_contains_resource(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_region_contains_resource(res: *const resource) -> bool {
    bool cxl_region_contains_resource(const struct resource *res)
    {
    guard(rwsem_read)(&cxl_rwsem.region);
    struct device *dev __free(put_device) = bus_find_device(
    &cxl_bus_type, core::ptr::null_mut(), res, region_contains_resource);
    return !!dev;
    }
    EXPORT_SYMBOL_FOR_MODULES(cxl_region_contains_resource, "dax_hmem");
#[no_mangle]
unsafe extern "C" fn cxl_region_can_probe(cxlr: *mut cxl_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn first_mapped_decoder(dev: *mut device, data: *const c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cxl_memdev_attach_region(cxlmd: *mut cxl_memdev) -> c_int {
...
//
    struct device *dev __free(put_device) =
    device_find_child(&endpoint.dev, core::ptr::null_mut(), first_mapped_decoder);
    if (!dev) {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_region_has_memdev_attach(cxlr: *mut cxl_region) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_region_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_region_init() -> c_int {
    int cxl_region_init(void)
    {
    return cxl_driver_register(&cxl_region_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn cxl_region_exit() {
