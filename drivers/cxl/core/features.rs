...
//! Source: drivers/cxl/core/features.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_cxl_feature_exclusive_by_uuid(uuid: *const uuid_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_cxl_feature_exclusive(entry: *mut cxl_feat_entry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_get_supported_features_count(cxl_mbox: *mut cxl_mailbox) -> c_int {
    ...
    let mut feat_size: c_int = sizeof(struct cxl_feat_entry);
    struct cxl_mbox_get_sup_feats_in mbox_in;
    struct cxl_feat_entry *entry;
    struct cxl_mbox_cmd mbox_cmd;
    let mut user_feats: c_int = 0;
    int count;
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_cxl_setup_features(cxlds: *mut cxl_dev_state) -> c_int {
    ...
    struct cxl_mbox_cmd mbox_cmd;
    let mut data_rcvd_size: usize = 0;
    int rc;
    if (return_code)
...
//
pub const FEAT_DATA_MIN_PAYLOAD_SIZE: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn cxlctl_open_uctx(uctx: *mut fwctl_uctx) -> c_int {
    static int cxlctl_open_uctx(struct fwctl_uctx *uctx)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cxlctl_close_uctx(uctx: *mut fwctl_uctx) {
...
// out_len = out_size;
    ...
    let mut out_size: usize = *out_len;
    if (rpc_in.op_size != sizeof(*feat_in))
    return ERR_PTR(-EINVAL);
...
#[no_mangle]
unsafe extern "C" fn free_memdev_fwctl(_fwctl_dev: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn devm_cxl_setup_fwctl(host: *mut device, cxlmd: *mut cxl_memdev) -> c_int {
