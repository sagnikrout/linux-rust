...
//
    let mut media_ready_timeout: static unsigned short = 60;
    module_param(media_ready_timeout, ushort, 0644);
    MODULE_PARM_DESC(media_ready_timeout, "seconds to wait for media ready");
#[no_mangle]
unsafe extern "C" fn pci_get_port_num(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_dvsec_mem_range_valid(cxlds: *mut cxl_dev_state, id: c_int) -> c_int {
    static int cxl_dvsec_mem_range_valid(struct cxl_dev_state *cxlds, int id)
    {
    struct pci_dev *pdev = to_pci_dev(cxlds.dev);
    let mut d: c_int = cxlds.cxl_dvsec;
...
#[no_mangle]
unsafe extern "C" fn cxl_dvsec_mem_range_active(cxlds: *mut cxl_dev_state, id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cxl_await_media_ready(cxlds: *mut cxl_dev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_set_mem_enable(cxlds: *mut cxl_dev_state, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clear_mem_enable(cxlds: *mut c_void) {
    static void clear_mem_enable(void *cxlds)
    {
    cxl_set_mem_enable(cxlds, 0);
    }
#[no_mangle]
unsafe extern "C" fn devm_cxl_enable_mem(host: *mut device, cxlds: *mut cxl_dev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvsec_range_allowed(dev: *mut device, arg: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disable_hdm(_cxlhdm: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_cxl_enable_hdm(host: *mut device, cxlhdm: *mut cxl_hdm) -> c_int {
...
pub const CXL_DOE_TABLE_ACCESS_REQ_CODE: c_uint = 0x000000ff;
pub const CXL_DOE_TABLE_ACCESS_REQ_CODE_READ: c_int = 0;
pub const CXL_DOE_TABLE_ACCESS_TABLE_TYPE: c_uint = 0x0000ff00;
pub const CXL_DOE_TABLE_ACCESS_TABLE_TYPE_CDATA: c_int = 0;
pub const CXL_DOE_TABLE_ACCESS_ENTRY_HANDLE: c_uint = 0xffff0000;
pub const CXL_DOE_TABLE_ACCESS_LAST_ENTRY: c_uint = 0xffff;
pub const CXL_DOE_PROTOCOL_TABLE_ACCESS: c_int = 2;
    ...
    size_t *length)
    {
    let mut request: __le32 = CDAT_DOE_REQ(0);
    __le32 response[2];
    int rc;
...
// length = le32_to_cpu(response[1]);
    ...
    let mut entry_handle: c_uint = 0;
    union cdat_data *data;
    let mut saved_dw: __le32 = 0;
    do {
    let mut request: __le32 = CDAT_DOE_REQ(entry_handle);
    int rc;
    rc = pci_doe(doe_mb, PCI_VENDOR_ID_CXL,
    CXL_DOE_PROTOCOL_TABLE_ACCESS,
    &request, sizeof(request),
...
#[no_mangle]
unsafe extern "C" fn cdat_checksum(buf: *mut c_void, size: usize) -> c_uchar {
...
//
#[no_mangle]
pub unsafe extern "C" fn read_cdat_data(port: *mut cxl_port) {
...
#[no_mangle]
unsafe extern "C" fn cxl_flit_size(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cxl_pci_get_latency(pdev: *mut pci_dev) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn __cxl_endpoint_decoder_reset_detected(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_endpoint_decoder_reset_detected(port: *mut cxl_port) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_pci_get_bandwidth(pdev: *mut pci_dev, c: *mut access_coordinate) -> c_int {
...
// system to wait.
//
pub const GPF_TIMEOUT_BASE_MAX: c_int = 2;

#[no_mangle]
pub unsafe extern "C" fn cxl_gpf_get_dvsec(dev: *mut device) -> u16 {
    u16 cxl_gpf_get_dvsec(struct device *dev)
    {
    struct pci_dev *pdev;
    let mut is_port: bool = true;
    u16 dvsec;
    if (!dev_is_pci(dev))
    return 0;
    pdev = to_pci_dev(dev);
...
#[no_mangle]
unsafe extern "C" fn update_gpf_port_dvsec(pdev: *mut pci_dev, dvsec: c_int, phase: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cxl_gpf_port_setup(dport: *mut cxl_dport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn count_dports(pdev: *mut pci_dev, data: *mut c_void) -> c_int {
    static int count_dports(struct pci_dev *pdev, void *data)
    {
    struct cxl_walk_context *ctx = data;
    let mut type: c_int = pci_pcie_type(pdev);
    if (pdev.bus != ctx.bus)
    return 0;
    if (!pci_is_pcie(pdev))
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn cxl_port_get_possible_dports(port: *mut cxl_port) -> c_int {
