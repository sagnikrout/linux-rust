...
//
#[no_mangle]
unsafe extern "C" fn enable_suspend(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cxl_mem_dpa_show(file: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_debugfs_poison_inject(data: *mut c_void, dpa: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_debugfs_poison_clear(data: *mut c_void, dpa: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_mem_probe(dev: *mut device) -> c_int {
...
//
    cxl_mem_active_inc();
    return devm_add_action_or_reset(dev, enable_suspend, core::ptr::null_mut());
    }
//
...
//
    ...
    {
    return __devm_cxl_add_memdev(cxlds, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn cxl_poison_attr_visible(kobj: *mut kobject, a: *mut attribute) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_mem_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
