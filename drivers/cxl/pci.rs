...
//
    let mut mbox_ready_timeout: static unsigned short = 60;
    module_param(mbox_ready_timeout, ushort, 0644);
    MODULE_PARM_DESC(mbox_ready_timeout, "seconds to wait for mailbox ready");
#[no_mangle]
unsafe extern "C" fn cxl_pci_mbox_wait_for_doorbell(cxlds: *mut cxl_dev_state) -> c_int {
    static int cxl_pci_mbox_wait_for_doorbell(struct cxl_dev_state *cxlds)
    {
    let mut start: c_ulong = jiffies;
    let mut end: c_ulong = start;
...
pub struct cxl_dev_id {
    ...
    return -ENOMEM;
    dev_id.cxlds = cxlds;
    return devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), thread_fn,
    IRQF_SHARED | IRQF_ONESHOT, core::ptr::null_mut(),
    dev_id);
    }
#[no_mangle]
unsafe extern "C" fn cxl_mbox_background_complete(cxlds: *mut cxl_dev_state) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_pci_mbox_irq(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
unsafe extern "C" fn cxl_mbox_sanitize_work(work: *mut work_struct) {
    ...
    let mut timeout: c_int = mds.security.poll_tmo_secs + 10;
...
// #5
    ...
    if (rc == -ETIMEDOUT) {
    let mut md_status: u64 = readq(cxlds.regs.memdev + CXLMDEV_STATUS_OFFSET);
...
#[no_mangle]
unsafe extern "C" fn cxl_pci_setup_mailbox(mds: *mut cxl_memdev_state, irq_avail: bool) -> c_int {
    static int cxl_pci_setup_mailbox(struct cxl_memdev_state *mds, bool irq_avail)
    {
    struct cxl_dev_state *cxlds = &mds.cxlds;
    struct cxl_mailbox *cxl_mbox = &cxlds.cxl_mbox;
    let mut cap: c_int = readl(cxlds.regs.mbox + CXLDEV_MBOX_CAPS_OFFSET);
    struct device *dev = cxlds.dev;
...
#[no_mangle]
unsafe extern "C" fn free_event_buf(buf: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_mem_alloc_event_buf(mds: *mut cxl_memdev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_alloc_irq_vectors(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_event_thread(irq: c_int, id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cxl_event_req_irq(cxlds: *mut cxl_dev_state, setting: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_event_irqsetup(mds: *mut cxl_memdev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_event_int_is_fw(setting: u8) -> bool {
    static bool cxl_event_int_is_fw(u8 setting)
    {
    let mut mode: u8 = FIELD_GET(CXLDEV_EVENT_INT_MODE_MASK, setting);
    let mut mode: return = = CXL_INT_FW;
    }
...
#[no_mangle]
unsafe extern "C" fn cxl_pci_type3_init_mailbox(cxlds: *mut cxl_dev_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcd_pcie_cap_emit(dev: *mut device, offset: u16, buf: *mut c_char, width: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn cxl_rcd_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn cxl_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn cxl_error_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cxl_endpoint_decoder_clear_reset_flags(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_reset_done(pdev: *mut pci_dev) {
...
//
    ...
    device_for_each_child(&cxlmd.endpoint.dev, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn cxl_cper_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cxl_pci_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cxl_pci_driver_exit() -> void __exit {
