...
//
#[no_mangle]
unsafe extern "C" fn schedule_detach(cxlmd: *mut c_void) {
    static void schedule_detach(void *cxlmd)
    {
    schedule_cxl_memdev_detach(cxlmd);
    }
#[no_mangle]
unsafe extern "C" fn discover_region(dev: *mut device, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_switch_port_probe(port: *mut cxl_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_ras_unmask(port: *mut cxl_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_endpoint_port_probe(port: *mut cxl_port) -> c_int {
...
//
    device_for_each_child(&port.dev, core::ptr::null_mut(), discover_region);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cxl_port_probe(dev: *mut device) -> c_int {
...
//
    for (iter = parent_port, down = core::ptr::null_mut(); !is_cxl_root(iter);
...
#[no_mangle]
unsafe extern "C" fn cxl_port_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cxl_port_exit() -> void __exit {
