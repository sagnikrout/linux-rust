...
// Check if vtag is supported by client
    ...
    cb = mei_cl_alloc_cb(cl, length, MEI_FOP_WRITE, core::ptr::null_mut());
    if (!cb) {
    rets = -ENOMEM;
    goto out;
    }
...
//
    ...
    size_t r_length;
    ssize_t rets;
    let mut nonblock: bool = !!(mode & MEI_CL_IO_RX_NONBLOCK);
    if (WARN_ON(!cl || !cl.dev))
    return -ENODEV;
    bus = cl.dev;
    mutex_lock(&bus.device_lock);
    ...
    cb = mei_cl_read_cb(cl, core::ptr::null_mut());
    if (cb)
    goto copy;
    rets = mei_cl_read_start(cl, length, core::ptr::null_mut());
    if (rets && rets != -EBUSY)
    goto out;
    if (nonblock) {
    rets = -EAGAIN;
...
// synchronized under device mutex
    ...
    (cl.rx_wait,
    mei_cl_read_cb(cl, core::ptr::null_mut()) ||
    (!mei_cl_is_connected(cl)),
...
//
    ...
    {
    return mei_cldev_recv_vtag_timeout(cldev, buf, length, core::ptr::null_mut(), timeout);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_send(cldev: *mut mei_cl_device, buf: *const u8, length: usize) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_recv(cldev: *mut mei_cl_device, buf: *mut u8, length: usize) -> isize {
    ssize_t mei_cldev_recv(struct mei_cl_device *cldev, u8 *buf, size_t length)
    {
    return mei_cldev_recv_vtag(cldev, buf, length, core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_rx_work(work: *mut work_struct) {
    ...
    mei_cl_read_start(cldev.cl, mei_cl_mtu(cldev.cl), core::ptr::null_mut());
    mutex_unlock(&bus.device_lock);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_notif_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cl_bus_notify_event(cl: *mut mei_cl) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cl_bus_rx_event(cl: *mut mei_cl) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_register_rx_cb(cldev: *mut mei_cl_device, rx_cb: mei_cldev_cb_t) -> c_int {
    ...
    mutex_lock(&bus.device_lock);
    if (mei_cl_is_connected(cldev.cl))
    ret = mei_cl_read_start(cldev.cl, mei_cl_mtu(cldev.cl), core::ptr::null_mut());
    else
    ret = -ENODEV;
    mutex_unlock(&bus.device_lock);
    if (ret && ret != -EBUSY) {
    cancel_work_sync(&cldev.rx_work);
    cldev.rx_cb = core::ptr::null_mut();
    return ret;
    }
    return 0;
    }
...
//
    ...
    mutex_lock(&bus.device_lock);
    ret = mei_cl_notify_request(cldev.cl, core::ptr::null_mut(), 1);
    mutex_unlock(&bus.device_lock);
    if (ret) {
    cancel_work_sync(&cldev.notif_work);
    cldev.notif_cb = core::ptr::null_mut();
    return ret;
    }
    return 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_set_drvdata(cldev: *mut mei_cl_device, data: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_ver(cldev: *const mei_cl_device) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_mtu(cldev: *const mei_cl_device) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_enabled(cldev: *const mei_cl_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_module_get(cldev: *mut mei_cl_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_module_put(cldev: *mut mei_cl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_vtag_alloc(cldev: *mut mei_cl_device) -> c_int {
...
//
    ...
    return 0;
    cl_vtag = mei_cl_vtag_alloc(core::ptr::null_mut(), 0);
    if (IS_ERR(cl_vtag))
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_vtag_free(cldev: *mut mei_cl_device) {
...
// update pointers
    ...
    ret = mei_cl_dma_alloc_and_map(cl, core::ptr::null_mut(), buffer_id, size);
    if (ret)
    mei_cl_unlink(cl);
    notlinked:
    mutex_unlock(&bus.device_lock);
...
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_dma_unmap(cldev: *mut mei_cl_device) -> c_int {
    ...
    bus = cldev.bus;
    mutex_lock(&bus.device_lock);
    ret = mei_cl_dma_unmap(cl, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_enable(cldev: *mut mei_cl_device) -> c_int {
...
// update pointers
    ...
    if (ret)
    goto out;
    ret = mei_cl_connect(cl, cldev.me_cl, core::ptr::null_mut());
    if (ret < 0) {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cldev_unregister_callbacks(cldev: *mut mei_cl_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_disable(cldev: *mut mei_cl_device) -> c_int {
...
//
    ...
    let mut buf_sz: usize = sizeof(struct mei_ext_hdr_gsc_h2f);
...
// receive the reply from GSC, note that at this point sg_in should contain the reply
    ret = __mei_cl_recv(cl, (u8 *)&rx_msg, sizeof(rx_msg), core::ptr::null_mut(), MEI_CL_IO_SGL, 0);
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_device_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_device_probe(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_device_remove(dev: *mut device) {
    ...
    {
    struct mei_cl_device *cldev = to_mei_cl_device(dev);
    let mut version: u8 = mei_me_cl_ver(cldev.me_cl);
    ...
    {
    struct mei_cl_device *cldev = to_mei_cl_device(dev);
    let mut maxconn: u8 = mei_me_cl_max_conn(cldev.me_cl);
    ...
    {
    struct mei_cl_device *cldev = to_mei_cl_device(dev);
    let mut fixed: u8 = mei_me_cl_fixed(cldev.me_cl);
    ...
    {
    struct mei_cl_device *cldev = to_mei_cl_device(dev);
    let mut vt: bool = mei_me_cl_vt(cldev.me_cl);
    ...
    {
    struct mei_cl_device *cldev = to_mei_cl_device(dev);
    let mut maxlen: u32 = mei_me_cl_max_len(cldev.me_cl);
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_device_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_dev_bus_put(bus: *mut mei_device) {
...
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_dev_release(dev: *mut device) {
    ...
    mei_cl_flush_queues(cldev.cl, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cl_bus_set_name(cldev: *mut mei_cl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_dev_add(cldev: *mut mei_cl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_dev_stop(cldev: *mut mei_cl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_dev_destroy(cldev: *mut mei_cl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_remove_device(cldev: *mut mei_cl_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cl_bus_remove_devices(bus: *mut mei_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_bus_rescan(bus: *mut mei_device) {
...
#[no_mangle]
pub unsafe extern "C" fn mei_cl_bus_rescan_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mei_cldev_driver_unregister(cldrv: *mut mei_cl_driver) {
...
#[no_mangle]
pub unsafe extern "C" fn mei_cl_bus_init() -> int __init {
    int __init mei_cl_bus_init(void)
    {
    return bus_register(&mei_cl_bus_type);
    }
#[no_mangle]
pub unsafe extern "C" fn mei_cl_bus_exit() -> void __exit {
