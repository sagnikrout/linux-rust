...
//! Source: drivers/misc/mei/interrupt.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_irq_compl_handler(dev: *mut mei_device, cmpl_list: *mut list_head) {
...
//
    ...
    {
    if (hdr.dma_ring) {
    mei_dma_ring_read(dev, core::ptr::null_mut(),
...
//
    ...
    struct mei_cl_cb *cb;
    struct mei_ext_hdr_vtag *vtag_hdr = core::ptr::null_mut();
    struct mei_ext_hdr_gsc_f2h *gsc_f2h = core::ptr::null_mut();
    size_t buf_sz;
    u32 length;
    u32 ext_len;
    ...
    if (gsc_f2h) {
    let mut ext_hdr_len: u32 = mei_ext_hdr_len(&gsc_f2h.hdr);
...
#[no_mangle]
pub unsafe extern "C" fn hdr_is_hbm(mei_hdr: *mut mei_msg_hdr) -> bool {
    static inline bool hdr_is_hbm(struct mei_msg_hdr *mei_hdr)
    {
    return mei_hdr.host_addr == 0 && mei_hdr.me_addr == 0;
    }
#[no_mangle]
pub unsafe extern "C" fn hdr_is_fixed(mei_hdr: *mut mei_msg_hdr) -> bool {
    static inline bool hdr_is_fixed(struct mei_msg_hdr *mei_hdr)
    {
    return mei_hdr.host_addr == 0 && mei_hdr.me_addr != 0;
    }
#[no_mangle]
pub unsafe extern "C" fn hdr_is_valid(msg_hdr: u32) -> c_int {
...
//
    ...
    {
    struct mei_msg_hdr *mei_hdr;
    struct mei_ext_meta_hdr *meta_hdr = core::ptr::null_mut();
    struct mei_cl *cl;
    int ret;
    u32 hdr_size_left;
    u32 hdr_size_ext;
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_irq_write_handler(dev: *mut mei_device, cmpl_list: *mut list_head) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_connect_timeout(cl: *mut mei_cl) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_schedule_stall_timer(dev: *mut mei_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_timer(work: *mut work_struct) {
    void mei_timer(struct work_struct *work)
    {
    struct mei_cl *cl;
    struct mei_device *dev = container_of(work,
    struct mei_device, timer_work.work);
    let mut reschedule_timer: bool = false;
