...
//! Source: drivers/misc/mei/main.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mei_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    struct mei_cl *cl = file.private_data;
    struct mei_device *dev;
    struct mei_cl_cb *cb = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_vtag_by_fp(cl: *const mei_cl, fp: *const file) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn mei_vt_support_check(dev: *mut mei_device, uuid: *const uuid_le) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_ioctl_client_notify_request(file: *const file, request: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_ioctl_client_notify_get(file: *const file, notify_get: *mut u32) -> c_int {
    static int mei_ioctl_client_notify_get(const struct file *file, u32 *notify_get)
    {
    struct mei_cl *cl = file.private_data;
    bool notify_ev;
    let mut block: bool = (file.f_flags & O_NONBLOCK) == 0;
    int rets;
...
//
#[no_mangle]
unsafe extern "C" fn mei_ioctl(file: *mut file, cmd: c_uint, data: c_ulong) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn mei_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
#[no_mangle]
unsafe extern "C" fn mei_cl_is_write_queued(cl: *mut mei_cl) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mei_fsync(fp: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_fasync(fd: c_int, file: *mut file, band: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_set_devstate(dev: *mut mei_device, state: enum mei_dev_state) {
    ...
    if (clsdev) {
    sysfs_notify(&clsdev.kobj, core::ptr::null_mut(), "dev_state");
    put_device(clsdev);
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn mei_minor_get(dev: *mut mei_device) -> c_int {
    ...
    dev.minor = ret;
#[no_mangle]
pub unsafe extern "C" fn if(-ENOSPC: ret ==) -> else {
    else if (ret == -ENOSPC)
...
//
#[no_mangle]
unsafe extern "C" fn mei_minor_free(minor: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mei_device_release(dev: *mut device) {
    static void mei_device_release(struct device *dev)
    {
    kfree(dev_get_drvdata(dev));
    }
#[no_mangle]
pub unsafe extern "C" fn mei_register(dev: *mut mei_device, parent: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mei_deregister(dev: *mut mei_device) {
    void mei_deregister(struct mei_device *dev)
    {
    int devno;
    let mut minor: c_int = dev.minor;
    devno = dev.cdev.dev;
    cdev_del(dev.cdev);
...
#[no_mangle]
unsafe extern "C" fn mei_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mei_exit() -> void __exit {
