...
//! Source: drivers/misc/mei/gsc_proxy/mei_gsc_proxy.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mei_gsc_proxy_send(dev: *mut device, buf: *const c_void, size: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_gsc_proxy_recv(dev: *mut device, buf: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_component_master_bind(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_component_master_unbind(dev: *mut device) {
...
// Only built-in GFX
    ...
    mei_gsc_proxy_component_match, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mei_gsc_proxy_remove(cldev: *mut mei_cl_device) {
