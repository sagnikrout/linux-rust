...
//! Source: drivers/misc/mei/dma-ring.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dmam_ring_free(dev: *mut mei_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dmam_ring_alloc(dev: *mut mei_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dma_ring_is_allocated(dev: *mut mei_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dma_ring_reset(dev: *mut mei_device) {
...
//
    ...
    let mut b_offset: usize = offset << 2;
    let mut b_n: usize = n << 2;
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dma_ring_read(dev: *mut mei_device, buf: *mut c_uchar, len: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mei_dma_ring_hbuf_depth(dev: *mut mei_device) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dma_ring_empty_slots(dev: *mut mei_device) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dma_ring_write(dev: *mut mei_device, buf: *mut c_uchar, len: u32) {
