...
//! Source: drivers/misc/mei/gsc-me.c
#![no_std]
...
pub const MEI_GSC_RPM_TIMEOUT: c_int = 500;
#[no_mangle]
unsafe extern "C" fn mei_gsc_read_hfs(dev: *const mei_device, where: c_int, name: *const c_char, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_gsc_set_ext_op_mem(hw: *const mei_me_hw, mem: *mut resource) {
    static void mei_gsc_set_ext_op_mem(const struct mei_me_hw *hw, struct resource *mem)
    {
    let mut low: u32 = lower_32_bits(mem.start);
    let mut hi: u32 = upper_32_bits(mem.start);
    let mut limit: u32 = (resource_size(mem) / SZ_4K) | GSC_EXT_OP_MEM_VALID;
...
//
    ...
    dev_set_drvdata(device, core::ptr::null_mut());
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn mei_gsc_remove(aux_dev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn mei_gsc_pm_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mei_gsc_pm_resume(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mei_gsc_pm_runtime_idle(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mei_gsc_pm_runtime_suspend(device: *mut device) -> int  __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mei_gsc_pm_runtime_resume(device: *mut device) -> int __maybe_unused {
