...
//! Source: drivers/misc/mei/platform-vsc.c
#![no_std]
...
pub const MEI_VSC_MAX_MSG_SIZE: c_int = 512;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mei_vsc_host_timestamp {
    pub realtime: u64,
    pub boottime: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mei_vsc_hw {
    pub tp: *mut vsc_tp,
    pub fw_ready: bool,
    pub host_ready: bool,
    pub write_lock_cnt: core::sync::atomic::AtomicI32,
    pub rx_len: u32,
    pub rx_hdr: u32,
// buffer for tx
    pub ____cacheline_aligned: char tx_buf[MEI_VSC_MAX_MSG_SIZE + sizeof(struct mei_msg_hdr)],
// buffer for rx
    pub ____cacheline_aligned: char rx_buf[MEI_VSC_MAX_MSG_SIZE + sizeof(struct mei_msg_hdr)],
}
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_write_helper(hw: *mut mei_vsc_hw, buf: *mut u8, len: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mei_vsc_pg_state(mei_dev: *mut mei_device) -> enum mei_pg_state {
    static inline enum mei_pg_state mei_vsc_pg_state(struct mei_device *mei_dev)
    {
    return MEI_PG_OFF;
    }
#[no_mangle]
unsafe extern "C" fn mei_vsc_intr_enable(mei_dev: *mut mei_device) {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_intr_disable(mei_dev: *mut mei_device) {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_intr_clear(mei_dev: *mut mei_device) {
    static void mei_vsc_intr_clear(struct mei_device *mei_dev)
    {
    }
// wait for pending irq handler
#[no_mangle]
unsafe extern "C" fn mei_vsc_synchronize_irq(mei_dev: *mut mei_device) {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_hw_config(mei_dev: *mut mei_device) -> c_int {
    static int mei_vsc_hw_config(struct mei_device *mei_dev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mei_vsc_host_is_ready(mei_dev: *mut mei_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_hw_is_ready(mei_dev: *mut mei_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_hw_start(mei_dev: *mut mei_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_hbuf_is_ready(mei_dev: *mut mei_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_hbuf_empty_slots(mei_dev: *mut mei_device) -> c_int {
    static int mei_vsc_hbuf_empty_slots(struct mei_device *mei_dev)
    {
    return MEI_VSC_MAX_MSG_SIZE / MEI_SLOT_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn mei_vsc_hbuf_depth(mei_dev: *const mei_device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn mei_vsc_read(mei_dev: *const mei_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_count_full_read_slots(mei_dev: *mut mei_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_pg_in_transition(mei_dev: *mut mei_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_pg_is_enabled(mei_dev: *mut mei_device) -> bool {
    static bool mei_vsc_pg_is_enabled(struct mei_device *mei_dev)
    {
    return false;
    }
#[no_mangle]
unsafe extern "C" fn mei_vsc_hw_reset(mei_dev: *mut mei_device, intr_enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_event_cb(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_probe(pdev: *mut platform_device) -> c_int {
    ...
    vsc_tp_register_event_cb(tp, core::ptr::null_mut(), core::ptr::null_mut());
    mei_disable_interrupts(mei_dev);
    mei_deregister(mei_dev);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn mei_vsc_remove(pdev: *mut platform_device) {
    ...
    mei_stop(mei_dev);
    vsc_tp_register_event_cb(hw.tp, core::ptr::null_mut(), core::ptr::null_mut());
    mei_disable_interrupts(mei_dev);
    mei_deregister(mei_dev);
    }
#[no_mangle]
unsafe extern "C" fn mei_vsc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_vsc_resume(dev: *mut device) -> c_int {
