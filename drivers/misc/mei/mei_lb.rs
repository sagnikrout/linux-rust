...
//! Source: drivers/misc/mei/mei_lb.c
#![no_std]
...
pub const INTEL_LB_CMD: c_uint = 0x12;

pub const INTEL_LB_SEND_TIMEOUT_MSEC: c_int = 3000;
pub const INTEL_LB_RECV_TIMEOUT_MSEC: c_int = 3000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mei_lb_req {
    pub header: mkhi_msg_hdr,
    pub type: __le32,
    pub flags: __le32,
    pub reserved: [__le32; 2],
    pub payload_size: __le32,
    pub __counted_by(payload_size): u8 payload[],
    pub __packed: },
//
...
pub const MEI_LB2_CMD: c_uint = 0x01;
pub const MEI_LB2_HDR_FLAG_RSP: c_uint = 0x01;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mei_lb2_header {
    pub command_id: __le32,
    pub flags: u8,
    pub reserved: [u8; 3],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mei_lb2_rsp_header {
    pub header: mei_lb2_header,
    pub status: __le32,
}

pub const MEI_LB2_FLAG_FST_CHUNK: c_uint = 0x02;
pub const MEI_LB2_FLAG_LST_CHUNK: c_uint = 0x04;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mei_lb2_req {
    pub header: mei_lb2_header,
    pub type: __le32,
    pub flags: __le32,
    pub reserved: __le32,
    pub total_payload_size: __le32,
    pub payload_size: __le32,
    pub __counted_by(payload_size): u8 payload[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mei_lb2_rsp {
    pub rheader: mei_lb2_rsp_header,
    pub type: __le32,
    pub reserved: [__le32; 2],
}
...
//
    ...
    {
    struct mei_lb_req *req = core::ptr::null_mut();
    struct mei_lb_rsp rsp;
    size_t req_size;
    ssize_t bytes;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mei_lb_component_master_bind(dev: *mut device) -> c_int {
    static int mei_lb_component_master_bind(struct device *dev)
    {
    return component_bind_all(dev, (void *)&mei_lb_ops);
    }
#[no_mangle]
unsafe extern "C" fn mei_lb_component_master_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn mei_lb_remove(cldev: *mut mei_cl_device) {
