...
//! Source: drivers/misc/mei/init.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_cancel_work(dev: *mut mei_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_reset(dev: *mut mei_device) -> c_int {
    int mei_reset(struct mei_device *dev)
    {
    let mut state: enum mei_dev_state = dev.dev_state;
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_start(dev: *mut mei_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_restart(dev: *mut mei_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_reset_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn mei_stop(dev: *mut mei_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_write_is_idle(dev: *mut mei_device) -> bool {
