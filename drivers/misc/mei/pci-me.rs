...
//! Source: drivers/misc/mei/pci-me.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mei_me_read_fws(dev: *const mei_device, where: c_int, name: *const c_char, val: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_me_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mei_me_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn mei_me_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mei_me_pci_prepare(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_me_pci_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_me_pci_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_me_pci_complete(device: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn mei_me_pm_runtime_idle(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_me_pm_runtime_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_me_pm_runtime_resume(device: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_me_set_pm_domain(dev: *mut mei_device) {
    static inline void mei_me_set_pm_domain(struct mei_device *dev)
    {
    struct pci_dev *pdev  = to_pci_dev(dev.parent);
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_me_unset_pm_domain(dev: *mut mei_device) {
    static inline void mei_me_unset_pm_domain(struct mei_device *dev)
    {
// stop using pm callbacks if any
    dev_pm_domain_set(dev.parent, core::ptr::null_mut());
    }
