...
//! Source: drivers/misc/mei/debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mei_dbgfs_meclients_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_dbgfs_active_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mei_dbgfs_devstate_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dbgfs_deregister(dev: *mut mei_device) {
    void mei_dbgfs_deregister(struct mei_device *dev)
    {
    if (!dev.dbgfs_dir)
    return;
    debugfs_remove_recursive(dev.dbgfs_dir);
    dev.dbgfs_dir = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn mei_dbgfs_register(dev: *mut mei_device, name: *const c_char) {
