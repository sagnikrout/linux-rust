...
pub const MAX_CONFIG_LEN: c_int = 40;
    ...
    let mut arch_needs_sstep_emulation: static int = 1;
...
// -1 = init not run yet, 0 = unconfigured, 1 = configured.
    let mut configured: static int = -1;
...
pub struct test_struct {
    pub get: *mut c_char,
    pub put: *mut c_char,
    pub ): *mut *mut void (get_handler)(char,
    pub ): *mut *mut *mut int (put_handler)(char , char,
}
...
pub struct test_state {
    pub name: *mut c_char,
    pub tst: *mut test_struct,
    pub idx: c_int,
    pub int): *mut *mut int (run_test) (int,,
    pub ): *mut *mut int (validate_put) (char,
}

    static struct test_state ts;
#[no_mangle]
unsafe extern "C" fn kgdbts_unreg_thread(ptr: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kgdbts_break_test() -> noinline void {
...
//
#[no_mangle]
unsafe extern "C" fn lookup_addr(arg: *mut c_char) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn break_helper(bp_type: *mut c_char, arg: *mut c_char, vaddr: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn sw_break(arg: *mut c_char) {
    static void sw_break(char *arg)
    {
    break_helper(force_hwbrks ? "Z1" : "Z0", arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn sw_rem_break(arg: *mut c_char) {
    static void sw_rem_break(char *arg)
    {
    break_helper(force_hwbrks ? "z1" : "z0", arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn hw_break(arg: *mut c_char) {
    static void hw_break(char *arg)
    {
    break_helper("Z1", arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn hw_rem_break(arg: *mut c_char) {
    static void hw_rem_break(char *arg)
    {
    break_helper("z1", arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn hw_write_break(arg: *mut c_char) {
    static void hw_write_break(char *arg)
    {
    break_helper("Z2", arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn hw_rem_write_break(arg: *mut c_char) {
    static void hw_rem_write_break(char *arg)
    {
    break_helper("z2", arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn hw_access_break(arg: *mut c_char) {
    static void hw_access_break(char *arg)
    {
    break_helper("Z4", arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn hw_rem_access_break(arg: *mut c_char) {
    static void hw_rem_access_break(char *arg)
    {
    break_helper("z4", arg, 0);
    }
#[no_mangle]
unsafe extern "C" fn hw_break_val_access() {
    static void hw_break_val_access(void)
    {
    READ_ONCE(hw_break_val);
    }
#[no_mangle]
unsafe extern "C" fn hw_break_val_write() {
    static void hw_break_val_write(void)
    {
    hw_break_val++;
    }
#[no_mangle]
unsafe extern "C" fn get_thread_id_continue(put_str: *mut c_char, arg: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_and_rewind_pc(put_str: *mut c_char, arg: *mut c_char) -> c_int {
    static int check_and_rewind_pc(char *put_str, char *arg)
    {
    let mut addr: c_ulong = lookup_addr(arg);
    unsigned long ip;
...
#[no_mangle]
unsafe extern "C" fn check_single_step(put_str: *mut c_char, arg: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_regs(arg: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn skip_back_repeat_test(arg: *mut c_char) {
    static void skip_back_repeat_test(char *arg)
    {
    let mut go_back: c_int = simple_strtol(arg, core::ptr::null_mut(), 10);
    repeat_test--;
    if (repeat_test <= 0) {
    ts.idx++;
    } else {
...
#[no_mangle]
unsafe extern "C" fn got_break(put_str: *mut c_char, arg: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_cont_catch(arg: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn put_cont_catch(put_str: *mut c_char, arg: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emul_reset(put_str: *mut c_char, arg: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn emul_sstep_get(arg: *mut c_char) {
...
// Start by looking at the current PC
    ...
    case 1:
// set breakpoint
    break_helper("Z0", core::ptr::null_mut(), sstep_addr);
    break;
    case 2:
// Continue
    fill_get_buf("c");
...
#[no_mangle]
unsafe extern "C" fn emul_sstep_put(put_str: *mut c_char, arg: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn final_ack_set(put_str: *mut c_char, arg: *mut c_char) -> c_int {
...
//
    ...
    { "kgdbts_break_test", "OK", sw_break, }, /* set sw breakpoint */
    { "c", "T0*", }, /* Continue */
    { "g", "kgdbts_break_test", core::ptr::null_mut(), check_and_rewind_pc },
    { "write", "OK", write_regs },
    { "kgdbts_break_test", "OK", sw_rem_break }, /*remove breakpoint */
    { "D", "OK" }, /* Detach */
    { "D", "OK", core::ptr::null_mut(),  got_break }, /* On success we made it here */
    { "", "" },
    };
//
...
//
    ...
    { "?", "S0*" }, /* Clear break points */
    { "kgdbts_break_test", "OK", sw_break, }, /* set sw breakpoint */
    { "c", "T0*", core::ptr::null_mut(), get_thread_id_continue }, /* Continue */
    { "kgdbts_break_test", "OK", sw_rem_break }, /*remove breakpoint */
    { "g", "kgdbts_break_test", core::ptr::null_mut(), check_and_rewind_pc },
    { "write", "OK", write_regs }, /* Write registers */
    { "s", "T0*", emul_sstep_get, emul_sstep_put }, /* Single step */
    { "g", "kgdbts_break_test", core::ptr::null_mut(), check_single_step },
    { "kgdbts_break_test", "OK", sw_break, }, /* set sw breakpoint */
    { "c", "T0*", }, /* Continue */
    { "g", "kgdbts_break_test", core::ptr::null_mut(), check_and_rewind_pc },
    { "write", "OK", write_regs }, /* Write registers */
...
//
    ...
    { "g", "kernel_clone", core::ptr::null_mut(), check_and_rewind_pc }, /* check location */
    { "write", "OK", write_regs, emul_reset }, /* Write registers */
    { "s", "T0*", emul_sstep_get, emul_sstep_put }, /* Single step */
    { "g", "kernel_clone", core::ptr::null_mut(), check_single_step },
    { "kernel_clone", "OK", sw_break, }, /* set sw breakpoint */
    { "7", "T0*", skip_back_repeat_test }, /* Loop based on repeat_test */
    { "D", "OK", core::ptr::null_mut(), final_ack_set }, /* detach and unregister I/O */
...
//
    ...
    { "g", "do_sys_openat2", core::ptr::null_mut(), check_and_rewind_pc }, /* check location */
    { "write", "OK", write_regs, emul_reset }, /* Write registers */
    { "s", "T0*", emul_sstep_get, emul_sstep_put }, /* Single step */
    { "g", "do_sys_openat2", core::ptr::null_mut(), check_single_step },
    { "do_sys_openat2", "OK", sw_break, }, /* set sw breakpoint */
    { "7", "T0*", skip_back_repeat_test }, /* Loop based on repeat_test */
    { "D", "OK", core::ptr::null_mut(), final_ack_set }, /* detach and unregister I/O */
    { "", "", get_cont_catch, put_cont_catch },
...
//
    ...
    { "c", "T0*", core::ptr::null_mut(), got_break }, /* Continue */
    { "g", "silent", core::ptr::null_mut(), check_and_rewind_pc },
    { "write", "OK", write_regs },
...
#[no_mangle]
unsafe extern "C" fn fill_get_buf(buf: *mut c_char) {
    static void fill_get_buf(char *buf)
    {
    let mut checksum: c_uchar = 0;
...
#[no_mangle]
unsafe extern "C" fn validate_simple_test(put_str: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn run_simple_test(is_get_char: c_int, chr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_simple_test() {
...
#[no_mangle]
unsafe extern "C" fn run_plant_and_detach_test(is_early: c_int) {
...
#[no_mangle]
unsafe extern "C" fn run_breakpoint_test(is_hw_breakpoint: c_int) {
...
#[no_mangle]
unsafe extern "C" fn run_hw_break_test(is_write_test: c_int) {
...
#[no_mangle]
unsafe extern "C" fn run_nmi_sleep_test(nmi_sleep: c_int) {
...
#[no_mangle]
unsafe extern "C" fn run_bad_read_test() {
...
#[no_mangle]
unsafe extern "C" fn run_kernel_clone_test() {
...
#[no_mangle]
unsafe extern "C" fn run_sys_open_test() {
...
#[no_mangle]
unsafe extern "C" fn run_singlestep_break_test() {
...
#[no_mangle]
unsafe extern "C" fn kgdbts_run_tests() {
    static void kgdbts_run_tests(void)
    {
    char *ptr;
    let mut clone_test: c_int = 0;
    let mut do_sys_open_test: c_int = 0;
    let mut sstep_test: c_int = 1000;
    let mut nmi_sleep: c_int = 0;
    int i;
    verbose = 0;
    if (strstr(config, "V1"))
    verbose = 1;
    ...
    ptr = strchr(config, 'F');
    if (ptr)
    clone_test = simple_strtol(ptr + 1, core::ptr::null_mut(), 10);
    ptr = strchr(config, 'S');
    if (ptr)
    do_sys_open_test = simple_strtol(ptr + 1, core::ptr::null_mut(), 10);
    ptr = strchr(config, 'N');
    if (ptr)
    nmi_sleep = simple_strtol(ptr+1, core::ptr::null_mut(), 10);
    ptr = strchr(config, 'I');
    if (ptr)
    sstep_test = simple_strtol(ptr+1, core::ptr::null_mut(), 10);
...
//
    ...
    repeat_test);
    kthread_run(kgdbts_unreg_thread, core::ptr::null_mut(), "kgdbts_unreg");
...
#[no_mangle]
unsafe extern "C" fn kgdbts_option_setup(opt: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn configure_kgdbts() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_kgdbts() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kgdbts_get_char() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdbts_put_char(chr: u8) {
    ...
    {
    let mut len: usize = strlen(kmessage);
...
#[no_mangle]
unsafe extern "C" fn kgdbts_pre_exp_handler() {
...
#[no_mangle]
unsafe extern "C" fn kgdbts_post_exp_handler() {
