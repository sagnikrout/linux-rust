...
//! Source: drivers/misc/tifm_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tifm_dev_match(sock: *mut tifm_dev, id: *const tifm_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tifm_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tifm_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tifm_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tifm_dummy_event(sock: *mut tifm_dev) {
    static void tifm_dummy_event(struct tifm_dev *sock)
    {
    return;
    }
#[no_mangle]
unsafe extern "C" fn tifm_device_remove(dev: *mut device) {
    ...
    drv.remove(sock);
    sock.dev.driver = core::ptr::null_mut();
    }
    put_device(dev);
    }

#[no_mangle]
unsafe extern "C" fn tifm_device_suspend(dev: *mut device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tifm_device_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tifm_free(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn tifm_add_adapter(fm: *mut tifm_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tifm_remove_adapter(fm: *mut tifm_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn tifm_free_adapter(fm: *mut tifm_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn tifm_free_device(dev: *mut device) {
    ...
    unsigned char type)
    {
    struct tifm_dev *sock = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn tifm_eject(sock: *mut tifm_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn tifm_has_ms_pif(sock: *mut tifm_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tifm_queue_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tifm_register_driver(drv: *mut tifm_driver) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tifm_unregister_driver(drv: *mut tifm_driver) {
...
#[no_mangle]
unsafe extern "C" fn tifm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tifm_exit() -> void __exit {
