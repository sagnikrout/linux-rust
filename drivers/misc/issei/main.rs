...
//! Source: drivers/misc/issei/main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn issei_rst_state_set(idev: *mut issei_device, state: enum issei_rst_state) {
...
#[no_mangle]
unsafe extern "C" fn issei_reset(idev: *mut issei_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn issei_process_read_msg(idev: *mut issei_device) -> c_int {
    static int issei_process_read_msg(struct issei_device *idev)
    {
    let mut data: issei_dma_data = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn issei_process_write_msg(idev: *mut issei_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn issei_process_thread(_dev: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn issei_start(idev: *mut issei_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn issei_stop(idev: *mut issei_device) {
