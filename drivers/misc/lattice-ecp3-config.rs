...
//! Source: drivers/misc/lattice-ecp3-config.c
#![no_std]
...
//
pub const ID_ECP3_17: c_uint = 0xc2088080;
pub const ID_ECP3_35: c_uint = 0xc2048080;
// FPGA commands
pub const FPGA_CMD_READ_ID: c_uint = 0x07	/* plus 24 bits */;
pub const FPGA_CMD_READ_STATUS: c_uint = 0x09	/* plus 24 bits */;
pub const FPGA_CMD_CLEAR: c_uint = 0x70;
pub const FPGA_CMD_REFRESH: c_uint = 0x71;
pub const FPGA_CMD_WRITE_EN: c_uint = 0x4a	/* plus 2 bits */;
pub const FPGA_CMD_WRITE_DIS: c_uint = 0x4f	/* plus 8 bits */;
pub const FPGA_CMD_WRITE_INC: c_uint = 0x41	/* plus 0 bits */;
//
// The status register is 32bit revered, DONE is bit 17 from the TN1222.pdf
// (LatticeECP3 Slave SPI Port User's Guide)
//
pub const FPGA_STATUS_DONE: c_uint = 0x00004000;
pub const FPGA_STATUS_CLEARED: c_uint = 0x00010000;

pub const FPGA_CLEAR_MSLEEP: c_int = 10;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fpga_data {
...
#[no_mangle]
unsafe extern "C" fn firmware_load(fw: *const firmware, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn lattice_ecp3_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lattice_ecp3_remove(spi: *mut spi_device) {
