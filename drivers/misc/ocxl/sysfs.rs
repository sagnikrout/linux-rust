...
//! Source: drivers/misc/ocxl/sysfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn global_mmio_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_sysfs_register_afu(info: *mut ocxl_file_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_sysfs_unregister_afu(info: *mut ocxl_file_info) {
