...
//! Source: drivers/misc/ocxl/config.c
#![no_std]
...
pub const OCXL_DVSEC_TEMPL_VERSION: c_uint = 0x0;
pub const OCXL_DVSEC_TEMPL_NAME: c_uint = 0x4;
pub const OCXL_DVSEC_TEMPL_AFU_VERSION: c_uint = 0x1C;
pub const OCXL_DVSEC_TEMPL_MMIO_GLOBAL: c_uint = 0x20;
pub const OCXL_DVSEC_TEMPL_MMIO_GLOBAL_SZ: c_uint = 0x28;
pub const OCXL_DVSEC_TEMPL_MMIO_PP: c_uint = 0x30;
pub const OCXL_DVSEC_TEMPL_MMIO_PP_SZ: c_uint = 0x38;
pub const OCXL_DVSEC_TEMPL_ALL_MEM_SZ: c_uint = 0x3C;
pub const OCXL_DVSEC_TEMPL_LPC_MEM_START: c_uint = 0x40;
pub const OCXL_DVSEC_TEMPL_WWID: c_uint = 0x48;
pub const OCXL_DVSEC_TEMPL_LPC_MEM_SZ: c_uint = 0x58;
pub const OCXL_MAX_AFU_PER_FUNCTION: c_int = 64;
pub const OCXL_TEMPL_LEN_1_0: c_uint = 0x58;
pub const OCXL_TEMPL_LEN_1_1: c_uint = 0x60;
pub const OCXL_TEMPL_NAME_LEN: c_int = 24;
pub const OCXL_CFG_TIMEOUT: c_int = 3;
#[no_mangle]
unsafe extern "C" fn find_dvsec(dev: *mut pci_dev, dvsec_id: c_int) -> c_int {
...
//
    ...
    {
    let mut devfn: c_uint = PCI_DEVFN(PCI_SLOT(dev.devfn), 0);
    return pci_get_domain_bus_and_slot(pci_domain_nr(dev.bus),
    dev.bus.number, devfn);
    }
#[no_mangle]
unsafe extern "C" fn read_pasid(dev: *mut pci_dev, fn: *mut ocxl_fn_config) {
...
#[no_mangle]
unsafe extern "C" fn read_dvsec_tl(dev: *mut pci_dev, fn: *mut ocxl_fn_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_dvsec_function(dev: *mut pci_dev, fn: *mut ocxl_fn_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_dvsec_afu_info(dev: *mut pci_dev, fn: *mut ocxl_fn_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_dvsec_vendor(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_config_get_reset_reload(dev: *mut pci_dev, val: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_config_set_reset_reload(dev: *mut pci_dev, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_function(dev: *mut pci_dev, fn: *mut ocxl_fn_config) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_config_read_function(dev: *mut pci_dev, fn: *mut ocxl_fn_config) -> c_int {
    ...
    {
    u32 val;
    let mut timeout: c_ulong = jiffies + (HZ * OCXL_CFG_TIMEOUT);
    let mut pos: c_int = fn.dvsec_afu_info_pos;
...
#[no_mangle]
unsafe extern "C" fn read_afu_control(dev: *mut pci_dev, afu: *mut ocxl_afu_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn char_allowed(c: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn validate_afu(dev: *mut pci_dev, afu: *mut ocxl_afu_config) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_config_get_pasid_info(dev: *mut pci_dev, count: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_config_set_afu_state(dev: *mut pci_dev, pos: c_int, enable: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_config_set_TL(dev: *mut pci_dev, tl_dvsec: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_config_terminate_pasid(dev: *mut pci_dev, afu_control: c_int, pasid: c_int) -> c_int {
