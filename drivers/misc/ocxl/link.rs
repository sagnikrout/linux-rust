...
//! Source: drivers/misc/ocxl/link.c
#![no_std]
...
pub const SPA_PASID_BITS: c_int = 15;

pub const SPA_PE_VALID: c_uint = 0x80000000;
    struct ocxl_link;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pe_data {
...
// callback to trigger when a translation fault occurs
    pub dsisr): *mut *mut *mut void (xsl_err_cb)(void data, u64 addr, u64,
// opaque pointer to be passed to the above callback
    pub xsl_err_data: *mut c_void,
    pub rcu: rcu_head,
    pub link: *mut ocxl_link,
...
#[derive(Copy, Clone)]
pub struct spa {
    pub spa_mem: *mut ocxl_process_element,
    pub spa_order: c_int,
    pub spa_lock: mutex,
    pub /: *mut *mut radix_tree_root pe_tree; / Maps PE handles to pe_data,
    pub irq_name: *mut c_char,
    pub virq: c_int,
    pub reg_dsisr: *mut void __iomem,
    pub reg_dar: *mut void __iomem,
    pub reg_tfc: *mut void __iomem,
    pub reg_pe_handle: *mut void __iomem,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xsl_fault {
    pub fault_work: work_struct,
    pub pe: u64,
    pub dsisr: u64,
    pub dar: u64,
    pub pe_data: pe_data,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocxl_link {
    pub list: list_head,
    pub ref: kref,
    pub domain: c_int,
    pub bus: c_int,
    pub dev: c_int,
    pub /: *mut *mut *mut void __iomem arva; / ATSD register virtual address,
    pub /: *mut *mut spinlock_t atsd_lock; / to serialize shootdowns,
    pub irq_available: core::sync::atomic::AtomicI32,
    pub spa: *mut spa,
...
#[no_mangle]
unsafe extern "C" fn read_irq(spa: *mut spa, dsisr: *mut u64, dar: *mut u64, pe: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn ack_irq(spa: *mut spa, r: enum xsl_response) {
...
// continue is not supported
    ...
    reg = PPC_BIT(31);
#[no_mangle]
pub unsafe extern "C" fn if(ADDRESS_ERROR: r ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn xsl_fault_handler_bh(fault_work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn xsl_fault_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn unmap_irq_registers(spa: *mut spa) {
...
#[no_mangle]
unsafe extern "C" fn map_irq_registers(dev: *mut pci_dev, spa: *mut spa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_xsl_irq(dev: *mut pci_dev, link: *mut ocxl_link) -> c_int {
...
//
    spa.virq = irq_create_mapping(core::ptr::null_mut(), hwirq);
    if (!spa.virq) {
    dev_err(&dev.dev,
...
#[no_mangle]
unsafe extern "C" fn release_xsl_irq(link: *mut ocxl_link) {
...
#[no_mangle]
unsafe extern "C" fn alloc_spa(dev: *mut pci_dev, link: *mut ocxl_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_spa(link: *mut ocxl_link) {
    ...
    kfree(spa);
    link.spa = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn alloc_link(dev: *mut pci_dev, PE_mask: c_int, out_link: *mut ocxl_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_link(link: *mut ocxl_link) {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_link_setup(dev: *mut pci_dev, PE_mask: c_int, link_handle: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_link_release(dev: *mut pci_dev, link_handle: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn calculate_cfg_state(kernel: bool) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_link_update_pe(link_handle: *mut c_void, pasid: c_int, tid: __u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_link_remove_pe(link_handle: *mut c_void, pasid: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_link_irq_alloc(link_handle: *mut c_void, hw_irq: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_link_free_irq(link_handle: *mut c_void, hw_irq: c_int) {
