...
//! Source: drivers/misc/ocxl/context.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn xsl_fault_error(data: *mut c_void, addr: u64, dsisr: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_context_attach(ctx: *mut ocxl_context, amr: u64, mm: *mut mm_struct) -> c_int {
    int ocxl_context_attach(struct ocxl_context *ctx, u64 amr, struct mm_struct *mm)
    {
    int rc;
    let mut pidr: c_ulong = 0;
    struct pci_dev *dev;
// Locks both status & tidr
    ...
    {
    u64 trigger_addr;
    let mut irq_id: c_int = ocxl_irq_offset_to_id(ctx, offset);
...
#[no_mangle]
unsafe extern "C" fn ocxl_mmap_fault(vmf: *mut vm_fault) -> vm_fault_t {
    ...
    {
    let mut irq_id: c_int = ocxl_irq_offset_to_id(ctx, vma.vm_pgoff << PAGE_SHIFT);
// only one page
    if (vma_pages(vma) != 1)
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_context_mmap(ctx: *mut ocxl_context, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_context_detach(ctx: *mut ocxl_context) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_context_detach_all(afu: *mut ocxl_afu) {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_context_free(ctx: *mut ocxl_context) {
