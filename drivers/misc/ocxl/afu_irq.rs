...
//! Source: drivers/misc/ocxl/afu_irq.c
#![no_std]
...
pub struct afu_irq {
    ...
    pub virq: c_uint,
    pub name: *mut c_char,
    pub private): *mut *mut irqreturn_t (handler)(void,
    pub private): *mut *mut void (free_private)(void,
    pub private: *mut c_void,
}

#[no_mangle]
pub unsafe extern "C" fn ocxl_irq_offset_to_id(ctx: *mut ocxl_context, offset: u64) -> c_int {
    int ocxl_irq_offset_to_id(struct ocxl_context *ctx, u64 offset)
    {
    return (offset - ctx.afu.irq_base_offset) >> PAGE_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn ocxl_irq_id_to_offset(ctx: *mut ocxl_context, irq_id: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn afu_irq_handler(virq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn setup_afu_irq(ctx: *mut ocxl_context, irq: *mut afu_irq) -> c_int {
    static int setup_afu_irq(struct ocxl_context *ctx, struct afu_irq *irq)
    {
    int rc;
    irq.virq = irq_create_mapping(core::ptr::null_mut(), irq.hw_irq);
    if (!irq.virq) {
...
#[no_mangle]
unsafe extern "C" fn release_afu_irq(irq: *mut afu_irq) {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_afu_irq_alloc(ctx: *mut ocxl_context, irq_id: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afu_irq_free(irq: *mut afu_irq, ctx: *mut ocxl_context) {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_afu_irq_free(ctx: *mut ocxl_context, irq_id: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_afu_irq_free_all(ctx: *mut ocxl_context) {
...
#[no_mangle]
pub unsafe extern "C" fn ocxl_afu_irq_get_addr(ctx: *mut ocxl_context, irq_id: c_int) -> u64 {
