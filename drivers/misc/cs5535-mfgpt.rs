...
//! Source: drivers/misc/cs5535-mfgpt.c
#![no_std]
...
pub struct cs5535_mfgpt_timer {
    pub chip: *mut cs5535_mfgpt_chip,
    pub nr: c_int,
}
    ...
    let mut shift: c_int = (cmp == MFGPT_CMP1) ? 0 : 8;
    if (!timer) {
    WARN_ON(1);
    return -EIO;
    }
...
// All chosen and checked - go for it
    ...
    struct cs5535_mfgpt_timer *timer = core::ptr::null_mut();
    unsigned long flags;
    int max;
...
//
#[no_mangle]
pub unsafe extern "C" fn cs5535_mfgpt_free_timer(timer: *mut cs5535_mfgpt_timer) {
...
#[no_mangle]
pub unsafe extern "C" fn cs5535_mfgpt_read(timer: *mut cs5535_mfgpt_timer, reg: u16) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn reset_all_timers() {
...
//
#[no_mangle]
unsafe extern "C" fn scan_timers(mfgpt: *mut cs5535_mfgpt_chip) -> c_int {
    static int scan_timers(struct cs5535_mfgpt_chip *mfgpt)
    {
    let mut timer: cs5535_mfgpt_timer = { .chip = mfgpt };
    unsigned long flags;
    let mut timers: c_int = 0;
    uint16_t val;
    int i;
// bios workaround
    ...
    reset_all_timers();
#[no_mangle]
pub unsafe extern "C" fn if(2: mfgpt_reset_timers ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cs5535_mfgpt_probe(pdev: *mut platform_device) -> c_int {
    static int cs5535_mfgpt_probe(struct platform_device *pdev)
    {
    struct resource *res;
    let mut err: c_int = -EIO, t;
