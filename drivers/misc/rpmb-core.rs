...
//! Source: drivers/misc/rpmb-core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmb_dev_put(rdev: *mut rpmb_dev) {
...
#[no_mangle]
unsafe extern "C" fn rpmb_dev_release(dev: *mut device) {
...
//
    ...
    {
    struct device *dev;
    const struct device *start_dev = core::ptr::null_mut();
    if (start)
    start_dev = &start.dev;
    dev = class_find_device(&rpmb_class, start_dev, data, match);
    return dev ? to_rpmb_dev(dev) : core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(rpmb_dev_find_device);
#[no_mangle]
pub unsafe extern "C" fn rpmb_interface_register(intf: *mut class_interface) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rpmb_interface_unregister(intf: *mut class_interface) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmb_dev_unregister(rdev: *mut rpmb_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmb_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rpmb_exit() -> void __exit {
