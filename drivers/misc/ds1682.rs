...
// Device registers
pub const DS1682_REG_CONFIG: c_uint = 0x00;
pub const DS1682_REG_ALARM: c_uint = 0x01;
pub const DS1682_REG_ELAPSED: c_uint = 0x05;
pub const DS1682_REG_EVT_CNTR: c_uint = 0x09;
pub const DS1682_REG_EEPROM: c_uint = 0x0b;
pub const DS1682_REG_RESET: c_uint = 0x1d;
pub const DS1682_REG_WRITE_DISABLE: c_uint = 0x1e;
pub const DS1682_REG_WRITE_MEM_DISABLE: c_uint = 0x1f;
pub const DS1682_EEPROM_SIZE: c_int = 10;
//
...
//
#[no_mangle]
unsafe extern "C" fn ds1682_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1682_remove(client: *mut i2c_client) {
