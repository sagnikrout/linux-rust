...
//! Source: drivers/misc/tifm_7xx1.c
#![no_std]
...
pub const TIFM_IRQ_ENABLE: c_uint = 0x80000000;

pub const TIFM_IRQ_SETALL: c_uint = 0xffffffff;
    static void tifm_7xx1_dummy_eject(struct tifm_adapter *fm,
    struct tifm_dev *sock)
    {
    }
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_eject(fm: *mut tifm_adapter, sock: *mut tifm_dev) {
...
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !fm->socket_change_set) -> else {
...
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_toggle_sock_power(sock_addr: *mut char __iomem) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_sock_power_off(sock_addr: *mut char __iomem) {
...
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_switch_media(work: *mut work_struct) {
    ...
    fm.sockets[cnt] = core::ptr::null_mut();
    sock_addr = sock.addr;
    spin_unlock_irqrestore(&fm.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_resume(dev_d: *mut device) -> int __maybe_unused {
    ...
    let mut good_sockets: c_uint = 0, bad_sockets = 0;
    unsigned long flags;
// Maximum number of entries is 4
    ...
    fm.addr + FM_SET_INTERRUPT_ENABLE);
    spin_lock_irqsave(&fm.lock, flags);
    fm.finish_me = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_has_ms_pif(fm: *mut tifm_adapter, sock: *mut tifm_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tifm_7xx1_remove(dev: *mut pci_dev) {
