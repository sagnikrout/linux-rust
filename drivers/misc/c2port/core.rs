...
//! Source: drivers/misc/c2port/core.c
#![no_std]
...
//
// C2 registers
pub const C2PORT_DEVICEID: c_uint = 0x00;
pub const C2PORT_REVID: c_uint = 0x01;
pub const C2PORT_FPCTL: c_uint = 0x02;
pub const C2PORT_FPDAT: c_uint = 0xB4;
// C2 interface commands
pub const C2PORT_GET_VERSION: c_uint = 0x01;
pub const C2PORT_DEVICE_ERASE: c_uint = 0x03;
pub const C2PORT_BLOCK_READ: c_uint = 0x06;
pub const C2PORT_BLOCK_WRITE: c_uint = 0x07;
pub const C2PORT_PAGE_ERASE: c_uint = 0x08;
// C2 status return codes
pub const C2PORT_INVALID_COMMAND: c_uint = 0x00;
pub const C2PORT_COMMAND_FAILED: c_uint = 0x02;
pub const C2PORT_COMMAND_OK: c_uint = 0x0d;
//
// C2 port low level signal managements
//
#[no_mangle]
unsafe extern "C" fn c2port_reset(dev: *mut c2port_device) {
...
#[no_mangle]
unsafe extern "C" fn c2port_strobe_ck(dev: *mut c2port_device) {
...
//
#[no_mangle]
unsafe extern "C" fn c2port_write_ar(dev: *mut c2port_device, addr: u8) {
...
#[no_mangle]
unsafe extern "C" fn c2port_read_ar(dev: *mut c2port_device, addr: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c2port_write_dr(dev: *mut c2port_device, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c2port_read_dr(dev: *mut c2port_device, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c2port_poll_in_busy(dev: *mut c2port_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn c2port_poll_out_ready(dev: *mut c2port_device) -> c_int {
...
//
    ...
    static DEVICE_ATTR(name, 0444, c2port_show_name, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(flash_blocks_num, 0444, c2port_show_flash_blocks_num, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(flash_block_size, 0444, c2port_show_flash_block_size, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(flash_size, 0444, c2port_show_flash_size, core::ptr::null_mut());
...
// Check the device access status
    ...
    static DEVICE_ATTR(reset, 0200, core::ptr::null_mut(), c2port_store_reset);
#[no_mangle]
unsafe extern "C" fn __c2port_show_dev_id(dev: *mut c2port_device, buf: *mut c_char) -> isize {
...
// Check the device access status
    ...
    static DEVICE_ATTR(dev_id, 0444, c2port_show_dev_id, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn __c2port_show_rev_id(dev: *mut c2port_device, buf: *mut c_char) -> isize {
...
// Check the device access status
    ...
    static DEVICE_ATTR(rev_id, 0444, c2port_show_rev_id, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __c2port_write_flash_erase(dev: *mut c2port_device) -> isize {
...
// Check the device and flash access status
    ...
    static DEVICE_ATTR(flash_erase, 0200, core::ptr::null_mut(), c2port_store_flash_erase);
...
//
    ...
    c2dev.id = ret;
    c2dev.ops = ops;
    c2dev.dev = device_create(c2port_class, core::ptr::null_mut(), 0, c2dev,
    "c2port%d", c2dev.id);
    if (IS_ERR(c2dev.dev)) {
...
#[no_mangle]
pub unsafe extern "C" fn c2port_device_unregister(c2dev: *mut c2port_device) {
...
//
#[no_mangle]
unsafe extern "C" fn c2port_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn c2port_exit() -> void __exit {
