...
//! Source: drivers/misc/pch_phub.c
#![no_std]
...
pub const PHUB_STATUS: c_uint = 0x00		/* Status Register offset */;
pub const PHUB_CONTROL: c_uint = 0x04		/* Control Register offset */;
pub const PHUB_TIMEOUT: c_uint = 0x05		/* Time out value for Status Register */;
pub const PCH_PHUB_ROM_WRITE_ENABLE: c_uint = 0x01	/* Enabling for writing ROM */;
pub const PCH_PHUB_ROM_WRITE_DISABLE: c_uint = 0x00	/* Disabling for writing ROM */;
pub const PCH_PHUB_MAC_START_ADDR_EG20T: c_uint = 0x14  /* MAC data area start address;
    offset */
pub const PCH_PHUB_MAC_START_ADDR_ML7223: c_uint = 0x20C  /* MAC data area start address;
    offset */
pub const PCH_PHUB_ROM_START_ADDR_EG20T: c_uint = 0x80 /* ROM data area start address offset;
    (Intel EG20T PCH)*/
pub const PCH_PHUB_ROM_START_ADDR_ML7213: c_uint = 0x400 /* ROM data area start address;
    offset(LAPIS Semicon ML7213)
//
pub const PCH_PHUB_ROM_START_ADDR_ML7223: c_uint = 0x400 /* ROM data area start address;
    offset(LAPIS Semicon ML7223)
//
// MAX number of INT_REDUCE_CONTROL registers
pub const MAX_NUM_INT_REDUCE_CONTROL_REG: c_int = 128;
pub const PCI_DEVICE_ID_PCH1_PHUB: c_uint = 0x8801;
pub const PCH_MINOR_NOS: c_int = 1;
pub const CLKCFG_CAN_50MHZ: c_uint = 0x12000000;
pub const CLKCFG_CANCLK_MASK: c_uint = 0xFF000000;
pub const CLKCFG_UART_MASK: c_uint = 0xFFFFFF;
// CM-iTC

// Macros for ML7213
pub const PCI_DEVICE_ID_ROHM_ML7213_PHUB: c_uint = 0x801A;
// Macros for ML7223
pub const PCI_DEVICE_ID_ROHM_ML7223_mPHUB: c_uint = 0x8012 /* for Bus-m */;
pub const PCI_DEVICE_ID_ROHM_ML7223_nPHUB: c_uint = 0x8002 /* for Bus-n */;
// Macros for ML7831
pub const PCI_DEVICE_ID_ROHM_ML7831_PHUB: c_uint = 0x8801;
// SROM ACCESS Macro

// Registers address offset
pub const PCH_PHUB_ID_REG: c_uint = 0x0000;
pub const PCH_PHUB_QUEUE_PRI_VAL_REG: c_uint = 0x0004;
pub const PCH_PHUB_RC_QUEUE_MAXSIZE_REG: c_uint = 0x0008;
pub const PCH_PHUB_BRI_QUEUE_MAXSIZE_REG: c_uint = 0x000C;
pub const PCH_PHUB_COMP_RESP_TIMEOUT_REG: c_uint = 0x0010;
pub const PCH_PHUB_BUS_SLAVE_CONTROL_REG: c_uint = 0x0014;
pub const PCH_PHUB_DEADLOCK_AVOID_TYPE_REG: c_uint = 0x0018;
pub const PCH_PHUB_INTPIN_REG_WPERMIT_REG0: c_uint = 0x0020;
pub const PCH_PHUB_INTPIN_REG_WPERMIT_REG1: c_uint = 0x0024;
pub const PCH_PHUB_INTPIN_REG_WPERMIT_REG2: c_uint = 0x0028;
pub const PCH_PHUB_INTPIN_REG_WPERMIT_REG3: c_uint = 0x002C;
pub const PCH_PHUB_INT_REDUCE_CONTROL_REG_BASE: c_uint = 0x0040;
pub const CLKCFG_REG_OFFSET: c_uint = 0x500;
pub const FUNCSEL_REG_OFFSET: c_uint = 0x508;
pub const PCH_PHUB_OROM_SIZE: c_int = 15360;
    enum pch_phub_type {
    PCH_EG20T,
    PCH_ML7213,
    PCH_ML7223M,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pch_phub_reg {
    pub pch_phub_base_address: *mut void __iomem,
    pub pch_phub_extrom_base_address: *mut void __iomem,
    pub pch_mac_start_address: u32,
    pub pch_opt_rom_start_address: u32,
    pub ioh_type: enum pch_phub_type,
...
//
#[no_mangle]
unsafe extern "C" fn pch_phub_gbe_serial_rom_conf(chip: *mut pch_phub_reg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_phub_gbe_serial_rom_conf_mp(chip: *mut pch_phub_reg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pch_phub_read_gbe_mac_addr(chip: *mut pch_phub_reg, data: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn pch_phub_write_gbe_mac_addr(chip: *mut pch_phub_reg, data: *mut u8) -> c_int {
...
// Get Rom signature
    ...
    if (chip.pch_phub_base_address == core::ptr::null_mut()) {
    ...
    let mut prefetch: c_uint = 0x000affaa;
    if (pdev.dev.of_node)
...
#[no_mangle]
unsafe extern "C" fn pch_phub_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pch_phub_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn pch_phub_resume(dev_d: *mut device) -> int __maybe_unused {
