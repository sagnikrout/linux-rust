...
//! Source: drivers/misc/gehc-achc.c
#![no_std]
...
pub const ACHC_MAX_FREQ_HZ: c_int = 300000;
pub const ACHC_FAST_READ_FREQ_HZ: c_int = 1000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct achc_data {
    pub main: *mut spi_device,
    pub ezport: *mut spi_device,
    pub reset: *mut gpio_desc,
    pub /: *mut *mut mutex device_lock; / avoid concurrent device access,
}

pub const EZPORT_RESET_DELAY_MS: c_int = 100;
pub const EZPORT_STARTUP_DELAY_MS: c_int = 200;
pub const EZPORT_WRITE_WAIT_MS: c_int = 10;
pub const EZPORT_TRANSFER_SIZE: c_int = 2048;
pub const EZPORT_CMD_SP: c_uint = 0x02 /* flash section program */;
pub const EZPORT_CMD_RDSR: c_uint = 0x05 /* read status register */;
pub const EZPORT_CMD_WREN: c_uint = 0x06 /* write enable */;
pub const EZPORT_CMD_FAST_READ: c_uint = 0x0b /* flash read data at high speed */;
pub const EZPORT_CMD_RESET: c_uint = 0xb9 /* reset chip */;
pub const EZPORT_CMD_BE: c_uint = 0xc7 /* bulk erase */;
pub const EZPORT_CMD_SE: c_uint = 0xd8 /* sector erase */;
pub const EZPORT_SECTOR_SIZE: c_int = 4096;

#[no_mangle]
unsafe extern "C" fn ezport_reset(reset: *mut gpio_desc) {
...
#[no_mangle]
unsafe extern "C" fn ezport_start_programming(spi: *mut spi_device, reset: *mut gpio_desc) -> c_int {
    ...
    let mut release_cs: spi_transfer = { };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ezport_stop_programming(spi: *mut spi_device, reset: *mut gpio_desc) {
...
#[no_mangle]
unsafe extern "C" fn ezport_get_status_register(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ezport_soft_reset(spi: *mut spi_device) -> c_int {
    static int ezport_soft_reset(struct spi_device *spi)
    {
    let mut cmd: u8 = EZPORT_CMD_RESET;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn ezport_send_simple(spi: *mut spi_device, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ezport_wait_write(spi: *mut spi_device, retries: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ezport_write_enable(spi: *mut spi_device) -> c_int {
    static int ezport_write_enable(struct spi_device *spi)
    {
    let mut ret: c_int = 0, retries = 3;
...
#[no_mangle]
unsafe extern "C" fn ezport_bulk_erase(spi: *mut spi_device) -> c_int {
    static int ezport_bulk_erase(struct spi_device *spi)
    {
    int ret;
    let mut cmd: static u8 = EZPORT_CMD_BE;
...
#[no_mangle]
unsafe extern "C" fn ezport_section_erase(spi: *mut spi_device, address: u32) -> c_int {
...
// FAST_READ receives one dummy byte before the real data
    ...
    return ret;
#[no_mangle]
pub unsafe extern "C" fn if(EZPORT_STATUS_WIP: ret &) -> else {
    else if (ret & EZPORT_STATUS_WIP)
    return -ETIMEDOUT;
#[no_mangle]
pub unsafe extern "C" fn if(EZPORT_STATUS_WEF: ret &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ezport_firmware_load(spi: *mut spi_device, fwname: *const c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ezport_flash(spi: *mut spi_device, reset: *mut gpio_desc, fwname: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn unregister_ezport(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gehc_achc_probe(spi: *mut spi_device) -> c_int {
