...
//! Source: drivers/misc/isl29020.c
#![no_std]
...
// Pick the smallest sensor range that will meet our requirements
    ...
    val = 1;
#[no_mangle]
pub unsafe extern "C" fn if(4000: val <=) -> else {
    else if (val <= 4000)
    val = 2;
#[no_mangle]
pub unsafe extern "C" fn if(16000: val <=) -> else {
    else if (val <= 16000)
    val = 3;
    else
    val = 4;
...
#[no_mangle]
unsafe extern "C" fn als_set_power_state(client: *mut i2c_client, enable: c_int) {
    ...
    static DEVICE_ATTR(lux0_input, S_IRUGO, als_lux_input_data_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn isl29020_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl29020_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn isl29020_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isl29020_runtime_resume(dev: *mut device) -> c_int {
