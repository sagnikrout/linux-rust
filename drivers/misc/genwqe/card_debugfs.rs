...
//! Source: drivers/misc/genwqe/card_debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn curr_dbg_uidn_show(s: *mut seq_file, unused: *mut c_void, uid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn curr_dbg_uid0_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn curr_dbg_uid1_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn curr_dbg_uid2_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prev_dbg_uidn_show(s: *mut seq_file, unused: *mut c_void, uid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prev_dbg_uid0_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prev_dbg_uid1_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prev_dbg_uid2_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn curr_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prev_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jtimer_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_working_time_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ddcb_info_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn info_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn genwqe_init_debugfs(cd: *mut genwqe_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn genqwe_exit_debugfs(cd: *mut genwqe_dev) {
