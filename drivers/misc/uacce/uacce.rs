...
//! Source: drivers/misc/uacce/uacce.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn uacce_queue_is_valid(q: *mut uacce_queue) -> bool {
    static bool uacce_queue_is_valid(struct uacce_queue *q)
    {
    return q.state == UACCE_Q_INIT || q.state == UACCE_Q_STARTED;
    }
#[no_mangle]
unsafe extern "C" fn uacce_start_queue(q: *mut uacce_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uacce_stop_queue(q: *mut uacce_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uacce_put_queue(q: *mut uacce_queue) {
...
#[no_mangle]
unsafe extern "C" fn uacce_bind_queue(uacce: *mut uacce_device, q: *mut uacce_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uacce_unbind_queue(q: *mut uacce_queue) {
    static void uacce_unbind_queue(struct uacce_queue *q)
    {
    if (!q.handle)
    return;
    iommu_sva_unbind_device(q.handle);
    q.handle = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn uacce_fops_open(inode: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uacce_fops_release(inode: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uacce_vma_close(vma: *mut vm_area_struct) {
    ...
    mutex_lock(&q.mutex);
    q.qfrs[vma.vm_pgoff] = core::ptr::null_mut();
    mutex_unlock(&q.mutex);
    kfree(qfr);
    }
    }
#[no_mangle]
unsafe extern "C" fn uacce_vma_mremap(area: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uacce_fops_mmap(filep: *mut file, vma: *mut vm_area_struct) -> c_int {
    static int uacce_fops_mmap(struct file *filep, struct vm_area_struct *vma)
    {
    struct uacce_queue *q = filep.private_data;
    struct uacce_device *uacce = q.uacce;
    struct uacce_qfile_region *qfr;
    let mut type: enum uacce_qfrt = UACCE_MAX_REGION;
    let mut ret: c_int = 0;
    if (vma.vm_pgoff < UACCE_MAX_REGION)
    type = vma.vm_pgoff;
    else
...
#[no_mangle]
unsafe extern "C" fn uacce_fops_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn isolate_strategy_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn uacce_release(dev: *mut device) {
...
//
    ...
    {
    let mut flags: c_uint = interface.flags;
    struct uacce_device *uacce;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn uacce_register(uacce: *mut uacce_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uacce_remove(uacce: *mut uacce_device) {
...
//
    uacce.ops = core::ptr::null_mut();
    uacce.parent = core::ptr::null_mut();
    mutex_unlock(&uacce.mutex);
    put_device(&uacce.dev);
    }
    EXPORT_SYMBOL_GPL(uacce_remove);
#[no_mangle]
unsafe extern "C" fn uacce_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn uacce_exit() -> __exit void {
