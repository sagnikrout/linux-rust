...
//! Source: drivers/misc/vmw_balloon.c
#![no_std]
...
pub const VMW_BALLOON_MAX_REFUSED: c_int = 16;
// Magic number for the balloon mount-point
pub const BALLOON_VMW_MAGIC: c_uint = 0x0ba11007;
//
// Hypervisor communication port definitions.
//
pub const VMW_BALLOON_HV_PORT: c_uint = 0x5670;
pub const VMW_BALLOON_HV_MAGIC: c_uint = 0x456c6d6f;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmballoon_ctl {
    pub pages: list_head,
    pub refused_pages: list_head,
    pub prealloc_pages: list_head,
    pub n_refused_pages: c_uint,
    pub n_pages: c_uint,
    pub page_size: enum vmballoon_page_size_type,
    pub op: enum vmballoon_op,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmballoon_batch_entry {
    pub 5: u64 status :,
    pub 5: u64 reserved : PAGE_SHIFT -,
    pub 52: u64 pfn :,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
...
//
    pub max_page_size: enum vmballoon_page_size_type,
//
...
//
    pub size: core::sync::atomic::AtomicI64,
//
...
//
    pub batch_page: *mut vmballoon_batch_entry,
//
...
//
    pub shrink_timeout: c_ulong,
// statistics
    pub stats: *mut vmballoon_stats,
//
// @b_dev_info: balloon device information descriptor.
//
    pub b_dev_info: balloon_dev_info,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmballoon_stats {
// timer / doorbell operations
    pub general_stat: [core::sync::atomic::AtomicI64; VMW_BALLOON_STAT_NUM],
// allocation statistics for huge and small pages
    atomic64_t
// Monitor operations: total operations, and failures
    pub ops: [core::sync::atomic::AtomicI64; VMW_BALLOON_CMD_NUM][VMW_BALLOON_OP_STAT_TYPES],
}

#[no_mangle]
pub unsafe extern "C" fn is_vmballoon_stats_on() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_send_start(b: *mut vmballoon, req_caps: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_send_guest_id(b: *mut vmballoon) -> c_int {
    ...
    let mut status: return = = VMW_BALLOON_SUCCESS ? 0 : -EIO;
    }
//
...
//
    static inline
#[no_mangle]
pub unsafe extern "C" fn vmballoon_page_order(page_size: enum vmballoon_page_size_type) -> c_uint {
    unsigned int vmballoon_page_order(enum vmballoon_page_size_type page_size)
    {
    let mut page_size: return = = VMW_BALLOON_2M_PAGE ? VMW_BALLOON_2M_ORDER : 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_send_get_target(b: *mut vmballoon) -> c_int {
...
// Allocation failed. Update statistics and stop.
    ...
    ctl.n_pages = i;
    let mut req_n_pages: return = = ctl.n_pages ? 0 : -ENOMEM;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_lock(b: *mut vmballoon, ctl: *mut vmballoon_ctl) -> c_int {
...
//
    ...
    let mut batch_status: return = = VMW_BALLOON_SUCCESS ? 0 : -EIO;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_change(b: *mut vmballoon) -> i64 {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_split_refused_pages(ctl: *mut vmballoon_ctl) {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_inflate(b: *mut vmballoon) {
...
//
    ...
    vmballoon_release_page_list(&ctl.prealloc_pages, core::ptr::null_mut(), ctl.page_size);
    }
//
...
//
    ...
    bool coordinated)
    {
    let mut deflated_frames: c_ulong = 0;
    let mut tried_frames: c_ulong = 0;
    struct vmballoon_ctl ctl = {
    .pages = LIST_HEAD_INIT(ctl.pages),
    .refused_pages = LIST_HEAD_INIT(ctl.refused_pages),
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_deinit_batching(b: *mut vmballoon) {
    static void vmballoon_deinit_batching(struct vmballoon *b)
    {
    free_page((unsigned long)b.batch_page);
    b.batch_page = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_init_batching(b: *mut vmballoon) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_doorbell(client_data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_vmci_cleanup(b: *mut vmballoon) {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_vmci_init(b: *mut vmballoon) -> c_int {
    ...
    b.vmci_doorbell.resource, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_pop(b: *mut vmballoon) {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_reset(b: *mut vmballoon) {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn vmballoon_unregister_shrinker(b: *mut vmballoon) {
    static void vmballoon_unregister_shrinker(struct vmballoon *b)
    {
    shrinker_free(b.shrinker);
    b.shrinker = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn vmballoon_register_shrinker(b: *mut vmballoon) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmballoon_enable_stats(b: *mut vmballoon) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmballoon_debug_show(f: *mut seq_file, offset: *mut c_void) -> c_int {
...
// enables stats if they are disabled
    if (!b.stats) {
    let mut r: c_int = vmballoon_enable_stats(b);
    if (r)
    return r;
    }
...
// format size info
    ...
    if (vmballoon_cmd_names[i] == core::ptr::null_mut())
    continue;
...
#[no_mangle]
unsafe extern "C" fn vmballoon_debugfs_init(b: *mut vmballoon) -> void __init {
    static void __init vmballoon_debugfs_init(struct vmballoon *b)
    {
    debugfs_create_file("vmmemctl", S_IRUGO, core::ptr::null_mut(), b,
    &vmballoon_debug_fops);
    }
#[no_mangle]
unsafe extern "C" fn vmballoon_debugfs_exit(b: *mut vmballoon) -> void __exit {
    static void __exit vmballoon_debugfs_exit(struct vmballoon *b)
    {
    static_key_disable(&balloon_stat_enabled.key);
    debugfs_lookup_and_remove("vmmemctl", core::ptr::null_mut());
    kfree(b.stats);
    b.stats = core::ptr::null_mut();
    }

#[no_mangle]
pub unsafe extern "C" fn vmballoon_debugfs_init(b: *mut vmballoon) {
    static inline void vmballoon_debugfs_init(struct vmballoon *b)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn vmballoon_debugfs_exit(b: *mut vmballoon) {
...
#[no_mangle]
unsafe extern "C" fn vmballoon_init() -> int __init {
...
//
    ...
    balloon.batch_page = core::ptr::null_mut();
    balloon.page = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn vmballoon_exit() -> void __exit {
