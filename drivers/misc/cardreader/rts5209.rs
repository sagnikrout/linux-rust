...
//! Source: drivers/misc/cardreader/rts5209.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rts5209_get_ic_version(pcr: *mut rtsx_pcr) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rts5209_fetch_vendor_settings(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts5209_force_power_down(pcr: *mut rtsx_pcr, pm_state: u8, runtime: bool) {
    static void rts5209_force_power_down(struct rtsx_pcr *pcr, u8 pm_state, bool runtime)
    {
    rtsx_pci_write_register(pcr, FPDCTL, 0x07, 0x07);
    }
#[no_mangle]
unsafe extern "C" fn rts5209_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5209_card_power_off(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5209_switch_output_voltage(pcr: *mut rtsx_pcr, voltage: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rts5209_init_params(pcr: *mut rtsx_pcr) {
