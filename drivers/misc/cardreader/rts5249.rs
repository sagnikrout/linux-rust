...
//! Source: drivers/misc/cardreader/rts5249.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rts5249_get_ic_version(pcr: *mut rtsx_pcr) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rts5249_fill_driving(pcr: *mut rtsx_pcr, voltage: u8) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_base_fetch_vendor_settings(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts5249_init_from_cfg(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts52xa_force_power_down(pcr: *mut rtsx_pcr, pm_state: u8, runtime: bool) {
...
#[no_mangle]
unsafe extern "C" fn rts52xa_save_content_from_efuse(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts52xa_save_content_to_autoload_space(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts5249_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5249_optimize_phy(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_base_turn_on_led(pcr: *mut rtsx_pcr) -> c_int {
    static int rtsx_base_turn_on_led(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, GPIO_CTL, 0x02, 0x02);
    }
#[no_mangle]
unsafe extern "C" fn rtsx_base_turn_off_led(pcr: *mut rtsx_pcr) -> c_int {
    static int rtsx_base_turn_off_led(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, GPIO_CTL, 0x02, 0x00);
    }
#[no_mangle]
unsafe extern "C" fn rtsx_base_enable_auto_blink(pcr: *mut rtsx_pcr) -> c_int {
    static int rtsx_base_enable_auto_blink(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, OLT_LED_CTL, 0x08, 0x08);
    }
#[no_mangle]
unsafe extern "C" fn rtsx_base_disable_auto_blink(pcr: *mut rtsx_pcr) -> c_int {
    static int rtsx_base_disable_auto_blink(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, OLT_LED_CTL, 0x08, 0x00);
    }
#[no_mangle]
unsafe extern "C" fn rtsx_base_card_power_on(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_base_card_power_off(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_base_switch_output_voltage(pcr: *mut rtsx_pcr, voltage: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rts5249_init_params(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts524a_write_phy(pcr: *mut rtsx_pcr, addr: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts524a_read_phy(pcr: *mut rtsx_pcr, addr: u8, val: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts524a_optimize_phy(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts524a_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5250_set_l1off_cfg_sub_d0(pcr: *mut rtsx_pcr, active: c_int) {
    static void rts5250_set_l1off_cfg_sub_d0(struct rtsx_pcr *pcr, int active)
    {
    struct rtsx_cr_option *option = &(pcr.option);
    let mut interrupt: u32 = rtsx_pci_readl(pcr, RTSX_BIPR);
    let mut card_exist: c_int = (interrupt & SD_EXIST) | (interrupt & MS_EXIST);
...
#[no_mangle]
pub unsafe extern "C" fn rts524a_init_params(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts525a_card_power_on(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts525a_switch_output_voltage(pcr: *mut rtsx_pcr, voltage: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts525a_optimize_phy(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts525a_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rts525a_init_params(pcr: *mut rtsx_pcr) {
