...
//! Source: drivers/misc/cardreader/rtl8411.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtl8411_get_ic_version(pcr: *mut rtsx_pcr) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rtl8411b_is_qfn48(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8411_fetch_vendor_settings(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rtl8411b_fetch_vendor_settings(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rtl8411_force_power_down(pcr: *mut rtsx_pcr, pm_state: u8, runtime: bool) {
    static void rtl8411_force_power_down(struct rtsx_pcr *pcr, u8 pm_state, bool runtime)
    {
    rtsx_pci_write_register(pcr, FPDCTL, 0x07, 0x07);
    }
#[no_mangle]
unsafe extern "C" fn rtl8411_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8411b_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8411_card_power_off(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8411_switch_output_voltage(pcr: *mut rtsx_pcr, voltage: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8402_switch_output_voltage(pcr: *mut rtsx_pcr, voltage: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl8411_cd_deglitch(pcr: *mut rtsx_pcr) -> c_uint {
...
// Enable card interrupt
    ...
    card_exist = MS_EXIST;
#[no_mangle]
pub unsafe extern "C" fn if(SD_EXIST: card_exist &) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtl8411_conv_clk_and_div_n(input: c_int, dir: c_int) -> c_int {
    ...
    .optimize_phy = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rtl8411_init_common_params(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8411_init_params(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8411b_init_params(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
pub unsafe extern "C" fn rtl8402_init_params(pcr: *mut rtsx_pcr) {
