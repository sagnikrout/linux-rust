...
//! Source: drivers/misc/cardreader/rts5229.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rts5229_get_ic_version(pcr: *mut rtsx_pcr) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rts5229_fetch_vendor_settings(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts5229_force_power_down(pcr: *mut rtsx_pcr, pm_state: u8, runtime: bool) {
    static void rts5229_force_power_down(struct rtsx_pcr *pcr, u8 pm_state, bool runtime)
    {
    rtsx_pci_write_register(pcr, FPDCTL, 0x03, 0x03);
    }
#[no_mangle]
unsafe extern "C" fn rts5229_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5229_optimize_phy(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5229_turn_on_led(pcr: *mut rtsx_pcr) -> c_int {
    static int rts5229_turn_on_led(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, GPIO_CTL, 0x02, 0x02);
    }
#[no_mangle]
unsafe extern "C" fn rts5229_turn_off_led(pcr: *mut rtsx_pcr) -> c_int {
    static int rts5229_turn_off_led(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, GPIO_CTL, 0x02, 0x00);
    }
#[no_mangle]
unsafe extern "C" fn rts5229_enable_auto_blink(pcr: *mut rtsx_pcr) -> c_int {
    static int rts5229_enable_auto_blink(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, OLT_LED_CTL, 0x08, 0x08);
    }
#[no_mangle]
unsafe extern "C" fn rts5229_disable_auto_blink(pcr: *mut rtsx_pcr) -> c_int {
    static int rts5229_disable_auto_blink(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, OLT_LED_CTL, 0x08, 0x00);
    }
#[no_mangle]
unsafe extern "C" fn rts5229_card_power_on(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5229_card_power_off(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5229_switch_output_voltage(pcr: *mut rtsx_pcr, voltage: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rts5229_init_params(pcr: *mut rtsx_pcr) {
