...
//! Source: drivers/misc/cardreader/rtsx_usb.c
#![no_std]
...
//
    ...
    let mut polling_pipe: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_sg_timed_out(t: *mut timer_list) {
...
// act_len = ucr->current_sg.bytes;
    ...
    {
    let mut cmd_len: u16 = ALIGN(SEQ_WRITE_DATA_OFFSET + len, 4);
    if (!data)
    return -EINVAL;
    ...
    ucr.cmd_buf, cmd_len, 0, core::ptr::null_mut(), 100);
    }
    static int rtsx_usb_seq_read_register(struct rtsx_ucr *ucr,
    u16 addr, u16 len, u8 *data)
    {
    int i, ret;
    let mut rsp_len: u16 = round_down(len, 4);
    let mut res_len: u16 = len - rsp_len;
    if (!data)
    return -EINVAL;
// 4-byte aligned part
    if (rsp_len) {
    ...
    usb_sndbulkpipe(ucr.pusb_dev, EP_BULK_OUT),
    ucr.cmd_buf, 12, 0, core::ptr::null_mut(), 100);
    if (ret)
    return ret;
    ret = rtsx_usb_transfer_data(ucr,
    usb_rcvbulkpipe(ucr.pusb_dev, EP_BULK_IN),
    data, rsp_len, 0, core::ptr::null_mut(), 100);
    if (ret)
    return ret;
    }
// unaligned part
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_read_ppbuf(ucr: *mut rtsx_ucr, buf: *mut u8, buf_len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_write_ppbuf(ucr: *mut rtsx_ucr, buf: *mut u8, buf_len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_ep0_read_register(ucr: *mut rtsx_ucr, addr: u16, data: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_send_cmd(ucr: *mut rtsx_ucr, flag: u8, timeout: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_get_rsp(ucr: *mut rtsx_ucr, rsp_len: c_int, timeout: c_int) -> c_int {
    ...
    return rtsx_usb_transfer_data(ucr,
    usb_rcvbulkpipe(ucr.pusb_dev, EP_BULK_IN),
    ucr.rsp_buf, rsp_len, 0, core::ptr::null_mut(), timeout);
    }
    EXPORT_SYMBOL_GPL(rtsx_usb_get_rsp);
#[no_mangle]
unsafe extern "C" fn rtsx_usb_get_status_with_bulk(ucr: *mut rtsx_ucr, status: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_get_card_status(ucr: *mut rtsx_ucr, status: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_write_phy_register(ucr: *mut rtsx_ucr, addr: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_write_register(ucr: *mut rtsx_ucr, addr: u16, mask: u8, data: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_read_register(ucr: *mut rtsx_ucr, addr: u16, data: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn double_ssc_depth(depth: u8) -> u8 {
    static inline u8 double_ssc_depth(u8 depth)
    {
    return (depth > 1) ? (depth - 1) : depth;
    }
#[no_mangle]
unsafe extern "C" fn revise_ssc_depth(ssc_depth: u8, div: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn rtsx_usb_card_exclusive_check(ucr: *mut rtsx_ucr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_reset_chip(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_init_chip(ucr: *mut rtsx_ucr) -> c_int {
...
// initialize USB SG transfer timer
    ...
    return 0;
    out_init_fail:
    usb_set_intfdata(ucr.pusb_intf, core::ptr::null_mut());
    kfree(ucr.rsp_buf);
    ucr.rsp_buf = core::ptr::null_mut();
    out_free_cmd_buf:
    kfree(ucr.cmd_buf);
    ucr.cmd_buf = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn rtsx_usb_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_resume_child(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
//
    if (valid && (val & MS_CD)) {
    device_for_each_child(&intf.dev, core::ptr::null_mut(), rtsx_usb_resume_child);
    return -EAGAIN;
    }
    } else {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_reset_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_pre_reset(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_post_reset(intf: *mut usb_interface) -> c_int {
