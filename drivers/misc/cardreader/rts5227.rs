...
//! Source: drivers/misc/cardreader/rts5227.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rts5227_get_ic_version(pcr: *mut rtsx_pcr) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rts5227_fill_driving(pcr: *mut rtsx_pcr, voltage: u8) {
...
#[no_mangle]
unsafe extern "C" fn rts5227_fetch_vendor_settings(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts5227_init_from_cfg(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts5227_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5227_optimize_phy(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5227_turn_on_led(pcr: *mut rtsx_pcr) -> c_int {
    static int rts5227_turn_on_led(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, GPIO_CTL, 0x02, 0x02);
    }
#[no_mangle]
unsafe extern "C" fn rts5227_turn_off_led(pcr: *mut rtsx_pcr) -> c_int {
    static int rts5227_turn_off_led(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, GPIO_CTL, 0x02, 0x00);
    }
#[no_mangle]
unsafe extern "C" fn rts5227_enable_auto_blink(pcr: *mut rtsx_pcr) -> c_int {
    static int rts5227_enable_auto_blink(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, OLT_LED_CTL, 0x08, 0x08);
    }
#[no_mangle]
unsafe extern "C" fn rts5227_disable_auto_blink(pcr: *mut rtsx_pcr) -> c_int {
    static int rts5227_disable_auto_blink(struct rtsx_pcr *pcr)
    {
    return rtsx_pci_write_register(pcr, OLT_LED_CTL, 0x08, 0x00);
    }
#[no_mangle]
unsafe extern "C" fn rts5227_card_power_on(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5227_card_power_off(pcr: *mut rtsx_pcr, card: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts5227_switch_output_voltage(pcr: *mut rtsx_pcr, voltage: u8) -> c_int {
...
// set pad drive
    ...
    .cd_deglitch = core::ptr::null_mut(),
    .conv_clk_and_div_n = core::ptr::null_mut(),
    };
...
#[no_mangle]
pub unsafe extern "C" fn rts5227_init_params(pcr: *mut rtsx_pcr) {
...
#[no_mangle]
unsafe extern "C" fn rts522a_optimize_phy(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts522a_extra_init_hw(pcr: *mut rtsx_pcr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts522a_switch_output_voltage(pcr: *mut rtsx_pcr, voltage: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rts522a_force_power_down(pcr: *mut rtsx_pcr, pm_state: u8, runtime: bool) {
...
#[no_mangle]
unsafe extern "C" fn rts522a_set_l1off_cfg_sub_d0(pcr: *mut rtsx_pcr, active: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn rts522a_init_params(pcr: *mut rtsx_pcr) {
