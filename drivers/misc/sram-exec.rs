...
//! Source: drivers/misc/sram-exec.c
#![no_std]
...
//
    ...
    {
    let mut base: c_ulong = (unsigned long)part.base;
    let mut end: c_ulong = base + block.size;
...
#[no_mangle]
pub unsafe extern "C" fn sram_add_protect_exec(part: *mut sram_partition) -> c_int {
...
//
    ...
    size_t size)
    {
    struct sram_partition *part = core::ptr::null_mut(), *p;
    unsigned long base;
    int pages;
    void *dst_cpy;
    int ret;
