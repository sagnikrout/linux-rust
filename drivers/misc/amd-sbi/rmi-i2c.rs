...
//! Source: drivers/misc/amd-sbi/rmi-i2c.c
#![no_std]
...
pub const REV_TWO_BYTE_ADDR: c_uint = 0x21;
#[no_mangle]
unsafe extern "C" fn sbrmi_enable_alert(data: *mut sbrmi_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbrmi_get_max_pwr_limit(data: *mut sbrmi_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbrmi_common_probe(dev: *mut device, regmap: *mut regmap, address: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbrmi_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbrmi_i2c_remove(client: *mut i2c_client) {
...
// Assign fops and parent of misc dev to NULL
    data.sbrmi_misc_dev.fops = core::ptr::null_mut();
    data.sbrmi_misc_dev.parent = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sbrmi_i3c_probe(i3cdev: *mut i3c_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbrmi_i3c_remove(i3cdev: *mut i3c_device) {
...
// PID for AMD SBRMI device
    I3C_DEVICE_EXTRA_INFO(0x112, 0x0, 0x2, core::ptr::null_mut()),
