...
//! Source: drivers/misc/amd-sbi/tsi.c
#![no_std]
...
pub const SBTSI_REG_CONFIG: c_uint = 0x03 /* RO */;
//
...
//
pub const SBTSI_CONFIG_EXT_RANGE_SHIFT: c_int = 2;
//
...
//
pub const SBTSI_CONFIG_READ_ORDER_SHIFT: c_int = 5;
#[no_mangle]
unsafe extern "C" fn sbtsi_adev_release(dev: *mut device) {
    static void sbtsi_adev_release(struct device *dev)
    {
    kfree(to_auxiliary_dev(dev));
    }
#[no_mangle]
unsafe extern "C" fn sbtsi_unregister_hwmon_adev(_adev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sbtsi_misc_unregister(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sbtsi_driver_unref(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn sbtsi_create_hwmon_adev(dev: *mut device, dev_addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbtsi_probe_common(dev: *mut device, data: *mut sbtsi_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbtsi_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbtsi_i3c_probe(i3cdev: *mut i3c_device) -> c_int {
...
// PID for AMD SBTSI device
    I3C_DEVICE_EXTRA_INFO(0x112, 0x0, 0x1, core::ptr::null_mut()),	/* Socket:0, Turin and Genoa */
    I3C_DEVICE_EXTRA_INFO(0x0, 0x0, 0x118, core::ptr::null_mut()),	/* Socket:0, Venice */
    I3C_DEVICE_EXTRA_INFO(0x0, 0x100, 0x118, core::ptr::null_mut()),	/* Socket:1, Venice */
    I3C_DEVICE_EXTRA_INFO(0x112, 0x0, 0x119, core::ptr::null_mut()),	/* Socket:0, Venice */
    I3C_DEVICE_EXTRA_INFO(0x112, 0x100, 0x119, core::ptr::null_mut()),	/* Socket:1, Venice */
    {}
    };
