...
pub const PHANTOM_MAX_MINORS: c_int = 8;
pub const PHN_IRQCTL: c_uint = 0x4c    /* irq control in caddr space */;
pub const PHB_RUNNING: c_int = 1;
pub const PHB_NOT_OH: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct phantom_device {
    pub opened: c_uint,
    pub caddr: *mut void __iomem,
    pub iaddr: *mut u32 __iomem,
    pub oaddr: *mut u32 __iomem,
    pub status: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn phantom_status(dev: *mut phantom_device, newstat: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phantom_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phantom_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phantom_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
    ...
    mask = EPOLLERR;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: atomic_read(&dev->counter)) -> else {
...
#[no_mangle]
unsafe extern "C" fn phantom_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn phantom_get_free() -> c_uint {
    ...
    MKDEV(phantom_major, minor), core::ptr::null_mut(),
    "phantom%u", minor)))
...
#[no_mangle]
unsafe extern "C" fn phantom_remove(pdev: *mut pci_dev) {
    static void phantom_remove(struct pci_dev *pdev)
    {
    struct phantom_device *pht = pci_get_drvdata(pdev);
    let mut minor: c_uint = MINOR(pht.cdev.dev);
...
#[no_mangle]
unsafe extern "C" fn phantom_suspend(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn phantom_resume(dev_d: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn phantom_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn phantom_exit() -> void __exit {
