...
//! Source: drivers/misc/ad525x_dpot-spi.c
#![no_std]
...
// SPI bus functions
#[no_mangle]
unsafe extern "C" fn write8(client: *mut c_void, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write16(client: *mut c_void, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write24(client: *mut c_void, reg: u8, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read8(client: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read16(client: *mut c_void, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read24(client: *mut c_void, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad_dpot_spi_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ad_dpot_spi_remove(spi: *mut spi_device) {
