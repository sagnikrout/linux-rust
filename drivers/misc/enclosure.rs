...
//! Source: drivers/misc/enclosure.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn enclosure_unregister(edev: *mut enclosure_device) {
...
pub const ENCLOSURE_NAME_SIZE: c_int = 64;
pub const COMPONENT_NAME_SIZE: c_int = 64;
#[no_mangle]
unsafe extern "C" fn enclosure_link_name(cdev: *mut enclosure_component, name: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn enclosure_remove_links(cdev: *mut enclosure_component) {
...
#[no_mangle]
unsafe extern "C" fn enclosure_add_links(cdev: *mut enclosure_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enclosure_release(cdev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn enclosure_component_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn enclosure_component_register(ecomp: *mut enclosure_component) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn enclosure_remove_device(edev: *mut enclosure_device, dev: *mut device) -> c_int {
...
//
    ...
    [ENCLOSURE_STATUS_MAX] = core::ptr::null_mut(),
    };
    ...
    struct enclosure_device *edev = to_enclosure_device(cdev.parent);
    struct enclosure_component *ecomp = to_enclosure_component(cdev);
    let mut val: c_int = simple_strtoul(buf, core::ptr::null_mut(), 0);
...
// if the enclosure does not override then use 'number' as a stand-in
    ...
    static DEVICE_ATTR(type, S_IRUGO, get_component_type, core::ptr::null_mut());
    static DEVICE_ATTR(slot, S_IRUGO, get_component_slot, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn enclosure_init() -> int __init {
    static int __init enclosure_init(void)
    {
    return class_register(&enclosure_class);
    }
#[no_mangle]
unsafe extern "C" fn enclosure_exit() -> void __exit {
