...
//! Source: drivers/misc/vcpu_stall_detector.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vcpu_stall_detect_config {
    pub clock_freq_hz: u32,
    pub stall_timeout_sec: u32,
    pub ppi_irq: c_int,
    pub membase: *mut void __iomem,
    pub dev: *mut platform_device,
    pub hp_online: enum cpuhp_state,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vcpu_stall_priv {
    pub vcpu_hrtimer: hrtimer,
...
#[no_mangle]
unsafe extern "C" fn vcpu_stall_detector_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn start_stall_detector_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stop_stall_detector_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcpu_stall_detect_probe(pdev: *mut platform_device) -> c_int {
    static int vcpu_stall_detect_probe(struct platform_device *pdev)
    {
    int ret, irq;
    struct resource *r;
    void __iomem *membase;
    let mut clock_freq_hz: u32 = VCPU_STALL_DEFAULT_CLOCK_HZ;
    let mut stall_timeout_sec: u32 = VCPU_STALL_DEFAULT_TIMEOUT_SEC;
...
#[no_mangle]
unsafe extern "C" fn vcpu_stall_detect_remove(pdev: *mut platform_device) {
