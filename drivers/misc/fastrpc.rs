...
pub const FASTRPC_MAX_SESSIONS: c_int = 14;
pub const FASTRPC_MAX_VMIDS: c_int = 16;
pub const FASTRPC_ALIGN: c_int = 128;
pub const FASTRPC_MAX_FDLIST: c_int = 16;
pub const FASTRPC_MAX_CRCLIST: c_int = 64;

pub const FASTRPC_INIT_HANDLE: c_int = 1;
pub const FASTRPC_DSP_UTILITIES_HANDLE: c_int = 2;
//
...
pub const FASTRPC_CTXID_SEQ_SHIFT: c_int = 16;
...
//
pub const FASTRPC_DSP_PD_NOTIFY_CTX: c_uint = 0xABCDABCD;

// Add memory to static PD pool, protection thru XPU
pub const ADSP_MMAP_HEAP_ADDR: c_int = 4;
// MAP static DMA buffer on DSP User PD
pub const ADSP_MMAP_DMA_BUFFER: c_int = 6;
// Add memory to static PD pool protection thru hypervisor
pub const ADSP_MMAP_REMOTE_HEAP_ADDR: c_int = 8;
// Add memory to userPD pool, for user heap
pub const ADSP_MMAP_ADD_PAGES: c_uint = 0x1000;
// Add memory to userPD pool, for LLC heap
pub const ADSP_MMAP_ADD_PAGES_LLC: c_uint = 0x3000,;
...
pub const FASTRPC_CREATE_PROCESS_NARGS: c_int = 6;
pub const FASTRPC_CREATE_STATIC_PROCESS_NARGS: c_int = 3;
// Remote Method id table
pub const FASTRPC_RMID_INIT_ATTACH: c_int = 0;
pub const FASTRPC_RMID_INIT_RELEASE: c_int = 1;
pub const FASTRPC_RMID_INIT_MMAP: c_int = 4;
pub const FASTRPC_RMID_INIT_MUNMAP: c_int = 5;
pub const FASTRPC_RMID_INIT_CREATE: c_int = 6;
pub const FASTRPC_RMID_INIT_CREATE_ATTR: c_int = 7;
pub const FASTRPC_RMID_INIT_CREATE_STATIC: c_int = 8;
pub const FASTRPC_RMID_INIT_MEM_MAP: c_int = 10;
pub const FASTRPC_RMID_INIT_MEM_UNMAP: c_int = 11;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_phy_page {
    pub /: *mut *mut dma_addr_t addr; / dma address,
    pub /: *mut *mut u64 size; / size of contiguous region,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_invoke_buf {
    pub /: *mut *mut u32 num; / number of contiguous regions,
    pub /: *mut *mut u32 pgidx; / index to start of contiguous region,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_remote_dmahandle {
    pub /: *mut *mut s32 fd; / dma handle fd,
    pub /: *mut *mut u32 offset; / dma handle offset,
    pub /: *mut *mut u32 len; / dma handle length,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_remote_buf {
    pub /: *mut *mut u64 pv; / buffer pointer,
    pub /: *mut *mut u64 len; / length of buffer,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_mmap_rsp_msg {
    pub vaddr: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_mmap_req_msg {
    pub client_id: i32,
    pub flags: u32,
    pub vaddr: u64,
    pub num: i32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_mem_map_req_msg {
    pub client_id: i32,
    pub fd: i32,
    pub offset: i32,
    pub flags: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_munmap_req_msg {
    pub client_id: i32,
    pub vaddr: u64,
    pub size: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_mem_unmap_req_msg {
    pub client_id: i32,
    pub fd: i32,
    pub vaddrin: u64,
    pub len: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_msg {
    pub /: *mut *mut int client_id; / process client id,
    pub /: *mut *mut int tid; / thread id,
    pub /: *mut *mut u64 ctx; / invoke caller context,
    pub /: *mut *mut u32 handle; / handle to invoke,
    pub /: *mut *mut u32 sc; / scalars structure describing the data,
    pub /: *mut *mut dma_addr_t addr; / dma address,
    pub /: *mut *mut u64 size; / size of contiguous region,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_invoke_rsp {
    pub /: *mut *mut u64 ctx; / invoke caller context,
    pub /: *mut *mut int retval; / invoke return value,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_buf_overlap {
    pub start: u64,
    pub end: u64,
    pub raix: c_int,
    pub mstart: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_buf {
    pub fl: *mut fastrpc_user,
...
// mmap support
    pub /: *mut *mut list_head node; / list of user requested mmaps,
    pub raddr: uintptr_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_dma_buf_attachment {
    pub dev: *mut device,
    pub sgt: sg_table,
    pub node: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_map {
    pub node: list_head,
    pub fl: *mut fastrpc_user,
    pub fd: c_int,
    pub buf: *mut dma_buf,
    pub table: *mut sg_table,
...
// process updates poll memory instead of glink response
    pub is_polled: bool,
    pub refcount: kref,
    pub /: *mut *mut list_head node; / list of ctxs,
    pub work: completion,
    pub put_work: work_struct,
    pub msg: fastrpc_msg,
    pub fl: *mut fastrpc_user,
    pub rpra: *mut union fastrpc_remote_arg,
    pub maps: *mut fastrpc_map,
    pub buf: *mut fastrpc_buf,
    pub args: *mut fastrpc_invoke_args,
    pub olaps: *mut fastrpc_buf_overlap,
    pub cctx: *mut fastrpc_channel_ctx,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_session_ctx {
    pub dev: *mut device,
    pub sid: c_int,
    pub used: bool,
    pub valid: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_soc_data {
    pub sid_pos: u32,
    pub dma_addr_bits_cdsp: u32,
    pub dma_addr_bits_default: u32,
    pub poll_mode_supported: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_channel_ctx {
    pub domain_id: c_int,
    pub sesscount: c_int,
    pub vmcount: c_int,
    pub vmperms: [qcom_scm_vmperm; FASTRPC_MAX_VMIDS],
    pub rpdev: *mut rpmsg_device,
    pub session: [fastrpc_session_ctx; FASTRPC_MAX_SESSIONS],
    pub lock: spinlock_t,
    pub ctx_idr: idr,
    pub users: list_head,
    pub refcount: kref,
// Flag if dsp attributes are cached
    pub valid_attributes: bool,
    pub dsp_attributes: [u32; FASTRPC_MAX_DSP_ATTRIBUTES],
    pub secure_fdevice: *mut fastrpc_device,
    pub fdevice: *mut fastrpc_device,
    pub remote_heap: *mut fastrpc_buf,
    pub invoke_interrupted_mmaps: list_head,
    pub secure: bool,
    pub unsigned_support: bool,
    pub poll_mode_supported: bool,
// Per-channel sequence counter; incremented on every context allocation
    pub ctx_seq: core::sync::atomic::AtomicI32,
    pub dma_mask: u64,
    pub soc_data: *const fastrpc_soc_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_device {
    pub cctx: *mut fastrpc_channel_ctx,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fastrpc_user {
    pub user: list_head,
    pub maps: list_head,
    pub pending: list_head,
    pub mmaps: list_head,
    pub cctx: *mut fastrpc_channel_ctx,
    pub sctx: *mut fastrpc_session_ctx,
    pub init_mem: *mut fastrpc_buf,
    pub client_id: c_int,
    pub pd: c_int,
    pub is_secure_dev: bool,
...
#[no_mangle]
pub unsafe extern "C" fn fastrpc_ipa_to_dma_addr(cctx: *mut fastrpc_channel_ctx, iova: dma_addr_t) -> dma_addr_t {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_free_map(ref: *mut kref) {
    ...
    let mut vmid: c_int = map.fl.cctx.vmperms[0].vmid;
    let mut src_perms: u64 = BIT(QCOM_SCM_VMID_HLOS) | BIT(vmid);
    let mut err: c_int = 0;
    ...
    map.fl = core::ptr::null_mut();
    }
    kfree(map);
    }
#[no_mangle]
unsafe extern "C" fn fastrpc_map_put(map: *mut fastrpc_map) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_map_get(map: *mut fastrpc_map) -> c_int {
    ...
    {
    struct fastrpc_map *map = core::ptr::null_mut();
    struct dma_buf *buf;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_buf_free(buf: *mut fastrpc_buf) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_channel_ctx_free(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_channel_ctx_get(cctx: *mut fastrpc_channel_ctx) {
    static void fastrpc_channel_ctx_get(struct fastrpc_channel_ctx *cctx)
    {
    kref_get(&cctx.refcount);
    }
#[no_mangle]
unsafe extern "C" fn fastrpc_channel_ctx_put(cctx: *mut fastrpc_channel_ctx) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_user_free(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_user_get(fl: *mut fastrpc_user) {
    static void fastrpc_user_get(struct fastrpc_user *fl)
    {
    kref_get(&fl.refcount);
    }
#[no_mangle]
unsafe extern "C" fn fastrpc_user_put(fl: *mut fastrpc_user) {
    static void fastrpc_user_put(struct fastrpc_user *fl)
    {
    kref_put(&fl.refcount, fastrpc_user_free);
    }
#[no_mangle]
unsafe extern "C" fn fastrpc_context_free(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_context_get(ctx: *mut fastrpc_invoke_ctx) {
    static void fastrpc_context_get(struct fastrpc_invoke_ctx *ctx)
    {
    kref_get(&ctx.refcount);
    }
#[no_mangle]
unsafe extern "C" fn fastrpc_context_put(ctx: *mut fastrpc_invoke_ctx) {
    static void fastrpc_context_put(struct fastrpc_invoke_ctx *ctx)
    {
    kref_put(&ctx.refcount, fastrpc_context_free);
    }
#[no_mangle]
unsafe extern "C" fn fastrpc_context_put_wq(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn olaps_cmp(a: *const c_void, b: *const c_void) -> c_int {
    static int olaps_cmp(const void *a, const void *b)
    {
    struct fastrpc_buf_overlap *pa = (struct fastrpc_buf_overlap *)a;
    struct fastrpc_buf_overlap *pb = (struct fastrpc_buf_overlap *)b;
// sort with lowest starting buffer first
    let mut st: c_int = CMP(pa.start, pb.start);
// sort with highest ending buffer first
    let mut ed: c_int = CMP(pb.end, pa.end);
    let mut st: return = = 0 ? ed : st;
    }
#[no_mangle]
unsafe extern "C" fn fastrpc_get_buff_overlaps(ctx: *mut fastrpc_invoke_ctx) {
    ...
    sort(ctx.olaps, ctx.nbufs, sizeof(*ctx.olaps), olaps_cmp, core::ptr::null_mut());
    for (i = 0; i < ctx.nbufs; ++i) {
// Falling inside previous range
    ...
    struct fastrpc_invoke_ctx *ctx = core::ptr::null_mut();
    unsigned long flags;
    int ret;
    ctx = kzalloc_obj(*ctx);
    if (!ctx)
...
#[no_mangle]
unsafe extern "C" fn fastrpc_release(dmabuf: *mut dma_buf) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_vmap(dmabuf: *mut dma_buf, map: *mut iosys_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_compute_dma_addr(fl: *mut fastrpc_user, sg_dma_addr: dma_addr_t) -> dma_addr_t {
    ...
    struct fastrpc_map *map = core::ptr::null_mut();
    struct sg_table *table;
    struct scatterlist *sgl = core::ptr::null_mut();
    let mut err: c_int = 0, sgl_index = 0;
    map = kzalloc_obj(*map);
    if (!map)
    return -ENOMEM;
...
//
    let mut src_perms: u64 = BIT(QCOM_SCM_VMID_HLOS);
...
//
#[no_mangle]
unsafe extern "C" fn fastrpc_get_meta_size(ctx: *mut fastrpc_invoke_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_get_payload_size(ctx: *mut fastrpc_invoke_ctx, metalen: c_int) -> u64 {
    ...
    let mut i: c_int = ctx.olaps[oix].raix;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_create_maps(ctx: *mut fastrpc_invoke_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_get_args(kernel: u32, ctx: *mut fastrpc_invoke_ctx) -> c_int {
    ...
    struct fastrpc_map *mmap = core::ptr::null_mut();
    ...
    let mut len: u64 = rpra[i].buf.len;
    if (!kernel) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_read_poll_addr(ctx: *mut fastrpc_invoke_ctx) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn poll_for_remote_response(ctx: *mut fastrpc_invoke_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_session_rejected(fl: *mut fastrpc_user, unsigned_pd_request: bool) -> bool {
...
// Map if we have any heap VMIDs associated with this ADSP Static Process.
    ...
    fl.cctx.remote_heap = core::ptr::null_mut();
    err_name:
    kfree(name);
    err:
    kfree(args);
    ...
    struct fastrpc_phy_page pages[1];
    struct fastrpc_map *map = core::ptr::null_mut();
    struct fastrpc_buf *imem = core::ptr::null_mut();
    int memlen;
    int err;
    struct {
    int client_id;
    ...
    u32 sc;
    let mut unsigned_module: bool = false;
    ...
    struct fastrpc_session_ctx *session = core::ptr::null_mut();
    unsigned long flags;
    int i;
    spin_lock_irqsave(&cctx.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn fastrpc_release_current_dsp_process(fl: *mut fastrpc_user) -> c_int {
    static int fastrpc_release_current_dsp_process(struct fastrpc_user *fl)
    {
    struct fastrpc_invoke_args args[1];
    let mut client_id: c_int = 0;
    u32 sc;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_device_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_device_open(inode: *mut inode, filp: *mut file) -> c_int {
    static int fastrpc_device_open(struct inode *inode, struct file *filp)
    {
    struct fastrpc_channel_ctx *cctx;
    struct fastrpc_device *fdevice;
    struct fastrpc_user *fl = core::ptr::null_mut();
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_dmabuf_alloc(fl: *mut fastrpc_user, argp: *mut char __user) -> c_int {
    static int fastrpc_dmabuf_alloc(struct fastrpc_user *fl, char __user *argp)
    {
    struct fastrpc_alloc_dma_buf bp;
    DEFINE_DMA_BUF_EXPORT_INFO(exp_info);
    struct fastrpc_buf *buf = core::ptr::null_mut();
    int err;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_init_attach(fl: *mut fastrpc_user, pd: c_int) -> c_int {
    static int fastrpc_init_attach(struct fastrpc_user *fl, int pd)
    {
    struct fastrpc_invoke_args args[1];
    let mut client_id: c_int = fl.client_id;
    u32 sc;
    args[0].ptr = (u64)(uintptr_t) &client_id;
    args[0].length = sizeof(client_id);
    args[0].fd = -1;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_invoke(fl: *mut fastrpc_user, argp: *mut char __user) -> c_int {
    static int fastrpc_invoke(struct fastrpc_user *fl, char __user *argp)
    {
    struct fastrpc_invoke_args *args = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn sizeof(_arg: *mut args))) -> *mut nscalars {
    kfree(args);
    return -EFAULT;
    }
    }
...
//
    ...
    {
    struct fastrpc_channel_ctx *cctx = fl.cctx;
    let mut attribute_id: u32 = cap.attribute_id;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_set_option(fl: *mut fastrpc_user, argp: *mut char __user) -> c_int {
    static int fastrpc_set_option(struct fastrpc_user *fl, char __user *argp)
    {
    let mut opt: fastrpc_ioctl_set_option = {0};
    int i;
    ...
    fl.poll_mode = true;
#[no_mangle]
pub unsafe extern "C" fn if(FASTRPC_POLL_MODE_DISABLE: opt.value ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_get_dsp_info(fl: *mut fastrpc_user, argp: *mut char __user) -> c_int {
    static int fastrpc_get_dsp_info(struct fastrpc_user *fl, char __user *argp)
    {
    let mut cap: fastrpc_ioctl_capability = {0};
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_req_munmap_impl(fl: *mut fastrpc_user, buf: *mut fastrpc_buf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_req_munmap(fl: *mut fastrpc_user, argp: *mut char __user) -> c_int {
    static int fastrpc_req_munmap(struct fastrpc_user *fl, char __user *argp)
    {
    struct fastrpc_buf *buf = core::ptr::null_mut(), *iter, *b;
...
#[no_mangle]
unsafe extern "C" fn fastrpc_req_mmap(fl: *mut fastrpc_user, argp: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_req_mem_unmap_impl(fl: *mut fastrpc_user, req: *mut fastrpc_mem_unmap) -> c_int {
    static int fastrpc_req_mem_unmap_impl(struct fastrpc_user *fl, struct fastrpc_mem_unmap *req)
    {
    struct fastrpc_invoke_args args[1] = { [0] = { 0 } };
    struct fastrpc_map *map = core::ptr::null_mut(), *iter, *m;
    let mut req_msg: fastrpc_mem_unmap_req_msg = { 0 };
    let mut err: c_int = 0;
    u32 sc;
    struct device *dev = fl.sctx.dev;
    spin_lock(&fl.lock);
...
#[no_mangle]
unsafe extern "C" fn fastrpc_req_mem_unmap(fl: *mut fastrpc_user, argp: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_req_mem_map(fl: *mut fastrpc_user, argp: *mut char __user) -> c_int {
    static int fastrpc_req_mem_map(struct fastrpc_user *fl, char __user *argp)
    {
    struct fastrpc_invoke_args args[4] = { [0 ... 3] = { 0 } };
    let mut req_msg: fastrpc_mem_map_req_msg = { 0 };
    let mut rsp_msg: fastrpc_mmap_rsp_msg = { 0 };
    let mut req_unmap: fastrpc_mem_unmap = { 0 };
    let mut pages: fastrpc_phy_page = { 0 };
...
#[no_mangle]
unsafe extern "C" fn fastrpc_cb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_cb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_get_domain_id(domain: *const c_char) -> c_int {
    static int fastrpc_get_domain_id(const char *domain)
    {
    if (!strncmp(domain, "adsp", 4))
    return ADSP_DOMAIN_ID;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(domain, _arg: "cdsp", _arg: 4)) -> else {
    else if (!strncmp(domain, "cdsp", 4))
    return CDSP_DOMAIN_ID;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(domain, _arg: "mdsp", _arg: 4)) -> else {
    else if (!strncmp(domain, "mdsp", 4))
    return MDSP_DOMAIN_ID;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(domain, _arg: "sdsp", _arg: 4)) -> else {
    else if (!strncmp(domain, "sdsp", 4))
    return SDSP_DOMAIN_ID;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(domain, _arg: "gdsp", _arg: 4)) -> else {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_rpmsg_probe(rpdev: *mut rpmsg_device) -> c_int {
    ...
    vmcount = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !qcom_scm_is_available()) -> else {
...
// Create both device nodes so that we can allow both Signed and Unsigned PD
    ...
    err = of_platform_populate(rdev.of_node, core::ptr::null_mut(), core::ptr::null_mut(), rdev);
    if (err)
    goto err_deregister_fdev;
    return 0;
    err_deregister_fdev:
...
#[no_mangle]
unsafe extern "C" fn fastrpc_notify_users(user: *mut fastrpc_user) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_rpmsg_remove(rpdev: *mut rpmsg_device) {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fastrpc_exit() {
