...
//! Source: drivers/misc/bcm-vk/bcm_vk_dev.c
#![no_std]
...
pub const PCI_DEVICE_ID_VALKYRIE: c_uint = 0x5e87;
pub const PCI_DEVICE_ID_VIPER: c_uint = 0x5e88;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct load_image_entry {
    pub image_type: u32,
    pub image_name: [*const c_char; IMG_PER_TYPE_MAX],
}

pub const NUM_BOOT_STAGES: c_int = 2;
...
pub const BAR1_CODEPUSH_BASE_BOOT1: c_uint = 0x100000;
...
pub const TXFR_COMPLETE_TIMEOUT_MS: c_int = 1;
// MSIX usages
pub const VK_MSIX_MSGQ_MAX: c_int = 3;
pub const VK_MSIX_NOTF_MAX: c_int = 1;

    VK_MSIX_TTY_MAX)

// Number of bits set in DMA mask
pub const BCM_VK_DMA_BITS: c_int = 64;
...
#[no_mangle]
pub unsafe extern "C" fn bcm_vk_notf_irqhandler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_intf_ver_chk(vk: *mut bcm_vk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_dump_peer_log(vk: *mut bcm_vk) {
...
#[no_mangle]
pub unsafe extern "C" fn bcm_vk_handle_notf(vk: *mut bcm_vk) {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_get_card_info(vk: *mut bcm_vk) {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_get_proc_mon_info(vk: *mut bcm_vk) {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_sync_card_info(vk: *mut bcm_vk) -> c_int {
    static int bcm_vk_sync_card_info(struct bcm_vk *vk)
    {
    let mut rdy_marker: u32 = vkread32(vk, BAR_1, VK_BAR1_MSGQ_DEF_RDY);
...
#[no_mangle]
pub unsafe extern "C" fn bcm_vk_blk_drv_access(vk: *mut bcm_vk) {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_next_boot_image(vk: *mut bcm_vk) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(BOOT1_RUNNING: boot_status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_soc_idx(vk: *mut bcm_vk) -> enum soc_idx {
    static enum soc_idx get_soc_idx(struct bcm_vk *vk)
    {
    struct pci_dev *pdev = vk.pdev;
    let mut idx: enum soc_idx = VK_IDX_INVALID;
    u32 rev;
...
#[no_mangle]
pub unsafe extern "C" fn bcm_vk_auto_load_all_images(vk: *mut bcm_vk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_trigger_autoload(vk: *mut bcm_vk) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bcm_vk_wq_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_reset_successful(vk: *mut bcm_vk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_to_v_reset_doorbell(vk: *mut bcm_vk, db_val: u32) {
    static void bcm_to_v_reset_doorbell(struct bcm_vk *vk, u32 db_val)
    {
    vkwrite32(vk, db_val, BAR_0, VK_BAR0_RESET_DB_BASE);
    }
#[no_mangle]
unsafe extern "C" fn bcm_vk_trigger_reset(vk: *mut bcm_vk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_reset(vk: *mut bcm_vk, arg: *mut vk_reset __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
pub const VK_MMAPABLE_BAR: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
// enable hb
    ...
    misc_device.name = core::ptr::null_mut();
    err_ida_remove:
...
#[no_mangle]
pub unsafe extern "C" fn bcm_vk_release_data(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn bcm_vk_shutdown(pdev: *mut pci_dev) {
