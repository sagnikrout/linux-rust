...
//! Source: drivers/tty/vt/keyboard.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn kbd_defleds() -> c_int {
    static inline int kbd_defleds(void)
    {
    return 0;
    }

pub const KBD_DEFLOCK: c_int = 0;
//
// Handler Tables.
//
// Macro flag: #define K_HANDLERS\
...
// maximum values each key_handler can handle
    ...
    let mut NR_TYPES: static int = ARRAY_SIZE(max_vals);
...
// Handles a number being assembled on the number pad
    ...
    let mut shift_state: static int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn register_keyboard_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_keyboard_notifier(nb: *mut notifier_block) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct getset_keycode_data {
    pub ke: input_keymap_entry,
    pub error: c_int,
}

#[no_mangle]
unsafe extern "C" fn getkeycode_helper(handle: *mut input_handle, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn getkeycode(scancode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setkeycode_helper(handle: *mut input_handle, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setkeycode(scancode: c_uint, keycode: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kd_sound_helper(handle: *mut input_handle, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kd_nosound(unused: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn kd_mksound(hz: c_uint, ticks: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn kbd_rate_helper(handle: *mut input_handle, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn kbd_rate(rpt: *mut kbd_repeat) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn put_queue(vc: *mut vc_data, ch: c_int) {
...
#[no_mangle]
unsafe extern "C" fn puts_queue(vc: *mut vc_data, cp: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn applkey(vc: *mut vc_data, key: c_int, mode: c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn to_utf8(vc: *mut vc_data, c: c_uint) {
...
// 0*******
    put_queue(vc, c);
#[no_mangle]
pub unsafe extern "C" fn if(0x800: c <) -> else {
// 110***** 10******
...
#[no_mangle]
unsafe extern "C" fn put_queue_utf8(vc: *mut vc_data, value: u32) {
    static void put_queue_utf8(struct vc_data *vc, u32 value)
    {
    if (kbd.kbdmode == VC_UNICODE)
    to_utf8(vc, value);
    else {
    let mut c: c_int = conv_uni_to_8bit(value);
    if (c != -1)
    put_queue(vc, c);
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn do_compute_shiftstate() {
...
#[no_mangle]
pub unsafe extern "C" fn vt_set_leds_compute_shiftstate() {
...
//
#[no_mangle]
unsafe extern "C" fn handle_diacr(vc: *mut vc_data, ch: c_uint) -> c_uint {
    static unsigned int handle_diacr(struct vc_data *vc, unsigned int ch)
    {
    let mut d: c_uint = diacr;
    unsigned int i;
    diacr = 0;
...
//
#[no_mangle]
unsafe extern "C" fn fn_enter(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_caps_toggle(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_caps_on(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_show_ptregs(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_hold(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_num(vc: *mut vc_data) {
...
//
#[no_mangle]
unsafe extern "C" fn fn_bare_num(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_lastcons(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_dec_console(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_inc_console(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_send_intr(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_scroll_forw(vc: *mut vc_data) {
    static void fn_scroll_forw(struct vc_data *vc)
    {
    scrollfront(vc, 0);
    }
#[no_mangle]
unsafe extern "C" fn fn_scroll_back(vc: *mut vc_data) {
    static void fn_scroll_back(struct vc_data *vc)
    {
    scrollback(vc);
    }
#[no_mangle]
unsafe extern "C" fn fn_show_mem(vc: *mut vc_data) {
    static void fn_show_mem(struct vc_data *vc)
    {
    show_mem();
    }
#[no_mangle]
unsafe extern "C" fn fn_show_state(vc: *mut vc_data) {
    static void fn_show_state(struct vc_data *vc)
    {
    show_state();
    }
#[no_mangle]
unsafe extern "C" fn fn_boot_it(vc: *mut vc_data) {
    static void fn_boot_it(struct vc_data *vc)
    {
    ctrl_alt_del();
    }
#[no_mangle]
unsafe extern "C" fn fn_compose(vc: *mut vc_data) {
    static void fn_compose(struct vc_data *vc)
    {
    dead_key_next = true;
    }
#[no_mangle]
unsafe extern "C" fn fn_spawn_con(vc: *mut vc_data) {
    ...
    vt_spawn_con.pid = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn fn_SAK(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn fn_null(vc: *mut vc_data) {
...
//
#[no_mangle]
unsafe extern "C" fn k_spec(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_lowercase(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
    static void k_lowercase(struct vc_data *vc, unsigned char value, char up_flag)
    {
    pr_err("k_lowercase was called - impossible\n");
    }
#[no_mangle]
unsafe extern "C" fn k_unicode(vc: *mut vc_data, value: c_uint, up_flag: c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn k_deadunicode(vc: *mut vc_data, value: c_uint, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_self(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
    static void k_self(struct vc_data *vc, unsigned char value, char up_flag)
    {
    k_unicode(vc, conv_8bit_to_uni(value), up_flag);
    }
#[no_mangle]
unsafe extern "C" fn k_dead2(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn k_dead(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_cons(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_fn(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn csi_modifier_param() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k_cur(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_pad(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_shift(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
    static void k_shift(struct vc_data *vc, unsigned char value, char up_flag)
    {
    let mut old_state: c_int = shift_state;
    if (rep)
    return;
//
// Mimic typewriter:
...
#[no_mangle]
unsafe extern "C" fn k_meta(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_ascii(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_lock(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_slock(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
// by default, 300ms interval for combination release
    let mut brl_timeout: static unsigned = 300;
    MODULE_PARM_DESC(brl_timeout, "Braille keys release delay in ms (0 for commit on first key release)");
    module_param(brl_timeout, uint, 0644);
    let mut brl_nbchords: static unsigned = 1;
    MODULE_PARM_DESC(brl_nbchords, "Number of chords that produce a braille pattern (0 for dead chords)");
    module_param(brl_nbchords, uint, 0644);
#[no_mangle]
unsafe extern "C" fn k_brlcommit(vc: *mut vc_data, pattern: c_uint, up_flag: c_char) {
...
#[no_mangle]
unsafe extern "C" fn k_brl(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn k_csi(vc: *mut vc_data, value: c_uchar, up_flag: c_char) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kbd_led_trigger {
    pub trigger: led_trigger,
    pub mask: c_uint,
}

#[no_mangle]
unsafe extern "C" fn kbd_led_trigger_activate(cdev: *mut led_classdev) -> c_int {
    ...
    {
    struct kbd_led_trigger *trigger;
    let mut changed: c_uint = old_state ^ new_state;
    int i;
...
#[no_mangle]
unsafe extern "C" fn kbd_update_leds_helper(handle: *mut input_handle, data: *mut c_void) -> c_int {
    static int kbd_update_leds_helper(struct input_handle *handle, void *data)
    {
    let mut led_state: c_uint = *(unsigned int *)data;
    if (test_bit(EV_LED, handle.dev.evbit))
    kbd_propagate_led_state(~led_state, led_state);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn kbd_init_leds() {
...
unsafe extern "C" fn kbd_update_leds_helper(handle: *mut input_handle, data: *mut c_void) -> c_int {
    static int kbd_update_leds_helper(struct input_handle *handle, void *data)
    {
    let mut leds: c_uint = *(unsigned int *)data;
    if (test_bit(EV_LED, handle.dev.evbit)) {
...
//
#[no_mangle]
unsafe extern "C" fn getledstate() -> c_uchar {
    static unsigned char getledstate(void)
    {
    return ledstate & 0xff;
    }
#[no_mangle]
pub unsafe extern "C" fn setledstate(kb: *mut kbd_struct, led: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn getleds() -> c_uchar {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_get_leds(console: c_uint, flag: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_set_led_state(console: c_uint, leds: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_kbd_con_start(console: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_kbd_con_stop(console: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn kbd_bh(unused: *mut tasklet_struct) {
    static void kbd_bh(struct tasklet_struct *unused)
    {
    unsigned int leds;
...
#[no_mangle]
pub unsafe extern "C" fn kbd_is_hw_raw(dev: *const input_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn emulate_raw(vc: *mut vc_data, keycode: c_uint, up_flag: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbd_rawcode(data: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn kbd_keycode(keycode: c_uint, down: c_int, hw_raw: bool) {
    ...
    int shift_final;
    let mut param: keyboard_notifier_param = { .vc = vc, .value = keycode, .down = down };
    int rc;
...
//
    ...
    let mut plain: c_ushort = key_maps[0][keycode];
    let mut type: c_uchar = KTYP(plain);
...
#[no_mangle]
pub unsafe extern "C" fn if(KEY_BRL_DOT8: keycode >= KEY_BRL_DOT1 && keycode <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn kbd_match(handler: *mut input_handler, dev: *mut input_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kbd_disconnect(handle: *mut input_handle) {
...
//
#[no_mangle]
unsafe extern "C" fn kbd_start(handle: *mut input_handle) {
...
#[no_mangle]
pub unsafe extern "C" fn kbd_init() -> int __init {
...
// Ioctl support code
#[no_mangle]
unsafe extern "C" fn vt_do_kdgkbdiacr(udp: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt_do_kdgkbdiacruc(udp: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt_do_kdskbdiacr(udp: *mut void __user, perm: c_int) -> c_int {
    static int vt_do_kdskbdiacr(void __user *udp, int perm)
    {
    struct kbdiacrs __user *a = udp;
    struct kbdiacr __free(kfree) *dia = core::ptr::null_mut();
    unsigned int ct;
    int i;
    if (!perm)
    return -EPERM;
...
#[no_mangle]
unsafe extern "C" fn vt_do_kdskbdiacruc(udp: *mut void __user, perm: c_int) -> c_int {
    static int vt_do_kdskbdiacruc(void __user *udp, int perm)
    {
    struct kbdiacrsuc __user *a = udp;
    unsigned int ct;
    void __free(kfree) *buf = core::ptr::null_mut();
    if (!perm)
    return -EPERM;
    if (get_user(ct, &a.kb_cnt))
    return -EFAULT;
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_do_diacrit(cmd: c_uint, udp: *mut void __user, perm: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_do_kdskbmode(console: c_uint, arg: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_do_kdskbmeta(console: c_uint, arg: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vt_do_kbkeycode_ioctl(cmd: c_int, user_kbkc: *mut kbkeycode __user, perm: c_int) -> c_int {
...
// Ensure another thread doesn't free it under us
    ...
    if (key_map) {
    let mut val: c_ushort = U(key_map[idx]);
...
// deallocate map
    key_map = key_maps[map];
    if (map && key_map) {
    key_maps[map] = core::ptr::null_mut();
...
// Attention Key
    ...
    func_table[cur] = kbs;
    return __test_and_set_bit(cur, is_kmalloc) ? cur_f : core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn vt_do_kdgkb_ioctl(cmd: c_int, user_kdgkb: *mut kbsentry __user, perm: c_int) -> c_int {
...
// size should have been a struct member
    let mut len: isize = sizeof(user_kdgkb.kb_string);
...
#[no_mangle]
pub unsafe extern "C" fn vt_do_kdskled(console: c_uint, cmd: c_int, arg: c_ulong, perm: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vt_do_kdgkbmode(console: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_do_kdgkbmeta(console: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_reset_unicode(console: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_get_shift_state() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_reset_keyboard(console: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_get_kbd_mode_bit(console: c_uint, bit: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_set_kbd_mode_bit(console: c_uint, bit: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vt_clr_kbd_mode_bit(console: c_uint, bit: c_int) {
