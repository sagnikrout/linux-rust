...
//! Source: drivers/tty/vt/consolemap.c
#![no_std]
...
pub struct uni_pagedict {
    pub uni_pgdir: [*mut u16; UNI_DIRS],
    pub refcount: c_ulong,
    pub sum: c_ulong,
    pub 1]: *mut *mut unsigned char inverse_translations[LAST_MAP +,
    pub inverse_trans_unicode: *mut u16,
}
    ...
    let mut glyph: c_int = conv_uni_to_pc(conp, t[ch]);
...
#[no_mangle]
unsafe extern "C" fn set_inverse_trans_unicode(dict: *mut uni_pagedict) {
...
//
#[no_mangle]
pub unsafe extern "C" fn inverse_translate(conp: *const vc_data, glyph: u16, use_unicode: bool) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn update_user_maps() {
    static void update_user_maps(void)
    {
    int i;
    struct uni_pagedict *p, *q = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn con_set_trans_old(arg: *mut *mut unsigned char __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn con_get_trans_old(arg: *mut *mut unsigned char __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn con_set_trans_new(arg: *mut *mut ushort __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn con_get_trans_new(arg: *mut *mut ushort __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn con_release_unimap(dict: *mut uni_pagedict) {
    static void con_release_unimap(struct uni_pagedict *dict)
    {
    unsigned int d, r;
    if (dict == dflt)
    dflt = core::ptr::null_mut();
    for (d = 0; d < UNI_DIRS; d++) {
    u16 **dir = dict.uni_pgdir[d];
    ...
    dict.uni_pgdir[d] = core::ptr::null_mut();
    }
    for (r = 0; r < ARRAY_SIZE(dict.inverse_translations); r++) {
    kfree(dict.inverse_translations[r]);
    dict.inverse_translations[r] = core::ptr::null_mut();
    }
    kfree(dict.inverse_trans_unicode);
    dict.inverse_trans_unicode = core::ptr::null_mut();
    }
// Caller must hold the console lock
#[no_mangle]
pub unsafe extern "C" fn con_free_unimap(vc: *mut vc_data) {
...
#[no_mangle]
unsafe extern "C" fn con_unify_unimap(conp: *mut vc_data, dict1: *mut uni_pagedict) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn con_allocate_new(vc: *mut vc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn con_do_clear_unimap(vc: *mut vc_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn con_clear_unimap(vc: *mut vc_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn con_set_unimap(vc: *mut vc_data, ct: c_ushort, list: *mut unipair __user) -> c_int {
...
//
    ...
    let mut err1: c_int = con_insert_unipair(dict, plist.unicode, plist.fontpos);
    if (err1)
    err = err1;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn con_set_default_unimap(vc: *mut vc_data) -> c_int {
    int con_set_default_unimap(struct vc_data *vc)
    {
    struct uni_pagedict *dict;
    unsigned int fontpos, count;
    let mut err: c_int = 0, err1;
    u16 *dfont;
    if (dflt) {
    dict = *vc.uni_pagedict_loc;
    if (dict == dflt)
...
//
#[no_mangle]
pub unsafe extern "C" fn con_copy_unimap(dst_vc: *mut vc_data, src_vc: *mut vc_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn conv_8bit_to_uni(c: c_uchar) -> u32 {
    u32 conv_8bit_to_uni(unsigned char c)
    {
    let mut uni: c_ushort = translations[USER_MAP][c];
    let mut uni: return = = (0xf000 | c) ? c : uni;
    }
#[no_mangle]
pub unsafe extern "C" fn conv_uni_to_8bit(uni: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn conv_uni_to_pc(conp: *mut vc_data, ucs: c_long) -> c_int {
...
// Only 16-bit codes supported at this time
    ...
    return -4;		/* Not found */
#[no_mangle]
pub unsafe extern "C" fn if(0x20: ucs <) -> else {
    else if (ucs < 0x20)
...
//
#[no_mangle]
pub unsafe extern "C" fn if(UNI_DIRECT_BASE: (ucs & ~UNI_DIRECT_MASK) ==) -> else {
