...
#[no_mangle]
unsafe extern "C" fn tty_port_default_wakeup(port: *mut tty_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_init(port: *mut tty_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_link_wq(port: *mut tty_port, flip_wq: *mut workqueue_struct) {
...
//
    ...
    {
    return tty_port_register_device_attr(port, driver, index, device, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
//
    ...
    {
    int ret;
    WRITE_ONCE(port.buf.flip_wq, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn tty_port_alloc_xmit_buf(port: *mut tty_port) -> c_int {
...
// We may sleep in get_zeroed_page()
    ...
    if (port.xmit_buf == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn tty_port_free_xmit_buf(port: *mut tty_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_destroy(port: *mut tty_port) {
...
#[no_mangle]
unsafe extern "C" fn tty_port_destructor(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_put(port: *mut tty_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_tty_set(port: *mut tty_port, tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tty_port_shutdown(port: *mut tty_port, tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_hangup(port: *mut tty_port) {
...
#[no_mangle]
pub unsafe extern "C" fn __tty_port_tty_hangup(port: *mut tty_port, check_clocal: bool, async: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_tty_wakeup(port: *mut tty_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_carrier_raised(port: *mut tty_port) -> bool {
    bool tty_port_carrier_raised(struct tty_port *port)
    {
    if (port.ops.carrier_raised == core::ptr::null_mut())
    return true;
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_raise_dtr_rts(port: *mut tty_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_lower_dtr_rts(port: *mut tty_port) {
...
//
    ...
    {
    let mut do_clocal: c_int = 0, retval;
    DEFINE_WAIT(wait);
...
//
    ...
    if (filp == core::ptr::null_mut() || (filp.f_flags & O_NONBLOCK)) {
...
#[no_mangle]
unsafe extern "C" fn tty_port_drain_delay(port: *mut tty_port, tty: *mut tty_struct) {
    static void tty_port_drain_delay(struct tty_port *port, struct tty_struct *tty)
    {
    let mut bps: c_uint = tty_get_baud_rate(tty);
    long timeout;
    if (bps > 1200) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_port_close_end(port: *mut tty_port, tty: *mut tty_struct) {
...
//
    ...
    let mut retval: c_int = port.ops.activate(port, tty);
    if (retval)
    return retval;
    }
