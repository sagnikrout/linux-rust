...
//! Source: drivers/tty/tty_ldisc.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_register_ldisc(new_ldisc: *const tty_ldisc_ops) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_unregister_ldisc(ldisc: *const tty_ldisc_ops) {
    void tty_unregister_ldisc(const struct tty_ldisc_ops *ldisc)
    {
    unsigned long flags;
    raw_spin_lock_irqsave(&tty_ldiscs_lock, flags);
    tty_ldiscs[ldisc.num] = core::ptr::null_mut();
    raw_spin_unlock_irqrestore(&tty_ldiscs_lock, flags);
    }
...
#[no_mangle]
unsafe extern "C" fn put_ldops(ldops: *const tty_ldisc_ops) {
    ...
    let mut tty_ldisc_autoload: c_int = IS_BUILTIN(CONFIG_LDISC_AUTOLOAD);
//
...
//
#[no_mangle]
unsafe extern "C" fn tty_ldisc_put(ld: *mut tty_ldisc) {
    ...
    {
    return (*pos < NR_LDISCS) ? pos : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tty_ldiscs_seq_stop(m: *mut seq_file, v: *mut c_void) {
    static void tty_ldiscs_seq_stop(struct seq_file *m, void *v)
    {
    }
#[no_mangle]
unsafe extern "C" fn tty_ldiscs_seq_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
//
    ...
    {
    struct tty_ldisc *ld = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_deref(ld: *mut tty_ldisc) {
...
#[no_mangle]
pub unsafe extern "C" fn __tty_ldisc_unlock(tty: *mut tty_struct) {
    static inline void __tty_ldisc_unlock(struct tty_struct *tty)
    {
    ldsem_up_write(&tty.ldisc_sem);
    }
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_lock(tty: *mut tty_struct, timeout: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_unlock(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn tty_ldisc_lock_pair(tty: *mut tty_struct, tty2: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_flush(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tty_set_termios_ldisc(tty: *mut tty_struct, disc: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tty_ldisc_open(tty: *mut tty_struct, ld: *mut tty_ldisc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty_ldisc_close(tty: *mut tty_struct, ld: *mut tty_ldisc) {
...
//
#[no_mangle]
unsafe extern "C" fn tty_ldisc_failto(tty: *mut tty_struct, ld: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty_ldisc_restore(tty: *mut tty_struct, old: *mut tty_ldisc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_set_ldisc(tty: *mut tty_struct, disc: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty_ldisc_kill(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tty_reset_termios(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_reinit(tty: *mut tty_struct, disc: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_hangup(tty: *mut tty_struct, reinit: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_setup(tty: *mut tty_struct, o_tty: *mut tty_struct) -> c_int {
    int tty_ldisc_setup(struct tty_struct *tty, struct tty_struct *o_tty)
    {
    let mut retval: c_int = tty_ldisc_open(tty, tty.ldisc);
    if (retval)
    return retval;
    if (o_tty) {
//
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_release(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_init(tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ldisc_deinit(tty: *mut tty_struct) {
