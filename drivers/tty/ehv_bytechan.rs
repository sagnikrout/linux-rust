...
//! Source: drivers/tty/ehv_bytechan.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ehv_bc_data {
    pub dev: *mut device,
    pub port: tty_port,
    pub handle: u32,
    pub rx_irq: c_uint,
    pub tx_irq: c_uint,
    pub /: *mut *mut spinlock_t lock; / lock for transmit buffer,
    pub /: *mut *mut u8 buf[BUF_SIZE]; / transmit circular buffer,
    pub /: *mut *mut unsigned int head; / circular buffer head,
    pub /: *mut *mut unsigned int tail; / circular buffer tail,
    pub /: *mut *mut int tx_irq_enabled; / true == TX interrupt is enabled,
}
...
//
#[no_mangle]
unsafe extern "C" fn enable_tx_interrupt(bc: *mut ehv_bc_data) {
...
#[no_mangle]
unsafe extern "C" fn disable_tx_interrupt(bc: *mut ehv_bc_data) {
...
//
#[no_mangle]
unsafe extern "C" fn find_console_handle() -> c_int {
...
//
    iprop = of_get_property(np, "hv-handle", core::ptr::null_mut());
    if (!iprop) {
...
//
#[no_mangle]
unsafe extern "C" fn byte_channel_spin_send(data: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_udbg_putc(c: c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn udbg_init_ehv_bc() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_console_init() -> int __init {
...
// add_preferred_console() must be called before register_console(),
    ...
    add_preferred_console(ehv_bc_console.name, ehv_bc_console.index, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_rx_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_tx_dequeue(bc: *mut ehv_bc_data) {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_tx_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_open(ttys: *mut tty_struct, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_close(ttys: *mut tty_struct, filp: *mut file) {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_write_room(ttys: *mut tty_struct) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_throttle(ttys: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_unthrottle(ttys: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_hangup(ttys: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_port_shutdown(port: *mut tty_port) {
...
#[no_mangle]
unsafe extern "C" fn ehv_bc_tty_probe(pdev: *mut platform_device) -> c_int {
    ...
    unsigned int handle;
    int ret;
    let mut index: static unsigned int = 1;
    unsigned int i;
    iprop = of_get_property(np, "hv-handle", core::ptr::null_mut());
    if (!iprop) {
...
//
#[no_mangle]
unsafe extern "C" fn ehv_bc_init() -> int __init {
...
// Count the number of byte channels
    for_each_compatible_node(np, core::ptr::null_mut(), "epapr,hv-byte-channel")
    count++;
    if (!count)
    return -ENODEV;
...
//
    ...
    ehv_bc_driver = core::ptr::null_mut();
