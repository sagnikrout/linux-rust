...
pub const GOLDFISH_TTY_REG_BYTES_READY: c_uint = 0x04;
pub const GOLDFISH_TTY_REG_CMD: c_uint = 0x08;
pub const GOLDFISH_TTY_REG_DATA_PTR: c_uint = 0x10;
pub const GOLDFISH_TTY_REG_DATA_LEN: c_uint = 0x14;
pub const GOLDFISH_TTY_REG_DATA_PTR_HIGH: c_uint = 0x18;
pub const GOLDFISH_TTY_REG_VERSION: c_uint = 0x20;
// Goldfish tty commands
pub const GOLDFISH_TTY_CMD_INT_DISABLE: c_int = 0;
pub const GOLDFISH_TTY_CMD_INT_ENABLE: c_int = 1;
pub const GOLDFISH_TTY_CMD_WRITE_BUFFER: c_int = 2;
pub const GOLDFISH_TTY_CMD_READ_BUFFER: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct goldfish_tty {
    pub port: tty_port,
    pub lock: spinlock_t,
    ...
    let mut goldfish_tty_line_count: static u32 = 8;
    static u32 goldfish_tty_current_line_count;
    static struct goldfish_tty *goldfish_ttys;
#[no_mangle]
pub unsafe extern "C" fn gf_write_addr(addr: c_ulong, portl: *mut void __iomem, porth: *mut void __iomem) {
...
//
    let mut addr_end: c_ulong = addr + count;
    while (addr < addr_end) {
    let mut pg_end: c_ulong = (addr & PAGE_MASK) + PAGE_SIZE;
    unsigned long next =
    pg_end < addr_end ? pg_end : addr_end;
    let mut avail: c_ulong = next - addr;
//
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_do_write(line: c_int, buf: *const u8, count: usize) {
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_activate(port: *mut tty_port, tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_shutdown(port: *mut tty_port) {
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_open(tty: *mut tty_struct, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_close(tty: *mut tty_struct, filp: *mut file) {
    static void goldfish_tty_close(struct tty_struct *tty, struct file *filp)
    {
    tty_port_close(tty.port, tty, filp);
    }
#[no_mangle]
unsafe extern "C" fn goldfish_tty_hangup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_write_room(tty: *mut tty_struct) -> c_uint {
    static unsigned int goldfish_tty_write_room(struct tty_struct *tty)
    {
    return 0x10000;
    }
#[no_mangle]
unsafe extern "C" fn goldfish_tty_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
unsafe extern "C" fn goldfish_tty_create_driver() -> c_int {
    ...
    kfree(goldfish_ttys);
    goldfish_ttys = core::ptr::null_mut();
    err_alloc_goldfish_ttys_failed:
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn goldfish_tty_delete_driver() {
    static void goldfish_tty_delete_driver(void)
    {
    tty_unregister_driver(goldfish_tty_driver);
    tty_driver_kref_put(goldfish_tty_driver);
    goldfish_tty_driver = core::ptr::null_mut();
    kfree(goldfish_ttys);
    goldfish_ttys = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn goldfish_tty_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn goldfish_tty_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gf_early_console_putchar(port: *mut uart_port, ch: c_uchar) {
    static void gf_early_console_putchar(struct uart_port *port, unsigned char ch)
    {
    gf_iowrite32(ch, port.membase);
    }
#[no_mangle]
unsafe extern "C" fn gf_early_write(con: *mut console, s: *const c_char, n: c_uint) {
