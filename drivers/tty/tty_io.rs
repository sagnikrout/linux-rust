...
pub const TTY_PARANOIA_CHECK: c_int = 1;
pub const CHECK_TTY_COUNT: c_int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn free_tty_struct(tty: *mut tty_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tty_alloc_file(file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tty_add_file(tty: *mut tty_struct, file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_free_file(file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn tty_del_file(file: *mut file) {
...
//
    ...
    {
    if (!tty) /* Hmm.  core::ptr::null_mut() pointer.  That's fun. */
    return "core::ptr::null_mut() tty";
    return tty.name;
    }
    ...
    if (!tty) {
    pr_warn("(%d:%d): %s: core::ptr::null_mut() tty\n",
...
#[no_mangle]
unsafe extern "C" fn check_tty_count(tty: *mut tty_struct, routine: *const c_char) {
    static void check_tty_count(struct tty_struct *tty, const char *routine)
    {

    struct list_head *p;
    let mut count: c_int = 0, kopen_count = 0;
...
//
    ...
    let mut base: dev_t = MKDEV(p.major, p.minor_start);
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_dev_name_to_number(name: *const c_char, number: *mut dev_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hung_up_tty_read(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
    static ssize_t hung_up_tty_read(struct kiocb *iocb, struct iov_iter *to)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn hung_up_tty_write(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hung_up_tty_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
    ...
    unsigned long arg)
    {
    let mut cmd: return = = TIOCSPGRP ? -ENOTTY : -EIO;
    }
...
#[no_mangle]
unsafe extern "C" fn hung_up_tty_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
    static int hung_up_tty_fasync(int fd, struct file *file, int on)
    {
    return -ENOTTY;
    }
#[no_mangle]
unsafe extern "C" fn tty_show_fdinfo(m: *mut seq_file, file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_wakeup(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn __tty_hangup(tty: *mut tty_struct, exit_session: c_int) {
    static void __tty_hangup(struct tty_struct *tty, int exit_session)
    {
    struct file *cons_filp = core::ptr::null_mut();
    struct file *filp, *f;
    struct tty_file_private *priv;
    let mut closecount: c_int = 0, n;
    int refs;
    if (!tty)
    return;
...
// Account for the p->signal references we killed
    while (refs--)
    tty_kref_put(tty);
    tty_ldisc_hangup(tty, cons_filp != core::ptr::null_mut());
    spin_lock_irq(&tty.ctrl.lock);
    clear_bit(TTY_THROTTLED, &tty.flags);
    clear_bit(TTY_DO_WRITE_WAKEUP, &tty.flags);
    put_pid(tty.ctrl.session);
    put_pid(tty.ctrl.pgrp);
    tty.ctrl.session = core::ptr::null_mut();
    tty.ctrl.pgrp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn do_tty_hangup(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_hangup(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_vhangup(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_vhangup_self() {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_vhangup_session(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_hung_up_p(filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __stop_tty(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn stop_tty(tty: *mut tty_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn __start_tty(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn start_tty(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn tty_update_time(tty: *mut tty_struct, mtime: bool) {
    static void tty_update_time(struct tty_struct *tty, bool mtime)
    {
    let mut sec: time64_t = ktime_get_real_seconds();
    struct tty_file_private *priv;
    guard(spinlock)(&tty.files_lock);
    list_for_each_entry(priv, &tty.tty_files, list) {
    struct inode *inode = file_inode(priv.file);
    let mut time: timespec64 = mtime ? inode_get_mtime(inode) : inode_get_atime(inode);
//
...
//
#[no_mangle]
unsafe extern "C" fn tty_read(iocb: *mut kiocb, to: *mut iov_iter) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn tty_write_unlock(tty: *mut tty_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tty_write_lock(tty: *mut tty_struct, ndelay: bool) -> c_int {
...
// Do the write ..
    for (;;) {
    let mut size: usize = min(chunk, count);
    ret = -EFAULT;
...
#[no_mangle]
unsafe extern "C" fn file_tty_write(file: *mut file, iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
// Short term debug to catch buggy drivers
    if (tty.ops.write_room == core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn tty_write(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
    static ssize_t tty_write(struct kiocb *iocb, struct iov_iter *from)
    {
    return file_tty_write(iocb.ki_filp, iocb, from);
    }
#[no_mangle]
pub unsafe extern "C" fn redirected_tty_write(iocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    ssize_t redirected_tty_write(struct kiocb *iocb, struct iov_iter *iter)
    {
    struct file *p = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_send_xchar(tty: *mut tty_struct, ch: u8) -> c_int {
    int tty_send_xchar(struct tty_struct *tty, u8 ch)
    {
    let mut was_stopped: bool = tty.flow.stopped;
...
//
#[no_mangle]
unsafe extern "C" fn pty_line_name(driver: *mut tty_driver, index: c_int, p: *mut c_char) {
    static void pty_line_name(struct tty_driver *driver, int index, char *p)
    {
    static const char ptychar[] = "pqrstuvwxyzabcde";
    let mut i: c_int = index + driver.name_base;
...
//
#[no_mangle]
unsafe extern "C" fn tty_line_name(driver: *mut tty_driver, index: c_int, p: *mut c_char) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_init_termios(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_standard_install(driver: *mut tty_driver, tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty_driver_remove_tty(driver: *mut tty_driver, tty: *mut tty_struct) {
    static void tty_driver_remove_tty(struct tty_driver *driver, struct tty_struct *tty)
    {
    if (driver.ops.remove)
    driver.ops.remove(driver, tty);
    else
    driver.ttys[tty.index] = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn tty_reopen(tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_save_termios(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tty_flush_works(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn release_one_tty(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn queue_release_one_tty(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_kref_put(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn release_tty(tty: *mut tty_struct, idx: c_int) {
    static void release_tty(struct tty_struct *tty, int idx)
    {
// This should always be true but check for the moment
    ...
    if (tty.port)
    tty.port.itty = core::ptr::null_mut();
    if (tty.link)
    tty.link.port.itty = core::ptr::null_mut();
    if (tty.port)
...
//
#[no_mangle]
unsafe extern "C" fn tty_release_checks(tty: *mut tty_struct, idx: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_kclose(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_release_struct(tty: *mut tty_struct, idx: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_release(inode: *mut inode, filp: *mut file) -> c_int {
    int tty_release(struct inode *inode, struct file *filp)
    {
    struct tty_struct *tty = file_tty(filp);
    struct tty_struct *o_tty = core::ptr::null_mut();
    int	do_sleep, final;
    int	idx;
    let mut timeout: c_long = 0;
    let mut once: c_int = 1;
...
// Don't let /dev/console block
    ...
    mutex_lock(&tty_mutex);
    driver = tty_lookup_driver(device, core::ptr::null_mut(), &index);
    if (IS_ERR(driver)) {
    mutex_unlock(&tty_mutex);
    return ERR_CAST(driver);
    }
// check whether we're reopening an existing tty
    tty = tty_driver_lookup_tty(driver, core::ptr::null_mut(), index);
...
//
#[no_mangle]
unsafe extern "C" fn tty_open(inode: *mut inode, filp: *mut file) -> c_int {
    static int tty_open(struct inode *inode, struct file *filp)
    {
    struct tty_struct *tty;
    int noctty, retval;
    let mut device: dev_t = inode.i_rdev;
    let mut saved_flags: unsigned = filp.f_flags;
...
//
#[no_mangle]
unsafe extern "C" fn tty_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn __tty_fasync(fd: c_int, filp: *mut file, on: c_int) -> c_int {
    static int __tty_fasync(int fd, struct file *filp, int on)
    {
    struct tty_struct *tty = file_tty(filp);
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn tty_fasync(fd: c_int, filp: *mut file, on: c_int) -> c_int {
    static int tty_fasync(int fd, struct file *filp, int on)
    {
    struct tty_struct *tty = file_tty(filp);
    let mut retval: c_int = -ENOTTY;
    tty_lock(tty);
    if (!tty_hung_up_p(filp))
    ...
    let mut __read_mostly: static bool tty_legacy_tiocsti = IS_ENABLED(CONFIG_LEGACY_TIOCSTI);
//
...
//
#[no_mangle]
unsafe extern "C" fn tiocsti(tty: *mut tty_struct, p: *mut u8 __user) -> c_int {
    ...
    ld.ops.receive_buf(tty, &ch, core::ptr::null_mut(), 1);
...
//
#[no_mangle]
unsafe extern "C" fn tiocgwinsz(tty: *mut tty_struct, arg: *mut winsize __user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_do_resize(tty: *mut tty_struct, ws: *mut winsize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tiocswinsz(tty: *mut tty_struct, arg: *mut winsize __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tioccons(file: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tiocsetd(tty: *mut tty_struct, p: *mut int __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tiocgetd(tty: *mut tty_struct, p: *mut int __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn send_break(tty: *mut tty_struct, duration: c_uint) -> c_int {
    static int send_break(struct tty_struct *tty, unsigned int duration)
    {
    int retval;
    if (tty.ops.break_ctl == core::ptr::null_mut())
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_get_tiocm(tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty_tiocmget(tty: *mut tty_struct, p: *mut int __user) -> c_int {
...
//
    ...
    if (tty.ops.tiocmset == core::ptr::null_mut())
    return -ENOTTY;
...
#[no_mangle]
unsafe extern "C" fn tty_tiocgicount(tty: *mut tty_struct, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tty_set_serial(tty: *mut tty_struct, ss: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tty_tiocsserial(tty: *mut tty_struct, ss: *mut serial___user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tty_tiocgserial(tty: *mut tty_struct, ss: *mut serial___user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
    ...
    case TIOCGEXCL:
    {
    let mut excl: c_int = test_bit(TTY_EXCLUSIVE, &tty.flags);
    ...
    case TIOCGDEV:
    {
    let mut ret: c_uint = new_encode_dev(tty_devnum(real_tty));
...
// flush tty buffer and allow ldisc to process ioctl
    tty_buffer_flush(tty, core::ptr::null_mut());
    break;
    }
    break;
    case TIOCSSERIAL:
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serial_struct32 {
    pub type: compat_int_t,
    pub line: compat_int_t,
    pub port: compat_uint_t,
    pub irq: compat_int_t,
    pub flags: compat_int_t,
    pub xmit_fifo_size: compat_int_t,
    pub custom_divisor: compat_int_t,
    pub baud_base: compat_int_t,
    pub close_delay: c_ushort,
    pub io_type: c_char,
    pub reserved_char: c_char,
    pub hub6: compat_int_t,
...
// compat_ulong_t  iomap_base FIXME
    ...
    struct tty_struct *tty = file_tty(file);
    struct tty_ldisc *ld;
    let mut retval: c_int = -ENOIOCTLCMD;
    switch (cmd) {
    case TIOCOUTQ:
    case TIOCSTI:
    case TIOCGWINSZ:
...
#[no_mangle]
unsafe extern "C" fn this_tty(t: *const c_void, file: *mut file, fd: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __do_SAK(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn do_SAK_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn do_SAK(tty: *mut tty_struct) {
...
// Must put_device() after it's unused!
    ...
    {
    let mut devt: dev_t = tty_devnum(tty);
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_put_char(tty: *mut tty_struct, ch: u8) -> c_int {
...
// init here, since reused cdevs cause crashes
    ...
    driver.cdevs[index] = core::ptr::null_mut();
    }
    return err;
    }
//
...
//
    ...
    {
    return tty_register_device_attr(driver, index, device, core::ptr::null_mut(), core::ptr::null_mut());
    }
    EXPORT_SYMBOL(tty_register_device);
#[no_mangle]
unsafe extern "C" fn tty_device_create_release(dev: *mut device) {
...
//
    ...
    {
    char name[64];
    let mut devt: dev_t = MKDEV(driver.major, driver.minor_start) + index;
    struct ktermios *tp;
    struct device *dev;
    int retval;
    if (index >= driver.num) {
...
//
    ...
    if (tp) {
    driver.termios[index] = core::ptr::null_mut();
    kfree(tp);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_unregister_device(driver: *mut tty_driver, index: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn destruct_tty_driver(kref: *mut kref) {
    ...
    tp = driver.termios[i];
    if (tp) {
    driver.termios[i] = core::ptr::null_mut();
    kfree(tp);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_driver_kref_put(driver: *mut tty_driver) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_register_driver(driver: *mut tty_driver) -> c_int {
...
//
    ...
    if (!(driver.flags & TTY_DRIVER_DYNAMIC_DEV)) {
    for (i = 0; i < driver.num; i++) {
    d = tty_register_device(driver, i, core::ptr::null_mut());
    if (IS_ERR(d)) {
    error = PTR_ERR(d);
    goto err_unreg_devs;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_unregister_driver(driver: *mut tty_driver) {
...
#[no_mangle]
pub unsafe extern "C" fn tty_devnum(tty: *mut tty_struct) -> dev_t {
...
#[no_mangle]
pub unsafe extern "C" fn tty_default_fops(fops: *mut file_operations) {
...
#[no_mangle]
unsafe extern "C" fn tty_class_init() -> int __init {
...
//
    console_lock();
    while (i--) {
    let mut index: c_int = cs[i].index;
...
// don't resolve tty0 as some programs depend on it
    ...
    static DEVICE_ATTR(active, S_IRUGO, show_cons_active, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn console_sysfs_notify() {
    void console_sysfs_notify(void)
    {
    if (consdev)
    sysfs_notify(&consdev.kobj, core::ptr::null_mut(), "active");
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_init() -> int __init {
    ...
    device_create(&tty_class, core::ptr::null_mut(), MKDEV(TTYAUX_MAJOR, 0), core::ptr::null_mut(), "tty");
    cdev_init(&console_cdev, &console_fops);
    if (cdev_add(&console_cdev, MKDEV(TTYAUX_MAJOR, 1), 1) ||
    register_chrdev_region(MKDEV(TTYAUX_MAJOR, 1), 1, "/dev/console") < 0)
    panic("Couldn't register /dev/console driver\n");
    consdev = device_create_with_groups(&tty_class, core::ptr::null_mut(),
    MKDEV(TTYAUX_MAJOR, 1), core::ptr::null_mut(),
    cons_dev_groups, "console");
    if (IS_ERR(consdev))
    consdev = core::ptr::null_mut();
