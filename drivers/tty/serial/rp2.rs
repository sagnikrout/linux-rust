...
//! Source: drivers/tty/serial/rp2.c
#![no_std]
...
pub const RP2_UCODE_BYTES: c_uint = 0x3f;
pub const PORTS_PER_ASIC: c_int = 16;

pub const UART_CLOCK: c_int = 44236800;

pub const FIFO_SIZE: c_int = 512;
// BAR0 registers
pub const RP2_FPGA_CTL0: c_uint = 0x110;
pub const RP2_FPGA_CTL1: c_uint = 0x11c;
pub const RP2_IRQ_MASK: c_uint = 0x1ec;

pub const RP2_IRQ_STATUS: c_uint = 0x1f0;
// BAR1 registers
pub const RP2_ASIC_SPACING: c_uint = 0x1000;

pub const RP2_PORT_BASE: c_uint = 0x000;
pub const RP2_PORT_SPACING: c_uint = 0x040;
pub const RP2_UCODE_BASE: c_uint = 0x400;
pub const RP2_UCODE_SPACING: c_uint = 0x80;
pub const RP2_CLK_PRESCALER: c_uint = 0xc00;
pub const RP2_CH_IRQ_STAT: c_uint = 0xc04;
pub const RP2_CH_IRQ_MASK: c_uint = 0xc08;
pub const RP2_ASIC_IRQ: c_uint = 0xd00;

pub const RP2_GLOBAL_CMD: c_uint = 0xd0c;
pub const RP2_ASIC_CFG: c_uint = 0xd04;
// port registers
pub const RP2_DATA_DWORD: c_uint = 0x000;
pub const RP2_DATA_BYTE: c_uint = 0x008;
...
pub const RP2_RX_FIFO_COUNT: c_uint = 0x00c;
pub const RP2_TX_FIFO_COUNT: c_uint = 0x00e;
pub const RP2_CHAN_STAT: c_uint = 0x010;

    RP2_CHAN_STAT_CTS_CHANGED_m | \
    RP2_CHAN_STAT_CD_CHANGED_m | \
    RP2_CHAN_STAT_RI_CHANGED_m)
pub const RP2_TXRX_CTL: c_uint = 0x014;

pub const RP2_TXRX_CTL_RX_TRIG_s: c_int = 3;

pub const RP2_TXRX_CTL_TX_TRIG_s: c_int = 16;

pub const RP2_UART_CTL: c_uint = 0x018;
pub const RP2_UART_CTL_MODE_s: c_int = 0;

pub const RP2_UART_CTL_DATABITS_s: c_int = 8;

pub const RP2_BAUD: c_uint = 0x01c;
// ucode registers
pub const RP2_TX_SWFLOW: c_uint = 0x02;
pub const RP2_TX_SWFLOW_ena: c_uint = 0x81;
pub const RP2_TX_SWFLOW_dis: c_uint = 0x9d;
pub const RP2_RX_SWFLOW: c_uint = 0x0c;
pub const RP2_RX_SWFLOW_ena: c_uint = 0x81;
pub const RP2_RX_SWFLOW_dis: c_uint = 0x8d;
pub const RP2_RX_FIFO: c_uint = 0x37;
pub const RP2_RX_FIFO_ena: c_uint = 0x08;
pub const RP2_RX_FIFO_dis: c_uint = 0x81;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rp2_uart_port {
    pub port: uart_port,
    pub idx: c_int,
    pub card: *mut rp2_card,
    pub asic_base: *mut void __iomem,
    pub base: *mut void __iomem,
    pub ucode: *mut void __iomem,
}
...
pub struct rp2_card {
    ...
    pub ports: *mut rp2_uart_port,
    pub n_ports: c_int,
    pub initialized_ports: c_int,
    pub minor_start: c_int,
    pub smpte: c_int,
    pub bar0: *mut void __iomem,
    pub bar1: *mut void __iomem,
    pub card_lock: spinlock_t,
}
...
#[no_mangle]
unsafe extern "C" fn rp2_alloc_ports(n_ports: c_int) -> c_int {
...
// sorry, no support for hot unplugging individual cards
    ...
    {
    let mut tmp: u32 = readl(up.base + reg);
    tmp &= ~clr_bits;
    tmp |= set_bits;
    writel(tmp, up.base + reg);
    }
#[no_mangle]
unsafe extern "C" fn rp2_rmw_clr(up: *mut rp2_uart_port, reg: c_int, val: u32) {
    static void rp2_rmw_clr(struct rp2_uart_port *up, int reg, u32 val)
    {
    rp2_rmw(up, reg, val, 0);
    }
#[no_mangle]
unsafe extern "C" fn rp2_rmw_set(up: *mut rp2_uart_port, reg: c_int, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_enable_ms(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn rp2_rx_chars(up: *mut rp2_uart_port) {
    static void rp2_rx_chars(struct rp2_uart_port *up)
    {
    let mut bytes: u16 = readw(up.base + RP2_RX_FIFO_COUNT);
    struct tty_port *port = &up.port.state.port;
    for (; bytes != 0; bytes--) {
    let mut byte: u32 = readw(up.base + RP2_DATA_BYTE) | RP2_DUMMY_READ;
    let mut ch: u8 = byte & 0xff;
    ...
    flag = TTY_BREAK;
#[no_mangle]
pub unsafe extern "C" fn if(RP2_DATA_BYTE_ERR_FRAMING_m: byte &) -> else {
    else if (byte & RP2_DATA_BYTE_ERR_FRAMING_m)
    flag = TTY_FRAME;
#[no_mangle]
pub unsafe extern "C" fn if(RP2_DATA_BYTE_ERR_PARITY_m: byte &) -> else {
...
#[no_mangle]
unsafe extern "C" fn rp2_tx_chars(up: *mut rp2_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn rp2_ch_interrupt(up: *mut rp2_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn rp2_asic_interrupt(card: *mut rp2_card, asic_id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn rp2_flush_fifos(up: *mut rp2_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_shutdown(port: *mut uart_port) {
    ...
    {
    return (port.type == PORT_RP2) ? "RocketPort 2 UART" : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn rp2_uart_release_port(port: *mut uart_port) {
    static void rp2_uart_release_port(struct uart_port *port)
    {
// Nothing to release ...
    }
#[no_mangle]
unsafe extern "C" fn rp2_uart_request_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rp2_reset_asic(card: *mut rp2_card, asic_id: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rp2_init_card(card: *mut rp2_card) {
...
#[no_mangle]
unsafe extern "C" fn rp2_init_port(up: *mut rp2_uart_port, fw: *const firmware) {
...
#[no_mangle]
unsafe extern "C" fn rp2_remove_ports(card: *mut rp2_card) {
...
#[no_mangle]
unsafe extern "C" fn rp2_load_firmware(card: *mut rp2_card, fw: *const firmware) -> c_int {
    ...
    struct uart_port *p;
    let mut j: c_int = (unsigned)i % PORTS_PER_ASIC;
...
#[no_mangle]
unsafe extern "C" fn rp2_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rp2_uart_exit() -> void __exit {
