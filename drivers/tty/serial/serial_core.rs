...
//! Source: drivers/tty/serial/serial_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn uart_dcd_enabled(uport: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uart_port_deref(uport: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn uart_port_unlock_deref(uport: *mut uart_port, flags: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_write_wakeup(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn uart_stop(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn __uart_start(state: *mut uart_state) {
...
#[no_mangle]
unsafe extern "C" fn uart_start(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn uart_port_dtr_rts(uport: *mut uart_port, active: bool) {
...
#[no_mangle]
unsafe extern "C" fn uart_alloc_xmit_buf(port: *mut tty_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_free_xmit_buf(port: *mut tty_port) {
...
//
    ...
    port.xmit_buf = core::ptr::null_mut();
...
//
    uart_change_line_settings(tty, state, core::ptr::null_mut());
//
...
//
#[no_mangle]
unsafe extern "C" fn uart_shutdown(tty: *mut tty_struct, state: *mut uart_state) {
...
//
    ...
    unsigned int baud)
    {
    let mut temp: u64 = tty_get_frame_size(cflag);
    temp *= NSEC_PER_SEC;
...
//
    ...
    let mut flags: upf_t = port.flags & UPF_SPD_MASK;
    switch (flags) {
    case UPF_SPD_HI:
    altbaud = 57600;
    break;
...
#[no_mangle]
unsafe extern "C" fn uart_put_char(tty: *mut tty_struct, c: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_flush_chars(tty: *mut tty_struct) {
    static void uart_flush_chars(struct tty_struct *tty)
    {
    uart_start(tty);
    }
#[no_mangle]
unsafe extern "C" fn uart_write(tty: *mut tty_struct, buf: *const u8, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn uart_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn uart_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn uart_flush_buffer(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_xchar_out(uport: *mut uart_port, offset: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn uart_send_xchar(tty: *mut tty_struct, ch: u8) {
...
#[no_mangle]
unsafe extern "C" fn uart_throttle(tty: *mut tty_struct) {
    static void uart_throttle(struct tty_struct *tty)
    {
    struct uart_state *state = tty.driver_data;
    let mut mask: upstat_t = UPSTAT_SYNC_FIFO;
    struct uart_port *port;
    port = uart_port_ref(state);
    if (!port)
    return;
...
#[no_mangle]
unsafe extern "C" fn uart_unthrottle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn uart_get_info(port: *mut tty_port, retinfo: *mut serial_struct) -> c_int {
...
//
    ...
    new_flags = ( upf_t)new_info.flags;
    old_custom_divisor = uport.custom_divisor;
    if (!(uport.flags & UPF_FIXED_PORT)) {
    let mut uartclk: c_uint = new_info.baud_base * 16;
...
#[no_mangle]
unsafe extern "C" fn uart_set_info_user(tty: *mut tty_struct, ss: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_tiocmget(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_break_ctl(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_do_autoconfig(tty: *mut tty_struct, state: *mut uart_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_enable_ms(uport: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn uart_wait_modem_status(state: *mut uart_state, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_check_rs485_flags(port: *mut uart_port, rs485: *mut serial_rs485) -> c_int {
    static int uart_check_rs485_flags(struct uart_port *port, struct serial_rs485 *rs485)
    {
    let mut flags: u32 = rs485.flags;
...
#[no_mangle]
unsafe extern "C" fn uart_sanitize_serial_rs485(port: *mut uart_port, rs485: *mut serial_rs485) {
    static void uart_sanitize_serial_rs485(struct uart_port *port, struct serial_rs485 *rs485)
    {
    let mut supported_flags: u32 = port.rs485_supported.flags;
...
#[no_mangle]
unsafe extern "C" fn uart_rs485_config(port: *mut uart_port) -> c_int {
    ...
    ret = port.rs485_config(port, core::ptr::null_mut(), rs485);
    if (ret) {
    memset(rs485, 0, sizeof(*rs485));
// unset GPIOs
...
//
    ...
    return -EINVAL;
    scoped_guard(uart_port_lock_irqsave, port) {
    let mut ret: c_int = port.iso7816_config(port, &iso7816);
    if (ret)
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn uart_set_ldisc(tty: *mut tty_struct) {
    ...
    let mut iflag_mask: c_uint = IGNBRK|BRKINT|IGNPAR|PARMRK|INPCK;
    let mut sw_changed: bool = false;
    guard(mutex)(&state.port.mutex);
    uport = uart_port_check(state);
    if (!uport)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn if(B0): ((old_termios->c_cflag & CBAUD) == B0) && ((cflag & CBAUD) !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn uart_close(tty: *mut tty_struct, filp: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn uart_tty_port_shutdown(port: *mut tty_port) {
...
#[no_mangle]
unsafe extern "C" fn uart_wait_until_sent(tty: *mut tty_struct, timeout: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn uart_hangup(tty: *mut tty_struct) {
    ...
    tty_port_tty_set(port, core::ptr::null_mut());
...
// uport == NULL if uart_port has already been removed
#[no_mangle]
unsafe extern "C" fn uart_port_shutdown(port: *mut tty_port) {
    static void uart_port_shutdown(struct tty_port *port)
    {
    struct uart_state *state = container_of(port, struct uart_state, port);
    struct uart_port *uport = uart_port_check(state);
...
#[no_mangle]
unsafe extern "C" fn uart_carrier_raised(port: *mut tty_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn uart_dtr_rts(port: *mut tty_port, active: bool) {
...
#[no_mangle]
unsafe extern "C" fn uart_install(driver: *mut tty_driver, tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uart_open(tty: *mut tty_struct, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_port_activate(port: *mut tty_port, tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uart_iotype_mmio(iotype: enum uart_iotype) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn uart_iotype_io(iotype: enum uart_iotype) -> bool {
...
#[no_mangle]
unsafe extern "C" fn uart_line_info(m: *mut seq_file, state: *mut uart_state) {
...
#[no_mangle]
unsafe extern "C" fn uart_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_port_spin_lock_init(port: *mut uart_port) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uart_match {
    pub port: *mut uart_port,
    pub driver: *mut uart_driver,
}

#[no_mangle]
unsafe extern "C" fn serial_match_port(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uart_suspend_port(drv: *mut uart_driver, uport: *mut uart_port) -> c_int {
    int uart_suspend_port(struct uart_driver *drv, struct uart_port *uport)
    {
    struct uart_state *state = drv.state + uport.line;
    struct tty_port *port = &state.port;
    struct device *tty_dev;
    let mut match: uart_match = {uport, drv};
    guard(mutex)(&port.mutex);
...
#[no_mangle]
pub unsafe extern "C" fn uart_resume_port(drv: *mut uart_driver, uport: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uart_get_ioinfos(port: *mut uart_port, buf: *mut c_char, size: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn if(UPIO_HUB6: port->iotype ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn uart_poll_init(driver: *mut tty_driver, line: c_int, options: *mut c_char) -> c_int {
...
//
    ...
    console_list_lock();
    ret = uart_set_options(port, core::ptr::null_mut(), baud, parity, bits, flow);
    console_list_unlock();
    }
    if (ret)
    uart_change_pm(state, pm_state);
...
#[no_mangle]
unsafe extern "C" fn uart_poll_get_char(driver: *mut tty_driver, line: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_poll_put_char(driver: *mut tty_driver, line: c_int, ch: c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_register_driver(drv: *mut uart_driver) -> c_int {
...
//
    ...
    drv.tty_driver = core::ptr::null_mut();
    out_kfree:
    kfree(drv.state);
    drv.state = core::ptr::null_mut();
    out:
    return retval;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_unregister_driver(drv: *mut uart_driver) {
...
//
#[no_mangle]
unsafe extern "C" fn serial_core_add_one_port(drv: *mut uart_driver, uport: *mut uart_port) -> c_int {
...
//
    uport.type = PORT_UNKNOWN;
    uport.port_dev = core::ptr::null_mut();
    guard(mutex)(&port.mutex);
    WARN_ON(atomic_dec_return(&state.refcount) < 0);
    wait_event(state.remove_wait, !atomic_read(&state.refcount));
    state.uart_port = core::ptr::null_mut();
    }
//
...
//
    ...
    return false;
#[no_mangle]
pub unsafe extern "C" fn if(UPIO_PORT: port1->iotype ==) -> else {
    else if (port1.iotype == UPIO_PORT)
    return port1.iobase == port2.iobase;
#[no_mangle]
pub unsafe extern "C" fn if(UPIO_HUB6: port1->iotype ==) -> else {
    else if (port1.iotype == UPIO_HUB6)
    return hub6_match_port(port1, port2);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: uart_iotype_mmio(port1->iotype)) -> else {
    else if (uart_iotype_mmio(port1.iotype))
    return port1.mapbase == port2.mapbase;
#[no_mangle]
pub unsafe extern "C" fn if(UPIO_BUS: port1->iotype ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial_core_register_port(drv: *mut uart_driver, port: *mut uart_port) -> c_int {
    int serial_core_register_port(struct uart_driver *drv, struct uart_port *port)
    {
    struct serial_ctrl_device *ctrl_dev, *new_ctrl_dev = core::ptr::null_mut();
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn serial_core_unregister_port(drv: *mut uart_driver, port: *mut uart_port) {
    void serial_core_unregister_port(struct uart_driver *drv, struct uart_port *port)
    {
    struct device *phys_dev = port.dev;
    struct serial_port_device *port_dev = port.port_dev;
    struct serial_ctrl_device *ctrl_dev = serial_core_get_ctrl_dev(port_dev);
    let mut ctrl_id: c_int = port.ctrl_id;
    guard(mutex)(&port_mutex);
    port.flags |= UPF_DEAD;
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_handle_dcd_change(uport: *mut uart_port, active: bool) {
    ...
    wake_up_interruptible(&port.open_wait);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tty) -> else {
    else if (tty)
    tty_hangup(tty);
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_handle_cts_change(uport: *mut uart_port, active: bool) {
...
#[no_mangle]
unsafe extern "C" fn uart_sysrq_on(w: *mut work_struct) {
    static void uart_sysrq_on(struct work_struct *w)
    {
    let mut sysrq_toggle_seq_len: c_int = strlen(sysrq_toggle_seq);
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_try_toggle_sysrq(port: *mut uart_port, ch: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_get_rs485_mode(port: *mut uart_port) -> c_int {
