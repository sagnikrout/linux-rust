...
//! Source: drivers/tty/serial/mpc52xx_uart.c
#![no_std]
...
pub const SERIAL_PSC_MAJOR: c_int = 204;
pub const SERIAL_PSC_MINOR: c_int = 148;
...
#[derive(Copy, Clone)]
pub struct psc_ops {
    pub port): *mut *mut void (fifo_init)(struct uart_port,
    pub port): *mut *mut unsigned int (raw_rx_rdy)(struct uart_port,
    pub port): *mut *mut unsigned int (raw_tx_rdy)(struct uart_port,
    pub port): *mut *mut unsigned int (rx_rdy)(struct uart_port,
    pub port): *mut *mut unsigned int (tx_rdy)(struct uart_port,
    pub port): *mut *mut unsigned int (tx_empty)(struct uart_port,
    pub port): *mut *mut void (stop_rx)(struct uart_port,
    pub port): *mut *mut void (start_tx)(struct uart_port,
    pub port): *mut *mut void (stop_tx)(struct uart_port,
    pub port): *mut *mut void (rx_clr_irq)(struct uart_port,
    pub port): *mut *mut void (tx_clr_irq)(struct uart_port,
    pub c): *mut *mut *mut void (write_char)(struct uart_port port, unsigned char,
    pub port): *mut *mut unsigned char (read_char)(struct uart_port,
    pub port): *mut *mut void (cw_disable_ints)(struct uart_port,
    pub port): *mut *mut void (cw_restore_ints)(struct uart_port,
    unsigned int	(*set_baudrate)(struct uart_port *port,
    struct ktermios *new,
    pub old): *const ktermios,
    pub port): *mut *mut int (clock_alloc)(struct uart_port,
    pub port): *mut *mut void (clock_relse)(struct uart_port,
    pub enable): *mut *mut *mut int (clock)(struct uart_port port, int,
    pub (*fifoc_init)(void): *mut c_int,
    pub (*fifoc_uninit)(void): *mut c_void,
    pub ): *mut *mut *mut void (get_irq)(struct uart_port , struct device_node,
    pub port): *mut *mut irqreturn_t (handle_irq)(struct uart_port,
    pub port): *mut *mut u16 (get_status)(struct uart_port,
    pub port): *mut *mut u8 (get_ipcr)(struct uart_port,
    pub cmd): *mut *mut *mut void (command)(struct uart_port port, u8,
    pub mr2): *mut *mut *mut void (set_mode)(struct uart_port port, u8 mr1, u8,
    pub state): *mut *mut *mut void (set_rts)(struct uart_port port, int,
    pub port): *mut *mut void (enable_ms)(struct uart_port,
    pub val): *mut *mut *mut void (set_sicr)(struct uart_port port, u32,
    pub val): *mut *mut *mut void (set_imr)(struct uart_port port, u16,
    pub port): *mut *mut u8 (get_mr1)(struct uart_port,
}
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_get_status(port: *mut uart_port) -> u16 {
    static u16 mpc52xx_psc_get_status(struct uart_port *port)
    {
    return in_be16(&PSC(port).mpc52xx_psc_status);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_get_ipcr(port: *mut uart_port) -> u8 {
    static u8 mpc52xx_psc_get_ipcr(struct uart_port *port)
    {
    return in_8(&PSC(port).mpc52xx_psc_ipcr);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_command(port: *mut uart_port, cmd: u8) {
    static void mpc52xx_psc_command(struct uart_port *port, u8 cmd)
    {
    out_8(&PSC(port).command, cmd);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_set_mode(port: *mut uart_port, mr1: u8, mr2: u8) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_set_rts(port: *mut uart_port, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_enable_ms(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_set_sicr(port: *mut uart_port, val: u32) {
    static void mpc52xx_psc_set_sicr(struct uart_port *port, u32 val)
    {
    out_be32(&PSC(port).sicr, val);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_set_imr(port: *mut uart_port, val: u16) {
    static void mpc52xx_psc_set_imr(struct uart_port *port, u16 val)
    {
    out_be16(&PSC(port).mpc52xx_psc_imr, val);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_get_mr1(port: *mut uart_port) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_fifo_init(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_raw_rx_rdy(port: *mut uart_port) -> c_uint {
    static unsigned int mpc52xx_psc_raw_rx_rdy(struct uart_port *port)
    {
#[no_mangle]
pub unsafe extern "C" fn in_be16(_arg: &PSC(port)->mpc52xx_psc_status) -> return {
    return in_be16(&PSC(port).mpc52xx_psc_status)
    & MPC52xx_PSC_SR_RXRDY;
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_raw_tx_rdy(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_rx_rdy(port: *mut uart_port) -> c_uint {
    static unsigned int mpc52xx_psc_rx_rdy(struct uart_port *port)
    {
#[no_mangle]
pub unsafe extern "C" fn in_be16(_arg: &PSC(port)->mpc52xx_psc_isr) -> return {
    return in_be16(&PSC(port).mpc52xx_psc_isr)
    & port.read_status_mask
    & MPC52xx_PSC_IMR_RXRDY;
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_tx_rdy(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_tx_empty(port: *mut uart_port) -> c_uint {
    static unsigned int mpc52xx_psc_tx_empty(struct uart_port *port)
    {
    let mut sts: u16 = in_be16(&PSC(port).mpc52xx_psc_status);
    return (sts & MPC52xx_PSC_SR_TXEMP) ? TIOCSER_TEMT : 0;
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_rx_clr_irq(port: *mut uart_port) {
    static void mpc52xx_psc_rx_clr_irq(struct uart_port *port)
    {
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_tx_clr_irq(port: *mut uart_port) {
    static void mpc52xx_psc_tx_clr_irq(struct uart_port *port)
    {
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_write_char(port: *mut uart_port, c: c_uchar) {
    static void mpc52xx_psc_write_char(struct uart_port *port, unsigned char c)
    {
    out_8(&PSC(port).mpc52xx_psc_buffer_8, c);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_read_char(port: *mut uart_port) -> c_uchar {
    static unsigned char mpc52xx_psc_read_char(struct uart_port *port)
    {
    return in_8(&PSC(port).mpc52xx_psc_buffer_8);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_cw_disable_ints(port: *mut uart_port) {
    static void mpc52xx_psc_cw_disable_ints(struct uart_port *port)
    {
    out_be16(&PSC(port).mpc52xx_psc_imr, 0);
    }
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_cw_restore_ints(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_get_irq(port: *mut uart_port, np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_psc_handle_irq(port: *mut uart_port) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_fifo_init(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_raw_rx_rdy(port: *mut uart_port) -> c_uint {
    static unsigned int mpc512x_psc_raw_rx_rdy(struct uart_port *port)
    {
    return !(in_be32(&FIFO_512x(port).rxsr) & MPC512x_PSC_FIFO_EMPTY);
    }
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_raw_tx_rdy(port: *mut uart_port) -> c_uint {
    static unsigned int mpc512x_psc_raw_tx_rdy(struct uart_port *port)
    {
    return !(in_be32(&FIFO_512x(port).txsr) & MPC512x_PSC_FIFO_FULL);
    }
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_rx_rdy(port: *mut uart_port) -> c_uint {
    static unsigned int mpc512x_psc_rx_rdy(struct uart_port *port)
    {
#[no_mangle]
pub unsafe extern "C" fn in_be32(_arg: &FIFO_512x(port)->rxsr) -> return {
    return in_be32(&FIFO_512x(port).rxsr)
    & in_be32(&FIFO_512x(port).rximr)
    & MPC512x_PSC_FIFO_ALARM;
    }
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_tx_rdy(port: *mut uart_port) -> c_uint {
    static unsigned int mpc512x_psc_tx_rdy(struct uart_port *port)
    {
#[no_mangle]
pub unsafe extern "C" fn in_be32(_arg: &FIFO_512x(port)->txsr) -> return {
    return in_be32(&FIFO_512x(port).txsr)
    & in_be32(&FIFO_512x(port).tximr)
    & MPC512x_PSC_FIFO_ALARM;
    }
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_rx_clr_irq(port: *mut uart_port) {
    static void mpc512x_psc_rx_clr_irq(struct uart_port *port)
    {
    out_be32(&FIFO_512x(port).rxisr, in_be32(&FIFO_512x(port).rxisr));
    }
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_tx_clr_irq(port: *mut uart_port) {
    static void mpc512x_psc_tx_clr_irq(struct uart_port *port)
    {
    out_be32(&FIFO_512x(port).txisr, in_be32(&FIFO_512x(port).txisr));
    }
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_write_char(port: *mut uart_port, c: c_uchar) {
    static void mpc512x_psc_write_char(struct uart_port *port, unsigned char c)
    {
    out_8(&FIFO_512x(port).txdata_8, c);
    }
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_read_char(port: *mut uart_port) -> c_uchar {
    static unsigned char mpc512x_psc_read_char(struct uart_port *port)
    {
    return in_8(&FIFO_512x(port).rxdata_8);
    }
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_cw_disable_ints(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_cw_restore_ints(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_fifoc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_fifoc_uninit() -> void __exit {
...
// disable the clock, errors are not fatal
    ...
    clk_disable_unprepare(psc_fifoc_clk);
    clk_put(psc_fifoc_clk);
    psc_fifoc_clk = core::ptr::null_mut();
    }
    }
// 512x specific interrupt handler. The caller holds the port lock
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_handle_irq(port: *mut uart_port) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_alloc_clock(port: *mut uart_port) -> c_int {
    ...
    psc_mclk_clk[psc_num] = core::ptr::null_mut();
    }
    if (psc_ipg_clk[psc_num]) {
    clk_disable_unprepare(psc_ipg_clk[psc_num]);
    psc_ipg_clk[psc_num] = core::ptr::null_mut();
    }
    return err;
    }
// called from within the .release_port() callback (release)
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_relse_clock(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_endis_clock(port: *mut uart_port, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpc512x_psc_get_irq(port: *mut uart_port, np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_fifo_init(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_raw_rx_rdy(port: *mut uart_port) -> c_uint {
    static unsigned int mpc5125_psc_raw_rx_rdy(struct uart_port *port)
    {
    return !(in_be32(&FIFO_5125(port).rxsr) & MPC512x_PSC_FIFO_EMPTY);
    }
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_raw_tx_rdy(port: *mut uart_port) -> c_uint {
    static unsigned int mpc5125_psc_raw_tx_rdy(struct uart_port *port)
    {
    return !(in_be32(&FIFO_5125(port).txsr) & MPC512x_PSC_FIFO_FULL);
    }
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_rx_rdy(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_tx_rdy(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_tx_empty(port: *mut uart_port) -> c_uint {
    static unsigned int mpc5125_psc_tx_empty(struct uart_port *port)
    {
    return in_be32(&FIFO_5125(port).txsr) & MPC512x_PSC_FIFO_EMPTY;
    }
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_cw_restore_ints(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_set_rts(port: *mut uart_port, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mpc5125_psc_enable_ms(port: *mut uart_port) {
...
// ========================================================================
    ...
    {
    let mut ret: c_uint = TIOCM_DSR;
    let mut status: u8 = psc_ops.get_ipcr(port);
...
//
    return port.type == PORT_MPC52xx ? "MPC5xxx PSC" : core::ptr::null_mut();
    }
    static void
...
// remapped by us ?
    ...
    "mpc52xx_psc_uart") != core::ptr::null_mut() ? 0 : -EBUSY;
    if (err)
    goto out_membase;
...
#[no_mangle]
pub unsafe extern "C" fn if(MPC52xx_PSC_SR_FE: status &) -> else {
    flag = TTY_FRAME;
    port.icount.frame++;
    }
...
//
    ...
    {
    let mut pass: c_ulong = ISR_PASS_LIMIT;
    bool keepgoing;
    u8 status;
...
// Restore interrupt state
    ...
    struct resource res;
    int ret;
    let mut baud: c_int = CONFIG_SERIAL_MPC52xx_CONSOLE_BAUD;
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_uart_of_probe(op: *mut platform_device) -> c_int {
    static int mpc52xx_uart_of_probe(struct platform_device *op)
    {
    let mut idx: c_int = -1;
    unsigned int uartclk;
    struct uart_port *port = core::ptr::null_mut();
    struct resource res;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mpc52xx_uart_of_remove(op: *mut platform_device) {
...
// Find the first free PSC number
    ...
    if (mpc52xx_uart_nodes[i] == core::ptr::null_mut()) {
    of_node_get(np);
