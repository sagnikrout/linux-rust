...
//! Source: drivers/tty/serial/mxs-auart.c
#![no_std]
...
pub const MXS_AUART_PORTS: c_int = 5;
pub const MXS_AUART_FIFO_SIZE: c_int = 16;
pub const SET_REG: c_uint = 0x4;
pub const CLR_REG: c_uint = 0x8;
pub const TOG_REG: c_uint = 0xc;
pub const AUART_CTRL0: c_uint = 0x00000000;
pub const AUART_CTRL1: c_uint = 0x00000010;
pub const AUART_CTRL2: c_uint = 0x00000020;
pub const AUART_LINECTRL: c_uint = 0x00000030;
pub const AUART_LINECTRL2: c_uint = 0x00000040;
pub const AUART_INTR: c_uint = 0x00000050;
pub const AUART_DATA: c_uint = 0x00000060;
pub const AUART_STAT: c_uint = 0x00000070;
pub const AUART_DEBUG: c_uint = 0x00000080;
pub const AUART_VERSION: c_uint = 0x00000090;
pub const AUART_AUTOBAUD: c_uint = 0x000000a0;

pub const AUART_LINECTRL_BAUD_DIV_MAX: c_uint = 0x003fffc0;
pub const AUART_LINECTRL_BAUD_DIV_MIN: c_uint = 0x000000ec;
pub const AUART_LINECTRL_BAUD_DIVINT_SHIFT: c_int = 16;
pub const AUART_LINECTRL_BAUD_DIVINT_MASK: c_uint = 0xffff0000;

pub const AUART_LINECTRL_BAUD_DIVFRAC_SHIFT: c_int = 8;
pub const AUART_LINECTRL_BAUD_DIVFRAC_MASK: c_uint = 0x00003f00;

pub const AUART_LINECTRL_WLEN_MASK: c_uint = 0x00000060;

pub const AUART_STAT_RXCOUNT_MASK: c_uint = 0xffff;
//
// Start of Alphascale asm9260 defines
// This list contains only differences of existing bits
// between imx2x and asm9260
//
pub const ASM9260_HW_CTRL0: c_uint = 0x0000;
//
...
pub const ASM9260_HW_LINECTRL: c_uint = 0x0030;
//
...
//
pub const ASM9260_HW_INTR: c_uint = 0x0040;
...
//
pub const ASM9260_HW_DATA: c_uint = 0x0050;
pub const ASM9260_HW_STAT: c_uint = 0x0060;
...
pub const ASM9260_HW_DEBUG: c_uint = 0x0070;
...
pub const ASM9260_HW_ILPR: c_uint = 0x0080;
pub const ASM9260_HW_RS485CTRL: c_uint = 0x0090;
//
...
pub const ASM9260_HW_RS485ADRMATCH: c_uint = 0x00a0;
// Contains the address match value.

pub const ASM9260_HW_RS485DLY: c_uint = 0x00b0;
//
// RW. Contains the direction control (RTS or DTR) delay value. This delay time
// is in periods of the baud clock.
//

pub const ASM9260_HW_AUTOBAUD: c_uint = 0x00c0;
...
pub const ASM9260_HW_CTRL3: c_uint = 0x00d0;
...
pub const ASM9260_HW_ISO7816_CTRL: c_uint = 0x00e0;
...
pub const ASM9260_HW_ISO7816_ERRCNT: c_uint = 0x00f0;
// Parity error counter. Will be cleared after reading

pub const ASM9260_HW_ISO7816_STATUS: c_uint = 0x0100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxs_auart_port {
    pub port: uart_port,
pub const MXS_AUART_DMA_ENABLED: c_uint = 0x2;

    pub flags: c_ulong,
    pub mctrl_prev: c_uint,
    pub devtype: enum mxs_auart_type,
    pub vendor: *const vendor_data,
    pub clk: *mut clk,
    pub clk_ahb: *mut clk,
    pub dev: *mut device,
// for DMA
    pub tx_sgl: scatterlist,
    pub tx_dma_chan: *mut dma_chan,
    pub tx_dma_buf: *mut c_void,
    pub rx_sgl: scatterlist,
    pub rx_dma_chan: *mut dma_chan,
    pub rx_dma_buf: *mut c_void,
    pub gpios: *mut mctrl_gpios,
    pub gpio_irq: [c_int; UART_GPIO_MAX],
    pub ms_irq_enabled: bool,
}
...
#[no_mangle]
pub unsafe extern "C" fn is_imx28_auart(s: *mut mxs_auart_port) -> c_int {
    static inline int is_imx28_auart(struct mxs_auart_port *s)
    {
    return s.devtype == IMX28_AUART;
    }
#[no_mangle]
pub unsafe extern "C" fn is_asm9260_auart(s: *mut mxs_auart_port) -> c_int {
    static inline int is_asm9260_auart(struct mxs_auart_port *s)
    {
    return s.devtype == ASM9260_AUART;
    }
#[no_mangle]
pub unsafe extern "C" fn auart_dma_enabled(s: *mut mxs_auart_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dma_tx_callback(param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_dma_tx(s: *mut mxs_auart_port, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_tx_chars(s: *mut mxs_auart_port) {
    static void mxs_auart_tx_chars(struct mxs_auart_port *s)
    {
    struct tty_port *tport = &s.port.state.port;
    bool pending;
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_rx_char(s: *mut mxs_auart_port) {
...
//
    ...
    flag = TTY_PARITY;
#[no_mangle]
pub unsafe extern "C" fn if(AUART_STAT_FERR: stat &) -> else {
    else if (stat & AUART_STAT_FERR)
    flag = TTY_FRAME;
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_rx_chars(s: *mut mxs_auart_port) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_request_port(u: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_config_port(u: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_release_port(u: *mut uart_port) {
    static void mxs_auart_release_port(struct uart_port *u)
    {
    }
#[no_mangle]
unsafe extern "C" fn mxs_auart_set_mctrl(u: *mut uart_port, mctrl: unsigned) {
    static void mxs_auart_set_mctrl(struct uart_port *u, unsigned mctrl)
    {
    struct mxs_auart_port *s = to_auart_port(u);
    let mut ctrl: u32 = mxs_read(s, REG_CTRL2);
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_modem_status(s: *mut mxs_auart_port, mctrl: u32) -> u32 {
    ...
    s.port.state != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_get_mctrl(u: *mut uart_port) -> u32 {
    static u32 mxs_auart_get_mctrl(struct uart_port *u)
    {
    struct mxs_auart_port *s = to_auart_port(u);
    let mut stat: u32 = mxs_read(s, REG_STAT);
    let mut mctrl: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn mxs_auart_enable_ms(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn mxs_auart_disable_ms(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn dma_rx_callback(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_dma_prep_rx(s: *mut mxs_auart_port) -> c_int {
    static int mxs_auart_dma_prep_rx(struct mxs_auart_port *s)
    {
    struct dma_async_tx_descriptor *desc;
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_dma_exit_channel(s: *mut mxs_auart_port) {
    static void mxs_auart_dma_exit_channel(struct mxs_auart_port *s)
    {
    if (s.tx_dma_chan) {
    dma_release_channel(s.tx_dma_chan);
    s.tx_dma_chan = core::ptr::null_mut();
    }
    if (s.rx_dma_chan) {
    dma_release_channel(s.rx_dma_chan);
    s.rx_dma_chan = core::ptr::null_mut();
    }
    kfree(s.tx_dma_buf);
    kfree(s.rx_dma_buf);
    s.tx_dma_buf = core::ptr::null_mut();
    s.rx_dma_buf = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mxs_auart_dma_exit(s: *mut mxs_auart_port) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_dma_init(s: *mut mxs_auart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_irq_handle(irq: c_int, context: *mut c_void) -> irqreturn_t {
    static irqreturn_t mxs_auart_irq_handle(int irq, void *context)
    {
    u32 istat, stat;
    struct mxs_auart_port *s = context;
    let mut mctrl_temp: u32 = s.mctrl_prev;
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_reset_deassert(s: *mut mxs_auart_port) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_reset_assert(s: *mut mxs_auart_port) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_startup(u: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_shutdown(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_tx_empty(u: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_start_tx(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_stop_tx(u: *mut uart_port) {
    static void mxs_auart_stop_tx(struct uart_port *u)
    {
    struct mxs_auart_port *s = to_auart_port(u);
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_stop_rx(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_break_ctl(u: *mut uart_port, ctl: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_console_putchar(port: *mut uart_port, ch: c_uchar) {
    static void mxs_auart_console_putchar(struct uart_port *port, unsigned char ch)
    {
    struct mxs_auart_port *s = to_auart_port(port);
    let mut to: c_uint = 1000;
...
#[no_mangle]
unsafe extern "C" fn mxs_init_regs(s: *mut mxs_auart_port) {
    ...
    int err;
    if (!is_asm9260_auart(s)) {
    s.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_init_gpios(s: *mut mxs_auart_port, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_free_gpio_irq(s: *mut mxs_auart_port) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_request_gpio_irq(s: *mut mxs_auart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_probe(pdev: *mut platform_device) -> c_int {
...
// ASM9260 don't have version reg
    ...
    auart_port[pdev.id] = core::ptr::null_mut();
    out_iounmap:
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mxs_auart_exit() -> void __exit {
