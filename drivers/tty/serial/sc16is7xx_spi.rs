...
//! Source: drivers/tty/serial/sc16is7xx_spi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sc16is7xx_spi_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc16is7xx_spi_remove(spi: *mut spi_device) {
