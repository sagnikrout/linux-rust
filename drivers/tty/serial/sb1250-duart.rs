...
//! Source: drivers/tty/serial/sb1250-duart.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const DUART_MAX_CHIP: c_int = 2;
pub const DUART_MAX_SIDE: c_int = 2;
//
// Per-port state.
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sbd_port {
    pub duart: *mut sbd_duart,
    pub port: uart_port,
    pub memctrl: *mut unsigned char __iomem,
    pub tx_stopped: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sbd_duart {
    pub sport: [sbd_port; 2],
    pub mapctrl: c_ulong,
    pub map_guard: refcount_t,
}
...
//
#[no_mangle]
unsafe extern "C" fn __read_sbdchn(sport: *mut sbd_port, reg: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn __read_sbdshr(sport: *mut sbd_port, reg: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn __write_sbdchn(sport: *mut sbd_port, reg: c_int, value: u64) {
...
#[no_mangle]
unsafe extern "C" fn __write_sbdshr(sport: *mut sbd_port, reg: c_int, value: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn __war_sbd1956(sport: *mut sbd_port) {
...
#[no_mangle]
unsafe extern "C" fn read_sbdchn(sport: *mut sbd_port, reg: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn read_sbdshr(sport: *mut sbd_port, reg: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn write_sbdchn(sport: *mut sbd_port, reg: c_int, value: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn write_sbdshr(sport: *mut sbd_port, reg: c_int, value: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sbd_receive_ready(sport: *mut sbd_port) -> c_int {
    static int sbd_receive_ready(struct sbd_port *sport)
    {
    return read_sbdchn(sport, R_DUART_STATUS) & M_DUART_RX_RDY;
    }
#[no_mangle]
unsafe extern "C" fn sbd_receive_drain(sport: *mut sbd_port) -> c_int {
    static int sbd_receive_drain(struct sbd_port *sport)
    {
    let mut loops: c_int = 10000;
    while (sbd_receive_ready(sport) && --loops)
    read_sbdchn(sport, R_DUART_RX_HOLD);
    return loops;
    }
#[no_mangle]
unsafe extern "C" fn sbd_transmit_ready(sport: *mut sbd_port) -> int __maybe_unused {
    static int __maybe_unused sbd_transmit_ready(struct sbd_port *sport)
    {
    return read_sbdchn(sport, R_DUART_STATUS) & M_DUART_TX_RDY;
    }
#[no_mangle]
unsafe extern "C" fn sbd_transmit_drain(sport: *mut sbd_port) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn sbd_transmit_empty(sport: *mut sbd_port) -> c_int {
    static int sbd_transmit_empty(struct sbd_port *sport)
    {
    return read_sbdchn(sport, R_DUART_STATUS) & M_DUART_TX_EMT;
    }
#[no_mangle]
unsafe extern "C" fn sbd_line_drain(sport: *mut sbd_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbd_tx_empty(uport: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sbd_get_mctrl(uport: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sbd_set_mctrl(uport: *mut uart_port, mctrl: c_uint) {
    static void sbd_set_mctrl(struct uart_port *uport, unsigned int mctrl)
    {
    struct sbd_port *sport = to_sport(uport);
    let mut clr: c_uint = 0, set = 0, mode2;
    if (mctrl & TIOCM_DTR)
...
#[no_mangle]
unsafe extern "C" fn sbd_stop_tx(uport: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sbd_start_tx(uport: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sbd_stop_rx(uport: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sbd_enable_ms(uport: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sbd_break_ctl(uport: *mut uart_port, break_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sbd_receive_chars(sport: *mut sbd_port) {
    ...
    icount.frame++;
#[no_mangle]
pub unsafe extern "C" fn if(M_DUART_PARITY_ERR: status &) -> else {
    ...
    flag = TTY_BREAK;
#[no_mangle]
pub unsafe extern "C" fn if(M_DUART_FRM_ERR: status &) -> else {
    else if (status & M_DUART_FRM_ERR)
    flag = TTY_FRAME;
#[no_mangle]
pub unsafe extern "C" fn if(M_DUART_PARITY_ERR: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn sbd_transmit_chars(sport: *mut sbd_port) {
...
#[no_mangle]
unsafe extern "C" fn sbd_status_handle(sport: *mut sbd_port) {
...
#[no_mangle]
unsafe extern "C" fn sbd_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sbd_startup(uport: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbd_shutdown(uport: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sbd_init_port(sport: *mut sbd_port) {
...
// There is no DUART reset feature, so just set some sane defaults.
    ...
    {
    struct sbd_port *sport = to_sport(uport);
    let mut mode1: c_uint = 0, mode2 = 0, aux = 0;
    let mut mode1mask: c_uint = 0, mode2mask = 0, auxmask = 0;
...
#[no_mangle]
unsafe extern "C" fn sbd_release_port(uport: *mut uart_port) {
    static void sbd_release_port(struct uart_port *uport)
    {
    struct sbd_port *sport = to_sport(uport);
    struct sbd_duart *duart = sport.duart;
    iounmap(sport.memctrl);
    sport.memctrl = core::ptr::null_mut();
    iounmap(uport.membase);
    uport.membase = core::ptr::null_mut();
    if(refcount_dec_and_test(&duart.map_guard))
    release_mem_region(duart.mapctrl, DUART_CHANREG_SPACING);
    release_mem_region(uport.mapbase, DUART_CHANREG_SPACING);
    }
#[no_mangle]
unsafe extern "C" fn sbd_map_port(uport: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbd_request_port(uport: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbd_config_port(uport: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sbd_verify_port(uport: *mut uart_port, ser: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbd_probe_duarts() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn sbd_console_putchar(uport: *mut uart_port, ch: c_uchar) {
    ...
    unsigned int count)
    {
    let mut chip: c_int = co.index / DUART_MAX_SIDE;
    let mut side: c_int = co.index % DUART_MAX_SIDE;
    struct sbd_port *sport = &sbd_duarts[chip].sport[side];
    struct uart_port *uport = &sport.port;
    unsigned long flags;
    unsigned int mask;
...
#[no_mangle]
unsafe extern "C" fn sbd_console_setup(co: *mut console, options: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sbd_serial_console_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sbd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sbd_exit() -> void __exit {
