...
//! Source: drivers/tty/serial/pmac_zilog.h
#![no_std]
...
//
pub const MAX_ZS_PORTS: c_int = 4;
//
// We wrap our port structure around the generic uart_port.
//
pub const NUM_ZSREGS: c_int = 17;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uart_pmac_port {
    pub port: uart_port,
    pub mate: *mut uart_pmac_port,

// macio_dev for the escc holding this port (maybe be null on
// early inited port)
//
    pub dev: *mut macio_dev,
...
// Port type as obtained from device tree (IRDA, modem, ...)
    pub port_type: c_int,
    pub curregs: [u8; NUM_ZSREGS],
    pub flags: c_uint,
pub const PMACZILOG_FLAG_IS_CONS: c_uint = 0x00000001;
pub const PMACZILOG_FLAG_IS_KGDB: c_uint = 0x00000002;
pub const PMACZILOG_FLAG_MODEM_STATUS: c_uint = 0x00000004;
pub const PMACZILOG_FLAG_IS_CHANNEL_A: c_uint = 0x00000008;
pub const PMACZILOG_FLAG_REGS_HELD: c_uint = 0x00000010;
pub const PMACZILOG_FLAG_TX_STOPPED: c_uint = 0x00000020;
pub const PMACZILOG_FLAG_TX_ACTIVE: c_uint = 0x00000040;
pub const PMACZILOG_FLAG_IS_IRDA: c_uint = 0x00000100;
pub const PMACZILOG_FLAG_IS_INTMODEM: c_uint = 0x00000200;
pub const PMACZILOG_FLAG_RSRC_REQUESTED: c_uint = 0x00000800;
pub const PMACZILOG_FLAG_IS_OPEN: c_uint = 0x00002000;
pub const PMACZILOG_FLAG_IS_EXTCLK: c_uint = 0x00008000;
pub const PMACZILOG_FLAG_BREAK: c_uint = 0x00010000;
    pub parity_mask: c_uchar,
    pub prev_status: c_uchar,
    pub control_reg: *mut volatile u8 __iomem,
    pub data_reg: *mut volatile u8 __iomem,
    pub irq_name: [c_uchar; 8],
}
...
//
extern "C" {
    pub fn readb(_arg: port->control_reg) -> return;
}
extern "C" {
    pub fn readb(_arg: port->data_reg) -> return;
}
...
pub const WT_RDY_RT: c_uint = 0x20	/* W/Req reflects recv if 1, xmit if 0 */;
pub const WT_FN_RDYFN: c_uint = 0x40	/* W/Req pin is DMA request if 1, wait if 0 */;
pub const WT_RDY_ENAB: c_uint = 0x80	/* Enable W/Req pin */;
...
pub const TxENABLE: c_uint = 0x8	/* Tx Enable */;
...
pub const ENEXREAD: c_uint = 0x40	/* Enable read of some write registers */;
...
pub const STATUS_MASK: c_uint = 0x06;
