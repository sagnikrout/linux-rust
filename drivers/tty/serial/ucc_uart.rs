...
//! Source: drivers/tty/serial/ucc_uart.c
#![no_std]
...
// this file.
//
pub const UCC_SLOW_GUMR_H_SUART: c_uint = 0x00004000      /* Soft-UART */;
//
...
//
pub const SERIAL_QE_MAJOR: c_int = 204;
pub const SERIAL_QE_MINOR: c_int = 46;
// Since we only have minor numbers 46 - 49, there is a hard limit of 4 ports
pub const UCC_MAX_UART: c_int = 4;
...
// sent over the wire.
//
pub const UCC_WAIT_CLOSING: c_int = 100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ucc_uart_pram {
    pub common: ucc_slow_pram,
    pub /: *mut *mut u8 res1[8]; / reserved,
    pub /: *mut *mut __be16 maxidl; / Maximum idle chars,
    pub /: *mut *mut __be16 idlc; / temp idle counter,
    pub /: *mut *mut __be16 brkcr; / Break count register,
    pub /: *mut *mut __be16 parec; / receive parity error counter,
    pub /: *mut *mut __be16 frmec; / receive framing error counter,
    pub /: *mut *mut __be16 nosec; / receive noise counter,
    pub /: *mut *mut __be16 brkec; / receive break condition counter,
    pub /: *mut *mut __be16 brkln; / last received break length,
    pub /: *mut *mut __be16 uaddr[2]; / UART address character 1 & 2,
    pub /: *mut *mut __be16 rtemp; / Temp storage,
    pub /: *mut *mut __be16 toseq; / Transmit out of sequence char,
    pub /: *mut *mut __be16 cchars[8]; / control characters 1-8,
    pub /: *mut *mut __be16 rccm; / receive control character mask,
    pub /: *mut *mut __be16 rccr; / receive control character register,
    pub /: *mut *mut __be16 rlbc; / receive last break character,
    pub /: *mut *mut __be16 res2; / reserved,
    pub /: *mut *mut __be32 res3; / reserved, should be cleared,
    pub /: *mut *mut u8 res4; / reserved, should be cleared,
    pub /: *mut *mut u8 res5[3]; / reserved, should be cleared,
    pub /: *mut *mut __be32 res6; / reserved, should be cleared,
    pub /: *mut *mut __be32 res7; / reserved, should be cleared,
    pub /: *mut *mut __be32 res8; / reserved, should be cleared,
    pub /: *mut *mut __be32 res9; / reserved, should be cleared,
    pub /: *mut *mut __be32 res10; / reserved, should be cleared,
    pub /: *mut *mut __be32 res11; / reserved, should be cleared,
    pub /: *mut *mut __be32 res12; / reserved, should be cleared,
    pub /: *mut *mut __be32 res13; / reserved, should be cleared,
// The rest is for Soft-UART only
    pub /: *mut *mut __be16 supsmr; / 0x90, Shadow UPSMR,
    pub /: *mut *mut __be16 res92; / 0x92, reserved, initialize to 0,
    pub /: *mut *mut __be32 rx_state; / 0x94, RX state, initialize to 0,
    pub /: *mut *mut __be32 rx_cnt; / 0x98, RX count, initialize to 0,
    pub /: *mut *mut u8 rx_length; / 0x9C, Char length, set to 1+CL+PEN+1+SL,
    pub /: *mut *mut u8 rx_bitmark; / 0x9D, reserved, initialize to 0,
    pub /: *mut *mut u8 rx_temp_dlst_qe; / 0x9E, reserved, initialize to 0,
    pub /: *mut *mut u8 res14[0xBC - 0x9F]; / reserved,
    pub /: *mut *mut __be32 dump_ptr; / 0xBC, Dump pointer,
    pub /: *mut *mut __be32 rx_frame_rem; / 0xC0, reserved, initialize to 0,
    pub /: *mut *mut u8 rx_frame_rem_size; / 0xC4, reserved, initialize to 0,
    pub /: *mut *mut u8 tx_mode; / 0xC5, mode, 0=AHDLC, 1=UART,
    pub /: *mut *mut __be16 tx_state; / 0xC6, TX state,
    pub /: *mut *mut u8 res15[0xD0 - 0xC8]; / reserved,
    pub /: *mut *mut __be32 resD0; / 0xD0, reserved, initialize to 0,
    pub /: *mut *mut u8 resD4; / 0xD4, reserved, initialize to 0,
    pub /: *mut *mut __be16 resD5; / 0xD5, reserved, initialize to 0,
// C attribute field omitted
// SUPSMR definitions, for Soft-UART only
pub const UCC_UART_SUPSMR_SL: c_uint = 0x8000;
pub const UCC_UART_SUPSMR_RPM_MASK: c_uint = 0x6000;
pub const UCC_UART_SUPSMR_RPM_ODD: c_uint = 0x0000;
pub const UCC_UART_SUPSMR_RPM_LOW: c_uint = 0x2000;
pub const UCC_UART_SUPSMR_RPM_EVEN: c_uint = 0x4000;
pub const UCC_UART_SUPSMR_RPM_HIGH: c_uint = 0x6000;
pub const UCC_UART_SUPSMR_PEN: c_uint = 0x1000;
pub const UCC_UART_SUPSMR_TPM_MASK: c_uint = 0x0C00;
pub const UCC_UART_SUPSMR_TPM_ODD: c_uint = 0x0000;
pub const UCC_UART_SUPSMR_TPM_LOW: c_uint = 0x0400;
pub const UCC_UART_SUPSMR_TPM_EVEN: c_uint = 0x0800;
pub const UCC_UART_SUPSMR_TPM_HIGH: c_uint = 0x0C00;
pub const UCC_UART_SUPSMR_FRZ: c_uint = 0x0100;
pub const UCC_UART_SUPSMR_UM_MASK: c_uint = 0x00c0;
pub const UCC_UART_SUPSMR_UM_NORMAL: c_uint = 0x0000;
pub const UCC_UART_SUPSMR_UM_MAN_MULTI: c_uint = 0x0040;
pub const UCC_UART_SUPSMR_UM_AUTO_MULTI: c_uint = 0x00c0;
pub const UCC_UART_SUPSMR_CL_MASK: c_uint = 0x0030;
pub const UCC_UART_SUPSMR_CL_8: c_uint = 0x0030;
pub const UCC_UART_SUPSMR_CL_7: c_uint = 0x0020;
pub const UCC_UART_SUPSMR_CL_6: c_uint = 0x0010;
pub const UCC_UART_SUPSMR_CL_5: c_uint = 0x0000;
pub const UCC_UART_TX_STATE_AHDLC: c_uint = 0x00;
pub const UCC_UART_TX_STATE_UART: c_uint = 0x01;
pub const UCC_UART_TX_STATE_X1: c_uint = 0x00;
pub const UCC_UART_TX_STATE_X16: c_uint = 0x80;
pub const UCC_UART_PRAM_ALIGNMENT: c_uint = 0x100;

pub const NUM_CONTROL_CHARS: c_int = 8;
// Private per-port data structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uart_qe_port {
    pub port: uart_port,
    pub uccp: *mut ucc_slow __iomem,
    pub uccup: *mut ucc_uart_pram __iomem,
    pub us_info: ucc_slow_info,
    pub us_private: *mut ucc_slow_private,
    pub np: *mut device_node,
    pub /: *mut *mut unsigned int ucc_num; / First ucc is 0, not 1,
    pub rx_nrfifos: u16,
    pub rx_fifosize: u16,
    pub tx_nrfifos: u16,
    pub tx_fifosize: u16,
    ...
    pub flags: u32,
    pub rx_bd_base: *mut qe_bd __iomem,
    pub rx_cur: *mut qe_bd __iomem,
    pub tx_bd_base: *mut qe_bd __iomem,
    pub tx_cur: *mut qe_bd __iomem,
    pub tx_buf: *mut c_uchar,
    pub rx_buf: *mut c_uchar,
    pub /: *mut *mut *mut void bd_virt; / virtual address of the BD buffers,
    pub /: *mut *mut dma_addr_t bd_dma_addr; / bus address of the BD buffers,
    pub /: *mut *mut unsigned int bd_size; / size of BD buffer space,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn cpu2qe_addr(addr: *mut c_void, qe_port: *mut uart_qe_port) -> dma_addr_t {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_tx_empty(port: *mut uart_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_get_mctrl(port: *mut uart_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_stop_tx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_tx_pump(qe_port: *mut uart_qe_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_start_tx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_stop_rx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_break_ctl(port: *mut uart_port, break_state: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_int_rx(qe_port: *mut uart_qe_port) {
...
// Handle the remaining ones
    ...
    flg = TTY_BREAK;
#[no_mangle]
pub unsafe extern "C" fn if(BD_SC_PR: status &) -> else {
    else if (status & BD_SC_PR)
    flg = TTY_PARITY;
#[no_mangle]
pub unsafe extern "C" fn if(BD_SC_FR: status &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_int(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_initbd(qe_port: *mut uart_qe_port) {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_init_ucc(qe_port: *mut uart_qe_port) {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_startup(port: *mut uart_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_shutdown(port: *mut uart_port) {
    static void qe_uart_shutdown(struct uart_port *port)
    {
    struct uart_qe_port *qe_port =
    container_of(port, struct uart_qe_port, port);
    struct ucc_slow __iomem *uccp = qe_port.uccp;
    let mut timeout: c_uint = 20;
// Disable RX and TX
...
//
    ...
    unsigned int baud;
    unsigned long flags;
    let mut upsmr: u16 = ioread16be(&uccp.upsmr);
    struct ucc_uart_pram __iomem *uccup = qe_port.uccup;
    let mut supsmr: u16 = ioread16be(&uccup.supsmr);
// byte size
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_request_port(port: *mut uart_port) -> c_int {
    ...
    void *bd_virt;
    let mut bd_dma_addr: dma_addr_t = 0;
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_config_port(port: *mut uart_port, flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn qe_uart_release_port(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn soc_info(rev_h: *mut c_uint, rev_l: *mut c_uint) -> c_uint {
    ...
    unsigned int soc;
// Find the CPU node
    np = of_find_node_by_type(core::ptr::null_mut(), "cpu");
    if (!np)
    return 0;
// Find the compatible property
    soc_string = of_get_property(np, "compatible", core::ptr::null_mut());
    if (!soc_string)
...
//
#[no_mangle]
unsafe extern "C" fn uart_firmware_cont(fw: *const firmware, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn soft_uart_init(ofdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucc_uart_probe(ofdev: *mut platform_device) -> c_int {
    static int ucc_uart_probe(struct platform_device *ofdev)
    {
    struct device_node *np = ofdev.dev.of_node;
    const char *sprop;      /* String OF properties */
    struct uart_qe_port *qe_port = core::ptr::null_mut();
    struct resource res;
    u32 val;
    int ret;
//
...
// assignments.
//
    sprop = of_get_property(np, "rx-clock-name", core::ptr::null_mut());
    if (!sprop) {
...
// In internal loopback mode, TX and RX must use the same clock
    ...
    sprop = of_get_property(np, "tx-clock-name", core::ptr::null_mut());
    if (!sprop) {
...
//
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,qe");
    if (!np) {
    np = of_find_node_by_type(core::ptr::null_mut(), "qe");
    if (!np) {
...
#[no_mangle]
unsafe extern "C" fn ucc_uart_remove(ofdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ucc_uart_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ucc_uart_exit() -> void __exit {
