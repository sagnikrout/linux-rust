...
//! Source: drivers/tty/serial/serial_port.c
#![no_std]
...
pub const SERIAL_PORT_AUTOSUSPEND_DELAY_MS: c_int = 500;
// Only considers pending TX for now. Caller must take care of locking
#[no_mangle]
unsafe extern "C" fn __serial_port_busy(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_port_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_port_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serial_base_port_startup(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial_base_port_shutdown(port: *mut uart_port) {
    ...
    serial_port_runtime_resume, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn serial_port_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_port_remove(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn uart_add_one_port(drv: *mut uart_driver, port: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uart_remove_one_port(drv: *mut uart_driver, port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __uart_read_properties(port: *mut uart_port, use_defaults: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev_is_pnp(dev)) -> else {
    ...
    port.irq = ret;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: use_defaults) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn uart_read_port_properties(port: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uart_read_and_validate_port_properties(port: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serial_base_port_init() -> c_int {
    int serial_base_port_init(void)
    {
    return serial_base_driver_register(&serial_port_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn serial_base_port_exit() {
