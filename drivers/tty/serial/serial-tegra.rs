...
//! Source: drivers/tty/serial/serial-tegra.c
#![no_std]
...
pub const TEGRA_UART_RX_DMA_BUFFER_SIZE: c_int = 4096;
pub const TEGRA_UART_LSR_TXFIFO_FULL: c_uint = 0x100;
pub const TEGRA_UART_IER_EORD: c_uint = 0x20;
pub const TEGRA_UART_MCR_RTS_EN: c_uint = 0x40;
pub const TEGRA_UART_MCR_CTS_EN: c_uint = 0x20;

    UART_LSR_PE | UART_LSR_FE)
pub const TEGRA_UART_IRDA_CSR: c_uint = 0x08;
pub const TEGRA_UART_SIR_ENABLED: c_uint = 0x80;
pub const TEGRA_UART_TX_PIO: c_int = 1;
pub const TEGRA_UART_TX_DMA: c_int = 2;
pub const TEGRA_UART_MIN_DMA: c_int = 16;
pub const TEGRA_UART_FIFO_SIZE: c_int = 32;
//
// Tx fifo trigger level setting in tegra uart is in
// reverse way then conventional uart.
//
pub const TEGRA_UART_TX_TRIG_16B: c_uint = 0x00;
pub const TEGRA_UART_TX_TRIG_8B: c_uint = 0x10;
pub const TEGRA_UART_TX_TRIG_4B: c_uint = 0x20;
pub const TEGRA_UART_TX_TRIG_1B: c_uint = 0x30;
pub const TEGRA_UART_MAXIMUM: c_int = 8;
// Default UART setting when started: 115200 no parity, stop, 8 data bits
pub const TEGRA_UART_DEFAULT_BAUD: c_int = 115200;

// Tx transfer mode
pub const TEGRA_TX_PIO: c_int = 1;
pub const TEGRA_TX_DMA: c_int = 2;
pub const TEGRA_UART_FCR_IIR_FIFO_EN: c_uint = 0x40;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_uart_chip_data {
    pub tx_fifo_full_status: bool,
    pub allow_txfifo_reset_fifo_mode: bool,
    pub support_clk_src_div: bool,
    pub fifo_mode_enable_status: bool,
    pub uart_max_port: c_int,
    pub max_dma_burst_bytes: c_int,
    pub error_tolerance_low_range: c_int,
    pub error_tolerance_high_range: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_baud_tolerance {
    pub lower_range_baud: u32,
    pub upper_range_baud: u32,
    pub tolerance: i32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_uart_port {
    pub uport: uart_port,
    pub cdata: *const tegra_uart_chip_data,
    pub uart_clk: *mut clk,
    pub rst: *mut reset_control,
    pub current_baud: c_uint,
// Register shadow
    pub fcr_shadow: c_ulong,
    pub mcr_shadow: c_ulong,
    pub lcr_shadow: c_ulong,
    pub ier_shadow: c_ulong,
    pub rts_active: bool,
    pub tx_in_progress: c_int,
    pub tx_bytes: c_uint,
    pub enable_modem_interrupt: bool,
    pub rx_timeout: bool,
    pub rx_in_progress: c_int,
    pub symb_bit: c_int,
    pub rx_dma_chan: *mut dma_chan,
    pub tx_dma_chan: *mut dma_chan,
    pub rx_dma_buf_phys: dma_addr_t,
    pub tx_dma_buf_phys: dma_addr_t,
    pub rx_dma_buf_virt: *mut c_uchar,
    pub tx_dma_buf_virt: *mut c_uchar,
    ...
    pub tx_bytes_requested: c_uint,
    pub rx_bytes_requested: c_uint,
    pub baud_tolerance: *mut tegra_baud_tolerance,
    pub n_adjustable_baud_rates: c_int,
    pub required_rate: c_int,
    pub configured_rate: c_int,
    pub use_rx_pio: bool,
    pub use_tx_pio: bool,
    pub rx_dma_active: bool,
}
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_get_mctrl(u: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn set_rts(tup: *mut tegra_uart_port, active: bool) {
...
#[no_mangle]
unsafe extern "C" fn set_dtr(tup: *mut tegra_uart_port, active: bool) {
...
#[no_mangle]
unsafe extern "C" fn set_loopbk(tup: *mut tegra_uart_port, active: bool) {
    static void set_loopbk(struct tegra_uart_port *tup, bool active)
    {
    let mut mcr: c_ulong = tup.mcr_shadow;
    if (active)
    mcr |= UART_MCR_LOOP;
    else
    mcr &= ~UART_MCR_LOOP;
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_set_mctrl(u: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_break_ctl(u: *mut uart_port, break_ctl: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_wait_fifo_mode_enabled(tup: *mut tegra_uart_port) -> c_int {
    static int tegra_uart_wait_fifo_mode_enabled(struct tegra_uart_port *tup)
    {
    unsigned long iir;
    let mut tmout: c_uint = 100;
    do {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_fifo_reset(tup: *mut tegra_uart_port, fcr_bits: u8) {
    static void tegra_uart_fifo_reset(struct tegra_uart_port *tup, u8 fcr_bits)
    {
    let mut fcr: c_ulong = tup.fcr_shadow;
...
#[no_mangle]
unsafe extern "C" fn tegra_check_rate_in_range(tup: *mut tegra_uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_set_baudrate(tup: *mut tegra_uart_port, baud: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_request_port(u: *mut uart_port) -> c_int {
    static int tegra_uart_request_port(struct uart_port *u)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra_uart_release_port(u: *mut uart_port) {
    static void tegra_uart_release_port(struct uart_port *u)
    {
// Nothing to do here
    }
#[no_mangle]
unsafe extern "C" fn tegra_uart_fill_tx_fifo(tup: *mut tegra_uart_port, max_bytes: c_int) {
    ...
    let mut lsr: c_ulong = tegra_uart_read(tup, UART_LSR);
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_tx_dma_complete(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_start_next_tx(tup: *mut tegra_uart_port) {
    static void tegra_uart_start_next_tx(struct tegra_uart_port *tup)
    {
    struct tty_port *tport = &tup.uport.state.port;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: BYTES_TO_ALIGN(tail) >) -> else {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_start_tx(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_tx_empty(u: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_stop_tx(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_handle_tx_pio(tup: *mut tegra_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn do_handle_rx_pio(tup: *mut tegra_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_rx_dma_complete(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_terminate_rx_dma(tup: *mut tegra_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_handle_rx_dma(tup: *mut tegra_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_start_rx_dma(tup: *mut tegra_uart_port) -> c_int {
    static int tegra_uart_start_rx_dma(struct tegra_uart_port *tup)
    {
    let mut count: c_uint = TEGRA_UART_RX_DMA_BUFFER_SIZE;
    if (tup.rx_dma_active)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_handle_modem_signal_change(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    unsigned long iir;
    unsigned long ier;
    let mut is_rx_start: bool = false;
    let mut is_rx_int: bool = false;
    unsigned long flags;
    uart_port_lock_irqsave(u, &flags);
    while (1) {
    iir = tegra_uart_read(tup, UART_IIR);
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_stop_rx(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_hw_deinit(tup: *mut tegra_uart_port) {
    static void tegra_uart_hw_deinit(struct tegra_uart_port *tup)
    {
    unsigned long flags;
    let mut char_time: c_ulong = DIV_ROUND_UP(10000000, tup.current_baud);
    let mut fifo_empty_time: c_ulong = tup.uport.fifosize * char_time;
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_hw_init(tup: *mut tegra_uart_port) -> c_int {
...
//
    ...
    tup.rx_dma_chan = core::ptr::null_mut();
    tup.rx_dma_buf_phys = 0;
    tup.rx_dma_buf_virt = core::ptr::null_mut();
    } else {
    dmaengine_terminate_all(tup.tx_dma_chan);
    dma_release_channel(tup.tx_dma_chan);
    dma_unmap_single(tup.uport.dev, tup.tx_dma_buf_phys,
    UART_XMIT_SIZE, DMA_TO_DEVICE);
    tup.tx_dma_chan = core::ptr::null_mut();
    tup.tx_dma_buf_phys = 0;
    tup.tx_dma_buf_virt = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_startup(u: *mut uart_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tegra_uart_flush_buffer(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_shutdown(u: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_enable_ms(u: *mut uart_port) {
    ...
    let mut parent_clk_rate: c_ulong = clk_get_rate(parent_clk);
    let mut max_divider: c_int = (tup.cdata.support_clk_src_div) ? 0x7FFF : 0xFFFF;
    int ret;
    max_divider *= 16;
    uart_port_lock_irqsave(u, &flags);
...
unsafe extern "C" fn tegra_uart_probe(pdev: *mut platform_device) -> c_int {
    ...
    tup.uart_clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_init() -> int __init {
    static int __init tegra_uart_init(void)
    {
    int ret;
    struct device_node *node;
    const struct of_device_id *match = core::ptr::null_mut();
    const struct tegra_uart_chip_data *cdata = core::ptr::null_mut();
    node = of_find_matching_node(core::ptr::null_mut(), tegra_uart_of_match);
    if (node)
...
#[no_mangle]
unsafe extern "C" fn tegra_uart_exit() -> void __exit {
