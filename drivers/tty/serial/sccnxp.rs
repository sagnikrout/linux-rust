...
//! Source: drivers/tty/serial/sccnxp.c
#![no_std]
...
pub const SCCNXP_MAJOR: c_int = 204;
pub const SCCNXP_MINOR: c_int = 205;

// Route helpers

pub const SCCNXP_HAVE_IO: c_uint = 0x00000001;
pub const SCCNXP_HAVE_MR0: c_uint = 0x00000002;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sccnxp_chip {
    pub name: *const c_char,
    pub nr: c_uint,
    pub freq_min: c_ulong,
    pub freq_std: c_ulong,
    pub freq_max: c_ulong,
    pub flags: c_uint,
    pub fifosize: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sccnxp_port {
    pub uart: uart_driver,
    pub port: [uart_port; SCCNXP_MAX_UARTS],
    pub opened: [bool; SCCNXP_MAX_UARTS],
    pub irq: c_int,
    pub imr: u8,
    pub chip: *mut sccnxp_chip,
...
#[no_mangle]
unsafe extern "C" fn sccnxp_read(port: *mut uart_port, reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_write(port: *mut uart_port, reg: u8, v: u8) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_port_read(port: *mut uart_port, reg: u8) -> u8 {
    static u8 sccnxp_port_read(struct uart_port *port, u8 reg)
    {
    return sccnxp_read(port, (port.line << 3) + reg);
    }
#[no_mangle]
unsafe extern "C" fn sccnxp_port_write(port: *mut uart_port, reg: u8, v: u8) {
    static void sccnxp_port_write(struct uart_port *port, u8 reg, u8 v)
    {
    sccnxp_write(port, (port.line << 3) + reg, v);
    }
#[no_mangle]
unsafe extern "C" fn sccnxp_update_best_err(a: c_int, b: c_int, besterr: *mut c_int) -> c_int {
    static int sccnxp_update_best_err(int a, int b, int *besterr)
    {
    let mut err: c_int = abs(a - b);
    if (*besterr > err) {
// besterr = err;
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn sccnxp_set_baud(port: *mut uart_port, baud: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_enable_irq(port: *mut uart_port, mask: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_disable_irq(port: *mut uart_port, mask: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_set_bit(port: *mut uart_port, sig: c_int, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_handle_rx(port: *mut uart_port) {
    ...
    port.icount.parity++;
#[no_mangle]
pub unsafe extern "C" fn if(SR_FE: sr &) -> else {
    else if (sr & SR_FE)
    port.icount.frame++;
#[no_mangle]
pub unsafe extern "C" fn if(SR_OVR: sr &) -> else {
    port.icount.overrun++;
    sccnxp_port_write(port, SCCNXP_CR_REG,
    CR_CMD_STATUS_RESET);
    }
    ...
    flag = TTY_BREAK;
#[no_mangle]
pub unsafe extern "C" fn if(SR_PE: sr &) -> else {
    else if (sr & SR_PE)
    flag = TTY_PARITY;
#[no_mangle]
pub unsafe extern "C" fn if(SR_FE: sr &) -> else {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_handle_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_handle_events(s: *mut sccnxp_port) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_ist(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_stop_tx(port: *mut uart_port) {
    static void sccnxp_stop_tx(struct uart_port *port)
    {
// Do nothing
    }
#[no_mangle]
unsafe extern "C" fn sccnxp_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_get_mctrl(port: *mut uart_port) -> c_uint {
    static unsigned int sccnxp_get_mctrl(struct uart_port *port)
    {
    u8 bitmask, ipr;
    unsigned long flags;
    struct sccnxp_port *s = dev_get_drvdata(port.dev);
    let mut mctrl: c_uint = TIOCM_DSR | TIOCM_CTS | TIOCM_CAR;
    if (!(s.chip.flags & SCCNXP_HAVE_IO))
    return mctrl;
    spin_lock_irqsave(&s.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn sccnxp_break_ctl(port: *mut uart_port, break_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_shutdown(port: *mut uart_port) {
...
// Leave direction to input
    ...
    {
    struct sccnxp_port *s = dev_get_drvdata(port.dev);
    return (port.type == PORT_SC26XX) ? s.chip.name : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn sccnxp_release_port(port: *mut uart_port) {
    static void sccnxp_release_port(struct uart_port *port)
    {
// Do nothing
    }
#[no_mangle]
unsafe extern "C" fn sccnxp_request_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_verify_port(port: *mut uart_port, s: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_console_putchar(port: *mut uart_port, c: c_uchar) {
    static void sccnxp_console_putchar(struct uart_port *port, unsigned char c)
    {
    let mut tryes: c_int = 100000;
    while (tryes--) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_console_write(co: *mut console, c: *const c_char, n: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn sccnxp_console_setup(co: *mut console, options: *mut c_char) -> c_int {
    static int sccnxp_console_setup(struct console *co, char *options)
    {
    struct sccnxp_port *s = (struct sccnxp_port *)co.data;
    struct uart_port *port = &s.port[(co.index > 0) ? co.index : 0];
    let mut baud: c_int = 9600, bits = 8, parity = 'n', flow = 'n';
    if (options)
...
#[no_mangle]
unsafe extern "C" fn sccnxp_probe(pdev: *mut platform_device) -> c_int {
...
// Disable interrupts
    ...
    if (!s.poll) {
    ret = devm_request_threaded_irq(&pdev.dev, s.irq, core::ptr::null_mut(),
    sccnxp_ist,
...
#[no_mangle]
unsafe extern "C" fn sccnxp_remove(pdev: *mut platform_device) {
    ...
    uart_unregister_driver(&s.uart);
    if (!IS_ERR(s.regulator)) {
    let mut ret: c_int = regulator_disable(s.regulator);
    if (ret)
