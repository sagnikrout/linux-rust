...
//! Source: drivers/tty/serial/liteuart.c
#![no_std]
...
//
pub const OFF_RXTX: c_uint = 0x00;
pub const OFF_TXFULL: c_uint = 0x04;
pub const OFF_RXEMPTY: c_uint = 0x08;
pub const OFF_EV_STATUS: c_uint = 0x0c;
pub const OFF_EV_PENDING: c_uint = 0x10;
pub const OFF_EV_ENABLE: c_uint = 0x14;
// events

#[repr(C)]
#[derive(Copy, Clone)]
pub struct liteuart_port {
    pub port: uart_port,
...
#[no_mangle]
unsafe extern "C" fn liteuart_update_irq_reg(port: *mut uart_port, set: bool, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn liteuart_stop_tx(port: *mut uart_port) {
    static void liteuart_stop_tx(struct uart_port *port)
    {
    liteuart_update_irq_reg(port, false, EV_TX);
    }
#[no_mangle]
unsafe extern "C" fn liteuart_start_tx(port: *mut uart_port) {
    static void liteuart_start_tx(struct uart_port *port)
    {
    liteuart_update_irq_reg(port, true, EV_TX);
    }
#[no_mangle]
unsafe extern "C" fn liteuart_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn liteuart_rx_chars(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn liteuart_tx_chars(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn liteuart_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn liteuart_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn liteuart_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn liteuart_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
    static void liteuart_set_mctrl(struct uart_port *port, unsigned int mctrl)
    {
// modem control register is not present in LiteUART
    }
#[no_mangle]
unsafe extern "C" fn liteuart_get_mctrl(port: *mut uart_port) -> c_uint {
    static unsigned int liteuart_get_mctrl(struct uart_port *port)
    {
    return TIOCM_CTS | TIOCM_DSR | TIOCM_CAR;
    }
#[no_mangle]
unsafe extern "C" fn liteuart_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn liteuart_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn liteuart_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn liteuart_probe(pdev: *mut platform_device) -> c_int {
    ...
    port = &uart.port;
// get membase
    port.membase = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn liteuart_remove(pdev: *mut platform_device) {
    static void liteuart_remove(struct platform_device *pdev)
    {
    struct uart_port *port = platform_get_drvdata(pdev);
    let mut line: c_uint = port.line;
...
#[no_mangle]
unsafe extern "C" fn liteuart_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn liteuart_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn liteuart_console_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn liteuart_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn liteuart_exit() -> void __exit {
