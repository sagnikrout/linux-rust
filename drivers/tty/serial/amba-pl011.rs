...
pub const UART_NR: c_int = 14;
pub const SERIAL_AMBA_MAJOR: c_int = 204;
pub const SERIAL_AMBA_MINOR: c_int = 64;
...
pub struct vendor_data {
    ...
    pub skip_ibrd_fbrd: bool,
    pub set_uartclk_rate: bool,
    pub dev): *mut *mut unsigned int (get_fifosize)(struct amba_device,
}

#[no_mangle]
unsafe extern "C" fn get_fifosize_arm(dev: *mut amba_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_fifosize_st(dev: *mut amba_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_fifosize_nvidia(dev: *mut amba_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn get_fifosize_zte(dev: *mut amba_device) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pl011_dmarx_data {
    pub chan: *mut dma_chan,
    pub complete: completion,
    pub use_buf_b: bool,
    pub dbuf_a: pl011_dmabuf,
    pub dbuf_b: pl011_dmabuf,
    pub cookie: dma_cookie_t,
    pub running: bool,
    pub timer: timer_list,
    pub last_residue: c_uint,
    pub last_jiffies: c_ulong,
    pub auto_poll_rate: bool,
    pub poll_rate: c_uint,
    pub poll_timeout: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pl011_dmatx_data {
    pub chan: *mut dma_chan,
    pub dma: dma_addr_t,
    pub len: usize,
    pub buf: *mut c_char,
...
pub struct uart_amba_port {
    ...
    pub reg_offset: *const u16,
    pub clk: *mut clk,
    pub vendor: *const vendor_data,
    pub /: *mut *mut unsigned int im; / interrupt mask,
    pub old_status: c_uint,
    pub /: *mut *mut unsigned int fifosize; / vendor-specific,
    pub /: *mut *mut unsigned int fixed_baud; / vendor-set fixed baud rate,
    pub type: [c_char; 12],
    pub /: *mut *mut ktime_t rs485_tx_drain_interval; / nano,
    pub rs485_tx_state: enum pl011_rs485_tx_state,
    pub trigger_start_tx: hrtimer,
    pub trigger_stop_tx: hrtimer,
    pub console_line_ended: bool,

// DMA stuff
    pub /: *mut *mut unsigned int dmacr; / dma control reg,
    pub using_tx_dma: bool,
    pub using_rx_dma: bool,
    pub dmarx: pl011_dmarx_data,
    pub dmatx: pl011_dmatx_data,
    pub dma_probed: bool,
...
//
#[no_mangle]
unsafe extern "C" fn pl011_fifo_to_tty(uap: *mut uart_amba_port) -> c_int {
...
// Take chars from the FIFO and update status
    ...
    flag = TTY_BREAK;
#[no_mangle]
pub unsafe extern "C" fn if(UART011_DR_PE: ch &) -> else {
    else if (ch & UART011_DR_PE)
    flag = TTY_PARITY;
#[no_mangle]
pub unsafe extern "C" fn if(UART011_DR_FE: ch &) -> else {
    else if (ch & UART011_DR_FE)
    flag = TTY_FRAME;
    }
...
#[no_mangle]
unsafe extern "C" fn pl011_dma_probe(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_dma_remove(uap: *mut uart_amba_port) {
...
//
#[no_mangle]
unsafe extern "C" fn pl011_dma_tx_callback(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn pl011_dma_tx_refill(uap: *mut uart_amba_port) -> c_int {
    static int pl011_dma_tx_refill(struct uart_amba_port *uap)
    {
    struct pl011_dmatx_data *dmatx = &uap.dmatx;
...
//
#[no_mangle]
unsafe extern "C" fn pl011_dma_tx_irq(uap: *mut uart_amba_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_tx_stop(uap: *mut uart_amba_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_tx_start(uap: *mut uart_amba_port) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pl011_dma_flush_buffer(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_dma_rx_trigger_dma(uap: *mut uart_amba_port) -> c_int {
...
//
    ...
    &uap.dmarx.dbuf_b : &uap.dmarx.dbuf_a;
    let mut dma_count: c_int = 0;
    u32 fifotaken = 0; /* only used for vdbg() */
    struct pl011_dmarx_data *dmarx = &uap.dmarx;
    let mut dmataken: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn pl011_dma_rx_irq(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_dma_rx_callback(data: *mut c_void) {
    static void pl011_dma_rx_callback(void *data)
    {
    struct uart_amba_port *uap = data;
    struct pl011_dmarx_data *dmarx = &uap.dmarx;
    struct dma_chan *rxchan = dmarx.chan;
    let mut lastbuf: bool = dmarx.use_buf_b;
    struct pl011_dmabuf *dbuf = dmarx.use_buf_b ?
    &dmarx.dbuf_b : &dmarx.dbuf_a;
    size_t pending;
    struct dma_tx_state state;
...
//
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_rx_stop(uap: *mut uart_amba_port) {
...
//
#[no_mangle]
unsafe extern "C" fn pl011_dma_rx_poll(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn pl011_dma_startup(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_dma_shutdown(uap: *mut uart_amba_port) {
...
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_rx_available(uap: *mut uart_amba_port) -> bool {
    static inline bool pl011_dma_rx_available(struct uart_amba_port *uap)
    {
    return uap.using_rx_dma;
    }
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_rx_running(uap: *mut uart_amba_port) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_remove(uap: *mut uart_amba_port) {
    static inline void pl011_dma_remove(struct uart_amba_port *uap)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_startup(uap: *mut uart_amba_port) {
    static inline void pl011_dma_startup(struct uart_amba_port *uap)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_shutdown(uap: *mut uart_amba_port) {
    static inline void pl011_dma_shutdown(struct uart_amba_port *uap)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_tx_irq(uap: *mut uart_amba_port) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_rx_irq(uap: *mut uart_amba_port) {
...
#[no_mangle]
pub unsafe extern "C" fn pl011_dma_rx_trigger_dma(uap: *mut uart_amba_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_rs485_tx_stop_now(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_rs485_tx_stop(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_start_tx_pio(uap: *mut uart_amba_port) {
    static void pl011_start_tx_pio(struct uart_amba_port *uap)
    {
...
#[no_mangle]
unsafe extern "C" fn pl011_rs485_tx_start(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_trigger_start_tx(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn pl011_trigger_stop_tx(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn pl011_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_throttle_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_enable_ms(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_rx_chars(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_tx_chars(uap: *mut uart_amba_port, from_irq: bool) -> bool {
    static bool pl011_tx_chars(struct uart_amba_port *uap, bool from_irq)
    {
    struct tty_port *tport = &uap.port.state.port;
    let mut count: c_int = uap.fifosize >> 1;
    if (uap.port.x_char) {
...
#[no_mangle]
unsafe extern "C" fn pl011_modem_status(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn check_apply_cts_event_workaround(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_int(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pl011_tx_empty(port: *mut uart_port) -> c_uint {
    static unsigned int pl011_tx_empty(struct uart_port *port)
    {
    struct uart_amba_port *uap =
    container_of(port, struct uart_amba_port, port);
// Allow feature register bits to be inverted to work around errata
    let mut status: c_uint = pl011_read(uap, REG_FR) ^ uap.vendor.inv_fr;
    return status & (uap.vendor.fr_busy | UART01x_FR_TXFF) ?
    0 : TIOCSER_TEMT;
    }
#[no_mangle]
unsafe extern "C" fn pl011_maybe_set_bit(cond: bool, ptr: *mut c_uint, mask: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pl011_get_mctrl(port: *mut uart_port) -> c_uint {
    static unsigned int pl011_get_mctrl(struct uart_port *port)
    {
    struct uart_amba_port *uap =
    container_of(port, struct uart_amba_port, port);
    let mut result: c_uint = 0;
    let mut status: c_uint = pl011_read(uap, REG_FR);
...
#[no_mangle]
unsafe extern "C" fn pl011_assign_bit(cond: bool, ptr: *mut c_uint, mask: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pl011_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pl011_break_ctl(port: *mut uart_port, break_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pl011_quiesce_irqs(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_get_poll_char(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_put_poll_char(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn pl011_hwinit(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_split_lcrh(uap: *const uart_amba_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pl011_write_lcr_h(uap: *mut uart_amba_port, lcr_h: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pl011_allocate_irq(uap: *mut uart_amba_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pl011_enable_interrupts(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_unthrottle_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbsa_uart_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_shutdown_channel(uap: *mut uart_amba_port, lcrh: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn pl011_disable_uart(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_disable_interrupts(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sbsa_uart_shutdown(port: *mut uart_port) {
...
//
    ...
    let mut max_clkrate: c_long = clk_round_rate(uap.clk, UINT_MAX);
//
...
//
    ...
    quot -= 1;
#[no_mangle]
pub unsafe extern "C" fn if(2: baud > 3250000 && quot >) -> else {
...
// The SBSA UART only supports 8n1 without hardware flow control.
    ...
    struct uart_amba_port *uap =
    container_of(port, struct uart_amba_port, port);
    return uap.port.type == PORT_AMBA ? uap.type : core::ptr::null_mut();
    }
//
// Configure/autoconfigure the port.
//
#[no_mangle]
unsafe extern "C" fn pl011_config_port(port: *mut uart_port, flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pl011_verify_port(port: *mut uart_port, ser: *mut serial_struct) -> c_int {
...
// Make sure auto RTS is disabled
    ...
    let mut cr: u32 = pl011_read(uap, REG_CR);
    cr &= ~UART011_CR_RTSEN;
    pl011_write(cr, uap, REG_CR);
...
#[no_mangle]
unsafe extern "C" fn sbsa_uart_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
    static void sbsa_uart_set_mctrl(struct uart_port *port, unsigned int mctrl)
    {
    }
#[no_mangle]
unsafe extern "C" fn sbsa_uart_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pl011_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn pl011_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_console_exit(co: *mut console) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qdf2400_e44_putc(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn qdf2400_e44_early_write(con: *mut console, s: *const c_char, n: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pl011_putc(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn pl011_early_write(con: *mut console, s: *const c_char, n: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pl011_getc(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_early_read(con: *mut console, s: *mut c_char, n: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_probe_dt_alias(index: c_int, dev: *mut device) -> c_int {
    static int pl011_probe_dt_alias(int index, struct device *dev)
    {
    struct device_node *np;
    static bool seen_dev_with_alias;
    static bool seen_dev_without_alias;
    let mut ret: c_int = index;
...
#[no_mangle]
unsafe extern "C" fn pl011_unregister_port(uap: *mut uart_amba_port) {
...
#[no_mangle]
unsafe extern "C" fn pl011_find_free_port() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_register_port(uap: *mut uart_amba_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_probe(dev: *mut amba_device, id: *const amba_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_remove(dev: *mut amba_device) {
...
#[no_mangle]
unsafe extern "C" fn pl011_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pl011_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbsa_uart_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbsa_uart_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pl011_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pl011_exit() -> void __exit {
