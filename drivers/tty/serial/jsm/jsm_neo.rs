...
//! Source: drivers/tty/serial/jsm/jsm_neo.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn neo_pci_posting_flush(bd: *mut jsm_board) {
    static inline void neo_pci_posting_flush(struct jsm_board *bd)
    {
    readb(bd.re_map_membase + 0x8D);
    }
#[no_mangle]
unsafe extern "C" fn neo_set_cts_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_set_rts_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_set_ixon_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_set_ixoff_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_set_no_input_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_set_no_output_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn neo_set_new_start_stop_chars(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_copy_data_from_uart_to_queue(ch: *mut jsm_channel) {
    static void neo_copy_data_from_uart_to_queue(struct jsm_channel *ch)
    {
    let mut qleft: c_int = 0;
    let mut linestatus: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn neo_copy_data_from_queue_to_uart(ch: *mut jsm_channel) {
...
//
    if (!(ch.ch_flags & CH_FIFO_ENABLED)) {
    let mut lsrbits: u8 = readb(&ch.ch_neo_uart.lsr);
...
#[no_mangle]
unsafe extern "C" fn neo_parse_modem(ch: *mut jsm_channel, signals: u8) {
    static void neo_parse_modem(struct jsm_channel *ch, u8 signals)
    {
    let mut msignals: u8 = signals;
...
#[no_mangle]
unsafe extern "C" fn neo_assert_modem_signals(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn neo_flush_uart_write(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn neo_flush_uart_read(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn neo_clear_break(ch: *mut jsm_channel) {
...
// Turn break off, and unset some variables
    ...
    let mut temp: u8 = readb(&ch.ch_neo_uart.lcr);
...
//
#[no_mangle]
unsafe extern "C" fn neo_parse_isr(brd: *mut jsm_board, port: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(UART_17158_XOFF_DETECT: cause ==) -> else {
    if (!(brd.channels[port].ch_flags & CH_STOP)) {
    ch.ch_flags |= CH_STOP;
    jsm_dbg(INTR, &ch.ch_bd.pci_dev,
    "Setting CH_STOP\n");
...
#[no_mangle]
pub unsafe extern "C" fn neo_parse_lsr(brd: *mut jsm_board, port: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(UART_17158_TX_AND_FIFO_CLR: linestatus &) -> else {
    spin_lock_irqsave(&ch.ch_lock, lock_flags);
    ch.ch_flags |= (CH_TX_FIFO_EMPTY | CH_TX_FIFO_LWM);
    spin_unlock_irqrestore(&ch.ch_lock, lock_flags);
// Transfer data (if any) from Write Queue -> UART.
...
//
#[no_mangle]
unsafe extern "C" fn neo_param(ch: *mut jsm_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IXON: ch->ch_c_iflag &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(IXOFF: ch->ch_c_iflag &) -> else {
// If start/stop is set to disable, then we should disable flow control
    if ((ch.ch_startc == __DISABLED_CHAR) || (ch.ch_stopc == __DISABLED_CHAR))
...
//
#[no_mangle]
unsafe extern "C" fn neo_intr(irq: c_int, voidbrd: *mut c_void) -> irqreturn_t {
    ...
    let mut outofloop_count: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn neo_disable_receiver(ch: *mut jsm_channel) {
    static void neo_disable_receiver(struct jsm_channel *ch)
    {
    let mut tmp: u8 = readb(&ch.ch_neo_uart.ier);
    tmp &= ~(UART_IER_RDI);
...
//
#[no_mangle]
unsafe extern "C" fn neo_enable_receiver(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_send_start_character(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_send_stop_character(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn neo_uart_init(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn neo_uart_off(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn neo_send_break(ch: *mut jsm_channel) {
