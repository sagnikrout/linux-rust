...
//! Source: drivers/tty/serial/jsm/jsm_cls.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cls_set_cts_flow_control(ch: *mut jsm_channel) {
    static void cls_set_cts_flow_control(struct jsm_channel *ch)
    {
    let mut lcrb: u8 = readb(&ch.ch_cls_uart.lcr);
    let mut ier: u8 = readb(&ch.ch_cls_uart.ier);
    let mut isr_fcr: u8 = 0;
//
...
#[no_mangle]
unsafe extern "C" fn cls_set_ixon_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_set_no_output_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_set_rts_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_set_ixoff_flow_control(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_set_no_input_flow_control(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn cls_clear_break(ch: *mut jsm_channel) {
...
// Turn break off, and unset some variables
    ...
    let mut temp: u8 = readb(&ch.ch_cls_uart.lcr);
...
#[no_mangle]
unsafe extern "C" fn cls_disable_receiver(ch: *mut jsm_channel) {
    static void cls_disable_receiver(struct jsm_channel *ch)
    {
    let mut tmp: u8 = readb(&ch.ch_cls_uart.ier);
    tmp &= ~(UART_IER_RDI);
    writeb(tmp, &ch.ch_cls_uart.ier);
    }
#[no_mangle]
unsafe extern "C" fn cls_enable_receiver(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_assert_modem_signals(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_copy_data_from_uart_to_queue(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_copy_data_from_queue_to_uart(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_parse_modem(ch: *mut jsm_channel, signals: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn cls_parse_isr(brd: *mut jsm_board, port: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn cls_flush_uart_write(ch: *mut jsm_channel) {
...
// Channel lock MUST be held before calling this function!
#[no_mangle]
unsafe extern "C" fn cls_flush_uart_read(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_send_start_character(ch: *mut jsm_channel) {
...
#[no_mangle]
unsafe extern "C" fn cls_send_stop_character(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn cls_param(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn cls_intr(irq: c_int, voidbrd: *mut c_void) -> irqreturn_t {
...
// Inits UART
#[no_mangle]
unsafe extern "C" fn cls_uart_init(ch: *mut jsm_channel) {
    static void cls_uart_init(struct jsm_channel *ch)
    {
    let mut lcrb: c_uchar = readb(&ch.ch_cls_uart.lcr);
    let mut isr_fcr: c_uchar = 0;
...
//
#[no_mangle]
unsafe extern "C" fn cls_uart_off(ch: *mut jsm_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn cls_send_break(ch: *mut jsm_channel) {
