...
//! Source: drivers/tty/serial/jsm/jsm_driver.c
#![no_std]
...
pub const NR_PORTS: c_int = 32;
pub const JSM_MINOR_START: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn jsm_probe_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jsm_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn jsm_io_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
    static pci_ers_result_t jsm_io_slot_reset(struct pci_dev *pdev)
    {
    int rc;
    rc = pci_enable_device(pdev);
...
#[no_mangle]
unsafe extern "C" fn jsm_io_resume(pdev: *mut pci_dev) {
    static void jsm_io_resume(struct pci_dev *pdev)
    {
    struct jsm_board *brd = pci_get_drvdata(pdev);
...
#[no_mangle]
unsafe extern "C" fn jsm_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn jsm_exit_module() -> void __exit {
