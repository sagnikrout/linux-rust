...
//! Source: drivers/tty/serial/milbeaut_usio.c
#![no_std]
...
pub const MLB_USIO_REG_SMR: c_int = 0;
pub const MLB_USIO_REG_SCR: c_int = 1;
pub const MLB_USIO_REG_ESCR: c_int = 2;
pub const MLB_USIO_REG_SSR: c_int = 3;
pub const MLB_USIO_REG_DR: c_int = 4;
pub const MLB_USIO_REG_BGR: c_int = 6;
pub const MLB_USIO_REG_FCR: c_int = 12;
pub const MLB_USIO_REG_FBYTE: c_int = 14;

pub const MLB_USIO_ESCR_L_8BIT: c_int = 0;
pub const MLB_USIO_ESCR_L_5BIT: c_int = 1;
pub const MLB_USIO_ESCR_L_6BIT: c_int = 2;
pub const MLB_USIO_ESCR_L_7BIT: c_int = 3;

#[no_mangle]
unsafe extern "C" fn mlb_usio_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_tx_chars(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_start_tx(port: *mut uart_port) {
    static void mlb_usio_start_tx(struct uart_port *port)
    {
    let mut fcr: u16 = readw(port.membase + MLB_USIO_REG_FCR);
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_enable_ms(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_rx_chars(port: *mut uart_port) {
    static void mlb_usio_rx_chars(struct uart_port *port)
    {
    struct tty_port *ttyport = &port.state.port;
    let mut flag: u8 = 0, ch = 0;
    u8 status;
    let mut max_count: c_int = 2;
    while (max_count--) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_rx_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_tx_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
    static void mlb_usio_set_mctrl(struct uart_port *port, unsigned int mctrl)
    {
    }
#[no_mangle]
unsafe extern "C" fn mlb_usio_get_mctrl(port: *mut uart_port) -> c_uint {
    static unsigned int mlb_usio_get_mctrl(struct uart_port *port)
    {
    return TIOCM_CAR | TIOCM_DSR | TIOCM_CTS;
    }
#[no_mangle]
unsafe extern "C" fn mlb_usio_break_ctl(port: *mut uart_port, break_state: c_int) {
    static void mlb_usio_break_ctl(struct uart_port *port, int break_state)
    {
    }
#[no_mangle]
unsafe extern "C" fn mlb_usio_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_shutdown(port: *mut uart_port) {
    static void mlb_usio_shutdown(struct uart_port *port)
    {
    let mut index: c_int = port.line;
    free_irq(mlb_usio_irq[index][RX], port);
...
// Set hard flow control
    ...
    {
    return ((port.type == PORT_MLB_USIO) ? USIO_NAME : core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn mlb_usio_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_console_putchar(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_console_setup(co: *mut console, options: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_console_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_init() -> int __init {
    static int __init mlb_usio_init(void)
    {
    let mut ret: c_int = uart_register_driver(&mlb_usio_uart_driver);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn mlb_usio_exit() -> void __exit {
