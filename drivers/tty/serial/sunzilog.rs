...
//! Source: drivers/tty/serial/sunzilog.h
#![no_std]
...
pub struct zilog_channel {
    ...
    pub __pad1: volatile unsigned char,
    pub data: volatile unsigned char,
    pub __pad2: volatile unsigned char,
}
...
pub const nDTRnREQ: c_uint = 0x10	/* /DTR/REQ timing */;
pub const TxFIFO_LVL: c_uint = 0x20	/* Transmit FIFO interrupt level */;
pub const EXT_RD_EN: c_uint = 0x40	/* Extended read register enable */;
// Write Register 8 (transmit buffer)
// Write Register 9 (Master interrupt control)

pub const STATHI: c_uint = 0x10	/* Status high */;
pub const SWIACK: c_uint = 0x20    /* Software Interrupt Ack (not on NMOS) */;
