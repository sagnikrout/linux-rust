...
//! Source: drivers/tty/serial/kgdboc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kgdboc_reset_disconnect(handle: *mut input_handle) {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_restore_input_helper(dummy: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_queue_restore_input_helper(unused: *mut irq_work) {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_restore_input() {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_register_kbd(cptr: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_unregister_kbd() {
    ...
    kdb_poll_funcs[kdb_poll_idx] = core::ptr::null_mut();
    i--;
    }
    }
...
pub const kgdboc_register_kbd(x): c_int = 0;
// Macro flag: #define kgdboc_unregister_kbd()
// Macro flag: #define kgdboc_restore_input()

#[no_mangle]
unsafe extern "C" fn cleanup_earlycon() {
...
#[no_mangle]
unsafe extern "C" fn cleanup_kgdboc() {
...
#[no_mangle]
unsafe extern "C" fn configure_kgdboc() -> c_int {
    ...
    kgdboc_io_ops.cons = core::ptr::null_mut();
    kgdb_tty_driver = core::ptr::null_mut();
    kgdboc_use_kms = 0;
...
#[no_mangle]
unsafe extern "C" fn kgdboc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_kgdboc() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_kgdboc() {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_get_char() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_put_char(chr: u8) {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_pre_exp_handler() {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_post_exp_handler() {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_option_setup(opt: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_early_init(opt: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_earlycon_get_char() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_earlycon_put_char(chr: u8) {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_earlycon_pre_exp_handler() {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_earlycon_deferred_exit(con: *mut console) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_earlycon_deinit() {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: kgdboc_earlycon_io_ops.cons->exit) -> else {
...
//
    ...
    kgdboc_earlycon_io_ops.cons = core::ptr::null_mut();
    }
    static struct kgdb_io kgdboc_earlycon_io_ops = {
...
#[no_mangle]
unsafe extern "C" fn kgdboc_earlycon_init(opt: *mut c_char) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn kgdboc_earlycon_late_init() -> int __init {
