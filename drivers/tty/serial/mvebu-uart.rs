...
//! Source: drivers/tty/serial/mvebu-uart.c
#![no_std]
...
// Register Map
pub const UART_STD_RBR: c_uint = 0x00;
pub const UART_EXT_RBR: c_uint = 0x18;
pub const UART_STD_TSH: c_uint = 0x04;
pub const UART_EXT_TSH: c_uint = 0x1C;
pub const UART_STD_CTRL1: c_uint = 0x08;
pub const UART_EXT_CTRL1: c_uint = 0x04;

    CTRL_PAR_ERR_INT | CTRL_OVR_ERR_INT)

pub const UART_EXT_CTRL2: c_uint = 0x20;

pub const UART_STAT: c_uint = 0x0C;
...
//
pub const UART_BRDV: c_uint = 0x10;
...
pub const CLK_TBG_DIV1_SHIFT: c_int = 15;
pub const CLK_TBG_DIV1_MASK: c_uint = 0x7;
pub const CLK_TBG_DIV1_MAX: c_int = 6;
pub const CLK_TBG_DIV2_SHIFT: c_int = 12;
pub const CLK_TBG_DIV2_MASK: c_uint = 0x7;
pub const CLK_TBG_DIV2_MAX: c_int = 6;
pub const CLK_TBG_SEL_SHIFT: c_int = 10;
pub const CLK_TBG_SEL_MASK: c_uint = 0x3;
// These bits are located in both UARTs address space
pub const BRDV_BAUD_MASK: c_uint = 0x3FF;

pub const UART_OSAMP: c_uint = 0x14;
pub const OSAMP_DEFAULT_DIVISOR: c_int = 16;
pub const OSAMP_DIVISORS_MASK: c_uint = 0x3F3F3F3F;
pub const OSAMP_MAX_DIVISOR: c_int = 63;
pub const MVEBU_NR_UARTS: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uart_flags {
    pub ctrl_tx_rdy_int: c_uint,
    pub ctrl_rx_rdy_int: c_uint,
    pub stat_tx_rdy: c_uint,
    pub stat_rx_rdy: c_uint,
}

// Driver data, a structure for each UART port
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_uart_driver_data {
    pub is_ext: bool,
    pub regs: uart_regs_layout,
    pub flags: uart_flags,
}

// Saved registers during suspend
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_uart_pm_regs {
    pub rbr: c_uint,
    pub tsh: c_uint,
    pub ctrl: c_uint,
    pub intr: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_uart {
    pub port: *mut uart_port,
    pub clk: *mut clk,
    pub irq: [c_int; UART_IRQ_COUNT],
    pub data: *mut mvebu_uart_driver_data,

    pub pm_regs: mvebu_uart_pm_regs,
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_stop_tx(port: *mut uart_port) {
    static void mvebu_uart_stop_tx(struct uart_port *port)
    {
    let mut ctl: c_uint = readl(port.membase + UART_INTR(port));
    ctl &= ~CTRL_TX_RDY_INT(port);
    writel(ctl, port.membase + UART_INTR(port));
    }
#[no_mangle]
unsafe extern "C" fn mvebu_uart_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_break_ctl(port: *mut uart_port, brk: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_rx_chars(port: *mut uart_port, status: c_uint) {
    static void mvebu_uart_rx_chars(struct uart_port *port, unsigned int status)
    {
    struct tty_port *tport = &port.state.port;
    let mut ch: c_uchar = 0;
    let mut flag: c_char = 0;
    int ret;
    do {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_tx_chars(port: *mut uart_port, status: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t mvebu_uart_isr(int irq, void *dev_id)
    {
    struct uart_port *port = (struct uart_port *)dev_id;
    let mut st: c_uint = readl(port.membase + UART_STAT);
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_rx_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_tx_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_baud_rate_set(port: *mut uart_port, baud: c_uint) -> c_uint {
...
//
    ...
    d_divisor = 1;
#[no_mangle]
pub unsafe extern "C" fn if(BRDV_BAUD_MAX: d_divisor >) -> else {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_release_port(port: *mut uart_port) {
    static void mvebu_uart_release_port(struct uart_port *port)
    {
// Nothing to do here
    }
#[no_mangle]
unsafe extern "C" fn mvebu_uart_request_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_get_poll_char(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_put_poll_char(port: *mut uart_port, c: c_uchar) {
...
// Early Console
#[no_mangle]
unsafe extern "C" fn mvebu_uart_putc(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn wait_for_xmite(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_console_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_probe(pdev: *mut platform_device) -> c_int {
...
// Get fixed clock frequency
    mvuart.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_uart_clock {
    pub clk_hw: clk_hw,
    pub clock_idx: c_int,
    pub pm_context_reg1: u32,
    pub pm_context_reg2: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvebu_uart_clock_base {
    pub clocks: [mvebu_uart_clock; 2],
    pub parent_rates: [c_uint; 5],
...
pub const PARENT_CLOCK_XTAL: c_int = 4;

    struct mvebu_uart_clock_base, clocks[uart_clock.clock_idx])
#[no_mangle]
unsafe extern "C" fn mvebu_uart_clock_prepare(hw: *mut clk_hw) -> c_int {
...
// Recalculate UART1 divisor so UART1 baudrate does not change
    ...
    divisor = 1;
#[no_mangle]
pub unsafe extern "C" fn if(BRDV_BAUD_MAX: divisor >) -> else {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_clock_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_clock_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_clock_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_clock_save_context(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_clock_restore_context(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_clock_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    d1 = 1;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_TBG_DIV1_MAX: d1 >) -> else {
    ...
    d2 = 1;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_TBG_DIV2_MAX: d2 >) -> else {
...
#[no_mangle]
unsafe extern "C" fn mvebu_uart_init() -> int __init {
