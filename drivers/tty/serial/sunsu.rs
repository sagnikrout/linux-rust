...
//! Source: drivers/tty/serial/sunsu.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serial_uart_config {
    pub name: *mut c_char,
    pub dfl_xmit_fifo_size: c_int,
    pub flags: c_int,
}
...
pub struct uart_sunsu_port {
    ...
    pub cflag: c_uint,
// Probing information.
    pub su_type: enum su_type,
    pub /: *mut *mut unsigned int type_probed; / XXX Stupid,
    pub reg_size: c_ulong,

    pub serio: serio,
    pub serio_open: c_int,

}

#[no_mangle]
unsafe extern "C" fn serial_in(up: *mut uart_sunsu_port, offset: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn serial_out(up: *mut uart_sunsu_port, offset: c_int, value: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn serial_icr_write(up: *mut uart_sunsu_port, offset: c_int, value: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn __enable_rsa(up: *mut uart_sunsu_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_rsa(up: *mut uart_sunsu_port) {
...
//
#[no_mangle]
unsafe extern "C" fn disable_rsa(up: *mut uart_sunsu_port) {
...
#[no_mangle]
pub unsafe extern "C" fn __stop_tx(p: *mut uart_sunsu_port) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_enable_ms(port: *mut uart_port) {
    ...
    let mut saw_console_brk: c_int = 0;
    do {
...
// status &= ~(UART_LSR_FE | UART_LSR_PE);
    up.port.icount.brk++;
    if (up.port.cons != core::ptr::null_mut() &&
...
#[no_mangle]
unsafe extern "C" fn transmit_chars(up: *mut uart_sunsu_port) {
...
#[no_mangle]
unsafe extern "C" fn check_modem_status(up: *mut uart_sunsu_port) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_serial_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sunsu_change_mouse_baud(up: *mut uart_sunsu_port) {
    static void sunsu_change_mouse_baud(struct uart_sunsu_port *up)
    {
    let mut cur_cflag: c_uint = up.cflag;
    int quot, new_baud;
    up.cflag &= ~CBAUD;
...
#[no_mangle]
unsafe extern "C" fn receive_kbd_ms_chars(up: *mut uart_sunsu_port, is_break: c_int) {
    static void receive_kbd_ms_chars(struct uart_sunsu_port *up, int is_break)
    {
    do {
    let mut ch: c_uchar = serial_in(up, UART_RX);
// Stop-A is handled by drivers/char/keyboard.c now.
    ...
    let mut ret: c_int = suncore_mouse_baud_detection(ch, is_break);
    switch (ret) {
    case 2:
...
#[no_mangle]
unsafe extern "C" fn sunsu_kbd_ms_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t sunsu_kbd_ms_interrupt(int irq, void *dev_id)
    {
    struct uart_sunsu_port *up = dev_id;
    if (!(serial_in(up, UART_IIR) & UART_IIR_NO_INT)) {
    let mut status: c_uchar = serial_in(up, UART_LSR);
...
#[no_mangle]
unsafe extern "C" fn sunsu_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sunsu_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sunsu_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_break_ctl(port: *mut uart_port, break_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunsu_shutdown(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PORT_RSA: up->port.type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sunsu_release_port(port: *mut uart_port) {
    static void sunsu_release_port(struct uart_port *port)
    {
    }
#[no_mangle]
unsafe extern "C" fn sunsu_request_port(port: *mut uart_port) -> c_int {
    static int sunsu_request_port(struct uart_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn sunsu_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_serio_write(serio: *mut serio, ch: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunsu_serio_open(serio: *mut serio) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunsu_serio_close(serio: *mut serio) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_autoconfig(up: *mut uart_sunsu_port) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_kbd_ms_init(up: *mut uart_sunsu_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wait_for_xmitr(up: *mut uart_sunsu_port) {
...
#[no_mangle]
unsafe extern "C" fn sunsu_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn sunsu_console_setup(co: *mut console, options: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn su_get_type(dp: *mut device_node) -> enum su_type {
    static enum su_type su_get_type(struct device_node *dp)
    {
    struct device_node *ap __free(device_node) =
    of_find_node_by_path("/aliases");
    if (ap) {
    const char *keyb = of_get_property(ap, "keyboard", core::ptr::null_mut());
    const char *ms = of_get_property(ap, "mouse", core::ptr::null_mut());
    if (keyb) {
...
#[no_mangle]
unsafe extern "C" fn su_probe(op: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sunsu_init() -> int __init {
    static int __init sunsu_init(void)
    {
    struct device_node *dp;
    int err;
    let mut num_uart: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn sunsu_exit() -> void __exit {
