...
//! Source: drivers/tty/serial/meson_uart.c
#![no_std]
...
// Register offsets
pub const AML_UART_WFIFO: c_uint = 0x00;
pub const AML_UART_RFIFO: c_uint = 0x04;
pub const AML_UART_CONTROL: c_uint = 0x08;
pub const AML_UART_STATUS: c_uint = 0x0c;
pub const AML_UART_MISC: c_uint = 0x10;
pub const AML_UART_REG5: c_uint = 0x14;
...
// AML_UART_REG5 bits
pub const AML_UART_BAUD_MASK: c_uint = 0x7fffff;

pub const AML_UART_PORT_NUM: c_int = 12;
pub const AML_UART_PORT_OFFSET: c_int = 6;
pub const AML_UART_POLL_USEC: c_int = 5;
pub const AML_UART_TIMEOUT_USEC: c_int = 10000;
    static struct uart_driver meson_uart_driver_ttyAML;
    static struct uart_driver meson_uart_driver_ttyS;
    static struct uart_port *meson_ports[AML_UART_PORT_NUM];
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_uart_data {
    pub uart_driver: *mut uart_driver,
    pub has_xtal_div2: bool,
}

#[no_mangle]
unsafe extern "C" fn meson_uart_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
    static void meson_uart_set_mctrl(struct uart_port *port, unsigned int mctrl)
    {
    }
#[no_mangle]
unsafe extern "C" fn meson_uart_get_mctrl(port: *mut uart_port) -> c_uint {
    static unsigned int meson_uart_get_mctrl(struct uart_port *port)
    {
    return TIOCM_CTS;
    }
#[no_mangle]
unsafe extern "C" fn meson_uart_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn meson_receive_chars(port: *mut uart_port) {
    ...
    port.icount.overrun++;
#[no_mangle]
pub unsafe extern "C" fn if(AML_UART_FRAME_ERR: status &) -> else {
    else if (status & AML_UART_FRAME_ERR)
    port.icount.frame++;
#[no_mangle]
pub unsafe extern "C" fn if(AML_UART_PARITY_ERR: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    {
    return (port.type == PORT_MESON) ? "meson_uart" : core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn meson_uart_reset(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_change_speed(port: *mut uart_port, baud: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_release_port(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_request_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_config_port(port: *mut uart_port, flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn meson_uart_poll_get_char(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_poll_put_char(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn meson_uart_enable_tx_engine(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn meson_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn meson_serial_console_setup(co: *mut console, options: *mut c_char) -> c_int {
    ...
    struct uart_port *port)
    {
    struct clk *clk_xtal = core::ptr::null_mut();
    struct clk *clk_pclk = core::ptr::null_mut();
    struct clk *clk_baud = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn meson_uart_probe(pdev: *mut platform_device) -> c_int {
...
// reset port before registering (and possibly registering console)
    ...
    if (ret)
    meson_ports[pdev.id] = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn meson_uart_remove(pdev: *mut platform_device) {
