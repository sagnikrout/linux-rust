...
//! Source: drivers/tty/serial/samsung_tty.c
#![no_std]
...
pub const S3C24XX_SERIAL_MAJOR: c_int = 204;
pub const S3C24XX_SERIAL_MINOR: c_int = 64;

pub const UART_NR: c_int = 18;

pub const S3C24XX_TX_PIO: c_int = 1;
pub const S3C24XX_TX_DMA: c_int = 2;
pub const S3C24XX_RX_PIO: c_int = 1;
pub const S3C24XX_RX_DMA: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c24xx_uart_info {
    pub name: *const c_char,
    pub type: enum s3c24xx_port_type,
    pub port_type: c_uint,
    pub fifosize: c_uint,
    pub rx_fifomask: u32,
    pub rx_fifoshift: u32,
    pub rx_fifofull: u32,
    pub tx_fifomask: u32,
    pub tx_fifoshift: u32,
    pub tx_fifofull: u32,
    pub clksel_mask: u32,
    pub clksel_shift: u32,
    pub ucon_mask: u32,
    pub def_clk_sel: u8,
    pub num_clks: u8,
    pub iotype: u8,
// uart port features
    pub has_divslot: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c24xx_serial_drv_data {
    pub info: s3c24xx_uart_info,
    pub def_cfg: s3c2410_uartcfg,
    pub fifosize: [c_uint; UART_NR],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c24xx_uart_dma {
    pub rx_chan_id: c_uint,
    pub tx_chan_id: c_uint,
    ...
    pub rx_buf: *mut c_char,
    pub tx_transfer_addr: dma_addr_t,
    pub rx_size: usize,
    pub tx_size: usize,
    pub tx_desc: *mut dma_async_tx_descriptor,
    pub rx_desc: *mut dma_async_tx_descriptor,
    pub tx_bytes_requested: c_int,
    pub rx_bytes_requested: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s3c24xx_uart_port {
    pub rx_enabled: c_uchar,
    pub tx_enabled: c_uchar,
    pub pm_level: c_uint,
    pub baudclk_rate: c_ulong,
    pub min_dma_size: c_uint,
    pub rx_irq: c_uint,
    pub tx_irq: c_uint,
    pub tx_in_progress: c_uint,
    pub tx_mode: c_uint,
    pub rx_mode: c_uint,
    pub info: *const s3c24xx_uart_info,
    pub clk: *mut clk,
    pub baudclk: *mut clk,
    pub port: uart_port,
    pub drv_data: *const s3c24xx_serial_drv_data,
// reference to platform data
    pub cfg: *const s3c2410_uartcfg,
    pub dma: *mut s3c24xx_uart_dma,
}
...
#[no_mangle]
unsafe extern "C" fn rd_reg(port: *const uart_port, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn wr_reg(port: *const uart_port, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_txempty_nofifo(port: *const uart_port) -> bool {
    static bool s3c24xx_serial_txempty_nofifo(const struct uart_port *port)
    {
    return rd_regl(port, S3C2410_UTRSTAT) & S3C2410_UTRSTAT_TXE;
    }
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_rx_enable(port: *mut uart_port) {
    static void s3c24xx_serial_rx_enable(struct uart_port *port)
    {
    struct s3c24xx_uart_port *ourport = to_ourport(port);
    let mut count: c_int = 10000;
    u32 ucon, ufcon;
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_rx_disable(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_tx_dma_complete(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn enable_tx_dma(ourport: *mut s3c24xx_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn enable_tx_pio(ourport: *mut s3c24xx_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_start_tx_pio(ourport: *mut s3c24xx_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_start_next_tx(ourport: *mut s3c24xx_uart_port) {
    static void s3c24xx_serial_start_next_tx(struct s3c24xx_uart_port *ourport)
    {
    struct uart_port *port = &ourport.port;
    struct tty_port *tport = &port.state.port;
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_rx_dma_complete(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_start_rx_dma(ourport: *mut s3c24xx_uart_port) {
    static void s3c64xx_start_rx_dma(struct s3c24xx_uart_port *ourport)
    {
    struct s3c24xx_uart_dma *dma = ourport.dma;
...
#[no_mangle]
unsafe extern "C" fn enable_rx_dma(ourport: *mut s3c24xx_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn enable_rx_pio(ourport: *mut s3c24xx_uart_port) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_rx_chars_dma(ourport: *mut s3c24xx_uart_port) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_rx_drain_fifo(ourport: *mut s3c24xx_uart_port) {
    static void s3c24xx_serial_rx_drain_fifo(struct s3c24xx_uart_port *ourport)
    {
    struct uart_port *port = &ourport.port;
    let mut max_count: c_uint = port.fifosize;
    let mut fifocnt: c_uint = 0;
...
//
    ...
    if (uart_cons_flow_enabled(port)) {
    let mut txe: bool = s3c24xx_serial_txempty_nofifo(port);
    if (ourport.rx_enabled) {
    if (!txe) {
    ourport.rx_enabled = 0;
    continue;
...
// check for break
    ...
    flag = TTY_BREAK;
#[no_mangle]
pub unsafe extern "C" fn if(S3C2410_UERSTAT_PARITY: uerstat &) -> else {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_rx_chars_pio(ourport: *mut s3c24xx_uart_port) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_rx_irq(ourport: *mut s3c24xx_uart_port) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_tx_chars(ourport: *mut s3c24xx_uart_port) {
    static void s3c24xx_serial_tx_chars(struct s3c24xx_uart_port *ourport)
    {
    struct uart_port *port = &ourport.port;
    struct tty_port *tport = &port.state.port;
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_tx_irq(ourport: *mut s3c24xx_uart_port) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_serial_handle_irq(irq: c_int, id: *mut c_void) -> irqreturn_t {
    static irqreturn_t s3c64xx_serial_handle_irq(int irq, void *id)
    {
    struct s3c24xx_uart_port *ourport = id;
    const struct uart_port *port = &ourport.port;
    let mut pend: u32 = rd_regl(port, S3C64XX_UINTP);
...
#[no_mangle]
unsafe extern "C" fn apple_serial_handle_irq(irq: c_int, id: *mut c_void) -> irqreturn_t {
    static irqreturn_t apple_serial_handle_irq(int irq, void *id)
    {
    struct s3c24xx_uart_port *ourport = id;
    const struct uart_port *port = &ourport.port;
    let mut pend: u32 = rd_regl(port, S3C2410_UTRSTAT);
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_tx_empty(port: *mut uart_port) -> c_uint {
    static unsigned int s3c24xx_serial_tx_empty(struct uart_port *port)
    {
    const struct s3c24xx_uart_info *info = s3c24xx_port_to_info(port);
    let mut ufstat: u32 = rd_regl(port, S3C2410_UFSTAT);
    let mut ufcon: u32 = rd_regl(port, S3C2410_UFCON);
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_get_mctrl(port: *mut uart_port) -> c_uint {
    static unsigned int s3c24xx_serial_get_mctrl(struct uart_port *port)
    {
    let mut umstat: u32 = rd_reg(port, S3C2410_UMSTAT);
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
    static void s3c24xx_serial_set_mctrl(struct uart_port *port, unsigned int mctrl)
    {
    let mut umcon: u32 = rd_regl(port, S3C2410_UMCON);
    let mut ucon: u32 = rd_regl(port, S3C2410_UCON);
    if (mctrl & TIOCM_RTS)
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_break_ctl(port: *mut uart_port, break_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_request_dma(p: *mut s3c24xx_uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_release_dma(p: *mut s3c24xx_uart_port) {
    ...
    dma_release_channel(dma.tx_chan);
    dma.tx_chan = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn s3c64xx_serial_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn apple_s5l_serial_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn s3c64xx_serial_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_s5l_serial_startup(port: *mut uart_port) -> c_int {
...
//
pub const MAX_CLK_NAME_LENGTH: c_int = 15;
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_serial_getsource(port: *mut uart_port) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_setsource(port: *mut uart_port, clk_sel: u8) {
...
// Keep selected clock if provided
    ...
    let mut div: c_ulong = rate / req_baud;
...
//
    ...
    let mut udivslot: c_uint = 0;
    u32 ulcon, umcon;
    let mut clk_sel: u8 = 0;
//
...
// check to see if we need  to change clock source
    ...
    if (ourport.info.has_divslot) {
    let mut div: c_uint = ourport.baudclk_rate / baud;
    if (cfg.has_fracval) {
    udivslot = (div & 15);
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_register_console() -> void __init {
    static void __init s3c24xx_serial_register_console(void)
    {
    register_console(&s3c24xx_serial_console);
    }
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_unregister_console() {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_init_port_default(index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_enable_baudclk(ourport: *mut s3c24xx_uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_probe(pdev: *mut platform_device) -> c_int {
    static int s3c24xx_serial_probe(struct platform_device *pdev)
    {
    struct device_node *np = pdev.dev.of_node;
    struct s3c24xx_uart_port *ourport;
    let mut index: c_int = probe_index;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ourport->info->fifosize) -> else {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_resume_noirq(dev: *mut device) -> c_int {
...
// restore IRQ mask
    ...
    SET_NOIRQ_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), s3c24xx_serial_resume_noirq)
    };
...
//
#[no_mangle]
unsafe extern "C" fn s3c24xx_serial_get_poll_char(port: *mut uart_port) -> c_int {
    static int s3c24xx_serial_get_poll_char(struct uart_port *port)
    {
    const struct s3c24xx_uart_port *ourport = to_ourport(port);
    u32 ufstat;
...
// not possible to xmit on unconfigured port
    ...
    unsigned int count)
    {
    let mut ucon: u32 = rd_regl(cons_uart, S3C2410_UCON);
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn samsung_serial_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn samsung_serial_exit() -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn wr_reg_barrier(port: *const uart_port, reg: u32, val: u32) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct samsung_early_console_data {
    pub txfull_mask: u32,
    pub rxfifo_mask: u32,
}

#[no_mangle]
unsafe extern "C" fn samsung_early_busyuart(port: *const uart_port) {
...
#[no_mangle]
unsafe extern "C" fn samsung_early_busyuart_fifo(port: *const uart_port) {
...
#[no_mangle]
unsafe extern "C" fn samsung_early_putc(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn samsung_early_read(con: *mut console, s: *mut c_char, n: c_uint) -> c_int {
