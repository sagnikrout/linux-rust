...
//! Source: drivers/tty/serial/msm_serial.c
#![no_std]
...
pub const MSM_UART_MR1: c_uint = 0x0000;
pub const MSM_UART_MR1_AUTO_RFR_LEVEL0: c_uint = 0x3F;
pub const MSM_UART_MR1_AUTO_RFR_LEVEL1: c_uint = 0x3FF00;
pub const MSM_UART_DM_MR1_AUTO_RFR_LEVEL1: c_uint = 0xFFFFFF00;

pub const MSM_UART_MR2: c_uint = 0x0004;

pub const MSM_UART_MR2_BITS_PER_CHAR: c_uint = 0x30;

pub const MSM_UART_MR2_PARITY_MODE_NONE: c_uint = 0x0;
pub const MSM_UART_MR2_PARITY_MODE_ODD: c_uint = 0x1;
pub const MSM_UART_MR2_PARITY_MODE_EVEN: c_uint = 0x2;
pub const MSM_UART_MR2_PARITY_MODE_SPACE: c_uint = 0x3;
pub const MSM_UART_MR2_PARITY_MODE: c_uint = 0x3;
pub const MSM_UART_CSR: c_uint = 0x0008;
pub const MSM_UART_TF: c_uint = 0x000C;
pub const UARTDM_TF: c_uint = 0x0070;
pub const MSM_UART_CR: c_uint = 0x0010;

pub const MSM_UART_IMR: c_uint = 0x0014;

pub const MSM_UART_IPR_RXSTALE_LAST: c_uint = 0x20;
pub const MSM_UART_IPR_STALE_LSB: c_uint = 0x1F;
pub const MSM_UART_IPR_STALE_TIMEOUT_MSB: c_uint = 0x3FF80;
pub const MSM_UART_DM_IPR_STALE_TIMEOUT_MSB: c_uint = 0xFFFFFF80;
pub const MSM_UART_IPR: c_uint = 0x0018;
pub const MSM_UART_TFWR: c_uint = 0x001C;
pub const MSM_UART_RFWR: c_uint = 0x0020;
pub const MSM_UART_HCR: c_uint = 0x0024;
pub const MSM_UART_MREG: c_uint = 0x0028;
pub const MSM_UART_NREG: c_uint = 0x002C;
pub const MSM_UART_DREG: c_uint = 0x0030;
pub const MSM_UART_MNDREG: c_uint = 0x0034;
pub const MSM_UART_IRDA: c_uint = 0x0038;
pub const MSM_UART_MISR_MODE: c_uint = 0x0040;
pub const MSM_UART_MISR_RESET: c_uint = 0x0044;
pub const MSM_UART_MISR_EXPORT: c_uint = 0x0048;
pub const MSM_UART_MISR_VAL: c_uint = 0x004C;
pub const MSM_UART_TEST_CTRL: c_uint = 0x0050;
pub const MSM_UART_SR: c_uint = 0x0008;

pub const MSM_UART_RF: c_uint = 0x000C;
pub const UARTDM_RF: c_uint = 0x0070;
pub const MSM_UART_MISR: c_uint = 0x0010;
pub const MSM_UART_ISR: c_uint = 0x0014;

pub const UARTDM_RXFS: c_uint = 0x50;
pub const UARTDM_RXFS_BUF_SHIFT: c_uint = 0x7;
pub const UARTDM_RXFS_BUF_MASK: c_uint = 0x7;
pub const UARTDM_DMEN: c_uint = 0x3C;

pub const UARTDM_DMRX: c_uint = 0x34;
pub const UARTDM_NCF_TX: c_uint = 0x40;
pub const UARTDM_RX_TOTAL_SNAP: c_uint = 0x38;
...
pub struct msm_port {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn msm_write(port: *mut uart_port, val: c_uint, off: c_uint) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn msm_read(port: *mut uart_port, off: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn msm_serial_set_mnd_regs_tcxo(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn msm_serial_set_mnd_regs_tcxoby4(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_serial_set_mnd_regs(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn if(4800000: port->uartclk ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn msm_stop_dma(port: *mut uart_port, dma: *mut msm_dma) {
...
#[no_mangle]
unsafe extern "C" fn msm_release_dma(msm_port: *mut msm_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_request_tx_dma(msm_port: *mut msm_port, base: resource_size_t) {
    static void msm_request_tx_dma(struct msm_port *msm_port, resource_size_t base)
    {
    struct device *dev = msm_port.uart.dev;
    struct dma_slave_config conf;
    let mut periph_conf: qcom_adm_peripheral_config = {};
    struct msm_dma *dma;
    let mut crci: u32 = 0;
    int ret;
    dma = &msm_port.tx_dma;
...
#[no_mangle]
unsafe extern "C" fn msm_request_rx_dma(msm_port: *mut msm_port, base: resource_size_t) {
...
#[no_mangle]
pub unsafe extern "C" fn msm_wait_for_xmitr(port: *mut uart_port) {
    static inline void msm_wait_for_xmitr(struct uart_port *port)
    {
    let mut timeout: c_uint = 500000;
...
#[no_mangle]
unsafe extern "C" fn msm_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_reset_dm_count(port: *mut uart_port, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn msm_complete_tx_dma(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn msm_handle_tx_dma(msm_port: *mut msm_port, count: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_complete_rx_dma(args: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn msm_start_rx_dma(msm_port: *mut msm_port) {
    static void msm_start_rx_dma(struct msm_port *msm_port)
    {
    struct msm_dma *dma = &msm_port.rx_dma;
...
#[no_mangle]
unsafe extern "C" fn msm_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_enable_ms(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_handle_rx_dm(port: *mut uart_port, misr: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn msm_handle_rx(port: *mut uart_port) {
...
// Mask conditions we're ignoring.
    ...
    flag = TTY_BREAK;
#[no_mangle]
pub unsafe extern "C" fn if(MSM_UART_SR_PAR_FRAME_ERR: sr &) -> else {
    else if (sr & MSM_UART_SR_PAR_FRAME_ERR)
    flag = TTY_FRAME;
...
#[no_mangle]
unsafe extern "C" fn msm_handle_tx_pio(port: *mut uart_port, tx_count: c_uint) {
    static void msm_handle_tx_pio(struct uart_port *port, unsigned int tx_count)
    {
    struct msm_port *msm_port = to_msm_port(port);
    struct tty_port *tport = &port.state.port;
    unsigned int num_chars;
    let mut tf_pointer: c_uint = 0;
    void __iomem *tf;
    if (msm_port.is_uartdm)
...
#[no_mangle]
unsafe extern "C" fn msm_handle_tx(port: *mut uart_port) {
    static void msm_handle_tx(struct uart_port *port)
    {
    struct msm_port *msm_port = to_msm_port(port);
    struct tty_port *tport = &port.state.port;
    ...
    dma_count = pio_count = kfifo_out_linear(&tport.xmit_fifo, core::ptr::null_mut(),
    UART_XMIT_SIZE);
...
#[no_mangle]
unsafe extern "C" fn msm_handle_delta_cts(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_uart_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn msm_tx_empty(port: *mut uart_port) -> c_uint {
    static unsigned int msm_tx_empty(struct uart_port *port)
    {
    return (msm_read(port, MSM_UART_SR) & MSM_UART_SR_TX_EMPTY) ? TIOCSER_TEMT : 0;
    }
#[no_mangle]
unsafe extern "C" fn msm_get_mctrl(port: *mut uart_port) -> c_uint {
    static unsigned int msm_get_mctrl(struct uart_port *port)
    {
    return TIOCM_CAR | TIOCM_CTS | TIOCM_DSR | TIOCM_RTS;
    }
#[no_mangle]
unsafe extern "C" fn msm_reset(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn msm_break_ctl(port: *mut uart_port, break_ctl: c_int) {
...
#[no_mangle]
unsafe extern "C" fn msm_init_clock(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_shutdown(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CMSPAR: termios->c_cflag &) -> else {
...
#[no_mangle]
unsafe extern "C" fn msm_release_port(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn msm_request_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn msm_verify_port(port: *mut uart_port, ser: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_poll_get_char_single(port: *mut uart_port) -> c_int {
    static int msm_poll_get_char_single(struct uart_port *port)
    {
    struct msm_port *msm_port = to_msm_port(port);
    let mut rf_reg: c_uint = msm_port.is_uartdm ? UARTDM_RF : MSM_UART_RF;
    if (!(msm_read(port, MSM_UART_SR) & MSM_UART_SR_RX_READY))
    return NO_POLL_CHAR;
    return msm_read(port, rf_reg) & 0xff;
    }
#[no_mangle]
unsafe extern "C" fn msm_poll_get_char_dm(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_poll_get_char(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_poll_put_char(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn msm_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
// Disable DM / single-character modes
    ...
    let mut msm_uart_next_id: static atomic_t = ATOMIC_INIT(0);
...
#[no_mangle]
unsafe extern "C" fn msm_serial_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msm_serial_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn msm_serial_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn msm_serial_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn msm_serial_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn msm_serial_exit() -> void __exit {
