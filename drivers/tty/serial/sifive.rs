...
//! Source: drivers/tty/serial/sifive.c
#![no_std]
...
//
// TXDATA
pub const SIFIVE_SERIAL_TXDATA_OFFS: c_uint = 0x0;
pub const SIFIVE_SERIAL_TXDATA_FULL_SHIFT: c_int = 31;

pub const SIFIVE_SERIAL_TXDATA_DATA_SHIFT: c_int = 0;

// RXDATA
pub const SIFIVE_SERIAL_RXDATA_OFFS: c_uint = 0x4;
pub const SIFIVE_SERIAL_RXDATA_EMPTY_SHIFT: c_int = 31;

pub const SIFIVE_SERIAL_RXDATA_DATA_SHIFT: c_int = 0;

// TXCTRL
pub const SIFIVE_SERIAL_TXCTRL_OFFS: c_uint = 0x8;
pub const SIFIVE_SERIAL_TXCTRL_TXCNT_SHIFT: c_int = 16;

pub const SIFIVE_SERIAL_TXCTRL_NSTOP_SHIFT: c_int = 1;

pub const SIFIVE_SERIAL_TXCTRL_TXEN_SHIFT: c_int = 0;

// RXCTRL
pub const SIFIVE_SERIAL_RXCTRL_OFFS: c_uint = 0xC;
pub const SIFIVE_SERIAL_RXCTRL_RXCNT_SHIFT: c_int = 16;

pub const SIFIVE_SERIAL_RXCTRL_RXEN_SHIFT: c_int = 0;

// IE
pub const SIFIVE_SERIAL_IE_OFFS: c_uint = 0x10;
pub const SIFIVE_SERIAL_IE_RXWM_SHIFT: c_int = 1;

pub const SIFIVE_SERIAL_IE_TXWM_SHIFT: c_int = 0;

// IP
pub const SIFIVE_SERIAL_IP_OFFS: c_uint = 0x14;
pub const SIFIVE_SERIAL_IP_RXWM_SHIFT: c_int = 1;

pub const SIFIVE_SERIAL_IP_TXWM_SHIFT: c_int = 0;

// DIV
pub const SIFIVE_SERIAL_DIV_OFFS: c_uint = 0x18;
pub const SIFIVE_SERIAL_DIV_DIV_SHIFT: c_int = 0;
...
//
pub const SIFIVE_SERIAL_MAX_PORTS: c_int = 8;
//
// SIFIVE_DEFAULT_BAUD_RATE: default baud rate that the driver should
// configure itself to use
//
pub const SIFIVE_DEFAULT_BAUD_RATE: c_int = 115200;
...
pub const SIFIVE_TX_FIFO_DEPTH: c_int = 8;
// SIFIVE_RX_FIFO_DEPTH: depth of the TX FIFO (in bytes)
pub const SIFIVE_RX_FIFO_DEPTH: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sifive_serial_port {
    pub port: uart_port,
    pub dev: *mut device,
    pub ier: c_uchar,
    pub baud_rate: c_ulong,
    pub clk: *mut clk,
    pub clk_notifier: notifier_block,
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_early_writel(v: u32, offs: u16, port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_early_readl(port: *mut uart_port, offs: u16) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_writel(v: u32, offs: u16, ssp: *mut sifive_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_readl(ssp: *mut sifive_serial_port, offs: u16) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn sifive_serial_is_txfifo_full(ssp: *mut sifive_serial_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_transmit_char(ssp: *mut sifive_serial_port, ch: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_transmit_chars(ssp: *mut sifive_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_enable_txwm(ssp: *mut sifive_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_enable_rxwm(ssp: *mut sifive_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_disable_txwm(ssp: *mut sifive_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_disable_rxwm(ssp: *mut sifive_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_receive_char(ssp: *mut sifive_serial_port, is_empty: *mut c_char) -> c_char {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_receive_chars(ssp: *mut sifive_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_update_div(ssp: *mut sifive_serial_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_set_stop_bits(ssp: *mut sifive_serial_port, nstop: c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn __ssp_wait_for_xmitr(ssp: *mut sifive_serial_port) -> void __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn sifive_serial_stop_tx(port: *mut uart_port) {
    static void sifive_serial_stop_tx(struct uart_port *port)
    {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_release_port(port: *mut uart_port) {
    static void sifive_serial_release_port(struct uart_port *port)
    {
    }
#[no_mangle]
unsafe extern "C" fn sifive_serial_request_port(port: *mut uart_port) -> c_int {
    static int sifive_serial_request_port(struct uart_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn sifive_serial_config_port(port: *mut uart_port, flags: c_int) {
    ...
    {
    return port.type == PORT_SIFIVE_V0 ? "SiFive UART v0" : core::ptr::null_mut();
    }

#[no_mangle]
unsafe extern "C" fn sifive_serial_poll_get_char(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn early_sifive_serial_putc(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_device_lock(co: *mut console, flags: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_device_unlock(co: *mut console, flags: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_console_setup(co: *mut console, options: *mut c_char) -> c_int {
    static int sifive_serial_console_setup(struct console *co, char *options)
    {
    struct sifive_serial_port *ssp;
    let mut baud: c_int = SIFIVE_DEFAULT_BAUD_RATE;
...
#[no_mangle]
unsafe extern "C" fn sifive_console_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn __ssp_add_console_port(ssp: *mut sifive_serial_port) {
    static void __ssp_add_console_port(struct sifive_serial_port *ssp)
    {
    sifive_serial_console_ports[ssp.port.line] = ssp;
    }
#[no_mangle]
unsafe extern "C" fn __ssp_remove_console_port(ssp: *mut sifive_serial_port) {
    static void __ssp_remove_console_port(struct sifive_serial_port *ssp)
    {
    sifive_serial_console_ports[ssp.port.line] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sifive_serial_exit() -> void __exit {
