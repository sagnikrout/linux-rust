...
//! Source: drivers/tty/serial/arc_uart.c
#![no_std]
...
//
pub const ARC_UART_TX_FIFO_SIZE: c_int = 1;
//
// UART Register set (this is not a Standards Compliant IP)
// Also each reg is Word aligned, but only 8 bits wide
//
pub const R_ID0: c_int = 0;
pub const R_ID1: c_int = 4;
pub const R_ID2: c_int = 8;
pub const R_ID3: c_int = 12;
pub const R_DATA: c_int = 16;
pub const R_STS: c_int = 20;
pub const R_BAUDL: c_int = 24;
pub const R_BAUDH: c_int = 28;
// Bits for UART Status Reg (R/W)
pub const RXIENB: c_uint = 0x04	/* Receive Interrupt Enable */;
pub const TXIENB: c_uint = 0x40	/* Transmit Interrupt Enable */;
pub const RXEMPTY: c_uint = 0x20	/* Receive FIFO Empty: No char receivede */;
pub const TXEMPTY: c_uint = 0x80	/* Transmit FIFO Empty, thus char can be written into */;
pub const RXFULL: c_uint = 0x08	/* Receive FIFO full */;
pub const RXFULL1: c_uint = 0x10	/* Receive FIFO has space for 1 char (tot space=4) */;
pub const RXFERR: c_uint = 0x01	/* Frame Error: Stop Bit not detected */;
pub const RXOERR: c_uint = 0x02	/* OverFlow Err: Char recv but RXFULL still set */;
...
#[no_mangle]
unsafe extern "C" fn arc_serial_stop_rx(port: *mut uart_port) {
    static void arc_serial_stop_rx(struct uart_port *port)
    {
    UART_RX_IRQ_DISABLE(port);
    }
#[no_mangle]
unsafe extern "C" fn arc_serial_stop_tx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_serial_tx_empty(port: *mut uart_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn arc_serial_tx_chars(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_serial_start_tx(port: *mut uart_port) {
    static void arc_serial_start_tx(struct uart_port *port)
    {
    arc_serial_tx_chars(port);
    }
#[no_mangle]
unsafe extern "C" fn arc_serial_rx_chars(port: *mut uart_port, status: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn arc_serial_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
    static void arc_serial_set_mctrl(struct uart_port *port, unsigned int mctrl)
    {
// MCR not present
    }
#[no_mangle]
unsafe extern "C" fn arc_serial_break_ctl(port: *mut uart_port, break_state: c_int) {
    static void arc_serial_break_ctl(struct uart_port *port, int break_state)
    {
// ARC UART doesn't support sending Break signal
    }
#[no_mangle]
unsafe extern "C" fn arc_serial_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_shutdown(port: *mut uart_port) {
...
// Don't rewrite B0
    ...
    {
    return port.type == PORT_ARC ? DRIVER_NAME : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn arc_serial_release_port(port: *mut uart_port) {
    static void arc_serial_release_port(struct uart_port *port)
    {
    }
#[no_mangle]
unsafe extern "C" fn arc_serial_request_port(port: *mut uart_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arc_serial_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_poll_putchar(port: *mut uart_port, chr: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_poll_getchar(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn arc_serial_exit() -> void __exit {
