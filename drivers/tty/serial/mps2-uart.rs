...
//! Source: drivers/tty/serial/mps2-uart.c
#![no_std]
...
pub const UARTn_DATA: c_uint = 0x00;
pub const UARTn_STATE: c_uint = 0x04;

pub const UARTn_CTRL: c_uint = 0x08;

pub const UARTn_INT: c_uint = 0x0c;

pub const UARTn_BAUDDIV: c_uint = 0x10;
...
pub const MPS2_MAX_PORTS: c_int = 3;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mps2_uart_port {
    pub port: uart_port,
    pub clk: *mut clk,
    pub tx_irq: c_uint,
    pub rx_irq: c_uint,
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_write8(port: *mut uart_port, val: u8, off: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_read8(port: *mut uart_port, off: c_uint) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_write32(port: *mut uart_port, val: u32, off: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_tx_empty(port: *mut uart_port) -> c_uint {
    static unsigned int mps2_uart_tx_empty(struct uart_port *port)
    {
    let mut status: u8 = mps2_uart_read8(port, UARTn_STATE);
    return (status & UARTn_STATE_TX_FULL) ? 0 : TIOCSER_TEMT;
    }
#[no_mangle]
unsafe extern "C" fn mps2_uart_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
    static void mps2_uart_set_mctrl(struct uart_port *port, unsigned int mctrl)
    {
    }
#[no_mangle]
unsafe extern "C" fn mps2_uart_get_mctrl(port: *mut uart_port) -> c_uint {
    static unsigned int mps2_uart_get_mctrl(struct uart_port *port)
    {
    return TIOCM_CAR | TIOCM_CTS | TIOCM_DSR;
    }
#[no_mangle]
unsafe extern "C" fn mps2_uart_stop_tx(port: *mut uart_port) {
    static void mps2_uart_stop_tx(struct uart_port *port)
    {
    let mut control: u8 = mps2_uart_read8(port, UARTn_CTRL);
    control &= ~UARTn_CTRL_TX_INT_ENABLE;
    mps2_uart_write8(port, control, UARTn_CTRL);
    }
#[no_mangle]
unsafe extern "C" fn mps2_uart_tx_chars(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_rxirq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t mps2_uart_rxirq(int irq, void *data)
    {
    struct uart_port *port = data;
    let mut irqflag: u8 = mps2_uart_read8(port, UARTn_INT);
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_txirq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_oerrirq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_combinedirq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_shutdown(port: *mut uart_port) {
    ...
    {
    return (port.type == PORT_MPS2UART) ? DRIVER_NAME : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mps2_uart_release_port(port: *mut uart_port) {
    static void mps2_uart_release_port(struct uart_port *port)
    {
    }
#[no_mangle]
unsafe extern "C" fn mps2_uart_request_port(port: *mut uart_port) -> c_int {
    static int mps2_uart_request_port(struct uart_port *port)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mps2_uart_config_port(port: *mut uart_port, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_verify_port(port: *mut uart_port, serinfo: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_console_write(co: *mut console, s: *const c_char, cnt: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mps2_early_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn mps2_early_write(con: *mut console, s: *const c_char, n: c_uint) {
...
// Only combined irq is presesnt
    ...
    mps_port.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mps2_serial_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mps2_uart_init() -> int __init {
