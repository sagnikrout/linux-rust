...
//! Source: drivers/tty/serial/sh-sci.c
#![no_std]
...
pub const SCI_MAJOR: c_int = 204;
pub const SCI_MINOR_START: c_int = 8;
//
...
pub const SCSMR_CKS: c_uint = 0x0003	/* Clock Select */;
// Serial Mode Register, SCIFA/SCIFB only bits

pub const SCSMR_SRC_MASK: c_uint = 0x0700	/* Sampling Control */;
pub const SCSMR_SRC_16: c_uint = 0x0000	/* Sampling rate 1/16 */;
pub const SCSMR_SRC_5: c_uint = 0x0100	/* Sampling rate 1/5 */;
pub const SCSMR_SRC_7: c_uint = 0x0200	/* Sampling rate 1/7 */;
pub const SCSMR_SRC_11: c_uint = 0x0300	/* Sampling rate 1/11 */;
pub const SCSMR_SRC_13: c_uint = 0x0400	/* Sampling rate 1/13 */;
pub const SCSMR_SRC_17: c_uint = 0x0500	/* Sampling rate 1/17 */;
pub const SCSMR_SRC_19: c_uint = 0x0600	/* Sampling rate 1/19 */;
pub const SCSMR_SRC_27: c_uint = 0x0700	/* Sampling rate 1/27 */;
// Serial Control Register, SCI only bits

// Serial Control Register, SCIFA/SCIFB only bits

// Serial Control Register, HSCIF-only bits
pub const HSSCR_TOT_SHIFT: c_int = 14;
// SCxSR (Serial Status Register) on SCI

pub const SCI_RESERVED: c_uint = 0x03	/* All reserved bits */;

// SCxSR (Serial Status Register) on SCIF, SCIFA, SCIFB, HSCIF

// SCIF only (optional)
pub const SCIF_PERC: c_uint = 0xf000	/* Number of Parity Errors */;
pub const SCIF_FERC: c_uint = 0x0f00	/* Number of Framing Errors */;
...
pub const HSCIF_SRHP_SHIFT: c_int = 8;
pub const HSCIF_SRHP_MASK: c_uint = 0x0f00;
...
#[no_mangle]
unsafe extern "C" fn sci_suspend_regs_size() -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn sci_serial_in(p: *mut uart_port, offset: c_int) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(16: reg->size ==) -> else {
    else if (reg.size == 16)
...
#[no_mangle]
unsafe extern "C" fn sci_serial_out(p: *mut uart_port, offset: c_int, value: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sci_port_enable(sci_port: *mut sci_port) {
...
#[no_mangle]
pub unsafe extern "C" fn sci_port_disable(sci_port: *mut sci_port) {
...
#[no_mangle]
pub unsafe extern "C" fn port_rx_irq_mask(port: *mut uart_port) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn sci_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_start_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_stop_rx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_clear_SCxSR(port: *mut uart_port, mask: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sci_poll_get_char(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_poll_put_char(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn sci_init_pins(port: *mut uart_port, cflag: c_uint) {
...
//
    ...
    if (s.type == PORT_SCIFA || s.type == PORT_SCIFB) {
    let mut data: u16 = sci_serial_in(port, SCPDR);
    let mut ctrl: u16 = sci_serial_in(port, SCPCR);
...
// Enable CTS# pin function
    ...
    let mut status: u16 = sci_serial_in(port, SCSPTR);
// RTS# is always output; and active low, unless autorts
    status |= SCSPTR_RTSIO;
    if (!(port.mctrl & TIOCM_RTS))
    status |= SCSPTR_RTSDT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !s->autorts) -> else {
    else if (!s.autorts)
    status &= ~SCSPTR_RTSDT;
...
#[no_mangle]
unsafe extern "C" fn sci_txfill(port: *mut uart_port) -> c_int {
    static int sci_txfill(struct uart_port *port)
    {
    struct sci_port *s = to_sci_port(port);
    let mut fifo_mask: c_uint = (s.params.fifosize << 1) - 1;
...
#[no_mangle]
unsafe extern "C" fn sci_txroom(port: *mut uart_port) -> c_int {
    static int sci_txroom(struct uart_port *port)
    {
    return port.fifosize - sci_txfill(port);
    }
#[no_mangle]
unsafe extern "C" fn sci_rxfill(port: *mut uart_port) -> c_int {
...
// **********************************************************************
#[no_mangle]
unsafe extern "C" fn sci_transmit_chars(port: *mut uart_port) {
    static void sci_transmit_chars(struct uart_port *port)
    {
    struct tty_port *tport = &port.state.port;
    let mut stopped: c_uint = uart_tx_stopped(port);
    struct sci_port *s = to_sci_port(port);
    unsigned short status;
    unsigned short ctrl;
    int count;
...
#[no_mangle]
unsafe extern "C" fn sci_receive_chars(port: *mut uart_port) {
...
// If for any reason we can't copy more data, we're done!
    ...
    break;
    if (s.type == PORT_SCI) {
    let mut c: c_char = sci_serial_in(port, SCxRDR);
...
#[no_mangle]
unsafe extern "C" fn sci_handle_errors(port: *mut uart_port) -> c_int {
    static int sci_handle_errors(struct uart_port *port)
    {
    let mut copied: c_int = 0;
    struct sci_port *s = to_sci_port(port);
    const struct sci_common_regs *regs = s.params.common_regs;
    let mut status: c_uint = s.ops.read_reg(port, regs.status);
    struct tty_port *tport = &port.state.port;
// Handle overruns
...
#[no_mangle]
unsafe extern "C" fn sci_is_rsci_type(type: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sci_handle_fifo_overrun(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_handle_breaks(port: *mut uart_port) -> c_int {
    static int sci_handle_breaks(struct uart_port *port)
    {
    let mut copied: c_int = 0;
    let mut status: c_ushort = sci_serial_in(port, SCxSR);
    struct tty_port *tport = &port.state.port;
...
#[no_mangle]
unsafe extern "C" fn scif_set_rtrg(port: *mut uart_port, rx_trig: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scif_rtrg_enabled(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rx_fifo_timer_fn(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn sci_dma_tx_complete(arg: *mut c_void) {
    ...
    let mut ctrl: u16 = sci_serial_in(port, SCSCR);
    sci_serial_out(port, SCSCR, ctrl & ~SCSCR_TIE);
    if (s.regtype == SCIx_RZ_SCIFA_REGTYPE) {
...
#[no_mangle]
unsafe extern "C" fn sci_dma_rx_push(s: *mut sci_port, buf: *mut c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_dma_rx_find_active(s: *mut sci_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_dma_rx_chan_invalidate(s: *mut sci_port) {
    static void sci_dma_rx_chan_invalidate(struct sci_port *s)
    {
    unsigned int i;
    s.chan_rx = core::ptr::null_mut();
    for (i = 0; i < ARRAY_SIZE(s.cookie_rx); i++)
    s.cookie_rx[i] = -EINVAL;
    s.active_rx = 0;
    }
#[no_mangle]
unsafe extern "C" fn sci_dma_rx_release(s: *mut sci_port) {
    ...
    unsigned long flags;
    uart_port_lock_irqsave(port, &flags);
    s.chan_rx_saved = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn start_hrtimer_us(hrt: *mut hrtimer, usec: c_ulong) {
    static void start_hrtimer_us(struct hrtimer *hrt, unsigned long usec)
    {
    let mut sec: c_long = usec / 1000000;
    let mut nsec: c_long = (usec % 1000000) * 1000;
    let mut t: ktime_t = ktime_set(sec, nsec);
    hrtimer_start(hrt, t, HRTIMER_MODE_REL);
    }
#[no_mangle]
unsafe extern "C" fn sci_dma_rx_reenable_irq(s: *mut sci_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_dma_rx_complete(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sci_dma_tx_release(s: *mut sci_port) {
    static void sci_dma_tx_release(struct sci_port *s)
    {
    struct dma_chan *chan = s.chan_tx_saved;
    cancel_work_sync(&s.work_tx);
    s.chan_tx_saved = s.chan_tx = core::ptr::null_mut();
    s.cookie_tx = -EINVAL;
    dmaengine_terminate_sync(chan);
...
#[no_mangle]
unsafe extern "C" fn sci_dma_rx_submit(s: *mut sci_port, port_lock_held: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_dma_tx_work_fn(work: *mut work_struct) {
...
// Transmit buffer has been flushed
    ...
    switch_to_pio:
    uart_port_lock_irqsave(port, &flags);
    s.chan_tx = core::ptr::null_mut();
    sci_start_tx(port);
    uart_port_unlock_irqrestore(port, flags);
    return;
    }
#[no_mangle]
unsafe extern "C" fn sci_dma_rx_timer_fn(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn sci_request_dma(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_free_dma(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_flush_buffer(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_dma_check_tx_occurred(s: *mut sci_port) {
...
#[no_mangle]
pub unsafe extern "C" fn sci_request_dma(port: *mut uart_port) {
    static inline void sci_request_dma(struct uart_port *port)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn sci_free_dma(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_rx_interrupt(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
    ...
    if (s.chan_rx) {
    let mut scr: u16 = sci_serial_in(port, SCSCR);
    let mut ssr: u16 = sci_serial_in(port, SCxSR);
...
#[no_mangle]
unsafe extern "C" fn sci_tx_interrupt(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sci_tx_end_interrupt(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sci_br_interrupt(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sci_er_interrupt(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
// Break and Error interrupts are muxed
    let mut ssr_status: c_ushort = sci_serial_in(port, SCxSR);
// Break Interrupt
...
#[no_mangle]
unsafe extern "C" fn sci_mpxed_interrupt(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sci_getreg(port, _arg: s->params->overrun_reg)->size) -> else {
...
#[no_mangle]
unsafe extern "C" fn sci_request_irq(port: *mut sci_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_free_irq(port: *mut sci_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_tx_empty(port: *mut uart_port) -> c_uint {
    static unsigned int sci_tx_empty(struct uart_port *port)
    {
    let mut status: c_ushort = sci_serial_in(port, SCxSR);
    let mut in_tx_fifo: c_ushort = sci_txfill(port);
    struct sci_port *s = to_sci_port(port);
...
#[no_mangle]
unsafe extern "C" fn sci_set_rts(port: *mut uart_port, state: bool) {
...
// RTS# is output
    ...
    let mut ctrl: u16 = sci_serial_in(port, SCSPTR);
// Active low
    if (state)
    ctrl &= ~SCSPTR_RTSDT;
    else
...
#[no_mangle]
unsafe extern "C" fn sci_get_cts(port: *mut uart_port) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn sci_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sci_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sci_enable_ms(port: *mut uart_port) {
    static void sci_enable_ms(struct uart_port *port)
    {
    mctrl_gpio_enable_ms(to_sci_port(port).gpios);
    }
#[no_mangle]
unsafe extern "C" fn sci_break_ctl(port: *mut uart_port, break_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sci_shutdown_complete(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn sci_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sci_shutdown(port: *mut uart_port) {
    ...
    unsigned int *srr)
    {
    let mut freq: c_ulong = s.clk_rates[SCI_SCK];
...
// calculate sample rate, BRR, and clock select
    ...
    {
    let mut freq: c_ulong = s.clk_rates[SCI_FCK];
...
#[no_mangle]
unsafe extern "C" fn sci_reset(port: *mut uart_port) {
    ...
    let mut brr: c_uint = 255, cks = 0, srr = 15, dl = 0, sccks = 0;
    let mut brr1: c_uint = 255, cks1 = 0, srr1 = 15, dl1 = 0;
    struct sci_port *s = to_sci_port(port);
    const struct plat_sci_reg *reg;
    let mut min_err: c_int = INT_MAX, err;
    let mut max_freq: c_ulong = 0;
    let mut best_clk: c_int = -1;
    unsigned long flags;
...
// byte size and parity
    ...
    let mut hssrr: c_uint = srr | HSCIF_SRE;
// Calculate deviation from intended rate at the
// center of the last stop bit in sampling clocks.
//
    let mut last_stop: c_int = bits * 2 - 1;
...
//
    let mut shift: c_int = clamp(deviation / 2, -8, 7);
...
// Don't touch the bit rate configuration
    ...
    reg = sci_getreg(port, SCFCR);
    if (reg.size) {
    let mut ctrl: c_ushort = sci_serial_in(port, SCFCR);
...
#[no_mangle]
unsafe extern "C" fn sci_remap_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sci_release_port(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn sci_request_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sci_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sci_verify_port(port: *mut uart_port, ser: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_prepare_console_write(port: *mut uart_port, ctrl: u32) {
...
#[no_mangle]
unsafe extern "C" fn sci_console_save(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_console_restore(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn sci_init_clocks(sci_port: *mut sci_port, dev: *mut device) -> c_int {
...
//
    ...
    defined(CONFIG_SERIAL_SH_SCI_EARLYCON)
#[no_mangle]
unsafe extern "C" fn serial_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn serial_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn early_serial_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_probe_earlyprintk(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sci_probe_earlyprintk(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sci_reset_control_assert(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sci_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_resume(dev: *mut device) -> c_int {
    ...
    let mut ret: c_int = reset_control_deassert(sport.rstc);
    if (ret)
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn sci_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sci_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn early_console_exit(co: *mut console) -> c_int {
