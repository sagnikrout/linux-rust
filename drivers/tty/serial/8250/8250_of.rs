...
//! Source: drivers/tty/serial/8250/8250_of.c
#![no_std]
...
pub const UART_NPCM_TOR: c_int = 7;

#[no_mangle]
unsafe extern "C" fn npcm_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_setup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_handle_irq(port: *mut uart_port) -> c_int {
...
// If the bus clock is required, core clock must be named
    info.clk = devm_clk_get_enabled(dev, bus_clk ? "core" : core::ptr::null_mut());
    if (IS_ERR(info.clk)) {
...
// Compatibility with the deprecated pxa driver and 8250_pxa drivers.
    ...
    port.regshift = 2;
    info.rst = devm_reset_control_get_optional_shared(&ofdev.dev, core::ptr::null_mut());
    if (IS_ERR(info.rst)) {
...
//
#[no_mangle]
unsafe extern "C" fn of_platform_serial_probe(ofdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn of_platform_serial_remove(ofdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn of_serial_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_serial_resume(dev: *mut device) -> c_int {
