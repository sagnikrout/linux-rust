...
//! Source: drivers/tty/serial/8250/serial_cs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serial_quirk {
    pub manfid: c_uint,
    pub prodid: c_uint,
    pub /: *mut *mut int multi; / 1 = multifunction, > 1 = # ports,
    pub ): *mut *mut void (config)(struct pcmcia_device,
    pub ): *mut *mut *mut void (setup)(struct pcmcia_device , struct uart_8250_port,
    pub ): *mut *mut void (wakeup)(struct pcmcia_device,
    pub ): *mut *mut int (post)(struct pcmcia_device,
}
...
//
#[no_mangle]
unsafe extern "C" fn quirk_setup_brainboxes_0104(link: *mut pcmcia_device, uart: *mut uart_8250_port) {
    static void quirk_setup_brainboxes_0104(struct pcmcia_device *link, struct uart_8250_port *uart)
    {
    uart.port.uartclk = 14745600;
    }
#[no_mangle]
unsafe extern "C" fn quirk_post_ibm(link: *mut pcmcia_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_config_nokia(link: *mut pcmcia_device) {
...
#[no_mangle]
unsafe extern "C" fn quirk_wakeup_oxsemi(link: *mut pcmcia_device) {
...
//
#[no_mangle]
unsafe extern "C" fn quirk_wakeup_possio_gcc(link: *mut pcmcia_device) {
    static void quirk_wakeup_possio_gcc(struct pcmcia_device *link)
    {
    struct serial_info *info = link.priv;
    let mut ctrl: c_uint = info.c950ctrl;
    outb(0xA, ctrl + 1);
    msleep(100);
    outb(0xE, ctrl + 1);
    msleep(300);
...
//
#[no_mangle]
unsafe extern "C" fn quirk_config_socket(link: *mut pcmcia_device) {
...
#[no_mangle]
unsafe extern "C" fn serial_remove(link: *mut pcmcia_device) {
...
#[no_mangle]
unsafe extern "C" fn serial_suspend(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_resume(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_probe(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_detach(link: *mut pcmcia_device) {
...
// ====================================================================
#[no_mangle]
unsafe extern "C" fn pfc_config(p_dev: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn simple_config_check(p_dev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn simple_config(link: *mut pcmcia_device) -> c_int {
...
//
    ret = pcmcia_loop_config(link, simple_config_check_notpicky, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn multi_config_check(p_dev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn multi_config(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_check_for_multi(p_dev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_config(link: *mut pcmcia_device) -> c_int {
    static int serial_config(struct pcmcia_device *link)
    {
    struct serial_info *info = link.priv;
    int i;
...
//
    ...
    i = pfc_config(link);
#[no_mangle]
pub unsafe extern "C" fn if(1: info->multi >) -> else {
