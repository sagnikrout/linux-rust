...
//! Source: drivers/tty/serial/8250/8250_pci.c
#![no_std]
...
pub const PCI_VENDOR_ID_SBSMODULARIO: c_uint = 0x124B;
pub const PCI_SUBVENDOR_ID_SBSMODULARIO: c_uint = 0x124B;
pub const PCI_DEVICE_ID_OCTPRO: c_uint = 0x0001;
pub const PCI_SUBDEVICE_ID_OCTPRO232: c_uint = 0x0108;
pub const PCI_SUBDEVICE_ID_OCTPRO422: c_uint = 0x0208;
pub const PCI_SUBDEVICE_ID_POCTAL232: c_uint = 0x0308;
pub const PCI_SUBDEVICE_ID_POCTAL422: c_uint = 0x0408;
pub const PCI_SUBDEVICE_ID_SIIG_DUAL_00: c_uint = 0x2500;
pub const PCI_SUBDEVICE_ID_SIIG_DUAL_30: c_uint = 0x2530;
pub const PCI_VENDOR_ID_ADVANTECH: c_uint = 0x13fe;
pub const PCI_DEVICE_ID_INTEL_CE4100_UART: c_uint = 0x2e66;
pub const PCI_DEVICE_ID_ADVANTECH_PCI1600: c_uint = 0x1600;
pub const PCI_DEVICE_ID_ADVANTECH_PCI1600_1611: c_uint = 0x1611;
pub const PCI_DEVICE_ID_ADVANTECH_PCI3620: c_uint = 0x3620;
pub const PCI_DEVICE_ID_ADVANTECH_PCI3618: c_uint = 0x3618;
pub const PCI_DEVICE_ID_ADVANTECH_PCIf618: c_uint = 0xf618;
pub const PCI_DEVICE_ID_TITAN_200I: c_uint = 0x8028;
pub const PCI_DEVICE_ID_TITAN_400I: c_uint = 0x8048;
pub const PCI_DEVICE_ID_TITAN_800I: c_uint = 0x8088;
pub const PCI_DEVICE_ID_TITAN_800EH: c_uint = 0xA007;
pub const PCI_DEVICE_ID_TITAN_800EHB: c_uint = 0xA008;
pub const PCI_DEVICE_ID_TITAN_400EH: c_uint = 0xA009;
pub const PCI_DEVICE_ID_TITAN_100E: c_uint = 0xA010;
pub const PCI_DEVICE_ID_TITAN_200E: c_uint = 0xA012;
pub const PCI_DEVICE_ID_TITAN_400E: c_uint = 0xA013;
pub const PCI_DEVICE_ID_TITAN_800E: c_uint = 0xA014;
pub const PCI_DEVICE_ID_TITAN_200EI: c_uint = 0xA016;
pub const PCI_DEVICE_ID_TITAN_200EISI: c_uint = 0xA017;
pub const PCI_DEVICE_ID_TITAN_200V3: c_uint = 0xA306;
pub const PCI_DEVICE_ID_TITAN_400V3: c_uint = 0xA310;
pub const PCI_DEVICE_ID_TITAN_410V3: c_uint = 0xA312;
pub const PCI_DEVICE_ID_TITAN_800V3: c_uint = 0xA314;
pub const PCI_DEVICE_ID_TITAN_800V3B: c_uint = 0xA315;
pub const PCI_DEVICE_ID_OXSEMI_16PCI958: c_uint = 0x9538;
pub const PCIE_DEVICE_ID_NEO_2_OX_IBM: c_uint = 0x00F6;
pub const PCI_DEVICE_ID_PLX_CRONYX_OMEGA: c_uint = 0xc001;
pub const PCI_DEVICE_ID_INTEL_PATSBURG_KT: c_uint = 0x1d3d;
pub const PCI_DEVICE_ID_WCHCN_CH352_2S: c_uint = 0x3253;
pub const PCI_DEVICE_ID_WCHCN_CH355_4S: c_uint = 0x7173;
pub const PCI_VENDOR_ID_AGESTAR: c_uint = 0x5372;
pub const PCI_DEVICE_ID_AGESTAR_9375: c_uint = 0x6872;
pub const PCI_DEVICE_ID_BROADCOM_TRUMANAGE: c_uint = 0x160a;
pub const PCI_DEVICE_ID_AMCC_ADDIDATA_APCI7800: c_uint = 0x818e;
pub const PCI_DEVICE_ID_WCHIC_CH384_4S: c_uint = 0x3470;
pub const PCI_DEVICE_ID_WCHIC_CH384_8S: c_uint = 0x3853;
pub const PCI_DEVICE_ID_ADDIDATA_CPCI7500: c_uint = 0x7003;
pub const PCI_DEVICE_ID_ADDIDATA_CPCI7500_NG: c_uint = 0x7024;
pub const PCI_DEVICE_ID_ADDIDATA_CPCI7420_NG: c_uint = 0x7025;
pub const PCI_DEVICE_ID_ADDIDATA_CPCI7300_NG: c_uint = 0x7026;
pub const PCI_VENDOR_ID_SYSTEMBASE: c_uint = 0x14a1;
// Unknown vendors/cards - this should not be in linux/pci_ids.h
pub const PCI_SUBDEVICE_ID_UNKNOWN_0x1584: c_uint = 0x1584;
pub const PCI_SUBDEVICE_ID_UNKNOWN_0x1588: c_uint = 0x1588;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_serial_quirk {
    pub vendor: u32,
    pub device: u32,
    pub subvendor: u32,
    pub subdevice: u32,
    pub dev): *mut *mut int (probe)(struct pci_dev,
    pub dev): *mut *mut int (init)(struct pci_dev,
    int	(*setup)(struct serial_private *,
    const struct pciserial_board *,
    pub int): *mut *mut uart_8250_port ,,
    pub dev): *mut *mut void (exit)(struct pci_dev,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct f815xxa_data {
    pub lock: spinlock_t,
    pub idx: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serial_private {
    pub dev: *mut pci_dev,
    pub nr: c_uint,
    pub quirk: *mut pci_serial_quirk,
    pub board: *const pciserial_board,
    pub line: [c_int; ],
}

pub const PCI_DEVICE_ID_HPE_PCI_SERIAL: c_uint = 0x37e;
pub const PCIE_VENDOR_ID_ASIX: c_uint = 0x125B;
pub const PCIE_DEVICE_ID_AX99100: c_uint = 0x9100;
...
#[no_mangle]
unsafe extern "C" fn moan_device(str: *const c_char, dev: *mut pci_dev) {
...
//
    ...
    {
    let mut bar: c_uint = 0, offset = board.first_offset;
...
//
#[no_mangle]
unsafe extern "C" fn pci_hp_diva_init(dev: *mut pci_dev) -> c_int {
...
//
    ...
    struct uart_8250_port *port, int idx)
    {
    let mut offset: c_uint = board.first_offset;
    let mut bar: c_uint = FL_GET_BASE(board.flags);
...
//
#[no_mangle]
unsafe extern "C" fn pci_inteli960ni_init(dev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pci_plx9050_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_plx9050_exit(dev: *mut pci_dev) {
...
pub const NI8420_INT_ENABLE_REG: c_uint = 0x38;
pub const NI8420_INT_ENABLE_BIT: c_uint = 0x2000;
#[no_mangle]
unsafe extern "C" fn pci_ni8420_exit(dev: *mut pci_dev) {
    static void pci_ni8420_exit(struct pci_dev *dev)
    {
    void __iomem *p;
    let mut bar: c_uint = 0;
...
// MITE registers
pub const MITE_IOWBSR1: c_uint = 0xc4;
pub const MITE_IOWCR1: c_uint = 0xf4;
pub const MITE_LCIMR1: c_uint = 0x08;
pub const MITE_LCIMR2: c_uint = 0x10;

#[no_mangle]
unsafe extern "C" fn pci_ni8430_exit(dev: *mut pci_dev) {
...
pub const OCT_REG_CR_OFF: c_uint = 0x500;
#[no_mangle]
unsafe extern "C" fn sbs_init(dev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sbs_exit(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pci_siig10x_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_siig20x_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_siig_init(dev: *mut pci_dev) -> c_int {
    static int pci_siig_init(struct pci_dev *dev)
    {
    let mut type: c_uint = dev.device & 0xff00;
    if (type == 0x1000)
    ...
    struct uart_8250_port *port, int idx)
    {
    let mut bar: c_uint = FL_GET_BASE(board.flags) + idx, offset = 0;
    if (idx > 3) {
    bar = 4;
    offset = (idx - 4) * 8;
    }
...
//
#[no_mangle]
unsafe extern "C" fn pci_timedia_probe(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_timedia_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_xircom_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_ni8420_init(dev: *mut pci_dev) -> c_int {
...
pub const MITE_IOWBSR1_WSIZE: c_uint = 0xa;
pub const MITE_IOWBSR1_WIN_OFFSET: c_uint = 0x800;

pub const MITE_IOWCR1_RAMSEL_MASK: c_uint = 0xfffffffe;
#[no_mangle]
unsafe extern "C" fn pci_ni8430_init(dev: *mut pci_dev) -> c_int {
...
pub const NI8430_PORTCON: c_uint = 0x0f;
...
//
#[no_mangle]
unsafe extern "C" fn pci_netmos_9900_numports(dev: *mut pci_dev) -> c_int {
    static int pci_netmos_9900_numports(struct pci_dev *dev)
    {
    let mut c: c_uint = dev.class;
    unsigned int pi;
...
#[no_mangle]
unsafe extern "C" fn pci_netmos_init(dev: *mut pci_dev) -> c_int {
...
//
// registers
pub const ITE_887x_MISCR: c_uint = 0x9c;
pub const ITE_887x_INTCBAR: c_uint = 0x78;
pub const ITE_887x_UARTBAR: c_uint = 0x7c;
pub const ITE_887x_PS0BAR: c_uint = 0x10;
pub const ITE_887x_POSIO0: c_uint = 0x60;
// I/O space size
pub const ITE_887x_IOSIZE: c_int = 32;
...
#[no_mangle]
unsafe extern "C" fn pci_ite887x_init(dev: *mut pci_dev) -> c_int {
    static int pci_ite887x_init(struct pci_dev *dev)
    {
    int ret, i, type;
    struct resource *iobase = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pci_ite887x_exit(dev: *mut pci_dev) {
...
//
pub const PCI_VENDOR_ID_ENDRUN: c_uint = 0x7401;
pub const PCI_DEVICE_ID_ENDRUN_1588: c_uint = 0xe100;
#[no_mangle]
unsafe extern "C" fn pci_oxsemi_tornado_p(dev: *mut pci_dev) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pci_oxsemi_tornado_init(dev: *mut pci_dev) -> c_int {
    static int pci_oxsemi_tornado_init(struct pci_dev *dev)
    {
    u8 __iomem *p;
    unsigned long deviceID;
    let mut number_uarts: c_uint = 0;
...
pub const OXSEMI_TORNADO_TCR_MASK: c_uint = 0xf;
pub const OXSEMI_TORNADO_CPR_MASK: c_uint = 0x1ff;
pub const OXSEMI_TORNADO_CPR_MIN: c_uint = 0x008;
pub const OXSEMI_TORNADO_CPR_DEF: c_uint = 0x10f;
//
...
// Scale the quotient for comparison to get the fractional part.
    let mut quot_scale: c_uint = 65536;
    let mut sclk: c_uint = port.uartclk * 2;
    let mut sdiv: c_uint = DIV_ROUND_CLOSEST(sclk, baud);
...
//
    ...
    let mut cpr2: u8 = quot_frac >> 16;
    let mut cpr: u8 = quot_frac >> 8;
    let mut tcr: u8 = quot_frac;
...
pub const QPCR_TEST_FOR1: c_uint = 0x3F;
pub const QPCR_TEST_GET1: c_uint = 0x00;
pub const QPCR_TEST_FOR2: c_uint = 0x40;
pub const QPCR_TEST_GET2: c_uint = 0x40;
pub const QPCR_TEST_FOR3: c_uint = 0x80;
pub const QPCR_TEST_GET3: c_uint = 0x40;
pub const QPCR_TEST_FOR4: c_uint = 0xC0;
pub const QPCR_TEST_GET4: c_uint = 0x80;
pub const QOPR_CLOCK_X1: c_uint = 0x0000;
pub const QOPR_CLOCK_X2: c_uint = 0x0001;
pub const QOPR_CLOCK_X4: c_uint = 0x0002;
pub const QOPR_CLOCK_X8: c_uint = 0x0003;
pub const QOPR_CLOCK_RATE_MASK: c_uint = 0x0003;
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_rqopr(port: *mut uart_8250_port) -> c_int {
    static int pci_quatech_rqopr(struct uart_8250_port *port)
    {
    let mut base: c_ulong = port.port.iobase;
    u8 LCR, val;
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_wqopr(port: *mut uart_8250_port, qopr: u8) {
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_rqmcr(port: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_wqmcr(port: *mut uart_8250_port, qmcr: u8) {
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_has_qmcr(port: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_test(port: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_clock(port: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_rs422(port: *mut uart_8250_port) -> c_int {
    static int pci_quatech_rs422(struct uart_8250_port *port)
    {
    u8 qmcr;
    let mut rs422: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn pci_quatech_init(dev: *mut pci_dev) -> c_int {
    static int pci_quatech_init(struct pci_dev *dev)
    {
    const struct pci_device_id *match;
    let mut amcc: bool = false;
    if (!IS_ENABLED(CONFIG_HAS_IOPORT))
    return serial_8250_warn_need_ioport(dev);
...
// For now just warn about RS422
    ...
    struct uart_8250_port *port, int idx)
    {
    let mut ret: c_int = pci_default_setup(priv, board, port, idx);
...
#[no_mangle]
unsafe extern "C" fn pci_fintek_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn f815xxa_mem_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn pci_fintek_f815xxa_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kt_handle_break(p: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn kt_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pci_eg20t_init(dev: *mut pci_dev) -> c_int {
...
pub const CH384_XINT_ENABLE_REG: c_uint = 0xEB;
pub const CH384_XINT_ENABLE_BIT: c_uint = 0x02;
#[no_mangle]
unsafe extern "C" fn pci_wch_ch38x_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_wch_ch38x_exit(dev: *mut pci_dev) {
...
pub const SB_OPTR_IMR0: c_uint = 0x0c /* Interrupt mask register, p0 to p7 */;
#[no_mangle]
unsafe extern "C" fn pci_systembase_init(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci_systembase_exit(dev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn quirk_id_matches(quirk_id: u32, dev_id: u32) -> c_int {
    static inline int quirk_id_matches(u32 quirk_id, u32 dev_id)
    {
    let mut quirk_id: return = = PCI_ANY_ID || quirk_id == dev_id;
    }
...
#[no_mangle]
unsafe extern "C" fn serial_pci_is_class_communication(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pciserial_detach_ports(priv: *mut serial_private) {
...
#[no_mangle]
pub unsafe extern "C" fn pciserial_remove_ports(priv: *mut serial_private) {
...
#[no_mangle]
pub unsafe extern "C" fn pciserial_suspend_ports(priv: *mut serial_private) {
...
#[no_mangle]
pub unsafe extern "C" fn pciserial_resume_ports(priv: *mut serial_private) {
...
#[no_mangle]
unsafe extern "C" fn pciserial_remove_one(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pciserial_suspend_one(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pciserial_resume_one(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial8250_io_slot_reset(dev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn serial8250_io_resume(dev: *mut pci_dev) {
