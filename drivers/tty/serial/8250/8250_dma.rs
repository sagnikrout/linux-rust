...
//! Source: drivers/tty/serial/8250/8250_dma.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __dma_tx_complete(param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __dma_rx_complete(p: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn dma_rx_complete(param: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_tx_dma(p: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_tx_dma_flush(p: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_rx_dma(p: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_rx_dma_flush(p: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_request_dma(p: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_release_dma(p: *mut uart_8250_port) {
...
// Release RX resources
    ...
    dma.rx_addr);
    dma_release_channel(dma.rxchan);
    dma.rxchan = core::ptr::null_mut();
// Release TX resources
    dmaengine_terminate_sync(dma.txchan);
    dma_unmap_single(dma.txchan.device.dev, dma.tx_addr,
    UART_XMIT_SIZE, DMA_TO_DEVICE);
    dma_release_channel(dma.txchan);
    dma.txchan = core::ptr::null_mut();
    dma.tx_running = 0;
