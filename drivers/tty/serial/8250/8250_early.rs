...
//! Source: drivers/tty/serial/8250/8250_early.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn serial8250_early_in(port: *mut uart_port, offset: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn serial8250_early_out(port: *mut uart_port, offset: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn serial_putc(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn init_port(device: *mut earlycon_device) -> void __init {
