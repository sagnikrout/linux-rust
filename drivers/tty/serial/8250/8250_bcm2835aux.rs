...
//! Source: drivers/tty/serial/8250/8250_bcm2835aux.c
#![no_std]
...
pub const BCM2835_AUX_UART_CNTL: c_int = 8;
pub const BCM2835_AUX_UART_CNTL_RXEN: c_uint = 0x01 /* Receiver enable */;
pub const BCM2835_AUX_UART_CNTL_TXEN: c_uint = 0x02 /* Transmitter enable */;
pub const BCM2835_AUX_UART_CNTL_AUTORTS: c_uint = 0x04 /* RTS set by RX fill level */;
pub const BCM2835_AUX_UART_CNTL_AUTOCTS: c_uint = 0x08 /* CTS stops transmitter */;
pub const BCM2835_AUX_UART_CNTL_RTS3: c_uint = 0x00 /* RTS set until 3 chars left */;
pub const BCM2835_AUX_UART_CNTL_RTS2: c_uint = 0x10 /* RTS set until 2 chars left */;
pub const BCM2835_AUX_UART_CNTL_RTS1: c_uint = 0x20 /* RTS set until 1 chars left */;
pub const BCM2835_AUX_UART_CNTL_RTS4: c_uint = 0x30 /* RTS set until 4 chars left */;
pub const BCM2835_AUX_UART_CNTL_RTSINV: c_uint = 0x40 /* Invert auto RTS polarity */;
pub const BCM2835_AUX_UART_CNTL_CTSINV: c_uint = 0x80 /* Invert auto CTS polarity */;
//
...
#[no_mangle]
unsafe extern "C" fn bcm2835aux_rs485_start_tx(up: *mut uart_8250_port, toggle_ier: bool) {
...
#[no_mangle]
unsafe extern "C" fn bcm2835aux_rs485_stop_tx(up: *mut uart_8250_port, toggle_ier: bool) {
...
#[no_mangle]
unsafe extern "C" fn bcm2835aux_serial_probe(pdev: *mut platform_device) -> c_int {
...
// get the clock - this also enables the HW
    data.clk = devm_clk_get_optional(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(data.clk))
...
#[no_mangle]
unsafe extern "C" fn bcm2835aux_serial_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn bcm2835aux_can_disable_clock(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bcm2835aux_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm2835aux_resume(dev: *mut device) -> c_int {
