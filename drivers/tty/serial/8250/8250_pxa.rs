...
//! Source: drivers/tty/serial/8250/8250_pxa.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa8250_data {
    pub line: c_int,
    pub clk: *mut clk,
}

#[no_mangle]
unsafe extern "C" fn serial_pxa_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn serial_pxa_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn serial_pxa_dl_write(up: *mut uart_8250_port, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn serial_pxa_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_pxa_remove(pdev: *mut platform_device) {
