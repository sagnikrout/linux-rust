...
//! Source: drivers/tty/serial/8250/8250_bcm7271.c
#![no_std]
...
pub const UDMA_ARB_RX: c_uint = 0x00;
pub const UDMA_ARB_TX: c_uint = 0x04;
pub const UDMA_ARB_REQ: c_uint = 0x00000001;
pub const UDMA_ARB_GRANT: c_uint = 0x00000002;
pub const UDMA_RX_REVISION: c_uint = 0x00;
pub const UDMA_RX_REVISION_REQUIRED: c_uint = 0x00000101;
pub const UDMA_RX_CTRL: c_uint = 0x04;
pub const UDMA_RX_CTRL_BUF_CLOSE_MODE: c_uint = 0x00010000;
pub const UDMA_RX_CTRL_MASK_WR_DONE: c_uint = 0x00008000;
pub const UDMA_RX_CTRL_ENDIAN_OVERRIDE: c_uint = 0x00004000;
pub const UDMA_RX_CTRL_ENDIAN: c_uint = 0x00002000;
pub const UDMA_RX_CTRL_OE_IS_ERR: c_uint = 0x00001000;
pub const UDMA_RX_CTRL_PE_IS_ERR: c_uint = 0x00000800;
pub const UDMA_RX_CTRL_FE_IS_ERR: c_uint = 0x00000400;
pub const UDMA_RX_CTRL_NUM_BUF_USED_MASK: c_uint = 0x000003c0;
pub const UDMA_RX_CTRL_NUM_BUF_USED_SHIFT: c_int = 6;
pub const UDMA_RX_CTRL_BUF_CLOSE_CLK_SEL_SYS: c_uint = 0x00000020;
pub const UDMA_RX_CTRL_BUF_CLOSE_ENA: c_uint = 0x00000010;
pub const UDMA_RX_CTRL_TIMEOUT_CLK_SEL_SYS: c_uint = 0x00000008;
pub const UDMA_RX_CTRL_TIMEOUT_ENA: c_uint = 0x00000004;
pub const UDMA_RX_CTRL_ABORT: c_uint = 0x00000002;
pub const UDMA_RX_CTRL_ENA: c_uint = 0x00000001;
pub const UDMA_RX_STATUS: c_uint = 0x08;
pub const UDMA_RX_STATUS_ACTIVE_BUF_MASK: c_uint = 0x0000000f;
pub const UDMA_RX_TRANSFER_LEN: c_uint = 0x0c;
pub const UDMA_RX_TRANSFER_TOTAL: c_uint = 0x10;
pub const UDMA_RX_BUFFER_SIZE: c_uint = 0x14;
pub const UDMA_RX_SRC_ADDR: c_uint = 0x18;
pub const UDMA_RX_TIMEOUT: c_uint = 0x1c;
pub const UDMA_RX_BUFFER_CLOSE: c_uint = 0x20;
pub const UDMA_RX_BLOCKOUT_COUNTER: c_uint = 0x24;
pub const UDMA_RX_BUF0_PTR_LO: c_uint = 0x28;
pub const UDMA_RX_BUF0_PTR_HI: c_uint = 0x2c;
pub const UDMA_RX_BUF0_STATUS: c_uint = 0x30;
pub const UDMA_RX_BUFX_STATUS_OVERRUN_ERR: c_uint = 0x00000010;
pub const UDMA_RX_BUFX_STATUS_FRAME_ERR: c_uint = 0x00000008;
pub const UDMA_RX_BUFX_STATUS_PARITY_ERR: c_uint = 0x00000004;
pub const UDMA_RX_BUFX_STATUS_CLOSE_EXPIRED: c_uint = 0x00000002;
pub const UDMA_RX_BUFX_STATUS_DATA_RDY: c_uint = 0x00000001;
pub const UDMA_RX_BUF0_DATA_LEN: c_uint = 0x34;
pub const UDMA_RX_BUF1_PTR_LO: c_uint = 0x38;
pub const UDMA_RX_BUF1_PTR_HI: c_uint = 0x3c;
pub const UDMA_RX_BUF1_STATUS: c_uint = 0x40;
pub const UDMA_RX_BUF1_DATA_LEN: c_uint = 0x44;
pub const UDMA_TX_REVISION: c_uint = 0x00;
pub const UDMA_TX_REVISION_REQUIRED: c_uint = 0x00000101;
pub const UDMA_TX_CTRL: c_uint = 0x04;
pub const UDMA_TX_CTRL_ENDIAN_OVERRIDE: c_uint = 0x00000080;
pub const UDMA_TX_CTRL_ENDIAN: c_uint = 0x00000040;
pub const UDMA_TX_CTRL_NUM_BUF_USED_MASK: c_uint = 0x00000030;
pub const UDMA_TX_CTRL_NUM_BUF_USED_1: c_uint = 0x00000010;
pub const UDMA_TX_CTRL_ABORT: c_uint = 0x00000002;
pub const UDMA_TX_CTRL_ENA: c_uint = 0x00000001;
pub const UDMA_TX_DST_ADDR: c_uint = 0x08;
pub const UDMA_TX_BLOCKOUT_COUNTER: c_uint = 0x10;
pub const UDMA_TX_TRANSFER_LEN: c_uint = 0x14;
pub const UDMA_TX_TRANSFER_TOTAL: c_uint = 0x18;
pub const UDMA_TX_STATUS: c_uint = 0x20;
pub const UDMA_TX_BUF0_PTR_LO: c_uint = 0x24;
pub const UDMA_TX_BUF0_PTR_HI: c_uint = 0x28;
pub const UDMA_TX_BUF0_STATUS: c_uint = 0x2c;
pub const UDMA_TX_BUFX_LAST: c_uint = 0x00000002;
pub const UDMA_TX_BUFX_EMPTY: c_uint = 0x00000001;
pub const UDMA_TX_BUF0_DATA_LEN: c_uint = 0x30;
pub const UDMA_TX_BUF0_DATA_SENT: c_uint = 0x34;
pub const UDMA_TX_BUF1_PTR_LO: c_uint = 0x38;
pub const UDMA_INTR_STATUS: c_uint = 0x00;
pub const UDMA_INTR_ARB_TX_GRANT: c_uint = 0x00040000;
pub const UDMA_INTR_ARB_RX_GRANT: c_uint = 0x00020000;
pub const UDMA_INTR_TX_ALL_EMPTY: c_uint = 0x00010000;
pub const UDMA_INTR_TX_EMPTY_BUF1: c_uint = 0x00008000;
pub const UDMA_INTR_TX_EMPTY_BUF0: c_uint = 0x00004000;
pub const UDMA_INTR_TX_ABORT: c_uint = 0x00002000;
pub const UDMA_INTR_TX_DONE: c_uint = 0x00001000;
pub const UDMA_INTR_RX_ERROR: c_uint = 0x00000800;
pub const UDMA_INTR_RX_TIMEOUT: c_uint = 0x00000400;
pub const UDMA_INTR_RX_READY_BUF7: c_uint = 0x00000200;
pub const UDMA_INTR_RX_READY_BUF6: c_uint = 0x00000100;
pub const UDMA_INTR_RX_READY_BUF5: c_uint = 0x00000080;
pub const UDMA_INTR_RX_READY_BUF4: c_uint = 0x00000040;
pub const UDMA_INTR_RX_READY_BUF3: c_uint = 0x00000020;
pub const UDMA_INTR_RX_READY_BUF2: c_uint = 0x00000010;
pub const UDMA_INTR_RX_READY_BUF1: c_uint = 0x00000008;
pub const UDMA_INTR_RX_READY_BUF0: c_uint = 0x00000004;
pub const UDMA_INTR_RX_READY_MASK: c_uint = 0x000003fc;
pub const UDMA_INTR_RX_READY_SHIFT: c_int = 2;
pub const UDMA_INTR_RX_ABORT: c_uint = 0x00000002;
pub const UDMA_INTR_RX_DONE: c_uint = 0x00000001;
pub const UDMA_INTR_SET: c_uint = 0x04;
pub const UDMA_INTR_CLEAR: c_uint = 0x08;
pub const UDMA_INTR_MASK_STATUS: c_uint = 0x0c;
pub const UDMA_INTR_MASK_SET: c_uint = 0x10;
pub const UDMA_INTR_MASK_CLEAR: c_uint = 0x14;
...
pub const UDMA_RX_BUFS_COUNT: c_int = 8;
...
pub const UDMA_TX_BUFS_COUNT: c_int = 2;
    ...
    ((x) * UDMA_TX_BUFS_REG_OFFSET))
pub const REGS_8250: c_int = 0;
pub const REGS_DMA_RX: c_int = 1;
pub const REGS_DMA_TX: c_int = 2;
pub const REGS_DMA_ISR: c_int = 3;
pub const REGS_DMA_ARB: c_int = 4;
pub const REGS_MAX: c_int = 5;
pub const TX_BUF_SIZE: c_int = 4096;
pub const RX_BUF_SIZE: c_int = 4096;
pub const RX_BUFS_COUNT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmuart_priv {
    pub line: c_int,
    pub baud_mux_clk: *mut clk,
    pub default_mux_rate: c_ulong,
    pub real_rates: [u32; ARRAY_SIZE(brcmstb_rate_table)],
    pub rate_table: *const u32,
    pub char_wait: ktime_t,
    pub up: *mut uart_port,
    pub hrt: hrtimer,
    pub shutdown: bool,
    pub dma_enabled: bool,
    pub dma: uart_8250_dma,
    pub regs: [*mut void __iomem; REGS_MAX],
    pub rx_addr: dma_addr_t,
    pub rx_bufs: *mut c_void,
    pub rx_size: usize,
    pub rx_next_buf: c_int,
...
// stats exposed through debugfs
    pub dma_rx_partial_buf: u64,
    pub dma_rx_full_buf: u64,
    pub rx_bad_timeout_late_char: u32,
    pub rx_bad_timeout_no_char: u32,
    pub rx_missing_close_timeout: u32,
    pub rx_err: u32,
    pub rx_timeout: u32,
    pub rx_abort: u32,
    pub saved_mctrl: u32,
...
//
#[no_mangle]
unsafe extern "C" fn brcmuart_arbitration(priv: *mut brcmuart_priv, acquire: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_init_dma_hardware(priv: *mut brcmuart_priv) {
...
#[no_mangle]
unsafe extern "C" fn start_rx_dma(p: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn stop_rx_dma(p: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn stop_tx_dma(p: *mut uart_8250_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn brcmuart_tx_dma(p: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_rx_buf_done_isr(up: *mut uart_port, index: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(RX_BUF_SIZE: length !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_rx_isr(up: *mut uart_port, rx_isr: u32) {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_tx_isr(up: *mut uart_port, isr: u32) {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_startup(port: *mut uart_port) -> c_int {
...
//
    ...
    priv.tx_running = false;
    priv.dma.rx_dma = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn brcmuart_shutdown(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn init_real_clk_rates(dev: *mut device, priv: *mut brcmuart_priv) {
...
#[no_mangle]
unsafe extern "C" fn find_quot(dev: *mut device, freq: u32, baud: u32, percent: *mut u32) -> u32 {
...
// percent = (unsigned long)DIV_ROUND_CLOSEST_ULL(hires_err, baud);
    ...
    {
    u32 percent;
    let mut best_percent: u32 = UINT_MAX;
    u32 quot;
    u32 freq;
    let mut best_quot: u32 = 1;
    let mut best_freq: u32 = 0;
    int rc;
    int i;
    int real_baud;
// If the Baud Mux Clock was not specified, just return
    if (priv.baud_mux_clk == core::ptr::null_mut())
    return;
...
#[no_mangle]
unsafe extern "C" fn brcmuart_handle_irq(p: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_hrtimer_func(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_free_bufs(dev: *mut device, priv: *mut brcmuart_priv) {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_throttle(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_unthrottle(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_stats_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_probe(pdev: *mut platform_device) -> c_int {
    ...
    void __iomem *membase = core::ptr::null_mut();
    let mut mapbase: resource_size_t = 0;
    int ret;
    int x;
    int dma_irq;
...
#[no_mangle]
unsafe extern "C" fn brcmuart_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn brcmuart_init() -> int __init {
    static int __init brcmuart_init(void)
    {
    int ret;
    brcmuart_debugfs_root = debugfs_create_dir(
    brcmuart_platform_driver.driver.name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn brcmuart_deinit() -> void __exit {
