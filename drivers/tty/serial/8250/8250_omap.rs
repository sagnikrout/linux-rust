...
//! Source: drivers/tty/serial/8250/8250_omap.c
#![no_std]
...
pub const DEFAULT_CLK_SPEED: c_int = 48000000;
pub const OMAP_UART_REGSHIFT: c_int = 2;
...
pub const OMAP_UART_FCR_RX_TRIG: c_int = 6;
pub const OMAP_UART_FCR_TX_TRIG: c_int = 4;
...
pub const UART_TI752_TLR_TX: c_int = 0;
pub const UART_TI752_TLR_RX: c_int = 4;
...
pub const TX_TRIGGER: c_int = 1;
pub const RX_TRIGGER: c_int = 48;

pub const OMAP_UART_REV_46: c_uint = 0x0406;
pub const OMAP_UART_REV_52: c_uint = 0x0502;
pub const OMAP_UART_REV_63: c_uint = 0x0603;
// Resume register
pub const UART_OMAP_RESUME: c_uint = 0x0B;
// Interrupt Enable Register 2
pub const UART_OMAP_IER2: c_uint = 0x1B;

// Mode Definition Register 3
pub const UART_OMAP_MDR3: c_uint = 0x20;

// Enhanced features register 2
pub const UART_OMAP_EFR2: c_uint = 0x23;

// RX FIFO occupancy indicator
pub const UART_OMAP_RX_LVL: c_uint = 0x19;
// Timeout low and High
pub const UART_OMAP_TO_L: c_uint = 0x26;
pub const UART_OMAP_TO_H: c_uint = 0x27;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap8250_priv {
    ...
    pub omap8250_dma: uart_8250_dma,
    pub rx_dma_lock: spinlock_t,
    pub rx_dma_broken: bool,
    pub throttled: bool,
    pub pinctrl: *mut pinctrl,
    pub pinctrl_wakeup: *mut pinctrl_state,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap8250_dma_params {
    pub rx_size: u32,
    pub rx_trigger: u8,
    pub tx_trigger: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap8250_platdata {
    pub dma_params: *mut omap8250_dma_params,
    pub habit: u8,
}
...
#[no_mangle]
unsafe extern "C" fn uart_read(priv: *mut omap8250_priv, reg: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn __omap8250_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn omap8250_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
//
    ...
    struct omap8250_priv *priv)
    {
    let mut uartclk: c_uint = port.uartclk;
...
#[no_mangle]
unsafe extern "C" fn omap8250_restore_regs(up: *mut uart_8250_port) {
    static void omap8250_restore_regs(struct uart_8250_port *up)
    {
    struct uart_port *port = &up.port;
    struct omap8250_priv *priv = port.private_data;
    struct uart_8250_dma	*dma = up.dma;
    let mut mcr: u8 = serial8250_in_MCR(up);
...
#[no_mangle]
unsafe extern "C" fn omap8250_uart_qos_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn omap8250_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn omap_8250_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_8250_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn omap_8250_throttle(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn omap_8250_unthrottle(port: *mut uart_port) {
...
// Synchronize UART_IER access against the console.
    ...
    struct omap8250_priv *priv = port.private_data;
    struct uart_8250_port *up = up_to_u8250p(port);
    let mut fixed_delay_rts_before_send: u32 = 0;
    let mut fixed_delay_rts_after_send: u32 = 0;
    unsigned int baud;
//
...
#[no_mangle]
unsafe extern "C" fn __dma_rx_do_complete(p: *mut uart_8250_port) {
...
//
    ...
    let mut poll_count: c_int = 25;
    while (dmaengine_tx_status(rxchan, cookie, core::ptr::null_mut()) &&
    poll_count--)
    cpu_relax();
    if (poll_count == -1)
...
#[no_mangle]
unsafe extern "C" fn __dma_rx_complete(param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn omap_8250_rx_dma_flush(p: *mut uart_8250_port) {
    static void omap_8250_rx_dma_flush(struct uart_8250_port *p)
    {
    struct omap8250_priv	*priv = p.port.private_data;
    struct uart_8250_dma	*dma = p.dma;
...
#[no_mangle]
unsafe extern "C" fn omap_8250_rx_dma(p: *mut uart_8250_port) -> c_int {
    static int omap_8250_rx_dma(struct uart_8250_port *p)
    {
    struct omap8250_priv		*priv = p.port.private_data;
    struct uart_8250_dma            *dma = p.dma;
...
// Port locked to synchronize UART_IER access against the console.
    ...
    state = dmaengine_tx_status(dma.rxchan, dma.rx_cookie, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn omap_8250_dma_tx_complete(param: *mut c_void) {
    static void omap_8250_dma_tx_complete(void *param)
    {
    struct uart_8250_port	*p = param;
    struct uart_8250_dma	*dma = p.dma;
    struct tty_port		*tport = &p.port.state.port;
    let mut en_thri: bool = false;
    struct omap8250_priv	*priv = p.port.private_data;
...
#[no_mangle]
unsafe extern "C" fn omap_8250_tx_dma(p: *mut uart_8250_port) -> c_int {
    static int omap_8250_tx_dma(struct uart_8250_port *p)
    {
    struct uart_8250_dma		*dma = p.dma;
    struct omap8250_priv		*priv = p.port.private_data;
...
#[no_mangle]
unsafe extern "C" fn omap_8250_handle_rx_dma(up: *mut uart_8250_port, iir: u8, status: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn am654_8250_handle_uart_errors(up: *mut uart_8250_port, iir: u8, status: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn omap_8250_dma_handle_irq(port: *mut uart_port) -> c_int {
    static int omap_8250_dma_handle_irq(struct uart_port *port)
    {
    struct uart_8250_port *up = up_to_u8250p(port);
    struct omap8250_priv *priv = port.private_data;
...
#[no_mangle]
unsafe extern "C" fn the_no_dma_filter_fn(chan: *mut dma_chan, param: *mut c_void) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn omap_8250_rx_dma(p: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap8250_no_handle_irq(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap8250_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    if (ret == 2) {
    struct omap8250_dma_params *dma_params = core::ptr::null_mut();
    struct uart_8250_dma *dma = &priv.omap8250_dma;
...
#[no_mangle]
unsafe extern "C" fn omap8250_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn omap8250_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap8250_complete(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn omap8250_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap8250_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap8250_lost_context(up: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uart_write(priv: *mut omap8250_priv, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn omap8250_soft_reset(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap8250_runtime_suspend(dev: *mut device) -> c_int {
    static int omap8250_runtime_suspend(struct device *dev)
    {
    struct omap8250_priv *priv = dev_get_drvdata(dev);
    struct uart_8250_port *up = core::ptr::null_mut();
    if (priv.line >= 0)
    up = serial8250_get_port(priv.line);
...
#[no_mangle]
unsafe extern "C" fn omap8250_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap8250_console_fixup() -> int __init {
...
// user did not set ttyO based console, so we don't care
    ...
    omap8250_runtime_resume, core::ptr::null_mut())
