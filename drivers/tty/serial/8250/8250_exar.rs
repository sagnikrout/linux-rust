...
//! Source: drivers/tty/serial/8250/8250_exar.c
#![no_std]
...
pub const PCI_DEVICE_ID_ACCESSIO_COM_2S: c_uint = 0x1052;
pub const PCI_DEVICE_ID_ACCESSIO_COM_4S: c_uint = 0x105d;
pub const PCI_DEVICE_ID_ACCESSIO_COM_8S: c_uint = 0x106c;
pub const PCI_DEVICE_ID_ACCESSIO_COM232_8: c_uint = 0x10a8;
pub const PCI_DEVICE_ID_ACCESSIO_COM_2SM: c_uint = 0x10d2;
pub const PCI_DEVICE_ID_ACCESSIO_COM_4SM: c_uint = 0x10db;
pub const PCI_DEVICE_ID_ACCESSIO_COM_8SM: c_uint = 0x10ea;
pub const PCI_DEVICE_ID_ADVANTECH_XR17V352: c_uint = 0x0018;
pub const PCI_DEVICE_ID_COMMTECH_4224PCI335: c_uint = 0x0002;
pub const PCI_DEVICE_ID_COMMTECH_4222PCI335: c_uint = 0x0004;
pub const PCI_DEVICE_ID_COMMTECH_2324PCI335: c_uint = 0x000a;
pub const PCI_DEVICE_ID_COMMTECH_2328PCI335: c_uint = 0x000b;
pub const PCI_DEVICE_ID_COMMTECH_4224PCIE: c_uint = 0x0020;
pub const PCI_DEVICE_ID_COMMTECH_4228PCIE: c_uint = 0x0021;
pub const PCI_DEVICE_ID_COMMTECH_4222PCIE: c_uint = 0x0022;
pub const PCI_VENDOR_ID_CONNECT_TECH: c_uint = 0x12c4;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_2_SP_OPTO: c_uint = 0x0340;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_SP_OPTO_A: c_uint = 0x0341;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_SP_OPTO_B: c_uint = 0x0342;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_2_XPRS: c_uint = 0x0350;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_XPRS_A: c_uint = 0x0351;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_XPRS_B: c_uint = 0x0352;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_XPRS: c_uint = 0x0353;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_16_XPRS_A: c_uint = 0x0354;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_16_XPRS_B: c_uint = 0x0355;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_2_XPRS_OPTO: c_uint = 0x0360;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_XPRS_OPTO_A: c_uint = 0x0361;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_XPRS_OPTO_B: c_uint = 0x0362;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_SP: c_uint = 0x0370;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_SP_232: c_uint = 0x0371;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_SP_485: c_uint = 0x0372;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_4_SP: c_uint = 0x0373;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_6_2_SP: c_uint = 0x0374;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_2_6_SP: c_uint = 0x0375;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_SP_232_NS: c_uint = 0x0376;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_2_XP_OPTO_LEFT: c_uint = 0x0380;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_2_XP_OPTO_RIGHT: c_uint = 0x0381;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_XP_OPTO: c_uint = 0x0382;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_4_4_XPRS_OPTO: c_uint = 0x0392;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_XPRS_LP: c_uint = 0x03A0;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_XPRS_LP_232: c_uint = 0x03A1;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_XPRS_LP_485: c_uint = 0x03A2;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCI_UART_8_XPRS_LP_232_NS: c_uint = 0x03A3;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCIE_XEG001: c_uint = 0x0602;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCIE_XR35X_BASE: c_uint = 0x1000;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCIE_XR35X_2: c_uint = 0x1002;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCIE_XR35X_4: c_uint = 0x1004;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCIE_XR35X_8: c_uint = 0x1008;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCIE_XR35X_12: c_uint = 0x100C;
pub const PCI_SUBDEVICE_ID_CONNECT_TECH_PCIE_XR35X_16: c_uint = 0x1010;
pub const PCI_DEVICE_ID_CONNECT_TECH_PCI_XR79X_12_XIG00X: c_uint = 0x110c;
pub const PCI_DEVICE_ID_CONNECT_TECH_PCI_XR79X_12_XIG01X: c_uint = 0x110d;
pub const PCI_DEVICE_ID_CONNECT_TECH_PCI_XR79X_16: c_uint = 0x1110;
pub const PCI_DEVICE_ID_EXAR_XR17V4358: c_uint = 0x4358;
pub const PCI_DEVICE_ID_EXAR_XR17V8358: c_uint = 0x8358;
pub const PCI_DEVICE_ID_EXAR_XR17V252: c_uint = 0x0252;
pub const PCI_DEVICE_ID_EXAR_XR17V254: c_uint = 0x0254;
pub const PCI_DEVICE_ID_EXAR_XR17V258: c_uint = 0x0258;
pub const PCI_SUBDEVICE_ID_USR_2980: c_uint = 0x0128;
pub const PCI_SUBDEVICE_ID_USR_2981: c_uint = 0x0129;
pub const UART_EXAR_INT0: c_uint = 0x80;
pub const UART_EXAR_8XMODE: c_uint = 0x88	/* 8X sampling rate select */;
pub const UART_EXAR_SLEEP: c_uint = 0x8b	/* Sleep mode */;
pub const UART_EXAR_DVID: c_uint = 0x8d	/* Device identification */;
pub const UART_EXAR_FCTR: c_uint = 0x08	/* Feature Control Register */;
pub const UART_FCTR_EXAR_IRDA: c_uint = 0x10	/* IrDa data encode select */;
pub const UART_FCTR_EXAR_485: c_uint = 0x20	/* Auto 485 half duplex dir ctl */;
pub const UART_FCTR_EXAR_TRGA: c_uint = 0x00	/* FIFO trigger table A */;
pub const UART_FCTR_EXAR_TRGB: c_uint = 0x60	/* FIFO trigger table B */;
pub const UART_FCTR_EXAR_TRGC: c_uint = 0x80	/* FIFO trigger table C */;
pub const UART_FCTR_EXAR_TRGD: c_uint = 0xc0	/* FIFO trigger table D programmable */;
pub const UART_EXAR_TXTRG: c_uint = 0x0a	/* Tx FIFO trigger level write-only */;
pub const UART_EXAR_RXTRG: c_uint = 0x0b	/* Rx FIFO trigger level write-only */;
pub const UART_EXAR_MPIOINT_7_0: c_uint = 0x8f	/* MPIOINT[7:0] */;
pub const UART_EXAR_MPIOLVL_7_0: c_uint = 0x90	/* MPIOLVL[7:0] */;
pub const UART_EXAR_MPIO3T_7_0: c_uint = 0x91	/* MPIO3T[7:0] */;
pub const UART_EXAR_MPIOINV_7_0: c_uint = 0x92	/* MPIOINV[7:0] */;
pub const UART_EXAR_MPIOSEL_7_0: c_uint = 0x93	/* MPIOSEL[7:0] */;
pub const UART_EXAR_MPIOOD_7_0: c_uint = 0x94	/* MPIOOD[7:0] */;
pub const UART_EXAR_MPIOINT_15_8: c_uint = 0x95	/* MPIOINT[15:8] */;
pub const UART_EXAR_MPIOLVL_15_8: c_uint = 0x96	/* MPIOLVL[15:8] */;
pub const UART_EXAR_MPIO3T_15_8: c_uint = 0x97	/* MPIO3T[15:8] */;
pub const UART_EXAR_MPIOINV_15_8: c_uint = 0x98	/* MPIOINV[15:8] */;
pub const UART_EXAR_MPIOSEL_15_8: c_uint = 0x99	/* MPIOSEL[15:8] */;
pub const UART_EXAR_MPIOOD_15_8: c_uint = 0x9a	/* MPIOOD[15:8] */;

pub const UART_EXAR_DLD: c_uint = 0x02 /* Divisor Fractional */;
pub const UART_EXAR_DLD_485_POLARITY: c_uint = 0x80 /* RS-485 Enable Signal Polarity */;
// EEPROM registers
pub const UART_EXAR_REGB: c_uint = 0x8e;

pub const UART_EXAR_XR17C15X_PORT_OFFSET: c_uint = 0x200;
pub const UART_EXAR_XR17V25X_PORT_OFFSET: c_uint = 0x200;
pub const UART_EXAR_XR17V35X_PORT_OFFSET: c_uint = 0x400;
//
...
//
// IOT2040 MPIOs 0..7
pub const IOT2040_UART_MODE_RS232: c_uint = 0x01;
pub const IOT2040_UART_MODE_RS485: c_uint = 0x02;
pub const IOT2040_UART_MODE_RS422: c_uint = 0x03;
pub const IOT2040_UART_TERMINATE_BUS: c_uint = 0x04;
pub const IOT2040_UART1_MASK: c_uint = 0x0f;
pub const IOT2040_UART2_SHIFT: c_int = 4;
pub const IOT2040_UARTS_DEFAULT_MODE: c_uint = 0x11	/* both RS232 */;
pub const IOT2040_UARTS_GPIO_LO_MODE: c_uint = 0x88	/* reserved pins as input */;
// IOT2040 MPIOs 8..15
pub const IOT2040_UARTS_ENABLE: c_uint = 0x03;
pub const IOT2040_UARTS_GPIO_HI_MODE: c_uint = 0xF8	/* enable & LED as outputs */;
// CTI EEPROM offsets
pub const CTI_EE_OFF_XR17C15X_OSC_FREQ: c_uint = 0x04  /* 2 words */;
pub const CTI_EE_OFF_XR17C15X_PART_NUM: c_uint = 0x0A  /* 4 words */;
pub const CTI_EE_OFF_XR17C15X_SERIAL_NUM: c_uint = 0x0E  /* 1 word */;
pub const CTI_EE_OFF_XR17V25X_OSC_FREQ: c_uint = 0x08  /* 2 words */;
pub const CTI_EE_OFF_XR17V25X_PART_NUM: c_uint = 0x0E  /* 4 words */;
pub const CTI_EE_OFF_XR17V25X_SERIAL_NUM: c_uint = 0x12  /* 1 word */;
pub const CTI_EE_OFF_XR17V35X_SERIAL_NUM: c_uint = 0x11  /* 2 word */;
pub const CTI_EE_OFF_XR17V35X_BRD_FLAGS: c_uint = 0x13  /* 1 word */;
pub const CTI_EE_OFF_XR17V35X_PORT_FLAGS: c_uint = 0x14  /* 1 word */;

pub const CTI_FPGA_RS485_IO_REG: c_uint = 0x2008;
pub const CTI_FPGA_CFG_INT_EN_REG: c_uint = 0x48;

pub const CTI_DEFAULT_PCI_OSC_FREQ: c_int = 29491200;
pub const CTI_DEFAULT_PCIE_OSC_FREQ: c_int = 125000000;
pub const CTI_DEFAULT_FPGA_OSC_FREQ: c_int = 33333333;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct exar8250_platform {
    int (*rs485_config)(struct uart_port *port, struct ktermios *termios,
    pub rs485): *mut serial_rs485,
    pub rs485_supported: *const serial_rs485,
    pub port): *mut *mut *mut int (register_gpio)(struct pci_dev pcidev, struct uart_8250_port,
    pub port): *mut *mut void (unregister_gpio)(struct uart_8250_port,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct exar8250_board {
    pub num_ports: c_uint,
    pub reg_shift: c_uint,
    int	(*setup)(struct exar8250 *priv, struct pci_dev *pcidev,
    pub idx): *mut *mut uart_8250_port port, int,
    pub pcidev): *mut *mut void (exit)(struct pci_dev,
}
...
#[no_mangle]
unsafe extern "C" fn exar_eeprom_init(priv: *mut exar8250) {
...
#[no_mangle]
unsafe extern "C" fn exar_mpio_set_low(priv: *mut exar8250, mpio_num: c_uint) -> c_int {
    static int exar_mpio_set_low(struct exar8250 *priv, unsigned int mpio_num)
    {
    return _exar_mpio_set(priv, mpio_num, false);
    }
#[no_mangle]
unsafe extern "C" fn exar_mpio_set_high(priv: *mut exar8250, mpio_num: c_uint) -> c_int {
    ...
    {
    let mut is_rs485: bool = !!(rs485.flags & SER_RS485_ENABLED);
...
#[no_mangle]
unsafe extern "C" fn exar_pm(port: *mut uart_port, state: c_uint, old: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn xr17v35x_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exar_shutdown(port: *mut uart_port) {
...
//
    ...
    {
    let mut offset: c_uint = idx * 0x200;
    let mut baud: c_uint = 1843200;
    u8 __iomem *p;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn cti_tristate_disable(priv: *mut exar8250, port_num: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cti_plx_int_enable(priv: *mut exar8250) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cti_read_osc_freq(priv: *mut exar8250, eeprom_offset: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cti_board_init_osc_freq(priv: *mut exar8250, pcidev: *mut pci_dev, eeprom_offset: u8) {
...
#[no_mangle]
unsafe extern "C" fn cti_board_init_fpga(priv: *mut exar8250, pcidev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cti_board_init_xr17v35x(priv: *mut exar8250, pcidev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cti_board_init_xr17v25x(priv: *mut exar8250, pcidev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cti_board_init_xr17c15x(priv: *mut exar8250, pcidev: *mut pci_dev) {
...
// Otherwise auto or no power on 485 tri-state support
    ...
    {
    let mut offset: c_uint = idx * 0x200;
    let mut baud: c_uint = 921600;
    port.port.uartclk = baud * 16;
    return default_setup(priv, pcidev, idx, offset, port);
    }
#[no_mangle]
unsafe extern "C" fn setup_gpio(pcidev: *mut pci_dev, p: *mut u8 __iomem) {
...
#[no_mangle]
unsafe extern "C" fn __xr17v35x_unregister_gpio(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn xr17v35x_register_gpio(pcidev: *mut pci_dev, port: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xr17v35x_unregister_gpio(port: *mut uart_8250_port) {
    ...
    port.port.private_data = core::ptr::null_mut();
    }
...
// Set DLD[7]=1 for inverted RS485 Enable logic
    ...
    let mut is_rs485: bool = !!(rs485.flags & SER_RS485_ENABLED);
    u8 __iomem *p = port.membase;
    let mut mask: u8 = IOT2040_UART1_MASK;
    u8 mode, value;
    if (is_rs485) {
...
//
    ...
    let mut offset: c_uint = idx * 0x400;
    let mut baud: c_uint = 7812500;
    u8 __iomem *p;
    int ret;
    port.port.uartclk = baud * 16;
...
#[no_mangle]
unsafe extern "C" fn pci_xr17v35x_exit(pcidev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn exar_misc_clear(priv: *mut exar8250) {
...
//
#[no_mangle]
unsafe extern "C" fn exar_misc_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn exar_get_nr_ports(board: *mut exar8250_board, pcidev: *mut pci_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn exar_pci_remove(pcidev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn exar_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exar_resume(dev: *mut device) -> c_int {
