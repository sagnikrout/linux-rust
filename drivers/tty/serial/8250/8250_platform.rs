...
//! Source: drivers/tty/serial/8250/8250_platform.c
#![no_std]
...
//
    let mut share_irqs: static bool = IS_ENABLED(CONFIG_SERIAL_8250_SHARE_IRQ);
    let mut nr_uarts: c_uint = CONFIG_SERIAL_8250_RUNTIME_UARTS;
...
// Macro flag: #define SERIAL_PORT_DFNS
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_set_isa_configurator(v: serial8250_isa_config_fn) {
...
#[no_mangle]
unsafe extern "C" fn __serial8250_isa_init_ports() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_isa_init_ports() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_probe_acpi(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial8250_probe_platform(dev: *mut platform_device, p: *mut plat_serial8250_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_suspend(dev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial8250_resume(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial8250_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn serial8250_exit() -> void __exit {
...
// in use).
//
    serial8250_isa_devs = core::ptr::null_mut();
