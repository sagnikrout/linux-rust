...
//! Source: drivers/tty/serial/8250/8250_ingenic.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_uart_config {
    pub tx_loadsz: c_int,
    pub fifosize: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ingenic_uart_data {
    pub clk_module: *mut clk,
    pub clk_baud: *mut clk,
    pub line: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn early_in(port: *mut uart_port, offset: c_int) -> u8 {
    static uint8_t early_in(struct uart_port *port, int offset)
    {
    return readl(port.membase + (offset << 2));
    }
#[no_mangle]
unsafe extern "C" fn early_out(port: *mut uart_port, offset: c_int, value: u8) {
    static void early_out(struct uart_port *port, int offset, uint8_t value)
    {
    writel(value, port.membase + (offset << 2));
    }
#[no_mangle]
unsafe extern "C" fn ingenic_early_console_putc(port: *mut uart_port, c: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_early_console_setup_clock(dev: *mut earlycon_device) -> void __init {
    ...
    if (offset < 0)
    return;
    prop = fdt_getprop(fdt, offset, "clock-frequency", core::ptr::null_mut());
    if (!prop)
    return;
...
//
    ...
    ingenic_early_console_setup);
#[no_mangle]
unsafe extern "C" fn ingenic_uart_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn ingenic_uart_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ingenic_uart_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ingenic_uart_remove(pdev: *mut platform_device) {
