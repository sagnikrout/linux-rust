...
//! Source: drivers/tty/serial/8250/8250_ni.c
#![no_std]
...
// TFS - TX FIFO Size
pub const NI16550_TFS_OFFSET: c_uint = 0x0C;
// RFS - RX FIFO Size
pub const NI16550_RFS_OFFSET: c_uint = 0x0D;
// PMR - Port Mode Register
pub const NI16550_PMR_OFFSET: c_uint = 0x0E;
...
//
pub const NI16550_PCR_OFFSET: c_uint = 0x0F;

// flags for ni16550_device_info

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ni16550_device_info {
    pub uartclk: u32,
    pub prescaler: u8,
    pub flags: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ni16550_data {
    pub line: c_int,
    pub clk: *mut clk,
}

#[no_mangle]
unsafe extern "C" fn ni16550_enable_transceivers(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni16550_disable_transceivers(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_pmr_rs232_mode(up: *mut uart_8250_port) -> bool {
    static bool is_pmr_rs232_mode(struct uart_8250_port *up)
    {
    let mut pmr: u8 = serial_in(up, NI16550_PMR_OFFSET);
    let mut pmr_mode: u8 = pmr & NI16550_PMR_MODE_MASK;
    let mut pmr_cap: u8 = pmr & NI16550_PMR_CAP_MASK;
//
...
//
    let mut pmr_mode: return = = NI16550_PMR_MODE_RS232;
//
// If it is not dual-mode capable, then decide based on the
// capability
//
    let mut pmr_cap: return = = NI16550_PMR_CAP_RS232;
    }
...
#[no_mangle]
unsafe extern "C" fn ni16550_rs485_setup(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn ni16550_port_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ni16550_port_shutdown(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn ni16550_read_fifo_size(uart: *mut uart_8250_port, reg: c_int) -> u8 {
    static u8 ni16550_read_fifo_size(struct uart_8250_port *uart, int reg)
    {
    let mut value: u8 = serial_in(uart, reg);
    if (value == 0x00 || value == 0xFF)
    return 128;
    return value;
    }
#[no_mangle]
unsafe extern "C" fn ni16550_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn ni16550_probe(pdev: *mut platform_device) -> c_int {
    static int ni16550_probe(struct platform_device *pdev)
    {
    struct uart_8250_port *uart __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ni16550_remove(pdev: *mut platform_device) {
