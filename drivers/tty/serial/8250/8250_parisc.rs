...
//! Source: drivers/tty/serial/8250/8250_parisc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn serial_init_chip(dev: *mut parisc_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn probe_serial_gsc() -> int __init {
