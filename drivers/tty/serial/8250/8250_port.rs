...
//! Source: drivers/tty/serial/8250/8250_port.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn default_serial_dl_read(up: *mut uart_8250_port) -> u32 {
    static u32 default_serial_dl_read(struct uart_8250_port *up)
    {
// Assign these in pieces to truncate any bits above 7.
    let mut dll: c_uchar = serial_in(up, UART_DLL);
    let mut dlm: c_uchar = serial_in(up, UART_DLM);
    return dll | dlm << 8;
    }
// Uart divisor latch write
#[no_mangle]
unsafe extern "C" fn default_serial_dl_write(up: *mut uart_8250_port, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn hub6_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hub6_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn mem_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mem_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn mem16_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn mem16_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mem32_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn mem32_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mem32be_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn mem32be_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn io_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn io_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn no_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
    static u32 no_serial_in(struct uart_port *p, unsigned int offset)
    {
    return ~0U;
    }
#[no_mangle]
unsafe extern "C" fn no_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
    static void no_serial_out(struct uart_port *p, unsigned int offset, u32 value)
    {
    }
    static int serial8250_default_handle_irq(struct uart_port *port);
#[no_mangle]
unsafe extern "C" fn set_io_from_upio(p: *mut uart_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_clear_fifos(p: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_clear_and_reinit_fifos(p: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_rpm_get(p: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_rpm_put(p: *mut uart_8250_port) {
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_em485_init(p: *mut uart_8250_port) -> c_int {
...
// Port locked to synchronize UART_IER access against the console.
    ...
    HRTIMER_MODE_REL);
    p.em485.port = p;
    p.em485.active_timer = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_em485_destroy(p: *mut uart_8250_port) {
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_rpm_get_tx(p: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_rpm_put_tx(p: *mut uart_8250_port) {
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_set_sleep(p: *mut uart_8250_port, sleep: c_int) {
    static void serial8250_set_sleep(struct uart_8250_port *p, int sleep)
    {
    let mut lcr: c_uchar = 0, efr = 0;
...
#[no_mangle]
unsafe extern "C" fn serial8250_clear_interrupts(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn __serial8250_clear_IER(up: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_clear_IER(up: *mut uart_8250_port) {
...
//
#[no_mangle]
unsafe extern "C" fn size_fifo(up: *mut uart_8250_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn autoconfig_read_divisor_id(p: *mut uart_8250_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn autoconfig_has_efr(up: *mut uart_8250_port) {
...
//
#[no_mangle]
unsafe extern "C" fn autoconfig_8250(up: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn broken_efr(up: *mut uart_8250_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn autoconfig_16550a(up: *mut uart_8250_port) {
...
//
#[no_mangle]
unsafe extern "C" fn autoconfig(up: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn autoconfig_irq(up: *mut uart_8250_port) {
    static void autoconfig_irq(struct uart_8250_port *up)
    {
    struct uart_port *port = &up.port;
    unsigned char save_mcr, save_ier;
    let mut save_ICP: c_uchar = 0;
    let mut ICP: c_uint = 0;
    unsigned long irqs;
    int irq;
...
#[no_mangle]
unsafe extern "C" fn serial8250_stop_rx(port: *mut uart_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_em485_stop_tx(p: *mut uart_8250_port, toggle_ier: bool) {
    void serial8250_em485_stop_tx(struct uart_8250_port *p, bool toggle_ier)
    {
    let mut mcr: c_uchar = serial8250_in_MCR(p);
...
#[no_mangle]
unsafe extern "C" fn serial8250_em485_handle_stop_tx(t: *mut hrtimer) -> enum hrtimer_restart {
    static enum hrtimer_restart serial8250_em485_handle_stop_tx(struct hrtimer *t)
    {
    ...
    p.rs485_stop_tx(p, true);
    em485.active_timer = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __stop_tx_rs485(p: *mut uart_8250_port, stop_delay: u64) {
...
#[no_mangle]
pub unsafe extern "C" fn __stop_tx(p: *mut uart_8250_port) {
    static inline void __stop_tx(struct uart_8250_port *p)
    {
    struct uart_8250_em485 *em485 = p.em485;
    if (em485) {
    let mut lsr: u16 = serial_lsr_in(p);
    let mut stop_delay: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn serial8250_stop_tx(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn __start_tx(port: *mut uart_port) {
    ...
    let mut lsr: u16 = serial_lsr_in(up);
    if (lsr & UART_LSR_THRE)
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_em485_start_tx(up: *mut uart_8250_port, toggle_ier: bool) {
    void serial8250_em485_start_tx(struct uart_8250_port *up, bool toggle_ier)
    {
    let mut mcr: c_uchar = serial8250_in_MCR(up);
...
#[no_mangle]
unsafe extern "C" fn start_tx_rs485(port: *mut uart_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn serial8250_em485_handle_start_tx(t: *mut hrtimer) -> enum hrtimer_restart {
    static enum hrtimer_restart serial8250_em485_handle_start_tx(struct hrtimer *t)
    {
    struct uart_8250_em485 *em485 = container_of(t, struct uart_8250_em485,
    start_tx_timer);
...
#[no_mangle]
unsafe extern "C" fn serial8250_start_tx(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_throttle(port: *mut uart_port) {
    static void serial8250_throttle(struct uart_port *port)
    {
    port.throttle(port);
    }
#[no_mangle]
unsafe extern "C" fn serial8250_unthrottle(port: *mut uart_port) {
    static void serial8250_unthrottle(struct uart_port *port)
    {
    port.unthrottle(port);
    }
#[no_mangle]
unsafe extern "C" fn serial8250_disable_ms(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_enable_ms(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_read_char(up: *mut uart_8250_port, lsr: u16) {
...
//
    ...
    port.icount.parity++;
#[no_mangle]
pub unsafe extern "C" fn if(UART_LSR_FE: lsr &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_rx_chars(up: *mut uart_8250_port, lsr: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_tx_chars(up: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_modem_status(up: *mut uart_8250_port) -> c_uint {
    unsigned int serial8250_modem_status(struct uart_8250_port *up)
    {
    struct uart_port *port = &up.port;
    let mut status: c_uint = serial_in(up, UART_MSR);
    status |= up.msr_saved_flags;
    up.msr_saved_flags = 0;
    if (status & UART_MSR_ANY_DELTA && up.ier & UART_IER_MSI &&
    port.state != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn handle_rx_dma(up: *mut uart_8250_port, iir: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_handle_irq_locked(port: *mut uart_port, iir: c_uint) {
    void serial8250_handle_irq_locked(struct uart_port *port, unsigned int iir)
    {
    struct uart_8250_port *up = up_to_u8250p(port);
    struct tty_port *tport = &port.state.port;
    let mut skip_rx: bool = false;
    u16 status;
    lockdep_assert_held_once(&port.lock);
...
//
    ...
    serial8250_tx_chars(up);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !up->dma->tx_running) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_handle_irq(port: *mut uart_port, iir: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial8250_default_handle_irq(port: *mut uart_port) -> c_int {
    static int serial8250_default_handle_irq(struct uart_port *port)
    {
    struct uart_8250_port *up = up_to_u8250p(port);
    unsigned int iir;
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_tx_threshold_handle_irq(port: *mut uart_port) -> c_int {
    static int serial8250_tx_threshold_handle_irq(struct uart_port *port)
    {
    let mut iir: c_uint = serial_port_in(port, UART_IIR);
...
#[no_mangle]
unsafe extern "C" fn serial8250_tx_empty(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_do_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn serial8250_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_do_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_do_break_ctl(port: *mut uart_port, break_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_break_ctl(port: *mut uart_port, break_state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wait_for_lsr(up: *mut uart_8250_port, bits: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wait_for_xmitr(up: *mut uart_8250_port, bits: c_int) {
...
//
    ...
    let mut msr: c_uint = serial_in(up, UART_MSR);
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_get_poll_char(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial8250_startup_special(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_set_TRG_levels(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_THRE_test(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_init_mctrl(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_iir_txen_test(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_initialize(port: *mut uart_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_do_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: serial8250_request_dma(up)) -> else {
    else if (serial8250_request_dma(up))
    msg = "failed to request DMA";
    if (msg) {
    dev_warn_ratelimited(port.dev, "%s\n", msg);
    up.dma = core::ptr::null_mut();
    }
    }
//
...
#[no_mangle]
unsafe extern "C" fn serial8250_startup(port: *mut uart_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_do_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_flush_buffer(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_do_get_divisor(port: *mut uart_port, baud: c_uint) -> c_uint {
    static unsigned int serial8250_do_get_divisor(struct uart_port *port, unsigned int baud)
    {
    let mut magic_multiplier: upf_t = port.flags & UPF_MAGIC_MULTIPLIER;
    struct uart_8250_port *up = up_to_u8250p(port);
    unsigned int quot;
//
...
//
    ...
    quot = 0x8001;
#[no_mangle]
pub unsafe extern "C" fn if(12: magic_multiplier && baud >= port->uartclk /) -> else {
...
#[no_mangle]
unsafe extern "C" fn serial8250_compute_lcr(up: *mut uart_8250_port, c_cflag: tcflag_t) -> c_uchar {
    static unsigned char serial8250_compute_lcr(struct uart_8250_port *up, tcflag_t c_cflag)
    {
    let mut lcr: u8 = UART_LCR_WLEN(tty_get_char_size(c_cflag));
    if (c_cflag & CSTOPB)
    lcr |= UART_LCR_STOP;
    if (c_cflag & PARENB)
    lcr |= UART_LCR_PARITY;
...
//
    ...
    {
    let mut tolerance: c_uint = port.uartclk / 100;
    unsigned int min;
    unsigned int max;
//
// Handle magic divisors for baud rates above baud_base on SMSC
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_update_uartclk(port: *mut uart_port, uartclk: c_uint) {
    ...
    return;
    serial8250_do_set_termios(port, &tty.termios, core::ptr::null_mut());
    return;
    }
    guard(mutex)(&tport.mutex);
    port.uartclk = uartclk;
...
#[no_mangle]
unsafe extern "C" fn serial8250_set_mini(port: *mut uart_port, termios: *mut ktermios) {
    ...
    let mut csize: tcflag_t = termios.c_cflag & CSIZE;
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_set_afe(port: *mut uart_port, termios: *mut ktermios) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_set_errors_and_ignores(port: *mut uart_port, termios: *mut ktermios) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_set_ier(port: *mut uart_port, termios: *mut ktermios) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_set_efr(port: *mut uart_port, termios: *mut ktermios) {
    static void serial8250_set_efr(struct uart_port *port, struct ktermios *termios)
    {
    struct uart_8250_port *up = up_to_u8250p(port);
    let mut efr_reg: u8 = UART_EFR;
    let mut efr: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn serial8250_set_fcr(port: *mut uart_port, termios: *mut ktermios) {
    static void serial8250_set_fcr(struct uart_port *port, struct ktermios *termios)
    {
    struct uart_8250_port *up = up_to_u8250p(port);
    let mut is_16750: bool = port.type == PORT_16750;
    if (is_16750)
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_do_set_ldisc(port: *mut uart_port, termios: *mut ktermios) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_port_size(pt: *mut uart_8250_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_request_std_resource(up: *mut uart_8250_port) -> c_int {
    static int serial8250_request_std_resource(struct uart_8250_port *up)
    {
    let mut size: c_uint = serial8250_port_size(up);
    struct uart_port *port = &up.port;
...
#[no_mangle]
unsafe extern "C" fn serial8250_release_std_resource(up: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_release_port(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_request_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fcr_get_rxtrig_bytes(up: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bytes_to_fcr_rxtrig(up: *mut uart_8250_port, bytes: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_get_rxtrig(port: *mut tty_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_serial8250_get_rxtrig(port: *mut tty_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_set_rxtrig(port: *mut tty_port, bytes: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_serial8250_set_rxtrig(port: *mut tty_port, bytes: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_dev_spec_attr_grp(up: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_config_port(port: *mut uart_port, flags: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_init_port(up: *mut uart_8250_port) {
    void serial8250_init_port(struct uart_8250_port *up)
    {
    struct uart_port *port = &up.port;
    spin_lock_init(&port.lock);
    port.ctrl_id = 0;
    port.pm = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_set_defaults(up: *mut uart_8250_port) {
    void serial8250_set_defaults(struct uart_8250_port *up)
    {
    struct uart_port *port = &up.port;
    if (up.port.flags & UPF_FIXED_TYPE) {
    let mut type: c_uint = up.port.type;
    if (!up.port.fifosize)
...
#[no_mangle]
unsafe extern "C" fn serial8250_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_console_wait_putchar(port: *mut uart_port, ch: c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_console_restore(up: *mut uart_8250_port) {
    ...
    baud = serial8250_get_baud_rate(port, &termios, core::ptr::null_mut());
    quot = serial8250_get_divisor(port, baud, &frac);
    serial8250_set_divisor(port, baud, quot, frac);
    serial_port_out(port, UART_LCR, up.lcr);
...
//
    ...
    let mut fifosize: c_uint = up.tx_loadsz;
    struct uart_port *port = &up.port;
    let mut tx_count: c_uint = 0;
    let mut cr_sent: bool = false;
    unsigned int i;
    while (s != end) {
...
#[no_mangle]
unsafe extern "C" fn probe_baud(port: *mut uart_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn console_msr_handler(iwp: *mut irq_work) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_console_setup(port: *mut uart_port, options: *mut c_char, probe: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: probe) -> else {
    else if (probe)
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_console_exit(port: *mut uart_port) -> c_int {
