...
//! Source: drivers/tty/serial/8250/8250_ce4100.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mem_serial_in(p: *mut uart_port, offset: c_int) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn ce4100_mem_serial_in(p: *mut uart_port, offset: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ce4100_mem_serial_out(p: *mut uart_port, offset: c_uint, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn ce4100_serial_fixup(port: c_int, up: *mut uart_port, capabilities: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn sdv_serial_fixup() -> void __init {
