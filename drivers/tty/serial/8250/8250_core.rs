...
//! Source: drivers/tty/serial/8250/8250_core.c
#![no_std]
...
pub const PASS_LIMIT: c_int = 512;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct irq_info {
    pub node: hlist_node,
    pub irq: c_int,
    pub /: *mut *mut spinlock_t lock; / Protects list not the hash,
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t serial8250_interrupt(int irq, void *dev_id)
    {
    struct irq_info *i = dev_id;
    struct list_head *l, *end = core::ptr::null_mut();
    let mut pass_counter: c_int = 0, handled = 0;
...
//
#[no_mangle]
unsafe extern "C" fn serial_do_unlink(i: *mut irq_info, up: *mut uart_8250_port) {
    ...
    i.head = core::ptr::null_mut();
    }
    spin_unlock_irq(&i.lock);
// List empty so throw away the hash node
    if (i.head == core::ptr::null_mut()) {
    hlist_del(&i.node);
    kfree(i);
    }
    }
...
#[no_mangle]
unsafe extern "C" fn serial_link_irq_chain(up: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_unlink_irq_chain(up: *mut uart_8250_port) {
    ...
    hash_for_each_possible(irq_lists, i, node, up.port.irq)
    if (i.irq == up.port.irq) {
    if (WARN_ON(i.head == core::ptr::null_mut()))
    return;
    if (list_empty(i.head))
...
//
#[no_mangle]
unsafe extern "C" fn serial8250_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn serial8250_backup_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn univ8250_setup_timer(up: *mut uart_8250_port) {
...
#[no_mangle]
unsafe extern "C" fn univ8250_setup_irq(up: *mut uart_8250_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn univ8250_release_irq(up: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_apply_quirks(up: *mut uart_8250_port) {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_register_ports(drv: *mut uart_driver, dev: *mut device) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn univ8250_console_device_lock(co: *mut console, flags: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn univ8250_console_device_unlock(co: *mut console, flags: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn univ8250_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
// link port to console
    ...
    if (retval != 0)
    uart_port_set_cons(port, core::ptr::null_mut());
    return retval;
    }
#[no_mangle]
unsafe extern "C" fn univ8250_console_exit(co: *mut console) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn univ8250_console_init() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn early_serial_setup(port: *mut uart_port) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_suspend_port(line: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_resume_port(line: c_int) {
...
#[no_mangle]
unsafe extern "C" fn serial_8250_overrun_backoff_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_register_8250_port(up: *const uart_8250_port) -> c_int {
...
// Check the type (again)! It might have changed by the port.type assignment above.
    ...
    if (serial8250_isa_config != core::ptr::null_mut())
...
// Initialise interrupt backoff work if required
    ...
    return ret;
    err:
    uart.port.dev = core::ptr::null_mut();
    return ret;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn serial8250_unregister_port(line: c_int) {
