...
//! Source: drivers/tty/serial/8250/8250_fsl.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn fsl8250_handle_irq(port: *mut uart_port) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl8250_data {
    pub line: c_int,
}

#[no_mangle]
unsafe extern "C" fn fsl8250_acpi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl8250_acpi_remove(pdev: *mut platform_device) {
