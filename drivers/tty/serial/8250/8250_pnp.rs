...
//! Source: drivers/tty/serial/8250/8250_pnp.c
#![no_std]
...
pub const UNKNOWN_DEV: c_uint = 0x3000;
pub const CIR_PORT: c_uint = 0x0800;
...
//
    ...
    "33600", "28800", "14400", "V.90", "V.34", "V.32", core::ptr::null_mut()
    };
#[no_mangle]
unsafe extern "C" fn check_name(name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn check_resources(dev: *mut pnp_dev) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn serial_pnp_guess_board(dev: *mut pnp_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serial_pnp_remove(dev: *mut pnp_dev) {
    static void serial_pnp_remove(struct pnp_dev *dev)
    {
    let mut line: c_long = (long)pnp_get_drvdata(dev);
    dev.capabilities &= ~PNP_CONSOLE;
    serial8250_unregister_port(line);
    }
#[no_mangle]
unsafe extern "C" fn serial_pnp_suspend(dev: *mut device) -> c_int {
    static int serial_pnp_suspend(struct device *dev)
    {
    let mut line: c_long = (long)dev_get_drvdata(dev);
    serial8250_suspend_port(line);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn serial_pnp_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serial8250_pnp_init() -> c_int {
    int serial8250_pnp_init(void)
    {
    return pnp_register_driver(&serial_pnp_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn serial8250_pnp_exit() {
