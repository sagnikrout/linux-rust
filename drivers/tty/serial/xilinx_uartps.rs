...
//! Source: drivers/tty/serial/xilinx_uartps.c
#![no_std]
...
pub const CDNS_UART_NR_PORTS: c_int = 16;

pub const TX_TIMEOUT: c_int = 500000;
// Rx Trigger level
    let mut rx_trigger_level: static int = 56;
    module_param(rx_trigger_level, uint, 0444);
    MODULE_PARM_DESC(rx_trigger_level, "Rx trigger level, 1-63 bytes");
// Rx Timeout
    let mut rx_timeout: static int = 10;
    module_param(rx_timeout, uint, 0444);
    MODULE_PARM_DESC(rx_timeout, "Rx timeout, 1-255");
// Register offsets for the UART.
pub const CDNS_UART_CR: c_uint = 0x00  /* Control Register */;
pub const CDNS_UART_MR: c_uint = 0x04  /* Mode Register */;
pub const CDNS_UART_IER: c_uint = 0x08  /* Interrupt Enable */;
pub const CDNS_UART_IDR: c_uint = 0x0C  /* Interrupt Disable */;
pub const CDNS_UART_IMR: c_uint = 0x10  /* Interrupt Mask */;
pub const CDNS_UART_ISR: c_uint = 0x14  /* Interrupt Status */;
pub const CDNS_UART_BAUDGEN: c_uint = 0x18  /* Baud Rate Generator */;
pub const CDNS_UART_RXTOUT: c_uint = 0x1C  /* RX Timeout */;
pub const CDNS_UART_RXWM: c_uint = 0x20  /* RX FIFO Trigger Level */;
pub const CDNS_UART_MODEMCR: c_uint = 0x24  /* Modem Control */;
pub const CDNS_UART_MODEMSR: c_uint = 0x28  /* Modem Status */;
pub const CDNS_UART_SR: c_uint = 0x2C  /* Channel Status */;
pub const CDNS_UART_FIFO: c_uint = 0x30  /* FIFO */;
pub const CDNS_UART_BAUDDIV: c_uint = 0x34  /* Baud Rate Divider */;
pub const CDNS_UART_FLOWDEL: c_uint = 0x38  /* Flow Delay */;
pub const CDNS_UART_IRRX_PWIDTH: c_uint = 0x3C  /* IR Min Received Pulse Width */;
pub const CDNS_UART_IRTX_PWIDTH: c_uint = 0x40  /* IR Transmitted pulse Width */;
pub const CDNS_UART_TXWM: c_uint = 0x44  /* TX FIFO Trigger Level */;
pub const CDNS_UART_RXBS: c_uint = 0x48  /* RX FIFO byte status register */;
// Control Register Bit Definitions
pub const CDNS_UART_CR_STOPBRK: c_uint = 0x00000100  /* Stop TX break */;
pub const CDNS_UART_CR_STARTBRK: c_uint = 0x00000080  /* Set TX break */;
pub const CDNS_UART_CR_TX_DIS: c_uint = 0x00000020  /* TX disabled. */;
pub const CDNS_UART_CR_TX_EN: c_uint = 0x00000010  /* TX enabled */;
pub const CDNS_UART_CR_RX_DIS: c_uint = 0x00000008  /* RX disabled. */;
pub const CDNS_UART_CR_RX_EN: c_uint = 0x00000004  /* RX enabled */;
pub const CDNS_UART_CR_TXRST: c_uint = 0x00000002  /* TX logic reset */;
pub const CDNS_UART_CR_RXRST: c_uint = 0x00000001  /* RX logic reset */;
pub const CDNS_UART_CR_RST_TO: c_uint = 0x00000040  /* Restart Timeout Counter */;
pub const CDNS_UART_RXBS_PARITY: c_uint = 0x00000001 /* Parity error status */;
pub const CDNS_UART_RXBS_FRAMING: c_uint = 0x00000002 /* Framing error status */;
pub const CDNS_UART_RXBS_BRK: c_uint = 0x00000004 /* Overrun error status */;
//
// Mode Register:
...
//
pub const CDNS_UART_MR_CLKSEL: c_uint = 0x00000001  /* Pre-scalar selection */;
pub const CDNS_UART_MR_CHMODE_L_LOOP: c_uint = 0x00000200  /* Local loop back mode */;
pub const CDNS_UART_MR_CHMODE_NORM: c_uint = 0x00000000  /* Normal mode */;
pub const CDNS_UART_MR_CHMODE_MASK: c_uint = 0x00000300  /* Mask for mode bits */;
pub const CDNS_UART_MR_STOPMODE_2_BIT: c_uint = 0x00000080  /* 2 stop bits */;
pub const CDNS_UART_MR_STOPMODE_1_BIT: c_uint = 0x00000000  /* 1 stop bit */;
pub const CDNS_UART_MR_PARITY_NONE: c_uint = 0x00000020  /* No parity mode */;
pub const CDNS_UART_MR_PARITY_MARK: c_uint = 0x00000018  /* Mark parity mode */;
pub const CDNS_UART_MR_PARITY_SPACE: c_uint = 0x00000010  /* Space parity mode */;
pub const CDNS_UART_MR_PARITY_ODD: c_uint = 0x00000008  /* Odd parity mode */;
pub const CDNS_UART_MR_PARITY_EVEN: c_uint = 0x00000000  /* Even parity mode */;
pub const CDNS_UART_MR_CHARLEN_6_BIT: c_uint = 0x00000006  /* 6 bits data */;
pub const CDNS_UART_MR_CHARLEN_7_BIT: c_uint = 0x00000004  /* 7 bits data */;
pub const CDNS_UART_MR_CHARLEN_8_BIT: c_uint = 0x00000000  /* 8 bits data */;
//
// Interrupt Registers:
...
//
pub const CDNS_UART_IXR_TOUT: c_uint = 0x00000100 /* RX Timeout error interrupt */;
pub const CDNS_UART_IXR_PARITY: c_uint = 0x00000080 /* Parity error interrupt */;
pub const CDNS_UART_IXR_FRAMING: c_uint = 0x00000040 /* Framing error interrupt */;
pub const CDNS_UART_IXR_OVERRUN: c_uint = 0x00000020 /* Overrun error interrupt */;
pub const CDNS_UART_IXR_TXFULL: c_uint = 0x00000010 /* TX FIFO Full interrupt */;
pub const CDNS_UART_IXR_TXEMPTY: c_uint = 0x00000008 /* TX FIFO empty interrupt */;
pub const CDNS_UART_ISR_RXEMPTY: c_uint = 0x00000002 /* RX FIFO empty interrupt */;
pub const CDNS_UART_IXR_RXTRIG: c_uint = 0x00000001 /* RX FIFO trigger interrupt */;
pub const CDNS_UART_IXR_RXFULL: c_uint = 0x00000004 /* RX FIFO full interrupt. */;
pub const CDNS_UART_IXR_RXEMPTY: c_uint = 0x00000002 /* RX FIFO empty interrupt. */;
pub const CDNS_UART_IXR_RXMASK: c_uint = 0x000021e7 /* Valid RX bit mask */;
//
...
pub const CDNS_UART_IXR_BRK: c_uint = 0x00002000;
...
//
pub const CDNS_UART_MODEMCR_FCM: c_uint = 0x00000020 /* Automatic flow control mode */;
pub const CDNS_UART_MODEMCR_RTS: c_uint = 0x00000002 /* Request to send output control */;
pub const CDNS_UART_MODEMCR_DTR: c_uint = 0x00000001 /* Data Terminal Ready */;
//
...
//
pub const CDNS_UART_SR_RXEMPTY: c_uint = 0x00000002 /* RX FIFO empty */;
pub const CDNS_UART_SR_TXEMPTY: c_uint = 0x00000008 /* TX FIFO empty */;
pub const CDNS_UART_SR_TXFULL: c_uint = 0x00000010 /* TX FIFO full */;
pub const CDNS_UART_SR_RXTRIG: c_uint = 0x00000001 /* Rx Trigger */;
pub const CDNS_UART_SR_TACTIVE: c_uint = 0x00000800 /* TX state machine active */;
// baud dividers min/max values
pub const CDNS_UART_BDIV_MIN: c_int = 4;
pub const CDNS_UART_BDIV_MAX: c_int = 255;
pub const CDNS_UART_CD_MAX: c_int = 65535;
...
pub struct cdns_uart {
    ...
    pub quirks: u32,
    pub cts_override: bool,
    pub gpiod_rts: *mut gpio_desc,
    pub rs485_tx_started: bool,
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_handle_rx(dev_id: *mut c_void, isrstatus: c_uint) {
    static void cdns_uart_handle_rx(void *dev_id, unsigned int isrstatus)
    {
    struct uart_port *port = (struct uart_port *)dev_id;
    struct cdns_uart *cdns_uart = port.private_data;
    unsigned int data;
    let mut rxbs_status: c_uint = 0;
    unsigned int status_mask;
    let mut framerrprocessed: c_uint = 0;
    let mut status: c_char = TTY_NORMAL;
...
//
#[no_mangle]
unsafe extern "C" fn cdns_rts_gpio_enable(cdns_uart: *mut cdns_uart, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_rs485_tx_setup(cdns_uart: *mut cdns_uart) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_rs485_rx_setup(cdns_uart: *mut cdns_uart) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_tx_empty(port: *mut uart_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_rs485_rx_callback(t: *mut hrtimer) -> enum hrtimer_restart {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_calc_after_tx_delay(cdns_uart: *mut cdns_uart) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_handle_tx(dev_id: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    ...
    let mut bestbaud: c_uint = 0;
    unsigned int bauderror;
    let mut besterror: c_uint = ~0;
...
//
#[no_mangle]
unsafe extern "C" fn cdns_rs485_tx_callback(t: *mut hrtimer) -> enum hrtimer_restart {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_start_tx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_stop_tx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_stop_rx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_break_ctl(port: *mut uart_port, ctl: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_startup(port: *mut uart_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_shutdown(port: *mut uart_port) {
...
//
    ...
    {
    return port.type == PORT_XUARTPS ? CDNS_UART_NAME : core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_request_port(port: *mut uart_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_release_port(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_config_port(port: *mut uart_port, flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_get_mctrl(port: *mut uart_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cdns_uart_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn cdns_uart_poll_get_char(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_uart_poll_put_char(port: *mut uart_port, c: c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_console_putchar(port: *mut uart_port, ch: c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_console_setup(co: *mut console, options: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_suspend(device: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdns_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cdns_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    cdns_runtime_resume, core::ptr::null_mut())
    };
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_probe(pdev: *mut platform_device) -> c_int {
...
// Look for a serialN alias
    ...
    cdns_uart_data.rstc = devm_reset_control_get_optional_exclusive(&pdev.dev, core::ptr::null_mut());
...
// This is not port which is used for console that's why clean it up
    ...
    console_port = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn cdns_uart_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cdns_uart_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cdns_uart_exit() -> void __exit {
