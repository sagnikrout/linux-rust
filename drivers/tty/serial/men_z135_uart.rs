...
//! Source: drivers/tty/serial/men_z135_uart.c
#![no_std]
...
pub const MEN_Z135_MAX_PORTS: c_int = 12;
pub const MEN_Z135_BASECLK: c_int = 29491200;
pub const MEN_Z135_FIFO_SIZE: c_int = 1024;
pub const MEN_Z135_FIFO_WATERMARK: c_int = 1020;
pub const MEN_Z135_STAT_REG: c_uint = 0x0;
pub const MEN_Z135_RX_RAM: c_uint = 0x4;
pub const MEN_Z135_TX_RAM: c_uint = 0x400;
pub const MEN_Z135_RX_CTRL: c_uint = 0x800;
pub const MEN_Z135_TX_CTRL: c_uint = 0x804;
pub const MEN_Z135_CONF_REG: c_uint = 0x808;
pub const MEN_Z135_UART_FREQ: c_uint = 0x80c;
pub const MEN_Z135_BAUD_REG: c_uint = 0x810;
pub const MEN_Z135_TIMEOUT: c_uint = 0x814;

    | MEN_Z135_IER_RLSIEN	\
    | MEN_Z135_IER_MSIEN	\
    | MEN_Z135_IER_TXCIEN)

pub const MEN_Z135_NSTB1: c_int = 0;
pub const MEN_Z135_NSTB2: c_int = 1;

pub const MEN_Z135_PAR_DIS: c_int = 0;
pub const MEN_Z135_PAR_ENA: c_int = 1;

pub const MEN_Z135_PTY_ODD: c_int = 0;
pub const MEN_Z135_PTY_EVN: c_int = 1;

    static int line;
    let mut txlvl: static int = 5;
    module_param(txlvl, int, S_IRUGO);
    MODULE_PARM_DESC(txlvl, "TX IRQ trigger level 0-7, default 5 (128 byte)");
    let mut rxlvl: static int = 6;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct men_z135_port {
    pub port: uart_port,
    pub mdev: *mut mcb_device,
    pub mem: *mut resource,
    pub rxbuf: *mut c_uchar,
    pub stat_reg: u32,
    pub lock: spinlock_t,
    pub automode: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_handle_modem_status(uart: *mut men_z135_port) {
...
#[no_mangle]
unsafe extern "C" fn men_z135_handle_lsr(uart: *mut men_z135_port) {
...
//
#[no_mangle]
unsafe extern "C" fn get_rx_fifo_content(uart: *mut men_z135_port) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_handle_rx(uart: *mut men_z135_port) {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_handle_tx(uart: *mut men_z135_port) {
...
#[no_mangle]
pub unsafe extern "C" fn if(txfree: qlen >) -> else {
    else if (qlen > txfree)
    n = txfree;
    else
    n = qlen;
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_intr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_request_irq(uart: *mut men_z135_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_tx_empty(port: *mut uart_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_set_mctrl(port: *mut uart_port, mctrl: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_get_mctrl(port: *mut uart_port) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_stop_tx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_disable_ms(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_start_tx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_stop_rx(port: *mut uart_port) {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_enable_ms(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn men_z135_startup(port: *mut uart_port) -> c_int {
    static int men_z135_startup(struct uart_port *port)
    {
    struct men_z135_port *uart = to_men_z135(port);
    int err;
    let mut conf_reg: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn men_z135_shutdown(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn men_z135_release_port(port: *mut uart_port) {
...
#[no_mangle]
unsafe extern "C" fn men_z135_request_port(port: *mut uart_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn men_z135_config_port(port: *mut uart_port, type: c_int) {
...
//
    ...
    uart.port.membase = core::ptr::null_mut();
    uart.mdev = mdev;
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_remove(mdev: *mut mcb_device) {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn men_z135_exit() -> void __exit {
