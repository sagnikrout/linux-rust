...
//! Source: drivers/tty/amiserial.c
#![no_std]
...
pub struct serial_state {
    ...
    pub read_status_mask: c_int,
    pub ignore_status_mask: c_int,
    pub timeout: c_int,
    pub quot: c_int,
    pub /: *mut *mut int IER; / Interrupt Enable Register,
    pub /: *mut *mut int MCR; / Modem control register,
...
pub const XMIT_FIFO_SIZE: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn rtsdtr_ctrl(bits: c_int) -> __inline__ void {
...
//
#[no_mangle]
unsafe extern "C" fn rs_stop(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn rs_start(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn receive_chars(info: *mut serial_state) {
...
//
    ...
    icount.parity++;
#[no_mangle]
pub unsafe extern "C" fn if(UART_LSR_FE: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn transmit_chars(info: *mut serial_state) {
...
#[no_mangle]
unsafe extern "C" fn check_modem_status(info: *mut serial_state) {
    static void check_modem_status(struct serial_state *info)
    {
    struct tty_port *port = &info.tport;
    let mut status: c_uchar = ciab.pra & (SER_DCD | SER_CTS | SER_DSR);
...
#[no_mangle]
unsafe extern "C" fn ser_vbl_int(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ser_rx_int(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ser_tx_int(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn rs_startup(tty: *mut tty_struct, info: *mut serial_state) -> c_int {
...
//
    change_speed(tty, info, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn rs_shutdown(tty: *mut tty_struct, info: *mut serial_state) {
...
//
    ...
    kfree(info.xmit.buf);
    info.xmit.buf = core::ptr::null_mut();
    info.IER = 0;
...
//
    ...
    {
    struct tty_port *port = &info.tport;
    let mut quot: c_int = 0, baud_base, baud;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: baud) -> else {
    else if (baud)
    quot = baud_base / baud;
    }
...
#[no_mangle]
unsafe extern "C" fn rs_put_char(tty: *mut tty_struct, ch: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs_flush_chars(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn rs_write(tty: *mut *mut tty_struct, buf: *const u8, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn rs_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rs_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rs_flush_buffer(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn rs_send_xchar(tty: *mut tty_struct, ch: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn rs_throttle(tty: *mut *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn rs_unthrottle(tty: *mut *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn get_serial_info(tty: *mut tty_struct, ss: *mut serial_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_serial_info(tty: *mut tty_struct, ss: *mut serial_struct) -> c_int {
...
// warn about deprecation unless clearing
    ...
    change_speed(tty, state, core::ptr::null_mut());
    }
    } else
...
//
#[no_mangle]
unsafe extern "C" fn get_lsr_info(info: *mut serial_state, value: *mut unsigned int __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs_tiocmget(tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rs_break(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs_set_termios(tty: *mut tty_struct, old_termios: *const ktermios) {
...
//
#[no_mangle]
unsafe extern "C" fn rs_close(tty: *mut tty_struct, filp: *mut *mut file) {
...
//
#[no_mangle]
unsafe extern "C" fn rs_wait_until_sent(tty: *mut tty_struct, timeout: c_int) {
    static void rs_wait_until_sent(struct tty_struct *tty, int timeout)
    {
    struct serial_state *info = tty.driver_data;
...
//
#[no_mangle]
unsafe extern "C" fn rs_hangup(tty: *mut tty_struct) {
    ...
    info.tport.tty = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn rs_open(tty: *mut tty_struct, filp: *mut *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amiga_carrier_raised(port: *mut tty_port) -> bool {
    static bool amiga_carrier_raised(struct tty_port *port)
    {
    return !(ciab.pra & SER_DCD);
    }
#[no_mangle]
unsafe extern "C" fn amiga_dtr_rts(port: *mut tty_port, active: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn amiga_serial_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn amiga_serial_remove(pdev: *mut platform_device) -> void __exit {
...
//
#[no_mangle]
unsafe extern "C" fn amiga_serial_putc(c: c_char) {
...
//
    ...
    unsigned count)
    {
    let mut intena: c_ushort = amiga_custom.intenar;
    amiga_custom.intena = IF_TBE;
    while (count--) {
    if (*s == '\n')
    amiga_serial_putc('\r');
...
//
#[no_mangle]
unsafe extern "C" fn amiserial_console_init() -> int __init {
