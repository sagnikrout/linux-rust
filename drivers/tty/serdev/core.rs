...
//! Source: drivers/tty/serdev/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn serdev_device_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdev_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn is_serdev_device(dev: *const device) -> bool {
    static bool is_serdev_device(const struct device *dev)
    {
    return dev.type == &serdev_device_type;
    }
#[no_mangle]
unsafe extern "C" fn serdev_ctrl_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn serdev_device_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn serdev_device_add(serdev: *mut serdev_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn serdev_device_remove(serdev: *mut serdev_device) {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_open(serdev: *mut serdev_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_close(serdev: *mut serdev_device) {
...
#[no_mangle]
unsafe extern "C" fn devm_serdev_device_close(serdev: *mut c_void) {
    static void devm_serdev_device_close(void *serdev)
    {
    serdev_device_close(serdev);
    }
#[no_mangle]
pub unsafe extern "C" fn devm_serdev_device_open(dev: *mut device, serdev: *mut serdev_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_write_wakeup(serdev: *mut serdev_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn serdev_device_write_buf(serdev: *mut serdev_device, buf: *const u8, count: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_write_flush(serdev: *mut serdev_device) {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_set_baudrate(serdev: *mut serdev_device, speed: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_set_flow_control(serdev: *mut serdev_device, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_wait_until_sent(serdev: *mut serdev_device, timeout: c_long) {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_get_tiocm(serdev: *mut serdev_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_set_tiocm(serdev: *mut serdev_device, set: c_int, clear: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serdev_device_break_ctl(serdev: *mut serdev_device, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdev_drv_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdev_drv_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn serdev_drv_shutdown(dev: *mut device) {
...
//
    ...
    return (dev && dev.type == &serdev_ctrl_type) ? to_serdev_controller(dev) : core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(of_find_serdev_controller_by_node);

#[no_mangle]
unsafe extern "C" fn of_serdev_register_devices(ctrl: *mut serdev_controller) -> c_int {
    static int of_serdev_register_devices(struct serdev_controller *ctrl)
    {
    struct device_node *node;
    struct serdev_device *serdev = core::ptr::null_mut();
    int err;
...
pub const SERDEV_ACPI_MAX_SCAN_DEPTH: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_serdev_lookup {
    pub device_handle: acpi_handle,
    pub controller_handle: acpi_handle,
    pub n: c_int,
    pub index: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn acpi_serdev_parse_resource(ares: *mut acpi_resource, data: *mut c_void) -> c_int {
...
//
    ...
    lookup.controller_handle = core::ptr::null_mut();
    lookup.n = 0;
...
//
    ...
    !acpi_dev_get_property(adev, "baud", ACPI_TYPE_BUFFER, core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn acpi_serdev_register_devices(ctrl: *mut serdev_controller) -> c_int {
...
//
    ...
    acpi_serdev_add_device, core::ptr::null_mut(), ctrl, core::ptr::null_mut());
    if (ACPI_FAILURE(status))
...
#[no_mangle]
pub unsafe extern "C" fn acpi_serdev_register_devices(ctrl: *mut serdev_controller) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn serdev_controller_add(ctrl: *mut serdev_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdev_remove_device(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn serdev_controller_remove(ctrl: *mut serdev_controller) {
    void serdev_controller_remove(struct serdev_controller *ctrl)
    {
    if (!ctrl)
    return;
    device_for_each_child(&ctrl.dev, core::ptr::null_mut(), serdev_remove_device);
    pm_runtime_disable(&ctrl.dev);
    device_del(&ctrl.dev);
    }
    EXPORT_SYMBOL_GPL(serdev_controller_remove);
#[no_mangle]
unsafe extern "C" fn serdev_legacy_shutdown(serdev: *mut serdev_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __serdev_device_driver_register(sdrv: *mut serdev_device_driver, owner: *mut module) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serdev_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn serdev_init() -> int __init {
