...
// MOXA ioctls
//
pub const MOXA: c_uint = 0x400;

pub const RS232_MODE: c_int = 0;
pub const RS485_2WIRE_MODE: c_int = 1;
pub const RS422_MODE: c_int = 2;
pub const RS485_4WIRE_MODE: c_int = 3;
pub const OP_MODE_MASK: c_int = 3;
// ---------------------------------------------------
//
...
// change bank.
//
pub const MOXA_MUST_ENTER_ENHANCED: c_uint = 0xBF;
// when enhanced mode is enabled, access to general bank register
pub const MOXA_MUST_GDL_REGISTER: c_uint = 0x07;
pub const MOXA_MUST_GDL_MASK: c_uint = 0x7F;
pub const MOXA_MUST_GDL_HAS_BAD_DATA: c_uint = 0x80;
pub const MOXA_MUST_LSR_RERR: c_uint = 0x80	/* error in receive FIFO */;
// enhanced register bank select and enhanced mode setting register
// This works only when LCR register equals to 0xBF
pub const MOXA_MUST_EFR_REGISTER: c_uint = 0x02;
pub const MOXA_MUST_EFR_EFRB_ENABLE: c_uint = 0x10 /* enhanced mode enable */;
// enhanced register bank set 0, 1, 2
pub const MOXA_MUST_EFR_BANK0: c_uint = 0x00;
pub const MOXA_MUST_EFR_BANK1: c_uint = 0x40;
pub const MOXA_MUST_EFR_BANK2: c_uint = 0x80;
pub const MOXA_MUST_EFR_BANK3: c_uint = 0xC0;
pub const MOXA_MUST_EFR_BANK_MASK: c_uint = 0xC0;
// set XON1 value register, when LCR=0xBF and change to bank0
pub const MOXA_MUST_XON1_REGISTER: c_uint = 0x04;
// set XON2 value register, when LCR=0xBF and change to bank0
pub const MOXA_MUST_XON2_REGISTER: c_uint = 0x05;
// set XOFF1 value register, when LCR=0xBF and change to bank0
pub const MOXA_MUST_XOFF1_REGISTER: c_uint = 0x06;
// set XOFF2 value register, when LCR=0xBF and change to bank0
pub const MOXA_MUST_XOFF2_REGISTER: c_uint = 0x07;
pub const MOXA_MUST_RBRTL_REGISTER: c_uint = 0x04;
pub const MOXA_MUST_RBRTH_REGISTER: c_uint = 0x05;
pub const MOXA_MUST_RBRTI_REGISTER: c_uint = 0x06;
pub const MOXA_MUST_THRTL_REGISTER: c_uint = 0x07;
pub const MOXA_MUST_ENUM_REGISTER: c_uint = 0x04;
pub const MOXA_MUST_HWID_REGISTER: c_uint = 0x05;
pub const MOXA_MUST_ECR_REGISTER: c_uint = 0x06;
pub const MOXA_MUST_CSR_REGISTER: c_uint = 0x07;
pub const MOXA_MUST_FCR_GDA_MODE_ENABLE: c_uint = 0x20 /* good data mode enable */;
pub const MOXA_MUST_FCR_GDA_ONLY_ENABLE: c_uint = 0x10 /* only good data put into RxFIFO */;
pub const MOXA_MUST_IER_ECTSI: c_uint = 0x80 /* enable CTS interrupt */;
pub const MOXA_MUST_IER_ERTSI: c_uint = 0x40 /* enable RTS interrupt */;
pub const MOXA_MUST_IER_XINT: c_uint = 0x20 /* enable Xon/Xoff interrupt */;
pub const MOXA_MUST_IER_EGDAI: c_uint = 0x10 /* enable GDA interrupt */;

// GDA interrupt pending
pub const MOXA_MUST_IIR_GDA: c_uint = 0x1C;
pub const MOXA_MUST_IIR_RDA: c_uint = 0x04;
pub const MOXA_MUST_IIR_RTO: c_uint = 0x0C;
pub const MOXA_MUST_IIR_LSR: c_uint = 0x06;
// received Xon/Xoff or specical interrupt pending
pub const MOXA_MUST_IIR_XSC: c_uint = 0x10;
// RTS/CTS change state interrupt pending
pub const MOXA_MUST_IIR_RTSCTS: c_uint = 0x20;
pub const MOXA_MUST_IIR_MASK: c_uint = 0x3E;
pub const MOXA_MUST_MCR_XON_FLAG: c_uint = 0x40;
pub const MOXA_MUST_MCR_XON_ANY: c_uint = 0x80;
pub const MOXA_MUST_MCR_TX_XON: c_uint = 0x08;
pub const MOXA_MUST_EFR_SF_MASK: c_uint = 0x0F /* software flow control on chip mask value */;
pub const MOXA_MUST_EFR_SF_TX1: c_uint = 0x08 /* send Xon1/Xoff1 */;
pub const MOXA_MUST_EFR_SF_TX2: c_uint = 0x04 /* send Xon2/Xoff2 */;
pub const MOXA_MUST_EFR_SF_TX12: c_uint = 0x0C /* send Xon1,Xon2/Xoff1,Xoff2 */;
pub const MOXA_MUST_EFR_SF_TX_NO: c_uint = 0x00 /* don't send Xon/Xoff */;
pub const MOXA_MUST_EFR_SF_TX_MASK: c_uint = 0x0C /* Tx software flow control mask */;
pub const MOXA_MUST_EFR_SF_RX_NO: c_uint = 0x00 /* don't receive Xon/Xoff */;
pub const MOXA_MUST_EFR_SF_RX1: c_uint = 0x02 /* receive Xon1/Xoff1 */;
pub const MOXA_MUST_EFR_SF_RX2: c_uint = 0x01 /* receive Xon2/Xoff2 */;
pub const MOXA_MUST_EFR_SF_RX12: c_uint = 0x03 /* receive Xon1,Xon2/Xoff1,Xoff2 */;
pub const MOXA_MUST_EFR_SF_RX_MASK: c_uint = 0x03 /* Rx software flow control mask */;
pub const MXSERMAJOR: c_int = 174;

pub const MXSER_ISR_PASS_LIMIT: c_int = 100;
pub const WAKEUP_CHARS: c_int = 256;
pub const MXSER_BAUD_BASE: c_int = 921600;

pub const PCI_DEVICE_ID_MOXA_RC7000: c_uint = 0x0001;
pub const PCI_DEVICE_ID_MOXA_CP102: c_uint = 0x1020;
pub const PCI_DEVICE_ID_MOXA_CP102UL: c_uint = 0x1021;
pub const PCI_DEVICE_ID_MOXA_CP102U: c_uint = 0x1022;
pub const PCI_DEVICE_ID_MOXA_CP102UF: c_uint = 0x1023;
pub const PCI_DEVICE_ID_MOXA_C104: c_uint = 0x1040;
pub const PCI_DEVICE_ID_MOXA_CP104U: c_uint = 0x1041;
pub const PCI_DEVICE_ID_MOXA_CP104JU: c_uint = 0x1042;
pub const PCI_DEVICE_ID_MOXA_CP104EL: c_uint = 0x1043;
pub const PCI_DEVICE_ID_MOXA_POS104UL: c_uint = 0x1044;
pub const PCI_DEVICE_ID_MOXA_CB108: c_uint = 0x1080;
pub const PCI_DEVICE_ID_MOXA_CP112UL: c_uint = 0x1120;
pub const PCI_DEVICE_ID_MOXA_CT114: c_uint = 0x1140;
pub const PCI_DEVICE_ID_MOXA_CP114: c_uint = 0x1141;
pub const PCI_DEVICE_ID_MOXA_CB114: c_uint = 0x1142;
pub const PCI_DEVICE_ID_MOXA_CP114UL: c_uint = 0x1143;
pub const PCI_DEVICE_ID_MOXA_CP118U: c_uint = 0x1180;
pub const PCI_DEVICE_ID_MOXA_CP118EL: c_uint = 0x1181;
pub const PCI_DEVICE_ID_MOXA_CP132: c_uint = 0x1320;
pub const PCI_DEVICE_ID_MOXA_CP132U: c_uint = 0x1321;
pub const PCI_DEVICE_ID_MOXA_CP134U: c_uint = 0x1340;
pub const PCI_DEVICE_ID_MOXA_CB134I: c_uint = 0x1341;
pub const PCI_DEVICE_ID_MOXA_CP138U: c_uint = 0x1380;
pub const PCI_DEVICE_ID_MOXA_C168: c_uint = 0x1680;
pub const PCI_DEVICE_ID_MOXA_CP168U: c_uint = 0x1681;
pub const PCI_DEVICE_ID_MOXA_CP168EL: c_uint = 0x1682;

pub const MXSER_HIGHBAUD: c_uint = 0x0100;
    ...
    let mut ttymajor: static int = MXSERMAJOR;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxser_port {
    pub port: tty_port,
    pub board: *mut mxser_board,
    pub ioaddr: c_ulong,
    pub opmode_ioaddr: c_ulong,
    pub rx_high_water: u8,
    pub rx_low_water: u8,
    pub /: *mut *mut int type; / UART type,
    pub /: *mut *mut u8 x_char; / xon/xoff character,
    pub /: *mut *mut u8 IER; / Interrupt Enable Register,
    pub /: *mut *mut u8 MCR; / Modem control register,
    pub /: *mut *mut u8 FCR; / FIFO control register,
    pub /: *mut *mut async_icount icount; / kernel counters for 4 input interrupts,
    pub timeout: c_uint,
    pub read_status_mask: u8,
    pub ignore_status_mask: u8,
    pub xmit_fifo_size: u8,
    pub slock: spinlock_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxser_board {
    pub idx: c_uint,
    pub nports: c_ushort,
    pub irq: c_int,
    pub vector: c_ulong,
    pub must_hwid: enum mxser_must_hwid,
    pub max_baud: speed_t,
    pub /: *mut *mut mxser_port ports[] / __counted_by(nports),
}
...
#[no_mangle]
unsafe extern "C" fn mxser_must_select_bank(baseio: c_ulong, bank: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mxser_set_must_xon1_value(baseio: c_ulong, value: u8) {
    static void mxser_set_must_xon1_value(unsigned long baseio, u8 value)
    {
    let mut oldlcr: u8 = mxser_must_select_bank(baseio, MOXA_MUST_EFR_BANK0);
    outb(value, baseio + MOXA_MUST_XON1_REGISTER);
    outb(oldlcr, baseio + UART_LCR);
    }
#[no_mangle]
unsafe extern "C" fn mxser_set_must_xoff1_value(baseio: c_ulong, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn mxser_set_must_fifo_value(info: *mut mxser_port) {
    static void mxser_set_must_fifo_value(struct mxser_port *info)
    {
    let mut oldlcr: u8 = mxser_must_select_bank(info.ioaddr, MOXA_MUST_EFR_BANK1);
...
#[no_mangle]
unsafe extern "C" fn mxser_set_must_enum_value(baseio: c_ulong, value: u8) {
    static void mxser_set_must_enum_value(unsigned long baseio, u8 value)
    {
    let mut oldlcr: u8 = mxser_must_select_bank(baseio, MOXA_MUST_EFR_BANK2);
    outb(value, baseio + MOXA_MUST_ENUM_REGISTER);
    outb(oldlcr, baseio + UART_LCR);
    }
#[no_mangle]
unsafe extern "C" fn mxser_get_must_hardware_id(baseio: c_ulong) -> u8 {
    static u8 mxser_get_must_hardware_id(unsigned long baseio)
    {
    let mut oldlcr: u8 = mxser_must_select_bank(baseio, MOXA_MUST_EFR_BANK2);
    let mut id: u8 = inb(baseio + MOXA_MUST_HWID_REGISTER);
    outb(oldlcr, baseio + UART_LCR);
    return id;
    }
#[no_mangle]
unsafe extern "C" fn mxser_must_set_EFR(baseio: c_ulong, clear: u8, set: u8) {
    static void mxser_must_set_EFR(unsigned long baseio, u8 clear, u8 set)
    {
    __mxser_must_set_EFR(baseio, clear, set, true);
    }
#[no_mangle]
unsafe extern "C" fn mxser_must_set_enhance_mode(baseio: c_ulong, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxser_must_no_sw_flow_control(baseio: c_ulong) {
    static void mxser_must_no_sw_flow_control(unsigned long baseio)
    {
    mxser_must_set_EFR(baseio, MOXA_MUST_EFR_SF_MASK, 0);
    }
#[no_mangle]
unsafe extern "C" fn mxser_must_set_tx_sw_flow_control(baseio: c_ulong, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxser_must_set_rx_sw_flow_control(baseio: c_ulong, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxser_must_get_hwid(io: c_ulong) -> enum mxser_must_hwid {
...
#[no_mangle]
unsafe extern "C" fn mxser_16550A_or_MUST(info: *mut mxser_port) -> bool {
    static bool mxser_16550A_or_MUST(struct mxser_port *info)
    {
    return info.type == PORT_16550A || info.board.must_hwid;
    }
#[no_mangle]
unsafe extern "C" fn mxser_process_txrx_fifo(info: *mut mxser_port) {
...
#[no_mangle]
unsafe extern "C" fn __mxser_start_tx(info: *mut mxser_port) {
...
#[no_mangle]
unsafe extern "C" fn mxser_start_tx(info: *mut mxser_port) {
...
#[no_mangle]
unsafe extern "C" fn __mxser_stop_tx(info: *mut mxser_port) {
...
#[no_mangle]
unsafe extern "C" fn mxser_carrier_raised(port: *mut tty_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mxser_dtr_rts(port: *mut tty_port, active: bool) {
...
#[no_mangle]
unsafe extern "C" fn mxser_set_baud(tty: *mut tty_struct, newspd: speed_t) -> c_int {
    static int mxser_set_baud(struct tty_struct *tty, speed_t newspd)
    {
    struct mxser_port *info = tty.driver_data;
    let mut quot: c_uint = 0, baud;
    unsigned char cval;
    u64 timeout;
...
//
    ...
    u8 msr)
    {
    let mut cts: bool = msr & UART_MSR_CTS;
    if (tty.hw_stopped) {
    if (cts) {
...
// Use previous rate on a failure
    if (old_termios) {
    let mut baud: speed_t = tty_termios_baud_rate(old_termios);
    tty_encode_baud_rate(tty, baud, baud);
    }
    }
...
//
    ...
    {
    let mut msr: u8 = inb(port.ioaddr + UART_MSR);
...
#[no_mangle]
unsafe extern "C" fn mxser_disable_and_clear_FIFO(info: *mut mxser_port) {
    static void mxser_disable_and_clear_FIFO(struct mxser_port *info)
    {
    let mut fcr: u8 = UART_FCR_CLEAR_RCVR | UART_FCR_CLEAR_XMIT;
    if (info.board.must_hwid)
    fcr |= MOXA_MUST_FCR_GDA_MODE_ENABLE;
    outb(fcr, info.ioaddr + UART_FCR);
    }
#[no_mangle]
unsafe extern "C" fn mxser_activate(port: *mut tty_port, tty: *mut tty_struct) -> c_int {
...
//
    mxser_change_speed(tty, core::ptr::null_mut());
    spin_unlock_irqrestore(&info.slock, flags);
    return 0;
    err_free_xmit:
...
//
#[no_mangle]
unsafe extern "C" fn mxser_stop_rx(info: *mut mxser_port) {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_shutdown_port(port: *mut tty_port) {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_open(tty: *mut tty_struct, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxser_flush_buffer(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn mxser_close(tty: *mut tty_struct, filp: *mut file) {
    static void mxser_close(struct tty_struct *tty, struct file *filp)
    {
    tty_port_close(tty.port, tty, filp);
    }
#[no_mangle]
unsafe extern "C" fn mxser_write(tty: *mut tty_struct, buf: *const u8, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mxser_put_char(tty: *mut tty_struct, ch: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxser_flush_chars(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn mxser_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mxser_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
//
    ...
    let mut retval: c_int = mxser_activate(port, tty);
    if (retval == 0)
...
#[no_mangle]
unsafe extern "C" fn mxser_tiocmget(tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_throttle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn mxser_unthrottle(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_stop(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn mxser_start(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn mxser_tx_empty(info: *mut mxser_port) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_wait_until_sent(tty: *mut tty_struct, timeout: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_hangup(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_rs_break(tty: *mut tty_struct, break_state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxser_receive_chars_new(port: *mut mxser_port, status: u8) -> bool {
    static bool mxser_receive_chars_new(struct mxser_port *port, u8 status)
    {
    let mut hwid: enum mxser_must_hwid = port.board.must_hwid;
    u8 gdl;
    ...
    while (gdl--) {
    let mut ch: u8 = inb(port.ioaddr + UART_RX);
...
#[no_mangle]
unsafe extern "C" fn mxser_transmit_chars(tty: *mut tty_struct, port: *mut mxser_port) {
...
#[no_mangle]
unsafe extern "C" fn mxser_port_isr(port: *mut mxser_port) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn mxser_initbrd(brd: *mut mxser_board, high_baud: bool) {
...
// before set INT ISR, disable all int
    ...
    let mut nports: c_ushort = MXSER_NPORTS(ent.driver_data);
...
#[no_mangle]
unsafe extern "C" fn mxser_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mxser_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mxser_module_exit() -> void __exit {
