...
pub struct vcc_port {
    ...
    pub /: *mut *mut *mut tty_tty; / only populated while dev is open,
    pub /: *mut *mut unsigned long index; / index into the vcc_table,
    pub refcnt: u64,
    pub excl_locked: bool,
    pub removed: bool,
...
pub const VCC_REF_DELAY: c_int = 100;
pub const VCC_MAX_PORTS: c_int = 1024;
...
pub const VCC_DBG_DRV: c_uint = 0x1;
pub const VCC_DBG_LDC: c_uint = 0x2;
pub const VCC_DBG_PKT: c_uint = 0x4;
...
//
#[no_mangle]
unsafe extern "C" fn vcc_table_add(port: *mut vcc_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vcc_table_remove(index: c_ulong) {
    ...
    return;
    spin_lock_irqsave(&vcc_table_lock, flags);
    vcc_table[index] = core::ptr::null_mut();
    spin_unlock_irqrestore(&vcc_table_lock, flags);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn vcc_put(port: *mut vcc_port, excl: bool) {
...
#[no_mangle]
unsafe extern "C" fn vcc_kick_rx(port: *mut vcc_port) {
...
#[no_mangle]
unsafe extern "C" fn vcc_kick_tx(port: *mut vcc_port) {
...
#[no_mangle]
unsafe extern "C" fn vcc_rx_check(tty: *mut tty_struct, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcc_rx(tty: *mut tty_struct, buf: *mut c_char, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcc_ldc_read(port: *mut vcc_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcc_rx_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn vcc_tx_timer(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn vcc_event(arg: *mut c_void, event: c_int) {
...
// Ordered from largest major to lowest
    ...
    let mut vcc_port_ops: static struct tty_port_operations = { 0 };
...
#[no_mangle]
unsafe extern "C" fn vcc_send_ctl(port: *mut vcc_port, ctl: c_int) -> c_int {
    ...
    rv = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vcc_send_ctl(port, 0: VCC_CTL_BREAK) <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn vcc_probe(vdev: *mut vio_dev, id: *const vio_device_id) -> c_int {
    ...
    ARRAY_SIZE(vcc_versions), core::ptr::null_mut(), name);
    if (rv)
    goto free_name;
...
// Register the device using VCC table index as TTY index
    ...
    domain = mdesc_get_property(hp, node, "vcc-domain-name", core::ptr::null_mut());
    if (!domain) {
    rv = -ENXIO;
    mdesc_release(hp);
    goto unreg_tty;
...
//
#[no_mangle]
unsafe extern "C" fn vcc_remove(vdev: *mut vio_dev) {
...
#[no_mangle]
unsafe extern "C" fn vcc_open(tty: *mut tty_struct, vcc_file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcc_close(tty: *mut tty_struct, vcc_file: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn vcc_ldc_hup(port: *mut vcc_port) {
...
#[no_mangle]
unsafe extern "C" fn vcc_hangup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn vcc_write(tty: *mut tty_struct, buf: *const u8, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vcc_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn vcc_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn vcc_break_ctl(tty: *mut tty_struct, state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcc_install(driver: *mut tty_driver, tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vcc_cleanup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn vcc_tty_init() -> c_int {
    ...
    vcc_tty_driver = core::ptr::null_mut();
    return rv;
    }
...
#[no_mangle]
unsafe extern "C" fn vcc_tty_exit() {
...
#[no_mangle]
unsafe extern "C" fn vcc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vcc_exit() -> void __exit {
