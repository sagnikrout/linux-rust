...
//! Source: drivers/tty/hvc/hvc_vio.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hvterm_priv {
    pub /: *mut *mut u32 termno; / HV term number,
...
#[no_mangle]
unsafe extern "C" fn hvterm_raw_get_chars(vtermno: u32, buf: *mut u8, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hvterm_hvsi_get_chars(vtermno: u32, buf: *mut u8, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hvterm_hvsi_open(hp: *mut hvc_struct, data: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hvterm_hvsi_close(hp: *mut hvc_struct, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hvterm_hvsi_hangup(hp: *mut hvc_struct, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hvterm_hvsi_tiocmget(hp: *mut hvc_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udbg_hvc_putc(c: c_char) {
...
#[no_mangle]
unsafe extern "C" fn udbg_hvc_getc_poll() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn udbg_hvc_getc() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hvc_vio_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn hvc_vio_init_early() -> void __init {
...
// Check if it's a virtual terminal
    ...
    return;
    termno = of_get_property(of_stdout, "reg", core::ptr::null_mut());
    if (termno == core::ptr::null_mut())
    return;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(of_stdout, _arg: "hvterm-protocol")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn udbg_init_debug_lpar() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn udbg_init_debug_lpar_hvsi() -> void __init {
