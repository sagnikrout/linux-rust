...
//! Source: drivers/tty/hvc/hvc_iucv.c
#![no_std]
...
// IUCV TTY message
pub const MSG_VERSION: c_uint = 0x02	/* Message version */;
pub const MSG_TYPE_ERROR: c_uint = 0x01	/* Error message */;
pub const MSG_TYPE_TERMENV: c_uint = 0x02	/* Terminal environment variable */;
pub const MSG_TYPE_TERMIOS: c_uint = 0x04	/* Terminal IO struct update */;
pub const MSG_TYPE_WINSIZE: c_uint = 0x08	/* Terminal window size update */;
pub const MSG_TYPE_DATA: c_uint = 0x10	/* Terminal data */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iucv_tty_msg {
    pub /: *mut *mut u8 version; / Message version,
    pub /: *mut *mut u8 type; / Message type,

    pub /: *mut *mut u16 datalen; / Payload length,
    pub /: *mut *mut u8 data[]; / Payload buffer,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hvc_iucv_private {
    pub /: *mut *mut *mut hvc_hvc; / HVC reference,
    pub /: *mut *mut u8 srv_name[8]; / IUCV service name (ebcdic),
    pub /: *mut *mut unsigned char is_console; / Linux console usage flag,
    pub /: *mut *mut enum iucv_state_t iucv_state; / IUCV connection status,
    pub /: *mut *mut enum tty_state_t tty_state; / TTY status,
    pub /: *mut *mut *mut iucv_path path; / IUCV path pointer,
    pub /: *mut *mut spinlock_t lock; / hvc_iucv_private lock,

    pub /: *mut *mut *mut void sndbuf; / send buffer,
    pub /: *mut *mut size_t sndbuf_len; / length of send buffer,

    pub /: *mut *mut delayed_work sndbuf_work; / work: send iucv msg(s),
    pub /: *mut *mut wait_queue_head_t sndbuf_waitq; / wait for send completion,
    pub /: *mut *mut list_head tty_outqueue; / outgoing IUCV messages,
    pub /: *mut *mut list_head tty_inqueue; / incoming IUCV messages,
    pub /: *mut *mut *mut device dev; / device structure,
    pub /: *mut *mut u8 info_path[16]; / IUCV path info (dev attr),
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iucv_tty_buffer {
    pub /: *mut *mut list_head list; / list pointer,
    pub /: *mut *mut iucv_message msg; / store an IUCV message,
    pub /: *mut *mut size_t offset; / data buffer offset,
    pub /: *mut *mut *mut iucv_tty_msg mbuf; / buffer to store input/output data,
}
...
// Kernel module parameter: use one terminal device as default
    let mut hvc_iucv_devices: static unsigned long = 1;
...
//
#[no_mangle]
unsafe extern "C" fn destroy_tty_buffer(bufp: *mut iucv_tty_buffer) {
...
//
#[no_mangle]
unsafe extern "C" fn destroy_tty_buffer_list(list: *mut list_head) {
...
// then leave the buffer on the list and re-try later
    ...
    rb.mbuf, rb.msg.length, core::ptr::null_mut());
    switch (rc) {
    case 0: /* Successful	    */
    break;
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_get_chars(vtermno: u32, buf: *mut u8, count: usize) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_send(priv: *mut hvc_iucv_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_sndbuf_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_put_chars(vtermno: u32, buf: *const u8, count: usize) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_notifier_add(hp: *mut hvc_struct, id: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_cleanup(priv: *mut hvc_iucv_private) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_outqueue_empty(priv: *mut hvc_iucv_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn flush_sndbuf_sync(priv: *mut hvc_iucv_private) {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_hangup(priv: *mut hvc_iucv_private) {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_notifier_hangup(hp: *mut hvc_struct, id: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_dtr_rts(hp: *mut hvc_struct, active: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_notifier_del(hp: *mut hvc_struct, id: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_filter_connreq(ipvmid[8]: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_path_severed(path: *mut iucv_path, ipuser: *mut u8) {
...
// IUCV HVC device attributes
    static DEVICE_ATTR(termid, 0640, hvc_iucv_dev_termid_show, core::ptr::null_mut());
    static DEVICE_ATTR(state, 0640, hvc_iucv_dev_state_show, core::ptr::null_mut());
    static DEVICE_ATTR(peer, 0640, hvc_iucv_dev_peer_show, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_alloc(id: c_int, is_console: c_uint) -> int __init {
...
// setup iucv related information
    ...
    priv.dev = iucv_alloc_device(hvc_iucv_dev_attr_groups, core::ptr::null_mut(),
    priv, "hvc_iucv%d", id);
    if (!priv.dev) {
    rc = -ENOMEM;
    goto out_error_dev;
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_destroy(priv: *mut hvc_iucv_private) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_setup_filter(val: *const c_char) -> c_int {
...
// count user IDs in order to allocate sufficient memory
    size = 1;
    residual = val;
    while ((residual = strchr(residual, ',')) != core::ptr::null_mut()) {
    residual++;
    size++;
    }
...
//
#[no_mangle]
unsafe extern "C" fn param_set_vmidfilter(val: *const c_char, kp: *const kernel_param) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn param_get_vmidfilter(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn hvc_iucv_config(val: *mut c_char) -> int __init {
