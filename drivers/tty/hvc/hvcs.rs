...
//
pub const HVCS_DEFAULT_SERVER_ADAPTERS: c_int = 64;
//
...
//
pub const HVCS_MAX_SERVER_ADAPTERS: c_int = 1024;
//
...
//
pub const HVCS_MINOR_START: c_int = 0;
//
...
//
    let mut hvcs_parm_num_devs: static int = -1;
...
//
    pub buffer: [c_char; HVCS_BUFF_LEN],
...
//
    pub /: *mut *mut int connected; / is the vty-server currently connected to a vty?,
    pub /: *mut *mut uint32_t p_unit_address; / partner unit address,
    pub /: *mut *mut uint32_t p_partition_ID; / partner partition ID,
    pub /: *mut *mut char p_location_code[HVCS_CLC_LENGTH + 1]; / CLC + Null Term,
    pub /: *mut *mut list_head next; / list management,
    pub vdev: *mut vio_dev,
    pub destroyed: *mut completion,
}
...
pub const HVCS_SCHED_READ: c_uint = 0x00000001;
pub const HVCS_QUICK_READ: c_uint = 0x00000002;
pub const HVCS_TRY_WRITE: c_uint = 0x00000004;
...
#[no_mangle]
unsafe extern "C" fn hvcs_partner_vtys_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    static DEVICE_ATTR(partner_vtys, S_IRUGO, hvcs_partner_vtys_show, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn hvcs_partner_clcs_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    static DEVICE_ATTR(partner_clcs, S_IRUGO, hvcs_partner_clcs_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hvcs_current_vty_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
// writing a '0' to this sysfs entry will result in the disconnect.
    if (simple_strtol(buf, core::ptr::null_mut(), 0) != 0)
    return -EINVAL;
    spin_lock_irqsave(&hvcsd.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn hvcs_vterm_state_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn hvcs_index_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    static DEVICE_ATTR(index, S_IRUGO, hvcs_index_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rescan_show(ddp: *mut device_driver, buf: *mut c_char) -> isize {
...
// A 1 means it is updating, a 0 means it is done updating
    ...
    size_t count)
    {
    if ((simple_strtol(buf, core::ptr::null_mut(), 0) != 1)
...
#[no_mangle]
unsafe extern "C" fn hvcs_unthrottle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn hvcs_throttle(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_handle_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hvcs_try_write(hvcsd: *mut hvcs_struct) {
    static void hvcs_try_write(struct hvcs_struct *hvcsd)
    {
    let mut unit_address: u32 = hvcsd.vdev.unit_address;
...
#[no_mangle]
unsafe extern "C" fn hvcs_io(hvcsd: *mut hvcs_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn khvcsd(unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hvcs_return_index(index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hvcs_destruct_port(p: *mut tty_port) {
...
// the list_del poisons the pointers
    ...
    hvcsd.vdev.unit_address);
    hvcsd.vdev = core::ptr::null_mut();
    hvcsd.p_unit_address = 0;
    hvcsd.p_partition_ID = 0;
    hvcsd.destroyed = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hvcs_get_index() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hvcs_remove(dev: *mut vio_dev) {
...
#[no_mangle]
unsafe extern "C" fn hvcs_set_pi(pi: *mut hvcs_partner_info, hvcsd: *mut hvcs_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_get_pi(hvcsd: *mut hvcs_struct) -> c_int {
    static int hvcs_get_pi(struct hvcs_struct *hvcsd)
    {
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_rescan_devices_list() -> c_int {
    static int hvcs_rescan_devices_list(void)
    {
    struct hvcs_struct *hvcsd;
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_has_pi(hvcsd: *mut hvcs_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_partner_connect(hvcsd: *mut hvcs_struct) -> c_int {
    static int hvcs_partner_connect(struct hvcs_struct *hvcsd)
    {
    int retval;
    let mut unit_address: c_uint = hvcsd.vdev.unit_address;
//
...
// This function must be called with the hvcsd->lock held
#[no_mangle]
unsafe extern "C" fn hvcs_partner_free(hvcsd: *mut hvcs_struct) {
    static void hvcs_partner_free(struct hvcs_struct *hvcsd)
    {
    int retval;
    do {
...
#[no_mangle]
unsafe extern "C" fn hvcs_install(driver: *mut tty_driver, tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_open(tty: *mut tty_struct, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hvcs_close(tty: *mut tty_struct, filp: *mut file) {
...
//
    hvcsd.port.tty = core::ptr::null_mut();
    irq = hvcsd.vdev.irq;
    spin_unlock_irqrestore(&hvcsd.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn hvcs_cleanup(tty: *mut *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn hvcs_hangup(tty: *mut *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_write(tty: *mut tty_struct, buf: *const u8, count: usize) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn hvcs_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hvcs_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hvcs_alloc_index_list(n: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hvcs_free_index_list() {
    static void hvcs_free_index_list(void)
    {
// Paranoia check to be thorough.
    kfree(hvcs_index_list);
    hvcs_index_list = core::ptr::null_mut();
    hvcs_index_count = 0;
    }
#[no_mangle]
unsafe extern "C" fn hvcs_initialize() -> c_int {
    static int hvcs_initialize(void)
    {
...
//
    ...
    hvcs_task = kthread_run(khvcsd, core::ptr::null_mut(), "khvcsd");
    if (IS_ERR(hvcs_task)) {
    ...
    hvcs_tty_driver = core::ptr::null_mut();
    mutex_unlock(&hvcs_init_mutex);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn hvcs_module_init() -> int __init {
    static int __init hvcs_module_init(void)
    {
    let mut rc: c_int = vio_register_driver(&hvcs_vio_driver);
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn hvcs_module_exit() -> void __exit {
...
//
    ...
    spin_lock(&hvcs_pi_lock);
    free_page((unsigned long)hvcs_pi_buff);
    hvcs_pi_buff = core::ptr::null_mut();
    spin_unlock(&hvcs_pi_lock);
    tty_unregister_driver(hvcs_tty_driver);
    hvcs_free_index_list();
    tty_driver_kref_put(hvcs_tty_driver);
