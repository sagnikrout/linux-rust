...
//! Source: drivers/tty/tty_ioctl.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_write_room(tty: *mut tty_struct) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_driver_flush_buffer(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_unthrottle(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_throttle_safe(tty: *mut tty_struct) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_unthrottle_safe(tty: *mut tty_struct) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_wait_until_sent(tty: *mut tty_struct, timeout: c_long) {
...
//
#[no_mangle]
unsafe extern "C" fn unset_locked_termios(tty: *mut tty_struct, old: *const ktermios) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_termios_copy_hw(new: *mut ktermios, old: *const ktermios) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_termios_hw_change(a: *const ktermios, b: *const ktermios) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_get_char_size(cflag: c_uint) -> c_uchar {
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_get_frame_size(cflag: c_uint) -> c_uchar {
    unsigned char tty_get_frame_size(unsigned int cflag)
    {
    let mut bits: c_uchar = 2 + tty_get_char_size(cflag);
    if (cflag & CSTOPB)
    bits++;
    if (cflag & PARENB)
    bits++;
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_set_termios(tty: *mut tty_struct, new_termios: *mut ktermios) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn set_termios(tty: *mut tty_struct, arg: *mut void __user, opt: c_int) -> c_int {
    static int set_termios(struct tty_struct *tty, void __user *arg, int opt)
    {
    struct ktermios tmp_termios;
    struct tty_ldisc *ld;
    let mut retval: c_int = tty_check_change(tty);
    if (retval)
    return retval;
...
#[no_mangle]
unsafe extern "C" fn copy_termios(tty: *mut tty_struct, kterm: *mut ktermios) {
...
#[no_mangle]
unsafe extern "C" fn copy_termios_locked(tty: *mut tty_struct, kterm: *mut ktermios) {
...
#[no_mangle]
unsafe extern "C" fn get_termio(tty: *mut tty_struct, termio: *mut termio __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_sgflags(tty: *mut tty_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_sgttyb(tty: *mut tty_struct, sgttyb: *mut sgttyb __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_sgflags(termios: *mut ktermios, flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn set_sgttyb(tty: *mut tty_struct, sgttyb: *mut sgttyb __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_tchars(tty: *mut tty_struct, tchars: *mut tchars __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_tchars(tty: *mut tty_struct, tchars: *mut tchars __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ltchars(tty: *mut tty_struct, ltchars: *mut ltchars __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_ltchars(tty: *mut tty_struct, ltchars: *mut ltchars __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty_change_softcar(tty: *mut tty_struct, enable: bool) -> c_int {
    static int tty_change_softcar(struct tty_struct *tty, bool enable)
    {
    let mut ret: c_int = 0;
    struct ktermios old;
    let mut bit: tcflag_t = enable ? CLOCAL : 0;
    down_write(&tty.termios_rwsem);
    old = tty.termios;
...
//
#[no_mangle]
pub unsafe extern "C" fn tty_mode_ioctl(tty: *mut tty_struct, cmd: c_uint, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __tty_perform_flush(tty: *mut tty_struct, arg: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tty_perform_flush(tty: *mut tty_struct, arg: c_ulong) -> c_int {
