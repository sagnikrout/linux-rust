...
pub const N_TTY_BUF_SIZE: c_int = 4096;
//
...
pub const TTY_THRESHOLD_UNTHROTTLE: c_int = 128;
//
...
// codes.
//
pub const ECHO_OP_START: c_uint = 0xff;
pub const ECHO_OP_MOVE_BACK_COL: c_uint = 0x80;
pub const ECHO_OP_SET_CANON_COL: c_uint = 0x81;
pub const ECHO_OP_ERASE_TAB: c_uint = 0x82;
pub const ECHO_COMMIT_WATERMARK: c_int = 256;
pub const ECHO_BLOCK: c_int = 256;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct n_tty_data {
// producer-published
    pub read_head: usize,
    pub commit_head: usize,
    pub canon_head: usize,
    pub echo_head: usize,
    pub echo_commit: usize,
    pub echo_mark: usize,
    pub 256): DECLARE_BITMAP(char_map,,
// private to n_tty_receive_overrun (single-threaded)
    pub overrun_time: c_ulong,
    pub num_overrun: c_uint,
// non-atomic
    pub no_room: bool,
// must hold exclusive termios_rwsem to reset these
    pub icanon:1: unsigned char lnext:1, erasing:1, raw:1, real_raw:1,,
    pub push:1: c_uchar,
// shared by producer and consumer
    pub read_buf: [u8; N_TTY_BUF_SIZE],
    pub N_TTY_BUF_SIZE): DECLARE_BITMAP(read_flags,,
    pub echo_buf: [u8; N_TTY_BUF_SIZE],
// consumer-published
    pub read_tail: usize,
...
// protected by output lock
    pub column: c_uint,
    pub canon_column: c_uint,
    pub echo_tail: usize,
    pub atomic_read_lock: mutex,
    pub output_lock: mutex,
}

#[no_mangle]
pub unsafe extern "C" fn read_cnt(ldata: *mut n_tty_data) -> usize {
    static inline size_t read_cnt(struct n_tty_data *ldata)
    {
    return ldata.read_head - ldata.read_tail;
    }
#[no_mangle]
pub unsafe extern "C" fn read_buf(ldata: *mut n_tty_data, i: usize) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn echo_buf(ldata: *mut n_tty_data, i: usize) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn zero_buffer(tty: *const tty_struct, buffer: *mut u8, size: usize) {
    ...
    let mut size: usize = N_TTY_BUF_SIZE - tail;
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_kick_worker(tty: *const tty_struct) {
...
// Did the input worker stop? Restart it
    ...
    WARN_RATELIMIT(tty.port.itty == core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn chars_in_buffer(tty: *const tty_struct) -> isize {
    static ssize_t chars_in_buffer(const struct tty_struct *tty)
    {
    const struct n_tty_data *ldata = tty.disc_data;
    let mut head: usize = ldata.icanon ? ldata.canon_head : ldata.commit_head;
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_write_wakeup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn n_tty_check_throttle(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn n_tty_check_unthrottle(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn put_tty_queue(c: u8, ldata: *mut n_tty_data) {
...
//
#[no_mangle]
unsafe extern "C" fn reset_buffer_flags(ldata: *mut n_tty_data) {
...
#[no_mangle]
unsafe extern "C" fn n_tty_packet_mode_flush(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_flush_buffer(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_utf8_continuation(c: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_continuation(c: u8, tty: *const tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn do_output_char(c: u8, tty: *mut tty_struct, space: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn process_output(c: u8, tty: *mut tty_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __process_echoes(tty: *mut tty_struct) -> usize {
    ...
    if (c == ECHO_OP_START) {
    let mut ret: c_int = n_tty_process_echo_ops(tty, &tail, space);
    if (ret == -ENODATA)
    goto not_yet_stored;
    if (ret < 0)
    break;
    ...
    if (O_OPOST(tty)) {
    let mut retval: c_int = do_output_char(c, tty, space);
    if (retval < 0)
    break;
    space -= retval;
    } else {
...
#[no_mangle]
unsafe extern "C" fn commit_echoes(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn process_echoes(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn flush_echoes(tty: *mut tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn add_echo_byte(c: u8, ldata: *mut n_tty_data) {
...
//
#[no_mangle]
unsafe extern "C" fn echo_move_back_col(ldata: *mut n_tty_data) {
...
//
#[no_mangle]
unsafe extern "C" fn echo_set_canon_col(ldata: *mut n_tty_data) {
...
//
#[no_mangle]
unsafe extern "C" fn echo_char_raw(c: u8, ldata: *mut n_tty_data) {
...
//
#[no_mangle]
unsafe extern "C" fn echo_char(c: u8, tty: *const tty_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn finish_erasing(ldata: *mut n_tty_data) {
...
//
#[no_mangle]
unsafe extern "C" fn eraser(c: u8, tty: *const tty_struct) {
...
// process_output('\a', tty); */ /* what do you think?
    ...
    kill_type = ERASE;
#[no_mangle]
pub unsafe extern "C" fn if(WERASE_CHAR(tty): c ==) -> else {
...
// Equivalent to BSD's ALTWERASE.
    ...
    seen_alnums++;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: seen_alnums) -> else {
    else if (seen_alnums)
    break;
    }
...
// if cnt > 1, output a multi-byte character
    ...
    let mut num_chars: c_uint = 0;
    let mut after_tab: c_int = 0;
    let mut tail: usize = ldata.read_head;
//
...
#[no_mangle]
unsafe extern "C" fn __isig(sig: c_int, tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn isig(sig: c_int, tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_receive_break(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_receive_overrun(tty: *const tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn n_tty_is_char_flow_ctrl(tty: *mut tty_struct, c: u8) -> bool {
    static bool n_tty_is_char_flow_ctrl(struct tty_struct *tty, u8 c)
    {
    let mut c: return = = START_CHAR(tty) || c == STOP_CHAR(tty);
    }
//
...
#[no_mangle]
unsafe extern "C" fn n_tty_receive_handle_newline(tty: *mut tty_struct, c: u8) {
...
#[no_mangle]
unsafe extern "C" fn n_tty_receive_char_canon(tty: *mut tty_struct, c: u8) -> bool {
    ...
    let mut tail: usize = ldata.canon_head;
    finish_erasing(ldata);
    echo_char(c, tty);
    echo_char_raw('\n', ldata);
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_receive_char(tty: *mut tty_struct, c: u8) {
...
// handle buffer wrap-around by a loop
    ...
    let mut head: usize = MASK(ldata.read_head);
    let mut n: usize = min(count, N_TTY_BUF_SIZE - head);
    ...
    {
    struct n_tty_data *ldata = tty.disc_data;
    let mut preops: bool = I_ISTRIP(tty) || (I_IUCLC(tty) && L_IEXTEN(tty));
    let mut la_count: usize = min(ldata.lookahead_count, count);
    if (ldata.real_raw)
    n_tty_receive_buf_real_raw(tty, cp, count);
#[no_mangle]
pub unsafe extern "C" fn if(!preops): ldata->raw || (L_EXTPROC(tty) &&) -> else {
    else if (ldata.raw || (L_EXTPROC(tty) && !preops))
    n_tty_receive_buf_raw(tty, cp, fp, count);
#[no_mangle]
pub unsafe extern "C" fn if(!L_EXTPROC(tty): tty->closing &&) -> else {
    if (la_count > 0) {
...
//
    let mut tail: usize = smp_load_acquire(&ldata.read_tail);
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_set_termios(tty: *mut tty_struct, old: *const ktermios) {
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_close(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn n_tty_open(tty: *mut tty_struct) -> c_int {
...
// indicate buffer work may resume
    ...
    n_tty_set_termios(tty, core::ptr::null_mut());
    tty_unthrottle(tty);
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn input_available_p(tty: *const tty_struct, poll: c_int) -> c_int {
    static inline int input_available_p(const struct tty_struct *tty, int poll)
    {
    const struct n_tty_data *ldata = tty.disc_data;
    let mut amt: c_int = poll && !TIME_CHAR(tty) && MIN_CHAR(tty) ? MIN_CHAR(tty) : 1;
    if (ldata.icanon && !L_EXTPROC(tty))
...
//
    ...
    size_t n;
    bool is_eof;
    let mut head: usize = smp_load_acquire(&ldata.commit_head);
    let mut tail: usize = MASK(ldata.read_tail);
...
//
#[no_mangle]
unsafe extern "C" fn canon_skip_eof(ldata: *mut n_tty_data) {
...
//
#[no_mangle]
unsafe extern "C" fn job_control(tty: *mut tty_struct, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: canon_copy_from_read_buf(tty, _arg: &kb, _arg: &nr)) -> else {
...
#[no_mangle]
unsafe extern "C" fn inq_canon(ldata: *mut n_tty_data) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn n_tty_inherit_ops(ops: *mut tty_ldisc_ops) {
...
#[no_mangle]
pub unsafe extern "C" fn n_tty_init() -> void __init {
