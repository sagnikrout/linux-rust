...
//! Source: drivers/tty/mips_ejtag_fdc.c
#![no_std]
...
// Register offsets
pub const REG_FDACSR: c_uint = 0x00	/* FDC Access Control and Status Register */;
pub const REG_FDCFG: c_uint = 0x08	/* FDC Configuration Register */;
pub const REG_FDSTAT: c_uint = 0x10	/* FDC Status Register */;
pub const REG_FDRX: c_uint = 0x18	/* FDC Receive Register */;

// Register fields
pub const REG_FDCFG_TXINTTHRES_SHIFT: c_int = 18;

pub const REG_FDCFG_RXINTTHRES_SHIFT: c_int = 16;

pub const REG_FDCFG_TXFIFOSIZE_SHIFT: c_int = 8;

pub const REG_FDCFG_RXFIFOSIZE_SHIFT: c_int = 0;

pub const REG_FDSTAT_TXCOUNT_SHIFT: c_int = 24;

pub const REG_FDSTAT_RXCOUNT_SHIFT: c_int = 16;

pub const REG_FDSTAT_RXCHAN_SHIFT: c_int = 4;

// Default channel for the early console
pub const CONSOLE_CHANNEL: c_int = 1;
pub const NUM_TTY_CHANNELS: c_int = 16;
pub const RX_BUF_SIZE: c_int = 1024;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mips_ejtag_fdc_tty_port {
    pub port: tty_port,
    pub driver: *mut mips_ejtag_fdc_tty,
    pub rx_lock: raw_spinlock_t,
    pub rx_buf: *mut c_void,
    pub xmit_lock: spinlock_t,
    pub xmit_cnt: c_uint,
    pub xmit_head: c_uint,
    pub xmit_tail: c_uint,
    pub xmit_empty: completion,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mips_ejtag_fdc_tty {
    pub dev: *mut device,
    pub driver: *mut tty_driver,
    pub cpu: c_uint,
    pub fdc_name: [c_char; 16],
    pub driver_name: [c_char; 16],
    pub ports: [mips_ejtag_fdc_tty_port; NUM_TTY_CHANNELS],
    pub waitqueue: wait_queue_head_t,
    pub lock: raw_spinlock_t,
    pub thread: *mut task_struct,
    pub reg: *mut void __iomem,
    pub tx_fifo: u8,
    pub xmit_size: c_uint,
    pub xmit_total: core::sync::atomic::AtomicI32,
    pub xmit_next: c_uint,
    pub xmit_full: bool,
    pub irq: c_int,
    pub removing: bool,
    pub poll_timer: timer_list,

    pub sysrq_pressed: bool,
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_decode(word: u32, buf: *mut c_char) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mips_ejtag_fdc_console {
    pub cons: console,
    pub tty_drv: *mut tty_driver,
    pub lock: raw_spinlock_t,
    pub initialised: bool,
    pub regs: [*mut void __iomem; NR_CPUS],
}
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_console_init(c: *mut mips_ejtag_fdc_console) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_put(arg: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_handle(priv: *mut mips_ejtag_fdc_tty) {
...
//
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_port_shutdown(port: *mut tty_port) {
...
// Null the read buffer (timer could still be running!)
    raw_spin_lock_irq(&dport.rx_lock);
    rx_buf = dport.rx_buf;
    dport.rx_buf = core::ptr::null_mut();
    raw_spin_unlock_irq(&dport.rx_lock);
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_open(tty: *mut tty_struct, filp: *mut file) -> c_int {
    static int mips_ejtag_fdc_tty_open(struct tty_struct *tty, struct file *filp)
    {
    return tty_port_open(tty.port, tty, filp);
    }
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_close(tty: *mut tty_struct, filp: *mut file) {
    static void mips_ejtag_fdc_tty_close(struct tty_struct *tty, struct file *filp)
    {
    return tty_port_close(tty.port, tty, filp);
    }
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_hangup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_write_room(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_chars_in_buffer(tty: *mut tty_struct) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn get_c0_fdc_int() -> int __weak {
    int __weak get_c0_fdc_int(void)
    {
    return -1;
    }
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_probe(dev: *mut mips_cdmm_device) -> c_int {
...
// Disable interrupts
    ...
    err_destroy_ports:
    if (dev.cpu == 0)
    mips_ejtag_fdc_con.tty_drv = core::ptr::null_mut();
    for (nport = 0; nport < NUM_TTY_CHANNELS; nport++) {
    dport = &priv.ports[nport];
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_cpu_down(dev: *mut mips_cdmm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_tty_cpu_up(dev: *mut mips_cdmm_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mips_ejtag_fdc_init_console() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn setup_early_fdc_console() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kgdbfdc_read_char() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kgdbfdc_push_one() {
...
#[no_mangle]
unsafe extern "C" fn kgdbfdc_flush() {
...
#[no_mangle]
unsafe extern "C" fn kgdbfdc_write_char(chr: u8) {
...
#[no_mangle]
unsafe extern "C" fn kgdbfdc_init() -> int __init {
