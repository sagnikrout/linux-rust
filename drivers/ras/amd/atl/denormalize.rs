...
//! Source: drivers/ras/amd/atl/denormalize.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn get_dst_fabric_id(ctx: *mut addr_ctx) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn make_space_for_coh_st_id_at_intlv_bit(ctx: *mut addr_ctx) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn make_space_for_coh_st_id_split_2_1(ctx: *mut addr_ctx) -> u64 {
    static u64 make_space_for_coh_st_id_split_2_1(struct addr_ctx *ctx)
    {
// Make a single space at the interleave bit.
    let mut denorm_addr: u64 = expand_bits(ctx.map.intlv_bit_pos, 1, ctx.ret_addr);
...
//
#[no_mangle]
unsafe extern "C" fn make_space_for_coh_st_id_mi300(ctx: *mut addr_ctx) -> u64 {
    static u64 make_space_for_coh_st_id_mi300(struct addr_ctx *ctx)
    {
    let mut num_intlv_bits: u8 = ilog2(ctx.map.num_intlv_chan);
    u64 denorm_addr;
...
//
#[no_mangle]
unsafe extern "C" fn make_space_for_coh_st_id(ctx: *mut addr_ctx) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn get_coh_st_id_df2(ctx: *mut addr_ctx) -> u16 {
    static u16 get_coh_st_id_df2(struct addr_ctx *ctx)
    {
    let mut num_socket_intlv_bits: u8 = ilog2(ctx.map.num_intlv_sockets);
    let mut num_die_intlv_bits: u8 = ilog2(ctx.map.num_intlv_dies);
    u8 num_intlv_bits;
    u16 coh_st_id, mask;
...
#[no_mangle]
unsafe extern "C" fn get_coh_st_id_df4(ctx: *mut addr_ctx) -> u16 {
...
//
    let mut num_intlv_bits: u8 = ilog2(ctx.map.num_intlv_chan);
    let mut mask: u16 = df_cfg.component_id_mask;
    u16 socket_bits;
// Set the derived Coherent Station ID to the input Coherent Station Fabric ID.
    let mut coh_st_id: u16 = ctx.coh_st_fabric_id & mask;
//
...
//
#[no_mangle]
unsafe extern "C" fn get_coh_st_id_mi300(ctx: *mut addr_ctx) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn calculate_coh_st_id(ctx: *mut addr_ctx) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn insert_coh_st_id_at_intlv_bit(ctx: *mut addr_ctx, denorm_addr: u64, coh_st_id: u16) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn insert_coh_st_id_split_2_1(ctx: *mut addr_ctx, denorm_addr: u64, coh_st_id: u16) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn insert_coh_st_id_split_2_2(ctx: *mut addr_ctx, denorm_addr: u64, coh_st_id: u16) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn insert_coh_st_id(ctx: *mut addr_ctx, denorm_addr: u64, coh_st_id: u16) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn get_logical_coh_st_fabric_id_mi300(ctx: *mut addr_ctx) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn get_logical_coh_st_fabric_id(ctx: *mut addr_ctx) -> u16 {
...
// Start with the physical COH_ST Fabric ID.
    let mut phys_fabric_id: u16 = ctx.coh_st_fabric_id;
...
#[no_mangle]
unsafe extern "C" fn denorm_addr_common(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn denorm_addr_df3_6chan(ctx: *mut addr_ctx) -> c_int {
    static int denorm_addr_df3_6chan(struct addr_ctx *ctx)
    {
    let mut coh_st_id: u16 = ctx.coh_st_fabric_id & df_cfg.component_id_mask;
    let mut total_intlv_bits: u8 = ctx.map.total_intlv_bits;
    u8 low_bit, intlv_bit = ctx.map.intlv_bit_pos;
    u64 msb_intlv_bits, temp_addr_a, temp_addr_b;
    let mut np2_bits: u8 = ctx.map.np2_bits;
...
#[no_mangle]
unsafe extern "C" fn denorm_addr_df4_np2(ctx: *mut addr_ctx) -> c_int {
...
// Done for 6 and 10 channel.
    ...
    u64 addr)
    {
    let mut temp_addr_a: u64 = 0, temp_addr_b = 0;
    switch (ctx.map.intlv_mode) {
    case DF4p5_NPS0_24CHAN_1K_HASH:
    case DF4p5_NPS1_12CHAN_1K_HASH:
    case DF4p5_NPS2_6CHAN_1K_HASH:
...
//
    let mut id: u16 = get_logical_coh_st_fabric_id_for_current_spa(ctx, denorm_ctx);
...
#[no_mangle]
unsafe extern "C" fn match_norm_addr(ctx: *mut addr_ctx, denorm_ctx: *mut df4p5_denorm_ctx) -> bool {
    static bool match_norm_addr(struct addr_ctx *ctx, struct df4p5_denorm_ctx *denorm_ctx)
    {
    let mut addr: u64 = remove_base_and_hole(ctx, denorm_ctx.current_spa);
//
...
//
    ...
    let mut addr: return = = ctx.ret_addr;
    }
#[no_mangle]
unsafe extern "C" fn check_permutations(ctx: *mut addr_ctx, denorm_ctx: *mut df4p5_denorm_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_df4p5_denorm_ctx(ctx: *mut addr_ctx, denorm_ctx: *mut df4p5_denorm_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn denorm_addr_df4p5_np2(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn denormalize_address(ctx: *mut addr_ctx) -> c_int {
