...
//! Source: drivers/ras/amd/atl/map.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn df2_get_intlv_mode(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df3_get_intlv_mode(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df3p5_get_intlv_mode(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df4_get_intlv_mode(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df4p5_get_intlv_mode(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_intlv_mode(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_hi_addr_offset(reg_dram_offset: u32) -> u64 {
    static u64 get_hi_addr_offset(u32 reg_dram_offset)
    {
    let mut shift: u8 = DF_DRAM_BASE_LIMIT_LSB;
    u64 hi_addr_offset;
    switch (df_cfg.rev) {
    case DF2:
...
//
#[no_mangle]
unsafe extern "C" fn get_dram_offset(ctx: *mut addr_ctx, norm_offset: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df3_6ch_get_dram_addr_map(ctx: *mut addr_ctx) -> c_int {
    static int df3_6ch_get_dram_addr_map(struct addr_ctx *ctx)
    {
    let mut dst_fabric_id: u16 = FIELD_GET(DF3_DST_FABRIC_ID, ctx.map.limit);
...
#[no_mangle]
unsafe extern "C" fn df2_get_dram_addr_map(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df3_get_dram_addr_map(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df4_get_dram_addr_map(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df4p5_get_dram_addr_map(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_dram_addr_map(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_coh_st_fabric_id(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_normalized_offset(ctx: *mut addr_ctx, norm_offset: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn valid_map(ctx: *mut addr_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_address_map_common(ctx: *mut addr_ctx) -> c_int {
    static int get_address_map_common(struct addr_ctx *ctx)
    {
    let mut norm_offset: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn get_num_intlv_chan(ctx: *mut addr_ctx) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn calculate_intlv_bits(ctx: *mut addr_ctx) {
...
#[no_mangle]
unsafe extern "C" fn get_intlv_bit_pos(ctx: *mut addr_ctx) -> u8 {
    static u8 get_intlv_bit_pos(struct addr_ctx *ctx)
    {
    let mut addr_sel: u8 = 0;
    switch (df_cfg.rev) {
    case DF2:
...
#[no_mangle]
unsafe extern "C" fn get_num_intlv_dies(ctx: *mut addr_ctx) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn get_num_intlv_sockets(ctx: *mut addr_ctx) -> u8 {
    static u8 get_num_intlv_sockets(struct addr_ctx *ctx)
    {
    let mut sockets: u8 = 0;
    switch (df_cfg.rev) {
    case DF2:
...
#[no_mangle]
unsafe extern "C" fn get_global_map_data(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn validate_address_map(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dump_address_map(map: *mut dram_addr_map) {
...
#[no_mangle]
pub unsafe extern "C" fn get_address_map(ctx: *mut addr_ctx) -> c_int {
