...
//! Source: drivers/ras/amd/atl/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn addr_over_limit(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn legacy_hole_en(ctx: *mut addr_ctx) -> bool {
    static bool legacy_hole_en(struct addr_ctx *ctx)
    {
    let mut reg: u32 = ctx.map.base;
    if (df_cfg.rev >= DF4)
    reg = ctx.map.ctl;
    return FIELD_GET(DF_LEGACY_MMIO_HOLE_EN, reg);
    }
#[no_mangle]
unsafe extern "C" fn add_legacy_hole(ctx: *mut addr_ctx, addr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn remove_legacy_hole(ctx: *mut addr_ctx, addr: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn get_base_addr(ctx: *mut addr_ctx) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn add_base_and_hole(ctx: *mut addr_ctx, addr: u64) -> u64 {
    u64 add_base_and_hole(struct addr_ctx *ctx, u64 addr)
    {
    return add_legacy_hole(ctx, addr + get_base_addr(ctx));
    }
#[no_mangle]
pub unsafe extern "C" fn remove_base_and_hole(ctx: *mut addr_ctx, addr: u64) -> u64 {
    u64 remove_base_and_hole(struct addr_ctx *ctx, u64 addr)
    {
    return remove_legacy_hole(ctx, addr) - get_base_addr(ctx);
    }
#[no_mangle]
unsafe extern "C" fn late_hole_remove(ctx: *mut addr_ctx) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn norm_to_sys_addr(socket_id: u8, die_id: u8, coh_st_inst_id: u8, addr: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn check_for_legacy_df_access() {
...
//
    ...
    X86_MATCH_FEATURE(X86_FEATURE_SMCA, core::ptr::null_mut()),
    X86_MATCH_FEATURE(X86_FEATURE_ZEN, core::ptr::null_mut()),
    { }
    };
#[no_mangle]
unsafe extern "C" fn amd_atl_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn amd_atl_exit() -> void __exit {
