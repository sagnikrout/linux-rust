...
//! Source: drivers/ras/amd/atl/dehash.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn df2_dehash_addr(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df3_dehash_addr(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df3_6chan_dehash_addr(ctx: *mut addr_ctx) -> c_int {
    static int df3_6chan_dehash_addr(struct addr_ctx *ctx)
    {
    let mut intlv_bit_pos: u8 = ctx.map.intlv_bit_pos;
...
#[no_mangle]
unsafe extern "C" fn df4_dehash_addr(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn df4p5_dehash_addr(ctx: *mut addr_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mi300_dehash_addr(ctx: *mut addr_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dehash_address(ctx: *mut addr_ctx) -> c_int {
