...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct binder_alloc_test_case_info {
    pub alignments: [c_char; ALIGNMENTS_BUFLEN],
    pub alignments_sb: seq_buf,
    pub buffer_sizes: *mut usize,
    pub free_sequence: *mut c_int,
    pub front_pages: bool,
}

#[no_mangle]
unsafe extern "C" fn stringify_free_seq(test: *mut kunit, seq: *mut c_int, sb: *mut seq_buf) {
...
// Executes one full test run for the given test case.
    ...
    size_t end)
    {
    let mut pages: c_ulong = PAGE_ALIGN(end) / PAGE_SIZE;
...
#[no_mangle]
unsafe extern "C" fn is_dup(seq: *mut c_int, index: c_int, val: c_int) -> bool {
...
//
    ...
    int align;
    if (index == BUFFER_NUM) {
    let mut tc: binder_alloc_test_case_info = {0};
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct binder_alloc_test {
    pub alloc: binder_alloc,
    pub binder_test_freelist: list_lru,
    pub filp: *mut file,
    pub mmap_uaddr: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn binder_alloc_test_init_freelist(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn binder_alloc_test_mmap(test: *mut kunit) {
    ...
    KUNIT_EXPECT_PTR_EQ(test, n, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn binder_alloc_exhaustive_test(test: *mut kunit) {
...
// ===== End test cases =====
#[no_mangle]
unsafe extern "C" fn binder_alloc_test_vma_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn binder_alloc_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn binder_alloc_test_exit(test: *mut kunit) {
