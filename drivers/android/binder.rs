...
#[no_mangle]
pub unsafe extern "C" fn __printf(_arg: 2, mask: 3) void binder_debug(int, format: *const c_char, ...) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn __printf(_arg: 1, format: *const 2) void binder_user_error(char, ...) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn binder_stats_deleted(type: enum binder_stat_types) {
    static inline void binder_stats_deleted(enum binder_stat_types type)
    {
    atomic_inc(&binder_stats.obj_deleted[type]);
    }
#[no_mangle]
pub unsafe extern "C" fn binder_stats_created(type: enum binder_stat_types) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct binder_transaction_log_entry {
    pub debug_id: c_int,
    pub debug_id_done: c_int,
    pub call_type: c_int,
    pub from_proc: c_int,
    pub from_thread: c_int,
    pub target_handle: c_int,
    pub to_proc: c_int,
    pub to_thread: c_int,
    pub to_node: c_int,
    pub data_size: c_int,
    pub offsets_size: c_int,
    pub return_error_line: c_int,
    pub return_error: u32,
    pub return_error_param: u32,
    pub 1]: char context_name[BINDERFS_MAX_NAME +,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct binder_transaction_log {
    pub cur: core::sync::atomic::AtomicI32,
    pub full: bool,
    pub entry: [binder_transaction_log_entry; 32],
}
    ...
    let mut cur: c_uint = atomic_inc_return(&log.cur);
...
#[no_mangle]
unsafe extern "C" fn binder_worklist_empty_ilocked(list: *mut list_head) -> bool {
...
//
    ...
    {
    BUG_ON(target_list == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn binder_has_work(thread: *mut binder_thread, do_proc_work: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn binder_available_for_proc_work_ilocked(thread: *mut binder_thread) -> bool {
    ...
    for (n = rb_first(&proc.threads); n != core::ptr::null_mut(); n = rb_next(n)) {
...
#[no_mangle]
unsafe extern "C" fn binder_wakeup_proc_ilocked(proc: *mut binder_proc) {
...
#[no_mangle]
unsafe extern "C" fn binder_set_nice(nice: c_long) {
    ...
    n = n.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(node->ptr: ptr >) -> else {
...
//
    ...
    struct binder_node *node;
    let mut ptr: binder_uintptr_t = fp ? fp.binder : 0;
    let mut cookie: binder_uintptr_t = fp ? fp.cookie : 0;
    let mut flags: __u32 = fp ? fp.flags : 0;
    assert_spin_locked(&proc.inner_lock);
    while (*p) {
    parent = *p;
...
#[no_mangle]
unsafe extern "C" fn binder_free_node(node: *mut binder_node) {
    ...
    if (strong) {
    if (internal) {
    if (target_list == core::ptr::null_mut() &&
...
#[no_mangle]
unsafe extern "C" fn binder_dec_node(node: *mut binder_node, strong: c_int, internal: c_int) {
...
#[no_mangle]
unsafe extern "C" fn binder_inc_node_tmpref_ilocked(node: *mut binder_node) {
    static void binder_inc_node_tmpref_ilocked(struct binder_node *node)
    {
//
...
//
#[no_mangle]
unsafe extern "C" fn binder_inc_node_tmpref(node: *mut binder_node) {
...
//
#[no_mangle]
unsafe extern "C" fn binder_dec_node_tmpref(node: *mut binder_node) {
...
#[no_mangle]
unsafe extern "C" fn binder_put_node(node: *mut binder_node) {
...
#[no_mangle]
unsafe extern "C" fn slow_desc_lookup_olocked(proc: *mut binder_proc, offset: u32) -> u32 {
...
//
    ...
    p = &(*p).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(ref->node: node >) -> else {
...
// might release the proc->outer_lock
    ...
    p = &(*p).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(ref->data.desc: new_ref->data.desc >) -> else {
...
#[no_mangle]
unsafe extern "C" fn binder_cleanup_ref_olocked(ref: *mut binder_ref) {
    static void binder_cleanup_ref_olocked(struct binder_ref *ref)
    {
    struct dbitmap *dmap = &ref.proc.dmap;
    let mut delete_node: bool = false;
    binder_debug(BINDER_DEBUG_INTERNAL_REFS,
...
//
#[no_mangle]
unsafe extern "C" fn binder_dec_ref_olocked(ref: *mut binder_ref, strong: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn binder_free_ref(ref: *mut binder_ref) {
...
#[no_mangle]
unsafe extern "C" fn try_shrink_dmap(proc: *mut binder_proc) {
...
//
    ...
    if (increment)
    ret = binder_inc_ref_olocked(ref, strong, core::ptr::null_mut());
    else
...
//
    ...
    {
    struct binder_ref *ref;
    struct binder_ref *new_ref = core::ptr::null_mut();
    let mut ret: c_int = 0;
    binder_proc_lock(proc);
    ref = binder_get_ref_for_node_olocked(proc, node, core::ptr::null_mut());
    if (!ref) {
    binder_proc_unlock(proc);
...
//
#[no_mangle]
unsafe extern "C" fn binder_thread_dec_tmpref(thread: *mut binder_thread) {
...
//
#[no_mangle]
unsafe extern "C" fn binder_proc_dec_tmpref(proc: *mut binder_proc) {
...
//
#[no_mangle]
unsafe extern "C" fn binder_free_txn_fixups(t: *mut binder_transaction) {
...
#[no_mangle]
unsafe extern "C" fn binder_txn_latency_free(t: *mut binder_transaction) {
...
#[no_mangle]
unsafe extern "C" fn binder_free_transaction(t: *mut binder_transaction) {
...
//
    ...
    if (t.buffer)
    t.buffer.transaction = core::ptr::null_mut();
...
//
    ...
    return core::ptr::null_mut();
    object_size = binder_get_object(proc, core::ptr::null_mut(), b, object_offset, object);
...
// Nothing to fix up in
    ...
    size_t object_size = binder_get_object(proc, core::ptr::null_mut(), b,
    last_obj_offset,
    &last_object);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct binder_task_work_cb {
    pub twork: callback_head,
    pub file: *mut file,
}
...
//
#[no_mangle]
unsafe extern "C" fn binder_do_fd_close(twork: *mut callback_head) {
...
//
#[no_mangle]
unsafe extern "C" fn binder_deferred_fd_close(fd: c_int) {
...
// pin it until binder_do_fd_close(); see comments there
    ...
    bool is_failure)
    {
    let mut debug_id: c_int = buffer.debug_id;
    ...
    sizeof(object_offset)))
    object_size = binder_get_object(proc, core::ptr::null_mut(), buffer,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct binder_ptr_fixup {
    pub offset: binder_size_t,
    pub skip_size: usize,
    pub fixup_data: binder_uintptr_t,
    pub node: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct binder_sg_copy {
    pub offset: binder_size_t,
    pub sender_uaddr: *const void __user,
    pub length: usize,
    pub node: list_head,
}
...
//
    ...
    size_t copy_size;
    let mut bytes_left: usize = sgc.length - bytes_copied;
    let mut offset: usize = sgc.offset + bytes_copied;
//
...
//
    ...
    u32 fd;
    let mut offset: binder_size_t = fda_offset + fdi * sizeof(fd);
    let mut sender_uoffset: binder_size_t = fdi * sizeof(fd);
...
//
    ...
    let mut oneway: bool = !!(t.flags & TF_ONE_WAY);
    let mut pending_async: bool = false;
    struct binder_transaction *t_outdated = core::ptr::null_mut();
...
//
    ...
    t_outdated.buffer = core::ptr::null_mut();
    buffer.transaction = core::ptr::null_mut();
    trace_binder_transaction_update_buffer_release(buffer);
    binder_release_entire_buffer(proc, core::ptr::null_mut(), buffer, false);
...
//
    ...
    uint32_t *error)
    {
    struct binder_node *target_node = core::ptr::null_mut();
    binder_node_inner_lock(node);
    if (node.proc) {
    target_node = node;
    binder_inc_node_nilocked(node, 1, 0, core::ptr::null_mut());
    binder_inc_node_tmpref_ilocked(node);
    node.proc.tmp_ref++;
// procp = node->proc;
    } else
...
//
    ...
    let mut buffer_offset: binder_size_t = 0;
    binder_size_t off_start_offset, off_end_offset;
    binder_size_t off_min;
    binder_size_t sg_buf_offset, sg_buf_end_offset;
    let mut user_offset: binder_size_t = 0;
    struct binder_proc *target_proc = core::ptr::null_mut();
    struct binder_thread *target_thread = core::ptr::null_mut();
    struct binder_node *target_node = core::ptr::null_mut();
    struct binder_transaction *in_reply_to = core::ptr::null_mut();
    struct binder_transaction_log_entry *e;
    let mut return_error: u32 = 0;
    let mut return_error_param: u32 = 0;
    let mut return_error_line: u32 = 0;
    let mut last_fixup_obj_off: binder_size_t = 0;
    let mut last_fixup_min_off: binder_size_t = 0;
    struct binder_context *context = proc.context;
    let mut t_debug_id: c_int = atomic_inc_return(&binder_last_id);
    let mut t_start_time: ktime_t = ktime_get();
    let mut lsmctx: lsm_context = { };
    let mut lsmctx_aligned_size: usize = 0;
    LIST_HEAD(sgc_head);
    LIST_HEAD(pf_head);
    ...
    if (in_reply_to == core::ptr::null_mut()) {
    binder_inner_proc_unlock(proc);
    ...
    if (target_thread == core::ptr::null_mut()) {
// annotation for sparse
    __release(&target_thread.proc.inner_lock);
...
//
    ...
    if (tcomplete == core::ptr::null_mut()) {
    ...
    lsmctx.context = core::ptr::null_mut();
    }
...
//
    ...
    let mut buf_left: usize = sg_buf_end_offset - sg_buf_offset;
    size_t num_valid;
...
//
    let mut t_copy: binder_transaction = *t;
    BUG_ON(target_node == core::ptr::null_mut());
    BUG_ON(t.buffer.async_transaction != 1);
    return_error = binder_proc_transaction(t, target_proc, core::ptr::null_mut());
//
...
//
    ...
    binder_transaction_buffer_release(target_proc, core::ptr::null_mut(), t.buffer,
    buffer_offset, true);
    if (target_node)
    binder_dec_node_tmpref(target_node);
    target_node = core::ptr::null_mut();
    t.buffer.transaction = core::ptr::null_mut();
...
//
    ...
    {
    struct binder_ref_freeze *freeze = core::ptr::null_mut();
    struct binder_work *w;
    binder_inner_proc_lock(proc);
...
//
    ...
    buffer.transaction.buffer = core::ptr::null_mut();
    buffer.transaction = core::ptr::null_mut();
    }
    binder_inner_proc_unlock(proc);
    ...
    let mut strong: bool = cmd == BC_ACQUIRE || cmd == BC_RELEASE;
    let mut increment: bool = cmd == BC_INCREFS || cmd == BC_ACQUIRE;
    struct binder_ref_data rdata;
    ...
    proc, ctx_mgr_node,
    strong, core::ptr::null_mut(), &rdata);
    }
    mutex_unlock(&context.context_mgr_node_lock);
    }
    if (ret)
    ...
    binder_uintptr_t cookie;
    struct binder_ref *ref;
    struct binder_ref_death *death = core::ptr::null_mut();
    if (get_user(target, (uint32_t __user *)ptr))
    return -EFAULT;
    ptr += sizeof(uint32_t);
    if (get_user(cookie, (binder_uintptr_t __user *)ptr))
...
//
    ...
    death.cookie = cookie;
    ref.death = death;
    if (ref.node.proc == core::ptr::null_mut()) {
    ...
    if (ref.death == core::ptr::null_mut()) {
...
//
    ...
    let mut fd: c_int = get_unused_fd_flags(O_CLOEXEC);
    if (fd < 0) {
    binder_debug(BINDER_DEBUG_TRANSACTION,
    ...
    struct binder_work *w = core::ptr::null_mut();
    struct list_head *list = core::ptr::null_mut();
    struct binder_transaction *t = core::ptr::null_mut();
    struct binder_thread *t_from;
    let mut trsize: usize = sizeof(*trd);
    binder_inner_proc_lock(proc);
...
#[no_mangle]
pub unsafe extern "C" fn if(BINDER_WORK_TRANSACTION_PENDING: w->type ==) -> else {
    ...
    int strong, weak;
    let mut node_ptr: binder_uintptr_t = node.ptr;
    let mut node_cookie: binder_uintptr_t = node.cookie;
    let mut node_debug_id: c_int = node.debug_id;
    int has_weak_ref;
    int has_strong_ref;
...
//
    ...
    struct binder_ref_freeze *freeze =
    container_of(w, struct binder_ref_freeze, work);
    let mut cookie: binder_uintptr_t = freeze.cookie;
    binder_inner_proc_unlock(proc);
    kfree(freeze);
    binder_stats_deleted(BINDER_STAT_FREEZE);
    ...
    if (!t)
    continue;
    BUG_ON(t.buffer == core::ptr::null_mut());
...
// spawn a new thread if we leave this out */) {
    ...
    {
    struct binder_thread *thread = core::ptr::null_mut();
    struct rb_node *parent = core::ptr::null_mut();
    ...
    p = &(*p).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(thread->pid: current->pid >) -> else {
    ...
    binder_inner_proc_lock(proc);
    thread = binder_get_thread_ilocked(proc, core::ptr::null_mut());
    binder_inner_proc_unlock(proc);
    if (!thread) {
    new_thread = kzalloc_obj(*thread);
    if (new_thread == core::ptr::null_mut())
    return core::ptr::null_mut();
    binder_inner_proc_lock(proc);
...
#[no_mangle]
unsafe extern "C" fn binder_free_proc(proc: *mut binder_proc) {
    static void binder_free_proc(struct binder_proc *proc)
    {
...
#[no_mangle]
unsafe extern "C" fn binder_free_thread(thread: *mut binder_thread) {
    static void binder_free_thread(struct binder_thread *thread)
    {
    ...
    {
    struct binder_transaction *t;
    struct binder_transaction *send_reply = core::ptr::null_mut();
    let mut active_transactions: c_int = 0;
    struct binder_transaction *last_t = core::ptr::null_mut();
    binder_inner_proc_lock(thread.proc);
//
...
//
    ...
    t.to_proc = core::ptr::null_mut();
    t.to_thread = core::ptr::null_mut();
    if (t.buffer) {
    t.buffer.transaction = core::ptr::null_mut();
    t.buffer = core::ptr::null_mut();
    }
...
//
    ...
    struct binder_context *context = proc.context;
    struct binder_node *new_node;
    let mut curr_euid: kuid_t = current_euid();
    ...
    struct binder_node *node;
    struct binder_context *context = proc.context;
    let mut handle: __u32 = info.handle;
...
// This ioctl may only be used by the context manager
    ...
    mutex_unlock(&context.context_mgr_node_lock);
    node = binder_get_node_from_ref(proc, handle, true, core::ptr::null_mut());
    if (!node)
    return -EINVAL;
    ...
    {
    struct rb_node *n;
    let mut ptr: binder_uintptr_t = info.ptr;
    memset(info, 0, sizeof(*info));
    binder_inner_proc_lock(proc);
    for (n = rb_first(&proc.nodes); n != core::ptr::null_mut(); n = rb_next(n)) {
...
#[no_mangle]
unsafe extern "C" fn binder_txns_pending_ilocked(proc: *mut binder_proc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn binder_add_freeze_work(proc: *mut binder_proc, is_frozen: bool) {
    static void binder_add_freeze_work(struct binder_proc *proc, bool is_frozen)
    {
    struct binder_node *prev = core::ptr::null_mut();
    struct rb_node *n;
    struct binder_ref *ref;
    binder_inner_proc_lock(proc);
...
#[no_mangle]
unsafe extern "C" fn binder_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    ...
    ret = binder_ioctl_set_ctx_mgr(filp, core::ptr::null_mut());
    if (ret)
    goto err;
    break;
    ...
    struct binder_proc **target_procs = core::ptr::null_mut(), *target_proc;
    let mut target_procs_count: c_int = 0, i = 0;
    ret = 0;
    if (copy_from_user(&info, ubuf, sizeof(info))) {
    ret = -EFAULT;
    goto err;
...
#[no_mangle]
unsafe extern "C" fn binder_vma_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn binder_vma_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn binder_vm_fault(vmf: *mut vm_fault) -> VISIBLE_IF_KUNIT vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn binder_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn binder_open(nodp: *mut inode, filp: *mut file) -> c_int {
    static int binder_open(struct inode *nodp, struct file *filp)
    {
    struct binder_proc *proc, *itr;
    struct binder_device *binder_dev;
    struct binderfs_info *info;
    struct dentry *binder_binderfs_dir_entry_proc = core::ptr::null_mut();
    let mut existing_pid: bool = false;
...
#[no_mangle]
unsafe extern "C" fn binder_flush(filp: *mut file, id: fl_owner_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn binder_deferred_flush(proc: *mut binder_proc) {
    static void binder_deferred_flush(struct binder_proc *proc)
    {
    struct rb_node *n;
    let mut wake_count: c_int = 0;
    binder_inner_proc_lock(proc);
    for (n = rb_first(&proc.threads); n != core::ptr::null_mut(); n = rb_next(n)) {
...
#[no_mangle]
unsafe extern "C" fn binder_release(nodp: *mut inode, filp: *mut file) -> c_int {
    static int binder_release(struct inode *nodp, struct file *filp)
    {
    struct binder_proc *proc = filp.private_data;
    debugfs_remove(proc.debugfs_entry);
    if (proc.binderfs_entry) {
    simple_recursive_removal(proc.binderfs_entry, core::ptr::null_mut());
    proc.binderfs_entry = core::ptr::null_mut();
    }
    binder_defer_work(proc, BINDER_DEFERRED_RELEASE);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn binder_node_release(node: *mut binder_node, refs: c_int) -> c_int {
    static int binder_node_release(struct binder_node *node, int refs)
    {
    struct binder_ref *ref;
    let mut death: c_int = 0;
    struct binder_proc *proc = node.proc;
...
#[no_mangle]
unsafe extern "C" fn binder_deferred_release(proc: *mut binder_proc) {
    ...
    __func__, proc.pid);
    context.binder_context_mgr_node = core::ptr::null_mut();
    }
    mutex_unlock(&context.context_mgr_node_lock);
    binder_inner_proc_lock(proc);
//
...
#[no_mangle]
unsafe extern "C" fn binder_deferred_func(work: *mut work_struct) {
    ...
    struct binder_buffer *buffer = t.buffer;
    let mut current_time: ktime_t = ktime_get();
    spin_lock(&t.lock);
    to_proc = t.to_proc;
    seq_printf(m,
...
//
    ...
    struct binder_transaction *t;
    struct binder_work *w;
    let mut start_pos: usize = m.count;
    size_t header_pos;
...
//
    ...
    let mut start_pos: usize = m.count;
    size_t header_pos;
    struct binder_node *last_node = core::ptr::null_mut();
    seq_printf(m, "proc %d\n", proc.pid);
    ...
    let mut temp: c_int = atomic_read(&stats.bc[i]);
    if (temp)
    seq_printf(m, "%s%s: %d\n", prefix,
    ...
    let mut temp: c_int = atomic_read(&stats.br[i]);
    if (temp)
    seq_printf(m, "%s%s: %d\n", prefix,
    ...
    let mut created: c_int = atomic_read(&stats.obj_created[i]);
    let mut deleted: c_int = atomic_read(&stats.obj_deleted[i]);
    if (created || deleted)
...
#[no_mangle]
unsafe extern "C" fn print_binder_state(m: *mut seq_file, hash_ptrs: bool) {
    ...
    last_node = print_next_binder_node_ilocked(m, core::ptr::null_mut(), node,
    last_node,
    hash_ptrs);
    spin_unlock(&binder_dead_nodes_lock);
    if (last_node)
...
#[no_mangle]
unsafe extern "C" fn print_binder_transactions(m: *mut seq_file, hash_ptrs: bool) {
...
#[no_mangle]
unsafe extern "C" fn state_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn state_hashed_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stats_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn transactions_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn transactions_hashed_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
    static int proc_show(struct seq_file *m, void *unused)
    {
    struct binder_proc *itr;
    let mut pid: c_int = (unsigned long)m.private;
    ...
    struct binder_transaction_log_entry *e)
    {
    let mut debug_id: c_int = READ_ONCE(e.debug_id_done);
//
...
#[no_mangle]
unsafe extern "C" fn transaction_log_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
    static int transaction_log_show(struct seq_file *m, void *unused)
    {
    struct binder_transaction_log *log = m.private;
    let mut log_cur: c_uint = atomic_read(&log.cur);
    unsigned int count;
    unsigned int cur;
    int i;
    count = log_cur + 1;
    ...
    for (i = 0; i < count; i++) {
    let mut index: c_uint = cur++ % ARRAY_SIZE(log.entry);
...
#[no_mangle]
pub unsafe extern "C" fn binder_add_device(device: *mut binder_device) {
...
#[no_mangle]
pub unsafe extern "C" fn binder_remove_device(device: *mut binder_device) {
...
#[no_mangle]
unsafe extern "C" fn init_binder_device(name: *const c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn binder_init() -> int __init {
    ...
    char *device_names = core::ptr::null_mut();
    ...
    binder_debugfs_dir_entry_root = debugfs_create_dir("binder", core::ptr::null_mut());
