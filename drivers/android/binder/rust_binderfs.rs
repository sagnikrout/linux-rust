...
//! Source: drivers/android/binder/rust_binderfs.c
#![no_std]
...
pub const FIRST_INODE: c_int = 1;
pub const SECOND_INODE: c_int = 2;
pub const INODE_OFFSET: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct binder_features {
    pub oneway_spam_detection: bool,
    pub extended_error: bool,
    pub freeze_notification: bool,
}
...
//
    ...
    struct binder_device *device = core::ptr::null_mut();
    let mut ctx: rust_binder_context = core::ptr::null_mut();
    struct inode *inode = core::ptr::null_mut();
    struct super_block *sb = ref_inode.i_sb;
    struct binderfs_info *info = sb.s_fs_info;

    let mut use_reserve: bool = (info.ipc_ns == &init_ipc_ns);

    let mut use_reserve: bool = true;
...
#[no_mangle]
unsafe extern "C" fn binderfs_evict_inode(inode: *mut inode) {
...
#[no_mangle]
unsafe extern "C" fn binderfs_fs_context_reconfigure(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn binderfs_show_options(seq: *mut seq_file, root: *mut dentry) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_binderfs_control_device(dentry: *const dentry) -> bool {
...
#[no_mangle]
unsafe extern "C" fn binderfs_unlink(dir: *mut inode, dentry: *mut dentry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn binderfs_binder_ctl_create(sb: *mut super_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rust_binderfs_remove_file(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn binder_features_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_binder_features(sb: *mut super_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_binder_logs(sb: *mut super_block) -> c_int {
    ...
    &rust_binder_stats_fops, core::ptr::null_mut());
    if (IS_ERR(dentry)) {
    ret = PTR_ERR(dentry);
    goto out;
    }
    dentry = rust_binderfs_create_file(binder_logs_root_dir, "state",
    &rust_binder_state_fops, core::ptr::null_mut());
    if (IS_ERR(dentry)) {
    ret = PTR_ERR(dentry);
    goto out;
    }
    dentry = rust_binderfs_create_file(binder_logs_root_dir, "transactions",
    &rust_binder_transactions_fops, core::ptr::null_mut());
    if (IS_ERR(dentry)) {
    ret = PTR_ERR(dentry);
    goto out;
    }
...
#[no_mangle]
unsafe extern "C" fn binderfs_fill_super(sb: *mut super_block, fc: *mut fs_context) -> c_int {
    ...
    struct binderfs_mount_opts *ctx = fc.fs_private;
    struct inode *inode = core::ptr::null_mut();
    let mut device_info: binderfs_device = {};
    const char *name;
    size_t len;
...
//
    ...
    ret = binderfs_binder_device_create(inode, core::ptr::null_mut(), &device_info);
    if (ret)
    return ret;
    name += len;
    if (*name == ',')
...
#[no_mangle]
unsafe extern "C" fn binderfs_fs_context_get_tree(fc: *mut fs_context) -> c_int {
    static int binderfs_fs_context_get_tree(struct fs_context *fc)
    {
    return get_tree_nodev(fc, binderfs_fill_super);
    }
#[no_mangle]
unsafe extern "C" fn binderfs_fs_context_free(fc: *mut fs_context) {
...
#[no_mangle]
unsafe extern "C" fn binderfs_init_fs_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn binderfs_kill_super(sb: *mut super_block) {
...
#[no_mangle]
pub unsafe extern "C" fn init_rust_binderfs() -> c_int {
