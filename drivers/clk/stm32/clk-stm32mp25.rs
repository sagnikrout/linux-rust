...
//! Source: drivers/clk/stm32/clk-stm32mp25.c
#![no_std]
...
pub const RCC_REG_SIZE: c_int = 32;

pub const RCC_CID1: c_int = 1;
// Register: RIFSC_CIDCFGR

// Register: RIFSC_SEMCR

pub const MP25_RIF_RCC_IS2M: c_int = 107;
pub const MP25_RIF_RCC_MCO1: c_int = 108;
pub const MP25_RIF_RCC_MCO2: c_int = 109;
...
#[no_mangle]
unsafe extern "C" fn stm32_rcc_get_access(base: *mut void __iomem, index: u32) -> c_int {
...
// Pass-list with semaphore mode
    ...
    let mut index: u32 = (u32)cfg.sec_id;
...
#[no_mangle]
unsafe extern "C" fn stm32mp25_rcc_clocks_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32mp25_clocks_init() -> int __init {
