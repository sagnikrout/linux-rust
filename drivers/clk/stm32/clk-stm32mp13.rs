...
//! Source: drivers/clk/stm32/clk-stm32mp13.c
#![no_std]
...
pub const RCC_CLR_OFFSET: c_uint = 0x4;
...
// STM32 Divivers definition
    ...
    CFG_DIV(DIV_RTC, RCC_RTCDIVR, 0, 6, 0, core::ptr::null_mut(), DIV_NO_RDY),
    CFG_DIV(DIV_MCO1, RCC_MCO1CFGR, 4, 4, 0, core::ptr::null_mut(), DIV_NO_RDY),
    CFG_DIV(DIV_MCO2, RCC_MCO2CFGR, 4, 4, 0, core::ptr::null_mut(), DIV_NO_RDY),
    CFG_DIV(DIV_TRACE, RCC_DBGCFGR, 0, 3, 0, ck_trace_div_table, DIV_NO_RDY),
    CFG_DIV(DIV_ETH1PTP, RCC_ETH12CKSELR, 4, 4, 0, core::ptr::null_mut(), DIV_NO_RDY),
    CFG_DIV(DIV_ETH2PTP, RCC_ETH12CKSELR, 12, 4, 0, core::ptr::null_mut(), DIV_NO_RDY),
    };
...
// Kernel clocks
    ...
    {
    let mut sec_id: c_int = cfg.sec_id;
    if (sec_id != SECF_NONE) {
...
#[no_mangle]
unsafe extern "C" fn stm32mp13_clocks_init() -> int __init {
