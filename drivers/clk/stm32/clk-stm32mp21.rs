...
//! Source: drivers/clk/stm32/clk-stm32mp21.c
#![no_std]
...
pub const MP21_RIF_RCC_MCO1: c_int = 108;
pub const MP21_RIF_RCC_MCO2: c_int = 109;
...
#[no_mangle]
unsafe extern "C" fn stm32mp21_rcc_clocks_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32mp21_clocks_init() -> int __init {
