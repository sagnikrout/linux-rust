...
//! Source: drivers/clk/imx/clk-imx27.c
#![no_std]
...
pub const MX27_CCM_BASE_ADDR: c_uint = 0x10027000;
pub const MX27_GPT1_BASE_ADDR: c_uint = 0x10003000;
...
#[no_mangle]
unsafe extern "C" fn _mx27_clocks_init(fref: c_ulong) -> void __init {
    ...
    clk_register_clkdev(clk[IMX27_CLK_CPU_DIV], core::ptr::null_mut(), "cpu0");
    clk_prepare_enable(clk[IMX27_CLK_EMI_AHB_GATE]);
    imx_register_uart_clocks();
    imx_print_silicon_rev("i.MX27", mx27_revision());
    }
#[no_mangle]
unsafe extern "C" fn mx27_clocks_init_dt(np: *mut device_node) -> void __init {
    static void __init mx27_clocks_init_dt(struct device_node *np)
    {
    u32 fref = 26000000; /* default */
    for_each_compatible_node_scoped(refnp, core::ptr::null_mut(), "fixed-clock") {
