...
//! Source: drivers/clk/imx/clk-imx5.c
#![no_std]
...
pub const MX51_DPLL1_BASE: c_uint = 0x83f80000;
pub const MX51_DPLL2_BASE: c_uint = 0x83f84000;
pub const MX51_DPLL3_BASE: c_uint = 0x83f88000;
pub const MX53_DPLL1_BASE: c_uint = 0x63f80000;
pub const MX53_DPLL2_BASE: c_uint = 0x63f84000;
pub const MX53_DPLL3_BASE: c_uint = 0x63f88000;
pub const MX53_DPLL4_BASE: c_uint = 0x63f8c000;
...
#[no_mangle]
unsafe extern "C" fn mx5_clocks_common_init(ccm_base: *mut void __iomem) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mx50_clocks_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mx51_clocks_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mx53_clocks_init(np: *mut device_node) -> void __init {
