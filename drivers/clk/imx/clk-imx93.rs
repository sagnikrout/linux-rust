...
//! Source: drivers/clk/imx/clk-imx93.c
#![no_std]
...
pub const IMX93_CLK_END: c_int = 208;
...
// M33 critical clk for system run
    ...
    { IMX93_CLK_MU1_A_GATE,		"mu1_a",	"bus_aon_root",		0x84c0, CLK_IGNORE_UNUSED, core::ptr::null_mut(), PLAT_IMX93 },
    { IMX93_CLK_MU2_A_GATE,		"mu2_a",	"bus_wakeup_root",	0x84c0, CLK_IGNORE_UNUSED, core::ptr::null_mut(), PLAT_IMX93 },
    ...
    { IMX93_CLK_FLEXIO1_GATE,	"flexio1",	"flexio1_root",		0x8980, 0, core::ptr::null_mut(), PLAT_IMX93},
    { IMX93_CLK_FLEXIO2_GATE,	"flexio2",	"flexio2_root",		0x89c0, 0, core::ptr::null_mut(), PLAT_IMX93},
    ...
    { IMX93_CLK_MIPI_DSI_GATE,	"mipi_dsi",	"media_apb_root",	0x95c0, 0, core::ptr::null_mut(), PLAT_IMX93 },
    { IMX93_CLK_LVDS_GATE,		"lvds",		"media_ldb_root",	0x9600, 0, core::ptr::null_mut(), PLAT_IMX93 },
    { IMX93_CLK_LCDIF_GATE,		"lcdif",	"media_apb_root",	0x9640, },
    { IMX93_CLK_PXP_GATE,		"pxp",		"media_apb_root",	0x9680, 0, core::ptr::null_mut(), PLAT_IMX93 },
    ...
    { IMX93_CLK_ENET1_GATE,		"enet1",	"wakeup_axi_root",	0x9e00, 0, core::ptr::null_mut(), PLAT_IMX93, },
    { IMX93_CLK_ENET_QOS_GATE,	"enet_qos",	"wakeup_axi_root",	0x9e40, 0, core::ptr::null_mut(), PLAT_IMX93, },
    { IMX91_CLK_ENET2_REGULAR_GATE, "enet2_regular", "wakeup_axi_root",	0x9e00, 0, core::ptr::null_mut(), PLAT_IMX91, },
    { IMX91_CLK_ENET1_QOS_TSN_GATE, "enet1_qos_tsn", "wakeup_axi_root",	0x9e40, 0, core::ptr::null_mut(), PLAT_IMX91, },
...
#[no_mangle]
unsafe extern "C" fn imx93_clocks_probe(pdev: *mut platform_device) -> c_int {
    ...
    int i, ret;
    let mut plat: c_ulong = (unsigned long)device_get_match_data(&pdev.dev);
    ...
    "sys_pll_pfd2", 1, 2);
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx93-anatop");
    anatop_base = devm_of_iomap(dev, np, 0, core::ptr::null_mut());
    of_node_put(np);
    ...
    clks[ccgr.clk] = imx93_clk_gate(core::ptr::null_mut(),
