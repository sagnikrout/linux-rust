...
//! Source: drivers/clk/imx/clk-imx8mm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx8mm_clocks_probe(pdev: *mut platform_device) -> c_int {
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx8mm-anatop");
    base = of_iomap(np, 0);
    of_node_put(np);
    if (WARN_ON(!base))
    return -ENOMEM;
