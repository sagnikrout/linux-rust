...
//! Source: drivers/clk/imx/clk-imx6sll.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx6sll_clocks_init(ccm_node: *mut device_node) -> void __init {
...
// name		   parent_name	   reg		idx
    ...
    hws[IMX6SLL_CLK_PLL4_POST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll4_post_div", "pll4_audio",
    CLK_SET_RATE_PARENT | CLK_SET_RATE_GATE, base + 0x70, 19, 2, 0, post_div_table, &imx_ccm_lock);
    hws[IMX6SLL_CLK_PLL4_AUDIO_DIV] = clk_hw_register_divider(core::ptr::null_mut(), "pll4_audio_div", "pll4_post_div",
    CLK_SET_RATE_PARENT | CLK_SET_RATE_GATE, base + 0x170, 15, 1, 0, &imx_ccm_lock);
    hws[IMX6SLL_CLK_PLL5_POST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll5_post_div", "pll5_video",
    CLK_SET_RATE_PARENT | CLK_SET_RATE_GATE, base + 0xa0, 19, 2, 0, post_div_table, &imx_ccm_lock);
    hws[IMX6SLL_CLK_PLL5_VIDEO_DIV] = clk_hw_register_divider_table(core::ptr::null_mut(), "pll5_video_div", "pll5_post_div",
