...
//! Source: drivers/clk/imx/clk-imx8mn.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx8mn_clocks_probe(pdev: *mut platform_device) -> c_int {
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx8mn-anatop");
