...
//! Source: drivers/clk/imx/clk-imx6sx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx6sx_clocks_init(ccm_node: *mut device_node) -> void __init {
...
// Clock source from external clock via CLK1/2 PAD
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx6sx-anatop");
    base = of_iomap(np, 0);
    WARN_ON(!base);
    of_node_put(np);
...
// FIXME 100MHz is used for pcie ref for all imx6 pcie, excepted imx6q
    ...
    hws[IMX6SX_CLK_ENET_REF] = clk_hw_register_divider_table(core::ptr::null_mut(), "enet_ref", "pll6_enet", 0,
    base + 0xe0, 0, 2, 0, clk_enet_ref_table,
    &imx_ccm_lock);
    hws[IMX6SX_CLK_ENET2_REF] = clk_hw_register_divider_table(core::ptr::null_mut(), "enet2_ref", "pll6_enet", 0,
...
// name         parent_name       mult div
    ...
    hws[IMX6SX_CLK_PLL4_POST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll4_post_div", "pll4_audio",
    CLK_SET_RATE_PARENT, base + 0x70, 19, 2, 0, post_div_table, &imx_ccm_lock);
    hws[IMX6SX_CLK_PLL4_AUDIO_DIV] = clk_hw_register_divider(core::ptr::null_mut(), "pll4_audio_div", "pll4_post_div",
    CLK_SET_RATE_PARENT, base + 0x170, 15, 1, 0, &imx_ccm_lock);
    hws[IMX6SX_CLK_PLL5_POST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll5_post_div", "pll5_video",
    CLK_SET_RATE_PARENT, base + 0xa0, 19, 2, 0, post_div_table, &imx_ccm_lock);
    hws[IMX6SX_CLK_PLL5_VIDEO_DIV] = clk_hw_register_divider_table(core::ptr::null_mut(), "pll5_video_div", "pll5_post_div",
...
// Set the default 132MHz for EIM module
    ...
    lcdif1_assigned_clk = of_find_property(np, "assigned-clock-parents", core::ptr::null_mut());
