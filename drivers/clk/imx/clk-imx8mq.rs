...
//! Source: drivers/clk/imx/clk-imx8mq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx8mq_clocks_probe(pdev: *mut platform_device) -> c_int {
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx8mq-anatop");
