...
//! Source: drivers/clk/imx/clk-imx35.c
#![no_std]
...
pub const MX35_CCM_BASE_ADDR: c_uint = 0x53f80000;
pub const MX35_GPT1_BASE_ADDR: c_uint = 0x53f90000;

pub const MXC_CCM_PDR0: c_uint = 0x04;
pub const MX35_CCM_PDR2: c_uint = 0x0c;
pub const MX35_CCM_PDR3: c_uint = 0x10;
pub const MX35_CCM_PDR4: c_uint = 0x14;
pub const MX35_CCM_MPCTL: c_uint = 0x1c;
pub const MX35_CCM_PPCTL: c_uint = 0x20;
pub const MX35_CCM_CGR0: c_uint = 0x2c;
pub const MX35_CCM_CGR1: c_uint = 0x30;
pub const MX35_CCM_CGR2: c_uint = 0x34;
pub const MX35_CCM_CGR3: c_uint = 0x38;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arm_ahb_div {
    pub sel: unsigned char arm, ahb,,
}
...
#[no_mangle]
unsafe extern "C" fn _mx35_clocks_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mx35_clocks_init_dt(ccm_node: *mut device_node) -> void __init {
