...
//! Source: drivers/clk/imx/clk-imx8qxp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn clk_on_imx8dxl(node: *mut device_node) -> bool {
    static inline bool clk_on_imx8dxl(struct device_node *node)
    {
    return of_device_is_compatible(node, "fsl,imx8dxl-clk");
    }
#[no_mangle]
unsafe extern "C" fn imx8qxp_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_clk_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn imx8qxp_clk_exit() -> void __exit {
