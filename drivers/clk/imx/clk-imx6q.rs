...
//! Source: drivers/clk/imx/clk-imx6q.c
#![no_std]
...
//
    ...
    let mut enet_ref_sels_table_mask: static u32 = IMX6Q_GPR1_ENET_CLK_SEL_ANATOP;
...
#[no_mangle]
pub unsafe extern "C" fn clk_on_imx6q() -> c_int {
    static inline int clk_on_imx6q(void)
    {
    return of_machine_is_compatible("fsl,imx6q");
    }
#[no_mangle]
pub unsafe extern "C" fn clk_on_imx6qp() -> c_int {
    static inline int clk_on_imx6qp(void)
    {
    return of_machine_is_compatible("fsl,imx6qp");
    }
#[no_mangle]
pub unsafe extern "C" fn clk_on_imx6dl() -> c_int {
    static inline int clk_on_imx6dl(void)
    {
    return of_machine_is_compatible("fsl,imx6dl");
    }
#[no_mangle]
unsafe extern "C" fn ldb_di_sel_by_clock_id(clock_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pll6_bypassed(node: *mut device_node) -> bool {
...
pub const CCM_CCSR: c_uint = 0x0c;
pub const CCM_CS2CDR: c_uint = 0x2c;

pub const CS2CDR_LDB_DI0_CLK_SEL_SHIFT: c_int = 9;
pub const CS2CDR_LDB_DI1_CLK_SEL_SHIFT: c_int = 12;
//
...
//
#[no_mangle]
unsafe extern "C" fn mmdc_ch1_disable(ccm_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn mmdc_ch1_reenable(ccm_base: *mut void __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn init_ldb_clks(np: *mut device_node, ccm_base: *mut void __iomem) {
...
pub const CCM_ANALOG_PLL_VIDEO: c_uint = 0xa0;
pub const CCM_ANALOG_PFD_480: c_uint = 0xf0;
pub const CCM_ANALOG_PFD_528: c_uint = 0x100;

#[no_mangle]
unsafe extern "C" fn disable_anatop_clocks(anatop_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn imx6q_clocks_init(ccm_node: *mut device_node) -> void __init {
...
// Clock source from external clock via CLK1/2 PADs
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx6q-anatop");
...
//
    ...
    hws[IMX6QDL_CLK_ENET_REF] = clk_hw_register_divider_table(core::ptr::null_mut(), "enet_ref", "pll6_enet", 0,
...
// name         parent_name     mult div
    ...
    hws[IMX6QDL_CLK_PLL4_POST_DIV] = clk_hw_register_divider_table(core::ptr::null_mut(), "pll4_post_div", "pll4_audio", CLK_SET_RATE_PARENT, base + 0x70, 19, 2, 0, post_div_table, &imx_ccm_lock);
    if (clk_on_imx6q() || clk_on_imx6qp())
    hws[IMX6QDL_CLK_PLL4_AUDIO_DIV] = imx_clk_hw_fixed_factor("pll4_audio_div", "pll4_post_div", 1, 1);
    else
    hws[IMX6QDL_CLK_PLL4_AUDIO_DIV] = clk_hw_register_divider(core::ptr::null_mut(), "pll4_audio_div", "pll4_post_div", CLK_SET_RATE_PARENT, base + 0x170, 15, 1, 0, &imx_ccm_lock);
    hws[IMX6QDL_CLK_PLL5_POST_DIV] = clk_hw_register_divider_table(core::ptr::null_mut(), "pll5_post_div", "pll5_video", CLK_SET_RATE_PARENT, base + 0xa0, 19, 2, 0, post_div_table, &imx_ccm_lock);
    hws[IMX6QDL_CLK_PLL5_VIDEO_DIV] = clk_hw_register_divider_table(core::ptr::null_mut(), "pll5_video_div", "pll5_post_div", CLK_SET_RATE_PARENT, base + 0x170, 30, 2, 0, video_div_table, &imx_ccm_lock);
    np = ccm_node;
    base = of_iomap(np, 0);
    WARN_ON(!base);
...
//
    ...
    clk_hw_register_clkdev(hws[IMX6QDL_CLK_ENET_REF], "enet_ref", core::ptr::null_mut());
