...
//! Source: drivers/clk/imx/clk-imx6sl.c
#![no_std]
...
pub const CCSR: c_uint = 0xc;

pub const CACRR: c_uint = 0x10;
pub const CDHIPR: c_uint = 0x48;

pub const ARM_WAIT_DIV_396M: c_int = 2;
pub const ARM_WAIT_DIV_792M: c_int = 4;
pub const ARM_WAIT_DIV_996M: c_int = 6;
pub const PLL_ARM: c_uint = 0x0;
pub const BM_PLL_ARM_DIV_SELECT: c_uint = 0x7f;

pub const PLL_ARM_DIV_792M: c_int = 66;
...
//
#[no_mangle]
unsafe extern "C" fn imx6sl_get_arm_divider_for_wait() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx6sl_enable_pll_arm(enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn imx6sl_set_wait_clk(enter: bool) {
    void imx6sl_set_wait_clk(bool enter)
    {
    static unsigned long saved_arm_div;
    let mut arm_div_for_wait: c_int = imx6sl_get_arm_divider_for_wait();
//
...
#[no_mangle]
unsafe extern "C" fn imx6sl_clocks_init(ccm_node: *mut device_node) -> void __init {
...
// Clock source from external clock via CLK1 PAD
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx6sl-anatop");
    base = of_iomap(np, 0);
    WARN_ON(!base);
    of_node_put(np);
    anatop_base = base;
...
// dev   name              parent_name      flags                reg        shift width div: flags, div_table lock
    hws[IMX6SL_CLK_PLL4_POST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll4_post_div",  "pll4_audio",    CLK_SET_RATE_PARENT, base + 0x70,  19, 2,   0, post_div_table, &imx_ccm_lock);
    hws[IMX6SL_CLK_PLL4_AUDIO_DIV] =       clk_hw_register_divider(core::ptr::null_mut(), "pll4_audio_div", "pll4_post_div", CLK_SET_RATE_PARENT, base + 0x170, 15, 1,   0, &imx_ccm_lock);
    hws[IMX6SL_CLK_PLL5_POST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll5_post_div",  "pll5_video",    CLK_SET_RATE_PARENT, base + 0xa0,  19, 2,   0, post_div_table, &imx_ccm_lock);
    hws[IMX6SL_CLK_PLL5_VIDEO_DIV] = clk_hw_register_divider_table(core::ptr::null_mut(), "pll5_video_div", "pll5_post_div", CLK_SET_RATE_PARENT, base + 0x170, 30, 2,   0, video_div_table, &imx_ccm_lock);
    hws[IMX6SL_CLK_ENET_REF]       = clk_hw_register_divider_table(core::ptr::null_mut(), "enet_ref",       "pll6_enet",     0,                   base + 0xe0,  0,  2,   0, clk_enet_ref_table, &imx_ccm_lock);
