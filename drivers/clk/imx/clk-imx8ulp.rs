...
//! Source: drivers/clk/imx/clk-imx8ulp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx8ulp_pcc_assert(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
    ...
    let mut offset: u32 = pcc_reset.resets[id];
    unsigned long flags;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn imx8ulp_pcc_deassert(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8ulp_clk_cgc1_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8ulp_clk_cgc2_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8ulp_clk_pcc3_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8ulp_clk_pcc4_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8ulp_clk_pcc5_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8ulp_clk_probe(pdev: *mut platform_device) -> c_int {
