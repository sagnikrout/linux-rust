...
//! Source: drivers/clk/imx/clk-imx7ulp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx7ulp_clk_scg1_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn imx7ulp_clk_pcc2_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn imx7ulp_clk_pcc3_init(np: *mut device_node) -> void __init {
...
// PCC3
    ...
    hws[IMX7ULP_CLK_MMDC]		= clk_hw_register_gate(core::ptr::null_mut(), "mmdc", "nic1_clk", CLK_SET_RATE_PARENT | CLK_IS_CRITICAL,
...
#[no_mangle]
unsafe extern "C" fn imx7ulp_clk_smc1_init(np: *mut device_node) -> void __init {
