...
//! Source: drivers/clk/imx/clk-imx8mp.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8mp_clock_constraints {
    pub clkid: c_uint,
    pub maxrate: u32,
}
...
#[no_mangle]
unsafe extern "C" fn imx8mp_clocks_apply_constraints(constraints[]: imx8mp_clock_constraints) {
...
#[no_mangle]
unsafe extern "C" fn imx8mp_clocks_probe(pdev: *mut platform_device) -> c_int {
    ...
    const char *opmode;
    int err;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx8mp-anatop");
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(opmode, _arg: "overdrive")) -> else {
