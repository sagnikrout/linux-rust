...
//! Source: drivers/clk/imx/clk-pll14xx.c
#![no_std]
...
pub const GNRL_CTL: c_uint = 0x0;
pub const DIV_CTL0: c_uint = 0x4;
pub const DIV_CTL1: c_uint = 0x8;

pub const LOCK_TIMEOUT_US: c_int = 10000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_pll14xx {
    pub hw: clk_hw,
    pub base: *mut void __iomem,
    pub type: enum imx_pll14xx_type,
...
#[no_mangle]
unsafe extern "C" fn clk_pll14xx_wait_lock(pll: *mut clk_pll14xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_pll14xx_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_pll14xx_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_pll14xx_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn pll_delta_k_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pll_delta_k_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pll_setting_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn imx_audio_pll_debug_init(hws[]: *mut clk_hw, num_plls: c_uint) {
    void imx_audio_pll_debug_init(struct clk_hw *hws[], unsigned int num_plls)
    {
    struct dentry *rootdir, *audio_pll_dir;
    const char *pll_name;
    int i;
    rootdir = debugfs_create_dir("audio_pll_monitor", core::ptr::null_mut());
