...
//! Source: drivers/clk/imx/clk-imx25.c
#![no_std]
...
pub const CCM_MPCTL: c_uint = 0x00;
pub const CCM_UPCTL: c_uint = 0x04;
pub const CCM_CCTL: c_uint = 0x08;
pub const CCM_CGCR0: c_uint = 0x0C;
pub const CCM_CGCR1: c_uint = 0x10;
pub const CCM_CGCR2: c_uint = 0x14;
pub const CCM_PCDR0: c_uint = 0x18;
pub const CCM_PCDR1: c_uint = 0x1C;
pub const CCM_PCDR2: c_uint = 0x20;
pub const CCM_PCDR3: c_uint = 0x24;
pub const CCM_RCSR: c_uint = 0x28;
pub const CCM_CRDR: c_uint = 0x2C;
pub const CCM_DCVR0: c_uint = 0x30;
pub const CCM_DCVR1: c_uint = 0x34;
pub const CCM_DCVR2: c_uint = 0x38;
pub const CCM_DCVR3: c_uint = 0x3c;
pub const CCM_LTR0: c_uint = 0x40;
pub const CCM_LTR1: c_uint = 0x44;
pub const CCM_LTR2: c_uint = 0x48;
pub const CCM_LTR3: c_uint = 0x4c;
pub const CCM_MCR: c_uint = 0x64;
...
#[no_mangle]
unsafe extern "C" fn __mx25_clocks_init(ccm_base: *mut void __iomem) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mx25_clocks_init_dt(np: *mut device_node) -> void __init {
