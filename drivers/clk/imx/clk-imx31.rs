...
//! Source: drivers/clk/imx/clk-imx31.c
#![no_std]
...
pub const MX31_CCM_BASE_ADDR: c_uint = 0x53f80000;
pub const MX31_GPT1_BASE_ADDR: c_uint = 0x53f90000;

pub const MXC_CCM_CCMR: c_uint = 0x00;
pub const MXC_CCM_PDR0: c_uint = 0x04;
pub const MXC_CCM_PDR1: c_uint = 0x08;
pub const MXC_CCM_MPCTL: c_uint = 0x10;
pub const MXC_CCM_UPCTL: c_uint = 0x14;
pub const MXC_CCM_SRPCTL: c_uint = 0x18;
pub const MXC_CCM_CGR0: c_uint = 0x20;
pub const MXC_CCM_CGR1: c_uint = 0x24;
pub const MXC_CCM_CGR2: c_uint = 0x28;
pub const MXC_CCM_PMCR0: c_uint = 0x5c;
...
#[no_mangle]
unsafe extern "C" fn _mx31_clocks_init(base: *mut void __iomem, fref: c_ulong) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mx31_clocks_init_dt(np: *mut device_node) -> void __init {
    static void __init mx31_clocks_init_dt(struct device_node *np)
    {
    u32 fref = 26000000; /* default */
    void __iomem *ccm;
    for_each_compatible_node_scoped(osc_np, core::ptr::null_mut(), "fixed-clock") {
