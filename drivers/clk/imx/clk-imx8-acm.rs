...
//! Source: drivers/clk/imx/clk-imx8-acm.c
#![no_std]
...
pub struct imx8_acm_priv {
    ...
    pub regs: [u32; IMX_ADMA_ACM_CLK_END],
}
...
pub const ACM_AUD_CLK0_SEL_INDEX: c_int = 2;
pub const ACM_AUD_CLK1_SEL_INDEX: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn imx8_acm_clk_probe(pdev: *mut platform_device) -> c_int {
    ...
    int ret;
    int i;
    base = devm_of_iomap(dev, dev.of_node, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn imx8_acm_clk_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn imx8_acm_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn imx8_acm_runtime_resume(dev: *mut device) -> int __maybe_unused {
    ...
    imx8_acm_runtime_resume, core::ptr::null_mut())
