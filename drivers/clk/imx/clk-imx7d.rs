...
//! Source: drivers/clk/imx/clk-imx7d.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx7d_clocks_init(ccm_node: *mut device_node) -> void __init {
    ...
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx7d-anatop");
    base = of_iomap(np, 0);
    WARN_ON(!base);
    of_node_put(np);
    ...
    hws[IMX7D_PLL_DRAM_TEST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll_dram_test_div", "pll_dram_main_bypass",
    CLK_SET_RATE_PARENT | CLK_SET_RATE_GATE, base + 0x70, 21, 2, 0, test_div_table, &imx_ccm_lock);
    hws[IMX7D_PLL_AUDIO_TEST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll_audio_test_div", "pll_audio_main_clk",
    CLK_SET_RATE_PARENT | CLK_SET_RATE_GATE, base + 0xf0, 19, 2, 0, test_div_table, &imx_ccm_lock);
    hws[IMX7D_PLL_AUDIO_POST_DIV] = clk_hw_register_divider_table(core::ptr::null_mut(), "pll_audio_post_div", "pll_audio_test_div",
    CLK_SET_RATE_PARENT | CLK_SET_RATE_GATE, base + 0xf0, 22, 2, 0, post_div_table, &imx_ccm_lock);
    hws[IMX7D_PLL_VIDEO_TEST_DIV]  = clk_hw_register_divider_table(core::ptr::null_mut(), "pll_video_test_div", "pll_video_main_clk",
    CLK_SET_RATE_PARENT | CLK_SET_RATE_GATE, base + 0x130, 19, 2, 0, test_div_table, &imx_ccm_lock);
    hws[IMX7D_PLL_VIDEO_POST_DIV] = clk_hw_register_divider_table(core::ptr::null_mut(), "pll_video_post_div", "pll_video_test_div",
