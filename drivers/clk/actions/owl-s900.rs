...
//! Source: drivers/clk/actions/owl-s900.c
#![no_std]
...
// pll clocks
    static OWL_PLL_NO_PARENT(core_pll_clk, "core_pll_clk", CMU_COREPLL, 24000000, 9, 0, 8, 5, 107, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(dev_pll_clk, "dev_pll_clk", CMU_DEVPLL, 6000000, 8, 0, 8, 20, 180, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(ddr_pll_clk, "ddr_pll_clk", CMU_DDRPLL, 24000000, 8, 0, 8, 5, 45, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(nand_pll_clk, "nand_pll_clk", CMU_NANDPLL, 6000000, 8, 0, 8, 4, 100, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(display_pll_clk, "display_pll_clk", CMU_DISPLAYPLL, 6000000, 8, 0, 8, 20, 180, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(assist_pll_clk, "assist_pll_clk", CMU_ASSISTPLL, 500000000, 0, 0, 0, 0, 0, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
...
// divider clocks
    static OWL_DIVIDER(noc_clk_div, "noc_clk_div", "noc_clk", CMU_BUSCLK, 19, 1, core::ptr::null_mut(), 0, 0);
    static OWL_DIVIDER(ahb_clk, "ahb_clk", "noc_clk_div", CMU_BUSCLK, 4, 1, core::ptr::null_mut(), 0, 0);
...
// composite clocks
    ...
    OWL_DIVIDER_HW(CMU_CSICLK, 16, 4, 0, core::ptr::null_mut()),
    0);
    ...
    OWL_DIVIDER_HW(CMU_LCDCLK, 0, 5, 0, core::ptr::null_mut()),
    0);
    ...
    OWL_DIVIDER_HW(CMU_PWM0CLK, 0, 6, 0, core::ptr::null_mut()),
    0);
    static OWL_COMP_DIV_FIXED(pwm1_clk, "pwm1_clk", "hosc",
    OWL_GATE_HW(CMU_DEVCLKEN1, 24, 0),
    OWL_DIVIDER_HW(CMU_PWM1CLK, 0, 6, 0, core::ptr::null_mut()),
    0);
//
...
//
    ...
    OWL_GATE_HW(CMU_DEVCLKEN0, 14, 0),
    OWL_DIVIDER_HW(CMU_SENSORCLK, 0, 4, 0, core::ptr::null_mut()),
    0);
    static OWL_COMP_DIV_FIXED(speed_sensor_clk, "speed_sensor_clk",
    "hosc",
    OWL_GATE_HW(CMU_DEVCLKEN1, 0, 0),
    OWL_DIVIDER_HW(CMU_TLSCLK, 0, 4, CLK_DIVIDER_POWER_OF_TWO, core::ptr::null_mut()),
    0);
    static OWL_COMP_DIV_FIXED(thermal_sensor_clk, "thermal_sensor_clk",
    "hosc",
    OWL_GATE_HW(CMU_DEVCLKEN1, 2, 0),
    OWL_DIVIDER_HW(CMU_TLSCLK, 8, 4, CLK_DIVIDER_POWER_OF_TWO, core::ptr::null_mut()),
    0);
    ...
    OWL_DIVIDER_HW(CMU_UART1CLK, 1, 8, CLK_DIVIDER_ROUND_CLOSEST, core::ptr::null_mut()),
    CLK_IGNORE_UNUSED);
...
#[no_mangle]
unsafe extern "C" fn s900_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s900_clk_init() -> int __init {
