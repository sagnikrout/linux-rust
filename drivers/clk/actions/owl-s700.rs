...
//! Source: drivers/clk/actions/owl-s700.c
#![no_std]
...
// pll clocks
    static OWL_PLL_NO_PARENT(clk_core_pll,   "core_pll", CMU_COREPLL, 12000000, 9, 0, 8,  4, 174, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(clk_dev_pll,    "dev_pll", CMU_DEVPLL,  6000000, 8, 0, 8, 8, 126, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(clk_ddr_pll,    "ddr_pll", CMU_DDRPLL, 6000000, 8, 0, 8,  2,  180, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(clk_nand_pll,   "nand_pll", CMU_NANDPLL,  6000000, 8, 0, 8,  2, 86, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    static OWL_PLL_NO_PARENT(clk_display_pll, "display_pll", CMU_DISPLAYPLL, 6000000, 8, 0, 8, 2, 140, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
    ...
    static OWL_PLL_NO_PARENT(clk_ethernet_pll, "ethernet_pll", CMU_ETHERNETPLL, 500000000, 0, 0, 0, 0, 0, core::ptr::null_mut(), CLK_IGNORE_UNUSED);
...
// divider clocks
    static OWL_DIVIDER(clk_noc0, "noc0_clk", "noc0_clk_mux", CMU_BUSCLK, 16, 2, core::ptr::null_mut(), 0, 0);
    static OWL_DIVIDER(clk_noc1, "noc1_clk", "noc1_clk_mux", CMU_BUSCLK1, 16, 2, core::ptr::null_mut(), 0, 0);
    static OWL_DIVIDER(clk_noc1_clk_div, "noc1_clk_div", "noc1_clk", CMU_BUSCLK1, 20, 1, core::ptr::null_mut(), 0, 0);
    static OWL_DIVIDER(clk_hp_clk_div, "hp_clk_div", "hp_clk_mux", CMU_BUSCLK1, 12, 2, core::ptr::null_mut(), 0, 0);
    static OWL_DIVIDER(clk_ahb, "ahb_clk", "hp_clk_div", CMU_BUSCLK1, 2, 2, core::ptr::null_mut(), 0, 0);
    static OWL_DIVIDER(clk_apb, "apb_clk", "ahb_clk", CMU_BUSCLK1, 14, 2, core::ptr::null_mut(), 0, 0);
    static OWL_DIVIDER(clk_sensor0, "sensor0", "sensor_src", CMU_SENSORCLK, 0, 4, core::ptr::null_mut(), 0, 0);
    static OWL_DIVIDER(clk_sensor1, "sensor1", "sensor_src", CMU_SENSORCLK, 8, 4, core::ptr::null_mut(), 0, 0);
...
// composite clocks
    ...
    OWL_DIVIDER_HW(CMU_CSICLK, 0, 4, 0, core::ptr::null_mut()),
    0);
    static OWL_COMP_DIV(clk_si, "si", csi_clk_mux_p,
    OWL_MUX_HW(CMU_SICLK, 4, 1),
    OWL_GATE_HW(CMU_DEVCLKEN0, 14,  0),
    OWL_DIVIDER_HW(CMU_SICLK, 0, 4, 0, core::ptr::null_mut()),
    0);
    ...
    OWL_DIVIDER_HW(CMU_NANDCCLK, 0, 3, 0, core::ptr::null_mut()),
    CLK_SET_RATE_PARENT);
...
// for bluetooth pcm communication
    ...
    {0},
    OWL_DIVIDER_HW(CMU_SENSORCLK, 5, 2, 0, core::ptr::null_mut()),
    0);
    ...
    OWL_DIVIDER_HW(CMU_SSTSCLK, 20, 10, 0, core::ptr::null_mut()),
    0);
...
#[no_mangle]
unsafe extern "C" fn s700_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s700_clk_init() -> int __init {
