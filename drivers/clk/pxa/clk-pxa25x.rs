...
//! Source: drivers/clk/pxa/clk-pxa25x.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn pxa25x_get_clk_frequency_khz(info: c_int) -> c_uint {
    ...
    let mut m: c_uint = M_clk_mult[(cccr >> 5) & 0x03];
    ...
    div_hp, bit, core::ptr::null_mut(), 0)
    ...
    PXA25X_PBUS95_CKEN("pxa2xx-mci.0", core::ptr::null_mut(), MMC, 1, 5, 0),
    PXA25X_PBUS95_CKEN("pxa2xx-i2c.0", core::ptr::null_mut(), I2C, 1, 3, 0),
    PXA25X_PBUS95_CKEN("pxa2xx-ir", "FICPCLK", FICP, 1, 2, 0),
    PXA25X_PBUS95_CKEN("pxa25x-udc", core::ptr::null_mut(), USB, 1, 2, 5),
    PXA25X_PBUS147_CKEN("pxa2xx-uart.0", core::ptr::null_mut(), FFUART, 1, 10, 1),
    PXA25X_PBUS147_CKEN("pxa2xx-uart.1", core::ptr::null_mut(), BTUART, 1, 10, 1),
    PXA25X_PBUS147_CKEN("pxa2xx-uart.2", core::ptr::null_mut(), STUART, 1, 10, 1),
    PXA25X_PBUS147_CKEN("pxa2xx-uart.3", core::ptr::null_mut(), HWUART, 1, 10, 1),
    PXA25X_PBUS147_CKEN("pxa2xx-i2s", core::ptr::null_mut(), I2S, 1, 10, 0),
    PXA25X_PBUS147_CKEN(core::ptr::null_mut(), "AC97CLK", AC97, 1, 12, 0),
    PXA25X_OSC3_CKEN("pxa25x-ssp.0", core::ptr::null_mut(), SSP, 1, 1, 0),
    PXA25X_OSC3_CKEN("pxa25x-nssp.1", core::ptr::null_mut(), NSSP, 1, 1, 0),
    PXA25X_OSC3_CKEN("pxa25x-nssp.2", core::ptr::null_mut(), ASSP, 1, 1, 0),
    PXA25X_OSC3_CKEN("pxa25x-pwm.0", core::ptr::null_mut(), PWM0, 1, 1, 0),
    PXA25X_OSC3_CKEN("pxa25x-pwm.1", core::ptr::null_mut(), PWM1, 1, 1, 0),
    PXA25X_CKEN_1RATE("pxa2xx-fb", core::ptr::null_mut(), LCD, clk_pxa25x_memory_parents, 0),
    PXA25X_CKEN_1RATE_AO("pxa2xx-pcmcia", core::ptr::null_mut(), MEMC,
...
#[no_mangle]
unsafe extern "C" fn clk_pxa25x_core_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_pxa25x_core_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
    ...
    {
    let mut cccr: c_ulong = readl(clk_regs + CCCR);
    let mut n2: c_uint = N2_clk_mult[(cccr >> 7) & 0x07];
...
#[no_mangle]
unsafe extern "C" fn pxa25x_register_core() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pxa25x_register_plls() -> void __init {
    static void __init pxa25x_register_plls(void)
    {
    clk_register_fixed_rate(core::ptr::null_mut(), "osc_3_6864mhz", core::ptr::null_mut(),
    ...
    clk_register_fixed_factor(core::ptr::null_mut(), "ppll_95_85mhz", "osc_3_6864mhz",
    0, 26, 1);
    clk_register_fixed_factor(core::ptr::null_mut(), "ppll_147_46mhz", "osc_3_6864mhz",
    0, 40, 1);
    }
#[no_mangle]
unsafe extern "C" fn pxa25x_base_clocks_init() -> void __init {
...
pub struct dummy_clk {
    ...
    DUMMY_CLK(core::ptr::null_mut(), "pxa25x-gpio", "osc_32_768khz"),
    DUMMY_CLK(core::ptr::null_mut(), "pxa26x-gpio", "osc_32_768khz"),
    DUMMY_CLK("GPIO11_CLK", core::ptr::null_mut(), "osc_3_6864mhz"),
    DUMMY_CLK("GPIO12_CLK", core::ptr::null_mut(), "osc_32_768khz"),
    DUMMY_CLK(core::ptr::null_mut(), "sa1100-rtc", "osc_32_768khz"),
    DUMMY_CLK("OSTIMER0", core::ptr::null_mut(), "osc_3_6864mhz"),
    DUMMY_CLK("UARTCLK", "pxa2xx-ir", "STUART"),
    };
#[no_mangle]
unsafe extern "C" fn pxa25x_dummy_clocks_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn pxa25x_clocks_init(regs: *mut void __iomem) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pxa25x_dt_clocks_init(np: *mut device_node) -> void __init {
