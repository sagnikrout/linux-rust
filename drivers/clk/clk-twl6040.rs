...
//! Source: drivers/clk/clk-twl6040.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn twl6040_pdmclk_is_prepared(hw: *mut clk_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn twl6040_pdmclk_quirk_reset_clocks(pdmclk: *mut twl6040_pdmclk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6040_pdmclk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6040_pdmclk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn twl6040_pdmclk_probe(pdev: *mut platform_device) -> c_int {
