...
//! Source: drivers/clk/clk-npcm7xx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_clk_mux_data {
    pub shift: u8,
    pub mask: u8,
    pub table: *mut u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_clk_div_data {
    pub reg: u32,
    pub shift: u8,
    pub width: u8,
    pub name: *const c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm7xx_clk_pll_data {
    pub reg: u32,
    pub name: *const c_char,
    pub parent_name: *const c_char,
    pub flags: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn npcm7xx_clk_init(clk_np: *mut device_node) -> void __init {
...
// Register fixed dividers
    hw = clk_hw_register_fixed_factor(core::ptr::null_mut(), NPCM7XX_CLK_S_PLL1_DIV2,
    NPCM7XX_CLK_S_PLL1, 0, 1, 2);
    if (IS_ERR(hw)) {
    pr_err("npcm7xx_clk: Can't register fixed div\n");
    goto npcm7xx_init_fail;
    }
    hw = clk_hw_register_fixed_factor(core::ptr::null_mut(), NPCM7XX_CLK_S_PLL2_DIV2,
...
// Register muxes
    ...
    hw = clk_hw_register_mux_table(core::ptr::null_mut(),
    mux_data.name,
...
// Register clock dividers specified in npcm7xx_divs
    ...
    hw = clk_hw_register_divider(core::ptr::null_mut(), div_data.name,
