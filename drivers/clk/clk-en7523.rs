...
//! Source: drivers/clk/clk-en7523.c
#![no_std]
...
pub const REG_PCI_CONTROL: c_uint = 0x88;

pub const REG_GSW_CLK_DIV_SEL: c_uint = 0x1b4;
pub const REG_EMI_CLK_DIV_SEL: c_uint = 0x1b8;
pub const REG_BUS_CLK_DIV_SEL: c_uint = 0x1bc;
pub const REG_SPI_CLK_DIV_SEL: c_uint = 0x1c4;
pub const REG_SPI_CLK_FREQ_SEL: c_uint = 0x1c8;
pub const REG_NPU_CLK_DIV_SEL: c_uint = 0x1fc;
pub const REG_CRYPTO_CLKSRC: c_uint = 0x200;
pub const REG_RESET_CONTROL2: c_uint = 0x830;

pub const REG_RESET_CONTROL1: c_uint = 0x834;

pub const REG_HIR: c_uint = 0x064;

// EN7581
pub const REG_NP_SCU_PCIC: c_uint = 0x88;
pub const REG_NP_SCU_SSTR: c_uint = 0x9c;

pub const REG_CRYPTO_CLKSRC2: c_uint = 0x20c;
// EN751221
pub const EN751221_REG_SPI_DIV: c_uint = 0x0cc;

pub const EN751221_SPI_BASE: c_int = 500000000;
pub const EN751221_SPI_BASE_EN7526C: c_int = 400000000;
pub const EN751221_SPI_DIV_DEFAULT: c_int = 40;
pub const EN751221_REG_BUS: c_uint = 0x284;

pub const EN751221_REG_SSR3: c_uint = 0x094;

pub const REG_RST_CTRL2: c_uint = 0x830;
pub const REG_RST_CTRL1: c_uint = 0x834;

pub const EN751221_REG_RST_DMT: c_uint = 0x84;
pub const EN751221_REG_RST_USB: c_uint = 0xec;
pub const EN751221_MAX_CLKS: c_int = 5;
    enum en_hir {
    HIR_UNKNOWN	= -1,
    HIR_TC3169	= 0,
    HIR_TC3182	= 1,
...
pub struct en_clk_desc {
    ...
    pub base_shift: u8,
    union {
    pub base_values: *const c_uint,
    pub base_value: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct en_rst_data {
    pub bank_ofs: *const u16,
    pub idx_map: *const u16,
    pub base: *mut void __iomem,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct en_clk_soc_data {
    pub num_clocks: u32,
    pub pcie_ops: clk_ops,
...
#[no_mangle]
unsafe extern "C" fn en7523_get_base_rate(desc: *const en_clk_desc, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn en7523_get_div(desc: *const en_clk_desc, val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn en7523_pci_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn en7523_pci_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn en7523_pci_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn en7581_pci_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn en7581_pci_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn en7581_pci_disable(hw: *mut clk_hw) {
    ...
    let mut reg: u32 = desc.div_reg ? desc.div_reg : desc.base_reg;
    let mut val: u32 = readl(base + desc.base_reg);
    rate = en7523_get_base_rate(desc, val);
    val = readl(base + reg);
    rate /= en7523_get_div(desc, val);
    hw = clk_hw_register_fixed_rate(dev, desc.name, core::ptr::null_mut(), 0, rate);
    if (IS_ERR(hw)) {
    ...
    let mut offset: u32 = rst_data.bank_ofs[id / RST_NR_PER_BANK];
...
#[no_mangle]
unsafe extern "C" fn get_hw_id(np_base: *mut void __iomem) -> enum en_hir {
    static enum en_hir get_hw_id(void __iomem *np_base)
    {
    let mut val: u32 = FIELD_GET(REG_HIR_MASK, readl(np_base + REG_HIR));
    if (val < HIR_MAX)
    ...
    return;
    hw = clk_hw_register_fixed_rate(dev, name, core::ptr::null_mut(), 0, rate);
    if (IS_ERR(hw))
    ...
    {
    let mut hid: enum en_hir = get_hw_id(np_base);
    struct clk_hw *hw;
    u32 rate;
    u32 div;
    int err;
...
#[no_mangle]
unsafe extern "C" fn en7523_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_en7523_init() -> int __init {
