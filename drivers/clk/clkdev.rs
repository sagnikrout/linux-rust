...
//
    ...
    {
    struct clk_lookup *p, *cl = core::ptr::null_mut();
    ...
    {
    return __clk_get_sys(core::ptr::null_mut(), dev_id, con_id);
    }
...
#[no_mangle]
pub unsafe extern "C" fn clk_put(clk: *mut clk) {
...
#[no_mangle]
unsafe extern "C" fn __clkdev_add(cl: *mut clk_lookup) {
...
#[no_mangle]
pub unsafe extern "C" fn clkdev_add(cl: *mut clk_lookup) {
...
#[no_mangle]
pub unsafe extern "C" fn clkdev_add_table(cl: *mut clk_lookup, num: usize) {
...
pub const MAX_DEV_ID: c_int = 24;
pub const MAX_CON_ID: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_lookup_alloc {
    pub cl: clk_lookup,
    pub dev_id: [c_char; MAX_DEV_ID],
    pub con_id: [c_char; MAX_CON_ID],
}
...
//
    ...
    if (IS_ERR(r))
    return PTR_ERR(r);
    l = clkdev_create(r, alias, alias_dev_name ? "%s" : core::ptr::null_mut(),
    alias_dev_name);
    clk_put(r);
    return l ? 0 : -ENODEV;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn clkdev_drop(cl: *mut clk_lookup) {
...
#[no_mangle]
unsafe extern "C" fn devm_clkdev_release(res: *mut c_void) {
