...
//! Source: drivers/clk/mstar/clk-msc313-mpll.c
#![no_std]
...
pub const REG_CONFIG1: c_uint = 0x8;
pub const REG_CONFIG2: c_uint = 0xc;
    static const struct regmap_config msc313_mpll_regmap_config = {
    .reg_bits = 16,
    .val_bits = 16,
    .reg_stride = 4,
    };
    let mut config1_loop_div_first: static struct reg_field = REG_FIELD(REG_CONFIG1, 8, 9);
    let mut config1_input_div_first: static struct reg_field = REG_FIELD(REG_CONFIG1, 4, 5);
    let mut config2_output_div_first: static struct reg_field = REG_FIELD(REG_CONFIG2, 12, 13);
    let mut config2_loop_div_second: static struct reg_field = REG_FIELD(REG_CONFIG2, 0, 7);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msc313_mpll {
    pub clk_hw: clk_hw,
    pub input_div: *mut regmap_field,
    pub loop_div_first: *mut regmap_field,
    pub loop_div_second: *mut regmap_field,
    pub output_div: *mut regmap_field,
...
#[no_mangle]
unsafe extern "C" fn msc313_mpll_probe(pdev: *mut platform_device) -> c_int {
