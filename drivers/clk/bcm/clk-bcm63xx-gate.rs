...
//! Source: drivers/clk/bcm/clk-bcm63xx-gate.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_bcm63xx_table_entry {
...
#[no_mangle]
unsafe extern "C" fn clk_bcm63xx_probe(pdev: *mut platform_device) -> c_int {
    ...
    for (entry = table; entry.name; entry++) {
    struct clk_hw *clk;
    clk = clk_hw_register_gate(&pdev.dev, entry.name, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn clk_bcm63xx_remove(pdev: *mut platform_device) {
