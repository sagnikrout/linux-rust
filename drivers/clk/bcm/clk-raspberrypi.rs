...
//! Source: drivers/clk/bcm/clk-raspberrypi.c
#![no_std]
...
pub struct raspberrypi_clk {
    ...
    pub cpufreq: *mut platform_device,
}
...
pub struct raspberrypi_clk_data {
    pub hw: clk_hw,
    pub id: c_uint,
    pub variant: *mut raspberrypi_clk_variant,
    pub rpi: *mut raspberrypi_clk,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct raspberrypi_firmware_prop {
    pub id: __le32,
    pub val: __le32,
    pub disable_turbo: __le32,
    pub __packed: },
...
#[no_mangle]
unsafe extern "C" fn raspberrypi_fw_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn raspberrypi_fw_prepare(hw: *mut clk_hw) -> c_int {
    static int raspberrypi_fw_prepare(struct clk_hw *hw)
    {
    const struct raspberrypi_clk_data *data = clk_hw_to_data(hw);
    struct raspberrypi_clk_variant *variant = data.variant;
    struct raspberrypi_clk *rpi = data.rpi;
    let mut state: u32 = RPI_FIRMWARE_STATE_ENABLE_BIT;
    int ret;
    ret = raspberrypi_clock_property(rpi.firmware, data,
...
//
    ...
    core::ptr::null_mut(), variant.clkdev);
    if (ret) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpi_firmware_get_clocks_response {
    pub parent: u32,
    pub id: u32,
}
...
#[no_mangle]
unsafe extern "C" fn raspberrypi_clk_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    firmware_node = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(),
