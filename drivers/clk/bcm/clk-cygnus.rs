...
//! Source: drivers/clk/bcm/clk-cygnus.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cygnus_armpll_init(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn cygnus_genpll_clk_init(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn cygnus_lcpll0_clk_init(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn cygnus_mipipll_clk_init(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn cygnus_asiu_init(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn cygnus_audiopll_clk_init(node: *mut device_node) -> void __init {
    static void __init cygnus_audiopll_clk_init(struct device_node *node)
    {
    iproc_pll_clk_setup(node, &audiopll, core::ptr::null_mut(), 0,
