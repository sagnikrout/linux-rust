...
//! Source: drivers/clk/bcm/clk-kona-setup.c
#![no_std]
...
// Validity checking
#[no_mangle]
unsafe extern "C" fn ccu_data_offsets_valid(ccu: *mut ccu_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn clk_requires_trigger(bcm_clk: *mut kona_clk) -> bool {
...
#[no_mangle]
unsafe extern "C" fn peri_clk_data_offsets_valid(bcm_clk: *mut kona_clk) -> bool {
...
// A bit position must be less than the number of bits in a 32-bit register.
    ...
    {
    let mut limit: u32 = BITS_PER_BYTE * sizeof(u32) - 1;
    if (bit_posn > limit) {
...
//
    ...
    const char *clock_name)
    {
    let mut limit: u32 = BITS_PER_BYTE * sizeof(u32);
    if (!width) {
...
#[no_mangle]
unsafe extern "C" fn policy_valid(policy: *mut bcm_clk_policy, clock_name: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hyst_valid(hyst: *mut bcm_clk_hyst, clock_name: *const c_char) -> bool {
...
//
    ...
    sel.parent_sel = core::ptr::null_mut();
    }
    return true;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn kona_dividers_valid(bcm_clk: *mut kona_clk) -> bool {
...
#[no_mangle]
unsafe extern "C" fn kona_clk_valid(bcm_clk: *mut kona_clk) -> bool {
...
//
    ...
    let mut ret: c_int = PTR_ERR(parent_sel);
    ...
    init_data.parent_names = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn bcm_clk_teardown(bcm_clk: *mut kona_clk) {
    ...
    bcm_clk.u.data = core::ptr::null_mut();
    bcm_clk.type = bcm_clk_none;
    }
#[no_mangle]
unsafe extern "C" fn kona_clk_teardown(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn kona_clk_setup(bcm_clk: *mut kona_clk) -> c_int {
...
// Make sure everything makes sense before we set it up
    ...
    ret = clk_hw_register(core::ptr::null_mut(), &bcm_clk.hw);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn ccu_clks_teardown(ccu: *mut ccu_data) {
...
#[no_mangle]
unsafe extern "C" fn kona_ccu_teardown(ccu: *mut ccu_data) {
    ...
    ccu.node = core::ptr::null_mut();
    iounmap(ccu.base);
    ccu.base = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ccu_data_valid(ccu: *mut ccu_data) -> bool {
