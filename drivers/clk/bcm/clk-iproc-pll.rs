...
//! Source: drivers/clk/bcm/clk-iproc-pll.c
#![no_std]
...
pub const PLL_VCO_HIGH_SHIFT: c_int = 19;
pub const PLL_VCO_LOW_SHIFT: c_int = 30;
//
...
//
pub const PLL_USER_MODE: c_int = 7;
// number of delay loops waiting for PLL to lock
pub const LOCK_DELAY: c_int = 100;
// number of VCO frequency bands
pub const NUM_FREQ_BANDS: c_int = 8;
pub const NUM_KP_BANDS: c_int = 3;
    enum kp_band {
    KP_BAND_MID = 0,
    KP_BAND_HIGH,
    KP_BAND_HIGH_HIGH
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iproc_pll {
    pub status_base: *mut void __iomem,
    pub control_base: *mut void __iomem,
    pub pwr_base: *mut void __iomem,
    pub asiu_base: *mut void __iomem,
    pub ctrl: *const iproc_pll_ctrl,
    pub vco_param: *const iproc_pll_vco_param,
    pub num_vco_entries: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iproc_clk {
    pub hw: clk_hw,
    pub pll: *mut iproc_pll,
    pub ctrl: *const iproc_clk_ctrl,
}
...
//
#[no_mangle]
unsafe extern "C" fn pll_get_rate_index(pll: *mut iproc_pll, target_rate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_kp(ref_freq: c_ulong, kp_index: enum kp_band) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pll_wait_for_lock(pll: *mut iproc_pll) -> c_int {
    static int pll_wait_for_lock(struct iproc_pll *pll)
    {
    int i;
    const struct iproc_pll_ctrl *ctrl = pll.ctrl;
    for (i = 0; i < LOCK_DELAY; i++) {
    let mut val: u32 = readl(pll.status_base + ctrl.status.offset);
...
#[no_mangle]
unsafe extern "C" fn __pll_disable(pll: *mut iproc_pll) {
...
#[no_mangle]
unsafe extern "C" fn __pll_enable(pll: *mut iproc_pll) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __pll_put_in_reset(pll: *mut iproc_pll) {
...
// PLL needs to be locked
    ...
    const struct iproc_pll_ctrl *ctrl = pll.ctrl;
    let mut ka: c_int = 0, ki, kp, ret;
    let mut rate: c_ulong = vco.rate;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn iproc_pll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iproc_pll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn iproc_clk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iproc_clk_disable(hw: *mut clk_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn iproc_pll_sw_cfg(pll: *mut iproc_pll) {
...
// initialize and register the PLL itself
    ...
    ret = clk_hw_register(core::ptr::null_mut(), &iclk.hw);
    if (WARN_ON(ret))
    goto err_pll_register;
