...
//! Source: drivers/clk/at91/sckc.c
#![no_std]
...
pub const SLOWCK_SW_CYCLES: c_int = 5;

    SLOW_CLOCK_FREQ)
pub const AT91_SCKC_CR: c_uint = 0x00;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_slow_bits {
    pub cr_rcen: u32,
    pub cr_osc32en: u32,
    pub cr_osc32byp: u32,
    pub cr_oscsel: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_slow_osc {
    pub hw: clk_hw,
    pub sckcr: *mut void __iomem,
    pub bits: *const clk_slow_bits,
    pub startup_usec: c_ulong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_sama5d4_slow_osc {
    pub hw: clk_hw,
    pub sckcr: *mut void __iomem,
    pub bits: *const clk_slow_bits,
    pub startup_usec: c_ulong,
...
#[no_mangle]
unsafe extern "C" fn clk_slow_osc_prepare(hw: *mut clk_hw) -> c_int {
    static int clk_slow_osc_prepare(struct clk_hw *hw)
    {
    struct clk_slow_osc *osc = to_clk_slow_osc(hw);
    void __iomem *sckcr = osc.sckcr;
    let mut tmp: u32 = readl(sckcr);
...
#[no_mangle]
unsafe extern "C" fn clk_slow_osc_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_slow_osc_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91_clk_unregister_slow_osc(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_slow_rc_osc_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_slow_rc_osc_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_slow_rc_osc_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91_clk_unregister_slow_rc_osc(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_sam9x5_slow_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_sam9x5_slow_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn at91_clk_unregister_sam9x5_slow(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn of_at91sam9x5_sckc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_sama5d3_sckc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_sam9x60_sckc_setup(np: *mut device_node) -> void __init {
    ...
    if (!regbase)
    return;
    slow_rc = clk_hw_register_fixed_rate_with_accuracy(core::ptr::null_mut(), "slow_rc_osc",
    core::ptr::null_mut(), 0, 32768,
    93750000);
    if (IS_ERR(slow_rc))
    return;
    xtal_name = of_clk_get_parent_name(np, 0);
...
// MD_SLCK and TD_SLCK.
    clk_data.num = 2;
    hw = clk_hw_register_fixed_rate_parent_hw(core::ptr::null_mut(), "md_slck", slow_rc,
    0, 32768);
    if (IS_ERR(hw))
    goto clk_data_free;
...
#[no_mangle]
unsafe extern "C" fn clk_sama5d4_slow_osc_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_sama5d4_slow_osc_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_sama5d4_sckc_setup(np: *mut device_node) -> void __init {
    ...
    if (!regbase)
    return;
    slow_rc = clk_hw_register_fixed_rate_with_accuracy(core::ptr::null_mut(),
    "slow_rc_osc",
    core::ptr::null_mut(), 0, 32768,
    250000000);
    if (IS_ERR(slow_rc))
