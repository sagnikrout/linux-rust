...
//! Source: drivers/clk/at91/clk-usb.c
#![no_std]
...
pub const SAM9X5_USB_DIV_SHIFT: c_int = 8;
pub const SAM9X5_USB_MAX_DIV: c_uint = 0xf;
pub const RM9200_USB_DIV_SHIFT: c_int = 28;
pub const RM9200_USB_DIV_TAB_SIZE: c_int = 4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct at91sam9x5_clk_usb {
    pub hw: clk_hw,
...
#[no_mangle]
unsafe extern "C" fn at91sam9n12_clk_usb_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at91sam9n12_clk_usb_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn at91sam9n12_clk_usb_is_enabled(hw: *mut clk_hw) -> c_int {
    ...
    hw = &usb.hw;
    ret = clk_hw_register(core::ptr::null_mut(), &usb.hw);
    if (ret) {
    kfree(usb);
    hw = ERR_PTR(ret);
    }
    ...
    let mut bestrate: c_ulong = 0;
    let mut bestdiff: c_int = -1;
