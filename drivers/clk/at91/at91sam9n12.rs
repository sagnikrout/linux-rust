...
//! Source: drivers/clk/at91/at91sam9n12.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn at91sam9n12_pmc_setup(np: *mut device_node) -> void __init {
    ...
    at91sam9n12_systemck[i].p, core::ptr::null_mut(),
