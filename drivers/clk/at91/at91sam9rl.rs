...
//! Source: drivers/clk/at91/at91sam9rl.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn at91sam9rl_pmc_setup(np: *mut device_node) -> void __init {
    ...
    if (!at91sam9rl_pmc)
    return;
    hw = at91_clk_register_rm9200_main(regmap, "mainck", mainxtal_name, core::ptr::null_mut());
    if (IS_ERR(hw))
    goto err_free;
    ...
    at91sam9rl_systemck[i].p, core::ptr::null_mut(),
