...
//! Source: drivers/clk/at91/at91sam9x5.c
#![no_std]
...
pub struct pck {
    ...
    hw = at91_clk_register_main_osc(regmap, "main_osc", mainxtal_name, core::ptr::null_mut(),
    bypass);
    if (IS_ERR(hw))
    goto err_free;
    parent_names[0] = "main_rc_osc";
    parent_names[1] = "main_osc";
    hw = at91_clk_register_sam9x5_main(regmap, "mainck", parent_names, core::ptr::null_mut(), 2);
    if (IS_ERR(hw))
    goto err_free;
    ...
    hw = at91_clk_register_utmi(regmap, core::ptr::null_mut(), "utmick", "mainck", core::ptr::null_mut());
    if (IS_ERR(hw))
    goto err_free;
    ...
    parent_names, core::ptr::null_mut(),
    &at91sam9x5_master_layout,
    &mck_characteristics, &mck_lock);
    if (IS_ERR(hw))
    goto err_free;
    hw = at91_clk_register_master_div(regmap, "masterck_div",
    "masterck_pres", core::ptr::null_mut(),
    &at91sam9x5_master_layout,
    &mck_characteristics, &mck_lock,
    CLK_SET_RATE_GATE, 0);
    if (IS_ERR(hw))
    ...
    parent_names, core::ptr::null_mut(), 5, i,
    ...
    at91sam9x5_systemck[i].p, core::ptr::null_mut(),
    ...
    "masterck_div", core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn at91sam9g15_pmc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn at91sam9g25_pmc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn at91sam9g35_pmc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn at91sam9x25_pmc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn at91sam9x35_pmc_setup(np: *mut device_node) -> void __init {
