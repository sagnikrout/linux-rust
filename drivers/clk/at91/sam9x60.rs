...
//! Source: drivers/clk/at91/sam9x60.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sam9x60_pmc_setup(np: *mut device_node) -> void __init {
...
//
    ...
    "pllack_fracck", core::ptr::null_mut(), 0, &plla_characteristics,
    &pll_div_layout,
//
...
//
    ...
    "upllck_fracck", core::ptr::null_mut(), 1, &upll_characteristics,
    &pll_div_layout,
    CLK_SET_RATE_GATE |
    CLK_SET_PARENT_GATE |
    ...
    parent_names, core::ptr::null_mut(), &sam9x60_master_layout,
    &mck_characteristics, &mck_lock);
    if (IS_ERR(hw))
    goto err_free;
    hw = at91_clk_register_master_div(regmap, "masterck_div",
    "masterck_pres", core::ptr::null_mut(), &sam9x60_master_layout,
    &mck_characteristics, &mck_lock,
    CLK_SET_RATE_GATE, 0);
    if (IS_ERR(hw))
    goto err_free;
    ...
    parent_names, core::ptr::null_mut(), 6, i,
    ...
    sam9x60_systemck[i].p, core::ptr::null_mut(),
    ...
    &sam9x60_pcr_layout,
    sam9x60_gck[i].n,
    parent_names, core::ptr::null_mut(), core::ptr::null_mut(), 6,
    sam9x60_gck[i].id,
