...
//! Source: drivers/clk/at91/sama7g5.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sama7g5_pmc_setup(np: *mut device_node) -> void __init {
    static void __init sama7g5_pmc_setup(struct device_node *np)
    {
    const char *main_xtal_name = "main_xtal";
    struct pmc_data *sama7g5_pmc;
    void **alloc_mem = core::ptr::null_mut();
    let mut alloc_mem_size: c_int = 0;
    ...
    main_osc_hw = at91_clk_register_main_osc(regmap, "main_osc", core::ptr::null_mut(),
    &parent_data, bypass);
    if (IS_ERR(main_osc_hw))
    goto err_free;
    parent_hws[0] = main_rc_hw;
    parent_hws[1] = main_osc_hw;
    hw = at91_clk_register_sam9x5_main(regmap, "mainck", core::ptr::null_mut(), parent_hws, 2);
    if (IS_ERR(hw))
    goto err_free;
    ...
    default:
// Should not happen.
    parent_hw = core::ptr::null_mut();
    break;
    }
    hw = sam9x60_clk_register_frac_pll(regmap,
    &pmc_pll_lock, sama7g5_plls[i][j].n,
    core::ptr::null_mut(), parent_hw, i,
    sama7g5_plls[i][j].c,
    sama7g5_plls[i][j].l,
    sama7g5_plls[i][j].f);
    break;
    ...
    &pmc_pll_lock, sama7g5_plls[i][j].n,
    core::ptr::null_mut(), sama7g5_plls[i][0].hw, i,
    sama7g5_plls[i][j].c,
    sama7g5_plls[i][j].l,
    sama7g5_plls[i][j].f,
    ...
    hw = at91_clk_register_master_div(regmap, "mck0", core::ptr::null_mut(),
    ...
    let mut num_parents: u8 = 3 + sama7g5_mckx[i].ep_count;
    ...
    let mut pll_id: u8 = sama7g5_mckx[i].ep[j].pll_id;
    let mut pll_compid: u8 = sama7g5_mckx[i].ep[j].pll_compid;
    tmp_parent_hws[j] = sama7g5_plls[pll_id][pll_compid].hw;
    }
    PMC_FILL_TABLE(&parent_hws[3], tmp_parent_hws,
    sama7g5_mckx[i].ep_count);
    hw = at91_clk_sama7g5_register_master(regmap, sama7g5_mckx[i].n,
    num_parents, core::ptr::null_mut(), parent_hws, mux_table,
    ...
    hw = at91_clk_sama7g5_register_utmi(regmap, "utmick", core::ptr::null_mut(), main_xtal_hw);
    if (IS_ERR(hw))
    goto err_free;
    ...
    hw = at91_clk_register_programmable(regmap, name, core::ptr::null_mut(), parent_hws,
    9, i,
    &programmable_layout,
    ...
    core::ptr::null_mut(), sama7g5_pmc.pchws[i],
    ...
    let mut num_parents: u8 = 3 + sama7g5_gck[i].pp_count;
    struct clk_hw *tmp_parent_hws[8];
    u32 *mux_table;
    mux_table = kmalloc_array(num_parents, sizeof(*mux_table),
    GFP_KERNEL);
    ...
    let mut pll_id: u8 = sama7g5_gck[i].pp[j].pll_id;
    let mut pll_compid: u8 = sama7g5_gck[i].pp[j].pll_compid;
    tmp_parent_hws[j] = sama7g5_plls[pll_id][pll_compid].hw;
    }
    PMC_FILL_TABLE(&parent_hws[3], tmp_parent_hws,
    sama7g5_gck[i].pp_count);
    ...
    &sama7g5_pcr_layout,
    sama7g5_gck[i].n, core::ptr::null_mut(),
