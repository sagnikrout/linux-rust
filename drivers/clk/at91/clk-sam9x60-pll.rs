...
//! Source: drivers/clk/at91/clk-sam9x60-pll.c
#![no_std]
...
pub const UPLL_DIV: c_int = 2;

pub const PLL_MAX_ID: c_int = 9;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sam9x60_pll_core {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sam9x60_frac {
    pub core: sam9x60_pll_core,
...
#[no_mangle]
pub unsafe extern "C" fn sam9x60_pll_ready(regmap: *mut regmap, id: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_frac_pll_ready(regmap: *mut regmap, id: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_frac_pll_set(core: *mut sam9x60_pll_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_frac_pll_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_frac_pll_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_frac_pll_is_prepared(hw: *mut clk_hw) -> c_int {
    ...
    let mut nmul: c_ulong = 0;
    let mut nfrac: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn sam9x60_frac_pll_save_context(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_frac_pll_restore_context(hw: *mut clk_hw) {
...
//
    ...
    {
    struct regmap *regmap = core.regmap;
    let mut ena_msk: u32 = enable ? core.layout.endiv_mask : 0;
    let mut ena_val: u32 = enable ? (1 << core.layout.endiv_shift) : 0;
    regmap_update_bits(regmap, AT91_PMC_PLL_CTRL0,
...
#[no_mangle]
unsafe extern "C" fn sam9x60_div_pll_set(core: *mut sam9x60_pll_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_div_pll_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_div_pll_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_div_pll_is_prepared(hw: *mut clk_hw) -> c_int {
    ...
    let mut best_diff: c_long = -1, best_rate = -EINVAL;
    u32 divid;
    if (!rate)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn sam9x60_div_pll_save_context(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sam9x60_div_pll_restore_context(hw: *mut clk_hw) {
    ...
    let mut core: sam9x60_pll_core = div.core;
    struct regmap *regmap = core.regmap;
    unsigned long irqflags;
    u32 val, cdiv;
...
#[no_mangle]
pub unsafe extern "C" fn if(CLK_SET_RATE_GATE: flags &) -> else {
