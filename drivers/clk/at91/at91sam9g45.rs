...
//! Source: drivers/clk/at91/at91sam9g45.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn at91sam9g45_pmc_setup(np: *mut device_node) -> void __init {
    ...
    at91sam9g45_systemck[i].p, core::ptr::null_mut(),
