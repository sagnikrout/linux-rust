...
//! Source: drivers/clk/at91/sama5d2.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sama5d2_pmc_setup(np: *mut device_node) -> void __init {
    ...
    hw = at91_clk_register_utmi(regmap, regmap_sfr, "utmick", "mainck", core::ptr::null_mut());
    if (IS_ERR(hw))
    goto err_free;
    ...
    sama5d2_systemck[i].p, core::ptr::null_mut(),
