...
//! Source: drivers/clk/at91/at91sam9260.c
#![no_std]
...
pub struct at91sam926x_data {
    ...
    if (IS_ERR(hw))
    goto err_free;
    hw = at91_clk_register_rm9200_main(regmap, "mainck", "main_osc", core::ptr::null_mut());
    if (IS_ERR(hw))
    goto err_free;
    at91sam9260_pmc.chws[PMC_MAIN] = hw;
    if (data.has_slck) {
    hw = clk_hw_register_fixed_rate_with_accuracy(core::ptr::null_mut(),
    "slow_rc_osc",
    ...
    parent_names, core::ptr::null_mut(), 4, i,
    ...
    data.sck[i].p, core::ptr::null_mut(),
    data.sck[i].id, 0);
    if (IS_ERR(hw))
    goto err_free;
...
#[no_mangle]
unsafe extern "C" fn at91sam9260_pmc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn at91sam9261_pmc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn at91sam9263_pmc_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn at91sam9g20_pmc_setup(np: *mut device_node) -> void __init {
