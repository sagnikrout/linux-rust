...
//! Source: drivers/clk/at91/clk-generated.c
#![no_std]
...
pub const GENERATED_MAX_DIV: c_int = 255;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_generated {
    pub hw: clk_hw,
...
#[no_mangle]
unsafe extern "C" fn clk_generated_set(gck: *mut clk_generated, status: c_int) -> c_int {
    static int clk_generated_set(struct clk_generated *gck, int status)
    {
    unsigned long flags;
    let mut enable: c_uint = status ? AT91_PMC_PCR_GCKEN : 0;
...
#[no_mangle]
unsafe extern "C" fn clk_generated_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_generated_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_generated_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_generated_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_generated_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_generated_save_context(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_generated_restore_context(hw: *mut clk_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_generated_startup(gck: *mut clk_generated) {
    ...
    hw = &gck.hw;
    ret = clk_hw_register(core::ptr::null_mut(), &gck.hw);
    if (ret) {
    kfree(gck);
    hw = ERR_PTR(ret);
    }
