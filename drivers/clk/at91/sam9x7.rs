...
//! Source: drivers/clk/at91/sam9x7.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sam9x7_pmc_setup(np: *mut device_node) -> void __init {
    ...
    void **clk_mux_buffer = core::ptr::null_mut();
    let mut clk_mux_buffer_size: c_int = 0;
    ...
    if (IS_ERR(hw))
    goto err_free;
    hw = at91_clk_register_main_osc(regmap, "main_osc", mainxtal_name, core::ptr::null_mut(), 0);
    if (IS_ERR(hw))
    goto err_free;
    main_osc_hw = hw;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(sam9x7_plls[i][j].p, _arg: "main_osc")) -> else {
    ...
    &pmc_pll_lock,
    sam9x7_plls[i][j].n,
    sam9x7_plls[i][j].p, core::ptr::null_mut(), i,
    sam9x7_plls[i][j].c,
    sam9x7_plls[i][j].l,
    sam9x7_plls[i][j].f, 0);
    break;
    ...
    parent_names, core::ptr::null_mut(), &sam9x7_master_layout,
    &mck_characteristics, &mck_lock);
    if (IS_ERR(hw))
    goto err_free;
    hw = at91_clk_register_master_div(regmap, "masterck_div",
    "masterck_pres", core::ptr::null_mut(), &sam9x7_master_layout,
    &mck_characteristics, &mck_lock,
    CLK_SET_RATE_GATE, 0);
    if (IS_ERR(hw))
    goto err_free;
    ...
    parent_names, core::ptr::null_mut(), 7, i,
    ...
    sam9x7_systemck[i].p, core::ptr::null_mut(),
    ...
    let mut num_parents: u8 = 4 + sam9x7_gck[i].pp_count;
    u32 *mux_table;
    ...
    &sam9x7_pcr_layout,
    sam9x7_gck[i].n,
    parent_names, core::ptr::null_mut(), mux_table,
    num_parents,
    sam9x7_gck[i].id,
    &sam9x7_gck[i].r,
