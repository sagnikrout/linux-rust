...
//! Source: drivers/clk/ux500/u8500_of_clk.c
#![no_std]
...
// gets the right size.
//
    [PRCMU_NUM_CLKS] = core::ptr::null_mut(),
    },
    .num = PRCMU_NUM_CLKS,
    };
...
unsafe extern "C" fn u8500_clk_init(np: *mut device_node) {
    ...
    const char *sgaclk_parent = core::ptr::null_mut();
...
// Clock sources
    ...
    clk_reg_prcmu_gate("soc0_pll", core::ptr::null_mut(), PRCMU_PLLSOC0,
    CLK_IGNORE_UNUSED);
    u8500_prcmu_hw_clks.hws[PRCMU_PLLSOC1] =
    clk_reg_prcmu_gate("soc1_pll", core::ptr::null_mut(), PRCMU_PLLSOC1,
    CLK_IGNORE_UNUSED);
    u8500_prcmu_hw_clks.hws[PRCMU_PLLDDR] =
    clk_reg_prcmu_gate("ddr_pll", core::ptr::null_mut(), PRCMU_PLLDDR,
    CLK_IGNORE_UNUSED);
//
...
//
    clk_reg_prcmu_rate("clk38m_to_clkgen", core::ptr::null_mut(), PRCMU_SYSCLK,
    CLK_IGNORE_UNUSED);
    clk_reg_prcmu_rate("aclk", core::ptr::null_mut(), PRCMU_ACLK,
    CLK_IGNORE_UNUSED);
// TODO: add CLK009 if needed
    rtc_clk = clk_register_fixed_rate(core::ptr::null_mut(), "rtc32k", "core::ptr::null_mut()",
    CLK_IGNORE_UNUSED,
    32768);
// PRCMU clocks
    fw_version = prcmu_get_fw_version();
    if (fw_version != core::ptr::null_mut()) {
    ...
    u8500_prcmu_hw_clks.hws[PRCMU_SGACLK] =
    clk_reg_prcmu_gate("sgclk", core::ptr::null_mut(), PRCMU_SGACLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_UARTCLK] =
    clk_reg_prcmu_gate("uartclk", core::ptr::null_mut(), PRCMU_UARTCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_MSP02CLK] =
    clk_reg_prcmu_gate("msp02clk", core::ptr::null_mut(), PRCMU_MSP02CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_MSP1CLK] =
    clk_reg_prcmu_gate("msp1clk", core::ptr::null_mut(), PRCMU_MSP1CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_I2CCLK] =
    clk_reg_prcmu_gate("i2cclk", core::ptr::null_mut(), PRCMU_I2CCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_SLIMCLK] =
    clk_reg_prcmu_gate("slimclk", core::ptr::null_mut(), PRCMU_SLIMCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_PER1CLK] =
    clk_reg_prcmu_gate("per1clk", core::ptr::null_mut(), PRCMU_PER1CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_PER2CLK] =
    clk_reg_prcmu_gate("per2clk", core::ptr::null_mut(), PRCMU_PER2CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_PER3CLK] =
    clk_reg_prcmu_gate("per3clk", core::ptr::null_mut(), PRCMU_PER3CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_PER5CLK] =
    clk_reg_prcmu_gate("per5clk", core::ptr::null_mut(), PRCMU_PER5CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_PER6CLK] =
    clk_reg_prcmu_gate("per6clk", core::ptr::null_mut(), PRCMU_PER6CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_PER7CLK] =
    clk_reg_prcmu_gate("per7clk", core::ptr::null_mut(), PRCMU_PER7CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_LCDCLK] =
    clk_reg_prcmu_scalable("lcdclk", core::ptr::null_mut(), PRCMU_LCDCLK, 0,
    CLK_SET_RATE_GATE);
    u8500_prcmu_hw_clks.hws[PRCMU_BMLCLK] =
    clk_reg_prcmu_opp_gate("bmlclk", core::ptr::null_mut(), PRCMU_BMLCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_HSITXCLK] =
    clk_reg_prcmu_scalable("hsitxclk", core::ptr::null_mut(), PRCMU_HSITXCLK, 0,
    CLK_SET_RATE_GATE);
    u8500_prcmu_hw_clks.hws[PRCMU_HSIRXCLK] =
    clk_reg_prcmu_scalable("hsirxclk", core::ptr::null_mut(), PRCMU_HSIRXCLK, 0,
    CLK_SET_RATE_GATE);
    u8500_prcmu_hw_clks.hws[PRCMU_HDMICLK] =
    clk_reg_prcmu_scalable("hdmiclk", core::ptr::null_mut(), PRCMU_HDMICLK, 0,
    CLK_SET_RATE_GATE);
    u8500_prcmu_hw_clks.hws[PRCMU_APEATCLK] =
    clk_reg_prcmu_gate("apeatclk", core::ptr::null_mut(), PRCMU_APEATCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_APETRACECLK] =
    clk_reg_prcmu_scalable("apetraceclk", core::ptr::null_mut(), PRCMU_APETRACECLK, 0,
    CLK_SET_RATE_GATE);
    u8500_prcmu_hw_clks.hws[PRCMU_MCDECLK] =
    clk_reg_prcmu_gate("mcdeclk", core::ptr::null_mut(), PRCMU_MCDECLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_IPI2CCLK] =
    clk_reg_prcmu_opp_gate("ipi2cclk", core::ptr::null_mut(), PRCMU_IPI2CCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_DSIALTCLK] =
    clk_reg_prcmu_gate("dsialtclk", core::ptr::null_mut(), PRCMU_DSIALTCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_DMACLK] =
    clk_reg_prcmu_gate("dmaclk", core::ptr::null_mut(), PRCMU_DMACLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_B2R2CLK] =
    clk_reg_prcmu_gate("b2r2clk", core::ptr::null_mut(), PRCMU_B2R2CLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_TVCLK] =
    clk_reg_prcmu_scalable("tvclk", core::ptr::null_mut(), PRCMU_TVCLK, 0,
    CLK_SET_RATE_GATE);
    u8500_prcmu_hw_clks.hws[PRCMU_SSPCLK] =
    clk_reg_prcmu_gate("sspclk", core::ptr::null_mut(), PRCMU_SSPCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_RNGCLK] =
    clk_reg_prcmu_gate("rngclk", core::ptr::null_mut(), PRCMU_RNGCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_UICCCLK] =
    clk_reg_prcmu_gate("uiccclk", core::ptr::null_mut(), PRCMU_UICCCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_TIMCLK] =
    clk_reg_prcmu_gate("timclk", core::ptr::null_mut(), PRCMU_TIMCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_SYSCLK] =
    clk_reg_prcmu_gate("ab8500_sysclk", core::ptr::null_mut(), PRCMU_SYSCLK, 0);
    u8500_prcmu_hw_clks.hws[PRCMU_SDMMCCLK] =
    clk_reg_prcmu_opp_volt_scalable("sdmmcclk", core::ptr::null_mut(),
    ...
    clk_reg_prcmu_scalable_rate("armss", core::ptr::null_mut(),
    PRCMU_ARMSS, 0, CLK_IGNORE_UNUSED);
    twd_clk = clk_register_fixed_factor(core::ptr::null_mut(), "smp_twd", "armss",
...
// Periph6
    ...
    of_clk_add_hw_provider(child, ux500_clkout_get, core::ptr::null_mut());
