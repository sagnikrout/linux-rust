...
//! Source: drivers/clk/clk-axm5516.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn axmclk_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    return devm_of_clk_add_hw_provider(dev, of_clk_axmclk_get, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn axmclk_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn axmclk_exit() -> void __exit {
