...
//! Source: drivers/clk/spear/clk-vco-pll.c
#![no_std]
...
pub const PLL_MODE_NORMAL: c_int = 0;
pub const PLL_MODE_FRACTION: c_int = 1;
pub const PLL_MODE_DITH_DSM: c_int = 2;
pub const PLL_MODE_DITH_SSM: c_int = 3;
pub const PLL_MODE_MASK: c_int = 3;
pub const PLL_MODE_SHIFT: c_int = 3;
pub const PLL_ENABLE: c_int = 2;
pub const PLL_LOCK_SHIFT: c_int = 0;
pub const PLL_LOCK_MASK: c_int = 1;
// PLL FRQ register masks
pub const PLL_NORM_FDBK_M_MASK: c_uint = 0xFF;
pub const PLL_NORM_FDBK_M_SHIFT: c_int = 24;
pub const PLL_DITH_FDBK_M_MASK: c_uint = 0xFFFF;
pub const PLL_DITH_FDBK_M_SHIFT: c_int = 16;
pub const PLL_DIV_P_MASK: c_uint = 0x7;
pub const PLL_DIV_P_SHIFT: c_int = 8;
pub const PLL_DIV_N_MASK: c_uint = 0xFF;
pub const PLL_DIV_N_SHIFT: c_int = 0;
...
// prate = vco_prev_rate;
    ...
    let mut i: c_int = 0;
    clk_pll_round_rate_index(hw, drate, core::ptr::null_mut(), &i);
    if (pll.vco.lock)
    spin_lock_irqsave(pll.vco.lock, flags);
    ...
    return pll_calc_rate(vco.rtbl, prate, index, core::ptr::null_mut());
    }
    ...
    struct clk_vco *vco = to_clk_vco(hw);
    let mut flags: c_ulong = 0;
    let mut num: c_uint = 2, den = 0, val, mode = 0;
    if (vco.lock)
...
// struct clk_vco assignments
    ...
    if (vco_gate_name) {
    tvco_gate_clk = clk_register_gate(core::ptr::null_mut(), vco_gate_name,
...
// vco_gate_clk = tvco_gate_clk;
    ...
    vco_clk = clk_register(core::ptr::null_mut(), &vco.hw);
    if (IS_ERR_OR_NULL(vco_clk))
    goto free_pll;
    tpll_clk = clk_register(core::ptr::null_mut(), &pll.hw);
