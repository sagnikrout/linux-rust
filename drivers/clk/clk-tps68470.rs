...
//! Source: drivers/clk/clk-tps68470.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tps68470_clk_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps68470_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps68470_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn tps68470_clk_recalc_rate(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn tps68470_clk_cfg_lookup(rate: c_ulong) -> c_uint {
    ...
    {
    let mut idx: c_uint = tps68470_clk_cfg_lookup(req.rate);
    ...
    {
    struct tps68470_clkdata *clkdata = to_tps68470_clkdata(hw);
    let mut idx: c_uint = tps68470_clk_cfg_lookup(rate);
...
#[no_mangle]
unsafe extern "C" fn tps68470_clk_probe(pdev: *mut platform_device) -> c_int {
...
// Set initial rate
    ...
    TPS68470_CLK_NAME, core::ptr::null_mut());
    if (ret)
    return ret;
    if (pdata) {
...
//
#[no_mangle]
unsafe extern "C" fn tps68470_clk_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps68470_clk_exit() -> void __exit {
