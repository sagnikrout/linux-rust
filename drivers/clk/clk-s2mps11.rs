...
//! Source: drivers/clk/clk-s2mps11.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2mps11_clk {
    pub iodev: *mut sec_pmic_dev,
    pub clk_np: *mut device_node,
    pub hw: clk_hw,
    pub clk: *mut clk,
...
#[no_mangle]
unsafe extern "C" fn s2mps11_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2mps11_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn s2mps11_clk_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2mps11_clk_probe(pdev: *mut platform_device) -> c_int {
    ...
    int i, ret = 0;
    let mut hwid: enum sec_device_type = platform_get_device_id(pdev).driver_data;
...
// Store clocks of_node in first element of s2mps11_clks array
    ...
    s2mps11_clks_init[i].name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn s2mps11_clk_remove(pdev: *mut platform_device) {
