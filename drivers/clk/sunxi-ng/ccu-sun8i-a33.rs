...
//! Source: drivers/clk/sunxi-ng/ccu-sun8i-a33.c
#![no_std]
...
//
pub const SUN8I_A33_PLL_AUDIO_REG: c_uint = 0x008;
...
//
pub const SUN8I_A33_PLL_MIPI_REG: c_uint = 0x040;
...
#[no_mangle]
unsafe extern "C" fn sun8i_a33_ccu_probe(pdev: *mut platform_device) -> c_int {
