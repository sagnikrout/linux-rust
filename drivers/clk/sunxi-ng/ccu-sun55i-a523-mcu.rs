...
//! Source: drivers/clk/sunxi-ng/ccu-sun55i-a523-mcu.c
#![no_std]
...
pub const SUN55I_A523_PLL_AUDIO1_REG: c_uint = 0x00c;
...
#[no_mangle]
unsafe extern "C" fn sun55i_a523_mcu_ccu_probe(pdev: *mut platform_device) -> c_int {
