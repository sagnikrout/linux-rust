...
//! Source: drivers/clk/sunxi-ng/ccu-sun55i-a523.c
#![no_std]
...
pub const SUN55I_A523_PLL_DDR0_REG: c_uint = 0x010;
...
//
pub const SUN55I_A523_PLL_PERIPH0_REG: c_uint = 0x020;
...
pub const SUN55I_A523_PLL_PERIPH1_REG: c_uint = 0x028;
...
pub const SUN55I_A523_PLL_GPU_REG: c_uint = 0x030;
...
pub const SUN55I_A523_PLL_VIDEO0_REG: c_uint = 0x040;
...
pub const SUN55I_A523_PLL_VIDEO1_REG: c_uint = 0x048;
...
pub const SUN55I_A523_PLL_VIDEO2_REG: c_uint = 0x050;
...
pub const SUN55I_A523_PLL_VE_REG: c_uint = 0x058;
...
pub const SUN55I_A523_PLL_VIDEO3_REG: c_uint = 0x068;
...
//
pub const SUN55I_A523_PLL_AUDIO0_REG: c_uint = 0x078;
...
pub const SUN55I_A523_PLL_NPU_REG: c_uint = 0x080;
...
#[no_mangle]
unsafe extern "C" fn sun55i_a523_ccu_probe(pdev: *mut platform_device) -> c_int {
