...
//! Source: drivers/clk/clk-hi655x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hi655x_clk_enable(hw: *mut clk_hw, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi655x_clk_prepare(hw: *mut clk_hw) -> c_int {
    static int hi655x_clk_prepare(struct clk_hw *hw)
    {
    return hi655x_clk_enable(hw, true);
    }
#[no_mangle]
unsafe extern "C" fn hi655x_clk_unprepare(hw: *mut clk_hw) {
    static void hi655x_clk_unprepare(struct clk_hw *hw)
    {
    hi655x_clk_enable(hw, false);
    }
#[no_mangle]
unsafe extern "C" fn hi655x_clk_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi655x_clk_probe(pdev: *mut platform_device) -> c_int {
