...
//! Source: drivers/clk/meson/c3-peripherals.c
#![no_std]
...
pub const RTC_BY_OSCIN_CTRL0: c_uint = 0x8;
pub const RTC_BY_OSCIN_CTRL1: c_uint = 0xc;
pub const RTC_CTRL: c_uint = 0x10;
pub const SYS_CLK_EN0_REG0: c_uint = 0x44;
pub const SYS_CLK_EN0_REG1: c_uint = 0x48;
pub const SYS_CLK_EN0_REG2: c_uint = 0x4c;
pub const CLK12_24_CTRL: c_uint = 0xa8;
pub const AXI_CLK_EN0: c_uint = 0xac;
pub const VDIN_MEAS_CLK_CTRL: c_uint = 0xf8;
pub const VAPB_CLK_CTRL: c_uint = 0xfc;
pub const MIPIDSI_PHY_CLK_CTRL: c_uint = 0x104;
pub const GE2D_CLK_CTRL: c_uint = 0x10c;
pub const ISP0_CLK_CTRL: c_uint = 0x110;
pub const DEWARPA_CLK_CTRL: c_uint = 0x114;
pub const VOUTENC_CLK_CTRL: c_uint = 0x118;
pub const VDEC_CLK_CTRL: c_uint = 0x140;
pub const VDEC3_CLK_CTRL: c_uint = 0x148;
pub const TS_CLK_CTRL: c_uint = 0x158;
pub const ETH_CLK_CTRL: c_uint = 0x164;
pub const NAND_CLK_CTRL: c_uint = 0x168;
pub const SD_EMMC_CLK_CTRL: c_uint = 0x16c;
pub const SPICC_CLK_CTRL: c_uint = 0x174;
pub const GEN_CLK_CTRL: c_uint = 0x178;
pub const SAR_CLK_CTRL0: c_uint = 0x17c;
pub const PWM_CLK_AB_CTRL: c_uint = 0x180;
pub const PWM_CLK_CD_CTRL: c_uint = 0x184;
pub const PWM_CLK_EF_CTRL: c_uint = 0x188;
pub const PWM_CLK_GH_CTRL: c_uint = 0x18c;
pub const PWM_CLK_IJ_CTRL: c_uint = 0x190;
pub const PWM_CLK_KL_CTRL: c_uint = 0x194;
pub const PWM_CLK_MN_CTRL: c_uint = 0x198;
pub const VC9000E_CLK_CTRL: c_uint = 0x19c;
pub const SPIFC_CLK_CTRL: c_uint = 0x1a0;
pub const NNA_CLK_CTRL: c_uint = 0x220;

    MESON_COMP_SEL(c3_, _name, _reg, _shift, _mask, _pdata, core::ptr::null_mut(), 0, 0)
    ...
    let mut c3_sys_pclk_parents: static struct clk_parent_data = { .fw_name = "sysclk" };
...
//
    ...
    let mut c3_axi_pclk_parents: static struct clk_parent_data = { .fw_name = "axiclk" };
