...
//! Source: drivers/clk/meson/a9-peripherals.c
#![no_std]
...
pub const SYS_CLK_EN0_REG0: c_uint = 0x30;
pub const SYS_CLK_EN0_REG1: c_uint = 0x34;
pub const SYS_CLK_EN0_REG2: c_uint = 0x38;
pub const SYS_CLK_EN0_REG3: c_uint = 0x3c;
pub const SD_EMMC_CLK_CTRL0: c_uint = 0x90;
pub const SD_EMMC_CLK_CTRL1: c_uint = 0x94;
pub const PWM_CLK_H_CTRL: c_uint = 0xbc;
pub const PWM_CLK_I_CTRL: c_uint = 0xc0;
pub const PWM_CLK_J_CTRL: c_uint = 0xc4;
pub const PWM_CLK_K_CTRL: c_uint = 0xc8;
pub const PWM_CLK_L_CTRL: c_uint = 0xcc;
pub const PWM_CLK_M_CTRL: c_uint = 0xd0;
pub const PWM_CLK_N_CTRL: c_uint = 0xd4;
pub const SPISG_CLK_CTRL: c_uint = 0x100;
pub const SPISG_CLK_CTRL1: c_uint = 0x104;
pub const SAR_CLK_CTRL: c_uint = 0x150;
pub const AMFC_CLK_CTRL: c_uint = 0x154;
pub const NNA_CLK_CTRL: c_uint = 0x15c;
pub const USB_CLK_CTRL: c_uint = 0x160;
pub const PCIE_TL_CLK_CTRL: c_uint = 0x164;
pub const CMPR_CLK_CTRL: c_uint = 0x168;
pub const DEWARP_CLK_CTRL: c_uint = 0x16c;
pub const SC_CLK_CTRL: c_uint = 0x170;
pub const DPTX_CLK_CTRL: c_uint = 0x178;
pub const ISP_CLK_CTRL: c_uint = 0x17c;
pub const CVE_CLK_CTRL: c_uint = 0x180;
pub const PP_CLK_CTRL: c_uint = 0x184;
pub const GLB_CLK_CTRL: c_uint = 0x188;
pub const USB_CLK_CTRL0: c_uint = 0x18c;
pub const USB_CLK_CTRL1: c_uint = 0x190;
pub const CAN_CLK_CTRL: c_uint = 0x194;
pub const CAN_CLK_CTRL1: c_uint = 0x198;
pub const I3C_CLK_CTRL: c_uint = 0x19c;
pub const TS_CLK_CTRL: c_uint = 0x1a0;
pub const ETH_CLK_CTRL: c_uint = 0x1a4;
pub const GEN_CLK_CTRL: c_uint = 0x1a8;
pub const CLK12_24_CTRL: c_uint = 0x1ac;
pub const MALI_CLK_CTRL: c_uint = 0x200;
pub const MALI_STACK_CLK_CTRL: c_uint = 0x204;
pub const DSPA_CLK_CTRL: c_uint = 0x220;
pub const HEVCF_CLK_CTRL: c_uint = 0x240;
pub const HCODEC_CLK_CTRL: c_uint = 0x244;
pub const VPU_CLK_CTRL: c_uint = 0x260;
pub const VAPB_CLK_CTRL: c_uint = 0x268;
pub const VPU_CLKB_CTRL: c_uint = 0x280;
pub const HDMI_CLK_CTRL: c_uint = 0x284;
pub const HTX_CLK_CTRL: c_uint = 0x28c;
pub const HTX_CLK_CTRL1: c_uint = 0x290;
pub const HRX_CLK_CTRL: c_uint = 0x294;
pub const HRX_CLK_CTRL1: c_uint = 0x298;
pub const HRX_CLK_CTRL2: c_uint = 0x29c;
pub const HRX_CLK_CTRL3: c_uint = 0x2a0;
pub const VID_LOCK_CLK_CTRL: c_uint = 0x2a4;
pub const VDIN_MEAS_CLK_CTRL: c_uint = 0x2a8;
pub const VID_PLL_CLK_DIV: c_uint = 0x2b0;
pub const VID_CLK_CTRL: c_uint = 0x2c0;
pub const VID_CLK_CTRL2: c_uint = 0x2c4;
pub const VID_CLK_DIV: c_uint = 0x2c8;
pub const VIID_CLK_DIV: c_uint = 0x2cc;
pub const VIID_CLK_CTRL: c_uint = 0x2d0;
pub const MIPI_CSI_PHY_CLK_CTRL: c_uint = 0x2e0;
pub const DSI_MEAS_CLK_CTRL: c_uint = 0x2f4;
    ...
    let mut a9_sys_pclk_parents: static struct clk_parent_data = { .fw_name = "sys" };
...
// Channel 5 is unconnected.
    ...
    static A9_COMP_SEL(pwm_h, PWM_CLK_H_CTRL, 9, 0x7, a9_pwm_parents, core::ptr::null_mut());
    static A9_COMP_DIV(pwm_h, PWM_CLK_H_CTRL, 0, 8);
    static A9_COMP_GATE(pwm_h, PWM_CLK_H_CTRL, 8, 0);
    static A9_COMP_SEL(pwm_i, PWM_CLK_I_CTRL, 9, 0x7, a9_pwm_parents, core::ptr::null_mut());
    static A9_COMP_DIV(pwm_i, PWM_CLK_I_CTRL, 0, 8);
    static A9_COMP_GATE(pwm_i, PWM_CLK_I_CTRL, 8, 0);
    static A9_COMP_SEL(pwm_j, PWM_CLK_J_CTRL, 9, 0x7, a9_pwm_parents, core::ptr::null_mut());
    static A9_COMP_DIV(pwm_j, PWM_CLK_J_CTRL, 0, 8);
    static A9_COMP_GATE(pwm_j, PWM_CLK_J_CTRL, 8, 0);
    static A9_COMP_SEL(pwm_k, PWM_CLK_K_CTRL, 9, 0x7, a9_pwm_parents, core::ptr::null_mut());
    static A9_COMP_DIV(pwm_k, PWM_CLK_K_CTRL, 0, 8);
    static A9_COMP_GATE(pwm_k, PWM_CLK_K_CTRL, 8, 0);
    static A9_COMP_SEL(pwm_l, PWM_CLK_L_CTRL, 9, 0x7, a9_pwm_parents, core::ptr::null_mut());
    static A9_COMP_DIV(pwm_l, PWM_CLK_L_CTRL, 0, 8);
    static A9_COMP_GATE(pwm_l, PWM_CLK_L_CTRL, 8, 0);
    static A9_COMP_SEL(pwm_m, PWM_CLK_M_CTRL, 9, 0x7, a9_pwm_parents, core::ptr::null_mut());
    static A9_COMP_DIV(pwm_m, PWM_CLK_M_CTRL, 0, 8);
    static A9_COMP_GATE(pwm_m, PWM_CLK_M_CTRL, 8, 0);
    static A9_COMP_SEL(pwm_n, PWM_CLK_N_CTRL, 9, 0x7, a9_pwm_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(spisg0, SPISG_CLK_CTRL, 9, 0x7, a9_spisg_parents, core::ptr::null_mut());
    static A9_COMP_DIV(spisg0, SPISG_CLK_CTRL, 0, 6);
    static A9_COMP_GATE(spisg0, SPISG_CLK_CTRL, 8, 0);
    static A9_COMP_SEL(spisg1, SPISG_CLK_CTRL, 25, 0x7, a9_spisg_parents, core::ptr::null_mut());
    static A9_COMP_DIV(spisg1, SPISG_CLK_CTRL, 16, 6);
    static A9_COMP_GATE(spisg1, SPISG_CLK_CTRL, 24, 0);
    static A9_COMP_SEL(spisg2, SPISG_CLK_CTRL1, 9, 0x7, a9_spisg_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(saradc, SAR_CLK_CTRL, 9, 0x7, a9_saradc_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(amfc, AMFC_CLK_CTRL, 9, 0x7, a9_amfc_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(nna, NNA_CLK_CTRL, 9, 0x7, a9_nna_parents, core::ptr::null_mut());
...
// Channel 5 and 6 are unconnected.
    ...
    static A9_COMP_SEL(usb_48m_pre, USB_CLK_CTRL, 25, 0x3, a9_usb_48m_pre_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(pcie0_tl, PCIE_TL_CLK_CTRL, 9, 0x7, a9_pcie_tl_parents, core::ptr::null_mut());
    static A9_COMP_DIV(pcie0_tl, PCIE_TL_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(pcie0_tl, PCIE_TL_CLK_CTRL, 8, 0);
    static A9_COMP_SEL(pcie1_tl, PCIE_TL_CLK_CTRL, 25, 0x7, a9_pcie_tl_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(cmpr, CMPR_CLK_CTRL, 25, 0x7, a9_cmpr_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(dewarpa, DEWARP_CLK_CTRL, 9, 0x7, a9_dewarpa_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(sc_pre, SC_CLK_CTRL, 9, 0x7, a9_sc_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(dptx_apb2, DPTX_CLK_CTRL, 9, 0x7, a9_dptx_apb2_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(dptx_aud, DPTX_CLK_CTRL, 25, 0x7, a9_dptx_aud_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(isp, ISP_CLK_CTRL, 9, 0x7, a9_isp_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(cve, CVE_CLK_CTRL, 9, 0x7, a9_cve_vge_parents, core::ptr::null_mut());
    static A9_COMP_DIV(cve, CVE_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(cve, CVE_CLK_CTRL, 8, 0);
    static A9_COMP_SEL(vge, CVE_CLK_CTRL, 25, 0x7, a9_cve_vge_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(pp, PP_CLK_CTRL, 9, 0x7, a9_pp_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(dspa_0, DSPA_CLK_CTRL, 9, 0x7, a9_dspa_parents, core::ptr::null_mut());
    static A9_COMP_DIV(dspa_0, DSPA_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(dspa_0, DSPA_CLK_CTRL, 8, CLK_SET_RATE_GATE);
    static A9_COMP_SEL(dspa_1, DSPA_CLK_CTRL, 25, 0x7, a9_dspa_parents, core::ptr::null_mut());
...
// Channel 2 is unconnected.
    ...
    static A9_COMP_SEL(can0_filter, CAN_CLK_CTRL1, 9, 0x7, a9_can_filter_parents, core::ptr::null_mut());
    static A9_COMP_DIV(can0_filter, CAN_CLK_CTRL1, 0, 7);
    static A9_COMP_GATE(can0_filter, CAN_CLK_CTRL1, 8, 0);
    static A9_COMP_SEL(can1_filter, CAN_CLK_CTRL1, 25, 0x7, a9_can_filter_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(i3c, I3C_CLK_CTRL, 9, 0x7, a9_i3c_parents, core::ptr::null_mut());
...
//
    ...
    static A9_COMP_SEL(mali_0, MALI_CLK_CTRL, 9, 0x7, a9_mali_parents, core::ptr::null_mut());
    static A9_COMP_DIV(mali_0, MALI_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(mali_0, MALI_CLK_CTRL, 8, CLK_SET_RATE_GATE);
    static A9_COMP_SEL(mali_1, MALI_CLK_CTRL, 25, 0x7, a9_mali_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(mali_stack_0, MALI_STACK_CLK_CTRL, 9, 0x7, a9_mali_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(mali_stack_1, MALI_STACK_CLK_CTRL, 25, 0x7, a9_mali_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(hevcf_0, HEVCF_CLK_CTRL, 9, 0x7, a9_hevcf_parents, core::ptr::null_mut());
    static A9_COMP_DIV(hevcf_0, HEVCF_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(hevcf_0, HEVCF_CLK_CTRL, 8, CLK_SET_RATE_GATE);
    static A9_COMP_SEL(hevcf_1, HEVCF_CLK_CTRL, 25, 0x7, a9_hevcf_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(hcodec_0, HCODEC_CLK_CTRL, 9, 0x7, a9_hcodec_parents, core::ptr::null_mut());
    static A9_COMP_DIV(hcodec_0, HCODEC_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(hcodec_0, HCODEC_CLK_CTRL, 8, CLK_SET_RATE_GATE);
    static A9_COMP_SEL(hcodec_1, HCODEC_CLK_CTRL, 25, 0x7, a9_hcodec_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(vpu_0, VPU_CLK_CTRL, 9, 0x7, a9_vpu_parents, core::ptr::null_mut());
    static A9_COMP_DIV(vpu_0, VPU_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(vpu_0, VPU_CLK_CTRL, 8, CLK_SET_RATE_GATE);
    static A9_COMP_SEL(vpu_1, VPU_CLK_CTRL, 25, 0x7, a9_vpu_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(vapb_0, VAPB_CLK_CTRL, 9, 0x7, a9_vapb_parents, core::ptr::null_mut());
    static A9_COMP_DIV(vapb_0, VAPB_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(vapb_0, VAPB_CLK_CTRL, 8, CLK_SET_RATE_GATE);
    static A9_COMP_SEL(vapb_1, VAPB_CLK_CTRL, 25, 0x7, a9_vapb_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(vpu_clkb_tmp, VPU_CLKB_CTRL, 25, 0x7, a9_vpu_clkb_tmp_parents, core::ptr::null_mut());
...
// Channel 5, 6 and 7 are unconnected
    ...
    static A9_COMP_SEL(vid_lock, VID_LOCK_CLK_CTRL, 9, 0x7, a9_vid_lock_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(vdin_meas, VDIN_MEAS_CLK_CTRL, 9, 0x7, a9_vdin_meas_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(csi_phy, MIPI_CSI_PHY_CLK_CTRL, 9, 0x7, a9_csi_phy_parents, core::ptr::null_mut());
    ...
    static A9_COMP_SEL(dsi0_meas, DSI_MEAS_CLK_CTRL, 9, 0x7, a9_dsi_meas_parents, core::ptr::null_mut());
    static A9_COMP_DIV(dsi0_meas, DSI_MEAS_CLK_CTRL, 0, 7);
    static A9_COMP_GATE(dsi0_meas, DSI_MEAS_CLK_CTRL, 8, 0);
    static A9_COMP_SEL(dsi1_meas, DSI_MEAS_CLK_CTRL, 25, 0x7, a9_dsi_meas_parents, core::ptr::null_mut());
