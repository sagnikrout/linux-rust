...
//! Source: drivers/clk/meson/meson8b.c
#![no_std]
...
//
pub const HHI_GP_PLL_CNTL: c_uint = 0x40;
pub const HHI_GP_PLL_CNTL2: c_uint = 0x44;
pub const HHI_GP_PLL_CNTL3: c_uint = 0x48;
pub const HHI_GP_PLL_CNTL4: c_uint = 0x4C;
pub const HHI_GP_PLL_CNTL5: c_uint = 0x50;
...
pub const HHI_VID_DIVIDER_CNTL: c_uint = 0x198;
...
pub const HHI_VID_PLL_CNTL: c_uint = 0x320;
pub const HHI_VID_PLL_CNTL2: c_uint = 0x324;
pub const HHI_VID_PLL_CNTL3: c_uint = 0x328;
pub const HHI_VID_PLL_CNTL4: c_uint = 0x32c;
pub const HHI_VID_PLL_CNTL5: c_uint = 0x330;
pub const HHI_VID_PLL_CNTL6: c_uint = 0x334;
pub const HHI_VID2_PLL_CNTL: c_uint = 0x380;
pub const HHI_VID2_PLL_CNTL2: c_uint = 0x384;
pub const HHI_VID2_PLL_CNTL3: c_uint = 0x388;
pub const HHI_VID2_PLL_CNTL4: c_uint = 0x38c;
pub const HHI_VID2_PLL_CNTL5: c_uint = 0x390;
pub const HHI_VID2_PLL_CNTL6: c_uint = 0x394;
//
...
//
    ...
    let mut meson8b_pclk_parents: static struct clk_parent_data = { .hw = &meson8b_clk81.hw };
...
// AIU gates
    let mut meson8b_aiu_glue_parents: static struct clk_parent_data = { .hw = &meson8b_aiu.hw };
    static MESON_PCLK(meson8b_aiu_glue, HHI_GCLK_MPEG1, 6,
    &meson8b_aiu_glue_parents, CLK_IGNORE_UNUSED);
    let mut meson8b_aiu_pclk_parents: static struct clk_parent_data = { .hw = &meson8b_aiu_glue.hw };
...
#[no_mangle]
unsafe extern "C" fn meson8_clkc_init(np: *mut device_node) -> void __init {
    static void __init meson8_clkc_init(struct device_node *np)
    {
    return meson8b_clkc_init_common(np, &meson8_clks);
    }
#[no_mangle]
unsafe extern "C" fn meson8b_clkc_init(np: *mut device_node) -> void __init {
    static void __init meson8b_clkc_init(struct device_node *np)
    {
    return meson8b_clkc_init_common(np, &meson8b_clks);
    }
#[no_mangle]
unsafe extern "C" fn meson8m2_clkc_init(np: *mut device_node) -> void __init {
