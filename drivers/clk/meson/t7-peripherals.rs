...
//! Source: drivers/clk/meson/t7-peripherals.c
#![no_std]
...
pub const SYS_CLK_CTRL0: c_uint = 0x40;
pub const SYS_CLK_EN0_REG0: c_uint = 0x44;
pub const SYS_CLK_EN0_REG1: c_uint = 0x48;
pub const SYS_CLK_EN0_REG2: c_uint = 0x4c;
pub const SYS_CLK_EN0_REG3: c_uint = 0x50;
pub const CECA_CTRL0: c_uint = 0x88;
pub const CECA_CTRL1: c_uint = 0x8c;
pub const CECB_CTRL0: c_uint = 0x90;
pub const CECB_CTRL1: c_uint = 0x94;
pub const SC_CLK_CTRL: c_uint = 0x98;
pub const DSPA_CLK_CTRL0: c_uint = 0x9c;
pub const DSPB_CLK_CTRL0: c_uint = 0xa0;
pub const CLK12_24_CTRL: c_uint = 0xa8;
pub const ANAKIN_CLK_CTRL: c_uint = 0xac;
pub const MIPI_CSI_PHY_CLK_CTRL: c_uint = 0x10c;
pub const MIPI_ISP_CLK_CTRL: c_uint = 0x110;
pub const TS_CLK_CTRL: c_uint = 0x158;
pub const MALI_CLK_CTRL: c_uint = 0x15c;
...
pub const PWM_CLK_AO_AB_CTRL: c_uint = 0x1a0;
pub const PWM_CLK_AO_CD_CTRL: c_uint = 0x1a4;
pub const PWM_CLK_AO_EF_CTRL: c_uint = 0x1a8;
pub const PWM_CLK_AO_GH_CTRL: c_uint = 0x1ac;
pub const SPICC_CLK_CTRL1: c_uint = 0x1c0;
pub const SPICC_CLK_CTRL2: c_uint = 0x1c4;

    MESON_COMP_SEL(t7_, _name, _reg, _shift, _mask, _pdata, core::ptr::null_mut(), 0, 0)
...
//
    ...
    let mut t7_sys_pclk_parents: static struct clk_parent_data = { .fw_name = "sys" };
