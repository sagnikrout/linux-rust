...
//! Source: drivers/clk/meson/a1-peripherals.c
#![no_std]
...
pub const SYS_OSCIN_CTRL: c_uint = 0x0;
pub const RTC_BY_OSCIN_CTRL0: c_uint = 0x4;
pub const RTC_BY_OSCIN_CTRL1: c_uint = 0x8;
pub const RTC_CTRL: c_uint = 0xc;
pub const SYS_CLK_CTRL0: c_uint = 0x10;
pub const SYS_CLK_EN0: c_uint = 0x1c;
pub const SYS_CLK_EN1: c_uint = 0x20;
pub const AXI_CLK_EN: c_uint = 0x24;
pub const DSPA_CLK_EN: c_uint = 0x28;
pub const DSPB_CLK_EN: c_uint = 0x2c;
pub const DSPA_CLK_CTRL0: c_uint = 0x30;
pub const DSPB_CLK_CTRL0: c_uint = 0x34;
pub const CLK12_24_CTRL: c_uint = 0x38;
pub const GEN_CLK_CTRL: c_uint = 0x3c;
pub const SAR_ADC_CLK_CTRL: c_uint = 0xc0;
pub const PWM_CLK_AB_CTRL: c_uint = 0xc4;
pub const PWM_CLK_CD_CTRL: c_uint = 0xc8;
pub const PWM_CLK_EF_CTRL: c_uint = 0xcc;
pub const SPICC_CLK_CTRL: c_uint = 0xd0;
pub const TS_CLK_CTRL: c_uint = 0xd4;
pub const SPIFC_CLK_CTRL: c_uint = 0xd8;
pub const USB_BUSCLK_CTRL: c_uint = 0xdc;
pub const SD_EMMC_CLK_CTRL: c_uint = 0xe0;
pub const CECA_CLK_CTRL0: c_uint = 0xe4;
pub const CECA_CLK_CTRL1: c_uint = 0xe8;
pub const CECB_CLK_CTRL0: c_uint = 0xec;
pub const CECB_CLK_CTRL1: c_uint = 0xf0;
pub const PSRAM_CLK_CTRL: c_uint = 0xf4;
pub const DMC_CLK_CTRL: c_uint = 0xf8;
...
//
    ...
    let mut a1_pclk_parents: static struct clk_parent_data = { .hw = &a1_sys.hw };
