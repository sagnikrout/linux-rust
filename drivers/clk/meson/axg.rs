...
//! Source: drivers/clk/meson/axg.c
#![no_std]
...
pub const HHI_GP0_PLL_STS: c_uint = 0x54;
pub const HHI_GP0_PLL_CNTL1: c_uint = 0x58;
pub const HHI_HIFI_PLL_CNTL: c_uint = 0x80;
pub const HHI_HIFI_PLL_CNTL2: c_uint = 0x84;
pub const HHI_HIFI_PLL_CNTL3: c_uint = 0x88;
pub const HHI_HIFI_PLL_CNTL4: c_uint = 0x8C;
pub const HHI_HIFI_PLL_CNTL5: c_uint = 0x90;
pub const HHI_HIFI_PLL_STS: c_uint = 0x94;
pub const HHI_HIFI_PLL_CNTL1: c_uint = 0x98;
pub const HHI_XTAL_DIVN_CNTL: c_uint = 0xbc;
pub const HHI_GCLK2_MPEG0: c_uint = 0xc0;
pub const HHI_GCLK2_MPEG1: c_uint = 0xc4;
pub const HHI_GCLK2_MPEG2: c_uint = 0xc8;
pub const HHI_GCLK2_OTHER: c_uint = 0xd0;
pub const HHI_GCLK2_AO: c_uint = 0xd4;
pub const HHI_PCIE_PLL_CNTL: c_uint = 0xd8;
pub const HHI_PCIE_PLL_CNTL1: c_uint = 0xdC;
pub const HHI_PCIE_PLL_CNTL2: c_uint = 0xe0;
pub const HHI_PCIE_PLL_CNTL3: c_uint = 0xe4;
pub const HHI_PCIE_PLL_CNTL4: c_uint = 0xe8;
pub const HHI_PCIE_PLL_CNTL5: c_uint = 0xec;
pub const HHI_PCIE_PLL_CNTL6: c_uint = 0xf0;
pub const HHI_PCIE_PLL_STS: c_uint = 0xf4;
pub const HHI_MEM_PD_REG0: c_uint = 0x100;
pub const HHI_VPU_MEM_PD_REG0: c_uint = 0x104;
...
pub const HHI_SPICC_HCLK_CNTL: c_uint = 0x168;
...
pub const HHI_PLL_TOP_MISC: c_uint = 0x2E8;
pub const HHI_SYS_PLL_CNTL1: c_uint = 0x2FC;
...
pub const HHI_SYS_PLL_STS: c_uint = 0x314;
...
//
    ...
    let mut axg_pclk_parents: static struct clk_parent_data = { .hw = &axg_clk81.hw };
