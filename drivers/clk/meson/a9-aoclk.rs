...
//! Source: drivers/clk/meson/a9-aoclk.c
#![no_std]
...
pub const AO_OSCIN_CTRL: c_uint = 0x00;
pub const AO_SYS_CLK0: c_uint = 0x04;
pub const AO_PWM_CLK_A_CTRL: c_uint = 0x1c;
pub const AO_PWM_CLK_B_CTRL: c_uint = 0x20;
pub const AO_PWM_CLK_C_CTRL: c_uint = 0x24;
pub const AO_PWM_CLK_D_CTRL: c_uint = 0x28;
pub const AO_PWM_CLK_E_CTRL: c_uint = 0x2c;
pub const AO_PWM_CLK_F_CTRL: c_uint = 0x30;
pub const AO_PWM_CLK_G_CTRL: c_uint = 0x34;
pub const AO_CEC_CTRL0: c_uint = 0x38;
pub const AO_CEC_CTRL1: c_uint = 0x3c;
pub const AO_RTC_BY_OSCIN_CTRL0: c_uint = 0x50;
pub const AO_RTC_BY_OSCIN_CTRL1: c_uint = 0x54;

    MESON_COMP_SEL(a9_ao_, _name, _reg, _shift, _mask, _pdata, core::ptr::null_mut(), 0, 0)
...
// ext_32k is from external PAD, do not automatically reparent
    ...
    let mut a9_ao_pclk_parents: static struct clk_parent_data = { .hw = &a9_ao_sys.hw };
