...
//! Source: drivers/clk/meson/s4-peripherals.c
#![no_std]
...
pub const CLKCTRL_RTC_BY_OSCIN_CTRL0: c_uint = 0x008;
pub const CLKCTRL_RTC_BY_OSCIN_CTRL1: c_uint = 0x00c;
pub const CLKCTRL_RTC_CTRL: c_uint = 0x010;
pub const CLKCTRL_SYS_CLK_CTRL0: c_uint = 0x040;
pub const CLKCTRL_SYS_CLK_EN0_REG0: c_uint = 0x044;
pub const CLKCTRL_SYS_CLK_EN0_REG1: c_uint = 0x048;
pub const CLKCTRL_SYS_CLK_EN0_REG2: c_uint = 0x04c;
pub const CLKCTRL_SYS_CLK_EN0_REG3: c_uint = 0x050;
pub const CLKCTRL_CECA_CTRL0: c_uint = 0x088;
pub const CLKCTRL_CECA_CTRL1: c_uint = 0x08c;
pub const CLKCTRL_CECB_CTRL0: c_uint = 0x090;
pub const CLKCTRL_CECB_CTRL1: c_uint = 0x094;
pub const CLKCTRL_SC_CLK_CTRL: c_uint = 0x098;
pub const CLKCTRL_CLK12_24_CTRL: c_uint = 0x0a8;
pub const CLKCTRL_VID_CLK_CTRL: c_uint = 0x0c0;
pub const CLKCTRL_VID_CLK_CTRL2: c_uint = 0x0c4;
pub const CLKCTRL_VID_CLK_DIV: c_uint = 0x0c8;
pub const CLKCTRL_VIID_CLK_DIV: c_uint = 0x0cc;
pub const CLKCTRL_VIID_CLK_CTRL: c_uint = 0x0d0;
pub const CLKCTRL_HDMI_CLK_CTRL: c_uint = 0x0e0;
pub const CLKCTRL_VID_PLL_CLK_DIV: c_uint = 0x0e4;
pub const CLKCTRL_VPU_CLK_CTRL: c_uint = 0x0e8;
pub const CLKCTRL_VPU_CLKB_CTRL: c_uint = 0x0ec;
pub const CLKCTRL_VPU_CLKC_CTRL: c_uint = 0x0f0;
pub const CLKCTRL_VID_LOCK_CLK_CTRL: c_uint = 0x0f4;
pub const CLKCTRL_VDIN_MEAS_CLK_CTRL: c_uint = 0x0f8;
pub const CLKCTRL_VAPBCLK_CTRL: c_uint = 0x0fc;
pub const CLKCTRL_HDCP22_CTRL: c_uint = 0x100;
pub const CLKCTRL_CDAC_CLK_CTRL: c_uint = 0x108;
pub const CLKCTRL_VDEC_CLK_CTRL: c_uint = 0x140;
pub const CLKCTRL_VDEC2_CLK_CTRL: c_uint = 0x144;
pub const CLKCTRL_VDEC3_CLK_CTRL: c_uint = 0x148;
pub const CLKCTRL_VDEC4_CLK_CTRL: c_uint = 0x14c;
pub const CLKCTRL_TS_CLK_CTRL: c_uint = 0x158;
pub const CLKCTRL_MALI_CLK_CTRL: c_uint = 0x15c;
pub const CLKCTRL_NAND_CLK_CTRL: c_uint = 0x168;
pub const CLKCTRL_SD_EMMC_CLK_CTRL: c_uint = 0x16c;
pub const CLKCTRL_SPICC_CLK_CTRL: c_uint = 0x174;
pub const CLKCTRL_GEN_CLK_CTRL: c_uint = 0x178;
pub const CLKCTRL_SAR_CLK_CTRL: c_uint = 0x17c;
pub const CLKCTRL_PWM_CLK_AB_CTRL: c_uint = 0x180;
pub const CLKCTRL_PWM_CLK_CD_CTRL: c_uint = 0x184;
pub const CLKCTRL_PWM_CLK_EF_CTRL: c_uint = 0x188;
pub const CLKCTRL_PWM_CLK_GH_CTRL: c_uint = 0x18c;
pub const CLKCTRL_PWM_CLK_IJ_CTRL: c_uint = 0x190;
pub const CLKCTRL_DEMOD_CLK_CTRL: c_uint = 0x200;

    MESON_COMP_SEL(s4_, _name, _reg, _shift, _mask, _pdata, core::ptr::null_mut(), 0, 0)
...
// CVBS ADC
    ...
    let mut s4_pclk_parents: static struct clk_parent_data = { .hw = &s4_sys_clk.hw };
