...
//! Source: drivers/clk/meson/a1-pll.c
#![no_std]
...
pub const ANACTRL_FIXPLL_CTRL0: c_uint = 0x0;
pub const ANACTRL_FIXPLL_CTRL1: c_uint = 0x4;
pub const ANACTRL_FIXPLL_STS: c_uint = 0x14;
pub const ANACTRL_HIFIPLL_CTRL0: c_uint = 0xc0;
pub const ANACTRL_HIFIPLL_CTRL1: c_uint = 0xc4;
pub const ANACTRL_HIFIPLL_CTRL2: c_uint = 0xc8;
pub const ANACTRL_HIFIPLL_CTRL3: c_uint = 0xcc;
pub const ANACTRL_HIFIPLL_CTRL4: c_uint = 0xd0;
pub const ANACTRL_HIFIPLL_STS: c_uint = 0xd4;
