...
//! Source: drivers/clk/meson/g12a-aoclk.c
#![no_std]
...
//
pub const AO_RTI_STATUS_REG3: c_uint = 0x0C;
pub const AO_RTI_PWR_CNTL_REG0: c_uint = 0x10;
pub const AO_RTI_GEN_CNTL_REG0: c_uint = 0x40;
pub const AO_CLK_GATE0: c_uint = 0x4c;
pub const AO_CLK_GATE0_SP: c_uint = 0x50;
pub const AO_OSCIN_CNTL: c_uint = 0x58;
pub const AO_CEC_CLK_CNTL_REG0: c_uint = 0x74;
pub const AO_CEC_CLK_CNTL_REG1: c_uint = 0x78;
pub const AO_SAR_CLK: c_uint = 0x90;
pub const AO_RTC_ALT_CLK_CNTL0: c_uint = 0x94;
pub const AO_RTC_ALT_CLK_CNTL1: c_uint = 0x98;
    let mut g12a_ao_pclk_parents: static struct clk_parent_data = { .fw_name = "mpeg-clk" };
