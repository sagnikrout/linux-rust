...
//! Source: drivers/clk/meson/axg-audio.c
#![no_std]
...
pub const AUDIO_CLK_GATE_EN: c_uint = 0x000;
pub const AUDIO_MCLK_A_CTRL: c_uint = 0x004;
pub const AUDIO_MCLK_B_CTRL: c_uint = 0x008;
pub const AUDIO_MCLK_C_CTRL: c_uint = 0x00C;
pub const AUDIO_MCLK_D_CTRL: c_uint = 0x010;
pub const AUDIO_MCLK_E_CTRL: c_uint = 0x014;
pub const AUDIO_MCLK_F_CTRL: c_uint = 0x018;
pub const AUDIO_MST_PAD_CTRL0: c_uint = 0x01c;
pub const AUDIO_MST_PAD_CTRL1: c_uint = 0x020;
pub const AUDIO_SW_RESET: c_uint = 0x024;
pub const AUDIO_MST_A_SCLK_CTRL0: c_uint = 0x040;
pub const AUDIO_MST_A_SCLK_CTRL1: c_uint = 0x044;
pub const AUDIO_MST_B_SCLK_CTRL0: c_uint = 0x048;
pub const AUDIO_MST_B_SCLK_CTRL1: c_uint = 0x04C;
pub const AUDIO_MST_C_SCLK_CTRL0: c_uint = 0x050;
pub const AUDIO_MST_C_SCLK_CTRL1: c_uint = 0x054;
pub const AUDIO_MST_D_SCLK_CTRL0: c_uint = 0x058;
pub const AUDIO_MST_D_SCLK_CTRL1: c_uint = 0x05C;
pub const AUDIO_MST_E_SCLK_CTRL0: c_uint = 0x060;
pub const AUDIO_MST_E_SCLK_CTRL1: c_uint = 0x064;
pub const AUDIO_MST_F_SCLK_CTRL0: c_uint = 0x068;
pub const AUDIO_MST_F_SCLK_CTRL1: c_uint = 0x06C;
pub const AUDIO_CLK_TDMIN_A_CTRL: c_uint = 0x080;
pub const AUDIO_CLK_TDMIN_B_CTRL: c_uint = 0x084;
pub const AUDIO_CLK_TDMIN_C_CTRL: c_uint = 0x088;
pub const AUDIO_CLK_TDMIN_LB_CTRL: c_uint = 0x08C;
pub const AUDIO_CLK_TDMOUT_A_CTRL: c_uint = 0x090;
pub const AUDIO_CLK_TDMOUT_B_CTRL: c_uint = 0x094;
pub const AUDIO_CLK_TDMOUT_C_CTRL: c_uint = 0x098;
pub const AUDIO_CLK_SPDIFIN_CTRL: c_uint = 0x09C;
pub const AUDIO_CLK_SPDIFOUT_CTRL: c_uint = 0x0A0;
pub const AUDIO_CLK_RESAMPLE_CTRL: c_uint = 0x0A4;
pub const AUDIO_CLK_LOCKER_CTRL: c_uint = 0x0A8;
pub const AUDIO_CLK_PDMIN_CTRL0: c_uint = 0x0AC;
pub const AUDIO_CLK_PDMIN_CTRL1: c_uint = 0x0B0;
pub const AUDIO_CLK_SPDIFOUT_B_CTRL: c_uint = 0x0B4;
// SM1 introduce new register and some shifts :(
pub const AUDIO_CLK_GATE_EN1: c_uint = 0x004;
pub const AUDIO_SM1_MCLK_A_CTRL: c_uint = 0x008;
pub const AUDIO_SM1_MCLK_B_CTRL: c_uint = 0x00C;
pub const AUDIO_SM1_MCLK_C_CTRL: c_uint = 0x010;
pub const AUDIO_SM1_MCLK_D_CTRL: c_uint = 0x014;
pub const AUDIO_SM1_MCLK_E_CTRL: c_uint = 0x018;
pub const AUDIO_SM1_MCLK_F_CTRL: c_uint = 0x01C;
pub const AUDIO_SM1_MST_PAD_CTRL0: c_uint = 0x020;
pub const AUDIO_SM1_MST_PAD_CTRL1: c_uint = 0x024;
pub const AUDIO_SM1_SW_RESET0: c_uint = 0x028;
pub const AUDIO_SM1_SW_RESET1: c_uint = 0x02C;
pub const AUDIO_CLK81_CTRL: c_uint = 0x030;
pub const AUDIO_CLK81_EN: c_uint = 0x034;
pub const AUDIO_EARCRX_CMDC_CLK_CTRL: c_uint = 0x0D0;
pub const AUDIO_EARCRX_DMAC_CLK_CTRL: c_uint = 0x0D4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct audioclk_data {
    pub hw_clks: meson_clk_hw_data,
    pub rst_drvname: *const c_char,
    pub max_register: c_uint,
}

#[no_mangle]
unsafe extern "C" fn axg_audio_clkc_probe(pdev: *mut platform_device) -> c_int {
...
// Register auxiliary reset driver when applicable
    ...
    data.rst_drvname, core::ptr::null_mut(), 0);
    if (!auxdev)
    return -ENODEV;
    }
    return 0;
