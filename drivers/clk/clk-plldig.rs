...
//! Source: drivers/clk/clk-plldig.c
#![no_std]
...
pub const PLLDIG_REG_PLLSR: c_uint = 0x24;

pub const PLLDIG_REG_PLLDV: c_uint = 0x28;

pub const PLLDIG_REG_PLLFM: c_uint = 0x2c;

pub const PLLDIG_REG_PLLFD: c_uint = 0x30;

pub const PLLDIG_REG_PLLCAL1: c_uint = 0x38;
pub const PLLDIG_REG_PLLCAL2: c_uint = 0x3c;
// Range of the VCO frequencies, in Hz
pub const PLLDIG_MIN_VCO_FREQ: c_int = 650000000;
pub const PLLDIG_MAX_VCO_FREQ: c_int = 1300000000;
// Range of the output frequencies, in Hz

// Maximum value of the reduced frequency divider

// Best value of multiplication factor divider
pub const PLLDIG_DEFAULT_MFD: c_int = 44;
//
// Denominator part of the fractional part of the
// loop multiplication factor.
//
pub const MFDEN: c_int = 20480;
    static const struct clk_parent_data parent_data[] = {
    { .index = 0 },
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_plldig {
    pub hw: clk_hw,
...
#[no_mangle]
unsafe extern "C" fn plldig_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn plldig_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn plldig_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn plldig_init(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn plldig_clk_probe(pdev: *mut platform_device) -> c_int {
