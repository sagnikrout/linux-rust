...
//! Source: drivers/clk/sunxi/clk-sun8i-apb0.c
#![no_std]
...
// The A23 APB0 clock is a standard 2 bit wide divider clock
    clk = clk_register_divider(core::ptr::null_mut(), clk_name, clk_parent, 0, reg,
    0, 2, 0, core::ptr::null_mut());
    if (IS_ERR(clk))
    return clk;
...
#[no_mangle]
unsafe extern "C" fn sun8i_a23_apb0_setup(node: *mut device_node) {
