...
//! Source: drivers/clk/sunxi/clk-mod0.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn sun4i_a10_get_mod0_factors(req: *mut factors_request) {
...
// frequencies higher than the parent frequency
    ...
    calcp = 0;
#[no_mangle]
pub unsafe extern "C" fn if(16: div / 2 <) -> else {
    else if (div / 2 < 16)
    calcp = 1;
#[no_mangle]
pub unsafe extern "C" fn if(16: div / 4 <) -> else {
    else if (div / 4 < 16)
    calcp = 2;
    else
    calcp = 3;
...
#[no_mangle]
unsafe extern "C" fn sun4i_a10_mod0_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun4i_a10_mod0_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun9i_a80_mod0_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun5i_a13_mbus_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mmc_get_phase(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_set_phase(hw: *mut clk_hw, degrees: c_int) -> c_int {
...
//
    ...
    i, &init.name))
    init.name = node.name;
    clk_data.clks[i] = clk_register(core::ptr::null_mut(), &phase.hw);
...
#[no_mangle]
unsafe extern "C" fn sun4i_a10_mmc_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun9i_a80_mmc_setup(node: *mut device_node) -> void __init {
