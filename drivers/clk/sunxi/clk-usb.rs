...
//! Source: drivers/clk/sunxi/clk-usb.c
#![no_std]
...
pub const SUNXI_USB_MAX_SIZE: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
...
// Worst-case size approximation and memory allocation
    ...
    j, &clk_name);
    clk_data.clks[i] = clk_register_gate(core::ptr::null_mut(), clk_name,
    clk_parent, 0,
    reg, i, 0, lock);
...
#[no_mangle]
unsafe extern "C" fn sun4i_a10_usb_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun5i_a13_usb_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun6i_a31_usb_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun8i_a23_usb_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun8i_h3_usb_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun9i_a80_usb_mod_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun9i_a80_usb_phy_setup(node: *mut device_node) -> void __init {
