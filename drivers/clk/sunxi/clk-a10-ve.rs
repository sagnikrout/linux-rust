...
//! Source: drivers/clk/sunxi/clk-a10-ve.c
#![no_std]
...
pub const SUN4I_VE_ENABLE: c_int = 31;
pub const SUN4I_VE_DIVIDER_SHIFT: c_int = 16;
pub const SUN4I_VE_DIVIDER_WIDTH: c_int = 3;
pub const SUN4I_VE_RESET: c_int = 0;
//
// sunxi_ve_reset... - reset bit in ve clk registers handling
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ve_reset_data {
...
#[no_mangle]
unsafe extern "C" fn sun4i_ve_clk_setup(node: *mut device_node) -> void __init {
    ...
    div.lock = &ve_lock;
    clk = clk_register_composite(core::ptr::null_mut(), clk_name, &parent, 1,
