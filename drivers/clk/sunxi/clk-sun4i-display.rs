...
//! Source: drivers/clk/sunxi/clk-sun4i-display.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun4i_a10_display_clk_data {
    pub has_div: bool,
    pub num_rst: u8,
    pub parents: u8,
    pub offset_en: u8,
...
// We only have a single reset signal
    ...
    &mux.hw, &clk_mux_ops,
    data.has_div ? &div.hw : core::ptr::null_mut(),
    data.has_div ? &clk_divider_ops : core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn sun4i_a10_tcon_ch0_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn sun4i_a10_display_setup(node: *mut device_node) -> void __init {
