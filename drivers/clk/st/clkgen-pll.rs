...
//! Source: drivers/clk/st/clkgen-pll.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clkgen_pll_data {
    pub pdn_status: clkgen_field,
    pub pdn_ctrl: clkgen_field,
    pub locked_status: clkgen_field,
    pub mdiv: clkgen_field,
    pub ndiv: clkgen_field,
    pub pdiv: clkgen_field,
    pub idf: clkgen_field,
    pub ldf: clkgen_field,
    pub cp: clkgen_field,
    pub num_odfs: c_uint,
    pub odf: [clkgen_field; C32_MAX_ODFS],
    pub odf_gate: [clkgen_field; C32_MAX_ODFS],
    pub switch2pll_en: bool,
    pub switch2pll: clkgen_field,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clkgen_pll_data_clks {
    pub data: *mut clkgen_pll_data,
...
#[no_mangle]
unsafe extern "C" fn clkgen_pll_is_locked(hw: *mut clk_hw) -> c_int {
    static int clkgen_pll_is_locked(struct clk_hw *hw)
    {
    struct clkgen_pll *pll = to_clkgen_pll(hw);
    let mut locked: u32 = CLKGEN_READ(pll, locked_status);
    return !!locked;
    }
#[no_mangle]
unsafe extern "C" fn clkgen_pll_is_enabled(hw: *mut clk_hw) -> c_int {
    static int clkgen_pll_is_enabled(struct clk_hw *hw)
    {
    struct clkgen_pll *pll = to_clkgen_pll(hw);
    let mut poweroff: u32 = CLKGEN_READ(pll, pdn_status);
    return !poweroff;
    }
#[no_mangle]
unsafe extern "C" fn __clkgen_pll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clkgen_pll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __clkgen_pll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clkgen_pll_disable(hw: *mut clk_hw) {
...
// rate = (input / pll->idf) * 2 * pll->ndiv;
    ...
    div.lock = odf_lock;
    clk = clk_register_composite(core::ptr::null_mut(), odf_name, &parent_name, 1,
...
#[no_mangle]
unsafe extern "C" fn clkgen_c32_pll0_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clkgen_c32_pll0_a0_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clkgen_c32_pll0_c0_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clkgen_c32_pll1_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clkgen_c32_pll1_c0_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clkgen_c32_plla9_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clkgen_c28_plla9_setup(np: *mut device_node) -> void __init {
