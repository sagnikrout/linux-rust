...
//! Source: drivers/clk/st/clk-flexgen.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clkgen_data {
    pub flags: c_ulong,
    pub mode: bool,
    pub outputs: *const clkgen_clk_out,
    pub outputs_nb: c_uint,
}
...
// Pre-divisor's gate
    pub pgate: clk_gate,
// Pre-divisor
    pub pdiv: clk_divider,
// Final divisor's gate
    pub fgate: clk_gate,
// Final divisor
    pub fdiv: clk_divider,
...
#[no_mangle]
unsafe extern "C" fn flexgen_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexgen_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn flexgen_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flexgen_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn flexgen_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
// Crossbar element config
    ...
    fgxbar.mux.table = core::ptr::null_mut();
...
// Final divider sync config
    ...
    fgxbar.hw.init = &init;
    clk = clk_register(core::ptr::null_mut(), &fgxbar.hw);
    if (IS_ERR(clk))
    kfree(fgxbar);
    else
...
#[no_mangle]
unsafe extern "C" fn st_of_flexgen_setup(np: *mut device_node) -> void __init {
    ...
    const char **parents;
    int num_parents, i;
    spinlock_t *rlock = core::ptr::null_mut();
    const struct of_device_id *match;
    struct clkgen_data *data = core::ptr::null_mut();
    let mut flex_flags: c_ulong = 0;
    int ret;
    let mut clk_mode: bool = 0;
    const char *clk_name;
