...
//! Source: drivers/clk/st/clkgen-fsyn.c
#![no_std]
...
// be used.
//
pub const QUADFS_NDIV_THRESHOLD: c_int = 30000000;

pub const QUADFS_MAX_CHAN: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm_fs {
    pub ndiv: c_ulong,
...
pub struct clkgen_quadfs_data {
    ...
    pub bwfilter_present: bool,
    pub lockstatus_present: bool,
    pub powerup_polarity: bool,
    pub standby_polarity: bool,
    pub nsdiv_present: bool,
    pub nrst_present: bool,
    pub ndiv: clkgen_field,
    pub ref_bw: clkgen_field,
    pub nreset: clkgen_field,
    pub npda: clkgen_field,
    pub lock_status: clkgen_field,
    pub nrst: [clkgen_field; QUADFS_MAX_CHAN],
    pub nsb: [clkgen_field; QUADFS_MAX_CHAN],
    pub en: [clkgen_field; QUADFS_MAX_CHAN],
    pub mdiv: [clkgen_field; QUADFS_MAX_CHAN],
    pub pe: [clkgen_field; QUADFS_MAX_CHAN],
    pub sdiv: [clkgen_field; QUADFS_MAX_CHAN],
    pub nsdiv: [clkgen_field; QUADFS_MAX_CHAN],
    pub pll_ops: *const clk_ops,
    pub ): *mut *mut int (get_params)(unsigned long, unsigned long, struct stm_fs,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clkgen_quadfs_data_clks {
    pub data: *mut clkgen_quadfs_data,
    pub outputs: *const clkgen_clk_out,
}
...
#[no_mangle]
unsafe extern "C" fn quadfs_pll_enable(hw: *mut clk_hw) -> c_int {
    static int quadfs_pll_enable(struct clk_hw *hw)
    {
    struct st_clk_quadfs_pll *pll = to_quadfs_pll(hw);
    let mut flags: c_ulong = 0, timeout = jiffies + msecs_to_jiffies(10);
    if (pll.lock)
...
#[no_mangle]
unsafe extern "C" fn quadfs_pll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn quadfs_pll_is_enabled(hw: *mut clk_hw) -> c_int {
    static int quadfs_pll_is_enabled(struct clk_hw *hw)
    {
    struct st_clk_quadfs_pll *pll = to_quadfs_pll(hw);
    let mut npda: u32 = CLKGEN_READ(pll, npda);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_clk_quadfs_fsynth {
    pub hw: clk_hw,
    pub regs_base: *mut void __iomem,
    pub lock: *mut spinlock_t,
    pub data: *mut clkgen_quadfs_data,
...
#[no_mangle]
unsafe extern "C" fn quadfs_fsynth_program_enable(fs: *mut st_clk_quadfs_fsynth) {
...
#[no_mangle]
unsafe extern "C" fn quadfs_fsynth_program_rate(fs: *mut st_clk_quadfs_fsynth) {
...
#[no_mangle]
unsafe extern "C" fn quadfs_fsynth_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn quadfs_fsynth_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn quadfs_fsynth_is_enabled(hw: *mut clk_hw) -> c_int {
    static int quadfs_fsynth_is_enabled(struct clk_hw *hw)
    {
    struct st_clk_quadfs_fsynth *fs = to_quadfs_fsynth(hw);
    let mut nsb: u32 = CLKGEN_READ(fs, nsb[fs.chan]);
...
//
    ...
    fs.lock = lock;
    fs.hw.init = &init;
    clk = clk_register(core::ptr::null_mut(), &fs.hw);
    if (IS_ERR(clk))
    kfree(fs);
    return clk;
    }
...
#[no_mangle]
unsafe extern "C" fn st_of_quadfs660C_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn st_of_quadfs660D_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn st_of_quadfs660D0_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn st_of_quadfs660D2_setup(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn st_of_quadfs660D3_setup(np: *mut device_node) -> void __init {
