...
pub const K230_PLL_DIV_REG_OFFSET: c_uint = 0x00;
pub const K230_PLL_BYPASS_REG_OFFSET: c_uint = 0x04;
pub const K230_PLL_GATE_REG_OFFSET: c_uint = 0x08;
pub const K230_PLL_LOCK_REG_OFFSET: c_uint = 0x0C;
// PLL lock register

pub const K230_PLL_LOCK_TIME_DELAY: c_int = 400;
pub const K230_PLL_LOCK_TIMEOUT: c_int = 0;
// K230 CLK registers offset
pub const K230_CLK_AUDIO_CLKDIV_OFFSET: c_uint = 0x34;
pub const K230_CLK_PDM_CLKDIV_OFFSET: c_uint = 0x40;
pub const K230_CLK_CODEC_ADC_MCLKDIV_OFFSET: c_uint = 0x38;
pub const K230_CLK_CODEC_DAC_MCLKDIV_OFFSET: c_uint = 0x3c;
...
// clk_ops for clocks whose rate is determined by both a multiplier and a divider
    ...
    K230_CLK_PLL_FORMAT(pll0, 0, CLK_IS_CRITICAL, core::ptr::null_mut());
    K230_CLK_PLL_FORMAT(pll1, 1, CLK_IS_CRITICAL, core::ptr::null_mut());
    K230_CLK_PLL_FORMAT(pll2, 2, CLK_IS_CRITICAL, core::ptr::null_mut());
    K230_CLK_PLL_FORMAT(pll3, 3, CLK_IS_CRITICAL, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn k230_pll_prepare(hw: *mut clk_hw) -> c_int {
    static int k230_pll_prepare(struct clk_hw *hw)
    {
...
#[no_mangle]
pub unsafe extern "C" fn k230_pll_hw_is_enabled(pll: *mut k230_pll) -> bool {
...
#[no_mangle]
unsafe extern "C" fn k230_pll_enable_hw(pll: *mut k230_pll) {
...
#[no_mangle]
unsafe extern "C" fn k230_pll_enable(hw: *mut clk_hw) -> c_int {
    static int k230_pll_enable(struct clk_hw *hw)
    {
    struct k230_pll *pll = hw_to_k230_pll(hw);
...
#[no_mangle]
unsafe extern "C" fn k230_pll_disable(hw: *mut clk_hw) {
    static void k230_pll_disable(struct clk_hw *hw)
    {
    struct k230_pll *pll = hw_to_k230_pll(hw);
    u32 reg;
...
#[no_mangle]
unsafe extern "C" fn k230_pll_is_enabled(hw: *mut clk_hw) -> c_int {
    static int k230_pll_is_enabled(struct clk_hw *hw)
    {
    return k230_pll_hw_is_enabled(hw_to_k230_pll(hw));
    }
#[no_mangle]
unsafe extern "C" fn k230_pll_get_rate(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
    static unsigned long k230_pll_get_rate(struct clk_hw *hw, unsigned long parent_rate)
    {
    struct k230_pll *pll = hw_to_k230_pll(hw);
    u32 reg;
    ...
    if (ret)
    return ret;
    ret = devm_clk_hw_register_clkdev(&pdev.dev, &pll.hw, name, core::ptr::null_mut());
    if (ret)
    return ret;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn k230_register_pll_divs(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k230_clk_determine_rate_mul(hw: *mut clk_hw, req: *mut clk_rate_request) -> c_int {
    static int k230_clk_determine_rate_mul(struct clk_hw *hw, struct clk_rate_request *req)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn k230_clk_determine_rate_div(hw: *mut clk_hw, req: *mut clk_rate_request) -> c_int {
    static int k230_clk_determine_rate_div(struct clk_hw *hw, struct clk_rate_request *req)
    {
    int ret;
    struct k230_clk_rate_self *rate_self = hw_to_k230_clk_rate_self(hw);
...
#[no_mangle]
unsafe extern "C" fn k230_clk_determine_rate_mul_div(hw: *mut clk_hw, req: *mut clk_rate_request) -> c_int {
    static int k230_clk_determine_rate_mul_div(struct clk_hw *hw, struct clk_rate_request *req)
    {
    int ret;
    struct k230_clk_rate_self *rate_self = hw_to_k230_clk_rate_self(hw);
...
#[no_mangle]
unsafe extern "C" fn k230_clk_init_plls(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k230_clk_probe(pdev: *mut platform_device) -> c_int {
