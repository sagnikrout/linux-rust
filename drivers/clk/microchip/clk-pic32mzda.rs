...
//! Source: drivers/clk/microchip/clk-pic32mzda.c
#![no_std]
...
// FRC Postscaler
pub const OSC_FRCDIV_MASK: c_uint = 0x07;
pub const OSC_FRCDIV_SHIFT: c_int = 24;
// SPLL fields
pub const PLL_ICLK_MASK: c_uint = 0x01;
pub const PLL_ICLK_SHIFT: c_int = 7;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pic32mzda_clk_data {
    pub clks: [*mut clk; MAXCLKS],
    pub core: pic32_clk_common,
    pub onecell_data: clk_onecell_data,
    pub failsafe_notifier: notifier_block,
}
...
// register fixed rate clocks
    clks[POSCCLK] = clk_register_fixed_rate(&pdev.dev, "posc_clk", core::ptr::null_mut(),
    0, 24000000);
    clks[FRCCLK] =  clk_register_fixed_rate(&pdev.dev, "frc_clk", core::ptr::null_mut(),
    0, 8000000);
    clks[BFRCCLK] = clk_register_fixed_rate(&pdev.dev, "bfrc_clk", core::ptr::null_mut(),
    0, 8000000);
    clks[LPRCCLK] = clk_register_fixed_rate(&pdev.dev, "lprc_clk", core::ptr::null_mut(),
    0, 32000);
    clks[UPLLCLK] = clk_register_fixed_rate(&pdev.dev, "usbphy_clk", core::ptr::null_mut(),
    0, 24000000);
...
// register clkdev
    ...
    if (IS_ERR(clks[i]))
    continue;
    clk_register_clkdev(clks[i], core::ptr::null_mut(), __clk_get_name(clks[i]));
    }
...
#[no_mangle]
unsafe extern "C" fn microchip_pic32mzda_clk_init() -> int __init {
