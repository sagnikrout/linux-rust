...
//! Source: drivers/clk/mediatek/clk-mt8188-topckgen.c
#![no_std]
...
//
    ...
    FIXED_CLK(CLK_TOP_ULPOSC1, "ulposc_ck1", core::ptr::null_mut(), 260000000),
    FIXED_CLK(CLK_TOP_MPHONE_SLAVE_BCK, "mphone_slave_bck", core::ptr::null_mut(), 49152000),
    FIXED_CLK(CLK_TOP_PAD_FPC, "pad_fpc_ck", core::ptr::null_mut(), 50000000),
    FIXED_CLK(CLK_TOP_466M_FMEM, "hd_466m_fmem_ck", core::ptr::null_mut(), 533000000),
    FIXED_CLK(CLK_TOP_PEXTP_PIPE, "pextp_pipe", core::ptr::null_mut(), 250000000),
    FIXED_CLK(CLK_TOP_DSI_PHY, "dsi_phy", core::ptr::null_mut(), 500000000),
    };
...
#[no_mangle]
unsafe extern "C" fn clk_mt8188_reg_mfg_mux_notifier(dev: *mut device, clk: *mut clk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8188_topck_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8188_topck_remove(pdev: *mut platform_device) {
