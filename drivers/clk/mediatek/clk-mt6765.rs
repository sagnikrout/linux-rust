...
//! Source: drivers/clk/mediatek/clk-mt6765.c
#![no_std]
...
// clk cfg update
pub const CLK_CFG_0: c_uint = 0x40;
pub const CLK_CFG_0_SET: c_uint = 0x44;
pub const CLK_CFG_0_CLR: c_uint = 0x48;
pub const CLK_CFG_1: c_uint = 0x50;
pub const CLK_CFG_1_SET: c_uint = 0x54;
pub const CLK_CFG_1_CLR: c_uint = 0x58;
pub const CLK_CFG_2: c_uint = 0x60;
pub const CLK_CFG_2_SET: c_uint = 0x64;
pub const CLK_CFG_2_CLR: c_uint = 0x68;
pub const CLK_CFG_3: c_uint = 0x70;
pub const CLK_CFG_3_SET: c_uint = 0x74;
pub const CLK_CFG_3_CLR: c_uint = 0x78;
pub const CLK_CFG_4: c_uint = 0x80;
pub const CLK_CFG_4_SET: c_uint = 0x84;
pub const CLK_CFG_4_CLR: c_uint = 0x88;
pub const CLK_CFG_5: c_uint = 0x90;
pub const CLK_CFG_5_SET: c_uint = 0x94;
pub const CLK_CFG_5_CLR: c_uint = 0x98;
pub const CLK_CFG_6: c_uint = 0xa0;
pub const CLK_CFG_6_SET: c_uint = 0xa4;
pub const CLK_CFG_6_CLR: c_uint = 0xa8;
pub const CLK_CFG_7: c_uint = 0xb0;
pub const CLK_CFG_7_SET: c_uint = 0xb4;
pub const CLK_CFG_7_CLR: c_uint = 0xb8;
pub const CLK_CFG_8: c_uint = 0xc0;
pub const CLK_CFG_8_SET: c_uint = 0xc4;
pub const CLK_CFG_8_CLR: c_uint = 0xc8;
pub const CLK_CFG_9: c_uint = 0xd0;
pub const CLK_CFG_9_SET: c_uint = 0xd4;
pub const CLK_CFG_9_CLR: c_uint = 0xd8;
pub const CLK_CFG_10: c_uint = 0xe0;
pub const CLK_CFG_10_SET: c_uint = 0xe4;
pub const CLK_CFG_10_CLR: c_uint = 0xe8;
pub const CLK_CFG_UPDATE: c_uint = 0x004;
    static const struct mtk_fixed_clk fixed_clks[] = {
    FIXED_CLK(CLK_TOP_F_FRTC, "f_frtc_ck", "clk32k", 32768),
    FIXED_CLK(CLK_TOP_CLK26M, "clk_26m_ck", "clk26m", 26000000),
    FIXED_CLK(CLK_TOP_DMPLL, "dmpll_ck", core::ptr::null_mut(), 466000000),
    };
...
pub const INVALID_UPDATE_REG: c_uint = 0xFFFFFFFF;
...
// AUDIO0
    ...
    _pcw_reg, _pcw_shift, core::ptr::null_mut())	\
...
#[no_mangle]
unsafe extern "C" fn clk_mt6765_apmixed_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6765_top_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6765_ifr_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6765_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6765_init() -> int __init {
