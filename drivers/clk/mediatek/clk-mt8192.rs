...
//! Source: drivers/clk/mediatek/clk-mt8192.c
#![no_std]
...
// Author: Chun-Jie Chen <chun-jie.chen@mediatek.com>
    ...
    FIXED_CLK(CLK_TOP_ULPOSC, "ulposc", core::ptr::null_mut(), 260000000),
    };
...
#[no_mangle]
unsafe extern "C" fn clk_mt8192_reg_mfg_mux_notifier(dev: *mut device, clk: *mut clk) -> c_int {
