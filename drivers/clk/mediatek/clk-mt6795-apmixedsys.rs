...
//! Source: drivers/clk/mediatek/clk-mt6795-apmixedsys.c
#![no_std]
...
pub const REG_REF2USB: c_uint = 0x8;
pub const REG_AP_PLL_CON7: c_uint = 0x1c;
...
#[no_mangle]
unsafe extern "C" fn clk_mt6795_apmixed_setup_md1(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6795_apmixed_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6795_apmixed_remove(pdev: *mut platform_device) {
