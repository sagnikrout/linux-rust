...
//! Source: drivers/clk/mediatek/clk-mt2701.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtk_topckgen_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_infrasys_init_early(node: *mut device_node) -> void __init {
    ...
    infra_clk_data);
    mtk_clk_register_cpumuxes(core::ptr::null_mut(), node, cpu_muxes, ARRAY_SIZE(cpu_muxes),
    infra_clk_data);
...
#[no_mangle]
unsafe extern "C" fn mtk_infrasys_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_pericfg_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_apmixedsys_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt2701_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt2701_init() -> int __init {
