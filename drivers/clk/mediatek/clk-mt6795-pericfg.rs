...
//! Source: drivers/clk/mediatek/clk-mt6795-pericfg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_mt6795_pericfg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6795_pericfg_remove(pdev: *mut platform_device) {
