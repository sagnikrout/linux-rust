...
//! Source: drivers/clk/mediatek/clk-mt6735-topckgen.c
#![no_std]
...
// MEMPLL.
//
    FIXED_CLK(CLK_TOP_CLKPH_MCK_O, "clkph_mck_o", core::ptr::null_mut(), 0),
//
...
//
    FIXED_CLK(CLK_TOP_DPI_CK, "dpi_ck", core::ptr::null_mut(), 0),
//
// This clock is a child of WHPLL which is controlled by
// the modem.
//
    FIXED_CLK(CLK_TOP_WHPLL_AUDIO_CK, "whpll_audio_ck", core::ptr::null_mut(), 0)
    };
