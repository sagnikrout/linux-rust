...
//! Source: drivers/clk/mediatek/clk-mt8196-topckgen.c
#![no_std]
...
// MUX SEL REG
pub const CLK_CFG_UPDATE: c_uint = 0x0004;
pub const CLK_CFG_UPDATE1: c_uint = 0x0008;
pub const CLK_CFG_UPDATE2: c_uint = 0x000c;
pub const CLK_CFG_0: c_uint = 0x0010;
pub const CLK_CFG_0_SET: c_uint = 0x0014;
pub const CLK_CFG_0_CLR: c_uint = 0x0018;
pub const CLK_CFG_1: c_uint = 0x0020;
pub const CLK_CFG_1_SET: c_uint = 0x0024;
pub const CLK_CFG_1_CLR: c_uint = 0x0028;
pub const CLK_CFG_2: c_uint = 0x0030;
pub const CLK_CFG_2_SET: c_uint = 0x0034;
pub const CLK_CFG_2_CLR: c_uint = 0x0038;
pub const CLK_CFG_3: c_uint = 0x0040;
pub const CLK_CFG_3_SET: c_uint = 0x0044;
pub const CLK_CFG_3_CLR: c_uint = 0x0048;
pub const CLK_CFG_4: c_uint = 0x0050;
pub const CLK_CFG_4_SET: c_uint = 0x0054;
pub const CLK_CFG_4_CLR: c_uint = 0x0058;
pub const CLK_CFG_5: c_uint = 0x0060;
pub const CLK_CFG_5_SET: c_uint = 0x0064;
pub const CLK_CFG_5_CLR: c_uint = 0x0068;
pub const CLK_CFG_6: c_uint = 0x0070;
pub const CLK_CFG_6_SET: c_uint = 0x0074;
pub const CLK_CFG_6_CLR: c_uint = 0x0078;
pub const CLK_CFG_7: c_uint = 0x0080;
pub const CLK_CFG_7_SET: c_uint = 0x0084;
pub const CLK_CFG_7_CLR: c_uint = 0x0088;
pub const CLK_CFG_8: c_uint = 0x0090;
pub const CLK_CFG_8_SET: c_uint = 0x0094;
pub const CLK_CFG_8_CLR: c_uint = 0x0098;
pub const CLK_CFG_9: c_uint = 0x00a0;
pub const CLK_CFG_9_SET: c_uint = 0x00a4;
pub const CLK_CFG_9_CLR: c_uint = 0x00a8;
pub const CLK_CFG_10: c_uint = 0x00b0;
pub const CLK_CFG_10_SET: c_uint = 0x00b4;
pub const CLK_CFG_10_CLR: c_uint = 0x00b8;
pub const CLK_CFG_11: c_uint = 0x00c0;
pub const CLK_CFG_11_SET: c_uint = 0x00c4;
pub const CLK_CFG_11_CLR: c_uint = 0x00c8;
pub const CLK_CFG_12: c_uint = 0x00d0;
pub const CLK_CFG_12_SET: c_uint = 0x00d4;
pub const CLK_CFG_12_CLR: c_uint = 0x00d8;
pub const CLK_CFG_13: c_uint = 0x00e0;
pub const CLK_CFG_13_SET: c_uint = 0x00e4;
pub const CLK_CFG_13_CLR: c_uint = 0x00e8;
pub const CLK_CFG_14: c_uint = 0x00f0;
pub const CLK_CFG_14_SET: c_uint = 0x00f4;
pub const CLK_CFG_14_CLR: c_uint = 0x00f8;
pub const CLK_CFG_15: c_uint = 0x0100;
pub const CLK_CFG_15_SET: c_uint = 0x0104;
pub const CLK_CFG_15_CLR: c_uint = 0x0108;
pub const CLK_CFG_16: c_uint = 0x0110;
pub const CLK_CFG_16_SET: c_uint = 0x0114;
pub const CLK_CFG_16_CLR: c_uint = 0x0118;
pub const CLK_CFG_17: c_uint = 0x0120;
pub const CLK_CFG_17_SET: c_uint = 0x0124;
pub const CLK_CFG_17_CLR: c_uint = 0x0128;
pub const CLK_CFG_18: c_uint = 0x0130;
pub const CLK_CFG_18_SET: c_uint = 0x0134;
pub const CLK_CFG_18_CLR: c_uint = 0x0138;
pub const CLK_CFG_19: c_uint = 0x0140;
pub const CLK_CFG_19_SET: c_uint = 0x0144;
pub const CLK_CFG_19_CLR: c_uint = 0x0148;
pub const CLK_AUDDIV_0: c_uint = 0x020c;
pub const CLK_FENC_STATUS_MON_0: c_uint = 0x0270;
pub const CLK_FENC_STATUS_MON_1: c_uint = 0x0274;
pub const CLK_FENC_STATUS_MON_2: c_uint = 0x0278;
// MUX SHIFT
pub const TOP_MUX_AXI_SHIFT: c_int = 0;
pub const TOP_MUX_MEM_SUB_SHIFT: c_int = 1;
pub const TOP_MUX_IO_NOC_SHIFT: c_int = 2;
pub const TOP_MUX_PERI_AXI_SHIFT: c_int = 3;
pub const TOP_MUX_UFS_PEXTP0_AXI_SHIFT: c_int = 4;
pub const TOP_MUX_PEXTP1_USB_AXI_SHIFT: c_int = 5;
pub const TOP_MUX_PERI_FMEM_SUB_SHIFT: c_int = 6;
pub const TOP_MUX_UFS_PEXPT0_MEM_SUB_SHIFT: c_int = 7;
pub const TOP_MUX_PEXTP1_USB_MEM_SUB_SHIFT: c_int = 8;
pub const TOP_MUX_PERI_NOC_SHIFT: c_int = 9;
pub const TOP_MUX_EMI_N_SHIFT: c_int = 10;
pub const TOP_MUX_EMI_S_SHIFT: c_int = 11;
pub const TOP_MUX_AP2CONN_HOST_SHIFT: c_int = 14;
pub const TOP_MUX_ATB_SHIFT: c_int = 15;
pub const TOP_MUX_CIRQ_SHIFT: c_int = 16;
pub const TOP_MUX_PBUS_156M_SHIFT: c_int = 17;
pub const TOP_MUX_EFUSE_SHIFT: c_int = 20;
pub const TOP_MUX_MCU_L3GIC_SHIFT: c_int = 21;
pub const TOP_MUX_MCU_INFRA_SHIFT: c_int = 22;
pub const TOP_MUX_DSP_SHIFT: c_int = 23;
pub const TOP_MUX_MFG_REF_SHIFT: c_int = 24;
pub const TOP_MUX_MFG_EB_SHIFT: c_int = 26;
pub const TOP_MUX_UART_SHIFT: c_int = 27;
pub const TOP_MUX_SPI0_BCLK_SHIFT: c_int = 28;
pub const TOP_MUX_SPI1_BCLK_SHIFT: c_int = 29;
pub const TOP_MUX_SPI2_BCLK_SHIFT: c_int = 30;
pub const TOP_MUX_SPI3_BCLK_SHIFT: c_int = 0;
pub const TOP_MUX_SPI4_BCLK_SHIFT: c_int = 1;
pub const TOP_MUX_SPI5_BCLK_SHIFT: c_int = 2;
pub const TOP_MUX_SPI6_BCLK_SHIFT: c_int = 3;
pub const TOP_MUX_SPI7_BCLK_SHIFT: c_int = 4;
pub const TOP_MUX_MSDC30_1_SHIFT: c_int = 7;
pub const TOP_MUX_MSDC30_2_SHIFT: c_int = 8;
pub const TOP_MUX_DISP_PWM_SHIFT: c_int = 9;
pub const TOP_MUX_USB_TOP_1P_SHIFT: c_int = 10;
pub const TOP_MUX_SSUSB_XHCI_1P_SHIFT: c_int = 11;
pub const TOP_MUX_SSUSB_FMCNT_P1_SHIFT: c_int = 12;
pub const TOP_MUX_I2C_PERI_SHIFT: c_int = 13;
pub const TOP_MUX_I2C_EAST_SHIFT: c_int = 14;
pub const TOP_MUX_I2C_WEST_SHIFT: c_int = 15;
pub const TOP_MUX_I2C_NORTH_SHIFT: c_int = 16;
pub const TOP_MUX_AES_UFSFDE_SHIFT: c_int = 17;
pub const TOP_MUX_UFS_SHIFT: c_int = 18;
pub const TOP_MUX_AUD_1_SHIFT: c_int = 21;
pub const TOP_MUX_AUD_2_SHIFT: c_int = 22;
pub const TOP_MUX_ADSP_SHIFT: c_int = 23;
pub const TOP_MUX_ADSP_UARTHUB_B_SHIFT: c_int = 24;
pub const TOP_MUX_DPMAIF_MAIN_SHIFT: c_int = 25;
pub const TOP_MUX_PWM_SHIFT: c_int = 26;
pub const TOP_MUX_MCUPM_SHIFT: c_int = 27;
pub const TOP_MUX_SFLASH_SHIFT: c_int = 28;
pub const TOP_MUX_IPSEAST_SHIFT: c_int = 29;
pub const TOP_MUX_TL_SHIFT: c_int = 0;
pub const TOP_MUX_TL_P1_SHIFT: c_int = 1;
pub const TOP_MUX_TL_P2_SHIFT: c_int = 2;
pub const TOP_MUX_EMI_INTERFACE_546_SHIFT: c_int = 3;
pub const TOP_MUX_SDF_SHIFT: c_int = 4;
pub const TOP_MUX_UARTHUB_BCLK_SHIFT: c_int = 5;
pub const TOP_MUX_DPSW_CMP_26M_SHIFT: c_int = 6;
pub const TOP_MUX_SMAPCK_SHIFT: c_int = 7;
pub const TOP_MUX_SSR_PKA_SHIFT: c_int = 8;
pub const TOP_MUX_SSR_DMA_SHIFT: c_int = 9;
pub const TOP_MUX_SSR_KDF_SHIFT: c_int = 10;
pub const TOP_MUX_SSR_RNG_SHIFT: c_int = 11;
pub const TOP_MUX_SPU0_SHIFT: c_int = 12;
pub const TOP_MUX_SPU1_SHIFT: c_int = 13;
pub const TOP_MUX_DXCC_SHIFT: c_int = 14;
// CKSTA REG
pub const CKSTA_REG: c_uint = 0x01c8;
pub const CKSTA_REG1: c_uint = 0x01cc;
pub const CKSTA_REG2: c_uint = 0x01d0;
// DIVIDER REG
pub const CLK_AUDDIV_2: c_uint = 0x0214;
pub const CLK_AUDDIV_3: c_uint = 0x0220;
pub const CLK_AUDDIV_4: c_uint = 0x0224;
pub const CLK_AUDDIV_5: c_uint = 0x0228;
// HW Voter REG
pub const HWV_CG_0_SET: c_uint = 0x0000;
pub const HWV_CG_0_CLR: c_uint = 0x0004;
pub const HWV_CG_0_DONE: c_uint = 0x2c00;
pub const HWV_CG_1_SET: c_uint = 0x0008;
pub const HWV_CG_1_CLR: c_uint = 0x000c;
pub const HWV_CG_1_DONE: c_uint = 0x2c04;
pub const HWV_CG_2_SET: c_uint = 0x0010;
pub const HWV_CG_2_CLR: c_uint = 0x0014;
pub const HWV_CG_2_DONE: c_uint = 0x2c08;
pub const HWV_CG_3_SET: c_uint = 0x0018;
pub const HWV_CG_3_CLR: c_uint = 0x001c;
pub const HWV_CG_3_DONE: c_uint = 0x2c0c;
pub const HWV_CG_4_SET: c_uint = 0x0020;
pub const HWV_CG_4_CLR: c_uint = 0x0024;
pub const HWV_CG_4_DONE: c_uint = 0x2c10;
pub const HWV_CG_5_SET: c_uint = 0x0028;
pub const HWV_CG_5_CLR: c_uint = 0x002c;
pub const HWV_CG_5_DONE: c_uint = 0x2c14;
pub const HWV_CG_6_SET: c_uint = 0x0030;
pub const HWV_CG_6_CLR: c_uint = 0x0034;
pub const HWV_CG_6_DONE: c_uint = 0x2c18;
pub const HWV_CG_7_SET: c_uint = 0x0038;
pub const HWV_CG_7_CLR: c_uint = 0x003c;
pub const HWV_CG_7_DONE: c_uint = 0x2c1c;
pub const HWV_CG_8_SET: c_uint = 0x0040;
pub const HWV_CG_8_CLR: c_uint = 0x0044;
pub const HWV_CG_8_DONE: c_uint = 0x2c20;
...
// CLK_CFG_6
    ...
    core::ptr::null_mut(), ARRAY_SIZE(mfg_ref_parents),
