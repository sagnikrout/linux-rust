...
//! Source: drivers/clk/mediatek/clk-mt6779.c
#![no_std]
...
//
    ...
    _pd_shift, _tuner_reg, _tuner_en_reg,		\
    _tuner_en_bit, _pcw_reg, _pcw_shift,		\
    _pcw_chg_reg, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn clk_mt6779_apmixed_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6779_top_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6779_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6779_init() -> int __init {
    static int __init clk_mt6779_init(void)
    {
    let mut ret: c_int = platform_driver_register(&clk_mt6779_drv);
    if (ret)
    return ret;
