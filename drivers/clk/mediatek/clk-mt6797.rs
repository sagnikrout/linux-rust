...
//! Source: drivers/clk/mediatek/clk-mt6797.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mtk_infrasys_init_early(node: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6797_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6797_init() -> int __init {
