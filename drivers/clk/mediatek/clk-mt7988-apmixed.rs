...
//! Source: drivers/clk/mediatek/clk-mt7988-apmixed.c
#![no_std]
...
pub const MT7988_PCW_CHG_BIT: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn clk_mt7988_apmixed_probe(pdev: *mut platform_device) -> c_int {
