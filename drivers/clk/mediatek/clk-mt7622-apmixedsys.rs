...
//! Source: drivers/clk/mediatek/clk-mt7622-apmixedsys.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_mt7622_apmixed_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt7622_apmixed_remove(pdev: *mut platform_device) {
