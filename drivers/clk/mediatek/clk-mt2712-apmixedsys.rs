...
//! Source: drivers/clk/mediatek/clk-mt2712-apmixedsys.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_mt2712_apmixed_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt2712_apmixed_remove(pdev: *mut platform_device) {
