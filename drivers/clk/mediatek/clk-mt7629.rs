...
//! Source: drivers/clk/mediatek/clk-mt7629.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_mt7629_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt7629_init() -> c_int {
