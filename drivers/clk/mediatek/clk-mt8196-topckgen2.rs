...
//! Source: drivers/clk/mediatek/clk-mt8196-topckgen2.c
#![no_std]
...
// MUX SEL REG
pub const CKSYS2_CLK_CFG_UPDATE: c_uint = 0x0004;
pub const CKSYS2_CLK_CFG_0: c_uint = 0x0010;
pub const CKSYS2_CLK_CFG_0_SET: c_uint = 0x0014;
pub const CKSYS2_CLK_CFG_0_CLR: c_uint = 0x0018;
pub const CKSYS2_CLK_CFG_1: c_uint = 0x0020;
pub const CKSYS2_CLK_CFG_1_SET: c_uint = 0x0024;
pub const CKSYS2_CLK_CFG_1_CLR: c_uint = 0x0028;
pub const CKSYS2_CLK_CFG_2: c_uint = 0x0030;
pub const CKSYS2_CLK_CFG_2_SET: c_uint = 0x0034;
pub const CKSYS2_CLK_CFG_2_CLR: c_uint = 0x0038;
pub const CKSYS2_CLK_CFG_3: c_uint = 0x0040;
pub const CKSYS2_CLK_CFG_3_SET: c_uint = 0x0044;
pub const CKSYS2_CLK_CFG_3_CLR: c_uint = 0x0048;
pub const CKSYS2_CLK_CFG_4: c_uint = 0x0050;
pub const CKSYS2_CLK_CFG_4_SET: c_uint = 0x0054;
pub const CKSYS2_CLK_CFG_4_CLR: c_uint = 0x0058;
pub const CKSYS2_CLK_CFG_5: c_uint = 0x0060;
pub const CKSYS2_CLK_CFG_5_SET: c_uint = 0x0064;
pub const CKSYS2_CLK_CFG_5_CLR: c_uint = 0x0068;
pub const CKSYS2_CLK_CFG_6: c_uint = 0x0070;
pub const CKSYS2_CLK_CFG_6_SET: c_uint = 0x0074;
pub const CKSYS2_CLK_CFG_6_CLR: c_uint = 0x0078;
pub const CKSYS2_CLK_FENC_STATUS_MON_0: c_uint = 0x0174;
// MUX SHIFT
pub const TOP_MUX_SENINF0_SHIFT: c_int = 0;
pub const TOP_MUX_SENINF1_SHIFT: c_int = 1;
pub const TOP_MUX_SENINF2_SHIFT: c_int = 2;
pub const TOP_MUX_SENINF3_SHIFT: c_int = 3;
pub const TOP_MUX_SENINF4_SHIFT: c_int = 4;
pub const TOP_MUX_SENINF5_SHIFT: c_int = 5;
pub const TOP_MUX_IMG1_SHIFT: c_int = 6;
pub const TOP_MUX_IPE_SHIFT: c_int = 7;
pub const TOP_MUX_CAM_SHIFT: c_int = 8;
pub const TOP_MUX_CAMTM_SHIFT: c_int = 9;
pub const TOP_MUX_DPE_SHIFT: c_int = 10;
pub const TOP_MUX_VDEC_SHIFT: c_int = 11;
pub const TOP_MUX_CCUSYS_SHIFT: c_int = 12;
pub const TOP_MUX_CCUTM_SHIFT: c_int = 13;
pub const TOP_MUX_VENC_SHIFT: c_int = 14;
pub const TOP_MUX_DVO_SHIFT: c_int = 15;
pub const TOP_MUX_DVO_FAVT_SHIFT: c_int = 16;
pub const TOP_MUX_DP1_SHIFT: c_int = 17;
pub const TOP_MUX_DP0_SHIFT: c_int = 18;
pub const TOP_MUX_DISP_SHIFT: c_int = 19;
pub const TOP_MUX_MDP_SHIFT: c_int = 20;
pub const TOP_MUX_MMINFRA_SHIFT: c_int = 21;
pub const TOP_MUX_MMINFRA_SNOC_SHIFT: c_int = 22;
pub const TOP_MUX_MMUP_SHIFT: c_int = 23;
pub const TOP_MUX_MMINFRA_AO_SHIFT: c_int = 26;
// HW Voter REG
pub const HWV_CG_30_SET: c_uint = 0x0058;
pub const HWV_CG_30_CLR: c_uint = 0x005c;
pub const HWV_CG_30_DONE: c_uint = 0x2c2c;
pub const MM_HWV_CG_30_SET: c_uint = 0x00f0;
pub const MM_HWV_CG_30_CLR: c_uint = 0x00f4;
pub const MM_HWV_CG_30_DONE: c_uint = 0x2c78;
pub const MM_HWV_CG_31_SET: c_uint = 0x00f8;
pub const MM_HWV_CG_31_CLR: c_uint = 0x00fc;
pub const MM_HWV_CG_31_DONE: c_uint = 0x2c7c;
pub const MM_HWV_CG_32_SET: c_uint = 0x0100;
pub const MM_HWV_CG_32_CLR: c_uint = 0x0104;
pub const MM_HWV_CG_32_DONE: c_uint = 0x2c80;
pub const MM_HWV_CG_33_SET: c_uint = 0x0108;
pub const MM_HWV_CG_33_CLR: c_uint = 0x010c;
pub const MM_HWV_CG_33_DONE: c_uint = 0x2c84;
pub const MM_HWV_CG_34_SET: c_uint = 0x0110;
pub const MM_HWV_CG_34_CLR: c_uint = 0x0114;
pub const MM_HWV_CG_34_DONE: c_uint = 0x2c88;
pub const MM_HWV_CG_35_SET: c_uint = 0x0118;
pub const MM_HWV_CG_35_CLR: c_uint = 0x011c;
pub const MM_HWV_CG_35_DONE: c_uint = 0x2c8c;
pub const MM_HWV_CG_36_SET: c_uint = 0x0120;
pub const MM_HWV_CG_36_CLR: c_uint = 0x0124;
pub const MM_HWV_CG_36_DONE: c_uint = 0x2c90;
pub const MM_HWV_MUX_UPDATE_31_0: c_uint = 0x0240;
