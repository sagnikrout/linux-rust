...
//! Source: drivers/clk/mediatek/clk-mt8195-apmixedsys.c
#![no_std]
...
pub const MT8195_INTEGER_BITS: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn clk_mt8195_apmixed_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8195_apmixed_remove(pdev: *mut platform_device) {
