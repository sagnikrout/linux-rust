...
//! Source: drivers/clk/mediatek/clk-mt8188-apmixedsys.c
#![no_std]
...
pub const MT8188_INTEGER_BITS: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn clk_mt8188_apmixed_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8188_apmixed_remove(pdev: *mut platform_device) {
