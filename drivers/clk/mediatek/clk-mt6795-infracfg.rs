...
//! Source: drivers/clk/mediatek/clk-mt6795-infracfg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_mt6795_infracfg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt6795_infracfg_remove(pdev: *mut platform_device) {
