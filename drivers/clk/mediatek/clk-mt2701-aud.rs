...
//! Source: drivers/clk/mediatek/clk-mt2701-aud.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_mt2701_aud_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt2701_aud_remove(pdev: *mut platform_device) {
