...
//! Source: drivers/clk/mediatek/clk-mt6735-infracfg.c
#![no_std]
...
pub const INFRA_RST0: c_uint = 0x30;
pub const INFRA_GLOBALCON_PDN0: c_uint = 0x40;
pub const INFRA_PDN1: c_uint = 0x44;
pub const INFRA_PDN_STA: c_uint = 0x48;
