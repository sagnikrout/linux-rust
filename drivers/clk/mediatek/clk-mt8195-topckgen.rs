...
//! Source: drivers/clk/mediatek/clk-mt8195-topckgen.c
#![no_std]
...
// Author: Chun-Jie Chen <chun-jie.chen@mediatek.com>
    ...
    FIXED_CLK(CLK_TOP_IN_DGI, "in_dgi", core::ptr::null_mut(), 165000000),
    FIXED_CLK(CLK_TOP_ULPOSC1, "ulposc1", core::ptr::null_mut(), 248000000),
    FIXED_CLK(CLK_TOP_ULPOSC2, "ulposc2", core::ptr::null_mut(), 326000000),
    FIXED_CLK(CLK_TOP_MEM_466M, "mem_466m", core::ptr::null_mut(), 533000000),
    FIXED_CLK(CLK_TOP_MPHONE_SLAVE_B, "mphone_slave_b", core::ptr::null_mut(), 49152000),
    FIXED_CLK(CLK_TOP_PEXTP_PIPE, "pextp_pipe", core::ptr::null_mut(), 250000000),
    FIXED_CLK(CLK_TOP_UFS_RX_SYMBOL, "ufs_rx_symbol", core::ptr::null_mut(), 166000000),
    FIXED_CLK(CLK_TOP_UFS_TX_SYMBOL, "ufs_tx_symbol", core::ptr::null_mut(), 166000000),
    FIXED_CLK(CLK_TOP_SSUSB_U3PHY_P1_P_P0, "ssusb_u3phy_p1_p_p0", core::ptr::null_mut(), 131000000),
    FIXED_CLK(CLK_TOP_UFS_RX_SYMBOL1, "ufs_rx_symbol1", core::ptr::null_mut(), 166000000),
    FIXED_CLK(CLK_TOP_FPC, "fpc", core::ptr::null_mut(), 50000000),
    FIXED_CLK(CLK_TOP_HDMIRX_P, "hdmirx_p", core::ptr::null_mut(), 594000000),
    };
...
#[no_mangle]
unsafe extern "C" fn clk_mt8195_reg_mfg_mux_notifier(dev: *mut device, clk: *mut clk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8195_topck_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8195_topck_remove(pdev: *mut platform_device) {
