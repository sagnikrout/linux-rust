...
//! Source: drivers/clk/mediatek/clk-mt8173-infracfg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_mt8173_infra_init_early(node: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8173_infracfg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8173_infracfg_remove(pdev: *mut platform_device) {
