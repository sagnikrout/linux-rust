...
//! Source: drivers/clk/mediatek/clk-mt2712.c
#![no_std]
...
//
    ...
    FIXED_CLK(CLK_TOP_VPLL3_DPIX, "vpll3_dpix", core::ptr::null_mut(), 200000000),
    FIXED_CLK(CLK_TOP_VPLL_DPIX, "vpll_dpix", core::ptr::null_mut(), 200000000),
    FIXED_CLK(CLK_TOP_LTEPLL_FS26M, "ltepll_fs26m", core::ptr::null_mut(), 26000000),
    FIXED_CLK(CLK_TOP_DMPLL, "dmpll_ck", core::ptr::null_mut(), 350000000),
    FIXED_CLK(CLK_TOP_DSI0_LNTC, "dsi0_lntc", core::ptr::null_mut(), 143000000),
    FIXED_CLK(CLK_TOP_DSI1_LNTC, "dsi1_lntc", core::ptr::null_mut(), 143000000),
    FIXED_CLK(CLK_TOP_LVDSTX3_CLKDIG_CTS, "lvdstx3", core::ptr::null_mut(), 140000000),
    FIXED_CLK(CLK_TOP_LVDSTX_CLKDIG_CTS, "lvdstx", core::ptr::null_mut(), 140000000),
    FIXED_CLK(CLK_TOP_CLKRTC_EXT, "clkrtc_ext", core::ptr::null_mut(), 32768),
    FIXED_CLK(CLK_TOP_CLKRTC_INT, "clkrtc_int", core::ptr::null_mut(), 32747),
    FIXED_CLK(CLK_TOP_CSI0, "csi0", core::ptr::null_mut(), 26000000),
    FIXED_CLK(CLK_TOP_CVBSPLL, "cvbspll", core::ptr::null_mut(), 108000000),
    };
