...
//! Source: drivers/clk/mediatek/clk-mt8186-topckgen.c
#![no_std]
...
// Author: Chun-Jie Chen <chun-jie.chen@mediatek.com>
    ...
    FIXED_CLK(CLK_TOP_ULPOSC1, "ulposc1", core::ptr::null_mut(), 250000000),
    FIXED_CLK(CLK_TOP_466M_FMEM, "hd_466m_fmem_ck", core::ptr::null_mut(), 466000000),
    FIXED_CLK(CLK_TOP_MPLL, "mpll", core::ptr::null_mut(), 208000000),
    };
...
#[no_mangle]
unsafe extern "C" fn clk_mt8186_reg_mfg_mux_notifier(dev: *mut device, clk: *mut clk) -> c_int {
