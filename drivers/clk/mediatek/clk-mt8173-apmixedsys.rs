...
//! Source: drivers/clk/mediatek/clk-mt8173-apmixedsys.c
#![no_std]
...
pub const REGOFF_REF2USB: c_uint = 0x8;
pub const REGOFF_HDMI_REF: c_uint = 0x40;
...
#[no_mangle]
unsafe extern "C" fn clk_mt8173_apmixed_probe(pdev: *mut platform_device) -> c_int {
    ...
    CLK_DIVIDER_POWER_OF_TWO, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn clk_mt8173_apmixed_remove(pdev: *mut platform_device) {
