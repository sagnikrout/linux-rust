...
//! Source: drivers/clk/mediatek/clk-mt8192-aud.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_mt8192_aud_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mt8192_aud_remove(pdev: *mut platform_device) {
