...
//! Source: drivers/clk/mediatek/clk-mt8365.c
#![no_std]
...
//
    ...
    FIXED_CLK(CLK_TOP_CLK_NULL, "clk_null", core::ptr::null_mut(), 0),
    FIXED_CLK(CLK_TOP_I2S0_BCK, "i2s0_bck", core::ptr::null_mut(), 26000000),
...
pub const CLK_CFG_UPDATE1: c_uint = 0x008;
...
// bus_pll_divider_cfg
    ...
    GATE_TOP1(CLK_TOP_SSUSB_TOP_CK_EN, "ssusb_top_ck_en", core::ptr::null_mut(), 22),
    GATE_TOP1(CLK_TOP_SSUSB_PHY_CK_EN, "ssusb_phy_ck_en", core::ptr::null_mut(), 23),
...
// IFR5
    ...
    GATE_MTK_FLAGS(CLK_IFR_MCU_PM_BK, "ifr_mcu_pm_bk", core::ptr::null_mut(), &ifr5_cg_regs,
