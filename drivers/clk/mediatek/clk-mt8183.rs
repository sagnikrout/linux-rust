...
//! Source: drivers/clk/mediatek/clk-mt8183.c
#![no_std]
...
// Author: Weiyi Lu <weiyi.lu@mediatek.com>
    ...
    FIXED_CLK(CLK_TOP_ULPOSC, "osc", core::ptr::null_mut(), 250000),
...
#[no_mangle]
unsafe extern "C" fn clk_mt8183_reg_mfg_mux_notifier(dev: *mut device, clk: *mut clk) -> c_int {
