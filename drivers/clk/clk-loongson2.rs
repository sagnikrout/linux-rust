...
//! Source: drivers/clk/clk-loongson2.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson2_clk_provider {
    pub base: *mut void __iomem,
    pub dev: *mut device,
    pub /: *mut *mut spinlock_t clk_lock; / protect access to DIV registers,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct loongson2_clk_board_info {
    pub id: u8,
    pub type: enum loongson2_clk_type,
...
// Reference Clock
    ...
    CLK_FIXED(LS2K0300_CLK_STABLE, "clk_stable", core::ptr::null_mut(), 100000000),
    CLK_FIXED(LS2K0300_CLK_THSENS, "clk_thsens", core::ptr::null_mut(), 10000000),
// Node PLL
...
//
    ...
    CLK_SCALE(LOONGSON2_BOOT_CLK, "clk_boot", core::ptr::null_mut(),       0x50, 8,  3),
    ...
    CLK_SCALE(LOONGSON2_BOOT_CLK, "clk_boot", core::ptr::null_mut(),        0x50, 23, 3),
    CLK_SCALE(LOONGSON2_DES_CLK,  "clk_des",  "clk_node",  0x50, 40, 3),
    CLK_SCALE(LOONGSON2_I2S_CLK,  "clk_i2s",  "clk_node",  0x50, 44, 3),
    CLK_FIXED(LOONGSON2_MISC_CLK, "clk_misc", core::ptr::null_mut(), 50000000),
    { /* Sentinel */ },
    };
...
#[no_mangle]
pub unsafe extern "C" fn loongson2_rate_part(val: u64, shift: u8, width: u8) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn loongson2_clk_probe(pdev: *mut platform_device) -> c_int {
