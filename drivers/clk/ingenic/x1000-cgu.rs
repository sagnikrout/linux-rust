...
//! Source: drivers/clk/ingenic/x1000-cgu.c
#![no_std]
...
pub const CGU_REG_PCMCDR1: c_uint = 0xe0;
...
#[no_mangle]
unsafe extern "C" fn x1000_usb_phy_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x1000_usb_phy_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn x1000_usb_phy_is_enabled(hw: *mut clk_hw) -> c_int {
    ...
    {
    let mut m_max: c_ulong = GENMASK(pll_info.m_bits - 1, 0);
    let mut n_max: c_ulong = GENMASK(pll_info.n_bits - 1, 0);
    unsigned long m, n;
...
#[no_mangle]
unsafe extern "C" fn x1000_cgu_init(np: *mut device_node) -> void __init {
