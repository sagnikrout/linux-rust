...
//! Source: drivers/clk/samsung/clk-exynos2200.c
#![no_std]
...
pub const PLL_LOCKTIME_PLL_MMC: c_uint = 0x0;
pub const PLL_LOCKTIME_PLL_SHARED0: c_uint = 0x4;
pub const PLL_LOCKTIME_PLL_SHARED1: c_uint = 0x8;
pub const PLL_LOCKTIME_PLL_SHARED2: c_uint = 0xc;
pub const PLL_LOCKTIME_PLL_SHARED3: c_uint = 0x10;
pub const PLL_LOCKTIME_PLL_SHARED4: c_uint = 0x14;
pub const PLL_LOCKTIME_PLL_SHARED_MIF: c_uint = 0x18;
pub const PLL_CON3_PLL_MMC: c_uint = 0x10c;
pub const PLL_CON8_PLL_MMC: c_uint = 0x120;
pub const PLL_CON3_PLL_SHARED0: c_uint = 0x14c;
pub const PLL_CON8_PLL_SHARED0: c_uint = 0x160;
pub const PLL_CON3_PLL_SHARED1: c_uint = 0x18c;
pub const PLL_CON8_PLL_SHARED1: c_uint = 0x1a0;
pub const PLL_CON3_PLL_SHARED2: c_uint = 0x1cc;
pub const PLL_CON8_PLL_SHARED2: c_uint = 0x1e0;
pub const PLL_CON3_PLL_SHARED3: c_uint = 0x20c;
pub const PLL_CON8_PLL_SHARED3: c_uint = 0x220;
pub const PLL_CON3_PLL_SHARED4: c_uint = 0x24c;
pub const PLL_CON8_PLL_SHARED4: c_uint = 0x260;
pub const PLL_CON3_PLL_SHARED_MIF: c_uint = 0x28c;
pub const PLL_CON8_PLL_SHARED_MIF: c_uint = 0x2a0;
pub const PLL_CON0_MUX_CP_MPLL_CLK_D2_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CP_MPLL_CLK_D2_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CP_MPLL_CLK_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CP_MPLL_CLK_USER: c_uint = 0x614;
pub const CLK_CON_MUX_CLKCMU_AUD_AUDIF0: c_uint = 0x1000;
pub const CLK_CON_MUX_CLKCMU_AUD_AUDIF1: c_uint = 0x1004;
pub const CLK_CON_MUX_CLKCMU_AUD_CPU: c_uint = 0x1008;
pub const CLK_CON_MUX_CLKCMU_CPUCL0_DBG_NOC: c_uint = 0x100c;
pub const CLK_CON_MUX_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1010;
pub const CLK_CON_MUX_CLKCMU_CPUCL1_SWITCH: c_uint = 0x1014;
pub const CLK_CON_MUX_CLKCMU_CPUCL2_SWITCH: c_uint = 0x1018;
pub const CLK_CON_MUX_CLKCMU_DNC_NOC: c_uint = 0x101c;
pub const CLK_CON_MUX_CLKCMU_DPUB_NOC: c_uint = 0x1020;
pub const CLK_CON_MUX_CLKCMU_DPUF_NOC: c_uint = 0x1024;
pub const CLK_CON_MUX_CLKCMU_DSP_NOC: c_uint = 0x102c;
pub const CLK_CON_MUX_CLKCMU_DSU_SWITCH: c_uint = 0x1030;
pub const CLK_CON_MUX_CLKCMU_G3D_SWITCH: c_uint = 0x1034;
pub const CLK_CON_MUX_CLKCMU_GNPU_NOC: c_uint = 0x103c;
pub const CLK_CON_MUX_CLKCMU_UFS_MMC_CARD: c_uint = 0x1040;
pub const CLK_CON_MUX_CLKCMU_M2M_NOC: c_uint = 0x1044;
pub const CLK_CON_MUX_CLKCMU_NOCL0_NOC: c_uint = 0x1048;
pub const CLK_CON_MUX_CLKCMU_NOCL1A_NOC: c_uint = 0x104c;
pub const CLK_CON_MUX_CLKCMU_NOCL1B_NOC0: c_uint = 0x1050;
pub const CLK_CON_MUX_CLKCMU_NOCL1C_NOC: c_uint = 0x1054;
pub const CLK_CON_MUX_CLKCMU_SDMA_NOC: c_uint = 0x1058;
pub const CLK_CON_MUX_CP_HISPEEDY_CLK: c_uint = 0x105c;
pub const CLK_CON_MUX_CP_SHARED0_CLK: c_uint = 0x1060;
pub const CLK_CON_MUX_CP_SHARED2_CLK: c_uint = 0x1064;
pub const CLK_CON_MUX_MUX_CLKCMU_ALIVE_NOC: c_uint = 0x1068;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_AUDIF0: c_uint = 0x106c;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_AUDIF1: c_uint = 0x1070;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_CPU: c_uint = 0x1074;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_NOC: c_uint = 0x1078;
pub const CLK_CON_MUX_MUX_CLKCMU_BRP_NOC: c_uint = 0x107c;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK0: c_uint = 0x1080;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK1: c_uint = 0x1084;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK2: c_uint = 0x1088;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK3: c_uint = 0x108c;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK4: c_uint = 0x1090;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK5: c_uint = 0x1094;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK6: c_uint = 0x1098;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK7: c_uint = 0x109c;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST: c_uint = 0x10a0;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST_CAM: c_uint = 0x10a4;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST_CPU: c_uint = 0x10a8;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST_MIF: c_uint = 0x10ac;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_DBG_NOC: c_uint = 0x10b0;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_NOCP: c_uint = 0x10b4;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_SWITCH: c_uint = 0x10b8;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH: c_uint = 0x10bc;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL2_SWITCH: c_uint = 0x10c0;
pub const CLK_CON_MUX_MUX_CLKCMU_CSIS_DCPHY: c_uint = 0x10c4;
pub const CLK_CON_MUX_MUX_CLKCMU_CSIS_NOC: c_uint = 0x10c8;
pub const CLK_CON_MUX_MUX_CLKCMU_CSIS_OIS_MCU: c_uint = 0x10cc;
pub const CLK_CON_MUX_MUX_CLKCMU_CSTAT_NOC: c_uint = 0x10d0;
pub const CLK_CON_MUX_MUX_CLKCMU_DNC_NOC: c_uint = 0x10d4;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUB: c_uint = 0x10d8;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUB_ALT: c_uint = 0x10dc;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUB_DSIM: c_uint = 0x10e0;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUF: c_uint = 0x10e4;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUF_ALT: c_uint = 0x10e8;
pub const CLK_CON_MUX_MUX_CLKCMU_DSP_NOC: c_uint = 0x10f8;
pub const CLK_CON_MUX_MUX_CLKCMU_DSU_SWITCH: c_uint = 0x10fc;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D_NOCP: c_uint = 0x1100;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D_SWITCH: c_uint = 0x1104;
pub const CLK_CON_MUX_MUX_CLKCMU_GNPU_NOC: c_uint = 0x110c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_DPGTC: c_uint = 0x1114;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_DPOSC: c_uint = 0x1118;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_NOC: c_uint = 0x111c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_USB32DRD: c_uint = 0x1120;
pub const CLK_CON_MUX_MUX_CLKCMU_UFS_MMC_CARD: c_uint = 0x1124;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_NOC: c_uint = 0x1128;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_PCIE: c_uint = 0x112c;
pub const CLK_CON_MUX_MUX_CLKCMU_UFS_UFS_EMBD: c_uint = 0x1130;
pub const CLK_CON_MUX_MUX_CLKCMU_LME_LME: c_uint = 0x1134;
pub const CLK_CON_MUX_MUX_CLKCMU_LME_NOC: c_uint = 0x1138;
pub const CLK_CON_MUX_MUX_CLKCMU_M2M_NOC: c_uint = 0x1140;
pub const CLK_CON_MUX_MUX_CLKCMU_MCSC_MCSC: c_uint = 0x1148;
pub const CLK_CON_MUX_MUX_CLKCMU_MCSC_NOC: c_uint = 0x114c;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC0_MFC0: c_uint = 0x1150;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC0_WFD: c_uint = 0x1154;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC1_MFC1: c_uint = 0x1158;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_NOCP: c_uint = 0x115c;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x1160;
pub const CLK_CON_MUX_MUX_CLKCMU_NOCL0_NOC: c_uint = 0x1164;
pub const CLK_CON_MUX_MUX_CLKCMU_NOCL1A_NOC: c_uint = 0x1168;
pub const CLK_CON_MUX_MUX_CLKCMU_NOCL1B_NOC0: c_uint = 0x116c;
pub const CLK_CON_MUX_MUX_CLKCMU_NOCL1B_NOC1: c_uint = 0x1170;
pub const CLK_CON_MUX_MUX_CLKCMU_NOCL1C_NOC: c_uint = 0x1174;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_IP0: c_uint = 0x1178;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_IP1: c_uint = 0x117c;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_NOC: c_uint = 0x1180;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_IP0: c_uint = 0x1184;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_IP1: c_uint = 0x1188;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_NOC: c_uint = 0x118c;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC2_IP0: c_uint = 0x1190;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC2_IP1: c_uint = 0x1194;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC2_NOC: c_uint = 0x1198;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIS_GIC: c_uint = 0x119c;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIS_NOC: c_uint = 0x11a0;
pub const CLK_CON_MUX_MUX_CLKCMU_SDMA_NOC: c_uint = 0x11a8;
pub const CLK_CON_MUX_MUX_CLKCMU_SSP_NOC: c_uint = 0x11ac;
pub const CLK_CON_MUX_MUX_CLKCMU_VTS_DMIC: c_uint = 0x11b0;
pub const CLK_CON_MUX_MUX_CLKCMU_YUVP_NOC: c_uint = 0x11b4;
pub const CLK_CON_MUX_MUX_CMU_CMUREF: c_uint = 0x11b8;
pub const CLK_CON_MUX_MUX_CP_HISPEEDY_CLK: c_uint = 0x11bc;
pub const CLK_CON_MUX_MUX_CP_SHARED0_CLK: c_uint = 0x11c0;
pub const CLK_CON_MUX_MUX_CP_SHARED1_CLK: c_uint = 0x11c4;
pub const CLK_CON_MUX_MUX_CP_SHARED2_CLK: c_uint = 0x11c8;
pub const CLK_CON_MUX_CLKCMU_M2M_FRC: c_uint = 0x11cc;
pub const CLK_CON_MUX_CLKCMU_MCSC_MCSC: c_uint = 0x11d0;
pub const CLK_CON_MUX_CLKCMU_MCSC_NOC: c_uint = 0x11d4;
pub const CLK_CON_MUX_MUX_CLKCMU_M2M_FRC: c_uint = 0x11d8;
pub const CLK_CON_MUX_MUX_CLKCMU_UFS_NOC: c_uint = 0x11dc;
pub const CLK_CON_DIV_CLKCMU_ALIVE_NOC: c_uint = 0x1800;
pub const CLK_CON_DIV_CLKCMU_AUD_NOC: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKCMU_BRP_NOC: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKCMU_CMU_BOOST: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_CMU_BOOST_CAM: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_CMU_BOOST_CPU: c_uint = 0x1814;
pub const CLK_CON_DIV_CLKCMU_CMU_BOOST_MIF: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_NOCP: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_CSIS_DCPHY: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_CSIS_NOC: c_uint = 0x1824;
pub const CLK_CON_DIV_CLKCMU_CSIS_OIS_MCU: c_uint = 0x1828;
pub const CLK_CON_DIV_CLKCMU_CSTAT_NOC: c_uint = 0x182c;
pub const CLK_CON_DIV_CLKCMU_DPUB_DSIM: c_uint = 0x1830;
pub const CLK_CON_DIV_CLKCMU_LME_LME: c_uint = 0x1834;
pub const CLK_CON_DIV_CLKCMU_G3D_NOCP: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKCMU_HSI0_DPGTC: c_uint = 0x1840;
pub const CLK_CON_DIV_CLKCMU_HSI0_DPOSC: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_HSI0_NOC: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_HSI0_USB32DRD: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_HSI1_NOC: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_HSI1_PCIE: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_UFS_UFS_EMBD: c_uint = 0x1858;
pub const CLK_CON_DIV_CLKCMU_LME_NOC: c_uint = 0x1860;
pub const CLK_CON_DIV_CLKCMU_MFC0_MFC0: c_uint = 0x1874;
pub const CLK_CON_DIV_CLKCMU_MFC0_WFD: c_uint = 0x1878;
pub const CLK_CON_DIV_CLKCMU_MFC1_MFC1: c_uint = 0x187c;
pub const CLK_CON_DIV_CLKCMU_MIF_NOCP: c_uint = 0x1880;
pub const CLK_CON_DIV_CLKCMU_NOCL1B_NOC1: c_uint = 0x1884;
pub const CLK_CON_DIV_CLKCMU_PERIC0_IP0: c_uint = 0x1888;
pub const CLK_CON_DIV_CLKCMU_PERIC0_IP1: c_uint = 0x188c;
pub const CLK_CON_DIV_CLKCMU_PERIC0_NOC: c_uint = 0x1890;
pub const CLK_CON_DIV_CLKCMU_PERIC1_IP0: c_uint = 0x1894;
pub const CLK_CON_DIV_CLKCMU_PERIC1_IP1: c_uint = 0x1898;
pub const CLK_CON_DIV_CLKCMU_PERIC1_NOC: c_uint = 0x189c;
pub const CLK_CON_DIV_CLKCMU_PERIC2_IP0: c_uint = 0x18a0;
pub const CLK_CON_DIV_CLKCMU_PERIC2_IP1: c_uint = 0x18a4;
pub const CLK_CON_DIV_CLKCMU_PERIC2_NOC: c_uint = 0x18a8;
pub const CLK_CON_DIV_CLKCMU_PERIS_GIC: c_uint = 0x18ac;
pub const CLK_CON_DIV_CLKCMU_PERIS_NOC: c_uint = 0x18b0;
pub const CLK_CON_DIV_CLKCMU_SSP_NOC: c_uint = 0x18b8;
pub const CLK_CON_DIV_CLKCMU_VTS_DMIC: c_uint = 0x18bc;
pub const CLK_CON_DIV_CLKCMU_YUVP_NOC: c_uint = 0x18c0;
pub const CLK_CON_DIV_CP_SHARED1_CLK: c_uint = 0x18c4;
pub const CLK_CON_DIV_DIV_CLKCMU_AUD_AUDIF0: c_uint = 0x18c8;
pub const CLK_CON_DIV_DIV_CLKCMU_AUD_AUDIF0_SM: c_uint = 0x18cc;
pub const CLK_CON_DIV_DIV_CLKCMU_AUD_AUDIF1: c_uint = 0x18d0;
pub const CLK_CON_DIV_DIV_CLKCMU_AUD_AUDIF1_SM: c_uint = 0x18d4;
pub const CLK_CON_DIV_DIV_CLKCMU_AUD_CPU: c_uint = 0x18d8;
pub const CLK_CON_DIV_DIV_CLKCMU_AUD_CPU_SM: c_uint = 0x18dc;
pub const CLK_CON_DIV_DIV_CLKCMU_CIS_CLK0: c_uint = 0x18e0;
pub const CLK_CON_DIV_DIV_CLKCMU_CIS_CLK1: c_uint = 0x18e4;
pub const CLK_CON_DIV_DIV_CLKCMU_CIS_CLK2: c_uint = 0x18e8;
pub const CLK_CON_DIV_DIV_CLKCMU_CIS_CLK3: c_uint = 0x18ec;
pub const CLK_CON_DIV_DIV_CLKCMU_CIS_CLK4: c_uint = 0x18f0;
pub const CLK_CON_DIV_DIV_CLKCMU_CIS_CLK5: c_uint = 0x18f4;
pub const CLK_CON_DIV_DIV_CLKCMU_CIS_CLK6: c_uint = 0x18f8;
pub const CLK_CON_DIV_DIV_CLKCMU_CIS_CLK7: c_uint = 0x18fc;
pub const CLK_CON_DIV_DIV_CLKCMU_CPUCL0_DBG_NOC: c_uint = 0x1900;
pub const CLK_CON_DIV_DIV_CLKCMU_CPUCL0_DBG_NOC_SM: c_uint = 0x1904;
pub const CLK_CON_DIV_DIV_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1908;
pub const CLK_CON_DIV_DIV_CLKCMU_CPUCL0_SWITCH_SM: c_uint = 0x190c;
pub const CLK_CON_DIV_DIV_CLKCMU_CPUCL1_SWITCH: c_uint = 0x1910;
pub const CLK_CON_DIV_DIV_CLKCMU_CPUCL1_SWITCH_SM: c_uint = 0x1914;
pub const CLK_CON_DIV_DIV_CLKCMU_CPUCL2_SWITCH: c_uint = 0x1918;
pub const CLK_CON_DIV_DIV_CLKCMU_CPUCL2_SWITCH_SM: c_uint = 0x191c;
pub const CLK_CON_DIV_DIV_CLKCMU_DNC_NOC: c_uint = 0x1920;
pub const CLK_CON_DIV_DIV_CLKCMU_DNC_NOC_SM: c_uint = 0x1924;
pub const CLK_CON_DIV_DIV_CLKCMU_DPUB: c_uint = 0x1928;
pub const CLK_CON_DIV_DIV_CLKCMU_DPUB_ALT: c_uint = 0x192c;
pub const CLK_CON_DIV_DIV_CLKCMU_DPUF: c_uint = 0x1930;
pub const CLK_CON_DIV_DIV_CLKCMU_DPUF_ALT: c_uint = 0x1934;
pub const CLK_CON_DIV_DIV_CLKCMU_DSP_NOC: c_uint = 0x1940;
pub const CLK_CON_DIV_DIV_CLKCMU_DSP_NOC_SM: c_uint = 0x1944;
pub const CLK_CON_DIV_DIV_CLKCMU_DSU_SWITCH: c_uint = 0x1948;
pub const CLK_CON_DIV_DIV_CLKCMU_DSU_SWITCH_SM: c_uint = 0x194c;
pub const CLK_CON_DIV_DIV_CLKCMU_G3D_SWITCH: c_uint = 0x1950;
pub const CLK_CON_DIV_DIV_CLKCMU_G3D_SWITCH_SM: c_uint = 0x1954;
pub const CLK_CON_DIV_DIV_CLKCMU_GNPU_NOC: c_uint = 0x1960;
pub const CLK_CON_DIV_DIV_CLKCMU_GNPU_NOC_SM: c_uint = 0x1964;
pub const CLK_CON_DIV_DIV_CLKCMU_UFS_MMC_CARD: c_uint = 0x1968;
pub const CLK_CON_DIV_DIV_CLKCMU_UFS_MMC_CARD_SM: c_uint = 0x196c;
pub const CLK_CON_DIV_DIV_CLKCMU_M2M_NOC: c_uint = 0x1970;
pub const CLK_CON_DIV_DIV_CLKCMU_M2M_NOC_SM: c_uint = 0x1974;
pub const CLK_CON_DIV_DIV_CLKCMU_NOCL0_NOC: c_uint = 0x1978;
pub const CLK_CON_DIV_DIV_CLKCMU_NOCL0_NOC_SM: c_uint = 0x197c;
pub const CLK_CON_DIV_DIV_CLKCMU_NOCL1A_NOC: c_uint = 0x1980;
pub const CLK_CON_DIV_DIV_CLKCMU_NOCL1A_NOC_SM: c_uint = 0x1984;
pub const CLK_CON_DIV_DIV_CLKCMU_NOCL1B_NOC0: c_uint = 0x1988;
pub const CLK_CON_DIV_DIV_CLKCMU_NOCL1B_NOC0_SM: c_uint = 0x198c;
pub const CLK_CON_DIV_DIV_CLKCMU_NOCL1C_NOC: c_uint = 0x1990;
pub const CLK_CON_DIV_DIV_CLKCMU_NOCL1C_NOC_SM: c_uint = 0x1994;
pub const CLK_CON_DIV_DIV_CLKCMU_SDMA_NOC: c_uint = 0x1998;
pub const CLK_CON_DIV_DIV_CLKCMU_SDMA_NOC_SM: c_uint = 0x199c;
pub const CLK_CON_DIV_DIV_CP_HISPEEDY_CLK: c_uint = 0x19a0;
pub const CLK_CON_DIV_DIV_CP_HISPEEDY_CLK_SM: c_uint = 0x19a4;
pub const CLK_CON_DIV_DIV_CP_SHARED0_CLK: c_uint = 0x19a8;
pub const CLK_CON_DIV_DIV_CP_SHARED0_CLK_SM: c_uint = 0x19ac;
pub const CLK_CON_DIV_DIV_CP_SHARED2_CLK: c_uint = 0x19b0;
pub const CLK_CON_DIV_DIV_CP_SHARED2_CLK_SM: c_uint = 0x19b4;
pub const CLK_CON_DIV_CLKCMU_UFS_NOC: c_uint = 0x19b8;
pub const CLK_CON_DIV_DIV_CLKCMU_M2M_FRC: c_uint = 0x19bc;
pub const CLK_CON_DIV_DIV_CLKCMU_M2M_FRC_SM: c_uint = 0x19c0;
pub const CLK_CON_DIV_DIV_CLKCMU_MCSC_MCSC: c_uint = 0x19c4;
pub const CLK_CON_DIV_DIV_CLKCMU_MCSC_MCSC_SM: c_uint = 0x19c8;
pub const CLK_CON_DIV_DIV_CLKCMU_MCSC_NOC: c_uint = 0x19cc;
pub const CLK_CON_DIV_DIV_CLKCMU_MCSC_NOC_SM: c_uint = 0x19d0;
pub const CLK_CON_GAT_CLKCMU_MIF01_SWITCH: c_uint = 0x2000;
pub const CLK_CON_GAT_CLKCMU_MIF23_SWITCH: c_uint = 0x2004;
pub const CLK_CON_GAT_GATE_CLKCMU_ALIVE_NOC: c_uint = 0x200c;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_AUDIF0: c_uint = 0x2010;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_AUDIF0_SM: c_uint = 0x2014;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_AUDIF1: c_uint = 0x2018;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_AUDIF1_SM: c_uint = 0x201c;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_CPU: c_uint = 0x2020;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_CPU_SM: c_uint = 0x2024;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_NOC: c_uint = 0x2028;
pub const CLK_CON_GAT_GATE_CLKCMU_BRP_NOC: c_uint = 0x202c;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK0: c_uint = 0x2030;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK1: c_uint = 0x2034;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK2: c_uint = 0x2038;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK3: c_uint = 0x203c;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK4: c_uint = 0x2040;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK5: c_uint = 0x2044;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK6: c_uint = 0x2048;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK7: c_uint = 0x204c;
pub const CLK_CON_GAT_GATE_CLKCMU_CMU_BOOST: c_uint = 0x2050;
pub const CLK_CON_GAT_GATE_CLKCMU_CMU_BOOST_CAM: c_uint = 0x2054;
pub const CLK_CON_GAT_GATE_CLKCMU_CMU_BOOST_CPU: c_uint = 0x2058;
pub const CLK_CON_GAT_GATE_CLKCMU_CMU_BOOST_CPU_MIF: c_uint = 0x205c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_DBG_NOC: c_uint = 0x2060;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_DBG_NOC_SM: c_uint = 0x2064;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_NOCP: c_uint = 0x2068;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_SWITCH: c_uint = 0x206c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_SWITCH_SM: c_uint = 0x2070;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH: c_uint = 0x2074;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH_SM: c_uint = 0x2078;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL2_SWITCH: c_uint = 0x207c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL2_SWITCH_SM: c_uint = 0x2080;
pub const CLK_CON_GAT_GATE_CLKCMU_CSIS_DCPHY: c_uint = 0x2084;
pub const CLK_CON_GAT_GATE_CLKCMU_CSIS_NOC: c_uint = 0x2088;
pub const CLK_CON_GAT_GATE_CLKCMU_CSIS_OIS_MCU: c_uint = 0x208c;
pub const CLK_CON_GAT_GATE_CLKCMU_CSTAT_NOC: c_uint = 0x2090;
pub const CLK_CON_GAT_GATE_CLKCMU_DNC_NOC: c_uint = 0x2094;
pub const CLK_CON_GAT_GATE_CLKCMU_DNC_NOC_SM: c_uint = 0x2098;
pub const CLK_CON_GAT_GATE_CLKCMU_DPUB: c_uint = 0x209c;
pub const CLK_CON_GAT_GATE_CLKCMU_DPUB_ALT: c_uint = 0x20a0;
pub const CLK_CON_GAT_GATE_CLKCMU_DPUB_DSIM: c_uint = 0x20a4;
pub const CLK_CON_GAT_GATE_CLKCMU_DPUF: c_uint = 0x20a8;
pub const CLK_CON_GAT_GATE_CLKCMU_DPUF_ALT: c_uint = 0x20ac;
pub const CLK_CON_GAT_GATE_CLKCMU_DSP_NOC: c_uint = 0x20bc;
pub const CLK_CON_GAT_GATE_CLKCMU_DSP_NOC_SM: c_uint = 0x20c0;
pub const CLK_CON_GAT_GATE_CLKCMU_DSU_SWITCH: c_uint = 0x20c4;
pub const CLK_CON_GAT_GATE_CLKCMU_DSU_SWITCH_SM: c_uint = 0x20c8;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_NOCP: c_uint = 0x20cc;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_SWITCH: c_uint = 0x20d0;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_SWITCH_SM: c_uint = 0x20d4;
pub const CLK_CON_GAT_GATE_CLKCMU_GNPU_NOC: c_uint = 0x20e0;
pub const CLK_CON_GAT_GATE_CLKCMU_GNPU_NOC_SM: c_uint = 0x20e4;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_DPGTC: c_uint = 0x20ec;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_DPOSC: c_uint = 0x20f0;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_NOC: c_uint = 0x20f4;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_USB32DRD: c_uint = 0x20f8;
pub const CLK_CON_GAT_GATE_CLKCMU_UFS_MMC_CARD: c_uint = 0x20fc;
pub const CLK_CON_GAT_GATE_CLKCMU_UFS_MMC_CARD_SM: c_uint = 0x2100;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_NOC: c_uint = 0x2104;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_PCIE: c_uint = 0x2108;
pub const CLK_CON_GAT_GATE_CLKCMU_UFS_UFS_EMBD: c_uint = 0x210c;
pub const CLK_CON_GAT_GATE_CLKCMU_LME_LME: c_uint = 0x2110;
pub const CLK_CON_GAT_GATE_CLKCMU_LME_NOC: c_uint = 0x2114;
pub const CLK_CON_GAT_GATE_CLKCMU_M2M_NOC: c_uint = 0x2118;
pub const CLK_CON_GAT_GATE_CLKCMU_M2M_NOC_SM: c_uint = 0x211c;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC0_MFC0: c_uint = 0x212c;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC0_WFD: c_uint = 0x2130;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC1_MFC1: c_uint = 0x2134;
pub const CLK_CON_GAT_GATE_CLKCMU_MIF_NOCP: c_uint = 0x2138;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL0_NOC: c_uint = 0x213c;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL0_NOC_SM: c_uint = 0x2140;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL1A_NOC: c_uint = 0x2144;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL1A_NOC_SM: c_uint = 0x2148;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL1B_NOC0: c_uint = 0x214c;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL1B_NOC0_SM: c_uint = 0x2150;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL1B_NOC1: c_uint = 0x2154;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL1C_NOC: c_uint = 0x2158;
pub const CLK_CON_GAT_GATE_CLKCMU_NOCL1C_NOC_SM: c_uint = 0x215c;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_IP0: c_uint = 0x2160;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_IP1: c_uint = 0x2164;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_NOC: c_uint = 0x2168;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_IP0: c_uint = 0x216c;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_IP1: c_uint = 0x2170;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_NOC: c_uint = 0x2174;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC2_IP0: c_uint = 0x2178;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC2_IP1: c_uint = 0x217c;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC2_NOC: c_uint = 0x2180;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIS_GIC: c_uint = 0x2184;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIS_NOC: c_uint = 0x2188;
pub const CLK_CON_GAT_GATE_CLKCMU_SDMA_NOC: c_uint = 0x2190;
pub const CLK_CON_GAT_GATE_CLKCMU_SDMA_NOC_SM: c_uint = 0x2194;
pub const CLK_CON_GAT_GATE_CLKCMU_SSP_NOC: c_uint = 0x2198;
pub const CLK_CON_GAT_GATE_CLKCMU_VTS_DMIC: c_uint = 0x219c;
pub const CLK_CON_GAT_GATE_CLKCMU_YUVP_NOC: c_uint = 0x21a0;
pub const CLK_CON_GAT_GATE_CP_HISPEEDY_CLK: c_uint = 0x21a4;
pub const CLK_CON_GAT_GATE_CP_HISPEEDY_CLK_SM: c_uint = 0x21a8;
pub const CLK_CON_GAT_GATE_CP_SHARED0_CLK: c_uint = 0x21ac;
pub const CLK_CON_GAT_GATE_CP_SHARED0_CLK_SM: c_uint = 0x21b0;
pub const CLK_CON_GAT_GATE_CP_SHARED1_CLK: c_uint = 0x21b4;
pub const CLK_CON_GAT_GATE_CP_SHARED2_CLK: c_uint = 0x21b8;
pub const CLK_CON_GAT_GATE_CP_SHARED2_CLK_SM: c_uint = 0x21bc;
pub const CLK_CON_GAT_GATE_CLKCMU_UFS_NOC: c_uint = 0x21c0;
pub const CLK_CON_GAT_GATE_CLKCMU_M2M_FRC: c_uint = 0x21c4;
pub const CLK_CON_GAT_GATE_CLKCMU_M2M_FRC_SM: c_uint = 0x21c8;
pub const CLK_CON_GAT_GATE_CLKCMU_MCSC_MCSC: c_uint = 0x21cc;
pub const CLK_CON_GAT_GATE_CLKCMU_MCSC_MCSC_SM: c_uint = 0x21d0;
pub const CLK_CON_GAT_GATE_CLKCMU_MCSC_NOC: c_uint = 0x21d4;
pub const CLK_CON_GAT_GATE_CLKCMU_MCSC_NOC_SM: c_uint = 0x21d8;
...
// List of parent clocks for Muxes in CMU_TOP
    ...
    PLL_LOCKTIME_PLL_SHARED_MIF, PLL_CON3_PLL_SHARED_MIF, core::ptr::null_mut()),
    };
...
#[no_mangle]
unsafe extern "C" fn exynos2200_cmu_top_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_ALIVE_NOC_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CLKCMU_ALIVE_NOC_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CLKMUX_ALIVE_RCO_SPMI_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKMUX_ALIVE_RCO_SPMI_USER: c_uint = 0x614;
pub const PLL_CON0_MUX_CLK_RCO_ALIVE_USER: c_uint = 0x620;
pub const PLL_CON1_MUX_CLK_RCO_ALIVE_USER: c_uint = 0x624;
pub const CLK_CON_MUX_MUX_CLKALIVE_CHUB_PERI: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLKALIVE_CMGP_NOC: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLKALIVE_CMGP_PERI: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLKALIVE_DBGCORE_NOC: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLKALIVE_DNC_NOC: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLKALIVE_CHUBVTS_NOC: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLKALIVE_GNPU_NOC: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLKALIVE_GNSS_NOC: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLKALIVE_SDMA_NOC: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLKALIVE_UFD_NOC: c_uint = 0x1028;
pub const CLK_CON_MUX_MUX_CLK_ALIVE_DBGCORE_UART: c_uint = 0x1030;
pub const CLK_CON_MUX_MUX_CLK_ALIVE_NOC: c_uint = 0x1034;
pub const CLK_CON_MUX_MUX_CLK_ALIVE_PMU_SUB: c_uint = 0x1038;
pub const CLK_CON_MUX_MUX_CLK_ALIVE_SPMI: c_uint = 0x103c;
pub const CLK_CON_MUX_MUX_CLK_ALIVE_TIMER: c_uint = 0x1040;
pub const CLK_CON_MUX_MUX_CLKALIVE_CSIS_NOC: c_uint = 0x1044;
pub const CLK_CON_MUX_MUX_CLKALIVE_DSP_NOC: c_uint = 0x1048;
pub const CLK_CON_DIV_CLKALIVE_CHUB_PERI: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKALIVE_CMGP_NOC: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKALIVE_CMGP_PERI: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKALIVE_DBGCORE_NOC: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKALIVE_DNC_NOC: c_uint = 0x1814;
pub const CLK_CON_DIV_CLKALIVE_CHUBVTS_NOC: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKALIVE_GNPU_NOC: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKALIVE_SDMA_NOC: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKALIVE_UFD_NOC: c_uint = 0x1824;
pub const CLK_CON_DIV_DIV_CLK_ALIVE_DBGCORE_UART: c_uint = 0x182c;
pub const CLK_CON_DIV_DIV_CLK_ALIVE_NOC: c_uint = 0x1830;
pub const CLK_CON_DIV_DIV_CLK_ALIVE_PMU_SUB: c_uint = 0x1834;
pub const CLK_CON_DIV_DIV_CLK_ALIVE_SPMI: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKALIVE_CSIS_NOC: c_uint = 0x183c;
pub const CLK_CON_DIV_CLKALIVE_DSP_NOC: c_uint = 0x1840;
pub const CLK_CON_GAT_CLKALIVE_CHUBVTS_RCO: c_uint = 0x2000;
pub const CLK_CON_GAT_CLKALIVE_DNC_RCO: c_uint = 0x2004;
pub const CLK_CON_GAT_CLKALIVE_CSIS_RCO: c_uint = 0x2008;
pub const CLK_CON_GAT_CLKALIVE_GNPU_RCO: c_uint = 0x200c;
pub const CLK_CON_GAT_CLKALIVE_GNSS_NOC: c_uint = 0x2010;
pub const CLK_CON_GAT_CLKALIVE_SDMA_RCO: c_uint = 0x2014;
pub const CLK_CON_GAT_CLKALIVE_UFD_RCO: c_uint = 0x2018;
pub const CLK_CON_GAT_CLKALIVE_DSP_RCO: c_uint = 0x201c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_ALIVE_CMU_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_APBIF_GPIO_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_APBIF_INTCOMB_VGPIO2APM_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_APBIF_INTCOMB_VGPIO2AP_IPCLKPORT_PCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_APBIF_INTCOMB_VGPIO2PMU_IPCLKPORT_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_APBIF_PMU_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_APM_DMA_IPCLKPORT_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_CHUB_RTC_IPCLKPORT_OSCCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_CHUB_RTC_IPCLKPORT_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_CLKMON_IPCLKPORT_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_DBGCORE_UART_IPCLKPORT_IPCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_DBGCORE_UART_IPCLKPORT_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_BLK_ALIVE_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK: c_uint = 0x2050;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_DTZPC_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_GREBEINTEGRATION_IPCLKPORT_HCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_HW_SCANDUMP_CLKSTOP_CTRL_IPCLKPORT_ACLK: c_uint = 0x205c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_INTMEM_IPCLKPORT_I_ACLK: c_uint = 0x2060;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_INTMEM_IPCLKPORT_I_PCLK: c_uint = 0x2064;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_LH_AXI_SI_D_APM_IPCLKPORT_I_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_AP_IPCLKPORT_PCLK: c_uint = 0x206c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_CHUB_IPCLKPORT_PCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_CP_IPCLKPORT_PCLK: c_uint = 0x2074;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_GNSS_IPCLKPORT_PCLK: c_uint = 0x2078;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_VTS_IPCLKPORT_PCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_AP_CHUB_IPCLKPORT_PCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_AP_CP_IPCLKPORT_PCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_AP_CP_S_IPCLKPORT_PCLK: c_uint = 0x2088;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_AP_DBGCORE_IPCLKPORT_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_AP_GNSS_IPCLKPORT_PCLK: c_uint = 0x2090;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_CP_CHUB_IPCLKPORT_PCLK: c_uint = 0x2094;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_CP_GNSS_IPCLKPORT_PCLK: c_uint = 0x2098;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_GNSS_CHUB_IPCLKPORT_PCLK: c_uint = 0x209c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_SHARED_SRAM_IPCLKPORT_PCLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_AUD_IPCLKPORT_PCLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MCT_ALIVE_IPCLKPORT_I_PCLK: c_uint = 0x20a8;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_PMU_INTR_GEN_IPCLKPORT_PCLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_PMU_IPCLKPORT_ACLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_PMU_IPCLKPORT_CLKIN_PMU_SUB: c_uint = 0x20b4;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_MAILBOX_APM_CP_1_IPCLKPORT_PCLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_OTP_DESERIAL_ALIVE_IPCLKPORT_I_CLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_DBGCORE_UART_IPCLKPORT_CLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_GREBE_IPCLKPORT_CLK: c_uint = 0x20c8;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_NOC_IPCLKPORT_CLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_OSCCLK_RCO_IPCLKPORT_CLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_SPMI_IPCLKPORT_CLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_CLK_ALIVE_TIMER_IPCLKPORT_CLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_NOC_IPCLKPORT_CLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RTC_IPCLKPORT_PCLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_OTP_HCU_DESERIAL_IPCLKPORT_I_CLK: c_uint = 0x20e4;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_LD_GNSS_IPCLKPORT_I_CLK: c_uint = 0x20e8;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_LP_MODEM_IPCLKPORT_I_CLK: c_uint = 0x20ec;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_LD_CHUBVTS_IPCLKPORT_I_CLK: c_uint = 0x20f0;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_ID_DBGCORE_IPCLKPORT_I_CLK: c_uint = 0x20f4;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_MI_P_APM_IPCLKPORT_I_CLK: c_uint = 0x20f8;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_LP_CMGP_IPCLKPORT_I_CLK: c_uint = 0x20fc;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_IP_APM_IPCLKPORT_I_CLK: c_uint = 0x2100;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2104;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_LP_CHUBVTS_IPCLKPORT_I_CLK: c_uint = 0x2108;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_LP_PPU_IPCLKPORT_I_CLK: c_uint = 0x210c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SLH_AXI_SI_LP_ALIVEDNC_IPCLKPORT_I_CLK: c_uint = 0x2110;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SPC_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2114;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SPMI_MASTER_PMIC_IPCLKPORT_I_IPCLK: c_uint = 0x2118;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SPMI_MASTER_PMIC_IPCLKPORT_I_PCLK: c_uint = 0x211c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SWEEPER_P_ALIVE_IPCLKPORT_ACLK: c_uint = 0x2120;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_SYSREG_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2124;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_TOP_RTC_IPCLKPORT_OSCCLK: c_uint = 0x2128;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_TOP_RTC_IPCLKPORT_PCLK: c_uint = 0x212c;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_VGEN_LITE_ALIVE_IPCLKPORT_CLK: c_uint = 0x2130;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_WDT_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2134;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_XIU_DP_ALIVE_IPCLKPORT_ACLK: c_uint = 0x2138;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_OSCCLK_RCO_IPCLKPORT_CLK: c_uint = 0x213c;
pub const CLK_CON_GAT_GATE_CLKALIVE_CHUB_PERI: c_uint = 0x2140;
pub const CLK_CON_GAT_GATE_CLKALIVE_CMGP_NOC: c_uint = 0x2144;
pub const CLK_CON_GAT_GATE_CLKALIVE_CMGP_PERI: c_uint = 0x2148;
pub const CLK_CON_GAT_GATE_CLKALIVE_DBGCORE_NOC: c_uint = 0x214c;
pub const CLK_CON_GAT_GATE_CLKALIVE_DNC_NOC: c_uint = 0x2150;
pub const CLK_CON_GAT_CLK_BLK_ALIVE_UID_RSTNSYNC_SR_CLK_ALIVE_SPMI_IPCLKPORT_CLK: c_uint = 0x2154;
pub const CLK_CON_GAT_GATE_CLKALIVE_GNPU_NOC: c_uint = 0x2158;
pub const CLK_CON_GAT_GATE_CLKALIVE_SDMA_NOC: c_uint = 0x215c;
pub const CLK_CON_GAT_GATE_CLKALIVE_UFD_NOC: c_uint = 0x2160;
pub const CLK_CON_GAT_GATE_CLKALIVE_CHUBVTS_NOC: c_uint = 0x2164;
pub const CLK_CON_GAT_GATE_CLKALIVE_CSIS_NOC: c_uint = 0x2168;
pub const CLK_CON_GAT_GATE_CLKALIVE_DSP_NOC: c_uint = 0x216c;
    ...
    FRATE(0, "rco_i3c_pmic", core::ptr::null_mut(), 0, 49152000),
    FRATE(0, "rco_alive", core::ptr::null_mut(), 0, 49152000),
    FRATE(0, "rco_400", core::ptr::null_mut(), 0, 393216000),
    };
...
#[no_mangle]
unsafe extern "C" fn exynos2200_cmu_alive_init(np: *mut device_node) -> void __init {
    static void __init exynos2200_cmu_alive_init(struct device_node *np)
    {
    exynos_arm64_register_cmu(core::ptr::null_mut(), np, &alive_cmu_info);
    }
...
pub const PLL_CON0_MUX_CLKCMU_PERIS_GIC_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CLKCMU_PERIS_GIC_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CLKCMU_PERIS_NOC_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKCMU_PERIS_NOC_USER: c_uint = 0x614;
pub const CLK_CON_MUX_MUX_CLK_PERIS_GIC: c_uint = 0x1000;
pub const CLK_CON_DIV_CLKCMU_OTP: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIS_DDD_CTRL: c_uint = 0x1804;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_BUSIF_DDD_PERIS_IPCLKPORT_ATCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_BUSIF_DDD_PERIS_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_DDD_PERIS_IPCLKPORT_CK_IN: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_D_TZPC_PERIS_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_GIC_IPCLKPORT_GICCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_LH_AST_MI_LD_ICC_CPUGIC_CLUSTER0_IPCLKPORT_I_CLK: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_LH_AST_SI_LD_IRI_GICCPU_CLUSTER0_IPCLKPORT_I_CLK: c_uint = 0x2018;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_MCT_IPCLKPORT_PCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BIRA_IPCLKPORT_I_OSCCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BIRA_IPCLKPORT_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_TOP_IPCLKPORT_I_OSCCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_TOP_IPCLKPORT_PCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_PERIS_CMU_PERIS_IPCLKPORT_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2038;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_GIC_IPCLKPORT_CLK: c_uint = 0x203c;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_NOCP_IPCLKPORT_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_SLH_AXI_MI_P_PERISGIC_IPCLKPORT_I_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_SLH_AXI_MI_P_PERIS_IPCLKPORT_I_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_SYSREG_PERIS_IPCLKPORT_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_SUB_IPCLKPORT_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_TMU_TOP_IPCLKPORT_PCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_WDT0_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_WDT1_IPCLKPORT_PCLK: c_uint = 0x205c;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_RSTNSYNC_SR_CLK_PERIS_DDD_CTRL_IPCLKPORT_CLK: c_uint = 0x2060;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_RSTNSYNC_SR_CLK_PERIS_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2064;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_RSTNSYNC_SR_CLK_PERIS_GIC_IPCLKPORT_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_RSTNSYNC_SR_CLK_PERIS_NOCP_IPCLKPORT_CLK: c_uint = 0x206c;
...
#[no_mangle]
unsafe extern "C" fn exynos2200_cmu_peris_init(np: *mut device_node) -> void __init {
    static void __init exynos2200_cmu_peris_init(struct device_node *np)
    {
    exynos_arm64_register_cmu(core::ptr::null_mut(), np, &peris_cmu_info);
    }
...
pub const PLL_CON0_MUX_CLKALIVE_CMGP_NOC_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKALIVE_CMGP_NOC_USER: c_uint = 0x614;
pub const PLL_CON0_MUX_CLKALIVE_CMGP_PERI_USER: c_uint = 0x620;
pub const PLL_CON1_MUX_CLKALIVE_CMGP_PERI_USER: c_uint = 0x624;
pub const CLK_CON_MUX_MUX_CLK_CMGP_I2C: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_CMGP_SPI_I2C0: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLK_CMGP_SPI_I2C1: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLK_CMGP_SPI_MS_CTRL: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI0: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI1: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI2: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI3: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI4: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI5: c_uint = 0x1028;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI6: c_uint = 0x102c;
pub const CLK_CON_DIV_DIV_CLK_CMGP_I2C: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_CMGP_SPI_I2C0: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_CMGP_SPI_I2C1: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_CMGP_SPI_MS_CTRL: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI0: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI1: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI2: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI3: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI4: c_uint = 0x1824;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI5: c_uint = 0x1828;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI6: c_uint = 0x182c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_APBIF_GPIO_CMGP_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_CMGP_CMU_CMGP_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_CMGP_I2C_IPCLKPORT_IPCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_CMGP_I2C_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_D_TZPC_CMGP_IPCLKPORT_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP2_IPCLKPORT_IPCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP2_IPCLKPORT_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP3_IPCLKPORT_IPCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP3_IPCLKPORT_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP4_IPCLKPORT_IPCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP4_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP5_IPCLKPORT_IPCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP5_IPCLKPORT_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP6_IPCLKPORT_IPCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_I2C_CMGP6_IPCLKPORT_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_NOC_IPCLKPORT_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_CLK_CMGP_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_I2C_IPCLKPORT_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_CLK_CMGP_NOC_IPCLKPORT_CLK: c_uint = 0x2050;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_SPI_I2C0_IPCLKPORT_CLK: c_uint = 0x2054;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_SPI_I2C1_IPCLKPORT_CLK: c_uint = 0x2058;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_USI0_IPCLKPORT_CLK: c_uint = 0x205c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_USI1_IPCLKPORT_CLK: c_uint = 0x2060;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_USI2_IPCLKPORT_CLK: c_uint = 0x2064;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_USI3_IPCLKPORT_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_USI4_IPCLKPORT_CLK: c_uint = 0x206c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_USI5_IPCLKPORT_CLK: c_uint = 0x2070;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_USI6_IPCLKPORT_CLK: c_uint = 0x2074;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_RSTNSYNC_SR_CLK_CMGP_SPI_MS_CTRL_IPCLKPORT_CLK: c_uint = 0x2078;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SLH_AXI_MI_LP_CMGP_IPCLKPORT_I_CLK: c_uint = 0x207c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SLH_AXI_SI_LP_CMGPUFD_IPCLKPORT_I_CLK: c_uint = 0x2080;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SPI_I2C_CMGP0_IPCLKPORT_IPCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SPI_I2C_CMGP0_IPCLKPORT_PCLK: c_uint = 0x2088;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SPI_I2C_CMGP1_IPCLKPORT_IPCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SPI_I2C_CMGP1_IPCLKPORT_PCLK: c_uint = 0x2090;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SPI_MULTI_SLV_Q_CTRL_CMGP_IPCLKPORT_CLK: c_uint = 0x2094;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SYSREG_CMGP2APM_IPCLKPORT_PCLK: c_uint = 0x2098;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SYSREG_CMGP2CHUB_IPCLKPORT_PCLK: c_uint = 0x209c;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SYSREG_CMGP2CP_IPCLKPORT_PCLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SYSREG_CMGP2GNSS_IPCLKPORT_PCLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SYSREG_CMGP2PMU_AP_IPCLKPORT_PCLK: c_uint = 0x20a8;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_SYSREG_CMGP_IPCLKPORT_PCLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP0_IPCLKPORT_IPCLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP0_IPCLKPORT_PCLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP1_IPCLKPORT_IPCLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP1_IPCLKPORT_PCLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP2_IPCLKPORT_IPCLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP2_IPCLKPORT_PCLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP3_IPCLKPORT_IPCLK: c_uint = 0x20c8;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP3_IPCLKPORT_PCLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP4_IPCLKPORT_IPCLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP4_IPCLKPORT_PCLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP5_IPCLKPORT_IPCLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP5_IPCLKPORT_PCLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP6_IPCLKPORT_IPCLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_CLK_BLK_CMGP_UID_USI_CMGP6_IPCLKPORT_PCLK: c_uint = 0x20e4;
...
pub const PLL_CON0_MUX_CLKAUD_HSI0_NOC_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CLKAUD_HSI0_NOC_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CLKCMU_HSI0_DPGTC_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKCMU_HSI0_DPGTC_USER: c_uint = 0x614;
pub const PLL_CON0_MUX_CLKCMU_HSI0_DPOSC_USER: c_uint = 0x620;
pub const PLL_CON1_MUX_CLKCMU_HSI0_DPOSC_USER: c_uint = 0x624;
pub const PLL_CON0_MUX_CLKCMU_HSI0_NOC_USER: c_uint = 0x630;
pub const PLL_CON1_MUX_CLKCMU_HSI0_NOC_USER: c_uint = 0x634;
pub const PLL_CON0_MUX_CLKCMU_HSI0_USB32DRD_USER: c_uint = 0x640;
pub const PLL_CON1_MUX_CLKCMU_HSI0_USB32DRD_USER: c_uint = 0x644;
pub const CLK_CON_MUX_MUX_CLK_HSI0_NOC: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_HSI0_RTCCLK: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_HSI0_USB32DRD: c_uint = 0x1008;
pub const CLK_CON_DIV_DIV_CLK_HSI0_EUSB: c_uint = 0x1800;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_AS_APB_EUSBPHY_HSI0_IPCLKPORT_PCLKM: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_DP_GTC_CLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_DP_OSC_CLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_D_TZPC_HSI0_IPCLKPORT_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_HSI0_CMU_HSI0_IPCLKPORT_PCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_PPMU_HSI0_BUS1_IPCLKPORT_ACLK: c_uint = 0x2018;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_PPMU_HSI0_BUS1_IPCLKPORT_PCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_RSTNSYNC_CLK_HSI0_EUSB_IPCLKPORT_CLK: c_uint = 0x2020;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_RSTNSYNC_CLK_HSI0_NOC_IPCLKPORT_CLK: c_uint = 0x2024;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_ACEL_SI_D_HSI0_IPCLKPORT_I_CLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AST_SI_G_PPMU_HSI0_IPCLKPORT_I_CLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_MI_LD_AUDHSI0_IPCLKPORT_I_CLK: c_uint = 0x2030;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_MI_P_HSI0_IPCLKPORT_I_CLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_SLH_AXI_SI_LD_HSI0AUD_IPCLKPORT_I_CLK: c_uint = 0x2038;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_BLK_HSI0_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK: c_uint = 0x203c;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_SYSMMU_D_HSI0_IPCLKPORT_CLK_S2: c_uint = 0x2040;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_SYSREG_HSI0_IPCLKPORT_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_URAM_IPCLKPORT_ACLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_USB32DRD_IPCLKPORT_I_EUSB_APB_CLK: c_uint = 0x204c;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_USB32DRD_IPCLKPORT_I_EUSB_CTRL_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_USB32DRD_IPCLKPORT_I_USB32DRD_REF_CLK_40: c_uint = 0x2054;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_USB32DRD_IPCLKPORT_I_USBDPPHY_CTRL_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_USB32DRD_IPCLKPORT_I_USBDPPHY_TCA_APB_CLK: c_uint = 0x205c;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_USB32DRD_IPCLKPORT_I_USBLINK_ACLK: c_uint = 0x2060;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_USB32DRD_IPCLKPORT_I_USBSUBCTL_APB_PCLK: c_uint = 0x2064;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_VGEN_LITE_HSI0_IPCLKPORT_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_XIU_D_HSI0_IPCLKPORT_ACLK: c_uint = 0x206c;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_XIU_P0_HSI0_IPCLKPORT_ACLK: c_uint = 0x2070;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_OTP_DESERIAL_DPLINK_HDCP_IPCLKPORT_I_CLK: c_uint = 0x2074;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_RSTNSYNC_SR_CLK_HSI0_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2078;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_RSTNSYNC_SR_CLK_HSI0_NOC_IPCLKPORT_CLK: c_uint = 0x207c;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_SPC_HSI0_IPCLKPORT_PCLK: c_uint = 0x2080;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC0_IP0_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_IP0_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_IP1_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_IP1_USER: c_uint = 0x614;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_NOC_USER: c_uint = 0x620;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_NOC_USER: c_uint = 0x624;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_I2C: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI04: c_uint = 0x1010;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_I2C: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI04: c_uint = 0x1810;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_D_TZPC_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_GPIO_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_PERIC0_CMU_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_I2C_IPCLKPORT_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_NOCP_IPCLKPORT_CLK: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_USI04_IPCLKPORT_CLK: c_uint = 0x2018;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_SLH_AXI_MI_P_PERIC0_IPCLKPORT_I_CLK: c_uint = 0x201c;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_SYSREG_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI04_I2C_IPCLKPORT_IPCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI04_I2C_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI04_USI_IPCLKPORT_IPCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_USI04_USI_IPCLKPORT_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C00_IPCLKPORT_I_PCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C00_IPCLKPORT_I_SCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C01_IPCLKPORT_I_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C01_IPCLKPORT_I_SCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C02_IPCLKPORT_I_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_I3C02_IPCLKPORT_I_SCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_I2C_IPCLKPORT_CLK: c_uint = 0x204c;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_SR_CLK_PERIC0_NOCP_IPCLKPORT_CLK: c_uint = 0x2050;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC1_IP0_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_IP0_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_IP1_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_IP1_USER: c_uint = 0x614;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_NOC_USER: c_uint = 0x620;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_NOC_USER: c_uint = 0x624;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_I2C: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_SPI_MS_CTRL: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_UART_BT: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI07: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI07_SPI_I2C: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI08: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI08_SPI_I2C: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI09: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI10: c_uint = 0x1020;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_I2C: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_SPI_MS_CTRL: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_UART_BT: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI07: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI07_SPI_I2C: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI08: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI08_SPI_I2C: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI09: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI10: c_uint = 0x1820;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_BT_UART_IPCLKPORT_IPCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_BT_UART_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_D_TZPC_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_GPIO_PERIC1_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_I2C_IPCLKPORT_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_NOCP_IPCLKPORT_CLK: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_CMU_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_NOCP_IPCLKPORT_CLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_UART_BT_IPCLKPORT_CLK: c_uint = 0x2038;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_USI07_IPCLKPORT_CLK: c_uint = 0x203c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_USI07_SPI_I2C_IPCLKPORT_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_USI08_IPCLKPORT_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_USI08_SPI_I2C_IPCLKPORT_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_USI09_IPCLKPORT_CLK: c_uint = 0x204c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_USI10_IPCLKPORT_CLK: c_uint = 0x2050;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_SR_CLK_PERIC1_SPI_MS_CTRL_IPCLKPORT_CLK: c_uint = 0x2054;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_SLH_AXI_MI_P_PERIC1_IPCLKPORT_I_CLK: c_uint = 0x205c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_SPI_MULTI_SLV_Q_CTRL_PERIC1_IPCLKPORT_CLK: c_uint = 0x2060;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_SYSREG_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2064;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI07_SPI_I2C_IPCLKPORT_IPCLK: c_uint = 0x2068;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI07_SPI_I2C_IPCLKPORT_PCLK: c_uint = 0x206c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI07_USI_IPCLKPORT_IPCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI07_USI_IPCLKPORT_PCLK: c_uint = 0x2074;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI08_SPI_I2C_IPCLKPORT_IPCLK: c_uint = 0x2078;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI08_SPI_I2C_IPCLKPORT_PCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI08_USI_IPCLKPORT_IPCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI08_USI_IPCLKPORT_PCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI09_I2C_IPCLKPORT_IPCLK: c_uint = 0x2088;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI09_I2C_IPCLKPORT_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI09_USI_IPCLKPORT_IPCLK: c_uint = 0x2090;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI09_USI_IPCLKPORT_PCLK: c_uint = 0x2094;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI10_I2C_IPCLKPORT_IPCLK: c_uint = 0x2098;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI10_I2C_IPCLKPORT_PCLK: c_uint = 0x209c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI10_USI_IPCLKPORT_IPCLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_USI10_USI_IPCLKPORT_PCLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_XIU_P_PERIC1_IPCLKPORT_ACLK: c_uint = 0x20a8;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC2_IP0_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CLKCMU_PERIC2_IP0_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CLKCMU_PERIC2_IP1_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKCMU_PERIC2_IP1_USER: c_uint = 0x614;
pub const PLL_CON0_MUX_CLKCMU_PERIC2_NOC_USER: c_uint = 0x620;
pub const PLL_CON1_MUX_CLKCMU_PERIC2_NOC_USER: c_uint = 0x624;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_I2C: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_SPI_MS_CTRL: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_UART_DBG: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI00: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI00_SPI_I2C: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI01: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI01_SPI_I2C: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI02: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI03: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI05: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI06: c_uint = 0x1028;
pub const CLK_CON_MUX_MUX_CLK_PERIC2_USI11: c_uint = 0x102c;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_I2C: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_SPI_MS_CTRL: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_UART_DBG: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI00: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI00_SPI_I2C: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI01: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI01_SPI_I2C: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI02: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI03: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI05: c_uint = 0x1824;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI06: c_uint = 0x1828;
pub const CLK_CON_DIV_DIV_CLK_PERIC2_USI11: c_uint = 0x182c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_DBG_UART_IPCLKPORT_IPCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_DBG_UART_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_D_TZPC_PERIC2_IPCLKPORT_PCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_GPIO_PERIC2_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C03_OIS_IPCLKPORT_I_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C03_OIS_IPCLKPORT_I_SCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C04_IPCLKPORT_I_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C04_IPCLKPORT_I_SCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C05_IPCLKPORT_I_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C05_IPCLKPORT_I_SCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C06_IPCLKPORT_I_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C06_IPCLKPORT_I_SCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C07_IPCLKPORT_I_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C07_IPCLKPORT_I_SCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C08_IPCLKPORT_I_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C08_IPCLKPORT_I_SCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C09_IPCLKPORT_I_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C09_IPCLKPORT_I_SCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C10_IPCLKPORT_I_PCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C10_IPCLKPORT_I_SCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C11_IPCLKPORT_I_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_I3C11_IPCLKPORT_I_SCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_PERIC2_CMU_PERIC2_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_PWM_IPCLKPORT_I_PCLK_S0: c_uint = 0x205c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_CLK_PERIC2_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2060;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_CLK_PERIC2_I2C_IPCLKPORT_CLK: c_uint = 0x2064;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_CLK_PERIC2_NOCP_IPCLKPORT_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_UART_DBG_IPCLKPORT_CLK: c_uint = 0x206c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI00_IPCLKPORT_CLK: c_uint = 0x2070;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI00_SPI_I2C_IPCLKPORT_CLK: c_uint = 0x2074;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI01_IPCLKPORT_CLK: c_uint = 0x2078;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI01_SPI_I2C_IPCLKPORT_CLK: c_uint = 0x207c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI02_IPCLKPORT_CLK: c_uint = 0x2080;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI03_IPCLKPORT_CLK: c_uint = 0x2084;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI05_IPCLKPORT_CLK: c_uint = 0x2088;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI06_IPCLKPORT_CLK: c_uint = 0x208c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_USI11_IPCLKPORT_CLK: c_uint = 0x2090;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_SPI_MS_CTRL_IPCLKPORT_CLK: c_uint = 0x2094;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_SLH_AXI_MI_P_PERIC2_IPCLKPORT_I_CLK: c_uint = 0x2098;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_SPI_MULTI_SLV_Q_CTRL_PERIC2_IPCLKPORT_CLK: c_uint = 0x209c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_SYSREG_PERIC2_IPCLKPORT_PCLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI00_SPI_I2C_IPCLKPORT_IPCLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI00_SPI_I2C_IPCLKPORT_PCLK: c_uint = 0x20a8;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI00_USI_IPCLKPORT_IPCLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI00_USI_IPCLKPORT_PCLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI01_SPI_I2C_IPCLKPORT_IPCLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI01_SPI_I2C_IPCLKPORT_PCLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI01_USI_IPCLKPORT_IPCLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI01_USI_IPCLKPORT_PCLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI02_I2C_IPCLKPORT_IPCLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI02_I2C_IPCLKPORT_PCLK: c_uint = 0x20c8;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI02_USI_IPCLKPORT_IPCLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI02_USI_IPCLKPORT_PCLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI03_I2C_IPCLKPORT_IPCLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI03_I2C_IPCLKPORT_PCLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI03_USI_IPCLKPORT_IPCLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI03_USI_IPCLKPORT_PCLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI05_I2C_IPCLKPORT_IPCLK: c_uint = 0x20e4;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI05_I2C_IPCLKPORT_PCLK: c_uint = 0x20e8;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI05_USI_OIS_IPCLKPORT_IPCLK: c_uint = 0x20ec;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI05_USI_OIS_IPCLKPORT_PCLK: c_uint = 0x20f0;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI06_I2C_IPCLKPORT_IPCLK: c_uint = 0x20f4;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI06_I2C_IPCLKPORT_PCLK: c_uint = 0x20f8;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI06_USI_OIS_IPCLKPORT_IPCLK: c_uint = 0x20fc;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI06_USI_OIS_IPCLKPORT_PCLK: c_uint = 0x2100;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI11_I2C_IPCLKPORT_IPCLK: c_uint = 0x2104;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI11_I2C_IPCLKPORT_PCLK: c_uint = 0x2108;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI11_USI_IPCLKPORT_IPCLK: c_uint = 0x210c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_USI11_USI_IPCLKPORT_PCLK: c_uint = 0x2110;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_I2C_IPCLKPORT_CLK: c_uint = 0x2114;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_RSTNSYNC_SR_CLK_PERIC2_NOCP_IPCLKPORT_CLK: c_uint = 0x2118;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_SLH_AXI_MI_LP_CSISPERIC2_IPCLKPORT_I_CLK: c_uint = 0x211c;
pub const CLK_CON_GAT_CLK_BLK_PERIC2_UID_XIU_P_PERIC2_IPCLKPORT_ACLK: c_uint = 0x2120;
...
pub const PLL_CON0_MUX_CLKCMU_UFS_MMC_CARD_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CLKCMU_UFS_MMC_CARD_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CLKCMU_UFS_NOC_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKCMU_UFS_NOC_USER: c_uint = 0x614;
pub const PLL_CON0_MUX_CLKCMU_UFS_UFS_EMBD_USER: c_uint = 0x620;
pub const PLL_CON1_MUX_CLKCMU_UFS_UFS_EMBD_USER: c_uint = 0x624;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_BLK_UFS_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_D_TZPC_UFS_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_GPIO_HSI1UFS_IPCLKPORT_PCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_GPIO_UFS_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_LH_ACEL_SI_D_UFS_IPCLKPORT_I_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_MMC_CARD_IPCLKPORT_I_ACLK: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_MMC_CARD_IPCLKPORT_SDCLKIN: c_uint = 0x2018;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_OTP_DESERIAL_UFS_EMBD_FMP_IPCLKPORT_I_CLK: c_uint = 0x201c;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_PPMU_UFS_IPCLKPORT_ACLK: c_uint = 0x2024;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_PPMU_UFS_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_CLK_UFS_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_CLK_UFS_MMC_CARD_IPCLKPORT_CLK: c_uint = 0x2030;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_CLK_UFS_NOC_IPCLKPORT_CLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_CLK_UFS_UFS_EMBD_IPCLKPORT_CLK: c_uint = 0x2038;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_SR_CLK_UFS_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x203c;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_RSTNSYNC_SR_CLK_UFS_NOC_IPCLKPORT_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_SLH_AST_SI_G_PPMU_UFS_IPCLKPORT_I_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_SLH_AXI_MI_P_UFS_IPCLKPORT_I_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_SPC_UFS_IPCLKPORT_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_SYSMMU_UFS_IPCLKPORT_CLK_S2: c_uint = 0x2050;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_SYSREG_UFS_IPCLKPORT_PCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_UFS_CMU_UFS_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_UFS_EMBD_IPCLKPORT_I_ACLK: c_uint = 0x205c;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_UFS_EMBD_IPCLKPORT_I_CLK_UNIPRO: c_uint = 0x2060;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_UFS_EMBD_IPCLKPORT_I_FMP_CLK: c_uint = 0x2064;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_VGEN_LITE_UFS_IPCLKPORT_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_XIU_D_UFS_IPCLKPORT_ACLK: c_uint = 0x206c;
pub const CLK_CON_GAT_CLK_BLK_UFS_UID_XIU_P_UFS_IPCLKPORT_ACLK: c_uint = 0x2070;
...
pub const PLL_CON0_MUX_CLKALIVE_VTS_NOC_USER: c_uint = 0x600;
pub const PLL_CON1_MUX_CLKALIVE_VTS_NOC_USER: c_uint = 0x604;
pub const PLL_CON0_MUX_CLKALIVE_VTS_RCO_USER: c_uint = 0x610;
pub const PLL_CON1_MUX_CLKALIVE_VTS_RCO_USER: c_uint = 0x614;
pub const PLL_CON0_MUX_CLKCMU_VTS_DMIC_USER: c_uint = 0x620;
pub const PLL_CON1_MUX_CLKCMU_VTS_DMIC_USER: c_uint = 0x624;
pub const CLK_CON_MUX_MUX_CLKVTS_AUD_DMIC1: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_VTS_NOC: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_VTS_DMIC_PAD: c_uint = 0x100c;
pub const CLK_CON_DIV_DIV_CLKVTS_AUD_DMIC0: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLKVTS_AUD_DMIC1: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_VTS_CPU: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_VTS_DMIC_IF: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_VTS_DMIC_IF_DIV2: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_VTS_NOC: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_VTS_SERIAL_LIF_CORE: c_uint = 0x1824;
pub const CLK_CON_GAT_CLKVTS_AUD_DMIC0: c_uint = 0x2000;
pub const CLK_CON_GAT_CLKVTS_AUD_DMIC1: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_BAAW_VTS_IPCLKPORT_I_PCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_LH_AXI_MI_IP_VC2VTS_IPCLKPORT_I_CLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_LH_AXI_SI_ID_VTS2VC_IPCLKPORT_I_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_CLK_VTS_FREE_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_DMIC_IF_IPCLKPORT_CLK: c_uint = 0x2018;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_CORE_IPCLKPORT_CLK: c_uint = 0x2020;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_SERIAL_LIF_IPCLKPORT_CLK: c_uint = 0x2024;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_YAMIN_IPCLKPORT_CLK: c_uint = 0x2028;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_VT_IPCLKPORT_ACLK: c_uint = 0x202c;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SS_VTS_FRC_OTP_DESERIAL_IPCLKPORT_I_CLK: c_uint = 0x2030;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_ASYNCINTERRUPT_VTS_IPCLKPORT_CLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF0_IPCLKPORT_DMIC_IF_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF0_IPCLKPORT_DMIC_IF_DIV2_CLK: c_uint = 0x206c;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF0_IPCLKPORT_PCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF1_IPCLKPORT_DMIC_IF_CLK: c_uint = 0x2074;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF1_IPCLKPORT_DMIC_IF_DIV2_CLK: c_uint = 0x2078;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF1_IPCLKPORT_PCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF2_IPCLKPORT_DMIC_IF_CLK: c_uint = 0x2080;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF2_IPCLKPORT_DMIC_IF_DIV2_CLK: c_uint = 0x2084;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_DMIC_IF2_IPCLKPORT_PCLK: c_uint = 0x2088;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_GPIO_VTS_IPCLKPORT_PCLK: c_uint = 0x2090;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_INTMEM_CODE_IPCLKPORT_I_ACLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_INTMEM_CODE_IPCLKPORT_I_PCLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_INTMEM_DATA0_IPCLKPORT_I_ACLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_INTMEM_DATA0_IPCLKPORT_I_PCLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_INTMEM_DATA1_IPCLKPORT_I_ACLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_INTMEM_DATA1_IPCLKPORT_I_PCLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_INTMEM_PCM_IPCLKPORT_I_ACLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_INTMEM_PCM_IPCLKPORT_I_PCLK: c_uint = 0x20c8;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_MAILBOX_ABOX_VTS_IPCLKPORT_PCLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_MAILBOX_AP_VTS_IPCLKPORT_PCLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_MAILBOX_DNC_VTS_IPCLKPORT_PCLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_CLK_VTS_NOC_IPCLKPORT_CLK: c_uint = 0x20ec;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_CLK_VTS_YAMIN_IPCLKPORT_CLK: c_uint = 0x20f8;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_RSTNSYNC_SR_CLK_VTS_NOC_IPCLKPORT_CLK: c_uint = 0x20fc;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_VT_IPCLKPORT_BCLK: c_uint = 0x2104;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_VT_IPCLKPORT_CCLK: c_uint = 0x2108;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SERIAL_LIF_VT_IPCLKPORT_PCLK: c_uint = 0x210c;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SS_VTS_GLUE_IPCLKPORT_ACLK_CPU: c_uint = 0x2124;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SS_VTS_GLUE_IPCLKPORT_DMIC_AUD_DIV2_CLK: c_uint = 0x2128;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SS_VTS_GLUE_IPCLKPORT_DMIC_IF_PAD_CLK0: c_uint = 0x212c;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SS_VTS_GLUE_IPCLKPORT_DMIC_IF_PAD_CLK1: c_uint = 0x2130;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SS_VTS_GLUE_IPCLKPORT_DMIC_IF_PAD_CLK2: c_uint = 0x2134;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_SYSREG_VTS_IPCLKPORT_PCLK: c_uint = 0x213c;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_TIMER1_IPCLKPORT_PCLK: c_uint = 0x2140;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_TIMER2_IPCLKPORT_PCLK: c_uint = 0x2144;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_TIMER_IPCLKPORT_PCLK: c_uint = 0x2148;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_VTS_CMU_VTS_IPCLKPORT_PCLK: c_uint = 0x2150;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_WDT_VTS_IPCLKPORT_PCLK: c_uint = 0x2154;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_XIU_DP0_VTS_IPCLKPORT_ACLK: c_uint = 0x2158;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_YAMIN_MCU_VTS_IPCLKPORT_CLKIN: c_uint = 0x215c;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_YAMIN_MCU_VTS_IPCLKPORT_DBGCLK: c_uint = 0x2160;
pub const CLK_CON_GAT_CLK_BLK_VTS_UID_YAMIN_MCU_VTS_IPCLKPORT_IWICCLK: c_uint = 0x2164;
    ...
    FRATE(0, "dmic_clk0_in", core::ptr::null_mut(), 0, 100000000),
    FRATE(0, "dmic_clk1_in", core::ptr::null_mut(), 0, 100000000),
    FRATE(0, "dmic_clk2_in", core::ptr::null_mut(), 0, 100000000),
    };
...
#[no_mangle]
unsafe extern "C" fn exynos2200_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynos2200_cmu_init() -> int __init {
