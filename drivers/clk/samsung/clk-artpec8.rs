...
//! Source: drivers/clk/samsung/clk-artpec8.c
#![no_std]
...
pub const CLK_CON_MUX_CLKCMU_2D: c_uint = 0x1000;
pub const CLK_CON_MUX_CLKCMU_3D: c_uint = 0x1004;
pub const CLK_CON_MUX_CLKCMU_BUS: c_uint = 0x1008;
pub const CLK_CON_MUX_CLKCMU_BUS_DLP: c_uint = 0x100c;
pub const CLK_CON_MUX_CLKCMU_CDC_CORE: c_uint = 0x1010;
pub const CLK_CON_MUX_CLKCMU_FSYS_SCAN0: c_uint = 0x1014;
pub const CLK_CON_MUX_CLKCMU_FSYS_SCAN1: c_uint = 0x1018;
pub const CLK_CON_MUX_CLKCMU_IMEM_JPEG: c_uint = 0x101c;
pub const CLK_CON_MUX_CLKCMU_PERI_DISP: c_uint = 0x1020;
pub const CLK_CON_MUX_CLKCMU_CORE_BUS: c_uint = 0x1024;
pub const CLK_CON_MUX_CLKCMU_CORE_DLP: c_uint = 0x1028;
pub const CLK_CON_MUX_CLKCMU_CPUCL_SWITCH: c_uint = 0x1030;
pub const CLK_CON_MUX_CLKCMU_DLP_CORE: c_uint = 0x1034;
pub const CLK_CON_MUX_CLKCMU_FSYS_BUS: c_uint = 0x1038;
pub const CLK_CON_MUX_CLKCMU_FSYS_IP: c_uint = 0x103c;
pub const CLK_CON_MUX_CLKCMU_IMEM_ACLK: c_uint = 0x1054;
pub const CLK_CON_MUX_CLKCMU_MIF_BUSP: c_uint = 0x1080;
pub const CLK_CON_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x1084;
pub const CLK_CON_MUX_CLKCMU_PERI_IP: c_uint = 0x1088;
pub const CLK_CON_MUX_CLKCMU_RSP_CORE: c_uint = 0x108c;
pub const CLK_CON_MUX_CLKCMU_TRFM_CORE: c_uint = 0x1090;
pub const CLK_CON_MUX_CLKCMU_VCA_ACE: c_uint = 0x1094;
pub const CLK_CON_MUX_CLKCMU_VCA_OD: c_uint = 0x1098;
pub const CLK_CON_MUX_CLKCMU_VIO_CORE: c_uint = 0x109c;
pub const CLK_CON_MUX_CLKCMU_VIP0_CORE: c_uint = 0x10a0;
pub const CLK_CON_MUX_CLKCMU_VIP1_CORE: c_uint = 0x10a4;
pub const CLK_CON_MUX_CLKCMU_VPP_CORE: c_uint = 0x10a8;
pub const CLK_CON_DIV_CLKCMU_BUS: c_uint = 0x1800;
pub const CLK_CON_DIV_CLKCMU_BUS_DLP: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKCMU_CDC_CORE: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKCMU_FSYS_SCAN0: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_FSYS_SCAN1: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_IMEM_JPEG: c_uint = 0x1814;
pub const CLK_CON_DIV_CLKCMU_MIF_SWITCH: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKCMU_CORE_DLP: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_CORE_MAIN: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_PERI_DISP: c_uint = 0x1824;
pub const CLK_CON_DIV_CLKCMU_CPUCL_SWITCH: c_uint = 0x1828;
pub const CLK_CON_DIV_CLKCMU_DLP_CORE: c_uint = 0x182c;
pub const CLK_CON_DIV_CLKCMU_FSYS_BUS: c_uint = 0x1830;
pub const CLK_CON_DIV_CLKCMU_FSYS_IP: c_uint = 0x1834;
pub const CLK_CON_DIV_CLKCMU_VIO_AUDIO: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKCMU_GPU_2D: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_GPU_3D: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_IMEM_ACLK: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_MIF_BUSP: c_uint = 0x1884;
pub const CLK_CON_DIV_CLKCMU_PERI_AUDIO: c_uint = 0x1890;
pub const CLK_CON_DIV_CLKCMU_PERI_IP: c_uint = 0x1894;
pub const CLK_CON_DIV_CLKCMU_RSP_CORE: c_uint = 0x1898;
pub const CLK_CON_DIV_CLKCMU_TRFM_CORE: c_uint = 0x189c;
pub const CLK_CON_DIV_CLKCMU_VCA_ACE: c_uint = 0x18a0;
pub const CLK_CON_DIV_CLKCMU_VCA_OD: c_uint = 0x18a4;
pub const CLK_CON_DIV_CLKCMU_VIO_CORE: c_uint = 0x18ac;
pub const CLK_CON_DIV_CLKCMU_VIP0_CORE: c_uint = 0x18b0;
pub const CLK_CON_DIV_CLKCMU_VIP1_CORE: c_uint = 0x18b4;
pub const CLK_CON_DIV_CLKCMU_VPP_CORE: c_uint = 0x18b8;
pub const CLK_CON_DIV_PLL_SHARED0_DIV2: c_uint = 0x18bc;
pub const CLK_CON_DIV_PLL_SHARED0_DIV3: c_uint = 0x18c0;
pub const CLK_CON_DIV_PLL_SHARED0_DIV4: c_uint = 0x18c4;
pub const CLK_CON_DIV_PLL_SHARED1_DIV2: c_uint = 0x18c8;
pub const CLK_CON_DIV_PLL_SHARED1_DIV3: c_uint = 0x18cc;
pub const CLK_CON_DIV_PLL_SHARED1_DIV4: c_uint = 0x18d0;
...
pub const PLL_CON0_MUX_CLK_BUS_DLP_USER: c_uint = 0x0120;
pub const CLK_CON_DIV_CLK_BUS_PCLK: c_uint = 0x1800;
...
pub const PLL_CON0_MUX_CLK_CORE_DLP_USER: c_uint = 0x0120;
pub const CLK_CON_DIV_CLK_CORE_PCLK: c_uint = 0x1800;
...
pub const PLL_LOCKTIME_PLL_CPUCL: c_uint = 0x0000;
pub const PLL_CON0_MUX_CLKCMU_CPUCL_SWITCH_USER: c_uint = 0x0120;
pub const PLL_CON0_PLL_CPUCL: c_uint = 0x0140;
pub const CLK_CON_MUX_CLK_CPUCL_PLL: c_uint = 0x1000;
pub const CLK_CON_DIV_CLK_CLUSTER_ACLK: c_uint = 0x1800;
pub const CLK_CON_DIV_CLK_CLUSTER_CNTCLK: c_uint = 0x1804;
pub const CLK_CON_DIV_CLK_CLUSTER_PCLKDBG: c_uint = 0x1808;
pub const CLK_CON_DIV_CLK_CPUCL_CMUREF: c_uint = 0x180c;
pub const CLK_CON_DIV_CLK_CPUCL_PCLK: c_uint = 0x1814;
pub const CLK_CON_DIV_CLK_CLUSTER_ATCLK: c_uint = 0x1818;
pub const CLK_CON_DIV_CLK_CPUCL_DBG: c_uint = 0x181c;
pub const CLK_CON_DIV_CLK_CPUCL_PCLKDBG: c_uint = 0x1820;
pub const CLK_CON_GAT_CLK_CLUSTER_CPU: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_CPUCL_SHORTSTOP: c_uint = 0x200c;
pub const CLK_CON_DMYQCH_CON_CSSYS_QCH: c_uint = 0x3008;
    ...
    PLL_LOCKTIME_PLL_CPUCL, PLL_CON0_PLL_CPUCL, core::ptr::null_mut()),
    };
...
pub const PLL_LOCKTIME_PLL_FSYS: c_uint = 0x0004;
pub const PLL_CON0_MUX_CLK_FSYS_BUS_USER: c_uint = 0x0120;
pub const PLL_CON0_MUX_CLK_FSYS_MMC_USER: c_uint = 0x0140;
pub const PLL_CON0_MUX_CLK_FSYS_SCAN0_USER: c_uint = 0x0160;
pub const PLL_CON0_MUX_CLK_FSYS_SCAN1_USER: c_uint = 0x0180;
pub const PLL_CON0_PLL_FSYS: c_uint = 0x01c0;
pub const CLK_CON_DIV_CLK_FSYS_ADC: c_uint = 0x1804;
pub const CLK_CON_DIV_CLK_FSYS_BUS300: c_uint = 0x1808;
pub const CLK_CON_DIV_CLK_FSYS_BUS_QSPI: c_uint = 0x180c;
pub const CLK_CON_DIV_CLK_FSYS_EQOS_25: c_uint = 0x1810;
pub const CLK_CON_DIV_CLK_FSYS_EQOS_2P5: c_uint = 0x1814;
pub const CLK_CON_DIV_CLK_FSYS_EQOS_500: c_uint = 0x1818;
pub const CLK_CON_DIV_CLK_FSYS_EQOS_INT125: c_uint = 0x181c;
pub const CLK_CON_DIV_CLK_FSYS_MMC_CARD0: c_uint = 0x1820;
pub const CLK_CON_DIV_CLK_FSYS_MMC_CARD1: c_uint = 0x1824;
pub const CLK_CON_DIV_CLK_FSYS_OTP_MEM: c_uint = 0x1828;
pub const CLK_CON_DIV_CLK_FSYS_PCIE_PHY_REFCLK_SYSPLL: c_uint = 0x182c;
pub const CLK_CON_DIV_CLK_FSYS_QSPI: c_uint = 0x1830;
pub const CLK_CON_DIV_CLK_FSYS_SCLK_UART: c_uint = 0x1834;
pub const CLK_CON_DIV_CLK_FSYS_SFMC_NAND: c_uint = 0x1838;
pub const CLK_CON_DIV_SCAN_CLK_FSYS_125: c_uint = 0x183c;
pub const CLK_CON_DIV_SCAN_CLK_FSYS_MMC: c_uint = 0x1840;
pub const CLK_CON_DIV_SCAN_CLK_FSYS_PCIE_PIPE: c_uint = 0x1844;
pub const CLK_CON_FSYS_I2C0_IPCLKPORT_I_PCLK: c_uint = 0x2044;
pub const CLK_CON_FSYS_I2C1_IPCLKPORT_I_PCLK: c_uint = 0x2048;
pub const CLK_CON_FSYS_UART0_IPCLKPORT_I_PCLK: c_uint = 0x204c;
pub const CLK_CON_FSYS_UART0_IPCLKPORT_I_SCLK_UART: c_uint = 0x2050;
pub const CLK_CON_MMC0_IPCLKPORT_I_ACLK: c_uint = 0x2070;
pub const CLK_CON_MMC1_IPCLKPORT_I_ACLK: c_uint = 0x2078;
pub const CLK_CON_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG: c_uint = 0x208c;
pub const CLK_CON_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG: c_uint = 0x2090;
pub const CLK_CON_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG: c_uint = 0x2094;
pub const CLK_CON_PWM_IPCLKPORT_I_PCLK_S0: c_uint = 0x20a0;
pub const CLK_CON_USB20DRD_IPCLKPORT_ACLK_PHYCTRL_20: c_uint = 0x20bc;
pub const CLK_CON_USB20DRD_IPCLKPORT_BUS_CLK_EARLY: c_uint = 0x20c0;
pub const CLK_CON_XHB_AHBBR_IPCLKPORT_CLK: c_uint = 0x20c4;
pub const CLK_CON_XHB_USB_IPCLKPORT_CLK: c_uint = 0x20cc;
pub const CLK_CON_BUS_P_FSYS_IPCLKPORT_QSPICLK: c_uint = 0x201c;
pub const CLK_CON_DMYQCH_CON_EQOS_TOP_QCH: c_uint = 0x3008;
pub const CLK_CON_DMYQCH_CON_MMC0_QCH: c_uint = 0x300c;
pub const CLK_CON_DMYQCH_CON_MMC1_QCH: c_uint = 0x3010;
pub const CLK_CON_DMYQCH_CON_PCIE_TOP_QCH: c_uint = 0x3018;
pub const CLK_CON_DMYQCH_CON_PCIE_TOP_QCH_REF: c_uint = 0x301c;
pub const CLK_CON_DMYQCH_CON_QSPI_QCH: c_uint = 0x3020;
pub const CLK_CON_DMYQCH_CON_SFMC_QCH: c_uint = 0x3024;
    ...
    PLL_LOCKTIME_PLL_FSYS, PLL_CON0_PLL_FSYS, core::ptr::null_mut()),
    };
...
pub const PLL_CON0_MUX_CLK_IMEM_JPEG_USER: c_uint = 0x0120;
pub const CLK_CON_MUX_CLK_IMEM_GIC_CA53: c_uint = 0x1000;
pub const CLK_CON_MUX_CLK_IMEM_GIC_CA5: c_uint = 0x1008;
pub const CLK_CON_MCT_IPCLKPORT_PCLK: c_uint = 0x2038;
pub const CLK_CON_SFRIF_TMU_IMEM_IPCLKPORT_PCLK: c_uint = 0x2044;
...
#[no_mangle]
unsafe extern "C" fn artpec8_clk_cmu_imem_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLK_PERI_AUDIO_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLK_PERI_DISP_USER: c_uint = 0x0120;
pub const PLL_CON0_MUX_CLK_PERI_IP_USER: c_uint = 0x0140;
pub const CLK_CON_MUX_CLK_PERI_I2S0: c_uint = 0x1000;
pub const CLK_CON_MUX_CLK_PERI_I2S1: c_uint = 0x1004;
pub const CLK_CON_DIV_CLK_PERI_DSIM: c_uint = 0x1800;
pub const CLK_CON_DIV_CLK_PERI_I2S0: c_uint = 0x1804;
pub const CLK_CON_DIV_CLK_PERI_I2S1: c_uint = 0x1808;
...
pub const CLK_CON_APB_ASYNC_DSIM_IPCLKPORT_PCLKS: c_uint = 0x2004;
pub const CLK_CON_PERI_I2C2_IPCLKPORT_I_PCLK: c_uint = 0x2030;
pub const CLK_CON_PERI_I2C3_IPCLKPORT_I_PCLK: c_uint = 0x2034;
pub const CLK_CON_PERI_SPI0_IPCLKPORT_I_PCLK: c_uint = 0x2048;
pub const CLK_CON_PERI_SPI0_IPCLKPORT_I_SCLK_SPI: c_uint = 0x204c;
pub const CLK_CON_PERI_UART1_IPCLKPORT_I_PCLK: c_uint = 0x2050;
pub const CLK_CON_PERI_UART1_IPCLKPORT_I_SCLK_UART: c_uint = 0x2054;
pub const CLK_CON_PERI_UART2_IPCLKPORT_I_PCLK: c_uint = 0x2058;
pub const CLK_CON_PERI_UART2_IPCLKPORT_I_SCLK_UART: c_uint = 0x205c;
pub const CLK_CON_DMYQCH_CON_AUDIO_OUT_QCH: c_uint = 0x3000;
pub const CLK_CON_DMYQCH_CON_DMA4DSIM_QCH: c_uint = 0x3004;
pub const CLK_CON_DMYQCH_CON_PERI_I2SSC0_QCH: c_uint = 0x3008;
pub const CLK_CON_DMYQCH_CON_PERI_I2SSC1_QCH: c_uint = 0x300c;
    ...
    FRATE(0, "clk_peri_audio", core::ptr::null_mut(), 0, 100000000),
    };
...
//
#[no_mangle]
unsafe extern "C" fn artpec8_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn artpec8_cmu_init() -> int __init {
