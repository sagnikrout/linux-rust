...
//! Source: drivers/clk/samsung/clk-exynos4412-isp.c
#![no_std]
...
pub const E4X12_DIV_ISP0: c_uint = 0x0300;
pub const E4X12_DIV_ISP1: c_uint = 0x0304;
pub const E4X12_GATE_ISP0: c_uint = 0x0800;
pub const E4X12_GATE_ISP1: c_uint = 0x0804;
...
#[no_mangle]
unsafe extern "C" fn exynos4x12_isp_clk_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn exynos4x12_isp_clk_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn exynos4x12_isp_clk_probe(pdev: *mut platform_device) -> int __init {
    ...
    exynos4x12_isp_clk_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn exynos4x12_isp_clk_init() -> int __init {
