...
//! Source: drivers/clk/samsung/clk-exynos7885.c
#![no_std]
...
pub const PLL_CON0_PLL_SHARED1: c_uint = 0x0120;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_BUS: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_CCI: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_G3D: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS_BUS: c_uint = 0x1028;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS_MMC_CARD: c_uint = 0x102c;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS_MMC_EMBD: c_uint = 0x1030;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS_MMC_SDIO: c_uint = 0x1034;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS_USB30DRD: c_uint = 0x1038;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_BUS: c_uint = 0x1058;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_SPI0: c_uint = 0x105c;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_SPI1: c_uint = 0x1060;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_UART0: c_uint = 0x1064;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_UART1: c_uint = 0x1068;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_UART2: c_uint = 0x106c;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_USI0: c_uint = 0x1070;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_USI1: c_uint = 0x1074;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_USI2: c_uint = 0x1078;
pub const CLK_CON_DIV_CLKCMU_CORE_BUS: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_CORE_CCI: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_CORE_G3D: c_uint = 0x1824;
pub const CLK_CON_DIV_CLKCMU_FSYS_BUS: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_FSYS_MMC_CARD: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_FSYS_MMC_EMBD: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_FSYS_MMC_SDIO: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_FSYS_USB30DRD: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_PERI_BUS: c_uint = 0x1874;
pub const CLK_CON_DIV_CLKCMU_PERI_SPI0: c_uint = 0x1878;
pub const CLK_CON_DIV_CLKCMU_PERI_SPI1: c_uint = 0x187c;
pub const CLK_CON_DIV_CLKCMU_PERI_UART0: c_uint = 0x1880;
pub const CLK_CON_DIV_CLKCMU_PERI_UART1: c_uint = 0x1884;
pub const CLK_CON_DIV_CLKCMU_PERI_UART2: c_uint = 0x1888;
pub const CLK_CON_DIV_CLKCMU_PERI_USI0: c_uint = 0x188c;
pub const CLK_CON_DIV_CLKCMU_PERI_USI1: c_uint = 0x1890;
pub const CLK_CON_DIV_CLKCMU_PERI_USI2: c_uint = 0x1894;
pub const CLK_CON_DIV_PLL_SHARED0_DIV2: c_uint = 0x189c;
pub const CLK_CON_DIV_PLL_SHARED0_DIV3: c_uint = 0x18a0;
pub const CLK_CON_DIV_PLL_SHARED0_DIV4: c_uint = 0x18a4;
pub const CLK_CON_DIV_PLL_SHARED0_DIV5: c_uint = 0x18a8;
pub const CLK_CON_DIV_PLL_SHARED1_DIV2: c_uint = 0x18ac;
pub const CLK_CON_DIV_PLL_SHARED1_DIV3: c_uint = 0x18b0;
pub const CLK_CON_DIV_PLL_SHARED1_DIV4: c_uint = 0x18b4;
pub const CLK_CON_GAT_GATE_CLKCMUC_PERI_UART1: c_uint = 0x2004;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_BUS: c_uint = 0x201c;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_CCI: c_uint = 0x2020;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_G3D: c_uint = 0x2024;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS_BUS: c_uint = 0x2044;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS_MMC_CARD: c_uint = 0x2048;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS_MMC_EMBD: c_uint = 0x204c;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS_MMC_SDIO: c_uint = 0x2050;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS_USB30DRD: c_uint = 0x2054;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_BUS: c_uint = 0x207c;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_SPI0: c_uint = 0x2080;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_SPI1: c_uint = 0x2084;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_UART0: c_uint = 0x2088;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_UART2: c_uint = 0x208c;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_USI0: c_uint = 0x2090;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_USI1: c_uint = 0x2094;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_USI2: c_uint = 0x2098;
...
#[no_mangle]
unsafe extern "C" fn exynos7885_cmu_top_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_PERI_BUS_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLKCMU_PERI_SPI0_USER: c_uint = 0x0120;
pub const PLL_CON0_MUX_CLKCMU_PERI_SPI1_USER: c_uint = 0x0140;
pub const PLL_CON0_MUX_CLKCMU_PERI_UART0_USER: c_uint = 0x0160;
pub const PLL_CON0_MUX_CLKCMU_PERI_UART1_USER: c_uint = 0x0180;
pub const PLL_CON0_MUX_CLKCMU_PERI_UART2_USER: c_uint = 0x01a0;
pub const PLL_CON0_MUX_CLKCMU_PERI_USI0_USER: c_uint = 0x01c0;
pub const PLL_CON0_MUX_CLKCMU_PERI_USI1_USER: c_uint = 0x01e0;
pub const PLL_CON0_MUX_CLKCMU_PERI_USI2_USER: c_uint = 0x0200;
pub const CLK_CON_GAT_GOUT_PERI_GPIO_TOP_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_0_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_1_PCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_2_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_3_PCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_PERI_I2C_0_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_PERI_I2C_1_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_PERI_I2C_2_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_PERI_I2C_3_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_PERI_I2C_4_PCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_PERI_I2C_5_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_PERI_I2C_6_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_PERI_I2C_7_PCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_PERI_PWM_MOTOR_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_PERI_SPI_0_PCLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_PERI_SPI_0_EXT_CLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_PERI_SPI_1_PCLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_PERI_SPI_1_EXT_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_PERI_UART_0_EXT_UCLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_PERI_UART_0_PCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_PERI_UART_1_EXT_UCLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_PERI_UART_1_PCLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_PERI_UART_2_EXT_UCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_PERI_UART_2_PCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_PERI_USI0_PCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_PERI_USI0_SCLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_PERI_USI1_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_PERI_USI1_SCLK: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_PERI_USI2_PCLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_PERI_USI2_SCLK: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_PERI_MCT_PCLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_PERI_SYSREG_PERI_PCLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_PERI_WDT_CLUSTER0_PCLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_PERI_WDT_CLUSTER1_PCLK: c_uint = 0x20b8;
...
#[no_mangle]
unsafe extern "C" fn exynos7885_cmu_peri_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_CORE_BUS_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLKCMU_CORE_CCI_USER: c_uint = 0x0120;
pub const PLL_CON0_MUX_CLKCMU_CORE_G3D_USER: c_uint = 0x0140;
pub const CLK_CON_MUX_MUX_CLK_CORE_GIC: c_uint = 0x1000;
pub const CLK_CON_DIV_DIV_CLK_CORE_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_GOUT_CORE_CCI_550_ACLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_CORE_GIC400_CLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_CORE_TREX_D_CORE_ACLK: c_uint = 0x215c;
pub const CLK_CON_GAT_GOUT_CORE_TREX_D_CORE_GCLK: c_uint = 0x2160;
pub const CLK_CON_GAT_GOUT_CORE_TREX_D_CORE_PCLK: c_uint = 0x2164;
pub const CLK_CON_GAT_GOUT_CORE_TREX_P_CORE_ACLK_P_CORE: c_uint = 0x2168;
pub const CLK_CON_GAT_GOUT_CORE_TREX_P_CORE_CCLK_P_CORE: c_uint = 0x216c;
pub const CLK_CON_GAT_GOUT_CORE_TREX_P_CORE_PCLK: c_uint = 0x2170;
pub const CLK_CON_GAT_GOUT_CORE_TREX_P_CORE_PCLK_P_CORE: c_uint = 0x2174;
...
pub const PLL_LOCKTIME_PLL_USB: c_uint = 0x0000;
pub const PLL_CON0_MUX_CLKCMU_FSYS_BUS_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLKCMU_FSYS_MMC_CARD_USER: c_uint = 0x0120;
pub const PLL_CON0_MUX_CLKCMU_FSYS_MMC_EMBD_USER: c_uint = 0x0140;
pub const PLL_CON0_MUX_CLKCMU_FSYS_MMC_SDIO_USER: c_uint = 0x0160;
pub const PLL_CON0_MUX_CLKCMU_FSYS_USB30DRD_USER: c_uint = 0x0180;
pub const PLL_CON0_PLL_USB: c_uint = 0x01a0;
pub const CLK_CON_GAT_CLK_FSYS_USB20PHY_CLKCORE: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_FSYS_MMC_CARD_I_ACLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_FSYS_MMC_CARD_SDCLKIN: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_FSYS_MMC_EMBD_I_ACLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_FSYS_MMC_EMBD_SDCLKIN: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_FSYS_MMC_SDIO_I_ACLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_FSYS_MMC_SDIO_SDCLKIN: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_FSYS_USB30DRD_ACLK_20PHYCTRL: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_FSYS_USB30DRD_ACLK_30PHYCTRL_0: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_FSYS_USB30DRD_ACLK_30PHYCTRL_1: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_FSYS_USB30DRD_BUS_CLK_EARLY: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_FSYS_USB30DRD_REF_CLK: c_uint = 0x2078;
...
// ---- platform_driver -----------------------------------------------------
#[no_mangle]
unsafe extern "C" fn exynos7885_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynos7885_cmu_init() -> int __init {
