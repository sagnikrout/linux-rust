...
//! Source: drivers/clk/samsung/clk-fsd.c
#![no_std]
...
pub const PLL_LOCKTIME_PLL_SHARED0: c_uint = 0x0;
pub const PLL_LOCKTIME_PLL_SHARED1: c_uint = 0x4;
pub const PLL_LOCKTIME_PLL_SHARED2: c_uint = 0x8;
pub const PLL_LOCKTIME_PLL_SHARED3: c_uint = 0xc;
pub const PLL_CON0_PLL_SHARED0: c_uint = 0x100;
pub const PLL_CON0_PLL_SHARED1: c_uint = 0x120;
pub const PLL_CON0_PLL_SHARED2: c_uint = 0x140;
pub const PLL_CON0_PLL_SHARED3: c_uint = 0x160;
pub const MUX_CMU_CIS0_CLKMUX: c_uint = 0x1000;
pub const MUX_CMU_CIS1_CLKMUX: c_uint = 0x1004;
pub const MUX_CMU_CIS2_CLKMUX: c_uint = 0x1008;
pub const MUX_CMU_CPUCL_SWITCHMUX: c_uint = 0x100c;
pub const MUX_CMU_FSYS1_ACLK_MUX: c_uint = 0x1014;
pub const MUX_PLL_SHARED0_MUX: c_uint = 0x1020;
pub const MUX_PLL_SHARED1_MUX: c_uint = 0x1024;
pub const DIV_CMU_CIS0_CLK: c_uint = 0x1800;
pub const DIV_CMU_CIS1_CLK: c_uint = 0x1804;
pub const DIV_CMU_CIS2_CLK: c_uint = 0x1808;
pub const DIV_CMU_CMU_ACLK: c_uint = 0x180c;
pub const DIV_CMU_CPUCL_SWITCH: c_uint = 0x1810;
pub const DIV_CMU_FSYS0_SHARED0DIV4: c_uint = 0x181c;
pub const DIV_CMU_FSYS0_SHARED1DIV3: c_uint = 0x1820;
pub const DIV_CMU_FSYS0_SHARED1DIV4: c_uint = 0x1824;
pub const DIV_CMU_FSYS1_SHARED0DIV4: c_uint = 0x1828;
pub const DIV_CMU_FSYS1_SHARED0DIV8: c_uint = 0x182c;
pub const DIV_CMU_IMEM_ACLK: c_uint = 0x1834;
pub const DIV_CMU_IMEM_DMACLK: c_uint = 0x1838;
pub const DIV_CMU_IMEM_TCUCLK: c_uint = 0x183c;
pub const DIV_CMU_PERIC_SHARED0DIV20: c_uint = 0x1844;
pub const DIV_CMU_PERIC_SHARED0DIV3_TBUCLK: c_uint = 0x1848;
pub const DIV_CMU_PERIC_SHARED1DIV36: c_uint = 0x184c;
pub const DIV_CMU_PERIC_SHARED1DIV4_DMACLK: c_uint = 0x1850;
pub const DIV_PLL_SHARED0_DIV2: c_uint = 0x1858;
pub const DIV_PLL_SHARED0_DIV3: c_uint = 0x185c;
pub const DIV_PLL_SHARED0_DIV4: c_uint = 0x1860;
pub const DIV_PLL_SHARED0_DIV6: c_uint = 0x1864;
pub const DIV_PLL_SHARED1_DIV3: c_uint = 0x1868;
pub const DIV_PLL_SHARED1_DIV36: c_uint = 0x186c;
pub const DIV_PLL_SHARED1_DIV4: c_uint = 0x1870;
pub const DIV_PLL_SHARED1_DIV9: c_uint = 0x1874;
pub const GAT_CMU_CIS0_CLKGATE: c_uint = 0x2000;
pub const GAT_CMU_CIS1_CLKGATE: c_uint = 0x2004;
pub const GAT_CMU_CIS2_CLKGATE: c_uint = 0x2008;
pub const GAT_CMU_CPUCL_SWITCH_GATE: c_uint = 0x200c;
pub const GAT_CMU_FSYS0_SHARED0DIV4_GATE: c_uint = 0x2018;
pub const GAT_CMU_FSYS0_SHARED1DIV4_CLK: c_uint = 0x201c;
pub const GAT_CMU_FSYS0_SHARED1DIV4_GATE: c_uint = 0x2020;
pub const GAT_CMU_FSYS1_SHARED0DIV4_GATE: c_uint = 0x2024;
pub const GAT_CMU_FSYS1_SHARED1DIV4_GATE: c_uint = 0x2028;
pub const GAT_CMU_IMEM_ACLK_GATE: c_uint = 0x2030;
pub const GAT_CMU_IMEM_DMACLK_GATE: c_uint = 0x2034;
pub const GAT_CMU_IMEM_TCUCLK_GATE: c_uint = 0x2038;
pub const GAT_CMU_PERIC_SHARED0DIVE3_TBUCLK_GATE: c_uint = 0x2040;
pub const GAT_CMU_PERIC_SHARED0DIVE4_GATE: c_uint = 0x2044;
pub const GAT_CMU_PERIC_SHARED1DIV4_DMACLK_GATE: c_uint = 0x2048;
pub const GAT_CMU_PERIC_SHARED1DIVE4_GATE: c_uint = 0x204c;
pub const GAT_CMU_CMU_CMU_IPCLKPORT_PCLK: c_uint = 0x2054;
pub const GAT_CMU_AXI2APB_CMU_IPCLKPORT_ACLK: c_uint = 0x2058;
pub const GAT_CMU_NS_BRDG_CMU_IPCLKPORT_CLK__PSOC_CMU__CLK_CMU: c_uint = 0x205c;
pub const GAT_CMU_SYSREG_CMU_IPCLKPORT_PCLK: c_uint = 0x2060;
...
#[no_mangle]
unsafe extern "C" fn fsd_clk_cmu_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_PERIC_DMACLK_MUX: c_uint = 0x100;
pub const PLL_CON0_PERIC_EQOS_BUSCLK_MUX: c_uint = 0x120;
pub const PLL_CON0_PERIC_PCLK_MUX: c_uint = 0x140;
pub const PLL_CON0_PERIC_TBUCLK_MUX: c_uint = 0x160;
pub const PLL_CON0_SPI_CLK: c_uint = 0x180;
pub const PLL_CON0_SPI_PCLK: c_uint = 0x1a0;
pub const PLL_CON0_UART_CLK: c_uint = 0x1c0;
pub const PLL_CON0_UART_PCLK: c_uint = 0x1e0;
pub const MUX_PERIC_EQOS_PHYRXCLK: c_uint = 0x1000;
pub const DIV_EQOS_BUSCLK: c_uint = 0x1800;
pub const DIV_PERIC_MCAN_CLK: c_uint = 0x1804;
pub const DIV_RGMII_CLK: c_uint = 0x1808;
pub const DIV_RII_CLK: c_uint = 0x180c;
pub const DIV_RMII_CLK: c_uint = 0x1810;
pub const DIV_SPI_CLK: c_uint = 0x1814;
pub const DIV_UART_CLK: c_uint = 0x1818;
pub const GAT_EQOS_TOP_IPCLKPORT_CLK_PTP_REF_I: c_uint = 0x2000;
pub const GAT_GPIO_PERIC_IPCLKPORT_OSCCLK: c_uint = 0x2004;
pub const GAT_PERIC_ADC0_IPCLKPORT_I_OSCCLK: c_uint = 0x2008;
pub const GAT_PERIC_CMU_PERIC_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const GAT_PERIC_PWM0_IPCLKPORT_I_OSCCLK: c_uint = 0x2010;
pub const GAT_PERIC_PWM1_IPCLKPORT_I_OSCCLK: c_uint = 0x2014;
pub const GAT_ASYNC_APB_DMA0_IPCLKPORT_PCLKM: c_uint = 0x2018;
pub const GAT_ASYNC_APB_DMA0_IPCLKPORT_PCLKS: c_uint = 0x201c;
pub const GAT_ASYNC_APB_DMA1_IPCLKPORT_PCLKM: c_uint = 0x2020;
pub const GAT_ASYNC_APB_DMA1_IPCLKPORT_PCLKS: c_uint = 0x2024;
pub const GAT_AXI2APB_PERIC0_IPCLKPORT_ACLK: c_uint = 0x2028;
pub const GAT_AXI2APB_PERIC1_IPCLKPORT_ACLK: c_uint = 0x202c;
pub const GAT_AXI2APB_PERIC2_IPCLKPORT_ACLK: c_uint = 0x2030;
pub const GAT_BUS_D_PERIC_IPCLKPORT_DMACLK: c_uint = 0x2034;
pub const GAT_BUS_D_PERIC_IPCLKPORT_EQOSCLK: c_uint = 0x2038;
pub const GAT_BUS_D_PERIC_IPCLKPORT_MAINCLK: c_uint = 0x203c;
pub const GAT_BUS_P_PERIC_IPCLKPORT_EQOSCLK: c_uint = 0x2040;
pub const GAT_BUS_P_PERIC_IPCLKPORT_MAINCLK: c_uint = 0x2044;
pub const GAT_BUS_P_PERIC_IPCLKPORT_SMMUCLK: c_uint = 0x2048;
pub const GAT_EQOS_TOP_IPCLKPORT_ACLK_I: c_uint = 0x204c;
pub const GAT_EQOS_TOP_IPCLKPORT_CLK_RX_I: c_uint = 0x2050;
pub const GAT_EQOS_TOP_IPCLKPORT_HCLK_I: c_uint = 0x2054;
pub const GAT_EQOS_TOP_IPCLKPORT_RGMII_CLK_I: c_uint = 0x2058;
pub const GAT_EQOS_TOP_IPCLKPORT_RII_CLK_I: c_uint = 0x205c;
pub const GAT_EQOS_TOP_IPCLKPORT_RMII_CLK_I: c_uint = 0x2060;
pub const GAT_GPIO_PERIC_IPCLKPORT_PCLK: c_uint = 0x2064;
pub const GAT_NS_BRDG_PERIC_IPCLKPORT_CLK__PSOC_PERIC__CLK_PERIC_D: c_uint = 0x2068;
pub const GAT_NS_BRDG_PERIC_IPCLKPORT_CLK__PSOC_PERIC__CLK_PERIC_P: c_uint = 0x206c;
pub const GAT_PERIC_ADC0_IPCLKPORT_PCLK_S0: c_uint = 0x2070;
pub const GAT_PERIC_DMA0_IPCLKPORT_ACLK: c_uint = 0x2074;
pub const GAT_PERIC_DMA1_IPCLKPORT_ACLK: c_uint = 0x2078;
pub const GAT_PERIC_I2C0_IPCLKPORT_I_PCLK: c_uint = 0x207c;
pub const GAT_PERIC_I2C1_IPCLKPORT_I_PCLK: c_uint = 0x2080;
pub const GAT_PERIC_I2C2_IPCLKPORT_I_PCLK: c_uint = 0x2084;
pub const GAT_PERIC_I2C3_IPCLKPORT_I_PCLK: c_uint = 0x2088;
pub const GAT_PERIC_I2C4_IPCLKPORT_I_PCLK: c_uint = 0x208c;
pub const GAT_PERIC_I2C5_IPCLKPORT_I_PCLK: c_uint = 0x2090;
pub const GAT_PERIC_I2C6_IPCLKPORT_I_PCLK: c_uint = 0x2094;
pub const GAT_PERIC_I2C7_IPCLKPORT_I_PCLK: c_uint = 0x2098;
pub const GAT_PERIC_MCAN0_IPCLKPORT_CCLK: c_uint = 0x209c;
pub const GAT_PERIC_MCAN0_IPCLKPORT_PCLK: c_uint = 0x20a0;
pub const GAT_PERIC_MCAN1_IPCLKPORT_CCLK: c_uint = 0x20a4;
pub const GAT_PERIC_MCAN1_IPCLKPORT_PCLK: c_uint = 0x20a8;
pub const GAT_PERIC_MCAN2_IPCLKPORT_CCLK: c_uint = 0x20ac;
pub const GAT_PERIC_MCAN2_IPCLKPORT_PCLK: c_uint = 0x20b0;
pub const GAT_PERIC_MCAN3_IPCLKPORT_CCLK: c_uint = 0x20b4;
pub const GAT_PERIC_MCAN3_IPCLKPORT_PCLK: c_uint = 0x20b8;
pub const GAT_PERIC_PWM0_IPCLKPORT_I_PCLK_S0: c_uint = 0x20bc;
pub const GAT_PERIC_PWM1_IPCLKPORT_I_PCLK_S0: c_uint = 0x20c0;
pub const GAT_PERIC_SMMU_IPCLKPORT_CCLK: c_uint = 0x20c4;
pub const GAT_PERIC_SMMU_IPCLKPORT_PERIC_BCLK: c_uint = 0x20c8;
pub const GAT_PERIC_SPI0_IPCLKPORT_I_PCLK: c_uint = 0x20cc;
pub const GAT_PERIC_SPI0_IPCLKPORT_I_SCLK_SPI: c_uint = 0x20d0;
pub const GAT_PERIC_SPI1_IPCLKPORT_I_PCLK: c_uint = 0x20d4;
pub const GAT_PERIC_SPI1_IPCLKPORT_I_SCLK_SPI: c_uint = 0x20d8;
pub const GAT_PERIC_SPI2_IPCLKPORT_I_PCLK: c_uint = 0x20dc;
pub const GAT_PERIC_SPI2_IPCLKPORT_I_SCLK_SPI: c_uint = 0x20e0;
pub const GAT_PERIC_TDM0_IPCLKPORT_HCLK_M: c_uint = 0x20e4;
pub const GAT_PERIC_TDM0_IPCLKPORT_PCLK: c_uint = 0x20e8;
pub const GAT_PERIC_TDM1_IPCLKPORT_HCLK_M: c_uint = 0x20ec;
pub const GAT_PERIC_TDM1_IPCLKPORT_PCLK: c_uint = 0x20f0;
pub const GAT_PERIC_UART0_IPCLKPORT_I_SCLK_UART: c_uint = 0x20f4;
pub const GAT_PERIC_UART0_IPCLKPORT_PCLK: c_uint = 0x20f8;
pub const GAT_PERIC_UART1_IPCLKPORT_I_SCLK_UART: c_uint = 0x20fc;
pub const GAT_PERIC_UART1_IPCLKPORT_PCLK: c_uint = 0x2100;
pub const GAT_SYSREG_PERI_IPCLKPORT_PCLK: c_uint = 0x2104;
    ...
    FRATE(PERIC_EQOS_PHYRXCLK, "eqos_phyrxclk", core::ptr::null_mut(), 0, 125000000),
    };
...
pub const PLL_CON0_CLKCMU_FSYS0_UNIPRO: c_uint = 0x100;
pub const PLL_CON0_CLK_FSYS0_SLAVEBUSCLK: c_uint = 0x140;
pub const PLL_CON0_EQOS_RGMII_125_MUX1: c_uint = 0x160;
pub const DIV_CLK_UNIPRO: c_uint = 0x1800;
pub const DIV_EQS_RGMII_CLK_125: c_uint = 0x1804;
pub const DIV_PERIBUS_GRP: c_uint = 0x1808;
pub const DIV_EQOS_RII_CLK2O5: c_uint = 0x180c;
pub const DIV_EQOS_RMIICLK_25: c_uint = 0x1810;
pub const DIV_PCIE_PHY_OSCCLK: c_uint = 0x1814;
pub const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_CLK_PTP_REF_I: c_uint = 0x2004;
pub const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_CLK_RX_I: c_uint = 0x2008;
pub const GAT_FSYS0_FSYS0_CMU_FSYS0_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const GAT_FSYS0_GPIO_FSYS0_IPCLKPORT_OSCCLK: c_uint = 0x2010;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PCIEG3_PHY_X4_INST_0_PLL_REFCLK_FROM_XO: c_uint = 0x2014;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PIPE_PAL_INST_0_I_IMMORTAL_CLK: c_uint = 0x2018;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_AUX_CLK_SOC: c_uint = 0x201c;
pub const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_MPHY_REFCLK_IXTAL24: c_uint = 0x2020;
pub const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_MPHY_REFCLK_IXTAL26: c_uint = 0x2024;
pub const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_MPHY_REFCLK_IXTAL24: c_uint = 0x2028;
pub const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_MPHY_REFCLK_IXTAL26: c_uint = 0x202c;
pub const GAT_FSYS0_AHBBR_FSYS0_IPCLKPORT_HCLK: c_uint = 0x2038;
pub const GAT_FSYS0_AXI2APB_FSYS0_IPCLKPORT_ACLK: c_uint = 0x203c;
pub const GAT_FSYS0_BUS_D_FSYS0_IPCLKPORT_MAINCLK: c_uint = 0x2040;
pub const GAT_FSYS0_BUS_D_FSYS0_IPCLKPORT_PERICLK: c_uint = 0x2044;
pub const GAT_FSYS0_BUS_P_FSYS0_IPCLKPORT_MAINCLK: c_uint = 0x2048;
pub const GAT_FSYS0_BUS_P_FSYS0_IPCLKPORT_TCUCLK: c_uint = 0x204c;
pub const GAT_FSYS0_CPE425_IPCLKPORT_ACLK: c_uint = 0x2050;
pub const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_ACLK_I: c_uint = 0x2054;
pub const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_HCLK_I: c_uint = 0x2058;
pub const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_RGMII_CLK_I: c_uint = 0x205c;
pub const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_RII_CLK_I: c_uint = 0x2060;
pub const GAT_FSYS0_EQOS_TOP0_IPCLKPORT_RMII_CLK_I: c_uint = 0x2064;
pub const GAT_FSYS0_GPIO_FSYS0_IPCLKPORT_PCLK: c_uint = 0x2068;
pub const GAT_FSYS0_NS_BRDG_FSYS0_IPCLKPORT_CLK__PSOC_FSYS0__CLK_FSYS0_D: c_uint = 0x206c;
pub const GAT_FSYS0_NS_BRDG_FSYS0_IPCLKPORT_CLK__PSOC_FSYS0__CLK_FSYS0_D1: c_uint = 0x2070;
pub const GAT_FSYS0_NS_BRDG_FSYS0_IPCLKPORT_CLK__PSOC_FSYS0__CLK_FSYS0_P: c_uint = 0x2074;
pub const GAT_FSYS0_NS_BRDG_FSYS0_IPCLKPORT_CLK__PSOC_FSYS0__CLK_FSYS0_S: c_uint = 0x2078;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PCIEG3_PHY_X4_INST_0_I_APB_PCLK: c_uint = 0x207c;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PCIEG3_PHY_X4_INST_0_PLL_REFCLK_FROM_SYSPLL: c_uint = 0x2080;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_PIPE_PAL_INST_0_I_APB_PCLK_0: c_uint = 0x2084;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_DBI_ACLK_SOC: c_uint = 0x2088;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK: c_uint = 0x208c;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_MSTR_ACLK_SOC: c_uint = 0x2090;
pub const GAT_FSYS0_PCIE_TOP_IPCLKPORT_FSD_PCIE_SUB_CTRL_INST_0_SLV_ACLK_SOC: c_uint = 0x2094;
pub const GAT_FSYS0_SMMU_FSYS0_IPCLKPORT_CCLK: c_uint = 0x2098;
pub const GAT_FSYS0_SMMU_FSYS0_IPCLKPORT_FSYS0_BCLK: c_uint = 0x209c;
pub const GAT_FSYS0_SYSREG_FSYS0_IPCLKPORT_PCLK: c_uint = 0x20a0;
pub const GAT_FSYS0_UFS_TOP0_IPCLKPORT_HCLK_BUS: c_uint = 0x20a4;
pub const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_ACLK: c_uint = 0x20a8;
pub const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_CLK_UNIPRO: c_uint = 0x20ac;
pub const GAT_FSYS0_UFS_TOP0_IPCLKPORT_I_FMP_CLK: c_uint = 0x20b0;
pub const GAT_FSYS0_UFS_TOP1_IPCLKPORT_HCLK_BUS: c_uint = 0x20b4;
pub const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_ACLK: c_uint = 0x20b8;
pub const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_CLK_UNIPRO: c_uint = 0x20bc;
pub const GAT_FSYS0_UFS_TOP1_IPCLKPORT_I_FMP_CLK: c_uint = 0x20c0;
pub const GAT_FSYS0_RII_CLK_DIVGATE: c_uint = 0x20d4;
    ...
    FRATE(0, "pad_eqos0_phyrxclk", core::ptr::null_mut(), 0, 125000000),
    FRATE(0, "i_mphy_refclk_ixtal26", core::ptr::null_mut(), 0, 26000000),
    FRATE(0, "xtal_clk_pcie_phy", core::ptr::null_mut(), 0, 100000000),
    };
...
pub const PLL_CON0_ACLK_FSYS1_BUSP_MUX: c_uint = 0x100;
pub const PLL_CON0_PCLKL_FSYS1_BUSP_MUX: c_uint = 0x180;
pub const DIV_CLK_FSYS1_PHY0_OSCCLK: c_uint = 0x1800;
pub const DIV_CLK_FSYS1_PHY1_OSCCLK: c_uint = 0x1804;
pub const GAT_FSYS1_CMU_FSYS1_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_AUXCLK: c_uint = 0x2004;
pub const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_I_SOC_REF_CLK: c_uint = 0x2008;
pub const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_AUXCLK: c_uint = 0x200c;
pub const GAT_FSYS1_PCIE_PHY0_IPCLKPORT_I_REF_XTAL: c_uint = 0x202c;
pub const GAT_FSYS1_PHY0_OSCCLLK: c_uint = 0x2034;
pub const GAT_FSYS1_PHY1_OSCCLK: c_uint = 0x2038;
pub const GAT_FSYS1_AXI2APB_FSYS1_IPCLKPORT_ACLK: c_uint = 0x203c;
pub const GAT_FSYS1_BUS_D0_FSYS1_IPCLKPORT_MAINCLK: c_uint = 0x2040;
pub const GAT_FSYS1_BUS_S0_FSYS1_IPCLKPORT_M250CLK: c_uint = 0x2048;
pub const GAT_FSYS1_BUS_S0_FSYS1_IPCLKPORT_MAINCLK: c_uint = 0x204c;
pub const GAT_FSYS1_CPE425_0_FSYS1_IPCLKPORT_ACLK: c_uint = 0x2054;
pub const GAT_FSYS1_NS_BRDG_FSYS1_IPCLKPORT_CLK__PSOC_FSYS1__CLK_FSYS1_D0: c_uint = 0x205c;
pub const GAT_FSYS1_NS_BRDG_FSYS1_IPCLKPORT_CLK__PSOC_FSYS1__CLK_FSYS1_S0: c_uint = 0x2064;
pub const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_DBI_ACLK: c_uint = 0x206c;
pub const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_I_APB_CLK: c_uint = 0x2070;
pub const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_I_DRIVER_APB_CLK: c_uint = 0x2074;
pub const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_MSTR_ACLK: c_uint = 0x2078;
pub const GAT_FSYS1_PCIE_LINK0_IPCLKPORT_SLV_ACLK: c_uint = 0x207c;
pub const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_DBI_ACLK: c_uint = 0x2080;
pub const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_I_DRIVER_APB_CLK: c_uint = 0x2084;
pub const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_MSTR_ACLK: c_uint = 0x2088;
pub const GAT_FSYS1_PCIE_LINK1_IPCLKPORT_SLV_ACLK: c_uint = 0x208c;
pub const GAT_FSYS1_PCIE_PHY0_IPCLKPORT_I_APB_CLK: c_uint = 0x20a4;
pub const GAT_FSYS1_PCIE_PHY0_IPCLKPORT_I_REF_SOC_PLL: c_uint = 0x20a8;
pub const GAT_FSYS1_SYSREG_FSYS1_IPCLKPORT_PCLK: c_uint = 0x20b4;
pub const GAT_FSYS1_TBU0_FSYS1_IPCLKPORT_ACLK: c_uint = 0x20b8;
    ...
    FRATE(0, "clk_fsys1_phy0_ref", core::ptr::null_mut(), 0, 100000000),
    FRATE(0, "clk_fsys1_phy1_ref", core::ptr::null_mut(), 0, 100000000),
    };
...
pub const PLL_CON0_CLK_IMEM_ACLK: c_uint = 0x100;
pub const PLL_CON0_CLK_IMEM_INTMEMCLK: c_uint = 0x120;
pub const PLL_CON0_CLK_IMEM_TCUCLK: c_uint = 0x140;
pub const DIV_OSCCLK_IMEM_TMUTSCLK: c_uint = 0x1800;
pub const GAT_IMEM_IMEM_CMU_IMEM_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const GAT_IMEM_MCT_IPCLKPORT_OSCCLK__ALO: c_uint = 0x2004;
pub const GAT_IMEM_OTP_CON_TOP_IPCLKPORT_I_OSCCLK: c_uint = 0x2008;
pub const GAT_IMEM_RSTNSYNC_OSCCLK_IPCLKPORT_CLK: c_uint = 0x200c;
pub const GAT_IMEM_TMU_CPU0_IPCLKPORT_I_CLK: c_uint = 0x2010;
pub const GAT_IMEM_TMU_CPU0_IPCLKPORT_I_CLK_TS: c_uint = 0x2014;
pub const GAT_IMEM_TMU_CPU2_IPCLKPORT_I_CLK: c_uint = 0x2018;
pub const GAT_IMEM_TMU_CPU2_IPCLKPORT_I_CLK_TS: c_uint = 0x201c;
pub const GAT_IMEM_TMU_GPU_IPCLKPORT_I_CLK: c_uint = 0x2020;
pub const GAT_IMEM_TMU_GPU_IPCLKPORT_I_CLK_TS: c_uint = 0x2024;
pub const GAT_IMEM_TMU_GT_IPCLKPORT_I_CLK: c_uint = 0x2028;
pub const GAT_IMEM_TMU_GT_IPCLKPORT_I_CLK_TS: c_uint = 0x202c;
pub const GAT_IMEM_TMU_TOP_IPCLKPORT_I_CLK: c_uint = 0x2030;
pub const GAT_IMEM_TMU_TOP_IPCLKPORT_I_CLK_TS: c_uint = 0x2034;
pub const GAT_IMEM_WDT0_IPCLKPORT_CLK: c_uint = 0x2038;
pub const GAT_IMEM_WDT1_IPCLKPORT_CLK: c_uint = 0x203c;
pub const GAT_IMEM_WDT2_IPCLKPORT_CLK: c_uint = 0x2040;
pub const GAT_IMEM_ADM_AXI4ST_I0_IMEM_IPCLKPORT_ACLKM: c_uint = 0x2044;
pub const GAT_IMEM_ADM_AXI4ST_I1_IMEM_IPCLKPORT_ACLKM: c_uint = 0x2048;
pub const GAT_IMEM_ADM_AXI4ST_I2_IMEM_IPCLKPORT_ACLKM: c_uint = 0x204c;
pub const GAT_IMEM_ADS_AXI4ST_I0_IMEM_IPCLKPORT_ACLKS: c_uint = 0x2050;
pub const GAT_IMEM_ADS_AXI4ST_I1_IMEM_IPCLKPORT_ACLKS: c_uint = 0x2054;
pub const GAT_IMEM_ADS_AXI4ST_I2_IMEM_IPCLKPORT_ACLKS: c_uint = 0x2058;
pub const GAT_IMEM_ASYNC_DMA0_IPCLKPORT_PCLKM: c_uint = 0x205c;
pub const GAT_IMEM_ASYNC_DMA0_IPCLKPORT_PCLKS: c_uint = 0x2060;
pub const GAT_IMEM_ASYNC_DMA1_IPCLKPORT_PCLKM: c_uint = 0x2064;
pub const GAT_IMEM_ASYNC_DMA1_IPCLKPORT_PCLKS: c_uint = 0x2068;
pub const GAT_IMEM_AXI2APB_IMEMP0_IPCLKPORT_ACLK: c_uint = 0x206c;
pub const GAT_IMEM_AXI2APB_IMEMP1_IPCLKPORT_ACLK: c_uint = 0x2070;
pub const GAT_IMEM_BUS_D_IMEM_IPCLKPORT_MAINCLK: c_uint = 0x2074;
pub const GAT_IMEM_BUS_P_IMEM_IPCLKPORT_MAINCLK: c_uint = 0x2078;
pub const GAT_IMEM_BUS_P_IMEM_IPCLKPORT_PERICLK: c_uint = 0x207c;
pub const GAT_IMEM_BUS_P_IMEM_IPCLKPORT_TCUCLK: c_uint = 0x2080;
pub const GAT_IMEM_DMA0_IPCLKPORT_ACLK: c_uint = 0x2084;
pub const GAT_IMEM_DMA1_IPCLKPORT_ACLK: c_uint = 0x2088;
pub const GAT_IMEM_GIC500_INPUT_SYNC_IPCLKPORT_CLK: c_uint = 0x208c;
pub const GAT_IMEM_GIC_IPCLKPORT_CLK: c_uint = 0x2090;
pub const GAT_IMEM_INTMEM_IPCLKPORT_ACLK: c_uint = 0x2094;
pub const GAT_IMEM_MAILBOX_SCS_CA72_IPCLKPORT_PCLK: c_uint = 0x2098;
pub const GAT_IMEM_MAILBOX_SMS_CA72_IPCLKPORT_PCLK: c_uint = 0x209c;
pub const GAT_IMEM_MCT_IPCLKPORT_PCLK: c_uint = 0x20a0;
pub const GAT_IMEM_NS_BRDG_IMEM_IPCLKPORT_CLK__PSCO_IMEM__CLK_IMEM_D: c_uint = 0x20a4;
pub const GAT_IMEM_NS_BRDG_IMEM_IPCLKPORT_CLK__PSCO_IMEM__CLK_IMEM_TCU: c_uint = 0x20a8;
pub const GAT_IMEM_NS_BRDG_IMEM_IPCLKPORT_CLK__PSOC_IMEM__CLK_IMEM_P: c_uint = 0x20ac;
pub const GAT_IMEM_OTP_CON_TOP_IPCLKPORT_PCLK: c_uint = 0x20b0;
pub const GAT_IMEM_RSTNSYNC_ACLK_IPCLKPORT_CLK: c_uint = 0x20b4;
pub const GAT_IMEM_RSTNSYNC_INTMEMCLK_IPCLKPORT_CLK: c_uint = 0x20b8;
pub const GAT_IMEM_RSTNSYNC_TCUCLK_IPCLKPORT_CLK: c_uint = 0x20bc;
pub const GAT_IMEM_SFRIF_TMU0_IMEM_IPCLKPORT_PCLK: c_uint = 0x20c0;
pub const GAT_IMEM_SFRIF_TMU1_IMEM_IPCLKPORT_PCLK: c_uint = 0x20c4;
pub const GAT_IMEM_SYSREG_IMEM_IPCLKPORT_PCLK: c_uint = 0x20c8;
pub const GAT_IMEM_TBU_IMEM_IPCLKPORT_ACLK: c_uint = 0x20cc;
pub const GAT_IMEM_TCU_IPCLKPORT_ACLK: c_uint = 0x20d0;
pub const GAT_IMEM_WDT0_IPCLKPORT_PCLK: c_uint = 0x20d4;
pub const GAT_IMEM_WDT1_IPCLKPORT_PCLK: c_uint = 0x20d8;
pub const GAT_IMEM_WDT2_IPCLKPORT_PCLK: c_uint = 0x20dc;
...
#[no_mangle]
unsafe extern "C" fn fsd_clk_imem_init(np: *mut device_node) -> void __init {
...
pub const PLL_LOCKTIME_PLL_MFC: c_uint = 0x0;
pub const PLL_CON0_PLL_MFC: c_uint = 0x100;
pub const MUX_MFC_BUSD: c_uint = 0x1000;
pub const MUX_MFC_BUSP: c_uint = 0x1008;
pub const DIV_MFC_BUSD_DIV4: c_uint = 0x1800;
pub const GAT_MFC_CMU_MFC_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const GAT_MFC_AS_P_MFC_IPCLKPORT_PCLKM: c_uint = 0x2004;
pub const GAT_MFC_AS_P_MFC_IPCLKPORT_PCLKS: c_uint = 0x2008;
pub const GAT_MFC_AXI2APB_MFC_IPCLKPORT_ACLK: c_uint = 0x200c;
pub const GAT_MFC_MFC_IPCLKPORT_ACLK: c_uint = 0x2010;
pub const GAT_MFC_NS_BRDG_MFC_IPCLKPORT_CLK__PMFC__CLK_MFC_D: c_uint = 0x2018;
pub const GAT_MFC_NS_BRDG_MFC_IPCLKPORT_CLK__PMFC__CLK_MFC_P: c_uint = 0x201c;
pub const GAT_MFC_PPMU_MFCD0_IPCLKPORT_ACLK: c_uint = 0x2028;
pub const GAT_MFC_PPMU_MFCD0_IPCLKPORT_PCLK: c_uint = 0x202c;
pub const GAT_MFC_PPMU_MFCD1_IPCLKPORT_ACLK: c_uint = 0x2030;
pub const GAT_MFC_PPMU_MFCD1_IPCLKPORT_PCLK: c_uint = 0x2034;
pub const GAT_MFC_SYSREG_MFC_IPCLKPORT_PCLK: c_uint = 0x2038;
pub const GAT_MFC_TBU_MFCD0_IPCLKPORT_CLK: c_uint = 0x203c;
pub const GAT_MFC_TBU_MFCD1_IPCLKPORT_CLK: c_uint = 0x2040;
pub const GAT_MFC_BUSD_DIV4_GATE: c_uint = 0x2044;
pub const GAT_MFC_BUSD_GATE: c_uint = 0x2048;
...
pub const PLL_LOCKTIME_PLL_CAM_CSI: c_uint = 0x0;
pub const PLL_CON0_PLL_CAM_CSI: c_uint = 0x100;
pub const DIV_CAM_CSI0_ACLK: c_uint = 0x1800;
pub const DIV_CAM_CSI1_ACLK: c_uint = 0x1804;
pub const DIV_CAM_CSI2_ACLK: c_uint = 0x1808;
pub const DIV_CAM_CSI_BUSD: c_uint = 0x180c;
pub const DIV_CAM_CSI_BUSP: c_uint = 0x1810;
pub const GAT_CAM_CSI_CMU_CAM_CSI_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const GAT_CAM_AXI2APB_CAM_CSI_IPCLKPORT_ACLK: c_uint = 0x2004;
pub const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__CLK_CSI0: c_uint = 0x2008;
pub const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__CLK_CSI1: c_uint = 0x200c;
pub const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__CLK_CSI2: c_uint = 0x2010;
pub const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__CLK_SOC_NOC: c_uint = 0x2014;
pub const GAT_CAM_CSI_BUS_D_CAM_CSI_IPCLKPORT_CLK__SYSTEM__NOC: c_uint = 0x2018;
pub const GAT_CAM_CSI0_0_IPCLKPORT_I_ACLK: c_uint = 0x201c;
pub const GAT_CAM_CSI0_0_IPCLKPORT_I_PCLK: c_uint = 0x2020;
pub const GAT_CAM_CSI0_1_IPCLKPORT_I_ACLK: c_uint = 0x2024;
pub const GAT_CAM_CSI0_1_IPCLKPORT_I_PCLK: c_uint = 0x2028;
pub const GAT_CAM_CSI0_2_IPCLKPORT_I_ACLK: c_uint = 0x202c;
pub const GAT_CAM_CSI0_2_IPCLKPORT_I_PCLK: c_uint = 0x2030;
pub const GAT_CAM_CSI0_3_IPCLKPORT_I_ACLK: c_uint = 0x2034;
pub const GAT_CAM_CSI0_3_IPCLKPORT_I_PCLK: c_uint = 0x2038;
pub const GAT_CAM_CSI1_0_IPCLKPORT_I_ACLK: c_uint = 0x203c;
pub const GAT_CAM_CSI1_0_IPCLKPORT_I_PCLK: c_uint = 0x2040;
pub const GAT_CAM_CSI1_1_IPCLKPORT_I_ACLK: c_uint = 0x2044;
pub const GAT_CAM_CSI1_1_IPCLKPORT_I_PCLK: c_uint = 0x2048;
pub const GAT_CAM_CSI1_2_IPCLKPORT_I_ACLK: c_uint = 0x204c;
pub const GAT_CAM_CSI1_2_IPCLKPORT_I_PCLK: c_uint = 0x2050;
pub const GAT_CAM_CSI1_3_IPCLKPORT_I_ACLK: c_uint = 0x2054;
pub const GAT_CAM_CSI1_3_IPCLKPORT_I_PCLK: c_uint = 0x2058;
pub const GAT_CAM_CSI2_0_IPCLKPORT_I_ACLK: c_uint = 0x205c;
pub const GAT_CAM_CSI2_0_IPCLKPORT_I_PCLK: c_uint = 0x2060;
pub const GAT_CAM_CSI2_1_IPCLKPORT_I_ACLK: c_uint = 0x2064;
pub const GAT_CAM_CSI2_1_IPCLKPORT_I_PCLK: c_uint = 0x2068;
pub const GAT_CAM_CSI2_2_IPCLKPORT_I_ACLK: c_uint = 0x206c;
pub const GAT_CAM_CSI2_2_IPCLKPORT_I_PCLK: c_uint = 0x2070;
pub const GAT_CAM_CSI2_3_IPCLKPORT_I_ACLK: c_uint = 0x2074;
pub const GAT_CAM_CSI2_3_IPCLKPORT_I_PCLK: c_uint = 0x2078;
pub const GAT_CAM_NS_BRDG_CAM_CSI_IPCLKPORT_CLK__PSOC_CAM_CSI__CLK_CAM_CSI_D: c_uint = 0x207c;
pub const GAT_CAM_NS_BRDG_CAM_CSI_IPCLKPORT_CLK__PSOC_CAM_CSI__CLK_CAM_CSI_P: c_uint = 0x2080;
pub const GAT_CAM_SYSREG_CAM_CSI_IPCLKPORT_PCLK: c_uint = 0x2084;
pub const GAT_CAM_TBU_CAM_CSI_IPCLKPORT_ACLK: c_uint = 0x2088;
...
//
#[no_mangle]
unsafe extern "C" fn fsd_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fsd_cmu_init() -> int __init {
