...
//! Source: drivers/clk/samsung/clk-exynos4.c
#![no_std]
...
pub const SRC_LEFTBUS: c_uint = 0x4200;
pub const DIV_LEFTBUS: c_uint = 0x4500;
pub const GATE_IP_LEFTBUS: c_uint = 0x4800;
pub const E4X12_GATE_IP_IMAGE: c_uint = 0x4930;
pub const CLKOUT_CMU_LEFTBUS: c_uint = 0x4a00;
pub const SRC_RIGHTBUS: c_uint = 0x8200;
pub const DIV_RIGHTBUS: c_uint = 0x8500;
pub const GATE_IP_RIGHTBUS: c_uint = 0x8800;
pub const E4X12_GATE_IP_PERIR: c_uint = 0x8960;
pub const CLKOUT_CMU_RIGHTBUS: c_uint = 0x8a00;
pub const EPLL_LOCK: c_uint = 0xc010;
pub const VPLL_LOCK: c_uint = 0xc020;
pub const EPLL_CON0: c_uint = 0xc110;
pub const EPLL_CON1: c_uint = 0xc114;
pub const EPLL_CON2: c_uint = 0xc118;
pub const VPLL_CON0: c_uint = 0xc120;
pub const VPLL_CON1: c_uint = 0xc124;
pub const VPLL_CON2: c_uint = 0xc128;
pub const SRC_TOP0: c_uint = 0xc210;
pub const SRC_TOP1: c_uint = 0xc214;
pub const SRC_CAM: c_uint = 0xc220;
pub const SRC_TV: c_uint = 0xc224;
pub const SRC_MFC: c_uint = 0xc228;
pub const SRC_G3D: c_uint = 0xc22c;
pub const E4210_SRC_IMAGE: c_uint = 0xc230;
pub const SRC_LCD0: c_uint = 0xc234;
pub const E4210_SRC_LCD1: c_uint = 0xc238;
pub const E4X12_SRC_ISP: c_uint = 0xc238;
pub const SRC_MAUDIO: c_uint = 0xc23c;
pub const SRC_FSYS: c_uint = 0xc240;
pub const SRC_PERIL0: c_uint = 0xc250;
pub const SRC_PERIL1: c_uint = 0xc254;
pub const E4X12_SRC_CAM1: c_uint = 0xc258;
pub const SRC_MASK_TOP: c_uint = 0xc310;
pub const SRC_MASK_CAM: c_uint = 0xc320;
pub const SRC_MASK_TV: c_uint = 0xc324;
pub const SRC_MASK_LCD0: c_uint = 0xc334;
pub const E4210_SRC_MASK_LCD1: c_uint = 0xc338;
pub const E4X12_SRC_MASK_ISP: c_uint = 0xc338;
pub const SRC_MASK_MAUDIO: c_uint = 0xc33c;
pub const SRC_MASK_FSYS: c_uint = 0xc340;
pub const SRC_MASK_PERIL0: c_uint = 0xc350;
pub const SRC_MASK_PERIL1: c_uint = 0xc354;
pub const DIV_TOP: c_uint = 0xc510;
pub const DIV_CAM: c_uint = 0xc520;
pub const DIV_TV: c_uint = 0xc524;
pub const DIV_MFC: c_uint = 0xc528;
pub const DIV_G3D: c_uint = 0xc52c;
pub const DIV_IMAGE: c_uint = 0xc530;
pub const DIV_LCD0: c_uint = 0xc534;
pub const E4210_DIV_LCD1: c_uint = 0xc538;
pub const E4X12_DIV_ISP: c_uint = 0xc538;
pub const DIV_MAUDIO: c_uint = 0xc53c;
pub const DIV_FSYS0: c_uint = 0xc540;
pub const DIV_FSYS1: c_uint = 0xc544;
pub const DIV_FSYS2: c_uint = 0xc548;
pub const DIV_FSYS3: c_uint = 0xc54c;
pub const DIV_PERIL0: c_uint = 0xc550;
pub const DIV_PERIL1: c_uint = 0xc554;
pub const DIV_PERIL2: c_uint = 0xc558;
pub const DIV_PERIL3: c_uint = 0xc55c;
pub const DIV_PERIL4: c_uint = 0xc560;
pub const DIV_PERIL5: c_uint = 0xc564;
pub const E4X12_DIV_CAM1: c_uint = 0xc568;
pub const E4X12_GATE_BUS_FSYS1: c_uint = 0xc744;
pub const GATE_SCLK_CAM: c_uint = 0xc820;
pub const GATE_IP_CAM: c_uint = 0xc920;
pub const GATE_IP_TV: c_uint = 0xc924;
pub const GATE_IP_MFC: c_uint = 0xc928;
pub const GATE_IP_G3D: c_uint = 0xc92c;
pub const E4210_GATE_IP_IMAGE: c_uint = 0xc930;
pub const GATE_IP_LCD0: c_uint = 0xc934;
pub const E4210_GATE_IP_LCD1: c_uint = 0xc938;
pub const E4X12_GATE_IP_ISP: c_uint = 0xc938;
pub const E4X12_GATE_IP_MAUDIO: c_uint = 0xc93c;
pub const GATE_IP_FSYS: c_uint = 0xc940;
pub const GATE_IP_GPS: c_uint = 0xc94c;
pub const GATE_IP_PERIL: c_uint = 0xc950;
pub const E4210_GATE_IP_PERIR: c_uint = 0xc960;
pub const GATE_BLOCK: c_uint = 0xc970;
pub const CLKOUT_CMU_TOP: c_uint = 0xca00;
pub const E4X12_MPLL_LOCK: c_uint = 0x10008;
pub const E4X12_MPLL_CON0: c_uint = 0x10108;
pub const SRC_DMC: c_uint = 0x10200;
pub const SRC_MASK_DMC: c_uint = 0x10300;
pub const DIV_DMC0: c_uint = 0x10500;
pub const DIV_DMC1: c_uint = 0x10504;
pub const GATE_IP_DMC: c_uint = 0x10900;
pub const CLKOUT_CMU_DMC: c_uint = 0x10a00;
pub const APLL_LOCK: c_uint = 0x14000;
pub const E4210_MPLL_LOCK: c_uint = 0x14008;
pub const APLL_CON0: c_uint = 0x14100;
pub const E4210_MPLL_CON0: c_uint = 0x14108;
pub const SRC_CPU: c_uint = 0x14200;
pub const DIV_CPU0: c_uint = 0x14500;
pub const DIV_CPU1: c_uint = 0x14504;
pub const GATE_SCLK_CPU: c_uint = 0x14800;
pub const GATE_IP_CPU: c_uint = 0x14900;
pub const CLKOUT_CMU_CPU: c_uint = 0x14a00;
pub const PWR_CTRL1: c_uint = 0x15020;
pub const E4X12_PWR_CTRL2: c_uint = 0x15024;
...
// fixed rate clocks generated outside the soc
    ...
    FRATE(CLK_XXTI, "xxti", core::ptr::null_mut(), 0, 0),
    FRATE(CLK_XUSBXTI, "xusbxti", core::ptr::null_mut(), 0, 0),
    };
// fixed rate clocks generated inside the soc
    static const struct samsung_fixed_rate_clock exynos4_fixed_rate_clks[] __initconst = {
    FRATE(0, "sclk_hdmi24m", core::ptr::null_mut(), 0, 24000000),
    FRATE(CLK_SCLK_HDMIPHY, "sclk_hdmiphy", "hdmi", 0, 27000000),
    FRATE(0, "sclk_usbphy0", core::ptr::null_mut(), 0, 48000000),
    };
    static const struct samsung_fixed_rate_clock exynos4210_fixed_rate_clks[] __initconst = {
    FRATE(0, "sclk_usbphy1", core::ptr::null_mut(), 0, 48000000),
    };
...
//
#[no_mangle]
unsafe extern "C" fn exynos4_get_xom() -> unsigned long __init {
    static unsigned long __init exynos4_get_xom(void)
    {
    let mut xom: c_ulong = 0;
    void __iomem *chipid_base;
    struct device_node *np;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "samsung,exynos4210-chipid");
    if (np) {
...
#[no_mangle]
unsafe extern "C" fn exynos4_clk_register_finpll(ctx: *mut samsung_clk_provider) -> void __init {
    ...
    unsigned int parent;
    char *parent_name;
    let mut xom: c_uint = exynos4_get_xom();
    ...
    fclk.id = CLK_FIN_PLL;
    fclk.name = "fin_pll";
    fclk.parent_name = core::ptr::null_mut();
    fclk.flags = 0;
...
// PLLs PMS values
    ...
    E4210_MPLL_LOCK, E4210_MPLL_CON0, core::ptr::null_mut()),
    ...
    E4X12_MPLL_LOCK, E4X12_MPLL_CON0, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn exynos4x12_core_down_clock() -> void __init {
...
// register exynos4 clocks
    ...
    samsung_clk_extended_sleep_init(reg_base, core::ptr::null_mut(),
    ...
    samsung_clk_sleep_init(reg_base, core::ptr::null_mut(), exynos4x12_clk_save,
...
#[no_mangle]
unsafe extern "C" fn exynos4210_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn exynos4212_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn exynos4412_clk_init(np: *mut device_node) -> void __init {
