...
//! Source: drivers/clk/samsung/clk-exynos5420.c
#![no_std]
...
pub const DIV_CPU1: c_uint = 0x504;
pub const GATE_BUS_CPU: c_uint = 0x700;
pub const GATE_SCLK_CPU: c_uint = 0x800;
pub const CLKOUT_CMU_CPU: c_uint = 0xa00;
pub const SRC_MASK_CPERI: c_uint = 0x4300;
pub const GATE_IP_G2D: c_uint = 0x8800;
pub const CPLL_LOCK: c_uint = 0x10020;
pub const DPLL_LOCK: c_uint = 0x10030;
pub const EPLL_LOCK: c_uint = 0x10040;
pub const RPLL_LOCK: c_uint = 0x10050;
pub const IPLL_LOCK: c_uint = 0x10060;
pub const SPLL_LOCK: c_uint = 0x10070;
pub const VPLL_LOCK: c_uint = 0x10080;
pub const MPLL_LOCK: c_uint = 0x10090;
pub const CPLL_CON0: c_uint = 0x10120;
pub const DPLL_CON0: c_uint = 0x10128;
pub const EPLL_CON0: c_uint = 0x10130;
pub const EPLL_CON1: c_uint = 0x10134;
pub const EPLL_CON2: c_uint = 0x10138;
pub const RPLL_CON0: c_uint = 0x10140;
pub const RPLL_CON1: c_uint = 0x10144;
pub const RPLL_CON2: c_uint = 0x10148;
pub const IPLL_CON0: c_uint = 0x10150;
pub const SPLL_CON0: c_uint = 0x10160;
pub const VPLL_CON0: c_uint = 0x10170;
pub const MPLL_CON0: c_uint = 0x10180;
pub const SRC_TOP0: c_uint = 0x10200;
pub const SRC_TOP1: c_uint = 0x10204;
pub const SRC_TOP2: c_uint = 0x10208;
pub const SRC_TOP3: c_uint = 0x1020c;
pub const SRC_TOP4: c_uint = 0x10210;
pub const SRC_TOP5: c_uint = 0x10214;
pub const SRC_TOP6: c_uint = 0x10218;
pub const SRC_TOP7: c_uint = 0x1021c;
pub const SRC_TOP8: c_uint = 0x10220 /* 5800 specific */;
pub const SRC_TOP9: c_uint = 0x10224 /* 5800 specific */;
pub const SRC_DISP10: c_uint = 0x1022c;
pub const SRC_MAU: c_uint = 0x10240;
pub const SRC_FSYS: c_uint = 0x10244;
pub const SRC_PERIC0: c_uint = 0x10250;
pub const SRC_PERIC1: c_uint = 0x10254;
pub const SRC_ISP: c_uint = 0x10270;
pub const SRC_CAM: c_uint = 0x10274 /* 5800 specific */;
pub const SRC_TOP10: c_uint = 0x10280;
pub const SRC_TOP11: c_uint = 0x10284;
pub const SRC_TOP12: c_uint = 0x10288;
pub const SRC_TOP13: c_uint = 0x1028c /* 5800 specific */;
pub const SRC_MASK_TOP0: c_uint = 0x10300;
pub const SRC_MASK_TOP1: c_uint = 0x10304;
pub const SRC_MASK_TOP2: c_uint = 0x10308;
pub const SRC_MASK_TOP7: c_uint = 0x1031c;
pub const SRC_MASK_DISP10: c_uint = 0x1032c;
pub const SRC_MASK_MAU: c_uint = 0x10334;
pub const SRC_MASK_FSYS: c_uint = 0x10340;
pub const SRC_MASK_PERIC0: c_uint = 0x10350;
pub const SRC_MASK_PERIC1: c_uint = 0x10354;
pub const SRC_MASK_ISP: c_uint = 0x10370;
pub const DIV_TOP0: c_uint = 0x10500;
pub const DIV_TOP1: c_uint = 0x10504;
pub const DIV_TOP2: c_uint = 0x10508;
pub const DIV_TOP8: c_uint = 0x10520 /* 5800 specific */;
pub const DIV_TOP9: c_uint = 0x10524 /* 5800 specific */;
pub const DIV_DISP10: c_uint = 0x1052c;
pub const DIV_MAU: c_uint = 0x10544;
...
pub const DIV_PERIC1: c_uint = 0x1055c;
pub const DIV_PERIC2: c_uint = 0x10560;
pub const DIV_PERIC3: c_uint = 0x10564;
pub const DIV_PERIC4: c_uint = 0x10568;
pub const DIV_CAM: c_uint = 0x10574 /* 5800 specific */;
pub const SCLK_DIV_ISP0: c_uint = 0x10580;
pub const SCLK_DIV_ISP1: c_uint = 0x10584;
pub const DIV2_RATIO0: c_uint = 0x10590;
pub const DIV4_RATIO: c_uint = 0x105a0;
pub const GATE_BUS_TOP: c_uint = 0x10700;
pub const GATE_BUS_DISP1: c_uint = 0x10728;
pub const GATE_BUS_GEN: c_uint = 0x1073c;
pub const GATE_BUS_FSYS0: c_uint = 0x10740;
pub const GATE_BUS_FSYS2: c_uint = 0x10748;
pub const GATE_BUS_PERIC: c_uint = 0x10750;
pub const GATE_BUS_PERIC1: c_uint = 0x10754;
pub const GATE_BUS_PERIS0: c_uint = 0x10760;
pub const GATE_BUS_PERIS1: c_uint = 0x10764;
pub const GATE_BUS_NOC: c_uint = 0x10770;
pub const GATE_TOP_SCLK_ISP: c_uint = 0x10870;
pub const GATE_IP_GSCL0: c_uint = 0x10910;
pub const GATE_IP_GSCL1: c_uint = 0x10920;
pub const GATE_IP_CAM: c_uint = 0x10924 /* 5800 specific */;
pub const GATE_IP_MFC: c_uint = 0x1092c;
pub const GATE_IP_DISP1: c_uint = 0x10928;
pub const GATE_IP_G3D: c_uint = 0x10930;
pub const GATE_IP_GEN: c_uint = 0x10934;
pub const GATE_IP_FSYS: c_uint = 0x10944;
pub const GATE_IP_PERIC: c_uint = 0x10950;
pub const GATE_IP_PERIS: c_uint = 0x10960;
pub const GATE_IP_MSCL: c_uint = 0x10970;
pub const GATE_TOP_SCLK_GSCL: c_uint = 0x10820;
pub const GATE_TOP_SCLK_DISP1: c_uint = 0x10828;
pub const GATE_TOP_SCLK_MAU: c_uint = 0x1083c;
pub const GATE_TOP_SCLK_FSYS: c_uint = 0x10840;
pub const GATE_TOP_SCLK_PERIC: c_uint = 0x10850;
pub const TOP_SPARE2: c_uint = 0x10b08;
pub const BPLL_LOCK: c_uint = 0x20010;
pub const BPLL_CON0: c_uint = 0x20110;
pub const SRC_CDREX: c_uint = 0x20200;
pub const DIV_CDREX0: c_uint = 0x20500;
pub const DIV_CDREX1: c_uint = 0x20504;
pub const GATE_BUS_CDREX0: c_uint = 0x20700;
pub const GATE_BUS_CDREX1: c_uint = 0x20704;
...
// fixed rate clocks generated inside the soc
    ...
    FRATE(0, "sclk_pwi", core::ptr::null_mut(), 0, 24000000),
    FRATE(0, "sclk_usbh20", core::ptr::null_mut(), 0, 48000000),
    FRATE(0, "mphy_refclk_ixtal24", core::ptr::null_mut(), 0, 48000000),
    FRATE(0, "sclk_usbh20_scan_clk", core::ptr::null_mut(), 0, 480000000),
    };
...
// register exynos5420 clocks
    ...
    if (soc == EXYNOS5800) {
    samsung_clk_sleep_init(reg_base, core::ptr::null_mut(), exynos5800_clk_regs,
...
#[no_mangle]
unsafe extern "C" fn exynos5420_clk_init(np: *mut device_node) -> void __init {
    ...
    exynos5420_clk_init);
#[no_mangle]
unsafe extern "C" fn exynos5800_clk_init(np: *mut device_node) -> void __init {
