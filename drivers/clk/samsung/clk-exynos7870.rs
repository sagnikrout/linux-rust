...
//! Source: drivers/clk/samsung/clk-exynos7870.c
#![no_std]
...
//
pub const PLL_LOCKTIME_MIF_MEM_PLL: c_uint = 0x0000;
pub const PLL_LOCKTIME_MIF_MEDIA_PLL: c_uint = 0x0020;
pub const PLL_LOCKTIME_MIF_BUS_PLL: c_uint = 0x0040;
pub const PLL_CON0_MIF_MEM_PLL: c_uint = 0x0100;
pub const PLL_CON0_MIF_MEDIA_PLL: c_uint = 0x0120;
pub const PLL_CON0_MIF_BUS_PLL: c_uint = 0x0140;
pub const CLK_CON_GAT_MIF_MUX_MEM_PLL: c_uint = 0x0200;
pub const CLK_CON_GAT_MIF_MUX_MEM_PLL_CON: c_uint = 0x0200;
pub const CLK_CON_GAT_MIF_MUX_MEDIA_PLL: c_uint = 0x0204;
pub const CLK_CON_GAT_MIF_MUX_MEDIA_PLL_CON: c_uint = 0x0204;
pub const CLK_CON_GAT_MIF_MUX_BUS_PLL: c_uint = 0x0208;
pub const CLK_CON_GAT_MIF_MUX_BUS_PLL_CON: c_uint = 0x0208;
pub const CLK_CON_GAT_MIF_MUX_BUSD: c_uint = 0x0220;
pub const CLK_CON_MUX_MIF_BUSD: c_uint = 0x0220;
pub const CLK_CON_GAT_MIF_MUX_CMU_ISP_VRA: c_uint = 0x0264;
pub const CLK_CON_MUX_MIF_CMU_ISP_VRA: c_uint = 0x0264;
pub const CLK_CON_GAT_MIF_MUX_CMU_ISP_CAM: c_uint = 0x0268;
pub const CLK_CON_MUX_MIF_CMU_ISP_CAM: c_uint = 0x0268;
pub const CLK_CON_GAT_MIF_MUX_CMU_ISP_ISP: c_uint = 0x026c;
pub const CLK_CON_MUX_MIF_CMU_ISP_ISP: c_uint = 0x026c;
pub const CLK_CON_GAT_MIF_MUX_CMU_DISPAUD_BUS: c_uint = 0x0270;
pub const CLK_CON_MUX_MIF_CMU_DISPAUD_BUS: c_uint = 0x0270;
pub const CLK_CON_GAT_MIF_MUX_CMU_DISPAUD_DECON_VCLK: c_uint = 0x0274;
pub const CLK_CON_MUX_MIF_CMU_DISPAUD_DECON_VCLK: c_uint = 0x0274;
pub const CLK_CON_GAT_MIF_MUX_CMU_DISPAUD_DECON_ECLK: c_uint = 0x0278;
pub const CLK_CON_MUX_MIF_CMU_DISPAUD_DECON_ECLK: c_uint = 0x0278;
pub const CLK_CON_GAT_MIF_MUX_CMU_MFCMSCL_MSCL: c_uint = 0x027c;
pub const CLK_CON_MUX_MIF_CMU_MFCMSCL_MSCL: c_uint = 0x027c;
pub const CLK_CON_GAT_MIF_MUX_CMU_MFCMSCL_MFC: c_uint = 0x0280;
pub const CLK_CON_MUX_MIF_CMU_MFCMSCL_MFC: c_uint = 0x0280;
pub const CLK_CON_GAT_MIF_MUX_CMU_FSYS_BUS: c_uint = 0x0284;
pub const CLK_CON_MUX_MIF_CMU_FSYS_BUS: c_uint = 0x0284;
pub const CLK_CON_GAT_MIF_MUX_CMU_FSYS_MMC0: c_uint = 0x0288;
pub const CLK_CON_MUX_MIF_CMU_FSYS_MMC0: c_uint = 0x0288;
pub const CLK_CON_GAT_MIF_MUX_CMU_FSYS_MMC1: c_uint = 0x028c;
pub const CLK_CON_MUX_MIF_CMU_FSYS_MMC1: c_uint = 0x028c;
pub const CLK_CON_GAT_MIF_MUX_CMU_FSYS_MMC2: c_uint = 0x0290;
pub const CLK_CON_MUX_MIF_CMU_FSYS_MMC2: c_uint = 0x0290;
pub const CLK_CON_GAT_MIF_MUX_CMU_FSYS_USB20DRD_REFCLK: c_uint = 0x029c;
pub const CLK_CON_MUX_MIF_CMU_FSYS_USB20DRD_REFCLK: c_uint = 0x029c;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_BUS: c_uint = 0x02a0;
pub const CLK_CON_MUX_MIF_CMU_PERI_BUS: c_uint = 0x02a0;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_UART1: c_uint = 0x02a4;
pub const CLK_CON_MUX_MIF_CMU_PERI_UART1: c_uint = 0x02a4;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_UART2: c_uint = 0x02a8;
pub const CLK_CON_MUX_MIF_CMU_PERI_UART2: c_uint = 0x02a8;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_UART0: c_uint = 0x02ac;
pub const CLK_CON_MUX_MIF_CMU_PERI_UART0: c_uint = 0x02ac;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI2: c_uint = 0x02b0;
pub const CLK_CON_MUX_MIF_CMU_PERI_SPI2: c_uint = 0x02b0;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI1: c_uint = 0x02b4;
pub const CLK_CON_MUX_MIF_CMU_PERI_SPI1: c_uint = 0x02b4;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI0: c_uint = 0x02b8;
pub const CLK_CON_MUX_MIF_CMU_PERI_SPI0: c_uint = 0x02b8;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI3: c_uint = 0x02bc;
pub const CLK_CON_MUX_MIF_CMU_PERI_SPI3: c_uint = 0x02bc;
pub const CLK_CON_GAT_MIF_MUX_CMU_PERI_SPI4: c_uint = 0x02c0;
pub const CLK_CON_MUX_MIF_CMU_PERI_SPI4: c_uint = 0x02c0;
pub const CLK_CON_GAT_MIF_MUX_CMU_ISP_SENSOR0: c_uint = 0x02c4;
pub const CLK_CON_MUX_MIF_CMU_ISP_SENSOR0: c_uint = 0x02c4;
pub const CLK_CON_GAT_MIF_MUX_CMU_ISP_SENSOR1: c_uint = 0x02c8;
pub const CLK_CON_MUX_MIF_CMU_ISP_SENSOR1: c_uint = 0x02c8;
pub const CLK_CON_GAT_MIF_MUX_CMU_ISP_SENSOR2: c_uint = 0x02cc;
pub const CLK_CON_MUX_MIF_CMU_ISP_SENSOR2: c_uint = 0x02cc;
pub const CLK_CON_DIV_MIF_BUSD: c_uint = 0x0420;
pub const CLK_CON_DIV_MIF_APB: c_uint = 0x0424;
pub const CLK_CON_DIV_MIF_HSI2C: c_uint = 0x0430;
pub const CLK_CON_DIV_MIF_CMU_G3D_SWITCH: c_uint = 0x0460;
pub const CLK_CON_DIV_MIF_CMU_ISP_VRA: c_uint = 0x0464;
pub const CLK_CON_DIV_MIF_CMU_ISP_CAM: c_uint = 0x0468;
pub const CLK_CON_DIV_MIF_CMU_ISP_ISP: c_uint = 0x046c;
pub const CLK_CON_DIV_MIF_CMU_DISPAUD_BUS: c_uint = 0x0470;
pub const CLK_CON_DIV_MIF_CMU_DISPAUD_DECON_VCLK: c_uint = 0x0474;
pub const CLK_CON_DIV_MIF_CMU_DISPAUD_DECON_ECLK: c_uint = 0x0478;
pub const CLK_CON_DIV_MIF_CMU_MFCMSCL_MSCL: c_uint = 0x047c;
pub const CLK_CON_DIV_MIF_CMU_MFCMSCL_MFC: c_uint = 0x0480;
pub const CLK_CON_DIV_MIF_CMU_FSYS_BUS: c_uint = 0x0484;
pub const CLK_CON_DIV_MIF_CMU_FSYS_MMC0: c_uint = 0x0488;
pub const CLK_CON_DIV_MIF_CMU_FSYS_MMC1: c_uint = 0x048c;
pub const CLK_CON_DIV_MIF_CMU_FSYS_MMC2: c_uint = 0x0490;
pub const CLK_CON_DIV_MIF_CMU_FSYS_USB20DRD_REFCLK: c_uint = 0x049c;
pub const CLK_CON_DIV_MIF_CMU_PERI_BUS: c_uint = 0x04a0;
pub const CLK_CON_DIV_MIF_CMU_PERI_UART1: c_uint = 0x04a4;
pub const CLK_CON_DIV_MIF_CMU_PERI_UART2: c_uint = 0x04a8;
pub const CLK_CON_DIV_MIF_CMU_PERI_UART0: c_uint = 0x04ac;
pub const CLK_CON_DIV_MIF_CMU_PERI_SPI2: c_uint = 0x04b0;
pub const CLK_CON_DIV_MIF_CMU_PERI_SPI1: c_uint = 0x04b4;
pub const CLK_CON_DIV_MIF_CMU_PERI_SPI0: c_uint = 0x04b8;
pub const CLK_CON_DIV_MIF_CMU_PERI_SPI3: c_uint = 0x04bc;
pub const CLK_CON_DIV_MIF_CMU_PERI_SPI4: c_uint = 0x04c0;
pub const CLK_CON_DIV_MIF_CMU_ISP_SENSOR0: c_uint = 0x04c4;
pub const CLK_CON_DIV_MIF_CMU_ISP_SENSOR1: c_uint = 0x04c8;
pub const CLK_CON_DIV_MIF_CMU_ISP_SENSOR2: c_uint = 0x04cc;
pub const CLK_CON_GAT_MIF_WRAP_ADC_IF_OSC_SYS: c_uint = 0x080c;
pub const CLK_CON_GAT_MIF_HSI2C_AP_PCLKS: c_uint = 0x0828;
pub const CLK_CON_GAT_MIF_HSI2C_CP_PCLKS: c_uint = 0x0828;
pub const CLK_CON_GAT_MIF_WRAP_ADC_IF_PCLK_S0: c_uint = 0x0828;
pub const CLK_CON_GAT_MIF_WRAP_ADC_IF_PCLK_S1: c_uint = 0x0828;
pub const CLK_CON_GAT_MIF_HSI2C_AP_PCLKM: c_uint = 0x0840;
pub const CLK_CON_GAT_MIF_HSI2C_CP_PCLKM: c_uint = 0x0840;
pub const CLK_CON_GAT_MIF_HSI2C_IPCLK: c_uint = 0x0840;
pub const CLK_CON_GAT_MIF_HSI2C_ITCLK: c_uint = 0x0840;
pub const CLK_CON_GAT_MIF_CP_PCLK_HSI2C: c_uint = 0x0840;
pub const CLK_CON_GAT_MIF_CP_PCLK_HSI2C_BAT_0: c_uint = 0x0840;
pub const CLK_CON_GAT_MIF_CP_PCLK_HSI2C_BAT_1: c_uint = 0x0840;
pub const CLK_CON_GAT_MIF_CMU_G3D_SWITCH: c_uint = 0x0860;
pub const CLK_CON_GAT_MIF_CMU_ISP_VRA: c_uint = 0x0864;
pub const CLK_CON_GAT_MIF_CMU_ISP_CAM: c_uint = 0x0868;
pub const CLK_CON_GAT_MIF_CMU_ISP_ISP: c_uint = 0x086c;
pub const CLK_CON_GAT_MIF_CMU_DISPAUD_BUS: c_uint = 0x0870;
pub const CLK_CON_GAT_MIF_CMU_DISPAUD_DECON_VCLK: c_uint = 0x0874;
pub const CLK_CON_GAT_MIF_CMU_DISPAUD_DECON_ECLK: c_uint = 0x0878;
pub const CLK_CON_GAT_MIF_CMU_MFCMSCL_MSCL: c_uint = 0x087c;
pub const CLK_CON_GAT_MIF_CMU_MFCMSCL_MFC: c_uint = 0x0880;
pub const CLK_CON_GAT_MIF_CMU_FSYS_BUS: c_uint = 0x0884;
pub const CLK_CON_GAT_MIF_CMU_FSYS_MMC0: c_uint = 0x0888;
pub const CLK_CON_GAT_MIF_CMU_FSYS_MMC1: c_uint = 0x088c;
pub const CLK_CON_GAT_MIF_CMU_FSYS_MMC2: c_uint = 0x0890;
pub const CLK_CON_GAT_MIF_CMU_FSYS_USB20DRD_REFCLK: c_uint = 0x089c;
pub const CLK_CON_GAT_MIF_CMU_PERI_BUS: c_uint = 0x08a0;
pub const CLK_CON_GAT_MIF_CMU_PERI_UART1: c_uint = 0x08a4;
pub const CLK_CON_GAT_MIF_CMU_PERI_UART2: c_uint = 0x08a8;
pub const CLK_CON_GAT_MIF_CMU_PERI_UART0: c_uint = 0x08ac;
pub const CLK_CON_GAT_MIF_CMU_PERI_SPI2: c_uint = 0x08b0;
pub const CLK_CON_GAT_MIF_CMU_PERI_SPI1: c_uint = 0x08b4;
pub const CLK_CON_GAT_MIF_CMU_PERI_SPI0: c_uint = 0x08b8;
pub const CLK_CON_GAT_MIF_CMU_PERI_SPI3: c_uint = 0x08bc;
pub const CLK_CON_GAT_MIF_CMU_PERI_SPI4: c_uint = 0x08c0;
pub const CLK_CON_GAT_MIF_CMU_ISP_SENSOR0: c_uint = 0x08c4;
pub const CLK_CON_GAT_MIF_CMU_ISP_SENSOR1: c_uint = 0x08c8;
pub const CLK_CON_GAT_MIF_CMU_ISP_SENSOR2: c_uint = 0x08cc;
...
//
pub const PLL_LOCKTIME_DISPAUD_PLL: c_uint = 0x0000;
pub const PLL_LOCKTIME_DISPAUD_AUD_PLL: c_uint = 0x00c0;
pub const PLL_CON0_DISPAUD_PLL: c_uint = 0x0100;
pub const PLL_CON0_DISPAUD_AUD_PLL: c_uint = 0x01c0;
pub const CLK_CON_GAT_DISPAUD_MUX_PLL: c_uint = 0x0200;
pub const CLK_CON_GAT_DISPAUD_MUX_PLL_CON: c_uint = 0x0200;
pub const CLK_CON_GAT_DISPAUD_MUX_AUD_PLL: c_uint = 0x0204;
pub const CLK_CON_GAT_DISPAUD_MUX_AUD_PLL_CON: c_uint = 0x0204;
pub const CLK_CON_GAT_DISPAUD_MUX_BUS_USER: c_uint = 0x0210;
pub const CLK_CON_MUX_DISPAUD_BUS_USER: c_uint = 0x0210;
pub const CLK_CON_GAT_DISPAUD_MUX_DECON_VCLK_USER: c_uint = 0x0214;
pub const CLK_CON_MUX_DISPAUD_DECON_VCLK_USER: c_uint = 0x0214;
pub const CLK_CON_GAT_DISPAUD_MUX_DECON_ECLK_USER: c_uint = 0x0218;
pub const CLK_CON_MUX_DISPAUD_DECON_ECLK_USER: c_uint = 0x0218;
pub const CLK_CON_GAT_DISPAUD_MUX_DECON_VCLK: c_uint = 0x021c;
pub const CLK_CON_MUX_DISPAUD_DECON_VCLK: c_uint = 0x021c;
pub const CLK_CON_GAT_DISPAUD_MUX_DECON_ECLK: c_uint = 0x0220;
pub const CLK_CON_MUX_DISPAUD_DECON_ECLK: c_uint = 0x0220;
pub const CLK_CON_GAT_DISPAUD_MUX_MIPIPHY_TXBYTECLKHS_USER: c_uint = 0x0224;
pub const CLK_CON_GAT_DISPAUD_MUX_MIPIPHY_TXBYTECLKHS_USER_CON: c_uint = 0x0224;
pub const CLK_CON_GAT_DISPAUD_MUX_MIPIPHY_RXCLKESC0_USER: c_uint = 0x0228;
pub const CLK_CON_GAT_DISPAUD_MUX_MIPIPHY_RXCLKESC0_USER_CON: c_uint = 0x0228;
pub const CLK_CON_GAT_DISPAUD_MUX_MI2S: c_uint = 0x022c;
pub const CLK_CON_MUX_DISPAUD_MI2S: c_uint = 0x022c;
pub const CLK_CON_DIV_DISPAUD_APB: c_uint = 0x0400;
pub const CLK_CON_DIV_DISPAUD_DECON_VCLK: c_uint = 0x0404;
pub const CLK_CON_DIV_DISPAUD_DECON_ECLK: c_uint = 0x0408;
pub const CLK_CON_DIV_DISPAUD_MI2S: c_uint = 0x040c;
pub const CLK_CON_DIV_DISPAUD_MIXER: c_uint = 0x0410;
pub const CLK_CON_GAT_DISPAUD_BUS: c_uint = 0x0810;
pub const CLK_CON_GAT_DISPAUD_BUS_DISP: c_uint = 0x0810;
pub const CLK_CON_GAT_DISPAUD_BUS_PPMU: c_uint = 0x0810;
pub const CLK_CON_GAT_DISPAUD_APB_AUD: c_uint = 0x0814;
pub const CLK_CON_GAT_DISPAUD_APB_AUD_AMP: c_uint = 0x0814;
pub const CLK_CON_GAT_DISPAUD_APB_DISP: c_uint = 0x0814;
pub const CLK_CON_GAT_DISPAUD_DECON_VCLK: c_uint = 0x081c;
pub const CLK_CON_GAT_DISPAUD_DECON_ECLK: c_uint = 0x0820;
pub const CLK_CON_GAT_DISPAUD_MI2S_AMP_I2SCODCLKI: c_uint = 0x082c;
pub const CLK_CON_GAT_DISPAUD_MI2S_AUD_I2SCODCLKI: c_uint = 0x082c;
pub const CLK_CON_GAT_DISPAUD_MIXER_AUD_SYSCLK: c_uint = 0x0830;
pub const CLK_CON_GAT_DISPAUD_CON_EXT2AUD_BCK_GPIO_I2S: c_uint = 0x0834;
pub const CLK_CON_GAT_DISPAUD_CON_AUD_I2S_BCLK_BT_IN: c_uint = 0x0838;
pub const CLK_CON_GAT_DISPAUD_CON_CP2AUD_BCK: c_uint = 0x083c;
pub const CLK_CON_GAT_DISPAUD_CON_AUD_I2S_BCLK_FM_IN: c_uint = 0x0840;
...
//
pub const PLL_LOCKTIME_FSYS_USB_PLL: c_uint = 0x0000;
pub const PLL_CON0_FSYS_USB_PLL: c_uint = 0x0100;
pub const CLK_CON_GAT_FSYS_MUX_USB_PLL: c_uint = 0x0200;
pub const CLK_CON_GAT_FSYS_MUX_USB_PLL_CON: c_uint = 0x0200;
pub const CLK_CON_GAT_FSYS_MUX_USB20DRD_PHYCLOCK_USER: c_uint = 0x0230;
pub const CLK_CON_GAT_FSYS_MUX_USB20DRD_PHYCLOCK_USER_CON: c_uint = 0x0230;
pub const CLK_CON_GAT_FSYS_BUSP3_HCLK: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_MMC0_ACLK: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_MMC1_ACLK: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_MMC2_ACLK: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_PDMA0_ACLK_PDMA0: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_PPMU_ACLK: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_PPMU_PCLK: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_SROMC_HCLK: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_UPSIZER_BUS1_ACLK: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_USB20DRD_ACLK_HSDRD: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_USB20DRD_HCLK_USB20_CTRL: c_uint = 0x0804;
pub const CLK_CON_GAT_FSYS_USB20DRD_HSDRD_REF_CLK: c_uint = 0x0828;
...
//
pub const PLL_LOCKTIME_G3D_PLL: c_uint = 0x0000;
pub const PLL_CON0_G3D_PLL: c_uint = 0x0100;
pub const CLK_CON_GAT_G3D_MUX_PLL: c_uint = 0x0200;
pub const CLK_CON_GAT_G3D_MUX_PLL_CON: c_uint = 0x0200;
pub const CLK_CON_GAT_G3D_MUX_SWITCH_USER: c_uint = 0x0204;
pub const CLK_CON_MUX_G3D_SWITCH_USER: c_uint = 0x0204;
pub const CLK_CON_GAT_G3D_MUX: c_uint = 0x0208;
pub const CLK_CON_MUX_G3D: c_uint = 0x0208;
pub const CLK_CON_DIV_G3D_BUS: c_uint = 0x0400;
pub const CLK_CON_DIV_G3D_APB: c_uint = 0x0404;
pub const CLK_CON_GAT_G3D_ASYNCS_D0_CLK: c_uint = 0x0804;
pub const CLK_CON_GAT_G3D_ASYNC_PCLKM: c_uint = 0x0804;
pub const CLK_CON_GAT_G3D_CLK: c_uint = 0x0804;
pub const CLK_CON_GAT_G3D_PPMU_ACLK: c_uint = 0x0804;
pub const CLK_CON_GAT_G3D_QE_ACLK: c_uint = 0x0804;
pub const CLK_CON_GAT_G3D_PPMU_PCLK: c_uint = 0x0808;
pub const CLK_CON_GAT_G3D_QE_PCLK: c_uint = 0x0808;
pub const CLK_CON_GAT_G3D_SYSREG_PCLK: c_uint = 0x0808;
...
//
pub const PLL_LOCKTIME_ISP_PLL: c_uint = 0x0000;
pub const PLL_CON0_ISP_PLL: c_uint = 0x0100;
pub const CLK_CON_GAT_ISP_MUX_PLL: c_uint = 0x0200;
pub const CLK_CON_GAT_ISP_MUX_PLL_CON: c_uint = 0x0200;
pub const CLK_CON_GAT_ISP_MUX_VRA_USER: c_uint = 0x0210;
pub const CLK_CON_MUX_ISP_VRA_USER: c_uint = 0x0210;
pub const CLK_CON_GAT_ISP_MUX_CAM_USER: c_uint = 0x0214;
pub const CLK_CON_MUX_ISP_CAM_USER: c_uint = 0x0214;
pub const CLK_CON_GAT_ISP_MUX_USER: c_uint = 0x0218;
pub const CLK_CON_MUX_ISP_USER: c_uint = 0x0218;
pub const CLK_CON_GAT_ISP_MUX_VRA: c_uint = 0x0220;
pub const CLK_CON_MUX_ISP_VRA: c_uint = 0x0220;
pub const CLK_CON_GAT_ISP_MUX_CAM: c_uint = 0x0224;
pub const CLK_CON_MUX_ISP_CAM: c_uint = 0x0224;
pub const CLK_CON_GAT_ISP_MUX_ISP: c_uint = 0x0228;
pub const CLK_CON_MUX_ISP_ISP: c_uint = 0x0228;
pub const CLK_CON_GAT_ISP_MUX_ISPD: c_uint = 0x022c;
pub const CLK_CON_MUX_ISP_ISPD: c_uint = 0x022c;
pub const CLK_CON_GAT_ISP_MUX_RXBYTECLKHS0_SENSOR0_USER: c_uint = 0x0230;
pub const CLK_CON_GAT_ISP_MUX_RXBYTECLKHS0_SENSOR0_USER_CON: c_uint = 0x0230;
pub const CLK_CON_GAT_ISP_MUX_RXBYTECLKHS0_SENSOR1_USER: c_uint = 0x0234;
pub const CLK_CON_GAT_ISP_MUX_RXBYTECLKHS0_SENSOR1_USER_CON: c_uint = 0x0234;
pub const CLK_CON_DIV_ISP_APB: c_uint = 0x0400;
pub const CLK_CON_DIV_ISP_CAM_HALF: c_uint = 0x0404;
pub const CLK_CON_GAT_ISP_VRA: c_uint = 0x0810;
pub const CLK_CON_GAT_ISP_ISPD: c_uint = 0x0818;
pub const CLK_CON_GAT_ISP_ISPD_PPMU: c_uint = 0x0818;
pub const CLK_CON_GAT_ISP_CAM: c_uint = 0x081c;
pub const CLK_CON_GAT_ISP_CAM_HALF: c_uint = 0x0820;
...
//
pub const CLK_CON_GAT_MFCMSCL_MUX_MSCL_USER: c_uint = 0x0200;
pub const CLK_CON_MUX_MFCMSCL_MSCL_USER: c_uint = 0x0200;
pub const CLK_CON_GAT_MFCMSCL_MUX_MFC_USER: c_uint = 0x0204;
pub const CLK_CON_MUX_MFCMSCL_MFC_USER: c_uint = 0x0204;
pub const CLK_CON_DIV_MFCMSCL_APB: c_uint = 0x0400;
pub const CLK_CON_GAT_MFCMSCL_MSCL: c_uint = 0x0804;
pub const CLK_CON_GAT_MFCMSCL_MSCL_BI: c_uint = 0x0804;
pub const CLK_CON_GAT_MFCMSCL_MSCL_D: c_uint = 0x0804;
pub const CLK_CON_GAT_MFCMSCL_MSCL_JPEG: c_uint = 0x0804;
pub const CLK_CON_GAT_MFCMSCL_MSCL_POLY: c_uint = 0x0804;
pub const CLK_CON_GAT_MFCMSCL_MSCL_PPMU: c_uint = 0x0804;
pub const CLK_CON_GAT_MFCMSCL_MFC: c_uint = 0x0808;
...
//
pub const CLK_CON_GAT_PERI_PWM_MOTOR_OSCCLK: c_uint = 0x0800;
pub const CLK_CON_GAT_PERI_TMU_CPUCL0_CLK: c_uint = 0x0800;
pub const CLK_CON_GAT_PERI_TMU_CPUCL1_CLK: c_uint = 0x0800;
pub const CLK_CON_GAT_PERI_TMU_CLK: c_uint = 0x0800;
pub const CLK_CON_GAT_PERI_BUSP1_PERIC0_HCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_GPIO2_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_GPIO5_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_GPIO6_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_GPIO7_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_HSI2C4_IPCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_HSI2C6_IPCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_HSI2C3_IPCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_HSI2C5_IPCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_HSI2C2_IPCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_HSI2C1_IPCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C0_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C4_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C5_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C6_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C7_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C8_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C3_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C2_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_I2C1_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_MCT_PCLK: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_PWM_MOTOR_PCLK_S0: c_uint = 0x0810;
pub const CLK_CON_GAT_PERI_SFRIF_TMU_CPUCL0_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_SFRIF_TMU_CPUCL1_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_SFRIF_TMU_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_SPI0_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_SPI2_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_SPI1_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_SPI4_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_SPI3_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_UART1_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_UART2_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_UART0_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_WDT_CPUCL0_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_WDT_CPUCL1_PCLK: c_uint = 0x0814;
pub const CLK_CON_GAT_PERI_UART1_EXT_UCLK: c_uint = 0x0830;
pub const CLK_CON_GAT_PERI_UART2_EXT_UCLK: c_uint = 0x0834;
pub const CLK_CON_GAT_PERI_UART0_EXT_UCLK: c_uint = 0x0838;
pub const CLK_CON_GAT_PERI_SPI2_SPI_EXT_CLK: c_uint = 0x083c;
pub const CLK_CON_GAT_PERI_SPI1_SPI_EXT_CLK: c_uint = 0x0840;
pub const CLK_CON_GAT_PERI_SPI0_SPI_EXT_CLK: c_uint = 0x0844;
pub const CLK_CON_GAT_PERI_SPI3_SPI_EXT_CLK: c_uint = 0x0848;
pub const CLK_CON_GAT_PERI_SPI4_SPI_EXT_CLK: c_uint = 0x084c;
...
#[no_mangle]
unsafe extern "C" fn exynos7870_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynos7870_cmu_init() -> int __init {
