...
//! Source: drivers/clk/samsung/clk-exynos5433.c
#![no_std]
...
//
pub const ISP_PLL_LOCK: c_uint = 0x0000;
pub const AUD_PLL_LOCK: c_uint = 0x0004;
pub const ISP_PLL_CON0: c_uint = 0x0100;
pub const ISP_PLL_CON1: c_uint = 0x0104;
pub const ISP_PLL_FREQ_DET: c_uint = 0x0108;
pub const AUD_PLL_CON0: c_uint = 0x0110;
pub const AUD_PLL_CON1: c_uint = 0x0114;
pub const AUD_PLL_CON2: c_uint = 0x0118;
pub const AUD_PLL_FREQ_DET: c_uint = 0x011c;
pub const MUX_SEL_TOP0: c_uint = 0x0200;
pub const MUX_SEL_TOP1: c_uint = 0x0204;
pub const MUX_SEL_TOP2: c_uint = 0x0208;
pub const MUX_SEL_TOP3: c_uint = 0x020c;
pub const MUX_SEL_TOP4: c_uint = 0x0210;
pub const MUX_SEL_TOP_MSCL: c_uint = 0x0220;
pub const MUX_SEL_TOP_CAM1: c_uint = 0x0224;
pub const MUX_SEL_TOP_DISP: c_uint = 0x0228;
pub const MUX_SEL_TOP_FSYS0: c_uint = 0x0230;
pub const MUX_SEL_TOP_FSYS1: c_uint = 0x0234;
pub const MUX_SEL_TOP_PERIC0: c_uint = 0x0238;
pub const MUX_SEL_TOP_PERIC1: c_uint = 0x023c;
pub const MUX_ENABLE_TOP0: c_uint = 0x0300;
pub const MUX_ENABLE_TOP1: c_uint = 0x0304;
pub const MUX_ENABLE_TOP2: c_uint = 0x0308;
pub const MUX_ENABLE_TOP3: c_uint = 0x030c;
pub const MUX_ENABLE_TOP4: c_uint = 0x0310;
pub const MUX_ENABLE_TOP_MSCL: c_uint = 0x0320;
pub const MUX_ENABLE_TOP_CAM1: c_uint = 0x0324;
pub const MUX_ENABLE_TOP_DISP: c_uint = 0x0328;
pub const MUX_ENABLE_TOP_FSYS0: c_uint = 0x0330;
pub const MUX_ENABLE_TOP_FSYS1: c_uint = 0x0334;
pub const MUX_ENABLE_TOP_PERIC0: c_uint = 0x0338;
pub const MUX_ENABLE_TOP_PERIC1: c_uint = 0x033c;
pub const MUX_STAT_TOP0: c_uint = 0x0400;
pub const MUX_STAT_TOP1: c_uint = 0x0404;
pub const MUX_STAT_TOP2: c_uint = 0x0408;
pub const MUX_STAT_TOP3: c_uint = 0x040c;
pub const MUX_STAT_TOP4: c_uint = 0x0410;
pub const MUX_STAT_TOP_MSCL: c_uint = 0x0420;
pub const MUX_STAT_TOP_CAM1: c_uint = 0x0424;
pub const MUX_STAT_TOP_FSYS0: c_uint = 0x0430;
pub const MUX_STAT_TOP_FSYS1: c_uint = 0x0434;
pub const MUX_STAT_TOP_PERIC0: c_uint = 0x0438;
pub const MUX_STAT_TOP_PERIC1: c_uint = 0x043c;
pub const DIV_TOP0: c_uint = 0x0600;
pub const DIV_TOP1: c_uint = 0x0604;
pub const DIV_TOP2: c_uint = 0x0608;
pub const DIV_TOP3: c_uint = 0x060c;
pub const DIV_TOP4: c_uint = 0x0610;
pub const DIV_TOP_MSCL: c_uint = 0x0618;
pub const DIV_TOP_CAM10: c_uint = 0x061c;
pub const DIV_TOP_CAM11: c_uint = 0x0620;
pub const DIV_TOP_FSYS0: c_uint = 0x062c;
pub const DIV_TOP_FSYS1: c_uint = 0x0630;
pub const DIV_TOP_FSYS2: c_uint = 0x0634;
pub const DIV_TOP_PERIC0: c_uint = 0x0638;
pub const DIV_TOP_PERIC1: c_uint = 0x063c;
pub const DIV_TOP_PERIC2: c_uint = 0x0640;
pub const DIV_TOP_PERIC3: c_uint = 0x0644;
pub const DIV_TOP_PERIC4: c_uint = 0x0648;
pub const DIV_TOP_PLL_FREQ_DET: c_uint = 0x064c;
pub const DIV_STAT_TOP0: c_uint = 0x0700;
pub const DIV_STAT_TOP1: c_uint = 0x0704;
pub const DIV_STAT_TOP2: c_uint = 0x0708;
pub const DIV_STAT_TOP3: c_uint = 0x070c;
pub const DIV_STAT_TOP4: c_uint = 0x0710;
pub const DIV_STAT_TOP_MSCL: c_uint = 0x0718;
pub const DIV_STAT_TOP_CAM10: c_uint = 0x071c;
pub const DIV_STAT_TOP_CAM11: c_uint = 0x0720;
pub const DIV_STAT_TOP_FSYS0: c_uint = 0x072c;
pub const DIV_STAT_TOP_FSYS1: c_uint = 0x0730;
pub const DIV_STAT_TOP_FSYS2: c_uint = 0x0734;
pub const DIV_STAT_TOP_PERIC0: c_uint = 0x0738;
pub const DIV_STAT_TOP_PERIC1: c_uint = 0x073c;
pub const DIV_STAT_TOP_PERIC2: c_uint = 0x0740;
pub const DIV_STAT_TOP_PERIC3: c_uint = 0x0744;
pub const DIV_STAT_TOP_PLL_FREQ_DET: c_uint = 0x074c;
pub const ENABLE_ACLK_TOP: c_uint = 0x0800;
pub const ENABLE_SCLK_TOP: c_uint = 0x0a00;
pub const ENABLE_SCLK_TOP_MSCL: c_uint = 0x0a04;
pub const ENABLE_SCLK_TOP_CAM1: c_uint = 0x0a08;
pub const ENABLE_SCLK_TOP_DISP: c_uint = 0x0a0c;
pub const ENABLE_SCLK_TOP_FSYS: c_uint = 0x0a10;
pub const ENABLE_SCLK_TOP_PERIC: c_uint = 0x0a14;
pub const ENABLE_IP_TOP: c_uint = 0x0b00;
pub const ENABLE_CMU_TOP: c_uint = 0x0c00;
pub const ENABLE_CMU_TOP_DIV_STAT: c_uint = 0x0c04;
...
// Xi2s{0|1}CDCLK input clock for I2S/PCM
    FRATE(0, "ioclk_audiocdclk1", core::ptr::null_mut(), 0, 100000000),
    FRATE(0, "ioclk_audiocdclk0", core::ptr::null_mut(), 0, 100000000),
// Xi2s1SDI input clock for SPDIF
    FRATE(0, "ioclk_spdif_extclk", core::ptr::null_mut(), 0, 100000000),
// XspiCLK[4:0] input clock for SPI
    FRATE(0, "ioclk_spi4_clk_in", core::ptr::null_mut(), 0, 50000000),
    FRATE(0, "ioclk_spi3_clk_in", core::ptr::null_mut(), 0, 50000000),
    FRATE(0, "ioclk_spi2_clk_in", core::ptr::null_mut(), 0, 50000000),
    FRATE(0, "ioclk_spi1_clk_in", core::ptr::null_mut(), 0, 50000000),
    FRATE(0, "ioclk_spi0_clk_in", core::ptr::null_mut(), 0, 50000000),
// Xi2s1SCLK input clock for I2S1_BCLK
    FRATE(0, "ioclk_i2s1_bclk_in", core::ptr::null_mut(), 0, 12288000),
    };
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_top_init(np: *mut device_node) -> void __init {
...
//
pub const MPHY_PLL_LOCK: c_uint = 0x0000;
pub const MPHY_PLL_CON0: c_uint = 0x0100;
pub const MPHY_PLL_CON1: c_uint = 0x0104;
pub const MPHY_PLL_FREQ_DET: c_uint = 0x010c;
pub const MUX_SEL_CPIF0: c_uint = 0x0200;
pub const DIV_CPIF: c_uint = 0x0600;
pub const ENABLE_SCLK_CPIF: c_uint = 0x0a00;
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_cpif_init(np: *mut device_node) -> void __init {
...
//
pub const MEM0_PLL_LOCK: c_uint = 0x0000;
pub const MEM1_PLL_LOCK: c_uint = 0x0004;
pub const BUS_PLL_LOCK: c_uint = 0x0008;
pub const MFC_PLL_LOCK: c_uint = 0x000c;
pub const MEM0_PLL_CON0: c_uint = 0x0100;
pub const MEM0_PLL_CON1: c_uint = 0x0104;
pub const MEM0_PLL_FREQ_DET: c_uint = 0x010c;
pub const MEM1_PLL_CON0: c_uint = 0x0110;
pub const MEM1_PLL_CON1: c_uint = 0x0114;
pub const MEM1_PLL_FREQ_DET: c_uint = 0x011c;
pub const BUS_PLL_CON0: c_uint = 0x0120;
pub const BUS_PLL_CON1: c_uint = 0x0124;
pub const BUS_PLL_FREQ_DET: c_uint = 0x012c;
pub const MFC_PLL_CON0: c_uint = 0x0130;
pub const MFC_PLL_CON1: c_uint = 0x0134;
pub const MFC_PLL_FREQ_DET: c_uint = 0x013c;
pub const MUX_SEL_MIF0: c_uint = 0x0200;
pub const MUX_SEL_MIF1: c_uint = 0x0204;
pub const MUX_SEL_MIF2: c_uint = 0x0208;
pub const MUX_SEL_MIF3: c_uint = 0x020c;
pub const MUX_SEL_MIF4: c_uint = 0x0210;
pub const MUX_SEL_MIF5: c_uint = 0x0214;
pub const MUX_SEL_MIF6: c_uint = 0x0218;
pub const MUX_SEL_MIF7: c_uint = 0x021c;
pub const MUX_ENABLE_MIF0: c_uint = 0x0300;
pub const MUX_ENABLE_MIF1: c_uint = 0x0304;
pub const MUX_ENABLE_MIF2: c_uint = 0x0308;
pub const MUX_ENABLE_MIF3: c_uint = 0x030c;
pub const MUX_ENABLE_MIF4: c_uint = 0x0310;
pub const MUX_ENABLE_MIF5: c_uint = 0x0314;
pub const MUX_ENABLE_MIF6: c_uint = 0x0318;
pub const MUX_ENABLE_MIF7: c_uint = 0x031c;
pub const MUX_STAT_MIF0: c_uint = 0x0400;
pub const MUX_STAT_MIF1: c_uint = 0x0404;
pub const MUX_STAT_MIF2: c_uint = 0x0408;
pub const MUX_STAT_MIF3: c_uint = 0x040c;
pub const MUX_STAT_MIF4: c_uint = 0x0410;
pub const MUX_STAT_MIF5: c_uint = 0x0414;
pub const MUX_STAT_MIF6: c_uint = 0x0418;
pub const MUX_STAT_MIF7: c_uint = 0x041c;
pub const DIV_MIF1: c_uint = 0x0604;
pub const DIV_MIF2: c_uint = 0x0608;
pub const DIV_MIF3: c_uint = 0x060c;
pub const DIV_MIF4: c_uint = 0x0610;
pub const DIV_MIF5: c_uint = 0x0614;
pub const DIV_MIF_PLL_FREQ_DET: c_uint = 0x0618;
pub const DIV_STAT_MIF1: c_uint = 0x0704;
pub const DIV_STAT_MIF2: c_uint = 0x0708;
pub const DIV_STAT_MIF3: c_uint = 0x070c;
pub const DIV_STAT_MIF4: c_uint = 0x0710;
pub const DIV_STAT_MIF5: c_uint = 0x0714;
pub const DIV_STAT_MIF_PLL_FREQ_DET: c_uint = 0x0718;
pub const ENABLE_ACLK_MIF0: c_uint = 0x0800;
pub const ENABLE_ACLK_MIF1: c_uint = 0x0804;
pub const ENABLE_ACLK_MIF2: c_uint = 0x0808;
pub const ENABLE_ACLK_MIF3: c_uint = 0x080c;
pub const ENABLE_PCLK_MIF: c_uint = 0x0900;
pub const ENABLE_PCLK_MIF_SECURE_DREX0_TZ: c_uint = 0x0904;
pub const ENABLE_PCLK_MIF_SECURE_DREX1_TZ: c_uint = 0x0908;
pub const ENABLE_PCLK_MIF_SECURE_MONOTONIC_CNT: c_uint = 0x090c;
pub const ENABLE_PCLK_MIF_SECURE_RTC: c_uint = 0x0910;
pub const ENABLE_SCLK_MIF: c_uint = 0x0a00;
pub const ENABLE_IP_MIF0: c_uint = 0x0b00;
pub const ENABLE_IP_MIF1: c_uint = 0x0b04;
pub const ENABLE_IP_MIF2: c_uint = 0x0b08;
pub const ENABLE_IP_MIF3: c_uint = 0x0b0c;
pub const ENABLE_IP_MIF_SECURE_DREX0_TZ: c_uint = 0x0b10;
pub const ENABLE_IP_MIF_SECURE_DREX1_TZ: c_uint = 0x0b14;
pub const ENABLE_IP_MIF_SECURE_MONOTONIC_CNT: c_uint = 0x0b18;
pub const ENABLE_IP_MIF_SECURE_RTC: c_uint = 0x0b1c;
pub const CLKOUT_CMU_MIF: c_uint = 0x0c00;
pub const CLKOUT_CMU_MIF_DIV_STAT: c_uint = 0x0c04;
pub const DREX_FREQ_CTRL0: c_uint = 0x1000;
pub const DREX_FREQ_CTRL1: c_uint = 0x1004;
pub const PAUSE: c_uint = 0x1008;
pub const DDRPHY_LOCK_CTRL: c_uint = 0x100c;
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_mif_init(np: *mut device_node) -> void __init {
...
//
pub const DIV_PERIC: c_uint = 0x0600;
pub const DIV_STAT_PERIC: c_uint = 0x0700;
pub const ENABLE_ACLK_PERIC: c_uint = 0x0800;
pub const ENABLE_PCLK_PERIC0: c_uint = 0x0900;
pub const ENABLE_PCLK_PERIC1: c_uint = 0x0904;
pub const ENABLE_SCLK_PERIC: c_uint = 0x0A00;
pub const ENABLE_IP_PERIC0: c_uint = 0x0B00;
pub const ENABLE_IP_PERIC1: c_uint = 0x0B04;
pub const ENABLE_IP_PERIC2: c_uint = 0x0B08;
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_peric_init(np: *mut device_node) -> void __init {
...
//
pub const ENABLE_ACLK_PERIS: c_uint = 0x0800;
pub const ENABLE_PCLK_PERIS: c_uint = 0x0900;
pub const ENABLE_PCLK_PERIS_SECURE_TZPC: c_uint = 0x0904;
pub const ENABLE_PCLK_PERIS_SECURE_SECKEY_APBIF: c_uint = 0x0908;
pub const ENABLE_PCLK_PERIS_SECURE_CHIPID_APBIF: c_uint = 0x090c;
pub const ENABLE_PCLK_PERIS_SECURE_TOPRTC: c_uint = 0x0910;
pub const ENABLE_PCLK_PERIS_SECURE_CUSTOM_EFUSE_APBIF: c_uint = 0x0914;
pub const ENABLE_PCLK_PERIS_SECURE_ANTIRBK_CNT_APBIF: c_uint = 0x0918;
pub const ENABLE_PCLK_PERIS_SECURE_OTP_CON_APBIF: c_uint = 0x091c;
pub const ENABLE_SCLK_PERIS: c_uint = 0x0a00;
pub const ENABLE_SCLK_PERIS_SECURE_SECKEY: c_uint = 0x0a04;
pub const ENABLE_SCLK_PERIS_SECURE_CHIPID: c_uint = 0x0a08;
pub const ENABLE_SCLK_PERIS_SECURE_TOPRTC: c_uint = 0x0a0c;
pub const ENABLE_SCLK_PERIS_SECURE_CUSTOM_EFUSE: c_uint = 0x0a10;
pub const ENABLE_SCLK_PERIS_SECURE_ANTIRBK_CNT: c_uint = 0x0a14;
pub const ENABLE_SCLK_PERIS_SECURE_OTP_CON: c_uint = 0x0a18;
pub const ENABLE_IP_PERIS0: c_uint = 0x0b00;
pub const ENABLE_IP_PERIS1: c_uint = 0x0b04;
pub const ENABLE_IP_PERIS_SECURE_TZPC: c_uint = 0x0b08;
pub const ENABLE_IP_PERIS_SECURE_SECKEY: c_uint = 0x0b0c;
pub const ENABLE_IP_PERIS_SECURE_CHIPID: c_uint = 0x0b10;
pub const ENABLE_IP_PERIS_SECURE_TOPRTC: c_uint = 0x0b14;
pub const ENABLE_IP_PERIS_SECURE_CUSTOM_EFUSE: c_uint = 0x0b18;
pub const ENABLE_IP_PERIS_SECURE_ANTIBRK_CNT: c_uint = 0x0b1c;
pub const ENABLE_IP_PERIS_SECURE_OTP_CON: c_uint = 0x0b20;
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_peris_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_FSYS2: c_uint = 0x0208;
pub const MUX_SEL_FSYS3: c_uint = 0x020c;
pub const MUX_SEL_FSYS4: c_uint = 0x0210;
pub const MUX_ENABLE_FSYS0: c_uint = 0x0300;
pub const MUX_ENABLE_FSYS1: c_uint = 0x0304;
pub const MUX_ENABLE_FSYS2: c_uint = 0x0308;
pub const MUX_ENABLE_FSYS3: c_uint = 0x030c;
pub const MUX_ENABLE_FSYS4: c_uint = 0x0310;
pub const MUX_STAT_FSYS0: c_uint = 0x0400;
pub const MUX_STAT_FSYS1: c_uint = 0x0404;
pub const MUX_STAT_FSYS2: c_uint = 0x0408;
pub const MUX_STAT_FSYS3: c_uint = 0x040c;
pub const MUX_STAT_FSYS4: c_uint = 0x0410;
pub const MUX_IGNORE_FSYS2: c_uint = 0x0508;
pub const MUX_IGNORE_FSYS3: c_uint = 0x050c;
pub const ENABLE_ACLK_FSYS0: c_uint = 0x0800;
pub const ENABLE_ACLK_FSYS1: c_uint = 0x0804;
pub const ENABLE_PCLK_FSYS: c_uint = 0x0900;
pub const ENABLE_SCLK_FSYS: c_uint = 0x0a00;
pub const ENABLE_IP_FSYS0: c_uint = 0x0b00;
pub const ENABLE_IP_FSYS1: c_uint = 0x0b04;
// list of all parent clock list
...
// PHY clocks from USBDRD30_PHY
    ...
    "phyclk_usbdrd30_udrd30_phyclock_phy", core::ptr::null_mut(),
    0, 60000000),
    FRATE(CLK_PHYCLK_USBDRD30_UDRD30_PIPE_PCLK_PHY,
    "phyclk_usbdrd30_udrd30_pipe_pclk_phy", core::ptr::null_mut(),
    0, 125000000),
// PHY clocks from USBHOST30_PHY
    FRATE(CLK_PHYCLK_USBHOST30_UHOST30_PHYCLOCK_PHY,
    "phyclk_usbhost30_uhost30_phyclock_phy", core::ptr::null_mut(),
    0, 60000000),
    FRATE(CLK_PHYCLK_USBHOST30_UHOST30_PIPE_PCLK_PHY,
    "phyclk_usbhost30_uhost30_pipe_pclk_phy", core::ptr::null_mut(),
    0, 125000000),
// PHY clocks from USBHOST20_PHY
    FRATE(CLK_PHYCLK_USBHOST20_PHY_FREECLK_PHY,
    "phyclk_usbhost20_phy_freeclk_phy", core::ptr::null_mut(), 0, 60000000),
    FRATE(CLK_PHYCLK_USBHOST20_PHY_PHYCLOCK_PHY,
    "phyclk_usbhost20_phy_phyclock_phy", core::ptr::null_mut(), 0, 60000000),
    FRATE(CLK_PHYCLK_USBHOST20_PHY_CLK48MOHCI_PHY,
    "phyclk_usbhost20_phy_clk48mohci_phy", core::ptr::null_mut(),
    0, 48000000),
    FRATE(CLK_PHYCLK_USBHOST20_PHY_HSIC1_PHY,
    "phyclk_usbhost20_phy_hsic1_phy", core::ptr::null_mut(), 0,
    60000000),
// PHY clocks from UFS_PHY
    FRATE(CLK_PHYCLK_UFS_TX0_SYMBOL_PHY, "phyclk_ufs_tx0_symbol_phy",
    core::ptr::null_mut(), 0, 300000000),
...
//
pub const MUX_SEL_G2D0: c_uint = 0x0200;
pub const MUX_SEL_ENABLE_G2D0: c_uint = 0x0300;
pub const MUX_SEL_STAT_G2D0: c_uint = 0x0400;
pub const DIV_G2D: c_uint = 0x0600;
pub const DIV_STAT_G2D: c_uint = 0x0700;
pub const DIV_ENABLE_ACLK_G2D: c_uint = 0x0800;
pub const DIV_ENABLE_ACLK_G2D_SECURE_SMMU_G2D: c_uint = 0x0804;
pub const DIV_ENABLE_PCLK_G2D: c_uint = 0x0900;
pub const DIV_ENABLE_PCLK_G2D_SECURE_SMMU_G2D: c_uint = 0x0904;
pub const DIV_ENABLE_IP_G2D0: c_uint = 0x0b00;
pub const DIV_ENABLE_IP_G2D1: c_uint = 0x0b04;
pub const DIV_ENABLE_IP_G2D_SECURE_SMMU_G2D: c_uint = 0x0b08;
...
pub const DISP_PLL_FREQ_DET: c_uint = 0x0108;
...
pub const DIV_DISP_PLL_FREQ_DET: c_uint = 0x0604;
pub const DIV_STAT_DISP: c_uint = 0x0700;
pub const DIV_STAT_DISP_PLL_FREQ_DET: c_uint = 0x0704;
pub const ENABLE_ACLK_DISP0: c_uint = 0x0800;
pub const ENABLE_ACLK_DISP1: c_uint = 0x0804;
pub const ENABLE_PCLK_DISP: c_uint = 0x0900;
pub const ENABLE_SCLK_DISP: c_uint = 0x0a00;
pub const ENABLE_IP_DISP0: c_uint = 0x0b00;
pub const ENABLE_IP_DISP1: c_uint = 0x0b04;
pub const CLKOUT_CMU_DISP: c_uint = 0x0c00;
pub const CLKOUT_CMU_DISP_DIV_STAT: c_uint = 0x0c04;
...
//
pub const MUX_SEL_AUD0: c_uint = 0x0200;
pub const MUX_SEL_AUD1: c_uint = 0x0204;
pub const MUX_ENABLE_AUD0: c_uint = 0x0300;
pub const MUX_ENABLE_AUD1: c_uint = 0x0304;
pub const MUX_STAT_AUD0: c_uint = 0x0400;
...
pub const ENABLE_ACLK_AUD: c_uint = 0x0800;
pub const ENABLE_PCLK_AUD: c_uint = 0x0900;
pub const ENABLE_SCLK_AUD0: c_uint = 0x0a00;
pub const ENABLE_SCLK_AUD1: c_uint = 0x0a04;
pub const ENABLE_IP_AUD0: c_uint = 0x0b00;
pub const ENABLE_IP_AUD1: c_uint = 0x0b04;
...
// list of all parent clock list
    ...
    FRATE(0, "ioclk_jtag_tclk", core::ptr::null_mut(), 0, 33000000),
    FRATE(0, "ioclk_slimbus_clk", core::ptr::null_mut(), 0, 25000000),
    FRATE(0, "ioclk_i2s_bclk", core::ptr::null_mut(), 0, 50000000),
    };
...
//
pub const DIV_BUS: c_uint = 0x0600;
pub const DIV_STAT_BUS: c_uint = 0x0700;
pub const ENABLE_ACLK_BUS: c_uint = 0x0800;
pub const ENABLE_PCLK_BUS: c_uint = 0x0900;
pub const ENABLE_IP_BUS0: c_uint = 0x0b00;
pub const ENABLE_IP_BUS1: c_uint = 0x0b04;
pub const MUX_SEL_BUS2: c_uint = 0x0200	/* Only for CMU_BUS2 */;
pub const MUX_ENABLE_BUS2: c_uint = 0x0300	/* Only for CMU_BUS2 */;
pub const MUX_STAT_BUS2: c_uint = 0x0400	/* Only for CMU_BUS2 */;
// list of all parent clock list
...
pub const G3D_PLL_FREQ_DET: c_uint = 0x010c;
pub const MUX_SEL_G3D: c_uint = 0x0200;
pub const MUX_ENABLE_G3D: c_uint = 0x0300;
pub const MUX_STAT_G3D: c_uint = 0x0400;
pub const DIV_G3D: c_uint = 0x0600;
pub const DIV_G3D_PLL_FREQ_DET: c_uint = 0x0604;
pub const DIV_STAT_G3D: c_uint = 0x0700;
pub const DIV_STAT_G3D_PLL_FREQ_DET: c_uint = 0x0704;
pub const ENABLE_ACLK_G3D: c_uint = 0x0800;
pub const ENABLE_PCLK_G3D: c_uint = 0x0900;
pub const ENABLE_SCLK_G3D: c_uint = 0x0a00;
pub const ENABLE_IP_G3D0: c_uint = 0x0b00;
pub const ENABLE_IP_G3D1: c_uint = 0x0b04;
pub const CLKOUT_CMU_G3D: c_uint = 0x0c00;
pub const CLKOUT_CMU_G3D_DIV_STAT: c_uint = 0x0c04;
pub const CLK_STOPCTRL: c_uint = 0x1000;
...
pub const MUX_ENABLE_GSCL: c_uint = 0x0300;
pub const MUX_STAT_GSCL: c_uint = 0x0400;
pub const ENABLE_ACLK_GSCL: c_uint = 0x0800;
pub const ENABLE_ACLK_GSCL_SECURE_SMMU_GSCL0: c_uint = 0x0804;
pub const ENABLE_ACLK_GSCL_SECURE_SMMU_GSCL1: c_uint = 0x0808;
pub const ENABLE_ACLK_GSCL_SECURE_SMMU_GSCL2: c_uint = 0x080c;
pub const ENABLE_PCLK_GSCL: c_uint = 0x0900;
pub const ENABLE_PCLK_GSCL_SECURE_SMMU_GSCL0: c_uint = 0x0904;
pub const ENABLE_PCLK_GSCL_SECURE_SMMU_GSCL1: c_uint = 0x0908;
pub const ENABLE_PCLK_GSCL_SECURE_SMMU_GSCL2: c_uint = 0x090c;
pub const ENABLE_IP_GSCL0: c_uint = 0x0b00;
pub const ENABLE_IP_GSCL1: c_uint = 0x0b04;
pub const ENABLE_IP_GSCL_SECURE_SMMU_GSCL0: c_uint = 0x0b08;
pub const ENABLE_IP_GSCL_SECURE_SMMU_GSCL1: c_uint = 0x0b0c;
pub const ENABLE_IP_GSCL_SECURE_SMMU_GSCL2: c_uint = 0x0b10;
...
//
pub const APOLLO_PLL_LOCK: c_uint = 0x0000;
pub const APOLLO_PLL_CON0: c_uint = 0x0100;
pub const APOLLO_PLL_CON1: c_uint = 0x0104;
pub const APOLLO_PLL_FREQ_DET: c_uint = 0x010c;
pub const MUX_SEL_APOLLO0: c_uint = 0x0200;
pub const MUX_SEL_APOLLO1: c_uint = 0x0204;
pub const MUX_SEL_APOLLO2: c_uint = 0x0208;
pub const MUX_ENABLE_APOLLO0: c_uint = 0x0300;
pub const MUX_ENABLE_APOLLO1: c_uint = 0x0304;
pub const MUX_ENABLE_APOLLO2: c_uint = 0x0308;
pub const MUX_STAT_APOLLO0: c_uint = 0x0400;
pub const MUX_STAT_APOLLO1: c_uint = 0x0404;
pub const MUX_STAT_APOLLO2: c_uint = 0x0408;
pub const DIV_APOLLO0: c_uint = 0x0600;
pub const DIV_APOLLO1: c_uint = 0x0604;
pub const DIV_APOLLO_PLL_FREQ_DET: c_uint = 0x0608;
pub const DIV_STAT_APOLLO0: c_uint = 0x0700;
pub const DIV_STAT_APOLLO1: c_uint = 0x0704;
pub const DIV_STAT_APOLLO_PLL_FREQ_DET: c_uint = 0x0708;
pub const ENABLE_ACLK_APOLLO: c_uint = 0x0800;
pub const ENABLE_PCLK_APOLLO: c_uint = 0x0900;
pub const ENABLE_SCLK_APOLLO: c_uint = 0x0a00;
pub const ENABLE_IP_APOLLO0: c_uint = 0x0b00;
pub const ENABLE_IP_APOLLO1: c_uint = 0x0b04;
pub const CLKOUT_CMU_APOLLO: c_uint = 0x0c00;
pub const CLKOUT_CMU_APOLLO_DIV_STAT: c_uint = 0x0c04;
pub const ARMCLK_STOPCTRL: c_uint = 0x1000;
pub const APOLLO_PWR_CTRL: c_uint = 0x1020;
pub const APOLLO_PWR_CTRL2: c_uint = 0x1024;
pub const APOLLO_INTR_SPREAD_ENABLE: c_uint = 0x1080;
pub const APOLLO_INTR_SPREAD_USE_STANDBYWFI: c_uint = 0x1084;
pub const APOLLO_INTR_SPREAD_BLOCKING_DURATION: c_uint = 0x1088;
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_apollo_init(np: *mut device_node) -> void __init {
...
//
pub const ATLAS_PLL_LOCK: c_uint = 0x0000;
pub const ATLAS_PLL_CON0: c_uint = 0x0100;
pub const ATLAS_PLL_CON1: c_uint = 0x0104;
pub const ATLAS_PLL_FREQ_DET: c_uint = 0x010c;
pub const MUX_SEL_ATLAS0: c_uint = 0x0200;
pub const MUX_SEL_ATLAS1: c_uint = 0x0204;
pub const MUX_SEL_ATLAS2: c_uint = 0x0208;
pub const MUX_ENABLE_ATLAS0: c_uint = 0x0300;
pub const MUX_ENABLE_ATLAS1: c_uint = 0x0304;
pub const MUX_ENABLE_ATLAS2: c_uint = 0x0308;
pub const MUX_STAT_ATLAS0: c_uint = 0x0400;
pub const MUX_STAT_ATLAS1: c_uint = 0x0404;
pub const MUX_STAT_ATLAS2: c_uint = 0x0408;
pub const DIV_ATLAS0: c_uint = 0x0600;
pub const DIV_ATLAS1: c_uint = 0x0604;
pub const DIV_ATLAS_PLL_FREQ_DET: c_uint = 0x0608;
pub const DIV_STAT_ATLAS0: c_uint = 0x0700;
pub const DIV_STAT_ATLAS1: c_uint = 0x0704;
pub const DIV_STAT_ATLAS_PLL_FREQ_DET: c_uint = 0x0708;
pub const ENABLE_ACLK_ATLAS: c_uint = 0x0800;
pub const ENABLE_PCLK_ATLAS: c_uint = 0x0900;
pub const ENABLE_SCLK_ATLAS: c_uint = 0x0a00;
pub const ENABLE_IP_ATLAS0: c_uint = 0x0b00;
pub const ENABLE_IP_ATLAS1: c_uint = 0x0b04;
pub const CLKOUT_CMU_ATLAS: c_uint = 0x0c00;
pub const CLKOUT_CMU_ATLAS_DIV_STAT: c_uint = 0x0c04;
pub const ARMCLK_STOPCTRL: c_uint = 0x1000;
pub const ATLAS_PWR_CTRL: c_uint = 0x1020;
pub const ATLAS_PWR_CTRL2: c_uint = 0x1024;
pub const ATLAS_INTR_SPREAD_ENABLE: c_uint = 0x1080;
pub const ATLAS_INTR_SPREAD_USE_STANDBYWFI: c_uint = 0x1084;
pub const ATLAS_INTR_SPREAD_BLOCKING_DURATION: c_uint = 0x1088;
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_atlas_init(np: *mut device_node) -> void __init {
...
//
pub const MUX_SEL_MSCL0: c_uint = 0x0200;
pub const MUX_SEL_MSCL1: c_uint = 0x0204;
pub const MUX_ENABLE_MSCL0: c_uint = 0x0300;
pub const MUX_ENABLE_MSCL1: c_uint = 0x0304;
pub const MUX_STAT_MSCL0: c_uint = 0x0400;
pub const MUX_STAT_MSCL1: c_uint = 0x0404;
pub const DIV_MSCL: c_uint = 0x0600;
pub const DIV_STAT_MSCL: c_uint = 0x0700;
pub const ENABLE_ACLK_MSCL: c_uint = 0x0800;
pub const ENABLE_ACLK_MSCL_SECURE_SMMU_M2MSCALER0: c_uint = 0x0804;
pub const ENABLE_ACLK_MSCL_SECURE_SMMU_M2MSCALER1: c_uint = 0x0808;
pub const ENABLE_ACLK_MSCL_SECURE_SMMU_JPEG: c_uint = 0x080c;
pub const ENABLE_PCLK_MSCL: c_uint = 0x0900;
pub const ENABLE_PCLK_MSCL_SECURE_SMMU_M2MSCALER0: c_uint = 0x0904;
pub const ENABLE_PCLK_MSCL_SECURE_SMMU_M2MSCALER1: c_uint = 0x0908;
pub const ENABLE_PCLK_MSCL_SECURE_SMMU_JPEG: c_uint = 0x090c;
pub const ENABLE_SCLK_MSCL: c_uint = 0x0a00;
pub const ENABLE_IP_MSCL0: c_uint = 0x0b00;
pub const ENABLE_IP_MSCL1: c_uint = 0x0b04;
pub const ENABLE_IP_MSCL_SECURE_SMMU_M2MSCALER0: c_uint = 0x0b08;
pub const ENABLE_IP_MSCL_SECURE_SMMU_M2MSCALER1: c_uint = 0x0b0c;
pub const ENABLE_IP_MSCL_SECURE_SMMU_JPEG: c_uint = 0x0b10;
...
pub const ENABLE_ACLK_MFC: c_uint = 0x0800;
pub const ENABLE_ACLK_MFC_SECURE_SMMU_MFC: c_uint = 0x0804;
pub const ENABLE_PCLK_MFC: c_uint = 0x0900;
pub const ENABLE_PCLK_MFC_SECURE_SMMU_MFC: c_uint = 0x0904;
pub const ENABLE_IP_MFC0: c_uint = 0x0b00;
pub const ENABLE_IP_MFC1: c_uint = 0x0b04;
pub const ENABLE_IP_MFC_SECURE_SMMU_MFC: c_uint = 0x0b08;
...
//
pub const MUX_SEL_HEVC: c_uint = 0x0200;
pub const MUX_ENABLE_HEVC: c_uint = 0x0300;
pub const MUX_STAT_HEVC: c_uint = 0x0400;
pub const DIV_HEVC: c_uint = 0x0600;
pub const DIV_STAT_HEVC: c_uint = 0x0700;
pub const ENABLE_ACLK_HEVC: c_uint = 0x0800;
pub const ENABLE_ACLK_HEVC_SECURE_SMMU_HEVC: c_uint = 0x0804;
pub const ENABLE_PCLK_HEVC: c_uint = 0x0900;
pub const ENABLE_PCLK_HEVC_SECURE_SMMU_HEVC: c_uint = 0x0904;
pub const ENABLE_IP_HEVC0: c_uint = 0x0b00;
pub const ENABLE_IP_HEVC1: c_uint = 0x0b04;
pub const ENABLE_IP_HEVC_SECURE_SMMU_HEVC: c_uint = 0x0b08;
...
//
pub const MUX_SEL_ISP: c_uint = 0x0200;
pub const MUX_ENABLE_ISP: c_uint = 0x0300;
pub const MUX_STAT_ISP: c_uint = 0x0400;
pub const DIV_ISP: c_uint = 0x0600;
pub const DIV_STAT_ISP: c_uint = 0x0700;
pub const ENABLE_ACLK_ISP0: c_uint = 0x0800;
pub const ENABLE_ACLK_ISP1: c_uint = 0x0804;
pub const ENABLE_ACLK_ISP2: c_uint = 0x0808;
pub const ENABLE_PCLK_ISP: c_uint = 0x0900;
pub const ENABLE_SCLK_ISP: c_uint = 0x0a00;
pub const ENABLE_IP_ISP0: c_uint = 0x0b00;
pub const ENABLE_IP_ISP1: c_uint = 0x0b04;
pub const ENABLE_IP_ISP2: c_uint = 0x0b08;
pub const ENABLE_IP_ISP3: c_uint = 0x0b0c;
...
//
pub const MUX_SEL_CAM00: c_uint = 0x0200;
pub const MUX_SEL_CAM01: c_uint = 0x0204;
pub const MUX_SEL_CAM02: c_uint = 0x0208;
pub const MUX_SEL_CAM03: c_uint = 0x020c;
pub const MUX_SEL_CAM04: c_uint = 0x0210;
pub const MUX_ENABLE_CAM00: c_uint = 0x0300;
pub const MUX_ENABLE_CAM01: c_uint = 0x0304;
pub const MUX_ENABLE_CAM02: c_uint = 0x0308;
pub const MUX_ENABLE_CAM03: c_uint = 0x030c;
pub const MUX_ENABLE_CAM04: c_uint = 0x0310;
pub const MUX_STAT_CAM00: c_uint = 0x0400;
pub const MUX_STAT_CAM01: c_uint = 0x0404;
pub const MUX_STAT_CAM02: c_uint = 0x0408;
pub const MUX_STAT_CAM03: c_uint = 0x040c;
pub const MUX_STAT_CAM04: c_uint = 0x0410;
pub const MUX_IGNORE_CAM01: c_uint = 0x0504;
pub const DIV_CAM00: c_uint = 0x0600;
pub const DIV_CAM01: c_uint = 0x0604;
pub const DIV_CAM02: c_uint = 0x0608;
pub const DIV_CAM03: c_uint = 0x060c;
pub const DIV_STAT_CAM00: c_uint = 0x0700;
pub const DIV_STAT_CAM01: c_uint = 0x0704;
pub const DIV_STAT_CAM02: c_uint = 0x0708;
pub const DIV_STAT_CAM03: c_uint = 0x070c;
...
//
pub const MUX_SEL_CAM10: c_uint = 0x0200;
pub const MUX_SEL_CAM11: c_uint = 0x0204;
pub const MUX_SEL_CAM12: c_uint = 0x0208;
pub const MUX_ENABLE_CAM10: c_uint = 0x0300;
pub const MUX_ENABLE_CAM11: c_uint = 0x0304;
pub const MUX_ENABLE_CAM12: c_uint = 0x0308;
pub const MUX_STAT_CAM10: c_uint = 0x0400;
pub const MUX_STAT_CAM11: c_uint = 0x0404;
pub const MUX_STAT_CAM12: c_uint = 0x0408;
pub const MUX_IGNORE_CAM11: c_uint = 0x0504;
pub const DIV_CAM10: c_uint = 0x0600;
pub const DIV_CAM11: c_uint = 0x0604;
pub const DIV_STAT_CAM10: c_uint = 0x0700;
pub const DIV_STAT_CAM11: c_uint = 0x0704;
    ...
    FRATE(CLK_PHYCLK_RXBYTEECLKHS0_S2B, "phyclk_rxbyteclkhs0_s2b_phy", core::ptr::null_mut(),
    0, 100000000),
    };
...
//
pub const ENABLE_ACLK_IMEM_SLIMSSS: c_uint = 0x080c;
pub const ENABLE_PCLK_IMEM_SLIMSSS: c_uint = 0x0908;
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynos5433_cmu_init() -> int __init {
