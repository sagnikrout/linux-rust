...
//! Source: drivers/clk/samsung/clk-s5pv210.c
#![no_std]
...
pub const APLL_LOCK: c_uint = 0x0000;
pub const MPLL_LOCK: c_uint = 0x0008;
pub const EPLL_LOCK: c_uint = 0x0010;
pub const VPLL_LOCK: c_uint = 0x0020;
pub const APLL_CON0: c_uint = 0x0100;
pub const APLL_CON1: c_uint = 0x0104;
pub const MPLL_CON: c_uint = 0x0108;
pub const EPLL_CON0: c_uint = 0x0110;
pub const EPLL_CON1: c_uint = 0x0114;
pub const VPLL_CON: c_uint = 0x0120;
pub const CLK_SRC0: c_uint = 0x0200;
pub const CLK_SRC1: c_uint = 0x0204;
pub const CLK_SRC2: c_uint = 0x0208;
pub const CLK_SRC3: c_uint = 0x020c;
pub const CLK_SRC4: c_uint = 0x0210;
pub const CLK_SRC5: c_uint = 0x0214;
pub const CLK_SRC6: c_uint = 0x0218;
pub const CLK_SRC_MASK0: c_uint = 0x0280;
pub const CLK_SRC_MASK1: c_uint = 0x0284;
pub const CLK_DIV0: c_uint = 0x0300;
pub const CLK_DIV1: c_uint = 0x0304;
pub const CLK_DIV2: c_uint = 0x0308;
pub const CLK_DIV3: c_uint = 0x030c;
pub const CLK_DIV4: c_uint = 0x0310;
pub const CLK_DIV5: c_uint = 0x0314;
pub const CLK_DIV6: c_uint = 0x0318;
pub const CLK_DIV7: c_uint = 0x031c;
pub const CLK_GATE_MAIN0: c_uint = 0x0400;
pub const CLK_GATE_MAIN1: c_uint = 0x0404;
pub const CLK_GATE_MAIN2: c_uint = 0x0408;
pub const CLK_GATE_PERI0: c_uint = 0x0420;
pub const CLK_GATE_PERI1: c_uint = 0x0424;
pub const CLK_GATE_SCLK0: c_uint = 0x0440;
pub const CLK_GATE_SCLK1: c_uint = 0x0444;
pub const CLK_GATE_IP0: c_uint = 0x0460;
pub const CLK_GATE_IP1: c_uint = 0x0464;
pub const CLK_GATE_IP2: c_uint = 0x0468;
pub const CLK_GATE_IP3: c_uint = 0x046c;
pub const CLK_GATE_IP4: c_uint = 0x0470;
pub const CLK_GATE_BLOCK: c_uint = 0x0480;
pub const CLK_GATE_IP5: c_uint = 0x0484;
pub const CLK_OUT: c_uint = 0x0500;
pub const MISC: c_uint = 0xe000;
pub const OM_STAT: c_uint = 0xe100;
...
#[no_mangle]
unsafe extern "C" fn s5pv210_clk_dt_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn s5p6442_clk_dt_init(np: *mut device_node) -> void __init {
