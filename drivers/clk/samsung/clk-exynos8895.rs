...
//! Source: drivers/clk/samsung/clk-exynos8895.c
#![no_std]
...
pub const PLL_LOCKTIME_PLL_SHARED4: c_uint = 0x0010;
pub const PLL_CON0_MUX_CP2AP_MIF_CLK_USER: c_uint = 0x0100;
pub const PLL_CON2_MUX_CP2AP_MIF_CLK_USER: c_uint = 0x0108;
pub const PLL_CON0_PLL_SHARED0: c_uint = 0x0120;
pub const PLL_CON0_PLL_SHARED1: c_uint = 0x0140;
pub const PLL_CON0_PLL_SHARED2: c_uint = 0x0160;
pub const PLL_CON0_PLL_SHARED3: c_uint = 0x0180;
pub const PLL_CON0_PLL_SHARED4: c_uint = 0x01a0;
pub const CLK_CON_MUX_MUX_CLKCMU_ABOX_CPUABOX: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLKCMU_APM_BUS: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLKCMU_BUS1_BUS: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLKCMU_BUSC_BUS: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLKCMU_BUSC_BUSPHSI2C: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLKCMU_CAM_BUS: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLKCMU_CAM_TPU0: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLKCMU_CAM_TPU1: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLKCMU_CAM_VRA: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK0: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK1: c_uint = 0x1028;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK2: c_uint = 0x102c;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK3: c_uint = 0x1030;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_BUS: c_uint = 0x1034;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1038;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH: c_uint = 0x103c;
pub const CLK_CON_MUX_MUX_CLKCMU_DBG_BUS: c_uint = 0x1040;
pub const CLK_CON_MUX_MUX_CLKCMU_DCAM_BUS: c_uint = 0x1044;
pub const CLK_CON_MUX_MUX_CLKCMU_DCAM_IMGD: c_uint = 0x1048;
pub const CLK_CON_MUX_MUX_CLKCMU_DPU_BUS: c_uint = 0x104c;
pub const CLK_CON_MUX_MUX_CLKCMU_DROOPDETECTOR: c_uint = 0x1050;
pub const CLK_CON_MUX_MUX_CLKCMU_DSP_BUS: c_uint = 0x1054;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS0_BUS: c_uint = 0x1058;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS0_DPGTC: c_uint = 0x105c;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS0_MMC_EMBD: c_uint = 0x1060;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS0_UFS_EMBD: c_uint = 0x1064;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS0_USBDRD30: c_uint = 0x1068;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS1_BUS: c_uint = 0x106c;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS1_MMC_CARD: c_uint = 0x1070;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS1_PCIE: c_uint = 0x1074;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS1_UFS_CARD: c_uint = 0x1078;
pub const CLK_CON_MUX_MUX_CLKCMU_G2D_G2D: c_uint = 0x107c;
pub const CLK_CON_MUX_MUX_CLKCMU_G2D_JPEG: c_uint = 0x1080;
pub const CLK_CON_MUX_MUX_CLKCMU_HPM: c_uint = 0x1084;
pub const CLK_CON_MUX_MUX_CLKCMU_IMEM_BUS: c_uint = 0x1088;
pub const CLK_CON_MUX_MUX_CLKCMU_ISPHQ_BUS: c_uint = 0x108c;
pub const CLK_CON_MUX_MUX_CLKCMU_ISPLP_BUS: c_uint = 0x1090;
pub const CLK_CON_MUX_MUX_CLKCMU_IVA_BUS: c_uint = 0x1094;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC_BUS: c_uint = 0x1098;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x109c;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_BUS: c_uint = 0x10a0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_UART_DBG: c_uint = 0x10a4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_USI00: c_uint = 0x10a8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_USI01: c_uint = 0x10ac;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_USI02: c_uint = 0x10b0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_USI03: c_uint = 0x10b4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_BUS: c_uint = 0x10b8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_SPEEDY2: c_uint = 0x10bc;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_SPI_CAM0: c_uint = 0x10c0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_SPI_CAM1: c_uint = 0x10c4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_UART_BT: c_uint = 0x10c8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI04: c_uint = 0x10cc;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI05: c_uint = 0x10d0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI06: c_uint = 0x10d4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI07: c_uint = 0x10d8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI08: c_uint = 0x10dc;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI09: c_uint = 0x10e0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI10: c_uint = 0x10e4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI11: c_uint = 0x10e8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI12: c_uint = 0x10ec;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_USI13: c_uint = 0x10f0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIS_BUS: c_uint = 0x10f4;
pub const CLK_CON_MUX_MUX_CLKCMU_SRDZ_BUS: c_uint = 0x10f8;
pub const CLK_CON_MUX_MUX_CLKCMU_SRDZ_IMGD: c_uint = 0x10fc;
pub const CLK_CON_MUX_MUX_CLKCMU_VPU_BUS: c_uint = 0x1100;
pub const CLK_CON_MUX_MUX_CLK_CMU_CMUREF: c_uint = 0x1104;
pub const CLK_CON_MUX_MUX_CMU_CMUREF: c_uint = 0x1108;
pub const CLK_CON_DIV_CLKCMU_ABOX_CPUABOX: c_uint = 0x1800;
pub const CLK_CON_DIV_CLKCMU_APM_BUS: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKCMU_BUS1_BUS: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKCMU_BUSC_BUS: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_BUSC_BUSPHSI2C: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_CAM_BUS: c_uint = 0x1814;
pub const CLK_CON_DIV_CLKCMU_CAM_TPU0: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKCMU_CAM_TPU1: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_CAM_VRA: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK0: c_uint = 0x1824;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK1: c_uint = 0x1828;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK2: c_uint = 0x182c;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK3: c_uint = 0x1830;
pub const CLK_CON_DIV_CLKCMU_CORE_BUS: c_uint = 0x1834;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKCMU_CPUCL1_SWITCH: c_uint = 0x183c;
pub const CLK_CON_DIV_CLKCMU_DBG_BUS: c_uint = 0x1840;
pub const CLK_CON_DIV_CLKCMU_DCAM_BUS: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_DCAM_IMGD: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_DPU_BUS: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_DSP_BUS: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_FSYS0_BUS: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_FSYS0_DPGTC: c_uint = 0x1858;
pub const CLK_CON_DIV_CLKCMU_FSYS0_MMC_EMBD: c_uint = 0x185c;
pub const CLK_CON_DIV_CLKCMU_FSYS0_UFS_EMBD: c_uint = 0x1860;
pub const CLK_CON_DIV_CLKCMU_FSYS0_USBDRD30: c_uint = 0x1864;
pub const CLK_CON_DIV_CLKCMU_FSYS1_BUS: c_uint = 0x1868;
pub const CLK_CON_DIV_CLKCMU_FSYS1_MMC_CARD: c_uint = 0x186c;
pub const CLK_CON_DIV_CLKCMU_FSYS1_PCIE: c_uint = 0x1870;
pub const CLK_CON_DIV_CLKCMU_FSYS1_UFS_CARD: c_uint = 0x1874;
pub const CLK_CON_DIV_CLKCMU_G2D_G2D: c_uint = 0x1878;
pub const CLK_CON_DIV_CLKCMU_G2D_JPEG: c_uint = 0x187c;
pub const CLK_CON_DIV_CLKCMU_G3D_SWITCH: c_uint = 0x1880;
pub const CLK_CON_DIV_CLKCMU_HPM: c_uint = 0x1884;
pub const CLK_CON_DIV_CLKCMU_IMEM_BUS: c_uint = 0x1888;
pub const CLK_CON_DIV_CLKCMU_ISPHQ_BUS: c_uint = 0x188c;
pub const CLK_CON_DIV_CLKCMU_ISPLP_BUS: c_uint = 0x1890;
pub const CLK_CON_DIV_CLKCMU_IVA_BUS: c_uint = 0x1894;
pub const CLK_CON_DIV_CLKCMU_MFC_BUS: c_uint = 0x1898;
pub const CLK_CON_DIV_CLKCMU_MODEM_SHARED0: c_uint = 0x189c;
pub const CLK_CON_DIV_CLKCMU_MODEM_SHARED1: c_uint = 0x18a0;
pub const CLK_CON_DIV_CLKCMU_OTP: c_uint = 0x18a4;
pub const CLK_CON_DIV_CLKCMU_PERIC0_BUS: c_uint = 0x18a8;
pub const CLK_CON_DIV_CLKCMU_PERIC0_UART_DBG: c_uint = 0x18ac;
pub const CLK_CON_DIV_CLKCMU_PERIC0_USI00: c_uint = 0x18b0;
pub const CLK_CON_DIV_CLKCMU_PERIC0_USI01: c_uint = 0x18b4;
pub const CLK_CON_DIV_CLKCMU_PERIC0_USI02: c_uint = 0x18b8;
pub const CLK_CON_DIV_CLKCMU_PERIC0_USI03: c_uint = 0x18bc;
pub const CLK_CON_DIV_CLKCMU_PERIC1_BUS: c_uint = 0x18c0;
pub const CLK_CON_DIV_CLKCMU_PERIC1_SPEEDY2: c_uint = 0x18c4;
pub const CLK_CON_DIV_CLKCMU_PERIC1_SPI_CAM0: c_uint = 0x18c8;
pub const CLK_CON_DIV_CLKCMU_PERIC1_SPI_CAM1: c_uint = 0x18cc;
pub const CLK_CON_DIV_CLKCMU_PERIC1_UART_BT: c_uint = 0x18d0;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI04: c_uint = 0x18d4;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI05: c_uint = 0x18d8;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI06: c_uint = 0x18dc;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI07: c_uint = 0x18e0;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI08: c_uint = 0x18e4;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI09: c_uint = 0x18e8;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI10: c_uint = 0x18ec;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI11: c_uint = 0x18f0;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI12: c_uint = 0x18f4;
pub const CLK_CON_DIV_CLKCMU_PERIC1_USI13: c_uint = 0x18f8;
pub const CLK_CON_DIV_CLKCMU_PERIS_BUS: c_uint = 0x18fc;
pub const CLK_CON_DIV_CLKCMU_SRDZ_BUS: c_uint = 0x1900;
pub const CLK_CON_DIV_CLKCMU_SRDZ_IMGD: c_uint = 0x1904;
pub const CLK_CON_DIV_CLKCMU_VPU_BUS: c_uint = 0x1908;
pub const CLK_CON_DIV_DIV_CLK_CMU_CMUREF: c_uint = 0x190c;
pub const CLK_CON_DIV_DIV_CP2AP_MIF_CLK_DIV2: c_uint = 0x1910;
pub const CLK_CON_DIV_DIV_PLL_SHARED0_DIV2: c_uint = 0x1914;
pub const CLK_CON_DIV_DIV_PLL_SHARED0_DIV4: c_uint = 0x1918;
pub const CLK_CON_DIV_DIV_PLL_SHARED1_DIV2: c_uint = 0x191c;
pub const CLK_CON_DIV_DIV_PLL_SHARED1_DIV4: c_uint = 0x1920;
pub const CLK_CON_DIV_DIV_PLL_SHARED2_DIV2: c_uint = 0x1924;
pub const CLK_CON_DIV_DIV_PLL_SHARED3_DIV2: c_uint = 0x1928;
pub const CLK_CON_DIV_DIV_PLL_SHARED4_DIV2: c_uint = 0x192c;
pub const CLK_CON_GAT_CLKCMU_DROOPDETECTOR: c_uint = 0x2000;
pub const CLK_CON_GAT_CLKCMU_MIF_SWITCH: c_uint = 0x2004;
pub const CLK_CON_GAT_GATE_CLKCMU_ABOX_CPUABOX: c_uint = 0x2008;
pub const CLK_CON_GAT_GATE_CLKCMU_APM_BUS: c_uint = 0x200c;
pub const CLK_CON_GAT_GATE_CLKCMU_BUS1_BUS: c_uint = 0x2010;
pub const CLK_CON_GAT_GATE_CLKCMU_BUSC_BUS: c_uint = 0x2014;
pub const CLK_CON_GAT_GATE_CLKCMU_BUSC_BUSPHSI2C: c_uint = 0x2018;
pub const CLK_CON_GAT_GATE_CLKCMU_CAM_BUS: c_uint = 0x201c;
pub const CLK_CON_GAT_GATE_CLKCMU_CAM_TPU0: c_uint = 0x2020;
pub const CLK_CON_GAT_GATE_CLKCMU_CAM_TPU1: c_uint = 0x2024;
pub const CLK_CON_GAT_GATE_CLKCMU_CAM_VRA: c_uint = 0x2028;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK0: c_uint = 0x202c;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK1: c_uint = 0x2030;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK2: c_uint = 0x2034;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK3: c_uint = 0x2038;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_BUS: c_uint = 0x203c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_SWITCH: c_uint = 0x2040;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH: c_uint = 0x2044;
pub const CLK_CON_GAT_GATE_CLKCMU_DBG_BUS: c_uint = 0x2048;
pub const CLK_CON_GAT_GATE_CLKCMU_DCAM_BUS: c_uint = 0x204c;
pub const CLK_CON_GAT_GATE_CLKCMU_DCAM_IMGD: c_uint = 0x2050;
pub const CLK_CON_GAT_GATE_CLKCMU_DPU_BUS: c_uint = 0x2054;
pub const CLK_CON_GAT_GATE_CLKCMU_DSP_BUS: c_uint = 0x2058;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS0_BUS: c_uint = 0x205c;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS0_DPGTC: c_uint = 0x2060;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS0_MMC_EMBD: c_uint = 0x2064;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS0_UFS_EMBD: c_uint = 0x2068;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS0_USBDRD30: c_uint = 0x206c;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS1_BUS: c_uint = 0x2070;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS1_MMC_CARD: c_uint = 0x2074;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS1_PCIE: c_uint = 0x2078;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS1_UFS_CARD: c_uint = 0x207c;
pub const CLK_CON_GAT_GATE_CLKCMU_G2D_G2D: c_uint = 0x2080;
pub const CLK_CON_GAT_GATE_CLKCMU_G2D_JPEG: c_uint = 0x2084;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_SWITCH: c_uint = 0x2088;
pub const CLK_CON_GAT_GATE_CLKCMU_HPM: c_uint = 0x208c;
pub const CLK_CON_GAT_GATE_CLKCMU_IMEM_BUS: c_uint = 0x2090;
pub const CLK_CON_GAT_GATE_CLKCMU_ISPHQ_BUS: c_uint = 0x2094;
pub const CLK_CON_GAT_GATE_CLKCMU_ISPLP_BUS: c_uint = 0x2098;
pub const CLK_CON_GAT_GATE_CLKCMU_IVA_BUS: c_uint = 0x209c;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC_BUS: c_uint = 0x20a0;
pub const CLK_CON_GAT_GATE_CLKCMU_MODEM_SHARED0: c_uint = 0x20a4;
pub const CLK_CON_GAT_GATE_CLKCMU_MODEM_SHARED1: c_uint = 0x20a8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_BUS: c_uint = 0x20ac;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_UART_DBG: c_uint = 0x20b0;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_USI00: c_uint = 0x20b4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_USI01: c_uint = 0x20b8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_USI02: c_uint = 0x20bc;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_USI03: c_uint = 0x20c0;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_BUS: c_uint = 0x20c4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_SPEEDY2: c_uint = 0x20c8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_SPI_CAM0: c_uint = 0x20cc;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_SPI_CAM1: c_uint = 0x20d0;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_UART_BT: c_uint = 0x20d4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI04: c_uint = 0x20d8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI05: c_uint = 0x20dc;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI06: c_uint = 0x20e0;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI07: c_uint = 0x20e4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI08: c_uint = 0x20e8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI09: c_uint = 0x20ec;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI10: c_uint = 0x20f0;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI11: c_uint = 0x20f4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI12: c_uint = 0x20f8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_USI13: c_uint = 0x20fc;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIS_BUS: c_uint = 0x2100;
pub const CLK_CON_GAT_GATE_CLKCMU_SRDZ_BUS: c_uint = 0x2104;
pub const CLK_CON_GAT_GATE_CLKCMU_SRDZ_IMGD: c_uint = 0x2108;
pub const CLK_CON_GAT_GATE_CLKCMU_VPU_BUS: c_uint = 0x210c;
...
#[no_mangle]
unsafe extern "C" fn exynos8895_cmu_top_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_PERIS_BUS_USER: c_uint = 0x0100;
pub const PLL_CON2_MUX_CLKCMU_PERIS_BUS_USER: c_uint = 0x0108;
pub const CLK_CON_MUX_MUX_CLK_PERIS_GIC: c_uint = 0x1000;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_PERIS_CMU_PERIS_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_AD_AXI_P_PERIS_IPCLKPORT_ACLKM: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_AD_AXI_P_PERIS_IPCLKPORT_ACLKS: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_AXI2APB_PERISP0_IPCLKPORT_ACLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_AXI2APB_PERISP1_IPCLKPORT_ACLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_BUSIF_TMU_IPCLKPORT_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_GIC_IPCLKPORT_CLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_LHM_AXI_P_PERIS_IPCLKPORT_I_CLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_MCT_IPCLKPORT_PCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_OTP_CON_BIRA_IPCLKPORT_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_OTP_CON_TOP_IPCLKPORT_PCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_PMU_PERIS_IPCLKPORT_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_BUSP_IPCLKPORT_CLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_GIC_IPCLKPORT_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_SYSREG_PERIS_IPCLKPORT_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC00_IPCLKPORT_PCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC01_IPCLKPORT_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC02_IPCLKPORT_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC03_IPCLKPORT_PCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC04_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC05_IPCLKPORT_PCLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC06_IPCLKPORT_PCLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC07_IPCLKPORT_PCLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC08_IPCLKPORT_PCLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC09_IPCLKPORT_PCLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC10_IPCLKPORT_PCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC11_IPCLKPORT_PCLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC12_IPCLKPORT_PCLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC13_IPCLKPORT_PCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC14_IPCLKPORT_PCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TZPC15_IPCLKPORT_PCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_WDT_CLUSTER0_IPCLKPORT_PCLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_WDT_CLUSTER1_IPCLKPORT_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_XIU_P_PERIS_IPCLKPORT_ACLK: c_uint = 0x2090;
...
#[no_mangle]
unsafe extern "C" fn exynos8895_cmu_peris_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_FSYS0_BUS_USER: c_uint = 0x0100;
pub const PLL_CON2_MUX_CLKCMU_FSYS0_BUS_USER: c_uint = 0x0108;
pub const PLL_CON0_MUX_CLKCMU_FSYS0_DPGTC_USER: c_uint = 0x0120;
pub const PLL_CON2_MUX_CLKCMU_FSYS0_DPGTC_USER: c_uint = 0x0128;
pub const PLL_CON0_MUX_CLKCMU_FSYS0_MMC_EMBD_USER: c_uint = 0x0140;
pub const PLL_CON2_MUX_CLKCMU_FSYS0_MMC_EMBD_USER: c_uint = 0x0148;
pub const PLL_CON0_MUX_CLKCMU_FSYS0_UFS_EMBD_USER: c_uint = 0x0160;
pub const PLL_CON2_MUX_CLKCMU_FSYS0_UFS_EMBD_USER: c_uint = 0x0168;
pub const PLL_CON0_MUX_CLKCMU_FSYS0_USBDRD30_USER: c_uint = 0x0180;
pub const PLL_CON2_MUX_CLKCMU_FSYS0_USBDRD30_USER: c_uint = 0x0188;
pub const CLK_CON_GAT_CLK_BLK_FSYS0_UID_FSYS0_CMU_FSYS0_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_AHBBR_FSYS0_IPCLKPORT_HCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_AXI2AHB_FSYS0_IPCLKPORT_ACLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_AXI2AHB_USB_FSYS0_IPCLKPORT_ACLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_AXI2APB_FSYS0_IPCLKPORT_ACLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_BTM_FSYS0_IPCLKPORT_I_ACLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_BTM_FSYS0_IPCLKPORT_I_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_DP_LINK_IPCLKPORT_I_GTC_EXT_CLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_DP_LINK_IPCLKPORT_I_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_ETR_MIU_IPCLKPORT_I_ACLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_ETR_MIU_IPCLKPORT_I_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_GPIO_FSYS0_IPCLKPORT_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_LHM_AXI_D_USBTV_IPCLKPORT_I_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_LHM_AXI_G_ETR_IPCLKPORT_I_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_LHM_AXI_P_FSYS0_IPCLKPORT_I_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_LHS_ACEL_D_FSYS0_IPCLKPORT_I_CLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_MMC_EMBD_IPCLKPORT_I_ACLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_MMC_EMBD_IPCLKPORT_SDCLKIN: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PMU_FSYS0_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_BCM_FSYS0_IPCLKPORT_ACLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_BCM_FSYS0_IPCLKPORT_PCLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_RSTNSYNC_CLK_FSYS0_BUS_IPCLKPORT_CLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_SYSREG_FSYS0_IPCLKPORT_PCLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_UFS_EMBD_IPCLKPORT_I_ACLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_UFS_EMBD_IPCLKPORT_I_CLK_UNIPRO: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_UFS_EMBD_IPCLKPORT_I_FMP_CLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USB30DRD_ACLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USB30DRD_REF_CLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USB30DRD_SUSPEND_CLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USBTVH_AHB_CLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USBTVH_CORE_CLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_USBTV_IPCLKPORT_I_USBTVH_XIU_CLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_US_D_FSYS0_USB_IPCLKPORT_ACLK: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_XIU_D_FSYS0_IPCLKPORT_ACLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_XIU_D_FSYS0_USB_IPCLKPORT_ACLK: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_XIU_P_FSYS0_IPCLKPORT_ACLK: c_uint = 0x209c;
...
pub const PLL_CON0_MUX_CLKCMU_FSYS1_BUS_USER: c_uint = 0x0100;
pub const PLL_CON2_MUX_CLKCMU_FSYS1_BUS_USER: c_uint = 0x0108;
pub const PLL_CON0_MUX_CLKCMU_FSYS1_MMC_CARD_USER: c_uint = 0x0120;
pub const PLL_CON2_MUX_CLKCMU_FSYS1_MMC_CARD_USER: c_uint = 0x0128;
pub const PLL_CON0_MUX_CLKCMU_FSYS1_PCIE_USER: c_uint = 0x0140;
pub const PLL_CON2_MUX_CLKCMU_FSYS1_PCIE_USER: c_uint = 0x0148;
pub const PLL_CON0_MUX_CLKCMU_FSYS1_UFS_CARD_USER: c_uint = 0x0160;
pub const PLL_CON2_MUX_CLKCMU_FSYS1_UFS_CARD_USER: c_uint = 0x0168;
pub const CLK_CON_GAT_CLK_BLK_FSYS1_UID_PCIE_IPCLKPORT_PHY_REF_CLK_IN: c_uint = 0x2000;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_ADM_AHB_SSS_IPCLKPORT_HCLKM: c_uint = 0x2004;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_AHBBR_FSYS1_IPCLKPORT_HCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_AXI2AHB_FSYS1_IPCLKPORT_ACLK: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_AXI2APB_FSYS1P0_IPCLKPORT_ACLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_AXI2APB_FSYS1P1_IPCLKPORT_ACLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_BTM_FSYS1_IPCLKPORT_I_ACLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_BTM_FSYS1_IPCLKPORT_I_PCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_FSYS1_CMU_FSYS1_IPCLKPORT_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_GPIO_FSYS1_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_LHM_AXI_P_FSYS1_IPCLKPORT_I_CLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_LHS_ACEL_D_FSYS1_IPCLKPORT_I_CLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_MMC_CARD_IPCLKPORT_I_ACLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_MMC_CARD_IPCLKPORT_SDCLKIN: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_DBI_ACLK_0: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_DBI_ACLK_1: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_IEEE1500_WRAPPER_FOR_PCIE_PHY_LC_X2_INST_0_I_SCL_APB_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_MSTR_ACLK_0: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_MSTR_ACLK_1: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_PCIE_SUB_CTRL_INST_1_I_DRIVER_APB_CLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_PIPE2_DIGITAL_X2_WRAP_INST_0_I_APB_PCLK_SCL: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_SLV_ACLK_0: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PCIE_IPCLKPORT_SLV_ACLK_1: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_PMU_FSYS1_IPCLKPORT_PCLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_BCM_FSYS1_IPCLKPORT_ACLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_BCM_FSYS1_IPCLKPORT_PCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_RSTNSYNC_CLK_FSYS1_BUS_IPCLKPORT_CLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_RTIC_IPCLKPORT_I_ACLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_RTIC_IPCLKPORT_I_PCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_SSS_IPCLKPORT_I_ACLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_SSS_IPCLKPORT_I_PCLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_SYSREG_FSYS1_IPCLKPORT_PCLK: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_TOE_WIFI0_IPCLKPORT_I_CLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_TOE_WIFI1_IPCLKPORT_I_CLK: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_UFS_CARD_IPCLKPORT_I_ACLK: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_UFS_CARD_IPCLKPORT_I_CLK_UNIPRO: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_UFS_CARD_IPCLKPORT_I_FMP_CLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_XIU_D_FSYS1_IPCLKPORT_ACLK: c_uint = 0x20a8;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_XIU_P_FSYS1_IPCLKPORT_ACLK: c_uint = 0x20ac;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC0_BUS_USER: c_uint = 0x0100;
pub const PLL_CON2_MUX_CLKCMU_PERIC0_BUS_USER: c_uint = 0x0108;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_UART_DBG_USER: c_uint = 0x0120;
pub const PLL_CON2_MUX_CLKCMU_PERIC0_UART_DBG_USER: c_uint = 0x0128;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI00_USER: c_uint = 0x0140;
pub const PLL_CON2_MUX_CLKCMU_PERIC0_USI00_USER: c_uint = 0x0148;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI01_USER: c_uint = 0x0160;
pub const PLL_CON2_MUX_CLKCMU_PERIC0_USI01_USER: c_uint = 0x0168;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI02_USER: c_uint = 0x0180;
pub const PLL_CON2_MUX_CLKCMU_PERIC0_USI02_USER: c_uint = 0x0188;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI03_USER: c_uint = 0x01a0;
pub const PLL_CON2_MUX_CLKCMU_PERIC0_USI03_USER: c_uint = 0x01a8;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_PERIC0_CMU_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_AXI2APB_PERIC0_IPCLKPORT_ACLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_GPIO_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_LHM_AXI_P_PERIC0_IPCLKPORT_I_CLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PMU_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PWM_IPCLKPORT_I_PCLK_S0: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_BUSP_IPCLKPORT_CLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_SPEEDY2_TSP_IPCLKPORT_CLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_SYSREG_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_UART_DBG_IPCLKPORT_EXT_UCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_UART_DBG_IPCLKPORT_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_USI00_IPCLKPORT_I_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_USI00_IPCLKPORT_I_SCLK_USI: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_USI01_IPCLKPORT_I_PCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_USI01_IPCLKPORT_I_SCLK_USI: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_USI02_IPCLKPORT_I_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_USI02_IPCLKPORT_I_SCLK_USI: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_USI03_IPCLKPORT_I_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_USI03_IPCLKPORT_I_SCLK_USI: c_uint = 0x205c;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC1_BUS_USER: c_uint = 0x0100;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_BUS_USER: c_uint = 0x0108;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_SPEEDY2_USER: c_uint = 0x0120;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_SPEEDY2_USER: c_uint = 0x0128;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_SPI_CAM0_USER: c_uint = 0x0140;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_SPI_CAM0_USER: c_uint = 0x0148;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_SPI_CAM1_USER: c_uint = 0x0160;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_SPI_CAM1_USER: c_uint = 0x0168;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_UART_BT_USER: c_uint = 0x0180;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_UART_BT_USER: c_uint = 0x0188;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI04_USER: c_uint = 0x01a0;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI04_USER: c_uint = 0x01a8;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI05_USER: c_uint = 0x01c0;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI05_USER: c_uint = 0x01c8;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI06_USER: c_uint = 0x01e0;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI06_USER: c_uint = 0x01e8;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI07_USER: c_uint = 0x0200;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI07_USER: c_uint = 0x0208;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI08_USER: c_uint = 0x0220;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI08_USER: c_uint = 0x0228;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI09_USER: c_uint = 0x0240;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI09_USER: c_uint = 0x0248;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI10_USER: c_uint = 0x0260;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI10_USER: c_uint = 0x0268;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI11_USER: c_uint = 0x0280;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI11_USER: c_uint = 0x0288;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI12_USER: c_uint = 0x02a0;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI12_USER: c_uint = 0x02a8;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI13_USER: c_uint = 0x02c0;
pub const PLL_CON2_MUX_CLKCMU_PERIC1_USI13_USER: c_uint = 0x02c8;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_CMU_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_SPEEDY2_IPCLKPORT_CLK: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_AXI2APB_PERIC1P0_IPCLKPORT_ACLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_AXI2APB_PERIC1P1_IPCLKPORT_ACLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_AXI2APB_PERIC1P2_IPCLKPORT_ACLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_GPIO_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_HSI2C_CAM0_IPCLKPORT_IPCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_HSI2C_CAM1_IPCLKPORT_IPCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_HSI2C_CAM2_IPCLKPORT_IPCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_HSI2C_CAM3_IPCLKPORT_IPCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_LHM_AXI_P_PERIC1_IPCLKPORT_I_CLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PMU_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_BUSP_IPCLKPORT_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPEEDY2_DDI1_IPCLKPORT_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPEEDY2_DDI1_IPCLKPORT_SCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPEEDY2_DDI2_IPCLKPORT_CLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPEEDY2_DDI2_IPCLKPORT_SCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPEEDY2_DDI_IPCLKPORT_CLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPEEDY2_DDI_IPCLKPORT_SCLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPEEDY2_TSP1_IPCLKPORT_CLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPEEDY2_TSP2_IPCLKPORT_CLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPI_CAM0_IPCLKPORT_PCLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPI_CAM0_IPCLKPORT_SPI_EXT_CLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPI_CAM1_IPCLKPORT_PCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SPI_CAM1_IPCLKPORT_SPI_EXT_CLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SYSREG_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_UART_BT_IPCLKPORT_EXT_UCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_UART_BT_IPCLKPORT_PCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI04_IPCLKPORT_I_PCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI04_IPCLKPORT_I_SCLK_USI: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI05_IPCLKPORT_I_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI05_IPCLKPORT_I_SCLK_USI: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI06_IPCLKPORT_I_PCLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI06_IPCLKPORT_I_SCLK_USI: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI07_IPCLKPORT_I_PCLK: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI07_IPCLKPORT_I_SCLK_USI: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI08_IPCLKPORT_I_PCLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI08_IPCLKPORT_I_SCLK_USI: c_uint = 0x20a8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI09_IPCLKPORT_I_PCLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI09_IPCLKPORT_I_SCLK_USI: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI10_IPCLKPORT_I_PCLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI10_IPCLKPORT_I_SCLK_USI: c_uint = 0x20b8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI11_IPCLKPORT_I_PCLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI11_IPCLKPORT_I_SCLK_USI: c_uint = 0x20c0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI12_IPCLKPORT_I_PCLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI12_IPCLKPORT_I_SCLK_USI: c_uint = 0x20c8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI13_IPCLKPORT_I_PCLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI13_IPCLKPORT_I_SCLK_USI: c_uint = 0x20d0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_XIU_P_PERIC1_IPCLKPORT_ACLK: c_uint = 0x20d4;
...
#[no_mangle]
unsafe extern "C" fn exynos8895_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynos8895_cmu_init() -> int __init {
