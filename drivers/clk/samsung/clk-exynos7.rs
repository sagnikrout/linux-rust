...
//! Source: drivers/clk/samsung/clk-exynos7.c
#![no_std]
...
pub const CC_PLL_LOCK: c_uint = 0x0000;
pub const BUS0_PLL_LOCK: c_uint = 0x0004;
pub const BUS1_DPLL_LOCK: c_uint = 0x0008;
pub const MFC_PLL_LOCK: c_uint = 0x000C;
pub const AUD_PLL_LOCK: c_uint = 0x0010;
pub const CC_PLL_CON0: c_uint = 0x0100;
pub const BUS0_PLL_CON0: c_uint = 0x0110;
pub const BUS1_DPLL_CON0: c_uint = 0x0120;
pub const MFC_PLL_CON0: c_uint = 0x0130;
pub const AUD_PLL_CON0: c_uint = 0x0140;
pub const MUX_SEL_TOPC0: c_uint = 0x0200;
pub const MUX_SEL_TOPC1: c_uint = 0x0204;
pub const MUX_SEL_TOPC2: c_uint = 0x0208;
pub const MUX_SEL_TOPC3: c_uint = 0x020C;
pub const DIV_TOPC0: c_uint = 0x0600;
pub const DIV_TOPC1: c_uint = 0x0604;
pub const DIV_TOPC3: c_uint = 0x060C;
pub const ENABLE_ACLK_TOPC0: c_uint = 0x0800;
pub const ENABLE_ACLK_TOPC1: c_uint = 0x0804;
pub const ENABLE_SCLK_TOPC1: c_uint = 0x0A04;
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_topc_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_TOP00: c_uint = 0x0200;
pub const MUX_SEL_TOP01: c_uint = 0x0204;
pub const MUX_SEL_TOP03: c_uint = 0x020C;
pub const MUX_SEL_TOP0_PERIC0: c_uint = 0x0230;
pub const MUX_SEL_TOP0_PERIC1: c_uint = 0x0234;
pub const MUX_SEL_TOP0_PERIC2: c_uint = 0x0238;
pub const MUX_SEL_TOP0_PERIC3: c_uint = 0x023C;
pub const DIV_TOP03: c_uint = 0x060C;
pub const DIV_TOP0_PERIC0: c_uint = 0x0630;
pub const DIV_TOP0_PERIC1: c_uint = 0x0634;
pub const DIV_TOP0_PERIC2: c_uint = 0x0638;
pub const DIV_TOP0_PERIC3: c_uint = 0x063C;
pub const ENABLE_ACLK_TOP03: c_uint = 0x080C;
pub const ENABLE_SCLK_TOP0_PERIC0: c_uint = 0x0A30;
pub const ENABLE_SCLK_TOP0_PERIC1: c_uint = 0x0A34;
pub const ENABLE_SCLK_TOP0_PERIC2: c_uint = 0x0A38;
pub const ENABLE_SCLK_TOP0_PERIC3: c_uint = 0x0A3C;
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_top0_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_TOP10: c_uint = 0x0200;
pub const MUX_SEL_TOP11: c_uint = 0x0204;
pub const MUX_SEL_TOP13: c_uint = 0x020C;
pub const MUX_SEL_TOP1_FSYS0: c_uint = 0x0224;
pub const MUX_SEL_TOP1_FSYS1: c_uint = 0x0228;
pub const MUX_SEL_TOP1_FSYS11: c_uint = 0x022C;
pub const DIV_TOP13: c_uint = 0x060C;
pub const DIV_TOP1_FSYS0: c_uint = 0x0624;
pub const DIV_TOP1_FSYS1: c_uint = 0x0628;
pub const DIV_TOP1_FSYS11: c_uint = 0x062C;
pub const ENABLE_ACLK_TOP13: c_uint = 0x080C;
pub const ENABLE_SCLK_TOP1_FSYS0: c_uint = 0x0A24;
pub const ENABLE_SCLK_TOP1_FSYS1: c_uint = 0x0A28;
pub const ENABLE_SCLK_TOP1_FSYS11: c_uint = 0x0A2C;
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_top1_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_CCORE: c_uint = 0x0200;
pub const DIV_CCORE: c_uint = 0x0600;
pub const ENABLE_ACLK_CCORE0: c_uint = 0x0800;
pub const ENABLE_ACLK_CCORE1: c_uint = 0x0804;
pub const ENABLE_PCLK_CCORE: c_uint = 0x0900;
//
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_ccore_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_PERIC0: c_uint = 0x0200;
pub const ENABLE_PCLK_PERIC0: c_uint = 0x0900;
pub const ENABLE_SCLK_PERIC0: c_uint = 0x0A00;
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_peric0_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_PERIC10: c_uint = 0x0200;
pub const MUX_SEL_PERIC11: c_uint = 0x0204;
pub const MUX_SEL_PERIC12: c_uint = 0x0208;
pub const ENABLE_PCLK_PERIC1: c_uint = 0x0900;
pub const ENABLE_SCLK_PERIC10: c_uint = 0x0A00;
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_peric1_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_PERIS: c_uint = 0x0200;
pub const ENABLE_PCLK_PERIS: c_uint = 0x0900;
pub const ENABLE_PCLK_PERIS_SECURE_CHIPID: c_uint = 0x0910;
pub const ENABLE_SCLK_PERIS: c_uint = 0x0A00;
pub const ENABLE_SCLK_PERIS_SECURE_CHIPID: c_uint = 0x0A10;
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_peris_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_FSYS00: c_uint = 0x0200;
pub const MUX_SEL_FSYS01: c_uint = 0x0204;
pub const MUX_SEL_FSYS02: c_uint = 0x0208;
pub const ENABLE_ACLK_FSYS00: c_uint = 0x0800;
pub const ENABLE_ACLK_FSYS01: c_uint = 0x0804;
pub const ENABLE_SCLK_FSYS01: c_uint = 0x0A04;
pub const ENABLE_SCLK_FSYS02: c_uint = 0x0A08;
pub const ENABLE_SCLK_FSYS04: c_uint = 0x0A10;
//
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_fsys0_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_FSYS10: c_uint = 0x0200;
pub const MUX_SEL_FSYS11: c_uint = 0x0204;
pub const MUX_SEL_FSYS12: c_uint = 0x0208;
pub const DIV_FSYS1: c_uint = 0x0600;
pub const ENABLE_ACLK_FSYS1: c_uint = 0x0800;
pub const ENABLE_PCLK_FSYS1: c_uint = 0x0900;
pub const ENABLE_SCLK_FSYS11: c_uint = 0x0A04;
pub const ENABLE_SCLK_FSYS12: c_uint = 0x0A08;
pub const ENABLE_SCLK_FSYS13: c_uint = 0x0A0C;
//
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_fsys1_init(np: *mut device_node) -> void __init {
...
pub const MUX_SEL_MSCL: c_uint = 0x0200;
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_mscl_init(np: *mut device_node) -> void __init {
...
pub const ENABLE_SCLK_AUD: c_uint = 0x0A00;
//
...
#[no_mangle]
unsafe extern "C" fn exynos7_clk_aud_init(np: *mut device_node) -> void __init {
