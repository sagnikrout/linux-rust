...
//! Source: drivers/clk/samsung/clk-gs101.c
#![no_std]
...
pub const GS101_GATE_DBG_OFFSET: c_uint = 0x4000;
pub const GS101_DRCG_EN_OFFSET: c_uint = 0x104;
pub const GS101_MEMCLK_OFFSET: c_uint = 0x108;
// ---- CMU_TOP -------------------------------------------------------------
// Register Offset definitions for CMU_TOP (0x1e080000)
pub const PLL_LOCKTIME_PLL_SHARED0: c_uint = 0x0000;
pub const PLL_LOCKTIME_PLL_SHARED1: c_uint = 0x0004;
pub const PLL_LOCKTIME_PLL_SHARED2: c_uint = 0x0008;
pub const PLL_LOCKTIME_PLL_SHARED3: c_uint = 0x000c;
pub const PLL_LOCKTIME_PLL_SPARE: c_uint = 0x0010;
pub const PLL_CON0_PLL_SHARED0: c_uint = 0x0100;
pub const PLL_CON1_PLL_SHARED0: c_uint = 0x0104;
pub const PLL_CON2_PLL_SHARED0: c_uint = 0x0108;
pub const PLL_CON3_PLL_SHARED0: c_uint = 0x010c;
pub const PLL_CON4_PLL_SHARED0: c_uint = 0x0110;
pub const PLL_CON0_PLL_SHARED1: c_uint = 0x0140;
pub const PLL_CON1_PLL_SHARED1: c_uint = 0x0144;
pub const PLL_CON2_PLL_SHARED1: c_uint = 0x0148;
pub const PLL_CON3_PLL_SHARED1: c_uint = 0x014c;
pub const PLL_CON4_PLL_SHARED1: c_uint = 0x0150;
pub const PLL_CON0_PLL_SHARED2: c_uint = 0x0180;
pub const PLL_CON1_PLL_SHARED2: c_uint = 0x0184;
pub const PLL_CON2_PLL_SHARED2: c_uint = 0x0188;
pub const PLL_CON3_PLL_SHARED2: c_uint = 0x018c;
pub const PLL_CON4_PLL_SHARED2: c_uint = 0x0190;
pub const PLL_CON0_PLL_SHARED3: c_uint = 0x01c0;
pub const PLL_CON1_PLL_SHARED3: c_uint = 0x01c4;
pub const PLL_CON2_PLL_SHARED3: c_uint = 0x01c8;
pub const PLL_CON3_PLL_SHARED3: c_uint = 0x01cc;
pub const PLL_CON4_PLL_SHARED3: c_uint = 0x01d0;
pub const PLL_CON0_PLL_SPARE: c_uint = 0x0200;
pub const PLL_CON1_PLL_SPARE: c_uint = 0x0204;
pub const PLL_CON2_PLL_SPARE: c_uint = 0x0208;
pub const PLL_CON3_PLL_SPARE: c_uint = 0x020c;
pub const PLL_CON4_PLL_SPARE: c_uint = 0x0210;
pub const CMU_CMU_TOP_CONTROLLER_OPTION: c_uint = 0x0800;
pub const CLKOUT_CON_BLK_CMU_CMU_TOP_CLKOUT0: c_uint = 0x0810;
pub const CMU_HCHGEN_CLKMUX_CMU_BOOST: c_uint = 0x0840;
pub const CMU_HCHGEN_CLKMUX_TOP_BOOST: c_uint = 0x0844;
pub const CMU_HCHGEN_CLKMUX: c_uint = 0x0850;
pub const POWER_FAIL_DETECT_PLL: c_uint = 0x0864;
pub const EARLY_WAKEUP_FORCED_0_ENABLE: c_uint = 0x0870;
pub const EARLY_WAKEUP_FORCED_1_ENABLE: c_uint = 0x0874;
pub const EARLY_WAKEUP_APM_CTRL: c_uint = 0x0878;
pub const EARLY_WAKEUP_CLUSTER0_CTRL: c_uint = 0x087c;
pub const EARLY_WAKEUP_DPU_CTRL: c_uint = 0x0880;
pub const EARLY_WAKEUP_CSIS_CTRL: c_uint = 0x0884;
pub const EARLY_WAKEUP_APM_DEST: c_uint = 0x0890;
pub const EARLY_WAKEUP_CLUSTER0_DEST: c_uint = 0x0894;
pub const EARLY_WAKEUP_DPU_DEST: c_uint = 0x0898;
pub const EARLY_WAKEUP_CSIS_DEST: c_uint = 0x089c;
pub const EARLY_WAKEUP_SW_TRIG_APM: c_uint = 0x08c0;
pub const EARLY_WAKEUP_SW_TRIG_APM_SET: c_uint = 0x08c4;
pub const EARLY_WAKEUP_SW_TRIG_APM_CLEAR: c_uint = 0x08c8;
pub const EARLY_WAKEUP_SW_TRIG_CLUSTER0: c_uint = 0x08d0;
pub const EARLY_WAKEUP_SW_TRIG_CLUSTER0_SET: c_uint = 0x08d4;
pub const EARLY_WAKEUP_SW_TRIG_CLUSTER0_CLEAR: c_uint = 0x08d8;
pub const EARLY_WAKEUP_SW_TRIG_DPU: c_uint = 0x08e0;
pub const EARLY_WAKEUP_SW_TRIG_DPU_SET: c_uint = 0x08e4;
pub const EARLY_WAKEUP_SW_TRIG_DPU_CLEAR: c_uint = 0x08e8;
pub const EARLY_WAKEUP_SW_TRIG_CSIS: c_uint = 0x08f0;
pub const EARLY_WAKEUP_SW_TRIG_CSIS_SET: c_uint = 0x08f4;
pub const EARLY_WAKEUP_SW_TRIG_CSIS_CLEAR: c_uint = 0x08f8;
pub const CLK_CON_MUX_MUX_CLKCMU_BO_BUS: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLKCMU_BUS0_BUS: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLKCMU_BUS1_BUS: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLKCMU_BUS2_BUS: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK0: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK1: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK2: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK3: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK4: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK5: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK6: c_uint = 0x1028;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK7: c_uint = 0x102c;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST: c_uint = 0x1030;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST_OPTION1: c_uint = 0x1034;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_BUS: c_uint = 0x1038;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_DBG: c_uint = 0x103c;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1040;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH: c_uint = 0x1044;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL2_SWITCH: c_uint = 0x1048;
pub const CLK_CON_MUX_MUX_CLKCMU_CSIS_BUS: c_uint = 0x104c;
pub const CLK_CON_MUX_MUX_CLKCMU_DISP_BUS: c_uint = 0x1050;
pub const CLK_CON_MUX_MUX_CLKCMU_DNS_BUS: c_uint = 0x1054;
pub const CLK_CON_MUX_MUX_CLKCMU_DPU_BUS: c_uint = 0x1058;
pub const CLK_CON_MUX_MUX_CLKCMU_EH_BUS: c_uint = 0x105c;
pub const CLK_CON_MUX_MUX_CLKCMU_G2D_G2D: c_uint = 0x1060;
pub const CLK_CON_MUX_MUX_CLKCMU_G2D_MSCL: c_uint = 0x1064;
pub const CLK_CON_MUX_MUX_CLKCMU_G3AA_G3AA: c_uint = 0x1068;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D_BUSD: c_uint = 0x106c;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D_GLB: c_uint = 0x1070;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D_SWITCH: c_uint = 0x1074;
pub const CLK_CON_MUX_MUX_CLKCMU_GDC_GDC0: c_uint = 0x1078;
pub const CLK_CON_MUX_MUX_CLKCMU_GDC_GDC1: c_uint = 0x107c;
pub const CLK_CON_MUX_MUX_CLKCMU_GDC_SCSC: c_uint = 0x1080;
pub const CLK_CON_MUX_MUX_CLKCMU_HPM: c_uint = 0x1084;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_BUS: c_uint = 0x1088;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_DPGTC: c_uint = 0x108c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_USB31DRD: c_uint = 0x1090;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_USBDPDBG: c_uint = 0x1094;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_BUS: c_uint = 0x1098;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_PCIE: c_uint = 0x109c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_BUS: c_uint = 0x10a0;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_MMC_CARD: c_uint = 0x10a4;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_PCIE: c_uint = 0x10a8;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_UFS_EMBD: c_uint = 0x10ac;
pub const CLK_CON_MUX_MUX_CLKCMU_IPP_BUS: c_uint = 0x10b0;
pub const CLK_CON_MUX_MUX_CLKCMU_ITP_BUS: c_uint = 0x10b4;
pub const CLK_CON_MUX_MUX_CLKCMU_MCSC_ITSC: c_uint = 0x10b8;
pub const CLK_CON_MUX_MUX_CLKCMU_MCSC_MCSC: c_uint = 0x10bc;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC_MFC: c_uint = 0x10c0;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_BUSP: c_uint = 0x10c4;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x10c8;
pub const CLK_CON_MUX_MUX_CLKCMU_MISC_BUS: c_uint = 0x10cc;
pub const CLK_CON_MUX_MUX_CLKCMU_MISC_SSS: c_uint = 0x10d0;
pub const CLK_CON_MUX_MUX_CLKCMU_PDP_BUS: c_uint = 0x10d4;
pub const CLK_CON_MUX_MUX_CLKCMU_PDP_VRA: c_uint = 0x10d8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_BUS: c_uint = 0x10dc;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_IP: c_uint = 0x10e0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_BUS: c_uint = 0x10e4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_IP: c_uint = 0x10e8;
pub const CLK_CON_MUX_MUX_CLKCMU_TNR_BUS: c_uint = 0x10ec;
pub const CLK_CON_MUX_MUX_CLKCMU_TOP_BOOST_OPTION1: c_uint = 0x10f0;
pub const CLK_CON_MUX_MUX_CLKCMU_TOP_CMUREF: c_uint = 0x10f4;
pub const CLK_CON_MUX_MUX_CLKCMU_TPU_BUS: c_uint = 0x10f8;
pub const CLK_CON_MUX_MUX_CLKCMU_TPU_TPU: c_uint = 0x10fc;
pub const CLK_CON_MUX_MUX_CLKCMU_TPU_TPUCTL: c_uint = 0x1100;
pub const CLK_CON_MUX_MUX_CLKCMU_TPU_UART: c_uint = 0x1104;
pub const CLK_CON_MUX_MUX_CMU_CMUREF: c_uint = 0x1108;
pub const CLK_CON_DIV_CLKCMU_BO_BUS: c_uint = 0x1800;
pub const CLK_CON_DIV_CLKCMU_BUS0_BUS: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKCMU_BUS1_BUS: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKCMU_BUS2_BUS: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK0: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK1: c_uint = 0x1814;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK2: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK3: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK4: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK5: c_uint = 0x1824;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK6: c_uint = 0x1828;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK7: c_uint = 0x182c;
pub const CLK_CON_DIV_CLKCMU_CORE_BUS: c_uint = 0x1830;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_DBG: c_uint = 0x1834;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKCMU_CPUCL1_SWITCH: c_uint = 0x183c;
pub const CLK_CON_DIV_CLKCMU_CPUCL2_SWITCH: c_uint = 0x1840;
pub const CLK_CON_DIV_CLKCMU_CSIS_BUS: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_DISP_BUS: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_DNS_BUS: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_DPU_BUS: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_EH_BUS: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_G2D_G2D: c_uint = 0x1858;
pub const CLK_CON_DIV_CLKCMU_G2D_MSCL: c_uint = 0x185c;
pub const CLK_CON_DIV_CLKCMU_G3AA_G3AA: c_uint = 0x1860;
pub const CLK_CON_DIV_CLKCMU_G3D_BUSD: c_uint = 0x1864;
pub const CLK_CON_DIV_CLKCMU_G3D_GLB: c_uint = 0x1868;
pub const CLK_CON_DIV_CLKCMU_G3D_SWITCH: c_uint = 0x186c;
pub const CLK_CON_DIV_CLKCMU_GDC_GDC0: c_uint = 0x1870;
pub const CLK_CON_DIV_CLKCMU_GDC_GDC1: c_uint = 0x1874;
pub const CLK_CON_DIV_CLKCMU_GDC_SCSC: c_uint = 0x1878;
pub const CLK_CON_DIV_CLKCMU_HPM: c_uint = 0x187c;
pub const CLK_CON_DIV_CLKCMU_HSI0_BUS: c_uint = 0x1880;
pub const CLK_CON_DIV_CLKCMU_HSI0_DPGTC: c_uint = 0x1884;
pub const CLK_CON_DIV_CLKCMU_HSI0_USB31DRD: c_uint = 0x1888;
pub const CLK_CON_DIV_CLKCMU_HSI0_USBDPDBG: c_uint = 0x188c;
pub const CLK_CON_DIV_CLKCMU_HSI1_BUS: c_uint = 0x1890;
pub const CLK_CON_DIV_CLKCMU_HSI1_PCIE: c_uint = 0x1894;
pub const CLK_CON_DIV_CLKCMU_HSI2_BUS: c_uint = 0x1898;
pub const CLK_CON_DIV_CLKCMU_HSI2_MMC_CARD: c_uint = 0x189c;
pub const CLK_CON_DIV_CLKCMU_HSI2_PCIE: c_uint = 0x18a0;
pub const CLK_CON_DIV_CLKCMU_HSI2_UFS_EMBD: c_uint = 0x18a4;
pub const CLK_CON_DIV_CLKCMU_IPP_BUS: c_uint = 0x18a8;
pub const CLK_CON_DIV_CLKCMU_ITP_BUS: c_uint = 0x18ac;
pub const CLK_CON_DIV_CLKCMU_MCSC_ITSC: c_uint = 0x18b0;
pub const CLK_CON_DIV_CLKCMU_MCSC_MCSC: c_uint = 0x18b4;
pub const CLK_CON_DIV_CLKCMU_MFC_MFC: c_uint = 0x18b8;
pub const CLK_CON_DIV_CLKCMU_MIF_BUSP: c_uint = 0x18bc;
pub const CLK_CON_DIV_CLKCMU_MISC_BUS: c_uint = 0x18c0;
pub const CLK_CON_DIV_CLKCMU_MISC_SSS: c_uint = 0x18c4;
pub const CLK_CON_DIV_CLKCMU_OTP: c_uint = 0x18c8;
pub const CLK_CON_DIV_CLKCMU_PDP_BUS: c_uint = 0x18cc;
pub const CLK_CON_DIV_CLKCMU_PDP_VRA: c_uint = 0x18d0;
pub const CLK_CON_DIV_CLKCMU_PERIC0_BUS: c_uint = 0x18d4;
pub const CLK_CON_DIV_CLKCMU_PERIC0_IP: c_uint = 0x18d8;
pub const CLK_CON_DIV_CLKCMU_PERIC1_BUS: c_uint = 0x18dc;
pub const CLK_CON_DIV_CLKCMU_PERIC1_IP: c_uint = 0x18e0;
pub const CLK_CON_DIV_CLKCMU_TNR_BUS: c_uint = 0x18e4;
pub const CLK_CON_DIV_CLKCMU_TPU_BUS: c_uint = 0x18e8;
pub const CLK_CON_DIV_CLKCMU_TPU_TPU: c_uint = 0x18ec;
pub const CLK_CON_DIV_CLKCMU_TPU_TPUCTL: c_uint = 0x18f0;
pub const CLK_CON_DIV_CLKCMU_TPU_UART: c_uint = 0x18f4;
pub const CLK_CON_DIV_DIV_CLKCMU_CMU_BOOST: c_uint = 0x18f8;
pub const CLK_CON_DIV_DIV_CLK_CMU_CMUREF: c_uint = 0x18fc;
pub const CLK_CON_DIV_PLL_SHARED0_DIV2: c_uint = 0x1900;
pub const CLK_CON_DIV_PLL_SHARED0_DIV3: c_uint = 0x1904;
pub const CLK_CON_DIV_PLL_SHARED0_DIV4: c_uint = 0x1908;
pub const CLK_CON_DIV_PLL_SHARED0_DIV5: c_uint = 0x190c;
pub const CLK_CON_DIV_PLL_SHARED1_DIV2: c_uint = 0x1910;
pub const CLK_CON_DIV_PLL_SHARED1_DIV3: c_uint = 0x1914;
pub const CLK_CON_DIV_PLL_SHARED1_DIV4: c_uint = 0x1918;
pub const CLK_CON_DIV_PLL_SHARED2_DIV2: c_uint = 0x191c;
pub const CLK_CON_DIV_PLL_SHARED3_DIV2: c_uint = 0x1920;
pub const CLK_CON_GAT_CLKCMU_BUS0_BOOST: c_uint = 0x2000;
pub const CLK_CON_GAT_CLKCMU_BUS1_BOOST: c_uint = 0x2004;
pub const CLK_CON_GAT_CLKCMU_BUS2_BOOST: c_uint = 0x2008;
pub const CLK_CON_GAT_CLKCMU_CORE_BOOST: c_uint = 0x200c;
pub const CLK_CON_GAT_CLKCMU_CPUCL0_BOOST: c_uint = 0x2010;
pub const CLK_CON_GAT_CLKCMU_CPUCL1_BOOST: c_uint = 0x2014;
pub const CLK_CON_GAT_CLKCMU_CPUCL2_BOOST: c_uint = 0x2018;
pub const CLK_CON_GAT_CLKCMU_MIF_BOOST: c_uint = 0x201c;
pub const CLK_CON_GAT_CLKCMU_MIF_SWITCH: c_uint = 0x2020;
pub const CLK_CON_GAT_GATE_CLKCMU_BO_BUS: c_uint = 0x2024;
pub const CLK_CON_GAT_GATE_CLKCMU_BUS0_BUS: c_uint = 0x2028;
pub const CLK_CON_GAT_GATE_CLKCMU_BUS1_BUS: c_uint = 0x202c;
pub const CLK_CON_GAT_GATE_CLKCMU_BUS2_BUS: c_uint = 0x2030;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK0: c_uint = 0x2034;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK1: c_uint = 0x2038;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK2: c_uint = 0x203c;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK3: c_uint = 0x2040;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK4: c_uint = 0x2044;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK5: c_uint = 0x2048;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK6: c_uint = 0x204c;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK7: c_uint = 0x2050;
pub const CLK_CON_GAT_GATE_CLKCMU_CMU_BOOST: c_uint = 0x2054;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_BUS: c_uint = 0x2058;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_DBG_BUS: c_uint = 0x205c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_SWITCH: c_uint = 0x2060;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH: c_uint = 0x2064;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL2_SWITCH: c_uint = 0x2068;
pub const CLK_CON_GAT_GATE_CLKCMU_CSIS_BUS: c_uint = 0x206c;
pub const CLK_CON_GAT_GATE_CLKCMU_DISP_BUS: c_uint = 0x2070;
pub const CLK_CON_GAT_GATE_CLKCMU_DNS_BUS: c_uint = 0x2074;
pub const CLK_CON_GAT_GATE_CLKCMU_DPU_BUS: c_uint = 0x2078;
pub const CLK_CON_GAT_GATE_CLKCMU_EH_BUS: c_uint = 0x207c;
pub const CLK_CON_GAT_GATE_CLKCMU_G2D_G2D: c_uint = 0x2080;
pub const CLK_CON_GAT_GATE_CLKCMU_G2D_MSCL: c_uint = 0x2084;
pub const CLK_CON_GAT_GATE_CLKCMU_G3AA_G3AA: c_uint = 0x2088;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_BUSD: c_uint = 0x208c;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_GLB: c_uint = 0x2090;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_SWITCH: c_uint = 0x2094;
pub const CLK_CON_GAT_GATE_CLKCMU_GDC_GDC0: c_uint = 0x2098;
pub const CLK_CON_GAT_GATE_CLKCMU_GDC_GDC1: c_uint = 0x209c;
pub const CLK_CON_GAT_GATE_CLKCMU_GDC_SCSC: c_uint = 0x20a0;
pub const CLK_CON_GAT_GATE_CLKCMU_HPM: c_uint = 0x20a4;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_BUS: c_uint = 0x20a8;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_DPGTC: c_uint = 0x20ac;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_USB31DRD: c_uint = 0x20b0;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_USBDPDBG: c_uint = 0x20b4;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_BUS: c_uint = 0x20b8;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_PCIE: c_uint = 0x20bc;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI2_BUS: c_uint = 0x20c0;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI2_MMCCARD: c_uint = 0x20c4;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI2_PCIE: c_uint = 0x20c8;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI2_UFS_EMBD: c_uint = 0x20cc;
pub const CLK_CON_GAT_GATE_CLKCMU_IPP_BUS: c_uint = 0x20d0;
pub const CLK_CON_GAT_GATE_CLKCMU_ITP_BUS: c_uint = 0x20d4;
pub const CLK_CON_GAT_GATE_CLKCMU_MCSC_ITSC: c_uint = 0x20d8;
pub const CLK_CON_GAT_GATE_CLKCMU_MCSC_MCSC: c_uint = 0x20dc;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC_MFC: c_uint = 0x20e0;
pub const CLK_CON_GAT_GATE_CLKCMU_MIF_BUSP: c_uint = 0x20e4;
pub const CLK_CON_GAT_GATE_CLKCMU_MISC_BUS: c_uint = 0x20e8;
pub const CLK_CON_GAT_GATE_CLKCMU_MISC_SSS: c_uint = 0x20ec;
pub const CLK_CON_GAT_GATE_CLKCMU_PDP_BUS: c_uint = 0x20f0;
pub const CLK_CON_GAT_GATE_CLKCMU_PDP_VRA: c_uint = 0x20f4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_BUS: c_uint = 0x20f8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_IP: c_uint = 0x20fc;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_BUS: c_uint = 0x2100;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_IP: c_uint = 0x2104;
pub const CLK_CON_GAT_GATE_CLKCMU_TNR_BUS: c_uint = 0x2108;
pub const CLK_CON_GAT_GATE_CLKCMU_TOP_CMUREF: c_uint = 0x210c;
pub const CLK_CON_GAT_GATE_CLKCMU_TPU_BUS: c_uint = 0x2110;
pub const CLK_CON_GAT_GATE_CLKCMU_TPU_TPU: c_uint = 0x2114;
pub const CLK_CON_GAT_GATE_CLKCMU_TPU_TPUCTL: c_uint = 0x2118;
pub const CLK_CON_GAT_GATE_CLKCMU_TPU_UART: c_uint = 0x211c;
pub const DMYQCH_CON_CMU_TOP_CMUREF_QCH: c_uint = 0x3000;
pub const DMYQCH_CON_DFTMUX_CMU_QCH_CIS_CLK0: c_uint = 0x3004;
pub const DMYQCH_CON_DFTMUX_CMU_QCH_CIS_CLK1: c_uint = 0x3008;
pub const DMYQCH_CON_DFTMUX_CMU_QCH_CIS_CLK2: c_uint = 0x300c;
pub const DMYQCH_CON_DFTMUX_CMU_QCH_CIS_CLK3: c_uint = 0x3010;
pub const DMYQCH_CON_DFTMUX_CMU_QCH_CIS_CLK4: c_uint = 0x3014;
pub const DMYQCH_CON_DFTMUX_CMU_QCH_CIS_CLK5: c_uint = 0x3018;
pub const DMYQCH_CON_DFTMUX_CMU_QCH_CIS_CLK6: c_uint = 0x301c;
pub const DMYQCH_CON_DFTMUX_CMU_QCH_CIS_CLK7: c_uint = 0x3020;
pub const DMYQCH_CON_OTP_QCH: c_uint = 0x3024;
pub const QUEUE_CTRL_REG_BLK_CMU_CMU_TOP: c_uint = 0x3c00;
pub const QUEUE_ENTRY0_BLK_CMU_CMU_TOP: c_uint = 0x3c10;
pub const QUEUE_ENTRY1_BLK_CMU_CMU_TOP: c_uint = 0x3c14;
pub const QUEUE_ENTRY2_BLK_CMU_CMU_TOP: c_uint = 0x3c18;
pub const QUEUE_ENTRY3_BLK_CMU_CMU_TOP: c_uint = 0x3c1c;
pub const QUEUE_ENTRY4_BLK_CMU_CMU_TOP: c_uint = 0x3c20;
pub const QUEUE_ENTRY5_BLK_CMU_CMU_TOP: c_uint = 0x3c24;
pub const QUEUE_ENTRY6_BLK_CMU_CMU_TOP: c_uint = 0x3c28;
pub const QUEUE_ENTRY7_BLK_CMU_CMU_TOP: c_uint = 0x3c2c;
pub const MIFMIRROR_QUEUE_CTRL_REG: c_uint = 0x3e00;
pub const MIFMIRROR_QUEUE_ENTRY0: c_uint = 0x3e10;
pub const MIFMIRROR_QUEUE_ENTRY1: c_uint = 0x3e14;
pub const MIFMIRROR_QUEUE_ENTRY2: c_uint = 0x3e18;
pub const MIFMIRROR_QUEUE_ENTRY3: c_uint = 0x3e1c;
pub const MIFMIRROR_QUEUE_ENTRY4: c_uint = 0x3e20;
pub const MIFMIRROR_QUEUE_ENTRY5: c_uint = 0x3e24;
pub const MIFMIRROR_QUEUE_ENTRY6: c_uint = 0x3e28;
pub const MIFMIRROR_QUEUE_ENTRY7: c_uint = 0x3e2c;
pub const MIFMIRROR_QUEUE_BUSY: c_uint = 0x3e30;
pub const GENERALIO_ACD_CHANNEL_0: c_uint = 0x3f00;
pub const GENERALIO_ACD_CHANNEL_1: c_uint = 0x3f04;
pub const GENERALIO_ACD_CHANNEL_2: c_uint = 0x3f08;
pub const GENERALIO_ACD_CHANNEL_3: c_uint = 0x3f0c;
pub const GENERALIO_ACD_MASK: c_uint = 0x3f14;
...
#[no_mangle]
unsafe extern "C" fn gs101_cmu_top_init(np: *mut device_node) -> void __init {
...
pub const APM_CMU_APM_CONTROLLER_OPTION: c_uint = 0x0800;
pub const CLKOUT_CON_BLK_APM_CMU_APM_CLKOUT0: c_uint = 0x0810;
pub const CLK_CON_MUX_MUX_CLKCMU_APM_FUNC: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLKCMU_APM_FUNCSRC: c_uint = 0x1004;
pub const CLK_CON_DIV_DIV_CLK_APM_BOOST: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_APM_USI0_UART: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_APM_USI0_USI: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_APM_USI1_UART: c_uint = 0x180c;
pub const CLK_CON_GAT_CLK_BLK_APM_UID_APM_CMU_APM_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BUS0_BOOST_OPTION1: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_CMU_BOOST_OPTION1: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_CORE_BOOST_OPTION1: c_uint = 0x200c;
pub const CLK_CON_GAT_GATE_CLKCMU_APM_FUNC: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APBIF_GPIO_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APBIF_GPIO_FAR_ALIVE_IPCLKPORT_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APBIF_PMU_ALIVE_IPCLKPORT_PCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APBIF_RTC_IPCLKPORT_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APBIF_TRTC_IPCLKPORT_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APM_USI0_UART_IPCLKPORT_IPCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APM_USI0_UART_IPCLKPORT_PCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APM_USI0_USI_IPCLKPORT_IPCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APM_USI0_USI_IPCLKPORT_PCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APM_USI1_UART_IPCLKPORT_IPCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_APM_USI1_UART_IPCLKPORT_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_D_TZPC_APM_IPCLKPORT_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_GPC_APM_IPCLKPORT_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_GREBEINTEGRATION_IPCLKPORT_HCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_INTMEM_IPCLKPORT_ACLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_INTMEM_IPCLKPORT_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_LHM_AXI_G_SWD_IPCLKPORT_I_CLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_LHM_AXI_P_AOCAPM_IPCLKPORT_I_CLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_LHM_AXI_P_APM_IPCLKPORT_I_CLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_LHS_AXI_D_APM_IPCLKPORT_I_CLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_LHS_AXI_G_DBGCORE_IPCLKPORT_I_CLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_LHS_AXI_G_SCAN2DRAM_IPCLKPORT_I_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_MAILBOX_APM_AOC_IPCLKPORT_PCLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_MAILBOX_APM_AP_IPCLKPORT_PCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_MAILBOX_APM_GSA_IPCLKPORT_PCLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_MAILBOX_APM_SWD_IPCLKPORT_PCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_MAILBOX_APM_TPU_IPCLKPORT_PCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_MAILBOX_AP_AOC_IPCLKPORT_PCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_MAILBOX_AP_DBGCORE_IPCLKPORT_PCLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_PMU_INTR_GEN_IPCLKPORT_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_ROM_CRC32_HOST_IPCLKPORT_ACLK: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_ROM_CRC32_HOST_IPCLKPORT_PCLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_RSTNSYNC_CLK_APM_BUS_IPCLKPORT_CLK: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_RSTNSYNC_CLK_APM_USI0_UART_IPCLKPORT_CLK: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_RSTNSYNC_CLK_APM_USI0_USI_IPCLKPORT_CLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_RSTNSYNC_CLK_APM_USI1_UART_IPCLKPORT_CLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SPEEDY_APM_IPCLKPORT_PCLK: c_uint = 0x20a8;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SPEEDY_SUB_APM_IPCLKPORT_PCLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SSMT_D_APM_IPCLKPORT_ACLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SSMT_D_APM_IPCLKPORT_PCLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SSMT_G_DBGCORE_IPCLKPORT_ACLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SSMT_G_DBGCORE_IPCLKPORT_PCLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SS_DBGCORE_IPCLKPORT_SS_DBGCORE_IPCLKPORT_HCLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SYSMMU_D_APM_IPCLKPORT_CLK_S2: c_uint = 0x20c4;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_SYSREG_APM_IPCLKPORT_PCLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_APM_IPCLKPORT_ACLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_APM_IPCLKPORT_PCLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_DBGCORE_IPCLKPORT_ACLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_DBGCORE_IPCLKPORT_PCLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_G_SWD_IPCLKPORT_ACLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_G_SWD_IPCLKPORT_PCLK: c_uint = 0x20e4;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_P_AOCAPM_IPCLKPORT_ACLK: c_uint = 0x20e8;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_P_AOCAPM_IPCLKPORT_PCLK: c_uint = 0x20ec;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_P_APM_IPCLKPORT_ACLK: c_uint = 0x20f0;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_UASC_P_APM_IPCLKPORT_PCLK: c_uint = 0x20f4;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_WDT_APM_IPCLKPORT_PCLK: c_uint = 0x20f8;
pub const CLK_CON_GAT_GOUT_BLK_APM_UID_XIU_DP_APM_IPCLKPORT_ACLK: c_uint = 0x20fc;
pub const PCH_CON_LHM_AXI_G_SWD_PCH: c_uint = 0x3000;
pub const PCH_CON_LHM_AXI_P_AOCAPM_PCH: c_uint = 0x3004;
pub const PCH_CON_LHM_AXI_P_APM_PCH: c_uint = 0x3008;
pub const PCH_CON_LHS_AXI_D_APM_PCH: c_uint = 0x300c;
pub const PCH_CON_LHS_AXI_G_DBGCORE_PCH: c_uint = 0x3010;
pub const PCH_CON_LHS_AXI_G_SCAN2DRAM_PCH: c_uint = 0x3014;
pub const QCH_CON_APBIF_GPIO_ALIVE_QCH: c_uint = 0x3018;
pub const QCH_CON_APBIF_GPIO_FAR_ALIVE_QCH: c_uint = 0x301c;
pub const QCH_CON_APBIF_PMU_ALIVE_QCH: c_uint = 0x3020;
pub const QCH_CON_APBIF_RTC_QCH: c_uint = 0x3024;
pub const QCH_CON_APBIF_TRTC_QCH: c_uint = 0x3028;
pub const QCH_CON_APM_CMU_APM_QCH: c_uint = 0x302c;
pub const QCH_CON_APM_USI0_UART_QCH: c_uint = 0x3030;
pub const QCH_CON_APM_USI0_USI_QCH: c_uint = 0x3034;
pub const QCH_CON_APM_USI1_UART_QCH: c_uint = 0x3038;
pub const QCH_CON_D_TZPC_APM_QCH: c_uint = 0x303c;
pub const QCH_CON_GPC_APM_QCH: c_uint = 0x3040;
pub const QCH_CON_GREBEINTEGRATION_QCH_DBG: c_uint = 0x3044;
pub const QCH_CON_GREBEINTEGRATION_QCH_GREBE: c_uint = 0x3048;
pub const QCH_CON_INTMEM_QCH: c_uint = 0x304c;
pub const QCH_CON_LHM_AXI_G_SWD_QCH: c_uint = 0x3050;
pub const QCH_CON_LHM_AXI_P_AOCAPM_QCH: c_uint = 0x3054;
pub const QCH_CON_LHM_AXI_P_APM_QCH: c_uint = 0x3058;
pub const QCH_CON_LHS_AXI_D_APM_QCH: c_uint = 0x305c;
pub const QCH_CON_LHS_AXI_G_DBGCORE_QCH: c_uint = 0x3060;
pub const QCH_CON_LHS_AXI_G_SCAN2DRAM_QCH: c_uint = 0x3064;
pub const QCH_CON_MAILBOX_APM_AOC_QCH: c_uint = 0x3068;
pub const QCH_CON_MAILBOX_APM_AP_QCH: c_uint = 0x306c;
pub const QCH_CON_MAILBOX_APM_GSA_QCH: c_uint = 0x3070;
pub const QCH_CON_MAILBOX_APM_SWD_QCH: c_uint = 0x3078;
pub const QCH_CON_MAILBOX_APM_TPU_QCH: c_uint = 0x307c;
pub const QCH_CON_MAILBOX_AP_AOC_QCH: c_uint = 0x3080;
pub const QCH_CON_MAILBOX_AP_DBGCORE_QCH: c_uint = 0x3084;
pub const QCH_CON_PMU_INTR_GEN_QCH: c_uint = 0x3088;
pub const QCH_CON_ROM_CRC32_HOST_QCH: c_uint = 0x308c;
pub const QCH_CON_RSTNSYNC_CLK_APM_BUS_QCH_GREBE: c_uint = 0x3090;
pub const QCH_CON_RSTNSYNC_CLK_APM_BUS_QCH_GREBE_DBG: c_uint = 0x3094;
pub const QCH_CON_SPEEDY_APM_QCH: c_uint = 0x3098;
pub const QCH_CON_SPEEDY_SUB_APM_QCH: c_uint = 0x309c;
pub const QCH_CON_SSMT_D_APM_QCH: c_uint = 0x30a0;
pub const QCH_CON_SSMT_G_DBGCORE_QCH: c_uint = 0x30a4;
pub const QCH_CON_SS_DBGCORE_QCH_DBG: c_uint = 0x30a8;
pub const QCH_CON_SS_DBGCORE_QCH_GREBE: c_uint = 0x30ac;
pub const QCH_CON_SYSMMU_D_APM_QCH: c_uint = 0x30b0;
pub const QCH_CON_SYSREG_APM_QCH: c_uint = 0x30b8;
pub const QCH_CON_UASC_APM_QCH: c_uint = 0x30bc;
pub const QCH_CON_UASC_DBGCORE_QCH: c_uint = 0x30c0;
pub const QCH_CON_UASC_G_SWD_QCH: c_uint = 0x30c4;
pub const QCH_CON_UASC_P_AOCAPM_QCH: c_uint = 0x30c8;
pub const QCH_CON_UASC_P_APM_QCH: c_uint = 0x30cc;
pub const QCH_CON_WDT_APM_QCH: c_uint = 0x30d0;
pub const QUEUE_CTRL_REG_BLK_APM_CMU_APM: c_uint = 0x3c00;
    ...
    FRATE(CLK_APM_PLL_DIV2_APM, "pll_alv_div2_apm", core::ptr::null_mut(), 0, 393216000),
    FRATE(CLK_APM_PLL_DIV4_APM, "pll_alv_div4_apm", core::ptr::null_mut(), 0, 196608000),
    FRATE(CLK_APM_PLL_DIV16_APM, "pll_alv_div16_apm", core::ptr::null_mut(), 0, 49152000),
    };
...
pub const PLL_CON0_MUX_CLKCMU_DPU_BUS_USER: c_uint = 0x0600;
pub const PLL_CON1_MUX_CLKCMU_DPU_BUS_USER: c_uint = 0x0604;
pub const DPU_CMU_DPU_CONTROLLER_OPTION: c_uint = 0x0800;
pub const CLKOUT_CON_BLK_DPU_CMU_DPU_CLKOUT0: c_uint = 0x0810;
pub const CLK_CON_DIV_DIV_CLK_DPU_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_CLK_BLK_DPU_UID_DPU_CMU_DPU_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_DPU_UID_RSTNSYNC_CLK_DPU_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2004;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_AD_APB_DPU_DMA_IPCLKPORT_PCLKM: c_uint = 0x2008;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_DPUF_IPCLKPORT_ACLK_DMA: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_DPUF_IPCLKPORT_ACLK_DPP: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_D_TZPC_DPU_IPCLKPORT_PCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_GPC_DPU_IPCLKPORT_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_LHM_AXI_P_DPU_IPCLKPORT_I_CLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_LHS_AXI_D0_DPU_IPCLKPORT_I_CLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_LHS_AXI_D1_DPU_IPCLKPORT_I_CLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_LHS_AXI_D2_DPU_IPCLKPORT_I_CLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_PPMU_DPUD0_IPCLKPORT_ACLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_PPMU_DPUD0_IPCLKPORT_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_PPMU_DPUD1_IPCLKPORT_ACLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_PPMU_DPUD1_IPCLKPORT_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_PPMU_DPUD2_IPCLKPORT_ACLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_PPMU_DPUD2_IPCLKPORT_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_RSTNSYNC_CLK_DPU_BUSD_IPCLKPORT_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_RSTNSYNC_CLK_DPU_BUSP_IPCLKPORT_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SSMT_DPU0_IPCLKPORT_ACLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SSMT_DPU0_IPCLKPORT_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SSMT_DPU1_IPCLKPORT_ACLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SSMT_DPU1_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SSMT_DPU2_IPCLKPORT_ACLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SSMT_DPU2_IPCLKPORT_PCLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SYSMMU_DPUD0_IPCLKPORT_CLK_S1: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SYSMMU_DPUD0_IPCLKPORT_CLK_S2: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SYSMMU_DPUD1_IPCLKPORT_CLK_S1: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SYSMMU_DPUD1_IPCLKPORT_CLK_S2: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SYSMMU_DPUD2_IPCLKPORT_CLK_S1: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SYSMMU_DPUD2_IPCLKPORT_CLK_S2: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_DPU_UID_SYSREG_DPU_IPCLKPORT_PCLK: c_uint = 0x207c;
pub const PCH_CON_LHM_AXI_P_DPU_PCH: c_uint = 0x3000;
pub const PCH_CON_LHS_AXI_D0_DPU_PCH: c_uint = 0x3004;
pub const PCH_CON_LHS_AXI_D1_DPU_PCH: c_uint = 0x3008;
pub const PCH_CON_LHS_AXI_D2_DPU_PCH: c_uint = 0x300c;
pub const QCH_CON_DPUF_QCH_DPU_DMA: c_uint = 0x3010;
pub const QCH_CON_DPUF_QCH_DPU_DPP: c_uint = 0x3014;
pub const QCH_CON_DPU_CMU_DPU_QCH: c_uint = 0x301c;
pub const QCH_CON_D_TZPC_DPU_QCH: c_uint = 0x3020;
pub const QCH_CON_GPC_DPU_QCH: c_uint = 0x3024;
pub const QCH_CON_LHM_AXI_P_DPU_QCH: c_uint = 0x3028;
pub const QCH_CON_LHS_AXI_D0_DPU_QCH: c_uint = 0x302c;
pub const QCH_CON_LHS_AXI_D1_DPU_QCH: c_uint = 0x3030;
pub const QCH_CON_LHS_AXI_D2_DPU_QCH: c_uint = 0x3034;
pub const QCH_CON_PPMU_DPUD0_QCH: c_uint = 0x3038;
pub const QCH_CON_PPMU_DPUD1_QCH: c_uint = 0x303c;
pub const QCH_CON_PPMU_DPUD2_QCH: c_uint = 0x3040;
pub const QCH_CON_SSMT_DPU0_QCH: c_uint = 0x3044;
pub const QCH_CON_SSMT_DPU1_QCH: c_uint = 0x3048;
pub const QCH_CON_SSMT_DPU2_QCH: c_uint = 0x304c;
pub const QCH_CON_SYSMMU_DPUD0_QCH_S1: c_uint = 0x3050;
pub const QCH_CON_SYSMMU_DPUD0_QCH_S2: c_uint = 0x3054;
pub const QCH_CON_SYSMMU_DPUD1_QCH_S1: c_uint = 0x3058;
pub const QCH_CON_SYSMMU_DPUD1_QCH_S2: c_uint = 0x305c;
pub const QCH_CON_SYSMMU_DPUD2_QCH_S1: c_uint = 0x3060;
pub const QCH_CON_SYSMMU_DPUD2_QCH_S2: c_uint = 0x3064;
pub const QCH_CON_SYSREG_DPU_QCH: c_uint = 0x3068;
pub const QUEUE_CTRL_REG_BLK_DPU_CMU_DPU: c_uint = 0x3c00;
...
pub const PLL_LOCKTIME_PLL_USB: c_uint = 0x0004;
pub const PLL_CON0_PLL_USB: c_uint = 0x0140;
pub const PLL_CON1_PLL_USB: c_uint = 0x0144;
pub const PLL_CON2_PLL_USB: c_uint = 0x0148;
pub const PLL_CON3_PLL_USB: c_uint = 0x014c;
pub const PLL_CON4_PLL_USB: c_uint = 0x0150;
pub const PLL_CON0_MUX_CLKCMU_HSI0_ALT_USER: c_uint = 0x0600;
pub const PLL_CON1_MUX_CLKCMU_HSI0_ALT_USER: c_uint = 0x0604;
pub const PLL_CON0_MUX_CLKCMU_HSI0_BUS_USER: c_uint = 0x0610;
pub const PLL_CON1_MUX_CLKCMU_HSI0_BUS_USER: c_uint = 0x0614;
pub const PLL_CON0_MUX_CLKCMU_HSI0_DPGTC_USER: c_uint = 0x0620;
pub const PLL_CON1_MUX_CLKCMU_HSI0_DPGTC_USER: c_uint = 0x0624;
pub const PLL_CON0_MUX_CLKCMU_HSI0_TCXO_USER: c_uint = 0x0630;
pub const PLL_CON1_MUX_CLKCMU_HSI0_TCXO_USER: c_uint = 0x0634;
pub const PLL_CON0_MUX_CLKCMU_HSI0_USB20_USER: c_uint = 0x0640;
pub const PLL_CON1_MUX_CLKCMU_HSI0_USB20_USER: c_uint = 0x0644;
pub const PLL_CON0_MUX_CLKCMU_HSI0_USB31DRD_USER: c_uint = 0x0650;
pub const PLL_CON1_MUX_CLKCMU_HSI0_USB31DRD_USER: c_uint = 0x0654;
pub const PLL_CON0_MUX_CLKCMU_HSI0_USPDPDBG_USER: c_uint = 0x0660;
pub const PLL_CON1_MUX_CLKCMU_HSI0_USPDPDBG_USER: c_uint = 0x0664;
pub const HSI0_CMU_HSI0_CONTROLLER_OPTION: c_uint = 0x0800;
pub const CLKOUT_CON_BLK_HSI0_CMU_HSI0_CLKOUT0: c_uint = 0x0810;
pub const CLK_CON_MUX_MUX_CLK_HSI0_BUS: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_HSI0_USB20_REF: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_HSI0_USB31DRD: c_uint = 0x1008;
pub const CLK_CON_DIV_DIV_CLK_HSI0_USB31DRD: c_uint = 0x1800;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_HSI0_CMU_HSI0_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USB31DRD_SUSPEND_CLK_26: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_HSI0_ALT: c_uint = 0x2008;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_DP_GTC_CLK: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_D_TZPC_HSI0_IPCLKPORT_PCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_ETR_MIU_IPCLKPORT_I_ACLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_ETR_MIU_IPCLKPORT_I_PCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_GPC_HSI0_IPCLKPORT_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_LHM_AXI_G_ETR_HSI0_IPCLKPORT_I_CLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_LHM_AXI_P_AOCHSI0_IPCLKPORT_I_CLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_LHM_AXI_P_HSI0_IPCLKPORT_I_CLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_LHS_ACEL_D_HSI0_IPCLKPORT_I_CLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_LHS_AXI_D_HSI0AOC_IPCLKPORT_I_CLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_PPMU_HSI0_AOC_IPCLKPORT_ACLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_PPMU_HSI0_AOC_IPCLKPORT_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_PPMU_HSI0_BUS0_IPCLKPORT_ACLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_PPMU_HSI0_BUS0_IPCLKPORT_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_RSTNSYNC_CLK_HSI0_BUS_IPCLKPORT_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_SSMT_USB_IPCLKPORT_ACLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_SSMT_USB_IPCLKPORT_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_SYSMMU_USB_IPCLKPORT_CLK_S2: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_SYSREG_HSI0_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_UASC_HSI0_CTRL_IPCLKPORT_ACLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_UASC_HSI0_CTRL_IPCLKPORT_PCLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_UASC_HSI0_LINK_IPCLKPORT_ACLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_UASC_HSI0_LINK_IPCLKPORT_PCLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_ACLK_PHYCTRL: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_BUS_CLK_EARLY: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USB20_PHY_REFCLK_26: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USB31DRD_REF_CLK_40: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USBDPPHY_REF_SOC_PLL: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USBDPPHY_SCL_APB_PCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USBPCS_APB_CLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_USBDPPHY_I_ACLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_USBDPPHY_UDBG_I_APB_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_XIU_D0_HSI0_IPCLKPORT_ACLK: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_XIU_D1_HSI0_IPCLKPORT_ACLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_XIU_P_HSI0_IPCLKPORT_ACLK: c_uint = 0x2098;
pub const DMYQCH_CON_USB31DRD_QCH: c_uint = 0x3000;
pub const DMYQCH_CON_USB31DRD_QCH_REF: c_uint = 0x3004;
pub const PCH_CON_LHM_AXI_G_ETR_HSI0_PCH: c_uint = 0x3008;
pub const PCH_CON_LHM_AXI_P_AOCHSI0_PCH: c_uint = 0x300c;
pub const PCH_CON_LHM_AXI_P_HSI0_PCH: c_uint = 0x3010;
pub const PCH_CON_LHS_ACEL_D_HSI0_PCH: c_uint = 0x3014;
pub const PCH_CON_LHS_AXI_D_HSI0AOC_PCH: c_uint = 0x3018;
pub const QCH_CON_DP_LINK_QCH_GTC_CLK: c_uint = 0x301c;
pub const QCH_CON_DP_LINK_QCH_PCLK: c_uint = 0x3020;
pub const QCH_CON_D_TZPC_HSI0_QCH: c_uint = 0x3024;
pub const QCH_CON_ETR_MIU_QCH_ACLK: c_uint = 0x3028;
pub const QCH_CON_ETR_MIU_QCH_PCLK: c_uint = 0x302c;
pub const QCH_CON_GPC_HSI0_QCH: c_uint = 0x3030;
pub const QCH_CON_HSI0_CMU_HSI0_QCH: c_uint = 0x3034;
pub const QCH_CON_LHM_AXI_G_ETR_HSI0_QCH: c_uint = 0x3038;
pub const QCH_CON_LHM_AXI_P_AOCHSI0_QCH: c_uint = 0x303c;
pub const QCH_CON_LHM_AXI_P_HSI0_QCH: c_uint = 0x3040;
pub const QCH_CON_LHS_ACEL_D_HSI0_QCH: c_uint = 0x3044;
pub const QCH_CON_LHS_AXI_D_HSI0AOC_QCH: c_uint = 0x3048;
pub const QCH_CON_PPMU_HSI0_AOC_QCH: c_uint = 0x304c;
pub const QCH_CON_PPMU_HSI0_BUS0_QCH: c_uint = 0x3050;
pub const QCH_CON_SSMT_USB_QCH: c_uint = 0x3054;
pub const QCH_CON_SYSMMU_USB_QCH: c_uint = 0x3058;
pub const QCH_CON_SYSREG_HSI0_QCH: c_uint = 0x305c;
pub const QCH_CON_UASC_HSI0_CTRL_QCH: c_uint = 0x3060;
pub const QCH_CON_UASC_HSI0_LINK_QCH: c_uint = 0x3064;
pub const QCH_CON_USB31DRD_QCH_APB: c_uint = 0x3068;
pub const QCH_CON_USB31DRD_QCH_DBG: c_uint = 0x306c;
pub const QCH_CON_USB31DRD_QCH_PCS: c_uint = 0x3070;
pub const QCH_CON_USB31DRD_QCH_SLV_CTRL: c_uint = 0x3074;
pub const QCH_CON_USB31DRD_QCH_SLV_LINK: c_uint = 0x3078;
pub const QUEUE_CTRL_REG_BLK_HSI0_CMU_HSI0: c_uint = 0x3c00;
...
// TODO: should have a driver for this
    ...
    FRATE(0, "tcxo_hsi1_hsi0", core::ptr::null_mut(), 0, 26000000),
    FRATE(0, "usb20phy_phy_clock", core::ptr::null_mut(), 0, 120000000),
// until we implement APMGSA
    FRATE(0, "ioclk_clk_hsi0_alt", core::ptr::null_mut(), 0, 213000000),
    };
...
pub const PLL_CON0_MUX_CLKCMU_HSI2_BUS_USER: c_uint = 0x0600;
pub const PLL_CON1_MUX_CLKCMU_HSI2_BUS_USER: c_uint = 0x0604;
pub const PLL_CON0_MUX_CLKCMU_HSI2_MMC_CARD_USER: c_uint = 0x0610;
pub const PLL_CON1_MUX_CLKCMU_HSI2_MMC_CARD_USER: c_uint = 0x0614;
pub const PLL_CON0_MUX_CLKCMU_HSI2_PCIE_USER: c_uint = 0x0620;
pub const PLL_CON1_MUX_CLKCMU_HSI2_PCIE_USER: c_uint = 0x0624;
pub const PLL_CON0_MUX_CLKCMU_HSI2_UFS_EMBD_USER: c_uint = 0x0630;
pub const PLL_CON1_MUX_CLKCMU_HSI2_UFS_EMBD_USER: c_uint = 0x0634;
pub const HSI2_CMU_HSI2_CONTROLLER_OPTION: c_uint = 0x0800;
pub const CLKOUT_CON_BLK_HSI2_CMU_HSI2_CLKOUT0: c_uint = 0x0810;
pub const CLK_CON_GAT_CLK_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_INST_0_PHY_REFCLK_IN: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_004_PCIE_SUB_CTRL_INST_0_PHY_REFCLK_IN: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_HSI2_UID_SSMT_PCIE_IA_GEN4A_1_IPCLKPORT_ACLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_HSI2_UID_SSMT_PCIE_IA_GEN4A_1_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_HSI2_UID_SSMT_PCIE_IA_GEN4B_1_IPCLKPORT_ACLK: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_HSI2_UID_SSMT_PCIE_IA_GEN4B_1_IPCLKPORT_PCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_D_TZPC_HSI2_IPCLKPORT_PCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_GPC_HSI2_IPCLKPORT_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_GPIO_HSI2_IPCLKPORT_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_HSI2_CMU_HSI2_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_LHM_AXI_P_HSI2_IPCLKPORT_I_CLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_LHS_ACEL_D_HSI2_IPCLKPORT_I_CLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_MMC_CARD_IPCLKPORT_I_ACLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_MMC_CARD_IPCLKPORT_SDCLKIN: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_003_G4X2_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_003_G4X2_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_003_G4X2_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_003_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_004_G4X1_DWC_PCIE_CTL_INST_0_DBI_ACLK_UG: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_004_G4X1_DWC_PCIE_CTL_INST_0_MSTR_ACLK_UG: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_004_G4X1_DWC_PCIE_CTL_INST_0_SLV_ACLK_UG: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCIE_004_PCIE_SUB_CTRL_INST_0_I_DRIVER_APB_CLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCS_PMA_INST_0_PHY_UDBG_I_APB_PCLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCS_PMA_INST_0_PIPE_PAL_PCIE_INST_0_I_APB_PCLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_GEN4_1_IPCLKPORT_PCS_PMA_INST_0_SF_PCIEPHY210X2_LN05LPE_QCH_TM_WRAPPER_INST_0_I_APB_PCLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_IA_GEN4A_1_IPCLKPORT_I_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PCIE_IA_GEN4B_1_IPCLKPORT_I_CLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PPMU_HSI2_IPCLKPORT_ACLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_PPMU_HSI2_IPCLKPORT_PCLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_MMC_CARD_HSI2_IPCLKPORT_ACLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_MMC_CARD_HSI2_IPCLKPORT_PCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_PCIE_GEN4A_HSI2_IPCLKPORT_ACLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_PCIE_GEN4A_HSI2_IPCLKPORT_PCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_PCIE_GEN4B_HSI2_IPCLKPORT_ACLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_PCIE_GEN4B_HSI2_IPCLKPORT_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_UFS_EMBD_HSI2_IPCLKPORT_ACLK: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_QE_UFS_EMBD_HSI2_IPCLKPORT_PCLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_RSTNSYNC_CLK_HSI2_BUS_IPCLKPORT_CLK: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_RSTNSYNC_CLK_HSI2_OSCCLK_IPCLKPORT_CLK: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_SSMT_HSI2_IPCLKPORT_ACLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_SSMT_HSI2_IPCLKPORT_PCLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_SYSMMU_HSI2_IPCLKPORT_CLK_S2: c_uint = 0x20a8;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_SYSREG_HSI2_IPCLKPORT_PCLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UASC_PCIE_GEN4A_DBI_1_IPCLKPORT_ACLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UASC_PCIE_GEN4A_DBI_1_IPCLKPORT_PCLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UASC_PCIE_GEN4A_SLV_1_IPCLKPORT_ACLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UASC_PCIE_GEN4A_SLV_1_IPCLKPORT_PCLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UASC_PCIE_GEN4B_DBI_1_IPCLKPORT_ACLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UASC_PCIE_GEN4B_DBI_1_IPCLKPORT_PCLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UASC_PCIE_GEN4B_SLV_1_IPCLKPORT_ACLK: c_uint = 0x20c8;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UASC_PCIE_GEN4B_SLV_1_IPCLKPORT_PCLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_ACLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_CLK_UNIPRO: c_uint = 0x20d4;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_UFS_EMBD_IPCLKPORT_I_FMP_CLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_XIU_D_HSI2_IPCLKPORT_ACLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_GOUT_BLK_HSI2_UID_XIU_P_HSI2_IPCLKPORT_ACLK: c_uint = 0x20e0;
pub const DMYQCH_CON_PCIE_GEN4_1_QCH_SCLK_1: c_uint = 0x3000;
pub const PCH_CON_LHM_AXI_P_HSI2_PCH: c_uint = 0x3008;
pub const PCH_CON_LHS_ACEL_D_HSI2_PCH: c_uint = 0x300c;
pub const QCH_CON_D_TZPC_HSI2_QCH: c_uint = 0x3010;
pub const QCH_CON_GPC_HSI2_QCH: c_uint = 0x3014;
pub const QCH_CON_GPIO_HSI2_QCH: c_uint = 0x3018;
pub const QCH_CON_HSI2_CMU_HSI2_QCH: c_uint = 0x301c;
pub const QCH_CON_LHM_AXI_P_HSI2_QCH: c_uint = 0x3020;
pub const QCH_CON_LHS_ACEL_D_HSI2_QCH: c_uint = 0x3024;
pub const QCH_CON_MMC_CARD_QCH: c_uint = 0x3028;
pub const QCH_CON_PCIE_GEN4_1_QCH_APB_1: c_uint = 0x302c;
pub const QCH_CON_PCIE_GEN4_1_QCH_APB_2: c_uint = 0x3030;
pub const QCH_CON_PCIE_GEN4_1_QCH_AXI_1: c_uint = 0x3034;
pub const QCH_CON_PCIE_GEN4_1_QCH_AXI_2: c_uint = 0x3038;
pub const QCH_CON_PCIE_GEN4_1_QCH_DBG_1: c_uint = 0x303c;
pub const QCH_CON_PCIE_GEN4_1_QCH_DBG_2: c_uint = 0x3040;
pub const QCH_CON_PCIE_GEN4_1_QCH_PCS_APB: c_uint = 0x3044;
pub const QCH_CON_PCIE_GEN4_1_QCH_PMA_APB: c_uint = 0x3048;
pub const QCH_CON_PCIE_GEN4_1_QCH_UDBG: c_uint = 0x304c;
pub const QCH_CON_PCIE_IA_GEN4A_1_QCH: c_uint = 0x3050;
pub const QCH_CON_PCIE_IA_GEN4B_1_QCH: c_uint = 0x3054;
pub const QCH_CON_PPMU_HSI2_QCH: c_uint = 0x3058;
pub const QCH_CON_QE_MMC_CARD_HSI2_QCH: c_uint = 0x305c;
pub const QCH_CON_QE_PCIE_GEN4A_HSI2_QCH: c_uint = 0x3060;
pub const QCH_CON_QE_PCIE_GEN4B_HSI2_QCH: c_uint = 0x3064;
pub const QCH_CON_QE_UFS_EMBD_HSI2_QCH: c_uint = 0x3068;
pub const QCH_CON_SSMT_HSI2_QCH: c_uint = 0x306c;
pub const QCH_CON_SSMT_PCIE_IA_GEN4A_1_QCH: c_uint = 0x3070;
pub const QCH_CON_SSMT_PCIE_IA_GEN4B_1_QCH: c_uint = 0x3074;
pub const QCH_CON_SYSMMU_HSI2_QCH: c_uint = 0x3078;
pub const QCH_CON_SYSREG_HSI2_QCH: c_uint = 0x307c;
pub const QCH_CON_UASC_PCIE_GEN4A_DBI_1_QCH: c_uint = 0x3080;
pub const QCH_CON_UASC_PCIE_GEN4A_SLV_1_QCH: c_uint = 0x3084;
pub const QCH_CON_UASC_PCIE_GEN4B_DBI_1_QCH: c_uint = 0x3088;
pub const QCH_CON_UASC_PCIE_GEN4B_SLV_1_QCH: c_uint = 0x308c;
pub const QCH_CON_UFS_EMBD_QCH: c_uint = 0x3090;
pub const QCH_CON_UFS_EMBD_QCH_FMP: c_uint = 0x3094;
pub const QUEUE_CTRL_REG_BLK_HSI2_CMU_HSI2: c_uint = 0x3c00;
...
pub const PLL_CON0_MUX_CLKCMU_MISC_BUS_USER: c_uint = 0x0600;
pub const PLL_CON1_MUX_CLKCMU_MISC_BUS_USER: c_uint = 0x0604;
pub const PLL_CON0_MUX_CLKCMU_MISC_SSS_USER: c_uint = 0x0610;
pub const PLL_CON1_MUX_CLKCMU_MISC_SSS_USER: c_uint = 0x0614;
pub const MISC_CMU_MISC_CONTROLLER_OPTION: c_uint = 0x0800;
pub const CLKOUT_CON_BLK_MISC_CMU_MISC_CLKOUT0: c_uint = 0x0810;
pub const CLK_CON_MUX_MUX_CLK_MISC_GIC: c_uint = 0x1000;
pub const CLK_CON_DIV_DIV_CLK_MISC_BUSP: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_MISC_GIC: c_uint = 0x1804;
pub const CLK_CON_GAT_CLK_BLK_MISC_UID_MISC_CMU_MISC_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_MISC_UID_OTP_CON_BIRA_IPCLKPORT_I_OSCCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_MISC_UID_OTP_CON_BISR_IPCLKPORT_I_OSCCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_MISC_UID_OTP_CON_TOP_IPCLKPORT_I_OSCCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_MISC_UID_RSTNSYNC_CLK_MISC_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_ADM_AHB_SSS_IPCLKPORT_HCLKM: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_AD_APB_DIT_IPCLKPORT_PCLKM: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_AD_APB_PUF_IPCLKPORT_PCLKM: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_DIT_IPCLKPORT_ICLKL2A: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_D_TZPC_MISC_IPCLKPORT_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_GIC_IPCLKPORT_GICCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_GPC_MISC_IPCLKPORT_PCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_LHM_AST_ICC_CPUGIC_IPCLKPORT_I_CLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_LHM_AXI_D_SSS_IPCLKPORT_I_CLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_LHM_AXI_P_GIC_IPCLKPORT_I_CLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_LHM_AXI_P_MISC_IPCLKPORT_I_CLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_LHS_ACEL_D_MISC_IPCLKPORT_I_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_LHS_AST_IRI_GICCPU_IPCLKPORT_I_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_LHS_AXI_D_SSS_IPCLKPORT_I_CLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_MCT_IPCLKPORT_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_OTP_CON_BIRA_IPCLKPORT_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_OTP_CON_BISR_IPCLKPORT_PCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_OTP_CON_TOP_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_PDMA_IPCLKPORT_ACLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_PPMU_DMA_IPCLKPORT_ACLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_PPMU_MISC_IPCLKPORT_ACLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_PPMU_MISC_IPCLKPORT_PCLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_PUF_IPCLKPORT_I_CLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_DIT_IPCLKPORT_ACLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_DIT_IPCLKPORT_PCLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_PDMA_IPCLKPORT_ACLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_PDMA_IPCLKPORT_PCLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_PPMU_DMA_IPCLKPORT_ACLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_PPMU_DMA_IPCLKPORT_PCLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_RTIC_IPCLKPORT_ACLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_RTIC_IPCLKPORT_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_SPDMA_IPCLKPORT_ACLK: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_SPDMA_IPCLKPORT_PCLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_SSS_IPCLKPORT_ACLK: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_QE_SSS_IPCLKPORT_PCLK: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_RSTNSYNC_CLK_MISC_BUSD_IPCLKPORT_CLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_RSTNSYNC_CLK_MISC_BUSP_IPCLKPORT_CLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_RSTNSYNC_CLK_MISC_GIC_IPCLKPORT_CLK: c_uint = 0x20a8;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_RSTNSYNC_CLK_MISC_SSS_IPCLKPORT_CLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_RTIC_IPCLKPORT_I_ACLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_RTIC_IPCLKPORT_I_PCLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SPDMA_IPCLKPORT_ACLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_DIT_IPCLKPORT_ACLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_DIT_IPCLKPORT_PCLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_PDMA_IPCLKPORT_ACLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_PDMA_IPCLKPORT_PCLK: c_uint = 0x20c8;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_PPMU_DMA_IPCLKPORT_ACLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_PPMU_DMA_IPCLKPORT_PCLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_RTIC_IPCLKPORT_ACLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_RTIC_IPCLKPORT_PCLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_SPDMA_IPCLKPORT_ACLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_SPDMA_IPCLKPORT_PCLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_SSS_IPCLKPORT_ACLK: c_uint = 0x20e4;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSMT_SSS_IPCLKPORT_PCLK: c_uint = 0x20e8;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSS_IPCLKPORT_I_ACLK: c_uint = 0x20ec;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SSS_IPCLKPORT_I_PCLK: c_uint = 0x20f0;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SYSMMU_MISC_IPCLKPORT_CLK_S2: c_uint = 0x20f4;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SYSMMU_SSS_IPCLKPORT_CLK_S1: c_uint = 0x20f8;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_SYSREG_MISC_IPCLKPORT_PCLK: c_uint = 0x20fc;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_TMU_SUB_IPCLKPORT_PCLK: c_uint = 0x2100;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_TMU_TOP_IPCLKPORT_PCLK: c_uint = 0x2104;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_WDT_CLUSTER0_IPCLKPORT_PCLK: c_uint = 0x2108;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_WDT_CLUSTER1_IPCLKPORT_PCLK: c_uint = 0x210c;
pub const CLK_CON_GAT_GOUT_BLK_MISC_UID_XIU_D_MISC_IPCLKPORT_ACLK: c_uint = 0x2110;
pub const DMYQCH_CON_PPMU_DMA_QCH: c_uint = 0x3000;
pub const DMYQCH_CON_PUF_QCH: c_uint = 0x3004;
pub const PCH_CON_LHM_AXI_D_SSS_PCH: c_uint = 0x300c;
pub const PCH_CON_LHM_AXI_P_GIC_PCH: c_uint = 0x3010;
pub const PCH_CON_LHM_AXI_P_MISC_PCH: c_uint = 0x3014;
pub const PCH_CON_LHS_ACEL_D_MISC_PCH: c_uint = 0x3018;
pub const PCH_CON_LHS_AST_IRI_GICCPU_PCH: c_uint = 0x301c;
pub const PCH_CON_LHS_AXI_D_SSS_PCH: c_uint = 0x3020;
pub const QCH_CON_ADM_AHB_SSS_QCH: c_uint = 0x3024;
pub const QCH_CON_DIT_QCH: c_uint = 0x3028;
pub const QCH_CON_GIC_QCH: c_uint = 0x3030;
pub const QCH_CON_LHM_AST_ICC_CPUGIC_QCH: c_uint = 0x3038;
pub const QCH_CON_LHM_AXI_D_SSS_QCH: c_uint = 0x303c;
pub const QCH_CON_LHM_AXI_P_GIC_QCH: c_uint = 0x3040;
pub const QCH_CON_LHM_AXI_P_MISC_QCH: c_uint = 0x3044;
pub const QCH_CON_LHS_ACEL_D_MISC_QCH: c_uint = 0x3048;
pub const QCH_CON_LHS_AST_IRI_GICCPU_QCH: c_uint = 0x304c;
pub const QCH_CON_LHS_AXI_D_SSS_QCH: c_uint = 0x3050;
pub const QCH_CON_MCT_QCH: c_uint = 0x3054;
pub const QCH_CON_MISC_CMU_MISC_QCH: c_uint = 0x3058;
pub const QCH_CON_OTP_CON_BIRA_QCH: c_uint = 0x305c;
pub const QCH_CON_OTP_CON_BISR_QCH: c_uint = 0x3060;
pub const QCH_CON_OTP_CON_TOP_QCH: c_uint = 0x3064;
pub const QCH_CON_PDMA_QCH: c_uint = 0x3068;
pub const QCH_CON_PPMU_MISC_QCH: c_uint = 0x306c;
pub const QCH_CON_QE_DIT_QCH: c_uint = 0x3070;
pub const QCH_CON_QE_PDMA_QCH: c_uint = 0x3074;
pub const QCH_CON_QE_PPMU_DMA_QCH: c_uint = 0x3078;
pub const QCH_CON_QE_RTIC_QCH: c_uint = 0x307c;
pub const QCH_CON_QE_SPDMA_QCH: c_uint = 0x3080;
pub const QCH_CON_QE_SSS_QCH: c_uint = 0x3084;
pub const QCH_CON_RTIC_QCH: c_uint = 0x3088;
pub const QCH_CON_SPDMA_QCH: c_uint = 0x308c;
pub const QCH_CON_SSMT_DIT_QCH: c_uint = 0x3090;
pub const QCH_CON_SSMT_PDMA_QCH: c_uint = 0x3094;
pub const QCH_CON_SSMT_PPMU_DMA_QCH: c_uint = 0x3098;
pub const QCH_CON_SSMT_RTIC_QCH: c_uint = 0x309c;
pub const QCH_CON_SSMT_SPDMA_QCH: c_uint = 0x30a0;
pub const QCH_CON_SSMT_SSS_QCH: c_uint = 0x30a4;
pub const QCH_CON_SSS_QCH: c_uint = 0x30a8;
pub const QCH_CON_SYSMMU_MISC_QCH: c_uint = 0x30ac;
pub const QCH_CON_SYSMMU_SSS_QCH: c_uint = 0x30b0;
pub const QCH_CON_SYSREG_MISC_QCH: c_uint = 0x30b4;
pub const QCH_CON_TMU_SUB_QCH: c_uint = 0x30b8;
pub const QCH_CON_TMU_TOP_QCH: c_uint = 0x30bc;
pub const QCH_CON_WDT_CLUSTER0_QCH: c_uint = 0x30c0;
pub const QCH_CON_WDT_CLUSTER1_QCH: c_uint = 0x30c4;
pub const QUEUE_CTRL_REG_BLK_MISC_CMU_MISC: c_uint = 0x3c00;
...
#[no_mangle]
unsafe extern "C" fn gs101_cmu_misc_init(np: *mut device_node) -> void __init {
    static void __init gs101_cmu_misc_init(struct device_node *np)
    {
    exynos_arm64_register_cmu(core::ptr::null_mut(), np, &misc_cmu_info);
    }
...
pub const PLL_CON0_MUX_CLKCMU_PERIC0_BUS_USER: c_uint = 0x0600;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_BUS_USER: c_uint = 0x0604;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_I3C_USER: c_uint = 0x0610;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_I3C_USER: c_uint = 0x0614;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI0_UART_USER: c_uint = 0x0620;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI0_UART_USER: c_uint = 0x0624;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI14_USI_USER: c_uint = 0x0640;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI14_USI_USER: c_uint = 0x0644;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI1_USI_USER: c_uint = 0x0650;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI1_USI_USER: c_uint = 0x0654;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI2_USI_USER: c_uint = 0x0660;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI2_USI_USER: c_uint = 0x0664;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI3_USI_USER: c_uint = 0x0670;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI3_USI_USER: c_uint = 0x0674;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI4_USI_USER: c_uint = 0x0680;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI4_USI_USER: c_uint = 0x0684;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI5_USI_USER: c_uint = 0x0690;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI5_USI_USER: c_uint = 0x0694;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI6_USI_USER: c_uint = 0x06a0;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI6_USI_USER: c_uint = 0x06a4;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI7_USI_USER: c_uint = 0x06b0;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI7_USI_USER: c_uint = 0x06b4;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI8_USI_USER: c_uint = 0x06c0;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI8_USI_USER: c_uint = 0x06c4;
pub const PERIC0_CMU_PERIC0_CONTROLLER_OPTION: c_uint = 0x0800;
pub const CLKOUT_CON_BLK_PERIC0_CMU_PERIC0_CLKOUT0: c_uint = 0x0810;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_I3C: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI0_UART: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI14_USI: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI1_USI: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI2_USI: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI3_USI: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI4_USI: c_uint = 0x1824;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI5_USI: c_uint = 0x1828;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI6_USI: c_uint = 0x182c;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI7_USI: c_uint = 0x1830;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI8_USI: c_uint = 0x1834;
pub const CLK_CON_BUF_CLKBUF_PERIC0_IP: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_PERIC0_CMU_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2008;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_D_TZPC_PERIC0_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_GPC_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_GPIO_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_LHM_AXI_P_PERIC0_IPCLKPORT_I_CLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_0: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_1: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_10: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_11: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_12: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_13: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_14: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_15: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_2: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_3: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_4: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_5: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_6: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_7: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_8: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_9: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_0: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_1: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_10: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_11: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_12: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_13: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_14: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_15: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_2: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_3: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_4: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_5: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_6: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_7: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_8: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_9: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_0: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_2: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_0: c_uint = 0x20a8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_2: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_BUSP_IPCLKPORT_CLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_I3C_IPCLKPORT_CLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI0_UART_IPCLKPORT_CLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI14_USI_IPCLKPORT_CLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI1_USI_IPCLKPORT_CLK: c_uint = 0x20c8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI2_USI_IPCLKPORT_CLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI3_USI_IPCLKPORT_CLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI4_USI_IPCLKPORT_CLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI5_USI_IPCLKPORT_CLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI6_USI_IPCLKPORT_CLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI7_USI_IPCLKPORT_CLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI8_USI_IPCLKPORT_CLK: c_uint = 0x20e4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_SYSREG_PERIC0_IPCLKPORT_PCLK: c_uint = 0x20e8;
pub const DMYQCH_CON_PERIC0_TOP0_QCH_S1: c_uint = 0x3000;
pub const DMYQCH_CON_PERIC0_TOP0_QCH_S2: c_uint = 0x3004;
pub const DMYQCH_CON_PERIC0_TOP0_QCH_S3: c_uint = 0x3008;
pub const DMYQCH_CON_PERIC0_TOP0_QCH_S4: c_uint = 0x300c;
pub const DMYQCH_CON_PERIC0_TOP0_QCH_S5: c_uint = 0x3010;
pub const DMYQCH_CON_PERIC0_TOP0_QCH_S6: c_uint = 0x3014;
pub const DMYQCH_CON_PERIC0_TOP0_QCH_S7: c_uint = 0x3018;
pub const DMYQCH_CON_PERIC0_TOP0_QCH_S8: c_uint = 0x301c;
pub const PCH_CON_LHM_AXI_P_PERIC0_PCH: c_uint = 0x3020;
pub const QCH_CON_D_TZPC_PERIC0_QCH: c_uint = 0x3024;
pub const QCH_CON_GPC_PERIC0_QCH: c_uint = 0x3028;
pub const QCH_CON_GPIO_PERIC0_QCH: c_uint = 0x302c;
pub const QCH_CON_LHM_AXI_P_PERIC0_QCH: c_uint = 0x3030;
pub const QCH_CON_PERIC0_CMU_PERIC0_QCH: c_uint = 0x3034;
pub const QCH_CON_PERIC0_TOP0_QCH_I3C1: c_uint = 0x3038;
pub const QCH_CON_PERIC0_TOP0_QCH_I3C2: c_uint = 0x303c;
pub const QCH_CON_PERIC0_TOP0_QCH_I3C3: c_uint = 0x3040;
pub const QCH_CON_PERIC0_TOP0_QCH_I3C4: c_uint = 0x3044;
pub const QCH_CON_PERIC0_TOP0_QCH_I3C5: c_uint = 0x3048;
pub const QCH_CON_PERIC0_TOP0_QCH_I3C6: c_uint = 0x304c;
pub const QCH_CON_PERIC0_TOP0_QCH_I3C7: c_uint = 0x3050;
pub const QCH_CON_PERIC0_TOP0_QCH_I3C8: c_uint = 0x3054;
pub const QCH_CON_PERIC0_TOP0_QCH_USI1_USI: c_uint = 0x3058;
pub const QCH_CON_PERIC0_TOP0_QCH_USI2_USI: c_uint = 0x305c;
pub const QCH_CON_PERIC0_TOP0_QCH_USI3_USI: c_uint = 0x3060;
pub const QCH_CON_PERIC0_TOP0_QCH_USI4_USI: c_uint = 0x3064;
pub const QCH_CON_PERIC0_TOP0_QCH_USI5_USI: c_uint = 0x3068;
pub const QCH_CON_PERIC0_TOP0_QCH_USI6_USI: c_uint = 0x306c;
pub const QCH_CON_PERIC0_TOP0_QCH_USI7_USI: c_uint = 0x3070;
pub const QCH_CON_PERIC0_TOP0_QCH_USI8_USI: c_uint = 0x3074;
pub const QCH_CON_PERIC0_TOP1_QCH_USI0_UART: c_uint = 0x3078;
pub const QCH_CON_PERIC0_TOP1_QCH_USI14_UART: c_uint = 0x307c;
pub const QCH_CON_SYSREG_PERIC0_QCH: c_uint = 0x3080;
pub const QUEUE_CTRL_REG_BLK_PERIC0_CMU_PERIC0: c_uint = 0x3c00;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC1_BUS_USER: c_uint = 0x0600;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_BUS_USER: c_uint = 0x0604;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_I3C_USER: c_uint = 0x0610;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_I3C_USER: c_uint = 0x0614;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI0_USI_USER: c_uint = 0x0620;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI0_USI_USER: c_uint = 0x0624;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI10_USI_USER: c_uint = 0x0630;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI10_USI_USER: c_uint = 0x0634;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI11_USI_USER: c_uint = 0x0640;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI11_USI_USER: c_uint = 0x0644;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI12_USI_USER: c_uint = 0x0650;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI12_USI_USER: c_uint = 0x0654;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI13_USI_USER: c_uint = 0x0660;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI13_USI_USER: c_uint = 0x0664;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI9_USI_USER: c_uint = 0x0670;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI9_USI_USER: c_uint = 0x0674;
pub const PERIC1_CMU_PERIC1_CONTROLLER_OPTION: c_uint = 0x0800;
pub const CLKOUT_CON_BLK_PERIC1_CMU_PERIC1_CLKOUT0: c_uint = 0x0810;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_I3C: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI0_USI: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI10_USI: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI11_USI: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI12_USI: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI13_USI: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI9_USI: c_uint = 0x1818;
pub const CLK_CON_BUF_CLKBUF_PERIC1_IP: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_CMU_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_I3C_IPCLKPORT_CLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_OSCCLK_IPCLKPORT_CLK: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_D_TZPC_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_GPC_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_GPIO_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_LHM_AXI_P_PERIC1_IPCLKPORT_I_CLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_1: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_2: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_3: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_4: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_5: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_6: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_8: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_1: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_15: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_2: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_3: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_4: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_5: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_6: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_8: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_BUSP_IPCLKPORT_CLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI0_USI_IPCLKPORT_CLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI10_USI_IPCLKPORT_CLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI11_USI_IPCLKPORT_CLK: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI12_USI_IPCLKPORT_CLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI13_USI_IPCLKPORT_CLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI9_USI_IPCLKPORT_CLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SYSREG_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2078;
pub const DMYQCH_CON_PERIC1_TOP0_QCH_S: c_uint = 0x3000;
pub const PCH_CON_LHM_AXI_P_PERIC1_PCH: c_uint = 0x3004;
pub const QCH_CON_D_TZPC_PERIC1_QCH: c_uint = 0x3008;
pub const QCH_CON_GPC_PERIC1_QCH: c_uint = 0x300c;
pub const QCH_CON_GPIO_PERIC1_QCH: c_uint = 0x3010;
pub const QCH_CON_LHM_AXI_P_PERIC1_QCH: c_uint = 0x3014;
pub const QCH_CON_PERIC1_CMU_PERIC1_QCH: c_uint = 0x3018;
pub const QCH_CON_PERIC1_TOP0_QCH_I3C0: c_uint = 0x301c;
pub const QCH_CON_PERIC1_TOP0_QCH_PWM: c_uint = 0x3020;
pub const QCH_CON_PERIC1_TOP0_QCH_USI0_USI: c_uint = 0x3024;
pub const QCH_CON_PERIC1_TOP0_QCH_USI10_USI: c_uint = 0x3028;
pub const QCH_CON_PERIC1_TOP0_QCH_USI11_USI: c_uint = 0x302c;
pub const QCH_CON_PERIC1_TOP0_QCH_USI12_USI: c_uint = 0x3030;
pub const QCH_CON_PERIC1_TOP0_QCH_USI13_USI: c_uint = 0x3034;
pub const QCH_CON_PERIC1_TOP0_QCH_USI9_USI: c_uint = 0x3038;
pub const QCH_CON_SYSREG_PERIC1_QCH: c_uint = 0x303c;
pub const QUEUE_CTRL_REG_BLK_PERIC1_CMU_PERIC1: c_uint = 0x3c00;
...
// ---- platform_driver -----------------------------------------------------
#[no_mangle]
unsafe extern "C" fn gs101_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gs101_cmu_init() -> int __init {
