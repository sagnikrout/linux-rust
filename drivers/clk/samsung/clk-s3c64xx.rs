...
//! Source: drivers/clk/samsung/clk-s3c64xx.c
#![no_std]
...
pub const APLL_LOCK: c_uint = 0x000;
pub const MPLL_LOCK: c_uint = 0x004;
pub const EPLL_LOCK: c_uint = 0x008;
pub const APLL_CON: c_uint = 0x00c;
pub const MPLL_CON: c_uint = 0x010;
pub const EPLL_CON0: c_uint = 0x014;
pub const EPLL_CON1: c_uint = 0x018;
pub const CLK_SRC: c_uint = 0x01c;
pub const CLK_DIV0: c_uint = 0x020;
pub const CLK_DIV1: c_uint = 0x024;
pub const CLK_DIV2: c_uint = 0x028;
pub const HCLK_GATE: c_uint = 0x030;
pub const PCLK_GATE: c_uint = 0x034;
pub const SCLK_GATE: c_uint = 0x038;
pub const MEM0_GATE: c_uint = 0x03c;
pub const CLK_SRC2: c_uint = 0x10c;
pub const OTHERS: c_uint = 0x900;
...
// Fixed rate clocks generated outside the SoC.
    ...
    FRATE(0, "fin_pll", core::ptr::null_mut(), 0, 0),
    FRATE(0, "xusbxti", core::ptr::null_mut(), 0, 0),
    };
// Fixed rate clocks generated inside the SoC.
    FIXED_RATE_CLOCKS(s3c64xx_fixed_rate_clks) __initdata = {
    FRATE(CLK27M, "clk27m", core::ptr::null_mut(), 0, 27000000),
    FRATE(CLK48M, "clk48m", core::ptr::null_mut(), 0, 48000000),
    };
...
// List of PLL clocks.
    ...
    APLL_LOCK, APLL_CON, core::ptr::null_mut()),
...
// Aliases for common s3c64xx clocks.
    ...
    ALIAS(FOUT_APLL, core::ptr::null_mut(), "fout_apll"),
    ALIAS(FOUT_MPLL, core::ptr::null_mut(), "fout_mpll"),
    ALIAS(FOUT_EPLL, core::ptr::null_mut(), "fout_epll"),
    ALIAS(MOUT_EPLL, core::ptr::null_mut(), "mout_epll"),
    ALIAS(DOUT_MPLL, core::ptr::null_mut(), "dout_mpll"),
    ALIAS(HCLKX2, core::ptr::null_mut(), "hclk2"),
    ALIAS(HCLK, core::ptr::null_mut(), "hclk"),
    ALIAS(PCLK, core::ptr::null_mut(), "pclk"),
    ALIAS(PCLK, core::ptr::null_mut(), "clk_uart_baud2"),
    ALIAS(ARMCLK, core::ptr::null_mut(), "armclk"),
    ...
    ALIAS(PCLK_PWM, core::ptr::null_mut(), "timers"),
    ALIAS(PCLK_RTC, "s3c64xx-rtc", "rtc"),
    ALIAS(PCLK_WDT, core::ptr::null_mut(), "watchdog"),
    ...
    ALIAS(SCLK_UART, core::ptr::null_mut(), "clk_uart_baud3"),
...
// Aliases for s3c6410-specific clocks.
    ...
    ALIAS(MEM0_SROM, core::ptr::null_mut(), "srom"),
    };
...
// Register SoC-specific clocks.
    ...
    samsung_clk_sleep_init(reg_base, core::ptr::null_mut(), s3c64xx_clk_regs,
    ARRAY_SIZE(s3c64xx_clk_regs));
    if (!is_s3c6400)
    samsung_clk_sleep_init(reg_base, core::ptr::null_mut(), s3c6410_clk_regs,
...
#[no_mangle]
unsafe extern "C" fn s3c6400_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn s3c6410_clk_init(np: *mut device_node) -> void __init {
