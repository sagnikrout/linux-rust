...
//! Source: drivers/clk/samsung/clk-exynosautov9.c
#![no_std]
...
pub const PLL_CON0_PLL_SHARED4: c_uint = 0x0200;
pub const PLL_CON3_PLL_SHARED4: c_uint = 0x020c;
// MUX
pub const CLK_CON_MUX_MUX_CLKCMU_ACC_BUS: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLKCMU_APM_BUS: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_BUS: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_CPU: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLKCMU_BUSC_BUS: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLKCMU_BUSMC_BUS: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_BUS: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_CLUSTER: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_SWITCH: c_uint = 0x102c;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL1_CLUSTER: c_uint = 0x1030;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH: c_uint = 0x1034;
pub const CLK_CON_MUX_MUX_CLKCMU_DPTX_BUS: c_uint = 0x1040;
pub const CLK_CON_MUX_MUX_CLKCMU_DPTX_DPGTC: c_uint = 0x1044;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUM_BUS: c_uint = 0x1048;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUS0_BUS: c_uint = 0x104c;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUS1_BUS: c_uint = 0x1050;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS0_BUS: c_uint = 0x1054;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS0_PCIE: c_uint = 0x1058;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS1_BUS: c_uint = 0x105c;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS1_MMC_CARD: c_uint = 0x1060;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS1_USBDRD: c_uint = 0x1064;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS2_BUS: c_uint = 0x1068;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS2_ETHERNET: c_uint = 0x106c;
pub const CLK_CON_MUX_MUX_CLKCMU_FSYS2_UFS_EMBD: c_uint = 0x1070;
pub const CLK_CON_MUX_MUX_CLKCMU_G2D_G2D: c_uint = 0x1074;
pub const CLK_CON_MUX_MUX_CLKCMU_G2D_MSCL: c_uint = 0x1078;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D00_SWITCH: c_uint = 0x107c;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D01_SWITCH: c_uint = 0x1080;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D1_SWITCH: c_uint = 0x1084;
pub const CLK_CON_MUX_MUX_CLKCMU_ISPB_BUS: c_uint = 0x108c;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC_MFC: c_uint = 0x1090;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC_WFD: c_uint = 0x1094;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x109c;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_BUSP: c_uint = 0x1098;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x109c;
pub const CLK_CON_MUX_MUX_CLKCMU_NPU_BUS: c_uint = 0x10a0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_BUS: c_uint = 0x10a4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_IP: c_uint = 0x10a8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_BUS: c_uint = 0x10ac;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_IP: c_uint = 0x10b0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIS_BUS: c_uint = 0x10b4;
pub const CLK_CON_MUX_MUX_CMU_CMUREF: c_uint = 0x10c0;
// DIV
pub const CLK_CON_DIV_CLKCMU_ACC_BUS: c_uint = 0x1800;
pub const CLK_CON_DIV_CLKCMU_APM_BUS: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKCMU_AUD_BUS: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKCMU_AUD_CPU: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_BUSC_BUS: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_BUSMC_BUS: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKCMU_CORE_BUS: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_CLUSTER: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1828;
pub const CLK_CON_DIV_CLKCMU_CPUCL1_CLUSTER: c_uint = 0x182c;
pub const CLK_CON_DIV_CLKCMU_CPUCL1_SWITCH: c_uint = 0x1830;
pub const CLK_CON_DIV_CLKCMU_DPTX_BUS: c_uint = 0x183c;
pub const CLK_CON_DIV_CLKCMU_DPTX_DPGTC: c_uint = 0x1840;
pub const CLK_CON_DIV_CLKCMU_DPUM_BUS: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_DPUS0_BUS: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_DPUS1_BUS: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_FSYS0_BUS: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_FSYS0_PCIE: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_FSYS1_BUS: c_uint = 0x1858;
pub const CLK_CON_DIV_CLKCMU_FSYS1_USBDRD: c_uint = 0x185c;
pub const CLK_CON_DIV_CLKCMU_FSYS2_BUS: c_uint = 0x1860;
pub const CLK_CON_DIV_CLKCMU_FSYS2_ETHERNET: c_uint = 0x1864;
pub const CLK_CON_DIV_CLKCMU_FSYS2_UFS_EMBD: c_uint = 0x1868;
pub const CLK_CON_DIV_CLKCMU_G2D_G2D: c_uint = 0x186c;
pub const CLK_CON_DIV_CLKCMU_G2D_MSCL: c_uint = 0x1870;
pub const CLK_CON_DIV_CLKCMU_G3D00_SWITCH: c_uint = 0x1874;
pub const CLK_CON_DIV_CLKCMU_G3D01_SWITCH: c_uint = 0x1878;
pub const CLK_CON_DIV_CLKCMU_G3D1_SWITCH: c_uint = 0x187c;
pub const CLK_CON_DIV_CLKCMU_ISPB_BUS: c_uint = 0x1884;
pub const CLK_CON_DIV_CLKCMU_MFC_MFC: c_uint = 0x1888;
pub const CLK_CON_DIV_CLKCMU_MFC_WFD: c_uint = 0x188c;
pub const CLK_CON_DIV_CLKCMU_MIF_BUSP: c_uint = 0x1890;
pub const CLK_CON_DIV_CLKCMU_NPU_BUS: c_uint = 0x1894;
pub const CLK_CON_DIV_CLKCMU_PERIC0_BUS: c_uint = 0x1898;
pub const CLK_CON_DIV_CLKCMU_PERIC0_IP: c_uint = 0x189c;
pub const CLK_CON_DIV_CLKCMU_PERIC1_BUS: c_uint = 0x18a0;
pub const CLK_CON_DIV_CLKCMU_PERIC1_IP: c_uint = 0x18a4;
pub const CLK_CON_DIV_CLKCMU_PERIS_BUS: c_uint = 0x18a8;
pub const CLK_CON_DIV_DIV_CLKCMU_CMU_BOOST: c_uint = 0x18b4;
pub const CLK_CON_DIV_PLL_SHARED0_DIV2: c_uint = 0x18b8;
pub const CLK_CON_DIV_PLL_SHARED0_DIV3: c_uint = 0x18bc;
pub const CLK_CON_DIV_PLL_SHARED1_DIV2: c_uint = 0x18c0;
pub const CLK_CON_DIV_PLL_SHARED1_DIV3: c_uint = 0x18c4;
pub const CLK_CON_DIV_PLL_SHARED1_DIV4: c_uint = 0x18c8;
pub const CLK_CON_DIV_PLL_SHARED2_DIV2: c_uint = 0x18cc;
pub const CLK_CON_DIV_PLL_SHARED2_DIV3: c_uint = 0x18d0;
pub const CLK_CON_DIV_PLL_SHARED2_DIV4: c_uint = 0x18d4;
pub const CLK_CON_DIV_PLL_SHARED4_DIV2: c_uint = 0x18d4;
pub const CLK_CON_DIV_PLL_SHARED4_DIV4: c_uint = 0x18d8;
// GATE
pub const CLK_CON_GAT_CLKCMU_CMU_BUSC_BOOST: c_uint = 0x2000;
pub const CLK_CON_GAT_CLKCMU_CMU_BUSMC_BOOST: c_uint = 0x2004;
pub const CLK_CON_GAT_CLKCMU_CMU_CORE_BOOST: c_uint = 0x2008;
pub const CLK_CON_GAT_CLKCMU_CMU_CPUCL0_BOOST: c_uint = 0x2010;
pub const CLK_CON_GAT_CLKCMU_CMU_CPUCL1_BOOST: c_uint = 0x2018;
pub const CLK_CON_GAT_CLKCMU_CMU_MIF_BOOST: c_uint = 0x2020;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS1_MMC_CARD: c_uint = 0x2024;
pub const CLK_CON_GAT_GATE_CLKCMU_MIF_SWITCH: c_uint = 0x2028;
pub const CLK_CON_GAT_GATE_CLKCMU_ACC_BUS: c_uint = 0x202c;
pub const CLK_CON_GAT_GATE_CLKCMU_APM_BUS: c_uint = 0x2030;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_BUS: c_uint = 0x2034;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_CPU: c_uint = 0x2038;
pub const CLK_CON_GAT_GATE_CLKCMU_BUSC_BUS: c_uint = 0x203c;
pub const CLK_CON_GAT_GATE_CLKCMU_BUSMC_BUS: c_uint = 0x2044;
pub const CLK_CON_GAT_GATE_CLKCMU_CMU_BOOST: c_uint = 0x2048;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_BUS: c_uint = 0x204c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_CLUSTER: c_uint = 0x2050;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_SWITCH: c_uint = 0x2058;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_CLUSTER: c_uint = 0x205c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH: c_uint = 0x2060;
pub const CLK_CON_GAT_GATE_CLKCMU_DPTX_BUS: c_uint = 0x206c;
pub const CLK_CON_GAT_GATE_CLKCMU_DPTX_DPGTC: c_uint = 0x2070;
pub const CLK_CON_GAT_GATE_CLKCMU_DPUM_BUS: c_uint = 0x2060;
pub const CLK_CON_GAT_GATE_CLKCMU_DPUS0_BUS: c_uint = 0x2064;
pub const CLK_CON_GAT_GATE_CLKCMU_DPUS1_BUS: c_uint = 0x207c;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS0_BUS: c_uint = 0x2080;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS0_PCIE: c_uint = 0x2084;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS1_BUS: c_uint = 0x2088;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS1_USBDRD: c_uint = 0x208c;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS2_BUS: c_uint = 0x2090;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS2_ETHERNET: c_uint = 0x2094;
pub const CLK_CON_GAT_GATE_CLKCMU_FSYS2_UFS_EMBD: c_uint = 0x2098;
pub const CLK_CON_GAT_GATE_CLKCMU_G2D_G2D: c_uint = 0x209c;
pub const CLK_CON_GAT_GATE_CLKCMU_G2D_MSCL: c_uint = 0x20a0;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D00_SWITCH: c_uint = 0x20a4;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D01_SWITCH: c_uint = 0x20a8;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D1_SWITCH: c_uint = 0x20ac;
pub const CLK_CON_GAT_GATE_CLKCMU_ISPB_BUS: c_uint = 0x20b4;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC_MFC: c_uint = 0x20b8;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC_WFD: c_uint = 0x20bc;
pub const CLK_CON_GAT_GATE_CLKCMU_MIF_BUSP: c_uint = 0x20c0;
pub const CLK_CON_GAT_GATE_CLKCMU_NPU_BUS: c_uint = 0x20c4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_BUS: c_uint = 0x20c8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_IP: c_uint = 0x20cc;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_BUS: c_uint = 0x20d0;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_IP: c_uint = 0x20d4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIS_BUS: c_uint = 0x20d8;
...
#[no_mangle]
unsafe extern "C" fn exynosautov9_cmu_top_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_BUSMC_BUS_USER: c_uint = 0x0600;
pub const CLK_CON_DIV_DIV_CLK_BUSMC_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_GOUT_BLK_BUSMC_UID_QE_PDMA0_IPCLKPORT_PCLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_BUSMC_UID_QE_SPDMA_IPCLKPORT_PCLK: c_uint = 0x2080;
...
pub const PLL_CON0_MUX_CLKCMU_CORE_BUS_USER: c_uint = 0x0600;
pub const CLK_CON_MUX_MUX_CORE_CMUREF: c_uint = 0x1000;
pub const CLK_CON_DIV_DIV_CLK_CORE_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_CLK_BLK_CORE_UID_CCI_IPCLKPORT_CLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_CORE_UID_CCI_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_CORE_UID_CORE_CMU_CORE_IPCLKPORT_PCLK: c_uint = 0x2008;
...
pub const PLL_CON0_MUX_CLKCMU_DPUM_BUS_USER: c_uint = 0x0600;
pub const CLK_CON_DIV_DIV_CLK_DPUM_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_GOUT_BLK_DPUM_UID_DPUM_IPCLKPORT_ACLK_DECON: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_DPUM_UID_DPUM_IPCLKPORT_ACLK_DMA: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_DPUM_UID_DPUM_IPCLKPORT_ACLK_DPP: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_DPUM_UID_SYSMMU_D0_DPUM_IPCLKPORT_CLK_S1: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_DPUM_UID_SYSMMU_D1_DPUM_IPCLKPORT_CLK_S1: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_DPUM_UID_SYSMMU_D2_DPUM_IPCLKPORT_CLK_S1: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_DPUM_UID_SYSMMU_D3_DPUM_IPCLKPORT_CLK_S1: c_uint = 0x2094;
...
pub const PLL_CON0_MUX_CLKCMU_FSYS0_BUS_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_FSYS0_PCIE_USER: c_uint = 0x0610;
pub const CLK_CON_GAT_CLK_BLK_FSYS0_UID_FSYS0_CMU_FSYS0_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_2L0_X1_PHY_REFCLK_IN: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_PHY_REFCLK_IN: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_2L1_X1_PHY_REFCLK_IN: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_PHY_REFCLK_IN: c_uint = 0x2010;
pub const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_4L_X2_PHY_REFCLK_IN: c_uint = 0x2014;
pub const CLK_CON_GAT_CLK_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_PHY_REFCLK_IN: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X1_DBI_ACLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X1_MSTR_ACLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X1_SLV_ACLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_DBI_ACLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_MSTR_ACLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_SLV_ACLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L0_X2_PIPE_CLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X1_DBI_ACLK: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X1_MSTR_ACLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X1_SLV_ACLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_DBI_ACLK: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_MSTR_ACLK: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_SLV_ACLK: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_2L1_X2_PIPE_CLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X2_DBI_ACLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X2_MSTR_ACLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X2_SLV_ACLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_DBI_ACLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_MSTR_ACLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_SLV_ACLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3_4L_X4_PIPE_CLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3A_2L0_CLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3A_2L1_CLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3A_4L_CLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3B_2L0_CLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3B_2L1_CLK: c_uint = 0x20e4;
pub const CLK_CON_GAT_GOUT_BLK_FSYS0_UID_PCIE_GEN3B_4L_CLK: c_uint = 0x20e8;
...
pub const PLL_LOCKTIME_PLL_MMC: c_uint = 0x0000;
pub const PLL_CON0_PLL_MMC: c_uint = 0x0100;
pub const PLL_CON3_PLL_MMC: c_uint = 0x010c;
pub const PLL_CON0_MUX_CLKCMU_FSYS1_BUS_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_FSYS1_MMC_CARD_USER: c_uint = 0x0610;
pub const PLL_CON0_MUX_CLKCMU_FSYS1_USBDRD_USER: c_uint = 0x0620;
pub const CLK_CON_MUX_MUX_CLK_FSYS1_MMC_CARD: c_uint = 0x1000;
pub const CLK_CON_DIV_DIV_CLK_FSYS1_MMC_CARD: c_uint = 0x1800;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_FSYS1_CMU_FSYS1_IPCLKPORT_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_MMC_CARD_IPCLKPORT_SDCLKIN: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_MMC_CARD_IPCLKPORT_I_ACLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_USB20DRD_0_REF_CLK_40: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_USB20DRD_1_REF_CLK_40: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_USB30DRD_0_REF_CLK_40: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_USB30DRD_1_REF_CLK_40: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_US_D_USB2_0_IPCLKPORT_ACLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_US_D_USB2_1_IPCLKPORT_ACLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_US_D_USB3_0_IPCLKPORT_ACLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS1_UID_US_D_USB3_1_IPCLKPORT_ACLK: c_uint = 0x2080;
...
pub const PLL_CON0_MUX_CLKCMU_FSYS2_BUS_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_FSYS2_UFS_EMBD_USER: c_uint = 0x0620;
pub const PLL_CON0_MUX_CLKCMU_FSYS2_ETHERNET_USER: c_uint = 0x0610;
pub const CLK_CON_GAT_GOUT_BLK_FSYS2_UID_UFS_EMBD0_IPCLKPORT_I_ACLK: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_FSYS2_UID_UFS_EMBD0_IPCLKPORT_I_CLK_UNIPRO: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_FSYS2_UID_UFS_EMBD1_IPCLKPORT_I_ACLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_FSYS2_UID_UFS_EMBD1_IPCLKPORT_I_CLK_UNIPRO: c_uint = 0x20a8;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC0_IP_USER: c_uint = 0x0610;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI00_USI: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI01_USI: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI02_USI: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI03_USI: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI04_USI: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI05_USI: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI_I2C: c_uint = 0x1018;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI00_USI: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI01_USI: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI02_USI: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI03_USI: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI04_USI: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI05_USI: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI_I2C: c_uint = 0x1818;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_0: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_1: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_2: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_3: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_4: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_5: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_6: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_7: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_8: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_9: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_10: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_11: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_0: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_1: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_2: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_3: c_uint = 0x205c;
...
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_10: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_11: c_uint = 0x2050;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC1_IP_USER: c_uint = 0x0610;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI06_USI: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI07_USI: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI08_USI: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI09_USI: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI10_USI: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI11_USI: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI_I2C: c_uint = 0x1018;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI06_USI: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI07_USI: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI08_USI: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI09_USI: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI10_USI: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI11_USI: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI_I2C: c_uint = 0x1818;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_0: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_1: c_uint = 0x2018;
...
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_7: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_8: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_9: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_10: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_11: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_0: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_1: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_2: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_3: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_4: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_5: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_6: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_7: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_8: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_9: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_10: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_11: c_uint = 0x2050;
...
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_SYSREG_PERIS_IPCLKPORT_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_WDT_CLUSTER0_IPCLKPORT_PCLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_WDT_CLUSTER1_IPCLKPORT_PCLK: c_uint = 0x2060;
...
#[no_mangle]
unsafe extern "C" fn exynosautov9_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynosautov9_cmu_init() -> int __init {
