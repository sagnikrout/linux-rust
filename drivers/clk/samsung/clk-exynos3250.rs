...
//! Source: drivers/clk/samsung/clk-exynos3250.c
#![no_std]
...
pub const GATE_IP_PERIR: c_uint = 0x8960;
pub const MPLL_LOCK: c_uint = 0xc010;
pub const MPLL_CON0: c_uint = 0xc110;
pub const VPLL_LOCK: c_uint = 0xc020;
pub const VPLL_CON0: c_uint = 0xc120;
pub const UPLL_LOCK: c_uint = 0xc030;
pub const UPLL_CON0: c_uint = 0xc130;
...
pub const SRC_LCD: c_uint = 0xc234;
pub const SRC_ISP: c_uint = 0xc238;
...
pub const SRC_MASK_LCD: c_uint = 0xc334;
pub const SRC_MASK_ISP: c_uint = 0xc338;
...
pub const DIV_LCD: c_uint = 0xc534;
pub const DIV_ISP: c_uint = 0xc538;
...
pub const DIV_CAM1: c_uint = 0xc568;
pub const CLKDIV2_RATIO: c_uint = 0xc580;
pub const GATE_SCLK_CAM: c_uint = 0xc820;
pub const GATE_SCLK_MFC: c_uint = 0xc828;
pub const GATE_SCLK_G3D: c_uint = 0xc82c;
pub const GATE_SCLK_LCD: c_uint = 0xc834;
pub const GATE_SCLK_ISP_TOP: c_uint = 0xc838;
pub const GATE_SCLK_FSYS: c_uint = 0xc840;
pub const GATE_SCLK_PERIL: c_uint = 0xc850;
pub const GATE_IP_CAM: c_uint = 0xc920;
pub const GATE_IP_MFC: c_uint = 0xc928;
pub const GATE_IP_G3D: c_uint = 0xc92c;
pub const GATE_IP_LCD: c_uint = 0xc934;
pub const GATE_IP_ISP: c_uint = 0xc938;
...
pub const PWR_CTRL2: c_uint = 0x15024;
...
#[no_mangle]
unsafe extern "C" fn exynos3_core_down_clock(reg_base: *mut void __iomem) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn exynos3250_cmu_init(np: *mut device_node) -> void __init {
...
// CMU DMC
//
pub const BPLL_LOCK: c_uint = 0x0118;
pub const BPLL_CON0: c_uint = 0x0218;
pub const BPLL_CON1: c_uint = 0x021c;
pub const BPLL_CON2: c_uint = 0x0220;
pub const SRC_DMC: c_uint = 0x0300;
pub const DIV_DMC1: c_uint = 0x0504;
pub const GATE_BUS_DMC0: c_uint = 0x0700;
pub const GATE_BUS_DMC1: c_uint = 0x0704;
pub const GATE_BUS_DMC2: c_uint = 0x0708;
pub const GATE_BUS_DMC3: c_uint = 0x070c;
pub const GATE_SCLK_DMC: c_uint = 0x0800;
pub const GATE_IP_DMC0: c_uint = 0x0900;
pub const GATE_IP_DMC1: c_uint = 0x0904;
pub const EPLL_LOCK: c_uint = 0x1110;
pub const EPLL_CON0: c_uint = 0x1114;
pub const EPLL_CON1: c_uint = 0x1118;
pub const EPLL_CON2: c_uint = 0x111c;
pub const SRC_EPLL: c_uint = 0x1120;
...
#[no_mangle]
unsafe extern "C" fn exynos3250_cmu_dmc_init(np: *mut device_node) -> void __init {
...
// CMU ISP
//
pub const DIV_ISP0: c_uint = 0x300;
pub const DIV_ISP1: c_uint = 0x304;
pub const GATE_IP_ISP0: c_uint = 0x800;
pub const GATE_IP_ISP1: c_uint = 0x804;
pub const GATE_SCLK_ISP: c_uint = 0x900;
...
#[no_mangle]
unsafe extern "C" fn exynos3250_cmu_isp_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynos3250_cmu_platform_init() -> int __init {
