...
//! Source: drivers/clk/samsung/clk-exynos850.c
#![no_std]
...
pub const PLL_LOCKTIME_PLL_SHARED0: c_uint = 0x0004;
pub const PLL_LOCKTIME_PLL_SHARED1: c_uint = 0x0008;
pub const PLL_CON0_PLL_MMC: c_uint = 0x0100;
pub const PLL_CON3_PLL_MMC: c_uint = 0x010c;
pub const PLL_CON0_PLL_SHARED0: c_uint = 0x0140;
pub const PLL_CON3_PLL_SHARED0: c_uint = 0x014c;
pub const PLL_CON0_PLL_SHARED1: c_uint = 0x0180;
pub const PLL_CON3_PLL_SHARED1: c_uint = 0x018c;
pub const CLK_CON_MUX_MUX_CLKCMU_APM_BUS: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_BUS: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_CCI: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_MMC_EMBD: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_SSS: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_DBG: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1028;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL1_DBG: c_uint = 0x102c;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH: c_uint = 0x1030;
pub const CLK_CON_MUX_MUX_CLKCMU_DPU: c_uint = 0x1034;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D_SWITCH: c_uint = 0x1038;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI_BUS: c_uint = 0x103c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI_MMC_CARD: c_uint = 0x1040;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI_USB20DRD: c_uint = 0x1044;
pub const CLK_CON_MUX_MUX_CLKCMU_IS_BUS: c_uint = 0x1048;
pub const CLK_CON_MUX_MUX_CLKCMU_IS_GDC: c_uint = 0x104c;
pub const CLK_CON_MUX_MUX_CLKCMU_IS_ITP: c_uint = 0x1050;
pub const CLK_CON_MUX_MUX_CLKCMU_IS_VRA: c_uint = 0x1054;
pub const CLK_CON_MUX_MUX_CLKCMU_MFCMSCL_JPEG: c_uint = 0x1058;
pub const CLK_CON_MUX_MUX_CLKCMU_MFCMSCL_M2M: c_uint = 0x105c;
pub const CLK_CON_MUX_MUX_CLKCMU_MFCMSCL_MCSC: c_uint = 0x1060;
pub const CLK_CON_MUX_MUX_CLKCMU_MFCMSCL_MFC: c_uint = 0x1064;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_BUS: c_uint = 0x1070;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_IP: c_uint = 0x1074;
pub const CLK_CON_MUX_MUX_CLKCMU_PERI_UART: c_uint = 0x1078;
pub const CLK_CON_DIV_CLKCMU_APM_BUS: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_AUD: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_CORE_BUS: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_CORE_CCI: c_uint = 0x1824;
pub const CLK_CON_DIV_CLKCMU_CORE_MMC_EMBD: c_uint = 0x1828;
pub const CLK_CON_DIV_CLKCMU_CORE_SSS: c_uint = 0x182c;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_DBG: c_uint = 0x1830;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1834;
pub const CLK_CON_DIV_CLKCMU_CPUCL1_DBG: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKCMU_CPUCL1_SWITCH: c_uint = 0x183c;
pub const CLK_CON_DIV_CLKCMU_DPU: c_uint = 0x1840;
pub const CLK_CON_DIV_CLKCMU_G3D_SWITCH: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_HSI_BUS: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_HSI_MMC_CARD: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_HSI_USB20DRD: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_IS_BUS: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_IS_GDC: c_uint = 0x1858;
pub const CLK_CON_DIV_CLKCMU_IS_ITP: c_uint = 0x185c;
pub const CLK_CON_DIV_CLKCMU_IS_VRA: c_uint = 0x1860;
pub const CLK_CON_DIV_CLKCMU_MFCMSCL_JPEG: c_uint = 0x1864;
pub const CLK_CON_DIV_CLKCMU_MFCMSCL_M2M: c_uint = 0x1868;
pub const CLK_CON_DIV_CLKCMU_MFCMSCL_MCSC: c_uint = 0x186c;
pub const CLK_CON_DIV_CLKCMU_MFCMSCL_MFC: c_uint = 0x1870;
pub const CLK_CON_DIV_CLKCMU_PERI_BUS: c_uint = 0x187c;
pub const CLK_CON_DIV_CLKCMU_PERI_IP: c_uint = 0x1880;
pub const CLK_CON_DIV_CLKCMU_PERI_UART: c_uint = 0x1884;
pub const CLK_CON_DIV_PLL_SHARED0_DIV2: c_uint = 0x188c;
pub const CLK_CON_DIV_PLL_SHARED0_DIV3: c_uint = 0x1890;
pub const CLK_CON_DIV_PLL_SHARED0_DIV4: c_uint = 0x1894;
pub const CLK_CON_DIV_PLL_SHARED1_DIV2: c_uint = 0x1898;
pub const CLK_CON_DIV_PLL_SHARED1_DIV3: c_uint = 0x189c;
pub const CLK_CON_DIV_PLL_SHARED1_DIV4: c_uint = 0x18a0;
pub const CLK_CON_GAT_GATE_CLKCMU_APM_BUS: c_uint = 0x2008;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD: c_uint = 0x200c;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_BUS: c_uint = 0x201c;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_CCI: c_uint = 0x2020;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_MMC_EMBD: c_uint = 0x2024;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_SSS: c_uint = 0x2028;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_DBG: c_uint = 0x202c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_SWITCH: c_uint = 0x2030;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_DBG: c_uint = 0x2034;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH: c_uint = 0x2038;
pub const CLK_CON_GAT_GATE_CLKCMU_DPU: c_uint = 0x203c;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_SWITCH: c_uint = 0x2040;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI_BUS: c_uint = 0x2044;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI_MMC_CARD: c_uint = 0x2048;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI_USB20DRD: c_uint = 0x204c;
pub const CLK_CON_GAT_GATE_CLKCMU_IS_BUS: c_uint = 0x2050;
pub const CLK_CON_GAT_GATE_CLKCMU_IS_GDC: c_uint = 0x2054;
pub const CLK_CON_GAT_GATE_CLKCMU_IS_ITP: c_uint = 0x2058;
pub const CLK_CON_GAT_GATE_CLKCMU_IS_VRA: c_uint = 0x205c;
pub const CLK_CON_GAT_GATE_CLKCMU_MFCMSCL_JPEG: c_uint = 0x2060;
pub const CLK_CON_GAT_GATE_CLKCMU_MFCMSCL_M2M: c_uint = 0x2064;
pub const CLK_CON_GAT_GATE_CLKCMU_MFCMSCL_MCSC: c_uint = 0x2068;
pub const CLK_CON_GAT_GATE_CLKCMU_MFCMSCL_MFC: c_uint = 0x206c;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_BUS: c_uint = 0x2080;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_IP: c_uint = 0x2084;
pub const CLK_CON_GAT_GATE_CLKCMU_PERI_UART: c_uint = 0x2088;
...
#[no_mangle]
unsafe extern "C" fn exynos850_cmu_top_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_APM_BUS_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLK_RCO_APM_I3C_USER: c_uint = 0x0610;
pub const PLL_CON0_MUX_CLK_RCO_APM_USER: c_uint = 0x0620;
pub const PLL_CON0_MUX_DLL_USER: c_uint = 0x0630;
pub const CLK_CON_MUX_MUX_CLKCMU_CHUB_BUS: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_APM_BUS: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_APM_I3C: c_uint = 0x1008;
pub const CLK_CON_DIV_CLKCMU_CHUB_BUS: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_APM_BUS: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_APM_I3C: c_uint = 0x1808;
pub const CLK_CON_GAT_CLKCMU_CMGP_BUS: c_uint = 0x2000;
pub const CLK_CON_GAT_GATE_CLKCMU_CHUB_BUS: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_APM_APBIF_GPIO_ALIVE_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_APM_APBIF_PMU_ALIVE_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_APM_APBIF_RTC_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_APM_APBIF_TOP_RTC_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_APM_I3C_APM_PMIC_I_PCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_APM_I3C_APM_PMIC_I_SCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_APM_MAILBOX_APM_AP_PCLK: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_APM_SPEEDY_APM_PCLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_APM_SYSREG_APM_PCLK: c_uint = 0x20c0;
...
// List of parent clocks for Muxes in CMU_APM
    ...
    FRATE(CLK_RCO_I3C_PMIC, "clk_rco_i3c_pmic", core::ptr::null_mut(), 0, 491520000),
    FRATE(OSCCLK_RCO_APM, "oscclk_rco_apm", core::ptr::null_mut(), 0, 24576000),
    FRATE(CLK_RCO_APM__ALV, "clk_rco_apm__alv", core::ptr::null_mut(), 0, 49152000),
    FRATE(CLK_DLL_DCO, "clk_dll_dco", core::ptr::null_mut(), 0, 360000000),
    };
...
// ---- CMU_AUD -------------------------------------------------------------
pub const PLL_LOCKTIME_PLL_AUD: c_uint = 0x0000;
pub const PLL_CON0_PLL_AUD: c_uint = 0x0100;
pub const PLL_CON3_PLL_AUD: c_uint = 0x010c;
pub const PLL_CON0_MUX_CLKCMU_AUD_CPU_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_TICK_USB_USER: c_uint = 0x0610;
pub const CLK_CON_MUX_MUX_CLK_AUD_CPU: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_AUD_CPU_HCH: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_AUD_FM: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLK_AUD_UAIF0: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLK_AUD_UAIF1: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLK_AUD_UAIF2: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLK_AUD_UAIF3: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLK_AUD_UAIF4: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLK_AUD_UAIF5: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLK_AUD_UAIF6: c_uint = 0x1024;
pub const CLK_CON_DIV_DIV_CLK_AUD_MCLK: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_AUD_AUDIF: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_AUD_BUSD: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_AUD_BUSP: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_AUD_CNT: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_AUD_CPU: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_AUD_CPU_ACLK: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_AUD_CPU_PCLKDBG: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_AUD_FM: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_AUD_FM_SPDY: c_uint = 0x1824;
pub const CLK_CON_DIV_DIV_CLK_AUD_UAIF0: c_uint = 0x1828;
pub const CLK_CON_DIV_DIV_CLK_AUD_UAIF1: c_uint = 0x182c;
pub const CLK_CON_DIV_DIV_CLK_AUD_UAIF2: c_uint = 0x1830;
pub const CLK_CON_DIV_DIV_CLK_AUD_UAIF3: c_uint = 0x1834;
pub const CLK_CON_DIV_DIV_CLK_AUD_UAIF4: c_uint = 0x1838;
pub const CLK_CON_DIV_DIV_CLK_AUD_UAIF5: c_uint = 0x183c;
pub const CLK_CON_DIV_DIV_CLK_AUD_UAIF6: c_uint = 0x1840;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_CNT: c_uint = 0x2000;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_UAIF0: c_uint = 0x2004;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_UAIF1: c_uint = 0x2008;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_UAIF2: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_UAIF3: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_UAIF4: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_UAIF5: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_UAIF6: c_uint = 0x201c;
pub const CLK_CON_GAT_CLK_AUD_CMU_AUD_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_ACLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_BCLK_SPDY: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_CCLK_ASB: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_CCLK_CA32: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_AUD_ABOX_CCLK_DAP: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_AUD_CODEC_MCLK: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_AUD_TZPC_PCLK: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_AUD_GPIO_PCLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_AUD_PPMU_ACLK: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_AUD_PPMU_PCLK: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_AUD_SYSMMU_CLK_S1: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_AUD_SYSREG_PCLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_GOUT_AUD_WDT_PCLK: c_uint = 0x20bc;
...
//
    ...
    PLL_LOCKTIME_PLL_AUD, PLL_CON3_PLL_AUD, core::ptr::null_mut()),
    };
    static const struct samsung_fixed_rate_clock aud_fixed_clks[] __initconst = {
    FRATE(IOCLK_AUDIOCDCLK0, "ioclk_audiocdclk0", core::ptr::null_mut(), 0, 25000000),
    FRATE(IOCLK_AUDIOCDCLK1, "ioclk_audiocdclk1", core::ptr::null_mut(), 0, 25000000),
    FRATE(IOCLK_AUDIOCDCLK2, "ioclk_audiocdclk2", core::ptr::null_mut(), 0, 25000000),
    FRATE(IOCLK_AUDIOCDCLK3, "ioclk_audiocdclk3", core::ptr::null_mut(), 0, 25000000),
    FRATE(IOCLK_AUDIOCDCLK4, "ioclk_audiocdclk4", core::ptr::null_mut(), 0, 25000000),
    FRATE(IOCLK_AUDIOCDCLK5, "ioclk_audiocdclk5", core::ptr::null_mut(), 0, 25000000),
    FRATE(IOCLK_AUDIOCDCLK6, "ioclk_audiocdclk6", core::ptr::null_mut(), 0, 25000000),
    FRATE(TICK_USB, "tick_usb", core::ptr::null_mut(), 0, 60000000),
    };
...
pub const CLK_CON_MUX_CLK_CMGP_ADC: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI_CMGP0: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_CMGP_USI_CMGP1: c_uint = 0x1008;
pub const CLK_CON_DIV_DIV_CLK_CMGP_ADC: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI_CMGP0: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_CMGP_USI_CMGP1: c_uint = 0x1808;
pub const CLK_CON_GAT_GOUT_CMGP_ADC_PCLK_S0: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_CMGP_ADC_PCLK_S1: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_CMGP_GPIO_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_CMGP_SYSREG_CMGP_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_CMGP_USI_CMGP0_IPCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_CMGP_USI_CMGP0_PCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_CMGP_USI_CMGP1_IPCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_CMGP_USI_CMGP1_PCLK: c_uint = 0x2050;
...
// List of parent clocks for Muxes in CMU_CMGP
    ...
    FRATE(CLK_RCO_CMGP, "clk_rco_cmgp", core::ptr::null_mut(), 0, 49152000),
    };
...
pub const PLL_LOCKTIME_PLL_CPUCL0: c_uint = 0x0000;
pub const PLL_CON0_PLL_CPUCL0: c_uint = 0x0100;
pub const PLL_CON1_PLL_CPUCL0: c_uint = 0x0104;
pub const PLL_CON3_PLL_CPUCL0: c_uint = 0x010c;
pub const PLL_CON0_MUX_CLKCMU_CPUCL0_DBG_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_CPUCL0_SWITCH_USER: c_uint = 0x0610;
pub const CLK_CON_MUX_MUX_CLK_CPUCL0_PLL: c_uint = 0x100c;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_ACLK: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_ATCLK: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_PCLKDBG: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_PERIPHCLK: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_CPUCL0_CMUREF: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_CPUCL0_CPU: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_CPUCL0_PCLK: c_uint = 0x181c;
pub const CLK_CON_GAT_CLK_CPUCL0_CLUSTER0_ATCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_CPUCL0_CLUSTER0_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_CPUCL0_CLUSTER0_PERIPHCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_CPUCL0_CLUSTER0_SCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_CPUCL0_CMU_CPUCL0_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GATE_CLK_CPUCL0_CPU: c_uint = 0x2020;
...
#[no_mangle]
unsafe extern "C" fn exynos850_cmu_cpucl0_init(np: *mut device_node) -> void __init {
...
pub const PLL_LOCKTIME_PLL_CPUCL1: c_uint = 0x0000;
pub const PLL_CON0_PLL_CPUCL1: c_uint = 0x0100;
pub const PLL_CON1_PLL_CPUCL1: c_uint = 0x0104;
pub const PLL_CON3_PLL_CPUCL1: c_uint = 0x010c;
pub const PLL_CON0_MUX_CLKCMU_CPUCL1_DBG_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_CPUCL1_SWITCH_USER: c_uint = 0x0610;
pub const CLK_CON_MUX_MUX_CLK_CPUCL1_PLL: c_uint = 0x1000;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_ACLK: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_ATCLK: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_PCLKDBG: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_PERIPHCLK: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_CPUCL1_CMUREF: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_CPUCL1_CPU: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_CPUCL1_PCLK: c_uint = 0x181c;
pub const CLK_CON_GAT_CLK_CPUCL1_CLUSTER1_ATCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_CPUCL1_CLUSTER1_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_CPUCL1_CLUSTER1_PERIPHCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_CPUCL1_CLUSTER1_SCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_CPUCL1_CMU_CPUCL1_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GATE_CLK_CPUCL1_CPU: c_uint = 0x2020;
...
#[no_mangle]
unsafe extern "C" fn exynos850_cmu_cpucl1_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_G3D_SWITCH_USER: c_uint = 0x0600;
pub const CLK_CON_MUX_MUX_CLK_G3D_BUSD: c_uint = 0x1000;
pub const CLK_CON_DIV_DIV_CLK_G3D_BUSP: c_uint = 0x1804;
pub const CLK_CON_GAT_CLK_G3D_CMU_G3D_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_G3D_GPU_CLK: c_uint = 0x2004;
pub const CLK_CON_GAT_GOUT_G3D_TZPC_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_G3D_GRAY2BIN_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_G3D_BUSD_CLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_G3D_BUSP_CLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_G3D_SYSREG_PCLK: c_uint = 0x202c;
...
pub const PLL_CON0_MUX_CLKCMU_HSI_BUS_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_HSI_MMC_CARD_USER: c_uint = 0x0610;
pub const PLL_CON0_MUX_CLKCMU_HSI_USB20DRD_USER: c_uint = 0x0620;
pub const CLK_CON_MUX_MUX_CLK_HSI_RTC: c_uint = 0x1000;
pub const CLK_CON_GAT_CLK_HSI_CMU_HSI_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_HSI_USB20DRD_TOP_I_RTC_CLK__ALV: c_uint = 0x2008;
pub const CLK_CON_GAT_HSI_USB20DRD_TOP_I_REF_CLK_50: c_uint = 0x200c;
pub const CLK_CON_GAT_HSI_USB20DRD_TOP_I_PHY_REFCLK_26: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_HSI_GPIO_HSI_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_HSI_MMC_CARD_I_ACLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_HSI_MMC_CARD_SDCLKIN: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_HSI_PPMU_ACLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_HSI_PPMU_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_HSI_SYSREG_HSI_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_HSI_USB20DRD_TOP_ACLK_PHYCTRL_20: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_HSI_USB20DRD_TOP_BUS_CLK_EARLY: c_uint = 0x2040;
...
// ---- CMU_IS --------------------------------------------------------------
pub const PLL_CON0_MUX_CLKCMU_IS_BUS_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_IS_GDC_USER: c_uint = 0x0610;
pub const PLL_CON0_MUX_CLKCMU_IS_ITP_USER: c_uint = 0x0620;
pub const PLL_CON0_MUX_CLKCMU_IS_VRA_USER: c_uint = 0x0630;
pub const CLK_CON_DIV_DIV_CLK_IS_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_CLK_IS_CMU_IS_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_GOUT_IS_CSIS0_ACLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_IS_CSIS1_ACLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_IS_CSIS2_ACLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_IS_TZPC_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_IS_CLK_CSIS_DMA: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_IS_CLK_GDC: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_IS_CLK_IPP: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_IS_CLK_ITP: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_IS_CLK_MCSC: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_IS_CLK_VRA: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_IS_PPMU_IS0_ACLK: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_IS_PPMU_IS0_PCLK: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_IS_PPMU_IS1_ACLK: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_IS_PPMU_IS1_PCLK: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_IS_SYSMMU_IS0_CLK_S1: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_IS_SYSMMU_IS1_CLK_S1: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_IS_SYSREG_PCLK: c_uint = 0x20a0;
...
// ---- CMU_MFCMSCL ---------------------------------------------------------
pub const PLL_CON0_MUX_CLKCMU_MFCMSCL_JPEG_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_MFCMSCL_M2M_USER: c_uint = 0x0610;
pub const PLL_CON0_MUX_CLKCMU_MFCMSCL_MCSC_USER: c_uint = 0x0620;
pub const PLL_CON0_MUX_CLKCMU_MFCMSCL_MFC_USER: c_uint = 0x0630;
pub const CLK_CON_DIV_DIV_CLK_MFCMSCL_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_CLK_MFCMSCL_CMU_MFCMSCL_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_GOUT_MFCMSCL_TZPC_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_MFCMSCL_JPEG_ACLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_MFCMSCL_M2M_ACLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_MFCMSCL_MCSC_I_CLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_MFCMSCL_MFC_ACLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_MFCMSCL_PPMU_ACLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_MFCMSCL_PPMU_PCLK: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_MFCMSCL_SYSMMU_CLK_S1: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_MFCMSCL_SYSREG_PCLK: c_uint = 0x2078;
...
pub const PLL_CON0_MUX_CLKCMU_PERI_BUS_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_PERI_HSI2C_USER: c_uint = 0x0610;
pub const PLL_CON0_MUX_CLKCMU_PERI_SPI_USER: c_uint = 0x0620;
pub const PLL_CON0_MUX_CLKCMU_PERI_UART_USER: c_uint = 0x0630;
pub const CLK_CON_DIV_DIV_CLK_PERI_HSI2C_0: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERI_HSI2C_1: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERI_HSI2C_2: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_PERI_SPI_0: c_uint = 0x180c;
pub const CLK_CON_GAT_GATE_CLK_PERI_HSI2C_0: c_uint = 0x200c;
pub const CLK_CON_GAT_GATE_CLK_PERI_HSI2C_1: c_uint = 0x2010;
pub const CLK_CON_GAT_GATE_CLK_PERI_HSI2C_2: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_PERI_BUSIF_TMU_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_PERI_GPIO_PERI_PCLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_0_IPCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_0_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_1_IPCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_1_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_2_IPCLK: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_PERI_HSI2C_2_PCLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_PERI_I2C_0_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_PERI_I2C_1_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_PERI_I2C_2_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_PERI_I2C_3_PCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_PERI_I2C_4_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_PERI_I2C_5_PCLK: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_PERI_I2C_6_PCLK: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_PERI_MCT_PCLK: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_PERI_PWM_MOTOR_PCLK: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_PERI_SPI_0_IPCLK: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_PERI_SPI_0_PCLK: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_PERI_SYSREG_PERI_PCLK: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_PERI_UART_IPCLK: c_uint = 0x20a8;
pub const CLK_CON_GAT_GOUT_PERI_UART_PCLK: c_uint = 0x20ac;
pub const CLK_CON_GAT_GOUT_PERI_WDT_0_PCLK: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_PERI_WDT_1_PCLK: c_uint = 0x20b4;
...
#[no_mangle]
unsafe extern "C" fn exynos850_cmu_peri_init(np: *mut device_node) -> void __init {
    static void __init exynos850_cmu_peri_init(struct device_node *np)
    {
    exynos_arm64_register_cmu(core::ptr::null_mut(), np, &peri_cmu_info);
    }
...
pub const PLL_CON0_MUX_CLKCMU_CORE_CCI_USER: c_uint = 0x0610;
pub const PLL_CON0_MUX_CLKCMU_CORE_MMC_EMBD_USER: c_uint = 0x0620;
pub const PLL_CON0_MUX_CLKCMU_CORE_SSS_USER: c_uint = 0x0630;
pub const CLK_CON_MUX_MUX_CLK_CORE_GIC: c_uint = 0x1000;
pub const CLK_CON_DIV_DIV_CLK_CORE_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_GOUT_CORE_CCI_550_ACLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_CORE_GIC_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_CORE_GPIO_CORE_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_CORE_MMC_EMBD_I_ACLK: c_uint = 0x20e8;
pub const CLK_CON_GAT_GOUT_CORE_MMC_EMBD_SDCLKIN: c_uint = 0x20ec;
pub const CLK_CON_GAT_GOUT_CORE_PDMA_ACLK: c_uint = 0x20f0;
pub const CLK_CON_GAT_GOUT_CORE_SPDMA_ACLK: c_uint = 0x2124;
pub const CLK_CON_GAT_GOUT_CORE_SSS_I_ACLK: c_uint = 0x2128;
pub const CLK_CON_GAT_GOUT_CORE_SSS_I_PCLK: c_uint = 0x212c;
pub const CLK_CON_GAT_GOUT_CORE_SYSREG_CORE_PCLK: c_uint = 0x2130;
...
pub const PLL_CON0_MUX_CLKCMU_DPU_USER: c_uint = 0x0600;
pub const CLK_CON_DIV_DIV_CLK_DPU_BUSP: c_uint = 0x1800;
pub const CLK_CON_GAT_CLK_DPU_CMU_DPU_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_GOUT_DPU_ACLK_DECON0: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_DPU_ACLK_DMA: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_DPU_ACLK_DPP: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_DPU_PPMU_ACLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_DPU_PPMU_PCLK: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_DPU_SMMU_CLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_DPU_SYSREG_PCLK: c_uint = 0x203c;
...
// ---- platform_driver -----------------------------------------------------
#[no_mangle]
unsafe extern "C" fn exynos850_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynos850_cmu_init() -> int __init {
