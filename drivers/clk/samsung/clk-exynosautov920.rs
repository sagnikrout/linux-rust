...
//! Source: drivers/clk/samsung/clk-exynosautov920.c
#![no_std]
...
pub const PLL_LOCKTIME_PLL_SHARED5: c_uint = 0x0018;
...
pub const PLL_CON0_PLL_SHARED5: c_uint = 0x02c0;
pub const PLL_CON3_PLL_SHARED5: c_uint = 0x02cc;
// MUX
pub const CLK_CON_MUX_MUX_CLKCMU_ACC_NOC: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLKCMU_APM_NOC: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_CPU: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_NOC: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_MCLK0: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_MCLK1: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_MCLK2: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_MCLK3: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_CLUSTER: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_DBG: c_uint = 0x1028;
...
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL2_CLUSTER: c_uint = 0x1038;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL2_SWITCH: c_uint = 0x103c;
pub const CLK_CON_MUX_MUX_CLKCMU_DNC_NOC: c_uint = 0x1040;
pub const CLK_CON_MUX_MUX_CLKCMU_DPTX_DPGTC: c_uint = 0x1044;
pub const CLK_CON_MUX_MUX_CLKCMU_DPTX_DPOSC: c_uint = 0x1048;
pub const CLK_CON_MUX_MUX_CLKCMU_DPTX_NOC: c_uint = 0x104c;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUB_DSIM: c_uint = 0x1050;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUB_NOC: c_uint = 0x1054;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUF0_NOC: c_uint = 0x1058;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUF1_NOC: c_uint = 0x105c;
pub const CLK_CON_MUX_MUX_CLKCMU_DPUF2_NOC: c_uint = 0x1060;
pub const CLK_CON_MUX_MUX_CLKCMU_DSP_NOC: c_uint = 0x1064;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D_NOCP: c_uint = 0x1068;
pub const CLK_CON_MUX_MUX_CLKCMU_G3D_SWITCH: c_uint = 0x106c;
pub const CLK_CON_MUX_MUX_CLKCMU_GNPU_NOC: c_uint = 0x1070;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_NOC: c_uint = 0x1074;
pub const CLK_CON_MUX_MUX_CLKCMU_ACC_ORB: c_uint = 0x1078;
pub const CLK_CON_MUX_MUX_CLKCMU_GNPU_XMAA: c_uint = 0x107c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_MMC_CARD: c_uint = 0x1080;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_NOC: c_uint = 0x1084;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_USBDRD: c_uint = 0x1088;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_ETHERNET: c_uint = 0x108c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_NOC: c_uint = 0x1090;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_NOC_UFS: c_uint = 0x1094;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_UFS_EMBD: c_uint = 0x1098;
pub const CLK_CON_MUX_MUX_CLKCMU_ISP_NOC: c_uint = 0x109c;
pub const CLK_CON_MUX_MUX_CLKCMU_M2M_JPEG: c_uint = 0x10a0;
pub const CLK_CON_MUX_MUX_CLKCMU_M2M_NOC: c_uint = 0x10a4;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC_MFC: c_uint = 0x10a8;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC_WFD: c_uint = 0x10ac;
pub const CLK_CON_MUX_MUX_CLKCMU_MFD_NOC: c_uint = 0x10b0;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_NOCP: c_uint = 0x10b4;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x10b8;
pub const CLK_CON_MUX_MUX_CLKCMU_MISC_NOC: c_uint = 0x10bc;
pub const CLK_CON_MUX_MUX_CLKCMU_NOCL0_NOC: c_uint = 0x10c0;
pub const CLK_CON_MUX_MUX_CLKCMU_NOCL1_NOC: c_uint = 0x10c4;
pub const CLK_CON_MUX_MUX_CLKCMU_NOCL2_NOC: c_uint = 0x10c8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_IP: c_uint = 0x10cc;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_NOC: c_uint = 0x10d0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_IP: c_uint = 0x10d4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_NOC: c_uint = 0x10d8;
pub const CLK_CON_MUX_MUX_CLKCMU_SDMA_NOC: c_uint = 0x10dc;
pub const CLK_CON_MUX_MUX_CLKCMU_SNW_NOC: c_uint = 0x10e0;
pub const CLK_CON_MUX_MUX_CLKCMU_SSP_NOC: c_uint = 0x10e4;
pub const CLK_CON_MUX_MUX_CLKCMU_TAA_NOC: c_uint = 0x10e8;
pub const CLK_CON_MUX_MUX_CLK_CMU_NOCP: c_uint = 0x10ec;
pub const CLK_CON_MUX_MUX_CLK_CMU_PLLCLKOUT: c_uint = 0x10f0;
pub const CLK_CON_MUX_MUX_CMU_CMUREF: c_uint = 0x10f4;
// DIV
pub const CLK_CON_DIV_CLKCMU_ACC_NOC: c_uint = 0x1800;
pub const CLK_CON_DIV_CLKCMU_APM_NOC: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKCMU_AUD_CPU: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKCMU_AUD_NOC: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_CIS_MCLK0: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_CIS_MCLK1: c_uint = 0x1814;
pub const CLK_CON_DIV_CLKCMU_CIS_MCLK2: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKCMU_CIS_MCLK3: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_CLUSTER: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_DBG: c_uint = 0x1824;
...
pub const CLK_CON_DIV_CLKCMU_CPUCL2_CLUSTER: c_uint = 0x1834;
pub const CLK_CON_DIV_CLKCMU_CPUCL2_SWITCH: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKCMU_DNC_NOC: c_uint = 0x183c;
pub const CLK_CON_DIV_CLKCMU_DPTX_DPGTC: c_uint = 0x1840;
pub const CLK_CON_DIV_CLKCMU_DPTX_DPOSC: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_DPTX_NOC: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_DPUB_DSIM: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_DPUB_NOC: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_DPUF0_NOC: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_DPUF1_NOC: c_uint = 0x1858;
pub const CLK_CON_DIV_CLKCMU_DPUF2_NOC: c_uint = 0x185c;
pub const CLK_CON_DIV_CLKCMU_DSP_NOC: c_uint = 0x1860;
pub const CLK_CON_DIV_CLKCMU_G3D_NOCP: c_uint = 0x1864;
pub const CLK_CON_DIV_CLKCMU_G3D_SWITCH: c_uint = 0x1868;
pub const CLK_CON_DIV_CLKCMU_GNPU_NOC: c_uint = 0x186c;
pub const CLK_CON_DIV_CLKCMU_HSI0_NOC: c_uint = 0x1870;
pub const CLK_CON_DIV_CLKCMU_ACC_ORB: c_uint = 0x1874;
pub const CLK_CON_DIV_CLKCMU_GNPU_XMAA: c_uint = 0x1878;
pub const CLK_CON_DIV_CLKCMU_HSI1_MMC_CARD: c_uint = 0x187c;
pub const CLK_CON_DIV_CLKCMU_HSI1_NOC: c_uint = 0x1880;
pub const CLK_CON_DIV_CLKCMU_HSI1_USBDRD: c_uint = 0x1884;
pub const CLK_CON_DIV_CLKCMU_HSI2_ETHERNET: c_uint = 0x1888;
pub const CLK_CON_DIV_CLKCMU_HSI2_NOC: c_uint = 0x188c;
pub const CLK_CON_DIV_CLKCMU_HSI2_NOC_UFS: c_uint = 0x1890;
pub const CLK_CON_DIV_CLKCMU_HSI2_UFS_EMBD: c_uint = 0x1894;
pub const CLK_CON_DIV_CLKCMU_ISP_NOC: c_uint = 0x1898;
pub const CLK_CON_DIV_CLKCMU_M2M_JPEG: c_uint = 0x189c;
pub const CLK_CON_DIV_CLKCMU_M2M_NOC: c_uint = 0x18a0;
pub const CLK_CON_DIV_CLKCMU_MFC_MFC: c_uint = 0x18a4;
pub const CLK_CON_DIV_CLKCMU_MFC_WFD: c_uint = 0x18a8;
pub const CLK_CON_DIV_CLKCMU_MFD_NOC: c_uint = 0x18ac;
pub const CLK_CON_DIV_CLKCMU_MIF_NOCP: c_uint = 0x18b0;
pub const CLK_CON_DIV_CLKCMU_MISC_NOC: c_uint = 0x18b4;
pub const CLK_CON_DIV_CLKCMU_NOCL0_NOC: c_uint = 0x18b8;
pub const CLK_CON_DIV_CLKCMU_NOCL1_NOC: c_uint = 0x18bc;
pub const CLK_CON_DIV_CLKCMU_NOCL2_NOC: c_uint = 0x18c0;
pub const CLK_CON_DIV_CLKCMU_PERIC0_IP: c_uint = 0x18c4;
pub const CLK_CON_DIV_CLKCMU_PERIC0_NOC: c_uint = 0x18c8;
pub const CLK_CON_DIV_CLKCMU_PERIC1_IP: c_uint = 0x18cc;
pub const CLK_CON_DIV_CLKCMU_PERIC1_NOC: c_uint = 0x18d0;
pub const CLK_CON_DIV_CLKCMU_SDMA_NOC: c_uint = 0x18d4;
pub const CLK_CON_DIV_CLKCMU_SNW_NOC: c_uint = 0x18d8;
pub const CLK_CON_DIV_CLKCMU_SSP_NOC: c_uint = 0x18dc;
pub const CLK_CON_DIV_CLKCMU_TAA_NOC: c_uint = 0x18e0;
pub const CLK_CON_DIV_CLK_ADD_CH_CLK: c_uint = 0x18e4;
pub const CLK_CON_DIV_CLK_CMU_PLLCLKOUT: c_uint = 0x18e8;
pub const CLK_CON_DIV_DIV_CLKCMU_CMU_BOOST: c_uint = 0x18ec;
pub const CLK_CON_DIV_DIV_CLK_CMU_NOCP: c_uint = 0x18f0;
...
#[no_mangle]
unsafe extern "C" fn exynosautov920_cmu_top_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_CPUCL0_CLUSTER_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_CPUCL0_DBG_USER: c_uint = 0x0610;
pub const PLL_CON0_MUX_CLKCMU_CPUCL0_SWITCH_USER: c_uint = 0x0620;
pub const CLK_CON_MUX_MUX_CLK_CPUCL0_CLUSTER: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_CPUCL0_CORE: c_uint = 0x1004;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_ACLK: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_ATCLK: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_MPCLK: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_PCLK: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER0_PERIPHCLK: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_CPUCL0_DBG_NOC: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_CPUCL0_DBG_PCLKDBG: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_CPUCL0_NOCP: c_uint = 0x1824;
...
#[no_mangle]
unsafe extern "C" fn exynosautov920_cmu_cpucl0_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_CPUCL1_CLUSTER_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_CPUCL1_SWITCH_USER: c_uint = 0x0610;
pub const CLK_CON_MUX_MUX_CLK_CPUCL1_CLUSTER: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_CPUCL1_CORE: c_uint = 0x1004;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_ACLK: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_ATCLK: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_MPCLK: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_PCLK: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER1_PERIPHCLK: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_CPUCL1_NOCP: c_uint = 0x181c;
...
#[no_mangle]
unsafe extern "C" fn exynosautov920_cmu_cpucl1_init(np: *mut device_node) -> void __init {
...
pub const PLL_LOCKTIME_PLL_CPUCL2: c_uint = 0x0000;
pub const PLL_CON0_PLL_CPUCL2: c_uint = 0x0100;
pub const PLL_CON1_PLL_CPUCL2: c_uint = 0x0104;
pub const PLL_CON3_PLL_CPUCL2: c_uint = 0x010c;
pub const PLL_CON0_MUX_CLKCMU_CPUCL2_CLUSTER_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_CPUCL2_SWITCH_USER: c_uint = 0x0610;
pub const CLK_CON_MUX_MUX_CLK_CPUCL2_CLUSTER: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_CPUCL2_CORE: c_uint = 0x1004;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER2_ACLK: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER2_ATCLK: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER2_MPCLK: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER2_PCLK: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_CLUSTER2_PERIPHCLK: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_CPUCL2_NOCP: c_uint = 0x181c;
...
#[no_mangle]
unsafe extern "C" fn exynosautov920_cmu_cpucl2_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_PERIC0_IP_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_NOC_USER: c_uint = 0x0610;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_I3C: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI00_USI: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI01_USI: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI02_USI: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI03_USI: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI04_USI: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI05_USI: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI06_USI: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI07_USI: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI08_USI: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLK_PERIC0_USI_I2C: c_uint = 0x1028;
...
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI06_USI: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI07_USI: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI08_USI: c_uint = 0x1824;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC1_IP_USER: c_uint = 0x600;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_NOC_USER: c_uint = 0x610;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_I3C: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI09_USI: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI10_USI: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI11_USI: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI12_USI: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI13_USI: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI14_USI: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI15_USI: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI16_USI: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI17_USI: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLK_PERIC1_USI_I2C: c_uint = 0x1028;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_I3C: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI09_USI: c_uint = 0x1804;
...
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI14_USI: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI15_USI: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI16_USI: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI17_USI: c_uint = 0x1824;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI_I2C: c_uint = 0x1828;
...
pub const PLL_CON0_MUX_CLKCMU_MISC_NOC_USER: c_uint = 0x600;
pub const CLK_CON_MUX_MUX_CLK_MISC_GIC: c_uint = 0x1000;
pub const CLK_CON_DIV_CLKCMU_OTP: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_MISC_NOCP: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_MISC_OSC_DIV2: c_uint = 0x1808;
...
pub const PLL_CON0_MUX_CLKCMU_HSI0_NOC_USER: c_uint = 0x600;
pub const CLK_CON_DIV_DIV_CLK_HSI0_PCIE_APB: c_uint = 0x1800;
...
pub const PLL_CON0_MUX_CLKCMU_HSI1_MMC_CARD_USER: c_uint = 0x600;
pub const PLL_CON0_MUX_CLKCMU_HSI1_NOC_USER: c_uint = 0x610;
pub const PLL_CON0_MUX_CLKCMU_HSI1_USBDRD_USER: c_uint = 0x620;
pub const CLK_CON_MUX_MUX_CLK_HSI1_USBDRD: c_uint = 0x1000;
...
pub const PLL_LOCKTIME_PLL_ETH: c_uint = 0x0;
pub const PLL_CON3_PLL_ETH: c_uint = 0x10c;
pub const PLL_CON0_MUX_CLKCMU_HSI2_ETHERNET_USER: c_uint = 0x600;
pub const PLL_CON0_MUX_CLKCMU_HSI2_NOC_UFS_USER: c_uint = 0x610;
pub const PLL_CON0_MUX_CLKCMU_HSI2_UFS_EMBD_USER: c_uint = 0x630;
pub const CLK_CON_MUX_MUX_CLK_HSI2_ETHERNET: c_uint = 0x1000;
pub const CLK_CON_DIV_DIV_CLK_HSI2_ETHERNET: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_HSI2_ETHERNET_PTP: c_uint = 0x1804;
...
pub const PLL_CON0_MUX_CLKCMU_M2M_JPEG_USER: c_uint = 0x600;
pub const PLL_CON0_MUX_CLKCMU_M2M_NOC_USER: c_uint = 0x610;
pub const CLK_CON_DIV_DIV_CLK_M2M_NOCP: c_uint = 0x1800;
...
pub const PLL_CON0_MUX_CLKCMU_MFC_MFC_USER: c_uint = 0x600;
pub const PLL_CON0_MUX_CLKCMU_MFC_WFD_USER: c_uint = 0x610;
pub const CLK_CON_DIV_DIV_CLK_MFC_NOCP: c_uint = 0x1800;
...
pub const PLL_CON0_MUX_CLKCMU_MFD_NOC_USER: c_uint = 0x600;
pub const CLK_CON_DIV_DIV_CLK_MFD_NOCP: c_uint = 0x1800;
...
pub const PLL_LOCKTIME_PLL_G3D: c_uint = 0x0;
pub const PLL_CON3_PLL_G3D: c_uint = 0x10c;
pub const CLK_CON_MUX_MUX_CLK_G3D_NOC: c_uint = 0x1000;
pub const PLL_CON0_MUX_CLKCMU_G3D_NOCP_USER: c_uint = 0x600;
pub const PLL_CON0_MUX_CLKCMU_G3D_SWITCH_USER: c_uint = 0x610;
...
#[no_mangle]
unsafe extern "C" fn exynosautov920_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynosautov920_cmu_init() -> int __init {
