...
//! Source: drivers/clk/samsung/clk-exynos5250.c
#![no_std]
...
pub const PWR_CTRL1: c_uint = 0x1020;
pub const PWR_CTRL2: c_uint = 0x1024;
pub const MPLL_LOCK: c_uint = 0x4000;
pub const MPLL_CON0: c_uint = 0x4100;
pub const SRC_CORE1: c_uint = 0x4204;
pub const GATE_IP_ACP: c_uint = 0x8800;
pub const GATE_IP_ISP0: c_uint = 0xc800;
pub const GATE_IP_ISP1: c_uint = 0xc804;
pub const CPLL_LOCK: c_uint = 0x10020;
pub const EPLL_LOCK: c_uint = 0x10030;
pub const VPLL_LOCK: c_uint = 0x10040;
pub const GPLL_LOCK: c_uint = 0x10050;
pub const CPLL_CON0: c_uint = 0x10120;
pub const EPLL_CON0: c_uint = 0x10130;
pub const VPLL_CON0: c_uint = 0x10140;
pub const GPLL_CON0: c_uint = 0x10150;
pub const SRC_TOP0: c_uint = 0x10210;
pub const SRC_TOP1: c_uint = 0x10214;
pub const SRC_TOP2: c_uint = 0x10218;
pub const SRC_TOP3: c_uint = 0x1021c;
pub const SRC_GSCL: c_uint = 0x10220;
pub const SRC_DISP1_0: c_uint = 0x1022c;
pub const SRC_MAU: c_uint = 0x10240;
pub const SRC_FSYS: c_uint = 0x10244;
pub const SRC_GEN: c_uint = 0x10248;
pub const SRC_PERIC0: c_uint = 0x10250;
pub const SRC_PERIC1: c_uint = 0x10254;
pub const SRC_MASK_GSCL: c_uint = 0x10320;
pub const SRC_MASK_DISP1_0: c_uint = 0x1032c;
pub const SRC_MASK_MAU: c_uint = 0x10334;
pub const SRC_MASK_FSYS: c_uint = 0x10340;
pub const SRC_MASK_GEN: c_uint = 0x10344;
...
pub const DIV_GSCL: c_uint = 0x10520;
pub const DIV_DISP1_0: c_uint = 0x1052c;
pub const DIV_GEN: c_uint = 0x1053c;
...
pub const DIV_PERIC5: c_uint = 0x1056c;
pub const GATE_IP_GSCL: c_uint = 0x10920;
...
pub const PLL_DIV2_SEL: c_uint = 0x20a24;
...
#[no_mangle]
unsafe extern "C" fn exynos5250_clk_init(np: *mut device_node) -> void __init {
