...
//! Source: drivers/clk/samsung/clk-exynos990.c
#![no_std]
...
pub const PLL_LOCKTIME_PLL_G3D: c_uint = 0x0000;
pub const PLL_LOCKTIME_PLL_MMC: c_uint = 0x0004;
pub const PLL_LOCKTIME_PLL_SHARED0: c_uint = 0x0008;
pub const PLL_LOCKTIME_PLL_SHARED1: c_uint = 0x000c;
pub const PLL_LOCKTIME_PLL_SHARED2: c_uint = 0x0010;
pub const PLL_LOCKTIME_PLL_SHARED3: c_uint = 0x0014;
pub const PLL_LOCKTIME_PLL_SHARED4: c_uint = 0x0018;
pub const PLL_CON0_PLL_G3D: c_uint = 0x0100;
pub const PLL_CON3_PLL_G3D: c_uint = 0x010c;
pub const PLL_CON0_PLL_MMC: c_uint = 0x0140;
pub const PLL_CON3_PLL_MMC: c_uint = 0x014c;
pub const PLL_CON0_PLL_SHARED0: c_uint = 0x0180;
pub const PLL_CON3_PLL_SHARED0: c_uint = 0x018c;
pub const PLL_CON0_PLL_SHARED1: c_uint = 0x01c0;
pub const PLL_CON3_PLL_SHARED1: c_uint = 0x01cc;
pub const PLL_CON0_PLL_SHARED2: c_uint = 0x0200;
pub const PLL_CON3_PLL_SHARED2: c_uint = 0x020c;
pub const PLL_CON0_PLL_SHARED3: c_uint = 0x0240;
pub const PLL_CON3_PLL_SHARED3: c_uint = 0x024c;
pub const PLL_CON0_PLL_SHARED4: c_uint = 0x0280;
pub const PLL_CON3_PLL_SHARED4: c_uint = 0x028c;
pub const CLK_CON_MUX_CLKCMU_DPU_BUS: c_uint = 0x1000;
pub const CLK_CON_MUX_MUX_CLKCMU_APM_BUS: c_uint = 0x1004;
pub const CLK_CON_MUX_MUX_CLKCMU_AUD_CPU: c_uint = 0x1008;
pub const CLK_CON_MUX_MUX_CLKCMU_BUS0_BUS: c_uint = 0x100c;
pub const CLK_CON_MUX_MUX_CLKCMU_BUS1_BUS: c_uint = 0x1010;
pub const CLK_CON_MUX_MUX_CLKCMU_BUS1_SSS: c_uint = 0x1014;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK0: c_uint = 0x1018;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK1: c_uint = 0x101c;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK2: c_uint = 0x1020;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK3: c_uint = 0x1024;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK4: c_uint = 0x1028;
pub const CLK_CON_MUX_MUX_CLKCMU_CIS_CLK5: c_uint = 0x102c;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST: c_uint = 0x1030;
pub const CLK_CON_MUX_MUX_CLKCMU_CORE_BUS: c_uint = 0x1034;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_DBG_BUS: c_uint = 0x1038;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL0_SWITCH: c_uint = 0x103c;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL1_SWITCH: c_uint = 0x1040;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL2_BUSP: c_uint = 0x1044;
pub const CLK_CON_MUX_MUX_CLKCMU_CPUCL2_SWITCH: c_uint = 0x1048;
pub const CLK_CON_MUX_MUX_CLKCMU_CSIS_BUS: c_uint = 0x104c;
pub const CLK_CON_MUX_MUX_CLKCMU_CSIS_OIS_MCU: c_uint = 0x1050;
pub const CLK_CON_MUX_MUX_CLKCMU_DNC_BUS: c_uint = 0x1054;
pub const CLK_CON_MUX_MUX_CLKCMU_DNC_BUSM: c_uint = 0x1058;
pub const CLK_CON_MUX_MUX_CLKCMU_DNS_BUS: c_uint = 0x105c;
pub const CLK_CON_MUX_MUX_CLKCMU_DPU: c_uint = 0x1060;
pub const CLK_CON_MUX_MUX_CLKCMU_DPU_ALT: c_uint = 0x1064;
pub const CLK_CON_MUX_MUX_CLKCMU_DSP_BUS: c_uint = 0x1068;
pub const CLK_CON_MUX_MUX_CLKCMU_G2D_G2D: c_uint = 0x106c;
pub const CLK_CON_MUX_MUX_CLKCMU_G2D_MSCL: c_uint = 0x1070;
pub const CLK_CON_MUX_MUX_CLKCMU_HPM: c_uint = 0x1074;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_BUS: c_uint = 0x1078;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_DPGTC: c_uint = 0x107c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_USB31DRD: c_uint = 0x1080;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI0_USBDP_DEBUG: c_uint = 0x1084;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_BUS: c_uint = 0x1088;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_MMC_CARD: c_uint = 0x108c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_PCIE: c_uint = 0x1090;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_UFS_CARD: c_uint = 0x1094;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI1_UFS_EMBD: c_uint = 0x1098;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_BUS: c_uint = 0x109c;
pub const CLK_CON_MUX_MUX_CLKCMU_HSI2_PCIE: c_uint = 0x10a0;
pub const CLK_CON_MUX_MUX_CLKCMU_IPP_BUS: c_uint = 0x10a4;
pub const CLK_CON_MUX_MUX_CLKCMU_ITP_BUS: c_uint = 0x10a8;
pub const CLK_CON_MUX_MUX_CLKCMU_MCSC_BUS: c_uint = 0x10ac;
pub const CLK_CON_MUX_MUX_CLKCMU_MCSC_GDC: c_uint = 0x10b0;
pub const CLK_CON_MUX_MUX_CLKCMU_CMU_BOOST_CPU: c_uint = 0x10b4;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC0_MFC0: c_uint = 0x10b8;
pub const CLK_CON_MUX_MUX_CLKCMU_MFC0_WFD: c_uint = 0x10bc;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_BUSP: c_uint = 0x10c0;
pub const CLK_CON_MUX_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x10c4;
pub const CLK_CON_MUX_MUX_CLKCMU_NPU_BUS: c_uint = 0x10c8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_BUS: c_uint = 0x10cc;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC0_IP: c_uint = 0x10d0;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_BUS: c_uint = 0x10d4;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIC1_IP: c_uint = 0x10d8;
pub const CLK_CON_MUX_MUX_CLKCMU_PERIS_BUS: c_uint = 0x10dc;
pub const CLK_CON_MUX_MUX_CLKCMU_SSP_BUS: c_uint = 0x10e0;
pub const CLK_CON_MUX_MUX_CLKCMU_TNR_BUS: c_uint = 0x10e4;
pub const CLK_CON_MUX_MUX_CLKCMU_VRA_BUS: c_uint = 0x10e8;
pub const CLK_CON_MUX_MUX_CLK_CMU_CMUREF: c_uint = 0x10f0;
pub const CLK_CON_MUX_MUX_CMU_CMUREF: c_uint = 0x10f4;
pub const CLK_CON_DIV_CLKCMU_APM_BUS: c_uint = 0x1800;
pub const CLK_CON_DIV_CLKCMU_AUD_CPU: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKCMU_BUS0_BUS: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKCMU_BUS1_BUS: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_BUS1_SSS: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK0: c_uint = 0x1814;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK1: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK2: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK3: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK4: c_uint = 0x1824;
pub const CLK_CON_DIV_CLKCMU_CIS_CLK5: c_uint = 0x1828;
pub const CLK_CON_DIV_CLKCMU_CMU_BOOST: c_uint = 0x182c;
pub const CLK_CON_DIV_CLKCMU_CORE_BUS: c_uint = 0x1830;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_DBG_BUS: c_uint = 0x1834;
pub const CLK_CON_DIV_CLKCMU_CPUCL0_SWITCH: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKCMU_CPUCL1_SWITCH: c_uint = 0x183c;
pub const CLK_CON_DIV_CLKCMU_CPUCL2_BUSP: c_uint = 0x1840;
pub const CLK_CON_DIV_CLKCMU_CPUCL2_SWITCH: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_CSIS_BUS: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_CSIS_OIS_MCU: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_DNC_BUS: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_DNC_BUSM: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_DNS_BUS: c_uint = 0x1858;
pub const CLK_CON_DIV_CLKCMU_DSP_BUS: c_uint = 0x185c;
pub const CLK_CON_DIV_CLKCMU_G2D_G2D: c_uint = 0x1860;
pub const CLK_CON_DIV_CLKCMU_G2D_MSCL: c_uint = 0x1864;
pub const CLK_CON_DIV_CLKCMU_G3D_SWITCH: c_uint = 0x1868;
pub const CLK_CON_DIV_CLKCMU_HPM: c_uint = 0x186c;
pub const CLK_CON_DIV_CLKCMU_HSI0_BUS: c_uint = 0x1870;
pub const CLK_CON_DIV_CLKCMU_HSI0_DPGTC: c_uint = 0x1874;
pub const CLK_CON_DIV_CLKCMU_HSI0_USB31DRD: c_uint = 0x1878;
pub const CLK_CON_DIV_CLKCMU_HSI0_USBDP_DEBUG: c_uint = 0x187c;
pub const CLK_CON_DIV_CLKCMU_HSI1_BUS: c_uint = 0x1880;
pub const CLK_CON_DIV_CLKCMU_HSI1_MMC_CARD: c_uint = 0x1884;
pub const CLK_CON_DIV_CLKCMU_HSI1_PCIE: c_uint = 0x1888;
pub const CLK_CON_DIV_CLKCMU_HSI1_UFS_CARD: c_uint = 0x188c;
pub const CLK_CON_DIV_CLKCMU_HSI1_UFS_EMBD: c_uint = 0x1890;
pub const CLK_CON_DIV_CLKCMU_HSI2_BUS: c_uint = 0x1894;
pub const CLK_CON_DIV_CLKCMU_HSI2_PCIE: c_uint = 0x1898;
pub const CLK_CON_DIV_CLKCMU_IPP_BUS: c_uint = 0x189c;
pub const CLK_CON_DIV_CLKCMU_ITP_BUS: c_uint = 0x18a0;
pub const CLK_CON_DIV_CLKCMU_MCSC_BUS: c_uint = 0x18a4;
pub const CLK_CON_DIV_CLKCMU_MCSC_GDC: c_uint = 0x18a8;
pub const CLK_CON_DIV_CLKCMU_CMU_BOOST_CPU: c_uint = 0x18ac;
pub const CLK_CON_DIV_CLKCMU_MFC0_MFC0: c_uint = 0x18b0;
pub const CLK_CON_DIV_CLKCMU_MFC0_WFD: c_uint = 0x18b4;
pub const CLK_CON_DIV_CLKCMU_MIF_BUSP: c_uint = 0x18b8;
pub const CLK_CON_DIV_CLKCMU_NPU_BUS: c_uint = 0x18bc;
pub const CLK_CON_DIV_CLKCMU_OTP: c_uint = 0x18c0;
pub const CLK_CON_DIV_CLKCMU_PERIC0_BUS: c_uint = 0x18c4;
pub const CLK_CON_DIV_CLKCMU_PERIC0_IP: c_uint = 0x18c8;
pub const CLK_CON_DIV_CLKCMU_PERIC1_BUS: c_uint = 0x18cc;
pub const CLK_CON_DIV_CLKCMU_PERIC1_IP: c_uint = 0x18d0;
pub const CLK_CON_DIV_CLKCMU_PERIS_BUS: c_uint = 0x18d4;
pub const CLK_CON_DIV_CLKCMU_SSP_BUS: c_uint = 0x18d8;
pub const CLK_CON_DIV_CLKCMU_TNR_BUS: c_uint = 0x18dc;
pub const CLK_CON_DIV_CLKCMU_VRA_BUS: c_uint = 0x18e0;
pub const CLK_CON_DIV_DIV_CLKCMU_DPU: c_uint = 0x18e8;
pub const CLK_CON_DIV_DIV_CLKCMU_DPU_ALT: c_uint = 0x18ec;
pub const CLK_CON_DIV_DIV_CLK_CMU_CMUREF: c_uint = 0x18f0;
pub const CLK_CON_DIV_PLL_SHARED0_DIV2: c_uint = 0x18f4;
pub const CLK_CON_DIV_PLL_SHARED0_DIV3: c_uint = 0x18f8;
pub const CLK_CON_DIV_PLL_SHARED0_DIV4: c_uint = 0x18fc;
pub const CLK_CON_DIV_PLL_SHARED1_DIV2: c_uint = 0x1900;
pub const CLK_CON_DIV_PLL_SHARED1_DIV3: c_uint = 0x1904;
pub const CLK_CON_DIV_PLL_SHARED1_DIV4: c_uint = 0x1908;
pub const CLK_CON_DIV_PLL_SHARED2_DIV2: c_uint = 0x190c;
pub const CLK_CON_DIV_PLL_SHARED4_DIV2: c_uint = 0x1910;
pub const CLK_CON_DIV_PLL_SHARED4_DIV3: c_uint = 0x1914;
pub const CLK_CON_DIV_PLL_SHARED4_DIV4: c_uint = 0x1918;
pub const CLK_CON_GAT_CLKCMU_G3D_BUS: c_uint = 0x2000;
pub const CLK_CON_GAT_CLKCMU_MIF_SWITCH: c_uint = 0x2004;
pub const CLK_CON_GAT_GATE_CLKCMU_APM_BUS: c_uint = 0x2008;
pub const CLK_CON_GAT_GATE_CLKCMU_AUD_CPU: c_uint = 0x200c;
pub const CLK_CON_GAT_GATE_CLKCMU_BUS0_BUS: c_uint = 0x2010;
pub const CLK_CON_GAT_GATE_CLKCMU_BUS1_BUS: c_uint = 0x2014;
pub const CLK_CON_GAT_GATE_CLKCMU_BUS1_SSS: c_uint = 0x2018;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK0: c_uint = 0x201c;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK1: c_uint = 0x2020;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK2: c_uint = 0x2024;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK3: c_uint = 0x2028;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK4: c_uint = 0x202c;
pub const CLK_CON_GAT_GATE_CLKCMU_CIS_CLK5: c_uint = 0x2030;
pub const CLK_CON_GAT_GATE_CLKCMU_CORE_BUS: c_uint = 0x2034;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_DBG_BUS: c_uint = 0x2038;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL0_SWITCH: c_uint = 0x203c;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL1_SWITCH: c_uint = 0x2040;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL2_BUSP: c_uint = 0x2044;
pub const CLK_CON_GAT_GATE_CLKCMU_CPUCL2_SWITCH: c_uint = 0x2048;
pub const CLK_CON_GAT_GATE_CLKCMU_CSIS_BUS: c_uint = 0x204c;
pub const CLK_CON_GAT_GATE_CLKCMU_CSIS_OIS_MCU: c_uint = 0x2050;
pub const CLK_CON_GAT_GATE_CLKCMU_DNC_BUS: c_uint = 0x2054;
pub const CLK_CON_GAT_GATE_CLKCMU_DNC_BUSM: c_uint = 0x2058;
pub const CLK_CON_GAT_GATE_CLKCMU_DNS_BUS: c_uint = 0x205c;
pub const CLK_CON_GAT_GATE_CLKCMU_DPU: c_uint = 0x2060;
pub const CLK_CON_GAT_GATE_CLKCMU_DPU_BUS: c_uint = 0x2064;
pub const CLK_CON_GAT_GATE_CLKCMU_DSP_BUS: c_uint = 0x2068;
pub const CLK_CON_GAT_GATE_CLKCMU_G2D_G2D: c_uint = 0x206c;
pub const CLK_CON_GAT_GATE_CLKCMU_G2D_MSCL: c_uint = 0x2070;
pub const CLK_CON_GAT_GATE_CLKCMU_G3D_SWITCH: c_uint = 0x2074;
pub const CLK_CON_GAT_GATE_CLKCMU_HPM: c_uint = 0x2078;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_BUS: c_uint = 0x207c;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_DPGTC: c_uint = 0x2080;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_USB31DRD: c_uint = 0x2084;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI0_USBDP_DEBUG: c_uint = 0x2088;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_BUS: c_uint = 0x208c;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_MMC_CARD: c_uint = 0x2090;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_PCIE: c_uint = 0x2094;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_UFS_CARD: c_uint = 0x2098;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI1_UFS_EMBD: c_uint = 0x209c;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI2_BUS: c_uint = 0x20a0;
pub const CLK_CON_GAT_GATE_CLKCMU_HSI2_PCIE: c_uint = 0x20a4;
pub const CLK_CON_GAT_GATE_CLKCMU_IPP_BUS: c_uint = 0x20a8;
pub const CLK_CON_GAT_GATE_CLKCMU_ITP_BUS: c_uint = 0x20ac;
pub const CLK_CON_GAT_GATE_CLKCMU_MCSC_BUS: c_uint = 0x20b0;
pub const CLK_CON_GAT_GATE_CLKCMU_MCSC_GDC: c_uint = 0x20b4;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC0_MFC0: c_uint = 0x20bc;
pub const CLK_CON_GAT_GATE_CLKCMU_MFC0_WFD: c_uint = 0x20c0;
pub const CLK_CON_GAT_GATE_CLKCMU_MIF_BUSP: c_uint = 0x20c4;
pub const CLK_CON_GAT_GATE_CLKCMU_NPU_BUS: c_uint = 0x20c8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_BUS: c_uint = 0x20cc;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC0_IP: c_uint = 0x20d0;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_BUS: c_uint = 0x20d4;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIC1_IP: c_uint = 0x20d8;
pub const CLK_CON_GAT_GATE_CLKCMU_PERIS_BUS: c_uint = 0x20dc;
pub const CLK_CON_GAT_GATE_CLKCMU_SSP_BUS: c_uint = 0x20e0;
pub const CLK_CON_GAT_GATE_CLKCMU_TNR_BUS: c_uint = 0x20e4;
pub const CLK_CON_GAT_GATE_CLKCMU_VRA_BUS: c_uint = 0x20e8;
...
#[no_mangle]
unsafe extern "C" fn exynos990_cmu_top_init(np: *mut device_node) -> void __init {
...
pub const PLL_CON0_MUX_CLKCMU_HSI0_BUS_USER: c_uint = 0x0600;
pub const PLL_CON0_MUX_CLKCMU_HSI0_USB31DRD_USER: c_uint = 0x0620;
pub const PLL_CON0_MUX_CLKCMU_HSI0_USBDP_DEBUG_USER: c_uint = 0x0630;
pub const PLL_CON0_MUX_CLKCMU_HSI0_DPGTC_USER: c_uint = 0x0610;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_DP_GTC_CLK: c_uint = 0x2004;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_PPMU_HSI0_BUS1_IPCLKPORT_ACLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_LHS_ACEL_D_HSI0_IPCLKPORT_I_CLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_RSTNSYNC_CLK_HSI0_BUS_IPCLKPORT_CLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_VGEN_LITE_HSI0_IPCLKPORT_CLK: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_DP_LINK_IPCLKPORT_I_PCLK: c_uint = 0x2008;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_D_TZPC_HSI0_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_LHM_AXI_P_HSI0_IPCLKPORT_I_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_PPMU_HSI0_BUS1_IPCLKPORT_PCLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_SYSMMU_USB_IPCLKPORT_CLK_S2: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_SYSREG_HSI0_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_ACLK_PHYCTRL: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USB31DRD_REF_CLK_40: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USBDPPHY_SCL_APB_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USBPCS_APB_CLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_BUS_CLK_EARLY: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_HSI0_CMU_HSI0_IPCLKPORT_PCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_XIU_D_HSI0_IPCLKPORT_ACLK: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_HSI0_UID_USB31DRD_IPCLKPORT_I_USBDPPHY_REF_SOC_PLL: c_uint = 0x2038;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC0_UART_DBG: c_uint = 0x0610;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_UART_DBG: c_uint = 0x0614;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI00_USI_USER: c_uint = 0x0620;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI00_USI_USER: c_uint = 0x0624;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI01_USI_USER: c_uint = 0x0630;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI01_USI_USER: c_uint = 0x0634;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI02_USI_USER: c_uint = 0x0640;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI02_USI_USER: c_uint = 0x0644;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI03_USI_USER: c_uint = 0x0650;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI03_USI_USER: c_uint = 0x0654;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI04_USI_USER: c_uint = 0x0660;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI04_USI_USER: c_uint = 0x0664;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI05_USI_USER: c_uint = 0x0670;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI05_USI_USER: c_uint = 0x0674;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI13_USI_USER: c_uint = 0x0680;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI13_USI_USER: c_uint = 0x0684;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI14_USI_USER: c_uint = 0x0690;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI14_USI_USER: c_uint = 0x0694;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI15_USI_USER: c_uint = 0x06a0;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI15_USI_USER: c_uint = 0x06a4;
pub const PLL_CON0_MUX_CLKCMU_PERIC0_USI_I2C_USER: c_uint = 0x06b0;
pub const PLL_CON1_MUX_CLKCMU_PERIC0_USI_I2C_USER: c_uint = 0x06b4;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_UART_DBG: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI00_USI: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI01_USI: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI02_USI: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI03_USI: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI04_USI: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI05_USI: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI13_USI: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI14_USI: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI15_USI: c_uint = 0x1824;
pub const CLK_CON_DIV_DIV_CLK_PERIC0_USI_I2C: c_uint = 0x1828;
...
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_GPIO_PERIC0_IPCLKPORT_PCLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_LHM_AXI_P_PERIC0_IPCLKPORT_I_CLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_10: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_11: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_12: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_13: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_14: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_15: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_4: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_5: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_6: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_7: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_8: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_IPCLK_9: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_10: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_11: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_12: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_13: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_14: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_15: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_4: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_5: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_6: c_uint = 0x2068;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_7: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_8: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP0_IPCLKPORT_PCLK_9: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_0: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_3: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_4: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_5: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_6: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_7: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_IPCLK_8: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_0: c_uint = 0x2094;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_15: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_3: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_4: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_5: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_6: c_uint = 0x20a8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_7: c_uint = 0x20ac;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_PERIC0_TOP1_IPCLKPORT_PCLK_8: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_BUSP_IPCLKPORT_CLK: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_UART_DBG_IPCLKPORT_CLK: c_uint = 0x20b8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI00_USI_IPCLKPORT_CLK: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI01_USI_IPCLKPORT_CLK: c_uint = 0x20c0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI02_USI_IPCLKPORT_CLK: c_uint = 0x20c4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI03_USI_IPCLKPORT_CLK: c_uint = 0x20c8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI04_USI_IPCLKPORT_CLK: c_uint = 0x20cc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI05_USI_IPCLKPORT_CLK: c_uint = 0x20d0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI13_USI_IPCLKPORT_CLK: c_uint = 0x20d4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI14_USI_IPCLKPORT_CLK: c_uint = 0x20d8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI15_USI_IPCLKPORT_CLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_RSTNSYNC_CLK_PERIC0_USI_I2C_IPCLKPORT_CLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC0_UID_SYSREG_PERIC0_IPCLKPORT_PCLK: c_uint = 0x20e4;
...
pub const PLL_CON0_MUX_CLKCMU_PERIC1_UART_BT_USER: c_uint = 0x0610;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_UART_BT_USER: c_uint = 0x0614;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI06_USI_USER: c_uint = 0x0620;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI06_USI_USER: c_uint = 0x0624;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI07_USI_USER: c_uint = 0x0630;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI07_USI_USER: c_uint = 0x0634;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI08_USI_USER: c_uint = 0x0640;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI08_USI_USER: c_uint = 0x0644;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI09_USI_USER: c_uint = 0x0650;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI09_USI_USER: c_uint = 0x0654;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI10_USI_USER: c_uint = 0x0660;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI10_USI_USER: c_uint = 0x0664;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI11_USI_USER: c_uint = 0x0670;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI11_USI_USER: c_uint = 0x0674;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI12_USI_USER: c_uint = 0x0680;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI12_USI_USER: c_uint = 0x0684;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI16_USI_USER: c_uint = 0x0690;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI16_USI_USER: c_uint = 0x0694;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI17_USI_USER: c_uint = 0x06a0;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI17_USI_USER: c_uint = 0x06a4;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI18_USI_USER: c_uint = 0x06b0;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI18_USI_USER: c_uint = 0x06b4;
pub const PLL_CON0_MUX_CLKCMU_PERIC1_USI_I2C_USER: c_uint = 0x06c0;
pub const PLL_CON1_MUX_CLKCMU_PERIC1_USI_I2C_USER: c_uint = 0x06c4;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_UART_BT: c_uint = 0x1800;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI06_USI: c_uint = 0x1804;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI07_USI: c_uint = 0x1808;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI08_USI: c_uint = 0x180c;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI09_USI: c_uint = 0x1810;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI10_USI: c_uint = 0x1814;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI11_USI: c_uint = 0x1818;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI12_USI: c_uint = 0x181c;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI16_USI: c_uint = 0x1820;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI17_USI: c_uint = 0x1824;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI18_USI: c_uint = 0x1828;
pub const CLK_CON_DIV_DIV_CLK_PERIC1_USI_I2C: c_uint = 0x182c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_PERIC1_CMU_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2004;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_UART_BT_IPCLKPORT_CLK: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI12_USI_IPCLKPORT_CLK: c_uint = 0x200c;
pub const CLK_CON_GAT_CLK_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI18_USI_IPCLKPORT_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_D_TZPC_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_GPIO_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_LHM_AXI_P_CSISPERIC1_IPCLKPORT_I_CLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_LHM_AXI_P_PERIC1_IPCLKPORT_I_CLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_10: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_11: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_12: c_uint = 0x202c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_13: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_14: c_uint = 0x2034;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_15: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_IPCLK_4: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_10: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_11: c_uint = 0x2044;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_12: c_uint = 0x2048;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_13: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_14: c_uint = 0x2050;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_15: c_uint = 0x2054;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP0_IPCLKPORT_PCLK_4: c_uint = 0x2058;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_0: c_uint = 0x205c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_1: c_uint = 0x2060;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_10: c_uint = 0x2064;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_12: c_uint = 0x206c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_13: c_uint = 0x2070;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_14: c_uint = 0x2074;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_15: c_uint = 0x2078;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_2: c_uint = 0x207c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_3: c_uint = 0x2080;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_4: c_uint = 0x2084;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_5: c_uint = 0x2088;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_6: c_uint = 0x208c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_7: c_uint = 0x2090;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_IPCLK_9: c_uint = 0x2098;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_0: c_uint = 0x209c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_1: c_uint = 0x20a0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_10: c_uint = 0x20a4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_12: c_uint = 0x20ac;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_13: c_uint = 0x20b0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_14: c_uint = 0x20b4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_15: c_uint = 0x20b8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_2: c_uint = 0x20bc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_3: c_uint = 0x20c0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_4: c_uint = 0x20c4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_5: c_uint = 0x20c8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_6: c_uint = 0x20cc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_7: c_uint = 0x20d0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_PERIC1_TOP1_IPCLKPORT_PCLK_9: c_uint = 0x20d8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_BUSP_IPCLKPORT_CLK: c_uint = 0x20dc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_OSCCLK_IPCLKPORT_CLK: c_uint = 0x20e0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI06_USI_IPCLKPORT_CLK: c_uint = 0x20e4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI07_USI_IPCLKPORT_CLK: c_uint = 0x20e8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI08_USI_IPCLKPORT_CLK: c_uint = 0x20ec;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI09_USI_IPCLKPORT_CLK: c_uint = 0x20f0;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI10_USI_IPCLKPORT_CLK: c_uint = 0x20f4;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI11_USI_IPCLKPORT_CLK: c_uint = 0x20f8;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI16_USI_IPCLKPORT_CLK: c_uint = 0x20fc;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI17_USI_IPCLKPORT_CLK: c_uint = 0x2100;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_RSTNSYNC_CLK_PERIC1_USI_I2C_IPCLKPORT_CLK: c_uint = 0x2104;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_SYSREG_PERIC1_IPCLKPORT_PCLK: c_uint = 0x2108;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI16_I3C_IPCLKPORT_I_PCLK: c_uint = 0x210c;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI16_I3C_IPCLKPORT_I_SCLK: c_uint = 0x2110;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI17_I3C_IPCLKPORT_I_PCLK: c_uint = 0x2114;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_USI17_I3C_IPCLKPORT_I_SCLK: c_uint = 0x2118;
pub const CLK_CON_GAT_GOUT_BLK_PERIC1_UID_XIU_P_PERIC1_IPCLKPORT_ACLK: c_uint = 0x211c;
...
pub const PLL_CON0_MUX_CLKCMU_PERIS_BUS_USER: c_uint = 0x0600;
pub const PLL_CON1_MUX_CLKCMU_PERIS_BUS_USER: c_uint = 0x0604;
pub const CLK_CON_MUX_MUX_CLK_PERIS_GIC: c_uint = 0x1000;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_SYSREG_PERIS_IPCLKPORT_PCLK: c_uint = 0x203c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_WDT_CLUSTER2_IPCLKPORT_PCLK: c_uint = 0x204c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_WDT_CLUSTER0_IPCLKPORT_PCLK: c_uint = 0x2048;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_PERIS_CMU_PERIS_IPCLKPORT_PCLK: c_uint = 0x200c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_BUSP_IPCLKPORT_CLK: c_uint = 0x2034;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_OSCCLK_IPCLKPORT_CLK: c_uint = 0x2010;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_RSTNSYNC_CLK_PERIS_GIC_IPCLKPORT_CLK: c_uint = 0x2038;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_AD_AXI_P_PERIS_IPCLKPORT_ACLKM: c_uint = 0x2014;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_OTP_CON_BIRA_IPCLKPORT_PCLK: c_uint = 0x2028;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_GIC_IPCLKPORT_CLK: c_uint = 0x201c;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_LHM_AXI_P_PERIS_IPCLKPORT_I_CLK: c_uint = 0x2020;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_MCT_IPCLKPORT_PCLK: c_uint = 0x2024;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_OTP_CON_TOP_IPCLKPORT_PCLK: c_uint = 0x2030;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_D_TZPC_PERIS_IPCLKPORT_PCLK: c_uint = 0x2018;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TMU_SUB_IPCLKPORT_PCLK: c_uint = 0x2040;
pub const CLK_CON_GAT_GOUT_BLK_PERIS_UID_TMU_TOP_IPCLKPORT_PCLK: c_uint = 0x2044;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_BIRA_IPCLKPORT_I_OSCCLK: c_uint = 0x2000;
pub const CLK_CON_GAT_CLK_BLK_PERIS_UID_OTP_CON_TOP_IPCLKPORT_I_OSCCLK: c_uint = 0x2008;
pub const QCH_CON_D_TZPC_PERIS_QCH: c_uint = 0x3004;
pub const QCH_CON_GIC_QCH: c_uint = 0x3008;
pub const QCH_CON_LHM_AXI_P_PERIS_QCH: c_uint = 0x300c;
pub const QCH_CON_MCT_QCH: c_uint = 0x3010;
pub const QCH_CON_OTP_CON_BIRA_QCH: c_uint = 0x3014;
pub const QCH_CON_OTP_CON_TOP_QCH: c_uint = 0x301c;
pub const QCH_CON_PERIS_CMU_PERIS_QCH: c_uint = 0x3020;
pub const QCH_CON_SYSREG_PERIS_QCH: c_uint = 0x3024;
pub const QCH_CON_TMU_SUB_QCH: c_uint = 0x3028;
pub const QCH_CON_TMU_TOP_QCH: c_uint = 0x302c;
pub const QCH_CON_WDT_CLUSTER0_QCH: c_uint = 0x3030;
pub const QCH_CON_WDT_CLUSTER2_QCH: c_uint = 0x3034;
...
#[no_mangle]
unsafe extern "C" fn exynos990_cmu_peris_init(np: *mut device_node) -> void __init {
...
// ----- platform_driver -----
#[no_mangle]
unsafe extern "C" fn exynos990_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exynos990_cmu_init() -> int __init {
