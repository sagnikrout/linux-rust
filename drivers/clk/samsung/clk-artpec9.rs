...
//! Source: drivers/clk/samsung/clk-artpec9.c
#![no_std]
...
pub const PLL_LOCKTIME_PLL_AUDIO: c_uint = 0x0000;
pub const PLL_LOCKTIME_PLL_SHARED0: c_uint = 0x0004;
pub const PLL_LOCKTIME_PLL_SHARED1: c_uint = 0x0008;
pub const PLL_CON0_PLL_AUDIO: c_uint = 0x0100;
pub const PLL_CON0_PLL_SHARED0: c_uint = 0x0120;
pub const PLL_CON0_PLL_SHARED1: c_uint = 0x0140;
pub const CLK_CON_MUX_CLKCMU_BUS: c_uint = 0x1000;
pub const CLK_CON_MUX_CLKCMU_CDC_CORE: c_uint = 0x1004;
pub const CLK_CON_MUX_CLKCMU_CORE_MAIN: c_uint = 0x1008;
pub const CLK_CON_MUX_CLKCMU_CPUCL_SWITCH: c_uint = 0x100c;
pub const CLK_CON_MUX_CLKCMU_VIO_AUDIO: c_uint = 0x1010;
pub const CLK_CON_MUX_CLKCMU_DLP_CORE: c_uint = 0x1014;
pub const CLK_CON_MUX_CLKCMU_FSYS0_BUS: c_uint = 0x1018;
pub const CLK_CON_MUX_CLKCMU_FSYS0_IP: c_uint = 0x101c;
pub const CLK_CON_MUX_CLKCMU_FSYS1_BUS: c_uint = 0x1020;
pub const CLK_CON_MUX_CLKCMU_FSYS1_SCAN0: c_uint = 0x1024;
pub const CLK_CON_MUX_CLKCMU_FSYS1_SCAN1: c_uint = 0x1028;
pub const CLK_CON_MUX_CLKCMU_GPU_2D: c_uint = 0x102c;
pub const CLK_CON_MUX_CLKCMU_GPU_3D: c_uint = 0x1030;
pub const CLK_CON_MUX_CLKCMU_IMEM_ACLK: c_uint = 0x1034;
pub const CLK_CON_MUX_CLKCMU_IMEM_CA5: c_uint = 0x1038;
pub const CLK_CON_MUX_CLKCMU_IMEM_JPEG: c_uint = 0x103c;
pub const CLK_CON_MUX_CLKCMU_IMEM_SSS: c_uint = 0x1040;
pub const CLK_CON_MUX_CLKCMU_IPA_CORE: c_uint = 0x1044;
pub const CLK_CON_MUX_CLKCMU_MIF_BUSP: c_uint = 0x1048;
pub const CLK_CON_MUX_CLKCMU_MIF_SWITCH: c_uint = 0x104c;
pub const CLK_CON_MUX_CLKCMU_PERI_DISP: c_uint = 0x1050;
pub const CLK_CON_MUX_CLKCMU_PERI_IP: c_uint = 0x1054;
pub const CLK_CON_MUX_CLKCMU_RSP_CORE: c_uint = 0x1058;
pub const CLK_CON_MUX_CLKCMU_TRFM: c_uint = 0x105c;
pub const CLK_CON_MUX_CLKCMU_VIO_CORE: c_uint = 0x1060;
pub const CLK_CON_MUX_CLKCMU_VIO_CORE_L: c_uint = 0x1064;
pub const CLK_CON_MUX_CLKCMU_VIP0: c_uint = 0x1068;
pub const CLK_CON_MUX_CLKCMU_VIP1: c_uint = 0x106c;
pub const CLK_CON_MUX_CLKCMU_VPP_CORE: c_uint = 0x1070;
pub const CLK_CON_DIV_CLKCMU_ADD: c_uint = 0x1800;
pub const CLK_CON_DIV_CLKCMU_BUS: c_uint = 0x1804;
pub const CLK_CON_DIV_CLKCMU_CDC_CORE: c_uint = 0x1808;
pub const CLK_CON_DIV_CLKCMU_CORE_MAIN: c_uint = 0x180c;
pub const CLK_CON_DIV_CLKCMU_CPUCL_SWITCH: c_uint = 0x1810;
pub const CLK_CON_DIV_CLKCMU_DLP_CORE: c_uint = 0x1814;
pub const CLK_CON_DIV_CLKCMU_FSYS0_BUS: c_uint = 0x1818;
pub const CLK_CON_DIV_CLKCMU_FSYS0_IP: c_uint = 0x181c;
pub const CLK_CON_DIV_CLKCMU_FSYS1_BUS: c_uint = 0x1820;
pub const CLK_CON_DIV_CLKCMU_FSYS1_SCAN0: c_uint = 0x1824;
pub const CLK_CON_DIV_CLKCMU_FSYS1_SCAN1: c_uint = 0x1828;
pub const CLK_CON_DIV_CLKCMU_GPU_2D: c_uint = 0x182c;
pub const CLK_CON_DIV_CLKCMU_GPU_3D: c_uint = 0x1830;
pub const CLK_CON_DIV_CLKCMU_IMEM_ACLK: c_uint = 0x1834;
pub const CLK_CON_DIV_CLKCMU_IMEM_CA5: c_uint = 0x1838;
pub const CLK_CON_DIV_CLKCMU_IMEM_JPEG: c_uint = 0x183c;
pub const CLK_CON_DIV_CLKCMU_IMEM_SSS: c_uint = 0x1840;
pub const CLK_CON_DIV_CLKCMU_IPA_CORE: c_uint = 0x1844;
pub const CLK_CON_DIV_CLKCMU_LCPU: c_uint = 0x1848;
pub const CLK_CON_DIV_CLKCMU_MIF_BUSP: c_uint = 0x184c;
pub const CLK_CON_DIV_CLKCMU_MIF_SWITCH: c_uint = 0x1850;
pub const CLK_CON_DIV_CLKCMU_PERI_DISP: c_uint = 0x1854;
pub const CLK_CON_DIV_CLKCMU_PERI_IP: c_uint = 0x1858;
pub const CLK_CON_DIV_CLKCMU_RSP_CORE: c_uint = 0x185c;
pub const CLK_CON_DIV_CLKCMU_TRFM: c_uint = 0x1860;
pub const CLK_CON_DIV_CLKCMU_VIO_AUDIO: c_uint = 0x1864;
pub const CLK_CON_DIV_CLKCMU_VIO_CORE: c_uint = 0x1868;
pub const CLK_CON_DIV_CLKCMU_VIO_CORE_L: c_uint = 0x186c;
pub const CLK_CON_DIV_CLKCMU_VIP0: c_uint = 0x1870;
pub const CLK_CON_DIV_CLKCMU_VIP1: c_uint = 0x1874;
pub const CLK_CON_DIV_CLKCMU_VPP_CORE: c_uint = 0x1878;
pub const CLK_CON_DIV_PLL_SHARED0_DIV2: c_uint = 0x187c;
pub const CLK_CON_DIV_PLL_SHARED0_DIV3: c_uint = 0x1880;
pub const CLK_CON_DIV_PLL_SHARED0_DIV4: c_uint = 0x1884;
pub const CLK_CON_DIV_PLL_SHARED1_DIV2: c_uint = 0x1888;
pub const CLK_CON_DIV_PLL_SHARED1_DIV3: c_uint = 0x188c;
pub const CLK_CON_DIV_PLL_SHARED1_DIV4: c_uint = 0x1890;
    ...
    PLL_LOCKTIME_PLL_SHARED0, PLL_CON0_PLL_SHARED0, core::ptr::null_mut()),
    PLL(pll_a9fracm, CLK_FOUT_SHARED1_PLL, "fout_pll_shared1", "fin_pll",
    PLL_LOCKTIME_PLL_SHARED1, PLL_CON0_PLL_SHARED1, core::ptr::null_mut()),
...
pub const PLL_CON0_MUX_CLK_BUS_ACLK_USER: c_uint = 0x0100;
...
pub const PLL_CON0_MUX_CLK_CORE_ACLK_USER: c_uint = 0x0100;
...
pub const PLL_LOCKTIME_PLL0_CPUCL: c_uint = 0x0000;
pub const PLL_LOCKTIME_PLL1_CPUCL: c_uint = 0x0008;
pub const PLL_CON0_MUX_CLKCMU_CPUCL_SWITCH_SCU_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLKCMU_CPUCL_SWITCH_USER: c_uint = 0x0120;
pub const PLL_CON0_PLL0_CPUCL: c_uint = 0x0140;
pub const PLL_CON0_PLL1_CPUCL: c_uint = 0x0160;
pub const CLK_CON_MUX_CLK_CPUCL_PLL: c_uint = 0x1000;
pub const CLK_CON_MUX_CLK_CPUCL_PLL_SCU: c_uint = 0x1004;
pub const CLK_CON_DIV_CLK_CPUCL_CLUSTER_PERIPHCLK: c_uint = 0x1800;
pub const CLK_CON_DIV_CLK_CPUCL_CLUSTER_GICCLK: c_uint = 0x1804;
pub const CLK_CON_DIV_CLK_CPUCL_CLUSTER_PCLK: c_uint = 0x1808;
pub const CLK_CON_DIV_CLK_CPUCL_CMUREF: c_uint = 0x180c;
pub const CLK_CON_DIV_CLK_CPUCL_CPU: c_uint = 0x1810;
pub const CLK_CON_DIV_CLK_CPUCL_CLUSTER_ATCLK: c_uint = 0x1818;
pub const CLK_CON_DIV_CLK_CPUCL_CLUSTER_SCU: c_uint = 0x181c;
pub const CLK_CON_DIV_CLK_CPUCL_DBG: c_uint = 0x1820;
pub const CLK_CON_GAT_CLK_CLUSTER_CPU: c_uint = 0x2008;
pub const CLK_CON_GAT_CLK_CPUCL_SHORTSTOP: c_uint = 0x200c;
pub const CSSYS_IPCLKPORT_ATCLK: c_uint = 0x2070;
pub const CSSYS_IPCLKPORT_PCLKDBG: c_uint = 0x2074;
pub const DMYQCH_CON_CSSYS_QCH: c_uint = 0x3000;
pub const DMYQCH_CON_CLUSTER_QCH_CORECLK0: c_uint = 0x3104;
pub const DMYQCH_CON_CLUSTER_QCH_CORECLK1: c_uint = 0x3108;
pub const DMYQCH_CON_CLUSTER_QCH_CORECLK2: c_uint = 0x310c;
pub const DMYQCH_CON_CLUSTER_QCH_CORECLK3: c_uint = 0x3110;
pub const DMYQCH_CON_CLUSTER_QCH_CORECLK4: c_uint = 0x3114;
pub const DMYQCH_CON_CLUSTER_QCH_CORECLK5: c_uint = 0x3118;
pub const DMYQCH_CON_CLUSTER_QCH_PERIPHCLK: c_uint = 0x311c;
...
pub const PLL_CON0_MUX_CLK_FSYS0_BUS_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLK_FSYS0_IP_USER: c_uint = 0x0120;
pub const PLL_CON0_MUX_CLK_FSYS0_MAIN_USER: c_uint = 0x0140;
pub const CLK_CON_DIV_CLK_FSYS0_125: c_uint = 0x1800;
pub const CLK_CON_DIV_CLK_FSYS0_ADC: c_uint = 0x1804;
pub const CLK_CON_DIV_CLK_FSYS0_BUS_300: c_uint = 0x1808;
pub const CLK_CON_DIV_CLK_FSYS0_EQOS0: c_uint = 0x1814;
pub const CLK_CON_DIV_CLK_FSYS0_EQOS1: c_uint = 0x1818;
pub const CLK_CON_DIV_CLK_FSYS0_EQOS_250: c_uint = 0x181C;
pub const CLK_CON_DIV_CLK_FSYS0_MMC_CARD0: c_uint = 0x1820;
pub const CLK_CON_DIV_CLK_FSYS0_MMC_CARD1: c_uint = 0x1824;
pub const CLK_CON_DIV_CLK_FSYS0_MMC_CARD2: c_uint = 0x1828;
pub const CLK_CON_DIV_CLK_FSYS0_QSPI: c_uint = 0x182c;
pub const CLK_CON_DIV_CLK_FSYS0_SFMC_NAND: c_uint = 0x1830;
pub const CLK_CON_FSYS0_I2C0_IPCLKPORT_I_PCLK: c_uint = 0x2040;
pub const CLK_CON_FSYS0_I2C1_IPCLKPORT_I_PCLK: c_uint = 0x2044;
pub const CLK_CON_MMC0_IPCLKPORT_I_ACLK: c_uint = 0x2078;
pub const CLK_CON_MMC1_IPCLKPORT_I_ACLK: c_uint = 0x2080;
pub const CLK_CON_MMC2_IPCLKPORT_I_ACLK: c_uint = 0x2088;
pub const CLK_CON_PWM_IPCLKPORT_I_PCLK_S0: c_uint = 0x2090;
pub const CLK_CON_DMYQCH_CON_ADC_WRAP_QCH: c_uint = 0x3000;
pub const CLK_CON_DMYQCH_CON_EQOS_TOP0_QCH: c_uint = 0x3004;
pub const CLK_CON_DMYQCH_CON_EQOS_TOP1_QCH: c_uint = 0x3008;
pub const CLK_CON_DMYQCH_CON_FSYS0_I3C0_QCH: c_uint = 0x3010;
pub const CLK_CON_DMYQCH_CON_FSYS0_I3C1_QCH: c_uint = 0x3014;
pub const CLK_CON_DMYQCH_CON_MMC0_QCH: c_uint = 0x3018;
pub const CLK_CON_DMYQCH_CON_MMC1_QCH: c_uint = 0x301c;
pub const CLK_CON_DMYQCH_CON_MMC2_QCH: c_uint = 0x3020;
pub const CLK_CON_DMYQCH_CON_QSPI_QCH: c_uint = 0x3024;
pub const CLK_CON_DMYQCH_CON_SFMC_QCH: c_uint = 0x3028;
...
pub const PLL_LOCKTIME_PLL_FSYS1: c_uint = 0x0000;
pub const PLL_CON0_MUX_CLK_FSYS1_BUS_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLK_FSYS1_SCAN0_USER: c_uint = 0x0120;
pub const PLL_CON0_MUX_CLK_FSYS1_SCAN1_USER: c_uint = 0x0140;
pub const PLL_CON0_PLL_FSYS1: c_uint = 0x0160;
pub const CLK_CON_DIV_CLK_FSYS1_200: c_uint = 0x1808;
pub const CLK_CON_DIV_CLK_FSYS1_BUS_300: c_uint = 0x1810;
pub const CLK_CON_DIV_CLK_FSYS1_OTP_MEM: c_uint = 0x1814;
pub const CLK_CON_DIV_CLK_FSYS1_PCIE_PHY_REFCLK_SYSPLL: c_uint = 0x1818;
pub const CLK_CON_FSYS1_UART0_IPCLKPORT_I_PCLK: c_uint = 0x202c;
pub const CLK_CON_FSYS1_UART0_IPCLKPORT_I_SCLK_UART: c_uint = 0x2030;
pub const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_PHY_APB2CR_PCLK_300: c_uint = 0x205c;
pub const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X1_DBI_ACLK_SOC: c_uint = 0x2068;
pub const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X1_MSTR_ACLK_SOC: c_uint = 0x206c;
pub const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X1_SLV_ACLK_SOC: c_uint = 0x2070;
pub const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X2_DBI_ACLK_SOC: c_uint = 0x2078;
pub const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X2_MSTR_ACLK_SOC: c_uint = 0x2080;
pub const CLK_CON_PCIE_TOP_IPCLKPORT_PCIE_SUB_CON_X2_SLV_ACLK_SOC: c_uint = 0x2084;
pub const CLK_CON_USB20DRD_IPCLKPORT_ACLK_PHYCTRL_20: c_uint = 0x209c;
pub const CLK_CON_USB20DRD_IPCLKPORT_BUS_CLK_EARLY: c_uint = 0x20a0;
pub const CLK_CON_XHB_AHBBR_FSYS1_IPCLKPORT_CLK: c_uint = 0x20a8;
pub const CLK_CON_XHB_USB_IPCLKPORT_CLK: c_uint = 0x20ac;
pub const CLK_CON_DMYQCH_CON_TZ400_QCH: c_uint = 0x3004;
pub const CLK_CON_DMYQCH_CON_PCIE_TOP_QCH_PHY_100: c_uint = 0x309c;
pub const CLK_CON_QCH_CON_MMU_FSYS1_QCH_U_TBU_0_0: c_uint = 0x3050;
pub const CLK_CON_QCH_CON_MMU_FSYS1_QCH_U_TBU_1_0: c_uint = 0x3058;
...
pub const PLL_CON0_MUX_CLK_IMEM_ACLK_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLK_IMEM_CA5_USER: c_uint = 0x0120;
pub const PLL_CON0_MUX_CLK_IMEM_JPEG_USER: c_uint = 0x0140;
pub const PLL_CON0_MUX_CLK_IMEM_SSS_USER: c_uint = 0x0160;
pub const CLK_CON_MCT0_IPCLKPORT_PCLK: c_uint = 0x20b4;
pub const CLK_CON_MCT1_IPCLKPORT_PCLK: c_uint = 0x20b8;
pub const CLK_CON_MCT2_IPCLKPORT_PCLK: c_uint = 0x20bc;
pub const CLK_CON_MCT3_IPCLKPORT_PCLK: c_uint = 0x20c0;
pub const CLK_CON_TMU_APB_IPCLKPORT_PCLK: c_uint = 0x20d4;
pub const CLK_CON_DMYQCH_CON_CA5_0_QCH: c_uint = 0x3008;
pub const CLK_CON_DMYQCH_CON_CA5_1_QCH: c_uint = 0x3018;
pub const CLK_CON_DMYQCH_CON_INTMEM_QCH: c_uint = 0x3020;
pub const CLK_CON_QCH_CON_GIC_CA55_QCHANNEL_SLAVE_0: c_uint = 0x306c;
pub const CLK_CON_QCH_CON_GIC_CA5_0_QCH: c_uint = 0x3078;
pub const CLK_CON_QCH_CON_GIC_CA5_1_QCH: c_uint = 0x307c;
pub const CLK_CON_QCH_CON_MMU_IMEM_QCH_U_TBU_0_0: c_uint = 0x30ac;
pub const CLK_CON_QCH_CON_MMU_IMEM_QCH_U_TBU_1_0: c_uint = 0x30b4;
...
#[no_mangle]
unsafe extern "C" fn artpec9_cmu_imem_init(np: *mut device_node) -> void __init {
    static void __init artpec9_cmu_imem_init(struct device_node *np)
    {
    exynos_arm64_register_cmu(core::ptr::null_mut(), np, &cmu_imem_info);
    }
...
pub const PLL_CON0_MUX_CLK_PERI_DISP_USER: c_uint = 0x0100;
pub const PLL_CON0_MUX_CLK_PERI_IP_USER: c_uint = 0x0120;
pub const CLK_CON_DIV_CLK_PERI_125: c_uint = 0x1800;
pub const CLK_CON_DIV_CLK_PERI_PCLK: c_uint = 0x180c;
pub const CLK_CON_DIV_CLK_PERI_SPI: c_uint = 0x1810;
pub const CLK_CON_DIV_CLK_PERI_UART1: c_uint = 0x1814;
pub const CLK_CON_DIV_CLK_PERI_UART2: c_uint = 0x1818;
pub const CLK_CON_APB_ASYNC_DSIM_IPCLKPORT_PCLKS: c_uint = 0x2000;
pub const CLK_CON_PERI_I2C2_IPCLKPORT_I_PCLK: c_uint = 0x202c;
pub const CLK_CON_PERI_I2C3_IPCLKPORT_I_PCLK: c_uint = 0x2030;
pub const CLK_CON_PERI_SPI0_IPCLKPORT_I_PCLK: c_uint = 0x2054;
pub const CLK_CON_PERI_SPI0_IPCLKPORT_I_SCLK_SPI: c_uint = 0x2058;
pub const CLK_CON_PERI_UART1_IPCLKPORT_I_PCLK: c_uint = 0x205c;
pub const CLK_CON_PERI_UART1_IPCLKPORT_I_SCLK_UART: c_uint = 0x2060;
pub const CLK_CON_PERI_UART2_IPCLKPORT_I_PCLK: c_uint = 0x2064;
pub const CLK_CON_PERI_UART2_IPCLKPORT_I_SCLK_UART: c_uint = 0x2068;
pub const CLK_CON_DMYQCH_CON_DMA4DSIM_QCH: c_uint = 0x3000;
pub const CLK_CON_DMYQCH_CON_PERI_I3C2_QCH: c_uint = 0x3004;
pub const CLK_CON_DMYQCH_CON_PERI_I3C3_QCH: c_uint = 0x3008;
...
#[no_mangle]
unsafe extern "C" fn artpec9_cmu_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn artpec9_cmu_init() -> int __init {
