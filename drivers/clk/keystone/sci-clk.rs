...
//! Source: drivers/clk/keystone/sci-clk.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sci_clk_provider {
    pub sci: *const ti_sci_handle,
    pub ops: *const ti_sci_clk_ops,
    pub dev: *mut device,
    pub clocks: *mut sci_clk,
...
pub struct sci_clk {
    ...
    pub clk_id: u32,
    pub num_parents: u32,
    pub provider: *mut sci_clk_provider,
    pub flags: u8,
    pub node: list_head,
    pub cached_req: c_ulong,
    pub cached_res: c_ulong,
    pub parent_id: c_int,
    pub rate: c_ulong,
}
...
//
#[no_mangle]
unsafe extern "C" fn sci_clk_prepare(hw: *mut clk_hw) -> c_int {
    static int sci_clk_prepare(struct clk_hw *hw)
    {
    struct sci_clk *clk = to_sci_clk(hw);
    let mut enable_ssc: bool = clk.flags & SCI_CLK_SSC_ENABLE;
    let mut allow_freq_change: bool = clk.flags & SCI_CLK_ALLOW_FREQ_CHANGE;
    let mut input_termination: bool = clk.flags & SCI_CLK_INPUT_TERMINATION;
...
//
#[no_mangle]
unsafe extern "C" fn sci_clk_unprepare(hw: *mut clk_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn sci_clk_is_prepared(hw: *mut clk_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sci_clk_get_parent(hw: *mut clk_hw) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn sci_clk_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sci_clk_restore_context(hw: *mut clk_hw) {
...
//
    ...
    char **parent_names = core::ptr::null_mut();
    int i;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn _cmp_sci_clk(a: *const c_void, b: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sci_init_clocks(p: *mut sci_clk_provider) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sci_scan_clocks_from_fw(provider: *mut sci_clk_provider) -> c_int {
    static int ti_sci_scan_clocks_from_fw(struct sci_clk_provider *provider)
    {
    int ret;
    let mut num_clks: c_int = 0;
    struct sci_clk **clks = core::ptr::null_mut();
    struct sci_clk **tmp_clks;
    struct sci_clk *sci_clk;
    let mut max_clks: c_int = 0;
    let mut clk_id: c_int = 0;
    let mut dev_id: c_int = 0;
    let mut num_parents: u32 = 0;
    let mut gap_size: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ti_sci_scan_clocks_from_dt(provider: *mut sci_clk_provider) -> c_int {
    ...
    "clocks", "assigned-clocks", "assigned-clock-parents", core::ptr::null_mut()
    };
...
// Check if this clock id is valid
    ...
    list_sort(core::ptr::null_mut(), &clks, _cmp_sci_clk_list);
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_clk_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_sci_clk_remove(pdev: *mut platform_device) {
