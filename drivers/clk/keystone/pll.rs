...
//! Source: drivers/clk/keystone/pll.c
#![no_std]
...
pub const PLLM_LOW_MASK: c_uint = 0x3f;
pub const PLLM_HIGH_MASK: c_uint = 0x7ffc0;
pub const MAIN_PLLM_HIGH_MASK: c_uint = 0x7f000;
pub const PLLM_HIGH_SHIFT: c_int = 6;
pub const PLLD_MASK: c_uint = 0x3f;
pub const CLKOD_MASK: c_uint = 0x780000;
pub const CLKOD_SHIFT: c_int = 19;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_pll_data {
    pub has_pllctrl: bool,
    pub phy_pllm: u32,
    pub phy_pll_ctl0: u32,
    pub pllm: *mut void __iomem,
    pub pllod: *mut void __iomem,
    pub pll_ctl0: *mut void __iomem,
    pub pllm_lower_mask: u32,
    pub pllm_upper_mask: u32,
    pub pllm_upper_shift: u32,
    pub plld_mask: u32,
    pub clkod_mask: u32,
    pub clkod_shift: u32,
    pub postdiv: u32,
...
pub struct clk_pll {
    ...
    let mut mult: u32 = 0, prediv, postdiv, val;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pll_data->pllod) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn _of_pll_clk_init(node: *mut device_node, pllctrl: bool) -> void __init {
...
//
    ...
    clk = clk_register_pll(core::ptr::null_mut(), node.name, parent_name, pll_data);
...
//
#[no_mangle]
unsafe extern "C" fn of_keystone_pll_clk_init(node: *mut device_node) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn of_keystone_main_pll_clk_init(node: *mut device_node) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn of_pll_div_clk_init(node: *mut device_node) -> void __init {
    ...
    clk = clk_register_divider(core::ptr::null_mut(), clk_name, parent_name, 0, reg, shift,
    mask, 0, core::ptr::null_mut());
    if (IS_ERR(clk)) {
...
//
#[no_mangle]
unsafe extern "C" fn of_pll_mux_clk_init(node: *mut device_node) -> void __init {
    ...
    clk = clk_register_mux(core::ptr::null_mut(), clk_name, (const char **)&parents,
