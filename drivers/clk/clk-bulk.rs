...
//
    ...
    clks[i].id = core::ptr::null_mut();
    clks[i].clk = core::ptr::null_mut();
    }
    for (i = 0; i < num_clks; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn clk_bulk_put(num_clks: c_int, clks: *mut clk_bulk_data) {
    void clk_bulk_put(int num_clks, struct clk_bulk_data *clks)
    {
    while (--num_clks >= 0) {
    clk_put(clks[num_clks].clk);
    clks[num_clks].clk = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn clk_bulk_put_all(num_clks: c_int, clks: *mut clk_bulk_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn clk_bulk_unprepare(num_clks: c_int, clks: *const clk_bulk_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn clk_bulk_disable(num_clks: c_int, clks: *const clk_bulk_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn clk_bulk_enable(num_clks: c_int, clks: *const clk_bulk_data) -> int __must_check {
