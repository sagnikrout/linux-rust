...
//! Source: drivers/clk/berlin/bg2.c
#![no_std]
...
pub const REG_PINMUX0: c_uint = 0x0000;
pub const REG_PINMUX1: c_uint = 0x0004;
pub const REG_SYSPLLCTL0: c_uint = 0x0014;
pub const REG_SYSPLLCTL4: c_uint = 0x0024;
pub const REG_MEMPLLCTL0: c_uint = 0x0028;
pub const REG_MEMPLLCTL4: c_uint = 0x0038;
pub const REG_CPUPLLCTL0: c_uint = 0x003c;
pub const REG_CPUPLLCTL4: c_uint = 0x004c;
pub const REG_AVPLLCTL0: c_uint = 0x0050;
pub const REG_AVPLLCTL31: c_uint = 0x00cc;
pub const REG_AVPLLCTL62: c_uint = 0x0148;
pub const REG_PLLSTATUS: c_uint = 0x014c;
pub const REG_CLKENABLE: c_uint = 0x0150;
pub const REG_CLKSELECT0: c_uint = 0x0154;
pub const REG_CLKSELECT1: c_uint = 0x0158;
pub const REG_CLKSELECT2: c_uint = 0x015c;
pub const REG_CLKSELECT3: c_uint = 0x0160;
pub const REG_CLKSWITCH0: c_uint = 0x0164;
pub const REG_CLKSWITCH1: c_uint = 0x0168;
pub const REG_RESET_TRIGGER: c_uint = 0x0178;
pub const REG_RESET_STATUS0: c_uint = 0x017c;
pub const REG_RESET_STATUS1: c_uint = 0x0180;
pub const REG_SW_GENERIC0: c_uint = 0x0184;
pub const REG_SW_GENERIC3: c_uint = 0x0190;
pub const REG_PRODUCTID: c_uint = 0x01cc;
pub const REG_PRODUCTID_EXT: c_uint = 0x01d0;
pub const REG_GFX3DCORE_CLKCTL: c_uint = 0x022c;
pub const REG_GFX3DSYS_CLKCTL: c_uint = 0x0230;
pub const REG_ARC_CLKCTL: c_uint = 0x0234;
pub const REG_VIP_CLKCTL: c_uint = 0x0238;
pub const REG_SDIO0XIN_CLKCTL: c_uint = 0x023c;
pub const REG_SDIO1XIN_CLKCTL: c_uint = 0x0240;
pub const REG_GFX3DEXTRA_CLKCTL: c_uint = 0x0244;
pub const REG_GFX3D_RESET: c_uint = 0x0248;
pub const REG_GC360_CLKCTL: c_uint = 0x024c;
pub const REG_SDIO_DLLMST_CLKCTL: c_uint = 0x0250;
//
...
#[no_mangle]
unsafe extern "C" fn berlin2_clock_setup(np: *mut device_node) -> void __init {
...
// reference clock bypass switches
    ...
    hw = clk_hw_register_mux(core::ptr::null_mut(), "syspll_byp", parent_names, 2,
    ...
    parent_names[1] = clk_names[REFCLK];
    hw = clk_hw_register_mux(core::ptr::null_mut(), "mempll_byp", parent_names, 2,
    ...
    parent_names[1] = clk_names[REFCLK];
    hw = clk_hw_register_mux(core::ptr::null_mut(), "cpupll_byp", parent_names, 2,
...
// clock muxes
    ...
    hw = clk_hw_register_mux(core::ptr::null_mut(), clk_names[AUDIO1_PLL], parent_names, 2,
    0, gbase + REG_CLKSELECT2, 29, 1, 0, &lock);
    if (IS_ERR(hw))
    goto bg2_fail;
    parent_names[0] = clk_names[VIDEO0_PLL];
    parent_names[1] = clk_names[VIDEO_EXT0];
    hw = clk_hw_register_mux(core::ptr::null_mut(), clk_names[VIDEO0_IN], parent_names, 2,
    0, gbase + REG_CLKSELECT3, 4, 1, 0, &lock);
    if (IS_ERR(hw))
    goto bg2_fail;
    parent_names[0] = clk_names[VIDEO1_PLL];
    parent_names[1] = clk_names[VIDEO_EXT0];
    hw = clk_hw_register_mux(core::ptr::null_mut(), clk_names[VIDEO1_IN], parent_names, 2,
    0, gbase + REG_CLKSELECT3, 6, 1, 0, &lock);
    if (IS_ERR(hw))
    goto bg2_fail;
    parent_names[0] = clk_names[AVPLL_A2];
    parent_names[1] = clk_names[AVPLL_B2];
    hw = clk_hw_register_mux(core::ptr::null_mut(), clk_names[VIDEO1_PLL], parent_names, 2,
    0, gbase + REG_CLKSELECT3, 7, 1, 0, &lock);
    if (IS_ERR(hw))
    goto bg2_fail;
    parent_names[0] = clk_names[VIDEO2_PLL];
    parent_names[1] = clk_names[VIDEO_EXT0];
    hw = clk_hw_register_mux(core::ptr::null_mut(), clk_names[VIDEO2_IN], parent_names, 2,
    0, gbase + REG_CLKSELECT3, 9, 1, 0, &lock);
    if (IS_ERR(hw))
    goto bg2_fail;
    parent_names[0] = clk_names[AVPLL_B1];
    parent_names[1] = clk_names[AVPLL_A5];
    hw = clk_hw_register_mux(core::ptr::null_mut(), clk_names[VIDEO2_PLL], parent_names, 2,
...
// clock gate cells
    ...
    hws[CLKID_GETH0 + n] = clk_hw_register_gate(core::ptr::null_mut(), gd.name,
