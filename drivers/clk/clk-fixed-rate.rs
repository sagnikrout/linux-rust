...
#[no_mangle]
unsafe extern "C" fn devm_clk_hw_register_fixed_rate_release(dev: *mut device, res: *mut c_void) {
...
pub unsafe extern "C" fn clk_hw_unregister_fixed_rate(hw: *mut clk_hw) {
    ...
    hw = clk_hw_register_fixed_rate_with_accuracy(core::ptr::null_mut(), clk_name, core::ptr::null_mut(),
    0, rate, accuracy);
    if (IS_ERR(hw))
    return hw;
...
//
#[no_mangle]
pub unsafe extern "C" fn of_fixed_clk_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_fixed_clk_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn of_fixed_clk_probe(pdev: *mut platform_device) -> c_int {
