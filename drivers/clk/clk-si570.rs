...
//! Source: drivers/clk/clk-si570.c
#![no_std]
...
// Si570 registers
pub const SI570_REG_HS_N1: c_int = 7;
pub const SI570_REG_N1_RFREQ0: c_int = 8;
pub const SI570_REG_RFREQ1: c_int = 9;
pub const SI570_REG_RFREQ2: c_int = 10;
pub const SI570_REG_RFREQ3: c_int = 11;
pub const SI570_REG_RFREQ4: c_int = 12;
pub const SI570_REG_CONTROL: c_int = 135;
pub const SI570_REG_FREEZE_DCO: c_int = 137;
pub const SI570_DIV_OFFSET_7PPM: c_int = 6;
pub const HS_DIV_SHIFT: c_int = 5;
pub const HS_DIV_MASK: c_uint = 0xe0;
pub const HS_DIV_OFFSET: c_int = 4;
pub const N1_6_2_MASK: c_uint = 0x1f;
pub const N1_1_0_MASK: c_uint = 0xc0;
pub const RFREQ_37_32_MASK: c_uint = 0x3f;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_si570_info {
    pub max_freq: u64,
    pub has_temperature_stability: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_si570 {
    pub hw: clk_hw,
    pub regmap: *mut regmap,
    pub div_offset: c_uint,
    pub info: *const clk_si570_info,
    pub fxtal: u64,
    pub n1: c_uint,
    pub hs_div: c_uint,
    pub rfreq: u64,
...
//
#[no_mangle]
unsafe extern "C" fn si570_update_rfreq(data: *mut clk_si570) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si570_set_frequency(data: *mut clk_si570, frequency: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si570_regmap_is_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn si570_regmap_is_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn si570_probe(client: *mut i2c_client) -> c_int {
