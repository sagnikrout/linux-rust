...
//! Source: drivers/clk/visconti/clkc-tmpv770x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn visconti_clk_probe(pdev: *mut platform_device) -> c_int {
    ...
    clk_hw_register_fixed_factor(core::ptr::null_mut(),
