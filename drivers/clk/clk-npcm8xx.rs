...
//! Source: drivers/clk/clk-npcm8xx.c
#![no_std]
...
pub const NPCM8XX_CLKSEL: c_uint = 0x04;
pub const NPCM8XX_CLKDIV1: c_uint = 0x08;
pub const NPCM8XX_CLKDIV2: c_uint = 0x2C;
pub const NPCM8XX_CLKDIV3: c_uint = 0x58;
pub const NPCM8XX_CLKDIV4: c_uint = 0x7C;
pub const NPCM8XX_PLLCON0: c_uint = 0x0C;
pub const NPCM8XX_PLLCON1: c_uint = 0x10;
pub const NPCM8XX_PLLCON2: c_uint = 0x54;
pub const NPCM8XX_PLLCONG: c_uint = 0x60;
pub const NPCM8XX_THRTL_CNT: c_uint = 0xC0;

    static void __iomem *clk_base;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm8xx_clk_pll {
    pub pllcon: *mut void __iomem,
    pub id: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm8xx_clk_pll_data {
    pub name: *const c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm8xx_clk_div_data {
    pub reg: u32,
    pub shift: u8,
    pub width: u8,
    pub name: *const c_char,
    pub parent_hw: *const clk_hw,
    pub clk_divider_flags: c_ulong,
    pub flags: c_ulong,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm8xx_clk_mux_data {
    pub shift: u8,
    pub mask: u32,
    pub table: *const u32,
    pub name: *const c_char,
