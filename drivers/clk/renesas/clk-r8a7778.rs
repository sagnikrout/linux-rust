...
//! Source: drivers/clk/renesas/clk-r8a7778.c
#![no_std]
...
// Clock dividers per bits 1 and 2 of MODEMR
    ...
    {
    if (!strcmp(name, "plla")) {
    return clk_register_fixed_factor(core::ptr::null_mut(), "plla",
    of_clk_get_parent_name(np, 0), 0,
    r8a7778_rates[cpg_mode_rates].plla_mult, 1);
    } else if (!strcmp(name, "pllb")) {
    return clk_register_fixed_factor(core::ptr::null_mut(), "pllb",
    of_clk_get_parent_name(np, 0), 0,
    ...
    return clk_register_fixed_factor(core::ptr::null_mut(),
    r8a7778_divs[i].name,
    "plla", 0, 1,
...
#[no_mangle]
unsafe extern "C" fn r8a7778_cpg_clocks_init(np: *mut device_node) -> void __init {
    ...
    if (data == core::ptr::null_mut() || clks == core::ptr::null_mut()) {
