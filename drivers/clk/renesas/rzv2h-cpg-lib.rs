...
//! Source: drivers/clk/renesas/rzv2h-cpg-lib.c
#![no_std]
...
//
    ...
    {
    let mut input_fref: c_ulong = limits.input_fref ?: (24 * MEGA);
    let mut fout_min_millihz: u64 = mul_u32_u32(limits.fout.min, MILLI);
    let mut fout_max_millihz: u64 = mul_u32_u32(limits.fout.max, MILLI);
...
// Initialize best error to maximum possible value
    ...
    let mut fref: u32 = input_fref / p.p;
    u16 divider;
