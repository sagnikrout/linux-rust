...
//! Source: drivers/clk/renesas/r8a77970-cpg-mssr.c
#![no_std]
...
pub const CPG_SD0CKCR: c_uint = 0x0074;
...
#[no_mangle]
unsafe extern "C" fn r8a77970_cpg_mssr_init(dev: *mut device) -> int __init {
    ...
    return clk_register_divider_table(core::ptr::null_mut(), core.name,
