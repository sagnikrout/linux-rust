...
//! Source: drivers/clk/renesas/r8a779a0-cpg-mssr.c
#![no_std]
...
// Module Clocks
    ...
    .offset = _offset)
pub const CPG_PLL20CR: c_uint = 0x0834	/* PLL20 Control Register */;
pub const CPG_PLL21CR: c_uint = 0x0838	/* PLL21 Control Register */;
pub const CPG_PLL30CR: c_uint = 0x083c	/* PLL30 Control Register */;
pub const CPG_PLL31CR: c_uint = 0x0840	/* PLL31 Control Register */;
pub const CPG_PLL4CR: c_uint = 0x0844	/* PLL4 Control Register */;
...
#[no_mangle]
unsafe extern "C" fn r8a779a0_cpg_mssr_init(dev: *mut device) -> int __init {
