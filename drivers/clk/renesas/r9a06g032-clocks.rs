...
//! Source: drivers/clk/renesas/r9a06g032-clocks.c
#![no_std]
...
pub const R9A06G032_SYSCTRL_USB: c_uint = 0x00;

pub const R9A06G032_SYSCTRL_DMAMUX: c_uint = 0xA0;
pub const R9A06G032_SYSCTRL_RSTEN: c_uint = 0x120;

pub const R9A06G032_SYSCTRL_RSTCTRL: c_uint = 0x198;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r9a06g032_gate {
    pub midle: regbit gate, reset, ready,,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r9a06g032_clkdesc {
    pub name: *const c_char,
    pub managed:1: u32,
    pub type:3: enum gate_type,
    pub index:8: u32,
    pub /: *mut *mut uint32_t source:8; / source index + 1 (0 == none),
    union {
// type = K_GATE
    pub gate: r9a06g032_gate,
// type = K_DIV
    struct {
    pub reg:10: unsigned int min:10, max:10,,
    pub table: [u16; 4],
    pub div: },
// type = K_FFC
    struct {
...
// Internal clock IDs
pub const R9A06G032_CLKOUT: c_int = 0;
pub const R9A06G032_CLKOUT_D10: c_int = 2;
pub const R9A06G032_CLKOUT_D16: c_int = 3;
pub const R9A06G032_CLKOUT_D160: c_int = 4;
pub const R9A06G032_CLKOUT_D1OR2: c_int = 5;
pub const R9A06G032_CLKOUT_D20: c_int = 6;
pub const R9A06G032_CLKOUT_D40: c_int = 7;
pub const R9A06G032_CLKOUT_D5: c_int = 8;
pub const R9A06G032_CLKOUT_D8: c_int = 9;
pub const R9A06G032_DIV_ADC: c_int = 10;
pub const R9A06G032_DIV_I2C: c_int = 11;
pub const R9A06G032_DIV_NAND: c_int = 12;
pub const R9A06G032_DIV_P1_PG: c_int = 13;
pub const R9A06G032_DIV_P2_PG: c_int = 14;
pub const R9A06G032_DIV_P3_PG: c_int = 15;
pub const R9A06G032_DIV_P4_PG: c_int = 16;
pub const R9A06G032_DIV_P5_PG: c_int = 17;
pub const R9A06G032_DIV_P6_PG: c_int = 18;
pub const R9A06G032_DIV_QSPI0: c_int = 19;
pub const R9A06G032_DIV_QSPI1: c_int = 20;
pub const R9A06G032_DIV_REF_SYNC: c_int = 21;
pub const R9A06G032_DIV_SDIO0: c_int = 22;
pub const R9A06G032_DIV_SDIO1: c_int = 23;
pub const R9A06G032_DIV_SWITCH: c_int = 24;
pub const R9A06G032_DIV_UART: c_int = 25;
pub const R9A06G032_DIV_MOTOR: c_int = 64;
pub const R9A06G032_CLK_DDRPHY_PLLCLK_D4: c_int = 78;
pub const R9A06G032_CLK_ECAT100_D4: c_int = 79;
pub const R9A06G032_CLK_HSR100_D2: c_int = 80;
pub const R9A06G032_CLK_REF_SYNC_D4: c_int = 81;
pub const R9A06G032_CLK_REF_SYNC_D8: c_int = 82;
pub const R9A06G032_CLK_SERCOS100_D2: c_int = 83;
pub const R9A06G032_DIV_CA7: c_int = 84;
pub const R9A06G032_UART_GROUP_012: c_int = 154;
pub const R9A06G032_UART_GROUP_34567: c_int = 155;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r9a06g032_priv {
    pub data: clk_onecell_data,
    pub /: *mut *mut spinlock_t lock; / protects concurrent access to gates,
...
#[no_mangle]
pub unsafe extern "C" fn r9a06g032_sysctrl_set_dmamux(mask: u32, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rdesc_get(clocks: *mut r9a06g032_priv, rb: regbit) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r9a06g032_clk_gate {
    pub hw: clk_hw,
    pub clocks: *mut r9a06g032_priv,
    pub index: u16,
    pub gate: r9a06g032_gate,
}
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_detach_dev(unused: *mut generic_pm_domain, dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_add_clk_domain(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clk_gate_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clk_gate_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clk_gate_is_enabled(hw: *mut clk_hw) -> c_int {
...
//
    ...
    clk = clk_register(core::ptr::null_mut(), &g.hw);
    if (IS_ERR(clk)) {
    kfree(g);
    return core::ptr::null_mut();
    }
...
pub struct r9a06g032_clk_div {
    ...
    pub max: u16 min,,
    pub table_size: u8,
    pub /: *mut *mut u16 table[8]; / we know there are no more than 8,
}
    ...
    let mut div: u32 = readl(reg);
    if (div < clk.min)
    div = clk.min;
#[no_mangle]
pub unsafe extern "C" fn if(clk->max: div >) -> else {
    else if (div > clk.max)
    div = clk.max;
...
// + 1 to cope with rates that have the remainder dropped
    let mut div: u32 = DIV_ROUND_UP(prate, rate + 1);
    int i;
    if (div <= clk.min)
    return clk.min;
    if (div >= clk.max)
...
//
    ...
    {
    struct r9a06g032_clk_div *clk = to_r9a06g032_div(hw);
    let mut div: u32 = DIV_ROUND_UP(req.best_parent_rate, req.rate);
...
//
    ...
    struct r9a06g032_clk_div *clk = to_r9a06g032_div(hw);
// + 1 to cope with rates that have the remainder dropped
    let mut div: u32 = DIV_ROUND_UP(parent_rate, rate + 1);
    u32 __iomem *reg = clk.clocks.reg + (4 * clk.reg);
...
// populate (optional) divider table fixed values
    ...
    clk = clk_register(core::ptr::null_mut(), &div.hw);
    if (IS_ERR(clk)) {
    kfree(div);
    return core::ptr::null_mut();
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r9a06g032_clk_bitsel {
    pub hw: clk_hw,
    pub clocks: *mut r9a06g032_priv,
    pub index: u16,
    pub /: *mut *mut regbit selector; / selector register + bit,
}

    container_of(_hw, struct r9a06g032_clk_bitsel, hw)
#[no_mangle]
unsafe extern "C" fn r9a06g032_clk_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clk_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct r9a06g032_clk_dualgate {
    pub hw: clk_hw,
    pub clocks: *mut r9a06g032_priv,
    pub index: u16,
    pub /: *mut *mut regbit selector; / selector register + bit,
    pub gate: [r9a06g032_gate; 2],
}
    ...
    {
    let mut sel_bit: u8 = clk_rdesc_get(g.clocks, g.selector);
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clk_dualgate_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clk_dualgate_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clk_dualgate_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clocks_del_clk_provider(data: *mut c_void) {
    static void r9a06g032_clocks_del_clk_provider(void *data)
    {
    of_clk_del_provider(data);
    }
#[no_mangle]
unsafe extern "C" fn r9a06g032_restart_handler(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_init_h2mode(clocks: *mut r9a06g032_priv) -> void __init {
    static void __init r9a06g032_init_h2mode(struct r9a06g032_priv *clocks)
    {
    struct device_node *usbf_np;
    u32 usb;
    for_each_compatible_node(usbf_np, core::ptr::null_mut(), "renesas,rzn1-usbf") {
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clocks_probe(pdev: *mut platform_device) -> int __init {
    ...
    if (IS_ERR(mclk))
    return PTR_ERR(mclk);
    clocks.reg = devm_of_iomap(dev, np, 0, core::ptr::null_mut());
...
// Allow watchdog and software resets
    ...
    r9a06g032_restart_handler, core::ptr::null_mut());
    if (error)
    ...
    switch (d.type) {
    case K_FFC:
    clk = clk_register_fixed_factor(core::ptr::null_mut(), d.name,
    parent_name, 0,
    d.ffc.mul,
    d.ffc.div);
    break;
...
// keep that selector register around
    ...
    return error;
    sysctrl_priv = clocks;
    error = of_platform_populate(np, core::ptr::null_mut(), core::ptr::null_mut(), dev);
    if (error)
...
#[no_mangle]
unsafe extern "C" fn r9a06g032_clocks_init() -> int __init {
