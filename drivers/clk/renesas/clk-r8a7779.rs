...
//! Source: drivers/clk/renesas/clk-r8a7779.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpg_clk_config {
    pub z_mult: c_uint,
    pub z_div: c_uint,
    pub zs_and_s_div: c_uint,
    pub s1_div: c_uint,
    pub p_div: c_uint,
    pub b_and_out_div: c_uint,
}
...
//
    ...
    return clk_register_fixed_factor(core::ptr::null_mut(), name, parent_name, 0, mult, div);
    }
#[no_mangle]
unsafe extern "C" fn r8a7779_cpg_clocks_init(np: *mut device_node) -> void __init {
