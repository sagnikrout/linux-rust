...
//! Source: drivers/clk/mvebu/ap806-system-controller.c
#![no_std]
...
pub const AP806_SAR_REG: c_uint = 0x400;
pub const AP806_SAR_CLKFREQ_MODE_MASK: c_uint = 0x1f;
pub const AP806_CLK_NUM: c_int = 6;
...
// CPU clocks depend on the Sample At Reset configuration
    ...
    ap806_clks[0] = clk_register_fixed_rate(dev, name, core::ptr::null_mut(),
    0, cpuclk_freq);
    ...
    ap806_clks[1] = clk_register_fixed_rate(dev, name, core::ptr::null_mut(), 0,
    cpuclk_freq);
...
// Fixed clock is always 1200 Mhz
    ...
    ap806_clks[2] = clk_register_fixed_rate(dev, fixedclk_name, core::ptr::null_mut(),
    0, 1200 * 1000 * 1000);
...
// MSS Clock is fixed clock divided by 6
    ...
    ap806_clks[3] = clk_register_fixed_factor(core::ptr::null_mut(), name, fixedclk_name,
    0, 1, 6);
...
// SDIO(/eMMC) Clock is fixed clock divided by 3
    ...
    ap806_clks[4] = clk_register_fixed_factor(core::ptr::null_mut(), name,
    fixedclk_name,
    0, 1, 3);
...
// AP-DCLK(HCLK) Clock is DDR clock divided by 2
    ...
    ap806_clks[5] = clk_register_fixed_rate(dev, name, core::ptr::null_mut(), 0, dclk_freq);
...
#[no_mangle]
unsafe extern "C" fn ap806_syscon_legacy_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ap806_clock_probe(pdev: *mut platform_device) -> c_int {
