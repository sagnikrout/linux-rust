...
//! Source: drivers/clk/aspeed/clk-ast2700.c
#![no_std]
...
// SOC0
pub const SCU0_HWSTRAP1: c_uint = 0x010;
pub const SCU0_CLK_STOP: c_uint = 0x240;
pub const SCU0_CLK_SEL1: c_uint = 0x280;
pub const SCU0_CLK_SEL2: c_uint = 0x284;

pub const SCU0_HPLL_PARAM: c_uint = 0x300;
pub const SCU0_DPLL_PARAM: c_uint = 0x308;
pub const SCU0_MPLL_PARAM: c_uint = 0x310;
pub const SCU0_D0CLK_PARAM: c_uint = 0x320;
pub const SCU0_D1CLK_PARAM: c_uint = 0x330;
pub const SCU0_CRT0CLK_PARAM: c_uint = 0x340;
pub const SCU0_CRT1CLK_PARAM: c_uint = 0x350;
pub const SCU0_MPHYCLK_PARAM: c_uint = 0x360;
// SOC1
pub const SCU1_REVISION_ID: c_uint = 0x0;

pub const SCU1_CLK_STOP: c_uint = 0x240;
pub const SCU1_CLK_STOP2: c_uint = 0x260;
pub const SCU1_CLK_SEL1: c_uint = 0x280;
pub const SCU1_CLK_SEL2: c_uint = 0x284;

pub const SCU1_HPLL_PARAM: c_uint = 0x300;
pub const SCU1_APLL_PARAM: c_uint = 0x310;
pub const SCU1_DPLL_PARAM: c_uint = 0x320;
pub const SCU1_UXCLK_CTRL: c_uint = 0x330;
pub const SCU1_HUXCLK_CTRL: c_uint = 0x334;
pub const SCU1_MAC12_CLK_DLY: c_uint = 0x390;
pub const SCU1_MAC12_CLK_DLY_100M: c_uint = 0x394;
pub const SCU1_MAC12_CLK_DLY_10M: c_uint = 0x398;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_fixed_factor_data {
    pub mult: c_uint,
    pub div: c_uint,
    pub parent_id: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_gate_data {
    pub parent_id: c_int,
    pub flags: u32,
    pub reg: u32,
    pub bit: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_mux_data {
    pub parent_hws: *const clk_hw,
    pub parent_ids: *const c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_div_data {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_pll_data {
    pub parent_id: c_uint,
    pub reg: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_fixed_rate_data {
    pub fixed_rate: c_ulong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_display_fixed_data {
    pub reg: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_info {
    pub name: *const c_char,
    pub id: u32,
    pub reg: u32,
    pub type: u32,
    union {
    pub factor: ast2700_clk_fixed_factor_data,
    pub rate: ast2700_clk_fixed_rate_data,
    pub display_rate: ast2700_clk_display_fixed_data,
    pub gate: ast2700_clk_gate_data,
    pub div: ast2700_clk_div_data,
    pub pll: ast2700_clk_pll_data,
    pub mux: ast2700_clk_mux_data,
    pub data: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_data {
    pub clk_info: *const ast2700_clk_info,
    pub nr_clks: c_uint,
    pub scu: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ast2700_clk_ctrl {
    pub clk_data: *const ast2700_clk_data,
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub /: *mut *mut spinlock_t lock; / clk lock,
}
...
// soc 1
    ...
    mult = r;
    div = 2 * n;
    return devm_clk_hw_register_fixed_rate(clk_ctrl.dev, name, core::ptr::null_mut(), 0, (xdclk * mult) / div);
    }
    ...
    case 2:
    return devm_clk_hw_register_fixed_rate(clk_ctrl.dev, name, core::ptr::null_mut(),
    0, 1800 * HZ_PER_MHZ);
    case 3:
    return devm_clk_hw_register_fixed_rate(clk_ctrl.dev, name, core::ptr::null_mut(),
    0, 1700 * HZ_PER_MHZ);
...
// Pass through mode
    ...
    struct ast2700_clk_ctrl *clk_ctrl)
    {
    let mut scu: c_int = clk_ctrl.clk_data.scu;
    unsigned int mult, div;
...
// Pass through mode
    ...
    unsigned int mult, div;
    let mut val: u32 = readl(reg);
    let mut r: u32 = val & 0xff;
    let mut n: u32 = (val >> 8) & 0x3ff;
    mult = r;
    div = n * 2;
    return devm_clk_hw_register_fixed_factor_parent_hw(clk_ctrl.dev, name,
    parent_hw, 0, mult, div);
...
#[no_mangle]
unsafe extern "C" fn ast2700_clk_is_enabled(hw: *mut clk_hw) -> c_int {
    static int ast2700_clk_is_enabled(struct clk_hw *hw)
    {
    struct clk_gate *gate = to_clk_gate(hw);
    let mut clk: u32 = BIT(gate.bit_idx);
    u32 reg;
    reg = readl(gate.reg);
    return !(reg & clk);
    }
#[no_mangle]
unsafe extern "C" fn ast2700_clk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ast2700_clk_disable(hw: *mut clk_hw) {
...
// Clock is set to enable, so use write to set register
    ...
    init.parent_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ast2700_soc1_configure_i3c_clk(clk_ctrl: *mut ast2700_clk_ctrl) {
...
#[no_mangle]
unsafe extern "C" fn ast2700_soc_clk_probe(pdev: *mut platform_device) -> c_int {
    ...
    const struct clk_hw *phw = core::ptr::null_mut();
    let mut id: c_uint = clk.id;
    ...
    hws[id] = devm_clk_hw_register_fixed_rate(dev, clk.name, core::ptr::null_mut(), 0,
    ...
    let mut pid: c_uint = mux.parent_ids[j];
    ...
    if (ret)
    return ret;
    adev = devm_auxiliary_device_create(dev, reset_name, ( void *)clk_base);
    if (!adev)
    return -ENODEV;
    return 0;
    }
