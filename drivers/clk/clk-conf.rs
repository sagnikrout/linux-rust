...
#[no_mangle]
unsafe extern "C" fn __set_clk_parents(node: *mut device_node, clk_supplier: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __set_clk_rates(node: *mut device_node, clk_supplier: bool) -> c_int {
    static int __set_clk_rates(struct device_node *node, bool clk_supplier)
    {
    struct of_phandle_args clkspec;
    int rc, count, count_64, index;
    struct clk *clk;
    u64 *rates_64 __free(kfree) = core::ptr::null_mut();
    u32 *rates __free(kfree) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __set_clk_spread_spectrum(node: *mut device_node, clk_supplier: bool) -> c_int {
    static int __set_clk_spread_spectrum(struct device_node *node, bool clk_supplier)
    {
    let mut elem_size: u32 = sizeof(struct clk_spread_spectrum);
...
//
#[no_mangle]
pub unsafe extern "C" fn of_clk_set_defaults(node: *mut device_node, clk_supplier: bool) -> c_int {
