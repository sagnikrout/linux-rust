...
//! Source: drivers/clk/eswin/clk-eic7700-hsp.c
#![no_std]
...
pub const EIC7700_HSP_SATA_REG: c_uint = 0x300;
pub const EIC7700_HSP_MSHC0_REG: c_uint = 0x510;
pub const EIC7700_HSP_MSHC1_REG: c_uint = 0x610;
pub const EIC7700_HSP_MSHC2_REG: c_uint = 0x710;
pub const EIC7700_HSP_USB0_REG: c_uint = 0x800;
pub const EIC7700_HSP_USB0_REF_REG: c_uint = 0x83c;
pub const EIC7700_HSP_USB1_REG: c_uint = 0x900;
pub const EIC7700_HSP_USB1_REF_REG: c_uint = 0x93c;
pub const USB_REF_XTAL24M: c_uint = 0x2a;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct eic7700_hsp_clk_gate {
    pub hw: clk_hw,
    pub id: c_uint,
...
#[no_mangle]
unsafe extern "C" fn hsp_clk_gate_endisable(hw: *mut clk_hw, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn hsp_clk_gate_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hsp_clk_gate_disable(hw: *mut clk_hw) {
    static void hsp_clk_gate_disable(struct clk_hw *hw)
    {
    hsp_clk_gate_endisable(hw, false);
    }
#[no_mangle]
unsafe extern "C" fn hsp_clk_gate_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eic7700_hsp_clk_probe(pdev: *mut platform_device) -> c_int {
    ...
    adev = devm_auxiliary_device_create(dev, "hsp-reset", core::ptr::null_mut());
    if (!adev)
