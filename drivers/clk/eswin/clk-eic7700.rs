...
//! Source: drivers/clk/eswin/clk-eic7700.c
#![no_std]
...
pub const EIC7700_REG_OFFSET_SPLL0_CFG_0: c_uint = 0x0;
pub const EIC7700_REG_OFFSET_SPLL0_CFG_1: c_uint = 0x4;
pub const EIC7700_REG_OFFSET_SPLL0_CFG_2: c_uint = 0x8;
pub const EIC7700_REG_OFFSET_SPLL0_DSKEWCAL: c_uint = 0xC;
pub const EIC7700_REG_OFFSET_SPLL0_SSC: c_uint = 0x10;
pub const EIC7700_REG_OFFSET_SPLL1_CFG_0: c_uint = 0x14;
pub const EIC7700_REG_OFFSET_SPLL1_CFG_1: c_uint = 0x18;
pub const EIC7700_REG_OFFSET_SPLL1_CFG_2: c_uint = 0x1C;
pub const EIC7700_REG_OFFSET_SPLL1_DSKEWCAL: c_uint = 0x20;
pub const EIC7700_REG_OFFSET_SPLL1_SSC: c_uint = 0x24;
pub const EIC7700_REG_OFFSET_SPLL2_CFG_0: c_uint = 0x28;
pub const EIC7700_REG_OFFSET_SPLL2_CFG_1: c_uint = 0x2C;
pub const EIC7700_REG_OFFSET_SPLL2_CFG_2: c_uint = 0x30;
pub const EIC7700_REG_OFFSET_SPLL2_DSKEWCAL: c_uint = 0x34;
pub const EIC7700_REG_OFFSET_SPLL2_SSC: c_uint = 0x38;
pub const EIC7700_REG_OFFSET_VPLL_CFG_0: c_uint = 0x3C;
pub const EIC7700_REG_OFFSET_VPLL_CFG_1: c_uint = 0x40;
pub const EIC7700_REG_OFFSET_VPLL_CFG_2: c_uint = 0x44;
pub const EIC7700_REG_OFFSET_VPLL_DSKEWCAL: c_uint = 0x48;
pub const EIC7700_REG_OFFSET_VPLL_SSC: c_uint = 0x4C;
pub const EIC7700_REG_OFFSET_APLL_CFG_0: c_uint = 0x50;
pub const EIC7700_REG_OFFSET_APLL_CFG_1: c_uint = 0x54;
pub const EIC7700_REG_OFFSET_APLL_CFG_2: c_uint = 0x58;
pub const EIC7700_REG_OFFSET_APLL_DSKEWCAL: c_uint = 0x5C;
pub const EIC7700_REG_OFFSET_APLL_SSC: c_uint = 0x60;
pub const EIC7700_REG_OFFSET_MCPUT_PLL_CFG_0: c_uint = 0x64;
pub const EIC7700_REG_OFFSET_MCPUT_PLL_CFG_1: c_uint = 0x68;
pub const EIC7700_REG_OFFSET_MCPUT_PLL_CFG_2: c_uint = 0x6C;
pub const EIC7700_REG_OFFSET_MCPUT_PLL_DSKEWCAL: c_uint = 0x70;
pub const EIC7700_REG_OFFSET_MCPUT_PLL_SSC: c_uint = 0x74;
pub const EIC7700_REG_OFFSET_DDRT_PLL_CFG_0: c_uint = 0x78;
pub const EIC7700_REG_OFFSET_DDRT_PLL_CFG_1: c_uint = 0x7C;
pub const EIC7700_REG_OFFSET_DDRT_PLL_CFG_2: c_uint = 0x80;
pub const EIC7700_REG_OFFSET_DDRT_PLL_DSKEWCAL: c_uint = 0x84;
pub const EIC7700_REG_OFFSET_DDRT_PLL_SSC: c_uint = 0x88;
pub const EIC7700_REG_OFFSET_PLL_STATUS: c_uint = 0xA4;
pub const EIC7700_REG_OFFSET_NOC: c_uint = 0x100;
pub const EIC7700_REG_OFFSET_BOOTSPI: c_uint = 0x104;
pub const EIC7700_REG_OFFSET_BOOTSPI_CFGCLK: c_uint = 0x108;
pub const EIC7700_REG_OFFSET_SCPU_CORE: c_uint = 0x10C;
pub const EIC7700_REG_OFFSET_SCPU_BUSCLK: c_uint = 0x110;
pub const EIC7700_REG_OFFSET_LPCPU_CORE: c_uint = 0x114;
pub const EIC7700_REG_OFFSET_LPCPU_BUSCLK: c_uint = 0x118;
pub const EIC7700_REG_OFFSET_TCU_ACLK: c_uint = 0x11C;
pub const EIC7700_REG_OFFSET_TCU_CFG: c_uint = 0x120;
pub const EIC7700_REG_OFFSET_DDR: c_uint = 0x124;
pub const EIC7700_REG_OFFSET_DDR1: c_uint = 0x128;
pub const EIC7700_REG_OFFSET_GPU_ACLK: c_uint = 0x12C;
pub const EIC7700_REG_OFFSET_GPU_CFG: c_uint = 0x130;
pub const EIC7700_REG_OFFSET_GPU_GRAY: c_uint = 0x134;
pub const EIC7700_REG_OFFSET_DSP_ACLK: c_uint = 0x138;
pub const EIC7700_REG_OFFSET_DSP_CFG: c_uint = 0x13C;
pub const EIC7700_REG_OFFSET_D2D_ACLK: c_uint = 0x140;
pub const EIC7700_REG_OFFSET_D2D_CFG: c_uint = 0x144;
pub const EIC7700_REG_OFFSET_HSP_ACLK: c_uint = 0x148;
pub const EIC7700_REG_OFFSET_HSP_CFG: c_uint = 0x14C;
pub const EIC7700_REG_OFFSET_SATA_RBC: c_uint = 0x150;
pub const EIC7700_REG_OFFSET_SATA_OOB: c_uint = 0x154;
pub const EIC7700_REG_OFFSET_ETH0: c_uint = 0x158;
pub const EIC7700_REG_OFFSET_ETH1: c_uint = 0x15C;
pub const EIC7700_REG_OFFSET_MSHC0_CORE: c_uint = 0x160;
pub const EIC7700_REG_OFFSET_MSHC1_CORE: c_uint = 0x164;
pub const EIC7700_REG_OFFSET_MSHC2_CORE: c_uint = 0x168;
pub const EIC7700_REG_OFFSET_MSHC_USB_SLWCLK: c_uint = 0x16C;
pub const EIC7700_REG_OFFSET_PCIE_ACLK: c_uint = 0x170;
pub const EIC7700_REG_OFFSET_PCIE_CFG: c_uint = 0x174;
pub const EIC7700_REG_OFFSET_NPU_ACLK: c_uint = 0x178;
pub const EIC7700_REG_OFFSET_NPU_LLC: c_uint = 0x17C;
pub const EIC7700_REG_OFFSET_NPU_CORE: c_uint = 0x180;
pub const EIC7700_REG_OFFSET_VI_DWCLK: c_uint = 0x184;
pub const EIC7700_REG_OFFSET_VI_ACLK: c_uint = 0x188;
pub const EIC7700_REG_OFFSET_VI_DIG_ISP: c_uint = 0x18C;
pub const EIC7700_REG_OFFSET_VI_DVP: c_uint = 0x190;
pub const EIC7700_REG_OFFSET_VI_SHUTTER0: c_uint = 0x194;
pub const EIC7700_REG_OFFSET_VI_SHUTTER1: c_uint = 0x198;
pub const EIC7700_REG_OFFSET_VI_SHUTTER2: c_uint = 0x19C;
pub const EIC7700_REG_OFFSET_VI_SHUTTER3: c_uint = 0x1A0;
pub const EIC7700_REG_OFFSET_VI_SHUTTER4: c_uint = 0x1A4;
pub const EIC7700_REG_OFFSET_VI_SHUTTER5: c_uint = 0x1A8;
pub const EIC7700_REG_OFFSET_VI_PHY: c_uint = 0x1AC;
pub const EIC7700_REG_OFFSET_VO_ACLK: c_uint = 0x1B0;
pub const EIC7700_REG_OFFSET_VO_IESMCLK: c_uint = 0x1B4;
pub const EIC7700_REG_OFFSET_VO_PIXEL: c_uint = 0x1B8;
pub const EIC7700_REG_OFFSET_VO_MCLK: c_uint = 0x1BC;
pub const EIC7700_REG_OFFSET_VO_PHY_CLK: c_uint = 0x1C0;
pub const EIC7700_REG_OFFSET_VC_ACLK: c_uint = 0x1C4;
pub const EIC7700_REG_OFFSET_VCDEC_ROOT: c_uint = 0x1C8;
pub const EIC7700_REG_OFFSET_G2D: c_uint = 0x1CC;
pub const EIC7700_REG_OFFSET_VC_CLKEN: c_uint = 0x1D0;
pub const EIC7700_REG_OFFSET_JE: c_uint = 0x1D4;
pub const EIC7700_REG_OFFSET_JD: c_uint = 0x1D8;
pub const EIC7700_REG_OFFSET_VD: c_uint = 0x1DC;
pub const EIC7700_REG_OFFSET_VE: c_uint = 0x1E0;
pub const EIC7700_REG_OFFSET_AON_DMA: c_uint = 0x1E4;
pub const EIC7700_REG_OFFSET_TIMER: c_uint = 0x1E8;
pub const EIC7700_REG_OFFSET_RTC: c_uint = 0x1EC;
pub const EIC7700_REG_OFFSET_PKA: c_uint = 0x1F0;
pub const EIC7700_REG_OFFSET_SPACC: c_uint = 0x1F4;
pub const EIC7700_REG_OFFSET_TRNG: c_uint = 0x1F8;
pub const EIC7700_REG_OFFSET_OTP: c_uint = 0x1FC;
pub const EIC7700_REG_OFFSET_LSP_EN0: c_uint = 0x200;
pub const EIC7700_REG_OFFSET_LSP_EN1: c_uint = 0x204;
pub const EIC7700_REG_OFFSET_U84: c_uint = 0x208;
pub const EIC7700_REG_OFFSET_SYSCFG: c_uint = 0x20C;
pub const EIC7700_REG_OFFSET_I2C0: c_uint = 0x210;
pub const EIC7700_REG_OFFSET_I2C1: c_uint = 0x214;
...
// Define the early clocks as the parent clocks of the mux clocks.
    ...
    CLK_MUX_ROUND_CLOSEST, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn eic7700_clk_probe(pdev: *mut platform_device) -> c_int {
