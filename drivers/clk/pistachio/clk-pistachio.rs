...
//! Source: drivers/clk/pistachio/clk-pistachio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pistachio_clk_init(np: *mut device_node) -> void __init {
    ...
    debug_clk = clk_register_mux_table(core::ptr::null_mut(), "debug_mux", mux_debug,
    ARRAY_SIZE(mux_debug),
    CLK_SET_RATE_NO_REPARENT,
    p.base + 0x200, 18, 0x1f, 0,
    mux_debug_idx, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pistachio_clk_periph_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pistachio_cr_periph_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pistachio_cr_top_init(np: *mut device_node) -> void __init {
