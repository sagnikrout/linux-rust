...
pub struct k210_clk {
    pub id: c_int,
    pub ksc: *mut k210_sysclk,
    pub hw: clk_hw,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct k210_clk_cfg {
...
//
pub const K210_PLL_LOCK: c_int = 0;
pub const K210_PLL_CLEAR_SLIP: c_int = 2;
pub const K210_PLL_TEST_OUT: c_int = 3;
//
...
#[derive(Copy, Clone)]
pub struct k210_pll {
    pub id: enum k210_pll_id,
    pub ksc: *mut k210_sysclk,
    pub base: *mut void __iomem,
    pub reg: *mut void __iomem,
    pub lock: *mut void __iomem,
    pub lock_shift: u8,
    pub lock_width: u8,
    pub hw: clk_hw,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k210_sysclk {
    pub regs: *mut void __iomem,
    pub clk_lock: spinlock_t,
    pub plls: [k210_pll; K210_PLL_NUM],
    pub aclk: clk_hw,
    pub clks: [k210_clk; K210_NUM_CLKS],
}
...
//
#[no_mangle]
unsafe extern "C" fn k210_aclk_set_selector(regs: *mut void __iomem, sel: u8) {
    static void k210_aclk_set_selector(void __iomem *regs, u8 sel)
    {
    let mut reg: u32 = readl(regs + K210_SYSCTL_SEL0);
    if (sel)
    reg |= K210_ACLK_SEL;
    else
    reg &= K210_ACLK_SEL;
...
#[no_mangle]
unsafe extern "C" fn k210_pll_wait_for_lock(pll: *mut k210_pll) {
...
#[no_mangle]
unsafe extern "C" fn k210_pll_hw_is_enabled(pll: *mut k210_pll) -> bool {
    static bool k210_pll_hw_is_enabled(struct k210_pll *pll)
    {
    let mut reg: u32 = readl(pll.reg);
    let mut mask: u32 = K210_PLL_PWRD | K210_PLL_EN;
    if (reg & K210_PLL_RESET)
    return false;
    return (reg & mask) == mask;
    }
#[no_mangle]
unsafe extern "C" fn k210_pll_enable_hw(regs: *mut void __iomem, pll: *mut k210_pll) {
...
#[no_mangle]
unsafe extern "C" fn k210_pll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k210_pll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn k210_pll_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k210_pll2_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k210_pll2_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn k210_aclk_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k210_aclk_get_parent(hw: *mut clk_hw) -> u8 {
    ...
    {
    struct k210_sysclk *ksc = to_k210_sysclk(hw);
    let mut reg: u32 = readl(ksc.regs + K210_SYSCTL_SEL0);
    unsigned int shift;
    if (!(reg & 0x1))
    return parent_rate;
...
#[no_mangle]
unsafe extern "C" fn k210_clk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k210_clk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn k210_clk_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k210_clk_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn k210_clk_init(np: *mut device_node) -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn k210_clk_early_init(regs: *mut void __iomem) -> void __init {
