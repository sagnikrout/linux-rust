...
pub const PLL_DIV1: c_int = 0;
pub const PLL_DIV2: c_int = 1;
pub const PLL_DIV3: c_int = 2;
pub const PLL_DIV4: c_int = 3;
pub const PLATFORM_PLL: c_int = 0;
pub const CGA_PLL1: c_int = 1;
pub const CGA_PLL2: c_int = 2;
pub const CGA_PLL3: c_int = 3;

pub const CGB_PLL1: c_int = 4;
pub const CGB_PLL2: c_int = 5;
pub const MAX_PLL_DIV: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clockgen_pll_div {
    pub clk: *mut clk,
    pub name: [c_char; 32],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clockgen_pll {
    pub div: [clockgen_pll_div; MAX_PLL_DIV],
}

pub const CLKSEL_VALID: c_int = 1;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct clockgen_sourceinfo {
    pub /: *mut *mut u32 flags; / CLKSEL_xxx,
    pub /: *mut *mut int pll; / CGx_PLLn,
    pub /: *mut *mut int div; / PLL_DIVn,
}

pub const NUM_MUX_PARENTS: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clockgen_muxinfo {
    pub clksel: [clockgen_sourceinfo; NUM_MUX_PARENTS],
}

pub const NUM_HWACCEL: c_int = 5;
pub const NUM_CMUX: c_int = 8;
    struct clockgen;
//
// cmux freq must be >= platform pll.
// If not set, cmux freq must be >= platform pll/2
//
pub const CG_CMUX_GE_PLAT: c_int = 1;

pub const CG_LITTLE_ENDIAN: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clockgen_chipinfo {
    pub guts_compat: *const *const char compat,,
    pub cmux_groups: [*const clockgen_muxinfo; 2],
    pub hwaccel: [*const clockgen_muxinfo; NUM_HWACCEL],
    pub cg): *mut *mut void (init_periph)(struct clockgen,
    pub /: *mut *mut int cmux_to_group[NUM_CMUX + 1]; / array should be -1 terminated,
    pub /: *mut *mut u32 pll_mask; / 1 << n bit set if PLL n is valid,
    pub /: *mut *mut u32 flags; / CG_xxx,
}
...
pub struct clockgen {
    ...
    pub /: *mut *mut clockgen_chipinfo info; / mutable copy,
    pub coreclk: *mut *mut clk sysclk,,
    pub pll: [clockgen_pll; 6],
    pub cmux: [*mut clk; NUM_CMUX],
    pub hwaccel: [*mut clk; NUM_HWACCEL],
    pub fman: [*mut clk; 2],
    pub guts: *mut ccsr_guts __iomem,
}

    static struct clockgen clockgen;
    static bool add_cpufreq_dev __initdata;
#[no_mangle]
unsafe extern "C" fn cg_out(cg: *mut clockgen, val: u32, reg: *mut u32 __iomem) {
...
#[no_mangle]
unsafe extern "C" fn cg_in(cg: *mut clockgen, reg: *mut u32 __iomem) -> u32 {
...
pub const RCWSR7_FM1_CLK_SEL: c_uint = 0x40000000;
pub const RCWSR7_FM2_CLK_SEL: c_uint = 0x20000000;
pub const RCWSR7_HWA_ASYNC_DIV: c_uint = 0x04000000;
#[no_mangle]
unsafe extern "C" fn p2041_init_periph(cg: *mut clockgen) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn p4080_init_periph(cg: *mut clockgen) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn p5020_init_periph(cg: *mut clockgen) -> void __init {
    static void __init p5020_init_periph(struct clockgen *cg)
    {
    u32 reg;
    let mut div: c_int = PLL_DIV2;
    reg = ioread32be(&cg.guts.rcwsr[7]);
...
#[no_mangle]
unsafe extern "C" fn p5040_init_periph(cg: *mut clockgen) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn t1023_init_periph(cg: *mut clockgen) -> void __init {
    static void __init t1023_init_periph(struct clockgen *cg)
    {
    cg.fman[0] = cg.hwaccel[1];
    }
#[no_mangle]
unsafe extern "C" fn t1040_init_periph(cg: *mut clockgen) -> void __init {
    static void __init t1040_init_periph(struct clockgen *cg)
    {
    cg.fman[0] = cg.pll[PLATFORM_PLL].div[PLL_DIV1].clk;
    }
#[no_mangle]
unsafe extern "C" fn t2080_init_periph(cg: *mut clockgen) -> void __init {
    static void __init t2080_init_periph(struct clockgen *cg)
    {
    cg.fman[0] = cg.hwaccel[0];
    }
#[no_mangle]
unsafe extern "C" fn t4240_init_periph(cg: *mut clockgen) -> void __init {
    ...
    .hwaccel = {
    &t4240_hwa1, core::ptr::null_mut(), core::ptr::null_mut(), &t4240_hwa4, &t4240_hwa5
    },
    .cmux_to_group = {
    0, 0, 1, -1
    },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mux_hwclock {
    pub hw: clk_hw,
    pub cg: *mut clockgen,
    pub info: *const clockgen_muxinfo,
    pub reg: *mut u32 __iomem,
    pub parent_to_clksel: [u8; NUM_MUX_PARENTS],
    pub clksel_to_parent: [i8; NUM_MUX_PARENTS],
    pub num_parents: c_int,
}

pub const CLKSEL_MASK: c_uint = 0x78000000;
pub const CLKSEL_SHIFT: c_int = 27;
#[no_mangle]
unsafe extern "C" fn mux_set_parent(hw: *mut clk_hw, idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn __printf(_arg: 7, _arg: 8) -> *mut clk  __init {
    ...
    hwc.hw.init = &init;
    hwc.cg = cg;
    clk = clk_register(core::ptr::null_mut(), &hwc.hw);
    if (IS_ERR(clk)) {
...
#[no_mangle]
unsafe extern "C" fn create_one_cmux(cg: *mut clockgen, idx: c_int) -> *mut clk  __init {
...
#[no_mangle]
unsafe extern "C" fn create_one_hwaccel(cg: *mut clockgen, idx: c_int) -> *mut clk  __init {
...
#[no_mangle]
unsafe extern "C" fn create_muxes(cg: *mut clockgen) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn legacy_init_clockgen(np: *mut device_node) -> void __init {
...
// Legacy node
#[no_mangle]
unsafe extern "C" fn core_mux_init(np: *mut device_node) -> void __init {
...
// sysclk_from_fixed(struct device_node *node, const char *name)
    ...
    return clk_register_fixed_rate(core::ptr::null_mut(), name, core::ptr::null_mut(), 0, rate);
    }
...
// Register the input clock under the desired name.
    ...
    clk = clk_register_fixed_factor(core::ptr::null_mut(), name, input_name,
    0, 1, 1);
    if (IS_ERR(clk))
    pr_err("%s: Couldn't register %s: %ld\n", __func__, name,
    PTR_ERR(clk));
...
#[no_mangle]
unsafe extern "C" fn create_sysclk(name: *const c_char) -> *mut clk  __init {
...
#[no_mangle]
unsafe extern "C" fn create_coreclk(name: *const c_char) -> *mut clk  __init {
...
// Legacy node
#[no_mangle]
unsafe extern "C" fn sysclk_init(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn create_one_pll(cg: *mut clockgen, idx: c_int) -> void __init {
...
//
    ...
    clk = clk_register_fixed_factor(core::ptr::null_mut(),
    ...
    pll.div[i].clk = clk;
    ret = clk_register_clkdev(clk, pll.div[i].name, core::ptr::null_mut());
    if (ret != 0)
...
#[no_mangle]
unsafe extern "C" fn create_plls(cg: *mut clockgen) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn legacy_pll_init(np: *mut device_node, idx: c_int) -> void __init {
...
// Legacy node
#[no_mangle]
unsafe extern "C" fn pltfrm_pll_init(np: *mut device_node) -> void __init {
...
// Legacy node
#[no_mangle]
unsafe extern "C" fn core_pll_init(np: *mut device_node) -> void __init {
...
pub const SVR_SECURITY: c_uint = 0x80000	/* The Security (E) bit */;
#[no_mangle]
unsafe extern "C" fn has_erratum_a4510() -> bool __init {
    static bool __init has_erratum_a4510(void)
    {
    let mut svr: u32 = mfspr(SPRN_SVR);
    int i;
    svr &= ~SVR_SECURITY;
...
#[no_mangle]
unsafe extern "C" fn _clockgen_init(np: *mut device_node, legacy: bool) -> void __init {
    static void __init _clockgen_init(struct device_node *np, bool legacy)
    {
    int i, ret;
    let mut is_old_ls1021a: bool = false;
...
// Compatibility hack for old, broken device trees
    ...
    guts = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(),
...
// Don't create cpufreq device for legacy clockgen blocks
    ...
    clockgen.regs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn clockgen_init(np: *mut device_node) -> void __init {
    static void __init clockgen_init(struct device_node *np)
    {
    _clockgen_init(np, false);
    }
#[no_mangle]
unsafe extern "C" fn clockgen_cpufreq_init() -> int __init {
