...
//! Source: drivers/clk/clk-versaclock7.c
#![no_std]
...
//
pub const VC7_PAGE_ADDR: c_uint = 0xFD;
pub const VC7_PAGE_WINDOW: c_int = 256;
pub const VC7_MAX_REG: c_uint = 0x364;
// Maximum number of banks supported by VC7
pub const VC7_NUM_BANKS: c_int = 7;
// Maximum number of FODs supported by VC7
pub const VC7_NUM_FOD: c_int = 3;
// Maximum number of IODs supported by VC7
pub const VC7_NUM_IOD: c_int = 4;
// Maximum number of outputs supported by VC7
pub const VC7_NUM_OUT: c_int = 12;
// VCO valid range is 9.5 GHz to 10.7 GHz

// APLL denominator is fixed at 2^27
pub const VC7_APLL_DENOMINATOR_BITS: c_int = 27;
// FOD 1st stage denominator is fixed 2^34
pub const VC7_FOD_DENOMINATOR_BITS: c_int = 34;
// IOD can operate between 1kHz and 650MHz

pub const VC7_IOD_MIN_DIVISOR: c_int = 14;
pub const VC7_IOD_MAX_DIVISOR: c_uint = 0x1ffffff /* 25-bit */;

pub const VC7_FOD_1ST_INT_MAX: c_int = 324;
pub const VC7_FOD_2ND_INT_MIN: c_int = 2;
pub const VC7_FOD_2ND_INT_MAX: c_uint = 0x1ffff /* 17-bit */;
// VC7 Registers
pub const VC7_REG_XO_CNFG: c_uint = 0x2C;
pub const VC7_REG_XO_CNFG_COUNT: c_int = 4;
pub const VC7_REG_XO_IB_H_DIV_SHIFT: c_int = 24;

pub const VC7_REG_APLL_FB_DIV_FRAC: c_uint = 0x120;
pub const VC7_REG_APLL_FB_DIV_FRAC_COUNT: c_int = 4;

pub const VC7_REG_APLL_FB_DIV_INT: c_uint = 0x124;
pub const VC7_REG_APLL_FB_DIV_INT_COUNT: c_int = 2;

pub const VC7_REG_APLL_CNFG: c_uint = 0x127;

pub const VC7_REG_FOD_INT_CNFG_COUNT: c_int = 8;

pub const VC7_REG_FOD_2ND_INT_SHIFT: c_int = 9;

pub const VC7_REG_FOD_FRAC_SHIFT: c_int = 26;

pub const VC7_REG_IOD_INT_CNFG_COUNT: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc7_chip_info {
    pub model: enum vc7_model,
    pub banks: [c_uint; VC7_NUM_BANKS],
    pub num_banks: c_uint,
    pub outputs: [c_uint; VC7_NUM_OUT],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc7_apll_data {
    pub clk: *mut clk,
    pub vc7: *mut vc7_driver_data,
    pub xo_ib_h_div: u8,
    pub en_doubler: u8,
    pub apll_fb_div_int: u16,
    pub apll_fb_div_frac: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc7_fod_data {
    pub hw: clk_hw,
    pub vc7: *mut vc7_driver_data,
    pub num: c_uint,
    pub fod_1st_int: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc7_driver_data {
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub chip_info: *const vc7_chip_info,
    pub pin_xin: *mut clk,
    pub clk_apll: vc7_apll_data,
    pub clk_fod: [vc7_fod_data; VC7_NUM_FOD],
    pub clk_iod: [vc7_iod_data; VC7_NUM_IOD],
    pub clk_out: [vc7_out_data; VC7_NUM_OUT],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc7_bank_src_map {
    enum vc7_bank_src_type {
    VC7_FOD,
    VC7_IOD,
    pub type: },
    union _divider {
    pub iod: *mut vc7_iod_data,
    pub fod: *mut vc7_fod_data,
    pub src: },
}
...
#[no_mangle]
unsafe extern "C" fn vc7_map_index_to_output(model: enum vc7_model, i: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vc7_64_mul_64_to_128(left: u64, right: u64, hi: *mut u64, lo: *mut u64) {
    static void vc7_64_mul_64_to_128(u64 left, u64 right, u64 *hi, u64 *lo)
    {
    let mut a0: u64 = left & 0xffffffffull;
    let mut a1: u64 = left >> 32;
    let mut b0: u64 = right & 0xffffffffull;
    let mut b1: u64 = right >> 32;
    let mut m0: u64 = a0 * b0;
    let mut m1: u64 = a0 * b1;
    let mut m2: u64 = a1 * b0;
    let mut m3: u64 = a1 * b1;
    m2 += (m0 >> 32);
    m2 += m1;
// Overflow
    if (m2 < m1)
...
//
#[no_mangle]
unsafe extern "C" fn vc7_128_div_64_to_64(numhi: u64, numlo: u64, den: u64, r: *mut u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vc7_read_apll(vc7: *mut vc7_driver_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_read_fod(vc7: *mut vc7_driver_data, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_write_fod(vc7: *mut vc7_driver_data, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_read_iod(vc7: *mut vc7_driver_data, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_write_iod(vc7: *mut vc7_driver_data, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_read_output(vc7: *mut vc7_driver_data, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_write_output(vc7: *mut vc7_driver_data, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_get_apll_rate(vc7: *mut vc7_driver_data) -> c_ulong {
...
// div_frac = div64_u64(rem << VC7_FOD_DENOMINATOR_BITS, rate);
    ...
    return vc7_128_div_64_to_64(hi, lo, divisor, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn vc7_fod_recalc_rate(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn vc7_fod_set_rate(hw: *mut clk_hw, rate: c_ulong, parent_rate: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_iod_recalc_rate(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn vc7_iod_set_rate(hw: *mut clk_hw, rate: c_ulong, parent_rate: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_clk_out_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_clk_out_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn vc7_clk_out_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc7_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn vc7_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
