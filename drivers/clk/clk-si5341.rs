...
//! Source: drivers/clk/clk-si5341.c
#![no_std]
...
pub const SI5341_NUM_INPUTS: c_int = 4;
pub const SI5340_MAX_NUM_OUTPUTS: c_int = 4;
pub const SI5341_MAX_NUM_OUTPUTS: c_int = 10;
pub const SI5342_MAX_NUM_OUTPUTS: c_int = 2;
pub const SI5344_MAX_NUM_OUTPUTS: c_int = 4;
pub const SI5345_MAX_NUM_OUTPUTS: c_int = 10;
pub const SI5340_NUM_SYNTH: c_int = 4;
pub const SI5341_NUM_SYNTH: c_int = 5;
pub const SI5342_NUM_SYNTH: c_int = 2;
pub const SI5344_NUM_SYNTH: c_int = 4;
pub const SI5345_NUM_SYNTH: c_int = 5;
// Range of the synthesizer fractional divider
pub const SI5341_SYNTH_N_MIN: c_int = 10;
pub const SI5341_SYNTH_N_MAX: c_int = 4095;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_si5341_synth {
    pub hw: clk_hw,
    pub data: *mut clk_si5341,
    pub index: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_si5341_output {
    pub hw: clk_hw,
    pub data: *mut clk_si5341,
    pub vddo_reg: *mut regulator,
    pub index: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_si5341 {
    pub hw: clk_hw,
    pub regmap: *mut regmap,
    pub i2c_client: *mut i2c_client,
    pub synth: [clk_si5341_synth; SI5341_NUM_SYNTH],
    pub clk: [clk_si5341_output; SI5341_MAX_NUM_OUTPUTS],
    pub input_clk: [*mut clk; SI5341_NUM_INPUTS],
    pub input_clk_name: [*const c_char; SI5341_NUM_INPUTS],
    pub reg_output_offset: *const u16,
    pub reg_rdiv_offset: *const u16,
    pub /: *mut *mut u64 freq_vco; / 13500–14256 MHz,
    pub num_outputs: u8,
    pub num_synth: u8,
    pub chip_id: u16,
    pub xaxb_ext_clk: bool,
    pub iovdd_33: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_si5341_output_config {
    pub out_format_drv_bits: u8,
    pub out_cm_ampl_bits: u8,
    pub vdd_sel_bits: u8,
    pub synth_master: bool,
    pub always_on: bool,
}

pub const SI5341_PAGE: c_uint = 0x0001;
pub const SI5341_PN_BASE: c_uint = 0x0002;
pub const SI5341_DEVICE_REV: c_uint = 0x0005;
pub const SI5341_STATUS: c_uint = 0x000C;
pub const SI5341_LOS: c_uint = 0x000D;
pub const SI5341_STATUS_STICKY: c_uint = 0x0011;
pub const SI5341_LOS_STICKY: c_uint = 0x0012;
pub const SI5341_SOFT_RST: c_uint = 0x001C;
pub const SI5341_IN_SEL: c_uint = 0x0021;
pub const SI5341_DEVICE_READY: c_uint = 0x00FE;
pub const SI5341_XAXB_CFG: c_uint = 0x090E;
pub const SI5341_IO_VDD_SEL: c_uint = 0x0943;
pub const SI5341_IN_EN: c_uint = 0x0949;
pub const SI5341_INX_TO_PFD_EN: c_uint = 0x094A;
// Status bits

// Input selection
pub const SI5341_IN_SEL_MASK: c_uint = 0x06;
pub const SI5341_IN_SEL_SHIFT: c_int = 1;
pub const SI5341_IN_SEL_REGCTRL: c_uint = 0x01;
pub const SI5341_INX_TO_PFD_SHIFT: c_int = 4;
// XTAL config bits

// Input dividers (48-bit)

pub const SI5341_PX_UPD: c_uint = 0x0230;
// PLL configuration
pub const SI5341_PLL_M_NUM: c_uint = 0x0235;
pub const SI5341_PLL_M_DEN: c_uint = 0x023B;
// Output configuration

    ((output).data.reg_output_offset[(output).index])

    ((output).data.reg_rdiv_offset[(output).index])
pub const SI5341_OUT_MUX_VDD_SEL_MASK: c_uint = 0x38;
// Synthesize N divider

// Synthesizer output enable, phase bypass, power mode
pub const SI5341_SYNTH_N_CLK_TO_OUTX_EN: c_uint = 0x0A03;
pub const SI5341_SYNTH_N_PIBYP: c_uint = 0x0A04;
pub const SI5341_SYNTH_N_PDNB: c_uint = 0x0A05;
pub const SI5341_SYNTH_N_CLK_DIS: c_uint = 0x0B4A;
pub const SI5341_REGISTER_MAX: c_uint = 0xBFF;
// SI5341_OUT_CONFIG bits

// Static configuration (to be moved to firmware)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct si5341_reg_default {
    pub address: u16,
    pub value: u8,
}
...
#[no_mangle]
unsafe extern "C" fn si5341_clk_get_selected_input(data: *mut clk_si5341) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_clk_get_parent(hw: *mut clk_hw) -> u8 {
    static u8 si5341_clk_get_parent(struct clk_hw *hw)
    {
    struct clk_si5341 *data = to_clk_si5341(hw);
    let mut res: c_int = si5341_clk_get_selected_input(data);
    if (res < 0)
    return 0; /* Apparently we cannot report errors */
    return res;
    }
#[no_mangle]
unsafe extern "C" fn si5341_clk_reparent(data: *mut clk_si5341, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_clk_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_synth_clk_is_on(hw: *mut clk_hw) -> c_int {
    static int si5341_synth_clk_is_on(struct clk_hw *hw)
    {
    struct clk_si5341_synth *synth = to_clk_si5341_synth(hw);
    int err;
    u32 val;
    let mut index: u8 = synth.index;
...
#[no_mangle]
unsafe extern "C" fn si5341_synth_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_output_clk_is_on(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_output_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn si5341_output_clk_prepare(hw: *mut clk_hw) -> c_int {
...
// Frequency divider is (r_div + 1) * 2
    ...
    r_div = 0;
#[no_mangle]
pub unsafe extern "C" fn if(BIT(24): r_div >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn si5341_output_reparent(output: *mut clk_si5341_output, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_output_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_output_get_parent(hw: *mut clk_hw) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn si5341_is_programmed_already(data: *mut clk_si5341) -> c_int {
...
// Read the PLL divider value, it must have a non-zero value
    ...
    let mut group: c_uint = clkspec.args[0];
    switch (group) {
    case 0:
...
#[no_mangle]
unsafe extern "C" fn si5341_probe_chip_id(data: *mut clk_si5341) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_read_settings(data: *mut clk_si5341) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_send_preamble(data: *mut clk_si5341) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_finalize_defaults(data: *mut clk_si5341) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_wait_device_ready(client: *mut i2c_client) -> c_int {
...
// Always enable the SYNC feature
    ...
    let mut vdd: c_int = regulator_get_voltage(data.clk[num].vddo_reg);
    switch (vdd) {
    case 3300000:
...
//
#[no_mangle]
unsafe extern "C" fn si5341_initialize_pll(data: *mut clk_si5341) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si5341_clk_select_active_input(data: *mut clk_si5341) -> c_int {
...
// Make sure the selected clock is also enabled and routed
    ...
    u32 status;
    let mut res: c_int = regmap_read(data.regmap, SI5341_STATUS, &status);
    if (res < 0)
    return res;
    ...
    struct clk_si5341 *data = dev_get_drvdata(dev);
    u32 status;
    let mut res: c_int = regmap_read(data.regmap, SI5341_STATUS_STICKY, &status);
    if (res < 0)
    return res;
    res = !(status & SI5341_STATUS_LOSREF);
    return sysfs_emit(buf, "%d\n", res);
    ...
    return -EINVAL;
    if (val) {
    let mut res: c_int = regmap_write(data.regmap, SI5341_STATUS_STICKY, 0);
    if (res < 0)
    return res;
    }
    return count;
...
#[no_mangle]
unsafe extern "C" fn si5341_probe(client: *mut i2c_client) -> c_int {
    ...
    const char *synth_clock_names[SI5341_NUM_SYNTH] = { core::ptr::null_mut() };
    int err;
    unsigned int i;
...
// Must be done before otherwise touching hardware
    ...
    data.clk[i].vddo_reg = core::ptr::null_mut();
    if (err == -ENODEV)
    continue;
    goto cleanup;
    } else {
...
#[no_mangle]
unsafe extern "C" fn si5341_remove(client: *mut i2c_client) {
