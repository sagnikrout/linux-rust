...
//! Source: drivers/clk/ti/divider.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn _setup_mask(divider: *mut clk_omap_divider) {
...
#[no_mangle]
unsafe extern "C" fn _get_div(divider: *mut clk_omap_divider, val: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn _get_val(divider: *mut clk_omap_divider, div: u8) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn _is_valid_div(divider: *mut clk_omap_divider, div: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn clk_divider_save_context(hw: *mut clk_hw) -> c_int {
...
// register the clock
    ...
    {
    let mut valid_div: c_int = 0;
    int i;
    struct clk_div_table *tmp;
    let mut min_div: u16 = 0;
    if (!div_table) {
    divider.min = 1;
    divider.max = max_div;
    _setup_mask(divider);
...
//
#[no_mangle]
unsafe extern "C" fn of_ti_divider_clk_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_composite_divider_clk_setup(node: *mut device_node) -> void __init {
