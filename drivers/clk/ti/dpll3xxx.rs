...
//! Source: drivers/clk/ti/dpll3xxx.c
#![no_std]
...
pub const DPLL_AUTOIDLE_DISABLE: c_uint = 0x0;
pub const DPLL_AUTOIDLE_LOW_POWER_STOP: c_uint = 0x1;
pub const MAX_DPLL_WAIT_TRIES: c_int = 1000000;
pub const OMAP3XXX_EN_DPLL_LOCKED: c_uint = 0x7;
...
#[no_mangle]
unsafe extern "C" fn _omap3_dpll_write_clken(clk: *mut clk_hw_omap, clken_bits: u8) {
...
#[no_mangle]
unsafe extern "C" fn _omap3_wait_dpll_status(clk: *mut clk_hw_omap, state: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _omap3_dpll_compute_freqsel(clk: *mut clk_hw_omap, n: u8) -> u16 {
    ...
    f = 0x3;
#[no_mangle]
pub unsafe extern "C" fn if(1250000: fint > 1000000 && fint <=) -> else {
    else if (fint > 1000000 && fint <= 1250000)
    f = 0x4;
#[no_mangle]
pub unsafe extern "C" fn if(1500000: fint > 1250000 && fint <=) -> else {
    else if (fint > 1250000 && fint <= 1500000)
    f = 0x5;
#[no_mangle]
pub unsafe extern "C" fn if(1750000: fint > 1500000 && fint <=) -> else {
    else if (fint > 1500000 && fint <= 1750000)
    f = 0x6;
#[no_mangle]
pub unsafe extern "C" fn if(2100000: fint > 1750000 && fint <=) -> else {
    else if (fint > 1750000 && fint <= 2100000)
    f = 0x7;
#[no_mangle]
pub unsafe extern "C" fn if(10000000: fint > 7500000 && fint <=) -> else {
    else if (fint > 7500000 && fint <= 10000000)
    f = 0xB;
#[no_mangle]
pub unsafe extern "C" fn if(12500000: fint > 10000000 && fint <=) -> else {
    else if (fint > 10000000 && fint <= 12500000)
    f = 0xC;
#[no_mangle]
pub unsafe extern "C" fn if(15000000: fint > 12500000 && fint <=) -> else {
    else if (fint > 12500000 && fint <= 15000000)
    f = 0xD;
#[no_mangle]
pub unsafe extern "C" fn if(17500000: fint > 15000000 && fint <=) -> else {
    else if (fint > 15000000 && fint <= 17500000)
    f = 0xE;
#[no_mangle]
pub unsafe extern "C" fn if(21000000: fint > 17500000 && fint <=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn _omap3_noncore_dpll_lock(clk: *mut clk_hw_omap) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _omap3_noncore_dpll_bypass(clk: *mut clk_hw_omap) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _omap3_noncore_dpll_stop(clk: *mut clk_hw_omap) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _lookup_dco(clk: *mut clk_hw_omap, dco: *mut u8, m: u16, n: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn _lookup_sddiv(clk: *mut clk_hw_omap, sd_div: *mut u8, m: u16, n: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn omap3_noncore_dpll_ssc_program(clk: *mut clk_hw_omap) {
...
//
#[no_mangle]
unsafe extern "C" fn omap3_noncore_dpll_program(clk: *mut clk_hw_omap, freqsel: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3_dpll_recalc(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3_noncore_dpll_enable(hw: *mut clk_hw) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3_noncore_dpll_disable(hw: *mut clk_hw) {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3_noncore_dpll_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omap3_dpll_autoidle_read(clk: *mut clk_hw_omap) -> u32 {
    static u32 omap3_dpll_autoidle_read(struct clk_hw_omap *clk)
    {
    const struct dpll_data *dd;
    u32 v;
...
//
#[no_mangle]
unsafe extern "C" fn omap3_dpll_allow_idle(clk: *mut clk_hw_omap) {
    static void omap3_dpll_allow_idle(struct clk_hw_omap *clk)
    {
    const struct dpll_data *dd;
    u32 v;
...
//
#[no_mangle]
unsafe extern "C" fn omap3_dpll_deny_idle(clk: *mut clk_hw_omap) {
    static void omap3_dpll_deny_idle(struct clk_hw_omap *clk)
    {
    const struct dpll_data *dd;
    u32 v;
...
// Find the parent DPLL for the given clkoutx2 clock
    ...
    {
    struct clk_hw_omap *pclk = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3_core_dpll_save_context(hw: *mut clk_hw) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3_core_dpll_restore_context(hw: *mut clk_hw) {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3_noncore_dpll_save_context(hw: *mut clk_hw) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap3_noncore_dpll_restore_context(hw: *mut clk_hw) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap3_dpll5_settings {
    pub n: unsigned int rate, m,,
}
