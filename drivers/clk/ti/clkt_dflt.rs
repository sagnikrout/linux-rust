...
//! Source: drivers/clk/ti/clkt_dflt.c
#![no_std]
...
//
pub const MAX_MODULE_ENABLE_WAIT: c_int = 100000;
//
// CM module register offsets, used for calculating the companion
// register addresses.
//
pub const CM_FCLKEN: c_uint = 0x0000;
pub const CM_ICLKEN: c_uint = 0x0010;
//
...
//
#[no_mangle]
unsafe extern "C" fn _omap2_module_wait_ready(clk: *mut clk_hw_omap) {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap2_dflt_clk_enable(hw: *mut clk_hw) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap2_dflt_clk_is_enabled(hw: *mut clk_hw) -> c_int {
