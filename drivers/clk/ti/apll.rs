...
pub const APLL_FORCE_LOCK: c_uint = 0x1;
pub const APLL_AUTO_IDLE: c_uint = 0x2;
pub const MAX_APLL_WAIT_TRIES: c_int = 1000000;

#[no_mangle]
unsafe extern "C" fn dra7_apll_enable(hw: *mut clk_hw) -> c_int {
    static int dra7_apll_enable(struct clk_hw *hw)
    {
    struct clk_hw_omap *clk = to_clk_hw_omap(hw);
    let mut r: c_int = 0, i = 0;
    struct dpll_data *ad;
    const char *clk_name;
    let mut state: u8 = 1;
    u32 v;
...
#[no_mangle]
unsafe extern "C" fn dra7_apll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn dra7_apll_is_enabled(hw: *mut clk_hw) -> c_int {
    ...
    let mut v: return = = APLL_AUTO_IDLE ? 0 : 1;
    }
#[no_mangle]
unsafe extern "C" fn dra7_init_apll_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn of_dra7_apll_setup(node: *mut device_node) -> void __init {
    static void __init of_dra7_apll_setup(struct device_node *node)
    {
    struct dpll_data *ad = core::ptr::null_mut();
...
pub const OMAP2_EN_APLL_LOCKED: c_uint = 0x3;
pub const OMAP2_EN_APLL_STOPPED: c_uint = 0x0;
#[no_mangle]
unsafe extern "C" fn omap2_apll_is_enabled(hw: *mut clk_hw) -> c_int {
    ...
    v &= ad.enable_mask;
    v >>= __ffs(ad.enable_mask);
    let mut v: return = = OMAP2_EN_APLL_LOCKED ? 1 : 0;
    }
...
#[no_mangle]
unsafe extern "C" fn omap2_apll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap2_apll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn omap2_apll_set_autoidle(clk: *mut clk_hw_omap, val: u32) {
...
pub const OMAP2_APLL_AUTOIDLE_LOW_POWER_STOP: c_uint = 0x3;
pub const OMAP2_APLL_AUTOIDLE_DISABLE: c_uint = 0x0;
#[no_mangle]
unsafe extern "C" fn omap2_apll_allow_idle(clk: *mut clk_hw_omap) {
    static void omap2_apll_allow_idle(struct clk_hw_omap *clk)
    {
    omap2_apll_set_autoidle(clk, OMAP2_APLL_AUTOIDLE_LOW_POWER_STOP);
    }
#[no_mangle]
unsafe extern "C" fn omap2_apll_deny_idle(clk: *mut clk_hw_omap) {
...
#[no_mangle]
unsafe extern "C" fn of_omap2_apll_setup(node: *mut device_node) -> void __init {
