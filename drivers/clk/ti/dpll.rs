...
//
    ...
    let mut dpll_core_ck_ops: static struct clk_ops = {};
    let mut dpll_ck_ops: static struct clk_ops = {};
    let mut dpll_no_gate_ck_ops: static struct clk_ops = {};
    let mut clkhwops_omap3_dpll: clk_hw_omap_ops = {};
    ...
    let mut omap2_dpll_core_ck_ops: static struct clk_ops = {};
...
//
    ...
    {
    struct clk_hw_omap *clk_hw = core::ptr::null_mut();
    struct clk_init_data *init = core::ptr::null_mut();
    const char **parent_names = core::ptr::null_mut();
    struct dpll_data *dd = core::ptr::null_mut();
    int ssc_clk_index;
    let mut dpll_mode: u8 = 0;
    u32 min_div;
...
//
    ...
    defined(CONFIG_SOC_DRA7XX)
#[no_mangle]
unsafe extern "C" fn of_ti_omap4_dpll_x2_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_am3_dpll_x2_setup(node: *mut device_node) -> void __init {
    static void __init of_ti_am3_dpll_x2_setup(struct device_node *node)
    {
    _register_dpll_x2(node, &dpll_x2_ck_ops, core::ptr::null_mut());
    }
    CLK_OF_DECLARE(ti_am3_dpll_x2_clock, "ti,am3-dpll-x2-clock",
    of_ti_am3_dpll_x2_setup);

#[no_mangle]
unsafe extern "C" fn of_ti_omap3_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_omap3_core_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_omap3_per_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_omap3_per_jtype_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_omap4_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_omap5_mpu_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_omap4_core_dpll_setup(node: *mut device_node) -> void __init {
    ...
    defined(CONFIG_SOC_DRA7XX)
#[no_mangle]
unsafe extern "C" fn of_ti_omap4_m4xen_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_omap4_jtype_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_am3_no_gate_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_am3_jtype_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_am3_no_gate_jtype_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_am3_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_am3_core_dpll_setup(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn of_ti_omap2_core_dpll_setup(node: *mut device_node) -> void __init {
