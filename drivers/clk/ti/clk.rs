...
#[no_mangle]
unsafe extern "C" fn clk_memmap_writel(val: u32, reg: *const clk_omap_reg) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: io->regmap) -> else {
    else if (io.regmap)
...
#[no_mangle]
unsafe extern "C" fn _clk_rmw(val: u32, mask: u32, ptr: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn clk_memmap_rmw(val: u32, mask: u32, reg: *const clk_omap_reg) {
...
#[no_mangle]
unsafe extern "C" fn clk_memmap_readl(reg: *const clk_omap_reg) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_clk_setup_ll_ops(ops: *mut ti_clk_ll_ops) -> c_int {
...
// Fall back to using old node name base provider name
    return of_find_node_by_name(core::ptr::null_mut(), tmp);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_dt_clocks_register(oclks[]: ti_dt_clk) -> void __init {
    ...
    for (c = oclks; c.node_name != core::ptr::null_mut(); c++) {
    strcpy(buf, c.node_name);
    ptr = buf;
    for (i = 0; i < 2; i++)
    tags[i] = core::ptr::null_mut();
    num_args = 0;
    while (*ptr) {
    if (*ptr == ':') {
    if (num_args >= 2) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_init_item {
    pub node: *mut device_node,
    pub user: *mut c_void,
    pub func: ti_of_clk_init_cb_t,
    pub link: list_head,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_clk_get_legacy_bit_shift(node: *mut device_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ti_clk_latch(reg: *mut clk_omap_reg, shift: i8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap2_clk_legacy_provider_init(index: c_int, mem: *mut void __iomem) -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_dt_clk_init_retry_clks() {
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_clk_add_aliases() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_clk_setup_features(features: *mut ti_clk_features) -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap2_clk_enable_init_clocks(clk_names: *const c_char, num_clocks: u8) {
    void omap2_clk_enable_init_clocks(const char **clk_names, u8 num_clocks)
    {
    struct clk *init_clk;
    int i;
    for (i = 0; i < num_clocks; i++) {
    init_clk = clk_get(core::ptr::null_mut(), clk_names[i]);
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_clk_add_alias(clk: *mut clk, con: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap2_clk_for_each(hw): *mut *mut int (fn)(struct clk_hw_omap) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap2_clk_is_hw_omap(hw: *mut clk_hw) -> bool {
