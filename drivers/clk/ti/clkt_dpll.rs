...
//! Source: drivers/clk/ti/clkt_dpll.c
#![no_std]
...
pub const DPLL_MIN_MULTIPLIER: c_int = 2;
pub const DPLL_MIN_DIVIDER: c_int = 1;
...
//
pub const DPLL_SCALE_FACTOR: c_int = 64;
pub const DPLL_SCALE_BASE: c_int = 2;
...
//
pub const OMAP3PLUS_DPLL_FINT_JTYPE_MIN: c_int = 500000;
pub const OMAP3PLUS_DPLL_FINT_JTYPE_MAX: c_int = 2500000;
...
//
#[no_mangle]
unsafe extern "C" fn _dpll_test_fint(clk: *mut clk_hw_omap, n: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _omap2_dpll_is_in_bypass(v: u32) -> c_int {
...
// Public functions
#[no_mangle]
pub unsafe extern "C" fn omap2_init_dpll_parent(hw: *mut clk_hw) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap2_get_dpll_rate(clk: *mut clk_hw_omap) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn omap2_dpll_determine_rate(hw: *mut clk_hw, req: *mut clk_rate_request) -> c_int {
    int omap2_dpll_determine_rate(struct clk_hw *hw, struct clk_rate_request *req)
    {
    struct clk_hw_omap *clk = to_clk_hw_omap(hw);
    int m, n, r, scaled_max_m;
    let mut min_delta_m: c_int = INT_MAX, min_delta_n = INT_MAX;
    unsigned long scaled_rt_rp;
    let mut new_rate: c_ulong = 0;
    struct dpll_data *dd;
    unsigned long ref_rate;
    long delta;
    let mut prev_min_delta: c_long = LONG_MAX;
    const char *clk_name;
...
// Is the (input clk, divider) pair valid for the DPLL?
    ...
    break;
#[no_mangle]
pub unsafe extern "C" fn if(DPLL_FINT_INVALID: r ==) -> else {
