...
//! Source: drivers/clk/ti/clkctrl.c
#![no_std]
...
pub const NO_IDLEST: c_int = 0;
pub const OMAP4_MODULEMODE_MASK: c_uint = 0x3;
pub const MODULEMODE_HWCTRL: c_uint = 0x1;
pub const MODULEMODE_SWCTRL: c_uint = 0x2;

pub const OMAP4_IDLEST_SHIFT: c_int = 16;

pub const OMAP4_STBYST_SHIFT: c_int = 18;
pub const CLKCTRL_IDLEST_FUNCTIONAL: c_uint = 0x0;
pub const CLKCTRL_IDLEST_INTERFACE_IDLE: c_uint = 0x2;
pub const CLKCTRL_IDLEST_DISABLED: c_uint = 0x3;
// These timeouts are in us
pub const OMAP4_MAX_MODULE_READY_TIME: c_int = 2000;
pub const OMAP4_MAX_MODULE_DISABLE_TIME: c_int = 5000;
    let mut _early_timeout: static bool = true;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_clkctrl_provider {
    pub base: *mut void __iomem,
    pub clocks: list_head,
    pub clkdm_name: *mut c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_clkctrl_clk {
    pub clk: *mut clk_hw,
    pub reg_offset: u16,
...
#[no_mangle]
unsafe extern "C" fn _omap4_idlest(val: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn _omap4_is_idle(val: u32) -> bool {
    static bool _omap4_is_idle(u32 val)
    {
    val = _omap4_idlest(val);
    let mut val: return = = CLKCTRL_IDLEST_DISABLED;
    }
#[no_mangle]
unsafe extern "C" fn _omap4_is_ready(val: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn _omap4_is_timeout(time: *mut union omap4_timeout, timeout: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn _omap4_disable_early_timeout() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn _omap4_clkctrl_clk_enable(hw: *mut clk_hw) -> c_int {
    static int _omap4_clkctrl_clk_enable(struct clk_hw *hw)
    {
    struct clk_hw_omap *clk = to_clk_hw_omap(hw);
    u32 val;
    int ret;
    let mut timeout: union omap4_timeout = { 0 };
    if (clk.clkdm) {
...
#[no_mangle]
unsafe extern "C" fn _omap4_clkctrl_clk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn _omap4_clkctrl_clk_is_enabled(hw: *mut clk_hw) -> c_int {
    ...
    struct omap_clkctrl_clk *entry = core::ptr::null_mut(), *iter;
...
//
#[no_mangle]
unsafe extern "C" fn clkctrl_get_name(np: *mut device_node) -> *const char  __init {
    static const char * __init clkctrl_get_name(struct device_node *np)
    {
    struct property *prop;
    let mut prefix_len: c_int = 11;
    const char *compat;
    const char *output;
    const char *end;
    char *name;
...
#[no_mangle]
unsafe extern "C" fn _ti_omap4_clkctrl_setup(node: *mut device_node) -> void __init {
    ...
    struct clk *clk;
    struct omap_clkctrl_clk *clkctrl_clk = core::ptr::null_mut();
    bool legacy_naming;
    const char *clkctrl_name;
    u32 addr;
    int ret;
    char *c;
    let mut soc_mask: u16 = 0;
    struct resource res;
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_clk_is_in_standby(clk: *mut clk) -> bool {
