...
pub const FAPLL_MAIN_MULT_N_SHIFT: c_int = 16;
pub const FAPLL_MAIN_DIV_P_SHIFT: c_int = 8;

pub const FAPLL_MAIN_MAX_MULT_N: c_uint = 0xffff;
pub const FAPLL_MAIN_MAX_DIV_P: c_uint = 0xff;

    ((FAPLL_MAIN_MAX_MULT_N << FAPLL_MAIN_MULT_N_SHIFT) | \
    (FAPLL_MAIN_DIV_P_SHIFT << FAPLL_MAIN_DIV_P_SHIFT) | \
    FAPLL_MAIN_LOC_CTL)
// FAPLL powerdown register PWD
pub const FAPLL_PWD_OFFSET: c_int = 4;
pub const MAX_FAPLL_OUTPUTS: c_int = 7;
pub const FAPLL_MAX_RETRIES: c_int = 1000;
...
pub const SYNTH_PHASE_K: c_int = 8;
pub const SYNTH_MAX_INT_DIV: c_uint = 0xf;
pub const SYNTH_MAX_DIV_M: c_uint = 0xff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fapll_data {
    pub hw: clk_hw,
    pub base: *mut void __iomem,
    pub name: *const c_char,
    pub clk_ref: *mut clk,
    pub clk_bypass: *mut clk,
    pub outputs: clk_onecell_data,
    pub bypass_bit_inverted: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fapll_synth {
    pub hw: clk_hw,
    pub fd: *mut fapll_data,
    pub index: c_int,
    pub freq: *mut void __iomem,
    pub div: *mut void __iomem,
    pub name: *const c_char,
    pub clk_pll: *mut clk,
}

#[no_mangle]
unsafe extern "C" fn ti_fapll_clock_is_bypass(fd: *mut fapll_data) -> bool {
    static bool ti_fapll_clock_is_bypass(struct fapll_data *fd)
    {
    let mut v: u32 = readl_relaxed(fd.base);
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_set_bypass(fd: *mut fapll_data) {
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_clear_bypass(fd: *mut fapll_data) {
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_wait_lock(fd: *mut fapll_data) -> c_int {
    static int ti_fapll_wait_lock(struct fapll_data *fd)
    {
    let mut retries: c_int = FAPLL_MAX_RETRIES;
    u32 v;
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_synth_enable(hw: *mut clk_hw) -> c_int {
    static int ti_fapll_synth_enable(struct clk_hw *hw)
    {
    struct fapll_synth *synth = to_synth(hw);
    let mut v: u32 = readl_relaxed(synth.fd.base + FAPLL_PWD_OFFSET);
    v &= ~(1 << synth.index);
    writel_relaxed(v, synth.fd.base + FAPLL_PWD_OFFSET);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ti_fapll_synth_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_synth_is_enabled(hw: *mut clk_hw) -> c_int {
...
// Need to recalculate the fractional divider?
    ...
    clk = clk_register(core::ptr::null_mut(), &synth.hw);
    if (IS_ERR(clk)) {
...
#[no_mangle]
unsafe extern "C" fn ti_fapll_setup(node: *mut device_node) -> void __init {
...
// Register the parent PLL
    pll_clk = clk_register(core::ptr::null_mut(), &fd.hw);
    if (IS_ERR(pll_clk))
    goto unmap;
...
// Does the synthesizer have a FREQ register?
    ...
    fd.outputs.clk_num++;
    clk_register_clkdev(synth_clk, output_name, core::ptr::null_mut());
    }
