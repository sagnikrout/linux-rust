...
//! Source: drivers/clk/ti/clk-44xx.c
#![no_std]
...
// half of this value.
//
pub const OMAP4_DPLL_ABE_DEFFREQ: c_int = 98304000;
//
// OMAP4 USB DPLL default frequency. In OMAP4430 TRM version V, section
// "3.6.3.9.5 DPLL_USB Preferred Settings" shows that the preferred
// locked frequency for the USB DPLL is 960MHz.
//
pub const OMAP4_DPLL_USB_DEFFREQ: c_int = 960000000;
    static const struct omap_clkctrl_reg_data omap4_mpuss_clkctrl_regs[] __initconst = {
    { OMAP4_MPU_CLKCTRL, core::ptr::null_mut(), 0, "dpll_mpu_m2_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_tesla_clkctrl_regs[] __initconst = {
    { OMAP4_DSP_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP | CLKF_NO_IDLEST, "dpll_iva_m4x2_ck" },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_func_dmic_abe_gfclk_parents, core::ptr::null_mut() },
    { 26, TI_CLK_MUX, omap4_dmic_sync_mux_ck_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_func_mcasp_abe_gfclk_parents, core::ptr::null_mut() },
    { 26, TI_CLK_MUX, omap4_dmic_sync_mux_ck_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_func_mcbsp1_gfclk_parents, core::ptr::null_mut() },
    { 26, TI_CLK_MUX, omap4_dmic_sync_mux_ck_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_func_mcbsp2_gfclk_parents, core::ptr::null_mut() },
    { 26, TI_CLK_MUX, omap4_dmic_sync_mux_ck_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_func_mcbsp3_gfclk_parents, core::ptr::null_mut() },
    { 26, TI_CLK_MUX, omap4_dmic_sync_mux_ck_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 8, TI_CLK_GATE, omap4_slimbus1_fclk_0_parents, core::ptr::null_mut() },
    { 9, TI_CLK_GATE, omap4_slimbus1_fclk_1_parents, core::ptr::null_mut() },
    { 10, TI_CLK_GATE, omap4_slimbus1_fclk_2_parents, core::ptr::null_mut() },
    { 11, TI_CLK_GATE, omap4_slimbus1_slimbus_clk_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_timer5_sync_mux_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { OMAP4_L4_ABE_CLKCTRL, core::ptr::null_mut(), 0, "ocp_abe_iclk" },
    { OMAP4_AESS_CLKCTRL, omap4_aess_bit_data, CLKF_SW_SUP, "abe-clkctrl:0008:24" },
    { OMAP4_MCPDM_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "pad_clks_ck" },
    ...
    { OMAP4_WD_TIMER3_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "sys_32k_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_l4_ao_clkctrl_regs[] __initconst = {
    { OMAP4_SMARTREFLEX_MPU_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "l4_wkup_clk_mux_ck" },
    { OMAP4_SMARTREFLEX_IVA_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "l4_wkup_clk_mux_ck" },
    { OMAP4_SMARTREFLEX_CORE_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "l4_wkup_clk_mux_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_l3_1_clkctrl_regs[] __initconst = {
    { OMAP4_L3_MAIN_1_CLKCTRL, core::ptr::null_mut(), 0, "l3_div_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_l3_2_clkctrl_regs[] __initconst = {
    { OMAP4_L3_MAIN_2_CLKCTRL, core::ptr::null_mut(), 0, "l3_div_ck" },
    { OMAP4_GPMC_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP, "l3_div_ck" },
    { OMAP4_OCMC_RAM_CLKCTRL, core::ptr::null_mut(), 0, "l3_div_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_ducati_clkctrl_regs[] __initconst = {
    { OMAP4_IPU_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP | CLKF_NO_IDLEST, "ducati_clk_mux_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_l3_dma_clkctrl_regs[] __initconst = {
    { OMAP4_DMA_SYSTEM_CLKCTRL, core::ptr::null_mut(), 0, "l3_div_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_l3_emif_clkctrl_regs[] __initconst = {
    { OMAP4_DMM_CLKCTRL, core::ptr::null_mut(), 0, "l3_div_ck" },
    { OMAP4_EMIF1_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP, "ddrphy_ck" },
    { OMAP4_EMIF2_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP, "ddrphy_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_d2d_clkctrl_regs[] __initconst = {
    { OMAP4_C2C_CLKCTRL, core::ptr::null_mut(), 0, "div_core_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_l4_cfg_clkctrl_regs[] __initconst = {
    { OMAP4_L4_CFG_CLKCTRL, core::ptr::null_mut(), 0, "l4_div_ck" },
    { OMAP4_SPINLOCK_CLKCTRL, core::ptr::null_mut(), 0, "l4_div_ck" },
    { OMAP4_MAILBOX_CLKCTRL, core::ptr::null_mut(), 0, "l4_div_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_l3_instr_clkctrl_regs[] __initconst = {
    { OMAP4_L3_MAIN_3_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP, "l3_div_ck" },
    { OMAP4_L3_INSTR_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP, "l3_div_ck" },
    { OMAP4_OCP_WP_NOC_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP, "l3_div_ck" },
    { 0 },
    };
    static const struct omap_clkctrl_reg_data omap4_ivahd_clkctrl_regs[] __initconst = {
    { OMAP4_IVA_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP | CLKF_NO_IDLEST, "dpll_iva_m5x2_ck" },
    { OMAP4_SL2IF_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP, "dpll_iva_m5x2_ck" },
    { 0 },
    };
    ...
    { 8, TI_CLK_GATE, omap4_iss_ctrlclk_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 8, TI_CLK_GATE, omap4_dss_dss_clk_parents, core::ptr::null_mut() },
    { 9, TI_CLK_GATE, omap4_dss_48mhz_clk_parents, core::ptr::null_mut() },
    { 10, TI_CLK_GATE, omap4_dss_sys_clk_parents, core::ptr::null_mut() },
    { 11, TI_CLK_GATE, omap4_dss_tv_clk_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_sgx_clk_mux_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_hsmmc1_fclk_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 8, TI_CLK_GATE, omap4_usb_host_hs_utmi_p1_clk_parents, core::ptr::null_mut() },
    { 9, TI_CLK_GATE, omap4_usb_host_hs_utmi_p2_clk_parents, core::ptr::null_mut() },
    { 10, TI_CLK_GATE, omap4_usb_host_hs_utmi_p3_clk_parents, core::ptr::null_mut() },
    { 11, TI_CLK_GATE, omap4_usb_host_hs_utmi_p3_clk_parents, core::ptr::null_mut() },
    { 12, TI_CLK_GATE, omap4_usb_host_hs_utmi_p3_clk_parents, core::ptr::null_mut() },
    { 13, TI_CLK_GATE, omap4_usb_host_hs_hsic480m_p1_clk_parents, core::ptr::null_mut() },
    { 14, TI_CLK_GATE, omap4_usb_host_hs_hsic480m_p1_clk_parents, core::ptr::null_mut() },
    { 15, TI_CLK_GATE, omap4_dss_48mhz_clk_parents, core::ptr::null_mut() },
    { 24, TI_CLK_MUX, omap4_utmi_p1_gfclk_parents, core::ptr::null_mut() },
    { 25, TI_CLK_MUX, omap4_utmi_p2_gfclk_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 8, TI_CLK_GATE, omap4_usb_otg_hs_xclk_parents, core::ptr::null_mut() },
    { 24, TI_CLK_MUX, omap4_otg_60m_gfclk_parents, core::ptr::null_mut() },
    { 0 },
    };
    static const struct omap_clkctrl_bit_data omap4_usb_tll_hs_bit_data[] __initconst = {
    { 8, TI_CLK_GATE, omap4_usb_host_hs_utmi_p3_clk_parents, core::ptr::null_mut() },
    { 9, TI_CLK_GATE, omap4_usb_host_hs_utmi_p3_clk_parents, core::ptr::null_mut() },
    { 10, TI_CLK_GATE, omap4_usb_host_hs_utmi_p3_clk_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 8, TI_CLK_GATE, omap4_ocp2scp_usb_phy_phy_48m_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { OMAP4_USB_HOST_FS_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48mc_fclk" },
    ...
    { 24, TI_CLK_MUX, omap4_cm2_dm10_mux_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 8, TI_CLK_GATE, omap4_gpio2_dbclk_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 24, TI_CLK_MUX, omap4_per_mcbsp4_gfclk_parents, core::ptr::null_mut() },
    { 26, TI_CLK_MUX, omap4_mcbsp4_sync_mux_ck_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { 8, TI_CLK_GATE, omap4_slimbus2_fclk_0_parents, core::ptr::null_mut() },
    { 9, TI_CLK_GATE, omap4_slimbus2_fclk_1_parents, core::ptr::null_mut() },
    { 10, TI_CLK_GATE, omap4_slimbus2_slimbus_clk_parents, core::ptr::null_mut() },
    { 0 },
    };
    ...
    { OMAP4_ELM_CLKCTRL, core::ptr::null_mut(), 0, "l4_div_ck" },
    ...
    { OMAP4_HDQ1W_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_12m_fclk" },
    { OMAP4_I2C1_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_96m_fclk" },
    { OMAP4_I2C2_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_96m_fclk" },
    { OMAP4_I2C3_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_96m_fclk" },
    { OMAP4_I2C4_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_96m_fclk" },
    { OMAP4_L4_PER_CLKCTRL, core::ptr::null_mut(), 0, "l4_div_ck" },
    { OMAP4_MCBSP4_CLKCTRL, omap4_mcbsp4_bit_data, CLKF_SW_SUP, "l4-per-clkctrl:00c0:24" },
    { OMAP4_MCSPI1_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_MCSPI2_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_MCSPI3_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_MCSPI4_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_MMC3_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_MMC4_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_SLIMBUS2_CLKCTRL, omap4_slimbus2_bit_data, CLKF_SW_SUP, "l4-per-clkctrl:0118:8" },
    { OMAP4_UART1_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_UART2_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_UART3_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_UART4_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { OMAP4_MMC5_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "func_48m_fclk" },
    { 0 },
    };
    static const struct
    omap_clkctrl_reg_data omap4_l4_secure_clkctrl_regs[] __initconst = {
    { OMAP4_AES1_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "l3_div_ck" },
    { OMAP4_AES2_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "l3_div_ck" },
    { OMAP4_DES3DES_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "l4_div_ck" },
    { OMAP4_PKA_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "l4_div_ck" },
    { OMAP4_RNG_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP | CLKF_SOC_NONSEC, "l4_div_ck" },
    { OMAP4_SHA2MD5_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "l3_div_ck" },
    { OMAP4_CRYPTODMA_CLKCTRL, core::ptr::null_mut(), CLKF_HW_SUP | CLKF_SOC_NONSEC, "l3_div_ck" },
    { 0 },
    };
    ...
    { OMAP4_L4_WKUP_CLKCTRL, core::ptr::null_mut(), 0, "l4_wkup_clk_mux_ck" },
    { OMAP4_WD_TIMER2_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "sys_32k_ck" },
    ...
    { OMAP4_COUNTER_32K_CLKCTRL, core::ptr::null_mut(), 0, "sys_32k_ck" },
    { OMAP4_KBD_CLKCTRL, core::ptr::null_mut(), CLKF_SW_SUP, "sys_32k_ck" },
    { 0 },
    };
    ...
    { 20, TI_CLK_MUX, omap4_pmd_stm_clock_mux_ck_parents, core::ptr::null_mut() },
    { 22, TI_CLK_MUX, omap4_pmd_stm_clock_mux_ck_parents, core::ptr::null_mut() },
...
// also.
//
    DT_CLK(core::ptr::null_mut(), "aess_fclk", "abe-clkctrl:0008:24"),
    DT_CLK(core::ptr::null_mut(), "cm2_dm10_mux", "l4-per-clkctrl:0008:24"),
    DT_CLK(core::ptr::null_mut(), "cm2_dm11_mux", "l4-per-clkctrl:0010:24"),
    DT_CLK(core::ptr::null_mut(), "cm2_dm2_mux", "l4-per-clkctrl:0018:24"),
    DT_CLK(core::ptr::null_mut(), "cm2_dm3_mux", "l4-per-clkctrl:0020:24"),
    DT_CLK(core::ptr::null_mut(), "cm2_dm4_mux", "l4-per-clkctrl:0028:24"),
    DT_CLK(core::ptr::null_mut(), "cm2_dm9_mux", "l4-per-clkctrl:0030:24"),
    DT_CLK(core::ptr::null_mut(), "dmic_sync_mux_ck", "abe-clkctrl:0018:26"),
    DT_CLK(core::ptr::null_mut(), "dmt1_clk_mux", "l4-wkup-clkctrl:0020:24"),
    DT_CLK(core::ptr::null_mut(), "dss_48mhz_clk", "l3-dss-clkctrl:0000:9"),
    DT_CLK(core::ptr::null_mut(), "dss_dss_clk", "l3-dss-clkctrl:0000:8"),
    DT_CLK(core::ptr::null_mut(), "dss_sys_clk", "l3-dss-clkctrl:0000:10"),
    DT_CLK(core::ptr::null_mut(), "dss_tv_clk", "l3-dss-clkctrl:0000:11"),
    DT_CLK(core::ptr::null_mut(), "fdif_fck", "iss-clkctrl:0008:24"),
    DT_CLK(core::ptr::null_mut(), "func_dmic_abe_gfclk", "abe-clkctrl:0018:24"),
    DT_CLK(core::ptr::null_mut(), "func_mcasp_abe_gfclk", "abe-clkctrl:0020:24"),
    DT_CLK(core::ptr::null_mut(), "func_mcbsp1_gfclk", "abe-clkctrl:0028:24"),
    DT_CLK(core::ptr::null_mut(), "func_mcbsp2_gfclk", "abe-clkctrl:0030:24"),
    DT_CLK(core::ptr::null_mut(), "func_mcbsp3_gfclk", "abe-clkctrl:0038:24"),
    DT_CLK(core::ptr::null_mut(), "gpio1_dbclk", "l4-wkup-clkctrl:0018:8"),
    DT_CLK(core::ptr::null_mut(), "gpio2_dbclk", "l4-per-clkctrl:0040:8"),
    DT_CLK(core::ptr::null_mut(), "gpio3_dbclk", "l4-per-clkctrl:0048:8"),
    DT_CLK(core::ptr::null_mut(), "gpio4_dbclk", "l4-per-clkctrl:0050:8"),
    DT_CLK(core::ptr::null_mut(), "gpio5_dbclk", "l4-per-clkctrl:0058:8"),
    DT_CLK(core::ptr::null_mut(), "gpio6_dbclk", "l4-per-clkctrl:0060:8"),
    DT_CLK(core::ptr::null_mut(), "hsi_fck", "l3-init-clkctrl:0018:24"),
    DT_CLK(core::ptr::null_mut(), "hsmmc1_fclk", "l3-init-clkctrl:0008:24"),
    DT_CLK(core::ptr::null_mut(), "hsmmc2_fclk", "l3-init-clkctrl:0010:24"),
    DT_CLK(core::ptr::null_mut(), "iss_ctrlclk", "iss-clkctrl:0000:8"),
    DT_CLK(core::ptr::null_mut(), "mcasp_sync_mux_ck", "abe-clkctrl:0020:26"),
    ...
    DT_CLK(core::ptr::null_mut(), "mcbsp4_sync_mux_ck", "l4-per-clkctrl:00c0:26"),
    DT_CLK("48096000.mcbsp", "prcm_fck", "l4-per-clkctrl:00c0:26"),
    DT_CLK(core::ptr::null_mut(), "ocp2scp_usb_phy_phy_48m", "l3-init-clkctrl:00c0:8"),
    DT_CLK(core::ptr::null_mut(), "otg_60m_gfclk", "l3-init-clkctrl:0040:24"),
    DT_CLK(core::ptr::null_mut(), "pad_fck", "pad_clks_ck"),
    DT_CLK(core::ptr::null_mut(), "per_mcbsp4_gfclk", "l4-per-clkctrl:00c0:24"),
    DT_CLK(core::ptr::null_mut(), "pmd_stm_clock_mux_ck", "emu-sys-clkctrl:0000:20"),
    DT_CLK(core::ptr::null_mut(), "pmd_trace_clk_mux_ck", "emu-sys-clkctrl:0000:22"),
    DT_CLK(core::ptr::null_mut(), "sgx_clk_mux", "l3-gfx-clkctrl:0000:24"),
    DT_CLK(core::ptr::null_mut(), "slimbus1_fclk_0", "abe-clkctrl:0040:8"),
    DT_CLK(core::ptr::null_mut(), "slimbus1_fclk_1", "abe-clkctrl:0040:9"),
    DT_CLK(core::ptr::null_mut(), "slimbus1_fclk_2", "abe-clkctrl:0040:10"),
    DT_CLK(core::ptr::null_mut(), "slimbus1_slimbus_clk", "abe-clkctrl:0040:11"),
    DT_CLK(core::ptr::null_mut(), "slimbus2_fclk_0", "l4-per-clkctrl:0118:8"),
    DT_CLK(core::ptr::null_mut(), "slimbus2_fclk_1", "l4-per-clkctrl:0118:9"),
    DT_CLK(core::ptr::null_mut(), "slimbus2_slimbus_clk", "l4-per-clkctrl:0118:10"),
    DT_CLK(core::ptr::null_mut(), "stm_clk_div_ck", "emu-sys-clkctrl:0000:27"),
    DT_CLK(core::ptr::null_mut(), "timer5_sync_mux", "abe-clkctrl:0048:24"),
    DT_CLK(core::ptr::null_mut(), "timer6_sync_mux", "abe-clkctrl:0050:24"),
    DT_CLK(core::ptr::null_mut(), "timer7_sync_mux", "abe-clkctrl:0058:24"),
    DT_CLK(core::ptr::null_mut(), "timer8_sync_mux", "abe-clkctrl:0060:24"),
    DT_CLK(core::ptr::null_mut(), "trace_clk_div_div_ck", "emu-sys-clkctrl:0000:24"),
    DT_CLK(core::ptr::null_mut(), "usb_host_hs_func48mclk", "l3-init-clkctrl:0038:15"),
    DT_CLK(core::ptr::null_mut(), "usb_host_hs_hsic480m_p1_clk", "l3-init-clkctrl:0038:13"),
    DT_CLK(core::ptr::null_mut(), "usb_host_hs_hsic480m_p2_clk", "l3-init-clkctrl:0038:14"),
    DT_CLK(core::ptr::null_mut(), "usb_host_hs_hsic60m_p1_clk", "l3-init-clkctrl:0038:11"),
    DT_CLK(core::ptr::null_mut(), "usb_host_hs_hsic60m_p2_clk", "l3-init-clkctrl:0038:12"),
    DT_CLK(core::ptr::null_mut(), "usb_host_hs_utmi_p1_clk", "l3-init-clkctrl:0038:8"),
    DT_CLK(core::ptr::null_mut(), "usb_host_hs_utmi_p2_clk", "l3-init-clkctrl:0038:9"),
    DT_CLK(core::ptr::null_mut(), "usb_host_hs_utmi_p3_clk", "l3_init-clkctrl:0038:10"),
    DT_CLK(core::ptr::null_mut(), "usb_otg_hs_xclk", "l3-init-clkctrl:0040:8"),
    DT_CLK(core::ptr::null_mut(), "usb_tll_hs_usb_ch0_clk", "l3-init-clkctrl:0048:8"),
    DT_CLK(core::ptr::null_mut(), "usb_tll_hs_usb_ch1_clk", "l3-init-clkctrl:0048:9"),
    DT_CLK(core::ptr::null_mut(), "usb_tll_hs_usb_ch2_clk", "l3-init-clkctrl:0048:10"),
    DT_CLK(core::ptr::null_mut(), "utmi_p1_gfclk", "l3-init-clkctrl:0038:24"),
    DT_CLK(core::ptr::null_mut(), "utmi_p2_gfclk", "l3-init-clkctrl:0038:25"),
    { .node_name = core::ptr::null_mut() },
    };
#[no_mangle]
pub unsafe extern "C" fn omap4xxx_dt_clk_init() -> int __init {
...
//
    abe_dpll_ref = clk_get_sys(core::ptr::null_mut(), "abe_dpll_refclk_mux_ck");
