...
//! Source: drivers/clk/clk-versaclock3.c
#![no_std]
...
pub const NUM_CONFIG_REGISTERS: c_int = 37;
pub const VC3_GENERAL_CTR: c_uint = 0x0;

pub const VC3_PLL3_M_DIVIDER: c_uint = 0x3;

pub const VC3_PLL3_N_DIVIDER: c_uint = 0x4;
pub const VC3_PLL3_LOOP_FILTER_N_DIV_MSB: c_uint = 0x5;
pub const VC3_PLL3_CHARGE_PUMP_CTRL: c_uint = 0x6;

pub const VC3_PLL1_CTRL_OUTDIV5: c_uint = 0x7;

pub const VC3_PLL1_M_DIVIDER: c_uint = 0x8;

pub const VC3_PLL1_VCO_N_DIVIDER: c_uint = 0x9;
pub const VC3_PLL1_LOOP_FILTER_N_DIV_MSB: c_uint = 0xa;
pub const VC3_OUT_DIV1_DIV2_CTRL: c_uint = 0xf;
pub const VC3_PLL2_FB_INT_DIV_MSB: c_uint = 0x10;
pub const VC3_PLL2_FB_INT_DIV_LSB: c_uint = 0x11;
pub const VC3_PLL2_FB_FRC_DIV_MSB: c_uint = 0x12;
pub const VC3_PLL2_FB_FRC_DIV_LSB: c_uint = 0x13;
pub const VC3_PLL2_M_DIVIDER: c_uint = 0x1a;

pub const VC3_OUT_DIV3_DIV4_CTRL: c_uint = 0x1b;
pub const VC3_PLL_OP_CTRL: c_uint = 0x1c;
pub const VC3_PLL_OP_CTRL_PLL2_REFIN_SEL: c_int = 6;
pub const VC3_OUTPUT_CTR: c_uint = 0x1d;

pub const VC3_SE2_CTRL_REG0: c_uint = 0x1f;

pub const VC3_SE3_DIFF1_CTRL_REG: c_uint = 0x21;

pub const VC3_DIFF1_CTRL_REG: c_uint = 0x22;

pub const VC3_DIFF2_CTRL_REG: c_uint = 0x23;

pub const VC3_SE1_DIV4_CTRL: c_uint = 0x24;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc3_pll_data {
    pub vco: vc3_vco,
    pub num: u8,
    pub int_div_msb_offs: u8,
    pub int_div_lsb_offs: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc3_div_data {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc3_hw_cfg {
    pub pll2_vco: vc3_vco,
    pub se2_clk_sel_msk: u32,
}
...
#[no_mangle]
unsafe extern "C" fn vc3_pfd_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn vc3_pfd_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(VC3_PFD2: pfd->num ==) -> else {
    else if (pfd.num == VC3_PFD2)
...
#[no_mangle]
unsafe extern "C" fn vc3_div_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn vc3_div_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc3_clk_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn vc3_clk_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc3_probe(client: *mut i2c_client) -> c_int {
