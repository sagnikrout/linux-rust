...
//! Source: drivers/clk/nxp/clk-lpc18xx-cgu.c
#![no_std]
...
pub const LPC18XX_CGU_XTAL_OSC_CTRL: c_uint = 0x018;
pub const LPC18XX_CGU_PLL0USB_STAT: c_uint = 0x01c;
pub const LPC18XX_CGU_PLL0USB_CTRL: c_uint = 0x020;
pub const LPC18XX_CGU_PLL0USB_MDIV: c_uint = 0x024;
pub const LPC18XX_CGU_PLL0USB_NP_DIV: c_uint = 0x028;
pub const LPC18XX_CGU_PLL0AUDIO_STAT: c_uint = 0x02c;
pub const LPC18XX_CGU_PLL0AUDIO_CTRL: c_uint = 0x030;
pub const LPC18XX_CGU_PLL0AUDIO_MDIV: c_uint = 0x034;
pub const LPC18XX_CGU_PLL0AUDIO_NP_DIV: c_uint = 0x038;
pub const LPC18XX_CGU_PLL0AUDIO_FRAC: c_uint = 0x03c;
pub const LPC18XX_CGU_PLL1_STAT: c_uint = 0x040;
pub const LPC18XX_CGU_PLL1_CTRL: c_uint = 0x044;

pub const LPC18XX_CGU_PLL_CTRL_OFFSET: c_uint = 0x4;
// PLL0 bits common to both audio and USB PLL

pub const LPC18XX_PLL0_MDIV_MDEC_MASK: c_uint = 0x1ffff;
pub const LPC18XX_PLL0_MDIV_SELP_SHIFT: c_int = 17;
pub const LPC18XX_PLL0_MDIV_SELI_SHIFT: c_int = 22;

// Register value that gives PLL0 post/pre dividers equal to 1
pub const LPC18XX_PLL0_NP_DIVS_1: c_uint = 0x00302062;
    enum {
    CLK_SRC_OSC32,
    CLK_SRC_IRC,
    CLK_SRC_ENET_RX_CLK,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc18xx_cgu_src_clk_div {
    pub clk_id: u8,
    pub n_parents: u8,
    pub div: clk_divider,
    pub mux: clk_mux,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc18xx_cgu_base_clk {
    pub clk_id: u8,
    pub n_parents: u8,
    pub mux: clk_mux,
    pub gate: clk_gate,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc18xx_cgu_pll_clk {
    pub clk_id: u8,
    pub n_parents: u8,
    pub reg_offset: u8,
    pub mux: clk_mux,
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pll0_mdec2msel(x: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pll0_msel2mdec(msel: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pll0_msel2seli(msel: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_pll0_msel2selp(msel: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_cgu_gate_enable(hw: *mut clk_hw) -> c_int {
    static int lpc18xx_cgu_gate_enable(struct clk_hw *hw)
    {
    return clk_gate_ops.enable(hw);
    }
#[no_mangle]
unsafe extern "C" fn lpc18xx_cgu_gate_disable(hw: *mut clk_hw) {
    static void lpc18xx_cgu_gate_disable(struct clk_hw *hw)
    {
    clk_gate_ops.disable(hw);
    }
#[no_mangle]
unsafe extern "C" fn lpc18xx_cgu_gate_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_fill_parent_names(parent: *const c_char, id: *const u32, size: c_int) {
    ...
    return clk_register_composite(core::ptr::null_mut(), name, parents, clk.n_parents,
...
// SAFE_CLK can not be turned off
    ...
    return clk_register_composite(core::ptr::null_mut(), name, parents, clk.n_parents,
    &clk.mux.hw, &clk_mux_ops,
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0);
    return clk_register_composite(core::ptr::null_mut(), name, parents, clk.n_parents,
    &clk.mux.hw, &clk_mux_ops,
...
// Register the internal 12 MHz RC oscillator (IRC)
    clk = clk_register_fixed_rate(core::ptr::null_mut(), clk_src_names[CLK_SRC_IRC],
    core::ptr::null_mut(), 0, 12000000);
    if (IS_ERR(clk))
    pr_warn("%s: failed to register irc clk\n", __func__);
// Register crystal oscillator controller
    parents[0] = of_clk_get_parent_name(np, 0);
    clk = clk_register_gate(core::ptr::null_mut(), clk_src_names[CLK_SRC_OSC], parents[0],
    0, base + LPC18XX_CGU_XTAL_OSC_CTRL,
    0, CLK_GATE_SET_TO_DISABLE, core::ptr::null_mut());
    if (IS_ERR(clk))
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_cgu_register_base_clks(reg_base: *mut void __iomem) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_cgu_init(np: *mut device_node) -> void __init {
