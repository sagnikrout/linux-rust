...
//! Source: drivers/clk/nxp/clk-lpc32xx.c
#![no_std]
...
pub const LPC32XX_CLKPWR_DEBUG_CTRL: c_uint = 0x00;
pub const LPC32XX_CLKPWR_USB_DIV: c_uint = 0x1C;
pub const LPC32XX_CLKPWR_HCLKDIV_CTRL: c_uint = 0x40;
pub const LPC32XX_CLKPWR_PWR_CTRL: c_uint = 0x44;
pub const LPC32XX_CLKPWR_PLL397_CTRL: c_uint = 0x48;
pub const LPC32XX_CLKPWR_OSC_CTRL: c_uint = 0x4C;
pub const LPC32XX_CLKPWR_SYSCLK_CTRL: c_uint = 0x50;
pub const LPC32XX_CLKPWR_LCDCLK_CTRL: c_uint = 0x54;
pub const LPC32XX_CLKPWR_HCLKPLL_CTRL: c_uint = 0x58;
pub const LPC32XX_CLKPWR_ADCCLK_CTRL1: c_uint = 0x60;
pub const LPC32XX_CLKPWR_USB_CTRL: c_uint = 0x64;
pub const LPC32XX_CLKPWR_SSP_CTRL: c_uint = 0x78;
pub const LPC32XX_CLKPWR_I2S_CTRL: c_uint = 0x7C;
pub const LPC32XX_CLKPWR_MS_CTRL: c_uint = 0x80;
pub const LPC32XX_CLKPWR_MACCLK_CTRL: c_uint = 0x90;
pub const LPC32XX_CLKPWR_TEST_CLK_CTRL: c_uint = 0xA4;
pub const LPC32XX_CLKPWR_I2CCLK_CTRL: c_uint = 0xAC;
pub const LPC32XX_CLKPWR_KEYCLK_CTRL: c_uint = 0xB0;
pub const LPC32XX_CLKPWR_ADCCLK_CTRL: c_uint = 0xB4;
pub const LPC32XX_CLKPWR_PWMCLK_CTRL: c_uint = 0xB8;
pub const LPC32XX_CLKPWR_TIMCLK_CTRL: c_uint = 0xBC;
pub const LPC32XX_CLKPWR_TIMCLK_CTRL1: c_uint = 0xC0;
pub const LPC32XX_CLKPWR_SPI_CTRL: c_uint = 0xC4;
pub const LPC32XX_CLKPWR_FLASHCLK_CTRL: c_uint = 0xC8;
pub const LPC32XX_CLKPWR_UART3_CLK_CTRL: c_uint = 0xD0;
pub const LPC32XX_CLKPWR_UART4_CLK_CTRL: c_uint = 0xD4;
pub const LPC32XX_CLKPWR_UART5_CLK_CTRL: c_uint = 0xD8;
pub const LPC32XX_CLKPWR_UART6_CLK_CTRL: c_uint = 0xDC;
pub const LPC32XX_CLKPWR_IRDA_CLK_CTRL: c_uint = 0xE0;
pub const LPC32XX_CLKPWR_UART_CLK_CTRL: c_uint = 0xE4;
pub const LPC32XX_CLKPWR_DMA_CLK_CTRL: c_uint = 0xE8;
// Clock registers on USB controller
pub const LPC32XX_USB_CLK_CTRL: c_uint = 0xF4;
pub const LPC32XX_USB_CLK_STS: c_uint = 0xF8;
...
pub const LPC32XX_CLK_PARENTS_MAX: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_proto_t {
    pub name: *const c_char,
    pub parents: [u8; LPC32XX_CLK_PARENTS_MAX],
    pub num_parents: u8,
    pub flags: c_ulong,
}
...
pub struct lpc32xx_pll_clk {
    ...
    pub n_div: c_ulong,
    pub p_div: c_ulong,
    pub mode: enum clk_pll_mode,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc32xx_usb_clk {
    pub hw: clk_hw,
    pub ctrl_enable: u32,
    pub ctrl_disable: u32,
    pub ctrl_mask: u32,
    pub enable: u32,
    pub busy: u32,
}
...
#[no_mangle]
unsafe extern "C" fn clk_mask_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_mask_is_enabled(hw: *mut clk_hw) -> c_int {
...
// Check if valid USB divider and USB PLL parameters exists
    ...
    LPC32XX_DEFINE_PLL_OPS(pll_397x, clk_pll_397x_recalc_rate, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn clk_ddram_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_ddram_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_usb_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_usb_disable(hw: *mut clk_hw) {
    static void clk_usb_disable(struct clk_hw *hw)
    {
    struct lpc32xx_usb_clk *clk = to_lpc32xx_usb_clk(hw);
    let mut val: u32 = lpc32xx_usb_clk_read(clk);
    val &= ~clk.enable;
    lpc32xx_usb_clk_write(clk, val);
    if (clk.ctrl_mask)
    regmap_update_bits(clk_regmap, LPC32XX_CLKPWR_USB_CTRL,
...
#[no_mangle]
unsafe extern "C" fn clk_usb_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_clk_gate_enable(hw: *mut clk_hw) -> c_int {
    static int lpc32xx_clk_gate_enable(struct clk_hw *hw)
    {
    struct lpc32xx_clk_gate *clk = to_lpc32xx_gate(hw);
    let mut mask: u32 = BIT(clk.bit_idx);
    let mut val: u32 = (clk.flags & CLK_GATE_SET_TO_DISABLE ? 0x0 : mask);
    return regmap_update_bits(clk_regmap, clk.reg, mask, val);
    }
#[no_mangle]
unsafe extern "C" fn lpc32xx_clk_gate_disable(hw: *mut clk_hw) {
    static void lpc32xx_clk_gate_disable(struct clk_hw *hw)
    {
    struct lpc32xx_clk_gate *clk = to_lpc32xx_gate(hw);
    let mut mask: u32 = BIT(clk.bit_idx);
    let mut val: u32 = (clk.flags & CLK_GATE_SET_TO_DISABLE ? mask : 0x0);
    regmap_update_bits(clk_regmap, clk.reg, mask, val);
    }
#[no_mangle]
unsafe extern "C" fn lpc32xx_clk_gate_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_mux_get_parent(hw: *mut clk_hw) -> u8 {
    static u8 clk_mux_get_parent(struct clk_hw *hw)
    {
    struct lpc32xx_clk_mux *mux = to_lpc32xx_mux(hw);
    let mut num_parents: u32 = clk_hw_get_num_parents(hw);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn clk_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_hw_proto0 {
    pub ops: *const clk_ops,
    union {
    pub pll: lpc32xx_pll_clk,
    pub clk: lpc32xx_clk,
    pub usb_clk: lpc32xx_usb_clk,
    pub mux: lpc32xx_clk_mux,
    pub div: lpc32xx_clk_div,
    pub gate: lpc32xx_clk_gate,
}

    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_hw_proto1 {
    pub mux: *mut clk_hw_proto0,
    pub div: *mut clk_hw_proto0,
    pub gate: *mut clk_hw_proto0,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_hw_proto {
    pub type: enum lpc32xx_clk_type,
    union {
    pub f: clk_fixed_rate,
    pub hw0: clk_hw_proto0,
    pub hw1: clk_hw_proto1,
}
    ...
    {								\
    .hw1 = {						\
    .mux = (CLK_PREFIX(_mux) == LPC32XX_CLK__NULL ? core::ptr::null_mut() :	\
    &clk_hw_proto[CLK_PREFIX(_mux)].hw0),		\
    .div = (CLK_PREFIX(_div) == LPC32XX_CLK__NULL ? core::ptr::null_mut() :	\
    &clk_hw_proto[CLK_PREFIX(_div)].hw0),		\
    .gate = (CLK_PREFIX(_gate) == LPC32XX_CLK__NULL ? core::ptr::null_mut() :\
    ...
    LPC32XX_DEFINE_DIV(HCLK_DIV_PERIPH, HCLKDIV_CTRL, 2, 5, core::ptr::null_mut(),
...
// Register 3 read-only muxes with a single control PWR_CTRL[2]
    LPC32XX_DEFINE_MUX(SYSCLK_PERIPH_MUX, PWR_CTRL, 2, 0x1, core::ptr::null_mut(),
    CLK_MUX_READ_ONLY),
    LPC32XX_DEFINE_MUX(SYSCLK_HCLK_MUX, PWR_CTRL, 2, 0x1, core::ptr::null_mut(),
    CLK_MUX_READ_ONLY),
    LPC32XX_DEFINE_MUX(SYSCLK_ARM_MUX, PWR_CTRL, 2, 0x1, core::ptr::null_mut(),
    CLK_MUX_READ_ONLY),
// Register 2 read-only muxes with a single control PWR_CTRL[10]
    LPC32XX_DEFINE_MUX(PERIPH_HCLK_MUX, PWR_CTRL, 10, 0x1, core::ptr::null_mut(),
    CLK_MUX_READ_ONLY),
    LPC32XX_DEFINE_MUX(PERIPH_ARM_MUX, PWR_CTRL, 10, 0x1, core::ptr::null_mut(),
    CLK_MUX_READ_ONLY),
// 3 always on gates with a single control PWR_CTRL[0] same as OSC
    ...
    LPC32XX_DEFINE_MUX(PWM1_MUX, PWMCLK_CTRL, 1, 0x1, core::ptr::null_mut(), 0),
    LPC32XX_DEFINE_DIV(PWM1_DIV, PWMCLK_CTRL, 4, 4, core::ptr::null_mut(),
    CLK_DIVIDER_ONE_BASED),
    LPC32XX_DEFINE_GATE(PWM1_GATE, PWMCLK_CTRL, 0, 0),
    LPC32XX_DEFINE_COMPOSITE(PWM1, PWM1_MUX, PWM1_DIV, PWM1_GATE),
    LPC32XX_DEFINE_MUX(PWM2_MUX, PWMCLK_CTRL, 3, 0x1, core::ptr::null_mut(), 0),
    LPC32XX_DEFINE_DIV(PWM2_DIV, PWMCLK_CTRL, 8, 4, core::ptr::null_mut(),
    CLK_DIVIDER_ONE_BASED),
    LPC32XX_DEFINE_GATE(PWM2_GATE, PWMCLK_CTRL, 2, 0),
    LPC32XX_DEFINE_COMPOSITE(PWM2, PWM2_MUX, PWM2_DIV, PWM2_GATE),
    LPC32XX_DEFINE_MUX(UART3_MUX, UART3_CLK_CTRL, 16, 0x1, core::ptr::null_mut(), 0),
    ...
    LPC32XX_DEFINE_MUX(UART4_MUX, UART4_CLK_CTRL, 16, 0x1, core::ptr::null_mut(), 0),
    ...
    LPC32XX_DEFINE_MUX(UART5_MUX, UART5_CLK_CTRL, 16, 0x1, core::ptr::null_mut(), 0),
    ...
    LPC32XX_DEFINE_MUX(UART6_MUX, UART6_CLK_CTRL, 16, 0x1, core::ptr::null_mut(), 0),
    ...
    LPC32XX_DEFINE_MUX(SYS, SYSCLK_CTRL, 0, 0x1, core::ptr::null_mut(), CLK_MUX_READ_ONLY),
    LPC32XX_DEFINE_DIV(USB_DIV_DIV, USB_DIV, 0, 4, core::ptr::null_mut(), 0),
    LPC32XX_DEFINE_GATE(USB_DIV_GATE, USB_CTRL, 17, 0),
    LPC32XX_DEFINE_COMPOSITE(USB_DIV, _NULL, USB_DIV_DIV, USB_DIV_GATE),
    LPC32XX_DEFINE_DIV(SD_DIV, MS_CTRL, 0, 4, core::ptr::null_mut(), CLK_DIVIDER_ONE_BASED),
    ...
    LPC32XX_DEFINE_DIV(LCD_DIV, LCDCLK_CTRL, 0, 5, core::ptr::null_mut(), 0),
...
//
    LPC32XX_DEFINE_DIV(ADC_DIV, ADCCLK_CTRL1, 0, 8, core::ptr::null_mut(), 0),
    LPC32XX_DEFINE_GATE(ADC_RTC, ADCCLK_CTRL, 0, 0),
    LPC32XX_DEFINE_MUX(ADC, ADCCLK_CTRL1, 8, 0x1, core::ptr::null_mut(), 0),
// USB controller clocks
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_clk_register(id: u32) -> *mut clk  __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(CLK_LPC32XX_PLL: clk_hw->type ==) -> else {
    else if (clk_hw.type == CLK_LPC32XX_PLL)
    hw = &clk_hw.hw0.pll.hw;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_LPC32XX_USB: clk_hw->type ==) -> else {
    else if (clk_hw.type == CLK_LPC32XX_USB)
    hw = &clk_hw.hw0.usb_clk.hw;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_MUX: clk_hw->type ==) -> else {
    else if (clk_hw.type == CLK_MUX)
    hw = &clk_hw.hw0.mux.hw;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_DIV: clk_hw->type ==) -> else {
    else if (clk_hw.type == CLK_DIV)
    hw = &clk_hw.hw0.div.hw;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_GATE: clk_hw->type ==) -> else {
    else if (clk_hw.type == CLK_GATE)
    hw = &clk_hw.hw0.gate.hw;
    else
    return ERR_PTR(-EINVAL);
    hw.init = &clk_init;
    clk = clk_register(core::ptr::null_mut(), hw);
    break;
    }
    case CLK_COMPOSITE:
    {
    struct clk_hw *mux_hw = core::ptr::null_mut(), *div_hw = core::ptr::null_mut(), *gate_hw = core::ptr::null_mut();
    const struct clk_ops *mops = core::ptr::null_mut(), *dops = core::ptr::null_mut(), *gops = core::ptr::null_mut();
    ...
    clk = clk_register_composite(core::ptr::null_mut(), lpc32xx_clk.name,
    ...
    clk = clk_register_fixed_rate(core::ptr::null_mut(), lpc32xx_clk.name,
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_clk_div_quirk(reg: u32, div_mask: u32, gate: u32) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_clk_init(np: *mut device_node) -> void __init {
...
// Ensure that parent clocks are available and valid
    ...
    clk_regmap = regmap_init_mmio(core::ptr::null_mut(), base, &lpc32xx_scb_regmap_config);
...
#[no_mangle]
unsafe extern "C" fn lpc32xx_usb_clk_init(np: *mut device_node) -> void __init {
