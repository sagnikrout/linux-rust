...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eqc_clock {
    pub index: c_int,
    pub parent_idx: c_int,
    ...
    pub cells): *mut clk_hw_onecell_data,
    pub hw): *mut *mut void (unregister)(struct clk_hw,
    union {
    struct {
    pub reg: c_uint,
    pub shift: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eqc_match_data {
    pub clk_count: c_uint,
    pub clks: *const eqc_clock,
    pub reset_auxdev_name: *const c_char,
    pub pinctrl_auxdev_name: *const c_char,
    pub eth_phy_auxdev_name: *const c_char,
    pub early_clk_count: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct eqc_early_match_data {
    pub early_clk_count: c_uint,
    pub early_clks: *const eqc_clock,
//
// We want our of_xlate callback to EPROBE_DEFER instead of dev_err()
// and EINVAL. For that, we must know the total clock count.
//
    pub late_clk_count: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn eqc_pll_downshift_factors(mult: *mut c_ulong, div: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn eqc_pll_parse_aintp(base: *mut void __iomem, mult: *mut c_ulong, div: *mut c_ulong) -> c_int {
...
// make sure mult and div fit in 32 bits
    ...
    {
    let mut pidx: c_int = clk.parent_idx;
...
// no parent lookup by index: explicitly fail
    ...
    clk.div.width, clk.div.flags, clk.div.table, core::ptr::null_mut());
    if (IS_ERR(hw))
    return PTR_ERR(hw);
...
#[no_mangle]
unsafe extern "C" fn eqc_probe(pdev: *mut platform_device) -> c_int {
...
// Early PLLs are marked as errors: the early provider will get queried.
    ...
    if (clk.probe)
    ret = clk.probe(dev, core::ptr::null_mut(), clk, base, cells);
    else
    ret = -EINVAL;
    if (ret)
...
// Required early for GIC timer (pll-cpu) and UARTs (pll-per).
    ...
    FF(EQ5C_CPU_OCC, EQ5C_PLL_CPU, "occ-cpu", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_CPU_SI_CSS0, EQ5C_CPU_OCC, "si-css0", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_CPU_CORE0, EQ5C_CPU_SI_CSS0, "core0", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_CPU_CORE1, EQ5C_CPU_SI_CSS0, "core1", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_CPU_CORE2, EQ5C_CPU_SI_CSS0, "core2", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_CPU_CORE3, EQ5C_CPU_SI_CSS0, "core3", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_PER_OCC, EQ5C_PLL_PER, "occ-periph", core::ptr::null_mut(), 1, 16),
    FF(EQ5C_PER_UART, EQ5C_PER_OCC, "uart", core::ptr::null_mut(), 1, 1),
    };
    ...
    FF(EQ5C_CPU_ISRAM, EQ5C_CPU_OCC_ISRAM, "isram", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_CPU_OCC_DBU, PARENT_BY_NAME, "occ-dbu", "pll-cpu", 1, 10),
    FF(EQ5C_CPU_SI_DBU_TP, EQ5C_CPU_OCC_DBU, "si-dbu-tp", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_VDI_OCC_VDI, PARENT_BY_NAME, "occ-vdi", "pll-vdi", 1, 2),
    FF(EQ5C_VDI_VDI, EQ5C_VDI_OCC_VDI, "vdi", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_VDI_OCC_CAN_SER, PARENT_BY_NAME, "occ-can-ser", "pll-vdi", 1, 16),
    FF(EQ5C_VDI_CAN_SER, EQ5C_VDI_OCC_CAN_SER, "can-ser", core::ptr::null_mut(), 1, 1),
    ...
    FF(EQ5C_PER_HSM, EQ5C_PER_OCC_MJPEG, "hsm", core::ptr::null_mut(), 1, 1),
    FF(EQ5C_PER_MJPEG, EQ5C_PER_OCC_MJPEG, "mjpeg", core::ptr::null_mut(), 1, 1),
    ...
    FF(EQ6LPC_CPU_OCC, EQ6LPC_PLL_CPU, "occ-cpu", core::ptr::null_mut(), 1, 1),
    };
    ...
    FF(EQ6LPC_DDR_OCC, EQ6LPC_PLL_DDR, "occ-ddr", core::ptr::null_mut(), 1, 1),
    FF(EQ6LPC_ACC_VDI, EQ6LPC_PLL_ACC, "vdi-div", core::ptr::null_mut(), 1, 10),
    FF(EQ6LPC_ACC_OCC, EQ6LPC_PLL_ACC, "occ-acc", core::ptr::null_mut(), 1, 1),
    FF(EQ6LPC_ACC_FCMU, EQ6LPC_ACC_OCC, "fcmu-a-clk", core::ptr::null_mut(), 1, 10),
    FF(EQ6LPC_PER_OCC, EQ6LPC_PLL_PER, "occ-per", core::ptr::null_mut(), 1, 1),
    FF(EQ6LPC_PER_I2C_SER, EQ6LPC_PER_OCC, "i2c-ser-clk", core::ptr::null_mut(), 1, 10),
    FF(EQ6LPC_PER_PCLK, EQ6LPC_PER_OCC, "pclk", core::ptr::null_mut(), 1, 4),
    FF(EQ6LPC_PER_TSU, EQ6LPC_PER_OCC, "tsu-clk", core::ptr::null_mut(), 1, 8),
    FF(EQ6LPC_PER_OSPI, EQ6LPC_PER_OCC, "ospi-ref-clk", core::ptr::null_mut(), 1, 10),
    FF(EQ6LPC_PER_GPIO, EQ6LPC_PER_OCC, "gpio-clk", core::ptr::null_mut(), 1, 4),
    FF(EQ6LPC_PER_TIMER, EQ6LPC_PER_OCC, "timer-clk", core::ptr::null_mut(), 1, 4),
    FF(EQ6LPC_PER_I2C, EQ6LPC_PER_OCC, "i2c-clk", core::ptr::null_mut(), 1, 4),
    FF(EQ6LPC_PER_UART, EQ6LPC_PER_OCC, "uart-clk", core::ptr::null_mut(), 1, 4),
    FF(EQ6LPC_PER_SPI, EQ6LPC_PER_OCC, "spi-clk", core::ptr::null_mut(), 1, 4),
    FF(EQ6LPC_PER_PERIPH, EQ6LPC_PER_OCC, "periph-clk", core::ptr::null_mut(), 1, 1),
    FF(EQ6LPC_VDI_OCC, EQ6LPC_PLL_VDI, "occ-vdi", core::ptr::null_mut(), 1, 1),
    };
    ...
    DIV(EQ6HC_SOUTH_DIV_EMMC, EQ6HC_SOUTH_PLL_PER, "div-emmc", core::ptr::null_mut(), 0x070, 4, 4),
    DIV(EQ6HC_SOUTH_DIV_OSPI_REF, EQ6HC_SOUTH_PLL_PER, "div-ospi-ref", core::ptr::null_mut(), 0x090, 4, 4),
    DIV(EQ6HC_SOUTH_DIV_OSPI_SYS, EQ6HC_SOUTH_PLL_PER, "div-ospi-sys", core::ptr::null_mut(), 0x090, 8, 1),
    DIV(EQ6HC_SOUTH_DIV_TSU, EQ6HC_SOUTH_PLL_PCIE, "div-tsu", core::ptr::null_mut(), 0x098, 4, 8),
    };
    ...
    FF(EQ7HC_ACC_DIV_PMA, EQ7HC_ACC_PLL_PMA, "acc0_pma", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_ACC_DIV_NCORE, EQ7HC_ACC_PLL_NOC, "acc0_ncore", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_ACC_DIV_CFG, EQ7HC_ACC_PLL_NOC, "acc0_cfg", core::ptr::null_mut(), 1, 8),
    };
...
// A single bit configures the 3 dividers below
    DIV_TABLE_RO(EQ7HC_DDR_DIV_APB, EQ7HC_DDR_PLL, "div-ddr0_apb", core::ptr::null_mut(),
    0x08, 10, 1, eqc_eyeq7h_ddr_apb_div_table),
    DIV_TABLE_RO(EQ7HC_DDR_DIV_PLLREF, EQ7HC_DDR_PLL, "div-ddr0_pllref", core::ptr::null_mut(),
    0x08, 10, 1, eqc_eyeq7h_ddr_ref_div_table),
    DIV_TABLE_RO(EQ7HC_DDR_DIV_DFI, EQ7HC_DDR_PLL, "div-ddr0-dfi", core::ptr::null_mut(),
...
// A single bit configures the 3 dividers below
    DIV_TABLE_RO(EQ7HC_DDR_DIV_APB, EQ7HC_DDR_PLL, "div-ddr1_apb", core::ptr::null_mut(),
    0x08, 10, 1, eqc_eyeq7h_ddr_apb_div_table),
    DIV_TABLE_RO(EQ7HC_DDR_DIV_PLLREF, EQ7HC_DDR_PLL, "div-ddr1_pllref", core::ptr::null_mut(),
    0x08, 10, 1, eqc_eyeq7h_ddr_ref_div_table),
    DIV_TABLE_RO(EQ7HC_DDR_DIV_DFI, EQ7HC_DDR_PLL, "div-ddr1-dfi", core::ptr::null_mut(),
    0x08, 10, 1, eqc_eyeq7h_ddr_dfi_div_table),
    };
    ...
    FF(EQ7HC_EAST_DIV_REF_106P6, EQ7HC_EAST_PLL_106P6, "ref_106p6_e", core::ptr::null_mut(), 1, 40),
    PLL_AINTP(EQ7HC_EAST_PLL_NOC, EQ7HC_EAST_DIV_REF_106P6, "pll-noc-e", core::ptr::null_mut(), 0x30),
    ...
    FF(EQ7HC_EAST_DIV_REF_DDR_PHY, EQ7HC_EAST_PLL_106P6, "ref_ddr_phy_e", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_EAST_DIV_CORE, EQ7HC_EAST_PLL_NOC, "core_e", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_EAST_DIV_CORE_MBIST, EQ7HC_EAST_PLL_NOC, "core_mbist_e", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_EAST_DIV_ISRAM_MBIST, EQ7HC_EAST_PLL_NOC, "isram_mbist_e", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_EAST_DIV_CFG, EQ7HC_EAST_PLL_NOC, "cfg_e", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_EAST_DIV_VEU_CORE, EQ7HC_EAST_PLL_VEU, "veu_core", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_EAST_DIV_VEU_MBIST, EQ7HC_EAST_PLL_VEU, "veu_mbist", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_EAST_DIV_VEU_OCP, EQ7HC_EAST_PLL_VEU, "veu_ocp", core::ptr::null_mut(), 1, 16),
    FF(EQ7HC_EAST_DIV_LBITS, EQ7HC_EAST_PLL_ISP, "lbits_e", core::ptr::null_mut(), 1, 48),
    FF(EQ7HC_EAST_DIV_ISP0_CORE, EQ7HC_EAST_PLL_ISP, "isp0_core", core::ptr::null_mut(), 1, 2),
    };
    ...
    FF(EQ7HC_MIPS_DIV_CM, EQ7HC_MIPS_PLL_CPU, "mips0_cm", core::ptr::null_mut(), 1, 2),
    };
    ...
    FF(EQ7HC_MIPS_DIV_CM, EQ7HC_MIPS_PLL_CPU, "mips1_cm", core::ptr::null_mut(), 1, 2),
    };
    ...
    FF(EQ7HC_MIPS_DIV_CM, EQ7HC_MIPS_PLL_CPU, "mips2_cm", core::ptr::null_mut(), 1, 2),
    };
    ...
    FF(EQ7HC_PERIPH_EAST_DIV_PER, EQ7HC_PERIPH_EAST_PLL_PER, "periph_e", core::ptr::null_mut(), 1, 10),
    };
    ...
    FF(EQ7HC_PERIPH_WEST_DIV_PER, EQ7HC_PERIPH_WEST_PLL_PER, "periph_w", core::ptr::null_mut(), 1, 10),
    FF(EQ7HC_PERIPH_WEST_DIV_I2S, EQ7HC_PERIPH_WEST_PLL_I2S, "periph_i2s_ser_w", core::ptr::null_mut(), 1, 100),
    };
    ...
    FF(EQ7HC_SOUTH_DIV_REF_100P0, EQ7HC_SOUTH_PLL_100P0, "ref_100p0", core::ptr::null_mut(), 1, 48),
    PLL_AINTP(EQ7HC_SOUTH_PLL_XSPI, EQ7HC_SOUTH_DIV_REF_100P0, "pll-xspi", core::ptr::null_mut(), 0x10),
    PLL_AINTP(EQ7HC_SOUTH_PLL_VDIO, EQ7HC_SOUTH_DIV_REF_100P0, "pll-vdio", core::ptr::null_mut(), 0x18),
    PLL_AINTP(EQ7HC_SOUTH_PLL_PER, EQ7HC_SOUTH_DIV_REF_100P0, "pll-per-s", core::ptr::null_mut(), 0x20),
    FF(EQ7HC_SOUTH_DIV_VDO_DSI_SYS, EQ7HC_SOUTH_PLL_100P0, "vdo_dsi_sys", core::ptr::null_mut(), 1, 9),
    FF(EQ7HC_SOUTH_DIV_PMA_CMN_REF, EQ7HC_SOUTH_PLL_100P0, "pma_cmn_ref", core::ptr::null_mut(), 1, 48),
    FF(EQ7HC_SOUTH_DIV_REF_UFS, EQ7HC_SOUTH_PLL_100P0, "ref_ufs", core::ptr::null_mut(), 1, 250),
    FF(EQ7HC_SOUTH_DIV_XSPI_SYS, EQ7HC_SOUTH_PLL_XSPI, "xspi_sys", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_SOUTH_DIV_XSPI_MBIST, EQ7HC_SOUTH_PLL_XSPI, "xspi_mbist", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_SOUTH_DIV_NOC_S, EQ7HC_SOUTH_PLL_PER, "noc_s", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_SOUTH_DIV_PCIE_SYS, EQ7HC_SOUTH_PLL_PER, "pcie_sys", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_SOUTH_DIV_PCIE_SYS_MBIST, EQ7HC_SOUTH_PLL_PER, "pcie_sys_mbist", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_SOUTH_DIV_PCIE_GBE_PHY, EQ7HC_SOUTH_PLL_PER, "pcie_gbe_phy_apb", core::ptr::null_mut(), 1, 16),
    FF(EQ7HC_SOUTH_DIV_UFS_CORE, EQ7HC_SOUTH_PLL_PER, "ufs_core", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_SOUTH_DIV_UFS_SMS, EQ7HC_SOUTH_PLL_PER, "ufs_sms", core::ptr::null_mut(), 1, 5),
    FF(EQ7HC_SOUTH_DIV_UFS_ROM_SMS, EQ7HC_SOUTH_PLL_PER, "ufs_rom_sms", core::ptr::null_mut(), 1, 5),
    FF(EQ7HC_SOUTH_DIV_ETH_SYS, EQ7HC_SOUTH_PLL_PER, "eth_sys", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_SOUTH_DIV_ETH_MBIST, EQ7HC_SOUTH_PLL_PER, "eth_mbist", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_SOUTH_DIV_CFG_S, EQ7HC_SOUTH_PLL_PER, "cfg_s", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_SOUTH_DIV_TSU, EQ7HC_SOUTH_PLL_PER, "tsu", core::ptr::null_mut(), 1, 64),
    FF(EQ7HC_SOUTH_DIV_VDIO, EQ7HC_SOUTH_PLL_VDIO, "vdio", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_SOUTH_DIV_VDIO_CORE, EQ7HC_SOUTH_PLL_VDIO, "vdio_core", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_SOUTH_DIV_VDIO_CORE_MBIST, EQ7HC_SOUTH_PLL_VDIO, "vdio_core_mbist", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_SOUTH_DIV_VDO_CORE_MBIST, EQ7HC_SOUTH_PLL_VDIO, "vdo_core_mbist", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_SOUTH_DIV_VDO_P, EQ7HC_SOUTH_PLL_VDIO, "vdo_p", core::ptr::null_mut(), 1, 40),
    FF(EQ7HC_SOUTH_DIV_VDIO_CFG, EQ7HC_SOUTH_PLL_VDIO, "vdio_cfg", core::ptr::null_mut(), 1, 150),
    FF(EQ7HC_SOUTH_DIV_VDIO_TXCLKESC, EQ7HC_SOUTH_PLL_VDIO, "vdio_txclkesc", core::ptr::null_mut(), 1, 8),
    };
    ...
    FF(EQ7HC_WEST_DIV_REF_106P6, EQ7HC_WEST_PLL_106P6, "ref_106p6_w", core::ptr::null_mut(), 1, 40),
    PLL_AINTP(EQ7HC_WEST_PLL_NOC, EQ7HC_WEST_DIV_REF_106P6, "pll-noc-w", core::ptr::null_mut(), 0x30),
    ...
    FF(EQ7HC_WEST_DIV_GPU, EQ7HC_WEST_PLL_GPU, "gpu", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_WEST_DIV_GPU_MBIST, EQ7HC_WEST_PLL_GPU, "gpu_mbist", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_WEST_DIV_LBITS, EQ7HC_WEST_PLL_GPU, "lbits_w", core::ptr::null_mut(), 1, 40),
    FF(EQ7HC_WEST_DIV_MIPS_TIMER, EQ7HC_WEST_PLL_SSI, "mips_timer", core::ptr::null_mut(), 1, 24),
    FF(EQ7HC_WEST_DIV_SSI_CORE, EQ7HC_WEST_PLL_SSI, "ssi_core", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_WEST_DIV_SSI_CORE_MBIST, EQ7HC_WEST_PLL_SSI, "ssi_core_mbist", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_WEST_DIV_SSI_ROM, EQ7HC_WEST_PLL_SSI, "ssi_rom", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_WEST_DIV_SSI_ROM_MBIST, EQ7HC_WEST_PLL_SSI, "ssi_rom_mbist", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_WEST_DIV_REF_DDR_PHY, EQ7HC_WEST_PLL_106P6, "ref_ddr_phy_w", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_WEST_DIV_CORE, EQ7HC_WEST_PLL_NOC, "core_w", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_WEST_DIV_CORE_MBIST, EQ7HC_WEST_PLL_NOC, "core_mbist_w", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_WEST_DIV_CFG, EQ7HC_WEST_PLL_NOC, "cfg_w", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_WEST_DIV_CAU, EQ7HC_WEST_PLL_NOC, "cau_w", core::ptr::null_mut(), 1, 8),
    FF(EQ7HC_WEST_DIV_CAU_MBIST, EQ7HC_WEST_PLL_NOC, "cau_mbist_w", core::ptr::null_mut(), 1, 8),
    };
    ...
    FF(EQ7HC_XNN_DIV_XNN0, EQ7HC_XNN_PLL_XNN0, "xnn0", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_XNN_DIV_XNN1, EQ7HC_XNN_PLL_XNN1, "xnn1", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_XNN_DIV_XNN2, EQ7HC_XNN_PLL_XNN2, "xnn2", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_XNN_DIV_CLSTR, EQ7HC_XNN_PLL_CLSTR, "xnn0_clstr", core::ptr::null_mut(), 1, 2),
    FF(EQ7HC_XNN_DIV_I2, EQ7HC_XNN_PLL_CLSTR, "xnn0_i2", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_XNN_DIV_I2_SMS, EQ7HC_XNN_PLL_CLSTR, "xnn0_i2_sms", core::ptr::null_mut(), 1, 4),
    FF(EQ7HC_XNN_DIV_CFG, EQ7HC_XNN_PLL_CLSTR, "xnn0_cfg", core::ptr::null_mut(), 1, 8),
    };
...
// Required early for GIC timer.
    ...
    FF(EQ6HC_CENTRAL_CPU_OCC, EQ6HC_CENTRAL_PLL_CPU, "occ-cpu", core::ptr::null_mut(), 1, 1),
    };
...
// Required early for UART.
    ...
    FF(EQ6HC_WEST_PER_OCC, EQ6HC_WEST_PLL_PER, "west-per-occ", core::ptr::null_mut(), 1, 10),
    FF(EQ6HC_WEST_PER_UART, EQ6HC_WEST_PER_OCC, "west-per-uart", core::ptr::null_mut(), 1, 1),
    };
...
// Offsets (reg64) of early PLLs are relative to OLB block.
    ...
    if (clk.probe)
    ret = clk.probe(core::ptr::null_mut(), np, clk, base, cells);
    else
    ret = -EINVAL;
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn eqc_eyeq5_early_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn eqc_eyeq6h_central_early_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn eqc_eyeq6h_west_early_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn eqc_eyeq6lplus_early_init(np: *mut device_node) -> void __init {
