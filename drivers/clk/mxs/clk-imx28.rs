...
//! Source: drivers/clk/mxs/clk-imx28.c
#![no_std]
...
pub const BP_ENET_DIV_TIME: c_int = 21;
pub const BP_ENET_SLEEP: c_int = 31;
pub const BP_CLKSEQ_BYPASS_SAIF0: c_int = 0;
pub const BP_CLKSEQ_BYPASS_SSP0: c_int = 3;
pub const BP_FRAC0_IO1FRAC: c_int = 16;
pub const BP_FRAC0_IO0FRAC: c_int = 24;
    static void __iomem *digctrl;

pub const BP_SAIF_CLKMUX: c_int = 10;
//
// HW_SAIF_CLKMUX_SEL:
...
//
#[no_mangle]
pub unsafe extern "C" fn mxs_saif_clkmux_select(clkmux: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mx28_clocks_init(np: *mut device_node) -> void __init {
    static void __init mx28_clocks_init(struct device_node *np)
    {
    struct device_node *dcnp;
    u32 i;
    dcnp = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,imx28-digctl");
    ...
    clks[usb0_phy] = clk_register_gate(core::ptr::null_mut(), "usb0_phy", "pll0", 0, PLL0CTRL0, 18, 0, &mxs_lock);
    clks[usb1_phy] = clk_register_gate(core::ptr::null_mut(), "usb1_phy", "pll1", 0, PLL1CTRL0, 18, 0, &mxs_lock);
    clks[enet_out] = clk_register_gate(core::ptr::null_mut(), "enet_out", "pll2", 0, ENET, 18, 0, &mxs_lock);
    ...
    clk_register_clkdev(clks[enet_out], core::ptr::null_mut(), "enet_out");
