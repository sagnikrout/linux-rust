...
//! Source: drivers/clk/tenstorrent/atlantis-prcm.c
#![no_std]
...
pub const PLL_RCPU_CFG_REG: c_uint = 0x0000;
pub const PLL_NOCC_CFG_REG: c_uint = 0x0004;
pub const NOCC_CLK_CFG_REG: c_uint = 0x0008;
pub const RCPU_DIV_CFG_REG: c_uint = 0x000C;
pub const RCPU_BLK_CG_REG: c_uint = 0x0014;
pub const LSIO_BLK_CG_REG: c_uint = 0x0018;
pub const PLL_RCPU_EN_REG: c_uint = 0x011C;
pub const PLL_NOCC_EN_REG: c_uint = 0x0120;
pub const BUS_CG_REG: c_uint = 0x01FC;
// PLL Bit Definitions

pub const PLL_CFG_REFDIV_SHIFT: c_int = 2;

pub const PLL_CFG_POSTDIV1_SHIFT: c_int = 8;

pub const PLL_CFG_POSTDIV2_SHIFT: c_int = 11;

pub const PLL_CFG_FBDIV_SHIFT: c_int = 14;

pub const PLL_LOCK_TIMEOUT_US: c_int = 1000;
pub const PLL_BYPASS_WAIT_US: c_int = 500;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_common {
    pub clkid: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_mux_config {
    pub shift: u8,
    pub width: u8,
    pub reg_offset: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_mux {
    pub common: atlantis_clk_common,
    pub config: atlantis_clk_mux_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_gate_config {
    pub reg_offset: u32,
    pub enable: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_gate {
    pub common: atlantis_clk_common,
    pub config: atlantis_clk_gate_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_divider_config {
    pub shift: u8,
    pub width: u8,
    pub flags: u32,
    pub reg_offset: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_divider {
    pub common: atlantis_clk_common,
    pub config: atlantis_clk_divider_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_pll_config {
    pub tbl_num: u32,
    pub reg_offset: u32,
    pub en_reg_offset: u32,
    pub cg_reg_offset: u32,
    pub cg_reg_enable: u32,
}

// Models a PLL with Bypass Functionality and Enable Bit + an optional Gate Clock at it's output
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_pll {
    pub common: atlantis_clk_common,
    pub config: atlantis_clk_pll_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_gate_shared_config {
    pub reg_offset: u32,
    pub enable: u32,
    pub share_count: *mut c_uint,
    pub refcount_lock: *mut spinlock_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_gate_shared {
    pub common: atlantis_clk_common,
    pub config: atlantis_clk_gate_shared_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_fixed_factor_config {
    pub mult: c_uint,
    pub div: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atlantis_clk_fixed_factor {
    pub config: atlantis_clk_fixed_factor_config,
    pub common: atlantis_clk_common,
}
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
    static int atlantis_clk_mux_set_parent(struct clk_hw *hw, u8 index)
    {
    struct atlantis_clk_mux *mux = hw_to_atlantis_clk_mux(hw);
    let mut val: u32 = index;
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_gate_endisable(hw: *mut clk_hw, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_gate_enable(hw: *mut clk_hw) -> c_int {
    static int atlantis_clk_gate_enable(struct clk_hw *hw)
    {
    return atlantis_clk_gate_endisable(hw, 1);
    }
#[no_mangle]
unsafe extern "C" fn atlantis_clk_gate_disable(hw: *mut clk_hw) {
    static void atlantis_clk_gate_disable(struct clk_hw *hw)
    {
    atlantis_clk_gate_endisable(hw, 0);
    }
#[no_mangle]
unsafe extern "C" fn atlantis_clk_gate_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_pll_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_pll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_pll_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_gate_shared_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_gate_shared_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_gate_shared_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atlantis_clk_gate_shared_disable_unused(hw: *mut clk_hw) {
...
pub struct atlantis_prcm_data {
    ...
    int i, ret;
    let mut num_clks: usize = data.num;
...
#[no_mangle]
unsafe extern "C" fn atlantis_prcm_probe(pdev: *mut platform_device) -> c_int {
    ...
    reset_adev = devm_auxiliary_device_create(dev, data.reset_name, core::ptr::null_mut());
    if (!reset_adev)
