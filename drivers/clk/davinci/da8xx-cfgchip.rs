...
//! Source: drivers/clk/davinci/da8xx-cfgchip.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da8xx_cfgchip_gate_clk_info {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da8xx_cfgchip_gate_clk {
    pub hw: clk_hw,
...
#[no_mangle]
unsafe extern "C" fn da8xx_cfgchip_gate_clk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da8xx_cfgchip_gate_clk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn da8xx_cfgchip_gate_clk_is_enabled(hw: *mut clk_hw) -> c_int {
...
// this clock divides by 4.5
    ...
    int ret;
    parent = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(parent))
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da8xx_cfgchip_mux_clk_info {
    pub name: *const c_char,
    pub parent0: *const c_char,
    pub parent1: *const c_char,
    pub cfgchip: u32,
    pub bit: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da8xx_cfgchip_mux_clk {
    pub hw: clk_hw,
    pub regmap: *mut regmap,
    pub reg: u32,
    pub mask: u32,
...
#[no_mangle]
unsafe extern "C" fn da8xx_cfgchip_mux_clk_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
    ...
    let mut val: c_uint = index ? clk.mask : 0;
    return regmap_write_bits(clk.regmap, clk.reg, clk.mask, val);
    }
#[no_mangle]
unsafe extern "C" fn da8xx_cfgchip_mux_clk_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn of_da850_async1_init(dev: *mut device, regmap: *mut regmap) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn of_da850_async3_init(dev: *mut device, regmap: *mut regmap) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb0_clk48_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb0_clk48_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb0_clk48_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb0_clk48_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb0_clk48_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb0_clk48_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb0_clk48_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb1_clk48_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da8xx_usb1_clk48_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn of_da8xx_usb_phy_clk_init(dev: *mut device, regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da8xx_cfgchip_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut clk_init: da8xx_cfgchip_init = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn da8xx_cfgchip_driver_init() -> int __init {
