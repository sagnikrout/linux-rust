...
//! Source: drivers/clk/davinci/pll-da850.c
#![no_std]
...
pub const OCSEL_OCSRC_OSCIN: c_uint = 0x14;

pub const OCSEL_OCSRC_PLL1_OBSCLK: c_uint = 0x1e;
...
#[no_mangle]
pub unsafe extern "C" fn da850_pll0_init(dev: *mut device, base: *mut void __iomem, cfgchip: *mut regmap) -> c_int {
    ...
    CLK_IS_CRITICAL, 1, 1);
    clk_register_clkdev(clk, core::ptr::null_mut(), "i2c_davinci.1");
    clk_register_clkdev(clk, "timer0", core::ptr::null_mut());
    clk_register_clkdev(clk, core::ptr::null_mut(), "davinci-wdt");
...
#[no_mangle]
pub unsafe extern "C" fn of_da850_pll0_init(node: *mut device_node) {
...
#[no_mangle]
pub unsafe extern "C" fn da850_pll1_init(dev: *mut device, base: *mut void __iomem, cfgchip: *mut regmap) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn of_da850_pll1_init(dev: *mut device, base: *mut void __iomem, cfgchip: *mut regmap) -> c_int {
