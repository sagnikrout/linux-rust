...
//! Source: drivers/clk/ralink/clk-mt7621.c
#![no_std]
...
pub const SYSC_REG_SYSTEM_CONFIG0: c_uint = 0x10;
pub const SYSC_REG_SYSTEM_CONFIG1: c_uint = 0x14;
pub const SYSC_REG_CLKCFG0: c_uint = 0x2c;
pub const SYSC_REG_CLKCFG1: c_uint = 0x30;
pub const SYSC_REG_RESET_CTRL: c_uint = 0x34;
pub const SYSC_REG_CUR_CLK_STS: c_uint = 0x44;
pub const MEMC_REG_CPU_PLL: c_uint = 0x648;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7621_clk_priv {
    pub sysc: *mut regmap,
    pub memc: *mut regmap,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7621_clk {
    pub hw: clk_hw,
    pub priv: *mut mt7621_clk_priv,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt7621_fixed_clk {
    pub idx: u8,
...
//
    ...
    { CLK_BASE("xtal", core::ptr::null_mut(), mt7621_xtal_recalc_rate) },
...
#[no_mangle]
unsafe extern "C" fn mt7621_clk_init(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mt7621_reset_init(dev: *mut device, sysc: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt7621_clk_reset_init() -> int __init {
