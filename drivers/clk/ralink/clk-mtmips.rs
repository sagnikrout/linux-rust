...
//! Source: drivers/clk/ralink/clk-mtmips.c
#![no_std]
...
pub const SYSC_REG_SYSTEM_CONFIG: c_uint = 0x10;
pub const SYSC_REG_CLKCFG0: c_uint = 0x2c;
pub const SYSC_REG_RESET_CTRL: c_uint = 0x34;
pub const SYSC_REG_CPU_SYS_CLKCFG: c_uint = 0x3c;
pub const SYSC_REG_CPLL_CONFIG0: c_uint = 0x54;
pub const SYSC_REG_CPLL_CONFIG1: c_uint = 0x58;
// RT2880 SoC
pub const RT2880_CONFIG_CPUCLK_SHIFT: c_int = 20;
pub const RT2880_CONFIG_CPUCLK_MASK: c_uint = 0x3;
pub const RT2880_CONFIG_CPUCLK_250: c_uint = 0x0;
pub const RT2880_CONFIG_CPUCLK_266: c_uint = 0x1;
pub const RT2880_CONFIG_CPUCLK_280: c_uint = 0x2;
pub const RT2880_CONFIG_CPUCLK_300: c_uint = 0x3;
// RT305X SoC
pub const RT305X_SYSCFG_CPUCLK_SHIFT: c_int = 18;
pub const RT305X_SYSCFG_CPUCLK_MASK: c_uint = 0x1;
pub const RT305X_SYSCFG_CPUCLK_LOW: c_uint = 0x0;
pub const RT305X_SYSCFG_CPUCLK_HIGH: c_uint = 0x1;
// RT3352 SoC
pub const RT3352_SYSCFG0_CPUCLK_SHIFT: c_int = 8;
pub const RT3352_SYSCFG0_CPUCLK_MASK: c_uint = 0x1;
pub const RT3352_SYSCFG0_CPUCLK_LOW: c_uint = 0x0;
pub const RT3352_SYSCFG0_CPUCLK_HIGH: c_uint = 0x1;
// RT3383 SoC

pub const RT3883_SYSCFG0_CPUCLK_SHIFT: c_int = 8;
pub const RT3883_SYSCFG0_CPUCLK_MASK: c_uint = 0x3;
pub const RT3883_SYSCFG0_CPUCLK_250: c_uint = 0x0;
pub const RT3883_SYSCFG0_CPUCLK_384: c_uint = 0x1;
pub const RT3883_SYSCFG0_CPUCLK_480: c_uint = 0x2;
pub const RT3883_SYSCFG0_CPUCLK_500: c_uint = 0x3;
// RT5350 SoC

pub const RT5350_SYSCFG0_CPUCLK_SHIFT: c_int = 8;
pub const RT5350_SYSCFG0_CPUCLK_MASK: c_uint = 0x3;
pub const RT5350_SYSCFG0_CPUCLK_360: c_uint = 0x0;
pub const RT5350_SYSCFG0_CPUCLK_320: c_uint = 0x2;
pub const RT5350_SYSCFG0_CPUCLK_300: c_uint = 0x3;
// MT7620 and MT76x8 SoCs

pub const CPLL_CFG0_PLL_MULT_RATIO_SHIFT: c_int = 16;
pub const CPLL_CFG0_PLL_MULT_RATIO_MASK: c_uint = 0x7;

pub const CPLL_CFG0_PLL_DIV_RATIO_SHIFT: c_int = 10;
pub const CPLL_CFG0_PLL_DIV_RATIO_MASK: c_uint = 0x3;

pub const CPU_SYS_CLKCFG_OCP_RATIO_SHIFT: c_int = 16;
pub const CPU_SYS_CLKCFG_OCP_RATIO_MASK: c_uint = 0xf;

pub const CPU_SYS_CLKCFG_CPU_FDIV_SHIFT: c_int = 8;
pub const CPU_SYS_CLKCFG_CPU_FDIV_MASK: c_uint = 0x1f;
pub const CPU_SYS_CLKCFG_CPU_FFRAC_SHIFT: c_int = 0;
pub const CPU_SYS_CLKCFG_CPU_FFRAC_MASK: c_uint = 0x1f;
// clock scaling
pub const CLKCFG_FDIV_MASK: c_uint = 0x1f00;
pub const CLKCFG_FDIV_USB_VAL: c_uint = 0x0300;
pub const CLKCFG_FFRAC_MASK: c_uint = 0x001f;
pub const CLKCFG_FFRAC_USB_VAL: c_uint = 0x0003;
    struct mtmips_clk;
    struct mtmips_clk_fixed;
    struct mtmips_clk_factor;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtmips_clk_data {
    pub clk_base: *mut mtmips_clk,
    pub num_clk_base: usize,
    pub clk_fixed: *mut mtmips_clk_fixed,
    pub num_clk_fixed: usize,
    pub clk_factor: *mut mtmips_clk_factor,
    pub num_clk_factor: usize,
    pub clk_periph: *mut mtmips_clk,
    pub num_clk_periph: usize,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtmips_clk_priv {
    pub sysc: *mut regmap,
    pub data: *const mtmips_clk_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtmips_clk {
    pub hw: clk_hw,
    pub priv: *mut mtmips_clk_priv,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtmips_clk_fixed {
...
// \
    ...
    let mut idx_start: usize = priv.data.num_clk_base;
    int ret, i;
    for (i = 0; i < priv.data.num_clk_fixed; i++) {
    let mut idx: c_int = idx_start + i;
    sclk = &priv.data.clk_fixed[i];
    sclk.hw = clk_hw_register_fixed_rate(core::ptr::null_mut(), sclk.name,
    sclk.parent, 0,
    sclk.rate);
    if (IS_ERR(sclk.hw)) {
    ret = PTR_ERR(sclk.hw);
    ...
    let mut idx_start: usize = priv.data.num_clk_base + priv.data.num_clk_fixed;
    int ret, i;
    for (i = 0; i < priv.data.num_clk_factor; i++) {
    let mut idx: c_int = idx_start + i;
    sclk = &priv.data.clk_factor[i];
    sclk.hw = clk_hw_register_fixed_factor(core::ptr::null_mut(), sclk.name,
...
#[no_mangle]
unsafe extern "C" fn mt7620_calc_rate(ref_rate: u32, mul: u32, div: u32) -> u32 {
    ...
    { CLK_BASE("xtal", core::ptr::null_mut(), rt2880_xtal_recalc_rate) },
    ...
    { CLK_BASE("xtal", core::ptr::null_mut(), rt5350_xtal_recalc_rate) },
    ...
    { CLK_BASE("xtal", core::ptr::null_mut(), mt76x8_xtal_recalc_rate) },
...
#[no_mangle]
unsafe extern "C" fn mtmips_clk_init(node: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn mtmips_reset_init(dev: *mut device, sysc: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtmips_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtmips_clk_reset_init() -> int __init {
