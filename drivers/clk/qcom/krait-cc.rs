...
//! Source: drivers/clk/qcom/krait-cc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn krait_cc_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct clk *clk, **clks;
    let mut unique_aux: bool = !!device_get_match_data(dev);
// Rate is 1 because 0 causes problems for __clk_mux_determine_rate
    clk = clk_register_fixed_rate(dev, "qsb", core::ptr::null_mut(), 0, 1);
    if (IS_ERR(clk))
    return PTR_ERR(clk);
    if (!unique_aux) {
