...
//! Source: drivers/clk/qcom/mmcc-sdm660.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sdm630_clock_override() {
    static void sdm630_clock_override(void)
    {
// SDM630 has only one DSI
    mmcc_660_desc.clks[BYTE1_CLK_SRC] = core::ptr::null_mut();
    mmcc_660_desc.clks[MDSS_BYTE1_CLK] = core::ptr::null_mut();
    mmcc_660_desc.clks[MDSS_BYTE1_INTF_DIV_CLK] = core::ptr::null_mut();
    mmcc_660_desc.clks[MDSS_BYTE1_INTF_CLK] = core::ptr::null_mut();
    mmcc_660_desc.clks[ESC1_CLK_SRC] = core::ptr::null_mut();
    mmcc_660_desc.clks[MDSS_ESC1_CLK] = core::ptr::null_mut();
    mmcc_660_desc.clks[PCLK1_CLK_SRC] = core::ptr::null_mut();
    mmcc_660_desc.clks[MDSS_PCLK1_CLK] = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mmcc_660_probe(pdev: *mut platform_device) -> c_int {
