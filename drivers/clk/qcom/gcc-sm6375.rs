...
//! Source: drivers/clk/qcom/gcc-sm6375.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_sm6375_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm6375_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm6375_exit() -> void __exit {
