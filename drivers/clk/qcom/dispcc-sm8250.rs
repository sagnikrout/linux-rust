...
//! Source: drivers/clk/qcom/dispcc-sm8250.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn disp_cc_sm8250_probe(pdev: *mut platform_device) -> c_int {
...
// Apply differences for SM8150 and SM8350
    ...
    &disp_cc_mdss_edp_link_clk_src.clkr.hw;
    disp_cc_sm8250_clocks[DISP_CC_MDSS_DP_LINK1_DIV_CLK_SRC] = core::ptr::null_mut();
    disp_cc_sm8250_clocks[DISP_CC_MDSS_DP_LINK_DIV_CLK_SRC] = core::ptr::null_mut();
    disp_cc_sm8250_clocks[DISP_CC_MDSS_EDP_LINK_DIV_CLK_SRC] = core::ptr::null_mut();
...
//
    ...
    disp_cc_sm8250_clocks[DISP_CC_MDSS_EDP_GTC_CLK] = core::ptr::null_mut();
    disp_cc_sm8250_clocks[DISP_CC_MDSS_EDP_GTC_CLK_SRC] = core::ptr::null_mut();
    }
