...
//! Source: drivers/clk/qcom/gcc-glymur.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_glymur_regs_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn gcc_glymur_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_glymur_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_glymur_exit() -> void __exit {
