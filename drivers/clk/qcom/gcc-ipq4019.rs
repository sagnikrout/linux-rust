...
//! Source: drivers/clk/qcom/gcc-ipq4019.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_fepll {
    pub fixed_div: u32,
    pub parent_map: *const u8,
    pub cdiv: clk_regmap_div,
    pub pll_vco: *const clk_fepll_vco,
...
//
    let mut gcc_ipq4019_cpu_safe_parent: static int = 2;
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq4019_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq4019_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq4019_exit() -> void __exit {
