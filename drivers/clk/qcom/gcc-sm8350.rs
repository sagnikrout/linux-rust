...
//! Source: drivers/clk/qcom/gcc-sm8350.c
#![no_std]
...
// Clock ON depends on external parent clock, so don't poll
    ...
    static struct clk_branch gcc_usb30_prim_master_clk_mem_core_on = {
    .halt_reg = 0xf010,
    .halt_check = BRANCH_HALT,
    .clkr = {
    .enable_reg = 0xf010,
    .enable_mask = BIT(14),
    .hw.init = &(struct clk_init_data){
    .name = "gcc_usb30_prim_master_clk_mem_core_on",
    ...
    static struct clk_branch gcc_usb30_sec_master_clk_mem_core_on = {
    .halt_reg = 0x10010,
    .halt_check = BRANCH_HALT,
    .clkr = {
    .enable_reg = 0x10010,
    .enable_mask = BIT(14),
    .hw.init = &(struct clk_init_data){
    .name = "gcc_usb30_sec_master_clk_mem_core_on",
    .ops = &clk_branch_simple_ops,
    },
    },
    };
...
// external clocks so add BRANCH_HALT_SKIP
    ...
    &gcc_usb30_prim_master_clk_mem_core_on.clkr,
    ...
    &gcc_usb30_sec_master_clk_mem_core_on.clkr,
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8350_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8350_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8350_exit() -> void __exit {
