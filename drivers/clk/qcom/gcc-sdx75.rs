...
//! Source: drivers/clk/qcom/gcc-sdx75.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_sdx75_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sdx75_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sdx75_exit() -> void __exit {
