...
//! Source: drivers/clk/qcom/clk-cbf-8996.c
#![no_std]
...
pub const DIV_THRESHOLD: c_int = 600000000;
pub const CBF_MUX_OFFSET: c_uint = 0x18;

    FIELD_PREP(CBF_MUX_AUTO_CLK_SEL_ALWAYS_ON_MASK, 0x03)

pub const CBF_PLL_OFFSET: c_uint = 0xf000;
...
pub const CBF_MASTER_NODE: c_int = 2000;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn qcom_msm8996_cbf_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn qcom_msm8996_cbf_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qcom_msm8996_cbf_exit() -> void __exit {
