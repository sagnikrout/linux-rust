...
//! Source: drivers/clk/qcom/gcc-msm8998.c
#![no_std]
...
pub const GCC_MMSS_MISC: c_uint = 0x0902C;
pub const GCC_GPU_MISC: c_uint = 0x71028;
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8998_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8998_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8998_exit() -> void __exit {
