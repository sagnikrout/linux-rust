...
//! Source: drivers/clk/qcom/gcc-sm8550.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8550_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8550_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8550_exit() -> void __exit {
