...
//! Source: drivers/clk/qcom/camcc-sa8775p.c
#![no_std]
...
//
    ...
    [CAM_CC_TITAN_TOP_ACCU_SHIFT_CLK] = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn cam_cc_sa8775p_probe(pdev: *mut platform_device) -> c_int {
    ...
    cam_cc_sa8775p_clocks[CAM_CC_CCI_3_CLK] = core::ptr::null_mut();
    cam_cc_sa8775p_clocks[CAM_CC_CCI_3_CLK_SRC] = core::ptr::null_mut();
    cam_cc_sa8775p_clocks[CAM_CC_CSI3PHYTIMER_CLK] = core::ptr::null_mut();
    cam_cc_sa8775p_clocks[CAM_CC_CSI3PHYTIMER_CLK_SRC] = core::ptr::null_mut();
    cam_cc_sa8775p_clocks[CAM_CC_CSIPHY3_CLK] = core::ptr::null_mut();
    cam_cc_sa8775p_clocks[CAM_CC_MCLK3_CLK] = core::ptr::null_mut();
    cam_cc_sa8775p_clocks[CAM_CC_MCLK3_CLK_SRC] = core::ptr::null_mut();
