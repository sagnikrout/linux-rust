...
//! Source: drivers/clk/qcom/gcc-sdm845.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_sdm845_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sdm845_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sdm845_exit() -> void __exit {
