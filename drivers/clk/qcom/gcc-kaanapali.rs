...
//! Source: drivers/clk/qcom/gcc-kaanapali.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_kaanapali_regs_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn gcc_kaanapali_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_kaanapali_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_kaanapali_exit() -> void __exit {
