...
//! Source: drivers/clk/qcom/gcc-sm4450.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_sm4450_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm4450_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm4450_exit() -> void __exit {
