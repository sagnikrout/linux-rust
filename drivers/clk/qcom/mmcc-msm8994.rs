...
//! Source: drivers/clk/qcom/mmcc-msm8994.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mmcc_msm8994_probe(pdev: *mut platform_device) -> c_int {
...
// MSM8992 features less clocks and some have different freq tables
    mmcc_msm8994_desc.clks[CAMSS_JPEG_JPEG1_CLK] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[CAMSS_JPEG_JPEG2_CLK] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[FD_CORE_CLK_SRC] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[FD_CORE_CLK] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[FD_CORE_UAR_CLK] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[FD_AXI_CLK] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[FD_AHB_CLK] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[JPEG1_CLK_SRC] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[JPEG2_CLK_SRC] = core::ptr::null_mut();
    mmcc_msm8994_desc.clks[VENUS0_CORE2_VCODEC_CLK] = core::ptr::null_mut();
    mmcc_msm8994_desc.gdscs[FD_GDSC] = core::ptr::null_mut();
    mmcc_msm8994_desc.gdscs[VENUS_CORE2_GDSC] = core::ptr::null_mut();
