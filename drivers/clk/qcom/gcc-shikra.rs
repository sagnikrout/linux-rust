...
//! Source: drivers/clk/qcom/gcc-shikra.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_shikra_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_shikra_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_shikra_exit() -> void __exit {
