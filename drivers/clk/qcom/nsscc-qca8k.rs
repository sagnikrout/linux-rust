...
//! Source: drivers/clk/qcom/nsscc-qca8k.c
#![no_std]
...
pub const QCA8K_CLK_REG_BASE: c_uint = 0x800000;
pub const QCA8K_HIGH_ADDR_PREFIX: c_uint = 0x18;
pub const QCA8K_LOW_ADDR_PREFIX: c_uint = 0x10;
pub const QCA8K_CFG_PAGE_REG: c_uint = 0xc;
...
//
#[no_mangle]
pub unsafe extern "C" fn convert_reg_to_mii_addr(regaddr: u32, reg: *mut u16, phy_addr: *mut u16, page: *mut u16) {
...
#[no_mangle]
unsafe extern "C" fn qca8k_mii_read(bus: *mut mii_bus, switch_phy_id: u16, reg: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qca8k_mii_write(bus: *mut mii_bus, switch_phy_id: u16, reg: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn qca8k_mii_page_set(bus: *mut mii_bus, switch_phy_id: u16, reg: u32, page: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qca8k_regmap_read(context: *mut c_void, regaddr: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qca8k_regmap_write(context: *mut c_void, regaddr: c_uint, val: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nss_cc_qca8k_clock_enable_and_reset(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nss_cc_qca8k_probe(mdiodev: *mut mdio_device) -> c_int {
    ...
    regmap = devm_regmap_init(&mdiodev.dev, core::ptr::null_mut(), mdiodev.bus, nss_cc_qca8k_desc.config);
    if (IS_ERR(regmap))
