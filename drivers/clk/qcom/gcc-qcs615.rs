...
//! Source: drivers/clk/qcom/gcc-qcs615.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs615_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs615_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs615_exit() -> void __exit {
