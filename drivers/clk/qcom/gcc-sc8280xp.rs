...
//! Source: drivers/clk/qcom/gcc-sc8280xp.c
#![no_std]
...
// Need to match the order of clocks in DT binding
    ...
    let mut gcc_parent_data_tcxo: static struct clk_parent_data = { .index = DT_BI_TCXO };
...
#[no_mangle]
unsafe extern "C" fn gcc_sc8280xp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sc8280xp_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sc8280xp_exit() -> void __exit {
