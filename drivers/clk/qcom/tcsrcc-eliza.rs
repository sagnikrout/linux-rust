...
//! Source: drivers/clk/qcom/tcsrcc-eliza.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_eliza_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_eliza_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_eliza_exit() -> void __exit {
