...
//! Source: drivers/clk/qcom/gcc-sar2130p.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_sar2130p_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sar2130p_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sar2130p_exit() -> void __exit {
