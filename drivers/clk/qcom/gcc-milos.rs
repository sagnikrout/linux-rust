...
//! Source: drivers/clk/qcom/gcc-milos.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_milos_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_milos_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_milos_exit() -> void __exit {
