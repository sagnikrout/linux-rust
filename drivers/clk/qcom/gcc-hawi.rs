...
//! Source: drivers/clk/qcom/gcc-hawi.c
#![no_std]
...
//
    [GCC_QUPV3_WRAP_5_S_AHB_CLK] = core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn clk_hawi_regs_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn gcc_hawi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_hawi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_hawi_exit() -> void __exit {
