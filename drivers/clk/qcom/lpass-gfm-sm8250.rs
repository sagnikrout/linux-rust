...
//! Source: drivers/clk/qcom/lpass-gfm-sm8250.c
#![no_std]
...
pub struct clk_gfm {
    ...
    pub mux_mask: c_uint,
    pub hw: clk_hw,
    pub priv: *mut lpass_gfm,
    pub gfm_mux: *mut void __iomem,
}
...
#[no_mangle]
unsafe extern "C" fn clk_gfm_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_gfm_clk_driver_probe(pdev: *mut platform_device) -> c_int {
