...
//! Source: drivers/clk/qcom/tcsrcc-glymur.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_glymur_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_glymur_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_glymur_exit() -> void __exit {
