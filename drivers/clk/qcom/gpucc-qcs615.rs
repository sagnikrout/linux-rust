...
//! Source: drivers/clk/qcom/gpucc-qcs615.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_qcs615_regs_crc_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn gpu_cc_qcs615_probe(pdev: *mut platform_device) -> c_int {
