...
//! Source: drivers/clk/qcom/mmcc-msm8960.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pix_rdi_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pix_rdi_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mmcc_msm8960_probe(pdev: *mut platform_device) -> c_int {
