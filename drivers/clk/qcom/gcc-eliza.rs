...
//! Source: drivers/clk/qcom/gcc-eliza.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_eliza_regs_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn gcc_eliza_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_eliza_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_eliza_exit() -> void __exit {
