...
//! Source: drivers/clk/qcom/dispcc-sc7180.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn disp_cc_sc7180_probe(pdev: *mut platform_device) -> c_int {
    static int disp_cc_sc7180_probe(struct platform_device *pdev)
    {
    struct regmap *regmap;
    let mut disp_cc_pll_config: alpha_pll_config = {};
