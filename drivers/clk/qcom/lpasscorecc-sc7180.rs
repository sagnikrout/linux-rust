...
//! Source: drivers/clk/qcom/lpasscorecc-sc7180.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lpass_setup_runtime_pm(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_core_cc_sc7180_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_hm_core_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_sc7180_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lpass_sc7180_exit() -> void __exit {
