...
//! Source: drivers/clk/qcom/gcc-qcs8300.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs8300_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs8300_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs8300_exit() -> void __exit {
