...
//! Source: drivers/clk/qcom/videocc-maili.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_maili_regs_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn video_cc_maili_probe(pdev: *mut platform_device) -> c_int {
