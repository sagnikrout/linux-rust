...
//! Source: drivers/clk/qcom/tcsrcc-sm8750.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_sm8750_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_sm8750_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_sm8750_exit() -> void __exit {
