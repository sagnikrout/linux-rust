...
//! Source: drivers/clk/qcom/gcc-msm8974.c
#![no_std]
...
//
    ...
    [GPLL4] = core::ptr::null_mut(),
    [GPLL4_VOTE] = core::ptr::null_mut(),
    [GCC_SDCC1_CDCCAL_SLEEP_CLK] = core::ptr::null_mut(),
    [GCC_SDCC1_CDCCAL_FF_CLK] = core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn msm8226_clock_override() {
...
#[no_mangle]
unsafe extern "C" fn msm8974_pro_clock_override() {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8974_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8974_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8974_exit() -> void __exit {
