...
//! Source: drivers/clk/qcom/clk-cpu-8996.c
#![no_std]
...
pub const DIV_2_THRESHOLD: c_int = 600000000;
pub const PWRCL_REG_OFFSET: c_uint = 0x0;
pub const PERFCL_REG_OFFSET: c_uint = 0x80000;
pub const MUX_OFFSET: c_uint = 0x40;
pub const CLK_CTL_OFFSET: c_uint = 0x44;

pub const ALT_PLL_OFFSET: c_uint = 0x100;
pub const SSSCTL_OFFSET: c_uint = 0x160;
pub const PSCTL_OFFSET: c_uint = 0x164;
pub const PMUX_MASK: c_uint = 0x3;
...
#[no_mangle]
unsafe extern "C" fn clk_cpu_8996_pmux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_cpu_8996_pmux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
pub const CPU_CLUSTER_AFFINITY_MASK: c_uint = 0xf00;
pub const PWRCL_AFFINITY_MASK: c_uint = 0x000;
pub const PERFCL_AFFINITY_MASK: c_uint = 0x100;
pub const L2ACDCR_REG: c_uint = 0x580ULL;
pub const L2ACDTD_REG: c_uint = 0x581ULL;
pub const L2ACDDVMRC_REG: c_uint = 0x584ULL;
pub const L2ACDSSCR_REG: c_uint = 0x589ULL;
    static DEFINE_SPINLOCK(qcom_clk_acd_lock);
#[no_mangle]
unsafe extern "C" fn qcom_cpu_clk_msm8996_acd_init(regmap: *mut regmap) {
    static void qcom_cpu_clk_msm8996_acd_init(struct regmap *regmap)
    {
    u64 hwid;
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn qcom_cpu_clk_msm8996_driver_probe(pdev: *mut platform_device) -> c_int {
