...
//! Source: drivers/clk/qcom/clk-rcg2.c
#![no_std]
...
pub const CMD_REG: c_uint = 0x0;

pub const CFG_REG: c_uint = 0x4;
pub const CFG_SRC_DIV_SHIFT: c_int = 0;
pub const CFG_SRC_DIV_LENGTH: c_int = 8;
pub const CFG_SRC_SEL_SHIFT: c_int = 8;

pub const CFG_MODE_SHIFT: c_int = 12;

pub const M_REG: c_uint = 0x8;
pub const N_REG: c_uint = 0xc;
pub const D_REG: c_uint = 0x10;

// Dynamic Frequency Scaling
pub const MAX_PERF_LEVEL: c_int = 8;
pub const SE_CMD_DFSR_OFFSET: c_uint = 0x14;
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __clk_rcg2_get_parent(hw: *mut clk_hw, cfg: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn update_config(rcg: *mut clk_rcg2) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
    static int clk_rcg2_set_parent(struct clk_hw *hw, u8 index)
    {
    struct clk_rcg2 *rcg = to_clk_rcg2(hw);
    int ret;
    let mut cfg: u32 = rcg.parent_map[index].cfg << CFG_SRC_SEL_SHIFT;
...
//
#[no_mangle]
unsafe extern "C" fn convert_to_reg_val(f: *mut freq_tbl) {
...
//
    ...
    const struct freq_conf *conf, *best_conf = core::ptr::null_mut();
    struct clk_rcg2 *rcg = to_clk_rcg2(hw);
    const char *name = clk_hw_get_name(hw);
...
// cannot lower scale, just set max divisor values.
    ...
    n = n_candidate;
#[no_mangle]
pub unsafe extern "C" fn if(pre_div_max: *mut *mut pre_div  i <) -> else {
    ...
    {
    struct clk_rcg2 *rcg = to_clk_rcg2(hw);
    let mut f_tbl: freq_tbl = {}, *f = &f_tbl;
    let mut mnd_max: c_int = BIT(rcg.mnd_width) - 1;
    let mut hid_max: c_int = BIT(rcg.hid_width) - 1;
...
#[no_mangle]
unsafe extern "C" fn __clk_rcg2_configure_parent(rcg: *mut clk_rcg2, src: u8, _cfg: *mut u32) -> c_int {
    static int __clk_rcg2_configure_parent(struct clk_rcg2 *rcg, u8 src, u32 *_cfg)
    {
    struct clk_hw *hw = &rcg.clkr.hw;
    let mut index: c_int = qcom_find_src_index(hw, rcg.parent_map, src);
    if (index < 0)
    return index;
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_configure(rcg: *mut clk_rcg2, f: *const freq_tbl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_configure_gp(rcg: *mut clk_rcg2, f: *const freq_tbl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_get_duty_cycle(hw: *mut clk_hw, duty: *mut clk_duty) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_set_duty_cycle(hw: *mut clk_hw, duty: *mut clk_duty) -> c_int {
...
//
    ...
    d = (n - m) * 2;
#[no_mangle]
pub unsafe extern "C" fn if(2): (d / 2) < (m /) -> else {
    else if ((d / 2) < (m / 2))
    d = m;
    not2d = ~d & mask;
...
pub struct frac_entry {
    ...
    {
    struct clk_rcg2 *rcg = to_clk_rcg2(hw);
    let mut f: freq_tbl = *rcg.freq_tbl;
    const struct frac_entry *frac;
    let mut delta: c_int = 100000;
    let mut src_rate: i64 = parent_rate;
    s64 request;
    let mut mask: u32 = BIT(rcg.hid_width) - 1;
    u32 hid_div;
...
// Parent index is set statically in frequency table
    ...
    let mut mask: u32 = BIT(rcg.hid_width) - 1;
    u32 hid_div;
    let mut index: c_int = qcom_find_src_index(hw, rcg.parent_map, f.src);
...
// Read the hardware to determine parent during set_rate
    ...
    struct clk_rate_request *req)
    {
    let mut parent_req: clk_rate_request = { .min_rate = 0, .max_rate = ULONG_MAX };
    struct clk_rcg2_gfx3d *cgfx = to_clk_rcg2_gfx3d(hw);
    struct clk_hw *xo, *p0, *p1, *p2;
    unsigned long p0_rate;
    let mut mux_div: u8 = cgfx.div;
    int ret;
    p0 = cgfx.hws[0];
    p1 = cgfx.hws[1];
    p2 = cgfx.hws[2];
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_set_force_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_clear_force_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_shared_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_shared_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_shared_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_shared_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_shared_init(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_shared_no_init_park(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rcg2_dfs_populate_freq_table(rcg: *mut clk_rcg2) -> c_int {
...
//
    ...
    rcg.freq_tbl = core::ptr::null_mut();
    return 0;
    }
