...
//! Source: drivers/clk/qcom/apcs-msm8916.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qcom_apcs_msm8916_clk_probe(pdev: *mut platform_device) -> c_int {
...
// Use an unique name by appending parent's @unit-address
    ...
    a53cc.pclk = devm_clk_get(parent, core::ptr::null_mut());
