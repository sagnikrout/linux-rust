...
//! Source: drivers/clk/qcom/lpassaudiocc-sc7280.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lpass_audio_setup_runtime_pm(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_audio_cc_sc7280_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_aon_cc_sc7280_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpass_audio_cc_sc7280_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lpass_audio_cc_sc7280_exit() -> void __exit {
