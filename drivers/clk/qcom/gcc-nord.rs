...
//! Source: drivers/clk/qcom/gcc-nord.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_nord_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_nord_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_nord_exit() -> void __exit {
