...
//! Source: drivers/clk/qcom/tcsrcc-sm8650.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_sm8650_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_sm8650_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tcsr_cc_sm8650_exit() -> void __exit {
