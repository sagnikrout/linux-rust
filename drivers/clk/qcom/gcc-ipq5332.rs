...
//! Source: drivers/clk/qcom/gcc-ipq5332.c
#![no_std]
...
//
    ...
    let mut gcc_parent_data_xo: static struct clk_parent_data = { .index = DT_XO };
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq5332_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq5332_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq5332_exit() -> void __exit {
