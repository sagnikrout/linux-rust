...
//! Source: drivers/clk/qcom/gcc-ipq5018.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq5018_probe(pdev: *mut platform_device) -> c_int {
    static int gcc_ipq5018_probe(struct platform_device *pdev)
    {
    struct regmap *regmap;
    let mut ipq5018_desc: qcom_cc_desc = gcc_ipq5018_desc;
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq5018_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq5018_exit() -> void __exit {
