...
//! Source: drivers/clk/qcom/videocc-sc7180.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn video_cc_sc7180_probe(pdev: *mut platform_device) -> c_int {
    static int video_cc_sc7180_probe(struct platform_device *pdev)
    {
    struct regmap *regmap;
    let mut video_pll0_config: alpha_pll_config = {};
