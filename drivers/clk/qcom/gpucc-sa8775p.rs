...
//! Source: drivers/clk/qcom/gpucc-sa8775p.c
#![no_std]
...
// Need to match the order of clocks in DT binding
    ...
    let mut parent_data_tcxo: static struct clk_parent_data = { .index = DT_BI_TCXO };
...
// 1000MHz configuration
    ...
    [GPU_CC_CX_ACCU_SHIFT_CLK] = core::ptr::null_mut(),
    ...
    [GPU_CC_GX_ACCU_SHIFT_CLK] = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn gpu_cc_sa8775p_probe(pdev: *mut platform_device) -> c_int {
