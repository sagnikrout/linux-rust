...
//! Source: drivers/clk/qcom/dispcc-x1e80100.c
#![no_std]
...
pub const DISP_CC_MISC_CMD: c_uint = 0xF000;
    enum {
    P_BI_TCXO,
    P_BI_TCXO_AO,
...
#[no_mangle]
unsafe extern "C" fn disp_cc_x1e80100_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disp_cc_x1e80100_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn disp_cc_x1e80100_exit() -> void __exit {
