...
//! Source: drivers/clk/qcom/gcc-msm8994.c
#![no_std]
...
//
    [CONFIG_NOC_CLK_SRC] = core::ptr::null_mut(),
    [PERIPH_NOC_CLK_SRC] = core::ptr::null_mut(),
    [SYSTEM_NOC_CLK_SRC] = core::ptr::null_mut(),
    };
    static struct gdsc *gcc_msm8994_gdscs[] = {
// This GDSC does not exist, but ABI has to remain intact
    [PCIE_GDSC] = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8994_probe(pdev: *mut platform_device) -> c_int {
...
// MSM8992 features less clocks and some have different freq tables
    gcc_msm8994_desc.clks[UFS_AXI_CLK_SRC] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_LPASS_Q6_AXI_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[UFS_PHY_LDO] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_UFS_AHB_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_UFS_AXI_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_UFS_RX_CFG_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_UFS_RX_SYMBOL_0_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_UFS_RX_SYMBOL_1_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_UFS_TX_CFG_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_UFS_TX_SYMBOL_0_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_UFS_TX_SYMBOL_1_CLK] = core::ptr::null_mut();
...
//
    gcc_msm8994_desc.clks[PCIE_1_AUX_CLK_SRC] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[PCIE_1_PIPE_CLK_SRC] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[PCIE_1_PHY_LDO] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_PCIE_1_AUX_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_PCIE_1_CFG_AHB_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_PCIE_1_MSTR_AXI_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_PCIE_1_PIPE_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_PCIE_1_SLV_AXI_CLK] = core::ptr::null_mut();
    gcc_msm8994_desc.clks[GCC_SYS_NOC_UFS_AXI_CLK] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8994_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8994_exit() -> void __exit {
