...
//! Source: drivers/clk/qcom/gcc-sm8450.c
#![no_std]
...
//
    ...
    [SM8475_GCC_GPLL2] = core::ptr::null_mut(),
    [SM8475_GCC_GPLL3] = core::ptr::null_mut(),
    };
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8450_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8450_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8450_exit() -> void __exit {
