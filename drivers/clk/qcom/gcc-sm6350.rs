...
//! Source: drivers/clk/qcom/gcc-sm6350.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_sm6350_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm6350_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm6350_exit() -> void __exit {
