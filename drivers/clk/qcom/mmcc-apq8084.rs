...
//! Source: drivers/clk/qcom/mmcc-apq8084.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mmcc_apq8084_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    return ret;
    regmap = dev_get_regmap(&pdev.dev, core::ptr::null_mut());
