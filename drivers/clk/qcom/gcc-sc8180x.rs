...
//! Source: drivers/clk/qcom/gcc-sc8180x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_sc8180x_regs_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn gcc_sc8180x_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sc8180x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sc8180x_exit() -> void __exit {
