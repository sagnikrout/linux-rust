...
//! Source: drivers/clk/qcom/gcc-qcs404.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs404_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs404_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_qcs404_exit() -> void __exit {
