...
//! Source: drivers/clk/qcom/ipq-cmn-pll.c
#![no_std]
...
pub const CMN_PLL_REFCLK_SRC_SELECTION: c_uint = 0x28;

pub const CMN_PLL_LOCKED: c_uint = 0x64;

pub const CMN_PLL_POWER_ON_AND_RESET: c_uint = 0x780;

pub const CMN_PLL_REFCLK_CONFIG: c_uint = 0x784;

pub const CMN_PLL_CTRL: c_uint = 0x78c;

pub const CMN_PLL_DIVIDER_CTRL: c_uint = 0x794;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmn_pll_fixed_output_clk {
    pub id: c_uint,
...
//
#[no_mangle]
unsafe extern "C" fn ipq_cmn_pll_find_freq_index(parent_rate: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq_cmn_pll_register_clks(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq_cmn_pll_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipq_cmn_pll_clk_remove(pdev: *mut platform_device) {
