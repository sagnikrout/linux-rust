...
//! Source: drivers/clk/qcom/gpucc-sm6350.c
#![no_std]
...
pub const CX_GMU_CBCR_SLEEP_MASK: c_uint = 0xF;
pub const CX_GMU_CBCR_SLEEP_SHIFT: c_int = 4;
pub const CX_GMU_CBCR_WAKE_MASK: c_uint = 0xF;
pub const CX_GMU_CBCR_WAKE_SHIFT: c_int = 8;
    enum {
    DT_BI_TCXO,
    DT_GPLL0_OUT_MAIN,
...
#[no_mangle]
unsafe extern "C" fn gpu_cc_sm6350_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpu_cc_sm6350_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gpu_cc_sm6350_exit() -> void __exit {
