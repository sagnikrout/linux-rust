...
//! Source: drivers/clk/qcom/gcc-sm8250.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8250_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8250_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_sm8250_exit() -> void __exit {
