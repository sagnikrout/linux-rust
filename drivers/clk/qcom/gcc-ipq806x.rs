...
//! Source: drivers/clk/qcom/gcc-ipq806x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq806x_probe(pdev: *mut platform_device) -> c_int {
...
// Set GMAC footswitch sleep/wakeup values
    ...
    return of_platform_populate(pdev.dev.of_node, core::ptr::null_mut(), core::ptr::null_mut(), &pdev.dev);
    }
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq806x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_ipq806x_exit() -> void __exit {
