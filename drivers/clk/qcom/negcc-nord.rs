...
//! Source: drivers/clk/qcom/negcc-nord.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_nord_regs_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn ne_gcc_nord_probe(pdev: *mut platform_device) -> c_int {
