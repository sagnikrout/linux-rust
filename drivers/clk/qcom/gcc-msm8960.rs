...
//! Source: drivers/clk/qcom/gcc-msm8960.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8960_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8960_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8960_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn gcc_msm8960_exit() -> void __exit {
