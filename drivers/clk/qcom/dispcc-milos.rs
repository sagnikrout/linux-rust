...
//! Source: drivers/clk/qcom/dispcc-milos.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn disp_cc_milos_clk_regs_configure(dev: *mut device, regmap: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn disp_cc_milos_probe(pdev: *mut platform_device) -> c_int {
