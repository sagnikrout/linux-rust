...
//! Source: drivers/clk/qcom/clk-rpmh.c
#![no_std]
...
pub const CLK_RPMH_ARC_EN_OFFSET: c_int = 0;
pub const CLK_RPMH_VRM_EN_OFFSET: c_int = 4;
//
...
#[no_mangle]
pub unsafe extern "C" fn has_state_changed(c: *mut clk_rpmh, state: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_send_aggregate_command(c: *mut clk_rpmh) -> c_int {
    static int clk_rpmh_send_aggregate_command(struct clk_rpmh *c)
    {
    let mut cmd: tcs_cmd = { 0 };
    u32 cmd_state, on_val;
    let mut state: enum rpmh_state = RPMH_SLEEP_STATE;
    int ret;
    bool wait;
    cmd.addr = c.res_addr;
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_bcm_send_cmd(c: *mut clk_rpmh, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_bcm_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_bcm_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn clk_rpmh_exit() -> void __exit {
