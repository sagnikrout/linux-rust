...
//! Source: drivers/clk/qcom/clk-smd-rpm.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpm_smd_clk_desc {
    pub clks: *mut clk_smd_rpm,
    pub num_clks: usize,
//
...
//
    pub icc_clks: *const *const *const clk_smd_rpm,
    pub num_icc_clks: usize,
    pub scaling_before_handover: bool,
}

    static DEFINE_MUTEX(rpm_smd_clk_lock);
#[no_mangle]
unsafe extern "C" fn clk_smd_rpm_handoff(r: *const clk_smd_rpm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_smd_rpm_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_smd_rpm_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_smd_rpm_enable_scaling() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_smd_unregister_icc(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rpm_smd_clk_probe(pdev: *mut platform_device) -> c_int {
    ...
    "icc_smd_rpm", -1, core::ptr::null_mut(), 0);
    if (IS_ERR(icc_pdev)) {
...
#[no_mangle]
unsafe extern "C" fn rpm_smd_clk_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rpm_smd_clk_exit() -> void __exit {
