...
//! Source: drivers/clk/qcom/camcc-sm8450.c
#![no_std]
...
//
    ...
    let mut pll_parent_data_tcxo: static struct clk_parent_data = { .index = DT_BI_TCXO };
...
#[no_mangle]
unsafe extern "C" fn cam_cc_sm8450_probe(pdev: *mut platform_device) -> c_int {
