...
//! Source: drivers/clk/qcom/clk-ref.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_clk_ref_provider {
    pub num_refs: usize,
    pub __counted_by(num_refs): qcom_clk_ref refs[],
}
...
#[no_mangle]
unsafe extern "C" fn qcom_clk_ref_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_clk_ref_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn qcom_clk_ref_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_clk_ref_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn qcom_clk_ref_is_enabled(hw: *mut clk_hw) -> c_int {
    ...
    let mut init_data: clk_init_data = {};
