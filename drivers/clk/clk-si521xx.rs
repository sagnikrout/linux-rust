...
//! Source: drivers/clk/clk-si521xx.c
#![no_std]
...
pub const SI521XX_REG_ID: c_uint = 0x3;

pub const SI521XX_REG_BC: c_uint = 0x4;
pub const SI521XX_REG_DA: c_uint = 0x5;

pub const SI521XX_REG_DA_AMP_MIN: c_int = 300000;
pub const SI521XX_REG_DA_AMP_DEFAULT: c_int = 800000;
pub const SI521XX_REG_DA_AMP_MAX: c_int = 1000000;
pub const SI521XX_REG_DA_AMP_STEP: c_int = 100000;
...
pub const SI521XX_DIFF_MULT: c_int = 4;
pub const SI521XX_DIFF_DIV: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn si521xx_diff_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si521xx_diff_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn si521xx_get_common_config(si: *mut si521xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si521xx_update_config(si: *mut si521xx) {
...
#[no_mangle]
unsafe extern "C" fn si521xx_probe(client: *mut i2c_client) -> c_int {
    static int si521xx_probe(struct i2c_client *client)
    {
    let mut chip_info: u16 = (u16)(uintptr_t)i2c_get_match_data(client);
    let mut clk_parent_data: clk_parent_data = { .index = 0 };
...
// Fetch common configuration from DT (if specified)
    ...
    if (ret)
    return ret;
    si.regmap = devm_regmap_init(&client.dev, core::ptr::null_mut(), client,
...
#[no_mangle]
unsafe extern "C" fn si521xx_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn si521xx_resume(dev: *mut device) -> int __maybe_unused {
