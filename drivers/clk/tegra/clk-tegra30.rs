...
//! Source: drivers/clk/tegra/clk-tegra30.c
#![no_std]
...
pub const OSC_FREQ_DET_CNT_MASK: c_uint = 0xffff;
pub const CCLKG_BURST_POLICY: c_uint = 0x368;
pub const SUPER_CCLKG_DIVIDER: c_uint = 0x36c;
pub const CCLKLP_BURST_POLICY: c_uint = 0x370;
pub const SUPER_CCLKLP_DIVIDER: c_uint = 0x374;
pub const SCLK_BURST_POLICY: c_uint = 0x028;
pub const SUPER_SCLK_DIVIDER: c_uint = 0x02c;
pub const SYSTEM_CLK_RATE: c_uint = 0x030;
pub const TEGRA30_CLK_PERIPH_BANKS: c_int = 5;
pub const TEGRA30_CLK_CLK_MAX: c_int = 311;
...
pub const CLK_SOURCE_3D2: c_uint = 0x3b0;
pub const CLK_SOURCE_2D: c_uint = 0x15c;
pub const CLK_SOURCE_HDMI: c_uint = 0x18c;
pub const CLK_SOURCE_DSIB: c_uint = 0xd0;
...
pub const TEGRA30_CLK_RST_CONTROLLER_CLK_CPU_CMPLX_CLR: c_uint = 0x34c;
pub const TEGRA30_CLK_RST_CONTROLLER_CPU_CMPLX_STATUS: c_uint = 0x470;

pub const CLK_RESET_CCLK_BURST: c_uint = 0x20;
pub const CLK_RESET_CCLK_DIVIDER: c_uint = 0x24;
pub const CLK_RESET_PLLX_BASE: c_uint = 0xe0;
pub const CLK_RESET_PLLX_MISC: c_uint = 0xe4;
pub const CLK_RESET_SOURCE_CSITE: c_uint = 0x1d4;
pub const CLK_RESET_CCLK_BURST_POLICY_SHIFT: c_int = 28;
pub const CLK_RESET_CCLK_RUN_POLICY_SHIFT: c_int = 4;
pub const CLK_RESET_CCLK_IDLE_POLICY_SHIFT: c_int = 0;
pub const CLK_RESET_CCLK_IDLE_POLICY: c_int = 1;
pub const CLK_RESET_CCLK_RUN_POLICY: c_int = 2;
pub const CLK_RESET_CCLK_BURST_POLICY_PLLX: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn tegra30_pll_init() -> void __init {
...
// PLLE
    clk = clk_register_mux(core::ptr::null_mut(), "pll_e_mux", pll_e_parents,
    ARRAY_SIZE(pll_e_parents),
    CLK_SET_RATE_NO_REPARENT,
    clk_base + PLLE_AUX, 2, 1, 0, core::ptr::null_mut());
    }
    ...
    "clk_32k", "pll_m_out1" };
#[no_mangle]
unsafe extern "C" fn tegra30_super_clk_init() -> void __init {
...
//
    ...
    TEGRA_DIVIDER_INT, 16, 8, 1, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_p_cclkg", core::ptr::null_mut());
//
...
//
    ...
    clk_base + SUPER_CCLKG_DIVIDER, 0,
    TEGRA_DIVIDER_INT, 16, 8, 1, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_p_out3_cclkg", core::ptr::null_mut());
//
...
//
    ...
    clk_base + SUPER_CCLKG_DIVIDER, 0,
    TEGRA_DIVIDER_INT, 16, 8, 1, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_p_out4_cclkg", core::ptr::null_mut());
// CCLKG
...
//
    ...
    TEGRA_DIVIDER_INT, 16, 8, 1, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_p_cclklp", core::ptr::null_mut());
//
...
//
    ...
    clk_base + SUPER_CCLKLP_DIVIDER, 0,
    TEGRA_DIVIDER_INT, 16, 8, 1, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_p_out3_cclklp", core::ptr::null_mut());
//
...
//
    ...
    clk_base + SUPER_CCLKLP_DIVIDER, 0,
    TEGRA_DIVIDER_INT, 16, 8, 1, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_p_out4_cclklp", core::ptr::null_mut());
// CCLKLP
...
// twd
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "twd", "cclk_g",
    CLK_SET_RATE_PARENT, 1, 2);
    clks[TEGRA30_CLK_TWD] = clk;
    tegra_super_clk_gen4_init(clk_base, pmc_base, tegra30_clks, core::ptr::null_mut());
    }
    ...
    TEGRA_INIT_DATA("pwm", core::ptr::null_mut(), core::ptr::null_mut(), pwm_parents, CLK_SOURCE_PWM, 28, 2, 0, 0, 8, 1, 0, 17, TEGRA_PERIPH_ON_APB, TEGRA30_CLK_PWM),
    };
    static struct tegra_periph_init_data tegra_periph_nodiv_clk_list[] = {
    TEGRA_INIT_DATA_NODIV("dsib", mux_plld_out0_plld2_out0, CLK_SOURCE_DSIB, 25, 1, 82, 0, TEGRA30_CLK_DSIB),
    };
#[no_mangle]
unsafe extern "C" fn tegra30_periph_clk_init() -> void __init {
...
// csia_pad
    clk = clk_register_gate(core::ptr::null_mut(), "csia_pad", "pll_d", CLK_SET_RATE_PARENT,
    clk_base + PLLD_BASE, 26, 0, &pll_d_lock);
    clks[TEGRA30_CLK_CSIA_PAD] = clk;
// csib_pad
    clk = clk_register_gate(core::ptr::null_mut(), "csib_pad", "pll_d2", CLK_SET_RATE_PARENT,
...
#[no_mangle]
unsafe extern "C" fn tegra30_put_cpu_in_reset(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra30_cpu_out_of_reset(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra30_enable_cpu_clock(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra30_disable_cpu_clock(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra30_cpu_rail_off_ready() -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra30_cpu_clock_suspend() {
...
#[no_mangle]
unsafe extern "C" fn tegra30_cpu_clock_resume() {
...
#[no_mangle]
pub unsafe extern "C" fn if(CLK_RESET_CCLK_RUN_POLICY: policy ==) -> else {
...
//
    ...
    TEGRA_CLK_DUPLICATE(TEGRA30_CLK_USBD, "utmip-pad", core::ptr::null_mut()),
    TEGRA_CLK_DUPLICATE(TEGRA30_CLK_USBD, "tegra-ehci.0", core::ptr::null_mut()),
    TEGRA_CLK_DUPLICATE(TEGRA30_CLK_USBD, "tegra-otg", core::ptr::null_mut()),
    ...
    TEGRA_CLK_DUPLICATE(TEGRA30_CLK_CML1, "tegra_sata_cml", core::ptr::null_mut()),
    TEGRA_CLK_DUPLICATE(TEGRA30_CLK_CML0, "tegra_pcie", "cml"),
    TEGRA_CLK_DUPLICATE(TEGRA30_CLK_VCP, "nvavp", "vcp"),
// must be the last entry
    TEGRA_CLK_DUPLICATE(TEGRA30_CLK_CLK_MAX, core::ptr::null_mut(), core::ptr::null_mut()),
    };
...
#[no_mangle]
unsafe extern "C" fn tegra30_clock_init(np: *mut device_node) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn tegra30_car_probe(pdev: *mut platform_device) -> c_int {
...
// PLLE
    ...
    CLK_GET_RATE_NOCACHE, &pll_e_params, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn tegra30_car_init() -> c_int {
