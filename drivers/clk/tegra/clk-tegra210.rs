...
//! Source: drivers/clk/tegra/clk-tegra210.c
#![no_std]
...
//
pub const TEGRA210_CAR_BANK_COUNT: c_int = 7;
pub const CLK_SOURCE_CSITE: c_uint = 0x1d4;
pub const CLK_SOURCE_EMC: c_uint = 0x19c;
pub const CLK_SOURCE_SOR1: c_uint = 0x410;
...
pub const CLK_SOURCE_EMC_DLL: c_uint = 0x664;
pub const PLLC_BASE: c_uint = 0x80;
pub const PLLC_OUT: c_uint = 0x84;
pub const PLLC_MISC0: c_uint = 0x88;
pub const PLLC_MISC1: c_uint = 0x8c;
pub const PLLC_MISC2: c_uint = 0x5d0;
pub const PLLC_MISC3: c_uint = 0x5d4;
pub const PLLC2_BASE: c_uint = 0x4e8;
pub const PLLC2_MISC0: c_uint = 0x4ec;
pub const PLLC2_MISC1: c_uint = 0x4f0;
pub const PLLC2_MISC2: c_uint = 0x4f4;
pub const PLLC2_MISC3: c_uint = 0x4f8;
pub const PLLC3_BASE: c_uint = 0x4fc;
pub const PLLC3_MISC0: c_uint = 0x500;
pub const PLLC3_MISC1: c_uint = 0x504;
pub const PLLC3_MISC2: c_uint = 0x508;
pub const PLLC3_MISC3: c_uint = 0x50c;
pub const PLLM_BASE: c_uint = 0x90;
pub const PLLM_MISC1: c_uint = 0x98;
pub const PLLM_MISC2: c_uint = 0x9c;
pub const PLLP_BASE: c_uint = 0xa0;
pub const PLLP_MISC0: c_uint = 0xac;
pub const PLLP_MISC1: c_uint = 0x680;
pub const PLLA_BASE: c_uint = 0xb0;
pub const PLLA_MISC0: c_uint = 0xbc;
pub const PLLA_MISC1: c_uint = 0xb8;
pub const PLLA_MISC2: c_uint = 0x5d8;
pub const PLLD_BASE: c_uint = 0xd0;
pub const PLLD_MISC0: c_uint = 0xdc;
pub const PLLD_MISC1: c_uint = 0xd8;
pub const PLLU_BASE: c_uint = 0xc0;
pub const PLLU_OUTA: c_uint = 0xc4;
pub const PLLU_MISC0: c_uint = 0xcc;
pub const PLLU_MISC1: c_uint = 0xc8;
pub const PLLX_BASE: c_uint = 0xe0;
pub const PLLX_MISC0: c_uint = 0xe4;
pub const PLLX_MISC1: c_uint = 0x510;
pub const PLLX_MISC2: c_uint = 0x514;
pub const PLLX_MISC3: c_uint = 0x518;
pub const PLLX_MISC4: c_uint = 0x5f0;
pub const PLLX_MISC5: c_uint = 0x5f4;
pub const PLLE_BASE: c_uint = 0xe8;
pub const PLLE_MISC0: c_uint = 0xec;
pub const PLLD2_BASE: c_uint = 0x4b8;
pub const PLLD2_MISC0: c_uint = 0x4bc;
pub const PLLD2_MISC1: c_uint = 0x570;
pub const PLLD2_MISC2: c_uint = 0x574;
pub const PLLD2_MISC3: c_uint = 0x578;
pub const PLLE_AUX: c_uint = 0x48c;
pub const PLLRE_BASE: c_uint = 0x4c4;
pub const PLLRE_MISC0: c_uint = 0x4c8;
pub const PLLRE_OUT1: c_uint = 0x4cc;
pub const PLLDP_BASE: c_uint = 0x590;
pub const PLLDP_MISC: c_uint = 0x594;
pub const PLLC4_BASE: c_uint = 0x5a4;
pub const PLLC4_MISC0: c_uint = 0x5a8;
pub const PLLC4_OUT: c_uint = 0x5e4;
pub const PLLMB_BASE: c_uint = 0x5e8;
pub const PLLMB_MISC1: c_uint = 0x5ec;
pub const PLLA1_BASE: c_uint = 0x6a4;
pub const PLLA1_MISC0: c_uint = 0x6a8;
pub const PLLA1_MISC1: c_uint = 0x6ac;
pub const PLLA1_MISC2: c_uint = 0x6b0;
pub const PLLA1_MISC3: c_uint = 0x6b4;
pub const PLLU_IDDQ_BIT: c_int = 31;
pub const PLLCX_IDDQ_BIT: c_int = 27;
pub const PLLRE_IDDQ_BIT: c_int = 24;
pub const PLLA_IDDQ_BIT: c_int = 25;
pub const PLLD_IDDQ_BIT: c_int = 20;
pub const PLLSS_IDDQ_BIT: c_int = 18;
pub const PLLM_IDDQ_BIT: c_int = 5;
pub const PLLMB_IDDQ_BIT: c_int = 17;
pub const PLLXP_IDDQ_BIT: c_int = 3;
pub const PLLCX_RESET_BIT: c_int = 30;

pub const PLL_MISC_LOCK_ENABLE: c_int = 18;
pub const PLLC_MISC_LOCK_ENABLE: c_int = 24;
pub const PLLDU_MISC_LOCK_ENABLE: c_int = 22;
pub const PLLU_MISC_LOCK_ENABLE: c_int = 29;
pub const PLLE_MISC_LOCK_ENABLE: c_int = 9;
pub const PLLRE_MISC_LOCK_ENABLE: c_int = 30;
pub const PLLSS_MISC_LOCK_ENABLE: c_int = 30;
pub const PLLP_MISC_LOCK_ENABLE: c_int = 18;
pub const PLLM_MISC_LOCK_ENABLE: c_int = 4;
pub const PLLMB_MISC_LOCK_ENABLE: c_int = 16;
pub const PLLA_MISC_LOCK_ENABLE: c_int = 28;
pub const PLLU_MISC_LOCK_ENABLE: c_int = 29;
pub const PLLD_MISC_LOCK_ENABLE: c_int = 18;
pub const PLLA_SDM_DIN_MASK: c_uint = 0xffff;

pub const PLLD2_SSC_EN_MASK: c_int = 0;
pub const PLLDP_SS_CFG: c_uint = 0x598;

pub const PLLDP_SS_CTRL1: c_uint = 0x59c;
pub const PLLDP_SS_CTRL2: c_uint = 0x5a0;
pub const PMC_PLLM_WB0_OVERRIDE: c_uint = 0x1dc;
pub const PMC_PLLM_WB0_OVERRIDE_2: c_uint = 0x2b0;
...
pub const SPARE_REG0: c_uint = 0x55c;
pub const CLK_M_DIVISOR_SHIFT: c_int = 2;
pub const CLK_M_DIVISOR_MASK: c_uint = 0x3;
pub const CLK_MASK_ARM: c_uint = 0x44;
pub const MISC_CLK_ENB: c_uint = 0x48;
pub const RST_DFLL_DVCO: c_uint = 0x2f4;
pub const DVFS_DFLL_RESET_SHIFT: c_int = 0;
pub const CLK_RST_CONTROLLER_CLK_OUT_ENB_X_SET: c_uint = 0x284;
pub const CLK_RST_CONTROLLER_CLK_OUT_ENB_X_CLR: c_uint = 0x288;

pub const CLK_RST_CONTROLLER_RST_DEV_Y_SET: c_uint = 0x2a8;
pub const CLK_RST_CONTROLLER_RST_DEV_Y_CLR: c_uint = 0x2ac;
pub const CPU_SOFTRST_CTRL: c_uint = 0x380;
pub const LVL2_CLK_GATE_OVRA: c_uint = 0xf8;
pub const LVL2_CLK_GATE_OVRC: c_uint = 0x3a0;
pub const LVL2_CLK_GATE_OVRD: c_uint = 0x3a4;
pub const LVL2_CLK_GATE_OVRE: c_uint = 0x554;
// I2S registers to handle during APE MBIST WAR
pub const TEGRA210_I2S_BASE: c_uint = 0x1000;
pub const TEGRA210_I2S_SIZE: c_uint = 0x100;
pub const TEGRA210_I2S_CTRLS: c_int = 5;
pub const TEGRA210_I2S_CG: c_uint = 0x88;
pub const TEGRA210_I2S_CTRL: c_uint = 0xa0;
// DISPA registers to handle during MBIST WAR
pub const DC_CMD_DISPLAY_COMMAND: c_uint = 0xc8;
pub const DC_COM_DSC_TOP_CTL: c_uint = 0xcf8;
// VIC register to handle during MBIST WAR
pub const NV_PVIC_THI_SLCG_OVERRIDE_LOW: c_uint = 0x8c;
// APE, DISPA and VIC base addresses needed for MBIST WAR
pub const TEGRA210_AHUB_BASE: c_uint = 0x702d0000;
pub const TEGRA210_DISPA_BASE: c_uint = 0x54200000;
pub const TEGRA210_VIC_BASE: c_uint = 0x54340000;
//
...
pub const CLK_RST_CONTROLLER_CPU_CMPLX_STATUS: c_uint = 0x470;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra210_domain_mbist_war {
    pub mbist): *mut *mut void (handle_lvl2_ovr)(struct tegra210_domain_mbist_war,
    pub lvl2_offset: u32,
    pub lvl2_mask: u32,
    pub num_clks: c_uint,
    pub clk_init_data: *const c_uint,
...
pub const PLLCX_MISC0_DEFAULT_VALUE: c_uint = 0x40080000;
pub const PLLCX_MISC0_WRITE_MASK: c_uint = 0x400ffffb;
pub const PLLCX_MISC1_DEFAULT_VALUE: c_uint = 0x08000000;
pub const PLLCX_MISC1_WRITE_MASK: c_uint = 0x08003cff;
pub const PLLCX_MISC2_DEFAULT_VALUE: c_uint = 0x1f720f05;
pub const PLLCX_MISC2_WRITE_MASK: c_uint = 0xffffff17;
pub const PLLCX_MISC3_DEFAULT_VALUE: c_uint = 0x000000c4;
pub const PLLCX_MISC3_WRITE_MASK: c_uint = 0x00ffffff;
// PLLA

pub const PLLA_MISC0_DEFAULT_VALUE: c_uint = 0x12000020;
pub const PLLA_MISC0_WRITE_MASK: c_uint = 0x7fffffff;
pub const PLLA_MISC2_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLA_MISC2_WRITE_MASK: c_uint = 0x06ffffff;
// PLLD

pub const PLLD_MISC0_DEFAULT_VALUE: c_uint = 0x00140000;
pub const PLLD_MISC0_WRITE_MASK: c_uint = 0x3ff7ffff;
pub const PLLD_MISC1_DEFAULT_VALUE: c_uint = 0x20;
pub const PLLD_MISC1_WRITE_MASK: c_uint = 0x00ffffff;
// PLLD2 and PLLDP  and PLLC4

pub const PLLDSS_BASE_REF_SEL_SHIFT: c_int = 25;

pub const PLLD2_MISC0_DEFAULT_VALUE: c_uint = 0x40000020;
pub const PLLD2_MISC1_CFG_DEFAULT_VALUE: c_uint = 0x10000000;
pub const PLLD2_MISC2_CTRL1_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLD2_MISC3_CTRL2_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLDP_MISC0_DEFAULT_VALUE: c_uint = 0x40000020;
pub const PLLDP_MISC1_CFG_DEFAULT_VALUE: c_uint = 0xc0000000;
pub const PLLDP_MISC2_CTRL1_DEFAULT_VALUE: c_uint = 0xf400f0da;
pub const PLLDP_MISC3_CTRL2_DEFAULT_VALUE: c_uint = 0x2004f400;
pub const PLLDSS_MISC0_WRITE_MASK: c_uint = 0x47ffffff;
pub const PLLDSS_MISC1_CFG_WRITE_MASK: c_uint = 0xf8000000;
pub const PLLDSS_MISC2_CTRL1_WRITE_MASK: c_uint = 0xffffffff;
pub const PLLDSS_MISC3_CTRL2_WRITE_MASK: c_uint = 0xffffffff;
pub const PLLC4_MISC0_DEFAULT_VALUE: c_uint = 0x40000000;
// PLLRE

pub const PLLRE_BASE_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLRE_MISC0_DEFAULT_VALUE: c_uint = 0x41000000;
pub const PLLRE_BASE_DEFAULT_MASK: c_uint = 0x1c000000;
pub const PLLRE_MISC0_WRITE_MASK: c_uint = 0x67ffffff;
// PLLE

// PLLX
pub const PLLX_USE_DYN_RAMP: c_int = 1;

pub const PLLX_MISC2_DYNRAMP_STEPB_SHIFT: c_int = 24;

pub const PLLX_MISC2_DYNRAMP_STEPA_SHIFT: c_int = 16;

pub const PLLX_MISC2_NDIV_NEW_SHIFT: c_int = 8;

pub const PLLX_MISC0_WRITE_MASK: c_uint = 0x10c40000;
pub const PLLX_MISC1_DEFAULT_VALUE: c_uint = 0x20;
pub const PLLX_MISC1_WRITE_MASK: c_uint = 0x00ffffff;
pub const PLLX_MISC2_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLX_MISC2_WRITE_MASK: c_uint = 0xffffff11;

pub const PLLX_MISC3_WRITE_MASK: c_uint = 0x01ff0f0f;
pub const PLLX_MISC4_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLX_MISC4_WRITE_MASK: c_uint = 0x8000ffff;
pub const PLLX_MISC5_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLX_MISC5_WRITE_MASK: c_uint = 0x0000ffff;
pub const PLLX_HW_CTRL_CFG: c_uint = 0x548;

// PLLMB

pub const PLLMB_MISC1_DEFAULT_VALUE: c_uint = 0x00030000;
pub const PLLMB_MISC1_WRITE_MASK: c_uint = 0x0007ffff;
// PLLP

pub const PLLP_MISC1_HSIO_EN_SHIFT: c_int = 29;

pub const PLLP_MISC1_XUSB_EN_SHIFT: c_int = 28;

pub const PLLP_MISC0_DEFAULT_VALUE: c_uint = 0x00040008;
pub const PLLP_MISC1_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLP_MISC0_WRITE_MASK: c_uint = 0xdc6000f;
pub const PLLP_MISC1_WRITE_MASK: c_uint = 0x70ffffff;
// PLLU
...
pub const PLLU_MISC0_DEFAULT_VALUE: c_uint = 0xa0000000;
pub const PLLU_MISC1_DEFAULT_VALUE: c_uint = 0x0;
pub const PLLU_MISC0_WRITE_MASK: c_uint = 0xbfffffff;
pub const PLLU_MISC1_WRITE_MASK: c_uint = 0x00000007;
#[no_mangle]
pub unsafe extern "C" fn tegra210_plle_hw_sequence_is_enabled() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_plle_hw_sequence_start() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_xusb_pll_hw_control_enable() {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_xusb_pll_hw_sequence_start() {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_sata_pll_hw_control_enable() {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_sata_pll_hw_sequence_start() {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_set_sata_pll_seq_sw(state: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_clk_emc_dll_enable(flag: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_clk_emc_dll_update_setting(emc_dll_src_value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_clk_emc_update_setting(emc_src_value: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_generic_mbist_war(mbist: *mut tegra210_domain_mbist_war) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_venc_mbist_war(mbist: *mut tegra210_domain_mbist_war) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_disp_mbist_war(mbist: *mut tegra210_domain_mbist_war) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_vic_mbist_war(mbist: *mut tegra210_domain_mbist_war) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_ape_mbist_war(mbist: *mut tegra210_domain_mbist_war) {
    ...
    {
    let mut boot_val: u32 = readl_relaxed(base + params.ext_misc_reg[misc_num]);
    boot_val &= mask;
    default_val &= mask;
...
//
#[no_mangle]
unsafe extern "C" fn pllcx_check_defaults(params: *mut tegra_clk_pll_params) {
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_plla_set_defaults(plla: *mut tegra_clk_pll) {
    static void tegra210_plla_set_defaults(struct tegra_clk_pll *plla)
    {
    u32 mask;
    let mut val: u32 = readl_relaxed(clk_base + plla.params.base_reg);
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_plld_set_defaults(plld: *mut tegra_clk_pll) {
...
//
    ...
    {
    u32 default_val;
    let mut val: u32 = readl_relaxed(clk_base + plldss.params.base_reg);
...
#[no_mangle]
unsafe extern "C" fn tegra210_plld2_set_defaults(plld2: *mut tegra_clk_pll) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_plldp_set_defaults(plldp: *mut tegra_clk_pll) {
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_pllc4_set_defaults(pllc4: *mut tegra_clk_pll) {
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_pllre_set_defaults(pllre: *mut tegra_clk_pll) {
    static void tegra210_pllre_set_defaults(struct tegra_clk_pll *pllre)
    {
    u32 mask;
    let mut val: u32 = readl_relaxed(clk_base + pllre.params.base_reg);
...
#[no_mangle]
unsafe extern "C" fn pllx_get_dyn_steps(hw: *mut clk_hw, step_a: *mut u32, step_b: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn pllx_check_defaults(pll: *mut tegra_clk_pll) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pllx_set_defaults(pllx: *mut tegra_clk_pll) {
...
// PLLMB
#[no_mangle]
unsafe extern "C" fn tegra210_pllmb_set_defaults(pllmb: *mut tegra_clk_pll) {
...
//
#[no_mangle]
unsafe extern "C" fn pllp_check_defaults(pll: *mut tegra_clk_pll, enabled: bool) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_pllp_set_defaults(pllp: *mut tegra_clk_pll) {
    static void tegra210_pllp_set_defaults(struct tegra_clk_pll *pllp)
    {
    u32 mask;
    let mut val: u32 = readl_relaxed(clk_base + pllp.params.base_reg);
...
#[no_mangle]
unsafe extern "C" fn tegra210_pllu_set_defaults(pllu: *mut tegra_clk_pll_params) {
    static void tegra210_pllu_set_defaults(struct tegra_clk_pll_params *pllu)
    {
    let mut val: u32 = readl_relaxed(clk_base + pllu.base_reg);
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_clk_pll_set_gain(cfg: *mut tegra_clk_pll_freq_table) {
    ...
    {
    let mut vco_min: c_ulong = params.vco_min;
...
// post divider.
//
pub const PLL_QLIN_PDIV_MAX: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn pll_qlin_p_to_pdiv(p: u32, pdiv: *mut u32) -> u32 {
...
pub const PLL_EXPO_PDIV_MAX: c_int = 7;
...
#[no_mangle]
unsafe extern "C" fn pll_expo_p_to_pdiv(p: u32, pdiv: *mut u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_clk_handle_mbist_war(id: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_put_utmipll_in_iddq() {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_put_utmipll_out_iddq() {
...
#[no_mangle]
unsafe extern "C" fn tegra210_utmi_param_configure() {
...
#[no_mangle]
unsafe extern "C" fn tegra210_enable_pllu() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_init_pllu() -> c_int {
...
//
    ...
    {
    struct clk *clk;
    clk = clk_register_divider_table(core::ptr::null_mut(), name, parent_name,
    CLK_IS_CRITICAL,
...
//
    TEGRA_INIT_DATA_TABLE("sor0", core::ptr::null_mut(), core::ptr::null_mut(), sor0_parents,
    CLK_SOURCE_SOR0, 29, 0x0, 0, 0, 0, 0,
    0, 182, 0, tegra_clk_sor0, core::ptr::null_mut(), 0,
    &sor0_lock),
    TEGRA_INIT_DATA_TABLE("sor0_out", core::ptr::null_mut(), core::ptr::null_mut(), sor0_out_parents,
    CLK_SOURCE_SOR0, 14, 0x1, 0, 0, 0, 0,
    0, 0, TEGRA_PERIPH_NO_GATE, tegra_clk_sor0_out,
    core::ptr::null_mut(), 0, &sor0_lock),
    TEGRA_INIT_DATA_TABLE("sor1", core::ptr::null_mut(), core::ptr::null_mut(), sor1_parents,
    CLK_SOURCE_SOR1, 29, 0x7, 0, 0, 8, 1,
    TEGRA_DIVIDER_ROUND_UP, 183, 0,
    tegra_clk_sor1, sor1_parents_idx, 0,
    &sor1_lock),
    TEGRA_INIT_DATA_TABLE("sor1_out", core::ptr::null_mut(), core::ptr::null_mut(), sor1_out_parents,
    CLK_SOURCE_SOR1, 14, 0x3, 0, 0, 0, 0,
    0, 0, TEGRA_PERIPH_NO_GATE,
    tegra_clk_sor1_out, core::ptr::null_mut(), 0, &sor1_lock),
    };
    static const char * const la_parents[] = {
    "pll_p", "pll_c2", "pll_c", "pll_c3", "pll_re_out1", "pll_a1", "clk_m", "pll_c4_out0"
    };
    static struct tegra_clk_periph tegra210_la =
    TEGRA_CLK_PERIPH(29, 7, 9, 0, 8, 1, TEGRA_DIVIDER_ROUND_UP, 76, 0, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    unsigned int i;
// xusb_ss_div2
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "xusb_ss_div2", "xusb_ss_src", 0,
    1, 2);
...
// pll_d_dsi_out
    clk = clk_register_gate(core::ptr::null_mut(), "pll_d_dsi_out", "pll_d_out0", 0,
...
// csi_tpg
    clk = clk_register_gate(core::ptr::null_mut(), "csi_tpg", "pll_d",
    CLK_SET_RATE_PARENT, clk_base + PLLD_BASE,
    23, 0, &pll_d_lock);
    clk_register_clkdev(clk, "csi_tpg", core::ptr::null_mut());
...
// cml0
    clk = clk_register_gate(core::ptr::null_mut(), "cml0", "pll_e", 0, clk_base + PLLE_AUX,
    0, 0, &pll_e_lock);
    clk_register_clkdev(clk, "cml0", core::ptr::null_mut());
    clks[TEGRA210_CLK_CML0] = clk;
// cml1
    clk = clk_register_gate(core::ptr::null_mut(), "cml1", "pll_e", 0, clk_base + PLLE_AUX,
    1, 0, &pll_e_lock);
    clk_register_clkdev(clk, "cml1", core::ptr::null_mut());
    ...
    CLK_SOURCE_SDMMC2, 9,
    TEGRA_DIVIDER_ROUND_UP, 0, core::ptr::null_mut());
...
// PLLC
    ...
    pmc, 0, &pll_c_params, core::ptr::null_mut());
    if (!WARN_ON(IS_ERR(clk)))
    clk_register_clkdev(clk, "pll_c", core::ptr::null_mut());
...
// PLLC_OUT1
    ...
    clk_register_clkdev(clk, "pll_c_out1", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_C_OUT1] = clk;
// PLLC_UD
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_c_ud", "pll_c",
    CLK_SET_RATE_PARENT, 1, 1);
    clk_register_clkdev(clk, "pll_c_ud", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_C_UD] = clk;
// PLLC2
    clk = tegra_clk_register_pllc_tegra210("pll_c2", "pll_ref", clk_base,
    pmc, 0, &pll_c2_params, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_c2", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_C2] = clk;
// PLLC3
    clk = tegra_clk_register_pllc_tegra210("pll_c3", "pll_ref", clk_base,
    pmc, 0, &pll_c3_params, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_c3", core::ptr::null_mut());
...
// PLLM
    ...
    clk_register_clkdev(clk, "pll_m", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_M] = clk;
// PLLMB
    clk = tegra_clk_register_pllmb("pll_mb", "osc", clk_base, pmc,
    CLK_SET_RATE_GATE, &pll_mb_params, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_mb", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_MB] = clk;
// PLLM_UD
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_m_ud", "pll_m",
    CLK_SET_RATE_PARENT, 1, 1);
    clk_register_clkdev(clk, "pll_m_ud", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_M_UD] = clk;
// PLLMB_UD
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_mb_ud", "pll_mb",
    CLK_SET_RATE_PARENT, 1, 1);
    clk_register_clkdev(clk, "pll_mb_ud", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_MB_UD] = clk;
// PLLP_UD
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_p_ud", "pll_p",
    0, 1, 1);
    clks[TEGRA210_CLK_PLL_P_UD] = clk;
// PLLU_VCO
    if (!tegra210_init_pllu()) {
    clk = clk_register_fixed_rate(core::ptr::null_mut(), "pll_u_vco", "pll_ref", 0,
    480*1000*1000);
    clk_register_clkdev(clk, "pll_u_vco", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_U] = clk;
    }
// PLLU_OUT
    clk = clk_register_divider_table(core::ptr::null_mut(), "pll_u_out", "pll_u_vco", 0,
    clk_base + PLLU_BASE, 16, 4, 0,
    pll_vco_post_div_table, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_u_out", core::ptr::null_mut());
...
// PLLU_OUT1
    ...
    clk_register_clkdev(clk, "pll_u_out1", core::ptr::null_mut());
...
// PLLU_OUT2
    ...
    CLK_SET_RATE_PARENT, 0, &pll_u_lock);
    clk_register_clkdev(clk, "pll_u_out2", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_U_OUT2] = clk;
// PLLU_480M
    clk = clk_register_gate(core::ptr::null_mut(), "pll_u_480M", "pll_u_vco",
    CLK_SET_RATE_PARENT, clk_base + PLLU_BASE,
    22, 0, &pll_u_lock);
    clk_register_clkdev(clk, "pll_u_480M", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_U_480M] = clk;
// PLLU_60M
    clk = clk_register_gate(core::ptr::null_mut(), "pll_u_60M", "pll_u_out2",
    CLK_SET_RATE_PARENT, clk_base + PLLU_BASE,
    23, 0, &pll_u_lock);
    clk_register_clkdev(clk, "pll_u_60M", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_U_60M] = clk;
// PLLU_48M
    clk = clk_register_gate(core::ptr::null_mut(), "pll_u_48M", "pll_u_out1",
    CLK_SET_RATE_PARENT, clk_base + PLLU_BASE,
    25, 0, &pll_u_lock);
    clk_register_clkdev(clk, "pll_u_48M", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_U_48M] = clk;
// PLLD
    clk = tegra_clk_register_pll("pll_d", "pll_ref", clk_base, pmc, 0,
    &pll_d_params, &pll_d_lock);
    clk_register_clkdev(clk, "pll_d", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_D] = clk;
// PLLD_OUT0
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_d_out0", "pll_d",
    CLK_SET_RATE_PARENT, 1, 2);
    clk_register_clkdev(clk, "pll_d_out0", core::ptr::null_mut());
...
// PLLRE
    ...
    clk_register_clkdev(clk, "pll_re_vco", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_RE_VCO] = clk;
    clk = clk_register_divider_table(core::ptr::null_mut(), "pll_re_out", "pll_re_vco", 0,
    clk_base + PLLRE_BASE, 16, 5, 0,
    pll_vco_post_div_table, &pll_re_lock);
    clk_register_clkdev(clk, "pll_re_out", core::ptr::null_mut());
...
// PLLE
    ...
    clk_base, 0, &pll_e_params, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_e", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_E] = clk;
// PLLC4
    clk = tegra_clk_register_pllre("pll_c4_vco", "pll_ref", clk_base, pmc,
    0, &pll_c4_vco_params, core::ptr::null_mut(), pll_ref_freq);
    clk_register_clkdev(clk, "pll_c4_vco", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_C4] = clk;
// PLLC4_OUT0
    clk = clk_register_divider_table(core::ptr::null_mut(), "pll_c4_out0", "pll_c4_vco", 0,
    clk_base + PLLC4_BASE, 19, 4, 0,
    pll_vco_post_div_table, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_c4_out0", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_C4_OUT0] = clk;
// PLLC4_OUT1
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_c4_out1", "pll_c4_vco",
    CLK_SET_RATE_PARENT, 1, 3);
    clk_register_clkdev(clk, "pll_c4_out1", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_C4_OUT1] = clk;
// PLLC4_OUT2
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_c4_out2", "pll_c4_vco",
    CLK_SET_RATE_PARENT, 1, 5);
    clk_register_clkdev(clk, "pll_c4_out2", core::ptr::null_mut());
...
// PLLC4_OUT3
    ...
    CLK_SET_RATE_PARENT, 0, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_c4_out3", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_C4_OUT3] = clk;
// PLLDP
    clk = tegra_clk_register_pllss_tegra210("pll_dp", "pll_ref", clk_base,
    0, &pll_dp_params, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_dp", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_DP] = clk;
// PLLD2
    clk = tegra_clk_register_pllss_tegra210("pll_d2", "pll_ref", clk_base,
    0, &pll_d2_params, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_d2", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_D2] = clk;
// PLLD2_OUT0
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_d2_out0", "pll_d2",
    CLK_SET_RATE_PARENT, 1, 1);
    clk_register_clkdev(clk, "pll_d2_out0", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_D2_OUT0] = clk;
// PLLP_OUT2
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_p_out2", "pll_p",
    CLK_SET_RATE_PARENT, 1, 2);
    clk_register_clkdev(clk, "pll_p_out2", core::ptr::null_mut());
    clks[TEGRA210_CLK_PLL_P_OUT2] = clk;
    }
// Tegra210 CPU clock and reset control functions
#[no_mangle]
unsafe extern "C" fn tegra210_wait_cpu_in_reset(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_disable_cpu_clock(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_clk_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_clk_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_cpu_clock_suspend() {
...
#[no_mangle]
unsafe extern "C" fn tegra210_cpu_clock_resume() {
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_clock_apply_init_table() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_car_barrier() {
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_clock_assert_dfll_dvco_reset() {
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_clock_deassert_dfll_dvco_reset() {
...
#[no_mangle]
unsafe extern "C" fn tegra210_reset_deassert(id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_mbist_clk_init() {
    static void tegra210_mbist_clk_init(void)
    {
    unsigned int i, j;
    for (i = 0; i < ARRAY_SIZE(tegra210_pg_mbist_war); i++) {
    let mut num_clks: c_uint = tegra210_pg_mbist_war[i].num_clks;
    ...
    let mut clk_id: c_int = tegra210_pg_mbist_war[i].clk_init_data[j];
    struct clk *clk = clks[clk_id];
    if (WARN(IS_ERR(clk), "clk_id: %d\n", clk_id)) {
    kfree(clk_data);
    tegra210_pg_mbist_war[i].clks = core::ptr::null_mut();
    break;
    }
    clk_data[j].clk = clk;
    }
...
//
#[no_mangle]
unsafe extern "C" fn tegra210_clock_init(np: *mut device_node) -> void __init {
