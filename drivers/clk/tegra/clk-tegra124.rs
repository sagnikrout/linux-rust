...
//! Source: drivers/clk/tegra/clk-tegra124.c
#![no_std]
...
//
pub const TEGRA124_CAR_BANK_COUNT: c_int = 6;
...
pub const PLLC_MISC2: c_uint = 0x88;
pub const PLLC_MISC: c_uint = 0x8c;
pub const PLLC2_BASE: c_uint = 0x4e8;
pub const PLLC2_MISC: c_uint = 0x4ec;
pub const PLLC3_BASE: c_uint = 0x4fc;
pub const PLLC3_MISC: c_uint = 0x500;
...
pub const PLLD2_MISC: c_uint = 0x4bc;
pub const PLLE_AUX: c_uint = 0x48c;
pub const PLLRE_BASE: c_uint = 0x4c4;
pub const PLLRE_MISC: c_uint = 0x4c8;
pub const PLLDP_BASE: c_uint = 0x590;
pub const PLLDP_MISC: c_uint = 0x594;
pub const PLLC4_BASE: c_uint = 0x5a4;
pub const PLLC4_MISC: c_uint = 0x5a8;
pub const PLLC_IDDQ_BIT: c_int = 26;
pub const PLLRE_IDDQ_BIT: c_int = 16;
pub const PLLSS_IDDQ_BIT: c_int = 19;
...
pub const PLLXC_SW_MAX_P: c_int = 6;
...
// PLLC2
    ...
    &pll_c2_params, core::ptr::null_mut());
...
// PLLC3
    ...
    &pll_c3_params, core::ptr::null_mut());
...
// PLLM_OUT1
    ...
    CLK_SET_RATE_PARENT, 0, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_m_out1", core::ptr::null_mut());
...
// PLLU
    ...
    clk_register_clkdev(clk, "pll_u", core::ptr::null_mut());
    clks[TEGRA124_CLK_PLL_U] = clk;
// PLLU_480M
    clk = clk_register_gate(core::ptr::null_mut(), "pll_u_480M", "pll_u",
    CLK_SET_RATE_PARENT, clk_base + PLLU_BASE,
    22, 0, &pll_u_lock);
    clk_register_clkdev(clk, "pll_u_480M", core::ptr::null_mut());
    clks[TEGRA124_CLK_PLL_U_480M] = clk;
// PLLU_60M
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_u_60M", "pll_u",
    CLK_SET_RATE_PARENT, 1, 8);
    clk_register_clkdev(clk, "pll_u_60M", core::ptr::null_mut());
    clks[TEGRA124_CLK_PLL_U_60M] = clk;
// PLLU_48M
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_u_48M", "pll_u",
    CLK_SET_RATE_PARENT, 1, 10);
    clk_register_clkdev(clk, "pll_u_48M", core::ptr::null_mut());
    clks[TEGRA124_CLK_PLL_U_48M] = clk;
// PLLU_12M
    clk = clk_register_fixed_factor(core::ptr::null_mut(), "pll_u_12M", "pll_u",
    CLK_SET_RATE_PARENT, 1, 40);
    clk_register_clkdev(clk, "pll_u_12M", core::ptr::null_mut());
...
// PLLC4
    ...
    &pll_c4_params, core::ptr::null_mut());
    clk_register_clkdev(clk, "pll_c4", core::ptr::null_mut());
    clks[TEGRA124_CLK_PLL_C4] = clk;
// PLLDP
    clk = tegra_clk_register_pllss("pll_dp", "pll_ref", clk_base, 0,
    &pll_dp_params, core::ptr::null_mut());
...
// PLLD2
    ...
    &tegra124_pll_d2_params, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tegra124_wait_cpu_in_reset(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_disable_cpu_clock(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra124_cpu_clock_suspend() {
...
#[no_mangle]
unsafe extern "C" fn tegra124_cpu_clock_resume() {
...
//
#[no_mangle]
unsafe extern "C" fn tegra124_clock_apply_init_table() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn tegra124_car_barrier() {
...
//
#[no_mangle]
unsafe extern "C" fn tegra124_clock_assert_dfll_dvco_reset() {
...
//
#[no_mangle]
unsafe extern "C" fn tegra124_clock_deassert_dfll_dvco_reset() {
...
#[no_mangle]
unsafe extern "C" fn tegra124_reset_assert(id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_reset_deassert(id: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tegra132_clock_apply_init_table() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn tegra124_132_clock_init_pre(np: *mut device_node) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn tegra124_132_clock_init_post(np: *mut device_node) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn tegra124_clock_init(np: *mut device_node) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn tegra132_clock_init(np: *mut device_node) -> void __init {
