...
//! Source: drivers/clk/tegra/clk-periph.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_periph_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_periph_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_periph_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_periph_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_periph_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_periph_disable_unused(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_periph_restore_context(hw: *mut clk_hw) {
    ...
    let mut div: bool = !(periph.gate.flags & TEGRA_PERIPH_NO_DIV);
    if (periph.gate.flags & TEGRA_PERIPH_NO_DIV) {
...
// Data in .init is copied by clk_register(), so stack variable OK
    ...
    periph.divider.reg = div ? (clk_base + offset) : core::ptr::null_mut();
    periph.gate.clk_base = clk_base;
    periph.gate.regs = bank;
    periph.gate.enable_refcnt = periph_clk_enb_refcnt;
    clk = clk_register(core::ptr::null_mut(), &periph.hw);
    if (IS_ERR(clk))
    return clk;
    periph.mux.hw.clk = clk;
    periph.divider.hw.clk = div ? clk : core::ptr::null_mut();
