...
//! Source: drivers/clk/tegra/clk-tegra124-dfll-fcpu.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dfll_fcpu_data {
    pub cpu_max_freq_table: *const c_ulong,
    pub cpu_max_freq_table_size: c_uint,
    pub cpu_cvb_tables: *const cvb_table,
    pub cpu_cvb_tables_size: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn tegra124_dfll_fcpu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra124_dfll_fcpu_remove(pdev: *mut platform_device) {
...
//
    ...
    tegra_dfll_runtime_resume, core::ptr::null_mut())
