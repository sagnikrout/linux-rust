...
//! Source: drivers/clk/tegra/clk-periph-gate.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_periph_enable_locked(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_periph_disable_locked(hw: *mut clk_hw) {
