...
//! Source: drivers/clk/tegra/clk-super.c
#![no_std]
...
pub const SUPER_STATE_IDLE: c_int = 0;
pub const SUPER_STATE_RUN: c_int = 1;
pub const SUPER_STATE_IRQ: c_int = 2;
pub const SUPER_STATE_FIQ: c_int = 3;
pub const SUPER_STATE_SHIFT: c_int = 28;

    BIT(SUPER_STATE_IRQ) | BIT(SUPER_STATE_FIQ))	\
    << SUPER_STATE_SHIFT)

pub const CCLK_SRC_PLLP_OUT0: c_int = 4;
pub const CCLK_SRC_PLLP_OUT4: c_int = 5;
#[no_mangle]
unsafe extern "C" fn clk_super_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_super_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_super_mux_restore_context(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_super_restore_context(hw: *mut clk_hw) {
