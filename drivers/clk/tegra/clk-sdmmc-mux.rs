...
//! Source: drivers/clk/tegra/clk-sdmmc-mux.c
#![no_std]
...
pub const MUX_SHIFT: c_int = 29;

pub const SDMMC_MUL: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn clk_sdmmc_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_sdmmc_mux_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_sdmmc_mux_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_sdmmc_mux_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_sdmmc_mux_disable_unused(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn clk_sdmmc_mux_restore_context(hw: *mut clk_hw) {
...
// Data in .init is copied by clk_register(), so stack variable OK
    ...
    clk = clk_register(core::ptr::null_mut(), &sdmmc_mux.hw);
    if (IS_ERR(clk)) {
    kfree(sdmmc_mux);
    return clk;
    }
