...
//! Source: drivers/clk/tegra/clk-tegra114.c
#![no_std]
...
pub const CPU_FINETRIM_SELECT: c_uint = 0x4d4	/* override default prop dlys */;
pub const CPU_FINETRIM_DR: c_uint = 0x4d8	/* rise->rise prop dly A */;
pub const CPU_FINETRIM_R: c_uint = 0x4e4	/* rise->rise prop dly inc A */;
...
pub const TEGRA114_CLK_PERIPH_BANKS: c_int = 5;
...
pub const PLLX_IDDQ_BIT: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn tegra114_fixed_clk_init(clk_base: *mut void __iomem) -> void __init {
...
// dsia mux
    clk = clk_register_mux(core::ptr::null_mut(), "dsia_mux", mux_plld_out0_plld2_out0,
    ARRAY_SIZE(mux_plld_out0_plld2_out0),
    CLK_SET_RATE_NO_REPARENT,
    clk_base + PLLD_BASE, 25, 1, 0, &pll_d_lock);
    clks[TEGRA114_CLK_DSIA_MUX] = clk;
// dsib mux
    clk = clk_register_mux(core::ptr::null_mut(), "dsib_mux", mux_plld_out0_plld2_out0,
    ARRAY_SIZE(mux_plld_out0_plld2_out0),
    CLK_SET_RATE_NO_REPARENT,
...
#[no_mangle]
unsafe extern "C" fn tegra114_wait_cpu_in_reset(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra114_disable_cpu_clock(cpu: u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra114_cpu_clock_suspend() {
...
#[no_mangle]
unsafe extern "C" fn tegra114_cpu_clock_resume() {
...
#[no_mangle]
unsafe extern "C" fn tegra114_clock_apply_init_table() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn tegra114_car_barrier() {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra114_clock_tune_cpu_trimmers_high() {
...
//
#[no_mangle]
pub unsafe extern "C" fn tegra114_clock_tune_cpu_trimmers_low() {
...
#[no_mangle]
pub unsafe extern "C" fn tegra114_clock_tune_cpu_trimmers_init() {
    void tegra114_clock_tune_cpu_trimmers_init(void)
    {
    let mut dr: u32 = 0, r = 0;
...
//
#[no_mangle]
unsafe extern "C" fn tegra114_clock_assert_dfll_dvco_reset() {
...
//
#[no_mangle]
unsafe extern "C" fn tegra114_clock_deassert_dfll_dvco_reset() {
...
#[no_mangle]
unsafe extern "C" fn tegra114_reset_assert(id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra114_reset_deassert(id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra114_clock_init(np: *mut device_node) -> void __init {
