...
//! Source: drivers/clk/tegra/clk-bpmp.c
#![no_std]
...
pub const TEGRA_BPMP_DUMP_CLOCK_INFO: c_int = 0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_bpmp_clk_info {
    pub id: c_uint,
    pub name: [c_char; MRQ_CLK_NAME_MAXLEN],
    pub parents: [c_uint; MRQ_CLK_MAX_PARENTS],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_bpmp_clk {
    pub hw: clk_hw,
    pub bpmp: *mut tegra_bpmp,
    pub id: c_uint,
    pub num_parents: c_uint,
    pub parents: *mut c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_bpmp_clk_message {
    pub cmd: c_uint,
    pub id: c_uint,
    struct {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_clk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_clk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_clk_is_prepared(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_clk_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_clk_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_clk_get_max_id(bpmp: *mut tegra_bpmp) -> c_int {
...
// already registered
    ...
    let mut p_id: c_uint = info.parents[j];
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_unregister_clocks(bpmp: *mut tegra_bpmp) {
    ...
    void *data)
    {
    let mut id: c_uint = clkspec.args[0], i;
...
#[no_mangle]
pub unsafe extern "C" fn tegra_bpmp_init_clocks(bpmp: *mut tegra_bpmp) -> c_int {
