...
//! Source: drivers/clk/clk-hsdk-pll.c
#![no_std]
...
pub const CGU_PLL_CTRL: c_uint = 0x000 /* ARC PLL control register */;
pub const CGU_PLL_STATUS: c_uint = 0x004 /* ARC PLL status register */;
pub const CGU_PLL_FMEAS: c_uint = 0x008 /* ARC PLL frequency measurement register */;
pub const CGU_PLL_MON: c_uint = 0x00C /* ARC PLL monitor register */;
pub const CGU_PLL_CTRL_ODIV_SHIFT: c_int = 2;
pub const CGU_PLL_CTRL_IDIV_SHIFT: c_int = 4;
pub const CGU_PLL_CTRL_FBDIV_SHIFT: c_int = 9;
pub const CGU_PLL_CTRL_BAND_SHIFT: c_int = 20;

pub const CGU_PLL_SOURCE_MAX: c_int = 1;
pub const CORE_IF_CLK_THRESHOLD_HZ: c_int = 500000000;
pub const CREG_CORE_IF_CLK_DIV_1: c_uint = 0x0;
pub const CREG_CORE_IF_CLK_DIV_2: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hsdk_pll_cfg {
    pub rate: u32,
    pub idiv: u32,
    pub fbdiv: u32,
    pub odiv: u32,
...
pub struct hsdk_pll_clk {
    ...
    pub spec_regs: *mut void __iomem,
...
#[no_mangle]
pub unsafe extern "C" fn hsdk_pll_write(clk: *mut hsdk_pll_clk, reg: u32, val: u32) {
    static inline void hsdk_pll_write(struct hsdk_pll_clk *clk, u32 reg, u32 val)
    {
    iowrite32(val, clk.regs + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn hsdk_pll_read(clk: *mut hsdk_pll_clk, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn hsdk_pll_is_locked(clk: *mut hsdk_pll_clk) -> bool {
    static inline bool hsdk_pll_is_locked(struct hsdk_pll_clk *clk)
    {
    return !!(hsdk_pll_read(clk, CGU_PLL_STATUS) & CGU_PLL_STATUS_LOCK);
    }
#[no_mangle]
pub unsafe extern "C" fn hsdk_pll_is_err(clk: *mut hsdk_pll_clk) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hsdk_pll_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_hsdk_pll_clk_setup(node: *mut device_node) -> void __init {
    ...
    ret = clk_hw_register(core::ptr::null_mut(), &pll_clk.hw);
    if (ret) {
