...
//! Source: drivers/clk/clk-fractional-divider_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn clk_fd_test_approximation_max_denominator(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_fd_test_approximation_max_numerator(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_fd_test_approximation_max_denominator_zero_based(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_fd_test_approximation_max_numerator_zero_based(test: *mut kunit) {
