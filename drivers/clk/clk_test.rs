...
// Needed for clk_hw_get_clk()
    ...
    let mut empty_clk_ops: static struct clk_ops = { };
...
#[no_mangle]
unsafe extern "C" fn clk_dummy_single_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_dummy_single_get_parent(hw: *mut clk_hw) -> u8 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_multiple_parent_ctx {
    pub parents_ctx: [clk_dummy_context; 2],
    pub hw: clk_hw,
    pub current_parent: u8,
}

#[no_mangle]
unsafe extern "C" fn clk_multiple_parents_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_multiple_parents_mux_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_test_init_with_ops(test: *mut kunit, ops: *const clk_ops) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn clk_test_get_rate(test: *mut kunit) {
    static void clk_test_get_rate(struct kunit *test)
    {
    struct clk_dummy_context *ctx = test.priv;
    struct clk_hw *hw = &ctx.hw;
    struct clk *clk = clk_hw_get_clk(hw, core::ptr::null_mut());
    unsigned long rate;
...
//
#[no_mangle]
unsafe extern "C" fn clk_test_set_get_rate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_test_set_set_get_rate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_test_round_set_get_rate(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn clk_uncached_test_init(test: *mut kunit) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn clk_test_uncached_get_rate(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_test_uncached_set_range(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_test_uncached_updated_rate_set_range(test: *mut kunit) {
...
//
    ...
    ret = clk_hw_register_kunit(test, core::ptr::null_mut(), &ctx.parents_ctx[0].hw);
    if (ret)
    return ret;
    ...
    ret = clk_hw_register_kunit(test, core::ptr::null_mut(), &ctx.parents_ctx[1].hw);
    if (ret)
    return ret;
    ...
    CLK_SET_RATE_PARENT);
    ret = clk_hw_register_kunit(test, core::ptr::null_mut(), &ctx.hw);
    if (ret)
    return ret;
    return 0;
    }
...
//
    ...
    struct clk_hw *hw = &ctx.hw;
    struct clk *clk = clk_hw_get_clk(hw, core::ptr::null_mut());
    struct clk *parent = clk_hw_get_clk(&ctx.parents_ctx[0].hw, core::ptr::null_mut());
...
//
    ...
    struct clk *clk = clk_hw_get_clk(hw, core::ptr::null_mut());
    struct clk *parent;
    parent = clk_hw_get_clk(&ctx.parents_ctx[0].hw, core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, clk_has_parent(clk, parent));
    clk_put(parent);
    parent = clk_hw_get_clk(&ctx.parents_ctx[1].hw, core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, clk_has_parent(clk, parent));
    clk_put(parent);
    clk_put(clk);
    }
...
//
    ...
    struct clk_multiple_parent_ctx *ctx = test.priv;
    struct clk_hw *hw = &ctx.hw;
    struct clk *clk = clk_hw_get_clk_kunit(test, hw, core::ptr::null_mut());
    struct clk *parent1, *parent2;
    unsigned long rate;
    int ret;
    kunit_skip(test, "This needs to be fixed in the core.");
    parent1 = clk_hw_get_clk_kunit(test, &ctx.parents_ctx[0].hw, core::ptr::null_mut());
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, parent1);
    KUNIT_ASSERT_TRUE(test, clk_is_match(clk_get_parent(clk), parent1));
    parent2 = clk_hw_get_clk_kunit(test, &ctx.parents_ctx[1].hw, core::ptr::null_mut());
...
//
    ...
    struct clk_hw *hw = &ctx.hw;
    struct clk *clk = clk_hw_get_clk(hw, core::ptr::null_mut());
    KUNIT_EXPECT_PTR_EQ(test, clk_get_parent(clk), core::ptr::null_mut());
    clk_put(clk);
    }
//
...
//
    ...
    parent = clk_hw_get_clk(&ctx.parents_ctx[1].hw, core::ptr::null_mut());
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, parent);
    clk = clk_hw_get_clk(&ctx.hw, core::ptr::null_mut());
...
//
    ...
    parent = clk_hw_get_clk_kunit(test, &ctx.parents_ctx[1].hw, core::ptr::null_mut());
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, parent);
    ret = clk_set_parent(clk, parent);
    KUNIT_ASSERT_EQ(test, ret, 0);
    rate = clk_get_rate(clk);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_single_parent_ctx {
    pub parent_ctx: clk_dummy_context,
    pub hw: clk_hw,
}

#[no_mangle]
unsafe extern "C" fn clk_single_parent_mux_test_init(test: *mut kunit) -> c_int {
    ...
    &clk_dummy_rate_ops,
    0);
    ret = clk_hw_register_kunit(test, core::ptr::null_mut(), &ctx.parent_ctx.hw);
    if (ret)
    return ret;
...
//
    ...
    struct clk_hw *hw = &ctx.hw;
    struct clk *clk = clk_hw_get_clk(hw, core::ptr::null_mut());
    struct clk *parent = clk_hw_get_clk(&ctx.parent_ctx.hw, core::ptr::null_mut());
    KUNIT_EXPECT_TRUE(test, clk_is_match(clk_get_parent(clk), parent));
    clk_put(parent);
    clk_put(clk);
    }
...
//
    ...
    KUNIT_ASSERT_PTR_NE(test, parent, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn clk_orphan_transparent_single_parent_mux_test_init(test: *mut kunit) -> c_int {
    ...
    ctx.parent_ctx.rate = DUMMY_CLOCK_INIT_RATE;
    ret = clk_hw_register(core::ptr::null_mut(), &ctx.parent_ctx.hw);
    if (ret)
    return ret;
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn clk_test_orphan_transparent_parent_mux_set_range(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_single_parent_two_lvl_ctx {
    pub parent_parent_ctx: clk_dummy_context,
    pub parent_ctx: clk_dummy_context,
    pub hw: clk_hw,
}
    ...
    &clk_dummy_rate_ops,
    0);
    ret = clk_hw_register(core::ptr::null_mut(), &ctx.parent_parent_ctx.hw);
    if (ret)
    return ret;
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_invalid(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_multiple_disjoints_range(test: *mut kunit) {
    static void clk_range_test_multiple_disjoints_range(struct kunit *test)
    {
    struct clk_dummy_context *ctx = test.priv;
    struct clk_hw *hw = &ctx.hw;
    struct clk *user1, *user2;
    user1 = clk_hw_get_clk(hw, core::ptr::null_mut());
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, user1);
    user2 = clk_hw_get_clk(hw, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_round_rate_lower(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_set_rate_lower(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_set_round_rate_consistent_lower(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_round_rate_higher(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_set_rate_higher(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_set_round_rate_consistent_higher(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_get_rate_raised(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_get_rate_lowered(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_rate_maximized(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_multiple_set_range_rate_maximized(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_multiple_set_range_rate_put_maximized(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_set_range_rate_minimized(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_multiple_set_range_rate_minimized(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_range_test_multiple_set_range_rate_put_minimized(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_leaf_mux_ctx {
    pub mux_ctx: clk_multiple_parent_ctx,
    pub hw: clk_hw,
    pub parent: clk_hw,
    pub req: *mut clk_rate_request,
    pub req): *mut *mut *mut int (determine_rate_func)(struct clk_hw hw, struct clk_rate_request,
}

#[no_mangle]
unsafe extern "C" fn clk_leaf_mux_determine_rate(hw: *mut clk_hw, req: *mut clk_rate_request) -> c_int {
    ...
    ret = clk_hw_register(core::ptr::null_mut(), &ctx.mux_ctx.parents_ctx[0].hw);
    if (ret)
    return ret;
    ...
    ret = clk_hw_register(core::ptr::null_mut(), &ctx.mux_ctx.parents_ctx[1].hw);
    if (ret)
    return ret;
    ...
    &clk_multiple_parents_mux_ops,
    0);
    ret = clk_hw_register(core::ptr::null_mut(), &ctx.mux_ctx.hw);
    if (ret)
    return ret;
    ctx.parent.init = CLK_HW_INIT_HW("test-parent", &ctx.mux_ctx.hw,
    &empty_clk_ops, CLK_SET_RATE_PARENT);
    ret = clk_hw_register(core::ptr::null_mut(), &ctx.parent);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn clk_leaf_mux_set_rate_parent_test_exit(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_leaf_mux_set_rate_parent_determine_rate_test_case {
...
//
#[no_mangle]
unsafe extern "C" fn clk_leaf_mux_set_rate_parent_determine_rate_test(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_mux_notifier_rate_change {
    pub done: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_mux_notifier_ctx {
    pub mux_ctx: clk_multiple_parent_ctx,
    pub clk: *mut clk,
    pub clk_nb: notifier_block,
    pub pre_rate_change: clk_mux_notifier_rate_change,
    pub post_rate_change: clk_mux_notifier_rate_change,
}

pub const NOTIFIER_TIMEOUT_MS: c_int = 100;
...
#[no_mangle]
unsafe extern "C" fn clk_mux_notifier_test_init(test: *mut kunit) -> c_int {
    ...
    if (ret)
    return ret;
    ctx.clk = clk_hw_get_clk(&ctx.mux_ctx.hw, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn clk_mux_notifier_test_exit(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_mux_notifier_set_parent_test(test: *mut kunit) {
    static void clk_mux_notifier_set_parent_test(struct kunit *test)
    {
    struct clk_mux_notifier_ctx *ctx = test.priv;
    struct clk_hw *hw = &ctx.mux_ctx.hw;
    struct clk *clk = clk_hw_get_clk(hw, core::ptr::null_mut());
    struct clk *new_parent = clk_hw_get_clk(&ctx.mux_ctx.parents_ctx[1].hw, core::ptr::null_mut());
    int ret;
...
//
    ...
    0);
    ctx.parents_ctx[0].rate = DUMMY_CLOCK_RATE_1;
    ret = clk_hw_register(core::ptr::null_mut(), &ctx.parents_ctx[0].hw);
    if (ret)
    return ret;
    ctx.parents_ctx[1].hw.init = CLK_HW_INIT_NO_PARENT("parent-1",
    &clk_dummy_rate_ops,
    0);
    ctx.parents_ctx[1].rate = DUMMY_CLOCK_RATE_2;
    ret = clk_hw_register(core::ptr::null_mut(), &ctx.parents_ctx[1].hw);
    if (ret)
    return ret;
    ctx.current_parent = 0;
    ctx.hw.init = CLK_HW_INIT_PARENTS("test-mux", parents,
...
//
#[no_mangle]
unsafe extern "C" fn clk_mux_no_reparent_round_rate(test: *mut kunit) {
    ...
    parent_rate = clk_get_rate(parent);
    KUNIT_ASSERT_GT(test, parent_rate, 0);
    other_parent = clk_hw_get_clk(&ctx.parents_ctx[1].hw, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn clk_mux_no_reparent_set_rate(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_register_clk_parent_data_test_case {
    pub desc: *const c_char,
    pub pdata: clk_parent_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_register_clk_parent_data_of_ctx {
    pub np: *mut device_node,
    pub hw: clk_hw,
}

#[no_mangle]
unsafe extern "C" fn clk_register_clk_parent_data_of_test_init(test: *mut kunit) -> c_int {
    ...
    return -ENOMEM;
    test.priv = ctx;
    ctx.np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "test,clk-parent-data");
    if (!ctx.np)
    return -ENODEV;
...
//
#[no_mangle]
unsafe extern "C" fn clk_register_clk_parent_data_of_test(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct platform_driver_dev_ctx {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn kunit_platform_driver_dev_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn clk_register_clk_parent_data_device_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_register_clk_parent_data_device_hw_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn clk_register_clk_parent_data_device_init(test: *mut kunit) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_assigned_rates_context {
    pub clk0: clk_dummy_context,
    pub clk1: clk_dummy_context,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_assigned_rates_test_param {
    pub desc: *const c_char,
    pub overlay_begin: *mut u8,
    pub overlay_end: *mut u8,
    pub rate0: c_ulong,
    pub rate1: c_ulong,
    pub sscs: clk_spread_spectrum,
...
//
#[no_mangle]
unsafe extern "C" fn clk_assigned_rates_test_init(test: *mut kunit) -> c_int {
    ...
    test.priv = ctx;
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test,
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "test,clk-assigned-rates"));
...
// Consumers are optional
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test,
    consumer = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "test,clk-consumer"));
...
#[no_mangle]
unsafe extern "C" fn clk_assigned_rates_assigns_one(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn clk_assigned_rates_assigns_multiple(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn clk_assigned_rates_skips(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn clk_assigned_sscs_assigns_one(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn clk_assigned_sscs_assigns_multiple(test: *mut kunit) {
...
//
    ...
    desc)
#[no_mangle]
unsafe extern "C" fn clk_assigned_sscs_skips(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_hw_register_dev_get_dev_returns_dev(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn clk_hw_register_dev_no_node_get_dev_returns_dev(test: *mut kunit) {
    ...
    KUNIT_ASSERT_EQ(test, 0, clk_hw_register_kunit(test, dev, hw));
    KUNIT_EXPECT_PTR_EQ(test, dev, clk_hw_get_dev(hw));
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(), clk_hw_get_of_node(hw));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn clk_hw_register_NULL_get_dev_of_node_returns_NULL(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, hw);
    hw.init = &clk_hw_get_dev_of_node_init_data;
    KUNIT_ASSERT_EQ(test, 0, clk_hw_register_kunit(test, core::ptr::null_mut(), hw));
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(), clk_hw_get_dev(hw));
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(), clk_hw_get_of_node(hw));
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn of_clk_hw_register_node_get_of_node_returns_node(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, hw);
    KUNIT_ASSERT_EQ(test, 0, of_overlay_apply_kunit(test, kunit_clk_hw_get_dev_of_node));
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "test,clk-hw-get-dev-of-node");
...
//
#[no_mangle]
unsafe extern "C" fn of_clk_hw_register_NULL_get_of_node_returns_NULL(test: *mut kunit) {
    ...
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, hw);
    hw.init = &clk_hw_get_dev_of_node_init_data;
    KUNIT_ASSERT_EQ(test, 0, of_clk_hw_register_kunit(test, core::ptr::null_mut(), hw));
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(), clk_hw_get_dev(hw));
    KUNIT_EXPECT_PTR_EQ(test, core::ptr::null_mut(), clk_hw_get_of_node(hw));
    }
