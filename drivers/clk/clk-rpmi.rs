...
pub const RPMI_CLK_DISCRETE_MAX_NUM_RATES: c_int = 16;
pub const RPMI_CLK_NAME_LEN: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_clk_context {
    pub dev: *mut device,
    pub chan: *mut mbox_chan,
    pub client: mbox_client,
    pub max_msg_data_size: u32,
}
...
#[derive(Copy, Clone)]
pub struct rpmi_clk {
    pub context: *mut rpmi_clk_context,
    pub id: u32,
    pub num_rates: u32,
    pub transition_latency: u32,
    pub type: enum rpmi_clk_type,
    pub rates: *mut union rpmi_clk_rates,
    pub name: [c_char; RPMI_CLK_NAME_LEN],
    pub hw: clk_hw,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_clk_rate_discrete {
    pub lo: __le32,
    pub hi: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_clk_rate_linear {
    pub min_lo: __le32,
    pub min_hi: __le32,
    pub max_lo: __le32,
    pub max_hi: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_get_num_clocks_rx {
    pub status: __le32,
    pub num_clocks: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_get_attrs_tx {
    pub clkid: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_get_attrs_rx {
    pub status: __le32,
    pub flags: __le32,
    pub num_rates: __le32,
    pub transition_latency: __le32,
    pub name: [c_char; RPMI_CLK_NAME_LEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_get_supp_rates_tx {
    pub clkid: __le32,
    pub clk_rate_idx: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_get_supp_rates_rx {
    pub status: __le32,
    pub flags: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_get_rate_tx {
    pub clkid: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_get_rate_rx {
    pub status: __le32,
    pub lo: __le32,
    pub hi: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_set_rate_rx {
    pub status: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_set_config_tx {
    pub clkid: __le32,
    pub config: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmi_set_config_rx {
    pub status: __le32,
}

#[no_mangle]
pub unsafe extern "C" fn rpmi_clkrate_u64(__hi: u32, __lo: u32) -> u64 {
    static inline u64 rpmi_clkrate_u64(u32 __hi, u32 __lo)
    {
    return (((u64)(__hi) << 32) | (u32)(__lo));
    }
#[no_mangle]
unsafe extern "C" fn rpmi_clk_get_num_clocks(context: *mut rpmi_clk_context) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rpmi_clk_get_attrs(clkid: u32, rpmi_clk: *mut rpmi_clk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmi_clk_get_supported_rates(clkid: u32, rpmi_clk: *mut rpmi_clk) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmi_clk_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmi_clk_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn rpmi_clk_mbox_chan_release(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rpmi_clk_probe(pdev: *mut platform_device) -> c_int {
    ...
    context.client.rx_callback	= core::ptr::null_mut();
