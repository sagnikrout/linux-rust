...
//! Source: drivers/clk/sophgo/clk-sg2042-rpgate.c
#![no_std]
...
pub const R_SYSGATE_BEGIN: c_uint = 0x0368;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2042_rpgate_clock {
    pub hw: clk_hw,
    pub id: c_uint,
...
#[no_mangle]
unsafe extern "C" fn sg2042_rpgate_probe(pdev: *mut platform_device) -> c_int {
