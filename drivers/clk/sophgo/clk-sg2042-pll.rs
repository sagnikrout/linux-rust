...
//! Source: drivers/clk/sophgo/clk-sg2042-pll.c
#![no_std]
...
// protect register access
    ...
    pub offset_ctrl: u32,
    pub shift_status_lock: u8,
    pub shift_status_updating: u8,
    pub shift_enable: u8,
}

pub const REFDIV_MIN: c_int = 1;
pub const REFDIV_MAX: c_int = 63;
pub const FBDIV_MIN: c_int = 16;
pub const FBDIV_MAX: c_int = 320;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2042_pll_ctrl {
    pub freq: c_ulong,
    pub fbdiv: c_uint,
    pub postdiv1: c_uint,
    pub postdiv2: c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn sg2042_pll_ctrl_encode(ctrl: *mut sg2042_pll_ctrl) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sg2042_pll_enable(pll: *mut sg2042_pll_clock, en: bool) {
...
pub const POSTDIV_RESULT_INDEX: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn sg2042_pll_probe(pdev: *mut platform_device) -> c_int {
