...
//! Source: drivers/clk/sophgo/clk-sg2044.c
#![no_std]
...
pub const DIV_ASSERT_TIME: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2044_div_internal {
    pub offset: u32,
    pub initval: u32,
    pub shift: u8,
    pub width: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2044_mux_internal {
    pub table: *const u32,
    pub offset: u32,
    pub shift: u16,
    pub flags: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2044_gate_internal {
    pub offset: u32,
    pub shift: u16,
    pub flags: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2044_div {
    pub common: sg2044_clk_common,
    pub div: sg2044_div_internal,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2044_mux {
    pub common: sg2044_clk_common,
    pub mux: sg2044_mux_internal,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2044_gate {
    pub common: sg2044_clk_common,
    pub gate: sg2044_gate_internal,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2044_clk_ctrl {
    pub lock: spinlock_t,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sg2044_clk_desc_data {
    pub pll: *const *const sg2044_clk_common,
    pub div: *const *const sg2044_clk_common,
    pub mux: *const *const sg2044_clk_common,
    pub gate: *const *const sg2044_clk_common,
    pub num_pll: u16,
    pub num_div: u16,
    pub num_mux: u16,
    pub num_gate: u16,
...
#[no_mangle]
unsafe extern "C" fn sg2044_div_get_reg_div(reg: u32, div: *mut sg2044_div_internal) -> u32 {
    ...
    {
    let mut reg: u32 = readl(common.base + div.offset);
    let mut val: u32 = sg2044_div_get_reg_div(reg, div);
    return divider_recalc_rate(&common.hw, parent_rate, val, core::ptr::null_mut(),
    div.flags, div.width);
    }
    ...
    let mut reg: u32 = readl(common.base + div.offset);
    let mut val: u32 = sg2044_div_get_reg_div(reg, div);
    return divider_ro_determine_rate(&common.hw, req, core::ptr::null_mut(),
    div.width, div.flags,
    val);
    }
    return divider_determine_rate(&common.hw, req, core::ptr::null_mut(),
    div.width, div.flags);
    }
...
#[no_mangle]
unsafe extern "C" fn sg2044_div_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sg2044_div_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn sg2044_div_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sg2044_clk_probe(pdev: *mut platform_device) -> c_int {
