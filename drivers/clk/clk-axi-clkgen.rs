...
//! Source: drivers/clk/clk-axi-clkgen.c
#![no_std]
...
pub const AXI_CLKGEN_V2_REG_RESET: c_uint = 0x40;
pub const AXI_CLKGEN_V2_REG_CLKSEL: c_uint = 0x44;
pub const AXI_CLKGEN_V2_REG_DRP_CNTRL: c_uint = 0x70;
pub const AXI_CLKGEN_V2_REG_DRP_STATUS: c_uint = 0x74;

pub const ADI_CLKGEN_REG_FPGA_VOLTAGE: c_uint = 0x0140;

pub const MMCM_REG_CLKOUT5_2: c_uint = 0x07;
pub const MMCM_REG_CLKOUT0_1: c_uint = 0x08;
pub const MMCM_REG_CLKOUT0_2: c_uint = 0x09;
pub const MMCM_REG_CLKOUT6_2: c_uint = 0x13;
pub const MMCM_REG_CLK_FB1: c_uint = 0x14;
pub const MMCM_REG_CLK_FB2: c_uint = 0x15;
pub const MMCM_REG_CLK_DIV: c_uint = 0x16;
pub const MMCM_REG_LOCK1: c_uint = 0x18;
pub const MMCM_REG_LOCK2: c_uint = 0x19;
pub const MMCM_REG_LOCK3: c_uint = 0x1a;
pub const MMCM_REG_POWER: c_uint = 0x28;
pub const MMCM_REG_FILTER1: c_uint = 0x4e;
pub const MMCM_REG_FILTER2: c_uint = 0x4f;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_clkgen_limits {
    pub fpfd_min: c_uint,
    pub fpfd_max: c_uint,
    pub fvco_min: c_uint,
    pub fvco_max: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_clkgen {
    pub base: *mut void __iomem,
    pub clk_hw: clk_hw,
    pub limits: axi_clkgen_limits,
}

#[no_mangle]
unsafe extern "C" fn axi_clkgen_lookup_filter(m: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn axi_clkgen_lookup_lock(m: c_uint) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axi_clkgen_div_params {
    pub low: c_uint,
    pub high: c_uint,
    pub edge: c_uint,
    pub nocount: c_uint,
    pub frac_en: c_uint,
    pub frac: c_uint,
    pub frac_wf_f: c_uint,
    pub frac_wf_r: c_uint,
    pub frac_phase: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn axi_clkgen_wait_non_busy(axi_clkgen: *mut axi_clkgen) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_clkgen_mmcm_enable(axi_clkgen: *mut axi_clkgen, enable: bool) {
    static void axi_clkgen_mmcm_enable(struct axi_clkgen *axi_clkgen, bool enable)
    {
    let mut val: c_uint = AXI_CLKGEN_V2_RESET_ENABLE;
    if (enable)
    ...
    struct axi_clkgen_div_params params;
    let mut power: u32 = 0, filter, lock;
...
#[no_mangle]
unsafe extern "C" fn axi_clkgen_enable(clk_hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_clkgen_disable(clk_hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn axi_clkgen_set_parent(clk_hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axi_clkgen_get_parent(clk_hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn axi_clkgen_probe(pdev: *mut platform_device) -> c_int {
