...
//! Source: drivers/clk/rockchip/clk-px30.c
#![no_std]
...
pub const PX30_GRF_SOC_STATUS0: c_uint = 0x480;
    enum px30_plls {
...
pub const PX30_DIV_ACLKM_MASK: c_uint = 0x7;
pub const PX30_DIV_ACLKM_SHIFT: c_int = 12;
pub const PX30_DIV_PCLK_DBG_MASK: c_uint = 0xf;
pub const PX30_DIV_PCLK_DBG_SHIFT: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn px30_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn px30_pmu_clk_init(np: *mut device_node) -> void __init {
