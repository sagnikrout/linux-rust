...
//! Source: drivers/clk/rockchip/clk-rk3528.c
#![no_std]
...
pub const RK3528_GRF_SOC_STATUS0: c_uint = 0x1a0;
    enum rk3528_plls {
...
pub const RK3528_DIV_ACLK_M_CORE_MASK: c_uint = 0x1f;
pub const RK3528_DIV_ACLK_M_CORE_SHIFT: c_int = 11;
pub const RK3528_DIV_PCLK_DBG_MASK: c_uint = 0x1f;
pub const RK3528_DIV_PCLK_DBG_SHIFT: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn clk_rk3528_probe(pdev: *mut platform_device) -> int __init {
    static int __init clk_rk3528_probe(struct platform_device *pdev)
    {
    let mut nr_vpu_branches: c_ulong = ARRAY_SIZE(rk3528_vpu_clk_branches);
    let mut nr_vo_branches: c_ulong = ARRAY_SIZE(rk3528_vo_clk_branches);
    let mut nr_branches: c_ulong = ARRAY_SIZE(rk3528_clk_branches);
    ...
    rockchip_register_restart_notifier(ctx, RK3528_GLB_SRST_FST, core::ptr::null_mut());
