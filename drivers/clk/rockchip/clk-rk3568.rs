...
//! Source: drivers/clk/rockchip/clk-rk3568.c
#![no_std]
...
pub const RK3568_GRF_SOC_STATUS0: c_uint = 0x580;
...
pub const RK3568_DIV_ATCLK_CORE_MASK: c_uint = 0x1f;
pub const RK3568_DIV_ATCLK_CORE_SHIFT: c_int = 0;
pub const RK3568_DIV_GICCLK_CORE_MASK: c_uint = 0x1f;
pub const RK3568_DIV_GICCLK_CORE_SHIFT: c_int = 8;
pub const RK3568_DIV_PCLK_CORE_MASK: c_uint = 0x1f;
pub const RK3568_DIV_PCLK_CORE_SHIFT: c_int = 0;
pub const RK3568_DIV_PERIPHCLK_CORE_MASK: c_uint = 0x1f;
pub const RK3568_DIV_PERIPHCLK_CORE_SHIFT: c_int = 8;
pub const RK3568_DIV_ACLK_CORE_MASK: c_uint = 0x1f;
pub const RK3568_DIV_ACLK_CORE_SHIFT: c_int = 8;
pub const RK3568_DIV_SCLK_CORE_MASK: c_uint = 0xf;
pub const RK3568_DIV_SCLK_CORE_SHIFT: c_int = 0;
pub const RK3568_MUX_SCLK_CORE_MASK: c_uint = 0x3;
pub const RK3568_MUX_SCLK_CORE_SHIFT: c_int = 8;
pub const RK3568_MUX_SCLK_CORE_NPLL_MASK: c_uint = 0x1;
pub const RK3568_MUX_SCLK_CORE_NPLL_SHIFT: c_int = 15;
pub const RK3568_MUX_CLK_CORE_APLL_MASK: c_uint = 0x1;
pub const RK3568_MUX_CLK_CORE_APLL_SHIFT: c_int = 7;
pub const RK3568_MUX_CLK_PVTPLL_MASK: c_uint = 0x1;
pub const RK3568_MUX_CLK_PVTPLL_SHIFT: c_int = 15;
    ...
    0, RK3568_PLL_CON(8),
    RK3568_MODE_CON0, 2, 1, 0, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn rk3568_pmu_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rk3568_clk_init(np: *mut device_node) -> void __init {
    ...
    ROCKCHIP_SOFTRST_HIWORD_MASK);
    rockchip_register_restart_notifier(ctx, RK3568_GLB_SRST_FST, core::ptr::null_mut());
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_rk3568_inits {
    pub np): *mut *mut void (inits)(struct device_node,
}
...
#[no_mangle]
unsafe extern "C" fn clk_rk3568_probe(pdev: *mut platform_device) -> int __init {
