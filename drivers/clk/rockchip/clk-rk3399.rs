...
//! Source: drivers/clk/rockchip/clk-rk3399.c
#![no_std]
...
// PMU CRU parents
    ...
    RK3399_PLL_CON(19), 8, 31, 0, core::ptr::null_mut()),
...
pub const RK3399_DIV_ACLKM_MASK: c_uint = 0x1f;
pub const RK3399_DIV_ACLKM_SHIFT: c_int = 8;
pub const RK3399_DIV_ATCLK_MASK: c_uint = 0x1f;
pub const RK3399_DIV_ATCLK_SHIFT: c_int = 0;
pub const RK3399_DIV_PCLK_DBG_MASK: c_uint = 0x1f;
pub const RK3399_DIV_PCLK_DBG_SHIFT: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn rk3399_clk_init(np: *mut device_node) -> void __init {
    ...
    rockchip_register_restart_notifier(ctx, RK3399_GLB_SRST_FST, core::ptr::null_mut());
    rockchip_clk_of_add_provider(np, ctx);
    }
    CLK_OF_DECLARE(rk3399_cru, "rockchip,rk3399-cru", rk3399_clk_init);
#[no_mangle]
unsafe extern "C" fn rk3399_pmu_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clk_rk3399_probe(pdev: *mut platform_device) -> int __init {
