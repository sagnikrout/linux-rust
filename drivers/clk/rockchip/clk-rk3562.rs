...
//! Source: drivers/clk/rockchip/clk-rk3562.c
#![no_std]
...
pub const RK3562_GRF_SOC_STATUS0: c_uint = 0x430;
...
// _mhz, _refdiv, _fbdiv, _postdiv1, _postdiv2, _dsmpd, _frac
    ...
    RK3562_SUBDDR_MODE_CON, 0, 1, 0, core::ptr::null_mut()),
    };
...
#[no_mangle]
unsafe extern "C" fn rk3562_clk_init(np: *mut device_node) -> void __init {
    ...
    rockchip_register_restart_notifier(ctx, RK3562_GLB_SRST_FST, core::ptr::null_mut());
    rockchip_clk_of_add_provider(np, ctx);
    }
    CLK_OF_DECLARE(rk3562_cru, "rockchip,rk3562-cru", rk3562_clk_init);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct clk_rk3562_inits {
...
#[no_mangle]
unsafe extern "C" fn clk_rk3562_probe(pdev: *mut platform_device) -> c_int {
