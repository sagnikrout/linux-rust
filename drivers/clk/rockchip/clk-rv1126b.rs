...
//! Source: drivers/clk/rockchip/clk-rv1126b.c
#![no_std]
...
pub const RV1126B_FRAC_MAX_PRATE: c_int = 1200000000;
...
pub const RV1126B_DIV_ACLK_CORE_MASK: c_uint = 0x1f;
pub const RV1126B_DIV_ACLK_CORE_SHIFT: c_int = 0;
pub const RV1126B_DIV_PCLK_CORE_MASK: c_uint = 0x1f;
pub const RV1126B_DIV_PCLK_CORE_SHIFT: c_int = 8;
pub const RV1126B_CORE_SEL_MASK: c_uint = 0x1;
pub const RV1126B_CORE_SEL_SHIFT: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn rv1126b_clk_init(np: *mut device_node) -> void __init {
    ...
    rockchip_register_restart_notifier(ctx, RV1126B_GLB_SRST_FST, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn clk_rv1126b_probe(pdev: *mut platform_device) -> c_int {
