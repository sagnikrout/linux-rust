...
//! Source: drivers/clk/rockchip/clk-rk3228.c
#![no_std]
...
pub const RK3228_GRF_SOC_STATUS0: c_uint = 0x480;
    enum rk3228_plls {
    apll, dpll, cpll, gpll,
    };
...
pub const RK3228_DIV_CPU_MASK: c_uint = 0x1f;
pub const RK3228_DIV_CPU_SHIFT: c_int = 8;
pub const RK3228_DIV_PERI_MASK: c_uint = 0xf;
pub const RK3228_DIV_PERI_SHIFT: c_int = 0;
pub const RK3228_DIV_ACLK_MASK: c_uint = 0x7;
pub const RK3228_DIV_ACLK_SHIFT: c_int = 4;
pub const RK3228_DIV_HCLK_MASK: c_uint = 0x3;
pub const RK3228_DIV_HCLK_SHIFT: c_int = 8;
pub const RK3228_DIV_PCLK_MASK: c_uint = 0x7;
pub const RK3228_DIV_PCLK_SHIFT: c_int = 12;
    ...
    RK2928_MODE_CON, 4, 6, 0, core::ptr::null_mut()),
    [cpll] = PLL(pll_rk3036, PLL_CPLL, "cpll", mux_pll_p, 0, RK2928_PLL_CON(6),
    RK2928_MODE_CON, 8, 8, 0, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn rk3228_clk_init(np: *mut device_node) -> void __init {
    ...
    rockchip_register_restart_notifier(ctx, RK3228_GLB_SRST_FST, core::ptr::null_mut());
