...
//! Source: drivers/clk/rockchip/clk-rk3036.c
#![no_std]
...
pub const RK3036_GRF_SOC_STATUS0: c_uint = 0x14c;
    enum rk3036_plls {
    apll, dpll, gpll,
    };
...
pub const RK3036_DIV_CPU_MASK: c_uint = 0x1f;
pub const RK3036_DIV_CPU_SHIFT: c_int = 8;
pub const RK3036_DIV_PERI_MASK: c_uint = 0xf;
pub const RK3036_DIV_PERI_SHIFT: c_int = 0;
pub const RK3036_DIV_ACLK_MASK: c_uint = 0x7;
pub const RK3036_DIV_ACLK_SHIFT: c_int = 4;
pub const RK3036_DIV_HCLK_MASK: c_uint = 0x3;
pub const RK3036_DIV_HCLK_SHIFT: c_int = 8;
pub const RK3036_DIV_PCLK_MASK: c_uint = 0x7;
pub const RK3036_DIV_PCLK_SHIFT: c_int = 12;
...
#[no_mangle]
unsafe extern "C" fn rk3036_clk_init(np: *mut device_node) -> void __init {
