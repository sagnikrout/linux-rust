...
//! Source: drivers/clk/rockchip/clk-rk3588.c
#![no_std]
...
pub const RK3588_GRF_SOC_STATUS0: c_uint = 0x600;
pub const RK3588_PHYREF_ALT_GATE: c_uint = 0xc38;
    enum rk3588_plls {
...
pub const RK3588_CLK_CORE_B0_SEL_CLEAN_MASK: c_uint = 0x3;
pub const RK3588_CLK_CORE_B0_SEL_CLEAN_SHIFT: c_int = 13;
pub const RK3588_CLK_CORE_B1_SEL_CLEAN_MASK: c_uint = 0x3;
pub const RK3588_CLK_CORE_B1_SEL_CLEAN_SHIFT: c_int = 5;
pub const RK3588_CLK_CORE_B0_GPLL_DIV_MASK: c_uint = 0x1f;
pub const RK3588_CLK_CORE_B0_GPLL_DIV_SHIFT: c_int = 1;
pub const RK3588_CLK_CORE_L_SEL_CLEAN_MASK: c_uint = 0x3;
pub const RK3588_CLK_CORE_L1_SEL_CLEAN_SHIFT: c_int = 12;
pub const RK3588_CLK_CORE_L0_SEL_CLEAN_SHIFT: c_int = 5;
pub const RK3588_CLK_DSU_SEL_DF_MASK: c_uint = 0x1;
pub const RK3588_CLK_DSU_SEL_DF_SHIFT: c_int = 15;
pub const RK3588_CLK_DSU_DF_SRC_MASK: c_uint = 0x3;
pub const RK3588_CLK_DSU_DF_SRC_SHIFT: c_int = 12;
pub const RK3588_CLK_DSU_DF_DIV_MASK: c_uint = 0x1f;
pub const RK3588_CLK_DSU_DF_DIV_SHIFT: c_int = 7;
pub const RK3588_ACLKM_DSU_DIV_MASK: c_uint = 0x1f;
pub const RK3588_ACLKM_DSU_DIV_SHIFT: c_int = 1;
pub const RK3588_ACLKS_DSU_DIV_MASK: c_uint = 0x1f;
pub const RK3588_ACLKS_DSU_DIV_SHIFT: c_int = 6;
pub const RK3588_ACLKMP_DSU_DIV_MASK: c_uint = 0x1f;
pub const RK3588_ACLKMP_DSU_DIV_SHIFT: c_int = 11;
pub const RK3588_PERIPH_DSU_DIV_MASK: c_uint = 0x1f;
pub const RK3588_PERIPH_DSU_DIV_SHIFT: c_int = 0;
pub const RK3588_ATCLK_DSU_DIV_MASK: c_uint = 0x1f;
pub const RK3588_ATCLK_DSU_DIV_SHIFT: c_int = 0;
pub const RK3588_GICCLK_DSU_DIV_MASK: c_uint = 0x1f;
pub const RK3588_GICCLK_DSU_DIV_SHIFT: c_int = 5;
...
#[no_mangle]
unsafe extern "C" fn rk3588_clk_early_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clk_rk3588_probe(pdev: *mut platform_device) -> c_int {
    ...
    rockchip_register_restart_notifier(ctx, RK3588_GLB_SRST_FST, core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn rockchip_clk_rk3588_drv_register() -> int __init {
