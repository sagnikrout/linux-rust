...
//! Source: drivers/clk/rockchip/clk-rv1126.c
#![no_std]
...
pub const RV1126_GMAC_CON: c_uint = 0x460;
pub const RV1126_GRF_IOFUNC_CON1: c_uint = 0x10264;
pub const RV1126_GRF_SOC_STATUS0: c_uint = 0x10;
pub const RV1126_FRAC_MAX_PRATE: c_int = 1200000000;
pub const RV1126_CSIOUT_FRAC_MAX_PRATE: c_int = 300000000;
...
pub const RV1126_DIV_ACLK_CORE_MASK: c_uint = 0xf;
pub const RV1126_DIV_ACLK_CORE_SHIFT: c_int = 4;
pub const RV1126_DIV_PCLK_DBG_MASK: c_uint = 0x7;
pub const RV1126_DIV_PCLK_DBG_SHIFT: c_int = 0;
    ...
    0, RV1126_PLL_CON(8),
    RV1126_MODE_CON, 2, 1, 0, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn rv1126_pmu_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rv1126_clk_init(np: *mut device_node) -> void __init {
    ...
    ROCKCHIP_SOFTRST_HIWORD_MASK);
    rockchip_register_restart_notifier(ctx, RV1126_GLB_SRST_FST, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn clk_rv1126_probe(pdev: *mut platform_device) -> int __init {
