...
//! Source: drivers/clk/rockchip/clk-rv1106.c
#![no_std]
...
//
pub const RV1106_TOPCRU_BASE: c_uint = 0x10000;
pub const RV1106_PERICRU_BASE: c_uint = 0x12000;
pub const RV1106_VICRU_BASE: c_uint = 0x14000;
pub const RV1106_NPUCRU_BASE: c_uint = 0x16000;
pub const RV1106_CORECRU_BASE: c_uint = 0x18000;
pub const RV1106_VEPUCRU_BASE: c_uint = 0x1a000;
pub const RV1106_VOCRU_BASE: c_uint = 0x1c000;
pub const RV1106_DDRCRU_BASE: c_uint = 0x1e000;
pub const RV1106_SUBDDRCRU_BASE: c_uint = 0x1f000;

// Register offsets inside the GRF region for the MMC phase clocks
pub const RV1106_VI_GRF_BASE: c_uint = 0x50000;
pub const RV1106_VO_GRF_BASE: c_uint = 0x60000;
pub const RV1106_EMMC_CON0: c_uint = 0x20;
pub const RV1106_EMMC_CON1: c_uint = 0x24;

pub const CRU_PVTPLL0_CON0_L: c_uint = 0x11000;
pub const CRU_PVTPLL0_CON0_H: c_uint = 0x11004;
pub const CRU_PVTPLL0_CON1_L: c_uint = 0x11008;
pub const CRU_PVTPLL0_CON2_H: c_uint = 0x11014;
pub const CRU_PVTPLL1_CON0_L: c_uint = 0x11030;
pub const CRU_PVTPLL1_CON0_H: c_uint = 0x11034;
pub const CRU_PVTPLL1_CON1_L: c_uint = 0x11038;
pub const CRU_PVTPLL1_CON2_H: c_uint = 0x11044;
pub const RV1106_GRF_SOC_STATUS0: c_uint = 0x10;
pub const CPU_PVTPLL_CON0_L: c_uint = 0x40000;
pub const CPU_PVTPLL_CON0_H: c_uint = 0x40004;
pub const PVTPLL_RING_SEL_MASK: c_uint = 0x7;
pub const PVTPLL_RING_SEL_SHIFT: c_int = 8;
pub const PVTPLL_EN_MASK: c_uint = 0x3;
pub const PVTPLL_EN_SHIFT: c_int = 0;
pub const PVTPLL_LENGTH_SEL_MASK: c_uint = 0x7f;
pub const PVTPLL_LENGTH_SEL_SHIFT: c_int = 0;

pub const RV1106_FRAC_MAX_PRATE: c_int = 1200000000;
    enum rv1106_plls {
    apll, dpll, cpll, gpll,
    };
...
pub const RV1106_DIV_ACLK_CORE_MASK: c_uint = 0x1f;
pub const RV1106_DIV_ACLK_CORE_SHIFT: c_int = 7;
pub const RV1106_DIV_PCLK_DBG_MASK: c_uint = 0x1f;
pub const RV1106_DIV_PCLK_DBG_SHIFT: c_int = 0;
pub const RV1106_CORE_SEL_MASK: c_uint = 0x3;
pub const RV1106_CORE_SEL_SHIFT: c_int = 5;
    ...
    RV1106_SUBDDRMODE_CON, 0, 10, 0, core::ptr::null_mut()),
...
// PD _TOP
    ...
    COMPOSITE_FRACMUX(CLK_VICAP_M1_FRAC, "clk_vicap_m1_frac", "clk_vicap_m1_src", CLK_SET_RATE_PARENT,
...
#[no_mangle]
unsafe extern "C" fn rv1106_pvtpll_init(ctx: *mut rockchip_clk_provider) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn clk_rv1106_probe(pdev: *mut platform_device) -> int __init {
...
//
    ...
    rockchip_register_restart_notifier(ctx, RV1106_GLB_SRST_FST, core::ptr::null_mut());
