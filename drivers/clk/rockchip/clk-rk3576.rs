...
//! Source: drivers/clk/rockchip/clk-rk3576.c
#![no_std]
...
pub const RK3576_GRF_SOC_STATUS0: c_uint = 0x600;
pub const RK3576_PMU0_GRF_OSC_CON6: c_uint = 0x18;
pub const RK3576_VCCIO_IOC_MISC_CON0: c_uint = 0x6400;
    enum rk3576_plls {
...
pub const RK3576_ACLK_M_BIGCORE_DIV_MASK: c_uint = 0x1f;
pub const RK3576_ACLK_M_BIGCORE_DIV_SHIFT: c_int = 0;
pub const RK3576_ACLK_M_LITCORE_DIV_MASK: c_uint = 0x1f;
pub const RK3576_ACLK_M_LITCORE_DIV_SHIFT: c_int = 8;
pub const RK3576_PCLK_DBG_LITCORE_DIV_MASK: c_uint = 0x1f;
pub const RK3576_PCLK_DBG_LITCORE_DIV_SHIFT: c_int = 0;
pub const RK3576_ACLK_CCI_DIV_MASK: c_uint = 0x1f;
pub const RK3576_ACLK_CCI_DIV_SHIFT: c_int = 7;
pub const RK3576_ACLK_CCI_MUX_MASK: c_uint = 0x3;
pub const RK3576_ACLK_CCI_MUX_SHIFT: c_int = 12;
...
#[no_mangle]
unsafe extern "C" fn rk3576_clk_init(np: *mut device_node) -> void __init {
    ...
    rockchip_register_restart_notifier(ctx, RK3576_GLB_SRST_FST, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn clk_rk3576_probe(pdev: *mut platform_device) -> c_int {
