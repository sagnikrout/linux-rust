...
//! Source: drivers/clk/rockchip/clk-rk3328.c
#![no_std]
...
pub const RK3328_GRF_SOC_STATUS0: c_uint = 0x480;
pub const RK3328_GRF_MAC_CON1: c_uint = 0x904;
pub const RK3328_GRF_MAC_CON2: c_uint = 0x908;
    enum rk3328_plls {
...
pub const RK3328_DIV_ACLKM_MASK: c_uint = 0x7;
pub const RK3328_DIV_ACLKM_SHIFT: c_int = 4;
pub const RK3328_DIV_PCLK_DBG_MASK: c_uint = 0xf;
pub const RK3328_DIV_PCLK_DBG_SHIFT: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn rk3328_clk_init(np: *mut device_node) -> void __init {
