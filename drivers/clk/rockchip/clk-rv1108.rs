...
//! Source: drivers/clk/rockchip/clk-rv1108.c
#![no_std]
...
pub const RV1108_GRF_SOC_STATUS0: c_uint = 0x480;
    enum rv1108_plls {
    apll, dpll, gpll,
    };
...
pub const RV1108_DIV_CORE_MASK: c_uint = 0xf;
pub const RV1108_DIV_CORE_SHIFT: c_int = 4;
    ...
    RV1108_PLL_CON(11), 8, 1, 0, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn rv1108_clk_init(np: *mut device_node) -> void __init {
    ...
    rockchip_register_restart_notifier(ctx, RV1108_GLB_SRST_FST, core::ptr::null_mut());
