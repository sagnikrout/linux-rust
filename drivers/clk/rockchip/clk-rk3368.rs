...
//! Source: drivers/clk/rockchip/clk-rk3368.c
#![no_std]
...
pub const RK3368_GRF_SOC_STATUS0: c_uint = 0x480;
    enum rk3368_plls {
    ...
    RK3368_PLL_CON(11), 8, 2, 0, core::ptr::null_mut()),
...
pub const RK3368_DIV_ACLKM_MASK: c_uint = 0x1f;
pub const RK3368_DIV_ACLKM_SHIFT: c_int = 8;
pub const RK3368_DIV_ATCLK_MASK: c_uint = 0x1f;
pub const RK3368_DIV_ATCLK_SHIFT: c_int = 0;
pub const RK3368_DIV_PCLK_DBG_MASK: c_uint = 0x1f;
pub const RK3368_DIV_PCLK_DBG_SHIFT: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn rk3368_clk_init(np: *mut device_node) -> void __init {
    ...
    rockchip_register_restart_notifier(ctx, RK3368_GLB_SRST_FST, core::ptr::null_mut());
