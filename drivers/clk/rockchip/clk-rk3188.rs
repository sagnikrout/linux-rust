...
//! Source: drivers/clk/rockchip/clk-rk3188.c
#![no_std]
...
pub const RK3066_GRF_SOC_STATUS: c_uint = 0x15c;
pub const RK3188_GRF_SOC_STATUS: c_uint = 0xac;
    enum rk3188_plls {
    apll, cpll, dpll, gpll,
    };
...
pub const RK3066_DIV_CORE_PERIPH_MASK: c_uint = 0x3;
pub const RK3066_DIV_CORE_PERIPH_SHIFT: c_int = 6;
pub const RK3066_DIV_ACLK_CORE_MASK: c_uint = 0x7;
pub const RK3066_DIV_ACLK_CORE_SHIFT: c_int = 0;
pub const RK3066_DIV_ACLK_HCLK_MASK: c_uint = 0x3;
pub const RK3066_DIV_ACLK_HCLK_SHIFT: c_int = 8;
pub const RK3066_DIV_ACLK_PCLK_MASK: c_uint = 0x3;
pub const RK3066_DIV_ACLK_PCLK_SHIFT: c_int = 12;
pub const RK3066_DIV_AHB2APB_MASK: c_uint = 0x3;
pub const RK3066_DIV_AHB2APB_SHIFT: c_int = 14;
...
pub const RK3188_DIV_ACLK_CORE_MASK: c_uint = 0x7;
pub const RK3188_DIV_ACLK_CORE_SHIFT: c_int = 3;
    ...
    [dpll] = PLL(pll_rk3066, PLL_DPLL, "dpll", mux_pll_p, 0, RK2928_PLL_CON(4),
    RK2928_MODE_CON, 4, 5, 0, core::ptr::null_mut()),
    [cpll] = PLL(pll_rk3066, PLL_CPLL, "cpll", mux_pll_p, 0, RK2928_PLL_CON(8),
...
#[no_mangle]
unsafe extern "C" fn rk3066a_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rk3188a_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rk3188_clk_init(np: *mut device_node) -> void __init {
