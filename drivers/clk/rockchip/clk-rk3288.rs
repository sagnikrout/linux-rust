...
//! Source: drivers/clk/rockchip/clk-rk3288.c
#![no_std]
...
pub const RK3288_GRF_SOC_STATUS1: c_uint = 0x284;
    enum rk3288_variant {
    RK3288_CRU,
    RK3288W_CRU,
    };
...
pub const RK3288_DIV_ACLK_CORE_M0_MASK: c_uint = 0xf;
pub const RK3288_DIV_ACLK_CORE_M0_SHIFT: c_int = 0;
pub const RK3288_DIV_ACLK_CORE_MP_MASK: c_uint = 0xf;
pub const RK3288_DIV_ACLK_CORE_MP_SHIFT: c_int = 4;
pub const RK3288_DIV_L2RAM_MASK: c_uint = 0x7;
pub const RK3288_DIV_L2RAM_SHIFT: c_int = 0;
pub const RK3288_DIV_ATCLK_MASK: c_uint = 0x1f;
pub const RK3288_DIV_ATCLK_SHIFT: c_int = 4;
pub const RK3288_DIV_PCLK_DBGPRE_MASK: c_uint = 0x1f;
pub const RK3288_DIV_PCLK_DBGPRE_SHIFT: c_int = 9;
    ...
    RK3288_MODE_CON, 4, 5, 0, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn rk3288_clk_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3288_clk_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rk3288_clk_shutdown() {
...
#[no_mangle]
unsafe extern "C" fn rk3288_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rk3288w_clk_init(np: *mut device_node) -> void __init {
