...
//! Source: drivers/clk/rockchip/clk-rk3128.c
#![no_std]
...
pub const RK3128_GRF_SOC_STATUS0: c_uint = 0x14c;
    enum rk3128_plls {
    apll, dpll, cpll, gpll,
    };
...
pub const RK3128_DIV_CPU_MASK: c_uint = 0x1f;
pub const RK3128_DIV_CPU_SHIFT: c_int = 8;
pub const RK3128_DIV_PERI_MASK: c_uint = 0xf;
pub const RK3128_DIV_PERI_SHIFT: c_int = 0;
pub const RK3128_DIV_ACLK_MASK: c_uint = 0x7;
pub const RK3128_DIV_ACLK_SHIFT: c_int = 4;
pub const RK3128_DIV_HCLK_MASK: c_uint = 0x3;
pub const RK3128_DIV_HCLK_SHIFT: c_int = 8;
pub const RK3128_DIV_PCLK_MASK: c_uint = 0x7;
pub const RK3128_DIV_PCLK_SHIFT: c_int = 12;
    ...
    RK2928_MODE_CON, 4, 0, 0, core::ptr::null_mut()),
...
#[no_mangle]
unsafe extern "C" fn rk3126_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn rk3128_clk_init(np: *mut device_node) -> void __init {
