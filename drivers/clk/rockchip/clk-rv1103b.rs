...
//! Source: drivers/clk/rockchip/clk-rv1103b.c
#![no_std]
...
pub const RV1103B_GRF_SOC_STATUS0: c_uint = 0x10;
pub const RV1103B_FRAC_MAX_PRATE: c_int = 1200000000;
...
pub const RV1103B_DIV_ACLK_CORE_MASK: c_uint = 0x1f;
pub const RV1103B_DIV_ACLK_CORE_SHIFT: c_int = 0;
pub const RV1103B_DIV_PCLK_DBG_MASK: c_uint = 0x1f;
pub const RV1103B_DIV_PCLK_DBG_SHIFT: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn rv1103b_clk_init(np: *mut device_node) -> void __init {
