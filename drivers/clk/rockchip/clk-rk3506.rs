...
//! Source: drivers/clk/rockchip/clk-rk3506.c
#![no_std]
...
pub const RK3506_DIV_ACLK_CORE_MASK: c_uint = 0xf;
pub const RK3506_DIV_ACLK_CORE_SHIFT: c_int = 9;
pub const RK3506_DIV_PCLK_CORE_MASK: c_uint = 0xf;
pub const RK3506_DIV_PCLK_CORE_SHIFT: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn rk3506_clk_init(np: *mut device_node) -> void __init {
    ...
    rockchip_register_restart_notifier(ctx, RK3506_GLB_SRST_FST, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn clk_rk3506_probe(pdev: *mut platform_device) -> c_int {
