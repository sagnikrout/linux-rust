...
//! Source: drivers/clk/starfive/clk-starfive-jh7110-stg.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn jh7110_stgcrg_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut max: u32 = jh7110_stgclk_data[idx].max;
    ...
    let mut pidx: c_uint = jh7110_stgclk_data[idx].parents[i];
    if (pidx < JH7110_STGCLK_END)
    parents[i].hw = &priv.reg[pidx].hw;
#[no_mangle]
pub unsafe extern "C" fn if(JH7110_STGCLK_EXT_END: pidx <) -> else {
