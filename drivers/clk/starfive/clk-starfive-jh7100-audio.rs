...
//! Source: drivers/clk/starfive/clk-starfive-jh7100-audio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn jh7100_audclk_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut max: u32 = jh7100_audclk_data[idx].max;
    ...
    let mut pidx: c_uint = jh7100_audclk_data[idx].parents[i];
    if (pidx < JH7100_AUDCLK_END)
    parents[i].hw = &priv.reg[pidx].hw;
#[no_mangle]
pub unsafe extern "C" fn if(JH7100_AUDCLK_AUDIO_SRC: pidx ==) -> else {
    else if (pidx == JH7100_AUDCLK_AUDIO_SRC)
    parents[i].fw_name = "audio_src";
#[no_mangle]
pub unsafe extern "C" fn if(JH7100_AUDCLK_AUDIO_12288: pidx ==) -> else {
    else if (pidx == JH7100_AUDCLK_AUDIO_12288)
    parents[i].fw_name = "audio_12288";
#[no_mangle]
pub unsafe extern "C" fn if(JH7100_AUDCLK_DOM7AHB_BUS: pidx ==) -> else {
