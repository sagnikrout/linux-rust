...
//! Source: drivers/clk/clk-versaclock5.c
#![no_std]
...
pub const VC5_OTP_CONTROL: c_uint = 0x00;
// Factory-reserved register block
pub const VC5_RSVD_DEVICE_ID: c_uint = 0x01;
pub const VC5_RSVD_ADC_GAIN_7_0: c_uint = 0x02;
pub const VC5_RSVD_ADC_GAIN_15_8: c_uint = 0x03;
pub const VC5_RSVD_ADC_OFFSET_7_0: c_uint = 0x04;
pub const VC5_RSVD_ADC_OFFSET_15_8: c_uint = 0x05;
pub const VC5_RSVD_TEMPY: c_uint = 0x06;
pub const VC5_RSVD_OFFSET_TBIN: c_uint = 0x07;
pub const VC5_RSVD_GAIN: c_uint = 0x08;
pub const VC5_RSVD_TEST_NP: c_uint = 0x09;
pub const VC5_RSVD_UNUSED: c_uint = 0x0a;
pub const VC5_RSVD_BANDGAP_TRIM_UP: c_uint = 0x0b;
pub const VC5_RSVD_BANDGAP_TRIM_DN: c_uint = 0x0c;
pub const VC5_RSVD_CLK_R_12_CLK_AMP_4: c_uint = 0x0d;
pub const VC5_RSVD_CLK_R_34_CLK_AMP_4: c_uint = 0x0e;
pub const VC5_RSVD_CLK_AMP_123: c_uint = 0x0f;
// Configuration register block
pub const VC5_PRIM_SRC_SHDN: c_uint = 0x10;

pub const VC5_VCO_BAND: c_uint = 0x11;
pub const VC5_XTAL_X1_LOAD_CAP: c_uint = 0x12;
pub const VC5_XTAL_X2_LOAD_CAP: c_uint = 0x13;
pub const VC5_REF_DIVIDER: c_uint = 0x15;

pub const VC5_VCO_CTRL_AND_PREDIV: c_uint = 0x16;

pub const VC5_FEEDBACK_INT_DIV: c_uint = 0x17;
pub const VC5_FEEDBACK_INT_DIV_BITS: c_uint = 0x18;

pub const VC5_RC_CONTROL0: c_uint = 0x1e;
pub const VC5_RC_CONTROL1: c_uint = 0x1f;
...
pub const VC5_CLK_OUTPUT_CFG0_CFG_SHIFT: c_int = 5;

pub const VC5_CLK_OUTPUT_CFG0_PWR_SHIFT: c_int = 3;

pub const VC5_CLK_OUTPUT_CFG0_SLEW_SHIFT: c_int = 0;

pub const VC5_CLK_OE_SHDN: c_uint = 0x68;
pub const VC5_CLK_OS_SHDN: c_uint = 0x69;
pub const VC5_GLOBAL_REGISTER: c_uint = 0x76;
...
pub const VC5_MAX_CLK_OUT_NUM: c_int = 5;
// Maximum number of FODs supported by this driver
pub const VC5_MAX_FOD_NUM: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc5_chip_info {
    pub model: enum vc5_model,
    pub clk_fod_cnt: c_uint,
    pub clk_out_cnt: c_uint,
    pub flags: u32,
    pub vco_max: c_ulong,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc5_hw_data {
    pub hw: clk_hw,
    pub vc5: *mut vc5_driver_data,
    pub div_int: u32,
    pub div_frc: u32,
    pub num: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc5_out_data {
    pub hw: clk_hw,
    pub vc5: *mut vc5_driver_data,
    pub num: c_uint,
    pub clk_output_cfg0: c_uint,
    pub clk_output_cfg0_mask: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vc5_driver_data {
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub chip_info: *const vc5_chip_info,
    pub pin_xin: *mut clk,
    pub pin_clkin: *mut clk,
    pub clk_mux_ins: c_uchar,
    pub clk_mux: clk_hw,
    pub clk_mul: clk_hw,
    pub clk_pfd: clk_hw,
    pub clk_pll: vc5_hw_data,
    pub clk_fod: [vc5_hw_data; VC5_MAX_FOD_NUM],
    pub clk_out: [vc5_out_data; VC5_MAX_CLK_OUT_NUM],
}
...
//
#[no_mangle]
unsafe extern "C" fn vc5_regmap_is_writeable(dev: *mut device, reg: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn vc5_mux_get_parent(hw: *mut clk_hw) -> c_uchar {
    static unsigned char vc5_mux_get_parent(struct clk_hw *hw)
    {
    struct vc5_driver_data *vc5 =
    container_of(hw, struct vc5_driver_data, clk_mux);
    let mut mask: u8 = VC5_PRIM_SRC_SHDN_EN_XTAL | VC5_PRIM_SRC_SHDN_EN_CLKIN;
    unsigned int src;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn vc5_mux_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
    ...
    src = VC5_PRIM_SRC_SHDN_EN_XTAL;
#[no_mangle]
pub unsafe extern "C" fn if(VC5_MUX_IN_CLKIN: vc5->clk_mux_ins ==) -> else {
...
// VCO frequency is divided by two before entering FOD
    let mut f_in: u32 = parent_rate / 2;
    u32 div_int, div_frc;
    u8 od_int[2];
    u8 od_frc[4];
...
// The PLL divider has 12 integer bits and 30 fractional bits
    ...
    struct vc5_hw_data *hwdata = container_of(hw, struct vc5_hw_data, hw);
// VCO frequency is divided by two before entering FOD
    let mut f_in: u32 = req.best_parent_rate / 2;
    u32 div_int;
    u64 div_frc;
// Determine integer part, which is 12 bit wide
...
#[no_mangle]
unsafe extern "C" fn vc5_clk_out_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc5_clk_out_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn vc5_clk_out_get_parent(hw: *mut clk_hw) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn vc5_clk_out_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
    ...
    const u8 extclk = VC5_OUT_DIV_CONTROL_SELB_NORM |
    VC5_OUT_DIV_CONTROL_SEL_EXT;
    let mut src: u8 = VC5_OUT_DIV_CONTROL_RESET;
    if (index == 0)
...
#[no_mangle]
unsafe extern "C" fn vc5_map_cap_value(femtofarads: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc5_update_cap_load(node: *mut device_node, vc5: *mut vc5_driver_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vc5_probe(client: *mut i2c_client) -> c_int {
...
// Register clock input mux
    ...
    "internal-xtal", core::ptr::null_mut(),
    0, 25000000);
    if (IS_ERR(vc5.pin_xin))
...
#[no_mangle]
unsafe extern "C" fn vc5_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn vc5_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn vc5_resume(dev: *mut device) -> int __maybe_unused {
