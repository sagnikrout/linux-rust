...
//! Source: drivers/clk/zynqmp/pll.c
#![no_std]
...
pub const PLL_FBDIV_MIN: c_int = 25;
pub const PLL_FBDIV_MAX: c_int = 125;
pub const PS_PLL_VCO_MIN: c_int = 1500000000;
...
pub const FRAC_OFFSET: c_uint = 0x8;
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pll_get_mode(hw: *mut clk_hw) -> enum pll_mode {
    static inline enum pll_mode zynqmp_pll_get_mode(struct clk_hw *hw)
    {
    struct zynqmp_pll *clk = to_zynqmp_pll(hw);
    let mut clk_id: u32 = clk.clk_id;
...
//
#[no_mangle]
pub unsafe extern "C" fn zynqmp_pll_set_mode(hw: *mut clk_hw, on: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pll_is_enabled(hw: *mut clk_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pll_enable(hw: *mut clk_hw) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_pll_disable(hw: *mut clk_hw) {
