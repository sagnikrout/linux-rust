...
//! Source: drivers/clk/zynqmp/divider.c
#![no_std]
...
//
    ...
    let mut clk_id: u32 = divider.clk_id;
    let mut div_type: u32 = divider.div_type;
    u32 div, value;
    int ret;
...
// if read only, just return current value
    ...
    ret = divider_determine_rate(hw, req, core::ptr::null_mut(), width, divider.flags);
    if (ret != 0)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_clk_get_max_divisor(clk_id: u32, type: u32) -> u32 {
