...
//! Source: drivers/clk/clk-composite.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn clk_composite_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn clk_composite_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_composite_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_composite_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_composite_disable(hw: *mut clk_hw) {
...
// .set_rate requires .determine_rate
    ...
    unsigned long flags)
    {
    return __clk_hw_register_composite(dev, name, parent_names, core::ptr::null_mut(),
    ...
    unsigned long flags)
    {
    return __clk_hw_register_composite(dev, name, core::ptr::null_mut(), parent_data,
    num_parents, mux_hw, mux_ops,
    rate_hw, rate_ops, gate_hw,
    gate_ops, flags);
    }
...
#[no_mangle]
pub unsafe extern "C" fn clk_unregister_composite(clk: *mut clk) {
...
#[no_mangle]
pub unsafe extern "C" fn clk_hw_unregister_composite(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn devm_clk_hw_release_composite(dev: *mut device, res: *mut c_void) {
...
// ptr = hw;
    ...
    unsigned long flags)
    {
    return __devm_clk_hw_register_composite(dev, name, core::ptr::null_mut(), parent_data,
    num_parents, mux_hw, mux_ops,
    rate_hw, rate_ops, gate_hw,
    gate_ops, flags);
    }
