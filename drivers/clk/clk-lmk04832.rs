...
//! Source: drivers/clk/clk-lmk04832.c
#![no_std]
...
pub const LMK04832_REG_RST3W: c_uint = 0x000;

pub const LMK04832_REG_POWERDOWN: c_uint = 0x002;
pub const LMK04832_REG_ID_DEV_TYPE: c_uint = 0x003;
pub const LMK04832_REG_ID_PROD_MSB: c_uint = 0x004;
pub const LMK04832_REG_ID_PROD_LSB: c_uint = 0x005;
pub const LMK04832_REG_ID_MASKREV: c_uint = 0x006;
pub const LMK04832_REG_ID_VNDR_MSB: c_uint = 0x00c;
pub const LMK04832_REG_ID_VNDR_LSB: c_uint = 0x00d;
// 0x100 - 0x137 Device Clock and SYSREF Clock Output Control

pub const LMK04832_VAL_CLKOUT_FMT_POWERDOWN: c_uint = 0x00;
pub const LMK04832_VAL_CLKOUT_FMT_LVDS: c_uint = 0x01;
pub const LMK04832_VAL_CLKOUT_FMT_HSDS6: c_uint = 0x02;
pub const LMK04832_VAL_CLKOUT_FMT_HSDS8: c_uint = 0x03;
pub const LMK04832_VAL_CLKOUT_FMT_LVPECL1600: c_uint = 0x04;
pub const LMK04832_VAL_CLKOUT_FMT_LVPECL2000: c_uint = 0x05;
pub const LMK04832_VAL_CLKOUT_FMT_LCPECL: c_uint = 0x06;
pub const LMK04832_VAL_CLKOUT_FMT_CML16: c_uint = 0x07;
pub const LMK04832_VAL_CLKOUT_FMT_CML24: c_uint = 0x08;
pub const LMK04832_VAL_CLKOUT_FMT_CML32: c_uint = 0x09;
pub const LMK04832_VAL_CLKOUT_FMT_CMOS_OFF_INV: c_uint = 0x0a;
pub const LMK04832_VAL_CLKOUT_FMT_CMOS_NOR_OFF: c_uint = 0x0b;
pub const LMK04832_VAL_CLKOUT_FMT_CMOS_INV_INV: c_uint = 0x0c;
pub const LMK04832_VAL_CLKOUT_FMT_CMOS_INV_NOR: c_uint = 0x0d;
pub const LMK04832_VAL_CLKOUT_FMT_CMOS_NOR_INV: c_uint = 0x0e;
pub const LMK04832_VAL_CLKOUT_FMT_CMOS_NOR_NOR: c_uint = 0x0f;
// 0x138 - 0x145 SYSREF, SYNC, and Device Config
pub const LMK04832_REG_VCO_OSCOUT: c_uint = 0x138;

pub const LMK04832_VAL_VCO_MUX_VCO0: c_uint = 0x00;
pub const LMK04832_VAL_VCO_MUX_VCO1: c_uint = 0x01;
pub const LMK04832_VAL_VCO_MUX_EXT: c_uint = 0x02;
pub const LMK04832_REG_SYSREF_OUT: c_uint = 0x139;

pub const LMK04832_VAL_SYSREF_MUX_NORMAL_SYNC: c_uint = 0x00;
pub const LMK04832_VAL_SYSREF_MUX_RECLK: c_uint = 0x01;
pub const LMK04832_VAL_SYSREF_MUX_PULSER: c_uint = 0x02;
pub const LMK04832_VAL_SYSREF_MUX_CONTINUOUS: c_uint = 0x03;
pub const LMK04832_REG_SYSREF_DIV_MSB: c_uint = 0x13a;

pub const LMK04832_REG_SYSREF_DIV_LSB: c_uint = 0x13b;
pub const LMK04832_REG_SYSREF_DDLY_MSB: c_uint = 0x13c;

pub const LMK04832_REG_SYSREF_DDLY_LSB: c_uint = 0x13d;
pub const LMK04832_REG_SYSREF_PULSE_CNT: c_uint = 0x13e;
pub const LMK04832_REG_FB_CTRL: c_uint = 0x13f;

pub const LMK04832_VAL_PLL2_RCLK_MUX_OSCIN: c_uint = 0x00;
pub const LMK04832_VAL_PLL2_RCLK_MUX_CLKIN: c_uint = 0x01;

pub const LMK04832_VAL_PLL2_NCLK_MUX_PLL2_P: c_uint = 0x00;
pub const LMK04832_VAL_PLL2_NCLK_MUX_FB_MUX: c_uint = 0x01;

pub const LMK04832_REG_MAIN_PD: c_uint = 0x140;

pub const LMK04832_REG_SYNC: c_uint = 0x143;

pub const LMK04832_VAL_SYNC_MODE_OFF: c_uint = 0x00;
pub const LMK04832_VAL_SYNC_MODE_ON: c_uint = 0x01;
pub const LMK04832_VAL_SYNC_MODE_PULSER_PIN: c_uint = 0x02;
pub const LMK04832_VAL_SYNC_MODE_PULSER_SPI: c_uint = 0x03;
pub const LMK04832_REG_SYNC_DIS: c_uint = 0x144;
// 0x146 - 0x14a CLKin Control
pub const LMK04832_REG_CLKIN_SEL0: c_uint = 0x148;
pub const LMK04832_REG_CLKIN_SEL1: c_uint = 0x149;
pub const LMK04832_REG_CLKIN_RST: c_uint = 0x14a;

pub const LMK04832_VAL_CLKIN_SEL_MUX_SPI_RDBK: c_uint = 0x06;

pub const LMK04832_VAL_CLKIN_SEL_TYPE_OUT: c_uint = 0x03;
// 0x14b - 0x152 Holdover
// 0x153 - 0x15f PLL1 Configuration
pub const LMK04832_REG_PLL1_LD: c_uint = 0x15f;

pub const LMK04832_VAL_PLL1_LD_MUX_SPI_RDBK: c_uint = 0x07;

pub const LMK04832_VAL_PLL1_LD_TYPE_OUT_PP: c_uint = 0x03;
// 0x160 - 0x16e PLL2 Configuration
pub const LMK04832_REG_PLL2_R_MSB: c_uint = 0x160;

pub const LMK04832_REG_PLL2_R_LSB: c_uint = 0x161;
pub const LMK04832_REG_PLL2_MISC: c_uint = 0x162;

pub const LMK04832_REG_PLL2_N_CAL_0: c_uint = 0x163;

pub const LMK04832_REG_PLL2_N_CAL_1: c_uint = 0x164;
pub const LMK04832_REG_PLL2_N_CAL_2: c_uint = 0x165;
pub const LMK04832_REG_PLL2_N_0: c_uint = 0x166;

pub const LMK04832_REG_PLL2_N_1: c_uint = 0x167;
pub const LMK04832_REG_PLL2_N_2: c_uint = 0x168;
pub const LMK04832_REG_PLL2_DLD_CNT_MSB: c_uint = 0x16a;
pub const LMK04832_REG_PLL2_DLD_CNT_LSB: c_uint = 0x16b;
pub const LMK04832_REG_PLL2_LD: c_uint = 0x16e;

pub const LMK04832_VAL_PLL2_LD_MUX_PLL2_DLD: c_uint = 0x02;

pub const LMK04832_VAL_PLL2_LD_TYPE_OUT_PP: c_uint = 0x03;
// 0x16F - 0x555 Misc Registers
pub const LMK04832_REG_PLL2_PD: c_uint = 0x173;

pub const LMK04832_REG_PLL1R_RST: c_uint = 0x177;
pub const LMK04832_REG_CLR_PLL_LOST: c_uint = 0x182;
pub const LMK04832_REG_RB_PLL_LD: c_uint = 0x183;
pub const LMK04832_REG_RB_CLK_DAC_VAL_MSB: c_uint = 0x184;
pub const LMK04832_REG_RB_DAC_VAL_LSB: c_uint = 0x185;
pub const LMK04832_REG_RB_HOLDOVER: c_uint = 0x188;
pub const LMK04832_REG_SPI_LOCK: c_uint = 0x555;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lmk04832_device_info {
    pub pid: u16,
    pub maskrev: u8,
    pub num_channels: usize,
    pub vco0_range: [c_uint; 2],
    pub vco1_range: [c_uint; 2],
}
...
pub struct lmk04832 {
    ...
    pub sysref_mux: c_uint,
    pub sysref_pulse_cnt: c_uint,
    pub sysref_ddly: c_uint,
    pub oscin: *mut clk,
    pub vco: clk_hw,
    pub sclk: clk_hw,
    pub vco_rate: c_uint,
    pub reset_gpio: *mut gpio_desc,
    pub dclk: *mut lmk_dclk,
    pub clkout: *mut lmk_clkout,
    pub clk_data: *mut clk_hw_onecell_data,
}

#[no_mangle]
unsafe extern "C" fn lmk04832_regmap_rd_regs(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_regmap_wr_regs(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_vco_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_vco_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_vco_unprepare(hw: *mut clk_hw) {
...
//
#[no_mangle]
unsafe extern "C" fn lmk04832_register_vco(lmk: *mut lmk04832) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lmk04832_sclk_sync_sequence(lmk: *mut lmk04832) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_sclk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_sclk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_sclk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_register_sclk(lmk: *mut lmk04832) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_dclk_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_dclk_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_dclk_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_clkout_is_enabled(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_clkout_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_clkout_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_clkout_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_clkout_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_register_clkout(lmk: *mut lmk04832, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_set_spi_rdbk(lmk: *const lmk04832, rdbk_pin: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lmk04832_probe(spi: *mut spi_device) -> c_int {
    static int lmk04832_probe(struct spi_device *spi)
    {
    const struct lmk04832_device_info *info;
    let mut rdbk_pin: c_int = RDBK_CLKIN_SEL1;
    struct lmk04832 *lmk;
    u8 tmp[3];
    int ret;
    int i;
