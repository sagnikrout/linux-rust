...
//! Source: drivers/clk/clk-renesas-pcie.c
#![no_std]
...
pub const RS9_REG_OE: c_uint = 0x0;
pub const RS9_REG_SS: c_uint = 0x1;
pub const RS9_REG_SS_AMP_0V6: c_uint = 0x0;
pub const RS9_REG_SS_AMP_0V7: c_uint = 0x1;
pub const RS9_REG_SS_AMP_0V8: c_uint = 0x2;
pub const RS9_REG_SS_AMP_0V9: c_uint = 0x3;

pub const RS9_REG_SS_AMP_MASK: c_uint = 0x3;
pub const RS9_REG_SS_SSC_100: c_int = 0;

pub const RS9_REG_SR: c_uint = 0x2;
pub const RS9_REG_REF: c_uint = 0x3;

pub const RS9_REG_REF_SR_SLOWEST: c_int = 0;

pub const RS9_REG_VID: c_uint = 0x5;
pub const RS9_REG_DID: c_uint = 0x6;
pub const RS9_REG_BCP: c_uint = 0x7;

pub const RS9_REG_VID_IDT: c_uint = 0x01;

pub const RS9_REG_DID_TYPE_SHIFT: c_uint = 0x6;
// Structure to describe features of a particular 9-series model
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rs9_chip_info {
    pub num_clks: c_uint,
    pub outshift: u8,
    pub did: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rs9_driver_data {
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub chip_info: *const rs9_chip_info,
    pub clk_dif: [*mut clk_hw; 8],
    pub pll_amplitude: u8,
    pub pll_ssc: u8,
    pub clk_dif_sr: u8,
}
...
//
    ...
    let mut count: c_int = ARRAY_SIZE(data);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rs9_calc_dif(rs9: *const rs9_driver_data, idx: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rs9_get_output_config(rs9: *mut rs9_driver_data, idx: c_int) -> c_int {
    static int rs9_get_output_config(struct rs9_driver_data *rs9, int idx)
    {
    struct i2c_client *client = rs9.client;
    let mut dif: u8 = rs9_calc_dif(rs9, idx);
...
#[no_mangle]
unsafe extern "C" fn rs9_get_common_config(rs9: *mut rs9_driver_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs9_update_config(rs9: *mut rs9_driver_data) {
...
// If SSC is non-default, update it.
    ...
    let mut dif: u8 = rs9_calc_dif(rs9, i);
...
#[no_mangle]
unsafe extern "C" fn rs9_probe(client: *mut i2c_client) -> c_int {
...
// Fetch DIFx output configuration from DT (if specified)
    ...
    rs9.regmap = devm_regmap_init(&client.dev, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn rs9_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rs9_resume(dev: *mut device) -> c_int {
