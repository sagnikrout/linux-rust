...
//! Source: drivers/clk/clk-lan966x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lan966x_match_data {
    pub name: *mut c_char,
    pub clk_name: *const *const c_char,
    pub clk_gate_desc: *const clk_gate_soc_desc,
    pub num_generic_clks: u8,
    pub num_total_clks: u8,
}
...
#[no_mangle]
unsafe extern "C" fn lan966x_gck_enable(hw: *mut clk_hw) -> c_int {
    static int lan966x_gck_enable(struct clk_hw *hw)
    {
    struct lan966x_gck *gck = to_lan966x_gck(hw);
    let mut val: u32 = readl(gck.reg);
    val |= GCK_ENA;
    writel(val, gck.reg);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn lan966x_gck_disable(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn lan966x_gck_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn lan966x_gck_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
    ...
    let mut idx: c_int = i - data.num_generic_clks;
...
#[no_mangle]
unsafe extern "C" fn lan966x_clk_probe(pdev: *mut platform_device) -> c_int {
