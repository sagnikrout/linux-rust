...
//! Source: drivers/clk/analogbits/wrpll-cln28hpc.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn __wrpll_calc_filter_range(post_divr_freq: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __wrpll_calc_fbdiv(c: *const wrpll_cfg) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn __wrpll_calc_divq(target_rate: u32, vco_rate: *mut u64) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn wrpll_calc_max_lock_us(c: *const wrpll_cfg) -> c_uint {
