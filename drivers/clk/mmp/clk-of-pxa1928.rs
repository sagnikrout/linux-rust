...
//! Source: drivers/clk/mmp/clk-of-pxa1928.c
#![no_std]
...
pub const APBC_NR_CLKS: c_int = 48;
pub const APMU_NR_CLKS: c_int = 96;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa1928_clk_unit {
    pub unit: mmp_clk_unit,
    pub mpmu_base: *mut void __iomem,
    pub apmu_base: *mut void __iomem,
    pub apbc_base: *mut void __iomem,
    pub apbcp_base: *mut void __iomem,
}

    static struct mmp_param_fixed_rate_clk fixed_rate_clks[] = {
    {0, "clk32", core::ptr::null_mut(), 0, 32768},
    {0, "vctcxo", core::ptr::null_mut(), 0, 26000000},
    {0, "pll1_624", core::ptr::null_mut(), 0, 624000000},
    {0, "pll5p", core::ptr::null_mut(), 0, 832000000},
    {0, "pll5", core::ptr::null_mut(), 0, 1248000000},
    {0, "usb_pll", core::ptr::null_mut(), 0, 480000000},
    };
...
#[no_mangle]
unsafe extern "C" fn pxa1928_pll_init(pxa_unit: *mut pxa1928_clk_unit) {
    ...
    {PXA1928_CLK_KPC, "kpc_clk", "clk32", CLK_SET_RATE_PARENT, PXA1928_CLK_KPC * 4, 0x3, 0x3, 0x0, MMP_CLK_GATE_NEED_DELAY, core::ptr::null_mut()},
    {PXA1928_CLK_RTC, "rtc_clk", "clk32", CLK_SET_RATE_PARENT, PXA1928_CLK_RTC * 4, 0x83, 0x83, 0x0, MMP_CLK_GATE_NEED_DELAY, core::ptr::null_mut()},
...
#[no_mangle]
unsafe extern "C" fn pxa1928_apb_periph_clk_init(pxa_unit: *mut pxa1928_clk_unit) {
...
#[no_mangle]
unsafe extern "C" fn pxa1928_axi_periph_clk_init(pxa_unit: *mut pxa1928_clk_unit) {
...
#[no_mangle]
unsafe extern "C" fn pxa1928_mpmu_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pxa1928_apmu_clk_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn pxa1928_apbc_clk_init(np: *mut device_node) -> void __init {
