...
//! Source: drivers/clk/mmp/clk-of-mmp2.c
#![no_std]
...
pub const APBC_RTC: c_uint = 0x0;
pub const APBC_TWSI0: c_uint = 0x4;
pub const APBC_TWSI1: c_uint = 0x8;
pub const APBC_TWSI2: c_uint = 0xc;
pub const APBC_TWSI3: c_uint = 0x10;
pub const APBC_TWSI4: c_uint = 0x7c;
pub const APBC_TWSI5: c_uint = 0x80;
pub const APBC_KPC: c_uint = 0x18;
pub const APBC_TIMER: c_uint = 0x24;
pub const APBC_UART0: c_uint = 0x2c;
pub const APBC_UART1: c_uint = 0x30;
pub const APBC_UART2: c_uint = 0x34;
pub const APBC_UART3: c_uint = 0x88;
pub const APBC_GPIO: c_uint = 0x38;
pub const APBC_PWM0: c_uint = 0x3c;
pub const APBC_PWM1: c_uint = 0x40;
pub const APBC_PWM2: c_uint = 0x44;
pub const APBC_PWM3: c_uint = 0x48;
pub const APBC_SSP0: c_uint = 0x50;
pub const APBC_SSP1: c_uint = 0x54;
pub const APBC_SSP2: c_uint = 0x58;
pub const APBC_SSP3: c_uint = 0x5c;
pub const APBC_THERMAL0: c_uint = 0x90;
pub const APBC_THERMAL1: c_uint = 0x98;
pub const APBC_THERMAL2: c_uint = 0x9c;
pub const APBC_THERMAL3: c_uint = 0xa0;
pub const APMU_SDH0: c_uint = 0x54;
pub const APMU_SDH1: c_uint = 0x58;
pub const APMU_SDH2: c_uint = 0xe8;
pub const APMU_SDH3: c_uint = 0xec;
pub const APMU_SDH4: c_uint = 0x15c;
pub const APMU_USB: c_uint = 0x5c;
pub const APMU_DISP0: c_uint = 0x4c;
pub const APMU_DISP1: c_uint = 0x110;
pub const APMU_CCIC0: c_uint = 0x50;
pub const APMU_CCIC1: c_uint = 0xf4;
pub const APMU_USBHSIC0: c_uint = 0xf8;
pub const APMU_USBHSIC1: c_uint = 0xfc;
pub const APMU_GPU: c_uint = 0xcc;
pub const APMU_AUDIO: c_uint = 0x10c;
pub const APMU_CAMERA: c_uint = 0x1fc;
pub const MPMU_FCCR: c_uint = 0x8;
pub const MPMU_POSR: c_uint = 0x10;
pub const MPMU_UART_PLL: c_uint = 0x14;
pub const MPMU_PLL2_CR: c_uint = 0x34;
pub const MPMU_I2S0_PLL: c_uint = 0x40;
pub const MPMU_I2S1_PLL: c_uint = 0x44;
pub const MPMU_ACGR: c_uint = 0x1024;
// MMP3 specific below
pub const MPMU_PLL3_CR: c_uint = 0x50;
pub const MPMU_PLL3_CTRL1: c_uint = 0x58;
pub const MPMU_PLL1_CTRL: c_uint = 0x5c;
pub const MPMU_PLL_DIFF_CTRL: c_uint = 0x68;
pub const MPMU_PLL2_CTRL1: c_uint = 0x414;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmp2_clk_unit {
    pub unit: mmp_clk_unit,
    pub model: enum mmp2_clk_model,
    pub pd_data: genpd_onecell_data,
    pub pm_domains: [*mut generic_pm_domain; MMP2_NR_POWER_DOMAINS],
    ...
    {MMP2_CLK_CLK32, "clk32", core::ptr::null_mut(), 0, 32768},
    {MMP2_CLK_VCTCXO, "vctcxo", core::ptr::null_mut(), 0, 26000000},
    {MMP2_CLK_USB_PLL, "usb_pll", core::ptr::null_mut(), 0, 480000000},
    {0, "i2s_pll", core::ptr::null_mut(), 0, 99666667},
    };
...
#[no_mangle]
unsafe extern "C" fn mmp2_main_clk_init(pxa_unit: *mut mmp2_clk_unit) {
    ...
    ARRAY_SIZE(i2s_factor_tbl), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mmp2_apb_periph_clk_init(pxa_unit: *mut mmp2_clk_unit) {
...
#[no_mangle]
unsafe extern "C" fn mmp2_axi_periph_clk_init(pxa_unit: *mut mmp2_clk_unit) {
    static void mmp2_axi_periph_clk_init(struct mmp2_clk_unit *pxa_unit)
    {
    struct clk *clk;
    struct mmp_clk_unit *unit = &pxa_unit.unit;
    sdh_mix_config.reg_info.reg_clk_ctrl = pxa_unit.apmu_base + APMU_SDH0;
    clk = mmp_clk_register_mix(core::ptr::null_mut(), "sdh_mix_clk", sdh_parent_names,
    ARRAY_SIZE(sdh_parent_names),
    CLK_SET_RATE_PARENT,
    &sdh_mix_config, &sdh_lock);
    ccic0_mix_config.reg_info.reg_clk_ctrl = pxa_unit.apmu_base + APMU_CCIC0;
    clk = mmp_clk_register_mix(core::ptr::null_mut(), "ccic0_mix_clk", ccic_parent_names,
    ...
    clk = mmp_clk_register_mix(core::ptr::null_mut(), "ccic1_mix_clk", ccic_parent_names,
    ARRAY_SIZE(ccic_parent_names),
    CLK_SET_RATE_PARENT,
    ...
    clk_register_mux_table(core::ptr::null_mut(), "gpu_3d_mux", mmp2_gpu_gc_parent_names,
    ARRAY_SIZE(mmp2_gpu_gc_parent_names),
    CLK_SET_RATE_PARENT,
    pxa_unit.apmu_base + APMU_GPU,
    0, 0x10c0, 0,
    mmp2_gpu_gc_parent_table, &gpu_lock);
    clk_register_mux_table(core::ptr::null_mut(), "gpu_bus_mux", mmp2_gpu_bus_parent_names,
...
#[no_mangle]
unsafe extern "C" fn mmp2_clk_init(np: *mut device_node) -> void __init {
