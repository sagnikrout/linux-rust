...
//! Source: drivers/clk/mmp/clk-of-pxa910.c
#![no_std]
...
pub const APBC_TIMER0: c_uint = 0x30;
pub const APBC_TIMER1: c_uint = 0x44;
pub const APBCP_TWSI1: c_uint = 0x28;
...
pub struct pxa910_clk_unit {
    ...
    {PXA910_CLK_CLK32, "clk32", core::ptr::null_mut(), 0, 32768},
    {PXA910_CLK_VCTCXO, "vctcxo", core::ptr::null_mut(), 0, 26000000},
    {PXA910_CLK_PLL1, "pll1", core::ptr::null_mut(), 0, 624000000},
    {PXA910_CLK_USB_PLL, "usb_pll", core::ptr::null_mut(), 0, 480000000},
    };
...
#[no_mangle]
unsafe extern "C" fn pxa910_pll_init(pxa_unit: *mut pxa910_clk_unit) {
    ...
    {PXA910_CLK_KPC, "kpc_clk", "clk32", CLK_SET_RATE_PARENT, APBC_KPC, 0x3, 0x3, 0x0, MMP_CLK_GATE_NEED_DELAY, core::ptr::null_mut()},
    {PXA910_CLK_RTC, "rtc_clk", "clk32", CLK_SET_RATE_PARENT, APBC_RTC, 0x83, 0x83, 0x0, MMP_CLK_GATE_NEED_DELAY, core::ptr::null_mut()},
...
#[no_mangle]
unsafe extern "C" fn pxa910_apb_periph_clk_init(pxa_unit: *mut pxa910_clk_unit) {
    ...
    {PXA910_CLK_DFC, "dfc_clk", "pll1_4", CLK_SET_RATE_PARENT, APMU_DFC, 0x19b, 0x19b, 0x0, 0, core::ptr::null_mut()},
...
#[no_mangle]
unsafe extern "C" fn pxa910_axi_periph_clk_init(pxa_unit: *mut pxa910_clk_unit) {
...
#[no_mangle]
unsafe extern "C" fn pxa910_clk_init(np: *mut device_node) -> void __init {
