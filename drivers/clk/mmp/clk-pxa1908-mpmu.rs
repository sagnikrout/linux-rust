...
//! Source: drivers/clk/mmp/clk-pxa1908-mpmu.c
#![no_std]
...
pub const MPMU_NR_CLKS: c_int = 39;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pxa1908_clk_unit {
    ...
    {PXA1908_CLK_CLK32, "clk32", core::ptr::null_mut(), 0, 32768},
    {PXA1908_CLK_VCTCXO, "vctcxo", core::ptr::null_mut(), 0, 26 * HZ_PER_MHZ},
    {PXA1908_CLK_PLL1_624, "pll1_624", core::ptr::null_mut(), 0, 624 * HZ_PER_MHZ},
    {PXA1908_CLK_PLL1_416, "pll1_416", core::ptr::null_mut(), 0, 416 * HZ_PER_MHZ},
    {PXA1908_CLK_PLL1_499, "pll1_499", core::ptr::null_mut(), 0, 499 * HZ_PER_MHZ},
    {PXA1908_CLK_PLL1_832, "pll1_832", core::ptr::null_mut(), 0, 832 * HZ_PER_MHZ},
    {PXA1908_CLK_PLL1_1248, "pll1_1248", core::ptr::null_mut(), 0, 1248 * HZ_PER_MHZ},
    };
...
#[no_mangle]
unsafe extern "C" fn pxa1908_pll_init(pxa_unit: *mut pxa1908_clk_unit) {
...
#[no_mangle]
unsafe extern "C" fn pxa1908_mpmu_probe(pdev: *mut platform_device) -> c_int {
