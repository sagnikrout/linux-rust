...
//! Source: drivers/clk/xilinx/clk-xlnx-clock-wizard.c
#![no_std]
...
pub const WZRD_NUM_OUTPUTS: c_int = 7;

pub const WZRD_CLKFBOUT_1: c_int = 0;
pub const WZRD_CLKFBOUT_2: c_int = 1;
pub const WZRD_CLKOUT0_1: c_int = 2;
pub const WZRD_CLKOUT0_2: c_int = 3;
pub const WZRD_DESKEW_2: c_int = 20;
pub const WZRD_DIVCLK: c_int = 21;
pub const WZRD_CLKFBOUT_4: c_int = 51;
pub const WZRD_CLKFBOUT_3: c_int = 48;
pub const WZRD_CP: c_int = 18;
pub const WZRD_LOCK: c_int = 27;
pub const WZRD_LOCK_REF_DLY: c_int = 28;
pub const WZRD_RES: c_int = 30;
pub const WZRD_DUTY_CYCLE: c_int = 2;
pub const WZRD_O_DIV: c_int = 4;

pub const WZRD_P5EN_SHIFT: c_int = 13;

pub const WZRD_P5FEDGE_SHIFT: c_int = 15;

pub const WZRD_EDGE_SHIFT: c_int = 8;

pub const WZRD_CLKFBOUT_MULT_SHIFT: c_int = 8;

pub const WZRD_CLKFBOUT_L_SHIFT: c_int = 0;
pub const WZRD_CLKFBOUT_H_SHIFT: c_int = 8;

pub const WZRD_CLKFBOUT_FRAC_SHIFT: c_int = 16;

pub const WZRD_DIVCLK_DIVIDE_SHIFT: c_int = 0;

pub const WZRD_CLKOUT_DIVIDE_SHIFT: c_int = 0;
pub const WZRD_CLKOUT_DIVIDE_WIDTH: c_int = 8;

pub const WZRD_CLKOUT_FRAC_SHIFT: c_int = 8;
pub const WZRD_CLKOUT_FRAC_MASK: c_uint = 0x3ff;

pub const WZRD_DR_MAX_INT_DIV_VALUE: c_int = 255;
pub const WZRD_DR_STATUS_REG_OFFSET: c_uint = 0x04;
pub const WZRD_DR_LOCK_BIT_MASK: c_uint = 0x00000001;
pub const WZRD_DR_INIT_REG_OFFSET: c_uint = 0x25C;
pub const WZRD_DR_INIT_VERSAL_OFFSET: c_uint = 0x14;
pub const WZRD_DR_DIV_TO_PHASE_OFFSET: c_int = 4;
pub const WZRD_DR_BEGIN_DYNA_RECONF: c_uint = 0x03;
pub const WZRD_DR_BEGIN_DYNA_RECONF_5_2: c_uint = 0x07;
pub const WZRD_DR_BEGIN_DYNA_RECONF1_5_2: c_uint = 0x02;
pub const WZRD_USEC_POLL: c_int = 10;
pub const WZRD_TIMEOUT_POLL: c_int = 1000;
pub const WZRD_FRAC_GRADIENT: c_int = 64;
pub const PREDIV2_MULT: c_int = 2;
// Divider limits, from UG572 Table 3-4 for Ultrascale+
pub const DIV_O: c_uint = 0x01;
pub const DIV_ALL: c_uint = 0x03;

pub const VER_WZRD_M_MIN: c_int = 4;
pub const VER_WZRD_M_MAX: c_int = 432;
pub const VER_WZRD_D_MIN: c_int = 1;
pub const VER_WZRD_D_MAX: c_int = 123;

pub const VER_WZRD_O_MIN: c_int = 2;
pub const VER_WZRD_O_MAX: c_int = 511;
pub const WZRD_FRAC_POINTS: c_int = 1000;
...
pub struct clk_wzrd {
    ...
    pub clk_in1: *mut clk,
    pub axi_clk: *mut clk,
    pub clks_internal: [*mut clk_hw; wzrd_clk_int_max],
    pub speed_grade: c_uint,
    pub suspended: bool,
...
pub struct clk_wzrd_divider {
    ...
    pub o: u32,
    pub o_frac: u32,
    pub /: *mut *mut *mut spinlock_t lock; / divider lock,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct versal_clk_data {
    pub is_versal: bool,
}
...
#[no_mangle]
unsafe extern "C" fn clk_wzrd_reconfig(divider: *mut clk_wzrd_divider, div_addr: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_wzrd_update_cp_res_lock(divider: *mut clk_wzrd_divider, m: u32) {
    static void clk_wzrd_update_cp_res_lock(struct clk_wzrd_divider *divider, u32 m)
    {
    let mut lock_ref_dly: u32 = 16, lock_fb_dly = 16, lock_cnt = 250, cp = 15, res = 15;
...
#[no_mangle]
pub unsafe extern "C" fn if(DIV_O: div_type ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(clk_wzrd->axi_clk: ndata->clk ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn clk_wzrd_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn clk_wzrd_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn clk_wzrd_register_output_clocks(dev: *mut device, nr_outputs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clk_wzrd_probe(pdev: *mut platform_device) -> c_int {
