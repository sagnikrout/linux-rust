...
//! Source: drivers/clk/xilinx/xlnx_vcu.c
#![no_std]
...
pub const VCU_PLL_CTRL: c_uint = 0x24;

pub const VCU_PLL_CFG: c_uint = 0x28;

pub const VCU_ENC_CORE_CTRL: c_uint = 0x30;
pub const VCU_ENC_MCU_CTRL: c_uint = 0x34;
pub const VCU_DEC_CORE_CTRL: c_uint = 0x38;
pub const VCU_DEC_MCU_CTRL: c_uint = 0x3c;
pub const VCU_PLL_STATUS: c_uint = 0x60;

pub const MHZ: c_int = 1000000;
...
pub struct xvcu_device {
    ...
    pub vcu_slcr_ba: *mut void __iomem,
    pub pll: *mut clk_hw,
...
//
#[no_mangle]
pub unsafe extern "C" fn xvcu_read(iomem: *mut void __iomem, offset: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn xvcu_write(iomem: *mut void __iomem, offset: u32, value: u32) {
...
pub struct vcu_pll {
    ...
    pub fvco_min: c_ulong,
    pub fvco_max: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn xvcu_pll_wait_for_lock(pll: *mut vcu_pll) -> c_int {
...
//
    ...
    {
    const struct xvcu_pll_cfg *cfg = core::ptr::null_mut();
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn xvcu_pll_set_div(pll: *mut vcu_pll, div: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xvcu_pll_enable(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xvcu_pll_disable(hw: *mut clk_hw) {
    ...
    void __iomem *reg)
    {
    let mut mux_flags: u8 = CLK_MUX_ROUND_CLOSEST;
    u8 divider_flags = CLK_DIVIDER_ONE_BASED | CLK_DIVIDER_ALLOW_ZERO |
    CLK_DIVIDER_ROUND_CLOSEST;
    struct clk_hw *mux = core::ptr::null_mut();
    struct clk_hw *divider = core::ptr::null_mut();
    struct clk_hw *gate = core::ptr::null_mut();
    char *name_mux;
    char *name_div;
    int err;
...
#[no_mangle]
unsafe extern "C" fn xvcu_clk_hw_unregister_leaf(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn xvcu_register_clock_provider(xvcu: *mut xvcu_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xvcu_unregister_clock_provider(xvcu: *mut xvcu_device) {
...
//
#[no_mangle]
unsafe extern "C" fn xvcu_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xvcu_remove(pdev: *mut platform_device) {
