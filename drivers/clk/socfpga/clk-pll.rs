...
//! Source: drivers/clk/socfpga/clk-pll.c
#![no_std]
...
pub const SOCFPGA_PLL_EXT_ENA: c_int = 1;
pub const SOCFPGA_PLL_PWR_DOWN: c_int = 2;
pub const SOCFPGA_PLL_DIVF_MASK: c_uint = 0x0000FFF8;
pub const SOCFPGA_PLL_DIVF_SHIFT: c_int = 3;
pub const SOCFPGA_PLL_DIVQ_MASK: c_uint = 0x003F0000;
pub const SOCFPGA_PLL_DIVQ_SHIFT: c_int = 16;
pub const CLK_MGR_PLL_CLK_SRC_SHIFT: c_int = 22;
...
#[no_mangle]
pub unsafe extern "C" fn socfpga_pll_init(node: *mut device_node) -> void __init {
