...
//! Source: drivers/clk/socfpga/clk-agilex5.c
#![no_std]
...
// Main PLL C0, C1, C2, C3 and Peri PLL C0, C1, C2, C3. With ping-pong counter.
    ...
    { AGILEX5_MAIN_PLL_C0_CLK, "main_pll_c0", "main_pll", core::ptr::null_mut(), 1, 0,
    0x5C },
    { AGILEX5_MAIN_PLL_C1_CLK, "main_pll_c1", "main_pll", core::ptr::null_mut(), 1, 0,
    0x60 },
    { AGILEX5_MAIN_PLL_C2_CLK, "main_pll_c2", "main_pll", core::ptr::null_mut(), 1, 0,
    0x64 },
    { AGILEX5_MAIN_PLL_C3_CLK, "main_pll_c3", "main_pll", core::ptr::null_mut(), 1, 0,
    0x68 },
    { AGILEX5_PERIPH_PLL_C0_CLK, "peri_pll_c0", "periph_pll", core::ptr::null_mut(), 1, 0,
    0xB0 },
    { AGILEX5_PERIPH_PLL_C1_CLK, "peri_pll_c1", "periph_pll", core::ptr::null_mut(), 1, 0,
    0xB4 },
    { AGILEX5_PERIPH_PLL_C2_CLK, "peri_pll_c2", "periph_pll", core::ptr::null_mut(), 1, 0,
    0xB8 },
    { AGILEX5_PERIPH_PLL_C3_CLK, "peri_pll_c3", "periph_pll", core::ptr::null_mut(), 1, 0,
    0xBC },
    };
...
#[no_mangle]
unsafe extern "C" fn agilex5_clkmgr_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn agilex5_clkmgr_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn agilex5_clk_init() -> int __init {
