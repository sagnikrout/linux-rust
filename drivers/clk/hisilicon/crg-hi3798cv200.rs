...
//! Source: drivers/clk/hisilicon/crg-hi3798cv200.c
#![no_std]
...
pub const HI3798CV200_INNER_CLK_OFFSET: c_int = 64;
pub const HI3798CV200_FIXED_24M: c_int = 65;
pub const HI3798CV200_FIXED_25M: c_int = 66;
pub const HI3798CV200_FIXED_50M: c_int = 67;
pub const HI3798CV200_FIXED_75M: c_int = 68;
pub const HI3798CV200_FIXED_100M: c_int = 69;
pub const HI3798CV200_FIXED_150M: c_int = 70;
pub const HI3798CV200_FIXED_200M: c_int = 71;
pub const HI3798CV200_FIXED_250M: c_int = 72;
pub const HI3798CV200_FIXED_300M: c_int = 73;
pub const HI3798CV200_FIXED_400M: c_int = 74;
pub const HI3798CV200_MMC_MUX: c_int = 75;
pub const HI3798CV200_ETH_PUB_CLK: c_int = 76;
pub const HI3798CV200_ETH_BUS_CLK: c_int = 77;
pub const HI3798CV200_ETH_BUS0_CLK: c_int = 78;
pub const HI3798CV200_ETH_BUS1_CLK: c_int = 79;
pub const HI3798CV200_COMBPHY1_MUX: c_int = 80;
pub const HI3798CV200_FIXED_12M: c_int = 81;
pub const HI3798CV200_FIXED_48M: c_int = 82;
pub const HI3798CV200_FIXED_60M: c_int = 83;
pub const HI3798CV200_FIXED_166P5M: c_int = 84;
pub const HI3798CV200_SDIO0_MUX: c_int = 85;
pub const HI3798CV200_COMBPHY0_MUX: c_int = 86;
pub const HI3798CV200_CRG_NR_CLKS: c_int = 128;
    static const struct hisi_fixed_rate_clock hi3798cv200_fixed_rate_clks[] = {
    { HISTB_OSC_CLK, "clk_osc", core::ptr::null_mut(), 0, 24000000, },
    { HISTB_APB_CLK, "clk_apb", core::ptr::null_mut(), 0, 100000000, },
    { HISTB_AHB_CLK, "clk_ahb", core::ptr::null_mut(), 0, 200000000, },
    { HI3798CV200_FIXED_12M, "12m", core::ptr::null_mut(), 0, 12000000, },
    { HI3798CV200_FIXED_24M, "24m", core::ptr::null_mut(), 0, 24000000, },
    { HI3798CV200_FIXED_25M, "25m", core::ptr::null_mut(), 0, 25000000, },
    { HI3798CV200_FIXED_48M, "48m", core::ptr::null_mut(), 0, 48000000, },
    { HI3798CV200_FIXED_50M, "50m", core::ptr::null_mut(), 0, 50000000, },
    { HI3798CV200_FIXED_60M, "60m", core::ptr::null_mut(), 0, 60000000, },
    { HI3798CV200_FIXED_75M, "75m", core::ptr::null_mut(), 0, 75000000, },
    { HI3798CV200_FIXED_100M, "100m", core::ptr::null_mut(), 0, 100000000, },
    { HI3798CV200_FIXED_150M, "150m", core::ptr::null_mut(), 0, 150000000, },
    { HI3798CV200_FIXED_166P5M, "166p5m", core::ptr::null_mut(), 0, 165000000, },
    { HI3798CV200_FIXED_200M, "200m", core::ptr::null_mut(), 0, 200000000, },
    { HI3798CV200_FIXED_250M, "250m", core::ptr::null_mut(), 0, 250000000, },
    };
...
// Ethernet
    { HI3798CV200_ETH_PUB_CLK, "clk_pub", core::ptr::null_mut(),
...
// USB3
    { HISTB_USB3_BUS_CLK, "clk_u3_bus", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0xb0, 0, 0 },
    { HISTB_USB3_UTMI_CLK, "clk_u3_utmi", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0xb0, 4, 0 },
    { HISTB_USB3_PIPE_CLK, "clk_u3_pipe", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0xb0, 3, 0 },
    { HISTB_USB3_SUSPEND_CLK, "clk_u3_suspend", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0xb0, 2, 0 },
    { HISTB_USB3_BUS_CLK1, "clk_u3_bus1", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0xb0, 16, 0 },
    { HISTB_USB3_UTMI_CLK1, "clk_u3_utmi1", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0xb0, 20, 0 },
    { HISTB_USB3_PIPE_CLK1, "clk_u3_pipe1", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0xb0, 19, 0 },
    { HISTB_USB3_SUSPEND_CLK1, "clk_u3_suspend1", core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn hi3798cv200_clk_unregister(pdev: *mut platform_device) {
...
pub const HI3798CV200_SYSCTRL_NR_CLKS: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn hi3798cv200_sysctrl_clk_unregister(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hi3798cv200_crg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3798cv200_crg_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hi3798cv200_crg_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hi3798cv200_crg_exit() -> void __exit {
