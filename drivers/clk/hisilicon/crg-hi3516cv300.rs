...
//! Source: drivers/clk/hisilicon/crg-hi3516cv300.c
#![no_std]
...
pub const HI3516CV300_INNER_CLK_OFFSET: c_int = 64;
pub const HI3516CV300_FIXED_3M: c_int = 65;
pub const HI3516CV300_FIXED_6M: c_int = 66;
pub const HI3516CV300_FIXED_24M: c_int = 67;
pub const HI3516CV300_FIXED_49P5: c_int = 68;
pub const HI3516CV300_FIXED_50M: c_int = 69;
pub const HI3516CV300_FIXED_83P3M: c_int = 70;
pub const HI3516CV300_FIXED_99M: c_int = 71;
pub const HI3516CV300_FIXED_100M: c_int = 72;
pub const HI3516CV300_FIXED_148P5M: c_int = 73;
pub const HI3516CV300_FIXED_198M: c_int = 74;
pub const HI3516CV300_FIXED_297M: c_int = 75;
pub const HI3516CV300_UART_MUX: c_int = 76;
pub const HI3516CV300_FMC_MUX: c_int = 77;
pub const HI3516CV300_MMC0_MUX: c_int = 78;
pub const HI3516CV300_MMC1_MUX: c_int = 79;
pub const HI3516CV300_MMC2_MUX: c_int = 80;
pub const HI3516CV300_MMC3_MUX: c_int = 81;
pub const HI3516CV300_PWM_MUX: c_int = 82;
pub const HI3516CV300_CRG_NR_CLKS: c_int = 128;
    static const struct hisi_fixed_rate_clock hi3516cv300_fixed_rate_clks[] = {
    { HI3516CV300_FIXED_3M, "3m", core::ptr::null_mut(), 0, 3000000, },
    { HI3516CV300_FIXED_6M, "6m", core::ptr::null_mut(), 0, 6000000, },
    { HI3516CV300_FIXED_24M, "24m", core::ptr::null_mut(), 0, 24000000, },
    { HI3516CV300_FIXED_49P5, "49.5m", core::ptr::null_mut(), 0, 49500000, },
    { HI3516CV300_FIXED_50M, "50m", core::ptr::null_mut(), 0, 50000000, },
    { HI3516CV300_FIXED_83P3M, "83.3m", core::ptr::null_mut(), 0, 83300000, },
    { HI3516CV300_FIXED_99M, "99m", core::ptr::null_mut(), 0, 99000000, },
    { HI3516CV300_FIXED_100M, "100m", core::ptr::null_mut(), 0, 100000000, },
    { HI3516CV300_FIXED_148P5M, "148.5m", core::ptr::null_mut(), 0, 148500000, },
    { HI3516CV300_FIXED_198M, "198m", core::ptr::null_mut(), 0, 198000000, },
    { HI3516CV300_FIXED_297M, "297m", core::ptr::null_mut(), 0, 297000000, },
    { HI3516CV300_APB_CLK, "apb", core::ptr::null_mut(), 0, 50000000, },
    };
    ...
    0xc8, 1, 0, },
    { HI3516CV300_ETH_CLK, "clk_eth", core::ptr::null_mut(), 0, 0xec, 1, 0, },
    { HI3516CV300_DMAC_CLK, "clk_dmac", core::ptr::null_mut(), 0, 0xd8, 5, 0, },
    { HI3516CV300_PWM_CLK, "clk_pwm", "pwm_mux", CLK_SET_RATE_PARENT,
    0x38, 1, 0, },
    { HI3516CV300_USB2_BUS_CLK, "clk_usb2_bus", core::ptr::null_mut(), 0, 0xb8, 0, 0, },
    { HI3516CV300_USB2_OHCI48M_CLK, "clk_usb2_ohci48m", core::ptr::null_mut(), 0,
    0xb8, 1, 0, },
    { HI3516CV300_USB2_OHCI12M_CLK, "clk_usb2_ohci12m", core::ptr::null_mut(), 0,
    0xb8, 2, 0, },
    { HI3516CV300_USB2_OTG_UTMI_CLK, "clk_usb2_otg_utmi", core::ptr::null_mut(), 0,
    0xb8, 3, 0, },
    { HI3516CV300_USB2_HST_PHY_CLK, "clk_usb2_hst_phy", core::ptr::null_mut(), 0,
    0xb8, 4, 0, },
    { HI3516CV300_USB2_UTMI0_CLK, "clk_usb2_utmi0", core::ptr::null_mut(), 0, 0xb8, 5, 0, },
    { HI3516CV300_USB2_PHY_CLK, "clk_usb2_phy", core::ptr::null_mut(), 0, 0xb8, 7, 0, },
    };
...
#[no_mangle]
unsafe extern "C" fn hi3516cv300_clk_unregister(pdev: *mut platform_device) {
...
pub const HI3516CV300_SYSCTRL_NR_CLKS: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn hi3516cv300_sysctrl_clk_unregister(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hi3516cv300_crg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3516cv300_crg_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hi3516cv300_crg_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hi3516cv300_crg_exit() -> void __exit {
