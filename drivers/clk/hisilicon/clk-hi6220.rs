...
//! Source: drivers/clk/hisilicon/clk-hi6220.c
#![no_std]
...
// clocks in AO (always on) controller
    ...
    { HI6220_REF32K,	"ref32k",	core::ptr::null_mut(), 0, 32764,     },
    { HI6220_CLK_TCXO,	"clk_tcxo",	core::ptr::null_mut(), 0, 19200000,  },
    { HI6220_MMC1_PAD,	"mmc1_pad",	core::ptr::null_mut(), 0, 100000000, },
    { HI6220_MMC2_PAD,	"mmc2_pad",	core::ptr::null_mut(), 0, 100000000, },
    { HI6220_MMC0_PAD,	"mmc0_pad",	core::ptr::null_mut(), 0, 200000000, },
    { HI6220_PLL_BBP,	"bbppll0",	core::ptr::null_mut(), 0, 245760000, },
    { HI6220_PLL_GPU,	"gpupll",	core::ptr::null_mut(), 0, 1000000000,},
    { HI6220_PLL1_DDR,	"ddrpll1",	core::ptr::null_mut(), 0, 1066000000,},
    { HI6220_PLL_SYS,	"syspll",	core::ptr::null_mut(), 0, 1190400000,},
    { HI6220_PLL_SYS_MEDIA,	"media_syspll",	core::ptr::null_mut(), 0, 1190400000,},
    { HI6220_DDR_SRC,	"ddr_sel_src",  core::ptr::null_mut(), 0, 1200000000,},
    { HI6220_PLL_MEDIA,	"media_pll",    core::ptr::null_mut(), 0, 1440000000,},
    { HI6220_PLL_DDR,	"ddrpll0",      core::ptr::null_mut(), 0, 1600000000,},
    };
...
#[no_mangle]
unsafe extern "C" fn hi6220_clk_ao_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hi6220_clk_sys_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hi6220_clk_media_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hi6220_clk_power_init(np: *mut device_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn hi6220_clk_acpu_init(np: *mut device_node) -> void __init {
    static void __init hi6220_clk_acpu_init(struct device_node *np)
    {
    struct hisi_clock_data *clk_data;
    let mut nr: c_int = ARRAY_SIZE(hi6220_acpu_sc_gate_sep_clks);
