...
//! Source: drivers/clk/hisilicon/clk-hi3670.c
#![no_std]
...
//
    ...
    { HI3670_CLKIN_SYS, "clkin_sys", core::ptr::null_mut(), 0, 19200000, },
    { HI3670_CLKIN_REF, "clkin_ref", core::ptr::null_mut(), 0, 32764, },
    { HI3670_CLK_FLL_SRC, "clk_fll_src", core::ptr::null_mut(), 0, 134400000, },
    { HI3670_CLK_PPLL0, "clk_ppll0", core::ptr::null_mut(), 0, 1660000000, },
    { HI3670_CLK_PPLL1, "clk_ppll1", core::ptr::null_mut(), 0, 1866000000, },
    { HI3670_CLK_PPLL2, "clk_ppll2", core::ptr::null_mut(), 0, 1920000000, },
    { HI3670_CLK_PPLL3, "clk_ppll3", core::ptr::null_mut(), 0, 1200000000, },
    { HI3670_CLK_PPLL4, "clk_ppll4", core::ptr::null_mut(), 0, 900000000, },
    { HI3670_CLK_PPLL6, "clk_ppll6", core::ptr::null_mut(), 0, 393216000, },
    { HI3670_CLK_PPLL7, "clk_ppll7", core::ptr::null_mut(), 0, 1008000000, },
    { HI3670_CLK_PPLL_PCIE, "clk_ppll_pcie", core::ptr::null_mut(), 0, 100000000, },
    { HI3670_CLK_PCIEPLL_REV, "clk_pciepll_rev", core::ptr::null_mut(), 0, 100000000, },
    { HI3670_CLK_SCPLL, "clk_scpll", core::ptr::null_mut(), 0, 245760000, },
    { HI3670_PCLK, "pclk", core::ptr::null_mut(), 0, 20000000, },
    { HI3670_CLK_UART0_DBG, "clk_uart0_dbg", core::ptr::null_mut(), 0, 19200000, },
    { HI3670_CLK_UART6, "clk_uart6", core::ptr::null_mut(), 0, 19200000, },
    { HI3670_OSC32K, "osc32k", core::ptr::null_mut(), 0, 32764, },
    { HI3670_OSC19M, "osc19m", core::ptr::null_mut(), 0, 19200000, },
    { HI3670_CLK_480M, "clk_480m", core::ptr::null_mut(), 0, 480000000, },
    { HI3670_CLK_INVALID, "clk_invalid", core::ptr::null_mut(), 0, 10000000, },
    };
// crgctrl
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_crgctrl_init(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_pctrl_init(np: *mut device_node) {
    static void hi3670_clk_pctrl_init(struct device_node *np)
    {
    struct hisi_clock_data *clk_data;
    let mut nr: c_int = ARRAY_SIZE(hi3670_pctrl_gate_clks);
    clk_data = hisi_clk_init(np, nr);
    if (!clk_data)
    return;
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_pmuctrl_init(np: *mut device_node) {
    static void hi3670_clk_pmuctrl_init(struct device_node *np)
    {
    struct hisi_clock_data *clk_data;
    let mut nr: c_int = ARRAY_SIZE(hi3670_pmu_gate_clks);
    clk_data = hisi_clk_init(np, nr);
    if (!clk_data)
    return;
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_sctrl_init(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_iomcu_init(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_media1_init(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_media2_init(np: *mut device_node) {
    static void hi3670_clk_media2_init(struct device_node *np)
    {
    struct hisi_clock_data *clk_data;
    let mut nr: c_int = ARRAY_SIZE(hi3670_media2_gate_sep_clks);
    clk_data = hisi_clk_init(np, nr);
    if (!clk_data)
    return;
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3670_clk_init() -> int __init {
