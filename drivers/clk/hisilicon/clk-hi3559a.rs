...
//! Source: drivers/clk/hisilicon/clk-hi3559a.c
#![no_std]
...
pub const CRG_BASE_ADDR: c_uint = 0x18020000;
pub const PLL_MASK_WIDTH: c_int = 24;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi3559av100_pll_clock {
    pub id: u32,
    ...
    pub frac_shift: u8,
    pub frac_width: u8,
    pub postdiv1_shift: u8,
    pub postdiv1_width: u8,
    pub postdiv2_shift: u8,
    pub postdiv2_width: u8,
    pub ctrl_reg2: u32,
    pub fbdiv_shift: u8,
    pub fbdiv_width: u8,
    pub refdiv_shift: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi3559av100_clk_pll {
    pub hw: clk_hw,
    pub id: u32,
...
// soc clk config
    ...
    { HI3559AV100_FIXED_1188M, "1188m", core::ptr::null_mut(), 0, 1188000000, },
    { HI3559AV100_FIXED_1000M, "1000m", core::ptr::null_mut(), 0, 1000000000, },
    { HI3559AV100_FIXED_842M, "842m", core::ptr::null_mut(), 0, 842000000, },
    { HI3559AV100_FIXED_792M, "792m", core::ptr::null_mut(), 0, 792000000, },
    { HI3559AV100_FIXED_750M, "750m", core::ptr::null_mut(), 0, 750000000, },
    { HI3559AV100_FIXED_710M, "710m", core::ptr::null_mut(), 0, 710000000, },
    { HI3559AV100_FIXED_680M, "680m", core::ptr::null_mut(), 0, 680000000, },
    { HI3559AV100_FIXED_667M, "667m", core::ptr::null_mut(), 0, 667000000, },
    { HI3559AV100_FIXED_631M, "631m", core::ptr::null_mut(), 0, 631000000, },
    { HI3559AV100_FIXED_600M, "600m", core::ptr::null_mut(), 0, 600000000, },
    { HI3559AV100_FIXED_568M, "568m", core::ptr::null_mut(), 0, 568000000, },
    { HI3559AV100_FIXED_500M, "500m", core::ptr::null_mut(), 0, 500000000, },
    { HI3559AV100_FIXED_475M, "475m", core::ptr::null_mut(), 0, 475000000, },
    { HI3559AV100_FIXED_428M, "428m", core::ptr::null_mut(), 0, 428000000, },
    { HI3559AV100_FIXED_400M, "400m", core::ptr::null_mut(), 0, 400000000, },
    { HI3559AV100_FIXED_396M, "396m", core::ptr::null_mut(), 0, 396000000, },
    { HI3559AV100_FIXED_300M, "300m", core::ptr::null_mut(), 0, 300000000, },
    { HI3559AV100_FIXED_250M, "250m", core::ptr::null_mut(), 0, 250000000, },
    { HI3559AV100_FIXED_200M, "200m", core::ptr::null_mut(), 0, 200000000, },
    { HI3559AV100_FIXED_198M, "198m", core::ptr::null_mut(), 0, 198000000, },
    { HI3559AV100_FIXED_187p5M, "187p5m", core::ptr::null_mut(), 0, 187500000, },
    { HI3559AV100_FIXED_150M, "150m", core::ptr::null_mut(), 0, 150000000, },
    { HI3559AV100_FIXED_148p5M, "148p5m", core::ptr::null_mut(), 0, 1485000000, },
    { HI3559AV100_FIXED_125M, "125m", core::ptr::null_mut(), 0, 125000000, },
    { HI3559AV100_FIXED_107M, "107m", core::ptr::null_mut(), 0, 107000000, },
    { HI3559AV100_FIXED_100M, "100m", core::ptr::null_mut(), 0, 100000000, },
    { HI3559AV100_FIXED_99M, "99m",	core::ptr::null_mut(), 0, 99000000, },
    { HI3559AV100_FIXED_75M, "75m", core::ptr::null_mut(), 0, 75000000, },
    { HI3559AV100_FIXED_74p25M, "74p25m", core::ptr::null_mut(), 0, 74250000, },
    { HI3559AV100_FIXED_72M, "72m",	core::ptr::null_mut(), 0, 72000000, },
    { HI3559AV100_FIXED_60M, "60m",	core::ptr::null_mut(), 0, 60000000, },
    { HI3559AV100_FIXED_54M, "54m",	core::ptr::null_mut(), 0, 54000000, },
    { HI3559AV100_FIXED_50M, "50m",	core::ptr::null_mut(), 0, 50000000, },
    { HI3559AV100_FIXED_49p5M, "49p5m", core::ptr::null_mut(), 0, 49500000, },
    { HI3559AV100_FIXED_37p125M, "37p125m", core::ptr::null_mut(), 0, 37125000, },
    { HI3559AV100_FIXED_36M, "36m",	core::ptr::null_mut(), 0, 36000000, },
    { HI3559AV100_FIXED_32p4M, "32p4m", core::ptr::null_mut(), 0, 32400000, },
    { HI3559AV100_FIXED_27M, "27m",	core::ptr::null_mut(), 0, 27000000, },
    { HI3559AV100_FIXED_25M, "25m",	core::ptr::null_mut(), 0, 25000000, },
    { HI3559AV100_FIXED_24M, "24m",	core::ptr::null_mut(), 0, 24000000, },
    { HI3559AV100_FIXED_12M, "12m",	core::ptr::null_mut(), 0, 12000000, },
    { HI3559AV100_FIXED_3M,	 "3m", core::ptr::null_mut(), 0, 3000000, },
    { HI3559AV100_FIXED_1p6M, "1p6m", core::ptr::null_mut(), 0, 1600000, },
    { HI3559AV100_FIXED_400K, "400k", core::ptr::null_mut(), 0, 400000, },
    { HI3559AV100_FIXED_100K, "100k", core::ptr::null_mut(), 0, 100000, },
    };
    ...
    {
    HI3559AV100_ETH_CLK, "clk_eth", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0x0174, 1, 0,
    },
    {
    HI3559AV100_ETH_MACIF_CLK, "clk_eth_macif", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0x0174, 5, 0,
    },
    {
    HI3559AV100_ETH1_CLK, "clk_eth1", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0x0174, 3, 0,
    },
    {
    HI3559AV100_ETH1_MACIF_CLK, "clk_eth1_macif", core::ptr::null_mut(),
    ...
    {
    HI3559AV100_EDMAC_AXICLK, "axi_clk_edmac", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0x16c, 6, 0,
    },
    {
    HI3559AV100_EDMAC_CLK, "clk_edmac", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0x16c, 5, 0,
    },
    {
    HI3559AV100_EDMAC1_AXICLK, "axi_clk_edmac1", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0x16c, 9, 0,
    },
    {
    HI3559AV100_EDMAC1_CLK, "clk_edmac1", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0x16c, 8, 0,
    },
    {
    HI3559AV100_VDMAC_CLK, "clk_vdmac", core::ptr::null_mut(),
    CLK_SET_RATE_PARENT, 0x14c, 5, 0,
    },
    };
    static struct hi3559av100_pll_clock hi3559av100_pll_clks[] = {
    {
    HI3559AV100_APLL_CLK, "apll", core::ptr::null_mut(), 0x0, 0, 24, 24, 3, 28, 3,
    0x4, 0, 12, 12, 6
    },
    {
    HI3559AV100_GPLL_CLK, "gpll", core::ptr::null_mut(), 0x20, 0, 24, 24, 3, 28, 3,
    0x24, 0, 12, 12, 6
    },
    };
...
// rate = 24000000 * (fbdiv + frac / (1<<24) ) / refdiv
    ...
    struct hi3559av100_clk_pll *p_clk = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hi3559av100_clk_unregister(pdev: *mut platform_device) {
    ...
    { HI3559AV100_SHUB_SOURCE_SOC_24M, "clk_source_24M", core::ptr::null_mut(), 0, 24000000UL, },
    { HI3559AV100_SHUB_SOURCE_SOC_200M, "clk_source_200M", core::ptr::null_mut(), 0, 200000000UL, },
    { HI3559AV100_SHUB_SOURCE_SOC_300M, "clk_source_300M", core::ptr::null_mut(), 0, 300000000UL, },
    { HI3559AV100_SHUB_SOURCE_PLL, "clk_source_PLL", core::ptr::null_mut(), 0, 192000000UL, },
    { HI3559AV100_SHUB_I2C0_CLK, "clk_shub_i2c0", core::ptr::null_mut(), 0, 48000000UL, },
    { HI3559AV100_SHUB_I2C1_CLK, "clk_shub_i2c1", core::ptr::null_mut(), 0, 48000000UL, },
    { HI3559AV100_SHUB_I2C2_CLK, "clk_shub_i2c2", core::ptr::null_mut(), 0, 48000000UL, },
    { HI3559AV100_SHUB_I2C3_CLK, "clk_shub_i2c3", core::ptr::null_mut(), 0, 48000000UL, },
    { HI3559AV100_SHUB_I2C4_CLK, "clk_shub_i2c4", core::ptr::null_mut(), 0, 48000000UL, },
    { HI3559AV100_SHUB_I2C5_CLK, "clk_shub_i2c5", core::ptr::null_mut(), 0, 48000000UL, },
    { HI3559AV100_SHUB_I2C6_CLK, "clk_shub_i2c6", core::ptr::null_mut(), 0, 48000000UL, },
    { HI3559AV100_SHUB_I2C7_CLK, "clk_shub_i2c7", core::ptr::null_mut(), 0, 48000000UL, },
    { HI3559AV100_SHUB_UART_CLK_32K, "clk_uart_32K", core::ptr::null_mut(), 0, 32000UL, },
    };
// shub mux clk
...
#[no_mangle]
unsafe extern "C" fn hi3559av100_shub_default_clk_set() -> c_int {
...
// UART: 192M/8
    ...
    iounmap(crg_base);
    crg_base = core::ptr::null_mut();
    return 0;
    }
    static struct hisi_clock_data *hi3559av100_shub_clk_register(
    struct platform_device *pdev)
    {
    struct hisi_clock_data *clk_data = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn hi3559av100_shub_clk_unregister(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hi3559av100_crg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3559av100_crg_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hi3559av100_crg_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hi3559av100_crg_exit() -> void __exit {
