...
//! Source: drivers/clk/hisilicon/clk-hi3660.c
#![no_std]
...
//
    ...
    { HI3660_CLKIN_SYS, "clkin_sys", core::ptr::null_mut(), 0, 19200000, },
    { HI3660_CLKIN_REF, "clkin_ref", core::ptr::null_mut(), 0, 32764, },
    { HI3660_CLK_FLL_SRC, "clk_fll_src", core::ptr::null_mut(), 0, 128000000, },
    { HI3660_CLK_PPLL0, "clk_ppll0", core::ptr::null_mut(), 0, 1600000000, },
    { HI3660_CLK_PPLL1, "clk_ppll1", core::ptr::null_mut(), 0, 1866000000, },
    { HI3660_CLK_PPLL2, "clk_ppll2", core::ptr::null_mut(), 0, 2880000000UL, },
    { HI3660_CLK_PPLL3, "clk_ppll3", core::ptr::null_mut(), 0, 1290000000, },
    { HI3660_CLK_SCPLL, "clk_scpll", core::ptr::null_mut(), 0, 245760000, },
    { HI3660_PCLK, "pclk", core::ptr::null_mut(), 0, 20000000, },
    { HI3660_CLK_UART0_DBG, "clk_uart0_dbg", core::ptr::null_mut(), 0, 19200000, },
    { HI3660_CLK_UART6, "clk_uart6", core::ptr::null_mut(), 0, 19200000, },
    { HI3660_OSC32K, "osc32k", core::ptr::null_mut(), 0, 32764, },
    { HI3660_OSC19M, "osc19m", core::ptr::null_mut(), 0, 19200000, },
    { HI3660_CLK_480M, "clk_480m", core::ptr::null_mut(), 0, 480000000, },
    { HI3660_CLK_INV, "clk_inv", core::ptr::null_mut(), 0, 10000000, },
    };
// crgctrl
...
#[no_mangle]
unsafe extern "C" fn hi3660_clk_iomcu_init(np: *mut device_node) {
    static void hi3660_clk_iomcu_init(struct device_node *np)
    {
    struct hisi_clock_data *clk_data;
    let mut nr: c_int = ARRAY_SIZE(hi3660_iomcu_gate_sep_clks);
...
#[no_mangle]
unsafe extern "C" fn hi3660_clk_pmuctrl_init(np: *mut device_node) {
    static void hi3660_clk_pmuctrl_init(struct device_node *np)
    {
    struct hisi_clock_data *clk_data;
    let mut nr: c_int = ARRAY_SIZE(hi3660_pmu_gate_clks);
    clk_data = hisi_clk_init(np, nr);
    if (!clk_data)
    return;
...
#[no_mangle]
unsafe extern "C" fn hi3660_clk_pctrl_init(np: *mut device_node) {
    static void hi3660_clk_pctrl_init(struct device_node *np)
    {
    struct hisi_clock_data *clk_data;
    let mut nr: c_int = ARRAY_SIZE(hi3660_pctrl_gate_clks);
    clk_data = hisi_clk_init(np, nr);
    if (!clk_data)
    return;
...
#[no_mangle]
unsafe extern "C" fn hi3660_clk_sctrl_init(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn hi3660_clk_crgctrl_early_init(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn hi3660_clk_crgctrl_init(np: *mut device_node) {
...
#[no_mangle]
unsafe extern "C" fn hi3660_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi3660_clk_init() -> int __init {
