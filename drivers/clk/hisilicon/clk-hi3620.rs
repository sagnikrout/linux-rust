...
//! Source: drivers/clk/hisilicon/clk-hi3620.c
#![no_std]
...
// fixed rate clocks
    ...
    { HI3620_OSC32K,   "osc32k",   core::ptr::null_mut(), 0, 32768, },
    { HI3620_OSC26M,   "osc26m",   core::ptr::null_mut(), 0, 26000000, },
    { HI3620_PCLK,     "pclk",     core::ptr::null_mut(), 0, 26000000, },
    { HI3620_PLL_ARM0, "armpll0",  core::ptr::null_mut(), 0, 1600000000, },
    { HI3620_PLL_ARM1, "armpll1",  core::ptr::null_mut(), 0, 1600000000, },
    { HI3620_PLL_PERI, "armpll2",  core::ptr::null_mut(), 0, 1440000000, },
    { HI3620_PLL_USB,  "armpll3",  core::ptr::null_mut(), 0, 1440000000, },
    { HI3620_PLL_HDMI, "armpll4",  core::ptr::null_mut(), 0, 1188000000, },
    { HI3620_PLL_GPU,  "armpll5",  core::ptr::null_mut(), 0, 1300000000, },
    };
// fixed factor clocks
    ...
    { HI3620_SHAREAXI_DIV, "saxi_div",   "saxi_mux",  0, 0x100, 0, 5, CLK_DIVIDER_HIWORD_MASK, core::ptr::null_mut(), },
    { HI3620_CFGAXI_DIV,   "cfgaxi_div", "saxi_div",  0, 0x100, 5, 2, CLK_DIVIDER_HIWORD_MASK, core::ptr::null_mut(), },
    { HI3620_SD_DIV,       "sd_div",     "sd_mux",	  0, 0x108, 0, 4, CLK_DIVIDER_HIWORD_MASK, core::ptr::null_mut(), },
    { HI3620_MMC1_DIV,     "mmc1_div",   "mmc1_mux",  0, 0x108, 5, 4, CLK_DIVIDER_HIWORD_MASK, core::ptr::null_mut(), },
    { HI3620_HSIC_DIV,     "hsic_div",   "rclk_hsic", 0, 0x130, 0, 2, CLK_DIVIDER_HIWORD_MASK, core::ptr::null_mut(), },
    { HI3620_MMC2_DIV,     "mmc2_div",   "mmc2_mux",  0, 0x140, 0, 4, CLK_DIVIDER_HIWORD_MASK, core::ptr::null_mut(), },
    { HI3620_MMC3_DIV,     "mmc3_div",   "mmc3_mux",  0, 0x140, 5, 4, CLK_DIVIDER_HIWORD_MASK, core::ptr::null_mut(), },
    };
...
#[no_mangle]
unsafe extern "C" fn hi3620_clk_init(np: *mut device_node) -> void __init {
...
pub struct clk_mmc {
    pub hw: clk_hw,
    pub id: u32,
    pub clken_reg: *mut void __iomem,
    pub clken_bit: u32,
    pub div_reg: *mut void __iomem,
    pub div_off: u32,
    pub div_bits: u32,
    pub drv_reg: *mut void __iomem,
    pub drv_off: u32,
    pub drv_bits: u32,
    pub sam_reg: *mut void __iomem,
    pub sam_off: u32,
    pub sam_bits: u32,
}
...
#[no_mangle]
unsafe extern "C" fn mmc_clk_delay(val: u32, para: u32, off: u32, len: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mmc_clk_set_timing(hw: *mut clk_hw, rate: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_clk_prepare(hw: *mut clk_hw) -> c_int {
    ...
    init.parent_names = (mmc_clk.parent_name ? &mmc_clk.parent_name : core::ptr::null_mut());
    ...
    clk = clk_register(core::ptr::null_mut(), &mclk.hw);
    if (WARN_ON(IS_ERR(clk)))
    kfree(mclk);
    return clk;
    }
#[no_mangle]
unsafe extern "C" fn hi3620_mmc_clk_init(node: *mut device_node) -> void __init {
