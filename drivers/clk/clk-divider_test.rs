...
//! Source: drivers/clk/clk-divider_test.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn clk_divider_bestdiv_ulong_max_returns_max_rate(test: *mut kunit) {
    ...
    parent_hw = clk_hw_register_fixed_rate(core::ptr::null_mut(), "bestdiv-parent",
    core::ptr::null_mut(), 0, PARENT_RATE_1GHZ);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, parent_hw);
    KUNIT_ASSERT_EQ(test, 0,
    kunit_add_action_or_reset(test, clk_hw_unregister_fixed_rate_wrapper,
    parent_hw));
    div_hw = clk_hw_register_divider_table(core::ptr::null_mut(), "bestdiv-div",
    "bestdiv-parent",
    CLK_SET_RATE_PARENT,
    (void __iomem  *)fake_reg,
    0, 2, 0, bestdiv_table, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn clk_divider_bestdiv_mux_ulong_max_returns_max_rate(test: *mut kunit) {
...
// Higher-rate parent: the mux should select this for ULONG_MAX.
    parent_a_hw = clk_hw_register_fixed_rate(core::ptr::null_mut(), "bestdiv-mux-parent-a",
    core::ptr::null_mut(), 0, PARENT_RATE_4GHZ);
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, parent_a_hw);
    KUNIT_ASSERT_EQ(test, 0,
    kunit_add_action_or_reset(test, clk_hw_unregister_fixed_rate_wrapper,
    parent_a_hw));
// Lower-rate parent: should not be selected.
    parent_b_hw = clk_hw_register_fixed_rate(core::ptr::null_mut(), "bestdiv-mux-parent-b",
    core::ptr::null_mut(), 0, PARENT_RATE_2GHZ);
...
//
    mux_hw = clk_hw_register_mux(core::ptr::null_mut(), "bestdiv-mux",
    mux_parents, ARRAY_SIZE(mux_parents),
    CLK_SET_RATE_PARENT,
    (void __iomem  *)fake_reg_mux,
    ...
    mux_hw));
    div_hw = clk_hw_register_divider_table(core::ptr::null_mut(), "bestdiv-mux-div",
    "bestdiv-mux",
    CLK_SET_RATE_PARENT,
    (void __iomem  *)fake_reg_div,
    0, 2, 0, bestdiv_table, core::ptr::null_mut());
    KUNIT_ASSERT_NOT_ERR_OR_NULL(test, div_hw);
    KUNIT_ASSERT_EQ(test, 0,
    kunit_add_action_or_reset(test, clk_hw_unregister_divider_wrapper,
