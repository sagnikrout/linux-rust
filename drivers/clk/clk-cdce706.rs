...
//! Source: drivers/clk/clk-cdce706.c
#![no_std]
...
pub const CDCE706_CLKIN_CLOCK: c_int = 10;
pub const CDCE706_CLKIN_SOURCE: c_int = 11;

pub const CDCE706_PLL_MUX: c_int = 3;
pub const CDCE706_PLL_FVCO: c_int = 6;

pub const CDCE706_CLKIN_CLOCK_MASK: c_uint = 0x10;
pub const CDCE706_CLKIN_SOURCE_SHIFT: c_int = 6;
pub const CDCE706_CLKIN_SOURCE_MASK: c_uint = 0xc0;
pub const CDCE706_CLKIN_SOURCE_LVCMOS: c_uint = 0x40;

pub const CDCE706_PLL_LOW_M_MASK: c_uint = 0xff;
pub const CDCE706_PLL_LOW_N_MASK: c_uint = 0xff;
pub const CDCE706_PLL_HI_M_MASK: c_uint = 0x1;
pub const CDCE706_PLL_HI_N_MASK: c_uint = 0x1e;
pub const CDCE706_PLL_HI_N_SHIFT: c_int = 1;
pub const CDCE706_PLL_M_MAX: c_uint = 0x1ff;
pub const CDCE706_PLL_N_MAX: c_uint = 0xfff;

pub const CDCE706_PLL_FREQ_MIN: c_int = 80000000;
pub const CDCE706_PLL_FREQ_MAX: c_int = 300000000;
pub const CDCE706_PLL_FREQ_HI: c_int = 180000000;

pub const CDCE706_DIVIDER_DIVIDER_MASK: c_uint = 0x7f;
pub const CDCE706_DIVIDER_DIVIDER_MAX: c_uint = 0x7f;
pub const CDCE706_CLKOUT_DIVIDER_MASK: c_uint = 0x7;
pub const CDCE706_CLKOUT_ENABLE_MASK: c_uint = 0x8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdce706_hw_data {
    pub dev_data: *mut cdce706_dev_data,
    pub idx: unsigned,
    pub parent: unsigned,
    pub hw: clk_hw,
    pub div: unsigned,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cdce706_dev_data {
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub clkin_clk: [*mut clk; 2],
    pub clkin_name: [*const c_char; 2],
    pub clkin: [cdce706_hw_data; 1],
    pub pll: [cdce706_hw_data; 3],
    pub divider: [cdce706_hw_data; 6],
    pub clkout: [cdce706_hw_data; 6],
}
    ...
    unsigned *val)
    {
    let mut rc: c_int = regmap_read(dev_data.regmap, reg | 0x80, val);
    if (rc < 0)
    ...
    unsigned val)
    {
    let mut rc: c_int = regmap_write(dev_data.regmap, reg | 0x80, val);
    if (rc < 0)
    ...
    {
    let mut rc: c_int = regmap_update_bits(dev_data.regmap, reg | 0x80, mask, val);
    if (rc < 0)
    dev_err(&dev_data.client.dev, "error updating reg %u", reg);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn cdce706_clkin_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdce706_clkin_get_parent(hw: *mut clk_hw) -> u8 {
    ...
    if (!hwd.mux) {
    if (hwd.div && hwd.mul) {
    let mut res: u64 = (u64)parent_rate * hwd.mul;
    do_div(res, hwd.div);
    return res;
    }
    } else {
    ...
    {
    struct cdce706_hw_data *hwd = to_hw_data(hw);
    let mut mul: c_ulong = hwd.mul, div = hwd.div;
    int err;
    dev_dbg(&hwd.dev_data.client.dev,
    "%s, pll: %d, mul: %lu, div: %lu\n",
    __func__, hwd.idx, mul, div);
...
#[no_mangle]
unsafe extern "C" fn cdce706_divider_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdce706_divider_get_parent(hw: *mut clk_hw) -> u8 {
    ...
    let mut best_diff: c_ulong = rate;
    let mut best_div: c_ulong = 0;
    struct clk *gp_clk = cdce.clkin_clk[cdce.clkin[0].parent];
    let mut gp_rate: c_ulong = gp_clk ? clk_get_rate(gp_clk) : 0;
...
#[no_mangle]
unsafe extern "C" fn cdce706_clkout_prepare(hw: *mut clk_hw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdce706_clkout_unprepare(hw: *mut clk_hw) {
...
#[no_mangle]
unsafe extern "C" fn cdce706_clkout_set_parent(hw: *mut clk_hw, index: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdce706_clkout_get_parent(hw: *mut clk_hw) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn cdce706_register_clkin(cdce: *mut cdce706_dev_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdce706_register_plls(cdce: *mut cdce706_dev_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdce706_register_dividers(cdce: *mut cdce706_dev_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdce706_register_clkouts(cdce: *mut cdce706_dev_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cdce706_probe(client: *mut i2c_client) -> c_int {
