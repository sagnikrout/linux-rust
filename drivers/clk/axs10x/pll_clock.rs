...
//! Source: drivers/clk/axs10x/pll_clock.c
#![no_std]
...
pub const PLL_REG_IDIV: c_uint = 0x0;
pub const PLL_REG_FBDIV: c_uint = 0x4;
pub const PLL_REG_ODIV: c_uint = 0x8;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axs10x_pll_clk {
    pub hw: clk_hw,
    pub base: *mut void __iomem,
    pub lock: *mut void __iomem,
    pub pll_cfg: *const axs10x_pll_cfg,
    pub dev: *mut device,
}
...
#[no_mangle]
pub unsafe extern "C" fn axs10x_pll_read(clk: *mut axs10x_pll_clk, reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn axs10x_div_get_value(reg: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn axs10x_encode_div(id: c_uint, upd: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn axs10x_pll_clk_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_axs10x_pll_clk_setup(node: *mut device_node) -> void __init {
