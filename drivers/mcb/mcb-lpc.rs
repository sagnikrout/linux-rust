...
#[no_mangle]
unsafe extern "C" fn mcb_lpc_probe(pdev: *mut platform_device) -> c_int {
    static int mcb_lpc_probe(struct platform_device *pdev)
    {
    struct resource *res;
    struct priv *priv;
    let mut ret: c_int = 0, table_size;
...
#[no_mangle]
unsafe extern "C" fn mcb_lpc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mcb_lpc_create_platform_device(id: *const dmi_system_id) -> c_int {
    ...
    let mut sc24_fpga_resource: static struct resource = DEFINE_RES_MEM(0xe000e000, CHAM_HEADER_SIZE);
    let mut sc31_fpga_resource: static struct resource = DEFINE_RES_MEM(0xf000e000, CHAM_HEADER_SIZE);
...
#[no_mangle]
unsafe extern "C" fn mcb_lpc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mcb_lpc_exit() -> void __exit {
