...
#[no_mangle]
unsafe extern "C" fn dax_kmem_range(dev_dax: *mut dev_dax, i: c_int, r: *mut range) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dax_kmem_data {
    pub res_name: *const c_char,
    pub mgid: c_int,
    pub state: c_int,
    pub /: *mut *mut mutex lock; / protects hotplug state transitions,
...
#[no_mangle]
unsafe extern "C" fn kmem_put_memory_types() {
...
#[no_mangle]
unsafe extern "C" fn dax_kmem_state_is_online(state: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dax_kmem_parse_state(buf: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dev_dax_kmem_probe(dev_dax: *mut dev_dax) -> c_int {
    static int dev_dax_kmem_probe(struct dev_dax *dev_dax)
    {
    struct device *dev = &dev_dax.dev;
    let mut total_len: c_ulong = 0, orig_len = 0;
    struct dax_kmem_data *data;
    struct memory_dev_type *mtype;
    int i, rc;
    int numa_node;
    let mut adist: c_int = MEMTIER_DEFAULT_DAX_ADISTANCE;
    let mut online_type: c_int = mhp_get_default_online_type();
//
...
#[no_mangle]
unsafe extern "C" fn dev_dax_kmem_remove(dev_dax: *mut dev_dax) {
    static void dev_dax_kmem_remove(struct dev_dax *dev_dax)
    {
    let mut node: c_int = dev_dax.target_node;
    struct device *dev = &dev_dax.dev;
    struct dax_kmem_data *data = dev_get_drvdata(dev);
//
...
// till next reboot.
//
    clear_node_memory_type(node, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn dax_kmem_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dax_kmem_exit() -> void __exit {
