...
//! Source: drivers/dax/hmem/hmem.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dax_hmem_probe(pdev: *mut platform_device) -> c_int {
    static int dax_hmem_probe(struct platform_device *pdev)
    {
    let mut flags: c_ulong = IORESOURCE_DAX_KMEM;
...
#[no_mangle]
unsafe extern "C" fn release_memregion(data: *mut c_void) {
    static void release_memregion(void *data)
    {
    memregion_free((long) data);
    }
#[no_mangle]
unsafe extern "C" fn release_hmem(pdev: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn dax_hmem_flush_work() {
...
#[no_mangle]
unsafe extern "C" fn process_defer_work(w: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn dax_hmem_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dax_hmem_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn dax_hmem_exit() -> __exit void {
