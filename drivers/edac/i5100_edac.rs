...
//! Source: drivers/edac/i5100_edac.c
#![no_std]
...
// register addresses
// device 16, func 1
pub const I5100_MC: c_uint = 0x40	/* Memory Control Register */;

pub const I5100_MS: c_uint = 0x44	/* Memory Status Register */;
pub const I5100_SPDDATA: c_uint = 0x48	/* Serial Presence Detect Status Reg */;
pub const I5100_SPDCMD: c_uint = 0x4c	/* Serial Presence Detect Command Reg */;
pub const I5100_TOLM: c_uint = 0x6c	/* Top of Low Memory */;
pub const I5100_MIR0: c_uint = 0x80	/* Memory Interleave Range 0 */;
pub const I5100_MIR1: c_uint = 0x84	/* Memory Interleave Range 1 */;
pub const I5100_AMIR_0: c_uint = 0x8c	/* Adjusted Memory Interleave Range 0 */;
pub const I5100_AMIR_1: c_uint = 0x90	/* Adjusted Memory Interleave Range 1 */;
pub const I5100_FERR_NF_MEM: c_uint = 0xa0	/* MC First Non Fatal Errors */;
...
pub const I5100_NERR_NF_MEM: c_uint = 0xa4	/* MC Next Non-Fatal Errors */;
pub const I5100_EMASK_MEM: c_uint = 0xa8	/* MC Error Mask Register */;
pub const I5100_MEM0EINJMSK0: c_uint = 0x200	/* Injection Mask0 Register Channel 0 */;
pub const I5100_MEM1EINJMSK0: c_uint = 0x208	/* Injection Mask0 Register Channel 1 */;

pub const I5100_MEM0EINJMSK1: c_uint = 0x204	/* Injection Mask1 Register Channel 0 */;
pub const I5100_MEM1EINJMSK1: c_uint = 0x206	/* Injection Mask1 Register Channel 1 */;
// Device 19, Function 0
pub const I5100_DINJ0: c_uint = 0x9a;
// device 21 and 22, func 0
pub const I5100_MTR_0: c_uint = 0x154	/* Memory Technology Registers 0-3 */;
pub const I5100_DMIR: c_uint = 0x15c	/* DIMM Interleave Range */;
pub const I5100_VALIDLOG: c_uint = 0x18c	/* Valid Log Markers */;
pub const I5100_NRECMEMA: c_uint = 0x190	/* Non-Recoverable Memory Error Log Reg A */;
pub const I5100_NRECMEMB: c_uint = 0x194	/* Non-Recoverable Memory Error Log Reg B */;
pub const I5100_REDMEMA: c_uint = 0x198	/* Recoverable Memory Data Error Log Reg A */;
pub const I5100_REDMEMB: c_uint = 0x19c	/* Recoverable Memory Data Error Log Reg B */;
pub const I5100_RECMEMA: c_uint = 0x1a0	/* Recoverable Memory Error Log Reg A */;
pub const I5100_RECMEMB: c_uint = 0x1a4	/* Recoverable Memory Error Log Reg B */;
pub const I5100_MTR_4: c_uint = 0x1b0	/* Memory Technology Registers 4,5 */;
// bit field accessors
#[no_mangle]
pub unsafe extern "C" fn i5100_mc_scrben(mc: u32) -> u32 {
    static inline u32 i5100_mc_scrben(u32 mc)
    {
    return mc >> 7 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mc_errdeten(mc: u32) -> u32 {
    static inline u32 i5100_mc_errdeten(u32 mc)
    {
    return mc >> 5 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mc_scrbdone(mc: u32) -> u32 {
    static inline u32 i5100_mc_scrbdone(u32 mc)
    {
    return mc >> 4 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_spddata_rdo(a: u16) -> u16 {
    static inline u16 i5100_spddata_rdo(u16 a)
    {
    return a >> 15 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_spddata_sbe(a: u16) -> u16 {
    static inline u16 i5100_spddata_sbe(u16 a)
    {
    return a >> 13 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_spddata_busy(a: u16) -> u16 {
    static inline u16 i5100_spddata_busy(u16 a)
    {
    return a >> 12 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_spddata_data(a: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn i5100_tolm_tolm(a: u16) -> u16 {
    static inline u16 i5100_tolm_tolm(u16 a)
    {
    return a >> 12 & ((1 << 4) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mir_limit(a: u16) -> u16 {
    static inline u16 i5100_mir_limit(u16 a)
    {
    return a >> 4 & ((1 << 12) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mir_way1(a: u16) -> u16 {
    static inline u16 i5100_mir_way1(u16 a)
    {
    return a >> 1 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mir_way0(a: u16) -> u16 {
    static inline u16 i5100_mir_way0(u16 a)
    {
    return a & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_ferr_nf_mem_chan_indx(a: u32) -> u32 {
    static inline u32 i5100_ferr_nf_mem_chan_indx(u32 a)
    {
    return a >> 28 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_ferr_nf_mem_any(a: u32) -> u32 {
    static inline u32 i5100_ferr_nf_mem_any(u32 a)
    {
    return a & I5100_FERR_NF_MEM_ANY_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_nerr_nf_mem_any(a: u32) -> u32 {
    static inline u32 i5100_nerr_nf_mem_any(u32 a)
    {
    return i5100_ferr_nf_mem_any(a);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_dmir_limit(a: u32) -> u32 {
    static inline u32 i5100_dmir_limit(u32 a)
    {
    return a >> 16 & ((1 << 11) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_dmir_rank(a: u32, i: u32) -> u32 {
    static inline u32 i5100_dmir_rank(u32 a, u32 i)
    {
    return a >> (4 * i) & ((1 << 2) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mtr_present(a: u16) -> u16 {
    static inline u16 i5100_mtr_present(u16 a)
    {
    return a >> 10 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mtr_ethrottle(a: u16) -> u16 {
    static inline u16 i5100_mtr_ethrottle(u16 a)
    {
    return a >> 9 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mtr_width(a: u16) -> u16 {
    static inline u16 i5100_mtr_width(u16 a)
    {
    return a >> 8 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mtr_numbank(a: u16) -> u16 {
    static inline u16 i5100_mtr_numbank(u16 a)
    {
    return a >> 6 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mtr_numrow(a: u16) -> u16 {
    static inline u16 i5100_mtr_numrow(u16 a)
    {
    return a >> 2 & ((1 << 2) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_mtr_numcol(a: u16) -> u16 {
    static inline u16 i5100_mtr_numcol(u16 a)
    {
    return a & ((1 << 2) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_validlog_redmemvalid(a: u32) -> u32 {
    static inline u32 i5100_validlog_redmemvalid(u32 a)
    {
    return a >> 2 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_validlog_recmemvalid(a: u32) -> u32 {
    static inline u32 i5100_validlog_recmemvalid(u32 a)
    {
    return a >> 1 & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_validlog_nrecmemvalid(a: u32) -> u32 {
    static inline u32 i5100_validlog_nrecmemvalid(u32 a)
    {
    return a & 1;
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_nrecmema_merr(a: u32) -> u32 {
    static inline u32 i5100_nrecmema_merr(u32 a)
    {
    return a >> 15 & ((1 << 5) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_nrecmema_bank(a: u32) -> u32 {
    static inline u32 i5100_nrecmema_bank(u32 a)
    {
    return a >> 12 & ((1 << 3) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_nrecmema_rank(a: u32) -> u32 {
    static inline u32 i5100_nrecmema_rank(u32 a)
    {
    return a >>  8 & ((1 << 3) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_nrecmemb_cas(a: u32) -> u32 {
    static inline u32 i5100_nrecmemb_cas(u32 a)
    {
    return a >> 16 & ((1 << 13) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_nrecmemb_ras(a: u32) -> u32 {
    static inline u32 i5100_nrecmemb_ras(u32 a)
    {
    return a & ((1 << 16) - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_recmema_merr(a: u32) -> u32 {
    static inline u32 i5100_recmema_merr(u32 a)
    {
    return i5100_nrecmema_merr(a);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_recmema_bank(a: u32) -> u32 {
    static inline u32 i5100_recmema_bank(u32 a)
    {
    return i5100_nrecmema_bank(a);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_recmema_rank(a: u32) -> u32 {
    static inline u32 i5100_recmema_rank(u32 a)
    {
    return i5100_nrecmema_rank(a);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_recmemb_cas(a: u32) -> u32 {
    static inline u32 i5100_recmemb_cas(u32 a)
    {
    return i5100_nrecmemb_cas(a);
    }
#[no_mangle]
pub unsafe extern "C" fn i5100_recmemb_ras(a: u32) -> u32 {
    static inline u32 i5100_recmemb_ras(u32 a)
    {
    return i5100_nrecmemb_ras(a);
    }
// some generic limits
pub const I5100_MAX_RANKS_PER_CHAN: c_int = 6;
pub const I5100_CHANNELS: c_int = 2;
pub const I5100_MAX_RANKS_PER_DIMM: c_int = 4;

pub const I5100_MAX_DIMM_SLOTS_PER_CHAN: c_int = 4;
pub const I5100_MAX_RANK_INTERLEAVE: c_int = 4;
pub const I5100_MAX_DMIRS: c_int = 5;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i5100_priv {
// ranks on each dimm -- 0 maps to not present -- obtained via SPD
    pub dimm_numrank: [c_int; I5100_CHANNELS][I5100_MAX_DIMM_SLOTS_PER_CHAN],
//
...
// map...
//
    pub dimm_csmap: [c_int; I5100_MAX_DIMM_SLOTS_PER_CHAN][I5100_MAX_RANKS_PER_DIMM],
// memory interleave range
    struct {
    pub limit: u64,
    pub way: [unsigned; 2],
    pub mir: [}; I5100_CHANNELS],
// adjusted memory interleave range register
    pub amir: [unsigned; I5100_CHANNELS],
// dimm interleave range
    struct {
    pub rank: [unsigned; I5100_MAX_RANK_INTERLEAVE],
    pub limit: u64,
    pub dmir: [}; I5100_CHANNELS][I5100_MAX_DMIRS],
// memory technology registers...
    struct {
    pub /: *mut *mut unsigned present; / 0 or 1,
    pub /: *mut *mut unsigned ethrottle; / 0 or 1,
    pub /: *mut *mut unsigned width; / 4 or 8 bits,
    pub /: *mut *mut unsigned numbank; / 2 or 3 lines,
    pub /: *mut *mut unsigned numrow; / 13 .. 16 lines,
    pub /: *mut *mut unsigned numcol; / 11 .. 12 lines,
    pub mtr: [}; I5100_CHANNELS][I5100_MAX_RANKS_PER_CHAN],
    pub /: *mut *mut u64 tolm; / top of low memory in bytes,
    pub /: *mut *mut unsigned ranksperchan; / number of ranks per channel,
    pub /: *mut *mut *mut pci_dev mc; / device 16 func 1,
    pub /: *mut *mut *mut pci_dev einj; / device 19 func 0,
    pub /: *mut *mut *mut pci_dev ch0mm; / device 21 func 0,
    pub /: *mut *mut *mut pci_dev ch1mm; / device 22 func 0,
    pub i5100_scrubbing: delayed_work,
    pub scrub_enable: c_int,
// Error injection
    pub inject_channel: u8,
    pub inject_hlinesel: u8,
    pub inject_deviceptr1: u8,
    pub inject_deviceptr2: u8,
    pub inject_eccmask1: u16,
    pub inject_eccmask2: u16,
...
// map a rank/chan to a slot number on the mainboard
    ...
    int j;
    let mut numrank: c_int = priv.dimm_numrank[chan][i];
    for (j = 0; j < numrank; j++)
...
#[no_mangle]
unsafe extern "C" fn i5100_check_error(mci: *mut mem_ctl_info) {
...
//
#[no_mangle]
unsafe extern "C" fn i5100_refresh_scrubbing(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn i5100_set_scrub_rate(mci: *mut mem_ctl_info, bandwidth: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i5100_get_scrub_rate(mci: *mut mem_ctl_info) -> c_int {
    ...
    unsigned func)
    {
    struct pci_dev *ret = core::ptr::null_mut();
    while (1) {
...
#[no_mangle]
unsafe extern "C" fn i5100_npages(mci: *mut mem_ctl_info, csrow: c_uint) -> c_ulong {
    static unsigned long i5100_npages(struct mem_ctl_info *mci, unsigned int csrow)
    {
    struct i5100_priv *priv = mci.pvt_info;
    let mut chan_rank: c_uint = i5100_csrow_to_rank(mci, csrow);
    let mut chan: c_uint = i5100_csrow_to_chan(mci, csrow);
    unsigned addr_lines;
// dimm present?
...
#[no_mangle]
unsafe extern "C" fn i5100_init_mtr(mci: *mut mem_ctl_info) {
...
//
#[no_mangle]
unsafe extern "C" fn i5100_init_dimm_csmap(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn i5100_init_csrows(mci: *mut mem_ctl_info) {
    static void i5100_init_csrows(struct mem_ctl_info *mci)
    {
    struct i5100_priv *priv = mci.pvt_info;
    struct dimm_info *dimm;
    mci_for_each_dimm(mci, dimm) {
    let mut npages: c_ulong = i5100_npages(mci, dimm.idx);
    let mut chan: c_uint = i5100_csrow_to_chan(mci, dimm.idx);
    let mut rank: c_uint = i5100_csrow_to_rank(mci, dimm.idx);
    if (!npages)
    continue;
...
#[no_mangle]
unsafe extern "C" fn i5100_set_error_reporting(pdev: *mut pci_dev, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn i5100_do_inject(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn i5100_setup_debugfs(mci: *mut mem_ctl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i5100_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i5100_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn i5100_init() -> int __init {
    static int __init i5100_init(void)
    {
    int pci_rc;
    i5100_debugfs = edac_debugfs_create_dir_at("i5100_edac", core::ptr::null_mut());
    pci_rc = pci_register_driver(&i5100_driver);
    return (pci_rc < 0) ? pci_rc : 0;
    }
#[no_mangle]
unsafe extern "C" fn i5100_exit() -> void __exit {
