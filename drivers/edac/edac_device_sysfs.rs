...
//! Source: drivers/edac/edac_device_sysfs.c
#![no_std]
...
// if parameter is zero, turn off flag, if non-zero turn on flag
    ctl_info.log_ue = (simple_strtoul(data, core::ptr::null_mut(), 0) != 0);
    return count;
    }
// 'log_ce'
...
// ctl_info, const char *data,
    ...
    {
// if parameter is zero, turn off flag, if non-zero turn on flag
    ctl_info.log_ce = (simple_strtoul(data, core::ptr::null_mut(), 0) != 0);
    return count;
    }
// 'panic_on_ue'
...
// ctl_info, const char *data,
    ...
    {
// if parameter is zero, turn off flag, if non-zero turn on flag
    ctl_info.panic_on_ue = (simple_strtoul(data, core::ptr::null_mut(), 0) != 0);
    return count;
    }
...
//
#[no_mangle]
unsafe extern "C" fn edac_device_ctrl_master_release(kobj: *mut kobject) {
...
//
#[no_mangle]
pub unsafe extern "C" fn edac_device_register_sysfs_main_kobj(edac_dev: *mut edac_device_ctl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn edac_device_unregister_sysfs_main_kobj(dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn edac_device_ctrl_instance_release(kobj: *mut kobject) {
...
pub struct instance_attribute {
    pub attr: attribute,
    pub ): *mut *mut *mut ssize_t(show) (struct edac_device_instance , char,
    pub size_t): *const *const *const *const ssize_t(store) (struct edac_device_instance , char ,,
}
...
//
    INSTANCE_ATTR(ce_count, S_IRUGO, instance_ce_count_show, core::ptr::null_mut());
    INSTANCE_ATTR(ue_count, S_IRUGO, instance_ue_count_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn edac_device_ctrl_block_release(kobj: *mut kobject) {
...
//
#[no_mangle]
unsafe extern "C" fn edac_device_create_instances(edac_dev: *mut edac_device_ctl_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn edac_device_delete_instances(edac_dev: *mut edac_device_ctl_info) {
...
// entry in the list
//
    while (sysfs_attrib.attr.name != core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn edac_device_create_sysfs(edac_dev: *mut edac_device_ctl_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn edac_device_remove_sysfs(edac_dev: *mut edac_device_ctl_info) {
