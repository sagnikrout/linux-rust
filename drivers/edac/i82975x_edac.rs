...
//! Source: drivers/edac/i82975x_edac.c
#![no_std]
...
pub const PCI_DEVICE_ID_INTEL_82975_0: c_uint = 0x277c;

pub const I82975X_NR_DIMMS: c_int = 8;

// Intel 82975X register addresses - device 0 function 0 - DRAM Controller
pub const I82975X_EAP: c_uint = 0x58	/* Dram Error Address Pointer (32b);
//
// 31:7  128 byte cache-line address
// 6:1   reserved
// 0     0: CH0; 1: CH1
//
pub const I82975X_DERRSYN: c_uint = 0x5c	/* Dram Error SYNdrome (8b);
//
// 7:0  DRAM ECC Syndrome
//
pub const I82975X_DES: c_uint = 0x5d	/* Dram ERRor DeSTination (8b);
// 0h:    Processor Memory Reads
// 1h:7h  reserved
// More - See Page 65 of Intel DocSheet.
//
pub const I82975X_ERRSTS: c_uint = 0xc8	/* Error Status Register (16b);
//
// 15:12 reserved
...
//
pub const I82975X_ERRCMD: c_uint = 0xca	/* Error Command (16b);
//
// 15:12 reserved
// 11    Thermal Sensor Event
// 10    reserved
...
// 0    ECC CE (singlebit DRAM error)
//
pub const I82975X_SMICMD: c_uint = 0xcc	/* Error Command (16b);
//
// 15:2  reserved
// 1    ECC UE (multibit DRAM error)
// 0    ECC CE (singlebit DRAM error)
//
pub const I82975X_SCICMD: c_uint = 0xce	/* Error Command (16b);
//
// 15:2  reserved
// 1    ECC UE (multibit DRAM error)
// 0    ECC CE (singlebit DRAM error)
//
pub const I82975X_XEAP: c_uint = 0xfc	/* Extended Dram Error Address Pointer (8b);
//
// 7:1   reserved
// 0     Bit32 of the Dram Error Address
//
pub const I82975X_MCHBAR: c_uint = 0x44	/*;
//
...
pub const I82975X_DRB: c_uint = 0x100	/* DRAM Row Boundary (8b x 8);
//
...
// 1:0 set to 0
//
pub const I82975X_DRB_CH0R0: c_uint = 0x100;
pub const I82975X_DRB_CH0R1: c_uint = 0x101;
pub const I82975X_DRB_CH0R2: c_uint = 0x102;
pub const I82975X_DRB_CH0R3: c_uint = 0x103;
pub const I82975X_DRB_CH1R0: c_uint = 0x180;
pub const I82975X_DRB_CH1R1: c_uint = 0x181;
pub const I82975X_DRB_CH1R2: c_uint = 0x182;
pub const I82975X_DRB_CH1R3: c_uint = 0x183;
pub const I82975X_DRA: c_uint = 0x108	/* DRAM Row Attribute (4b x 8);
...
// others = reserved
//
pub const I82975X_DRA_CH0R01: c_uint = 0x108;
pub const I82975X_DRA_CH0R23: c_uint = 0x109;
pub const I82975X_DRA_CH1R01: c_uint = 0x188;
pub const I82975X_DRA_CH1R23: c_uint = 0x189;
pub const I82975X_BNKARC: c_uint = 0x10e /* Type of device in each rank - Bank Arch (16b);
//
// 15:8  reserved
...
// 01 => 8 banks
//
pub const I82975X_C0BNKARC: c_uint = 0x10e;
pub const I82975X_C1BNKARC: c_uint = 0x18e;
pub const I82975X_DRC: c_uint = 0x120 /* DRAM Controller Mode0 (32b);
//
// 31:30 reserved
// 29    init complete
...
// 00, 01, 11 reserved
//
pub const I82975X_DRC_CH0M0: c_uint = 0x120;
pub const I82975X_DRC_CH1M0: c_uint = 0x1A0;
pub const I82975X_DRC_M1: c_uint = 0x124 /* DRAM Controller Mode1 (32b);
// 31	0=Standard Address Map
// 1=Enhanced Address Map
// 30:0	reserved
//
pub const I82975X_DRC_CH0M1: c_uint = 0x124;
pub const I82975X_DRC_CH1M1: c_uint = 0x1A4;
    enum i82975x_chips {
    I82975X = 0,
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i82975x_pvt {
    pub mch_window: *mut void __iomem,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i82975x_dev_info {
    pub ctl_name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i82975x_error_info {
    pub errsts: u16,
    pub eap: u32,
    pub des: u8,
    pub derrsyn: u8,
    pub errsts2: u16,
    pub /: *mut *mut u8 chan; / the channel is bit 0 of EAP,
    pub /: *mut *mut u8 xeap; / extended eap bit,
}
...
//
    let mut i82975x_registered: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn i82975x_check(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn dual_channel_active(mch_window: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i82975x_print_dram_timings(mch_window: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn i82975x_probe1(pdev: *mut pci_dev, dev_idx: c_int) -> c_int {
...
// returns count (>= 0), or negative on error
    ...
    if (mci_pdev == core::ptr::null_mut())
    mci_pdev = pci_dev_get(pdev);
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn i82975x_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn i82975x_init() -> int __init {
...
// Ensure that the OPSTATE is set correctly for POLL or NMI
    ...
    PCI_DEVICE_ID_INTEL_82975_0, core::ptr::null_mut());
    if (!mci_pdev) {
...
#[no_mangle]
unsafe extern "C" fn i82975x_exit() -> void __exit {
