...
//! Source: drivers/edac/al_mc_edac.c
#![no_std]
...
// Registers Offset
pub const AL_MC_ECC_CFG: c_uint = 0x70;
pub const AL_MC_ECC_CLEAR: c_uint = 0x7c;
pub const AL_MC_ECC_ERR_COUNT: c_uint = 0x80;
pub const AL_MC_ECC_CE_ADDR0: c_uint = 0x84;
pub const AL_MC_ECC_CE_ADDR1: c_uint = 0x88;
pub const AL_MC_ECC_UE_ADDR0: c_uint = 0xa4;
pub const AL_MC_ECC_UE_ADDR1: c_uint = 0xa8;
pub const AL_MC_ECC_CE_SYND0: c_uint = 0x8c;
pub const AL_MC_ECC_CE_SYND1: c_uint = 0x90;
pub const AL_MC_ECC_CE_SYND2: c_uint = 0x94;
pub const AL_MC_ECC_UE_SYND0: c_uint = 0xac;
pub const AL_MC_ECC_UE_SYND1: c_uint = 0xb0;
pub const AL_MC_ECC_UE_SYND2: c_uint = 0xb4;
// Registers Fields

pub const AL_MC_EDAC_MSG_MAX: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct al_mc_edac {
...
#[no_mangle]
unsafe extern "C" fn handle_ce(mci: *mut mem_ctl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_ue(mci: *mut mem_ctl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn al_mc_edac_check(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn al_mc_edac_irq_handler_ue(irq: c_int, info: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn al_mc_edac_irq_handler_ce(irq: c_int, info: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn get_scrub_mode(mmio_base: *mut void __iomem) -> enum scrub_type {
...
#[no_mangle]
unsafe extern "C" fn devm_al_mc_edac_free(data: *mut c_void) {
    static void devm_al_mc_edac_free(void *data)
    {
    edac_mc_free(data);
    }
#[no_mangle]
unsafe extern "C" fn devm_al_mc_edac_del(data: *mut c_void) {
    static void devm_al_mc_edac_del(void *data)
    {
    edac_mc_del_mc(data);
    }
#[no_mangle]
unsafe extern "C" fn al_mc_edac_probe(pdev: *mut platform_device) -> c_int {
