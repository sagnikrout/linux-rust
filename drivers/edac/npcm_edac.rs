...
//! Source: drivers/edac/npcm_edac.c
#![no_std]
...
pub const EDAC_MSG_SIZE: c_int = 256;
// chip serials

// syndrome values
pub const UE_SYNDROME: c_uint = 0x03;
// error injection
pub const ERROR_TYPE_CORRECTABLE: c_int = 0;
pub const ERROR_TYPE_UNCORRECTABLE: c_int = 1;
pub const ERROR_LOCATION_DATA: c_int = 0;
pub const ERROR_LOCATION_CHECKCODE: c_int = 1;
pub const ERROR_BIT_DATA_MAX: c_int = 63;
pub const ERROR_BIT_CHECKCODE_MAX: c_int = 7;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm_platform_data {
// chip serials
    pub chip: c_int,
// memory controller registers
    pub ctl_ecc_en: u32,
    pub ctl_int_status: u32,
    pub ctl_int_ack: u32,
    pub ctl_int_mask_master: u32,
    pub ctl_int_mask_ecc: u32,
    pub ctl_ce_addr_l: u32,
    pub ctl_ce_addr_h: u32,
    pub ctl_ce_data_l: u32,
    pub ctl_ce_data_h: u32,
    pub ctl_ce_synd: u32,
    pub ctl_ue_addr_l: u32,
    pub ctl_ue_addr_h: u32,
    pub ctl_ue_data_l: u32,
    pub ctl_ue_data_h: u32,
    pub ctl_ue_synd: u32,
    pub ctl_source_id: u32,
    pub ctl_controller_busy: u32,
    pub ctl_xor_check_bits: u32,
// masks and shifts
    pub ecc_en_mask: u32,
    pub int_status_ce_mask: u32,
    pub int_status_ue_mask: u32,
    pub int_ack_ce_mask: u32,
    pub int_ack_ue_mask: u32,
    pub int_mask_master_non_ecc_mask: u32,
    pub int_mask_master_global_mask: u32,
    pub int_mask_ecc_non_event_mask: u32,
    pub ce_addr_h_mask: u32,
    pub ce_synd_mask: u32,
    pub ce_synd_shift: u32,
    pub ue_addr_h_mask: u32,
    pub ue_synd_mask: u32,
    pub ue_synd_shift: u32,
    pub source_id_ce_mask: u32,
    pub source_id_ce_shift: u32,
    pub source_id_ue_mask: u32,
    pub source_id_ue_shift: u32,
    pub controller_busy_mask: u32,
    pub xor_check_bits_mask: u32,
    pub xor_check_bits_shift: u32,
    pub writeback_en_mask: u32,
    pub fwc_mask: u32,
}
...
pub struct priv_data {
    ...
    pub message: [c_char; EDAC_MSG_SIZE],
    pub pdata: *const npcm_platform_data,
// error injection
...
#[no_mangle]
unsafe extern "C" fn handle_ce(mci: *mut mem_ctl_info) {
    static void handle_ce(struct mem_ctl_info *mci)
    {
    struct priv_data *priv = mci.pvt_info;
    const struct npcm_platform_data *pdata;
    let mut val_h: u32 = 0, val_l, id, synd;
    let mut addr: u64 = 0, data = 0;
    pdata = priv.pdata;
...
#[no_mangle]
unsafe extern "C" fn handle_ue(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn edac_ecc_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn setup_debugfs(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn setup_irq(mci: *mut mem_ctl_info, pdev: *mut platform_device) -> c_int {
