...
//! Source: drivers/edac/i10nm_base.c
#![no_std]
...
pub const I10NM_GNR_IMC_MMIO_OFFSET: c_uint = 0x24c000;
pub const I10NM_GNR_D_IMC_MMIO_OFFSET: c_uint = 0x206000;
pub const I10NM_GNR_IMC_MMIO_SIZE: c_uint = 0x4000;
pub const I10NM_HBM_IMC_MMIO_SIZE: c_uint = 0x9000;

pub const I10NM_MAX_SAD: c_int = 16;
...
//
#[no_mangle]
unsafe extern "C" fn i10nm_get_imc_num(cfg: *mut res_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i10nm_check_2lm(cfg: *mut res_config) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn i10nm_mscod_is_ddrt(mscod: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i10nm_mc_decode_available(mce: *mut mce) -> bool {
    static bool i10nm_mc_decode_available(struct mce *mce)
    {
pub const ICX_IMCx_CHy: c_uint = 0x06666000;
    u8 bank;
...
#[no_mangle]
unsafe extern "C" fn i10nm_mc_decode(res: *mut decoded_addr) -> bool {
...
//
    ...
    {
pub const GNR_MAX_IMC_PCI_CNT: c_int = 28;
    struct pci_dev *mdev;
    int i, logical = 0;
//
...
#[no_mangle]
unsafe extern "C" fn get_gnr_imc_mmio_offset() -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn i10nm_imc_absent(imc: *mut skx_imc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i10nm_get_ddr_munits() -> c_int {
    ...
    pci_dev_put(mdev);
    iounmap(mbase);
    d.imc[lmc].mbase = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn i10nm_check_hbm_imc(d: *mut skx_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i10nm_get_hbm_munits() -> c_int {
    ...
    d.imc[lmc].mdev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn i10nm_check_ecc(imc: *mut skx_imc, chan: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i10nm_channel_disabled(imc: *mut skx_imc, chan: c_int) -> bool {
    static bool i10nm_channel_disabled(struct skx_imc *imc, int chan)
    {
    let mut mcmtr: u32 = I10NM_GET_MCMTR(imc, chan);
    ...
    imc, i, j, cfg);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_NVDIMM_PRESENT(mcddrtcfg, _arg: j)) -> else {
...
#[no_mangle]
unsafe extern "C" fn i10nm_init() -> int __init {
    static int __init i10nm_init(void)
    {
    let mut mc: u8 = 0, src_id = 0;
...
#[no_mangle]
unsafe extern "C" fn i10nm_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn set_decoding_via_mca(buf: *const c_char, kp: *const kernel_param) -> c_int {
