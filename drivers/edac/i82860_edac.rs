...
//! Source: drivers/edac/i82860_edac.c
#![no_std]
...
pub const PCI_DEVICE_ID_INTEL_82860_0: c_uint = 0x2531;

pub const I82860_MCHCFG: c_uint = 0x50;
pub const I82860_GBA: c_uint = 0x60;
pub const I82860_GBA_MASK: c_uint = 0x7FF;
pub const I82860_GBA_SHIFT: c_int = 24;
pub const I82860_ERRSTS: c_uint = 0xC8;
pub const I82860_EAP: c_uint = 0xE4;
pub const I82860_DERRCTL_STS: c_uint = 0xE2;
    enum i82860_chips {
    I82860 = 0,
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i82860_dev_info {
    pub ctl_name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i82860_error_info {
    pub errsts: u16,
    pub eap: u32,
    pub derrsyn: u16,
    pub errsts2: u16,
...
#[no_mangle]
unsafe extern "C" fn i82860_check(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn i82860_init_csrows(mci: *mut mem_ctl_info, pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn i82860_probe1(pdev: *mut pci_dev, dev_idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i82860_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn i82860_init() -> int __init {
...
// Ensure that the OPSTATE is set correctly for POLL or NMI
    ...
    PCI_DEVICE_ID_INTEL_82860_0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn i82860_exit() -> void __exit {
