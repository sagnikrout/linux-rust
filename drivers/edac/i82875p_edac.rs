...
//! Source: drivers/edac/i82875p_edac.c
#![no_std]
...
pub const PCI_DEVICE_ID_INTEL_82875_0: c_uint = 0x2578;

pub const PCI_DEVICE_ID_INTEL_82875_6: c_uint = 0x257e;

// four csrows in dual channel, eight in single channel
pub const I82875P_NR_DIMMS: c_int = 8;

// Intel 82875p register addresses - device 0 function 0 - DRAM Controller
pub const I82875P_EAP: c_uint = 0x58	/* Error Address Pointer (32b);
//
// 31:12 block address
// 11:0  reserved
//
pub const I82875P_DERRSYN: c_uint = 0x5c	/* DRAM Error Syndrome (8b);
//
// 7:0  DRAM ECC Syndrome
//
pub const I82875P_DES: c_uint = 0x5d	/* DRAM Error Status (8b);
//
// 7:1  reserved
// 0    Error channel 0/1
//
pub const I82875P_ERRSTS: c_uint = 0xc8	/* Error Status Register (16b);
//
// 15:10 reserved
...
// 0    ECC CE
//
pub const I82875P_ERRCMD: c_uint = 0xca	/* Error Command (16b);
//
// 15:10 reserved
...
pub const I82875P_PCICMD6: c_uint = 0x04	/* PCI Command Register (16b);
//
// 15:10 reserved
...
//
pub const I82875P_BAR6: c_uint = 0x10	/* Mem Delays Base ADDR Reg (32b);
//
...
pub const I82875P_DRB: c_uint = 0x00	/* DRAM Row Boundary (8b x 8);
//
// 7    reserved
// 6:0  64MiB row boundary addr
//
pub const I82875P_DRA: c_uint = 0x10	/* DRAM Row Attribute (4b x 8);
//
// 7    reserved
// 6:4  row attr row 1
// 3    reserved
...
// 011 = 32KiB
//
pub const I82875P_DRC: c_uint = 0x68	/* DRAM Controller Mode (32b);
//
// 31:30 reserved
// 29    init complete
// 28:23 reserved
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i82875p_pvt {
    pub ovrfl_pdev: *mut pci_dev,
    pub ovrfl_window: *mut void __iomem,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i82875p_dev_info {
    pub ctl_name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i82875p_error_info {
    pub errsts: u16,
    pub eap: u32,
    pub des: u8,
    pub derrsyn: u8,
...
// ovrfl_pdev = NULL;
// ovrfl_window = NULL;
    dev = pci_get_device(PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_82875_6, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn dual_channel_active(drc: u32) -> c_int {
    ...
    let mut nr_chans: unsigned = dual_channel_active(drc) + 1;
...
#[no_mangle]
unsafe extern "C" fn i82875p_probe1(pdev: *mut pci_dev, dev_idx: c_int) -> c_int {
...
unsafe extern "C" fn i82875p_remove_one(pdev: *mut pci_dev) {
    ...
    {
    struct mem_ctl_info *mci;
    struct i82875p_pvt *pvt = core::ptr::null_mut();
    edac_dbg(0, "\n");
    if (i82875p_pci)
...
#[no_mangle]
unsafe extern "C" fn i82875p_init() -> int __init {
...
// Ensure that the OPSTATE is set correctly for POLL or NMI
    ...
    PCI_DEVICE_ID_INTEL_82875_0, core::ptr::null_mut());
    if (!mci_pdev) {
...
#[no_mangle]
unsafe extern "C" fn i82875p_exit() -> void __exit {
