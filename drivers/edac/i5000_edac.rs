...
//! Source: drivers/edac/i5000_edac.c
#![no_std]
...
pub const PCI_DEVICE_ID_INTEL_FBD_0: c_uint = 0x25F5;

pub const PCI_DEVICE_ID_INTEL_FBD_1: c_uint = 0x25F6;
...
//
pub const PCI_DEVICE_ID_INTEL_I5000_DEV16: c_uint = 0x25F0;
// OFFSETS for Function 0
// OFFSETS for Function 1
pub const AMBASE: c_uint = 0x48;
pub const MAXCH: c_uint = 0x56;
pub const MAXDIMMPERCH: c_uint = 0x57;
pub const TOLM: c_uint = 0x6C;
pub const REDMEMB: c_uint = 0x7C;

pub const MIR0: c_uint = 0x80;
pub const MIR1: c_uint = 0x84;
pub const MIR2: c_uint = 0x88;
pub const AMIR0: c_uint = 0x8C;
pub const AMIR1: c_uint = 0x90;
pub const AMIR2: c_uint = 0x94;
pub const FERR_FAT_FBD: c_uint = 0x98;
pub const NERR_FAT_FBD: c_uint = 0x9C;

pub const FERR_FAT_FBDCHAN: c_uint = 0x30000000;
pub const FERR_FAT_M3ERR: c_uint = 0x00000004;
pub const FERR_FAT_M2ERR: c_uint = 0x00000002;
pub const FERR_FAT_M1ERR: c_uint = 0x00000001;

    FERR_FAT_M2ERR | \
    FERR_FAT_M3ERR)
pub const FERR_NF_FBD: c_uint = 0xA0;
// Thermal and SPD or BFD errors
pub const FERR_NF_M28ERR: c_uint = 0x01000000;
pub const FERR_NF_M27ERR: c_uint = 0x00800000;
pub const FERR_NF_M26ERR: c_uint = 0x00400000;
pub const FERR_NF_M25ERR: c_uint = 0x00200000;
pub const FERR_NF_M24ERR: c_uint = 0x00100000;
pub const FERR_NF_M23ERR: c_uint = 0x00080000;
pub const FERR_NF_M22ERR: c_uint = 0x00040000;
pub const FERR_NF_M21ERR: c_uint = 0x00020000;
// Correctable errors
pub const FERR_NF_M20ERR: c_uint = 0x00010000;
pub const FERR_NF_M19ERR: c_uint = 0x00008000;
pub const FERR_NF_M18ERR: c_uint = 0x00004000;
pub const FERR_NF_M17ERR: c_uint = 0x00002000;
// Non-Retry or redundant Retry errors
pub const FERR_NF_M16ERR: c_uint = 0x00001000;
pub const FERR_NF_M15ERR: c_uint = 0x00000800;
pub const FERR_NF_M14ERR: c_uint = 0x00000400;
pub const FERR_NF_M13ERR: c_uint = 0x00000200;
// Uncorrectable errors
pub const FERR_NF_M12ERR: c_uint = 0x00000100;
pub const FERR_NF_M11ERR: c_uint = 0x00000080;
pub const FERR_NF_M10ERR: c_uint = 0x00000040;
pub const FERR_NF_M9ERR: c_uint = 0x00000020;
pub const FERR_NF_M8ERR: c_uint = 0x00000010;
pub const FERR_NF_M7ERR: c_uint = 0x00000008;
pub const FERR_NF_M6ERR: c_uint = 0x00000004;
pub const FERR_NF_M5ERR: c_uint = 0x00000002;
pub const FERR_NF_M4ERR: c_uint = 0x00000001;
...
pub const EMASK_FBD_M28ERR: c_uint = 0x08000000;
pub const EMASK_FBD_M27ERR: c_uint = 0x04000000;
pub const EMASK_FBD_M26ERR: c_uint = 0x02000000;
pub const EMASK_FBD_M25ERR: c_uint = 0x01000000;
pub const EMASK_FBD_M24ERR: c_uint = 0x00800000;
pub const EMASK_FBD_M23ERR: c_uint = 0x00400000;
pub const EMASK_FBD_M22ERR: c_uint = 0x00200000;
pub const EMASK_FBD_M21ERR: c_uint = 0x00100000;
pub const EMASK_FBD_M20ERR: c_uint = 0x00080000;
pub const EMASK_FBD_M19ERR: c_uint = 0x00040000;
pub const EMASK_FBD_M18ERR: c_uint = 0x00020000;
pub const EMASK_FBD_M17ERR: c_uint = 0x00010000;
pub const EMASK_FBD_M15ERR: c_uint = 0x00004000;
pub const EMASK_FBD_M14ERR: c_uint = 0x00002000;
pub const EMASK_FBD_M13ERR: c_uint = 0x00001000;
pub const EMASK_FBD_M12ERR: c_uint = 0x00000800;
pub const EMASK_FBD_M11ERR: c_uint = 0x00000400;
pub const EMASK_FBD_M10ERR: c_uint = 0x00000200;
pub const EMASK_FBD_M9ERR: c_uint = 0x00000100;
pub const EMASK_FBD_M8ERR: c_uint = 0x00000080;
pub const EMASK_FBD_M7ERR: c_uint = 0x00000040;
pub const EMASK_FBD_M6ERR: c_uint = 0x00000020;
pub const EMASK_FBD_M5ERR: c_uint = 0x00000010;
pub const EMASK_FBD_M4ERR: c_uint = 0x00000008;
pub const EMASK_FBD_M3ERR: c_uint = 0x00000004;
pub const EMASK_FBD_M2ERR: c_uint = 0x00000002;
pub const EMASK_FBD_M1ERR: c_uint = 0x00000001;
...
pub const NRECFGLOG: c_uint = 0xC4;
pub const NREEECFBDA: c_uint = 0xC8;
pub const NREEECFBDB: c_uint = 0xCC;
pub const NREEECFBDC: c_uint = 0xD0;
pub const NREEECFBDD: c_uint = 0xD4;
pub const NREEECFBDE: c_uint = 0xD8;
pub const REDMEMA: c_uint = 0xDC;
pub const RECMEMA: c_uint = 0xE2;

pub const RECMEMB: c_uint = 0xE4;

pub const RECFGLOG: c_uint = 0xE8;
pub const RECFBDA: c_uint = 0xEC;
pub const RECFBDB: c_uint = 0xF0;
pub const RECFBDC: c_uint = 0xF4;
pub const RECFBDD: c_uint = 0xF8;
pub const RECFBDE: c_uint = 0xFC;
...
//
pub const PCI_DEVICE_ID_I5000_BRANCH_0: c_uint = 0x25F5;
pub const PCI_DEVICE_ID_I5000_BRANCH_1: c_uint = 0x25F6;
pub const AMB_PRESENT_0: c_uint = 0x64;
pub const AMB_PRESENT_1: c_uint = 0x66;
pub const MTR0: c_uint = 0x80;
pub const MTR1: c_uint = 0x84;
pub const MTR2: c_uint = 0x88;
pub const MTR3: c_uint = 0x8C;
pub const NUM_MTRS: c_int = 4;
...
//
    ...
    char *specific = core::ptr::null_mut();
    u32 allErrors;
    int channel;
    int bank;
    int rank;
...
//
#[no_mangle]
unsafe extern "C" fn i5000_clear_error(mci: *mut mem_ctl_info) {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_check_error(mci: *mut mem_ctl_info) {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_get_devices(mci: *mut mem_ctl_info, dev_idx: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_put_devices(mci: *mut mem_ctl_info) {
...
//
#[no_mangle]
unsafe extern "C" fn determine_amb_present_reg(pvt: *mut i5000_pvt, channel: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn determine_mtr(pvt: *mut i5000_pvt, slot: c_int, channel: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn calculate_dimm_size(pvt: *mut i5000_pvt) {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_get_mc_regs(mci: *mut mem_ctl_info) {
...
// Get the MTR[0-3] regs
    ...
    let mut where: c_int = MTR0 + (slot_row * sizeof(u32));
...
//
#[no_mangle]
unsafe extern "C" fn i5000_init_csrows(mci: *mut mem_ctl_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_set_error_reporting(mci: *mut mem_ctl_info, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_probe1(pdev: *mut pci_dev, dev_idx: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_remove_one(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn i5000_exit() -> void __exit {
