...
//! Source: drivers/edac/imh_base.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __read_local_reg(reg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn read_local_reg(reg: *mut local_reg) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_imc_bitmap(cfg: *mut res_config, pkg: c_int, north: bool) -> u32 {
...
unsafe extern "C" fn imc_release(dev: *mut device) {
    ...
    bool north, int lmc)
    {
    let mut size: c_ulong = cfg.ddr_chan_mmio_sz * cfg.ddr_chan_num;
    let mut bitmap: c_ulong = get_imc_bitmap(cfg, d.pkg, north);
    void __iomem *mbase;
    struct device *dev;
    int i, rc, pmc;
    u64 base;
...
#[no_mangle]
unsafe extern "C" fn get_ddr_munits(cfg: *mut res_config, d: *mut skx_dev) -> bool {
    static bool get_ddr_munits(struct res_config *cfg, struct skx_dev *d)
    {
    let mut lmc: c_int = __get_ddr_munits(cfg, d, true, 0);
    if (lmc < 0)
    return false;
...
#[no_mangle]
unsafe extern "C" fn get_socket_id(cfg: *mut res_config, d: *mut skx_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imh_get_tolm_tohm(cfg: *mut res_config, tolm: *mut u64, tohm: *mut u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imh_get_all_mmio_base_h(cfg: *mut res_config, edac_list: *mut list_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imh_get_imc_num(cfg: *mut res_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imh_get_munits(cfg: *mut res_config, edac_list: *mut list_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_2lm_enabled(cfg: *mut res_config, d: *mut skx_dev, ha_idx: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imh_2lm_enabled(cfg: *mut res_config, head: *mut list_head) -> bool {
...
#[no_mangle]
unsafe extern "C" fn read_imc_mcmtr(cfg: *mut res_config, imc: *mut skx_imc, chan: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn read_imc_dimmmtr(cfg: *mut res_config, imc: *mut skx_imc, chan: c_int, dimm: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ecc_enabled(mcmtr: u32) -> bool {
    static bool ecc_enabled(u32 mcmtr)
    {
    return (bool)ECC_ENABLED(mcmtr);
    }
#[no_mangle]
unsafe extern "C" fn dimm_populated(dimmmtr: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn imh_get_dimm_config(mci: *mut mem_ctl_info, cfg: *mut res_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imh_register_mci(cfg: *mut res_config, edac_list: *mut list_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imh_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn imh_exit() -> void __exit {
    ...
    skx_set_show_rrl(core::ptr::null_mut());
    }
    skx_teardown_debug();
