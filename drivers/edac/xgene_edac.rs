...
//! Source: drivers/edac/xgene_edac.c
#![no_std]
...
pub const PCPHPERRINTSTS: c_uint = 0x0000;
pub const PCPHPERRINTMSK: c_uint = 0x0004;

pub const PCPLPERRINTSTS: c_uint = 0x0008;
pub const PCPLPERRINTMSK: c_uint = 0x000C;

pub const MEMERRINTSTS: c_uint = 0x0010;
pub const MEMERRINTMSK: c_uint = 0x0014;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_edac {
    pub dev: *mut device,
    pub csw_map: *mut regmap,
    pub mcba_map: *mut regmap,
    pub mcbb_map: *mut regmap,
    pub efuse_map: *mut regmap,
    pub rb_map: *mut regmap,
    pub pcp_csr: *mut void __iomem,
    pub lock: spinlock_t,
    pub dfs: *mut dentry,
    pub mcus: list_head,
    pub pmds: list_head,
    ...
    pub socs: list_head,
    pub mc_lock: mutex,
    pub mc_active_mask: c_int,
    pub mc_registered_mask: c_int,
}

#[no_mangle]
unsafe extern "C" fn xgene_edac_pcp_rd(edac: *mut xgene_edac, reg: u32, val: *mut u32) {
...
pub const MCU_MAX_RANK: c_int = 8;
pub const MCU_RANK_STRIDE: c_uint = 0x40;
pub const MCUGECR: c_uint = 0x0110;

pub const MCUGESR: c_uint = 0x0114;

pub const MCUESRR0: c_uint = 0x0314;

pub const MCUESRRA0: c_uint = 0x0318;
pub const MCUEBLRR0: c_uint = 0x031c;

pub const MCUERCRR0: c_uint = 0x0320;

pub const MCUSBECNT0: c_uint = 0x0324;
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_mc_create_debugfs_node(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_mc_check(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_mc_irq_ctl(mci: *mut mem_ctl_info, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_mc_is_active(ctx: *mut xgene_edac_mc_ctx, mc_idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_mc_add(edac: *mut xgene_edac, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_mc_remove(mcu: *mut xgene_edac_mc_ctx) -> c_int {
...
// CPU L1/L2 error CSR
pub const MAX_CPU_PER_PMD: c_int = 2;
pub const CPU_CSR_STRIDE: c_uint = 0x00100000;
pub const CPU_L2C_PAGE: c_uint = 0x000D0000;
pub const CPU_MEMERR_L2C_PAGE: c_uint = 0x000E0000;
pub const CPU_MEMERR_CPU_PAGE: c_uint = 0x000F0000;
pub const MEMERR_CPU_ICFECR_PAGE_OFFSET: c_uint = 0x0000;
pub const MEMERR_CPU_ICFESR_PAGE_OFFSET: c_uint = 0x0004;

pub const MEMERR_CPU_LSUESR_PAGE_OFFSET: c_uint = 0x000c;

pub const MEMERR_CPU_LSUECR_PAGE_OFFSET: c_uint = 0x0008;
pub const MEMERR_CPU_MMUECR_PAGE_OFFSET: c_uint = 0x0010;
pub const MEMERR_CPU_MMUESR_PAGE_OFFSET: c_uint = 0x0014;

pub const MEMERR_CPU_ICFESRA_PAGE_OFFSET: c_uint = 0x0804;
pub const MEMERR_CPU_LSUESRA_PAGE_OFFSET: c_uint = 0x080c;
pub const MEMERR_CPU_MMUESRA_PAGE_OFFSET: c_uint = 0x0814;
pub const MEMERR_L2C_L2ECR_PAGE_OFFSET: c_uint = 0x0000;
pub const MEMERR_L2C_L2ESR_PAGE_OFFSET: c_uint = 0x0004;

pub const MEMERR_L2C_L2EALR_PAGE_OFFSET: c_uint = 0x0008;
pub const CPUX_L2C_L2RTOCR_PAGE_OFFSET: c_uint = 0x0010;
pub const MEMERR_L2C_L2EAHR_PAGE_OFFSET: c_uint = 0x000c;
pub const CPUX_L2C_L2RTOSR_PAGE_OFFSET: c_uint = 0x0014;

pub const CPUX_L2C_L2RTOALR_PAGE_OFFSET: c_uint = 0x0018;
pub const CPUX_L2C_L2RTOAHR_PAGE_OFFSET: c_uint = 0x001c;
pub const MEMERR_L2C_L2ESRA_PAGE_OFFSET: c_uint = 0x0804;
//
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_pmd_l2_check(edac_dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_pmd_check(edac_dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_pmd_hw_cfg(edac_dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_pmd_available(efuse: u32, pmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_pmd_remove(pmd: *mut xgene_edac_pmd_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xgene_edac_l3_promote_to_uc_err(l3cesr: u32, l3celr: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_l3_check(edac_dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_l3_remove(l3: *mut xgene_edac_dev_ctx) -> c_int {
...
// SoC error device
pub const IOBAXIS0TRANSERRINTSTS: c_uint = 0x0000;

pub const IOBAXIS0TRANSERRINTMSK: c_uint = 0x0004;
pub const IOBAXIS0TRANSERRREQINFOL: c_uint = 0x0008;
pub const IOBAXIS0TRANSERRREQINFOH: c_uint = 0x000c;

pub const IOBAXIS1TRANSERRINTSTS: c_uint = 0x0010;
pub const IOBAXIS1TRANSERRINTMSK: c_uint = 0x0014;
pub const IOBAXIS1TRANSERRREQINFOL: c_uint = 0x0018;
pub const IOBAXIS1TRANSERRREQINFOH: c_uint = 0x001c;
pub const IOBPATRANSERRINTSTS: c_uint = 0x0020;

pub const IOBBATRANSERRINTSTS: c_uint = 0x0030;

pub const IOBBATRANSERRREQINFOL: c_uint = 0x0038;
pub const IOBBATRANSERRREQINFOH: c_uint = 0x003c;

pub const IOBBATRANSERRCSWREQID: c_uint = 0x0040;
pub const XGICTRANSERRINTSTS: c_uint = 0x0050;

pub const XGICTRANSERRINTMSK: c_uint = 0x0054;
pub const XGICTRANSERRREQINFO: c_uint = 0x0058;

pub const GLBL_ERR_STS: c_uint = 0x0800;

pub const GLBL_SEC_ERRL: c_uint = 0x0810;
pub const GLBL_SEC_ERRH: c_uint = 0x0818;
pub const GLBL_MSEC_ERRL: c_uint = 0x0820;
pub const GLBL_MSEC_ERRH: c_uint = 0x0828;
pub const GLBL_DED_ERRL: c_uint = 0x0830;
pub const GLBL_DED_ERRLMASK: c_uint = 0x0834;
pub const GLBL_DED_ERRH: c_uint = 0x0838;
pub const GLBL_DED_ERRHMASK: c_uint = 0x083c;
pub const GLBL_MDED_ERRL: c_uint = 0x0840;
pub const GLBL_MDED_ERRLMASK: c_uint = 0x0844;
pub const GLBL_MDED_ERRH: c_uint = 0x0848;
pub const GLBL_MDED_ERRHMASK: c_uint = 0x084c;
// IO Bus Registers
pub const RBCSR: c_uint = 0x0000;

pub const RBEIR: c_uint = 0x0008;
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_iob_gic_report(edac_dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_rb_report(edac_dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_pa_report(edac_dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_soc_check(edac_dev: *mut edac_device_ctl_info) {
    static void xgene_edac_soc_check(struct edac_device_ctl_info *edac_dev)
    {
    struct xgene_edac_dev_ctx *ctx = edac_dev.pvt_info;
    const char * const *soc_mem_err = core::ptr::null_mut();
    u32 pcp_hp_stat;
    u32 pcp_lp_stat;
    u32 reg;
    int i;
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_soc_remove(soc: *mut xgene_edac_dev_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xgene_edac_exit() -> void __exit {
