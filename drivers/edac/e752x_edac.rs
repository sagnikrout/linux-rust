...
//! Source: drivers/edac/e752x_edac.c
#![no_std]
...
//
    ...
    let mut sysbus_parity: static int = -1;
...
pub const PCI_DEVICE_ID_INTEL_7520_0: c_uint = 0x3590;

pub const PCI_DEVICE_ID_INTEL_7520_1_ERR: c_uint = 0x3591;

pub const PCI_DEVICE_ID_INTEL_7525_0: c_uint = 0x359E;

pub const PCI_DEVICE_ID_INTEL_7525_1_ERR: c_uint = 0x3593;

pub const PCI_DEVICE_ID_INTEL_7320_0: c_uint = 0x3592;

pub const PCI_DEVICE_ID_INTEL_7320_1_ERR: c_uint = 0x3593;

pub const PCI_DEVICE_ID_INTEL_3100_0: c_uint = 0x35B0;

pub const PCI_DEVICE_ID_INTEL_3100_1_ERR: c_uint = 0x35B1;

// E752X register addresses - device 0 function 0
pub const E752X_MCHSCRB: c_uint = 0x52	/* Memory Scrub register (16b) */;
//
...
// 00=off 10=on
//
pub const E752X_DRB: c_uint = 0x60	/* DRAM row boundary register (8b) */;
pub const E752X_DRA: c_uint = 0x70	/* DRAM row attribute register (8b) */;
//
...
//
pub const E752X_DRC: c_uint = 0x7C	/* DRAM controller mode reg (32b) */;
// FIXME:IS THIS RIGHT?
//
// 22    Number channels 0=1,1=2
// 19:18 DRB Granularity 32/64MB
//
pub const E752X_DRM: c_uint = 0x80	/* Dimm mapping register */;
pub const E752X_DDRCSR: c_uint = 0x9A	/* DDR control and status reg (16b) */;
//
// 14:12 1 single A, 2 single B, 3 dual
//
pub const E752X_TOLM: c_uint = 0xC4	/* DRAM top of low memory reg (16b) */;
pub const E752X_REMAPBASE: c_uint = 0xC6	/* DRAM remap base address reg (16b) */;
pub const E752X_REMAPLIMIT: c_uint = 0xC8	/* DRAM remap limit address reg (16b) */;
pub const E752X_REMAPOFFSET: c_uint = 0xCA	/* DRAM remap limit offset reg (16b) */;
// E752X register addresses - device 0 function 1
pub const E752X_FERR_GLOBAL: c_uint = 0x40	/* Global first error register (32b) */;
pub const E752X_NERR_GLOBAL: c_uint = 0x44	/* Global next error register (32b) */;
pub const E752X_HI_FERR: c_uint = 0x50	/* Hub interface first error reg (8b) */;
pub const E752X_HI_NERR: c_uint = 0x52	/* Hub interface next error reg (8b) */;
pub const E752X_HI_ERRMASK: c_uint = 0x54	/* Hub interface error mask reg (8b) */;
pub const E752X_HI_SMICMD: c_uint = 0x5A	/* Hub interface SMI command reg (8b) */;
pub const E752X_SYSBUS_FERR: c_uint = 0x60	/* System buss first error reg (16b) */;
pub const E752X_SYSBUS_NERR: c_uint = 0x62	/* System buss next error reg (16b) */;
pub const E752X_SYSBUS_ERRMASK: c_uint = 0x64	/* System buss error mask reg (16b) */;
pub const E752X_SYSBUS_SMICMD: c_uint = 0x6A	/* System buss SMI command reg (16b) */;
pub const E752X_BUF_FERR: c_uint = 0x70	/* Memory buffer first error reg (8b) */;
pub const E752X_BUF_NERR: c_uint = 0x72	/* Memory buffer next error reg (8b) */;
pub const E752X_BUF_ERRMASK: c_uint = 0x74	/* Memory buffer error mask reg (8b) */;
pub const E752X_BUF_SMICMD: c_uint = 0x7A	/* Memory buffer SMI cmd reg (8b) */;
pub const E752X_DRAM_FERR: c_uint = 0x80	/* DRAM first error register (16b) */;
pub const E752X_DRAM_NERR: c_uint = 0x82	/* DRAM next error register (16b) */;
pub const E752X_DRAM_ERRMASK: c_uint = 0x84	/* DRAM error mask register (8b) */;
pub const E752X_DRAM_SMICMD: c_uint = 0x8A	/* DRAM SMI command register (8b) */;
pub const E752X_DRAM_RETR_ADD: c_uint = 0xAC	/* DRAM Retry address register (32b) */;
pub const E752X_DRAM_SEC1_ADD: c_uint = 0xA0	/* DRAM first correctable memory */;
...
// 0     HiLoCS
//
pub const E752X_DRAM_SEC2_ADD: c_uint = 0xC8	/* DRAM first correctable memory */;
// error address register (32b)
//
// 31    Reserved
// 30:2  CE address (64 byte block 34:6)
...
// 0     HiLoCS
//
pub const E752X_DRAM_DED_ADD: c_uint = 0xA4	/* DRAM first uncorrectable memory */;
// error address register (32b)
//
// 31    Reserved
// 30:2  CE address (64 byte block 34:6)
...
// 0     HiLoCS
//
pub const E752X_DRAM_SCRB_ADD: c_uint = 0xA8	/* DRAM 1st uncorrectable scrub mem */;
// error address register (32b)
//
// 31    Reserved
// 30:2  CE address (64 byte block 34:6
...
// 0     HiLoCS
//
pub const E752X_DRAM_SEC1_SYNDROME: c_uint = 0xC4	/* DRAM first correctable memory */;
// error syndrome register (16b)
pub const E752X_DRAM_SEC2_SYNDROME: c_uint = 0xC6	/* DRAM second correctable memory */;
// error syndrome register (16b)
pub const E752X_DEVPRES1: c_uint = 0xF4	/* Device Present 1 register (8b) */;
// 3100 IMCH specific register addresses - device 0 function 1
pub const I3100_NSI_FERR: c_uint = 0x48	/* NSI first error reg (32b) */;
pub const I3100_NSI_NERR: c_uint = 0x4C	/* NSI next error reg (32b) */;
pub const I3100_NSI_SMICMD: c_uint = 0x54	/* NSI SMI command register (32b) */;
pub const I3100_NSI_EMASK: c_uint = 0x90	/* NSI error mask register (32b) */;
// ICH5R register addresses - device 30 function 0
pub const ICH5R_PCI_STAT: c_uint = 0x06	/* PCI status register (16b) */;
pub const ICH5R_PCI_2ND_STAT: c_uint = 0x1E	/* PCI status secondary reg (16b) */;
pub const ICH5R_PCI_BRIDGE_CTL: c_uint = 0x3E	/* PCI bridge control register (16b) */;
    enum e752x_chips {
    E7520 = 0,
    E7525 = 1,
    E7320 = 2,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct e752x_pvt {
    pub dev_d0f0: *mut pci_dev,
    pub dev_d0f1: *mut pci_dev,
    pub tolm: u32,
    pub remapbase: u32,
    pub remaplimit: u32,
    pub mc_symmetric: c_int,
    pub map: [u8; 8],
    pub map_type: c_int,
    pub dev_info: *const e752x_dev_info,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct e752x_dev_info {
    pub err_dev: u16,
    pub ctl_dev: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct e752x_error_info {
    pub ferr_global: u32,
    pub nerr_global: u32,
    pub /: *mut *mut u32 nsi_ferr; / 3100 only,
    pub /: *mut *mut u32 nsi_nerr; / 3100 only,
    pub /: *mut *mut u8 hi_ferr; / all but 3100,
    pub /: *mut *mut u8 hi_nerr; / all but 3100,
    pub sysbus_ferr: u16,
    pub sysbus_nerr: u16,
    pub buf_ferr: u8,
    pub buf_nerr: u8,
    pub dram_ferr: u16,
    pub dram_nerr: u16,
    pub dram_sec1_add: u32,
    pub dram_sec2_add: u32,
    pub dram_sec1_syndrome: u16,
    pub dram_sec2_syndrome: u16,
    pub dram_ded_add: u32,
    pub dram_scrb_add: u32,
    pub dram_retr_add: u32,
}
...
//
pub const SDRATE_EOT: c_uint = 0xFFFFFFFF;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scrubrate {
    pub /: *mut *mut u32 bandwidth; / bandwidth consumed by scrubbing in bytes/sec,
    pub /: *mut *mut u16 scrubval; / register value for scrub rate,
}
...
pub const DRAM_ENTRY: c_int = 9;
    static char *fatal_message[2] = { "Non-Fatal ", "Fatal " };
#[no_mangle]
unsafe extern "C" fn do_global_error(fatal: c_int, errors: u32) {
...
#[no_mangle]
unsafe extern "C" fn do_hub_error(fatal: c_int, errors: u8) {
...
pub const NSI_FATAL_MASK: c_uint = 0x0c080081;
pub const NSI_NON_FATAL_MASK: c_uint = 0x23a0ba64;
...
#[no_mangle]
unsafe extern "C" fn do_nsi_error(fatal: c_int, errors: u32) {
...
#[no_mangle]
unsafe extern "C" fn do_membuf_error(errors: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn membuf_error(errors: u8, error_found: *mut c_int, handle_error: c_int) {
...
#[no_mangle]
unsafe extern "C" fn do_sysbus_error(fatal: c_int, errors: u32) {
...
#[no_mangle]
unsafe extern "C" fn e752x_check(mci: *mut mem_ctl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn dual_channel_active(ddrcsr: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn remap_csrow_index(mci: *mut mem_ctl_info, index: c_int) -> c_int {
...
// Return 0 on success or 1 on failure.
    ...
    pvt.dev_info.err_dev, core::ptr::null_mut());
    if (pvt.dev_d0f1 == core::ptr::null_mut()) {
    ...
    core::ptr::null_mut());
    if (pvt.dev_d0f0 == core::ptr::null_mut())
    goto fail;
    return 0;
    fail:
...
//
#[no_mangle]
unsafe extern "C" fn e752x_init_sysbus_parity_mask(pvt: *mut e752x_pvt) {
...
#[no_mangle]
unsafe extern "C" fn e752x_init_error_reporting_regs(pvt: *mut e752x_pvt) {
...
#[no_mangle]
unsafe extern "C" fn e752x_probe1(pdev: *mut pci_dev, dev_idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e752x_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn e752x_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn e752x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn e752x_exit() -> void __exit {
