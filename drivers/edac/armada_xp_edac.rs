...
//! Source: drivers/edac/armada_xp_edac.c
#![no_std]
...
// EDAC MC (DDR RAM)
pub const SDRAM_NUM_CS: c_int = 4;
pub const SDRAM_CONFIG_REG: c_uint = 0x0;

pub const SDRAM_ADDR_CTRL_REG: c_uint = 0x10;

pub const SDRAM_ERR_DATA_H_REG: c_uint = 0x40;
pub const SDRAM_ERR_DATA_L_REG: c_uint = 0x44;
pub const SDRAM_ERR_RECV_ECC_REG: c_uint = 0x48;
pub const SDRAM_ERR_RECV_ECC_VALUE_MASK: c_uint = 0xff;
pub const SDRAM_ERR_CALC_ECC_REG: c_uint = 0x4c;
pub const SDRAM_ERR_CALC_ECC_ROW_OFFSET: c_int = 8;

pub const SDRAM_ERR_CALC_ECC_VALUE_MASK: c_uint = 0xff;
pub const SDRAM_ERR_ADDR_REG: c_uint = 0x50;
pub const SDRAM_ERR_ADDR_BANK_OFFSET: c_int = 23;

pub const SDRAM_ERR_ADDR_COL_OFFSET: c_int = 8;

pub const SDRAM_ERR_ADDR_CS_OFFSET: c_int = 1;

pub const SDRAM_ERR_CTRL_REG: c_uint = 0x54;
pub const SDRAM_ERR_CTRL_THR_OFFSET: c_int = 16;

pub const SDRAM_ERR_SBE_COUNT_REG: c_uint = 0x58;
pub const SDRAM_ERR_DBE_COUNT_REG: c_uint = 0x5c;
pub const SDRAM_ERR_CAUSE_ERR_REG: c_uint = 0xd0;
pub const SDRAM_ERR_CAUSE_MSG_REG: c_uint = 0xd8;

pub const SDRAM_RANK_CTRL_REG: c_uint = 0x1e0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct axp_mc_drvdata {
    pub base: *mut void __iomem,
// width in bytes
    pub width: c_uint,
// bank interleaving
    pub cs_addr_sel: [bool; SDRAM_NUM_CS],
    pub msg: [c_char; 128],
}
...
#[no_mangle]
unsafe extern "C" fn axp_mc_check(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn axp_mc_read_config(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn axp_mc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp_mc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn aurora_l2_inject(drvdata: *mut aurora_l2_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn aurora_l2_check(dci: *mut edac_device_ctl_info) {
    ...
    char *msg = drvdata.msg;
    let mut size: usize = sizeof(drvdata.msg);
    let mut len: usize = 0;
...
#[no_mangle]
unsafe extern "C" fn aurora_l2_poll(dci: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn aurora_l2_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aurora_l2_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn armada_xp_edac_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn armada_xp_edac_exit() -> void __exit {
