...
//! Source: drivers/edac/i3000_edac.c
#![no_std]
...
pub const I3000_RANKS: c_int = 8;
pub const I3000_RANKS_PER_CHANNEL: c_int = 4;
pub const I3000_CHANNELS: c_int = 2;
// Intel 3000 register addresses - device 0 function 0 - DRAM Controller
pub const I3000_MCHBAR: c_uint = 0x44	/* MCH Memory Mapped Register BAR */;
pub const I3000_MCHBAR_MASK: c_uint = 0xffffc000;
pub const I3000_MMR_WINDOW_SIZE: c_int = 16384;
pub const I3000_EDEAP: c_uint = 0x70	/* Extended DRAM Error Address Pointer (8b);
//
// 7:1   reserved
// 0     bit 32 of address
//
pub const I3000_DEAP: c_uint = 0x58	/* DRAM Error Address Pointer (32b);
//
// 31:7  address
// 6:1   reserved
// 0     Error channel 0/1
...
//
#[no_mangle]
pub unsafe extern "C" fn deap_pfn(edeap: u8, deap: u32) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn deap_offset(deap: u32) -> c_ulong {
    static inline unsigned long deap_offset(u32 deap)
    {
    return deap & ~(I3000_DEAP_GRAIN - 1) & ~PAGE_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn deap_channel(deap: u32) -> c_int {
    static inline int deap_channel(u32 deap)
    {
    return deap & 1;
    }
pub const I3000_DERRSYN: c_uint = 0x5c	/* DRAM Error Syndrome (8b);
//
// 7:0  DRAM ECC Syndrome
//
pub const I3000_ERRSTS: c_uint = 0xc8	/* Error Status Register (16b);
//
// 15:12 reserved
...
//
pub const I3000_ERRSTS_BITS: c_uint = 0x0b03	/* bits which indicate errors */;
pub const I3000_ERRSTS_UE: c_uint = 0x0002;
pub const I3000_ERRSTS_CE: c_uint = 0x0001;
pub const I3000_ERRCMD: c_uint = 0xca	/* Error Command (16b);
//
// 15:12 reserved
...
pub const I3000_C0DRB: c_uint = 0x100	/* Channel 0 DRAM Rank Boundary (8b x 4);
//
// 7:0   Channel 0 DRAM Rank Boundary Address
//
pub const I3000_C1DRB: c_uint = 0x180	/* Channel 1 DRAM Rank Boundary (8b x 4);
//
// 7:0   Channel 1 DRAM Rank Boundary Address
//
pub const I3000_C0DRA: c_uint = 0x108	/* Channel 0 DRAM Rank Attribute (8b x 2);
//
// 7     reserved
...
// Others: reserved
//
pub const I3000_C1DRA: c_uint = 0x188	/* Channel 1 DRAM Rank Attribute (8b x 2) */;
#[no_mangle]
pub unsafe extern "C" fn odd_rank_attrib(dra: c_uchar) -> c_uchar {
    static inline unsigned char odd_rank_attrib(unsigned char dra)
    {
    return (dra & 0x70) >> 4;
    }
#[no_mangle]
pub unsafe extern "C" fn even_rank_attrib(dra: c_uchar) -> c_uchar {
    static inline unsigned char even_rank_attrib(unsigned char dra)
    {
    return dra & 0x07;
    }
pub const I3000_C0DRC0: c_uint = 0x120	/* DRAM Controller Mode 0 (32b);
//
// 31:30 reserved
...
// 1:0   DRAM Type (DT)
//
pub const I3000_C0DRC1: c_uint = 0x124	/* DRAM Controller Mode 1 (32b);
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i3000_dev_info {
    pub ctl_name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i3000_error_info {
    pub errsts: u16,
    pub derrsyn: u8,
    pub edeap: u8,
    pub deap: u32,
    ...
    let mut i3000_registered: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn i3000_check(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn i3000_probe1(pdev: *mut pci_dev, dev_idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3000_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i3000_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn i3000_init() -> int __init {
...
// Ensure that the OPSTATE is set correctly for POLL or NMI
    ...
    PCI_DEVICE_ID_INTEL_3000_HB, core::ptr::null_mut());
    if (!mci_pdev) {
...
#[no_mangle]
unsafe extern "C" fn i3000_exit() -> void __exit {
