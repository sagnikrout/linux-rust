...
//! Source: drivers/edac/amd76x_edac.c
#![no_std]
...
pub const AMD76X_NR_CSROWS: c_int = 8;
pub const AMD76X_NR_DIMMS: c_int = 4;
// AMD 76x register addresses - device 0 function 0 - PCI bridge
pub const AMD76X_ECC_MODE_STATUS: c_uint = 0x48	/* Mode and status of ECC (32b);
//
// 31:16 reserved
...
// 3:0  CE cs row
//
pub const AMD76X_DRAM_MODE_STATUS: c_uint = 0x58	/* DRAM Mode and status (32b);
//
...
//
pub const AMD76X_MEM_BASE_ADDR: c_uint = 0xC0	/* Memory base address (8 x 32b);
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd76x_error_info {
    pub ecc_mode_status: u32,
}
...
//
#[no_mangle]
unsafe extern "C" fn amd76x_check(mci: *mut mem_ctl_info) {
...
//
#[no_mangle]
unsafe extern "C" fn amd76x_probe1(pdev: *mut pci_dev, dev_idx: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd76x_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd76x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn amd76x_exit() -> void __exit {
