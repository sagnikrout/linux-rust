...
//! Source: drivers/edac/versal_edac.c
#![no_std]
...
pub const XDDR_EDAC_ERR_GRAIN: c_int = 1;
pub const XDDR_EDAC_MSG_SIZE: c_int = 256;
pub const EVENT: c_int = 2;
pub const XDDR_PCSR_OFFSET: c_uint = 0xC;
pub const XDDR_ISR_OFFSET: c_uint = 0x14;
pub const XDDR_IRQ_EN_OFFSET: c_uint = 0x20;
pub const XDDR_IRQ1_EN_OFFSET: c_uint = 0x2C;
pub const XDDR_IRQ_DIS_OFFSET: c_uint = 0x24;

pub const XDDR_REG_CONFIG0_OFFSET: c_uint = 0x258;

pub const XDDR_REG_PINOUT_OFFSET: c_uint = 0x25C;

pub const ECCW0_FLIP_CTRL: c_uint = 0x109C;
pub const ECCW0_FLIP0_OFFSET: c_uint = 0x10A0;
pub const ECCW0_FLIP0_BITS: c_int = 31;
pub const ECCW0_FLIP1_OFFSET: c_uint = 0x10A4;
pub const ECCW1_FLIP_CTRL: c_uint = 0x10AC;
pub const ECCW1_FLIP0_OFFSET: c_uint = 0x10B0;
pub const ECCW1_FLIP1_OFFSET: c_uint = 0x10B4;
pub const ECCR0_CERR_STAT_OFFSET: c_uint = 0x10BC;
pub const ECCR0_CE_ADDR_LO_OFFSET: c_uint = 0x10C0;
pub const ECCR0_CE_ADDR_HI_OFFSET: c_uint = 0x10C4;
pub const ECCR0_CE_DATA_LO_OFFSET: c_uint = 0x10C8;
pub const ECCR0_CE_DATA_HI_OFFSET: c_uint = 0x10CC;
pub const ECCR0_CE_DATA_PAR_OFFSET: c_uint = 0x10D0;
pub const ECCR0_UERR_STAT_OFFSET: c_uint = 0x10D4;
pub const ECCR0_UE_ADDR_LO_OFFSET: c_uint = 0x10D8;
pub const ECCR0_UE_ADDR_HI_OFFSET: c_uint = 0x10DC;
pub const ECCR0_UE_DATA_LO_OFFSET: c_uint = 0x10E0;
pub const ECCR0_UE_DATA_HI_OFFSET: c_uint = 0x10E4;
pub const ECCR0_UE_DATA_PAR_OFFSET: c_uint = 0x10E8;
pub const ECCR1_CERR_STAT_OFFSET: c_uint = 0x10F4;
pub const ECCR1_CE_ADDR_LO_OFFSET: c_uint = 0x10F8;
pub const ECCR1_CE_ADDR_HI_OFFSET: c_uint = 0x10FC;
pub const ECCR1_CE_DATA_LO_OFFSET: c_uint = 0x1100;
pub const ECCR1_CE_DATA_HI_OFFSET: c_uint = 0x110C;
pub const ECCR1_CE_DATA_PAR_OFFSET: c_uint = 0x1108;
pub const ECCR1_UERR_STAT_OFFSET: c_uint = 0x110C;
pub const ECCR1_UE_ADDR_LO_OFFSET: c_uint = 0x1110;
pub const ECCR1_UE_ADDR_HI_OFFSET: c_uint = 0x1114;
pub const ECCR1_UE_DATA_LO_OFFSET: c_uint = 0x1118;
pub const ECCR1_UE_DATA_HI_OFFSET: c_uint = 0x111C;
pub const ECCR1_UE_DATA_PAR_OFFSET: c_uint = 0x1120;
pub const XDDR_NOC_REG_ADEC4_OFFSET: c_uint = 0x44;

pub const XDDR_NOC_REG_ADEC5_OFFSET: c_uint = 0x48;
pub const XDDR_NOC_REG_ADEC6_OFFSET: c_uint = 0x4C;
pub const XDDR_NOC_REG_ADEC7_OFFSET: c_uint = 0x50;
pub const XDDR_NOC_REG_ADEC8_OFFSET: c_uint = 0x54;
pub const XDDR_NOC_REG_ADEC9_OFFSET: c_uint = 0x58;
pub const XDDR_NOC_REG_ADEC10_OFFSET: c_uint = 0x5C;
pub const XDDR_NOC_REG_ADEC11_OFFSET: c_uint = 0x60;

pub const XDDR_NOC_REG_ADEC12_OFFSET: c_uint = 0x71C;
pub const XDDR_NOC_REG_ADEC13_OFFSET: c_uint = 0x720;
pub const XDDR_NOC_REG_ADEC14_OFFSET: c_uint = 0x724;

pub const XDDR_NOC_REG_ADEC15_OFFSET: c_uint = 0x728;

pub const XDDR_EDAC_NR_CSROWS: c_int = 1;
pub const XDDR_EDAC_NR_CHANS: c_int = 1;
pub const XDDR_BUS_WIDTH_64: c_int = 0;
pub const XDDR_BUS_WIDTH_32: c_int = 1;
pub const XDDR_BUS_WIDTH_16: c_int = 2;
pub const XDDR_MAX_ROW_CNT: c_int = 18;
pub const XDDR_MAX_COL_CNT: c_int = 10;
pub const XDDR_MAX_RANK_CNT: c_int = 2;
pub const XDDR_MAX_LRANK_CNT: c_int = 3;
pub const XDDR_MAX_BANK_CNT: c_int = 2;
pub const XDDR_MAX_GRP_CNT: c_int = 2;
//
...
//
pub const PCSR_UNLOCK_VAL: c_uint = 0xF9E8D7C6;
pub const PCSR_LOCK_VAL: c_int = 1;
pub const XDDR_ERR_TYPE_CE: c_int = 0;
pub const XDDR_ERR_TYPE_UE: c_int = 1;
pub const XILINX_DRAM_SIZE_4G: c_int = 0;
pub const XILINX_DRAM_SIZE_6G: c_int = 1;
pub const XILINX_DRAM_SIZE_8G: c_int = 2;
pub const XILINX_DRAM_SIZE_12G: c_int = 3;
pub const XILINX_DRAM_SIZE_16G: c_int = 4;
pub const XILINX_DRAM_SIZE_32G: c_int = 5;
pub const NUM_UE_BITPOS: c_int = 2;
//
...
pub struct edac_priv {
    pub ddrmc_baseaddr: *mut void __iomem,
    pub ddrmc_noc_baseaddr: *mut void __iomem,
    pub message: [c_char; XDDR_EDAC_MSG_SIZE],
    pub mc_id: u32,
    pub ce_cnt: u32,
    pub ue_cnt: u32,
    pub stat: ecc_status,
    ...
    pub err_inject_addr: u64,
    pub debugfs: *mut dentry,

}

#[no_mangle]
unsafe extern "C" fn get_ce_error_info(priv: *mut edac_priv) {
...
#[no_mangle]
unsafe extern "C" fn get_ue_error_info(priv: *mut edac_priv) {
...
#[no_mangle]
unsafe extern "C" fn get_error_info(priv: *mut edac_priv) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn convert_to_physical(priv: *mut edac_priv, pinf: union ecc_error_info) -> c_ulong {
    static unsigned long convert_to_physical(struct edac_priv *priv, union ecc_error_info pinf)
    {
    let mut err_addr: c_ulong = 0;
    u32 index;
    u32 row;
...
//
#[no_mangle]
unsafe extern "C" fn handle_error(mci: *mut mem_ctl_info, stat: *mut ecc_status) {
...
//
#[no_mangle]
unsafe extern "C" fn err_callback(payload: *const u32, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn get_dwidth(base: *const void __iomem) -> enum dev_type {
...
//
#[no_mangle]
unsafe extern "C" fn get_ecc_state(base: *mut void __iomem) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn get_memsize(priv: *mut edac_priv) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn enable_intr(priv: *mut edac_priv) {
...
#[no_mangle]
unsafe extern "C" fn disable_intr(priv: *mut edac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn poison_setup(priv: *mut edac_priv) {
    static void poison_setup(struct edac_priv *priv)
    {
    let mut col: u32 = 0, row = 0, bank = 0, grp = 0, rank = 0, lrank = 0, ch = 0;
    u32 index, regval;
    for (index = 0; index < XDDR_MAX_ROW_CNT; index++) {
...
#[no_mangle]
unsafe extern "C" fn xddr_inject_data_ce_store(mci: *mut mem_ctl_info, ce_bitpos: u8) {
...
#[no_mangle]
unsafe extern "C" fn xddr_inject_data_ue_store(mci: *mut mem_ctl_info, val0: u32, val1: u32) {
...
#[no_mangle]
unsafe extern "C" fn create_debugfs_attributes(mci: *mut mem_ctl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn process_bit(priv: *mut edac_priv, start: c_uint, regval: u32) {
...
#[no_mangle]
unsafe extern "C" fn setup_row_address_map(priv: *mut edac_priv) {
...
#[no_mangle]
unsafe extern "C" fn setup_column_address_map(priv: *mut edac_priv) {
...
#[no_mangle]
unsafe extern "C" fn setup_bank_grp_ch_address_map(priv: *mut edac_priv) {
...
#[no_mangle]
unsafe extern "C" fn setup_rank_lrank_address_map(priv: *mut edac_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn setup_address_map(priv: *mut edac_priv) {
...
#[no_mangle]
unsafe extern "C" fn emif_get_id(node: *mut device_node) -> u32 {
