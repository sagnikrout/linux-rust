...
pub const TOLM: c_uint = 0x80;
pub const TOHM: c_uint = 0x84;
pub const HASWELL_TOLM: c_uint = 0xd0;
pub const HASWELL_TOHM_0: c_uint = 0xd4;
pub const HASWELL_TOHM_1: c_uint = 0xd8;
pub const KNL_TOLM: c_uint = 0xd0;
pub const KNL_TOHM_0: c_uint = 0xd4;
pub const KNL_TOHM_1: c_uint = 0xd8;

// Device 13 Function 6
pub const SAD_TARGET: c_uint = 0xf0;

pub const SAD_CONTROL: c_uint = 0xf4;
...
pub const MCMTR: c_uint = 0x7c;
pub const KNL_MCMTR: c_uint = 0x624;

// Device 15, function 1
pub const RASENABLES: c_uint = 0xac;

// Device 15, functions 2-5
    static const int mtr_regs[] = {
    0x80, 0x84, 0x88,
    };
    let mut knl_mtr_reg: static int = 0xb60;
...
pub const SB_RANK_CFG_A: c_uint = 0x0328;
pub const IB_RANK_CFG_A: c_uint = 0x0320;
//
// sbridge structs
//

pub const CHANNEL_UNSPECIFIED: c_uint = 0xf	/* Intel IA32 SDM 15-14 */;
    enum type {
    SANDY_BRIDGE,
    IVY_BRIDGE,
    HASWELL,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sbridge_info {
    pub type: enum type,
    pub mcmtr: u32,
    pub rankcfgr: u32,
    pub pvt): *mut *mut u64 (get_tolm)(struct sbridge_pvt,
    pub pvt): *mut *mut u64 (get_tohm)(struct sbridge_pvt,
    pub reg): *mut *mut u64 (rir_limit)(u32,
    pub reg): *mut *mut u64 (sad_limit)(u32,
    pub reg): *mut *mut u32 (interleave_mode)(u32,
    pub reg): *mut *mut u32 (dram_attr)(u32,
    pub dram_rule: *const u32,
    pub interleave_list: *const u32,
    pub interleave_pkg: *const interleave_pkg,
    pub max_sad: u8,
    pub pvt): *mut *mut u8 (get_node_id)(struct sbridge_pvt,
    pub bank): *mut *mut u8 (get_ha)(u8,
    pub pvt): *mut *mut enum mem_type (get_memory_type)(struct sbridge_pvt,
    pub mtr): *mut *mut *mut enum dev_type (get_width)(struct sbridge_pvt pvt, u32,
    pub pci_vtd: *mut pci_dev,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sbridge_channel {
    pub ranks: u32,
    pub dimms: u32,
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct pci_id_table {
    ...
    pub n_devs_per_imc: c_int,
    pub n_devs_per_sock: c_int,
    pub n_imcs_per_sock: c_int,
    pub type: enum type,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sbridge_dev {
    pub list: list_head,
    pub seg: c_int,
    pub mc: u8 bus,,
    pub source_id: u8 node_id,,
    pub dom: enum domain,
    pub n_devs: c_int,
    pub i_devs: c_int,
...
#[derive(Copy, Clone)]
pub struct knl_pvt {
    pub pci_cha: [*mut pci_dev; KNL_MAX_CHAS],
    pub pci_channel: [*mut pci_dev; KNL_MAX_CHANNELS],
    pub pci_mc0: *mut pci_dev,
    pub pci_mc1: *mut pci_dev,
    pub pci_mc0_misc: *mut pci_dev,
    pub pci_mc1_misc: *mut pci_dev,
    pub /: *mut *mut *mut pci_dev pci_mc_info; / tolm, tohm,
}
...
// Devices per socket
    pub pci_ddrio: *mut pci_dev,
    pub pci_sad1: *mut *mut pci_dev pci_sad0,,
    pub pci_br1: *mut *mut pci_dev pci_br0,,
// Devices per memory controller
    pub pci_ras: *mut *mut *mut pci_dev pci_ha, pci_ta,,
    pub pci_tad: [*mut pci_dev; NUM_CHANNELS],
    pub sbridge_dev: *mut sbridge_dev,
    pub info: sbridge_info,
    pub channel: [sbridge_channel; NUM_CHANNELS],
// Memory type detection
    pub is_close_pg: bool is_cur_addr_mirrored, is_lockstep,,
    pub is_chan_hash: bool,
    pub mirror_mode: enum mirroring_mode,
// Memory description
    pub tohm: u64 tolm,,
    pub knl: knl_pvt,
}
...
//
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_1HA_DDRIO0: c_uint = 0x0eb8;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_2HA_DDRIO0: c_uint = 0x0ebc;
// pci ids
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA0: c_uint = 0x0ea0;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA0_TA: c_uint = 0x0ea8;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA0_RAS: c_uint = 0x0e71;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA0_TAD0: c_uint = 0x0eaa;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA0_TAD1: c_uint = 0x0eab;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA0_TAD2: c_uint = 0x0eac;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA0_TAD3: c_uint = 0x0ead;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_SAD: c_uint = 0x0ec8;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_BR0: c_uint = 0x0ec9;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_BR1: c_uint = 0x0eca;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA1: c_uint = 0x0e60;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA1_TA: c_uint = 0x0e68;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA1_RAS: c_uint = 0x0e79;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA1_TAD0: c_uint = 0x0e6a;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA1_TAD1: c_uint = 0x0e6b;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA1_TAD2: c_uint = 0x0e6c;
pub const PCI_DEVICE_ID_INTEL_IBRIDGE_IMC_HA1_TAD3: c_uint = 0x0e6d;
...
//
pub const HASWELL_DDRCRCLKCONTROLS: c_uint = 0xa10 /* Ditto on Broadwell */;
pub const HASWELL_HASYSDEFEATURE2: c_uint = 0x84;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_VTD_MISC: c_uint = 0x2f28;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA0: c_uint = 0x2fa0;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA1: c_uint = 0x2f60;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA0_TA: c_uint = 0x2fa8;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA0_TM: c_uint = 0x2f71;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA1_TA: c_uint = 0x2f68;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA1_TM: c_uint = 0x2f79;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_CBO_SAD0: c_uint = 0x2ffc;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_CBO_SAD1: c_uint = 0x2ffd;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA0_TAD0: c_uint = 0x2faa;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA0_TAD1: c_uint = 0x2fab;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA0_TAD2: c_uint = 0x2fac;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA0_TAD3: c_uint = 0x2fad;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA1_TAD0: c_uint = 0x2f6a;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA1_TAD1: c_uint = 0x2f6b;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA1_TAD2: c_uint = 0x2f6c;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_HA1_TAD3: c_uint = 0x2f6d;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_DDRIO0: c_uint = 0x2fbd;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_DDRIO1: c_uint = 0x2fbf;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_DDRIO2: c_uint = 0x2fb9;
pub const PCI_DEVICE_ID_INTEL_HASWELL_IMC_DDRIO3: c_uint = 0x2fbb;
...
pub const PCI_DEVICE_ID_INTEL_KNL_IMC_MC: c_uint = 0x7840;
// DRAM channel stuff; bank addrs, dimmmtr, etc.. 2-8-2 - 2-9-4 (6 of these)
pub const PCI_DEVICE_ID_INTEL_KNL_IMC_CHAN: c_uint = 0x7843;
// kdrwdbu TAD limits/offsets, MCMTR - 2-10-1, 2-11-1 (2 of these)
pub const PCI_DEVICE_ID_INTEL_KNL_IMC_TA: c_uint = 0x7844;
// CHA broadcast registers, dram rules - 1-29-0 (1 of these)
pub const PCI_DEVICE_ID_INTEL_KNL_IMC_SAD0: c_uint = 0x782a;
// SAD target - 1-29-1 (1 of these)
pub const PCI_DEVICE_ID_INTEL_KNL_IMC_SAD1: c_uint = 0x782b;
// Caching / Home Agent
pub const PCI_DEVICE_ID_INTEL_KNL_IMC_CHA: c_uint = 0x782c;
// Device with TOLM and TOHM, 0-5-0 (1 of these)
pub const PCI_DEVICE_ID_INTEL_KNL_IMC_TOLHM: c_uint = 0x7810;
//
...
// - each scalable memory buffer supports 4 DDR3/DDR4 channels, 3 DPC
//
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_VTD_MISC: c_uint = 0x6f28;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA0: c_uint = 0x6fa0;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA1: c_uint = 0x6f60;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA0_TA: c_uint = 0x6fa8;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA0_TM: c_uint = 0x6f71;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA1_TA: c_uint = 0x6f68;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA1_TM: c_uint = 0x6f79;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CBO_SAD0: c_uint = 0x6ffc;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_CBO_SAD1: c_uint = 0x6ffd;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA0_TAD0: c_uint = 0x6faa;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA0_TAD1: c_uint = 0x6fab;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA0_TAD2: c_uint = 0x6fac;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA0_TAD3: c_uint = 0x6fad;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA1_TAD0: c_uint = 0x6f6a;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA1_TAD1: c_uint = 0x6f6b;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA1_TAD2: c_uint = 0x6f6c;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_HA1_TAD3: c_uint = 0x6f6d;
pub const PCI_DEVICE_ID_INTEL_BROADWELL_IMC_DDRIO0: c_uint = 0x6faf;
...
//
#[no_mangle]
pub unsafe extern "C" fn numrank(type: enum type, mtr: u32) -> c_int {
    static inline int numrank(enum type type, u32 mtr)
    {
    let mut ranks: c_int = (1 << RANK_CNT_BITS(mtr));
    let mut max: c_int = 4;
...
#[no_mangle]
pub unsafe extern "C" fn numrow(mtr: u32) -> c_int {
    static inline int numrow(u32 mtr)
    {
    let mut rows: c_int = (RANK_WIDTH_BITS(mtr) + 12);
    if (rows < 13 || rows > 18) {
...
#[no_mangle]
pub unsafe extern "C" fn numcol(mtr: u32) -> c_int {
    static inline int numcol(u32 mtr)
    {
    let mut cols: c_int = (COL_WIDTH_BITS(mtr) + 10);
    if (cols > 12) {
...
#[no_mangle]
unsafe extern "C" fn free_sbridge_dev(sbridge_dev: *mut sbridge_dev) {
...
#[no_mangle]
unsafe extern "C" fn sbridge_get_tolm(pvt: *mut sbridge_pvt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn sbridge_get_tohm(pvt: *mut sbridge_pvt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ibridge_get_tolm(pvt: *mut sbridge_pvt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ibridge_get_tohm(pvt: *mut sbridge_pvt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn rir_limit(reg: u32) -> u64 {
    static u64 rir_limit(u32 reg)
    {
    return ((u64)GET_BITFIELD(reg,  1, 10) << 29) | 0x1fffffff;
    }
#[no_mangle]
unsafe extern "C" fn sad_limit(reg: u32) -> u64 {
    static u64 sad_limit(u32 reg)
    {
    return (GET_BITFIELD(reg, 6, 25) << 26) | 0x3ffffff;
    }
#[no_mangle]
unsafe extern "C" fn interleave_mode(reg: u32) -> u32 {
    static u32 interleave_mode(u32 reg)
    {
    return GET_BITFIELD(reg, 1, 1);
    }
#[no_mangle]
unsafe extern "C" fn dram_attr(reg: u32) -> u32 {
    static u32 dram_attr(u32 reg)
    {
    return GET_BITFIELD(reg, 2, 3);
    }
#[no_mangle]
unsafe extern "C" fn knl_sad_limit(reg: u32) -> u64 {
    static u64 knl_sad_limit(u32 reg)
    {
    return (GET_BITFIELD(reg, 7, 26) << 26) | 0x3ffffff;
    }
#[no_mangle]
unsafe extern "C" fn knl_interleave_mode(reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn dram_attr_knl(reg: u32) -> u32 {
    static u32 dram_attr_knl(u32 reg)
    {
    return GET_BITFIELD(reg, 3, 4);
    }
#[no_mangle]
unsafe extern "C" fn get_memory_type(pvt: *mut sbridge_pvt) -> enum mem_type {
...
#[no_mangle]
unsafe extern "C" fn haswell_get_memory_type(pvt: *mut sbridge_pvt) -> enum mem_type {
    static enum mem_type haswell_get_memory_type(struct sbridge_pvt *pvt)
    {
    u32 reg;
    let mut registered: bool = false;
    let mut mtype: enum mem_type = MEM_UNKNOWN;
    if (!pvt.pci_ddrio)
    goto out;
...
#[no_mangle]
unsafe extern "C" fn knl_get_width(pvt: *mut sbridge_pvt, mtr: u32) -> enum dev_type {
...
#[no_mangle]
unsafe extern "C" fn sbridge_get_width(pvt: *mut sbridge_pvt, mtr: u32) -> enum dev_type {
...
#[no_mangle]
unsafe extern "C" fn __ibridge_get_width(mtr: u32) -> enum dev_type {
    static enum dev_type __ibridge_get_width(u32 mtr)
    {
    let mut type: enum dev_type = DEV_UNKNOWN;
    switch (mtr) {
    case 2:
    type = DEV_X16;
    break;
...
#[no_mangle]
unsafe extern "C" fn ibridge_get_width(pvt: *mut sbridge_pvt, mtr: u32) -> enum dev_type {
...
#[no_mangle]
unsafe extern "C" fn broadwell_get_width(pvt: *mut sbridge_pvt, mtr: u32) -> enum dev_type {
...
#[no_mangle]
unsafe extern "C" fn knl_get_memory_type(pvt: *mut sbridge_pvt) -> enum mem_type {
...
#[no_mangle]
unsafe extern "C" fn get_node_id(pvt: *mut sbridge_pvt) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn haswell_get_node_id(pvt: *mut sbridge_pvt) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn knl_get_node_id(pvt: *mut sbridge_pvt) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn sbridge_get_ha(bank: u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn ibridge_get_ha(bank: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn knl_get_ha(bank: u8) -> u8 {
    static u8 knl_get_ha(u8 bank)
    {
    return 0xff;
    }
#[no_mangle]
unsafe extern "C" fn haswell_get_tolm(pvt: *mut sbridge_pvt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn haswell_get_tohm(pvt: *mut sbridge_pvt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn knl_get_tolm(pvt: *mut sbridge_pvt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn knl_get_tohm(pvt: *mut sbridge_pvt) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn haswell_rir_limit(reg: u32) -> u64 {
    static u64 haswell_rir_limit(u32 reg)
    {
    return (((u64)GET_BITFIELD(reg,  1, 11) + 1) << 29) - 1;
    }
#[no_mangle]
pub unsafe extern "C" fn sad_pkg_socket(pkg: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn sad_pkg_ha(pkg: u8) -> u8 {
    static inline u8 sad_pkg_ha(u8 pkg)
    {
    return (pkg >> 2) & 0x1;
    }
#[no_mangle]
unsafe extern "C" fn haswell_chan_hash(idx: c_int, addr: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn knl_channel_mc(channel: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn knl_get_edc_route(entry: c_int, reg: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn knl_get_mc_route(entry: c_int, reg: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn knl_show_edc_route(reg: u32, s: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn knl_show_mc_route(reg: u32, s: *mut c_char) {
...
pub const KNL_EDC_ROUTE: c_uint = 0xb8;
pub const KNL_MC_ROUTE: c_uint = 0xb4;
...
//
#[no_mangle]
unsafe extern "C" fn knl_get_dimm_capacity(pvt: *mut sbridge_pvt, mc_sizes: *mut u64) -> c_int {
    static int knl_get_dimm_capacity(struct sbridge_pvt *pvt, u64 *mc_sizes)
    {
    u64 sad_base, sad_limit = 0;
    u64 tad_base, tad_size, tad_limit, tad_deadspace, tad_livespace;
    let mut sad_rule: c_int = 0;
    let mut tad_rule: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn get_source_id(mci: *mut mem_ctl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn if(MEM_UNKNOWN: mtype ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_memory_layout(mci: *const mem_ctl_info) {
...
// SAD_LIMIT Address range is 45:26
    ...
    for (j = 0; j < 8; j++) {
    let mut pkg: u32 = sad_pkg(pvt.info.interleave_pkg, reg, j);
...
#[no_mangle]
unsafe extern "C" fn sb_bits(addr: u64, nbits: c_int, bits: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sb_bank_bits(addr: u64, b0: c_int, b1: c_int, do_xor: c_int, x0: c_int, x1: c_int) -> c_int {
    ...
    {
    let mut dimmno: c_int = 0;
    int row, col, bank_address, bank_group;
    struct sbridge_pvt *pvt;
    let mut bg0: u32 = 0, rowbits = 0, colbits = 0;
    let mut amap_fine: u32 = 0, bank_xor_enable = 0;
...
// area_type = show_dram_attr(pvt->info.dram_attr(dram_rule));
    ...
    let mut pkg: u32 = sad_pkg(pvt.info.interleave_pkg, reg, sad_way);
...
//
#[no_mangle]
unsafe extern "C" fn sbridge_put_devices(sbridge_dev: *mut sbridge_dev) {
...
#[no_mangle]
unsafe extern "C" fn sbridge_put_all_devices() {
    ...
    const int multi_bus)
    {
    struct sbridge_dev *sbridge_dev = core::ptr::null_mut();
...
//
    ...
    int i, rc;
    struct pci_dev *pdev = core::ptr::null_mut();
    let mut allow_dups: c_int = 0;
    let mut multi_bus: c_int = 0;
...
//
    ...
    {
    let mut id: c_int = TAD_DEV_TO_CHAN(pdev.device);
    pvt.pci_tad[id] = pdev;
    saw_chan_mask |= 1 << id;
    }
    break;
...
// there's only one device per system; not tied to any bus
    if (pvt.info.pci_vtd == core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn if(9: dev ==) -> else {
    else if (dev == 9)
...
//
    ...
    WARN_ON(pvt.knl.pci_cha[devidx] != core::ptr::null_mut());
...
//
    ...
    devidx = func-2;
#[no_mangle]
pub unsafe extern "C" fn if(8: dev ==) -> else {
    else if (dev == 8)
    devidx = 3 + (func-2);
    ...
    WARN_ON(pvt.knl.pci_channel[devidx] != core::ptr::null_mut());
...
//
    ...
    let mut ripv: bool = GET_BITFIELD(m.mcgstatus, 0, 0);
    let mut overflow: bool = GET_BITFIELD(m.status, 62, 62);
    let mut uncorrected_error: bool = GET_BITFIELD(m.status, 61, 61);
    bool recoverable;
    let mut core_err_cnt: u32 = GET_BITFIELD(m.status, 38, 52);
    let mut mscod: u32 = GET_BITFIELD(m.status, 16, 31);
    let mut errcode: u32 = GET_BITFIELD(m.status, 0, 15);
    let mut channel: u32 = GET_BITFIELD(m.status, 0, 3);
    let mut optypenum: u32 = GET_BITFIELD(m.status, 4, 6);
//
...
//
    let mut lsb: u32 = GET_BITFIELD(m.misc, 0, 5);
    char *optype, *area_type = "DRAM";
    long channel_mask, first_channel;
    let mut rank: u8 = 0xff, socket, ha;
    int rc, dimm;
    if (pvt.info.type != SANDY_BRIDGE)
    recoverable = true;
    else
...
//
    ...
    dimm = -1;
#[no_mangle]
pub unsafe extern "C" fn if(4: rank <) -> else {
    else if (rank < 4)
    dimm = 0;
#[no_mangle]
pub unsafe extern "C" fn if(8: rank <) -> else {
    else if (rank < 8)
    dimm = 1;
    else
    dimm = 2;
...
//
#[no_mangle]
unsafe extern "C" fn sbridge_unregister_mci(sbridge_dev: *mut sbridge_dev) {
...
// Remove MC sysfs nodes
    ...
    kfree(mci.ctl_name);
    edac_mc_free(mci);
    sbridge_dev.mci = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn sbridge_register_mci(sbridge_dev: *mut sbridge_dev, type: enum type) -> c_int {
...
// pvt->info.rankcfgr == ???
    ...
    pvt.info.rir_limit = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn sbridge_probe(id: *const x86_cpu_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sbridge_remove() {
...
//
#[no_mangle]
unsafe extern "C" fn sbridge_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn sbridge_exit() -> void __exit {
