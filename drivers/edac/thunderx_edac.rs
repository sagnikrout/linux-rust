...
//! Source: drivers/edac/thunderx_edac.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_bits(data: c_ulong, pos: c_int, width: c_int) -> c_ulong {
    static unsigned long get_bits(unsigned long data, int pos, int width)
    {
    return (data >> pos) & ((1 << width) - 1);
    }
pub const L2C_CTL: c_uint = 0x87E080800000;

pub const PCI_DEVICE_ID_THUNDER_LMC: c_uint = 0xa022;
pub const LMC_FADR: c_uint = 0x20;

pub const LMC_NXM_FADR: c_uint = 0x28;
pub const LMC_ECC_SYND: c_uint = 0x38;
pub const LMC_ECC_PARITY_TEST: c_uint = 0x108;
pub const LMC_INT_W1S: c_uint = 0x150;
pub const LMC_INT_ENA_W1C: c_uint = 0x158;
pub const LMC_INT_ENA_W1S: c_uint = 0x160;
pub const LMC_CONFIG: c_uint = 0x188;

pub const LMC_CONTROL: c_uint = 0x190;

pub const LMC_INT: c_uint = 0x1F0;

pub const LMC_DDR_PLL_CTL: c_uint = 0x258;

pub const LMC_FADR_SCRAMBLED: c_uint = 0x330;
...
pub const LMC_SCRAM_FADR: c_uint = 0x330;
pub const LMC_CHAR_MASK0: c_uint = 0x228;
pub const LMC_CHAR_MASK2: c_uint = 0x238;
pub const RING_ENTRIES: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct debugfs_entry {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lmc_err_ctx {
    pub reg_int: u64,
    pub reg_fadr: u64,
    pub reg_nxm_fadr: u64,
    pub reg_scram_fadr: u64,
    pub reg_ecc_synd: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct thunderx_lmc {
    pub regs: *mut void __iomem,
    pub pdev: *mut pci_dev,
    pub msix_ent: msix_entry,
    pub ecc_int: core::sync::atomic::AtomicI32,
    pub mask0: u64,
    pub mask2: u64,
    pub parity_test: u64,
    pub node: u64,
    pub xbits: c_int,
    pub bank_width: c_int,
    pub pbank_lsb: c_int,
    pub dimm_lsb: c_int,
    pub rank_lsb: c_int,
    pub bank_lsb: c_int,
    pub row_lsb: c_int,
    pub col_hi_lsb: c_int,
    pub xor_bank: c_int,
    pub l2c_alias: c_int,
    pub mem: *mut page,
    pub err_ctx: [lmc_err_ctx; RING_ENTRIES],
    pub ring_head: c_ulong,
    pub ring_tail: c_ulong,
}
...
// Trigger the interrupt
    ...
    struct thunderx_lmc *lmc = file.private_data;
    char buf[20];
    let mut lmc_int: u64 = readq(lmc.regs + LMC_INT);
    snprintf(buf, sizeof(buf), "0x%016llx", lmc_int);
    return simple_read_from_buffer(data, count, ppos, buf, sizeof(buf));
    }
pub const TEST_PATTERN: c_uint = 0xa5;
#[no_mangle]
unsafe extern "C" fn inject_ecc_fn(arg: *mut c_void) -> c_int {
    static int inject_ecc_fn(void *arg)
    {
    struct thunderx_lmc *lmc = arg;
    uintptr_t addr, phys;
    let mut cline_size: c_uint = cache_line_size();
    let mut lines: c_uint = PAGE_SIZE / cline_size;
...
//
    ...
    stop_machine(inject_ecc_fn, lmc, core::ptr::null_mut());
...
//
    ...
    DEBUGFS_STRUCT(inject_int, 0200, thunderx_lmc_inject_int_write, core::ptr::null_mut());
    DEBUGFS_STRUCT(inject_ecc, 0200, thunderx_lmc_inject_ecc_write, core::ptr::null_mut());
    DEBUGFS_STRUCT(int_w1c, 0400, core::ptr::null_mut(), thunderx_lmc_int_read);
...
#[no_mangle]
unsafe extern "C" fn thunderx_faddr_to_phys(faddr: u64, lmc: *mut thunderx_lmc) -> phys_addr_t {
...
#[no_mangle]
unsafe extern "C" fn thunderx_get_num_lmcs(node: c_uint) -> c_uint {
...
pub const LMC_MESSAGE_SIZE: c_int = 120;

#[no_mangle]
unsafe extern "C" fn thunderx_lmc_err_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t thunderx_lmc_err_isr(int irq, void *dev_id)
    {
    struct mem_ctl_info *mci = dev_id;
    struct thunderx_lmc *lmc = mci.pvt_info;
    let mut head: c_ulong = ring_pos(lmc.ring_head, ARRAY_SIZE(lmc.err_ctx));
...
#[no_mangle]
unsafe extern "C" fn thunderx_lmc_threaded_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    0, -1, -1, -1, msg, other);
#[no_mangle]
pub unsafe extern "C" fn if(LMC_INT_CE: ctx->reg_int &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn pci_dev_to_mc_idx(pdev: *mut pci_dev) -> c_int {
    static inline int pci_dev_to_mc_idx(struct pci_dev *pdev)
    {
    let mut node: c_int = dev_to_node(&pdev.dev);
    let mut ret: c_int = PCI_FUNC(pdev.devfn);
    ret += max(node, 0) << 3;
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn thunderx_lmc_remove(pdev: *mut pci_dev) {
...
// ---------------------- OCX driver ---------------------------------
pub const PCI_DEVICE_ID_THUNDER_OCX: c_uint = 0xa013;
pub const OCX_LINK_INTS: c_int = 3;

pub const OCX_RX_LANES: c_int = 24;
pub const OCX_RX_LANE_STATS: c_int = 15;
pub const OCX_COM_INT: c_uint = 0x100;
pub const OCX_COM_INT_W1S: c_uint = 0x108;
pub const OCX_COM_INT_ENA_W1S: c_uint = 0x110;
pub const OCX_COM_INT_ENA_W1C: c_uint = 0x118;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocx_com_err_ctx {
    pub reg_com_int: u64,
    pub reg_lane_int: [u64; OCX_RX_LANES],
    pub reg_lane_stat11: [u64; OCX_RX_LANES],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocx_link_err_ctx {
    pub reg_com_link_int: u64,
    pub link: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct thunderx_ocx {
    pub regs: *mut void __iomem,
    pub com_link: c_int,
    pub pdev: *mut pci_dev,
    pub edac_dev: *mut edac_device_ctl_info,
    pub debugfs: *mut dentry,
    pub msix_ent: [msix_entry; OCX_INTS],
    pub com_err_ctx: [ocx_com_err_ctx; RING_ENTRIES],
    pub link_err_ctx: [ocx_link_err_ctx; RING_ENTRIES],
    pub com_ring_head: c_ulong,
    pub com_ring_tail: c_ulong,
    pub link_ring_head: c_ulong,
    pub link_ring_tail: c_ulong,
}

// This handler is threaded
#[no_mangle]
unsafe extern "C" fn thunderx_ocx_com_isr(irq: c_int, irq_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn thunderx_ocx_com_threaded_isr(irq: c_int, irq_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn thunderx_ocx_lnk_isr(irq: c_int, irq_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn thunderx_ocx_lnk_threaded_isr(irq: c_int, irq_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(OCX_COM_LINK_INT_CE: ctx->reg_com_link_int &) -> else {
...
#[no_mangle]
unsafe extern "C" fn thunderx_ocx_clearstats(ocx: *mut thunderx_ocx) {
...
#[no_mangle]
unsafe extern "C" fn thunderx_ocx_remove(pdev: *mut pci_dev) {
...
// ---------------------- L2C driver ---------------------------------
pub const PCI_DEVICE_ID_THUNDER_L2C_TAD: c_uint = 0xa02e;
pub const PCI_DEVICE_ID_THUNDER_L2C_CBC: c_uint = 0xa02f;
pub const PCI_DEVICE_ID_THUNDER_L2C_MCI: c_uint = 0xa030;
pub const L2C_TAD_INT_W1C: c_uint = 0x40000;
pub const L2C_TAD_INT_W1S: c_uint = 0x40008;
pub const L2C_TAD_INT_ENA_W1C: c_uint = 0x40020;
pub const L2C_TAD_INT_ENA_W1S: c_uint = 0x40028;
    ...
    L2C_TAD_INT_LFBTO)
pub const L2C_TAD_TIMETWO: c_uint = 0x50000;
pub const L2C_TAD_TIMEOUT: c_uint = 0x50100;
pub const L2C_TAD_ERR: c_uint = 0x60000;
pub const L2C_TAD_TQD_ERR: c_uint = 0x60100;
pub const L2C_TAD_TTG_ERR: c_uint = 0x60200;
pub const L2C_CBC_INT_W1C: c_uint = 0x60000;
...
pub const L2C_CBC_INT_W1S: c_uint = 0x60008;
pub const L2C_CBC_INT_ENA_W1C: c_uint = 0x60020;

    L2C_CBC_INT_IODISOCI)
pub const L2C_CBC_INT_ENA_W1S: c_uint = 0x60028;
pub const L2C_CBC_IODISOCIERR: c_uint = 0x80008;
pub const L2C_CBC_IOCERR: c_uint = 0x80010;
pub const L2C_CBC_RSDERR: c_uint = 0x80018;
pub const L2C_CBC_MIBERR: c_uint = 0x80020;
pub const L2C_MCI_INT_W1C: c_uint = 0x0;
...
pub const L2C_MCI_INT_W1S: c_uint = 0x8;
pub const L2C_MCI_INT_ENA_W1C: c_uint = 0x20;

pub const L2C_MCI_INT_ENA_W1S: c_uint = 0x28;
pub const L2C_MCI_ERR: c_uint = 0x10000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct l2c_err_ctx {
    pub reg_ext_name: *mut c_char,
    pub reg_int: u64,
    pub reg_ext: u64,
}
...
pub struct thunderx_l2c {
    ...
    pub index: c_int,
    pub msix_ent: msix_entry,
    pub err_ctx: [l2c_err_ctx; RING_ENTRIES],
    pub ring_head: c_ulong,
    pub ring_tail: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn thunderx_l2c_tad_isr(irq: c_int, irq_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t thunderx_l2c_tad_isr(int irq, void *irq_id)
    {
    struct msix_entry *msix = irq_id;
    struct thunderx_l2c *tad = container_of(msix, struct thunderx_l2c,
    msix_ent);
    let mut head: c_ulong = ring_pos(tad.ring_head, ARRAY_SIZE(tad.err_ctx));
...
#[no_mangle]
unsafe extern "C" fn thunderx_l2c_cbc_isr(irq: c_int, irq_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t thunderx_l2c_cbc_isr(int irq, void *irq_id)
    {
    struct msix_entry *msix = irq_id;
    struct thunderx_l2c *cbc = container_of(msix, struct thunderx_l2c,
    msix_ent);
    let mut head: c_ulong = ring_pos(cbc.ring_head, ARRAY_SIZE(cbc.err_ctx));
...
#[no_mangle]
unsafe extern "C" fn thunderx_l2c_mci_isr(irq: c_int, irq_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t thunderx_l2c_mci_isr(int irq, void *irq_id)
    {
    struct msix_entry *msix = irq_id;
    struct thunderx_l2c *mci = container_of(msix, struct thunderx_l2c,
    msix_ent);
    let mut head: c_ulong = ring_pos(mci.ring_head, ARRAY_SIZE(mci.err_ctx));
...
#[no_mangle]
unsafe extern "C" fn thunderx_l2c_threaded_isr(irq: c_int, irq_id: *mut c_void) -> irqreturn_t {
    ...
    msix_ent);
    let mut tail: c_ulong = ring_pos(l2c.ring_tail, ARRAY_SIZE(l2c.err_ctx));
...
#[no_mangle]
pub unsafe extern "C" fn if(mask_ce: ctx->reg_int &) -> else {
    ...
    size_t dfs_entries;
    irqreturn_t (*thunderx_l2c_isr)(int, void *) = core::ptr::null_mut();
    char name[32];
    const char *fmt;
...
#[no_mangle]
unsafe extern "C" fn thunderx_l2c_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn thunderx_edac_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn thunderx_edac_exit() -> void __exit {
