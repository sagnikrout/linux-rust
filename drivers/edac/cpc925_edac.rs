...
//! Source: drivers/edac/cpc925_edac.c
#![no_std]
...
//
pub const CPC925_BITS_PER_REG: c_int = 32;
...
pub const CPC925_REF_FREQ: c_uint = 0xFA69;

pub const CPC925_NR_CSROWS: c_int = 8;
//
...
//
pub const REG_APIMASK_OFFSET: c_uint = 0x30070;
    enum apimask_bits {
...
//
pub const REG_APIEXCP_OFFSET: c_uint = 0x30060;
    enum apiexcp_bits {
...
//
pub const REG_MBCR_OFFSET: c_uint = 0x2190;
pub const MBCR_64BITCFG_SHIFT: c_int = 23;

pub const MBCR_64BITBUS_SHIFT: c_int = 22;

//
// Memory Bank Mode Register (MBMR)
//
pub const REG_MBMR_OFFSET: c_uint = 0x21C0;
pub const MBMR_MODE_MAX_VALUE: c_uint = 0xF;
pub const MBMR_MODE_SHIFT: c_int = 25;

pub const MBMR_BBA_SHIFT: c_int = 24;

//
// Memory Bank Boundary Address Register (MBBAR)
//
pub const REG_MBBAR_OFFSET: c_uint = 0x21D0;
pub const MBBAR_BBA_MAX_VALUE: c_uint = 0xFF;
pub const MBBAR_BBA_SHIFT: c_int = 24;

//
// Memory Scrub Control Register (MSCR)
//
pub const REG_MSCR_OFFSET: c_uint = 0x2400;
pub const MSCR_SCRUB_MOD_MASK: c_uint = 0xC0000000 /* scrub_mod - bit0:1*/;
pub const MSCR_BACKGR_SCRUB: c_uint = 0x40000000 /* 01 */;

pub const MSCR_SI_MAX_VALUE: c_uint = 0xFF;

//
// Memory Scrub Range Start Register (MSRSR)
//
pub const REG_MSRSR_OFFSET: c_uint = 0x2410;
//
// Memory Scrub Range End Register (MSRER)
//
pub const REG_MSRER_OFFSET: c_uint = 0x2420;
//
// Memory Scrub Pattern Register (MSPR)
//
pub const REG_MSPR_OFFSET: c_uint = 0x2430;
//
// Memory Check Control Register (MCCR)
//
pub const REG_MCCR_OFFSET: c_uint = 0x2440;
    enum mccr_bits {
...
//
pub const REG_MCRER_OFFSET: c_uint = 0x2450;
//
// Memory Error Address Register (MEAR)
//
pub const REG_MEAR_OFFSET: c_uint = 0x2460;
pub const MEAR_BCNT_MAX_VALUE: c_uint = 0x3;
pub const MEAR_BCNT_SHIFT: c_int = 30;

pub const MEAR_RANK_MAX_VALUE: c_uint = 0x7;
pub const MEAR_RANK_SHIFT: c_int = 27;

pub const MEAR_COL_MAX_VALUE: c_uint = 0x7FF;
pub const MEAR_COL_SHIFT: c_int = 16;

pub const MEAR_BANK_MAX_VALUE: c_uint = 0x3;
pub const MEAR_BANK_SHIFT: c_int = 14;

pub const MEAR_ROW_MASK: c_uint = 0x00003FFF;
//
// Memory Error Syndrome Register (MESR)
//
pub const REG_MESR_OFFSET: c_uint = 0x2470;
pub const MESR_ECC_SYN_H_MASK: c_uint = 0xFF00;
pub const MESR_ECC_SYN_L_MASK: c_uint = 0x00FF;
//
// Memory Mode Control Register (MMCR)
//
pub const REG_MMCR_OFFSET: c_uint = 0x2500;
    enum mmcr_bits {
...
//
pub const REG_ERRCTRL_OFFSET: c_uint = 0x70140;
...
//
pub const REG_LINKCTRL_OFFSET: c_uint = 0x70110;
    enum linkctrl_bits {
...
//
pub const REG_LINKERR_OFFSET: c_uint = 0x70120;
    enum linkerr_bits {
...
//
pub const REG_BRGCTRL_OFFSET: c_uint = 0x70300;
    enum brgctrl_bits {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpc925_mc_pdata {
    pub vbase: *mut void __iomem,
    pub total_mem: c_ulong,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpc925_dev_info {
    pub vbase: *mut void __iomem,
    pub pdev: *mut platform_device,
    pub ctl_name: *mut c_char,
    pub edac_idx: c_int,
    pub edac_dev: *mut edac_device_ctl_info,
    pub dev_info): *mut *mut void (init)(struct cpc925_dev_info,
    pub dev_info): *mut *mut void (exit)(struct cpc925_dev_info,
    pub edac_dev): *mut *mut void (check)(struct edac_device_ctl_info,
}

// Get total memory size from Open Firmware DTB
#[no_mangle]
unsafe extern "C" fn get_total_mem(pdata: *mut cpc925_mc_pdata) {
    ...
    np = of_find_node_by_type(core::ptr::null_mut(), "memory");
    if (!np)
    return;
...
#[no_mangle]
unsafe extern "C" fn cpc925_init_csrows(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_mc_init(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_mc_exit(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_mc_find_channel(mci: *mut mem_ctl_info, syndrome: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpc925_mc_check(mci: *mut mem_ctl_info) {
    ...
    u32 mesr;
    u16 syndrome;
    let mut pfn: c_ulong = 0, offset = 0;
    let mut csrow: c_int = 0, channel = 0;
...
// CPU err device
#[no_mangle]
unsafe extern "C" fn cpc925_cpu_mask_disabled() -> u32 {
    static u32 cpc925_cpu_mask_disabled(void)
    {
    struct device_node *cpunode;
    let mut mask: static u32 = 0;
// use cached value if available
    if (mask != 0)
    return mask;
    mask = APIMASK_ADI0 | APIMASK_ADI1;
    for_each_of_cpu_node(cpunode) {
    const u32 *reg = of_get_property(cpunode, "reg", core::ptr::null_mut());
    if (reg == core::ptr::null_mut() || *reg > 2) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_cpu_init(dev_info: *mut cpc925_dev_info) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_cpu_exit(dev_info: *mut cpc925_dev_info) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_cpu_check(edac_dev: *mut edac_device_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_htlink_init(dev_info: *mut cpc925_dev_info) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_htlink_exit(dev_info: *mut cpc925_dev_info) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_htlink_check(edac_dev: *mut edac_device_ctl_info) {
    static void cpc925_htlink_check(struct edac_device_ctl_info *edac_dev)
    {
    struct cpc925_dev_info *dev_info = edac_dev.pvt_info;
    let mut brgctrl: u32 = __raw_readl(dev_info.vbase + REG_BRGCTRL_OFFSET);
    let mut linkctrl: u32 = __raw_readl(dev_info.vbase + REG_LINKCTRL_OFFSET);
    let mut errctrl: u32 = __raw_readl(dev_info.vbase + REG_ERRCTRL_OFFSET);
    let mut linkerr: u32 = __raw_readl(dev_info.vbase + REG_LINKERR_OFFSET);
...
//
#[no_mangle]
unsafe extern "C" fn cpc925_add_edac_devices(vbase: *mut void __iomem) {
    ...
    dev_info.ctl_name, 0, core::ptr::null_mut(), 0);
...
//
    ...
    1, core::ptr::null_mut(), 0, 0, dev_info.edac_idx);
...
//
#[no_mangle]
unsafe extern "C" fn cpc925_del_edac_devices() {
...
#[no_mangle]
unsafe extern "C" fn cpc925_get_sdram_scrub_rate(mci: *mut mem_ctl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpc925_mc_get_channels(vbase: *mut void __iomem) -> c_int {
    static int cpc925_mc_get_channels(void __iomem *vbase)
    {
    let mut dual: c_int = 0;
    u32 mbcr;
...
#[no_mangle]
unsafe extern "C" fn cpc925_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct resource *r;
    let mut res: c_int = 0, nr_channels;
    ...
    mci.set_sdram_scrub_rate = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cpc925_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cpc925_edac_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cpc925_edac_exit() -> void __exit {
