...
pub const PCI_DEVICE_ID_INTEL_X38_HB: c_uint = 0x29e0;
pub const X38_RANKS: c_int = 8;
pub const X38_RANKS_PER_CHANNEL: c_int = 4;
pub const X38_CHANNELS: c_int = 2;
// Intel X38 register addresses - device 0 function 0 - DRAM Controller
pub const X38_MCHBAR_LOW: c_uint = 0x48	/* MCH Memory Mapped Register BAR */;
pub const X38_MCHBAR_HIGH: c_uint = 0x4c;
pub const X38_MCHBAR_MASK: c_uint = 0xfffffc000ULL	/* bits 35:14 */;
pub const X38_MMR_WINDOW_SIZE: c_int = 16384;
pub const X38_TOM: c_uint = 0xa0	/* Top of Memory (16b);
//
// 15:10 reserved
// 9:0  total populated physical memory
//
pub const X38_TOM_MASK: c_uint = 0x3ff	/* bits 9:0 */;

pub const X38_ERRSTS: c_uint = 0xc8	/* Error Status Register (16b);
//
// 15    reserved
...
//
pub const X38_ERRSTS_UE: c_uint = 0x0002;
pub const X38_ERRSTS_CE: c_uint = 0x0001;

// Intel  MMIO register space - device 0 function 0 - MMR space
pub const X38_C0DRB: c_uint = 0x200	/* Channel 0 DRAM Rank Boundary (16b x 4);
//
// 15:10 reserved
// 9:0  Channel 0 DRAM Rank Boundary Address
//
pub const X38_C1DRB: c_uint = 0x600	/* Channel 1 DRAM Rank Boundary (16b x 4) */;
pub const X38_DRB_MASK: c_uint = 0x3ff	/* bits 9:0 */;

pub const X38_C0ECCERRLOG: c_uint = 0x280	/* Channel 0 ECC Error Log (64b);
//
...
//
pub const X38_C1ECCERRLOG: c_uint = 0x680	/* Channel 1 ECC Error Log (64b) */;
pub const X38_ECCERRLOG_CE: c_uint = 0x1;
pub const X38_ECCERRLOG_UE: c_uint = 0x2;
pub const X38_ECCERRLOG_RANK_BITS: c_uint = 0x18000000;
pub const X38_ECCERRLOG_SYNDROME_BITS: c_uint = 0xff0000;
pub const X38_CAPID0: c_uint = 0xe0	/* see P.94 of spec for details */;
    static int x38_channel_num;
#[no_mangle]
unsafe extern "C" fn how_many_channel(pdev: *mut pci_dev) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct x38_dev_info {
    pub ctl_name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct x38_error_info {
    pub errsts: u16,
    pub errsts2: u16,
    pub eccerrlog: [u64; X38_CHANNELS],
}
    ...
    let mut x38_registered: static int = 1;
#[no_mangle]
unsafe extern "C" fn x38_clear_error_info(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn x38_check(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn x38_probe1(pdev: *mut pci_dev, dev_idx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x38_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn x38_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn x38_init() -> int __init {
...
// Ensure that the OPSTATE is set correctly for POLL or NMI
    ...
    PCI_DEVICE_ID_INTEL_X38_HB, core::ptr::null_mut());
    if (!mci_pdev) {
...
#[no_mangle]
unsafe extern "C" fn x38_exit() -> void __exit {
