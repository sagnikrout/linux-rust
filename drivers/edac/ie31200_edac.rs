...
//! Source: drivers/edac/ie31200_edac.c
#![no_std]
...
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_1: c_uint = 0x0108;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_2: c_uint = 0x010c;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_3: c_uint = 0x0150;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_4: c_uint = 0x0158;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_5: c_uint = 0x015c;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_6: c_uint = 0x0c04;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_7: c_uint = 0x0c08;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_8: c_uint = 0x190F;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_9: c_uint = 0x1918;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_10: c_uint = 0x191F;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_11: c_uint = 0x590f;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_12: c_uint = 0x5918;
// Coffee Lake-S
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_MASK: c_uint = 0x3e00;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_1: c_uint = 0x3e0f;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_2: c_uint = 0x3e18;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_3: c_uint = 0x3e1f;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_4: c_uint = 0x3e30;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_5: c_uint = 0x3e31;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_6: c_uint = 0x3e32;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_7: c_uint = 0x3e33;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_8: c_uint = 0x3ec2;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_9: c_uint = 0x3ec6;
pub const PCI_DEVICE_ID_INTEL_IE31200_HB_CFL_10: c_uint = 0x3eca;
// Raptor Lake-S
pub const PCI_DEVICE_ID_INTEL_IE31200_RPL_S_1: c_uint = 0xa703 /* 8P+8E,  e.g. i7-13700 */;
pub const PCI_DEVICE_ID_INTEL_IE31200_RPL_S_2: c_uint = 0x4640 /* 6P+8E,  e.g. i5-13500, i5-13600, i5-14500 */;
pub const PCI_DEVICE_ID_INTEL_IE31200_RPL_S_3: c_uint = 0x4630 /* 4P+0E,  e.g. i3-13100E */;
pub const PCI_DEVICE_ID_INTEL_IE31200_RPL_S_4: c_uint = 0xa700 /* 8P+16E, e.g. i9-13900, i9-14900 */;
pub const PCI_DEVICE_ID_INTEL_IE31200_RPL_S_5: c_uint = 0xa740 /* 8P+12E, e.g. i7-14700 */;
pub const PCI_DEVICE_ID_INTEL_IE31200_RPL_S_6: c_uint = 0xa704 /* 6P+8E,  e.g. i5-14600 */;
// Raptor Lake-HX
pub const PCI_DEVICE_ID_INTEL_IE31200_RPL_HX_1: c_uint = 0xa702 /* 8P+16E, e.g. i9-13950HX */;
// Alder Lake-S
pub const PCI_DEVICE_ID_INTEL_IE31200_ADL_S_1: c_uint = 0x4660;
pub const PCI_DEVICE_ID_INTEL_IE31200_ADL_S_2: c_uint = 0x4668	/* 8P+4E, e.g. i7-12700K */;
pub const PCI_DEVICE_ID_INTEL_IE31200_ADL_S_3: c_uint = 0x4648	/* 6P+4E, e.g. i5-12600K */;
// Bartlett Lake-S
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_1: c_uint = 0x4639;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_2: c_uint = 0x463c;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_3: c_uint = 0x4642;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_4: c_uint = 0x4643;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_5: c_uint = 0xa731;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_6: c_uint = 0xa732;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_7: c_uint = 0xa733;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_8: c_uint = 0xa741;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_9: c_uint = 0xa744;
pub const PCI_DEVICE_ID_INTEL_IE31200_BTL_S_10: c_uint = 0xa745;
pub const IE31200_RANKS_PER_CHANNEL: c_int = 8;
pub const IE31200_DIMMS_PER_CHANNEL: c_int = 2;
pub const IE31200_CHANNELS: c_int = 2;
pub const IE31200_IMC_NUM: c_int = 2;
// Intel IE31200 register addresses - device 0 function 0 - DRAM Controller
pub const IE31200_MCHBAR_LOW: c_uint = 0x48;
pub const IE31200_MCHBAR_HIGH: c_uint = 0x4c;
//
...
//
pub const IE31200_ERRSTS: c_uint = 0xc8;

pub const IE31200_CAPID0: c_uint = 0xe4;

    static int nr_channels;
    static struct pci_dev *mci_pdev;
    let mut ie31200_registered: static int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct res_config {
    pub mtype: enum mem_type,
    pub cmci: bool,
    pub imc_num: c_int,
// Host MMIO configuration register
    pub reg_mchbar_mask: u64,
    pub reg_mchbar_window_size: u64,
// ECC error log register
    pub reg_eccerrlog_offset: [u64; IE31200_CHANNELS],
    pub reg_eccerrlog_ce_mask: u64,
    pub reg_eccerrlog_ce_ovfl_mask: u64,
    pub reg_eccerrlog_ue_mask: u64,
    pub reg_eccerrlog_ue_ovfl_mask: u64,
    pub reg_eccerrlog_rank_mask: u64,
    pub reg_eccerrlog_syndrome_mask: u64,
// MSR to clear ECC error log register
    pub msr_clear_eccerrlog_offset: u32,
// DIMM characteristics register
    pub reg_mad_dimm_size_granularity: u64,
    pub reg_mad_dimm_offset: [u64; IE31200_CHANNELS],
    pub reg_mad_dimm_size_mask: [u32; IE31200_DIMMS_PER_CHANNEL],
    pub reg_mad_dimm_rank_mask: [u32; IE31200_DIMMS_PER_CHANNEL],
    pub reg_mad_dimm_width_mask: [u32; IE31200_DIMMS_PER_CHANNEL],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ie31200_priv {
    pub window: *mut void __iomem,
    pub c0errlog: *mut void __iomem,
    pub c1errlog: *mut void __iomem,
    pub cfg: *mut res_config,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ie31200_dev_info {
    pub ctl_name: *const c_char,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ie31200_error_info {
    pub errsts: u16,
    pub errsts2: u16,
    pub eccerrlog: [u64; IE31200_CHANNELS],
    pub erraddr: u64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dimm_data {
    pub /: *mut *mut u64 size; / in bytes,
    pub ranks: u8,
    pub dtype: enum dev_type,
}
...
#[no_mangle]
unsafe extern "C" fn ecc_capable(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ie31200_clear_error_info(mci: *mut mem_ctl_info) {
...
#[no_mangle]
unsafe extern "C" fn __ie31200_check(mci: *mut mem_ctl_info, mce: *mut mce) {
...
#[no_mangle]
unsafe extern "C" fn ie31200_check(mci: *mut mem_ctl_info) {
    static void ie31200_check(struct mem_ctl_info *mci)
    {
    __ie31200_check(mci, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn ie31200_register_mci(pdev: *mut pci_dev, cfg: *mut res_config, mc: c_int) -> c_int {
    ...
    mci.edac_check = cfg.cmci ? core::ptr::null_mut() : ie31200_check;
...
#[no_mangle]
unsafe extern "C" fn mce_check(mce: *mut mce) {
...
#[no_mangle]
unsafe extern "C" fn mce_handler(nb: *mut notifier_block, val: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ie31200_unregister_mcis() {
...
#[no_mangle]
unsafe extern "C" fn ie31200_probe1(pdev: *mut pci_dev, cfg: *mut res_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ie31200_remove_one(pdev: *mut pci_dev) {
    static void ie31200_remove_one(struct pci_dev *pdev)
    {
    struct ie31200_priv *priv = ie31200_pvt.priv[0];
    edac_dbg(0, "\n");
    pci_dev_put(mci_pdev);
    mci_pdev = core::ptr::null_mut();
    if (priv.cfg.cmci)
...
#[no_mangle]
unsafe extern "C" fn ie31200_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ie31200_exit() -> void __exit {
