...
//! Source: drivers/edac/octeon_edac-l2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn _octeon_l2c_poll_oct2(l2c: *mut edac_device_ctl_info, tad: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octeon_l2c_probe(pdev: *mut platform_device) -> c_int {
    static int octeon_l2c_probe(struct platform_device *pdev)
    {
    struct edac_device_ctl_info *l2c;
    let mut num_tads: c_int = OCTEON_IS_MODEL(OCTEON_CN68XX) ? 4 : 1;
...
#[no_mangle]
unsafe extern "C" fn octeon_l2c_remove(pdev: *mut platform_device) {
