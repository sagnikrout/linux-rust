...
//! Source: drivers/reset/reset-imx8mp-audiomix.c
#![no_std]
...
pub const IMX8MP_AUDIOMIX_EARC_RESET_OFFSET: c_uint = 0x200;
pub const IMX8MP_AUDIOMIX_DSP_RUNSTALL_OFFSET: c_uint = 0x108;
pub const IMX8ULP_SIM_LPAV_SYSCTRL0_OFFSET: c_uint = 0x8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8mp_reset_map {
    pub offset: c_uint,
    pub mask: c_uint,
    pub active_low: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8mp_reset_info {
    pub map: *const imx8mp_reset_map,
    pub num_lines: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx8mp_audiomix_reset {
...
#[no_mangle]
unsafe extern "C" fn imx8mp_audiomix_reset_iounmap(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn imx8mp_audiomix_reset_get_regmap(priv: *mut imx8mp_audiomix_reset) -> c_int {
