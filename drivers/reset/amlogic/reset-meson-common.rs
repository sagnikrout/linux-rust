...
//! Source: drivers/reset/amlogic/reset-meson-common.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_reset {
    pub param: *const meson_reset_param,
    ...
    unsigned int *bit)
    {
    let mut stride: c_uint = regmap_get_reg_stride(data.map);
