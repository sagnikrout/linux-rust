...
pub struct reset_control {
    pub rcdev: *mut reset_controller_dev __rcu,
    ...
    pub shared: bool,
    pub array: bool,
    pub deassert_count: core::sync::atomic::AtomicI32,
    pub triggered_count: core::sync::atomic::AtomicI32,
    pub lock: mutex,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct reset_control_array {
    pub base: reset_control,
    pub num_rstcs: c_uint,
    pub __counted_by(num_rstcs): *mut *mut reset_control rstc[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct reset_gpio_lookup {
    pub ref_args: fwnode_reference_args,
    pub swnode: *mut fwnode_handle,
    pub list: list_head,
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_controller_register(rcdev: *mut reset_controller_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_controller_unregister(rcdev: *mut reset_controller_dev) {
...
//
    ...
    rcu_assign_pointer(rstc.rcdev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn devm_reset_controller_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn reset_control_array_reset(resets: *mut reset_control_array) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_control_array_rearm(resets: *mut reset_control_array) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_control_array_assert(resets: *mut reset_control_array) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_control_array_deassert(resets: *mut reset_control_array) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_control_array_acquire(resets: *mut reset_control_array) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reset_control_array_release(resets: *mut reset_control_array) {
...
#[no_mangle]
pub unsafe extern "C" fn reset_control_is_array(rstc: *mut reset_control) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_reset(rstc: *mut reset_control) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_rearm(rstc: *mut reset_control) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_assert(rstc: *mut reset_control) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_deassert(rstc: *mut reset_control) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_status(rstc: *mut reset_control) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_acquire(rstc: *mut reset_control) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_release(rstc: *mut reset_control) {
...
//
    ...
    {
    let mut shared: bool = flags & RESET_CONTROL_FLAGS_BIT_SHARED;
    let mut acquired: bool = flags & RESET_CONTROL_FLAGS_BIT_ACQUIRED;
    struct reset_control *rstc;
    int ret;
    lockdep_assert_held(&rcdev.lock);
...
#[no_mangle]
unsafe extern "C" fn __reset_control_release(kref: *mut kref) {
    ...
    rcdev = rcu_replace_pointer(rstc.rcdev, core::ptr::null_mut(), true);
    if (rcdev) {
    lockdep_assert_held(&rcdev.lock);
    reset_controller_remove(rcdev, rstc);
    }
...
#[no_mangle]
unsafe extern "C" fn reset_control_put_internal(rstc: *mut reset_control) {
...
#[no_mangle]
unsafe extern "C" fn reset_gpio_aux_device_release(dev: *mut device) {
...
//
    ...
    rgpio_dev.swnode = fwnode_create_software_node(properties, core::ptr::null_mut());
    ...
    {
    let mut optional: bool = flags & RESET_CONTROL_FLAGS_BIT_OPTIONAL;
    let mut gpio_fallback: bool = false;
    struct reset_control *rstc = ERR_PTR(-EINVAL);
    struct reset_controller_dev *rcdev;
    struct fwnode_reference_args args;
    struct of_phandle_args of_args;
    let mut rstc_id: c_int = -EINVAL;
    int ret;
    if (!fwnode)
    return ERR_PTR(-EINVAL);
    if (id) {
    ...
    if (index < 0)
    return optional ? core::ptr::null_mut() : ERR_PTR(-ENOENT);
    }
    ...
    return optional ? core::ptr::null_mut() : ERR_PTR(ret);
//
...
#[no_mangle]
unsafe extern "C" fn reset_control_array_put(resets: *mut reset_control_array) {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_put(rstc: *mut reset_control) {
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_bulk_put(num_rstcs: c_int, rstcs: *mut reset_control_bulk_data) {
...
#[no_mangle]
unsafe extern "C" fn devm_reset_control_release(dev: *mut device, res: *mut c_void) {
    static void devm_reset_control_release(struct device *dev, void *res)
    {
    reset_control_put(*(struct reset_control **)res);
    }
#[no_mangle]
unsafe extern "C" fn devm_reset_control_release_deasserted(dev: *mut device, res: *mut c_void) {
    ...
    let mut deasserted: bool = flags & RESET_CONTROL_FLAGS_BIT_DEASSERTED;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct reset_control_bulk_devres {
    pub num_rstcs: c_int,
    pub rstcs: *mut reset_control_bulk_data,
}

#[no_mangle]
unsafe extern "C" fn devm_reset_control_bulk_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_reset_control_bulk_release_deasserted(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __device_reset(dev: *mut device, optional: bool) -> c_int {
    ...
    if (ACPI_FAILURE(acpi_evaluate_object(handle, "_RST", core::ptr::null_mut(),
    core::ptr::null_mut())))
    return -EIO;
    }

    flags = optional ? RESET_CONTROL_OPTIONAL_EXCLUSIVE : RESET_CONTROL_EXCLUSIVE;
    rstc = __reset_control_get(dev, core::ptr::null_mut(), 0, flags);
    if (IS_ERR(rstc))
    return PTR_ERR(rstc);
...
//
#[no_mangle]
unsafe extern "C" fn fwnode_reset_control_get_count(fwnode: *mut fwnode_handle) -> c_int {
    static int fwnode_reset_control_get_count(struct fwnode_handle *fwnode)
    {
    struct fwnode_reference_args args;
    let mut count: c_int = 0, ret;
    if (!fwnode)
    return -EINVAL;
    for (;;) {
    ret = fwnode_property_get_reference_args(fwnode, "resets", "#reset-cells",
...
//
    ...
    if (num < 0)
    return optional ? core::ptr::null_mut() : ERR_PTR(num);
    resets = kzalloc_flex(*resets, rstc, num);
    if (!resets)
    return ERR_PTR(-ENOMEM);
    resets.num_rstcs = num;
    for (i = 0; i < num; i++) {
    rstc = __fwnode_reset_control_get(fwnode, core::ptr::null_mut(), i, flags);
    if (IS_ERR(rstc))
    goto err_rst;
    resets.rstc[i] = rstc;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn reset_control_get_count(dev: *mut device) -> c_int {
