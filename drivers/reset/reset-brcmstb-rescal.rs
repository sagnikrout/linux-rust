...
//! Source: drivers/reset/reset-brcmstb-rescal.c
#![no_std]
...
pub const BRCM_RESCAL_START: c_uint = 0x0;

pub const BRCM_RESCAL_CTRL: c_uint = 0x4;
pub const BRCM_RESCAL_STATUS: c_uint = 0x8;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcm_rescal_reset {
...
#[no_mangle]
unsafe extern "C" fn brcm_rescal_reset_probe(pdev: *mut platform_device) -> c_int {
