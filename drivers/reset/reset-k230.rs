...
//! Source: drivers/reset/reset-k230.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k230_rst_map {
    pub offset: u32,
    pub type: enum k230_rst_type,
    pub done: u32,
    pub reset: u32,
}
...
#[no_mangle]
unsafe extern "C" fn k230_rst_assert(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k230_rst_reset(rcdev: *mut reset_controller_dev, id: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k230_rst_probe(pdev: *mut platform_device) -> c_int {
