...
//! Source: drivers/reset/reset-lpc18xx.c
#![no_std]
...
pub const LPC18XX_RGU_CTRL0: c_uint = 0x100;
pub const LPC18XX_RGU_CTRL1: c_uint = 0x104;
pub const LPC18XX_RGU_ACTIVE_STATUS0: c_uint = 0x150;
pub const LPC18XX_RGU_ACTIVE_STATUS1: c_uint = 0x154;
pub const LPC18XX_RGU_RESETS_PER_REG: c_int = 32;
// Internal reset outputs
pub const LPC18XX_RGU_CORE_RST: c_int = 0;
pub const LPC43XX_RGU_M0SUB_RST: c_int = 12;
pub const LPC43XX_RGU_M0APP_RST: c_int = 56;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc18xx_rgu_data {
    pub rcdev: reset_controller_dev,
    pub clk_delay: *mut clk,
    pub clk_reg: *mut clk,
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_rgu_restart(data: *mut sys_off_data) -> c_int {
...
//
    ...
    let mut stat_offset: u32 = LPC18XX_RGU_ACTIVE_STATUS0;
    let mut ctrl_offset: u32 = LPC18XX_RGU_CTRL0;
    unsigned long flags;
    u32 stat, rst_bit;
...
#[no_mangle]
unsafe extern "C" fn lpc18xx_rgu_probe(pdev: *mut platform_device) -> c_int {
