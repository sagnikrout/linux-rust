...
//! Source: drivers/reset/reset-tps380x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps380x_reset_devdata {
    pub min_reset_ms: c_uint,
    pub typ_reset_ms: c_uint,
    pub max_reset_ms: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn tps380x_reset_probe(pdev: *mut platform_device) -> c_int {
