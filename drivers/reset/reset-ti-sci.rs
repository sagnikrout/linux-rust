...
//! Source: drivers/reset/reset-ti-sci.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_sci_reset_control {
    pub dev_id: u32,
    pub reset_mask: u32,
    pub lock: mutex,
}
...
#[no_mangle]
unsafe extern "C" fn ti_sci_reset_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_sci_reset_remove(pdev: *mut platform_device) {
