...
//! Source: drivers/reset/reset-microchip-sparx5.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mchp_reset_context {
    pub cpu_ctrl: *mut regmap,
    pub gcb_ctrl: *mut regmap,
...
#[no_mangle]
unsafe extern "C" fn sparx5_switch_reset(ctx: *mut mchp_reset_context) -> c_int {
...
// Wait for soft reset done
    ...
    {
    let mut regmap_config: regmap_config = mchp_lan966x_syscon_regmap_config;
    struct resource res;
    void __iomem *base;
    int err;
...
#[no_mangle]
unsafe extern "C" fn mchp_sparx5_reset_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mchp_sparx5_reset_init() -> int __init {
