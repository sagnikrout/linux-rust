...
//! Source: drivers/reset/sti/reset-stih407.c
#![no_std]
...
pub const SYSCFG_5000: c_uint = 0x0;
pub const SYSSTAT_5500: c_uint = 0x7d0;
// Powerdown requests control 1 (High Speed Links)
pub const SYSCFG_5001: c_uint = 0x4;
pub const SYSSTAT_5501: c_uint = 0x7d4;
// Ethernet powerdown/status/reset
pub const SYSCFG_4032: c_uint = 0x80;
pub const SYSSTAT_4520: c_uint = 0x820;
pub const SYSCFG_4002: c_uint = 0x8;
...
pub const SYSCFG_5128: c_uint = 0x200;
pub const SYSCFG_5131: c_uint = 0x20c;
pub const SYSCFG_5132: c_uint = 0x210;
pub const LPM_SYSCFG_1: c_uint = 0x4	/* Softreset IRB & SBC UART */;
...
pub const SYSCFG_5061: c_uint = 0x0f4;
...
#[no_mangle]
unsafe extern "C" fn stih407_reset_init() -> int __init {
