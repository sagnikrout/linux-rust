...
//! Source: drivers/reset/reset-eic7700.c
#![no_std]
...
pub const SYSCRG_CLEAR_BOOT_INFO_OFFSET: c_uint = 0xC;

pub const SYSCRG_RESET_OFFSET: c_uint = 0x100;
//
...
#[no_mangle]
unsafe extern "C" fn eic7700_reset_probe(pdev: *mut platform_device) -> c_int {
