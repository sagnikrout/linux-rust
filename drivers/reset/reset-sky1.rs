...
//! Source: drivers/reset/reset-sky1.c
#![no_std]
...
pub const SKY1_RESET_SLEEP_MIN_US: c_int = 50;
pub const SKY1_RESET_SLEEP_MAX_US: c_int = 100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sky1_src_signal {
    pub offset: c_uint,
    pub bit: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sky1_src_variant {
    pub signals: *const sky1_src_signal,
...
// resets for fch_sw_xspi
    ...
    let mut value: c_uint = assert ? 0 : signal.bit;
...
#[no_mangle]
unsafe extern "C" fn sky1_reset_probe(pdev: *mut platform_device) -> c_int {
