...
//! Source: drivers/soundwire/debugfs.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn sdw_bus_debugfs_init(bus: *mut sdw_bus) {
...
#[no_mangle]
pub unsafe extern "C" fn sdw_bus_debugfs_exit(bus: *mut sdw_bus) {
...
#[no_mangle]
unsafe extern "C" fn sdw_slave_reg_show(s_file: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_command(data: *mut c_void, value: u64) -> c_int {
...
// Userspace changed the hardware state behind the kernel's back
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(set_command_fops, core::ptr::null_mut(),
    set_command, "%llu\n");
#[no_mangle]
unsafe extern "C" fn set_command_type(data: *mut c_void, value: u64) -> c_int {
...
// Userspace changed the hardware state behind the kernel's back
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(set_command_type_fops, core::ptr::null_mut(),
    set_command_type, "%llu\n");
#[no_mangle]
unsafe extern "C" fn set_start_address(data: *mut c_void, value: u64) -> c_int {
...
// Userspace changed the hardware state behind the kernel's back
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(set_start_address_fops, core::ptr::null_mut(),
    set_start_address, "%llu\n");
#[no_mangle]
unsafe extern "C" fn set_num_bytes(data: *mut c_void, value: u64) -> c_int {
...
// Userspace changed the hardware state behind the kernel's back
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(set_num_bytes_fops, core::ptr::null_mut(),
    set_num_bytes, "%llu\n");
#[no_mangle]
unsafe extern "C" fn do_bpt_sequence(slave: *mut sdw_slave, write: bool, buffer: *mut u8) -> c_int {
    static int do_bpt_sequence(struct sdw_slave *slave, bool write, u8 *buffer)
    {
    let mut msg: sdw_bpt_msg = {0};
...
#[no_mangle]
unsafe extern "C" fn cmd_go(data: *mut c_void, value: u64) -> c_int {
...
// Userspace changed the hardware state behind the kernel's back
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(cmd_go_fops, core::ptr::null_mut(),
    cmd_go, "%llu\n");
pub const MAX_LINE_LEN: c_int = 128;
#[no_mangle]
unsafe extern "C" fn read_buffer_show(s_file: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdw_slave_debugfs_init(slave: *mut sdw_slave) {
...
#[no_mangle]
pub unsafe extern "C" fn sdw_slave_debugfs_exit(slave: *mut sdw_slave) {
    void sdw_slave_debugfs_exit(struct sdw_slave *slave)
    {
    debugfs_remove_recursive(slave.debugfs);
    }
#[no_mangle]
pub unsafe extern "C" fn sdw_debugfs_init() {
    void sdw_debugfs_init(void)
    {
    if (!firmware_file)
    firmware_file = kstrdup("", GFP_KERNEL);
    sdw_debugfs_root = debugfs_create_dir("soundwire", core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn sdw_debugfs_exit() {
    void sdw_debugfs_exit(void)
    {
    debugfs_remove_recursive(sdw_debugfs_root);
    kfree(firmware_file);
    firmware_file = core::ptr::null_mut();
    }
