...
//! Source: drivers/soundwire/mipi_disco.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_master_read_prop(bus: *mut sdw_bus) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_slave_read_lane_mapping(slave: *mut sdw_slave) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_slave_read_prop(slave: *mut sdw_slave) -> c_int {
