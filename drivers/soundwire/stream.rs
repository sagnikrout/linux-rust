...
//! Source: drivers/soundwire/stream.c
#![no_std]
...
pub const SDW_PORT_PREP_POLL_USEC: c_int = 1000;
//
...
#[no_mangle]
pub unsafe extern "C" fn sdw_find_col_index(col: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdw_find_row_index(row: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdw_program_port_params(m_rt: *mut sdw_master_runtime) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdw_enable_disable_ports(m_rt: *mut sdw_master_runtime, en: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdw_prep_deprep_ports(m_rt: *mut sdw_master_runtime, prep: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdw_notify_config(m_rt: *mut sdw_master_runtime) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdw_program_params(bus: *mut sdw_bus, prepare: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdw_bank_switch(bus: *mut sdw_bus, m_rt_count: c_int) -> c_int {
...
// Get row and column index to program register
    ...
    sdw_fill_msg(wr_msg, core::ptr::null_mut(), addr, 1, SDW_BROADCAST_DEV_NUM,
...
//
    ...
    kfree(wbuf);
    kfree(wr_msg);
    bus.defer_msg.msg = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn sdw_ml_sync_bank_switch(bus: *mut sdw_bus, multi_link: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_bank_switch(stream: *mut sdw_stream_runtime) -> c_int {
    static int do_bank_switch(struct sdw_stream_runtime *stream)
    {
    struct sdw_master_runtime *m_rt;
    const struct sdw_master_ops *ops;
    struct sdw_bus *bus;
    let mut multi_link: bool = false;
    int m_rt_count;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn sdw_port_free(p_rt: *mut sdw_port_runtime) {
...
#[no_mangle]
unsafe extern "C" fn sdw_slave_port_allocated(s_rt: *mut sdw_slave_runtime) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sdw_slave_port_is_valid_range(dev: *mut device, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdw_master_port_allocated(m_rt: *mut sdw_master_runtime) -> bool {
    static bool sdw_master_port_allocated(struct sdw_master_runtime *m_rt)
    {
    return !list_empty(&m_rt.port_list);
    }
#[no_mangle]
unsafe extern "C" fn sdw_master_port_free(m_rt: *mut sdw_master_runtime) {
...
//
#[no_mangle]
unsafe extern "C" fn sdw_acquire_bus_lock(stream: *mut sdw_stream_runtime) {
...
//
#[no_mangle]
unsafe extern "C" fn sdw_release_bus_lock(stream: *mut sdw_stream_runtime) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_prepare_stream(stream: *mut sdw_stream_runtime) -> c_int {
    int sdw_prepare_stream(struct sdw_stream_runtime *stream)
    {
    let mut update_params: bool = true;
    int ret;
    if (!stream) {
...
#[no_mangle]
unsafe extern "C" fn _sdw_enable_stream(stream: *mut sdw_stream_runtime) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_enable_stream(stream: *mut sdw_stream_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _sdw_disable_stream(stream: *mut sdw_stream_runtime) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_disable_stream(stream: *mut sdw_stream_runtime) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _sdw_deprepare_stream(stream: *mut sdw_stream_runtime) -> c_int {
    ...
    struct sdw_bus *bus;
    let mut state: c_int = stream.state;
    let mut ret: c_int = 0;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_deprepare_stream(stream: *mut sdw_stream_runtime) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_startup_stream(sdw_substream: *mut c_void) -> c_int {
    ...
    set_stream(substream, core::ptr::null_mut());
    error:
    kfree(name);
    return ret;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_shutdown_stream(sdw_substream: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_release_stream(stream: *mut sdw_stream_runtime) {
...
//
    ...
    {
    struct sdw_master_runtime *m_rt;
    let mut alloc_master_rt: bool = false;
    int ret;
    mutex_lock(&bus.bus_lock);
//
...
//
    ...
    struct sdw_master_runtime *m_rt;
    let mut alloc_master_rt: bool = false;
    let mut alloc_slave_rt: bool = false;
    int ret;
...
//
    ...
    sdw_master_rt_free(m_rt, stream);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: alloc_slave_rt) -> else {
