...
//! Source: drivers/soundwire/intel_bus_common.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn intel_start_bus(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_start_bus_after_reset(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_check_clock_stop(sdw: *mut sdw_intel) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_start_bus_after_clock_stop(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_stop_bus(sdw: *mut sdw_intel, clock_stop: bool) -> c_int {
    int intel_stop_bus(struct sdw_intel *sdw, bool clock_stop)
    {
    struct device *dev = sdw.cdns.dev;
    struct sdw_cdns *cdns = &sdw.cdns;
    let mut wake_enable: bool = false;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_pre_bank_switch(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_post_bank_switch(sdw: *mut sdw_intel) -> c_int {
