...
//! Source: drivers/soundwire/intel_ace2x.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sdw_slave_bpt_stream_add(slave: *mut sdw_slave, stream: *mut sdw_stream_runtime) -> c_int {
...
pub const READ_PDI1_MIN_SIZE: c_int = 12;
...
//
    ...
    cdns.bus.bpt_stream = core::ptr::null_mut();
    return ret;
    }
...
pub const INTEL_BPT_MSG_BYTE_MIN: c_int = 16;
...
//
#[no_mangle]
unsafe extern "C" fn intel_shim_vs_init(sdw: *mut sdw_intel) {
...
#[no_mangle]
unsafe extern "C" fn intel_shim_vs_set_clock_source(sdw: *mut sdw_intel, source: u32) {
...
#[no_mangle]
unsafe extern "C" fn intel_shim_check_wake(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_shim_wake(sdw: *mut sdw_intel, wake_enable: bool) {
    static void intel_shim_wake(struct sdw_intel *sdw, bool wake_enable)
    {
    let mut lsdiid: u16 = 0;
    u16 wake_en;
    u16 wake_sts;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn intel_link_power_up(sdw: *mut sdw_intel) -> c_int {
    static int intel_link_power_up(struct sdw_intel *sdw)
    {
    struct sdw_bus *bus = &sdw.cdns.bus;
    struct sdw_master_prop *prop = &bus.prop;
    u32 *shim_mask = sdw.link_res.shim_mask;
    let mut link_id: c_uint = sdw.instance;
    u32 clock_source;
    u32 syncprd;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn intel_link_power_down(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_sync_arm(sdw: *mut sdw_intel) {
...
#[no_mangle]
unsafe extern "C" fn intel_sync_go_unlocked(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_sync_go(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_check_cmdsync_unlocked(sdw: *mut sdw_intel) -> bool {
...
//
    ...
    dai_runtime.pdi = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn intel_trigger(substream: *mut snd_pcm_substream, cmd: c_int, dai: *mut snd_soc_dai) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_component_dais_suspend(component: *mut snd_soc_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_register_dai(sdw: *mut sdw_intel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_program_sdi(sdw: *mut sdw_intel, dev_num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_get_link_count(sdw: *mut sdw_intel) -> c_int {
