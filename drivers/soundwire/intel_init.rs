...
//! Source: drivers/soundwire/intel_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn intel_link_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn intel_link_dev_unregister(ldev: *mut sdw_intel_link_dev) {
...
#[no_mangle]
unsafe extern "C" fn sdw_intel_cleanup(ctx: *mut sdw_intel_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sdw_intel_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_intel_startup(ctx: *mut sdw_intel_ctx) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_intel_exit(ctx: *mut sdw_intel_ctx) {
...
// we first resume links and devices and wait synchronously before the cleanup
    ...
    int ret;
    ret = device_for_each_child(bus.dev, core::ptr::null_mut(), intel_resume_child_device);
    if (ret < 0)
...
#[no_mangle]
pub unsafe extern "C" fn sdw_intel_process_wakeen_event(ctx: *mut sdw_intel_ctx) {
