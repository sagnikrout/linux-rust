...
//! Source: drivers/soundwire/slave.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sdw_slave_release(dev: *mut device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdw_acpi_child_walk_data {
    pub bus: *mut sdw_bus,
    pub adev: *mut acpi_device,
    pub id: sdw_slave_id,
    pub ignore_unique_id: bool,
}

#[no_mangle]
unsafe extern "C" fn sdw_acpi_check_duplicate(adev: *mut acpi_device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdw_acpi_find_one(adev: *mut acpi_device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_acpi_find_slaves(bus: *mut sdw_bus) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_of_find_slaves(bus: *mut sdw_bus) -> c_int {
