...
//! Source: drivers/soundwire/generic_bandwidth_allocation.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdw_group_params {
    pub rate: c_uint,
    pub lane: c_uint,
    pub full_bw: c_int,
    pub payload_bw: c_int,
    pub hwidth: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdw_group {
    pub count: c_uint,
    pub max_size: c_uint,
    pub rates: *mut c_uint,
    pub lanes: *mut c_uint,
}

    void sdw_compute_slave_ports(struct sdw_master_runtime *m_rt,
    struct sdw_transport_data *t_data)
    {
    struct sdw_slave_runtime *s_rt = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sdw_compute_dp0_slave_ports(m_rt: *mut sdw_master_runtime) {
...
#[no_mangle]
unsafe extern "C" fn sdw_compute_dp0_master_ports(m_rt: *mut sdw_master_runtime) {
...
#[no_mangle]
unsafe extern "C" fn sdw_compute_dp0_port_params(bus: *mut sdw_bus) {
...
// DP0 is for BPT only
    ...
    {
    let mut t_data: sdw_transport_data = {0};
    struct sdw_port_runtime *p_rt;
    struct sdw_bus *bus = m_rt.bus;
...
//
    ...
    struct sdw_master_runtime *m_rt;
    struct sdw_port_runtime *p_rt;
    let mut sel_col: c_int = bus.params.col;
    unsigned int rate, bps, ch;
...
//
#[no_mangle]
unsafe extern "C" fn sdw_compute_port_params(bus: *mut sdw_bus, stream: *mut sdw_stream_runtime) -> c_int {
    static int sdw_compute_port_params(struct sdw_bus *bus, struct sdw_stream_runtime *stream)
    {
    struct sdw_group_params *params = core::ptr::null_mut();
    struct sdw_group group;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sdw_select_row_col(bus: *mut sdw_bus, clk_freq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_clock_scaling_supported(bus: *mut sdw_bus) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn is_lane_connected_to_all_peripherals(m_rt: *mut sdw_master_runtime, lane: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn sdw_compute_bus_params(bus: *mut sdw_bus) -> c_int {
    ...
    struct sdw_master_runtime *m_rt;
    struct sdw_slave_runtime *s_rt;
    let mut curr_dr_freq: c_uint = 0;
    int i, l, clk_values, ret;
    let mut is_gear: bool = false;
    let mut m_lane: c_int = 0;
    u32 *clk_buf;
...
//
#[no_mangle]
pub unsafe extern "C" fn sdw_compute_params(bus: *mut sdw_bus, stream: *mut sdw_stream_runtime) -> c_int {
