...
//
#[no_mangle]
unsafe extern "C" fn cn_call_callback(skb: *mut sk_buff) -> c_int {
    static int cn_call_callback(struct sk_buff *skb)
    {
    struct nlmsghdr *nlh;
    struct cn_callback_entry *i, *cbq = core::ptr::null_mut();
    struct cn_dev *dev = &cdev;
...
//
#[no_mangle]
unsafe extern "C" fn cn_bind(net: *mut net, group: c_int) -> c_int {
    static int cn_bind(struct net *net, int group)
    {
    let mut groups: c_ulong = (unsigned long) group;
...
#[no_mangle]
unsafe extern "C" fn cn_proc_show(m: *mut seq_file, v: *mut c_void) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cn_init() -> c_int {
