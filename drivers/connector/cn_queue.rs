...
//! Source: drivers/connector/cn_queue.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cn_cb_equal(i1: *const cb_id, i2: *const cb_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cn_queue_free_dev(dev: *mut cn_queue_dev) {
