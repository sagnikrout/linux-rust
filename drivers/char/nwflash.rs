...
pub const KFLASH_ID: c_uint = 0x89A6		//Intel flash;
pub const KFLASH_ID4: c_uint = 0xB0D4		//Intel flash 4Meg;
    static bool flashdebug;		//if set - we will display progress msgs
    static int gbWriteEnable;
    static int gbWriteBase64Enable;
    static volatile unsigned char *FLASH_BASE;
    let mut gbFlashSize: static int = KFLASH_SIZE;
    static DEFINE_MUTEX(nwflash_mutex);
#[no_mangle]
unsafe extern "C" fn get_flash_id() -> c_int {
    static int get_flash_id(void)
    {
...
#[no_mangle]
unsafe extern "C" fn flash_ioctl(filep: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn flash_llseek(file: *mut file, offset: loff_t, orig: c_int) -> loff_t {
...
//
#[no_mangle]
unsafe extern "C" fn erase_block(nBlock: c_int) -> c_int {
    static int erase_block(int nBlock)
    {
...
//
#[no_mangle]
unsafe extern "C" fn write_block(p: c_ulong, buf: *const char __user, count: c_int) -> c_int {
    static int write_block(unsigned long p, const char __user *buf, int count)
    {
    volatile unsigned int c1;
...
#[no_mangle]
unsafe extern "C" fn nwflash_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nwflash_exit() -> void __exit {
