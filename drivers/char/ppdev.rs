...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pp_struct {
    pub pdev: *mut pardevice,
    pub irq_wait: wait_queue_head_t,
    pub irqc: core::sync::atomic::AtomicI32,
    pub flags: c_uint,
    pub irqresponse: c_int,
    pub irqctl: c_uchar,
    pub state: ieee1284_info,
    pub saved_state: ieee1284_info,
    pub default_inactivity: c_long,
    pub index: c_int,
}
...
pub const PP_BUFFER_SIZE: c_int = 1024;
pub const PARDEVICE_MAX: c_int = 8;
    static DEFINE_MUTEX(pp_do_mutex);
// define fixed sized ioctl cmd for y2038 migration

#[no_mangle]
pub unsafe extern "C" fn pp_enable_irq(pp: *mut pp_struct) {
...
// Trivial case.
    ...
    while (bytes_read == 0) {
    let mut need: isize = min_t(unsigned long, count, PP_BUFFER_SIZE);
...
// Don't have the port claimed
    ...
    let mut n: isize = min_t(unsigned long, count - bytes_written, PP_BUFFER_SIZE);
...
#[no_mangle]
unsafe extern "C" fn pp_irq(private: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn register_device(minor: c_int, pp: *mut pp_struct) -> c_int {
    static int register_device(int minor, struct pp_struct *pp)
    {
    struct parport *port;
    struct pardevice *pdev = core::ptr::null_mut();
    char *name;
    struct pardev_cb ppdev_cb;
    let mut rc: c_int = 0, index;
...
#[no_mangle]
unsafe extern "C" fn init_phase(mode: c_int) -> enum ieee1284_phase {
...
#[no_mangle]
unsafe extern "C" fn pp_set_timeout(pdev: *mut pardevice, tv_sec: i64, tv_usec: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pp_do_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_int {
...
// Deferred device registration.
    if (!pp.pdev) {
    let mut err: c_int = register_device(minor, pp);
    if (err)
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn pp_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn pp_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
    pp.pdev = core::ptr::null_mut();
    file.private_data = pp;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pp_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pp_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn pp_attach(port: *mut parport) {
    ...
    MKDEV(PP_MAJOR, port.number), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn pp_detach(port: *mut parport) {
    static void pp_detach(struct parport *port)
    {
    if (!devices[port.number])
    return;
    device_destroy(&ppdev_class, MKDEV(PP_MAJOR, port.number));
    devices[port.number] = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn pp_probe(par_dev: *mut pardevice) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ppdev_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ppdev_cleanup() -> void __exit {
