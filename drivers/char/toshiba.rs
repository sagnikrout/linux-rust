...
#[no_mangle]
unsafe extern "C" fn tosh_fn_status() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tosh_emulate_fan(regs: *mut SMMRegisters) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tosh_smm(regs: *mut SMMRegisters) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tosh_ioctl(fp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn proc_toshiba_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tosh_set_fn_port() {
...
//
#[no_mangle]
unsafe extern "C" fn tosh_get_machine_id(bios: *mut void __iomem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tosh_probe() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn toshiba_init() -> int __init {
...
// register the device file
    ...
    pde = proc_create_single("toshiba", 0, core::ptr::null_mut(), proc_toshiba_show);
    if (!pde) {
...
#[no_mangle]
unsafe extern "C" fn toshiba_exit() -> void __exit {
    static void __exit toshiba_exit(void)
    {
    remove_proc_entry("toshiba", core::ptr::null_mut());
    misc_deregister(&tosh_device);
    }
