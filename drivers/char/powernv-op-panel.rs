...
//! Source: drivers/char/powernv-op-panel.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn oppanel_llseek(filp: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn __op_panel_update_display() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(oppanel_size: *mut *mut f_pos >=) -> else {
