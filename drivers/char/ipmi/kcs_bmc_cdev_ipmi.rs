...
//! Source: drivers/char/ipmi/kcs_bmc_cdev_ipmi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct kcs_bmc_ipmi {
    pub entry: list_head,
    pub client: kcs_bmc_client,
    pub lock: spinlock_t,
    pub phase: enum kcs_ipmi_phases,
    pub error: enum kcs_ipmi_errors,
    pub queue: wait_queue_head_t,
    pub data_in_avail: bool,
    pub data_in_idx: c_int,
    pub data_in: *mut u8,
    pub data_out_idx: c_int,
    pub data_out_len: c_int,
    pub data_out: *mut u8,
    pub mutex: mutex,
    pub kbuffer: *mut u8,
...
pub const KCS_MSG_BUFSIZ: c_int = 1000;
pub const KCS_ZERO_DATA: c_int = 0;
...
pub const KCS_CMD_GET_STATUS_ABORT: c_uint = 0x60;
pub const KCS_CMD_WRITE_START: c_uint = 0x61;
pub const KCS_CMD_WRITE_END: c_uint = 0x62;
pub const KCS_CMD_READ_BYTE: c_uint = 0x68;
#[no_mangle]
pub unsafe extern "C" fn set_state(priv: *mut kcs_bmc_ipmi, state: u8) {
...
#[no_mangle]
unsafe extern "C" fn kcs_bmc_ipmi_force_abort(priv: *mut kcs_bmc_ipmi) {
...
#[no_mangle]
unsafe extern "C" fn kcs_bmc_ipmi_handle_data(priv: *mut kcs_bmc_ipmi) {
...
#[no_mangle]
unsafe extern "C" fn kcs_bmc_ipmi_handle_cmd(priv: *mut kcs_bmc_ipmi) {
...
#[no_mangle]
unsafe extern "C" fn kcs_bmc_ipmi_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kcs_bmc_ipmi_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn kcs_bmc_ipmi_release(inode: *mut inode, filp: *mut file) -> c_int {
...
unsafe extern "C" fn kcs_bmc_ipmi_remove_device(kcs_bmc: *mut kcs_bmc_device) -> c_int {
    ...
    {
    struct kcs_bmc_ipmi *priv = core::ptr::null_mut(), *pos;
    spin_lock_irq(&kcs_bmc_ipmi_instances_lock);
...
#[no_mangle]
unsafe extern "C" fn kcs_bmc_ipmi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kcs_bmc_ipmi_exit() -> void __exit {
