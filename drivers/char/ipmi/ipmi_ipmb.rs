...
//! Source: drivers/char/ipmi/ipmi_ipmb.c
#![no_std]
...
pub struct ipmi_ipmb_dev {
    ...
    pub max_retries: u32,
    pub next_msg: *mut ipmi_smi_msg,
    pub working_msg: *mut ipmi_smi_msg,
// Transmit thread.
    pub thread: *mut task_struct,
    pub wake_thread: semaphore,
    pub got_rsp: semaphore,
    pub lock: spinlock_t,
    pub stopping: bool,
    pub xmitmsg: [u8; IPMB_MAX_MSG_LEN],
    pub xmitlen: c_uint,
    pub rcvmsg: [u8; IPMB_MAX_MSG_LEN],
    pub rcvlen: c_uint,
    pub overrun: bool,
}

#[no_mangle]
unsafe extern "C" fn valid_ipmb(iidev: *mut ipmi_ipmb_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_check_msg_done(iidev: *mut ipmi_ipmb_dev) {
    static void ipmi_ipmb_check_msg_done(struct ipmi_ipmb_dev *iidev)
    {
    struct ipmi_smi_msg *imsg = core::ptr::null_mut();
    u8 *msg = iidev.rcvmsg;
    bool is_cmd;
    unsigned long flags;
    if (iidev.rcvlen == 0)
...
// It's a command, allocate a message for it.
    ...
    let mut seq: u8 = msg[4] >> 2;
    let mut xmit_rsp: bool = (iidev.working_msg.data[0] >> 2) & 1;
//
...
//
    ...
    iidev.working_msg = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_thread(data: *mut c_void) -> c_int {
    ...
    struct ipmi_smi_msg *msg = core::ptr::null_mut();
    unsigned long flags;
...
// Wait for a message to send
    ...
    if (iidev.next_msg) {
    msg = iidev.next_msg;
    iidev.next_msg = core::ptr::null_mut();
    }
    spin_unlock_irqrestore(&iidev.lock, flags);
    if (!msg)
    continue;
...
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_stop_thread(iidev: *mut ipmi_ipmb_dev) {
    static void ipmi_ipmb_stop_thread(struct ipmi_ipmb_dev *iidev)
    {
    if (iidev.thread) {
    struct task_struct *t = iidev.thread;
    iidev.thread = core::ptr::null_mut();
    iidev.stopping = true;
...
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_shutdown(send_info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_sender(send_info: *mut c_void, msg: *mut ipmi_smi_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_request_events(send_info: *mut c_void) {
    static void ipmi_ipmb_request_events(void *send_info)
    {
// We don't fetch events here.
    }
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_cleanup(iidev: *mut ipmi_ipmb_dev) {
    ...
    iidev.slave = core::ptr::null_mut();
    iidev.client = core::ptr::null_mut();
    ipmi_ipmb_stop_thread(iidev);
    }
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_ipmb_probe(client: *mut i2c_client) -> c_int {
    static int ipmi_ipmb_probe(struct i2c_client *client)
    {
    struct device *dev = &client.dev;
    struct ipmi_ipmb_dev *iidev;
    struct device_node *slave_np;
    struct i2c_adapter *slave_adap = core::ptr::null_mut();
    struct i2c_client *slave = core::ptr::null_mut();
    int rv;
