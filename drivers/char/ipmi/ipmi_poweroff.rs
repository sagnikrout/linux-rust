...
//! Source: drivers/char/ipmi/ipmi_poweroff.c
#![no_std]
...
pub const IPMI_CHASSIS_POWER_CYCLE: c_uint = 0x02	/* power cycle */;
...
#[no_mangle]
unsafe extern "C" fn set_param_ifnum(val: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    ipmi_po_new_smi(ifnum_to_use, core::ptr::null_mut());
    return 0;
    }
...
// required.
//
    let mut dummy_count: static atomic_t = ATOMIC_INIT(0);
#[no_mangle]
unsafe extern "C" fn dummy_smi_free(msg: *mut ipmi_smi_msg) {
    static void dummy_smi_free(struct ipmi_smi_msg *msg)
    {
    atomic_dec(&dummy_count);
    }
#[no_mangle]
unsafe extern "C" fn dummy_recv_free(msg: *mut ipmi_recv_msg) {
    static void dummy_recv_free(struct ipmi_recv_msg *msg)
    {
    atomic_dec(&dummy_count);
    }
    let mut halt_smi_msg: static struct ipmi_smi_msg = INIT_IPMI_SMI_MSG(dummy_smi_free);
    let mut halt_recv_msg: static struct ipmi_recv_msg = INIT_IPMI_RECV_MSG(dummy_recv_free);
//
// Code to send a message and wait for the response.
//
#[no_mangle]
unsafe extern "C" fn receive_handler(recv_msg: *mut ipmi_recv_msg, handler_data: *mut c_void) {
...
// Wait for message to complete, spinning.
    ...
    rv = ipmi_request_supply_msgs(user, addr, 0, send_msg, core::ptr::null_mut(),
    &halt_smi_msg, &halt_recv_msg, 0);
    if (rv) {
...
// ATCA Support
//
pub const IPMI_NETFN_ATCA: c_uint = 0x2c;
pub const IPMI_ATCA_SET_POWER_CMD: c_uint = 0x11;
pub const IPMI_ATCA_GET_ADDR_INFO_CMD: c_uint = 0x01;
pub const IPMI_PICMG_ID: c_int = 0;
pub const IPMI_NETFN_OEM: c_uint = 0x2e;
pub const IPMI_ATCA_PPS_GRACEFUL_RESTART: c_uint = 0x11;

pub const IPMI_MOTOROLA_MANUFACTURER_ID: c_uint = 0x0000A1;
pub const IPMI_MOTOROLA_PPS_IPMC_PRODUCT_ID: c_uint = 0x0051;
    static void (*atca_oem_poweroff_hook)(struct ipmi_user *user);
#[no_mangle]
unsafe extern "C" fn pps_poweroff_atca(user: *mut ipmi_user) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_atca_detect(user: *mut ipmi_user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmi_poweroff_atca(user: *mut ipmi_user) {
...
// CPI1 Support
//
pub const IPMI_NETFN_OEM_1: c_uint = 0xf8;
pub const OEM_GRP_CMD_SET_RESET_STATE: c_uint = 0x84;
pub const OEM_GRP_CMD_SET_POWER_STATE: c_uint = 0x82;
pub const IPMI_NETFN_OEM_8: c_uint = 0xf8;
pub const OEM_GRP_CMD_REQUEST_HOTSWAP_CTRL: c_uint = 0x80;
pub const OEM_GRP_CMD_GET_SLOT_GA: c_uint = 0xa3;
pub const IPMI_NETFN_SENSOR_EVT: c_uint = 0x10;
pub const IPMI_CMD_GET_EVENT_RECEIVER: c_uint = 0x01;
pub const IPMI_CPI1_PRODUCT_ID: c_uint = 0x000157;
pub const IPMI_CPI1_MANUFACTURER_ID: c_uint = 0x0108;
#[no_mangle]
unsafe extern "C" fn ipmi_cpi1_detect(user: *mut ipmi_user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmi_poweroff_cpi1(user: *mut ipmi_user) {
...
//
    ...
    send_msg.data = core::ptr::null_mut();
    send_msg.data_len = 0;
    rv = ipmi_request_in_rc_mode(user,
    (struct ipmi_addr *) &smi_addr,
    &send_msg);
...
#[no_mangle]
unsafe extern "C" fn ipmi_dell_chassis_detect(user: *mut ipmi_user) -> c_int {
    static int ipmi_dell_chassis_detect(struct ipmi_user *user)
    {
    let mut ipmi_version_major: c_char = ipmi_version & 0xF;
    let mut ipmi_version_minor: c_char = (ipmi_version >> 4) & 0xF;
...
// but they can handle a chassis poweroff or powercycle command.
//
pub const HP_IANA_MFR_ID: c_uint = 0x0b;
pub const HP_BMC_PROD_ID: c_uint = 0x8201;
#[no_mangle]
unsafe extern "C" fn ipmi_hp_chassis_detect(user: *mut ipmi_user) -> c_int {
...
//
pub const IPMI_NETFN_CHASSIS_REQUEST: c_int = 0;
pub const IPMI_CHASSIS_CONTROL_CMD: c_uint = 0x02;
#[no_mangle]
unsafe extern "C" fn ipmi_chassis_detect(user: *mut ipmi_user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmi_poweroff_chassis(user: *mut ipmi_user) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct poweroff_function {
    pub platform_type: *mut c_char,
    pub user): *mut *mut int (detect)(struct ipmi_user,
    pub user): *mut *mut void (poweroff_func)(struct ipmi_user,
}
...
#[no_mangle]
unsafe extern "C" fn ipmi_poweroff_function() {
...
#[no_mangle]
unsafe extern "C" fn ipmi_po_new_smi(if_num: c_int, device: *mut device) {
    static void ipmi_po_new_smi(int if_num, struct device *device)
    {
    struct ipmi_system_interface_addr smi_addr;
    struct kernel_ipmi_msg            send_msg;
    ...
    return;
    rv = ipmi_create_user(if_num, &ipmi_poweroff_handler, core::ptr::null_mut(),
    &ipmi_user);
    if (rv) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_po_smi_gone(if_num: c_int) {
    static void ipmi_po_smi_gone(int if_num)
    {
    if (!ready)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn ipmi_poweroff_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ipmi_poweroff_cleanup() -> void __exit {
