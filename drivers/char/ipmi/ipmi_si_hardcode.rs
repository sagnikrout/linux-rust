...
//! Source: drivers/char/ipmi/ipmi_si_hardcode.c
#![no_std]
...
//
pub const SI_MAX_PARMS: c_int = 4;
pub const MAX_SI_TYPE_STR: c_int = 30;
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_hardcode_init() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_si_hardcode_exit() {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipmi_si_hardcode_match(addr_space: c_int, addr: c_ulong) -> c_int {
