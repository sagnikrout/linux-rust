...
//! Source: drivers/char/ipmi/ipmi_bt_sm.c
#![no_std]
...
pub const BT_NORMAL_RETRY_LIMIT: c_int = 2;
...
pub struct si_sm_data {
    pub state: enum bt_states,
    pub /: *mut *mut unsigned char seq; / BT sequence number,
    pub io: *mut si_sm_io,
    pub /: *mut *mut unsigned char write_data[IPMI_MAX_MSG_LENGTH + 2]; / +2 for memcpy,
    pub write_count: c_int,
    pub /: *mut *mut unsigned char read_data[IPMI_MAX_MSG_LENGTH + 2]; / +2 for memcpy,
    pub read_count: c_int,
    pub truncated: c_int,
    pub /: *mut *mut long timeout; / microseconds countdown,
    pub /: *mut *mut int error_retries; / end of "common" fields,
    pub /: *mut *mut int nonzero_status; / hung BMCs stay all 0,
    pub /: *mut *mut enum bt_states complete; / to divert the state machine,
    pub BT_CAP_req2rsp: c_long,
    pub /: *mut *mut int BT_CAP_retries; / Recommended retries,
}

pub const BT_CLR_WR_PTR: c_uint = 0x01	/* See IPMI 1.5 table 11.6.4 */;
pub const BT_CLR_RD_PTR: c_uint = 0x02;
pub const BT_H2B_ATN: c_uint = 0x04;
pub const BT_B2H_ATN: c_uint = 0x08;
pub const BT_SMS_ATN: c_uint = 0x10;
pub const BT_OEM0: c_uint = 0x20;
pub const BT_H_BUSY: c_uint = 0x40;
pub const BT_B_BUSY: c_uint = 0x80;
//
...
#[no_mangle]
unsafe extern "C" fn bt_init_data(bt: *mut si_sm_data, io: *mut si_sm_io) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn force_result(bt: *mut si_sm_data, completion_code: c_uchar) {
...
pub const BT_BMC_HWRST: c_uint = 0x80;
#[no_mangle]
unsafe extern "C" fn reset_flags(bt: *mut si_sm_data) {
...
//
#[no_mangle]
unsafe extern "C" fn drain_BMC2HOST(bt: *mut si_sm_data) {
...
#[no_mangle]
pub unsafe extern "C" fn write_all_bytes(bt: *mut si_sm_data) {
...
#[no_mangle]
pub unsafe extern "C" fn read_all_bytes(bt: *mut si_sm_data) -> c_int {
...
//
    ...
    if (bt_debug & BT_DEBUG_MSG) {
    let mut max: c_int = bt.read_count;
    dev_dbg(bt.io.dev,
...
#[no_mangle]
pub unsafe extern "C" fn if(0xFF): bt->seq <= (unsigned char)(bt->BT_CAP_retries &) -> else {
...
#[no_mangle]
unsafe extern "C" fn bt_event(bt: *mut si_sm_data, time: c_long) -> enum si_sm_result {
    static enum si_sm_result bt_event(struct si_sm_data *bt, long time)
    {
    unsigned char status;
    let mut last_printed: static enum bt_states = BT_STATE_PRINTME;
    int i;
    status = BT_STATUS;
...
#[no_mangle]
unsafe extern "C" fn bt_detect(bt: *mut si_sm_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bt_cleanup(bt: *mut si_sm_data) {
    static void bt_cleanup(struct si_sm_data *bt)
    {
    }
#[no_mangle]
unsafe extern "C" fn bt_size() -> c_int {
