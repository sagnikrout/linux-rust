...
//! Source: drivers/char/ipmi/ipmi_si_hotmod.c
#![no_std]
...
//
    ...
    module_param_call(hotmod, hotmod_handler, core::ptr::null_mut(), core::ptr::null_mut(), 0200);
...
// o = '\0';
    ...
    return rv;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rv) -> else {
    else if (rv)
    continue;
...
#[no_mangle]
unsafe extern "C" fn hotmod_handler(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int hotmod_handler(const char *val, const struct kernel_param *kp)
    {
    int  rv;
    struct ipmi_plat_data h;
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_si_hotmod_exit() {
