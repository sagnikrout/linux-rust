...
//! Source: drivers/char/ipmi/ssif_bmc.c
#![no_std]
...
pub const MAX_PAYLOAD_PER_TRANSACTION: c_int = 32;
// Transaction includes the address, the command, the length and the PEC byte

pub const MAX_IPMI_DATA_PER_START_TRANSACTION: c_int = 30;
pub const MAX_IPMI_DATA_PER_MIDDLE_TRANSACTION: c_int = 31;
pub const SSIF_IPMI_SINGLEPART_WRITE: c_uint = 0x2;
pub const SSIF_IPMI_SINGLEPART_READ: c_uint = 0x3;
pub const SSIF_IPMI_MULTIPART_WRITE_START: c_uint = 0x6;
pub const SSIF_IPMI_MULTIPART_WRITE_MIDDLE: c_uint = 0x7;
pub const SSIF_IPMI_MULTIPART_WRITE_END: c_uint = 0x8;
pub const SSIF_IPMI_MULTIPART_READ_START: c_uint = 0x3;
pub const SSIF_IPMI_MULTIPART_READ_MIDDLE: c_uint = 0x9;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssif_part_buffer {
    pub address: u8,
    pub smbus_cmd: u8,
    pub length: u8,
    pub payload: [u8; MAX_PAYLOAD_PER_TRANSACTION],
    pub pec: u8,
    pub index: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssif_bmc_ctx {
    pub client: *mut i2c_client,
    pub miscdev: miscdevice,
    pub msg_idx: c_int,
    pub pec_support: bool,
// ssif bmc spinlock
    pub lock: spinlock_t,
    pub wait_queue: wait_queue_head_t,
    pub running: u8,
    pub state: enum ssif_state,
// Timeout waiting for response
    pub response_timer: timer_list,
    pub response_timer_inited: bool,
// Flag to identify a Multi-part Read Transaction
    pub is_singlepart_read: bool,
    pub nbytes_processed: u8,
    pub remain_len: u8,
    pub recv_len: u8,
...
// Buffer for SSIF Transaction part
    pub part_buf: ssif_part_buffer,
    pub response: ipmi_ssif_msg,
    pub request: ipmi_ssif_msg,
}
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_read(file: *mut file, buf: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn complete_response(ssif_bmc: *mut ssif_bmc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn response_timeout(t: *mut timer_list) {
...
// Called with ssif_bmc->lock held.
#[no_mangle]
unsafe extern "C" fn handle_request(ssif_bmc: *mut ssif_bmc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn calculate_response_part_pec(part: *mut ssif_part_buffer) {
    static void calculate_response_part_pec(struct ssif_part_buffer *part)
    {
    let mut addr: u8 = part.address;
...
#[no_mangle]
unsafe extern "C" fn set_singlepart_response_buffer(ssif_bmc: *mut ssif_bmc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn set_multipart_response_buffer(ssif_bmc: *mut ssif_bmc_ctx) {
    static void set_multipart_response_buffer(struct ssif_bmc_ctx *ssif_bmc)
    {
    struct ssif_part_buffer *part = &ssif_bmc.part_buf;
    let mut part_len: u8 = 0;
    part.address = GET_8BIT_ADDR(ssif_bmc.client.addr);
...
#[no_mangle]
unsafe extern "C" fn supported_read_cmd(cmd: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn supported_write_cmd(cmd: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn supported_write_start_cmd(cmd: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn handle_read_processed(ssif_bmc: *mut ssif_bmc_ctx, val: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ssif_bmc->pec_support: part->index == part->length &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn handle_write_received(ssif_bmc: *mut ssif_bmc_ctx, val: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn validate_request_part(ssif_bmc: *mut ssif_bmc_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn process_request_part(ssif_bmc: *mut ssif_bmc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn process_smbus_cmd(ssif_bmc: *mut ssif_bmc_ctx, val: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn on_read_requested_event(ssif_bmc: *mut ssif_bmc_ctx, val: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn on_read_processed_event(ssif_bmc: *mut ssif_bmc_ctx, val: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn on_write_requested_event(ssif_bmc: *mut ssif_bmc_ctx, val: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn on_write_received_event(ssif_bmc: *mut ssif_bmc_ctx, val: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn if(SSIF_SMBUS_CMD: ssif_bmc->state ==) -> else {
    else if (ssif_bmc.state == SSIF_SMBUS_CMD)
    process_smbus_cmd(ssif_bmc, val);
    }
#[no_mangle]
unsafe extern "C" fn on_stop_event(ssif_bmc: *mut ssif_bmc_ctx, val: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ssif_bmc_cb(client: *mut i2c_client, event: enum i2c_slave_event, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_remove(client: *mut i2c_client) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssif_bmc_test_ctx {
    pub ssif_bmc: ssif_bmc_ctx,
    pub client: i2c_client,
    pub adapter: i2c_adapter,
    pub algo: i2c_algorithm,
}

#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_exit(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_singlepart_req(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_restart_write_without_stop(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_restart_after_invalid_command(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_singlepart_read_response_completion(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_stop_during_start_discards_partial_request(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_read_interrupts_partial_write(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_write_interrupts_response_send(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_write_interrupts_response_sending(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn ssif_bmc_test_timeout_interrupt_allows_retry(test: *mut kunit) {
