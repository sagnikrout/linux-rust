...
//! Source: drivers/char/ipmi/ipmb_dev_int.c
#![no_std]
...
pub const MAX_MSG_LEN: c_int = 240;
pub const IPMB_REQUEST_LEN_MIN: c_int = 7;
pub const NETFN_RSP_BIT_MASK: c_uint = 0x4;
pub const REQUEST_QUEUE_MAX_LEN: c_int = 256;
pub const IPMB_MSG_LEN_IDX: c_int = 0;
pub const RQ_SA_8BIT_IDX: c_int = 1;
pub const NETFN_LUN_IDX: c_int = 2;

pub const SMBUS_MSG_HEADER_LENGTH: c_int = 2;
...
pub struct ipmb_msg {
    ...
    pub cmd: u8,
    pub payload: [u8; IPMB_MSG_PAYLOAD_LEN_MAX],
// checksum2 is included in payload
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipmb_request_elem {
    pub list: list_head,
    pub request: ipmb_msg,
}
...
pub struct ipmb_dev {
    ...
    pub request: ipmb_msg,
    pub request_queue: list_head,
    pub request_queue_len: core::sync::atomic::AtomicI32,
    pub msg_idx: usize,
    pub lock: spinlock_t,
    pub wait_queue: wait_queue_head_t,
    pub file_mutex: mutex,
    pub is_i2c_protocol: bool,
}
...
#[no_mangle]
unsafe extern "C" fn ipmb_i2c_write(client: *mut i2c_client, msg: *mut u8, addr: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmb_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
    static __poll_t ipmb_poll(struct file *file, poll_table *wait)
    {
    struct ipmb_dev *ipmb_dev = to_ipmb_dev(file);
    let mut mask: __poll_t = EPOLLOUT;
...
#[no_mangle]
unsafe extern "C" fn ipmb_handle_request(ipmb_dev: *mut ipmb_dev) {
...
#[no_mangle]
unsafe extern "C" fn ipmb_verify_checksum1(ipmb_dev: *mut ipmb_dev, rs_sa: u8) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn is_ipmb_msg(ipmb_dev: *mut ipmb_dev, rs_sa: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ipmb_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmb_remove(client: *mut i2c_client) {
