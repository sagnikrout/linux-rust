...
//! Source: drivers/char/ipmi/ipmi_devintf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipmi_open(inode: *mut inode, file: *mut file) -> c_int {
    static int ipmi_open(struct inode *inode, struct file *file)
    {
    let mut if_num: c_int = iminor(inode);
    int                      rv;
    ...
    priv.fasync_queue = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ipmi_release(inode: *mut inode, file: *mut file) -> c_int {
...
// From here out we cannot return, we must jump to "out" for
    ...
    if (rv)
    goto out;
    if (req.msg.data != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn copyout_recv(rsp: *mut ipmi_recv, to: *mut void __user) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_ipmi_req {
    pub addr: compat_uptr_t,
    pub addr_len: compat_uint_t,
    pub msgid: compat_long_t,
    pub msg: compat_ipmi_msg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_ipmi_recv {
    pub recv_type: compat_int_t,
    pub addr: compat_uptr_t,
    pub addr_len: compat_uint_t,
    pub msgid: compat_long_t,
    pub msg: compat_ipmi_msg,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_ipmi_req_settime {
    pub req: compat_ipmi_req,
    pub retries: compat_int_t,
    pub retry_time_ms: compat_uint_t,
}
...
#[no_mangle]
unsafe extern "C" fn copyout_recv32(p64: *mut ipmi_recv, to: *mut void __user) -> c_int {
...
unsafe extern "C" fn ipmi_new_smi(if_num: c_int, device: *mut device) {
    ...
    {
    let mut dev: dev_t = MKDEV(ipmi_major, if_num);
    ...
    device_create(&ipmi_class, device, dev, core::ptr::null_mut(), "ipmi%d", if_num);
...
#[no_mangle]
unsafe extern "C" fn init_ipmi_devintf() -> int __init {
