...
//! Source: drivers/char/ipmi/ipmi_msghandler.c
#![no_std]
...
// Indices in this array should be mapped to enum ipmi_panic_event_op
    static const char *const ipmi_panic_event_str[] = { "none", "event", "string", core::ptr::null_mut() };

    let mut ipmi_send_panic_event: static enum ipmi_panic_event_op = IPMI_PANIC_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn panic_op_read_handler(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    ...
    module_param_cb(panic_op, &panic_op_ops, core::ptr::null_mut(), 0600);
    MODULE_PARM_DESC(panic_op, "Sets if the IPMI driver will attempt to store panic information in the event log in the event of a panic.  Set to 'none' for no, 'event' for a single event, or 'string' for a generic event and the panic string in IPMI OEM events.");
pub const MAX_EVENTS_IN_QUEUE: c_int = 25;
// Remain in auto-maintenance mode for this amount of time (in ms).
    let mut maintenance_mode_timeout_ms: static unsigned long = 30000;
...
//
pub const MAX_MSG_TIMEOUT: c_int = 60000;
//
...
// The default timeout for message retries.
    let mut default_retry_ms: static unsigned long = 2000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipmi_user {
    pub link: list_head,
    pub refcount: kref,
    pub destroyed: refcount_t,
// The upper layer that handles receive messages.
    pub handler: *const ipmi_user_hndl,
    pub handler_data: *mut c_void,
// The interface this user is bound to.
    pub intf: *mut ipmi_smi,
// Does this interface receive IPMI events?
    pub gets_events: bool,
    pub nr_msgs: core::sync::atomic::AtomicI32,
}
...
//
    pub next: *mut cmd_rcvr,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct seq_table {
    pub 1: unsigned int inuse :,
    pub 1: unsigned int broadcast :,
    pub timeout: c_ulong,
    pub orig_timeout: c_ulong,
    pub retries_left: c_uint,
//
...
pub const IPMI_MAX_CHANNELS: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmc_device {
    pub pdev: platform_device,
    pub /: *mut *mut list_head intfs; / Interfaces on this BMC.,
    pub id: ipmi_device_id,
    pub fetch_id: ipmi_device_id,
    pub dyn_id_set: c_int,
    pub dyn_id_expiry: c_ulong,
    pub /: *mut *mut *mut mutex dyn_mutex; / Protects id, intfs, & dyn,
    pub guid: guid_t,
    pub fetch_guid: guid_t,
    pub dyn_guid_set: c_int,
    pub usecount: kref,
    pub remove_work: work_struct,
    pub /: *mut *mut unsigned char cc; / completion code,
}
...
pub const IPMI_IPMB_NUM_SEQ: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipmi_smi {
...
//
    ...
    pub nr_users: core::sync::atomic::AtomicI32,
    pub nr_users_devattr: device_attribute,
    pub nr_msgs_devattr: device_attribute,
    pub maintenance_mode_devattr: device_attribute,
...
// structure.
//
    pub bmc_reg_mutex: mutex,
    pub tmp_bmc: bmc_device,
    pub bmc: *mut bmc_device,
    pub bmc_registered: bool,
    pub bmc_link: list_head,
    pub my_dev_name: *mut c_char,
    pub /: *mut *mut bool in_bmc_register; / Handle recursive situations. Yuck.,
    pub bmc_reg_work: work_struct,
    pub handlers: *const ipmi_smi_handlers,
    pub send_info: *mut c_void,
// Driver-model device for the system interface.
    pub si_dev: *mut device,
//
...
//
    pub seq_lock: mutex,
    pub seq_table: [seq_table; IPMI_IPMB_NUM_SEQ],
    pub curr_seq: c_int,
//
// Messages queued for deliver to the user.
//
    pub user_msgs_mutex: mutex,
    pub user_msgs: list_head,
//
...
// the handler.
//
    pub waiting_rcv_msgs_lock: spinlock_t,
    pub waiting_rcv_msgs: list_head,
    pub watchdog_pretimeouts_to_deliver: core::sync::atomic::AtomicI32,
    pub smi_work: work_struct,
    pub xmit_msgs_lock: spinlock_t,
    pub xmit_msgs: list_head,
    pub curr_msg: *mut ipmi_smi_msg,
    pub hp_xmit_msgs: list_head,
//
// The list of command receivers that are registered for commands
// on this interface.
//
    pub cmd_rcvrs_mutex: mutex,
    pub cmd_rcvrs: list_head,
//
// Events that were queues because no one was there to receive
// them.
//
    pub /: *mut *mut mutex events_mutex; / For dealing with event stuff.,
    pub waiting_events: list_head,
    pub /: *mut *mut unsigned int waiting_events_count; / How many events in queue?,
    pub event_msg_printed: c_char,
// How many users are waiting for events?
    pub event_waiters: core::sync::atomic::AtomicI32,
    pub ticks_to_req_ev: c_uint,
    pub /: *mut *mut spinlock_t watch_lock; / For dealing with watch stuff below.,
// How many users are waiting for commands?
    pub command_waiters: c_uint,
// How many users are waiting for watchdogs?
    pub watchdog_waiters: c_uint,
// How many users are waiting for message responses?
    pub response_waiters: c_uint,
//
// Tells what the lower layer has last been asked to watch for,
// messages and/or watchdogs.  Protected by watch_lock.
//
    pub last_watch_mask: c_uint,
//
// The event receiver for my BMC, only really used at panic
// shutdown as a place to store this.
//
    pub event_receiver: c_uchar,
    pub event_receiver_lun: c_uchar,
    pub local_sel_device: c_uchar,
    pub local_event_generator: c_uchar,
// For handling of maintenance mode.
    pub maintenance_mode: c_int,
pub const IPMI_MAINTENANCE_MODE_STATE_OFF: c_int = 0;
pub const IPMI_MAINTENANCE_MODE_STATE_FIRMWARE: c_int = 1;
pub const IPMI_MAINTENANCE_MODE_STATE_RESET: c_int = 2;
    pub maintenance_mode_state: c_int,
    pub auto_maintenance_timeout: c_int,
    pub /: *mut *mut spinlock_t maintenance_mode_lock; / Used in a timer...,
//
// If we are doing maintenance on something on IPMB, extend
// the timeout time to avoid timeouts writing firmware and
// such.
//
    pub ipmb_maintenance_mode_timeout: c_int,
//
...
//
    ...
    pub msg): *mut ipmi_recv_msg,
//
// When we are scanning the channels for an SMI, this will
// tell which channel we are scanning.
//
    pub curr_channel: c_int,
// Channel information
    pub channel_list: *mut ipmi_channel_set,
    pub /: *mut *mut unsigned int curr_working_cset; / First index into the following.,
    pub wchannels: [ipmi_channel_set; 2],
    pub addrinfo: [ipmi_my_addrinfo; IPMI_MAX_CHANNELS],
    pub channels_ready: bool,
    pub stats: [core::sync::atomic::AtomicI32; IPMI_NUM_STATS],
//
// run_to_completion duplicate of smb_info, smi_info
// and ipmi_serial_info structures. Used to decrease numbers of
// parameters passed by "low" level IPMI code.
//
    pub run_to_completion: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn free_ipmi_user(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn release_ipmi_user(user: *mut ipmi_user) {
...
#[no_mangle]
unsafe extern "C" fn is_lan_addr(addr: *mut ipmi_addr) -> c_int {
    static int is_lan_addr(struct ipmi_addr *addr)
    {
    return addr.addr_type == IPMI_LAN_ADDR_TYPE;
    }
#[no_mangle]
unsafe extern "C" fn is_ipmb_addr(addr: *mut ipmi_addr) -> c_int {
    static int is_ipmb_addr(struct ipmi_addr *addr)
    {
    return addr.addr_type == IPMI_IPMB_ADDR_TYPE;
    }
#[no_mangle]
unsafe extern "C" fn is_ipmb_bcast_addr(addr: *mut ipmi_addr) -> c_int {
    static int is_ipmb_bcast_addr(struct ipmi_addr *addr)
    {
    return addr.addr_type == IPMI_IPMB_BROADCAST_ADDR_TYPE;
    }
#[no_mangle]
unsafe extern "C" fn is_ipmb_direct_addr(addr: *mut ipmi_addr) -> c_int {
    static int is_ipmb_direct_addr(struct ipmi_addr *addr)
    {
    return addr.addr_type == IPMI_IPMB_DIRECT_ADDR_TYPE;
    }
#[no_mangle]
unsafe extern "C" fn free_recv_msg_list(q: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn free_smi_msg_list(q: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn intf_free(ref: *mut kref) {
    static void intf_free(struct kref *ref)
    {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_smi_watcher_register(watcher: *mut ipmi_smi_watcher) -> c_int {
    int ipmi_smi_watcher_register(struct ipmi_smi_watcher *watcher)
    {
    struct ipmi_smi *intf;
    let mut count: c_uint = 0, i;
    int *interfaces = core::ptr::null_mut();
    struct device **devices = core::ptr::null_mut();
    let mut rv: c_int = 0;
//
...
//
    ...
    if (interfaces) {
    list_for_each_entry(intf, &ipmi_interfaces, link) {
    let mut intf_num: c_int = READ_ONCE(intf.intf_num);
    if (intf_num == -1)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_smi_watcher_unregister(watcher: *mut ipmi_smi_watcher) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_validate_addr(addr: *mut ipmi_addr, len: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_addr_length(addr_type: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn deliver_response(intf: *mut ipmi_smi, msg: *mut ipmi_recv_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_add_watch(intf: *mut ipmi_smi, flags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn smi_remove_watch(intf: *mut ipmi_smi, flags: c_uint) {
...
// Got an error for the send message for a specific sequence number.
    ...
    unsigned char        seq;
    unsigned long        seqid;
    struct ipmi_recv_msg *msg = core::ptr::null_mut();
    GET_SEQ_FROM_MSGID(msgid, seq, seqid);
    mutex_lock(&intf.seq_lock);
//
// We do this verification because the user can be deleted
...
//
    ...
    struct ipmi_user      **user)
    {
    struct ipmi_user *new_user = core::ptr::null_mut();
    let mut rv: c_int = 0;
    struct ipmi_smi *intf;
//
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_get_smi_info(if_num: c_int, data: *mut ipmi_smi_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _ipmi_destroy_user(user: *mut ipmi_user) {
    static void _ipmi_destroy_user(struct ipmi_user *user)
    {
    struct ipmi_smi  *intf = user.intf;
    int              i;
    struct cmd_rcvr  *rcvr;
    struct cmd_rcvr  *rcvrs = core::ptr::null_mut();
    struct ipmi_recv_msg *msg, *msg2;
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_destroy_user(user: *mut ipmi_user) {
    ...
    if (!user)
    return -ENODEV;
    rv = bmc_get_device_id(user.intf, core::ptr::null_mut(), &id, core::ptr::null_mut(), core::ptr::null_mut());
    if (!rv) {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_get_maintenance_mode(user: *mut ipmi_user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn maintenance_mode_update(intf: *mut ipmi_smi) {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_set_maintenance_mode(user: *mut ipmi_user, mode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_set_gets_events(user: *mut ipmi_user, val: bool) -> c_int {
...
//
    ...
    {
    let mut run_to_completion: c_int = READ_ONCE(intf.run_to_completion);
    ...
    if (rv) {
    ipmi_lock_xmit_msgs(intf, run_to_completion, &flags);
    intf.curr_msg = core::ptr::null_mut();
    ipmi_unlock_xmit_msgs(intf, run_to_completion, &flags);
//
...
#[no_mangle]
unsafe extern "C" fn is_maintenance_mode_cmd(msg: *mut kernel_ipmi_msg) -> bool {
...
//
    ...
    let mut is_cmd: bool = !(recv_msg.msg.netfn & 0x1);
...
//
    ...
    let mut run_to_completion: c_int = READ_ONCE(intf.run_to_completion);
    let mut rv: c_int = 0;
    let mut in_seq_table: bool = false;
    if (supplied_recv) {
...
// The put happens when the message is freed.
    ...
    if (smi_msg == core::ptr::null_mut()) {
    if (!supplied_recv)
    ipmi_free_recv_msg(recv_msg);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: recv_msg->user) -> else {
...
//
    ...
    msg.data_len = 0;
    return i_ipmi_request(core::ptr::null_mut(),
    intf,
    (struct ipmi_addr *) &si,
    0,
    &msg,
...
#[no_mangle]
unsafe extern "C" fn __get_device_id(intf: *mut ipmi_smi, bmc: *mut bmc_device) -> c_int {
...
// dyn_id_set makes the id data available.
    smp_rmb();
    out_reset_handler:
    intf.null_user_handler = core::ptr::null_mut();
    return rv;
    }
//
...
//
    ...
    let mut intf_set: bool = intf != core::ptr::null_mut();
    if (!intf) {
...
//
    ...
    let mut id: ipmi_device_id = bmc.fetch_id;
    let mut guid_set: c_int = bmc.dyn_guid_set;
    guid_t guid;
    guid = bmc.fetch_guid;
    mutex_unlock(&bmc.dyn_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: prev_guid_set) -> else {
...
// guid =  bmc->guid;
    ...
    struct ipmi_device_id id;
    int rv;
    rv = bmc_get_device_id(core::ptr::null_mut(), bmc, &id, core::ptr::null_mut(), core::ptr::null_mut());
    if (rv)
    return rv;
    ...
    static DEVICE_ATTR(aux_firmware_revision, S_IRUGO, aux_firmware_rev_show, core::ptr::null_mut());
    ...
    guid_t guid;
    int rv;
    rv = bmc_get_device_id(core::ptr::null_mut(), bmc, core::ptr::null_mut(), &guid_set, &guid);
    if (rv)
    return rv;
    if (!guid_set)
    return -ENOENT;
    ...
    bool guid_set;
    rv = bmc_get_device_id(core::ptr::null_mut(), bmc, core::ptr::null_mut(), &guid_set, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __find_bmc_guid(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    {
    struct device *dev;
    struct bmc_device *bmc = core::ptr::null_mut();
    dev = driver_find_device(drv, core::ptr::null_mut(), guid, __find_bmc_guid);
    if (dev) {
    bmc = to_bmc_device(dev);
    put_device(dev);
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct prod_dev_id {
    pub product_id: c_uint,
    pub device_id: c_uchar,
}

#[no_mangle]
unsafe extern "C" fn __find_bmc_prod_dev_id(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    struct device *dev;
    struct bmc_device *bmc = core::ptr::null_mut();
    dev = driver_find_device(drv, core::ptr::null_mut(), &id, __find_bmc_prod_dev_id);
    if (dev) {
    bmc = to_bmc_device(dev);
    put_device(dev);
    }
...
#[no_mangle]
unsafe extern "C" fn cleanup_bmc_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn __ipmi_bmc_unregister(intf: *mut ipmi_smi) {
    static void __ipmi_bmc_unregister(struct ipmi_smi *intf)
    {
    ...
    intf.my_dev_name = core::ptr::null_mut();
    mutex_lock(&bmc.dyn_mutex);
...
#[no_mangle]
unsafe extern "C" fn ipmi_bmc_unregister(intf: *mut ipmi_smi) {
...
#[no_mangle]
unsafe extern "C" fn guid_handler(intf: *mut ipmi_smi, msg: *mut ipmi_recv_msg) {
...
#[no_mangle]
unsafe extern "C" fn __get_guid(intf: *mut ipmi_smi) {
    static void __get_guid(struct ipmi_smi *intf)
    {
    int rv;
    struct bmc_device *bmc = intf.bmc;
...
// dyn_guid_set makes the guid data available.
    ...
    let mut rv: c_int = 0;
    int ch;
    let mut set: c_uint = intf.curr_working_cset;
    struct ipmi_channel *chans;
    if ((msg.addr.addr_type == IPMI_SYSTEM_INTERFACE_ADDR_TYPE)
    && (msg.msg.netfn == IPMI_NETFN_APP_RESPONSE)
...
#[no_mangle]
unsafe extern "C" fn ipmi_poll(intf: *mut ipmi_smi) {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_poll_interface(user: *mut ipmi_user) {
...
#[no_mangle]
unsafe extern "C" fn redo_bmc_reg(work: *mut work_struct) {
    static void redo_bmc_reg(struct work_struct *work)
    {
    struct ipmi_smi *intf = container_of(work, struct ipmi_smi,
    bmc_reg_work);
    if (!intf.in_shutdown)
    bmc_get_device_id(intf, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    kref_put(&intf.refcount, intf_free);
    }
...
// Add the new interface in numeric order.
    ...
    if (rv)
    goto out_err;
    rv = __bmc_get_device_id(intf, core::ptr::null_mut(), &id, core::ptr::null_mut(), core::ptr::null_mut(), i);
    if (rv) {
...
#[no_mangle]
unsafe extern "C" fn cleanup_smi_msgs(intf: *mut ipmi_smi) {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_unregister_smi(intf: *mut ipmi_smi) {
...
//
    ...
    unsigned char            cmd;
    unsigned char            chan;
    struct ipmi_user         *user = core::ptr::null_mut();
    struct ipmi_ipmb_addr    *ipmb_addr;
    struct ipmi_recv_msg     *recv_msg = core::ptr::null_mut();
    if (msg.rsp_size < 10) {
// Message not big enough, just ignore it.
...
//
    ...
    struct ipmi_ipmb_direct_addr *daddr;
    struct ipmi_recv_msg     *recv_msg = core::ptr::null_mut();
    let mut netfn: c_uchar = msg.rsp[0] >> 2;
    let mut cmd: c_uchar = msg.rsp[3];
    rcu_read_lock();
...
//
    ...
    recv_msg.user_msg_data = core::ptr::null_mut();
...
//
    ...
    LIST_HEAD(msgs);
    struct ipmi_user     *user;
    let mut rv: c_int = 0, deliver_count = 0;
    if (msg.rsp_size < 19) {
...
//
    recv_msg = ipmi_alloc_recv_msg(core::ptr::null_mut());
    if (IS_ERR(recv_msg)) {
//
// We couldn't allocate memory for the
// message, so requeue it for handling
...
//
    ...
    struct ipmi_smi_msg *msg)
    {
    let mut requeue: c_int = 0;
    int chan;
    unsigned char cc;
    let mut is_cmd: bool = !((msg.rsp[0] >> 2) & 1);
...
// Construct a valid error response.
    ...
    && (msg.data[0] == (IPMI_NETFN_APP_REQUEST << 2))
    && (msg.data[1] == IPMI_SEND_MSG_CMD)
    && (msg.recv_msg == core::ptr::null_mut())) {
...
//
    ...
    let mut ch: c_int = msg.rsp[3] & 0xf;
    struct ipmi_channel *chans;
...
//
#[no_mangle]
unsafe extern "C" fn handle_new_recv_msgs(intf: *mut ipmi_smi) {
    static void handle_new_recv_msgs(struct ipmi_smi *intf)
    {
    struct ipmi_smi_msg *smi_msg;
    let mut flags: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn smi_work(t: *mut work_struct) {
    static void smi_work(struct work_struct *t)
    {
    unsigned long flags = 0; /* keep us warning-free. */
    struct ipmi_smi *intf = from_work(intf, t, smi_work);
    let mut run_to_completion: c_int = READ_ONCE(intf.run_to_completion);
    struct ipmi_smi_msg *newmsg = core::ptr::null_mut();
    struct ipmi_recv_msg *msg, *msg2;
    int cc;
//
...
//
    restart:
    ipmi_lock_xmit_msgs(intf, run_to_completion, &flags);
    if (intf.curr_msg == core::ptr::null_mut() && !intf.in_shutdown) {
    struct list_head *entry = core::ptr::null_mut();
// Pick the high priority queue first.
    if (!list_empty(&intf.hp_xmit_msgs))
    entry = intf.hp_xmit_msgs.next;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !list_empty(&intf->xmit_msgs)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_smi_watchdog_pretimeout(intf: *mut ipmi_smi) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_lan_addr(&ent->recv_msg->addr)) -> else {
...
#[no_mangle]
unsafe extern "C" fn ipmi_request_event(intf: *mut ipmi_smi) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_timeout_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_timeout(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn need_waiter(intf: *mut ipmi_smi) {
    static void need_waiter(struct ipmi_smi *intf)
    {
// Racy, but worst case we start the timer twice.
    ...
    let mut smi_msg_inuse_count: static atomic_t = ATOMIC_INIT(0);
    let mut recv_msg_inuse_count: static atomic_t = ATOMIC_INIT(0);
#[no_mangle]
unsafe extern "C" fn free_smi_msg(msg: *mut ipmi_smi_msg) {
...
#[no_mangle]
unsafe extern "C" fn free_recv_msg(msg: *mut ipmi_recv_msg) {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_free_recv_msg(msg: *mut ipmi_recv_msg) {
    ...
    let mut panic_done_count: static atomic_t = ATOMIC_INIT(0);
#[no_mangle]
unsafe extern "C" fn dummy_smi_done_handler(msg: *mut ipmi_smi_msg) {
    static void dummy_smi_done_handler(struct ipmi_smi_msg *msg)
    {
    atomic_dec(&panic_done_count);
    }
#[no_mangle]
unsafe extern "C" fn dummy_recv_done_handler(msg: *mut ipmi_recv_msg) {
...
//
    ...
    rv = i_ipmi_request(core::ptr::null_mut(),
    intf,
    addr,
    0,
    msg,
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: intf->handlers->flush_messages) -> else {
...
#[no_mangle]
unsafe extern "C" fn device_id_fetcher(intf: *mut ipmi_smi, msg: *mut ipmi_recv_msg) {
...
#[no_mangle]
unsafe extern "C" fn send_panic_events(intf: *mut ipmi_smi, str: *mut c_char) {
...
//
    ...
    j = 0;
    while (*p) {
    let mut size: c_int = strnlen(p, 11);
    data[0] = 0;
    data[1] = 0;
...
#[no_mangle]
unsafe extern "C" fn ipmi_register_driver() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmi_init_msghandler() -> c_int {
    static int ipmi_init_msghandler(void)
    {
    int rv;
    mutex_lock(&ipmi_interfaces_mutex);
...
#[no_mangle]
unsafe extern "C" fn ipmi_init_msghandler_mod() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cleanup_ipmi() -> void __exit {
