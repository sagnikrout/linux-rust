...
//! Source: drivers/char/ipmi/ipmi_ssif.c
#![no_std]
...
pub const IPMI_GET_SYSTEM_INTERFACE_CAPABILITIES_CMD: c_uint = 0x57;
...
//
pub const SSIF_DEBUG_TIMING: c_int = 4;
pub const SSIF_DEBUG_STATE: c_int = 2;
pub const SSIF_DEBUG_MSG: c_int = 1;
pub const SSIF_NODEBUG: c_int = 0;
...
// FIXME - add watchdog stuff.
    ...
    && (ssif).curr_msg == core::ptr::null_mut())
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssif_addr_info {
    pub binfo: i2c_board_info,
    pub adapter_name: *mut c_char,
    pub debug: c_int,
    pub slave_addr: c_int,
    pub addr_src: enum ipmi_addr_src,
    pub addr_info: union ipmi_smi_info_union,
    pub dev: *mut device,
    pub client: *mut i2c_client,
    pub clients_mutex: mutex,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssif_info {
    pub intf: *mut ipmi_smi,
    pub lock: spinlock_t,
    pub waiting_msg: *mut ipmi_smi_msg,
    pub curr_msg: *mut ipmi_smi_msg,
    pub ssif_state: enum ssif_intf_state,
    pub ssif_debug: c_ulong,
    pub handlers: ipmi_smi_handlers,
    pub /: *mut *mut enum ipmi_addr_src addr_source; / ACPI, PCI, SMBIOS, hardcode, etc.,
    pub addr_info: union ipmi_smi_info_union,
//
...
// Used for sending/receiving data.  +1 for the length.
    pub 1]: unsigned char data[IPMI_MAX_MSG_LENGTH +,
    pub data_len: c_uint,
// Temp receive buffer, gets copied into data.
    pub recv: [c_uchar; I2C_SMBUS_BLOCK_MAX],
    pub client: *mut i2c_client,
    pub done_handler: ssif_i2c_done,
// Thread interface handling
    pub thread: *mut task_struct,
    pub wake_thread: completion,
    pub stopping: bool,
    pub i2c_read_write: c_int,
    pub i2c_command: c_int,
    pub i2c_data: *mut c_uchar,
    pub i2c_size: c_uint,
    pub retry_timer: timer_list,
    pub retries_left: c_int,
    pub /: *mut *mut long watch_timeout; / Timeout for flags check, 0 if off.,
    pub /: *mut *mut timer_list watch_timer; / Flag fetch timer.,
// Info from SSIF cmd
    pub max_xmit_msg_size: c_uchar,
    pub max_recv_msg_size: c_uchar,
    pub /: *mut *mut bool cmd8_works; / See test_multipart_messages() for details.,
    pub multi_support: c_uint,
    pub supports_pec: c_int,
pub const SSIF_NO_MULTI: c_int = 0;
pub const SSIF_MULTI_2_PART: c_int = 1;
pub const SSIF_MULTI_n_PART: c_int = 2;
    pub multi_data: *mut c_uchar,
    pub multi_len: c_uint,
    pub multi_pos: c_uint,
    pub stats: [core::sync::atomic::AtomicI32; SSIF_NUM_STATS],
}
...
//
#[no_mangle]
unsafe extern "C" fn start_clear_flags(ssif_info: *mut ssif_info, flags: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn start_flag_fetch(ssif_info: *mut ssif_info, flags: *mut c_ulong) {
    ...
    ssif_info.curr_msg = core::ptr::null_mut();
    ssif_info.ssif_state = SSIF_IDLE;
    ipmi_ssif_unlock_cond(ssif_info, flags);
...
#[no_mangle]
unsafe extern "C" fn start_event_fetch(ssif_info: *mut ssif_info, flags: *mut c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn handle_flags(ssif_info: *mut ssif_info, flags: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn if(EVENT_MSG_BUFFER_FULL: ssif_info->msg_flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ipmi_ssif_thread(data: *mut c_void) -> c_int {
...
// Wait for something to do
    ...
    ssif_info.done_handler(ssif_info, result, core::ptr::null_mut(), 0);
    } else {
    ...
    unsigned char *data, unsigned int len);
#[no_mangle]
unsafe extern "C" fn start_get(ssif_info: *mut ssif_info) {
...
#[no_mangle]
unsafe extern "C" fn retry_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn watch_timeout(t: *mut timer_list) {
...
// Should never happen, but just in case.
    ...
    start_event_fetch(ssif_info, flags);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ssif_info->req_flags) -> else {
...
//
    ...
    dev_dbg(&ssif_info.client.dev,
    "%s: Out of retries\n", __func__);
    msg_done_handler(ssif_info, -EIO, core::ptr::null_mut(), 0);
    return;
    }
...
// Length byte.
    ...
    ssif_info.multi_data = core::ptr::null_mut();
    }
    } else if (to_write < 32) {
    ssif_info.multi_data = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn start_resend(ssif_info: *mut ssif_info) {
    static void start_resend(struct ssif_info *ssif_info)
    {
    int command;
    ssif_info.got_alert = false;
...
#[no_mangle]
unsafe extern "C" fn start_next_msg(ssif_info: *mut ssif_info, flags: *mut c_ulong) {
    static void start_next_msg(struct ssif_info *ssif_info, unsigned long *flags)
    {
    struct ipmi_smi_msg *msg;
    unsigned long oflags;
    ...
    ssif_info.waiting_msg = core::ptr::null_mut();
    ipmi_ssif_unlock_cond(ssif_info, flags);
...
//
#[no_mangle]
unsafe extern "C" fn ssif_set_need_watch(send_info: *mut c_void, watch_mask: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: watch_mask) -> else {
    else if (watch_mask)
...
pub const MAX_SSIF_BMCS: c_int = 4;
...
//
    ...
    let mut ssif_tryacpi: static bool = true;
    module_param_named(tryacpi, ssif_tryacpi, bool, 0);
    MODULE_PARM_DESC(tryacpi, "Setting this to zero will disable the default scan of the interfaces identified via ACPI");
    let mut ssif_trydmi: static bool = true;
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR(_arg: name, _arg: S_IRUGO, _arg: ipmi_##name##_show, _arg: NULL) -> static {
    static DEVICE_ATTR(name, S_IRUGO, ipmi_##name##_show, core::ptr::null_mut())
    ...
    static DEVICE_ATTR(type, S_IRUGO, ipmi_type_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn shutdown_ssif(send_info: *mut c_void) {
    static void shutdown_ssif(void *send_info)
    {
    struct ssif_info *ssif_info = send_info;
    device_remove_group(&ssif_info.client.dev, &ipmi_ssif_dev_attr_group);
    dev_set_drvdata(&ssif_info.client.dev, core::ptr::null_mut());
// make sure the driver is not looking for flags any more.
    ...
    ssif_info.thread = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn ssif_remove(client: *mut i2c_client) {
...
//
    ...
    addr_info.client = core::ptr::null_mut();
    break;
    }
    }
    kfree(ssif_info);
...
#[no_mangle]
unsafe extern "C" fn read_response(client: *mut i2c_client, resp: *mut c_uchar) -> c_int {
    static int read_response(struct i2c_client *client, unsigned char *resp)
    {
    let mut ret: c_int = -ENODEV, retry_cnt = SSIF_RECV_RETRIES;
    while (retry_cnt > 0) {
...
// Validate that the response is correct.
    ...
    ret = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(IPMI_MAX_MSG_LENGTH: ret >) -> else {
    ret = -E2BIG;
    } else {
// resp_len = ret;
    ret = 0;
...
#[no_mangle]
unsafe extern "C" fn ssif_detect(client: *mut i2c_client, info: *mut i2c_board_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn strcmp_nospace(s1: *mut c_char, s2: *mut c_char) -> c_int {
    ...
    {
    struct ssif_addr_info *info, *found = core::ptr::null_mut();
    restart:
...
// Try to get an exact match first, then try with a NULL name
    adapter_name = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn check_acpi(ssif_info: *mut ssif_info, dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn find_slave_address(client: *mut i2c_client, slave_addr: c_int) -> c_int {
    ...
    {
    let mut retry_cnt: c_int = SSIF_SEND_RETRIES, ret;
    retry_write:
...
#[no_mangle]
unsafe extern "C" fn ssif_remove_dup(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ssif_add_infos(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssif_probe(client: *mut i2c_client) -> c_int {
    ...
    let mut len: c_int = 0;
    int               i;
    let mut slave_addr: u8 = 0;
    unsigned int      thread_num;
    struct ssif_addr_info *addr_info = core::ptr::null_mut();
...
//
    rv = ssif_detect(client, core::ptr::null_mut());
    if (rv) {
...
#[no_mangle]
unsafe extern "C" fn free_ssif_clients() {
    ...
    list_for_each_entry(info, &ssif_infos, link) {
    let mut addr: c_ushort = info.binfo.addr;
    int j;
    for (j = 0; j < i; j++) {
...
#[no_mangle]
unsafe extern "C" fn dmi_ipmi_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (rv)
    slave_addr = 0x20;
    return new_ssif_client(i2c_addr, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn ssif_platform_probe(dev: *mut platform_device) -> c_int {
    static int ssif_platform_probe(struct platform_device *dev)
    {
    return dmi_ipmi_probe(dev);
    }
#[no_mangle]
unsafe extern "C" fn ssif_platform_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn init_ipmi_ssif() -> int __init {
...
// build list for i2c from addr list
    ...
    dbg[i], slave_addrs[i],
    SI_HARDCODED, core::ptr::null_mut());
    if (rv)
...
#[no_mangle]
unsafe extern "C" fn cleanup_ipmi_ssif() -> void __exit {
