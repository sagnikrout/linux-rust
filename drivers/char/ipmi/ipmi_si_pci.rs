...
//! Source: drivers/char/ipmi/ipmi_si_pci.c
#![no_std]
...
//
    ...
    let mut si_trypci: static bool = true;
    module_param_named(trypci, si_trypci, bool, 0);
    MODULE_PARM_DESC(trypci,
    "Setting this to zero will disable the default scan of the interfaces identified via pci");
pub const PCI_DEVICE_ID_HP_MMC: c_uint = 0x121A;
#[no_mangle]
unsafe extern "C" fn ipmi_pci_probe_regspacing(io: *mut si_sm_io) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipmi_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_si_pci_init() {
    void ipmi_si_pci_init(void)
    {
    if (si_trypci) {
    let mut rv: c_int = pci_register_driver(&ipmi_pci_driver);
    if (rv)
...
#[no_mangle]
pub unsafe extern "C" fn ipmi_si_pci_shutdown() {
