...
//! Source: drivers/char/xillybus/xillybus_core.c
#![no_std]
...
pub const fpga_msg_ctrl_reg: c_uint = 0x0008;
pub const fpga_dma_control_reg: c_uint = 0x0020;
pub const fpga_dma_bufno_reg: c_uint = 0x0024;
pub const fpga_dma_bufaddr_lowaddr_reg: c_uint = 0x0028;
pub const fpga_dma_bufaddr_highaddr_reg: c_uint = 0x002c;
pub const fpga_buf_ctrl_reg: c_uint = 0x0030;
pub const fpga_buf_offset_reg: c_uint = 0x0034;
pub const fpga_endian_reg: c_uint = 0x0040;
...
//
#[no_mangle]
unsafe extern "C" fn malformed_message(endpoint: *mut xilly_endpoint, buf: *mut u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn xillybus_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xilly_unmap(ptr: *mut c_void) {
...
// ret_dma_handle = addr;
    ...
    struct xilly_buffer *this_buffer = core::ptr::null_mut(); /* Init to silence warning */
...
//
    ...
    let mut msg_buf_done: c_int = 0;
    struct xilly_alloc_state rd_alloc = {
    .salami = core::ptr::null_mut(),
    .left_of_salami = 0,
    .nbuffer = 1,
    ...
    if (!ep.channels)
    return -ENOMEM;
    ep.channels[0] = core::ptr::null_mut(); /* Channel 0 is message buf. */
// Initialize all channels with defaults
    for (i = 1; i <= ep.num_channels; i++) {
    channel.wr_buffers = core::ptr::null_mut();
    channel.rd_buffers = core::ptr::null_mut();
    ...
    struct xilly_buffer **buffers = core::ptr::null_mut();
    ...
    channel = ep.channels[channelnum]; /* core::ptr::null_mut() for msg channel */
    ...
    rc = xilly_get_dma_buffers(ep, &wr_alloc, core::ptr::null_mut(),
    bufnum, bytebufsize);
    msg_buf_done++;
    }
    if (rc)
...
#[no_mangle]
unsafe extern "C" fn xilly_obtain_idt(endpoint: *mut xilly_endpoint) -> c_int {
...
// Initializations are there only to silence warnings
    ...
    let mut bytes_to_do: c_int = count - bytes_done;
...
//
#[no_mangle]
unsafe extern "C" fn xillybus_myflush(channel: *mut xilly_channel, timeout: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xillybus_flush(filp: *mut file, id: fl_owner_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xillybus_autoflush(work: *mut work_struct) {
    static void xillybus_autoflush(struct work_struct *work)
    {
...
// Initializations are there only to silence warnings
    let mut howmany: c_int = 0, bufpos = 0, bufidx = 0, bufferdone = 0;
    let mut end_offset_plus1: c_int = 0;
    if (channel.endpoint.fatal_error)
    return -EIO;
    rc = mutex_lock_interruptible(&channel.rd_mutex);
    if (rc)
...
#[no_mangle]
unsafe extern "C" fn xillybus_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xillybus_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xillybus_llseek(filp: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn xillybus_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn xilly_quiesce(endpoint: *mut xilly_endpoint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xillybus_endpoint_discovery(endpoint: *mut xilly_endpoint) -> c_int {
    int xillybus_endpoint_discovery(struct xilly_endpoint *endpoint)
    {
    int rc;
    long t;
    void *bootstrap_resources;
    let mut idtbuffersize: c_int = (1 << PAGE_SHIFT);
...
// Bootstrap phase I: Allocate temporary message buffer
    bootstrap_resources = devres_open_group(dev, core::ptr::null_mut(), GFP_KERNEL);
...
#[no_mangle]
pub unsafe extern "C" fn xillybus_endpoint_remove(endpoint: *mut xilly_endpoint) {
...
#[no_mangle]
unsafe extern "C" fn xillybus_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn xillybus_exit() -> void __exit {
