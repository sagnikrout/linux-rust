...
//! Source: drivers/char/virtio_console.c
#![no_std]
...
pub const VIRTCONS_MAX_PORTS: c_uint = 0x8000;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ports_driver_data {
// Used for exporting per-port information to debugfs
    pub debugfs_dir: *mut dentry,
// List of all the devices we're handling
    pub portdevs: list_head,
// All the console devices handled by this driver
    pub consoles: list_head,
}
...
// sg is used if spages > 0. sg must be the last in is struct
    pub __counted_by(sgpages): scatterlist sg[],
}
...
// notification
//
    pub control_work: work_struct,
    pub config_work: work_struct,
    pub ports: list_head,
// To protect the list of ports
    pub ports_lock: spinlock_t,
// To protect the vq operations for the control channel
    pub c_ivq_lock: spinlock_t,
    pub c_ovq_lock: spinlock_t,
...
//
    pub c_ovq: *mut *mut virtqueue c_ivq,,
//
// A control packet buffer for guest->host requests, protected
// by c_ovq_lock.
//
    pub cpkt: virtio_console_control,
// Array of per-port IO virtqueues
    pub out_vqs: *mut *mut *mut virtqueue in_vqs,,
...
//
    pub pm_freezing: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct port_stats {
    pub bytes_discarded: unsigned long bytes_sent, bytes_received,,
}
...
// Pointer to the parent virtio_console device
    pub portdev: *mut ports_device,
// The current buffer from which data has to be fed to readers
    pub inbuf: *mut port_buffer,
//
// To protect the operations on the in_vq associated with this
// port.  Has to be a spinlock because it can be called from
// interrupt context (get_char()).
//
    pub inbuf_lock: spinlock_t,
// Protect the operations on the out_vq.
    pub outvq_lock: spinlock_t,
// The IO vqs for this port
    pub out_vq: *mut *mut virtqueue in_vq,,
...
#[no_mangle]
unsafe extern "C" fn is_console_port(port: *mut port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_rproc_serial(vdev: *const virtio_device) -> bool {
    static bool is_rproc_serial(const struct virtio_device *vdev)
    {
    return is_rproc_enabled && vdev.id.device == VIRTIO_ID_RPROC_SERIAL;
    }
#[no_mangle]
pub unsafe extern "C" fn use_multiport(portdev: *mut ports_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn free_buf(buf: *mut port_buffer, can_sleep: bool) {
...
#[no_mangle]
unsafe extern "C" fn reclaim_dma_bufs() {
...
//
#[no_mangle]
unsafe extern "C" fn add_inbuf(vq: *mut virtqueue, buf: *mut port_buffer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn discard_port_data(port: *mut port) {
...
#[no_mangle]
unsafe extern "C" fn port_has_data(port: *mut port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn reclaim_consumed_buffers(port: *mut port) {
...
//
    ...
    memcpy(( u8 *)out_buf, buf.buf + buf.offset,
    out_count);
    }
...
#[no_mangle]
unsafe extern "C" fn will_read_block(port: *mut port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn will_write_block(port: *mut port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wait_port_writable(port: *mut port, nonblock: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_fops_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn port_fops_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_fops_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_fops_fasync(fd: c_int, filp: *mut file, mode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn put_chars(vtermno: u32, buf: *const u8, count: usize) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn get_chars(vtermno: u32, buf: *mut u8, count: usize) -> isize {
...
// If we don't have an input queue yet, we can't get input.
    BUG_ON(!port.in_vq);
    return fill_readbuf(port, ( u8 __user *)buf, count, false);
    }
#[no_mangle]
unsafe extern "C" fn resize_console(port: *mut port) {
...
#[no_mangle]
unsafe extern "C" fn notifier_add_vio(hp: *mut hvc_struct, data: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn notifier_del_vio(hp: *mut hvc_struct, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn init_port_console(port: *mut port) -> c_int {
...
//
    ...
    port.cons.hvc = core::ptr::null_mut();
...
// Notify host of port being opened
    ...
    static DEVICE_ATTR(name, S_IRUGO, show_port_name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn port_debugfs_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_console_size(port: *mut port, rows: u16, cols: u16) {
...
#[no_mangle]
unsafe extern "C" fn fill_queue(vq: *mut virtqueue, lock: *mut spinlock_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_sigio_to_port(port: *mut port) {
...
#[no_mangle]
unsafe extern "C" fn add_port(portdev: *mut ports_device, id: u32) -> c_int {
    ...
    port.inbuf = core::ptr::null_mut();
    port.cons.hvc = core::ptr::null_mut();
    port.async_queue = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !use_multiport(port->portdev)) -> else {
//
...
#[no_mangle]
unsafe extern "C" fn remove_port(kref: *mut kref) {
    static void remove_port(struct kref *kref)
    {
    struct port *port;
...
#[no_mangle]
unsafe extern "C" fn remove_port_data(port: *mut port) {
...
//
#[no_mangle]
unsafe extern "C" fn unplug_port(port: *mut port) {
...
//
    spin_lock_irq(&port.outvq_lock);
    port.portdev = core::ptr::null_mut();
    spin_unlock_irq(&port.outvq_lock);
...
#[no_mangle]
unsafe extern "C" fn control_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn flush_bufs(vq: *mut virtqueue, can_sleep: bool) {
...
#[no_mangle]
unsafe extern "C" fn out_intr(vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn in_intr(vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn control_intr(vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn config_intr(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn update_size_from_config(portdev: *mut ports_device) {
...
#[no_mangle]
unsafe extern "C" fn config_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn init_vqs(portdev: *mut ports_device) -> c_int {
...
// Find the queues.
    err = virtio_find_vqs(portdev.vdev, nr_queues, vqs, vqs_info, core::ptr::null_mut());
    if (err)
    goto free;
    j = 0;
...
#[no_mangle]
unsafe extern "C" fn remove_vqs(portdev: *mut ports_device) {
...
#[no_mangle]
unsafe extern "C" fn virtcons_remove(vdev: *mut virtio_device) {
...
//
#[no_mangle]
unsafe extern "C" fn virtcons_probe(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtcons_freeze(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtcons_restore(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_console_init() -> int __init {
    ...
    if (err)
    return err;
    pdrvdata.debugfs_dir = debugfs_create_dir("virtio-ports", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn virtio_console_fini() -> void __exit {
