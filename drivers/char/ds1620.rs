...
// Macro flag: #define THERM_USE_PROC

// Definitions for DS1620 chip
pub const THERM_START_CONVERT: c_uint = 0xee;
pub const THERM_RESET: c_uint = 0xaf;
pub const THERM_READ_CONFIG: c_uint = 0xac;
pub const THERM_READ_TEMP: c_uint = 0xaa;
pub const THERM_READ_TL: c_uint = 0xa2;
pub const THERM_READ_TH: c_uint = 0xa1;
pub const THERM_WRITE_CONFIG: c_uint = 0x0c;
pub const THERM_WRITE_TL: c_uint = 0x02;
pub const THERM_WRITE_TH: c_uint = 0x01;
pub const CFG_CPU: c_int = 2;
pub const CFG_1SHOT: c_int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn netwinder_ds1620_set_clk(clk: c_int) {
    static inline void netwinder_ds1620_set_clk(int clk)
    {
    nw_gpio_modify_op(GPIO_DSCLK, clk ? GPIO_DSCLK : 0);
    }
#[no_mangle]
pub unsafe extern "C" fn netwinder_ds1620_set_data(dat: c_int) {
    static inline void netwinder_ds1620_set_data(int dat)
    {
    nw_gpio_modify_op(GPIO_DATA, dat ? GPIO_DATA : 0);
    }
#[no_mangle]
pub unsafe extern "C" fn netwinder_ds1620_get_data() -> c_int {
    static inline int netwinder_ds1620_get_data(void)
    {
    return nw_gpio_read() & GPIO_DATA;
    }
#[no_mangle]
pub unsafe extern "C" fn netwinder_ds1620_set_data_dir(dir: c_int) {
    static inline void netwinder_ds1620_set_data_dir(int dir)
    {
    nw_gpio_modify_io(GPIO_DATA, dir ? GPIO_DATA : 0);
    }
#[no_mangle]
pub unsafe extern "C" fn netwinder_ds1620_reset() {
...
#[no_mangle]
pub unsafe extern "C" fn netwinder_lock(flags: *mut c_ulong) {
    static inline void netwinder_lock(unsigned long *flags)
    {
    raw_spin_lock_irqsave(&nw_gpio_lock, *flags);
    }
#[no_mangle]
pub unsafe extern "C" fn netwinder_unlock(flags: *mut c_ulong) {
    static inline void netwinder_unlock(unsigned long *flags)
    {
    raw_spin_unlock_irqrestore(&nw_gpio_lock, *flags);
    }
#[no_mangle]
pub unsafe extern "C" fn netwinder_set_fan(i: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn netwinder_get_fan() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ds1620_send_bits(nr: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ds1620_recv_bits(nr: c_int) -> c_uint {
    static unsigned int ds1620_recv_bits(int nr)
    {
    let mut value: c_uint = 0, mask = 1;
    int i;
...
#[no_mangle]
unsafe extern "C" fn ds1620_out(cmd: c_int, bits: c_int, value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ds1620_in(cmd: c_int, bits: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cvt_9_to_int(val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1620_write_state(therm: *mut therm) {
...
#[no_mangle]
unsafe extern "C" fn ds1620_read_state(therm: *mut therm) {
...
#[no_mangle]
unsafe extern "C" fn ds1620_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1620_proc_therm_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds1620_init() -> int __init {
...
//
    ...
    if (!proc_create_single("therm", 0, core::ptr::null_mut(), ds1620_proc_therm_show))
...
#[no_mangle]
unsafe extern "C" fn ds1620_exit() -> void __exit {
    static void __exit ds1620_exit(void)
    {

    remove_proc_entry("therm", core::ptr::null_mut());
