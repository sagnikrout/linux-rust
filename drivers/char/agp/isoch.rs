...
//! Source: drivers/char/agp/isoch.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn agp_3_5_dev_list_insert(head: *mut list_head, new: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn agp_3_5_dev_list_sort(list: *mut agp_3_5_dev, ndevs: c_uint) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct isoch_data {
    pub maxbw: u32,
    pub n: u32,
    pub y: u32,
    pub l: u32,
    pub rq: u32,
    pub dev: *mut agp_3_5_dev,
}
    ...
    let mut cdev: c_uint = 0;
    u32 mnistat, tnistat, tstatus, mcmd;
    u16 tnicmd, mnicmd;
    let mut tot_bw: u32 = 0, tot_n = 0, tot_rq = 0, y_max, rq_isoch, rq_async;
...
//
#[no_mangle]
pub unsafe extern "C" fn agp_3_5_enable(bridge: *mut agp_bridge_data) -> c_int {
    int agp_3_5_enable(struct agp_bridge_data *bridge)
    {
    struct pci_dev *td = bridge.dev, *dev = core::ptr::null_mut();
    u8 mcapndx;
    u32 isoch;
...
//
    if ((dev_list = kmalloc_obj(*dev_list)) == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto get_out;
    }
    head = &dev_list.list;
...
// Don't know what this is, but log it for investigation.
    ...
    if ((cur = kmalloc_obj(*cur)) == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto free_and_exit;
    }
    cur.dev = dev;
