...
//! Source: drivers/char/agp/ali-agp.c
#![no_std]
...
pub const ALI_AGPCTRL: c_uint = 0xb8;
pub const ALI_ATTBASE: c_uint = 0xbc;
pub const ALI_TLBCTRL: c_uint = 0xc0;
pub const ALI_TAGCTRL: c_uint = 0xc4;
pub const ALI_CACHE_FLUSH_CTRL: c_uint = 0xD0;
pub const ALI_CACHE_FLUSH_ADDR_MASK: c_uint = 0xFFFFF000;
pub const ALI_CACHE_FLUSH_EN: c_uint = 0x100;
#[no_mangle]
unsafe extern "C" fn ali_fetch_size() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali_tlbflush(mem: *mut agp_memory) {
...
#[no_mangle]
unsafe extern "C" fn ali_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn ali_configure() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m1541_cache_flush() {
...
#[no_mangle]
unsafe extern "C" fn ali_destroy_page(page: *mut page, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn m1541_destroy_page(page: *mut page, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn agp_ali_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn agp_ali_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn agp_ali_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn agp_ali_cleanup() -> void __exit {
