...
//! Source: drivers/char/agp/sworks-agp.c
#![no_std]
...
pub const SVWRKS_COMMAND: c_uint = 0x04;
pub const SVWRKS_APSIZE: c_uint = 0x10;
pub const SVWRKS_MMBASE: c_uint = 0x14;
pub const SVWRKS_CACHING: c_uint = 0x4b;
pub const SVWRKS_AGP_ENABLE: c_uint = 0x60;
pub const SVWRKS_FEATURE: c_uint = 0x68;
pub const SVWRKS_SIZE_MASK: c_uint = 0xfe000000;
// Memory mapped registers
pub const SVWRKS_GART_CACHE: c_uint = 0x02;
pub const SVWRKS_GATTBASE: c_uint = 0x04;
pub const SVWRKS_TLBFLUSH: c_uint = 0x10;
pub const SVWRKS_POSTFLUSH: c_uint = 0x14;
pub const SVWRKS_DIRFLUSH: c_uint = 0x0c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct serverworks_page_map {
...
#[no_mangle]
unsafe extern "C" fn serverworks_create_page_map(page_map: *mut serverworks_page_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serverworks_free_page_map(page_map: *mut serverworks_page_map) {
...
#[no_mangle]
unsafe extern "C" fn serverworks_free_gatt_pages() {
...
#[no_mangle]
unsafe extern "C" fn serverworks_create_gatt_pages(nr_tables: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serverworks_create_gatt_table(bridge: *mut agp_bridge_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serverworks_free_gatt_table(bridge: *mut agp_bridge_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn serverworks_fetch_size() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn serverworks_tlbflush(temp: *mut agp_memory) {
...
#[no_mangle]
unsafe extern "C" fn serverworks_configure() -> c_int {
...
// Get the memory mapped registers
    ...
    serverworks_tlbflush(core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn serverworks_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn serverworks_agp_enable(bridge: *mut agp_bridge_data, mode: u32) {
...
#[no_mangle]
unsafe extern "C" fn agp_serverworks_remove(pdev: *mut pci_dev) {
    ...
    serverworks_private.svrwrks_dev = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn agp_serverworks_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn agp_serverworks_cleanup() -> void __exit {
