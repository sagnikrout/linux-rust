...
//! Source: drivers/char/agp/amd-k7-agp.c
#![no_std]
...
pub const AMD_MMBASE_BAR: c_int = 1;
pub const AMD_APSIZE: c_uint = 0xac;
pub const AMD_MODECNTL: c_uint = 0xb0;
pub const AMD_MODECNTL2: c_uint = 0xb2;
pub const AMD_GARTENABLE: c_uint = 0x02	/* In mmio region (16-bit register) */;
pub const AMD_ATTBASE: c_uint = 0x04	/* In mmio region (32-bit register) */;
pub const AMD_TLBFLUSH: c_uint = 0x0c	/* In mmio region (32-bit register) */;
pub const AMD_CACHEENTRY: c_uint = 0x10	/* In mmio region (32-bit register) */;
    static const struct pci_device_id agp_amdk7_pci_table[];
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_page_map {
    pub real: *mut c_ulong,
    pub remapped: *mut unsigned long __iomem,
}
...
#[no_mangle]
unsafe extern "C" fn amd_create_page_map(page_map: *mut amd_page_map) -> c_int {
    static int amd_create_page_map(struct amd_page_map *page_map)
    {
    int i;
    page_map.real = (unsigned long *) __get_free_page(GFP_KERNEL);
    if (page_map.real == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn amd_free_page_map(page_map: *mut amd_page_map) {
...
#[no_mangle]
unsafe extern "C" fn amd_free_gatt_pages() {
    ...
    if (entry.real != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn amd_create_gatt_pages(nr_tables: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_create_gatt_table(bridge: *mut agp_bridge_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_free_gatt_table(bridge: *mut agp_bridge_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_irongate_fetch_size() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_irongate_configure() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_irongate_cleanup() {
...
//
#[no_mangle]
unsafe extern "C" fn amd_irongate_tlbflush(temp: *mut agp_memory) {
...
#[no_mangle]
unsafe extern "C" fn amd_insert_memory(mem: *mut agp_memory, pg_start: off_t, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_remove_memory(mem: *mut agp_memory, pg_start: off_t, type: c_int) -> c_int {
...
//
    ...
    struct pci_dev *gfxcard=core::ptr::null_mut();
    cap_ptr = 0;
    while (!cap_ptr) {
...
#[no_mangle]
unsafe extern "C" fn agp_amdk7_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn agp_amdk7_resume(dev: *mut device) -> c_int {
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(agp_amdk7_pm_ops, core::ptr::null_mut(), agp_amdk7_resume);
...
#[no_mangle]
unsafe extern "C" fn agp_amdk7_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn agp_amdk7_cleanup() -> void __exit {
