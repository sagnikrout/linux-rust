...
//! Source: drivers/char/agp/ati-agp.c
#![no_std]
...
pub const ATI_GART_MMBASE_BAR: c_int = 1;
pub const ATI_RS100_APSIZE: c_uint = 0xac;
pub const ATI_RS100_IG_AGPMODE: c_uint = 0xb0;
pub const ATI_RS300_APSIZE: c_uint = 0xf8;
pub const ATI_RS300_IG_AGPMODE: c_uint = 0xfc;
pub const ATI_GART_FEATURE_ID: c_uint = 0x00;
pub const ATI_GART_BASE: c_uint = 0x04;
pub const ATI_GART_CACHE_SZBASE: c_uint = 0x08;
pub const ATI_GART_CACHE_CNTRL: c_uint = 0x0c;
pub const ATI_GART_CACHE_ENTRY_CNTRL: c_uint = 0x10;
...
#[no_mangle]
unsafe extern "C" fn ati_create_page_map(page_map: *mut ati_page_map) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_free_page_map(page_map: *mut ati_page_map) {
...
#[no_mangle]
unsafe extern "C" fn ati_free_gatt_pages() {
...
#[no_mangle]
unsafe extern "C" fn ati_create_gatt_pages(nr_tables: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_r200() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_fetch_size() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_tlbflush(mem: *mut *mut agp_memory) {
...
#[no_mangle]
unsafe extern "C" fn ati_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn ati_configure() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn agp_ati_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_create_gatt_table(bridge: *mut agp_bridge_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ati_free_gatt_table(bridge: *mut agp_bridge_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn agp_ati_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn agp_ati_remove(pdev: *mut pci_dev) {
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(agp_ati_pm_ops, core::ptr::null_mut(), agp_ati_resume);
...
#[no_mangle]
unsafe extern "C" fn agp_ati_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn agp_ati_cleanup() -> void __exit {
