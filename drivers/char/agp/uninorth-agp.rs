...
//! Source: drivers/char/agp/uninorth-agp.c
#![no_std]
...
pub const DEFAULT_APERTURE_SIZE: c_int = 256;

    static char *aperture = core::ptr::null_mut();
#[no_mangle]
unsafe extern "C" fn uninorth_fetch_size() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uninorth_tlbflush(mem: *mut agp_memory) {
    static void uninorth_tlbflush(struct agp_memory *mem)
    {
    let mut ctrl: u32 = UNI_N_CFG_GART_ENABLE;
    if (is_u3)
...
#[no_mangle]
unsafe extern "C" fn uninorth_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn uninorth_configure() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uninorth_insert_memory(mem: *mut agp_memory, pg_start: off_t, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uninorth_remove_memory(mem: *mut agp_memory, pg_start: off_t, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uninorth_agp_enable(bridge: *mut agp_bridge_data, mode: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn agp_uninorth_suspend(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn agp_uninorth_resume(pdev: *mut pci_dev) -> c_int {
    ...
    bridge.dev_private_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn uninorth_create_gatt_table(bridge: *mut agp_bridge_data) -> c_int {
...
// We can't handle 2 level gatt's
    ...
    if (uninorth_priv.pages_arr == core::ptr::null_mut())
    goto enomem;
...
#[no_mangle]
unsafe extern "C" fn uninorth_free_gatt_table(bridge: *mut agp_bridge_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn null_cache_flush() {
...
// probe for known chipsets
    for (j = 0; devs[j].chipset_name != core::ptr::null_mut(); ++j) {
...
// Locate G5 u3
    ...
    "device-rev", core::ptr::null_mut());
    if (revprop != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn agp_uninorth_remove(pdev: *mut pci_dev) {
    static void agp_uninorth_remove(struct pci_dev *pdev)
    {
    struct agp_bridge_data *bridge = pci_get_drvdata(pdev);

// Inform platform of our suspend/resume caps
    pmac_register_agp_pm(pdev, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn agp_uninorth_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn agp_uninorth_cleanup() -> void __exit {
