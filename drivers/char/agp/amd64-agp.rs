...
//! Source: drivers/char/agp/amd64-agp.c
#![no_std]
...
// NVIDIA K8 registers
pub const NVIDIA_X86_64_0_APBASE: c_uint = 0x10;
pub const NVIDIA_X86_64_1_APBASE1: c_uint = 0x50;
pub const NVIDIA_X86_64_1_APLIMIT1: c_uint = 0x54;
pub const NVIDIA_X86_64_1_APSIZE: c_uint = 0xa8;
pub const NVIDIA_X86_64_1_APBASE2: c_uint = 0xd8;
pub const NVIDIA_X86_64_1_APLIMIT2: c_uint = 0xdc;
// ULi K8 registers
pub const ULI_X86_64_BASE_ADDR: c_uint = 0x10;
pub const ULI_X86_64_HTT_FEA_REG: c_uint = 0x50;
pub const ULI_X86_64_ENU_SCR_REG: c_uint = 0x54;
    static struct resource *aperture_resource;
    let mut agp_try_unsupported: static bool __initdata = 1;
    static int agp_bridges_found;
#[no_mangle]
unsafe extern "C" fn amd64_tlbflush(temp: *mut agp_memory) {
    static void amd64_tlbflush(struct agp_memory *temp)
    {
    amd_flush_garts();
    }
#[no_mangle]
unsafe extern "C" fn amd64_insert_memory(mem: *mut agp_memory, pg_start: off_t, type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd64_fetch_size() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd64_configure(hammer: *mut pci_dev, gatt_table: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn amd_8151_configure() -> c_int {
    static int amd_8151_configure(void)
    {
    let mut gatt_bus: c_ulong = virt_to_phys(agp_bridge.gatt_table_real);
    int i;
...
#[no_mangle]
unsafe extern "C" fn amd64_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn agp_aperture_valid(aper: u64, size: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fix_northbridge(nb: *mut pci_dev, agp: *mut pci_dev, cap: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cache_nbs(pdev: *mut pci_dev, cap_ptr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd8151_init(pdev: *mut pci_dev, bridge: *mut agp_bridge_data) {
...
#[no_mangle]
unsafe extern "C" fn uli_agp_init(pdev: *mut pci_dev) -> c_int {
    static int uli_agp_init(struct pci_dev *pdev)
    {
    u32 httfea,baseaddr,enuscr;
    struct pci_dev *dev1;
    int i, ret;
    let mut size: unsigned = amd64_fetch_size();
    dev_info(&pdev.dev, "setting up ULi AGP\n");
    dev1 = pci_get_slot (pdev.bus,PCI_DEVFN(0,0));
    if (dev1 == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn nforce3_agp_init(pdev: *mut pci_dev) -> c_int {
...
// Fill in the mode register
    ...
    let mut ret: c_int = nforce3_agp_init(pdev);
    if (ret) {
    agp_put_bridge(bridge);
    return ret;
    }
    ...
    let mut ret: c_int = uli_agp_init(pdev);
    if (ret) {
    agp_put_bridge(bridge);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn agp_amd64_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn agp_amd64_resume(dev: *mut device) -> c_int {
...
// ALI/ULI M1695
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(agp_amd64_pm_ops, core::ptr::null_mut(), agp_amd64_resume);
...
#[no_mangle]
pub unsafe extern "C" fn agp_amd64_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn agp_amd64_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn agp_amd64_cleanup() -> void __exit {
