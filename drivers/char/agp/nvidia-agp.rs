...
//! Source: drivers/char/agp/nvidia-agp.c
#![no_std]
...
// NVIDIA registers
pub const NVIDIA_0_APSIZE: c_uint = 0x80;
pub const NVIDIA_1_WBC: c_uint = 0xf0;
pub const NVIDIA_2_GARTCTRL: c_uint = 0xd0;
pub const NVIDIA_2_APBASE: c_uint = 0xd8;
pub const NVIDIA_2_APLIMIT: c_uint = 0xdc;

pub const NVIDIA_3_APBASE: c_uint = 0x50;
pub const NVIDIA_3_APLIMIT: c_uint = 0x54;
...
#[no_mangle]
unsafe extern "C" fn nvidia_fetch_size() -> c_int {
...
pub const SYSCFG: c_uint = 0xC0010010;
pub const IORR_BASE0: c_uint = 0xC0010016;
pub const IORR_MASK0: c_uint = 0xC0010017;
pub const AMD_K7_NUM_IORR: c_int = 2;
#[no_mangle]
unsafe extern "C" fn nvidia_init_iorr(base: u32, size: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvidia_configure() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvidia_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn nvidia_insert_memory(mem: *mut agp_memory, pg_start: off_t, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvidia_remove_memory(mem: *mut agp_memory, pg_start: off_t, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvidia_tlbflush(mem: *mut agp_memory) {
...
#[no_mangle]
unsafe extern "C" fn agp_nvidia_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn agp_nvidia_resume(dev: *mut device) -> c_int {
...
// reconfigure AGP hardware again
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(agp_nvidia_pm_ops, core::ptr::null_mut(), agp_nvidia_resume);
...
#[no_mangle]
unsafe extern "C" fn agp_nvidia_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn agp_nvidia_cleanup() -> void __exit {
