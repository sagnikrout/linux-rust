...
//! Source: drivers/char/apm-emulation.c
#![no_std]
...
//
pub const APM_MAX_EVENTS: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apm_queue {
    pub event_head: c_uint,
    pub event_tail: c_uint,
...
pub struct apm_user {
    ...
    pub suspend_state: enum apm_suspend_state,
    pub queue: apm_queue,
}
...
// Local variables
//
    let mut suspend_acks_pending: static atomic_t = ATOMIC_INIT(0);
    let mut userspace_notification_inhibit: static atomic_t = ATOMIC_INIT(0);
...
//
#[no_mangle]
pub unsafe extern "C" fn queue_empty(q: *mut apm_queue) -> c_int {
    static inline int queue_empty(struct apm_queue *q)
    {
    return q.event_head == q.event_tail;
    }
#[no_mangle]
pub unsafe extern "C" fn queue_get_event(q: *mut apm_queue) -> apm_event_t {
...
#[no_mangle]
unsafe extern "C" fn queue_add_event(q: *mut apm_queue, event: apm_event_t) {
...
#[no_mangle]
unsafe extern "C" fn queue_event(event: apm_event_t) {
...
#[no_mangle]
unsafe extern "C" fn apm_read(fp: *mut file, buf: *mut char __user, count: usize, ppos: *mut loff_t) -> isize {
    static ssize_t apm_read(struct file *fp, char __user *buf, size_t count, loff_t *ppos)
    {
    struct apm_user *as = fp.private_data;
    apm_event_t event;
    let mut i: c_int = count, ret = 0;
...
#[no_mangle]
unsafe extern "C" fn apm_poll(fp: *mut file, wait: *mut *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn apm_release(inode: *mut *mut inode, filp: *mut *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apm_open(inode: *mut *mut inode, filp: *mut *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kapmd(arg: *mut c_void) -> c_int {
...
unsafe extern "C" fn apm_init() -> int __init {
    ...
    kapmd_tsk = kthread_create(kapmd, core::ptr::null_mut(), "kapmd");
    if (IS_ERR(kapmd_tsk)) {
    ret = PTR_ERR(kapmd_tsk);
    kapmd_tsk = core::ptr::null_mut();
    goto out;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn apm_queue_event(event: apm_event_t) {
