...
//! Source: drivers/char/tpm/tpm_i2c_infineon.c
#![no_std]
...
pub const TPM_I2C_INFINEON_BUFSIZE: c_int = 1260;
// max. number of iterations after I2C NAK
pub const MAX_COUNT: c_int = 3;
pub const SLEEP_DURATION_LOW: c_int = 55;
pub const SLEEP_DURATION_HI: c_int = 65;
// max. number of iterations after I2C NAK for 'long' commands
// we need this especially for sending TPM_READY, since the cleanup after the
// transtion to the ready state may take some time, but it is unpredictable
// how long it will take.
//
pub const MAX_COUNT_LONG: c_int = 50;
pub const SLEEP_DURATION_LONG_LOW: c_int = 200;
pub const SLEEP_DURATION_LONG_HI: c_int = 220;
// After sending TPM_READY to 'reset' the TPM we have to sleep even longer
pub const SLEEP_DURATION_RESET_LOW: c_int = 2400;
pub const SLEEP_DURATION_RESET_HI: c_int = 2600;
// we want to use usleep_range instead of msleep for the 5ms TPM_TIMEOUT

// expected value for DIDVID register
pub const TPM_TIS_I2C_DID_VID_9635: c_uint = 0xd1150b00L;
pub const TPM_TIS_I2C_DID_VID_9645: c_uint = 0x001a15d1L;
    enum i2c_chip_type {
    SLB9635,
    SLB9645,
    UNKNOWN,
...
//
    pub 1]: u8 buf[TPM_I2C_INFINEON_BUFSIZE +,
    pub chip: *mut tpm_chip,
    pub chip_type: enum i2c_chip_type,
    pub adapterlimit: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn iic_tpm_read(addr: u8, buffer: *mut u8, len: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iic_tpm_write(addr: u8, buffer: *mut u8, len: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iic_tpm_write_long(addr: u8, buffer: *mut u8, len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_locality(chip: *mut tpm_chip, loc: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn release_locality(chip: *mut tpm_chip, loc: c_int, force: c_int) {
...
#[no_mangle]
unsafe extern "C" fn request_locality(chip: *mut tpm_chip, loc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_status(chip: *mut tpm_chip) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_ready(chip: *mut tpm_chip) {
    static void tpm_tis_i2c_ready(struct tpm_chip *chip)
    {
// this causes the current command to be aborted
    let mut buf: u8 = TPM_STS_COMMAND_READY;
    iic_tpm_write_long(TPM_STS(tpm_dev.locality), &buf, 1);
    }
#[no_mangle]
unsafe extern "C" fn get_burstcount(chip: *mut tpm_chip) -> isize {
...
#[no_mangle]
unsafe extern "C" fn recv_data(chip: *mut tpm_chip, buf: *mut u8, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_recv(chip: *mut tpm_chip, buf: *mut u8, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_req_canceled(chip: *mut tpm_chip, status: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_init(dev: *mut device) -> c_int {
...
// read four bytes from DID_VID register
    ...
    tpm_dev.client = core::ptr::null_mut();
    out_err:
    return rc;
    }
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_probe(client: *mut i2c_client) -> c_int {
    static int tpm_tis_i2c_probe(struct i2c_client *client)
    {
    int rc;
    struct device *dev = &(client.dev);
    if (tpm_dev.client != core::ptr::null_mut()) {
