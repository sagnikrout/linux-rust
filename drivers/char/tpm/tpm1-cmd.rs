...
//! Source: drivers/char/tpm/tpm1-cmd.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm1_calc_ordinal_duration(chip: *mut tpm_chip, ordinal: u32) -> c_ulong {
    unsigned long tpm1_calc_ordinal_duration(struct tpm_chip *chip, u32 ordinal)
    {
    let mut duration_idx: c_int = TPM_UNDEFINED;
...
//
#[no_mangle]
unsafe extern "C" fn tpm1_startup(chip: *mut tpm_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tpm1_get_timeouts(chip: *mut tpm_chip) -> c_int {
    ...
    ssize_t rc;
    rc = tpm1_getcap(chip, TPM_CAP_PROP_TIS_TIMEOUT, &cap, core::ptr::null_mut(),
    sizeof(cap.timeout));
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm1_get_random(chip: *mut tpm_chip, dest: *mut u8, max: usize) -> c_int {
    int tpm1_get_random(struct tpm_chip *chip, u8 *dest, size_t max)
    {
    struct tpm1_get_random_out *out;
    struct tpm_buf *buf __free(kfree) = core::ptr::null_mut();
    let mut num_bytes: u32 = min_t(u32, max, TPM_MAX_RNG_DATA);
    let mut total: u32 = 0;
...
#[no_mangle]
pub unsafe extern "C" fn tpm1_pcr_read(chip: *mut tpm_chip, pcr_idx: u32, res_buf: *mut u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tpm1_continue_selftest(chip: *mut tpm_chip) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm1_do_selftest(chip: *mut tpm_chip) -> c_int {
    int tpm1_do_selftest(struct tpm_chip *chip)
    {
    int rc;
    unsigned int loops;
    let mut delay_msec: c_uint = 100;
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm1_auto_startup(chip: *mut tpm_chip) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm1_pm_suspend(chip: *mut tpm_chip, tpm_suspend_pcr: u32) -> c_int {
...
//
    ...
    rc);
#[no_mangle]
pub unsafe extern "C" fn if(0: try >) -> else {
    else if (try > 0)
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm1_get_pcr_allocation(chip: *mut tpm_chip) -> c_int {
