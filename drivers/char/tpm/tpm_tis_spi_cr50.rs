...
//! Source: drivers/char/tpm/tpm_tis_spi_cr50.c
#![no_std]
...
//
pub const CR50_SLEEP_DELAY_MSEC: c_int = 1000;
pub const CR50_WAKE_START_DELAY_USEC: c_int = 1000;

pub const MAX_IRQ_CONFIRMATION_ATTEMPTS: c_int = 3;

pub const TPM_CR50_MAX_FW_VER_LEN: c_int = 64;
// Default quality for hwrng.
pub const TPM_CR50_DEFAULT_RNG_QUALITY: c_int = 700;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cr50_spi_phy {
    pub spi_phy: tpm_tis_spi_phy,
    pub time_track_mutex: mutex,
    pub last_access: c_ulong,
    pub access_delay: c_ulong,
    pub irq_confirmation_attempt: c_uint,
    pub irq_needs_confirmation: bool,
...
//
#[no_mangle]
unsafe extern "C" fn cr50_spi_irq_handler(dummy: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn cr50_ensure_access_delay(phy: *mut cr50_spi_phy) {
    static void cr50_ensure_access_delay(struct cr50_spi_phy *phy)
    {
    let mut allowed_access: c_ulong = phy.last_access + phy.access_delay;
    let mut time_now: c_ulong = jiffies;
...
//
    ...
    let mut attempt: c_uint = ++phy.irq_confirmation_attempt;
...
//
#[no_mangle]
unsafe extern "C" fn cr50_needs_waking(phy: *mut cr50_spi_phy) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cr50_wake_if_needed(cr50_phy: *mut cr50_spi_phy) {
...
//
    ...
    let mut timeout: c_ulong = jiffies + CR50_FLOW_CONTROL;
...
#[no_mangle]
unsafe extern "C" fn tpm_cr50_spi_is_firmware_power_managed(dev: *mut device) -> bool {
...
//
    ...
    {
    return tpm_tis_spi_cr50_transfer(data, addr, len, result, core::ptr::null_mut());
    }
    static int tpm_tis_spi_cr50_write_bytes(struct tpm_tis_data *data, u32 addr,
    u16 len, const u8 *value, enum tpm_tis_io_mode io_mode)
    {
    return tpm_tis_spi_cr50_transfer(data, addr, len, core::ptr::null_mut(), value);
    }
...
#[no_mangle]
unsafe extern "C" fn cr50_print_fw_version(data: *mut tpm_tis_data) {
...
#[no_mangle]
pub unsafe extern "C" fn cr50_spi_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tpm_tis_spi_resume(dev: *mut device) -> c_int {
