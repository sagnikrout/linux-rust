...
//! Source: drivers/char/tpm/tpm_tis_i2c.c
#![no_std]
...
// TPM registers
pub const TPM_I2C_LOC_SEL: c_uint = 0x00;
pub const TPM_I2C_ACCESS: c_uint = 0x04;
pub const TPM_I2C_INTERFACE_CAPABILITY: c_uint = 0x30;
pub const TPM_I2C_DEVICE_ADDRESS: c_uint = 0x38;
pub const TPM_I2C_DATA_CSUM_ENABLE: c_uint = 0x40;
pub const TPM_DATA_CSUM: c_uint = 0x44;
pub const TPM_I2C_DID_VID: c_uint = 0x48;
pub const TPM_I2C_RID: c_uint = 0x4C;
// TIS-compatible register address to avoid clash with TPM_ACCESS (0x00)
pub const TPM_LOC_SEL: c_uint = 0x0FFF;
// Mask to extract the I2C register from TIS register addresses
pub const TPM_TIS_REGISTER_MASK: c_uint = 0x0FFF;
// Default Guard Time of 250µs until interface capability register is read
pub const GUARD_TIME_DEFAULT_MIN: c_int = 250;
pub const GUARD_TIME_DEFAULT_MAX: c_int = 300;
// Guard Time of 250µs after I2C slave NACK
pub const GUARD_TIME_ERR_MIN: c_int = 250;
pub const GUARD_TIME_ERR_MAX: c_int = 300;
// Guard Time bit masks; SR is repeated start, RW is read then write, etc.
pub const TPM_GUARD_TIME_SR_MASK: c_uint = 0x40000000;
pub const TPM_GUARD_TIME_RR_MASK: c_uint = 0x00100000;
pub const TPM_GUARD_TIME_RW_MASK: c_uint = 0x00080000;
pub const TPM_GUARD_TIME_WR_MASK: c_uint = 0x00040000;
pub const TPM_GUARD_TIME_WW_MASK: c_uint = 0x00020000;
pub const TPM_GUARD_TIME_MIN_MASK: c_uint = 0x0001FE00;
pub const TPM_GUARD_TIME_MIN_SHIFT: c_int = 9;
// Masks with bits that must be read zero
pub const TPM_ACCESS_READ_ZERO: c_uint = 0x48;
pub const TPM_INT_ENABLE_ZERO: c_uint = 0x7FFFFF60;
pub const TPM_STS_READ_ZERO: c_uint = 0x23;
pub const TPM_INTF_CAPABILITY_ZERO: c_uint = 0x0FFFF000;
pub const TPM_I2C_INTERFACE_CAPABILITY_ZERO: c_uint = 0x80000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpm_tis_i2c_phy {
    pub priv: tpm_tis_data,
    pub i2c_client: *mut i2c_client,
    pub guard_time_read: bool,
    pub guard_time_write: bool,
    pub guard_time_min: u16,
    pub guard_time_max: u16,
    pub io_buf: *mut u8,
}
...
//
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_address_to_register(addr: u32) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: guard_time) -> else {
    else if (guard_time)
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_sanity_check_read(reg: u8, len: u16, buf: *mut u8) -> c_int {
...
// unknown register, skip check
    ...
    {
    struct tpm_tis_i2c_phy *phy = to_tpm_tis_i2c_phy(data);
    let mut msg: i2c_msg = { .addr = phy.i2c_client.addr };
    let mut reg: u8 = tpm_tis_i2c_address_to_register(addr);
    int i;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_init_guard_time(phy: *mut tpm_tis_i2c_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_probe(dev: *mut i2c_client) -> c_int {
    static int tpm_tis_i2c_probe(struct i2c_client *dev)
    {
    struct tpm_tis_i2c_phy *phy;
    let mut crc_enable: u8 = 1;
    let mut locality: u8 = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tpm_tis_i2c_remove(client: *mut i2c_client) {
