...
//! Source: drivers/char/tpm/tpm2-cmd.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tpm2_find_hash_alg(crypto_id: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tpm2_get_timeouts(chip: *mut tpm_chip) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm2_calc_ordinal_duration(ordinal: u32) -> c_ulong {
...
//
    ...
    if (!disable_pcr_integrity) {
    rc = tpm_buf_append_name(chip, buf, pcr_idx, core::ptr::null_mut());
    if (rc) {
    tpm2_end_auth_session(chip);
    return rc;
    }
    tpm_buf_append_hmac_session(chip, buf, 0, core::ptr::null_mut(), 0);
    } else {
    tpm_buf_append_handle(buf, pcr_idx);
    tpm_buf_append_auth(chip, buf, core::ptr::null_mut(), 0);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm2_get_random(chip: *mut tpm_chip, dest: *mut u8, max: usize) -> c_int {
    int tpm2_get_random(struct tpm_chip *chip, u8 *dest, size_t max)
    {
    struct tpm2_get_random_out *out;
    struct tpm_header *head;
    u32 recd;
    let mut num_bytes: u32 = max;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm2_flush_context(chip: *mut tpm_chip, handle: u32) {
...
//
    ...
    tpm_buf_append_u32(buf, 1);
    rc = tpm_transmit_cmd(chip, buf, 0, core::ptr::null_mut());
    if (!rc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm2_shutdown(chip: *mut tpm_chip, shutdown_type: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn tpm2_do_selftest(chip: *mut tpm_chip) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm2_probe(chip: *mut tpm_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpm2_init_bank_info(chip: *mut tpm_chip, bank_index: u32) -> c_int {
    ...
    let mut digest: tpm_digest = { .alg_id = bank.alg_id };
    int i;
//
...
//
    for (i = 0; i < ARRAY_SIZE(tpm2_hash_map); i++) {
    let mut crypto_algo: enum hash_algo = tpm2_hash_map[i].crypto_id;
...
#[no_mangle]
pub unsafe extern "C" fn tpm2_get_pcr_allocation(chip: *mut tpm_chip) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn tpm2_get_cc_attrs_tbl(chip: *mut tpm_chip) -> c_int {
    ...
    int rc;
    struct tpm_buf *buf __free(kfree) = core::ptr::null_mut();
    rc = tpm2_get_tpm_pt(chip, TPM_PT_TOTAL_COMMANDS, &nr_commands, core::ptr::null_mut());
    if (rc)
    goto out;
    ...
    rc = tpm_transmit_cmd(chip, buf, 9 + 4 * nr_commands, core::ptr::null_mut());
    if (rc)
    goto out;
    if (nr_commands !=
...
//
#[no_mangle]
unsafe extern "C" fn tpm2_startup(chip: *mut tpm_chip) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm2_auto_startup(chip: *mut tpm_chip) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tpm2_find_cc(chip: *mut tpm_chip, cc: u32) -> c_int {
