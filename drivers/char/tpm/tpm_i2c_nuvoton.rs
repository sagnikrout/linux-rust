...
//! Source: drivers/char/tpm/tpm_i2c_nuvoton.c
#![no_std]
...
pub const TPM_STS: c_uint = 0x00;
pub const TPM_BURST_COUNT: c_uint = 0x01;
pub const TPM_DATA_FIFO_W: c_uint = 0x20;
pub const TPM_DATA_FIFO_R: c_uint = 0x40;
pub const TPM_VID_DID_RID: c_uint = 0x60;
pub const TPM_I2C_RETRIES: c_int = 5;
//
// I2C bus device maximum buffer size w/o counting I2C address or command
// i.e. max size required for I2C write is 34 = addr, command, 32 bytes data
//
pub const TPM_I2C_MAX_BUF_SIZE: c_int = 32;
pub const TPM_I2C_RETRY_COUNT: c_int = 32;

pub const I2C_IS_TPM2: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
...
pub const TPM_STS_VALID: c_uint = 0x80;
pub const TPM_STS_COMMAND_READY: c_uint = 0x40;
pub const TPM_STS_GO: c_uint = 0x20;
pub const TPM_STS_DATA_AVAIL: c_uint = 0x10;
pub const TPM_STS_EXPECT: c_uint = 0x08;
pub const TPM_STS_RESPONSE_RETRY: c_uint = 0x02;
pub const TPM_STS_ERR_VAL: c_uint = 0x07    /* bit2...bit0 reads always 0 */;

// read TPM_STS register
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_read_status(chip: *mut tpm_chip) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_write_status(client: *mut i2c_client, data: u8) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_ready(chip: *mut tpm_chip) {
...
// return -1 on fail to read
    ...
    {
    let mut stop: c_ulong = jiffies + chip.timeout_d;
    s32 status;
    let mut burst_count: c_int = -1;
    u8 data;
...
//
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_check_status(chip: *mut tpm_chip, mask: u8, value: u8) -> bool {
    static bool i2c_nuvoton_check_status(struct tpm_chip *chip, u8 mask, u8 value)
    {
    let mut status: u8 = i2c_nuvoton_read_status(chip);
    ...
    let mut cur_intrs: c_uint = priv.intrs;
    enable_irq(priv.irq);
...
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_recv(chip: *mut tpm_chip, buf: *mut u8, count: usize) -> c_int {
...
//
    ...
    chip.timeout_b, core::ptr::null_mut())) {
...
// write last byte
    ...
    TPM_STS_VALID,
    chip.timeout_c, core::ptr::null_mut());
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_req_canceled(chip: *mut tpm_chip, status: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_int_handler(dummy: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn get_vid(client: *mut i2c_client, res: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_nuvoton_remove(client: *mut i2c_client) {
