...
//! Source: drivers/char/tpm/tpm-dev-common.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tpm_dev_async_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn user_reader_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn tpm_timeout_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn tpm_common_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn tpm_common_release(file: *mut file, priv: *mut file_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn tpm_dev_common_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn tpm_dev_common_exit() -> void __exit {
