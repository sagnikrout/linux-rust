...
//! Source: drivers/char/tpm/eventlog/efi.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tpm_read_log_efi(chip: *mut tpm_chip) -> c_int {
    int tpm_read_log_efi(struct tpm_chip *chip)
    {
    struct efi_tcg2_final_events_table *final_tbl = core::ptr::null_mut();
    let mut final_events_log_size: c_int = efi_tpm_final_log_size;
