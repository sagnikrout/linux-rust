...
//! Source: drivers/char/tpm/eventlog/tpm1.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tpm1_bios_measurements_stop(m: *mut seq_file, v: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tpm1_binary_bios_measurements_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpm1_ascii_bios_measurements_show(m: *mut seq_file, v: *mut c_void) -> c_int {
