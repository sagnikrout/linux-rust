...
//! Source: drivers/char/uv_mmtimer.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn uv_mmtimer_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
    static int uv_mmtimer_mmap(struct file *file, struct vm_area_struct *vma)
    {
...
//
#[no_mangle]
unsafe extern "C" fn uv_mmtimer_init() -> int __init {
