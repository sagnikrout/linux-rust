...
//
#[no_mangle]
unsafe extern "C" fn __nvram_read_byte(i: c_int) -> c_uchar {
    static unsigned char __nvram_read_byte(int i)
    {
    return CMOS_READ(NVRAM_FIRST_BYTE + i);
    }
#[no_mangle]
unsafe extern "C" fn pc_nvram_read_byte(i: c_int) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn __nvram_write_byte(c: c_uchar, i: c_int) {
    static void __nvram_write_byte(unsigned char c, int i)
    {
    CMOS_WRITE(c, NVRAM_FIRST_BYTE + i);
    }
#[no_mangle]
unsafe extern "C" fn pc_nvram_write_byte(c: c_uchar, i: c_int) {
...
pub const PC_CKS_RANGE_START: c_int = 2;
pub const PC_CKS_RANGE_END: c_int = 31;
pub const PC_CKS_LOC: c_int = 32;
#[no_mangle]
unsafe extern "C" fn __nvram_check_checksum() -> c_int {
    static int __nvram_check_checksum(void)
    {
    int i;
    let mut sum: c_ushort = 0;
...
#[no_mangle]
unsafe extern "C" fn __nvram_set_checksum() {
...
#[no_mangle]
unsafe extern "C" fn pc_nvram_set_checksum() -> c_long {
...
#[no_mangle]
unsafe extern "C" fn pc_nvram_initialize() -> c_long {
...
#[no_mangle]
unsafe extern "C" fn pc_nvram_get_size() -> isize {
    static ssize_t pc_nvram_get_size(void)
    {
    return NVRAM_BYTES;
    }
#[no_mangle]
unsafe extern "C" fn pc_nvram_read(buf: *mut c_char, count: usize, ppos: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn pc_nvram_write(buf: *mut c_char, count: usize, ppos: *mut loff_t) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn nvram_misc_llseek(file: *mut file, offset: loff_t, origin: c_int) -> loff_t {
...
#[no_mangle]
unsafe extern "C" fn nvram_misc_open(inode: *mut inode, file: *mut file) -> c_int {
...
// Prevent multiple writers if the set_checksum ioctl is implemented.
    if ((arch_nvram_ops.set_checksum != core::ptr::null_mut()) &&
...
#[no_mangle]
unsafe extern "C" fn nvram_misc_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvram_proc_read(seq: *mut seq_file, offset: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvram_module_init() -> int __init {
    ...
    if (!proc_create_single("driver/nvram", 0, core::ptr::null_mut(), nvram_proc_read)) {
...
#[no_mangle]
unsafe extern "C" fn nvram_module_exit() -> void __exit {
    static void __exit nvram_module_exit(void)
    {

    remove_proc_entry("driver/nvram", core::ptr::null_mut());
