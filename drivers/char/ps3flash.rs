...
//! Source: drivers/char/ps3flash.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ps3flash_private {
    pub /: *mut *mut mutex mutex; / Bounce buffer mutex,
    pub chunk_sectors: u64,
    pub /: *mut *mut int tag; / Start sector of buffer, -1 if invalid,
    pub dirty: bool,
}
...
#[no_mangle]
unsafe extern "C" fn ps3flash_writeback(dev: *mut ps3_storage_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3flash_fetch(dev: *mut ps3_storage_device, start_sector: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3flash_llseek(file: *mut file, offset: loff_t, origin: c_int) -> loff_t {
...
// pos += n;
    ...
    res = ps3flash_fetch(dev, sector);
#[no_mangle]
pub unsafe extern "C" fn if(priv->tag: sector !=) -> else {
...
// pos += n;
    ...
    size_t count, loff_t *pos)
    {
    return ps3flash_read(buf, core::ptr::null_mut(), count, pos);
    }
    static ssize_t ps3flash_user_write(struct file *file, const char __user *buf,
    size_t count, loff_t *pos)
    {
    return ps3flash_write(buf, core::ptr::null_mut(), count, pos);
    }
#[no_mangle]
unsafe extern "C" fn ps3flash_kernel_read(buf: *mut c_void, count: usize, pos: loff_t) -> isize {
    static ssize_t ps3flash_kernel_read(void *buf, size_t count, loff_t pos)
    {
    return ps3flash_read(core::ptr::null_mut(), buf, count, &pos);
    }
    ...
    ssize_t res;
    int wb;
    res = ps3flash_write(core::ptr::null_mut(), buf, count, &pos);
    if (res < 0)
    return res;
...
#[no_mangle]
unsafe extern "C" fn ps3flash_flush(file: *mut file, id: fl_owner_t) -> c_int {
    static int ps3flash_flush(struct file *file, fl_owner_t id)
    {
    return ps3flash_writeback(ps3flash_dev);
    }
#[no_mangle]
unsafe extern "C" fn ps3flash_fsync(file: *mut file, start: loff_t, end: loff_t, datasync: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps3flash_interrupt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ps3flash_probe(_dev: *mut ps3_system_bus_device) -> c_int {
...
// use static buffer, kmalloc cannot allocate 256 KiB
    ...
    fail:
    ps3flash_dev = core::ptr::null_mut();
    return error;
    }
#[no_mangle]
unsafe extern "C" fn ps3flash_remove(_dev: *mut ps3_system_bus_device) {
    static void ps3flash_remove(struct ps3_system_bus_device *_dev)
    {
    struct ps3_storage_device *dev = to_ps3_storage_device(&_dev.core);
    ps3_os_area_flash_register(core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ps3flash_init() -> int __init {
    static int __init ps3flash_init(void)
    {
    return ps3_system_bus_driver_register(&ps3flash);
    }
#[no_mangle]
unsafe extern "C" fn ps3flash_exit() -> void __exit {
