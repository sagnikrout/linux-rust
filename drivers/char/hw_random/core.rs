...
//! Source: drivers/char/hw_random/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rng_buffer_size() -> usize {
    static size_t rng_buffer_size(void)
    {
    return RNG_BUFFER_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn cleanup_rng_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn cleanup_rng(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn set_current_rng(rng: *mut hwrng) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drop_current_rng() {
    ...
    if (!rng)
    return;
    RCU_INIT_POINTER(current_rng, core::ptr::null_mut());
    synchronize_rcu();
...
#[no_mangle]
unsafe extern "C" fn put_rng(rng: *mut hwrng) {
...
#[no_mangle]
unsafe extern "C" fn hwrng_init(rng: *mut hwrng) -> c_int {
    static int hwrng_init(struct hwrng *rng)
    {
...
#[no_mangle]
unsafe extern "C" fn rng_dev_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rng_get_data(rng: *mut hwrng, buffer: *mut u8, size: usize, wait: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_best_rng() -> c_int {
    static int enable_best_rng(void)
    {
    struct hwrng *rng, *cur_rng, *new_rng = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hwrng_start_hwrng_fillfn() {
    static void hwrng_start_hwrng_fillfn(void)
    {
...
//
    ...
    return;
    if (!hwrng_fill) {
    hwrng_fill = kthread_run(hwrng_fillfn, core::ptr::null_mut(), "hwrng");
    if (IS_ERR(hwrng_fill)) {
    pr_err("hwrng_fill thread creation failed\n");
    hwrng_fill = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn hwrng_stop_hwrng_fillfn() {
    static void hwrng_stop_hwrng_fillfn(void)
    {
    lockdep_assert_held(&rng_mutex);
    if (hwrng_fill) {
...
#[no_mangle]
unsafe extern "C" fn hwrng_fillfn(unused: *mut c_void) -> c_int {
    static int hwrng_fillfn(void *unused)
    {
...
#[no_mangle]
pub unsafe extern "C" fn hwrng_register(rng: *mut hwrng) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hwrng_unregister(rng: *mut hwrng) {
...
#[no_mangle]
unsafe extern "C" fn devm_hwrng_release(dev: *mut device, res: *mut c_void) {
    static void devm_hwrng_release(struct device *dev, void *res)
    {
    hwrng_unregister(*(struct hwrng **)res);
    }
#[no_mangle]
unsafe extern "C" fn devm_hwrng_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devm_hwrng_register(dev: *mut device, rng: *mut hwrng) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devm_hwrng_unregister(dev: *mut device, rng: *mut hwrng) {
...
#[no_mangle]
pub unsafe extern "C" fn hwrng_msleep(rng: *mut hwrng, msecs: c_uint) -> c_long {
    long hwrng_msleep(struct hwrng *rng, unsigned int msecs)
    {
    let mut timeout: c_ulong = msecs_to_jiffies(msecs) + 1;
    return wait_for_completion_interruptible_timeout(&rng.dying, timeout);
    }
    EXPORT_SYMBOL_GPL(hwrng_msleep);
#[no_mangle]
pub unsafe extern "C" fn hwrng_yield(rng: *mut hwrng) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn hwrng_modinit() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hwrng_modexit() -> void __exit {
