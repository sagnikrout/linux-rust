...
//! Source: drivers/char/hw_random/stm32-rng.c
#![no_std]
...
pub const RNG_CR: c_uint = 0x00;

pub const RNG_CR_CLKDIV_SHIFT: c_int = 16;

pub const RNG_SR: c_uint = 0x04;

pub const RNG_DR: c_uint = 0x08;
pub const RNG_NSCR: c_uint = 0x0C;

pub const RNG_HTCR: c_uint = 0x10;
pub const RNG_NB_RECOVER_TRIES: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rng_data {
    pub max_clock_rate: c_uint,
    pub nb_clock: c_uint,
    pub cr: u32,
    pub nscr: u32,
    pub htcr: u32,
    pub has_cond_reset: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rng_private {
    pub rng: hwrng,
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub clk_bulk: *mut clk_bulk_data,
    pub rst: *mut reset_control,
    pub pm_conf: stm32_rng_config,
    pub data: *const stm32_rng_data,
    pub ced: bool,
    pub lock_conf: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn stm32_rng_conceal_seed_error_cond_reset(priv: *mut stm32_rng_private) -> c_int {
    static int stm32_rng_conceal_seed_error_cond_reset(struct stm32_rng_private *priv)
    {
    struct device *dev = priv.dev;
    let mut sr: u32 = readl_relaxed(priv.base + RNG_SR);
    let mut cr: u32 = readl_relaxed(priv.base + RNG_CR);
    int err;
    if (sr & RNG_SR_SECS) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32_rng_conceal_seed_error_sw_reset(priv: *mut stm32_rng_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_conceal_seed_error(rng: *mut hwrng) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_read(rng: *mut hwrng, data: *mut c_void, max: usize, wait: bool) -> c_int {
    static int stm32_rng_read(struct hwrng *rng, void *data, size_t max, bool wait)
    {
    struct stm32_rng_private *priv = container_of(rng, struct stm32_rng_private, rng);
    let mut i: c_uint = 0;
    let mut retval: c_int = 0, err = 0;
    u32 sr;
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_clock_freq_restrain(rng: *mut hwrng) -> c_uint {
    static uint stm32_rng_clock_freq_restrain(struct hwrng *rng)
    {
    struct stm32_rng_private *priv =
    container_of(rng, struct stm32_rng_private, rng);
    let mut clock_rate: c_ulong = 0;
    let mut clock_div: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_init(rng: *mut hwrng) -> c_int {
...
//
    ...
    let mut clock_div: c_uint = stm32_rng_clock_freq_restrain(rng);
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_resume(dev: *mut device) -> int __maybe_unused {
...
//
    ...
    stm32_rng_runtime_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn stm32_rng_probe(ofdev: *mut platform_device) -> c_int {
    ...
    priv.rst = devm_reset_control_get(&ofdev.dev, core::ptr::null_mut());
    if (!IS_ERR(priv.rst)) {
