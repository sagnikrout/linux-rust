...
//! Source: drivers/char/hw_random/amd-rng.c
#![no_std]
...
pub const RNGDATA: c_uint = 0x00;
pub const RNGDONE: c_uint = 0x04;
pub const PMBASE_OFFSET: c_uint = 0xF0;
pub const PMBASE_SIZE: c_int = 8;
//
...
#[no_mangle]
unsafe extern "C" fn amd_rng_read(rng: *mut hwrng, buf: *mut c_void, max: usize, wait: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_rng_init(rng: *mut hwrng) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_rng_cleanup(rng: *mut hwrng) {
...
#[no_mangle]
unsafe extern "C" fn amd_rng_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn amd_rng_mod_exit() -> void __exit {
