...
//! Source: drivers/char/hw_random/exynos-trng.c
#![no_std]
...
pub const EXYNOS_TRNG_CLKDIV: c_uint = 0x0;
pub const EXYNOS_TRNG_CTRL: c_uint = 0x20;

pub const EXYNOS_TRNG_POST_CTRL: c_uint = 0x30;
pub const EXYNOS_TRNG_ONLINE_CTRL: c_uint = 0x40;
pub const EXYNOS_TRNG_ONLINE_STAT: c_uint = 0x44;
pub const EXYNOS_TRNG_ONLINE_MAXCHI2: c_uint = 0x48;
pub const EXYNOS_TRNG_FIFO_CTRL: c_uint = 0x50;
pub const EXYNOS_TRNG_FIFO_0: c_uint = 0x80;
pub const EXYNOS_TRNG_FIFO_1: c_uint = 0x84;
pub const EXYNOS_TRNG_FIFO_2: c_uint = 0x88;
pub const EXYNOS_TRNG_FIFO_3: c_uint = 0x8c;
pub const EXYNOS_TRNG_FIFO_4: c_uint = 0x90;
pub const EXYNOS_TRNG_FIFO_5: c_uint = 0x94;
pub const EXYNOS_TRNG_FIFO_6: c_uint = 0x98;
pub const EXYNOS_TRNG_FIFO_7: c_uint = 0x9c;
pub const EXYNOS_TRNG_FIFO_LEN: c_int = 8;
pub const EXYNOS_TRNG_CLOCK_RATE: c_int = 500000;
...
pub const HWRNG_INIT: c_uint = 0x0;
pub const HWRNG_EXIT: c_uint = 0x1;
pub const HWRNG_GET_DATA: c_uint = 0x2;
pub const HWRNG_RESUME: c_uint = 0x3;
// SMC_CMD_RANDOM: return values
pub const HWRNG_RET_OK: c_uint = 0x0;
pub const HWRNG_RET_RETRY_ERROR: c_uint = 0x2;
pub const HWRNG_MAX_TRIES: c_int = 100;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn exynos_trng_init_reg(rng: *mut hwrng) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_trng_init_smc(rng: *mut hwrng) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_trng_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_trng_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn exynos_trng_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_trng_resume(dev: *mut device) -> c_int {
