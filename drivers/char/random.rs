...
// Control how we warn userspace.
    ...
    let mut __read_mostly: static int ratelimit_disable = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn rng_is_initialized() -> bool {
...
#[no_mangle]
unsafe extern "C" fn crng_set_ready(work: *mut work_struct) -> void __cold {
...
//
#[no_mangle]
pub unsafe extern "C" fn wait_for_random_bytes() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn execute_with_initialized_rng(nb: *mut notifier_block) -> int __cold {
...
//
#[no_mangle]
unsafe extern "C" fn crng_reseed_interval() -> c_uint {
    static unsigned int crng_reseed_interval(void)
    {
    let mut early_boot: static bool = true;
    if (unlikely(READ_ONCE(early_boot))) {
    let mut uptime: time64_t = ktime_get_seconds();
...
#[no_mangle]
unsafe extern "C" fn crng_reseed(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn _get_random_bytes(buf: *mut c_void, len: usize) {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_random_bytes(buf: *mut c_void, len: usize) {
    void get_random_bytes(void *buf, size_t len)
    {
...
#[no_mangle]
unsafe extern "C" fn get_random_bytes_user(iter: *mut iov_iter) -> isize {
    static ssize_t get_random_bytes_user(struct iov_iter *iter)
    {
    struct chacha_state chacha_state;
    u8 block[CHACHA_BLOCK_SIZE];
    let mut ret: usize = 0, copied;
...
#[no_mangle]
pub unsafe extern "C" fn __get_random_u32_below(ceil: u32) -> u32 {
...
// in 32-bits.
//
    let mut rand: u32 = get_random_u32();
    u64 mult;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn random_prepare_cpu(cpu: c_uint) -> int __cold {
...
#[no_mangle]
unsafe extern "C" fn _mix_pool_bytes(buf: *const c_void, len: usize) {
...
//
#[no_mangle]
unsafe extern "C" fn mix_pool_bytes(buf: *const c_void, len: usize) {
    static void mix_pool_bytes(const void *buf, size_t len)
    {
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn extract_entropy(buf: *mut c_void, len: usize) {
    static void extract_entropy(void *buf, size_t len)
    {
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn _credit_init_bits(bits: usize) -> void __cold {
    ...
    crng_reseed(core::ptr::null_mut()); /* Sets crng_init to CRNG_READY under base_crng.lock. */
    if (system_dfl_wq)
    queue_work(system_dfl_wq, &set_ready);
    atomic_notifier_call_chain(&random_ready_notifier, 0, core::ptr::null_mut());
    if (IS_ENABLED(CONFIG_VDSO_GETRANDOM))
...
//
    let mut __initdata: static bool trust_cpu = true;
    let mut __initdata: static bool trust_bootloader = true;
#[no_mangle]
unsafe extern "C" fn parse_trust_cpu(arg: *mut c_char) -> int __init {
    static int __init parse_trust_cpu(char *arg)
    {
    return kstrtobool(arg, &trust_cpu);
    }
#[no_mangle]
unsafe extern "C" fn parse_trust_bootloader(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn random_pm_notification(nb: *mut notifier_block, action: c_ulong, data: *mut c_void) -> c_int {
...
//
    ...
    crng_reseed(core::ptr::null_mut());
    pr_notice("crng reseeded on system resumption\n");
    }
    return 0;
    }
    let mut pm_notifier: static struct notifier_block = { .notifier_call = random_pm_notification };
//
...
//
#[no_mangle]
pub unsafe extern "C" fn random_init_early(command_line: *const c_char) -> void __init {
...
// Reseed if already seeded by earlier phases.
    ...
    crng_reseed(core::ptr::null_mut());
#[no_mangle]
pub unsafe extern "C" fn if(_arg: trust_cpu) -> else {
    else if (trust_cpu)
...
//
#[no_mangle]
pub unsafe extern "C" fn random_init() -> void __init {
    void __init random_init(void)
    {
    let mut entropy: c_ulong = random_get_entropy();
    let mut now: ktime_t = ktime_get_real();
...
//
    ...
    crng_set_ready(core::ptr::null_mut());
// Reseed if already seeded by earlier phases.
    if (crng_ready())
    crng_reseed(core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn add_device_randomness(buf: *const c_void, len: usize) {
    void add_device_randomness(const void *buf, size_t len)
    {
    let mut entropy: c_ulong = random_get_entropy();
    unsigned long flags;
...
//
#[no_mangle]
pub unsafe extern "C" fn add_hwgenerator_randomness(buf: *const c_void, len: usize, entropy: usize, sleep_after: bool) {
    void add_hwgenerator_randomness(const void *buf, size_t len, size_t entropy, bool sleep_after)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn add_bootloader_randomness(buf: *const c_void, len: usize) -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn add_vmfork_randomness(unique_vm_id: *const c_void, len: usize) -> void __cold {
    ...
    blocking_notifier_call_chain(&vmfork_chain, 0, core::ptr::null_mut());
    }

    EXPORT_SYMBOL_GPL(add_vmfork_randomness);

#[no_mangle]
pub unsafe extern "C" fn register_random_vmfork_notifier(nb: *mut notifier_block) -> int __cold {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_random_vmfork_notifier(nb: *mut notifier_block) -> int __cold {
...
//
#[no_mangle]
unsafe extern "C" fn fast_mix(s[4]: c_ulong, v1: c_ulong, v2: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn random_online_cpu(cpu: c_uint) -> int __cold {
...
#[no_mangle]
unsafe extern "C" fn mix_interrupt_randomness(work: *mut timer_list) {
    static void mix_interrupt_randomness(struct timer_list *work)
    {
...
#[no_mangle]
pub unsafe extern "C" fn add_interrupt_randomness(irq: c_int) {
    void add_interrupt_randomness(int irq)
    {
...
pub struct timer_rand_state {
    ...
    pub last_delta2: long last_delta,,
}
...
//
#[no_mangle]
unsafe extern "C" fn add_timer_randomness(state: *mut timer_rand_state, num: c_uint) {
    static void add_timer_randomness(struct timer_rand_state *state, unsigned int num)
    {
    let mut entropy: c_ulong = random_get_entropy(), now = jiffies, flags;
...
#[no_mangle]
pub unsafe extern "C" fn add_input_randomness(type: c_uint, code: c_uint, value: c_uint) {
    void add_input_randomness(unsigned int type, unsigned int code, unsigned int value)
    {
    static unsigned char last_value;
    let mut input_timer_state: static struct timer_rand_state = { INITIAL_JIFFIES };
...
#[no_mangle]
pub unsafe extern "C" fn add_disk_randomness(disk: *mut gendisk) {
    void add_disk_randomness(struct gendisk *disk)
    {
    if (!disk || !disk.random)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn rand_initialize_disk(disk: *mut gendisk) -> void __cold {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct entropy_timer_state {
    pub entropy: c_ulong,
    pub timer: timer_list,
    pub samples: core::sync::atomic::AtomicI32,
    pub samples_per_bit: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn entropy_timer(timer: *mut timer_list) -> void __cold {
...
//
#[no_mangle]
unsafe extern "C" fn try_to_generate_entropy() -> void __cold {
    ...
    let mut last: c_ulong = random_get_entropy();
...
#[no_mangle]
unsafe extern "C" fn random_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn write_pool_user(iter: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn random_write_iter(kiocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    static ssize_t random_write_iter(struct kiocb *kiocb, struct iov_iter *iter)
    {
    return write_pool_user(iter);
    }
#[no_mangle]
unsafe extern "C" fn urandom_read_iter(kiocb: *mut kiocb, iter: *mut iov_iter) -> isize {
    static ssize_t urandom_read_iter(struct kiocb *kiocb, struct iov_iter *iter)
    {
    let mut maxwarn: static int = 10;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(__ratelimit(&urandom_warning): ratelimit_disable ||) -> else {
    --maxwarn;
...
#[no_mangle]
unsafe extern "C" fn random_read_iter(kiocb: *mut kiocb, iter: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn random_ioctl(f: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn random_fasync(fd: c_int, filp: *mut file, on: c_int) -> c_int {
...
//
    ...
    let mut sysctl_random_min_urandom_seed: static int = CRNG_RESEED_INTERVAL / HZ;
    let mut sysctl_random_write_wakeup_bits: static int = POOL_READY_BITS;
    let mut sysctl_poolsize: static int = POOL_BITS;
...
//
#[no_mangle]
unsafe extern "C" fn random_sysctls_init() -> int __init {
