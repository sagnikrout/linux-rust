...
//! Source: drivers/char/misc_minor_kunit.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kunit_static_minor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn kunit_misc_dynamic_minor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn miscdev_find_minors(suite: *mut kunit_suite) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_valid_dynamic_minor(minor: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_can_open(test: *mut kunit, misc: *mut miscdevice) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_static_basic(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_dynamic_basic(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_twice(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_duplicate_minor(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_duplicate_name(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn miscdev_test_duplicate_name_leak(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn miscdev_test_duplicate_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_dynamic_only_range(test: *mut kunit) -> void __init {
    static void __init miscdev_test_dynamic_only_range(struct kunit *test)
    {
    int ret;
    struct miscdevice *miscdev;
    let mut dynamic_minors: c_int = 256;
    int i;
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_collision(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_collision_reverse(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_conflict(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_conflict_reverse(test: *mut kunit) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn miscdev_test_invalid_input(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn miscdev_test_dynamic_reentry(test: *mut kunit) {
