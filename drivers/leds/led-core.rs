...
//! Source: drivers/leds/led-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __led_set_brightness(led_cdev: *mut led_classdev, value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __led_set_brightness_blocking(led_cdev: *mut led_classdev, value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn led_timer_function(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn set_brightness_delayed(ws: *mut work_struct) {
...
//
    ...
    let mut delay_on: c_ulong = led_cdev.delayed_delay_on;
    let mut delay_off: c_ulong = led_cdev.delayed_delay_off;
...
#[no_mangle]
pub unsafe extern "C" fn led_init_core(led_cdev: *mut led_classdev) {
...
#[no_mangle]
pub unsafe extern "C" fn led_stop_software_blink(led_cdev: *mut led_classdev) {
...
#[no_mangle]
pub unsafe extern "C" fn led_set_brightness(led_cdev: *mut led_classdev, brightness: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn led_set_brightness_nopm(led_cdev: *mut led_classdev, value: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn led_set_brightness_nosleep(led_cdev: *mut led_classdev, value: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn led_set_brightness_sync(led_cdev: *mut led_classdev, value: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn led_update_brightness(led_cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn led_sysfs_disable(led_cdev: *mut led_classdev) {
...
// Caller must ensure led_cdev->led_access held
#[no_mangle]
pub unsafe extern "C" fn led_sysfs_enable(led_cdev: *mut led_classdev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(LED_COLOR_ID_MAX: props->color >=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn led_init_default_state_get(fwnode: *mut fwnode_handle) -> enum led_default_state {
    enum led_default_state led_init_default_state_get(struct fwnode_handle *fwnode)
    {
    const char *state = core::ptr::null_mut();
