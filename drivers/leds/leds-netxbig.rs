...
//! Source: drivers/leds/leds-netxbig.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netxbig_gpio_ext {
    pub addr: *mut gpio_desc,
    pub num_addr: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct netxbig_led_timer {
    pub delay_on: c_ulong,
    pub delay_off: c_ulong,
    pub mode: enum netxbig_led_mode,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct netxbig_led {
    pub name: *const c_char,
    pub default_trigger: *const c_char,
    pub mode_addr: c_int,
    pub mode_val: *mut c_int,
    pub bright_addr: c_int,
    pub bright_max: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct netxbig_led_platform_data {
    pub gpio_ext: *mut netxbig_gpio_ext,
    pub timer: *mut netxbig_led_timer,
    pub num_timer: c_int,
    pub leds: *mut netxbig_led,
    pub num_leds: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn gpio_ext_set_addr(gpio_ext: *mut netxbig_gpio_ext, addr: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gpio_ext_set_data(gpio_ext: *mut netxbig_gpio_ext, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gpio_ext_enable_select(gpio_ext: *mut netxbig_gpio_ext) {
...
// Look for a LED mode with the requested timer frequency.
    ...
    enum netxbig_led_mode mode;
    int mode_val;
    let mut set_brightness: c_int = 1;
    unsigned long flags;
...
#[no_mangle]
pub unsafe extern "C" fn if(NETXBIG_LED_OFF: led_dat->mode ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn netxbig_gpio_ext_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn netxbig_led_probe(pdev: *mut platform_device) -> c_int {
