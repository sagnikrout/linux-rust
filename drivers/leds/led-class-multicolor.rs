...
//! Source: drivers/leds/led-class-multicolor.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn led_mc_get_max_intensity(mcled_cdev: *mut led_classdev_mc, index: usize) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn led_classdev_multicolor_unregister(mcled_cdev: *mut led_classdev_mc) {
...
#[no_mangle]
unsafe extern "C" fn devm_led_classdev_multicolor_release(dev: *mut device, res: *mut c_void) {
