...
//! Source: drivers/leds/leds-turris-omnia.c
#![no_std]
...
pub const OMNIA_BOARD_LEDS: c_int = 12;
pub const OMNIA_LED_NUM_CHANNELS: c_int = 3;
// MCU controller I2C address 0x2a, needed for detecting MCU features
pub const OMNIA_MCU_I2C_ADDR: c_uint = 0x2a;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omnia_led {
    pub mc_cdev: led_classdev_mc,
    pub subled_info: [mc_subled; OMNIA_LED_NUM_CHANNELS],
    pub cached_channels: [u8; OMNIA_LED_NUM_CHANNELS],
    pub hwtrig: bool on,,
    pub reg: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omnia_leds {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub has_gamma_correction: bool,
    pub brightness_knode: *mut kernfs_node,
    pub leds: [omnia_led; ],
}

#[no_mangle]
unsafe extern "C" fn omnia_cmd_set_color(client: *const i2c_client, led: u8, r: u8, g: u8, b: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_led_channels_changed(led: *mut omnia_led) -> bool {
...
//
    ...
    let mut state: u8 = OMNIA_CMD_LED_STATE_LED(led.reg);
    if (brightness)
...
#[no_mangle]
unsafe extern "C" fn omnia_hwtrig_activate(cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_hwtrig_deactivate(cdev: *mut led_classdev) {
...
#[no_mangle]
unsafe extern "C" fn omnia_brightness_changed_threaded_fn(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn omnia_brightness_knode_put(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn omnia_request_brightness_irq(leds: *mut omnia_leds) -> c_int {
...
//
    ...
    if (ret < 0)
    return ret;
    return devm_request_threaded_irq(dev, leds.client.irq, core::ptr::null_mut(),
    omnia_brightness_changed_threaded_fn, IRQF_ONESHOT,
    "leds-turris-omnia", leds);
    }
#[no_mangle]
unsafe extern "C" fn omnia_mcu_get_features(mcu_client: *const i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_match_mcu_client(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_find_mcu_and_get_features(dev: *mut device) -> c_int {
    static int omnia_find_mcu_and_get_features(struct device *dev)
    {
    struct device *mcu_dev;
    int ret;
    mcu_dev = device_find_child(dev.parent, core::ptr::null_mut(), omnia_match_mcu_client);
    if (!mcu_dev)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn omnia_leds_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_leds_remove(client: *mut i2c_client) {
