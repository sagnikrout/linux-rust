...
//! Source: drivers/leds/leds-mlxreg.c
#![no_std]
...
// Codes for LEDs.
pub const MLXREG_LED_OFFSET_BLINK_3HZ: c_uint = 0x01 /* Offset from solid: 3Hz blink */;
pub const MLXREG_LED_OFFSET_BLINK_6HZ: c_uint = 0x02 /* Offset from solid: 6Hz blink */;
pub const MLXREG_LED_IS_OFF: c_uint = 0x00 /* Off */;
pub const MLXREG_LED_RED_SOLID: c_uint = 0x05 /* Solid red */;
pub const MLXREG_LED_GREEN_SOLID: c_uint = 0x0D /* Solid green */;
pub const MLXREG_LED_AMBER_SOLID: c_uint = 0x09 /* Solid amber */;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxreg_led_data {
    pub data: *mut mlxreg_core_data,
    pub led_cdev: led_classdev,
    pub base_color: u8,
    pub data_parent: *mut c_void,
    pub led_cdev_name: [c_char; MLXREG_CORE_LABEL_MAX_SIZE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxreg_led_priv_data {
    pub pdev: *mut platform_device,
    pub pdata: *mut mlxreg_core_platform_data,
    pub /: *mut *mut mutex access_lock; / protect IO operations,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(MLXREG_LED_BLINK_3HZ: *mut *mut delay_on ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_led_config(priv: *mut mlxreg_led_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_led_probe(pdev: *mut platform_device) -> c_int {
