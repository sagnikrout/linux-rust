...
//! Source: drivers/leds/leds-lp50xx.c
#![no_std]
...
pub const LP50XX_DEV_CFG0: c_uint = 0x00;
pub const LP50XX_DEV_CFG1: c_uint = 0x01;
pub const LP50XX_LED_CFG0: c_uint = 0x02;
// LP5009 and LP5012 registers
pub const LP5012_BNK_BRT: c_uint = 0x03;
pub const LP5012_BNKA_CLR: c_uint = 0x04;
pub const LP5012_BNKB_CLR: c_uint = 0x05;
pub const LP5012_BNKC_CLR: c_uint = 0x06;
pub const LP5012_LED0_BRT: c_uint = 0x07;
pub const LP5012_OUT0_CLR: c_uint = 0x0b;
pub const LP5012_RESET: c_uint = 0x17;
// LP5018 and LP5024 registers
pub const LP5024_BNK_BRT: c_uint = 0x03;
pub const LP5024_BNKA_CLR: c_uint = 0x04;
pub const LP5024_BNKB_CLR: c_uint = 0x05;
pub const LP5024_BNKC_CLR: c_uint = 0x06;
pub const LP5024_LED0_BRT: c_uint = 0x07;
pub const LP5024_OUT0_CLR: c_uint = 0x0f;
pub const LP5024_RESET: c_uint = 0x27;
// LP5030 and LP5036 registers
pub const LP5036_LED_CFG1: c_uint = 0x03;
pub const LP5036_BNK_BRT: c_uint = 0x04;
pub const LP5036_BNKA_CLR: c_uint = 0x05;
pub const LP5036_BNKB_CLR: c_uint = 0x06;
pub const LP5036_BNKC_CLR: c_uint = 0x07;
pub const LP5036_LED0_BRT: c_uint = 0x08;
pub const LP5036_OUT0_CLR: c_uint = 0x14;
pub const LP5036_RESET: c_uint = 0x38;
pub const LP50XX_SW_RESET: c_uint = 0xff;

pub const LP50XX_CHIP_DISABLE: c_uint = 0x00;
pub const LP50XX_START_TIME_US: c_int = 500;
pub const LP50XX_RESET_TIME_US: c_int = 3;
pub const LP50XX_EN_GPIO_LOW: c_int = 0;
pub const LP50XX_EN_GPIO_HIGH: c_int = 1;
// There are 3 LED outputs per bank
pub const LP50XX_LEDS_PER_MODULE: c_int = 3;
pub const LP5009_MAX_LED_MODULES: c_int = 3;
pub const LP5012_MAX_LED_MODULES: c_int = 4;
pub const LP5018_MAX_LED_MODULES: c_int = 6;
pub const LP5024_MAX_LED_MODULES: c_int = 8;
pub const LP5030_MAX_LED_MODULES: c_int = 10;
pub const LP5036_MAX_LED_MODULES: c_int = 12;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp50xx_chip_info {
    pub lp50xx_regmap_config: *const regmap_config,
    pub model_id: c_int,
    pub max_modules: u8,
    pub num_leds: u8,
    pub led_brightness0_reg: u8,
    pub mix_out0_reg: u8,
    pub bank_brt_reg: u8,
    pub bank_mix_reg: u8,
    pub reset_reg: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp50xx_led {
    pub mc_cdev: led_classdev_mc,
    pub priv: *mut lp50xx,
    pub ctrl_bank_enabled: u8,
    pub led_number: c_int,
}
...
pub struct lp50xx {
    ...
    pub dev: *mut device,
    pub lock: mutex,
    pub chip_info: *const lp50xx_chip_info,
...
#[no_mangle]
unsafe extern "C" fn lp50xx_set_banks(priv: *mut lp50xx, led_banks[]: u32, num_leds: c_int) -> c_int {
    static int lp50xx_set_banks(struct lp50xx *priv, u32 led_banks[], int num_leds)
    {
    u8 led_config_lo, led_config_hi;
    let mut bank_enable_mask: u32 = 0;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn lp50xx_reset(priv: *mut lp50xx) -> c_int {
    static int lp50xx_reset(struct lp50xx *priv)
    {
    return regmap_write(priv.regmap, priv.chip_info.reset_reg, LP50XX_SW_RESET);
    }
#[no_mangle]
unsafe extern "C" fn lp50xx_enable(priv: *mut lp50xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp50xx_disable(priv: *mut lp50xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp50xx_probe_dt(priv: *mut lp50xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp50xx_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp50xx_remove(client: *mut i2c_client) {
