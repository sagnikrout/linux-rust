...
//! Source: drivers/leds/leds-lm3533.c
#![no_std]
...
pub const LM3533_LVCTRLBANK_MIN: c_int = 2;
pub const LM3533_LVCTRLBANK_MAX: c_int = 5;
pub const LM3533_LVCTRLBANK_COUNT: c_int = 4;
pub const LM3533_RISEFALLTIME_MAX: c_int = 7;
pub const LM3533_ALS_CHANNEL_LV_MIN: c_int = 1;
pub const LM3533_ALS_CHANNEL_LV_MAX: c_int = 2;
pub const LM3533_REG_CTRLBANK_BCONF_BASE: c_uint = 0x1b;
pub const LM3533_REG_PATTERN_ENABLE: c_uint = 0x28;
pub const LM3533_REG_PATTERN_LOW_TIME_BASE: c_uint = 0x71;
pub const LM3533_REG_PATTERN_HIGH_TIME_BASE: c_uint = 0x72;
pub const LM3533_REG_PATTERN_RISETIME_BASE: c_uint = 0x74;
pub const LM3533_REG_PATTERN_FALLTIME_BASE: c_uint = 0x75;
pub const LM3533_REG_PATTERN_STEP: c_uint = 0x10;
pub const LM3533_REG_CTRLBANK_BCONF_MAPPING_MASK: c_uint = 0x04;
pub const LM3533_REG_CTRLBANK_BCONF_ALS_EN_MASK: c_uint = 0x02;
pub const LM3533_REG_CTRLBANK_BCONF_ALS_CHANNEL_MASK: c_uint = 0x01;
pub const LM3533_LED_FLAG_PATTERN_ENABLE: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3533_led {
    pub lm3533: *mut lm3533,
    pub cb: lm3533_ctrlbank,
...
#[no_mangle]
pub unsafe extern "C" fn lm3533_led_get_ctrlbank_id(led: *mut lm3533_led) -> c_int {
    static inline int lm3533_led_get_ctrlbank_id(struct lm3533_led *led)
    {
    return led.id + 2;
    }
#[no_mangle]
pub unsafe extern "C" fn lm3533_led_get_lv_reg(led: *mut lm3533_led, base: u8) -> u8 {
    static inline u8 lm3533_led_get_lv_reg(struct lm3533_led *led, u8 base)
    {
    return base + led.id;
    }
#[no_mangle]
pub unsafe extern "C" fn lm3533_led_get_pattern(led: *mut lm3533_led) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn lm3533_led_pattern_enable(led: *mut lm3533_led, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_led_get(cdev: *mut led_classdev) -> enum led_brightness {
...
pub const LM3533_LED_DELAY1_VMIN: c_uint = 0x00;
pub const LM3533_LED_DELAY2_VMIN: c_uint = 0x3d;
pub const LM3533_LED_DELAY3_VMIN: c_uint = 0x80;

pub const LM3533_LED_DELAY3_VMAX: c_uint = 0xff;

// t_step = (t_max - t_min) / (v_max - v_min)
pub const LM3533_LED_DELAY1_TSTEP: c_int = 16384;
pub const LM3533_LED_DELAY2_TSTEP: c_int = 131072;
pub const LM3533_LED_DELAY3_TSTEP: c_int = 524288;
...
//
#[no_mangle]
unsafe extern "C" fn lm3533_led_get_hw_delay(delay: *mut unsigned) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn lm3533_led_delay_on_set(led: *mut lm3533_led, t: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_led_delay_off_set(led: *mut lm3533_led, t: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_led_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3533_led_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn lm3533_led_shutdown(pdev: *mut platform_device) {
