...
//! Source: drivers/leds/flash/leds-s2m-flash.c
#![no_std]
...
//
    pub lock: mutex,
    pub reg_enable: c_uint,
    pub channel: u8,
    pub flash_brightness: u8,
    pub flash_timeout: u8,
}
...
#[no_mangle]
unsafe extern "C" fn s2m_fled_flash_brightness_set(fled: *mut led_classdev_flash, brightness: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2m_fled_flash_timeout_set(fled: *mut led_classdev_flash, timeout: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2m_fled_flash_external_strobe_set(v4l2_flash: *mut v4l2_flash, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2m_fled_v4l2_flash_release(v4l2_flash: *mut c_void) {
    static void s2m_fled_v4l2_flash_release(void *v4l2_flash)
    {
    v4l2_flash_release(v4l2_flash);
    }
#[no_mangle]
unsafe extern "C" fn s2mu005_fled_torch_brightness_set(cdev: *mut led_classdev, value: enum led_brightness) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2mu005_fled_flash_strobe_set(fled: *mut led_classdev_flash, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2mu005_fled_flash_strobe_get(fled: *mut led_classdev_flash, state: *mut bool) -> c_int {
...
// Enable the LED channels.
    ...
    let mut v4l2_cfg: v4l2_flash_config = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn s2m_fled_probe(pdev: *mut platform_device) -> c_int {
