...
//! Source: drivers/leds/flash/leds-qcom-flash.c
#![no_std]
...
pub const FLASH_REVISION_REG: c_uint = 0x00;
pub const FLASH_4CH_REVISION_V0P1: c_uint = 0x01;
pub const FLASH_TYPE_REG: c_uint = 0x04;
pub const FLASH_TYPE_VAL: c_uint = 0x18;
pub const FLASH_SUBTYPE_REG: c_uint = 0x05;
pub const FLASH_SUBTYPE_3CH_PM8150_VAL: c_uint = 0x04;
pub const FLASH_SUBTYPE_3CH_PMI8998_VAL: c_uint = 0x03;
pub const FLASH_SUBTYPE_4CH_VAL: c_uint = 0x07;

pub const FLASH_TIMER_STEP_MS: c_int = 10;

pub const SW_STROBE_VAL: c_int = 0;
pub const HW_STROBE_VAL: c_int = 1;

pub const STROBE_LEVEL_TRIGGER_VAL: c_int = 0;
pub const STROBE_EDGE_TRIGGER_VAL: c_int = 1;

pub const STROBE_ACTIVE_HIGH_VAL: c_int = 1;

pub const FLASH_IRES_12P5MA_VAL: c_int = 0;
pub const FLASH_IRES_5MA_VAL_4CH: c_int = 1;
pub const FLASH_IRES_5MA_VAL_3CH: c_int = 3;
// constants
pub const FLASH_CURRENT_MAX_UA: c_int = 1500000;
pub const TORCH_CURRENT_MAX_UA: c_int = 500000;
pub const FLASH_TOTAL_CURRENT_MAX_UA: c_int = 2000000;
pub const FLASH_CURRENT_DEFAULT_UA: c_int = 1000000;
pub const TORCH_CURRENT_DEFAULT_UA: c_int = 200000;
pub const TORCH_IRES_UA: c_int = 5000;
pub const FLASH_IRES_UA: c_int = 12500;
pub const FLASH_TIMEOUT_MAX_US: c_int = 1280000;
pub const FLASH_TIMEOUT_STEP_US: c_int = 10000;
pub const UA_PER_MA: c_int = 1000;
// thermal threshold constants
pub const OTST_3CH_MIN_VAL: c_int = 3;
pub const OTST1_4CH_MIN_VAL: c_int = 0;
pub const OTST1_4CH_V0P1_MIN_VAL: c_int = 3;
pub const OTST2_4CH_MIN_VAL: c_int = 0;
pub const OTST1_MAX_CURRENT_MA: c_int = 1000;
pub const OTST2_MAX_CURRENT_MA: c_int = 500;
pub const OTST3_MAX_CURRENT_MA: c_int = 200;
    enum hw_type {
    QCOM_MVFLASH_3CH,
    QCOM_MVFLASH_4CH,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_flash_data {
    pub v4l2_flash: *mut v4l2_flash,
    pub r_fields: [*mut regmap_field; REG_MAX_COUNT],
    pub lock: mutex,
    pub hw_type: enum hw_type,
    pub total_ma: u32,
    pub leds_count: u8,
    pub max_channels: u8,
    pub chan_en_bits: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_flash_led {
    pub flash_data: *mut qcom_flash_data,
    pub flash: led_classdev_flash,
    pub max_flash_current_ma: u32,
    pub max_torch_current_ma: u32,
    pub max_timeout_ms: u32,
    pub flash_current_ma: u32,
    pub flash_timeout_ms: u32,
    pub current_in_use_ma: u32,
    pub chan_id: *mut u8,
    pub chan_count: u8,
    pub enabled: bool,
}
...
#[no_mangle]
unsafe extern "C" fn set_flash_module_en(led: *mut qcom_flash_led, en: bool) -> c_int {
    static int set_flash_module_en(struct qcom_flash_led *led, bool en)
    {
    struct qcom_flash_data *flash_data = led.flash_data;
    let mut led_mask: u8 = 0, enable;
    int i, rc;
...
#[no_mangle]
unsafe extern "C" fn update_allowed_flash_current(led: *mut qcom_flash_led, current_ma: *mut u32, strobe: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(FLASH_STS_3CH_OTST2: sts &) -> else {
    else if (sts & FLASH_STS_3CH_OTST2)
    therm_ma = OTST2_MAX_CURRENT_MA;
#[no_mangle]
pub unsafe extern "C" fn if(FLASH_STS_3CH_OTST1: sts &) -> else {
    ...
    therm_ma = OTST2_MAX_CURRENT_MA;
#[no_mangle]
pub unsafe extern "C" fn if(FLASH_STS_4CH_OTST1: sts &) -> else {
...
#[no_mangle]
unsafe extern "C" fn set_flash_current(led: *mut qcom_flash_led, current_ma: u32, mode: enum led_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_flash_timeout(led: *mut qcom_flash_led, timeout_ms: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_flash_strobe(led: *mut qcom_flash_led, strobe: enum led_strobe, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_flash_brightness_set(fled_cdev: *mut led_classdev_flash, brightness: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_flash_timeout_set(fled_cdev: *mut led_classdev_flash, timeout: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_flash_strobe_set(fled_cdev: *mut led_classdev_flash, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_flash_strobe_get(fled_cdev: *mut led_classdev_flash, state: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_flash_fault_get(fled_cdev: *mut led_classdev_flash, fault: *mut u32) -> c_int {
    static int qcom_flash_fault_get(struct led_classdev_flash *fled_cdev, u32 *fault)
    {
    struct qcom_flash_led *led = flcdev_to_qcom_fled(fled_cdev);
    struct qcom_flash_data *flash_data = led.flash_data;
    u8 shift, chan_id, chan_mask = 0;
    let mut ot_mask: u8 = 0, oc_mask = 0, uv_mask = 0;
    u32 val, fault_sts = 0;
    int i, rc;
...
// fault = fault_sts;
    ...
    struct qcom_flash_led *led = flcdev_to_qcom_fled(fled_cdev);
    let mut current_ma: u32 = brightness * led.max_torch_current_ma / LED_FULL;
    let mut enable: bool = !!brightness;
    int rc;
    rc = set_flash_strobe(led, SW_STROBE, false);
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn qcom_flash_external_strobe_set(v4l2_flash: *mut v4l2_flash, enable: bool) -> c_int {
    ...
    struct led_classdev_flash *fled_cdev = v4l2_flash.fled_cdev;
    struct qcom_flash_led *led = flcdev_to_qcom_fled(fled_cdev);
    let mut current_ma: u32 = intensity / UA_PER_MA;
...
#[no_mangle]
unsafe extern "C" fn qcom_flash_led_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_flash_led_remove(pdev: *mut platform_device) {
