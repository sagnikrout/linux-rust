...
//! Source: drivers/leds/flash/leds-lm3601x.c
#![no_std]
...
pub const LM3601X_LED_IR: c_uint = 0x0;
pub const LM3601X_LED_TORCH: c_uint = 0x1;
// Registers
pub const LM3601X_ENABLE_REG: c_uint = 0x01;
pub const LM3601X_CFG_REG: c_uint = 0x02;
pub const LM3601X_LED_FLASH_REG: c_uint = 0x03;
pub const LM3601X_LED_TORCH_REG: c_uint = 0x04;
pub const LM3601X_FLAGS_REG: c_uint = 0x05;
pub const LM3601X_DEV_ID_REG: c_uint = 0x06;

// Enable Mode bits
pub const LM3601X_MODE_STANDBY: c_uint = 0x00;

// Flag Mask

pub const LM3601X_MAX_TORCH_I_UA: c_int = 376000;
pub const LM3601X_MIN_TORCH_I_UA: c_int = 2400;
pub const LM3601X_TORCH_REG_DIV: c_int = 2965;
pub const LM3601X_MAX_STROBE_I_UA: c_int = 1500000;
pub const LM3601X_MIN_STROBE_I_UA: c_int = 11000;
pub const LM3601X_STROBE_REG_DIV: c_int = 11800;
pub const LM3601X_TIMEOUT_MASK: c_uint = 0x1e;

pub const LM3601X_LOWER_STEP_US: c_int = 40000;
pub const LM3601X_UPPER_STEP_US: c_int = 200000;
pub const LM3601X_MIN_TIMEOUT_US: c_int = 40000;
pub const LM3601X_MAX_TIMEOUT_US: c_int = 1600000;
pub const LM3601X_TIMEOUT_XOVER_US: c_int = 400000;
    enum lm3601x_type {
    CHIP_LM36010 = 0,
    CHIP_LM36011,
    };
...
pub struct lm3601x_led {
    ...
    pub torch_current_max: u32,
    pub flash_current_max: u32,
...
#[no_mangle]
unsafe extern "C" fn lm3601x_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lm3601x_read_faults(led: *mut lm3601x_led) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3601x_strobe_get(fled_cdev: *mut led_classdev_flash, state: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3601x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3601x_remove(client: *mut i2c_client) {
