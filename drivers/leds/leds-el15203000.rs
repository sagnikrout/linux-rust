...
//! Source: drivers/leds/leds-el15203000.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct el15203000_led {
    pub ldev: led_classdev,
    pub priv: *mut el15203000,
    pub reg: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct el15203000 {
    pub dev: *mut device,
    pub lock: mutex,
    pub spi: *mut spi_device,
    pub delay: c_ulong,
    pub count: usize,
    pub __counted_by(count): el15203000_led leds[],
}

#[no_mangle]
unsafe extern "C" fn el15203000_cmd(led: *mut el15203000_led, brightness: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_bounce(pattern: *const led_pattern, len: u32, inv: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn el15203000_pattern_clear(ldev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn el15203000_probe_dt(priv: *mut el15203000) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn el15203000_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn el15203000_remove(spi: *mut spi_device) {
