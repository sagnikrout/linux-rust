...
//! Source: drivers/leds/led-triggers.c
#![no_std]
...
// we come here only if buf matches no trigger
    ...
    __printf(3, 4)
#[no_mangle]
unsafe extern "C" fn led_trigger_snprintf(buf: *mut c_char, size: isize, fmt: *const c_char, ...) -> c_int {
    ...
    va_start(args, fmt);
    if (size <= 0)
    i = vsnprintf(core::ptr::null_mut(), 0, fmt, args);
    else
...
//
    ...
    len = led_trigger_format(core::ptr::null_mut(), 0, led_cdev);
...
#[no_mangle]
pub unsafe extern "C" fn led_trigger_set(led_cdev: *mut led_classdev, trig: *mut led_trigger) -> c_int {
    int led_trigger_set(struct led_classdev *led_cdev, struct led_trigger *trig)
    {
    char *event = core::ptr::null_mut();
    char *envp[2];
    const char *name;
    int ret;
...
// ensure it's no longer visible on the led_cdevs list
    ...
    led_cdev.trigger = core::ptr::null_mut();
    led_cdev.trigger_data = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn led_trigger_remove(led_cdev: *mut led_classdev) {
...
#[no_mangle]
pub unsafe extern "C" fn led_trigger_set_default(led_cdev: *mut led_classdev) {
...
#[no_mangle]
pub unsafe extern "C" fn led_trigger_register(trig: *mut led_trigger) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn led_trigger_unregister(trig: *mut led_trigger) {
...
#[no_mangle]
unsafe extern "C" fn devm_led_trigger_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn led_trigger_register_simple(name: *const c_char, tp: *mut led_trigger) {
...
#[no_mangle]
pub unsafe extern "C" fn led_trigger_unregister_simple(trig: *mut led_trigger) {
