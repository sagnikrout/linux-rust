...
//! Source: drivers/leds/leds-aw200xx.c
#![no_std]
...
pub const AW200XX_IMAX_DEFAULT_uA: c_int = 60000;
pub const AW200XX_IMAX_MAX_uA: c_int = 160000;
pub const AW200XX_IMAX_MIN_uA: c_int = 3300;
// Page 0
pub const AW200XX_REG_PAGE0_BASE: c_uint = 0xc000;
// Select page register
pub const AW200XX_REG_PAGE: c_uint = 0xF0;

pub const AW200XX_PAGE_SHIFT: c_int = 0;
pub const AW200XX_NUM_PAGES: c_int = 6;
pub const AW200XX_PAGE_SIZE: c_int = 256;

    (AW200XX_REG_PAGE0_BASE + (page) * AW200XX_PAGE_SIZE + (reg))

    AW200XX_REG(AW200XX_NUM_PAGES - 1, AW200XX_PAGE_SIZE - 1)
pub const AW200XX_PAGE0: c_int = 0;
pub const AW200XX_PAGE1: c_int = 1;
pub const AW200XX_PAGE2: c_int = 2;
pub const AW200XX_PAGE3: c_int = 3;
pub const AW200XX_PAGE4: c_int = 4;
pub const AW200XX_PAGE5: c_int = 5;
// Chip ID register

pub const AW200XX_IDR_CHIPID: c_uint = 0x18;
// Sleep mode register

pub const AW200XX_SLPCR_ACTIVE: c_uint = 0x00;
// Reset register

pub const AW200XX_RSTR_RESET: c_uint = 0x01;
// Global current configuration register

// Fast clear display control register

pub const AW200XX_FCD_CLEAR: c_uint = 0x01;
// Display size configuration

pub const AW200XX_DSIZE_COLUMNS_MAX: c_int = 12;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aw200xx_chipdef {
    pub channels: u32,
    pub display_size_rows_max: u32,
    pub display_size_columns: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct aw200xx_led {
    pub cdev: led_classdev,
    pub chip: *mut aw200xx,
    pub dim: c_int,
    pub num: u32,
}
...
#[derive(Copy, Clone)]
pub struct aw200xx {
    pub cdef: *const aw200xx_chipdef,
    ...
    pub __counted_by(num_leds): aw200xx_led leds[],
}
    ...
    let mut columns: u32 = chip.cdef.display_size_columns;
    int dim;
    ssize_t ret;
...
//
    ...
    u32 led_imax_uA)
    {
    let mut duty: u32 = AW200XX_DUTY_RATIO(chip.display_rows);
// The output current of each LED (see p.14 of datasheet for formula)
    return (led_imax_uA * 1000U) / duty;
    }
pub const AW200XX_IMAX_MULTIPLIER1: c_int = 10000;
pub const AW200XX_IMAX_MULTIPLIER2: c_int = 3333;
pub const AW200XX_IMAX_BASE_VAL1: c_int = 0;
pub const AW200XX_IMAX_BASE_VAL2: c_int = 8;
//
...
//
    ...
    u32 led_imax_uA)
    {
    let mut g_imax_uA: u32 = aw200xx_imax_to_global(chip, led_imax_uA);
    static const u32 coeff_table[] = {1, 2, 3, 4, 6, 8, 12, 16};
    let mut gccr_imax: u32 = UINT_MAX;
    let mut cur_imax: u32 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn aw200xx_chip_reset(chip: *const *const aw200xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw200xx_chip_init(chip: *const *const aw200xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw200xx_chip_check(chip: *const *const aw200xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw200xx_enable(chip: *const *const aw200xx) {
...
#[no_mangle]
unsafe extern "C" fn aw200xx_disable(chip: *const *const aw200xx) {
...
#[no_mangle]
unsafe extern "C" fn aw200xx_probe_fw(dev: *mut device, chip: *mut aw200xx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aw200xx_chip_reset_action(data: *mut c_void) {
    static void aw200xx_chip_reset_action(void *data)
    {
    aw200xx_chip_reset(data);
    }
#[no_mangle]
unsafe extern "C" fn aw200xx_disable_action(data: *mut c_void) {
    static void aw200xx_disable_action(void *data)
    {
    aw200xx_disable(data);
    }
#[no_mangle]
unsafe extern "C" fn aw200xx_probe(client: *mut i2c_client) -> c_int {
