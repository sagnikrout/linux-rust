...
//! Source: drivers/leds/leds-ltc3220.c
#![no_std]
...
// LTC3220 Registers
pub const LTC3220_COMMAND_REG: c_uint = 0x00;

pub const LTC3220_GRAD_BLINK_REG: c_uint = 0x13;

pub const LTC3220_NUM_LEDS: c_int = 18;
pub const LTC3220_MAX_BRIGHTNESS: c_int = 63;
pub const LTC3220_GRADATION_RAMP_TIME_240MS: c_int = 240;
pub const LTC3220_GRADATION_RAMP_TIME_480MS: c_int = 480;
pub const LTC3220_BLINK_ON_156MS: c_int = 156;
pub const LTC3220_BLINK_ON_625MS: c_int = 625;
pub const LTC3220_BLINK_PERIOD_1250MS: c_int = 1250;
pub const LTC3220_BLINK_PERIOD_2500MS: c_int = 2500;
...
#[derive(Copy, Clone)]
pub struct ltc3220 {
    pub uled_cfg: [ltc3220_uled_cfg; LTC3220_NUM_LEDS],
...
#[no_mangle]
unsafe extern "C" fn ltc3220_get_led_data(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
pub unsafe extern "C" fn if(LTC3220_GRADATION_RAMP_TIME_240MS: pattern[0].delta_t <=) -> else {
    else if (pattern[0].delta_t <= LTC3220_GRADATION_RAMP_TIME_240MS)
    gradation_period = LTC3220_GRADATION_MODE_240MS_RAMP_TIME;
#[no_mangle]
pub unsafe extern "C" fn if(LTC3220_GRADATION_RAMP_TIME_480MS: pattern[0].delta_t <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn ltc3220_pattern_clear(led_cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc3220_reset_gpio_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ltc3220_reset(ltc3220: *mut ltc3220, client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc3220_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc3220_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc3220_probe(client: *mut i2c_client) -> c_int {
    static int ltc3220_probe(struct i2c_client *client)
    {
    struct ltc3220 *ltc3220;
    let mut aggregated_led_found: bool = false;
    let mut num_leds: c_int = 0;
