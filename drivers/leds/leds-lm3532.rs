...
//! Source: drivers/leds/leds-lm3532.c
#![no_std]
...
pub const LM3532_BL_MODE_MANUAL: c_uint = 0x00;
pub const LM3532_BL_MODE_ALS: c_uint = 0x01;
pub const LM3532_REG_OUTPUT_CFG: c_uint = 0x10;
pub const LM3532_REG_STARTSHUT_RAMP: c_uint = 0x11;
pub const LM3532_REG_RT_RAMP: c_uint = 0x12;
pub const LM3532_REG_PWM_A_CFG: c_uint = 0x13;
pub const LM3532_REG_PWM_B_CFG: c_uint = 0x14;
pub const LM3532_REG_PWM_C_CFG: c_uint = 0x15;
pub const LM3532_REG_ZONE_CFG_A: c_uint = 0x16;
pub const LM3532_REG_CTRL_A_FS_CURR: c_uint = 0x17;
pub const LM3532_REG_ZONE_CFG_B: c_uint = 0x18;
pub const LM3532_REG_CTRL_B_FS_CURR: c_uint = 0x19;
pub const LM3532_REG_ZONE_CFG_C: c_uint = 0x1a;
pub const LM3532_REG_CTRL_C_FS_CURR: c_uint = 0x1b;
pub const LM3532_REG_ENABLE: c_uint = 0x1d;
pub const LM3532_ALS_CONFIG: c_uint = 0x23;
pub const LM3532_REG_ZN_0_HI: c_uint = 0x60;
pub const LM3532_REG_ZN_0_LO: c_uint = 0x61;
pub const LM3532_REG_ZN_1_HI: c_uint = 0x62;
pub const LM3532_REG_ZN_1_LO: c_uint = 0x63;
pub const LM3532_REG_ZN_2_HI: c_uint = 0x64;
pub const LM3532_REG_ZN_2_LO: c_uint = 0x65;
pub const LM3532_REG_ZN_3_HI: c_uint = 0x66;
pub const LM3532_REG_ZN_3_LO: c_uint = 0x67;
pub const LM3532_REG_ZONE_TRGT_A: c_uint = 0x70;
pub const LM3532_REG_ZONE_TRGT_B: c_uint = 0x75;
pub const LM3532_REG_ZONE_TRGT_C: c_uint = 0x7a;
pub const LM3532_REG_MAX: c_uint = 0x7e;
// Control Enable

// PWM Zone Control
pub const LM3532_PWM_ZONE_MASK: c_uint = 0x7c;

// Brightness Configuration

pub const LM3532_ALS_CTRL: c_int = 0;

pub const LM3532_ZONE_0: c_int = 0;

pub const LM3532_ALS_SEL_SHIFT: c_int = 6;
// Zone Boundary Register
pub const LM3532_ALS_WINDOW_mV: c_int = 2000;
pub const LM3532_ALS_ZB_MAX: c_int = 4;
pub const LM3532_ALS_OFFSET_mV: c_int = 2;
pub const LM3532_CONTROL_A: c_int = 0;
pub const LM3532_CONTROL_B: c_int = 1;
pub const LM3532_CONTROL_C: c_int = 2;
pub const LM3532_MAX_CONTROL_BANKS: c_int = 3;
pub const LM3532_MAX_LED_STRINGS: c_int = 3;
pub const LM3532_OUTPUT_CFG_MASK: c_uint = 0x3;
pub const LM3532_BRT_VAL_ADJUST: c_int = 8;
pub const LM3532_RAMP_DOWN_SHIFT: c_int = 3;
pub const LM3532_NUM_RAMP_VALS: c_int = 8;
pub const LM3532_NUM_AVG_VALS: c_int = 8;
pub const LM3532_NUM_IMP_VALS: c_int = 32;
pub const LM3532_FS_CURR_MIN: c_int = 5000;
pub const LM3532_FS_CURR_MAX: c_int = 29800;
pub const LM3532_FS_CURR_STEP: c_int = 800;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3532_als_data {
    pub config: u8,
    pub als1_imp_sel: u8,
    pub als2_imp_sel: u8,
    pub als_avrg_time: u8,
    pub als_input_mode: u8,
    pub als_vmin: u32,
    pub als_vmax: u32,
    pub zones_lo: [u8; LM3532_ALS_ZB_MAX],
    pub zones_hi: [u8; LM3532_ALS_ZB_MAX],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm3532_led {
    pub led_dev: led_classdev,
    pub priv: *mut lm3532_data,
    pub control_bank: c_int,
    pub mode: c_int,
    pub ctrl_brt_pointer: c_int,
    pub num_leds: c_int,
    pub full_scale_current: c_int,
    pub enabled:1: c_uint,
    pub led_strings: [u32; LM3532_MAX_CONTROL_BANKS],
}
...
pub struct lm3532_data {
    ...
    pub dev: *mut device,
    pub lock: mutex,
    pub als_data: *mut lm3532_als_data,
    pub runtime_ramp_up: u32,
    pub runtime_ramp_down: u32,
    pub leds: [lm3532_led; ],
}
    ...
    1320, 1280, 1230, 1190};
#[no_mangle]
unsafe extern "C" fn lm3532_get_als_imp_index(als_imped: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3532_get_index(table[]: c_int, size: c_int, value: c_int) -> c_int {
...
// Find an approximate index by looking up the table
    ...
    1146880, 2293760};
#[no_mangle]
unsafe extern "C" fn lm3532_get_als_avg_index(avg_time: c_int) -> c_int {
    ...
    16384, 32768, 65536};
#[no_mangle]
unsafe extern "C" fn lm3532_get_ramp_index(ramp_time: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3532_led_enable(led_data: *mut lm3532_led) -> c_int {
    static int lm3532_led_enable(struct lm3532_led *led_data)
    {
    let mut ctrl_en_val: c_int = BIT(led_data.control_bank);
    int ret;
    if (led_data.enabled)
    return 0;
...
// Caller must take care of locking
#[no_mangle]
unsafe extern "C" fn lm3532_led_disable(led_data: *mut lm3532_led) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm3532_init_registers(led: *mut lm3532_led) -> c_int {
    static int lm3532_init_registers(struct lm3532_led *led)
    {
    struct lm3532_data *drvdata = led.priv;
    unsigned int runtime_ramp_val;
    let mut output_cfg_val: c_uint = 0;
    let mut output_cfg_shift: c_uint = 0;
    let mut output_cfg_mask: c_uint = 0;
...
//
    ...
    let mut zone_reg: c_int = LM3532_REG_ZN_0_HI;
    int ret;
    int i;
...
#[no_mangle]
unsafe extern "C" fn lm3532_parse_als(priv: *mut lm3532_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_set_low_action(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn lm3532_parse_node(priv: *mut lm3532_data) -> c_int {
    ...
    priv.enable_gpio = core::ptr::null_mut();
    if (priv.enable_gpio) {
...
#[no_mangle]
unsafe extern "C" fn lm3532_probe(client: *mut i2c_client) -> c_int {
