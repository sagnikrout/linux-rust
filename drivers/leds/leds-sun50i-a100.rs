...
//! Source: drivers/leds/leds-sun50i-a100.c
#![no_std]
...
pub const LEDC_CTRL_REG: c_uint = 0x0000;

pub const LEDC_T01_TIMING_CTRL_REG: c_uint = 0x0004;

pub const LEDC_RESET_TIMING_CTRL_REG: c_uint = 0x000c;

pub const LEDC_DATA_REG: c_uint = 0x0014;
pub const LEDC_DMA_CTRL_REG: c_uint = 0x0018;

pub const LEDC_INT_CTRL_REG: c_uint = 0x001c;

pub const LEDC_INT_STS_REG: c_uint = 0x0020;

pub const LEDC_MAX_LEDS: c_int = 1024;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun50i_a100_ledc_led {
    pub mc_cdev: led_classdev_mc,
    pub subled_info: [mc_subled; LEDC_CHANNELS_PER_LED],
    pub addr: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun50i_a100_ledc_timing {
    pub t0h_ns: u32,
    pub t0l_ns: u32,
    pub t1h_ns: u32,
    pub t1l_ns: u32,
...
pub struct sun50i_a100_ledc {
    ...
    pub pio_length: c_uint,
    pub pio_offset: c_uint,
    pub lock: spinlock_t,
    pub next_length: c_uint,
    pub xfer_active: bool,
    pub format: u32,
    pub timing: sun50i_a100_ledc_timing,
    pub max_addr: u32,
    pub num_leds: u32,
    pub __counted_by(num_leds): sun50i_a100_ledc_led leds[],
}

#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_dma_xfer(priv: *mut sun50i_a100_ledc, length: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_pio_xfer(priv: *mut sun50i_a100_ledc, fifo_used: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_start_xfer(priv: *mut sun50i_a100_ledc, length: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_set_format(priv: *mut sun50i_a100_ledc) {
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_set_timing(priv: *mut sun50i_a100_ledc) {
    ...
    let mut mod_freq: c_ulong = clk_get_rate(priv.mod_clk);
    u32 cycle_ns;
    u32 control;
    if (!mod_freq)
    return;
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_dma_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_probe(pdev: *mut platform_device) -> c_int {
    static int sun50i_a100_ledc_probe(struct platform_device *pdev)
    {
    let mut dma_cfg: dma_slave_config = {};
...
//
    ...
    priv.dma_chan = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sun50i_a100_ledc_remove(pdev: *mut platform_device) {
