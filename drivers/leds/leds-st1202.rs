...
//! Source: drivers/leds/leds-st1202.c
#![no_std]
...
pub const ST1202_CHAN_DISABLE_ALL: c_uint = 0x00;
pub const ST1202_CHAN_ENABLE_HIGH: c_uint = 0x03;
pub const ST1202_CHAN_ENABLE_LOW: c_uint = 0x02;
pub const ST1202_CONFIG_REG: c_uint = 0x04;
// PATS: Pattern sequence feature enable

// PATSR: Pattern sequence runs (self-clear when sequence is finished)

pub const ST1202_DEV_ENABLE: c_uint = 0x01;

pub const ST1202_DEVICE_ID: c_uint = 0x00;
pub const ST1202_ILED_REG0: c_uint = 0x09;
pub const ST1202_MAX_LEDS: c_int = 12;
pub const ST1202_MAX_PATTERNS: c_int = 8;

pub const ST1202_MILLIS_PATTERN_DUR_MIN: c_int = 22;
pub const ST1202_PATTERN_DUR: c_uint = 0x16;
pub const ST1202_PATTERN_PWM: c_uint = 0x1E;
pub const ST1202_PATTERN_PWM_FULL: c_uint = 0x0FFF;
pub const ST1202_PATTERN_REP: c_uint = 0x15;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st1202_led {
    pub fwnode: *mut fwnode_handle,
    pub led_cdev: led_classdev,
    pub chip: *mut st1202_chip,
    pub is_active: bool,
    pub led_num: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st1202_chip {
    pub client: *mut i2c_client,
    pub lock: mutex,
    pub leds: [st1202_led; ST1202_MAX_LEDS],
}
...
#[no_mangle]
unsafe extern "C" fn st1202_read_reg(chip: *mut st1202_chip, reg: c_int, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st1202_write_reg(chip: *mut st1202_chip, reg: c_int, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st1202_prescalar_to_miliseconds(value: c_uint) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn __st1202_channel_set(chip: *mut st1202_chip, led_num: c_int, active: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st1202_channel_set(chip: *mut st1202_chip, led_num: c_int, active: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st1202_brightness_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn st1202_led_set(ldev: *mut led_classdev, value: enum led_brightness) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st1202_led_pattern_clear(ldev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st1202_dt_init(chip: *mut st1202_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st1202_setup(chip: *mut st1202_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st1202_probe(client: *mut i2c_client) -> c_int {
