...
//! Source: drivers/leds/leds-is31fl32xx.c
#![no_std]
...
pub const IS31FL32XX_REG_NONE: c_uint = 0xFF;
// Software Shutdown bit in Shutdown Register
pub const IS31FL32XX_SHUTDOWN_SSD_ENABLE: c_int = 0;

// IS31FL3216 has a number of unique registers
pub const IS31FL3216_CONFIG_REG: c_uint = 0x00;
pub const IS31FL3216_LIGHTING_EFFECT_REG: c_uint = 0x03;
pub const IS31FL3216_CHANNEL_CONFIG_REG: c_uint = 0x04;
// Software Shutdown bit in 3216 Config Register

pub const IS31FL3216_CONFIG_SSD_DISABLE: c_int = 0;
pub const IS31FL32XX_PWM_FREQUENCY_22KHZ: c_uint = 0x01;
// Registers for IS31FL3293
pub const IS31FL3293_SHUTDOWN_REG: c_uint = 0x01;

pub const IS31FL3293_GCC_REG: c_uint = 0x03;
pub const IS31FL3293_GCC_LEVEL_MAX: c_uint = 0x3f;
pub const IS31FL3293_CL_REG: c_uint = 0x10;
pub const IS31FL3293_COLOR_UPDATE_REG: c_uint = 0x27;
pub const IS31FL3293_COLOR_UPDATE_MAGIC: c_uint = 0xc5;
pub const IS31FL3293_RESET_REG: c_uint = 0x3c;
pub const IS31FL3293_RESET_MAGIC: c_uint = 0xc5;
pub const IS31FL3293_MAX_MICROAMP: c_int = 20000;
    struct is31fl32xx_priv;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct is31fl32xx_led_data {
    pub cdev: led_classdev,
    pub /: *mut *mut u8 channel; / 1-based, max priv->cdef->channels,
    pub max_microamp: u32,
    pub priv: *mut is31fl32xx_priv,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct is31fl32xx_priv {
    pub cdef: *const is31fl32xx_chipdef,
    pub client: *mut i2c_client,
    pub num_leds: c_uint,
    pub leds: [is31fl32xx_led_data; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct is31fl32xx_chipdef {
    pub channels: u8,
    pub shutdown_reg: u8,
    pub pwm_update_reg: u8,
    pub pwm_update_value: u8,
    pub global_control_reg: u8,
    pub reset_reg: u8,
    pub output_frequency_setting_reg: u8,
    pub pwm_register_base: u8,
    pub pwm_registers_reversed: bool,
    pub led_control_register_base: u8,
    pub enable_bits_per_led_control_register: u8,
    pub brightness_steps: u16,
    pub priv): *mut *mut int (reset_func)(struct is31fl32xx_priv,
    pub enable): *mut *mut *mut int (sw_shutdown_func)(struct is31fl32xx_priv priv, bool,
}

#[no_mangle]
unsafe extern "C" fn is31fl32xx_write(priv: *mut is31fl32xx_priv, reg: u8, val: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn is31fl3216_reset(priv: *mut is31fl32xx_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn is31fl3293_reset(priv: *mut is31fl32xx_priv) -> c_int {
...
// Set the global current limit to maximum
    ...
    let mut current_level_reg: c_int = IS31FL3293_CL_REG + led_data.channel - 1;
    let mut microamp: c_int = max(led_data.max_microamp, IS31FL3293_MAX_MICROAMP);
    let mut current_level: c_int = (microamp * 0xff) / IS31FL3293_MAX_MICROAMP;
...
#[no_mangle]
unsafe extern "C" fn is31fl32xx_reset_regs(priv: *mut is31fl32xx_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is31fl32xx_init_regs(priv: *mut is31fl32xx_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is31fl32xx_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is31fl32xx_remove(client: *mut i2c_client) {
