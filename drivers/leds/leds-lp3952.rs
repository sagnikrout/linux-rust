...
//! Source: drivers/leds/leds-lp3952.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lp3952_register_write(client: *mut i2c_client, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3952_get_label(dev: *mut device, label: *const c_char, dest: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3952_register_led_classdev(priv: *mut lp3952_led_array) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3952_configure(priv: *mut lp3952_led_array) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3952_probe(client: *mut i2c_client) -> c_int {
    ...
    let mut err: c_int = PTR_ERR(priv.regmap);
