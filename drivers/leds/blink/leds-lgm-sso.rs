...
//! Source: drivers/leds/blink/leds-lgm-sso.c
#![no_std]
...
pub const LED_BLINK_H8_0: c_uint = 0x0;
pub const LED_BLINK_H8_1: c_uint = 0x4;

pub const SSO_CON0: c_uint = 0x2B0;

pub const SSO_CON1: c_uint = 0x2B4;

pub const SSO_CPU: c_uint = 0x2B8;
pub const SSO_CON2: c_uint = 0x2C4;
pub const SSO_CON3: c_uint = 0x2C8;
// Driver MACRO

pub const MAX_FREQ_RANK: c_int = 10;
pub const DEF_GPTC_CLK_RATE: c_int = 200000000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sso_led_desc {
    pub name: *const c_char,
    pub default_trigger: *const c_char,
    pub brightness: c_uint,
    pub blink_rate: c_uint,
    pub retain_state_suspended:1: c_uint,
    pub retain_state_shutdown:1: c_uint,
    pub panic_indicator:1: c_uint,
    pub hw_blink:1: c_uint,
    pub hw_trig:1: c_uint,
    pub blinking:1: c_uint,
    pub freq_idx: c_int,
    pub pin: u32,
}
...
pub struct sso_led {
    ...
    pub desc: sso_led_desc,
    pub priv: *mut sso_led_priv,
}
...
pub struct sso_gpio {
    pub chip: gpio_chip,
    pub shift_clk_freq: c_int,
    pub edge: c_int,
    pub freq: c_int,
    pub pins: u32,
    pub alloc_bitmap: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sso_led_priv {
    pub mmap: *mut regmap,
    pub dev: *mut device,
    pub pdev: *mut platform_device,
    pub clocks: [clk_bulk_data; 2],
    pub fpid_clkrate: u32,
    pub gptc_clkrate: u32,
    pub freq: [u32; MAX_FREQ_RANK],
    pub led_list: list_head,
    pub gpio: sso_gpio,
}

#[no_mangle]
unsafe extern "C" fn sso_get_blink_rate_idx(priv: *mut sso_led_priv, rate: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_led_pin_to_group(pin: u32) -> c_uint {
    static unsigned int sso_led_pin_to_group(u32 pin)
    {
    if (pin < LED_GRP0_PIN_MAX)
    return LED_GRP0_0_23;
#[no_mangle]
pub unsafe extern "C" fn if(LED_GRP1_PIN_MAX: pin <) -> else {
...
#[no_mangle]
unsafe extern "C" fn sso_led_get_freq_src(freq_idx: c_int) -> u32 {
    static u32 sso_led_get_freq_src(int freq_idx)
    {
    if (freq_idx < MAX_FPID_FREQ_RANK)
    return CLK_SRC_FPID;
#[no_mangle]
pub unsafe extern "C" fn if(MAX_GPTC_FREQ_RANK: freq_idx <) -> else {
...
#[no_mangle]
unsafe extern "C" fn sso_led_pin_blink_off(pin: u32, group: c_uint) -> u32 {
    static u32 sso_led_pin_blink_off(u32 pin, unsigned int group)
    {
    if (group == LED_GRP2_29_31)
    return pin - LED_GRP1_PIN_MAX;
#[no_mangle]
pub unsafe extern "C" fn if(LED_GRP1_24_28: group ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sso_led_freq_set(priv: *mut sso_led_priv, pin: u32, freq_idx: c_int) {
...
pub unsafe extern "C" fn if(LED_GRP1_24_28: group ==) -> else {
    ...
    val_freq = freq_idx - 1;
#[no_mangle]
pub unsafe extern "C" fn if(CLK_SRC_GPTC: freq_src ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sso_led_brightness_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn sso_led_hw_cfg(priv: *mut sso_led_priv, led: *mut sso_led) {
...
#[no_mangle]
unsafe extern "C" fn sso_init_freq(priv: *mut sso_led_priv) {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_request(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_free(chip: *mut gpio_chip, offset: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_get_dir(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_set(chip: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_gc_init(dev: *mut device, priv: *mut sso_led_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_get_freq_idx(freq: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_register_shift_clk(priv: *mut sso_led_priv) {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_freq_set(priv: *mut sso_led_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_gpio_hw_init(priv: *mut sso_led_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_led_shutdown(led: *mut sso_led) {
...
// clear HW control bit
    ...
    led.priv = priv;
    desc = &led.desc;
    led.gpiod = devm_fwnode_gpiod_get(dev, fwnode_child, core::ptr::null_mut(),
    GPIOD_ASIS, core::ptr::null_mut());
    if (IS_ERR(led.gpiod)) {
    ...
    if (desc.hw_trig) {
    desc.default_trigger = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sso_led_dt_parse(priv: *mut sso_led_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_probe_gpios(priv: *mut sso_led_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sso_clock_disable_unprepare(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn intel_sso_led_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_sso_led_remove(pdev: *mut platform_device) {
