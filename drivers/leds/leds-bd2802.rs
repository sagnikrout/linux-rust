...
//! Source: drivers/leds/leds-bd2802.c
#![no_std]
...
pub const BD2802_LED_OFFSET: c_uint = 0xa;
pub const BD2802_COLOR_OFFSET: c_uint = 0x3;
pub const BD2802_REG_CLKSETUP: c_uint = 0x00;
pub const BD2802_REG_CONTROL: c_uint = 0x01;
pub const BD2802_REG_HOURSETUP: c_uint = 0x02;
pub const BD2802_REG_CURRENT1SETUP: c_uint = 0x03;
pub const BD2802_REG_CURRENT2SETUP: c_uint = 0x04;
pub const BD2802_REG_WAVEPATTERN: c_uint = 0x05;
pub const BD2802_CURRENT_032: c_uint = 0x10 /* 3.2mA */;
pub const BD2802_CURRENT_000: c_uint = 0x00 /* 0.0mA */;
pub const BD2802_PATTERN_FULL: c_uint = 0x07;
pub const BD2802_PATTERN_HALF: c_uint = 0x03;
    enum led_ids {
    LED1,
    LED2,
    LED_NUM,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd2802_led {
    pub pdata: *mut bd2802_led_platform_data,
...
// are needed.
//
    pub cdev_led1r: led_classdev,
    pub cdev_led1g: led_classdev,
    pub cdev_led1b: led_classdev,
    pub cdev_led2r: led_classdev,
    pub cdev_led2g: led_classdev,
    pub cdev_led2b: led_classdev,
//
...
//
    pub adf_on: c_int,
    pub led_id: enum led_ids,
    pub color: enum led_colors,
    pub state: enum led_bits,
// General attributes of RGB LEDs
    pub wave_pattern: c_int,
    pub rgb_current: c_int,
}
...
#[no_mangle]
pub unsafe extern "C" fn bd2802_is_led_off(led: *mut bd2802_led, id: enum led_ids) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bd2802_is_all_off(led: *mut bd2802_led) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bd2802_get_base_offset(id: enum led_ids, color: enum led_colors) -> u8 {
...
// --------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn bd2802_write_byte(client: *mut i2c_client, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd2802_configure(led: *mut bd2802_led) {
...
#[no_mangle]
unsafe extern "C" fn bd2802_reset_cancel(led: *mut bd2802_led) {
...
#[no_mangle]
unsafe extern "C" fn bd2802_enable(led: *mut bd2802_led, id: enum led_ids) {
    static void bd2802_enable(struct bd2802_led *led, enum led_ids id)
    {
    let mut other_led: enum led_ids = (id == LED1) ? LED2 : LED1;
...
#[no_mangle]
unsafe extern "C" fn bd2802_enable_adv_conf(led: *mut bd2802_led) {
...
#[no_mangle]
unsafe extern "C" fn bd2802_disable_adv_conf(led: *mut bd2802_led) {
...
#[no_mangle]
pub unsafe extern "C" fn if(!strncmp(buf: led->adf_on &&, _arg: "off", _arg: 3)) -> else {
...
#[no_mangle]
unsafe extern "C" fn bd2802_register_led_classdev(led: *mut bd2802_led) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd2802_unregister_led_classdev(led: *mut bd2802_led) {
...
#[no_mangle]
unsafe extern "C" fn bd2802_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd2802_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn bd2802_restore_state(led: *mut bd2802_led) {
...
#[no_mangle]
unsafe extern "C" fn bd2802_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd2802_resume(dev: *mut device) -> c_int {
