...
//! Source: drivers/leds/leds-qnap-mcu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_register_err_led(dev: *mut device, mcu: *mut qnap_mcu, num_err_led: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_register_usb_led(dev: *mut device, mcu: *mut qnap_mcu) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qnap_mcu_status_led {
    pub cdev: led_classdev,
    pub red: *mut qnap_mcu_status_led,
    pub mode: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qnap_mcu_status {
    pub mcu: *mut qnap_mcu,
    pub red: qnap_mcu_status_led,
    pub green: qnap_mcu_status_led,
}
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_status_led_encode(status: *mut qnap_mcu_status) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_register_status_leds(dev: *mut device, mcu: *mut qnap_mcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnap_mcu_leds_probe(pdev: *mut platform_device) -> c_int {
