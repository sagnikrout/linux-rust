...
//! Source: drivers/leds/leds-lm355x.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lm355x_chip_data {
    pub dev: *mut device,
    pub type: enum lm355x_type,
    pub cdev_flash: led_classdev,
    pub cdev_torch: led_classdev,
    pub cdev_indicator: led_classdev,
    pub pdata: *mut lm355x_platform_data,
    pub regmap: *mut regmap,
    pub lock: mutex,
    pub last_flag: c_uint,
    pub regs: *mut lm355x_reg_data,
}
...
pub const INDIC_PATTERN_SIZE: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
...
// chip initialize
#[no_mangle]
unsafe extern "C" fn lm355x_chip_init(chip: *mut lm355x_chip_data) -> c_int {
...
// module initialize
#[no_mangle]
unsafe extern "C" fn lm355x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lm355x_remove(client: *mut i2c_client) {
