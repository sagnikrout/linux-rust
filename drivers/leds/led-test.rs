...
//! Source: drivers/leds/led-test.c
#![no_std]
...
pub const LED_TEST_POST_REG_BRIGHTNESS: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct led_test_ddata {
    pub cdev: led_classdev,
    pub dev: *mut device,
}

#[no_mangle]
unsafe extern "C" fn led_test_brightness_get(cdev: *mut led_classdev) -> enum led_brightness {
    static enum led_brightness led_test_brightness_get(struct led_classdev *cdev)
    {
    return LED_TEST_POST_REG_BRIGHTNESS;
    }
#[no_mangle]
unsafe extern "C" fn led_test_class_register(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn led_test_class_add_lookup_and_get(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn led_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn led_test_exit(test: *mut kunit) {
