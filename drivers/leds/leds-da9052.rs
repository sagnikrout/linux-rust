...
//! Source: drivers/leds/leds-da9052.c
#![no_std]
...
pub const DA9052_OPENDRAIN_OUTPUT: c_int = 2;

pub const DA9052_MASK_UPPER_NIBBLE: c_uint = 0xF0;
pub const DA9052_MASK_LOWER_NIBBLE: c_uint = 0x0F;
pub const DA9052_NIBBLE_SHIFT: c_int = 4;
pub const DA9052_MAX_BRIGHTNESS: c_uint = 0x5f;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9052_led {
    pub cdev: led_classdev,
    pub da9052: *mut da9052,
    pub led_index: c_uchar,
    pub id: c_uchar,
}
...
#[no_mangle]
unsafe extern "C" fn da9052_configure_leds(da9052: *mut da9052) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_led_probe(pdev: *mut platform_device) -> c_int {
    static int da9052_led_probe(struct platform_device *pdev)
    {
    struct da9052_pdata *pdata;
    struct da9052 *da9052;
    struct led_platform_data *pled;
    struct da9052_led *led = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn da9052_led_remove(pdev: *mut platform_device) {
