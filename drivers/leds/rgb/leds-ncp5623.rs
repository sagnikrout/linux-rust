...
//! Source: drivers/leds/rgb/leds-ncp5623.c
#![no_std]
...
pub const NCP5623_FUNCTION_OFFSET: c_uint = 0x5;

pub const NCP5623_MAX_BRIGHTNESS: c_uint = 0x1f;
pub const NCP5623_MAX_DIM_TIME_MS: c_int = 240;
pub const NCP5623_DIM_STEP_MS: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ncp5623 {
    pub client: *mut i2c_client,
    pub mc_dev: led_classdev_mc,
    pub lock: mutex,
...
#[no_mangle]
unsafe extern "C" fn ncp5623_write(client: *mut i2c_client, reg: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncp5623_pattern_clear(led_cdev: *mut led_classdev) -> c_int {
    static int ncp5623_pattern_clear(struct led_classdev *led_cdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ncp5623_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ncp5623_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn ncp5623_shutdown(client: *mut i2c_client) {
