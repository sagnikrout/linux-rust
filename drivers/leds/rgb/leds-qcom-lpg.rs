...
//! Source: drivers/leds/rgb/leds-qcom-lpg.c
#![no_std]
...
pub const LPG_SUBTYPE_REG: c_uint = 0x05;
pub const LPG_SUBTYPE_LPG: c_uint = 0x2;
pub const LPG_SUBTYPE_PWM: c_uint = 0xb;
pub const LPG_SUBTYPE_HI_RES_PWM: c_uint = 0xc;
pub const LPG_SUBTYPE_LPG_LITE: c_uint = 0x11;
pub const LPG_PATTERN_CONFIG_REG: c_uint = 0x40;
pub const LPG_SIZE_CLK_REG: c_uint = 0x41;

pub const LPG_PREDIV_CLK_REG: c_uint = 0x42;

pub const PWM_TYPE_CONFIG_REG: c_uint = 0x43;
pub const PWM_VALUE_REG: c_uint = 0x44;
pub const PWM_ENABLE_CONTROL_REG: c_uint = 0x46;
pub const PWM_SYNC_REG: c_uint = 0x47;
pub const LPG_RAMP_DURATION_REG: c_uint = 0x50;
pub const LPG_HI_PAUSE_REG: c_uint = 0x52;
pub const LPG_LO_PAUSE_REG: c_uint = 0x54;
pub const LPG_HI_IDX_REG: c_uint = 0x56;
pub const LPG_LO_IDX_REG: c_uint = 0x57;
pub const PWM_SEC_ACCESS_REG: c_uint = 0xd0;

pub const SDAM_REG_PBS_SEQ_EN: c_uint = 0x42;
pub const SDAM_PBS_TRIG_SET: c_uint = 0xe5;
pub const SDAM_PBS_TRIG_CLR: c_uint = 0xe6;
pub const TRI_LED_SRC_SEL: c_uint = 0x45;
pub const TRI_LED_EN_CTL: c_uint = 0x46;
pub const TRI_LED_ATC_CTL: c_uint = 0x47;

pub const RAMP_CONTROL_REG: c_uint = 0xc8;

pub const PPG_MAX_LED_BRIGHTNESS: c_int = 255;
pub const LPG_MAX_M: c_int = 7;
pub const LPG_MAX_PREDIV: c_int = 6;
pub const DEFAULT_TICK_DURATION_US: c_int = 7800;

pub const SDAM_MAX_DEVICES: c_int = 2;
// LPG common config settings for PPG
pub const SDAM_START_BASE: c_uint = 0x40;
pub const SDAM_REG_RAMP_STEP_DURATION: c_uint = 0x47;
pub const SDAM_LUT_SDAM_LUT_PATTERN_OFFSET: c_uint = 0x45;
pub const SDAM_LPG_SDAM_LUT_PATTERN_OFFSET: c_uint = 0x80;
// LPG per channel config settings for PPG
pub const SDAM_LUT_EN_OFFSET: c_uint = 0x0;
pub const SDAM_PATTERN_CONFIG_OFFSET: c_uint = 0x1;
pub const SDAM_END_INDEX_OFFSET: c_uint = 0x3;
pub const SDAM_START_INDEX_OFFSET: c_uint = 0x4;
pub const SDAM_PBS_SCRATCH_LUT_COUNTER_OFFSET: c_uint = 0x6;
pub const SDAM_PAUSE_HI_MULTIPLIER_OFFSET: c_uint = 0x8;
pub const SDAM_PAUSE_LO_MULTIPLIER_OFFSET: c_uint = 0x9;
    struct lpg_data;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpg_channel {
    pub lpg: *mut lpg,
    pub base: u32,
    pub triled_mask: c_uint,
    pub lut_mask: c_uint,
    pub subtype: c_uint,
    pub sdam_offset: u32,
    pub in_use: bool,
    ...
    pub period: u64,
    pub clk_sel: c_uint,
    pub pre_div_sel: c_uint,
    pub pre_div_exp: c_uint,
    pub pwm_resolution_sel: c_uint,
    pub ramp_enabled: bool,
    pub ramp_ping_pong: bool,
    pub ramp_oneshot: bool,
    pub ramp_reverse: bool,
    pub ramp_tick_ms: c_ushort,
    pub ramp_lo_pause_ms: c_ulong,
    pub ramp_hi_pause_ms: c_ulong,
    pub pattern_lo_idx: c_uint,
    pub pattern_hi_idx: c_uint,
}
...
pub struct lpg_led {
    ...
    pub __counted_by(num_channels): *mut *mut lpg_channel channels[],
}
...
pub struct lpg {
    ...
    pub map: *mut regmap,
    pub lock: mutex,
    pub pwm: *mut pwm_chip,
    pub data: *const lpg_data,
    pub lut_base: u32,
    pub lut_size: u32,
    pub lut_bitmap: *mut c_ulong,
    pub pbs_dev: *mut pbs_dev,
    pub lpg_chan_sdam: *mut nvmem_device,
    pub lut_sdam: *mut nvmem_device,
    pub pbs_en_bitmap: c_ulong,
    pub triled_base: u32,
    pub triled_src: u32,
    pub triled_has_atc_ctl: bool,
    pub triled_has_src_sel: bool,
    pub num_channels: c_uint,
    pub __counted_by(num_channels): lpg_channel channels[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpg_channel_data {
    pub sdam_offset: c_uint,
    pub base: c_uint,
    pub triled_mask: u8,
}
...
pub struct lpg_data {
    pub lut_base: c_uint,
    pub lut_size: c_uint,
    pub triled_base: c_uint,
    pub triled_has_atc_ctl: bool,
    pub triled_has_src_sel: bool,
    pub num_channels: c_int,
    pub channels: *const lpg_channel_data,
}

#[no_mangle]
unsafe extern "C" fn lpg_clear_pbs_trigger(lpg: *mut lpg, lut_mask: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_set_pbs_trigger(lpg: *mut lpg, lut_mask: c_uint) -> c_int {
    static int lpg_set_pbs_trigger(struct lpg *lpg, unsigned int lut_mask)
    {
    let mut val: u8 = PBS_SW_TRIG_BIT;
    int rc;
    if (!lpg.lpg_chan_sdam)
    return 0;
    if (!lpg.pbs_en_bitmap) {
...
#[no_mangle]
unsafe extern "C" fn lpg_sdam_configure_triggers(chan: *mut lpg_channel, set_trig: u8) -> c_int {
    static int lpg_sdam_configure_triggers(struct lpg_channel *chan, u8 set_trig)
    {
    let mut addr: u32 = SDAM_LUT_EN_OFFSET + chan.sdam_offset;
    if (!chan.lpg.lpg_chan_sdam)
    return 0;
    return nvmem_device_write(chan.lpg.lpg_chan_sdam, addr, 1, &set_trig);
    }
#[no_mangle]
unsafe extern "C" fn triled_set(lpg: *mut lpg, mask: c_uint, enable: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_lut_free(lpg: *mut lpg, lo_idx: c_uint, hi_idx: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn lpg_lut_sync(lpg: *mut lpg, mask: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_calc_freq(chan: *mut lpg_channel, period: u64) -> c_int {
...
//
    ...
    let mut numerator: u64 = period * clk_rate_arr[clk_sel];
...
#[no_mangle]
unsafe extern "C" fn lpg_calc_duty(chan: *mut lpg_channel, duty: u64) {
...
#[no_mangle]
unsafe extern "C" fn lpg_apply_freq(chan: *mut lpg_channel) {
...
#[no_mangle]
unsafe extern "C" fn lpg_enable_glitch(chan: *mut lpg_channel) {
...
#[no_mangle]
unsafe extern "C" fn lpg_disable_glitch(chan: *mut lpg_channel) {
...
#[no_mangle]
unsafe extern "C" fn lpg_apply_pwm_value(chan: *mut lpg_channel) {
    static void lpg_apply_pwm_value(struct lpg_channel *chan)
    {
    struct lpg *lpg = chan.lpg;
    let mut val: u16 = chan.pwm_value;
    if (!chan.enabled)
    return;
...
#[no_mangle]
unsafe extern "C" fn lpg_sdam_apply_lut_control(chan: *mut lpg_channel) {
    static void lpg_sdam_apply_lut_control(struct lpg_channel *chan)
    {
    struct nvmem_device *lpg_chan_sdam = chan.lpg.lpg_chan_sdam;
    let mut lo_idx: c_uint = chan.pattern_lo_idx;
    let mut hi_idx: c_uint = chan.pattern_hi_idx;
    let mut val: u8 = 0, conf = 0, lut_offset = 0;
...
#[no_mangle]
unsafe extern "C" fn lpg_apply_lut_control(chan: *mut lpg_channel) {
    ...
    let mut lo_idx: c_uint = chan.pattern_lo_idx;
    let mut hi_idx: c_uint = chan.pattern_hi_idx;
    let mut step: u16 = chan.ramp_tick_ms;
    if (!chan.ramp_enabled || chan.pattern_lo_idx == chan.pattern_hi_idx)
    return;
...
#[no_mangle]
unsafe extern "C" fn lpg_apply_control(chan: *mut lpg_channel) {
...
#[no_mangle]
unsafe extern "C" fn lpg_apply_sync(chan: *mut lpg_channel) {
...
#[no_mangle]
unsafe extern "C" fn lpg_parse_dtest(lpg: *mut lpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_apply_dtest(chan: *mut lpg_channel) {
...
#[no_mangle]
unsafe extern "C" fn lpg_apply(chan: *mut lpg_channel) {
    ...
    struct lpg_channel *chan;
    let mut triled_enabled: c_uint = 0;
    let mut triled_mask: c_uint = 0;
    let mut lut_mask: c_uint = 0;
    unsigned int duty;
...
// delay_off = div_u64(chan->period - duty, NSEC_PER_MSEC);
    ...
    let mut hi_pause: c_uint = 0;
    let mut lo_pause: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn lpg_pattern_clear(led: *mut lpg_led) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_pattern_single_clear(cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_pattern_mc_clear(cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_pwm_request(chip: *mut pwm_chip, pwm: *mut pwm_device) -> c_int {
...
//
    ...
    return ret;
    if (chan.subtype == LPG_SUBTYPE_HI_RES_PWM) {
    let mut clk_idx: c_uint = FIELD_GET(PWM_CLK_SELECT_HI_RES_MASK, val);
...
#[no_mangle]
unsafe extern "C" fn lpg_add_pwm(lpg: *mut lpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_add_led(lpg: *mut lpg, np: *mut device_node) -> c_int {
...
// Register pattern accessors if we have a LUT block or when using PPG
    ...
    cdev.default_trigger = of_get_property(np, "linux,default-trigger", core::ptr::null_mut());
    if (lpg.lpg_chan_sdam)
...
#[no_mangle]
unsafe extern "C" fn lpg_init_channels(lpg: *mut lpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_init_triled(lpg: *mut lpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_init_lut(lpg: *mut lpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_init_sdam(lpg: *mut lpg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpg_probe(pdev: *mut platform_device) -> c_int {
    ...
    lpg.dev = &pdev.dev;
    mutex_init(&lpg.lock);
    lpg.map = dev_get_regmap(pdev.dev.parent, core::ptr::null_mut());
    if (!lpg.map)
