...
//! Source: drivers/leds/rgb/leds-pwm-multicolor.c
#![no_std]
...
// iterate over the nodes inside the multi-led node
    ...
    pwmled.pwm = devm_fwnode_pwm_get(dev, fwnode, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn led_pwm_mc_probe(pdev: *mut platform_device) -> c_int {
