...
//! Source: drivers/leds/rgb/leds-mt6370-rgb.c
#![no_std]
...
pub const MT6370_REG_RGB1_DIM: c_uint = 0x182;
pub const MT6370_REG_RGB2_DIM: c_uint = 0x183;
pub const MT6370_REG_RGB3_DIM: c_uint = 0x184;
pub const MT6370_REG_RGB_EN: c_uint = 0x185;
pub const MT6370_REG_RGB1_ISNK: c_uint = 0x186;
pub const MT6370_REG_RGB2_ISNK: c_uint = 0x187;
pub const MT6370_REG_RGB3_ISNK: c_uint = 0x188;
pub const MT6370_REG_RGB1_TR: c_uint = 0x189;
pub const MT6370_REG_RGB_CHRIND_DIM: c_uint = 0x192;
pub const MT6370_REG_RGB_CHRIND_CTRL: c_uint = 0x193;
pub const MT6370_REG_RGB_CHRIND_TR: c_uint = 0x194;
pub const MT6372_REG_RGB_EN: c_uint = 0x182;
pub const MT6372_REG_RGB1_ISNK: c_uint = 0x183;
pub const MT6372_REG_RGB2_ISNK: c_uint = 0x184;
pub const MT6372_REG_RGB3_ISNK: c_uint = 0x185;
pub const MT6372_REG_RGB4_ISNK: c_uint = 0x186;
pub const MT6372_REG_RGB1_DIM: c_uint = 0x187;
pub const MT6372_REG_RGB2_DIM: c_uint = 0x188;
pub const MT6372_REG_RGB3_DIM: c_uint = 0x189;
pub const MT6372_REG_RGB4_DIM: c_uint = 0x18A;
pub const MT6372_REG_RGB12_FREQ: c_uint = 0x18B;
pub const MT6372_REG_RGB34_FREQ: c_uint = 0x18C;
pub const MT6372_REG_RGB1_TR: c_uint = 0x18D;

pub const MT6372_VENDOR_ID: c_uint = 0x9;
pub const MT6372C_VENDOR_ID: c_uint = 0xb;

pub const MT6370_VIRTUAL_MULTICOLOR: c_int = 5;
pub const MC_CHANNEL_NUM: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6370_pdata {
    pub tfreq: *const c_uint,
    pub tfreq_len: c_uint,
    pub reg_rgb1_tr: u16,
    pub reg_rgb_chrind_tr: i16,
    pub pwm_duty: u8,
}
...
// Per LED access lock
    ...
    pub ranges: *const linear_range,
    pub pdata: *const mt6370_pdata,
...
#[no_mangle]
unsafe extern "C" fn mt6370_get_led_current_field(led_no: c_uint) -> enum mt6370_led_field {
    ...
    const struct mt6370_pdata *pdata = priv.pdata;
    enum mt6370_led_field sel_field;
    let mut tfreq_len: c_uint = pdata.tfreq_len;
...
#[no_mangle]
unsafe extern "C" fn mt6370_mc_brightness_set(lcdev: *mut led_classdev, level: enum led_brightness) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt6370_mc_pattern_clear(lcdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt6370_isnk_pattern_clear(lcdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_isnk_init_default_state(led: *mut mt6370_led) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_leds_probe(pdev: *mut platform_device) -> c_int {
