...
//! Source: drivers/leds/leds-mc13783.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mc13xxx_led_devtype {
    pub led_min: c_int,
    pub led_max: c_int,
    pub num_regs: c_int,
    pub ledctrl_base: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mc13xxx_led {
    pub cdev: led_classdev,
    pub id: c_int,
    pub leds: *mut mc13xxx_leds,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mc13xxx_leds {
    pub master: *mut mc13xxx,
    pub devtype: *mut mc13xxx_led_devtype,
    pub num_leds: c_int,
    pub led: *mut mc13xxx_led,
}

#[no_mangle]
unsafe extern "C" fn mc13xxx_max_brightness(id: c_int) -> c_uint {
    static unsigned int mc13xxx_max_brightness(int id)
    {
    if (id >= MC13783_LED_MD && id <= MC13783_LED_KP)
    return 0x0f;
#[no_mangle]
pub unsafe extern "C" fn if(MC13783_LED_B3: id >= MC13783_LED_R1 && id <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_led_probe(pdev: *mut platform_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_led_remove(pdev: *mut platform_device) {
