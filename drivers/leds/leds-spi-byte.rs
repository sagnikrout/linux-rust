...
//! Source: drivers/leds/leds-spi-byte.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn spi_byte_probe(spi: *mut spi_device) -> c_int {
    static int spi_byte_probe(struct spi_device *spi)
    {
    struct fwnode_handle *child __free(fwnode_handle) = core::ptr::null_mut();
