...
//! Source: drivers/leds/trigger/ledtrig-activity.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn led_activity_function(t: *mut timer_list) {
...
//
    ...
    usage = 0;
#[no_mangle]
pub unsafe extern "C" fn if(diff_boot: diff_used >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn activity_activate(led_cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn activity_deactivate(led_cdev: *mut led_classdev) {
...
#[no_mangle]
unsafe extern "C" fn activity_init() -> int __init {
    static int __init activity_init(void)
    {
    let mut rc: c_int = led_trigger_register(&activity_led_trigger);
    if (!rc) {
...
#[no_mangle]
unsafe extern "C" fn activity_exit() -> void __exit {
