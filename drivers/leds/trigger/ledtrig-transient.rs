...
//! Source: drivers/leds/trigger/ledtrig-transient.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct transient_trig_data {
    pub activate: c_int,
    pub state: c_int,
    pub restore_state: c_int,
...
#[no_mangle]
unsafe extern "C" fn transient_timer_function(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn transient_trig_activate(led_cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn transient_trig_deactivate(led_cdev: *mut led_classdev) {
