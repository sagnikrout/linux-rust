...
//! Source: drivers/leds/trigger/ledtrig-pattern.c
#![no_std]
...
pub const MAX_PATTERNS: c_int = 1024;
//
// When doing gradual dimming, the led brightness will be updated
// every 50 milliseconds.
//
pub const UPDATE_INTERVAL: c_int = 50;
    enum pattern_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pattern_trig_data {
    pub led_cdev: *mut led_classdev,
    pub patterns: [led_pattern; MAX_PATTERNS],
    pub curr: *mut led_pattern,
    pub next: *mut led_pattern,
    pub lock: mutex,
    pub npatterns: u32,
    pub repeat: c_int,
    pub last_repeat: c_int,
    pub delta_t: c_int,
    pub is_indefinite: bool,
    pub type: enum pattern_type,
    pub timer: timer_list,
    pub hrtimer: hrtimer,
}

#[no_mangle]
unsafe extern "C" fn pattern_trig_update_patterns(data: *mut pattern_trig_data) {
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_compute_brightness(data: *mut pattern_trig_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_timer_start(data: *mut pattern_trig_data) {
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_timer_cancel(data: *mut pattern_trig_data) {
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_timer_common_function(data: *mut pattern_trig_data) {
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_timer_function(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_hrtimer_function(t: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_start_pattern(led_cdev: *mut led_classdev) -> c_int {
...
// -1 means repeat indefinitely
    ...
    {
    struct led_classdev *led_cdev = dev_get_drvdata(dev);
    return pattern_trig_store_patterns(led_cdev, buf, core::ptr::null_mut(), count,
    PATTERN_TYPE_SW);
    }
    ...
    return attr.mode;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_hr_pattern.attr: attr ==) -> else {
    else if (attr == &dev_attr_hr_pattern.attr)
    return attr.mode;
#[no_mangle]
pub unsafe extern "C" fn if(led_cdev->pattern_set: attr == &dev_attr_hw_pattern.attr &&) -> else {
...
unsafe extern "C" fn pattern_init(led_cdev: *mut led_classdev) {
    ...
    err = pattern_trig_store_patterns(led_cdev, core::ptr::null_mut(), pattern, size,
    PATTERN_TYPE_SW);
    if (err < 0)
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_activate(led_cdev: *mut led_classdev) -> c_int {
    ...
    led_cdev.pattern_set = core::ptr::null_mut();
    led_cdev.pattern_clear = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_deactivate(led_cdev: *mut led_classdev) {
...
#[no_mangle]
unsafe extern "C" fn pattern_trig_init() -> int __init {
    static int __init pattern_trig_init(void)
    {
    return led_trigger_register(&pattern_led_trigger);
    }
#[no_mangle]
unsafe extern "C" fn pattern_trig_exit() -> void __exit {
