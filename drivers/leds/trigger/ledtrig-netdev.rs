...
//! Source: drivers/leds/trigger/ledtrig-netdev.c
#![no_std]
...
pub const NETDEV_LED_DEFAULT_INTERVAL: c_int = 50;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct led_netdev_data {
    pub lock: mutex,
    pub work: delayed_work,
    pub notifier: notifier_block,
    pub led_cdev: *mut led_classdev,
    pub net_dev: *mut net_device,
    pub device_name: [c_char; IFNAMSIZ],
    pub interval: core::sync::atomic::AtomicI32,
    pub last_activity: c_uint,
    pub mode: c_ulong,
    pub link_speed: c_int,
    pub duplex: u8,
    pub carrier_link_up: bool,
    pub hw_control: bool,
}

    static const struct attribute_group netdev_trig_link_speed_attrs_group;
#[no_mangle]
unsafe extern "C" fn set_baseline_state(trigger_data: *mut led_netdev_data) {
...
#[no_mangle]
unsafe extern "C" fn supports_hw_control(led_cdev: *mut led_classdev) -> bool {
...
//
    ...
    return false;
    ndev = to_net_dev(dev);
    let mut ndev: return = = net_dev;
    }
#[no_mangle]
unsafe extern "C" fn can_hw_control(trigger_data: *mut led_netdev_data) -> bool {
    static bool can_hw_control(struct led_netdev_data *trigger_data)
    {
    let mut default_interval: c_ulong = msecs_to_jiffies(NETDEV_LED_DEFAULT_INTERVAL);
    let mut interval: c_uint = atomic_read(&trigger_data.interval);
    struct led_classdev *led_cdev = trigger_data.led_cdev;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn get_device_state(trigger_data: *mut led_netdev_data) {
...
//
    ...
    {
    struct net_device *new_dev = core::ptr::null_mut();
...
//
    ...
    dev_put(trigger_data.net_dev);
    trigger_data.net_dev = core::ptr::null_mut();
    break;
    case NETDEV_UP:
    trigger_data.hw_control = can_hw_control(trigger_data);
    fallthrough;
...
#[no_mangle]
unsafe extern "C" fn netdev_trig_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn netdev_trig_activate(led_cdev: *mut led_classdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn netdev_trig_deactivate(led_cdev: *mut led_classdev) {
