...
//! Source: drivers/fwctl/mlx5/main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mlx5ctl_alloc_uid(mcdev: *mut mlx5ctl_dev, cap: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5ctl_release_uid(mcdev: *mut mlx5ctl_dev, uid: u16) {
...
#[no_mangle]
unsafe extern "C" fn mlx5ctl_open_uctx(uctx: *mut fwctl_uctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5ctl_close_uctx(uctx: *mut fwctl_uctx) {
...
#[no_mangle]
unsafe extern "C" fn mlx5ctl_validate_rpc(in: *const c_void, scope: enum fwctl_rpc_scope) -> bool {
    static bool mlx5ctl_validate_rpc(const void *in, enum fwctl_rpc_scope scope)
    {
    let mut opcode: u16 = MLX5_GET(mbox_in_hdr, in, opcode);
    let mut op_mod: u16 = MLX5_GET(mbox_in_hdr, in, op_mod);
//
...
#[no_mangle]
unsafe extern "C" fn mlx5ctl_remove(adev: *mut auxiliary_device) {
