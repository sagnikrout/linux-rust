...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fwctl_ucmd {
    pub uctx: *mut fwctl_uctx,
...
#[no_mangle]
unsafe extern "C" fn ucmd_respond(ucmd: *mut fwctl_ucmd, cmd_len: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fwctl_cmd_info(ucmd: *mut fwctl_ucmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fwctl_cmd_rpc(ucmd: *mut fwctl_ucmd) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fwctl_ioctl_op {
    pub size: c_uint,
    pub min_size: c_uint,
    pub ioctl_num: c_uint,
    pub ucmd): *mut *mut int (execute)(struct fwctl_ucmd,
}
...
#[no_mangle]
unsafe extern "C" fn fwctl_fops_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fwctl_destroy_uctx(uctx: *mut fwctl_uctx) {
...
#[no_mangle]
unsafe extern "C" fn fwctl_fops_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fwctl_device_release(device: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fwctl_register(fwctl: *mut fwctl_device) -> c_int {
...
// not be valid.
//
    fwctl.ops = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_NS_GPL(fwctl_unregister, "FWCTL");
#[no_mangle]
unsafe extern "C" fn fwctl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fwctl_exit() -> void __exit {
