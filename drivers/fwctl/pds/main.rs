...
//! Source: drivers/fwctl/pds/main.c
#![no_std]
...
pub struct pdsfc_rpc_endpoint_info {
    ...
    pub /: *mut *mut mutex lock; / lock for endpoint info management,
}
...
#[no_mangle]
unsafe extern "C" fn pdsfc_open_uctx(uctx: *mut fwctl_uctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pdsfc_close_uctx(uctx: *mut fwctl_uctx) {
...
#[no_mangle]
unsafe extern "C" fn pdsfc_identify(pdsfc: *mut pdsfc_dev) -> c_int {
    static int pdsfc_identify(struct pdsfc_dev *pdsfc)
    {
    struct device *dev = &pdsfc.fwctl.dev;
    let mut comp: union pds_core_adminq_comp = {0};
...
#[no_mangle]
unsafe extern "C" fn pdsfc_free_endpoints(pdsfc: *mut pdsfc_dev) {
...
#[no_mangle]
unsafe extern "C" fn pdsfc_free_operations(pdsfc: *mut pdsfc_dev) {
...
#[no_mangle]
unsafe extern "C" fn pdsfc_init_endpoints(pdsfc: *mut pdsfc_dev) -> c_int {
...
// Translate FW command attribute to fwctl scope
    ...
    struct pdsfc_rpc_endpoint_info *ep_info = core::ptr::null_mut();
    struct device *dev = &pdsfc.fwctl.dev;
    u32 num_entries;
    int i;
...
// reject unsupported and/or out of scope commands
    ...
    let mut comp: union pds_core_adminq_comp = {0};
    let mut out_payload_dma_addr: dma_addr_t = 0;
    let mut in_payload_dma_addr: dma_addr_t = 0;
    struct fwctl_rpc_pds *rpc = in;
    union pds_core_adminq_cmd cmd;
    void *out_payload = core::ptr::null_mut();
    void *in_payload = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pdsfc_remove(adev: *mut auxiliary_device) {
