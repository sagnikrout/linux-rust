...
//! Source: drivers/i2c/busses/i2c-mt7621.c
#![no_std]
...
pub const REG_SM0CFG2_REG: c_uint = 0x28;
pub const REG_SM0CTL0_REG: c_uint = 0x40;
pub const REG_SM0CTL1_REG: c_uint = 0x44;
pub const REG_SM0D0_REG: c_uint = 0x50;
pub const REG_SM0D1_REG: c_uint = 0x54;
pub const REG_PINTEN_REG: c_uint = 0x5c;
pub const REG_PINTST_REG: c_uint = 0x60;
pub const REG_PINTCL_REG: c_uint = 0x64;
// REG_SM0CFG2_REG

// REG_SM0CTL0_REG

pub const SM0CTL0_CLK_DIV_MAX: c_uint = 0x7ff;
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_wait_idle(i2c: *mut mtk_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_reset(i2c: *mut mtk_i2c) {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_dump_reg(i2c: *mut mtk_i2c) {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_check_ack(i2c: *mut mtk_i2c, expected: u32) -> c_int {
    static int mtk_i2c_check_ack(struct mtk_i2c *i2c, u32 expected)
    {
    let mut ack: u32 = readl_relaxed(i2c.base + REG_SM0CTL1_REG);
    let mut ack_expected: u32 = (expected << 16) & SM0CTL1_ACK_MASK;
    return ((ack & ack_expected) == ack_expected) ? 0 : -ENXIO;
    }
#[no_mangle]
unsafe extern "C" fn mtk_i2c_start(i2c: *mut mtk_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_stop(i2c: *mut mtk_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_cmd(i2c: *mut mtk_i2c, cmd: u32, page_len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_func(a: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_init(i2c: *mut mtk_i2c) {
