...
//! Source: drivers/i2c/busses/i2c-ali15x3.c
#![no_std]
...
pub const SMBBA: c_uint = 0x014;
pub const SMBATPC: c_uint = 0x05B	/* used to unlock xxxBA registers */;
pub const SMBHSTCFG: c_uint = 0x0E0;
pub const SMBSLVC: c_uint = 0x0E1;
pub const SMBCLK: c_uint = 0x0E2;
pub const SMBREV: c_uint = 0x008;
// Other settings

pub const ALI15X3_SMB_IOSIZE: c_int = 32;
...
//
pub const ALI15X3_SMB_DEFAULTBASE: c_uint = 0xE800;
// ALI15X3 address lock bits
pub const ALI15X3_LOCK: c_uint = 0x06;
// ALI15X3 command constants
pub const ALI15X3_ABORT: c_uint = 0x02;
pub const ALI15X3_T_OUT: c_uint = 0x04;
pub const ALI15X3_QUICK: c_uint = 0x00;
pub const ALI15X3_BYTE: c_uint = 0x10;
pub const ALI15X3_BYTE_DATA: c_uint = 0x20;
pub const ALI15X3_WORD_DATA: c_uint = 0x30;
pub const ALI15X3_BLOCK_DATA: c_uint = 0x40;
pub const ALI15X3_BLOCK_CLR: c_uint = 0x80;
// ALI15X3 status register bits
pub const ALI15X3_STS_IDLE: c_uint = 0x04;
pub const ALI15X3_STS_BUSY: c_uint = 0x08;
pub const ALI15X3_STS_DONE: c_uint = 0x10;
pub const ALI15X3_STS_DEV: c_uint = 0x20	/* device error */;
pub const ALI15X3_STS_COLL: c_uint = 0x40	/* collision or no response */;
pub const ALI15X3_STS_TERM: c_uint = 0x80	/* terminated by abort */;
pub const ALI15X3_STS_ERR: c_uint = 0xE0	/* all the bad error bits */;
...
#[no_mangle]
unsafe extern "C" fn ali15x3_setup(ALI15X3_dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali15x3_transaction(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali15x3_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ali15x3_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali15x3_remove(dev: *mut pci_dev) {
