...
//! Source: drivers/i2c/busses/i2c-designware-common.c
#![no_std]
...
pub const DW_IC_DEFAULT_BUS_CAPACITANCE_pF: c_int = 100;
pub const DW_IC_ABORT_TIMEOUT_US: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn dw_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_reg_read_swab(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_reg_write_swab(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_reg_read_word(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_reg_write_word(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_dw_init_regmap(dev: *mut dw_i2c_dev) -> c_int {
...
// can fail.
//
    dev.map = devm_regmap_init(dev.dev, core::ptr::null_mut(), dev, &map_cfg);
    if (IS_ERR(dev.map)) {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_validate_speed(dev: *mut dw_i2c_dev) -> c_int {
...
pub const MSCC_ICPU_CFG_TWI_DELAY: c_uint = 0x0;

pub const MSCC_ICPU_CFG_TWI_SPIKE_FILTER: c_uint = 0x4;
#[no_mangle]
unsafe extern "C" fn mscc_twi_set_sda_hold_time(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_of_configure(device: *mut device) {
...
//
    ...
    {
    let mut buf: acpi_buffer = { ACPI_ALLOCATE_BUFFER };
    let mut handle: acpi_handle = ACPI_HANDLE(device);
    union acpi_object *obj;
    if (dmi_check_system(i2c_dw_no_acpi_params))
    return;
    if (ACPI_FAILURE(acpi_evaluate_object(handle, method, core::ptr::null_mut(), &buf)))
    return;
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_acpi_configure(device: *mut device) {
    static void i2c_dw_acpi_configure(struct device *device)
    {
    struct dw_i2c_dev *dev = dev_get_drvdata(device);
    struct i2c_timings *t = &dev.timings;
    let mut ss_ht: u32 = 0, fp_ht = 0, hs_ht = 0, fs_ht = 0;
//
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_acpi_round_bus_speed(device: *mut device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_configure_mode(dev: *mut dw_i2c_dev, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_write_timings(dev: *mut dw_i2c_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_set_mode(dev: *mut dw_i2c_dev, mode: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_init(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_adjust_bus_speed(dev: *mut dw_i2c_dev) {
    static void i2c_dw_adjust_bus_speed(struct dw_i2c_dev *dev)
    {
    let mut acpi_speed: u32 = i2c_dw_acpi_round_bus_speed(dev.dev);
    struct i2c_timings *t = &dev.timings;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(t->bus_freq_hz: acpi_speed ||) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_fw_parse_and_configure(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_read_scl_reg(dev: *mut dw_i2c_dev, reg: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_set_sda_hold(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __i2c_dw_disable(dev: *mut dw_i2c_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_clk_rate(dev: *mut dw_i2c_dev) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_prepare_clk(dev: *mut dw_i2c_dev, prepare: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_acquire_lock(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_release_lock(dev: *mut dw_i2c_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_wait_bus_not_busy(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_handle_tx_abort(dev: *mut dw_i2c_dev) -> c_int {
    int i2c_dw_handle_tx_abort(struct dw_i2c_dev *dev)
    {
    let mut abort_source: c_ulong = dev.abort_source;
    int i;
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_set_fifo_size(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_disable(dev: *mut dw_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_isr(this_irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_probe(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ACCESS_NO_IRQ_SUSPEND: dev->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_prepare(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_runtime_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_runtime_resume(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_resume(device: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(i2c_dw_runtime_suspend, i2c_dw_runtime_resume, core::ptr::null_mut())
    };
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_shutdown(dev: *mut dw_i2c_dev) {
