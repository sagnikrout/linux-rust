...
//! Source: drivers/i2c/busses/i2c-mlxbf.c
#![no_std]
...
pub const MLXBF_I2C_COALESCE_TYU_ADDR: c_uint = 0x02801300;
pub const MLXBF_I2C_COALESCE_TYU_SIZE: c_uint = 0x010;
pub const MLXBF_I2C_GPIO_TYU_ADDR: c_uint = 0x02802000;
pub const MLXBF_I2C_GPIO_TYU_SIZE: c_uint = 0x100;
pub const MLXBF_I2C_COREPLL_TYU_ADDR: c_uint = 0x02800358;
pub const MLXBF_I2C_COREPLL_TYU_SIZE: c_uint = 0x008;
pub const MLXBF_I2C_COREPLL_YU_ADDR: c_uint = 0x02800c30;
pub const MLXBF_I2C_COREPLL_YU_SIZE: c_uint = 0x00c;
pub const MLXBF_I2C_COREPLL_RSH_YU_ADDR: c_uint = 0x13409824;
pub const MLXBF_I2C_COREPLL_RSH_YU_SIZE: c_uint = 0x00c;
pub const MLXBF_I2C_SHARED_RES_MAX: c_int = 3;
//
...
// PLL registers.
pub const MLXBF_I2C_CORE_PLL_REG1: c_uint = 0x4;
pub const MLXBF_I2C_CORE_PLL_REG2: c_uint = 0x8;
// OR cause register.
pub const MLXBF_I2C_CAUSE_OR_EVTEN0: c_uint = 0x14;
pub const MLXBF_I2C_CAUSE_OR_CLEAR: c_uint = 0x18;
// Arbiter Cause Register.
pub const MLXBF_I2C_CAUSE_ARBITER: c_uint = 0x1c;
//
...
pub const MLXBF_I2C_CAUSE_COALESCE_0: c_uint = 0x00;
pub const MLXBF_I2C_CAUSE_TYU_SLAVE_BIT: c_int = 3;
pub const MLXBF_I2C_CAUSE_YU_SLAVE_BIT: c_int = 1;
// Functional enable register.
pub const MLXBF_I2C_GPIO_0_FUNC_EN_0: c_uint = 0x28;
// Force OE enable register.
pub const MLXBF_I2C_GPIO_0_FORCE_OE_EN: c_uint = 0x30;
//
...
pub const MLXBF_I2C_SMBUS_TIMER_SCL_LOW_SCL_HIGH: c_uint = 0x00;
pub const MLXBF_I2C_SMBUS_TIMER_FALL_RISE_SPIKE: c_uint = 0x04;
pub const MLXBF_I2C_SMBUS_TIMER_THOLD: c_uint = 0x08;
pub const MLXBF_I2C_SMBUS_TIMER_TSETUP_START_STOP: c_uint = 0x0c;
pub const MLXBF_I2C_SMBUS_TIMER_TSETUP_DATA: c_uint = 0x10;
pub const MLXBF_I2C_SMBUS_THIGH_MAX_TBUF: c_uint = 0x14;
pub const MLXBF_I2C_SMBUS_SCL_LOW_TIMEOUT: c_uint = 0x18;
pub const MLXBF_I2C_SHIFT_0: c_int = 0;
pub const MLXBF_I2C_SHIFT_8: c_int = 8;
pub const MLXBF_I2C_SHIFT_16: c_int = 16;
pub const MLXBF_I2C_SHIFT_24: c_int = 24;

pub const MLXBF_I2C_MST_ADDR_OFFSET: c_uint = 0x200;
// SMBus Master GW.
pub const MLXBF_I2C_SMBUS_MASTER_GW: c_uint = 0x0;
// Number of bytes received and sent.
pub const MLXBF_I2C_YU_SMBUS_RS_BYTES: c_uint = 0x100;
pub const MLXBF_I2C_RSH_YU_SMBUS_RS_BYTES: c_uint = 0x10c;
// Packet error check (PEC) value.
pub const MLXBF_I2C_SMBUS_MASTER_PEC: c_uint = 0x104;
// Status bits (ACK/NACK/FW Timeout).
pub const MLXBF_I2C_SMBUS_MASTER_STATUS: c_uint = 0x108;
// SMbus Master Finite State Machine.
pub const MLXBF_I2C_YU_SMBUS_MASTER_FSM: c_uint = 0x110;
pub const MLXBF_I2C_RSH_YU_SMBUS_MASTER_FSM: c_uint = 0x100;
...
pub const MLXBF_I2C_MASTER_DATA_DESC_ADDR: c_uint = 0x80;
pub const MLXBF_I2C_MASTER_DATA_DESC_SIZE: c_uint = 0x80 /* Size in bytes. */;
...
pub const MLXBF_I2C_SLV_ADDR_OFFSET: c_uint = 0x400;
// SMBus slave GW.
pub const MLXBF_I2C_SMBUS_SLAVE_GW: c_uint = 0x0;
// Number of bytes received and sent from/to master.
pub const MLXBF_I2C_SMBUS_SLAVE_RS_MASTER_BYTES: c_uint = 0x100;
// Packet error check (PEC) value.
pub const MLXBF_I2C_SMBUS_SLAVE_PEC: c_uint = 0x104;
// SMBus slave Finite State Machine (FSM).
pub const MLXBF_I2C_SMBUS_SLAVE_FSM: c_uint = 0x110;
//
// Should be set when all raised causes handled, and cleared by HW on
// every new cause.
//
pub const MLXBF_I2C_SMBUS_SLAVE_READY: c_uint = 0x12c;
...
pub const MLXBF_I2C_SLAVE_DATA_DESC_ADDR: c_uint = 0x80;
pub const MLXBF_I2C_SLAVE_DATA_DESC_SIZE: c_uint = 0x80 /* Size in bytes. */;
// SMbus slave configuration registers.
pub const MLXBF_I2C_SMBUS_SLAVE_ADDR_CFG: c_uint = 0x114;
pub const MLXBF_I2C_SMBUS_SLAVE_ADDR_CNT: c_int = 16;
...
pub const MLXBF_I2C_POLL_FREQ_IN_USEC: c_int = 200;
pub const MLXBF_I2C_SMBUS_OP_CNT_1: c_int = 1;
pub const MLXBF_I2C_SMBUS_OP_CNT_2: c_int = 2;
pub const MLXBF_I2C_SMBUS_OP_CNT_3: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_i2c_timings {
    pub /: *mut *mut u16 scl_high; / Clock high period.,
    pub /: *mut *mut u16 scl_low; / Clock low period.,
    pub /: *mut *mut u8 sda_rise; / Data rise time.,
    pub /: *mut *mut u8 sda_fall; / Data fall time.,
    pub /: *mut *mut u8 scl_rise; / Clock rise time.,
    pub /: *mut *mut u8 scl_fall; / Clock fall time.,
    pub /: *mut *mut u16 hold_start; / Hold time after (REPEATED) START.,
    pub /: *mut *mut u16 hold_data; / Data hold time.,
    pub /: *mut *mut u16 setup_start; / REPEATED START condition setup time.,
    pub /: *mut *mut u16 setup_stop; / STOP condition setup time.,
    pub /: *mut *mut u16 setup_data; / Data setup time.,
    pub /: *mut *mut u16 pad; / Padding.,
    pub /: *mut *mut u16 buf; / Bus free time between STOP and START.,
    pub /: *mut *mut u16 thigh_max; / Thigh max.,
    pub /: *mut *mut u32 timeout; / Detect clock low timeout.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_i2c_smbus_operation {
    pub flags: u32,
    pub /: *mut *mut u32 length; / Buffer length in bytes.,
    pub buffer: *mut u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_i2c_smbus_request {
    pub slave: u8,
    pub operation_cnt: u8,
    pub operation: [mlxbf_i2c_smbus_operation; MLXBF_I2C_SMBUS_MAX_OP_CNT],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_i2c_resource {
    pub io: *mut void __iomem,
    pub params: *mut resource,
    pub /: *mut *mut *mut mutex lock; / Mutex to protect mlxbf_i2c_resource.,
    pub type: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_i2c_chip_info {
    pub type: enum mlxbf_i2c_chip_type,
// Chip shared resources that are being used by the I2C controller.
    pub shared_res: [*mut mlxbf_i2c_resource; MLXBF_I2C_SHARED_RES_MAX],
// Callback to calculate the core PLL frequency.
    pub corepll_res): *mut *mut u64 (calculate_freq)(struct mlxbf_i2c_resource,
// Registers' address offset
    pub smbus_master_rs_bytes_off: u32,
    pub smbus_master_fsm_off: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_i2c_priv {
    pub chip: *const mlxbf_i2c_chip_info,
    pub adap: i2c_adapter,
    pub smbus: *mut mlxbf_i2c_resource,
    pub timer: *mut mlxbf_i2c_resource,
    pub mst: *mut mlxbf_i2c_resource,
    pub slv: *mut mlxbf_i2c_resource,
    pub mst_cause: *mut mlxbf_i2c_resource,
    pub slv_cause: *mut mlxbf_i2c_resource,
    pub coalesce: *mut mlxbf_i2c_resource,
    pub /: *mut *mut u64 frequency; / Core frequency in Hz.,
    pub /: *mut *mut int bus; / Physical bus identifier.,
    pub irq: c_int,
    pub slave: [*mut i2c_client; MLXBF_I2C_SMBUS_SLAVE_ADDR_CNT],
...
//
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_smbus_check_status(priv: *mut mlxbf_i2c_priv) -> c_int {
...
//
    ...
    let mut stop_after_write: bool = true;
    u8 slave, addr;
    u8 *read_buf;
    u32 flags;
    u32 bits;
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_has_chip_type(priv: *mut mlxbf_i2c_priv, type: u8) -> bool {
    ...
    let mut ret: c_int = PTR_ERR(tmp_res.io);
...
//
    ...
    u32 mask, u8 shift)
    {
    let mut val: u32 = (mlxbf_i2c_get_ticks(priv, nsec, opt) & mask) << shift;
    return val;
    }
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_calculate_freq_from_tyu(corepll_res: *mut mlxbf_i2c_resource) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_calculate_freq_from_yu(corepll_res: *mut mlxbf_i2c_resource) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_slave_disable(priv: *mut mlxbf_i2c_priv, addr: u8) -> c_int {
...
// Free slave at the corresponding index
    priv.slave[(reg * 4) + byte] = core::ptr::null_mut();
    return 0;
    }
// Parse next byte.
    slave_reg_tmp >>= 8;
...
// read = true;
#[no_mangle]
pub unsafe extern "C" fn if(MLXBF_I2C_CAUSE_WRITE_SUCCESS: cause_reg &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_irq_send(priv: *mut mlxbf_i2c_priv, recv_bytes: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_irq_recv(priv: *mut mlxbf_i2c_priv, recv_bytes: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_irq(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
// Return negative errno on error.
    ...
    {
    let mut request: mlxbf_i2c_smbus_request = { 0 };
    struct mlxbf_i2c_priv *priv;
    bool read, pec;
    u8 byte_cnt;
    request.slave = addr;
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_reg_slave(slave: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_unreg_slave(slave: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_acpi_probe(dev: *mut device, priv: *mut mlxbf_i2c_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_i2c_exit() -> void __exit {
