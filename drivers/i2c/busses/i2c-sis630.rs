...
//! Source: drivers/i2c/busses/i2c-sis630.c
#![no_std]
...
pub const PCI_DEVICE_ID_SI_964: c_uint = 0x0964;
// SIS630/730/964 SMBus registers
pub const SMB_STS: c_uint = 0x00	/* status */;
pub const SMB_CNT: c_uint = 0x02	/* control */;
pub const SMBHOST_CNT: c_uint = 0x03	/* host control */;
pub const SMB_ADDR: c_uint = 0x04	/* address */;
pub const SMB_CMD: c_uint = 0x05	/* command */;
pub const SMB_COUNT: c_uint = 0x07	/* byte count */;
pub const SMB_BYTE: c_uint = 0x08	/* ~0x8F data byte field */;
// SMB_STS register
pub const BYTE_DONE_STS: c_uint = 0x10	/* Byte Done Status / Block Array */;
pub const SMBCOL_STS: c_uint = 0x04	/* Collision */;
pub const SMBERR_STS: c_uint = 0x02	/* Device error */;
// SMB_CNT register
pub const MSTO_EN: c_uint = 0x40	/* Host Master Timeout Enable */;
pub const SMBCLK_SEL: c_uint = 0x20	/* Host master clock selection */;
pub const SMB_PROBE: c_uint = 0x02	/* Bus Probe/Slave busy */;
pub const SMB_HOSTBUSY: c_uint = 0x01	/* Host Busy */;
// SMBHOST_CNT register
pub const SMB_KILL: c_uint = 0x20	/* Kill */;
pub const SMB_START: c_uint = 0x10	/* Start */;
// register count for request_region
// As we don't use SMB_PCOUNT, 20 is ok for SiS630 and SiS964
//
pub const SIS630_SMB_IOREGION: c_int = 20;
// PCI address constants
// acpi base address register
pub const SIS630_ACPI_BASE_REG: c_uint = 0x74;
// bios control register
pub const SIS630_BIOS_CTL_REG: c_uint = 0x40;
// Other settings
pub const MAX_TIMEOUT: c_int = 500;
// SIS630 constants
pub const SIS630_QUICK: c_uint = 0x00;
pub const SIS630_BYTE: c_uint = 0x01;
pub const SIS630_BYTE_DATA: c_uint = 0x02;
pub const SIS630_WORD_DATA: c_uint = 0x03;
pub const SIS630_PCALL: c_uint = 0x04;
pub const SIS630_BLOCK_DATA: c_uint = 0x05;
...
#[no_mangle]
pub unsafe extern "C" fn sis630_read(reg: u8) -> u8 {
    static inline u8 sis630_read(u8 reg)
    {
    return inb(smbus_base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn sis630_write(reg: u8, data: u8) {
...
#[no_mangle]
unsafe extern "C" fn sis630_transaction_wait(adap: *mut i2c_adapter, size: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sis630_transaction_end(adap: *mut i2c_adapter, oldclock: u8) {
...
#[no_mangle]
unsafe extern "C" fn sis630_transaction(adap: *mut i2c_adapter, size: c_int) -> c_int {
    static int sis630_transaction(struct i2c_adapter *adap, int size)
    {
    let mut result: c_int = 0;
    let mut oldclock: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn sis630_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sis630_setup(sis630_dev: *mut pci_dev) -> c_int {
    static int sis630_setup(struct pci_dev *sis630_dev)
    {
    unsigned char b;
    struct pci_dev *dummy = core::ptr::null_mut();
    int retval, i;
// acpi base address
...
#[no_mangle]
unsafe extern "C" fn sis630_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sis630_remove(dev: *mut pci_dev) {
