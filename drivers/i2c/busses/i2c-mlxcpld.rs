...
//! Source: drivers/i2c/busses/i2c-mlxcpld.c
#![no_std]
...
// General defines
pub const MLXPLAT_CPLD_LPC_I2C_BASE_ADDR: c_uint = 0x2000;

pub const MLXCPLD_I2C_BUS_NUM: c_int = 1;
pub const MLXCPLD_I2C_DATA_REG_SZ: c_int = 36;

pub const MLXCPLD_I2C_MAX_ADDR_LEN: c_int = 4;
pub const MLXCPLD_I2C_RETR_NUM: c_int = 2;

// LPC I2C registers
pub const MLXCPLD_LPCI2C_CPBLTY_REG: c_uint = 0x0;
pub const MLXCPLD_LPCI2C_CTRL_REG: c_uint = 0x1;
pub const MLXCPLD_LPCI2C_HALF_CYC_REG: c_uint = 0x4;
pub const MLXCPLD_LPCI2C_I2C_HOLD_REG: c_uint = 0x5;
pub const MLXCPLD_LPCI2C_CMD_REG: c_uint = 0x6;
pub const MLXCPLD_LPCI2C_NUM_DAT_REG: c_uint = 0x7;
pub const MLXCPLD_LPCI2C_NUM_ADDR_REG: c_uint = 0x8;
pub const MLXCPLD_LPCI2C_STATUS_REG: c_uint = 0x9;
pub const MLXCPLD_LPCI2C_DATA_REG: c_uint = 0xa;
// LPC I2C masks and parameters
pub const MLXCPLD_LPCI2C_RST_SEL_MASK: c_uint = 0x1;
pub const MLXCPLD_LPCI2C_TRANS_END: c_uint = 0x1;
pub const MLXCPLD_LPCI2C_STATUS_NACK: c_uint = 0x10;
pub const MLXCPLD_LPCI2C_NO_IND: c_int = 0;
pub const MLXCPLD_LPCI2C_ACK_IND: c_int = 1;
pub const MLXCPLD_LPCI2C_NACK_IND: c_int = 2;
pub const MLXCPLD_I2C_FREQ_1000KHZ_SET: c_uint = 0x04;
pub const MLXCPLD_I2C_FREQ_400KHZ_SET: c_uint = 0x0e;
pub const MLXCPLD_I2C_FREQ_100KHZ_SET: c_uint = 0x42;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxcpld_i2c_curr_xfer {
    pub cmd: u8,
    pub addr_width: u8,
    pub data_len: u8,
    pub msg_num: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxcpld_i2c_priv {
    pub adap: i2c_adapter,
    pub base_addr: u32,
    pub lock: mutex,
    pub xfer: mlxcpld_i2c_curr_xfer,
    pub dev: *mut device,
    pub smbus_block: bool,
    pub polling_time: c_int,
}

#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_lpc_write_buf(data: *mut u8, len: u8, addr: u32) {
...
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_lpc_read_buf(data: *mut u8, len: u8, addr: u32) {
...
// (data + i) = inb(addr + i);
    ...
    u8 *data, u8 datalen)
    {
    let mut addr: u32 = priv.base_addr + offs;
    switch (datalen) {
    case 1:
// (data) = inb(addr);
    break;
...
//
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_check_status(priv: *mut mlxcpld_i2c_priv, status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_reset(priv: *mut mlxcpld_i2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_check_busy(priv: *mut mlxcpld_i2c_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_wait_for_free(priv: *mut mlxcpld_i2c_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_wait_for_tc(priv: *mut mlxcpld_i2c_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_xfer_msg(priv: *mut mlxcpld_i2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MLXCPLD_I2C_DATA_EXT2_SZ_BIT: (val & MLXCPLD_I2C_DATA_SZ_MASK) ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mlxcpld_i2c_remove(pdev: *mut platform_device) {
