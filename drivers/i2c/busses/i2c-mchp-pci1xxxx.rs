...
//! Source: drivers/i2c/busses/i2c-mchp-pci1xxxx.c
#![no_std]
...
pub const SMBUS_MAST_CORE_ADDR_BASE: c_uint = 0x00000;
pub const SMBUS_MAST_SYS_REG_ADDR_BASE: c_uint = 0x01000;
// SMB register space.
...
//
pub const SR_HOLD_TIME_100K_TICKS: c_int = 150;
pub const SR_HOLD_TIME_400K_TICKS: c_int = 20;
pub const SR_HOLD_TIME_1000K_TICKS: c_int = 12;
...
//
pub const FAIR_BUS_IDLE_MIN_100K_TICKS: c_int = 992;
pub const FAIR_BUS_IDLE_MIN_400K_TICKS: c_int = 500;
pub const FAIR_BUS_IDLE_MIN_1000K_TICKS: c_int = 500;
//
...
//
pub const FAIR_IDLE_DELAY_100K_TICKS: c_int = 963;
pub const FAIR_IDLE_DELAY_400K_TICKS: c_int = 156;
pub const FAIR_IDLE_DELAY_1000K_TICKS: c_int = 156;
...
//
pub const BUS_CLK_100K_LOW_PERIOD_TICKS: c_int = 156;
pub const BUS_CLK_400K_LOW_PERIOD_TICKS: c_int = 41;
pub const BUS_CLK_1000K_LOW_PERIOD_TICKS: c_int = 15;
//
...
//
pub const BUS_CLK_100K_HIGH_PERIOD_TICKS: c_int = 154;
pub const BUS_CLK_400K_HIGH_PERIOD_TICKS: c_int = 35;
pub const BUS_CLK_1000K_HIGH_PERIOD_TICKS: c_int = 14;
...
// at X KHz.
//
pub const CLK_SYNC_100K: c_int = 4;
pub const CLK_SYNC_400K: c_int = 4;
pub const CLK_SYNC_1000K: c_int = 4;
...
//
pub const FIRST_START_HOLD_100K_TICKS: c_int = 23;
pub const FIRST_START_HOLD_400K_TICKS: c_int = 8;
pub const FIRST_START_HOLD_1000K_TICKS: c_int = 12;
//
...
//
pub const STOP_SETUP_100K_TICKS: c_int = 150;
pub const STOP_SETUP_400K_TICKS: c_int = 20;
pub const STOP_SETUP_1000K_TICKS: c_int = 12;
//
...
//
pub const RESTART_SETUP_100K_TICKS: c_int = 156;
pub const RESTART_SETUP_400K_TICKS: c_int = 20;
pub const RESTART_SETUP_1000K_TICKS: c_int = 12;
//
...
//
pub const DATA_HOLD_100K_TICKS: c_int = 12;
pub const DATA_HOLD_400K_TICKS: c_int = 2;
pub const DATA_HOLD_1000K_TICKS: c_int = 2;
...
//
pub const CTRL_CUM_TIME_OUT_100K_TICKS: c_int = 76;
pub const CTRL_CUM_TIME_OUT_400K_TICKS: c_int = 76;
pub const CTRL_CUM_TIME_OUT_1000K_TICKS: c_int = 76;
//
...
//
pub const TARGET_CUM_TIME_OUT_100K_TICKS: c_int = 95;
pub const TARGET_CUM_TIME_OUT_400K_TICKS: c_int = 95;
pub const TARGET_CUM_TIME_OUT_1000K_TICKS: c_int = 95;
//
...
//
pub const CLOCK_HIGH_TIME_OUT_100K_TICKS: c_int = 97;
pub const CLOCK_HIGH_TIME_OUT_400K_TICKS: c_int = 97;
pub const CLOCK_HIGH_TIME_OUT_1000K_TICKS: c_int = 97;
...
pub const I2C_DIRN_WRITE: c_int = 0;
pub const I2C_DIRN_READ: c_int = 1;
...
pub const SMBUS_BUF_MAX_SIZE: c_uint = 0x80;

pub const PCI1XXXX_I2C_TIMEOUT_MS: c_int = 1000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci1xxxx_i2c {
    pub i2c_xfer_done: completion,
    pub i2c_xfer_in_progress: bool,
    pub adap: i2c_adapter,
    pub i2c_base: *mut void __iomem,
    pub freq: u32,
    pub flags: u32,
}

#[no_mangle]
unsafe extern "C" fn set_sys_lock(i2c: *mut pci1xxxx_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_sys_lock(i2c: *mut pci1xxxx_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_ack_high_level_intr(i2c: *mut pci1xxxx_i2c, intr_msk: u16) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_send_start_stop(i2c: *mut pci1xxxx_i2c, start: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_clear_FW_ACK(i2c: *mut pci1xxxx_i2c, set: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_enable_ESO(i2c: *mut pci1xxxx_i2c) {
    static void pci1xxxx_i2c_enable_ESO(struct pci1xxxx_i2c *i2c)
    {
    writeb(SMB_CORE_CTRL_ESO, i2c.i2c_base + SMB_CORE_CTRL_REG_OFF);
    }
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_reset_counters(i2c: *mut pci1xxxx_i2c) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_transfer_dir(i2c: *mut pci1xxxx_i2c, direction: u8) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_mcu_count(i2c: *mut pci1xxxx_i2c, count: u8) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_read_count(i2c: *mut pci1xxxx_i2c, readcount: u8) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_write_count(i2c: *mut pci1xxxx_i2c, writecount: u8) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_DMA_run(i2c: *mut pci1xxxx_i2c) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_mrun_proceed(i2c: *mut pci1xxxx_i2c) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_start_DMA(i2c: *mut pci1xxxx_i2c) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_config_asr(i2c: *mut pci1xxxx_i2c, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_isr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    ...
    let mut intr_handled: irqreturn_t = IRQ_NONE;
    u16 reg1;
    u8 reg3;
//
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_readm(i2c: *mut pci1xxxx_i2c, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_ack_nw_layer_intr(i2c: *mut pci1xxxx_i2c, ack_intr_msk: u8) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_config_padctrl(i2c: *mut pci1xxxx_i2c, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_mode(i2c: *mut pci1xxxx_i2c) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_configure_core_reg(i2c: *mut pci1xxxx_i2c, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_set_freq(i2c: *mut pci1xxxx_i2c) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_init(i2c: *mut pci1xxxx_i2c) {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_clear_flags(i2c: *mut pci1xxxx_i2c) {
...
// Write I2c buffer with just the slave addr.
    pci1xxxx_i2c_buffer_write(i2c, slaveaddr, 0, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_get_funcs(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_resume(dev: *mut device) -> c_int {
    ...
    pci1xxxx_i2c_resume);
#[no_mangle]
unsafe extern "C" fn pci1xxxx_i2c_shutdown(data: *mut c_void) {
