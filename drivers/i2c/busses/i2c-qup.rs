...
//! Source: drivers/i2c/busses/i2c-qup.c
#![no_std]
...
// QUP Registers
pub const QUP_CONFIG: c_uint = 0x000;
pub const QUP_STATE: c_uint = 0x004;
pub const QUP_IO_MODE: c_uint = 0x008;
pub const QUP_SW_RESET: c_uint = 0x00c;
pub const QUP_OPERATIONAL: c_uint = 0x018;
pub const QUP_ERROR_FLAGS: c_uint = 0x01c;
pub const QUP_ERROR_FLAGS_EN: c_uint = 0x020;
pub const QUP_OPERATIONAL_MASK: c_uint = 0x028;
pub const QUP_HW_VERSION: c_uint = 0x030;
pub const QUP_MX_OUTPUT_CNT: c_uint = 0x100;
pub const QUP_OUT_FIFO_BASE: c_uint = 0x110;
pub const QUP_MX_WRITE_CNT: c_uint = 0x150;
pub const QUP_MX_INPUT_CNT: c_uint = 0x200;
pub const QUP_MX_READ_CNT: c_uint = 0x208;
pub const QUP_IN_FIFO_BASE: c_uint = 0x218;
pub const QUP_I2C_CLK_CTL: c_uint = 0x400;
pub const QUP_I2C_STATUS: c_uint = 0x404;
pub const QUP_I2C_MASTER_GEN: c_uint = 0x408;
// QUP States and reset values
pub const QUP_RESET_STATE: c_int = 0;
pub const QUP_RUN_STATE: c_int = 1;
pub const QUP_PAUSE_STATE: c_int = 3;
pub const QUP_STATE_MASK: c_int = 3;

pub const QUP_OPERATIONAL_RESET: c_uint = 0x000ff0;
pub const QUP_I2C_STATUS_RESET: c_uint = 0xfffffc;
// QUP OPERATIONAL FLAGS

// I2C mini core related values

pub const I2C_N_VAL: c_int = 15;
pub const I2C_N_VAL_V2: c_int = 7;
// Most significant word offset in FIFO port

// Packing/Unpacking words in FIFOs, and IO modes

pub const QUP_V2_TAGS_EN: c_int = 1;

// QUP tags

pub const QUP_BAM_INPUT_EOT: c_uint = 0x93;
pub const QUP_BAM_FLUSH_STOP: c_uint = 0x96;
// QUP v2 tags
pub const QUP_TAG_V2_START: c_uint = 0x81;
pub const QUP_TAG_V2_DATAWR: c_uint = 0x82;
pub const QUP_TAG_V2_DATAWR_STOP: c_uint = 0x83;
pub const QUP_TAG_V2_DATARD: c_uint = 0x85;
pub const QUP_TAG_V2_DATARD_NACK: c_uint = 0x86;
pub const QUP_TAG_V2_DATARD_STOP: c_uint = 0x87;
// Status, Error flags

pub const I2C_STATUS_ERROR_MASK: c_uint = 0x38000fc;
pub const QUP_STATUS_ERROR_FLAGS: c_uint = 0x7c;
pub const QUP_READ_LIMIT: c_int = 256;
pub const SET_BIT: c_uint = 0x1;
pub const RESET_BIT: c_uint = 0x0;
pub const ONE_BYTE: c_uint = 0x1;
...
// the overheads.
//
pub const TOUT_MIN: c_int = 2;
// Default values. Use these if FW query fails

pub const DEFAULT_SRC_CLK: c_int = 20000000;
//
// Max tags length (start, stop and maximum 2 bytes address) for each QUP
// data transfer
//
pub const QUP_MAX_TAGS_LEN: c_int = 4;
// Max data length for each DATARD tags
pub const RECV_MAX_DATA_LEN: c_int = 254;
// TAG length for DATA READ in RX FIFO
pub const READ_RX_TAGS_LEN: c_int = 2;
pub const QUP_BUS_WIDTH: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qup_i2c_block {
    pub count: c_int,
    pub pos: c_int,
    pub tx_tag_len: c_int,
    pub rx_tag_len: c_int,
    pub data_len: c_int,
    pub cur_blk_len: c_int,
    pub total_tx_len: c_int,
    pub total_rx_len: c_int,
    pub tx_fifo_data_pos: c_int,
    pub tx_fifo_free: c_int,
    pub rx_fifo_data_pos: c_int,
    pub fifo_available: c_int,
    pub tx_fifo_data: u32,
    pub rx_fifo_data: u32,
    pub cur_data: *mut u8,
    pub cur_tx_tags: *mut u8,
    pub tx_tags_sent: bool,
    pub send_last_word: bool,
    pub rx_tags_fetched: bool,
    pub rx_bytes_read: bool,
    pub is_tx_blk_mode: bool,
    pub is_rx_blk_mode: bool,
    pub tags: [u8; 6],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qup_i2c_tag {
    pub start: *mut u8,
    pub addr: dma_addr_t,
}
...
pub struct qup_i2c_dev {
    ...
    pub in_blk_sz: c_int,
    pub blk_xfer_limit: c_int,
    pub one_byte_t: c_ulong,
    pub xfer_timeout: c_ulong,
    pub blk: qup_i2c_block,
    pub msg: *mut i2c_msg,
...
// To check if this is the last msg
    pub is_last: bool,
    pub is_smbus_read: bool,
// To configure when bus is in run state
    pub config_run: u32,
// bandwidth votes
    pub src_clk_freq: u32,
    pub cur_bw_clk_freq: u32,
// dma parameters
    pub is_dma: bool,
// To check if the current transfer is using DMA
    pub use_dma: bool,
    pub max_xfer_sg_len: c_uint,
    pub tag_buf_pos: c_uint,
// The threshold length above which block mode will be used
    pub blk_mode_threshold: c_uint,
    pub dpool: *mut dma_pool,
    pub start_tag: qup_i2c_tag,
    pub brx: qup_i2c_bam,
    pub btx: qup_i2c_bam,
    pub xfer: completion,
// function to write data in tx fifo
    pub qup): *mut *mut void (write_tx_fifo)(struct qup_i2c_dev,
// function to read data from rx fifo
    pub qup): *mut *mut void (read_rx_fifo)(struct qup_i2c_dev,
// function to write tags in tx fifo for i2c read transfer
    pub qup): *mut *mut void (write_rx_tags)(struct qup_i2c_dev,
}

#[no_mangle]
unsafe extern "C" fn qup_i2c_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_poll_state(qup: *mut qup_i2c_dev, req_state: u32) -> c_int {
    static int qup_i2c_poll_state(struct qup_i2c_dev *qup, u32 req_state)
    {
    return qup_i2c_poll_state_mask(qup, req_state, QUP_STATE_MASK);
    }
#[no_mangle]
unsafe extern "C" fn qup_i2c_flush(qup: *mut qup_i2c_dev) {
    static void qup_i2c_flush(struct qup_i2c_dev *qup)
    {
    let mut val: u32 = readl(qup.base + QUP_STATE);
    val |= QUP_I2C_FLUSH;
    writel(val, qup.base + QUP_STATE);
    }
#[no_mangle]
unsafe extern "C" fn qup_i2c_poll_state_valid(qup: *mut qup_i2c_dev) -> c_int {
    static int qup_i2c_poll_state_valid(struct qup_i2c_dev *qup)
    {
    return qup_i2c_poll_state_mask(qup, 0, 0);
    }
#[no_mangle]
unsafe extern "C" fn qup_i2c_poll_state_i2c_master(qup: *mut qup_i2c_dev) -> c_int {
    static int qup_i2c_poll_state_i2c_master(struct qup_i2c_dev *qup)
    {
    return qup_i2c_poll_state_mask(qup, QUP_I2C_MAST_GEN, QUP_I2C_MAST_GEN);
    }
#[no_mangle]
unsafe extern "C" fn qup_i2c_change_state(qup: *mut qup_i2c_dev, state: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_bus_active(qup: *mut qup_i2c_dev, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_vote_bw(qup: *mut qup_i2c_dev, clk_freq: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_write_tx_fifo_v1(qup: *mut qup_i2c_dev) {
    static void qup_i2c_write_tx_fifo_v1(struct qup_i2c_dev *qup)
    {
    struct qup_i2c_block *blk = &qup.blk;
    struct i2c_msg *msg = qup.msg;
    let mut addr: u32 = i2c_8bit_addr_from_msg(msg);
    u32 qup_tag;
    int idx;
    u32 val;
    if (qup.pos == 0) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_get_data_len(qup: *mut qup_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_check_msg_len(msg: *mut i2c_msg) -> bool {
...
// Read 1 byte indicating the length of the SMBus message
    ...
    struct i2c_msg *msg)
    {
    let mut addr: u16 = i2c_8bit_addr_from_msg(msg);
    let mut len: c_int = 0;
    int data_len;
    let mut last: c_int = (qup.blk.pos == (qup.blk.count - 1)) && (qup.is_last);
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_bam_cb(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_rel_dma(qup: *mut qup_i2c_dev) {
    ...
    qup.btx.dma = core::ptr::null_mut();
    qup.brx.dma = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn qup_i2c_req_dma(qup: *mut qup_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_bam_make_desc(qup: *mut qup_i2c_dev, msg: *mut i2c_msg) -> c_int {
    static int qup_i2c_bam_make_desc(struct qup_i2c_dev *qup, struct i2c_msg *msg)
    {
    let mut ret: c_int = 0, limit = QUP_READ_LIMIT;
    let mut len: u32 = 0, blocks, rem;
    let mut i: u32 = 0, tlen, tx_len = 0;
    u8 *tags;
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_bam_schedule_desc(qup: *mut qup_i2c_dev) -> c_int {
    static int qup_i2c_bam_schedule_desc(struct qup_i2c_dev *qup)
    {
    struct dma_async_tx_descriptor *txd, *rxd = core::ptr::null_mut();
    let mut ret: c_int = 0;
    dma_cookie_t cookie_rx, cookie_tx;
    let mut len: u32 = 0;
    let mut tx_cnt: u32 = qup.btx.sg_cnt, rx_cnt = qup.brx.sg_cnt;
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_bam_clear_tag_buffers(qup: *mut qup_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_read_rx_fifo_v1(qup: *mut qup_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_write_rx_tags_v1(qup: *mut qup_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_conf_v1(qup: *mut qup_i2c_dev) {
    static void qup_i2c_conf_v1(struct qup_i2c_dev *qup)
    {
    struct qup_i2c_block *blk = &qup.blk;
    let mut qup_config: u32 = I2C_MINI_CORE | I2C_N_VAL;
    let mut io_mode: u32 = QUP_REPACK_EN;
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_clear_blk_v1(blk: *mut qup_i2c_block) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_conf_xfer_v1(qup: *mut qup_i2c_dev, is_rx: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_write_one(qup: *mut qup_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_read_one(qup: *mut qup_i2c_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qup_i2c_conf_count_v2(qup: *mut qup_i2c_dev) {
    static void qup_i2c_conf_count_v2(struct qup_i2c_dev *qup)
    {
    struct qup_i2c_block *blk = &qup.blk;
    let mut qup_config: u32 = I2C_MINI_CORE | I2C_N_VAL_V2;
    if (blk.is_tx_blk_mode)
...
//
#[no_mangle]
unsafe extern "C" fn qup_i2c_conf_mode_v2(qup: *mut qup_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_clear_blk_v2(blk: *mut qup_i2c_block) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_recv_data(qup: *mut qup_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_recv_tags(qup: *mut qup_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn qup_i2c_read_rx_fifo_v2(qup: *mut qup_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_write_rx_tags_v2(qup: *mut qup_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn qup_i2c_write_tx_fifo_v2(qup: *mut qup_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn qup_i2c_xfer_v2_msg(qup: *mut qup_i2c_dev, msg_id: c_int, is_rx: bool) -> c_int {
...
//
    ...
    {
    int idx;
    let mut no_dma: bool = false;
    let mut max_tx_len: c_uint = 0, max_rx_len = 0, total_len = 0;
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_enable_clocks(qup: *mut qup_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_disable_clocks(qup: *mut qup_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut src_clk_freq: u32 = DEFAULT_SRC_CLK;
    let mut clk_freq: u32 = DEFAULT_CLK_FREQ;
    int blocks;
    bool is_qup_v1;
...
// 2 tag bytes for each block + 5 for start, stop tags
    ...
    qup.is_dma = true;
    qup.icc_path = devm_of_icc_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_pm_suspend_runtime(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_pm_resume_runtime(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_suspend(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qup_i2c_resume(device: *mut device) -> c_int {
    ...
    qup_i2c_pm_resume_runtime, core::ptr::null_mut())
    };
