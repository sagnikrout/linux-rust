...
//! Source: drivers/i2c/busses/i2c-designware-master.c
#![no_std]
...
pub const AMD_TIMEOUT_MIN_US: c_int = 25;
pub const AMD_TIMEOUT_MAX_US: c_int = 250;

#[no_mangle]
unsafe extern "C" fn i2c_dw_set_timings_master(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_xfer_init(dev: *mut dw_i2c_dev) {
    static void i2c_dw_xfer_init(struct dw_i2c_dev *dev)
    {
    struct i2c_msg *msgs = dev.msgs;
    let mut ic_con: u32 = 0, ic_tar = 0;
    unsigned int dummy;
// Disable the adapter
...
//
#[no_mangle]
unsafe extern "C" fn i2c_dw_is_controller_active(dev: *mut dw_i2c_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_check_stopbit(dev: *mut dw_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_status(dev: *mut dw_i2c_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd_i2c_dw_xfer_quirk(dev: *mut dw_i2c_dev, msgs: *mut i2c_msg, num_msgs: c_int) -> c_int {
    static int amd_i2c_dw_xfer_quirk(struct dw_i2c_dev *dev, struct i2c_msg *msgs, int num_msgs)
    {
    int msg_wrt_idx, msg_itr_lmt, buf_len, data_idx;
    let mut cmd: c_int = 0, status;
    u8 *tx_buf;
    unsigned int val;
...
//
    ...
    let mut buf_len: u32 = dev.tx_buf_len;
    u8 *buf = dev.tx_buf;
    let mut need_restart: bool = false;
    unsigned int flr;
    intr_mask = DW_IC_INTR_MASTER_MASK;
    for (; dev.msg_write_idx < dev.msgs_num; dev.msg_write_idx++) {
    let mut flags: u32 = msgs[dev.msg_write_idx].flags;
...
//
    ...
    {
    struct i2c_msg *msgs = dev.msgs;
    let mut flags: u32 = msgs[dev.msg_read_idx].flags;
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_read_clear_intrbits(dev: *mut dw_i2c_dev) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_process_transfer(dev: *mut dw_i2c_dev, stat: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ACCESS_INTR_MASK): unlikely(dev->flags &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_isr_master(dev: *mut dw_i2c_dev) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_wait_transfer(dev: *mut dw_i2c_dev) -> c_int {
    static int i2c_dw_wait_transfer(struct dw_i2c_dev *dev)
    {
    let mut timeout: c_ulong = dev.adapter.timeout;
    unsigned int stat;
    int ret;
    if (!(dev.flags & ACCESS_POLLING)) {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_xfer(adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_configure_master(dev: *mut dw_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_prepare_recovery(adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_unprepare_recovery(adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn i2c_dw_init_recovery_info(dev: *mut dw_i2c_dev) -> c_int {
    ...
    rinfo.pinctrl = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn i2c_dw_probe_master(dev: *mut dw_i2c_dev) -> c_int {
