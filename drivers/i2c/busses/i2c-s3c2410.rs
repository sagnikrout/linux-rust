...
//! Source: drivers/i2c/busses/i2c-s3c2410.c
#![no_std]
...
pub const S3C2410_IICCON: c_uint = 0x00;
pub const S3C2410_IICSTAT: c_uint = 0x04;
pub const S3C2410_IICADD: c_uint = 0x08;
pub const S3C2410_IICDS: c_uint = 0x0C;
pub const S3C2440_IICLC: c_uint = 0x10;

// Treat S3C2410 as baseline hardware, anything else is supported via quirks

// Max time to wait for bus to become idle after a xfer (in us)
pub const S3C2410_IDLE_TIMEOUT: c_int = 5000;
// Exynos5 Sysreg offset
pub const EXYNOS5_SYS_I2C_CFG: c_uint = 0x0234;
...
pub struct s3c24xx_i2c {
    ...
    pub tx_setup: c_uint,
    pub irq: c_uint,
    pub state: enum s3c24xx_i2c_state,
    pub clkrate: c_ulong,
    pub regs: *mut void __iomem,
    pub clk: *mut clk,
    pub dev: *mut device,
    pub adap: i2c_adapter,
    pub pdata: *mut s3c2410_platform_i2c,
    pub gpios: [*mut gpio_desc; 2],
    pub pctrl: *mut pinctrl,
    pub sysreg: *mut regmap,
    pub sys_i2c_cfg: c_uint,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_get_device_quirks(pdev: *mut platform_device) -> kernel_ulong_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_i2c_master_complete(i2c: *mut s3c24xx_i2c, ret: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_i2c_disable_ack(i2c: *mut s3c24xx_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_i2c_enable_ack(i2c: *mut s3c24xx_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_i2c_disable_irq(i2c: *mut s3c24xx_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_i2c_enable_irq(i2c: *mut s3c24xx_i2c) {
...
#[no_mangle]
unsafe extern "C" fn is_ack(i2c: *mut s3c24xx_i2c) -> bool {
    static bool is_ack(struct s3c24xx_i2c *i2c)
    {
    int tries;
    for (tries = 50; tries; --tries) {
    let mut tmp: c_ulong = readl(i2c.regs + S3C2410_IICCON);
...
//
    ...
    struct i2c_msg *msg)
    {
    let mut addr: c_uint = (msg.addr & 0x7f) << 1;
    unsigned long stat;
...
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_i2c_stop(i2c: *mut s3c24xx_i2c, ret: c_int) {
    static inline void s3c24xx_i2c_stop(struct s3c24xx_i2c *i2c, int ret)
    {
    let mut iicstat: c_ulong = readl(i2c.regs + S3C2410_IICSTAT);
...
//
#[no_mangle]
pub unsafe extern "C" fn is_lastmsg(i2c: *mut s3c24xx_i2c) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_msglast(i2c: *mut s3c24xx_i2c) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_msgend(i2c: *mut s3c24xx_i2c) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_s3c_irq_nextbyte(i2c: *mut s3c24xx_i2c, iicstat: c_ulong) {
    static void i2c_s3c_irq_nextbyte(struct s3c24xx_i2c *i2c, unsigned long iicstat)
    {
    unsigned long tmp;
    unsigned char byte;
...
//
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_irq(irqno: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn s3c24xx_i2c_disable_bus(i2c: *mut s3c24xx_i2c) {
...
//
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_set_master(i2c: *mut s3c24xx_i2c) -> c_int {
    static int s3c24xx_i2c_set_master(struct s3c24xx_i2c *i2c)
    {
    unsigned long iicstat;
    let mut timeout: c_int = 400;
    while (timeout-- > 0) {
...
//
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_wait_idle(i2c: *mut s3c24xx_i2c) {
...
//
    ...
    let mut stat: c_ulong = readl(i2c.regs + S3C2410_IICSTAT);
...
#[no_mangle]
pub unsafe extern "C" fn if(num: ret !=) -> else {
    else if (ret != num)
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
//
    ...
    {
    let mut calc_divs: c_uint = clkin / wanted;
...
//
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_clockrate(i2c: *mut s3c24xx_i2c, got: *mut c_uint) -> c_int {
    static int s3c24xx_i2c_clockrate(struct s3c24xx_i2c *i2c, unsigned int *got)
    {
    struct s3c2410_platform_i2c *pdata = i2c.pdata;
    let mut clkin: c_ulong = clk_get_rate(i2c.clk);
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_parse_dt_gpio(i2c: *mut s3c24xx_i2c) -> c_int {
    ...
    return 0;
    for (i = 0; i < 2; i++) {
    i2c.gpios[i] = devm_gpiod_get_index(i2c.dev, core::ptr::null_mut(),
    i, GPIOD_ASIS);
...
//
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_init(i2c: *mut s3c24xx_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_probe(pdev: *mut platform_device) -> c_int {
    static int s3c24xx_i2c_probe(struct platform_device *pdev)
    {
    struct s3c24xx_i2c *i2c;
    struct s3c2410_platform_i2c *pdata = core::ptr::null_mut();
    struct resource *res;
    int ret;
    if (!pdev.dev.of_node) {
...
#[no_mangle]
pub unsafe extern "C" fn if(s3c24xx_i2c_parse_dt_gpio(i2c): IS_ERR(i2c->pctrl) &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s3c24xx_i2c_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_adap_s3c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn i2c_adap_s3c_exit() -> void __exit {
