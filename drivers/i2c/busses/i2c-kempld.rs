...
//! Source: drivers/i2c/busses/i2c-kempld.c
#![no_std]
...
pub const KEMPLD_I2C_PRELOW: c_uint = 0x0b;
pub const KEMPLD_I2C_PREHIGH: c_uint = 0x0c;
pub const KEMPLD_I2C_DATA: c_uint = 0x0e;
pub const KEMPLD_I2C_CTRL: c_uint = 0x0d;
pub const I2C_CTRL_IEN: c_uint = 0x40;
pub const I2C_CTRL_EN: c_uint = 0x80;
pub const KEMPLD_I2C_STAT: c_uint = 0x0f;
pub const I2C_STAT_IF: c_uint = 0x01;
pub const I2C_STAT_TIP: c_uint = 0x02;
pub const I2C_STAT_ARBLOST: c_uint = 0x20;
pub const I2C_STAT_BUSY: c_uint = 0x40;
pub const I2C_STAT_NACK: c_uint = 0x80;
pub const KEMPLD_I2C_CMD: c_uint = 0x0f;
pub const I2C_CMD_START: c_uint = 0x91;
pub const I2C_CMD_STOP: c_uint = 0x41;
pub const I2C_CMD_READ: c_uint = 0x21;
pub const I2C_CMD_WRITE: c_uint = 0x11;
pub const I2C_CMD_READ_ACK: c_uint = 0x21;
pub const I2C_CMD_READ_NACK: c_uint = 0x29;
pub const I2C_CMD_IACK: c_uint = 0x01;
...
pub struct kempld_i2c_data {
    ...
    let mut bus_frequency: static unsigned int = KEMPLD_I2C_FREQ_STD;
...
//
#[no_mangle]
unsafe extern "C" fn kempld_i2c_process(i2c: *mut kempld_i2c_data) -> c_int {
    static int kempld_i2c_process(struct kempld_i2c_data *i2c)
    {
    struct kempld_device_data *pld = i2c.pld;
    let mut stat: u8 = kempld_read8(pld, KEMPLD_I2C_STAT);
...
//
#[no_mangle]
unsafe extern "C" fn kempld_i2c_device_init(i2c: *mut kempld_i2c_data) {
...
#[no_mangle]
unsafe extern "C" fn kempld_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn kempld_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn kempld_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_i2c_resume(dev: *mut device) -> c_int {
