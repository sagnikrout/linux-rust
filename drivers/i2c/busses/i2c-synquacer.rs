...
//! Source: drivers/i2c/busses/i2c-synquacer.c
#![no_std]
...
pub const SYNQUACER_I2C_CSR_CS_STD_MAX_18M(rate): c_uint = 0x00;
...
pub const SYNQUACER_I2C_CSR_CS_FAST_MAX_18M(rate): c_uint = 0x00;
// (clkrate > 18000000)
// calculate the value of CS bits in CCR register on standard mode
...
#[no_mangle]
pub unsafe extern "C" fn is_lastmsg(i2c: *mut synquacer_i2c) -> c_int {
    static inline int is_lastmsg(struct synquacer_i2c *i2c)
    {
    return i2c.msg_idx >= (i2c.msg_num - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn is_msglast(i2c: *mut synquacer_i2c) -> c_int {
    static inline int is_msglast(struct synquacer_i2c *i2c)
    {
    return i2c.msg_ptr == (i2c.msg.len - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn is_msgend(i2c: *mut synquacer_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn synquacer_i2c_stop(i2c: *mut synquacer_i2c, ret: c_int) {
...
#[no_mangle]
unsafe extern "C" fn synquacer_i2c_hw_init(i2c: *mut synquacer_i2c) {
    static void synquacer_i2c_hw_init(struct synquacer_i2c *i2c)
    {
    unsigned char ccr_cs, csr_cs;
    let mut rt: u32 = i2c.pclkrate;
// Set own Address
...
#[no_mangle]
unsafe extern "C" fn synquacer_i2c_hw_reset(i2c: *mut synquacer_i2c) {
...
#[no_mangle]
unsafe extern "C" fn synquacer_i2c_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn synquacer_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn synquacer_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn synquacer_i2c_remove(pdev: *mut platform_device) {
