...
//! Source: drivers/i2c/busses/i2c-npcm7xx.c
#![no_std]
...
pub const NPCM_I2CSEGCTL: c_uint = 0xE4;
// Common regs
pub const NPCM_I2CSDA: c_uint = 0x00;
pub const NPCM_I2CST: c_uint = 0x02;
pub const NPCM_I2CCST: c_uint = 0x04;
pub const NPCM_I2CCTL1: c_uint = 0x06;
pub const NPCM_I2CADDR1: c_uint = 0x08;
pub const NPCM_I2CCTL2: c_uint = 0x0A;
pub const NPCM_I2CADDR2: c_uint = 0x0C;
pub const NPCM_I2CCTL3: c_uint = 0x0E;
pub const NPCM_I2CCST2: c_uint = 0x18;
pub const NPCM_I2CCST3: c_uint = 0x19;
pub const I2C_VER: c_uint = 0x1F;
// BANK 0 regs
pub const NPCM_I2CADDR3: c_uint = 0x10;
pub const NPCM_I2CADDR7: c_uint = 0x11;
pub const NPCM_I2CADDR4: c_uint = 0x12;
pub const NPCM_I2CADDR8: c_uint = 0x13;
pub const NPCM_I2CADDR5: c_uint = 0x14;
pub const NPCM_I2CADDR9: c_uint = 0x15;
pub const NPCM_I2CADDR6: c_uint = 0x16;
pub const NPCM_I2CADDR10: c_uint = 0x17;
pub const NPCM_I2CCTL4: c_uint = 0x1A;
pub const NPCM_I2CCTL5: c_uint = 0x1B;
pub const NPCM_I2CSCLLT: c_uint = 0x1C /* SCL Low Time */;
pub const NPCM_I2CFIF_CTL: c_uint = 0x1D /* FIFO Control */;
pub const NPCM_I2CSCLHT: c_uint = 0x1E /* SCL High Time */;
// BANK 1 regs
pub const NPCM_I2CFIF_CTS: c_uint = 0x10 /* Both FIFOs Control and Status */;
pub const NPCM_I2CTXF_CTL: c_uint = 0x12 /* Tx-FIFO Control */;
pub const NPCM_I2CT_OUT: c_uint = 0x14 /* Bus T.O. */;
pub const NPCM_I2CPEC: c_uint = 0x16 /* PEC Data */;
pub const NPCM_I2CTXF_STS: c_uint = 0x1A /* Tx-FIFO Status */;
pub const NPCM_I2CRXF_STS: c_uint = 0x1C /* Rx-FIFO Status */;
pub const NPCM_I2CRXF_CTL: c_uint = 0x1E /* Rx-FIFO Control */;
...
//
pub const I2C_NUM_OWN_ADDR: c_int = 10;
pub const I2C_NUM_OWN_ADDR_SUPPORTED: c_int = 2;
...
pub const MAX_I2C_HW_FIFO_SIZE: c_int = 32;
// I2C_VER reg fields

// stall/stuck timeout in us
pub const DEFAULT_STALL_COUNT: c_int = 25;
// SCLFRQ field position

// supported clk settings. values in Hz.
pub const I2C_FREQ_MIN_HZ: c_int = 10000;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct smb_timing_t {
    pub core_clk: u32,
    pub hldt: u8,
    pub dbcnt: u8,
    pub sclfrq: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct npcm_i2c_data {
    pub fifo_size: u8,
    pub segctl_init_val: u32,
    pub txf_sts_tx_bytes: u8,
    pub rxf_sts_rx_bytes: u8,
    pub rxf_ctl_last_pec: u8,
}
...
pub struct npcm_i2c {
    ...
    pub dev: *mut device,
    pub reg: *mut unsigned char __iomem,
    pub data: *const npcm_i2c_data,
    ...
    pub state: enum i2c_state,
    pub operation: enum i2c_oper,
    pub master_or_slave: enum i2c_mode,
    pub stop_ind: enum i2c_state_ind,
    pub dest_addr: u8,
    pub rd_buf: *mut u8,
    pub rd_size: u16,
    pub rd_ind: u16,
    ...
    pub wr_ind: u16,
    pub fifo_use: bool,
    pub /: *mut *mut u16 PEC_mask; / PEC bit mask per slave address,
    pub PEC_use: bool,
    pub read_block_use: bool,
    pub int_time_stamp: c_ulong,
    pub /: *mut *mut unsigned long bus_freq; / in Hz,

    pub own_slave_addr: u8,
    pub slave: *mut i2c_client,
    pub slv_rd_size: c_int,
    pub slv_rd_ind: c_int,
    pub slv_wr_size: c_int,
    pub slv_wr_ind: c_int,
    pub slv_rd_buf: [u8; MAX_I2C_HW_FIFO_SIZE],
    pub slv_wr_buf: [u8; MAX_I2C_HW_FIFO_SIZE],
    pub ber_cnt: u64,
    pub rec_succ_cnt: u64,
    pub rec_fail_cnt: u64,
    pub nack_cnt: u64,
    pub timeout_cnt: u64,
    pub tx_complete_cnt: u64,
    pub /: *mut *mut bool ber_state; / Indicate the bus error state,
}

    static inline void npcm_i2c_select_bank(struct npcm_i2c *bus,
    enum i2c_bank bank)
    {
    let mut i2cctl3: u8 = ioread8(bus.reg + NPCM_I2CCTL3);
    if (bank == I2C_BANK_0)
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_init_params(bus: *mut npcm_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_wr_byte(bus: *mut npcm_i2c, data: u8) {
    static inline void npcm_i2c_wr_byte(struct npcm_i2c *bus, u8 data)
    {
    iowrite8(data, bus.reg + NPCM_I2CSDA);
    }
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_rd_byte(bus: *mut npcm_i2c) -> u8 {
    static inline u8 npcm_i2c_rd_byte(struct npcm_i2c *bus)
    {
    return ioread8(bus.reg + NPCM_I2CSDA);
    }
#[no_mangle]
unsafe extern "C" fn npcm_i2c_get_SCL(_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_get_SDA(_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_get_index(bus: *mut npcm_i2c) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_is_quick(bus: *mut npcm_i2c) -> bool {
    static inline bool npcm_i2c_is_quick(struct npcm_i2c *bus)
    {
    return bus.wr_size == 0 && bus.rd_size == 0;
    }
#[no_mangle]
unsafe extern "C" fn npcm_i2c_disable(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_enable(bus: *mut npcm_i2c) {
    static void npcm_i2c_enable(struct npcm_i2c *bus)
    {
    let mut i2cctl2: u8 = ioread8(bus.reg + NPCM_I2CCTL2);
    i2cctl2 = i2cctl2 | I2CCTL2_ENABLE;
    iowrite8(i2cctl2, bus.reg + NPCM_I2CCTL2);
    bus.state = I2C_IDLE;
    }
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_eob_int(bus: *mut npcm_i2c, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_tx_fifo_empty(bus: *mut npcm_i2c) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_rx_fifo_full(bus: *mut npcm_i2c) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_clear_fifo_int(bus: *mut npcm_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_clear_tx_fifo(bus: *mut npcm_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_clear_rx_fifo(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_int_enable(bus: *mut npcm_i2c, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_master_start(bus: *mut npcm_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_master_stop(bus: *mut npcm_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_stall_after_start(bus: *mut npcm_i2c, stall: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_nack(bus: *mut npcm_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_clear_master_status(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_slave_int_enable(bus: *mut npcm_i2c, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_reset(bus: *mut npcm_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn npcm_i2c_is_master(bus: *mut npcm_i2c) -> bool {
    ...
    struct i2c_msg *msgs;
    int msgs_num;
    let mut do_complete: bool = false;
    msgs = bus.msgs;
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_fifo_usage(bus: *mut npcm_i2c) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_write_to_fifo_master(bus: *mut npcm_i2c, max_bytes: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn npcm_i2c_set_fifo(bus: *mut npcm_i2c, nread: c_int, nwrite: c_int) {
    static void npcm_i2c_set_fifo(struct npcm_i2c *bus, int nread, int nwrite)
    {
    let mut rxf_ctl: u8 = 0;
    if (!bus.fifo_use)
    return;
    npcm_i2c_select_bank(bus, I2C_BANK_1);
    npcm_i2c_clear_tx_fifo(bus);
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_read_fifo(bus: *mut npcm_i2c, bytes_in_fifo: u8) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_master_abort(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_get_slave_addr(bus: *mut npcm_i2c, addr_type: enum i2c_addr) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_remove_slave_addr(bus: *mut npcm_i2c, slave_add: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_write_fifo_slave(bus: *mut npcm_i2c, max_bytes: u16) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_read_fifo_slave(bus: *mut npcm_i2c, bytes_in_fifo: u8) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_slave_get_wr_buf(bus: *mut npcm_i2c) -> c_int {
    static int npcm_i2c_slave_get_wr_buf(struct npcm_i2c *bus)
    {
    int i;
    u8 value;
    int ind;
    let mut ret: c_int = bus.slv_wr_ind;
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_slave_send_rd_buf(bus: *mut npcm_i2c) {
...
//
#[no_mangle]
unsafe extern "C" fn npcm_i2c_slave_wr_buf_sync(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_slave_rd_wr(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_int_slave_handler(bus: *mut npcm_i2c) -> irqreturn_t {
    static irqreturn_t npcm_i2c_int_slave_handler(struct npcm_i2c *bus)
    {
    u8 val;
    let mut ret: irqreturn_t = IRQ_NONE;
    let mut i2cst: u8 = ioread8(bus.reg + NPCM_I2CST);
...
// A Slave Stop Condition has been identified
    ...
    let mut bytes_in_fifo: u8 = npcm_i2c_fifo_usage(bus);
...
//
    bus.operation = I2C_NO_OPER;
    bus.own_slave_addr = 0xFF;
    i2c_slave_event(bus.slave, I2C_SLAVE_STOP, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_reg_slave(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_unreg_slave(client: *mut i2c_client) -> c_int {
    ...
    bus.slave = core::ptr::null_mut();
    spin_unlock_irqrestore(&bus.lock, lock_flags);
    return 0;
    }

#[no_mangle]
unsafe extern "C" fn npcm_i2c_master_fifo_read(bus: *mut npcm_i2c) {
    static void npcm_i2c_master_fifo_read(struct npcm_i2c *bus)
    {
    int rcount;
    int fifo_bytes;
    let mut ind: enum i2c_state_ind = I2C_MASTER_DONE_IND;
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_irq_master_handler_write(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_irq_master_handler_read(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_irq_handle_nmatch(bus: *mut npcm_i2c) {
...
// A NACK has occurred
#[no_mangle]
unsafe extern "C" fn npcm_i2c_irq_handle_nack(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_irq_handle_ber(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_irq_handle_eob(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_irq_handle_stall_after_start(bus: *mut npcm_i2c) {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_irq_handle_sda(bus: *mut npcm_i2c, i2cst: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn if(I2C_READ_OPER: bus->operation ==) -> else {
    else if (bus.operation == I2C_READ_OPER)
    npcm_i2c_irq_master_handler_read(bus);
    }
    }
#[no_mangle]
unsafe extern "C" fn npcm_i2c_int_master_handler(bus: *mut npcm_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_recovery_tgclk(_adap: *mut i2c_adapter) -> c_int {
    static int npcm_i2c_recovery_tgclk(struct i2c_adapter *_adap)
    {
    u8               val;
    u8               fif_cts;
    let mut done: bool = false;
    let mut status: c_int = -ENOTRECOVERABLE;
    struct npcm_i2c *bus = container_of(_adap, struct npcm_i2c, adap);
// Allow 3 bytes (27 toggles) to be read from the slave:
    let mut iter: c_int = 27;
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_recovery_init(_adap: *mut i2c_adapter) {
...
pub const SCLFRQ_MIN: c_int = 10;
pub const SCLFRQ_MAX: c_int = 511;
...
//
#[no_mangle]
unsafe extern "C" fn npcm_i2c_init_clk(bus: *mut npcm_i2c, bus_freq_hz: u32) -> c_int {
    static int npcm_i2c_init_clk(struct npcm_i2c *bus, u32 bus_freq_hz)
    {
    struct  smb_timing_t *smb_timing;
    let mut scl_table_cnt: u8 = 0, table_size = 0;
    let mut fast_mode: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn __npcm_i2c_init(bus: *mut npcm_i2c, pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_bus_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_probe_bus(pdev: *mut platform_device) -> c_int {
...
// core clk must be acquired to calculate module timing settings
    i2c_clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(i2c_clk))
...
#[no_mangle]
unsafe extern "C" fn npcm_i2c_remove_bus(pdev: *mut platform_device) {
