...
//! Source: drivers/i2c/busses/i2c-xiic.c
#![no_std]
...
pub const SMBUS_BLOCK_READ_MIN_LEN: c_int = 3;
...
pub struct xiic_i2c {
    ...
    pub tx_msg: *mut i2c_msg,
    pub lock: mutex,
    pub tx_pos: c_uint,
    pub nmsgs: c_uint,
    pub rx_msg: *mut i2c_msg,
    pub rx_pos: c_int,
    pub endianness: enum xiic_endian,
    pub clk: *mut clk,
    pub state: enum xilinx_i2c_state,
    pub singlemaster: bool,
    pub dynamic: bool,
    pub prev_msg_tx: bool,
    pub quirks: u32,
    pub smbus_block_read: bool,
    pub input_clk: c_ulong,
    pub i2c_clk: c_uint,
    pub atomic: bool,
    pub /: *mut *mut spinlock_t atomic_lock; / Lock for atomic transfer mode,
    pub atomic_xfer_state: enum xilinx_i2c_state,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xiic_version_data {
    pub quirks: u32,
}
...
pub const XIIC_MSB_OFFSET: c_int = 0;
...
pub const XIIC_CR_ENABLE_DEVICE_MASK: c_uint = 0x01	/* Device enable = 1      */;
pub const XIIC_CR_TX_FIFO_RESET_MASK: c_uint = 0x02	/* Transmit FIFO reset=1  */;
pub const XIIC_CR_MSMS_MASK: c_uint = 0x04	/* Master starts Txing=1  */;
pub const XIIC_CR_DIR_IS_TX_MASK: c_uint = 0x08	/* Dir of tx. Txing=1     */;
pub const XIIC_CR_NO_ACK_MASK: c_uint = 0x10	/* Tx Ack. NO ack = 1     */;
pub const XIIC_CR_REPEATED_START_MASK: c_uint = 0x20	/* Repeated start = 1     */;
pub const XIIC_CR_GENERAL_CALL_MASK: c_uint = 0x40	/* Gen Call enabled = 1   */;
// Status Register masks
pub const XIIC_SR_GEN_CALL_MASK: c_uint = 0x01	/* 1=a mstr issued a GC   */;
pub const XIIC_SR_ADDR_AS_SLAVE_MASK: c_uint = 0x02	/* 1=when addr as slave   */;
pub const XIIC_SR_BUS_BUSY_MASK: c_uint = 0x04	/* 1 = bus is busy        */;
pub const XIIC_SR_MSTR_RDING_SLAVE_MASK: c_uint = 0x08	/* 1=Dir: mstr <-- slave  */;
pub const XIIC_SR_TX_FIFO_FULL_MASK: c_uint = 0x10	/* 1 = Tx FIFO full       */;
pub const XIIC_SR_RX_FIFO_FULL_MASK: c_uint = 0x20	/* 1 = Rx FIFO full       */;
pub const XIIC_SR_RX_FIFO_EMPTY_MASK: c_uint = 0x40	/* 1 = Rx FIFO empty      */;
pub const XIIC_SR_TX_FIFO_EMPTY_MASK: c_uint = 0x80	/* 1 = Tx FIFO empty      */;
// Interrupt Status Register masks    Interrupt occurs when...
pub const XIIC_INTR_ARB_LOST_MASK: c_uint = 0x01	/* 1 = arbitration lost   */;
pub const XIIC_INTR_TX_ERROR_MASK: c_uint = 0x02	/* 1=Tx error/msg complete */;
pub const XIIC_INTR_TX_EMPTY_MASK: c_uint = 0x04	/* 1 = Tx FIFO/reg empty  */;
pub const XIIC_INTR_RX_FULL_MASK: c_uint = 0x08	/* 1=Rx FIFO/reg=OCY level */;
pub const XIIC_INTR_BNB_MASK: c_uint = 0x10	/* 1 = Bus not busy       */;
pub const XIIC_INTR_AAS_MASK: c_uint = 0x20	/* 1 = when addr as slave */;
pub const XIIC_INTR_NAAS_MASK: c_uint = 0x40	/* 1 = not addr as slave  */;
pub const XIIC_INTR_TX_HALF_MASK: c_uint = 0x80	/* 1 = TX FIFO half empty */;
...
//
pub const XIIC_TX_DYN_START_MASK: c_uint = 0x0100 /* 1 = Set dynamic start */;
pub const XIIC_TX_DYN_STOP_MASK: c_uint = 0x0200 /* 1 = Set dynamic stop */;
...
//
pub const XIIC_DGIER_OFFSET: c_uint = 0x1C /* Device Global Interrupt Enable Register */;
pub const XIIC_IISR_OFFSET: c_uint = 0x20 /* Interrupt Status Register */;
pub const XIIC_IIER_OFFSET: c_uint = 0x28 /* Interrupt Enable Register */;
pub const XIIC_RESETR_OFFSET: c_uint = 0x40 /* Reset Register */;
pub const XIIC_RESET_MASK: c_uint = 0xAUL;
...
pub const XIIC_XFER_TIMEOUT_US: c_int = 10000000;
//
// The following constant is used for the device global interrupt enable
// register, to enable all interrupts for the device, this is the only bit
// in the register
//
pub const XIIC_GINTR_ENABLE_MASK: c_uint = 0x80000000UL;

    static int xiic_start_xfer(struct xiic_i2c *i2c, struct i2c_msg *msgs, int num);
    static void __xiic_start_xfer(struct xiic_i2c *i2c);
#[no_mangle]
unsafe extern "C" fn xiic_i2c_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xiic_i2c_runtime_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn xiic_setreg8(i2c: *mut xiic_i2c, reg: c_int, value: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn xiic_getreg8(i2c: *mut xiic_i2c, reg: c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn xiic_setreg16(i2c: *mut xiic_i2c, reg: c_int, value: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn xiic_setreg32(i2c: *mut xiic_i2c, reg: c_int, value: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn xiic_getreg32(i2c: *mut xiic_i2c, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xiic_irq_dis(i2c: *mut xiic_i2c, mask: u32) {
    static inline void xiic_irq_dis(struct xiic_i2c *i2c, u32 mask)
    {
    let mut ier: u32 = xiic_getreg32(i2c, XIIC_IIER_OFFSET);
    xiic_setreg32(i2c, XIIC_IIER_OFFSET, ier & ~mask);
    }
#[no_mangle]
pub unsafe extern "C" fn xiic_irq_en(i2c: *mut xiic_i2c, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn xiic_irq_clr(i2c: *mut xiic_i2c, mask: u32) {
    static inline void xiic_irq_clr(struct xiic_i2c *i2c, u32 mask)
    {
    let mut isr: u32 = xiic_getreg32(i2c, XIIC_IISR_OFFSET);
    xiic_setreg32(i2c, XIIC_IISR_OFFSET, isr & mask);
    }
#[no_mangle]
pub unsafe extern "C" fn xiic_irq_clr_en(i2c: *mut xiic_i2c, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn xiic_clear_rx_fifo(i2c: *mut xiic_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xiic_wait_tx_empty(i2c: *mut xiic_i2c) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xiic_setclk(i2c: *mut xiic_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xiic_reinit(i2c: *mut xiic_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xiic_deinit(i2c: *mut xiic_i2c) {
...
#[no_mangle]
unsafe extern "C" fn xiic_smbus_block_read_setup(i2c: *mut xiic_i2c) {
...
#[no_mangle]
unsafe extern "C" fn xiic_read_rx(i2c: *mut xiic_i2c) {
...
#[no_mangle]
unsafe extern "C" fn xiic_error_check(i2c: *mut xiic_i2c) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xiic_tx_fifo_space(i2c: *mut xiic_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xiic_fill_tx_fifo(i2c: *mut xiic_i2c) {
    static void xiic_fill_tx_fifo(struct xiic_i2c *i2c)
    {
    let mut fifo_space: u8 = xiic_tx_fifo_space(i2c);
    let mut len: c_int = xiic_tx_space(i2c);
    len = (len > fifo_space) ? fifo_space : len;
    if (!i2c.atomic)
    dev_dbg(i2c.adap.dev.parent, "%s entry, len: %d, fifo space: %d\n",
    __func__, len, fifo_space);
    while (len--) {
    let mut data: u16 = i2c.tx_msg.buf[i2c.tx_pos++];
...
#[no_mangle]
unsafe extern "C" fn xiic_wakeup(i2c: *mut xiic_i2c, code: enum xilinx_i2c_state) {
    static void xiic_wakeup(struct xiic_i2c *i2c, enum xilinx_i2c_state code)
    {
    i2c.tx_msg = core::ptr::null_mut();
    i2c.rx_msg = core::ptr::null_mut();
    i2c.nmsgs = 0;
    i2c.state = code;
    complete(&i2c.completion);
    }
#[no_mangle]
unsafe extern "C" fn xiic_process(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t xiic_process(int irq, void *dev_id)
    {
    struct xiic_i2c *i2c = dev_id;
    u32 pend, isr, ier;
    let mut clr: u32 = 0;
    let mut xfer_more: c_int = 0;
    let mut wakeup_req: c_int = 0;
    let mut wakeup_code: enum xilinx_i2c_state = STATE_DONE;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn xiic_bus_busy(i2c: *mut xiic_i2c) -> c_int {
    static int xiic_bus_busy(struct xiic_i2c *i2c)
    {
    let mut sr: u8 = xiic_getreg8(i2c, XIIC_SR_REG_OFFSET);
    return (sr & XIIC_SR_BUS_BUSY_MASK) ? -EBUSY : 0;
    }
#[no_mangle]
unsafe extern "C" fn xiic_wait_not_busy(i2c: *mut xiic_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xiic_recv_atomic(i2c: *mut xiic_i2c) {
...
#[no_mangle]
unsafe extern "C" fn xiic_start_recv(i2c: *mut xiic_i2c) {
    static void xiic_start_recv(struct xiic_i2c *i2c)
    {
    u16 rx_watermark;
    let mut cr: u8 = 0, rfd_set = 0;
...
#[no_mangle]
unsafe extern "C" fn xiic_send_rem_atomic(i2c: *mut xiic_i2c) {
...
#[no_mangle]
unsafe extern "C" fn xiic_start_send(i2c: *mut xiic_i2c) {
...
#[no_mangle]
unsafe extern "C" fn __xiic_start_xfer(i2c: *mut xiic_i2c) {
    static void __xiic_start_xfer(struct xiic_i2c *i2c)
    {
    let mut fifo_space: c_int = xiic_tx_fifo_space(i2c);
    if (!i2c.atomic)
...
#[no_mangle]
unsafe extern "C" fn xiic_start_xfer(i2c: *mut xiic_i2c, msgs: *mut i2c_msg, num: c_int) -> c_int {
    static int xiic_start_xfer(struct xiic_i2c *i2c, struct i2c_msg *msgs, int num)
    {
...
#[no_mangle]
unsafe extern "C" fn xiic_xfer(adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xiic_xfer_atomic(adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xiic_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn xiic_i2c_probe(pdev: *mut platform_device) -> c_int {
...
// hook up driver to tree
    ...
    i2c.clk = devm_clk_get_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(i2c.clk))
...
// If clock-frequency not specified in DT, do not configure in SW
    ...
    i2c.i2c_clk = 0;
    ret = devm_request_threaded_irq(dev, irq, core::ptr::null_mut(), xiic_process,
...
#[no_mangle]
unsafe extern "C" fn xiic_i2c_remove(pdev: *mut platform_device) {
...
// remove adapter & data
    ...
    xiic_i2c_runtime_resume, core::ptr::null_mut())
    };
