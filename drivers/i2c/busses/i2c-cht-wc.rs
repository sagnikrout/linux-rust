...
//! Source: drivers/i2c/busses/i2c-cht-wc.c
#![no_std]
...
pub const CHT_WC_I2C_CTRL: c_uint = 0x5e24;

pub const CHT_WC_I2C_CLIENT_ADDR: c_uint = 0x5e25;
pub const CHT_WC_I2C_REG_OFFSET: c_uint = 0x5e26;
pub const CHT_WC_I2C_WRDATA: c_uint = 0x5e27;
pub const CHT_WC_I2C_RDDATA: c_uint = 0x5e28;
pub const CHT_WC_EXTCHGRIRQ: c_uint = 0x6e0a;

pub const CHT_WC_EXTCHGRIRQ_MSK: c_uint = 0x6e17;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cht_wc_i2c_adap {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_i2c_adap_thread_handler(id: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_i2c_adap_func(adap: *mut i2c_adapter) -> u32 {
...
//
    ...
    ret = -EIO;
#[no_mangle]
pub unsafe extern "C" fn if(I2C_SMBUS_READ: read_write ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_i2c_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_i2c_irq_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_i2c_irq_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_i2c_irq_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_i2c_adap_i2c_probe(pdev: *mut platform_device) -> c_int {
    static int cht_wc_i2c_adap_i2c_probe(struct platform_device *pdev)
    {
    struct intel_soc_pmic *pmic = dev_get_drvdata(pdev.dev.parent);
    struct i2c_board_info *board_info = core::ptr::null_mut();
...
// Alloc and register client IRQ
    adap.irq_domain = irq_domain_create_linear(core::ptr::null_mut(), 1, &irq_domain_simple_ops, core::ptr::null_mut());
    if (!adap.irq_domain)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn cht_wc_i2c_adap_i2c_remove(pdev: *mut platform_device) {
