...
//! Source: drivers/i2c/busses/i2c-gxp.c
#![no_std]
...
pub const GXP_MAX_I2C_ENGINE: c_int = 10;
...
pub const GXP_I2CINTSTAT: c_uint = 0x00;
pub const GXP_I2CINTEN: c_uint = 0x04;
// GXP I2C registers
pub const GXP_I2CSTAT: c_uint = 0x00;
pub const MASK_STOP_EVENT: c_uint = 0x20;
pub const MASK_ACK: c_uint = 0x08;
pub const MASK_RW: c_uint = 0x04;
pub const GXP_I2CEVTERR: c_uint = 0x01;
pub const MASK_SLAVE_CMD_EVENT: c_uint = 0x01;
pub const MASK_SLAVE_DATA_EVENT: c_uint = 0x02;
pub const MASK_MASTER_EVENT: c_uint = 0x10;
pub const GXP_I2CSNPDAT: c_uint = 0x02;
pub const GXP_I2CMCMD: c_uint = 0x04;
pub const GXP_I2CSCMD: c_uint = 0x06;
pub const GXP_I2CSNPAA: c_uint = 0x09;
pub const GXP_I2CADVFEAT: c_uint = 0x0A;
pub const GXP_I2COWNADR: c_uint = 0x0B;
pub const GXP_I2CFREQDIV: c_uint = 0x0C;
pub const GXP_I2CFLTFAIR: c_uint = 0x0D;
pub const GXP_I2CTMOEDG: c_uint = 0x0E;
pub const GXP_I2CCYCTIM: c_uint = 0x0F;
// I2CSCMD Bits
pub const SNOOP_EVT_CLR: c_uint = 0x80;
pub const SLAVE_EVT_CLR: c_uint = 0x40;
pub const SNOOP_EVT_MASK: c_uint = 0x20;
pub const SLAVE_EVT_MASK: c_uint = 0x10;
pub const SLAVE_ACK_ENAB: c_uint = 0x08;
pub const SLAVE_EVT_STALL: c_uint = 0x01;
// I2CMCMD Bits
pub const MASTER_EVT_CLR: c_uint = 0x80;
pub const MASTER_ACK_ENAB: c_uint = 0x08;
pub const RW_CMD: c_uint = 0x04;
pub const STOP_CMD: c_uint = 0x02;
pub const START_CMD: c_uint = 0x01;
// I2CTMOEDG value
pub const GXP_DATA_EDGE_RST_CTRL: c_uint = 0x0a /* 30ns */;
// I2CFLTFAIR Bits
pub const FILTER_CNT: c_uint = 0x30;
pub const FAIRNESS_CNT: c_uint = 0x02;
    enum {
    GXP_I2C_IDLE = 0,
    GXP_I2C_ADDR_PHASE,
    GXP_I2C_RDATA_PHASE,
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_start(drvdata: *mut gxp_i2c_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_reg_slave(slave: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_unreg_slave(slave: *mut i2c_client) -> c_int {
    ...
    drvdata.slave = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_stop(drvdata: *mut gxp_i2c_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_restart(drvdata: *mut gxp_i2c_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_chk_addr_ack(drvdata: *mut gxp_i2c_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_ack_data(drvdata: *mut gxp_i2c_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_chk_data_ack(drvdata: *mut gxp_i2c_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_slave_irq_handler(drvdata: *mut gxp_i2c_drvdata) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_irq_handler(irq: c_int, _drvdata: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_init(drvdata: *mut gxp_i2c_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gxp_i2c_remove(pdev: *mut platform_device) {
