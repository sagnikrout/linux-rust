...
//! Source: drivers/i2c/busses/i2c-viapro.c
#![no_std]
...
pub const SMBBA1: c_uint = 0x90;
pub const SMBBA2: c_uint = 0x80;
pub const SMBBA3: c_uint = 0xD0;
...
// SMBus data in configuration space can be found in two places,
    ...
    let mut SMBHSTCFG: static unsigned short = 0xD2;
// Other settings
pub const MAX_TIMEOUT: c_int = 500;
// VT82C596 constants
pub const VT596_QUICK: c_uint = 0x00;
pub const VT596_BYTE: c_uint = 0x04;
pub const VT596_BYTE_DATA: c_uint = 0x08;
pub const VT596_WORD_DATA: c_uint = 0x0C;
pub const VT596_PROC_CALL: c_uint = 0x10;
pub const VT596_BLOCK_DATA: c_uint = 0x14;
pub const VT596_I2C_BLOCK_DATA: c_uint = 0x34;
...
#[no_mangle]
unsafe extern "C" fn vt596_dump_regs(msg: *const c_char, size: u8) {
...
#[no_mangle]
unsafe extern "C" fn vt596_transaction(size: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vt596_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_vt596_init() -> int __init {
    static int __init i2c_vt596_init(void)
    {
    return pci_register_driver(&vt596_driver);
    }
#[no_mangle]
unsafe extern "C" fn i2c_vt596_exit() -> void __exit {
    static void __exit i2c_vt596_exit(void)
    {
    pci_unregister_driver(&vt596_driver);
    if (vt596_pdev != core::ptr::null_mut()) {
