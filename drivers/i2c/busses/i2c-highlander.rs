...
//! Source: drivers/i2c/busses/i2c-highlander.c
#![no_std]
...
pub const SMCR: c_uint = 0x00;

pub const SMSMADR: c_uint = 0x02;
pub const SMMR: c_uint = 0x04;

pub const SMSADR: c_uint = 0x06;
pub const SMTRDR: c_uint = 0x46;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct highlander_i2c_dev {
    pub dev: *mut device,
    pub base: *mut void __iomem,
    pub adapter: i2c_adapter,
    pub cmd_complete: completion,
    pub last_read_time: c_ulong,
    pub irq: c_int,
    pub buf: *mut u8,
    pub buf_len: usize,
}
    ...
    let mut iic_timeout: static int = 1000, iic_read_delay;
#[no_mangle]
pub unsafe extern "C" fn highlander_i2c_irq_enable(dev: *mut highlander_i2c_dev) {
    static inline void highlander_i2c_irq_enable(struct highlander_i2c_dev *dev)
    {
    iowrite16(ioread16(dev.base + SMCR) | SMCR_IEIC, dev.base + SMCR);
    }
#[no_mangle]
pub unsafe extern "C" fn highlander_i2c_irq_disable(dev: *mut highlander_i2c_dev) {
    static inline void highlander_i2c_irq_disable(struct highlander_i2c_dev *dev)
    {
    iowrite16(ioread16(dev.base + SMCR) & ~SMCR_IEIC, dev.base + SMCR);
    }
#[no_mangle]
pub unsafe extern "C" fn highlander_i2c_start(dev: *mut highlander_i2c_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn highlander_i2c_done(dev: *mut highlander_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_setup(dev: *mut highlander_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn smbus_write_data(src: *mut u8, dst: *mut u16, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smbus_read_data(src: *mut u16, dst: *mut u8, len: c_int) {
...
// dst = *src >> 8;
    ...
    {
    unsigned int i;
    let mut cmd: u16 = (command << 8) | command;
    for (i = 0; i < len; i += 2) {
    if (len - i == 1)
    cmd = command << 8;
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_wait_for_bbsy(dev: *mut highlander_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_reset(dev: *mut highlander_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_wait_for_ack(dev: *mut highlander_i2c_dev) -> c_int {
    static int highlander_i2c_wait_for_ack(struct highlander_i2c_dev *dev)
    {
    let mut tmp: u16 = ioread16(dev.base + SMCR);
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_poll(dev: *mut highlander_i2c_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn highlander_i2c_wait_xfer_done(dev: *mut highlander_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_read(dev: *mut highlander_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_write(dev: *mut highlander_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn highlander_i2c_remove(pdev: *mut platform_device) {
