...
//! Source: drivers/i2c/busses/i2c-ali1535.c
#![no_std]
...
pub const SMBCOM: c_uint = 0x004;
pub const SMBREV: c_uint = 0x008;
pub const SMBCFG: c_uint = 0x0D1;
pub const SMBBA: c_uint = 0x0E2;
pub const SMBHSTCFG: c_uint = 0x0F0;
pub const SMBCLK: c_uint = 0x0F2;
// Other settings

pub const ALI1535_SMB_IOSIZE: c_int = 32;
pub const ALI1535_SMB_DEFAULTBASE: c_uint = 0x8040;
// ALI1535 address lock bits
pub const ALI1535_LOCK: c_uint = 0x06	/* dwe */;
// ALI1535 command constants
pub const ALI1535_QUICK: c_uint = 0x00;
pub const ALI1535_BYTE: c_uint = 0x10;
pub const ALI1535_BYTE_DATA: c_uint = 0x20;
pub const ALI1535_WORD_DATA: c_uint = 0x30;
pub const ALI1535_BLOCK_DATA: c_uint = 0x40;
pub const ALI1535_I2C_READ: c_uint = 0x60;
pub const ALI1535_DEV10B_EN: c_uint = 0x80	/* Enable 10-bit addressing in	*/;
// I2C read
pub const ALI1535_T_OUT: c_uint = 0x08	/* Time-out Command (write)	*/;
pub const ALI1535_A_HIGH_BIT9: c_uint = 0x08	/* Bit 9 of 10-bit address in	*/;
// Alert-Response-Address
// (read)
pub const ALI1535_KILL: c_uint = 0x04	/* Kill Command (write)		*/;
pub const ALI1535_A_HIGH_BIT8: c_uint = 0x04	/* Bit 8 of 10-bit address in	*/;
// Alert-Response-Address
// (read)
pub const ALI1535_D_HI_MASK: c_uint = 0x03	/* Mask for isolating bits 9-8	*/;
// of 10-bit address in I2C
// Read Command
// ALI1535 status register bits
pub const ALI1535_STS_IDLE: c_uint = 0x04;
pub const ALI1535_STS_BUSY: c_uint = 0x08	/* host busy */;
pub const ALI1535_STS_DONE: c_uint = 0x10	/* transaction complete */;
pub const ALI1535_STS_DEV: c_uint = 0x20	/* device error */;
pub const ALI1535_STS_BUSERR: c_uint = 0x40	/* bus error    */;
pub const ALI1535_STS_FAIL: c_uint = 0x80	/* failed bus transaction */;
pub const ALI1535_STS_ERR: c_uint = 0xE0	/* all the bad error bits */;
pub const ALI1535_BLOCK_CLR: c_uint = 0x04	/* reset block data index */;
// ALI1535 device address register bits
pub const ALI1535_RD_ADDR: c_uint = 0x01	/* Read/Write Bit in Device	*/;
// Address field
// -> Write = 0
// -> Read  = 1
pub const ALI1535_SMBIO_EN: c_uint = 0x04	/* SMB I/O Space enable		*/;
...
#[no_mangle]
unsafe extern "C" fn ali1535_setup(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali1535_transaction(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali1535_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ali1535_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali1535_remove(dev: *mut pci_dev) {
