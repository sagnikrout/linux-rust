...
//! Source: drivers/i2c/busses/i2c-imx-lpi2c.c
#![no_std]
...
pub const LPI2C_VERID: c_uint = 0x00	/* i2c version ID */;
pub const LPI2C_PARAM: c_uint = 0x04	/* i2c RX/TX FIFO size */;
pub const LPI2C_MCR: c_uint = 0x10	/* i2c contrl register */;
pub const LPI2C_MSR: c_uint = 0x14	/* i2c status register */;
pub const LPI2C_MIER: c_uint = 0x18	/* i2c interrupt enable */;
pub const LPI2C_MDER: c_uint = 0x1C	/* i2c DMA enable */;
pub const LPI2C_MCFGR0: c_uint = 0x20	/* i2c master configuration */;
pub const LPI2C_MCFGR1: c_uint = 0x24	/* i2c master configuration */;
pub const LPI2C_MCFGR2: c_uint = 0x28	/* i2c master configuration */;
pub const LPI2C_MCFGR3: c_uint = 0x2C	/* i2c master configuration */;
pub const LPI2C_MCCR0: c_uint = 0x48	/* i2c master clk configuration */;
pub const LPI2C_MCCR1: c_uint = 0x50	/* i2c master clk configuration */;
pub const LPI2C_MFCR: c_uint = 0x58	/* i2c master FIFO control */;
pub const LPI2C_MFSR: c_uint = 0x5C	/* i2c master FIFO status */;
pub const LPI2C_MTDR: c_uint = 0x60	/* i2c master TX data register */;
pub const LPI2C_MRDR: c_uint = 0x70	/* i2c master RX data register */;
pub const LPI2C_SCR: c_uint = 0x110	/* i2c target control register */;
pub const LPI2C_SSR: c_uint = 0x114	/* i2c target status register */;
pub const LPI2C_SIER: c_uint = 0x118	/* i2c target interrupt enable */;
pub const LPI2C_SDER: c_uint = 0x11C	/* i2c target DMA enable */;
pub const LPI2C_SCFGR0: c_uint = 0x120	/* i2c target configuration */;
pub const LPI2C_SCFGR1: c_uint = 0x124	/* i2c target configuration */;
pub const LPI2C_SCFGR2: c_uint = 0x128	/* i2c target configuration */;
pub const LPI2C_SAMR: c_uint = 0x140	/* i2c target address match */;
pub const LPI2C_SASR: c_uint = 0x150	/* i2c target address status */;
pub const LPI2C_STAR: c_uint = 0x154	/* i2c target transmit ACK */;
pub const LPI2C_STDR: c_uint = 0x160	/* i2c target transmit data */;
pub const LPI2C_SRDR: c_uint = 0x170	/* i2c target receive data */;
pub const LPI2C_SRDROR: c_uint = 0x178	/* i2c target receive data read only */;
// i2c command

pub const SCFGR2_FILTSDA_SHIFT: c_int = 24;
pub const SCFGR2_FILTSCL_SHIFT: c_int = 16;

pub const SASR_READ_REQ: c_uint = 0x1;

    SIER_SDIE | SIER_BEIE)
pub const I2C_CLK_RATIO: c_int = 2;
pub const CHUNK_DATA: c_int = 256;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_lpi2c_hwdata {
    pub /: *mut *mut bool need_request_free_irq; / Needed by irqsteer,
    pub /: *mut *mut bool need_prepare_unprepare_clk; / Needed by LPCG,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpi2c_imx_dma {
    pub using_pio_mode: bool,
    pub rx_cmd_buf_len: u8,
    pub dma_buf: *mut u8,
    pub rx_cmd_buf: *mut u16,
    pub dma_len: c_uint,
    pub tx_burst_num: c_uint,
    pub rx_burst_num: c_uint,
    pub dma_msg_flag: c_ulong,
...
pub struct lpi2c_imx_struct {
    ...
    pub rate_per: c_ulong,
    pub msglen: c_uint,
    pub delivered: c_uint,
    pub block_data: c_uint,
    pub bitrate: c_uint,
    pub txfifosize: c_uint,
    pub rxfifosize: c_uint,
    pub mode: enum lpi2c_imx_mode,
    pub rinfo: i2c_bus_recovery_info,
    pub can_use_dma: bool,
    pub dma: *mut lpi2c_imx_dma,
    pub target: *mut i2c_client,
    pub target_supported: bool,
    pub irq: c_int,
    pub hwdata: *const imx_lpi2c_hwdata,
}
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_bus_busy(lpi2c_imx: *mut lpi2c_imx_struct, atomic: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_txfifo_cnt(lpi2c_imx: *mut lpi2c_imx_struct) -> u32 {
    static u32 lpi2c_imx_txfifo_cnt(struct lpi2c_imx_struct *lpi2c_imx)
    {
    return readl(lpi2c_imx.base + LPI2C_MFSR) & 0xff;
    }
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_set_mode(lpi2c_imx: *mut lpi2c_imx_struct) {
    static void lpi2c_imx_set_mode(struct lpi2c_imx_struct *lpi2c_imx)
    {
    let mut bitrate: c_uint = lpi2c_imx.bitrate;
    enum lpi2c_imx_mode mode;
    if (bitrate < I2C_MAX_FAST_MODE_FREQ)
    mode = STANDARD;
#[no_mangle]
pub unsafe extern "C" fn if(I2C_MAX_FAST_MODE_PLUS_FREQ: bitrate <) -> else {
    else if (bitrate < I2C_MAX_FAST_MODE_PLUS_FREQ)
    mode = FAST;
#[no_mangle]
pub unsafe extern "C" fn if(I2C_MAX_HIGH_SPEED_MODE_FREQ: bitrate <) -> else {
    else if (bitrate < I2C_MAX_HIGH_SPEED_MODE_FREQ)
    mode = FAST_PLUS;
#[no_mangle]
pub unsafe extern "C" fn if(I2C_MAX_ULTRA_FAST_MODE_FREQ: bitrate <) -> else {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_stop(lpi2c_imx: *mut lpi2c_imx_struct, atomic: bool) {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_config(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_master_enable(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_master_disable(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_pio_msg_complete(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_txfifo_empty(lpi2c_imx: *mut lpi2c_imx_struct, atomic: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_set_tx_watermark(lpi2c_imx: *mut lpi2c_imx_struct) {
    static void lpi2c_imx_set_tx_watermark(struct lpi2c_imx_struct *lpi2c_imx)
    {
    writel(lpi2c_imx.txfifosize >> 1, lpi2c_imx.base + LPI2C_MFCR);
    }
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_set_rx_watermark(lpi2c_imx: *mut lpi2c_imx_struct) {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_write_txfifo(lpi2c_imx: *mut lpi2c_imx_struct, atomic: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_read_rxfifo(lpi2c_imx: *mut lpi2c_imx_struct, atomic: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_SMBus_block_read_length_byte(lpi2c_imx: *mut lpi2c_imx_struct) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_read_chunk_atomic(lpi2c_imx: *mut lpi2c_imx_struct) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_use_dma(lpi2c_imx: *mut lpi2c_imx_struct, msg: *mut i2c_msg) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_dma_timeout_calculate(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_alloc_rx_cmd_buf(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
    static int lpi2c_imx_alloc_rx_cmd_buf(struct lpi2c_imx_struct *lpi2c_imx)
    {
    struct lpi2c_imx_dma *dma = lpi2c_imx.dma;
    let mut rx_remain: u16 = dma.dma_len;
    int cmd_num;
    u16 temp;
//
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_dma_msg_complete(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_dma_unmap(dma: *mut lpi2c_imx_dma) {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_cleanup_rx_cmd_dma(dma: *mut lpi2c_imx_dma) {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_cleanup_dma(dma: *mut lpi2c_imx_dma) {
    static void lpi2c_cleanup_dma(struct lpi2c_imx_dma *dma)
    {
    if (dma.dma_data_dir == DMA_FROM_DEVICE)
    dmaengine_terminate_sync(dma.chan_rx);
#[no_mangle]
pub unsafe extern "C" fn if(DMA_TO_DEVICE: dma->dma_data_dir ==) -> else {
    else if (dma.dma_data_dir == DMA_TO_DEVICE)
    dmaengine_terminate_sync(dma.chan_tx);
    lpi2c_dma_unmap(dma);
    }
#[no_mangle]
unsafe extern "C" fn lpi2c_dma_callback(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_dma_rx_cmd_submit(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_dma_submit(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_find_max_burst_num(fifosize: c_uint, len: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_dma_burst_num_calculate(lpi2c_imx: *mut lpi2c_imx_struct) {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_dma_config(lpi2c_imx: *mut lpi2c_imx_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_dma_enable(lpi2c_imx: *mut lpi2c_imx_struct) {
...
// quick smbus
    ...
    goto stop;
    lpi2c_imx.rx_buf = core::ptr::null_mut();
    lpi2c_imx.tx_buf = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_xfer(adapter: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_xfer_atomic(adapter: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_master_isr(lpi2c_imx: *mut lpi2c_imx_struct) -> irqreturn_t {
    ...
    complete(&lpi2c_imx.complete);
#[no_mangle]
pub unsafe extern "C" fn if(MSR_RDF: temp &) -> else {
    else if (temp & MSR_RDF)
    lpi2c_imx_read_rxfifo(lpi2c_imx, false);
#[no_mangle]
pub unsafe extern "C" fn if(MSR_TDF: temp &) -> else {
    else if (temp & MSR_TDF)
    lpi2c_imx_write_txfifo(lpi2c_imx, false);
    return IRQ_HANDLED;
    }
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t lpi2c_imx_isr(int irq, void *dev_id)
    {
    struct lpi2c_imx_struct *lpi2c_imx = dev_id;
    if (lpi2c_imx.target) {
    let mut scr: u32 = readl(lpi2c_imx.base + LPI2C_SCR);
    let mut ssr: u32 = readl(lpi2c_imx.base + LPI2C_SSR);
    let mut sier_filter: u32 = ssr & readl(lpi2c_imx.base + LPI2C_SIER);
//
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_target_init(lpi2c_imx: *mut lpi2c_imx_struct) {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_register_target(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_unregister_target(client: *mut i2c_client) -> c_int {
...
// Reset target address.
    ...
    writel(SCR_RST, lpi2c_imx.base + LPI2C_SCR);
    writel(0, lpi2c_imx.base + LPI2C_SCR);
    lpi2c_imx.target = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lpi2c_dma_init(dev: *mut device, phy_addr: dma_addr_t) -> c_int {
...
//
    group = devres_open_group(dev, core::ptr::null_mut(), GFP_KERNEL);
    if (!group)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_imx_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_runtime_suspend(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused lpi2c_runtime_suspend(struct device *dev)
    {
    struct lpi2c_imx_struct *lpi2c_imx = dev_get_drvdata(dev);
    let mut need_prepare_unprepare_clk: bool = lpi2c_imx.hwdata.need_prepare_unprepare_clk;
    let mut need_request_free_irq: bool = lpi2c_imx.hwdata.need_request_free_irq;
...
#[no_mangle]
unsafe extern "C" fn lpi2c_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_suspend_noirq(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_resume_noirq(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpi2c_resume(dev: *mut device) -> c_int {
    ...
    lpi2c_runtime_resume, core::ptr::null_mut())
    };
