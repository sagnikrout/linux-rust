...
//! Source: drivers/i2c/busses/i2c-opal.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn i2c_opal_translate_error(rc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_opal_send_request(bus_id: u32, req: *mut opal_i2c_request) -> c_int {
    ...
    int num)
    {
    let mut opal_id: c_ulong = (unsigned long)adap.algo_data;
...
#[no_mangle]
unsafe extern "C" fn i2c_opal_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_opal_probe(pdev: *mut platform_device) -> c_int {
    ...
    pname = of_get_property(pdev.dev.of_node, "ibm,port-name", core::ptr::null_mut());
    if (pname)
...
#[no_mangle]
unsafe extern "C" fn i2c_opal_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn i2c_opal_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn i2c_opal_exit() -> void __exit {
