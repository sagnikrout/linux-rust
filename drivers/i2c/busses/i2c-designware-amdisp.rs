...
//! Source: drivers/i2c/busses/i2c-designware-amdisp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn amd_isp_dw_i2c_plat_pm_cleanup(i2c_dev: *mut dw_i2c_dev) {
    static void amd_isp_dw_i2c_plat_pm_cleanup(struct dw_i2c_dev *i2c_dev)
    {
    pm_runtime_disable(i2c_dev.dev);
    }
#[no_mangle]
pub unsafe extern "C" fn amd_isp_dw_i2c_get_clk_rate(i2c_dev: *mut dw_i2c_dev) -> u32 {
    static inline u32 amd_isp_dw_i2c_get_clk_rate(struct dw_i2c_dev *i2c_dev)
    {
    return AMD_ISP_I2C_INPUT_CLK * 1000;
    }
#[no_mangle]
unsafe extern "C" fn amd_isp_dw_i2c_plat_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_isp_dw_i2c_plat_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn amd_isp_dw_i2c_plat_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_isp_dw_i2c_plat_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_isp_dw_i2c_plat_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_isp_dw_i2c_plat_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_isp_dw_i2c_plat_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(amd_isp_dw_i2c_plat_runtime_suspend, amd_isp_dw_i2c_plat_runtime_resume, core::ptr::null_mut())
    };
