...
//! Source: drivers/i2c/busses/i2c-rtl9300.c
#![no_std]
...
pub const RTL9300_I2C_MAX_SUPER_FAST_FREQ: c_int = 2500000;
pub const RTL9300_I2C_MAX_SLOW_FREQ: c_int = 50000;
    struct rtl9300_i2c;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl9300_i2c_chan {
    pub adap: i2c_adapter,
    pub i2c: *mut rtl9300_i2c,
    pub bus_freq: enum rtl9300_bus_freq,
    pub sda_num: u8,
    pub clk_div: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl9300_i2c_reg_field {
    pub field: reg_field,
    pub scope: enum rtl9300_i2c_reg_scope,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl9300_i2c_drv_data {
    pub field_desc: [rtl9300_i2c_reg_field; F_NUM_FIELDS],
    pub scl): *mut *mut *mut int (select_scl)(struct rtl9300_i2c i2c, u8,
    pub chan): *mut *mut *mut int (config_chan)(struct rtl9300_i2c i2c, struct rtl9300_i2c_chan,
    pub chan): *mut *mut void (config_clock)(u32 clock_freq, struct rtl9300_i2c_chan,
    pub i2c): *mut *mut int (misc_init)(struct rtl9300_i2c,
    pub rd_reg: u32,
    pub wd_reg: u32,
    pub max_nchan: u8,
    pub max_data_len: u8,
    pub reg_addr_8bit_len: u8,
}

pub const RTL9300_I2C_MUX_NCHAN: c_int = 8;
pub const RTL9310_I2C_MUX_NCHAN: c_int = 12;
pub const RTL9607_I2C_MUX_NCHAN: c_int = 1;
pub const RTL9300_I2C_MAX_DATA_LEN: c_int = 16;
pub const RTL9607_I2C_MAX_DATA_LEN: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl9300_i2c {
    pub regmap: *mut regmap,
    pub dev: *mut device,
    pub chans: [rtl9300_i2c_chan; RTL9310_I2C_MUX_NCHAN],
    pub fields: [*mut regmap_field; F_NUM_FIELDS],
    pub reg_base: u32,
    pub rd_reg: u32,
    pub wd_reg: u32,
    pub scl_num: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtl9300_i2c_xfer {
    pub type: enum rtl9300_i2c_xfer_type,
    pub dev_addr: u16,
    pub reg_addr: u8,
    pub reg_addr_len: u8,
    pub data: *mut u8,
...
pub const RTL9300_I2C_MST_CTRL1: c_uint = 0x0;
pub const RTL9300_I2C_MST_CTRL2: c_uint = 0x4;
pub const RTL9300_I2C_MST_DATA_WORD0: c_uint = 0x8;
pub const RTL9300_I2C_MST_DATA_WORD1: c_uint = 0xc;
pub const RTL9300_I2C_MST_DATA_WORD2: c_uint = 0x10;
pub const RTL9300_I2C_MST_DATA_WORD3: c_uint = 0x14;
pub const RTL9300_I2C_MST_GLB_CTRL: c_uint = 0x384;
pub const RTL9300_REG_ADDR_8BIT_LEN: c_int = 1;
pub const RTL9310_I2C_MST_IF_CTRL: c_uint = 0x1004;
pub const RTL9310_I2C_MST_IF_SEL: c_uint = 0x1008;
pub const RTL9310_I2C_MST_CTRL: c_uint = 0x0;
pub const RTL9310_I2C_MST_MEMADDR_CTRL: c_uint = 0x4;
pub const RTL9310_I2C_MST_DATA_CTRL: c_uint = 0x8;
pub const RTL9607_I2C_CONFIG: c_uint = 0x22f50;
pub const RTL9607_IO_MODE_EN: c_uint = 0x23014;
pub const RTL9607_I2C_IND_WD: c_uint = 0x0;
pub const RTL9607_I2C_IND_ADR: c_uint = 0x8;
pub const RTL9607_I2C_IND_CMD: c_uint = 0x10;
pub const RTL9607_I2C_IND_RD: c_uint = 0x18;
pub const RTL9607_REG_ADDR_8BIT_LEN: c_int = 0;
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_reg_addr_set(i2c: *mut rtl9300_i2c, reg: u32, len: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_select_scl(i2c: *mut rtl9300_i2c, scl: u8) -> c_int {
    static int rtl9300_i2c_select_scl(struct rtl9300_i2c *i2c, u8 scl)
    {
    return regmap_field_write(i2c.fields[F_SCL_SEL], 1);
    }
#[no_mangle]
unsafe extern "C" fn rtl9310_i2c_select_scl(i2c: *mut rtl9300_i2c, scl: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_config_chan(i2c: *mut rtl9300_i2c, chan: *mut rtl9300_i2c_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl9607_i2c_config_chan(i2c: *mut rtl9300_i2c, chan: *mut rtl9300_i2c_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_config_clock(clock_freq: u32, chan: *mut rtl9300_i2c_chan) {
...
#[no_mangle]
unsafe extern "C" fn rtl9607_i2c_config_clock(clock_freq: u32, chan: *mut rtl9300_i2c_chan) {
...
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_read(i2c: *mut rtl9300_i2c, buf: *mut u8, len: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_write(i2c: *mut rtl9300_i2c, buf: *mut u8, len: u8) -> c_int {
    ...
    return -EIO;
    for (i = 0; i < len; i++) {
    let mut shift: c_uint = (i % 4) * 8;
    let mut reg: c_uint = i / 4;
    vals[reg] |= buf[i] << shift;
    }
    return regmap_bulk_write(i2c.regmap, i2c.wd_reg, vals, ARRAY_SIZE(vals));
    }
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_writel(i2c: *mut rtl9300_i2c, data: u32) -> c_int {
    static int rtl9300_i2c_writel(struct rtl9300_i2c *i2c, u32 data)
    {
    return regmap_write(i2c.regmap, i2c.wd_reg, data);
    }
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_prepare_xfer(i2c: *mut rtl9300_i2c, xfer: *mut rtl9300_i2c_xfer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_do_xfer(i2c: *mut rtl9300_i2c, xfer: *mut rtl9300_i2c_xfer) -> c_int {
...
// xfer->data = val & 0xff;
    ...
    const struct rtl9300_i2c_drv_data *drv_data;
    struct rtl9300_i2c *i2c = chan.i2c;
    let mut xfer: rtl9300_i2c_xfer = {0};
    int ret;
    if (addr > 0x7f)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_func(a: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_init(i2c: *mut rtl9300_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtl9607_i2c_init(i2c: *mut rtl9300_i2c) -> c_int {
    static int rtl9607_i2c_init(struct rtl9300_i2c *i2c)
    {
    return regmap_field_write(i2c.fields[F_EXT_SCK_5MS], 1);
    }
#[no_mangle]
unsafe extern "C" fn rtl9300_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    return ret;
    i2c.clk = devm_clk_get_optional_enabled(dev, core::ptr::null_mut());
    if (IS_ERR(i2c.clk))
