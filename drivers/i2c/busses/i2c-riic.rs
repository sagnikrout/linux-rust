...
//! Source: drivers/i2c/busses/i2c-riic.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct riic_of_data {
    pub regs: *const u8,
    pub irqs: *const riic_irq_desc,
    pub num_irqs: u8,
...
#[no_mangle]
pub unsafe extern "C" fn riic_writeb(riic: *mut riic_dev, val: u8, offset: u8) {
    static inline void riic_writeb(struct riic_dev *riic, u8 val, u8 offset)
    {
    writeb(val, riic.base + riic.info.regs[offset]);
    }
#[no_mangle]
pub unsafe extern "C" fn riic_readb(riic: *mut riic_dev, offset: u8) -> u8 {
    static inline u8 riic_readb(struct riic_dev *riic, u8 offset)
    {
    return readb(riic.base + riic.info.regs[offset]);
    }
#[no_mangle]
pub unsafe extern "C" fn riic_clear_set_bit(riic: *mut riic_dev, clear: u8, set: u8, reg: u8) {
    static inline void riic_clear_set_bit(struct riic_dev *riic, u8 clear, u8 set, u8 reg)
    {
    riic_writeb(riic, (riic_readb(riic, reg) & ~clear) | set, reg);
    }
#[no_mangle]
unsafe extern "C" fn riic_bus_barrier(riic: *mut riic_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riic_xfer(adap: *mut i2c_adapter, msgs[]: i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riic_tdre_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn riic_tend_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn riic_rdrf_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn riic_stop_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn riic_eei_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t riic_eei_isr(int irq, void *data)
    {
    let mut icsr2: u8 = riic_readb(data, RIIC_ICSR2);
...
#[no_mangle]
unsafe extern "C" fn riic_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn riic_init_hw(riic: *mut riic_dev) -> c_int {
    ...
    let mut fast_mode_plus: bool = riic.info.fast_mode_plus;
...
#[no_mangle]
unsafe extern "C" fn riic_get_scl(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riic_get_sda(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riic_set_scl(adap: *mut i2c_adapter, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn riic_set_sda(adap: *mut i2c_adapter, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn riic_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    riic.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(riic.clk))
    return dev_err_probe(dev, PTR_ERR(riic.clk),
    "missing controller clock");
    riic.rstc = devm_reset_control_get_optional_exclusive_deasserted(dev, core::ptr::null_mut());
    if (IS_ERR(riic.rstc))
...
#[no_mangle]
unsafe extern "C" fn riic_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn riic_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riic_i2c_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riic_i2c_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riic_i2c_resume_noirq(dev: *mut device) -> c_int {
