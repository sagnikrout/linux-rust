...
//! Source: drivers/i2c/busses/i2c-rzv2m.c
#![no_std]
...
// Register offsets
pub const IICB0DAT: c_uint = 0x00		/* Data Register */;
pub const IICB0CTL0: c_uint = 0x08		/* Control Register 0 */;
pub const IICB0TRG: c_uint = 0x0C		/* Trigger Register */;
pub const IICB0STR0: c_uint = 0x10		/* Status Register 0 */;
pub const IICB0CTL1: c_uint = 0x20		/* Control Register 1 */;
pub const IICB0WL: c_uint = 0x24		/* Low Level Width Setting Reg */;
pub const IICB0WH: c_uint = 0x28		/* How Level Width Setting Reg */;
// IICB0CTL0
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rzv2m_i2c_priv {
    pub base: *mut void __iomem,
    pub adap: i2c_adapter,
    pub clk: *mut clk,
    pub bus_mode: c_int,
    pub msg_tia_done: completion,
    pub iicb0wl: u32,
    pub iicb0wh: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bitrate_config {
    pub percent_low: c_uint,
    pub min_hold_time_ns: c_uint,
}
...
#[no_mangle]
pub unsafe extern "C" fn bit_setl(addr: *mut void __iomem, val: u32) {
    static inline void bit_setl(void __iomem *addr, u32 val)
    {
    writel(readl(addr) | val, addr);
    }
#[no_mangle]
pub unsafe extern "C" fn bit_clrl(addr: *mut void __iomem, val: u32) {
    static inline void bit_clrl(void __iomem *addr, u32 val)
    {
    writel(readl(addr) & ~val, addr);
    }
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_tia_irq_handler(this_irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_init(priv: *mut rzv2m_i2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_write_with_ack(priv: *mut rzv2m_i2c_priv, data: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_stop_condition(priv: *mut rzv2m_i2c_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_disable(dev: *mut device, priv: *mut rzv2m_i2c_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rzv2m_i2c_resume(dev: *mut device) -> c_int {
