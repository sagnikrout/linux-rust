...
//! Source: drivers/i2c/busses/i2c-rcar.c
#![no_std]
...
// register offsets
pub const ICSCR: c_uint = 0x00	/* slave ctrl */;
pub const ICMCR: c_uint = 0x04	/* master ctrl */;
pub const ICSSR: c_uint = 0x08	/* slave status */;
pub const ICMSR: c_uint = 0x0C	/* master status */;
pub const ICSIER: c_uint = 0x10	/* slave irq enable */;
pub const ICMIER: c_uint = 0x14	/* master irq enable */;
pub const ICCCR: c_uint = 0x18	/* clock dividers */;
pub const ICSAR: c_uint = 0x1C	/* slave address */;
pub const ICMAR: c_uint = 0x20	/* master address */;
pub const ICRXTX: c_uint = 0x24	/* data port */;
pub const ICCCR2: c_uint = 0x28	/* Clock control 2 */;
pub const ICMPR: c_uint = 0x2C	/* SCL mask control */;
pub const ICHPR: c_uint = 0x30	/* SCL HIGH control */;
pub const ICLPR: c_uint = 0x34	/* SCL LOW control */;
pub const ICFBSCR: c_uint = 0x38	/* first bit setup cycle (Gen3) */;
pub const ICDMAER: c_uint = 0x3c	/* DMA enable (Gen3) */;
// ICSCR
...
// ICFBSCR
pub const TCYC17: c_uint = 0x0f		/* 17*Tcyc delay 1st bit between SDA and SCL */;
pub const RCAR_MIN_DMA_LEN: c_int = 8;
// SCL low/high ratio 5:4 to meet all I2C timing specs (incl safety margin)
pub const RCAR_SCLD_RATIO: c_int = 5;
pub const RCAR_SCHD_RATIO: c_int = 4;
//
...
//
pub const RCAR_DEFAULT_SMD: c_int = 20;
...
pub struct rcar_i2c_priv {
    ...
    pub scld: u16,
    pub smd: u8,
    pub /: *mut *mut u8 recovery_icmcr; / protected by adapter lock,
    pub devtype: enum rcar_i2c_type,
    pub slave: *mut i2c_client,
    pub res: *mut resource,
    pub dma_tx: *mut dma_chan,
    pub dma_rx: *mut dma_chan,
    pub sg: scatterlist,
    pub dma_direction: enum dma_data_direction,
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_write(priv: *mut rcar_i2c_priv, reg: c_int, val: u32) {
    static void rcar_i2c_write(struct rcar_i2c_priv *priv, int reg, u32 val)
    {
    writel(val, priv.io + reg);
    }
#[no_mangle]
unsafe extern "C" fn rcar_i2c_read(priv: *mut rcar_i2c_priv, reg: c_int) -> u32 {
    static u32 rcar_i2c_read(struct rcar_i2c_priv *priv, int reg)
    {
    return readl(priv.io + reg);
    }
#[no_mangle]
unsafe extern "C" fn rcar_i2c_clear_irq(priv: *mut rcar_i2c_priv, val: u32) {
    static void rcar_i2c_clear_irq(struct rcar_i2c_priv *priv, u32 val)
    {
    writel(~val & 0x7f, priv.io + ICMSR);
    }
#[no_mangle]
unsafe extern "C" fn rcar_i2c_get_scl(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_set_scl(adap: *mut i2c_adapter, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_set_sda(adap: *mut i2c_adapter, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_get_bus_free(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_init(priv: *mut rcar_i2c_priv) {
...
// start clock
    ...
    let mut icccr2: u32 = CDFD | HLSE | SME;
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_reset_slave(priv: *mut rcar_i2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_bus_barrier(priv: *mut rcar_i2c_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_clock_calculate(priv: *mut rcar_i2c_priv) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_i2c_prepare_msg(priv: *mut rcar_i2c_priv) {
    static void rcar_i2c_prepare_msg(struct rcar_i2c_priv *priv)
    {
    let mut read: c_int = !!rcar_i2c_is_recv(priv);
    let mut rep_start: bool = !(priv.flags & ID_REP_AFTER_RD);
    priv.pos = 0;
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_next_msg(priv: *mut rcar_i2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_cleanup_dma(priv: *mut rcar_i2c_priv, terminate: bool) {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_dma_callback(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_dma(priv: *mut rcar_i2c_priv) -> bool {
    static bool rcar_i2c_dma(struct rcar_i2c_priv *priv)
    {
    struct device *dev = rcar_i2c_priv_to_dev(priv);
    struct i2c_msg *msg = priv.msg;
    let mut read: bool = msg.flags & I2C_M_RD;
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_irq_send(priv: *mut rcar_i2c_priv, msr: u32) {
    static void rcar_i2c_irq_send(struct rcar_i2c_priv *priv, u32 msr)
    {
    struct i2c_msg *msg = priv.msg;
    let mut irqs_to_clear: u32 = MDE;
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_irq_recv(priv: *mut rcar_i2c_priv, msr: u32) {
    static void rcar_i2c_irq_recv(struct rcar_i2c_priv *priv, u32 msr)
    {
    struct i2c_msg *msg = priv.msg;
    let mut recv_len_init: bool = priv.pos == 0 && msg.flags & I2C_M_RECV_LEN;
    let mut irqs_to_clear: u32 = MDR;
// FIXME: sometimes, unknown interrupt happened. Do nothing
    if (!(msr & MDR))
    return;
    if (msr & MAT) {
...
// get received data
    let mut data: u8 = rcar_i2c_read(priv, ICRXTX);
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_slave_irq(priv: *mut rcar_i2c_priv) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn rcar_i2c_irq(irq: c_int, priv: *mut rcar_i2c_priv, msr: u32) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_gen2_irq(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_gen3_irq(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_release_dma(priv: *mut rcar_i2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_do_reset(priv: *mut rcar_i2c_priv) -> c_int {
...
// Check bus state before init otherwise bus busy info will be lost
    ...
    do {
    let mut msr: u32 = rcar_i2c_read(priv, ICMSR);
...
#[no_mangle]
unsafe extern "C" fn rcar_reg_slave(slave: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_unreg_slave(slave: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rcar_i2c_resume(dev: *mut device) -> c_int {
