...
//! Source: drivers/i2c/busses/i2c-mxs.c
#![no_std]
...
pub const MXS_I2C_CTRL0_SFTRST: c_uint = 0x80000000;
pub const MXS_I2C_CTRL0_RUN: c_uint = 0x20000000;
pub const MXS_I2C_CTRL0_SEND_NAK_ON_LAST: c_uint = 0x02000000;
pub const MXS_I2C_CTRL0_PIO_MODE: c_uint = 0x01000000;
pub const MXS_I2C_CTRL0_RETAIN_CLOCK: c_uint = 0x00200000;
pub const MXS_I2C_CTRL0_POST_SEND_STOP: c_uint = 0x00100000;
pub const MXS_I2C_CTRL0_PRE_SEND_START: c_uint = 0x00080000;
pub const MXS_I2C_CTRL0_MASTER_MODE: c_uint = 0x00020000;
pub const MXS_I2C_CTRL0_DIRECTION: c_uint = 0x00010000;

pub const MXS_I2C_CTRL1_CLR_GOT_A_NAK: c_uint = 0x10000000;
pub const MXS_I2C_CTRL1_BUS_FREE_IRQ: c_uint = 0x80;
pub const MXS_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ: c_uint = 0x40;
pub const MXS_I2C_CTRL1_NO_SLAVE_ACK_IRQ: c_uint = 0x20;
pub const MXS_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ: c_uint = 0x10;
pub const MXS_I2C_CTRL1_EARLY_TERM_IRQ: c_uint = 0x08;
pub const MXS_I2C_CTRL1_MASTER_LOSS_IRQ: c_uint = 0x04;
pub const MXS_I2C_CTRL1_SLAVE_STOP_IRQ: c_uint = 0x02;
pub const MXS_I2C_CTRL1_SLAVE_IRQ: c_uint = 0x01;

pub const MXS_I2C_STAT_GOT_A_NAK: c_uint = 0x10000000;
pub const MXS_I2C_STAT_BUS_BUSY: c_uint = 0x00000800;
pub const MXS_I2C_STAT_CLK_GEN_BUSY: c_uint = 0x00000400;

pub const MXS_I2C_DEBUG0_DMAREQ: c_uint = 0x80000000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mxs_i2c_dev {
    pub dev: *mut device,
    pub dev_type: enum mxs_i2c_devtype,
...
// DMA support components
    ...
    pub pio_data: [u32; 2],
    pub addr_data: u32,
    pub sg_io: [scatterlist; 2],
    pub dma_read: bool,
}

#[no_mangle]
unsafe extern "C" fn mxs_i2c_reset(i2c: *mut mxs_i2c_dev) -> c_int {
    static int mxs_i2c_reset(struct mxs_i2c_dev *i2c)
    {
    let mut ret: c_int = stmp_reset_block(i2c.regs);
    if (ret)
    return ret;
//
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_dma_finish(i2c: *mut mxs_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_dma_irq_callback(param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_pio_wait_xfer_end(i2c: *mut mxs_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_pio_check_error_state(i2c: *mut mxs_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_pio_trigger_cmd(i2c: *mut mxs_i2c_dev, cmd: u32) {
...
//
    ...
    {
    struct mxs_i2c_dev *i2c = i2c_get_adapdata(adap);
    let mut addr_data: u32 = i2c_8bit_addr_from_msg(msg);
    let mut data: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_func(adap: *mut i2c_adapter) -> u32 {
    static u32 mxs_i2c_func(struct i2c_adapter *adap)
    {
    return I2C_FUNC_I2C | I2C_FUNC_SMBUS_EMUL;
    }
#[no_mangle]
unsafe extern "C" fn mxs_i2c_isr(this_irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t mxs_i2c_isr(int this_irq, void *dev_id)
    {
    struct mxs_i2c_dev *i2c = dev_id;
    let mut stat: u32 = readl(i2c.regs + MXS_I2C_CTRL1) & MXS_I2C_IRQ_MASK;
    if (!stat)
    return IRQ_NONE;
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_derive_timing(i2c: *mut mxs_i2c_dev, speed: u32) {
    static void mxs_i2c_derive_timing(struct mxs_i2c_dev *i2c, uint32_t speed)
    {
// The I2C block clock runs at 24MHz
    let mut clk: u32 = 24000000;
    uint32_t divider;
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_get_ofdata(i2c: *mut mxs_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mxs_i2c_exit() -> void __exit {
