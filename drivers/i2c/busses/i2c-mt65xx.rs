...
//! Source: drivers/i2c/busses/i2c-mt65xx.c
#![no_std]
...
pub const I2C_DCM_DISABLE: c_uint = 0x0000;
pub const I2C_IO_CONFIG_OPEN_DRAIN: c_uint = 0x0003;
pub const I2C_IO_CONFIG_PUSH_PULL: c_uint = 0x0000;
pub const I2C_SOFT_RST: c_uint = 0x0001;
pub const I2C_HANDSHAKE_RST: c_uint = 0x0020;
pub const I2C_FIFO_ADDR_CLR: c_uint = 0x0001;
pub const I2C_DELAY_LEN: c_uint = 0x0002;
pub const I2C_ST_START_CON: c_uint = 0x8001;
pub const I2C_FS_START_CON: c_uint = 0x1800;
pub const I2C_TIME_CLR_VALUE: c_uint = 0x0000;
pub const I2C_TIME_DEFAULT_VALUE: c_uint = 0x0003;
pub const I2C_WRRD_TRANAC_VALUE: c_uint = 0x0002;
pub const I2C_RD_TRANAC_VALUE: c_uint = 0x0001;
pub const I2C_SCL_MIS_COMP_VALUE: c_uint = 0x0000;
pub const I2C_CHN_CLR_FLAG: c_uint = 0x0000;
pub const I2C_RELIABILITY: c_uint = 0x0010;
pub const I2C_DMAACK_ENABLE: c_uint = 0x0008;
pub const I2C_DMA_CON_TX: c_uint = 0x0000;
pub const I2C_DMA_CON_RX: c_uint = 0x0001;
pub const I2C_DMA_ASYNC_MODE: c_uint = 0x0004;
pub const I2C_DMA_SKIP_CONFIG: c_uint = 0x0010;
pub const I2C_DMA_DIR_CHANGE: c_uint = 0x0200;
pub const I2C_DMA_START_EN: c_uint = 0x0001;
pub const I2C_DMA_INT_FLAG_NONE: c_uint = 0x0000;
pub const I2C_DMA_CLR_FLAG: c_uint = 0x0000;
pub const I2C_DMA_WARM_RST: c_uint = 0x0001;
pub const I2C_DMA_HARD_RST: c_uint = 0x0002;
pub const I2C_DMA_HANDSHAKE_RST: c_uint = 0x0004;
pub const MAX_SAMPLE_CNT_DIV: c_int = 8;
pub const MAX_STEP_CNT_DIV: c_int = 64;
pub const MAX_CLOCK_DIV_8BITS: c_int = 256;
pub const MAX_CLOCK_DIV_5BITS: c_int = 32;
pub const MAX_HS_STEP_CNT_DIV: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_i2c_compatible {
    pub quirks: *const i2c_adapter_quirks,
    pub regs: *const u16,
    pub 1: unsigned char pmic_i2c:,
    pub 1: unsigned char dcm:,
    pub 1: unsigned char auto_restart:,
    pub 1: unsigned char aux_len_reg:,
    pub 1: unsigned char timing_adjust:,
    pub 1: unsigned char dma_sync:,
    pub 1: unsigned char ltiming_adjust:,
    pub 1: unsigned char apdma_sync:,
    pub max_dma_support: c_uchar,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_i2c_ac_timing {
    pub htiming: u16,
    pub ltiming: u16,
    pub hs: u16,
    pub ext: u16,
    pub inter_clk_div: u16,
    pub scl_hl_ratio: u16,
    pub hs_scl_hl_ratio: u16,
    pub sta_stop: u16,
    pub hs_sta_stop: u16,
    pub sda_timing: u16,
}
...
#[derive(Copy, Clone)]
pub struct mtk_i2c {
    pub /: *mut *mut i2c_adapter adap; / i2c host adapter,
    pub dev: *mut device,
    pub msg_complete: completion,
    pub timing_info: i2c_timings,
// set in i2c probe
    pub /: *mut *mut *mut void __iomem base; / i2c base addr,
    pub address*/: *mut *mut *mut void __iomem pdmabase; / dma base,
    pub /: *mut *mut clk_bulk_data clocks[I2C_MT65XX_CLK_MAX]; / clocks for i2c,
    pub /: *mut *mut bool have_pmic; / can use i2c pins from PMIC,
    pub /: *mut *mut bool use_push_pull; / IO config push-pull mode,
    pub /: *mut *mut u16 irq_stat; / interrupt status,
    pub clk_src_div: c_uint,
    pub /: *mut *mut unsigned int speed_hz; / The speed in transfer,
    pub op: enum mtk_trans_op,
    pub timing_reg: u16,
    pub high_speed_reg: u16,
    pub ltiming_reg: u16,
    pub auto_restart: c_uchar,
    pub ignore_restart_irq: bool,
    pub ac_timing: mtk_i2c_ac_timing,
    pub dev_comp: *const mtk_i2c_compatible,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_spec_values {
    pub min_low_ns: c_uint,
    pub min_su_sta_ns: c_uint,
    pub max_hd_dat_ns: c_uint,
    pub min_su_dat_ns: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_readw(i2c: *mut mtk_i2c, reg: enum I2C_REGS_OFFSET) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_init_hw(i2c: *mut mtk_i2c) {
...
#[no_mangle]
pub unsafe extern "C" fn if(I2C_MAX_FAST_MODE_FREQ: speed <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_max_step_cnt(target_speed: c_uint) -> c_int {
    ...
    {
    let mut clk_div_restri: c_int = 0;
    ...
    clk_div_restri = -1;
#[no_mangle]
pub unsafe extern "C" fn if(1: i2c->ac_timing.inter_clk_div ==) -> else {
...
//
    ...
    let mut base_sample_cnt: c_uint = MAX_SAMPLE_CNT_DIV;
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_set_speed(i2c: *mut mtk_i2c, parent_clk: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: i2c->dev_comp->timing_adjust) -> else {
...
#[no_mangle]
unsafe extern "C" fn i2c_dump_register(i2c: *mut mtk_i2c) {
    ...
    u16 start_reg;
    u16 control_reg;
    let mut restart_flag: u16 = 0;
    let mut dma_sync: u16 = 0;
    u32 reg_4g_mode;
    u32 reg_dma_reset;
    u8 *dma_rd_buf = core::ptr::null_mut();
    u8 *dma_wr_buf = core::ptr::null_mut();
    let mut rpaddr: dma_addr_t = 0;
    let mut wpaddr: dma_addr_t = 0;
    int ret;
    i2c.irq_stat = 0;
    if (i2c.auto_restart)
...
// Clear interrupt mask
    ...
    {
    int ret;
    let mut left_num: c_int = num;
    let mut write_then_read_en: bool = false;
...
//
    ...
    while (left_num--) {
    if (!msgs.buf) {
    dev_dbg(i2c.dev, "data buffer is core::ptr::null_mut().\n");
    ret = -EINVAL;
    goto err_exit;
    }
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_irq(irqno: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t mtk_i2c_irq(int irqno, void *dev_id)
    {
    struct mtk_i2c *i2c = dev_id;
    let mut restart_flag: u16 = i2c.auto_restart ? I2C_RS_TRANSFER : 0;
    u16 intr_stat;
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_parse_dt(np: *mut device_node, i2c: *mut mtk_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!i2c)
    return -ENOMEM;
    i2c.base = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    if (IS_ERR(i2c.base))
    return PTR_ERR(i2c.base);
    i2c.pdmabase = devm_platform_get_and_ioremap_resource(pdev, 1, core::ptr::null_mut());
    ...
    i2c.adap.bus_regulator = core::ptr::null_mut();
    else
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_i2c_resume_noirq(dev: *mut device) -> c_int {
