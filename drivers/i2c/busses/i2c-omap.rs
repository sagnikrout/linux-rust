...
//! Source: drivers/i2c/busses/i2c-omap.c
#![no_std]
...
pub const OMAP_I2C_OMAP1_REV_2: c_uint = 0x20;
// I2C controller revisions present on specific hardware
pub const OMAP_I2C_REV_ON_2430: c_uint = 0x00000036;
pub const OMAP_I2C_REV_ON_3430_3530: c_uint = 0x0000003C;
pub const OMAP_I2C_REV_ON_3630: c_uint = 0x00000040;
pub const OMAP_I2C_REV_ON_4430_PLUS: c_uint = 0x50400002;
...
pub const OMAP_I2C_SCLL_HSSCLL: c_int = 8;
pub const OMAP_I2C_SCLH_HSSCLH: c_int = 8;
...
pub const SYSC_IDLEMODE_SMART: c_uint = 0x2;
pub const SYSC_CLOCKACTIVITY_FCLK: c_uint = 0x2;
// Errata definitions

pub const OMAP_I2C_IP_V2_INTERRUPTS_MASK: c_uint = 0x6FFF;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_i2c_dev {
    pub dev: *mut device,
    pub /: *mut *mut *mut void __iomem base; / virtual,
    pub irq: c_int,
    pub /: *mut *mut int reg_shift; / bit shift for I2C register addresses,
    pub cmd_complete: completion,
    pub ioarea: *mut resource,
    pub /: *mut *mut u32 latency; / maximum mpu wkup latency,
    void			(*set_mpu_wkup_lat)(struct device *dev,
    pub latency): c_long,
    pub /: *mut *mut u32 speed; / Speed of bus in kHz,
    pub flags: u32,
    pub scheme: u16,
    pub cmd_err: u16,
    pub buf: *mut u8,
    ...
    pub threshold: u8,
    pub value: *mut *mut u8 fifo_size; / use as flag and,
// fifo_size==0 implies no fifo
// if set, should be trsh+1
//
    pub rev: u32,
    pub /: *mut *mut unsigned b_hw:1; / bad h/w fixes,
    pub reflects: *mut *mut unsigned bb_valid:1; / true when BB-bit,
// the I2C bus state
//
    pub /: *mut *mut unsigned receiver:1; / true when we're in receiver mode,
    pub /: *mut *mut u16 iestate; / Saved interrupt register,
    pub pscstate: u16,
    pub scllstate: u16,
    pub sclhstate: u16,
    pub syscstate: u16,
...
#[no_mangle]
pub unsafe extern "C" fn omap_i2c_read_reg(omap: *mut omap_i2c_dev, reg: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn __omap_i2c_init(omap: *mut omap_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_reset(omap: *mut omap_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_init(omap: *mut omap_i2c_dev) -> c_int {
    static int omap_i2c_init(struct omap_i2c_dev *omap)
    {
    let mut psc: u16 = 0, scll = 0, sclh = 0;
    let mut fsscll: u16 = 0, fssclh = 0, hsscll = 0, hssclh = 0;
    let mut fclk_rate: c_ulong = 12000000;
    let mut internal_clk: c_ulong = 0;
    struct clk *fclk;
    int error;
    if (omap.rev >= OMAP_I2C_REV_ON_3430_3530) {
//
...
//
    ...
    internal_clk = 19200;
#[no_mangle]
pub unsafe extern "C" fn if(100: omap->speed >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn omap_i2c_recover_bus(omap: *mut omap_i2c_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omap_i2c_wait_for_bb(omap: *mut omap_i2c_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn omap_i2c_wait_for_bb_valid(omap: *mut omap_i2c_dev) -> c_int {
    static int omap_i2c_wait_for_bb_valid(struct omap_i2c_dev *omap)
    {
    let mut bus_free_timeout: c_ulong = 0;
    unsigned long timeout;
    let mut bus_free: c_int = 0;
    u16 stat, systest;
    if (omap.bb_valid)
    return 0;
    timeout = jiffies + OMAP_I2C_TIMEOUT;
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_resize_fifo(omap: *mut omap_i2c_dev, size: u8, is_rx: bool) {
...
// calculate wakeup latency constraint for MPU
    if (omap.set_mpu_wkup_lat != core::ptr::null_mut())
    omap.latency = (1000000 * omap.threshold) /
    (1000 * omap.speed / 8);
    }
#[no_mangle]
unsafe extern "C" fn omap_i2c_wait(omap: *mut omap_i2c_dev) {
    static void omap_i2c_wait(struct omap_i2c_dev *omap)
    {
    u16 stat;
    let mut mask: u16 = omap_i2c_read_reg(omap, OMAP_I2C_IE_REG);
...
//
    if (omap.b_hw && stop) {
    let mut delay: c_ulong = jiffies + OMAP_I2C_TIMEOUT;
    let mut con: u16 = omap_i2c_read_reg(omap, OMAP_I2C_CON_REG);
...
#[no_mangle]
pub unsafe extern "C" fn i2c_omap_errata_i207(omap: *mut omap_i2c_dev, stat: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn errata_omap3_i462(omap: *mut omap_i2c_dev) -> c_int {
    static int errata_omap3_i462(struct omap_i2c_dev *omap)
    {
    let mut timeout: c_ulong = 10000;
    u16 stat;
    do {
    stat = omap_i2c_read_reg(omap, OMAP_I2C_STAT_REG);
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_xfer_data(omap: *mut omap_i2c_dev) -> c_int {
    static int omap_i2c_xfer_data(struct omap_i2c_dev *omap)
    {
    u16 bits;
    u16 stat;
...
pub const OMAP_I2C_SCHEME_0: c_int = 0;
pub const OMAP_I2C_SCHEME_1: c_int = 1;
#[no_mangle]
unsafe extern "C" fn omap_i2c_get_scl(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_get_sda(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_set_scl(adap: *mut i2c_adapter, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_prepare_recovery(adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_unprepare_recovery(adap: *mut i2c_adapter) {
...
// restore reset values
    ...
    if (pdev.dev.of_node) {
    let mut freq: u32 = I2C_MAX_STANDARD_MODE_FREQ;
    pdata = device_get_match_data(&pdev.dev);
    omap.flags = pdata.flags;
    of_property_read_u32(node, "clock-frequency", &freq);
// convert DT freq value in Hz into kHz for speed
    omap.speed = freq / 1000;
    } else if (pdata != core::ptr::null_mut()) {
...
// calculate wakeup latency constraint for MPU
    ...
    omap.mux_state = devm_mux_state_get_optional_selected(&pdev.dev, core::ptr::null_mut());
...
// reset ASAP, clearing any IRQs
    ...
    core::ptr::null_mut(), omap_i2c_isr_thread,
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_resume(dev: *mut device) -> c_int {
    ...
    omap_i2c_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn omap_i2c_exit_driver() -> void __exit {
