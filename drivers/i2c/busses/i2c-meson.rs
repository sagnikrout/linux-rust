...
//! Source: drivers/i2c/busses/i2c-meson.c
#![no_std]
...
pub const REG_SLAVE_ADDR: c_uint = 0x04;
pub const REG_TOK_LIST0: c_uint = 0x08;
pub const REG_TOK_LIST1: c_uint = 0x0c;
pub const REG_TOK_WDATA0: c_uint = 0x10;
pub const REG_TOK_WDATA1: c_uint = 0x14;
pub const REG_TOK_RDATA0: c_uint = 0x18;
pub const REG_TOK_RDATA1: c_uint = 0x1c;
// Control register fields

pub const REG_CTRL_CLKDIV_SHIFT: c_int = 12;

pub const REG_CTRL_CLKDIVEXT_SHIFT: c_int = 28;

pub const REG_SLV_SCL_LOW_SHIFT: c_int = 16;

pub const I2C_TIMEOUT_MS: c_int = 500;
pub const FILTER_DELAY: c_int = 15;
    enum {
    TOKEN_END = 0,
    TOKEN_START,
...
pub struct meson_i2c {
    ...
    pub data: *const meson_i2c_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_i2c_data {
    pub freq): *mut *mut *mut void (set_clk_div)(struct meson_i2c i2c, unsigned int,
}
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_reset_tokens(i2c: *mut meson_i2c) {
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_add_token(i2c: *mut meson_i2c, token: c_int) {
...
#[no_mangle]
unsafe extern "C" fn meson_gxbb_axg_i2c_set_clk_div(i2c: *mut meson_i2c, freq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn meson6_i2c_set_clk_div(i2c: *mut meson_i2c, freq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_get_data(i2c: *mut meson_i2c, buf: *mut c_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_put_data(i2c: *mut meson_i2c, buf: *mut c_char, len: c_int) {
    static void meson_i2c_put_data(struct meson_i2c *i2c, char *buf, int len)
    {
    let mut wdata0: u32 = 0, wdata1 = 0;
    int i;
    for (i = 0; i < min(4, len); i++)
    wdata0 |= *buf++ << (i * 8);
    for (i = 4; i < min(8, len); i++)
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_prepare_xfer(i2c: *mut meson_i2c) {
    static void meson_i2c_prepare_xfer(struct meson_i2c *i2c)
    {
    let mut write: bool = !(i2c.msg.flags & I2C_M_RD);
    int i;
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_transfer_complete(i2c: *mut meson_i2c, ctrl: u32) {
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_irq(irqno: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_do_start(i2c: *mut meson_i2c, msg: *mut i2c_msg) {
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (irq < 0)
    return irq;
    ret = devm_request_irq(&pdev.dev, irq, meson_i2c_irq, 0, core::ptr::null_mut(), i2c);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn meson_i2c_remove(pdev: *mut platform_device) {
