...
//! Source: drivers/i2c/busses/i2c-cros-ec-tunnel.c
#![no_std]
...
pub const I2C_MAX_RETRIES: c_int = 3;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ec_i2c_device {
    pub dev: *mut device,
    pub adap: i2c_adapter,
    pub ec: *mut cros_ec_device,
    pub remote_bus: u16,
    pub request_buf: [u8; 256],
...
//
#[no_mangle]
unsafe extern "C" fn ec_i2c_count_message(i2c_msgs[]: i2c_msg, num: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ec_i2c_count_response(i2c_msgs[]: i2c_msg, num: c_int) -> c_int {
...
//
    ...
    return -ETIMEDOUT;
#[no_mangle]
pub unsafe extern "C" fn if(EC_I2C_STATUS_NAK: resp->i2c_status &) -> else {
    else if (resp.i2c_status & EC_I2C_STATUS_NAK)
    return -ENXIO;
#[no_mangle]
pub unsafe extern "C" fn if(EC_I2C_STATUS_ERROR: resp->i2c_status &) -> else {
...
// num = resp->num_msgs;
    ...
    let mut bus_num: u16 = bus.remote_bus;
    int request_len;
    int response_len;
    int alloc_size;
    int result;
...
#[no_mangle]
unsafe extern "C" fn ec_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ec_i2c_probe(pdev: *mut platform_device) -> c_int {
    static int ec_i2c_probe(struct platform_device *pdev)
    {
    struct cros_ec_device *ec = dev_get_drvdata(pdev.dev.parent);
    struct device *dev = &pdev.dev;
    struct ec_i2c_device *bus = core::ptr::null_mut();
    u32 remote_bus;
    int err;
    if (!ec)
...
#[no_mangle]
unsafe extern "C" fn ec_i2c_remove(dev: *mut platform_device) {
