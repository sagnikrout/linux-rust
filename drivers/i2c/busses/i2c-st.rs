...
//! Source: drivers/i2c/busses/i2c-st.c
#![no_std]
...
pub const SSC_STA: c_uint = 0x014;
pub const SSC_I2C: c_uint = 0x018;
pub const SSC_SLAD: c_uint = 0x01C;
pub const SSC_REP_START_HOLD: c_uint = 0x020;
pub const SSC_START_HOLD: c_uint = 0x024;
pub const SSC_REP_START_SETUP: c_uint = 0x028;
pub const SSC_DATA_SETUP: c_uint = 0x02C;
pub const SSC_STOP_SETUP: c_uint = 0x030;
pub const SSC_BUS_FREE: c_uint = 0x034;
pub const SSC_TX_FSTAT: c_uint = 0x038;
pub const SSC_RX_FSTAT: c_uint = 0x03C;
pub const SSC_PRE_SCALER_BRG: c_uint = 0x040;
pub const SSC_CLR: c_uint = 0x080;
pub const SSC_NOISE_SUPP_WIDTH: c_uint = 0x100;
pub const SSC_PRSCALER: c_uint = 0x104;
pub const SSC_NOISE_SUPP_WIDTH_DATAOUT: c_uint = 0x108;
pub const SSC_PRSCALER_DATAOUT: c_uint = 0x10c;
// SSC Control
...
// SSC Tx FIFO Status
pub const SSC_TX_FSTAT_STATUS: c_uint = 0x07;
// SSC Rx FIFO Status
pub const SSC_RX_FSTAT_STATUS: c_uint = 0x07;
// SSC Clear bit operation

// SSC Clock Prescaler
pub const SSC_PRSC_VALUE: c_uint = 0x0f;
pub const SSC_TXFIFO_SIZE: c_uint = 0x8;
pub const SSC_RXFIFO_SIZE: c_uint = 0x8;
    enum st_i2c_mode {
    I2C_MODE_STANDARD,
    I2C_MODE_FAST,
    I2C_MODE_END,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_i2c_timings {
    pub rate: u32,
    pub rep_start_hold: u32,
    pub rep_start_setup: u32,
    pub start_hold: u32,
    pub data_setup_time: u32,
    pub stop_setup_time: u32,
    pub bus_free_time: u32,
    pub sda_pulse_min_limit: u32,
}
...
pub struct st_i2c_dev {
    ...
    pub clk: *mut clk,
    pub mode: c_int,
    pub scl_min_width_us: u32,
    pub sda_min_width_us: u32,
    pub client: st_i2c_client,
    pub busy: bool,
}

#[no_mangle]
pub unsafe extern "C" fn st_i2c_set_bits(reg: *mut void __iomem, mask: u32) {
    static inline void st_i2c_set_bits(void __iomem *reg, u32 mask)
    {
    writel_relaxed(readl_relaxed(reg) | mask, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn st_i2c_clr_bits(reg: *mut void __iomem, mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_flush_rx_fifo(i2c_dev: *mut st_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_soft_reset(i2c_dev: *mut st_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn st_i2c_hw_config(i2c_dev: *mut st_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_recover_bus(i2c_adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_wait_free_bus(i2c_dev: *mut st_i2c_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn st_i2c_write_tx_fifo(i2c_dev: *mut st_i2c_dev, byte: u8) {
    static inline void st_i2c_write_tx_fifo(struct st_i2c_dev *i2c_dev, u8 byte)
    {
    let mut tbuf: u16 = byte << 1;
...
//
#[no_mangle]
unsafe extern "C" fn st_i2c_wr_fill_tx_fifo(i2c_dev: *mut st_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn st_i2c_rd_fill_tx_fifo(i2c_dev: *mut st_i2c_dev, max: u32) {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_read_rx_fifo(i2c_dev: *mut st_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn st_i2c_terminate_xfer(i2c_dev: *mut st_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn st_i2c_handle_write(i2c_dev: *mut st_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn st_i2c_handle_read(i2c_dev: *mut st_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn st_i2c_isr_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn st_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    core::ptr::null_mut(), st_i2c_isr_thread,
...
#[no_mangle]
unsafe extern "C" fn st_i2c_remove(pdev: *mut platform_device) {
