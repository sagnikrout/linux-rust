...
//! Source: drivers/i2c/busses/i2c-bcm-iproc.c
#![no_std]
...
pub const IDM_CTRL_DIRECT_OFFSET: c_uint = 0x00;
pub const CFG_OFFSET: c_uint = 0x00;
pub const CFG_RESET_SHIFT: c_int = 31;
pub const CFG_EN_SHIFT: c_int = 30;
pub const CFG_SLAVE_ADDR_0_SHIFT: c_int = 28;
pub const CFG_M_RETRY_CNT_SHIFT: c_int = 16;
pub const CFG_M_RETRY_CNT_MASK: c_uint = 0x0f;
pub const TIM_CFG_OFFSET: c_uint = 0x04;
pub const TIM_CFG_MODE_400_SHIFT: c_int = 31;
pub const TIM_RAND_SLAVE_STRETCH_SHIFT: c_int = 24;
pub const TIM_RAND_SLAVE_STRETCH_MASK: c_uint = 0x7f;
pub const TIM_PERIODIC_SLAVE_STRETCH_SHIFT: c_int = 16;
pub const TIM_PERIODIC_SLAVE_STRETCH_MASK: c_uint = 0x7f;
pub const S_CFG_SMBUS_ADDR_OFFSET: c_uint = 0x08;
pub const S_CFG_EN_NIC_SMB_ADDR3_SHIFT: c_int = 31;
pub const S_CFG_NIC_SMB_ADDR3_SHIFT: c_int = 24;
pub const S_CFG_NIC_SMB_ADDR3_MASK: c_uint = 0x7f;
pub const S_CFG_EN_NIC_SMB_ADDR2_SHIFT: c_int = 23;
pub const S_CFG_NIC_SMB_ADDR2_SHIFT: c_int = 16;
pub const S_CFG_NIC_SMB_ADDR2_MASK: c_uint = 0x7f;
pub const S_CFG_EN_NIC_SMB_ADDR1_SHIFT: c_int = 15;
pub const S_CFG_NIC_SMB_ADDR1_SHIFT: c_int = 8;
pub const S_CFG_NIC_SMB_ADDR1_MASK: c_uint = 0x7f;
pub const S_CFG_EN_NIC_SMB_ADDR0_SHIFT: c_int = 7;
pub const S_CFG_NIC_SMB_ADDR0_SHIFT: c_int = 0;
pub const S_CFG_NIC_SMB_ADDR0_MASK: c_uint = 0x7f;
pub const M_FIFO_CTRL_OFFSET: c_uint = 0x0c;
pub const M_FIFO_RX_FLUSH_SHIFT: c_int = 31;
pub const M_FIFO_TX_FLUSH_SHIFT: c_int = 30;
pub const M_FIFO_RX_CNT_SHIFT: c_int = 16;
pub const M_FIFO_RX_CNT_MASK: c_uint = 0x7f;
pub const M_FIFO_RX_THLD_SHIFT: c_int = 8;
pub const M_FIFO_RX_THLD_MASK: c_uint = 0x3f;
pub const S_FIFO_CTRL_OFFSET: c_uint = 0x10;
pub const S_FIFO_RX_FLUSH_SHIFT: c_int = 31;
pub const S_FIFO_TX_FLUSH_SHIFT: c_int = 30;
pub const S_FIFO_RX_CNT_SHIFT: c_int = 16;
pub const S_FIFO_RX_CNT_MASK: c_uint = 0x7f;
pub const S_FIFO_RX_THLD_SHIFT: c_int = 8;
pub const S_FIFO_RX_THLD_MASK: c_uint = 0x3f;
pub const M_CMD_OFFSET: c_uint = 0x30;
pub const M_CMD_START_BUSY_SHIFT: c_int = 31;
pub const M_CMD_STATUS_SHIFT: c_int = 25;
pub const M_CMD_STATUS_MASK: c_uint = 0x07;
pub const M_CMD_STATUS_SUCCESS: c_uint = 0x0;
pub const M_CMD_STATUS_LOST_ARB: c_uint = 0x1;
pub const M_CMD_STATUS_NACK_ADDR: c_uint = 0x2;
pub const M_CMD_STATUS_NACK_DATA: c_uint = 0x3;
pub const M_CMD_STATUS_TIMEOUT: c_uint = 0x4;
pub const M_CMD_STATUS_FIFO_UNDERRUN: c_uint = 0x5;
pub const M_CMD_STATUS_RX_FIFO_FULL: c_uint = 0x6;
pub const M_CMD_PROTOCOL_SHIFT: c_int = 9;
pub const M_CMD_PROTOCOL_MASK: c_uint = 0xf;
pub const M_CMD_PROTOCOL_QUICK: c_uint = 0x0;
pub const M_CMD_PROTOCOL_BLK_WR: c_uint = 0x7;
pub const M_CMD_PROTOCOL_BLK_RD: c_uint = 0x8;
pub const M_CMD_PROTOCOL_PROCESS: c_uint = 0xa;
pub const M_CMD_PEC_SHIFT: c_int = 8;
pub const M_CMD_RD_CNT_SHIFT: c_int = 0;
pub const M_CMD_RD_CNT_MASK: c_uint = 0xff;
pub const S_CMD_OFFSET: c_uint = 0x34;
pub const S_CMD_START_BUSY_SHIFT: c_int = 31;
pub const S_CMD_STATUS_SHIFT: c_int = 23;
pub const S_CMD_STATUS_MASK: c_uint = 0x07;
pub const S_CMD_STATUS_SUCCESS: c_uint = 0x0;
pub const S_CMD_STATUS_TIMEOUT: c_uint = 0x5;
pub const S_CMD_STATUS_MASTER_ABORT: c_uint = 0x7;
pub const IE_OFFSET: c_uint = 0x38;
pub const IE_M_RX_FIFO_FULL_SHIFT: c_int = 31;
pub const IE_M_RX_THLD_SHIFT: c_int = 30;
pub const IE_M_START_BUSY_SHIFT: c_int = 28;
pub const IE_M_TX_UNDERRUN_SHIFT: c_int = 27;
pub const IE_S_RX_FIFO_FULL_SHIFT: c_int = 26;
pub const IE_S_RX_THLD_SHIFT: c_int = 25;
pub const IE_S_RX_EVENT_SHIFT: c_int = 24;
pub const IE_S_START_BUSY_SHIFT: c_int = 23;
pub const IE_S_TX_UNDERRUN_SHIFT: c_int = 22;
pub const IE_S_RD_EVENT_SHIFT: c_int = 21;
pub const IS_OFFSET: c_uint = 0x3c;
pub const IS_M_RX_FIFO_FULL_SHIFT: c_int = 31;
pub const IS_M_RX_THLD_SHIFT: c_int = 30;
pub const IS_M_START_BUSY_SHIFT: c_int = 28;
pub const IS_M_TX_UNDERRUN_SHIFT: c_int = 27;
pub const IS_S_RX_FIFO_FULL_SHIFT: c_int = 26;
pub const IS_S_RX_THLD_SHIFT: c_int = 25;
pub const IS_S_RX_EVENT_SHIFT: c_int = 24;
pub const IS_S_START_BUSY_SHIFT: c_int = 23;
pub const IS_S_TX_UNDERRUN_SHIFT: c_int = 22;
pub const IS_S_RD_EVENT_SHIFT: c_int = 21;
pub const M_TX_OFFSET: c_uint = 0x40;
pub const M_TX_WR_STATUS_SHIFT: c_int = 31;
pub const M_TX_DATA_SHIFT: c_int = 0;
pub const M_TX_DATA_MASK: c_uint = 0xff;
pub const M_RX_OFFSET: c_uint = 0x44;
pub const M_RX_STATUS_SHIFT: c_int = 30;
pub const M_RX_STATUS_MASK: c_uint = 0x03;
pub const M_RX_PEC_ERR_SHIFT: c_int = 29;
pub const M_RX_DATA_SHIFT: c_int = 0;
pub const M_RX_DATA_MASK: c_uint = 0xff;
pub const S_TX_OFFSET: c_uint = 0x48;
pub const S_TX_WR_STATUS_SHIFT: c_int = 31;
pub const S_TX_DATA_SHIFT: c_int = 0;
pub const S_TX_DATA_MASK: c_uint = 0xff;
pub const S_RX_OFFSET: c_uint = 0x4c;
pub const S_RX_STATUS_SHIFT: c_int = 30;
pub const S_RX_STATUS_MASK: c_uint = 0x03;
pub const S_RX_PEC_ERR_SHIFT: c_int = 29;
pub const S_RX_DATA_SHIFT: c_int = 0;
pub const S_RX_DATA_MASK: c_uint = 0xff;
pub const I2C_TIMEOUT_MSEC: c_int = 50000;
pub const M_TX_RX_FIFO_SIZE: c_int = 64;

pub const M_RX_MAX_READ_LEN: c_int = 255;
pub const M_RX_FIFO_THLD_VALUE: c_int = 50;
pub const IE_M_ALL_INTERRUPT_SHIFT: c_int = 27;
pub const IE_M_ALL_INTERRUPT_MASK: c_uint = 0x1e;
pub const SLAVE_READ_WRITE_BIT_MASK: c_uint = 0x1;
pub const SLAVE_READ_WRITE_BIT_SHIFT: c_uint = 0x1;
pub const SLAVE_MAX_SIZE_TRANSACTION: c_int = 64;
pub const SLAVE_CLOCK_STRETCH_TIME: c_int = 25;
pub const IE_S_ALL_INTERRUPT_SHIFT: c_int = 21;
pub const IE_S_ALL_INTERRUPT_MASK: c_uint = 0x3f;
//
// It takes ~18us to reading 10bytes of data, hence to keep tasklet
// running for less time, max slave read per tasklet is set to 10 bytes.
//
pub const MAX_SLAVE_RX_PER_INT: c_int = 10;
...
// bytes that have been read
    pub rx_bytes: c_uint,
    pub thld_bytes: c_uint,
    pub slave_rx_only: bool,
    pub rx_start_rcvd: bool,
    pub slave_read_complete: bool,
    pub tx_underrun: u32,
    pub slave_int_mask: u32,
    pub slave_rx_tasklet: tasklet_struct,
}
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_slave_read(iproc_i2c: *mut bcm_iproc_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn slave_rx_tasklet_fn(data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_read_valid_bytes(iproc_i2c: *mut bcm_iproc_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_send(iproc_i2c: *mut bcm_iproc_i2c_dev) {
    static void bcm_iproc_i2c_send(struct bcm_iproc_i2c_dev *iproc_i2c)
    {
    struct i2c_msg *msg = iproc_i2c.msg;
    let mut tx_bytes: c_uint = msg.len - iproc_i2c.tx_bytes;
    unsigned int i;
    u32 val;
...
// start from where we left over
    let mut idx: c_uint = iproc_i2c.tx_bytes + i;
    val = msg.buf[idx];
// mark the last byte
    if (idx == msg.len - 1) {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_read(iproc_i2c: *mut bcm_iproc_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_init(iproc_i2c: *mut bcm_iproc_i2c_dev) {
...
// re-initialize i2c for recovery
    ...
    u32 cmd)
    {
    let mut time_left: c_ulong = msecs_to_jiffies(I2C_TIMEOUT_MSEC);
    u32 val, status;
    int ret;
...
// make sure the interrupt handler isn't running
    ...
    let mut timeout: c_ulong = jiffies + time_left;
    do {
...
// enable the RX threshold interrupt
    ...
    let mut process_call: bool = false;
    int ret;
    if (num == 2) {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_reg_slave(slave: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_unreg_slave(slave: *mut i2c_client) -> c_int {
...
// clear all pending slave interrupts
    iproc_i2c_wr_reg(iproc_i2c, IS_OFFSET, ISR_MASK_SLAVE);
    iproc_i2c.slave = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_cfg_speed(iproc_i2c: *mut bcm_iproc_i2c_dev) -> c_int {
    ...
    bus_speed);
#[no_mangle]
pub unsafe extern "C" fn if(I2C_MAX_FAST_MODE_FREQ: bus_speed <) -> else {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_probe(pdev: *mut platform_device) -> c_int {
...
// no slave support
    bcm_iproc_algo.reg_slave = core::ptr::null_mut();
    bcm_iproc_algo.unreg_slave = core::ptr::null_mut();
    }
    bcm_iproc_i2c_init(iproc_i2c);
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm_iproc_i2c_resume(dev: *mut device) -> c_int {
