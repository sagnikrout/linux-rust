...
//! Source: drivers/i2c/busses/i2c-viai2c-zhaoxin.c
#![no_std]
...
pub const ZXI2C_REG_CLK: c_uint = 0x10;

pub const ZXI2C_REG_REV: c_uint = 0x11;
pub const ZXI2C_REG_HCR: c_uint = 0x12;

pub const ZXI2C_REG_HTDR: c_uint = 0x13;
pub const ZXI2C_REG_HRDR: c_uint = 0x14;
pub const ZXI2C_REG_HTLR: c_uint = 0x15;
pub const ZXI2C_REG_HRLR: c_uint = 0x16;
pub const ZXI2C_REG_HWCNTR: c_uint = 0x18;
pub const ZXI2C_REG_HRCNTR: c_uint = 0x19;
// parameters Constants
pub const ZXI2C_GOLD_FSTP_100K: c_uint = 0xF3;
pub const ZXI2C_GOLD_FSTP_400K: c_uint = 0x38;
pub const ZXI2C_GOLD_FSTP_1M: c_uint = 0x13;
pub const ZXI2C_GOLD_FSTP_3400K: c_uint = 0x37;

pub const ZXI2C_FIFO_SIZE: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct viai2c_zhaoxin {
    pub hrv: u8,
    pub tr: u16,
    pub mcr: u16,
    pub xfer_len: u16,
...
#[no_mangle]
unsafe extern "C" fn viai2c_fifo_xfer(i2c: *mut viai2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn viai2c_fifo_irq_xfer(i2c: *mut viai2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zxi2c_xfer(adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zxi2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn zxi2c_set_bus_speed(i2c: *mut viai2c) {
...
#[no_mangle]
unsafe extern "C" fn zxi2c_get_bus_speed(i2c: *mut viai2c) {
    ...
    const u32 *params;
    struct viai2c_zhaoxin *priv = i2c.pltfm_priv;
    let mut acpi_speed: u32 = i2c_acpi_find_bus_speed(i2c.dev);
...
#[no_mangle]
unsafe extern "C" fn zxi2c_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn zxi2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zxi2c_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), zxi2c_resume)
    };
