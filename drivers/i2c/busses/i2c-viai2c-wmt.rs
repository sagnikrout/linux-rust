...
//! Source: drivers/i2c/busses/i2c-viai2c-wmt.c
#![no_std]
...
pub const REG_SLAVE_CR: c_uint = 0x10;
pub const REG_SLAVE_SR: c_uint = 0x12;
pub const REG_SLAVE_ISR: c_uint = 0x14;
pub const REG_SLAVE_IMR: c_uint = 0x16;
pub const REG_SLAVE_DR: c_uint = 0x18;
pub const REG_SLAVE_TR: c_uint = 0x1A;
// REG_TR

pub const TR_STD: c_uint = 0x0064;
pub const TR_HS: c_uint = 0x0019;
// REG_MCR
pub const MCR_APB_96M: c_int = 7;
pub const MCR_APB_166M: c_int = 12;
#[no_mangle]
unsafe extern "C" fn wmt_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn wmt_i2c_reset_hardware(i2c: *mut viai2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmt_i2c_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wmt_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmt_i2c_remove(pdev: *mut platform_device) {
