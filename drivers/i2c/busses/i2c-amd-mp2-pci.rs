...
//! Source: drivers/i2c/busses/i2c-amd-mp2-pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn amd_mp2_c2p_mutex_lock(i2c_common: *mut amd_i2c_common) {
...
#[no_mangle]
unsafe extern "C" fn amd_mp2_c2p_mutex_unlock(i2c_common: *mut amd_i2c_common) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_mp2_bus_enable_set(i2c_common: *mut amd_i2c_common, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_mp2_rw(i2c_common: *mut amd_i2c_common, reqcmd: enum i2c_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_mp2_pci_check_rw_event(i2c_common: *mut amd_i2c_common) {
    static void amd_mp2_pci_check_rw_event(struct amd_i2c_common *i2c_common)
    {
    struct amd_mp2_dev *privdata = i2c_common.mp2_dev;
    struct pci_dev *pdev = privdata.pci_dev;
    let mut len: c_int = i2c_common.eventval.r.length;
    let mut slave_addr: u32 = i2c_common.eventval.r.slave_addr;
...
#[no_mangle]
unsafe extern "C" fn __amd_mp2_process_event(i2c_common: *mut amd_i2c_common) {
    static void __amd_mp2_process_event(struct amd_i2c_common *i2c_common)
    {
    struct amd_mp2_dev *privdata = i2c_common.mp2_dev;
    struct pci_dev *pdev = privdata.pci_dev;
    let mut sts: enum status_type = i2c_common.eventval.r.status;
    let mut res: enum response_type = i2c_common.eventval.r.response;
    let mut len: c_int = i2c_common.eventval.r.length;
    ...
    amd_mp2_pci_check_rw_event(i2c_common);
#[no_mangle]
pub unsafe extern "C" fn if(i2c_writefail_event: sts !=) -> else {
    ...
    i2c_common.cmd_success = true;
#[no_mangle]
pub unsafe extern "C" fn if(i2c_busenable_failed: sts !=) -> else {
    ...
    i2c_common.cmd_success = true;
#[no_mangle]
pub unsafe extern "C" fn if(i2c_busdisable_failed: sts !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn amd_mp2_process_event(i2c_common: *mut amd_i2c_common) {
...
#[no_mangle]
unsafe extern "C" fn amd_mp2_irq_isr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    ...
    unsigned int bus_id;
    void __iomem *reg;
    let mut ret: enum irqreturn = IRQ_NONE;
...
#[no_mangle]
pub unsafe extern "C" fn amd_mp2_rw_timeout(i2c_common: *mut amd_i2c_common) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_mp2_register_cb(i2c_common: *mut amd_i2c_common) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_mp2_unregister_cb(i2c_common: *mut amd_i2c_common) -> c_int {
    int amd_mp2_unregister_cb(struct amd_i2c_common *i2c_common)
    {
    struct amd_mp2_dev *privdata = i2c_common.mp2_dev;
    privdata.busses[i2c_common.bus_id] = core::ptr::null_mut();
    return 0;
    }
    EXPORT_SYMBOL_GPL(amd_mp2_unregister_cb);
#[no_mangle]
unsafe extern "C" fn amd_mp2_clear_reg(privdata: *mut amd_mp2_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_mp2_pci_remove(pci_dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_mp2_pci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_mp2_pci_resume(dev: *mut device) -> c_int {
    ...
    amd_mp2_pci_resume, core::ptr::null_mut());
    ...
    struct device *dev;
    struct pci_dev *pci_dev;
    dev = driver_find_next_device(&amd_mp2_pci_driver.driver, core::ptr::null_mut());
    if (!dev)
