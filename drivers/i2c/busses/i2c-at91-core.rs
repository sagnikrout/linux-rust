...
//! Source: drivers/i2c/busses/i2c-at91-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn at91_twi_read(dev: *mut at91_twi_dev, reg: unsigned) -> unsigned {
    unsigned at91_twi_read(struct at91_twi_dev *dev, unsigned reg)
    {
    return readl_relaxed(dev.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn at91_twi_write(dev: *mut at91_twi_dev, reg: unsigned, val: unsigned) {
    void at91_twi_write(struct at91_twi_dev *dev, unsigned reg, unsigned val)
    {
    writel_relaxed(val, dev.base + reg);
    }
#[no_mangle]
pub unsafe extern "C" fn at91_disable_twi_interrupts(dev: *mut at91_twi_dev) {
    void at91_disable_twi_interrupts(struct at91_twi_dev *dev)
    {
    at91_twi_write(dev, AT91_TWI_IDR, AT91_TWI_INT_MASK);
    }
#[no_mangle]
pub unsafe extern "C" fn at91_twi_irq_save(dev: *mut at91_twi_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn at91_twi_irq_restore(dev: *mut at91_twi_dev) {
    void at91_twi_irq_restore(struct at91_twi_dev *dev)
    {
    at91_twi_write(dev, AT91_TWI_IER, dev.imr);
    }
#[no_mangle]
pub unsafe extern "C" fn at91_init_twi_bus(dev: *mut at91_twi_dev) {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_probe(pdev: *mut platform_device) -> c_int {
    ...
    dev.clk = devm_clk_get_enabled(dev.dev, core::ptr::null_mut());
    if (IS_ERR(dev.clk))
...
#[no_mangle]
unsafe extern "C" fn at91_twi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_suspend_noirq(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_resume_noirq(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_init() -> int __init {
    static int __init at91_twi_init(void)
    {
    return platform_driver_register(&at91_twi_driver);
    }
#[no_mangle]
unsafe extern "C" fn at91_twi_exit() -> void __exit {
