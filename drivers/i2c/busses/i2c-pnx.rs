...
//! Source: drivers/i2c/busses/i2c-pnx.c
#![no_std]
...
pub const I2C_PNX_REGION_SIZE: c_uint = 0x100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_pnx_mif {
    pub /: *mut *mut int ret; / Return value,
    pub /: *mut *mut int mode; / Interface mode,
    pub /: *mut *mut completion complete; / I/O completion,
    pub /: *mut *mut *mut u8  buf; / Data buffer,
    pub /: *mut *mut int len; / Length of data buffer,
    pub /: *mut *mut int order; / RX Bytes to order via TX,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_pnx_algo_data {
...
#[no_mangle]
pub unsafe extern "C" fn wait_timeout(data: *mut i2c_pnx_algo_data) -> c_int {
    static inline int wait_timeout(struct i2c_pnx_algo_data *data)
    {
    let mut timeout: c_long = jiffies_to_msecs(data.timeout);
    while (timeout > 0 &&
...
#[no_mangle]
pub unsafe extern "C" fn wait_reset(data: *mut i2c_pnx_algo_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_pnx_stop(alg_data: *mut i2c_pnx_algo_data) {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_pnx_master_xmit(alg_data: *mut i2c_pnx_algo_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_pnx_master_rcv(alg_data: *mut i2c_pnx_algo_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_pnx_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn i2c_pnx_timeout(alg_data: *mut i2c_pnx_algo_data) {
...
#[no_mangle]
pub unsafe extern "C" fn bus_reset_if_active(alg_data: *mut i2c_pnx_algo_data) {
...
//
    ...
    {
    struct i2c_msg *pmsg;
    let mut rc: c_int = 0, completed = 0, i;
...
// Clear TDI and AFI bits in case they are set.
    ...
    bus_reset_if_active(alg_data);
// Cleanup to be sure...
    alg_data.mif.buf = core::ptr::null_mut();
    alg_data.mif.len = 0;
...
#[no_mangle]
unsafe extern "C" fn i2c_pnx_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_pnx_controller_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_pnx_controller_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_pnx_probe(pdev: *mut platform_device) -> c_int {
    static int i2c_pnx_probe(struct platform_device *pdev)
    {
    let mut speed: u32 = I2C_MAX_STANDARD_MODE_FREQ;
    unsigned long tmp;
    let mut ret: c_int = 0;
    struct i2c_pnx_algo_data *alg_data;
    unsigned long freq;
...
//
    ...
    alg_data.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn i2c_pnx_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn i2c_adap_pnx_init() -> int __init {
    static int __init i2c_adap_pnx_init(void)
    {
    return platform_driver_register(&i2c_pnx_driver);
    }
#[no_mangle]
unsafe extern "C" fn i2c_adap_pnx_exit() -> void __exit {
