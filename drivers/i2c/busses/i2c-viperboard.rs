...
//! Source: drivers/i2c/busses/i2c-viperboard.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vprbrd_i2c {
    pub i2c: i2c_adapter,
    pub bus_freq_param: u8,
}

// i2c bus frequency module parameter
    static u8 i2c_bus_param;
    let mut i2c_bus_freq: static unsigned int = 100;
...
#[no_mangle]
unsafe extern "C" fn vprbrd_i2c_read(vb: *mut vprbrd, msg: *mut i2c_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vprbrd_i2c_write(vb: *mut vprbrd, msg: *mut i2c_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vprbrd_i2c_func(i2c: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vprbrd_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vprbrd_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vprbrd_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vprbrd_i2c_exit() -> void __exit {
