...
//! Source: drivers/i2c/busses/i2c-gpio.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_gpio_scl_data {
    pub args: fwnode_reference_args,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_gpio_private_data {
    pub sda: *mut gpio_desc,
    pub scl: *mut i2c_gpio_scl_data,
    pub adap: i2c_adapter,
    pub bit_data: i2c_algo_bit_data,
    pub pdata: i2c_gpio_platform_data,

// these must be protected by bus lock
    pub scl_irq_completion: completion,
    pub scl_irq_data: u64,
...
//
#[no_mangle]
unsafe extern "C" fn i2c_gpio_setsda_val(data: *mut c_void, state: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_gpio_setscl_val(data: *mut c_void, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_getsda(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_getscl(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_lock_bus(adap: *mut i2c_adapter, flags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_trylock_bus(adap: *mut i2c_adapter, flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_unlock_bus(adap: *mut i2c_adapter, flags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fops_incomplete_addr_phase_set(data: *mut c_void, addr: u64) -> c_int {
...
// ADDR (7 bit) + RD (1 bit) + Client ACK, keep SDA hi (1 bit)
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_incomplete_addr_phase, core::ptr::null_mut(), fops_incomplete_addr_phase_set, "%llu\n");
#[no_mangle]
unsafe extern "C" fn fops_incomplete_write_byte_set(data: *mut c_void, addr: u64) -> c_int {
...
// 0x00 (8 bit) + Client ACK, keep SDA hi (1 bit)
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_incomplete_write_byte, core::ptr::null_mut(), fops_incomplete_write_byte_set, "%llu\n");
    static int i2c_gpio_fi_act_on_scl_irq(struct i2c_gpio_private_data *priv,
#[no_mangle]
pub unsafe extern "C" fn handler(_arg: c_int, _arg: *mut void)) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lose_arbitration_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fops_lose_arbitration_set(data: *mut c_void, duration: u64) -> c_int {
...
//
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_lose_arbitration, core::ptr::null_mut(), fops_lose_arbitration_set, "%llu\n");
#[no_mangle]
unsafe extern "C" fn inject_panic_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fops_inject_panic_set(data: *mut c_void, duration: u64) -> c_int {
...
//
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(fops_inject_panic, core::ptr::null_mut(), fops_inject_panic_set, "%llu\n");
#[no_mangle]
unsafe extern "C" fn i2c_gpio_fault_injector_init(pdev: *mut platform_device) {
...
//
    ...
    retdesc = gpiod_get_index(dev, core::ptr::null_mut(), index, gflags);
    if (!IS_ERR(retdesc)) {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_free_scl(scl: *mut i2c_gpio_scl_data) {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_scl_matches(a: *mut i2c_gpio_scl_data, b: *mut i2c_gpio_scl_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_cleanup_scl(scl: *mut i2c_gpio_scl_data) {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pdata->scl_is_output_only) -> else {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn i2c_gpio_exit() -> void __exit {
