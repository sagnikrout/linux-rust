...
//! Source: drivers/i2c/busses/i2c-rk3x.c
#![no_std]
...
// Register Map
pub const REG_CON: c_uint = 0x00 /* control register */;
pub const REG_CLKDIV: c_uint = 0x04 /* clock divisor register */;
pub const REG_MRXADDR: c_uint = 0x08 /* target address for REGISTER_TX */;
pub const REG_MRXRADDR: c_uint = 0x0c /* target register address for REGISTER_TX */;
pub const REG_MTXCNT: c_uint = 0x10 /* number of bytes to be transmitted */;
pub const REG_MRXCNT: c_uint = 0x14 /* number of bytes to be received */;
pub const REG_IEN: c_uint = 0x18 /* interrupt enable */;
pub const REG_IPD: c_uint = 0x1c /* interrupt pending */;
pub const REG_FCNT: c_uint = 0x20 /* finished count */;
// Data buffer offsets
pub const TXBUFFER_BASE: c_uint = 0x100;
pub const RXBUFFER_BASE: c_uint = 0x200;
// REG_CON bits
...
pub const REG_INT_ALL: c_uint = 0x7f;
// Constants
...
pub struct i2c_spec_values {
    pub min_hold_start_ns: c_ulong,
    pub min_low_ns: c_ulong,
    pub min_high_ns: c_ulong,
    pub min_setup_start_ns: c_ulong,
    pub max_data_hold_ns: c_ulong,
    pub min_data_setup_ns: c_ulong,
    pub min_setup_stop_ns: c_ulong,
    pub min_hold_buffer_ns: c_ulong,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk3x_i2c_calced_timings {
    pub div_low: c_ulong,
    pub div_high: c_ulong,
    pub tuning: c_uint,
}
...
pub struct rk3x_i2c {
    ...
    pub dev: *mut device,
    pub soc_data: *const rk3x_i2c_soc_data,
// Hardware resources
    pub regs: *mut void __iomem,
    pub clk: *mut clk,
    pub pclk: *mut clk,
    pub clk_rate_nb: notifier_block,
    pub irq: c_int,
// Settings
    pub t: i2c_timings,
...
// Current message
    ...
    pub addr: u8,
    pub mode: c_uint,
    pub is_last_msg: bool,
// I2C state machine
    pub state: enum rk3x_i2c_state,
...
#[no_mangle]
pub unsafe extern "C" fn i2c_readl(i2c: *mut rk3x_i2c, offset: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn rk3x_i2c_clean_ipd(i2c: *mut rk3x_i2c) {
...
//
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_start(i2c: *mut rk3x_i2c) {
    static void rk3x_i2c_start(struct rk3x_i2c *i2c)
    {
    let mut val: u32 = i2c_readl(i2c, REG_CON) & REG_CON_TUNING_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_stop(i2c: *mut rk3x_i2c, error: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_prepare_read(i2c: *mut rk3x_i2c) {
    static void rk3x_i2c_prepare_read(struct rk3x_i2c *i2c)
    {
    let mut len: c_uint = i2c.msg.len - i2c.processed;
    u32 con;
...
//
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_fill_transmit_buf(i2c: *mut rk3x_i2c) {
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_handle_start(i2c: *mut rk3x_i2c, ipd: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_handle_write(i2c: *mut rk3x_i2c, ipd: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_handle_read(i2c: *mut rk3x_i2c, ipd: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_handle_stop(i2c: *mut rk3x_i2c, ipd: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_irq(irqno: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    ...
    let mut data_hold_buffer_ns: c_ulong = 50;
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_adapt_div(i2c: *mut rk3x_i2c, clk_rate: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_setup(i2c: *mut rk3x_i2c, msgs: *mut i2c_msg, num: c_int) -> c_int {
    static int rk3x_i2c_setup(struct rk3x_i2c *i2c, struct i2c_msg *msgs, int num)
    {
    let mut addr: u32 = (msgs[0].addr & 0x7f) << 1;
    let mut ret: c_int = 0;
//
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_wait_xfer_poll(i2c: *mut rk3x_i2c) -> c_int {
    static int rk3x_i2c_wait_xfer_poll(struct rk3x_i2c *i2c)
    {
    let mut timeout: ktime_t = ktime_add_ms(ktime_get(), WAIT_TIMEOUT);
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_resume(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3x_i2c_remove(pdev: *mut platform_device) {
    ...
    static SIMPLE_DEV_PM_OPS(rk3x_i2c_pm_ops, core::ptr::null_mut(), rk3x_i2c_resume);
