...
//! Source: drivers/i2c/busses/i2c-stm32f7.c
#![no_std]
...
pub const STM32F7_I2C_CR1: c_uint = 0x00;
pub const STM32F7_I2C_CR2: c_uint = 0x04;
pub const STM32F7_I2C_OAR1: c_uint = 0x08;
pub const STM32F7_I2C_OAR2: c_uint = 0x0C;
pub const STM32F7_I2C_PECR: c_uint = 0x20;
pub const STM32F7_I2C_TIMINGR: c_uint = 0x10;
pub const STM32F7_I2C_ISR: c_uint = 0x18;
pub const STM32F7_I2C_ICR: c_uint = 0x1C;
pub const STM32F7_I2C_RXDR: c_uint = 0x24;
pub const STM32F7_I2C_TXDR: c_uint = 0x28;
...
pub const STM32F7_I2C_MAX_LEN: c_uint = 0xff;
pub const STM32F7_I2C_DMA_LEN_MIN: c_uint = 0x16;
    enum {
...
pub const STM32F7_I2C_DNF_DEFAULT: c_int = 0;
pub const STM32F7_I2C_DNF_MAX: c_int = 15;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32f7_i2c_setup {
    pub speed_freq: u32,
    pub clock_src: u32,
    pub rise_time: u32,
    pub fall_time: u32,
    pub fmp_clr_offset: u32,
    pub single_it_line: bool,
    pub fmp_cr1_bit: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32f7_i2c_timings {
    pub node: list_head,
    pub presc: u8,
    pub scldel: u8,
    pub sdadel: u8,
...
pub struct stm32f7_i2c_msg {
    ...
    pub smbus: bool,
    pub size: c_int,
    pub read_write: c_char,
    pub __aligned(4): u8 smbus_buf[I2C_SMBUS_BLOCK_MAX + 3],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32f7_i2c_alert {
    pub setup: i2c_smbus_alert_setup,
...
pub struct stm32f7_i2c_dev {
    ...
    pub msg_num: c_uint,
    pub msg_id: c_uint,
    pub f7_msg: stm32f7_i2c_msg,
    pub setup: stm32f7_i2c_setup,
    pub timing: stm32f7_i2c_timings,
    pub slave: [*mut i2c_client; STM32F7_I2C_MAX_SLAVE],
    pub slave_running: *mut i2c_client,
    pub backup_regs: stm32f7_i2c_regs,
    pub slave_dir: u32,
    pub master_mode: bool,
    pub dma: *mut stm32_i2c_dma,
    pub use_dma: bool,
    ...
    pub wakeup_src: bool,
    pub smbus_mode: bool,
    pub host_notify_client: *mut i2c_client,
    pub analog_filter: bool,
    pub dnf_dt: u32,
    pub dnf: u32,
    pub alert: *mut stm32f7_i2c_alert,
    pub atomic: bool,
}
...
#[no_mangle]
pub unsafe extern "C" fn stm32f7_i2c_set_bits(reg: *mut void __iomem, mask: u32) {
    static inline void stm32f7_i2c_set_bits(void __iomem *reg, u32 mask)
    {
    writel_relaxed(readl_relaxed(reg) | mask, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn stm32f7_i2c_clr_bits(reg: *mut void __iomem, mask: u32) {
    static inline void stm32f7_i2c_clr_bits(void __iomem *reg, u32 mask)
    {
    writel_relaxed(readl_relaxed(reg) & ~mask, reg);
    }
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_disable_irq(i2c_dev: *mut stm32f7_i2c_dev, mask: u32) {
    ...
    let mut p_prev: u32 = STM32F7_PRESC_MAX;
//
...
//
    let mut i2cclk: u32 = NSEC_PER_SEC / setup.clock_src;
    u32 i2cbus = DIV_ROUND_CLOSEST(NSEC_PER_SEC,
    setup.speed_freq);
    let mut clk_error_prev: u32 = i2cbus;
    u32 tsync;
...
// Compute possible values for PRESC, SCLDEL and SDADEL
    ...
    let mut scldel: u32 = (l + 1) * (p + 1) * i2cclk;
    if (scldel < scldel_min)
    continue;
    for (a = 0; a < STM32F7_SDADEL_MAX; a++) {
    let mut sdadel: u32 = (a * (p + 1) + 1) * i2cclk;
...
//
    ...
    let mut prescaler: u32 = (v.presc + 1) * i2cclk;
    for (l = 0; l < STM32F7_SCLL_MAX; l++) {
    let mut tscl_l: u32 = (l + 1) * prescaler + tsync;
    ...
    let mut tscl_h: u32 = (h + 1) * prescaler + tsync;
    u32 tscl = tscl_l + tscl_h +
    setup.rise_time + setup.fall_time;
    if ((tscl >= clk_min) && (tscl <= clk_max) &&
    (tscl_h >= specs.h_min) &&
    (i2cclk < tscl_h)) {
    let mut clk_error: c_int = tscl - i2cbus;
    if (clk_error < 0)
    clk_error = -clk_error;
...
#[no_mangle]
unsafe extern "C" fn stm32f7_get_lower_rate(rate: u32) -> u32 {
    static u32 stm32f7_get_lower_rate(u32 rate)
    {
    let mut i: c_int = ARRAY_SIZE(stm32f7_i2c_specs);
    while (--i)
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_disable_dma_req(i2c_dev: *mut stm32f7_i2c_dev) {
    static void stm32f7_i2c_disable_dma_req(struct stm32f7_i2c_dev *i2c_dev)
    {
    void __iomem *base = i2c_dev.base;
    let mut mask: u32 = STM32F7_I2C_CR1_RXDMAEN | STM32F7_I2C_CR1_TXDMAEN;
    stm32f7_i2c_clr_bits(base + STM32F7_I2C_CR1, mask);
    }
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_dma_callback(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_hw_config(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_write_tx_data(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_read_rx_data(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_reload(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_smbus_reload(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_release_bus(i2c_adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_wait_free_bus(i2c_dev: *mut stm32f7_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_smbus_rep_start(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_smbus_check_pec(i2c_dev: *mut stm32f7_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_is_addr_match(slave: *mut i2c_client, addcode: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_slave_start(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_slave_addr(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_is_slave_registered(i2c_dev: *mut stm32f7_i2c_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_is_slave_busy(i2c_dev: *mut stm32f7_i2c_dev) -> bool {
    ...
    let mut i: return = = busy;
    }
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_slave_isr_event(i2c_dev: *mut stm32f7_i2c_dev, status: u32) -> irqreturn_t {
...
// Notify i2c slave that a STOP flag has been detected
    ...
    i2c_dev.slave_running = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_handle_isr_errs(i2c_dev: *mut stm32f7_i2c_dev, status: u32) -> irqreturn_t {
    static irqreturn_t stm32f7_i2c_handle_isr_errs(struct stm32f7_i2c_dev *i2c_dev, u32 status)
    {
    struct stm32f7_i2c_msg *f7_msg = &i2c_dev.f7_msg;
    let mut addr: u16 = f7_msg.addr;
    void __iomem *base = i2c_dev.base;
    struct device *dev = i2c_dev.dev;
// Bus error
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_isr_event(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_isr_event_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_isr_error_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_wait_polling(i2c_dev: *mut stm32f7_i2c_dev) -> c_int {
    static int stm32f7_i2c_wait_polling(struct stm32f7_i2c_dev *i2c_dev)
    {
    let mut timeout: ktime_t = ktime_add_ms(ktime_get(), i2c_dev.adap.timeout);
...
// Check PEC
    ...
    {
    void __iomem *base = i2c_dev.base;
    let mut mask: u32 = STM32F7_I2C_CR1_WUPEN;
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_reg_slave(slave: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_unreg_slave(slave: *mut i2c_client) -> c_int {
    ...
    i2c_dev.slave[id] = core::ptr::null_mut();
    if (!stm32f7_i2c_is_slave_registered(i2c_dev)) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_enable_smbus_host(i2c_dev: *mut stm32f7_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_disable_smbus_host(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_enable_smbus_alert(i2c_dev: *mut stm32f7_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_disable_smbus_alert(i2c_dev: *mut stm32f7_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    "wakeup-source");
    i2c_dev.clk = devm_clk_get_enabled(&pdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_regs_backup(i2c_dev: *mut stm32f7_i2c_dev) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_regs_restore(i2c_dev: *mut stm32f7_i2c_dev) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32f7_i2c_resume(dev: *mut device) -> int __maybe_unused {
    ...
    stm32f7_i2c_runtime_resume, core::ptr::null_mut())
