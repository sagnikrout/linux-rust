...
//! Source: drivers/i2c/busses/i2c-sis5595.c
#![no_std]
...
pub const SMB_STS_LO: c_uint = 0x00;
pub const SMB_STS_HI: c_uint = 0x01;
pub const SMB_CTL_LO: c_uint = 0x02;
pub const SMB_CTL_HI: c_uint = 0x03;
pub const SMB_ADDR: c_uint = 0x04;
pub const SMB_CMD: c_uint = 0x05;
pub const SMB_PCNT: c_uint = 0x06;
pub const SMB_CNT: c_uint = 0x07;
pub const SMB_BYTE: c_uint = 0x08;
pub const SMB_DEV: c_uint = 0x10;
pub const SMB_DB0: c_uint = 0x11;
pub const SMB_DB1: c_uint = 0x12;
pub const SMB_HAA: c_uint = 0x13;
// PCI Address Constants
pub const SMB_INDEX: c_uint = 0x38;
pub const SMB_DAT: c_uint = 0x39;
pub const SIS5595_ENABLE_REG: c_uint = 0x40;
pub const ACPI_BASE: c_uint = 0x90;
// Other settings
pub const MAX_TIMEOUT: c_int = 500;
// SIS5595 constants
pub const SIS5595_QUICK: c_uint = 0x00;
pub const SIS5595_BYTE: c_uint = 0x02;
pub const SIS5595_BYTE_DATA: c_uint = 0x04;
pub const SIS5595_WORD_DATA: c_uint = 0x06;
pub const SIS5595_PROC_CALL: c_uint = 0x08;
pub const SIS5595_BLOCK_DATA: c_uint = 0x0A;
// insmod parameters
...
#[no_mangle]
unsafe extern "C" fn sis5595_read(reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sis5595_write(reg: u8, data: u8) {
...
#[no_mangle]
unsafe extern "C" fn sis5595_setup(SIS5595_dev: *mut pci_dev) -> c_int {
...
// Look for imposters
    ...
    struct pci_dev *dev;
    dev = pci_get_device(PCI_VENDOR_ID_SI, *i, core::ptr::null_mut());
    if (dev) {
...
#[no_mangle]
unsafe extern "C" fn sis5595_transaction(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sis5595_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sis5595_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_sis5595_init() -> int __init {
    static int __init i2c_sis5595_init(void)
    {
    return pci_register_driver(&sis5595_driver);
    }
#[no_mangle]
unsafe extern "C" fn i2c_sis5595_exit() -> void __exit {
    ...
    sis5595_pdev = core::ptr::null_mut();
    }
    }
