...
//! Source: drivers/i2c/busses/i2c-stm32f4.c
#![no_std]
...
pub const STM32F4_I2C_CR1: c_uint = 0x00;
pub const STM32F4_I2C_CR2: c_uint = 0x04;
pub const STM32F4_I2C_DR: c_uint = 0x10;
pub const STM32F4_I2C_SR1: c_uint = 0x14;
pub const STM32F4_I2C_SR2: c_uint = 0x18;
pub const STM32F4_I2C_CCR: c_uint = 0x1C;
pub const STM32F4_I2C_TRISE: c_uint = 0x20;
pub const STM32F4_I2C_FLTR: c_uint = 0x24;
...
pub struct stm32f4_i2c_dev {
    ...
    pub clk: *mut clk,
    pub speed: c_int,
    pub parent_rate: c_int,
    pub msg: stm32f4_i2c_msg,
}

#[no_mangle]
pub unsafe extern "C" fn stm32f4_i2c_set_bits(reg: *mut void __iomem, mask: u32) {
    static inline void stm32f4_i2c_set_bits(void __iomem *reg, u32 mask)
    {
    writel_relaxed(readl_relaxed(reg) | mask, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn stm32f4_i2c_clr_bits(reg: *mut void __iomem, mask: u32) {
    static inline void stm32f4_i2c_clr_bits(void __iomem *reg, u32 mask)
    {
    writel_relaxed(readl_relaxed(reg) & ~mask, reg);
    }
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_disable_irq(i2c_dev: *mut stm32f4_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_set_periph_clk_freq(i2c_dev: *mut stm32f4_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_set_rise_time(i2c_dev: *mut stm32f4_i2c_dev) {
    static void stm32f4_i2c_set_rise_time(struct stm32f4_i2c_dev *i2c_dev)
    {
    let mut freq: u32 = DIV_ROUND_UP(i2c_dev.parent_rate, HZ_TO_MHZ);
    u32 trise;
//
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_set_speed_mode(i2c_dev: *mut stm32f4_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_hw_config(i2c_dev: *mut stm32f4_i2c_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_wait_free_bus(i2c_dev: *mut stm32f4_i2c_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_write_byte(i2c_dev: *mut stm32f4_i2c_dev, byte: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_write_msg(i2c_dev: *mut stm32f4_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_read_msg(i2c_dev: *mut stm32f4_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_terminate_xfer(i2c_dev: *mut stm32f4_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_handle_write(i2c_dev: *mut stm32f4_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_handle_read(i2c_dev: *mut stm32f4_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_handle_rx_done(i2c_dev: *mut stm32f4_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_handle_rx_addr(i2c_dev: *mut stm32f4_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_isr_event(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t stm32f4_i2c_isr_event(int irq, void *data)
    {
    struct stm32f4_i2c_dev *i2c_dev = data;
    struct stm32f4_i2c_msg *msg = &i2c_dev.msg;
    let mut possible_status: u32 = STM32F4_I2C_SR1_ITEVTEN_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_isr_error(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    rst = devm_reset_control_get_exclusive(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(rst))
...
#[no_mangle]
unsafe extern "C" fn stm32f4_i2c_remove(pdev: *mut platform_device) {
