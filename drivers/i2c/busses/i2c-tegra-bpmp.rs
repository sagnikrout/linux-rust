...
//! Source: drivers/i2c/busses/i2c-tegra-bpmp.c
#![no_std]
...
// and length
//
pub const SERIALI2C_HDR_SIZE: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_bpmp_i2c {
...
//
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_xlate_flags(flags: u16, out: *mut u16) {
...
//
    ...
    unsigned int num)
    {
    let mut size: usize = response.xfer.data_size, len = 0, pos = 0;
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_i2c_msg_len_check(msgs: *mut i2c_msg, num: c_uint) -> c_int {
    static int tegra_bpmp_i2c_msg_len_check(struct i2c_msg *msgs, unsigned int num)
    {
    let mut tx_len: usize = 0, rx_len = 0;
    unsigned int i;
    for (i = 0; i < num; i++)
    if (!(msgs[i].flags & I2C_M_RD))
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_i2c_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_i2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_bpmp_i2c_remove(pdev: *mut platform_device) {
