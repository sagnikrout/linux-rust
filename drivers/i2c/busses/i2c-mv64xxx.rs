...
//! Source: drivers/i2c/busses/i2c-mv64xxx.c
#![no_std]
...
// Ctlr status values
pub const MV64XXX_I2C_STATUS_BUS_ERR: c_uint = 0x00;
pub const MV64XXX_I2C_STATUS_MAST_START: c_uint = 0x08;
pub const MV64XXX_I2C_STATUS_MAST_REPEAT_START: c_uint = 0x10;
pub const MV64XXX_I2C_STATUS_MAST_WR_ADDR_ACK: c_uint = 0x18;
pub const MV64XXX_I2C_STATUS_MAST_WR_ADDR_NO_ACK: c_uint = 0x20;
pub const MV64XXX_I2C_STATUS_MAST_WR_ACK: c_uint = 0x28;
pub const MV64XXX_I2C_STATUS_MAST_WR_NO_ACK: c_uint = 0x30;
pub const MV64XXX_I2C_STATUS_MAST_LOST_ARB: c_uint = 0x38;
pub const MV64XXX_I2C_STATUS_MAST_RD_ADDR_ACK: c_uint = 0x40;
pub const MV64XXX_I2C_STATUS_MAST_RD_ADDR_NO_ACK: c_uint = 0x48;
pub const MV64XXX_I2C_STATUS_MAST_RD_DATA_ACK: c_uint = 0x50;
pub const MV64XXX_I2C_STATUS_MAST_RD_DATA_NO_ACK: c_uint = 0x58;
pub const MV64XXX_I2C_STATUS_MAST_WR_ADDR_2_ACK: c_uint = 0xd0;
pub const MV64XXX_I2C_STATUS_MAST_WR_ADDR_2_NO_ACK: c_uint = 0xd8;
pub const MV64XXX_I2C_STATUS_MAST_RD_ADDR_2_ACK: c_uint = 0xe0;
pub const MV64XXX_I2C_STATUS_MAST_RD_ADDR_2_NO_ACK: c_uint = 0xe8;
pub const MV64XXX_I2C_STATUS_NO_STATUS: c_uint = 0xf8;
// Register defines (I2C bridge)
pub const MV64XXX_I2C_REG_TX_DATA_LO: c_uint = 0xc0;
pub const MV64XXX_I2C_REG_TX_DATA_HI: c_uint = 0xc4;
pub const MV64XXX_I2C_REG_RX_DATA_LO: c_uint = 0xc8;
pub const MV64XXX_I2C_REG_RX_DATA_HI: c_uint = 0xcc;
pub const MV64XXX_I2C_REG_BRIDGE_CONTROL: c_uint = 0xd0;
pub const MV64XXX_I2C_REG_BRIDGE_STATUS: c_uint = 0xd4;
pub const MV64XXX_I2C_REG_BRIDGE_INTR_CAUSE: c_uint = 0xd8;
pub const MV64XXX_I2C_REG_BRIDGE_INTR_MASK: c_uint = 0xdC;
pub const MV64XXX_I2C_REG_BRIDGE_TIMING: c_uint = 0xe0;
// Bridge Control values

pub const MV64XXX_I2C_BRIDGE_CONTROL_ADDR_SHIFT: c_int = 2;

pub const MV64XXX_I2C_BRIDGE_CONTROL_TX_SIZE_SHIFT: c_int = 13;
pub const MV64XXX_I2C_BRIDGE_CONTROL_RX_SIZE_SHIFT: c_int = 16;
...
pub struct mv64xxx_i2c_data {
    ...
    pub reg_offsets: mv64xxx_i2c_regs,
    pub addr1: u32,
    pub addr2: u32,
    pub bytes_left: u32,
    pub byte_posn: u32,
...
// 5us delay in order to avoid repeated start timing violation
    pub errata_delay: bool,
    pub rstc: *mut reset_control,
    pub irq_clear_inverted: bool,
// Clk div is 2 to the power n, not 2 to the power n + 1
    pub clk_n_base_0: bool,
...
#[no_mangle]
unsafe extern "C" fn mv64xxx_i2c_send_start(drv_data: *mut mv64xxx_i2c_data) {
...
#[no_mangle]
unsafe extern "C" fn mv64xxx_i2c_wait_polling(drv_data: *mut mv64xxx_i2c_data) {
    static void mv64xxx_i2c_wait_polling(struct mv64xxx_i2c_data *drv_data)
    {
    let mut timeout: ktime_t = ktime_add_ms(ktime_get(), drv_data.adapter.timeout);
    ...
    let mut num: c_int = drv_data.num_msgs;
...
// Single write message transaction
    ...
    let mut len: usize = msgs[0].len - 1;
...
#[no_mangle]
pub unsafe extern "C" fn if(I2C_M_RD: num == 1 && msgs[0].flags &) -> else {
    let mut len: usize = msgs[0].len - 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn if(2: num ==) -> else {
    let mut lentx: usize = msgs[0].len - 1;
    let mut lenrx: usize = msgs[1].len - 1;
    ctrl_reg |=
...
//
    ...
    if (rc)
    return rc;
    BUG_ON(drv_data.msgs != core::ptr::null_mut());
    drv_data.msgs = msgs;
    ...
    ret = rc;
    drv_data.num_msgs = 0;
    drv_data.msgs = core::ptr::null_mut();
...
//
    ...
    drv_data.rstc = devm_reset_control_get_optional_exclusive(dev, core::ptr::null_mut());
...
// Not all platforms have clocks
    drv_data.clk = devm_clk_get(&pd.dev, core::ptr::null_mut());
    if (IS_ERR(drv_data.clk)) {
    if (PTR_ERR(drv_data.clk) == -EPROBE_DEFER)
    return -EPROBE_DEFER;
    drv_data.clk = core::ptr::null_mut();
    }
    drv_data.reg_clk = devm_clk_get(&pd.dev, "reg");
    if (IS_ERR(drv_data.reg_clk)) {
    if (PTR_ERR(drv_data.reg_clk) == -EPROBE_DEFER)
    return -EPROBE_DEFER;
    drv_data.reg_clk = core::ptr::null_mut();
    }
    ...
    mv64xxx_i2c_runtime_resume, core::ptr::null_mut())
