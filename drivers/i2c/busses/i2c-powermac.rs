...
//! Source: drivers/i2c/busses/i2c-powermac.c
#![no_std]
...
//
    ...
    let mut rc: c_int = 0;
    let mut read: c_int = (read_write == I2C_SMBUS_READ);
    let mut addrdir: c_int = (addr << 1) | read;
...
#[no_mangle]
unsafe extern "C" fn i2c_powermac_func(adapter: *mut *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_powermac_remove(dev: *mut platform_device) {
...
// Now handle some devices with missing "reg" properties
    ...
    return 0x60;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_node_name_eq(node, _arg: "deq")) -> else {
...
#[no_mangle]
unsafe extern "C" fn i2c_powermac_probe(dev: *mut platform_device) -> c_int {
...
// Clear of_node to skip automatic registration of i2c child nodes
    adapter.dev.of_node = core::ptr::null_mut();
