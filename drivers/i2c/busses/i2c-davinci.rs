...
//! Source: drivers/i2c/busses/i2c-davinci.c
#![no_std]
...
pub const DAVINCI_I2C_MAX_TRIES: c_int = 2;
pub const DAVINCI_I2C_OWN_ADDRESS: c_uint = 0x08;

    DAVINCI_I2C_IMR_ARDY | \
    DAVINCI_I2C_IMR_NACK | \
    DAVINCI_I2C_IMR_AL)
pub const DAVINCI_I2C_OAR_REG: c_uint = 0x00;
pub const DAVINCI_I2C_IMR_REG: c_uint = 0x04;
pub const DAVINCI_I2C_STR_REG: c_uint = 0x08;
pub const DAVINCI_I2C_CLKL_REG: c_uint = 0x0c;
pub const DAVINCI_I2C_CLKH_REG: c_uint = 0x10;
pub const DAVINCI_I2C_CNT_REG: c_uint = 0x14;
pub const DAVINCI_I2C_DRR_REG: c_uint = 0x18;
pub const DAVINCI_I2C_SAR_REG: c_uint = 0x1c;
pub const DAVINCI_I2C_DXR_REG: c_uint = 0x20;
pub const DAVINCI_I2C_MDR_REG: c_uint = 0x24;
pub const DAVINCI_I2C_IVR_REG: c_uint = 0x28;
pub const DAVINCI_I2C_EMDR_REG: c_uint = 0x2c;
pub const DAVINCI_I2C_PSC_REG: c_uint = 0x30;
pub const DAVINCI_I2C_FUNC_REG: c_uint = 0x48;
pub const DAVINCI_I2C_DIR_REG: c_uint = 0x4c;
pub const DAVINCI_I2C_DIN_REG: c_uint = 0x50;
pub const DAVINCI_I2C_DOUT_REG: c_uint = 0x54;
pub const DAVINCI_I2C_DSET_REG: c_uint = 0x58;
pub const DAVINCI_I2C_DCLR_REG: c_uint = 0x5c;
pub const DAVINCI_I2C_IVR_AAS: c_uint = 0x07;
pub const DAVINCI_I2C_IVR_SCD: c_uint = 0x06;
pub const DAVINCI_I2C_IVR_XRDY: c_uint = 0x05;
pub const DAVINCI_I2C_IVR_RDR: c_uint = 0x04;
pub const DAVINCI_I2C_IVR_ARDY: c_uint = 0x03;
pub const DAVINCI_I2C_IVR_NACK: c_uint = 0x02;
pub const DAVINCI_I2C_IVR_AL: c_uint = 0x01;
...
#[no_mangle]
pub unsafe extern "C" fn davinci_i2c_read_reg(i2c_dev: *mut davinci_i2c_dev, reg: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn i2c_davinci_calc_clk_dividers(dev: *mut davinci_i2c_dev) {
    ...
    u32 clkh;
    u32 clkl;
    let mut input_clock: u32 = clk_get_rate(dev.clk);
...
//
#[no_mangle]
unsafe extern "C" fn i2c_davinci_init(dev: *mut davinci_i2c_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn davinci_i2c_prepare_recovery(adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_unprepare_recovery(adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_set_scl(adap: *mut i2c_adapter, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_get_scl(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_get_sda(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_scl_prepare_recovery(adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_scl_unprepare_recovery(adap: *mut i2c_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_davinci_wait_bus_not_busy(dev: *mut davinci_i2c_dev) -> c_int {
    static int i2c_davinci_wait_bus_not_busy(struct davinci_i2c_dev *dev)
    {
    let mut timeout: c_ulong = jiffies + dev.adapter.timeout;
    do {
...
#[no_mangle]
unsafe extern "C" fn i2c_davinci_func(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn terminate_read(dev: *mut davinci_i2c_dev) {
    static void terminate_read(struct davinci_i2c_dev *dev)
    {
    let mut w: u16 = davinci_i2c_read_reg(dev, DAVINCI_I2C_MDR_REG);
...
#[no_mangle]
unsafe extern "C" fn terminate_write(dev: *mut davinci_i2c_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_davinci_isr(this_irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_davinci_cpufreq_register(dev: *mut davinci_i2c_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_davinci_cpufreq_deregister(dev: *mut davinci_i2c_dev) {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_probe(pdev: *mut platform_device) -> c_int {
    ...
    dev.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(dev.clk))
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_init_driver() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn davinci_i2c_exit_driver() -> void __exit {
