...
//! Source: drivers/i2c/busses/i2c-isch.c
#![no_std]
...
pub const SMBHSTCNT: c_uint = 0x00;
pub const SMBHSTSTS: c_uint = 0x01;
pub const SMBHSTCLK: c_uint = 0x02;
pub const SMBHSTADD: c_uint = 0x04	/* TSA */;
pub const SMBHSTCMD: c_uint = 0x05;
pub const SMBHSTDAT0: c_uint = 0x06;
pub const SMBHSTDAT1: c_uint = 0x07;
pub const SMBBLKDAT: c_uint = 0x20;
// I2C constants
pub const SCH_QUICK: c_uint = 0x00;
pub const SCH_BYTE: c_uint = 0x01;
pub const SCH_BYTE_DATA: c_uint = 0x02;
pub const SCH_WORD_DATA: c_uint = 0x03;
pub const SCH_BLOCK_DATA: c_uint = 0x05;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sch_i2c {
...
//
#[no_mangle]
unsafe extern "C" fn sch_transaction(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sch_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn smbus_sch_probe(pdev: *mut platform_device) -> c_int {
