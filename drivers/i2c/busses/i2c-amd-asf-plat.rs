...
//! Source: drivers/i2c/busses/i2c-amd-asf-plat.c
#![no_std]
...
// ASF register bits
pub const ASF_SLV_LISTN: c_int = 0;
pub const ASF_SLV_INTR: c_int = 1;
pub const ASF_SLV_RST: c_int = 4;
pub const ASF_PEC_SP: c_int = 5;
pub const ASF_DATA_EN: c_int = 7;
pub const ASF_MSTR_EN: c_int = 16;
pub const ASF_CLK_EN: c_int = 17;
// ASF address offsets

pub const ASF_BLOCK_MAX_BYTES: c_int = 72;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_asf_dev {
    pub adap: i2c_adapter,
    pub eoi_base: *mut void __iomem,
    pub target: *mut i2c_client,
    pub work_buf: delayed_work,
    pub mmio_cfg: sb800_mmio_cfg,
    pub port_addr: *mut resource,
}

#[no_mangle]
unsafe extern "C" fn amd_asf_process_target(work: *mut work_struct) {
    ...
    let mut piix4_smba: c_ushort = dev.port_addr.start;
    u8 data[ASF_BLOCK_MAX_BYTES];
    u8 bank, reg, cmd;
    let mut len: u8 = 0, idx, val;
...
#[no_mangle]
unsafe extern "C" fn amd_asf_update_mmio_target(dev: *mut amd_asf_dev, bit: u8, set: bool) {
...
#[no_mangle]
unsafe extern "C" fn amd_asf_setup_target(dev: *mut amd_asf_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_asf_access(adap: *mut i2c_adapter, addr: u16, command: u8, data: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_asf_xfer(adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_asf_reg_target(target: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_asf_unreg_target(target: *mut i2c_client) -> c_int {
    ...
    amd_asf_update_ioport_target(piix4_smba, ASF_SLV_RST, ASFSLVEN, true);
    dev.target = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn amd_asf_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn amd_asf_irq_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
    static irqreturn_t amd_asf_irq_handler(int irq, void *ptr)
    {
    struct amd_asf_dev *dev = ptr;
    let mut piix4_smba: c_ushort = dev.port_addr.start;
    let mut target_int: u8 = inb_p(ASFSTA);
    if (target_int & BIT(6)) {
// Target Interrupt
...
#[no_mangle]
unsafe extern "C" fn amd_asf_probe(pdev: *mut platform_device) -> c_int {
