...
//! Source: drivers/i2c/busses/i2c-uniphier-f.c
#![no_std]
...
pub const UNIPHIER_FI2C_CR: c_uint = 0x00	/* control register */;

pub const UNIPHIER_FI2C_DTTX: c_uint = 0x04	/* TX FIFO */;

pub const UNIPHIER_FI2C_DTRX: c_uint = 0x04	/* RX FIFO */;
pub const UNIPHIER_FI2C_SLAD: c_uint = 0x0c	/* target address */;
pub const UNIPHIER_FI2C_CYC: c_uint = 0x10	/* clock cycle control */;
pub const UNIPHIER_FI2C_LCTL: c_uint = 0x14	/* clock low period control */;
pub const UNIPHIER_FI2C_SSUT: c_uint = 0x18	/* restart/stop setup time control */;
pub const UNIPHIER_FI2C_DSUT: c_uint = 0x1c	/* data setup time control */;
pub const UNIPHIER_FI2C_INT: c_uint = 0x20	/* interrupt status */;
pub const UNIPHIER_FI2C_IE: c_uint = 0x24	/* interrupt enable */;
pub const UNIPHIER_FI2C_IC: c_uint = 0x28	/* interrupt clear */;

pub const UNIPHIER_FI2C_SR: c_uint = 0x2c	/* status register */;

pub const UNIPHIER_FI2C_RST: c_uint = 0x34	/* reset control */;

pub const UNIPHIER_FI2C_BM: c_uint = 0x38	/* bus monitor */;

pub const UNIPHIER_FI2C_NOISE: c_uint = 0x3c	/* noise filter control */;
pub const UNIPHIER_FI2C_TBC: c_uint = 0x40	/* TX byte count setting */;
pub const UNIPHIER_FI2C_RBC: c_uint = 0x44	/* RX byte count setting */;
pub const UNIPHIER_FI2C_TBCM: c_uint = 0x48	/* TX byte count monitor */;
pub const UNIPHIER_FI2C_RBCM: c_uint = 0x4c	/* RX byte count monitor */;
pub const UNIPHIER_FI2C_BRST: c_uint = 0x50	/* bus reset */;

    (UNIPHIER_FI2C_INT_NA | UNIPHIER_FI2C_INT_AL)

    (UNIPHIER_FI2C_INT_TC | UNIPHIER_FI2C_INT_RC)

pub const UNIPHIER_FI2C_FIFO_SIZE: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_fi2c_priv {
    pub comp: completion,
    ...
    bool first)
    {
    let mut fifo_space: c_int = UNIPHIER_FI2C_FIFO_SIZE;
//
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_drain_rxfifo(priv: *mut uniphier_fi2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_set_irqs(priv: *mut uniphier_fi2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_stop(priv: *mut uniphier_fi2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_rx_init(priv: *mut uniphier_fi2c_priv, addr: u16) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_reset(priv: *mut uniphier_fi2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_prepare_operation(priv: *mut uniphier_fi2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_recover(priv: *mut uniphier_fi2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_check_bus_busy(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_xfer(adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_get_scl(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_set_scl(adap: *mut i2c_adapter, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_get_sda(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_unprepare_recovery(adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_hw_init(priv: *mut uniphier_fi2c_priv) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn uniphier_fi2c_resume(dev: *mut device) -> int __maybe_unused {
