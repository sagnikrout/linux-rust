...
//! Source: drivers/i2c/busses/i2c-nforce2.c
#![no_std]
...
//
pub const NFORCE_PCI_SMB1: c_uint = 0x50;
pub const NFORCE_PCI_SMB2: c_uint = 0x54;
//
...
pub const NVIDIA_SMB_STATUS_ABRT_STS: c_uint = 0x01		/* Bit to notify that;
    abort succeeded */
pub const NVIDIA_SMB_CTRL_ABORT: c_uint = 0x20;
pub const NVIDIA_SMB_STS_DONE: c_uint = 0x80;
pub const NVIDIA_SMB_STS_ALRM: c_uint = 0x40;
pub const NVIDIA_SMB_STS_RES: c_uint = 0x20;
pub const NVIDIA_SMB_STS_STATUS: c_uint = 0x1f;
pub const NVIDIA_SMB_PRTCL_WRITE: c_uint = 0x00;
pub const NVIDIA_SMB_PRTCL_READ: c_uint = 0x01;
pub const NVIDIA_SMB_PRTCL_QUICK: c_uint = 0x02;
pub const NVIDIA_SMB_PRTCL_BYTE: c_uint = 0x04;
pub const NVIDIA_SMB_PRTCL_BYTE_DATA: c_uint = 0x06;
pub const NVIDIA_SMB_PRTCL_WORD_DATA: c_uint = 0x08;
pub const NVIDIA_SMB_PRTCL_BLOCK_DATA: c_uint = 0x0a;
pub const NVIDIA_SMB_PRTCL_PEC: c_uint = 0x80;
// Misc definitions
pub const MAX_TIMEOUT: c_int = 100;
...
#[no_mangle]
unsafe extern "C" fn nforce2_abort(adap: *mut i2c_adapter) {
...
#[no_mangle]
unsafe extern "C" fn nforce2_check_status(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nforce2_func(adapter: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nforce2_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nforce2_remove(dev: *mut pci_dev) {
