...
//! Source: drivers/i2c/busses/i2c-mpc.c
#![no_std]
...
pub const MPC_I2C_CLOCK_LEGACY: c_int = 0;

pub const MPC_I2C_FDR: c_uint = 0x04;
pub const MPC_I2C_CR: c_uint = 0x08;
pub const MPC_I2C_SR: c_uint = 0x0c;
pub const MPC_I2C_DR: c_uint = 0x10;
pub const MPC_I2C_DFSRR: c_uint = 0x14;
pub const CCR_MEN: c_uint = 0x80;
pub const CCR_MIEN: c_uint = 0x40;
pub const CCR_MSTA: c_uint = 0x20;
pub const CCR_MTX: c_uint = 0x10;
pub const CCR_TXAK: c_uint = 0x08;
pub const CCR_RSTA: c_uint = 0x04;
pub const CCR_RSVD: c_uint = 0x02;
pub const CSR_MCF: c_uint = 0x80;
pub const CSR_MAAS: c_uint = 0x40;
pub const CSR_MBB: c_uint = 0x20;
pub const CSR_MAL: c_uint = 0x10;
pub const CSR_SRW: c_uint = 0x04;
pub const CSR_MIF: c_uint = 0x02;
pub const CSR_RXAK: c_uint = 0x01;
    enum mpc_i2c_action {
...
pub struct mpc_i2c {
    ...
    pub dfsrr: u8 fdr,,
    pub cntl_bits: u32,
    pub action: enum mpc_i2c_action,
    ...
    pub block: u32,
    pub rc: c_int,
    pub expect_rxack: c_int,
    pub has_errata_A004447: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpc_i2c_divider {
    pub divider: u16,
    pub /: *mut *mut u16 fdr; / including dfsrr,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpc_i2c_data {
    pub clock): *mut *mut *mut *mut void (setup)(struct device_node node, struct mpc_i2c i2c, u32,
}

#[no_mangle]
pub unsafe extern "C" fn writeccr(i2c: *mut mpc_i2c, x: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn mpc_i2c_fixup(i2c: *mut mpc_i2c) {
...
#[no_mangle]
unsafe extern "C" fn i2c_mpc_wait_sr(i2c: *mut mpc_i2c, mask: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpc_i2c_fixup_A004447(i2c: *mut mpc_i2c) {
    ...
    const struct mpc_i2c_divider *div = core::ptr::null_mut();
...
// Enable I2C interrupts for mpc5121
    ...
    of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,mpc5121-i2c-ctrl");
    if (node_ctrl) {
    ctrl = of_iomap(node_ctrl, 0);
    if (ctrl) {
    u64 addr;
// Interrupt enable bits for i2c-0/1/2: bit 24/26/28
    of_property_read_reg(node, 0, &addr, core::ptr::null_mut());
    idx = (addr & 0xff) / 0x20;
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_get_sec_cfg_8xxx() -> u32 {
    static u32 mpc_i2c_get_sec_cfg_8xxx(void)
    {
    u32 __iomem *reg;
    let mut val: u32 = 0;
    struct device_node *node __free(device_node) =
    of_find_node_by_name(core::ptr::null_mut(), "global-utilities");
    if (node) {
    const u32 *prop = of_get_property(node, "reg", core::ptr::null_mut());
    if (prop) {
//
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_get_prescaler_8xxx() -> u32 {
...
// the above 85xx SoCs have prescaler 1
    prescaler = 1;
#[no_mangle]
pub unsafe extern "C" fn if(SVR_8533: (SVR_SOC_VER(svr) ==) -> else {
...
// all the other 85xx have prescaler 2
    ...
    {
    const struct mpc_i2c_divider *div = core::ptr::null_mut();
    let mut prescaler: u32 = mpc_i2c_get_prescaler_8xxx();
    u32 divider;
    int i;
    if (clock == MPC_I2C_CLOCK_LEGACY) {
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_finish(i2c: *mut mpc_i2c, rc: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_do_action(i2c: *mut mpc_i2c) {
    static void mpc_i2c_do_action(struct mpc_i2c *i2c)
    {
    struct i2c_msg *msg = core::ptr::null_mut();
    let mut dir: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_do_intr(i2c: *mut mpc_i2c, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_wait_for_completion(i2c: *mut mpc_i2c) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_execute_msg(i2c: *mut mpc_i2c) -> c_int {
...
// Wait until STOP is seen, allow up to 1 s
    ...
    let mut status: u8 = readb(i2c.base + MPC_I2C_SR);
...
#[no_mangle]
unsafe extern "C" fn mpc_xfer(adap: *mut i2c_adapter, msgs: *mut i2c_msg, num: c_int) -> c_int {
    ...
    msgs[i].buf);
    WARN_ON(i2c.msgs != core::ptr::null_mut());
    i2c.msgs = msgs;
    i2c.num_msgs = num;
    ...
    ret = rc;
    i2c.num_msgs = 0;
    i2c.msgs = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn mpc_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fsl_i2c_bus_recovery(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_i2c_probe(op: *mut platform_device) -> c_int {
...
//
    clk = devm_clk_get_optional_enabled(&op.dev, core::ptr::null_mut());
    if (IS_ERR(clk)) {
...
#[no_mangle]
unsafe extern "C" fn fsl_i2c_remove(op: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mpc_i2c_resume(dev: *mut device) -> int __maybe_unused {
