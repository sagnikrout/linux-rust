...
//! Source: drivers/i2c/busses/i2c-pxa-pci.c
#![no_std]
...
pub const CE4100_PCI_I2C_DEVS: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ce4100_devices {
    pub pdev: [*mut platform_device; CE4100_PCI_I2C_DEVS],
}
    ...
    continue;
    prop = of_get_property(child, "fast-mode", core::ptr::null_mut());
    if (prop)
    pdata.fast_mode = 1;
    break;
    }
