...
//! Source: drivers/i2c/busses/i2c-thunderx-pcidrv.c
#![no_std]
...
pub const PCI_DEVICE_ID_THUNDER_TWSI: c_uint = 0xa012;
pub const SYS_FREQ_DEFAULT: c_int = 800000000;
pub const OTX2_REF_FREQ_DEFAULT: c_int = 100000000;
pub const TWSI_INT_ENA_W1C: c_uint = 0x1028;
pub const TWSI_INT_ENA_W1S: c_uint = 0x1030;
//
...
//
#[no_mangle]
unsafe extern "C" fn thunder_i2c_int_enable(i2c: *mut octeon_i2c) {
...
//
#[no_mangle]
unsafe extern "C" fn thunder_i2c_int_disable(i2c: *mut octeon_i2c) {
...
#[no_mangle]
unsafe extern "C" fn thunder_i2c_hlc_int_enable(i2c: *mut octeon_i2c) {
...
#[no_mangle]
unsafe extern "C" fn thunder_i2c_hlc_int_disable(i2c: *mut octeon_i2c) {
...
#[no_mangle]
unsafe extern "C" fn thunderx_i2c_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn thunder_i2c_clock_enable(dev: *mut device, i2c: *mut octeon_i2c) {
    static void thunder_i2c_clock_enable(struct device *dev, struct octeon_i2c *i2c)
    {
    int ret;
    if (acpi_disabled) {
// DT
    i2c.clk = clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(i2c.clk)) {
    i2c.clk = core::ptr::null_mut();
    goto skip;
    }
...
#[no_mangle]
unsafe extern "C" fn thunder_i2c_clock_disable(dev: *mut device, clk: *mut clk) {
...
#[no_mangle]
unsafe extern "C" fn thunder_i2c_smbus_remove(i2c: *mut octeon_i2c) {
...
#[no_mangle]
unsafe extern "C" fn thunder_i2c_remove_pci(pdev: *mut pci_dev) {
