...
//! Source: drivers/i2c/busses/i2c-at91-master.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn at91_init_twi_bus_master(dev: *mut at91_twi_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn at91_calc_twi_clock(dev: *mut at91_twi_dev) {
    static void at91_calc_twi_clock(struct at91_twi_dev *dev)
    {
    int ckdiv, cdiv, div, hold = 0, filter_width = 0;
    struct at91_twi_pdata *pdata = dev.pdata;
    let mut offset: c_int = pdata.clk_offset;
    let mut max_ckdiv: c_int = pdata.clk_max_div;
...
#[no_mangle]
unsafe extern "C" fn at91_twi_dma_cleanup(dev: *mut at91_twi_dev) {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_write_next_byte(dev: *mut at91_twi_dev) {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_write_data_dma_callback(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_write_data_dma(dev: *mut at91_twi_dev) {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_read_next_byte(dev: *mut at91_twi_dev) {
...
#[no_mangle]
unsafe extern "C" fn at91_twi_read_data_dma_callback(data: *mut c_void) {
    static void at91_twi_read_data_dma_callback(void *data)
    {
    struct at91_twi_dev *dev = (struct at91_twi_dev *)data;
    let mut ier: unsigned = AT91_TWI_TXCOMP;
    dma_unmap_single(dev.dev, sg_dma_address(&dev.dma.sg[0]),
...
#[no_mangle]
unsafe extern "C" fn at91_twi_read_data_dma(dev: *mut at91_twi_dev) {
...
#[no_mangle]
unsafe extern "C" fn atmel_twi_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn at91_do_twi_transfer(dev: *mut at91_twi_dev) -> c_int {
    static int at91_do_twi_transfer(struct at91_twi_dev *dev)
    {
    int ret;
    unsigned long time_left;
    let mut has_unre_flag: bool = dev.pdata.has_unre_flag;
    let mut has_alt_cmd: bool = dev.pdata.has_alt_cmd;
//
...
// Clear pending interrupts, such as NACK.
    ...
    if (dev.fifo_size) {
    let mut fifo_mr: unsigned = at91_twi_read(dev, AT91_TWI_FMR);
...
// Flush FIFOs
    ...
    let mut start_flags: unsigned = AT91_TWI_START;
...
#[no_mangle]
unsafe extern "C" fn at91_twi_xfer(adap: *mut i2c_adapter, msg: *mut i2c_msg, num: c_int) -> c_int {
    static int at91_twi_xfer(struct i2c_adapter *adap, struct i2c_msg *msg, int num)
    {
    struct at91_twi_dev *dev = i2c_get_adapdata(adap);
    int ret;
    let mut int_addr_flag: unsigned = 0;
    struct i2c_msg *m_start = msg;
    bool is_read;
    u8 *dma_buf = core::ptr::null_mut();
    dev_dbg(&adap.dev, "at91_xfer: processing %d messages:\n", num);
    ret = pm_runtime_get_sync(dev.dev);
    if (ret < 0)
    goto out;
    if (num == 2) {
    let mut internal_address: c_int = 0;
    int i;
// 1st msg is put into the internal address, start with 2nd
    m_start = &msg[1];
    for (i = 0; i < msg.len; ++i) {
    let mut addr: unsigned = msg.buf[msg.len - 1 - i];
...
#[no_mangle]
unsafe extern "C" fn at91_twi_configure_dma(dev: *mut at91_twi_dev, phy_addr: u32) -> c_int {
    static int at91_twi_configure_dma(struct at91_twi_dev *dev, u32 phy_addr)
    {
    let mut ret: c_int = 0;
    struct dma_slave_config slave_config;
    struct at91_twi_dma *dma = &dev.dma;
    let mut addr_width: enum dma_slave_buswidth = DMA_SLAVE_BUSWIDTH_1_BYTE;
//
...
#[no_mangle]
unsafe extern "C" fn at91_twi_recover_bus_cmd(adap: *mut i2c_adapter) -> c_int {
    ...
    {
    struct i2c_bus_recovery_info *rinfo = &dev.rinfo;
    let mut has_clear_cmd: bool = dev.pdata.has_clear_cmd;
    if (!has_clear_cmd)
