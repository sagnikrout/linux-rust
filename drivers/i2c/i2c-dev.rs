...
#[no_mangle]
unsafe extern "C" fn put_i2c_dev(i2c_dev: *mut i2c_dev, del_cdev: bool) {
...
#[no_mangle]
unsafe extern "C" fn i2cdev_check(dev: *mut device, addrp: *mut c_void) -> c_int {
...
// walk up mux tree
#[no_mangle]
unsafe extern "C" fn i2cdev_check_mux_parents(adapter: *mut i2c_adapter, addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2cdev_check_mux_children(dev: *mut device, addrp: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2cdev_check_addr(adapter: *mut i2c_adapter, addr: c_uint) -> c_int {
...
//
    ...
    {
    let mut temp: union i2c_smbus_data = {};
    int datasize, res;
...
// These are special: we do not use data
    ...
    command, size, core::ptr::null_mut());
    if (data == core::ptr::null_mut()) {
    dev_dbg(&client.adapter.dev,
    "data is core::ptr::null_mut() pointer in ioctl I2C_SMBUS.\n");
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn i2cdev_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_smbus_ioctl_data32 {
    pub read_write: u8,
    pub command: u8,
    pub size: u32,
    pub /: *mut *mut *mut compat_caddr_t data; / union i2c_smbus_data data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_msg32 {
    pub addr: u16,
    pub flags: u16,
    pub len: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_rdwr_ioctl_data32 {
    pub /: *mut *mut *mut compat_caddr_t msgs; / struct i2c_msg __user msgs,
    pub nmsgs: u32,
}

#[no_mangle]
unsafe extern "C" fn compat_i2cdev_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn i2cdev_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2cdev_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2cdev_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn i2cdev_attach_adapter(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2cdev_detach_adapter(dev: *mut device) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn i2c_dev_attach_adapter(dev: *mut device, dummy: *mut c_void) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn i2c_dev_detach_adapter(dev: *mut device, dummy: *mut c_void) -> int __exit {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_dev_init() -> int __init {
...
// Bind to already existing adapters right away
    i2c_for_each_dev(core::ptr::null_mut(), i2c_dev_attach_adapter);
    return 0;
    out_unreg_class:
...
#[no_mangle]
unsafe extern "C" fn i2c_dev_exit() -> void __exit {
    static void __exit i2c_dev_exit(void)
    {
    bus_unregister_notifier(&i2c_bus_type, &i2cdev_notifier);
    i2c_for_each_dev(core::ptr::null_mut(), i2c_dev_detach_adapter);
    class_unregister(&i2c_dev_class);
    unregister_chrdev_region(MKDEV(I2C_MAJOR, 0), I2C_MINORS);
    }
