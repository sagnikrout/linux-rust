...
//! Source: drivers/i2c/algos/i2c-algo-bit.c
#![no_std]
...
// ----- global variables ---------------------------------------------
    ...
    let mut i2c_debug: static int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn sdalo(adap: *mut i2c_algo_bit_data) {
...
#[no_mangle]
pub unsafe extern "C" fn sdahi(adap: *mut i2c_algo_bit_data) {
...
#[no_mangle]
pub unsafe extern "C" fn scllo(adap: *mut i2c_algo_bit_data) {
...
//
#[no_mangle]
unsafe extern "C" fn sclhi(adap: *mut i2c_algo_bit_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_start(adap: *mut i2c_algo_bit_data) {
...
#[no_mangle]
unsafe extern "C" fn i2c_repstart(adap: *mut i2c_algo_bit_data) {
...
#[no_mangle]
unsafe extern "C" fn i2c_stop(adap: *mut i2c_algo_bit_data) {
...
//
#[no_mangle]
unsafe extern "C" fn i2c_outb(i2c_adap: *mut i2c_adapter, c: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_inb(i2c_adap: *mut i2c_adapter) -> c_int {
    static int i2c_inb(struct i2c_adapter *i2c_adap)
    {
// read byte via i2c port, without start/stop sequence
// acknowledge is sent in i2c_read.
    int i;
    let mut indata: c_uchar = 0;
    struct i2c_algo_bit_data *adap = i2c_adap.algo_data;
// assert: scl is low
    sdahi(adap);
    for (i = 0; i < 8; i++) {
...
//
#[no_mangle]
unsafe extern "C" fn test_bus(i2c_adap: *mut i2c_adapter) -> c_int {
    ...
    if (adap.getsda == core::ptr::null_mut())
    pr_info("%s: SDA is write-only, testing not possible\n", name);
    if (adap.getscl == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn sendbytes(i2c_adap: *mut i2c_adapter, msg: *mut i2c_msg) -> c_int {
    static int sendbytes(struct i2c_adapter *i2c_adap, struct i2c_msg *msg)
    {
    const unsigned char *temp = msg.buf;
    let mut count: c_int = msg.len;
    let mut nak_ok: c_ushort = msg.flags & I2C_M_IGNORE_NAK;
    int retval;
    let mut wrcount: c_int = 0;
    while (count > 0) {
...
#[no_mangle]
unsafe extern "C" fn acknak(i2c_adap: *mut i2c_adapter, is_ack: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn readbytes(i2c_adap: *mut i2c_adapter, msg: *mut i2c_msg) -> c_int {
    ...
    let mut count: c_int = msg.len;
    let mut flags: unsigned = msg.flags;
    struct i2c_algo_bit_data *adap = i2c_adap.algo_data;
    if (!adap.getsda)
    return -EOPNOTSUPP;
    while (count > 0) {
...
//
#[no_mangle]
unsafe extern "C" fn bit_doAddress(i2c_adap: *mut i2c_adapter, msg: *mut i2c_msg) -> c_int {
    static int bit_doAddress(struct i2c_adapter *i2c_adap, struct i2c_msg *msg)
    {
    let mut flags: c_ushort = msg.flags;
    let mut nak_ok: c_ushort = msg.flags & I2C_M_IGNORE_NAK;
    struct i2c_algo_bit_data *adap = i2c_adap.algo_data;
    unsigned char addr;
    int ret, retries;
...
// register new adapter to i2c module...
    ...
    adap.retries = 3;
    if (bit_adap.getscl == core::ptr::null_mut())
...
//
    ...
    if (ret < 0)
    return ret;
    if (bit_adap.getsda == core::ptr::null_mut())
    dev_warn(&adap.dev, "Not I2C compliant: can't read SDA\n");
    if (bit_adap.getscl == core::ptr::null_mut())
    dev_warn(&adap.dev, "Not I2C compliant: can't read SCL\n");
    if (bit_adap.getsda == core::ptr::null_mut() || bit_adap.getscl == core::ptr::null_mut())
    dev_warn(&adap.dev, "Bus may be unreliable\n");
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn i2c_bit_add_bus(adap: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_bit_add_numbered_bus(adap: *mut i2c_adapter) -> c_int {
