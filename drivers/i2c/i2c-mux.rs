...
#[no_mangle]
unsafe extern "C" fn i2c_mux_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_lock_bus(adapter: *mut i2c_adapter, flags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_trylock_bus(adapter: *mut i2c_adapter, flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_unlock_bus(adapter: *mut i2c_adapter, flags: c_uint) {
...
//
    ...
    struct device_node *mux_node, *child = core::ptr::null_mut();
    u32 reg;
    if (muxc.arbitrator)
    mux_node = of_get_child_by_name(dev_node, "i2c-arb");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: muxc->gate) -> else {
    else if (muxc.gate)
...
// A "reg" property indicates an old-style DT entry
    ...
    mux_node = core::ptr::null_mut();
    }
    }
    if (!mux_node)
    mux_node = of_node_get(dev_node);
#[no_mangle]
pub unsafe extern "C" fn if(muxc->gate: muxc->arbitrator ||) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_mux_del_adapters(muxc: *mut i2c_mux_core) {
    ...
    muxc.adapter[muxc.num_adapters] = core::ptr::null_mut();
