...
//! Source: drivers/i2c/i2c-core-acpi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_acpi_handler_data {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_acpi_lookup {
    pub info: *mut i2c_board_info,
    pub adapter_handle: acpi_handle,
    pub device_handle: acpi_handle,
    pub search_handle: acpi_handle,
    pub n: c_int,
    pub index: c_int,
    pub speed: u32,
    pub min_speed: u32,
...
#[no_mangle]
unsafe extern "C" fn i2c_acpi_resource_count(ares: *mut acpi_resource, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_acpi_client_count(adev: *mut acpi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_acpi_fill_info(ares: *mut acpi_resource, data: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_acpi_irq_context {
    pub irq: c_int,
...
#[no_mangle]
unsafe extern "C" fn i2c_acpi_add_irq_resource(ares: *mut acpi_resource, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_acpi_get_irq(client: *mut i2c_client, wake_capable: *mut bool) -> c_int {
...
//
    ...
    struct i2c_board_info info;
    if (!adev || i2c_acpi_get_info(adev, &info, adapter, core::ptr::null_mut()))
    return AE_OK;
    i2c_acpi_register_device(adapter, adev, &info);
    return AE_OK;
    }
pub const I2C_ACPI_MAX_SCAN_DEPTH: c_int = 32;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_acpi_register_devices(adap: *mut i2c_adapter) {
    ...
    i2c_acpi_add_device, core::ptr::null_mut(),
    adap, core::ptr::null_mut());
    if (ACPI_FAILURE(status))
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_acpi_find_bus_speed(dev: *mut device) -> u32 {
    ...
    status = acpi_walk_namespace(ACPI_TYPE_DEVICE, ACPI_ROOT_OBJECT,
    I2C_ACPI_MAX_SCAN_DEPTH,
    i2c_acpi_lookup_speed, core::ptr::null_mut(),
    &lookup, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
    ...
    struct i2c_adapter *adapter;
    struct device *dev;
    dev = bus_find_device(&i2c_bus_type, core::ptr::null_mut(), handle, device_match_acpi_handle);
    if (!dev)
    ...
    if (i2c_acpi_get_info(adev, &info, core::ptr::null_mut(), &adapter_handle))
    break;
...
#[no_mangle]
pub unsafe extern "C" fn i2c_acpi_waive_d0_probe(dev: *mut device) -> bool {
...
// 1 transfer must have completed successfully
    ...
    let mut action: u8 = function & ACPI_IO_MASK;
    acpi_status ret;
    int status;
...
#[no_mangle]
pub unsafe extern "C" fn i2c_acpi_install_space_handler(adapter: *mut i2c_adapter) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_acpi_remove_space_handler(adapter: *mut i2c_adapter) {
