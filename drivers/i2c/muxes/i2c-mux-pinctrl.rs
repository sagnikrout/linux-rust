...
//! Source: drivers/i2c/muxes/i2c-mux-pinctrl.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_mux_pinctrl {
    pub pinctrl: *mut pinctrl,
    pub states: [*mut pinctrl_state; ],
}

#[no_mangle]
unsafe extern "C" fn i2c_mux_pinctrl_select(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_pinctrl_deselect(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
    ...
    root = pin_root;
#[no_mangle]
pub unsafe extern "C" fn if(pin_root: root !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    ...
    0, i2c_mux_pinctrl_select, core::ptr::null_mut());
    if (!muxc) {
    ret = -ENOMEM;
    goto err_put_parent;
    }
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_pinctrl_remove(pdev: *mut platform_device) {
