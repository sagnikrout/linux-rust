...
//! Source: drivers/i2c/muxes/i2c-demux-pinctrl.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_demux_pinctrl_chan {
    pub parent_np: *mut device_node,
    pub parent_adap: *mut i2c_adapter,
    pub chgset: of_changeset,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_demux_pinctrl_priv {
    pub cur_chan: c_int,
    pub num_chan: c_int,
    pub dev: *mut device,
    pub bus_name: *const c_char,
    pub cur_adap: i2c_adapter,
    pub algo: i2c_algorithm,
    pub __counted_by(num_chan): i2c_demux_pinctrl_chan chan[],
}

#[no_mangle]
unsafe extern "C" fn i2c_demux_master_xfer(adap: *mut i2c_adapter, msgs[]: i2c_msg, num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_demux_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_demux_activate_master(priv: *mut i2c_demux_pinctrl_priv, new_chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_demux_deactivate_master(priv: *mut i2c_demux_pinctrl_priv) -> c_int {
    ...
    priv.chan[cur].parent_adap = core::ptr::null_mut();
    priv.cur_chan = -EINVAL;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn i2c_demux_change_master(priv: *mut i2c_demux_pinctrl_priv, new_chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_demux_pinctrl_probe(pdev: *mut platform_device) -> c_int {
    ...
    num_chan = of_count_phandle_with_args(np, "i2c-parent", core::ptr::null_mut());
    if (num_chan < 2) {
...
#[no_mangle]
unsafe extern "C" fn i2c_demux_pinctrl_remove(pdev: *mut platform_device) {
