...
//! Source: drivers/i2c/muxes/i2c-mux-ltc4306.c
#![no_std]
...
pub const LTC4305_MAX_NCHANS: c_int = 2;
pub const LTC4306_MAX_NCHANS: c_int = 4;
pub const LTC_REG_STATUS: c_uint = 0x0;
pub const LTC_REG_CONFIG: c_uint = 0x1;
pub const LTC_REG_MODE: c_uint = 0x2;
pub const LTC_REG_SWITCH: c_uint = 0x3;

pub const LTC_GPIO_ALL_INPUT: c_uint = 0xC0;
pub const LTC_SWITCH_MASK: c_uint = 0xF0;
    enum ltc_type {
    ltc_4305,
    ltc_4306,
    };
...
#[no_mangle]
unsafe extern "C" fn ltc4306_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool ltc4306_is_volatile_reg(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = LTC_REG_CONFIG;
    }
...
#[no_mangle]
unsafe extern "C" fn ltc4306_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4306_gpio_init(data: *mut ltc4306) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4306_select_mux(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4306_deselect_mux(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4306_probe(client: *mut i2c_client) -> c_int {
    ...
    idle_disc ? ltc4306_deselect_mux : core::ptr::null_mut());
    if (!muxc)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn ltc4306_remove(client: *mut i2c_client) {
