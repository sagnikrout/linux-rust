...
//! Source: drivers/i2c/muxes/i2c-mux-reg.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct regmux {
    pub data: i2c_mux_reg_platform_data,
}

#[no_mangle]
unsafe extern "C" fn i2c_mux_reg_set(mux: *const regmux, chan_id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_reg_select(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_reg_deselect(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_reg_probe_fw(mux: *mut regmux, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_reg_probe(pdev: *mut platform_device) -> c_int {
    ...
    i2c_mux_reg_select, core::ptr::null_mut());
    if (!muxc) {
    ret = -ENOMEM;
    goto err_put_parent;
    }
...
#[no_mangle]
unsafe extern "C" fn i2c_mux_reg_remove(pdev: *mut platform_device) {
