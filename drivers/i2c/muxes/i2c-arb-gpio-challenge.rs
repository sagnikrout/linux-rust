...
//! Source: drivers/i2c/muxes/i2c-arb-gpio-challenge.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_arbitrator_data {
    pub our_gpio: *mut gpio_desc,
    pub their_gpio: *mut gpio_desc,
    pub slew_delay_us: c_uint,
    pub wait_retry_us: c_uint,
    pub wait_free_us: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn i2c_arbitrator_select(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
...
// Wait for the other master to release it
    ...
    let mut gpio_val: c_int = gpiod_get_value(arb.their_gpio);
    if (!gpio_val) {
// We got it, so return
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn i2c_arbitrator_deselect(muxc: *mut i2c_mux_core, chan: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_arbitrator_probe(pdev: *mut platform_device) -> c_int {
...
// We only support probing from device tree; no platform_data
    ...
    muxc = i2c_mux_alloc(core::ptr::null_mut(), dev, 1, sizeof(*arb), I2C_MUX_ARBITRATOR,
...
#[no_mangle]
unsafe extern "C" fn i2c_arbitrator_remove(pdev: *mut platform_device) {
