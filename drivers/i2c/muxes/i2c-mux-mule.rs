...
//! Source: drivers/i2c/muxes/i2c-mux-mule.c
#![no_std]
...
pub const MULE_I2C_MUX_CONFIG_REG: c_uint = 0xff;
pub const MULE_I2C_MUX_DEFAULT_DEV: c_uint = 0x0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mule_i2c_reg_mux {
    pub regmap: *mut regmap,
}

#[no_mangle]
unsafe extern "C" fn mule_i2c_mux_select(muxc: *mut i2c_mux_core, dev: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mule_i2c_mux_deselect(muxc: *mut i2c_mux_core, dev: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mule_i2c_mux_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mule_i2c_mux_probe(pdev: *mut platform_device) -> c_int {
...
// Count devices on the mux
    ...
    priv.regmap = dev_get_regmap(mux_dev.parent, core::ptr::null_mut());
    if (!priv.regmap)
