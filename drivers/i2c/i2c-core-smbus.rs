...
//! Source: drivers/i2c/i2c-core-smbus.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn crc8(data: u16) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_smbus_pec(crc: u8, p: *mut u8, count: usize) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn i2c_smbus_msg_pec(pec: u8, msg: *mut i2c_msg) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_smbus_add_pec(msg: *mut i2c_msg) {
...
#[no_mangle]
unsafe extern "C" fn i2c_smbus_check_pec(cpec: u8, msg: *mut i2c_msg) -> c_int {
    static int i2c_smbus_check_pec(u8 cpec, struct i2c_msg *msg)
    {
    let mut rpec: u8 = msg.buf[--msg.len];
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_smbus_read_byte(client: *const i2c_client) -> i32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_smbus_write_byte(client: *const i2c_client, value: u8) -> i32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_smbus_read_byte_data(client: *const i2c_client, command: u8) -> i32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_smbus_read_word_data(client: *const i2c_client, command: u8) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_smbus_try_get_dmabuf(msg: *mut i2c_msg, init_val: u8) {
...
//
    ...
    let mut nmsgs: c_int = read_write == I2C_SMBUS_READ ? 2 : 1;
    let mut partial_pec: u8 = 0;
    int status;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: adapter->algo->master_xfer_atomic) -> else {
    else if (adapter.algo.master_xfer_atomic)
    xfer_func = core::ptr::null_mut(); /* fallback to I2C emulation */
    }
    if (xfer_func) {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_setup_smbus_alert(adapter: *mut i2c_adapter) -> c_int {
...
// Skip setup when no irq was found
    ...
    return 0;
    return PTR_ERR_OR_ZERO(i2c_new_smbus_alert_device(adapter, core::ptr::null_mut()));
    }
