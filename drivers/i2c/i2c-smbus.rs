...
//! Source: drivers/i2c/i2c-smbus.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_smbus_alert {
    pub alert: work_struct,
    pub /: *mut *mut *mut i2c_client ara; / Alert response address,
}
...
pub struct alert_data {
    pub addr: c_ushort,
    pub type: enum i2c_alert_protocol,
    pub data: c_uint,
}

// If this is the alerting device, notify its driver
#[no_mangle]
unsafe extern "C" fn smbus_do_alert(dev: *mut device, addrp: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbus_do_alert_force(dev: *mut device, addrp: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn smbus_alert(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smbalert_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn smbalert_probe(ara: *mut i2c_client) -> c_int {
    static int smbalert_probe(struct i2c_client *ara)
    {
    struct i2c_smbus_alert_setup *setup = dev_get_platdata(&ara.dev);
    struct i2c_smbus_alert *alert;
    struct i2c_adapter *adapter = ara.adapter;
    let mut irqflags: c_ulong = IRQF_SHARED | IRQF_ONESHOT;
    ...
    alert.ara = ara;
    if (irq > 0) {
    res = devm_request_threaded_irq(&ara.dev, irq, core::ptr::null_mut(), smbus_alert,
...
#[no_mangle]
unsafe extern "C" fn smbalert_remove(ara: *mut i2c_client) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_handle_smbus_alert(ara: *mut i2c_client) -> c_int {
...
pub const SMBUS_HOST_NOTIFY_LEN: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_slave_host_notify_status {
    pub index: u8,
    pub addr: u8,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_free_slave_host_notify_device(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn i2c_register_spd(adap: *mut i2c_adapter, write_disabled: bool) {
    static void i2c_register_spd(struct i2c_adapter *adap, bool write_disabled)
    {
    int n, slot_count = 0, dimm_count = 0;
    u16 handle;
    let mut common_mem_type: u8 = 0x0, mem_type;
    u64 mem_size;
    let mut instantiate: bool = true;
    const char *name;
...
//
    ...
    if (!instantiate)
    continue;
    if (!IS_ERR(i2c_new_scanned_device(adap, &info, addr_list, core::ptr::null_mut()))) {
    dev_info(&adap.dev,
...
#[no_mangle]
pub unsafe extern "C" fn i2c_register_spd_write_disable(adap: *mut i2c_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_register_spd_write_enable(adap: *mut i2c_adapter) {
