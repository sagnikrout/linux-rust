...
//! Source: drivers/i2c/i2c-core-of-prober.c
#![no_std]
...
//
    ...
    {
    struct device_node *node __free(device_node) = of_find_node_by_name(core::ptr::null_mut(), type);
    if (!node) {
...
#[no_mangle]
unsafe extern "C" fn i2c_of_probe_enable_node(dev: *mut device, node: *mut device_node) -> c_int {
...
//
    let mut __always_unused: *mut void ptr = no_free_ptr(ocs);
    }
    return ret;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_of_probe_component(dev: *mut device, cfg: *const i2c_of_probe_cfg, ctx: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_of_probe_simple_put_supply(ctx: *mut i2c_of_probe_simple_ctx) {
    static void i2c_of_probe_simple_put_supply(struct i2c_of_probe_simple_ctx *ctx)
    {
    regulator_put(ctx.supply);
    ctx.supply = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn i2c_of_probe_simple_enable_regulator(dev: *mut device, ctx: *mut i2c_of_probe_simple_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_of_probe_simple_disable_regulator(dev: *mut device, ctx: *mut i2c_of_probe_simple_ctx) {
...
#[no_mangle]
unsafe extern "C" fn i2c_of_probe_simple_put_gpiod(ctx: *mut i2c_of_probe_simple_ctx) {
    static void i2c_of_probe_simple_put_gpiod(struct i2c_of_probe_simple_ctx *ctx)
    {
    gpiod_put(ctx.gpiod);
    ctx.gpiod = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn i2c_of_probe_simple_set_gpio(dev: *mut device, ctx: *mut i2c_of_probe_simple_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_of_probe_simple_disable_gpio(dev: *mut device, ctx: *mut i2c_of_probe_simple_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_of_probe_simple_enable(dev: *mut device, bus_node: *mut device_node, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_of_probe_simple_cleanup_early(dev: *mut device, data: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn i2c_of_probe_simple_cleanup(dev: *mut device, data: *mut c_void) {
