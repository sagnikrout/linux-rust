...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_atr_alias_pool {
    pub size: usize,
    pub shared: bool,
// Protects aliases and use_mask
    pub lock: spinlock_t,
    pub use_mask: *mut c_ulong,
    pub __counted_by(size): u16 aliases[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct i2c_atr_chan {
    pub adap: i2c_adapter,
    pub atr: *mut i2c_atr,
    pub chan_id: u32,
// Lock alias_pairs during attach/detach
    pub alias_pairs_lock: mutex,
    pub alias_pairs_lock_key: lock_class_key,
    pub alias_pairs: list_head,
    pub alias_pool: *mut i2c_atr_alias_pool,
// Lock orig_addrs during xfer
    pub orig_addrs_lock: mutex,
    pub orig_addrs_lock_key: lock_class_key,
    pub orig_addrs: *mut u16,
    pub orig_addrs_size: c_uint,
}
...
// lock for the I2C bus segment (see struct i2c_lock_operations)
    ...
    pub flags: u32,
    pub alias_pool: *mut i2c_atr_alias_pool,
    pub i2c_nb: notifier_block,
    pub __counted_by(max_adapters): *mut *mut i2c_adapter adapter[],
}
...
#[no_mangle]
unsafe extern "C" fn i2c_atr_free_alias_pool(alias_pool: *mut i2c_atr_alias_pool) {
...
// Must be called with alias_pairs_lock held
#[no_mangle]
unsafe extern "C" fn i2c_atr_destroy_c2a(pc2a: *mut i2c_atr_alias_pair) {
...
#[no_mangle]
unsafe extern "C" fn i2c_atr_reserve_alias(alias_pool: *mut i2c_atr_alias_pool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_atr_release_alias(alias_pool: *mut i2c_atr_alias_pool, alias: u16) {
...
#[no_mangle]
unsafe extern "C" fn i2c_atr_functionality(adap: *mut i2c_adapter) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn i2c_atr_lock_bus(adapter: *mut i2c_adapter, flags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn i2c_atr_trylock_bus(adapter: *mut i2c_adapter, flags: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn i2c_atr_unlock_bus(adapter: *mut i2c_adapter, flags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn i2c_atr_parse_alias_pool(atr: *mut i2c_atr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_atr_delete(atr: *mut i2c_atr) {
...
#[no_mangle]
pub unsafe extern "C" fn i2c_atr_add_adapter(atr: *mut i2c_atr, desc: *mut i2c_atr_adap_desc) -> c_int {
    ...
    struct device *dev = atr.dev;
    let mut chan_id: u32 = desc.chan_id;
...
#[no_mangle]
pub unsafe extern "C" fn i2c_atr_del_adapter(atr: *mut i2c_atr, chan_id: u32) {
    ...
    if (!chan.alias_pool.shared)
    i2c_atr_free_alias_pool(chan.alias_pool);
    atr.adapter[chan_id] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn i2c_atr_set_driver_data(atr: *mut i2c_atr, data: *mut c_void) {
