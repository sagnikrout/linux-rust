...
//! Source: drivers/memory/renesas-rpc-if.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpcif_impl {
    pub hyperflash): *mut *mut *mut int (hw_init)(struct rpcif_priv rpc, bool,
    void (*prepare)(struct rpcif_priv *rpc, const struct rpcif_op *op,
    pub len): *mut *mut u64 offs, size_t,
    pub rpc): *mut *mut int (manual_xfer)(struct rpcif_priv,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpcif_info {
    pub regmap_config: *const regmap_config,
    pub impl: *const rpcif_impl,
    pub type: enum rpcif_type,
    pub strtim: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpcif_priv {
    pub dev: *mut device,
    ...
    pub spi_clk: *mut clk,
    pub spix2_clk: *mut clk,
    pub vdev: *mut platform_device,
    pub size: usize,
    pub info: *const rpcif_info,
    pub dir: enum rpcif_data_dir,
    pub bus_size: u8,
    pub xfer_size: u8,
    pub /: *mut *mut u8 addr_nbytes; / Specified for xSPI,
    pub /: *mut *mut u32 proto; / Specified for xSPI,
    pub buffer: *mut c_void,
    pub xferlen: u32,
    pub smcr: u32,
    pub smadr: u32,
    pub /: *mut *mut u32 command; / DRCMR or SMCMR,
    pub /: *mut *mut u32 option; / DROPR or SMOPR,
    pub /: *mut *mut u32 enable; / DRENR or SMENR,
    pub /: *mut *mut u32 dummy; / DRDMCR or SMDMCR,
    pub /: *mut *mut u32 ddr; / DRDRENR or SMDRENR,
}
...
//
#[no_mangle]
unsafe extern "C" fn rpcif_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpcif_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xspi_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xspi_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rpcif_sw_init(rpcif: *mut rpcif, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpcif_rzg2l_timing_adjust_sdr(rpc: *mut rpcif_priv) {
...
#[no_mangle]
unsafe extern "C" fn rpcif_hw_init_impl(rpc: *mut rpcif_priv, hyperflash: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xspi_hw_init_impl(xspi: *mut rpcif_priv, hyperflash: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rpcif_hw_init(dev: *mut device, hyperflash: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wait_msg_xfer_end(rpc: *mut rpcif_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpcif_bits_set(rpc: *mut rpcif_priv, nbytes: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn rpcif_bit_size(buswidth: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(4: op->addr.buswidth == 4 || op->data.buswidth ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rpcif_manual_xfer_impl(rpc: *mut rpcif_priv) -> c_int {
    ...
    let mut bytes_left: u32 = rpc.xferlen - pos;
...
#[no_mangle]
unsafe extern "C" fn xspi_manual_xfer_impl(xspi: *mut rpcif_priv) -> c_int {
    static int xspi_manual_xfer_impl(struct rpcif_priv *xspi)
    {
    let mut pos: u32 = 0, max = 8;
    let mut ret: c_int = 0;
    ...
    let mut bytes_left: u32 = xspi.xferlen - pos;
    u32 nbytes, data[2], *p = data;
...
#[no_mangle]
pub unsafe extern "C" fn rpcif_manual_xfer(dev: *mut device) -> c_int {
    ...
    size_t count)
    {
    let mut maxw: c_int = (IS_ENABLED(CONFIG_64BIT)) ? 8 : 4;
    u8 buf[2];
...
// (u8 *)to = buf[0];
    ...
    size_t len, void *buf)
    {
    let mut from: loff_t = offs & (rpc.size - 1);
    let mut size: usize = rpc.size - from;
    if (len > size)
    len = size;
    ...
    size_t len, void *buf)
    {
    let mut from: loff_t = offs & (xspi.size - 1);
    let mut size: usize = xspi.size - from;
    let mut addsize: u8 = xspi.addr_nbytes - 1;
    if (len > size)
    len = size;
...
#[no_mangle]
pub unsafe extern "C" fn rpcif_dirmap_read(dev: *mut device, offs: u64, len: usize, buf: *mut c_void) -> isize {
...
//
#[no_mangle]
pub unsafe extern "C" fn xspi_dirmap_write(dev: *mut device, offs: u64, len: usize, buf: *const c_void) -> isize {
...
#[no_mangle]
unsafe extern "C" fn rpcif_probe(pdev: *mut platform_device) -> c_int {
    ...
    const char *name;
    int ret;
    flash = of_get_next_child(dev.of_node, core::ptr::null_mut());
    if (!flash) {
    ...
    rpc.regmap = devm_regmap_init(dev, core::ptr::null_mut(), rpc, rpc.info.regmap_config);
...
#[no_mangle]
unsafe extern "C" fn rpcif_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rpcif_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpcif_resume(dev: *mut device) -> c_int {
