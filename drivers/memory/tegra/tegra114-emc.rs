...
//! Source: drivers/memory/tegra/tegra114-emc.c
#![no_std]
...
pub const EMC_INTMASK: c_uint = 0x4;
pub const EMC_DBG: c_uint = 0x8;

pub const EMC_CFG: c_uint = 0xc;

pub const EMC_ADR_CFG: c_uint = 0x10;
...
pub const EMC_QUSE_EXTRA: c_uint = 0xac;
...
#[no_mangle]
unsafe extern "C" fn tegra114_emc_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t tegra114_emc_isr(int irq, void *data)
    {
    struct tegra_emc *emc = data;
    let mut intmask: u32 = EMC_INTSTATUS_REFRESH_OVERFLOW;
    u32 status;
...
unsafe extern "C" fn emc_seq_wait_clkchange(emc: *mut tegra_emc) {
    ...
    u32 val, mask;
    let mut last_dll_enabled: bool = !(last.emc_mode_1 & 0x1);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: next_dll_enabled) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn tegra114_emc_validate_rate(emc: *mut tegra_emc, rate: c_ulong) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra114_emc_debug_min_rate_get(data: *mut c_void, rate: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra114_emc_debug_min_rate_set(data: *mut c_void, rate: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra114_emc_debug_max_rate_get(data: *mut c_void, rate: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra114_emc_debug_max_rate_set(data: *mut c_void, rate: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra114_emc_interconnect_init(emc: *mut tegra_emc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_tegra114_emc_unset_callback(data: *mut c_void) {
    static void devm_tegra114_emc_unset_callback(void *data)
    {
    tegra124_clk_set_emc_callbacks(core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tegra114_emc_probe(pdev: *mut platform_device) -> c_int {
