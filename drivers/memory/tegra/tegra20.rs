...
//! Source: drivers/memory/tegra/tegra20.c
#![no_std]
...
pub const MC_STAT_CONTROL: c_uint = 0x90;
pub const MC_STAT_EMC_CLOCK_LIMIT: c_uint = 0xa0;
pub const MC_STAT_EMC_CLOCKS: c_uint = 0xa4;
pub const MC_STAT_EMC_CONTROL_0: c_uint = 0xa8;
pub const MC_STAT_EMC_CONTROL_1: c_uint = 0xac;
pub const MC_STAT_EMC_COUNT_0: c_uint = 0xb8;
pub const MC_STAT_EMC_COUNT_1: c_uint = 0xbc;

pub const MC_STAT_CONTROL_PRI_EVENT_HP: c_int = 0;
pub const MC_STAT_CONTROL_PRI_EVENT_TM: c_int = 1;
pub const MC_STAT_CONTROL_PRI_EVENT_BW: c_int = 2;
pub const MC_STAT_CONTROL_FILTER_PRI_DISABLE: c_int = 0;
pub const MC_STAT_CONTROL_FILTER_PRI_NO: c_int = 1;
pub const MC_STAT_CONTROL_FILTER_PRI_YES: c_int = 2;
pub const MC_STAT_CONTROL_EVENT_QUALIFIED: c_int = 0;
pub const MC_STAT_CONTROL_EVENT_ANY_READ: c_int = 1;
pub const MC_STAT_CONTROL_EVENT_ANY_WRITE: c_int = 2;
pub const MC_STAT_CONTROL_EVENT_RD_WR_CHANGE: c_int = 3;
pub const MC_STAT_CONTROL_EVENT_SUCCESSIVE: c_int = 4;
pub const MC_STAT_CONTROL_EVENT_ARB_BANK_AA: c_int = 5;
pub const MC_STAT_CONTROL_EVENT_ARB_BANK_BB: c_int = 6;
pub const MC_STAT_CONTROL_EVENT_PAGE_MISS: c_int = 7;
pub const MC_STAT_CONTROL_EVENT_AUTO_PRECHARGE: c_int = 8;

pub const MC_STAT_SAMPLE_TIME_USEC: c_int = 16000;
// we store collected statistics as a fixed point values
pub const MC_FX_FRAC_SCALE: c_int = 100;
    static DEFINE_MUTEX(tegra20_mc_stat_lock);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra20_mc_stat_gather {
    pub pri_filter: c_uint,
    pub pri_event: c_uint,
    pub result: c_uint,
    pub client: c_uint,
    pub event: c_uint,
    pub client_enb: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra20_mc_stat {
    pub gather0: tegra20_mc_stat_gather,
    pub gather1: tegra20_mc_stat_gather,
    pub sample_time_usec: c_uint,
    pub mc: *const tegra_mc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra20_mc_client_stat {
    pub events: c_uint,
    pub arb_high_prio: c_uint,
    pub arb_timeout: c_uint,
    pub arb_bandwidth: c_uint,
    pub rd_wr_change: c_uint,
    pub successive: c_uint,
    pub page_miss: c_uint,
    pub auto_precharge: c_uint,
    pub arb_bank_aa: c_uint,
    pub arb_bank_bb: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn tegra20_mc_icc_set(src: *mut icc_node, dst: *mut icc_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra20_mc_stat_gather_control(g: *const tegra20_mc_stat_gather) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn tegra20_mc_stat_gather(stat: *mut tegra20_mc_stat) {
...
// collect more info from active clients
    ...
    for (client0 = core::ptr::null_mut(); i < mc.soc.num_clients; i++) {
    if (stats[i].events) {
    client0 = &mc.soc.clients[i];
    clienta = i++;
    break;
    ...
    for (client1 = core::ptr::null_mut(); i < mc.soc.num_clients; i++) {
    if (stats[i].events) {
...
#[no_mangle]
unsafe extern "C" fn tegra20_mc_stats_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra20_mc_probe(mc: *mut tegra_mc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra20_mc_handle_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
