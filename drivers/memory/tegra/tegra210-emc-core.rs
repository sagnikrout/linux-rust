...
//! Source: drivers/memory/tegra/tegra210-emc-core.c
#![no_std]
...
pub const EMC_CLK_EMC_2X_CLK_SRC_SHIFT: c_int = 29;

    (0x7 << EMC_CLK_EMC_2X_CLK_SRC_SHIFT)
pub const EMC_CLK_SOURCE_PLLM_LJ: c_uint = 0x4;
pub const EMC_CLK_SOURCE_PLLMB_LJ: c_uint = 0x5;

pub const EMC_CLK_EMC_2X_CLK_DIVISOR_SHIFT: c_int = 0;

    (0xff << EMC_CLK_EMC_2X_CLK_DIVISOR_SHIFT)
// CLK_RST_CONTROLLER_CLK_SOURCE_EMC_DLL
pub const DLL_CLK_EMC_DLL_CLK_SRC_SHIFT: c_int = 29;

    (0x7 << DLL_CLK_EMC_DLL_CLK_SRC_SHIFT)
pub const DLL_CLK_EMC_DLL_DDLL_CLK_SEL_SHIFT: c_int = 10;

    (0x3 << DLL_CLK_EMC_DLL_DDLL_CLK_SEL_SHIFT)
pub const PLLM_VCOA: c_int = 0;
pub const PLLM_VCOB: c_int = 1;
pub const EMC_DLL_SWITCH_OUT: c_int = 2;
pub const DLL_CLK_EMC_DLL_CLK_DIVISOR_SHIFT: c_int = 0;

    (0xff << DLL_CLK_EMC_DLL_CLK_DIVISOR_SHIFT)
// MC_EMEM_ARB_MISC0

// EMC_DATA_BRLSHFT_X
pub const EMC0_EMC_DATA_BRLSHFT_0_INDEX: c_int = 2;
pub const EMC1_EMC_DATA_BRLSHFT_0_INDEX: c_int = 3;
pub const EMC0_EMC_DATA_BRLSHFT_1_INDEX: c_int = 4;
pub const EMC1_EMC_DATA_BRLSHFT_1_INDEX: c_int = 5;
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_train(timer: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_training_start(emc: *mut tegra210_emc) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_training_stop(emc: *mut tegra210_emc) {
    static void tegra210_emc_training_stop(struct tegra210_emc *emc)
    {
    timer_delete(&emc.training);
    }
#[no_mangle]
unsafe extern "C" fn tegra210_emc_get_temperature(emc: *mut tegra210_emc) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_poll_refresh(timer: *mut timer_list) {
...
// temperature is fine, using regular refresh
    ...
    let mut interval: c_uint = emc.refresh_poll_interval;
    let mut timeout: c_uint = msecs_to_jiffies(interval);
    mod_timer(&emc.refresh_timer, jiffies + timeout);
    }
    }
#[no_mangle]
unsafe extern "C" fn tegra210_emc_poll_refresh_stop(emc: *mut tegra210_emc) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_poll_refresh_start(emc: *mut tegra210_emc) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_set_clock(emc: *mut tegra210_emc, clksrc: u32) {
    ...
    u32 clksrc)
    {
    let mut dll_setting: u32 = emc.next.dll_clk_src;
    u32 emc_clk_src;
    u32 emc_clk_div;
...
#[no_mangle]
pub unsafe extern "C" fn if(EMC_CLK_SOURCE_PLLM_LJ: emc_clk_src ==) -> else {
    ...
    let mut index: c_uint = emc.last - emc.timings;
    u32 clksrc;
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_do_clock_change(emc: *mut tegra210_emc, clksrc: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_set_shadow_bypass(emc: *mut tegra210_emc, set: c_int) {
    void tegra210_emc_set_shadow_bypass(struct tegra210_emc *emc, int set)
    {
    let mut emc_dbg: u32 = emc_readl(emc, EMC_DBG);
    if (set)
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_get_dll_state(next: *mut tegra210_emc_timing) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_timing_update(emc: *mut tegra210_emc) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_actual_osc_clocks(in: u32) -> c_ulong {
    unsigned long tegra210_emc_actual_osc_clocks(u32 in)
    {
    if (in < 0x40)
    return in * 16;
#[no_mangle]
pub unsafe extern "C" fn if(0x80: in <) -> else {
    else if (in < 0x80)
    return 2048;
#[no_mangle]
pub unsafe extern "C" fn if(0xc0: in <) -> else {
    else if (in < 0xc0)
    return 4096;
    else
    return 8192;
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_start_periodic_compensation(emc: *mut tegra210_emc) {
    void tegra210_emc_start_periodic_compensation(struct tegra210_emc *emc)
    {
    let mut mpc_req: u32 = 0x4b;
    emc_writel(emc, mpc_req, EMC_MPC);
    mpc_req = emc_readl(emc, EMC_MPC);
    }
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_compensate(next: *mut tegra210_emc_timing, offset: u32) -> u32 {
    u32 tegra210_emc_compensate(struct tegra210_emc_timing *next, u32 offset)
    {
    let mut temp: u32 = 0, rate = next.rate / 1000;
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_dll_prelock(emc: *mut tegra210_emc, clksrc: u32) -> u32 {
    ...
    value |= 150;
#[no_mangle]
pub unsafe extern "C" fn if(800000: emc->next->rate >= 600000 && emc->next->rate <) -> else {
    else if (emc.next.rate >= 600000 && emc.next.rate < 800000)
    value |= 100;
#[no_mangle]
pub unsafe extern "C" fn if(1000000: emc->next->rate >= 800000 && emc->next->rate <) -> else {
    else if (emc.next.rate >= 800000 && emc.next.rate < 1000000)
    value |= 70;
#[no_mangle]
pub unsafe extern "C" fn if(1200000: emc->next->rate >= 1000000 && emc->next->rate <) -> else {
    ...
    bool flip_backward)
    {
    let mut ramp_down_wait: u32 = 0, cmd_pad, dq_pad, rfu1, cfg5, common_tx;
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_reset_dram_clktree_values(timing: *mut tegra210_emc_timing) {
...
#[no_mangle]
unsafe extern "C" fn update_dll_control(emc: *mut tegra210_emc, value: u32, state: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_dll_disable(emc: *mut tegra210_emc) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra210_emc_dll_enable(emc: *mut tegra210_emc) {
    ...
    {
    let mut dsr_cntrl: u32 = timing.burst_regs[EMC_DYN_SELF_REF_CONTROL_INDEX];
    let mut pre_ref: u32 = timing.burst_regs[EMC_PRE_REFRESH_REQ_CNT_INDEX];
    let mut ref: u32 = timing.burst_regs[EMC_REFRESH_INDEX];
    switch (emc.refresh) {
    ...
    struct tegra210_emc_timing *timing = core::ptr::null_mut();
    let mut rate: c_ulong = config.rate;
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_debug_min_rate_get(data: *mut c_void, rate: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_debug_min_rate_set(data: *mut c_void, rate: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_debug_max_rate_get(data: *mut c_void, rate: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_debug_max_rate_set(data: *mut c_void, rate: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_debug_temperature_get(data: *mut c_void, temperature: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_debug_temperature_set(data: *mut c_void, temperature: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_debugfs_init(emc: *mut tegra210_emc) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_detect(emc: *mut tegra210_emc) {
...
// probe the number of channels
    ...
    let mut min_volt: u32 = timings[i].min_volt;
    let mut rate: u32 = timings[i].rate;
    if (!rate)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tegra210_emc_resume(dev: *mut device) -> int __maybe_unused {
