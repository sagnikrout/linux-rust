...
//! Source: drivers/memory/tegra/tegra234.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn tegra234_mc_icc_set(src: *mut icc_node, dst: *mut icc_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra234_mc_icc_get_init_bw(node: *mut icc_node, avg: *mut u32, peak: *mut u32) -> c_int {
