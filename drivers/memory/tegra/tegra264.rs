...
//! Source: drivers/memory/tegra/tegra264.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn tegra264_mc_icc_set(src: *mut icc_node, dst: *mut icc_node) -> c_int {
    static int tegra264_mc_icc_set(struct icc_node *src, struct icc_node *dst)
    {
    struct tegra_mc *mc = icc_provider_to_tegra_mc(dst.provider);
    let mut bwmgr_req: mrq_bwmgr_int_request = { 0 };
    let mut bwmgr_resp: mrq_bwmgr_int_response = { 0 };
...
//
    ...
    return 0;
    if (!mc.bpmp) {
    dev_err(mc.dev, "BPMP reference core::ptr::null_mut()\n");
    return -ENOENT;
    }
...
#[no_mangle]
unsafe extern "C" fn tegra264_mc_icc_get_init_bw(node: *mut icc_node, avg: *mut u32, peak: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcf_log_fault(mc: *mut tegra_mc, channel: u32, mcf_ch_intstatus: c_ulong) {
    ...
    let mut mc_rw_bit: u32 = MC_ERR_STATUS_RW, mc_sec_bit = MC_ERR_STATUS_SECURITY;
...
#[no_mangle]
unsafe extern "C" fn handle_mcf_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hub_log_fault(mc: *mut tegra_mc, hub: u32, hub_intstat: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn handle_hub_irq(irq: c_int, data: *mut c_void, mc_hubc_aperture_number: c_int) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn handle_sbs_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t handle_sbs_irq(int irq, void *data)
    {
    return handle_generic_irq((struct tegra_mc *)data, MSS_SBS_INTSTATUS_0);
    }
#[no_mangle]
unsafe extern "C" fn handle_channel_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
