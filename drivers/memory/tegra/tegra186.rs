...
//! Source: drivers/memory/tegra/tegra186.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tegra186_mc_probe(mc: *mut tegra_mc) -> c_int {
...
//
    ...
    mc.bcast_ch_regs = core::ptr::null_mut();
    goto populate;
    }
    ...
    populate:
    err = of_platform_populate(mc.dev.of_node, core::ptr::null_mut(), core::ptr::null_mut(), mc.dev);
    if (err < 0)
    return err;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tegra186_mc_remove(mc: *mut tegra_mc) {
...
#[no_mangle]
unsafe extern "C" fn tegra186_mc_probe_device(mc: *mut tegra_mc, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra186_mc_resume(mc: *mut tegra_mc) {
