...
//! Source: drivers/memory/mtk-smi.c
#![no_std]
...
// SMI COMMON
pub const SMI_L1LEN: c_uint = 0x100;
pub const SMI_L1_ARB: c_uint = 0x200;
pub const SMI_BUS_SEL: c_uint = 0x220;

// All are MMU0 defaultly. Only specialize mmu1 here.

pub const SMI_READ_FIFO_TH: c_uint = 0x230;
pub const SMI_M4U_TH: c_uint = 0x234;
pub const SMI_FIFO_TH1: c_uint = 0x238;
pub const SMI_FIFO_TH2: c_uint = 0x23c;
pub const SMI_DCM: c_uint = 0x300;
pub const SMI_DUMMY: c_uint = 0x444;
// SMI LARB
pub const SMI_LARB_SLP_CON: c_uint = 0xc;

pub const SMI_LARB_CMD_THRT_CON: c_uint = 0x24;

pub const SMI_LARB_SW_FLAG: c_uint = 0x40;
pub const SMI_LARB_SW_FLAG_1: c_uint = 0x1;
pub const SMI_LARB_OSTDL_PORT: c_uint = 0x200;

// Below are about mmu enable registers, they are different in SoCs
// gen1: mt2701
pub const REG_SMI_SECUR_CON_BASE: c_uint = 0x5c0;
...
// gen2:
// mt8167
pub const MT8167_SMI_LARB_MMU_EN: c_uint = 0xfc0;
// mt8173
pub const MT8173_SMI_LARB_MMU_EN: c_uint = 0xf00;
// general

    u32 _id = (id) & 0x3;				\
    (_id << 8 | _id << 10 | _id << 12 | _id << 14);	\
    })
pub const SMI_COMMON_INIT_REGS_NR: c_int = 6;
pub const SMI_LARB_PORT_NR_MAX: c_int = 32;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_smi_reg_pair {
    pub offset: c_uint,
    pub value: u32,
}
...
pub const MTK_SMI_LARB_REQ_CLK_NR: c_int = 2;
pub const MTK_SMI_LARB_OPT_CLK_NR: c_int = 1;
//
...
pub const MTK_SMI_COM_REQ_CLK_NR: c_int = 2;

pub const MTK_SMI_SUB_COM_GALS_REQ_CLK_NR: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_smi_common_plat {
    pub type: enum mtk_smi_type,
    pub has_gals: bool,
    pub /: *mut *mut u32 bus_sel; / Balance some larbs to enter mmu0 or mmu1,
    pub init: *const mtk_smi_reg_pair,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_smi_larb_gen {
    pub 1]: int port_in_larb[MTK_LARB_NR_MAX +,
    pub dev): *mut *mut int (config_port)(struct device,
    pub larb_direct_to_common_mask: c_uint,
    pub flags_general: c_uint,
    pub (*ostd)[SMI_LARB_PORT_NR_MAX]: *const u8,
}
...
pub struct mtk_smi {
    pub dev: *mut device,
    pub clk_num: c_uint,
    pub clks: [clk_bulk_data; MTK_SMI_CLK_NR_MAX],
    pub mt2701*/: *mut *mut *mut clk clk_async; /only needed by,
    union {
    pub /: *mut *mut *mut void __iomem smi_ao_base; / only for gen1,
    pub /: *mut *mut *mut void __iomem base; / only for gen2,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_smi_larb {
    pub smi: mtk_smi,
    pub base: *mut void __iomem,
    pub /: *mut *mut *mut device smi_common_dev; / common or sub-common dev,
    pub larb_gen: *const mtk_smi_larb_gen,
    pub larbid: c_int,
    pub mmu: *mut u32,
    pub bank: *mut c_uchar,
}
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_config_port_gen1(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_config_port_mt8167(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_config_port_mt8173(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_config_port_gen2_general(dev: *mut device) -> c_int {
    static int mtk_smi_larb_config_port_gen2_general(struct device *dev)
    {
    struct mtk_smi_larb *larb = dev_get_drvdata(dev);
    u32 reg, flags_general = larb.larb_gen.flags_general;
    const u8 *larbostd = larb.larb_gen.ostd ? larb.larb_gen.ostd[larb.larbid] : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_sleep_ctrl_enable(larb: *mut mtk_smi_larb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_sleep_ctrl_disable(larb: *mut mtk_smi_larb) {
    static void mtk_smi_larb_sleep_ctrl_disable(struct mtk_smi_larb *larb)
    {
    writel_relaxed(0, larb.base + SMI_LARB_SLP_CON);
    }
#[no_mangle]
unsafe extern "C" fn mtk_smi_device_link_common(dev: *mut device, com_dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_larb_suspend(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(mtk_smi_larb_suspend, mtk_smi_larb_resume, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_common_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MTK_SMI_GEN2_SUB_COMM: common->plat->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_common_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_common_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_common_suspend(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(mtk_smi_common_suspend, mtk_smi_common_resume, core::ptr::null_mut())
    SET_LATE_SYSTEM_SLEEP_PM_OPS(pm_runtime_force_suspend,
    pm_runtime_force_resume)
    };
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mtk_smi_exit() -> void __exit {
