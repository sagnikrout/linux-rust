...
//! Source: drivers/memory/brcmstb_dpfe.c
#![no_std]
...
pub const REG_DCPU_RESET: c_uint = 0x0;
pub const REG_TO_DCPU_MBOX: c_uint = 0x10;
pub const REG_TO_HOST_MBOX: c_uint = 0x14;
// Macros to process offsets returned by the DCPU
pub const DRAM_MSG_ADDR_OFFSET: c_uint = 0x0;
pub const DRAM_MSG_TYPE_OFFSET: c_uint = 0x1c;

    (BITS_PER_LONG - DRAM_MSG_TYPE_OFFSET)) - 1)
// Message RAM
pub const DCPU_MSG_RAM_START: c_uint = 0x100;

// DRAM Info Offsets & Masks
pub const DRAM_INFO_INTERVAL: c_uint = 0x0;
pub const DRAM_INFO_MR4: c_uint = 0x4;
pub const DRAM_INFO_ERROR: c_uint = 0x8;
pub const DRAM_INFO_MR4_MASK: c_uint = 0xff;

// DRAM MR4 Offsets & Masks
pub const DRAM_MR4_REFRESH: c_uint = 0x0	/* Refresh rate */;
pub const DRAM_MR4_SR_ABORT: c_uint = 0x3	/* Self Refresh Abort */;
pub const DRAM_MR4_PPRE: c_uint = 0x4	/* Post-package repair entry/exit */;
pub const DRAM_MR4_TH_OFFS: c_uint = 0x5	/* Thermal Offset; vendor specific */;
pub const DRAM_MR4_TUF: c_uint = 0x7	/* Temperature Update Flag */;
pub const DRAM_MR4_REFRESH_MASK: c_uint = 0x7;
pub const DRAM_MR4_SR_ABORT_MASK: c_uint = 0x1;
pub const DRAM_MR4_PPRE_MASK: c_uint = 0x1;
pub const DRAM_MR4_TH_OFFS_MASK: c_uint = 0x3;
pub const DRAM_MR4_TUF_MASK: c_uint = 0x1;
// DRAM Vendor Offsets & Masks (API v2)
pub const DRAM_VENDOR_MR5: c_uint = 0x0;
pub const DRAM_VENDOR_MR6: c_uint = 0x4;
pub const DRAM_VENDOR_MR7: c_uint = 0x8;
pub const DRAM_VENDOR_MR8: c_uint = 0xc;
pub const DRAM_VENDOR_ERROR: c_uint = 0x10;
pub const DRAM_VENDOR_MASK: c_uint = 0xff;

// DRAM Information Offsets & Masks (API v3)
pub const DRAM_DDR_INFO_MR4: c_uint = 0x0;
pub const DRAM_DDR_INFO_MR5: c_uint = 0x4;
pub const DRAM_DDR_INFO_MR6: c_uint = 0x8;
pub const DRAM_DDR_INFO_MR7: c_uint = 0xc;
pub const DRAM_DDR_INFO_MR8: c_uint = 0x10;
pub const DRAM_DDR_INFO_ERROR: c_uint = 0x14;
pub const DRAM_DDR_INFO_MASK: c_uint = 0xff;
// Reset register bits & masks
pub const DCPU_RESET_SHIFT: c_uint = 0x0;
pub const DCPU_RESET_MASK: c_uint = 0x1;
pub const DCPU_CLK_DISABLE_SHIFT: c_uint = 0x2;
// DCPU return codes

pub const DCPU_RET_SUCCESS: c_uint = 0x1;

// This error code is not firmware defined and only used in the driver.

// Firmware magic
pub const DPFE_BE_MAGIC: c_uint = 0xfe1010fe;
pub const DPFE_LE_MAGIC: c_uint = 0xfe0101fe;
// Error codes

// Message types
pub const DPFE_MSG_TYPE_COMMAND: c_int = 1;
pub const DPFE_MSG_TYPE_RESPONSE: c_int = 2;
pub const DELAY_LOOP_MAX: c_int = 1000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dpfe_firmware_header {
    pub magic: u32,
    pub sequence: u32,
    pub version: u32,
    pub imem_size: u32,
...
pub struct dpfe_api {
    ...
    pub sysfs_attrs: *const attribute_group,
    pub command: [u32; DPFE_CMD_MAX][MSG_FIELD_MAX],
}

// Things we need for as long as we are active.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcmstb_dpfe_priv {
    pub regs: *mut void __iomem,
    pub dmem: *mut void __iomem,
    pub imem: *mut void __iomem,
    pub dev: *mut device,
    pub dpfe_api: *const dpfe_api,
    pub lock: mutex,
}
...
// version.
//
    static DEVICE_ATTR(dpfe_info, 0444, show_info, core::ptr::null_mut());
    static DEVICE_ATTR(dpfe_refresh, 0644, show_refresh, store_refresh);
    static DEVICE_ATTR(dpfe_vendor, 0444, show_vendor, core::ptr::null_mut());
    static DEVICE_ATTR(dpfe_dram, 0444, show_dram, core::ptr::null_mut());
...
//
    ...
    .version = 2,
    .fw_name = core::ptr::null_mut(), /* We expect the firmware to have been downloaded! */
    .sysfs_attrs = dpfe_v2_groups,
    .command = {
    [DPFE_CMD_GET_INFO] = {
    [MSG_HEADER] = DPFE_MSG_TYPE_COMMAND,
...
#[no_mangle]
unsafe extern "C" fn is_dcpu_enabled(priv: *mut brcmstb_dpfe_priv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __disable_dcpu(priv: *mut brcmstb_dpfe_priv) {
...
#[no_mangle]
unsafe extern "C" fn __enable_dcpu(priv: *mut brcmstb_dpfe_priv) {
...
#[no_mangle]
unsafe extern "C" fn get_msg_chksum(msg[]: u32, max: c_uint) -> c_uint {
...
// Don't include the last field in the checksum.
    ...
    unsigned int offset;
    void __iomem *ptr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __finalize_command(priv: *mut brcmstb_dpfe_priv) {
...
// Ensure that the firmware file loaded meets all the requirements.
    ...
    let mut is_big_endian: bool = false;
    const u32 *chksum_ptr;
    if (header.magic == DPFE_BE_MAGIC)
    is_big_endian = true;
#[no_mangle]
pub unsafe extern "C" fn if(DPFE_LE_MAGIC: header->magic !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_dpfe_download_firmware(priv: *mut brcmstb_dpfe_priv) -> c_int {
...
// DMEM follows after IMEM.
    ...
    if (ret)
    return ret;
    info = get_msg_ptr(priv, response[MSG_ARG0], core::ptr::null_mut(), core::ptr::null_mut());
    if (!info)
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn brcmstb_dpfe_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_dpfe_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcmstb_dpfe_remove(pdev: *mut platform_device) {
