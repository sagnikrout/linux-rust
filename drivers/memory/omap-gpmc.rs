...
//! Source: drivers/memory/omap-gpmc.c
#![no_std]
...
pub const GPMC_REVISION: c_uint = 0x00;
pub const GPMC_SYSCONFIG: c_uint = 0x10;
pub const GPMC_SYSSTATUS: c_uint = 0x14;
pub const GPMC_IRQSTATUS: c_uint = 0x18;
pub const GPMC_IRQENABLE: c_uint = 0x1c;
pub const GPMC_TIMEOUT_CONTROL: c_uint = 0x40;
pub const GPMC_ERR_ADDRESS: c_uint = 0x44;
pub const GPMC_ERR_TYPE: c_uint = 0x48;
pub const GPMC_CONFIG: c_uint = 0x50;
pub const GPMC_STATUS: c_uint = 0x54;
pub const GPMC_PREFETCH_CONFIG1: c_uint = 0x1e0;
pub const GPMC_PREFETCH_CONFIG2: c_uint = 0x1e4;
pub const GPMC_PREFETCH_CONTROL: c_uint = 0x1ec;
pub const GPMC_PREFETCH_STATUS: c_uint = 0x1f0;
pub const GPMC_ECC_CONFIG: c_uint = 0x1f4;
pub const GPMC_ECC_CONTROL: c_uint = 0x1f8;
pub const GPMC_ECC_SIZE_CONFIG: c_uint = 0x1fc;
pub const GPMC_ECC1_RESULT: c_uint = 0x200;
pub const GPMC_ECC_BCH_RESULT_0: c_uint = 0x240   /* not available on OMAP2 */;
pub const GPMC_ECC_BCH_RESULT_1: c_uint = 0x244	/* not available on OMAP2 */;
pub const GPMC_ECC_BCH_RESULT_2: c_uint = 0x248	/* not available on OMAP2 */;
pub const GPMC_ECC_BCH_RESULT_3: c_uint = 0x24c	/* not available on OMAP2 */;
pub const GPMC_ECC_BCH_RESULT_4: c_uint = 0x300	/* not available on OMAP2 */;
pub const GPMC_ECC_BCH_RESULT_5: c_uint = 0x304	/* not available on OMAP2 */;
pub const GPMC_ECC_BCH_RESULT_6: c_uint = 0x308	/* not available on OMAP2 */;
// GPMC ECC control settings
pub const GPMC_ECC_CTRL_ECCCLEAR: c_uint = 0x100;
pub const GPMC_ECC_CTRL_ECCDISABLE: c_uint = 0x000;
pub const GPMC_ECC_CTRL_ECCREG1: c_uint = 0x001;
pub const GPMC_ECC_CTRL_ECCREG2: c_uint = 0x002;
pub const GPMC_ECC_CTRL_ECCREG3: c_uint = 0x003;
pub const GPMC_ECC_CTRL_ECCREG4: c_uint = 0x004;
pub const GPMC_ECC_CTRL_ECCREG5: c_uint = 0x005;
pub const GPMC_ECC_CTRL_ECCREG6: c_uint = 0x006;
pub const GPMC_ECC_CTRL_ECCREG7: c_uint = 0x007;
pub const GPMC_ECC_CTRL_ECCREG8: c_uint = 0x008;
pub const GPMC_ECC_CTRL_ECCREG9: c_uint = 0x009;

pub const GPMC_CS0_OFFSET: c_uint = 0x60;
pub const GPMC_CS_SIZE: c_uint = 0x30;
pub const GPMC_BCH_SIZE: c_uint = 0x10;
//
...
// there.
//
pub const GPMC_MEM_START: c_uint = 0x1000000;
pub const GPMC_MEM_END: c_uint = 0x3FFFFFFF;

pub const CS_NUM_SHIFT: c_int = 24;

pub const DMA_MPU_MODE: c_int = 2;

pub const GPMC_HAS_WR_ACCESS: c_uint = 0x1;
pub const GPMC_HAS_WR_DATA_MUX_BUS: c_uint = 0x2;
pub const GPMC_HAS_MUX_AAD: c_uint = 0x4;
pub const GPMC_NR_WAITPINS: c_int = 4;
pub const GPMC_CS_CONFIG1: c_uint = 0x00;
pub const GPMC_CS_CONFIG2: c_uint = 0x04;
pub const GPMC_CS_CONFIG3: c_uint = 0x08;
pub const GPMC_CS_CONFIG4: c_uint = 0x0c;
pub const GPMC_CS_CONFIG5: c_uint = 0x10;
pub const GPMC_CS_CONFIG6: c_uint = 0x14;
pub const GPMC_CS_CONFIG7: c_uint = 0x18;
pub const GPMC_CS_NAND_COMMAND: c_uint = 0x1c;
pub const GPMC_CS_NAND_ADDRESS: c_uint = 0x20;
pub const GPMC_CS_NAND_DATA: c_uint = 0x24;
// Control Commands
pub const GPMC_CONFIG_RDY_BSY: c_uint = 0x00000001;
pub const GPMC_CONFIG_DEV_SIZE: c_uint = 0x00000002;
pub const GPMC_CONFIG_DEV_TYPE: c_uint = 0x00000003;

// CLKACTIVATIONTIME Max Ticks
pub const GPMC_CONFIG1_CLKACTIVATIONTIME_MAX: c_int = 2;

// ATTACHEDDEVICEPAGELENGTH Max Value
pub const GPMC_CONFIG1_ATTACHEDDEVICEPAGELENGTH_MAX: c_int = 2;

// WAITMONITORINGTIME Max Ticks
pub const GPMC_CONFIG1_WAITMONITORINGTIME_MAX: c_int = 2;

// DEVICESIZE Max Value
pub const GPMC_CONFIG1_DEVICESIZE_MAX: c_int = 1;

pub const GPMC_CONFIG7_BASEADDRESS_MASK: c_uint = 0x3f;

pub const GPMC_CONFIG7_MASKADDRESS_OFFSET: c_int = 8;

// All CONFIG7 bits except reserved bits

    GPMC_CONFIG7_CSVALID_MASK |     \
    GPMC_CONFIG7_MASKADDRESS_MASK)
pub const GPMC_DEVICETYPE_NOR: c_int = 0;
pub const GPMC_DEVICETYPE_NAND: c_int = 2;
pub const GPMC_CONFIG_WRITEPROTECT: c_uint = 0x00000010;
pub const WR_RD_PIN_MONITORING: c_uint = 0x00600000;
// ECC commands
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap3_gpmc_regs {
    pub sysconfig: u32,
    pub irqenable: u32,
    pub timeout_ctrl: u32,
    pub config: u32,
    pub prefetch_config1: u32,
    pub prefetch_config2: u32,
    pub prefetch_control: u32,
    pub cs_context: [gpmc_cs_config; GPMC_CS_NUM],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpmc_waitpin {
    pub pin: u32,
    pub polarity: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpmc_device {
    pub dev: *mut device,
    pub irq: c_int,
    pub irq_chip: irq_chip,
    pub gpio_chip: gpio_chip,
    pub nb: notifier_block,
    pub context: omap3_gpmc_regs,
    pub waitpins: *mut gpmc_waitpin,
    pub nirqs: c_int,
    pub is_suspended:1: c_uint,
    pub data: *mut resource,
}
...
// Define chip-selects as reserved by default until probe completes
    let mut gpmc_cs_num: static unsigned int = GPMC_CS_NUM;
...
#[no_mangle]
unsafe extern "C" fn gpmc_write_reg(idx: c_int, val: u32) {
    static void gpmc_write_reg(int idx, u32 val)
    {
    writel_relaxed(val, gpmc_base + idx);
    }
#[no_mangle]
unsafe extern "C" fn gpmc_read_reg(idx: c_int) -> u32 {
    static u32 gpmc_read_reg(int idx)
    {
    return readl_relaxed(gpmc_base + idx);
    }
#[no_mangle]
pub unsafe extern "C" fn gpmc_cs_write_reg(cs: c_int, idx: c_int, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_read_reg(cs: c_int, idx: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gpmc_get_fclk_period() -> c_ulong {
    static unsigned long gpmc_get_fclk_period(void)
    {
    let mut rate: c_ulong = clk_get_rate(gpmc_l3_clk);
    rate /= 1000;
...
//
#[no_mangle]
unsafe extern "C" fn gpmc_get_clk_period(cs: c_int, cd: enum gpmc_clk_domain) -> c_ulong {
    static unsigned long gpmc_get_clk_period(int cs, enum gpmc_clk_domain cd)
    {
    let mut tick_ps: c_ulong = gpmc_get_fclk_period();
    u32 l;
    int div;
    switch (cd) {
    case GPMC_CD_CLK:
...
#[no_mangle]
unsafe extern "C" fn gpmc_ns_to_ticks(time_ns: c_uint) -> c_uint {
    static unsigned int gpmc_ns_to_ticks(unsigned int time_ns)
    {
    return gpmc_ns_to_clk_ticks(time_ns, /* any CS */ 0, GPMC_CD_FCLK);
    }
#[no_mangle]
unsafe extern "C" fn gpmc_ps_to_ticks(time_ps: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn gpmc_ticks_to_ps(ticks: c_uint) -> c_uint {
    static unsigned int gpmc_ticks_to_ps(unsigned int ticks)
    {
    return ticks * gpmc_get_fclk_period();
    }
#[no_mangle]
unsafe extern "C" fn gpmc_round_ps_to_ticks(time_ps: c_uint) -> c_uint {
    static unsigned int gpmc_round_ps_to_ticks(unsigned int time_ps)
    {
    let mut ticks: c_ulong = gpmc_ps_to_ticks(time_ps);
    return ticks * gpmc_get_fclk_period();
    }
#[no_mangle]
pub unsafe extern "C" fn gpmc_cs_modify_reg(cs: c_int, reg: c_int, mask: u32, value: bool) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_bool_timings(cs: c_int, p: *const gpmc_bool_timings) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_show_regs(cs: c_int, desc: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn gpmc_cs_show_timings(cs: c_int, desc: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn gpmc_cs_show_timings(cs: c_int, desc: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn gpmc_calc_waitmonitoring_divider(wait_monitoring: c_uint) -> c_int {
    static int gpmc_calc_waitmonitoring_divider(unsigned int wait_monitoring)
    {
    let mut div: c_int = gpmc_ns_to_ticks(wait_monitoring);
...
//
#[no_mangle]
pub unsafe extern "C" fn gpmc_calc_divider(sync_clk: c_uint) -> c_int {
    int gpmc_calc_divider(unsigned int sync_clk)
    {
    let mut div: c_int = gpmc_ps_to_ticks(sync_clk);
    if (div > 4)
    return -1;
    if (div <= 0)
    div = 1;
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_set_memconf(cs: c_int, base: u32, size: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_enable_mem(cs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_disable_mem(cs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_get_memconf(cs: c_int, base: *mut u32, size: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_mem_enabled(cs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_set_reserved(cs: c_int, reserved: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_reserved(cs: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gpmc_mem_align(size: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_insert_mem(cs: c_int, base: c_ulong, size: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_delete_mem(cs: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gpmc_cs_request(cs: c_int, size: c_ulong, base: *mut c_ulong) -> c_int {
    ...
    size, core::ptr::null_mut(), core::ptr::null_mut());
    if (r < 0)
    return r;
...
#[no_mangle]
pub unsafe extern "C" fn gpmc_cs_free(cs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_is_valid_waitpin(waitpin: u32) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpmc_configure(cmd: c_int, wval: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_nand_writebuffer_empty() -> bool {
...
//
    ...
    let mut t_cer: c_int = 15;
    let mut t_avdp: c_int = 12;
    const int t_cez  = 20; /* max of t_cez, t_oez */
    let mut t_wpl: c_int = 40;
    let mut t_wph: c_int = 30;
...
#[no_mangle]
unsafe extern "C" fn gpmc_irq_endis(hwirq: c_ulong, endis: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_irq_disable(p: *mut irq_data) {
    static void gpmc_irq_disable(struct irq_data *p)
    {
    gpmc_irq_endis(p.hwirq, false);
    }
#[no_mangle]
unsafe extern "C" fn gpmc_irq_enable(p: *mut irq_data) {
    static void gpmc_irq_enable(struct irq_data *p)
    {
    gpmc_irq_endis(p.hwirq, true);
    }
#[no_mangle]
unsafe extern "C" fn gpmc_irq_mask(d: *mut irq_data) {
    static void gpmc_irq_mask(struct irq_data *d)
    {
    gpmc_irq_endis(d.hwirq, false);
    }
#[no_mangle]
unsafe extern "C" fn gpmc_irq_unmask(d: *mut irq_data) {
    static void gpmc_irq_unmask(struct irq_data *d)
    {
    gpmc_irq_endis(d.hwirq, true);
    }
#[no_mangle]
unsafe extern "C" fn gpmc_irq_edge_config(hwirq: c_ulong, rising_edge: bool) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_irq_ack(d: *mut irq_data) {
    static void gpmc_irq_ack(struct irq_data *d)
    {
    let mut hwirq: c_uint = d.hwirq;
// skip reserved bits
    if (hwirq >= GPMC_NR_NAND_IRQS)
    hwirq += 8 - GPMC_NR_NAND_IRQS;
...
#[no_mangle]
unsafe extern "C" fn gpmc_irq_set_type(d: *mut irq_data, trigger: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IRQ_TYPE_EDGE_RISING: trigger ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn gpmc_handle_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn gpmc_setup_irq(gpmc: *mut gpmc_device) -> c_int {
...
// clear interrupts
    ...
    gpmc_irq_domain = core::ptr::null_mut();
    }
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn gpmc_free_irq(gpmc: *mut gpmc_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_mem_exit() {
...
#[no_mangle]
unsafe extern "C" fn gpmc_mem_init(gpmc: *mut gpmc_device) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_round_ps_to_sync_clk(time_ps: u32, sync_clk: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn gpmc_convert_ps_to_ns(t: *mut gpmc_timings) {
    ...
    struct gpmc_device_timings *dev_t)
    {
    let mut mux: bool = false, sync = false;
    if (gpmc_s) {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpmc_cs_program_settings(cs: c_int, p: *mut gpmc_settings) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(GPMC_WAITPINPOLARITY_ACTIVE_HIGH: p->wait_pin_polarity ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn gpmc_cs_set_name(cs: c_int, name: *const c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn gpmc_cs_remap(cs: c_int, base: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn gpmc_read_settings_dt(np: *mut device_node, p: *mut gpmc_settings) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_child_is_nand(child: *mut device_node) -> c_int {
...
// create platform device, NULL on error or when disabled
    if (!of_platform_device_create(child, core::ptr::null_mut(), &pdev.dev))
    goto err_child_fail;
// create children and other common bus children
    if (of_platform_default_populate(child, core::ptr::null_mut(), &pdev.dev))
    goto err_child_fail;
    return 0;
    err_child_fail:
...
#[no_mangle]
unsafe extern "C" fn gpmc_probe_dt(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_probe_dt_children(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_gpio_get_direction(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_gpio_get(chip: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_gpio_init(gpmc: *mut gpmc_device) -> c_int {
    ...
    ret = devm_gpiochip_add_data(gpmc.dev, &gpmc.gpio_chip, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn omap3_gpmc_save_context(gpmc: *mut gpmc_device) {
...
#[no_mangle]
unsafe extern "C" fn omap3_gpmc_restore_context(gpmc: *mut gpmc_device) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn gpmc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpmc_resume(dev: *mut device) -> c_int {
