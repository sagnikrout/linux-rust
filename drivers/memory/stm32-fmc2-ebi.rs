...
//! Source: drivers/memory/stm32-fmc2-ebi.c
#![no_std]
...
pub const FMC2_BTR1: c_uint = 0x4;

pub const FMC2_PCSCNTR: c_uint = 0x20;
pub const FMC2_CFGR: c_uint = 0x20;
pub const FMC2_SR: c_uint = 0x84;
pub const FMC2_BWTR1: c_uint = 0x104;

pub const FMC2_SECCFGR: c_uint = 0x300;
pub const FMC2_CIDCFGR0: c_uint = 0x30c;

pub const FMC2_SEMCR0: c_uint = 0x310;
...
pub const FMC2_MAX_EBI_CE: c_int = 4;
pub const FMC2_MAX_BANKS: c_int = 5;
pub const FMC2_MAX_RESOURCES: c_int = 6;
pub const FMC2_CID1: c_int = 1;
pub const FMC2_BCR_CPSIZE_0: c_uint = 0x0;
pub const FMC2_BCR_CPSIZE_128: c_uint = 0x1;
pub const FMC2_BCR_CPSIZE_256: c_uint = 0x2;
pub const FMC2_BCR_CPSIZE_512: c_uint = 0x3;
pub const FMC2_BCR_CPSIZE_1024: c_uint = 0x4;
pub const FMC2_BCR_MWID_8: c_uint = 0x0;
pub const FMC2_BCR_MWID_16: c_uint = 0x1;
pub const FMC2_BCR_MTYP_SRAM: c_uint = 0x0;
pub const FMC2_BCR_MTYP_PSRAM: c_uint = 0x1;
pub const FMC2_BCR_MTYP_NOR: c_uint = 0x2;
pub const FMC2_BCR_CSCOUNT_0: c_uint = 0x0;
pub const FMC2_BCR_CSCOUNT_1: c_uint = 0x1;
pub const FMC2_BCR_CSCOUNT_64: c_uint = 0x2;
pub const FMC2_BCR_CSCOUNT_256: c_uint = 0x3;
pub const FMC2_BXTR_EXTMOD_A: c_uint = 0x0;
pub const FMC2_BXTR_EXTMOD_B: c_uint = 0x1;
pub const FMC2_BXTR_EXTMOD_C: c_uint = 0x2;
pub const FMC2_BXTR_EXTMOD_D: c_uint = 0x3;
pub const FMC2_BCR_NBLSET_MAX: c_uint = 0x3;
pub const FMC2_BXTR_ADDSET_MAX: c_uint = 0xf;
pub const FMC2_BXTR_ADDHLD_MAX: c_uint = 0xf;
pub const FMC2_BXTR_DATAST_MAX: c_uint = 0xff;
pub const FMC2_BXTR_BUSTURN_MAX: c_uint = 0xf;
pub const FMC2_BXTR_DATAHLD_MAX: c_uint = 0x3;
pub const FMC2_BTR_CLKDIV_MAX: c_uint = 0xf;
pub const FMC2_BTR_DATLAT_MAX: c_uint = 0xf;
pub const FMC2_PCSCNTR_CSCOUNT_MAX: c_uint = 0xff;
pub const FMC2_CFGR_CLKDIV_MAX: c_uint = 0xf;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_fmc2_ebi_data {
    pub child_props: *const stm32_fmc2_prop,
    pub nb_child_props: c_uint,
    pub fmc2_enable_reg: u32,
    pub fmc2_enable_bit: u32,
    pub ebi): *mut *mut int (nwait_used_by_ctrls)(struct stm32_fmc2_ebi,
    pub ebi): *mut *mut void (set_setup)(struct stm32_fmc2_ebi,
    pub ebi): *mut *mut int (save_setup)(struct stm32_fmc2_ebi,
    pub resource): *mut *mut *mut int (check_rif)(struct stm32_fmc2_ebi ebi, u32,
    pub ebi): *mut *mut void (put_sems)(struct stm32_fmc2_ebi,
    pub ebi): *mut *mut void (get_sems)(struct stm32_fmc2_ebi,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_fmc2_ebi {
    pub dev: *mut device,
    pub clk: *mut clk,
    pub regmap: *mut regmap,
    pub data: *const stm32_fmc2_ebi_data,
    pub bank_assigned: u8,
    pub sem_taken: u8,
    pub access_granted: bool,
    pub bcr: [u32; FMC2_MAX_EBI_CE],
    pub btr: [u32; FMC2_MAX_EBI_CE],
    pub bwtr: [u32; FMC2_MAX_EBI_CE],
    pub pcscntr: u32,
    pub cfgr: u32,
}
...
pub struct stm32_fmc2_prop {
    ...
    pub cs): *const *const stm32_fmc2_prop prop, int,
    pub setup): *mut *mut *mut u32 (calculate)(struct stm32_fmc2_ebi ebi, int cs, u32,
    int (*set)(struct stm32_fmc2_ebi *ebi,
    const struct stm32_fmc2_prop *prop,
    pub setup): int cs, u32,
}
    ...
    int cs, u32 setup)
    {
    let mut hclk: c_ulong = clk_get_rate(ebi.clk);
    ...
    int cs, u32 setup)
    {
    let mut nb_clk_cycles: u32 = stm32_fmc2_ebi_ns_to_clock_cycles(ebi, cs, setup);
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_get_reg(reg_type: c_int, cs: c_int, reg: *mut u32) -> c_int {
...
// Cpsize not supported
    ...
    {
    u32 bcr, bxtr, reg;
    let mut val: u32 = FIELD_PREP(FMC2_BXTR_ACCMOD, FMC2_BXTR_EXTMOD_D);
    int ret;
    ret = stm32_fmc2_ebi_get_reg(prop.reg_type, cs, &reg);
    if (ret)
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(FMC2_CSCOUNT_1: setup ==) -> else {
    else if (setup == FMC2_CSCOUNT_1)
    val = FIELD_PREP(FMC2_BCR_CSCOUNT, FMC2_BCR_CSCOUNT_1);
#[no_mangle]
pub unsafe extern "C" fn if(FMC2_CSCOUNT_64: setup <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_mp25_check_rif(ebi: *mut stm32_fmc2_ebi, resource: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_mp25_put_sems(ebi: *mut stm32_fmc2_ebi) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_mp25_get_sems(ebi: *mut stm32_fmc2_ebi) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: prop->calculate) -> else {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_enable_bank(ebi: *mut stm32_fmc2_ebi, cs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_disable_bank(ebi: *mut stm32_fmc2_ebi, cs: c_int) {
    static void stm32_fmc2_ebi_disable_bank(struct stm32_fmc2_ebi *ebi, int cs)
    {
    regmap_update_bits(ebi.regmap, FMC2_BCR(cs), FMC2_BCR_MBKEN, 0);
    }
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_save_setup(ebi: *mut stm32_fmc2_ebi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_mp1_save_setup(ebi: *mut stm32_fmc2_ebi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_mp25_save_setup(ebi: *mut stm32_fmc2_ebi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_set_setup(ebi: *mut stm32_fmc2_ebi) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_mp1_set_setup(ebi: *mut stm32_fmc2_ebi) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_mp25_set_setup(ebi: *mut stm32_fmc2_ebi) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_disable_banks(ebi: *mut stm32_fmc2_ebi) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_nwait_used_by_ctrls(ebi: *mut stm32_fmc2_ebi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_enable(ebi: *mut stm32_fmc2_ebi) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_disable(ebi: *mut stm32_fmc2_ebi) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_parse_dt(ebi: *mut stm32_fmc2_ebi) -> c_int {
    static int stm32_fmc2_ebi_parse_dt(struct stm32_fmc2_ebi *ebi)
    {
    struct device *dev = ebi.dev;
    let mut child_found: bool = false;
    u32 bank;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_probe(pdev: *mut platform_device) -> c_int {
    ...
    ebi.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(ebi.clk))
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_fmc2_ebi_resume(dev: *mut device) -> int __maybe_unused {
    ...
    stm32_fmc2_ebi_runtime_resume, core::ptr::null_mut())
