...
//! Source: drivers/memory/samsung/exynos5422-dmc.c
#![no_std]
...
pub const PERF_COUNTER_START_VALUE: c_uint = 0xff000000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct exynos5_dmc {
    pub dev: *mut device,
    pub df: *mut devfreq,
    pub gov_data: devfreq_simple_ondemand_data,
    pub base_drexi0: *mut void __iomem,
    pub base_drexi1: *mut void __iomem,
    pub clk_regmap: *mut regmap,
// Protects curr_rate and frequency/voltage setting section
    pub lock: mutex,
    pub curr_rate: c_ulong,
    pub curr_volt: c_ulong,
    pub opp: *mut dmc_opp_table,
    pub opp_count: c_int,
    pub timings_arr_size: u32,
    pub timing_row: *mut u32,
    pub timing_data: *mut u32,
    pub timing_power: *mut u32,
    pub timings: *const lpddr3_timings,
    pub min_tck: *const lpddr3_min_tck,
    pub bypass_timing_row: u32,
    pub bypass_timing_data: u32,
    pub bypass_timing_power: u32,
    pub vdd_mif: *mut regulator,
    pub fout_spll: *mut clk,
    pub fout_bpll: *mut clk,
    pub mout_spll: *mut clk,
    pub mout_bpll: *mut clk,
    pub mout_mclk_cdrex: *mut clk,
    pub mout_mx_mspll_ccore: *mut clk,
    pub counter: *mut devfreq_event_dev,
    pub num_counters: c_int,
    pub last_overflow_ts: [u64; 2],
    pub load: c_ulong,
    pub total: c_ulong,
    pub in_irq_mode: bool,
}
...
#[no_mangle]
unsafe extern "C" fn exynos5_counters_set_event(dmc: *mut exynos5_dmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos5_counters_enable_edev(dmc: *mut exynos5_dmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos5_counters_disable_edev(dmc: *mut exynos5_dmc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_switch_timing_regs(dmc: *mut exynos5_dmc, set: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_set_bypass_dram_timings(dmc: *mut exynos5_dmc) {
...
//
    ...
    unsigned long target_rate)
    {
    let mut idx: c_int = find_target_freq_idx(dmc, target_rate);
    if (idx < 0)
    return -EINVAL;
...
//
    ...
    let mut target_rate: c_ulong = 0;
    let mut target_volt: c_ulong = 0;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_dmc_perf_events_calc(dmc: *mut exynos5_dmc, diff_ts: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_dmc_perf_events_check(dmc: *mut exynos5_dmc) {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_dmc_enable_perf_events(dmc: *mut exynos5_dmc) {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_dmc_disable_perf_events(dmc: *mut exynos5_dmc) {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_dmc_get_cur_freq(dev: *mut device, freq: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn of_get_dram_timings(dmc: *mut exynos5_dmc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_dmc_init_clks(dmc: *mut exynos5_dmc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_performance_counters_init(dmc: *mut exynos5_dmc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn exynos5_dmc_set_pause_on_switching(dmc: *mut exynos5_dmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmc_irq_thread(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_dmc_probe(pdev: *mut platform_device) -> c_int {
...
// There is two modes in which the driver works: polling or IRQ
    ...
    ret = devm_request_threaded_irq(dev, irq[0], core::ptr::null_mut(),
    ...
    ret = devm_request_threaded_irq(dev, irq[1], core::ptr::null_mut(),
    dmc_irq_thread, IRQF_ONESHOT,
    dev_name(dev), dmc);
    if (ret) {
    dev_err(dev, "couldn't grab IRQ\n");
...
//
#[no_mangle]
unsafe extern "C" fn exynos5_dmc_remove(pdev: *mut platform_device) {
