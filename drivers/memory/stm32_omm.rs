...
//! Source: drivers/memory/stm32_omm.c
#![no_std]
...
pub const OMM_CR: c_int = 0;

pub const OMM_CHILD_NB: c_int = 2;
pub const OMM_CLK_NB: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_omm {
    pub mm_res: *mut resource,
    pub clk_bulk: [clk_bulk_data; OMM_CLK_NB],
    pub child_reset: [*mut reset_control; OMM_CHILD_NB],
    pub io_base: *mut void __iomem,
    pub cr: u32,
    pub nb_child: u8,
    pub restore_omm: bool,
}

#[no_mangle]
unsafe extern "C" fn stm32_omm_set_amcr(dev: *mut device, set: bool) -> c_int {
    static int stm32_omm_set_amcr(struct device *dev, bool set)
    {
    struct stm32_omm *omm = dev_get_drvdata(dev);
    let mut mm_ospi2_size: resource_size_t = 0;
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_toggle_child_clock(dev: *mut device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_disable_child(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_configure(dev: *mut device) -> c_int {
    static int stm32_omm_configure(struct device *dev)
    {
    static const char * const clocks_name[] = {"omm", "ospi1", "ospi2"};
    struct stm32_omm *omm = dev_get_drvdata(dev);
    let mut clk_rate_max: c_ulong = 0;
    let mut mux: u32 = 0;
    let mut cssel_ovr: u32 = 0;
    let mut req2ack: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_check_access(np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_probe(pdev: *mut platform_device) -> c_int {
    static int stm32_omm_probe(struct platform_device *pdev)
    {
    static const char * const resets_name[] = {"ospi1", "ospi2"};
    struct device *dev = &pdev.dev;
    let mut child_access_granted: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn stm32_omm_resume(dev: *mut device) -> int __maybe_unused {
...
// Ensure both OSPI instance are disabled before configuring OMM
    ...
    stm32_omm_runtime_resume, core::ptr::null_mut())
