...
//! Source: drivers/memory/ti-emif-pm.c
#![no_std]
...
pub const EMIF_POWER_MGMT_WAIT_SELF_REFRESH_8192_CYCLES: c_uint = 0x00a0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_emif_data {
    pub ti_emif_sram_phys: phys_addr_t,
    pub ti_emif_sram_data_phys: phys_addr_t,
    pub ti_emif_sram_virt: c_ulong,
    pub ti_emif_sram_data_virt: c_ulong,
    pub sram_pool_code: *mut gen_pool,
    pub sram_pool_data: *mut gen_pool,
    pub pm_data: ti_emif_pm_data,
    pub pm_functions: ti_emif_pm_functions,
}
...
#[no_mangle]
unsafe extern "C" fn ti_emif_free_sram(emif_data: *mut ti_emif_data) {
...
#[no_mangle]
unsafe extern "C" fn ti_emif_push_sram(dev: *mut device, emif_data: *mut ti_emif_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_emif_configure_sr_delay(emif_data: *mut ti_emif_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_emif_copy_pm_function_table(sram_pool: *mut gen_pool, dst: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_emif_get_mem_type() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_emif_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_emif_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ti_emif_probe(pdev: *mut platform_device) -> c_int {
