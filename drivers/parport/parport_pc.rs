...
//! Source: drivers/parport/parport_pc.c
#![no_std]
...
pub const ECR_VND: c_int = 05;
pub const ECR_TST: c_int = 06;
pub const ECR_CNF: c_int = 07;
pub const ECR_MODE_MASK: c_uint = 0xe0;

pub const NR_SUPERIOS: c_int = 3;
...
// frob_control, but for ECR
    ...
    let mut ecr_writable: c_uchar = priv.ecr_writable;
    let mut ectr: c_uchar = 0;
    unsigned char new;
    if (m != 0xff)
...
#[no_mangle]
pub unsafe extern "C" fn frob_set_mode(p: *mut parport, mode: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn change_mode(p: *mut parport, m: c_int) -> c_int {
...
// have to wait for it to drain first.
    let mut expire: c_ulong = jiffies + p.physport.cad.timeout;
    int counter;
    switch (mode) {
...
//
#[no_mangle]
unsafe extern "C" fn clear_epp_timeout(pb: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parport_pc_save_state(p: *mut parport, s: *mut parport_state) {
    ...
    let mut c: register unsigned char = s.u.pc.ctr & priv.ctr_writable;
    outb(c, CONTROL(p));
    priv.ctr = c;
    if (priv.ecr)
...
#[no_mangle]
pub unsafe extern "C" fn if(PARPORT_EPP_FAST_16: (flags &) -> else {
...
// ((char *)buf) = inb(EPPADDR(port));
    ...
    let mut left: usize = length;
    let mut expire: c_ulong = jiffies + port.physport.cad.timeout;
    let mut fifo: c_ulong = FIFO(port);
    int poll_for = 8; /* 80 usecs */
    const struct parport_pc_private *priv = port.physport.private_data;
    let mut fifo_depth: c_int = priv.fifo_depth;
    port = port.physport;
...
// Forward mode.
    ...
    while (left) {
    unsigned char byte;
    let mut ecrval: c_uchar = inb(ECONTROL(port));
    let mut i: c_int = 0;
...
// FIFO is empty. Blast it full.
    let mut n: c_int = left < fifo_depth ? left : fifo_depth;
    outsb(fifo, bufp, n);
    bufp += n;
    left -= n;
...
// Half-full(call me an optimist)
    ...
    let mut start: c_ulong = (unsigned long) buf;
    let mut end: c_ulong = (unsigned long) buf + length - 1;
...
#[no_mangle]
unsafe extern "C" fn show_parconfig_smsc37c669(io: c_int, key: c_int) {
...
#[no_mangle]
unsafe extern "C" fn show_parconfig_winbond(io: c_int, key: c_int) {
...
#[no_mangle]
unsafe extern "C" fn decode_winbond(efer: c_int, key: c_int, devid: c_int, devrev: c_int, oldid: c_int) {
...
// Values are from public data sheets pdf files, I can just
    ...
    type = "83977F/AF";
#[no_mangle]
pub unsafe extern "C" fn if(0x9773: id ==) -> else {
    else if (id == 0x9773)
    type = "83977TF / SMSC 97w33x/97w34x";
#[no_mangle]
pub unsafe extern "C" fn if(0x9774: id ==) -> else {
    else if (id == 0x9774)
    type = "83977ATF";
#[no_mangle]
pub unsafe extern "C" fn if(0x5270: (id & ~0x0f) ==) -> else {
    else if ((id & ~0x0f) == 0x5270)
    type = "83977CTF / SMSC 97w36x";
#[no_mangle]
pub unsafe extern "C" fn if(0x52f0: (id & ~0x0f) ==) -> else {
    else if ((id & ~0x0f) == 0x52f0)
    type = "83977EF / SMSC 97w35x";
#[no_mangle]
pub unsafe extern "C" fn if(0x5210: (id & ~0x0f) ==) -> else {
    else if ((id & ~0x0f) == 0x5210)
    type = "83627";
#[no_mangle]
pub unsafe extern "C" fn if(0x6010: (id & ~0x0f) ==) -> else {
    else if ((id & ~0x0f) == 0x6010)
    type = "83697HF";
#[no_mangle]
pub unsafe extern "C" fn if(0x0a: (oldid & 0x0f) ==) -> else {
    type = "83877F";
    progif = 1;
...
#[no_mangle]
unsafe extern "C" fn decode_smsc(efer: c_int, key: c_int, devid: c_int, devrev: c_int) {
...
// simple heuristics, we happened to read some
    ...
    type = "37c665IR";
#[no_mangle]
pub unsafe extern "C" fn if(0x65: devid ==) -> else {
    else if	(devid == 0x65)
    type = "37c665GT";
#[no_mangle]
pub unsafe extern "C" fn if(0x66: devid ==) -> else {
    else if	(devid == 0x66)
    type = "37c666GT";
    if (verbose_probing)
...
#[no_mangle]
unsafe extern "C" fn winbond_check(io: c_int, key: c_int) {
...
#[no_mangle]
unsafe extern "C" fn winbond_check2(io: c_int, key: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smsc_check(io: c_int, key: c_int) {
...
#[no_mangle]
unsafe extern "C" fn detect_and_report_winbond() {
...
#[no_mangle]
unsafe extern "C" fn detect_and_report_smsc() {
...
#[no_mangle]
unsafe extern "C" fn detect_and_report_it87() {
...
#[no_mangle]
unsafe extern "C" fn get_superio_dma(p: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_superio_irq(p: *mut parport) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn parport_SPP_supported(pb: *mut parport) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn parport_ECR_present(pb: *mut parport) -> c_int {
    static int parport_ECR_present(struct parport *pb)
    {
    struct parport_pc_private *priv = pb.private_data;
    let mut r: c_uchar = 0xc;
...
//
#[no_mangle]
unsafe extern "C" fn parport_PS2_supported(pb: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parport_ECP_supported(pb: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_bug_present_check_epp(pb: *mut parport) -> c_int {
    static int intel_bug_present_check_epp(struct parport *pb)
    {
    const struct parport_pc_private *priv = pb.private_data;
    let mut bug_present: c_int = 0;
    if (priv.ecr) {
// store value of ECR
    let mut ecr: c_uchar = inb(ECONTROL(pb));
    unsigned char i;
...
#[no_mangle]
unsafe extern "C" fn intel_bug_present(pb: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parport_ECPPS2_supported(pb: *mut parport) -> c_int {
...
// EPP mode detection
#[no_mangle]
unsafe extern "C" fn parport_EPP_supported(pb: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parport_ECPEPP_supported(pb: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn programmable_irq_support(pb: *mut parport) -> c_int {
    static int programmable_irq_support(struct parport *pb)
    {
    int irq, intrLine;
    let mut oecr: c_uchar = inb(ECONTROL(pb));
...
#[no_mangle]
unsafe extern "C" fn irq_probe_ECP(pb: *mut parport) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irq_probe_EPP(pb: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irq_probe_SPP(pb: *mut parport) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn parport_irq_probe(pb: *mut parport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn programmable_dma_support(p: *mut parport) -> c_int {
    static int programmable_dma_support(struct parport *p)
    {
    let mut oecr: c_uchar = inb(ECONTROL(p));
    int dma;
...
#[no_mangle]
unsafe extern "C" fn parport_dma_probe(p: *mut parport) -> c_int {
...
// --- Initialisation code --------------------------------
    ...
    struct parport *p;
    let mut probedirq: c_int = PARPORT_IRQ_NONE;
    struct resource *base_res;
    struct resource	*ECR_res = core::ptr::null_mut();
    struct resource	*EPP_res = core::ptr::null_mut();
...
// a misnomer, actually - it's allocate and reserve parport number
    ...
    priv.fifo_depth = 0;
    priv.dma_buf = core::ptr::null_mut();
    priv.dma_handle = 0;
...
#[no_mangle]
pub unsafe extern "C" fn parport_pc_unregister_port(p: *mut parport) {
...
// Data for two known VIA chips
    ...
    {
    u8 tmp, tmp2, siofunc;
    let mut ppcontrol: u8 = 0;
    int dma, irq;
    unsigned port1, port2;
    let mut have_epp: unsigned = 0;
...
// each element directly indexed from enum list, above
    ...
    { sio_ite_8872_probe, core::ptr::null_mut(), },
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pci_parport_data {
    pub num: c_int,
    pub ports: [*mut parport; 2],
}
...
// This is a PCI card
    ...
    let mut lo: c_int = cards[i].addr[n].lo;
    let mut hi: c_int = cards[i].addr[n].hi;
    int irq;
...
#[no_mangle]
pub unsafe extern "C" fn if(6: hi >) -> else {
    else if (hi > 6)
...
#[no_mangle]
unsafe extern "C" fn parport_pc_pci_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn parport_pc_init_superio(autoirq: c_int, autodma: c_int) -> int __init {
    ...
    if (id == core::ptr::null_mut() || id.driver_data >= last_sio)
    continue;
...
#[no_mangle]
unsafe extern "C" fn parport_pc_pnp_remove(dev: *mut pnp_dev) {
...
#[no_mangle]
unsafe extern "C" fn parport_pc_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __attribute__(_arg: (unused)) -> c_int {
    static int __attribute__((unused))
    parport_pc_find_isa_ports(int autoirq, int autodma)
    {
    let mut count: c_int = 0;
    if (parport_pc_probe_port(0x3bc, 0x7bc, autoirq, autodma, core::ptr::null_mut(), 0))
    count++;
    if (parport_pc_probe_port(0x378, 0x778, autoirq, autodma, core::ptr::null_mut(), 0))
    count++;
    if (parport_pc_probe_port(0x278, 0x678, autoirq, autodma, core::ptr::null_mut(), 0))
    count++;
    return count;
    }
...
//
#[no_mangle]
unsafe extern "C" fn parport_pc_find_ports(autoirq: c_int, autodma: c_int) -> void __init {
    static void __init parport_pc_find_ports(int autoirq, int autodma)
    {
    let mut count: c_int = 0, err;
...
// val = automatic;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(s, _arg: "none", _arg: 4)) -> else {
    else if (!strncmp(s, "none", 4))
// val = none;
#[no_mangle]
pub unsafe extern "C" fn if(!strncmp(s: nofifo &&, _arg: "nofifo", _arg: 6)) -> else {
    else if (nofifo && !strncmp(s, "nofifo", 6))
// val = nofifo;
    else {
    char *ep;
    let mut r: c_ulong = simple_strtoul(s, &ep, 0);
    if (ep != s)
// val = r;
    else {
...
#[no_mangle]
unsafe extern "C" fn parport_parse_irq(irqstr: *const c_char, val: *mut c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parport_parse_dma(dmastr: *const c_char, val: *mut c_int) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parport_init_mode_setup(str: *mut c_char) -> int __init {
    ...
    module_param_hw_array(io_hi, int, ioport, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(irq, "IRQ line");
    module_param_hw_array(irq, charp, irq, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(dma, "DMA channel");
    module_param_hw_array(dma, charp, dma, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn parse_parport_params() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn parport_setup(str: *mut c_char) -> int __init {
...
// "Parser" ends here
#[no_mangle]
unsafe extern "C" fn parport_pc_init() -> int __init {
...
// Only probe the ports we were given.
    ...
    irqval[i], dmaval[i], core::ptr::null_mut(), 0);
    }
    } else
...
#[no_mangle]
unsafe extern "C" fn parport_pc_exit() -> void __exit {
