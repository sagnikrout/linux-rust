...
//! Source: drivers/parport/ieee1284.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn parport_ieee1284_wakeup(port: *mut parport) {
    static void parport_ieee1284_wakeup (struct parport *port)
    {
    up (&port.physport.ieee1284.irq);
    }
#[no_mangle]
unsafe extern "C" fn timeout_waiting_on_port(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_wait_event(port: *mut parport, timeout: signed long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parport_ieee1284_terminate(port: *mut parport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_negotiate(port: *mut parport, mode: c_int) -> c_int {
    ...
    let mut m: c_int = mode & ~IEEE1284_ADDR;
    int r;
    unsigned char xflag;
    port = port.physport;
...
#[no_mangle]
unsafe extern "C" fn parport_ieee1284_ack_data_avail(port: *mut parport) -> c_int {
...
// Handle an interrupt.
#[no_mangle]
pub unsafe extern "C" fn parport_ieee1284_interrupt(handle: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_write(port: *mut parport, buffer: *const c_void, len: usize) -> isize {
    ...
    ssize_t retval;
    let mut mode: c_int = port.ieee1284.mode;
    let mut addr: c_int = mode & IEEE1284_ADDR;
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_read(port: *mut parport, buffer: *mut c_void, len: usize) -> isize {
    ...
    let mut mode: c_int = port.physport.ieee1284.mode;
    let mut addr: c_int = mode & IEEE1284_ADDR;
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_set_timeout(dev: *mut pardevice, inactivity: c_long) -> c_long {
    long parport_set_timeout (struct pardevice *dev, long inactivity)
    {
    let mut old: long int = dev.timeout;
