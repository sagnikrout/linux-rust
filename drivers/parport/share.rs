...
//! Source: drivers/parport/share.c
#![no_std]
...
//
    ...
    let mut parport_default_timeslice: c_ulong = PARPORT_DEFAULT_TIMESLICE;
    let mut parport_default_spintime: c_int = DEFAULT_SPIN_TIME;
...
#[no_mangle]
unsafe extern "C" fn dead_write(p: *mut parport, b: *const c_void, l: usize, f: c_int) -> usize {
    static size_t dead_write(struct parport *p, const void *b, size_t l, int f)
    { return 0; }
#[no_mangle]
unsafe extern "C" fn dead_read(p: *mut parport, b: *mut c_void, l: usize, f: c_int) -> usize {
...
#[no_mangle]
unsafe extern "C" fn is_parport(dev: *mut device) -> c_int {
    static int is_parport(struct device *dev)
    {
    return dev.type == &parport_device_type;
    }
#[no_mangle]
unsafe extern "C" fn parport_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn parport_bus_init() -> c_int {
    int parport_bus_init(void)
    {
    return bus_register(&parport_bus_type);
    }
#[no_mangle]
pub unsafe extern "C" fn parport_bus_exit() {
...
//
#[no_mangle]
unsafe extern "C" fn driver_check(dev_drv: *mut device_driver, _port: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn attach_driver_chain(port: *mut parport) {
...
// new device model
//
    bus_for_each_drv(&parport_bus_type, core::ptr::null_mut(), port, driver_check);
    }
#[no_mangle]
unsafe extern "C" fn driver_detach(_drv: *mut device_driver, _port: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn detach_driver_chain(port: *mut parport) {
...
// new device model
//
    bus_for_each_drv(&parport_bus_type, core::ptr::null_mut(), port, driver_detach);
    }
// Ask kmod for some lowlevel drivers.
#[no_mangle]
unsafe extern "C" fn get_lowlevel_driver() {
...
//
#[no_mangle]
unsafe extern "C" fn port_check(dev: *mut device, dev_drv: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn port_detect(dev: *mut device, dev_drv: *mut c_void) -> c_int {
...
//
    ret = bus_for_each_dev(&parport_bus_type, core::ptr::null_mut(), core::ptr::null_mut(),
    port_detect);
    if (!ret)
    get_lowlevel_driver();
    mutex_lock(&registration_lock);
    if (drv.match_port)
    bus_for_each_dev(&parport_bus_type, core::ptr::null_mut(), drv,
    port_check);
...
#[no_mangle]
unsafe extern "C" fn port_detach(dev: *mut device, _drv: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_unregister_driver(drv: *mut parport_driver) {
    void parport_unregister_driver(struct parport_driver *drv)
    {
    mutex_lock(&registration_lock);
    bus_for_each_dev(&parport_bus_type, core::ptr::null_mut(), drv, port_detach);
    driver_unregister(&drv.driver);
    mutex_unlock(&registration_lock);
    }
    EXPORT_SYMBOL(parport_unregister_driver);
#[no_mangle]
unsafe extern "C" fn free_port(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn parport_del_port(port: *mut parport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_put_port(port: *mut parport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_announce_port(port: *mut parport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_remove_port(port: *mut parport) {
...
#[no_mangle]
unsafe extern "C" fn free_pardevice(dev: *mut device) {
...
// Chain this onto the list
    par_dev.prev = core::ptr::null_mut();
//
...
//
    ...
    par_dev.waitnext = core::ptr::null_mut();
    par_dev.waitprev = core::ptr::null_mut();
//
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_unregister_device(dev: *mut pardevice) {
    void parport_unregister_device(struct pardevice *dev)
    {
    struct parport *port;

    if (!dev) {
    pr_err("%s: passed core::ptr::null_mut()\n", __func__);
    return;
    }

    port = dev.port.physport;
    if (port.proc_device == dev) {
    port.proc_device = core::ptr::null_mut();
...
//
    ...
    {
    struct parport *port, *result = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_claim(dev: *mut pardevice) -> c_int {
...
// Take ourselves out of the wait list again.
    ...
    port.waittail = dev.waitprev;
    spin_unlock_irq(&port.waitlist_lock);
    dev.waitprev = dev.waitnext = core::ptr::null_mut();
    }
...
// First add ourselves to the end of the wait list.
    dev.waitnext = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_claim_or_block(dev: *mut pardevice) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_release(dev: *mut pardevice) {
...
#[no_mangle]
pub unsafe extern "C" fn parport_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
