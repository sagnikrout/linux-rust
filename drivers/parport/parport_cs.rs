...
//! Source: drivers/parport/parport_cs.c
#![no_std]
...
// ====================================================================
pub const FORCE_EPP_MODE: c_uint = 0x08;
...
#[no_mangle]
unsafe extern "C" fn parport_probe(link: *mut pcmcia_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parport_detach(link: *mut pcmcia_device) {
...
#[no_mangle]
unsafe extern "C" fn parport_config_check(p_dev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parport_config(link: *mut pcmcia_device) -> c_int {
    static int parport_config(struct pcmcia_device *link)
    {
    ...
    ret = pcmcia_loop_config(link, parport_config_check, core::ptr::null_mut());
    if (ret)
    goto failed;
    if (!link.irq)
    goto failed;
...
#[no_mangle]
unsafe extern "C" fn parport_cs_release(link: *mut pcmcia_device) {
