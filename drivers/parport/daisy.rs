...
//! Source: drivers/parport/daisy.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn add_dev(devnum: c_int, port: *mut parport, daisy: c_int) {
...
#[no_mangle]
unsafe extern "C" fn daisy_drv_probe(par_dev: *mut pardevice) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn parport_daisy_init(port: *mut parport) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn parport_daisy_fini(port: *mut parport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn parport_close(dev: *mut pardevice) {
...
#[no_mangle]
unsafe extern "C" fn cpp_daisy(port: *mut parport, cmd: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpp_mux(port: *mut parport, cmd: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn parport_daisy_deselect_all(port: *mut parport) {
    void parport_daisy_deselect_all(struct parport *port)
    {
    cpp_daisy(port, 0x30);
    }
#[no_mangle]
pub unsafe extern "C" fn parport_daisy_select(port: *mut parport, daisy: c_int, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mux_present(port: *mut parport) -> c_int {
    static int mux_present(struct parport *port)
    {
    return cpp_mux(port, 0x51) == 3;
    }
#[no_mangle]
unsafe extern "C" fn num_mux_ports(port: *mut parport) -> c_int {
    static int num_mux_ports(struct parport *port)
    {
    return cpp_mux(port, 0x58);
    }
#[no_mangle]
unsafe extern "C" fn select_port(port: *mut parport) -> c_int {
    static int select_port(struct parport *port)
    {
    let mut muxport: c_int = port.muxport;
    return cpp_mux(port, 0x60 + muxport) == muxport;
    }
#[no_mangle]
unsafe extern "C" fn assign_addrs(port: *mut parport) -> c_int {
    static int assign_addrs(struct parport *port)
    {
    unsigned char s;
    unsigned char daisy;
    let mut thisdev: c_int = numdevs;
    int detected;
    char *deviceid;
    parport_data_forward(port);
    parport_write_data(port, 0xaa); udelay(2);
