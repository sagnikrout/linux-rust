...
//! Source: drivers/parport/parport_serial.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct parport_pc_pci {
    pub numports: c_int,
    struct { /* BAR (base address registers) numbers in the config
    space header */
    pub lo: c_int,
    pub (max: *mut *mut int hi; / -1 if not there, >6 for offset-method,
    BAR is 6) */
    pub addr: [}; 4],
...
// ports will not be used.
    ...
    pub autodma): int autoirq, int,
// If set, this is called after probing for ports.  If 'failed'
// is non-zero we couldn't use any of the ports.
    void (*postinit_hook) (struct pci_dev *pdev,
    pub failed): *mut *mut parport_pc_pci card, int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct parport_serial_private {
    pub serial: *mut serial_private,
    pub num_par: c_int,
    pub port: [*mut parport; PARPORT_MAX],
    pub par: parport_pc_pci,
}

// Register the serial port(s) of a PCI card.
#[no_mangle]
unsafe extern "C" fn serial_register(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn parport_register(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    struct parport *port;
    let mut lo: c_int = card.addr[n].lo;
    let mut hi: c_int = card.addr[n].hi;
...
#[no_mangle]
unsafe extern "C" fn parport_serial_pci_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn parport_serial_pci_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn parport_serial_pci_resume(dev: *mut device) -> int __maybe_unused {
