...
//! Source: drivers/parport/ieee1284_ops.c
#![no_std]
...
// Compatibility mode.
    ...
    while (count < len) {
    let mut expire: c_ulong = jiffies + dev.timeout;
    let mut wait: c_long = msecs_to_jiffies(10);
...
//
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn ecp_forward_to_reverse(port: *mut parport) -> c_int {
...
// Event 40: PError goes low
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn ecp_reverse_to_forward(port: *mut parport) -> c_int {
...
// HostAck high (data, not command)
    ...
    let mut expire: c_ulong = jiffies + port.cad.timeout;
    unsigned char byte;
    byte = *buf;
    try_again:
    parport_write_data (port, byte);
...
#[no_mangle]
pub unsafe extern "C" fn if(IEEE1284_MODE_ECPRLE: port->ieee1284.mode !=) -> else {
