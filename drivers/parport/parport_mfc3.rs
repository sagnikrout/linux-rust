...
//! Source: drivers/parport/parport_mfc3.c
#![no_std]
...
pub const MAX_MFC: c_int = 5;

    static struct parport *this_port[MAX_MFC] = {core::ptr::null_mut(), };
    static volatile int dummy; /* for trigger readds */

    static struct parport_operations pp_mfc3_ops;
#[no_mangle]
unsafe extern "C" fn mfc3_write_data(p: *mut parport, data: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn mfc3_read_data(p: *mut parport) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn control_pc_to_mfc3(control: c_uchar) -> c_uchar {
    static unsigned char control_pc_to_mfc3(unsigned char control)
    {
    let mut ret: c_uchar = 32|64;
...
#[no_mangle]
unsafe extern "C" fn control_mfc3_to_pc(control: c_uchar) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn mfc3_write_control(p: *mut parport, control: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn mfc3_read_control(p: *mut parport) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn mfc3_frob_control(p: *mut parport, mask: c_uchar, val: c_uchar) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn status_mfc3_to_pc(status: c_uchar) -> c_uchar {
    static unsigned char status_mfc3_to_pc(unsigned char status)
    {
    let mut ret: c_uchar = PARPORT_STATUS_BUSY;
    if (status & 1) /* Busy */
...
#[no_mangle]
unsafe extern "C" fn mfc3_read_status(p: *mut parport) -> c_uchar {
    ...
    static int use_cnt;
#[no_mangle]
unsafe extern "C" fn mfc3_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t mfc3_interrupt(int irq, void *dev_id)
    {
    int i;
    for( i = 0; i < MAX_MFC; i++)
    if (this_port[i] != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn mfc3_enable_irq(p: *mut parport) {
    static void mfc3_enable_irq(struct parport *p)
    {
    pia(p).crb |= PIA_C1_ENABLE_IRQ;
    }
#[no_mangle]
unsafe extern "C" fn mfc3_disable_irq(p: *mut parport) {
    static void mfc3_disable_irq(struct parport *p)
    {
    pia(p).crb &= ~PIA_C1_ENABLE_IRQ;
    }
#[no_mangle]
unsafe extern "C" fn mfc3_data_forward(p: *mut parport) {
...
#[no_mangle]
unsafe extern "C" fn mfc3_data_reverse(p: *mut parport) {
...
#[no_mangle]
unsafe extern "C" fn mfc3_init_state(dev: *mut pardevice, s: *mut parport_state) {
...
#[no_mangle]
unsafe extern "C" fn mfc3_save_state(p: *mut parport, s: *mut parport_state) {
...
#[no_mangle]
unsafe extern "C" fn mfc3_restore_state(p: *mut parport, s: *mut parport_state) {
...
#[no_mangle]
unsafe extern "C" fn parport_mfc3_exit() -> void __exit {
