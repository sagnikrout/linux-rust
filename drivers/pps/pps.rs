...
//
#[no_mangle]
unsafe extern "C" fn pps_cdev_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn pps_cdev_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pps_cdev_pps_fetch(pps: *mut pps_device, fdata: *mut pps_fdata) -> c_int {
    static int pps_cdev_pps_fetch(struct pps_device *pps, struct pps_fdata *fdata)
    {
    let mut ev: c_uint = pps.last_ev;
    let mut err: c_int = 0;
// Manage the timeout
...
#[no_mangle]
unsafe extern "C" fn pps_cdev_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pps_cdev_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pps_device_destruct(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn pps_register_cdev(pps: *mut pps_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pps_unregister_cdev(pps: *mut pps_device) {
    void pps_unregister_cdev(struct pps_device *pps)
    {
    pr_debug("unregistering pps%d\n", pps.id);
    pps.lookup_cookie = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn pps_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn pps_init() -> int __init {
