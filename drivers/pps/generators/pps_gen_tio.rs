...
//! Source: drivers/pps/generators/pps_gen_tio.c
#![no_std]
...
pub const TIOCTL: c_uint = 0x00;
pub const TIOCOMPV: c_uint = 0x10;
pub const TIOEC: c_uint = 0x30;
// Control Register

// Safety time to set hrtimer early

pub const ART_HW_DELAY_CYCLES: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pps_tio {
    pub gen_info: pps_gen_source_info,
    pub pps_gen: *mut pps_gen_device,
    pub timer: hrtimer,
...
#[no_mangle]
pub unsafe extern "C" fn pps_tio_read(offset: u32, tio: *mut pps_tio) -> u32 {
    static inline u32 pps_tio_read(u32 offset, struct pps_tio *tio)
    {
    return readl(tio.base + offset);
    }
#[no_mangle]
pub unsafe extern "C" fn pps_ctl_write(value: u32, tio: *mut pps_tio) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pps_compv_write(value: u64, tio: *mut pps_tio) {
    static inline void pps_compv_write(u64 value, struct pps_tio *tio)
    {
    hi_lo_writeq(value, tio.base + TIOCOMPV);
    }
#[no_mangle]
pub unsafe extern "C" fn first_event(tio: *mut pps_tio) -> ktime_t {
    static inline ktime_t first_event(struct pps_tio *tio)
    {
    return ktime_set(ktime_get_real_seconds() + 1, MAGIC_CONST);
    }
#[no_mangle]
unsafe extern "C" fn pps_tio_disable(tio: *mut pps_tio) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn pps_tio_enable(tio: *mut pps_tio) {
...
#[no_mangle]
unsafe extern "C" fn pps_tio_direction_output(tio: *mut pps_tio) {
...
#[no_mangle]
unsafe extern "C" fn pps_generate_next_pulse(expires: ktime_t, tio: *mut pps_tio) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hrtimer_callback(timer: *mut hrtimer) -> enum hrtimer_restart {
...
//
    ...
    pps_tio_disable(tio);
    pps_gen_event(tio.pps_gen, PPS_GEN_EVENT_MISSEDPULSE, core::ptr::null_mut());
    return HRTIMER_NORESTART;
    }
#[no_mangle]
unsafe extern "C" fn pps_tio_gen_enable(pps_gen: *mut pps_gen_device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pps_gen_tio_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pps_gen_tio_remove(pdev: *mut platform_device) {
