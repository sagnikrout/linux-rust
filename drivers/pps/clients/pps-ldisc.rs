...
//! Source: drivers/pps/clients/pps-ldisc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pps_tty_dcd_change(tty: *mut tty_struct, active: bool) {
...
//
    if (WARN_ON_ONCE(pps == core::ptr::null_mut()))
    return;
...
#[no_mangle]
unsafe extern "C" fn pps_tty_open(tty: *mut tty_struct) -> c_int {
    static int pps_tty_open(struct tty_struct *tty)
    {
    struct pps_source_info info;
    struct tty_driver *drv = tty.driver;
    let mut index: c_int = tty.index + drv.name_base;
    struct pps_device *pps;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn pps_tty_close(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn pps_tty_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pps_tty_cleanup() -> void __exit {
