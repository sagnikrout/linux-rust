...
//! Source: drivers/nvmem/brcm_nvram.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcm_nvram {
    pub dev: *mut device,
    pub nvmem_size: usize,
    pub data: *mut u8,
    pub data_len: usize,
    pub padding_byte: u8,
    pub cells: *mut nvmem_cell_info,
    pub ncells: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct brcm_nvram_header {
    pub magic: [c_char; 4],
    pub len: __le32,
    pub /: *mut *mut __le32 crc_ver_init; / 0:7 crc, 8:15 ver, 16:31 sdram_init,
    pub /: *mut *mut __le32 config_refresh; / 0:15 sdram_config, 16:31 sdram_refresh,
    pub /: *mut *mut __le32 config_ncdl; / ncdl values for memc,
}
...
#[no_mangle]
unsafe extern "C" fn brcm_nvram_copy_data(priv: *mut brcm_nvram, pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_nvram_parse(priv: *mut brcm_nvram) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_nvram_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_nvram_init() -> int __init {
