...
//! Source: drivers/nvmem/u-boot-env.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct u_boot_env {
    pub dev: *mut device,
    pub nvmem: *mut nvmem_device,
    pub format: enum u_boot_env_format,
...
#[no_mangle]
unsafe extern "C" fn u_boot_env_probe(pdev: *mut platform_device) -> c_int {
