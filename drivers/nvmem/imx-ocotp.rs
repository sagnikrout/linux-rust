...
//! Source: drivers/nvmem/imx-ocotp.c
#![no_std]
...
pub const IMX_OCOTP_OFFSET_B0W0: c_uint = 0x400 /* Offset from base address of the;
// OTP Bank0 Word0
//
pub const IMX_OCOTP_OFFSET_PER_WORD: c_uint = 0x10  /* Offset between the start addr;
// of two consecutive OTP words.
//
pub const IMX_OCOTP_ADDR_CTRL: c_uint = 0x0000;
pub const IMX_OCOTP_ADDR_CTRL_SET: c_uint = 0x0004;
pub const IMX_OCOTP_ADDR_CTRL_CLR: c_uint = 0x0008;
pub const IMX_OCOTP_ADDR_TIMING: c_uint = 0x0010;
pub const IMX_OCOTP_ADDR_DATA0: c_uint = 0x0020;
pub const IMX_OCOTP_ADDR_DATA1: c_uint = 0x0030;
pub const IMX_OCOTP_ADDR_DATA2: c_uint = 0x0040;
pub const IMX_OCOTP_ADDR_DATA3: c_uint = 0x0050;
pub const IMX_OCOTP_BM_CTRL_ADDR: c_uint = 0x000000FF;
pub const IMX_OCOTP_BM_CTRL_BUSY: c_uint = 0x00000100;
pub const IMX_OCOTP_BM_CTRL_ERROR: c_uint = 0x00000200;
pub const IMX_OCOTP_BM_CTRL_REL_SHADOWS: c_uint = 0x00000400;
pub const IMX_OCOTP_BM_CTRL_ADDR_8MP: c_uint = 0x000001FF;
pub const IMX_OCOTP_BM_CTRL_BUSY_8MP: c_uint = 0x00000200;
pub const IMX_OCOTP_BM_CTRL_ERROR_8MP: c_uint = 0x00000400;
pub const IMX_OCOTP_BM_CTRL_REL_SHADOWS_8MP: c_uint = 0x00000800;
...
pub const TIMING_RELAX_NS: c_int = 17;

pub const IMX_OCOTP_WR_UNLOCK: c_uint = 0x3E770000;
pub const IMX_OCOTP_READ_LOCKED_VAL: c_uint = 0xBADABADA;
...
pub struct ocotp_priv {
    ...
    pub params: *const ocotp_params,
    pub config: *mut nvmem_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocotp_ctrl_reg {
    pub bm_addr: u32,
    pub bm_busy: u32,
    pub bm_error: u32,
    pub bm_rel_shadows: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocotp_params {
    pub nregs: c_uint,
    pub bank_address_words: c_uint,
    pub priv): *mut *mut void (set_timing)(struct ocotp_priv,
    pub ctrl: ocotp_ctrl_reg,
}

#[no_mangle]
unsafe extern "C" fn imx_ocotp_wait_for_busy(priv: *mut ocotp_priv, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_ocotp_clr_err_if_set(priv: *mut ocotp_priv) {
...
#[no_mangle]
unsafe extern "C" fn imx_ocotp_set_imx6_timing(priv: *mut ocotp_priv) {
...
#[no_mangle]
unsafe extern "C" fn imx_ocotp_set_imx7_timing(priv: *mut ocotp_priv) {
...
#[no_mangle]
unsafe extern "C" fn imx_ocotp_probe(pdev: *mut platform_device) -> c_int {
