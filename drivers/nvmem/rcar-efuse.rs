...
//! Source: drivers/nvmem/rcar-efuse.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_fuse {
    pub keepouts: [nvmem_keepout; 2],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rcar_fuse_data {
    pub /: *mut *mut unsigned int bank; / 0: PFC + E-FUSE, 1: OPT_MEM + E-FUSE,
    pub /: *mut *mut unsigned int start; / inclusive,
    pub /: *mut *mut unsigned int end; / exclusive,
}
...
#[no_mangle]
unsafe extern "C" fn rcar_fuse_probe(pdev: *mut platform_device) -> c_int {
