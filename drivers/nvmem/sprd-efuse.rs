...
//! Source: drivers/nvmem/sprd-efuse.c
#![no_std]
...
pub const SPRD_EFUSE_ENABLE: c_uint = 0x20;
pub const SPRD_EFUSE_ERR_FLAG: c_uint = 0x24;
pub const SPRD_EFUSE_ERR_CLR: c_uint = 0x28;
pub const SPRD_EFUSE_MAGIC_NUM: c_uint = 0x2c;
pub const SPRD_EFUSE_FW_CFG: c_uint = 0x50;
pub const SPRD_EFUSE_PW_SWT: c_uint = 0x54;

pub const SPRD_EFUSE_MAGIC_NUMBER: c_uint = 0x8810;
// Block width (bytes) definitions
pub const SPRD_EFUSE_BLOCK_WIDTH: c_int = 4;
//
...
//
pub const SPRD_EFUSE_NORMAL_BLOCK_NUMS: c_int = 24;
pub const SPRD_EFUSE_NORMAL_BLOCK_OFFSET: c_int = 72;
// Timeout (ms) for the trylock of hardware spinlocks
pub const SPRD_EFUSE_HWLOCK_TIMEOUT: c_int = 5000;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_efuse_variant_data {
    pub blk_nums: u32,
    pub blk_offset: u32,
    pub blk_double: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_efuse {
    pub dev: *mut device,
    pub clk: *mut clk,
    pub hwlock: *mut hwspinlock,
    pub mutex: mutex,
    pub base: *mut void __iomem,
    pub data: *const sprd_efuse_variant_data,
}
...
//
#[no_mangle]
unsafe extern "C" fn sprd_efuse_lock(efuse: *mut sprd_efuse) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_unlock(efuse: *mut sprd_efuse) {
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_set_prog_power(efuse: *mut sprd_efuse, en: bool) {
    static void sprd_efuse_set_prog_power(struct sprd_efuse *efuse, bool en)
    {
    let mut val: u32 = readl(efuse.base + SPRD_EFUSE_PW_SWT);
    if (en)
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_set_read_power(efuse: *mut sprd_efuse, en: bool) {
    static void sprd_efuse_set_read_power(struct sprd_efuse *efuse, bool en)
    {
    let mut val: u32 = readl(efuse.base + SPRD_EFUSE_ENABLE);
    if (en)
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_set_prog_lock(efuse: *mut sprd_efuse, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_set_auto_check(efuse: *mut sprd_efuse, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_set_data_double(efuse: *mut sprd_efuse, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_set_prog_en(efuse: *mut sprd_efuse, en: bool) {
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_read(context: *mut c_void, offset: u32, val: *mut c_void, bytes: usize) -> c_int {
    static int sprd_efuse_read(void *context, u32 offset, void *val, size_t bytes)
    {
    struct sprd_efuse *efuse = context;
    let mut blk_double: bool = efuse.data.blk_double;
    let mut index: u32 = offset / SPRD_EFUSE_BLOCK_WIDTH + efuse.data.blk_offset;
    let mut blk_offset: u32 = (offset % SPRD_EFUSE_BLOCK_WIDTH) * BITS_PER_BYTE;
    u32 data;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_write(context: *mut c_void, offset: u32, val: *mut c_void, bytes: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_efuse_probe(pdev: *mut platform_device) -> c_int {
