...
pub const QFPROM_BLOW_TIMER_OFFSET: c_uint = 0x03c;
// Amount of time required to hold charge to blow fuse in micro-seconds
pub const QFPROM_FUSE_BLOW_POLL_US: c_int = 100;
pub const QFPROM_FUSE_BLOW_TIMEOUT_US: c_int = 10000;
pub const QFPROM_BLOW_STATUS_OFFSET: c_uint = 0x048;
pub const QFPROM_BLOW_STATUS_BUSY: c_uint = 0x1;
pub const QFPROM_BLOW_STATUS_READY: c_uint = 0x0;
pub const QFPROM_ACCEL_OFFSET: c_uint = 0x044;
pub const QFPROM_VERSION_OFFSET: c_uint = 0x0;
pub const QFPROM_MAJOR_VERSION_SHIFT: c_int = 28;

pub const QFPROM_MINOR_VERSION_SHIFT: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qfprom_soc_data {
    pub accel_value: u32,
    pub qfprom_blow_timer_value: u32,
    pub qfprom_blow_set_freq: u32,
    pub qfprom_blow_uV: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qfprom_priv {
    pub qfpraw: *mut void __iomem,
    pub qfpconf: *mut void __iomem,
    pub qfpcorrected: *mut void __iomem,
    pub qfpsecurity: *mut void __iomem,
    pub dev: *mut device,
    pub secclk: *mut clk,
    pub vcc: *mut regulator,
    pub soc_data: *const qfprom_soc_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qfprom_touched_values {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qfprom_soc_compatible_data {
...
//
    ...
    {
    int ret;
    let mut qfprom_blow_uV: c_int = priv.soc_data.qfprom_blow_uV;
...
// Give an error, but not much we can do in this case
    ...
    let mut words: c_int = DIV_ROUND_UP(bytes, sizeof(u32));
    int i;
...
// Align reads to word boundary
    ...
    {
    let mut byte_offset: c_uint = cell.offset % sizeof(u32);
...
#[no_mangle]
unsafe extern "C" fn qfprom_runtime_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qfprom_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(15: major_version == 7 && minor_version ==) -> else {
