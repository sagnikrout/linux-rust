...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at24_data {
//
// Lock protects against activities from other Linux tasks,
// but not from changes by other I2C masters.
//
    pub lock: mutex,
    pub write_max: c_uint,
    pub num_addresses: c_uint,
    pub offset_adj: c_uint,
    pub byte_len: u32,
    pub page_size: u16,
    pub flags: u8,
    pub nvmem: *mut nvmem_device,
    pub vcc_reg: *mut regulator,
    pub count): *mut *mut *mut void (read_post)(unsigned int off, char buf, size_t,
//
// Some chips tie up multiple I2C addresses; dummy devices reserve
// them for us.
//
    pub bank_addr_shift: u8,
    pub __counted_by(num_addresses): *mut *mut regmap client_regmaps[],
}
...
//
    let mut at24_io_limit: static unsigned int = 128;
...
//
    let mut at24_write_timeout: static unsigned int = 25;
    module_param_named(write_timeout, at24_write_timeout, uint, 0);
    MODULE_PARM_DESC(at24_write_timeout, "Time (in ms) to try writes (default 25)");
#[repr(C)]
#[derive(Copy, Clone)]
pub struct at24_chip_data {
    pub byte_len: u32,
    pub flags: u8,
    pub bank_addr_shift: u8,
    pub count): *mut *mut *mut void (read_post)(unsigned int off, char buf, size_t,
...
#[no_mangle]
unsafe extern "C" fn at24_read_post_vaio(off: c_uint, buf: *mut c_char, count: usize) {
...
#[no_mangle]
unsafe extern "C" fn at24_read(priv: *mut c_void, off: c_uint, val: *mut c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at24_write(priv: *mut c_void, off: c_uint, val: *mut c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn at24_get_offset_adj(flags: u8, byte_len: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn at24_probe_temp_sensor(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn at24_probe(client: *mut i2c_client) -> c_int {
    static int at24_probe(struct i2c_client *client)
    {
    let mut regmap_config: regmap_config = { };
...
#[no_mangle]
unsafe extern "C" fn at24_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn at24_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn at24_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(at24_suspend, at24_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn at24_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn at24_exit() -> void __exit {
