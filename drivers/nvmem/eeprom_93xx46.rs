...
//! Source: drivers/nvmem/eeprom_93xx46.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eeprom_93xx46_platform_data {
    pub flags: c_uchar,
pub const EE_ADDR8: c_uint = 0x01		/*  8 bit addr. cfg */;
pub const EE_ADDR16: c_uint = 0x02		/* 16 bit addr. cfg */;
pub const EE_READONLY: c_uint = 0x08		/* forbid writing */;
pub const EE_SIZE1K: c_uint = 0x10		/* 1 kb of data, that is a 93xx46 */;
pub const EE_SIZE2K: c_uint = 0x20		/* 2 kb of data, that is a 93xx56 */;
pub const EE_SIZE4K: c_uint = 0x40		/* 4 kb of data, that is a 93xx66 */;
    pub quirks: c_uint,
...
// Add extra cycle after address during a read
    ...
    pub select: *mut gpio_desc,
}

pub const OP_START: c_uint = 0x4;

// The following addresses are offset for the 1K EEPROM variant in 16-bit mode
pub const ADDR_EWDS: c_uint = 0x00;
pub const ADDR_ERAL: c_uint = 0x20;
pub const ADDR_EWEN: c_uint = 0x30;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eeprom_93xx46_devtype_data {
    pub quirks: c_uint,
    pub flags: c_uchar,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eeprom_93xx46_dev {
    pub spi: *mut spi_device,
    pub pdata: *mut eeprom_93xx46_platform_data,
    pub lock: mutex,
...
#[no_mangle]
pub unsafe extern "C" fn has_quirk_single_word_read(edev: *mut eeprom_93xx46_dev) -> bool {
    static inline bool has_quirk_single_word_read(struct eeprom_93xx46_dev *edev)
    {
    return edev.pdata.quirks & EEPROM_93XX46_QUIRK_SINGLE_WORD_READ;
    }
#[no_mangle]
pub unsafe extern "C" fn has_quirk_instruction_length(edev: *mut eeprom_93xx46_dev) -> bool {
    static inline bool has_quirk_instruction_length(struct eeprom_93xx46_dev *edev)
    {
    return edev.pdata.quirks & EEPROM_93XX46_QUIRK_INSTRUCTION_LENGTH;
    }
#[no_mangle]
pub unsafe extern "C" fn has_quirk_extra_read_cycle(edev: *mut eeprom_93xx46_dev) -> bool {
...
// The opcode in front of the address is three bits.
    ...
    let mut cmd_addr: u16 = OP_READ << edev.addrlen;
    let mut nbytes: usize = count;
...
#[no_mangle]
unsafe extern "C" fn eeprom_93xx46_ew(edev: *mut eeprom_93xx46_dev, is_on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeprom_93xx46_eral(edev: *mut eeprom_93xx46_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeprom_93xx46_probe_fw(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeprom_93xx46_probe(spi: *mut spi_device) -> c_int {
    ...
    edev.size = 128;
#[no_mangle]
pub unsafe extern "C" fn if(EE_SIZE2K: pd->flags &) -> else {
    else if (pd.flags & EE_SIZE2K)
    edev.size = 256;
#[no_mangle]
pub unsafe extern "C" fn if(EE_SIZE4K: pd->flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(EE_ADDR16: pd->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn eeprom_93xx46_remove(spi: *mut spi_device) {
