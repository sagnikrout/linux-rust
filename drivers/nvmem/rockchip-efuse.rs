...
//! Source: drivers/nvmem/rockchip-efuse.c
#![no_std]
...
pub const RK3288_A_SHIFT: c_int = 6;
pub const RK3288_A_MASK: c_uint = 0x3ff;

pub const RK3328_SECURE_SIZES: c_int = 96;
pub const RK3328_INT_STATUS: c_uint = 0x0018;
pub const RK3328_DOUT: c_uint = 0x0020;
pub const RK3328_AUTO_CTRL: c_uint = 0x0024;

pub const RK3399_A_SHIFT: c_int = 16;
pub const RK3399_A_MASK: c_uint = 0x3ff;
pub const RK3399_NBYTES: c_int = 4;

pub const REG_EFUSE_CTRL: c_uint = 0x0000;
pub const REG_EFUSE_DOUT: c_uint = 0x0004;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_efuse_chip {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn rockchip_efuse_probe(pdev: *mut platform_device) -> c_int {
