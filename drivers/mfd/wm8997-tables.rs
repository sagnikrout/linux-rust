...
//! Source: drivers/mfd/wm8997-tables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn wm8997_patch(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8997_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm8997_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
pub const WM8997_MAX_REGISTER: c_uint = 0x31ff;
