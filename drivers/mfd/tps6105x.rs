...
#[no_mangle]
unsafe extern "C" fn tps6105x_startup(tps6105x: *mut tps6105x) -> c_int {
...
//
    ...
    PLATFORM_DEVID_AUTO, cell, 1, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(!of_node_cmp(child->name: child->name &&, _arg: "led")) -> else {
...
#[no_mangle]
unsafe extern "C" fn tps6105x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6105x_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tps6105x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps6105x_exit() -> void __exit {
