...
//! Source: drivers/mfd/da9055-core.c
#![no_std]
...
pub const DA9055_IRQ_NONKEY_MASK: c_uint = 0x01;
pub const DA9055_IRQ_ALM_MASK: c_uint = 0x02;
pub const DA9055_IRQ_TICK_MASK: c_uint = 0x04;
pub const DA9055_IRQ_ADC_MASK: c_uint = 0x08;
pub const DA9055_IRQ_BUCK_ILIM_MASK: c_uint = 0x08;
#[no_mangle]
unsafe extern "C" fn da9055_register_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn da9055_register_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn da9055_register_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn da9055_device_init(da9055: *mut da9055) -> c_int {
    ...
    core::ptr::null_mut(), da9055.irq_base, core::ptr::null_mut());
    if (ret)
    goto err;
    return 0;
    err:
...
#[no_mangle]
pub unsafe extern "C" fn da9055_device_exit(da9055: *mut da9055) {
