...
//! Source: drivers/mfd/madera-core.c
#![no_std]
...
pub const CS47L15_SILICON_ID: c_uint = 0x6370;
pub const CS47L35_SILICON_ID: c_uint = 0x6360;
pub const CS47L85_SILICON_ID: c_uint = 0x6338;
pub const CS47L90_SILICON_ID: c_uint = 0x6364;
pub const CS47L92_SILICON_ID: c_uint = 0x6371;
pub const MADERA_32KZ_MCLK2: c_int = 1;
pub const MADERA_RESET_MIN_US: c_int = 2000;
pub const MADERA_RESET_MAX_US: c_int = 3000;
pub const ERRATA_DCVDD_MIN_US: c_int = 10000;
pub const ERRATA_DCVDD_MAX_US: c_int = 15000;
...
pub const MADERA_BOOT_POLL_INTERVAL_USEC: c_int = 5000;
pub const MADERA_BOOT_POLL_TIMEOUT_USEC: c_int = 25000;
#[no_mangle]
unsafe extern "C" fn madera_wait_for_boot_noack(madera: *mut madera) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn madera_wait_for_boot(madera: *mut madera) -> c_int {
    static int madera_wait_for_boot(struct madera *madera)
    {
    let mut ret: c_int = madera_wait_for_boot_noack(madera);
//
...
#[no_mangle]
unsafe extern "C" fn madera_soft_reset(madera: *mut madera) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn madera_enable_hard_reset(madera: *mut madera) {
...
#[no_mangle]
unsafe extern "C" fn madera_disable_hard_reset(madera: *mut madera) {
...
#[no_mangle]
unsafe extern "C" fn madera_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn madera_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn madera_get_reset_gpio(madera: *mut madera) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn madera_set_micbias_info(madera: *mut madera) {
...
#[no_mangle]
pub unsafe extern "C" fn madera_dev_init(madera: *mut madera) -> c_int {
    int madera_dev_init(struct madera *madera)
    {
    struct device *dev = madera.dev;
    unsigned int hwid;
    int (*patch_fn)(struct madera *) = core::ptr::null_mut();
    const struct mfd_cell *mfd_devs = core::ptr::null_mut();
    let mut n_devs: c_int = 0;
    int i, ret;
...
#[no_mangle]
pub unsafe extern "C" fn madera_dev_exit(madera: *mut madera) -> c_int {
