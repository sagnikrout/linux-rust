...
//! Source: drivers/mfd/mc13xxx-core.c
#![no_std]
...
pub const MC13XXX_IRQSTAT0: c_int = 0;
pub const MC13XXX_IRQMASK0: c_int = 1;
pub const MC13XXX_IRQSTAT1: c_int = 3;
pub const MC13XXX_IRQMASK1: c_int = 4;
pub const MC13XXX_REVISION: c_int = 7;

pub const MC13XXX_PWRCTRL: c_int = 15;

pub const MC13XXX_ADC1: c_int = 44;

pub const MC13XXX_ADC2: c_int = 45;
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_lock(mc13xxx: *mut mc13xxx) {
...
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_unlock(mc13xxx: *mut mc13xxx) {
...
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_reg_read(mc13xxx: *mut mc13xxx, offset: c_uint, val: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_reg_write(mc13xxx: *mut mc13xxx, offset: c_uint, val: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_irq_mask(mc13xxx: *mut mc13xxx, irq: c_int) -> c_int {
    int mc13xxx_irq_mask(struct mc13xxx *mc13xxx, int irq)
    {
    let mut virq: c_int = regmap_irq_get_virq(mc13xxx.irq_data, irq);
    disable_irq_nosync(virq);
    return 0;
    }
    EXPORT_SYMBOL(mc13xxx_irq_mask);
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_irq_unmask(mc13xxx: *mut mc13xxx, irq: c_int) -> c_int {
    ...
    {
    int ret;
    let mut offmask: c_uint = irq < 24 ? MC13XXX_IRQMASK0 : MC13XXX_IRQMASK1;
    let mut offstat: c_uint = irq < 24 ? MC13XXX_IRQSTAT0 : MC13XXX_IRQSTAT1;
    let mut irqbit: u32 = 1 << (irq < 24 ? irq : irq - 24);
...
// pending = stat & irqbit;
    ...
    {
    let mut virq: c_int = regmap_irq_get_virq(mc13xxx.irq_data, irq);
    return devm_request_threaded_irq(mc13xxx.dev, virq, core::ptr::null_mut(), handler,
    IRQF_ONESHOT, name, dev);
    }
    EXPORT_SYMBOL(mc13xxx_irq_request);
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_irq_free(mc13xxx: *mut mc13xxx, irq: c_int, dev: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_print_revision(mc13xxx: *mut mc13xxx, revision: u32) {
...
#[no_mangle]
unsafe extern "C" fn mc34708_print_revision(mc13xxx: *mut mc13xxx, revision: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_get_flags(mc13xxx: *mut mc13xxx) -> c_int {
    int mc13xxx_get_flags(struct mc13xxx *mc13xxx)
    {
    return mc13xxx.flags;
    }
    EXPORT_SYMBOL(mc13xxx_get_flags);
pub const MC13XXX_ADC1_CHAN0_SHIFT: c_int = 5;
pub const MC13XXX_ADC1_CHAN1_SHIFT: c_int = 8;
pub const MC13783_ADC1_ATO_SHIFT: c_int = 11;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mc13xxx_adcdone_data {
    pub mc13xxx: *mut mc13xxx,
    pub done: completion,
}

#[no_mangle]
unsafe extern "C" fn mc13xxx_handler_adcdone(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// there is no asnprintf in the kernel :-(
    ...
    if (!cell.name)
    return -ENOMEM;
    return mfd_add_devices(mc13xxx.dev, -1, &cell, 1, core::ptr::null_mut(), 0,
    regmap_irq_get_domain(mc13xxx.irq_data));
    }
#[no_mangle]
unsafe extern "C" fn mc13xxx_add_subdevice(mc13xxx: *mut mc13xxx, format: *const c_char) -> c_int {
    static int mc13xxx_add_subdevice(struct mc13xxx *mc13xxx, const char *format)
    {
    return mc13xxx_add_subdevice_pdata(mc13xxx, format, core::ptr::null_mut(), 0);
    }

#[no_mangle]
unsafe extern "C" fn mc13xxx_probe_flags_dt(mc13xxx: *mut mc13xxx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_probe_flags_dt(mc13xxx: *mut mc13xxx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_common_init(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mc13xxx_common_exit(dev: *mut device) {
