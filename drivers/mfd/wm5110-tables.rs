...
//! Source: drivers/mfd/wm5110-tables.c
#![no_std]
...
pub const WM5110_NUM_AOD_ISR: c_int = 2;
pub const WM5110_NUM_ISR: c_int = 5;
...
#[no_mangle]
pub unsafe extern "C" fn wm5110_patch(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm5110_is_rev_b_adsp_memory(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm5110_is_rev_d_adsp_memory(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm5110_is_adsp_memory(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm5110_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm5110_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
pub const WM5110_MAX_REGISTER: c_uint = 0x4a9fff;
