...
pub const MAX_LP8788_REGISTERS: c_uint = 0xA2;
...
#[no_mangle]
pub unsafe extern "C" fn lp8788_read_byte(lp: *mut lp8788, reg: u8, data: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lp8788_read_multi_bytes(lp: *mut lp8788, reg: u8, data: *mut u8, count: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lp8788_write_byte(lp: *mut lp8788, reg: u8, data: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lp8788_update_bits(lp: *mut lp8788, reg: u8, mask: u8, data: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp8788_platform_init(lp: *mut lp8788) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp8788_probe(cl: *mut i2c_client) -> c_int {
    ...
    ARRAY_SIZE(lp8788_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
    goto err_exit_irq;
    return 0;
    err_exit_irq:
...
#[no_mangle]
unsafe extern "C" fn lp8788_remove(cl: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn lp8788_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lp8788_exit() -> void __exit {
