...
//! Source: drivers/mfd/da9062-core.c
#![no_std]
...
pub const DA9062_REG_EVENT_A_OFFSET: c_int = 0;
pub const DA9062_REG_EVENT_B_OFFSET: c_int = 1;
pub const DA9062_REG_EVENT_C_OFFSET: c_int = 2;
pub const DA9062_IRQ_LOW: c_int = 0;
pub const DA9062_IRQ_HIGH: c_int = 1;
...
// EVENT C
    ...
    MFD_CELL_OF("da9061-core", da9061_core_resources, core::ptr::null_mut(), 0, 0,
    core::ptr::null_mut()),
    MFD_CELL_OF("da9062-regulators", da9061_regulators_resources, core::ptr::null_mut(), 0, 0,
    core::ptr::null_mut()),
    MFD_CELL_OF("da9061-watchdog", da9061_wdt_resources, core::ptr::null_mut(), 0, 0,
    "dlg,da9061-watchdog"),
    MFD_CELL_OF("da9061-thermal", da9061_thermal_resources, core::ptr::null_mut(), 0, 0,
    "dlg,da9061-thermal"),
    MFD_CELL_OF("da9061-onkey", da9061_onkey_resources, core::ptr::null_mut(), 0, 0,
    "dlg,da9061-onkey"),
    };
    static const struct mfd_cell da9061_devs_noirq[] = {
    MFD_CELL_OF("da9061-core", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, core::ptr::null_mut()),
    MFD_CELL_OF("da9062-regulators", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, core::ptr::null_mut()),
    MFD_CELL_OF("da9061-watchdog", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "dlg,da9061-watchdog"),
    MFD_CELL_OF("da9061-thermal", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "dlg,da9061-thermal"),
    MFD_CELL_OF("da9061-onkey", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "dlg,da9061-onkey"),
    };
    ...
    MFD_CELL_OF("da9062-core", da9062_core_resources, core::ptr::null_mut(), 0, 0,
    core::ptr::null_mut()),
    MFD_CELL_OF("da9062-regulators", da9062_regulators_resources, core::ptr::null_mut(), 0, 0,
    core::ptr::null_mut()),
    MFD_CELL_OF("da9062-watchdog", da9062_wdt_resources, core::ptr::null_mut(), 0, 0,
    "dlg,da9062-watchdog"),
    MFD_CELL_OF("da9062-thermal", da9062_thermal_resources, core::ptr::null_mut(), 0, 0,
    "dlg,da9062-thermal"),
    MFD_CELL_OF("da9062-rtc", da9062_rtc_resources, core::ptr::null_mut(), 0, 0,
    "dlg,da9062-rtc"),
    MFD_CELL_OF("da9062-onkey", da9062_onkey_resources, core::ptr::null_mut(), 0, 0,
    "dlg,da9062-onkey"),
    MFD_CELL_OF("da9062-gpio", da9062_gpio_resources, core::ptr::null_mut(), 0, 0,
    "dlg,da9062-gpio"),
    };
    static const struct mfd_cell da9062_devs_noirq[] = {
    MFD_CELL_OF("da9062-core", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, core::ptr::null_mut()),
    MFD_CELL_OF("da9062-regulators", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, core::ptr::null_mut()),
    MFD_CELL_OF("da9062-watchdog", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "dlg,da9062-watchdog"),
    MFD_CELL_OF("da9062-thermal", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "dlg,da9062-thermal"),
    MFD_CELL_OF("da9062-rtc", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "dlg,da9062-rtc"),
    MFD_CELL_OF("da9062-onkey", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "dlg,da9062-onkey"),
    MFD_CELL_OF("da9062-gpio", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "dlg,da9062-gpio"),
    };
#[no_mangle]
unsafe extern "C" fn da9062_clear_fault_log(chip: *mut da9062) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9062_get_device_type(chip: *mut da9062) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9062_configure_irq_type(chip: *mut da9062, irq: c_int, trigger: *mut u32) -> u32 {
    static u32 da9062_configure_irq_type(struct da9062 *chip, int irq, u32 *trigger)
    {
    let mut irq_type: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn da9062_i2c_probe(i2c: *mut i2c_client) -> c_int {
    static int da9062_i2c_probe(struct i2c_client *i2c)
    {
    struct da9062 *chip;
    let mut irq_base: c_uint = 0;
    const struct mfd_cell *cell;
    const struct regmap_irq_chip *irq_chip;
    const struct regmap_config *config;
    int cell_num;
    let mut trigger_type: u32 = 0;
    int ret;
...
// If IRQ is available, reconfigure it accordingly
    ...
    cell_num, core::ptr::null_mut(), irq_base,
    core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn da9062_i2c_remove(i2c: *mut i2c_client) {
