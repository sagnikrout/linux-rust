...
#[no_mangle]
unsafe extern "C" fn adp5585_validate_event(adp5585: *const adp5585_dev, ev: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5589_validate_event(adp5585: *const adp5585_dev, ev: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_unlock_ev_parse(adp5585: *mut adp5585_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_reset_ev_parse(adp5585: *mut adp5585_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_add_devices(adp5585: *const adp5585_dev) -> c_int {
...
// Make sure the PWM output pin is not used by the GPIO or INPUT devices
    ...
    &cells[ADP5585_DEV_PWM], 1, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
    return dev_err_probe(dev, ret, "Failed to add PWM device\n");
    }
    if (device_property_present(dev, "#gpio-cells")) {
    ret = devm_mfd_add_devices(dev, PLATFORM_DEVID_AUTO,
    &cells[ADP5585_DEV_GPIO], 1, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
    ...
    &cells[ADP5585_DEV_INPUT], 1, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn adp5585_osc_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adp5585_report_events(adp5585: *mut adp5585_dev, ev_cnt: c_int) {
...
#[no_mangle]
unsafe extern "C" fn adp5585_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adp5585_parse_fw(adp5585: *mut adp5585_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_irq_disable(data: *mut c_void) {
    ...
    if (i2c.irq <= 0)
    return 0;
    ret = devm_request_threaded_irq(&i2c.dev, i2c.irq, core::ptr::null_mut(), adp5585_irq,
...
#[no_mangle]
unsafe extern "C" fn adp5585_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5585_resume(dev: *mut device) -> c_int {
