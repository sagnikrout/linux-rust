...
//! Source: drivers/mfd/cs42l43-sdw.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cs42l43_read_prop(sdw: *mut sdw_slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_sdw_update_status(sdw: *mut sdw_slave, status: enum sdw_slave_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs42l43_sdw_probe(sdw: *mut sdw_slave, id: *const sdw_device_id) -> c_int {
