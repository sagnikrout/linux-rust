...
//! Source: drivers/mfd/intel_pmc_bxt.c
#![no_std]
...
pub const PLAT_RESOURCE_IPC_INDEX: c_int = 0;
pub const PLAT_RESOURCE_IPC_SIZE: c_uint = 0x1000;
pub const PLAT_RESOURCE_GCR_OFFSET: c_uint = 0x1000;
pub const PLAT_RESOURCE_GCR_SIZE: c_uint = 0x1000;
pub const PLAT_RESOURCE_BIOS_DATA_INDEX: c_int = 1;
pub const PLAT_RESOURCE_BIOS_IFACE_INDEX: c_int = 2;
pub const PLAT_RESOURCE_TELEM_SSRAM_INDEX: c_int = 3;
pub const PLAT_RESOURCE_ISP_DATA_INDEX: c_int = 4;
pub const PLAT_RESOURCE_ISP_IFACE_INDEX: c_int = 5;
pub const PLAT_RESOURCE_GTD_DATA_INDEX: c_int = 6;
pub const PLAT_RESOURCE_GTD_IFACE_INDEX: c_int = 7;
pub const PLAT_RESOURCE_ACPI_IO_INDEX: c_int = 0;
//
...
//
pub const SMI_EN_OFFSET: c_uint = 0x0040;
pub const SMI_EN_SIZE: c_int = 4;
pub const TCO_BASE_OFFSET: c_uint = 0x0060;
pub const TCO_REGS_SIZE: c_int = 16;
pub const TELEM_SSRAM_SIZE: c_int = 240;
pub const TELEM_PMC_SSRAM_OFFSET: c_uint = 0x1b00;
pub const TELEM_PUNIT_SSRAM_OFFSET: c_uint = 0x1a00;
// Commands
pub const PMC_NORTHPEAK_CTRL: c_uint = 0xed;
#[no_mangle]
pub unsafe extern "C" fn is_gcr_valid(offset: u32) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_pmc_gcr_read64(pmc: *mut intel_pmc_dev, offset: u32, data: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_pmc_gcr_update(pmc: *mut intel_pmc_dev, offset: u32, mask: u32, val: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_pmc_s0ix_counter_read(pmc: *mut intel_pmc_dev, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pmc_get_tco_resources(pdev: *mut platform_device) -> c_int {
...
unsafe extern "C" fn intel_pmc_create_devices(pmc: *mut intel_pmc_dev) -> c_int {
    ...
    &telem, 1, pmc.telem_base, 0, core::ptr::null_mut());
    }
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn intel_pmc_probe(pdev: *mut platform_device) -> c_int {
