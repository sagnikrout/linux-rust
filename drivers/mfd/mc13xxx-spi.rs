...
//! Source: drivers/mfd/mc13xxx-spi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_spi_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_spi_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_spi_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mc13xxx_exit() -> void __exit {
