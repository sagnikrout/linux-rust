...
#[no_mangle]
unsafe extern "C" fn wcd934x_is_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_bring_up(ddata: *mut wcd934x_ddata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_slim_status_up(sdev: *mut slim_device) -> c_int {
    ...
    ARRAY_SIZE(wcd934x_devices), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_slim_probe(sdev: *mut slim_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcd934x_slim_remove(sdev: *mut slim_device) {
