...
#[no_mangle]
pub unsafe extern "C" fn adp5520_write(dev: *mut device, reg: c_int, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adp5520_read(dev: *mut device, reg: c_int, val: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adp5520_set_bits(dev: *mut device, reg: c_int, bit_mask: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adp5520_clr_bits(dev: *mut device, reg: c_int, bit_mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5520_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    blocking_notifier_call_chain(&chip.notifier_list, events, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn adp5520_remove_subdevs(chip: *mut adp5520_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5520_probe(client: *mut i2c_client) -> c_int {
    ...
    ret = request_threaded_irq(chip.irq, core::ptr::null_mut(), adp5520_irq_thread,
...
#[no_mangle]
unsafe extern "C" fn adp5520_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5520_resume(dev: *mut device) -> c_int {
