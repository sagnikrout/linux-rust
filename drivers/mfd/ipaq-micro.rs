...
//! Source: drivers/mfd/ipaq-micro.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ipaq_micro_trigger_tx(micro: *mut ipaq_micro) {
...
#[no_mangle]
pub unsafe extern "C" fn ipaq_micro_tx_msg(micro: *mut ipaq_micro, msg: *mut ipaq_micro_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn micro_rx_msg(micro: *mut ipaq_micro, id: u8, len: c_int, data: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn micro_process_char(micro: *mut ipaq_micro, ch: u8) {
...
#[no_mangle]
unsafe extern "C" fn micro_rx_chars(micro: *mut ipaq_micro) {
...
#[no_mangle]
pub unsafe extern "C" fn if(UTSR1_FRE: status &) -> else {
    else if (status & UTSR1_FRE)
    dev_err(micro.dev, "rx: framing error\n");
#[no_mangle]
pub unsafe extern "C" fn if(UTSR1_ROR: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ipaq_micro_get_version(micro: *mut ipaq_micro) {
...
#[no_mangle]
unsafe extern "C" fn ipaq_micro_to_u16(data: *mut u8) -> u16 {
    static u16 ipaq_micro_to_u16(u8 *data)
    {
    return data[1] << 8 | data[0];
    }
#[no_mangle]
unsafe extern "C" fn ipaq_micro_eeprom_dump(micro: *mut ipaq_micro) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn micro_tx_chars(micro: *mut ipaq_micro) {
...
#[no_mangle]
unsafe extern "C" fn micro_reset_comm(micro: *mut ipaq_micro) {
...
#[no_mangle]
unsafe extern "C" fn micro_serial_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn micro_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn micro_probe(pdev: *mut platform_device) -> int __init {
    ...
    return -ENOMEM;
    micro.dev = &pdev.dev;
    micro.base = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    ...
    ARRAY_SIZE(micro_cells), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret) {
...
// Check version
    ...
    SET_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), micro_resume)
    };
