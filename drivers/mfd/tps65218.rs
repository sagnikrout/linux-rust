...
pub const TPS65218_PASSWORD_REGS_UNLOCK: c_uint = 0x7D;
...
#[no_mangle]
unsafe extern "C" fn tps65218_voltage_set_strict(tps: *mut tps65218) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65218_voltage_set_uv_hyst(tps: *mut tps65218) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65218_voltage_set_uvlo(tps: *mut tps65218) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65218_probe(client: *mut i2c_client) -> c_int {
    ...
    ARRAY_SIZE(tps65218_cells), core::ptr::null_mut(), 0,
