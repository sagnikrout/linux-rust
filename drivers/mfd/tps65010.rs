...
pub struct tps65010 {
    ...
    pub file: *mut dentry,
    pub charging:1: unsigned,
    pub por:1: unsigned,
    pub model:8: unsigned,
    pub vbus: u16,
    pub flags: c_ulong,
pub const FLAG_VBUS_CHANGED: c_int = 0;
pub const FLAG_IRQ_ENABLE: c_int = 1;
// copies of last register state
    pub chgconf: u8 chgstatus, regstatus,,
    pub nmask2: u8 nmask1,,
    pub outmask: u8,
    pub chip: gpio_chip,
    pub leds: *mut platform_device,
}

// -------------------------------------------------------------------------

#[no_mangle]
unsafe extern "C" fn dbg_chgstat(buf: *mut c_char, len: usize, chgstatus: u8) {
...
#[no_mangle]
unsafe extern "C" fn dbg_regstat(buf: *mut c_char, len: usize, regstatus: u8) {
...
#[no_mangle]
unsafe extern "C" fn dbg_chgconf(por: c_int, buf: *mut c_char, len: usize, chgconfig: u8) {
...
#[no_mangle]
unsafe extern "C" fn show_chgstatus(label: *const c_char, chgstatus: u8) {
...
#[no_mangle]
unsafe extern "C" fn show_regstatus(label: *const c_char, regstatus: u8) {
...
#[no_mangle]
unsafe extern "C" fn show_chgconfig(por: c_int, label: *const c_char, chgconfig: u8) {
...
#[no_mangle]
unsafe extern "C" fn dbg_show(s: *mut seq_file, _: *mut c_void) -> c_int {
    ...
    default:	chip = core::ptr::null_mut(); break;
    }
...
#[no_mangle]
unsafe extern "C" fn dbg_tps_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65010_interrupt(tps: *mut tps65010) {
    static void tps65010_interrupt(struct tps65010 *tps)
    {
    let mut tmp: u8 = 0, mask, poll;
...
#[no_mangle]
unsafe extern "C" fn tps65010_work(work: *mut work_struct) {
    ...
    chgconfig |= TPS_VBUS_500MA | TPS_VBUS_CHARGING;
#[no_mangle]
pub unsafe extern "C" fn if(100: tps->vbus >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn tps65010_irq(irq: c_int, _tps: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(6: offset <) -> else {
    else if (offset < 6)
...
#[no_mangle]
unsafe extern "C" fn tps65010_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65010_remove(client: *mut i2c_client) {
    ...
    the_tps = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tps65010_probe(client: *mut i2c_client) -> c_int {
...
// NOTE:  only partial support for inputs; nyet IRQs
    ...
    status);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: board->setup) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn tps65010_set_vbus_draw(mA: unsigned) -> c_int {
...
// assumes non-SMP
    ...
    mA = 500;
#[no_mangle]
pub unsafe extern "C" fn if(100: mA >=) -> else {
    else if (mA >= 100)
    mA = 100;
    else
    mA = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn tps65010_set_gpio_out_value(gpio: unsigned, value: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tps65010_set_led(led: unsigned, mode: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tps65010_set_vib(value: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tps65010_set_low_pwr(mode: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tps65010_config_vregs1(value: unsigned) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps65010_config_vdcdc2(value: unsigned) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps65013_set_low_pwr(mode: unsigned) -> c_int {
...
// -------------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tps_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps_exit() -> void __exit {
