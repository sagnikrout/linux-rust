...
pub const MAX77650_INT_GLBL_OFFSET: c_int = 0;
pub const MAX77650_INT_CHG_OFFSET: c_int = 1;

pub const MAX77650_SBIA_LPM_DISABLED: c_uint = 0x00;
    enum {
    MAX77650_INT_GPI,
    MAX77650_INT_nEN_F,
    MAX77650_INT_nEN_R,
...
#[no_mangle]
unsafe extern "C" fn max77650_i2c_probe(i2c: *mut i2c_client) -> c_int {
