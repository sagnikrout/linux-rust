...
//
pub const RSMU_CM_PAGE_ADDR: c_uint = 0xFC;
pub const RSMU_CM_PAGE_MASK: c_uint = 0xFFFFFF00;
pub const RSMU_CM_ADDRESS_MASK: c_uint = 0x000000FF;
//
// 15-bit register address: the lower 7 bits of the register address come
// from the offset addr byte and the upper 8 bits come from the page register.
//
pub const RSMU_SABRE_PAGE_ADDR: c_uint = 0x7F;
pub const RSMU_SABRE_PAGE_WINDOW: c_int = 128;
...
#[no_mangle]
unsafe extern "C" fn rsmu_sabre_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rsmu_smbus_i2c_write_device(rsmu: *mut rsmu_ddata, reg: u8, buf: *mut u8, bytes: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_smbus_i2c_read_device(rsmu: *mut rsmu_ddata, reg: u8, buf: *mut u8, bytes: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_i2c_read_device(rsmu: *mut rsmu_ddata, reg: u8, buf: *mut u8, bytes: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_i2c_write_device(rsmu: *mut rsmu_ddata, reg: u8, buf: *mut u8, bytes: u8) -> c_int {
...
// we add 1 byte for device register
    ...
    {
    let mut page: u32 = (reg | RSMU_CM_SCSR_BASE) & RSMU_CM_PAGE_MASK;
    u8 buf[4];
    int err;
...
#[no_mangle]
unsafe extern "C" fn rsmu_i2c_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
    static int rsmu_i2c_reg_read(void *context, unsigned int reg, unsigned int *val)
    {
    struct rsmu_ddata *rsmu = i2c_get_clientdata((struct i2c_client *)context);
    let mut addr: u8 = (u8)(reg & RSMU_CM_ADDRESS_MASK);
    int err;
...
#[no_mangle]
unsafe extern "C" fn rsmu_i2c_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
    static int rsmu_i2c_reg_write(void *context, unsigned int reg, unsigned int val)
    {
    struct rsmu_ddata *rsmu = i2c_get_clientdata((struct i2c_client *)context);
    let mut addr: u8 = (u8)(reg & RSMU_CM_ADDRESS_MASK);
    let mut data: u8 = (u8)val;
    int err;
    err = rsmu_write_page_register(rsmu, reg, rsmu_i2c_write_device);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn rsmu_smbus_i2c_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_smbus_i2c_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_i2c_probe(client: *mut i2c_client) -> c_int {
    ...
    rsmu.regmap = devm_regmap_init(&client.dev, core::ptr::null_mut(), client, cfg);
    else
...
#[no_mangle]
unsafe extern "C" fn rsmu_i2c_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn rsmu_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rsmu_i2c_exit() -> void __exit {
