...
//! Source: drivers/mfd/wm8350-core.c
#![no_std]
...
// debug
pub const WM8350_BUS_DEBUG: c_int = 0;
...
pub const WM8350_LOCK_DEBUG: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn wm8350_clear_bits(wm8350: *mut wm8350, reg: u16, mask: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm8350_set_bits(wm8350: *mut wm8350, reg: u16, mask: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm8350_reg_read(wm8350: *mut wm8350, reg: c_int) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn wm8350_reg_write(wm8350: *mut wm8350, reg: c_int, val: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wm8350_reg_lock(wm8350: *mut wm8350) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wm8350_reg_unlock(wm8350: *mut wm8350) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm8350_read_auxadc(wm8350: *mut wm8350, channel: c_int, scale: c_int, vref: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_auxadc_irq(irq: c_int, irq_data: *mut c_void) -> irqreturn_t {
...
// For safety we refuse to run on unknown hardware
    ...
    core::ptr::null_mut(), wm8350_auxadc_irq,
    IRQF_ONESHOT,
    "auxadc", wm8350);
    if (ret < 0)
    dev_warn(wm8350.dev,
