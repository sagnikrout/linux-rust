...
//! Source: drivers/mfd/kempld-core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn kempld_get_hardware_mutex(pld: *mut kempld_device_data) {
...
#[no_mangle]
unsafe extern "C" fn kempld_release_hardware_mutex(pld: *mut kempld_device_data) {
...
#[no_mangle]
unsafe extern "C" fn kempld_get_info_generic(pld: *mut kempld_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_register_cells_generic(pld: *mut kempld_device_data) -> c_int {
    ...
    return mfd_add_devices(pld.dev, PLATFORM_DEVID_NONE, devs, i, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn kempld_create_platform_device(pdata: *const kempld_platform_data) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn kempld_read8(pld: *mut kempld_device_data, index: u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn kempld_write8(pld: *mut kempld_device_data, index: u8, data: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kempld_read16(pld: *mut kempld_device_data, index: u8) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn kempld_write16(pld: *mut kempld_device_data, index: u8, data: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kempld_read32(pld: *mut kempld_device_data, index: u8) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn kempld_write32(pld: *mut kempld_device_data, index: u8, data: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kempld_get_mutex(pld: *mut kempld_device_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn kempld_release_mutex(pld: *mut kempld_device_data) {
...
//
#[no_mangle]
unsafe extern "C" fn kempld_get_info(pld: *mut kempld_device_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kempld_register_cells(pld: *mut kempld_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_detect_device(pld: *mut kempld_device_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kempld_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn kempld_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kempld_exit() -> void __exit {
