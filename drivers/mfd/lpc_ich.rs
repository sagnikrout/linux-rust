...
pub const ACPIBASE: c_uint = 0x40;
pub const ACPIBASE_GPE_OFF: c_uint = 0x28;
pub const ACPIBASE_GPE_END: c_uint = 0x2f;
pub const ACPIBASE_SMI_OFF: c_uint = 0x30;
pub const ACPIBASE_SMI_END: c_uint = 0x33;
pub const ACPIBASE_PMC_OFF: c_uint = 0x08;
pub const ACPIBASE_PMC_END: c_uint = 0x0c;
pub const ACPIBASE_TCO_OFF: c_uint = 0x60;
pub const ACPIBASE_TCO_END: c_uint = 0x7f;
pub const ACPICTRL_PMCBASE: c_uint = 0x44;
pub const ACPIBASE_GCS_OFF: c_uint = 0x3410;
pub const ACPIBASE_GCS_END: c_uint = 0x3414;
pub const SPIBASE_BYT: c_uint = 0x54;
pub const SPIBASE_BYT_SZ: c_int = 512;

pub const BYT_BCR: c_uint = 0xfc;

pub const SPIBASE_LPT: c_uint = 0x3800;
pub const SPIBASE_LPT_SZ: c_int = 512;
pub const BCR: c_uint = 0xdc;

pub const GPIOBASE_ICH0: c_uint = 0x58;
pub const GPIOCTRL_ICH0: c_uint = 0x5C;
pub const GPIOBASE_ICH6: c_uint = 0x48;
pub const GPIOCTRL_ICH6: c_uint = 0x4C;
pub const RCBABASE: c_uint = 0xf0;
...
pub const INTEL_GPIO_RESOURCE_SIZE: c_uint = 0x1000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc_ich_gpio_info {
    pub hid: *const c_char,
    pub devices: *const mfd_cell,
    pub nr_devices: usize,
    pub resources: *mut resource,
    pub nr_resources: usize,
    pub offsets: *const resource_size_t,
}

pub const APL_GPIO_NORTH: c_int = 0;
pub const APL_GPIO_NORTHWEST: c_int = 1;
pub const APL_GPIO_WEST: c_int = 2;
pub const APL_GPIO_SOUTHWEST: c_int = 3;
pub const APL_GPIO_NR_DEVICES: c_int = 4;
pub const APL_GPIO_NR_RESOURCES: c_int = 4;
...
pub const APL_GPIO_IRQ: c_int = 14;
...
pub const DNV_GPIO_NORTH: c_int = 0;
pub const DNV_GPIO_SOUTH: c_int = 1;
pub const DNV_GPIO_NR_DEVICES: c_int = 1;
pub const DNV_GPIO_NR_RESOURCES: c_int = 2;
...
pub const DNV_GPIO_IRQ: c_int = 14;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc_ich_priv {
    pub chipset: enum lpc_chipsets,
    pub /: *mut *mut int abase; / ACPI base,
    pub /: *mut *mut int actrl_pbase; / ACPI control or PMC base,
    pub /: *mut *mut int gbase; / GPIO base,
    pub /: *mut *mut int gctrl; / GPIO control,
    pub /: *mut *mut int abase_save; / Cached ACPI base value,
    pub /: *mut *mut int actrl_pbase_save; / Cached ACPI control or PMC base value,
    pub /: *mut *mut int gctrl_save; / Cached GPIO control value,
}
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_restore_config_space(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_enable_acpi_space(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_enable_gpio_space(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_enable_pmc_space(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_finalize_wdt_cell(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_finalize_gpio_cell(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn lpc_ich_check_conflict_gpio(res: *mut resource) -> c_int {
    static int lpc_ich_check_conflict_gpio(struct resource *res)
    {
    int ret;
    let mut use_gpio: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_init_gpio(dev: *mut pci_dev) -> c_int {
    ...
    u32 base_addr;
    int ret;
    let mut acpi_conflict: bool = false;
    struct resource *res;
...
// this isn't necessarily fatal for the GPIO
    ...
    &lpc_ich_gpio_cell, 1, core::ptr::null_mut(), 0, core::ptr::null_mut());
    gpio_done:
    if (acpi_conflict)
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_init_wdt(dev: *mut pci_dev) -> c_int {
...
// Don't register iomem for TCO ver 1
    ...
    goto wdt_done;
    ret = mfd_add_devices(&dev.dev, PLATFORM_DEVID_AUTO,
    &lpc_ich_wdt_cell, 1, core::ptr::null_mut(), 0, core::ptr::null_mut());
    wdt_done:
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn lpc_ich_init_pinctrl(dev: *mut pci_dev) -> c_int {
...
// Check, if GPIO has been exported as an ACPI device
    if (acpi_dev_present(info.hid, core::ptr::null_mut(), -1))
    return -EEXIST;
    ...
    let mut offset: resource_size_t = info.offsets[i];
// Fill MEM resource
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_byt_set_writeable(base: *mut void __iomem, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_set_writeable(bus: *mut pci_bus, devfn: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_lpt_set_writeable(base: *mut void __iomem, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_bxt_set_writeable(base: *mut void __iomem, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_init_spi(dev: *mut pci_dev) -> c_int {
...
//
    ...
    &lpc_ich_spi_cell, 1, core::ptr::null_mut(), 0, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn lpc_ich_remove(dev: *mut pci_dev) {
