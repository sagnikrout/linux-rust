...
pub const STPMIC1_MAX_RETRIES: c_int = 2;
pub const STPMIC1_MAIN_IRQ: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn stpmic1_power_off(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stpmic1_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stpmic1_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stpmic1_resume(dev: *mut device) -> c_int {
