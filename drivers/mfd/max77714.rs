...
//
#[no_mangle]
unsafe extern "C" fn max77714_setup_xosc(dev: *mut device, regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77714_probe(client: *mut i2c_client) -> c_int {
