...
//! Source: drivers/mfd/ti_am335x_tscadc.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn am335x_tsc_se_set_cache(tscadc: *mut ti_tscadc_dev, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !tscadc->adc_in_use) -> else {
...
#[no_mangle]
unsafe extern "C" fn am335x_tscadc_need_adc(tscadc: *mut ti_tscadc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn am335x_tsc_se_set_once(tscadc: *mut ti_tscadc_dev, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn am335x_tsc_se_adc_done(tscadc: *mut ti_tscadc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn am335x_tsc_se_clr(tscadc: *mut ti_tscadc_dev, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn tscadc_idle_config(tscadc: *mut ti_tscadc_dev) {
...
#[no_mangle]
unsafe extern "C" fn ti_tscadc_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut use_tsc: bool = false, use_mag = false;
    u32 val;
    int err;
    let mut tscmag_wires: c_int = 0, adc_channels = 0, cell_idx = 0, total_channels;
    let mut readouts: c_int = 0, mag_tracks = 0;
...
// ADC Cell
    ...
    tscadc.cells, cell_idx, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (err < 0)
    goto err_disable_clk;
...
#[no_mangle]
unsafe extern "C" fn ti_tscadc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ti_tscadc_can_wakeup(dev: *mut device, data: *mut c_void) -> int __maybe_unused {
    static int __maybe_unused ti_tscadc_can_wakeup(struct device *dev, void *data)
    {
    return device_may_wakeup(dev);
    }
#[no_mangle]
unsafe extern "C" fn tscadc_suspend(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused tscadc_suspend(struct device *dev)
    {
    struct ti_tscadc_dev *tscadc = dev_get_drvdata(dev);
    regmap_write(tscadc.regmap, REG_SE, 0x00);
    if (device_for_each_child(dev, core::ptr::null_mut(), ti_tscadc_can_wakeup)) {
    u32 ctrl;
...
#[no_mangle]
unsafe extern "C" fn tscadc_resume(dev: *mut device) -> int __maybe_unused {
