...
//! Source: drivers/mfd/cs47l90-tables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cs47l90_patch(madera: *mut madera) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l90_is_adsp_memory(reg: c_uint) -> bool {
