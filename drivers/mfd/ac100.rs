...
#[no_mangle]
unsafe extern "C" fn ac100_rsb_probe(rdev: *mut sunxi_rsb_device) -> c_int {
    ...
    ARRAY_SIZE(ac100_cells), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret) {
