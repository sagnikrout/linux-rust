...
//! Source: drivers/mfd/cs47l92-tables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cs47l92_patch(madera: *mut madera) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l92_is_adsp_memory(reg: c_uint) -> bool {
