...
//
#[no_mangle]
unsafe extern "C" fn max77620_irq_global_mask(irq_drv_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_irq_global_unmask(irq_drv_data: *mut c_void) -> c_int {
...
//
    ...
    let mut mask: c_uint = 0, config = 0;
    u32 fps_max_period;
    u32 param_val;
    int tperiod, fps_id;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn if(1: param_val ==) -> else {
    else if (param_val == 1)
...
#[no_mangle]
unsafe extern "C" fn max77620_initialise_fps(chip: *mut max77620_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_read_es_version(chip: *mut max77620_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_pm_power_off(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_probe(client: *mut i2c_client) -> c_int {
    ...
    mfd_cells, n_mfd_cells, core::ptr::null_mut(), 0,
    ...
    {
    let mut period: c_int = max77620_get_fps_period_reg_value(chip, time_period);
    int ret;
    ret = regmap_update_bits(chip.rmap, MAX77620_REG_FPS_CFG0 + fps_id,
...
#[no_mangle]
unsafe extern "C" fn max77620_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_i2c_resume(dev: *mut device) -> c_int {
