...
pub const RSMU_CM_PAGE_ADDR: c_uint = 0x7C;
pub const RSMU_SABRE_PAGE_ADDR: c_uint = 0x7F;
pub const RSMU_PAGE_MASK: c_uint = 0xFFFFFF80;
pub const RSMU_ADDR_MASK: c_uint = 0x7F;
#[no_mangle]
unsafe extern "C" fn rsmu_read_device(rsmu: *mut rsmu_ddata, reg: u8, buf: *mut u8, bytes: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_write_device(rsmu: *mut rsmu_ddata, reg: u8, buf: *mut u8, bytes: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rsmu_write_page_register(rsmu: *mut rsmu_ddata, reg: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
    static int rsmu_reg_read(void *context, unsigned int reg, unsigned int *val)
    {
    struct rsmu_ddata *rsmu = spi_get_drvdata((struct spi_device *)context);
    let mut addr: u8 = (u8)(reg & RSMU_ADDR_MASK);
    int err;
...
#[no_mangle]
unsafe extern "C" fn rsmu_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_spi_probe(client: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsmu_spi_remove(client: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn rsmu_spi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rsmu_spi_exit() -> void __exit {
