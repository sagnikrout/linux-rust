...
//! Source: drivers/mfd/intel_soc_pmic_chtdc_ti.c
#![no_std]
...
pub const CHTDC_TI_IRQLVL1: c_uint = 0x01;
pub const CHTDC_TI_MASK_IRQLVL1: c_uint = 0x02;
// Level 1 IRQs
    enum {
...
#[no_mangle]
unsafe extern "C" fn chtdc_ti_probe(i2c: *mut i2c_client) -> c_int {
    ...
    ARRAY_SIZE(chtdc_ti_dev), core::ptr::null_mut(), 0,
    regmap_irq_get_domain(pmic.irq_chip_data));
    }
#[no_mangle]
unsafe extern "C" fn chtdc_ti_shutdown(i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn chtdc_ti_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chtdc_ti_resume(dev: *mut device) -> c_int {
