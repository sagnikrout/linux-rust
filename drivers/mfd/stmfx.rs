...
#[no_mangle]
unsafe extern "C" fn stmfx_reg_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stmfx_reg_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stmfx_func_to_mask(func: u32) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn stmfx_function_enable(stmfx: *mut stmfx, func: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn stmfx_function_disable(stmfx: *mut stmfx, func: u32) -> c_int {
    int stmfx_function_disable(struct stmfx *stmfx, u32 func)
    {
    let mut mask: u8 = stmfx_func_to_mask(func);
    return regmap_update_bits(stmfx.map, STMFX_REG_SYS_CTRL, mask, 0);
    }
    EXPORT_SYMBOL_GPL(stmfx_function_disable);
#[no_mangle]
unsafe extern "C" fn stmfx_irq_bus_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn stmfx_irq_bus_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn stmfx_irq_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn stmfx_irq_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn stmfx_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stmfx_irq_unmap(d: *mut irq_domain, virq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn stmfx_irq_exit(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn stmfx_irq_init(client: *mut i2c_client) -> c_int {
    static int stmfx_irq_init(struct i2c_client *client)
    {
    struct stmfx *stmfx = i2c_get_clientdata(client);
    let mut irqoutpin: u32 = 0, irqtrigger;
    int ret;
    ...
    core::ptr::null_mut(), stmfx_irq_handler,
...
#[no_mangle]
unsafe extern "C" fn stmfx_chip_reset(stmfx: *mut stmfx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmfx_chip_init(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmfx_chip_exit(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn stmfx_probe(client: *mut i2c_client) -> c_int {
    ...
    stmfx_cells, ARRAY_SIZE(stmfx_cells), core::ptr::null_mut(),
    0, stmfx.irq_domain);
    if (ret)
    goto err_irq_exit;
    return 0;
...
#[no_mangle]
unsafe extern "C" fn stmfx_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn stmfx_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stmfx_resume(dev: *mut device) -> c_int {
