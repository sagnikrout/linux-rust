...
//! Source: drivers/mfd/twl4030-audio.c
#![no_std]
...
pub const TWL4030_AUDIO_CELLS: c_int = 2;
    static struct platform_device *twl4030_audio_dev;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl4030_audio_resource {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct twl4030_audio {
    pub audio_mclk: c_uint,
    pub mutex: mutex,
    pub resource: [twl4030_audio_resource; TWL4030_AUDIO_RES_MAX],
    pub cells: [mfd_cell; TWL4030_AUDIO_CELLS],
}
...
//
#[no_mangle]
unsafe extern "C" fn twl4030_audio_set_resource(id: enum twl4030_audio_res, enable: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn twl4030_audio_get_resource(id: enum twl4030_audio_res) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn twl4030_audio_enable_resource(id: enum twl4030_audio_res) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn twl4030_audio_disable_resource(id: enum twl4030_audio_res) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn twl4030_audio_get_mclk() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn twl4030_audio_probe(pdev: *mut platform_device) -> c_int {
...
// PLL
    ...
    childs, core::ptr::null_mut(), 0, core::ptr::null_mut());
    else {
    dev_err(&pdev.dev, "No platform data found for childs\n");
    ret = -ENODEV;
    }
    if (ret)
    twl4030_audio_dev = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn twl4030_audio_remove(pdev: *mut platform_device) {
