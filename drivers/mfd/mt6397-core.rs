...
//! Source: drivers/mfd/mt6397-core.c
#![no_std]
...
pub const MT6323_RTC_BASE: c_uint = 0x8000;
pub const MT6323_RTC_SIZE: c_uint = 0x40;
pub const MT6357_RTC_BASE: c_uint = 0x0588;
pub const MT6357_RTC_SIZE: c_uint = 0x3c;
pub const MT6331_RTC_BASE: c_uint = 0x4000;
pub const MT6331_RTC_SIZE: c_uint = 0x40;
pub const MT6358_RTC_BASE: c_uint = 0x0588;
pub const MT6358_RTC_SIZE: c_uint = 0x3c;
pub const MT6397_RTC_BASE: c_uint = 0xe000;
pub const MT6397_RTC_SIZE: c_uint = 0x3e;
pub const MT6323_PWRC_BASE: c_uint = 0x8000;
pub const MT6323_PWRC_SIZE: c_uint = 0x40;
...
pub struct chip_data {
    ...
    pub cell_size: c_int,
    pub chip): *mut *mut int (irq_init)(struct mt6397_chip,
}
...
#[no_mangle]
unsafe extern "C" fn mt6397_probe(pdev: *mut platform_device) -> c_int {
...
//
    pmic.regmap = dev_get_regmap(pdev.dev.parent, core::ptr::null_mut());
    if (!pmic.regmap)
    return -ENODEV;
    ...
    core::ptr::null_mut(), 0, pmic.irq_domain);
    if (ret) {
