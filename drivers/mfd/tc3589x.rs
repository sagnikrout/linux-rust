...
pub const TC3589x_CLKMODE_MODCTL_SLEEP: c_uint = 0x0;
...
//
#[no_mangle]
pub unsafe extern "C" fn tc3589x_reg_read(tc3589x: *mut tc3589x, reg: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tc3589x_reg_write(tc3589x: *mut tc3589x, reg: u8, data: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tc3589x_block_read(tc3589x: *mut tc3589x, reg: u8, length: u8, values: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tc3589x_set_bits(tc3589x: *mut tc3589x, reg: u8, mask: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    let mut virq: c_int = irq_find_mapping(tc3589x.domain, bit);
...
#[no_mangle]
unsafe extern "C" fn tc3589x_irq_unmap(d: *mut irq_domain, virq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_irq_init(tc3589x: *mut tc3589x, np: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_chip_init(tc3589x: *mut tc3589x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_device_init(tc3589x: *mut tc3589x) -> c_int {
    static int tc3589x_device_init(struct tc3589x *tc3589x)
    {
    let mut ret: c_int = 0;
    let mut blocks: c_uint = tc3589x.pdata.block;
    if (blocks & TC3589x_BLOCK_GPIO) {
    ret = mfd_add_devices(tc3589x.dev, -1, tc3589x_dev_gpio,
    ARRAY_SIZE(tc3589x_dev_gpio), core::ptr::null_mut(),
    0, tc3589x.domain);
    if (ret) {
    ...
    ARRAY_SIZE(tc3589x_dev_keypad), core::ptr::null_mut(),
    0, tc3589x.domain);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_probe(i2c: *mut i2c_client) -> c_int {
...
// When not probing from device tree we have this ID
    ...
    if (ret)
    return ret;
    ret = request_threaded_irq(tc3589x.i2c.irq, core::ptr::null_mut(), tc3589x_irq,
...
#[no_mangle]
unsafe extern "C" fn tc3589x_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tc3589x_exit() -> void __exit {
