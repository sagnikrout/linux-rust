...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dln2_response {
    pub hdr: dln2_header,
    pub result: __le16,
}

pub const DLN2_GENERIC_MODULE_ID: c_uint = 0x00;

pub const DLN2_HW_ID: c_uint = 0x200;

pub const DLN2_MAX_RX_SLOTS: c_int = 16;
pub const DLN2_MAX_URBS: c_int = 16;
pub const DLN2_RX_BUF_SIZE: c_int = 512;
    enum dln2_handle {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dln2_mod_rx_slots {
// RX slots bitmap
    pub DLN2_MAX_RX_SLOTS): DECLARE_BITMAP(bmap,,
// used to wait for a free RX slot
    pub wq: wait_queue_head_t,
// used to wait for an RX operation to complete
    pub slots: [dln2_rx_context; DLN2_MAX_RX_SLOTS],
...
pub struct dln2_dev {
    ...
    pub ep_in: u8,
    pub ep_out: u8,
    pub rx_urb: [*mut urb; DLN2_MAX_URBS],
    pub rx_buf: [*mut c_void; DLN2_MAX_URBS],
    pub mod_rx_slots: [dln2_mod_rx_slots; DLN2_HANDLES],
    pub event_cb_list: list_head,
    pub event_cb_lock: spinlock_t,
    pub disconnect: bool,
    pub active_transfers: c_int,
    pub disconnect_wq: wait_queue_head_t,
    pub disconnect_lock: spinlock_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct dln2_event_cb_entry {
    pub list: list_head,
    pub id: u16,
    pub pdev: *mut platform_device,
    pub callback: dln2_event_cb_t,
}
...
#[no_mangle]
pub unsafe extern "C" fn dln2_unregister_event_cb(pdev: *mut platform_device, id: u16) {
...
#[no_mangle]
unsafe extern "C" fn dln2_rx(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn find_free_slot(dln2: *mut dln2_dev, handle: u16, slot: *mut c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn alloc_rx_slot(dln2: *mut dln2_dev, handle: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_rx_slot(dln2: *mut dln2_dev, handle: u16, slot: c_int) {
    ...
    struct dln2_rx_context *rxc;
    struct device *dev = &dln2.interface.dev;
    let mut timeout: c_ulong = msecs_to_jiffies(DLN2_USB_TIMEOUT);
    struct dln2_mod_rx_slots *rxs = &dln2.mod_rx_slots[handle];
    int size;
...
#[no_mangle]
unsafe extern "C" fn dln2_check_hw(dln2: *mut dln2_dev) -> c_int {
    static int dln2_check_hw(struct dln2_dev *dln2)
    {
    int ret;
    __le32 hw_type;
    let mut len: c_int = sizeof(hw_type);
    ret = _dln2_transfer(dln2, DLN2_HANDLE_CTRL, CMD_GET_DEVICE_VER,
    core::ptr::null_mut(), 0, &hw_type, &len);
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn dln2_print_serialno(dln2: *mut dln2_dev) -> c_int {
    static int dln2_print_serialno(struct dln2_dev *dln2)
    {
    int ret;
    __le32 serial_no;
    let mut len: c_int = sizeof(serial_no);
    struct device *dev = &dln2.interface.dev;
    ret = _dln2_transfer(dln2, DLN2_HANDLE_CTRL, CMD_GET_DEVICE_SN, core::ptr::null_mut(), 0,
    &serial_no, &len);
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn dln2_hw_init(dln2: *mut dln2_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dln2_free_rx_urbs(dln2: *mut dln2_dev) {
...
#[no_mangle]
unsafe extern "C" fn dln2_stop_rx_urbs(dln2: *mut dln2_dev) {
...
#[no_mangle]
unsafe extern "C" fn dln2_free(dln2: *mut dln2_dev) {
    ...
    {
    int i;
    let mut rx_max_size: c_int = DLN2_RX_BUF_SIZE;
    struct device *dev = &dln2.interface.dev;
    for (i = 0; i < DLN2_MAX_URBS; i++) {
...
#[no_mangle]
unsafe extern "C" fn dln2_start_rx_urbs(dln2: *mut dln2_dev, gfp: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dln2_stop(dln2: *mut dln2_dev) {
...
#[no_mangle]
unsafe extern "C" fn dln2_disconnect(interface: *mut usb_interface) {
    ...
    return -ENODEV;
    ret = usb_find_common_endpoints(hostif, &epin, &epout, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn dln2_suspend(iface: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dln2_resume(iface: *mut usb_interface) -> c_int {
