...
//! Source: drivers/mfd/arizona-spi.c
#![no_std]
...
//
    ...
    let mut ldoena_gpios: static struct acpi_gpio_params = { 2, 0, false };
...
#[no_mangle]
unsafe extern "C" fn arizona_spi_acpi_remove_lookup(lookup: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn arizona_spi_acpi_windows_probe(arizona: *mut arizona) -> c_int {
...
// Enable 32KHz clock from SoC to codec for jack-detect
    status = acpi_evaluate_object(ACPI_HANDLE(arizona.dev), "CLKE", core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn arizona_spi_acpi_android_probe(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_spi_acpi_probe(arizona: *mut arizona) -> c_int {
    static int arizona_spi_acpi_probe(struct arizona *arizona)
    {
    struct acpi_device *adev = ACPI_COMPANION(arizona.dev);
    int ret;
    if (acpi_dev_hid_uid_match(adev, "10WM5102", core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn arizona_spi_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_spi_remove(spi: *mut spi_device) {
