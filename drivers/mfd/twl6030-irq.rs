...
//! Source: drivers/mfd/twl6030-irq.c
#![no_std]
...
//
pub const TWL6030_NR_IRQS: c_int = 20;
...
//
#[no_mangle]
unsafe extern "C" fn twl6030_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// ----------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn twl6030_irq_set_wake(d: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn twl6030_interrupt_unmask(bit_mask: u8, offset: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn twl6030_interrupt_mask(bit_mask: u8, offset: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl6030_irq_unmap(d: *mut irq_domain, virq: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn twl6030_init_irq(dev: *mut device, irq_num: c_int) -> c_int {
...
//
    ...
    twl6030_irq.irq_chip.irq_set_type = core::ptr::null_mut();
...
// install an irq handler to demultiplex the TWL6030 interrupt
    status = request_threaded_irq(irq_num, core::ptr::null_mut(), twl6030_irq_thread,
...
#[no_mangle]
pub unsafe extern "C" fn twl6030_exit_irq() {
    void twl6030_exit_irq(void)
    {
    if (twl6030_irq && twl6030_irq.twl_irq) {
    unregister_pm_notifier(&twl6030_irq.pm_nb);
    free_irq(twl6030_irq.twl_irq, core::ptr::null_mut());
//
