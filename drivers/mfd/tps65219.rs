...
#[no_mangle]
unsafe extern "C" fn tps65219_warm_reset(tps: *mut tps65219) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_cold_reset(tps: *mut tps65219) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_soft_shutdown(tps: *mut tps65219) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_power_off_handler(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_restart(tps: *mut tps65219, reboot_mode: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_restart_handler(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), 0, regmap_irq_get_domain(tps.irq_data));
    if (ret) {
    ...
    if (pwr_button) {
    ret = devm_mfd_add_devices(tps.dev, PLATFORM_DEVID_AUTO,
    &tps65219_pwrbutton_cell, 1, core::ptr::null_mut(), 0,
