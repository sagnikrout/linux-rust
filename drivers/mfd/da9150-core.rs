...
//! Source: drivers/mfd/da9150-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn da9150_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_read_qif(da9150: *mut da9150, addr: u8, count: c_int, buf: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_write_qif(da9150: *mut da9150, addr: u8, count: c_int, buf: *const u8) {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_reg_read(da9150: *mut da9150, reg: u16) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_reg_write(da9150: *mut da9150, reg: u16, val: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_set_bits(da9150: *mut da9150, reg: u16, mask: u8, val: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_bulk_read(da9150: *mut da9150, reg: u16, count: c_int, buf: *mut u8) {
...
#[no_mangle]
pub unsafe extern "C" fn da9150_bulk_write(da9150: *mut da9150, reg: u16, count: c_int, buf: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn da9150_probe(client: *mut i2c_client) -> c_int {
...
// Setup secondary I2C interface for QIF access
    ...
    ARRAY_SIZE(da9150_devs), core::ptr::null_mut(),
    da9150.irq_base, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn da9150_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn da9150_shutdown(client: *mut i2c_client) {
