...
#[no_mangle]
unsafe extern "C" fn max77802_is_accessible_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max77802_pmic_is_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max77802_rtc_is_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max77802_is_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max77802_pmic_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max77802_rtc_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max77802_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max77686_i2c_probe(i2c: *mut i2c_client) -> c_int {
    static int max77686_i2c_probe(struct i2c_client *i2c)
    {
    struct max77686_dev *max77686 = core::ptr::null_mut();
    unsigned int data;
    let mut ret: c_int = 0;
    ...
    ret = devm_mfd_add_devices(max77686.dev, -1, cells, n_devs, core::ptr::null_mut(),
    0, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn max77686_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77686_resume(dev: *mut device) -> c_int {
