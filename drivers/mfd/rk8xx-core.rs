...
//! Source: drivers/mfd/rk8xx-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rk808_power_off(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk808_restart(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rk8xx_shutdown(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn rk8xx_probe(dev: *mut device, variant: c_int, irq: c_uint, regmap: *mut regmap) -> c_int {
    int rk8xx_probe(struct device *dev, int variant, unsigned int irq, struct regmap *regmap)
    {
    struct rk808 *rk808;
    const struct rk808_reg_data *pre_init_reg;
    const struct mfd_cell *cells;
    let mut dual_support: c_int = 0;
    int nr_pre_init_regs;
    let mut rst_fun: u32 = 0;
    int nr_cells;
    int ret;
    int i;
    ...
    ret = devm_mfd_add_devices(dev, PLATFORM_DEVID_AUTO, cells, nr_cells, core::ptr::null_mut(), 0,
...
#[no_mangle]
pub unsafe extern "C" fn rk8xx_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rk8xx_resume(dev: *mut device) -> c_int {
