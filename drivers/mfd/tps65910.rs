...
pub const TPS65910_DUMMY_XFER_LEN: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn tps65910_power_off() {
...
#[no_mangle]
unsafe extern "C" fn tps65910_i2c_probe(i2c: *mut i2c_client) -> c_int {
    static int tps65910_i2c_probe(struct i2c_client *i2c)
    {
    const struct i2c_device_id *id = i2c_client_get_device_id(i2c);
    struct tps65910 *tps65910;
    struct tps65910_board *pmic_plat_data;
    struct tps65910_board *of_pmic_plat_data = core::ptr::null_mut();
    struct tps65910_platform_data *init_data;
    let mut chip_id: c_ulong = id.driver_data;
    int ret;
    ...
    if (init_data == core::ptr::null_mut())
    return -ENOMEM;
    tps65910 = devm_kzalloc(&i2c.dev, sizeof(*tps65910), GFP_KERNEL);
    if (tps65910 == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn tps65910_i2c_init() -> int __init {
