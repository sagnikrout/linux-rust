...
//! Source: drivers/mfd/da9052-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn da9052_reg_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn da9052_reg_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn da9052_reg_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn da9052_adc_manual_read(da9052: *mut da9052, channel: c_uchar) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn da9052_adc_read_temp(da9052: *mut da9052) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_clear_fault_log(da9052: *mut da9052) -> c_int {
    static int da9052_clear_fault_log(struct da9052 *da9052)
    {
    let mut ret: c_int = 0;
    let mut fault_log: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn da9052_device_init(da9052: *mut da9052, chip_id: u8) -> c_int {
    ...
    if (pdata && pdata.init != core::ptr::null_mut())
    pdata.init(da9052);
    ...
    da9052_subdev_info,
    ARRAY_SIZE(da9052_subdev_info), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn da9052_device_exit(da9052: *mut da9052) {
