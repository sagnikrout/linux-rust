...
//! Source: drivers/mfd/cros_ec_dev.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_feature_to_name {
    pub id: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_feature_to_cells {
    pub id: c_uint,
    pub mfd_cells: *const mfd_cell,
...
#[no_mangle]
unsafe extern "C" fn cros_ec_class_release(dev: *mut device) {
    static void cros_ec_class_release(struct device *dev)
    {
    kfree(to_cros_ec_dev(dev));
    }
#[no_mangle]
unsafe extern "C" fn ec_device_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    !of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "google,cros-ec-ucsi")) {
    retval = mfd_add_hotplug_devices(ec.dev,
    cros_ec_ucsi_cells,
...
//
    retval = cros_ec_cmd(ec.ec_dev, 0, EC_CMD_PCHG_COUNT, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn ec_device_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_dev_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_dev_exit() -> void __exit {
