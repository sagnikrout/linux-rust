...
//! Source: drivers/mfd/wm8350-irq.c
#![no_std]
...
pub const WM8350_INT_OFFSET_1: c_int = 0;
pub const WM8350_INT_OFFSET_2: c_int = 1;
pub const WM8350_POWER_UP_INT_OFFSET: c_int = 2;
pub const WM8350_UNDER_VOLTAGE_INT_OFFSET: c_int = 3;
pub const WM8350_OVER_CURRENT_INT_OFFSET: c_int = 4;
pub const WM8350_GPIO_INT_OFFSET: c_int = 5;
pub const WM8350_COMPARATOR_INT_OFFSET: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm8350_irq_data {
    pub primary: c_int,
    pub reg: c_int,
    pub mask: c_int,
    pub primary_only: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn wm8350_irq(irq: c_int, irq_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm8350_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wm8350_irq_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wm8350_irq_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wm8350_irq_disable(data: *mut irq_data) {
...
// Register with genirq
    ...
    ret = request_threaded_irq(irq, core::ptr::null_mut(), wm8350_irq, flags,
    "wm8350", wm8350);
    if (ret != 0)
...
#[no_mangle]
pub unsafe extern "C" fn wm8350_irq_exit(wm8350: *mut wm8350) -> c_int {
