...
//! Source: drivers/mfd/ocelot-spi.c
#![no_std]
...
pub const REG_DEV_CPUORG_IF_CTRL: c_uint = 0x0000;
pub const REG_DEV_CPUORG_IF_CFGSTAT: c_uint = 0x0004;

pub const VSC7512_DEVCPU_ORG_RES_START: c_uint = 0x71000000;
pub const VSC7512_DEVCPU_ORG_RES_SIZE: c_uint = 0x38;
pub const VSC7512_CHIP_REGS_RES_START: c_uint = 0x71070000;
pub const VSC7512_CHIP_REGS_RES_SIZE: c_uint = 0x14;
...
#[no_mangle]
unsafe extern "C" fn ocelot_spi_initialize(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocelot_spi_regmap_bus_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocelot_spi_probe(spi: *mut spi_device) -> c_int {
