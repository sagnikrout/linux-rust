...
//! Source: drivers/mfd/cs47l35-tables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cs47l35_patch(madera: *mut madera) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l35_is_adsp_memory(reg: c_uint) -> bool {
