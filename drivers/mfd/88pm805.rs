...
#[no_mangle]
unsafe extern "C" fn device_irq_init_805(chip: *mut pm80x_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_irq_exit_805(chip: *mut pm80x_chip) {
...
#[no_mangle]
unsafe extern "C" fn device_805_init(chip: *mut pm80x_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm805_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm805_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn pm805_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pm805_i2c_exit() -> void __exit {
