...
#[no_mangle]
unsafe extern "C" fn rn5t618_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_irq_init(rn5t618: *mut rn5t618) -> c_int {
    static int rn5t618_irq_init(struct rn5t618 *rn5t618)
    {
    const struct regmap_irq_chip *irq_chip = core::ptr::null_mut();
    int ret;
    if (!rn5t618.irq)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn rn5t618_trigger_poweroff_sequence(repower: bool) {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_power_off() {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_i2c_remove(i2c: *mut i2c_client) {
    static void rn5t618_i2c_remove(struct i2c_client *i2c)
    {
    if (i2c == rn5t618_pm_power_off) {
    rn5t618_pm_power_off = core::ptr::null_mut();
    pm_power_off = core::ptr::null_mut();
    }
    unregister_restart_handler(&rn5t618_restart_handler);
    }
#[no_mangle]
unsafe extern "C" fn rn5t618_i2c_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_i2c_resume(dev: *mut device) -> int __maybe_unused {
