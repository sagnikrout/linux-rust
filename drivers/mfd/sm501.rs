...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sm501_gpio_chip {
    pub gpio: gpio_chip,
    pub /: *mut *mut *mut sm501_gpio ourgpio; / to get back to parent.,
    pub regbase: *mut void __iomem,
    pub /: *mut *mut *mut void __iomem control; / address of control reg.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sm501_gpio {
    pub low: sm501_gpio_chip,
    pub high: sm501_gpio_chip,
    pub lock: spinlock_t,
    pub 1: unsigned int registered :,
    pub regs: *mut void __iomem,
    pub regs_res: *mut resource,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sm501_devdata {
    pub reg_lock: spinlock_t,
    pub clock_lock: mutex,
    pub devices: list_head,
    pub gpio: sm501_gpio,
    pub dev: *mut device,
    pub io_res: *mut resource,
    pub mem_res: *mut resource,
    pub regs_claim: *mut resource,
    pub platdata: *mut sm501_platdata,
    pub in_suspend: c_uint,
    pub pm_misc: c_ulong,
    pub unit_power: [c_int; 20],
    pub pdev_id: c_uint,
    pub irq: c_uint,
    pub regs: *mut void __iomem,
    pub rev: c_uint,
...
//
#[no_mangle]
unsafe extern "C" fn sm501_dump_clk(sm: *mut sm501_devdata) {
    static void sm501_dump_clk(struct sm501_devdata *sm)
    {
    let mut misct: c_ulong = smc501_readl(sm.regs + SM501_MISC_TIMING);
    let mut pm0: c_ulong = smc501_readl(sm.regs + SM501_POWER_MODE_0_CLOCK);
    let mut pm1: c_ulong = smc501_readl(sm.regs + SM501_POWER_MODE_1_CLOCK);
    let mut pmc: c_ulong = smc501_readl(sm.regs + SM501_POWER_MODE_CONTROL);
    unsigned long sdclk0, sdclk1;
    let mut pll2: c_ulong = 0;
    switch (misct & 0x30) {
    case 0x00:
    pll2 = 336 * MHZ;
    break;
...
#[no_mangle]
unsafe extern "C" fn sm501_dump_regs(sm: *mut sm501_devdata) {
...
#[no_mangle]
unsafe extern "C" fn sm501_dump_gate(sm: *mut sm501_devdata) {
...
//
#[no_mangle]
unsafe extern "C" fn sm501_sync_regs(sm: *mut sm501_devdata) {
    static void sm501_sync_regs(struct sm501_devdata *sm)
    {
    smc501_readl(sm.regs);
    }
#[no_mangle]
pub unsafe extern "C" fn sm501_mdelay(sm: *mut sm501_devdata, delay: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sm501_unit_power(dev: *mut device, unit: c_uint, to: c_uint) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sm501_clock {
    pub mclk: c_ulong,
    pub divider: c_int,
    pub shift: c_int,
    pub k: unsigned int m, n,,
}
...
//
    ...
    unsigned long mclk;
    unsigned int m, n, k;
    let mut best_diff: c_long = 999999999;
//
...
//
    ...
    {
    struct sm501_devdata *sm = dev_get_drvdata(dev);
    let mut mode: c_ulong = smc501_readl(sm.regs + SM501_POWER_MODE_CONTROL);
    let mut gate: c_ulong = smc501_readl(sm.regs + SM501_CURRENT_GATE);
    let mut clock: c_ulong = smc501_readl(sm.regs + SM501_CURRENT_CLOCK);
    let mut pll_reg: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(5: to.divider ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn sm501_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn sm501_register_uart(sm: *mut sm501_devdata, devices: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm501_gpio_get(chip: *mut gpio_chip, offset: unsigned) -> c_int {
...
// check and modify if this pin is not set as gpio.
    ...
    let mut bit: c_ulong = BIT(offset);
...
#[no_mangle]
unsafe extern "C" fn sm501_gpio_input(chip: *mut gpio_chip, offset: unsigned) -> c_int {
    ...
    let mut base: c_int = pdata.gpio_base;
...
#[no_mangle]
unsafe extern "C" fn sm501_register_gpio(sm: *mut sm501_devdata) -> c_int {
    static int sm501_register_gpio(struct sm501_devdata *sm)
    {
    struct sm501_gpio *gpio = &sm.gpio;
    let mut iobase: resource_size_t = sm.io_res.start + SM501_GPIO;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sm501_gpio_remove(sm: *mut sm501_devdata) {
...
#[no_mangle]
pub unsafe extern "C" fn sm501_gpio_isregistered(sm: *mut sm501_devdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sm501_register_gpio(sm: *mut sm501_devdata) -> c_int {
    static inline int sm501_register_gpio(struct sm501_devdata *sm)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn sm501_gpio_remove(sm: *mut sm501_devdata) {
...
// Create a gpiod lookup using gpiochip-local offsets
    ...
    iic.pin_sda % 32, core::ptr::null_mut(), 0,
    GPIO_ACTIVE_HIGH | GPIO_OPEN_DRAIN);
    lookup.table[1] = (struct gpiod_lookup)
    GPIO_LOOKUP_IDX(iic.pin_scl < 32 ? "SM501-LOW" : "SM501-HIGH",
    iic.pin_scl % 32, core::ptr::null_mut(), 1,
    GPIO_ACTIVE_HIGH | GPIO_OPEN_DRAIN);
...
//
#[no_mangle]
unsafe extern "C" fn sm501_check_clocks(sm: *mut sm501_devdata) -> c_int {
    static int sm501_check_clocks(struct sm501_devdata *sm)
    {
    let mut pwrmode: c_ulong = smc501_readl(sm.regs + SM501_CURRENT_CLOCK);
    let mut msrc: c_ulong = (pwrmode & SM501_POWERMODE_M_SRC);
    let mut m1src: c_ulong = (pwrmode & SM501_POWERMODE_M1_SRC);
...
//
#[no_mangle]
unsafe extern "C" fn sm501_init_dev(sm: *mut sm501_devdata) -> c_int {
...
// check to see if we have some device initialisation
    pdata = sm.platdata;
    idata = pdata ? pdata.init : core::ptr::null_mut();
    if (idata) {
...
#[no_mangle]
unsafe extern "C" fn sm501_plat_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm501_set_power(sm: *mut sm501_devdata, on: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sm501_plat_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm501_plat_resume(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sm501_dev_remove(sm: *mut sm501_devdata) {
...
#[no_mangle]
unsafe extern "C" fn sm501_pci_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn sm501_plat_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sm501_base_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sm501_base_exit() -> void __exit {
