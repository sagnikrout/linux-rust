...
//! Source: drivers/mfd/rc5t583-irq.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rc5t583_irq_data {
    pub int_type: u8,
    pub master_bit: u8,
    pub int_en_bit: u8,
    pub mask_reg_index: u8,
    pub grp_index: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn rc5t583_irq_lock(irq_data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rc5t583_irq_unmask(irq_data: *mut irq_data) {
    static void rc5t583_irq_unmask(struct irq_data *irq_data)
    {
    struct rc5t583 *rc5t583 = irq_data_get_irq_chip_data(irq_data);
    let mut __irq: c_uint = irq_data.irq - rc5t583.irq_base;
...
#[no_mangle]
unsafe extern "C" fn rc5t583_irq_mask(irq_data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rc5t583_irq_set_type(irq_data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t583_irq_sync_unlock(irq_data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn rc5t583_irq_set_wake(irq_data: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc5t583_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t rc5t583_irq(int irq, void *data)
    {
    struct rc5t583 *rc5t583 = data;
    uint8_t int_sts[RC5T583_MAX_INTERRUPT_MASK_REGS];
    let mut master_int: u8 = 0;
    int i;
    int ret;
    let mut rtc_int_sts: c_uint = 0;
// Clear the status
...
#[no_mangle]
pub unsafe extern "C" fn rc5t583_irq_init(rc5t583: *mut rc5t583, irq: c_int, irq_base: c_int) -> c_int {
...
// Clear all interrupts in case they woke up active.
    ...
    for (i = 0; i < RC5T583_MAX_IRQS; i++) {
    let mut __irq: c_int = i + rc5t583.irq_base;
    ...
    ret = devm_request_threaded_irq(rc5t583.dev, irq, core::ptr::null_mut(), rc5t583_irq,
