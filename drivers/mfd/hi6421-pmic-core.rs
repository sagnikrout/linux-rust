...
//! Source: drivers/mfd/hi6421-pmic-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hi6421_pmic_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (IS_ERR(base))
    return PTR_ERR(base);
    pmic.regmap = devm_regmap_init_mmio_clk(&pdev.dev, core::ptr::null_mut(), base,
