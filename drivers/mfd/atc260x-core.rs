...
//! Source: drivers/mfd/atc260x-core.c
#![no_std]
...
pub const ATC260X_CHIP_REV_MAX: c_int = 31;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atc260x_init_regs {
    pub cmu_devrst: c_uint,
    pub cmu_devrst_ints: c_uint,
    pub ints_msk: c_uint,
    pub pad_en: c_uint,
    pub pad_en_extirq: c_uint,
}

#[no_mangle]
unsafe extern "C" fn regmap_lock_mutex(__mutex: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_unlock_mutex(__mutex: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn atc260x_cmu_reset(atc260x: *mut atc260x) {
...
#[no_mangle]
unsafe extern "C" fn atc260x_dev_init(atc260x: *mut atc260x) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atc260x_match_device(atc260x: *mut atc260x, regmap_cfg: *mut regmap_config) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn atc260x_device_probe(atc260x: *mut atc260x) -> c_int {
...
// Initialize the hardware
    ...
    atc260x.cells, atc260x.nr_cells, core::ptr::null_mut(), 0,
