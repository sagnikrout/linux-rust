...
//! Source: drivers/mfd/wm831x-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wm831x_reg_locked(wm831x: *mut wm831x, reg: c_ushort) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wm831x_reg_lock(wm831x: *mut wm831x) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wm831x_reg_unlock(wm831x: *mut wm831x) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_reg_readable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm831x_reg_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm831x_reg_volatile(dev: *mut device, reg: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn wm831x_reg_read(wm831x: *mut wm831x, reg: c_ushort) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wm831x_device_init(wm831x: *mut wm831x, irq: c_int) -> c_int {
...
// Treat errors as non-critical
    ...
    ARRAY_SIZE(backlight_devs), core::ptr::null_mut(),
    0, core::ptr::null_mut());
    if (ret < 0)
...
#[no_mangle]
pub unsafe extern "C" fn wm831x_device_suspend(wm831x: *mut wm831x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm831x_device_shutdown(wm831x: *mut wm831x) {
