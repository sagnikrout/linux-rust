...
#[no_mangle]
unsafe extern "C" fn tps65217_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tps65217_irq_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tps65217_irq_enable(data: *mut irq_data) {
    static void tps65217_irq_enable(struct irq_data *data)
    {
    struct tps65217 *tps = irq_data_get_irq_chip_data(data);
    let mut mask: u8 = BIT(data.hwirq) << TPS65217_INT_SHIFT;
    tps.irq_mask &= ~mask;
    }
#[no_mangle]
unsafe extern "C" fn tps65217_irq_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tps65217_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tps65217_irq_init(tps: *mut tps65217, irq: c_int) -> c_int {
...
// Mask all interrupt sources
    ...
    ret = devm_request_threaded_irq(tps.dev, irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn tps65217_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tps65217_probe(client: *mut i2c_client) -> c_int {
    static int tps65217_probe(struct i2c_client *client)
    {
    struct tps65217 *tps;
    unsigned int version;
    let mut status_off: bool = false;
    int ret;
...
// Don't tell children about IRQ resources which won't fire
    ...
    ARRAY_SIZE(tps65217s), core::ptr::null_mut(), 0,
    tps.irq_domain);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn tps65217_remove(client: *mut i2c_client) {
    ...
    tps.irq_domain = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn tps65217_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps65217_exit() -> void __exit {
