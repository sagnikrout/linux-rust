...
//! Source: drivers/mfd/wm831x-irq.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn irq_data_to_status_reg(irq_data: *mut wm831x_irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wm831x_irq_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wm831x_irq_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wm831x_irq_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn wm831x_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    let mut offset: c_int = wm831x_irqs[i].reg - 1;
...
#[no_mangle]
pub unsafe extern "C" fn wm831x_irq_init(wm831x: *mut wm831x, irq: c_int) -> c_int {
...
//
    ...
    ret = request_threaded_irq(irq, core::ptr::null_mut(), wm831x_irq_thread,
...
#[no_mangle]
pub unsafe extern "C" fn wm831x_irq_exit(wm831x: *mut wm831x) {
