...
//! Source: drivers/mfd/stm32-timers.c
#![no_std]
...
pub const STM32_TIMERS_MAX_REGISTERS: c_uint = 0x3fc;
...
#[no_mangle]
unsafe extern "C" fn stm32_timers_dma_done(p: *mut c_void) {
...
//
    ...
    let mut timeout: c_ulong = msecs_to_jiffies(tmo_ms);
    struct regmap *regmap = ddata.regmap;
    struct stm32_timers_dma *dma = &ddata.dma;
    let mut len: usize = num_reg * bursts * sizeof(u32);
...
#[no_mangle]
unsafe extern "C" fn stm32_timers_get_arr_size(ddata: *mut stm32_timers) {
...
#[no_mangle]
unsafe extern "C" fn stm32_timers_probe_hwcfgr(dev: *mut device, ddata: *mut stm32_timers) -> c_int {
...
// Save the first error code to return
    ...
    ddata.dma.chans[i] = core::ptr::null_mut();
    }
    }
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn stm32_timers_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_timers_remove(pdev: *mut platform_device) {
