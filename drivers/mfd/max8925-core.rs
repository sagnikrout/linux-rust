...
//! Source: drivers/mfd/max8925-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn max8925_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// TSC IRQ should be serviced in max8925_tsc_irq()
    ...
    i2c = chip.rtc;
#[no_mangle]
pub unsafe extern "C" fn if(FLAGS_ADC: irq_data->flags ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn max8925_tsc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max8925_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max8925_irq_sync_unlock(data: *mut irq_data) {
    ...
    let mut cache_rtc: static unsigned char = 0xff, cache_tsc = 0xff;
...
#[no_mangle]
unsafe extern "C" fn max8925_irq_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn max8925_irq_disable(data: *mut irq_data) {
...
// request irq handler for pmic main irq
    ...
    if (!chip.core_irq)
    return -EBUSY;
    ret = request_threaded_irq(irq, core::ptr::null_mut(), max8925_irq, flags | IRQF_ONESHOT,
    "max8925", chip);
    if (ret) {
...
// mask TSC interrupt
    ...
    ret = request_threaded_irq(chip.tsc_irq, core::ptr::null_mut(), max8925_tsc_irq,
...
// enable Momentary Power Loss
    ...
    core::ptr::null_mut(), chip.tsc_irq, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
pub unsafe extern "C" fn max8925_device_exit(chip: *mut max8925_chip) {
