...
//! Source: drivers/mfd/lochnagar-i2c.c
#![no_std]
...
pub const LOCHNAGAR_BOOT_RETRIES: c_int = 10;
pub const LOCHNAGAR_BOOT_DELAY_MS: c_int = 350;
pub const LOCHNAGAR_CONFIG_POLL_US: c_int = 10000;
#[no_mangle]
unsafe extern "C" fn lochnagar1_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lochnagar2_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lochnagar2_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
pub struct lochnagar_config {
    ...
    pub type: enum lochnagar_type,
    pub regmap: *const regmap_config,
    pub patch: *const reg_sequence,
    pub npatch: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn lochnagar_wait_for_boot(regmap: *mut regmap, id: *mut c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn lochnagar_update_config(lochnagar: *mut lochnagar) -> c_int {
    int lochnagar_update_config(struct lochnagar *lochnagar)
    {
    struct regmap *regmap = lochnagar.regmap;
    let mut done: c_uint = LOCHNAGAR2_ANALOGUE_PATH_UPDATE_STS_MASK;
    let mut timeout_ms: c_int = LOCHNAGAR_BOOT_DELAY_MS * LOCHNAGAR_BOOT_RETRIES;
...
#[no_mangle]
unsafe extern "C" fn lochnagar_i2c_probe(i2c: *mut i2c_client) -> c_int {
    static int lochnagar_i2c_probe(struct i2c_client *i2c)
    {
    struct device *dev = &i2c.dev;
    const struct lochnagar_config *config = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lochnagar_i2c_init() -> int __init {
