...
//! Source: drivers/mfd/intel_soc_pmic_chtwc.c
#![no_std]
...
pub const CHT_WC_IRQLVL1: c_uint = 0x6e02;
pub const CHT_WC_IRQLVL1_MASK: c_uint = 0x6e0e;
// Whiskey Cove PMIC share same ACPI ID between different platforms
pub const CHT_WC_HRV: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn cht_wc_probe(client: *mut i2c_client) -> c_int {
    ...
    pmic.regmap = devm_regmap_init(dev, core::ptr::null_mut(), client, &cht_wc_regmap_cfg);
    ...
    cht_wc_dev, ARRAY_SIZE(cht_wc_dev), core::ptr::null_mut(), 0,
    regmap_irq_get_domain(pmic.irq_chip_data));
    }
#[no_mangle]
unsafe extern "C" fn cht_wc_shutdown(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cht_wc_resume(dev: *mut device) -> c_int {
