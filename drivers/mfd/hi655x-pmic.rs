...
//! Source: drivers/mfd/hi655x-pmic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hi655x_local_irq_clear(map: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn hi655x_pmic_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (IS_ERR(base))
    return PTR_ERR(base);
    pmic.regmap = devm_regmap_init_mmio_clk(dev, core::ptr::null_mut(), base,
    ...
    ARRAY_SIZE(hi655x_pmic_devs), core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn hi655x_pmic_remove(pdev: *mut platform_device) {
