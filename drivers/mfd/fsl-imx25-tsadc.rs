...
//! Source: drivers/mfd/fsl-imx25-tsadc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mx25_tsadc_irq_handler(desc: *mut irq_desc) {
...
#[no_mangle]
unsafe extern "C" fn mx25_tsadc_unset_irq(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mx25_tsadc_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (!tsadc)
    return -ENOMEM;
    iomem = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
    if (IS_ERR(iomem))
...
#[no_mangle]
unsafe extern "C" fn mx25_tsadc_remove(pdev: *mut platform_device) {
