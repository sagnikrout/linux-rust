...
//! Source: drivers/mfd/rohm-bd96801.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct bd968xx {
    pub errb_irqs: *const resource,
    pub intb_irqs: *const resource,
    pub num_errb_irqs: c_int,
    pub num_intb_irqs: c_int,
    pub errb_irq_chip: *const regmap_irq_chip,
    pub intb_irq_chip: *const regmap_irq_chip,
    pub regmap_config: *const regmap_config,
    pub cells: *mut mfd_cell,
    pub num_cells: c_int,
    pub unlock_reg: c_int,
    pub unlock_val: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn bd96801_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
// res = ddata->errb_irqs[i];
    ...
    ddata.num_cells, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn bd96801_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bd96801_i2c_exit() -> void __exit {
