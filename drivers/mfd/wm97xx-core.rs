...
//! Source: drivers/mfd/wm97xx-core.c
#![no_std]
...
pub const WM9713_VENDOR_ID: c_uint = 0x574d4c13;
pub const WM97xx_VENDOR_ID_MASK: c_uint = 0xffffffff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm97xx_priv {
    pub regmap: *mut regmap,
    pub ac97: *mut snd_ac97,
    pub dev: *mut device,
    pub codec_pdata: wm97xx_platform_data,
}

#[no_mangle]
unsafe extern "C" fn wm97xx_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_ac97_probe(adev: *mut ac97_codec_device) -> c_int {
    ...
    let mut ret: c_int = -ENODEV, nb_cells, i;
    ...
    codec_pdata.batt_pdata = pdata ? pdata.batt_pdata : core::ptr::null_mut();
    ...
    cells, nb_cells, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
    goto err_free_compat;
    return ret;
    err_free_compat:
...
#[no_mangle]
unsafe extern "C" fn wm97xx_ac97_remove(adev: *mut ac97_codec_device) {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_module_exit() -> void __exit {
