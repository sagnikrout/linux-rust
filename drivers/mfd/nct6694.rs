...
#[no_mangle]
unsafe extern "C" fn nct6694_response_err_handling(nct6694: *mut nct6694, err_status: c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nct6694_read_msg(nct6694: *mut nct6694, cmd_hd: *const nct6694_cmd_header, buf: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nct6694_write_msg(nct6694: *mut nct6694, cmd_hd: *const nct6694_cmd_header, buf: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_int_callback(urb: *mut urb) {
    ...
    while (int_status) {
    let mut irq: c_int = __ffs(int_status);
...
#[no_mangle]
unsafe extern "C" fn nct6694_irq_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_irq_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn nct6694_irq_domain_map(d: *mut irq_domain, irq: c_uint, hw: irq_hw_number_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nct6694_irq_domain_unmap(d: *mut irq_domain, irq: c_uint) {
    ...
    return -ENOMEM;
    nct6694.domain = irq_domain_create_simple(core::ptr::null_mut(), NCT6694_NR_IRQS, 0,
...
#[no_mangle]
unsafe extern "C" fn nct6694_usb_disconnect(iface: *mut usb_interface) {
