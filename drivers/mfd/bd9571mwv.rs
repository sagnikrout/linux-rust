...
//! Source: drivers/mfd/bd9571mwv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bd957x_identify(dev: *mut device, regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd9571mwv_probe(client: *mut i2c_client) -> c_int {
