...
pub struct syscon {
    ...
    u32 reg_io_width;
    int ret;
    let mut syscon_config: regmap_config = syscon_regmap_config;
    struct resource res;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_property_read_bool(np, _arg: "little-endian")) -> else {
    else if (of_property_read_bool(np, "little-endian"))
    syscon_config.val_format_endian = REGMAP_ENDIAN_LITTLE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_property_read_bool(np, _arg: "native-endian")) -> else {
...
// Ignore missing hwlock, it's optional.
    ...
    regmap = regmap_init_mmio(core::ptr::null_mut(), base, &syscon_config);
...
// clock is optional
    ...
    reset = of_reset_control_get_optional_exclusive(np, core::ptr::null_mut());
    if (IS_ERR(reset)) {
    ret = PTR_ERR(reset);
    goto err_attach_clk;
    }
    ...
    bool check_res)
    {
    struct syscon *entry, *syscon = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn of_syscon_register_regmap(np: *mut device_node, regmap: *mut regmap) -> c_int {
...
//
    ...
    struct regmap *regmap;
    syscon_np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), s);
    if (!syscon_np)
