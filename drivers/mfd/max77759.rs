...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77759_i2c_subdev {
    pub id: enum max77759_i2c_subdev_id,
    pub cfg: *const regmap_config,
    pub i2c_address: u16,
}
...
// I2C address is same as for sub-block 'top'
    ...
    MFD_CELL_OF("max77759-nvmem", core::ptr::null_mut(), core::ptr::null_mut(), 0, 0,
    "maxim,max77759-nvmem"),
    };
    static const struct mfd_cell max77759_maxq_cells[] = {
    MFD_CELL_OF("max77759-gpio", max77759_gpio_resources, core::ptr::null_mut(), 0, 0,
    "maxim,max77759-gpio"),
    };
    ...
    let mut timeout_ms: static unsigned int = 200;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn apcmdres_irq_handler(irq: c_int, irq_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(MAX77759_I2C_SUBDEV_ID_CHARGER: sd->id ==) -> else {
    ...
    core::ptr::null_mut(), apcmdres_irq_handler,
...
#[no_mangle]
unsafe extern "C" fn max77759_probe(client: *mut i2c_client) -> c_int {
