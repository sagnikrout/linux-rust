...
//! Source: drivers/mfd/cs40l50-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cs40l50_dsp_write(dev: *mut device, regmap: *mut regmap, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_wseq_init(cs40l50: *mut cs40l50) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_dsp_config(cs40l50: *mut cs40l50) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_dsp_post_run(dsp: *mut cs_dsp) -> c_int {
    ...
    ARRAY_SIZE(cs40l50_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn cs40l50_dsp_remove(data: *mut c_void) {
    static void cs40l50_dsp_remove(void *data)
    {
    cs_dsp_remove(data);
    }
#[no_mangle]
unsafe extern "C" fn cs40l50_dsp_init(cs40l50: *mut cs40l50) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_reset_dsp(cs40l50: *mut cs40l50) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_dsp_power_down(data: *mut c_void) {
    static void cs40l50_dsp_power_down(void *data)
    {
    cs_dsp_power_down(data);
    }
#[no_mangle]
unsafe extern "C" fn cs40l50_dsp_stop(data: *mut c_void) {
    static void cs40l50_dsp_stop(void *data)
    {
    cs_dsp_stop(data);
    }
#[no_mangle]
unsafe extern "C" fn cs40l50_dsp_bringup(bin: *const firmware, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_request_firmware(fw: *const firmware, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_hw_err(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_dsp_queue(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_irq_init(cs40l50: *mut cs40l50) -> c_int {
...
// Handle DSP and hardware interrupts separately
    ret = devm_request_threaded_irq(cs40l50.dev, virq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn cs40l50_get_model(cs40l50: *mut cs40l50) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_pm_runtime_setup(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs40l50_probe(cs40l50: *mut cs40l50) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cs40l50_remove(cs40l50: *mut cs40l50) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs40l50_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(cs40l50_runtime_suspend, cs40l50_runtime_resume, core::ptr::null_mut())
    };
