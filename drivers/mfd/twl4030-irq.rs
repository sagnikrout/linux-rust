...
//! Source: drivers/mfd/twl4030-irq.c
#![no_std]
...
//
pub const TWL4030_CORE_NR_IRQS: c_int = 8;
pub const TWL4030_PWR_NR_IRQS: c_int = 8;
// PIH register offsets
pub const REG_PIH_ISR_P1: c_uint = 0x01;
pub const REG_PIH_ISR_P2: c_uint = 0x02;
pub const REG_PIH_SIR: c_uint = 0x03	/* for testing */;
...
pub struct sih {
    pub name: [c_char; 8],
    pub /: *mut *mut u8 module; / module id,
    pub /: *mut *mut u8 control_offset; / for SIH_CTRL,
    pub set_cor: bool,
    pub /: *mut *mut u8 bits; / valid in isr/imr,
    pub /: *mut *mut u8 bytes_ixr; / bytelen of ISR/IMR/SIR,
    pub edr_offset: u8,
    pub /: *mut *mut u8 bytes_edr; / bytelen of EDR,
    pub /: *mut *mut u8 irq_lines; / number of supported irq lines,
// SIR ignored -- set interrupt, for testing only
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sih_irq_data {
    pub isr_offset: u8,
    pub imr_offset: u8,
    pub mask: [}; 2],
// + 2 bytes padding
...
//
#[no_mangle]
unsafe extern "C" fn handle_twl4030_pih(irq: c_int, devid: *mut c_void) -> irqreturn_t {
    ...
    while (pih_isr) {
    let mut pending: c_ulong = __ffs(pih_isr);
    unsigned int	irq;
    pih_isr &= ~BIT(pending);
...
//
#[no_mangle]
unsafe extern "C" fn twl4030_init_sih_modules(line: unsigned) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn activate_irq(irq: c_int) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sih_agent {
    pub irq_base: c_int,
    pub sih: *const sih,
    pub imr: u32,
    pub imr_change_pending: bool,
    pub edge_change: u32,
    pub irq_lock: mutex,
...
//
#[no_mangle]
unsafe extern "C" fn twl4030_sih_mask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn twl4030_sih_unmask(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn twl4030_sih_set_type(data: *mut irq_data, trigger: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_sih_bus_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn twl4030_sih_bus_sync_unlock(data: *mut irq_data) {
...
// Modify only the bits we know must change
    while (edge_change) {
    let mut i: c_int = fls(edge_change) - 1;
    let mut byte: c_int = i >> 2;
    let mut off: c_int = (i & 0x3) * 2;
    unsigned int	type;
    bytes[byte] &= ~(0x03 << off);
...
// ----------------------------------------------------------------------
#[no_mangle]
pub unsafe extern "C" fn sih_read_isr(sih: *const sih) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn handle_twl4030_sih(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn twl4030_sih_setup(dev: *mut device, module: c_int, irq_base: c_int) -> c_int {
    int twl4030_sih_setup(struct device *dev, int module, int irq_base)
    {
    int			sih_mod;
    const struct sih	*sih = core::ptr::null_mut();
...
// replace generic PIH handler (handle_simple_irq)
    ...
    status = request_threaded_irq(irq, core::ptr::null_mut(), handle_twl4030_sih,
    IRQF_EARLY_RESUME | IRQF_ONESHOT,
    agent.irq_name ?: sih.name, core::ptr::null_mut());
...
pub const twl_irq_line: c_int = 0;
#[no_mangle]
pub unsafe extern "C" fn twl4030_init_irq(dev: *mut device, irq_num: c_int) -> c_int {
...
// install an irq handler to demultiplex the TWL4030 interrupt
    status = request_threaded_irq(irq_num, core::ptr::null_mut(), handle_twl4030_pih,
    IRQF_ONESHOT,
    "TWL4030-PIH", core::ptr::null_mut());
    if (status < 0) {
...
// clean up twl4030_sih_setup
    ...
    irq_set_chip_and_handler(i, core::ptr::null_mut(), core::ptr::null_mut());
    }
    return status;
    }
#[no_mangle]
pub unsafe extern "C" fn twl4030_exit_irq() {
...
#[no_mangle]
pub unsafe extern "C" fn twl4030_init_chip_irq(chip: *const c_char) -> c_int {
