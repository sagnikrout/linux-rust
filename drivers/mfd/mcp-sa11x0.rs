...
//! Source: drivers/mfd/mcp-sa11x0.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mcp_sa11x0_enable(mcp: *mut mcp) {
...
#[no_mangle]
unsafe extern "C" fn mcp_sa11x0_disable(mcp: *mut mcp) {
...
#[no_mangle]
unsafe extern "C" fn mcp_sa11x0_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp_sa11x0_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mcp_sa11x0_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp_sa11x0_resume(dev: *mut device) -> c_int {
