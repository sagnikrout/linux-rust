...
//! Source: drivers/mfd/cs47l15-tables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cs47l15_patch(madera: *mut madera) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l15_is_adsp_memory(dev: *mut device, reg: c_uint) -> bool {
