...
//! Source: drivers/mfd/wm5102-tables.c
#![no_std]
...
pub const WM5102_NUM_AOD_ISR: c_int = 2;
pub const WM5102_NUM_ISR: c_int = 5;
...
#[no_mangle]
pub unsafe extern "C" fn wm5102_patch(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm5102_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm5102_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
pub const WM5102_MAX_REGISTER: c_uint = 0x1a9800;
