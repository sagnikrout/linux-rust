...
pub const RICOH_ONOFFSEL_REG: c_uint = 0x10;
pub const RICOH_SWCTL_REG: c_uint = 0x5E;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct deepsleep_control_data {
    pub reg_add: u8,
    pub ds_pos_bit: u8,
}
...
#[no_mangle]
unsafe extern "C" fn volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rc5t583_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
// Still continue with warning, if irq init fails
    ...
    ARRAY_SIZE(rc5t583_subdevs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn rc5t583_i2c_init() -> int __init {
