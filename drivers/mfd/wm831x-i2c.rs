...
//! Source: drivers/mfd/wm831x-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wm831x_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_i2c_poweroff(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_i2c_init() -> int __init {
