...
//! Source: drivers/mfd/mt6397-irq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mt6397_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mt6397_irq_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mt6397_irq_disable(data: *mut irq_data) {
    static void mt6397_irq_disable(struct irq_data *data)
    {
    struct mt6397_chip *mt6397 = irq_data_get_irq_chip_data(data);
    let mut shift: c_int = data.hwirq & 0xf;
    let mut reg: c_int = data.hwirq >> 4;
    mt6397.irq_masks_cur[reg] &= ~BIT(shift);
    }
#[no_mangle]
unsafe extern "C" fn mt6397_irq_enable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mt6397_irq_set_wake(irq_data: *mut irq_data, on: c_uint) -> c_int {
    static int mt6397_irq_set_wake(struct irq_data *irq_data, unsigned int on)
    {
    struct mt6397_chip *mt6397 = irq_data_get_irq_chip_data(irq_data);
    let mut shift: c_int = irq_data.hwirq & 0xf;
    let mut reg: c_int = irq_data.hwirq >> 4;
    if (on)
...
#[no_mangle]
unsafe extern "C" fn mt6397_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn mt6397_irq_init(chip: *mut mt6397_chip) -> c_int {
...
// Mask all interrupt sources
    ...
    ret = devm_request_threaded_irq(chip.dev, chip.irq, core::ptr::null_mut(),
