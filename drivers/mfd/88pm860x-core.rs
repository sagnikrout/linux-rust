...
//! Source: drivers/mfd/88pm860x-core.c
#![no_std]
...
pub const INT_STATUS_NUM: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pm860x_irq_data {
    pub reg: c_int,
    pub mask_reg: c_int,
    pub /: *mut *mut int enable; / enable or not,
    pub /: *mut *mut int offs; / bit offset in mask register,
}
...
#[no_mangle]
unsafe extern "C" fn pm860x_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t pm860x_irq(int irq, void *data)
    {
    struct pm860x_chip *chip = data;
    struct pm860x_irq_data *irq_data;
    struct i2c_client *i2c;
    let mut read_reg: c_int = -1, value = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn pm860x_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pm860x_irq_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pm860x_irq_enable(data: *mut irq_data) {
    static void pm860x_irq_enable(struct irq_data *data)
    {
    pm860x_irqs[data.hwirq].enable = pm860x_irqs[data.hwirq].offs;
    }
#[no_mangle]
unsafe extern "C" fn pm860x_irq_disable(data: *mut irq_data) {
    ...
    let mut flags: c_ulong = IRQF_TRIGGER_FALLING | IRQF_ONESHOT;
...
// clear interrupt status by read
    ...
    if (!chip.core_irq)
    goto out;
    ret = request_threaded_irq(chip.core_irq, core::ptr::null_mut(), pm860x_irq,
...
#[no_mangle]
unsafe extern "C" fn device_irq_exit(chip: *mut pm860x_chip) {
...
#[no_mangle]
pub unsafe extern "C" fn pm8606_osc_enable(chip: *mut pm860x_chip, client: c_ushort) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pm8606_osc_disable(chip: *mut pm860x_chip, client: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_osc_init(i2c: *mut i2c_client) {
...
// Disable Internal Oscillator
    ...
    ARRAY_SIZE(bk_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret < 0)
    ...
    ARRAY_SIZE(led_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret < 0) {
    ...
    ARRAY_SIZE(reg_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret < 0) {
    ...
    chip.irq_base, core::ptr::null_mut());
    if (ret < 0)
    ...
    &battery_resources[0], chip.irq_base, core::ptr::null_mut());
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn pm860x_device_exit(chip: *mut pm860x_chip) {
...
#[no_mangle]
unsafe extern "C" fn verify_addr(i2c: *mut i2c_client) -> c_int {
    static int verify_addr(struct i2c_client *i2c)
    {
    unsigned short addr_8607[] = {0x30, 0x34};
    unsigned short addr_8606[] = {0x10, 0x11};
    int size, i;
    if (i2c == core::ptr::null_mut())
    return 0;
...
#[no_mangle]
unsafe extern "C" fn pm860x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm860x_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn pm860x_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm860x_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm860x_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pm860x_i2c_exit() -> void __exit {
