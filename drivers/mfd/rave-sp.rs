...
//
pub const RAVE_SP_STX: c_uint = 0x02;
pub const RAVE_SP_ETX: c_uint = 0x03;
pub const RAVE_SP_DLE: c_uint = 0x10;
pub const RAVE_SP_MAX_DATA_SIZE: c_int = 64;
pub const RAVE_SP_CHECKSUM_8B2C: c_int = 1;
pub const RAVE_SP_CHECKSUM_CCITT: c_int = 2;
...
pub const RAVE_SP_STX_ETX_SIZE: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rave_sp_deframer {
    pub state: enum rave_sp_deframer_state,
    pub data: [c_uchar; RAVE_SP_RX_BUFFER_SIZE],
    pub length: usize,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rave_sp_checksum {
    pub length: usize,
    pub ): *const *const *const void (subroutine)(u8 , size_t, u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rave_sp_version {
    pub hardware: u8,
    pub major: __le16,
    pub minor: u8,
    pub letter: [u8; 2],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rave_sp_status {
    pub bootloader_version: rave_sp_version,
    pub firmware_version: rave_sp_version,
    pub rdu_eeprom_flag: u16,
    pub dds_eeprom_flag: u16,
    pub pic_flag: u8,
    pub orientation: u8,
    pub etc: u32,
    pub temp: [i16; 2],
    pub backlight_current: [u8; 3],
    pub dip_switch: u8,
    pub host_interrupt: u8,
    pub voltage_28: u16,
    pub i2c_device_status: u8,
    pub power_status: u8,
    pub general_status: u8,
    pub deprecated1: u8,
    pub power_led_status: u8,
    pub deprecated2: u8,
    pub periph_power_shutoff: u8,
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rave_sp_variant_cmds {
    pub rave_sp_command): *mut *mut int (translate)(enum,
    pub ): *mut *mut *mut int (get_status)(struct rave_sp sp, struct rave_sp_status,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rave_sp_variant {
    pub checksum: *const rave_sp_checksum,
    pub cmd: rave_sp_variant_cmds,
}
...
pub struct rave_sp {
    ...
    pub deframer: rave_sp_deframer,
    pub ackid: core::sync::atomic::AtomicI32,
    pub bus_lock: mutex,
    pub reply_lock: mutex,
    pub reply: *mut rave_sp_reply,
    pub variant: *const rave_sp_variant,
    pub event_notifier_list: blocking_notifier_head,
    pub part_number_firmware: *const c_char,
    pub part_number_bootloader: *const c_char,
}

#[no_mangle]
unsafe extern "C" fn rave_sp_id_is_event(code: u8) -> bool {
    static bool rave_sp_id_is_event(u8 code)
    {
    return (code & 0xF0) == RAVE_SP_EVNT_BASE;
    }
#[no_mangle]
unsafe extern "C" fn rave_sp_unregister_event_notifier(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn csum_8b2c(buf: *const u8, size: usize, crc: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn csum_ccitt(buf: *const u8, size: usize, crc: *mut u8) {
    static void csum_ccitt(const u8 *buf, size_t size, u8 *crc)
    {
    let mut calculated: u16 = crc_itu_t(0xffff, buf, size);
//
...
#[no_mangle]
unsafe extern "C" fn rave_sp_write(sp: *mut rave_sp, data: *const u8, data_size: u8) -> c_int {
    static int rave_sp_write(struct rave_sp *sp, const u8 *data, u8 data_size)
    {
    let mut checksum_length: usize = sp.variant.checksum.length;
...
#[no_mangle]
unsafe extern "C" fn rave_sp_reply_code(command: u8) -> u8 {
...
//
    ...
    blocking_notifier_call_chain(&sp.event_notifier_list, action, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn rave_sp_rdu1_cmd_translate(command: enum rave_sp_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_rdu2_cmd_translate(command: enum rave_sp_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_default_cmd_translate(command: enum rave_sp_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_get_status(sp: *mut rave_sp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rave_sp_probe(serdev: *mut serdev_device) -> c_int {
