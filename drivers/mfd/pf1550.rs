...
#[no_mangle]
unsafe extern "C" fn pf1550_i2c_probe(i2c: *mut i2c_client) -> c_int {
    ...
    let mut reg_data: c_uint = 0, otp_data = 0;
...
// Add regulator
    ...
    ret = devm_mfd_add_devices(pf1550.dev, PLATFORM_DEVID_NONE, regulator, 1, core::ptr::null_mut(), 0, domain);
    if (ret)
    return ret;
// Add onkey
    ...
    ret = devm_mfd_add_devices(pf1550.dev, PLATFORM_DEVID_NONE, onkey, 1, core::ptr::null_mut(), 0, domain);
    if (ret)
    return ret;
// Add battery charger
    ...
    return devm_mfd_add_devices(pf1550.dev, PLATFORM_DEVID_NONE, charger, 1, core::ptr::null_mut(), 0, domain);
    }
#[no_mangle]
unsafe extern "C" fn pf1550_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf1550_resume(dev: *mut device) -> c_int {
