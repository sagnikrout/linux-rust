...
//! Source: drivers/mfd/rohm-bd71828.c
#![no_std]
...
//
pub const BD72720_SECONDARY_I2C_SLAVE: c_uint = 0x4c;
pub const BD72720_SECONDARY_I2C_REG_OFFSET: c_uint = 0x100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd72720_regmaps {
    pub map1_4b: *mut regmap,
    pub map2_4c: *mut regmap,
}
...
#[no_mangle]
unsafe extern "C" fn regmap_write_wrapper(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regmap_read_wrapper(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd71828_power_off() {
...
#[no_mangle]
unsafe extern "C" fn bd71828_remove_poweroff(data: *mut c_void) {
    ...
    return maps.map2_4c;
    return devm_regmap_init(&i2c.dev, core::ptr::null_mut(), maps, &bd72720_wrapper_map_config);
    }
#[no_mangle]
unsafe extern "C" fn bd71828_i2c_probe(i2c: *mut i2c_client) -> c_int {
    ...
    int button_irq;
    int clkmode_reg;
    let mut main_lvl_mask_reg: c_int = 0, main_lvl_val = 0;
    if (!i2c.irq) {
...
//
    ...
    core::ptr::null_mut(), 0, irq_domain);
    if (ret)
