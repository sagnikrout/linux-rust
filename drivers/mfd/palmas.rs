...
// INT4 IRQs
    ...
    let mut preq_mask_bit: c_int = 0;
    let mut reg_add: c_int = 0;
    int bit_pos, ret;
...
#[no_mangle]
unsafe extern "C" fn palmas_power_off() {
...
#[no_mangle]
unsafe extern "C" fn palmas_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_i2c_remove(i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn palmas_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn palmas_i2c_exit() -> void __exit {
