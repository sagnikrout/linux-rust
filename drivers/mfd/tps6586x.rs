...
pub const TPS6586X_INT_ACK1: c_uint = 0xb5;
pub const TPS6586X_INT_ACK2: c_uint = 0xb6;
pub const TPS6586X_INT_ACK3: c_uint = 0xb7;
pub const TPS6586X_INT_ACK4: c_uint = 0xb8;
// interrupt mask registers
pub const TPS6586X_INT_MASK1: c_uint = 0xb0;
pub const TPS6586X_INT_MASK2: c_uint = 0xb1;
pub const TPS6586X_INT_MASK3: c_uint = 0xb2;
pub const TPS6586X_INT_MASK4: c_uint = 0xb3;
pub const TPS6586X_INT_MASK5: c_uint = 0xb4;
// device id
pub const TPS6586X_VERSIONCRC: c_uint = 0xcd;
// Maximum register

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6586x_irq_data {
    pub mask_reg: u8,
    pub mask_mask: u8,
}
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_write(dev: *mut device, reg: c_int, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_writes(dev: *mut device, reg: c_int, len: c_int, val: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_read(dev: *mut device, reg: c_int, val: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_reads(dev: *mut device, reg: c_int, len: c_int, val: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_set_bits(dev: *mut device, reg: c_int, bit_mask: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_clr_bits(dev: *mut device, reg: c_int, bit_mask: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_update(dev: *mut device, reg: c_int, val: u8, mask: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_irq_get_virq(dev: *mut device, irq: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6586x_get_version(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_remove_subdevs(tps6586x: *mut tps6586x) -> c_int {
    static int tps6586x_remove_subdevs(struct tps6586x *tps6586x)
    {
    return device_for_each_child(tps6586x.dev, core::ptr::null_mut(), __remove_subdev);
    }
#[no_mangle]
unsafe extern "C" fn tps6586x_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_irq_enable(irq_data: *mut irq_data) {
    static void tps6586x_irq_enable(struct irq_data *irq_data)
    {
    struct tps6586x *tps6586x = irq_data_get_irq_chip_data(irq_data);
    let mut __irq: c_uint = irq_data.hwirq;
    const struct tps6586x_irq_data *data = &tps6586x_irqs[__irq];
    tps6586x.mask_reg[data.mask_reg] &= ~data.mask_mask;
    tps6586x.irq_en |= (1 << __irq);
    }
#[no_mangle]
unsafe extern "C" fn tps6586x_irq_disable(irq_data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_irq_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_irq_set_wake(irq_data: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    u8 tmp[4];
    int new_irq_base;
    let mut irq_num: c_int = ARRAY_SIZE(tps6586x_irqs);
    tps6586x.irq = irq;
    ...
    ret = request_threaded_irq(irq, core::ptr::null_mut(), tps6586x_irq, IRQF_ONESHOT,
    "tps6586x", tps6586x);
    if (!ret)
    ...
    pdata.num_subdevs = 0;
    pdata.subdevs = core::ptr::null_mut();
    pdata.gpio_base = -1;
    pdata.irq_base = -1;
...
#[no_mangle]
unsafe extern "C" fn tps6586x_power_off_handler(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_restart_handler(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_print_version(client: *mut i2c_client, version: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_i2c_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), 0, tps6586x.irq_domain);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_i2c_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_i2c_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_i2c_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps6586x_exit() -> void __exit {
