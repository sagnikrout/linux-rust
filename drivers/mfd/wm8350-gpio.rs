...
//! Source: drivers/mfd/wm8350-gpio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn gpio_set_dir(wm8350: *mut wm8350, gpio: c_int, dir: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_gpio_set_debounce(wm8350: *mut wm8350, gpio: c_int, db: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_set_func(wm8350: *mut wm8350, gpio: c_int, func: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_set_pull_up(wm8350: *mut wm8350, gpio: c_int, up: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_set_pull_down(wm8350: *mut wm8350, gpio: c_int, down: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_set_polarity(wm8350: *mut wm8350, gpio: c_int, pol: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_set_invert(wm8350: *mut wm8350, gpio: c_int, invert: c_int) -> c_int {
