...
//! Source: drivers/mfd/intel-m10-bmc-spi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn check_m10bmc_version(ddata: *mut intel_m10bmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_m10_bmc_spi_probe(spi: *mut spi_device) -> c_int {
