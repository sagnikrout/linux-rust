...
//! Source: drivers/mfd/intel_soc_pmic_bxtwc.c
#![no_std]
...
pub const REG_ADDR_SHIFT: c_int = 8;

// Interrupt Status Registers
pub const BXTWC_IRQLVL1: c_uint = 0x4E02;
pub const BXTWC_PWRBTNIRQ: c_uint = 0x4E03;
pub const BXTWC_THRM0IRQ: c_uint = 0x4E04;
pub const BXTWC_THRM1IRQ: c_uint = 0x4E05;
pub const BXTWC_THRM2IRQ: c_uint = 0x4E06;
pub const BXTWC_BCUIRQ: c_uint = 0x4E07;
pub const BXTWC_ADCIRQ: c_uint = 0x4E08;
pub const BXTWC_CHGR0IRQ: c_uint = 0x4E09;
pub const BXTWC_CHGR1IRQ: c_uint = 0x4E0A;
pub const BXTWC_GPIOIRQ0: c_uint = 0x4E0B;
pub const BXTWC_GPIOIRQ1: c_uint = 0x4E0C;
pub const BXTWC_CRITIRQ: c_uint = 0x4E0D;
pub const BXTWC_TMUIRQ: c_uint = 0x4FB6;
// Interrupt MASK Registers
pub const BXTWC_MIRQLVL1: c_uint = 0x4E0E;

pub const BXTWC_MPWRBTNIRQ: c_uint = 0x4E0F;
pub const BXTWC_MTHRM0IRQ: c_uint = 0x4E12;
pub const BXTWC_MTHRM1IRQ: c_uint = 0x4E13;
pub const BXTWC_MTHRM2IRQ: c_uint = 0x4E14;
pub const BXTWC_MBCUIRQ: c_uint = 0x4E15;
pub const BXTWC_MADCIRQ: c_uint = 0x4E16;
pub const BXTWC_MCHGR0IRQ: c_uint = 0x4E17;
pub const BXTWC_MCHGR1IRQ: c_uint = 0x4E18;
pub const BXTWC_MGPIO0IRQ: c_uint = 0x4E19;
pub const BXTWC_MGPIO1IRQ: c_uint = 0x4E1A;
pub const BXTWC_MCRITIRQ: c_uint = 0x4E1B;
pub const BXTWC_MTMUIRQ: c_uint = 0x4FB7;
// Whiskey Cove PMIC share same ACPI ID between different platforms
pub const BROXTON_PMIC_WC_HRV: c_int = 4;
pub const PMC_PMIC_ACCESS: c_uint = 0xFF;
pub const PMC_PMIC_READ: c_uint = 0x0;
pub const PMC_PMIC_WRITE: c_uint = 0x1;
    enum bxtwc_irqs {
...
// sysfs interfaces to r/w PMIC registers, required by initial script
    ...
    return devm_mfd_add_devices(dev, PLATFORM_DEVID_NONE, cells, n_devs, core::ptr::null_mut(), 0, domain);
    }
#[no_mangle]
unsafe extern "C" fn bxtwc_probe(pdev: *mut platform_device) -> c_int {
    ...
    status = acpi_evaluate_integer(ACPI_HANDLE(dev), "_HRV", core::ptr::null_mut(), &hrv);
    ...
    if (!pmic.scu)
    return -EPROBE_DEFER;
    pmic.regmap = devm_regmap_init(dev, core::ptr::null_mut(), pmic, &bxtwc_regmap_config);
...
#[no_mangle]
unsafe extern "C" fn bxtwc_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn bxtwc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bxtwc_resume(dev: *mut device) -> c_int {
