...
//! Source: drivers/mfd/si476x-i2c.c
#![no_std]
...
pub const SI476X_MAX_IO_ERRORS: c_int = 10;
pub const SI476X_DRIVER_RDS_FIFO_DEPTH: c_int = 128;
//
...
//
#[no_mangle]
unsafe extern "C" fn si476x_core_config_pinmux(core: *mut si476x_core) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn si476x_core_schedule_polling_work(core: *mut si476x_core) {
...
//
#[no_mangle]
pub unsafe extern "C" fn si476x_core_start(core: *mut si476x_core, soft: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn si476x_core_stop(core: *mut si476x_core, soft: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn si476x_core_report_drainer_stop(core: *mut si476x_core) {
...
//
#[no_mangle]
pub unsafe extern "C" fn si476x_core_start_rds_drainer_once(core: *mut si476x_core) {
...
//
#[no_mangle]
unsafe extern "C" fn si476x_core_drain_rds_fifo(work: *mut work_struct) {
    ...
    if (!err) {
    let mut i: c_int = report.rdsfifoused;
...
//
#[no_mangle]
unsafe extern "C" fn si476x_core_pronounce_dead(core: *mut si476x_core) {
...
//
#[no_mangle]
unsafe extern "C" fn si476x_core_get_status(core: *mut si476x_core) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn si476x_core_get_and_signal_status(core: *mut si476x_core) {
    static void si476x_core_get_and_signal_status(struct si476x_core *core)
    {
    let mut status: c_int = si476x_core_get_status(core);
    if (status < 0) {
...
#[no_mangle]
unsafe extern "C" fn si476x_core_poll_loop(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn si476x_core_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn si476x_core_get_revision_info(core: *mut si476x_core) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn si476x_core_has_am(core: *mut si476x_core) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn si476x_core_has_diversity(core: *mut si476x_core) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn si476x_core_is_a_secondary_tuner(core: *mut si476x_core) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn si476x_core_is_a_primary_tuner(core: *mut si476x_core) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn si476x_core_is_in_am_receiver_mode(core: *mut si476x_core) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn si476x_core_is_powered_up(core: *mut si476x_core) -> bool {
...
#[no_mangle]
unsafe extern "C" fn si476x_core_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si476x_core_remove(client: *mut i2c_client) {
