...
//! Source: drivers/mfd/cs47l85-tables.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cs47l85_patch(madera: *mut madera) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l85_is_adsp_memory(reg: c_uint) -> bool {
