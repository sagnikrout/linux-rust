...
//! Source: drivers/mfd/wm8998-tables.c
#![no_std]
...
pub const WM8998_NUM_AOD_ISR: c_int = 2;
pub const WM8998_NUM_ISR: c_int = 5;
...
#[no_mangle]
pub unsafe extern "C" fn wm8998_patch(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8998_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm8998_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
pub const WM8998_MAX_REGISTER: c_uint = 0x31ff;
