...
#[no_mangle]
unsafe extern "C" fn max77693_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
// Unmask interrupts from all blocks in interrupt source register
    ...
    ARRAY_SIZE(max77693_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret < 0)
    goto err_mfd;
    return ret;
    err_mfd:
...
#[no_mangle]
unsafe extern "C" fn max77693_i2c_remove(i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn max77693_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_resume(dev: *mut device) -> c_int {
