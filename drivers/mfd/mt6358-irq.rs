...
//! Source: drivers/mfd/mt6358-irq.c
#![no_std]
...
pub const MTK_PMIC_REG_WIDTH: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn pmic_irq_enable(data: *mut irq_data) {
    static void pmic_irq_enable(struct irq_data *data)
    {
    let mut hwirq: c_uint = irqd_to_hwirq(data);
    struct mt6397_chip *chip = irq_data_get_irq_chip_data(data);
    struct pmic_irq_data *irqd = chip.irq_data;
    irqd.enable_hwirq[hwirq] = true;
    }
#[no_mangle]
unsafe extern "C" fn pmic_irq_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pmic_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn pmic_irq_sync_unlock(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn mt6358_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn mt6358_irq_init(chip: *mut mt6397_chip) -> c_int {
