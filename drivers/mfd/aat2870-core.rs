...
//! Source: drivers/mfd/aat2870-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __aat2870_read(aat2870: *mut aat2870_data, addr: u8, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __aat2870_write(aat2870: *mut aat2870_data, addr: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aat2870_read(aat2870: *mut aat2870_data, addr: u8, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aat2870_write(aat2870: *mut aat2870_data, addr: u8, val: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aat2870_enable(aat2870: *mut aat2870_data) {
...
#[no_mangle]
pub unsafe extern "C" fn aat2870_disable(aat2870: *mut aat2870_data) {
...
#[no_mangle]
unsafe extern "C" fn aat2870_dump_reg(aat2870: *mut aat2870_data, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn aat2870_init_debugfs(aat2870: *mut aat2870_data) {
...
#[no_mangle]
pub unsafe extern "C" fn aat2870_init_debugfs(aat2870: *mut aat2870_data) {
    static inline void aat2870_init_debugfs(struct aat2870_data *aat2870)
    {
    }

#[no_mangle]
unsafe extern "C" fn aat2870_i2c_probe(client: *mut i2c_client) -> c_int {
    ...
    ARRAY_SIZE(aat2870_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret != 0) {
...
#[no_mangle]
unsafe extern "C" fn aat2870_i2c_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aat2870_i2c_resume(dev: *mut device) -> c_int {
    static int aat2870_i2c_resume(struct device *dev)
    {
    struct i2c_client *client = to_i2c_client(dev);
    struct aat2870_data *aat2870 = i2c_get_clientdata(client);
    struct aat2870_register *reg = core::ptr::null_mut();
    int i;
    aat2870_enable(aat2870);
// restore registers
...
#[no_mangle]
unsafe extern "C" fn aat2870_init() -> int __init {
