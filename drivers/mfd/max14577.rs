...
#[no_mangle]
unsafe extern "C" fn max14577_muic_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max77836_muic_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn max14577_print_dev_type(max14577: *mut max14577) {
...
//
#[no_mangle]
unsafe extern "C" fn max77836_init(max14577: *mut max14577) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max77836_remove(max14577: *mut max14577) {
...
#[no_mangle]
unsafe extern "C" fn max14577_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
// Max77836 specific initialization code (additional regmap)
    ...
    mfd_devs_size, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret < 0)
    goto err_mfd;
...
#[no_mangle]
unsafe extern "C" fn max14577_i2c_remove(i2c: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn max14577_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max14577_i2c_exit() -> void __exit {
