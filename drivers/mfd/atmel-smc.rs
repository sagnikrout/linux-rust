...
//! Source: drivers/mfd/atmel-smc.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn atmel_smc_cs_conf_init(conf: *mut atmel_smc_cs_conf) {
...
//
    ...
    {
    let mut lsbmask: c_uint = GENMASK(msbpos - 1, 0);
    let mut msbmask: c_uint = GENMASK(msbwidth - 1, 0);
...
//
    ...
    { .compatible = "atmel,at91sam9260-smc", .data = core::ptr::null_mut() },
