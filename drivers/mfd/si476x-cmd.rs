...
//! Source: drivers/mfd/si476x-cmd.c
#![no_std]
...
pub const CMD_POWER_UP: c_uint = 0x01;
pub const CMD_POWER_UP_A10_NRESP: c_int = 1;
pub const CMD_POWER_UP_A10_NARGS: c_int = 5;
pub const CMD_POWER_UP_A20_NRESP: c_int = 1;
pub const CMD_POWER_UP_A20_NARGS: c_int = 5;
pub const POWER_UP_DELAY_MS: c_int = 110;
pub const CMD_POWER_DOWN: c_uint = 0x11;
pub const CMD_POWER_DOWN_A10_NRESP: c_int = 1;
pub const CMD_POWER_DOWN_A20_NRESP: c_int = 1;
pub const CMD_POWER_DOWN_A20_NARGS: c_int = 1;
pub const CMD_FUNC_INFO: c_uint = 0x12;
pub const CMD_FUNC_INFO_NRESP: c_int = 7;
pub const CMD_SET_PROPERTY: c_uint = 0x13;
pub const CMD_SET_PROPERTY_NARGS: c_int = 5;
pub const CMD_SET_PROPERTY_NRESP: c_int = 1;
pub const CMD_GET_PROPERTY: c_uint = 0x14;
pub const CMD_GET_PROPERTY_NARGS: c_int = 3;
pub const CMD_GET_PROPERTY_NRESP: c_int = 4;
pub const CMD_AGC_STATUS: c_uint = 0x17;
pub const CMD_AGC_STATUS_NRESP_A10: c_int = 2;
pub const CMD_AGC_STATUS_NRESP_A20: c_int = 6;

pub const CMD_DIG_AUDIO_PIN_CFG: c_uint = 0x18;
pub const CMD_DIG_AUDIO_PIN_CFG_NARGS: c_int = 4;
pub const CMD_DIG_AUDIO_PIN_CFG_NRESP: c_int = 5;
pub const CMD_ZIF_PIN_CFG: c_uint = 0x19;
pub const CMD_ZIF_PIN_CFG_NARGS: c_int = 4;
pub const CMD_ZIF_PIN_CFG_NRESP: c_int = 5;
pub const CMD_IC_LINK_GPO_CTL_PIN_CFG: c_uint = 0x1A;
pub const CMD_IC_LINK_GPO_CTL_PIN_CFG_NARGS: c_int = 4;
pub const CMD_IC_LINK_GPO_CTL_PIN_CFG_NRESP: c_int = 5;
pub const CMD_ANA_AUDIO_PIN_CFG: c_uint = 0x1B;
pub const CMD_ANA_AUDIO_PIN_CFG_NARGS: c_int = 1;
pub const CMD_ANA_AUDIO_PIN_CFG_NRESP: c_int = 2;
pub const CMD_INTB_PIN_CFG: c_uint = 0x1C;
pub const CMD_INTB_PIN_CFG_NARGS: c_int = 2;
pub const CMD_INTB_PIN_CFG_A10_NRESP: c_int = 6;
pub const CMD_INTB_PIN_CFG_A20_NRESP: c_int = 3;
pub const CMD_FM_TUNE_FREQ: c_uint = 0x30;
pub const CMD_FM_TUNE_FREQ_A10_NARGS: c_int = 5;
pub const CMD_FM_TUNE_FREQ_A20_NARGS: c_int = 3;
pub const CMD_FM_TUNE_FREQ_NRESP: c_int = 1;
pub const CMD_FM_RSQ_STATUS: c_uint = 0x32;
pub const CMD_FM_RSQ_STATUS_A10_NARGS: c_int = 1;
pub const CMD_FM_RSQ_STATUS_A10_NRESP: c_int = 17;
pub const CMD_FM_RSQ_STATUS_A30_NARGS: c_int = 1;
pub const CMD_FM_RSQ_STATUS_A30_NRESP: c_int = 23;
pub const CMD_FM_SEEK_START: c_uint = 0x31;
pub const CMD_FM_SEEK_START_NARGS: c_int = 1;
pub const CMD_FM_SEEK_START_NRESP: c_int = 1;
pub const CMD_FM_RDS_STATUS: c_uint = 0x36;
pub const CMD_FM_RDS_STATUS_NARGS: c_int = 1;
pub const CMD_FM_RDS_STATUS_NRESP: c_int = 16;
pub const CMD_FM_RDS_BLOCKCOUNT: c_uint = 0x37;
pub const CMD_FM_RDS_BLOCKCOUNT_NARGS: c_int = 1;
pub const CMD_FM_RDS_BLOCKCOUNT_NRESP: c_int = 8;
pub const CMD_FM_PHASE_DIVERSITY: c_uint = 0x38;
pub const CMD_FM_PHASE_DIVERSITY_NARGS: c_int = 1;
pub const CMD_FM_PHASE_DIVERSITY_NRESP: c_int = 1;
pub const CMD_FM_PHASE_DIV_STATUS: c_uint = 0x39;
pub const CMD_FM_PHASE_DIV_STATUS_NRESP: c_int = 2;
pub const CMD_AM_TUNE_FREQ: c_uint = 0x40;
pub const CMD_AM_TUNE_FREQ_NARGS: c_int = 3;
pub const CMD_AM_TUNE_FREQ_NRESP: c_int = 1;
pub const CMD_AM_RSQ_STATUS: c_uint = 0x42;
pub const CMD_AM_RSQ_STATUS_NARGS: c_int = 1;
pub const CMD_AM_RSQ_STATUS_NRESP: c_int = 13;
pub const CMD_AM_SEEK_START: c_uint = 0x41;
pub const CMD_AM_SEEK_START_NARGS: c_int = 1;
pub const CMD_AM_SEEK_START_NRESP: c_int = 1;
pub const CMD_AM_ACF_STATUS: c_uint = 0x45;
pub const CMD_AM_ACF_STATUS_NRESP: c_int = 6;
pub const CMD_AM_ACF_STATUS_NARGS: c_int = 1;
pub const CMD_FM_ACF_STATUS: c_uint = 0x35;
pub const CMD_FM_ACF_STATUS_NRESP: c_int = 8;
pub const CMD_FM_ACF_STATUS_NARGS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn si476x_core_parse_and_nag_about_error(core: *mut si476x_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn si476x_cmd_clear_stc(core: *mut si476x_core) -> c_int {
    ...
    err = si476x_core_cmd_fm_rsq_status(core, &args, core::ptr::null_mut());
    break;
    case SI476X_FUNC_AM_RECEIVER:
    err = si476x_core_cmd_am_rsq_status(core, &args, core::ptr::null_mut());
    break;
    default:
    err = -EINVAL;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn si476x_core_cmd_get_property(core: *mut si476x_core, property: u16) -> c_int {
...
//
    if (err < 0 || report == core::ptr::null_mut())
    return err;
...
//
#[no_mangle]
pub unsafe extern "C" fn si476x_core_cmd_fm_phase_div_status(core: *mut si476x_core) -> c_int {
...
//
    ...
    let mut intsel: bool = (core.pinmux.a1 == SI476X_A1_IRQ);
    let mut ctsen: bool = (core.client.irq != 0);
...
// zeros
    ...
    {
    let mut am_freq: c_int = tuneargs.freq;
