...
//! Source: drivers/mfd/arizona-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn arizona_clk32k_enable(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arizona_clk32k_disable(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_clkgen_err(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn arizona_underclocked(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn arizona_overclocked(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
pub const ARIZONA_REG_POLL_DELAY_US: c_int = 7500;
#[no_mangle]
pub unsafe extern "C" fn arizona_poll_reg_delay(timeout: ktime_t) -> bool {
    ...
    {
    let mut timeout: ktime_t = ktime_add_us(ktime_get(), timeout_ms * USEC_PER_MSEC);
...
#[no_mangle]
unsafe extern "C" fn arizona_wait_for_boot(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arizona_enable_reset(arizona: *mut arizona) {
...
#[no_mangle]
unsafe extern "C" fn arizona_disable_reset(arizona: *mut arizona) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arizona_sysclk_state {
    pub fll: c_uint,
    pub sysclk: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn wm5102_apply_hardware_patch(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm5110_apply_sleep_patch(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm5102_clear_write_sequencer(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_isolate_dcvdd(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_connect_dcvdd(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_is_jack_det_active(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_runtime_suspend(dev: *mut device) -> c_int {
    static int arizona_runtime_suspend(struct device *dev)
    {
    struct arizona *arizona = dev_get_drvdata(dev);
    let mut jd_active: c_int = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn arizona_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_resume_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_of_get_core_pdata(arizona: *mut arizona) -> c_int {
...
//
    ...
    return ret;
#[no_mangle]
pub unsafe extern "C" fn if(-ENOSYS: ret != -ENOENT && ret !=) -> else {
    else if (ret != -ENOENT && ret != -ENOSYS)
    dev_err(arizona.dev, "Reset GPIO malformed: %d\n",
    ret);
    pdata.reset = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(0: pdata->gpio_defaults[i] ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn arizona_of_get_core_pdata(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arizona_dev_init(arizona: *mut arizona) -> c_int {
    ...
    int (*apply_patch)(struct arizona *) = core::ptr::null_mut();
    const struct mfd_cell *subdevs = core::ptr::null_mut();
    let mut n_subdevs: c_int = 0, ret, i;
    ...
    arizona.mclk[i] = core::ptr::null_mut();
    }
    }
    regcache_cache_only(arizona.regmap, true);
    switch (arizona.type) {
...
// Mark DCVDD as external, LDO1 driver will clear if internal
    ...
    ARRAY_SIZE(early_devs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret != 0) {
...
// Start out with /RESET low to put the chip into reset
    ...
    arizona.pdata.reset = core::ptr::null_mut();
    }
    }
    ret = regulator_bulk_enable(arizona.num_core_supplies,
    arizona.core_supplies);
...
#[no_mangle]
pub unsafe extern "C" fn arizona_dev_exit(arizona: *mut arizona) -> c_int {
