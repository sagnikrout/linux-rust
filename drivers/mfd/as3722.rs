...
pub const AS3722_DEVICE_ID: c_uint = 0x0C;
...
#[no_mangle]
unsafe extern "C" fn as3722_check_device_id(as3722: *mut as3722) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_configure_pullups(as3722: *mut as3722) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_i2c_probe(i2c: *mut i2c_client) -> c_int {
    ...
    ARRAY_SIZE(as3722_devs), core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn as3722_i2c_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn as3722_i2c_resume(dev: *mut device) -> int __maybe_unused {
