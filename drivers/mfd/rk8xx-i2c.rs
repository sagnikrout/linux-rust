...
//! Source: drivers/mfd/rk8xx-i2c.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk8xx_i2c_platform_data {
    pub regmap_cfg: *const regmap_config,
    pub variant: c_int,
}

#[no_mangle]
unsafe extern "C" fn rk801_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk806_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk808_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk816_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk817_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk8xx_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk8xx_i2c_shutdown(client: *mut i2c_client) {
