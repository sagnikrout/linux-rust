...
#[no_mangle]
unsafe extern "C" fn as3711_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn as3711_precious_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn as3711_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn as3711_i2c_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    as3711_subdevs[AS3711_REGULATOR].platform_data = core::ptr::null_mut();
    as3711_subdevs[AS3711_REGULATOR].pdata_size = 0;
    as3711_subdevs[AS3711_BACKLIGHT].platform_data = core::ptr::null_mut();
    as3711_subdevs[AS3711_BACKLIGHT].pdata_size = 0;
    }
    ret = devm_mfd_add_devices(as3711.dev, -1, as3711_subdevs,
    ARRAY_SIZE(as3711_subdevs), core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret < 0)
...
#[no_mangle]
unsafe extern "C" fn as3711_i2c_init() -> int __init {
