...
//! Source: drivers/mfd/da9063-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn da9063_clear_fault_log(da9063: *mut da9063) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn da9063_device_init(da9063: *mut da9063, irq: c_uint) -> c_int {
    ...
    core::ptr::null_mut(), da9063.irq_base, core::ptr::null_mut());
    if (ret) {
