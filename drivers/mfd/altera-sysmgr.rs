...
//! Source: drivers/mfd/altera-sysmgr.c
#![no_std]
...
//
    ...
    let mut sysmgr_base: c_ulong = (unsigned long)base;
...
#[no_mangle]
unsafe extern "C" fn sysmgr_probe(pdev: *mut platform_device) -> c_int {
    static int sysmgr_probe(struct platform_device *pdev)
    {
    struct altr_sysmgr *sysmgr;
    struct regmap *regmap;
    struct resource *res;
    let mut sysmgr_config: regmap_config = altr_sysmgr_regmap_cfg;
...
// Need physical address for SMCC call
    regmap = devm_regmap_init(dev, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn altr_sysmgr_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn altr_sysmgr_exit() -> void __exit {
