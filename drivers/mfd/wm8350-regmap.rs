...
//! Source: drivers/mfd/wm8350-regmap.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wm8350_readable(dev: *mut device, reg: c_uint) -> bool {
    static bool wm8350_readable(struct device *dev, unsigned int reg)
    {
    return wm8350_reg_io_map[reg].readable;
    }
#[no_mangle]
unsafe extern "C" fn wm8350_writeable(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wm8350_volatile(dev: *mut device, reg: c_uint) -> bool {
    static bool wm8350_volatile(struct device *dev, unsigned int reg)
    {
    return wm8350_reg_io_map[reg].vol;
    }
#[no_mangle]
unsafe extern "C" fn wm8350_precious(dev: *mut device, reg: c_uint) -> bool {
