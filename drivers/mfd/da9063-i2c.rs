...
//! Source: drivers/mfd/da9063-i2c.c
#![no_std]
...
//
pub const DA9063_REG_PAGE_SIZE: c_uint = 0x100;
pub const DA9063_REG_PAGED_ADDR_MASK: c_uint = 0xFF;
...
#[no_mangle]
unsafe extern "C" fn da9063_get_device_type(i2c: *mut i2c_client, da9063: *mut da9063) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_i2c_probe(i2c: *mut i2c_client) -> c_int {
