...
//! Source: drivers/mfd/twl4030-power.c
#![no_std]
...
//
    ...
    let mut twl4030_start_script_address: static u8 = 0x2b;
...
pub const END_OF_SCRIPT: c_uint = 0x3f;
...
//
pub const DEV_GRP_OFFSET: c_int = 0;
pub const TYPE_OFFSET: c_int = 1;
pub const REMAP_OFFSET: c_int = 2;
pub const DEDICATED_OFFSET: c_int = 3;
// Bit positions in the registers
// <RESOURCE>_DEV_GRP
pub const DEV_GRP_SHIFT: c_int = 5;

// <RESOURCE>_TYPE
pub const TYPE_SHIFT: c_int = 0;

pub const TYPE2_SHIFT: c_int = 3;

// <RESOURCE>_REMAP
pub const SLEEP_STATE_SHIFT: c_int = 0;

pub const OFF_STATE_SHIFT: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn twl4030_write_script_byte(address: u8, byte: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_config_wakeup3_sequence(address: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_config_sleep_sequence(address: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_config_warmreset_sequence(address: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_configure_resource(rconfig: *mut twl4030_resconfig) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn twl4030_remove_script(flags: u8) -> c_int {
    ...
    int err;
    int i;
    let mut address: u8 = twl4030_start_script_address;
...
#[no_mangle]
unsafe extern "C" fn twl4030_starton_mask_and_set(bitmask: u8, bitvalues: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn twl4030_power_off() {
...
#[no_mangle]
unsafe extern "C" fn twl4030_power_probe(pdev: *mut platform_device) -> c_int {
