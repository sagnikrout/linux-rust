...
//! Source: drivers/mfd/wm831x-otp.c
#![no_std]
...
// In bytes
pub const WM831X_UNIQUE_ID_LEN: c_int = 16;
// Read the unique ID from the chip into id
#[no_mangle]
unsafe extern "C" fn wm831x_unique_id_read(wm831x: *mut wm831x, id: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm831x_otp_init(wm831x: *mut wm831x) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm831x_otp_exit(wm831x: *mut wm831x) {
