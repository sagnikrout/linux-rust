...
//! Source: drivers/mfd/cs47l24-tables.c
#![no_std]
...
pub const CS47L24_NUM_ISR: c_int = 5;
...
#[no_mangle]
pub unsafe extern "C" fn cs47l24_patch(arizona: *mut arizona) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs47l24_is_adsp_memory(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs47l24_readable_register(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cs47l24_volatile_register(dev: *mut device, reg: c_uint) -> bool {
...
pub const CS47L24_MAX_REGISTER: c_uint = 0x3b3fff;
