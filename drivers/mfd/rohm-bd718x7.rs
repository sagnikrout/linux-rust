...
//! Source: drivers/mfd/rohm-bd718x7.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bd718xx_i2c_probe(i2c: *mut i2c_client) -> c_int {
    ...
    mfd, cells, core::ptr::null_mut(), 0, irq_domain);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn bd718xx_i2c_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bd718xx_i2c_exit() -> void __exit {
