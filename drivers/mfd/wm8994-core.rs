...
//! Source: drivers/mfd/wm8994-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wm8994_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8994_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8994_ldo_in_use(pdata: *mut wm8994_pdata, ldo: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8994_set_pdata_from_of(wm8994: *mut wm8994) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm8994_device_init(wm8994: *mut wm8994, irq: c_int) -> c_int {
    static int wm8994_device_init(struct wm8994 *wm8994, int irq)
    {
    struct wm8994_pdata *pdata;
    struct regmap_config *regmap_config;
    const struct reg_sequence *regmap_patch = core::ptr::null_mut();
    const char *devname;
    int ret, i, patch_regs = 0;
    let mut pulls: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn wm8994_device_exit(wm8994: *mut wm8994) {
...
#[no_mangle]
unsafe extern "C" fn wm8994_i2c_probe(i2c: *mut i2c_client) -> c_int {
    static int wm8994_i2c_probe(struct i2c_client *i2c)
    {
    struct wm8994 *wm8994;
    int ret;
    wm8994 = devm_kzalloc(&i2c.dev, sizeof(struct wm8994), GFP_KERNEL);
    if (wm8994 == core::ptr::null_mut())
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn wm8994_i2c_remove(i2c: *mut i2c_client) {
    ...
    RUNTIME_PM_OPS(wm8994_suspend, wm8994_resume, core::ptr::null_mut())
    };
