...
#[no_mangle]
pub unsafe extern "C" fn max8997_read_reg(i2c: *mut i2c_client, reg: u8, dest: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn max8997_bulk_read(i2c: *mut i2c_client, reg: u8, count: c_int, buf: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn max8997_write_reg(i2c: *mut i2c_client, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn max8997_bulk_write(i2c: *mut i2c_client, reg: u8, count: c_int, buf: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn max8997_update_reg(i2c: *mut i2c_client, reg: u8, val: u8, mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_restore(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_i2c_init() -> int __init {
