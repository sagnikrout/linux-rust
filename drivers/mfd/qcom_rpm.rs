...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_rpm_resource {
    pub target_id: unsigned,
    pub status_id: unsigned,
    pub select_id: unsigned,
    pub size: unsigned,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_rpm_data {
    pub version: u32,
    pub resource_table: *const qcom_rpm_resource,
    pub n_resources: c_uint,
    pub req_ctx_off: c_uint,
    pub req_sel_off: c_uint,
    pub ack_ctx_off: c_uint,
    pub ack_sel_off: c_uint,
    pub req_sel_size: c_uint,
    pub ack_sel_size: c_uint,
}
...
pub struct qcom_rpm {
    ...
    pub ipc_offset: unsigned,
    pub ipc_bit: unsigned,
    pub ramclk: *mut clk,
    pub ack: completion,
    pub lock: mutex,
    pub status_regs: *mut void __iomem,
    pub ctrl_regs: *mut void __iomem,
    pub req_regs: *mut void __iomem,
    pub ack_status: u32,
    pub data: *const qcom_rpm_data,
}

pub const RPM_MAX_SEL_SIZE: c_int = 7;
    ...
    ret = -ETIMEDOUT;
#[no_mangle]
pub unsafe extern "C" fn if(RPM_REJECTED: rpm->ack_status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn qcom_rpm_ack_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qcom_rpm_err_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qcom_rpm_wakeup_interrupt(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t qcom_rpm_wakeup_interrupt(int irq, void *dev)
    {
    return IRQ_HANDLED;
    }
#[no_mangle]
unsafe extern "C" fn qcom_rpm_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    if (!rpm.data)
    return -ENODEV;
    rpm.status_regs = devm_platform_get_and_ioremap_resource(pdev, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qcom_rpm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qcom_rpm_exit() -> void __exit {
