...
#[no_mangle]
pub unsafe extern "C" fn max8998_read_reg(i2c: *mut i2c_client, reg: u8, dest: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn max8998_bulk_read(i2c: *mut i2c_client, reg: u8, count: c_int, buf: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn max8998_write_reg(i2c: *mut i2c_client, reg: u8, value: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn max8998_bulk_write(i2c: *mut i2c_client, reg: u8, count: c_int, buf: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn max8998_update_reg(i2c: *mut i2c_client, reg: u8, val: u8, mask: u8) -> c_int {
    ...
    ret = i2c_smbus_read_byte_data(i2c, reg);
    if (ret >= 0) {
    let mut old_val: u8 = ret & 0xff;
    let mut new_val: u8 = (val & mask) | (old_val & (~mask));
...
#[no_mangle]
unsafe extern "C" fn max8998_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8998_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8998_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8998_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8998_restore(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8998_i2c_init() -> int __init {
