...
pub const AXP806_REG_ADDR_EXT_ADDR_MASTER_MODE: c_int = 0;
...
// AXP323 is sometimes paired with AXP717 as sub-PMIC
    MFD_CELL_BASIC("axp20x-regulator", core::ptr::null_mut(), core::ptr::null_mut(), 0, 1),
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "x-powers,axp717-adc"),
    MFD_CELL_OF("axp20x-usb-power-supply",
    axp717_usb_power_supply_resources, core::ptr::null_mut(), 0, 0,
    "x-powers,axp717-usb-power-supply"),
    MFD_CELL_OF("axp20x-battery-power-supply",
    core::ptr::null_mut(), core::ptr::null_mut(), 0, 0, "x-powers,axp717-battery-power-supply"),
    };
...
#[no_mangle]
unsafe extern "C" fn axp20x_power_off(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn axp20x_match_device(axp20x: *mut axp20x_dev) -> c_int {
    int axp20x_match_device(struct axp20x_dev *axp20x)
    {
    struct device *dev = axp20x.dev;
    const struct mfd_cell *cells_no_irq = core::ptr::null_mut();
    let mut nr_cells_no_irq: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn axp20x_device_probe(axp20x: *mut axp20x_dev) -> c_int {
...
// Only if there is an interrupt line connected towards the CPU.
    ...
    axp20x.nr_cells, core::ptr::null_mut(), 0, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn axp20x_device_remove(axp20x: *mut axp20x_dev) {
