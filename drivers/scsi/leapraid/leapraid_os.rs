...
//! Source: drivers/scsi/leapraid/leapraid_os.c
#![no_std]
...
//
    ...
    let mut leapraid_ids: static atomic_t = ATOMIC_INIT(0);
    let mut open_pcie_trace: static int = 1;
    module_param(open_pcie_trace, int, 0644);
    MODULE_PARM_DESC(open_pcie_trace, "Default=1(open)/0(close)");
    let mut enable_mp: static int = 1;
...
#[no_mangle]
pub unsafe extern "C" fn leapraid_set_tm_flg(adapter: *mut leapraid_adapter, hdl: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn leapraid_clear_tm_flg(adapter: *mut leapraid_adapter, hdl: u16) {
...
// Iterate over all devices.
    ...
    struct leapraid_io_req_tracker *io_req_tracker = core::ptr::null_mut();
    u16 msix_task;
    u16 taskid;
    let mut issue_reset: bool = false;
    u32 db;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn leapraid_smart_fault_detect(adapter: *mut leapraid_adapter, hdl: u16) {
    ...
    starget_priv = starget ? starget.hostdata : core::ptr::null_mut();
    if (!starget_priv) {
    spin_unlock_irqrestore(&adapter.dev_topo.sas_dev_lock, flags);
    goto release_sdev;
    }
    ...
    {
    let mut scsi_status: u8 = scsiio_rep.scsi_status;
    let mut scsi_state: u8 = scsiio_rep.scsi_state;
    ...
    scmd.result = DID_SOFT_ERROR << LEAPRAID_SCSI_HOST_SHIFT;
#[no_mangle]
pub unsafe extern "C" fn if(LEAPRAID_SCSI_STATE_TERMINATED: scsi_state &) -> else {
    else if (scsi_state & LEAPRAID_SCSI_STATE_TERMINATED)
    scmd.result = DID_RESET << LEAPRAID_SCSI_HOST_SHIFT;
    }
...
#[no_mangle]
unsafe extern "C" fn leapraid_probe_raid(adapter: *mut leapraid_adapter) {
...
#[no_mangle]
unsafe extern "C" fn leapraid_probe_sas(adapter: *mut leapraid_adapter) {
...
#[no_mangle]
unsafe extern "C" fn leapraid_probe_boot_dev(adapter: *mut leapraid_adapter) {
...
#[no_mangle]
unsafe extern "C" fn leapraid_probe_devices(adapter: *mut leapraid_adapter) {
...
#[no_mangle]
pub unsafe extern "C" fn leapraid_scan_dev_done(adapter: *mut leapraid_adapter) {
    ...
    return false;
    opcode = scmd.cmnd[0];
    let mut opcode: return = = SYNCHRONIZE_CACHE || opcode == START_STOP;
    }
    return true;
    }
...
// rc = SCSI_MLQUEUE_DEVICE_BUSY;
    ...
    struct leapraid_io_req_tracker *io_req_tracker = core::ptr::null_mut();
    struct leapraid_sdev_priv *sdev_priv;
    struct leapraid_sas_dev *sas_dev = core::ptr::null_mut();
    u16 hdl;
    int rc;
    dev_info(&adapter.pdev.dev,
...
#[no_mangle]
unsafe extern "C" fn leapraid_eh_abort_handler(scmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_eh_device_reset_handler(scmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_eh_target_reset_handler(scmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_eh_host_reset_handler(scmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_sdev_init(sdev: *mut scsi_device) -> c_int {
...
// qd = adapter->adapter_attr.sata_max_queue_depth;
    ...
    struct leapraid_adapter *adapter;
    u16 hdl, vol_hdl = 0;
    let mut is_target_ssp: bool = false;
...
#[no_mangle]
unsafe extern "C" fn leapraid_sdev_destroy(sdev: *mut scsi_device) {
    ...
    sas_dev.starget = core::ptr::null_mut();
    if (sas_dev)
    leapraid_sdev_put(sas_dev);
    spin_unlock_irqrestore(&adapter.dev_topo.sas_dev_lock, flags);
    }
...
#[no_mangle]
unsafe extern "C" fn leapraid_target_alloc_raid(tgt: *mut scsi_target) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_target_alloc_sas(tgt: *mut scsi_target) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_target_alloc(tgt: *mut scsi_target) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_target_destroy_raid(tgt: *mut scsi_target) {
    ...
    if (raid_volume) {
    spin_lock_irqsave(&adapter.dev_topo.raid_volume_lock, flags);
    raid_volume.starget = core::ptr::null_mut();
    raid_volume.sdev = core::ptr::null_mut();
    spin_unlock_irqrestore(&adapter.dev_topo.raid_volume_lock,
    flags);
    leapraid_raid_volume_put(raid_volume);
    }
...
#[no_mangle]
unsafe extern "C" fn leapraid_target_destroy_sas(tgt: *mut scsi_target) {
    ...
    sas_dev.starget = core::ptr::null_mut();
    if (sas_dev) {
    starget_priv.sas_dev = core::ptr::null_mut();
    leapraid_sdev_put(sas_dev);
    leapraid_sdev_put(sas_dev);
    }
    spin_unlock_irqrestore(&adapter.dev_topo.sas_dev_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn leapraid_target_destroy(tgt: *mut scsi_target) {
    ...
    out_free:
    kfree(starget_priv);
    tgt.hostdata = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn leapraid_scan_finished(shost: *mut Scsi_Host, time: c_ulong) -> c_int {
    static int leapraid_scan_finished(struct Scsi_Host *shost, unsigned long time)
    {
    struct leapraid_adapter *adapter = shost_priv(shost);
    let mut need_hard_reset: bool = false;
...
#[no_mangle]
unsafe extern "C" fn leapraid_scan_start(shost: *mut Scsi_Host) {
...
#[no_mangle]
unsafe extern "C" fn leapraid_calc_max_queue_depth(sdev: *mut scsi_device, qdepth: c_int) -> c_int {
    ...
    struct leapraid_sas_dev *sas_dev;
    int max_depth;
    let mut default_qdepth: u32 = 0;
    let mut fw_qdepth: u32 = 0;
    shost = sdev.host;
    adapter = shost_priv(shost);
...
#[no_mangle]
pub unsafe extern "C" fn leapraid_change_queue_depth(sdev: *mut scsi_device, qdepth: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_map_queues(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn leapraid_blk_mq_poll(shost: *mut Scsi_Host, queue_num: c_uint) -> c_int {
    ...
    int num_entries;
    let mut qid: c_int = queue_num - adapter.notification_desc.iopoll_qdex;
...
#[no_mangle]
unsafe extern "C" fn leapraid_sdev_is_sata(sdev: *mut scsi_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn leapraid_lock_init(adapter: *mut leapraid_adapter) {
...
#[no_mangle]
unsafe extern "C" fn leapraid_list_init(adapter: *mut leapraid_adapter) {
...
#[no_mangle]
unsafe extern "C" fn leapraid_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn leapraid_cleanup_lists(adapter: *mut leapraid_adapter) {
    ...
    adapter.dev_topo.card.card_phy = core::ptr::null_mut();
    adapter.dev_topo.card.phys_num = 0;
    }
    }
#[no_mangle]
unsafe extern "C" fn leapraid_remove(pdev: *mut pci_dev) {
    ...
    adapter.fw_evt_s.fw_evt_thread = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn leapraid_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn leapraid_pci_mmio_enabled(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn leapraid_pci_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn leapraid_pci_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn leapraid_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_resume(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn leapraid_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn leapraid_exit() -> void __exit {
