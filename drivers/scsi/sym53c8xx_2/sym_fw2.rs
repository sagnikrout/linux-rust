...
//! Source: drivers/scsi/sym53c8xx_2/sym_fw2.h
#![no_std]
...
pub struct SYM_FWA_SCR {
    ...
    pub 6]: u32 init [,
    pub 4]: u32 clrack [,
    pub 10]: u32 datai_done [,
    pub 20]: u32 datai_done_wsr [,
    pub 10]: u32 datao_done [,
    pub 6]: u32 datao_done_wss [,
    pub 4]: u32 datai_phase [,
    pub 6]: u32 datao_phase [,
    pub 2]: u32 msg_in [,
    pub 10]: u32 msg_in2 [,
    ...
    pub 6]: u32 complete [,
    pub 12]: u32 complete2 [,
    pub 14]: u32 done [,
    pub 2]: u32 done_end [,
    pub 4]: u32 complete_error [,
    pub 12]: u32 save_dp [,
    pub 8]: u32 restore_dp [,
    pub 12]: u32 disconnect [,
    ...
    pub 22]: u32 reselected [,
    pub 20]: u32 resel_scntl4 [,
    pub 6]: u32 resel_lun0 [,

    pub 26]: u32 resel_tag [,

    pub 20]: u32 resel_tag [,

    pub 16]: u32 resel_tag [,

    pub 2]: u32 resel_dsa [,
    pub 4]: u32 resel_dsa1 [,
    pub 6]: u32 resel_no_tag [,
    ...
    pub 6]: u32 pm0_data_end [,
    pub 12]: u32 pm1_data [,
    pub 6]: u32 pm1_data_out [,
    pub 6]: u32 pm1_data_end [,
}
...
pub struct SYM_FWB_SCR {
    ...
    pub 4]: u32 msg_received [,
    pub 4]: u32 msg_weird_seen [,
    pub 20]: u32 msg_extended [,
    pub 6]: u32 msg_bad [,
    pub 4]: u32 msg_weird [,
    ...
    pub 6]: u32 bad_status [,
    pub 20]: u32 pm_handle [,
    pub 4]: u32 pm_handle1 [,
    pub 4]: u32 pm_save [,
    pub 12]: u32 pm0_save [,
    pub 4]: u32 pm_save_end [,
    pub 14]: u32 pm1_save [,
// WSR handling
    pub 38]: u32 pm_wsr_handle [,
    pub 4]: u32 wsr_ma_helper [,
// Data area
    pub 1]: u32 zero [,
    pub 1]: u32 scratch [,
    pub 1]: u32 pm0_data_addr [,
    pub 1]: u32 pm1_data_addr [,
    pub 1]: u32 done_pos [,
    pub 1]: u32 startpos [,
    pub 1]: u32 targtbl [,
}
