...
//! Source: drivers/scsi/advansys.c
#![no_std]
...
// Macro flag: #define ADVANSYS_STATS
// Enable driver tracing.

    typedef unsigned char uchar;

pub const PCI_VENDOR_ID_ASP: c_uint = 0x10cd;
pub const PCI_DEVICE_ID_ASP_1200A: c_uint = 0x1100;
pub const PCI_DEVICE_ID_ASP_ABP940: c_uint = 0x1200;
pub const PCI_DEVICE_ID_ASP_ABP940U: c_uint = 0x1300;
pub const PCI_DEVICE_ID_ASP_ABP940UW: c_uint = 0x2300;
pub const PCI_DEVICE_ID_38C0800_REV1: c_uint = 0x2500;
pub const PCI_DEVICE_ID_38C1600_REV1: c_uint = 0x2700;

pub const ASC_MAX_SG_QUEUE: c_int = 7;
pub const ASC_MAX_SG_LIST: c_int = 255;

pub const ASC_CHIP_VER_PCI: c_uint = 0x08;

pub const ASC_SCSI_ID_BITS: c_int = 3;

pub const ASC_ALL_DEVICE_BIT_SET: c_uint = 0xFF;

pub const ASC_MAX_TID: c_int = 7;
pub const ASC_MAX_LUN: c_int = 7;
pub const ASC_SCSI_WIDTH_BIT_SET: c_uint = 0xFF;
pub const ASC_MAX_SENSE_LEN: c_int = 32;
pub const ASC_MIN_SENSE_LEN: c_int = 14;
pub const ASC_SCSI_RESET_HOLD_TIME_US: c_int = 60;
//
// Narrow boards only support 12-byte commands, while wide boards
// extend to 16-byte commands.
//
pub const ASC_MAX_CDB_LEN: c_int = 12;
pub const ADV_MAX_CDB_LEN: c_int = 16;
pub const MS_SDTR_LEN: c_uint = 0x03;
pub const MS_WDTR_LEN: c_uint = 0x02;
pub const ASC_SG_LIST_PER_Q: c_int = 7;
pub const QS_FREE: c_uint = 0x00;
pub const QS_READY: c_uint = 0x01;
pub const QS_DISC1: c_uint = 0x02;
pub const QS_DISC2: c_uint = 0x04;
pub const QS_BUSY: c_uint = 0x08;
pub const QS_ABORTED: c_uint = 0x40;
pub const QS_DONE: c_uint = 0x80;
pub const QC_NO_CALLBACK: c_uint = 0x01;
pub const QC_SG_SWAP_QUEUE: c_uint = 0x02;
pub const QC_SG_HEAD: c_uint = 0x04;
pub const QC_DATA_IN: c_uint = 0x08;
pub const QC_DATA_OUT: c_uint = 0x10;
pub const QC_URGENT: c_uint = 0x20;
pub const QC_MSG_OUT: c_uint = 0x40;
pub const QC_REQ_SENSE: c_uint = 0x80;
pub const QCSG_SG_XFER_LIST: c_uint = 0x02;
pub const QCSG_SG_XFER_MORE: c_uint = 0x04;
pub const QCSG_SG_XFER_END: c_uint = 0x08;
pub const QD_IN_PROGRESS: c_uint = 0x00;
pub const QD_NO_ERROR: c_uint = 0x01;
pub const QD_ABORTED_BY_HOST: c_uint = 0x02;
pub const QD_WITH_ERROR: c_uint = 0x04;
pub const QD_INVALID_REQUEST: c_uint = 0x80;
pub const QD_INVALID_HOST_NUM: c_uint = 0x81;
pub const QD_INVALID_DEVICE: c_uint = 0x82;
pub const QD_ERR_INTERNAL: c_uint = 0xFF;
pub const QHSTA_NO_ERROR: c_uint = 0x00;
pub const QHSTA_M_SEL_TIMEOUT: c_uint = 0x11;
pub const QHSTA_M_DATA_OVER_RUN: c_uint = 0x12;
pub const QHSTA_M_DATA_UNDER_RUN: c_uint = 0x12;
pub const QHSTA_M_UNEXPECTED_BUS_FREE: c_uint = 0x13;
pub const QHSTA_M_BAD_BUS_PHASE_SEQ: c_uint = 0x14;
pub const QHSTA_D_QDONE_SG_LIST_CORRUPTED: c_uint = 0x21;
pub const QHSTA_D_ASC_DVC_ERROR_CODE_SET: c_uint = 0x22;
pub const QHSTA_D_HOST_ABORT_FAILED: c_uint = 0x23;
pub const QHSTA_D_EXE_SCSI_Q_FAILED: c_uint = 0x24;
pub const QHSTA_D_EXE_SCSI_Q_BUSY_TIMEOUT: c_uint = 0x25;
pub const QHSTA_D_ASPI_NO_BUF_POOL: c_uint = 0x26;
pub const QHSTA_M_WTM_TIMEOUT: c_uint = 0x41;
pub const QHSTA_M_BAD_CMPL_STATUS_IN: c_uint = 0x42;
pub const QHSTA_M_NO_AUTO_REQ_SENSE: c_uint = 0x43;
pub const QHSTA_M_AUTO_REQ_SENSE_FAIL: c_uint = 0x44;
pub const QHSTA_M_TARGET_STATUS_BUSY: c_uint = 0x45;
pub const QHSTA_M_BAD_TAG_CODE: c_uint = 0x46;
pub const QHSTA_M_BAD_QUEUE_FULL_OR_BUSY: c_uint = 0x47;
pub const QHSTA_M_HUNG_REQ_SCSI_BUS_RESET: c_uint = 0x48;
pub const QHSTA_D_LRAM_CMP_ERROR: c_uint = 0x81;
pub const QHSTA_M_MICRO_CODE_ERROR_HALT: c_uint = 0xA1;
pub const ASC_FLAG_SCSIQ_REQ: c_uint = 0x01;
pub const ASC_FLAG_BIOS_SCSIQ_REQ: c_uint = 0x02;
pub const ASC_FLAG_BIOS_ASYNC_IO: c_uint = 0x04;
pub const ASC_FLAG_SRB_LINEAR_ADDR: c_uint = 0x08;
pub const ASC_FLAG_WIN16: c_uint = 0x10;
pub const ASC_FLAG_WIN32: c_uint = 0x20;
pub const ASC_FLAG_DOS_VM_CALLBACK: c_uint = 0x80;
pub const ASC_TAG_FLAG_EXTRA_BYTES: c_uint = 0x10;
pub const ASC_TAG_FLAG_DISABLE_DISCONNECT: c_uint = 0x04;
pub const ASC_TAG_FLAG_DISABLE_ASYN_USE_SYN_FIX: c_uint = 0x08;
pub const ASC_TAG_FLAG_DISABLE_CHK_COND_INT_HOST: c_uint = 0x40;
pub const ASC_SCSIQ_CPY_BEG: c_int = 4;
pub const ASC_SCSIQ_SGHD_CPY_BEG: c_int = 2;
pub const ASC_SCSIQ_B_FWD: c_int = 0;
pub const ASC_SCSIQ_B_BWD: c_int = 1;
pub const ASC_SCSIQ_B_STATUS: c_int = 2;
pub const ASC_SCSIQ_B_QNO: c_int = 3;
pub const ASC_SCSIQ_B_CNTL: c_int = 4;
pub const ASC_SCSIQ_B_SG_QUEUE_CNT: c_int = 5;
pub const ASC_SCSIQ_D_DATA_ADDR: c_int = 8;
pub const ASC_SCSIQ_D_DATA_CNT: c_int = 12;
pub const ASC_SCSIQ_B_SENSE_LEN: c_int = 20;
pub const ASC_SCSIQ_DONE_INFO_BEG: c_int = 22;
pub const ASC_SCSIQ_D_SRBPTR: c_int = 22;
pub const ASC_SCSIQ_B_TARGET_IX: c_int = 26;
pub const ASC_SCSIQ_B_CDB_LEN: c_int = 28;
pub const ASC_SCSIQ_B_TAG_CODE: c_int = 29;
pub const ASC_SCSIQ_W_VM_ID: c_int = 30;
pub const ASC_SCSIQ_DONE_STATUS: c_int = 32;
pub const ASC_SCSIQ_HOST_STATUS: c_int = 33;
pub const ASC_SCSIQ_SCSI_STATUS: c_int = 34;
pub const ASC_SCSIQ_CDB_BEG: c_int = 36;
pub const ASC_SCSIQ_DW_REMAIN_XFER_ADDR: c_int = 56;
pub const ASC_SCSIQ_DW_REMAIN_XFER_CNT: c_int = 60;
pub const ASC_SCSIQ_B_FIRST_SG_WK_QP: c_int = 48;
pub const ASC_SCSIQ_B_SG_WK_QP: c_int = 49;
pub const ASC_SCSIQ_B_SG_WK_IX: c_int = 50;
pub const ASC_SCSIQ_W_ALT_DC1: c_int = 52;
pub const ASC_SCSIQ_B_LIST_CNT: c_int = 6;
pub const ASC_SCSIQ_B_CUR_LIST_CNT: c_int = 7;
pub const ASC_SGQ_B_SG_CNTL: c_int = 4;
pub const ASC_SGQ_B_SG_HEAD_QP: c_int = 5;
pub const ASC_SGQ_B_SG_LIST_CNT: c_int = 6;
pub const ASC_SGQ_B_SG_CUR_LIST_CNT: c_int = 7;
pub const ASC_SGQ_LIST_BEG: c_int = 8;
pub const ASC_DEF_SCSI1_QNG: c_int = 4;
pub const ASC_MAX_SCSI1_QNG: c_int = 4;
pub const ASC_DEF_SCSI2_QNG: c_int = 16;
pub const ASC_MAX_SCSI2_QNG: c_int = 32;
pub const ASC_TAG_CODE_MASK: c_uint = 0x23;
pub const ASC_STOP_REQ_RISC_STOP: c_uint = 0x01;
pub const ASC_STOP_ACK_RISC_STOP: c_uint = 0x03;
pub const ASC_STOP_CLEAN_UP_BUSY_Q: c_uint = 0x10;
pub const ASC_STOP_CLEAN_UP_DISC_Q: c_uint = 0x20;
pub const ASC_STOP_HOST_REQ_RISC_HALT: c_uint = 0x40;
...
pub const ASCQ_ERR_Q_STATUS: c_uint = 0x0D;
pub const ASCQ_ERR_CUR_QNG: c_uint = 0x17;
pub const ASCQ_ERR_SG_Q_LINKS: c_uint = 0x18;
pub const ASCQ_ERR_ISR_RE_ENTRY: c_uint = 0x1A;
pub const ASCQ_ERR_CRITICAL_RE_ENTRY: c_uint = 0x1B;
pub const ASCQ_ERR_ISR_ON_CRITICAL: c_uint = 0x1C;
//
// Warning code values are set in ASC_DVC_VAR  'warn_code'.
//
pub const ASC_WARN_NO_ERROR: c_uint = 0x0000;
pub const ASC_WARN_IO_PORT_ROTATE: c_uint = 0x0001;
pub const ASC_WARN_EEPROM_CHKSUM: c_uint = 0x0002;
pub const ASC_WARN_IRQ_MODIFIED: c_uint = 0x0004;
pub const ASC_WARN_AUTO_CONFIG: c_uint = 0x0008;
pub const ASC_WARN_CMD_QNG_CONFLICT: c_uint = 0x0010;
pub const ASC_WARN_EEPROM_RECOVER: c_uint = 0x0020;
pub const ASC_WARN_CFG_MSW_RECOVER: c_uint = 0x0040;
//
// Error code values are set in {ASC/ADV}_DVC_VAR  'err_code'.
//
pub const ASC_IERR_NO_CARRIER: c_uint = 0x0001	/* No more carrier memory */;
pub const ASC_IERR_MCODE_CHKSUM: c_uint = 0x0002	/* micro code check sum error */;
pub const ASC_IERR_SET_PC_ADDR: c_uint = 0x0004;
pub const ASC_IERR_START_STOP_CHIP: c_uint = 0x0008	/* start/stop chip failed */;
pub const ASC_IERR_ILLEGAL_CONNECTION: c_uint = 0x0010	/* Illegal cable connection */;
pub const ASC_IERR_SINGLE_END_DEVICE: c_uint = 0x0020	/* SE device on DIFF bus */;
pub const ASC_IERR_REVERSED_CABLE: c_uint = 0x0040	/* Narrow flat cable reversed */;
pub const ASC_IERR_SET_SCSI_ID: c_uint = 0x0080	/* set SCSI ID failed */;
pub const ASC_IERR_HVD_DEVICE: c_uint = 0x0100	/* HVD device on LVD port */;
pub const ASC_IERR_BAD_SIGNATURE: c_uint = 0x0200	/* signature not found */;
pub const ASC_IERR_NO_BUS_TYPE: c_uint = 0x0400;
pub const ASC_IERR_BIST_PRE_TEST: c_uint = 0x0800	/* BIST pre-test error */;
pub const ASC_IERR_BIST_RAM_TEST: c_uint = 0x1000	/* BIST RAM test error */;
pub const ASC_IERR_BAD_CHIPTYPE: c_uint = 0x2000	/* Invalid chip_type setting */;

pub const ASC_MAX_TOTAL_QNG: c_int = 240;
pub const ASC_MAX_PCI_ULTRA_INRAM_TOTAL_QNG: c_int = 16;
pub const ASC_MAX_PCI_ULTRA_INRAM_TAG_QNG: c_int = 8;
pub const ASC_MAX_PCI_INRAM_TOTAL_QNG: c_int = 20;
pub const ASC_MAX_INRAM_TAG_QNG: c_int = 16;
pub const ASC_IOADR_GAP: c_uint = 0x10;
pub const ASC_SYN_MAX_OFFSET: c_uint = 0x0F;
pub const ASC_DEF_SDTR_OFFSET: c_uint = 0x0F;
pub const ASC_SDTR_ULTRA_PCI_10MB_INDEX: c_uint = 0x02;
pub const ASYN_SDTR_DATA_FIX_PCI_REV_AB: c_uint = 0x41;
...
pub const ASC_DEF_DVC_CNTL: c_uint = 0xFFFF;
pub const ASC_DEF_CHIP_SCSI_ID: c_int = 7;
pub const ASC_DEF_ISA_DMA_SPEED: c_int = 4;
pub const ASC_INIT_STATE_BEG_GET_CFG: c_uint = 0x0001;
pub const ASC_INIT_STATE_END_GET_CFG: c_uint = 0x0002;
pub const ASC_INIT_STATE_BEG_SET_CFG: c_uint = 0x0004;
pub const ASC_INIT_STATE_END_SET_CFG: c_uint = 0x0008;
pub const ASC_INIT_STATE_BEG_LOAD_MC: c_uint = 0x0010;
pub const ASC_INIT_STATE_END_LOAD_MC: c_uint = 0x0020;
pub const ASC_INIT_STATE_BEG_INQUIRY: c_uint = 0x0040;
pub const ASC_INIT_STATE_END_INQUIRY: c_uint = 0x0080;
pub const ASC_INIT_RESET_SCSI_DONE: c_uint = 0x0100;
pub const ASC_INIT_STATE_WITHOUT_EEP: c_uint = 0x8000;
pub const ASC_BUG_FIX_IF_NOT_DWB: c_uint = 0x0001;
pub const ASC_BUG_FIX_ASYN_USE_SYN: c_uint = 0x0002;
pub const ASC_MIN_TAGGED_CMD: c_int = 7;
pub const ASC_MAX_SCSI_RESET_WAIT: c_int = 30;
pub const ASC_OVERRUN_BSIZE: c_int = 64;
...
pub const ASC_EEP_DVC_CFG_BEG_VL: c_int = 2;
pub const ASC_EEP_MAX_DVC_ADDR_VL: c_int = 15;
pub const ASC_EEP_DVC_CFG_BEG: c_int = 32;
pub const ASC_EEP_MAX_DVC_ADDR: c_int = 45;
pub const ASC_EEP_MAX_RETRY: c_int = 20;
//
...
pub const ASC_EEP_CMD_READ: c_uint = 0x80;
pub const ASC_EEP_CMD_WRITE: c_uint = 0x40;
pub const ASC_EEP_CMD_WRITE_ABLE: c_uint = 0x30;
pub const ASC_EEP_CMD_WRITE_DISABLE: c_uint = 0x00;
pub const ASCV_MSGOUT_BEG: c_uint = 0x0000;

pub const ASC_HOST_FLAG_IN_ISR: c_uint = 0x01;
pub const ASC_HOST_FLAG_ACK_INT: c_uint = 0x02;
pub const ASC_RISC_FLAG_GEN_INT: c_uint = 0x01;
pub const ASC_RISC_FLAG_REQ_SG_LIST: c_uint = 0x02;

pub const ASC_MAX_QNO: c_uint = 0xF8;

pub const ASC_QBLK_SIZE: c_uint = 0x40;
pub const ASC_BIOS_DATA_QBEG: c_uint = 0xF8;
pub const ASC_MIN_ACTIVE_QNO: c_uint = 0x01;
pub const ASC_QLINK_END: c_uint = 0xFF;
pub const ASC_EEPROM_WORDS: c_uint = 0x10;
pub const ASC_MAX_MGS_LEN: c_uint = 0x10;
pub const ASC_BIOS_ADDR_DEF: c_uint = 0xDC00;
pub const ASC_BIOS_SIZE: c_uint = 0x3800;
pub const ASC_BIOS_RAM_OFF: c_uint = 0x3800;
pub const ASC_BIOS_RAM_SIZE: c_uint = 0x800;
pub const ASC_BIOS_MIN_ADDR: c_uint = 0xC000;
pub const ASC_BIOS_MAX_ADDR: c_uint = 0xEC00;
pub const ASC_BIOS_BANK_SIZE: c_uint = 0x0400;
pub const ASC_MCODE_START_ADDR: c_uint = 0x0080;
pub const ASC_CFG0_HOST_INT_ON: c_uint = 0x0020;
pub const ASC_CFG0_BIOS_ON: c_uint = 0x0040;
pub const ASC_CFG0_VERA_BURST_ON: c_uint = 0x0080;
pub const ASC_CFG0_SCSI_PARITY_ON: c_uint = 0x0800;
pub const ASC_CFG1_SCSI_TARGET_ON: c_uint = 0x0080;
pub const ASC_CFG1_LRAM_8BITS_ON: c_uint = 0x0800;
pub const ASC_CFG_MSW_CLR_MASK: c_uint = 0x3080;

pub const ASC_1000_ID0W: c_uint = 0x04C1;
pub const ASC_1000_ID0W_FIX: c_uint = 0x00C1;
pub const ASC_1000_ID1B: c_uint = 0x25;

pub const ASC_MC_SAVE_CODE_WSIZE: c_uint = 0x500;
pub const ASC_MC_SAVE_DATA_WSIZE: c_uint = 0x40;
...
//
pub const ADV_MAX_SG_LIST: c_int = 255;
pub const NO_OF_SG_PER_BLOCK: c_int = 15;

pub const ADV_EEP_DELAY_MS: c_int = 100;
pub const ADV_EEPROM_BIG_ENDIAN: c_uint = 0x8000	/* EEPROM Bit 15 */;
pub const ADV_EEPROM_BIOS_ENABLE: c_uint = 0x4000	/* EEPROM Bit 14 */;
//
...
//
pub const ADV_EEPROM_TERM_POL: c_uint = 0x2000	/* EEPROM Bit 13 */;
pub const ADV_EEPROM_CIS_LD: c_uint = 0x2000	/* EEPROM Bit 13 */;
//
// ASC38C1600 Bit 11
//
...
//
pub const ADV_EEPROM_INTAB: c_uint = 0x0800	/* EEPROM Bit 11 */;
...
// EEPROM Commands
//
pub const ASC_EEP_CMD_DONE: c_uint = 0x0200;
// bios_ctrl
pub const BIOS_CTRL_BIOS: c_uint = 0x0001;
pub const BIOS_CTRL_EXTENDED_XLAT: c_uint = 0x0002;
pub const BIOS_CTRL_GT_2_DISK: c_uint = 0x0004;
pub const BIOS_CTRL_BIOS_REMOVABLE: c_uint = 0x0008;
pub const BIOS_CTRL_BOOTABLE_CD: c_uint = 0x0010;
pub const BIOS_CTRL_MULTIPLE_LUN: c_uint = 0x0040;
pub const BIOS_CTRL_DISPLAY_MSG: c_uint = 0x0080;
pub const BIOS_CTRL_NO_SCAM: c_uint = 0x0100;
pub const BIOS_CTRL_RESET_SCSI_BUS: c_uint = 0x0200;
pub const BIOS_CTRL_INIT_VERBOSE: c_uint = 0x0800;
pub const BIOS_CTRL_SCSI_PARITY: c_uint = 0x1000;
pub const BIOS_CTRL_AIPP_DIS: c_uint = 0x2000;
pub const ADV_3550_MEMSIZE: c_uint = 0x2000	/* 8 KB Internal Memory */;
pub const ADV_38C0800_MEMSIZE: c_uint = 0x4000	/* 16 KB Internal Memory */;
//
...
//
pub const ADV_38C1600_MEMSIZE: c_uint = 0x4000	/* 16 KB Internal Memory */;
//
// Byte I/O register address from base of 'iop_base'.
//
pub const IOPB_INTR_STATUS_REG: c_uint = 0x00;
pub const IOPB_CHIP_ID_1: c_uint = 0x01;
pub const IOPB_INTR_ENABLES: c_uint = 0x02;
pub const IOPB_CHIP_TYPE_REV: c_uint = 0x03;
pub const IOPB_RES_ADDR_4: c_uint = 0x04;
pub const IOPB_RES_ADDR_5: c_uint = 0x05;
pub const IOPB_RAM_DATA: c_uint = 0x06;
pub const IOPB_RES_ADDR_7: c_uint = 0x07;
pub const IOPB_FLAG_REG: c_uint = 0x08;
pub const IOPB_RES_ADDR_9: c_uint = 0x09;
pub const IOPB_RISC_CSR: c_uint = 0x0A;
pub const IOPB_RES_ADDR_B: c_uint = 0x0B;
pub const IOPB_RES_ADDR_C: c_uint = 0x0C;
pub const IOPB_RES_ADDR_D: c_uint = 0x0D;
pub const IOPB_SOFT_OVER_WR: c_uint = 0x0E;
pub const IOPB_RES_ADDR_F: c_uint = 0x0F;
pub const IOPB_MEM_CFG: c_uint = 0x10;
pub const IOPB_RES_ADDR_11: c_uint = 0x11;
pub const IOPB_GPIO_DATA: c_uint = 0x12;
pub const IOPB_RES_ADDR_13: c_uint = 0x13;
pub const IOPB_FLASH_PAGE: c_uint = 0x14;
pub const IOPB_RES_ADDR_15: c_uint = 0x15;
pub const IOPB_GPIO_CNTL: c_uint = 0x16;
pub const IOPB_RES_ADDR_17: c_uint = 0x17;
pub const IOPB_FLASH_DATA: c_uint = 0x18;
pub const IOPB_RES_ADDR_19: c_uint = 0x19;
pub const IOPB_RES_ADDR_1A: c_uint = 0x1A;
pub const IOPB_RES_ADDR_1B: c_uint = 0x1B;
pub const IOPB_RES_ADDR_1C: c_uint = 0x1C;
pub const IOPB_RES_ADDR_1D: c_uint = 0x1D;
pub const IOPB_RES_ADDR_1E: c_uint = 0x1E;
pub const IOPB_RES_ADDR_1F: c_uint = 0x1F;
pub const IOPB_DMA_CFG0: c_uint = 0x20;
pub const IOPB_DMA_CFG1: c_uint = 0x21;
pub const IOPB_TICKLE: c_uint = 0x22;
pub const IOPB_DMA_REG_WR: c_uint = 0x23;
pub const IOPB_SDMA_STATUS: c_uint = 0x24;
pub const IOPB_SCSI_BYTE_CNT: c_uint = 0x25;
pub const IOPB_HOST_BYTE_CNT: c_uint = 0x26;
pub const IOPB_BYTE_LEFT_TO_XFER: c_uint = 0x27;
pub const IOPB_BYTE_TO_XFER_0: c_uint = 0x28;
pub const IOPB_BYTE_TO_XFER_1: c_uint = 0x29;
pub const IOPB_BYTE_TO_XFER_2: c_uint = 0x2A;
pub const IOPB_BYTE_TO_XFER_3: c_uint = 0x2B;
pub const IOPB_ACC_GRP: c_uint = 0x2C;
pub const IOPB_RES_ADDR_2D: c_uint = 0x2D;
pub const IOPB_DEV_ID: c_uint = 0x2E;
pub const IOPB_RES_ADDR_2F: c_uint = 0x2F;
pub const IOPB_SCSI_DATA: c_uint = 0x30;
pub const IOPB_RES_ADDR_31: c_uint = 0x31;
pub const IOPB_RES_ADDR_32: c_uint = 0x32;
pub const IOPB_SCSI_DATA_HSHK: c_uint = 0x33;
pub const IOPB_SCSI_CTRL: c_uint = 0x34;
pub const IOPB_RES_ADDR_35: c_uint = 0x35;
pub const IOPB_RES_ADDR_36: c_uint = 0x36;
pub const IOPB_RES_ADDR_37: c_uint = 0x37;
pub const IOPB_RAM_BIST: c_uint = 0x38;
pub const IOPB_PLL_TEST: c_uint = 0x39;
pub const IOPB_PCI_INT_CFG: c_uint = 0x3A;
pub const IOPB_RES_ADDR_3B: c_uint = 0x3B;
pub const IOPB_RFIFO_CNT: c_uint = 0x3C;
pub const IOPB_RES_ADDR_3D: c_uint = 0x3D;
pub const IOPB_RES_ADDR_3E: c_uint = 0x3E;
pub const IOPB_RES_ADDR_3F: c_uint = 0x3F;
//
// Word I/O register address from base of 'iop_base'.
//
pub const IOPW_CHIP_ID_0: c_uint = 0x00	/* CID0  */;
pub const IOPW_CTRL_REG: c_uint = 0x02	/* CC    */;
pub const IOPW_RAM_ADDR: c_uint = 0x04	/* LA    */;
pub const IOPW_RAM_DATA: c_uint = 0x06	/* LD    */;
pub const IOPW_RES_ADDR_08: c_uint = 0x08;
pub const IOPW_RISC_CSR: c_uint = 0x0A	/* CSR   */;
pub const IOPW_SCSI_CFG0: c_uint = 0x0C	/* CFG0  */;
pub const IOPW_SCSI_CFG1: c_uint = 0x0E	/* CFG1  */;
pub const IOPW_RES_ADDR_10: c_uint = 0x10;
pub const IOPW_SEL_MASK: c_uint = 0x12	/* SM    */;
pub const IOPW_RES_ADDR_14: c_uint = 0x14;
pub const IOPW_FLASH_ADDR: c_uint = 0x16	/* FA    */;
pub const IOPW_RES_ADDR_18: c_uint = 0x18;
pub const IOPW_EE_CMD: c_uint = 0x1A	/* EC    */;
pub const IOPW_EE_DATA: c_uint = 0x1C	/* ED    */;
pub const IOPW_SFIFO_CNT: c_uint = 0x1E	/* SFC   */;
pub const IOPW_RES_ADDR_20: c_uint = 0x20;
pub const IOPW_Q_BASE: c_uint = 0x22	/* QB    */;
pub const IOPW_QP: c_uint = 0x24	/* QP    */;
pub const IOPW_IX: c_uint = 0x26	/* IX    */;
pub const IOPW_SP: c_uint = 0x28	/* SP    */;
pub const IOPW_PC: c_uint = 0x2A	/* PC    */;
pub const IOPW_RES_ADDR_2C: c_uint = 0x2C;
pub const IOPW_RES_ADDR_2E: c_uint = 0x2E;
pub const IOPW_SCSI_DATA: c_uint = 0x30	/* SD    */;
pub const IOPW_SCSI_DATA_HSHK: c_uint = 0x32	/* SDH   */;
pub const IOPW_SCSI_CTRL: c_uint = 0x34	/* SC    */;
pub const IOPW_HSHK_CFG: c_uint = 0x36	/* HCFG  */;
pub const IOPW_SXFR_STATUS: c_uint = 0x36	/* SXS   */;
pub const IOPW_SXFR_CNTL: c_uint = 0x38	/* SXL   */;
pub const IOPW_SXFR_CNTH: c_uint = 0x3A	/* SXH   */;
pub const IOPW_RES_ADDR_3C: c_uint = 0x3C;
pub const IOPW_RFIFO_DATA: c_uint = 0x3E	/* RFD   */;
//
// Doubleword I/O register address from base of 'iop_base'.
//
pub const IOPDW_RES_ADDR_0: c_uint = 0x00;
pub const IOPDW_RAM_DATA: c_uint = 0x04;
pub const IOPDW_RES_ADDR_8: c_uint = 0x08;
pub const IOPDW_RES_ADDR_C: c_uint = 0x0C;
pub const IOPDW_RES_ADDR_10: c_uint = 0x10;
pub const IOPDW_COMMA: c_uint = 0x14;
pub const IOPDW_COMMB: c_uint = 0x18;
pub const IOPDW_RES_ADDR_1C: c_uint = 0x1C;
pub const IOPDW_SDMA_ADDR0: c_uint = 0x20;
pub const IOPDW_SDMA_ADDR1: c_uint = 0x24;
pub const IOPDW_SDMA_COUNT: c_uint = 0x28;
pub const IOPDW_SDMA_ERROR: c_uint = 0x2C;
pub const IOPDW_RDMA_ADDR0: c_uint = 0x30;
pub const IOPDW_RDMA_ADDR1: c_uint = 0x34;
pub const IOPDW_RDMA_COUNT: c_uint = 0x38;
pub const IOPDW_RDMA_ERROR: c_uint = 0x3C;
pub const ADV_CHIP_ID_BYTE: c_uint = 0x25;
pub const ADV_CHIP_ID_WORD: c_uint = 0x04C1;
pub const ADV_INTR_ENABLE_HOST_INTR: c_uint = 0x01;
pub const ADV_INTR_ENABLE_SEL_INTR: c_uint = 0x02;
pub const ADV_INTR_ENABLE_DPR_INTR: c_uint = 0x04;
pub const ADV_INTR_ENABLE_RTA_INTR: c_uint = 0x08;
pub const ADV_INTR_ENABLE_RMA_INTR: c_uint = 0x10;
pub const ADV_INTR_ENABLE_RST_INTR: c_uint = 0x20;
pub const ADV_INTR_ENABLE_DPE_INTR: c_uint = 0x40;
pub const ADV_INTR_ENABLE_GLOBAL_INTR: c_uint = 0x80;
pub const ADV_INTR_STATUS_INTRA: c_uint = 0x01;
pub const ADV_INTR_STATUS_INTRB: c_uint = 0x02;
pub const ADV_INTR_STATUS_INTRC: c_uint = 0x04;

pub const ADV_CTRL_REG_HOST_INTR: c_uint = 0x0100;
pub const ADV_CTRL_REG_SEL_INTR: c_uint = 0x0200;
pub const ADV_CTRL_REG_DPR_INTR: c_uint = 0x0400;
pub const ADV_CTRL_REG_RTA_INTR: c_uint = 0x0800;
pub const ADV_CTRL_REG_RMA_INTR: c_uint = 0x1000;
pub const ADV_CTRL_REG_RES_BIT14: c_uint = 0x2000;
pub const ADV_CTRL_REG_DPE_INTR: c_uint = 0x4000;
pub const ADV_CTRL_REG_POWER_DONE: c_uint = 0x8000;
pub const ADV_CTRL_REG_ANY_INTR: c_uint = 0xFF00;
pub const ADV_CTRL_REG_CMD_RESET: c_uint = 0x00C6;
pub const ADV_CTRL_REG_CMD_WR_IO_REG: c_uint = 0x00C5;
pub const ADV_CTRL_REG_CMD_RD_IO_REG: c_uint = 0x00C4;
pub const ADV_CTRL_REG_CMD_WR_PCI_CFG_SPACE: c_uint = 0x00C3;
pub const ADV_CTRL_REG_CMD_RD_PCI_CFG_SPACE: c_uint = 0x00C2;
pub const ADV_TICKLE_NOP: c_uint = 0x00;
pub const ADV_TICKLE_A: c_uint = 0x01;
pub const ADV_TICKLE_B: c_uint = 0x02;
pub const ADV_TICKLE_C: c_uint = 0x03;

    (AdvReadWordRegister(port, IOPW_CTRL_REG) & ADV_CTRL_REG_HOST_INTR)
//
// SCSI_CFG0 Register bit definitions
//
pub const TIMER_MODEAB: c_uint = 0xC000	/* Watchdog, Second, and Select. Timer Ctrl. */;
pub const PARITY_EN: c_uint = 0x2000	/* Enable SCSI Parity Error detection */;
pub const EVEN_PARITY: c_uint = 0x1000	/* Select Even Parity */;
pub const WD_LONG: c_uint = 0x0800	/* Watchdog Interval, 1: 57 min, 0: 13 sec */;
pub const QUEUE_128: c_uint = 0x0400	/* Queue Size, 1: 128 byte, 0: 64 byte */;
pub const PRIM_MODE: c_uint = 0x0100	/* Primitive SCSI mode */;
pub const SCAM_EN: c_uint = 0x0080	/* Enable SCAM selection */;
pub const SEL_TMO_LONG: c_uint = 0x0040	/* Sel/Resel Timeout, 1: 400 ms, 0: 1.6 ms */;
pub const CFRM_ID: c_uint = 0x0020	/* SCAM id sel. confirm., 1: fast, 0: 6.4 ms */;
pub const OUR_ID_EN: c_uint = 0x0010	/* Enable OUR_ID bits */;
pub const OUR_ID: c_uint = 0x000F	/* SCSI ID */;
//
// SCSI_CFG1 Register bit definitions
//
pub const BIG_ENDIAN: c_uint = 0x8000	/* Enable Big Endian Mode MIO:15, EEP:15 */;
pub const TERM_POL: c_uint = 0x2000	/* Terminator Polarity Ctrl. MIO:13, EEP:13 */;
pub const SLEW_RATE: c_uint = 0x1000	/* SCSI output buffer slew rate */;
pub const FILTER_SEL: c_uint = 0x0C00	/* Filter Period Selection */;
pub const FLTR_DISABLE: c_uint = 0x0000	/* Input Filtering Disabled */;
pub const FLTR_11_TO_20NS: c_uint = 0x0800	/* Input Filtering 11ns to 20ns */;
pub const FLTR_21_TO_39NS: c_uint = 0x0C00	/* Input Filtering 21ns to 39ns */;
pub const ACTIVE_DBL: c_uint = 0x0200	/* Disable Active Negation */;
pub const DIFF_MODE: c_uint = 0x0100	/* SCSI differential Mode (Read-Only) */;
pub const DIFF_SENSE: c_uint = 0x0080	/* 1: No SE cables, 0: SE cable (Read-Only) */;
pub const TERM_CTL_SEL: c_uint = 0x0040	/* Enable TERM_CTL_H and TERM_CTL_L */;
pub const TERM_CTL: c_uint = 0x0030	/* External SCSI Termination Bits */;
pub const TERM_CTL_H: c_uint = 0x0020	/* Enable External SCSI Upper Termination */;
pub const TERM_CTL_L: c_uint = 0x0010	/* Enable External SCSI Lower Termination */;
pub const CABLE_DETECT: c_uint = 0x000F	/* External SCSI Cable Connection Status */;
//
...
//
pub const DIS_TERM_DRV: c_uint = 0x4000	/* 1: Read c_det[3:0], 0: cannot read */;
pub const HVD_LVD_SE: c_uint = 0x1C00	/* Device Detect Bits */;
pub const HVD: c_uint = 0x1000	/* HVD Device Detect */;
pub const LVD: c_uint = 0x0800	/* LVD Device Detect */;
pub const SE: c_uint = 0x0400	/* SE Device Detect */;
pub const TERM_LVD: c_uint = 0x00C0	/* LVD Termination Bits */;
pub const TERM_LVD_HI: c_uint = 0x0080	/* Enable LVD Upper Termination */;
pub const TERM_LVD_LO: c_uint = 0x0040	/* Enable LVD Lower Termination */;
pub const TERM_SE: c_uint = 0x0030	/* SE Termination Bits */;
pub const TERM_SE_HI: c_uint = 0x0020	/* Enable SE Upper Termination */;
pub const TERM_SE_LO: c_uint = 0x0010	/* Enable SE Lower Termination */;
pub const C_DET_LVD: c_uint = 0x000C	/* LVD Cable Detect Bits */;
pub const C_DET3: c_uint = 0x0008	/* Cable Detect for LVD External Wide */;
pub const C_DET2: c_uint = 0x0004	/* Cable Detect for LVD Internal Wide */;
pub const C_DET_SE: c_uint = 0x0003	/* SE Cable Detect Bits */;
pub const C_DET1: c_uint = 0x0002	/* Cable Detect for SE Internal Wide */;
pub const C_DET0: c_uint = 0x0001	/* Cable Detect for SE Internal Narrow */;
pub const CABLE_ILLEGAL_A: c_uint = 0x7;
// x 0 0 0  | on  on | Illegal (all 3 connectors are used)
pub const CABLE_ILLEGAL_B: c_uint = 0xB;
// 0 x 0 0  | on  on | Illegal (all 3 connectors are used)
//
// MEM_CFG Register bit definitions
//
pub const BIOS_EN: c_uint = 0x40	/* BIOS Enable MIO:14,EEP:14 */;
pub const FAST_EE_CLK: c_uint = 0x20	/* Diagnostic Bit */;
pub const RAM_SZ: c_uint = 0x1C	/* Specify size of RAM to RISC */;
pub const RAM_SZ_2KB: c_uint = 0x00	/* 2 KB */;
pub const RAM_SZ_4KB: c_uint = 0x04	/* 4 KB */;
pub const RAM_SZ_8KB: c_uint = 0x08	/* 8 KB */;
pub const RAM_SZ_16KB: c_uint = 0x0C	/* 16 KB */;
pub const RAM_SZ_32KB: c_uint = 0x10	/* 32 KB */;
pub const RAM_SZ_64KB: c_uint = 0x14	/* 64 KB */;
//
// DMA_CFG0 Register bit definitions
//
// This register is only accessible to the host.
//
pub const BC_THRESH_ENB: c_uint = 0x80	/* PCI DMA Start Conditions */;
pub const FIFO_THRESH: c_uint = 0x70	/* PCI DMA FIFO Threshold */;
pub const FIFO_THRESH_16B: c_uint = 0x00	/* 16 bytes */;
pub const FIFO_THRESH_32B: c_uint = 0x20	/* 32 bytes */;
pub const FIFO_THRESH_48B: c_uint = 0x30	/* 48 bytes */;
pub const FIFO_THRESH_64B: c_uint = 0x40	/* 64 bytes */;
pub const FIFO_THRESH_80B: c_uint = 0x50	/* 80 bytes (default) */;
pub const FIFO_THRESH_96B: c_uint = 0x60	/* 96 bytes */;
pub const FIFO_THRESH_112B: c_uint = 0x70	/* 112 bytes */;
pub const START_CTL: c_uint = 0x0C	/* DMA start conditions */;
pub const START_CTL_TH: c_uint = 0x00	/* Wait threshold level (default) */;
pub const START_CTL_ID: c_uint = 0x04	/* Wait SDMA/SBUS idle */;
pub const START_CTL_THID: c_uint = 0x08	/* Wait threshold and SDMA/SBUS idle */;
pub const START_CTL_EMFU: c_uint = 0x0C	/* Wait SDMA FIFO empty/full */;
pub const READ_CMD: c_uint = 0x03	/* Memory Read Method */;
pub const READ_CMD_MR: c_uint = 0x00	/* Memory Read */;
pub const READ_CMD_MRL: c_uint = 0x02	/* Memory Read Long */;
pub const READ_CMD_MRM: c_uint = 0x03	/* Memory Read Multiple (default) */;
//
// ASC-38C0800 RAM BIST Register bit definitions
//
pub const RAM_TEST_MODE: c_uint = 0x80;
pub const PRE_TEST_MODE: c_uint = 0x40;
pub const NORMAL_MODE: c_uint = 0x00;
pub const RAM_TEST_DONE: c_uint = 0x10;
pub const RAM_TEST_STATUS: c_uint = 0x0F;
pub const RAM_TEST_HOST_ERROR: c_uint = 0x08;
pub const RAM_TEST_INTRAM_ERROR: c_uint = 0x04;
pub const RAM_TEST_RISC_ERROR: c_uint = 0x02;
pub const RAM_TEST_SCSI_ERROR: c_uint = 0x01;
pub const RAM_TEST_SUCCESS: c_uint = 0x00;
pub const PRE_TEST_VALUE: c_uint = 0x05;
pub const NORMAL_VALUE: c_uint = 0x00;
//
// ASC38C1600 Definitions
//
// IOPB_PCI_INT_CFG Bit Field Definitions
//
pub const INTAB_LD: c_uint = 0x80	/* Value loaded from EEPROM Bit 11. */;
//
...
//
pub const TOTEMPOLE: c_uint = 0x02;
//
...
//
pub const INTAB: c_uint = 0x01;
//
// Adv Library Status Definitions
//
pub const ADV_TRUE: c_int = 1;
pub const ADV_FALSE: c_int = 0;
pub const ADV_SUCCESS: c_int = 1;
pub const ADV_BUSY: c_int = 0;

//
// ADV_DVC_VAR 'warn_code' values
//
pub const ASC_WARN_BUSRESET_ERROR: c_uint = 0x0001	/* SCSI Bus Reset error */;
pub const ASC_WARN_EEPROM_CHKSUM: c_uint = 0x0002	/* EEP check sum error */;
pub const ASC_WARN_EEPROM_TERMINATION: c_uint = 0x0004	/* EEP termination bad field */;
pub const ASC_WARN_ERROR: c_uint = 0xFFFF	/* ADV_ERROR return */;

//
// Fixed locations of microcode operating variables.
//
pub const ASC_MC_CODE_BEGIN_ADDR: c_uint = 0x0028	/* microcode start address */;
pub const ASC_MC_CODE_END_ADDR: c_uint = 0x002A	/* microcode end address */;
pub const ASC_MC_CODE_CHK_SUM: c_uint = 0x002C	/* microcode code checksum */;
pub const ASC_MC_VERSION_DATE: c_uint = 0x0038	/* microcode version */;
pub const ASC_MC_VERSION_NUM: c_uint = 0x003A	/* microcode number */;
pub const ASC_MC_BIOSMEM: c_uint = 0x0040	/* BIOS RISC Memory Start */;
pub const ASC_MC_BIOSLEN: c_uint = 0x0050	/* BIOS RISC Memory Length */;
pub const ASC_MC_BIOS_SIGNATURE: c_uint = 0x0058	/* BIOS Signature 0x55AA */;
pub const ASC_MC_BIOS_VERSION: c_uint = 0x005A	/* BIOS Version (2 bytes) */;
pub const ASC_MC_SDTR_SPEED1: c_uint = 0x0090	/* SDTR Speed for TID 0-3 */;
pub const ASC_MC_SDTR_SPEED2: c_uint = 0x0092	/* SDTR Speed for TID 4-7 */;
pub const ASC_MC_SDTR_SPEED3: c_uint = 0x0094	/* SDTR Speed for TID 8-11 */;
pub const ASC_MC_SDTR_SPEED4: c_uint = 0x0096	/* SDTR Speed for TID 12-15 */;
pub const ASC_MC_CHIP_TYPE: c_uint = 0x009A;
pub const ASC_MC_INTRB_CODE: c_uint = 0x009B;
pub const ASC_MC_WDTR_ABLE: c_uint = 0x009C;
pub const ASC_MC_SDTR_ABLE: c_uint = 0x009E;
pub const ASC_MC_TAGQNG_ABLE: c_uint = 0x00A0;
pub const ASC_MC_DISC_ENABLE: c_uint = 0x00A2;
pub const ASC_MC_IDLE_CMD_STATUS: c_uint = 0x00A4;
pub const ASC_MC_IDLE_CMD: c_uint = 0x00A6;
pub const ASC_MC_IDLE_CMD_PARAMETER: c_uint = 0x00A8;
pub const ASC_MC_DEFAULT_SCSI_CFG0: c_uint = 0x00AC;
pub const ASC_MC_DEFAULT_SCSI_CFG1: c_uint = 0x00AE;
pub const ASC_MC_DEFAULT_MEM_CFG: c_uint = 0x00B0;
pub const ASC_MC_DEFAULT_SEL_MASK: c_uint = 0x00B2;
pub const ASC_MC_SDTR_DONE: c_uint = 0x00B6;
pub const ASC_MC_NUMBER_OF_QUEUED_CMD: c_uint = 0x00C0;
pub const ASC_MC_NUMBER_OF_MAX_CMD: c_uint = 0x00D0;
pub const ASC_MC_DEVICE_HSHK_CFG_TABLE: c_uint = 0x0100;
pub const ASC_MC_CONTROL_FLAG: c_uint = 0x0122	/* Microcode control flag. */;
pub const ASC_MC_WDTR_DONE: c_uint = 0x0124;
pub const ASC_MC_CAM_MODE_MASK: c_uint = 0x015E	/* CAM mode TID bitmask. */;
pub const ASC_MC_ICQ: c_uint = 0x0160;
pub const ASC_MC_IRQ: c_uint = 0x0164;
pub const ASC_MC_PPR_ABLE: c_uint = 0x017A;
//
// BIOS LRAM variable absolute offsets.
//
pub const BIOS_CODESEG: c_uint = 0x54;
pub const BIOS_CODELEN: c_uint = 0x56;
pub const BIOS_SIGNATURE: c_uint = 0x58;
pub const BIOS_VERSION: c_uint = 0x5A;
//
...
//
pub const CONTROL_FLAG_IGNORE_PERR: c_uint = 0x0001	/* Ignore DMA Parity Errors */;
pub const CONTROL_FLAG_ENABLE_AIPP: c_uint = 0x0002	/* Enabled AIPP checking. */;
//
// ASC_MC_DEVICE_HSHK_CFG_TABLE microcode table or HSHK_CFG register format
//
pub const HSHK_CFG_WIDE_XFR: c_uint = 0x8000;
pub const HSHK_CFG_RATE: c_uint = 0x0F00;
pub const HSHK_CFG_OFFSET: c_uint = 0x001F;
pub const ASC_DEF_MAX_HOST_QNG: c_uint = 0xFD	/* Max. number of host commands (253) */;
pub const ASC_DEF_MIN_HOST_QNG: c_uint = 0x10	/* Min. number of host commands (16) */;
pub const ASC_DEF_MAX_DVC_QNG: c_uint = 0x3F	/* Max. number commands per device (63) */;
pub const ASC_DEF_MIN_DVC_QNG: c_uint = 0x04	/* Min. number commands per device (4) */;
pub const ASC_QC_DATA_CHECK: c_uint = 0x01	/* Require ASC_QC_DATA_OUT set or clear. */;
pub const ASC_QC_DATA_OUT: c_uint = 0x02	/* Data out DMA transfer. */;
pub const ASC_QC_START_MOTOR: c_uint = 0x04	/* Send auto-start motor before request. */;
pub const ASC_QC_NO_OVERRUN: c_uint = 0x08	/* Don't report overrun. */;
pub const ASC_QC_FREEZE_TIDQ: c_uint = 0x10	/* Freeze TID queue after request. XXX TBD */;
pub const ASC_QSC_NO_DISC: c_uint = 0x01	/* Don't allow disconnect for request. */;
pub const ASC_QSC_NO_TAGMSG: c_uint = 0x02	/* Don't allow tag queuing for request. */;
pub const ASC_QSC_NO_SYNC: c_uint = 0x04	/* Don't use Synch. transfer on request. */;
pub const ASC_QSC_NO_WIDE: c_uint = 0x08	/* Don't use Wide transfer on request. */;
pub const ASC_QSC_REDO_DTR: c_uint = 0x10	/* Renegotiate WDTR/SDTR before request. */;
//
...
//
pub const ASC_QSC_HEAD_TAG: c_uint = 0x40	/* Use Head Tag Message (0x21). */;
pub const ASC_QSC_ORDERED_TAG: c_uint = 0x80	/* Use Ordered Tag Message (0x22). */;
//
...
//
pub const ADV_NEXT_VPA_MASK: c_uint = 0xFFFFFFF0;
pub const ADV_RQ_DONE: c_uint = 0x00000001;
pub const ADV_RQ_GOOD: c_uint = 0x00000002;
pub const ADV_CQ_STOPPER: c_uint = 0x00000000;
...
pub const ADV_CHIP_ASC3550: c_uint = 0x01	/* Ultra-Wide IC */;
pub const ADV_CHIP_ASC38C0800: c_uint = 0x02	/* Ultra2-Wide/LVD IC */;
pub const ADV_CHIP_ASC38C1600: c_uint = 0x03	/* Ultra3-Wide/LVD2 IC */;
//
...
//
pub const IDLE_CMD_COMPLETED: c_int = 0;
pub const IDLE_CMD_STOP_CHIP: c_uint = 0x0001;
pub const IDLE_CMD_STOP_CHIP_SEND_INT: c_uint = 0x0002;
pub const IDLE_CMD_SEND_INT: c_uint = 0x0004;
pub const IDLE_CMD_ABORT: c_uint = 0x0008;
pub const IDLE_CMD_DEVICE_RESET: c_uint = 0x0010;
pub const IDLE_CMD_SCSI_RESET_START: c_uint = 0x0020	/* Assert SCSI Bus Reset */;
pub const IDLE_CMD_SCSI_RESET_END: c_uint = 0x0040	/* Deassert SCSI Bus Reset */;
pub const IDLE_CMD_SCSIREQ: c_uint = 0x0080;
pub const IDLE_CMD_STATUS_SUCCESS: c_uint = 0x0001;
pub const IDLE_CMD_STATUS_FAILURE: c_uint = 0x0002;
//
// AdvSendIdleCmd() flag definitions.
//
pub const ADV_NOWAIT: c_uint = 0x01;
//
// Wait loop time out values.
//

pub const ADV_ASYNC_RDMA_FAILURE: c_uint = 0x01	/* Fatal RDMA failure. */;
pub const ADV_ASYNC_SCSI_BUS_RESET_DET: c_uint = 0x02	/* Detected SCSI Bus Reset. */;
pub const ADV_ASYNC_CARRIER_READY_FAILURE: c_uint = 0x03	/* Carrier Ready failure. */;
pub const ADV_RDMA_IN_CARR_AND_Q_INVALID: c_uint = 0x04	/* RDMAed-in data invalid. */;
pub const ADV_HOST_SCSI_BUS_RESET: c_uint = 0x80	/* Host Initiated SCSI Bus Reset. */;
...
//
pub const ADV_SCAN_LUN: c_uint = 0x01;
pub const ADV_CAPINFO_NOLUN: c_uint = 0x02;
//
...
//
pub const QD_NO_STATUS: c_uint = 0x00	/* Request not completed yet. */;
pub const QD_NO_ERROR: c_uint = 0x01;
pub const QD_ABORTED_BY_HOST: c_uint = 0x02;
pub const QD_WITH_ERROR: c_uint = 0x04;
pub const QHSTA_NO_ERROR: c_uint = 0x00;
...
pub const QHSTA_M_DATA_OVER_RUN: c_uint = 0x12;
pub const QHSTA_M_UNEXPECTED_BUS_FREE: c_uint = 0x13;
pub const QHSTA_M_QUEUE_ABORTED: c_uint = 0x15;
pub const QHSTA_M_SXFR_SDMA_ERR: c_uint = 0x16	/* SXFR_STATUS SCSI DMA Error */;
pub const QHSTA_M_SXFR_SXFR_PERR: c_uint = 0x17	/* SXFR_STATUS SCSI Bus Parity Error */;
pub const QHSTA_M_RDMA_PERR: c_uint = 0x18	/* RISC PCI DMA parity error */;
pub const QHSTA_M_SXFR_OFF_UFLW: c_uint = 0x19	/* SXFR_STATUS Offset Underflow */;
pub const QHSTA_M_SXFR_OFF_OFLW: c_uint = 0x20	/* SXFR_STATUS Offset Overflow */;
pub const QHSTA_M_SXFR_WD_TMO: c_uint = 0x21	/* SXFR_STATUS Watchdog Timeout */;
pub const QHSTA_M_SXFR_DESELECTED: c_uint = 0x22	/* SXFR_STATUS Deselected */;
// Note: QHSTA_M_SXFR_XFR_OFLW is identical to QHSTA_M_DATA_OVER_RUN.
pub const QHSTA_M_SXFR_XFR_OFLW: c_uint = 0x12	/* SXFR_STATUS Transfer Overflow */;
pub const QHSTA_M_SXFR_XFR_PH_ERR: c_uint = 0x24	/* SXFR_STATUS Transfer Phase Error */;
pub const QHSTA_M_SXFR_UNKNOWN_ERROR: c_uint = 0x25	/* SXFR_STATUS Unknown Error */;
pub const QHSTA_M_SCSI_BUS_RESET: c_uint = 0x30	/* Request aborted from SBR */;
pub const QHSTA_M_SCSI_BUS_RESET_UNSOL: c_uint = 0x31	/* Request aborted from unsol. SBR */;
pub const QHSTA_M_BUS_DEVICE_RESET: c_uint = 0x32	/* Request aborted from BDR */;
pub const QHSTA_M_DIRECTION_ERR: c_uint = 0x35	/* Data Phase mismatch */;
pub const QHSTA_M_DIRECTION_ERR_HUNG: c_uint = 0x36	/* Data Phase mismatch and bus hang */;
pub const QHSTA_M_WTM_TIMEOUT: c_uint = 0x41;
pub const QHSTA_M_BAD_CMPL_STATUS_IN: c_uint = 0x42;
pub const QHSTA_M_NO_AUTO_REQ_SENSE: c_uint = 0x43;
pub const QHSTA_M_AUTO_REQ_SENSE_FAIL: c_uint = 0x44;
pub const QHSTA_M_INVALID_DEVICE: c_uint = 0x45	/* Bad target ID */;
pub const QHSTA_M_FROZEN_TIDQ: c_uint = 0x46	/* TID Queue frozen. */;
pub const QHSTA_M_SGBACKUP_ERROR: c_uint = 0x47	/* Scatter-Gather backup error */;
...
pub const ASC_IS_WIDE_BOARD: c_uint = 0x04	/* AdvanSys Wide Board */;

pub const NO_ISA_DMA: c_uint = 0xff	/* No ISA DMA Channel Used */;

// Asc Library return codes
pub const ASC_TRUE: c_int = 1;
pub const ASC_FALSE: c_int = 0;
pub const ASC_NOERROR: c_int = 1;
pub const ASC_BUSY: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct asc_stats {
// Driver Entrypoint Statistics
    pub /: *mut *mut unsigned int queuecommand; / # calls to advansys_queuecommand(),
    pub /: *mut *mut unsigned int reset; / # calls to advansys_eh_bus_reset(),
    pub /: *mut *mut unsigned int biosparam; / # calls to advansys_biosparam(),
    pub /: *mut *mut unsigned int interrupt; / # advansys_interrupt() calls,
    pub /: *mut *mut unsigned int callback; / # calls to asc/adv_isr_callback(),
    pub /: *mut *mut unsigned int done; / # calls to request's scsi_done function,
    pub /: *mut *mut unsigned int build_error; / # asc/adv_build_req() ASC_ERROR returns.,
    pub /: *mut *mut unsigned int adv_build_noreq; / # adv_build_req() adv_req_t alloc. fail.,
    pub /: *mut *mut unsigned int adv_build_nosg; / # adv_build_req() adv_sgblk_t alloc. fail.,
// AscExeScsiQueue()/AdvExeScsiQueue() Statistics
    pub /: *mut *mut unsigned int exe_noerror; / # ASC_NOERROR returns.,
    pub /: *mut *mut unsigned int exe_busy; / # ASC_BUSY returns.,
    pub /: *mut *mut unsigned int exe_error; / # ASC_ERROR returns.,
    pub /: *mut *mut unsigned int exe_unknown; / # unknown returns.,
// Data Transfer Statistics
    pub /: *mut *mut unsigned int xfer_cnt; / # I/O requests received,
    pub /: *mut *mut unsigned int xfer_elem; / # scatter-gather elements,
    pub /: *mut *mut unsigned int xfer_sect; / # 512-byte blocks,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct asc_board {
    pub dev: *mut device,
    pub shost: *mut Scsi_Host,
    pub /: *mut *mut uint flags; / Board flags,
    pub irq: c_uint,
    union {
    pub /: *mut *mut ASC_DVC_VAR asc_dvc_var; / Narrow board,
    pub /: *mut *mut ADV_DVC_VAR adv_dvc_var; / Wide board,
    pub dvc_var: },
    union {
    pub /: *mut *mut ASC_DVC_CFG asc_dvc_cfg; / Narrow board,
    pub /: *mut *mut ADV_DVC_CFG adv_dvc_cfg; / Wide board,
    pub dvc_cfg: },
    pub /: *mut *mut ushort asc_n_io_port; / Number I/O ports.,
    pub /: *mut *mut ADV_SCSI_BIT_ID_TYPE init_tidmask; / Target init./valid mask,
    pub /: *mut *mut ushort reqcnt[ADV_MAX_TID + 1]; / Starvation request count,
    pub /: *mut *mut ADV_SCSI_BIT_ID_TYPE queue_full; / Queue full mask,
    pub /: *mut *mut ushort queue_full_cnt[ADV_MAX_TID + 1]; / Queue full count,
    union {
    pub /: *mut *mut ASCEEP_CONFIG asc_eep; / Narrow EEPROM config.,
    pub /: *mut *mut ADVEEP_3550_CONFIG adv_3550_eep; / 3550 EEPROM config.,
    pub /: *mut *mut ADVEEP_38C0800_CONFIG adv_38C0800_eep; / 38C0800 EEPROM config.,
    pub /: *mut *mut ADVEEP_38C1600_CONFIG adv_38C1600_eep; / 38C1600 EEPROM config.,
    pub eep_config: },
// /proc/scsi/advansys/[0...]

    pub /: *mut *mut asc_stats asc_stats; / Board statistics,

//
// The following fields are used only for Narrow Boards.
//
    pub /: *mut *mut uchar sdtr_data[ASC_MAX_TID + 1]; / SDTR information,
//
// The following fields are used only for Wide Boards.
//
    pub /: *mut *mut *mut void __iomem ioremap_addr; / I/O Memory remap address.,
    pub /: *mut *mut ushort ioport; / I/O Port address.,
    pub /: *mut *mut *mut adv_req_t adv_reqp; / Request structures.,
    pub adv_reqp_addr: dma_addr_t,
    pub adv_reqp_size: usize,
    pub /: *mut *mut *mut dma_pool adv_sgblk_pool; / Scatter-gather structures.,
    pub /: *mut *mut ushort bios_signature; / BIOS Signature.,
    pub /: *mut *mut ushort bios_version; / BIOS Version.,
    pub /: *mut *mut ushort bios_codeseg; / BIOS Code Segment.,
    pub /: *mut *mut ushort bios_codelen; / BIOS Code Segment Length.,
}
...
pub struct advansys_cmd {
    ...
    let mut asc_dbglvl: static int = 3;
//
// asc_prt_asc_dvc_var()
//
#[no_mangle]
unsafe extern "C" fn asc_prt_asc_dvc_var(h: *mut ASC_DVC_VAR) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_asc_dvc_cfg(h: *mut ASC_DVC_CFG) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_adv_dvc_var(h: *mut ADV_DVC_VAR) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_adv_dvc_cfg(h: *mut ADV_DVC_CFG) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_scsi_host(s: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_hex(f: *mut c_char, s: *mut c_uchar, l: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_asc_scsi_q(q: *mut ASC_SCSI_Q) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_asc_qdone_info(q: *mut ASC_QDONE_INFO) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_adv_sgblock(sgblockno: c_int, b: *mut ADV_SG_BLOCK) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_adv_scsi_req_q(q: *mut ADV_SCSI_REQ_Q) {
...
// Display the request's ADV_SG_BLOCK structures.
    if (q.sg_list_ptr != core::ptr::null_mut()) {
...
//
    ...
    char *busname;
    char *widename = core::ptr::null_mut();
    if (ASC_NARROW_BOARD(boardp)) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_board_devices(m: *mut seq_file, shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_adv_bios(m: *mut seq_file, shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_get_eeprom_string(serialnum: *mut c_ushort, cp: *mut c_uchar) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_asc_board_eeprom(m: *mut seq_file, shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0xBB: ep->adapter_info[5] ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_adv_board_eeprom(m: *mut seq_file, shost: *mut Scsi_Host) {
    ...
    char *termstr;
    uchar serialstr[13];
    ADVEEP_3550_CONFIG *ep_3550 = core::ptr::null_mut();
    ADVEEP_38C0800_CONFIG *ep_38C0800 = core::ptr::null_mut();
    ADVEEP_38C1600_CONFIG *ep_38C1600 = core::ptr::null_mut();
    ushort word;
    ushort *wordp;
    let mut sdtr_speed: c_ushort = 0;
    adv_dvc_varp = &boardp.dvc_var.adv_dvc_var;
    if (adv_dvc_varp.chip_type == ADV_CHIP_ASC3550) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ADV_CHIP_ASC38C0800: adv_dvc_varp->chip_type ==) -> else {
    else if (adv_dvc_varp.chip_type == ADV_CHIP_ASC38C0800)
    seq_printf(m,
    " Host SCSI ID: %u, Host Queue Size: %u, Device Queue Size: %u\n",
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_driver_conf(m: *mut seq_file, shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_asc_board_info(m: *mut seq_file, shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_adv_board_info(m: *mut seq_file, shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_prt_board_stats(m: *mut seq_file, shost: *mut Scsi_Host) {
...
#[no_mangle]
unsafe extern "C" fn asc_scsi_done(scp: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn AscSetBank(iop_base: PortAddr, bank: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn AscSetChipIH(iop_base: PortAddr, ins_code: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn AscStartChip(iop_base: PortAddr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscStopChip(iop_base: PortAddr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn AscIsChipHalted(iop_base: PortAddr) -> bool {
...
#[no_mangle]
unsafe extern "C" fn AscResetChipAndScsiBus(asc_dvc: *mut ASC_DVC_VAR) -> bool {
...
#[no_mangle]
unsafe extern "C" fn AscFindSignature(iop_base: PortAddr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscEnableInterrupt(iop_base: PortAddr) {
...
#[no_mangle]
unsafe extern "C" fn AscDisableInterrupt(iop_base: PortAddr) {
...
#[no_mangle]
unsafe extern "C" fn AscReadLramByte(iop_base: PortAddr, addr: c_ushort) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn AscReadLramWord(iop_base: PortAddr, addr: c_ushort) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn AscWriteLramWord(iop_base: PortAddr, addr: c_ushort, word_val: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn AscWriteLramByte(iop_base: PortAddr, addr: c_ushort, byte_val: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn AscMemSumLramWord(iop_base: PortAddr, s_addr: c_ushort, words: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn AscInitLram(asc_dvc: *mut ASC_DVC_VAR) {
...
#[no_mangle]
unsafe extern "C" fn AscInitQLinkVar(asc_dvc: *mut ASC_DVC_VAR) {
...
#[no_mangle]
unsafe extern "C" fn AscInitMicroCodeVar(asc_dvc: *mut ASC_DVC_VAR) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscInitAsc1000Driver(asc_dvc: *mut ASC_DVC_VAR) -> c_int {
...
//
    ...
    if (buf[i] == 0xff) {
    let mut word: c_ushort = (buf[i + 3] << 8) | buf[i + 2];
    for (j = 0; j < buf[i + 1]; j++) {
    ...
    let mut word: c_ushort = (buf[i + 2] << 8) | buf[i + 1];
    AdvWriteWordAutoIncLram(iop_base, word);
    i += 2;
    len += 2;
    } else {
    let mut off: c_uint = buf[i] * 2;
    let mut word: c_ushort = (buf[off + 1] << 8) | buf[off];
    AdvWriteWordAutoIncLram(iop_base, word);
    len += 2;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn AdvBuildCarrierFreelist(adv_dvc: *mut adv_dvc_var) {
    static void AdvBuildCarrierFreelist(struct adv_dvc_var *adv_dvc)
    {
    let mut carr_offset: off_t = 0, next_offset;
    dma_addr_t carr_paddr;
    let mut carr_num: c_int = ADV_CARRIER_BUFSIZE / sizeof(ADV_CARR_T), i;
...
//
    ...
    let mut next_vpa: u32 = le32_to_cpu(carrp.next_vpa);
...
//
#[no_mangle]
unsafe extern "C" fn adv_get_reqp(adv_dvc: *mut adv_dvc_var, offset: u32) -> *mut adv_req_t {
...
//
#[no_mangle]
unsafe extern "C" fn AdvResetSB(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn AdvInitAsc3550Driver(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
    ...
    let mut wdtr_able: c_ushort = 0, sdtr_able, tagqng_able;
...
//
#[no_mangle]
unsafe extern "C" fn AdvInitAsc38C0800Driver(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn AdvInitAsc38C1600Driver(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn AdvResetChipAndSB(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
    static int AdvResetChipAndSB(ADV_DVC_VAR *asc_dvc)
    {
    int status;
    ushort wdtr_able, sdtr_able, tagqng_able;
    let mut ppr_able: c_ushort = 0;
...
//
#[no_mangle]
unsafe extern "C" fn adv_async_callback(adv_dvc_varp: *mut ADV_DVC_VAR, code: c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn adv_isr_callback(adv_dvc_varp: *mut ADV_DVC_VAR, scsiqp: *mut ADV_SCSI_REQ_Q) {
...
//
    ...
    ASC_DBG(1, "scp 0x%p\n", scp);
    if (scp == core::ptr::null_mut()) {
    ASC_PRINT
    ("adv_isr_callback: scp is core::ptr::null_mut(); adv_req_t dropped.\n");
    return;
    }
    ASC_DBG_PRT_CDB(2, scp.cmnd, scp.cmd_len);
    reqp = (adv_req_t *)scp.host_scribble;
    ASC_DBG(1, "reqp 0x%lx\n", (ulong)reqp);
    if (reqp == core::ptr::null_mut()) {
    ASC_PRINT("adv_isr_callback: reqp is core::ptr::null_mut()\n");
    return;
    }
//
...
// command completions.
//
    scp.host_scribble = core::ptr::null_mut();
    reqp.cmndp = core::ptr::null_mut();
...
//
    while ((sgblkp = reqp.sgblkp) != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn AdvISR(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
...
// in AdvExeScsiQueue().
//
    let mut pa_offset: u32 = le32_to_cpu(asc_dvc.irq_sp.areq_vpa);
...
#[no_mangle]
unsafe extern "C" fn AscSetLibErrorCode(asc_dvc: *mut ASC_DVC_VAR, err_code: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscAckInterrupt(iop_base: PortAddr) {
...
#[no_mangle]
unsafe extern "C" fn AscGetSynPeriodIndex(asc_dvc: *mut ASC_DVC_VAR, syn_time: c_uchar) -> c_uchar {
    ...
    {
    let mut iop_base: PortAddr = asc_dvc.iop_base;
    let mut sdtr_period_index: c_uchar = AscGetSynPeriodIndex(asc_dvc, sdtr_period);
    EXT_MSG sdtr_buf = {
...
#[no_mangle]
unsafe extern "C" fn AscSetChipSynRegAtID(iop_base: PortAddr, id: c_uchar, sdtr_data: c_uchar) -> bool {
    static bool AscSetChipSynRegAtID(PortAddr iop_base, uchar id, uchar sdtr_data)
    {
    ASC_SCSI_BIT_ID_TYPE org_id;
    int i;
    let mut sta: bool = true;
    AscSetBank(iop_base, 1);
...
#[no_mangle]
unsafe extern "C" fn AscSetChipSDTR(iop_base: PortAddr, sdtr_data: c_uchar, tid_no: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn AscIsrChipHalted(asc_dvc: *mut ASC_DVC_VAR) {
...
//
#[no_mangle]
unsafe extern "C" fn asc_isr_callback(asc_dvc_varp: *mut ASC_DVC_VAR, qdonep: *mut ASC_QDONE_INFO) {
...
#[no_mangle]
unsafe extern "C" fn AscIsrQDone(asc_dvc: *mut ASC_DVC_VAR) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscISR(asc_dvc: *mut ASC_DVC_VAR) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn advansys_reset(scp: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn advansys_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn AscHostReqRiscHalt(iop_base: PortAddr) -> bool {
    static bool AscHostReqRiscHalt(PortAddr iop_base)
    {
    let mut count: c_int = 0;
    let mut sta: bool = false;
...
#[no_mangle]
unsafe extern "C" fn AscAsyncFix(asc_dvc: *mut ASC_DVC_VAR, sdev: *mut scsi_device) {
    static void AscAsyncFix(ASC_DVC_VAR *asc_dvc, struct scsi_device *sdev)
    {
    let mut type: c_char = sdev.type;
    let mut tid_bits: ASC_SCSI_BIT_ID_TYPE = 1 << sdev.id;
    ...
    {
    let mut tid_bit: ASC_SCSI_BIT_ID_TYPE = 1 << sdev.id;
    let mut orig_use_tagged_qng: ASC_SCSI_BIT_ID_TYPE = asc_dvc.use_tagged_qng;
    if (sdev.lun == 0) {
    let mut orig_init_sdtr: ASC_SCSI_BIT_ID_TYPE = asc_dvc.init_sdtr;
...
//
    ...
    {
    let mut iop_base: AdvPortAddr = adv_dvc.iop_base;
    let mut tidmask: c_ushort = 1 << sdev.id;
    if (sdev.lun == 0) {
//
...
#[no_mangle]
unsafe extern "C" fn asc_get_sense_buffer_dma(scp: *mut scsi_cmnd) -> __le32 {
...
//
    ...
    slp = scsi_sglist(scp);
    sg_elem_cnt = use_sg;
    prev_sgblkp = core::ptr::null_mut();
    prev_sg_block = core::ptr::null_mut();
    reqp.sgblkp = core::ptr::null_mut();
    for (;;) {
//
...
// Remove 'sgblkp' from the request list.
    reqp.sgblkp = sgblkp.next_sgblkp;
    sgblkp.next_sgblkp = core::ptr::null_mut();
    dma_pool_free(boardp.adv_sgblk_pool, sgblkp,
    sgblkp.sg_addr);
    }
    return ASC_BUSY;
...
// request.
//
    if (reqp.sgblkp == core::ptr::null_mut()) {
...
//
    ...
    adv_req_t **adv_reqpp)
    {
    let mut srb_tag: u32 = scsi_cmd_to_rq(scp).tag;
    adv_req_t *reqp;
...
// Copy last 4 CDB bytes, if present, to cdb16[].
    if (scp.cmd_len > 12) {
    let mut cdb16_len: c_int = scp.cmd_len - 12;
...
// Zero-length transfer
    ...
    scsiqp.data_cnt = 0;
    scsiqp.data_addr = 0;
    scsiqp.sg_list_ptr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn AscSgListToQueue(sg_list: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscAllocFreeQueue(iop_base: PortAddr, free_q_head: c_uchar) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn AscPutReadyQueue(asc_dvc: *mut ASC_DVC_VAR, scsiq: *mut ASC_SCSI_Q, q_no: c_uchar) -> c_int {
...
pub const ASC_SYN_OFFSET_ONE_DISABLE_LIST: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn AscExeScsiQueue(asc_dvc: *mut ASC_DVC_VAR, scsiq: *mut ASC_SCSI_Q) -> c_int {
    ...
    int i;
    u32 addr;
    let mut sg_entry_cnt: c_ushort = 0;
    let mut sg_entry_cnt_minus_one: c_ushort = 0;
    uchar target_ix;
    uchar tid_no;
    uchar sdtr_data;
    uchar extra_bytes;
...
//
#[no_mangle]
unsafe extern "C" fn AdvExeScsiQueue(asc_dvc: *mut ADV_DVC_VAR, reqp: *mut adv_req_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn asc_execute_scsi_cmnd(scp: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn advansys_queuecommand_lck(scp: *mut scsi_cmnd) -> enum scsi_qc_status {
    static enum scsi_qc_status advansys_queuecommand_lck(struct scsi_cmnd *scp)
    {
    struct Scsi_Host *shost = scp.device.host;
    let mut result: enum scsi_qc_status = 0;
    int asc_res;
...
#[no_mangle]
pub unsafe extern "C" fn DEF_SCSI_QCMD(_arg: advansys_queuecommand) -> static {
    static DEF_SCSI_QCMD(advansys_queuecommand)
#[no_mangle]
unsafe extern "C" fn AscGetEisaChipCfg(iop_base: PortAddr) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn AscSetChipScsiID(iop_base: PortAddr, new_host_id: c_uchar) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn AscGetChipScsiCtrl(iop_base: PortAddr) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn AscStopQueueExe(iop_base: PortAddr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscGetMaxDmaCount(bus_type: c_ushort) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn AscInitAscDvcVar(asc_dvc: *mut ASC_DVC_VAR) {
...
#[no_mangle]
unsafe extern "C" fn AscWriteEEPCmdReg(iop_base: PortAddr, cmd_reg: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscWaitEEPRead() {
    static void AscWaitEEPRead(void)
    {
    mdelay(1);
    }
#[no_mangle]
unsafe extern "C" fn AscReadEEPWord(iop_base: PortAddr, addr: c_uchar) -> c_ushort {
    ...
    int cfg_beg;
    int cfg_end;
    let mut uchar_end_in_config: c_int = ASC_EEP_MAX_DVC_ADDR - 2;
    int s_addr;
    wbuf = (ushort *)cfg_buf;
    sum = 0;
...
#[no_mangle]
unsafe extern "C" fn AscTestExternalLram(asc_dvc: *mut ASC_DVC_VAR) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscWaitEEPWrite() {
    static void AscWaitEEPWrite(void)
    {
    mdelay(20);
    }
#[no_mangle]
unsafe extern "C" fn AscWriteEEPDataReg(iop_base: PortAddr, data_reg: c_ushort) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscWriteEEPWord(iop_base: PortAddr, addr: c_uchar, word_val: c_ushort) -> c_ushort {
...
#[no_mangle]
unsafe extern "C" fn AscInitFromEEP(asc_dvc: *mut ASC_DVC_VAR) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn AscInitGetConfig(shost: *mut Scsi_Host) -> c_int {
    static int AscInitGetConfig(struct Scsi_Host *shost)
    {
    struct asc_board *board = shost_priv(shost);
    ASC_DVC_VAR *asc_dvc = &board.dvc_var.asc_dvc_var;
    let mut warn_code: c_ushort = 0;
...
#[no_mangle]
unsafe extern "C" fn AscInitSetConfig(pdev: *mut pci_dev, shost: *mut Scsi_Host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn AdvWaitEEPCmd(iop_base: AdvPortAddr) {
...
//
#[no_mangle]
unsafe extern "C" fn AdvReadEEPWord(iop_base: AdvPortAddr, eep_word_addr: c_int) -> c_ushort {
...
//
#[no_mangle]
unsafe extern "C" fn AdvInitFrom3550EEP(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn AdvInitFrom38C0800EEP(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn AdvInitFrom38C1600EEP(asc_dvc: *mut ADV_DVC_VAR) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn AdvInitGetConfig(pdev: *mut pci_dev, shost: *mut Scsi_Host) -> c_int {
    static int AdvInitGetConfig(struct pci_dev *pdev, struct Scsi_Host *shost)
    {
    struct asc_board *board = shost_priv(shost);
    ADV_DVC_VAR *asc_dvc = &board.dvc_var.adv_dvc_var;
    let mut warn_code: c_ushort = 0;
    let mut iop_base: AdvPortAddr = asc_dvc.iop_base;
    u16 cmd;
    int status;
    asc_dvc.err_code = 0;
//
...
#[no_mangle]
unsafe extern "C" fn advansys_wide_init_chip(shost: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn advansys_wide_free_mem(board: *mut asc_board) {
    ...
    struct pci_dev *pdev;
    struct asc_board *boardp = shost_priv(shost);
    ASC_DVC_VAR *asc_dvc_varp = core::ptr::null_mut();
    ADV_DVC_VAR *adv_dvc_varp = core::ptr::null_mut();
    int share_irq, warn_code, ret;
    pdev = (bus_type == ASC_IS_PCI) ? to_pci_dev(boardp.dev) : core::ptr::null_mut();
    if (ASC_NARROW_BOARD(boardp)) {
...
//
#[no_mangle]
unsafe extern "C" fn advansys_release(shost: *mut Scsi_Host) -> c_int {
...
pub const ASC_IOADR_TABLE_MAX_IX: c_int = 11;
    static PortAddr _asc_def_iop_base[ASC_IOADR_TABLE_MAX_IX] = {
    0x100, 0x0110, 0x120, 0x0130, 0x140, 0x0150, 0x0190,
    0x0210, 0x0230, 0x0250, 0x0330
    };
#[no_mangle]
unsafe extern "C" fn advansys_vlb_remove(dev: *mut device, id: c_uint) {
    static void advansys_vlb_remove(struct device *dev, unsigned int id)
    {
    let mut ioport: c_int = _asc_def_iop_base[id];
...
//
#[no_mangle]
unsafe extern "C" fn advansys_vlb_irq_no(iop_base: PortAddr) -> c_uint {
    static unsigned int advansys_vlb_irq_no(PortAddr iop_base)
    {
    let mut cfg_lsw: c_ushort = AscGetChipCfgLsw(iop_base);
    let mut chip_irq: c_uint = ((cfg_lsw >> 2) & 0x07) + 9;
    if ((chip_irq < 10) || (chip_irq == 13) || (chip_irq > 15))
    return 0;
    return chip_irq;
    }
#[no_mangle]
unsafe extern "C" fn advansys_vlb_probe(dev: *mut device, id: c_uint) -> c_int {
    static int advansys_vlb_probe(struct device *dev, unsigned int id)
    {
    let mut err: c_int = -ENODEV;
    let mut iop_base: PortAddr = _asc_def_iop_base[id];
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eisa_scsi_data {
    pub host: [*mut Scsi_Host; 2],
}
...
//
#[no_mangle]
unsafe extern "C" fn advansys_eisa_irq_no(edev: *mut eisa_device) -> c_uint {
    static unsigned int advansys_eisa_irq_no(struct eisa_device *edev)
    {
    let mut cfg_lsw: c_ushort = inw(edev.base_addr + 0xc86);
    let mut chip_irq: c_uint = ((cfg_lsw >> 8) & 0x07) + 10;
    if ((chip_irq == 13) || (chip_irq > 15))
    return 0;
    return chip_irq;
    }
#[no_mangle]
unsafe extern "C" fn advansys_eisa_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn advansys_eisa_remove(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn advansys_set_latency(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn advansys_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn advansys_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn advansys_exit() -> void __exit {
