...
//! Source: drivers/scsi/aacraid/sa.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aac_sa_intr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn aac_sa_disable_interrupt(dev: *mut aac_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_sa_enable_interrupt(dev: *mut aac_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_sa_notify_adapter(dev: *mut aac_dev, event: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_sa_interrupt_adapter(dev: *mut aac_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_sa_start_adapter(dev: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_sa_restart_adapter(dev: *mut aac_dev, bled: c_int, reset_type: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_sa_check_health(dev: *mut aac_dev) -> c_int {
    static int aac_sa_check_health(struct aac_dev *dev)
    {
    let mut status: c_long = sa_readl(dev, Mailbox7);
//
...
//
#[no_mangle]
unsafe extern "C" fn aac_sa_ioremap(dev: *mut *mut aac_dev, size: u32) -> c_int {
    ...
    return (dev.base == core::ptr::null_mut()) ? -1 : 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_sa_init(dev: *mut aac_dev) -> c_int {
