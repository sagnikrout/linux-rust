...
//! Source: drivers/scsi/aacraid/commsup.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn fib_map_alloc(dev: *mut aac_dev) -> c_int {
...
// (dev->scsi_host_ptr->can_queue + AAC_NUM_MGT_FIB) + (ALIGN32 - 1),
    ...
    if (dev.hw_fib_va == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_fib_map_free(dev: *mut aac_dev) {
    ...
    dev.hw_fib_pa);
    dev.hw_fib_va = core::ptr::null_mut();
    dev.hw_fib_pa = 0;
    }
#[no_mangle]
pub unsafe extern "C" fn aac_fib_vector_assign(dev: *mut aac_dev) {
    void aac_fib_vector_assign(struct aac_dev *dev)
    {
    let mut i: u32 = 0;
    let mut vector: u32 = 1;
    struct fib *fibptr = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_fib_setup(dev: *mut *mut aac_dev) -> c_int {
...
//
    dev.fibs[dev.scsi_host_ptr.can_queue + AAC_NUM_MGT_FIB - 1].next = core::ptr::null_mut();
//
...
//
    ...
    fibptr.callback_data = core::ptr::null_mut();
    fibptr.callback = core::ptr::null_mut();
    fibptr.flags = 0;
    return fibptr;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_fib_free(fibptr: *mut fib) {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_fib_init(fibptr: *mut fib) {
...
//
#[no_mangle]
unsafe extern "C" fn fib_dealloc(fibptr: *mut *mut fib) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_get_entry(dev: *mut *mut aac_dev, qid: u32, entry: *mut aac_entry, index: *mut *mut u32, nonotify: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_queue_get(dev: *mut *mut aac_dev, index: *mut *mut u32, qid: u32, hw_fib: *mut *mut hw_fib, wait: c_int, fibptr: *mut *mut fib, nonotify: *mut c_ulong) -> c_int {
    int aac_queue_get(struct aac_dev * dev, u32 * index, u32 qid, struct hw_fib * hw_fib, int wait, struct fib * fibptr, unsigned long *nonotify)
    {
    let mut entry: *mut aac_entry = core::ptr::null_mut();
    let mut map: c_int = 0;
    if (qid == AdapNormCmdQueue) {
...
//
    ...
    void *callback_data)
    {
    let mut dev: *mut aac_dev = fibptr.dev;
    let mut hw_fib: *mut hw_fib = fibptr.hw_fib_va;
    let mut flags: c_ulong = 0;
    let mut mflags: c_ulong = 0;
    let mut sflags: c_ulong = 0;
...
//
    ...
    let mut q: *mut aac_queue = &dev.queues.queue[AdapNormCmdQueue];
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_consumer_get(dev: *mut *mut aac_dev, q: *mut *mut aac_queue, entry: *mut aac_entry) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_consumer_free(dev: *mut *mut aac_dev, q: *mut aac_queue, qid: u32) {
    void aac_consumer_free(struct aac_dev * dev, struct aac_queue *q, u32 qid)
    {
    let mut wasfull: c_int = 0;
    u32 notify;
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_fib_adapter_complete(fibptr: *mut fib, size: c_ushort) -> c_int {
    int aac_fib_adapter_complete(struct fib *fibptr, unsigned short size)
    {
    let mut hw_fib: *mut hw_fib = fibptr.hw_fib_va;
    let mut dev: *mut aac_dev = fibptr.dev;
    struct aac_queue * q;
    let mut nointr: c_ulong = 0;
...
//
    ...
    aac_queue_get(dev, &index, AdapNormRespQueue, hw_fib, 1, core::ptr::null_mut(), &nointr);
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_fib_complete(fibptr: *mut fib) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(cpu_to_le32(SentFromHost): hw_fib->header.XferState &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_printf(dev: *mut aac_dev, val: u32) {
    void aac_printf(struct aac_dev *dev, u32 val)
    {
    char *cp = dev.printfbuf;
    if (dev.printf_enabled)
    {
    let mut length: c_int = val & 0xffff;
    let mut level: c_int = (val >> 16) & 0xffff;
//
...
#[no_mangle]
pub unsafe extern "C" fn aac_aif_data(aifcmd: *mut aac_aifcmd, index: u32) -> c_int {
    static inline int aac_aif_data(struct aac_aifcmd *aifcmd, uint32_t index)
    {
    return le32_to_cpu(((__le32 *)aifcmd.data)[index]);
    }
#[no_mangle]
unsafe extern "C" fn aac_handle_aif_bu(dev: *mut aac_dev, aifcmd: *mut aac_aifcmd) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_handle_aif(dev: *mut *mut aac_dev, fibptr: *mut *mut fib) {
    static void aac_handle_aif(struct aac_dev * dev, struct fib * fibptr)
    {
    let mut hw_fib: *mut hw_fib = fibptr.hw_fib_va;
    let mut aifcmd: *mut aac_aifcmd = (struct aac_aifcmd *)hw_fib.data;
...
//
    if ((dev != core::ptr::null_mut()) && (dev.scsi_host_ptr != core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn aac_schedule_bus_scan(aac: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn _aac_reset_adapter(aac: *mut aac_dev, forced: c_int, reset_type: u8) -> c_int {
    static int _aac_reset_adapter(struct aac_dev *aac, int forced, u8 reset_type)
    {
    int index, quirks;
    int retval;
    struct Scsi_Host *host = aac.scsi_host_ptr;
    let mut jafo: c_int = 0;
    int bled;
    u64 dmamask;
    let mut num_of_fibs: c_int = 0;
//
// Assumptions:
...
//
    ...
    let mut XferState: __le32 = fib.hw_fib_va.header.XferState;
    let mut is_response_expected: bool = false;
...
//
    ...
    aac.comm_addr = core::ptr::null_mut();
    aac.comm_phys = 0;
    kfree(aac.queues);
    aac.queues = core::ptr::null_mut();
    kfree(aac.fsa_dev);
    aac.fsa_dev = core::ptr::null_mut();
    dmamask = DMA_BIT_MASK(32);
    quirks = aac_get_driver_ident(index).quirks;
    if (quirks & AAC_QUIRK_31BIT)
    retval = dma_set_mask(&aac.pdev.dev, dmamask);
#[no_mangle]
pub unsafe extern "C" fn if(AAC_QUIRK_SRC): !(quirks &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn aac_reset_adapter(aac: *mut aac_dev, forced: c_int, reset_type: u8) -> c_int {
    int aac_reset_adapter(struct aac_dev *aac, int forced, u8 reset_type)
    {
    let mut flagv: c_ulong = 0;
...
// Unwind aac_send_shutdown() IOP_RESET unsupported/disabled
    let mut fibctx: *mut fib = aac_fib_alloc(aac);
    if (fibctx) {
...
#[no_mangle]
pub unsafe extern "C" fn is_safw_raid_volume(aac: *mut aac_dev, bus: c_int, target: c_int) -> c_int {
    static inline int is_safw_raid_volume(struct aac_dev *aac, int bus, int target)
    {
    let mut bus: return = = CONTAINER_CHANNEL && target < aac.maximum_num_containers;
    }
...
#[no_mangle]
unsafe extern "C" fn aac_add_safw_device(dev: *mut aac_dev, bus: c_int, target: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_put_safw_scsi_device(sdev: *mut scsi_device) {
...
#[no_mangle]
unsafe extern "C" fn aac_remove_safw_device(dev: *mut aac_dev, bus: c_int, target: c_int) {
...
#[no_mangle]
unsafe extern "C" fn aac_is_safw_target_valid(dev: *mut aac_dev, bus: c_int, target: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_is_safw_device_exposed(dev: *mut aac_dev, bus: c_int, target: c_int) -> c_int {
    static int aac_is_safw_device_exposed(struct aac_dev *dev, int bus, int target)
    {
    let mut is_exposed: c_int = 0;
    struct scsi_device *sdev;
    sdev = aac_lookup_safw_scsi_device(dev, bus, target);
    if (sdev)
    is_exposed = 1;
...
#[no_mangle]
unsafe extern "C" fn aac_update_safw_host_devices(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_scan_safw_host(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aac_scan_host(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aac_src_reinit_aif_worker(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_handle_sa_aif(dev: *mut aac_dev, fibptr: *mut fib) {
...
#[no_mangle]
pub unsafe extern "C" fn if(SA_AIF_HARDWARE: fibptr->hbacmd_size &) -> else {
    else if (fibptr.hbacmd_size & SA_AIF_HARDWARE)
    events = SA_AIF_HARDWARE;
#[no_mangle]
pub unsafe extern "C" fn if(SA_AIF_PDEV_CHANGE: fibptr->hbacmd_size &) -> else {
    else if (fibptr.hbacmd_size & SA_AIF_PDEV_CHANGE)
    events = SA_AIF_PDEV_CHANGE;
#[no_mangle]
pub unsafe extern "C" fn if(SA_AIF_LDEV_CHANGE: fibptr->hbacmd_size &) -> else {
    else if (fibptr.hbacmd_size & SA_AIF_LDEV_CHANGE)
    events = SA_AIF_LDEV_CHANGE;
#[no_mangle]
pub unsafe extern "C" fn if(SA_AIF_BPSTAT_CHANGE: fibptr->hbacmd_size &) -> else {
    else if (fibptr.hbacmd_size & SA_AIF_BPSTAT_CHANGE)
    events = SA_AIF_BPSTAT_CHANGE;
#[no_mangle]
pub unsafe extern "C" fn if(SA_AIF_BPCFG_CHANGE: fibptr->hbacmd_size &) -> else {
...
#[no_mangle]
unsafe extern "C" fn get_fib_count(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_process_events(dev: *mut aac_dev) {
...
//
    ...
    FsaNormal, 1, 1, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn aac_send_safw_hostttime(dev: *mut aac_dev, now: *mut timespec64) -> c_int {
    static int aac_send_safw_hostttime(struct aac_dev *dev, struct timespec64 *now)
    {
    struct tm cur_tm;
    char wellness_str[] = "<HW>TD\010\0\0\0\0\0\0\0\0\0DW\0\0ZZ";
    let mut datasize: u32 = sizeof(wellness_str);
    time64_t local_time;
...
#[no_mangle]
unsafe extern "C" fn aac_send_hosttime(dev: *mut aac_dev, now: *mut timespec64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_command_thread(data: *mut c_void) -> c_int {
    int aac_command_thread(void *data)
    {
    struct aac_dev *dev = data;
    DECLARE_WAITQUEUE(wait, current);
    let mut next_jiffies: c_ulong = jiffies + HZ;
    let mut next_check_jiffies: c_ulong = next_jiffies;
    let mut difference: c_long = HZ;
//
...
#[no_mangle]
pub unsafe extern "C" fn aac_acquire_irq(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aac_free_irq(dev: *mut aac_dev) {
    ...
    pci_disable_msi(dev.pdev);
#[no_mangle]
pub unsafe extern "C" fn if(1: dev->max_msix >) -> else {
