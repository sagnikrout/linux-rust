...
//! Source: drivers/scsi/aacraid/src.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aac_src_intr_message(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    ...
    mode |= AAC_INT_MODE_AIF;
#[no_mangle]
pub unsafe extern "C" fn if(OUTBOUNDDOORBELL_0: bellbits_shifted &) -> else {
    ...
    dev.sync_fib = core::ptr::null_mut();
    }
...
// handle AIF
    if (dev.sa_firmware) {
    let mut events: u32 = src_readl(dev, MUnit.SCR0);
    aac_intr_normal(dev, events, 1, 0, core::ptr::null_mut());
    writel(events, &dev.IndexRegs.Mailbox[0]);
    src_writel(dev, MUnit.IDR, 1 << 23);
    } else {
    if (dev.aif_thread && dev.fsa_dev)
    aac_intr_normal(dev, 0, 2, 0, core::ptr::null_mut());
    }
    if (dev.msi_enabled)
...
// check fast response bits (30, 1)
    ...
    aac_intr_normal(dev, handle, 0, isFastResponse, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_disable_interrupt(dev: *mut aac_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_enable_interrupt_message(dev: *mut aac_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_interrupt_adapter(dev: *mut aac_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_notify_adapter(dev: *mut aac_dev, event: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_start_adapter(dev: *mut aac_dev) {
...
// reset host_rrq_idx first
    ...
    0, 0, 0, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_check_health(dev: *mut aac_dev) -> c_int {
    static int aac_src_check_health(struct aac_dev *dev)
    {
    let mut status: u32 = src_readl(dev, MUnit.OMR);
//
...
#[no_mangle]
pub unsafe extern "C" fn aac_get_vector(dev: *mut aac_dev) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_deliver_message(fib: *mut fib) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_ioremap(dev: *mut aac_dev, size: u32) -> c_int {
    static int aac_src_ioremap(struct aac_dev *dev, u32 size)
    {
    if (!size) {
    iounmap(dev.regs.src.bar1);
    dev.regs.src.bar1 = core::ptr::null_mut();
    iounmap(dev.regs.src.bar0);
    dev.base = dev.regs.src.bar0 = core::ptr::null_mut();
    return 0;
    }
    dev.regs.src.bar1 = ioremap(pci_resource_start(dev.pdev, 2),
    AAC_MIN_SRC_BAR1_SIZE);
    dev.base = core::ptr::null_mut();
    if (dev.regs.src.bar1 == core::ptr::null_mut())
    return -1;
...
//
#[no_mangle]
unsafe extern "C" fn aac_srcv_ioremap(dev: *mut aac_dev, size: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aac_set_intx_mode(dev: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_clear_omr(dev: *mut aac_dev) {
    static void aac_clear_omr(struct aac_dev *dev)
    {
    let mut omr_value: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn aac_dump_fw_fib_iop_reset(dev: *mut aac_dev) {
    ...
    0, 0, 0,  0, 0, 0, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn aac_is_ctrl_up_and_running(dev: *mut aac_dev) -> bool {
    static bool aac_is_ctrl_up_and_running(struct aac_dev *dev)
    {
    let mut ctrl_up: bool = true;
...
#[no_mangle]
unsafe extern "C" fn aac_src_drop_io(dev: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_notify_fw_of_iop_reset(dev: *mut aac_dev) {
    static void aac_notify_fw_of_iop_reset(struct aac_dev *dev)
    {
    aac_adapter_sync_cmd(dev, IOP_RESET_ALWAYS, 0, 0, 0, 0, 0, 0, core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    aac_src_drop_io(dev);
    }
#[no_mangle]
unsafe extern "C" fn aac_send_iop_reset(dev: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_send_hardware_soft_reset(dev: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_src_restart_adapter(dev: *mut aac_dev, bled: c_int, reset_type: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_select_comm(dev: *mut aac_dev, comm: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_src_init(dev: *mut aac_dev) -> c_int {
    int aac_src_init(struct aac_dev *dev)
    {
    unsigned long start;
    unsigned long status;
    let mut restart: c_int = 0;
    let mut instance: c_int = dev.id;
...
#[no_mangle]
unsafe extern "C" fn aac_src_wait_sync(dev: *mut aac_dev, status: *mut c_int) -> c_int {
    static int aac_src_wait_sync(struct aac_dev *dev, int *status)
    {
    let mut start: c_ulong = jiffies;
    let mut usecs: c_ulong = 0;
    let mut delay: c_int = 5 * HZ;
    let mut rc: c_int = 1;
    while (time_before(jiffies, start+delay)) {
//
...
//
#[no_mangle]
unsafe extern "C" fn aac_src_soft_reset(dev: *mut aac_dev) -> c_int {
    static int aac_src_soft_reset(struct aac_dev *dev)
    {
    let mut status_omr: u32 = src_readl(dev, MUnit.OMR);
    u32 status[5];
    let mut rc: c_int = 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_srcv_init(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aac_src_access_devreg(dev: *mut aac_dev, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn aac_src_get_sync_status(dev: *mut aac_dev) -> c_int {
    static int aac_src_get_sync_status(struct aac_dev *dev)
    {
    let mut msix_val: c_int = 0;
    let mut legacy_val: c_int = 0;
