...
//! Source: drivers/scsi/aacraid/aachba.c
#![no_std]
...
pub const INQD_PDT_DA: c_uint = 0x00	/* Direct-access (DISK) device */;
pub const INQD_PDT_PROC: c_uint = 0x03	/* Processor device */;
pub const INQD_PDT_CHNGR: c_uint = 0x08	/* Changer (jukebox, scsi2) */;
pub const INQD_PDT_COMM: c_uint = 0x09	/* Communication device (scsi2) */;
pub const INQD_PDT_NOLUN2: c_uint = 0x1f	/* Unknown Device (scsi2) */;
pub const INQD_PDT_NOLUN: c_uint = 0x7f	/* Logical Unit Not Present */;
pub const INQD_PDT_DMASK: c_uint = 0x1F	/* Peripheral Device Type Mask */;
pub const INQD_PDT_QMASK: c_uint = 0xE0	/* Peripheral Device Qualifer Mask */;
//
// Sense codes
//
pub const SENCODE_NO_SENSE: c_uint = 0x00;
pub const SENCODE_END_OF_DATA: c_uint = 0x00;
pub const SENCODE_BECOMING_READY: c_uint = 0x04;
pub const SENCODE_INIT_CMD_REQUIRED: c_uint = 0x04;
pub const SENCODE_UNRECOVERED_READ_ERROR: c_uint = 0x11;
pub const SENCODE_PARAM_LIST_LENGTH_ERROR: c_uint = 0x1A;
pub const SENCODE_INVALID_COMMAND: c_uint = 0x20;
pub const SENCODE_LBA_OUT_OF_RANGE: c_uint = 0x21;
pub const SENCODE_INVALID_CDB_FIELD: c_uint = 0x24;
pub const SENCODE_LUN_NOT_SUPPORTED: c_uint = 0x25;
pub const SENCODE_INVALID_PARAM_FIELD: c_uint = 0x26;
pub const SENCODE_PARAM_NOT_SUPPORTED: c_uint = 0x26;
pub const SENCODE_PARAM_VALUE_INVALID: c_uint = 0x26;
pub const SENCODE_RESET_OCCURRED: c_uint = 0x29;
pub const SENCODE_LUN_NOT_SELF_CONFIGURED_YET: c_uint = 0x3E;
pub const SENCODE_INQUIRY_DATA_CHANGED: c_uint = 0x3F;
pub const SENCODE_SAVING_PARAMS_NOT_SUPPORTED: c_uint = 0x39;
pub const SENCODE_DIAGNOSTIC_FAILURE: c_uint = 0x40;
pub const SENCODE_INTERNAL_TARGET_FAILURE: c_uint = 0x44;
pub const SENCODE_INVALID_MESSAGE_ERROR: c_uint = 0x49;
pub const SENCODE_LUN_FAILED_SELF_CONFIG: c_uint = 0x4c;
pub const SENCODE_OVERLAPPED_COMMAND: c_uint = 0x4E;
//
// Additional sense codes
//
pub const ASENCODE_NO_SENSE: c_uint = 0x00;
pub const ASENCODE_END_OF_DATA: c_uint = 0x05;
pub const ASENCODE_BECOMING_READY: c_uint = 0x01;
pub const ASENCODE_INIT_CMD_REQUIRED: c_uint = 0x02;
pub const ASENCODE_PARAM_LIST_LENGTH_ERROR: c_uint = 0x00;
pub const ASENCODE_INVALID_COMMAND: c_uint = 0x00;
pub const ASENCODE_LBA_OUT_OF_RANGE: c_uint = 0x00;
pub const ASENCODE_INVALID_CDB_FIELD: c_uint = 0x00;
pub const ASENCODE_LUN_NOT_SUPPORTED: c_uint = 0x00;
pub const ASENCODE_INVALID_PARAM_FIELD: c_uint = 0x00;
pub const ASENCODE_PARAM_NOT_SUPPORTED: c_uint = 0x01;
pub const ASENCODE_PARAM_VALUE_INVALID: c_uint = 0x02;
pub const ASENCODE_RESET_OCCURRED: c_uint = 0x00;
pub const ASENCODE_LUN_NOT_SELF_CONFIGURED_YET: c_uint = 0x00;
pub const ASENCODE_INQUIRY_DATA_CHANGED: c_uint = 0x03;
pub const ASENCODE_SAVING_PARAMS_NOT_SUPPORTED: c_uint = 0x00;
pub const ASENCODE_DIAGNOSTIC_FAILURE: c_uint = 0x80;
pub const ASENCODE_INTERNAL_TARGET_FAILURE: c_uint = 0x00;
pub const ASENCODE_INVALID_MESSAGE_ERROR: c_uint = 0x00;
pub const ASENCODE_LUN_FAILED_SELF_CONFIG: c_uint = 0x00;
pub const ASENCODE_OVERLAPPED_COMMAND: c_uint = 0x00;
...
pub struct inquiry_data {
    pub /: *mut *mut u8 inqd_pdt; / Peripheral qualifier | Peripheral Device Type,
    pub /: *mut *mut u8 inqd_dtq; / RMB | Device Type Qualifier,
    pub /: *mut *mut u8 inqd_ver; / ISO version | ECMA version | ANSI-approved version,
    pub /: *mut *mut u8 inqd_rdf; / AENC | TrmIOP | Response data format,
    pub /: *mut *mut u8 inqd_len; / Additional length (n-4),
    pub /: *mut *mut u8 inqd_pad1[2];/ Reserved - must be zero,
    pub /: *mut *mut u8 inqd_pad2; / RelAdr | WBus32 | WBus16 | Sync | Linked |Reserved| CmdQue | SftRe,
    pub /: *mut *mut u8 inqd_vid[8]; / Vendor ID,
    pub /: *mut *mut u8 inqd_pid[16];/ Product ID,
    pub /: *mut *mut u8 inqd_prl[4]; / Product Revision Level,
}

// Added for VPD 0x83
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvpd_id_descriptor_type_1 {
    pub /: *mut *mut u8 codeset:4; / VPD_CODE_SET,
    pub reserved:4: u8,
    pub /: *mut *mut u8 identifiertype:4; / VPD_IDENTIFIER_TYPE,
    pub reserved2:4: u8,
    pub reserved3: u8,
    pub identifierlength: u8,
    pub venid: [u8; 8],
    pub productid: [u8; 16],
    pub /: *mut *mut u8 serialnumber[8]; / SN in ASCII,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvpd_id_descriptor_type_2 {
    pub /: *mut *mut u8 codeset:4; / VPD_CODE_SET,
    pub reserved:4: u8,
    pub /: *mut *mut u8 identifiertype:4; / VPD_IDENTIFIER_TYPE,
    pub reserved2:4: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvpd_id_descriptor_type_3 {
    pub /: *mut *mut u8 codeset : 4; / VPD_CODE_SET,
    pub 4: u8 reserved :,
    pub /: *mut *mut u8 identifiertype : 4; / VPD_IDENTIFIER_TYPE,
    pub 4: u8 reserved2 :,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tvpd_page83 {
    pub DeviceType:5: u8,
    pub DeviceTypeQualifier:3: u8,
    pub PageCode: u8,
    pub reserved: u8,
    pub PageLength: u8,
    pub type1: tvpd_id_descriptor_type_1,
    pub type2: tvpd_id_descriptor_type_2,
    pub type3: tvpd_id_descriptor_type_3,
}
...
//
    let mut nondasd: static int = -1;
    static int aac_cache = 2;	/* WCE=0 to avoid performance problems */
    let mut dacmode: static int = -1;
    int aac_msi;
    let mut aac_commit: c_int = -1;
    let mut startup_timeout: c_int = 180;
    let mut aif_timeout: c_int = 120;
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_get_config_status(dev: *mut aac_dev, commit_flag: c_int) -> c_int {
    ...
    dinfo.count = cpu_to_le32(sizeof(((struct aac_get_config_status_resp *)core::ptr::null_mut()).data));
    }
...
#[no_mangle]
unsafe extern "C" fn aac_expose_phy_device(scsicmd: *mut scsi_cmnd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_get_containers(dev: *mut aac_dev) -> c_int {
    ...
    let mut maximum_num_containers: c_int = MAXIMUM_NUM_CONTAINERS;
    if (!(fibptr = aac_fib_alloc(dev)))
    return -ENOMEM;
    aac_fib_init(fibptr);
...
// FIB should be freed only after getting the response from the F/W
    ...
    if (dev.fsa_dev == core::ptr::null_mut() ||
    dev.maximum_num_containers != maximum_num_containers) {
    fsa_dev_ptr = dev.fsa_dev;
    dev.fsa_dev = kzalloc_objs(*fsa_dev_ptr,
    maximum_num_containers);
    kfree(fsa_dev_ptr);
    fsa_dev_ptr = core::ptr::null_mut();
    if (!dev.fsa_dev)
    return -ENOMEM;
    dev.maximum_num_containers = maximum_num_containers;
    }
...
#[no_mangle]
unsafe extern "C" fn aac_scsi_done(scmd: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn get_container_name_callback(context: *mut c_void, fibptr: *mut *mut fib) {
    ...
    BUG_ON(fibptr == core::ptr::null_mut());
    get_name_reply = (struct aac_get_name_resp *) fib_data(fibptr);
// Failure is irrelevant, using default value instead
    if ((le32_to_cpu(get_name_reply.status) == CT_OK)
    && (get_name_reply.data[0] != '\0')) {
    char *sp = get_name_reply.data;
    let mut data_size: c_int = sizeof_field(struct aac_get_name_resp, data);
    sp[data_size - 1] = '\0';
    while (*sp == ' ')
    ++sp;
    if (*sp) {
    struct inquiry_data inq;
    char d[sizeof(((struct inquiry_data *)core::ptr::null_mut()).inqd_pid)];
    let mut count: c_int = sizeof(d);
    char *dp = d;
    do {
// dp++ = (*sp) ? *sp++ : ' ';
    } while (--count > 0);
...
//
#[no_mangle]
unsafe extern "C" fn aac_get_container_name(scsicmd: *mut *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_probe_container_callback2(scsicmd: *mut *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _aac_probe_container2(context: *mut *mut c_void, fibptr: *mut *mut fib) {
    ...
    if (fsa_dev_ptr) {
    let mut dresp: *mut aac_mount = (struct aac_mount *) fib_data(fibptr);
    __le32 sup_options2;
...
#[no_mangle]
pub unsafe extern "C" fn if(NOT_READY: fsa_dev_ptr->sense_data.sense_key ==) -> else {
    ...
    cmd_priv.callback = core::ptr::null_mut();
    (*callback)(scsicmd);
    return;
    }
#[no_mangle]
unsafe extern "C" fn _aac_probe_container1(context: *mut *mut c_void, fibptr: *mut *mut fib) {
...
#[no_mangle]
unsafe extern "C" fn _aac_probe_container(scsicmd: *mut *mut scsi_cmnd, ): *mut *mut int (callback)(struct scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_probe_container_callback1(scsicmd: *mut *mut scsi_cmnd) -> c_int {
    static int aac_probe_container_callback1(struct scsi_cmnd * scsicmd)
    {
    scsicmd.device = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn aac_probe_container_scsi_done(scsi_cmnd: *mut scsi_cmnd) {
    static void aac_probe_container_scsi_done(struct scsi_cmnd *scsi_cmnd)
    {
    aac_probe_container_callback1(scsi_cmnd);
    }
#[no_mangle]
pub unsafe extern "C" fn aac_probe_container(dev: *mut aac_dev, cid: c_int) -> c_int {
...
#[derive(Copy, Clone)]
pub struct scsi_inq {
    pub /: *mut *mut char vid[8]; / Vendor ID,
    pub /: *mut *mut char pid[16]; / Product ID,
    pub /: *mut *mut char prl[4]; / Product Revision Level,
}
...
//
#[no_mangle]
unsafe extern "C" fn inqstrcpy(a: *mut c_char, b: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn get_container_type(tindex: unsigned) -> *mut c_char {
...
//
#[no_mangle]
unsafe extern "C" fn setinqstr(dev: *mut aac_dev, data: *mut c_void, tindex: c_int) {
...
#[no_mangle]
unsafe extern "C" fn get_container_serial_callback(context: *mut c_void, fibptr: *mut *mut fib) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_get_container_serial(scsicmd: *mut *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn setinqserial(dev: *mut aac_dev, data: *mut c_void, cid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_bounds_32(dev: *mut *mut aac_dev, cmd: *mut *mut scsi_cmnd, lba: u64) -> c_int {
    static int aac_bounds_32(struct aac_dev * dev, struct scsi_cmnd * cmd, u64 lba)
    {
    if (lba & 0xffffffff00000000LL) {
    let mut cid: c_int = scmd_id(cmd);
...
#[no_mangle]
unsafe extern "C" fn aac_bounds_64(dev: *mut *mut aac_dev, cmd: *mut *mut scsi_cmnd, lba: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_read_raw_io(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd, lba: u64, count: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_read_block64(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd, lba: u64, count: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_read_block(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd, lba: u64, count: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_write_raw_io(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd, lba: u64, count: u32, fua: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_write_block64(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd, lba: u64, count: u32, fua: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_write_block(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd, lba: u64, count: u32, fua: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_scsi_common(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd) -> *mut aac_srb {
...
#[no_mangle]
unsafe extern "C" fn aac_scsi_64(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd) -> c_int {
    static int aac_scsi_64(struct fib * fib, struct scsi_cmnd * cmd)
    {
    u16 fibsize;
    let mut srbcmd: *mut aac_srb = aac_scsi_common(fib, cmd);
    long ret;
...
#[no_mangle]
unsafe extern "C" fn aac_scsi_32(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_scsi_32_64(fib: *mut *mut fib, cmd: *mut *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_adapter_hba(fib: *mut fib, cmd: *mut scsi_cmnd) -> c_int {
...
// issue request to the controller
    ...
    1, 1, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn aac_set_safw_target_qd(dev: *mut aac_dev, bus: c_int, target: c_int) {
    ...
    if (identify_resp == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn aac_free_safw_ciss_luns(dev: *mut aac_dev) {
    static inline void aac_free_safw_ciss_luns(struct aac_dev *dev)
    {
    kfree(dev.safw_phys_luns);
    dev.safw_phys_luns = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn aac_get_safw_ciss_luns(dev: *mut aac_dev) -> c_int {
    ...
    if (phys_luns == core::ptr::null_mut())
    goto out;
    memset(&srbu, 0, sizeof(struct aac_srb_unit));
    srbcmd = &srbu.srb;
    srbcmd.flags	= cpu_to_le32(SRB_DataIn);
...
#[no_mangle]
pub unsafe extern "C" fn aac_get_safw_phys_lun_count(dev: *mut aac_dev) -> u32 {
...
pub unsafe extern "C" fn aac_get_safw_phys_nexus(dev: *mut aac_dev, lun: c_int) -> u32 {
    ...
    dev.hba_map[bus][target].safw_identify_resp = core::ptr::null_mut();
    }
    ...
    lun_count = luns;
#[no_mangle]
pub unsafe extern "C" fn if(0: lun_count <) -> else {
    else if (lun_count < 0)
    lun_count = luns;
...
#[no_mangle]
unsafe extern "C" fn aac_get_safw_attr_all_targets(dev: *mut aac_dev) -> c_int {
    ...
    u32 bus;
    u32 target;
    struct aac_ciss_identify_pd *identify_resp = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn aac_set_safw_attr_all_targets(dev: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_setup_safw_targets(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aac_setup_safw_adapter(dev: *mut aac_dev) -> c_int {
    int aac_setup_safw_adapter(struct aac_dev *dev)
    {
    return aac_setup_safw_targets(dev);
    }
#[no_mangle]
pub unsafe extern "C" fn aac_get_adapter_info(dev: *mut *mut aac_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn io_callback(context: *mut c_void, fibptr: *mut *mut fib) {
    static void io_callback(void *context, struct fib * fibptr)
    {
    struct aac_dev *dev;
...
#[no_mangle]
unsafe extern "C" fn aac_read(scsicmd: *mut *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_write(scsicmd: *mut *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn synchronize_callback(context: *mut c_void, fibptr: *mut fib) {
...
#[no_mangle]
unsafe extern "C" fn aac_synchronize(scsicmd: *mut scsi_cmnd) -> c_int {
...
//
    ...
    cpu_to_le32(sizeof(((struct aac_synchronize_reply *)core::ptr::null_mut()).data));
    aac_priv(scsicmd).owner = AAC_OWNER_FIRMWARE;
//
// Now send the Fib to the adapter
//
...
#[no_mangle]
unsafe extern "C" fn aac_start_stop_callback(context: *mut c_void, fibptr: *mut fib) {
...
#[no_mangle]
unsafe extern "C" fn aac_start_stop(scsicmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_scsi_cmd(scsicmd: *mut *mut scsi_cmnd) -> c_int {
    ...
    if (fsa_dev_ptr == core::ptr::null_mut())
    return -1;
//
...
// Do not cache partition table for arrays
    ...
    case MODE_SENSE:
    {
    let mut mode_buf_length: c_int = 4;
    u32 capacity;
    aac_modep_data mpd;
    if (fsa_dev_ptr[cid].size <= 0x100000000ULL)
    capacity = fsa_dev_ptr[cid].size - 1;
...
// Mode data length
    ...
    {
    u32 capacity;
    let mut mode_buf_length: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn query_disk(dev: *mut aac_dev, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn force_delete_disk(dev: *mut aac_dev, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn delete_disk(dev: *mut aac_dev, arg: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aac_dev_ioctl(dev: *mut aac_dev, cmd: c_uint, arg: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_srb_callback(context: *mut c_void, fibptr: *mut *mut fib) {
    static void aac_srb_callback(void *context, struct fib * fibptr)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_hba_callback(context: *mut c_void, fibptr: *mut fib) {
    ...
    if (!aac_valid_context(scsicmd, fibptr))
    return;
    WARN_ON(fibptr == core::ptr::null_mut());
    dev = fibptr.dev;
...
//
#[no_mangle]
unsafe extern "C" fn aac_send_srb_fib(scsicmd: *mut *mut scsi_cmnd) -> c_int {
    static int aac_send_srb_fib(struct scsi_cmnd* scsicmd)
    {
    struct fib* cmd_fibcontext;
    struct aac_dev* dev;
...
//
#[no_mangle]
unsafe extern "C" fn aac_send_hba_fib(scsicmd: *mut scsi_cmnd) -> c_int {
    static int aac_send_hba_fib(struct scsi_cmnd *scsicmd)
    {
    struct fib *cmd_fibcontext;
    struct aac_dev *dev;
...
#[no_mangle]
unsafe extern "C" fn aac_build_sg(scsicmd: *mut scsi_cmnd, psg: *mut sgmap) -> c_long {
    static long aac_build_sg(struct scsi_cmnd *scsicmd, struct sgmap *psg)
    {
    let mut byte_count: c_ulong = 0;
    int nseg;
...
#[no_mangle]
unsafe extern "C" fn aac_build_sg64(scsicmd: *mut scsi_cmnd, psg: *mut sgmap64) -> c_long {
    static long aac_build_sg64(struct scsi_cmnd *scsicmd, struct sgmap64 *psg)
    {
    let mut byte_count: c_ulong = 0;
    u64 addr;
...
// Get rid of old data
    ...
    return nseg;
    scsi_for_each_sg(scsicmd, sg, nseg, i) {
    let mut count: c_int = sg_dma_len(sg);
...
#[no_mangle]
unsafe extern "C" fn aac_build_sgraw(scsicmd: *mut scsi_cmnd, psg: *mut sgmapraw) -> c_long {
    static long aac_build_sgraw(struct scsi_cmnd *scsicmd, struct sgmapraw *psg)
    {
    let mut byte_count: c_ulong = 0;
    int nseg;
...
// Get rid of old data
    ...
    scsi_for_each_sg(scsicmd, sg, nseg, i) {
    let mut count: c_int = sg_dma_len(sg);
    let mut addr: u64 = sg_dma_address(sg);
    psg.sg[i].next = 0;
    psg.sg[i].prev = 0;
...
// Check for command underflow
    ...
    struct scatterlist *sg;
    int i, conformable = 0;
    let mut min_size: u32 = PAGE_SIZE, cur_size;
    nseg = scsi_dma_map(scsicmd);
    if (nseg <= 0)
    return nseg;
    scsi_for_each_sg(scsicmd, sg, nseg, i) {
...
// not conformable: evaluate required sg elements
    ...
    let mut ret: c_int = aac_convert_sgraw2(rio2, i, nseg, nseg_new);
    if (ret < 0)
    return ret;
    }
    } else
...
#[no_mangle]
unsafe extern "C" fn aac_convert_sgraw2(rio2: *mut aac_raw_io2, pages: c_int, nseg: c_int, nseg_new: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct aac_srb_status_info {
    pub status: u32,
    pub str: *mut c_char,
}
