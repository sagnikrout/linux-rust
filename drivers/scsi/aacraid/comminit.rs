...
//! Source: drivers/scsi/aacraid/comminit.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn aac_is_msix_mode(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aac_change_to_intx(dev: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_alloc_comm(dev: *mut aac_dev, commaddr: *mut c_void, commsize: c_ulong, commalign: c_ulong) -> c_int {
    static int aac_alloc_comm(struct aac_dev *dev, void **commaddr, unsigned long commsize, unsigned long commalign)
    {
    unsigned char *base;
    unsigned long size, align;
    let mut fibsize: c_ulong = dev.max_fib_size;
    let mut printfbufsiz: c_ulong = 256;
...
#[no_mangle]
unsafe extern "C" fn aac_queue_init(dev: *mut *mut aac_dev, q: *mut *mut aac_queue, mem: *mut u32, qsize: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wait_for_io_iter(cmd: *mut scsi_cmnd, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aac_wait_for_io_completion(aac: *mut aac_dev) {
    static void aac_wait_for_io_completion(struct aac_dev *aac)
    {
    let mut i: c_int = 0, active;
    for (i = 60; i; --i) {
    active = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_send_shutdown(dev: *mut *mut aac_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_comm_init(dev: *mut *mut aac_dev) -> c_int {
    static int aac_comm_init(struct aac_dev * dev)
    {
    let mut hdrsize: c_ulong = (sizeof(u32) * NUMBER_OF_COMM_QUEUES) * 2;
    let mut queuesize: c_ulong = sizeof(struct aac_entry) * TOTAL_QUEUE_ENTRIES;
    u32 *headers;
    struct aac_entry * queues;
    unsigned long size;
    let mut comm: *mut aac_queue_block = dev.queues;
//
...
#[no_mangle]
pub unsafe extern "C" fn aac_define_int_mode(dev: *mut aac_dev) {
...
// Don't bother allocating more MSI-X vectors than cpus
    ...
    {
    u32 status[5];
    let mut host: *mut Scsi_Host = dev.scsi_host_ptr;
...
//
    ...
    if (dev.queues == core::ptr::null_mut()) {
    printk(KERN_ERR "Error could not allocate comm region.\n");
    return core::ptr::null_mut();
    }
    if (aac_comm_init(dev)<0){
    kfree(dev.queues);
    dev.queues = core::ptr::null_mut();
    return core::ptr::null_mut();
    }
//
