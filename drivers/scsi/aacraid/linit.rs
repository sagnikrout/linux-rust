...
//! Source: drivers/scsi/aacraid/linit.c
#![no_std]
...
//
    ...
    let mut aac_cfg_major: static int = AAC_CHARDEV_UNREGISTERED;
...
//
    ...
    { core::ptr::null_mut()        , "aacraid",  "ADAPTEC ", "Themisto        ", 0, AAC_QUIRK_SLAVE }, /* Jupiter Platform */
...
//
#[no_mangle]
pub unsafe extern "C" fn aac_get_driver_ident(devtype: c_int) -> *mut aac_driver_ident {
...
//
    ...
    let mut saved_cylinders: c_int = param.cylinders;
    int num;
...
//
    ...
    let mut set_timeout: c_uint = 0;
    let mut timeout: c_int = 0;
    let mut set_qd_dev_type: bool = false;
    let mut devtype: u8 = 0;
    ...
    let mut num_lsu: unsigned = 0;
    let mut num_one: unsigned = 0;
    unsigned cid;
    set_timeout = 1;
...
//
    ...
    depth = 256;
#[no_mangle]
pub unsafe extern "C" fn if(1: depth <) -> else {
    else if (depth < 1)
    depth = 1;
...
//
#[no_mangle]
unsafe extern "C" fn aac_change_queue_depth(sdev: *mut scsi_device, depth: c_int) -> c_int {
    ...
    depth = 256;
#[no_mangle]
pub unsafe extern "C" fn if(2: depth <) -> else {
    else if (depth < 2)
    depth = 2;
...
#[no_mangle]
unsafe extern "C" fn aac_show_raid_level(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn fib_count_iter(scmnd: *mut scsi_cmnd, data: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_num_of_incomplete_fibs(aac: *mut aac_dev) -> c_int {
    static int get_num_of_incomplete_fibs(struct aac_dev *aac)
    {
    struct Scsi_Host *shost = aac.scsi_host_ptr;
    struct device *ctrl_dev;
    let mut fcnt: fib_count_data = { };
...
#[no_mangle]
unsafe extern "C" fn aac_eh_abort(cmd: *mut *mut scsi_cmnd) -> c_int {
    static int aac_eh_abort(struct scsi_cmnd* cmd)
    {
    struct aac_cmd_priv *cmd_priv = aac_priv(cmd);
    let mut dev: *mut scsi_device = cmd.device;
    let mut host: *mut Scsi_Host = dev.host;
    let mut aac: *mut aac_dev = (struct aac_dev *)host.hostdata;
    int count, found;
    u32 bus, cid;
...
#[no_mangle]
unsafe extern "C" fn aac_tmf_callback(context: *mut c_void, fibptr: *mut fib) {
...
//
#[no_mangle]
unsafe extern "C" fn aac_eh_dev_reset(cmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_eh_target_reset(cmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_eh_bus_reset(cmd: *mut *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aac_eh_host_reset(cmd: *mut scsi_cmnd) -> c_int {
    ...
    let mut aac: *mut aac_dev = (struct aac_dev *)host.hostdata;
    let mut ret: c_int = FAILED;
    let mut supported_options2: __le32 = 0;
    bool is_mu_reset;
...
//
#[no_mangle]
unsafe extern "C" fn aac_cfg_open(inode: *mut inode, file: *mut file) -> c_int {
    static int aac_cfg_open(struct inode *inode, struct file *file)
    {
    struct aac_dev *aac;
    let mut minor_number: unsigned = iminor(inode);
...
#[no_mangle]
pub unsafe extern "C" fn aac_get_serial_number(device: *mut device, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn __aac_shutdown(aac: *mut *mut aac_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: aac->max_msix >) -> else {
    else if (aac.max_msix > 1)
    pci_disable_msix(aac.pdev);
    }
#[no_mangle]
unsafe extern "C" fn aac_init_char() {
...
#[no_mangle]
pub unsafe extern "C" fn aac_reinit_aif(aac: *mut aac_dev, index: c_uint) {
...
//
    ...
    aac_intr_normal(aac, 0, 2, 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn aac_probe_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int aac_probe_one(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    let mut index: unsigned = id.driver_data;
    struct Scsi_Host *shost;
    struct aac_dev *aac;
    struct list_head *insert = &aac_devices;
    int error;
    let mut unique_id: c_int = 0;
    u64 dmamask;
    let mut mask_bits: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn aac_release_resources(aac: *mut aac_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_acquire_resources(dev: *mut aac_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aac_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn aac_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn aac_shutdown(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_pci_mmio_enabled(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn aac_pci_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn aac_pci_resume(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn aac_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aac_exit() -> void __exit {
