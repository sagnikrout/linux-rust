...
//! Source: drivers/scsi/scsi_lib_test.c
#![no_std]
...
pub const SCSI_LIB_TEST_MAX_ALLOWED: c_int = 3;
pub const SCSI_LIB_TEST_TOTAL_MAX_ALLOWED: c_int = 5;
#[no_mangle]
unsafe extern "C" fn scsi_lib_test_multiple_sense(test: *mut kunit) {
...
// Success
    ...
    KUNIT_EXPECT_EQ(test, 0, scsi_check_passthrough(&sc, core::ptr::null_mut()));
...
#[no_mangle]
unsafe extern "C" fn scsi_lib_test_any_sense(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn scsi_lib_test_host(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn scsi_lib_test_any_failure(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn scsi_lib_test_any_status(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn scsi_lib_test_total_allowed(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn scsi_lib_test_mixed_total(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn scsi_lib_test_check_passthough(test: *mut kunit) {
