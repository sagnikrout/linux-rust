...
//! Source: drivers/scsi/device_handler/scsi_dh_emc.c
#![no_std]
...
pub const CLARIION_TRESPASS_PAGE: c_uint = 0x22;
pub const CLARIION_BUFFER_SIZE: c_uint = 0xFC;

pub const CLARIION_RETRIES: c_int = 3;

pub const CLARIION_SP_A: c_int = 0;
pub const CLARIION_SP_B: c_int = 1;
// Flags
pub const CLARIION_SHORT_TRESPASS: c_int = 1;
pub const CLARIION_HONOR_RESERVATIONS: c_int = 2;
// LUN states

pub const CLARIION_LUN_UNBOUND: c_int = 0;
pub const CLARIION_LUN_BOUND: c_int = 1;
pub const CLARIION_LUN_OWNED: c_int = 2;
...
//
    pub buffer: [c_uchar; CLARIION_BUFFER_SIZE],
//
// LUN state
//
    pub lun_state: c_int,
...
#[no_mangle]
unsafe extern "C" fn parse_sp_model(sdev: *mut scsi_device, buffer: *mut c_uchar) -> *mut c_char {
    static char * parse_sp_model(struct scsi_device *sdev, unsigned char *buffer)
    {
    let mut len: c_uchar = buffer[4] + 5;
    char *sp_model = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn clariion_set_params(sdev: *mut scsi_device, params: *const c_char) -> c_int {
    static int clariion_set_params(struct scsi_device *sdev, const char *params)
    {
    struct clariion_dh_data *csdev = sdev.handler_data;
    let mut hr: c_uint = 0, st = 0, argc;
    const char *p = params;
...
#[no_mangle]
unsafe extern "C" fn clariion_bus_attach(sdev: *mut scsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clariion_bus_detach(sdev: *mut scsi_device) {
...
#[no_mangle]
unsafe extern "C" fn clariion_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn clariion_exit() -> void __exit {
