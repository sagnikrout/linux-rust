...
pub const ST_VER_MAJOR: c_int = 6;
pub const ST_VER_MINOR: c_int = 02;
pub const ST_OEM: c_int = 0000;
pub const ST_BUILD_VER: c_int = 01;
    enum {
// MU register offset
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_sgitem {
    pub /: *mut *mut u8 ctrl; / SG_CF_xxx,
    pub reserved: [u8; 3],
    pub count: __le32,
    pub addr: __le64,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_sgtable {
    pub sg_count: __le16,
    pub max_sg_count: __le16,
    pub sz_in_byte: __le32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct st_msg_header {
    pub handle: __le64,
    pub flag: u8,
    pub channel: u8,
    pub timeout: __le16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct handshake_frame {
    pub /: *mut *mut __le64 rb_phy; / request payload queue physical address,
    pub /: *mut *mut __le16 req_sz; / size of each request payload,
    pub /: *mut *mut __le16 req_cnt; / count of reqs the buffer can hold,
    pub /: *mut *mut __le16 status_sz; / size of each status payload,
    pub /: *mut *mut __le16 status_cnt; / count of status the buffer can hold,
    pub /: *mut *mut __le64 hosttime; / seconds from Jan 1, 1970 (GMT),
    pub /: *mut *mut u8 partner_type; / who sends this frame,
    pub reserved0: [u8; 7],
    pub partner_ver_major: __le32,
    pub partner_ver_minor: __le32,
    pub partner_ver_oem: __le32,
    pub partner_ver_build: __le32,
    pub /: *mut *mut __le32 extra_offset; / NEW,
    pub /: *mut *mut __le32 extra_size; / NEW,
    pub scratch_size: __le32,
    pub reserved1: u32,
}
...
pub struct req_msg {
    ...
    pub task_manage: u8,
    pub data_dir: u8,
    pub /: *mut *mut u8 payload_sz; / payload size in 4-byte, not used,
    pub cdb: [u8; STEX_CDB_LENGTH],
    pub variable: [u32; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct status_msg {
    pub tag: __le16,
    pub lun: u8,
    pub target: u8,
    pub srb_status: u8,
    pub scsi_status: u8,
    pub reserved: u8,
    pub /: *mut *mut u8 payload_sz; / payload size in 4-byte,
    pub variable: [u8; STATUS_VAR_LEN],
}
...
pub struct st_frame {
    pub base: [u32; 6],
    pub rom_addr: u32,
    pub drv_ver: ver_info,
    pub bios_ver: ver_info,
    pub bus: u32,
    pub slot: u32,
    pub irq_level: u32,
    pub irq_vec: u32,
...
#[derive(Copy, Clone)]
pub struct st_hba {
    pub /: *mut *mut *mut void __iomem mmio_base; / iomapped PCI memory space,
    pub dma_mem: *mut c_void,
    pub dma_handle: dma_addr_t,
    pub dma_size: usize,
    pub host: *mut Scsi_Host,
    pub pdev: *mut pci_dev,
    pub ): *mut *mut *mut req_msg  (alloc_rq) (st_hba,
    pub ): *mut *mut *mut *mut int (map_sg)(struct st_hba , struct req_msg , struct st_ccb,
    pub u16): *mut *mut *mut *mut void (send) (struct st_hba , struct req_msg ,,
    pub req_head: u32,
    pub req_tail: u32,
    pub status_head: u32,
    pub status_tail: u32,
    pub status_buffer: *mut status_msg,
    pub /: *mut *mut *mut void copy_buffer; / temp buffer for driver-handled commands,
    pub ccb: *mut st_ccb,
    pub wait_ccb: *mut st_ccb,
    pub scratch: *mut __le32,
    pub work_q: *mut workqueue_struct,
    pub reset_work: work_struct,
    pub reset_waitq: wait_queue_head_t,
    pub mu_status: c_uint,
    pub cardtype: c_uint,
    pub msi_enabled: c_int,
    pub out_req_cnt: c_int,
...
#[no_mangle]
unsafe extern "C" fn stex_controller_info(hba: *mut st_hba, ccb: *mut st_ccb) {
    static void stex_controller_info(struct st_hba *hba, struct st_ccb *ccb)
    {
    struct st_frame *p;
    let mut count: usize = sizeof(struct st_frame);
    p = hba.copy_buffer;
...
#[no_mangle]
unsafe extern "C" fn return_abnormal_state(hba: *mut st_hba, status: c_int) {
    ...
    ccb = &hba.ccb[tag];
    if (ccb.req == core::ptr::null_mut())
    continue;
    ccb.req = core::ptr::null_mut();
    if (ccb.cmd) {
    scsi_dma_unmap(ccb.cmd);
    ccb.cmd.result = status << 16;
    scsi_done(ccb.cmd);
    ccb.cmd = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn stex_queuecommand_lck(cmd: *mut scsi_cmnd) -> enum scsi_qc_status {
...
//
    ...
    let mut cp_len: usize = sizeof(ver);
...
#[no_mangle]
pub unsafe extern "C" fn if(DMA_TO_DEVICE: cmd->sc_data_direction ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn DEF_SCSI_QCMD(_arg: stex_queuecommand) -> static {
    static DEF_SCSI_QCMD(stex_queuecommand)
#[no_mangle]
unsafe extern "C" fn stex_scsi_done(ccb: *mut st_ccb) {
...
#[no_mangle]
pub unsafe extern "C" fn if(SRB_SEE_SENSE: ccb->srb_status &) -> else {
    else if (ccb.srb_status & SRB_SEE_SENSE)
    result = SAM_STAT_CHECK_CONDITION;
#[no_mangle]
pub unsafe extern "C" fn switch(_arg: ccb->srb_status) -> else {
    ...
    if (ccb.sense_buffer != core::ptr::null_mut())
    memcpy(ccb.sense_buffer, resp.variable,
    min(variable, ccb.sense_bufflen));
    return;
    }
    if (ccb.cmd == core::ptr::null_mut())
    return;
...
#[no_mangle]
unsafe extern "C" fn stex_mu_intr(hba: *mut st_hba, doorbell: u32) {
...
//
    ...
    hba.wait_ccb = core::ptr::null_mut();
    if (unlikely(ccb.req == core::ptr::null_mut())) {
    printk(KERN_WARNING DRV_NAME
    "(%s): lagging req\n", pci_name(hba.pdev));
    continue;
    }
    ...
    if (likely(ccb.cmd != core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn stex_intr(irq: c_int, __hba: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stex_ss_mu_intr(hba: *mut st_hba) {
...
#[no_mangle]
unsafe extern "C" fn stex_ss_intr(irq: c_int, __hba: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stex_common_handshake(hba: *mut st_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_ss_handshake(hba: *mut st_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_handshake(hba: *mut st_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_abort(cmd: *mut scsi_cmnd) -> c_int {
    static int stex_abort(struct scsi_cmnd *cmd)
    {
    struct Scsi_Host *host = cmd.device.host;
    struct st_hba *hba = (struct st_hba *)host.hostdata;
    let mut tag: u16 = scsi_cmd_to_rq(cmd).tag;
    void __iomem *base;
    u32 data;
    let mut result: c_int = SUCCESS;
    unsigned long flags;
    ...
    if (hba.wait_ccb == core::ptr::null_mut()) {
    printk(KERN_WARNING DRV_NAME
    "(%s): lost interrupt\n", pci_name(hba.pdev));
    goto out;
    }
    fail_out:
    scsi_dma_unmap(cmd);
    hba.wait_ccb.req = core::ptr::null_mut(); /* nullify the req's future return */
    hba.wait_ccb = core::ptr::null_mut();
    result = FAILED;
    out:
...
#[no_mangle]
unsafe extern "C" fn stex_hard_reset(hba: *mut st_hba) {
...
#[no_mangle]
unsafe extern "C" fn stex_yos_reset(hba: *mut st_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_ss_reset(hba: *mut st_hba) {
...
#[no_mangle]
unsafe extern "C" fn stex_p3_reset(hba: *mut st_hba) {
...
#[no_mangle]
unsafe extern "C" fn stex_do_reset(hba: *mut st_hba) -> c_int {
    static int stex_do_reset(struct st_hba *hba)
    {
    unsigned long flags;
    let mut mu_status: c_uint = MU_STATE_RESETTING;
    spin_lock_irqsave(hba.host.host_lock, flags);
    ...
    stex_hard_reset(hba);
#[no_mangle]
pub unsafe extern "C" fn if(st_yel: hba->cardtype ==) -> else {
    else if (hba.cardtype == st_yel)
    stex_ss_reset(hba);
#[no_mangle]
pub unsafe extern "C" fn if(st_P3: hba->cardtype ==) -> else {
    else if (hba.cardtype == st_P3)
    stex_p3_reset(hba);
...
#[no_mangle]
unsafe extern "C" fn stex_reset(cmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_reset_work(work: *mut work_struct) {
    ...
    {
    let mut heads: c_int = 255, sectors = 63;
...
#[no_mangle]
unsafe extern "C" fn stex_request_irq(hba: *mut st_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_free_irq(hba: *mut st_hba) {
...
#[no_mangle]
unsafe extern "C" fn stex_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int stex_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    struct st_hba *hba;
    struct Scsi_Host *host;
    const struct st_card_info *ci = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn stex_hba_stop(hba: *mut st_hba, st_sleep_mic: c_int) {
    ...
    hba.ccb[tag].cmd = core::ptr::null_mut();
    hba.ccb[tag].sg_count = 0;
    hba.ccb[tag].sense_bufflen = 0;
    hba.ccb[tag].sense_buffer = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn stex_hba_free(hba: *mut st_hba) {
...
#[no_mangle]
unsafe extern "C" fn stex_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn stex_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn stex_choice_sleep_mic(hba: *mut st_hba, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_resume(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_halt(nb: *mut notifier_block, event: c_ulong, buf: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stex_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn stex_exit() -> void __exit {
