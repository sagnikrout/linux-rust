...
//! Source: drivers/scsi/scsi_lib.c
#![no_std]
...
pub const SCSI_INLINE_PROT_SG_CNT: c_int = 0;
pub const SCSI_INLINE_SG_CNT: c_int = 0;

pub const SCSI_INLINE_PROT_SG_CNT: c_int = 1;
pub const SCSI_INLINE_SG_CNT: c_int = 2;

    static struct kmem_cache *scsi_sense_cache;
    static DEFINE_MUTEX(scsi_sense_cache_mutex);
    static void scsi_mq_uninit_cmd(struct scsi_cmnd *cmd);
#[no_mangle]
pub unsafe extern "C" fn scsi_init_sense_cache(shost: *mut Scsi_Host) -> c_int {
    ...
    0, SCSI_SENSE_BUFFERSIZE, core::ptr::null_mut());
    if (!scsi_sense_cache)
    ret = -ENOMEM;
    }
...
#[no_mangle]
unsafe extern "C" fn scsi_mq_requeue_cmd(cmd: *mut scsi_cmnd, msecs: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_queue_insert(cmd: *mut scsi_cmnd, reason: enum scsi_qc_status) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_failures_reset_retries(failures: *mut scsi_failures) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_dec_host_busy(shost: *mut Scsi_Host, cmd: *mut scsi_cmnd) {
...
//
    smp_mb();
    let mut busy: c_uint = scsi_host_busy(shost);
...
#[no_mangle]
pub unsafe extern "C" fn scsi_device_unbusy(sdev: *mut scsi_device, cmd: *mut scsi_cmnd) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_kick_sdev_queue(sdev: *mut scsi_device, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_single_lun_run(current_sdev: *mut scsi_device) {
    ...
    unsigned long flags;
    spin_lock_irqsave(shost.host_lock, flags);
    starget.starget_sdev_user = core::ptr::null_mut();
    spin_unlock_irqrestore(shost.host_lock, flags);
//
...
#[no_mangle]
pub unsafe extern "C" fn scsi_device_is_busy(sdev: *mut scsi_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_target_is_busy(starget: *mut scsi_target) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_host_is_busy(shost: *mut Scsi_Host) -> bool {
...
#[no_mangle]
unsafe extern "C" fn scsi_starved_list_run(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_run_queue(q: *mut request_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_requeue_run_queue(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_run_host_queues(shost: *mut Scsi_Host) {
    void scsi_run_host_queues(struct Scsi_Host *shost)
    {
    struct scsi_device *sdev, *prev = core::ptr::null_mut();
    unsigned long flags;
    spin_lock_irqsave(shost.host_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn scsi_uninit_cmd(cmd: *mut scsi_cmnd) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_free_sgtables(cmd: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn scsi_mq_uninit_cmd(cmd: *mut scsi_cmnd) {
    static void scsi_mq_uninit_cmd(struct scsi_cmnd *cmd)
    {
...
#[no_mangle]
unsafe extern "C" fn scsi_run_queue_async(sdev: *mut scsi_device) {
...
//
    let mut old: c_int = atomic_read(&sdev.restarts);
//
...
//
#[no_mangle]
unsafe extern "C" fn scsi_result_to_blk_status(result: c_int) -> blk_status_t {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_rq_err_bytes(rq: *const request) -> c_uint {
    static unsigned int scsi_rq_err_bytes(const struct request *rq)
    {
    let mut ff: blk_opf_t = rq.cmd_flags & REQ_FAILFAST_MASK;
...
#[no_mangle]
unsafe extern "C" fn scsi_cmd_runtime_exceeced(cmd: *mut scsi_cmnd) -> bool {
...
// state.
//
pub const ALUA_TRANSITION_REPREP_DELAY: c_int = 1000;
// Helper for scsi_io_completion() when special action required.
#[no_mangle]
unsafe extern "C" fn scsi_io_completion_action(cmd: *mut scsi_cmnd, result: c_int) {
...
//
    ...
    scsi_print_result(cmd, core::ptr::null_mut(), FAILED);
    if (sense_valid)
...
//
    ...
    do_print = false;
#[no_mangle]
pub unsafe extern "C" fn if(RQF_QUIET: req->rq_flags &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_io_completion(cmd: *mut scsi_cmnd, good_bytes: c_uint) {
    void scsi_io_completion(struct scsi_cmnd *cmd, unsigned int good_bytes)
    {
    let mut result: c_int = cmd.result;
    struct request *req = scsi_cmd_to_rq(cmd);
    let mut blk_stat: blk_status_t = BLK_STS_OK;
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_alloc_sgtables(cmd: *mut scsi_cmnd) -> blk_status_t {
    blk_status_t scsi_alloc_sgtables(struct scsi_cmnd *cmd)
    {
    struct scsi_device *sdev = cmd.device;
    struct request *rq = scsi_cmd_to_rq(cmd);
    let mut nr_segs: c_ushort = blk_rq_nr_phys_segments(rq);
    struct scatterlist *last_sg = core::ptr::null_mut();
    blk_status_t ret;
    let mut need_drain: bool = scsi_cmd_needs_dma_drain(sdev, rq);
    int count;
...
//
    ...
    let mut data_len: c_uint = last_sg.length;
...
//
#[no_mangle]
unsafe extern "C" fn scsi_initialize_rq(rq: *mut request) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_cleanup_rq(rq: *mut request) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_init_command(dev: *mut scsi_device, cmd: *mut scsi_cmnd) {
...
//
    if (req.bio) {
    let mut ret: blk_status_t = scsi_alloc_sgtables(cmd);
...
//
#[no_mangle]
unsafe extern "C" fn scsi_mq_lld_busy(q: *mut request_queue) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_complete(rq: *mut request) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_dispatch_cmd(cmd: *mut scsi_cmnd) -> enum scsi_qc_status {
...
#[no_mangle]
unsafe extern "C" fn scsi_mq_inline_sgl_size(shost: *mut Scsi_Host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn scsi_prepare_cmd(req: *mut request) -> blk_status_t {
    static blk_status_t scsi_prepare_cmd(struct request *req)
    {
    struct scsi_cmnd *cmd = blk_mq_rq_to_pdu(req);
    struct scsi_device *sdev = req.q.queuedata;
    struct Scsi_Host *shost = sdev.host;
    let mut in_flight: bool = test_bit(SCMD_STATE_INFLIGHT, &cmd.state);
...
//
    ...
    let mut ret: blk_status_t = sdev.handler.prep_fn(sdev, req);
    if (ret != BLK_STS_OK)
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn scsi_done_internal(cmd: *mut scsi_cmnd, complete_directly: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_done(cmd: *mut scsi_cmnd) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_done_direct(cmd: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn scsi_mq_put_budget(q: *mut request_queue, budget_token: c_int) {
...
//
pub const SCSI_QUEUE_DELAY: c_int = 3;
#[no_mangle]
unsafe extern "C" fn scsi_mq_get_budget(q: *mut request_queue) -> c_int {
    static int scsi_mq_get_budget(struct request_queue *q)
    {
    struct scsi_device *sdev = q.queuedata;
    let mut token: c_int = scsi_dev_queue_ready(q, sdev);
    if (token >= 0)
    return token;
...
#[no_mangle]
unsafe extern "C" fn scsi_mq_set_rq_budget_token(req: *mut request, token: c_int) {
...
#[no_mangle]
unsafe extern "C" fn scsi_mq_get_rq_budget_token(req: *mut request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scsi_mq_poll(hctx: *mut blk_mq_hw_ctx, iob: *mut io_comp_batch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scsi_map_queues(set: *mut blk_mq_tag_set) {
...
#[no_mangle]
unsafe extern "C" fn scsi_commit_rqs(hctx: *mut blk_mq_hw_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_mq_setup_tags(shost: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_mq_free_tags(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_put_internal_cmd(scmd: *mut scsi_cmnd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_block_requests(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_unblock_requests(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_exit_queue() {
...
// try to eat the UNIT_ATTENTION if there are enough retries
    do {
    result = scsi_execute_cmd(sdev, cmd, REQ_OP_DRV_IN, core::ptr::null_mut(), 0,
    timeout, 1, &exec_args);
...
//
    ...
    {
    let mut oldstate: enum scsi_device_state = sdev.sdev_state;
    if (state == oldstate)
    return 0;
    switch (state) {
    case SDEV_CREATED:
...
//
#[no_mangle]
unsafe extern "C" fn scsi_evt_emit(sdev: *mut scsi_device, evt: *mut scsi_event) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_evt_thread(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sdev_evt_send(sdev: *mut scsi_device, evt: *mut scsi_event) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_device_resume(sdev: *mut scsi_device) {
...
//
    ...
    if (sdev.quiesced_by) {
    sdev.quiesced_by = core::ptr::null_mut();
    ...
    {
    starget_for_each_device(starget, core::ptr::null_mut(), device_quiesce_fn);
    }
    ...
    {
    starget_for_each_device(starget, core::ptr::null_mut(), device_resume_fn);
    }
    EXPORT_SYMBOL(scsi_target_resume);
#[no_mangle]
unsafe extern "C" fn __scsi_internal_device_block_nowait(sdev: *mut scsi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_start_queue(sdev: *mut scsi_device) {
...
#[no_mangle]
unsafe extern "C" fn scsi_stop_queue(sdev: *mut scsi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_internal_device_block_nowait(sdev: *mut scsi_device) -> c_int {
    int scsi_internal_device_block_nowait(struct scsi_device *sdev)
    {
    let mut ret: c_int = __scsi_internal_device_block_nowait(sdev);
//
...
//
#[no_mangle]
unsafe extern "C" fn scsi_device_block(sdev: *mut scsi_device, data: *mut c_void) {
...
//
    ...
    starget_for_each_device(to_scsi_target(dev), core::ptr::null_mut(),
    scsi_device_block);
    return 0;
    }
//
...
//
    ...
    device_for_each_child(dev, core::ptr::null_mut(), target_block);
...
//
    ...
    {
    int i;
    let mut sg_len: usize = 0, len_complete = 0;
    struct scatterlist *sg;
    struct page *page;
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_kunmap_atomic_sg(virt: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn sdev_disable_disk_events(sdev: *mut scsi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn sdev_enable_disk_events(sdev: *mut scsi_device) {
...
#[no_mangle]
unsafe extern "C" fn designator_prio(d: *const c_uchar) -> c_uchar {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_vpd_lun_id(sdev: *mut scsi_device, id: *mut c_char, id_len: usize) -> c_int {
    int scsi_vpd_lun_id(struct scsi_device *sdev, char *id, size_t id_len)
    {
    let mut cur_id_prio: u8 = 0;
    let mut cur_id_size: u8 = 0;
    const unsigned char *d, *cur_id_str;
    const struct scsi_vpd *vpd_pg83;
    let mut id_size: c_int = -EINVAL;
    rcu_read_lock();
...
// The id string must be at least 20 bytes + terminating NULL byte
    ...
    d += d[3] + 4) {
    let mut prio: u8 = designator_prio(d);
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_vpd_lun_serial(sdev: *mut scsi_device, sn: *mut c_char, sn_size: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_vpd_tpg_id(sdev: *mut scsi_device, rel_id: *mut c_int) -> c_int {
    int scsi_vpd_tpg_id(struct scsi_device *sdev, int *rel_id)
    {
    const unsigned char *d;
    const struct scsi_vpd *vpd_pg83;
    let mut group_id: c_int = -EAGAIN, rel_port = -1;
    rcu_read_lock();
    vpd_pg83 = rcu_dereference(sdev.vpd_pg83);
    if (!vpd_pg83) {
    rcu_read_unlock();
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_build_sense(scmd: *mut scsi_cmnd, desc: c_int, key: u8, asc: u8, ascq: u8) {
