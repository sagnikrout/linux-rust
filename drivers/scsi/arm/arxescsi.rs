...
//! Source: drivers/scsi/arm/arxescsi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn arxescsi_pseudo_dma_write(addr: *mut c_uchar, base: *mut void __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn arxescsi_dma_stop(host: *mut Scsi_Host, SCp: *mut scsi_pointer) {
...
#[no_mangle]
unsafe extern "C" fn arxescsi_probe(ec: *mut expansion_card, id: *const ecard_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arxescsi_remove(ec: *mut expansion_card) {
...
#[no_mangle]
unsafe extern "C" fn init_arxe_scsi_driver() -> int __init {
    static int __init init_arxe_scsi_driver(void)
    {
    return ecard_register_driver(&arxescsi_driver);
    }
#[no_mangle]
unsafe extern "C" fn exit_arxe_scsi_driver() -> void __exit {
