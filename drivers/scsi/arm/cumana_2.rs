...
//! Source: drivers/scsi/arm/cumana_2.c
#![no_std]
...
pub const CUMANASCSI2_FAS216_SHIFT: c_int = 2;
//
// Version
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cumanascsi2_info {
    pub info: FAS216_Info,
    pub ec: *mut expansion_card,
    pub base: *mut void __iomem,
    pub /: *mut *mut unsigned int terms; / Terminator state,
...
//
    ...
    while (length > 1) {
    unsigned long word;
    let mut status: c_uint = readb(info.base + CUMANASCSI2_STATUS);
...
#[no_mangle]
unsafe extern "C" fn cumanascsi_2_show_info(m: *mut seq_file, host: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cumanascsi2_remove(ec: *mut expansion_card) {
...
#[no_mangle]
unsafe extern "C" fn cumanascsi2_init() -> int __init {
    static int __init cumanascsi2_init(void)
    {
    return ecard_register_driver(&cumanascsi2_driver);
    }
#[no_mangle]
unsafe extern "C" fn cumanascsi2_exit() -> void __exit {
