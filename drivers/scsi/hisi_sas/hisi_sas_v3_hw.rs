...
//! Source: drivers/scsi/hisi_sas/hisi_sas_v3_hw.c
#![no_std]
...
pub const SAS_AXI_USER3: c_uint = 0x50;
...
pub const CFG_MAX_TAG: c_uint = 0x68;
...
pub const CQ_INT_CONVERGE_EN: c_uint = 0xb0;
pub const CFG_AGING_TIME: c_uint = 0xbc;
pub const HGC_DFX_CFG2: c_uint = 0xc0;
pub const CFG_ICT_TIMER_STEP_TRSH: c_uint = 0xc8;
pub const CFG_ABT_SET_QUERY_IPTT: c_uint = 0xd4;
pub const CFG_SET_ABORTED_IPTT_OFF: c_int = 0;

pub const CFG_SET_ABORTED_EN_OFF: c_int = 12;
pub const CFG_ABT_SET_IPTT_DONE: c_uint = 0xd8;
pub const CFG_ABT_SET_IPTT_DONE_OFF: c_int = 0;
...
pub const CHNL_INT_STATUS: c_uint = 0x148;
pub const TAB_DFX: c_uint = 0x14c;
...
pub const TAB_RD_TYPE: c_uint = 0x15c;
...
pub const ENT_INT_SRC3_DQE_POISON_OFF: c_int = 18;
pub const ENT_INT_SRC3_IOST_POISON_OFF: c_int = 19;
pub const ENT_INT_SRC3_ITCT_POISON_OFF: c_int = 20;
pub const ENT_INT_SRC3_ITCT_NCQ_POISON_OFF: c_int = 21;
...
pub const CHNL_PHYUPDOWN_INT_MSK: c_uint = 0x1d0;
pub const CHNL_ENT_INT_MSK: c_uint = 0x1d4;
pub const HGC_COM_INT_MSK: c_uint = 0x1d8;
...
pub const SAS_ECC_INTR_ITCT_ECC_1B_OFF: c_int = 4;
pub const SAS_ECC_INTR_ITCT_ECC_MB_OFF: c_int = 5;
pub const SAS_ECC_INTR_ITCTLIST_ECC_1B_OFF: c_int = 6;
pub const SAS_ECC_INTR_ITCTLIST_ECC_MB_OFF: c_int = 7;
pub const SAS_ECC_INTR_IOSTLIST_ECC_1B_OFF: c_int = 8;
pub const SAS_ECC_INTR_IOSTLIST_ECC_MB_OFF: c_int = 9;
pub const SAS_ECC_INTR_CQE_ECC_1B_OFF: c_int = 10;
pub const SAS_ECC_INTR_CQE_ECC_MB_OFF: c_int = 11;
pub const SAS_ECC_INTR_NCQ_MEM0_ECC_1B_OFF: c_int = 12;
pub const SAS_ECC_INTR_NCQ_MEM0_ECC_MB_OFF: c_int = 13;
pub const SAS_ECC_INTR_NCQ_MEM1_ECC_1B_OFF: c_int = 14;
pub const SAS_ECC_INTR_NCQ_MEM1_ECC_MB_OFF: c_int = 15;
pub const SAS_ECC_INTR_NCQ_MEM2_ECC_1B_OFF: c_int = 16;
pub const SAS_ECC_INTR_NCQ_MEM2_ECC_MB_OFF: c_int = 17;
pub const SAS_ECC_INTR_NCQ_MEM3_ECC_1B_OFF: c_int = 18;
pub const SAS_ECC_INTR_NCQ_MEM3_ECC_MB_OFF: c_int = 19;
pub const SAS_ECC_INTR_OOO_RAM_ECC_1B_OFF: c_int = 20;
pub const SAS_ECC_INTR_OOO_RAM_ECC_MB_OFF: c_int = 21;
...
pub const AWQOS_AWCACHE_CFG: c_uint = 0xc84;
pub const ARQOS_ARCACHE_CFG: c_uint = 0xc88;
pub const HILINK_ERR_DFX: c_uint = 0xe04;
pub const SAS_GPIO_CFG_0: c_uint = 0x1000;
pub const SAS_GPIO_CFG_1: c_uint = 0x1004;
pub const SAS_GPIO_TX_0_1: c_uint = 0x1040;
pub const SAS_CFG_DRIVE_VLD: c_uint = 0x1070;
...
pub const PHY_CFG_PHY_RST_OFF: c_int = 3;

pub const CFG_PROG_PHY_LINK_RATE_OFF: c_int = 0;

pub const CFG_PROG_OOB_PHY_LINK_RATE_OFF: c_int = 8;

pub const PHY_CTRL_RESET_OFF: c_int = 0;

pub const CMD_HDR_PIR_OFF: c_int = 8;

pub const CFG_ALOS_CHK_DISABLE_OFF: c_int = 9;

pub const CFG_BIST_MODE_SEL_OFF: c_int = 0;

pub const CFG_LOOP_TEST_MODE_OFF: c_int = 14;

pub const CFG_RX_BIST_EN_OFF: c_int = 16;

pub const CFG_TX_BIST_EN_OFF: c_int = 17;

pub const CFG_BIST_TEST_OFF: c_int = 18;

pub const SL_CONTROL_NOTIFY_EN_OFF: c_int = 0;

pub const SL_CTA_OFF: c_int = 17;

pub const RX_BCAST_CHG_OFF: c_int = 1;

pub const CT3_OFF: c_int = 1;
...
pub const CHL_INT1_DMAC_TX_ECC_MB_ERR_OFF: c_int = 15;
pub const CHL_INT1_DMAC_TX_ECC_1B_ERR_OFF: c_int = 16;
pub const CHL_INT1_DMAC_RX_ECC_MB_ERR_OFF: c_int = 17;
pub const CHL_INT1_DMAC_RX_ECC_1B_ERR_OFF: c_int = 18;
...
pub const CHL_INT1_DMAC_TX_FIFO_ERR_OFF: c_int = 23;
pub const CHL_INT1_DMAC_RX_FIFO_ERR_OFF: c_int = 24;
pub const CHL_INT1_DMAC_TX_AXI_RUSER_ERR_OFF: c_int = 26;
pub const CHL_INT1_DMAC_RX_AXI_RUSER_ERR_OFF: c_int = 27;

pub const CHL_INT2_SL_IDAF_TOUT_CONF_OFF: c_int = 0;
pub const CHL_INT2_RX_DISP_ERR_OFF: c_int = 28;
pub const CHL_INT2_RX_CODE_ERR_OFF: c_int = 29;
pub const CHL_INT2_RX_INVLD_DW_OFF: c_int = 30;
pub const CHL_INT2_STP_LINK_TIMEOUT_OFF: c_int = 31;

pub const DMA_TX_STATUS_BUSY_OFF: c_int = 0;

pub const DMA_RX_STATUS_BUSY_OFF: c_int = 0;

pub const DFX_FIFO_CTRL_TRIGGER_MODE_OFF: c_int = 0;

pub const DFX_FIFO_CTRL_DUMP_MODE_OFF: c_int = 3;

pub const DFX_FIFO_CTRL_SIGNAL_SEL_OFF: c_int = 6;

pub const DFX_FIFO_CTRL_DUMP_DISABLE_OFF: c_int = 10;

pub const AM_CTRL_SHUTDOWN_REQ_OFF: c_int = 0;

pub const AM_ROB_ECC_ERR_ADDR_OFF: c_int = 0;
pub const AM_ROB_ECC_ERR_ADDR_MSK: c_uint = 0xffffffff;
...
// dw1
pub const CMD_HDR_UNCON_CMD_OFF: c_int = 3;
...
// dw7
pub const CMD_HDR_ADDR_MODE_SEL_OFF: c_int = 15;

pub const CMD_HDR_ABORT_IPTT_OFF: c_int = 16;

// Completion header
// dw0
pub const CMPLT_HDR_CMPLT_OFF: c_int = 0;

pub const CMPLT_HDR_ERROR_PHASE_OFF: c_int = 2;
...
pub const CMPLT_HDR_RSPNS_GOOD_OFF: c_int = 11;
...
// dw3
pub const SATA_DISK_IN_ERROR_STATUS_OFF: c_int = 8;

pub const CMPLT_HDR_SATA_DISK_ERR_OFF: c_int = 16;

pub const CMPLT_HDR_IO_IN_TARGET_OFF: c_int = 17;

// bit[23:18] ERR_FIS_ATA_STATUS
pub const FIS_ATA_STATUS_ERR_OFF: c_int = 18;

pub const FIS_TYPE_SDB_OFF: c_int = 31;
...
// debugfs
pub const TWO_PARA_PER_LINE: c_int = 2;
pub const FOUR_PARA_PER_LINE: c_int = 4;
pub const DUMP_BUF_SIZE: c_int = 8;
pub const BIST_BUF_SIZE: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_sas_protect_iu_v3_hw {
    pub dw0: u32,
    pub lbrtcv: u32,
    pub lbrtgv: u32,
    pub dw3: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_sas_complete_v3_hdr {
    pub dw0: __le32,
    pub dw1: __le32,
    pub act: __le32,
    pub dw3: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_sas_err_record_v3 {
// dw0
...
pub const RX_DATA_LEN_UNDERFLOW_OFF: c_int = 6;

pub const RX_FIS_STATUS_ERR_OFF: c_int = 0;

pub const HISI_SAS_COMMAND_ENTRIES_V3_HW: c_int = 4096;
pub const HISI_SAS_MSI_COUNT_V3_HW: c_int = 32;
...
pub const T10_INSRT_EN_OFF: c_int = 0;

pub const T10_RMV_EN_OFF: c_int = 1;

pub const T10_RPLC_EN_OFF: c_int = 2;

pub const T10_CHK_EN_OFF: c_int = 3;

pub const INCR_LBRT_OFF: c_int = 5;

pub const USR_DATA_BLOCK_SZ_OFF: c_int = 20;

pub const T10_CHK_MSK_OFF: c_int = 16;

pub const BASE_VECTORS_V3_HW: c_int = 16;

pub const IRQ_PHY_UP_DOWN_INDEX: c_int = 1;
pub const IRQ_CHL_INDEX: c_int = 2;
pub const IRQ_AXI_INDEX: c_int = 11;
pub const DELAY_FOR_RESET_HW: c_int = 100;
pub const HDR_SG_MOD: c_uint = 0x2;
pub const LUN_SIZE: c_int = 8;
pub const ATTR_PRIO_REGION: c_int = 9;
pub const CDB_REGION: c_int = 12;
pub const PRIO_OFF: c_int = 3;
pub const TMF_REGION: c_int = 10;
pub const TAG_MSB: c_int = 12;
pub const TAG_LSB: c_int = 13;
pub const SMP_FRAME_TYPE: c_int = 2;
pub const SMP_CRC_SIZE: c_int = 4;
pub const HDR_TAG_OFF: c_int = 3;
pub const HOST_NO_OFF: c_int = 6;
pub const PHY_NO_OFF: c_int = 7;
pub const IDENTIFY_REG_READ: c_int = 6;
pub const LINK_RESET_TIMEOUT_OFF: c_int = 4;
pub const DECIMALISM_FLAG: c_int = 10;
pub const WAIT_RETRY: c_int = 100;
pub const WAIT_TMROUT: c_int = 5000;
pub const ID_DWORD0_INDEX: c_int = 0;
pub const ID_DWORD1_INDEX: c_int = 1;
pub const ID_DWORD2_INDEX: c_int = 2;
pub const ID_DWORD3_INDEX: c_int = 3;
pub const ID_DWORD4_INDEX: c_int = 4;
pub const ID_DWORD5_INDEX: c_int = 5;
pub const TICKS_BIT_INDEX: c_int = 24;
pub const COUNT_BIT_INDEX: c_int = 8;
pub const PORT_REG_LENGTH: c_uint = 0x100;
pub const GLOBAL_REG_LENGTH: c_uint = 0x800;
pub const AXI_REG_LENGTH: c_uint = 0x61;
pub const RAS_REG_LENGTH: c_uint = 0x10;
pub const CHNL_INT_STS_MSK: c_uint = 0xeeeeeeee;
pub const CHNL_INT_STS_PHY_MSK: c_uint = 0xe;

pub const CHNL_WIDTH: c_int = 4;
pub const BAR_NO_V3_HW: c_int = 5;
    enum {
...
#[no_mangle]
unsafe extern "C" fn interrupt_enable_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn init_reg_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn config_phy_opt_mode_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn config_id_frame_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn reset_hw_v3_hw(hisi_hba: *mut hisi_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hw_init_v3_hw(hisi_hba: *mut hisi_hba) -> c_int {
...
//
    ...
    DSM_FUNC_ERR_HANDLE_MSI, core::ptr::null_mut());
    if (!obj)
...
#[no_mangle]
unsafe extern "C" fn enable_phy_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn disable_phy_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
    static void disable_phy_v3_hw(struct hisi_hba *hisi_hba, int phy_no)
    {
    let mut cfg: u32 = hisi_sas_phy_read32(hisi_hba, phy_no, PHY_CFG);
    let mut irq_msk: u32 = hisi_sas_phy_read32(hisi_hba, phy_no, CHL_INT2_MSK);
...
#[no_mangle]
unsafe extern "C" fn start_phy_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn phy_hard_reset_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn phy_get_max_linkrate_v3_hw() -> enum sas_linkrate {
    static enum sas_linkrate phy_get_max_linkrate_v3_hw(void)
    {
    return SAS_LINK_RATE_12_0_GBPS;
    }
#[no_mangle]
unsafe extern "C" fn phys_init_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn sl_notify_ssp_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn get_wideport_bitmap_v3_hw(hisi_hba: *mut hisi_hba, port_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn start_delivery_v3_hw(dq: *mut hisi_sas_dq) {
...
#[no_mangle]
unsafe extern "C" fn get_prot_chk_msk_v3_hw(scsi_cmnd: *mut scsi_cmnd) -> u32 {
    static u32 get_prot_chk_msk_v3_hw(struct scsi_cmnd *scsi_cmnd)
    {
    let mut prot_flags: c_uchar = scsi_cmnd.prot_flags;
    ...
    {
    let mut prot_op: c_uchar = scsi_get_prot_op(scsi_cmnd);
    let mut interval: c_uint = scsi_prot_interval(scsi_cmnd);
    let mut lbrt_chk_val: u32 = t10_pi_ref_tag(scsi_cmd_to_rq(scsi_cmnd));
    switch (prot_op) {
...
//
    ...
    let mut interval: c_uint = scsi_prot_interval(scsi_cmnd);
    let mut ilog2_interval: c_uint = ilog2(interval);
...
// fill in command FIS
    ...
    let mut sata: bool = dev_is_sata(dev);
// dw0
...
#[no_mangle]
unsafe extern "C" fn phy_up_v3_hw(phy_no: c_int, hisi_hba: *mut hisi_hba) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn phy_down_v3_hw(phy_no: c_int, hisi_hba: *mut hisi_hba) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn phy_bcast_v3_hw(phy_no: c_int, hisi_hba: *mut hisi_hba) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn int_phy_up_down_bcast_v3_hw(irq_no: c_int, p: *mut c_void) -> irqreturn_t {
    ...
    CHL_INT0);
    let mut phy_state: u32 = hisi_sas_read32(hisi_hba, PHY_STATE);
    let mut rdy: c_int = phy_state & (1 << phy_no);
    if (rdy) {
...
#[no_mangle]
unsafe extern "C" fn handle_chl_int1_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
    static void handle_chl_int1_v3_hw(struct hisi_hba *hisi_hba, int phy_no)
    {
    let mut irq_value: u32 = hisi_sas_phy_read32(hisi_hba, phy_no, CHL_INT1);
    let mut irq_msk: u32 = hisi_sas_phy_read32(hisi_hba, phy_no, CHL_INT1_MSK);
    struct device *dev = hisi_hba.dev;
    int i;
    irq_value &= ~irq_msk;
    if (!irq_value) {
...
#[no_mangle]
unsafe extern "C" fn phy_get_events_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
...
#[no_mangle]
unsafe extern "C" fn handle_chl_int2_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
    static void handle_chl_int2_v3_hw(struct hisi_hba *hisi_hba, int phy_no)
    {
    let mut irq_msk: u32 = hisi_sas_phy_read32(hisi_hba, phy_no, CHL_INT2_MSK);
    let mut irq_value: u32 = hisi_sas_phy_read32(hisi_hba, phy_no, CHL_INT2);
    struct hisi_sas_phy *phy = &hisi_hba.phy[phy_no];
...
#[no_mangle]
unsafe extern "C" fn handle_chl_int0_v3_hw(hisi_hba: *mut hisi_hba, phy_no: c_int) {
    static void handle_chl_int0_v3_hw(struct hisi_hba *hisi_hba, int phy_no)
    {
    let mut irq_value0: u32 = hisi_sas_phy_read32(hisi_hba, phy_no, CHL_INT0);
...
#[no_mangle]
unsafe extern "C" fn int_chnl_int_v3_hw(irq_no: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn fatal_ecc_int_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn fatal_axi_int_v3_hw(irq_no: c_int, p: *mut c_void) -> irqreturn_t {
    ...
    let mut err_value: u32 = hisi_sas_read32(hisi_hba, error.reg);
...
#[no_mangle]
unsafe extern "C" fn is_ncq_err_v3_hw(complete_hdr: *mut hisi_sas_complete_v3_hdr) -> bool {
    ...
    let mut dma_rx_err_type: u32 = le32_to_cpu(record.dma_rx_err_type);
    let mut trans_tx_fail_type: u32 = le32_to_cpu(record.trans_tx_fail_type);
    let mut sipc_rx_err_type: u16 = le16_to_cpu(record.sipc_rx_err_type);
    let mut dw3: u32 = le32_to_cpu(complete_hdr.dw3);
...
#[no_mangle]
unsafe extern "C" fn complete_v3_hw(cq: *mut hisi_sas_cq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_complete_v3_hw(shost: *mut Scsi_Host, queue: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cq_thread_v3_hw(irq_no: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cq_interrupt_v3_hw(irq_no: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_v3_free_vectors(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn interrupt_preinit_v3_hw(hisi_hba: *mut hisi_hba) -> c_int {
    static int interrupt_preinit_v3_hw(struct hisi_hba *hisi_hba)
    {
// Allocate all MSI vectors to avoid re-insertion issue
    let mut max_msi: c_int = HISI_SAS_MSI_COUNT_V3_HW;
    int vectors, min_msi;
    struct Scsi_Host *shost = hisi_hba.shost;
    struct pci_dev *pdev = hisi_hba.pci_dev;
...
#[no_mangle]
unsafe extern "C" fn interrupt_init_v3_hw(hisi_hba: *mut hisi_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_v3_init(hisi_hba: *mut hisi_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn interrupt_disable_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn get_phys_state_v3_hw(hisi_hba: *mut hisi_hba) -> u32 {
    static u32 get_phys_state_v3_hw(struct hisi_hba *hisi_hba)
    {
    return hisi_sas_read32(hisi_hba, PHY_STATE);
    }
#[no_mangle]
unsafe extern "C" fn disable_host_v3_hw(hisi_hba: *mut hisi_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn soft_reset_v3_hw(hisi_hba: *mut hisi_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn config_intr_coal_v3_hw(hisi_hba: *mut hisi_hba) {
...
// attr, char *buf)
    ...
    struct hisi_hba *hisi_hba = shost_priv(shost);
    let mut ret: c_int = hisi_sas_sdev_configure(sdev, lim);
    struct device *dev = hisi_hba.dev;
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_sdev_destroy(sdev: *mut scsi_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_sas_debugfs_reg_lu {
    pub name: *mut c_char,
    pub off: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_sas_debugfs_reg {
    pub lu: *const hisi_sas_debugfs_reg_lu,
    pub count: c_int,
    pub base_off: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_prepare_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_restore_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_bist_test_prep_v3_hw(hisi_hba: *mut hisi_hba) {
    static void hisi_sas_bist_test_prep_v3_hw(struct hisi_hba *hisi_hba)
    {
    u32 reg_val;
    let mut phy_no: c_int = hisi_hba.debugfs_bist_phy_no;
    int i;
// disable PHY
    hisi_sas_phy_enable(hisi_hba, phy_no, 0);
// update FFE
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_bist_test_restore_v3_hw(hisi_hba: *mut hisi_hba) {
...
pub const SAS_PHY_BIST_CODE_INIT: c_uint = 0x1;

pub const SAS_PHY_BIST_INIT_DELAY: c_int = 100;
pub const SAS_PHY_BIST_LOOP_TEST_0: c_int = 1;
pub const SAS_PHY_BIST_LOOP_TEST_1: c_int = 2;
#[no_mangle]
unsafe extern "C" fn debugfs_set_bist_v3_hw(hisi_hba: *mut hisi_hba, enable: bool) -> c_int {
    static int debugfs_set_bist_v3_hw(struct hisi_hba *hisi_hba, bool enable)
    {
    u32 reg_val, mode_tmp;
    let mut linkrate: u32 = hisi_hba.debugfs_bist_linkrate;
    let mut phy_no: u32 = hisi_hba.debugfs_bist_phy_no;
    u32 *ffe = hisi_hba.debugfs_bist_ffe[phy_no];
    let mut code_mode: u32 = hisi_hba.debugfs_bist_code_mode;
    let mut path_mode: u32 = hisi_hba.debugfs_bist_mode;
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_map_queues(shost: *mut Scsi_Host) {
...
#[no_mangle]
unsafe extern "C" fn check_fw_info_v3_hw(hisi_hba: *mut hisi_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_cq_reg_v3_hw(hisi_hba: *mut hisi_hba) {
    static void debugfs_snapshot_cq_reg_v3_hw(struct hisi_hba *hisi_hba)
    {
    let mut queue_entry_size: c_int = hisi_hba.hw.complete_hdr_size;
    let mut dump_index: c_int = hisi_hba.debugfs_dump_index;
    int i;
    for (i = 0; i < hisi_hba.queue_count; i++)
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_dq_reg_v3_hw(hisi_hba: *mut hisi_hba) {
    static void debugfs_snapshot_dq_reg_v3_hw(struct hisi_hba *hisi_hba)
    {
    let mut queue_entry_size: c_int = sizeof(struct hisi_sas_cmd_hdr);
    let mut dump_index: c_int = hisi_hba.debugfs_dump_index;
    int i;
    for (i = 0; i < hisi_hba.queue_count; i++) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_port_reg_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_global_reg_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_axi_reg_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_ras_reg_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_itct_reg_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_iost_reg_v3_hw(hisi_hba: *mut hisi_hba) {
    static void debugfs_snapshot_iost_reg_v3_hw(struct hisi_hba *hisi_hba)
    {
    let mut dump_index: c_int = hisi_hba.debugfs_dump_index;
    let mut max_command_entries: c_int = HISI_SAS_MAX_COMMANDS;
...
#[no_mangle]
unsafe extern "C" fn debugfs_dump_is_generated_v3_hw(p: *mut c_void) -> bool {
    ...
    let mut off: u32 = i * HISI_SAS_REG_MEM_SIZE;
    const char *name;
...
#[no_mangle]
unsafe extern "C" fn debugfs_global_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_axi_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_ras_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_port_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_cq_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_dq_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_iost_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_iost_cache_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
    ...
    let mut cache_size: u32 = HISI_SAS_IOST_ITCT_CACHE_DW_SZ * BYTE_TO_DW;
    int i, tab_idx;
    __le64 *iost;
...
#[no_mangle]
unsafe extern "C" fn debugfs_itct_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_itct_cache_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_create_files_v3_hw(hisi_hba: *mut hisi_hba, index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_bist_linkrate_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_bist_code_mode_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_bist_phy_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_bist_cnt_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_bist_mode_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_bist_enable_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_phy_down_cnt_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_is_fifo_config_valid_v3_hw(phy: *mut hisi_sas_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_update_fifo_config_v3_hw(phy: *mut hisi_sas_phy) -> c_int {
    static int debugfs_update_fifo_config_v3_hw(struct hisi_sas_phy *phy)
    {
    let mut trigger_mode: u32 = phy.fifo.trigger_mode;
    let mut signal_sel: u32 = phy.fifo.signal_sel;
    let mut dump_mode: u32 = phy.fifo.dump_mode;
    struct hisi_hba *hisi_hba = phy.hisi_hba;
    let mut phy_no: c_int = phy.sas_phy.id;
    u32 reg_val;
    int res;
...
#[no_mangle]
unsafe extern "C" fn debugfs_read_fifo_data_v3_hw(phy: *mut hisi_sas_phy) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_fifo_data_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_fifo_init_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_release_v3_hw(hisi_hba: *mut hisi_hba, dump_index: c_int) {
    static void debugfs_release_v3_hw(struct hisi_hba *hisi_hba, int dump_index)
    {
    struct device *dev = hisi_hba.dev;
    int i;
    devm_kfree(dev, hisi_hba.debugfs_iost_cache[dump_index].cache);
    hisi_hba.debugfs_iost_cache[dump_index].cache = core::ptr::null_mut();
    devm_kfree(dev, hisi_hba.debugfs_itct_cache[dump_index].cache);
    hisi_hba.debugfs_itct_cache[dump_index].cache = core::ptr::null_mut();
    devm_kfree(dev, hisi_hba.debugfs_iost[dump_index].iost);
    hisi_hba.debugfs_iost[dump_index].iost = core::ptr::null_mut();
    devm_kfree(dev, hisi_hba.debugfs_itct[dump_index].itct);
    hisi_hba.debugfs_itct[dump_index].itct = core::ptr::null_mut();
    for (i = 0; i < hisi_hba.queue_count; i++) {
    devm_kfree(dev, hisi_hba.debugfs_dq[dump_index][i].hdr);
    hisi_hba.debugfs_dq[dump_index][i].hdr = core::ptr::null_mut();
    }
    for (i = 0; i < hisi_hba.queue_count; i++) {
    devm_kfree(dev,
    hisi_hba.debugfs_cq[dump_index][i].complete_hdr);
    hisi_hba.debugfs_cq[dump_index][i].complete_hdr = core::ptr::null_mut();
    }
    for (i = 0; i < DEBUGFS_REGS_NUM; i++) {
    devm_kfree(dev, hisi_hba.debugfs_regs[dump_index][i].data);
    hisi_hba.debugfs_regs[dump_index][i].data = core::ptr::null_mut();
    }
    for (i = 0; i < hisi_hba.n_phy; i++) {
    devm_kfree(dev, hisi_hba.debugfs_port_reg[dump_index][i].data);
    hisi_hba.debugfs_port_reg[dump_index][i].data = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn debugfs_alloc_v3_hw(hisi_hba: *mut hisi_hba, dump_index: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_snapshot_regs_v3_hw(hisi_hba: *mut hisi_hba) -> c_int {
    static int debugfs_snapshot_regs_v3_hw(struct hisi_hba *hisi_hba)
    {
    let mut debugfs_dump_index: c_int = hisi_hba.debugfs_dump_index;
    struct device *dev = hisi_hba.dev;
...
#[no_mangle]
unsafe extern "C" fn debugfs_phy_down_cnt_init_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_bist_init_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_dump_index_v3_hw_show(s: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debugfs_dump_init_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn debugfs_exit_v3_hw(hisi_hba: *mut hisi_hba) {
    static void debugfs_exit_v3_hw(struct hisi_hba *hisi_hba)
    {
    debugfs_remove_recursive(hisi_hba.debugfs_dir);
    hisi_hba.debugfs_dir = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn debugfs_init_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_v3_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_reset_prepare_v3_hw(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hisi_sas_reset_done_v3_hw(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn enable_host_v3_hw(hisi_hba: *mut hisi_hba) {
...
#[no_mangle]
unsafe extern "C" fn _suspend_v3_hw(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _resume_v3_hw(device: *mut device) -> c_int {
    ...
    struct device *dev = hisi_hba.dev;
    unsigned int rc;
    let mut device_state: pci_power_t = pdev.current_state;
...
#[no_mangle]
unsafe extern "C" fn suspend_v3_hw(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn resume_v3_hw(device: *mut device) -> int __maybe_unused {
    static int __maybe_unused resume_v3_hw(struct device *device)
    {
    struct pci_dev *pdev = to_pci_dev(device);
    struct sas_ha_struct *sha = pci_get_drvdata(pdev);
    struct hisi_hba *hisi_hba = sha.lldd_ha;
    let mut rc: c_int = _resume_v3_hw(device);
    clear_bit(HISI_SAS_PM_BIT, &hisi_hba.flags);
    return rc;
    }
