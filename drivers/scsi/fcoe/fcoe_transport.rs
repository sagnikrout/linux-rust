...
//! Source: drivers/scsi/fcoe/fcoe_transport.c
#![no_std]
...
//
    ...
    module_param_call(show, core::ptr::null_mut(), fcoe_transport_show, core::ptr::null_mut(), S_IRUSR);
    __MODULE_PARM_TYPE(show, "string");
    MODULE_PARM_DESC(show, " Show attached FCoE transports");
    module_param_call(create, fcoe_transport_create, core::ptr::null_mut(),
    (void *)FIP_MODE_FABRIC, S_IWUSR);
    __MODULE_PARM_TYPE(create, "string");
    MODULE_PARM_DESC(create, " Creates fcoe instance on an ethernet interface");
    module_param_call(create_vn2vn, fcoe_transport_create, core::ptr::null_mut(),
    (void *)FIP_MODE_VN2VN, S_IWUSR);
    __MODULE_PARM_TYPE(create_vn2vn, "string");
    MODULE_PARM_DESC(create_vn2vn, " Creates a VN_node to VN_node FCoE instance "
    "on an Ethernet interface");
    module_param_call(destroy, fcoe_transport_destroy, core::ptr::null_mut(), core::ptr::null_mut(), S_IWUSR);
    __MODULE_PARM_TYPE(destroy, "string");
    MODULE_PARM_DESC(destroy, " Destroys fcoe instance on an ethernet interface");
    module_param_call(enable, fcoe_transport_enable, core::ptr::null_mut(), core::ptr::null_mut(), S_IWUSR);
    __MODULE_PARM_TYPE(enable, "string");
    MODULE_PARM_DESC(enable, " Enables fcoe on an ethernet interface.");
    module_param_call(disable, fcoe_transport_disable, core::ptr::null_mut(), core::ptr::null_mut(), S_IWUSR);
...
// notification function for packets from net device
    ...
    static const struct {
    u32 fc_port_speed;
pub const SPEED_2000: c_int = 2000;
pub const SPEED_4000: c_int = 4000;
pub const SPEED_8000: c_int = 8000;
pub const SPEED_16000: c_int = 16000;
pub const SPEED_32000: c_int = 32000;
    u32 eth_port_speed;
...
#[no_mangle]
pub unsafe extern "C" fn eth2fc_speed(eth_port_speed: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_link_speed_update(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_ctlr_get_lesb(ctlr_dev: *mut fcoe_ctlr_device) {
...
#[no_mangle]
pub unsafe extern "C" fn fcoe_wwn_to_str(wwn: u64, buf: *mut c_char, len: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_validate_vport_create(vport: *mut fc_vport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_get_wwn(netdev: *mut net_device, wwn: *mut u64, type: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_fc_crc(fp: *mut fc_frame) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_start_io(skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_clean_pending_queue(lport: *mut fc_lport) {
    void fcoe_clean_pending_queue(struct fc_lport *lport)
    {
    struct fcoe_port  *port = lport_priv(lport);
    struct sk_buff *skb;
    spin_lock_bh(&port.fcoe_pending_queue.lock);
    while ((skb = __skb_dequeue(&port.fcoe_pending_queue)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_check_wait_queue(lport: *mut fc_lport, skb: *mut sk_buff) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_queue_timer(t: *mut timer_list) {
    void fcoe_queue_timer(struct timer_list *t)
    {
    struct fcoe_port *port = timer_container_of(port, t, timer);
    fcoe_check_wait_queue(port.lport, core::ptr::null_mut());
    }
...
//
    ...
    fps.crc_eof_page = core::ptr::null_mut();
    fps.crc_eof_offset = 0;
    put_page(page);
    }
    return 0;
...
//
    ...
    {
    struct fcoe_transport *ft = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_transport_attach(ft: *mut fcoe_transport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_transport_detach(ft: *mut fcoe_transport) -> c_int {
    int fcoe_transport_detach(struct fcoe_transport *ft)
    {
    let mut rc: c_int = 0;
    struct fcoe_netdev_mapping *nm = core::ptr::null_mut(), *tmp;
    mutex_lock(&ft_mutex);
    if (!ft.attached) {
...
#[no_mangle]
unsafe extern "C" fn fcoe_transport_show(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    static int fcoe_transport_show(char *buffer, const struct kernel_param *kp)
    {
    int i, j;
    struct fcoe_transport *ft = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fcoe_transport_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fcoe_transport_exit() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fcoe_del_netdev_mapping(netdev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn fcoe_ctlr_create_store(buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn fcoe_ctlr_destroy_store(buf: *const c_char, count: usize) -> isize {
...
//
    ...
    struct net_device *netdev = core::ptr::null_mut();
    struct fcoe_transport *ft = core::ptr::null_mut();
    let mut fip_mode: enum fip_mode = (enum fip_mode)(uintptr_t)kp.arg;
    mutex_lock(&ft_mutex);
...
//
#[no_mangle]
unsafe extern "C" fn libfcoe_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn libfcoe_exit() -> void __exit {
