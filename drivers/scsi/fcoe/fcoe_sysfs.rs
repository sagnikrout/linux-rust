...
//! Source: drivers/scsi/fcoe/fcoe_sysfs.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn fcoe_str_to_dev_loss(buf: *const c_char, val: *mut c_ulong) -> c_int {
...
//
    ...
    show_fcoe_ctlr_device_##field, core::ptr::null_mut())
    ...
    show_fcoe_fcf_device_##field, core::ptr::null_mut())
...
pub const FCOE_FCF_STATE_MAX_NAMELEN: c_int = 50;
    ...
    static FCOE_DEVICE_ATTR(fcf, state, S_IRUGO, show_fcf_state, core::ptr::null_mut());
pub const FCOE_MAX_MODENAME_LEN: c_int = 20;
    ...
    enabled = true;
#[no_mangle]
pub unsafe extern "C" fn if('0': *mut *mut buf ==) -> else {
    else if (*buf == '0')
    enabled = false;
    else
    return -EINVAL;
...
pub const FCOE_CTLR_ENABLED_MAX_NAMELEN: c_int = 50;
...
//
#[no_mangle]
unsafe extern "C" fn fcoe_ctlr_device_release(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn fcoe_fcf_device_release(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn fcoe_ctlr_device_flush_work(ctlr: *mut fcoe_ctlr_device) {
...
//
#[no_mangle]
unsafe extern "C" fn fcoe_ctlr_device_flush_devloss(ctlr: *mut fcoe_ctlr_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_ctlr_device_delete(ctlr: *mut fcoe_ctlr_device) {
...
// Remove any attached fcfs
    ...
    destroy_workqueue(ctlr.devloss_work_q);
    ctlr.devloss_work_q = core::ptr::null_mut();
    destroy_workqueue(ctlr.work_q);
    ctlr.work_q = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn fcoe_fcf_device_final_delete(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn fip_timeout_deleted_fcf(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fcoe_fcf_device_delete(fcf: *mut fcoe_fcf_device) {
    void fcoe_fcf_device_delete(struct fcoe_fcf_device *fcf)
    {
    struct fcoe_ctlr_device *ctlr = fcoe_fcf_dev_to_ctlr_dev(fcf);
    let mut timeout: c_int = fcf.dev_loss_tmo;
...
#[no_mangle]
pub unsafe extern "C" fn fcoe_sysfs_setup() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn fcoe_sysfs_teardown() -> void __exit {
