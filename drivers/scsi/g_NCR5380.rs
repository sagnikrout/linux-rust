...
//! Source: drivers/scsi/g_NCR5380.c
#![no_std]
...
pub const NCR53C400_mem_base: c_uint = 0x3880;
pub const NCR53C400_host_buffer: c_uint = 0x3900;
pub const NCR53C400_region_size: c_uint = 0x3a00;
pub const BOARD_NCR5380: c_int = 0;
pub const BOARD_NCR53C400: c_int = 1;
pub const BOARD_NCR53C400A: c_int = 2;
pub const BOARD_DTC3181E: c_int = 3;
pub const BOARD_HP_C2502: c_int = 4;
pub const IRQ_AUTO: c_int = 254;
pub const MAX_CARDS: c_int = 8;
pub const DMA_MAX_SIZE: c_int = 32768;
// old-style parameters for compatibility
    let mut ncr_irq: static int = -1;
    static int ncr_addr;
    static int ncr_5380;
    ...
    module_param_hw_array(base, int, ioport, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(base, "base address(es)");
    static int card[] = { -1, -1, -1, -1, -1, -1, -1, -1 };
    module_param_array(card, int, core::ptr::null_mut(), 0);
    MODULE_PARM_DESC(card, "card type (0=NCR5380, 1=NCR53C400, 2=NCR53C400A, 3=DTC3181E, 4=HP C2502)");
    MODULE_ALIAS("g_NCR5380_mmio");
    MODULE_DESCRIPTION("Generic NCR5380/NCR53C400 SCSI driver");
    MODULE_LICENSE("GPL");
#[no_mangle]
unsafe extern "C" fn g_NCR5380_trigger_irq(instance: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn g_NCR5380_probe_irq(instance: *mut Scsi_Host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn magic_configure(idx: c_int, irq: u8, magic[]: u8) {
...
#[no_mangle]
unsafe extern "C" fn legacy_empty_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t legacy_empty_irq_handler(int irq, void *dev_id)
    {
    return IRQ_HANDLED;
    }
#[no_mangle]
unsafe extern "C" fn legacy_find_free_irq(irq_table: *mut c_int) -> c_int {
    ...
    {
    let mut is_pmio: bool = base <= 0xffff;
    int ret;
    let mut flags: c_int = 0;
    unsigned int *ports = core::ptr::null_mut();
    u8 *magic = core::ptr::null_mut();
    int i;
    let mut port_idx: c_int = -1;
...
// Compatibility with documented NCR5380 kernel parameters
    ...
    irq = NO_IRQ;
#[no_mangle]
pub unsafe extern "C" fn if(-1: irq ==) -> else {
    else if (irq == -1)
    irq = IRQ_AUTO;
    if (board == BOARD_HP_C2502) {
    int *irq_table = hp_c2502_irqs;
    let mut board_irq: c_int = -1;
    switch (irq) {
    case NO_IRQ:
    board_irq = 0;
    break;
...
#[no_mangle]
unsafe extern "C" fn generic_NCR5380_release_resources(instance: *mut Scsi_Host) {
    static void generic_NCR5380_release_resources(struct Scsi_Host *instance)
    {
    struct NCR5380_hostdata *hostdata = shost_priv(instance);
    void __iomem *iomem = hostdata.io;
    let mut io_port: c_ulong = hostdata.io_port;
    let mut base: c_ulong = hostdata.base;
    let mut region_size: c_ulong = hostdata.region_size;
...
//
#[no_mangle]
unsafe extern "C" fn wait_for_53c80_access(hostdata: *mut NCR5380_hostdata) {
...
// Ignore End of DMA interrupt for the final buffer
    ...
    dst + start, 64);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hostdata->io_port) -> else {
...
// 53c80 interrupt or transfer timeout. Reset 53c400 logic.
    ...
    {
    let mut transfersize: c_int = NCR5380_to_ncmd(cmd).this_residual;
...
#[no_mangle]
unsafe extern "C" fn generic_NCR5380_dma_residual(hostdata: *mut NCR5380_hostdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn generic_NCR5380_isa_match(pdev: *mut device, ndev: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn generic_NCR5380_pnp_remove(pdev: *mut pnp_dev) {
...
#[no_mangle]
unsafe extern "C" fn generic_NCR5380_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn generic_NCR5380_exit() -> void __exit {
