...
//! Source: drivers/scsi/smartpqi/smartpqi_init.c
#![no_std]
...
// Macro flag: #define BUILD_TIMESTAMP

pub const DRIVER_MAJOR: c_int = 2;
pub const DRIVER_MINOR: c_int = 1;
pub const DRIVER_RELEASE: c_int = 42;
pub const DRIVER_REVISION: c_int = 11;

    DRIVER_VERSION BUILD_TIMESTAMP ")"

pub const PQI_POST_RESET_DELAY_SECS: c_int = 5;
pub const PQI_POST_OFA_RESET_DELAY_UPON_TIMEOUT_SECS: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn pqi_init_cmd_priv(shost: *mut Scsi_Host, cmd: *mut scsi_cmnd) -> c_int {
...
pub const PQI_SYNC_FLAGS_INTERRUPTABLE: c_uint = 0x1;
    static struct scsi_transport_template *pqi_sas_transport_template;
    let mut pqi_controller_count: static atomic_t = ATOMIC_INIT(0);
    enum pqi_lockup_action {
    NONE,
    REBOOT,
    PANIC
    };
    let mut pqi_lockup_action: static enum pqi_lockup_action = NONE;
    static struct {
...
pub const SA_RAID_0: c_int = 0;
pub const SA_RAID_4: c_int = 1;

pub const SA_RAID_51: c_int = 4;

pub const SA_RAID_UNKNOWN: c_uint = 0xff;
#[no_mangle]
pub unsafe extern "C" fn pqi_scsi_done(scmd: *mut scsi_cmnd) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_disable_write_same(sdev: *mut scsi_device) {
    static inline void pqi_disable_write_same(struct scsi_device *sdev)
    {
    sdev.no_write_same = 1;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_scsi3addr_equal(scsi3addr1: *mut u8, scsi3addr2: *mut u8) -> bool {
    static inline bool pqi_scsi3addr_equal(u8 *scsi3addr1, u8 *scsi3addr2)
    {
    return memcmp(scsi3addr1, scsi3addr2, 8) == 0;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_is_logical_device(device: *mut pqi_scsi_dev) -> bool {
    static inline bool pqi_is_logical_device(struct pqi_scsi_dev *device)
    {
    return !device.is_physical_device;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_is_external_raid_addr(scsi3addr: *mut u8) -> bool {
    static inline bool pqi_is_external_raid_addr(u8 *scsi3addr)
    {
    return scsi3addr[2] != 0;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_offline(ctrl_info: *mut pqi_ctrl_info) -> bool {
    static inline bool pqi_ctrl_offline(struct pqi_ctrl_info *ctrl_info)
    {
    return !ctrl_info.controller_online;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_check_ctrl_health(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_hba_lunid(scsi3addr: *mut u8) -> bool {
    static inline bool pqi_is_hba_lunid(u8 *scsi3addr)
    {
    return pqi_scsi3addr_equal(scsi3addr, RAID_CTLR_LUNID);
    }
pub const PQI_DRIVER_SCRATCH_PQI_MODE: c_uint = 0x1;
pub const PQI_DRIVER_SCRATCH_FW_TRIAGE_SUPPORTED: c_uint = 0x2;
#[no_mangle]
pub unsafe extern "C" fn pqi_get_ctrl_mode(ctrl_info: *mut pqi_ctrl_info) -> enum pqi_ctrl_mode {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_fw_triage_supported(ctrl_info: *mut pqi_ctrl_info) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_save_fw_triage_setting(ctrl_info: *mut pqi_ctrl_info, is_supported: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_block_scan(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_unblock_scan(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_scan_blocked(ctrl_info: *mut pqi_ctrl_info) -> bool {
    static inline bool pqi_ctrl_scan_blocked(struct pqi_ctrl_info *ctrl_info)
    {
    return ctrl_info.scan_blocked;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_block_device_reset(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_ctrl_block_device_reset(struct pqi_ctrl_info *ctrl_info)
    {
    mutex_lock(&ctrl_info.lun_reset_mutex);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_unblock_device_reset(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_ctrl_unblock_device_reset(struct pqi_ctrl_info *ctrl_info)
    {
    mutex_unlock(&ctrl_info.lun_reset_mutex);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_scsi_block_requests(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_scsi_unblock_requests(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_scsi_unblock_requests(struct pqi_ctrl_info *ctrl_info)
    {
    scsi_unblock_requests(ctrl_info.scsi_host);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_busy(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_ctrl_busy(struct pqi_ctrl_info *ctrl_info)
    {
    atomic_inc(&ctrl_info.num_busy_threads);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_unbusy(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_ctrl_unbusy(struct pqi_ctrl_info *ctrl_info)
    {
    atomic_dec(&ctrl_info.num_busy_threads);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_blocked(ctrl_info: *mut pqi_ctrl_info) -> bool {
    static inline bool pqi_ctrl_blocked(struct pqi_ctrl_info *ctrl_info)
    {
    return ctrl_info.block_requests;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_block_requests(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_ctrl_block_requests(struct pqi_ctrl_info *ctrl_info)
    {
    ctrl_info.block_requests = true;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_unblock_requests(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_wait_if_ctrl_blocked(ctrl_info: *mut pqi_ctrl_info) {
...
pub const PQI_QUIESCE_WARNING_TIMEOUT_SECS: c_int = 10;
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_wait_until_quiesced(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_device_offline(device: *mut pqi_scsi_dev) -> bool {
    static inline bool pqi_device_offline(struct pqi_scsi_dev *device)
    {
    return device.device_offline;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_ofa_start(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_ctrl_ofa_start(struct pqi_ctrl_info *ctrl_info)
    {
    mutex_lock(&ctrl_info.ofa_mutex);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_ctrl_ofa_done(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_ctrl_ofa_done(struct pqi_ctrl_info *ctrl_info)
    {
    mutex_unlock(&ctrl_info.ofa_mutex);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_wait_until_ofa_finished(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_ofa_in_progress(ctrl_info: *mut pqi_ctrl_info) -> bool {
    static inline bool pqi_ofa_in_progress(struct pqi_ctrl_info *ctrl_info)
    {
    return mutex_is_locked(&ctrl_info.ofa_mutex);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_device_remove_start(device: *mut pqi_scsi_dev) {
    static inline void pqi_device_remove_start(struct pqi_scsi_dev *device)
    {
    device.in_remove = true;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_device_in_remove(device: *mut pqi_scsi_dev) -> bool {
    static inline bool pqi_device_in_remove(struct pqi_scsi_dev *device)
    {
    return device.in_remove;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_device_reset_start(device: *mut pqi_scsi_dev, lun: u8) {
    static inline void pqi_device_reset_start(struct pqi_scsi_dev *device, u8 lun)
    {
    device.in_reset[lun] = true;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_device_reset_done(device: *mut pqi_scsi_dev, lun: u8) {
    static inline void pqi_device_reset_done(struct pqi_scsi_dev *device, u8 lun)
    {
    device.in_reset[lun] = false;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_device_in_reset(device: *mut pqi_scsi_dev, lun: u8) -> bool {
    static inline bool pqi_device_in_reset(struct pqi_scsi_dev *device, u8 lun)
    {
    return device.in_reset[lun];
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_event_type_to_event_index(event_type: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_supported_event(event_type: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_schedule_rescan_worker(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_schedule_rescan_worker_delayed(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_schedule_rescan_worker_delayed(struct pqi_ctrl_info *ctrl_info)
    {
    pqi_schedule_rescan_worker_with_delay(ctrl_info, PQI_RESCAN_WORK_DELAY);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_cancel_rescan_worker(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_cancel_rescan_worker(struct pqi_ctrl_info *ctrl_info)
    {
    cancel_delayed_work_sync(&ctrl_info.rescan_work);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_read_heartbeat_counter(ctrl_info: *mut pqi_ctrl_info) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_read_soft_reset_status(ctrl_info: *mut pqi_ctrl_info) -> u8 {
    static inline u8 pqi_read_soft_reset_status(struct pqi_ctrl_info *ctrl_info)
    {
    return readb(ctrl_info.soft_reset_status);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_clear_soft_reset_status(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_io_high_priority(device: *mut pqi_scsi_dev, scmd: *mut scsi_cmnd) -> bool {
...
// Set NCQ priority for read/write commands.
    ...
    {
    u8 *cdb;
    let mut cdb_length: usize = buffer_length;
...
#[no_mangle]
pub unsafe extern "C" fn pqi_reinit_io_request(io_request: *mut pqi_io_request) {
    static inline void pqi_reinit_io_request(struct pqi_io_request *io_request)
    {
    io_request.scmd = core::ptr::null_mut();
    io_request.status = 0;
    io_request.error_info = core::ptr::null_mut();
    ...
    let mut blk_tag: u32 = blk_mq_unique_tag(scsi_cmd_to_rq(scmd));
...
#[no_mangle]
unsafe extern "C" fn pqi_free_io_request(io_request: *mut pqi_io_request) {
...
// helper functions for pqi_send_scsi_raid_request
    ...
    buffer, buffer_length, 0, core::ptr::null_mut());
    }
    ...
    buffer, buffer_length, vpd_page, core::ptr::null_mut());
    }
    ...
    rc = pqi_submit_raid_request_synchronous(ctrl_info, &request.header, 0, core::ptr::null_mut());
    pqi_pci_unmap(ctrl_info.pci_dev, request.sg_descriptors, 1, dir);
    return rc;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_aio_limit_to_bytes(limit: *mut __le16) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmic_sense_feature_buffer {
    pub header: bmic_sense_feature_buffer_header,
    pub aio_subpage: bmic_sense_feature_io_page_aio_subpage,
}
...
#[no_mangle]
unsafe extern "C" fn pqi_get_advanced_raid_bypass_config(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_set_diag_rescan(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmic_host_wellness_driver_version {
    pub start_tag: [u8; 4],
    pub driver_version_tag: [u8; 2],
    pub driver_version_length: __le16,
    pub driver_version: [c_char; 32],
    pub dont_write_tag: [u8; 2],
    pub end_tag: [u8; 2],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bmic_host_wellness_time {
    pub start_tag: [u8; 4],
    pub time_tag: [u8; 2],
    pub time_length: __le16,
    pub time: [u8; 8],
    pub dont_write_tag: [u8; 2],
    pub end_tag: [u8; 2],
}
...
#[no_mangle]
unsafe extern "C" fn pqi_update_time_worker(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_schedule_update_time_worker(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_schedule_update_time_worker(struct pqi_ctrl_info *ctrl_info)
    {
    schedule_delayed_work(&ctrl_info.update_time_work, 0);
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_cancel_update_time_worker(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_report_phys_logical_luns(ctrl_info: *mut pqi_ctrl_info, cmd: u8, buffer: *mut c_void) -> c_int {
    ...
    void *lun_data = core::ptr::null_mut();
    ...
    if (rc) {
    kfree(lun_data);
    lun_data = core::ptr::null_mut();
    }
// buffer = lun_data;
    return rc;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_report_phys_luns(ctrl_info: *mut pqi_ctrl_info, buffer: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_report_logical_luns(ctrl_info: *mut pqi_ctrl_info, buffer: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_assign_bus_target_lun(device: *mut pqi_scsi_dev) {
...
// ((u32 *)&device->scsi3addr[4]), err_msg);
    ...
    device.scsi3addr, raid_map, sizeof(*raid_map), 0, core::ptr::null_mut());
    if (rc)
    goto error;
    raid_map_size = get_unaligned_le32(&raid_map.structure_size);
    ...
    return -ENOMEM;
    rc = pqi_send_scsi_raid_request(ctrl_info, CISS_GET_RAID_MAP,
    device.scsi3addr, raid_map, raid_map_size, 0, core::ptr::null_mut());
    if (rc)
    goto error;
    ...
    if (rc)
    goto out;
pub const RAID_BYPASS_STATUS: c_int = 4;
pub const RAID_BYPASS_CONFIGURED: c_uint = 0x1;
pub const RAID_BYPASS_ENABLED: c_uint = 0x2;
...
//
    ...
    int rc;
    size_t page_length;
    let mut volume_status: u8 = CISS_LV_STATUS_UNAVAILABLE;
    let mut volume_offline: bool = true;
    u32 volume_flags;
...
pub const PQI_DEVICE_NCQ_PRIO_SUPPORTED: c_uint = 0x01;
pub const PQI_DEVICE_PHY_MAP_SUPPORTED: c_uint = 0x10;
pub const PQI_DEVICE_ERASE_IN_PROGRESS: c_uint = 0x10;
...
//
#[no_mangle]
pub unsafe extern "C" fn pqi_keep_device_offline(device: *mut pqi_scsi_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pqi_rescan_worker(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_remove_device(ctrl_info: *mut pqi_ctrl_info, device: *mut pqi_scsi_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_device_equal(dev1: *mut pqi_scsi_dev, dev2: *mut pqi_scsi_dev) -> bool {
...
pub const PQI_DEV_INFO_BUFFER_LENGTH: c_int = 128;
...
#[no_mangle]
unsafe extern "C" fn pqi_raid_maps_equal(raid_map1: *mut raid_map, raid_map2: *mut raid_map) -> bool {
    static bool pqi_raid_maps_equal(struct raid_map *raid_map1, struct raid_map *raid_map2)
    {
    u32 raid_map1_size;
    u32 raid_map2_size;
    if (raid_map1 == core::ptr::null_mut() || raid_map2 == core::ptr::null_mut())
    let mut raid_map1: return = = raid_map2;
...
// To prevent this from being freed later.
    new_device.raid_map = core::ptr::null_mut();
    }
    if (new_device.raid_bypass_enabled && existing_device.raid_io_stats == core::ptr::null_mut()) {
    existing_device.raid_io_stats = new_device.raid_io_stats;
    new_device.raid_io_stats = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn pqi_free_device(device: *mut pqi_scsi_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_device_added(device: *mut pqi_scsi_dev) -> bool {
    static inline bool pqi_is_device_added(struct pqi_scsi_dev *device)
    {
    if (device.is_expander_smp_device)
    return device.sas_port != core::ptr::null_mut();
    return device.sdev != core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_init_device_tmf_work(device: *mut pqi_scsi_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_volume_rescan_needed(device: *mut pqi_scsi_dev) -> bool {
    static inline bool pqi_volume_rescan_needed(struct pqi_scsi_dev *device)
    {
    if (pqi_device_in_remove(device))
    return false;
    if (device.sdev == core::ptr::null_mut())
    return false;
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_supported_device(device: *mut pqi_scsi_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_skip_device(scsi3addr: *mut u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_mask_device(scsi3addr: *mut u8) {
    static inline void pqi_mask_device(u8 *scsi3addr)
    {
    scsi3addr[3] |= 0xc0;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_expose_device(device: *mut pqi_scsi_dev) -> bool {
    static inline bool pqi_expose_device(struct pqi_scsi_dev *device)
    {
    return !device.is_physical_device || !pqi_skip_device(device.scsi3addr);
    }
#[no_mangle]
unsafe extern "C" fn pqi_update_scsi_devices(ctrl_info: *mut pqi_ctrl_info) -> c_int {
    static int pqi_update_scsi_devices(struct pqi_ctrl_info *ctrl_info)
    {
    int i;
    int rc;
    LIST_HEAD(new_device_list_head);
    struct report_phys_lun_16byte_wwid_list *physdev_list = core::ptr::null_mut();
    struct report_log_lun_list *logdev_list = core::ptr::null_mut();
    struct report_phys_lun_16byte_wwid *phys_lun;
    struct report_log_lun *log_lun;
    struct bmic_identify_physical_device *id_phys = core::ptr::null_mut();
    u32 num_physicals;
    u32 num_logicals;
    struct pqi_scsi_dev **new_device_list = core::ptr::null_mut();
    struct pqi_scsi_dev *device;
    struct pqi_scsi_dev *next;
...
//
    ...
    log_lun = core::ptr::null_mut();
    scsi3addr = phys_lun.lunid;
    } else {
    is_physical_device = false;
    phys_lun = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pqi_scan_scsi_devices(ctrl_info: *mut pqi_ctrl_info) -> c_int {
    static int pqi_scan_scsi_devices(struct pqi_ctrl_info *ctrl_info)
    {
    int rc;
    int mutex_acquired;
...
#[no_mangle]
unsafe extern "C" fn pqi_scan_start(shost: *mut Scsi_Host) {
    static void pqi_scan_start(struct Scsi_Host *shost)
    {
    struct pqi_ctrl_info *ctrl_info;
...
pub const PQI_RAID_BYPASS_INELIGIBLE: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn pqi_set_aio_cdb(rmd: *mut pqi_scsi_dev_raid_map_data) {
...
// Build the new CDB for the physical disk I/O.
    ...
    let mut rmd: pqi_scsi_dev_raid_map_data = { 0 };
...
// Handle differing logical/physical block sizes.
    ...
    encryption_info_ptr = core::ptr::null_mut();
    }
    if (rmd.is_write) {
...
pub const PQI_STATUS_IDLE: c_uint = 0x0;
pub const PQI_CREATE_ADMIN_QUEUE_PAIR: c_int = 1;
pub const PQI_DELETE_ADMIN_QUEUE_PAIR: c_int = 2;
pub const PQI_DEVICE_STATE_POWER_ON_AND_RESET: c_uint = 0x0;
pub const PQI_DEVICE_STATE_STATUS_AVAILABLE: c_uint = 0x1;
pub const PQI_DEVICE_STATE_ALL_REGISTERS_READY: c_uint = 0x2;
pub const PQI_DEVICE_STATE_ADMIN_QUEUE_PAIR_READY: c_uint = 0x3;
pub const PQI_DEVICE_STATE_ERROR: c_uint = 0x4;
pub const PQI_MODE_READY_TIMEOUT_SECS: c_int = 30;
pub const PQI_MODE_READY_POLL_INTERVAL_MSECS: c_int = 1;
#[no_mangle]
unsafe extern "C" fn pqi_wait_for_pqi_mode_ready(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_aio_path_disabled(io_request: *mut pqi_io_request) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_take_device_offline(sdev: *mut scsi_device, path: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn pqi_process_raid_io_error(io_request: *mut pqi_io_request) {
...
#[no_mangle]
unsafe extern "C" fn pqi_process_aio_io_error(io_request: *mut pqi_io_request) {
...
#[no_mangle]
unsafe extern "C" fn pqi_process_io_intr(ctrl_info: *mut pqi_ctrl_info, queue_group: *mut pqi_queue_group) -> c_int {
...
pub const PQI_SOFT_RESET_STATUS_TIMEOUT_SECS: c_int = 30;
pub const PQI_SOFT_RESET_STATUS_POLL_INTERVAL_SECS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn pqi_process_soft_reset(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_ofa_memory_alloc_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pqi_ofa_quiesce_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pqi_mark_volumes_for_rescan(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_disable_raid_bypass(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_event_worker(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PQI_EVENT_TYPE_AIO_STATE_CHANGE: event->event_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pqi_heartbeat_timer_handler(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn pqi_start_heartbeat_timer(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_stop_heartbeat_timer(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_process_event_intr(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
pub const PQI_LEGACY_INTX_MASK: c_uint = 0x1;
#[no_mangle]
pub unsafe extern "C" fn pqi_configure_legacy_intx(ctrl_info: *mut pqi_ctrl_info, enable_intx: bool) {
...
pub const PQI_LEGACY_INTX_PENDING: c_uint = 0x1;
#[no_mangle]
pub unsafe extern "C" fn pqi_is_valid_irq(ctrl_info: *mut pqi_ctrl_info) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pqi_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    pqi_start_io(ctrl_info, queue_group, RAID_PATH, core::ptr::null_mut());
    pqi_start_io(ctrl_info, queue_group, AIO_PATH, core::ptr::null_mut());
    out:
    return IRQ_HANDLED;
    }
#[no_mangle]
unsafe extern "C" fn pqi_request_irqs(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_free_irqs(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_enable_msix_interrupts(ctrl_info: *mut pqi_ctrl_info) -> c_int {
    static int pqi_enable_msix_interrupts(struct pqi_ctrl_info *ctrl_info)
    {
    int num_vectors_enabled;
    let mut flags: c_uint = PCI_IRQ_MSIX;
...
#[no_mangle]
unsafe extern "C" fn pqi_disable_msix_interrupts(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_alloc_operational_queues(ctrl_info: *mut pqi_ctrl_info) -> c_int {
    ...
    aligned_pointer = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pqi_init_operational_queues(ctrl_info: *mut pqi_ctrl_info) {
    static void pqi_init_operational_queues(struct pqi_ctrl_info *ctrl_info)
    {
    unsigned int i;
    let mut next_iq_id: u16 = PQI_MIN_OPERATIONAL_QUEUE_ID;
    let mut next_oq_id: u16 = PQI_MIN_OPERATIONAL_QUEUE_ID;
//
...
#[no_mangle]
unsafe extern "C" fn pqi_alloc_admin_queues(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
pub const PQI_ADMIN_QUEUE_CREATE_POLL_INTERVAL_MSECS: c_int = 1;
#[no_mangle]
unsafe extern "C" fn pqi_create_admin_queues(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
pub const PQI_ADMIN_REQUEST_TIMEOUT_SECS: c_int = 60;
...
pub const PQI_WAIT_FOR_COMPLETION_IO_TIMEOUT_SECS: c_int = 10;
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_blockable_request(request: *mut pqi_iu_header) -> bool {
...
//
    ...
    io_request = pqi_alloc_io_request(ctrl_info, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pqi_report_device_capability(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_validate_device_capability(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_create_event_queue(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_create_queues(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_enable_events(ctrl_info: *mut pqi_ctrl_info) -> c_int {
    static inline int pqi_enable_events(struct pqi_ctrl_info *ctrl_info)
    {
    return pqi_configure_events(ctrl_info, true);
    }
#[no_mangle]
unsafe extern "C" fn pqi_free_all_io_requests(ctrl_info: *mut pqi_ctrl_info) {
    ...
    ctrl_info.io_request_pool = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_alloc_error_buffer(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_alloc_io_resources(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pqi_calculate_io_resources(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_calculate_queue_resources(ctrl_info: *mut pqi_ctrl_info) {
...
// Add one because one element in each queue is unusable.
    ...
    {
    let mut address: u64 = (u64)sg_dma_address(sg);
    let mut length: c_uint = sg_dma_len(sg);
...
#[no_mangle]
unsafe extern "C" fn pqi_raid_bypass_retry_needed(io_request: *mut pqi_io_request) -> bool {
    ...
    scmd.cmnd, scmd.cmd_len, queue_group, core::ptr::null_mut(),
    false, io_high_prio);
    }
    static int pqi_aio_submit_io(struct pqi_ctrl_info *ctrl_info,
    struct scsi_cmnd *scmd, u32 aio_handle, u8 *cdb,
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_bypass_eligible_request(scmd: *mut scsi_cmnd) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pqi_prep_for_scsi_done(scmd: *mut scsi_cmnd) {
...
//
    ...
    wait = (struct completion *)xchg(&scmd.host_scribble, core::ptr::null_mut());
...
//
    ...
    out:
    if (rc) {
    scmd.host_scribble = core::ptr::null_mut();
    atomic_dec(&device.scsi_cmds_outstanding[lun]);
    }
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn pqi_queued_io_count(ctrl_info: *mut pqi_ctrl_info) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pqi_nonempty_inbound_queue_count(ctrl_info: *mut pqi_ctrl_info) -> c_uint {
...
pub const PQI_INBOUND_QUEUES_NONEMPTY_WARNING_TIMEOUT_SECS: c_int = 10;
#[no_mangle]
unsafe extern "C" fn pqi_wait_until_inbound_queues_empty(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
pub const PQI_PENDING_IO_WARNING_TIMEOUT_SECS: c_int = 10;
    static int pqi_device_wait_for_pending_io(struct pqi_ctrl_info *ctrl_info,
    struct pqi_scsi_dev *device, u8 lun, unsigned long timeout_msecs)
    {
...
pub const PQI_LUN_RESET_POLL_COMPLETION_SECS: c_int = 10;
...
pub const PQI_LUN_RESET_FIRMWARE_TIMEOUT_SECS: c_int = 30;
#[no_mangle]
unsafe extern "C" fn pqi_lun_reset(ctrl_info: *mut pqi_ctrl_info, device: *mut pqi_scsi_dev, lun: u8) -> c_int {
...
pub const PQI_LUN_RESET_RETRIES: c_int = 3;

#[no_mangle]
unsafe extern "C" fn pqi_lun_reset_with_retries(ctrl_info: *mut pqi_ctrl_info, device: *mut pqi_scsi_dev, lun: u8) -> c_int {
    ...
    reset_rc = wait_rc;
    let mut reset_rc: return = = 0 ? SUCCESS : FAILED;
    }
#[no_mangle]
unsafe extern "C" fn pqi_device_reset(ctrl_info: *mut pqi_ctrl_info, device: *mut pqi_scsi_dev, lun: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_device_reset_handler(ctrl_info: *mut pqi_ctrl_info, device: *mut pqi_scsi_dev, lun: u8, scmd: *mut scsi_cmnd, scsi_opcode: u8) -> c_int {
    ...
    mutex_lock(&ctrl_info.lun_reset_mutex);
    spin_lock_irqsave(&ctrl_info.scsi_device_list_lock, flags);
    if (pqi_find_scsi_dev(ctrl_info, device.bus, device.target, device.lun) == core::ptr::null_mut()) {
    dev_warn(&ctrl_info.pci_dev.dev,
...
#[no_mangle]
unsafe extern "C" fn pqi_eh_device_reset_handler(scmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_tmf_worker(work: *mut work_struct) {
    static void pqi_tmf_worker(struct work_struct *work)
    {
    struct pqi_tmf_work *tmf_work;
    struct scsi_cmnd *scmd;
    tmf_work = container_of(work, struct pqi_tmf_work, work_struct);
    scmd = (struct scsi_cmnd *)xchg(&tmf_work.scmd, core::ptr::null_mut());
    pqi_device_reset_handler(tmf_work.ctrl_info, tmf_work.device, tmf_work.lun, scmd, tmf_work.scsi_opcode);
    }
#[no_mangle]
unsafe extern "C" fn pqi_eh_abort_handler(scmd: *mut scsi_cmnd) -> c_int {
    ...
    if (cmpxchg(&scmd.host_scribble, PQI_NO_COMPLETION, (void *)&wait) == core::ptr::null_mut()) {
    dev_err(&ctrl_info.pci_dev.dev,
    ...
    if (cmpxchg(&tmf_work.scmd, core::ptr::null_mut(), scmd) == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn pqi_sdev_init(sdev: *mut scsi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_map_queues(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_is_tape_changer_device(device: *mut pqi_scsi_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pqi_sdev_destroy(sdev: *mut scsi_device) {
...
#[no_mangle]
unsafe extern "C" fn pqi_getpciinfo_ioctl(ctrl_info: *mut pqi_ctrl_info, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_getdrivver_ioctl(arg: *mut void __user) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ciss_error_info {
    pub scsi_status: u8,
    pub command_status: c_int,
    pub sense_data_length: usize,
}
...
#[no_mangle]
unsafe extern "C" fn pqi_passthru_ioctl(ctrl_info: *mut pqi_ctrl_info, arg: *mut void __user) -> c_int {
    static int pqi_passthru_ioctl(struct pqi_ctrl_info *ctrl_info, void __user *arg)
    {
    int rc;
    char *kernel_buffer = core::ptr::null_mut();
    u16 iu_length;
    size_t sense_data_length;
...
#[no_mangle]
unsafe extern "C" fn pqi_big_passthru_ioctl(ctrl_info: *mut pqi_ctrl_info, arg: *mut void __user) -> c_int {
    ...
    struct Scsi_Host *shost = class_to_shost(dev);
    struct pqi_ctrl_info *ctrl_info = shost_to_hba(shost);
    let mut set_stream_detection: u8 = 0;
    ...
    DRIVER_VERSION BUILD_TIMESTAMP);
    static DEVICE_ATTR(firmware_version, 0444, pqi_firmware_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(model, 0444, pqi_model_show, core::ptr::null_mut());
    static DEVICE_ATTR(serial_number, 0444, pqi_serial_number_show, core::ptr::null_mut());
    static DEVICE_ATTR(vendor, 0444, pqi_vendor_show, core::ptr::null_mut());
    static DEVICE_ATTR(rescan, 0200, core::ptr::null_mut(), pqi_host_rescan_store);
...
pub const MAX_PATHS: c_int = 8;
    ...
    active = "Active";
#[no_mangle]
pub unsafe extern "C" fn if(path_map_index: device->path_map &) -> else {
    ...
    static DEVICE_ATTR(lunid, 0444, pqi_lunid_show, core::ptr::null_mut());
    static DEVICE_ATTR(unique_id, 0444, pqi_unique_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(path_info, 0444, pqi_path_info_show, core::ptr::null_mut());
    static DEVICE_ATTR(sas_address, 0444, pqi_sas_address_show, core::ptr::null_mut());
    static DEVICE_ATTR(ssd_smart_path_enabled, 0444, pqi_ssd_smart_path_enabled_show, core::ptr::null_mut());
    static DEVICE_ATTR(raid_level, 0444, pqi_raid_level_show, core::ptr::null_mut());
    static DEVICE_ATTR(raid_bypass_cnt, 0444, pqi_raid_bypass_cnt_show, core::ptr::null_mut());
    static DEVICE_ATTR(sas_ncq_prio_enable, 0644,
    pqi_sas_ncq_prio_enable_show, pqi_sas_ncq_prio_enable_store);
    static DEVICE_ATTR(numa_node, 0444, pqi_numa_node_show, core::ptr::null_mut());
    static DEVICE_ATTR(write_stream_cnt, 0444, pqi_write_stream_cnt_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pqi_register_scsi(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_unregister_scsi(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_wait_for_pqi_reset_completion(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_reset(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_get_ctrl_serial_number(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_get_ctrl_product_details(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pqi_config_table_section_info {
    pub ctrl_info: *mut pqi_ctrl_info,
    pub section: *mut c_void,
    pub section_offset: u32,
    pub section_iomem_addr: *mut void __iomem,
}
    ...
    return *(( u8 *)features_enabled_iomem_addr) &
    (1 << (bit_position % BITS_PER_BYTE)) ? true : false;
    }
    ...
    return pqi_submit_raid_request_synchronous(ctrl_info, &request.header, 0, core::ptr::null_mut());
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pqi_firmware_feature {
    pub feature_name: *mut c_char,
    pub feature_bit: c_uint,
    pub supported: bool,
    pub enabled: bool,
    void (*feature_status)(struct pqi_ctrl_info *ctrl_info,
    pub firmware_feature): *mut pqi_firmware_feature,
}
...
#[no_mangle]
unsafe extern "C" fn pqi_init_firmware_features() {
...
//
#[no_mangle]
unsafe extern "C" fn pqi_ctrl_reset_config(ctrl_info: *mut pqi_ctrl_info) {
    static void pqi_ctrl_reset_config(struct pqi_ctrl_info *ctrl_info)
    {
    ctrl_info.heartbeat_counter = core::ptr::null_mut();
    ctrl_info.soft_reset_status = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pqi_process_config_table(ctrl_info: *mut pqi_ctrl_info) -> c_int {
    ...
    struct pqi_config_table_section_info section_info;
    let mut feature_section_info: pqi_config_table_section_info = {0};
...
#[no_mangle]
unsafe extern "C" fn pqi_revert_to_sis_mode(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pqi_force_sis_mode(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_perform_lockup_action() {
...
#[no_mangle]
unsafe extern "C" fn pqi_ctrl_init(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_reinit_queues(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_ctrl_init_resume(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_set_pcie_completion_timeout(pci_dev: *mut pci_dev, timeout: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_pci_init(ctrl_info: *mut pqi_ctrl_info) -> c_int {
...
pub const PCI_EXP_COMP_TIMEOUT_65_TO_210_MS: c_uint = 0x6;
...
#[no_mangle]
unsafe extern "C" fn pqi_cleanup_pci_init(ctrl_info: *mut pqi_ctrl_info) {
    ...
    pci_disable_device(ctrl_info.pci_dev);
    pci_set_drvdata(ctrl_info.pci_dev, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn pqi_free_ctrl_info(ctrl_info: *mut pqi_ctrl_info) {
    static inline void pqi_free_ctrl_info(struct pqi_ctrl_info *ctrl_info)
    {
    kfree(ctrl_info);
    }
#[no_mangle]
unsafe extern "C" fn pqi_free_interrupts(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_free_ctrl_resources(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_remove_ctrl(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_ofa_ctrl_quiesce(ctrl_info: *mut pqi_ctrl_info) {
    static void pqi_ofa_ctrl_quiesce(struct pqi_ctrl_info *ctrl_info)
    {
...
#[no_mangle]
unsafe extern "C" fn pqi_ofa_ctrl_unquiesce(ctrl_info: *mut pqi_ctrl_info) {
    static void pqi_ofa_ctrl_unquiesce(struct pqi_ctrl_info *ctrl_info)
    {
    pqi_start_heartbeat_timer(ctrl_info);
    pqi_ctrl_unblock_requests(ctrl_info);
...
#[no_mangle]
unsafe extern "C" fn pqi_ofa_ctrl_restart(ctrl_info: *mut pqi_ctrl_info, delay_secs: c_uint) -> c_int {
    static int pqi_ofa_ctrl_restart(struct pqi_ctrl_info *ctrl_info, unsigned int delay_secs)
    {
    ssleep(delay_secs);
    ...
    host_memory_descriptor.host_memory = core::ptr::null_mut();
    return;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn pqi_fail_all_outstanding_requests(ctrl_info: *mut pqi_ctrl_info) {
    static void pqi_fail_all_outstanding_requests(struct pqi_ctrl_info *ctrl_info)
    {
    unsigned int i;
    struct pqi_io_request *io_request;
...
#[no_mangle]
unsafe extern "C" fn pqi_take_ctrl_offline_deferred(ctrl_info: *mut pqi_ctrl_info) {
...
#[no_mangle]
unsafe extern "C" fn pqi_ctrl_offline_worker(work: *mut work_struct) {
    static void pqi_ctrl_offline_worker(struct work_struct *work)
    {
    struct pqi_ctrl_info *ctrl_info;
...
#[no_mangle]
unsafe extern "C" fn pqi_take_ctrl_devices_offline(ctrl_info: *mut pqi_ctrl_info) {
    static void pqi_take_ctrl_devices_offline(struct pqi_ctrl_info *ctrl_info)
    {
    int rc;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn pqi_pci_remove(pci_dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pqi_crash_if_pending_command(ctrl_info: *mut pqi_ctrl_info) {
    ...
    continue;
    scmd = io_request.scmd;
    WARN_ON(scmd != core::ptr::null_mut()); /* IO command from SML */
    WARN_ON(scmd == core::ptr::null_mut()); /* Non-IO cmd or driver initiated*/
    }
    }
#[no_mangle]
unsafe extern "C" fn pqi_shutdown(pci_dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pqi_process_lockup_action_param() {
...
pub const PQI_CTRL_READY_TIMEOUT_PARAM_MIN_SECS: c_int = 30;

#[no_mangle]
unsafe extern "C" fn pqi_process_ctrl_ready_timeout_param() {
...
#[no_mangle]
unsafe extern "C" fn pqi_process_module_params() {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_get_flush_cache_shutdown_event(pci_dev: *mut pci_dev) -> enum bmic_flush_cache_shutdown_event {
...
#[no_mangle]
unsafe extern "C" fn pqi_suspend_or_freeze(dev: *mut device, suspend: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_suspend(dev: *mut device) -> __maybe_unused int {
    static __maybe_unused int pqi_suspend(struct device *dev)
    {
    return pqi_suspend_or_freeze(dev, true);
    }
#[no_mangle]
unsafe extern "C" fn pqi_resume_or_restore(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_freeze(dev: *mut device) -> c_int {
    static int pqi_freeze(struct device *dev)
    {
    return pqi_suspend_or_freeze(dev, false);
    }
#[no_mangle]
unsafe extern "C" fn pqi_thaw(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_poweroff(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pqi_cleanup() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn pqi_verify_structures() {
    static void pqi_verify_structures(void)
    {
