...
//! Source: drivers/scsi/smartpqi/smartpqi_sas_transport.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pqi_free_sas_phy(pqi_sas_phy: *mut pqi_sas_phy) {
...
#[no_mangle]
unsafe extern "C" fn pqi_sas_port_add_phy(pqi_sas_phy: *mut pqi_sas_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_free_sas_port(pqi_sas_port: *mut pqi_sas_port) {
...
#[no_mangle]
unsafe extern "C" fn pqi_free_sas_node(pqi_sas_node: *mut pqi_sas_node) {
...
#[no_mangle]
pub unsafe extern "C" fn pqi_add_sas_host(shost: *mut Scsi_Host, ctrl_info: *mut pqi_ctrl_info) -> c_int {
    ...
    ctrl_info.sas_address, core::ptr::null_mut());
    if (!pqi_sas_port) {
    rc = -ENODEV;
    goto free_sas_node;
    }
...
#[no_mangle]
pub unsafe extern "C" fn pqi_delete_sas_host(ctrl_info: *mut pqi_ctrl_info) {
    ...
    free_sas_port:
    pqi_free_sas_port(pqi_sas_port);
    device.sas_port = core::ptr::null_mut();
    return rc;
    }
#[no_mangle]
pub unsafe extern "C" fn pqi_remove_sas_device(device: *mut pqi_scsi_dev) {
...
#[no_mangle]
unsafe extern "C" fn pqi_sas_get_linkerrors(phy: *mut sas_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_sas_get_bay_identifier(rphy: *mut sas_rphy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pqi_sas_phy_reset(phy: *mut sas_phy, hard_reset: c_int) -> c_int {
    static int pqi_sas_phy_reset(struct sas_phy *phy, int hard_reset)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pqi_sas_phy_enable(phy: *mut sas_phy, enable: c_int) -> c_int {
    static int pqi_sas_phy_enable(struct sas_phy *phy, int enable)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pqi_sas_phy_setup(phy: *mut sas_phy) -> c_int {
    static int pqi_sas_phy_setup(struct sas_phy *phy)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn pqi_sas_phy_release(phy: *mut sas_phy) {
...
pub const CSMI_IOCTL_TIMEOUT: c_int = 60;
pub const SMP_CRC_FIELD_LENGTH: c_int = 4;
