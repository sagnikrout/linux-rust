...
//! Source: drivers/scsi/fnic/fnic_debugfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fc_trace_flag_type {
    pub fc_row_file: u8,
    pub fc_normal_file: u8,
    pub fnic_trace: u8,
    pub fc_trace: u8,
    pub fc_clear: u8,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_debugfs_init() -> c_int {
    int fnic_debugfs_init(void)
    {
    fnic_trace_debugfs_root = debugfs_create_dir("fnic", core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_debugfs_terminate() {
    void fnic_debugfs_terminate(void)
    {
    debugfs_remove(fnic_nvmef_debugfs_root);
    fnic_nvmef_debugfs_root = core::ptr::null_mut();
    debugfs_remove(fnic_stats_debugfs_root);
    fnic_stats_debugfs_root = core::ptr::null_mut();
    debugfs_remove(fnic_trace_debugfs_root);
    fnic_trace_debugfs_root = core::ptr::null_mut();
    vfree(fc_trc_flag);
    }
//
...
#[no_mangle]
pub unsafe extern "C" fn if(fc_trc_flag->fc_trace: *mut *mut trace_type ==) -> else {
    else if (*trace_type == fc_trc_flag.fc_trace)
    len = sprintf(buf, "%d\n", fnic_fc_tracing_enabled);
#[no_mangle]
pub unsafe extern "C" fn if(fc_trc_flag->fc_clear: *mut *mut trace_type ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_trace_debugfs_init() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_trace_debugfs_terminate() {
    void fnic_trace_debugfs_terminate(void)
    {
    debugfs_remove(fnic_trace_debugfs_file);
    fnic_trace_debugfs_file = core::ptr::null_mut();
    debugfs_remove(fnic_trace_enable);
    fnic_trace_enable = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_fc_trace_debugfs_init() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_fc_trace_debugfs_terminate() {
    void fnic_fc_trace_debugfs_terminate(void)
    {
    debugfs_remove(fnic_fc_trace_debugfs_file);
    fnic_fc_trace_debugfs_file = core::ptr::null_mut();
    debugfs_remove(fnic_fc_rdata_trace_debugfs_file);
    fnic_fc_rdata_trace_debugfs_file = core::ptr::null_mut();
    debugfs_remove(fnic_fc_trace_enable);
    fnic_fc_trace_enable = core::ptr::null_mut();
    debugfs_remove(fnic_fc_trace_clear);
    fnic_fc_trace_clear = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fnic_reset_stats_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    struct stats_debug_info *debug;
    let mut buf_size: c_int = 2 * PAGE_SIZE;
    debug = kzalloc_obj(struct stats_debug_info);
    if (!debug)
    return -ENOMEM;
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_stats_debugfs_init(fnic: *mut fnic) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_stats_debugfs_remove(fnic: *mut fnic) {
    void fnic_stats_debugfs_remove(struct fnic *fnic)
    {
    if (!fnic)
    return;
    debugfs_remove(fnic.fnic_stats_debugfs_file);
    fnic.fnic_stats_debugfs_file = core::ptr::null_mut();
    debugfs_remove(fnic.fnic_reset_debugfs_file);
    fnic.fnic_reset_debugfs_file = core::ptr::null_mut();
    debugfs_remove(fnic.fnic_stats_debugfs_host);
    fnic.fnic_stats_debugfs_host = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn fnic_nvmef_debugfs_init(fnic: *mut fnic) {
...
#[no_mangle]
unsafe extern "C" fn fnic_nvmef_debugfs_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fnic_nvmef_debugfs_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_nvmef_debugfs_remove(fnic: *mut fnic) {
    void fnic_nvmef_debugfs_remove(struct fnic *fnic)
    {
    if (!fnic)
    return;
    debugfs_remove(fnic.fnic_nvmef_debugfs_file);
    fnic.fnic_nvmef_debugfs_file = core::ptr::null_mut();
    debugfs_remove(fnic.fnic_nvmef_debugfs_host);
    fnic.fnic_nvmef_debugfs_host = core::ptr::null_mut();
    }
