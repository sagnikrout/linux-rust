...
//! Source: drivers/scsi/fnic/fnic_scsi.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn fnic_count_ioreqs(fnic: *mut fnic, portid: u32) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_count_all_ioreqs(fnic: *mut fnic) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn free_wq_copy_descs(fnic: *mut fnic, wq: *mut vnic_wq_copy, hwq: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_fw_reset_handler(fnic: *mut fnic) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_flogi_reg_handler(fnic: *mut fnic, fc_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(DMA_TO_DEVICE: sc->sc_data_direction ==) -> else {
...
// scsi pri and tag
    ...
    struct scsi_cmnd *sc)
    {
    let mut rq: *mut request const = scsi_cmd_to_rq(sc);
    let mut mqtag: u32 = 0;
    void (*done)(struct scsi_cmnd *) = scsi_done;
    struct fc_rport *rport;
    struct fnic_io_req *io_req = core::ptr::null_mut();
    struct fnic *fnic = *((struct fnic **) shost_priv(sc.device.host));
    struct fnic_iport_s *iport = core::ptr::null_mut();
    struct fnic_stats *fnic_stats = &fnic.fnic_stats;
    struct vnic_wq_copy *wq;
    let mut ret: c_int = 1;
    u64 cmd_trace;
    let mut sg_count: c_int = 0;
    let mut flags: c_ulong = 0;
    unsigned long ptr;
    let mut hwq: u16 = 0;
    struct fnic_tport_s *tport = core::ptr::null_mut();
    struct rport_dd_data_s *rdd_data;
    let mut lun0_delay: u16 = 0;
    rport = starget_to_rport(scsi_target(sc.device));
    if (!rport) {
    FNIC_SCSI_DBG(KERN_ERR, fnic,
    "returning DID_NO_CONNECT for IO as rport is core::ptr::null_mut()\n");
...
// initialize rest of io_req
    ...
    io_req.sc = sc;
    if (fnic.sw_copy_wq[hwq].io_req_table[blk_mq_unique_tag_to_tag(mqtag)] != core::ptr::null_mut()) {
...
//
    ...
    fnic_priv(sc).io_req = core::ptr::null_mut();
    if (io_req)
    fnic.sw_copy_wq[hwq].io_req_table[blk_mq_unique_tag_to_tag(mqtag)] = core::ptr::null_mut();
...
//
    ...
    {
    struct vnic_wq_copy *wq;
    let mut request_out: u16 = desc.u.ack.request_out;
    unsigned long flags;
    u64 *ox_id_tag = (u64 *)(void *)desc;
    let mut wq_index: c_uint = cq_index;
// mark the ack state
...
//
    ...
    let mut hwq: c_uint = 0;
    let mut mqtag: c_uint = 0;
...
// Break link with the SCSI command
    fnic_priv(sc).io_req = core::ptr::null_mut();
    io_req.sc = core::ptr::null_mut();
    fnic_priv(sc).flags |= FNIC_IO_DONE;
    fnic.sw_copy_wq[hwq].io_req_table[tag] = core::ptr::null_mut();
    spin_unlock_irqrestore(&fnic.wq_copy_lock[hwq], flags);
...
//
    ...
    struct fcpio_tag ftag;
    u32 id;
    struct scsi_cmnd *sc = core::ptr::null_mut();
    struct fnic_io_req *io_req;
    struct fnic_stats *fnic_stats = &fnic.fnic_stats;
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_wq_copy_cmpl_handler(fnic: *mut fnic, copy_work_to_do: c_int, cq_index: c_uint) -> c_int {
    int fnic_wq_copy_cmpl_handler(struct fnic *fnic, int copy_work_to_do, unsigned int cq_index)
    {
    unsigned int cur_work_done;
    struct misc_stats *misc_stats = &fnic.fnic_stats.misc_stats;
    let mut start_jiffies: u64 = 0;
    let mut end_jiffies: u64 = 0;
    let mut delta_jiffies: u64 = 0;
    let mut delta_ms: u64 = 0;
...
#[no_mangle]
unsafe extern "C" fn fnic_cleanup_io_iter(sc: *mut scsi_cmnd, data: *mut c_void) -> bool {
    static bool fnic_cleanup_io_iter(struct scsi_cmnd *sc, void *data)
    {
    let mut rq: *mut request const = scsi_cmd_to_rq(sc);
    struct fnic *fnic = data;
    struct fnic_io_req *io_req;
    let mut start_time: c_ulong = 0;
    unsigned long flags;
    struct fnic_stats *fnic_stats = &fnic.fnic_stats;
    let mut hwq: u16 = 0;
    int tag;
...
//
    ...
    complete(io_req.dr_done);
#[no_mangle]
pub unsafe extern "C" fn if(io_req->abts_done: io_req &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn fnic_cleanup_io(fnic: *mut fnic, exclude_id: c_int) {
    static void fnic_cleanup_io(struct fnic *fnic, int exclude_id)
    {
    let mut io_count: c_uint = 0;
    unsigned long flags;
    struct fnic_io_req *io_req = core::ptr::null_mut();
    struct scsi_cmnd *sc = core::ptr::null_mut();
...
// fnic interrupts are turned off by now
    ...
    fnic_priv(sc).io_req = core::ptr::null_mut();
    io_req.sc = core::ptr::null_mut();
    fnic.sw_copy_wq[hwq].io_req_table[blk_mq_unique_tag_to_tag(id)] = core::ptr::null_mut();
    spin_unlock_irqrestore(&fnic.wq_copy_lock[hwq], flags);
    start_time = io_req.start_time;
    fnic_release_ioreq_buf(fnic, io_req, sc);
    mempool_free(io_req, fnic.io_req_pool);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fnic_rport_abort_io_iter_data {
    pub fnic: *mut fnic,
    pub port_id: u32,
    pub term_cnt: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn fnic_rport_abort_io_iter(sc: *mut scsi_cmnd, data: *mut c_void) -> bool {
    static bool fnic_rport_abort_io_iter(struct scsi_cmnd *sc, void *data)
    {
    let mut rq: *mut request const = scsi_cmd_to_rq(sc);
    struct fnic_rport_abort_io_iter_data *iter_data = data;
    struct fnic *fnic = iter_data.fnic;
    let mut abt_tag: c_int = 0;
    struct fnic_io_req *io_req;
    struct reset_stats *reset_stats = &fnic.fnic_stats.reset_stats;
    struct terminate_stats *term_stats = &fnic.fnic_stats.term_stats;
    struct scsi_lun fc_lun;
    ...
    if (!sc) {
    FNIC_SCSI_DBG(KERN_DEBUG, fnic,
    "sc is core::ptr::null_mut() abt_tag: 0x%x hwq: %d\n", abt_tag, hwq);
    return true;
    }
    spin_lock_irqsave(&fnic.wq_copy_lock[hwq], flags);
    io_req = fnic_priv(sc).io_req;
...
#[no_mangle]
pub unsafe extern "C" fn fnic_rport_exch_reset(fnic: *mut fnic, port_id: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_terminate_rport_io(rport: *mut fc_rport) {
    void fnic_terminate_rport_io(struct fc_rport *rport)
    {
    struct fnic_tport_s *tport;
    struct rport_dd_data_s *rdd_data;
    struct fnic_iport_s *iport = core::ptr::null_mut();
    struct fnic *fnic = core::ptr::null_mut();
    if (!rport) {
    pr_err("rport is core::ptr::null_mut()\n");
    return;
    }
    rdd_data = rport.dd_data;
    if (rdd_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_scsi_unload(fnic: *mut fnic) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_scsi_unload_cleanup(fnic: *mut fnic) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_abort_cmd(sc: *mut scsi_cmnd) -> c_int {
...
// Now queue the abort command to firmware
    ...
    io_req = fnic_priv(sc).io_req;
    if (io_req)
    io_req.abts_done = core::ptr::null_mut();
    spin_unlock_irqrestore(&fnic.wq_copy_lock[hwq], flags);
    ret = FAILED;
    goto fnic_abort_cmd_end;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fnic_pending_aborts_iter_data {
    pub fnic: *mut fnic,
    pub lr_sc: *mut scsi_cmnd,
    pub lun_dev: *mut scsi_device,
    pub ret: c_int,
}

#[no_mangle]
unsafe extern "C" fn fnic_pending_aborts_iter(sc: *mut scsi_cmnd, data: *mut c_void) -> bool {
...
// original sc used for lr is handled by dev reset code
    ...
    fnic_priv(sc).io_req = core::ptr::null_mut();
    fnic.sw_copy_wq[hwq].io_req_table[blk_mq_unique_tag_to_tag(abt_tag)] = core::ptr::null_mut();
    }
    spin_unlock_irqrestore(&fnic.wq_copy_lock[hwq], flags);
// original sc used for lr is handled by dev reset code
    if (sc != iter_data.lr_sc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_device_reset(sc: *mut scsi_cmnd) -> c_int {
    ...
    let mut mqtag: c_int = rq.tag;
    DECLARE_COMPLETION_ONSTACK(tm_done);
    let mut new_sc: bool = 0;
    let mut hwq: u16 = 0;
    struct fnic_iport_s *iport = core::ptr::null_mut();
    struct rport_dd_data_s *rdd_data;
    struct fnic_tport_s *tport;
...
//
    ...
    io_req = fnic_priv(sc).io_req;
    if (io_req)
    io_req.dr_done = core::ptr::null_mut();
...
// Completed, and successful
    ...
    fnic_priv(sc).io_req = core::ptr::null_mut();
    io_req.sc = core::ptr::null_mut();
    fnic.sw_copy_wq[hwq].io_req_table[blk_mq_unique_tag_to_tag(io_req.tag)] = core::ptr::null_mut();
    }
    spin_unlock_irqrestore(&fnic.wq_copy_lock[hwq], flags);
    if (io_req) {
    start_time = io_req.start_time;
...
//
    ...
    fnic_flags_and_state(sc));
    if (new_sc) {
    fnic.sgreset_sc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn fnic_post_flogo_linkflap(fnic: *mut fnic) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_reset(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_issue_fc_host_lip(shost: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_host_reset(shost: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fnic_abts_pending_iter(sc: *mut scsi_cmnd, data: *mut c_void) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_is_abts_pending(fnic: *mut fnic, lr_sc: *mut scsi_cmnd) -> c_int {
    int fnic_is_abts_pending(struct fnic *fnic, struct scsi_cmnd *lr_sc)
    {
    struct fnic_pending_aborts_iter_data iter_data = {
    .fnic = fnic,
    .lun_dev = core::ptr::null_mut(),
    .ret = 0,
    };
    if (lr_sc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_eh_host_reset_handler(sc: *mut scsi_cmnd) -> c_int {
