...
//! Source: drivers/scsi/fnic/fdls_disc.c
#![no_std]
...
pub const FC_FC4_TYPE_SCSI: c_uint = 0x08;

pub const PORT_SPEED_BIT_8: c_int = 8;
pub const PORT_SPEED_BIT_9: c_int = 9;
pub const PORT_SPEED_BIT_14: c_int = 14;
pub const PORT_SPEED_BIT_15: c_int = 15;
// FNIC FDMI Register HBA Macros
pub const FNIC_FDMI_NUM_PORTS: c_int = 1;
pub const FNIC_FDMI_NUM_HBA_ATTRS: c_int = 9;

pub const FNIC_FDMI_NN_LEN: c_int = 8;
pub const FNIC_FDMI_MANU_LEN: c_int = 20;
pub const FNIC_FDMI_SERIAL_LEN: c_int = 16;
pub const FNIC_FDMI_MODEL_LEN: c_int = 12;
pub const FNIC_FDMI_MODEL_DES_LEN: c_int = 56;
pub const FNIC_FDMI_HW_VER_LEN: c_int = 16;
pub const FNIC_FDMI_DR_VER_LEN: c_int = 28;
pub const FNIC_FDMI_ROM_VER_LEN: c_int = 8;
pub const FNIC_FDMI_FW_VER_LEN: c_int = 16;
// FNIC FDMI Register PA Macros

pub const FNIC_FDMI_NUM_PORT_ATTRS: c_int = 6;
pub const FNIC_FDMI_FC4_LEN: c_int = 32;
pub const FNIC_FDMI_SUPP_SPEED_LEN: c_int = 4;
pub const FNIC_FDMI_CUR_SPEED_LEN: c_int = 4;
pub const FNIC_FDMI_MFS_LEN: c_int = 4;
pub const FNIC_FDMI_MFS: c_uint = 0x800;
pub const FNIC_FDMI_OS_NAME_LEN: c_int = 16;
pub const FNIC_FDMI_HN_LEN: c_int = 24;
pub const FDLS_FDMI_PLOGI_PENDING: c_uint = 0x1;
pub const FDLS_FDMI_REG_HBA_PENDING: c_uint = 0x2;
pub const FDLS_FDMI_RPA_PENDING: c_uint = 0x4;
pub const FDLS_FDMI_ABORT_PENDING: c_uint = 0x8;
pub const FDLS_FDMI_MAX_RETRY: c_int = 3;
...
// Private Functions
    ...
    uint8_t *frame = core::ptr::null_mut();
    frame = mempool_alloc(fnic.frame_pool, GFP_ATOMIC);
    if (frame == core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn fdls_free_oxid_idx(iport: *mut fnic_iport_s, oxid_idx: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fdls_reclaim_oxid_handler(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fdls_schedule_oxid_free(iport: *mut fnic_iport_s, active_oxid: *mut u16) {
    void fdls_schedule_oxid_free(struct fnic_iport_s *iport, uint16_t *active_oxid)
    {
    struct fnic *fnic = iport.fnic;
    struct fnic_oxid_pool_s *oxid_pool = &iport.oxid_pool;
    struct reclaim_entry_s *reclaim_entry;
    let mut delay_j: c_ulong = msecs_to_jiffies(OXID_RECLAIM_TOV(iport));
    let mut oxid_idx: c_int = FNIC_OXID_IDX(*active_oxid);
    lockdep_assert_held(&fnic.fnic_lock);
    FNIC_FCS_DBG(KERN_INFO, fnic,
...
//
#[no_mangle]
pub unsafe extern "C" fn fdls_schedule_oxid_free_retry_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn fdls_is_oxid_fabric_req(oxid: u16) -> bool {
    static bool fdls_is_oxid_fabric_req(uint16_t oxid)
    {
    let mut oxid_frame_type: c_int = FNIC_FRAME_TYPE(oxid);
...
#[no_mangle]
unsafe extern "C" fn fdls_is_oxid_fdmi_req(oxid: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fdls_is_oxid_tgt_req(oxid: u16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fdls_is_oxid_nvme_req(oxid: u16) -> bool {
    static inline bool fdls_is_oxid_nvme_req(uint16_t oxid)
    {
    return FNIC_FRAME_TYPE(oxid) == FNIC_FRAME_TYPE_NVME_LS;
    }
#[no_mangle]
unsafe extern "C" fn fdls_reset_oxid_pool(iport: *mut fnic_iport_s) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_del_fabric_timer_sync(fnic: *mut fnic) {
...
#[no_mangle]
unsafe extern "C" fn fdls_set_frame_type(fnic: *mut fnic, frame_type: *mut u8) {
    static void fdls_set_frame_type(struct fnic *fnic, uint8_t *frame_type)
    {
    if (IS_FNIC_FCP_INITIATOR(fnic))
// frame_type = FC_TYPE_FCP;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_FNIC_NVME_INITIATOR(fnic)) -> else {
    else if (IS_FNIC_NVME_INITIATOR(fnic))
// frame_type = FC_TYPE_NVME;
    }
#[no_mangle]
unsafe extern "C" fn fdls_set_feature_type(fnic: *mut fnic, feature_type: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_fabric_abts(iport: *mut fnic_iport_s) {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_fdmi_abts(iport: *mut fnic_iport_s) {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_fabric_flogi(iport: *mut fnic_iport_s) {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_fabric_plogi(iport: *mut fnic_iport_s) {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_fdmi_plogi(iport: *mut fnic_iport_s) {
    static void fdls_send_fdmi_plogi(struct fnic_iport_s *iport)
    {
    uint8_t *frame;
    struct fc_std_flogi *pplogi;
...
#[no_mangle]
unsafe extern "C" fn fdls_send_rpn_id(iport: *mut fnic_iport_s) {
    static void fdls_send_rpn_id(struct fnic_iport_s *iport)
    {
    uint8_t *frame;
...
#[no_mangle]
unsafe extern "C" fn fdls_send_scr(iport: *mut fnic_iport_s) {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_gpn_ft(iport: *mut fnic_iport_s, fdls_state: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn fdls_delete_tport(iport: *mut fnic_iport_s, tport: *mut fnic_tport_s) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_register_fc4_types(iport: *mut fnic_iport_s) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_FNIC_FCP_INITIATOR(fnic)) -> else {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_register_fc4_features(iport: *mut fnic_iport_s) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fdls_send_fabric_logo(iport: *mut fnic_iport_s) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fdls_tgt_logout(iport: *mut fnic_iport_s, tport: *mut fnic_tport_s) {
...
#[no_mangle]
unsafe extern "C" fn fdls_tgt_discovery_start(iport: *mut fnic_iport_s) {
    static void fdls_tgt_discovery_start(struct fnic_iport_s *iport)
    {
    struct fnic_tport_s *tport, *next;
    let mut old_link_down_cnt: u32 = iport.fnic.link_down_cnt;
    struct fnic *fnic = iport.fnic;
    FNIC_FCS_DBG(KERN_INFO, fnic,
...
//
#[no_mangle]
unsafe extern "C" fn fdls_target_restart_nexus(tport: *mut fnic_tport_s) {
    static void fdls_target_restart_nexus(struct fnic_tport_s *tport)
    {
    struct fnic_iport_s *iport = tport.iport;
    struct fnic_tport_s *new_tport = core::ptr::null_mut();
    uint32_t fcid;
    uint64_t wwpn;
...
//
    ...
    void *data, u32 *off)
    {
    let mut size: u16 = len + FC_FDMI_ATTR_ENTRY_HEADER_LEN;
...
#[no_mangle]
unsafe extern "C" fn fdls_fdmi_register_hba(iport: *mut fnic_iport_s) {
    static void fdls_fdmi_register_hba(struct fnic_iport_s *iport)
    {
    uint8_t *frame;
    ...
    int err;
    struct fnic *fnic = iport.fnic;
    struct vnic_devcmd_fw_info *fw_info = core::ptr::null_mut();
    uint16_t oxid;
    u32 attr_off_bytes, len;
    u8 data[64];
    let mut frame_size: u16 = FNIC_ETH_FCOE_HDRS_OFFSET;
    frame = fdls_alloc_frame(iport);
    if (frame == core::ptr::null_mut()) {
    FNIC_FCS_DBG(KERN_ERR, fnic,
...
#[no_mangle]
unsafe extern "C" fn fdls_fdmi_register_pa(iport: *mut fnic_iport_s) {
    static void fdls_fdmi_register_pa(struct fnic_iport_s *iport)
    {
    uint8_t *frame;
    ...
    struct fnic *fnic = iport.fnic;
    u32 port_speed_bm;
    let mut port_speed: u32 = vnic_dev_port_speed(fnic.vdev);
    uint16_t oxid;
    u32 attr_off_bytes, len;
...
#[no_mangle]
pub unsafe extern "C" fn fdls_fabric_timer_callback(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn fdls_fdmi_retry_plogi(iport: *mut fnic_iport_s) {
...
#[no_mangle]
pub unsafe extern "C" fn fdls_fdmi_timer_callback(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn fdls_send_delete_tport_msg(tport: *mut fnic_tport_s) {
...
#[no_mangle]
unsafe extern "C" fn fdls_tport_timer_callback(t: *mut timer_list) {
    static void fdls_tport_timer_callback(struct timer_list *t)
    {
    ...
    uint16_t oxid;
    unsigned long flags;
    let mut fchdr: fc_frame_header = {0};
    uint8_t fcid[3];
    spin_lock_irqsave(&fnic.fnic_lock, flags);
    if (!tport.timer_pending) {
    spin_unlock_irqrestore(&fnic.fnic_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn fnic_fdls_start_flogi(iport: *mut fnic_iport_s) {
    static void fnic_fdls_start_flogi(struct fnic_iport_s *iport)
    {
...
#[no_mangle]
unsafe extern "C" fn fnic_fdls_start_plogi(iport: *mut fnic_iport_s) {
    static void fnic_fdls_start_plogi(struct fnic_iport_s *iport)
    {
    iport.fabric.retry_counter = 0;
    fdls_send_fabric_plogi(iport);
...
// Max frame size - choose the lowest
    ...
    struct fnic *fnic = iport.fnic;
    let mut mismatched_tgt: bool = false;
    fcid = FNIC_STD_GET_S_ID(fchdr);
    tgt_fcid = ntoh24(fcid);
    FNIC_FCS_DBG(KERN_INFO, fnic,
...
// Inform the driver about new target added
    ...
    uint16_t rsp;
    uint8_t reason_code;
    let mut oxid: u16 = FNIC_STD_GET_OX_ID(fchdr);
...
//
    ...
    let mut fabric_state: u32 = iport.fabric.state;
    struct fnic *fnic = iport.fnic;
    int frame_type;
    uint16_t oxid;
...
// pba_acc = (struct fc_std_abts_ba_acc) {
    ...
    uint16_t oxid;
    let mut d_id: u32 = ntoh24(fchdr.fh_d_id);
    struct fnic *fnic = iport.fnic;
    uint16_t frame_size = FNIC_ETH_FCOE_HDRS_OFFSET +
...
// got a logo in response to adisc to a target which has logged out
    ...
    struct fc_els_rscn_page *rscn_port = core::ptr::null_mut();
    int num_ports;
    struct fnic_tport_s *tport, *next;
    uint32_t nport_id;
    uint8_t fcid[3];
    let mut newports: c_int = 0;
    struct fnic_fdls_fabric_s *fdls = &iport.fabric;
    struct fnic *fnic = iport.fnic;
    let mut rscn_type: c_int = NOT_PC_RSCN;
    let mut sid: u32 = ntoh24(fchdr.fh_s_id);
    let mut reset_fnic_list_lock_flags: c_ulong = 0;
...
#[no_mangle]
pub unsafe extern "C" fn fnic_fdls_disc_start(iport: *mut fnic_iport_s) {
...
// send reject
    ...
    if (rjt_frame == core::ptr::null_mut()) {
    FNIC_FCS_DBG(KERN_ERR, fnic,
    ...
    if (acc_frame == core::ptr::null_mut()) {
    FNIC_FCS_DBG(KERN_ERR, fnic,
...
#[no_mangle]
pub unsafe extern "C" fn fnic_fdls_disc_init(iport: *mut fnic_iport_s) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_fdls_link_down(iport: *mut fnic_iport_s) {
