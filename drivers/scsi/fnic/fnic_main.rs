...
//! Source: drivers/scsi/fnic/fnic_main.c
#![no_std]
...
pub const PCI_DEVICE_ID_CISCO_FNIC: c_uint = 0x0045;
...
// Supported devices by fnic module
    ...
    let mut nvme_dev_loss_tmo: c_uint = 30;
    ...
    let mut nvme_max_ios_to_process: c_uint = 16;
    ...
    let mut fnic_max_qdepth: static unsigned int = FNIC_DFLT_QUEUE_DEPTH;
    module_param(fnic_max_qdepth, uint, S_IRUGO|S_IWUSR);
    MODULE_PARM_DESC(fnic_max_qdepth, "Queue depth to report for each LUN");
    let mut pc_rscn_handling_feature_flag: c_uint = PC_RSCN_HANDLING_FEATURE_ON;
...
#[no_mangle]
unsafe extern "C" fn fnic_sdev_init(sdev: *mut scsi_device) -> c_int {
    ...
    .bsg_request = core::ptr::null_mut(),
    };
#[no_mangle]
unsafe extern "C" fn fnic_get_host_speed(shost: *mut Scsi_Host) {
    static void fnic_get_host_speed(struct Scsi_Host *shost)
    {
...
//
#[no_mangle]
unsafe extern "C" fn fnic_reset_host_stats(host: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_log_q_error(fnic: *mut fnic) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_handle_link_event(fnic: *mut fnic) {
...
#[no_mangle]
unsafe extern "C" fn fnic_notify_set(fnic: *mut fnic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fnic_notify_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn fnic_notify_timer_start(fnic: *mut fnic) {
...
#[no_mangle]
unsafe extern "C" fn fnic_cleanup(fnic: *mut fnic) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fnic_iounmap(fnic: *mut fnic) {
...
#[no_mangle]
unsafe extern "C" fn fnic_set_vlan(fnic: *mut fnic, vlan_id: u16) {
    static void fnic_set_vlan(struct fnic *fnic, u16 vlan_id)
    {
    vnic_dev_set_default_vlan(fnic.vdev, vlan_id);
    }
#[no_mangle]
unsafe extern "C" fn fnic_scsi_init(fnic: *mut fnic) {
...
#[no_mangle]
unsafe extern "C" fn fnic_free_ioreq_tables_mq(fnic: *mut fnic) {
...
#[no_mangle]
unsafe extern "C" fn fnic_scsi_drv_init(fnic: *mut fnic) -> c_int {
...
// Configure maximum outstanding IO reqs
    ...
    if (fnic.host.shost_data != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn fnic_nvme_drv_init(fnic: *mut fnic) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_mq_map_queues_cpus(host: *mut Scsi_Host) {
    void fnic_mq_map_queues_cpus(struct Scsi_Host *host)
    {
    struct fnic *fnic = *((struct fnic **) shost_priv(host));
    struct pci_dev *l_pdev = fnic.pdev;
    let mut intr_mode: c_int = fnic.config.intr_mode;
...
#[no_mangle]
unsafe extern "C" fn fnic_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
// Map vNIC resources from BAR0
    ...
    fnic.vdev = vnic_dev_register(core::ptr::null_mut(), fnic, pdev, &fnic.bar0);
    if (!fnic.vdev) {
...
#[no_mangle]
unsafe extern "C" fn fnic_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn fnic_init_module() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fnic_cleanup_module() -> void __exit {
