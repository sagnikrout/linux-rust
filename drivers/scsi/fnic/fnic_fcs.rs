...
//! Source: drivers/scsi/fnic/fnic_fcs.c
#![no_std]
...
pub const MAX_RESET_WAIT_COUNT: c_int = 64;
    struct workqueue_struct *fnic_event_queue;
    static uint8_t FCOE_ALL_FCF_MAC[6] = FC_FCOE_FLOGI_MAC;
#[no_mangle]
pub unsafe extern "C" fn fnic_is_nvme_frame(fchdr: *mut fc_frame_header) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_get_host_port_state(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn if(FNIC_IPORT_STATE_READY: iport->state ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_fdls_link_status_change(fnic: *mut fnic, linkup: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_fdls_init(fnic: *mut fnic, usefip: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_handle_link(work: *mut work_struct) {
    void fnic_handle_link(struct work_struct *work)
    {
    struct fnic *fnic = container_of(work, struct fnic, link_work);
    int old_link_status;
    u32 old_link_down_cnt;
    let mut max_count: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn fnic_handle_frame(work: *mut work_struct) {
    void fnic_handle_frame(struct work_struct *work)
    {
    struct fnic *fnic = container_of(work, struct fnic, frame_work);
    struct fnic_frame_list *cur_frame, *next;
    let mut fchdr_offset: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn fnic_handle_fip_frame(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_import_rq_eth_pkt(fnic: *mut fnic, fp: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_update_mac_locked(fnic: *mut fnic, new: *mut u8) {
...
// cq_desc, struct vnic_rq_buf *buf,
    ...
    let mut fcoe_fnic_crc_ok: u8 = 1, fcoe_enc_error = 0;
    let mut fcs_ok: u8 = 1, packet_error = 0;
    u16 q_number, completed_index, vlan;
    u32 rss_hash;
    u16 checksum;
    u8 csum_not_calc, rss_type, ipv4, ipv6, ipv4_fragment;
    u8 tcp_udp_csum_ok, udp, tcp, ipv4_csum_ok;
    let mut fcoe: u8 = 0, fcoe_sof, fcoe_eof;
    u16 exchange_id, tmpl;
    let mut sof: u8 = 0;
    let mut eof: u8 = 0;
    let mut fcp_bytes_written: u32 = 0;
    let mut enet_bytes_written: u16 = 0;
    let mut bytes_written: u32 = 0;
    unsigned long flags;
    struct fnic_frame_list *frame_elem = core::ptr::null_mut();
    struct ethhdr *eh;
    dma_unmap_single(&fnic.pdev.dev, buf.dma_addr, buf.len,
    DMA_FROM_DEVICE);
    fp = (uint8_t *) buf.os_buf;
    buf.os_buf = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn fnic_rq_cmpl_handler(fnic: *mut fnic, rq_work_to_do: c_int) -> c_int {
    int fnic_rq_cmpl_handler(struct fnic *fnic, int rq_work_to_do)
    {
    let mut tot_rq_work_done: c_uint = 0, cur_work_done;
    unsigned int i;
    int err;
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_alloc_rq_frame(rq: *mut vnic_rq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_free_rq_buf(rq: *mut vnic_rq, buf: *mut vnic_rq_buf) {
...
//
#[no_mangle]
unsafe extern "C" fn fnic_send_frame(fnic: *mut fnic, frame: *mut c_void, frame_len: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_flush_tx(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_free_txq(fnic: *mut fnic) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_free_rxq(fnic: *mut fnic) {
    ...
    fnic_wq_complete_frame_send, core::ptr::null_mut());
    spin_unlock_irqrestore(&fnic.wq_lock[q_number], flags);
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn fnic_wq_cmpl_handler(fnic: *mut fnic, work_to_do: c_int) -> c_int {
    int fnic_wq_cmpl_handler(struct fnic *fnic, int work_to_do)
    {
    let mut wq_work_done: c_uint = 0;
    unsigned int i;
...
#[no_mangle]
pub unsafe extern "C" fn fnic_free_wq_buf(wq: *mut vnic_wq, buf: *mut vnic_wq_buf) {
...
//
    rdd_data = rport.dd_data;
    rdd_data.tport = core::ptr::null_mut();
    rdd_data.iport = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn fnic_delete_fcp_tports(fnic: *mut fnic) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fnic_tport_event_handler(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_flush_tport_event_list(fnic: *mut fnic) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_reset_work_handler(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn fnic_fcpio_reset(fnic: *mut fnic) {
...
// fw reset is in progress, poll for its completion
    ...
    fnic.fw_reset_done = core::ptr::null_mut();
    }
