...
//! Source: drivers/scsi/bfa/bfa_fcs_lport.c
#![no_std]
...
//
    ...
    struct bfa_rport_s *bfa_rport = core::ptr::null_mut();
    int		len;
    ...
    BFA_FALSE, FC_CLASS_3, len, &fchs, core::ptr::null_mut(), core::ptr::null_mut(),
    FC_MAX_PDUSZ, 0);
    }
//
// Send a FCCT Reject
...
//
    ...
    bfa_fcxp_send(fcxp, bfa_rport, port.fabric.vf_id, port.lp_tag,
    BFA_FALSE, FC_CLASS_3, pyld_len, &fchs, core::ptr::null_mut(), core::ptr::null_mut(),
    FC_MAX_PDUSZ, 0);
    }
//
...
//
    ...
    rx_fchs.s_id, bfa_fcs_lport_get_fcid(port),
    rx_fchs.ox_id, 0);
    bfa_fcxp_send(fcxp, core::ptr::null_mut(), port.fabric.vf_id, port.lp_tag,
    BFA_FALSE, FC_CLASS_3, len, &fchs, core::ptr::null_mut(), core::ptr::null_mut(),
    FC_MAX_PDUSZ, 0);
    }
    static void
...
//
    ...
    {
    let mut pid: u32 = fchs.s_id;
    struct bfa_fcs_rport_s *rport = core::ptr::null_mut();
...
//
    ...
    lport.fabric.vf_drv,
    vport ? vport.vport_drv : core::ptr::null_mut());
    ...
    BFA_FCS_GET_NS_FROM_PORT(port), core::ptr::null_mut());
    }
//
// fcs_lport_api
//
    ...
    if (port.vport != core::ptr::null_mut()) {
...
//
    ...
    WARN_ON(rport == core::ptr::null_mut());
    if (rport) {
    bfa_trc(port.fcs, rport.pwwn);
    bfa_sm_send_event(rport, RPSM_EVENT_DELETE);
    }
...
//
    ...
    {
    let mut i: c_int = 0, j = 0, bit = 0, alpa_bit = 0;
    let mut k: u8 = 0;
...
//
    ...
    {
    let mut num_alpa: u8 = 0, alpabm_valid = 0;
    struct bfa_fcs_rport_s *rport;
    u8 *alpa_map = core::ptr::null_mut();
    let mut i: c_int = 0;
    u32 pid;
...
pub const BFA_FCS_FDMI_CMD_MAX_RETRIES: c_int = 2;
//
...
//
    ...
    bfa_fcs_lport_fdmi_send_rprt(fdmi, core::ptr::null_mut());
    } else {
//
...
//
    ...
    bfa_fcs_lport_fdmi_send_rhba(fdmi, core::ptr::null_mut());
    }
    break;
...
//
    ...
    fdmi.retry_cnt = 0;
    bfa_fcs_lport_fdmi_send_rpa(fdmi, core::ptr::null_mut());
    break;
    case FDMISM_EVENT_PORT_OFFLINE:
...
//
    ...
    if (attr_len < 0)
    return;
    bfa_fcxp_send(fcxp, core::ptr::null_mut(), port.fabric.vf_id, port.lp_tag, BFA_FALSE,
...
//
    ...
    struct bfa_fcs_lport_s *port = fdmi.ms.port;
    struct ct_hdr_s *cthdr = core::ptr::null_mut();
    bfa_trc(port.fcs, port.port_cfg.pwwn);
//
// Sanity Checks
//
...
pub const BFA_FCS_MS_CMD_MAX_RETRIES: c_int = 2;
//
// forward declarations
//
...
//
    ...
    bfa_fcs_lport_ms_send_plogi(ms, core::ptr::null_mut());
    break;
...
//
    ...
    bfa_fcs_lport_ms_send_gmal(ms, core::ptr::null_mut());
    break;
    case MSSM_EVENT_PORT_OFFLINE:
    bfa_sm_set_state(ms, bfa_fcs_lport_ms_sm_offline);
...
//
    ...
    ms.retry_cnt = 0;
    bfa_fcs_lport_ms_send_gfn(ms, core::ptr::null_mut());
    break;
    default:
    bfa_sm_fault(ms.port.fcs, event);
    }
...
//
    ...
    bfa_fcs_lport_ns_send_plogi(ns, core::ptr::null_mut());
    break;
...
//
    ...
    bfa_fcs_lport_ns_send_rnn_id(ns, core::ptr::null_mut());
    break;
    case NSSM_EVENT_PORT_OFFLINE:
    bfa_sm_set_state(ns, bfa_fcs_lport_ns_sm_offline);
...
//
    ...
    bfa_fcs_lport_ns_send_rsnn_nn(ns, core::ptr::null_mut());
    break;
    case NSSM_EVENT_RSP_ERROR:
    ...
    bfa_fcs_lport_ns_send_rspn_id(ns, core::ptr::null_mut());
    }
    break;
    case NSSM_EVENT_PORT_OFFLINE:
    bfa_fcxp_discard(ns.fcxp);
...
//
    ...
    bfa_fcs_lport_ns_send_rft_id(ns, core::ptr::null_mut());
    break;
    case NSSM_EVENT_PORT_OFFLINE:
    bfa_fcxp_discard(ns.fcxp);
    bfa_sm_set_state(ns, bfa_fcs_lport_ns_sm_offline);
...
// Now move to register FC4 Features
    ...
    bfa_fcs_lport_ns_send_rff_id(ns, core::ptr::null_mut());
    break;
    case NSSM_EVENT_RSP_ERROR:
//
// Start timer for a delayed retry
...
//
    ...
    bfa_fcs_lport_ns_send_gid_ft(ns, core::ptr::null_mut());
    }
//
...
//
    ...
    bfa_fcxp_send(fcxp, core::ptr::null_mut(), port.fabric.vf_id, port.lp_tag, BFA_FALSE,
    FC_CLASS_3, len, &fchs, core::ptr::null_mut(), core::ptr::null_mut(), FC_MAX_PDUSZ, 0);
    port.stats.ns_rspnid_sent++;
    }
//
// FCS SCN
//
pub const FC_QOS_RSCN_EVENT: c_uint = 0x0c;
pub const FC_FABRIC_NAME_RSCN_EVENT: c_uint = 0x0d;
//
// forward declarations
//
...
//
    ...
    bfa_fcs_lport_scn_send_scr(scn, core::ptr::null_mut());
    break;
...
//
    ...
    int             num_entries;
    u32        rscn_pid;
    let mut nsquery: bfa_boolean_t = BFA_FALSE, found;
    let mut i: c_int = 0, j;
    num_entries =
...
//
    ...
    if (port == core::ptr::null_mut() || rports == core::ptr::null_mut() || *nrports == 0)
    return;
    fcs = port.fcs;
...
//
    ...
    struct bfa_fcs_rport_s *rport = core::ptr::null_mut();
    struct bfa_fcs_s	*fcs;
    let mut max_speed: bfa_port_speed_t = 0;
...
// Use default ratelim speed setting
    ...
    struct bfa_fcs_vport_s *vport;
    bfa_fcs_vf_t   *vf;
    WARN_ON(fcs == core::ptr::null_mut());
    vf = bfa_fcs_vf_lookup(fcs, vf_id);
    if (vf == core::ptr::null_mut()) {
    bfa_trc(fcs, vf_id);
    return core::ptr::null_mut();
    }
...
pub const BFA_FCS_VPORT_MAX_RETRIES: c_int = 5;
//
// Forward declarations
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bfa_fcs_vport_sm_table_s {
    pub /: *mut *mut bfa_fcs_vport_sm_t sm; / state machine function,
    pub /: *mut *mut enum bfa_vport_state state; / state machine encoding,
...
//
    ...
    {
    let mut lsrjt_rsn: u8 = vport.lps.lsrjt_rsn;
    let mut lsrjt_expl: u8 = vport.lps.lsrjt_expl;
...
//
    ...
    if (bfa_fcs_vport_lookup(fcs, vf_id, vport_cfg.pwwn) != core::ptr::null_mut())
...
//
    ...
    {
    if (vport == core::ptr::null_mut() || attr == core::ptr::null_mut())
    return;
