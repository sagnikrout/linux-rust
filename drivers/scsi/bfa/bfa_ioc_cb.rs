...
//! Source: drivers/scsi/bfa/bfa_ioc_cb.c
#![no_std]
...
//
    ...
    {
    let mut ioc_fwstate: u32 = readl(ioc.ioc_regs.ioc_fwstate);
//
...
//
    ...
    {
    let mut r32: u32 = readl(ioc.ioc_regs.ioc_fwstate);
    let mut join_pos: u32 = bfa_ioc_cb_join_pos(ioc);
    ...
    enum bfi_ioc_state fwstate)
    {
    let mut r32: u32 = readl(ioc.ioc_regs.alt_ioc_fwstate);
    writel((fwstate | (r32 & BFA_IOC_CB_JOIN_MASK)),
