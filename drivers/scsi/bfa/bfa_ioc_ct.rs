...
//! Source: drivers/scsi/bfa/bfa_ioc_ct.c
#![no_std]
...
pub const BFA_IOC_SYNC_REQD_SH: c_int = 16;
...
//
    ...
    {
    void __iomem *rb;
    let mut pcifn: c_int = bfa_ioc_pcifn(ioc);
    rb = bfa_ioc_bar0(ioc);
...
//
    ...
    {
    void __iomem *rb;
    let mut port: c_int = bfa_ioc_portid(ioc);
    rb = bfa_ioc_bar0(ioc);
...
//
    ...
    {
    let mut r32: u32 = readl(ioc.ioc_regs.ioc_fail_sync);
    let mut sync_reqd: u32 = bfa_ioc_ct_get_sync_reqd(r32);
//
...
//
    ...
    {
    let mut r32: u32 = readl(ioc.ioc_regs.ioc_fail_sync);
    let mut sync_pos: u32 = bfa_ioc_ct_sync_reqd_pos(ioc);
    ...
    let mut r32: u32 = readl(ioc.ioc_regs.ioc_fail_sync);
    let mut sync_reqd: u32 = bfa_ioc_ct_get_sync_reqd(r32);
    let mut sync_ackd: u32 = bfa_ioc_ct_get_sync_ackd(r32);
    uint32_t tmp_ackd;
    if (sync_ackd == 0)
    return BFA_TRUE;
//
...
//
    ...
    hwif_ct2.ioc_isr_mode_set = core::ptr::null_mut();
    ioc.ioc_hwif = &hwif_ct2;
    }
//
// Workaround for MSI-X resource allocation for catapult-2 with no asic block
//
pub const HOSTFN_MSIX_DEFAULT: c_int = 64;
pub const HOSTFN_MSIX_VT_INDEX_MBOX_ERR: c_uint = 0x30138;
pub const HOSTFN_MSIX_VT_OFST_NUMVT: c_uint = 0x3013c;
pub const __MSIX_VT_NUMVT__MK: c_uint = 0x003ff800;
pub const __MSIX_VT_NUMVT__SH: c_int = 11;

pub const __MSIX_VT_OFST_: c_uint = 0x000007ff;
    void
    ...
    let mut fcmode: bfa_boolean_t = (mode == BFI_ASIC_MODE_FC);
...
pub const CT2_NFC_MAX_DELAY: c_int = 1000;
pub const CT2_NFC_PAUSE_MAX_DELAY: c_int = 4000;
pub const CT2_NFC_VER_VALID: c_uint = 0x147;
pub const CT2_NFC_STATE_RUNNING: c_uint = 0x20000001;
pub const BFA_IOC_PLL_POLL: c_int = 1000000;
    static bfa_boolean_t
