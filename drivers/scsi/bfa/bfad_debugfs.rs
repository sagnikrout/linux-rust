...
//! Source: drivers/scsi/bfa/bfad_debugfs.c
#![no_std]
...
// CB register space 64KB
    ...
    kfree(bfad.regdata);
    bfad.regdata = core::ptr::null_mut();
    bfad.reglen = 0;
    }
    return rc;
    }
...
// Setup the BFA debugfs root directory
    if (!bfa_debugfs_root) {
    bfa_debugfs_root = debugfs_create_dir("bfa", core::ptr::null_mut());
...
// Setup the pci_dev debugfs directory for the port
    ...
    bfad.bfad_dentry_files[i] = core::ptr::null_mut();
    }
    }
// Remove the pci_dev debugfs directory for the port
    if (port.port_debugfs_root) {
    debugfs_remove(port.port_debugfs_root);
    port.port_debugfs_root = core::ptr::null_mut();
...
// Remove the BFA debugfs root directory
    ...
    bfa_debugfs_root = core::ptr::null_mut();
    }
    }
