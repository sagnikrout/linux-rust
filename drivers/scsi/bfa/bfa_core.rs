...
//! Source: drivers/scsi/bfa/bfa_core.c
#![no_std]
...
//
    ...
    core::ptr::null_mut(),
    core::ptr::null_mut(),		/* BFI_MC_IOC   */
    core::ptr::null_mut(),		/* BFI_MC_DIAG  */
    core::ptr::null_mut(),		/* BFI_MC_FLASH */
    core::ptr::null_mut(),		/* BFI_MC_CEE   */
    core::ptr::null_mut(),		/* BFI_MC_PORT  */
...
pub const DEF_CFG_NUM_FABRICS: c_int = 1;
pub const DEF_CFG_NUM_LPORTS: c_int = 256;
pub const DEF_CFG_NUM_CQS: c_int = 4;

pub const DEF_CFG_NUM_TSKIM_REQS: c_int = 128;
pub const DEF_CFG_NUM_FCXP_REQS: c_int = 64;
pub const DEF_CFG_NUM_UF_BUFS: c_int = 64;
pub const DEF_CFG_NUM_RPORTS: c_int = 1024;

pub const DEF_CFG_NUM_TINS: c_int = 256;
pub const DEF_CFG_NUM_SGPGS: c_int = 2048;
pub const DEF_CFG_NUM_REQQ_ELEMS: c_int = 256;
pub const DEF_CFG_NUM_RSPQ_ELEMS: c_int = 64;
pub const DEF_CFG_NUM_SBOOT_TGTS: c_int = 16;
pub const DEF_CFG_NUM_SBOOT_LUNS: c_int = 16;
//
...
//
    ...
    u32 intr, qintr;
    int queue;
    let mut rspq_comp: bfa_boolean_t = BFA_FALSE;
    intr = readl(bfa.iocfc.bfa_regs.intr_status);
...
//
    ...
    {
    u32 umsk;
    let mut port_id: c_int = bfa_ioc_portid(&bfa.ioc);
...
//
    ...
    iocfc.hwif.hw_reqq_ack = core::ptr::null_mut();
    ...
    iocfc.hwif.hw_isr_mode_set = core::ptr::null_mut();
...
//
    ...
    {
    let mut ioc_type: enum bfa_ioc_type_e = bfa_get_type(bfa);
    let mut card_type: u32 = bfa.ioc.attr.card_type;
...
//
    ...
    struct bfa_mem_dma_s *phy_dma = BFA_MEM_PHY_DMA(bfa);
    struct bfa_mem_dma_s *fru_dma = BFA_MEM_FRU_DMA(bfa);
    WARN_ON((cfg == core::ptr::null_mut()) || (meminfo == core::ptr::null_mut()));
