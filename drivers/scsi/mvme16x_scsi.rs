...
//! Source: drivers/scsi/mvme16x_scsi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mvme16x_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mvme16x_device_remove(dev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mvme16x_scsi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mvme16x_scsi_exit() -> void __exit {
