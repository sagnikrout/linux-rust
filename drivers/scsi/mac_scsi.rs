...
//! Source: drivers/scsi/mac_scsi.c
#![no_std]
...
// Definitions for the core NCR5380 driver.
    ...
    let mut setup_use_pdma: static int = 512;
...
#[no_mangle]
unsafe extern "C" fn mac_scsi_setup(str: *mut c_char) -> int __init {
...
//
    ...
    : "+a" (addr), "+r" (n), "+r" (result) : "a" (io))
#[no_mangle]
pub unsafe extern "C" fn mac_pdma_recv(io: *mut void __iomem, start: *mut c_uchar, n: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mac_pdma_send(start: *mut c_uchar, io: *mut void __iomem, n: c_int) -> c_int {
...
pub const CTRL_REG: c_uint = 0x8;

#[no_mangle]
pub unsafe extern "C" fn write_ctrl_reg(hostdata: *mut NCR5380_hostdata, value: u32) {
    static inline void write_ctrl_reg(struct NCR5380_hostdata *hostdata, u32 value)
    {
    out_be32(hostdata.io + (CTRL_REG << 4), value);
    }
#[no_mangle]
pub unsafe extern "C" fn macscsi_wait_for_drq(hostdata: *mut NCR5380_hostdata) -> c_int {
    ...
    {
    let mut resid: c_int = NCR5380_to_ncmd(cmd).this_residual;
    if (hostdata.flags & FLAG_NO_PSEUDO_DMA || resid < setup_use_pdma)
    return 0;
    return resid;
    }
#[no_mangle]
unsafe extern "C" fn macscsi_dma_residual(hostdata: *mut NCR5380_hostdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mac_scsi_probe(pdev: *mut platform_device) -> int __init {
    ...
    struct resource *irq, *pio_mem, *pdma_mem = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mac_scsi_remove(pdev: *mut platform_device) -> void __exit {
