...
//! Source: drivers/scsi/constants.c
#![no_std]
...
pub const THIRD_PARTY_COPY_OUT: c_uint = 0x83;
pub const THIRD_PARTY_COPY_IN: c_uint = 0x84;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sa_name_list {
    pub opcode: c_int,
    pub arr: *const value_name_pair,
    pub arr_sz: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct value_name_pair {
    pub value: c_int,
...
// 23-28 */ "Read Format Capacities", "Set Window",
    "Read Capacity(10)", core::ptr::null_mut(), core::ptr::null_mut(), "Read(10)",
...
// 90-94 */ "Pre-fetch(16)", "Synchronize cache(16)",
    "Lock/unlock cache(16)", "Write same(16)", core::ptr::null_mut(),
...
// SPC-4 rev 34 renamed the Extended Copy opcode to Third Party Copy Out.
    ...
    const struct value_name_pair *arr = core::ptr::null_mut();
    int arr_sz, k;
// cdb_name = NULL;
...
pub struct error_info {
    pub /: *mut *mut unsigned short code12; / 0x0302 looks better than 0x03,0x02,
    pub size: c_ushort,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct error_info2 {
    pub code2_max: unsigned char code1, code2_min,,
    pub str: *const *const c_char,
    pub fmt: *const *const c_char,
}
    ...
    {0, 0, 0, core::ptr::null_mut(), core::ptr::null_mut()}
    };
...
//
    ...
    {
    int i;
    let mut code: c_ushort = ((asc << 8) | ascq);
...
// fmt = additional2[i].fmt;
    ...
    {
    let mut hb: enum scsi_host_status = host_byte(result);
    const char *hb_string = core::ptr::null_mut();
