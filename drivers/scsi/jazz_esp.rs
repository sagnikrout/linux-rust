...
//! Source: drivers/scsi/jazz_esp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn jazz_esp_reset_dma(esp: *mut esp) {
    static void jazz_esp_reset_dma(struct esp *esp)
    {
    vdma_disable ((int)esp.dma_regs);
    }
#[no_mangle]
unsafe extern "C" fn jazz_esp_dma_drain(esp: *mut esp) {
    static void jazz_esp_dma_drain(struct esp *esp)
    {
// nothing to do
    }
#[no_mangle]
unsafe extern "C" fn jazz_esp_dma_invalidate(esp: *mut esp) {
...
#[no_mangle]
unsafe extern "C" fn jazz_esp_dma_error(esp: *mut esp) -> c_int {
    static int jazz_esp_dma_error(struct esp *esp)
    {
    let mut enable: u32 = vdma_get_enable((int)esp.dma_regs);
...
#[no_mangle]
unsafe extern "C" fn esp_jazz_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp_jazz_remove(dev: *mut platform_device) {
