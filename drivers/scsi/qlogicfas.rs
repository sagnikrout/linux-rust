...
//! Source: drivers/scsi/qlogicfas.c
#![no_std]
...
//
    ...
    goto free_scsi_host;
    if (scsi_add_host(hreg, core::ptr::null_mut()))
    goto free_interrupt;
    scsi_scan_host(hreg);
    return hreg;
    free_interrupt:
...
#[no_mangle]
unsafe extern "C" fn qlogicfas_release(shost: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qlogicfas_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn qlogicfas_exit() -> __exit void {
    static __exit void qlogicfas_exit(void)
    {
    struct qlogicfas408_priv *priv;
    for (priv = cards; priv != core::ptr::null_mut(); priv = priv.next)
