...
//! Source: drivers/scsi/pcmcia/nsp_debug.c
#![no_std]
...
pub const RESERVED_GROUP: c_int = 0;
pub const VENDOR_GROUP: c_int = 1;
pub const NOTEXT_GROUP: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn print_opcodek(opcode: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn print_commandk(command: *mut c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn show_command(SCpnt: *mut scsi_cmnd) {
    static void show_command(struct scsi_cmnd *SCpnt)
    {
    print_commandk(SCpnt.cmnd);
    }
#[no_mangle]
unsafe extern "C" fn show_phase(SCpnt: *mut scsi_cmnd) {
    static void show_phase(struct scsi_cmnd *SCpnt)
    {
    let mut i: c_int = nsp_scsi_pointer(SCpnt).phase;
    char *ph[] = {
    "PH_UNDETERMINED",
    "PH_ARBSTART",
    "PH_SELSTART",
...
#[no_mangle]
unsafe extern "C" fn show_busphase(stat: c_uchar) {
...
#[no_mangle]
unsafe extern "C" fn show_message(data: *mut nsp_hw_data) {
