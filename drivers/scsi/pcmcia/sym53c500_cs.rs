...
//! Source: drivers/scsi/pcmcia/sym53c500_cs.c
#![no_std]
...
//
pub const SYM53C500_DEBUG: c_int = 0;
pub const VERBOSE_SYM53C500_DEBUG: c_int = 0;
//
// Set this to 0 if you encounter kernel lockups while transferring
// data in PIO mode.  Note this can be changed via "sysfs".
//
pub const USE_FAST_PIO: c_int = 1;
// =============== End of user configurable parameters ==============

// ==================================================================

// Default configuration
pub const C1_IMG: c_uint = 0x07		/* ID=7 */;
pub const C2_IMG: c_uint = 0x48		/* FE SCSI2 */;
pub const C3_IMG: c_uint = 0x20		/* CDB */;
pub const C4_IMG: c_uint = 0x04		/* ANE */;
pub const C5_IMG: c_uint = 0xa4		/* ? changed from b6= AA PI SIE POL */;
pub const C7_IMG: c_uint = 0x80		/* added for SYM53C500 t. corner */;
// Hardware Registers: offsets from io_port (base)
// Control Register Set 0
pub const TC_LSB: c_uint = 0x00		/* transfer counter lsb */;
pub const TC_MSB: c_uint = 0x01		/* transfer counter msb */;
pub const SCSI_FIFO: c_uint = 0x02		/* scsi fifo register */;
pub const CMD_REG: c_uint = 0x03		/* command register */;
pub const STAT_REG: c_uint = 0x04		/* status register */;
pub const DEST_ID: c_uint = 0x04		/* selection/reselection bus id */;
pub const INT_REG: c_uint = 0x05		/* interrupt status register */;
pub const SRTIMOUT: c_uint = 0x05		/* select/reselect timeout reg */;
pub const SEQ_REG: c_uint = 0x06		/* sequence step register */;
pub const SYNCPRD: c_uint = 0x06		/* synchronous transfer period */;
pub const FIFO_FLAGS: c_uint = 0x07		/* indicates # of bytes in fifo */;
pub const SYNCOFF: c_uint = 0x07		/* synchronous offset register */;
pub const CONFIG1: c_uint = 0x08		/* configuration register */;
pub const CLKCONV: c_uint = 0x09		/* clock conversion register */;
// #define TESTREG	0x0A */		/* test mode register
pub const CONFIG2: c_uint = 0x0B		/* configuration 2 register */;
pub const CONFIG3: c_uint = 0x0C		/* configuration 3 register */;
pub const CONFIG4: c_uint = 0x0D		/* configuration 4 register */;
pub const TC_HIGH: c_uint = 0x0E		/* transfer counter high */;
...
pub const PIO_FIFO: c_uint = 0x04		/* PIO FIFO registers (r/w) */;
// #define PIO_FIFO1	0x05 */		/*
// #define PIO_FIFO2	0x06 */		/*
// #define PIO_FIFO3	0x07 */		/*
pub const PIO_STATUS: c_uint = 0x08		/* PIO status (r/w) */;
// #define ATA_CMD	0x09 */		/* ATA command/status reg (r/w)
// #define ATA_ERR	0x0A */		/* ATA features/error reg (r/w)
pub const PIO_FLAG: c_uint = 0x0B		/* PIO flag interrupt enable (r/w) */;
pub const CONFIG5: c_uint = 0x09		/* configuration 5 register */;
// #define SIGNATURE	0x0E */		/* signature register (r)
// #define CONFIG6	0x0F */		/* configuration 6 register (r)
pub const CONFIG7: c_uint = 0x0d;
// select register set 0

// select register set 1

// Macro flag: #define DEB(x)

// Macro flag: #define VDEB(x)

    outb(count & 0xff, (x) + TC_LSB); \
    outb((count >> 8) & 0xff, (x) + TC_MSB); \
    outb((count >> 16) & 0xff, (x) + TC_HIGH);
// Chip commands
pub const DMA_OP: c_uint = 0x80;
pub const SCSI_NOP: c_uint = 0x00;
pub const FLUSH_FIFO: c_uint = 0x01;
pub const CHIP_RESET: c_uint = 0x02;
pub const SCSI_RESET: c_uint = 0x03;
pub const RESELECT: c_uint = 0x40;
pub const SELECT_NO_ATN: c_uint = 0x41;
pub const SELECT_ATN: c_uint = 0x42;
pub const SELECT_ATN_STOP: c_uint = 0x43;
pub const ENABLE_SEL: c_uint = 0x44;
pub const DISABLE_SEL: c_uint = 0x45;
pub const SELECT_ATN3: c_uint = 0x46;
pub const RESELECT3: c_uint = 0x47;
pub const TRANSFER_INFO: c_uint = 0x10;
pub const INIT_CMD_COMPLETE: c_uint = 0x11;
pub const MSG_ACCEPT: c_uint = 0x12;
pub const TRANSFER_PAD: c_uint = 0x18;
pub const SET_ATN: c_uint = 0x1a;
pub const RESET_ATN: c_uint = 0x1b;
pub const SEND_MSG: c_uint = 0x20;
pub const SEND_STATUS: c_uint = 0x21;
pub const SEND_DATA: c_uint = 0x22;
pub const DISCONN_SEQ: c_uint = 0x23;
pub const TERMINATE_SEQ: c_uint = 0x24;
pub const TARG_CMD_COMPLETE: c_uint = 0x25;
pub const DISCONN: c_uint = 0x27;
pub const RECV_MSG: c_uint = 0x28;
pub const RECV_CMD: c_uint = 0x29;
pub const RECV_DATA: c_uint = 0x2a;
pub const RECV_CMD_SEQ: c_uint = 0x2b;
pub const TARGET_ABORT_DMA: c_uint = 0x04;
// ==================================================================
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scsi_info_t {
    pub p_dev: *mut pcmcia_device,
    pub host: *mut Scsi_Host,
    pub manf_id: c_ushort,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sym53c500_data {
    pub current_SC: *mut scsi_cmnd,
    pub fast_pio: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sym53c500_cmd_priv {
    pub status: c_int,
    pub message: c_int,
    pub phase: c_int,
}
...
// VDEB(printk("pio_status=%x\n", i));
    ...
    let mut port_base: c_int = dev.io_port;
    struct sym53c500_data *data =
    (struct sym53c500_data *)dev.hostdata;
    struct scsi_cmnd *curSC = data.current_SC;
    struct sym53c500_cmd_priv *scp = scsi_cmd_priv(curSC);
    let mut fast_pio: c_int = data.fast_pio;
...
#[no_mangle]
unsafe extern "C" fn SYM53C500_queue_lck(SCpnt: *mut scsi_cmnd) -> enum scsi_qc_status {
    static enum scsi_qc_status SYM53C500_queue_lck(struct scsi_cmnd *SCpnt)
    {
    struct sym53c500_cmd_priv *scp = scsi_cmd_priv(SCpnt);
    int i;
    let mut port_base: c_int = SCpnt.device.host.io_port;
    struct sym53c500_data *data =
...
#[no_mangle]
pub unsafe extern "C" fn DEF_SCSI_QCMD(_arg: SYM53C500_queue) -> static {
    ...
    struct sym53c500_data *data =
    (struct sym53c500_data *)SHp.hostdata;
    pio = simple_strtoul(buf, core::ptr::null_mut(), 0);
    if (pio == 0 || pio == 1) {
    data.fast_pio = pio;
    return count;
    }
...
#[no_mangle]
unsafe extern "C" fn SYM53C500_config_check(p_dev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
    ...
    ret = pcmcia_loop_config(link, SYM53C500_config_check, core::ptr::null_mut());
    if (ret)
    goto failed;
    if (!link.irq)
    goto failed;
...
//
    ...
    info.host = host;
    if (scsi_add_host(host, core::ptr::null_mut()))
    goto err_free_irq;
    scsi_scan_host(host);
    return 0;
    err_free_irq:
...
#[no_mangle]
unsafe extern "C" fn sym53c500_resume(link: *mut pcmcia_device) -> c_int {
