...
//! Source: drivers/scsi/scsi_scan.c
#![no_std]
...
// given LUN.
//
pub const SCSI_SCAN_NO_RESPONSE: c_int = 0;
pub const SCSI_SCAN_TARGET_PRESENT: c_int = 1;
pub const SCSI_SCAN_LUN_PRESENT: c_int = 2;
    static const char *scsi_null_device_strs = "nullnullnullnull";
pub const MAX_SCSI_LUNS: c_int = 512;
    let mut max_scsi_luns: static u64 = MAX_SCSI_LUNS;
    ...
    let mut scsi_inq_timeout: static unsigned int = SCSI_TIMEOUT/HZ + 18;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct async_scan_data {
    pub list: list_head,
    pub shost: *mut Scsi_Host,
    pub prev_finished: completion,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_enable_async_suspend(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_complete_async_scans() -> c_int {
...
//
    ...
    SCSI_TIMEOUT, 3, core::ptr::null_mut());
    }
    static int scsi_realloc_sdev_budget_map(struct scsi_device *sdev,
    unsigned int depth)
    {
    let mut new_shift: c_int = sbitmap_calculate_shift(depth);
    let mut need_alloc: bool = !sdev.budget_map.map;
    let mut need_free: bool = false;
...
//
    ...
    let mut display_failure_msg: c_int = 1, ret;
...
#[no_mangle]
unsafe extern "C" fn scsi_target_destroy(starget: *mut scsi_target) {
...
#[no_mangle]
unsafe extern "C" fn scsi_target_dev_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_is_target_device(dev: *const device) -> c_int {
    ...
    int channel, uint id)
    {
    struct scsi_target *starget, *found_starget = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn scsi_target_reap_ref_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn scsi_target_reap_ref_put(starget: *mut scsi_target) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_target_reap(starget: *mut scsi_target) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_sanitize_inquiry_string(s: *mut c_uchar, len: c_int) {
    void scsi_sanitize_inquiry_string(unsigned char *s, int len)
    {
    let mut terminated: c_int = 0;
    for (; len > 0; (--len, ++s)) {
    if (*s == 0)
    terminated = 1;
...
//
    ...
    GFP_KERNEL);
    if (sdev.inquiry == core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn if(BLIST_SKIP_VPD_PAGES: *mut *mut bflags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(BLIST_MAX_1024: *mut *mut bflags &) -> else {
...
//
    ...
    let mut res: c_int = SCSI_SCAN_NO_RESPONSE, result_len = 256;
//
...
//
    ...
    if (scsi_probe_and_add_lun(shost, starget, lun, core::ptr::null_mut(), core::ptr::null_mut(),
    rescan, core::ptr::null_mut()) != SCSI_SCAN_LUN_PRESENT &&
    !sparse_lun)
    return;
    }
//
...
//
    ...
    sdev = scsi_alloc_sdev(starget, 0, core::ptr::null_mut());
    if (!sdev)
    return 0;
...
//
    ...
    lun, core::ptr::null_mut(), core::ptr::null_mut(), rescan, core::ptr::null_mut());
...
//
    ...
    scsi_probe_and_add_lun(shost, starget, lun, core::ptr::null_mut(), &sdev,
...
//
    ...
    {
    struct scsi_device *sdev =
    __scsi_add_device(host, channel, target, lun, core::ptr::null_mut());
    if (IS_ERR(sdev))
    return PTR_ERR(sdev);
    scsi_device_put(sdev);
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn scsi_resume_device(sdev: *mut scsi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_rescan_device(sdev: *mut scsi_device) -> c_int {
...
//
    ...
    __must_hold(&shost.scan_mutex)
    {
    let mut bflags: blist_flags_t = 0;
    int res;
    struct scsi_target *starget;
    if (shost.this_id == id)
//
...
//
    scsi_probe_and_add_lun(shost, starget, lun, core::ptr::null_mut(), core::ptr::null_mut(), rescan,
    core::ptr::null_mut());
    goto out_reap;
    }
//
...
//
    res = scsi_probe_and_add_lun(shost, starget, 0, &bflags, core::ptr::null_mut(), rescan,
    core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn scsi_sysfs_add_devices(shost: *mut Scsi_Host) {
...
//
    ...
    {
    struct async_scan_data *data = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn scsi_finish_async_scan(data: *mut async_scan_data) {
...
#[no_mangle]
unsafe extern "C" fn do_scsi_scan_host(shost: *mut Scsi_Host) {
...
#[no_mangle]
unsafe extern "C" fn do_scan_async(_data: *mut c_void, c: async_cookie_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_scan_host(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_forget_host(shost: *mut Scsi_Host) {
...
//
    ...
    if (!starget)
    goto out;
    sdev = scsi_alloc_sdev(starget, U64_MAX, core::ptr::null_mut());
    if (!sdev) {
    scsi_target_reap(starget);
    goto put_target;
    }
