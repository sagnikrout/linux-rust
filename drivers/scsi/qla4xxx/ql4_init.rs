...
//! Source: drivers/scsi/qla4xxx/ql4_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ql4xxx_set_mac_number(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
unsafe extern "C" fn qla4xxx_init_response_q_entries(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_init_rings(ha: *mut scsi_qla_host) -> c_int {
...
// Initialize mailbox active array
    for (i = 0; i < MAX_MRB; i++)
    ha.active_mrb_array[i] = core::ptr::null_mut();
    spin_unlock_irqrestore(&ha.hardware_lock, flags);
    return QLA_SUCCESS;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_get_sys_info(ha: *mut scsi_qla_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qla4xxx_init_local_data(ha: *mut scsi_qla_host) {
...
// Initialize aen queue
    ...
    {
    let mut ipv4_wait: u8 = 0;
    let mut ipv6_wait: u8 = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_alloc_fw_dump(ha: *mut scsi_qla_host) {
...
#[no_mangle]
unsafe extern "C" fn qla4xxx_fw_ready(ha: *mut scsi_qla_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qla4xxx_init_firmware(ha: *mut scsi_qla_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qla4xxx_set_model_info(ha: *mut scsi_qla_host) {
    static void qla4xxx_set_model_info(struct scsi_qla_host *ha)
    {
    uint16_t board_id_string[8];
    int i;
    let mut size: c_int = sizeof(ha.nvram.isp4022.boardIdStr);
    let mut offset: c_int = offsetof(struct eeprom_data, isp4022.boardIdStr) / 2;
    for (i = 0; i < (size / 2) ; i++) {
...
#[no_mangle]
unsafe extern "C" fn qla4xxx_config_nvram(ha: *mut scsi_qla_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(is_qla4032(ha): is_qla4022(ha) |) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4_8xxx_pci_config(ha: *mut scsi_qla_host) {
    void qla4_8xxx_pci_config(struct scsi_qla_host *ha)
    {
    pci_set_master(ha.pdev);
    }
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_pci_config(ha: *mut scsi_qla_host) {
...
#[no_mangle]
unsafe extern "C" fn qla4xxx_start_firmware_from_flash(ha: *mut scsi_qla_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ql4xxx_lock_drvr_wait(a: *mut scsi_qla_host) -> c_int {
    int ql4xxx_lock_drvr_wait(struct scsi_qla_host *a)
    {
pub const QL4_LOCK_DRVR_WAIT: c_int = 60;
pub const QL4_LOCK_DRVR_SLEEP: c_int = 1;
    let mut drvr_wait: c_int = QL4_LOCK_DRVR_WAIT;
    while (drvr_wait) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_start_firmware(ha: *mut scsi_qla_host) -> c_int {
    int qla4xxx_start_firmware(struct scsi_qla_host *ha)
    {
    let mut flags: c_ulong = 0;
    uint32_t mbox_status;
    let mut status: c_int = QLA_ERROR;
    let mut soft_reset: c_int = 1;
    let mut config_chip: c_int = 0;
    if (is_qla4022(ha) | is_qla4032(ha))
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_free_ddb_index(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_initialize_adapter(ha: *mut scsi_qla_host, is_reset: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_arm_relogin_timer(ddb_entry: *mut ddb_entry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_login_flash_ddb(cls_session: *mut iscsi_cls_session) {
