...
//! Source: drivers/scsi/qla4xxx/ql4_isr.c
#![no_std]
...
//
    ...
    ha.status_srb = core::ptr::null_mut();
    return;
    }
...
//
    ...
    srb, srb.state));
    ql4_printk(KERN_WARNING, ha, "Command is core::ptr::null_mut():"
...
// complete the request, if not waiting for status_continuation pkt
    ...
    if (ha.status_srb == core::ptr::null_mut())
    kref_put(&srb.srb_ref, qla4xxx_srb_compl);
    }
//
...
//
    ...
    ql4_printk(KERN_ERR, ha, "%s: Task is core::ptr::null_mut()\n", __func__);
    return;
    }
    ...
    uint32_t index)
    {
    struct mrb *mrb = core::ptr::null_mut();
// validate handle and remove from active array
    if (index >= MAX_MRB)
    return mrb;
    mrb = ha.active_mrb_array[index];
    ha.active_mrb_array[index] = core::ptr::null_mut();
    if (!mrb)
    return mrb;
// update counters
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_process_response_queue(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
unsafe extern "C" fn qla4_83xx_loopback_in_progress(ha: *mut scsi_qla_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_qla8022(ha)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_intr_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    irqreturn_t qla4xxx_intr_handler(int irq, void *dev_id)
    {
    struct scsi_qla_host *ha;
    uint32_t intr_status;
    let mut flags: c_ulong = 0;
    let mut reqs_count: u8 = 0;
    ha = (struct scsi_qla_host *) dev_id;
    if (!ha) {
    DEBUG2(printk(KERN_INFO
    "qla4xxx: Interrupt with core::ptr::null_mut() host ptr\n"));
    return IRQ_NONE;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4_82xx_intr_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4_83xx_intr_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    irqreturn_t qla4_83xx_intr_handler(int irq, void *dev_id)
    {
    struct scsi_qla_host *ha = dev_id;
    let mut leg_int_ptr: u32 = 0;
    let mut flags: c_ulong = 0;
    ha.isr_count++;
...
//
    ...
    if (!ha) {
    DEBUG2(printk(KERN_INFO
    "qla4xxx: MSIX: Interrupt with core::ptr::null_mut() host ptr\n"));
    return IRQ_NONE;
    }
    ha.isr_count++;
// clear the interrupt
...
#[no_mangle]
unsafe extern "C" fn qla4_83xx_mailbox_intr_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_process_aen(ha: *mut *mut scsi_qla_host, process_aen: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_request_irqs(ha: *mut scsi_qla_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_free_irqs(ha: *mut scsi_qla_host) {
