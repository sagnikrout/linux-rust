...
//! Source: drivers/scsi/qla4xxx/ql4_mbx.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_process_mbox_intr(ha: *mut scsi_qla_host, out_count: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn qla4xxx_is_intr_poll_mode(ha: *mut scsi_qla_host) -> c_int {
    static int qla4xxx_is_intr_poll_mode(struct scsi_qla_host *ha)
    {
    let mut rval: c_int = 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_req_template_size(ha: *mut scsi_qla_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_mailbox_premature_completion(ha: *mut scsi_qla_host) {
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_set_ipaddr_state(fw_ipaddr_state: u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_initialize_fw_cb(ha: *mut *mut scsi_qla_host) -> c_int {
    ...
    if (init_fw_cb == core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_get_dhcp_ip_address(ha: *mut *mut scsi_qla_host) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_get_firmware_state(ha: *mut *mut scsi_qla_host) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_get_firmware_status(ha: *mut *mut scsi_qla_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_conn_open(ha: *mut scsi_qla_host, fw_ddb_index: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_get_crash_record(ha: *mut *mut scsi_qla_host) {
    void qla4xxx_get_crash_record(struct scsi_qla_host * ha)
    {
    uint32_t mbox_cmd[MBOX_REG_COUNT];
    uint32_t mbox_sts[MBOX_REG_COUNT];
    struct crash_record *crash_record = core::ptr::null_mut();
    let mut crash_record_dma: dma_addr_t = 0;
    let mut crash_record_size: u32 = 0;
    memset(&mbox_cmd, 0, sizeof(mbox_cmd));
    memset(&mbox_sts, 0, sizeof(mbox_sts));
...
// Alloc Memory for Crash Record.
    ...
    if (crash_record == core::ptr::null_mut())
    goto exit_get_crash_record;
// Get Crash Record.
    memset(&mbox_cmd, 0, sizeof(mbox_cmd));
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_get_conn_event_log(ha: *mut *mut scsi_qla_host) {
    void qla4xxx_get_conn_event_log(struct scsi_qla_host * ha)
    {
    uint32_t mbox_cmd[MBOX_REG_COUNT];
    uint32_t mbox_sts[MBOX_REG_COUNT];
    struct conn_event_log_entry *event_log = core::ptr::null_mut();
    let mut event_log_dma: dma_addr_t = 0;
    let mut event_log_size: u32 = 0;
    uint32_t num_valid_entries;
    let mut oldest_entry: u32 = 0;
...
// Alloc Memory for Crash Record.
    ...
    if (event_log == core::ptr::null_mut())
    goto exit_get_event_log;
// Get Crash Record.
    memset(&mbox_cmd, 0, sizeof(mbox_cmd));
    memset(&mbox_sts, 0, sizeof(mbox_sts));
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_abort_task(ha: *mut scsi_qla_host, srb: *mut srb) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_about_firmware(ha: *mut scsi_qla_host) -> c_int {
    int qla4xxx_about_firmware(struct scsi_qla_host *ha)
    {
    struct about_fw_info *about_fw = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_clear_ddb_entry(ha: *mut scsi_qla_host, ddb_index: u32) -> c_int {
...
//
    ...
    let mut offset: u32 = 0, chap_size;
...
// Update ha chap_list cache
    ...
    {
    let mut rval: c_int = QLA_ERROR;
    struct ql4_chap_table *chap_table = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn qla4_84xx_extend_idc_tmo(ha: *mut scsi_qla_host, ext_tmo: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_disable_acb(ha: *mut scsi_qla_host) -> c_int {
...
// CHAP
    if (sess.username != core::ptr::null_mut() && sess.password != core::ptr::null_mut()) {
    ...
    if (sess.username_in != core::ptr::null_mut() && sess.password_in != core::ptr::null_mut()) {
// Check if BIDI CHAP
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4_8xxx_set_param(ha: *mut scsi_qla_host, param: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4_83xx_post_idc_ack(ha: *mut scsi_qla_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla4_84xx_config_acb(ha: *mut scsi_qla_host, acb_config: c_int) -> c_int {
    int qla4_84xx_config_acb(struct scsi_qla_host *ha, int acb_config)
    {
    uint32_t mbox_cmd[MBOX_REG_COUNT];
    uint32_t mbox_sts[MBOX_REG_COUNT];
    struct addr_ctrl_blk *acb = core::ptr::null_mut();
    let mut acb_len: u32 = sizeof(struct addr_ctrl_blk);
    ...
    kfree(ha.saved_acb);
    ha.saved_acb = core::ptr::null_mut();
    }
    DEBUG2(ql4_printk(KERN_INFO, ha,
    "%s %s\n", __func__,
...
#[no_mangle]
pub unsafe extern "C" fn qla4_83xx_get_port_config(ha: *mut scsi_qla_host, config: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla4_83xx_set_port_config(ha: *mut scsi_qla_host, config: *mut u32) -> c_int {
