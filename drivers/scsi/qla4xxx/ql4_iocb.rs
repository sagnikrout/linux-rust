...
//! Source: drivers/scsi/qla4xxx/ql4_iocb.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qla4xxx_advance_req_ring_ptr(ha: *mut scsi_qla_host) {
...
#[no_mangle]
unsafe extern "C" fn qla4xxx_calc_request_entries(dsds: u16) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn qla4_83xx_queue_iocb(ha: *mut scsi_qla_host) {
...
#[no_mangle]
pub unsafe extern "C" fn qla4_83xx_complete_iocb(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4_82xx_queue_iocb(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4_82xx_complete_iocb(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_queue_iocb(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_complete_iocb(ha: *mut scsi_qla_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_send_command_to_isp(ha: *mut scsi_qla_host, srb: *mut *mut srb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla4xxx_send_passthru0(task: *mut iscsi_task) -> c_int {
...
// get valid mrb index
    ...
    if (index == MAX_MRB)
    index = 1;
    if (ha.active_mrb_array[index] == core::ptr::null_mut()) {
    ha.mrb_index = index;
    break;
    }
    }
