...
//! Source: drivers/scsi/qla4xxx/ql4_attr.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn qla4_8xxx_alloc_sysfs_attr(ha: *mut scsi_qla_host) {
...
#[no_mangle]
pub unsafe extern "C" fn qla4_8xxx_free_sysfs_attr(ha: *mut scsi_qla_host) {
...
// Scsi_Host attributes.
    ...
    {
    struct scsi_qla_host *ha = to_qla_host(class_to_shost(dev));
    char *load_src = core::ptr::null_mut();
    ...
    static DEVICE_ATTR(fw_version, S_IRUGO, qla4xxx_fw_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(serial_num, S_IRUGO, qla4xxx_serial_num_show, core::ptr::null_mut());
    static DEVICE_ATTR(iscsi_version, S_IRUGO, qla4xxx_iscsi_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(optrom_version, S_IRUGO, qla4xxx_optrom_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(board_id, S_IRUGO, qla4xxx_board_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(fw_state, S_IRUGO, qla4xxx_fw_state_show, core::ptr::null_mut());
    static DEVICE_ATTR(phy_port_cnt, S_IRUGO, qla4xxx_phy_port_cnt_show, core::ptr::null_mut());
    static DEVICE_ATTR(phy_port_num, S_IRUGO, qla4xxx_phy_port_num_show, core::ptr::null_mut());
    static DEVICE_ATTR(iscsi_func_cnt, S_IRUGO, qla4xxx_iscsi_func_cnt_show, core::ptr::null_mut());
    static DEVICE_ATTR(hba_model, S_IRUGO, qla4xxx_hba_model_show, core::ptr::null_mut());
    static DEVICE_ATTR(fw_timestamp, S_IRUGO, qla4xxx_fw_timestamp_show, core::ptr::null_mut());
    static DEVICE_ATTR(fw_build_user, S_IRUGO, qla4xxx_fw_build_user_show, core::ptr::null_mut());
    static DEVICE_ATTR(fw_ext_timestamp, S_IRUGO, qla4xxx_fw_ext_timestamp_show,
    core::ptr::null_mut());
    static DEVICE_ATTR(fw_load_src, S_IRUGO, qla4xxx_fw_load_src_show, core::ptr::null_mut());
    static DEVICE_ATTR(fw_uptime, S_IRUGO, qla4xxx_fw_uptime_show, core::ptr::null_mut());
