...
//! Source: drivers/scsi/scsi_transport_fc.c
#![no_std]
...
pub const FC_PORTTYPE_MAX_NAMELEN: c_int = 50;
...
// Convert fc_host_event_code values to ascii string name
    ...
    fc_host_event_code_names)
pub const FC_HOST_EVENT_CODE_MAX_NAMELEN: c_int = 30;
...
pub const FC_PORTSTATE_MAX_NAMELEN: c_int = 20;
...
pub const FC_VPORTSTATE_MAX_NAMELEN: c_int = 24;
...
// Convert fc_tgtid_binding_type values to ascii string name
    ...
    fc_tgtid_binding_type_names)
pub const FC_BINDTYPE_MAX_NAMELEN: c_int = 30;
...
//
pub const FC_WELLKNOWN_PORTID_MASK: c_uint = 0xfffff0;
pub const FC_WELLKNOWN_ROLE_MASK: c_uint = 0x00000f;
pub const FC_FPORT_PORTID: c_uint = 0x00000e;
pub const FC_FABCTLR_PORTID: c_uint = 0x00000d;
pub const FC_DIRSRVR_PORTID: c_uint = 0x00000c;
pub const FC_TIMESRVR_PORTID: c_uint = 0x00000b;
pub const FC_MGMTSRVR_PORTID: c_uint = 0x00000a;
...
//
pub const FC_STARGET_NUM_ATTRS: c_int = 3;
pub const FC_RPORT_NUM_ATTRS: c_int = 10;
pub const FC_VPORT_NUM_ATTRS: c_int = 9;
pub const FC_HOST_NUM_ATTRS: c_int = 29;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fc_internal {
    pub t: scsi_transport_template,
    pub f: *mut fc_function_template,
//
...
//
    ...
    pub 1]: *mut *mut device_attribute starget_attrs[FC_STARGET_NUM_ATTRS +,
    pub private_host_attrs: [device_attribute; FC_HOST_NUM_ATTRS],
    pub 1]: *mut *mut device_attribute host_attrs[FC_HOST_NUM_ATTRS +,
    pub rport_attr_cont: transport_container,
    pub private_rport_attrs: [device_attribute; FC_RPORT_NUM_ATTRS],
    pub 1]: *mut *mut device_attribute rport_attrs[FC_RPORT_NUM_ATTRS +,
    pub vport_attr_cont: transport_container,
    pub private_vport_attrs: [device_attribute; FC_VPORT_NUM_ATTRS],
    pub 1]: *mut *mut device_attribute vport_attrs[FC_VPORT_NUM_ATTRS +,
}
...
//
    ...
    {
    struct fc_rport *rport = core::ptr::null_mut();
    struct fc_rport *attach_rport = core::ptr::null_mut();
    struct fc_host_attrs *fc_host = shost_to_fc_host(shost);
    struct fc_fn_li_desc *li_desc = (struct fc_fn_li_desc *)tlv;
    let mut event_type: u16 = be16_to_cpu(li_desc.event_type);
...
//
    ...
    let mut reason_code: u32 = be32_to_cpu(dn_desc.deli_reason_code);
    rport = fc_find_rport_by_wwpn(shost,
...
//
    ...
    let mut event_type: u16 = be16_to_cpu(pc_desc.event_type);
    rport = fc_find_rport_by_wwpn(shost,
...
#[no_mangle]
unsafe extern "C" fn fc_transport_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn fc_transport_exit() -> void __exit {
...
//
    ...
    show_fc_rport_##field, core::ptr::null_mut())
    ...
    show_fc_rport_##title, core::ptr::null_mut())

    i.private_rport_attrs[count] = device_attr_rport_##field; \
    i.private_rport_attrs[count].attr.mode = S_IRUGO;		\
    i.private_rport_attrs[count].store = core::ptr::null_mut();			\
...
// Fixed Remote Port Attributes
    ...
    show_fc_rport_supported_classes, core::ptr::null_mut());
// Dynamic Remote Port Attributes
//
// dev_loss_tmo attribute
//
#[no_mangle]
unsafe extern "C" fn fc_str_to_dev_loss(buf: *const c_char, val: *mut c_ulong) -> c_int {
...
// identify any roles that are port_id specific
    ...
    show_fc_rport_roles, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(rport->port_state: port_state !=) -> else {
...
//
    ...
    static FC_DEVICE_ATTR(rport, encryption_##name, 0444, fc_rport_encinfo_##name, core::ptr::null_mut())	\
...
#[no_mangle]
pub unsafe extern "C" fn FC_DEVICE_ATTR(_arg: rport, _arg: fpin_##name, _arg: 0444, _arg: fc_rport_fpinstat_##name, _arg: NULL) -> static {
    static FC_DEVICE_ATTR(rport, fpin_##name, 0444, fc_rport_fpinstat_##name, core::ptr::null_mut())
...
//
    ...
    show_fc_starget_##field, core::ptr::null_mut())
    ...
    i.private_starget_attrs[count].store = core::ptr::null_mut();			\
...
// count may include a LF at end of string */			\
    ...
    show_fc_vport_##field, core::ptr::null_mut())
    ...
    show_fc_vport_##title, core::ptr::null_mut())

    i.private_vport_attrs[count] = device_attr_vport_##field; \
    i.private_vport_attrs[count].attr.mode = S_IRUGO;		\
    i.private_vport_attrs[count].store = core::ptr::null_mut();			\
...
// Private Virtual Port Attributes
    ...
    static FC_DEVICE_ATTR(vport, roles, S_IRUGO, show_fc_vport_roles, core::ptr::null_mut());
    ...
    core::ptr::null_mut(), store_fc_vport_delete);
//
...
//
    ...
    core::ptr::null_mut(), store_fc_vport_disable);
//
...
// count may include a LF at end of string */			\
    ...
    show_fc_host_##field, core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn FC_DEVICE_ATTR(_arg: host, _arg: title, _arg: S_IRUGO, _arg: show_fc_host_##title, _arg: NULL) -> static {
    static FC_DEVICE_ATTR(host, title, S_IRUGO, show_fc_host_##title, core::ptr::null_mut())

    i.private_host_attrs[count] = device_attr_host_##field;	\
    i.private_host_attrs[count].attr.mode = S_IRUGO;		\
    i.private_host_attrs[count].store = core::ptr::null_mut();			\
...
// Fixed Host Attributes
    ...
    show_fc_host_supported_classes, core::ptr::null_mut());
    static ssize_t
    ...
    show_fc_host_supported_fc4s, core::ptr::null_mut());
    static ssize_t
    ...
    show_fc_host_supported_speeds, core::ptr::null_mut());
...
// Dynamic Host Attributes
    ...
    show_fc_host_active_fc4s, core::ptr::null_mut());
    static ssize_t
    ...
    show_fc_host_speed, core::ptr::null_mut());
...
// ignore any data value written to the attribute
    ...
    static FC_DEVICE_ATTR(host, issue_lip, S_IWUSR, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn FC_DEVICE_ATTR(_arg: host, _arg: name, _arg: S_IRUGO, _arg: show_fcstat_##name, _arg: NULL) -> static {
    static FC_DEVICE_ATTR(host, name, S_IRUGO, show_fcstat_##name, core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn FC_DEVICE_ATTR(_arg: host, _arg: fpin_##name, _arg: 0444, _arg: fc_host_fpinstat_##name, _arg: NULL) -> static {
    static FC_DEVICE_ATTR(host, fpin_##name, 0444, fc_host_fpinstat_##name, core::ptr::null_mut())
...
// ignore any data value written to the attribute
    ...
    static FC_DEVICE_ATTR(host, reset_statistics, S_IWUSR, core::ptr::null_mut(),
    fc_reset_statistics);
...
// we only allow support on Channel 0 !!!
    ...
    static FC_DEVICE_ATTR(host, vport_create, S_IWUSR, core::ptr::null_mut(),
...
// we only allow support on Channel 0 !!!
    ...
    static FC_DEVICE_ATTR(host, vport_delete, S_IWUSR, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn fc_rport_dev_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_is_fc_rport(dev: *const device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fc_vport_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn scsi_is_fc_vport(dev: *const device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_eh_timed_out(scmd: *mut scsi_cmnd) -> enum scsi_timeout_action {
...
//
    ...
    i.starget_attrs[count] = core::ptr::null_mut();
//
...
// Transport-managed attributes
    ...
    i.host_attrs[count] = core::ptr::null_mut();
//
...
//
    ...
    i.rport_attrs[count] = core::ptr::null_mut();
//
...
//
    ...
    i.vport_attrs[count] = core::ptr::null_mut();
    return &i.t;
    }
    EXPORT_SYMBOL(fc_attach_transport);
#[no_mangle]
pub unsafe extern "C" fn fc_release_transport(t: *mut scsi_transport_template) {
...
//
    ...
    {
    struct fc_vport *vport = core::ptr::null_mut(), *next_vport = core::ptr::null_mut();
    struct fc_rport *rport = core::ptr::null_mut(), *next_rport = core::ptr::null_mut();
...
// flush all stgt delete, and rport delete work items, then kill it
    ...
    fc_host.work_q = core::ptr::null_mut();
    destroy_workqueue(work_q);
    }
    }
    EXPORT_SYMBOL(fc_remove_host);
#[no_mangle]
unsafe extern "C" fn fc_terminate_rport_io(rport: *mut fc_rport) {
...
//
    ...
    rport.devloss_work_q = core::ptr::null_mut();
    destroy_workqueue(work_q);
    }
...
//
    ...
    {
    struct Scsi_Host *shost = rport_to_shost(rport);
    let mut timeout: c_ulong = rport.dev_loss_tmo;
    unsigned long flags;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_block_rport(rport: *mut fc_rport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_block_scsi_eh(cmnd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_eh_should_retry_cmd(scmd: *mut scsi_cmnd) -> bool {
...
//
    ...
    ids, &vport);
    return stat ? core::ptr::null_mut() : vport;
    }
...
//
    ...
    struct fc_internal *i = to_fc_internal(shost.transportt);
    let mut err: c_int = 0, inflight = 0;
...
//
#[no_mangle]
unsafe extern "C" fn fc_bsg_host_dispatch(shost: *mut Scsi_Host, job: *mut bsg_job) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_bsg_rport_dispatch(shost: *mut Scsi_Host, job: *mut bsg_job) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fc_bsg_dispatch(job: *mut bsg_job) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fc_bsg_rport_prep(rport: *mut fc_rport) -> blk_status_t {
...
#[no_mangle]
unsafe extern "C" fn fc_bsg_dispatch_prep(job: *mut bsg_job) -> c_int {
...
//
    ...
    char bsg_name[20];
    fc_host.rqst_q = core::ptr::null_mut();
    if (!i.f.bsg_request)
    return -ENOTSUPP;
...
//
    ...
    struct queue_limits lim;
    struct request_queue *q;
    rport.rqst_q = core::ptr::null_mut();
    if (!i.f.bsg_request)
    return -ENOTSUPP;
    scsi_init_limits(shost, &lim);
    lim.max_segments = min_not_zero(lim.max_segments, i.f.max_bsg_segments);
