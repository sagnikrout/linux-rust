...
//! Source: drivers/scsi/lpfc/lpfc_nportdisc.c
#![no_std]
...
// Abort the targeted IOs and remove them from the abort list.
    ...
    retval = lpfc_sli_issue_abort_iotag(phba, pring, iocb, core::ptr::null_mut());
    spin_unlock_irq(&phba.hbalock);
...
//
    ...
    rc = lpfc_els_rsp_acc(login_mbox.vport, ELS_CMD_PLOGI,
    save_iocb, ndlp, core::ptr::null_mut());
    }
    if (rc) {
...
//
    ...
    login_mbox = core::ptr::null_mut();
    link_mbox = core::ptr::null_mut();
    save_iocb = core::ptr::null_mut();
...
//
    ...
    lpfc_els_rsp_acc(vport, ELS_CMD_PRLO, cmdiocb, ndlp, core::ptr::null_mut());
    else
...
// 1 sec timeout
    ...
    if (phba.sli_rev == LPFC_SLI_REV4) {
    rc = lpfc_sli4_resume_rpi(ndlp, core::ptr::null_mut(), core::ptr::null_mut());
    if (rc) {
...
// cleanup any ndlp on mbox q waiting for reglogin cmpl
    ...
    LPFC_MBOXQ_t *pmb = (LPFC_MBOXQ_t *) arg;
    MAILBOX_t *mb = &pmb.u.mb;
    let mut did: u32 = mb.un.varWords[1];
    if (mb.mbxStatus) {
// RegLogin failed
    lpfc_printf_vlog(vport, KERN_ERR, LOG_TRACE_EVENT,
...
//
    ...
    void *temp_ptr;
    u32 ulp_status;
    let mut acc_imode_sps: bool = false;
    cmdiocb = (struct lpfc_iocbq *) arg;
    rspiocb = cmdiocb.rsp_iocb;
    ulp_status = get_job_ulpstatus(phba, rspiocb);
...
//
    npr = core::ptr::null_mut();
    nvpr = core::ptr::null_mut();
    temp_ptr = lpfc_check_elscmpl_iocb(phba, cmdiocb, rspiocb);
    if (cmdiocb.cmd_flag & LPFC_PRLI_FCP_REQ)
    npr = (PRLI *) temp_ptr;
#[no_mangle]
pub unsafe extern "C" fn if(LPFC_PRLI_NVME_REQ: cmdiocb->cmd_flag &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn uint32_t(NLP_EVT_MAX_EVENT]: *mut *mut *mut lpfc_disc_action[NLP_STE_MAX_STATE) -> static {
