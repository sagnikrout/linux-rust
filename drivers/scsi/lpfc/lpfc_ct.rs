...
//! Source: drivers/scsi/lpfc/lpfc_ct.c
#![no_std]
...
pub const HBA_PORTSPEED_1GFC: c_uint = 0x00000001	/* 1G FC */;
pub const HBA_PORTSPEED_2GFC: c_uint = 0x00000002	/* 2G FC */;
pub const HBA_PORTSPEED_4GFC: c_uint = 0x00000008	/* 4G FC */;
pub const HBA_PORTSPEED_10GFC: c_uint = 0x00000004	/* 10G FC */;
pub const HBA_PORTSPEED_8GFC: c_uint = 0x00000010	/* 8G FC */;
pub const HBA_PORTSPEED_16GFC: c_uint = 0x00000020	/* 16G FC */;
pub const HBA_PORTSPEED_32GFC: c_uint = 0x00000040	/* 32G FC */;
pub const HBA_PORTSPEED_20GFC: c_uint = 0x00000080	/* 20G FC */;
pub const HBA_PORTSPEED_40GFC: c_uint = 0x00000100	/* 40G FC */;
pub const HBA_PORTSPEED_128GFC: c_uint = 0x00000200	/* 128G FC */;
pub const HBA_PORTSPEED_64GFC: c_uint = 0x00000400	/* 64G FC */;
pub const HBA_PORTSPEED_256GFC: c_uint = 0x00000800	/* 256G FC */;
pub const HBA_PORTSPEED_UNKNOWN: c_uint = 0x00008000	/* Unknown */;
pub const HBA_PORTSPEED_10GE: c_uint = 0x00010000	/* 10G E */;
pub const HBA_PORTSPEED_40GE: c_uint = 0x00020000	/* 40G E */;
pub const HBA_PORTSPEED_100GE: c_uint = 0x00040000	/* 100G E */;
pub const HBA_PORTSPEED_25GE: c_uint = 0x00080000	/* 25G E */;
pub const HBA_PORTSPEED_50GE: c_uint = 0x00100000	/* 50G E */;
pub const HBA_PORTSPEED_400GE: c_uint = 0x00200000	/* 400G E */;
pub const FOURBYTES: c_int = 4;
...
//
    ...
    kfree(mp);
    cmdiocb.rsp_dmabuf = core::ptr::null_mut();
    }
    if (bmp) {
    lpfc_mbuf_free(phba, bmp.virt, bmp.phys);
    kfree(bmp);
    cmdiocb.bpl_dmabuf = core::ptr::null_mut();
    }
...
//
    ...
    struct lpfc_iocbq *cmdiocbq = core::ptr::null_mut();
    struct lpfc_dmabuf *bmp = core::ptr::null_mut();
    struct lpfc_dmabuf *mp = core::ptr::null_mut();
...
//
    ...
    let mut ulp_status: u32 = get_job_ulpstatus(phba, ctiocbq);
    let mut ulp_word4: u32 = get_job_word4(phba, ctiocbq);
    u32 did;
    u16 mi_cmd;
...
//
    ...
    ctiocbq.cmd_dmabuf = core::ptr::null_mut();
    ctiocbq.rsp_dmabuf = core::ptr::null_mut();
    ctiocbq.bpl_dmabuf = core::ptr::null_mut();
...
//
    ...
    iocb.cmd_dmabuf = core::ptr::null_mut();
    if (phba.sli_rev == LPFC_SLI_REV4)
    ...
    iocb.bpl_dmabuf = core::ptr::null_mut();
    if (phba.sli_rev == LPFC_SLI_REV4)
    ...
    lpfc_ct_unsol_buffer(phba, iocbq, core::ptr::null_mut(), 0);
...
// CT upper level goes through BSG
    ...
    {
    struct lpfc_dmabuf *mlist = core::ptr::null_mut();
...
//
    ...
    kfree(buf_ptr);
    ctiocb.cmd_dmabuf = core::ptr::null_mut();
    }
    if (ctiocb.rsp_dmabuf) {
    lpfc_free_ct_rsp(phba, ctiocb.rsp_dmabuf);
    ctiocb.rsp_dmabuf = core::ptr::null_mut();
    }
    if (ctiocb.bpl_dmabuf) {
    buf_ptr = ctiocb.bpl_dmabuf;
    lpfc_mbuf_free(phba, buf_ptr.virt, buf_ptr.phys);
    kfree(buf_ptr);
    ctiocb.bpl_dmabuf = core::ptr::null_mut();
    }
...
// RSCN still
    ...
    int did, rc, retry;
    uint8_t fbits;
    struct lpfc_nodelist *ndlp = core::ptr::null_mut(), *free_ndlp = core::ptr::null_mut();
    let mut ulp_status: u32 = get_job_ulpstatus(phba, rspiocb);
    let mut ulp_word4: u32 = get_job_word4(phba, rspiocb);
...
//
    ...
    struct ulp_bde64 *bpl;
    void (*cmpl) (struct lpfc_hba *, struct lpfc_iocbq *,
    struct lpfc_iocbq *) = core::ptr::null_mut();
    uint32_t *ptr;
    let mut rsp_size: u32 = 1024;
    size_t   size;
    let mut rc: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_GID_PT: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_GID_PT)
    bpl.tus.f.bdeSize = GID_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_GFF_ID: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_GFF_ID)
    bpl.tus.f.bdeSize = GFF_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_GFT_ID: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_GFT_ID)
    bpl.tus.f.bdeSize = GFT_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_RFT_ID: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_RFT_ID)
    bpl.tus.f.bdeSize = RFT_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_RNN_ID: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_RNN_ID)
    bpl.tus.f.bdeSize = RNN_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_RSPN_ID: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_RSPN_ID)
    bpl.tus.f.bdeSize = RSPN_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_RSNN_NN: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_RSNN_NN)
    bpl.tus.f.bdeSize = RSNN_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_RSPNI_PNI: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_RSPNI_PNI)
    bpl.tus.f.bdeSize = RSPNI_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_DA_ID: cmdcode ==) -> else {
    else if (cmdcode == SLI_CTNS_DA_ID)
    bpl.tus.f.bdeSize = DA_ID_REQUEST_SZ;
#[no_mangle]
pub unsafe extern "C" fn if(SLI_CTNS_RFF_ID: cmdcode ==) -> else {
...
//
    ...
    let mut fdmi_cmd: __be16 = CTcmd.CommandResponse.bits.CmdRsp;
    let mut fdmi_rsp: __be16 = CTrsp.CommandResponse.bits.CmdRsp;
    struct lpfc_nodelist *ndlp, *free_ndlp = core::ptr::null_mut();
...
pub const ATTR_FC4_CT: c_uint = 0x00000001;
pub const ATTR_FC4_FCP: c_uint = 0x00000002;
pub const ATTR_FC4_NVME: c_uint = 0x00000004;
    static inline int
...
#[no_mangle]
pub unsafe extern "C" fn int(_arg: *mut lpfc_fdmi_hba_action[]) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn int(_arg: *mut lpfc_fdmi_port_action[]) -> static {
...
//
    ...
    struct lpfc_fdmi_reg_portattr *pab = core::ptr::null_mut(), *base = core::ptr::null_mut();
    struct lpfc_fdmi_attr_block *ab = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: vp->rev.rBit) -> else {
    ...
    struct lpfc_sli_ct_request *ctcmd = inp.virt;
    struct lpfc_sli_ct_request *ctrsp = outp.virt;
    let mut rsp: __be16 = ctrsp.CommandResponse.bits.CmdRsp;
