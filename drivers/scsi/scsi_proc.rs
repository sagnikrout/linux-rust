...
//! Source: drivers/scsi/scsi_proc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn proc_scsi_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn proc_scsi_host_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
    ...
    return e ? e.proc_dir : core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_proc_hostdir_add(sht: *const scsi_host_template) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_proc_hostdir_rm(sht: *const scsi_host_template) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_proc_host_add(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_proc_host_rm(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn proc_print_scsidevice(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_add_single_device(host: c_uint, channel: c_uint, id: c_uint, lun: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_remove_single_device(host: c_uint, channel: c_uint, id: c_uint, lun: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scsi_seq_stop(sfile: *mut seq_file, v: *mut c_void) {
    static void scsi_seq_stop(struct seq_file *sfile, void *v)
    {
    put_device(v);
    }
#[no_mangle]
unsafe extern "C" fn scsi_seq_show(sfile: *mut seq_file, dev: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn proc_scsi_open(inode: *mut inode, file: *mut file) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_init_procfs() -> int __init {
    int __init scsi_init_procfs(void)
    {
    struct proc_dir_entry *pde;
    proc_scsi = proc_mkdir("scsi", core::ptr::null_mut());
    if (!proc_scsi)
    goto err1;
    pde = proc_create("scsi/scsi", 0, core::ptr::null_mut(), &scsi_scsi_proc_ops);
    if (!pde)
    goto err2;
    return 0;
    err2:
    remove_proc_entry("scsi", core::ptr::null_mut());
    err1:
    return -ENOMEM;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_exit_procfs() {
    void scsi_exit_procfs(void)
    {
    remove_proc_entry("scsi/scsi", core::ptr::null_mut());
    remove_proc_entry("scsi", core::ptr::null_mut());
    }
