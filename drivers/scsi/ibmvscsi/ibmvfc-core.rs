...
//! Source: drivers/scsi/ibmvscsi/ibmvfc-core.c
#![no_std]
...
//
    ...
    let mut init_timeout: static unsigned int = IBMVFC_INIT_TIMEOUT;
    let mut default_timeout: static unsigned int = IBMVFC_DEFAULT_TIMEOUT;
    let mut max_lun: static u64 = IBMVFC_MAX_LUN;
    let mut max_targets: static unsigned int = IBMVFC_MAX_TARGETS;
    let mut max_requests: static unsigned int = IBMVFC_MAX_REQUESTS_DEFAULT;
    let mut max_sectors: static u16 = IBMVFC_MAX_SECTORS;
    let mut scsi_qdepth: static u16 = IBMVFC_SCSI_QDEPTH;
    let mut disc_threads: static unsigned int = IBMVFC_MAX_DISC_THREADS;
    let mut log_level: static unsigned int = IBMVFC_DEFAULT_LOG_LEVEL;
    let mut cls3_error: static unsigned int = IBMVFC_CLS3_ERROR;
    let mut mq_enabled: static unsigned int = IBMVFC_MQ;
    let mut nr_scsi_hw_queues: static unsigned int = IBMVFC_SCSI_HW_QUEUES;
    let mut nr_scsi_channels: static unsigned int = IBMVFC_SCSI_CHANNELS;
    let mut nvme_enabled: static unsigned int = IBMVFC_NVME;
    let mut nr_nvme_hw_queues: static unsigned int = IBMVFC_NVME_HW_QUEUES;
    let mut nr_nvme_channels: static unsigned int = IBMVFC_NVME_CHANNELS;
    let mut mig_channels_only: static unsigned int = IBMVFC_MIG_NO_SUB_TO_CRQ;
    let mut mig_no_less_channels: static unsigned int = IBMVFC_MIG_NO_N_TO_M;
    let mut ibmvfc_debug: c_uint = IBMVFC_DEBUG;
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_nvme_active(vhost: *mut ibmvfc_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ibmvfc_check_caps(vhost, _arg: IBMVFC_HANDLE_VF_WWPN)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_trc_start(evt: *mut ibmvfc_event) {
    ...
    let mut index: c_int = atomic_inc_return(&vhost.trace_index) & IBMVFC_TRACE_INDEX_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_trc_end(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_err_index(status: u16, error: u16) -> c_int {
...
//
    ...
    {
    let mut rc: c_int = ibmvfc_get_err_index(status, error);
    if (rc >= 0)
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_err_result(vhost: *mut ibmvfc_host, vfc_cmd: *mut ibmvfc_cmd) -> c_int {
    static int ibmvfc_get_err_result(struct ibmvfc_host *vhost, struct ibmvfc_cmd *vfc_cmd)
    {
    int err;
    struct ibmvfc_fcp_rsp *rsp = ibmvfc_get_fcp_rsp(vhost, vfc_cmd);
    let mut fc_rsp_len: c_int = be32_to_cpu(rsp.fcp_rsp_len);
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_retry_cmd(status: u16, error: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_reinit_host(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_del_tgt(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_init_host(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_send_crq(vhost: *mut ibmvfc_host, word1: u64, word2: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_send_crq_init(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_send_crq_init_complete(vhost: *mut ibmvfc_host) -> c_int {
...
//
    ...
    evt.vhost = vhost;
    evt.queue = queue;
    evt.ext_list = core::ptr::null_mut();
...
//
    ...
    queue.msgs.handle = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_release_crq_queue(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_reenable_crq_queue(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_reset_crq(vhost: *mut ibmvfc_host) -> c_int {
...
//
    ...
    {
    let mut index: c_int = evt - pool.events;
...
//
#[no_mangle]
pub unsafe extern "C" fn ibmvfc_free_event(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_vfc_eh_done(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_complete_purge(purge_list: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_fail_request(evt: *mut ibmvfc_event, error_code: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_purge_requests(vhost: *mut ibmvfc_host, error_code: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_hard_reset_host(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn __ibmvfc_reset_host(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_reset_host(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_retry_host_init(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_host_speed(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_host_port_state(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_set_rport_dev_loss_tmo(rport: *mut fc_rport, timeout: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibmvfc_release_tgt(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_starget_node_name(starget: *mut scsi_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_starget_port_name(starget: *mut scsi_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_starget_port_id(starget: *mut scsi_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_wait_while_resetting(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_issue_fc_host_lip(shost: *mut Scsi_Host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_gather_partition_info(vhost: *mut ibmvfc_host) {
    ...
    if (!rootdn)
    return;
    name = of_get_property(rootdn, "ibm,partition-name", core::ptr::null_mut());
    if (name)
    strscpy(vhost.partition_name, name, sizeof(vhost.partition_name));
    num = of_get_property(rootdn, "ibm,partition-no", core::ptr::null_mut());
    if (num)
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_set_login_info(vhost: *mut ibmvfc_host) {
    ...
    location = of_get_property(of_node, "ibm,loc-code", core::ptr::null_mut());
...
//
    ...
    {
    struct ibmvfc_event *evt = core::ptr::null_mut();
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_locked_done(evt: *mut ibmvfc_event) {
...
//
    ...
    {
    evt.cmnd = core::ptr::null_mut();
    evt.fcp_req = core::ptr::null_mut();
    evt.ls_req = core::ptr::null_mut();
    evt.sync_iu = core::ptr::null_mut();
    evt.eh_comp = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_timeout(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IBMVFC_MAD_FORMAT: evt->crq.format ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_log_error(evt: *mut ibmvfc_event) {
    ...
    let mut index: c_int = ibmvfc_get_err_index(be16_to_cpu(vfc_cmd.status), be16_to_cpu(vfc_cmd.error));
    let mut logerr: c_int = 0;
    let mut rsp_code: c_int = 0;
    if (index >= 0) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_scsi_relogin(sdev: *mut scsi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibmvfc_host_chkready(vhost: *mut ibmvfc_host) -> c_int {
...
//
    ...
    struct ibmvfc_event *evt;
    let mut tag_and_hwq: u32 = blk_mq_unique_tag(scsi_cmd_to_rq(cmnd));
    let mut hwq: u16 = blk_mq_unique_tag_to_hwq(tag_and_hwq);
    u16 scsi_channel;
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_sync_completion(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_bsg_timeout_done(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_bsg_timeout(job: *mut bsg_job) -> c_int {
    static int ibmvfc_bsg_timeout(struct bsg_job *job)
    {
    struct ibmvfc_host *vhost = shost_priv(fc_bsg_to_shost(job));
    let mut port_id: c_ulong = (unsigned long)job.dd_data;
    struct ibmvfc_event *evt;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_bsg_plogi(vhost: *mut ibmvfc_host, port_id: c_uint) -> c_int {
    ...
    unsigned long flags;
    let mut rc: c_int = 0, issue_login = 1;
    ENTER;
    spin_lock_irqsave(vhost.host.host_lock, flags);
    list_for_each_entry(tgt, &vhost.scsi_scrqs.targets, queue) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_bsg_request(job: *mut bsg_job) -> c_int {
    ...
    let mut code: c_uint = bsg_request.msgcode;
    let mut rc: c_int = 0, req_seg, rsp_seg, issue_login = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_reset_device(sdev: *mut scsi_device, type: c_int, desc: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_match_rport(evt: *mut ibmvfc_event, rport: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_match_target(evt: *mut ibmvfc_event, device: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_match_lun(evt: *mut ibmvfc_event, device: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_event_is_free(evt: *mut ibmvfc_event) -> bool {
...
//
    ...
    unsigned long flags;
    let mut timeout: signed long = IBMVFC_ABORT_WAIT_TIMEOUT * HZ;
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_cancel_all_mq(sdev: *mut scsi_device, type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_cancel_all_sq(sdev: *mut scsi_device, type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_cancel_all(sdev: *mut scsi_device, type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_match_key(evt: *mut ibmvfc_event, key: *mut c_void) -> c_int {
    static int ibmvfc_match_key(struct ibmvfc_event *evt, void *key)
    {
    let mut cancel_key: c_ulong = (unsigned long)key;
    if (evt.crq.format == IBMVFC_CMD_FORMAT &&
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_match_evt(evt: *mut ibmvfc_event, match: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_abort_task_set(sdev: *mut scsi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_eh_abort_handler(cmd: *mut scsi_cmnd) -> c_int {
    static int ibmvfc_eh_abort_handler(struct scsi_cmnd *cmd)
    {
    struct scsi_device *sdev = cmd.device;
    struct ibmvfc_host *vhost = shost_priv(sdev.host);
    int cancel_rc, block_rc;
    let mut rc: c_int = FAILED;
    ENTER;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_eh_device_reset_handler(cmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_dev_cancel_all_noreset(sdev: *mut scsi_device, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_eh_target_reset_handler(cmd: *mut scsi_cmnd) -> c_int {
    ...
    struct ibmvfc_host *vhost = shost_priv(shost);
    int block_rc;
    let mut reset_rc: c_int = 0;
    let mut rc: c_int = FAILED;
    let mut cancel_rc: c_ulong = 0;
    let mut tgt_reset: bool = false;
    ENTER;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_eh_host_reset_handler(cmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_terminate_rport_io(rport: *mut fc_rport) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_scan_finished(shost: *mut Scsi_Host, time: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(HZ): *mut *mut time >= (vhost->scan_timeout) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_sdev_init(sdev: *mut scsi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_target_alloc(starget: *mut scsi_target) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_change_queue_depth(sdev: *mut scsi_device, qdepth: c_int) -> c_int {
...
//
    ...
    let mut flags: c_ulong = 0;
    spin_lock_irqsave(shost.host_lock, flags);
    vhost.log_level = simple_strtoul(buf, core::ptr::null_mut(), 10);
    spin_unlock_irqrestore(shost.host_lock, flags);
    return strlen(buf);
    }
    ...
    spin_lock_irqsave(shost.host_lock, flags);
    channels = simple_strtoul(buf, core::ptr::null_mut(), 10);
    scsi.desired_queues = min(channels, shost.nr_hw_queues);
    ibmvfc_hard_reset_host(vhost);
    spin_unlock_irqrestore(shost.host_lock, flags);
    return strlen(buf);
    }
    static DEVICE_ATTR(partition_name, S_IRUGO, ibmvfc_show_host_partition_name, core::ptr::null_mut());
    static DEVICE_ATTR(device_name, S_IRUGO, ibmvfc_show_host_device_name, core::ptr::null_mut());
    static DEVICE_ATTR(port_loc_code, S_IRUGO, ibmvfc_show_host_loc_code, core::ptr::null_mut());
    static DEVICE_ATTR(drc_name, S_IRUGO, ibmvfc_show_host_drc_name, core::ptr::null_mut());
    static DEVICE_ATTR(npiv_version, S_IRUGO, ibmvfc_show_host_npiv_version, core::ptr::null_mut());
    static DEVICE_ATTR(capabilities, S_IRUGO, ibmvfc_show_host_capabilities, core::ptr::null_mut());
...
//
    ...
    struct ibmvfc_host *vhost = shost_priv(shost);
    let mut flags: c_ulong = 0;
    let mut size: c_int = IBMVFC_TRACE_SIZE;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tasklet(data: *mut c_void) {
...
// Pull all the valid messages off the async CRQ
    while ((async = ibmvfc_next_async_crq(vhost)) != core::ptr::null_mut()) {
    ibmvfc_handle_async(async, vhost);
    async.valid = 0;
    wmb();
    }
// Pull all the valid messages off the CRQ
    while ((crq = ibmvfc_next_crq(vhost)) != core::ptr::null_mut()) {
    ibmvfc_handle_crq(crq, vhost, &evt_doneq);
    crq.valid = 0;
    wmb();
    }
    vio_enable_interrupts(vdev);
    if ((async = ibmvfc_next_async_crq(vhost)) != core::ptr::null_mut()) {
    vio_disable_interrupts(vdev);
    ibmvfc_handle_async(async, vhost);
    async.valid = 0;
    wmb();
    } else if ((crq = ibmvfc_next_crq(vhost)) != core::ptr::null_mut()) {
    vio_disable_interrupts(vdev);
    ibmvfc_handle_crq(crq, vhost, &evt_doneq);
    crq.valid = 0;
    wmb();
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_toggle_scrq_irq(scrq: *mut ibmvfc_queue, enable: c_int) -> c_int {
    static int ibmvfc_toggle_scrq_irq(struct ibmvfc_queue *scrq, int enable)
    {
    struct device *dev = scrq.vhost.dev;
    struct vio_dev *vdev = to_vio_dev(dev);
    unsigned long rc;
    let mut irq_action: c_int = H_ENABLE_VIO_INTERRUPT;
    if (!enable)
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_drain_sub_crq(scrq: *mut ibmvfc_queue) {
    ...
    while (!done) {
    while ((crq = ibmvfc_next_scrq(scrq)) != core::ptr::null_mut()) {
    ibmvfc_handle_scrq(crq, scrq.vhost, &evt_doneq);
    crq.valid = 0;
    wmb();
    }
    ibmvfc_toggle_scrq_irq(scrq, 1);
    if ((crq = ibmvfc_next_scrq(scrq)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_interrupt_mq(irq: c_int, scrq_instance: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_prli_rsp(flags: u16) -> c_int {
    static int ibmvfc_get_prli_rsp(u16 flags)
    {
    int i;
    let mut code: c_int = (flags & 0x0f00) >> 8;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_prli_done(evt: *mut ibmvfc_event) {
    ...
    let mut status: u32 = be16_to_cpu(rsp.common.status);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tgt->logo_rcvd) -> else {
    else if (tgt.logo_rcvd)
    level += ibmvfc_retry_tgt_init(tgt, ibmvfc_tgt_send_plogi);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ibmvfc_retry_cmd(be16_to_cpu(rsp->status), _arg: be16_to_cpu(rsp->error))) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_send_prli(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_plogi_done(evt: *mut ibmvfc_event) {
    ...
    let mut status: u32 = be16_to_cpu(rsp.common.status);
    let mut level: c_int = IBMVFC_DEFAULT_LOG_LEVEL;
    vhost.discovery_threads--;
    ibmvfc_set_tgt_action(tgt, IBMVFC_TGT_ACTION_NONE);
    switch (status) {
    case IBMVFC_MAD_SUCCESS:
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_send_plogi(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_implicit_logout_done(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_implicit_logout(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_implicit_logout_and_del_done(evt: *mut ibmvfc_event) {
    static void ibmvfc_tgt_implicit_logout_and_del_done(struct ibmvfc_event *evt)
    {
    struct ibmvfc_target *tgt = evt.tgt;
    struct ibmvfc_host *vhost = evt.vhost;
    struct ibmvfc_passthru_mad *mad = &evt.xfer_iu.passthru;
    let mut status: u32 = be16_to_cpu(mad.common.status);
    vhost.discovery_threads--;
    ibmvfc_free_event(evt);
//
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_implicit_logout_and_del(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_move_login_done(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_move_login(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_adisc_done(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_init_passthru(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_adisc_cancel_done(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_adisc_timeout(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_adisc(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_query_target_done(evt: *mut ibmvfc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_query_target(tgt: *mut ibmvfc_target) {
...
//
    ...
    {
    struct ibmvfc_target *stgt = core::ptr::null_mut();
    struct ibmvfc_target *wtgt = core::ptr::null_mut();
    struct ibmvfc_target *tgt;
    struct ibmvfc_channels *channels;
    unsigned long flags;
    let mut scsi_id: u64 = be32_to_cpu(target.scsi_id) & IBMVFC_DISC_TGT_SCSI_ID_MASK;
    let mut wwpn: u64 = be64_to_cpu(target.wwpn);
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_alloc_targets(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_discover_targets_done(evt: *mut ibmvfc_event) {
    static void ibmvfc_discover_targets_done(struct ibmvfc_event *evt)
    {
    struct ibmvfc_host *vhost = evt.vhost;
    struct ibmvfc_discover_targets *rsp = &evt.xfer_iu.discover_targets;
    struct ibmvfc_channels *channels;
    let mut mad_status: u32 = be16_to_cpu(rsp.common.status);
    let mut opcode: u32 = be32_to_cpu(rsp.common.opcode);
    let mut level: c_int = IBMVFC_DEFAULT_LOG_LEVEL;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_discover_targets(vhost: *mut ibmvfc_host) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_fabric_login_nvme_done(evt: *mut ibmvfc_event) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_fabric_login_nvme(vhost: *mut ibmvfc_host) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_fabric_login_scsi_done(evt: *mut ibmvfc_event) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_fabric_login_scsi(vhost: *mut ibmvfc_host) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_channel_setup_done(evt: *mut ibmvfc_event) {
    ...
    let mut mad_status: u32 = be16_to_cpu(evt.xfer_iu.channel_setup.common.status);
    let mut level: c_int = IBMVFC_DEFAULT_LOG_LEVEL;
    int flags, i;
    ibmvfc_free_event(evt);
    switch (mad_status) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_channel_setup(vhost: *mut ibmvfc_host) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_channel_enquiry_done(evt: *mut ibmvfc_event) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_channel_enquiry(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_npiv_login_done(evt: *mut ibmvfc_event) {
    static void ibmvfc_npiv_login_done(struct ibmvfc_event *evt)
    {
    struct ibmvfc_host *vhost = evt.vhost;
    let mut mad_status: u32 = be16_to_cpu(evt.xfer_iu.npiv_login.common.status);
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_npiv_login(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_npiv_logout_done(evt: *mut ibmvfc_event) {
    static void ibmvfc_npiv_logout_done(struct ibmvfc_event *evt)
    {
    struct ibmvfc_host *vhost = evt.vhost;
    let mut mad_status: u32 = be16_to_cpu(evt.xfer_iu.npiv_logout.common.status);
    ibmvfc_free_event(evt);
    switch (mad_status) {
    case IBMVFC_MAD_SUCCESS:
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_npiv_logout(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_dev_init_to_do(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_dev_logo_to_do(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __ibmvfc_work_to_do(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_work_to_do(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_log_ae(vhost: *mut ibmvfc_host, events: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_add_nvme_rport(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_tgt_add_rport(tgt: *mut ibmvfc_target) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_do_work(vhost: *mut ibmvfc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_work(data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_init_crq(vhost: *mut ibmvfc_host) -> c_int {
...
// H_CLOSED indicates successful register, but no CRQ partner
    ...
    scrq.irq = irq_create_mapping(core::ptr::null_mut(), scrq.hw_irq);
    if (!scrq.irq) {
    rc = -EINVAL;
...
// Clean out the queue
    ...
    channels.scrqs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_init_sub_crqs(vhost: *mut ibmvfc_host) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_release_sub_crqs(vhost: *mut ibmvfc_host) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_free_disc_buf(dev: *mut device, channels: *mut ibmvfc_channels) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_free_mem(vhost: *mut ibmvfc_host) {
...
#[no_mangle]
unsafe extern "C" fn ibmvfc_alloc_disc_buf(dev: *mut device, channels: *mut ibmvfc_channels) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_alloc_mem(vhost: *mut ibmvfc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_rport_add_thread(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_probe(vdev: *mut vio_dev, id: *const vio_device_id) -> c_int {
    ...
    let mut rc: c_int = -ENOMEM;
    let mut online_cpus: c_uint = num_online_cpus();
    let mut max_scsi_queues: c_uint = min_t(unsigned int, IBMVFC_MAX_SCSI_QUEUES, online_cpus);
    let mut max_nvme_queues: c_uint = min_t(unsigned int, IBMVFC_MAX_NVME_QUEUES, online_cpus);
    ENTER;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_remove(vdev: *mut vio_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_get_desired_dma(vdev: *mut vio_dev) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_module_init() -> int __init {
    static int __init ibmvfc_module_init(void)
    {
    let mut min_max_sectors: c_int = PAGE_SIZE >> 9;
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn ibmvfc_module_exit() -> void __exit {
