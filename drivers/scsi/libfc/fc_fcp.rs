...
//! Source: drivers/scsi/libfc/fc_fcp.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fc_fcp_internal {
    pub scsi_pkt_pool: *mut mempool_t,
    pub scsi_queue_lock: spinlock_t,
    pub scsi_pkt_queue: list_head,
    pub last_can_queue_ramp_down_time: c_ulong,
    pub last_can_queue_ramp_up_time: c_ulong,
    pub max_can_queue: c_int,
}
...
//
pub const FC_COMPLETE: c_int = 0;
pub const FC_CMD_ABORTED: c_int = 1;
pub const FC_CMD_RESET: c_int = 2;
pub const FC_CMD_PLOGO: c_int = 3;
pub const FC_SNS_RCV: c_int = 4;
pub const FC_TRANS_ERR: c_int = 5;
pub const FC_DATA_OVRRUN: c_int = 6;
pub const FC_DATA_UNDRUN: c_int = 7;
pub const FC_ERROR: c_int = 8;
pub const FC_HRD_ERROR: c_int = 9;
pub const FC_CRC_ERROR: c_int = 10;
pub const FC_TIMED_OUT: c_int = 11;
pub const FC_TRANS_RESET: c_int = 12;
//
// Error recovery timeout values.
//

pub const FC_MAX_ERROR_CNT: c_int = 5;
pub const FC_MAX_RECOV_RETRY: c_int = 3;
pub const FC_FCP_DFLT_QUEUE_DEPTH: c_int = 32;
//
...
//
    ...
    timer_setup(&fsp.timer, core::ptr::null_mut(), 0);
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_pkt_release(fsp: *mut fc_fcp_pkt) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_pkt_hold(fsp: *mut fc_fcp_pkt) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_pkt_destroy(seq: *mut fc_seq, fsp: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fcp_lock_pkt(fsp: *mut fc_fcp_pkt) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fcp_unlock_pkt(fsp: *mut fc_fcp_pkt) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_timer_set(fsp: *mut fc_fcp_pkt, delay: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn fc_fcp_abort_done(fsp: *mut fc_fcp_pkt) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_send_abort(fsp: *mut fc_fcp_pkt) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_retry_cmd(fsp: *mut fc_fcp_pkt, status_code: c_int) {
    static void fc_fcp_retry_cmd(struct fc_fcp_pkt *fsp, int status_code)
    {
    if (fsp.seq_ptr) {
    fc_exch_done(fsp.seq_ptr);
    fsp.seq_ptr = core::ptr::null_mut();
    }
    fsp.state &= ~FC_SRB_ABORT_PENDING;
    fsp.io_status = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fcp_ddp_setup(fsp: *mut fc_fcp_pkt, xid: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fcp_ddp_done(fsp: *mut fc_fcp_pkt) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_can_queue_ramp_up(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_can_queue_ramp_down(lport: *mut fc_lport) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_fsp_rec_tov(fsp: *mut fc_fcp_pkt) -> c_uint {
    static inline unsigned int get_fsp_rec_tov(struct fc_fcp_pkt *fsp)
    {
    struct fc_rport_libfc_priv *rpriv = fsp.rport.dd_data;
    let mut e_d_tov: c_uint = FC_DEF_E_D_TOV;
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_recv_data(fsp: *mut fc_fcp_pkt, fp: *mut fc_frame) {
    ...
    u32 nents;
    let mut host_bcode: u8 = FC_COMPLETE;
...
//
    ...
    struct scsi_cmnd *sc;
    struct scatterlist *sg;
    struct fc_frame *fp = core::ptr::null_mut();
    struct fc_lport *lport = fsp.lp;
    struct page *page;
    size_t remaining;
    size_t t_blen;
    ...
    void *page_addr;
    let mut using_sg: c_int = lport.sg_supp;
    u32 f_ctl;
    WARN_ON(seq_blen <= 0);
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_abts_resp(fsp: *mut fc_fcp_pkt, fp: *mut fc_frame) {
    static void fc_fcp_abts_resp(struct fc_fcp_pkt *fsp, struct fc_frame *fp)
    {
    let mut ba_done: c_int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_recv(seq: *mut fc_seq, fp: *mut fc_frame, arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_resp(fsp: *mut fc_fcp_pkt, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_complete_locked(fsp: *mut fc_fcp_pkt) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_cleanup_cmd(fsp: *mut fc_fcp_pkt, error: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_abort_io(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_pkt_send(lport: *mut fc_lport, fsp: *mut fc_fcp_pkt) -> c_int {
    ...
    if (unlikely(rc)) {
    spin_lock_irqsave(&si.scsi_queue_lock, flags);
    libfc_priv(fsp.cmd).fsp = core::ptr::null_mut();
    list_del(&fsp.list);
    spin_unlock_irqrestore(&si.scsi_queue_lock, flags);
    }
    return rc;
...
//
    ...
    let mut len: usize = sizeof(fsp.cdb_cmd);
    let mut rc: c_int = 0;
    if (fc_fcp_lock_pkt(fsp))
    return 0;
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_error(fsp: *mut fc_fcp_pkt, fp: *mut fc_frame) {
    static void fc_fcp_error(struct fc_fcp_pkt *fsp, struct fc_frame *fp)
    {
    let mut error: c_int = PTR_ERR(fp);
    if (fc_fcp_lock_pkt(fsp))
    return;
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_pkt_abort(fsp: *mut fc_fcp_pkt) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lun_reset_send(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_tm_done(seq: *mut fc_seq, fp: *mut fc_frame, arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_cleanup(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_timeout(t: *mut timer_list) {
    ...
    fc_fcp_rec(fsp);
#[no_mangle]
pub unsafe extern "C" fn if(FC_SRB_RCV_STATUS: fsp->state &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_rec(fsp: *mut fc_fcp_pkt) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_rec_resp(seq: *mut fc_seq, fp: *mut fc_frame, arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_rec_error(fsp: *mut fc_fcp_pkt, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_recovery(fsp: *mut fc_fcp_pkt, code: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_srr(fsp: *mut fc_fcp_pkt, r_ctl: enum fc_rctl, offset: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_srr_resp(seq: *mut fc_seq, fp: *mut fc_frame, arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_fcp_srr_error(fsp: *mut fc_fcp_pkt, fp: *mut fc_frame) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fcp_lport_queue_ready(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_io_compl(fsp: *mut fc_fcp_pkt) {
...
//
    ...
    spin_lock_irqsave(&si.scsi_queue_lock, flags);
    list_del(&fsp.list);
    libfc_priv(sc_cmd).fsp = core::ptr::null_mut();
    spin_unlock_irqrestore(&si.scsi_queue_lock, flags);
    scsi_done(sc_cmd);
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_eh_abort(sc_cmd: *mut scsi_cmnd) -> c_int {
    ...
    return rc;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !lport->link_up) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_eh_device_reset(sc_cmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_eh_host_reset(sc_cmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_sdev_init(sdev: *mut scsi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fcp_destroy(lport: *mut fc_lport) {
    ...
    kfree(si);
    lport.scsi_priv = core::ptr::null_mut();
    }
    EXPORT_SYMBOL(fc_fcp_destroy);
#[no_mangle]
pub unsafe extern "C" fn fc_setup_fcp() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fc_destroy_fcp() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fcp_init(lport: *mut fc_lport) -> c_int {
