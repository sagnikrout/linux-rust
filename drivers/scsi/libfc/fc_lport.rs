...
//! Source: drivers/scsi/libfc/fc_lport.c
#![no_std]
...
pub const FC_LOCAL_PTP_FID_LO: c_uint = 0x010101;
pub const FC_LOCAL_PTP_FID_HI: c_uint = 0x010102;
...
//
#[no_mangle]
unsafe extern "C" fn fc_frame_drop(lport: *mut fc_lport, fp: *mut fc_frame) -> c_int {
...
//
    ...
    lport.dns_rdata = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(FC_FID_MGMT_SERV: rdata->ids.port_id ==) -> else {
    else if (rdata.ids.port_id == FC_FID_MGMT_SERV)
    lport.ms_rdata = core::ptr::null_mut();
    break;
    case RPORT_EV_NONE:
    break;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_get_host_port_state(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_get_host_speed(shost: *mut Scsi_Host) {
...
//
    ...
    struct fc_lport *lport = shost_priv(shost);
    unsigned int cpu;
    let mut fcp_in_bytes: u64 = 0;
    let mut fcp_out_bytes: u64 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_add_fc4_type(lport: *mut fc_lport, type: enum fc_fh_type) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_recv_rlir_req(lport: *mut fc_lport, fp: *mut fc_frame) {
    static void fc_lport_recv_rlir_req(struct fc_lport *lport, struct fc_frame *fp)
    {
    lockdep_assert_held(&lport.lp_mutex);
    FC_LPORT_DBG(lport, "Received RLIR request while in state %s\n",
    fc_lport_state(lport));
    fc_seq_els_rsp_send(fp, ELS_LS_ACC, core::ptr::null_mut());
    fc_frame_free(fp);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_recv_logo_req(lport: *mut fc_lport, fp: *mut fc_frame) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fabric_login(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __fc_linkup(lport: *mut fc_lport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_linkup(lport: *mut fc_lport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __fc_linkdown(lport: *mut fc_lport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_linkdown(lport: *mut fc_lport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_fabric_logoff(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_lport_destroy(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_set_mfs(lport: *mut fc_lport, mfs: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_ready(lport: *mut fc_lport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_lport_set_local_id(lport: *mut fc_lport, port_id: u32) {
    void fc_lport_set_local_id(struct fc_lport *lport, u32 port_id)
    {
    mutex_lock(&lport.lp_mutex);
    fc_lport_set_port_id(lport, port_id, core::ptr::null_mut());
    switch (lport.state) {
    case LPORT_ST_RESET:
    case LPORT_ST_FLOGI:
    if (port_id)
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_lport_recv(lport: *mut fc_lport, fp: *mut fc_frame) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_lport_reset(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_reset_locked(lport: *mut fc_lport) {
    ...
    fc_rport_logoff(lport.ptp_rdata);
    kref_put(&lport.ptp_rdata.kref, fc_rport_destroy);
    lport.ptp_rdata = core::ptr::null_mut();
    }
    lport.tt.disc_stop(lport);
    lport.tt.exch_mgr_reset(lport, 0, 0);
    fc_host_fabric_name(lport.host) = 0;
    if (lport.port_id && (!lport.point_to_multipoint || !lport.link_up))
    fc_lport_set_port_id(lport, 0, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_reset(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_disabled(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_error(lport: *mut fc_lport, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_scr(lport: *mut fc_lport) {
    ...
    2 * lport.r_a_tov))
    fc_lport_error(lport, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_ns(lport: *mut fc_lport, state: enum fc_lport_state) {
    static void fc_lport_enter_ns(struct fc_lport *lport, enum fc_lport_state state)
    {
    struct fc_frame *fp;
    enum fc_ns_req cmd;
    let mut size: c_int = sizeof(struct fc_ct_hdr);
    size_t len;
    lockdep_assert_held(&lport.lp_mutex);
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_dns(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_ms(lport: *mut fc_lport, state: enum fc_lport_state) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_fdmi(lport: *mut fc_lport) {
    static void fc_lport_enter_fdmi(struct fc_lport *lport)
    {
    struct fc_rport_priv *rdata;
    lockdep_assert_held(&lport.lp_mutex);
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_timeout(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_logo(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_lport_enter_flogi(lport: *mut fc_lport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_lport_config(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_lport_init(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_lport_bsg_request(job: *mut bsg_job) -> c_int {
