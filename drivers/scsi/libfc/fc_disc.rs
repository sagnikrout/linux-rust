...
//! Source: drivers/scsi/libfc/fc_disc.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_stop_rports(disc: *mut fc_disc) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_recv_rscn_req(disc: *mut fc_disc, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_recv_req(lport: *mut fc_lport, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_restart(disc: *mut fc_disc) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_done(disc: *mut fc_disc, event: enum fc_disc_event) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_error(disc: *mut fc_disc, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_gpn_ft_req(disc: *mut fc_disc) {
    ...
    return;
    err:
    fc_disc_error(disc, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_gpn_ft_parse(disc: *mut fc_disc, buf: *mut c_void, len: usize) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_timeout(work: *mut work_struct) {
...
//
    ...
    let mut event: enum fc_disc_event = DISC_EV_NONE;
...
#[no_mangle]
pub unsafe extern "C" fn if(DISC_EV_NONE: event !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(port_name: rdata->ids.port_name !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_single(lport: *mut fc_lport, dp: *mut fc_disc_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_stop(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_disc_stop_final(lport: *mut fc_lport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_disc_config(lport: *mut fc_lport, priv: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_disc_init(lport: *mut fc_lport) {
