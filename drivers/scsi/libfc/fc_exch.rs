...
//! Source: drivers/scsi/libfc/fc_exch.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fc_exch_pool {
    pub lock: spinlock_t,
    pub ex_list: list_head,
    pub next_index: u16,
    pub total_exches: u16,
    pub left: u16,
    pub right: u16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fc_exch_mgr {
    pub pool: *mut fc_exch_pool __percpu,
    pub ep_pool: *mut mempool_t,
    pub lport: *mut fc_lport,
    pub class: enum fc_class,
    pub kref: kref,
    pub min_xid: u16,
    pub max_xid: u16,
    pub pool_max_index: u16,
    struct {
    pub no_free_exch: core::sync::atomic::AtomicI32,
    pub no_free_exch_xid: core::sync::atomic::AtomicI32,
    pub xid_not_found: core::sync::atomic::AtomicI32,
    pub xid_busy: core::sync::atomic::AtomicI32,
    pub seq_not_found: core::sync::atomic::AtomicI32,
    pub non_bls_resp: core::sync::atomic::AtomicI32,
    pub stats: },
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fc_exch_mgr_anchor {
    pub ema_list: list_head,
    pub mp: *mut fc_exch_mgr,
    pub ): *mut *mut bool (match)(struct fc_frame,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_hold(ep: *mut fc_exch) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_release(ep: *mut fc_exch) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_timer_cancel(ep: *mut fc_exch) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_timer_set(ep: *mut fc_exch, timer_msec: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_done_locked(ep: *mut fc_exch) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_delete(ep: *mut fc_exch) {
...
// update cache of free slot
    ...
    pool.left = index;
#[no_mangle]
pub unsafe extern "C" fn if(FC_XID_UNKNOWN: pool->right ==) -> else {
    else if (pool.right == FC_XID_UNKNOWN)
    pool.right = index;
    else
    pool.next_index = index;
    fc_exch_ptr_set(pool, index, core::ptr::null_mut());
    } else {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_seq_send(lport: *mut fc_lport, sp: *mut fc_seq, fp: *mut fc_frame) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_seq_exch_abort(req_sp: *const fc_seq, timer_msec: c_uint) -> c_int {
...
//
    ...
    ep.resp_task = !ep.resp_task ? current : core::ptr::null_mut();
    resp = ep.resp;
    arg = ep.arg;
    spin_unlock_bh(&ep.ex_lock);
    if (resp) {
    ...
    spin_lock_bh(&ep.ex_lock);
    if (--ep.resp_active == 0)
    ep.resp_task = core::ptr::null_mut();
    spin_unlock_bh(&ep.ex_lock);
    if (ep.resp_active == 0)
    wake_up(&ep.resp_wq);
    return res;
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_timeout(work: *mut work_struct) {
    ...
    fc_seq_set_resp(sp, core::ptr::null_mut(), ep.arg);
...
//
    ...
    struct fc_exch_pool *pool;
    struct fc_exch *ep = core::ptr::null_mut();
    let mut cpu: u16 = xid & fc_cpu_mask;
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_done(sp: *mut fc_seq) {
...
//
    ...
    struct fc_frame_header *fh = fc_frame_header_get(fp);
    struct fc_exch *ep = core::ptr::null_mut();
    struct fc_seq *sp = core::ptr::null_mut();
    let mut reject: enum fc_pf_rjt_reason = FC_RJT_NONE;
    u32 f_ctl;
    u16 xid;
    f_ctl = ntoh24(fh.fh_f_ctl);
...
#[no_mangle]
pub unsafe extern "C" fn if(ntohs(fh->fh_rx_id): ep->rxid !=) -> else {
    reject = FC_RJT_OX_ID;
    goto rel;
    }
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn fc_seq_send_ack(sp: *mut fc_seq, rx_fp: *const fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_recv_abts(ep: *mut fc_exch, rx_fp: *mut fc_frame) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_seq_release(sp: *mut fc_seq) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_recv_seq_resp(mp: *mut fc_exch_mgr, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_recv_resp(mp: *mut fc_exch_mgr, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_abts_resp(ep: *mut fc_exch, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_recv_bls(mp: *mut fc_exch_mgr, fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_seq_ls_acc(rx_fp: *mut fc_frame) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_reset(ep: *mut fc_exch) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_mgr_reset(lport: *mut fc_lport, sid: u32, did: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_els_rec(rfp: *mut fc_frame) {
    ...
    let mut reason: enum fc_els_rjt_reason = ELS_RJT_LOGIC;
    enum fc_els_rjt_explan explan;
    u32 sid;
    u16 xid, rxid, oxid;
    lport = fr_dev(rfp);
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_rrq_resp(sp: *mut fc_seq, fp: *mut fc_frame, arg: *mut c_void) {
    static void fc_exch_rrq_resp(struct fc_seq *sp, struct fc_frame *fp, void *arg)
    {
    struct fc_exch *aborted_ep = arg;
    unsigned int op;
    if (IS_ERR(fp)) {
    let mut err: c_int = PTR_ERR(fp);
...
//
    ...
    struct fc_seq *sp = core::ptr::null_mut();
    struct fc_frame_header *fh;
    struct fc_fcp_pkt *fsp = core::ptr::null_mut();
    let mut rc: c_int = 1;
    ep = fc_exch_alloc(lport, fp);
    if (!ep) {
    fc_frame_free(fp);
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_rrq(ep: *mut fc_exch) {
    ...
    if (fc_exch_seq_send(lport, fp, fc_exch_rrq_resp, core::ptr::null_mut(), ep,
    lport.e_d_tov))
    return;
    retry:
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_els_rrq(fp: *mut fc_frame) {
    static void fc_exch_els_rrq(struct fc_frame *fp)
    {
    struct fc_lport *lport;
    struct fc_exch *ep = core::ptr::null_mut();	/* request or subject exchange */
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_update_stats(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_exch_mgr_destroy(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_mgr_del(ema: *mut fc_exch_mgr_anchor) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_mgr_list_clone(src: *mut fc_lport, dst: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_mgr_free(lport: *mut fc_lport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_recv(lport: *mut fc_lport, fp: *mut fc_frame) {
...
#[no_mangle]
pub unsafe extern "C" fn if(FC_FC_SEQ_CTX: f_ctl &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_exch_init(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_setup_exch_mgr() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_destroy_exch_mgr() {
