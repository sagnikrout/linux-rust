...
//! Source: drivers/scsi/libfc/fc_rport.c
#![no_std]
...
//
    ...
    u32 port_id)
    {
    struct fc_rport_priv *rdata = core::ptr::null_mut(), *tmp_rdata;
    rcu_read_lock();
...
//
    ...
    let mut rport_priv_size: usize = sizeof(*rdata);
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_rport_destroy(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_set_rport_loss_tmo(rport: *mut fc_rport, timeout: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_rport_login(rdata: *mut fc_rport_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_rport_logoff(rdata: *mut fc_rport_priv) -> c_int {
    int fc_rport_logoff(struct fc_rport_priv *rdata)
    {
    struct fc_lport *lport = rdata.local_port;
    let mut port_id: u32 = rdata.ids.port_id;
    mutex_lock(&rdata.rp_mutex);
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_enter_ready(rdata: *mut fc_rport_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_timeout(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_error(rdata: *mut fc_rport_priv, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_error_retry(rdata: *mut fc_rport_priv, err: c_int) {
    static void fc_rport_error_retry(struct fc_rport_priv *rdata, int err)
    {
    let mut delay: c_ulong = msecs_to_jiffies(rdata.e_d_tov);
    lockdep_assert_held(&rdata.rp_mutex);
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_enter_flogi(rdata: *mut fc_rport_priv) {
...
//
    ...
    struct fc_lport *lport = rdata.local_port;
    struct fc_els_flogi *plp = core::ptr::null_mut();
    u16 csp_seq;
    u16 cssp_seq;
    u8 op;
    ...
    if (op == ELS_LS_ACC &&
    (plp = fc_frame_payload_get(fp, sizeof(*plp))) != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_enter_plogi(rdata: *mut fc_rport_priv) {
...
//
    ...
    struct fc_els_ls_rjt *rjt;
    struct fc4_prov *prov;
    let mut roles: u32 = FC_RPORT_ROLE_UNKNOWN;
    let mut fcp_parm: u32 = 0;
    u8 op;
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_enter_prli(rdata: *mut fc_rport_priv) {
...
//
    ...
    if (prov) {
    pp = fc_frame_payload_get(fp, sizeof(*pp));
    prov.prli(rdata, sizeof(pp.spp), core::ptr::null_mut(), &pp.spp);
    }
    ...
    core::ptr::null_mut(), rdata, 2 * lport.r_a_tov)) {
    fc_rport_error_retry(rdata, -FC_EX_XMIT_ERR);
    kref_put(&rdata.kref, fc_rport_destroy);
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_enter_rtv(rdata: *mut fc_rport_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_enter_logo(rdata: *mut fc_rport_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_enter_adisc(rdata: *mut fc_rport_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_recv_els_req(lport: *mut fc_lport, fp: *mut fc_frame) {
    ...
    break;
    case ELS_RRQ:
    fc_seq_els_rsp_send(fp, ELS_RRQ, core::ptr::null_mut());
    fc_frame_free(fp);
    break;
    case ELS_REC:
    fc_seq_els_rsp_send(fp, ELS_REC, core::ptr::null_mut());
    fc_frame_free(fp);
    break;
    case ELS_RLS:
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_rport_recv_req(lport: *mut fc_lport, fp: *mut fc_frame) {
...
//
    ...
    let mut active: enum fc_els_spp_resp = 0, passive = 0;
...
//
#[no_mangle]
unsafe extern "C" fn fc_rport_recv_logo_req(lport: *mut fc_lport, fp: *mut fc_frame) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_rport_flush_queue() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_setup_rport() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_destroy_rport() {
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_rport_terminate_io(rport: *mut fc_rport) {
