...
//! Source: drivers/scsi/libfc/fc_elsct.c
#![no_std]
...
// CT requests
    ...
    FC_FCTL_REQ, 0);
    return fc_exch_seq_send(lport, fp, resp, core::ptr::null_mut(), arg, timer_msec);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn fc_elsct_init(lport: *mut fc_lport) -> c_int {
