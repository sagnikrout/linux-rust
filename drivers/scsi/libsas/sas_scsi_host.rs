...
//! Source: drivers/scsi/libsas/sas_scsi_host.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sas_end_task(sc: *mut scsi_cmnd, task: *mut sas_task) {
    static void sas_end_task(struct scsi_cmnd *sc, struct sas_task *task)
    {
    struct task_status_struct *ts = &task.task_status;
    let mut hs: enum scsi_host_status = DID_OK;
    let mut stat: enum exec_status = SAS_SAM_STAT_GOOD;
...
// task delivered, what happened afterwards?
    ...
    ASSIGN_SAS_TASK(sc, core::ptr::null_mut());
    sas_free_task(task);
    }
#[no_mangle]
unsafe extern "C" fn sas_scsi_task_done(task: *mut sas_task) {
...
// If the device fell off, no sense in issuing commands
    ...
    ASSIGN_SAS_TASK(cmd, core::ptr::null_mut());
    sas_free_task(task);
...
#[no_mangle]
unsafe extern "C" fn sas_eh_finish_cmd(cmd: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn sas_scsi_clear_queue_lu(error_q: *mut list_head, my_cmd: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn sas_scsi_find_task(task: *mut sas_task) -> enum task_disposition {
...
#[no_mangle]
unsafe extern "C" fn sas_recover_lu(dev: *mut domain_device, cmd: *mut scsi_cmnd) -> c_int {
    static int sas_recover_lu(struct domain_device *dev, struct scsi_cmnd *cmd)
    {
    let mut res: c_int = TMF_RESP_FUNC_FAILED;
    struct scsi_lun lun;
...
#[no_mangle]
unsafe extern "C" fn sas_recover_I_T(dev: *mut domain_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_queue_reset(dev: *mut domain_device, reset_type: c_int, lun: u64) -> c_int {
    static int sas_queue_reset(struct domain_device *dev, int reset_type, u64 lun)
    {
    struct sas_ha_struct *ha = dev.port.ha;
    let mut scheduled: c_int = 0, tries = 100;
...
#[no_mangle]
pub unsafe extern "C" fn sas_eh_abort_handler(cmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_eh_device_reset_handler(cmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_eh_target_reset_handler(cmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sas_eh_timed_out(cmd: *mut scsi_cmnd) -> enum scsi_timeout_action {
...
#[no_mangle]
unsafe extern "C" fn try_to_reset_cmd_device(cmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_eh_handle_sas_errors(shost: *mut Scsi_Host, work_q: *mut list_head) {
    static void sas_eh_handle_sas_errors(struct Scsi_Host *shost, struct list_head *work_q)
    {
    struct scsi_cmnd *cmd, *n;
    let mut res: enum task_disposition = TASK_IS_DONE;
...
#[no_mangle]
unsafe extern "C" fn sas_eh_handle_resets(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_scsi_recover_host(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_ioctl(sdev: *mut scsi_device, cmd: c_uint, arg: *mut void __user) -> c_int {
    ...
    struct sas_ha_struct *ha = SHOST_TO_SAS_HA(shost);
    struct domain_device *found_dev = core::ptr::null_mut();
    int i;
    unsigned long flags;
    spin_lock_irqsave(&ha.phy_port_lock, flags);
...
#[no_mangle]
pub unsafe extern "C" fn sas_target_alloc(starget: *mut scsi_target) -> c_int {
...
pub const SAS_DEF_QD: c_int = 256;
#[no_mangle]
pub unsafe extern "C" fn sas_sdev_configure(scsi_dev: *mut scsi_device, lim: *mut queue_limits) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_change_queue_depth(sdev: *mut scsi_device, depth: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_task_internal_done(task: *mut sas_task) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_task_internal_timedout(t: *mut timer_list) {
...
// Even if the internal abort timed out, return direct.
    ...
    BUG_ON(retry == TASK_RETRY && task != core::ptr::null_mut());
    sas_free_task(task);
    return res;
    }
...
#[no_mangle]
pub unsafe extern "C" fn sas_abort_task_set(dev: *mut domain_device, lun: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_clear_task_set(dev: *mut domain_device, lun: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_lu_reset(dev: *mut domain_device, lun: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_query_task(task: *mut sas_task, tag: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_abort_task(task: *mut sas_task, tag: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sas_task_abort(task: *mut sas_task) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_sdev_init(sdev: *mut scsi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_target_destroy(starget: *mut scsi_target) {
...
pub const SAS_STRING_ADDR_SIZE: c_int = 16;
#[no_mangle]
pub unsafe extern "C" fn sas_request_addr(shost: *mut Scsi_Host, addr: *mut u8) -> c_int {
