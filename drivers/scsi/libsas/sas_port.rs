...
//! Source: drivers/scsi/libsas/sas_port.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn phy_is_wideport_member(port: *mut asd_sas_port, phy: *mut asd_sas_phy) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sas_resume_port(phy: *mut asd_sas_phy) {
...
//
#[no_mangle]
unsafe extern "C" fn sas_form_port(phy: *mut asd_sas_phy) {
    static void sas_form_port(struct asd_sas_phy *phy)
    {
    int i;
    struct sas_ha_struct *sas_ha = phy.ha;
    struct asd_sas_port *port = phy.port;
    struct domain_device *port_dev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: phy->suspended) -> else {
    phy.suspended = 0;
    sas_resume_port(phy);
...
//
#[no_mangle]
pub unsafe extern "C" fn sas_deform_port(phy: *mut asd_sas_phy, gone: bool) {
    ...
    sas_phy_set_target(phy, core::ptr::null_mut());
...
// ---------- SAS port events ----------
#[no_mangle]
pub unsafe extern "C" fn sas_porte_bytes_dmaed(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_porte_broadcast_rcvd(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_porte_link_reset_err(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_porte_timer_event(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_porte_hard_reset(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_register_ports(sas_ha: *mut sas_ha_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_unregister_ports(sas_ha: *mut sas_ha_struct) {
