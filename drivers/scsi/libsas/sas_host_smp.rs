...
//! Source: drivers/scsi/libsas/sas_host_smp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn try_test_sas_gpio_gp_bit(od: c_uint, data: *mut u8, index: u8, count: u8) -> c_int {
    ...
    int written;
    if (i.dft.lldd_write_gpio == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_smp_host_handler(job: *mut bsg_job, shost: *mut Scsi_Host) {
...
// SFF-8485 v0.7
    let mut base_frame_size: c_int = 11;
    let mut to_write: c_int = req_data[4];
