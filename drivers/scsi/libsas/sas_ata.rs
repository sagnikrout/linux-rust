...
//! Source: drivers/scsi/libsas/sas_ata.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sas_to_ata_err(ts: *mut task_status_struct) -> enum ata_completion_errors {
...
#[no_mangle]
unsafe extern "C" fn sas_ata_task_done(task: *mut sas_task) {
...
#[no_mangle]
pub unsafe extern "C" fn if(qc->scsicmd: qc &&) -> else {
    else if (qc && qc.scsicmd)
    ASSIGN_SAS_TASK(qc.scsicmd, core::ptr::null_mut());
...
// We saw a SAS error. Send a vague error.
    ...
    qc.lldd_task = core::ptr::null_mut();
    ata_qc_complete(qc);
    spin_unlock_irqrestore(ap.lock, flags);
    qc_already_gone:
    sas_free_task(task);
...
#[no_mangle]
unsafe extern "C" fn sas_ata_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int sas_ata_qc_issue(struct ata_queued_cmd *qc)
    __must_hold(ap.lock)
    {
    struct sas_task *task;
    struct scatterlist *sg;
    let mut ret: c_int = AC_ERR_SYSTEM;
...
#[no_mangle]
unsafe extern "C" fn sas_ata_qc_fill_rtf(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn sas_get_ata_command_set(dev: *mut domain_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_get_ata_info(dev: *mut domain_device, phy: *mut ex_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_ata_clear_pending(dev: *mut domain_device, phy: *mut ex_phy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn smp_ata_check_ready_type(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smp_ata_check_ready(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn local_ata_check_ready(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_ata_wait_after_reset(dev: *mut domain_device, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sas_ata_internal_abort(task: *mut sas_task) {
...
#[no_mangle]
unsafe extern "C" fn sas_ata_post_internal(qc: *mut ata_queued_cmd) {
...
//
    ...
    if (!task)
    return;
    task.uldd_task = core::ptr::null_mut();
    sas_ata_internal_abort(task);
    }
    }
#[no_mangle]
unsafe extern "C" fn sas_ata_set_dmamode(ap: *mut ata_port, ata_dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn sas_ata_sched_eh(ap: *mut ata_port) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_ata_end_eh(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sas_ata_prereset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_ata_init(found_dev: *mut domain_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_ata_task_abort(task: *mut sas_task) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_probe_sata(port: *mut asd_sas_port) {
...
#[no_mangle]
unsafe extern "C" fn sas_ata_flush_pm_eh(port: *mut asd_sas_port, func: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_suspend_sata(port: *mut asd_sas_port) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_resume_sata(port: *mut asd_sas_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sas_discover_sata(dev: *mut domain_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn async_sas_ata_eh(data: *mut c_void, cookie: async_cookie_t) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_ata_strategy_handler(shost: *mut Scsi_Host) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_ata_eh(shost: *mut Scsi_Host, work_q: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_ata_schedule_reset(dev: *mut domain_device) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_ata_wait_eh(dev: *mut domain_device) {
    void sas_ata_wait_eh(struct domain_device *dev)
    {
    ata_port_wait_eh(dev.sata_dev.ap);
    }
#[no_mangle]
pub unsafe extern "C" fn sas_ata_device_link_abort(device: *mut domain_device, force_reset: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_execute_ata_cmd(device: *mut domain_device, fis: *mut u8, force_phy_id: c_int) -> c_int {
    int sas_execute_ata_cmd(struct domain_device *device, u8 *fis, int force_phy_id)
    {
    let mut tmf_task: sas_tmf_task = {};
    ...
    __ATTR(ncq_prio_supported, S_IRUGO, sas_ncq_prio_supported_show, core::ptr::null_mut());
