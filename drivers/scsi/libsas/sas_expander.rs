...
//! Source: drivers/scsi/libsas/sas_expander.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sas_port_add_ex_phy(port: *mut sas_port, ex_phy: *mut ex_phy) {
...
#[no_mangle]
unsafe extern "C" fn sas_ex_add_parent_port(dev: *mut domain_device, phy_id: c_int) {
...
// underrun
    ...
    BUG_ON(retry == 3 && task != core::ptr::null_mut());
    sas_free_task(task);
    return res;
    }
...
#[no_mangle]
unsafe extern "C" fn sas_route_char(dev: *mut domain_device, phy: *mut ex_phy) -> c_char {
...
#[no_mangle]
unsafe extern "C" fn to_dev_type(dr: *mut discover_resp) -> enum sas_device_type {
...
pub const DISCOVER_REQ_SIZE: c_int = 16;
...
#[no_mangle]
pub unsafe extern "C" fn sas_ex_phy_discover(dev: *mut domain_device, single: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_expander_discover(dev: *mut domain_device) -> c_int {
    ...
    out_err:
    kfree(ex.ex_phy);
    ex.ex_phy = core::ptr::null_mut();
    return res;
    }
pub const MAX_EXPANDER_PHYS: c_int = 128;
pub const RG_REQ_SIZE: c_int = 8;

#[no_mangle]
unsafe extern "C" fn sas_ex_general(dev: *mut domain_device) -> c_int {
...
pub const MI_REQ_SIZE: c_int = 8;
pub const MI_RESP_SIZE: c_int = 64;
#[no_mangle]
unsafe extern "C" fn sas_ex_manuf_info(dev: *mut domain_device) -> c_int {
...
pub const PC_REQ_SIZE: c_int = 44;
pub const PC_RESP_SIZE: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn sas_ex_disable_phy(dev: *mut domain_device, phy_id: c_int) {
    static void sas_ex_disable_phy(struct domain_device *dev, int phy_id)
    {
    struct expander_device *ex = &dev.ex_dev;
    struct ex_phy *phy = &ex.ex_phy[phy_id];
    sas_smp_phy_control(dev, phy_id, PHY_FUNC_DISABLE, core::ptr::null_mut());
    phy.linkrate = SAS_PHY_DISABLED;
    }
#[no_mangle]
unsafe extern "C" fn sas_ex_disable_port(dev: *mut domain_device, sas_addr: *mut u8) {
...
pub const RPEL_REQ_SIZE: c_int = 16;
pub const RPEL_RESP_SIZE: c_int = 32;
#[no_mangle]
pub unsafe extern "C" fn sas_smp_get_phy_events(phy: *mut sas_phy) -> c_int {
...
pub const RPS_REQ_SIZE: c_int = 16;
...
// reversal here
    ...
    struct domain_device *child = core::ptr::null_mut();
    int res;
...
#[no_mangle]
unsafe extern "C" fn sas_ex_join_wide_port(parent: *mut domain_device, phy_id: c_int) -> bool {
...
// FIXME: better error handling
    ...
    break;
    default:
    rphy = core::ptr::null_mut();	/* shut gcc up */
    BUG();
    }
    port = parent.port;
    child.rphy = rphy;
...
#[no_mangle]
unsafe extern "C" fn sas_ex_discover_dev(dev: *mut domain_device, phy_id: c_int) -> c_int {
...
// Phy state
    ...
    if (!sas_smp_phy_control(dev, phy_id, PHY_FUNC_LINK_RESET, core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn sas_find_sub_addr(dev: *mut domain_device, sub_addr: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_check_level_subtractive_boundary(dev: *mut domain_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sas_ex_discover_devices(dev: *mut domain_device, single: c_int) -> c_int {
    static int sas_ex_discover_devices(struct domain_device *dev, int single)
    {
    struct expander_device *ex = &dev.ex_dev;
    let mut i: c_int = 0, end = ex.num_phys;
    let mut res: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn sas_check_ex_subtractive_boundary(dev: *mut domain_device) -> c_int {
    static int sas_check_ex_subtractive_boundary(struct domain_device *dev)
    {
    struct expander_device *ex = &dev.ex_dev;
    int i;
    u8  *sub_sas_addr = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(TABLE_ROUTING: child_phy->routing_attr !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn sas_check_parent_topology(child: *mut domain_device) -> c_int {
...
pub const RRI_REQ_SIZE: c_int = 16;
pub const RRI_RESP_SIZE: c_int = 44;
...
pub const CRI_REQ_SIZE: c_int = 44;
pub const CRI_RESP_SIZE: c_int = 8;
...
//
#[no_mangle]
unsafe extern "C" fn sas_configure_routing(dev: *mut domain_device, sas_addr: *mut u8) -> c_int {
    static int sas_configure_routing(struct domain_device *dev, u8 *sas_addr)
    {
    if (dev.parent)
...
#[no_mangle]
unsafe extern "C" fn sas_disable_routing(dev: *mut domain_device, sas_addr: *mut u8) -> c_int {
    static int sas_disable_routing(struct domain_device *dev,  u8 *sas_addr)
    {
    if (dev.parent)
...
//
#[no_mangle]
unsafe extern "C" fn sas_discover_expander(dev: *mut domain_device) -> c_int {
    static int sas_discover_expander(struct domain_device *dev)
    {
    int res;
...
#[no_mangle]
unsafe extern "C" fn sas_ex_level_discovery(port: *mut asd_sas_port, level: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: level >) -> else {
    else if (level > 0)
...
#[no_mangle]
unsafe extern "C" fn sas_ex_bfs_disc(port: *mut asd_sas_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sas_discover_root_expander(dev: *mut domain_device) -> c_int {
...
// pcc = disc_resp->disc.change_count;
    ...
    let mut phy_change_count: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn sas_get_ex_change_count(dev: *mut domain_device, ecc: *mut c_int) -> c_int {
...
//
    ...
    {
    struct expander_device *ex = &dev.ex_dev;
    let mut ex_change_count: c_int = -1;
    let mut phy_id: c_int = -1;
    int res;
...
#[no_mangle]
unsafe extern "C" fn sas_unregister_ex_tree(port: *mut asd_sas_port, dev: *mut domain_device) {
    ...
    struct domain_device *child, *n, *found = core::ptr::null_mut();
    if (last) {
    ...
    ex_dev.parent_port = core::ptr::null_mut();
    }
    phy.port = core::ptr::null_mut();
    }
    }
    ...
    level);
#[no_mangle]
pub unsafe extern "C" fn if(ex->level: level ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sas_discover_bfs_by_root(dev: *mut domain_device) -> c_int {
    static int sas_discover_bfs_by_root(struct domain_device *dev)
    {
    int res;
    struct sas_expander_device *ex = rphy_to_expander_device(dev.rphy);
    let mut level: c_int = ex.level+1;
    res = sas_ex_discover_devices(dev, -1);
    if (res)
    goto out;
    do {
...
#[no_mangle]
unsafe extern "C" fn sas_discover_new(dev: *mut domain_device, phy_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dev_type_flutter(new: enum sas_device_type, old: enum sas_device_type) -> bool {
...
//
    ...
    struct expander_device *ex = &dev.ex_dev;
    struct ex_phy *phy = &ex.ex_phy[phy_id];
    let mut type: enum sas_device_type = SAS_PHY_UNUSED;
    struct smp_disc_resp *disc_resp;
    u8 sas_addr[SAS_ADDR_SIZE];
    char msg[80] = "";
    int res;
...
//
#[no_mangle]
unsafe extern "C" fn sas_rediscover(dev: *mut domain_device, phy_id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sas_ex_revalidate_domain(port_dev: *mut domain_device) -> c_int {
    int sas_ex_revalidate_domain(struct domain_device *port_dev)
    {
    int res;
    struct domain_device *dev = core::ptr::null_mut();
    res = sas_find_bcast_dev(port_dev, &dev);
    if (res == 0 && dev) {
    struct expander_device *ex = &dev.ex_dev;
    let mut i: c_int = 0, phy_id;
    do {
    phy_id = -1;
