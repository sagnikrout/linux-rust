...
//! Source: drivers/scsi/libsas/sas_init.c
#![no_std]
...
//
    ...
    task.slow_task = slow;
    slow.task = task;
    timer_setup(&slow.timer, core::ptr::null_mut(), 0);
    init_completion(&slow.completion);
    return task;
    }
#[no_mangle]
pub unsafe extern "C" fn sas_free_task(task: *mut sas_task) {
...
// ------------ SAS addr hash -----------
#[no_mangle]
pub unsafe extern "C" fn sas_hash_addr(hashed: *mut u8, sas_addr: *const u8) {
    void sas_hash_addr(u8 *hashed, const u8 *sas_addr)
    {
    let mut poly: u32 = 0x00DB2777;
    let mut r: u32 = 0;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn sas_register_ha(sas_ha: *mut sas_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_disable_events(sas_ha: *mut sas_ha_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_unregister_ha(sas_ha: *mut sas_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_get_linkerrors(phy: *mut sas_phy) -> c_int {
    ...
    return i.dft.lldd_control_phy(asd_phy, PHY_FUNC_GET_EVENTS, core::ptr::null_mut());
    }
    return sas_smp_get_phy_events(phy);
    }
#[no_mangle]
pub unsafe extern "C" fn sas_try_ata_reset(asd_phy: *mut asd_sas_phy) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn transport_sas_phy_reset(phy: *mut sas_phy, hard_reset: c_int) -> c_int {
    ...
    return 0;
    return i.dft.lldd_control_phy(asd_phy, reset_type, core::ptr::null_mut());
    } else {
    ...
    return sas_smp_phy_control(ddev, phy.number, reset_type, core::ptr::null_mut());
    }
    }
#[no_mangle]
pub unsafe extern "C" fn sas_phy_enable(phy: *mut sas_phy, enable: c_int) -> c_int {
    ...
    ret = i.dft.lldd_control_phy(asd_phy, cmd, core::ptr::null_mut());
    } else {
    struct sas_rphy *rphy = dev_to_rphy(phy.dev.parent);
    struct domain_device *ddev = sas_find_dev_by_rphy(rphy);
    if (enable)
    ...
    ret = sas_smp_phy_control(ddev, phy.number, cmd, core::ptr::null_mut());
    }
    return ret;
    }
    EXPORT_SYMBOL_GPL(sas_phy_enable);
#[no_mangle]
pub unsafe extern "C" fn sas_phy_reset(phy: *mut sas_phy, hard_reset: c_int) -> c_int {
    ...
    struct sas_internal *i =
    to_sas_internal(sas_ha.shost.transportt);
    ret = i.dft.lldd_control_phy(asd_phy, reset_type, core::ptr::null_mut());
    } else {
    struct sas_rphy *rphy = dev_to_rphy(phy.dev.parent);
    struct domain_device *ddev = sas_find_dev_by_rphy(rphy);
    ret = sas_smp_phy_control(ddev, phy.number, reset_type, core::ptr::null_mut());
    }
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn sas_prep_resume_ha(ha: *mut sas_ha_struct) {
...
#[no_mangle]
unsafe extern "C" fn phys_suspended(ha: *mut sas_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sas_resume_insert_broadcast_ha(ha: *mut sas_ha_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn sas_resume_ha(ha: *mut sas_ha_struct) {
    void sas_resume_ha(struct sas_ha_struct *ha)
    {
    let mut tmo: c_ulong = msecs_to_jiffies(25000);
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn sas_suspend_ha(ha: *mut sas_ha_struct) {
...
#[no_mangle]
unsafe extern "C" fn sas_phy_release(phy: *mut sas_phy) {
    static void sas_phy_release(struct sas_phy *phy)
    {
    kfree(phy.hostdata);
    phy.hostdata = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn phy_reset_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn phy_enable_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sas_phy_setup(phy: *mut sas_phy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_phy_reset(phy: *mut sas_phy, hard_reset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn queue_phy_enable(phy: *mut sas_phy, enable: c_int) -> c_int {
...
// libsas workqueue coordinates ata-eh reset with discovery
    ...
    struct Scsi_Host *shost = class_to_shost(dev);
    struct sas_ha_struct *sha = SHOST_TO_SAS_HA(shost);
    sha.event_thres = simple_strtol(buf, core::ptr::null_mut(), 10);
...
#[no_mangle]
pub unsafe extern "C" fn sas_free_event(event: *mut asd_sas_event) {
...
#[no_mangle]
unsafe extern "C" fn sas_class_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn sas_class_exit() -> void __exit {
