...
//! Source: drivers/scsi/megaraid/megaraid_sas_base.c
#![no_std]
...
//
    ...
    let mut throttlequeuedepth: static unsigned int = MEGASAS_THROTTLE_QUEUE_DEPTH;
    module_param(throttlequeuedepth, int, 0444);
    MODULE_PARM_DESC(throttlequeuedepth,
    "Adapter queue depth when throttled due to I/O timeout. Default: 16");
    let mut resetwaittime: c_uint = MEGASAS_RESET_WAIT_TIME;
    module_param(resetwaittime, int, 0444);
    MODULE_PARM_DESC(resetwaittime, "Wait time in (1-180s) after I/O timeout before resetting adapter. Default: 180s");
    let mut smp_affinity_enable: static int = 1;
    module_param(smp_affinity_enable, int, 0444);
    MODULE_PARM_DESC(smp_affinity_enable, "SMP affinity feature enable/disable Default: enable(1)");
    let mut rdpq_enable: static int = 1;
    module_param(rdpq_enable, int, 0444);
    MODULE_PARM_DESC(rdpq_enable, "Allocate reply queue in chunks for large queue depth enable/disable Default: enable(1)");
    unsigned int dual_qdepth_disable;
    module_param(dual_qdepth_disable, int, 0444);
    MODULE_PARM_DESC(dual_qdepth_disable, "Disable dual queue depth feature. Default: 0");
    let mut scmd_timeout: static unsigned int = MEGASAS_DEFAULT_CMD_TIMEOUT;
    module_param(scmd_timeout, int, 0444);
    MODULE_PARM_DESC(scmd_timeout, "scsi command timeout (10-90s), default 90s. See megasas_reset_timer.");
    let mut perf_mode: static int = -1;
    ...
    let mut event_log_level: static int = MFI_EVT_CLASS_CRITICAL;
    ...
    let mut host_tagset_enable: static int = 1;
...
// instance)
    {
    unsigned long flags;
    struct megasas_cmd *cmd = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(DMA_FROM_DEVICE: scp->sc_data_direction ==) -> else {
    else if (scp.sc_data_direction == DMA_FROM_DEVICE)
    flags = MFI_FRAME_DIR_READ;
#[no_mangle]
pub unsafe extern "C" fn if(DMA_NONE: scp->sc_data_direction ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(10: scp->cmd_len ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(12: scp->cmd_len ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(16: scp->cmd_len ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn megasas_cmd_type(cmd: *mut scsi_cmnd) -> c_int {
...
//
    ...
    struct megasas_pthru_frame *pthru;
    u32 sgcount;
    let mut max_cmd: u16 = instance.max_fw_cmds;
...
//
    ...
    {
    u8 interface_type;
    let mut device_qd: u32 = MEGASAS_DEFAULT_CMD_PER_LUN;
    u32 tgt_device_qd;
    struct megasas_instance *instance;
    struct MR_PRIV_DEVICE *mr_device_priv_data;
    instance = megasas_lookup_instance(sdev.host.host_no);
...
//
    ...
    struct queue_limits *lim, bool is_target_prop)
    {
    let mut max_io_size_kb: u32 = MR_DEFAULT_NVME_MDTS_KB;
    struct megasas_instance *instance;
    instance = megasas_lookup_instance(sdev.host.host_no);
//
...
//
    ...
    {
    let mut pd_index: u16 = 0;
    struct megasas_instance *instance;
    let mut ret_target_prop: c_int = DCMD_FAILED;
    let mut is_target_prop: bool = false;
    instance = megasas_lookup_instance(sdev.host.host_no);
...
#[no_mangle]
unsafe extern "C" fn megasas_sdev_init(sdev: *mut scsi_device) -> c_int {
    static int megasas_sdev_init(struct scsi_device *sdev)
    {
    let mut pd_index: u16 = 0, ld_tgt_id;
    struct megasas_instance *instance ;
    struct MR_PRIV_DEVICE *mr_device_priv_data;
    instance = megasas_lookup_instance(sdev.host.host_no);
    if (!MEGASAS_IS_LOGICAL(sdev)) {
...
#[no_mangle]
unsafe extern "C" fn megasas_sdev_destroy(sdev: *mut scsi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_complete_outstanding_ioctls(instance: *mut megasas_instance) {
...
#[no_mangle]
pub unsafe extern "C" fn megaraid_sas_kill_hba(instance: *mut megasas_instance) {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_complete_cmd_dpc(instance_addr: c_ulong) {
    static void megasas_complete_cmd_dpc(unsigned long instance_addr)
    {
    u32 producer;
    u32 consumer;
...
//
#[no_mangle]
pub unsafe extern "C" fn megasas_start_timer(instance: *mut megasas_instance) {
...
#[no_mangle]
unsafe extern "C" fn megasas_do_ocr(instance: *mut megasas_instance) {
...
// instance->consumer = cpu_to_le32(MEGASAS_ADPRESET_INPROG_SIGN);
    ...
    struct megasas_cmd *cmd;
    struct megasas_dcmd_frame *dcmd;
    struct MR_LD_VF_AFFILIATION_111 *new_affiliation_111 = core::ptr::null_mut();
    ...
    struct megasas_cmd *cmd;
    struct megasas_dcmd_frame *dcmd;
    struct MR_LD_VF_AFFILIATION *new_affiliation = core::ptr::null_mut();
    struct MR_LD_VF_MAP *newmap = core::ptr::null_mut(), *savedmap = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn megasas_sriov_heartbeat_handler(t: *mut timer_list) {
    static void megasas_sriov_heartbeat_handler(struct timer_list *t)
    {
    struct megasas_instance *instance =
...
//
#[no_mangle]
unsafe extern "C" fn megasas_wait_for_outstanding(instance: *mut megasas_instance) -> c_int {
    static int megasas_wait_for_outstanding(struct megasas_instance *instance)
    {
    int i, sl, outstanding;
    u32 reset_index;
    let mut wait_time: u32 = MEGASAS_RESET_WAIT_TIME;
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn megasas_generic_reset(scmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_reset_timer(scmd: *mut scsi_cmnd) -> enum scsi_timeout_action {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_reset_bus_host(scmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_task_abort(scmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_reset_target(scmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn megasas_map_queues(shost: *mut Scsi_Host) {
    static void megasas_map_queues(struct Scsi_Host *shost)
    {
    struct megasas_instance *instance;
    let mut qoff: c_int = 0, offset;
...
//
    ...
    cmd.abort_aen = 0;
    instance.aen_cmd = core::ptr::null_mut();
    megasas_return_cmd(instance, cmd);
    ...
    (struct megasas_instance *) shost.hostdata;
    u32 size;
    let mut dmachunk: c_ulong = CRASH_DMA_BUF_SIZE;
    ...
    (struct megasas_instance *) shost.hostdata;
#[no_mangle]
pub unsafe extern "C" fn snprintf(_arg: buf, _arg: PAGE_SIZE, _arg: "%ld\n", long: (unsigned) -> return {
...
// flag for the retry reset
    ...
    if (cmd.scmd)
    megasas_priv(cmd.scmd).cmd_priv = core::ptr::null_mut();
    switch (hdr.cmd) {
...
// Check for LD map update
    ...
    instance.map_update_cmd = core::ptr::null_mut();
...
// FW has an updated PD sequence
    ...
    spin_lock_irqsave(instance.host.host_lock, flags);
    status = cmd.frame.hdr.cmd_status;
    instance.jbod_seq_cmd = core::ptr::null_mut();
    megasas_return_cmd(instance, cmd);
    if (status == MFI_STAT_OK) {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_isr(irq: c_int, devp: *mut c_void) -> irqreturn_t {
    static irqreturn_t megasas_isr(int irq, void *devp)
    {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_teardown_frame_pool(instance: *mut megasas_instance) {
    static void megasas_teardown_frame_pool(struct megasas_instance *instance)
    {
    int i;
    let mut max_cmd: u16 = instance.max_mfi_cmds;
    struct megasas_cmd *cmd;
...
//
    ...
    instance.frame_dma_pool = core::ptr::null_mut();
    instance.sense_dma_pool = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn megasas_create_frame_pool(instance: *mut megasas_instance) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn megasas_free_cmds(instance: *mut megasas_instance) {
...
// Free the cmd_list buffer itself
    ...
    instance.cmd_list = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn megasas_alloc_cmds(instance: *mut megasas_instance) -> c_int {
...
//
    ...
    {
    let mut ret: c_int = 0, pd_index = 0;
    struct megasas_cmd *cmd;
    struct megasas_dcmd_frame *dcmd;
...
//
    ...
    {
    let mut ret: c_int = 0, ld_index = 0, ids = 0;
    struct megasas_cmd *cmd;
    struct megasas_dcmd_frame *dcmd;
    struct MR_LD_LIST *ci;
    let mut ci_h: dma_addr_t = 0;
    u32 ld_count;
...
//
#[no_mangle]
unsafe extern "C" fn megasas_update_ext_vd_details(instance: *mut megasas_instance) {
    static void megasas_update_ext_vd_details(struct megasas_instance *instance)
    {
    struct fusion_context *fusion;
    let mut ventura_map_sz: u32 = 0;
    fusion = instance.ctrl_context;
...
//
#[no_mangle]
pub unsafe extern "C" fn megasas_get_snapdump_properties(instance: *mut megasas_instance) {
...
//
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn megasas_setup_irq_poll(instance: *mut megasas_instance) {
...
// Try MSI-x
    ...
    pci_irq_vector(pdev, j), core::ptr::null_mut());
...
//
    ...
    irq_update_affinity_hint(
    pci_irq_vector(instance.pdev, i), core::ptr::null_mut());
...
//
    ...
    fusion.pd_seq_sync[0] = core::ptr::null_mut();
    }
    instance.use_seqnum_jbod_fp = false;
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn megasas_setup_reply_map(instance: *mut megasas_instance) {
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn megasas_get_device_list(instance: *mut megasas_instance) -> c_int {
...
//
    ...
    let mut nid: c_int = dev_to_node(&instance.pdev.dev);
    if (nid == NUMA_NO_NODE)
    nid = 0;
    ...
    {
    int i, irq_flags;
    let mut desc: irq_affinity = { .pre_vectors = instance.low_latency_index_start };
    struct irq_affinity *descp = &desc;
    irq_flags = PCI_IRQ_MSIX;
    if (instance.smp_affinity_enable)
    irq_flags |= PCI_IRQ_AFFINITY | PCI_IRQ_ALL_TYPES;
    else
    descp = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn megasas_init_fw(instance: *mut megasas_instance) -> c_int {
    ...
    void *base_addr_phys;
    struct megasas_ctrl_info *ctrl_info = core::ptr::null_mut();
...
// stream detection initialization
    ...
    fusion.stream_detect_by_ld = core::ptr::null_mut();
    goto fail_get_ld_pd_list;
    }
...
//
    ...
    instance.crash_dump_buf = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn megasas_release_mfi(instance: *mut megasas_instance) {
    static void megasas_release_mfi(struct megasas_instance *instance)
    {
    let mut reply_q_sz: u32 = sizeof(u32) *(instance.max_mfi_cmds + 1);
    if (instance.reply_queue)
    dma_free_coherent(&instance.pdev.dev, reply_q_sz,
    instance.reply_queue, instance.reply_queue_h);
    megasas_free_cmds(instance);
...
//
    ...
    let mut el_info_h: dma_addr_t = 0;
    int ret;
    cmd = megasas_get_cmd(instance);
    if (!cmd) {
    return -ENOMEM;
...
//
    ...
    if (instance.aen_cmd != core::ptr::null_mut()) {
    megasas_return_cmd(instance, cmd);
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn megasas_start_aen(instance: *mut megasas_instance) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_io_attach(instance: *mut megasas_instance) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn megasas_set_adapter_type(instance: *mut megasas_instance) {
...
#[no_mangle]
pub unsafe extern "C" fn megasas_alloc_mfi_ctrl_mem(instance: *mut megasas_instance) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_alloc_ctrl_mem(instance: *mut megasas_instance) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn megasas_free_ctrl_mem(instance: *mut megasas_instance) {
...
//
    static inline
#[no_mangle]
pub unsafe extern "C" fn megasas_alloc_ctrl_dma_buffers(instance: *mut megasas_instance) -> c_int {
...
//
    static inline
#[no_mangle]
pub unsafe extern "C" fn megasas_free_ctrl_dma_buffers(instance: *mut megasas_instance) {
...
//
#[no_mangle]
pub unsafe extern "C" fn megasas_init_ctrl_params(instance: *mut megasas_instance) {
...
// Get current SR-IOV LD/VF affiliation
    ...
    megasas_mgmt_info.count--;
    megasas_mgmt_info.max_index--;
    megasas_mgmt_info.instance[megasas_mgmt_info.max_index] = core::ptr::null_mut();
    if (instance.requestorId && !instance.skip_heartbeat_timer_del)
    timer_delete_sync(&instance.sriov_heartbeat_timer);
    instance.instancet.disable_intr(instance);
    megasas_destroy_irqs(instance);
...
//
#[no_mangle]
unsafe extern "C" fn megasas_flush_cache(instance: *mut megasas_instance) {
...
// cancel the delayed work if this work still in queue
    if (instance.ev != core::ptr::null_mut()) {
    struct megasas_aen_event *ev = instance.ev;
    cancel_delayed_work_sync(&ev.hotplug_work);
    instance.ev = core::ptr::null_mut();
    }
...
// Re-launch FW fault watchdog
    ...
    {
    let mut wait_time: c_int = MEGASAS_RESET_WAIT_TIME * 2;
    int i;
    u8 adp_state;
    for (i = 0; i < wait_time; i++) {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_detach_one(pdev: *mut pci_dev) {
...
//
    ...
    megasas_mgmt_info.count--;
    megasas_mgmt_info.instance[i] = core::ptr::null_mut();
    break;
    }
    }
    instance.instancet.disable_intr(instance);
...
//
#[no_mangle]
unsafe extern "C" fn megasas_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_mgmt_open(inode: *mut inode, filep: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_mgmt_fasync(fd: c_int, filep: *mut file, mode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_mgmt_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_set_crash_dump_params_ioctl(cmd: *mut megasas_cmd) -> c_int {
...
//
    ...
    {
    struct megasas_sge64 *kern_sge64 = core::ptr::null_mut();
    struct megasas_sge32 *kern_sge32 = core::ptr::null_mut();
    struct megasas_cmd *cmd;
    void *kbuff_arr[MAX_IOCTL_SGE];
    let mut buf_handle: dma_addr_t = 0;
    let mut error: c_int = 0, i;
    void *sense = core::ptr::null_mut();
    dma_addr_t sense_handle;
    void *sense_ptr;
    let mut opcode: u32 = 0;
    let mut ret: c_int = DCMD_SUCCESS;
...
#[no_mangle]
unsafe extern "C" fn megasas_mgmt_ioctl_fw(file: *mut file, arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn megasas_mgmt_ioctl_aen(file: *mut file, arg: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn version_show(dd: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn release_date_show(dd: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn support_poll_for_event_show(dd: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn support_device_change_show(dd: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn dbg_lvl_show(dd: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn megasas_remove_scsi_device(sdev: *mut scsi_device) {
...
//
    ...
    int i, j;
    let mut pd_index: u16 = 0;
    let mut ld_index: u16 = 0;
    let mut channel: u16 = 0, id = 0;
    struct Scsi_Host *host;
    struct scsi_device *sdev1;
    struct MR_HOST_DEVICE_LIST *targetid_list = core::ptr::null_mut();
    struct MR_HOST_DEVICE_LIST_ENTRY *targetid_entry = core::ptr::null_mut();
    host = instance.host;
    if (instance.enable_fw_dev_list) {
    ...
    u16 ld_target_id;
    int error;
    let mut dcmd_ret: u8 = DCMD_SUCCESS;
    struct scsi_device *sdev1;
    if (!instance) {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn megasas_exit() -> void __exit {
