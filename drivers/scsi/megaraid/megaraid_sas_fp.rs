...
//! Source: drivers/scsi/megaraid/megaraid_sas_fp.c
#![no_std]
...
pub const LB_PENDING_CMDS_DEFAULT: c_int = 4;
    let mut lb_pending_cmds: static unsigned int = LB_PENDING_CMDS_DEFAULT;
...
pub const MR_LD_STATE_OPTIMAL: c_int = 3;

pub const SPAN_INVALID: c_uint = 0xff;
// Prototypes
...
#[no_mangle]
pub unsafe extern "C" fn mega_mod64(dividend: u64, divisor: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn mega_div64_32(dividend: u64, divisor: u32) -> u64 {
    static u64 mega_div64_32(uint64_t dividend, uint32_t divisor)
    {
    let mut d: u64 = dividend;
    if (!divisor)
...
#[no_mangle]
unsafe extern "C" fn MR_LdDataArmGet(ld: u32, armIdx: u32, map: *mut MR_DRV_RAID_MAP_ALL) -> u8 {
    static u8 MR_LdDataArmGet(u32 ld, u32 armIdx, struct MR_DRV_RAID_MAP_ALL *map)
    {
    return map.raidMap.ldSpanMap[ld].dataArmMap[armIdx];
    }
#[no_mangle]
pub unsafe extern "C" fn MR_ArPdGet(ar: u32, arm: u32, map: *mut MR_DRV_RAID_MAP_ALL) -> u16 {
    u16 MR_ArPdGet(u32 ar, u32 arm, struct MR_DRV_RAID_MAP_ALL *map)
    {
    return le16_to_cpu(map.raidMap.arMapInfo[ar].pd[arm]);
    }
#[no_mangle]
pub unsafe extern "C" fn MR_LdSpanArrayGet(ld: u32, span: u32, map: *mut MR_DRV_RAID_MAP_ALL) -> u16 {
    u16 MR_LdSpanArrayGet(u32 ld, u32 span, struct MR_DRV_RAID_MAP_ALL *map)
    {
    return le16_to_cpu(map.raidMap.ldSpanMap[ld].spanBlock[span].span.arrayRef);
    }
#[no_mangle]
pub unsafe extern "C" fn MR_PdDevHandleGet(pd: u32, map: *mut MR_DRV_RAID_MAP_ALL) -> __le16 {
    __le16 MR_PdDevHandleGet(u32 pd, struct MR_DRV_RAID_MAP_ALL *map)
    {
    return map.raidMap.devHndlInfo[pd].curDevHdl;
    }
#[no_mangle]
unsafe extern "C" fn MR_PdInterfaceTypeGet(pd: u32, map: *mut MR_DRV_RAID_MAP_ALL) -> u8 {
    static u8 MR_PdInterfaceTypeGet(u32 pd, struct MR_DRV_RAID_MAP_ALL *map)
    {
    return map.raidMap.devHndlInfo[pd].interfaceType;
    }
#[no_mangle]
pub unsafe extern "C" fn MR_GetLDTgtId(ld: u32, map: *mut MR_DRV_RAID_MAP_ALL) -> u16 {
    u16 MR_GetLDTgtId(u32 ld, struct MR_DRV_RAID_MAP_ALL *map)
    {
    return le16_to_cpu(map.raidMap.ldSpanMap[ld].ldRaid.targetId);
    }
#[no_mangle]
pub unsafe extern "C" fn MR_TargetIdToLdGet(ldTgtId: u32, map: *mut MR_DRV_RAID_MAP_ALL) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn MR_PopulateDrvRaidMap(instance: *mut megasas_instance, map_id: u64) -> c_int {
    static int MR_PopulateDrvRaidMap(struct megasas_instance *instance, u64 map_id)
    {
    struct fusion_context *fusion = instance.ctrl_context;
    struct MR_FW_RAID_MAP_ALL     *fw_map_old    = core::ptr::null_mut();
    struct MR_FW_RAID_MAP         *pFwRaidMap    = core::ptr::null_mut();
    int i, j;
    u16 ld_count;
    ...
    void *raid_map_data = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn MR_ValidateMapInfo(instance: *mut megasas_instance, map_id: u64) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: instance->supportmax256vd) -> else {
    else if (instance.supportmax256vd)
...
//
    ...
    struct MR_QUAD_ELEMENT    *quad;
    u32    span, info;
    let mut ldSpanInfo: PLD_SPAN_INFO = fusion.log_to_span;
...
#[no_mangle]
pub unsafe extern "C" fn if(1: raid->level ==) -> else {
    physArm = physArm + 1;
    pd = MR_ArPdGet(arRef, physArm, map);
    if (pd != MR_PD_INVALID) {
// pDevHandle = MR_PdDevHandleGet(pd, map);
...
// logical arm within row
    let mut logArm: u32 = mega_mod64(stripRow, raid.rowDataSize);
    u32 rowMod, armQ, arm;
    if (raid.rowSize == 0)
    return false;
// get logical row mod
...
//
    ...
    u8          isRead;
    let mut retval: u8 = 0;
    let mut startlba_span: u8 = SPAN_INVALID;
    u64 *pdBlock = &io_info.pdBlock;
    u16	    ld;
...
//
    ...
    return false;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: instance->UnevenSpanSupport) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(THUNDERBOLT_SERIES: instance->adapter_type ==) -> else {
...
// span_row_width) - 1;
    ...
    let mut block: u64 = io_info.ldStartBlock;
    let mut count: u32 = io_info.numBlocks;
