...
pub const ISCSI_SEND_MAX_ALLOWED: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iscsi_internal {
    pub t: scsi_transport_template,
    pub iscsi_transport: *mut iscsi_transport,
    pub list: list_head,
    pub dev: device,
    pub conn_cont: transport_container,
    pub session_cont: transport_container,
}
...
#[no_mangle]
unsafe extern "C" fn iscsi_transport_release(dev: *mut device) {
...
//
    ...
    static DEVICE_ATTR(handle, S_IRUGO, show_transport_handle, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(name, S_IRUGO, show_transport_##name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn iscsi_endpoint_release(dev: *mut device) {
    ...
    static ISCSI_ATTR(ep, handle, S_IRUGO, show_ep_handle, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_destroy_endpoint(ep: *mut iscsi_endpoint) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_put_endpoint(ep: *mut iscsi_endpoint) {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_iface_release(dev: *mut device) {
...
// iface attrs show
    ...
    static ISCSI_IFACE_ATTR(type, name, S_IRUGO, show_##type##_##name, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_vlan_id.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_vlan_id.attr)
    param = ISCSI_NET_PARAM_VLAN_ID;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_vlan_priority.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_vlan_priority.attr)
    param = ISCSI_NET_PARAM_VLAN_PRIORITY;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_vlan_enabled.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_vlan_enabled.attr)
    param = ISCSI_NET_PARAM_VLAN_ENABLED;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_mtu.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_mtu.attr)
    param = ISCSI_NET_PARAM_MTU;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_port.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_port.attr)
    param = ISCSI_NET_PARAM_PORT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_ipaddress_state.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_ipaddress_state.attr)
    param = ISCSI_NET_PARAM_IPADDR_STATE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_delayed_ack_en.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_delayed_ack_en.attr)
    param = ISCSI_NET_PARAM_DELAYED_ACK_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_tcp_nagle_disable.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_tcp_nagle_disable.attr)
    param = ISCSI_NET_PARAM_TCP_NAGLE_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_tcp_wsf_disable.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_tcp_wsf_disable.attr)
    param = ISCSI_NET_PARAM_TCP_WSF_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_tcp_wsf.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_tcp_wsf.attr)
    param = ISCSI_NET_PARAM_TCP_WSF;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_tcp_timer_scale.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_tcp_timer_scale.attr)
    param = ISCSI_NET_PARAM_TCP_TIMER_SCALE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_tcp_timestamp_en.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_tcp_timestamp_en.attr)
    param = ISCSI_NET_PARAM_TCP_TIMESTAMP_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_cache_id.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_cache_id.attr)
    param = ISCSI_NET_PARAM_CACHE_ID;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_iface_redirect_en.attr: attr ==) -> else {
    else if (attr == &dev_attr_iface_redirect_en.attr)
    param = ISCSI_NET_PARAM_REDIRECT_EN;
#[no_mangle]
pub unsafe extern "C" fn if(ISCSI_IFACE_TYPE_IPV4: iface->iface_type ==) -> else {
    if (attr == &dev_attr_ipv4_iface_ipaddress.attr)
    param = ISCSI_NET_PARAM_IPV4_ADDR;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_gateway.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv4_iface_gateway.attr)
    param = ISCSI_NET_PARAM_IPV4_GW;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_subnet.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv4_iface_subnet.attr)
    param = ISCSI_NET_PARAM_IPV4_SUBNET;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_bootproto.attr: attr ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_tos_en.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv4_iface_tos_en.attr)
    param = ISCSI_NET_PARAM_IPV4_TOS_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_tos.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv4_iface_tos.attr)
    param = ISCSI_NET_PARAM_IPV4_TOS;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_grat_arp_en.attr: attr ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_dhcp_alt_client_id.attr: attr ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_dhcp_vendor_id.attr: attr ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv4_iface_ttl.attr: attr ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv6_iface_link_local_addr.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv6_iface_link_local_addr.attr)
    param = ISCSI_NET_PARAM_IPV6_LINKLOCAL;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv6_iface_router_addr.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv6_iface_router_addr.attr)
    param = ISCSI_NET_PARAM_IPV6_ROUTER;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv6_iface_ipaddr_autocfg.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv6_iface_ipaddr_autocfg.attr)
    param = ISCSI_NET_PARAM_IPV6_ADDR_AUTOCFG;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv6_iface_link_local_autocfg.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv6_iface_link_local_autocfg.attr)
    param = ISCSI_NET_PARAM_IPV6_LINKLOCAL_AUTOCFG;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv6_iface_link_local_state.attr: attr ==) -> else {
    else if (attr == &dev_attr_ipv6_iface_link_local_state.attr)
    param = ISCSI_NET_PARAM_IPV6_LINKLOCAL_STATE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_ipv6_iface_router_state.attr: attr ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_destroy_iface(iface: *mut iscsi_iface) {
...
// flash node session attrs show
    ...
    show_##type##_##name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn iscsi_flashnode_sess_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_flashnode_conn_release(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_is_flashnode_conn_dev(dev: *mut device, data: *const c_void) -> c_int {
    static int iscsi_is_flashnode_conn_dev(struct device *dev, const void *data)
    {
    return dev.bus == &iscsi_flashnode_bus;
    }
#[no_mangle]
unsafe extern "C" fn iscsi_destroy_flashnode_conn(fnode_conn: *mut iscsi_bus_flash_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn flashnode_match_index(dev: *mut device, data: *const c_void) -> c_int {
    static int flashnode_match_index(struct device *dev, const void *data)
    {
    struct iscsi_bus_flash_session *fnode_sess = core::ptr::null_mut();
    let mut ret: c_int = 0;
    if (!iscsi_flashnode_bus_match(dev, core::ptr::null_mut()))
...
//
    ...
    {
    return device_find_child(&fnode_sess.dev, core::ptr::null_mut(),
    iscsi_is_flashnode_conn_dev);
    }
    EXPORT_SYMBOL_GPL(iscsi_find_flashnode_conn);
#[no_mangle]
unsafe extern "C" fn iscsi_iter_destroy_flashnode_conn_fn(dev: *mut device, data: *mut c_void) -> c_int {
    static int iscsi_iter_destroy_flashnode_conn_fn(struct device *dev, void *data)
    {
    if (!iscsi_is_flashnode_conn_dev(dev, core::ptr::null_mut()))
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_destroy_flashnode_sess(fnode_sess: *mut iscsi_bus_flash_session) {
    void iscsi_destroy_flashnode_sess(struct iscsi_bus_flash_session *fnode_sess)
    {
    int err;
    err = device_for_each_child(&fnode_sess.dev, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn iscsi_iter_destroy_flashnode_fn(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_destroy_all_flashnode(shost: *mut Scsi_Host) {
    void iscsi_destroy_all_flashnode(struct Scsi_Host *shost)
    {
    device_for_each_child(&shost.shost_gendev, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_bsg_host_dispatch(job: *mut bsg_job) -> c_int {
...
//
    ...
    q = bsg_setup_queue(dev, bsg_name, &lim, iscsi_bsg_host_dispatch, core::ptr::null_mut(),
    0);
    if (IS_ERR(q)) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_conn_get_sid(conn: *mut iscsi_cls_conn) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_session_chkready(session: *mut iscsi_cls_session) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_is_session_online(session: *mut iscsi_cls_session) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_session_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_is_session_dev(dev: *const device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_iter_session_fn(dev: *mut device, data: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iscsi_scan_data {
    pub channel: c_uint,
    pub id: c_uint,
    pub lun: u64,
    pub rescan: enum scsi_scan_mode,
}

#[no_mangle]
unsafe extern "C" fn iscsi_user_scan_session(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_scan_session(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_block_scsi_eh(cmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn session_recovery_timedout(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __iscsi_unblock_session(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_unblock_session(session: *mut iscsi_cls_session) {
...
#[no_mangle]
unsafe extern "C" fn __iscsi_block_session(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_block_session(session: *mut iscsi_cls_session) {
...
#[no_mangle]
unsafe extern "C" fn __iscsi_unbind_session(work: *mut work_struct) {
    ...
    let mut remove_target: bool = true;
...
#[no_mangle]
unsafe extern "C" fn __iscsi_destroy_session(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_add_session(session: *mut iscsi_cls_session, target_id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_conn_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_is_conn_dev(dev: *const device) -> c_int {
    static int iscsi_is_conn_dev(const struct device *dev)
    {
    return dev.release == iscsi_conn_release;
    }
#[no_mangle]
unsafe extern "C" fn iscsi_iter_destroy_conn_fn(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_remove_session(session: *mut iscsi_cls_session) {
...
// hw iscsi may not have removed all connections from session
    err = device_for_each_child(&session.dev, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn iscsi_stop_conn(conn: *mut iscsi_cls_conn, flag: c_int) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_ep_disconnect(conn: *mut iscsi_cls_conn, is_active: bool) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_if_stop_conn(conn: *mut iscsi_cls_conn, flag: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_cleanup_conn_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_iter_force_destroy_conn_fn(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_force_destroy_session(session: *mut iscsi_cls_session) {
...
//
    ...
    spin_unlock_irqrestore(&sesslock, flags);
    device_for_each_child(&session.dev, core::ptr::null_mut(),
    iscsi_iter_force_destroy_conn_fn);
    transport.destroy_session(session);
    }
    EXPORT_SYMBOL_GPL(iscsi_force_destroy_session);
#[no_mangle]
pub unsafe extern "C" fn iscsi_free_session(session: *mut iscsi_cls_session) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_add_conn(conn: *mut iscsi_cls_conn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_remove_conn(conn: *mut iscsi_cls_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_put_conn(conn: *mut iscsi_cls_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_get_conn(conn: *mut iscsi_cls_conn) {
...
//
    ...
    struct sk_buff *skb;
    struct iscsi_uevent *ev;
    let mut len: c_int = nlmsg_total_size(sizeof(*ev) + data_size);
    skb = alloc_skb(len, GFP_ATOMIC);
    if (!skb) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_conn_error_event(conn: *mut iscsi_cls_conn, error: enum iscsi_err) {
    ...
    struct iscsi_uevent *ev;
    struct iscsi_internal *priv;
    let mut len: c_int = nlmsg_total_size(sizeof(*ev));
    unsigned long flags;
    int state;
...
//
    ...
    struct sk_buff	*skb;
    struct nlmsghdr	*nlh;
    let mut len: c_int = nlmsg_total_size(size);
    skb = alloc_skb(len, GFP_ATOMIC);
    if (!skb) {
...
//
    ...
    struct iscsi_cls_conn *conn;
    struct iscsi_cls_session *session;
    let mut err: c_int = 0, value = 0, state;
...
#[no_mangle]
unsafe extern "C" fn iscsi_session_has_conns(sid: c_int) -> c_int {
    ...
    let mut host_stats_size: c_int = 0;
    int len, err = 0;
    char *buf;
    ...
    struct iscsi_uevent *ev = nlmsg_data(nlh);
    struct iscsi_cls_session *session;
    struct iscsi_cls_conn *conn = core::ptr::null_mut();
    struct iscsi_endpoint *ep;
    let mut err: c_int = 0;
...
//
    ...
    u32 portid;
    struct iscsi_uevent *ev = nlmsg_data(nlh);
    struct iscsi_transport *transport = core::ptr::null_mut();
    struct iscsi_internal *priv;
    struct iscsi_cls_session *session;
    struct iscsi_endpoint *ep = core::ptr::null_mut();
    u32 rlen;
...
//
    ...
    err = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: iscsi_session_has_conns(ev->u.d_session.sid)) -> else {
...
//
    ...
    struct iscsi_uevent *ev;
    uint32_t group;
    let mut retries: c_int = ISCSI_SEND_MAX_ALLOWED;
    nlh = nlmsg_hdr(skb);
...
//
    ...
    let mut conn_state: c_int = READ_ONCE(conn.state);
    if (conn_state >= 0 &&
...
// \
    ...
    show_conn_ep_param_##param, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_max_xmit_dlength.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_max_xmit_dlength.attr)
    param = ISCSI_PARAM_MAX_XMIT_DLENGTH;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_header_digest.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_header_digest.attr)
    param = ISCSI_PARAM_HDRDGST_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_data_digest.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_data_digest.attr)
    param = ISCSI_PARAM_DATADGST_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_ifmarker.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_ifmarker.attr)
    param = ISCSI_PARAM_IFMARKER_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_ofmarker.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_ofmarker.attr)
    param = ISCSI_PARAM_OFMARKER_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_address.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_address.attr)
    param = ISCSI_PARAM_CONN_ADDRESS;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_port.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_port.attr)
    param = ISCSI_PARAM_CONN_PORT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_exp_statsn.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_exp_statsn.attr)
    param = ISCSI_PARAM_EXP_STATSN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_persistent_address.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_persistent_address.attr)
    param = ISCSI_PARAM_PERSISTENT_ADDRESS;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_persistent_port.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_persistent_port.attr)
    param = ISCSI_PARAM_PERSISTENT_PORT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_ping_tmo.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_ping_tmo.attr)
    param = ISCSI_PARAM_PING_TMO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_recv_tmo.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_recv_tmo.attr)
    param = ISCSI_PARAM_RECV_TMO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_local_port.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_local_port.attr)
    param = ISCSI_PARAM_LOCAL_PORT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_statsn.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_statsn.attr)
    param = ISCSI_PARAM_STATSN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_keepalive_tmo.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_keepalive_tmo.attr)
    param = ISCSI_PARAM_KEEPALIVE_TMO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_max_segment_size.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_max_segment_size.attr)
    param = ISCSI_PARAM_MAX_SEGMENT_SIZE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_tcp_timestamp_stat.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_tcp_timestamp_stat.attr)
    param = ISCSI_PARAM_TCP_TIMESTAMP_STAT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_tcp_wsf_disable.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_tcp_wsf_disable.attr)
    param = ISCSI_PARAM_TCP_WSF_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_tcp_nagle_disable.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_tcp_nagle_disable.attr)
    param = ISCSI_PARAM_TCP_NAGLE_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_tcp_timer_scale.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_tcp_timer_scale.attr)
    param = ISCSI_PARAM_TCP_TIMER_SCALE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_tcp_timestamp_enable.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_tcp_timestamp_enable.attr)
    param = ISCSI_PARAM_TCP_TIMESTAMP_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_fragment_disable.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_fragment_disable.attr)
    param = ISCSI_PARAM_IP_FRAGMENT_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_ipv4_tos.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_ipv4_tos.attr)
    param = ISCSI_PARAM_IPV4_TOS;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_ipv6_traffic_class.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_ipv6_traffic_class.attr)
    param = ISCSI_PARAM_IPV6_TC;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_ipv6_flow_label.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_ipv6_flow_label.attr)
    param = ISCSI_PARAM_IPV6_FLOW_LABEL;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_is_fw_assigned_ipv6.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_is_fw_assigned_ipv6.attr)
    param = ISCSI_PARAM_IS_FW_ASSIGNED_IPV6;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_tcp_xmit_wsf.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_tcp_xmit_wsf.attr)
    param = ISCSI_PARAM_TCP_XMIT_WSF;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_tcp_recv_wsf.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_tcp_recv_wsf.attr)
    param = ISCSI_PARAM_TCP_RECV_WSF;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_local_ipaddr.attr: attr ==) -> else {
    else if (attr == &dev_attr_conn_local_ipaddr.attr)
    param = ISCSI_PARAM_LOCAL_IPADDR;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_conn_state.attr: attr ==) -> else {
...
//
    ...
    show_priv_session_target_state, core::ptr::null_mut());
    static ssize_t
    ...
    show_priv_session_target_id, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_max_outstanding_r2t.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_max_outstanding_r2t.attr)
    param = ISCSI_PARAM_MAX_R2T;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_immediate_data.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_immediate_data.attr)
    param = ISCSI_PARAM_IMM_DATA_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_first_burst_len.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_first_burst_len.attr)
    param = ISCSI_PARAM_FIRST_BURST;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_max_burst_len.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_max_burst_len.attr)
    param = ISCSI_PARAM_MAX_BURST;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_data_pdu_in_order.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_data_pdu_in_order.attr)
    param = ISCSI_PARAM_PDU_INORDER_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_data_seq_in_order.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_data_seq_in_order.attr)
    param = ISCSI_PARAM_DATASEQ_INORDER_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_erl.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_erl.attr)
    param = ISCSI_PARAM_ERL;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_targetname.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_targetname.attr)
    param = ISCSI_PARAM_TARGET_NAME;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_tpgt.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_tpgt.attr)
    param = ISCSI_PARAM_TPGT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_chap_in_idx.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_chap_in_idx.attr)
    param = ISCSI_PARAM_CHAP_IN_IDX;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_chap_out_idx.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_chap_out_idx.attr)
    param = ISCSI_PARAM_CHAP_OUT_IDX;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_password.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_password.attr)
    param = ISCSI_PARAM_USERNAME;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_password_in.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_password_in.attr)
    param = ISCSI_PARAM_USERNAME_IN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_username.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_username.attr)
    param = ISCSI_PARAM_PASSWORD;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_username_in.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_username_in.attr)
    param = ISCSI_PARAM_PASSWORD_IN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_fast_abort.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_fast_abort.attr)
    param = ISCSI_PARAM_FAST_ABORT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_abort_tmo.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_abort_tmo.attr)
    param = ISCSI_PARAM_ABORT_TMO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_lu_reset_tmo.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_lu_reset_tmo.attr)
    param = ISCSI_PARAM_LU_RESET_TMO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_tgt_reset_tmo.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_tgt_reset_tmo.attr)
    param = ISCSI_PARAM_TGT_RESET_TMO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_ifacename.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_ifacename.attr)
    param = ISCSI_PARAM_IFACE_NAME;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_initiatorname.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_initiatorname.attr)
    param = ISCSI_PARAM_INITIATOR_NAME;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_targetalias.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_targetalias.attr)
    param = ISCSI_PARAM_TARGET_ALIAS;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_boot_root.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_boot_root.attr)
    param = ISCSI_PARAM_BOOT_ROOT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_boot_nic.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_boot_nic.attr)
    param = ISCSI_PARAM_BOOT_NIC;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_boot_target.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_boot_target.attr)
    param = ISCSI_PARAM_BOOT_TARGET;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_auto_snd_tgt_disable.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_auto_snd_tgt_disable.attr)
    param = ISCSI_PARAM_AUTO_SND_TGT_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_discovery_session.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_discovery_session.attr)
    param = ISCSI_PARAM_DISCOVERY_SESS;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_portal_type.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_portal_type.attr)
    param = ISCSI_PARAM_PORTAL_TYPE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_chap_auth.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_chap_auth.attr)
    param = ISCSI_PARAM_CHAP_AUTH_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_discovery_logout.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_discovery_logout.attr)
    param = ISCSI_PARAM_DISCOVERY_LOGOUT_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_bidi_chap.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_bidi_chap.attr)
    param = ISCSI_PARAM_BIDI_CHAP_EN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_discovery_auth_optional.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_discovery_auth_optional.attr)
    param = ISCSI_PARAM_DISCOVERY_AUTH_OPTIONAL;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_def_time2wait.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_def_time2wait.attr)
    param = ISCSI_PARAM_DEF_TIME2WAIT;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_def_time2retain.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_def_time2retain.attr)
    param = ISCSI_PARAM_DEF_TIME2RETAIN;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_isid.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_isid.attr)
    param = ISCSI_PARAM_ISID;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_tsid.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_tsid.attr)
    param = ISCSI_PARAM_TSID;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_def_taskmgmt_tmo.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_def_taskmgmt_tmo.attr)
    param = ISCSI_PARAM_DEF_TASKMGMT_TMO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_discovery_parent_idx.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_discovery_parent_idx.attr)
    param = ISCSI_PARAM_DISCOVERY_PARENT_IDX;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_sess_discovery_parent_type.attr: attr ==) -> else {
    else if (attr == &dev_attr_sess_discovery_parent_type.attr)
    param = ISCSI_PARAM_DISCOVERY_PARENT_TYPE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_priv_sess_recovery_tmo.attr: attr ==) -> else {
    else if (attr == &dev_attr_priv_sess_recovery_tmo.attr)
    return S_IRUGO | S_IWUSR;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_priv_sess_state.attr: attr ==) -> else {
    else if (attr == &dev_attr_priv_sess_state.attr)
    return S_IRUGO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_priv_sess_target_state.attr: attr ==) -> else {
    else if (attr == &dev_attr_priv_sess_target_state.attr)
    return S_IRUGO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_priv_sess_creator.attr: attr ==) -> else {
    else if (attr == &dev_attr_priv_sess_creator.attr)
    return S_IRUGO;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_priv_sess_target_id.attr: attr ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_host_hwaddress.attr: attr ==) -> else {
    else if (attr == &dev_attr_host_hwaddress.attr)
    param = ISCSI_HOST_PARAM_HWADDRESS;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_host_ipaddress.attr: attr ==) -> else {
    else if (attr == &dev_attr_host_ipaddress.attr)
    param = ISCSI_HOST_PARAM_IPADDRESS;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_host_initiatorname.attr: attr ==) -> else {
    else if (attr == &dev_attr_host_initiatorname.attr)
    param = ISCSI_HOST_PARAM_INITIATOR_NAME;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_host_port_state.attr: attr ==) -> else {
    else if (attr == &dev_attr_host_port_state.attr)
    param = ISCSI_HOST_PARAM_PORT_STATE;
#[no_mangle]
pub unsafe extern "C" fn if(&dev_attr_host_port_speed.attr: attr ==) -> else {
...
// convert iscsi_port_speed values to ascii string name
    ...
    char *speed = "Unknown!";
    struct iscsi_cls_host *ihost = shost.shost_data;
    let mut port_speed: u32 = ihost.port_speed;
...
// convert iscsi_port_state values to ascii string name
    ...
    char *state = "Unknown!";
    struct iscsi_cls_host *ihost = shost.shost_data;
    let mut port_state: u32 = ihost.port_state;
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_unregister_transport(tt: *mut iscsi_transport) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_transport_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_transport_exit() -> void __exit {
