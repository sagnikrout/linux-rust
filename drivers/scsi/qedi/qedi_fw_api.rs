...
//! Source: drivers/scsi/qedi/qedi_fw_api.c
#![no_std]
...
pub const SCSI_NUM_SGES_IN_CACHE: c_uint = 0x4;
#[no_mangle]
unsafe extern "C" fn scsi_is_slow_sgl(num_sges: u16, small_mid_sge: bool) -> bool {
...
// sgl params
    ...
    {
    let mut advance_statsn: bool = true;
    ...
    u8 total_ahs_length)
    {
    let mut max_unsolicited_data: u32 = 0, val;
    if (total_ahs_length &&
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: conn_params->immediate_data) -> else {
...
#[no_mangle]
unsafe extern "C" fn set_local_completion_context(context: *mut iscsi_task_context) {
    ...
    struct scsi_dif_task_params *dif_task_params)
    {
    let mut exp_data_transfer_len: u32 = conn_params.max_burst_length;
    struct iscsi_task_context *cxt;
    let mut slow_io: bool = false;
    u32 task_size, val;
    let mut num_sges: u8 = 0;
    ...
    rx_params.total_buffer_size : 0);
    init_sqe(task_params, tx_params, core::ptr::null_mut(),
    (struct iscsi_common_hdr *)login_header, core::ptr::null_mut(),
    ...
    0);
    init_sqe(task_params, tx_sgl_task_params, core::ptr::null_mut(),
    (struct iscsi_common_hdr *)nop_out_pdu_header, core::ptr::null_mut(),
    ISCSI_TASK_TYPE_MIDPATH, false);
    return 0;
    }
    ...
    rx_params.total_buffer_size : 0);
    init_sqe(task_params, tx_params, core::ptr::null_mut(),
    (struct iscsi_common_hdr *)logout_hdr, core::ptr::null_mut(),
    ISCSI_TASK_TYPE_MIDPATH, false);
    return 0;
    }
    ...
    ISCSI_TASK_TYPE_MIDPATH);
    init_sqe(task_params, core::ptr::null_mut(), core::ptr::null_mut(),
    (struct iscsi_common_hdr *)tmf_header, core::ptr::null_mut(),
    ISCSI_TASK_TYPE_MIDPATH, false);
    return 0;
    }
    ...
    init_sqe(task_params, tx_params, core::ptr::null_mut(),
    (struct iscsi_common_hdr *)text_header, core::ptr::null_mut(),
    ISCSI_TASK_TYPE_MIDPATH, false);
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn init_cleanup_task(task_params: *mut iscsi_task_params) -> c_int {
    int init_cleanup_task(struct iscsi_task_params *task_params)
    {
    init_sqe(task_params, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), ISCSI_TASK_TYPE_MIDPATH,
    true);
    return 0;
    }
