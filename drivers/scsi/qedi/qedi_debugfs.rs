...
//! Source: drivers/scsi/qedi/qedi_debugfs.c
#![no_std]
...
//
    ...
    qedi.bdf_dentry = core::ptr::null_mut();
    }
    void
    qedi_dbg_init(char *drv_name)
    {
    qedi_dbg_root = debugfs_create_dir(drv_name, core::ptr::null_mut());
    }
    void
    qedi_dbg_exit(void)
    {
    debugfs_remove_recursive(qedi_dbg_root);
    qedi_dbg_root = core::ptr::null_mut();
    }
    static ssize_t
    ...
    {
    struct qedi_fastpath *fp = core::ptr::null_mut();
    struct qed_sb_info *sb_info = core::ptr::null_mut();
    struct status_block *sb = core::ptr::null_mut();
    struct global_queue *que = core::ptr::null_mut();
    int id;
    u16 prod_idx;
