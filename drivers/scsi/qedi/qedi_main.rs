...
//! Source: drivers/scsi/qedi/qedi_main.c
#![no_std]
...
//
    ...
    let mut qedi_dbg_log: c_uint = QEDI_LOG_WARN | QEDI_LOG_SCSI_TM;
    ...
    let mut qedi_ll2_buf_size: static uint = 0x400;
...
#[no_mangle]
unsafe extern "C" fn qedi_iscsi_event_cb(context: *mut c_void, fw_event_code: u8, fw_handle: *mut c_void) -> c_int {
    ...
    QEDI_ERR(core::ptr::null_mut(), "Recv event with ctx core::ptr::null_mut()\n");
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn qedi_uio_open(uinfo: *mut uio_info, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_uio_close(uinfo: *mut uio_info, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __qedi_free_uio_rings(udev: *mut qedi_uio_dev) {
    static void __qedi_free_uio_rings(struct qedi_uio_dev *udev)
    {
    if (udev.uctrl) {
    free_page((unsigned long)udev.uctrl);
    udev.uctrl = core::ptr::null_mut();
    }
    if (udev.ll2_ring) {
    free_page((unsigned long)udev.ll2_ring);
    udev.ll2_ring = core::ptr::null_mut();
    }
    if (udev.ll2_buf) {
    free_pages((unsigned long)udev.ll2_buf, 2);
    udev.ll2_buf = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn __qedi_free_uio(udev: *mut qedi_uio_dev) {
...
#[no_mangle]
unsafe extern "C" fn qedi_free_uio(udev: *mut qedi_uio_dev) {
...
#[no_mangle]
unsafe extern "C" fn qedi_reset_uio_rings(udev: *mut qedi_uio_dev) {
    static void qedi_reset_uio_rings(struct qedi_uio_dev *udev)
    {
    struct qedi_ctx *qedi = core::ptr::null_mut();
    struct qedi_uio_ctrl *uctrl = core::ptr::null_mut();
    qedi = udev.qedi;
    uctrl = udev.uctrl;
...
#[no_mangle]
unsafe extern "C" fn __qedi_alloc_uio_rings(udev: *mut qedi_uio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_init_uio(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_free_sb(qedi: *mut qedi_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedi_free_fp(qedi: *mut qedi_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedi_destroy_fp(qedi: *mut qedi_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedi_alloc_fp(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_int_fp(qedi: *mut qedi_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedi_prepare_fp(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_setup_cid_que(qedi: *mut qedi_ctx) -> c_int {
    ...
    qedi.cid_que.cid_que_base = core::ptr::null_mut();
    return -ENOMEM;
    }
    ...
    qedi.cid_que.conn_cid_tbl[i] = core::ptr::null_mut();
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qedi_release_cid_que(qedi: *mut qedi_ctx) {
    static void qedi_release_cid_que(struct qedi_ctx *qedi)
    {
    kfree(qedi.cid_que.cid_que_base);
    qedi.cid_que.cid_que_base = core::ptr::null_mut();
    kfree(qedi.cid_que.conn_cid_tbl);
    qedi.cid_que.conn_cid_tbl = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn qedi_free_id_tbl(id_tbl: *mut qedi_portid_tbl) {
    static void qedi_free_id_tbl(struct qedi_portid_tbl *id_tbl)
    {
    kfree(id_tbl.table);
    id_tbl.table = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn qedi_alloc_id(id_tbl: *mut qedi_portid_tbl, id: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qedi_alloc_new_id(id_tbl: *mut qedi_portid_tbl) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn qedi_free_id(id_tbl: *mut qedi_portid_tbl, id: u16) {
...
#[no_mangle]
unsafe extern "C" fn qedi_cm_free_mem(qedi: *mut qedi_ctx) {
    static void qedi_cm_free_mem(struct qedi_ctx *qedi)
    {
    kfree(qedi.ep_tbl);
    qedi.ep_tbl = core::ptr::null_mut();
    qedi_free_id_tbl(&qedi.lcl_port_tbl);
    }
#[no_mangle]
unsafe extern "C" fn qedi_cm_alloc_mem(qedi: *mut qedi_ctx) -> c_int {
    ...
    if (!shost) {
    QEDI_ERR(core::ptr::null_mut(), "Could not allocate shost\n");
...
#[no_mangle]
unsafe extern "C" fn qedi_ll2_rx(cookie: *mut c_void, skb: *mut sk_buff, arg1: u32, arg2: u32) -> c_int {
    ...
    struct ethhdr *eh;
    if (!qedi) {
    QEDI_ERR(core::ptr::null_mut(), "qedi is core::ptr::null_mut()\n");
    return -1;
    }
...
#[no_mangle]
unsafe extern "C" fn qedi_ll2_free_skbs(qedi: *mut qedi_ctx) {
    static void qedi_ll2_free_skbs(struct qedi_ctx *qedi)
    {
...
#[no_mangle]
unsafe extern "C" fn qedi_ll2_recv_thread(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_set_iscsi_pf_param(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_free_iscsi_pf_param(qedi: *mut qedi_ctx) {
    ...
    {
    struct qedi_boot_target *pri_tgt = core::ptr::null_mut(), *sec_tgt = core::ptr::null_mut();
    let mut pri_ctrl_flags: u32 = 0, sec_ctrl_flags = 0, found = 0;
...
#[no_mangle]
unsafe extern "C" fn qedi_get_generic_tlv_data(dev: *mut c_void, data: *mut qed_generic_tlvs) {
    static void qedi_get_generic_tlv_data(void *dev, struct qed_generic_tlvs *data)
    {
    struct qedi_ctx *qedi;
    if (!dev) {
    QEDI_INFO(core::ptr::null_mut(), QEDI_LOG_EVT,
...
//
#[no_mangle]
unsafe extern "C" fn qedi_get_protocol_tlv_data(dev: *mut c_void, data: *mut c_void) {
    ...
    struct nvm_iscsi_block *block = core::ptr::null_mut();
    let mut chap_en: u32 = 0, mchap_en = 0;
...
// tpgt, hdr digest, data digest
    ...
    let mut override_flags: c_ulong = qedi_flags_override;
...
#[no_mangle]
unsafe extern "C" fn qedi_schedule_recovery_handler(dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qedi_set_conn_recovery(cls_session: *mut iscsi_cls_session) {
...
#[no_mangle]
unsafe extern "C" fn qedi_link_update(dev: *mut c_void, link: *mut qed_link_output) {
...
#[no_mangle]
unsafe extern "C" fn qedi_process_completions(fp: *mut qedi_fastpath) -> bool {
    static bool qedi_process_completions(struct qedi_fastpath *fp)
    {
    struct qedi_ctx *qedi = fp.qedi;
    struct qed_sb_info *sb_info = fp.sb_info;
    struct status_block *sb = sb_info.sb_virt;
    struct qedi_percpu_s *p = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qedi_fp_has_work(fp: *mut qedi_fastpath) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qedi_msix_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t qedi_msix_handler(int irq, void *dev_id)
    {
    struct qedi_fastpath *fp = dev_id;
    struct qedi_ctx *qedi = fp.qedi;
    let mut wake_io_thread: bool = true;
...
#[no_mangle]
unsafe extern "C" fn qedi_simd_int_handler(cookie: *mut c_void) {
...
pub const QEDI_SIMD_HANDLER_NUM: c_int = 0;
#[no_mangle]
unsafe extern "C" fn qedi_sync_free_irqs(qedi: *mut qedi_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedi_request_msix_irq(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_setup_int(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_free_nvm_iscsi_cfg(qedi: *mut qedi_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedi_alloc_nvm_iscsi_cfg(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_free_bdq(qedi: *mut qedi_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedi_free_global_queues(qedi: *mut qedi_ctx) {
    static void qedi_free_global_queues(struct qedi_ctx *qedi)
    {
    int i;
...
#[no_mangle]
unsafe extern "C" fn qedi_alloc_bdq(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_alloc_global_queues(qedi: *mut qedi_ctx) -> c_int {
    static int qedi_alloc_global_queues(struct qedi_ctx *qedi)
    {
    u32 *list;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn qedi_alloc_sq(qedi: *mut qedi_ctx, ep: *mut qedi_endpoint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qedi_free_sq(qedi: *mut qedi_ctx, ep: *mut qedi_endpoint) {
...
#[no_mangle]
pub unsafe extern "C" fn qedi_get_task_idx(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qedi_clear_task_idx(qedi: *mut qedi_ctx, idx: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qedi_get_task_tid(qedi: *mut qedi_ctx, itt: u32, tid: *mut i16) {
...
// tid = i;
    ...
    {
    struct qedi_cmd *cmd = core::ptr::null_mut();
    if (tid >= MAX_ISCSI_TASK_ENTRIES)
    return core::ptr::null_mut();
    cmd = qedi.itt_map[tid].p_cmd;
    if (cmd.task_id != tid)
    return core::ptr::null_mut();
    qedi.itt_map[tid].p_cmd = core::ptr::null_mut();
    return cmd;
    }
#[no_mangle]
unsafe extern "C" fn qedi_alloc_itt(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_free_itt(qedi: *mut qedi_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedi_percpu_io_thread(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_cpu_offline(cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qedi_reset_host_mtu(qedi: *mut qedi_ctx, mtu: u16) {
...
#[no_mangle]
unsafe extern "C" fn qedi_show_boot_eth_info(data: *mut c_void, type: c_int, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn qedi_eth_get_attr_visibility(data: *mut c_void, type: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn qedi_show_boot_ini_info(data: *mut c_void, type: c_int, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn qedi_ini_get_attr_visibility(data: *mut c_void, type: c_int) -> umode_t {
    ...
    chap_en = block.generic.ctrl_flags &
    NVM_ISCSI_CFG_GEN_CHAP_ENABLED;
    chap_name = chap_en ? block.initiator.chap_name.byte : core::ptr::null_mut();
    chap_secret = chap_en ? block.initiator.chap_password.byte : core::ptr::null_mut();
    mchap_en = block.generic.ctrl_flags &
    NVM_ISCSI_CFG_GEN_CHAP_MUTUAL_ENABLED;
    mchap_name = mchap_en ? block.target[idx].chap_name.byte : core::ptr::null_mut();
    mchap_secret = mchap_en ? block.target[idx].chap_password.byte : core::ptr::null_mut();
    switch (type) {
...
#[no_mangle]
unsafe extern "C" fn qedi_show_boot_tgt_pri_info(data: *mut c_void, type: c_int, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn qedi_show_boot_tgt_sec_info(data: *mut c_void, type: c_int, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn qedi_tgt_get_attr_visibility(data: *mut c_void, type: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn qedi_boot_release(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qedi_get_boot_info(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedi_setup_boot_info(qedi: *mut qedi_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __qedi_remove(pdev: *mut pci_dev, mode: c_int) {
    static void __qedi_remove(struct pci_dev *pdev, int mode)
    {
    struct qedi_ctx *qedi = pci_get_drvdata(pdev);
    int rval;
    let mut retry: u16 = 10;
    if (mode == QEDI_MODE_NORMAL)
    iscsi_host_remove(qedi.shost, false);
#[no_mangle]
pub unsafe extern "C" fn if(QEDI_MODE_SHUTDOWN: mode ==) -> else {
    else if (mode == QEDI_MODE_SHUTDOWN)
    iscsi_host_remove(qedi.shost, true);
    if (mode == QEDI_MODE_NORMAL || mode == QEDI_MODE_SHUTDOWN) {
    if (qedi.tmf_thread) {
    destroy_workqueue(qedi.tmf_thread);
    qedi.tmf_thread = core::ptr::null_mut();
    }
    if (qedi.offload_thread) {
    destroy_workqueue(qedi.offload_thread);
    qedi.offload_thread = core::ptr::null_mut();
    }
    }
    ...
    qedi.ll2_recv_thread = core::ptr::null_mut();
    }
    qedi_ll2_free_skbs(qedi);
    if (qedi.boot_kset)
    iscsi_boot_destroy_kset(qedi.boot_kset);
...
#[no_mangle]
unsafe extern "C" fn qedi_board_disable_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qedi_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qedi_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
    static int qedi_suspend(struct pci_dev *pdev, pm_message_t state)
    {
    struct qedi_ctx *qedi;
    if (!pdev) {
    QEDI_ERR(core::ptr::null_mut(), "pdev is core::ptr::null_mut().\n");
    return -ENODEV;
    }
...
#[no_mangle]
unsafe extern "C" fn __qedi_probe(pdev: *mut pci_dev, mode: c_int) -> c_int {
    static int __qedi_probe(struct pci_dev *pdev, int mode)
    {
    struct qedi_ctx *qedi;
    struct qed_ll2_params params;
    let mut dp_level: u8 = 0;
...
#[no_mangle]
unsafe extern "C" fn qedi_mark_conn_recovery(cls_session: *mut iscsi_cls_session) {
...
#[no_mangle]
unsafe extern "C" fn qedi_recovery_handler(work: *mut work_struct) {
    static void qedi_recovery_handler(struct work_struct *work)
    {
    struct qedi_ctx *qedi =
...
#[no_mangle]
unsafe extern "C" fn qedi_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int qedi_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    return __qedi_probe(pdev, QEDI_MODE_NORMAL);
    }
#[no_mangle]
unsafe extern "C" fn qedi_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qedi_init() -> int __init {
    ...
    if (!qedi_ops) {
    QEDI_ERR(core::ptr::null_mut(), "Failed to get qed iSCSI operations\n");
    return -EINVAL;
    }
    ...
    QEDI_ERR(core::ptr::null_mut(), "Could not register qedi transport");
    rc = -ENOMEM;
    ...
    if (rc) {
    QEDI_ERR(core::ptr::null_mut(), "Failed to register driver\n");
    goto exit_qedi_hp;
    }
    return 0;
    exit_qedi_hp:
...
#[no_mangle]
unsafe extern "C" fn qedi_cleanup() -> void __exit {
