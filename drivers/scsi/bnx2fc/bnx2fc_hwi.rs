...
//! Source: drivers/scsi/bnx2fc/bnx2fc_hwi.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_stat_req(hba: *mut bnx2fc_hba) -> c_int {
    int bnx2fc_send_stat_req(struct bnx2fc_hba *hba)
    {
    struct fcoe_kwqe_stat stat_req;
    struct kwqe *kwqe_arr[2];
    let mut num_kwqes: c_int = 1;
    let mut rc: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_fw_fcoe_init_msg(hba: *mut bnx2fc_hba) -> c_int {
    ...
    let mut num_kwqes: c_int = 3;
    let mut rc: c_int = 0;
    if (!hba.cnic) {
    printk(KERN_ERR PFX "hba.cnic core::ptr::null_mut() during fcoe fw init\n");
    return -ENODEV;
    }
// fill init1 KWQE
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_fw_fcoe_destroy_msg(hba: *mut bnx2fc_hba) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_valid_lport(hba: *mut bnx2fc_hba, lport: *mut fc_lport) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_unsol_els_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_process_unsol_compl(tgt: *mut bnx2fc_rport, wqe: u16) {
    static void bnx2fc_process_unsol_compl(struct bnx2fc_rport *tgt, u16 wqe)
    {
    u8 num_rq;
    struct fcoe_err_report_entry *err_entry;
    unsigned char *rq_data;
    unsigned char *buf = core::ptr::null_mut(), *buf1;
    int i;
    u16 xid;
    u32 frame_len, len;
    struct bnx2fc_cmd *io_req = core::ptr::null_mut();
...
// REC_TOV is not a warning code
    ...
    u16 xid;
    u8  cmd_type;
    let mut rx_state: u8 = 0;
    spin_lock_bh(&tgt.tgt_lock);
    xid = wqe & FCOE_PEND_WQ_CQE_TASK_ID;
    io_req = (struct bnx2fc_cmd *)hba.cmd_mgr.cmds[xid];
    if (io_req == core::ptr::null_mut()) {
    printk(KERN_ERR PFX "ERROR? cq_compl - io_req is core::ptr::null_mut()\n");
    spin_unlock_bh(&tgt.tgt_lock);
    return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(FCOE_TASK_RX_STATE_ABTS_COMPLETED: rx_state ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_arm_cq(tgt: *mut bnx2fc_rport) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_pending_work(tgt: *mut bnx2fc_rport, wqe: c_uint) -> bool {
    static bool bnx2fc_pending_work(struct bnx2fc_rport *tgt, unsigned int wqe)
    {
    let mut cpu: c_uint = wqe % num_possible_cpus();
    ...
    struct bnx2fc_interface *interface = port.priv;
    struct bnx2fc_hba *hba = interface.hba;
    unsigned char *rq_data = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_process_new_cqes(tgt: *mut bnx2fc_rport) -> c_int {
    int bnx2fc_process_new_cqes(struct bnx2fc_rport *tgt)
    {
    struct fcoe_cqe *cq;
    u32 cq_cons;
    struct fcoe_cqe *cqe;
    let mut num_free_sqes: u32 = 0;
    let mut num_cqes: u32 = 0;
    u16 wqe;
//
...
//
    ...
    if (!tgt.cq) {
    printk(KERN_ERR PFX "process_new_cqes: cq is core::ptr::null_mut()\n");
...
//
    ...
    struct fcoe_kcqe *new_cqe_kcqe)
    {
    let mut conn_id: u32 = new_cqe_kcqe.fcoe_conn_id;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_init_failure(hba: *mut bnx2fc_hba, err_code: u32) {
    static void bnx2fc_init_failure(struct bnx2fc_hba *hba, u32 err_code)
    {
    switch (err_code) {
...
//
    ...
    let mut i: c_int = 0;
    struct fcoe_kcqe *kcqe = core::ptr::null_mut();
    while (i < num_cqe) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_add_2_sq(tgt: *mut bnx2fc_rport, xid: u16) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_ring_doorbell(tgt: *mut bnx2fc_rport) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_map_doorbell(tgt: *mut bnx2fc_rport) -> c_int {
    int bnx2fc_map_doorbell(struct bnx2fc_rport *tgt)
    {
    let mut context_id: u32 = tgt.context_id;
    struct fcoe_port *port = tgt.port;
    u32 reg_off;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_return_rqe(tgt: *mut bnx2fc_rport, num_items: u8) {
    void bnx2fc_return_rqe(struct bnx2fc_rport *tgt, u8 num_items)
    {
// return the rq buffer
    let mut next_prod_idx: u32 = tgt.rq_prod_idx + num_items;
...
// Wrap around RQ
    ...
    let mut task_type: u8 = FCOE_TASK_TYPE_SEQUENCE_CLEANUP;
    u8 orig_task_type;
    let mut orig_xid: u16 = orig_io_req.xid;
    let mut context_id: u32 = tgt.context_id;
    let mut phys_addr: u64 = (u64)orig_io_req.bd_tbl.bd_tbl_dma;
    let mut orig_offset: u32 = offset;
    int bd_count;
    int i;
...
// Multiple SGEs were used for this IO
    ...
    u16 orig_xid)
    {
    let mut task_type: u8 = FCOE_TASK_TYPE_EXCHANGE_CLEANUP;
...
// Rx Only
    ...
    struct fcoe_ext_mul_sges_ctx *sgl;
    let mut dev_type: c_int = tgt.dev_type;
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_setup_task_ctx(hba: *mut bnx2fc_hba) -> c_int {
...
//
    ...
    hba.task_ctx[i] = core::ptr::null_mut();
    }
    }
    kfree(hba.task_ctx_dma);
    hba.task_ctx_dma = core::ptr::null_mut();
    out2:
    kfree(hba.task_ctx);
    hba.task_ctx = core::ptr::null_mut();
    out1:
    dma_free_coherent(&hba.pcidev.dev, PAGE_SIZE,
    hba.task_ctx_bd_tbl, hba.task_ctx_bd_dma);
    hba.task_ctx_bd_tbl = core::ptr::null_mut();
    out:
    return rc;
    }
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_free_task_ctx(hba: *mut bnx2fc_hba) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_free_hash_table(hba: *mut bnx2fc_hba) {
    ...
    hba.hash_tbl_segments = core::ptr::null_mut();
    }
    if (hba.hash_tbl_pbl) {
    dma_free_coherent(&hba.pcidev.dev, PAGE_SIZE,
    hba.hash_tbl_pbl,
    hba.hash_tbl_pbl_dma);
    hba.hash_tbl_pbl = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn bnx2fc_allocate_hash_table(hba: *mut bnx2fc_hba) -> c_int {
    ...
    pbl = hba.hash_tbl_pbl;
    for (i = 0; i < segment_count; ++i) {
    let mut paddr: u64 = dma_segment_array[i];
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_setup_fw_resc(hba: *mut bnx2fc_hba) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_free_fw_resc(hba: *mut bnx2fc_hba) {
    ...
    hba.stats_buffer = core::ptr::null_mut();
    }
    if (hba.dummy_buffer) {
    dma_free_coherent(&hba.pcidev.dev, PAGE_SIZE,
    ...
    hba.t2_hash_tbl_ptr,
    hba.t2_hash_tbl_ptr_dma);
    hba.t2_hash_tbl_ptr = core::ptr::null_mut();
    }
    if (hba.t2_hash_tbl) {
    mem_size = BNX2FC_NUM_MAX_SESS *
    sizeof(struct fcoe_t2_hash_table_entry);
    ...
    hba.t2_hash_tbl = core::ptr::null_mut();
    }
