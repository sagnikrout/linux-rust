...
//! Source: drivers/scsi/bnx2fc/bnx2fc_tgt.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_upld_timer(t: *mut timer_list) {
    static void bnx2fc_upld_timer(struct timer_list *t)
    {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_ofld_timer(t: *mut timer_list) {
    static void bnx2fc_ofld_timer(struct timer_list *t)
    {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_ofld_wait(tgt: *mut bnx2fc_rport) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_flush_active_ios(tgt: *mut bnx2fc_rport) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_upld_wait(tgt: *mut bnx2fc_rport) {
...
//
    ...
    case RPORT_EV_READY:
    if (!rport) {
    printk(KERN_ERR PFX "rport is core::ptr::null_mut(): ERROR!\n");
    break;
    }
    rp = rport.dd_data;
...
//
    ...
    hba.next_conn_id = 0;
    while (hba.tgt_ofld_list[conn_id] != core::ptr::null_mut()) {
    conn_id++;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_free_conn_id(hba: *mut bnx2fc_hba, conn_id: u32) {
    static void bnx2fc_free_conn_id(struct bnx2fc_hba *hba, u32 conn_id)
    {
// called with hba mutex held
    spin_lock_bh(&hba.hba_lock);
    hba.tgt_ofld_list[conn_id] = core::ptr::null_mut();
    spin_unlock_bh(&hba.hba_lock);
    }
//
