...
//! Source: drivers/scsi/bnx2fc/bnx2fc_fcoe.c
#![no_std]
...
pub const BNX2FC_MAX_QUEUE_DEPTH: c_int = 256;
pub const BNX2FC_MIN_QUEUE_DEPTH: c_int = 32;
...
// phys_dev);
    ...
    "attached via bnx2fc.");
    let mut bnx2fc_max_luns: static uint = BNX2FC_MAX_LUN;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_fcf_get_vlan_id(fcf_dev: *mut fcoe_fcf_device) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_clean_rx_queue(lp: *mut fc_lport) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_get_paged_crc_eof(skb: *mut sk_buff, tlen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_abort_io(lport: *mut fc_lport) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_cleanup(lport: *mut fc_lport) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_xmit(lport: *mut fc_lport, fp: *mut fc_frame) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fcoe_start_io(skb)) -> else {
...
//
    ...
    ctlr = bnx2fc_to_ctlr(interface);
    lport = ctlr.lp;
    if (unlikely(lport == core::ptr::null_mut())) {
    printk(KERN_ERR PFX "bnx2fc_rcv: lport is core::ptr::null_mut()\n");
    goto err;
    }
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_l2_rcv_thread(arg: *mut c_void) -> c_int {
    ...
    schedule();
    spin_lock_bh(&bg.fcoe_rx_list.lock);
    while ((skb = __skb_dequeue(&bg.fcoe_rx_list)) != core::ptr::null_mut()) {
    spin_unlock_bh(&bg.fcoe_rx_list.lock);
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_recv_frame(skb: *mut sk_buff) {
    static void bnx2fc_recv_frame(struct sk_buff *skb)
    {
    u64 crc_err;
    u32 fr_len, fr_crc;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_percpu_io_thread(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_shost_config(lport: *mut fc_lport, dev: *mut device) -> c_int {
    static int bnx2fc_shost_config(struct fc_lport *lport, struct device *dev)
    {
    struct fcoe_port *port = lport_priv(lport);
    struct bnx2fc_interface *interface = port.priv;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_link_ok(lport: *mut fc_lport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_get_link_state(hba: *mut bnx2fc_hba) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_net_config(lport: *mut fc_lport, netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_destroy_timer(t: *mut timer_list) {
...
//
    ...
    struct fcoe_ctlr *ctlr;
    let mut wait_for_upload: c_int = 0;
    let mut link_possible: u32 = 1;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_libfc_config(lport: *mut fc_lport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_em_config(lport: *mut fc_lport, hba: *mut bnx2fc_hba) -> c_int {
    static int bnx2fc_em_config(struct fc_lport *lport, struct bnx2fc_hba *hba)
    {
    ...
    fcoe_max_xid, core::ptr::null_mut())) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_lport_config(lport: *mut fc_lport) -> c_int {
    static int bnx2fc_lport_config(struct fc_lport *lport)
    {
    lport.link_up = 0;
    lport.qfull = 0;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_update_src_mac(lport: *mut fc_lport, addr: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_fip_send(fip: *mut fcoe_ctlr, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_vport_create(vport: *mut fc_vport, disabled: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_free_vport(hba: *mut bnx2fc_hba, lport: *mut fc_lport) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_vport_destroy(vport: *mut fc_vport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_vport_disable(vport: *mut fc_vport, disable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_interface_setup(interface: *mut bnx2fc_interface) -> c_int {
...
unsafe extern "C" fn bnx2fc_attach_transport() -> c_int {
    ...
    if (bnx2fc_vport_xport_template == core::ptr::null_mut()) {
    printk(KERN_ERR PFX
    "Failed to attach FC transport for vport\n");
    fc_release_transport(bnx2fc_transport_template);
    bnx2fc_transport_template = core::ptr::null_mut();
    return -ENODEV;
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bnx2fc_release_transport() {
    static void bnx2fc_release_transport(void)
    {
    fc_release_transport(bnx2fc_transport_template);
    fc_release_transport(bnx2fc_vport_xport_template);
    bnx2fc_transport_template = core::ptr::null_mut();
    bnx2fc_vport_xport_template = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn bnx2fc_interface_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_interface_get(interface: *mut bnx2fc_interface) {
    static inline void bnx2fc_interface_get(struct bnx2fc_interface *interface)
    {
    kref_get(&interface.kref);
    }
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_interface_put(interface: *mut bnx2fc_interface) {
    static inline void bnx2fc_interface_put(struct bnx2fc_interface *interface)
    {
    kref_put(&interface.kref, bnx2fc_interface_release);
    }
#[no_mangle]
unsafe extern "C" fn bnx2fc_hba_destroy(hba: *mut bnx2fc_hba) {
    static void bnx2fc_hba_destroy(struct bnx2fc_hba *hba)
    {
// Free the command manager
    if (hba.cmd_mgr) {
    bnx2fc_cmd_mgr_free(hba.cmd_mgr);
    hba.cmd_mgr = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_net_cleanup(interface: *mut bnx2fc_interface) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_interface_cleanup(interface: *mut bnx2fc_interface) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_if_destroy(lport: *mut fc_lport) {
...
#[no_mangle]
unsafe extern "C" fn __bnx2fc_destroy(interface: *mut bnx2fc_interface) {
    static void __bnx2fc_destroy(struct bnx2fc_interface *interface)
    {
    struct fcoe_ctlr *ctlr = bnx2fc_to_ctlr(interface);
    struct fc_lport *lport = ctlr.lp;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_destroy(netdev: *mut net_device) -> c_int {
    static int bnx2fc_destroy(struct net_device *netdev)
    {
    struct bnx2fc_interface *interface = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_port_destroy(port: *mut fcoe_port) {
    static void bnx2fc_port_destroy(struct fcoe_port *port)
    {
    struct fc_lport *lport;
    lport = port.lport;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_unbind_adapter_devices(hba: *mut bnx2fc_hba) {
    static void bnx2fc_unbind_adapter_devices(struct bnx2fc_hba *hba)
    {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_bind_adapter_devices(hba: *mut bnx2fc_hba) -> c_int {
    static int bnx2fc_bind_adapter_devices(struct bnx2fc_hba *hba)
    {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_bind_pcidev(hba: *mut bnx2fc_hba) -> c_int {
    static int bnx2fc_bind_pcidev(struct bnx2fc_hba *hba)
    {
    struct cnic_dev *cnic;
    struct pci_dev *pdev;
    if (!hba.cnic) {
    printk(KERN_ERR PFX "cnic is core::ptr::null_mut()\n");
    return -ENODEV;
    }
    cnic = hba.cnic;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_unbind_pcidev(hba: *mut bnx2fc_hba) {
    static void bnx2fc_unbind_pcidev(struct bnx2fc_hba *hba)
    {
    if (hba.pcidev) {
    hba.chip_num[0] = '\0';
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_ulp_get_stats(handle: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_ulp_start(handle: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_port_shutdown(lport: *mut fc_lport) {
    static void bnx2fc_port_shutdown(struct fc_lport *lport)
    {
    BNX2FC_MISC_DBG("Entered %s\n", __func__);
    fc_fabric_logoff(lport);
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_stop(interface: *mut bnx2fc_interface) {
    static void bnx2fc_stop(struct bnx2fc_interface *interface)
    {
    struct fcoe_ctlr *ctlr = bnx2fc_to_ctlr(interface);
    struct fc_lport *lport;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_fw_init(hba: *mut bnx2fc_hba) -> c_int {
    static int bnx2fc_fw_init(struct bnx2fc_hba *hba)
    {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_fw_destroy(hba: *mut bnx2fc_hba) {
    static void bnx2fc_fw_destroy(struct bnx2fc_hba *hba)
    {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_ulp_stop(handle: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_start_disc(interface: *mut bnx2fc_interface) {
    static void bnx2fc_start_disc(struct bnx2fc_interface *interface)
    {
    struct fcoe_ctlr *ctlr = bnx2fc_to_ctlr(interface);
    struct fc_lport *lport;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_ulp_init(dev: *mut cnic_dev) {
...
#[no_mangle]
unsafe extern "C" fn __bnx2fc_disable(ctlr: *mut fcoe_ctlr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_disable(netdev: *mut net_device) -> c_int {
    static int bnx2fc_disable(struct net_device *netdev)
    {
    struct bnx2fc_interface *interface;
    struct fcoe_ctlr *ctlr;
...
#[no_mangle]
unsafe extern "C" fn __bnx2fc_enable(ctlr: *mut fcoe_ctlr) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_enable(netdev: *mut net_device) -> c_int {
    static int bnx2fc_enable(struct net_device *netdev)
    {
    struct bnx2fc_interface *interface;
    struct fcoe_ctlr *ctlr;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_ctlr_enabled(cdev: *mut fcoe_ctlr_device) -> c_int {
    static int bnx2fc_ctlr_enabled(struct fcoe_ctlr_device *cdev)
    {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_create(netdev: *mut net_device, fip_mode: enum fip_mode) -> c_int {
    static int bnx2fc_create(struct net_device *netdev, enum fip_mode fip_mode)
    {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_ctlr_alloc(netdev: *mut net_device) -> c_int {
    static int bnx2fc_ctlr_alloc(struct net_device *netdev)
    {
...
// Called with bnx2fc_dev_lock held
    ...
    printk(KERN_ERR PFX "adapter_lookup: hba core::ptr::null_mut()\n");
    return core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_ulp_exit(dev: *mut cnic_dev) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_rport_terminate_io(rport: *mut fc_rport) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_fcoe_reset(shost: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_match(netdev: *mut net_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_cpu_offline(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2fc_mod_init() -> int __init {
    static int __init bnx2fc_mod_init(void)
    {
    struct fcoe_percpu_s *bg;
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_mod_exit() -> void __exit {
    static void __exit bnx2fc_mod_exit(void)
    {
