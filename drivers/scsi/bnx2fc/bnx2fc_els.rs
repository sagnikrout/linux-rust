...
//! Source: drivers/scsi/bnx2fc/bnx2fc_els.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_rrq_compl(cb_arg: *mut bnx2fc_els_cb_arg) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_rrq(aborted_io_req: *mut bnx2fc_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_l2_els_compl(cb_arg: *mut bnx2fc_els_cb_arg) {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_adisc(tgt: *mut bnx2fc_rport, fp: *mut fc_frame) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_logo(tgt: *mut bnx2fc_rport, fp: *mut fc_frame) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_rls(tgt: *mut bnx2fc_rport, fp: *mut fc_frame) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_srr_compl(cb_arg: *mut bnx2fc_els_cb_arg) {
...
// SRR timedout
    ...
    memcpy(buf, fc_hdr, hdr_len);
    memcpy(buf + hdr_len, resp_buf, resp_len);
    fp = fc_frame_alloc(core::ptr::null_mut(), resp_len);
    if (!fp) {
...
#[no_mangle]
unsafe extern "C" fn bnx2fc_rec_compl(cb_arg: *mut bnx2fc_els_cb_arg) {
    ...
    u32 resp_len, hdr_len;
    let mut rc: c_int = 0;
    let mut send_seq_clnp: bool = false;
    let mut abort_io: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_rec(orig_io_req: *mut bnx2fc_cmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bnx2fc_send_srr(orig_io_req: *mut bnx2fc_cmd, offset: u32, r_ctl: u8) -> c_int {
...
pub const BNX2FC_FCOE_MAC_METHOD_GRANGED_MAC: c_int = 1;
pub const BNX2FC_FCOE_MAC_METHOD_FCF_MAP: c_int = 2;
pub const BNX2FC_FCOE_MAC_METHOD_FCOE_SET_MAC: c_int = 3;
    static void bnx2fc_flogi_resp(struct fc_seq *seq, struct fc_frame *fp,
    void *arg)
    {
