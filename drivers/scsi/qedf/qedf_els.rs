...
//! Source: drivers/scsi/qedf/qedf_els.c
#![no_std]
...
// It's assumed that the lock is held when calling this function.
    ...
    "0x%p cb_arg = %p xid = %x\n", els_req, cb_arg,
    els_req.xid);
    els_req.sc_cmd = core::ptr::null_mut();
...
// Fill ELS Payload
    ...
    els_req.cb_func = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qedf_rrq_compl(cb_arg: *mut qedf_els_cb_arg) {
    ...
    "Original io_req is core::ptr::null_mut(), rrq_req = %p.\n", rrq_req);
    goto out_free;
    }
...
#[no_mangle]
pub unsafe extern "C" fn qedf_send_rrq(aborted_io_req: *mut qedf_ioreq) -> c_int {
    int qedf_send_rrq(struct qedf_ioreq *aborted_io_req)
    {
    struct fc_els_rrq rrq;
    struct qedf_rport *fcport;
    struct fc_lport *lport;
    struct qedf_els_cb_arg *cb_arg = core::ptr::null_mut();
    struct qedf_ctx *qedf;
    uint32_t sid;
    uint32_t r_a_tov;
    int rc;
    int refcount;
    if (!aborted_io_req) {
    QEDF_ERR(core::ptr::null_mut(), "abort_io_req is core::ptr::null_mut().\n");
    return -EINVAL;
    }
...
// Check that fcport is still offloaded
    ...
    if (!fcport.qedf) {
    QEDF_ERR(core::ptr::null_mut(), "fcport.qedf is core::ptr::null_mut().\n");
    return -EINVAL;
    }
    qedf = fcport.qedf;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn qedf_restart_rport(fcport: *mut qedf_rport) {
...
#[no_mangle]
unsafe extern "C" fn qedf_l2_els_compl(cb_arg: *mut qedf_els_cb_arg) {
    ...
    if (!els_req) {
    QEDF_ERR(core::ptr::null_mut(), "els_req is core::ptr::null_mut().\n");
    goto free_arg;
    }
//
...
//
    if (els_req.event == QEDF_IOREQ_EV_ELS_FLUSH) {
    QEDF_ERR(core::ptr::null_mut(), "els_req xid=0x%x event is flush.\n",
    els_req.xid);
    goto free_arg;
    }
    fcport = els_req.fcport;
...
#[no_mangle]
pub unsafe extern "C" fn qedf_send_adisc(fcport: *mut qedf_rport, fp: *mut fc_frame) -> c_int {
    ...
    struct qedf_els_cb_arg *cb_arg = core::ptr::null_mut();
    struct qedf_ctx *qedf;
    let mut r_a_tov: u32 = lport.r_a_tov;
    int rc;
    qedf = fcport.qedf;
...
#[no_mangle]
unsafe extern "C" fn qedf_srr_compl(cb_arg: *mut qedf_els_cb_arg) {
    ...
    orig_io_req = cb_arg.aborted_io_req;
    if (!orig_io_req) {
    QEDF_ERR(core::ptr::null_mut(), "orig_io_req is core::ptr::null_mut().\n");
    goto out_free;
    }
...
#[no_mangle]
unsafe extern "C" fn qedf_send_srr(orig_io_req: *mut qedf_ioreq, offset: u32, r_ctl: u8) -> c_int {
...
// If we timed out just free resources
    ...
    QEDF_ERR(&qedf.dbg_ctx,
    "cqe is core::ptr::null_mut() or timeout event (0x%x)", io_req.event);
    goto free;
    }
...
#[no_mangle]
unsafe extern "C" fn qedf_requeue_io_req(orig_io_req: *mut qedf_ioreq) -> bool {
    ...
    QEDF_ERR(&(fcport.qedf.dbg_ctx), "sc_cmd is core::ptr::null_mut() for "
    "xid=0x%x.\n", orig_io_req.xid);
    goto out;
    }
...
// for it.
//
    orig_io_req.sc_cmd = core::ptr::null_mut();
    kref_put(&orig_io_req.refcount, qedf_release_cmd);
    spin_lock_irqsave(&fcport.rport_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn qedf_rec_compl(cb_arg: *mut qedf_els_cb_arg) {
...
//
    ...
    if (!sc_cmd) {
    QEDF_INFO(&(qedf.dbg_ctx), QEDF_LOG_ELS,
    "sc_cmd is core::ptr::null_mut() for xid=0x%x.\n",
    orig_io_req.xid);
    goto out_free_frame;
    }
// SCSI write case
...
// Assumes kref is already held by caller
#[no_mangle]
pub unsafe extern "C" fn qedf_send_rec(orig_io_req: *mut qedf_ioreq) -> c_int {
