...
//! Source: drivers/scsi/qedf/qedf_main.c
#![no_std]
...
//
    let mut qedf_dev_loss_tmo: static unsigned int = 60;
    ...
    let mut qedf_debug: c_uint = QEDF_LOG_INFO;
    ...
    " mask");
    let mut qedf_fipvlan_retries: static uint = 60;
    ...
    let mut qedf_fallback_vlan: static uint = QEDF_FALLBACK_VLAN;
    ...
    "(default 1002).");
    let mut qedf_default_prio: static int = -1;
    ...
    let mut qedf_max_lun: static uint = MAX_FIBRE_LUNS;
    ...
    let mut qedf_dp_level: static uint = QED_LEVEL_NOTICE;
    module_param_named(dp_level, qedf_dp_level, uint, S_IRUGO);
    MODULE_PARM_DESC(dp_level, " printk verbosity control passed to qed module  "
    "during probe (0-3: 0 more verbose).");
    let mut qedf_enable_recovery: static bool = true;
...
#[no_mangle]
pub unsafe extern "C" fn qedf_set_vlan_id(qedf: *mut qedf_ctx, vlan_id: c_int) {
    void qedf_set_vlan_id(struct qedf_ctx *qedf, int vlan_id)
    {
    let mut vlan_id_tmp: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn qedf_initiate_fipvlan_req(qedf: *mut qedf_ctx) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qedf_handle_link_update(work: *mut work_struct) {
...
pub const QEDF_FCOE_MAC_METHOD_GRANGED_MAC: c_int = 1;
pub const QEDF_FCOE_MAC_METHOD_FCF_MAP: c_int = 2;
pub const QEDF_FCOE_MAC_METHOD_FCOE_SET_MAC: c_int = 3;
#[no_mangle]
unsafe extern "C" fn qedf_set_data_src_addr(qedf: *mut qedf_ctx, fp: *mut fc_frame) {
...
//
    ...
    if (!qedf) {
    QEDF_ERR(core::ptr::null_mut(), "qedf is core::ptr::null_mut().\n");
    return;
    }
//
...
// Log stats for FLOGI reject
    ...
    qedf.flogi_failed++;
#[no_mangle]
pub unsafe extern "C" fn if(ELS_LS_ACC: fc_frame_payload_op(fp) ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn qedf_send_flogi(qedf: *mut qedf_ctx) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qedf_link_recovery(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qedf_bw_update(dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn qedf_link_update(dev: *mut c_void, link: *mut qed_link_output) {
...
#[no_mangle]
unsafe extern "C" fn qedf_dcbx_handler(dev: *mut c_void, get: *mut qed_dcbx_get, mib_type: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(7: tmp_prio >) -> else {
    QEDF_INFO(&(qedf.dbg_ctx), QEDF_LOG_DISC,
...
#[no_mangle]
unsafe extern "C" fn qedf_get_login_failures(cookie: *mut c_void) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn qedf_eh_abort(sc_cmd: *mut scsi_cmnd) -> c_int {
    ...
    struct fc_rport_priv *rdata;
    struct qedf_rport *fcport = core::ptr::null_mut();
    let mut rc: c_int = FAILED;
    let mut wait_count: c_int = 100;
    let mut refcount: c_int = 0;
    int rval;
    let mut got_ref: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn qedf_eh_target_reset(sc_cmd: *mut scsi_cmnd) -> c_int {
    static int qedf_eh_target_reset(struct scsi_cmnd *sc_cmd)
    {
    struct scsi_target *starget = scsi_target(sc_cmd.device);
    struct fc_rport *rport = starget_to_rport(starget);
    QEDF_ERR(core::ptr::null_mut(), "TARGET RESET Issued...");
    return qedf_initiate_tmf(rport, 0, FCP_TMF_TGT_RESET);
    }
#[no_mangle]
unsafe extern "C" fn qedf_eh_device_reset(sc_cmd: *mut scsi_cmnd) -> c_int {
    static int qedf_eh_device_reset(struct scsi_cmnd *sc_cmd)
    {
    struct fc_rport *rport = starget_to_rport(scsi_target(sc_cmd.device));
    QEDF_ERR(core::ptr::null_mut(), "LUN RESET Issued...\n");
    return qedf_initiate_tmf(rport, sc_cmd.device.lun, FCP_TMF_LUN_RESET);
    }
#[no_mangle]
pub unsafe extern "C" fn qedf_wait_for_upload(qedf: *mut qedf_ctx) -> bool {
    bool qedf_wait_for_upload(struct qedf_ctx *qedf)
    {
    struct qedf_rport *fcport;
    let mut wait_cnt: c_int = 120;
    while (wait_cnt--) {
...
#[no_mangle]
pub unsafe extern "C" fn qedf_ctx_soft_reset(lport: *mut fc_lport) {
...
#[no_mangle]
unsafe extern "C" fn qedf_eh_host_reset(sc_cmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_get_paged_crc_eof(skb: *mut sk_buff, tlen: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_xmit_l2_frame(fcport: *mut qedf_rport, fp: *mut fc_frame) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qedf_xmit(lport: *mut fc_lport, fp: *mut fc_frame) -> c_int {
    ...
    struct fc_lport *vn_port = core::ptr::null_mut();
    struct qedf_rport *fcport;
    int rc;
...
//
    ...
    struct fc_rport_priv *rdata = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qedf_alloc_sq(qedf: *mut qedf_ctx, fcport: *mut qedf_rport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_free_sq(qedf: *mut qedf_ctx, fcport: *mut qedf_rport) {
    ...
    u32 port_id;
    int rval;
    let mut total_sqe: u16 = (fcport.sq_mem_size / sizeof(struct fcoe_wqe));
...
pub const QEDF_TERM_BUFF_SIZE: c_int = 10;
...
// Flush any remaining i/o's before we upload the connection
    ...
    fcport.rdata = core::ptr::null_mut();
    fcport.qedf = core::ptr::null_mut();
    kref_put(&rdata.kref, fc_rport_destroy);
    }
//
...
//
    ...
    case RPORT_EV_READY:
    if (!rport) {
    QEDF_WARN(&(qedf.dbg_ctx), "rport is core::ptr::null_mut().\n");
    break;
    }
    rp = rport.dd_data;
    fcport = (struct qedf_rport *)&rp[1];
...
#[no_mangle]
unsafe extern "C" fn qedf_abort_io(lport: *mut fc_lport) {
    static void qedf_abort_io(struct fc_lport *lport)
    {
// NO-OP but need to fill in the template
    }
#[no_mangle]
unsafe extern "C" fn qedf_fcp_cleanup(lport: *mut fc_lport) {
...
#[no_mangle]
unsafe extern "C" fn qedf_fcoe_ctlr_setup(qedf: *mut qedf_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedf_setup_fdmi(qedf: *mut qedf_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedf_lport_setup(qedf: *mut qedf_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_vport_create(vport: *mut fc_vport, disabled: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_vport_destroy(vport: *mut fc_vport) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_vport_disable(vport: *mut fc_vport, disable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qedf_wait_for_vport_destroy(qedf: *mut qedf_ctx) {
...
//
#[no_mangle]
unsafe extern "C" fn qedf_fcoe_reset(shost: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_get_host_port_id(shost: *mut Scsi_Host) {
...
#[no_mangle]
unsafe extern "C" fn qedf_fp_has_work(fp: *mut qedf_fastpath) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn qedf_process_completions(fp: *mut qedf_fastpath) -> bool {
    ...
    unsigned int cpu;
    struct qedf_ioreq *io_req = core::ptr::null_mut();
    u16 xid;
    u16 new_cqes;
    u32 comp_type;
// Get the current firmware producer index
...
// Copy contents of CQE for deferred processing
    ...
    io_work.fp = core::ptr::null_mut(); /* Only used for unsolicited frames */
...
#[no_mangle]
unsafe extern "C" fn qedf_msix_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t qedf_msix_handler(int irq, void *dev_id)
    {
    struct qedf_fastpath *fp = dev_id;
    if (!fp) {
    QEDF_ERR(core::ptr::null_mut(), "fp is null.\n");
    return IRQ_HANDLED;
    }
    if (!fp.sb_info) {
    QEDF_ERR(core::ptr::null_mut(), "fp.sb_info in null.");
    return IRQ_HANDLED;
    }
//
...
#[no_mangle]
unsafe extern "C" fn qedf_simd_int_handler(cookie: *mut c_void) {
...
pub const QEDF_SIMD_HANDLER_NUM: c_int = 0;
#[no_mangle]
unsafe extern "C" fn qedf_sync_free_irqs(qedf: *mut qedf_ctx) {
    static void qedf_sync_free_irqs(struct qedf_ctx *qedf)
    {
    int i;
    let mut vector_idx: u16 = 0;
    u32 vector;
    ...
    irq_set_affinity_hint(vector, core::ptr::null_mut());
    irq_set_affinity_notifier(vector, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qedf_request_msix_irq(qedf: *mut qedf_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_setup_int(qedf: *mut qedf_ctx) -> c_int {
...
// Main function for libfc frame reception
    ...
    struct fc_frame *fp;
    u8 *mac = core::ptr::null_mut();
    u8 *dest_mac = core::ptr::null_mut();
    struct fcoe_hdr *hp;
    struct qedf_rport *fcport;
    struct fc_lport *vn_port;
    u32 f_ctl;
    lport = qedf.lport;
    if (lport == core::ptr::null_mut() || lport.state == LPORT_ST_DISABLED) {
    QEDF_WARN(core::ptr::null_mut(), "Invalid lport struct or lport disabled.\n");
    kfree_skb(skb);
    return;
    }
    if (skb_is_nonlinear(skb))
...
// Pull the header
    ...
    QEDF_INFO(core::ptr::null_mut(), QEDF_LOG_LL2, "skb_copy_bits failed.\n");
    kfree_skb(skb);
    return;
    }
    ...
    QEDF_INFO(core::ptr::null_mut(), QEDF_LOG_LL2, "pskb_trim failed.\n");
    kfree_skb(skb);
    return;
    }
    fh = fc_frame_header_get(fp);
...
#[no_mangle]
unsafe extern "C" fn qedf_ll2_process_skb(work: *mut work_struct) {
...
//
    ...
    .rx_cb = qedf_ll2_rx,
    .tx_cb = core::ptr::null_mut(),
    };
// Main thread to process I/O completions
#[no_mangle]
pub unsafe extern "C" fn qedf_fp_io_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qedf_free_sb(qedf: *mut qedf_ctx, sb_info: *mut qed_sb_info) {
...
#[no_mangle]
unsafe extern "C" fn qedf_destroy_sb(qedf: *mut qedf_ctx) {
    static void qedf_destroy_sb(struct qedf_ctx *qedf)
    {
    int id;
    struct qedf_fastpath *fp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qedf_prepare_sb(qedf: *mut qedf_ctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qedf_process_cqe(qedf: *mut qedf_ctx, cqe: *mut fcoe_cqe) {
...
// Completion not for a valid I/O anymore so just return
    if (!io_req) {
    QEDF_ERR(&qedf.dbg_ctx,
    "io_req is core::ptr::null_mut() for xid=0x%x.\n", xid);
    return;
    }
    fcport = io_req.fcport;
    if (fcport == core::ptr::null_mut()) {
    QEDF_ERR(&qedf.dbg_ctx,
    "fcport is core::ptr::null_mut() for xid=0x%x io_req=%p.\n",
    xid, io_req);
    return;
    }
//
...
#[no_mangle]
unsafe extern "C" fn qedf_free_bdq(qedf: *mut qedf_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedf_free_global_queues(qedf: *mut qedf_ctx) {
...
#[no_mangle]
unsafe extern "C" fn qedf_alloc_bdq(qedf: *mut qedf_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_alloc_global_queues(qedf: *mut qedf_ctx) -> c_int {
...
//
    if (!qedf.p_cpuq) {
    QEDF_ERR(&qedf.dbg_ctx, "p_cpuq is core::ptr::null_mut().\n");
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn qedf_set_fcoe_pf_param(qedf: *mut qedf_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qedf_free_fcoe_pf_param(qedf: *mut qedf_ctx) {
...
#[no_mangle]
unsafe extern "C" fn __qedf_probe(pdev: *mut pci_dev, mode: c_int) -> c_int {
...
//
    ...
    if (!lport) {
    QEDF_ERR(core::ptr::null_mut(), "Could not allocate lport.\n");
    rc = -ENOMEM;
    goto err0;
    }
    fc_disc_init(lport);
...
// Allocate mempool for qedf_io_work structs
    ...
    qedf_io_work_cache);
    if (qedf.io_mempool == core::ptr::null_mut()) {
    QEDF_ERR(&(qedf.dbg_ctx), "qedf.io_mempool is core::ptr::null_mut().\n");
    goto err1;
    }
...
// Learn information crucial for qedf to progress
    ...
    qedf.devlink = core::ptr::null_mut();
    goto err2;
    }
    }
...
//
    ...
    qedf.grcdump = core::ptr::null_mut();
    }
    QEDF_INFO(&(qedf.dbg_ctx), QEDF_LOG_DISC,
...
#[no_mangle]
unsafe extern "C" fn qedf_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int qedf_probe(struct pci_dev *pdev, const struct pci_device_id *id)
    {
    return __qedf_probe(pdev, QEDF_MODE_NORMAL);
    }
#[no_mangle]
unsafe extern "C" fn __qedf_remove(pdev: *mut pci_dev, mode: c_int) {
    ...
    let mut cnt: c_int = 0;
    if (!pdev) {
    QEDF_ERR(core::ptr::null_mut(), "pdev is core::ptr::null_mut().\n");
    return;
    }
    qedf = pci_get_drvdata(pdev);
//
...
// Stop any link update handling
    ...
    qedf.link_update_wq = core::ptr::null_mut();
    if (qedf.timer_work_queue)
...
#[no_mangle]
unsafe extern "C" fn qedf_remove(pdev: *mut pci_dev) {
    static void qedf_remove(struct pci_dev *pdev)
    {
...
#[no_mangle]
pub unsafe extern "C" fn qedf_wq_grcdump(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn qedf_schedule_hw_err_handler(dev: *mut c_void, err_type: enum qed_hw_err_type) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qedf_get_protocol_tlv_data(dev: *mut c_void, data: *mut c_void) {
    ...
    if (!qedf) {
    QEDF_ERR(core::ptr::null_mut(), "qedf is null.\n");
    return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn qedf_stag_change_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qedf_shutdown(pdev: *mut pci_dev) {
    static void qedf_shutdown(struct pci_dev *pdev)
    {
    __qedf_remove(pdev, QEDF_MODE_NORMAL);
    }
#[no_mangle]
unsafe extern "C" fn qedf_suspend(pdev: *mut pci_dev, state: pm_message_t) -> c_int {
    static int qedf_suspend(struct pci_dev *pdev, pm_message_t state)
    {
    struct qedf_ctx *qedf;
    if (!pdev) {
...
//
#[no_mangle]
unsafe extern "C" fn qedf_schedule_recovery_handler(dev: *mut c_void) {
    static void qedf_schedule_recovery_handler(void *dev)
    {
    struct qedf_ctx *qedf = dev;
...
#[no_mangle]
unsafe extern "C" fn qedf_recovery_handler(work: *mut work_struct) {
    static void qedf_recovery_handler(struct work_struct *work)
    {
    struct qedf_ctx *qedf =
...
#[no_mangle]
pub unsafe extern "C" fn qedf_get_generic_tlv_data(dev: *mut c_void, data: *mut qed_generic_tlvs) {
    void qedf_get_generic_tlv_data(void *dev, struct qed_generic_tlvs *data)
    {
    struct qedf_ctx *qedf;
    if (!dev) {
    QEDF_INFO(core::ptr::null_mut(), QEDF_LOG_EVT,
    "dev is core::ptr::null_mut() so ignoring get_generic_tlv_data request.\n");
    return;
    }
...
//
#[no_mangle]
unsafe extern "C" fn qedf_init() -> int __init {
...
//
    ...
    QEDF_ERR(core::ptr::null_mut(), "FCoE/FIP priority out of range, resetting to %d.\n",
    QEDF_DEFAULT_PRIO);
    }
// Print driver banner
    QEDF_INFO(core::ptr::null_mut(), QEDF_LOG_INFO, "%s v%s.\n", QEDF_DESCR,
    QEDF_VERSION);
// Create kmem_cache for qedf_io_work structs
    qedf_io_work_cache = kmem_cache_create("qedf_io_work_cache",
    sizeof(struct qedf_io_work), 0, SLAB_HWCACHE_ALIGN, core::ptr::null_mut());
    if (qedf_io_work_cache == core::ptr::null_mut()) {
    QEDF_ERR(core::ptr::null_mut(), "qedf_io_work_cache is core::ptr::null_mut().\n");
    goto err1;
    }
    QEDF_INFO(core::ptr::null_mut(), QEDF_LOG_DISC, "qedf_io_work_cache=%p.\n",
    qedf_io_work_cache);
    qed_ops = qed_get_fcoe_ops();
    if (!qed_ops) {
    QEDF_ERR(core::ptr::null_mut(), "Failed to get qed fcoe operations\n");
    goto err1;
    }
    ...
    QEDF_ERR(core::ptr::null_mut(), "Could not register with FC transport\n");
    goto err2;
    }
    qedf_fc_vport_transport_template =
    fc_attach_transport(&qedf_fc_vport_transport_fn);
    if (!qedf_fc_vport_transport_template) {
    QEDF_ERR(core::ptr::null_mut(), "Could not register vport template with FC "
    "transport\n");
    goto err3;
    }
    ...
    "qedf_io_wq");
    if (!qedf_io_wq) {
    QEDF_ERR(core::ptr::null_mut(), "Could not create qedf_io_wq.\n");
    goto err4;
    }
    qedf_cb_ops.get_login_failures = qedf_get_login_failures;
    ret = pci_register_driver(&qedf_pci_driver);
    if (ret) {
    QEDF_ERR(core::ptr::null_mut(), "Failed to register driver\n");
    goto err5;
    }
    return 0;
    err5:
...
#[no_mangle]
unsafe extern "C" fn qedf_cleanup() -> void __exit {
