...
//! Source: drivers/scsi/qedf/qedf_debugfs.c
#![no_std]
...
// remove debugfs  entries of this PF
    ...
    qedf_dbg.bdf_dentry = core::ptr::null_mut();
    }
//
...
//
    ...
    {
    QEDF_INFO(core::ptr::null_mut(), QEDF_LOG_DEBUGFS, "Creating debugfs root node\n");
// create qed dir in root of debugfs. NULL means debugfs root
    qedf_dbg_root = debugfs_create_dir(drv_name, core::ptr::null_mut());
    }
//
...
//
    ...
    qedf_dbg_exit(void)
    {
    QEDF_INFO(core::ptr::null_mut(), QEDF_LOG_DEBUGFS, "Destroying debugfs root "
    "entry\n");
// remove qed dir in root of debugfs
    debugfs_remove_recursive(qedf_dbg_root);
    qedf_dbg_root = core::ptr::null_mut();
    }
    const struct qedf_debugfs_ops qedf_debugfs_ops[] = {
    { "fp_int", core::ptr::null_mut() },
    { "io_trace", core::ptr::null_mut() },
    { "debug", core::ptr::null_mut() },
    { "stop_io_on_error", core::ptr::null_mut()},
    { "driver_stats", core::ptr::null_mut()},
    { "clear_stats", core::ptr::null_mut()},
    { "offload_stats", core::ptr::null_mut()},
// This must be last
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(kern_buf, _arg: "true", 0: 4) ==) -> else {
    else if (strncmp(kern_buf, "true", 4) == 0)
    qedf.stop_io_on_error = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(kern_buf, _arg: "now", 0: 3) ==) -> else {
