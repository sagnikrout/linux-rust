...
//! Source: drivers/scsi/mpt3sas/mpt3sas_hwmon.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn _hwmon_to_mdegc(raw: i16, units: u8, out: *mut c_long) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpt3sas_hwmon_register(ioc: *mut MPT3SAS_ADAPTER) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpt3sas_hwmon_unregister(ioc: *mut MPT3SAS_ADAPTER) {
