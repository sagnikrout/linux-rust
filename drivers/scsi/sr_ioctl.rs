...
//! Source: drivers/scsi/sr_ioctl.c
#![no_std]
...
pub const IOCTL_RETRIES: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn sr_fake_playtrkind(cdi: *mut cdrom_device_info, ti: *mut cdrom_ti) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CDROM_LEADOUT: ti->cdti_trk1 !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn sr_do_ioctl(cd: *mut Scsi_CD, cgc: *mut packet_command) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sr_tray_move(cdi: *mut cdrom_device_info, pos: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sr_lock_door(cdi: *mut cdrom_device_info, lock: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sr_drive_status(cdi: *mut cdrom_device_info, slot: c_int) -> c_int {
...
// SK/ASC/ASCQ of 2/4/1 means "unit is becoming ready"
    ...
    return CDS_DISC_OK;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: med.door_open) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn sr_disk_status(cdi: *mut cdrom_device_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sr_get_mcn(cdi: *mut cdrom_device_info, mcn: *mut cdrom_mcn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sr_reset(cdi: *mut cdrom_device_info) -> c_int {
    int sr_reset(struct cdrom_device_info *cdi)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn sr_select_speed(cdi: *mut cdrom_device_info, speed: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sr_audio_ioctl(cdi: *mut cdrom_device_info, cmd: c_uint, arg: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sr_read_cd(cd: *mut Scsi_CD, dest: *mut c_uchar, lba: c_int, format: c_int, blksize: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sr_read_sector(cd: *mut Scsi_CD, lba: c_int, blksize: c_int, dest: *mut c_uchar) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sr_is_xa(cd: *mut Scsi_CD) -> c_int {
