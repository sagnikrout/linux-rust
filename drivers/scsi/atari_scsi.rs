...
//! Source: drivers/scsi/atari_scsi.c
#![no_std]
...
pub const DMA_MIN_SIZE: c_int = 32;
...
#[no_mangle]
pub unsafe extern "C" fn SCSI_DMA_SETADR(adr: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn SCSI_DMA_GETADR() -> c_ulong {
...
// mask for address bits that can't be used with the ST-DMA
    ...
    let mut setup_toshiba_delay: static int = -1;
    module_param(setup_toshiba_delay, int, 0);
#[no_mangle]
unsafe extern "C" fn scsi_dma_is_ignored_buserr(dma_stat: c_uchar) -> c_int {
    static int scsi_dma_is_ignored_buserr(unsigned char dma_stat)
    {
    int i;
    let mut addr: c_ulong = SCSI_DMA_READ_P(dma_addr), end_addr;
    if (dma_stat & 0x01) {
...
#[no_mangle]
unsafe extern "C" fn scsi_tt_intr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn scsi_falcon_intr(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
//
    ...
    atari_dma_orig_addr = core::ptr::null_mut();
    }
    NCR5380_intr(irq, dev);
    return IRQ_HANDLED;
    }
#[no_mangle]
unsafe extern "C" fn atari_scsi_fetch_restbytes() {
    static void atari_scsi_fetch_restbytes(void)
    {
    int nr;
    char *src, *dst;
...
//
#[no_mangle]
unsafe extern "C" fn falcon_release_lock() {
...
//
#[no_mangle]
unsafe extern "C" fn falcon_get_lock(instance: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atari_scsi_setup(str: *mut c_char) -> int __init {
...
// ints[6] (use_pdma) is ignored
    ...
    int dir)
    {
    let mut addr: c_ulong = virt_to_phys(data);
...
#[no_mangle]
unsafe extern "C" fn atari_scsi_dma_residual(hostdata: *mut NCR5380_hostdata) -> c_int {
    static int atari_scsi_dma_residual(struct NCR5380_hostdata *hostdata)
    {
    return atari_dma_residual;
    }
pub const CMD_SURELY_BLOCK_MODE: c_int = 0;
pub const CMD_SURELY_BYTE_MODE: c_int = 1;
pub const CMD_MODE_UNKNOWN: c_int = 2;
#[no_mangle]
unsafe extern "C" fn falcon_classify_cmd(cmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn atari_scsi_tt_reg_read(reg: c_uint) -> u8 {
    static u8 atari_scsi_tt_reg_read(unsigned int reg)
    {
    return tt_scsi_regp[reg * 2];
    }
#[no_mangle]
unsafe extern "C" fn atari_scsi_tt_reg_write(reg: c_uint, value: u8) {
    static void atari_scsi_tt_reg_write(unsigned int reg, u8 value)
    {
    tt_scsi_regp[reg * 2] = value;
    }
#[no_mangle]
unsafe extern "C" fn atari_scsi_falcon_reg_read(reg: c_uint) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn atari_scsi_falcon_reg_write(reg: c_uint, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn atari_scsi_host_reset(cmd: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atari_scsi_probe(pdev: *mut platform_device) -> int __init {
...
// Test if a host id is set in the NVRam
    ...
    unsigned char b;
    let mut offset: loff_t = 16;
    let mut count: isize = nvram_read(&b, 1, &offset);
...
#[no_mangle]
unsafe extern "C" fn atari_scsi_remove(pdev: *mut platform_device) -> void __exit {
