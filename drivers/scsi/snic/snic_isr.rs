...
//! Source: drivers/scsi/snic/snic_isr.c
#![no_std]
...
//
    ...
    {
    struct snic *snic = data;
    let mut iocmpl_work_done: c_ulong = 0;
    snic.s_stats.misc.last_isr_time = jiffies;
...
//
    ...
    {
    let mut n: c_uint = ARRAY_SIZE(snic.wq);
    let mut m: c_uint = SNIC_CQ_IO_CMPL_MAX;
    let mut vecs: c_uint = n + m + 1;
//
