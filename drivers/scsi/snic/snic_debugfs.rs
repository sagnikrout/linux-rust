...
//! Source: drivers/scsi/snic/snic_debugfs.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn snic_debugfs_init() {
    void snic_debugfs_init(void)
    {
    snic_glob.trc_root = debugfs_create_dir("snic", core::ptr::null_mut());
...
//
    ...
    snic_glob.stats_root = core::ptr::null_mut();
    debugfs_remove(snic_glob.trc_root);
    snic_glob.trc_root = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn snic_stats_debugfs_init(snic: *mut snic) {
...
//
    ...
    snic.stats_file = core::ptr::null_mut();
    debugfs_remove(snic.reset_stats_file);
    snic.reset_stats_file = core::ptr::null_mut();
    debugfs_remove(snic.stats_host);
    snic.stats_host = core::ptr::null_mut();
    }
...
pub const SNIC_TRC_PBLEN: c_int = 256;
    static int
...
//
#[no_mangle]
pub unsafe extern "C" fn snic_trc_debugfs_init() {
    ...
    snic_glob.trc_root, core::ptr::null_mut(), &snic_trc_fops);
    }
//
