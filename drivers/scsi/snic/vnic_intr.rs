...
//! Source: drivers/scsi/snic/vnic_intr.h
#![no_std]
...
pub const VNIC_INTR_TIMER_MAX: c_uint = 0xffff;
...
extern "C" {
    pub fn svnic_intr_free(: *mut vnic_intr);
}
extern "C" {
    pub fn svnic_intr_alloc(: *mut vnic_dev, : *mut vnic_intr, int: unsigned) -> c_int;
}
extern "C" {
    pub fn svnic_intr_clean(: *mut vnic_intr);
}
