...
//! Source: drivers/scsi/bnx2i/bnx2i_init.c
#![no_std]
...
//
    ...
    let mut adapter_list: static struct list_head = LIST_HEAD_INIT(adapter_list);
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_identify_device(hba: *mut bnx2i_hba, dev: *mut cnic_dev) {
...
//
    ...
    {
    struct bnx2i_hba *hba = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_start(handle: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_chip_cleanup(hba: *mut bnx2i_hba) {
...
// Clean up the chip only
    ...
    bnx2i_ep.cm_sk = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_stop(handle: *mut c_void) {
    void bnx2i_stop(void *handle)
    {
    struct bnx2i_hba *hba = handle;
    int conns_active;
    let mut wait_delay: c_int = 1 * HZ;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_init_one(hba: *mut bnx2i_hba, cnic: *mut cnic_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(-EINVAL: rc ==) -> else {
    else if (rc == -EINVAL)
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_ulp_init(dev: *mut cnic_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_ulp_exit(dev: *mut cnic_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_get_stats(handle: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bnx2i_cpu_offline(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_mod_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_mod_exit() -> void __exit {
