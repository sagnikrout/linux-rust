...
//! Source: drivers/scsi/bnx2i/bnx2i_iscsi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bnx2i_adapter_ready(hba: *mut bnx2i_hba) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_setup_write_cmd_bd_info(task: *mut iscsi_task) {
    ...
    let mut cmd_len: u32 = cmd.req.total_data_transfer_length;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_map_scsi_sg(hba: *mut bnx2i_hba, cmd: *mut bnx2i_cmd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_iscsi_map_sg_list(cmd: *mut bnx2i_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_iscsi_unmap_sg_list(cmd: *mut bnx2i_cmd) {
...
#[no_mangle]
unsafe extern "C" fn bnx2i_setup_cmd_wqe_template(cmd: *mut bnx2i_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_alloc_iscsi_cid(hba: *mut bnx2i_hba) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_free_iscsi_cid(hba: *mut bnx2i_hba, iscsi_cid: u16) {
    ...
    hba.cid_que.conn_cid_tbl[iscsi_cid] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_setup_free_cid_que(hba: *mut bnx2i_hba) -> c_int {
    ...
    hba.cid_que.cid_que_base = core::ptr::null_mut();
    return -ENOMEM;
    }
    ...
    hba.cid_que.conn_cid_tbl[i] = core::ptr::null_mut();
    }
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_release_free_cid_que(hba: *mut bnx2i_hba) {
    static void bnx2i_release_free_cid_que(struct bnx2i_hba *hba)
    {
    kfree(hba.cid_que.cid_que_base);
    hba.cid_que.cid_que_base = core::ptr::null_mut();
    kfree(hba.cid_que.conn_cid_tbl);
    hba.cid_que.conn_cid_tbl = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_free_ep(ep: *mut iscsi_endpoint) {
    ...
    if (bnx2i_ep.conn) {
    bnx2i_ep.conn.ep = core::ptr::null_mut();
    bnx2i_ep.conn = core::ptr::null_mut();
    }
    bnx2i_ep.hba = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_setup_mp_bdt(hba: *mut bnx2i_hba) -> c_int {
    ...
    hba.mp_bd_tbl = core::ptr::null_mut();
    rc = -1;
    goto out;
    }
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_free_mp_bdt(hba: *mut bnx2i_hba) {
    ...
    hba.dummy_buffer = core::ptr::null_mut();
    }
    return;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_drop_session(cls_session: *mut iscsi_cls_session) {
...
//
    ...
    struct bnx2i_endpoint *ep = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(BNX2I_NX2_DEV_5709, _arg: &hba->cnic_dev_type)) -> else {
    else if (test_bit(BNX2I_NX2_DEV_5709, &hba.cnic_dev_type))
    shost.can_queue = ISCSI_MAX_CMDS_PER_HBA_5709;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(BNX2I_NX2_DEV_57710, _arg: &hba->cnic_dev_type)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_free_hba(hba: *mut bnx2i_hba) {
...
//
    ...
    bnx2i_conn.gen_pdu.resp_bd_tbl = core::ptr::null_mut();
    }
    if (bnx2i_conn.gen_pdu.req_bd_tbl) {
    dma_free_coherent(&hba.pcidev.dev, CNIC_PAGE_SIZE,
    bnx2i_conn.gen_pdu.req_bd_tbl,
    bnx2i_conn.gen_pdu.req_bd_dma);
    bnx2i_conn.gen_pdu.req_bd_tbl = core::ptr::null_mut();
    }
    ...
    bnx2i_conn.gen_pdu.resp_buf = core::ptr::null_mut();
    }
    ...
    bnx2i_conn.gen_pdu.req_buf = core::ptr::null_mut();
    }
    }
//
...
// Allocate memory for login request/response buffers
    ...
    &bnx2i_conn.gen_pdu.req_dma_addr,
    GFP_KERNEL);
    if (bnx2i_conn.gen_pdu.req_buf == core::ptr::null_mut())
    ...
    &bnx2i_conn.gen_pdu.resp_dma_addr,
    GFP_KERNEL);
    if (bnx2i_conn.gen_pdu.resp_buf == core::ptr::null_mut())
    ...
    if (bnx2i_conn.gen_pdu.req_bd_tbl == core::ptr::null_mut())
    goto login_req_bd_tbl_failure;
    bnx2i_conn.gen_pdu.resp_bd_tbl =
    dma_alloc_coherent(&hba.pcidev.dev, CNIC_PAGE_SIZE,
    &bnx2i_conn.gen_pdu.resp_bd_dma,
    GFP_KERNEL);
    if (bnx2i_conn.gen_pdu.resp_bd_tbl == core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_iscsi_prep_generic_pdu_bd(bnx2i_conn: *mut bnx2i_conn) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_iscsi_send_generic_request(task: *mut iscsi_task) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_cpy_scsi_cdb(sc: *mut scsi_cmnd, cmd: *mut bnx2i_cmd) {
...
#[no_mangle]
unsafe extern "C" fn bnx2i_cleanup_task(task: *mut iscsi_task) {
...
// Tx PDU/data length count
    ...
    cmd.scsi_cmd = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_task_xmit(task: *mut iscsi_task) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(BNX2I_SQ_WQES_MIN: cmds_max <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_session_destroy(cls_session: *mut iscsi_cls_session) {
...
// 'ep' ptr will be assigned in bind() call
    bnx2i_conn.ep = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_conn_destroy(cls_conn: *mut iscsi_cls_conn) {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_conn_start(cls_conn: *mut iscsi_cls_conn) -> c_int {
...
//
    ...
    struct bnx2i_hba *hba;
    struct cnic_dev *cnic = core::ptr::null_mut();
...
//
    ...
    int non_blocking)
    {
    let mut iscsi_cid: u32 = BNX2I_CID_RESERVED;
    struct sockaddr_in *desti = (struct sockaddr_in *) dst_addr;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_ep_poll(ep: *mut iscsi_endpoint, timeout_ms: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_ep_tcp_conn_active(bnx2i_ep: *mut bnx2i_endpoint) -> c_int {
    static int bnx2i_ep_tcp_conn_active(struct bnx2i_endpoint *bnx2i_ep)
    {
    int ret;
    let mut cnic_dev_10g: c_int = 0;
    if (test_bit(BNX2I_NX2_DEV_57710, &bnx2i_ep.hba.cnic_dev_type))
    cnic_dev_10g = 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn bnx2i_hw_ep_disconnect(bnx2i_ep: *mut bnx2i_endpoint) -> c_int {
    int bnx2i_hw_ep_disconnect(struct bnx2i_endpoint *bnx2i_ep)
    {
    struct bnx2i_hba *hba = bnx2i_ep.hba;
    struct cnic_dev *cnic;
    struct iscsi_session *session = core::ptr::null_mut();
    struct iscsi_conn *conn = core::ptr::null_mut();
    let mut ret: c_int = 0;
    let mut close: c_int = 0;
    let mut close_ret: c_int = 0;
    if (!hba)
    return 0;
    cnic = hba.cnic;
    if (!cnic)
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_ep_disconnect(ep: *mut iscsi_endpoint) {
    static void bnx2i_ep_disconnect(struct iscsi_endpoint *ep)
    {
    struct bnx2i_endpoint *bnx2i_ep;
    struct bnx2i_conn *bnx2i_conn = core::ptr::null_mut();
    struct bnx2i_hba *hba;
    bnx2i_ep = ep.dd_data;
...
//
#[no_mangle]
unsafe extern "C" fn bnx2i_nl_set_path(shost: *mut Scsi_Host, params: *mut iscsi_path) -> c_int {
    static int bnx2i_nl_set_path(struct Scsi_Host *shost, struct iscsi_path *params)
    {
    struct bnx2i_hba *hba = iscsi_host_priv(shost);
    char *buf = (char *) params;
    let mut len: u16 = sizeof(*params);
...
#[no_mangle]
unsafe extern "C" fn bnx2i_attr_is_visible(param_type: c_int, param: c_int) -> umode_t {
