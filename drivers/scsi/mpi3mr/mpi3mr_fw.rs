...
//! Source: drivers/scsi/mpi3mr/mpi3mr_fw.c
#![no_std]
...
//
    ...
    let mut threaded_isr_poll: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn mpi3mr_sync_irqs(mrioc: *mut mpi3mr_ioc) {
...
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_ioc_disable_intr(mrioc: *mut mpi3mr_ioc) {
...
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_ioc_enable_intr(mrioc: *mut mpi3mr_ioc) {
    void mpi3mr_ioc_enable_intr(struct mpi3mr_ioc *mrioc)
    {
    mrioc.intr_enabled = 1;
    }
#[no_mangle]
unsafe extern "C" fn mpi3mr_cleanup_isr(mrioc: *mut mpi3mr_ioc) {
    ...
    mrioc.intr_info = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_build_zero_len_sge(paddr: *mut c_void) {
    void mpi3mr_build_zero_len_sge(void *paddr)
    {
    let mut sgl_flags: u8 = MPI3MR_SGEFLAGS_SYSTEM_SIMPLE_END_OF_LIST;
    ...
    let mut ioc_status: u16 = MPI3_IOCSTATUS_SUCCESS;
    let mut masked_ioc_status: u16 = MPI3_IOCSTATUS_SUCCESS;
    let mut ioc_loginfo: u32 = 0, sense_count = 0;
    struct mpi3_status_reply_descriptor *status_desc;
    struct mpi3_address_reply_descriptor *addr_desc;
    struct mpi3_success_reply_descriptor *success_desc;
    struct mpi3_default_reply *def_reply = core::ptr::null_mut();
    struct mpi3mr_drv_cmd *cmdptr = core::ptr::null_mut();
    struct mpi3_scsi_io_reply *scsi_reply;
    struct scsi_sense_hdr sshdr;
    u8 *sense_buf = core::ptr::null_mut();
// reply_dma = 0;
...
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_process_admin_reply_q(mrioc: *mut mpi3mr_ioc) -> c_int {
    int mpi3mr_process_admin_reply_q(struct mpi3mr_ioc *mrioc)
    {
    let mut exp_phase: u32 = mrioc.admin_reply_ephase;
    let mut admin_reply_ci: u32 = mrioc.admin_reply_ci;
    let mut num_admin_replies: u32 = 0;
    let mut reply_dma: u64 = 0;
    let mut threshold_comps: u16 = 0;
...
//
    ...
    struct mpi3_default_reply_descriptor *reply_desc = core::ptr::null_mut();
    segment_base_addr =
...
//
    ...
    u32 exp_phase;
    u32 reply_ci;
    let mut num_op_reply: u32 = 0;
    let mut reply_dma: u64 = 0;
    struct mpi3_default_reply_descriptor *reply_desc;
    let mut req_q_idx: u16 = 0, reply_qidx, threshold_comps = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_blk_mq_poll(shost: *mut Scsi_Host, queue_num: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpi3mr_isr_primary(irq: c_int, privdata: *mut c_void) -> irqreturn_t {
    static irqreturn_t mpi3mr_isr_primary(int irq, void *privdata)
    {
    struct mpi3mr_intr_info *intr_info = privdata;
    struct mpi3mr_ioc *mrioc;
    u16 midx;
    let mut num_admin_replies: u32 = 0, num_op_reply = 0;
    if (!intr_info)
    return IRQ_NONE;
...
#[no_mangle]
unsafe extern "C" fn mpi3mr_isr(irq: c_int, privdata: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_isr_poll(irq: c_int, privdata: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_request_irq(mrioc: *mut mpi3mr_ioc, index: u16) -> c_int {
    ...
    intr_info.op_reply_q = core::ptr::null_mut();
    ...
    core::ptr::null_mut(), IRQF_SHARED, intr_info.name, intr_info);
...
#[no_mangle]
unsafe extern "C" fn mpi3mr_calc_poll_queues(mrioc: *mut mpi3mr_ioc, max_vectors: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_setup_isr(mrioc: *mut mpi3mr_ioc, setup_one: u8) -> c_int {
    static int mpi3mr_setup_isr(struct mpi3mr_ioc *mrioc, u8 setup_one)
    {
    let mut irq_flags: c_uint = PCI_IRQ_MSIX;
    int max_vectors, min_vec;
    int retval;
    int i;
    let mut desc: irq_affinity = { .pre_vectors =  1, .post_vectors = 1 };
...
#[no_mangle]
pub unsafe extern "C" fn if((max_vectors): retval !=) -> else {
    ioc_info(mrioc,
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_is_fault_recoverable(mrioc: *mut mpi3mr_ioc) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_print_fault_info(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_save_fault_info(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_get_iocstate(mrioc: *mut mpi3mr_ioc) -> enum mpi3mr_iocstate {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_free_ioctl_dma_memory(mrioc: *mut mpi3mr_ioc) {
    ...
    mem_desc.addr,
    mem_desc.dma_addr);
    mem_desc.addr = core::ptr::null_mut();
    }
    }
    dma_pool_destroy(mrioc.ioctl_dma_pool);
    mrioc.ioctl_dma_pool = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_alloc_ioctl_dma_memory(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_fault_uevent_emit(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_clear_reset_history(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_bring_ioc_ready(mrioc: *mut mpi3mr_ioc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_set_diagsave(mrioc: *mut mpi3mr_ioc) {
...
//
    ...
    {
    let mut retval: c_int = -1;
    let mut unlock_retry_count: u8 = 0;
    u32 host_diagnostic, ioc_status, ioc_config, scratch_pad0;
    let mut timeout: u32 = MPI3MR_RESET_ACK_TIMEOUT * 10;
...
//
    ...
    {
    let mut areq_pi: u16 = 0, areq_ci = 0, max_entries = 0;
    let mut retval: c_int = 0;
    unsigned long flags;
    u8 *areq_entry;
    if (mrioc.unrecoverable) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_free_op_req_q_segments(mrioc: *mut mpi3mr_ioc, q_idx: u16) {
    ...
    mrioc.req_qinfo[q_idx].q_segment_list = core::ptr::null_mut();
    }
    } else
    ...
    segments[j].segment = core::ptr::null_mut();
    }
    kfree(mrioc.req_qinfo[q_idx].q_segments);
    mrioc.req_qinfo[q_idx].q_segments = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_free_op_reply_q_segments(mrioc: *mut mpi3mr_ioc, q_idx: u16) {
    ...
    mrioc.op_reply_qinfo[q_idx].q_segment_list = core::ptr::null_mut();
    }
    } else
    ...
    mrioc.op_reply_qinfo[q_idx].q_segments = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_delete_op_reply_q(mrioc: *mut mpi3mr_ioc, qidx: u16) -> c_int {
    static int mpi3mr_delete_op_reply_q(struct mpi3mr_ioc *mrioc, u16 qidx)
    {
    struct mpi3_delete_reply_queue_request delq_req;
    struct op_reply_qinfo *op_reply_q = mrioc.op_reply_qinfo + qidx;
    let mut retval: c_int = 0;
    let mut reply_qid: u16 = 0, midx;
    ...
    mrioc.init_cmds.callback = core::ptr::null_mut();
    ...
    mrioc.intr_info[midx].op_reply_q = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_alloc_op_reply_q_segments(mrioc: *mut mpi3mr_ioc, qidx: u16) -> c_int {
    static int mpi3mr_alloc_op_reply_q_segments(struct mpi3mr_ioc *mrioc, u16 qidx)
    {
    struct op_reply_qinfo *op_reply_q = mrioc.op_reply_qinfo + qidx;
    int i, size;
    u64 *q_segment_list_entry = core::ptr::null_mut();
    struct segments *segments;
    if (mrioc.enable_segqueue) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_alloc_op_req_q_segments(mrioc: *mut mpi3mr_ioc, qidx: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_create_op_reply_q(mrioc: *mut mpi3mr_ioc, qidx: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_create_op_queues(mrioc: *mut mpi3mr_ioc) -> c_int {
    static int mpi3mr_create_op_queues(struct mpi3mr_ioc *mrioc)
    {
    let mut retval: c_int = 0;
    let mut num_queues: u16 = 0, i = 0, msix_count_op_q = 1;
    u32 ioc_status;
    enum mpi3mr_iocstate ioc_state;
...
// Not even one queue is created successfully
    ...
    mrioc.req_qinfo = core::ptr::null_mut();
    kfree(mrioc.op_reply_qinfo);
    mrioc.op_reply_qinfo = core::ptr::null_mut();
    return retval;
    }
//
...
//
    ...
    {
    let mut pi: u16 = 0, max_entries, reply_qidx = 0, midx;
    let mut retval: c_int = 0;
    unsigned long flags;
    u8 *req_entry;
    void *segment_base_addr;
    let mut req_sz: u16 = mrioc.facts.op_req_sz;
    struct segments *segments = op_req_q.q_segments;
    struct op_reply_qinfo *op_reply_q = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_check_rh_fault_ioc(mrioc: *mut mpi3mr_ioc, reason_code: u32) {
    ...
    MPI3MR_HDB_TRIGGER_TYPE_FW_RELEASED, core::ptr::null_mut(), 0);
    return;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_sync_timestamp(mrioc: *mut mpi3mr_ioc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_print_pkg_ver(mrioc: *mut mpi3mr_ioc) -> c_int {
    ...
    let mut data_len: u32 = sizeof(struct mpi3_ci_manifest_mpi);
    let mut sgl_flags: u8 = MPI3MR_SGEFLAGS_SYSTEM_SIMPLE_END_OF_LIST;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_watchdog_work(work: *mut work_struct) {
    ...
    union mpi3mr_trigger_data trigger_data;
    let mut reset_reason: u16 = MPI3MR_RESET_FROM_FAULT_WATCH;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_start_watchdog(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_stop_watchdog(mrioc: *mut mpi3mr_ioc) {
    ...
    mrioc.watchdog_work_q = core::ptr::null_mut();
    spin_unlock_irqrestore(&mrioc.watchdog_lock, flags);
    if (wq) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_setup_admin_qpair(mrioc: *mut mpi3mr_ioc) -> c_int {
    static int mpi3mr_setup_admin_qpair(struct mpi3mr_ioc *mrioc)
    {
    let mut retval: c_int = 0;
    let mut num_admin_entries: u32 = 0;
    ...
    mrioc.admin_reply_base = core::ptr::null_mut();
    }
    if (mrioc.admin_req_base) {
    dma_free_coherent(&mrioc.pdev.dev, mrioc.admin_req_q_sz,
    mrioc.admin_req_base, mrioc.admin_req_dma);
    mrioc.admin_req_base = core::ptr::null_mut();
    }
    return retval;
    }
//
...
//
    ...
    void *data = core::ptr::null_mut();
    dma_addr_t data_dma;
    let mut data_len: u32 = sizeof(*facts_data);
    let mut retval: c_int = 0;
    let mut sgl_flags: u8 = MPI3MR_SGEFLAGS_SYSTEM_SIMPLE_END_OF_LIST;
    data = dma_alloc_coherent(&mrioc.pdev.dev, data_len, &data_dma,
    GFP_KERNEL);
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_check_reset_dma_mask(mrioc: *mut mpi3mr_ioc) -> c_int {
    static inline int mpi3mr_check_reset_dma_mask(struct mpi3mr_ioc *mrioc)
    {
    struct pci_dev *pdev = mrioc.pdev;
    int r;
    let mut facts_dma_mask: u64 = DMA_BIT_MASK(mrioc.facts.dma_mask);
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_alloc_reply_sense_bufs(mrioc: *mut mpi3mr_ioc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpimr_initialize_reply_sbuf_queues(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_issue_iocinit(mrioc: *mut mpi3mr_ioc) -> c_int {
    ...
    dma_addr_t data_dma;
    let mut data_len: u32 = sizeof(*drv_info);
    let mut retval: c_int = 0;
    ktime_t current_time;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_unmask_events(mrioc: *mut mpi3mr_ioc, event: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_issue_event_notification(mrioc: *mut mpi3mr_ioc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_alloc_chain_bufs(mrioc: *mut mpi3mr_ioc) -> c_int {
...
//
    ...
    struct mpi3mr_drv_cmd *drv_cmd)
    {
    drv_cmd.callback = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_issue_port_enable(mrioc: *mut mpi3mr_ioc, async: u8) -> c_int {
    int mpi3mr_issue_port_enable(struct mpi3mr_ioc *mrioc, u8 async)
    {
    struct mpi3_port_enable_request pe_req;
    let mut retval: c_int = 0;
    let mut pe_timeout: u32 = MPI3MR_PORTENABLE_TIMEOUT;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_repost_diag_bufs(mrioc: *mut mpi3mr_ioc) -> c_int {
    static int mpi3mr_repost_diag_bufs(struct mpi3mr_ioc *mrioc)
    {
    u64 global_trigger;
    union mpi3mr_trigger_data prev_trigger_data;
    struct diag_buffer_desc *trace_hdb = core::ptr::null_mut();
    struct diag_buffer_desc *fw_hdb = core::ptr::null_mut();
    let mut retval: c_int = 0;
    let mut trace_repost_needed: bool = false;
    let mut fw_repost_needed: bool = false;
    ...
    MPI3MR_HDB_TRIGGER_TYPE_UNKNOWN, core::ptr::null_mut(), 1);
    } else {
...
//
    ...
    let mut pg_sz: u16 = sizeof(driver_pg1);
    let mut retval: c_int = 0;
...
//
    ...
    {
    let mut i: c_int = 0, bytes_written = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_cleanup_resources(mrioc: *mut mpi3mr_ioc) {
    ...
    mrioc.sysif_regs = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_setup_resources(mrioc: *mut mpi3mr_ioc) -> c_int {
    int mpi3mr_setup_resources(struct mpi3mr_ioc *mrioc)
    {
    struct pci_dev *pdev = mrioc.pdev;
    let mut memap_sz: u32 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_enable_events(mrioc: *mut mpi3mr_ioc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_init_ioc(mrioc: *mut mpi3mr_ioc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_reinit_ioc(mrioc: *mut mpi3mr_ioc, is_resume: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_memset_op_reply_q_buffers(mrioc: *mut mpi3mr_ioc, qidx: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_memset_op_req_q_buffers(mrioc: *mut mpi3mr_ioc, qidx: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_memset_buffers(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_free_mem(mrioc: *mut mpi3mr_ioc) {
    ...
    mrioc.sense_buf = core::ptr::null_mut();
    mrioc.sense_buf_pool = core::ptr::null_mut();
    }
    if (mrioc.sense_buf_q_pool) {
    if (mrioc.sense_buf_q)
    ...
    mrioc.sense_buf_q = core::ptr::null_mut();
    mrioc.sense_buf_q_pool = core::ptr::null_mut();
    }
    if (mrioc.reply_buf_pool) {
    if (mrioc.reply_buf)
    ...
    mrioc.reply_buf = core::ptr::null_mut();
    mrioc.reply_buf_pool = core::ptr::null_mut();
    }
    if (mrioc.reply_free_q_pool) {
    if (mrioc.reply_free_q)
    ...
    mrioc.reply_free_q = core::ptr::null_mut();
    mrioc.reply_free_q_pool = core::ptr::null_mut();
    }
    ...
    mrioc.init_cmds.reply = core::ptr::null_mut();
    kfree(mrioc.bsg_cmds.reply);
    mrioc.bsg_cmds.reply = core::ptr::null_mut();
    kfree(mrioc.host_tm_cmds.reply);
    mrioc.host_tm_cmds.reply = core::ptr::null_mut();
    kfree(mrioc.pel_cmds.reply);
    mrioc.pel_cmds.reply = core::ptr::null_mut();
    kfree(mrioc.pel_abort_cmd.reply);
    mrioc.pel_abort_cmd.reply = core::ptr::null_mut();
    for (i = 0; i < MPI3MR_NUM_EVTACKCMD; i++) {
    kfree(mrioc.evtack_cmds[i].reply);
    mrioc.evtack_cmds[i].reply = core::ptr::null_mut();
    }
    bitmap_free(mrioc.removepend_bitmap);
    mrioc.removepend_bitmap = core::ptr::null_mut();
    bitmap_free(mrioc.devrem_bitmap);
    mrioc.devrem_bitmap = core::ptr::null_mut();
    bitmap_free(mrioc.evtack_cmds_bitmap);
    mrioc.evtack_cmds_bitmap = core::ptr::null_mut();
    bitmap_free(mrioc.chain_bitmap);
    mrioc.chain_bitmap = core::ptr::null_mut();
    kfree(mrioc.transport_cmds.reply);
    mrioc.transport_cmds.reply = core::ptr::null_mut();
    for (i = 0; i < MPI3MR_NUM_DEVRMCMD; i++) {
    kfree(mrioc.dev_rmhs_cmds[i].reply);
    mrioc.dev_rmhs_cmds[i].reply = core::ptr::null_mut();
    }
    if (mrioc.chain_buf_pool) {
    ...
    mrioc.chain_sgl_list[i].addr,
    mrioc.chain_sgl_list[i].dma_addr);
    mrioc.chain_sgl_list[i].addr = core::ptr::null_mut();
    }
    }
    dma_pool_destroy(mrioc.chain_buf_pool);
    mrioc.chain_buf_pool = core::ptr::null_mut();
    }
    kfree(mrioc.chain_sgl_list);
    mrioc.chain_sgl_list = core::ptr::null_mut();
    if (mrioc.admin_reply_base) {
    dma_free_coherent(&mrioc.pdev.dev, mrioc.admin_reply_q_sz,
    mrioc.admin_reply_base, mrioc.admin_reply_dma);
    mrioc.admin_reply_base = core::ptr::null_mut();
    ...
    mrioc.pel_seqnum_virt = core::ptr::null_mut();
    }
    ...
    mrioc.trace_buf[j].segment = core::ptr::null_mut();
    }
    mrioc.trace_buf[j].segment = core::ptr::null_mut();
    }
    dma_pool_destroy(mrioc.trace_buf_pool);
    mrioc.trace_buf_pool = core::ptr::null_mut();
    }
    kfree(mrioc.trace_buf);
    mrioc.trace_buf = core::ptr::null_mut();
    ...
    diag_buffer.addr = core::ptr::null_mut();
    diag_buffer.size = 0;
    diag_buffer.type = 0;
    ...
    mrioc.throttle_groups = core::ptr::null_mut();
    kfree(mrioc.logdata_buf);
    mrioc.logdata_buf = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_issue_ioc_shutdown(mrioc: *mut mpi3mr_ioc) {
    static void mpi3mr_issue_ioc_shutdown(struct mpi3mr_ioc *mrioc)
    {
    u32 ioc_config, ioc_status, shutdown_action;
    let mut retval: u8 = 1, retry = 0;
    let mut timeout: u32 = MPI3MR_DEFAULT_SHUTDOWN_TIME * 10, timeout_remaining = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_cleanup_ioc(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_flush_drv_cmds(mrioc: *mut mpi3mr_ioc) {
...
//
    ...
    struct mpi3mr_drv_cmd *drv_cmd)
    {
    struct mpi3_pel_reply *pel_reply = core::ptr::null_mut();
    u16 ioc_status, pe_log_status;
    let mut do_retry: bool = false;
    if (drv_cmd.state & MPI3MR_CMD_RESET)
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_check_op_admin_proc(mrioc: *mut mpi3mr_ioc) -> c_int {
    static int mpi3mr_check_op_admin_proc(struct mpi3mr_ioc *mrioc)
    {
    let mut timeout: u16 = 10 * 10;
    let mut elapsed_time: u16 = 0;
    let mut op_admin_in_use: bool = false;
    do {
...
//
    ...
    (reset_reason != MPI3MR_RESET_FROM_CIACTIV_FAULT)) {
    mpi3mr_set_trigger_data_in_all_hdb(mrioc,
    MPI3MR_HDB_TRIGGER_TYPE_SOFT_RESET, core::ptr::null_mut(), 0);
    dprint_reset(mrioc,
...
//
    ...
    mrioc.cfg_cmds.callback = core::ptr::null_mut();
...
//
    ...
    if (mpi3mr_process_cfg_req(mrioc, &cfg_req, core::ptr::null_mut(),
