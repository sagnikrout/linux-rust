...
//! Source: drivers/scsi/mpi3mr/mpi/mpi30_sas.h
#![no_std]
...
//
pub const MPI30_SAS_H: c_int = 1;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpi3_smp_passthrough_request {
    pub host_tag: __le16,
    ...
    pub request_sge: mpi3_sge_common,
    pub response_sge: mpi3_sge_common,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpi3_smp_passthrough_reply {
    pub host_tag: __le16,
    pub ioc_use_only02: u8,
    pub function: u8,
    pub ioc_use_only04: __le16,
