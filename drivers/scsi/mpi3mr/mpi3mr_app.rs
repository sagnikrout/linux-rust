...
//! Source: drivers/scsi/mpi3mr/mpi3mr_app.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_alloc_trace_buffer(mrioc: *mut mpi3mr_ioc, trace_size: u32) -> c_int {
    ...
    int i, sz;
    u64 *diag_buffer_list = core::ptr::null_mut();
    ...
    mrioc.trace_buf[i].segment,
    mrioc.trace_buf[i].segment_dma);
    mrioc.trace_buf[i].segment = core::ptr::null_mut();
    }
    mrioc.trace_buf[i].segment = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_alloc_diag_bufs(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_post_diag_bufs(mrioc: *mut mpi3mr_ioc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_global_trigger(mrioc: *mut mpi3mr_ioc, trigger_data: u64) {
...
//
    ...
    u8 ascq)
    {
    struct mpi3_driver2_trigger_scsi_sense *scsi_sense_trigger = core::ptr::null_mut();
    let mut i: u64 = 0;
    unsigned long flags;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_event_trigger(mrioc: *mut mpi3mr_ioc, event: u8) {
    void mpi3mr_event_trigger(struct mpi3mr_ioc *mrioc, u8 event)
    {
    struct mpi3_driver2_trigger_event *event_trigger = core::ptr::null_mut();
    let mut i: u64 = 0;
    unsigned long flags;
    u8 num_triggers, trigger_flags;
...
//
    ...
    u32 ioc_loginfo)
    {
    struct mpi3_driver2_trigger_reply *reply_trigger = core::ptr::null_mut();
    let mut i: u64 = 0;
    unsigned long flags;
    u8 num_triggers, trigger_flags;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_refresh_trigger(mrioc: *mut mpi3mr_ioc, page_action: u8) -> c_int {
    int mpi3mr_refresh_trigger(struct mpi3mr_ioc *mrioc, u8 page_action)
    {
    let mut pg_sz: u16 = sizeof(struct mpi3_driver_page2);
    struct mpi3_driver_page2 *drvr_page2 = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_release_diag_bufs(mrioc: *mut mpi3mr_ioc, skip_rel_action: u8) {
...
//
    ...
    u8 type, union mpi3mr_trigger_data *trigger_data, bool force)
    {
    struct diag_buffer_desc *hdb = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_bsg_pel_abort(mrioc: *mut mpi3mr_ioc) -> c_int {
    ...
    mrioc.pel_abort_cmd.callback = core::ptr::null_mut();
...
//
    ...
    mrioc.pel_locale = pel_enable.pel_locale;
    mrioc.pel_enabled = 1;
    rval = mpi3mr_pel_get_seqnum_post(mrioc, core::ptr::null_mut());
    if (rval) {
...
//
    ...
    struct bsg_job *job)
    {
    let mut num_devices: u16 = 0, i = 0, size;
    unsigned long flags;
    struct mpi3mr_tgt_dev *tgtdev;
    struct mpi3mr_device_map_info *devmap_info = core::ptr::null_mut();
    struct mpi3mr_all_tgt_info *alltgt_info = core::ptr::null_mut();
    let mut min_entrylen: u32 = 0, kern_entrylen = 0, usr_entrylen = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if((mrioc->stop_bsgs): (mrioc->reset_in_progress) ||) -> else {
    else if ((mrioc.reset_in_progress) || (mrioc.stop_bsgs))
    adpinfo.adp_state = MPI3MR_BSG_ADPSTATE_IN_RESET;
#[no_mangle]
pub unsafe extern "C" fn if(MRIOC_STATE_FAULT: ioc_state ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_bsg_process_drv_cmds(job: *mut bsg_job) -> c_long {
    static long mpi3mr_bsg_process_drv_cmds(struct bsg_job *job)
    {
    let mut rval: c_long = -EINVAL;
    struct mpi3mr_ioc *mrioc = core::ptr::null_mut();
    struct mpi3mr_bsg_packet *bsg_req = core::ptr::null_mut();
    struct mpi3mr_bsg_drv_cmd *drvrcmd = core::ptr::null_mut();
    bsg_req = job.request;
...
//
    ...
    let mut sge_element_size: u32 = sizeof(struct mpi3_sge_common);
    let mut chain_used: bool = false;
...
//
    ...
    let mut available_sges: u16 = 0, i;
    let mut sge_element_size: u32 = sizeof(struct mpi3mr_nvme_pt_sge);
    struct mpi3mr_buf_map *drv_buf_iter = drv_bufs;
...
//
    ...
    struct mpi3mr_buf_map *drv_bufs, u8 bufcnt)
    {
    let mut prp_size: c_int = MPI3MR_NVME_PRP_SIZE;
    __le64 *prp_entry, *prp1_entry, *prp2_entry;
    __le64 *prp_page;
    dma_addr_t prp_entry_dma, prp_page_dma, dma_addr;
    u32 offset, entry_len, dev_pgsz;
    u32 page_mask_result, page_mask;
    let mut length: usize = 0, desc_len;
    u8 count;
    struct mpi3mr_buf_map *drv_buf_iter = drv_bufs;
    u64 sgemod_mask = ((u64)((mrioc.facts.sge_mod_mask) <<
    mrioc.facts.sge_mod_shift) << 32);
    u64 sgemod_val = ((u64)(mrioc.facts.sge_mod_value) <<
    mrioc.facts.sge_mod_shift) << 32;
    let mut dev_handle: u16 = nvme_encap_request.dev_handle;
    struct mpi3mr_tgt_dev *tgtdev;
...
// decrement length accounting for last partial page.
    ...
    mrioc.prp_list_virt = core::ptr::null_mut();
    }
    return -1;
    }
//
...
//
    ...
    let mut buf_len: u32 = drv_buf.kern_buf_len, copied_len = 0;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_bsg_process_mpt_cmds(job: *mut bsg_job) -> c_long {
    static long mpi3mr_bsg_process_mpt_cmds(struct bsg_job *job)
    {
    let mut rval: c_long = -EINVAL;
    struct mpi3mr_ioc *mrioc = core::ptr::null_mut();
    u8 *mpi_req = core::ptr::null_mut(), *sense_buff_k = core::ptr::null_mut();
    let mut mpi_msg_size: u8 = 0;
    struct mpi3mr_bsg_packet *bsg_req = core::ptr::null_mut();
    struct mpi3mr_bsg_mptcmd *karg;
    struct mpi3mr_buf_entry *buf_entries = core::ptr::null_mut();
    struct mpi3mr_buf_map *drv_bufs = core::ptr::null_mut(), *drv_buf_iter = core::ptr::null_mut();
    u8 count, bufcnt = 0, is_rmcb = 0, is_rmrb = 0;
    let mut din_cnt: u8 = 0, dout_cnt = 0;
    let mut invalid_be: u8 = 0, erb_offset = 0xFF, mpirep_offset = 0xFF;
    let mut block_io: u8 = 0, nvme_fmt = 0, resp_code = 0;
    struct mpi3_request_header *mpi_header = core::ptr::null_mut();
    struct mpi3_status_reply_descriptor *status_desc;
    struct mpi3_scsi_task_mgmt_request *tm_req;
    let mut erbsz: u32 = MPI3MR_SENSE_BUF_SZ, tmplen;
    u16 dev_handle;
    struct mpi3mr_tgt_dev *tgtdev;
    struct mpi3mr_stgt_priv_data *stgt_priv = core::ptr::null_mut();
    struct mpi3mr_bsg_in_reply_buf *bsg_reply_buf = core::ptr::null_mut();
    let mut din_size: u32 = 0, dout_size = 0;
    u8 *din_buf = core::ptr::null_mut(), *dout_buf = core::ptr::null_mut();
    u8 *sgl_iter = core::ptr::null_mut(), *sgl_din_iter = core::ptr::null_mut(), *sgl_dout_iter = core::ptr::null_mut();
    let mut rmc_size: u16 = 0, desc_count = 0;
    bsg_req = job.request;
    ...
    drv_buf_iter.kern_buf_dma =
    mrioc.ioctl_chain_sge.dma_addr;
    drv_buf_iter.dma_desc = core::ptr::null_mut();
    ...
    mrioc.bsg_cmds.callback = core::ptr::null_mut();
    ...
    &mrioc.host_tm_cmds, &resp_code, core::ptr::null_mut());
    }
    if (!(mrioc.bsg_cmds.state & MPI3MR_CMD_COMPLETE) &&
    ...
    mrioc.bsg_cmds.is_sense = 0;
    mrioc.bsg_cmds.sensebuf = core::ptr::null_mut();
...
//
    ...
    u16 event_data_size)
    {
    let mut index: u32 = mrioc.logdata_buf_idx, sz;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_bsg_request(job: *mut bsg_job) -> c_int {
    static int mpi3mr_bsg_request(struct bsg_job *job)
    {
    let mut rval: c_long = -EINVAL;
    let mut reply_payload_rcv_len: c_uint = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_bsg_exit(mrioc: *mut mpi3mr_ioc) {
    ...
    mrioc.bsg_queue = core::ptr::null_mut();
    device_del(bsg_dev);
    put_device(bsg_dev);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_bsg_node_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_bsg_init(mrioc: *mut mpi3mr_ioc) {
    ...
    mpi3mr_bsg_request, core::ptr::null_mut(), 0);
    if (IS_ERR(q)) {
...
//
    ...
    struct scsi_device *sdev = to_scsi_device(dev);
    struct mpi3mr_sdev_priv_data *sdev_priv_data =  sdev.hostdata;
    let mut ncq_prio_enable: bool = 0;
