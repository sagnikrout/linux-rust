...
//! Source: drivers/scsi/mpi3mr/mpi3mr_os.c
#![no_std]
...
// Module parameters
    ...
    let mut max_sgl_entries: static int = MPI3MR_DEFAULT_SGL_ENTRIES;
...
//
pub const IOC_LOGINFO_SATA_NCQ_FAIL_AFTER_ERR: c_uint = 0x31080000;
//
...
//
    ...
    {
    struct scmd_priv *priv = core::ptr::null_mut();
    u32 unique_tag;
...
//
    ...
    {
    struct scsi_cmnd *scmd = core::ptr::null_mut();
    struct scmd_priv *priv = core::ptr::null_mut();
    let mut unique_tag: u32 = host_tag - 1;
    if (WARN_ON(host_tag > mrioc.max_host_ios))
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_fwevt_free(r: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_fwevt_get(fwevt: *mut mpi3mr_fwevt) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_fwevt_put(fwevt: *mut mpi3mr_fwevt) {
...
//
    ...
    {
    struct mpi3mr_fwevt *fwevt;
    let mut sz: u16 = sizeof(*event_data);
...
//
    ...
    {
    unsigned long flags;
    struct mpi3mr_fwevt *fwevt = core::ptr::null_mut();
    spin_lock_irqsave(&mrioc.fwevt_lock, flags);
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_cancel_work(fwevt: *mut mpi3mr_fwevt) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_cleanup_fwevt_list(mrioc: *mut mpi3mr_ioc) {
...
//
    ...
    {
    struct mpi3mr_fwevt *fwevt;
    let mut sz: u16 = sizeof(struct mpi3mr_throttle_group_info *);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_invalidate_devhandles(mrioc: *mut mpi3mr_ioc) {
    ...
    tgt_priv.throttle_group = core::ptr::null_mut();
    tgt_priv.wslen = 0;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_print_scmd(rq: *mut request, data: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_flush_scmd(rq: *mut request, data: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_count_dev_pending(rq: *mut request, data: *mut c_void) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_count_tgt_pending(rq: *mut request, data: *mut c_void) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_flush_host_io(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_flush_cmds_for_unrecovered_controller(mrioc: *mut mpi3mr_ioc) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !q_depth) -> else {
    else if (!q_depth)
    ...
    {
    let mut pgsz: u8 = tgt_dev.dev_spec.pcie_inf.pgsz ? : MPI3MR_DEFAULT_PGSZEXP;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_refresh_tgtdevs(mrioc: *mut mpi3mr_ioc) {
...
//
    ...
    {
    let mut flags: u16 = 0;
    struct mpi3mr_stgt_priv_data *scsi_tgt_priv_data = core::ptr::null_mut();
    struct mpi3mr_enclosure_node *enclosure_dev = core::ptr::null_mut();
    let mut prot_mask: u8 = 0;
    ...
    struct mpi3_device0_sas_sata_format *sasinf =
    &dev_pg0.device_specific.sas_sata_format;
    let mut dev_info: u16 = le16_to_cpu(sasinf.device_info);
    ...
    struct mpi3_device0_pcie_format *pcieinf =
    &dev_pg0.device_specific.pcie_format;
    let mut dev_info: u16 = le16_to_cpu(pcieinf.device_info);
...
// 2^12 = 4096
    ...
    struct mpi3_device0_vd_format *vdinf =
    &dev_pg0.device_specific.vd_format;
    struct mpi3mr_throttle_group_info *tg = core::ptr::null_mut();
...
//
    ...
    struct mpi3mr_fwevt *fwevt)
    {
    let mut dev_handle: u16 = 0;
    let mut uhide: u8 = 0, delete = 0, cleanup = 0;
    struct mpi3mr_tgt_dev *tgtdev = core::ptr::null_mut();
...
//
    ...
    struct scsi_target *starget;
    unsigned long flags;
    let mut dev_handle: u16 = 0, perst_id = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_free_enclosure_list(mrioc: *mut mpi3mr_ioc) {
...
//
    ...
    struct mpi3mr_ioc *mrioc, u16 handle)
    {
    struct mpi3mr_enclosure_node *enclosure_dev, *r = core::ptr::null_mut();
...
//
    ...
    unsigned long flags;
    let mut retval: c_int = 0;
    let mut trigger_type: u8 = event_data.trigger_type;
...
//
    ...
    {
    char *reason_str = core::ptr::null_mut();
...
//
    ...
    char *status_str = core::ptr::null_mut();
...
//
    ...
    u16 handle;
    u8 reason_code;
    let mut exp_sas_address: u64 = 0, parent_sas_address = 0;
    struct mpi3mr_hba_port *hba_port = core::ptr::null_mut();
    struct mpi3mr_tgt_dev *tgtdev = core::ptr::null_mut();
    struct mpi3mr_sas_node *sas_expander = core::ptr::null_mut();
    unsigned long flags;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_update_sdev_qd(sdev: *mut scsi_device, data: *mut c_void) {
...
//
    ...
    struct mpi3mr_fwevt *fwevt)
    {
    struct mpi3_device_page0 *dev_pg0 = core::ptr::null_mut();
    u16 perst_id, handle, dev_info;
    struct mpi3_device0_sas_sata_format *sasinf = core::ptr::null_mut();
...
// Put fwevt reference count to neutralize kref_init increment
    mpi3mr_fwevt_put(fwevt);
    mrioc.current_event = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_fwevt_worker(work: *mut work_struct) {
    static void mpi3mr_fwevt_worker(struct work_struct *work)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_flush_delayed_cmd_lists(mrioc: *mut mpi3mr_ioc) {
...
//
    ...
    {
    let mut cmd_idx: u16 = drv_cmd.host_tag - MPI3MR_HOSTTAG_DEVRMCMD_MIN;
    struct delayed_dev_rmhs_node *delayed_dev_rmhs = core::ptr::null_mut();
...
//
    ...
    let mut cmd_idx: u16 = drv_cmd.host_tag - MPI3MR_HOSTTAG_DEVRMCMD_MIN;
    struct mpi3_scsi_task_mgmt_reply *tm_reply = core::ptr::null_mut();
    int retval;
    if (drv_cmd.state & MPI3MR_CMD_RESET)
    goto clear_drv_cmd;
...
//
    ...
    let mut retval: c_int = 0;
    let mut cmd_idx: u16 = MPI3MR_NUM_DEVRMCMD;
    let mut retrycount: u8 = 5;
...
//
    ...
    struct mpi3mr_drv_cmd *drv_cmd)
    {
    let mut cmd_idx: u16 = drv_cmd.host_tag - MPI3MR_HOSTTAG_EVTACKCMD_MIN;
    struct delayed_evt_ack_node *delayed_evtack = core::ptr::null_mut();
    if (drv_cmd.state & MPI3MR_CMD_RESET)
    goto clear_drv_cmd;
    if (drv_cmd.ioc_status != MPI3_IOCSTATUS_SUCCESS) {
...
//
    ...
    let mut retval: c_int = 0;
    let mut retrycount: u8 = 5;
    let mut cmd_idx: u16 = MPI3MR_NUM_EVTACKCMD;
    struct mpi3mr_drv_cmd *drv_cmd = cmdparam;
    struct delayed_evt_ack_node *delayed_evtack = core::ptr::null_mut();
    if (drv_cmd) {
    dprint_event_th(mrioc,
...
//
    ...
    scsi_tgt_priv_data =  core::ptr::null_mut();
    tgtdev = mpi3mr_get_tgtdev_by_handle(mrioc, handle);
    ...
    mpi3mr_dev_rmhs_send_tm(mrioc, handle, core::ptr::null_mut(),
...
//
    ...
    {
    let mut dev_handle: u16 = 0;
    let mut ublock: u8 = 0, block = 0, hide = 0, delete = 0, remove = 0;
    struct mpi3mr_tgt_dev *tgtdev = core::ptr::null_mut();
    struct mpi3mr_stgt_priv_data *scsi_tgt_priv_data = core::ptr::null_mut();
    struct mpi3_event_data_device_status_change *evtdata =
    ...
    if (remove)
    mpi3mr_dev_rmhs_send_tm(mrioc, dev_handle, core::ptr::null_mut(),
    MPI3_CTRL_OP_REMOVE_DEVICE);
    if (hide)
    mpi3mr_dev_rmhs_send_tm(mrioc, dev_handle, core::ptr::null_mut(),
...
//
    ...
    mpi3mr_send_event_ack(mrioc, event_reply.event, core::ptr::null_mut(),
...
//
    ...
    let mut shutdown_timeout: u16 = le16_to_cpu(evtdata.shutdown_timeout);
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_add_event_wait_for_device_refresh(mrioc: *mut mpi3mr_ioc) {
...
//
    ...
    u16 evt_type, sz;
    struct mpi3mr_fwevt *fwevt = core::ptr::null_mut();
    let mut ack_req: bool = 0, process_evt_bh = 0;
    if (mrioc.stop_drv_processing)
    return;
    if ((event_reply.msg_flags & MPI3_EVENT_NOTIFY_MSGFLAGS_ACK_MASK)
    == MPI3_EVENT_NOTIFY_MSGFLAGS_ACK_REQUIRED)
...
//
    ...
    {
    let mut eedp_flags: u16 = 0;
    let mut prot_op: c_uchar = scsi_get_prot_op(scmd);
    switch (prot_op) {
...
//
    ...
    let mut ioc_loginfo: u32 = 0;
    struct mpi3_status_reply_descriptor *status_desc = core::ptr::null_mut();
    struct mpi3_address_reply_descriptor *addr_desc = core::ptr::null_mut();
    struct mpi3_success_reply_descriptor *success_desc = core::ptr::null_mut();
    struct mpi3_scsi_io_reply *scsi_reply = core::ptr::null_mut();
    struct scsi_cmnd *scmd = core::ptr::null_mut();
    struct scmd_priv *priv = core::ptr::null_mut();
    u8 *sense_buf = core::ptr::null_mut();
    let mut scsi_state: u8 = 0, scsi_status = 0, sense_state = 0;
    let mut xfer_count: u32 = 0, sense_count = 0, resp_data = 0;
    let mut dev_handle: u16 = 0xFFFF;
    struct scsi_sense_hdr sshdr;
    struct mpi3mr_stgt_priv_data *stgt_priv_data = core::ptr::null_mut();
    struct mpi3mr_sdev_priv_data *sdev_priv_data = core::ptr::null_mut();
    let mut ioc_pend_data_len: u32 = 0, tg_pend_data_len = 0, data_len_blks = 0;
    struct mpi3mr_throttle_group_info *tg = core::ptr::null_mut();
    let mut throttle_enabled_dev: u8 = 0;
// reply_dma = 0;
...
// reply_dma);
    if (!scsi_reply) {
    panic("%s: scsi_reply is core::ptr::null_mut(), this shouldn't happen\n",
    mrioc.name);
    goto out;
    }
    ...
    sense_buf) {
    let mut sz: u32 = min_t(u32, SCSI_SENSE_BUFFERSIZE, sense_count);
...
//
    ...
    scmd.result = DID_SOFT_ERROR << 16;
#[no_mangle]
pub unsafe extern "C" fn if(MPI3_SCSI_STATE_TERMINATED: scsi_state &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_get_chain_idx(mrioc: *mut mpi3mr_ioc) -> c_int {
    static int mpi3mr_get_chain_idx(struct mpi3mr_ioc *mrioc)
    {
    let mut retry_count: u8 = 5;
    let mut cmd_idx: c_int = -1;
    unsigned long flags;
...
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_poll_pend_io_completions(mrioc: *mut mpi3mr_ioc) {
...
//
    ...
    struct mpi3mr_tgt_dev *tgtdev = core::ptr::null_mut();
    struct mpi3mr_stgt_priv_data *scsi_tgt_priv_data = core::ptr::null_mut();
    struct scmd_priv *cmd_priv = core::ptr::null_mut();
    struct scsi_device *sdev = core::ptr::null_mut();
    struct mpi3mr_sdev_priv_data *sdev_priv_data = core::ptr::null_mut();
    ...
    sdev_priv_data.tgt_priv_data : core::ptr::null_mut());
    } else {
    if (tgtdev && tgtdev.starget && tgtdev.starget.hostdata)
    scsi_tgt_priv_data = (struct mpi3mr_stgt_priv_data *)
    tgtdev.starget.hostdata;
    ...
    : tgtdev.dev_spec.pcie_inf.reset_to;
#[no_mangle]
pub unsafe extern "C" fn if(MPI3_DEVICE_DEVFORM_VD: tgtdev->dev_type ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_map_queues(shost: *mut Scsi_Host) {
    static void mpi3mr_map_queues(struct Scsi_Host *shost)
    {
    struct mpi3mr_ioc *mrioc = shost_priv(shost);
    int i, qoff, offset;
    struct blk_mq_queue_map *map = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_get_fw_pending_ios(mrioc: *mut mpi3mr_ioc) -> c_int {
    static inline int mpi3mr_get_fw_pending_ios(struct mpi3mr_ioc *mrioc)
    {
    u16 i;
    let mut pend_ios: c_uint = 0;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_print_pending_host_io(mrioc: *mut mpi3mr_ioc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_wait_for_host_io(mrioc: *mut mpi3mr_ioc, timeout: u32) {
...
//
    ...
    {
    let mut unmap: u8 = 0, ndob = 0;
    let mut opcode: u8 = scmd.cmnd[0];
    let mut num_blocks: u32 = 0;
    let mut sa: u16 = (scmd.cmnd[8] << 8) | (scmd.cmnd[9]);
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_eh_host_reset(scmd: *mut scsi_cmnd) -> c_int {
    static int mpi3mr_eh_host_reset(struct scsi_cmnd *scmd)
    {
    struct mpi3mr_ioc *mrioc = shost_priv(scmd.device.host);
    let mut retval: c_int = FAILED, ret;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_eh_bus_reset(scmd: *mut scsi_cmnd) -> c_int {
    static int mpi3mr_eh_bus_reset(struct scsi_cmnd *scmd)
    {
    struct mpi3mr_ioc *mrioc = shost_priv(scmd.device.host);
    struct mpi3mr_stgt_priv_data *stgt_priv_data;
    struct mpi3mr_sdev_priv_data *sdev_priv_data;
    let mut dev_type: u8 = MPI3_DEVICE_DEVFORM_VD;
    let mut retval: c_int = FAILED;
    let mut timeout: c_uint = MPI3MR_RESET_TIMEOUT;
    sdev_priv_data = scmd.device.hostdata;
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_eh_target_reset(scmd: *mut scsi_cmnd) -> c_int {
    ...
    let mut retval: c_int = FAILED, ret = 0;
    sdev_printk(KERN_INFO, scmd.device,
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_eh_dev_reset(scmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_eh_abort(scmd: *mut scsi_cmnd) -> c_int {
    ...
    let mut scmd_age_ms: c_ulong = jiffies_to_msecs(jiffies - scmd.jiffies_at_alloc);
    let mut scmd_age_sec: c_ulong = scmd_age_ms / HZ;
    sdev_printk(KERN_INFO, scmd.device,
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_scan_start(shost: *mut Scsi_Host) {
...
//
    ...
    let mut ioc_status: u32 = readl(&mrioc.sysif_regs.ioc_status);
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_sdev_destroy(sdev: *mut scsi_device) {
    static void mpi3mr_sdev_destroy(struct scsi_device *sdev)
    {
    struct Scsi_Host *shost;
    struct mpi3mr_ioc *mrioc;
    struct mpi3mr_stgt_priv_data *scsi_tgt_priv_data;
    struct mpi3mr_tgt_dev *tgt_dev = core::ptr::null_mut();
    unsigned long flags;
    struct scsi_target *starget;
...
#[no_mangle]
pub unsafe extern "C" fn if(!starget->channel: mrioc->sas_transport_enabled &&) -> else {
    rphy = dev_to_rphy(starget.dev.parent);
    tgt_dev = __mpi3mr_get_tgtdev_by_addr_and_rphy(mrioc,
    rphy.identify.sas_address, rphy);
    }
    if (tgt_dev && (!scsi_tgt_priv_data.num_luns))
    tgt_dev.starget = core::ptr::null_mut();
    if (tgt_dev)
    mpi3mr_tgtdev_put(tgt_dev);
    spin_unlock_irqrestore(&mrioc.tgtdev_lock, flags);
    kfree(sdev.hostdata);
    sdev.hostdata = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_target_destroy(starget: *mut scsi_target) {
    ...
    tgt_dev.starget = core::ptr::null_mut();
    if (tgt_dev) {
    scsi_tgt_priv_data.tgt_dev = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_sdev_init(sdev: *mut scsi_device) -> c_int {
...
pub unsafe extern "C" fn if(!starget->channel: mrioc->sas_transport_enabled &&) -> else {
    ...
    if (tgt_dev) {
    if (tgt_dev.starget == core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_target_alloc(starget: *mut scsi_target) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpi3mr_allow_scmd_to_fw(scmd: *mut scsi_cmnd) -> bool {
...
//
    ...
    struct mpi3mr_stgt_priv_data *stgt_priv_data;
    struct mpi3mr_sdev_priv_data *sdev_priv_data;
    struct scmd_priv *scmd_priv_data = core::ptr::null_mut();
    struct mpi3_scsi_io_request *scsiio_req = core::ptr::null_mut();
    struct op_req_qinfo *op_req_q = core::ptr::null_mut();
    let mut retval: c_int = 0;
    u16 dev_handle;
    u16 host_tag;
    let mut scsiio_flags: u32 = 0, data_len_blks = 0;
    struct request *rq = scsi_cmd_to_rq(scmd);
    int iprio_class;
    let mut is_pcie_dev: u8 = 0;
    let mut tracked_io_sz: u32 = 0;
    let mut ioc_pend_data_len: u32 = 0, tg_pend_data_len = 0;
    struct mpi3mr_throttle_group_info *tg = core::ptr::null_mut();
    if (mrioc.unrecoverable) {
...
#[no_mangle]
pub unsafe extern "C" fn if(DMA_TO_DEVICE: scmd->sc_data_direction ==) -> else {
...
//
    ...
    cmdptr.reply = core::ptr::null_mut();
...
//
    ...
    {
    struct mpi3mr_ioc *mrioc = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(MPI3MR_DEFAULT_SGL_ENTRIES: max_sgl_entries <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_remove(pdev: *mut pci_dev) {
    ...
    mrioc.fwevt_worker_thread = core::ptr::null_mut();
    spin_unlock_irqrestore(&mrioc.fwevt_lock, flags);
    if (wq)
    ...
    mrioc.sas_hba.phy = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_shutdown(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_pcierr_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_pcierr_resume(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn mpi3mr_pcierr_mmio_enabled(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
unsafe extern "C" fn event_counter_show(dd: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mpi3mr_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mpi3mr_exit() -> void __exit {
