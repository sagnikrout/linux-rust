...
//! Source: drivers/scsi/aic94xx/aic94xx_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn asd_map_memio(asd_ha: *mut asd_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn asd_unmap_memio(asd_ha: *mut asd_ha_struct) {
...
#[no_mangle]
unsafe extern "C" fn asd_map_ioport(asd_ha: *mut asd_ha_struct) -> c_int {
    static int asd_map_ioport(struct asd_ha_struct *asd_ha)
    {
    let mut i: c_int = PCI_IOBAR_OFFSET, err;
...
#[no_mangle]
unsafe extern "C" fn asd_unmap_ioport(asd_ha: *mut asd_ha_struct) {
    static void asd_unmap_ioport(struct asd_ha_struct *asd_ha)
    {
    pci_release_region(asd_ha.pcidev, PCI_IOBAR_OFFSET);
    }
#[no_mangle]
unsafe extern "C" fn asd_map_ha(asd_ha: *mut asd_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn asd_unmap_ha(asd_ha: *mut asd_ha_struct) {
...
#[no_mangle]
unsafe extern "C" fn asd_common_setup(asd_ha: *mut asd_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn asd_aic9410_setup(asd_ha: *mut asd_ha_struct) -> c_int {
    static int asd_aic9410_setup(struct asd_ha_struct *asd_ha)
    {
    let mut err: c_int = asd_common_setup(asd_ha);
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn asd_aic9405_setup(asd_ha: *mut asd_ha_struct) -> c_int {
    ...
    static DEVICE_ATTR(aic_revision, S_IRUGO, asd_show_dev_rev, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(bios_build, S_IRUGO, asd_show_dev_bios_build, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(pcba_sn, S_IRUGO, asd_show_dev_pcba_sn, core::ptr::null_mut());
pub const FLASH_CMD_NONE: c_uint = 0x00;
pub const FLASH_CMD_UPDATE: c_uint = 0x01;
pub const FLASH_CMD_VERIFY: c_uint = 0x02;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct flash_command {
    pub command: [u8; 8],
    pub code: c_int,
}
    ...
    {"",            FLASH_CMD_NONE}      /* Last entry should be core::ptr::null_mut(). */
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct error_bios {
    ...
    int res, i;
    let mut csum: u32 = 0;
    let mut flash_command: c_int = FLASH_CMD_NONE;
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn asd_create_dev_attrs(asd_ha: *mut asd_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn asd_remove_dev_attrs(asd_ha: *mut asd_ha_struct) {
...
#[no_mangle]
unsafe extern "C" fn asd_create_ha_caches(asd_ha: *mut asd_ha_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn asd_free_edbs(asd_ha: *mut asd_ha_struct) {
    ...
    kfree(seq.edb_arr);
    seq.edb_arr = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn asd_free_escbs(asd_ha: *mut asd_ha_struct) {
    ...
    kfree(seq.escb_arr);
    seq.escb_arr = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn asd_destroy_ha_caches(asd_ha: *mut asd_ha_struct) {
    ...
    asd_ha.hw_prof.ddb_bitmap = core::ptr::null_mut();
    for (i = 0; i < ASD_MAX_PHYS; i++) {
    ...
    asd_ha.hw_prof.ue.area = core::ptr::null_mut();
    }
    if (asd_ha.seq.tc_index_array) {
    kfree(asd_ha.seq.tc_index_array);
    kfree(asd_ha.seq.tc_index_bitmap);
    asd_ha.seq.tc_index_array = core::ptr::null_mut();
    asd_ha.seq.tc_index_bitmap = core::ptr::null_mut();
    }
    if (asd_ha.seq.actual_dl) {
    asd_free_coherent(asd_ha, asd_ha.seq.actual_dl);
    asd_ha.seq.actual_dl = core::ptr::null_mut();
    asd_ha.seq.dl = core::ptr::null_mut();
    }
    if (asd_ha.seq.next_scb.vaddr) {
    dma_pool_free(asd_ha.scb_pool, asd_ha.seq.next_scb.vaddr,
    asd_ha.seq.next_scb.dma_handle);
    asd_ha.seq.next_scb.vaddr = core::ptr::null_mut();
    }
    dma_pool_destroy(asd_ha.scb_pool);
    asd_ha.scb_pool = core::ptr::null_mut();
    }
    struct kmem_cache *asd_dma_token_cache;
    struct kmem_cache *asd_ascb_cache;
#[no_mangle]
unsafe extern "C" fn asd_create_global_caches() -> c_int {
    ...
    asd_dma_token_cache = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn asd_destroy_global_caches() {
    static void asd_destroy_global_caches(void)
    {
    kmem_cache_destroy(asd_dma_token_cache);
    asd_dma_token_cache = core::ptr::null_mut();
    kmem_cache_destroy(asd_ascb_cache);
    asd_ascb_cache = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn asd_register_sas_ha(asd_ha: *mut asd_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn asd_unregister_sas_ha(asd_ha: *mut asd_ha_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn asd_pci_probe(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    static int asd_pci_probe(struct pci_dev *dev, const struct pci_device_id *id)
    {
    const struct asd_pcidev_struct *asd_dev;
    let mut asd_id: unsigned = (unsigned) id.driver_data;
...
#[no_mangle]
unsafe extern "C" fn asd_free_queues(asd_ha: *mut asd_ha_struct) {
...
#[no_mangle]
unsafe extern "C" fn asd_turn_off_leds(asd_ha: *mut asd_ha_struct) {
    static void asd_turn_off_leds(struct asd_ha_struct *asd_ha)
    {
    let mut phy_mask: u8 = asd_ha.hw_prof.enabled_phys;
    u8 i;
...
#[no_mangle]
unsafe extern "C" fn asd_pci_remove(dev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn asd_scan_start(shost: *mut Scsi_Host) {
...
#[no_mangle]
unsafe extern "C" fn asd_scan_finished(shost: *mut Scsi_Host, time: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn version_show(driver: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn asd_create_driver_attrs(driver: *mut device_driver) -> c_int {
    static int asd_create_driver_attrs(struct device_driver *driver)
    {
    return driver_create_file(driver, &driver_attr_version);
    }
#[no_mangle]
unsafe extern "C" fn asd_remove_driver_attrs(driver: *mut device_driver) {
...
#[no_mangle]
unsafe extern "C" fn aic94xx_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aic94xx_exit() -> void __exit {
