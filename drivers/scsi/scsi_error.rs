...
//! Source: drivers/scsi/scsi_error.c
#![no_std]
...
//
    ...
    struct scsi_cmnd *);
#[no_mangle]
pub unsafe extern "C" fn scsi_eh_wakeup(shost: *mut Scsi_Host, busy: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_rcu_eh_wakeup(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_schedule_eh(shost: *mut Scsi_Host) {
...
#[no_mangle]
unsafe extern "C" fn scsi_host_eh_past_deadline(shost: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scsi_cmd_retry_allowed(cmd: *mut scsi_cmnd) -> bool {
...
#[no_mangle]
unsafe extern "C" fn scsi_eh_should_retry_cmd(cmd: *mut scsi_cmnd) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_eh_reset(scmd: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn scsi_eh_inc_host_failed(head: *mut rcu_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_eh_scmd_add(scmd: *mut scsi_cmnd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_timeout(req: *mut request) -> enum blk_eh_timer_return {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_block_when_processing_errors(sdev: *mut scsi_device) -> c_int {
...
//
    ...
    let mut total_failures: c_int = 0;
    let mut cmd_failed: c_int = 0;
    let mut cmd_cancel: c_int = 0;
    let mut devices_failed: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn scsi_report_lun_change(sdev: *mut scsi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn set_scsi_ml_byte(cmd: *mut scsi_cmnd, status: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_check_sense(scmd: *mut scsi_cmnd) -> enum scsi_disposition {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x29: sshdr.asc ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn scsi_handle_queue_ramp_up(sdev: *mut scsi_device) {
...
#[no_mangle]
unsafe extern "C" fn scsi_handle_queue_full(sdev: *mut scsi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_eh_completed_normally(scmd: *mut scsi_cmnd) -> enum scsi_disposition {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_eh_done(scmd: *mut scsi_cmnd) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_try_host_reset(scmd: *mut scsi_cmnd) -> enum scsi_disposition {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_try_bus_reset(scmd: *mut scsi_cmnd) -> enum scsi_disposition {
...
#[no_mangle]
unsafe extern "C" fn __scsi_report_device_reset(sdev: *mut scsi_device, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_try_target_reset(scmd: *mut scsi_cmnd) -> enum scsi_disposition {
    ...
    if (rtn == SUCCESS) {
    spin_lock_irqsave(host.host_lock, flags);
    __starget_for_each_device(scsi_target(scmd.device), core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn scsi_try_bus_device_reset(scmd: *mut scsi_cmnd) -> enum scsi_disposition {
    ...
    if (rtn == SUCCESS)
    __scsi_report_device_reset(scmd.device, core::ptr::null_mut());
    return rtn;
    }
//
...
#[no_mangle]
unsafe extern "C" fn scsi_abort_eh_cmnd(scmd: *mut scsi_cmnd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_eh_restore_cmnd(scmd: *mut *mut scsi_cmnd, ses: *mut scsi_eh_save) {
...
//
    ...
    let mut timeleft: c_ulong = timeout, delay;
    struct scsi_eh_save ses;
    let mut stall_for: c_ulong = msecs_to_jiffies(100);
    int rtn;
    retry:
...
// signal not to enter either branch of the if () below
    ...
    shost.eh_action = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn scsi_request_sense(scmd: *mut scsi_cmnd) -> enum scsi_disposition {
    static enum scsi_disposition scsi_request_sense(struct scsi_cmnd *scmd)
    {
    return scsi_send_eh_cmnd(scmd, core::ptr::null_mut(), 0, scmd.device.eh_timeout, ~0);
    }
    static enum scsi_disposition
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_eh_finish_cmd(scmd: *mut scsi_cmnd, done_q: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn if(NEEDS_RETRY: rtn !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_eh_tur(scmd: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_eh_try_stu(scmd: *mut scsi_cmnd) -> c_int {
    static int scsi_eh_try_stu(struct scsi_cmnd *scmd)
    {
    static unsigned char stu_command[6] = {START_STOP, 0, 0, 0, 1, 0};
    if (scmd.device.allow_restart) {
    int i;
    let mut rtn: enum scsi_disposition = NEEDS_RETRY;
...
#[no_mangle]
pub unsafe extern "C" fn if(FAST_IO_FAIL: rtn ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_noretry_cmd(scmd: *mut scsi_cmnd) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_decide_disposition(scmd: *mut scsi_cmnd) -> enum scsi_disposition {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_eh_lock_door(sdev: *mut scsi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_restart_operations(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_eh_flush_done_q(done_q: *mut list_head) {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_unjam_host(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_error_handler(data: *mut c_void) -> c_int {
...
//
    ...
    shost.host_no));
    shost.ehandler = core::ptr::null_mut();
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_report_bus_reset(shost: *mut Scsi_Host, channel: c_int) {
    void scsi_report_bus_reset(struct Scsi_Host *shost, int channel)
    {
    struct scsi_device *sdev;
    __shost_for_each_device(sdev, shost) {
    if (channel == sdev_channel(sdev))
    __scsi_report_device_reset(sdev, core::ptr::null_mut());
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_report_device_reset(shost: *mut Scsi_Host, channel: c_int, target: c_int) {
...
//
    ...
    blk_rq_init(core::ptr::null_mut(), rq);
