...
//! Source: drivers/scsi/scsi_common.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn scsi_pr_type_to_block(type: enum scsi_pr_type) -> enum pr_type {
...
#[no_mangle]
pub unsafe extern "C" fn block_pr_type_to_scsi(type: enum pr_type) -> enum scsi_pr_type {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsilun_to_int(scsilun: *mut scsi_lun) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn int_to_scsilun(lun: u64, scsilun: *mut scsi_lun) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_build_sense_buffer(desc: c_int, buf: *mut u8, key: u8, asc: u8, ascq: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_set_sense_information(buf: *mut u8, buf_len: c_int, info: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_set_sense_field_pointer(buf: *mut u8, buf_len: c_int, fp: u16, bp: u8, cd: bool) -> c_int {
