...
//! Source: drivers/scsi/mvsas/mv_64xx.h
#![no_std]
...
pub const MAX_SG_ENTRY: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvs_prd {
    pub /: *mut *mut __le64 addr; / 64-bit buffer address,
    pub reserved: __le32,
    pub /: *mut *mut __le32 len; / 16-bit length,
}

pub const SPI_CTRL_REG: c_uint = 0xc0;

pub const SPI_CMD_REG: c_uint = 0xc4;
pub const SPI_DATA_REG: c_uint = 0xc8;
pub const SPI_CTRL_REG_64XX: c_uint = 0x10;
pub const SPI_CMD_REG_64XX: c_uint = 0x14;
pub const SPI_DATA_REG_64XX: c_uint = 0x18;
