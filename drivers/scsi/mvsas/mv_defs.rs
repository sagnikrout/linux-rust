...
//! Source: drivers/scsi/mvsas/mv_defs.h
#![no_std]
...
//
pub const PCI_DEVICE_ID_ARECA_1300: c_uint = 0x1300;
pub const PCI_DEVICE_ID_ARECA_1320: c_uint = 0x1320;
#[repr(C)]
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum peripheral_register_bits {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sas_sata_config_port_regs {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum sas_cmd_port_registers {
...
#[repr(C)]
#[derive(Copy, Clone, PartialEq, Eq)]
pub enum pci_cfg_register_bits {
