...
//! Source: drivers/scsi/mvsas/mv_init.c
#![no_std]
...
//
    ...
    let mut interrupt_coalescing: c_int = 0x80;
...
#[no_mangle]
unsafe extern "C" fn mvs_phy_init(mvi: *mut mvs_info, phy_id: c_int) {
    ...
    timer_setup(&phy.timer, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn mvs_free(mvi: *mut mvs_info) {
...
#[no_mangle]
unsafe extern "C" fn mvs_tasklet(opaque: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn mvs_interrupt(irq: c_int, opaque: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mvs_alloc(mvi: *mut mvs_info, shost: *mut Scsi_Host) -> c_int {
    static int mvs_alloc(struct mvs_info *mvi, struct Scsi_Host *shost)
    {
    let mut i: c_int = 0, slot_nr;
    char pool_name[32];
    if (mvi.flags & MVF_FLAG_SOC)
    slot_nr = MVS_SOC_SLOTS;
    else
...
#[no_mangle]
pub unsafe extern "C" fn mvs_ioremap(mvi: *mut mvs_info, bar: c_int, bar_ex: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mvs_iounmap(regs: *mut void __iomem) {
    ...
    {
    struct mvs_info *mvi = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pci_go_64(pdev: *mut pci_dev) -> c_int {
    ...
    struct mvs_info *mvi = core::ptr::null_mut();
    struct sas_ha_struct *sha = SHOST_TO_SAS_HA(shost);
    let mut nr_core: c_ushort = ((struct mvs_prv_info *)sha.lldd_ha).n_host;
    for (j = 0; j < nr_core; j++) {
...
#[no_mangle]
unsafe extern "C" fn mvs_init_sas_add(mvi: *mut mvs_info) {
...
#[no_mangle]
unsafe extern "C" fn mvs_pci_init(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int mvs_pci_init(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    unsigned int rc, nhost = 0;
    struct mvs_info *mvi;
    let mut irq_handler: irq_handler_t = mvs_interrupt;
...
#[no_mangle]
unsafe extern "C" fn mvs_pci_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn mvs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mvs_exit() -> void __exit {
