...
//! Source: drivers/scsi/mvsas/mv_94xx.h
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub union reg_phy_cfg {
    pub v: u32,
    pub phy_reset:1: u32,
    pub sas_support:1: u32,
    pub sata_support:1: u32,
    pub sata_host_mode:1: u32,
//
// bit 2: 6Gbps support
// bit 1: 3Gbps support
// bit 0: 1.5Gbps support
//
    pub speed_support:3: u32,
    pub snw_3_support:1: u32,
    pub tx_lnk_parity:1: u32,
//
...
//
    pub tx_spt_phs_lnk_rate:6: u32,
// 8h: 1.5Gbps 9h: 3Gbps Ah: 6Gbps
    pub tx_lgcl_lnk_rate:4: u32,
    pub tx_ssc_type:1: u32,
    pub sata_spin_up_spt:1: u32,
    pub sata_spin_up_en:1: u32,
    pub bypass_oob:1: u32,
    pub disable_phy:1: u32,
    pub rsvd:8: u32,
    pub u: },
}

pub const MAX_SG_ENTRY: c_int = 255;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mvs_prd_imt {
    pub len:22: __le32,
    pub _r_a:2: u8,
    pub misc_ctl:4: u8,
    pub inter_sel:4: u8,
...
pub const SPI_CTRL_REG_94XX: c_uint = 0xc800;
pub const SPI_ADDR_REG_94XX: c_uint = 0xc804;
pub const SPI_WR_DATA_REG_94XX: c_uint = 0xc808;
pub const SPI_RD_DATA_REG_94XX: c_uint = 0xc80c;

    pub ~v: u64 x =,
    pub -1: return x ? __ffs64(x) :,

    pub mvs_94xx_dispatch: extern struct mvs_dispatch,
