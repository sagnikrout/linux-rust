...
//! Source: drivers/scsi/libiscsi.c
#![no_std]
...
pub const ISCSI_CMD_COMPL_WAIT: c_int = 5;
#[no_mangle]
pub unsafe extern "C" fn iscsi_conn_queue_xmit(conn: *mut iscsi_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_conn_queue_recv(conn: *mut iscsi_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_update_cmdsn(session: *mut iscsi_session, hdr: *mut iscsi_nopin) {
...
//
    ...
    let mut left: c_uint = r2t.data_length - r2t.sent;
...
#[no_mangle]
unsafe extern "C" fn iscsi_add_hdr(task: *mut iscsi_task, len: unsigned) -> c_int {
    static int iscsi_add_hdr(struct iscsi_task *task, unsigned len)
    {
    let mut exp_len: unsigned = task.hdr_len + len;
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_prep_ecdb_ahs(task: *mut iscsi_task) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_check_tmf_restrictions(task: *mut iscsi_task, opcode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_prep_scsi_cmd_pdu(task: *mut iscsi_task) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ISCSI_CDB_SIZE: cmd_len >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_free_task(task: *mut iscsi_task) {
    static void iscsi_free_task(struct iscsi_task *task)
    {
    struct iscsi_conn *conn = task.conn;
    struct iscsi_session *session = conn.session;
    struct scsi_cmnd *sc = task.sc;
    let mut oldstate: c_int = task.state;
    ISCSI_DBG_SESSION(session, "freeing task itt 0x%x state %d sc %p\n",
    task.itt, task.state, task.sc);
    session.tt.cleanup_task(task);
    task.state = ISCSI_TASK_FREE;
    task.sc = core::ptr::null_mut();
//
...
// SCSI eh reuses commands to verify us
    iscsi_cmd(sc).task = core::ptr::null_mut();
//
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_get_task(task: *mut iscsi_task) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn __iscsi_put_task(task: *mut iscsi_task) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_put_task(task: *mut iscsi_task) {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_complete_task(task: *mut iscsi_task, state: c_int) {
    ...
    WRITE_ONCE(conn.ping_task, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn cleanup_queued_task(task: *mut iscsi_task) -> bool {
    static bool cleanup_queued_task(struct iscsi_task *task)
    {
    struct iscsi_conn *conn = task.conn;
    let mut early_complete: bool = false;
//
...
//
    ...
    conn.session.running_aborted_task = core::ptr::null_mut();
    __iscsi_put_task(task);
    }
    if (conn.task == task) {
    conn.task = core::ptr::null_mut();
    __iscsi_put_task(task);
    }
...
//
#[no_mangle]
unsafe extern "C" fn __fail_scsi_task(task: *mut iscsi_task, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fail_scsi_task(task: *mut iscsi_task, err: c_int) {
    ...
    let mut opcode: u8 = hdr.opcode & ISCSI_OPCODE_MASK;
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_send_mgmt_task(task: *mut iscsi_task) -> c_int {
...
//
    ...
    let mut res_count: c_int = be32_to_cpu(rhdr.residual_count);
    if (res_count > 0 &&
...
#[no_mangle]
unsafe extern "C" fn iscsi_tmf_rsp(conn: *mut iscsi_conn, hdr: *mut iscsi_hdr) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ISCSI_TMF_RSP_NO_TASK: tmf->response ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn iscsi_send_nopout(conn: *mut iscsi_conn, rhdr: *mut iscsi_nopin) -> c_int {
    ...
    task = iscsi_alloc_mgmt_task(conn, (struct iscsi_hdr *)&hdr, core::ptr::null_mut(), 0);
    if (!task)
    return -ENOMEM;
    if (!rhdr)
...
//
    ...
    return core::ptr::null_mut();
    if (session.tt.parse_pdu_itt)
    session.tt.parse_pdu_itt(conn, itt, &i, core::ptr::null_mut());
    else
    i = get_itt(itt);
...
//
    ...
    {
    struct iscsi_session *session = conn.session;
    let mut opcode: c_int = hdr.opcode & ISCSI_OPCODE_MASK, rc = 0;
    struct iscsi_task *task;
    uint32_t itt;
    conn.last_recv = jiffies;
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_verify_itt(conn: *mut iscsi_conn, itt: itt_t) -> c_int {
    int iscsi_verify_itt(struct iscsi_conn *conn, itt_t itt)
    {
    struct iscsi_session *session = conn.session;
    let mut age: c_int = 0, i = 0;
    if (itt == RESERVED_ITT)
    return 0;
    if (session.tt.parse_pdu_itt)
    ...
    i = get_itt(itt);
    age = (( u32)itt >> ISCSI_AGE_SHIFT) & ISCSI_AGE_MASK;
    }
    if (age != session.age) {
    iscsi_conn_printk(KERN_ERR, conn,
...
#[no_mangle]
unsafe extern "C" fn iscsi_set_conn_failed(conn: *mut iscsi_conn) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_conn_failure(conn: *mut iscsi_conn, err: enum iscsi_err) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_check_cmdsn_window_closed(conn: *mut iscsi_conn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_requeue_task(task: *mut iscsi_task) {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_data_xmit(conn: *mut iscsi_conn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_xmitworker(work: *mut work_struct) {
...
//
    ...
    struct iscsi_conn *conn;
    struct iscsi_task *task = core::ptr::null_mut();
    sc.result = 0;
    iscsi_cmd(sc).task = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_target_alloc(starget: *mut scsi_target) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_tmf_timedout(t: *mut timer_list) {
...
// unblock eh_abort()
    ...
    {
    struct iscsi_session *session = conn.session;
    if (__iscsi_conn_send_pdu(conn, (struct iscsi_hdr *)hdr, core::ptr::null_mut(), 0)) {
    spin_unlock_bh(&session.frwd_lock);
...
//
#[no_mangle]
unsafe extern "C" fn fail_scsi_tasks(conn: *mut iscsi_conn, lun: u64, error: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_suspend_queue(conn: *mut iscsi_conn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_suspend_tx(conn: *mut iscsi_conn) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_start_tx(conn: *mut iscsi_conn) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_suspend_rx(conn: *mut iscsi_conn) {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_has_ping_timed_out(conn: *mut iscsi_conn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_eh_cmd_timed_out(sc: *mut scsi_cmnd) -> enum scsi_timeout_action {
    enum scsi_timeout_action iscsi_eh_cmd_timed_out(struct scsi_cmnd *sc)
    {
    let mut rc: enum scsi_timeout_action = SCSI_EH_NOT_HANDLED;
    struct iscsi_task *task = core::ptr::null_mut(), *running_task;
    struct iscsi_cls_session *cls_session;
    struct iscsi_session *session;
    struct iscsi_conn *conn;
    int i;
...
// Make sure there is a transport check done
    iscsi_send_nopout(conn, core::ptr::null_mut());
    task.have_checked_conn = true;
    rc = SCSI_EH_RESET_TIMER;
    done:
    spin_unlock_bh(&session.frwd_lock);
...
#[no_mangle]
unsafe extern "C" fn iscsi_check_transport_timeouts(t: *mut timer_list) {
...
// send a ping to try to provoke some traffic
    ...
    if (iscsi_send_nopout(conn, core::ptr::null_mut()))
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_conn_unbind(cls_conn: *mut iscsi_cls_conn, is_active: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_eh_abort(sc: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_prep_lun_reset_pdu(sc: *mut scsi_cmnd, hdr: *mut iscsi_tm) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_eh_device_reset(sc: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_session_recovery_timedout(cls_session: *mut iscsi_cls_session) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_eh_session_reset(sc: *mut scsi_cmnd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_prep_tgt_reset_pdu(sc: *mut scsi_cmnd, hdr: *mut iscsi_tm) {
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_eh_target_reset(sc: *mut scsi_cmnd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_eh_recover_target(sc: *mut scsi_cmnd) -> c_int {
...
// the array.
    ...
    if (q.pool == core::ptr::null_mut())
    return -ENOMEM;
    kfifo_init(&q.queue, (void*)q.pool, max * sizeof(void*));
    for (i = 0; i < max; i++) {
    q.pool[i] = kzalloc(item_size, GFP_KERNEL);
    if (q.pool[i] == core::ptr::null_mut()) {
    q.max = i;
    goto enomem;
    }
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_pool_free(q: *mut iscsi_pool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_host_add(shost: *mut Scsi_Host, pdev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iscsi_notify_host_removed(cls_session: *mut iscsi_cls_session) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_host_remove(shost: *mut Scsi_Host, is_shutdown: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_host_free(shost: *mut Scsi_Host) {
...
#[no_mangle]
unsafe extern "C" fn iscsi_host_dec_session_cnt(shost: *mut Scsi_Host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_session_remove(cls_session: *mut iscsi_cls_session) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_session_free(cls_session: *mut iscsi_cls_session) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_session_teardown(cls_session: *mut iscsi_cls_session) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_conn_teardown(cls_conn: *mut iscsi_cls_conn) {
...
// regular RX path uses back_lock
    ...
    spin_unlock_bh(&session.back_lock);
    if (session.leadconn == conn)
    session.leadconn = core::ptr::null_mut();
    spin_unlock_bh(&session.frwd_lock);
    mutex_unlock(&session.eh_mutex);
    iscsi_put_conn(cls_conn);
    }
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_conn_start(cls_conn: *mut iscsi_cls_conn) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_conn_stop(cls_conn: *mut iscsi_cls_conn, flag: c_int) {
...
//
    ...
    session.state = ISCSI_STATE_TERMINATE;
#[no_mangle]
pub unsafe extern "C" fn if(STOP_CONN_RECOVER: conn->stop_stage !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_switch_str_param(param: *mut c_char, new_val_buf: *mut c_char) -> c_int {
...
// param = new_val;
    ...
    enum iscsi_param param, char *buf)
    {
    struct sockaddr_in6 *sin6 = core::ptr::null_mut();
    struct sockaddr_in *sin = core::ptr::null_mut();
    int len;
