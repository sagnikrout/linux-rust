...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct srp_host_attrs {
    pub next_port_id: core::sync::atomic::AtomicI32,
}

pub const SRP_HOST_ATTRS: c_int = 0;
pub const SRP_RPORT_ATTRS: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct srp_internal {
    pub t: scsi_transport_template,
    pub f: *mut srp_function_template,
    pub 1]: *mut *mut device_attribute host_attrs[SRP_HOST_ATTRS +,
    pub 1]: *mut *mut device_attribute rport_attrs[SRP_RPORT_ATTRS +,
...
#[no_mangle]
unsafe extern "C" fn find_child_rport(dev: *mut device, data: *mut c_void) -> c_int {
...
// child = dev;
    ...
    {
    struct device *child = core::ptr::null_mut();
    WARN_ON_ONCE(device_for_each_child(&shost.shost_gendev, &child,
    find_child_rport) < 0);
    return child ? dev_to_rport(child) : core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_tmo_valid(reconnect_delay: c_int, fast_io_fail_tmo: c_int, dev_loss_tmo: c_long) -> c_int {
    ...
    static DEVICE_ATTR(port_id, S_IRUGO, show_srp_rport_id, core::ptr::null_mut());
    static const struct {
    u32 value;
    char *name;
    ...
    static DEVICE_ATTR(roles, S_IRUGO, show_srp_rport_roles, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(delete, S_IWUSR, core::ptr::null_mut(), store_srp_rport_delete);
    ...
    struct srp_rport *rport = transport_class_to_srp_rport(dev);
    let mut state: enum srp_rport_state = rport.state;
    return sprintf(buf, "%s\n",
    (unsigned)state < ARRAY_SIZE(state_name) ?
    state_name[state] : "???");
    }
    static DEVICE_ATTR(state, S_IRUGO, show_srp_rport_state, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn srp_show_tmo(buf: *mut c_char, tmo: c_int) -> isize {
    static ssize_t srp_show_tmo(char *buf, int tmo)
    {
    return tmo >= 0 ? sprintf(buf, "%d\n", tmo) : sprintf(buf, "off\n");
    }
#[no_mangle]
pub unsafe extern "C" fn srp_parse_tmo(tmo: *mut c_int, buf: *const c_char) -> c_int {
...
// tmo = -1;
    ...
    static DEVICE_ATTR(failed_reconnects, S_IRUGO, show_failed_reconnects, core::ptr::null_mut());
    ...
    {
    let mut old_state: enum srp_rport_state = rport.state;
...
//
#[no_mangle]
unsafe extern "C" fn srp_reconnect_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn __rport_fail_io_fast(rport: *mut srp_rport) {
...
//
#[no_mangle]
unsafe extern "C" fn rport_fast_io_fail_timedout(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn rport_dev_loss_timedout(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __srp_start_tl_fail_timers(rport: *mut srp_rport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_start_tl_fail_timers(rport: *mut srp_rport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_reconnect_rport(rport: *mut srp_rport) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_timed_out(scmd: *mut scsi_cmnd) -> enum scsi_timeout_action {
...
#[no_mangle]
unsafe extern "C" fn srp_rport_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn scsi_is_srp_rport(dev: *const device) -> c_int {
    static int scsi_is_srp_rport(const struct device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn srp_host_match(cont: *mut attribute_container, dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_rport_get(rport: *mut srp_rport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_rport_put(rport: *mut srp_rport) {
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_rport_del(rport: *mut srp_rport) {
...
#[no_mangle]
unsafe extern "C" fn do_srp_rport_del(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_remove_host(shost: *mut Scsi_Host) {
    void srp_remove_host(struct Scsi_Host *shost)
    {
    device_for_each_child(&shost.shost_gendev, core::ptr::null_mut(), do_srp_rport_del);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_stop_rport_timers(rport: *mut srp_rport) {
...
//
    ...
    i.host_attrs[0] = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn srp_release_transport(t: *mut scsi_transport_template) {
...
#[no_mangle]
unsafe extern "C" fn srp_transport_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn srp_transport_exit() -> void __exit {
