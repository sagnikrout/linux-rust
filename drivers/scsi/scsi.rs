...
#[no_mangle]
pub unsafe extern "C" fn scsi_log_send(cmd: *mut scsi_cmnd) {
...
#[no_mangle]
pub unsafe extern "C" fn scsi_log_completion(cmd: *mut scsi_cmnd, disposition: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_finish_command(cmd: *mut scsi_cmnd) {
...
//
    ...
    let mut old_good_bytes: c_int = good_bytes;
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_device_max_queue_depth(sdev: *mut scsi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_change_queue_depth(sdev: *mut scsi_device, depth: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_track_queue_full(sdev: *mut scsi_device, depth: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scsi_get_vpd_size(sdev: *mut scsi_device, page: u8) -> c_int {
...
//
    ...
    return -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(vpd_len: result >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_attach_vpd(sdev: *mut scsi_device) {
...
pub const SCSI_CDL_CHECK_BUF_LEN: c_int = 64;
...
//
    cdlp = (buf[1] & 0x18) >> 3;
    let mut cdlp: return = = 0x01 || cdlp == 0x02;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_cdl_check(sdev: *mut scsi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_cdl_enable(sdev: *mut scsi_device, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_device_get(sdev: *mut scsi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_device_put(sdev: *mut scsi_device) {
...
// helper for shost_for_each_device, see that for documentation
    ...
    struct scsi_device *next = core::ptr::null_mut();
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn init_scsi() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_scsi() -> void __exit {
