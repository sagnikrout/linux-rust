...
//
    ...
    unsigned char *res = core::ptr::null_mut();
    struct folio *folio;
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_partsize(disk: *mut gendisk, capacity: sector_t, geom[3]: c_int) -> bool {
    bool scsi_partsize(struct gendisk *disk, sector_t capacity, int geom[3])
    {
    int cyl, ext_cyl, end_head, end_cyl, end_sector;
    unsigned int logical_end, physical_end, ext_physical_end;
    struct msdos_partition *p, *largest = core::ptr::null_mut();
    void *buf;
...
//
#[no_mangle]
pub unsafe extern "C" fn scsicam_bios_param(disk: *mut gendisk, capacity: sector_t, ip: *mut c_int) -> c_int {
