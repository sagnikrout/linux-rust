...
//! Source: drivers/scsi/qla2xxx/qla_init.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_sp_free(sp: *mut srb_t) {
...
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_rel_done_warning(sp: *mut srb_t, res: c_int) {
    void qla2xxx_rel_done_warning(srb_t *sp, int res)
    {
    WARN_ONCE(1, "Calling done() of an already freed srb %p object\n", sp);
    }
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_rel_free_warning(sp: *mut srb_t) {
...
#[no_mangle]
unsafe extern "C" fn qla24xx_abort_iocb_timeout(data: *mut c_void) {
    ...
    u32 handle;
    unsigned long flags;
    let mut sp_found: c_int = 0, cmdsp_found = 0;
    if (sp.cmd_sp)
    ...
    sp.cmd_sp)) {
    qpair.req.outstanding_cmds[handle] = core::ptr::null_mut();
    cmdsp_found = 1;
...
#[no_mangle]
unsafe extern "C" fn qla24xx_abort_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_async_abort_cmd(cmd_sp: *mut srb_t, wait: bool) -> c_int {
    int qla24xx_async_abort_cmd(srb_t *cmd_sp, bool wait)
    {
    scsi_qla_host_t *vha = cmd_sp.vha;
    struct srb_iocb *abt_iocb;
    srb_t *sp;
    let mut rval: c_int = QLA_FUNCTION_FAILED;
...
#[no_mangle]
unsafe extern "C" fn qla2x00_async_login_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_async_logout_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_async_prlo_sp_done(sp: *mut srb_t, res: c_int) {
...
// ref: INIT
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn qla24xx_handle_adisc_event(vha: *mut scsi_qla_host_t, ea: *mut event_arg) {
...
#[no_mangle]
unsafe extern "C" fn qla_post_els_plogi_work(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_async_adisc_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_is_reserved_id(vha: *mut scsi_qla_host_t, loop_id: u16) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn qla2x00_find_new_loop_id(vha: *mut scsi_qla_host_t, dev: *mut fc_port_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_clear_loop_id(fcport: *mut fc_port_t) {
...
#[no_mangle]
unsafe extern "C" fn qla24xx_async_gnl_sp_done(sp: *mut srb_t, res: c_int) {
    static void qla24xx_async_gnl_sp_done(srb_t *sp, int res)
    {
    struct scsi_qla_host *vha = sp.vha;
    unsigned long flags;
    struct fc_port *fcport = core::ptr::null_mut(), *tf;
    u16 i, n = 0, loop_id;
    struct event_arg ea;
    struct get_name_list_extended *e;
    u64 wwn;
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_async_gnl(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_post_gnl_work(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qla24xx_async_gpdb_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_post_prli_work(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_async_prli_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_post_gpdb_work(vha: *mut scsi_qla_host, fcport: *mut fc_port_t, opt: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_async_gpdb(vha: *mut scsi_qla_host, fcport: *mut fc_port_t, opt: u8) -> c_int {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn __qla24xx_handle_gpdb_event(vha: *mut scsi_qla_host_t, ea: *mut event_arg) {
...
// Start edif prli timer & ring doorbell for app
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn qla24xx_handle_gpdb_event(vha: *mut scsi_qla_host_t, ea: *mut event_arg) {
...
#[no_mangle]
unsafe extern "C" fn qla_chk_n2n_b4_login(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) {
    ...
    login = 1;
#[no_mangle]
pub unsafe extern "C" fn if(DSC_LS_PLOGI_COMP: (fcport->fw_login_state ==) -> else {
...
// initiator mode
    ...
    "%s %d %8phC post login\n",
    __func__, __LINE__, fcport.port_name);
    qla2x00_post_async_login_work(vha, fcport, core::ptr::null_mut());
    }
    }
#[no_mangle]
pub unsafe extern "C" fn qla24xx_fcport_handle_login(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qla_rscn_gen_tick(vha: *mut scsi_qla_host_t, ret_rscn_gen: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_handle_rscn(vha: *mut scsi_qla_host_t, ea: *mut event_arg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla_rscn_replay(fcport: *mut fc_port_t) {
    ...
    sp.qpair.req.outstanding_cmds[h] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qla_marker_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_tmf_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qla_tmf_wait(arg: *mut tmf_arg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qla_put_tmf(arg: *mut tmf_arg) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn qla_get_tmf(arg: *mut tmf_arg) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla_enable_fce_trace(vha: *mut scsi_qla_host_t) {
...
#[no_mangle]
unsafe extern "C" fn qla_enable_eft_trace(vha: *mut scsi_qla_host_t) {
...
// data = rd_reg_dword(&reg->iobase_window + RISC_REGISTER_WINDOW_OFFSET);
    ...
    {
    let mut wd32: u32 = 0;
    let mut delta_msec: c_uint = 100;
    let mut elapsed_msec: c_uint = 0;
    uint timeout_msec;
    ulong n;
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_alloc_fce_trace(vha: *mut scsi_qla_host_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_free_fce_trace(ha: *mut qla_hw_data) {
...
// Allocate memory for Extended Trace Buffer.
    ...
    let mut req_entry_size: usize = qla_req_entry_size(ha);
    let mut rsp_entry_size: usize = qla_rsp_entry_size(ha);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_QLA81XX(ha)) -> else {
    else if (IS_QLA81XX(ha))
    fixed_size = offsetof(struct qla81xx_fw_dump, ext_mem);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_QLA25XX(ha)) -> else {
...
// Add space for spare MPI fw dump.
    ...
    {
pub const MPS_MASK: c_uint = 0xe0;
    int rval;
    uint16_t dc;
    uint32_t dw;
    if (!IS_QLA81XX(vha.hw))
...
//
    ...
    if (!req.outstanding_cmds) {
    ql_log(ql_log_fatal, core::ptr::null_mut(), 0x0126,
...
#[no_mangle]
unsafe extern "C" fn qla2xxx_print_sfp_info(vha: *mut scsi_qla_host) {
    static void qla2xxx_print_sfp_info(struct scsi_qla_host *vha)
    {
pub const STR_LEN: c_int = 64;
...
pub const LR_DISTANCE_UNKNOWN: c_int = 2;
...
// Determine SR/LR capabilities of SFP/Transceiver.
    rc = qla2x00_read_sfp_dev(vha, core::ptr::null_mut(), 0);
    if (rc)
    goto out;
    used_nvram = 0;
...
#[no_mangle]
unsafe extern "C" fn __qla_adjust_iocb_limit(qpair: *mut qla_qpair) {
...
#[no_mangle]
pub unsafe extern "C" fn qla_init_iocb_limit(vha: *mut scsi_qla_host_t) {
...
#[no_mangle]
pub unsafe extern "C" fn qla_adjust_iocb_limit(vha: *mut scsi_qla_host_t) {
...
//
    ...
    {
    int rval;
    let mut srisc_address: u32 = 0;
    struct qla_hw_data *ha = vha.hw;
    struct device_reg_2xxx __iomem *reg = &ha.iobase.isp;
    unsigned long flags;
    let mut done_once: c_int = 0;
    if (IS_P3P_TYPE(ha)) {
...
#[no_mangle]
pub unsafe extern "C" fn if(IS_FAC_REQUIRED(ha): rval == QLA_SUCCESS &&) -> else {
    uint32_t size;
...
//
    ...
    rsp.ring_index    = 0;
    rsp.status_srb = core::ptr::null_mut();
...
// req->out_ptr = 0;
    ...
    req.outstanding_cmds[cnt] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn qla2xxx_nvram_wwn_from_ofw(vha: *mut scsi_qla_host_t, nv: *mut nvram_t) {
...
#[no_mangle]
pub unsafe extern "C" fn if((int)ha->login_retry_count: ha->port_down_retry_count >) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_set_fcport_state(fcport: *mut fc_port_t, state: c_int) {
...
// Setup fcport template structure.
    ...
    fcport.ct_desc.ct_sns = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn qla_get_login_template(vha: *mut scsi_qla_host_t) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_configure_n2n_loop(vha: *mut scsi_qla_host_t) -> c_int {
...
// Get list of logged in devices.
    ...
    spin_unlock_irqrestore(&vha.work_lock, flags);
    if (vha.scan.scan_retry < MAX_SCAN_RETRIES) {
    let mut loop_map_entries: u8 = 0;
    int rc;
    rc = qla2x00_get_fcal_position_map(vha, core::ptr::null_mut(),
    &loop_map_entries);
...
// Allocate temporary fcport for any new fcports discovered.
    ...
    if (new_fcport == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn qla_do_iidma_work(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) {
...
#[no_mangle]
pub unsafe extern "C" fn qla_post_iidma_work(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) -> c_int {
...
//
    ...
    let mut wrap: port_id_t = {}, nxt_d_id;
    struct qla_hw_data *ha = vha.hw;
...
// FW does not set aside Loop id for MGMT Server/FFFFFAh
    ...
    {
    let mut loop_id: c_int = FC_NO_LOOP_ID;
    let mut lid: c_int = NPH_MGMT_SERVER - vha.vp_idx;
    unsigned long flags;
    struct qla_hw_data *ha = vha.hw;
    if (vha.vp_idx == 0) {
...
// Interrogate mailbox registers for any errors
    ...
    rval = 1;
#[no_mangle]
pub unsafe extern "C" fn if(MBS_COMMAND_PARAMETER_ERROR: mb[0] ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla2x00_perform_loop_resync(ha: *mut scsi_qla_host_t) -> c_int {
...
// Assumes idc_lock always held on entry
    ...
    let mut class_type_mask: u32 = 0x3;
    let mut fcoe_other_function: u16 = 0xffff, i;
    if (IS_QLA8044(ha)) {
...
// Assumes idc-lock always held on entry
    ...
    {
    struct qla_hw_data *ha = vha.hw;
    let mut idc_audit_reg: u32 = 0, duration_secs = 0;
    switch (audit_type) {
...
pub const MCTP_DUMP_STR_ADDR: c_uint = 0x00000000;
...
// Issue a marker after FW becomes ready.
    ...
    {
    struct rsp_que *rsp = core::ptr::null_mut();
    struct req_que *req = core::ptr::null_mut();
    struct scsi_qla_host *base_vha = pci_get_drvdata(ha.pdev);
    let mut ret: c_int = -1;
    int i;
...
// Enable ZIO.
    ...
    struct qla27xx_image_status *image_status)
    {
    let mut signature: c_ulong = le32_to_cpu(image_status.signature);
    ...
    {
    __le32 *p = ( __le32 *)image_status;
    let mut n: c_uint = sizeof(*image_status) / sizeof(*p);
    let mut sum: u32 = 0;
    for ( ; n--; p++)
    sum += le32_to_cpup(p);
    return sum;
...
// calculate generation delta as uint16 (this accounts for wrap)
    ...
    ql_dbg(ql_dbg_init, core::ptr::null_mut(), 0x0180, "generation delta = %d\n", delta);
    return delta;
    }
    void
    ...
    let mut valid_pri_image: bool = false, valid_sec_image = false;
    let mut active_pri_image: bool = false, active_sec_image = false;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_risc_firmware_invalid(dword: *mut u32) -> bool {
...
// srisc_addr = be32_to_cpu(( __be32)dcode[2]);
    return QLA_SUCCESS;
    }
    static int
    ...
    risc_size = be32_to_cpu(( __be32)dcode[3]);
    if (risc_attr == 0)
    risc_attr = be32_to_cpu(( __be32)dcode[9]);
    ...
    vfree(fwdt.template);
    fwdt.template = core::ptr::null_mut();
    fwdt.length = 0;
    dcode = (uint32_t *)req.ring;
    ...
    risc_size = be32_to_cpu(( __be32)dcode[2]);
...
// srisc_addr = 0;
    ...
    risc_addr = be32_to_cpu(( __be32)dcode[2]);
    risc_size = be32_to_cpu(( __be32)dcode[3]);
    if (!*srisc_addr) {
...
// Next segment.
    ...
    fwcode = ( __be32 *)blob.fw.data;
    dcode = ( uint32_t *)fwcode;
...
//
    ...
    {
    int rval;
    let mut f_region: u32 = 0;
    struct qla_hw_data *ha = vha.hw;
    let mut active_regions: active_regions = { };
...
// For 28XXX, always load the flash firmware using rom mbx
    ...
    {
    let mut rval: c_int = QLA_SUCCESS;
    uint32_t *dcode = core::ptr::null_mut();
    struct qla_hw_data *ha = vha.hw;
    struct req_que *req = ha.req_q_map[0];
    let mut num_segments: c_int = 0, segment = 0;
    let mut chunks_per_segment: c_int = 0, chunk = 0;
    let mut is_first_chunk: c_int = 0;
    let mut is_last_chunk: c_int = 0;
    let mut is_first_segment: c_int = 0;
    let mut is_last_segment: c_int = 0;
    let mut opt: c_int = 0;
    let mut size: u32 = 0;
    let mut size_remainder: u32 = 0;
    let mut seg_size_remainder: u32 = 0;
    let mut i: c_int = 0;
    dcode = (uint32_t *)req.ring;
    if (section == TIM) {
...
//
    ...
    {
    let mut fw_size: usize = blob.fw.size;
    size_t offset;
// TIM
...
// Get VPD data into cache
    ha.vpd = ha.nvram + VPD_OFFSET;
    if (IS_QLA29XX(ha)) {
    let mut fw_options: u16 = 0, r_code;
...
// check source pid for a match
    ...
    pid_match++;
#[no_mangle]
pub unsafe extern "C" fn if(pid2: pid1 ==) -> else {
    else if (pid1 == pid2)
    pid_match++;
    }
...
// check source WWN for a match
    ...
    wwn_match++;
#[no_mangle]
pub unsafe extern "C" fn if(wwn2: wwn1 ==) -> else {
    else if (wwn1 == wwn2)
    wwn_match++;
    }
...
// We need to set priority for all logged in ports
    ...
    {
    let mut rsp_id: c_int = 0;
    let mut req_id: c_int = 0;
    int i;
    struct qla_hw_data *ha = vha.hw;
    let mut qpair_id: u16 = 0;
    struct qla_qpair *qpair = core::ptr::null_mut();
    struct qla_msix_entry *msix;
...
// Mark as online
    ...
    fail_msix:
    ha.queue_pair_map[qpair_id] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_delete_qpair(vha: *mut scsi_qla_host, qpair: *mut qla_qpair) -> c_int {
    int qla2xxx_delete_qpair(struct scsi_qla_host *vha, struct qla_qpair *qpair)
    {
    let mut ret: c_int = QLA_FUNCTION_FAILED;
...
//
    ...
    rsp.msix.have_irq = 0;
    rsp.msix.in_use = 0;
    rsp.msix.handle = core::ptr::null_mut();
    }
    if (rsp && ha.wq)
...
// clean up allocated prev pool
    ...
    mutex_lock(&ha.mq_lock);
    ha.queue_pair_map[qpair.id] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_reset_stats(host: *mut Scsi_Host, flags: u32) -> c_int {
    int qla2xxx_reset_stats(struct Scsi_Host *host, u32 flags)
    {
    scsi_qla_host_t *vha = shost_priv(host);
    fc_port_t *fcport = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_start_stats(host: *mut Scsi_Host, flags: u32) -> c_int {
    int qla2xxx_start_stats(struct Scsi_Host *host, u32 flags)
    {
    return qla2xxx_reset_stats(host, flags);
    }
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_stop_stats(host: *mut Scsi_Host, flags: u32) -> c_int {
    ...
    let mut ini_entry_count: u64 = 0;
    let mut i: u64 = 0;
    let mut entry_count: u64 = 0;
    let mut num_tgt: u64 = 0;
    let mut tmp_stat_type: u32 = 0;
    fc_port_t *fcport = core::ptr::null_mut();
    unsigned long int_flags;
...
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_disable_port(host: *mut Scsi_Host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_enable_port(host: *mut Scsi_Host) -> c_int {
