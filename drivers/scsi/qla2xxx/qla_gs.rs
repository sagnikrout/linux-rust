...
//! Source: drivers/scsi/qla2xxx/qla_gs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qla2x00_async_sns_sp_done(sp: *mut srb_t, rc: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qla_async_rftid(vha: *mut scsi_qla_host_t, d_id: *mut port_id_t) -> c_int {
    static int qla_async_rftid(scsi_qla_host_t *vha, port_id_t *d_id)
    {
    let mut rval: c_int = QLA_MEMORY_ALLOC_FAILED;
    struct ct_sns_req *ct_req;
    srb_t *sp;
    struct ct_sns_pkt *ct_sns;
    if (!vha.flags.online)
    goto done;
// ref: INIT
    sp = qla2x00_get_sp(vha, core::ptr::null_mut(), GFP_KERNEL);
    if (!sp)
    goto done;
...
#[no_mangle]
unsafe extern "C" fn qla_async_rsnn_nn(vha: *mut scsi_qla_host_t) -> c_int {
...
//
    ...
    struct ct_sns_rsp	*ct_rsp;
    struct qla_hw_data *ha = vha.hw;
    let mut fcp_scsi_features: u8 = 0, nvme_features = 0;
    struct ct_arg arg;
    for (i = 0; i < ha.max_fibre_devices; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_post_gpsc_work(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_handle_gpsc_event(vha: *mut scsi_qla_host_t, ea: *mut event_arg) {
...
#[no_mangle]
unsafe extern "C" fn qla24xx_async_gpsc_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_async_gpsc(vha: *mut scsi_qla_host_t, fcport: *mut fc_port_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_sp_unmap(vha: *mut scsi_qla_host_t, sp: *mut srb_t) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_async_gffid_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_async_gffid(vha: *mut scsi_qla_host_t, fcport: *mut fc_port_t, wait: bool) -> c_int {
...
// GPN_FT + GNN_FT
#[no_mangle]
unsafe extern "C" fn qla2x00_is_a_vp(vha: *mut scsi_qla_host_t, wwn: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qla_ok_to_clear_rscn(vha: *mut scsi_qla_host_t, fcport: *mut fc_port_t) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn qla_fab_scan_finish(vha: *mut scsi_qla_host_t, sp: *mut srb_t) {
    ...
    unsigned long flags;
    let mut recheck: u8 = 0;
    let mut dup: u16 = 0, dup_cnt = 0;
...
//
    ...
    rp.node_name, core::ptr::null_mut(), rp.fc4type);
    }
    }
    if (dup) {
...
//
    ...
    {
    struct qla_hw_data *ha = vha.hw;
    let mut num_fibre_dev: c_int = ha.max_fibre_devices;
...
#[no_mangle]
unsafe extern "C" fn qla_async_scan_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qla_fab_async_scan(vha: *mut scsi_qla_host_t, sp: *mut srb_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla_fab_scan_start(vha: *mut scsi_qla_host) {
    void qla_fab_scan_start(struct scsi_qla_host *vha)
    {
    int rval;
    rval = qla_fab_async_scan(vha, core::ptr::null_mut());
    if (rval)
    set_bit(LOOP_RESYNC_NEEDED, &vha.dpc_flags);
    }
#[no_mangle]
pub unsafe extern "C" fn qla_scan_work_fn(work: *mut work_struct) {
...
// GPFN_ID
#[no_mangle]
pub unsafe extern "C" fn qla24xx_handle_gfpnid_event(vha: *mut scsi_qla_host_t, ea: *mut event_arg) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_async_gfpnid_sp_done(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_async_gfpnid(vha: *mut scsi_qla_host_t, fcport: *mut fc_port_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_post_gfpnid_work(vha: *mut scsi_qla_host, fcport: *mut fc_port_t) -> c_int {
