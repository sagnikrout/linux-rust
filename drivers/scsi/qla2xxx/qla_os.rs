...
//! Source: drivers/scsi/qla2xxx/qla_os.c
#![no_std]
...
//
    ...
    let mut ql2xenforce_iocb_limit: c_int = 2;
...
//
    let mut ql_errlev: c_uint = 0x8001;
    int ql2xsecenable;
    ...
    let mut ql2xlogintimeout: c_int = 20;
    ...
    let mut ql2xallocfwdump: c_int = 1;
    ...
    let mut ql2xextended_error_logging_ktrace: c_int = 1;
    ...
    let mut ql2xshiftctondsd: c_int = 6;
    module_param(ql2xshiftctondsd, int, S_IRUGO);
    MODULE_PARM_DESC(ql2xshiftctondsd,
    "Set to control shifting of command type processing "
    "based on total number of SG elements.");
    let mut ql2xfdmienable: c_int = 1;
...
pub const MAX_Q_DEPTH: c_int = 64;
    let mut ql2xmaxqdepth: static int = MAX_Q_DEPTH;
    module_param(ql2xmaxqdepth, int, S_IRUGO|S_IWUSR);
    MODULE_PARM_DESC(ql2xmaxqdepth,
    "Maximum queue depth to set for each LUN. "
    "Default is 64.");
    let mut ql2xenabledif: c_int = 2;
    ...
    let mut ql2xnvmeenable: c_int = 1;
    ...
    let mut ql2xenablehba_err_chk: c_int = 2;
    ...
    let mut ql2xasynctmfenable: c_int = 1;
    ...
    let mut ql2xmaxlun: u64 = MAX_LUNS;
    module_param(ql2xmaxlun, ullong, S_IRUGO);
    MODULE_PARM_DESC(ql2xmaxlun,
    "Defines the maximum LU number to register with the SCSI "
    "midlayer. Default is 65535.");
    let mut ql2xmdcapmask: c_int = 0x1F;
    module_param(ql2xmdcapmask, int, S_IRUGO);
    MODULE_PARM_DESC(ql2xmdcapmask,
    "Set the Minidump driver capture mask level. "
    "Default is 0x1F - Can be set to 0x3, 0x7, 0xF, 0x1F, 0x7F.");
    let mut ql2xmdenable: c_int = 1;
    ...
    let mut ql2xmvasynctoatio: c_int = 1;
    ...
    let mut ql2xabts_wait_nvme: c_int = 1;
    module_param(ql2xabts_wait_nvme, int, 0444);
    MODULE_PARM_DESC(ql2xabts_wait_nvme,
    "To wait for ABTS response on I/O timeouts for NVMe. (default: 1)");
    let mut ql2xdelay_before_pci_error_handling: static u32 = 5;
    ...
    let mut ql2xnvme_queues: u32 = DEF_NVME_HW_QUEUES;
    ...
    "8 - Default value");
    let mut ql2xfc2target: c_int = 1;
    module_param(ql2xfc2target, int, 0444);
    MODULE_PARM_DESC(qla2xfc2target,
    "Enables FC2 Target support. "
    "0 - FC2 Target support is disabled. "
    "1 - FC2 Target support is enabled (default).");
    static struct scsi_transport_template *qla2xxx_transport_template = core::ptr::null_mut();
    struct scsi_transport_template *qla2xxx_transport_vport_template = core::ptr::null_mut();
...
// init qpair to this cpu. Will adjust at run time.
    ...
    if (ha.base_qpair == core::ptr::null_mut()) {
    ...
    ha.queue_pair_map = core::ptr::null_mut();
    goto fail_qpair_map;
    }
    }
//
...
//
    ...
    fail_qpair_map:
    kfree(ha.base_qpair);
    ha.base_qpair = core::ptr::null_mut();
    fail_base_qpair:
    kfree(ha.rsp_q_map);
    ha.rsp_q_map = core::ptr::null_mut();
    fail_rsp_map:
    kfree(ha.req_q_map);
    ha.req_q_map = core::ptr::null_mut();
    fail_req_map:
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn qla2x00_free_req_que(ha: *mut qla_hw_data, req: *mut req_que) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_free_rsp_que(ha: *mut qla_hw_data, rsp: *mut rsp_que) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_free_queues(ha: *mut qla_hw_data) {
    ...
    ha.req_q_map[cnt] = core::ptr::null_mut();
    ...
    ha.rsp_q_map[cnt] =  core::ptr::null_mut();
    spin_unlock_irqrestore(&ha.hardware_lock, flags);
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_sp_free_dma(sp: *mut srb_t) {
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_sp_compl(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_qpair_sp_free_dma(sp: *mut srb_t) {
...
#[no_mangle]
pub unsafe extern "C" fn qla2xxx_qpair_sp_compl(sp: *mut srb_t, res: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn test_fcport_count(vha: *mut scsi_qla_host_t) -> c_int {
...
//
    ...
    struct qla_qpair *qpair;
    unsigned long flags;
    let mut fast_fail_status: c_int = SUCCESS;
...
// Wait for the command completion.
    ...
    sp.comp = core::ptr::null_mut();
    ql_log(ql_log_info, vha, 0x801c,
    "Abort command issued nexus=%ld:%d:%llu -- %x.\n",
    vha.host_no, id, lun, ret);
    return ret;
    }
pub const ABORT_POLLING_PERIOD: c_int = 1000;
...
//
    ...
    srb_t *sp;
    struct scsi_cmnd *cmd;
    let mut wait_iter: c_ulong = ABORT_WAIT_ITER;
    bool found;
    struct qla_hw_data *ha = vha.hw;
    status = QLA_SUCCESS;
    while (wait_iter--) {
...
// the base queue pair
    ...
    .beacon_on		= core::ptr::null_mut(),
    .beacon_off		= core::ptr::null_mut(),
    .beacon_blink		= core::ptr::null_mut(),
    .read_optrom		= qla2x00_read_optrom_data,
    .write_optrom		= qla2x00_write_optrom_data,
    .get_flash_version	= qla2x00_get_flash_version,
    .start_scsi		= qla2x00_start_scsi,
    .start_scsi_mq          = core::ptr::null_mut(),
    ...
    .calc_req_entries	= core::ptr::null_mut(),
    .build_iocbs		= core::ptr::null_mut(),
    ...
    .prep_ms_iocb		= qla24xx_prep_ms_iocb,
    .prep_ms_fdmi_iocb	= qla24xx_prep_ms_fdmi_iocb,
    .read_nvram		= core::ptr::null_mut(),
    .write_nvram		= core::ptr::null_mut(),
    ...
    .nvram_config		= core::ptr::null_mut(),
    .update_fw_options	= core::ptr::null_mut(),
    .load_risc		= core::ptr::null_mut(),
    ...
    .fabric_login		= core::ptr::null_mut(),
    .fabric_logout		= core::ptr::null_mut(),
    .calc_req_entries	= core::ptr::null_mut(),
    .build_iocbs		= core::ptr::null_mut(),
    .prep_ms_iocb		= qla24xx_prep_ms_iocb,
    .prep_ms_fdmi_iocb	= qla24xx_prep_ms_fdmi_iocb,
...
#[no_mangle]
unsafe extern "C" fn qla_heartbeat_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_iocb_work_fn(work: *mut work_struct) {
    ...
    qla_trace_init(void)
    {
    qla_trc_array = trace_array_get_by_name("qla2xxx", core::ptr::null_mut());
    if (!qla_trc_array) {
    ql_log(ql_log_fatal, core::ptr::null_mut(), 0x0001,
...
//
    ...
    scsi_qla_host_t *base_vha = core::ptr::null_mut();
    struct qla_hw_data *ha;
    char pci_info[30];
    char fw_str[30], wq_name[30];
    struct scsi_host_template *sht;
    int bars, mem_only = 0;
    let mut req_length: u16 = 0, rsp_length = 0;
...
// Check if FW supports MQ or not for ISP25xx
    ...
    ha.mqenable = 0;
    if (ha.mqenable) {
    let mut startit: bool = !!(host.active_mode & MODE_INITIATOR);
...
//
    ...
    ha.dpc_thread = core::ptr::null_mut();
    goto probe_failed;
    }
...
//
    ...
    base_vha.gnl.l = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn __qla_set_remove_flag(base_vha: *mut scsi_qla_host_t) {
...
// Turn-off FCE trace
    ...
    qla2x00_disable_fce_trace(vha, core::ptr::null_mut(), core::ptr::null_mut());
...
// Cancel all work and destroy DPC workqueues
    ...
    ha.dpc_lp_wq = core::ptr::null_mut();
    }
    if (ha.dpc_hp_wq) {
    ...
    ha.dpc_hp_wq = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn qla2x00_free_fcports(vha: *mut scsi_qla_host) {
...
#[no_mangle]
unsafe extern "C" fn qla2x00_set_reserved_loop_ids(ha: *mut qla_hw_data) {
...
// Get memory for cached NVRAM
    ...
    if (ql2xenabledif) {
    let mut bufsize: u64 = DIF_BUNDLING_DMA_POOL_SIZE;
...
// Allocate memory for NVRAM data for vports
    ...
    ha.npiv_info = core::ptr::null_mut();
...
// allocate the purex dma pool
    ...
    ha.elsrej.c = core::ptr::null_mut();
    ha.elsrej.cdma = 0;
    fail_elsrej:
    dma_pool_destroy(ha.purex_dma_pool);
    ha.purex_dma_pool = core::ptr::null_mut();
    fail_flt_data:
    vfree(ha.flt_data);
    ha.flt_data = core::ptr::null_mut();
    fail_flt:
    dma_free_coherent(&ha.pdev.dev, sizeof(struct qla_flt_header) + FLT_REGIONS_SIZE,
    ha.flt, ha.flt_dma);
    ha.flt = core::ptr::null_mut();
    ha.flt_dma = 0;
    fail_flt_buffer:
    dma_free_coherent(&ha.pdev.dev, SFP_DEV_SIZE,
    ha.sfp_data, ha.sfp_data_dma);
    ha.sfp_data = core::ptr::null_mut();
    ha.sfp_data_dma = 0;
    fail_sfp_data:
    kfree(ha.loop_id_map);
    ha.loop_id_map = core::ptr::null_mut();
    fail_loop_id_map:
    dma_pool_free(ha.s_dma_pool, ha.async_pd, ha.async_pd_dma);
    ha.async_pd = core::ptr::null_mut();
    ha.async_pd_dma = 0;
    fail_async_pd:
    dma_pool_free(ha.s_dma_pool, ha.sf_init_cb, ha.sf_init_cb_dma);
    ha.sf_init_cb = core::ptr::null_mut();
    ha.sf_init_cb_dma = 0;
    fail_sf_init_cb:
    dma_pool_free(ha.s_dma_pool, ha.ex_init_cb, ha.ex_init_cb_dma);
    ha.ex_init_cb = core::ptr::null_mut();
    ha.ex_init_cb_dma = 0;
    fail_ex_init_cb:
    kfree(ha.npiv_info);
    ha.npiv_info = core::ptr::null_mut();
...
// req = NULL;
    ...
    ha.ct_sns = core::ptr::null_mut();
    ha.ct_sns_dma = 0;
    fail_free_ms_iocb:
    dma_pool_free(ha.s_dma_pool, ha.ms_iocb, ha.ms_iocb_dma);
    ha.ms_iocb = core::ptr::null_mut();
    ha.ms_iocb_dma = 0;
    if (ha.sns_cmd)
    ...
    ha.dif_bundl_pool = core::ptr::null_mut();
    }
    fail_dif_bundl_dma_pool:
    if (IS_QLA82XX(ha) || IS_QLA29XX(ha) || ql2xenabledif) {
    dma_pool_destroy(ha.fcp_cmnd_dma_pool);
    ha.fcp_cmnd_dma_pool = core::ptr::null_mut();
    }
    fail_dl_dma_pool:
    if (IS_QLA82XX(ha) || IS_QLA29XX(ha) || ql2xenabledif) {
    dma_pool_destroy(ha.dl_dma_pool);
    ha.dl_dma_pool = core::ptr::null_mut();
    }
    fail_s_dma_pool:
    dma_pool_destroy(ha.s_dma_pool);
    ha.s_dma_pool = core::ptr::null_mut();
    fail_free_nvram:
    kfree(ha.nvram);
    ha.nvram = core::ptr::null_mut();
    ha.fiv = core::ptr::null_mut();
    fail_free_ctx_mempool:
    mempool_destroy(ha.ctx_mempool);
    ha.ctx_mempool = core::ptr::null_mut();
    ...
    ha.init_cb_dma);
    ha.init_cb = core::ptr::null_mut();
    ha.init_cb_dma = 0;
    fail_free_vp_map:
    kfree(ha.vp_map);
    ha.vp_map = core::ptr::null_mut();
    fail:
    ql_log(ql_log_fatal, core::ptr::null_mut(), 0x0030,
...
//
    ...
    ha.exlogin_buf = core::ptr::null_mut();
    ha.exlogin_size = 0;
    }
    }
    static void
...
//
    ...
    ha.exchoffld_buf = core::ptr::null_mut();
    ha.exchoffld_size = 0;
    }
    }
//
...
//
    ...
    ha.mctp_dump_dma);
    ha.mctp_dump = core::ptr::null_mut();
    mempool_destroy(ha.srb_mempool);
    ha.srb_mempool = core::ptr::null_mut();
    if (ha.dcbx_tlv)
    dma_free_coherent(&ha.pdev.dev, DCBX_TLV_DATA_SIZE,
    ha.dcbx_tlv, ha.dcbx_tlv_dma);
    ha.dcbx_tlv = core::ptr::null_mut();
    if (ha.xgmac_data)
    dma_free_coherent(&ha.pdev.dev, XGMAC_DATA_SIZE,
    ha.xgmac_data, ha.xgmac_data_dma);
    ha.xgmac_data = core::ptr::null_mut();
    if (ha.sns_cmd)
    dma_free_coherent(&ha.pdev.dev, sizeof(struct sns_cmd_pkt),
    ha.sns_cmd, ha.sns_cmd_dma);
    ha.sns_cmd = core::ptr::null_mut();
    ha.sns_cmd_dma = 0;
    if (ha.ct_sns)
    dma_free_coherent(&ha.pdev.dev, sizeof(struct ct_sns_pkt),
    ha.ct_sns, ha.ct_sns_dma);
...
// clean up allocated prev pool
    ...
    ha.lsrjt.cdma);
    ha.lsrjt.c = core::ptr::null_mut();
    }
    ha.init_cb = core::ptr::null_mut();
    ha.init_cb_dma = 0;
    vfree(ha.optrom_buffer);
    ha.optrom_buffer = core::ptr::null_mut();
    kfree(ha.nvram);
    ha.nvram = core::ptr::null_mut();
    ha.fiv = core::ptr::null_mut();
    kfree(ha.npiv_info);
    ...
    {
    struct Scsi_Host *host;
    struct scsi_qla_host *vha = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_sched_upd_fcport(fcport: *mut fc_port_t) {
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn qla24xx_create_new_sess(vha: *mut scsi_qla_host, e: *mut qla_work_evt) {
    void qla24xx_create_new_sess(struct scsi_qla_host *vha, struct qla_work_evt *e)
    {
    unsigned long flags;
    fc_port_t *fcport =  core::ptr::null_mut(), *tfcp;
    struct qlt_plogi_ack_t *pla =
    (struct qlt_plogi_ack_t *)e.u.new_sess.pla;
    let mut free_fcport: u8 = 0;
...
// should rarily happen
    ...
    fc_port_t *dfcp = core::ptr::null_mut();
    spin_lock_irqsave(&vha.hw.tgt.sess_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn qla_sp_retry(vha: *mut scsi_qla_host, e: *mut qla_work_evt) {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_post_relogin_work(vha: *mut scsi_qla_host) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla2x00_relogin(vha: *mut scsi_qla_host) {
...
// Work: Execute IDC state handler
    ...
    let mut heart_beat_wait: c_ulong = jiffies + (1 * HZ);
...
//
pub const QLA83XX_WAIT_LOGIC_MS: c_int = 100;
    static int
    qla83xx_force_lock_recovery(scsi_qla_host_t *base_vha)
    {
    int rval;
    uint32_t data;
    let mut idc_lck_rcvry_stage_mask: u32 = 0x3;
    let mut idc_lck_rcvry_owner_mask: u32 = 0x3c;
    struct qla_hw_data *ha = base_vha.hw;
...
//
    ...
    dma_addr_t stat_dma;
    dma_addr_t sfp_dma;
    struct els_entry_24xx *rsp_els = core::ptr::null_mut();
    struct rdp_rsp_payload *rsp_payload = core::ptr::null_mut();
    struct link_statistics *stat = core::ptr::null_mut();
    uint8_t *sfp = core::ptr::null_mut();
    let mut sfp_flags: u16 = 0;
    let mut rsp_payload_length: c_uint = sizeof(*rsp_payload);
    u16 vp_idx;
    size_t purex_sz;
    size_t rsp_els_sz;
    void *rsp_els_pkt = core::ptr::null_mut();
    int rval;
...
#[no_mangle]
pub unsafe extern "C" fn if(BIT_1: sfp[0] &) -> else {
    else if (sfp[0] & BIT_1)
    sfp_flags |= BIT_1; /* long wave 1310nm */
#[no_mangle]
pub unsafe extern "C" fn if(BIT_4: sfp[1] &) -> else {
    else if (sfp[1] & BIT_4)
...
// SFP Diagnostics
    ...
    if (!rval) {
    __be16 *trx = ( __be16 *)sfp; /* already be16 */
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_process_purex_list(list: *mut purex_list) {
    void qla24xx_process_purex_list(struct purex_list *list)
    {
    let mut head: list_head = LIST_HEAD_INIT(head);
    struct purex_item *item, *next;
    ulong flags;
    spin_lock_irqsave(&list.lock, flags);
...
//
    ...
    let mut options: u16 = (requester_id << 15) | BIT_7;
...
// XXX: IDC-unlock implementation using access-control mbx
    retry = 0;
    retry_unlock2:
    if (qla83xx_access_control(base_vha, options, 0, 0, core::ptr::null_mut())) {
    if (retry < 10) {
// Retry for IDC-unlock
    msleep(QLA83XX_WAIT_LOGIC_MS);
    retry++;
...
// qpair online check
    ...
    &base_vha.dpc_flags)) {
    let mut threshold: u16 = ha.nvme_last_rptd_aen + ha.last_zio_threshold;
...
#[no_mangle]
unsafe extern "C" fn qla_do_heartbeat(vha: *mut scsi_qla_host) -> bool {
    static bool qla_do_heartbeat(struct scsi_qla_host *vha)
    {
    struct qla_hw_data *ha = vha.hw;
    u32 cmpl_cnt;
    u16 i;
    let mut do_heartbeat: bool = false;
//
...
#[no_mangle]
unsafe extern "C" fn qla_heart_beat(vha: *mut scsi_qla_host, dpc_started: u16) {
...
#[no_mangle]
unsafe extern "C" fn qla_wind_down_chip(vha: *mut scsi_qla_host_t) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_QLA8044(ha)) -> else {
    else if (IS_QLA8044(ha))
...
pub const FW_ISP21XX: c_int = 0;
pub const FW_ISP22XX: c_int = 1;
pub const FW_ISP2300: c_int = 2;
pub const FW_ISP2322: c_int = 3;
pub const FW_ISP24XX: c_int = 4;
pub const FW_ISP25XX: c_int = 5;
pub const FW_ISP81XX: c_int = 6;
pub const FW_ISP82XX: c_int = 7;
pub const FW_ISP2031: c_int = 8;
pub const FW_ISP8031: c_int = 9;
pub const FW_ISP27XX: c_int = 10;
pub const FW_ISP28XX: c_int = 11;
pub const FW_ISP29XX: c_int = 12;
...
#[no_mangle]
unsafe extern "C" fn qla_pci_error_cleanup(vha: *mut scsi_qla_host_t) {
...
//
#[no_mangle]
unsafe extern "C" fn qla2xxx_set_affinity_nobalance(pdev: *mut pci_dev, flag: bool) {
    ...
    struct qla_hw_data *ha = vha.hw;
    let mut ret: pci_ers_result_t = PCI_ERS_RESULT_NEED_RESET;
...
#[no_mangle]
pub unsafe extern "C" fn qla_pci_set_eeh_busy(vha: *mut scsi_qla_host) {
    void qla_pci_set_eeh_busy(struct scsi_qla_host *vha)
    {
    struct qla_hw_data *ha = vha.hw;
    struct scsi_qla_host *base_vha = pci_get_drvdata(ha.pdev);
    let mut do_cleanup: bool = false;
    unsigned long flags;
    if (ha.flags.eeh_busy)
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn qla_schedule_eeh_work(vha: *mut scsi_qla_host) {
...
#[no_mangle]
unsafe extern "C" fn qla2xxx_map_queues(shost: *mut Scsi_Host) {
    static void qla2xxx_map_queues(struct Scsi_Host *shost)
    {
...
// Derive version string.
    ...
    ql_log(ql_log_fatal, core::ptr::null_mut(), 0x0002,
    ...
    if (apidev_major < 0) {
    ql_log(ql_log_fatal, core::ptr::null_mut(), 0x0003,
    "Unable to register char device %s.\n", QLA2XXX_APIDEV);
    }
    qla2xxx_transport_vport_template =
    fc_attach_transport(&qla2xxx_transport_vport_functions);
    if (!qla2xxx_transport_vport_template) {
    ql_log(ql_log_fatal, core::ptr::null_mut(), 0x0004,
    "fc_attach_transport vport failed...Failing load!.\n");
    ret = -ENODEV;
    goto unreg_chrdev;
    }
    ql_log(ql_log_info, core::ptr::null_mut(), 0x0005,
    "QLogic Fibre Channel HBA Driver: %s.\n",
    qla2x00_version_str);
    ret = pci_register_driver(&qla2xxx_pci_driver);
    if (ret) {
    ql_log(ql_log_fatal, core::ptr::null_mut(), 0x0006,
