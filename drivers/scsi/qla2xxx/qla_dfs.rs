...
//! Source: drivers/scsi/qla2xxx/qla_dfs.c
#![no_std]
...
pub const QLA_DFS_RPORT_DEVLOSS_TMO: c_int = 1;
    static int
...
// val = _get_val;						\
    ...
    fp.dfs_rport_dir = core::ptr::null_mut();
    }
    static int
    ...
    unsigned long flags;
    struct fc_port *sess = core::ptr::null_mut();
...
//
    ...
    qla_dfs_##_name = core::ptr::null_mut();				\
    }							\
    } while (0)
    ...
    (_struct).dfs_##_name = core::ptr::null_mut();			\
    }							\
    } while (0)
    static ssize_t
    ...
    num_act_qp = simple_strtoul(buf, core::ptr::null_mut(), 0);
    ...
    qla2x00_dfs_root = debugfs_create_dir(QLA2XXX_DRIVER_NAME, core::ptr::null_mut());
    create_dir:
    if (ha.dfs_dir)
    goto create_nodes;
    ...
    ha.tgt.dfs_naqp = core::ptr::null_mut();
    }
    if (ha.tgt.dfs_tgt_sess) {
    debugfs_remove(ha.tgt.dfs_tgt_sess);
    ha.tgt.dfs_tgt_sess = core::ptr::null_mut();
    }
    if (ha.tgt.dfs_tgt_port_database) {
    debugfs_remove(ha.tgt.dfs_tgt_port_database);
    ha.tgt.dfs_tgt_port_database = core::ptr::null_mut();
    }
    if (ha.dfs_fw_resource_cnt) {
    debugfs_remove(ha.dfs_fw_resource_cnt);
    ha.dfs_fw_resource_cnt = core::ptr::null_mut();
    }
    if (ha.dfs_tgt_counters) {
    debugfs_remove(ha.dfs_tgt_counters);
    ha.dfs_tgt_counters = core::ptr::null_mut();
    }
    if (ha.dfs_fce) {
    debugfs_remove(ha.dfs_fce);
    ha.dfs_fce = core::ptr::null_mut();
    }
    if (vha.dfs_rport_root) {
    debugfs_remove_recursive(vha.dfs_rport_root);
    vha.dfs_rport_root = core::ptr::null_mut();
    }
    if (ha.dfs_dir) {
    debugfs_remove(ha.dfs_dir);
    ha.dfs_dir = core::ptr::null_mut();
    atomic_dec(&qla2x00_dfs_root_count);
    }
    if (atomic_read(&qla2x00_dfs_root_count) == 0 &&
    qla2x00_dfs_root) {
    debugfs_remove(qla2x00_dfs_root);
    qla2x00_dfs_root = core::ptr::null_mut();
    }
    return 0;
    }
