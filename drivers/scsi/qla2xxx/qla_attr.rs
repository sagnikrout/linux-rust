...
//! Source: drivers/scsi/qla2xxx/qla_attr.c
#![no_std]
...
// SYSFS attributes ---------------------------------------------------------
    ...
    if (off != 0)
    return (0);
    reading = simple_strtol(buf, core::ptr::null_mut(), 10);
    switch (reading) {
    case 0:
...
// NVRAM settings take effect immediately.
    ...
    struct qla_hw_data *ha = vha.hw;
    let mut start: u32 = 0;
    let mut size: u32 = ha.optrom_size;
    int val, valid;
    let mut rval: isize = count;
    if (off)
    return -EINVAL;
    ...
    if (ha.optrom_buffer == core::ptr::null_mut()) {
...
//
    ...
    valid = 1;
#[no_mangle]
pub unsafe extern "C" fn if(IS_QLA25XX(ha): IS_QLA24XX_TYPE(ha) ||) -> else {
...
// Update flash version information for 4Gb & above.
    ...
    uint8_t *tmp_data = core::ptr::null_mut();
    if (off != 0)
    return -EINVAL;
    type = simple_strtol(buf, core::ptr::null_mut(), 10);
    switch (type) {
    case 0x2025c:
...
// check led index
    ...
    size = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_P3P_TYPE(ha)) -> else {
    ...
    ulong type, speed;
    int oldspeed, rval;
    let mut mode: c_int = QLA_SET_DATA_RATE_LR;
    struct qla_hw_data *ha = vha.hw;
    if (!IS_QLA27XX(ha) && !IS_QLA28XX(ha) && !IS_QLA29XX(ha)) {
    ...
    static DEVICE_ATTR(mpi_pause, S_IWUSR, core::ptr::null_mut(), qla2x00_mpi_pause_store);
// -----
    static ssize_t
...
#[no_mangle]
unsafe extern "C" fn qla_set_ini_mode(vha: *mut scsi_qla_host_t, op: c_int) {
    ...
    let mut action: c_int = NO_ACTION;
    let mut set_mode: c_int = 0;
...
pub unsafe extern "C" fn if(0: val <) -> else {
    ...
    qla2x00_dport_diagnostics_show, core::ptr::null_mut());
    static DEVICE_STRING_ATTR_RO(driver_version, S_IRUGO, qla2x00_version_str);
    static DEVICE_ATTR(fw_version, S_IRUGO, qla2x00_fw_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(serial_num, S_IRUGO, qla2x00_serial_num_show, core::ptr::null_mut());
    static DEVICE_ATTR(isp_name, S_IRUGO, qla2x00_isp_name_show, core::ptr::null_mut());
    static DEVICE_ATTR(isp_id, S_IRUGO, qla2x00_isp_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(model_name, S_IRUGO, qla2x00_model_name_show, core::ptr::null_mut());
    static DEVICE_ATTR(model_desc, S_IRUGO, qla2x00_model_desc_show, core::ptr::null_mut());
    static DEVICE_ATTR(pci_info, S_IRUGO, qla2x00_pci_info_show, core::ptr::null_mut());
    static DEVICE_ATTR(link_state, S_IRUGO, qla2x00_link_state_show, core::ptr::null_mut());
    ...
    qla2x00_optrom_bios_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(optrom_efi_version, S_IRUGO,
    qla2x00_optrom_efi_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(optrom_fcode_version, S_IRUGO,
    qla2x00_optrom_fcode_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(optrom_fw_version, S_IRUGO, qla2x00_optrom_fw_version_show,
    core::ptr::null_mut());
    static DEVICE_ATTR(optrom_gold_fw_version, S_IRUGO,
    qla2x00_optrom_gold_fw_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(84xx_fw_version, S_IRUGO, qla24xx_84xx_fw_version_show,
    core::ptr::null_mut());
    static DEVICE_ATTR(total_isp_aborts, S_IRUGO, qla2x00_total_isp_aborts_show,
    core::ptr::null_mut());
    static DEVICE_ATTR(serdes_version, 0444, qla2x00_serdes_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(mpi_version, S_IRUGO, qla2x00_mpi_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(phy_version, S_IRUGO, qla2x00_phy_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(flash_block_size, S_IRUGO, qla2x00_flash_block_size_show,
    core::ptr::null_mut());
    static DEVICE_ATTR(vlan_id, S_IRUGO, qla2x00_vlan_id_show, core::ptr::null_mut());
    static DEVICE_ATTR(vn_port_mac_address, S_IRUGO,
    qla2x00_vn_port_mac_address_show, core::ptr::null_mut());
    static DEVICE_ATTR(fabric_param, S_IRUGO, qla2x00_fabric_param_show, core::ptr::null_mut());
    static DEVICE_ATTR(fw_state, S_IRUGO, qla2x00_fw_state_show, core::ptr::null_mut());
    static DEVICE_ATTR(thermal_temp, S_IRUGO, qla2x00_thermal_temp_show, core::ptr::null_mut());
    static DEVICE_ATTR(diag_requests, S_IRUGO, qla2x00_diag_requests_show, core::ptr::null_mut());
    static DEVICE_ATTR(diag_megabytes, S_IRUGO, qla2x00_diag_megabytes_show, core::ptr::null_mut());
    static DEVICE_ATTR(fw_dump_size, S_IRUGO, qla2x00_fw_dump_size_show, core::ptr::null_mut());
    static DEVICE_ATTR(allow_cna_fw_dump, S_IRUGO | S_IWUSR,
    qla2x00_allow_cna_fw_dump_show,
    qla2x00_allow_cna_fw_dump_store);
    static DEVICE_ATTR(pep_version, S_IRUGO, qla2x00_pep_version_show, core::ptr::null_mut());
    static DEVICE_ATTR(min_supported_speed, 0444,
    qla2x00_min_supported_speed_show, core::ptr::null_mut());
    static DEVICE_ATTR(max_supported_speed, 0444,
    qla2x00_max_supported_speed_show, core::ptr::null_mut());
    ...
    qla2x00_dif_bundle_statistics_show, core::ptr::null_mut());
    static DEVICE_ATTR(port_speed, 0644, qla2x00_port_speed_show,
    qla2x00_port_speed_store);
    static DEVICE_ATTR(port_no, 0444, qla2x00_port_no_show, core::ptr::null_mut());
    static DEVICE_ATTR(fw_attr, 0444, qla2x00_fw_attr_show, core::ptr::null_mut());
    static DEVICE_ATTR(mpi_fw_state, 0444, qla2x00_mpi_fw_state_show, core::ptr::null_mut());
...
// Confirm port has not reappeared before clearing pointers.
    ...
    fcport.rport = core::ptr::null_mut();
...
// check for any straggling io left behind
    ...
    int i;
    let mut ib: u64 = 0, ob = 0, ir = 0, or = 0;
    memset(p, -1, sizeof(*p));
    if (IS_QLAFX00(vha.hw))
    goto done;
...
// reset firmware statistics
    ...
    let mut fabric_name: u64 = wwn_to_u64(node_name);
    ...
    scsi_qla_host_t *vha = core::ptr::null_mut();
...
// Allow timer to run to drain queued items, when removing vp
    ...
    {
    let mut supported_speeds: c_uint = FC_PORTSPEED_UNKNOWN;
    ...
    {
    struct qla_hw_data *ha = vha.hw;
    let mut speeds: u32 = 0, fdmi_speed = 0;
    fc_host_dev_loss_tmo(vha.host) = ha.port_down_retry_count;
    fc_host_node_name(vha.host) = wwn_to_u64(vha.node_name);
    fc_host_port_name(vha.host) = wwn_to_u64(vha.port_name);
