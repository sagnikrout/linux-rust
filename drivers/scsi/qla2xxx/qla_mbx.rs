...
//! Source: drivers/scsi/qla2xxx/qla_mbx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn is_rom_cmd(cmd: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(!(IS_P3P_TYPE(ha)): IS_FWI2_CAPABLE(ha) &&) -> else {
...
//
    ...
    {
    struct qla_hw_data *ha = vha.hw;
    let mut rval: c_int = QLA_COMMAND_ERROR;
    mbx_cmd_t mc;
    mbx_cmd_t *mcp = &mc;
...
// Kernel context.
//
pub const FETCH_XLOGINS_STAT: c_uint = 0x8;
    int
...
// Kernel context.
//
pub const CONFIG_XLOGINS_MEM: c_uint = 0x9;
    int
...
// Kernel context.
//
pub const FETCH_XCHOFFLD_STAT: c_uint = 0x2;
    int
...
// Kernel context.
//
pub const CONFIG_XCHOFFLD_MEM: c_uint = 0x3;
    int
...
#[no_mangle]
pub unsafe extern "C" fn if(MBS_INVALID_COMMAND: mcp->mb[0] ==) -> else {
...
//
    ...
    qla82xx_wr_32(ha, (uintptr_t )ha.nxdb_wr_ptr,
...
//
    ...
    let mut dwords: c_ushort = offsetof(typeof(*stats), link_up_cnt)/sizeof(*iter);
    struct qla_hw_data *ha = vha.hw;
...
// Failed.
    ...
    mbx_cmd_t *mcp = &mc;
    uint32_t *iter = (uint32_t *)stats;
    let mut dwords: c_ushort = sizeof(*stats)/sizeof(*iter);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tsk_mgmt_cmd {
    union {
    pub tsk: tsk_mgmt_entry,
    pub tsk_ext: tsk_mgmt_entry_ext,
    pub sts: sts_entry_24xx,
    pub sts_ext: sts_entry_24xx_ext,
    pub p: },
}
...
// Return mailbox statuses.
    ...
    scsi_qla_host_t *vp = core::ptr::null_mut();
    unsigned long   flags;
    int found;
    port_id_t id;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs84xx_mgmt_cmd {
    union {
    pub req: verify_chip_entry_84xx,
    pub rsp: verify_chip_rsp_84xx,
    pub p: },
}
...
// bp = le32_to_cpu(( __le32)*bp);
    }
    return rval;
    }
pub const PUREX_CMD_COUNT: c_int = 4;
    int
...
// Always copy back return mailbox values.
    ...
    mbx_cmd_t *mcp = &mc;
    let mut rval: c_int = QLA_FUNCTION_FAILED;
    let mut offset: c_int = 0, size = MINIDUMP_SIZE_36K;
...
// Perform Implicit LOGO.
    ...
    mbx_cmd_t *mcp = &mc;
    struct qla_hw_data *ha = vha.hw;
    let mut retry_max_time: c_ulong = jiffies + (2 * HZ);
    if (!IS_QLA83XX(ha) && !IS_QLA27XX(ha) && !IS_QLA28XX(ha))
    return QLA_FUNCTION_FAILED;
...
//
    ...
    mbx_cmd_t mc;
    mbx_cmd_t *mcp = &mc;
    let mut subcode: u8 = (uint8_t)options;
    struct qla_hw_data *ha = vha.hw;
    if (!IS_QLA8031(ha))
    return QLA_FUNCTION_FAILED;
...
// sector_size = mcp->mb[1];
#[no_mangle]
pub unsafe extern "C" fn if(BIT_7): subcode & (BIT_6 |) -> else {
...
// For MCTP RAM ID is 0x40
    ...
    int rval;
    dma_addr_t dd_dma;
    let mut size: c_uint = sizeof(dd.buf);
    let mut options: u16 = dd.options;
    ql_dbg(ql_dbg_mbx + ql_dbg_verbose, vha, 0x119f,
    "Entered %s.\n", __func__);
...
#[no_mangle]
unsafe extern "C" fn qla2x00_async_mb_sp_done(sp: *mut srb_t, res: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla24xx_send_mb_cmd(vha: *mut scsi_qla_host, mcp: *mut mbx_cmd_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla24xx_print_fc_port_id(vha: *mut scsi_qla_host, s: *mut seq_file, loop_id: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla24xx_gpdb_wait(vha: *mut scsi_qla_host, fcport: *mut fc_port_t, opt: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla27xx_set_zio_threshold(vha: *mut scsi_qla_host_t, value: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qla27xx_get_zio_threshold(vha: *mut scsi_qla_host_t, value: *mut u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qla_no_op_mb(vha: *mut scsi_qla_host) {
...
#[no_mangle]
pub unsafe extern "C" fn qla_mpipt_validate_fw(vha: *mut scsi_qla_host_t, img_idx: u16, state: *mut u16) -> c_int {
