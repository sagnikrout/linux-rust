...
//! Source: drivers/scsi/sr_vendor.c
#![no_std]
...
pub const VENDOR_NEC: c_int = 2;
pub const VENDOR_TOSHIBA: c_int = 3;

#[no_mangle]
pub unsafe extern "C" fn sr_vendor_init(cd: *mut Scsi_CD) {
...
#[no_mangle]
pub unsafe extern "C" fn sr_set_blocklength(cd: *mut Scsi_CD, blocklength: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sr_cd_check(cdi: *mut cdrom_device_info) -> c_int {
