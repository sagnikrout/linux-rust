...
//! Source: drivers/scsi/scsi_ioctl.c
#![no_std]
...
pub const NORMAL_RETRIES: c_int = 5;
...
//
#[no_mangle]
unsafe extern "C" fn ioctl_probe(host: *mut Scsi_Host, buffer: *mut void __user) -> c_int {
    ...
    result = scsi_execute_cmd(sdev, cmd, REQ_OP_DRV_IN, core::ptr::null_mut(), 0, timeout,
    retries, &exec_args);
    ...
    result);
    scsi_print_sense_hdr(sdev, core::ptr::null_mut(), &sshdr);
    break;
    }
    }
    out:
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_set_medium_removal(sdev: *mut scsi_device, state: c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_ioctl_get_pci(sdev: *mut scsi_device, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sg_get_version(p: *mut int __user) -> c_int {
    static int sg_get_version(int __user *p)
    {
    let mut sg_version_num: static int = 30527;
    return put_user(sg_version_num, p);
    }
#[no_mangle]
unsafe extern "C" fn sg_set_timeout(sdev: *mut scsi_device, p: *mut int __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sg_get_reserved_size(sdev: *mut scsi_device, p: *mut int __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sg_set_reserved_size(sdev: *mut scsi_device, p: *mut int __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sg_emulated_host(q: *mut request_queue, p: *mut int __user) -> c_int {
    static int sg_emulated_host(struct request_queue *q, int __user *p)
    {
    return put_user(1, p);
    }
#[no_mangle]
unsafe extern "C" fn scsi_get_idlun(sdev: *mut scsi_device, argp: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scsi_send_start_stop(sdev: *mut scsi_device, data: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_cmd_allowed(cmd: *mut c_uchar, open_for_write: bool) -> bool {
...
//
    ...
    let mut len: c_int = min((unsigned int) hdr.mx_sb_len, scmd.sense_len);
    ...
    let mut ret: isize = 0;
    let mut writing: c_int = 0;
    let mut at_head: c_int = 0;
    struct request *rq;
    ...
    if (ret < 0)
    goto out_put_request;
    ret = blk_rq_map_user_io(rq, core::ptr::null_mut(), hdr.dxferp, hdr.dxfer_len,
...
#[no_mangle]
pub unsafe extern "C" fn put_sg_io_hdr(hdr: *const sg_io_hdr, argp: *mut void __user) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_sg_io_hdr(hdr: *mut sg_io_hdr, argp: *const void __user) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compat_cdrom_generic_command {
    pub cmd: [c_uchar; CDROM_PACKET_SIZE],
    pub buffer: compat_caddr_t,
    pub buflen: compat_uint_t,
    pub stat: compat_int_t,
    pub sense: compat_caddr_t,
    pub data_direction: c_uchar,
    pub pad: [c_uchar; 3],
    pub quiet: compat_int_t,
    pub timeout: compat_int_t,
    pub unused: compat_caddr_t,
}
