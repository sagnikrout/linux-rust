...
//! Source: drivers/scsi/libiscsi_tcp.c
#![no_std]
...
//
    ...
    segment.data = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_tcp_segment_map(segment: *mut iscsi_segment, recv: c_int) {
    static void iscsi_tcp_segment_map(struct iscsi_segment *segment, int recv)
    {
    struct scatterlist *sg;
    if (segment.data != core::ptr::null_mut() || !segment.sg)
    return;
    sg = segment.sg;
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_segment_unmap(segment: *mut iscsi_segment) {
    ...
    segment.sg_mapped = core::ptr::null_mut();
    segment.data = core::ptr::null_mut();
    }
    }
...
//
    ...
    segment.copied = 0;
    segment.sg = core::ptr::null_mut();
    segment.crcp = core::ptr::null_mut();
    }
//
...
//
    ...
    unsigned int len)
    {
    let mut copy: c_uint = 0, copied = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_hdr_recv_prep(tcp_conn: *mut iscsi_tcp_conn) {
    ...
    iscsi_tcp_hdr_recv_done, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_cleanup_task(task: *mut iscsi_task) {
...
// flush task's r2t queues
    ...
    r2t = tcp_task.r2t;
    if (r2t != core::ptr::null_mut()) {
    kfifo_in(&tcp_task.r2tpool.queue, (void*)&r2t,
    sizeof(void*));
    tcp_task.r2t = core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_tcp_data_in(conn: *mut iscsi_conn, task: *mut iscsi_task) -> c_int {
    static int iscsi_tcp_data_in(struct iscsi_conn *conn, struct iscsi_task *task)
    {
    struct iscsi_tcp_conn *tcp_conn = conn.dd_data;
    struct iscsi_tcp_task *tcp_task = task.dd_data;
    struct iscsi_data_rsp *rhdr = (struct iscsi_data_rsp *)tcp_conn.in.hdr;
    let mut datasn: c_int = be32_to_cpu(rhdr.datasn);
    let mut total_in_length: unsigned = task.sc.sdb.length;
//
...
//
#[no_mangle]
unsafe extern "C" fn iscsi_tcp_r2t_rsp(conn: *mut iscsi_conn, hdr: *mut iscsi_hdr) -> c_int {
...
// check for non-exceptional status
    ...
    rc = iscsi_complete_pdu(conn, tcp_conn.in.hdr, core::ptr::null_mut(), 0);
    if (rc)
    return rc;
    }
    iscsi_tcp_hdr_recv_prep(tcp_conn);
...
//
    ...
    {
    let mut rc: c_int = 0, opcode, ahslen;
    struct iscsi_tcp_conn *tcp_conn = conn.dd_data;
    struct iscsi_task *task;
// verify PDU length
...
//
    ...
    rc = __iscsi_complete_pdu(conn, hdr, core::ptr::null_mut(), 0);
    spin_unlock(&conn.session.back_lock);
    break;
    case ISCSI_OP_R2T:
    if (ahslen) {
...
//
    ...
    rc = iscsi_complete_pdu(conn, hdr, core::ptr::null_mut(), 0);
    break;
    default:
...
// call again.
    let mut ahslen: c_uint = hdr.hlength << 2;
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_recv_segment_is_hdr(tcp_conn: *mut iscsi_tcp_conn) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_task_init(task: *mut iscsi_task) -> c_int {
...
// Prepare PDU, optionally w/ immediate data
    ...
    {
    struct iscsi_tcp_task *tcp_task = task.dd_data;
    struct iscsi_r2t_info *r2t = core::ptr::null_mut();
...
// Continue with this R2T?
    ...
    (void *)&tcp_task.r2t,
    sizeof(void *));
    tcp_task.r2t = r2t = core::ptr::null_mut();
    }
    }
    if (r2t == core::ptr::null_mut()) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_task_xmit(task: *mut iscsi_task) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_conn_teardown(cls_conn: *mut iscsi_cls_conn) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_r2tpool_alloc(session: *mut iscsi_session) -> c_int {
...
// R2T pool
    ...
    session.max_r2t * 2, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_r2tpool_free(session: *mut iscsi_session) {
...
#[no_mangle]
pub unsafe extern "C" fn iscsi_tcp_set_max_r2t(conn: *mut iscsi_conn, buf: *mut c_char) -> c_int {
    int iscsi_tcp_set_max_r2t(struct iscsi_conn *conn, char *buf)
    {
    struct iscsi_session *session = conn.session;
    let mut r2ts: c_ushort = 0;
    sscanf(buf, "%hu", &r2ts);
