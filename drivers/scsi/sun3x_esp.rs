...
//! Source: drivers/scsi/sun3x_esp.c
#![no_std]
...
pub const DMA_CSR: c_uint = 0x00UL	/* rw  DMA control/status register    0x00   */;
pub const DMA_ADDR: c_uint = 0x04UL	/* rw  DMA transfer address register  0x04   */;
pub const DMA_COUNT: c_uint = 0x08UL	/* rw  DMA transfer count register    0x08   */;
pub const DMA_TEST: c_uint = 0x0cUL	/* rw  DMA test/debug register        0x0c   */;
...
#[no_mangle]
unsafe extern "C" fn sun3x_esp_write8(esp: *mut esp, val: u8, reg: c_ulong) {
    static void sun3x_esp_write8(struct esp *esp, u8 val, unsigned long reg)
    {
    writeb(val, esp.regs + (reg * 4UL));
    }
#[no_mangle]
unsafe extern "C" fn sun3x_esp_read8(esp: *mut esp, reg: c_ulong) -> u8 {
    static u8 sun3x_esp_read8(struct esp *esp, unsigned long reg)
    {
    return readb(esp.regs + (reg * 4UL));
    }
#[no_mangle]
unsafe extern "C" fn sun3x_esp_irq_pending(esp: *mut esp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun3x_esp_reset_dma(esp: *mut esp) {
...
#[no_mangle]
unsafe extern "C" fn sun3x_esp_dma_drain(esp: *mut esp) {
...
#[no_mangle]
unsafe extern "C" fn sun3x_esp_dma_invalidate(esp: *mut esp) {
...
#[no_mangle]
unsafe extern "C" fn sun3x_esp_dma_error(esp: *mut esp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp_sun3x_probe(dev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esp_sun3x_remove(dev: *mut platform_device) {
