...
//! Source: drivers/virtio/virtio_rtc_ptp.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct viortc_ptp_cross_ctx {
    pub device_time: ktime_t,
    pub system_counterval: system_counterval_t,
}

// Weak function in case get_device_system_crosststamp() is not supported
#[no_mangle]
pub unsafe extern "C" fn viortc_hw_xtstamp_params(hw_counter: *mut u8, cs_id: *mut enum clocksource_ids) -> int __weak {
...
#[no_mangle]
unsafe extern "C" fn viortc_ptp_adjfine(ptp: *mut ptp_clock_info, scaled_ppm: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn viortc_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
...
//
    ...
    {
    let mut ret: c_int = ptp_clock_unregister(vio_ptp.ptp_clock);
    if (!ret)
...
//
    ...
    goto err_free_dev;
    if (!vio_ptp.have_cross)
    vio_ptp.ptp_info.getcrosststamp = core::ptr::null_mut();
