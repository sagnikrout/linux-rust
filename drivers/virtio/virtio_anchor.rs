...
//! Source: drivers/virtio/virtio_anchor.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn virtio_require_restricted_mem_acc(dev: *mut virtio_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn virtio_no_restricted_mem_acc(dev: *mut virtio_device) -> bool {
