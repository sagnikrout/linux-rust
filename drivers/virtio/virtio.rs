...
//! Source: drivers/virtio/virtio.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn virtio_dev_match(_dv: *mut device, _dr: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_uevent(_dv: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __virtio_config_changed(dev: *mut virtio_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(drv->config_changed: drv &&) -> else {
    drv.config_changed(dev);
    dev.config_change_pending = false;
    }
    }
#[no_mangle]
pub unsafe extern "C" fn virtio_config_changed(dev: *mut virtio_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_config_driver_disable(dev: *mut virtio_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_config_driver_enable(dev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_config_core_disable(dev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_config_core_enable(dev: *mut virtio_device) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_add_status(dev: *mut virtio_device, status: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn virtio_features_ok(dev: *mut virtio_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_reset_device(dev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_dev_probe(_d: *mut device) -> c_int {
...
// Figure out what features the driver supports.
    ...
    for (i = 0; i < drv.feature_table_size; i++) {
    let mut f: c_uint = drv.feature_table[i];
...
// Some drivers have a separate feature table for virtio v1.0
    ...
    for (i = 0; i < drv.feature_table_size_legacy; i++) {
    let mut f: c_uint = drv.feature_table_legacy[i];
...
#[no_mangle]
unsafe extern "C" fn virtio_dev_remove(_d: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_device_shutdown(dev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_dev_shutdown(_d: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_dev_num_vf(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __register_virtio_driver(driver: *mut virtio_driver, owner: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_virtio_driver(driver: *mut virtio_driver) {
...
#[no_mangle]
unsafe extern "C" fn virtio_device_of_init(dev: *mut virtio_device) -> c_int {
...
// There can be only 1 child node
    if (WARN_ON(count > 1))
    return -EINVAL;
    np = of_get_next_available_child(pnode, core::ptr::null_mut());
    if (WARN_ON(!np))
    return -ENODEV;
...
//
#[no_mangle]
pub unsafe extern "C" fn register_virtio_device(dev: *mut virtio_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_virtio_device(dev: *mut device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_virtio_device(dev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_device_restore_priv(dev: *mut virtio_device, restore: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_device_freeze(dev: *mut virtio_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_device_restore(dev: *mut virtio_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_device_reset_prepare(dev: *mut virtio_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_device_reset_done(dev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_init() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_exit() -> void __exit {
