...
//! Source: drivers/virtio/virtio_pci_modern_dev.c
#![no_std]
...
// len = length;
    ...
    length, offset, bar);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pa) -> else {
    else if (pa)
...
#[no_mangle]
pub unsafe extern "C" fn check_offsets() {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_modern_probe(mdev: *mut virtio_pci_modern_device) -> c_int {
...
//
    ...
    admin_queue_num),
    &mdev.common_len, core::ptr::null_mut());
    if (!mdev.common)
    goto err_map_common;
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_modern_remove(mdev: *mut virtio_pci_modern_device) {
...
//
    ...
    int i;
    for (i = 0; i < VIRTIO_FEATURES_BITS / 32; i++) {
    let mut cur: u32 = features[i >> 1] >> (32 * (i & 1));
    vp_iowrite32(i, &cfg.guest_feature_select);
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_modern_generation(mdev: *mut virtio_pci_modern_device) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_modern_get_status(mdev: *mut virtio_pci_modern_device) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_modern_get_queue_reset(mdev: *mut virtio_pci_modern_device, index: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_modern_set_queue_reset(mdev: *mut virtio_pci_modern_device, index: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_modern_get_num_queues(mdev: *mut virtio_pci_modern_device) -> u16 {
...
//
    ...
    {
    let mut off: u16 = vp_modern_get_queue_notify_off(mdev, index);
    if (mdev.notify_base) {
...
// pa = mdev->notify_pa +
    ...
    core::ptr::null_mut(), pa);
    }
    }
    EXPORT_SYMBOL_GPL(vp_modern_map_vq_notify);
#[no_mangle]
pub unsafe extern "C" fn vp_modern_avq_num(mdev: *mut virtio_pci_modern_device) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn vp_modern_avq_index(mdev: *mut virtio_pci_modern_device) -> u16 {
