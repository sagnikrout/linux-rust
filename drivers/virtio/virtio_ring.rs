...
//! Source: drivers/virtio/virtio_ring.c
#![no_std]
...
// Macro flag: #define START_USE(vq)
// Macro flag: #define END_USE(vq)
// Macro flag: #define LAST_ADD_TIME_UPDATE(vq)
// Macro flag: #define LAST_ADD_TIME_CHECK(vq)
// Macro flag: #define LAST_ADD_TIME_INVALID(vq)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vring_desc_state_split {
    pub /: *mut *mut *mut void data; / Data for callback.,
// Indirect desc table and extra table, if any. These two will be
// allocated together. So we won't stress more to the memory allocator.
//
    pub indir_desc: *mut vring_desc,
    pub total_in_len: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vring_desc_state_packed {
    pub /: *mut *mut *mut void data; / Data for callback.,
// Indirect desc table and extra table, if any. These two will be
// allocated together. So we won't stress more to the memory allocator.
//
    pub indir_desc: *mut vring_packed_desc,
    pub /: *mut *mut u16 num; / Descriptor list length.,
    pub /: *mut *mut u16 last; / The last desc state in a list.,
    pub /: *mut *mut u32 total_in_len; / In length for the skipped buffer.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vring_desc_extra {
    pub /: *mut *mut dma_addr_t addr; / Descriptor DMA addr.,
    pub /: *mut *mut u32 len; / Descriptor length.,
    pub /: *mut *mut u16 flags; / Descriptor flags.,
    pub /: *mut *mut u16 next; / The next desc state in a list.,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vring_virtqueue_split {
// Actual memory layout for this queue.
    pub vring: vring,
// Last written value to avail->flags
    pub avail_flags_shadow: u16,
//
// Last written value to avail->idx in
// guest byte order.
//
    pub avail_idx_shadow: u16,
// Per-descriptor state.
    pub desc_state: *mut vring_desc_state_split,
    pub desc_extra: *mut vring_desc_extra,
// DMA address and size information
    pub queue_dma_addr: dma_addr_t,
    pub queue_size_in_bytes: usize,
//
// The parameters for creating vrings are reserved for creating new
// vring.
//
    pub vring_align: u32,
    pub may_reduce_num: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vring_virtqueue_packed {
// Actual memory layout for this queue.
    struct {
    pub num: c_uint,
    pub desc: *mut vring_packed_desc,
    pub driver: *mut vring_packed_desc_event,
    pub device: *mut vring_packed_desc_event,
    pub vring: },
// Driver ring wrap counter.
    pub avail_wrap_counter: bool,
// Avail used flags.
    pub avail_used_flags: u16,
...
// guest byte order.
//
    pub event_flags_shadow: u16,
// Per-descriptor state.
    pub desc_state: *mut vring_desc_state_packed,
    pub desc_extra: *mut vring_desc_extra,
// DMA address and size information
    pub ring_dma_addr: dma_addr_t,
    pub driver_event_dma_addr: dma_addr_t,
    pub device_event_dma_addr: dma_addr_t,
    pub ring_size_in_bytes: usize,
    pub event_size_in_bytes: usize,
}

    struct vring_virtqueue;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtqueue_ops {
    int (*add)(struct vring_virtqueue *vq, struct scatterlist *sgs[],
    unsigned int total_sg, unsigned int out_sgs,
    unsigned int in_sgs,	void *data,
    void *ctx, bool premapped, gfp_t gfp,
    pub attr): c_ulong,
    pub ctx): *mut *mut *mut *mut *mut void (get)(struct vring_virtqueue vq, unsigned int len, void,
    pub vq): *mut *mut bool (kick_prepare)(struct vring_virtqueue,
    pub vq): *mut *mut void (disable_cb)(struct vring_virtqueue,
    pub vq): *mut *mut bool (enable_cb_delayed)(struct vring_virtqueue,
    pub vq): *mut *mut unsigned int (enable_cb_prepare)(struct vring_virtqueue,
    bool (*poll)(const struct vring_virtqueue *vq,
    pub last_used_idx): c_uint,
    pub vq): *mut *mut *mut void (detach_unused_buf)(struct vring_virtqueue,
    pub vq): *const *const bool (more_used)(struct vring_virtqueue,
    pub num): *mut *mut *mut int (resize)(struct vring_virtqueue vq, u32,
    pub vq): *mut *mut void (reset)(struct vring_virtqueue,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vring_virtqueue {
    pub vq: virtqueue,
// Is DMA API used?
    pub use_map_api: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct used_entry {
    pub id: u32,
    pub len: u32,
    pub batch_last: },
// Number we've added since last sync.
    pub num_added: c_uint,
...
// Available for split ring
    pub split: vring_virtqueue_split,
// Available for packed ring
    pub packed: vring_virtqueue_packed,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn vring_read_split_used_idx(vq: *const vring_virtqueue) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn vring_read_split_used_len(vq: *const vring_virtqueue, idx: u16) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn vring_read_split_avail_event(vq: *const vring_virtqueue) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn virtqueue_is_packed(vq: *const vring_virtqueue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn virtqueue_is_in_order(vq: *const vring_virtqueue) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn vring_use_map_api(vdev: *const virtio_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_max_dma_size(vdev: *const virtio_device) -> usize {
    size_t virtio_max_dma_size(const struct virtio_device *vdev)
    {
    let mut max_segment_size: usize = SIZE_MAX;
    ...
    if (queue) {
    let mut phys_addr: phys_addr_t = virt_to_phys(queue);
...
#[no_mangle]
unsafe extern "C" fn virtqueue_init(vq: *mut vring_virtqueue, num: u32) {
...
// Total length for in-order
    let mut total_in_len: c_uint = 0;
    int head;
    bool indirect;
    START_USE(vq);
    BUG_ON(data == core::ptr::null_mut());
...
//
    ...
    dma_addr_t addr;
    u32 len;
    let mut flags: u16 = VRING_DESC_F_WRITE;
    if (++sg_count != total_sg)
    flags |= VRING_DESC_F_NEXT;
...
#[no_mangle]
unsafe extern "C" fn virtqueue_kick_prepare_split(vq: *mut vring_virtqueue) -> bool {
...
// Free the indirect table, if any, now that it's unmapped.
    ...
    kfree(indir_desc);
    vq.split.desc_state[head].indir_desc = core::ptr::null_mut();
    }
    ...
    struct vring_desc_extra *extra;
    unsigned int i;
    let mut nextflag: __virtio16 = cpu_to_virtio16(vq.vq.vdev, VRING_DESC_F_NEXT);
// Clear data ptr.
    vq.split.desc_state[head].data = core::ptr::null_mut();
    extra = vq.split.desc_extra;
...
// ctx = vq->split.desc_state[head].indir_desc;
    ...
    void **ctx)
    {
    let mut i: c_uint = detach_buf_split_in_order(vq, head, ctx);
...
#[no_mangle]
unsafe extern "C" fn more_used_split(vq: *const vring_virtqueue) -> bool {
    static bool more_used_split(const struct vring_virtqueue *vq)
    {
    return virtqueue_poll_split(vq, vq.last_used_idx);
    }
#[no_mangle]
unsafe extern "C" fn more_used_split_in_order(vq: *const vring_virtqueue) -> bool {
...
// the read in the next get_buf call.
    ...
    {
    void *ret;
    let mut num: c_uint = vq.split.vring.num;
    let mut num_free: c_uint = vq.vq.num_free;
...
#[no_mangle]
unsafe extern "C" fn virtqueue_disable_cb_split(vq: *mut vring_virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtqueue_enable_cb_prepare_split(vq: *mut vring_virtqueue) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn virtqueue_enable_cb_delayed_split(vq: *mut vring_virtqueue) -> bool {
...
// detach_buf_split clears data, so grab it now.
    ...
    if (virtqueue_is_in_order(vq))
    detach_buf_split_in_order(vq, i, core::ptr::null_mut());
    else
    detach_buf_split(vq, i, core::ptr::null_mut());
    vq.split.avail_idx_shadow--;
    vq.split.vring.avail.idx = cpu_to_virtio16(vq.vq.vdev,
    vq.split.avail_idx_shadow);
    END_USE(vq);
...
#[no_mangle]
unsafe extern "C" fn virtqueue_reset_split(vq: *mut vring_virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn vring_alloc_state_extra_split(vring_split: *mut vring_virtqueue_split) -> c_int {
    static int vring_alloc_state_extra_split(struct vring_virtqueue_split *vring_split)
    {
    struct vring_desc_state_split *state;
    struct vring_desc_extra *extra;
    let mut num: u32 = vring_split.vring.num;
...
// Try to get a single page. You are my only hope!
    ...
    union virtio_map map)
    {
    let mut vring_split: vring_virtqueue_split = {};
    struct virtqueue *vq;
    int err;
...
#[no_mangle]
unsafe extern "C" fn virtqueue_resize_split(vq: *mut vring_virtqueue, num: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn packed_used_wrap_counter(last_used_idx: u16) -> bool {
    static bool packed_used_wrap_counter(u16 last_used_idx)
    {
    return !!(last_used_idx & (1 << VRING_PACKED_EVENT_F_WRAP_CTR));
    }
#[no_mangle]
unsafe extern "C" fn packed_last_used(last_used_idx: u16) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn virtqueue_kick_prepare_packed(vq: *mut vring_virtqueue) -> bool {
...
//
    ...
    {
    struct vring_desc_state_packed *state = core::ptr::null_mut();
    struct vring_packed_desc *desc;
    unsigned int i, curr;
    state = &vq.packed.desc_state[id];
// Clear data ptr.
    state.data = core::ptr::null_mut();
...
// Free the indirect table, if any, now that it's unmapped.
    ...
    kfree(desc);
    state.indir_desc = core::ptr::null_mut();
    } else if (ctx) {
// ctx = state->indir_desc;
    ...
    let mut avail: return = = used && used == used_wrap_counter;
    }
...
#[no_mangle]
unsafe extern "C" fn more_used_packed(vq: *const vring_virtqueue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn more_used_packed_in_order(vq: *const vring_virtqueue) -> bool {
    ...
    void **ctx)
    {
    let mut num: c_uint = vq.packed.vring.num;
    u16 last_used, last_used_idx;
...
#[no_mangle]
unsafe extern "C" fn virtqueue_disable_cb_packed(vq: *mut vring_virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtqueue_enable_cb_prepare_packed(vq: *mut vring_virtqueue) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn virtqueue_enable_cb_delayed_packed(vq: *mut vring_virtqueue) -> bool {
...
// detach_buf clears data, so grab it now.
    ...
    if (virtqueue_is_in_order(vq))
    detach_buf_packed_in_order(vq, i, core::ptr::null_mut());
    else
    detach_buf_packed(vq, i, core::ptr::null_mut());
    END_USE(vq);
    return buf;
    }
// That should have freed everything.
...
#[no_mangle]
unsafe extern "C" fn vring_alloc_state_extra_packed(vring_packed: *mut vring_virtqueue_packed) -> c_int {
    static int vring_alloc_state_extra_packed(struct vring_virtqueue_packed *vring_packed)
    {
    struct vring_desc_state_packed *state;
    struct vring_desc_extra *extra;
    let mut num: u32 = vring_packed.vring.num;
...
#[no_mangle]
unsafe extern "C" fn virtqueue_reset_packed(vq: *mut vring_virtqueue) {
...
// we need to reset the desc.flags. For more, see is_used_desc_packed()
    ...
    union virtio_map map)
    {
    let mut vring_packed: vring_virtqueue_packed = {};
    struct virtqueue *vq;
...
#[no_mangle]
unsafe extern "C" fn virtqueue_resize_packed(vq: *mut vring_virtqueue, num: u32) -> c_int {
    ...
    if (err)
    return err;
    while ((buf = virtqueue_detach_unused_buf(_vq)) != core::ptr::null_mut())
    recycle(_vq, buf);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn virtqueue_enable_after_reset(_vq: *mut virtqueue) -> c_int {
...
// Count them first.
    ...
    data, core::ptr::null_mut(), false, gfp, 0);
    }
...
//
    ...
    gfp_t gfp)
    {
    return virtqueue_add(vq, &sg, num, 1, 0, data, core::ptr::null_mut(), false, gfp, 0);
    }
...
//
    ...
    gfp_t gfp)
    {
    return virtqueue_add(vq, &sg, num, 1, 0, data, core::ptr::null_mut(), true, gfp, 0);
    }
...
//
    ...
    gfp_t gfp)
    {
    return virtqueue_add(vq, &sg, num, 0, 1, data, core::ptr::null_mut(), false, gfp, 0);
    }
...
//
    ...
    gfp_t gfp)
    {
    return virtqueue_add(vq, &sg, num, 0, 1, data, core::ptr::null_mut(), false, gfp,
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_kick_prepare(_vq: *mut virtqueue) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_notify(_vq: *mut virtqueue) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_kick(vq: *mut virtqueue) -> bool {
...
//
    ...
    {
    return virtqueue_get_buf_ctx(_vq, len, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_disable_cb(_vq: *mut virtqueue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_enable_cb_prepare(_vq: *mut virtqueue) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_poll(_vq: *mut virtqueue, last_used_idx: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_enable_cb(_vq: *mut virtqueue) -> bool {
    bool virtqueue_enable_cb(struct virtqueue *_vq)
    {
    let mut last_used_idx: c_uint = virtqueue_enable_cb_prepare(_vq);
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_enable_cb_delayed(_vq: *mut virtqueue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn more_used(vq: *const vring_virtqueue) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn vring_interrupt(irq: c_int, _vq: *mut c_void) -> irqreturn_t {
...
// Just a hint for performance: so it's ok that this can be racy!
    ...
    const char *name)
    {
    let mut map: union virtio_map = {.dma_dev = vdev.dev.parent};
...
#[no_mangle]
unsafe extern "C" fn vring_free(_vq: *mut virtqueue) {
    static void vring_free(struct virtqueue *_vq)
    {
    struct vring_virtqueue *vq = to_vvq(_vq);
    if (vq.we_own_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn vring_del_virtqueue(_vq: *mut virtqueue) {
...
#[no_mangle]
pub unsafe extern "C" fn vring_notification_data(_vq: *mut virtqueue) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn vring_transport_features(vdev: *mut virtio_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __virtqueue_break(_vq: *mut virtqueue) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __virtqueue_unbreak(_vq: *mut virtqueue) {
...
#[no_mangle]
pub unsafe extern "C" fn virtqueue_is_broken(_vq: *const virtqueue) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_break_device(dev: *mut virtio_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __virtio_unbreak_device(dev: *mut virtio_device) {
...
#[no_mangle]
pub unsafe extern "C" fn virtqueue_get_desc_addr(_vq: *const virtqueue) -> dma_addr_t {
...
#[no_mangle]
pub unsafe extern "C" fn virtqueue_get_avail_addr(_vq: *const virtqueue) -> dma_addr_t {
...
#[no_mangle]
pub unsafe extern "C" fn virtqueue_get_used_addr(_vq: *const virtqueue) -> dma_addr_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_map_mapping_error(_vq: *const virtqueue, addr: dma_addr_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtqueue_map_need_sync(_vq: *const virtqueue, addr: dma_addr_t) -> bool {
