...
//! Source: drivers/virtio/virtio_rtc_driver.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct viortc_dev {
    pub vdev: *mut virtio_device,
    pub viortc_class: *mut viortc_class,
    pub vqs: [viortc_vq; VIORTC_MAX_NR_QUEUES],
    pub clocks_to_unregister: *mut viortc_ptp_clock,
    pub alarmq_bufs: *mut c_void,
    pub num_alarmq_bufs: c_uint,
    pub num_clocks: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct viortc_msg {
    pub viortc: *mut viortc_dev,
    pub req: *mut c_void,
    pub resp: *mut c_void,
    pub responded: completion,
    pub refcnt: refcount_t,
    pub req_size: c_uint,
    pub resp_cap: c_uint,
    pub resp_actual_size: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn viortc_alarms_supported(vdev: *mut virtio_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_msg_release(msg: *mut viortc_msg) {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_cb_requestq(vq: *mut virtqueue) {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_cb_alarmq(vq: *mut virtqueue) {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_get_resp_errno(resp_head: *mut virtio_rtc_resp_head) -> c_int {
...
//
    ...
    return -ETIMEDOUT;
#[no_mangle]
pub unsafe extern "C" fn if(0: timeout_ret <) -> else {
...
//
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), sizeof(msg_req), sizeof(msg_resp), (msg_id), \
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn viortc_read(viortc: *mut viortc_dev, vio_clk_id: u16, reading: *mut u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_cfg(viortc: *mut viortc_dev, num_clocks: *mut u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_init_clock(viortc: *mut viortc_dev, vio_clk_id: u16) -> c_int {
    static int viortc_init_clock(struct viortc_dev *viortc, u16 vio_clk_id)
    {
    u8 clock_type, leap_second_smearing, flags;
    let mut is_exposed: bool = false;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn viortc_clocks_deinit(viortc: *mut viortc_dev) {
    ...
    if (!vio_ptp)
    continue;
    viortc.clocks_to_unregister[i] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn viortc_clocks_init(viortc: *mut viortc_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_init_vqs(viortc: *mut viortc_dev) -> c_int {
    ...
    ret = virtio_find_vqs(vdev, nr_queues, vqs, vqs_info, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn __viortc_remove(viortc: *mut viortc_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_probe(vdev: *mut virtio_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_remove(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn viortc_freeze(dev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn viortc_restore(dev: *mut virtio_device) -> c_int {
