...
//! Source: drivers/virtio/virtio_pci_modern.c
#![no_std]
...
// Macro flag: #define VIRTIO_PCI_NO_LEGACY
// Macro flag: #define VIRTIO_RING_NO_LEGACY

pub const VIRTIO_AVQ_SGS_MAX: c_int = 4;
#[no_mangle]
unsafe extern "C" fn vp_get_features(vdev: *mut virtio_device, features: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn vp_avq_index(vdev: *mut virtio_device, index: *mut u16, num: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vp_modern_avq_done(vq: *mut virtqueue) {
    void vp_modern_avq_done(struct virtqueue *vq)
    {
    struct virtio_pci_device *vp_dev = to_vp_device(vq.vdev);
    struct virtio_pci_admin_vq *admin_vq = &vp_dev.admin_vq;
    let mut status_size: c_uint = sizeof(struct virtio_admin_cmd_status);
...
//
    ...
    let mut out_num: c_uint = 0, in_num = 0;
...
#[no_mangle]
unsafe extern "C" fn virtio_pci_admin_cmd_list_init(virtio_dev: *mut virtio_device) {
    static void virtio_pci_admin_cmd_list_init(struct virtio_device *virtio_dev)
    {
    struct virtio_pci_device *vp_dev = to_vp_device(virtio_dev);
    let mut cmd: virtio_admin_cmd = {};
...
// data &= cpu_to_le64(VIRTIO_ADMIN_CMD_BITMAP);
    ...
    cmd.data_sg = &data_sg;
    cmd.result_sg = core::ptr::null_mut();
    ret = vp_modern_admin_cmd_exec(virtio_dev, &cmd);
    if (ret)
    goto end;
...
#[no_mangle]
unsafe extern "C" fn virtio_pci_admin_cmd_cap_init(virtio_dev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn vp_modern_avq_activate(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn vp_modern_avq_cleanup(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn vp_transport_features(vdev: *mut virtio_device, features: u64) {
...
#[no_mangle]
unsafe extern "C" fn vp_check_common_size(vdev: *mut virtio_device) -> c_int {
...
unsafe extern "C" fn vp_finalize_features(vdev: *mut virtio_device) -> c_int {
    ...
    {
    struct virtio_pci_device *vp_dev = to_vp_device(vdev);
    let mut features: u64 = vdev.features;
...
#[no_mangle]
unsafe extern "C" fn vp_generation(vdev: *mut virtio_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vp_active_vq(vq: *mut virtqueue, msix_vec: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vp_modern_disable_vq_and_reset(vq: *mut virtqueue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vp_modern_enable_vq_after_reset(vq: *mut virtqueue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vp_notify_with_data(vq: *mut virtqueue) -> bool {
...
// create the vring
    ...
    if (err)
    goto err;
    vq.priv = (void  *)vp_modern_map_vq_notify(mdev, index, core::ptr::null_mut());
    if (!vq.priv) {
    err = -ENOMEM;
    goto err;
    }
    ...
    struct virtio_pci_device *vp_dev = to_vp_device(vdev);
    struct virtqueue *vq;
    let mut rc: c_int = vp_find_vqs(vdev, nvqs, vqs, vqs_info, desc);
    if (rc)
    return rc;
...
unsafe extern "C" fn del_vq(info: *mut virtio_pci_vq_info) {
    ...
    if (!mdev.notify_base)
    pci_iounmap(mdev.pci_dev, (void  __iomem *)vq.priv);
    vring_del_virtqueue(vq);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_pci_admin_has_dev_parts(pdev: *mut pci_dev) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_pci_admin_mode_set(pdev: *mut pci_dev, flags: u8) -> c_int {
...
//
    ...
    {
    struct virtio_device *virtio_dev = virtio_pci_vf_get_pf_dev(pdev);
    let mut data_size: u16 = sizeof(struct virtio_admin_cmd_resource_obj_create_data);
    struct virtio_admin_cmd_resource_obj_create_data *obj_create_data;
    let mut obj_dev_parts: virtio_resource_obj_dev_parts = {};
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_pci_admin_obj_destroy(pdev: *mut pci_dev, obj_type: u16, id: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn virtio_pci_admin_dev_parts_set(pdev: *mut pci_dev, data_sg: *mut scatterlist) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_pci_modern_probe(vp_dev: *mut virtio_pci_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_pci_modern_remove(vp_dev: *mut virtio_pci_device) {
