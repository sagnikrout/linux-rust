...
//! Source: drivers/virtio/virtio_rtc_class.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn viortc_class_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_class_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn viortc_class_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn viortc_class_alarm(viortc_class: *mut viortc_class, vio_clk_id: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn viortc_class_stop(viortc_class: *mut viortc_class) {
...
//
#[no_mangle]
pub unsafe extern "C" fn viortc_class_register(viortc_class: *mut viortc_class) -> c_int {
