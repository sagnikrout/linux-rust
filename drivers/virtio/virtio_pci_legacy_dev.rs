...
//! Source: drivers/virtio/virtio_pci_legacy_dev.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_legacy_probe(ldev: *mut virtio_pci_legacy_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_legacy_remove(ldev: *mut virtio_pci_legacy_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_legacy_get_features(ldev: *mut virtio_pci_legacy_device) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_legacy_get_driver_features(ldev: *mut virtio_pci_legacy_device) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn vp_legacy_get_status(ldev: *mut virtio_pci_legacy_device) -> u8 {
