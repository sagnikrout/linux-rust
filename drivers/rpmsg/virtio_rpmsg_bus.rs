...
//! Source: drivers/rpmsg/virtio_rpmsg_bus.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtproc_info {
    pub vdev: *mut virtio_device,
    pub svq: *mut *mut virtqueue rvq,,
    pub sbufs: *mut *mut void rbufs,,
    pub num_bufs: c_uint,
    pub buf_size: c_uint,
    pub last_sbuf: c_int,
    pub bufs_dma: dma_addr_t,
    pub tx_lock: mutex,
    pub endpoints: idr,
    pub endpoints_lock: mutex,
    pub sendq: wait_queue_head_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmsg_hdr {
    pub src: __rpmsg32,
    pub dst: __rpmsg32,
    pub reserved: __rpmsg32,
    pub len: __rpmsg16,
    pub flags: __rpmsg16,
    pub data: [u8; ],
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_rpmsg_channel {
    pub rpdev: rpmsg_device,
    pub vrp: *mut virtproc_info,
}
...
// make sure in-flight inbound messages won't invoke cb anymore
    ...
    ept.cb = core::ptr::null_mut();
    mutex_unlock(&ept.cb_lock);
    kref_put(&ept.refcount, __ept_release);
    }
#[no_mangle]
unsafe extern "C" fn virtio_rpmsg_destroy_ept(ept: *mut rpmsg_endpoint) {
    static void virtio_rpmsg_destroy_ept(struct rpmsg_endpoint *ept)
    {
...
#[no_mangle]
unsafe extern "C" fn virtio_rpmsg_announce_create(rpdev: *mut rpmsg_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_rpmsg_announce_destroy(rpdev: *mut rpmsg_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_rpmsg_release_device(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn virtio_rpmsg_send(ept: *mut rpmsg_endpoint, data: *const c_void, len: c_int) -> c_int {
    static int virtio_rpmsg_send(struct rpmsg_endpoint *ept, const void *data, int len)
    {
    struct rpmsg_device *rpdev = ept.rpdev;
    let mut src: u32 = ept.addr, dst = rpdev.dst;
...
#[no_mangle]
unsafe extern "C" fn virtio_rpmsg_get_mtu(ept: *mut rpmsg_endpoint) -> isize {
    static ssize_t virtio_rpmsg_get_mtu(struct rpmsg_endpoint *ept)
    {
    struct rpmsg_device *rpdev = ept.rpdev;
    struct virtio_rpmsg_channel *vch = to_virtio_rpmsg_channel(rpdev);
    ...
    struct rpmsg_endpoint *ept;
    struct scatterlist sg;
    let mut little_endian: bool = virtio_is_little_endian(vrp.vdev);
    let mut msg_len: c_uint = __rpmsg16_to_cpu(little_endian, msg.len);
    int err;
...
#[no_mangle]
unsafe extern "C" fn rpmsg_recv_done(rvq: *mut virtqueue) {
...
//
#[no_mangle]
unsafe extern "C" fn rpmsg_xmit_done(svq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn rpmsg_virtio_del_ctrl_dev(rpdev_ctrl: *mut rpmsg_device) {
...
#[no_mangle]
unsafe extern "C" fn rpmsg_probe(vdev: *mut virtio_device) -> c_int {
    ...
    struct virtio_rpmsg_channel *vch = core::ptr::null_mut();
...
// We expect two virtqueues, rx and tx (and in this order)
    err = virtio_find_vqs(vdev, 2, vqs, vqs_info, core::ptr::null_mut());
    if (err)
    goto free_vrp;
    vrp.rvq = vqs[0];
    vrp.svq = vqs[1];
...
#[no_mangle]
unsafe extern "C" fn rpmsg_remove_device(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmsg_remove(vdev: *mut virtio_device) {
    static void rpmsg_remove(struct virtio_device *vdev)
    {
    struct virtproc_info *vrp = vdev.priv;
    let mut total_buf_space: usize = vrp.num_bufs * vrp.buf_size;
    int ret;
    virtio_reset_device(vdev);
    ret = device_for_each_child(&vdev.dev, core::ptr::null_mut(), rpmsg_remove_device);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn rpmsg_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rpmsg_fini() -> void __exit {
