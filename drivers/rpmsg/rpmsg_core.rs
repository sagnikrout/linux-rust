...
//! Source: drivers/rpmsg/rpmsg_core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmsg_destroy_ept(ept: *mut rpmsg_endpoint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmsg_send(ept: *mut rpmsg_endpoint, data: *const c_void, len: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmsg_sendto(ept: *mut rpmsg_endpoint, data: *const c_void, len: c_int, dst: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmsg_trysend(ept: *mut rpmsg_endpoint, data: *const c_void, len: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmsg_trysendto(ept: *mut rpmsg_endpoint, data: *const c_void, len: c_int, dst: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmsg_set_flow_control(ept: *mut rpmsg_endpoint, pause: bool, dst: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rpmsg_get_mtu(ept: *mut rpmsg_endpoint) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn rpmsg_device_match(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmsg_dev_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmsg_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rpmsg_dev_probe(dev: *mut device) -> c_int {
    static int rpmsg_dev_probe(struct device *dev)
    {
    struct rpmsg_device *rpdev = to_rpmsg_device(dev);
    struct rpmsg_driver *rpdrv = to_rpmsg_driver(rpdev.dev.driver);
    let mut chinfo: rpmsg_channel_info = {};
    struct rpmsg_endpoint *ept = core::ptr::null_mut();
    int err;
    ...
    ept = rpmsg_create_ept(rpdev, rpdrv.callback, core::ptr::null_mut(), chinfo);
    if (!ept) {
...
#[no_mangle]
unsafe extern "C" fn rpmsg_dev_remove(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn rpmsg_register_device(rpdev: *mut rpmsg_device) -> c_int {
    int rpmsg_register_device(struct rpmsg_device *rpdev)
    {
    return rpmsg_register_device_override(rpdev, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn __register_rpmsg_driver(rpdrv: *mut rpmsg_driver, owner: *mut module) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_rpmsg_driver(rpdrv: *mut rpmsg_driver) {
