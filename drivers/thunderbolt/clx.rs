...
//! Source: drivers/thunderbolt/clx.c
#![no_std]
...
//
    ...
    let mut clx_enabled: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn tb_port_pm_secondary_set(port: *mut tb_port, secondary: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_port_pm_secondary_enable(port: *mut tb_port) -> c_int {
    static int tb_port_pm_secondary_enable(struct tb_port *port)
    {
    return tb_port_pm_secondary_set(port, true);
    }
#[no_mangle]
unsafe extern "C" fn tb_port_pm_secondary_disable(port: *mut tb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_port_clx_supported(port: *mut tb_port, clx: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tb_port_clx_set(port: *mut tb_port, clx: c_uint, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_clx_is_enabled(port: *mut tb_port, clx: c_uint) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn tb_switch_clx_is_supported(sw: *const tb_switch) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_clx_init(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_pm_secondary_resolve(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_mask_clx_objections(sw: *mut tb_switch) -> c_int {
    static int tb_switch_mask_clx_objections(struct tb_switch *sw)
    {
    let mut up_port: c_int = sw.config.upstream_port_number;
...
#[no_mangle]
unsafe extern "C" fn validate_mask(clx: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_clx_enable(sw: *mut tb_switch, clx: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_clx_disable(sw: *mut tb_switch) -> c_int {
    int tb_switch_clx_disable(struct tb_switch *sw)
    {
    let mut clx: c_uint = sw.clx;
    struct tb_port *up, *down;
    int ret;
    if (!tb_switch_clx_is_supported(sw))
    return 0;
