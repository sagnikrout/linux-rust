...
//! Source: drivers/thunderbolt/xdomain.c
#![no_std]
...
pub const XDOMAIN_RETRIES: c_int = 10;
pub const XDOMAIN_DEFAULT_MAX_HOPID: c_int = 15;
    enum {
    XDOMAIN_STATE_INIT,
    XDOMAIN_STATE_UUID,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xdomain_request_work {
    pub work: work_struct,
    pub pkg: *mut tb_xdp_header,
    pub pkg_len: usize,
    pub tb: *mut tb,
}

    let mut tb_xdomain_enabled: static bool = true;
...
#[no_mangle]
pub unsafe extern "C" fn tb_is_xdomain_enabled() -> bool {
...
// Check that the XDomain protocol matches
    ...
    const struct ctl_pkg *pkg)
    {
    let mut len: usize = min_t(size_t, pkg.frame.size, req.response_size);
    memcpy(req.response, pkg.buffer, len);
    req.result.err = 0;
    return true;
    }
#[no_mangle]
unsafe extern "C" fn response_ready(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdp_handle_error(res: *const tb_xdp_error_response) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_register_protocol_handler(handler: *mut tb_protocol_handler) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_unregister_protocol_handler(handler: *mut tb_protocol_handler) {
...
#[no_mangle]
unsafe extern "C" fn update_service_properties(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_property_block(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn start_handshake(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn __stop_handshake(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn stop_handshake(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdp_handle_request(work: *mut work_struct) {
    static void tb_xdp_handle_request(struct work_struct *work)
    {
    struct xdomain_request_work *xw = container_of(work, typeof(*xw), work);
    const struct tb_xdp_header *pkg = xw.pkg;
    const struct tb_xdomain_header *xhdr = &pkg.xd_hdr;
    let mut pkg_len: usize = xw.pkg_len;
    struct tb *tb = xw.tb;
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_register_service_driver(drv: *mut tb_service_driver) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_unregister_service_driver(drv: *mut tb_service_driver) {
...
#[no_mangle]
unsafe extern "C" fn update_xdomain(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_service_properties_changed(svc: *mut tb_service) {
    ...
    update_xdomain(&xd.dev, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn get_modalias(svc: *const tb_service, buf: *mut c_char, size: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_service_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_service_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn update_service(svc: *mut tb_service, property: *mut tb_property) {
...
#[no_mangle]
unsafe extern "C" fn __unregister_service(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn remove_missing_service(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_service(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enumerate_services(xd: *mut tb_xdomain) {
...
//
    ...
    xd.device_name = core::ptr::null_mut();
    kfree(xd.vendor_name);
    xd.vendor_name = core::ptr::null_mut();
// Optional properties
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_update_link_attributes(xd: *mut tb_xdomain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_get_uuid(xd: *mut tb_xdomain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_get_link_status(xd: *mut tb_xdomain) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: width ==) -> else {
    else if (width == 1)
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_bond_lanes_uuid_high(xd: *mut tb_xdomain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_get_properties(xd: *mut tb_xdomain) -> c_int {
    static int tb_xdomain_get_properties(struct tb_xdomain *xd)
    {
    struct tb_property_dir *dir;
    struct tb *tb = xd.tb;
    let mut update: bool = false;
    u32 *block = core::ptr::null_mut();
    let mut gen: u32 = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_queue_uuid(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_queue_link_status(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_queue_link_status2(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_queue_bonding(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_queue_bonding_uuid_low(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_queue_properties(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_queue_properties_changed(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_failed(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_state_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_properties_changed(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_link_init(xd: *mut tb_xdomain, down: *mut tb_port) {
...
#[no_mangle]
unsafe extern "C" fn tb_xdomain_link_exit(xd: *mut tb_xdomain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_add(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn unregister_service(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_remove(xd: *mut tb_xdomain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_unregister(xd: *mut tb_xdomain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_lane_bonding_enable(xd: *mut tb_xdomain) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_lane_bonding_disable(xd: *mut tb_xdomain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_alloc_in_hopid(xd: *mut tb_xdomain, hopid: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_alloc_out_hopid(xd: *mut tb_xdomain, hopid: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_release_in_hopid(xd: *mut tb_xdomain, hopid: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_release_out_hopid(xd: *mut tb_xdomain, hopid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn update_all_xdomains() {
    static void update_all_xdomains(void)
    {
    bus_for_each_dev(&tb_bus_type, core::ptr::null_mut(), core::ptr::null_mut(), update_xdomain);
    }
#[no_mangle]
unsafe extern "C" fn remove_directory(key: *const c_char, dir: *const tb_property_dir) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_register_property_dir(key: *const c_char, dir: *mut tb_property_dir) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_unregister_property_dir(key: *const c_char, dir: *mut tb_property_dir) {
...
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_init() -> c_int {
    int tb_xdomain_init(void)
    {
    xdomain_property_dir = tb_property_create_dir(core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_exit() {
