...
//! Source: drivers/thunderbolt/acpi.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_add_links(nhi: *mut tb_nhi) -> bool {
...
//
    ...
    tb_acpi_add_link, core::ptr::null_mut(), nhi, (void **)&ret);
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_is_native() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_may_tunnel_usb3() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_may_tunnel_dp() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_may_tunnel_pcie() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_is_xdomain_allowed() -> bool {
...
pub const RETIMER_DSM_QUERY_ONLINE_STATE: c_int = 1;
pub const RETIMER_DSM_SET_ONLINE_STATE: c_int = 2;
#[no_mangle]
unsafe extern "C" fn tb_acpi_retimer_set_power(port: *mut tb_port, power: bool) -> c_int {
...
// Check if we are already powered on (and in correct mode)
    ...
    RETIMER_DSM_QUERY_ONLINE_STATE, core::ptr::null_mut(),
    ACPI_TYPE_INTEGER);
    if (!obj) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_power_on_retimers(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_power_off_retimers(port: *mut tb_port) -> c_int {
    int tb_acpi_power_off_retimers(struct tb_port *port)
    {
    return tb_acpi_retimer_set_power(port, false);
    }
#[no_mangle]
unsafe extern "C" fn tb_acpi_bus_match(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tb_acpi_setup(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_init() -> c_int {
    int tb_acpi_init(void)
    {
    return register_acpi_bus_type(&tb_acpi_bus);
    }
#[no_mangle]
pub unsafe extern "C" fn tb_acpi_exit() {
