...
//! Source: drivers/thunderbolt/usb4_port.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn usb4_port_offline(usb4: *mut usb4_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb4_port_online(usb4: *mut usb4_port) {
...
//
    ...
    {
    struct fwnode_handle *nhi_fwnode __free(fwnode_handle) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn usb4_port_device_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_device_remove(usb4: *mut usb4_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_device_resume(usb4: *mut usb4_port) -> c_int {
