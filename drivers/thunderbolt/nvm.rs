...
//! Source: drivers/thunderbolt/nvm.c
#![no_std]
...
pub const NVM_DATA_DWORDS: c_int = 16;
// Intel specific NVM offsets
pub const INTEL_NVM_DEVID: c_uint = 0x05;
pub const INTEL_NVM_VERSION: c_uint = 0x08;
pub const INTEL_NVM_CSS: c_uint = 0x10;
pub const INTEL_NVM_FLASH_SIZE: c_uint = 0x45;
// ASMedia specific NVM offsets
pub const ASMEDIA_NVM_DATE: c_uint = 0x1c;
pub const ASMEDIA_NVM_VERSION: c_uint = 0x28;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tb_nvm_vendor_ops {
    pub nvm): *mut *mut int (read_version)(struct tb_nvm,
    pub nvm): *mut *mut int (validate)(struct tb_nvm,
    pub nvm): *mut *mut int (write_headers)(struct tb_nvm,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tb_nvm_vendor {
    pub vendor: u16,
    pub vops: *const tb_nvm_vendor_ops,
}

#[no_mangle]
unsafe extern "C" fn intel_switch_nvm_version(nvm: *mut tb_nvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_switch_nvm_validate(nvm: *mut tb_nvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_switch_nvm_write_headers(nvm: *mut tb_nvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn asmedia_switch_nvm_version(nvm: *mut tb_nvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_retimer_nvm_version(nvm: *mut tb_nvm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_retimer_nvm_validate(nvm: *mut tb_nvm) -> c_int {
...
//
    ...
    {
    const struct tb_nvm_vendor_ops *vops = core::ptr::null_mut();
    struct tb_nvm *nvm;
    int ret, i;
    if (tb_is_switch(dev)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_nvm_read_version(nvm: *mut tb_nvm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_nvm_validate(nvm: *mut tb_nvm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_nvm_write_headers(nvm: *mut tb_nvm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_nvm_add_active(nvm: *mut tb_nvm, reg_read: nvmem_reg_read_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_nvm_add_non_active(nvm: *mut tb_nvm, reg_write: nvmem_reg_write_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_nvm_free(nvm: *mut tb_nvm) {
...
#[no_mangle]
pub unsafe extern "C" fn tb_nvm_exit() {
