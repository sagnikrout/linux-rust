...
//! Source: drivers/thunderbolt/domain.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tb_service_match(dev: *mut device, drv: *const device_driver) -> c_int {
    static int tb_service_match(struct device *dev, const struct device_driver *drv)
    {
    return !!__tb_service_match(dev, drv);
    }
#[no_mangle]
unsafe extern "C" fn tb_service_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_service_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn tb_service_shutdown(dev: *mut device) {
...
//
    ...
    uuid_str = strim(str);
    while ((s = strsep(&uuid_str, ",")) != core::ptr::null_mut() && i < tb.nboot_acl) {
...
// Notify userspace about the change
    tb_domain_event(tb, core::ptr::null_mut());
    }
    mutex_unlock(&tb.lock);
    err_rpm_put:
    pm_runtime_mark_last_busy(&tb.dev);
    ...
    let mut deauthorization: bool = false;
...
#[no_mangle]
unsafe extern "C" fn tb_domain_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_add(tb: *mut tb, reset: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_remove(tb: *mut tb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_suspend_noirq(tb: *mut tb) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_resume_noirq(tb: *mut tb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tb_domain_suspend(tb: *mut tb) -> c_int {
    int tb_domain_suspend(struct tb *tb)
    {
    return tb.cm_ops.suspend ? tb.cm_ops.suspend(tb) : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn tb_domain_freeze_noirq(tb: *mut tb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tb_domain_thaw_noirq(tb: *mut tb) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tb_domain_complete(tb: *mut tb) {
...
#[no_mangle]
pub unsafe extern "C" fn tb_domain_runtime_suspend(tb: *mut tb) -> c_int {
    int tb_domain_runtime_suspend(struct tb *tb)
    {
    if (tb.cm_ops.runtime_suspend) {
    let mut ret: c_int = tb.cm_ops.runtime_suspend(tb);
    if (ret)
    return ret;
    }
    tb_ctl_stop(tb.ctl);
...
#[no_mangle]
pub unsafe extern "C" fn tb_domain_runtime_resume(tb: *mut tb) -> c_int {
    int tb_domain_runtime_resume(struct tb *tb)
    {
    tb_ctl_start(tb.ctl);
    if (tb.cm_ops.runtime_resume) {
    let mut ret: c_int = tb.cm_ops.runtime_resume(tb);
    if (ret)
    return ret;
    }
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_disapprove_switch(tb: *mut tb, sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_approve_switch(tb: *mut tb, sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_approve_switch_key(tb: *mut tb, sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_challenge_switch_key(tb: *mut tb, sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_disconnect_pcie_paths(tb: *mut tb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_domain_reset_interface(tb: *mut tb) {
...
#[no_mangle]
unsafe extern "C" fn disconnect_xdomain(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_domain_disconnect_all_paths(tb: *mut tb) -> c_int {
    ...
    if (ret)
    return ret;
    return bus_for_each_dev(&tb_bus_type, core::ptr::null_mut(), tb, disconnect_xdomain);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct unregister_context {
    pub tb: *const tb,
    pub n: c_int,
}

#[no_mangle]
unsafe extern "C" fn unregister_unplugged_xdomain(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tb_domain_unregister_unplugged_xdomains(tb: *mut tb) -> c_int {
    int tb_domain_unregister_unplugged_xdomains(struct tb *tb)
    {
    struct unregister_context ctx;
    ctx.tb = tb_domain_get(tb);
    ctx.n = 0;
    bus_for_each_dev(&tb_bus_type, core::ptr::null_mut(), &ctx, unregister_unplugged_xdomain);
    tb_domain_put(tb);
    return ctx.n;
    }
#[no_mangle]
pub unsafe extern "C" fn tb_domain_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tb_domain_exit() {
