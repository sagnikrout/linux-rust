...
//! Source: drivers/thunderbolt/icm.c
#![no_std]
...
pub const PCIE2CIO_CMD: c_uint = 0x30;

pub const PCIE2CIO_CMD_CS_SHIFT: c_int = 19;

pub const PCIE2CIO_CMD_PORT_SHIFT: c_int = 13;
pub const PCIE2CIO_WRDATA: c_uint = 0x34;
pub const PCIE2CIO_RDDATA: c_uint = 0x38;
pub const PHY_PORT_CS1: c_uint = 0x37;

pub const PHY_PORT_CS1_LINK_STATE_SHIFT: c_int = 26;

pub const ICM_RETRIES: c_int = 3;

pub const ICM_MAX_LINK: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct usb4_switch_nvm_auth {
    pub reply: icm_usb4_switch_op_response,
    pub request: icm_usb4_switch_op,
    pub icm: *mut icm,
}
...
pub struct icm {
    ...
    pub upstream_port: *mut pci_dev,
    pub vnd_cap: c_int,
    pub safe_mode: bool,
    pub max_boot_acl: usize,
    pub rpm: bool,
    pub can_upgrade_nvm: bool,
    pub proto_version: u8,
    pub last_nvm_auth: *mut usb4_switch_nvm_auth,
    pub veto: bool,
    pub tb): *mut *mut bool (is_supported)(struct tb,
    pub tb): *mut *mut int (cio_reset)(struct tb,
    pub tb): *mut *mut int (get_mode)(struct tb,
    pub route): *mut *mut *mut int (get_route)(struct tb tb, u8 link, u8 depth, u64,
    pub tb): *mut *mut void (save_devices)(struct tb,
    int (*driver_ready)(struct tb *tb,
    enum tb_security_level *security_level,
    pub rpm): *mut *mut *mut u8 proto_version, size_t nboot_acl, bool,
    pub tb): *mut *mut void (set_uuid)(struct tb,
    void (*device_connected)(struct tb *tb,
    pub hdr): *const icm_pkg_header,
    ...
    pub hdr): *const icm_pkg_header,
    pub hdr): *const *const *const void (rtd3_veto)(struct tb tb, struct icm_pkg_header,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct icm_notification {
    pub work: work_struct,
    pub pkg: *mut icm_pkg_header,
    pub tb: *mut tb,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ep_name_entry {
    pub len: u8,
    pub type: u8,
    pub data: [u8; ],
}

pub const EP_NAME_INTEL_VSS: c_uint = 0x10;
// Intel Vendor specific structure
#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_vss {
    pub vendor: u16,
    pub model: u16,
    pub mc: u8,
    pub flags: u8,
...
#[no_mangle]
unsafe extern "C" fn intel_vss_is_rtd3(ep_name: *const c_void, size: usize) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn phy_port_from_route(route: u64, depth: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn dual_link_from_link(link: u8) -> u8 {
    static inline u8 dual_link_from_link(u8 link)
    {
    return link ? ((link - 1) ^ 0x01) + 1 : 0;
    }
#[no_mangle]
pub unsafe extern "C" fn get_route(route_hi: u32, route_lo: u32) -> u64 {
    static inline u64 get_route(u32 route_hi, u32 route_lo)
    {
    return (u64)route_hi << 32 | route_lo;
    }
#[no_mangle]
pub unsafe extern "C" fn get_parent_route(route: u64) -> u64 {
    static inline u64 get_parent_route(u64 route)
    {
    let mut depth: c_int = tb_route_length(route);
    return depth ? route & ~(0xffULL << (depth - 1) * TB_ROUTE_SHIFT) : 0;
    }
#[no_mangle]
unsafe extern "C" fn pci2cio_wait_completion(icm: *mut icm, timeout_msec: c_ulong) -> c_int {
    static int pci2cio_wait_completion(struct icm *icm, unsigned long timeout_msec)
    {
    let mut end: c_ulong = jiffies + msecs_to_jiffies(timeout_msec);
    u32 cmd;
    do {
    ...
    {
    struct pci_dev *pdev = icm.upstream_port;
    let mut vnd_cap: c_int = icm.vnd_cap;
    u32 cmd;
...
#[no_mangle]
unsafe extern "C" fn icm_copy(req: *mut tb_cfg_request, pkg: *const ctl_pkg) -> bool {
    ...
    let mut offset: usize = hdr.packet_id * req.response_size;
...
//
#[no_mangle]
unsafe extern "C" fn icm_postpone_rescan(tb: *mut tb) {
...
#[no_mangle]
unsafe extern "C" fn icm_veto_begin(tb: *mut tb) {
...
#[no_mangle]
unsafe extern "C" fn icm_veto_end(tb: *mut tb) {
...
#[no_mangle]
unsafe extern "C" fn icm_firmware_running(nhi: *const tb_nhi) -> bool {
...
#[no_mangle]
unsafe extern "C" fn icm_xdomain_activated(xd: *mut tb_xdomain, activated: bool) {
...
#[no_mangle]
unsafe extern "C" fn icm_dp_event(tb: *mut tb) {
    static void icm_dp_event(struct tb *tb)
    {
    tb_tunnel_event(tb, TB_TUNNEL_CHANGED, TB_TUNNEL_DP, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn icm_fr_is_supported(tb: *mut tb) -> bool {
    static bool icm_fr_is_supported(struct tb *tb)
    {
    return !x86_apple_machine;
    }
#[no_mangle]
pub unsafe extern "C" fn icm_fr_get_switch_index(port: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_fr_get_route(tb: *mut tb, link: u8, depth: u8, route: *mut u64) -> c_int {
    ...
    let mut npackets: usize = ICM_GET_TOPOLOGY_PACKETS;
    int ret, index;
    u8 i;
...
#[no_mangle]
unsafe extern "C" fn icm_fr_save_devices(tb: *mut tb) {
...
#[no_mangle]
unsafe extern "C" fn icm_fr_approve_switch(tb: *mut tb, sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_fr_add_switch_key(tb: *mut tb, sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn add_switch(parent_sw: *mut tb_switch, sw: *mut tb_switch) -> c_int {
...
// Link the two switches now
    ...
    if (ret)
    tb_port_at(tb_route(sw), parent_sw).remote = core::ptr::null_mut();
    return ret;
    }
...
// Disconnect from parent
    tb_switch_downstream_port(sw).remote = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn remove_switch(sw: *mut tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn update_xdomain(xd: *mut tb_xdomain, route: u64, link: u8) {
...
#[no_mangle]
unsafe extern "C" fn remove_xdomain(xd: *mut tb_xdomain) {
    static void remove_xdomain(struct tb_xdomain *xd)
    {
    struct tb_switch *sw;
    sw = tb_to_switch(xd.dev.parent);
    tb_port_at(xd.route, sw).xdomain = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn icm_tr_cio_reset(tb: *mut tb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_tr_approve_switch(tb: *mut tb, sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_tr_add_switch_key(tb: *mut tb, sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_ar_is_supported(tb: *mut tb) -> bool {
...
#[no_mangle]
unsafe extern "C" fn icm_ar_cio_reset(tb: *mut tb) -> c_int {
    static int icm_ar_cio_reset(struct tb *tb)
    {
    return pcie2cio_write(tb_priv(tb), TB_CFG_SWITCH, 0, 0x50, BIT(9));
    }
#[no_mangle]
unsafe extern "C" fn icm_ar_get_mode(tb: *mut tb) -> c_int {
    static int icm_ar_get_mode(struct tb *tb)
    {
    struct tb_nhi *nhi = tb.nhi;
    let mut retries: c_int = 60;
    u32 val;
    do {
    val = ioread32(nhi.iobase + REG_FW_STS);
...
#[no_mangle]
unsafe extern "C" fn icm_ar_get_route(tb: *mut tb, link: u8, depth: u8, route: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_ar_get_boot_acl(tb: *mut tb, uuids: *mut uuid_t, nuuids: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_icl_set_uuid(tb: *mut tb) {
...
#[no_mangle]
unsafe extern "C" fn icm_icl_rtd3_veto(tb: *mut tb, hdr: *const icm_pkg_header) {
...
#[no_mangle]
unsafe extern "C" fn icm_tgl_is_supported(tb: *mut tb) -> bool {
    static bool icm_tgl_is_supported(struct tb *tb)
    {
    let mut end: c_ulong = jiffies + msecs_to_jiffies(10);
    do {
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn icm_handle_notification(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn icm_firmware_reset(tb: *mut tb, nhi: *mut tb_nhi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_firmware_start(tb: *mut tb, nhi: *mut tb_nhi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_reset_phy_port(tb: *mut tb, phy_port: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_firmware_init(tb: *mut tb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_driver_ready(tb: *mut tb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_suspend(tb: *mut tb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn icm_unplug_children(sw: *mut tb_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tb_port_has_remote(port)) -> else {
    else if (tb_port_has_remote(port))
    icm_unplug_children(port.remote.sw);
    }
    }
#[no_mangle]
unsafe extern "C" fn complete_rpm(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_unplugged_switch(sw: *mut tb_switch) {
...
// for it.
//
    complete_rpm(&sw.dev, core::ptr::null_mut());
    bus_for_each_dev(&tb_bus_type, &sw.dev, core::ptr::null_mut(), complete_rpm);
    tb_switch_remove(sw);
...
#[no_mangle]
unsafe extern "C" fn icm_free_unplugged_children(sw: *mut tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn icm_rescan_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn icm_complete(tb: *mut tb) {
...
//
    __icm_driver_ready(tb, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn icm_runtime_suspend(tb: *mut tb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_runtime_suspend_switch(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_runtime_resume_switch(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_runtime_resume(tb: *mut tb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icm_start(tb: *mut tb, not_used: bool) -> c_int {
    ...
    tb.root_switch = core::ptr::null_mut();
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn icm_stop(tb: *mut tb) {
    ...
    icm.last_nvm_auth = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn icm_disconnect_pcie_paths(tb: *mut tb) -> c_int {
    static int icm_disconnect_pcie_paths(struct tb *tb)
    {
    return nhi_mailbox_cmd(tb.nhi, NHI_MAILBOX_DISCONNECT_PCIE_PATHS, 0);
    }
#[no_mangle]
unsafe extern "C" fn icm_usb4_switch_nvm_auth_complete(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn icm_usb4_switch_nvm_authenticate(tb: *mut tb, route: u64) -> c_int {
