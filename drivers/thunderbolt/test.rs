...
//! Source: drivers/thunderbolt/test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __ida_init(res: *mut kunit_resource, context: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __ida_destroy(res: *mut kunit_resource) {
...
#[no_mangle]
unsafe extern "C" fn kunit_ida_init(test: *mut kunit, ida: *mut ida) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_basic(test: *mut kunit) {
    ...
    dst_port = src_port;
    p = tb_next_port_on_path(src_port, dst_port, core::ptr::null_mut());
    KUNIT_EXPECT_PTR_EQ(test, p, dst_port);
    p = tb_next_port_on_path(src_port, dst_port, p);
    KUNIT_EXPECT_TRUE(test, !p);
    }
#[no_mangle]
unsafe extern "C" fn tb_test_path_not_connected_walk(test: *mut kunit) {
...
// No connection between host and dev
    dev = alloc_dev_default(test, core::ptr::null_mut(), 3, true);
    ...
    KUNIT_EXPECT_TRUE(test, !p);
// Other direction
    p = tb_next_port_on_path(dst_port, src_port, core::ptr::null_mut());
    KUNIT_EXPECT_PTR_EQ(test, p, dst_port);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct port_expectation {
    pub route: u64,
    pub port: u8,
    pub type: enum tb_port_type,
}

#[no_mangle]
unsafe extern "C" fn tb_test_path_single_hop_walk(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_daisy_chain_walk(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_simple_tree_walk(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_complex_tree_walk(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_max_length_walk(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_not_connected(test: *mut kunit) {
...
// Not connected to anything
    dev2 = alloc_dev_default(test, core::ptr::null_mut(), 0x303, false);
    down = &dev1.ports[10];
    up = &dev2.ports[9];
    path = tb_path_alloc(core::ptr::null_mut(), down, 8, up, 8, 0, "PCIe Down");
    KUNIT_ASSERT_NULL(test, path);
    path = tb_path_alloc(core::ptr::null_mut(), down, 8, up, 8, 1, "PCIe Down");
    KUNIT_ASSERT_NULL(test, path);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hop_expectation {
    pub route: u64,
    pub in_port: u8,
    pub in_type: enum tb_port_type,
    pub out_port: u8,
    pub out_type: enum tb_port_type,
}

#[no_mangle]
unsafe extern "C" fn tb_test_path_not_bonded_lane0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_not_bonded_lane1(test: *mut kunit) {
...
//
    ...
    in = &host.ports[5];
    out = &dev.ports[13];
    path = tb_path_alloc(core::ptr::null_mut(), in, 9, out, 9, 1, "Video");
    KUNIT_ASSERT_NOT_NULL(test, path);
    KUNIT_ASSERT_EQ(test, path.path_length, ARRAY_SIZE(test_data));
    for (i = 0; i < ARRAY_SIZE(test_data); i++) {
    const struct tb_port *in_port, *out_port;
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_not_bonded_lane1_chain(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_not_bonded_lane1_chain_reverse(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_mixed_chain(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_path_mixed_chain_reverse(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_pcie(test: *mut kunit) {
...
//
    ...
    down = &host.ports[8];
    up = &dev1.ports[9];
    tunnel1 = tb_tunnel_alloc_pci(core::ptr::null_mut(), up, down);
    ...
    down = &dev1.ports[10];
    up = &dev2.ports[9];
    tunnel2 = tb_tunnel_alloc_pci(core::ptr::null_mut(), up, down);
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dp(test: *mut kunit) {
...
//
    ...
    in = &host.ports[5];
    out = &dev.ports[13];
    tunnel = tb_tunnel_alloc_dp(core::ptr::null_mut(), in, out, 1, 0, 0, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dp_chain(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dp_tree(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dp_max_length(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_3dp(test: *mut kunit) {
...
//
    ...
    out2 = &dev5.ports[13];
    out3 = &dev4.ports[14];
    tunnel1 = tb_tunnel_alloc_dp(core::ptr::null_mut(), in1, out1, 1, 0, 0, core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_ASSERT_TRUE(test, tunnel1 != core::ptr::null_mut());
    ...
    tunnel2 = tb_tunnel_alloc_dp(core::ptr::null_mut(), in2, out2, 1, 0, 0, core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_ASSERT_TRUE(test, tunnel2 != core::ptr::null_mut());
    ...
    tunnel3 = tb_tunnel_alloc_dp(core::ptr::null_mut(), in3, out3, 1, 0, 0, core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_ASSERT_TRUE(test, tunnel3 != core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_usb3(test: *mut kunit) {
...
//
    ...
    down = &host.ports[12];
    up = &dev1.ports[16];
    tunnel1 = tb_tunnel_alloc_usb3(core::ptr::null_mut(), up, down, 0, 0);
    KUNIT_ASSERT_NOT_NULL(test, tunnel1);
    ...
    down = &dev1.ports[17];
    up = &dev2.ports[16];
    tunnel2 = tb_tunnel_alloc_usb3(core::ptr::null_mut(), up, down, 0, 0);
    KUNIT_ASSERT_NOT_NULL(test, tunnel2);
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_port_on_path(test: *mut kunit) {
...
//
    ...
    in = &dev2.ports[13];
    out = &dev5.ports[13];
    dp_tunnel = tb_tunnel_alloc_dp(core::ptr::null_mut(), in, out, 1, 0, 0, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dma(test: *mut kunit) {
...
//
    ...
    nhi = &host.ports[7];
    port = &host.ports[1];
    tunnel = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 8, 1, 8, 1);
    KUNIT_ASSERT_NOT_NULL(test, tunnel);
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dma_rx(test: *mut kunit) {
...
//
    ...
    nhi = &host.ports[7];
    port = &host.ports[1];
    tunnel = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, -1, -1, 15, 2);
    KUNIT_ASSERT_NOT_NULL(test, tunnel);
    KUNIT_EXPECT_EQ(test, tunnel.type, TB_TUNNEL_DMA);
    KUNIT_EXPECT_PTR_EQ(test, tunnel.src_port, nhi);
    KUNIT_EXPECT_PTR_EQ(test, tunnel.dst_port, port);
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dma_tx(test: *mut kunit) {
...
//
    ...
    nhi = &host.ports[7];
    port = &host.ports[1];
    tunnel = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 15, 2, -1, -1);
    KUNIT_ASSERT_NOT_NULL(test, tunnel);
    KUNIT_EXPECT_EQ(test, tunnel.type, TB_TUNNEL_DMA);
    KUNIT_EXPECT_PTR_EQ(test, tunnel.src_port, nhi);
    KUNIT_EXPECT_PTR_EQ(test, tunnel.dst_port, port);
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dma_chain(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_tunnel_dma_match(test: *mut kunit) {
    ...
    nhi = &host.ports[7];
    port = &host.ports[1];
    tunnel = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 15, 1, 15, 1);
    KUNIT_ASSERT_NOT_NULL(test, tunnel);
    ...
    tb_tunnel_put(tunnel);
    tunnel = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 15, 1, -1, -1);
    KUNIT_ASSERT_NOT_NULL(test, tunnel);
    KUNIT_ASSERT_TRUE(test, tb_tunnel_match_dma(tunnel, 15, 1, -1, -1));
    KUNIT_ASSERT_TRUE(test, tb_tunnel_match_dma(tunnel, 15, -1, -1, -1));
    KUNIT_ASSERT_TRUE(test, tb_tunnel_match_dma(tunnel, -1, 1, -1, -1));
    ...
    tb_tunnel_put(tunnel);
    tunnel = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, -1, -1, 15, 11);
    KUNIT_ASSERT_NOT_NULL(test, tunnel);
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_legacy_not_bonded(test: *mut kunit) {
    ...
    down = &host.ports[8];
    up = &dev.ports[9];
    tunnel = tb_tunnel_alloc_pci(core::ptr::null_mut(), up, down);
    KUNIT_ASSERT_NOT_NULL(test, tunnel);
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_legacy_bonded(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_pcie(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_without_dp(test: *mut kunit) {
...
//
    ...
    up = &dev.ports[9];
    tunnel = tb_tunnel_alloc_pci(core::ptr::null_mut(), up, down);
    KUNIT_ASSERT_TRUE(test, tunnel != core::ptr::null_mut());
    KUNIT_ASSERT_EQ(test, tunnel.npaths, (size_t)2);
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_dp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_usb3(test: *mut kunit) {
    ...
    down = &host.ports[12];
    up = &dev.ports[16];
    tunnel = tb_tunnel_alloc_usb3(core::ptr::null_mut(), up, down, 0, 0);
    KUNIT_ASSERT_NOT_NULL(test, tunnel);
    KUNIT_ASSERT_EQ(test, tunnel.npaths, (size_t)2);
    path = tunnel.paths[0];
    KUNIT_ASSERT_EQ(test, path.path_length, 2);
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_dma(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_dma_multiple(test: *mut kunit) {
...
//
    tunnel1 = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 8, 1, 8, 1);
    KUNIT_ASSERT_NOT_NULL(test, tunnel1);
    ...
    KUNIT_EXPECT_EQ(test, path.hops[1].nfc_credits, 0U);
    KUNIT_EXPECT_EQ(test, path.hops[1].initial_credits, 14U);
    tunnel2 = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 9, 2, 9, 2);
    KUNIT_ASSERT_NOT_NULL(test, tunnel2);
    ...
    KUNIT_EXPECT_EQ(test, path.hops[1].nfc_credits, 0U);
    KUNIT_EXPECT_EQ(test, path.hops[1].initial_credits, 1U);
    tunnel3 = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 10, 3, 10, 3);
...
//
    ...
    down = &host.ports[8];
    up = &dev.ports[9];
    pcie_tunnel = tb_tunnel_alloc_pci(core::ptr::null_mut(), up, down);
    ...
    in = &host.ports[5];
    out = &dev.ports[13];
    dp_tunnel1 = tb_tunnel_alloc_dp(core::ptr::null_mut(), in, out, 1, 0, 0, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    in = &host.ports[6];
    out = &dev.ports[14];
    dp_tunnel2 = tb_tunnel_alloc_dp(core::ptr::null_mut(), in, out, 1, 0, 0, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    down = &host.ports[12];
    up = &dev.ports[16];
    usb3_tunnel = tb_tunnel_alloc_usb3(core::ptr::null_mut(), up, down, 0, 0);
    ...
    nhi = &host.ports[7];
    port = &dev.ports[3];
    dma_tunnel1 = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 8, 1, 8, 1);
    ...
    nhi = &host.ports[7];
    port = &dev.ports[3];
    dma_tunnel2 = tb_tunnel_alloc_dma(core::ptr::null_mut(), nhi, port, 9, 2, 9, 2);
...
#[no_mangle]
unsafe extern "C" fn tb_test_credit_alloc_all(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_property_parse(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_property_format(test: *mut kunit) {
    ...
    dir = tb_property_parse_dir(root_directory, ARRAY_SIZE(root_directory));
    KUNIT_ASSERT_NOT_NULL(test, dir);
    ret = tb_property_format_dir(dir, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn tb_test_property_copy(test: *mut kunit) {
...
// Compare the resulting property block
    ret = tb_property_format_dir(dst, core::ptr::null_mut(), 0);
    KUNIT_ASSERT_EQ(test, ret, ARRAY_SIZE(root_directory));
...
//
#[no_mangle]
unsafe extern "C" fn tb_test_property_parse_u32_wrap(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_property_parse_recursion(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_property_parse_dir_len_underflow(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_property_parse_zero_length(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_property_parse_rootdir_overflow(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn tb_test_property_merge(test: *mut kunit) {
...
// This replaces the value in dir1
    ...
    KUNIT_EXPECT_EQ(test, ret, 0);
    p = tb_property_get_next(dir1, core::ptr::null_mut());
    KUNIT_ASSERT_NOT_NULL(test, p);
