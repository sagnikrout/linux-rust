...
//! Source: drivers/thunderbolt/path.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tb_dump_hop(hop: *const tb_path_hop, regs: *const tb_regs_hop) {
    ...
    int dst_hopid)
    {
    struct tb_port *port, *out_port = core::ptr::null_mut();
    ...
    return out_port && hopid == dst_hopid ? out_port : core::ptr::null_mut();
    }
...
//
    ...
    size_t num_hops;
    int i, ret;
    first_port = last_port = core::ptr::null_mut();
    i = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_path_free(path: *mut tb_path) {
...
#[no_mangle]
unsafe extern "C" fn __tb_path_deallocate_nfc(path: *mut tb_path, first_hop: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_path_deactivate_hop(port: *mut tb_port, hop_index: c_int) -> c_int {
    int tb_path_deactivate_hop(struct tb_port *port, int hop_index)
    {
    return __tb_path_deactivate_hop(port, hop_index, true);
    }
#[no_mangle]
unsafe extern "C" fn __tb_path_deactivate_hops(path: *mut tb_path, first_hop: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn tb_path_deactivate(path: *mut tb_path) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_path_activate(path: *mut tb_path) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_path_is_invalid(path: *mut tb_path) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_path_port_on_path(path: *const tb_path, port: *const tb_port) -> bool {
