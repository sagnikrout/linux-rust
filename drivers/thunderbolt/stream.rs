...
//! Source: drivers/thunderbolt/stream.c
#![no_std]
...
//
pub const TBSTREAM_DEV_RING_SIZE: c_int = 256;
pub const TBSTREAM_DEV_MIN_RING_SIZE: c_int = 32;
pub const TBSTREAM_DEV_MAX_RING_SIZE: c_int = 4096;
pub const TBSTREAM_DEV_THROTTLING: c_int = 8192;
pub const TBSTREAM_DEV_MAX_THROTTLING: c_int = 16776960;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tbstream_frame {
    pub sdev: *mut tbstream_dev,
    pub page: *mut page,
    pub offset: c_uint,
    pub completed: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tbstream_ring {
    pub ring: *mut tb_ring,
    pub prod: c_ulong,
    pub cons: c_ulong,
    pub frames: *mut tbstream_frame,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tbstream_dev {
    pub group: config_group,
    pub stream: *mut tbstream,
    pub misc: miscdevice,
    pub kref: kref,
    pub index: c_int,
    pub in_hopid: c_int,
    ...
    pub lock: mutex,
    pub tx_ring: tbstream_ring,
    pub rx_ring: tbstream_ring,
    pub list: list_head,
}
...
#[no_mangle]
unsafe extern "C" fn tbstream_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn tbstream_put(stream: *mut tbstream) {
...
#[no_mangle]
pub unsafe extern "C" fn tbstream_valid(stream: *const tbstream) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tbstream_ring_free(ring: *mut tbstream_ring) {
...
#[no_mangle]
pub unsafe extern "C" fn tbstream_ring_available(ring: *const tbstream_ring) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn tbstream_dev_put(sdev: *mut tbstream_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn tbstream_dev_valid(sdev: *const tbstream_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tbstream_dev_removed(sdev: *const tbstream_dev) -> bool {
    static inline bool tbstream_dev_removed(const struct tbstream_dev *sdev)
    {
    return sdev.removed;
    }
#[no_mangle]
pub unsafe extern "C" fn tbstream_dev_closed(sdev: *const tbstream_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(RING_DESC_BUFFER_OVERRUN: sf->frame.flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_consume_rx(sdev: *mut tbstream_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_alloc_rx_buffers(sdev: *mut tbstream_dev) -> c_int {
    static int tbstream_dev_alloc_rx_buffers(struct tbstream_dev *sdev)
    {
    let mut ring_size: usize = tb_ring_size(sdev.rx_ring.ring);
    int i;
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_alloc_tx_buffers(sdev: *mut tbstream_dev) -> c_int {
    ...
    let mut ring_size: usize = tb_ring_size(sdev.tx_ring.ring);
    int i;
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_send_close(sdev: *mut tbstream_dev) -> c_int {
...
//
    let mut timeout: ktime_t = ktime_add_ms(ktime_get(), 500);
    do {
    if (tbstream_ring_available(&sdev.tx_ring))
    break;
    ...
    sf = tbstream_dev_alloc_tx(sdev, TBSTREAM_CLOSE, core::ptr::null_mut(), SZ_256);
    if (IS_ERR(sf))
    return PTR_ERR(sf);
    return tb_ring_tx(sdev.tx_ring.ring, &sf.frame);
    }
#[no_mangle]
unsafe extern "C" fn tbstream_dev_start(sdev: *mut tbstream_dev) -> c_int {
    static int tbstream_dev_start(struct tbstream_dev *sdev)
    {
    struct tb_xdomain *xd = tbstream_dev_xdomain(sdev);
    let mut flags: c_uint = RING_FLAG_FRAME | RING_FLAG_E2E;
    ...
    e2e_tx_hop, sof_mask, eof_mask, core::ptr::null_mut(), core::ptr::null_mut());
    if (!ring) {
    ret = -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_tx_drained(sdev: *const tbstream_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_stop(sdev: *mut tbstream_dev) {
...
//
    ...
    tb_ring_free(sdev.rx_ring.ring);
    sdev.rx_ring.ring = core::ptr::null_mut();
    tbstream_ring_free(&sdev.tx_ring);
    tb_ring_free(sdev.tx_ring.ring);
    sdev.tx_ring.ring = core::ptr::null_mut();
    }
// Use only with read_iter/write_iter() to handle nowait
#[no_mangle]
unsafe extern "C" fn tbstream_dev_lock(sdev: *mut tbstream_dev, nowait: bool) -> c_int {
    ...
    let mut nowait: bool = file.f_flags & O_NONBLOCK || kiocb.ki_flags & IOCB_NOWAIT;
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_fops_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_fops_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_busy_poll_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_index_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_in_hopid_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn service_remove_properties(svc: *mut tb_service, name: *const c_char) {
...
//
    ...
    svc.local_properties = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_update_properties(sdev: *mut tbstream_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_alloc_in_hopid(sdev: *mut tbstream_dev, hopid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_alloc_out_hopid(sdev: *mut tbstream_dev, hopid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_out_hopid_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_ring_size_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_throttling_show(item: *mut config_item, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_item_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn tbstream_dev_detach_stream(sdev: *mut tbstream_dev) {
...
#[no_mangle]
unsafe extern "C" fn tbstream_item_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn tbstream_group_attach_stream(stream: *mut tbstream) {
...
#[no_mangle]
unsafe extern "C" fn tbstream_group_detach_stream(stream: *mut tbstream) {
...
// Detach this stream from the stream devices
    ...
    tbstream_put(sg.stream);
    sg.stream = core::ptr::null_mut();
    }
    config_group_put(&sg.group);
    }
#[no_mangle]
unsafe extern "C" fn tbstream_probe(svc: *mut tb_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tbstream_remove(svc: *mut tb_service) {
...
#[no_mangle]
unsafe extern "C" fn tbstream_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tbstream_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tbstream_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tbstream_exit() -> void __exit {
