...
//! Source: drivers/thunderbolt/usb4.c
#![no_std]
...
pub const USB4_DATA_RETRIES: c_int = 3;
pub const USB4_DATA_DWORDS: c_int = 16;

pub const USB4_NVM_READ_OFFSET_SHIFT: c_int = 2;

pub const USB4_NVM_READ_LENGTH_SHIFT: c_int = 24;

pub const USB4_DROM_ADDRESS_SHIFT: c_int = 2;

pub const USB4_DROM_SIZE_SHIFT: c_int = 15;
...
pub const USB4_BA_VALUE_SHIFT: c_int = 16;
// Delays in us used with usb4_port_wait_for_bit()
pub const USB4_PORT_DELAY: c_int = 50;
pub const USB4_PORT_SB_DELAY: c_int = 1000;
...
//
    ...
    u32 *metadata, u8 *status)
    {
    return __usb4_switch_op(sw, opcode, metadata, status, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_check_wakes(sw: *mut tb_switch) {
    void usb4_switch_check_wakes(struct tb_switch *sw)
    {
    let mut wakeup_usb4: bool = false;
...
#[no_mangle]
unsafe extern "C" fn link_is_usb4(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_setup(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_configuration_valid(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_read_uid(sw: *mut tb_switch, uid: *mut u64) -> c_int {
    ...
    &status, core::ptr::null_mut(), 0, buf, dwords);
    if (ret)
    return ret;
    return status ? -EIO : 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_lane_bonding_possible(sw: *mut tb_switch) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_set_wake(sw: *mut tb_switch, flags: c_uint, runtime: bool) -> c_int {
    int usb4_switch_set_wake(struct tb_switch *sw, unsigned int flags, bool runtime)
    {
    struct tb_port *port;
    let mut route: u64 = tb_route(sw);
    u32 val;
    int ret;
//
...
//
    ...
    let mut configured: bool = val & PORT_CS_19_PC;
    let mut wakeup: bool = runtime || device_may_wakeup(&port.usb4.dev);
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_set_sleep(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_nvm_sector_size(sw: *mut tb_switch) -> c_int {
    ...
    return ret;
    if (status)
    let mut status: return = = 0x2 ? -EOPNOTSUPP : -EIO;
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_nvm_set_offset(sw: *mut tb_switch, address: c_uint) -> c_int {
    ...
    u8 status;
    int ret;
    ret = usb4_switch_op_data(sw, USB4_SWITCH_OP_NVM_WRITE, core::ptr::null_mut(), &status,
    buf, dwords, core::ptr::null_mut(), 0);
    if (ret)
    return ret;
    return status ? -EIO : 0;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_nvm_authenticate(sw: *mut tb_switch) -> c_int {
    int usb4_switch_nvm_authenticate(struct tb_switch *sw)
    {
    int ret;
    ret = usb4_switch_op(sw, USB4_SWITCH_OP_NVM_AUTH, core::ptr::null_mut(), core::ptr::null_mut());
    switch (ret) {
//
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_nvm_authenticate_status(sw: *mut tb_switch, status: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_credits_init(sw: *mut tb_switch) -> c_int {
    ...
    &status, core::ptr::null_mut(), 0, data, ARRAY_SIZE(data));
    if (ret)
    return ret;
    if (status)
    return -EIO;
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_query_dp_resource(sw: *mut tb_switch, in: *mut tb_port) -> bool {
    bool usb4_switch_query_dp_resource(struct tb_switch *sw, struct tb_port *in)
    {
    let mut metadata: u32 = in.port;
    u8 status;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_alloc_dp_resource(sw: *mut tb_switch, in: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_dealloc_dp_resource(sw: *mut tb_switch, in: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_index(sw: *const tb_switch, port: *const tb_port) -> c_int {
    int usb4_port_index(const struct tb_switch *sw, const struct tb_port *port)
    {
    struct tb_port *p;
    let mut usb4_idx: c_int = 0;
...
//
    ...
    const struct tb_port *port)
    {
    let mut usb4_idx: c_int = usb4_port_index(sw, port);
    struct tb_port *p;
    let mut pcie_idx: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_add_ports(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_switch_remove_ports(sw: *mut tb_switch) {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_unlock(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_hotplug_enable(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_reset(port: *mut tb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb4_port_set_configured(port: *mut tb_port, configured: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_configure(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_unconfigure(port: *mut tb_port) {
    void usb4_port_unconfigure(struct tb_port *port)
    {
    usb4_port_set_configured(port, false);
    }
#[no_mangle]
unsafe extern "C" fn usb4_set_xdomain_configured(port: *mut tb_port, configured: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_configure_xdomain(port: *mut tb_port, xd: *mut tb_xdomain) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_unconfigure_xdomain(port: *mut tb_port) {
...
#[no_mangle]
unsafe extern "C" fn usb4_port_read_data(port: *mut tb_port, data: *mut c_void, dwords: usize) -> c_int {
...
//
    ...
    {
    let mut dwords: usize = DIV_ROUND_UP(size, 4);
    int ret;
    u32 val;
    if (!port.cap_usb4)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn usb4_port_sb_opcode_err_to_errno(val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb4_port_set_router_offline(port: *mut tb_port, offline: bool) -> c_int {
    static int usb4_port_set_router_offline(struct tb_port *port, bool offline)
    {
    let mut val: u32 = !offline;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_router_offline(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_router_online(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_enumerate_retimers(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_clx_supported(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_asym_supported(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_asym_set_link_width(port: *mut tb_port, width: enum tb_link_width) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_asym_start(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_retimer_set_inbound_sbtx(port: *mut tb_port, index: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_retimer_unset_inbound_sbtx(port: *mut tb_port, index: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_retimer_is_last(port: *mut tb_port, index: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_retimer_is_cable(port: *mut tb_port, index: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_retimer_nvm_sector_size(port: *mut tb_port, index: u8) -> c_int {
...
//
    ...
    const void *buf, size_t size)
    {
    let mut info: retimer_info = { .port = port, .index = index };
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_port_retimer_nvm_authenticate(port: *mut tb_port, index: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_usb3_port_max_link_rate(port: *mut tb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb4_usb3_port_cm_request(port: *mut tb_port, request: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mbps_to_usb3_bw(mbps: c_uint, scale: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn is_usb4_dpin(port: *const tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_set_cm_id(port: *mut tb_port, cm_id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_bandwidth_mode_supported(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_bandwidth_mode_enabled(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_group_id(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_set_group_id(port: *mut tb_port, group_id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_nrd(port: *mut tb_port, rate: *mut c_int, lanes: *mut c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_set_nrd(port: *mut tb_port, rate: c_int, lanes: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_granularity(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_set_granularity(port: *mut tb_port, granularity: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_set_estimated_bandwidth(port: *mut tb_port, bw: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_allocated_bandwidth(port: *mut tb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __usb4_dp_port_set_cm_ack(port: *mut tb_port, ack: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_set_cm_ack(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_allocate_bandwidth(port: *mut tb_port, bw: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_dp_port_requested_bandwidth(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_pci_port_set_ext_encapsulation(port: *mut tb_port, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn usb4_pci_port_ltssm_state(port: *mut tb_port) -> c_int {
