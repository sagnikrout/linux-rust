...
//! Source: drivers/thunderbolt/switch.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nvm_get_auth_status(sw: *const tb_switch, status: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn nvm_set_auth_status(sw: *const tb_switch, status: u32) {
...
#[no_mangle]
unsafe extern "C" fn nvm_clear_auth_status(sw: *const tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn nvm_validate_and_write(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvm_authenticate_host_dma_port(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvm_authenticate_device_dma_port(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nvm_readable(sw: *mut tb_switch) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nvm_upgradeable(sw: *mut tb_switch) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nvm_authenticate(sw: *mut tb_switch, auth_only: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvm_read(priv: *mut c_void, offset: c_uint, val: *mut c_void, bytes: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvm_write(priv: *mut c_void, offset: c_uint, val: *mut c_void, bytes: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_nvm_init(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_nvm_add(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_nvm_remove(sw: *mut tb_switch) {
    static void tb_switch_nvm_remove(struct tb_switch *sw)
    {
    struct tb_nvm *nvm;
    nvm = sw.nvm;
    sw.nvm = core::ptr::null_mut();
    if (!nvm)
    return;
...
#[no_mangle]
unsafe extern "C" fn tb_dump_port(tb: *mut tb, port: *const tb_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_state(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_wait_for_port(port: *mut tb_port, wait_if_unplugged: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_add_nfc_credits(port: *mut tb_port, credits: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_clear_counter(port: *mut tb_port, counter: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_unlock(port: *mut tb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __tb_port_enable(port: *mut tb_port, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_enable(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_disable(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_reset(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tb_init_port(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_alloc_in_hopid(port: *mut tb_port, min_hopid: c_int, max_hopid: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_alloc_out_hopid(port: *mut tb_port, min_hopid: c_int, max_hopid: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_release_in_hopid(port: *mut tb_port, hopid: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_release_out_hopid(port: *mut tb_port, hopid: c_int) {
    ...
    {
    let mut mask: u64 = (1ULL << parent.config.depth * 8) - 1;
...
//
    ...
    return next != prev ? next : core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_get_link_speed(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_get_link_generation(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_get_link_width(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_width_supported(port: *mut tb_port, width: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_set_link_width(port: *mut tb_port, width: enum tb_link_width) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tb_port_set_lane_bonding(port: *mut tb_port, bonding: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_lane_bonding_enable(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_lane_bonding_disable(port: *mut tb_port) {
...
//
    ...
    int timeout_msec)
    {
    let mut timeout: ktime_t = ktime_add_ms(ktime_get(), timeout_msec);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tb_port_do_update_credits(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_update_credits(port: *mut tb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_port_start_lane_initialization(port: *mut tb_port) -> c_int {
    ...
    let mut ret: return = = -EINVAL ? 0 : ret;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn tb_port_resume(port: *mut tb_port) -> bool {
    static bool tb_port_resume(struct tb_port *port)
    {
    let mut has_remote: bool = tb_port_has_remote(port);
    if (port.usb4) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_port_is_enabled(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_usb3_port_is_enabled(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_usb3_port_enable(port: *mut tb_port, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_pci_port_is_enabled(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_pci_port_enable(port: *mut tb_port, enable: bool) -> c_int {
    int tb_pci_port_enable(struct tb_port *port, bool enable)
    {
    let mut word: u32 = enable ? ADP_PCIE_CS_0_PE : 0x0;
    if (!port.cap_adap)
    return -ENXIO;
    return tb_port_write(port, &word, TB_CFG_PORT,
    port.cap_adap + ADP_PCIE_CS_0, 1);
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_dp_port_hpd_is_active(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_dp_port_hpd_clear(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_dp_port_is_enabled(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_dp_port_enable(port: *mut tb_port, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_dump_switch(tb: *const tb, sw: *const tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_reset_host(sw: *mut tb_switch) -> c_int {
...
// Thunderbolt 1 uses the "reset" config space packet
    ...
    return -EIO;
#[no_mangle]
pub unsafe extern "C" fn if(0: res.err <) -> else {
    else if (res.err < 0)
    return res.err;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn tb_switch_reset_device(sw: *mut tb_switch) -> c_int {
    static int tb_switch_reset_device(struct tb_switch *sw)
    {
    return tb_port_reset(tb_switch_downstream_port(sw));
    }
#[no_mangle]
unsafe extern "C" fn tb_switch_enumerated(sw: *mut tb_switch) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_reset(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tb_plug_events_active(sw: *mut tb_switch, active: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disapprove_switch(dev: *mut device, not_used: *mut c_void) -> c_int {
    static int disapprove_switch(struct device *dev, void *not_used)
    {
    char *envp[] = { "AUTHORIZED=0", core::ptr::null_mut() };
    struct tb_switch *sw;
    sw = tb_to_switch(dev);
    if (sw && sw.authorized) {
    int ret;
// First children
    ret = device_for_each_child_reverse(&sw.dev, core::ptr::null_mut(), disapprove_switch);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn tb_switch_set_authorized(sw: *mut tb_switch, val: c_uint) -> c_int {
    static int tb_switch_set_authorized(struct tb_switch *sw, unsigned int val)
    {
    char envp_string[13];
    let mut ret: c_int = -EINVAL;
    char *envp[] = { envp_string, core::ptr::null_mut() };
    if (!mutex_trylock(&sw.tb.lock))
    return restart_syscall();
...
// Disapprove switch
    case 0:
    if (tb_route(sw)) {
    ret = disapprove_switch(&sw.dev, core::ptr::null_mut());
    goto unlock;
    }
    break;
// Approve switch
...
//
    ...
    clear = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hex2bin(key, _arg: buf, _arg: sizeof(key))) -> else {
...
//
    static DEVICE_ATTR(rx_speed, 0444, speed_show, core::ptr::null_mut());
    static DEVICE_ATTR(tx_speed, 0444, speed_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(rx_lanes, 0444, rx_lanes_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(tx_lanes, 0444, tx_lanes_show, core::ptr::null_mut());
...
// Always clear the authentication status
    ...
    {
    let mut ret: c_int = nvm_authenticate_sysfs(dev, buf, false);
    if (ret)
    return ret;
    return count;
    }
    ...
    ret = -ENODATA;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !sw->nvm) -> else {
    else if (!sw.nvm)
    ret = -EAGAIN;
    else
...
#[no_mangle]
unsafe extern "C" fn tb_switch_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tb_switch_runtime_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_runtime_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_get_generation(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_exceeds_max_depth(sw: *const tb_switch, depth: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_configure(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_configuration_valid(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_set_uuid(sw: *mut tb_switch) -> c_int {
    static int tb_switch_set_uuid(struct tb_switch *sw)
    {
    let mut uid: bool = false;
    u32 uuid[4];
    int ret;
    if (sw.uuid)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn tb_switch_add_dma_port(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_default_link_ports(sw: *mut tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_lane_bonding_possible(sw: *mut tb_switch) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_update_link_attributes(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_link_init(sw: *mut tb_switch) {
...
//
#[no_mangle]
unsafe extern "C" fn tb_switch_lane_bonding_enable(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tb_switch_lane_bonding_disable(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_asym_enable(sw: *mut tb_switch, width: enum tb_link_width) -> c_int {
...
// Note updating sw->link_width done in tb_switch_update_link_attributes()
#[no_mangle]
unsafe extern "C" fn tb_switch_asym_disable(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_set_link_width(sw: *mut tb_switch, width: enum tb_link_width) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_configure_link(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_unconfigure_link(sw: *mut tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_credits_init(sw: *mut tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_port_hotplug_enable(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_add(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_remove(sw: *mut tb_switch) {
...
// port 0 is the switch itself and never has a remote
    ...
    port.remote = core::ptr::null_mut();
    } else if (port.xdomain) {
    port.xdomain.is_unplugged = true;
    tb_xdomain_remove(port.xdomain);
    port.xdomain = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_sw_set_unplugged(sw: *mut tb_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: port->xdomain) -> else {
    else if (port.xdomain)
    port.xdomain.is_unplugged = true;
    }
    }
#[no_mangle]
unsafe extern "C" fn tb_switch_set_wake(sw: *mut tb_switch, flags: c_uint, runtime: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_check_wakes(sw: *mut tb_switch) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_resume(sw: *mut tb_switch, runtime: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_suspend(sw: *mut tb_switch, runtime: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_query_dp_resource(sw: *mut tb_switch, in: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_alloc_dp_resource(sw: *mut tb_switch, in: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_dealloc_dp_resource(sw: *mut tb_switch, in: *mut tb_port) {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_match(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    lookup.link = link;
    lookup.depth = depth;
    dev = bus_find_device(&tb_bus_type, core::ptr::null_mut(), &lookup, tb_switch_match);
    if (dev)
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_pcie_l1_enable(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_xhci_connect(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_xhci_disconnect(sw: *mut tb_switch) {
