...
//! Source: drivers/thunderbolt/tmu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_enhanced_is_supported(sw: *const tb_switch) -> bool {
    ...
    let mut delta_avg: u32 = tmu_params[mode].delta_avg_const;
    ret = tb_sw_read(sw, &val, TB_CFG_SWITCH,
...
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_ucap_is_supported(sw: *mut tb_switch) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_rate_read(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_rate_write(sw: *mut tb_switch, rate: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tb_port_tmu_unidirectional_disable(port: *mut tb_port) -> c_int {
    static inline int tb_port_tmu_unidirectional_disable(struct tb_port *port)
    {
    return tb_port_tmu_set_unidirectional(port, false);
    }
#[no_mangle]
pub unsafe extern "C" fn tb_port_tmu_unidirectional_enable(port: *mut tb_port) -> c_int {
    static inline int tb_port_tmu_unidirectional_enable(struct tb_port *port)
    {
    return tb_port_tmu_set_unidirectional(port, true);
    }
#[no_mangle]
unsafe extern "C" fn tb_port_tmu_is_unidirectional(port: *mut tb_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tb_port_tmu_is_enhanced(port: *mut tb_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tb_port_tmu_enhanced_enable(port: *mut tb_port, enable: bool) -> c_int {
...
// Can be called to non-v2 lane adapters too
#[no_mangle]
unsafe extern "C" fn tb_port_tmu_rate_write(port: *mut tb_port, rate: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_port_tmu_time_sync(port: *mut tb_port, time_sync: bool) -> c_int {
    static int tb_port_tmu_time_sync(struct tb_port *port, bool time_sync)
    {
    let mut val: u32 = time_sync ? TMU_ADP_CS_6_DTS : 0;
    return tb_port_tmu_write(port, TMU_ADP_CS_6, TMU_ADP_CS_6_DTS, val);
    }
#[no_mangle]
unsafe extern "C" fn tb_port_tmu_time_sync_disable(port: *mut tb_port) -> c_int {
    static int tb_port_tmu_time_sync_disable(struct tb_port *port)
    {
    return tb_port_tmu_time_sync(port, true);
    }
#[no_mangle]
unsafe extern "C" fn tb_port_tmu_time_sync_enable(port: *mut tb_port) -> c_int {
    static int tb_port_tmu_time_sync_enable(struct tb_port *port)
    {
    return tb_port_tmu_time_sync(port, false);
    }
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_set_time_disruption(sw: *mut tb_switch, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmu_mode_init(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(rate: tmu_rates[TB_SWITCH_TMU_MODE_HIFI_UNI] ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_tmu_init(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_tmu_post_time(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disable_enhanced(up: *mut tb_port, down: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_tmu_disable(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_off(sw: *mut tb_switch) {
    static void tb_switch_tmu_off(struct tb_switch *sw)
    {
    let mut rate: c_uint = tmu_rates[TB_SWITCH_TMU_MODE_OFF];
    struct tb_port *down, *up;
    down = tb_switch_downstream_port(sw);
    up = tb_upstream_port(sw);
//
...
//
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_enable_bidirectional(sw: *mut tb_switch) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_disable_objections(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_enable_unidirectional(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_enable_enhanced(sw: *mut tb_switch) -> c_int {
    static int tb_switch_tmu_enable_enhanced(struct tb_switch *sw)
    {
    let mut rate: c_uint = tmu_rates[sw.tmu.mode_request];
    struct tb_port *up, *down;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_change_mode_prev(sw: *mut tb_switch) {
    static void tb_switch_tmu_change_mode_prev(struct tb_switch *sw)
    {
    let mut rate: c_uint = tmu_rates[sw.tmu.mode];
    struct tb_port *down, *up;
    down = tb_switch_downstream_port(sw);
    up = tb_upstream_port(sw);
//
...
#[no_mangle]
unsafe extern "C" fn tb_switch_tmu_change_mode(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_tmu_enable(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_tmu_configure(sw: *mut tb_switch, mode: enum tb_switch_tmu_mode) -> c_int {
