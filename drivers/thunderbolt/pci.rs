...
//! Source: drivers/thunderbolt/pci.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_check_quirks(nhi_pci: *mut tb_nhi_pci) {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_check_iommu_pdev(pdev: *mut pci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_check_iommu(nhi_pci: *mut tb_nhi_pci) {
    static void nhi_pci_check_iommu(struct tb_nhi_pci *nhi_pci)
    {
    struct tb_nhi *nhi = &nhi_pci.nhi;
    struct pci_dev *pdev = to_pci_dev(nhi.dev);
    struct pci_bus *bus = pdev.bus;
    let mut port_ok: bool = false;
//
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_init_msi(nhi: *mut tb_nhi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_imr_valid(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_start_dma_port(nhi: *mut tb_nhi) {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_complete_dma_port(nhi: *mut tb_nhi) {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_ring_request_msix(ring: *mut tb_ring, no_suspend: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_ring_release_msix(ring: *mut tb_ring) {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_release_irq(nhi: *mut tb_nhi) {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_is_present(nhi: *mut tb_nhi) -> bool {
...
#[no_mangle]
unsafe extern "C" fn check_for_device(dev: *mut device, data: *mut c_void) -> c_int {
    static int check_for_device(struct device *dev, void *data)
    {
    return tb_is_switch(dev);
    }
#[no_mangle]
unsafe extern "C" fn icl_nhi_is_device_connected(nhi: *mut tb_nhi) -> bool {
    static bool icl_nhi_is_device_connected(struct tb_nhi *nhi)
    {
    struct tb *tb = dev_get_drvdata(nhi.dev);
    int ret;
    ret = device_for_each_child(&tb.root_switch.dev, core::ptr::null_mut(),
    check_for_device);
    return ret > 0;
    }
#[no_mangle]
unsafe extern "C" fn icl_nhi_force_power(nhi: *mut tb_nhi, power: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icl_nhi_lc_mailbox_cmd(nhi: *mut tb_nhi, cmd: enum icl_lc_mailbox_cmd) {
...
#[no_mangle]
unsafe extern "C" fn icl_nhi_lc_mailbox_cmd_complete(nhi: *mut tb_nhi, timeout: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icl_nhi_set_ltr(nhi: *mut tb_nhi) {
...
#[no_mangle]
unsafe extern "C" fn icl_nhi_suspend(nhi: *mut tb_nhi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icl_nhi_suspend_noirq(nhi: *mut tb_nhi, wakeup: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icl_nhi_resume(nhi: *mut tb_nhi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn icl_nhi_shutdown(nhi: *mut tb_nhi) {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_do_remove(pdev: *mut pci_dev, reset: bool) {
...
#[no_mangle]
unsafe extern "C" fn nhi_pci_remove(pdev: *mut pci_dev) {
    static void nhi_pci_remove(struct pci_dev *pdev)
    {
    nhi_pci_do_remove(pdev, false);
    }
#[no_mangle]
unsafe extern "C" fn nhi_pci_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nhi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn nhi_unload() -> void __exit {
