...
//! Source: drivers/thunderbolt/debugfs.c
#![no_std]
...
pub const PORT_CAP_V1_PCIE_LEN: c_int = 1;
pub const PORT_CAP_V2_PCIE_LEN: c_int = 2;
pub const PORT_CAP_POWER_LEN: c_int = 2;
pub const PORT_CAP_LANE_LEN: c_int = 3;
pub const PORT_CAP_USB3_LEN: c_int = 5;
pub const PORT_CAP_DP_V1_LEN: c_int = 9;
pub const PORT_CAP_DP_V2_LEN: c_int = 14;
pub const PORT_CAP_TMU_V1_LEN: c_int = 8;
pub const PORT_CAP_TMU_V2_LEN: c_int = 10;
pub const PORT_CAP_BASIC_LEN: c_int = 9;
pub const PORT_CAP_USB4_LEN: c_int = 20;
pub const SWITCH_CAP_TMU_LEN: c_int = 26;
pub const SWITCH_CAP_BASIC_LEN: c_int = 27;
pub const PATH_LEN: c_int = 2;
pub const COUNTER_SET_LEN: c_int = 3;
//
// USB4 spec doesn't specify dwell range, the range of 100 ms to 500 ms
// probed to give good results.
//

pub const DWELL_SAMPLE_INTERVAL: c_int = 10;
...
pub const SB_MAX_SIZE: c_int = 64;
...
// Sideband registers for retimer
    ...
    DEBUGFS_ATTR(__space, core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn path_write_one(port: *mut tb_port, val: u32, offset: u32) -> c_int {
    static int path_write_one(struct tb_port *port, u32 val, u32 offset)
    {
    let mut index: u32 = offset % PATH_LEN;
    let mut offs: u32 = offset - index;
    u32 data[PATH_LEN];
    int ret;
...
// User did hardware changes behind the driver's back
    ...
    return regs_write(sw, core::ptr::null_mut(), TB_CFG_SWITCH, user_buf, count, ppos);
    }
...
pub const DEBUGFS_MODE: c_int = 0600;

pub const DEBUGFS_MODE: c_int = 0400;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tb_margining {
    pub port: *mut tb_port,
    pub target: enum usb4_sb_target,
    pub index: u8,
    pub dev: *mut device,
    pub gen: c_uint,
    pub asym_rx: bool,
    pub caps: [u32; 3],
    pub results: [u32; 3],
    pub lanes: enum usb4_margining_lane,
    pub min_ber_level: c_uint,
    pub max_ber_level: c_uint,
    pub ber_level: c_uint,
    pub voltage_steps: c_uint,
    pub max_voltage_offset: c_uint,
    pub voltage_steps_optional_range: c_uint,
    pub max_voltage_offset_optional_range: c_uint,
    pub time_steps: c_uint,
    pub max_time_offset: c_uint,
    pub voltage_time_offset: c_uint,
    pub dwell_time: c_uint,
    pub error_counter: enum usb4_margin_sw_error_counter,
    ...
    {
    let mut params: usb4_port_margining_params = { 0 };
...
#[no_mangle]
unsafe extern "C" fn supports_software(margining: *const tb_margining) -> bool {
...
#[no_mangle]
unsafe extern "C" fn supports_hardware(margining: *const tb_margining) -> bool {
...
#[no_mangle]
unsafe extern "C" fn all_lanes(margining: *const tb_margining) -> bool {
...
#[no_mangle]
unsafe extern "C" fn supports_time(margining: *const tb_margining) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ber_level_show(s: *mut seq_file, val: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn margining_ber_level_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn margining_caps_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn margining_lanes_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "clear")) -> else {
    else if (!strcmp(buf, "clear"))
    error_counter = USB4_MARGIN_SW_ERROR_COUNTER_CLEAR;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "start")) -> else {
    else if (!strcmp(buf, "start"))
    error_counter = USB4_MARGIN_SW_ERROR_COUNTER_START;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "stop")) -> else {
...
#[no_mangle]
unsafe extern "C" fn margining_error_counter_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn margining_dwell_time_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn margining_mode_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
    ...
    {
    let mut nsamples: u32 = margining.dwell_time / DWELL_SAMPLE_INTERVAL;
    int ret, i;
    ...
    margining.results[1]);
#[no_mangle]
pub unsafe extern "C" fn if(USB4_MARGINING_LANE_RX1: margining->lanes ==) -> else {
    else if (margining.lanes == USB4_MARGINING_LANE_RX1)
    errors = FIELD_GET(USB4_MARGIN_SW_ERR_COUNTER_LANE_1_MASK,
    margining.results[1]);
#[no_mangle]
pub unsafe extern "C" fn if(USB4_MARGINING_LANE_RX2: margining->lanes ==) -> else {
    else if (margining.lanes == USB4_MARGINING_LANE_RX2)
    errors = FIELD_GET(USB4_MARGIN_SW_ERR_COUNTER_LANE_2_MASK,
    margining.results[1]);
#[no_mangle]
pub unsafe extern "C" fn if(USB4_MARGINING_LANE_ALL: margining->lanes ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn validate_margining(margining: *mut tb_margining) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn margining_run_write(data: *mut c_void, val: u64) -> c_int {
    ...
    down_sw = sw;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: port->remote) -> else {
    else if (port.remote)
    down_sw = port.remote.sw;
    else
    down_sw = core::ptr::null_mut();
    if (down_sw) {
//
...
// Clear the results
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(margining_run_fops, core::ptr::null_mut(), margining_run_write,
    "%llu\n");
...
// Clear the error counters
    ...
    val = results[1];
#[no_mangle]
pub unsafe extern "C" fn if(USB4_MARGINING_LANE_RX1: lane ==) -> else {
    else if (lane == USB4_MARGINING_LANE_RX1)
    val = results[1] >> USB4_MARGIN_HW_RES_LANE_SHIFT;
#[no_mangle]
pub unsafe extern "C" fn if(USB4_MARGINING_LANE_RX2: lane ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn margining_results_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
// Only the hardware margining has two result dwords
    ...
    margining.time = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "voltage")) -> else {
...
#[no_mangle]
unsafe extern "C" fn margining_test_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "right")) -> else {
    ...
    margining.right_high = false;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "high")) -> else {
...
#[no_mangle]
unsafe extern "C" fn margining_margin_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "upper")) -> else {
...
#[no_mangle]
unsafe extern "C" fn margining_eye_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn margining_port_init(port: *mut tb_port) {
...
#[no_mangle]
unsafe extern "C" fn margining_port_remove(port: *mut tb_port) {
    ...
    port.usb4.margining = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn margining_switch_init(sw: *mut tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn margining_switch_remove(sw: *mut tb_switch) {
...
#[no_mangle]
unsafe extern "C" fn margining_xdomain_init(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn margining_xdomain_remove(xd: *mut tb_xdomain) {
...
#[no_mangle]
unsafe extern "C" fn margining_retimer_init(rt: *mut tb_retimer, debugfs_dir: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn margining_retimer_remove(rt: *mut tb_retimer) {
    static void margining_retimer_remove(struct tb_retimer *rt)
    {
    kfree(rt.margining);
    rt.margining = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn port_clear_all_counters(port: *mut tb_port) -> c_int {
...
// If written delimiter only, clear all counters in one shot
    ...
    cap_show(s, core::ptr::null_mut(), port, cap, header.basic.cap, vsec_id, length);
    }
#[no_mangle]
unsafe extern "C" fn port_caps_show(port: *mut tb_port, s: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn port_basic_regs_show(port: *mut tb_port, s: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_regs_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
    ...
    cap_show(s, sw, core::ptr::null_mut(), cap, header.basic.cap, vsec_id, length);
    }
#[no_mangle]
unsafe extern "C" fn switch_caps_show(sw: *mut tb_switch, s: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn switch_basic_regs_show(sw: *mut tb_switch, s: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn switch_regs_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn path_show_one(port: *mut tb_port, s: *mut seq_file, hopid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn path_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn counters_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_sb_regs_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_debugfs_init(sw: *mut tb_switch) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_switch_debugfs_remove(sw: *mut tb_switch) {
...
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_debugfs_init(xd: *mut tb_xdomain) {
    void tb_xdomain_debugfs_init(struct tb_xdomain *xd)
    {
    margining_xdomain_init(xd);
    }
#[no_mangle]
pub unsafe extern "C" fn tb_xdomain_debugfs_remove(xd: *mut tb_xdomain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_service_debugfs_init(svc: *mut tb_service) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_service_debugfs_remove(svc: *mut tb_service) {
    void tb_service_debugfs_remove(struct tb_service *svc)
    {
    debugfs_remove_recursive(svc.debugfs_dir);
    svc.debugfs_dir = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn retimer_sb_regs_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_retimer_debugfs_init(rt: *mut tb_retimer) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_retimer_debugfs_remove(rt: *mut tb_retimer) {
...
#[no_mangle]
pub unsafe extern "C" fn tb_debugfs_init() {
    void tb_debugfs_init(void)
    {
    tb_debugfs_root = debugfs_create_dir("thunderbolt", core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn tb_debugfs_exit() {
