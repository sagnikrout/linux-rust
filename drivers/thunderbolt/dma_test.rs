...
//! Source: drivers/thunderbolt/dma_test.c
#![no_std]
...
pub const DMA_TEST_TX_RING_SIZE: c_int = 64;
pub const DMA_TEST_RX_RING_SIZE: c_int = 256;

pub const DMA_TEST_DATA_PATTERN: c_uint = 0x0123456789abcdefLL;
pub const DMA_TEST_MAX_PACKETS: c_int = 1000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dma_test_frame {
    pub dma_test: *mut dma_test,
    pub data: *mut c_void,
...
pub struct dma_test {
    ...
    pub rx_ring: *mut tb_ring,
    pub rx_hopid: c_int,
    pub tx_ring: *mut tb_ring,
    pub tx_hopid: c_int,
    pub packets_to_send: c_uint,
    pub packets_to_receive: c_uint,
    pub packets_sent: c_uint,
    pub packets_received: c_uint,
    pub link_speed: c_uint,
    pub link_width: enum tb_link_width,
    pub crc_errors: c_uint,
    pub buffer_overflow_errors: c_uint,
    pub result: enum dma_test_result,
    pub error_code: enum dma_test_test_error,
...
#[no_mangle]
unsafe extern "C" fn dma_test_stop_rings(dt: *mut dma_test) {
...
#[no_mangle]
unsafe extern "C" fn dma_test_submit_rx(dt: *mut dma_test, npackets: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_test_submit_tx(dt: *mut dma_test, npackets: usize) -> c_int {
    ...
    __fops ## _store, "%llu\n")
#[no_mangle]
unsafe extern "C" fn lanes_get(dt: *const dma_test, val: *mut u64) {
    static void lanes_get(const struct dma_test *dt, u64 *val)
    {
// val = dt->link_width;
    }
#[no_mangle]
unsafe extern "C" fn lanes_validate(val: u64) -> c_int {
    static int lanes_validate(u64 val)
    {
    return val > 2 ? -EINVAL : 0;
    }
#[no_mangle]
unsafe extern "C" fn lanes_set(dt: *mut dma_test, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn speed_get(dt: *const dma_test, val: *mut u64) {
    static void speed_get(const struct dma_test *dt, u64 *val)
    {
// val = dt->link_speed;
    }
#[no_mangle]
unsafe extern "C" fn speed_validate(val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn speed_set(dt: *mut dma_test, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn packets_to_receive_get(dt: *const dma_test, val: *mut u64) {
    static void packets_to_receive_get(const struct dma_test *dt, u64 *val)
    {
// val = dt->packets_to_receive;
    }
#[no_mangle]
unsafe extern "C" fn packets_to_receive_validate(val: u64) -> c_int {
    static int packets_to_receive_validate(u64 val)
    {
    return val > DMA_TEST_MAX_PACKETS ? -EINVAL : 0;
    }
#[no_mangle]
unsafe extern "C" fn packets_to_receive_set(dt: *mut dma_test, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn packets_to_send_get(dt: *const dma_test, val: *mut u64) {
    static void packets_to_send_get(const struct dma_test *dt, u64 *val)
    {
// val = dt->packets_to_send;
    }
#[no_mangle]
unsafe extern "C" fn packets_to_send_validate(val: u64) -> c_int {
    static int packets_to_send_validate(u64 val)
    {
    return val > DMA_TEST_MAX_PACKETS ? -EINVAL : 0;
    }
#[no_mangle]
unsafe extern "C" fn packets_to_send_set(dt: *mut dma_test, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn dma_test_set_bonding(dt: *mut dma_test) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_test_validate_config(dt: *mut dma_test) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dma_test_check_errors(dt: *mut dma_test, ret: c_int) {
...
#[no_mangle]
unsafe extern "C" fn test_store(data: *mut c_void, val: u64) -> c_int {
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(test_fops, core::ptr::null_mut(), test_store, "%llu\n");
#[no_mangle]
unsafe extern "C" fn status_show(s: *mut seq_file, not_used: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_test_debugfs_init(svc: *mut tb_service) {
...
#[no_mangle]
unsafe extern "C" fn dma_test_probe(svc: *mut tb_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_test_remove(svc: *mut tb_service) {
...
#[no_mangle]
unsafe extern "C" fn dma_test_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dma_test_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn dma_test_init() -> int __init {
    static int __init dma_test_init(void)
    {
    let mut data_value: u64 = DMA_TEST_DATA_PATTERN;
    int i, ret;
...
#[no_mangle]
unsafe extern "C" fn dma_test_exit() -> void __exit {
