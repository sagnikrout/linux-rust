...
//! Source: drivers/thunderbolt/property.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tb_property_rootdir_entry {
    pub magic: u32,
    pub length: u32,
    pub entries: [tb_property_entry; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tb_property_dir_entry {
    pub uuid: [u32; 4],
    pub entries: [tb_property_entry; ],
}

pub const TB_PROPERTY_ROOTDIR_MAGIC: c_uint = 0x55584401;
pub const TB_PROPERTY_MAX_DEPTH: c_int = 8;
    static struct tb_property_dir *__tb_property_parse_dir(const u32 *block,
    size_t block_len, unsigned int dir_offset, size_t dir_len,
    bool is_root, unsigned int depth);
    static struct tb_property *tb_property_copy(const struct tb_property *property);
#[no_mangle]
pub unsafe extern "C" fn parse_dwdata(dst: *mut c_void, src: *const c_void, dwords: usize) {
    static inline void parse_dwdata(void *dst, const void *src, size_t dwords)
    {
    be32_to_cpu_array(dst, src, dwords);
    }
#[no_mangle]
pub unsafe extern "C" fn format_dwdata(dst: *mut c_void, src: *const c_void, dwords: usize) {
...
#[no_mangle]
unsafe extern "C" fn tb_property_key_valid(key: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tb_property_free(property: *mut tb_property) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_property_free_dir(dir: *mut tb_property_dir) {
...
// Need to pad to dword boundary
    let mut size: usize = round_up(buflen, 4);
    struct tb_property *property;
    if (!tb_property_key_valid(key))
    return -EINVAL;
...
//
    ...
    {
// Need to pad to dword boundary
    let mut size: usize = round_up(strlen(text) + 1, 4);
    struct tb_property *property;
    if (!tb_property_key_valid(key))
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_property_remove(property: *mut tb_property) {
