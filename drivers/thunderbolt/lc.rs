...
//! Source: drivers/thunderbolt/lc.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_read_uuid(sw: *mut tb_switch, uuid: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_lc_desc(sw: *mut tb_switch, desc: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn find_port_lc_cap(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_reset_port(port: *mut tb_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_lc_set_port_configured(port: *mut tb_port, configured: bool) -> c_int {
    static int tb_lc_set_port_configured(struct tb_port *port, bool configured)
    {
    let mut upstream: bool = tb_is_upstream_port(port);
    struct tb_switch *sw = port.sw;
    u32 ctrl, lane;
    int cap, ret;
    if (sw.generation < 2)
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_configure_port(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_unconfigure_port(port: *mut tb_port) {
    void tb_lc_unconfigure_port(struct tb_port *port)
    {
    tb_lc_set_port_configured(port, false);
    }
#[no_mangle]
unsafe extern "C" fn tb_lc_set_xdomain_configured(port: *mut tb_port, configure: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_configure_xdomain(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_unconfigure_xdomain(port: *mut tb_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_start_lane_initialization(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_is_clx_supported(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_is_usb_plugged(port: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_is_xhci_connected(port: *mut tb_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn __tb_lc_xhci_connect(port: *mut tb_port, connect: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_xhci_connect(port: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_xhci_disconnect(port: *mut tb_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_set_wake(sw: *mut tb_switch, flags: c_uint) -> c_int {
...
// For each link controller set sleep bit
    for (i = 0; i < nlc; i++) {
    let mut offset: c_uint = sw.cap_lc + start + i * size;
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_set_sleep(sw: *mut tb_switch) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_lane_bonding_possible(sw: *mut tb_switch) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tb_lc_dp_sink_available(sw: *mut tb_switch, sink: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_dp_sink_query(sw: *mut tb_switch, in: *mut tb_port) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_dp_sink_alloc(sw: *mut tb_switch, in: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_dp_sink_dealloc(sw: *mut tb_switch, in: *mut tb_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_lc_force_power(sw: *mut tb_switch) -> c_int {
    int tb_lc_force_power(struct tb_switch *sw)
    {
    let mut in: u32 = 0xffff;
