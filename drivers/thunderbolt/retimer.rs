...
//! Source: drivers/thunderbolt/retimer.c
#![no_std]
...
pub const TB_MAX_RETIMER_INDEX: c_int = 6;

pub const TB_MAX_RETIMER_INDEX: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn tb_retimer_nvm_add(rt: *mut tb_retimer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_retimer_nvm_validate_and_write(rt: *mut tb_retimer) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_retimer_nvm_authenticate(rt: *mut tb_retimer, auth_only: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tb_retimer_nvm_authenticate_status(port: *mut tb_port, status: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn tb_retimer_set_inbound_sbtx(port: *mut tb_port) {
...
#[no_mangle]
unsafe extern "C" fn tb_retimer_unset_inbound_sbtx(port: *mut tb_port) {
...
#[no_mangle]
unsafe extern "C" fn tb_retimer_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn tb_retimer_remove(rt: *mut tb_retimer) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tb_retimer_lookup {
    pub port: *const tb_port,
    pub index: u8,
}

#[no_mangle]
unsafe extern "C" fn retimer_match(dev: *mut device, data: *const c_void) -> c_int {
    ...
    {
    let mut lookup: tb_retimer_lookup = { .port = port, .index = index };
    struct device *dev;
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_retimer_scan(port: *mut tb_port, add: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_retimer(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tb_retimer_remove_all(port: *mut tb_port) {
