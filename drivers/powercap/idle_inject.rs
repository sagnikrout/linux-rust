...
//! Source: drivers/powercap/idle_inject.c
#![no_std]
...
pub struct idle_inject_device {
    pub timer: hrtimer,
    pub idle_duration_us: c_uint,
    pub run_duration_us: c_uint,
    pub latency_us: c_uint,
    pub (*update)(void): *mut bool,
    pub cpumask: [c_ulong; ],
}
...
//
#[no_mangle]
unsafe extern "C" fn idle_inject_wakeup(ii_dev: *mut idle_inject_device) {
...
//
#[no_mangle]
unsafe extern "C" fn idle_inject_fn(cpu: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn idle_inject_start(ii_dev: *mut idle_inject_device) -> c_int {
    int idle_inject_start(struct idle_inject_device *ii_dev)
    {
    let mut idle_duration_us: c_uint = READ_ONCE(ii_dev.idle_duration_us);
    let mut run_duration_us: c_uint = READ_ONCE(ii_dev.run_duration_us);
...
//
#[no_mangle]
pub unsafe extern "C" fn idle_inject_stop(ii_dev: *mut idle_inject_device) {
...
//
#[no_mangle]
unsafe extern "C" fn idle_inject_setup(cpu: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn idle_inject_should_run(cpu: c_uint) -> c_int {
...
//
    ...
    if (cpu == cpu_rb)
    break;
    per_cpu(idle_inject_device, cpu_rb) = core::ptr::null_mut();
    }
    kfree(ii_dev);
    return core::ptr::null_mut();
    }
...
//
    ...
    {
    return idle_inject_register_full(cpumask, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn idle_inject_unregister(ii_dev: *mut idle_inject_device) {
    void idle_inject_unregister(struct idle_inject_device *ii_dev)
    {
    unsigned int cpu;
    idle_inject_stop(ii_dev);
    for_each_cpu(cpu, to_cpumask(ii_dev.cpumask))
    per_cpu(idle_inject_device, cpu) = core::ptr::null_mut();
    kfree(ii_dev);
    }
...
#[no_mangle]
unsafe extern "C" fn idle_inject_init() -> int __init {
