...
//! Source: drivers/powercap/dtpm_devfreq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __dtpm_devfreq_setup(devfreq: *mut devfreq, parent: *mut dtpm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dtpm_devfreq_setup(dtpm: *mut dtpm, np: *mut device_node) -> c_int {
