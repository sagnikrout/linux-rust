...
//! Source: drivers/powercap/intel_rapl_tpmi.c
#![no_std]
...
pub const TPMI_RAPL_MAJOR_VERSION: c_int = 0;
pub const TPMI_RAPL_MINOR_VERSION: c_int = 1;
// 1 header + 10 registers + 5 reserved. 8 bytes for each.
pub const TPMI_RAPL_DOMAIN_SIZE: c_int = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpmi_rapl_package {
    pub priv: rapl_if_priv,
    pub tpmi_info: *mut oobmsm_plat_info,
...
#[no_mangle]
unsafe extern "C" fn tpmi_rapl_read_raw(id: c_int, ra: *mut reg_action, atomic: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpmi_rapl_write_raw(id: c_int, ra: *mut reg_action) -> c_int {
    ...
    tpmi_control_type = powercap_register_control_type(core::ptr::null_mut(), "intel-rapl", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn trp_release(trp: *mut tpmi_rapl_package) {
...
#[no_mangle]
unsafe extern "C" fn parse_one_domain(trp: *mut tpmi_rapl_package, offset: u32) -> c_int {
    ...
    let mut tpmi_domain_header: u64 = readq(trp.base + offset);
...
pub const TPMI_ENERGY_UNIT_SCALE: c_int = 1000;
pub const TPMI_POWER_UNIT_OFFSET: c_uint = 0x00;

pub const TPMI_ENERGY_UNIT_OFFSET: c_uint = 0x06;

pub const TPMI_TIME_UNIT_OFFSET: c_uint = 0x0C;

#[no_mangle]
unsafe extern "C" fn rapl_check_unit_tpmi(rd: *mut rapl_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_rapl_tpmi_remove(auxdev: *mut auxiliary_device) {
