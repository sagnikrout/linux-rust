...
//! Source: drivers/powercap/intel_rapl_common.c
#![no_std]
...
pub const RAPL_CNTR_WIDTH: c_int = 32;
pub const POWER_UNIT_OFFSET: c_uint = 0x00;

pub const ENERGY_UNIT_OFFSET: c_uint = 0x08;

pub const TIME_UNIT_OFFSET: c_uint = 0x10;
...
#[no_mangle]
unsafe extern "C" fn is_pl_valid(rd: *mut rapl_domain, pl: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn get_pl_lock_prim(rd: *mut rapl_domain, pl: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_pl_prim(rd: *mut rapl_domain, pl: c_int, prim: enum pl_prims) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_max_energy_counter(pcd_dev: *mut powercap_zone, energy: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_zone(power_zone: *mut powercap_zone) -> c_int {
...
//
    ...
    kfree(rd);
    rp.domains = core::ptr::null_mut();
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn find_nr_power_limit(rd: *mut rapl_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_domain_enable(power_zone: *mut powercap_zone, mode: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_domain_enable(power_zone: *mut powercap_zone, mode: *mut bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn contraint_to_pl(rd: *mut rapl_domain, cid: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_max_power(power_zone: *mut powercap_zone, cid: c_int, data: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_rid(rp: *mut rapl_package) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rapl_init_domains(rp: *mut rapl_package) {
    static void rapl_init_domains(struct rapl_package *rp)
    {
    ...
    let mut mask: c_uint = rp.domain_map & (1 << i);
    int t;
    if (!mask)
    continue;
    rd.rp = rp;
...
#[no_mangle]
unsafe extern "C" fn rapl_config(rp: *mut rapl_package) -> c_int {
...
//
    ...
    {
    u64 value;
    let mut prim_fixed: enum rapl_primitives = prim_fixups(rd, prim);
...
// Similar use of primitive info in the read counterpart
    ...
    {
    let mut prim: enum rapl_primitives = get_pl_prim(rd, pl, pl_prim);
...
//
#[no_mangle]
pub unsafe extern "C" fn rapl_default_check_unit(rd: *mut rapl_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_limit_irq_save_cpu(info: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn package_power_limit_irq_save(rp: *mut rapl_package) {
    static void package_power_limit_irq_save(struct rapl_package *rp)
    {
    if (rp.lead_cpu < 0)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn package_power_limit_irq_restore(rp: *mut rapl_package) {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_default_set_floor_freq(rd: *mut rapl_domain, mode: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_default_compute_time_window(rd: *mut rapl_domain, value: u64, to_raw: bool) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn rapl_update_domain_data(rp: *mut rapl_package) {
...
#[no_mangle]
unsafe extern "C" fn rapl_package_register_powercap(rp: *mut rapl_package) -> c_int {
    static int rapl_package_register_powercap(struct rapl_package *rp)
    {
    struct rapl_domain *rd;
    struct powercap_zone *power_zone = core::ptr::null_mut();
    int nr_pl, ret;
...
// first we register package domain as the parent zone
    ...
    core::ptr::null_mut(), &zone_ops[rd.id], nr_pl,
    &constraint_ops);
...
#[no_mangle]
unsafe extern "C" fn rapl_check_domain(domain: c_int, rp: *mut rapl_package) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rapl_get_domain_unit(rd: *mut rapl_domain) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rapl_detect_powerlimit(rd: *mut rapl_domain) {
    ...
    rd.rpl[i].name = core::ptr::null_mut();
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn rapl_detect_domains(rp: *mut rapl_package) -> c_int {
...
#[derive(Copy, Clone)]
pub struct rapl_pmu {
    pub /: *mut *mut pmu pmu; / Perf PMU structure,
    pub /: *mut *mut u64 timer_ms; / Maximum expiration time to avoid counter overflow,
    pub /: *mut *mut unsigned long domain_map; / Events supported by current registered PMU,
    pub /: *mut *mut bool registered; / Whether the PMU has been registered or not,
}

    static struct rapl_pmu rapl_pmu;
// PMU helpers
#[no_mangle]
unsafe extern "C" fn set_pmu_cpumask(rp: *mut rapl_package, mask: cpumask_var_t) {
...
#[no_mangle]
unsafe extern "C" fn is_rp_pmu_cpu(rp: *mut rapl_package, cpu: c_int) -> bool {
...
// PMU event callbacks
#[no_mangle]
unsafe extern "C" fn event_read_counter(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn __rapl_pmu_event_start(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn rapl_pmu_event_start(event: *mut perf_event, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rapl_event_update(event: *mut perf_event) -> u64 {
    ...
    s64 delta, sdelta;
    let mut shift: c_int = 64 - RAPL_CNTR_WIDTH;
//
...
#[no_mangle]
unsafe extern "C" fn rapl_pmu_event_stop(event: *mut perf_event, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rapl_pmu_event_add(event: *mut perf_event, mode: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rapl_pmu_event_del(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rapl_pmu_event_init(event: *mut perf_event) -> c_int {
    static int rapl_pmu_event_init(struct perf_event *event)
    {
    struct rapl_package *pos, *rp = core::ptr::null_mut();
    let mut cfg: u64 = event.attr.config & RAPL_EVENT_MASK;
    int domain, idx;
...
#[no_mangle]
unsafe extern "C" fn rapl_pmu_event_read(event: *mut perf_event) {
    static void rapl_pmu_event_read(struct perf_event *event)
    {
    rapl_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn rapl_hrtimer_handle(hrtimer: *mut hrtimer) -> enum hrtimer_restart {
...
// Choose a cpu for each RAPL Package
    ...
    .attr		= __ATTR(_name, 0444, perf_event_sysfs_show, core::ptr::null_mut()),	\
    .event_str	= str,							\
    }
...
#[no_mangle]
unsafe extern "C" fn rapl_pmu_update(rp: *mut rapl_package) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_package_add_pmu_locked(rp: *mut rapl_package) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_package_add_pmu(rp: *mut rapl_package) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_package_remove_pmu_locked(rp: *mut rapl_package) {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_package_remove_pmu(rp: *mut rapl_package) {
...
#[no_mangle]
pub unsafe extern "C" fn rapl_remove_package_cpuslocked(rp: *mut rapl_package) {
    void rapl_remove_package_cpuslocked(struct rapl_package *rp)
    {
    struct rapl_domain *rd, *rd_package = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn rapl_remove_package(rp: *mut rapl_package) {
...
#[no_mangle]
unsafe extern "C" fn power_limit_state_save() {
...
#[no_mangle]
unsafe extern "C" fn power_limit_state_restore() {
...
#[no_mangle]
unsafe extern "C" fn rapl_init() -> int __init {
    static int __init rapl_init(void)
    {
    return register_pm_notifier(&rapl_pm_notifier);
    }
#[no_mangle]
unsafe extern "C" fn rapl_exit() -> void __exit {
