...
//! Source: drivers/powercap/powercap_sys.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct powercap_constraint_attr {
    pub power_limit_attr: device_attribute,
    pub time_window_attr: device_attribute,
    pub max_power_attr: device_attribute,
    pub min_power_attr: device_attribute,
    pub max_time_window_attr: device_attribute,
    pub min_time_window_attr: device_attribute,
...
#[no_mangle]
unsafe extern "C" fn free_constraint_attributes() {
...
#[no_mangle]
unsafe extern "C" fn seed_constraint_attributes() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn control_type_valid(control_type: *mut c_void) -> bool {
    static bool control_type_valid(void *control_type)
    {
    struct powercap_control_type *pos = core::ptr::null_mut();
...
// Create zone and attributes in sysfs
    ...
    power_zone.zone_dev_attrs[count] = core::ptr::null_mut();
    power_zone.zone_attr_count = count;
    }
#[no_mangle]
unsafe extern "C" fn powercap_release(dev: *mut device) {
...
// Using idr to get the unique id
    result = idr_alloc(power_zone.parent_idr, core::ptr::null_mut(), 0, 0, GFP_KERNEL);
    if (result < 0)
    goto err_idr_alloc;
    ...
    if (result)
    goto err_dev_ret;
    power_zone.zone_dev_attrs[power_zone.zone_attr_count] = core::ptr::null_mut();
    power_zone.dev_zone_attr_group.attrs = power_zone.zone_dev_attrs;
    power_zone.dev_attr_groups[0] = &power_zone.dev_zone_attr_group;
    power_zone.dev_attr_groups[1] = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn powercap_unregister_control_type(control_type: *mut powercap_control_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn powercap_init() -> int __init {
