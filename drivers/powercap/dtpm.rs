...
//! Source: drivers/powercap/dtpm.c
#![no_std]
...
pub const DTPM_POWER_LIMIT_FLAG: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn get_time_window_us(pcz: *mut powercap_zone, cid: c_int, window: *mut u64) -> c_int {
    static int get_time_window_us(struct powercap_zone *pcz, int cid, u64 *window)
    {
    return -ENOSYS;
    }
#[no_mangle]
unsafe extern "C" fn set_time_window_us(pcz: *mut powercap_zone, cid: c_int, window: u64) -> c_int {
    static int set_time_window_us(struct powercap_zone *pcz, int cid, u64 window)
    {
    return -ENOSYS;
    }
#[no_mangle]
unsafe extern "C" fn get_max_power_range_uw(pcz: *mut powercap_zone, max_power_uw: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __get_power_uw(dtpm: *mut dtpm, power_uw: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_power_uw(pcz: *mut powercap_zone, power_uw: *mut u64) -> c_int {
    static int get_power_uw(struct powercap_zone *pcz, u64 *power_uw)
    {
    return __get_power_uw(to_dtpm(pcz), power_uw);
    }
#[no_mangle]
unsafe extern "C" fn __dtpm_rebalance_weight(dtpm: *mut dtpm) {
...
#[no_mangle]
unsafe extern "C" fn __dtpm_sub_power(dtpm: *mut dtpm) {
...
#[no_mangle]
unsafe extern "C" fn __dtpm_add_power(dtpm: *mut dtpm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dtpm_update_power(dtpm: *mut dtpm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dtpm_release_zone(pcz: *mut powercap_zone) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __set_power_limit_uw(dtpm: *mut dtpm, cid: c_int, power_limit: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_max_power_uw(pcz: *mut powercap_zone, id: c_int, max_power: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dtpm_init(dtpm: *mut dtpm, ops: *mut dtpm_ops) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dtpm_unregister(dtpm: *mut dtpm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dtpm_register(name: *const c_char, dtpm: *mut dtpm, parent: *mut dtpm) -> c_int {
    ...
    parent ? &parent.zone : core::ptr::null_mut(),
    ...
    dtpm_init(dtpm, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn dtpm_create_hierarchy(dtpm_match_table: *mut of_device_id) -> c_int {
    ...
    pct = powercap_register_control_type(core::ptr::null_mut(), "dtpm", core::ptr::null_mut());
    if (IS_ERR(pct)) {
    ...
    ret = dtpm_for_each_child(hierarchy, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret)
    goto out_err;
    for (i = 0; i < ARRAY_SIZE(dtpm_subsys); i++) {
...
#[no_mangle]
unsafe extern "C" fn __dtpm_destroy_hierarchy(dtpm: *mut dtpm) {
...
#[no_mangle]
pub unsafe extern "C" fn dtpm_destroy_hierarchy() {
