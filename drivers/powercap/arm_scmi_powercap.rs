...
//! Source: drivers/powercap/arm_scmi_powercap.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_powercap_zone {
    pub registered: bool,
    pub invalid: bool,
    pub height: c_uint,
    pub dev: *mut device,
    pub ph: *mut scmi_protocol_handle,
    pub info: *const scmi_powercap_info,
    pub spzones: *mut scmi_powercap_zone,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_powercap_root {
    pub num_zones: c_uint,
    pub spzones: *mut scmi_powercap_zone,
    pub registered_zones: *mut list_head,
    pub scmi_zones: list_head,
}

    static struct powercap_control_type *scmi_top_pcntrl;
#[no_mangle]
unsafe extern "C" fn scmi_powercap_zone_release(pz: *mut powercap_zone) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_powercap_zone_enable_set(pz: *mut powercap_zone, mode: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_powercap_zone_enable_get(pz: *mut powercap_zone, mode: *mut bool) -> c_int {
    ...
    {
    let mut scale_mw: bool = spz.info.powercap_scale_mw;
    u64 val;
...
#[no_mangle]
unsafe extern "C" fn scmi_powercap_unregister_all_zones(pr: *mut scmi_powercap_root) {
...
//
    ...
    {
    let mut ret: c_int = 0;
    let mut sp: c_uint = 0, reg_zones = 0;
...
#[no_mangle]
unsafe extern "C" fn scmi_powercap_probe(sdev: *mut scmi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_powercap_remove(sdev: *mut scmi_device) {
...
#[no_mangle]
unsafe extern "C" fn scmi_powercap_init() -> int __init {
    static int __init scmi_powercap_init(void)
    {
    int ret;
    scmi_top_pcntrl = powercap_register_control_type(core::ptr::null_mut(), "arm-scmi", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn scmi_powercap_exit() -> void __exit {
