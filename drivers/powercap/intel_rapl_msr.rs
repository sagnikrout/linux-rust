...
//! Source: drivers/powercap/intel_rapl_msr.c
#![no_std]
...
// Local defines
pub const MSR_PLATFORM_POWER_LIMIT: c_uint = 0x0000065C;
...
pub const IOSF_CPU_POWER_BUDGET_CTL_BYT: c_uint = 0x02;
pub const IOSF_CPU_POWER_BUDGET_CTL_TNG: c_uint = 0xDF;
...
//
#[no_mangle]
unsafe extern "C" fn rapl_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rapl_cpu_down_prep(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rapl_msr_read_raw(cpu: c_int, ra: *mut reg_action, pmu_ctx: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rapl_msr_update_func(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rapl_msr_write_raw(cpu: c_int, ra: *mut reg_action) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rapl_check_unit_atom(rd: *mut rapl_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_floor_freq_atom(rd: *mut rapl_domain, enable: bool) {
...
// name, mask, shift, msr index, unit divisor
    ...
    .floor_freq_reg_addr = 0,
    .check_unit = rapl_check_unit_atom,
    .set_floor_freq = core::ptr::null_mut(),
    .compute_time_window = rapl_compute_time_window_atom,
    };
...
#[no_mangle]
unsafe extern "C" fn rapl_msr_probe(pdev: *mut platform_device) -> c_int {
    ...
    rapl_msr_priv.control_type = powercap_register_control_type(core::ptr::null_mut(), "intel-rapl", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rapl_msr_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn intel_rapl_msr_init() -> c_int {
...
// Create the MSR RAPL platform device for supported platforms
    ...
    rapl_msr_platdev = platform_device_register_data(core::ptr::null_mut(), "intel_rapl_msr", 0, def,
    sizeof(*def));
...
#[no_mangle]
unsafe extern "C" fn intel_rapl_msr_exit() {
