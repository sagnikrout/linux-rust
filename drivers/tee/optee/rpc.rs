...
//! Source: drivers/tee/optee/rpc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn handle_rpc_func_cmd_get_time(arg: *mut optee_msg_arg) {
...
#[no_mangle]
unsafe extern "C" fn handle_rpc_func_cmd_wait(arg: *mut optee_msg_arg) {
...
#[no_mangle]
pub unsafe extern "C" fn optee_rpc_cmd_free_suppl(ctx: *mut tee_context, shm: *mut tee_shm) {
...
//
    ...
    optee.rpmb_dev = core::ptr::null_mut();
    mutex_unlock(&optee.rpmb_dev_mutex);
    arg.ret = TEEC_SUCCESS;
    }
#[no_mangle]
unsafe extern "C" fn rpmb_type_to_rpc_type(rtype: enum rpmb_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpc_rpmb_match(dev: *mut device, data: *const c_void) -> c_int {
    ...
    mutex_lock(&optee.rpmb_dev_mutex);
    rdev = rpmb_dev_find_device(core::ptr::null_mut(), optee.rpmb_dev, rpc_rpmb_match);
    rpmb_dev_put(optee.rpmb_dev);
    optee.rpmb_dev = rdev;
    mutex_unlock(&optee.rpmb_dev_mutex);
    if (!rdev) {
