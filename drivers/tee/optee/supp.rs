...
//! Source: drivers/tee/optee/supp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn optee_supp_init(supp: *mut optee_supp) {
...
#[no_mangle]
pub unsafe extern "C" fn optee_supp_uninit(supp: *mut optee_supp) {
...
#[no_mangle]
pub unsafe extern "C" fn optee_supp_release(supp: *mut optee_supp) {
...
//
    ...
    struct optee_supp *supp = &optee.supp;
    struct optee_supp_req *req = core::ptr::null_mut();
    size_t num_meta;
    int rc;
