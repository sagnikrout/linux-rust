...
//! Source: drivers/tee/optee/ffa_abi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rh_free_fn(ptr: *mut c_void, arg: *mut c_void) {
    ...
    u64 global_id)
    {
    struct tee_shm *shm = core::ptr::null_mut();
    struct shm_rhash *r;
...
#[no_mangle]
unsafe extern "C" fn optee_shm_rem_ffa_handle(optee: *mut optee, global_id: u64) -> c_int {
...
//
    ...
    {
    struct tee_shm *shm = core::ptr::null_mut();
    let mut offs_high: u64 = 0;
    let mut offs_low: u64 = 0;
...
//
    ...
    if (shm) {
    let mut shm_offs: u64 = p.u.memref.shm_offs;
...
//
    ...
    const struct ffa_mem_ops *mem_ops = ffa_dev.ops.mem_ops;
    let mut global_handle: u64 = shm.sec_world_id;
...
#[no_mangle]
unsafe extern "C" fn pool_ffa_op_destroy_pool(pool: *mut tee_shm_pool) {
...
// Interrupt delivered by now
    ...
    let mut cmd: u32 = data.data0;
    let mut w4: u32 = data.data1;
    let mut w5: u32 = data.data2;
    let mut w6: u32 = data.data3;
    int rc;
// Initialize waiter
...
#[no_mangle]
unsafe extern "C" fn do_call_lend_protmem(optee: *mut optee, cookie: u64, use_case: u32) -> c_int {
    ...
    const struct ffa_msg_ops *msg_ops = ffa_dev.ops.msg_ops;
    const struct ffa_mem_ops *mem_ops = ffa_dev.ops.mem_ops;
    let mut global_handle: u64 = protmem.sec_world_id;
    struct ffa_send_direct_data data = {
    .data0 = OPTEE_FFA_RELEASE_PROTMEM,
    .data1 = (u32)global_handle,
    .data2 = (u32)(global_handle >> 32)
...
#[no_mangle]
unsafe extern "C" fn notif_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn notif_callback(notify_id: c_int, cb_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn enable_async_notif(optee: *mut optee) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn optee_ffa_open(ctx: *mut tee_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn optee_ffa_remove(ffa_dev: *mut ffa_device) {
    static void optee_ffa_remove(struct ffa_device *ffa_dev)
    {
    struct optee *optee = ffa_dev_get_drvdata(ffa_dev);
    let mut bottom_half_id: u32 = optee.ffa.bottom_half_value;
    ...
    rhashtable_free_and_destroy(&optee.ffa.global_ids, rh_free_fn, core::ptr::null_mut());
    kfree(optee);
    }
    static int optee_ffa_async_notif_init(struct ffa_device *ffa_dev,
    struct optee *optee)
    {
    let mut is_per_vcpu: bool = false;
...
#[no_mangle]
unsafe extern "C" fn optee_ffa_protmem_pool_init(optee: *mut optee, sec_caps: u32) -> c_int {
    static int optee_ffa_protmem_pool_init(struct optee *optee, u32 sec_caps)
    {
    let mut id: enum tee_dma_heap_id = TEE_DMA_HEAP_SECURE_VIDEO_PLAY;
...
#[no_mangle]
unsafe extern "C" fn optee_ffa_probe(ffa_dev: *mut ffa_device) -> c_int {
    ...
    teedev = tee_device_alloc(&optee_ffa_clnt_desc, core::ptr::null_mut(), optee.pool,
    optee);
    if (IS_ERR(teedev)) {
    rc = PTR_ERR(teedev);
    ...
    optee.teedev = teedev;
    teedev = tee_device_alloc(&optee_ffa_supp_desc, core::ptr::null_mut(), optee.pool,
    optee);
    if (IS_ERR(teedev)) {
    rc = PTR_ERR(teedev);
...
#[no_mangle]
pub unsafe extern "C" fn optee_ffa_abi_register() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn optee_ffa_abi_unregister() {
