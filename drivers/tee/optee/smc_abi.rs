...
#[no_mangle]
unsafe extern "C" fn optee_cpuhp_enable_pcpu_irq(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn optee_cpuhp_disable_pcpu_irq(cpu: c_uint) -> c_int {
...
//
    ...
    p.u.memref.shm = core::ptr::null_mut();
    return 0;
    }
...
//
    ...
    let mut attr: u32 = mp.attr & OPTEE_MSG_ATTR_TYPE_MASK;
    switch (attr) {
...
//
#[no_mangle]
unsafe extern "C" fn optee_enable_shm_cache(optee: *mut optee) {
...
//
#[no_mangle]
unsafe extern "C" fn __optee_disable_shm_cache(optee: *mut optee, is_mapped: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn optee_disable_shm_cache(optee: *mut optee) {
...
//
#[no_mangle]
unsafe extern "C" fn optee_disable_unmapped_shm_cache(optee: *mut optee) {
...
//
#[no_mangle]
unsafe extern "C" fn get_pages_list_size(num_entries: usize) -> usize {
    static size_t get_pages_list_size(size_t num_entries)
    {
    let mut pages: c_int = DIV_ROUND_UP(num_entries, PAGELIST_ENTRIES_PER_PAGE);
...
#[no_mangle]
unsafe extern "C" fn optee_free_pages_list(list: *mut c_void, num_entries: usize) {
...
#[no_mangle]
unsafe extern "C" fn optee_shm_unregister(ctx: *mut tee_context, shm: *mut tee_shm) -> c_int {
...
//
    ...
    return tee_dyn_shm_alloc_helper(shm, size, align, core::ptr::null_mut());
    ...
    tee_dyn_shm_free_helper(shm, core::ptr::null_mut());
    }
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn free_pages_list(call_ctx: *mut optee_call_ctx) {
    static void free_pages_list(struct optee_call_ctx *call_ctx)
    {
    if (call_ctx.pages_list) {
    optee_free_pages_list(call_ctx.pages_list,
    call_ctx.num_entries);
    call_ctx.pages_list = core::ptr::null_mut();
    call_ctx.num_entries = 0;
    }
    }
#[no_mangle]
unsafe extern "C" fn optee_rpc_finalize_call(call_ctx: *mut optee_call_ctx) {
...
//
    ...
    struct optee *optee = tee_get_drvdata(ctx.teedev);
    struct optee_call_waiter w;
    let mut param: optee_rpc_param = { };
    let mut call_ctx: optee_call_ctx = { };
    struct optee_msg_arg *rpc_arg = core::ptr::null_mut();
    int rc;
...
#[no_mangle]
unsafe extern "C" fn irq_handler(optee: *mut optee) -> irqreturn_t {
    static irqreturn_t irq_handler(struct optee *optee)
    {
    let mut do_bottom_half: bool = false;
    bool value_valid;
    bool value_pending;
    u32 value;
    do {
...
#[no_mangle]
unsafe extern "C" fn notif_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn notif_irq_thread_fn(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn init_irq(optee: *mut optee, irq: u_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn notif_pcpu_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn init_pcpu_irq(optee: *mut optee, irq: u_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn optee_smc_notif_init_irq(optee: *mut optee, irq: u_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uninit_pcpu_irq(optee: *mut optee) {
...
#[no_mangle]
unsafe extern "C" fn optee_smc_notif_uninit_irq(optee: *mut optee) {
...
#[no_mangle]
unsafe extern "C" fn optee_smc_open(ctx: *mut tee_context) -> c_int {
    static int optee_smc_open(struct tee_context *ctx)
    {
    struct optee *optee = tee_get_drvdata(ctx.teedev);
    let mut sec_caps: u32 = optee.smc.sec_caps;
...
#[no_mangle]
unsafe extern "C" fn enable_async_notif(invoke_fn: *mut optee_invoke_fn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn optee_msg_api_uid_is_optee_api(invoke_fn: *mut optee_invoke_fn) -> bool {
...
#[no_mangle]
unsafe extern "C" fn optee_msg_api_uid_is_optee_image_load(invoke_fn: *mut optee_invoke_fn) -> bool {
...
#[no_mangle]
unsafe extern "C" fn optee_msg_api_revision_is_compatible(invoke_fn: *mut optee_invoke_fn) -> bool {
...
#[no_mangle]
unsafe extern "C" fn optee_msg_get_thread_count(invoke_fn: *mut optee_invoke_fn) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("smc", _arg: method)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn optee_smc_remove(pdev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn optee_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn optee_cpuhp_probe(cpu: c_uint) -> c_int {
...
//
    ...
    optee_cpuhp_probe, core::ptr::null_mut());
    if (hp_state < 0) {
    pr_warn("Failed with CPU hotplug setup for OP-TEE");
    return -EINVAL;
    }
    cpuhp_remove_state(hp_state);
    cpuhp_invoke_fn = core::ptr::null_mut();
    }
    return rc;
    }
...
#[no_mangle]
unsafe extern "C" fn optee_protmem_pool_init(optee: *mut optee) -> c_int {
    static int optee_protmem_pool_init(struct optee *optee)
    {
    let mut protm: bool = optee.smc.sec_caps & OPTEE_SMC_SEC_CAP_PROTMEM;
    bool dyn_protm = optee.smc.sec_caps &
    OPTEE_SMC_SEC_CAP_DYNAMIC_PROTMEM;
    let mut heap_id: enum tee_dma_heap_id = TEE_DMA_HEAP_SECURE_VIDEO_PLAY;
...
#[no_mangle]
unsafe extern "C" fn optee_probe(pdev: *mut platform_device) -> c_int {
    static int optee_probe(struct platform_device *pdev)
    {
    optee_invoke_fn *invoke_fn;
    struct tee_shm_pool *pool = ERR_PTR(-EINVAL);
    struct optee *optee = core::ptr::null_mut();
    void *memremaped_shm = core::ptr::null_mut();
    unsigned int rpc_param_count;
...
//
    ...
    teedev = tee_device_alloc(&optee_clnt_desc, core::ptr::null_mut(), pool, optee);
    if (IS_ERR(teedev)) {
    rc = PTR_ERR(teedev);
    goto err_free_optee;
    }
    optee.teedev = teedev;
    teedev = tee_device_alloc(&optee_supp_desc, core::ptr::null_mut(), pool, optee);
    if (IS_ERR(teedev)) {
    rc = PTR_ERR(teedev);
...
#[no_mangle]
pub unsafe extern "C" fn optee_smc_abi_register() -> c_int {
    int optee_smc_abi_register(void)
    {
    return platform_driver_register(&optee_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn optee_smc_abi_unregister() {
