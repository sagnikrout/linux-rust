...
#[no_mangle]
unsafe extern "C" fn release_registered_pages(shm: *mut tee_shm) {
...
#[no_mangle]
unsafe extern "C" fn tee_shm_release(teedev: *mut tee_device, shm: *mut tee_shm) {
    ...
    let mut rc: c_int = teedev.desc.ops.shm_unregister(shm.ctx, shm);
    if (rc)
...
//
    ...
    {
    let mut flags: u32 = TEE_SHM_DYNAMIC | TEE_SHM_POOL;
    struct tee_device *teedev = ctx.teedev;
    struct tee_shm *shm;
    void *ret;
    int id;
    mutex_lock(&teedev.mutex);
    id = idr_alloc(&teedev.idr, core::ptr::null_mut(), 1, 0, GFP_KERNEL);
...
//
    ...
    {
    let mut flags: u32 = TEE_SHM_PRIV | TEE_SHM_POOL;
...
//
    ...
    unsigned long start))
    {
    let mut nr_pages: usize = roundup(size, PAGE_SIZE) / PAGE_SIZE;
    struct page **pages;
    unsigned int i;
    let mut rc: c_int = 0;
//
...
//
    ...
    {
    let mut flags: u32 = TEE_SHM_USER_MAPPED | TEE_SHM_DYNAMIC;
    struct tee_device *teedev = ctx.teedev;
    struct tee_shm *shm;
...
//
    ...
    {
    let mut flags: u32 = TEE_SHM_DYNAMIC;
    struct kvec kvec;
    struct iov_iter iter;
    kvec.iov_base = addr;
    kvec.iov_len = length;
...
#[no_mangle]
unsafe extern "C" fn tee_shm_fop_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tee_shm_fop_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tee_shm_get_fd(shm: *mut tee_shm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tee_shm_free(shm: *mut tee_shm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tee_shm_get_pa(shm: *mut tee_shm, offs: usize, pa: *mut phys_addr_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tee_shm_put(shm: *mut tee_shm) {
    void tee_shm_put(struct tee_shm *shm)
    {
    struct tee_device *teedev;
    let mut do_release: bool = false;
