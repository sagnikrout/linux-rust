...
//! Source: drivers/tee/qcomtee/call.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(QCOMTEE_OBJREF_FLAG_TEE: param->u.objref.flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(QCOMTEE_OBJREF_FLAG_MEM: param->u.objref.flags &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_qcomtee_memobj_object(object)) -> else {
...
// TEE Device Ops.
#[no_mangle]
unsafe extern "C" fn qcomtee_params_check(params: *mut tee_param, num_params: c_int) -> c_int {
    static int qcomtee_params_check(struct tee_param *params, int num_params)
    {
    let mut io: c_int = 0, oo = 0, ib = 0, ob = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn qcomtee_open(ctx: *mut tee_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcomtee_close_context(ctx: *mut tee_context) {
...
#[no_mangle]
unsafe extern "C" fn qcomtee_release(ctx: *mut tee_context) {
...
#[no_mangle]
unsafe extern "C" fn qcomtee_probe(pdev: *mut platform_device) -> c_int {
    ...
    teedev = tee_device_alloc(&qcomtee_desc, core::ptr::null_mut(), pool, qcomtee);
    if (IS_ERR(teedev)) {
    err = PTR_ERR(teedev);
...
//
#[no_mangle]
unsafe extern "C" fn qcomtee_remove(pdev: *mut platform_device) {
