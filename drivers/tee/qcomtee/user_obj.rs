...
//! Source: drivers/tee/qcomtee/user_obj.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcomtee_user_object {
...
// Is it a user object?
#[no_mangle]
pub unsafe extern "C" fn is_qcomtee_user_object(object: *mut qcomtee_object) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qcomtee_user_object_set_notify(object: *mut qcomtee_object, notify: bool) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcomtee_ureq {
    pub state: enum qcomtee_req_state,
// User Request:
    pub req_id: c_int,
    pub object_id: u64,
    pub op: u32,
    ...
    pub errno: c_int,
    pub node: list_head,
    pub /: *mut *mut completion c; / Completion for whoever wait.,
}
...
//
    let mut empty_ureq: static struct qcomtee_ureq = { .state = QCOMTEE_REQ_PROCESSING };
...
//
    ...
    {
    struct qcomtee_ureq *req, *ureq = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qcomtee_requests_destroy(ctxdata: *mut qcomtee_context_data) {
...
#[no_mangle]
unsafe extern "C" fn qcomtee_user_object_release(object: *mut qcomtee_object) {
