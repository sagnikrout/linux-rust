...
//! Source: drivers/tee/qcomtee/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qcomtee_qtee_object_free(object: *mut qcomtee_object) {
...
#[no_mangle]
unsafe extern "C" fn qcomtee_do_release_qtee_object(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qcomtee_release_qtee_object(object: *mut qcomtee_object) {
...
#[no_mangle]
unsafe extern "C" fn qcomtee_object_release(refcount: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcomtee_object_get(object: *mut qcomtee_object) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcomtee_object_put(object: *mut qcomtee_object) {
...
//
#[no_mangle]
unsafe extern "C" fn qcomtee_object_type(object_id: c_uint) -> enum qcomtee_object_type {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: copy_from_user(msgptr, _arg: u[i].b.uaddr, _arg: u[i].b.size)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: copy_to_user(u[i].b.uaddr, _arg: msgptr, _arg: u[i].b.size)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn qcomtee_prepare_args(oic: *mut qcomtee_object_invoke_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcomtee_update_msg(oic: *mut qcomtee_object_invoke_ctx) -> c_int {
...
// Get the object being invoked.
    let mut object_id: c_uint = msg.cxt;
    struct qcomtee_object *object;
...
//
#[no_mangle]
unsafe extern "C" fn qcomtee_qtee_objects_put(u: *mut qcomtee_arg) {
