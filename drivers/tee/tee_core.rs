...
pub const TEE_NUM_DEVICES: c_int = 32;

pub const TEE_UUID_NS_NAME_SIZE: c_int = 128;
//
...
#[no_mangle]
pub unsafe extern "C" fn teedev_ctx_get(ctx: *mut tee_context) {
...
#[no_mangle]
unsafe extern "C" fn teedev_ctx_release(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn teedev_ctx_put(ctx: *mut tee_context) {
...
#[no_mangle]
pub unsafe extern "C" fn teedev_close_context(ctx: *mut tee_context) {
...
#[no_mangle]
unsafe extern "C" fn tee_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tee_release(inode: *mut inode, filp: *mut file) -> c_int {
...
// Tag for version 5
    ...
    {
    let mut ns_grp: gid_t = (gid_t)-1;
    let mut grp: kgid_t = INVALID_GID;
...
#[no_mangle]
unsafe extern "C" fn free_params(params: *mut tee_param, num_params: usize) {
    ...
    struct tee_ioctl_param __user *uparams = core::ptr::null_mut();
    struct tee_param *params = core::ptr::null_mut();
    let mut have_session: bool = false;
...
//
    ...
    case TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_OUTPUT:
    case TEE_IOCTL_PARAM_ATTR_TYPE_UBUF_INOUT:
    ip.a = ( unsigned long)p.u.ubuf.uaddr;
    ip.b = p.u.ubuf.size;
    ip.c = 0;
    break;
    case TEE_IOCTL_PARAM_ATTR_TYPE_OBJREF_INPUT:
...
#[no_mangle]
unsafe extern "C" fn tee_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn tee_release_device(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tee_device_register(teedev: *mut tee_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tee_device_put(teedev: *mut tee_device) {
...
#[no_mangle]
pub unsafe extern "C" fn tee_device_get(teedev: *mut tee_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn tee_device_unregister(teedev: *mut tee_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct match_dev_data {
    pub vers: *mut tee_ioctl_version_data,
    pub data: *const c_void,
    pub ): *const *const *const int (match)(struct tee_ioctl_version_data , void,
}

#[no_mangle]
unsafe extern "C" fn match_dev(dev: *mut device, data: *const c_void) -> c_int {
    ...
    struct device *put_dev = core::ptr::null_mut();
    struct tee_context *ctx = core::ptr::null_mut();
    struct tee_ioctl_version_data v;
    let mut match_data: match_dev_data = { vers ? vers : &v, data, match };
    if (start)
...
#[no_mangle]
pub unsafe extern "C" fn tee_client_close_context(ctx: *mut tee_context) {
...
#[no_mangle]
pub unsafe extern "C" fn tee_client_close_session(ctx: *mut tee_context, session: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tee_client_system_session(ctx: *mut tee_context, session: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tee_client_device_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tee_client_device_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn tee_client_device_shutdown(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn tee_client_device_probe_legacy(tcdev: *mut tee_client_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tee_client_device_remove_legacy(tcdev: *mut tee_client_device) {
...
#[no_mangle]
unsafe extern "C" fn tee_client_device_shutdown_legacy(tcdev: *mut tee_client_device) {
...
#[no_mangle]
pub unsafe extern "C" fn tee_client_driver_unregister(tee_driver: *mut tee_client_driver) {
...
#[no_mangle]
unsafe extern "C" fn tee_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tee_exit() -> void __exit {
