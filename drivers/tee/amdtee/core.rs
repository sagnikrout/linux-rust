...
//! Source: drivers/tee/amdtee/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn amdtee_open(ctx: *mut tee_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_session(sess: *mut amdtee_session) {
...
#[no_mangle]
unsafe extern "C" fn amdtee_release(ctx: *mut tee_context) {
...
//
    ...
    {
    struct amdtee_session *sess;
    let mut ta_handle: u32 = get_ta_handle(session);
...
// Requires mutex to be held
    ...
    {
    let mut ta_handle: u32 = get_ta_handle(session);
    let mut index: u32 = get_session_index(session);
    struct amdtee_session *sess;
...
#[no_mangle]
unsafe extern "C" fn destroy_session(ref: *mut kref) {
    ...
    {
    struct amdtee_context_data *ctxdata = ctx.data;
    struct amdtee_session *sess = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn amdtee_close_session(ctx: *mut tee_context, session: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amdtee_map_shmem(shm: *mut tee_shm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amdtee_unmap_shmem(shm: *mut tee_shm) {
...
#[no_mangle]
pub unsafe extern "C" fn amdtee_cancel_req(ctx: *mut tee_context, cancel_id: u32, session: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amdtee_driver_init() -> int __init {
    ...
    teedev = tee_device_alloc(&amdtee_desc, core::ptr::null_mut(), pool, amdtee);
    if (IS_ERR(teedev)) {
    rc = PTR_ERR(teedev);
    goto err_free_pool;
    }
    ...
    err_kfree_drv_data:
    kfree(drv_data);
    drv_data = core::ptr::null_mut();
    pr_err("initialization failed\n");
    return rc;
    }
    module_init(amdtee_driver_init);
#[no_mangle]
unsafe extern "C" fn amdtee_driver_exit() -> void __exit {
