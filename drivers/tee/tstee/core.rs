...
//! Source: drivers/tee/tstee/core.c
#![no_std]
...
pub const FFA_DIRECT_REQ_ARG_NUM: c_int = 5;
...
#[no_mangle]
unsafe extern "C" fn tstee_open(ctx: *mut tee_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tstee_release(ctx: *mut tee_context) {
    ...
    struct ts_session *sess = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tstee_close_session(ctx: *mut tee_context, session: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tstee_shm_unregister(ctx: *mut tee_context, shm: *mut tee_shm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tstee_check_rpc_compatible(ffa_dev: *mut ffa_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tstee_probe(ffa_dev: *mut ffa_device) -> c_int {
    ...
    tstee.pool = core::ptr::null_mut();
    goto err_free_tstee;
    }
    tstee.teedev = tee_device_alloc(&tstee_desc, core::ptr::null_mut(), tstee.pool, tstee);
    if (IS_ERR(tstee.teedev)) {
    rc = PTR_ERR(tstee.teedev);
    tstee.teedev = core::ptr::null_mut();
    goto err_free_pool;
    }
...
#[no_mangle]
unsafe extern "C" fn tstee_remove(ffa_dev: *mut ffa_device) {
