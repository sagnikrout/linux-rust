...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tee_dma_heap {
    pub heap: *mut dma_heap,
    pub id: enum tee_dma_heap_id,
    pub kref: kref,
    pub pool: *mut tee_protmem_pool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tee_heap_buffer {
    pub heap: *mut tee_dma_heap,
    pub size: usize,
    pub offs: usize,
    pub table: sg_table,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tee_heap_attachment {
    pub table: sg_table,
    pub dev: *mut device,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tee_protmem_static_pool {
    pub pool: tee_protmem_pool,
    pub gen_pool: *mut gen_pool,
    pub pa_base: phys_addr_t,
}

    static DEFINE_XARRAY_ALLOC(tee_dma_heap);
#[no_mangle]
unsafe extern "C" fn tee_heap_release(kref: *mut kref) {
    ...
    h.pool = core::ptr::null_mut();
    h.teedev = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn put_tee_heap(h: *mut tee_dma_heap) {
    static void put_tee_heap(struct tee_dma_heap *h)
    {
    kref_put(&h.kref, tee_heap_release);
    }
#[no_mangle]
unsafe extern "C" fn get_tee_heap(h: *mut tee_dma_heap) {
    static void get_tee_heap(struct tee_dma_heap *h)
    {
    kref_get(&h.kref);
    }
#[no_mangle]
unsafe extern "C" fn copy_sg_table(dst: *mut sg_table, src: *mut sg_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tee_heap_buf_free(dmabuf: *mut dma_buf) {
    ...
    struct tee_device *teedev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn tee_device_put_all_dma_heaps(teedev: *mut tee_device) {
...
#[no_mangle]
unsafe extern "C" fn protmem_pool_op_static_destroy_pool(pool: *mut tee_protmem_pool) {
