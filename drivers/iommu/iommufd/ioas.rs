...
//! Source: drivers/iommu/iommufd/ioas.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_destroy(obj: *mut iommufd_object) {
    void iommufd_ioas_destroy(struct iommufd_object *obj)
    {
    struct iommufd_ioas *ioas = container_of(obj, struct iommufd_ioas, obj);
    int rc;
    rc = iopt_unmap_all(&ioas.iopt, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_alloc_ioctl(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_iova_ranges(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_allow_iovas(ucmd: *mut iommufd_ucmd) -> c_int {
    int iommufd_ioas_allow_iovas(struct iommufd_ucmd *ucmd)
    {
    struct iommu_ioas_allow_iovas *cmd = ucmd.cmd;
    let mut allowed_iova: rb_root_cached = RB_ROOT_CACHED;
...
#[no_mangle]
unsafe extern "C" fn conv_iommu_prot(map_flags: u32) -> c_int {
...
//
    let mut iommu_prot: c_int = IOMMU_CACHE;
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_map_file(ucmd: *mut iommufd_ucmd) -> c_int {
    int iommufd_ioas_map_file(struct iommufd_ucmd *ucmd)
    {
    struct iommu_ioas_map_file *cmd = ucmd.cmd;
    let mut iova: c_ulong = cmd.iova;
    struct iommufd_ioas *ioas;
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_map(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_copy(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_unmap(ucmd: *mut iommufd_ucmd) -> c_int {
    int iommufd_ioas_unmap(struct iommufd_ucmd *ucmd)
    {
    struct iommu_ioas_unmap *cmd = ucmd.cmd;
    struct iommufd_ioas *ioas;
    let mut unmapped: c_ulong = 0;
    int rc;
    ioas = iommufd_get_ioas(ucmd.ictx, cmd.ioas_id);
    if (IS_ERR(ioas))
    return PTR_ERR(ioas);
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_noiommu_get_pa(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn need_charge_update(pages: *mut iopt_pages) -> bool {
...
#[no_mangle]
unsafe extern "C" fn charge_current(npinned: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn change_mm(pages: *mut iopt_pages) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_change_process(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: cmd->val64 ==) -> else {
    else if (cmd.val64 == 1)
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_ioas_option(ucmd: *mut iommufd_ucmd) -> c_int {
