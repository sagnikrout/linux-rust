...
//! Source: drivers/iommu/iommufd/viommu.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_viommu_destroy(obj: *mut iommufd_object) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_viommu_alloc_ioctl(ucmd: *mut iommufd_ucmd) -> c_int {
...
//
    ...
    user_data.len ? &user_data : core::ptr::null_mut());
    if (rc)
    goto out_put_hwpt;
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_vdevice_abort(obj: *mut iommufd_object) {
...
// xa_cmpxchg is okay to fail if alloc failed xa_cmpxchg previously
    xa_cmpxchg(&viommu.vdevs, vdev.virt_id, vdev, core::ptr::null_mut(), GFP_KERNEL);
    refcount_dec(&viommu.obj.users);
    idev.vdev = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn iommufd_vdevice_destroy(obj: *mut iommufd_object) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_vdevice_alloc_ioctl(ucmd: *mut iommufd_ucmd) -> c_int {
    int iommufd_vdevice_alloc_ioctl(struct iommufd_ucmd *ucmd)
    {
    struct iommu_vdevice_alloc *cmd = ucmd.cmd;
    struct iommufd_vdevice *vdev;
    let mut vdev_size: usize = sizeof(*vdev);
    struct iommufd_viommu *viommu;
    struct iommu_device *iommu_dev;
    struct iommufd_device *idev;
    let mut virt_id: u64 = cmd.virt_id;
    let mut rc: c_int = 0;
...
//
    rc = xa_insert(&viommu.vdevs, virt_id, core::ptr::null_mut(), GFP_KERNEL);
    if (rc) {
    if (rc == -EBUSY)
    rc = -EEXIST;
    goto out_abort;
    ...
    {
    let mut aligned_iova: u64 = PAGE_ALIGN_DOWN(base_iova);
    let mut offset: u64 = base_iova - aligned_iova;
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hw_queue_destroy(obj: *mut iommufd_object) {
...
//
    ...
    {
    let mut aligned_iova: u64 = PAGE_ALIGN_DOWN(cmd.nesting_parent_iova);
    let mut offset: u64 = cmd.nesting_parent_iova - aligned_iova;
    struct iommufd_access *access;
    struct page **pages;
    size_t max_npages;
    size_t length;
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hw_queue_alloc_ioctl(ucmd: *mut iommufd_ucmd) -> c_int {
