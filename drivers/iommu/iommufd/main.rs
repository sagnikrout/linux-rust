...
//! Source: drivers/iommu/iommufd/main.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iommufd_object_ops {
    pub file_offset: usize,
    pub obj): *mut *mut void (pre_destroy)(struct iommufd_object,
    pub obj): *mut *mut void (destroy)(struct iommufd_object,
    pub obj): *mut *mut void (abort)(struct iommufd_object,
}
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_object_abort(ictx: *mut iommufd_ctx, obj: *mut iommufd_object) {
    void iommufd_object_abort(struct iommufd_ctx *ictx, struct iommufd_object *obj)
    {
    XA_STATE(xas, &ictx.objects, obj.id);
    void *old;
    xa_lock(&ictx.objects);
    old = xas_store(&xas, core::ptr::null_mut());
    xa_unlock(&ictx.objects);
    WARN_ON(old != XA_ZERO_ENTRY);
...
//
#[no_mangle]
pub unsafe extern "C" fn iommufd_try_inc_users(ictx: *mut iommufd_ctx, obj: *mut iommufd_object) -> c_int {
...
//
    ...
    let mut zerod_wait_cnt: bool = false;
    int ret;
//
...
//
    ...
    xas_store(&xas, (flags & REMOVE_OBJ_TOMBSTONE) ? XA_ZERO_ENTRY : core::ptr::null_mut());
    if (ictx.vfio_ioas == container_of(obj, struct iommufd_ioas, obj))
    ictx.vfio_ioas = core::ptr::null_mut();
    xa_unlock(&ictx.objects);
//
...
#[no_mangle]
unsafe extern "C" fn iommufd_destroy(ucmd: *mut iommufd_ucmd) -> c_int {
    static int iommufd_destroy(struct iommufd_ucmd *ucmd)
    {
    struct iommu_destroy *cmd = ucmd.cmd;
    return iommufd_object_remove(ucmd.ictx, core::ptr::null_mut(), cmd.id, 0);
    }
#[no_mangle]
unsafe extern "C" fn iommufd_fops_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommufd_fops_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommufd_option(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iommufd_ioctl_op {
    pub size: c_uint,
    pub min_size: c_uint,
    pub ioctl_num: c_uint,
    pub ucmd): *mut *mut int (execute)(struct iommufd_ucmd,
}
...
#[no_mangle]
unsafe extern "C" fn iommufd_fops_vma_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn iommufd_fops_vma_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn iommufd_fops_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommufd_ctx_get(ictx: *mut iommufd_ctx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommufd_ctx_put(ictx: *mut iommufd_ctx) {
    ...
    struct file *, ((_struct *)core::ptr::null_mut())._filep)) + \
...
#[no_mangle]
unsafe extern "C" fn iommufd_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iommufd_exit() -> void __exit {
