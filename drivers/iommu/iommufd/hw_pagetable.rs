...
//! Source: drivers/iommu/iommufd/hw_pagetable.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __iommufd_hwpt_destroy(hwpt: *mut iommufd_hw_pagetable) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hwpt_paging_destroy(obj: *mut iommufd_object) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hwpt_paging_abort(obj: *mut iommufd_object) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hwpt_nested_destroy(obj: *mut iommufd_object) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hwpt_nested_abort(obj: *mut iommufd_object) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hwpt_alloc(ucmd: *mut iommufd_ucmd) -> c_int {
    ...
    false, user_data.len ? &user_data : core::ptr::null_mut());
    if (IS_ERR(hwpt_paging)) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hwpt_set_dirty_tracking(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hwpt_get_dirty_bitmap(ucmd: *mut iommufd_ucmd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_hwpt_invalidate(ucmd: *mut iommufd_ucmd) -> c_int {
