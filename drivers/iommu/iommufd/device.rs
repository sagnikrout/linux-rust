...
//! Source: drivers/iommu/iommufd/device.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iommufd_attach {
    pub hwpt: *mut iommufd_hw_pagetable,
    pub device_array: xarray,
}
...
//
#[no_mangle]
unsafe extern "C" fn iommufd_device_is_noiommu(idev: *mut iommufd_device) -> bool {
    static bool iommufd_device_is_noiommu(struct iommufd_device *idev)
    {
    return IS_ENABLED(CONFIG_IOMMUFD_NOIOMMU) && !idev.dev.iommu;
    }
#[no_mangle]
unsafe extern "C" fn iommufd_group_release(kref: *mut kref) {
    ...
    igroup, core::ptr::null_mut(), GFP_KERNEL);
...
#[no_mangle]
unsafe extern "C" fn iommufd_put_group(group: *mut iommufd_group) {
...
#[no_mangle]
unsafe extern "C" fn iommufd_device_remove_vdev(idev: *mut iommufd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_device_pre_destroy(obj: *mut iommufd_object) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_device_destroy(obj: *mut iommufd_object) {
...
#[no_mangle]
unsafe extern "C" fn iommufd_bind_iommu(idev: *mut iommufd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn iommufd_bind_noiommu(idev: *mut iommufd_device) -> c_int {
    static int iommufd_bind_noiommu(struct iommufd_device *idev)
    {
    struct iommufd_group *igroup;
    igroup = iommufd_alloc_group(idev.ictx, core::ptr::null_mut());
    if (IS_ERR(igroup))
    return PTR_ERR(igroup);
    idev.igroup = igroup;
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn iommufd_ctx_has_group(ictx: *mut iommufd_ctx, group: *mut iommu_group) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommufd_device_unbind(idev: *mut iommufd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_device_to_id(idev: *mut iommufd_device) -> u32 {
...
// The device attach/detach/replace helpers for attach_handle
    ...
    let mut start: c_ulong = IOMMU_NO_PASID;
...
//
    ...
    attach = xa_cmpxchg(&igroup.pasid_attach, pasid, core::ptr::null_mut(),
...
// Caller must destroy hwpt
    ...
    &hwpt_paging.ioas.iopt, cur.dev, core::ptr::null_mut());
    if (rc)
    goto err_unresv;
    }
    }
...
//
    let mut immediate_attach: bool = do_attach == iommufd_device_do_attach;
...
// pt_id = hwpt->obj.id;
    ...
    0, immediate_attach, core::ptr::null_mut());
    ...
    destroy_hwpt = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn iommufd_device_detach(idev: *mut iommufd_device, pasid: ioasid_t) {
...
//
    ...
    {
    let mut iopt_access_list_id: u32 = access.iopt_access_list_id;
...
#[no_mangle]
unsafe extern "C" fn iommufd_access_change_ioas_id(access: *mut iommufd_access, id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_access_destroy_object(obj: *mut iommufd_object) {
    ...
    mutex_lock(&access.ioas_lock);
    if (access.ioas)
    WARN_ON(iommufd_access_change_ioas(access, core::ptr::null_mut()));
    mutex_unlock(&access.ioas_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn iommufd_access_destroy(access: *mut iommufd_access) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_access_detach(access: *mut iommufd_access) {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_access_attach(access: *mut iommufd_access, ioas_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_access_replace(access: *mut iommufd_access, ioas_id: u32) -> c_int {
...
//
    ...
    {
    let mut internal: bool = iommufd_access_is_internal(access);
...
#[no_mangle]
unsafe extern "C" fn iopt_area_contig_is_aligned(iter: *mut iopt_area_contig_iter) -> bool {
...
#[no_mangle]
unsafe extern "C" fn check_area_prot(area: *mut iopt_area, flags: c_uint) -> bool {
...
// Driver's ops don't support pin_pages
    ...
    down_read(&iopt.iova_rwsem);
    iopt_for_each_contig_area(&iter, area, iopt, iova, last_iova) {
    let mut last: c_ulong = min(last_iova, iopt_area_last_iova(area));
    let mut last_index: c_ulong = iopt_area_iova_to_index(area, last);
    unsigned long index =
...
//
    ...
    iopt_for_each_contig_area(&iter, area, iopt, iova, last_iova) {
    let mut last: c_ulong = min(last_iova, iopt_area_last_iova(area));
    let mut bytes: c_ulong = (last - iter.cur_iova) + 1;
    if (area.prevent_access) {
    rc = -EINVAL;
    goto err_out;
    }
...
#[no_mangle]
pub unsafe extern "C" fn iommufd_get_hw_info(ucmd: *mut iommufd_ucmd) -> c_int {
    int iommufd_get_hw_info(struct iommufd_ucmd *ucmd)
    {
    let mut SUPPORTED_FLAGS: u32 = IOMMU_HW_INFO_FLAG_INPUT_TYPE;
