...
//! Source: drivers/iommu/iommufd/driver.c
#![no_std]
...
// Caller should xa_lock(&viommu->vdevs) to protect the return value
    ...
    return vdev ? iommufd_vdevice_to_device(vdev) : core::ptr::null_mut();
    }
...
//
    ...
    if (ictx.sw_msi_id >=
#[no_mangle]
pub unsafe extern "C" fn sizeof_field(iommufd_sw_msi_maps: struct, _arg: bitmap)) -> *mut BITS_PER_BYTE {
