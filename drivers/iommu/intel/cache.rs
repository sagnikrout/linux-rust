...
//! Source: drivers/iommu/intel/cache.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn domain_qi_batch_alloc(domain: *mut dmar_domain) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn domain_get_id_for_dev(domain: *mut dmar_domain, dev: *mut device) -> u16 {
...
//
    ...
    struct device *dev, ioasid_t pasid)
    {
    let mut did: u16 = domain_get_id_for_dev(domain, dev);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qi_batch_flush_descs(iommu: *mut intel_iommu, batch: *mut qi_batch) {
...
#[no_mangle]
unsafe extern "C" fn qi_batch_increment_index(iommu: *mut intel_iommu, batch: *mut qi_batch) {
...
#[no_mangle]
unsafe extern "C" fn intel_domain_use_piotlb(domain: *mut dmar_domain) -> bool {
    ...
    let mut type: u64 = DMA_TLB_PSI_FLUSH;
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_tag_flush_all(domain: *mut dmar_domain) {
