...
//! Source: drivers/iommu/intel/svm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn intel_svm_check(iommu: *mut intel_iommu) {
...
#[no_mangle]
unsafe extern "C" fn intel_mm_release(mn: *mut mmu_notifier, mm: *mut mm_struct) {
...
#[no_mangle]
unsafe extern "C" fn intel_mm_free_notifier(mn: *mut mmu_notifier) {
...
#[no_mangle]
unsafe extern "C" fn intel_iommu_sva_supported(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_svm_domain_free(domain: *mut iommu_domain) {
