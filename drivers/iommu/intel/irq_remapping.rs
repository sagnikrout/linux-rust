...
//! Source: drivers/iommu/intel/irq_remapping.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ioapic_scope {
    pub iommu: *mut intel_iommu,
    pub id: c_uint,
    pub /: *mut *mut unsigned int bus; / PCI bus number,
    pub /: *mut *mut unsigned int devfn; / PCI devfn number,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hpet_scope {
    pub iommu: *mut intel_iommu,
    pub id: u8,
    pub bus: c_uint,
    pub devfn: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct irq_2_iommu {
    pub iommu: *mut intel_iommu,
    pub irte_index: u16,
    pub sub_handle: u16,
    pub irte_mask: u8,
    pub posted_msi: bool,
    pub posted_vcpu: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_ir_data {
    pub irq_2_iommu: irq_2_iommu,
    pub irte_entry: irte,
    union {
...
#[no_mangle]
unsafe extern "C" fn ir_pre_enabled(iommu: *mut intel_iommu) -> bool {
    static bool ir_pre_enabled(struct intel_iommu *iommu)
    {
    return (iommu.flags & VTD_FLAG_IRQ_REMAP_PRE_ENABLED);
    }
#[no_mangle]
unsafe extern "C" fn clear_ir_pre_enabled(iommu: *mut intel_iommu) {
    static void clear_ir_pre_enabled(struct intel_iommu *iommu)
    {
    iommu.flags &= ~VTD_FLAG_IRQ_REMAP_PRE_ENABLED;
    }
#[no_mangle]
unsafe extern "C" fn init_ir_status(iommu: *mut intel_iommu) {
...
#[no_mangle]
unsafe extern "C" fn qi_flush_iec(iommu: *mut intel_iommu, index: c_int, mask: c_int) -> c_int {
...
//
    ...
    return drhd ? drhd.iommu.ir_domain : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn clear_entries(irq_iommu: *mut irq_2_iommu) -> c_int {
...
//
pub const SVT_NO_VERIFY: c_uint = 0x0  /* no verification is required */;
pub const SVT_VERIFY_SID_SQ: c_uint = 0x1  /* verify using SID and SQ fields */;
pub const SVT_VERIFY_BUS: c_uint = 0x2  /* verify bus of request-id */;
//
// source-id qualifier
//
pub const SQ_ALL_16: c_uint = 0x0  /* verify all 16 bits of request-id */;
pub const SQ_13_IGNORE_1: c_uint = 0x1  /* verify most significant 13 bits, ignore;
// the third least significant bit
//
pub const SQ_13_IGNORE_2: c_uint = 0x2  /* verify most significant 13 bits, ignore;
// the second and third least significant bits
//
pub const SQ_13_IGNORE_3: c_uint = 0x3  /* verify most significant 13 bits, ignore;
...
#[no_mangle]
unsafe extern "C" fn set_ioapic_sid(irte: *mut irte, apic: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_hpet_sid(irte: *mut irte, id: u8) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct set_msi_sid_data {
    pub pdev: *mut pci_dev,
    pub alias: u16,
    pub count: c_int,
    pub busmatch_count: c_int,
}

#[no_mangle]
unsafe extern "C" fn set_msi_sid_cb(pdev: *mut pci_dev, alias: u16, opaque: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_msi_sid(irte: *mut irte, dev: *mut pci_dev) -> c_int {
...
//
    ...
    dev.bus.number);
#[no_mangle]
pub unsafe extern "C" fn if(data.count: data.count >= 2 && data.busmatch_count ==) -> else {
    else if (data.count >= 2 && data.busmatch_count == data.count)
    set_irte_verify_bus(irte, dev.bus.number, dev.bus.number);
#[no_mangle]
pub unsafe extern "C" fn if(dev->bus->number: data.pdev->bus->number !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn iommu_load_old_irte(iommu: *mut intel_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_set_irq_remapping(iommu: *mut intel_iommu, mode: c_int) {
...
#[no_mangle]
unsafe extern "C" fn iommu_enable_irq_remapping(iommu: *mut intel_iommu) {
...
#[no_mangle]
unsafe extern "C" fn intel_setup_irq_remapping(iommu: *mut intel_iommu) -> c_int {
...
//
    ...
    iommu.ir_domain = core::ptr::null_mut();
    out_free_fwnode:
    ...
    out_free_table:
    kfree(ir_table);
    iommu.ir_table  = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn intel_teardown_irq_remapping(iommu: *mut intel_iommu) {
...
//
#[no_mangle]
unsafe extern "C" fn iommu_disable_irq_remapping(iommu: *mut intel_iommu) {
    static void iommu_disable_irq_remapping(struct intel_iommu *iommu)
    {
    unsigned long flags;
    u32 sts;
...
#[no_mangle]
unsafe extern "C" fn dmar_x2apic_optout() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn intel_cleanup_irq_remapping() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_prepare_irq_remapping() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_irq_posting_cap() {
...
#[no_mangle]
unsafe extern "C" fn intel_enable_irq_remapping() -> int __init {
...
//
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(-1: ir_hpet[count].iommu == NULL && free ==) -> else {
    else if (ir_hpet[count].iommu == core::ptr::null_mut() && free == -1)
    free = count;
    }
    if (free == -1) {
...
//
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(-1: ir_ioapic[count].iommu == NULL && free ==) -> else {
    else if (ir_ioapic[count].iommu == core::ptr::null_mut() && free == -1)
    free = count;
    }
    if (free == -1) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_DMAR_SCOPE_TYPE_HPET: scope->entry_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ir_remove_ioapic_hpet_scope(iommu: *mut intel_iommu) {
    static void ir_remove_ioapic_hpet_scope(struct intel_iommu *iommu)
    {
    int i;
    for (i = 0; i < MAX_HPET_TBS; i++)
    if (ir_hpet[i].iommu == iommu)
    ir_hpet[i].iommu = core::ptr::null_mut();
    for (i = 0; i < MAX_IO_APICS; i++)
    if (ir_ioapic[i].iommu == iommu)
    ir_ioapic[i].iommu = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn parse_ioapics_under_ir() -> int __init {
    static int __init parse_ioapics_under_ir(void)
    {
    struct dmar_drhd_unit *drhd;
    struct intel_iommu *iommu;
    let mut ir_supported: bool = false;
    int ioapic_idx;
    for_each_iommu(iommu, drhd) {
    int ret;
    if (!ecap_ir_support(iommu.ecap))
    ...
    let mut ioapic_id: c_int = mpc_ioapic_id(ioapic_idx);
...
#[no_mangle]
unsafe extern "C" fn ir_dev_scope_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn disable_irq_remapping() {
    static void disable_irq_remapping(void)
    {
    struct dmar_drhd_unit *drhd;
    struct intel_iommu *iommu = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn reenable_irq_remapping(eim: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_irq_remap_add_device(info: *mut dmar_pci_notify_info) {
...
#[no_mangle]
unsafe extern "C" fn prepare_irte(irte: *mut irte, vector: c_int, dest: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn prepare_irte_posted(irte: *mut irte) {
...
#[no_mangle]
unsafe extern "C" fn get_pi_desc_addr(irqd: *mut irq_data) -> phys_addr_t {
    static phys_addr_t get_pi_desc_addr(struct irq_data *irqd)
    {
    let mut cpu: c_int = cpumask_first(irq_data_get_effective_affinity_mask(irqd));
    if (WARN_ON(cpu >= nr_cpu_ids))
    return 0;
    return __pa(per_cpu_ptr(&posted_msi_pi_desc, cpu));
    }
#[no_mangle]
unsafe extern "C" fn intel_ir_reconfigure_irte_posted(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn __intel_ir_reconfigure_irte(irqd: *mut irq_data, force_host: bool) {
...
#[no_mangle]
unsafe extern "C" fn intel_ir_reconfigure_irte(irqd: *mut irq_data, force_host: bool) {
...
#[no_mangle]
unsafe extern "C" fn intel_ir_set_vcpu_affinity(data: *mut irq_data, info: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fill_msi_msg(msg: *mut msi_msg, index: u32, subhandle: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn dmar_ir_add(dmaru: *mut dmar_drhd_unit, iommu: *mut intel_iommu) -> c_int {
    static int dmar_ir_add(struct dmar_drhd_unit *dmaru, struct intel_iommu *iommu)
    {
    int ret;
    let mut eim: c_int = x2apic_enabled();
    if (eim && !ecap_eim_support(iommu.ecap)) {
...
#[no_mangle]
pub unsafe extern "C" fn dmar_ir_hotplug(dmaru: *mut dmar_drhd_unit, insert: bool) -> c_int {
