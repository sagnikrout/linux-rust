...
//! Source: drivers/iommu/intel/debugfs.c
#![no_std]
...
pub struct tbl_walk {
    ...
    pub devfn: u16,
    pub pasid: u32,
    pub rt_entry: *mut root_entry,
    pub ctx_entry: *mut context_entry,
    pub pasid_tbl_entry: *mut pasid_entry,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct iommu_regset {
    pub offset: c_int,
    pub regs: *const c_char,
}

pub const DEBUG_BUFFER_SIZE: c_int = 1024;
...
#[no_mangle]
unsafe extern "C" fn iommu_regset_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn print_tbl_walk(m: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn ctx_tbl_walk(m: *mut seq_file, iommu: *mut intel_iommu, bus: u16) {
...
#[no_mangle]
unsafe extern "C" fn root_tbl_walk(m: *mut seq_file, iommu: *mut intel_iommu) {
...
#[no_mangle]
unsafe extern "C" fn dmar_translation_struct_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn level_to_directory_size(level: c_int) -> c_ulong {
...
//
    ...
    let mut tt: u8 = (u8)(context.lo & GENMASK_ULL(3, 2)) >> 2;
//
...
#[no_mangle]
unsafe extern "C" fn dev_domain_translation_struct_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pasid_domain_translation_struct_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn invalidation_queue_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ir_translation_struct_show(m: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn latency_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmar_perf_latency_open(inode: *mut inode, filp: *mut file) -> c_int {
    static int dmar_perf_latency_open(struct inode *inode, struct file *filp)
    {
    return single_open(filp, latency_show, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn intel_iommu_debugfs_init() -> void __init {
    void __init intel_iommu_debugfs_init(void)
    {
    intel_iommu_debug = debugfs_create_dir("intel", iommu_debugfs_dir);
    debugfs_create_file("iommu_regset", 0444, intel_iommu_debug, core::ptr::null_mut(),
    &iommu_regset_fops);
    debugfs_create_file("dmar_translation_struct", 0444, intel_iommu_debug,
    core::ptr::null_mut(), &dmar_translation_struct_fops);
    debugfs_create_file("invalidation_queue", 0444, intel_iommu_debug,
    core::ptr::null_mut(), &invalidation_queue_fops);

    debugfs_create_file("ir_translation_struct", 0444, intel_iommu_debug,
    core::ptr::null_mut(), &ir_translation_struct_fops);

    debugfs_create_file("dmar_perf_latency", 0644, intel_iommu_debug,
    core::ptr::null_mut(), &dmar_perf_latency_fops);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_iommu_debugfs_create_dev(info: *mut device_domain_info) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_iommu_debugfs_remove_dev(info: *mut device_domain_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_iommu_debugfs_create_dev_pasid(dev_pasid: *mut dev_pasid_info) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_iommu_debugfs_remove_dev_pasid(dev_pasid: *mut dev_pasid_info) {
