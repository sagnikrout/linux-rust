...
//
    ...
    let mut __read_mostly: static bool iommu_dma_strict = IS_ENABLED(CONFIG_IOMMU_DEFAULT_DMA_STRICT);
...
pub struct iommu_group {
    ...
    pub mutex: mutex,
    pub iommu_data: *mut c_void,
    pub iommu_data): *mut *mut void (iommu_data_release)(void,
    pub name: *mut c_char,
    pub id: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iommu_group_attribute {
    pub attr: attribute,
    pub buf): *mut *mut *mut ssize_t (show)(struct iommu_group group, char,
...
#[no_mangle]
unsafe extern "C" fn iommu_subsys_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn remove_iommu_group(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_device_unregister(iommu: *mut iommu_device) {
    void iommu_device_unregister(struct iommu_device *iommu)
    {
    for (int i = 0; i < ARRAY_SIZE(iommu_buses); i++)
    bus_for_each_dev(iommu_buses[i], core::ptr::null_mut(), iommu, remove_iommu_group);
    spin_lock(&iommu_device_lock);
    list_del(&iommu.list);
    spin_unlock(&iommu_device_lock);
// Pairs with the alloc in generic_single_device_group()
    iommu_group_put(iommu.singleton_group);
    iommu.singleton_group = core::ptr::null_mut();
    }
...
//
    ...
    if (err)
    return err;
    iommu.fwnode = fwnode_create_software_node(core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn iommu_mock_device_add(dev: *mut device, iommu: *mut iommu_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dev_iommu_free(dev: *mut device) {
    void dev_iommu_free(struct device *dev)
    {
    struct dev_iommu *param = dev.iommu;
    dev.iommu = core::ptr::null_mut();
    if (param.fwspec) {
...
//
#[no_mangle]
unsafe extern "C" fn dev_has_iommu(dev: *mut device) -> bool {
    static bool dev_has_iommu(struct device *dev)
    {
    return dev.iommu && dev.iommu.iommu_dev;
    }
#[no_mangle]
unsafe extern "C" fn dev_iommu_get_max_pasids(dev: *mut device) -> u32 {
    static u32 dev_iommu_get_max_pasids(struct device *dev)
    {
    let mut max_pasids: u32 = 0, bits = 0;
    int ret;
    if (dev_is_pci(dev)) {
...
#[no_mangle]
pub unsafe extern "C" fn dev_iommu_priv_set(dev: *mut device, priv: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn iommu_init_device(dev: *mut device) -> c_int {
...
//
    ...
    if (WARN_ON_ONCE(group == core::ptr::null_mut()))
    ...
    err_free:
    dev.iommu.iommu_dev = core::ptr::null_mut();
    dev_iommu_free(dev);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn iommu_deinit_device(dev: *mut device) {
...
//
    ...
    group.default_domain = core::ptr::null_mut();
    }
    if (group.blocking_domain) {
    iommu_domain_free(group.blocking_domain);
    group.blocking_domain = core::ptr::null_mut();
    }
    group.domain = core::ptr::null_mut();
    }
// Caller must put iommu_group
    dev.iommu_group = core::ptr::null_mut();
    module_put(ops.owner);
    dev_iommu_free(dev);
...
#[no_mangle]
unsafe extern "C" fn __iommu_probe_device(dev: *mut device, group_list: *mut list_head) -> c_int {
...
//
    ...
    if (group.domain) {
    ret = __iommu_device_set_domain(group, dev, group.domain, core::ptr::null_mut(),
    0);
    if (ret)
...
#[no_mangle]
pub unsafe extern "C" fn iommu_probe_device(dev: *mut device) -> c_int {
    int iommu_probe_device(struct device *dev)
    {
    const struct iommu_ops *ops;
    int ret;
    mutex_lock(&iommu_probe_device_lock);
    ret = __iommu_probe_device(dev, core::ptr::null_mut());
    mutex_unlock(&iommu_probe_device_lock);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn __iommu_group_remove_device(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn iommu_release_device(dev: *mut device) {
    static void iommu_release_device(struct device *dev)
    {
    struct iommu_group *group = dev.iommu_group;
    if (group)
...
#[no_mangle]
unsafe extern "C" fn iommu_set_def_domain_type(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iommu_dma_setup(str: *mut c_char) -> int __init {
    static int __init iommu_dma_setup(char *str)
    {
    let mut ret: c_int = kstrtobool(str, &iommu_dma_strict);
    if (!ret)
    iommu_cmd_line |= IOMMU_CMD_LINE_STRICT;
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn iommu_set_dma_strict() {
...
#[no_mangle]
unsafe extern "C" fn iommu_group_show_name(group: *mut iommu_group, buf: *mut c_char) -> isize {
...
//
    ...
    static IOMMU_GROUP_ATTR(name, S_IRUGO, iommu_group_show_name, core::ptr::null_mut());
    static IOMMU_GROUP_ATTR(reserved_regions, 0444,
    iommu_group_show_resv_regions, core::ptr::null_mut());
    static IOMMU_GROUP_ATTR(type, 0644, iommu_group_show_type,
    iommu_group_store_type);
#[no_mangle]
unsafe extern "C" fn iommu_group_release(kobj: *mut kobject) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_set_name(group: *mut iommu_group, name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_add_device(group: *mut iommu_group, dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_remove_device(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_mutex_assert(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_put(group: *mut iommu_group) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_id(group: *mut iommu_group) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn get_pci_alias_or_group(pdev: *mut pci_dev, alias: u16, opaque: *mut c_void) -> c_int {
    static int get_pci_alias_or_group(struct pci_dev *pdev, u16 alias, void *opaque)
    {
    struct group_for_pci_data *data = opaque;
    data.pdev = pdev;
    data.group = iommu_group_get(&pdev.dev);
    return data.group != core::ptr::null_mut();
    }
//
...
//
    ...
    struct pci_bus *bus;
    struct iommu_group *group = core::ptr::null_mut();
    u64 devfns[4] = { 0 };
...
//
    ...
    if (!bus.self)
    continue;
    if (pci_acs_path_enabled(bus.self, core::ptr::null_mut(), REQ_ACS_FLAGS))
    break;
    pdev = bus.self;
    group = iommu_group_get(&pdev.dev);
    if (group)
...
#[no_mangle]
unsafe extern "C" fn probe_iommu_group(dev: *mut device, data: *mut c_void) -> c_int {
...
//
    ...
    int target_type)
    {
    struct device *untrusted = core::ptr::null_mut();
    struct group_device *gdev;
    let mut driver_type: c_int = 0;
    lockdep_assert_held(&group.mutex);
//
...
#[no_mangle]
unsafe extern "C" fn iommu_group_do_probe_finalize(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn bus_iommu_probe(bus: *const bus_type) -> c_int {
    static int bus_iommu_probe(const struct bus_type *bus)
    {
    struct iommu_group *group, *next;
    LIST_HEAD(group_list);
    int ret;
    ret = bus_for_each_dev(bus, core::ptr::null_mut(), &group_list, probe_iommu_group);
    if (ret)
    return ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn device_iommu_capable(dev: *mut device, cap: enum iommu_cap) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_has_isolated_msi(group: *mut iommu_group) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ops->domain_alloc_paging_flags) -> else {
    else if (ops.domain_alloc_paging_flags)
    domain = ops.domain_alloc_paging_flags(dev, flags, core::ptr::null_mut());

#[no_mangle]
pub unsafe extern "C" fn if(!flags: ops->domain_alloc &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_domain_free(domain: *mut iommu_domain) {
...
//
#[no_mangle]
unsafe extern "C" fn __iommu_group_set_core_domain(group: *mut iommu_group) {
    ...
    {
    int ret;
    if (unlikely(domain.ops.attach_dev == core::ptr::null_mut()))
    return -ENODEV;
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_attach_device(domain: *mut iommu_domain, dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_deferred_attach(dev: *mut device, domain: *mut iommu_domain) -> c_int {
...
//
    if (gdev.blocked)
    return -EBUSY;
    return __iommu_attach_device(domain, dev, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn iommu_detach_device(domain: *mut iommu_domain, dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_attach_group(domain: *mut iommu_domain, group: *mut iommu_group) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_detach_group(domain: *mut iommu_domain, group: *mut iommu_group) {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_iova_to_phys(domain: *mut iommu_domain, iova: dma_addr_t) -> phys_addr_t {
    ...
    size_t offset_end;
    let mut addr_merge: c_ulong = paddr | iova;
...
#[no_mangle]
pub unsafe extern "C" fn iommu_sync_map(domain: *mut iommu_domain, iova: c_ulong, size: usize) -> c_int {
...
//
    ...
    gfp_t gfp)
    {
    let mut len: usize = 0, mapped = 0;
    phys_addr_t start;
    let mut i: c_uint = 0;
    int ret;
    while (i <= nents) {
    let mut s_phys: phys_addr_t = sg_phys(sg);
...
#[no_mangle]
unsafe extern "C" fn iommu_init() -> int __init {
    static int __init iommu_init(void)
    {
    iommu_group_kset = kset_create_and_add("iommu_groups",
    core::ptr::null_mut(), kernel_kobj);
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_get_resv_regions(dev: *mut device, list: *mut list_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_put_resv_regions(dev: *mut device, list: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_set_default_passthrough(cmd_line: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_set_default_translated(cmd_line: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_default_passthrough() -> bool {
    bool iommu_default_passthrough(void)
    {
    let mut iommu_def_domain_type: return = = IOMMU_DOMAIN_IDENTITY;
    }
    EXPORT_SYMBOL_GPL(iommu_default_passthrough);
    static const struct iommu_device *iommu_from_fwnode(const struct fwnode_handle *fwnode)
    {
    const struct iommu_device *iommu, *ret = core::ptr::null_mut();
    spin_lock(&iommu_device_lock);
    ...
    return iommu ? iommu.ops : core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn iommu_fwspec_init(dev: *mut device, iommu_fwnode: *mut fwnode_handle) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_fwspec_free(dev: *mut device) {
    ...
    kfree(fwspec);
    dev_iommu_fwspec_set(dev, core::ptr::null_mut());
    }
    }
#[no_mangle]
pub unsafe extern "C" fn iommu_fwspec_add_ids(dev: *mut device, ids: *const u32, num_ids: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "DMA")) -> else {
    else if (sysfs_streq(buf, "DMA"))
    req_type = IOMMU_DOMAIN_DMA;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: "DMA-FQ")) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_device_use_default_domain(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_device_unuse_default_domain(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn __iommu_group_alloc_blocking_domain(group: *mut iommu_group) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __iommu_take_dma_ownership(group: *mut iommu_group, owner: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_claim_dma_owner(group: *mut iommu_group, owner: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_device_claim_dma_owner(dev: *mut device, owner: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __iommu_release_dma_ownership(group: *mut iommu_group) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_release_dma_owner(group: *mut iommu_group) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_device_release_dma_owner(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_group_dma_owner_claimed(group: *mut iommu_group) -> bool {
...
//
    ...
    if (ret)
    goto out_unlock;
    ret = __iommu_set_group_pasid(domain, group, pasid, core::ptr::null_mut());
    if (ret) {
...
//
    ...
    entry = iommu_make_pasid_array_entry(domain, handle);
    curr = xa_cmpxchg(&group.pasid_array, pasid, core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn iommu_alloc_global_pasid(dev: *mut device) -> ioasid_t {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_free_global_pasid(pasid: ioasid_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_dev_reset_iommu_prepare(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pci_dev_reset_iommu_done(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_dma_prepare_msi(desc: *mut msi_desc, msi_addr: phys_addr_t) -> c_int {
