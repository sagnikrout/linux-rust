...
//! Source: drivers/iommu/rockchip-iommu.c
#![no_std]
...
pub const RK_MMU_DTE_ADDR: c_uint = 0x00	/* Directory table address */;
pub const RK_MMU_STATUS: c_uint = 0x04;
pub const RK_MMU_COMMAND: c_uint = 0x08;
pub const RK_MMU_PAGE_FAULT_ADDR: c_uint = 0x0C	/* IOVA of last page fault */;
pub const RK_MMU_ZAP_ONE_LINE: c_uint = 0x10	/* Shootdown one IOTLB entry */;
pub const RK_MMU_INT_RAWSTAT: c_uint = 0x14	/* IRQ status ignoring mask */;
pub const RK_MMU_INT_CLEAR: c_uint = 0x18	/* Acknowledge and re-arm irq */;
pub const RK_MMU_INT_MASK: c_uint = 0x1C	/* IRQ enable */;
pub const RK_MMU_INT_STATUS: c_uint = 0x20	/* IRQ status after masking */;
pub const RK_MMU_AUTO_GATING: c_uint = 0x24;
pub const DTE_ADDR_DUMMY: c_uint = 0xCAFEBABE;
pub const RK_MMU_POLL_PERIOD_US: c_int = 100;
pub const RK_MMU_FORCE_RESET_TIMEOUT_US: c_int = 100000;
pub const RK_MMU_POLL_TIMEOUT_US: c_int = 1000;
// RK_MMU_STATUS fields

// RK_MMU_COMMAND command values

// RK_MMU_INT_* register fields
pub const RK_MMU_IRQ_PAGE_FAULT: c_uint = 0x01  /* page fault */;
pub const RK_MMU_IRQ_BUS_ERROR: c_uint = 0x02  /* bus read error */;
...
// 4 KiB to 4 MiB
//
pub const RK_IOMMU_PGSIZE_BITMAP: c_uint = 0x007ff000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_iommu_ops {
    pub dte): *mut *mut phys_addr_t (pt_address)(u32,
    pub pt_dma): *mut *mut u32 (mk_dtentries)(dma_addr_t,
    pub prot): *mut *mut u32 (mk_ptentries)(phys_addr_t page, int,
    pub dma_bit_mask: u64,
    pub gfp_flags: gfp_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_iommu_domain {
    pub iommus: list_head,
    pub /: *mut *mut *mut u32 dt; / page directory table,
    pub dt_dma: dma_addr_t,
    pub /: *mut *mut spinlock_t iommus_lock; / lock for iommus list,
    pub /: *mut *mut spinlock_t dt_lock; / lock for modifying page directory table,
    pub dma_dev: *mut device,
    pub rk_ops: *const rk_iommu_ops,
...
pub struct rk_iommu {
    ...
    pub /: *mut *mut list_head node; / entry in rk_iommu_domain.iommus,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk_iommudata {
    pub /: *mut *mut *mut device_link link; / runtime PM link from IOMMU to master,
    pub iommu: *mut rk_iommu,
}
...
//
pub const RK_DTE_PT_ADDRESS_MASK: c_uint = 0xfffff000;

#[no_mangle]
pub unsafe extern "C" fn rk_dte_pt_address(dte: u32) -> phys_addr_t {
...
#[no_mangle]
pub unsafe extern "C" fn rk_dte_pt_address_v2(dte: u32) -> phys_addr_t {
    static inline phys_addr_t rk_dte_pt_address_v2(u32 dte)
    {
    let mut dte_v2: u64 = dte;
...
#[no_mangle]
pub unsafe extern "C" fn rk_dte_is_pt_valid(dte: u32) -> bool {
    static inline bool rk_dte_is_pt_valid(u32 dte)
    {
    return dte & RK_DTE_PT_VALID;
    }
#[no_mangle]
pub unsafe extern "C" fn rk_mk_dte(pt_dma: dma_addr_t) -> u32 {
    static inline u32 rk_mk_dte(dma_addr_t pt_dma)
    {
    return (pt_dma & RK_DTE_PT_ADDRESS_MASK) | RK_DTE_PT_VALID;
    }
#[no_mangle]
pub unsafe extern "C" fn rk_mk_dte_v2(pt_dma: dma_addr_t) -> u32 {
...
//
pub const RK_PTE_PAGE_ADDRESS_MASK: c_uint = 0xfffff000;
pub const RK_PTE_PAGE_FLAGS_MASK: c_uint = 0x000001fe;

#[no_mangle]
pub unsafe extern "C" fn rk_pte_is_page_valid(pte: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk_mk_pte(page: phys_addr_t, prot: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn rk_mk_pte_v2(page: phys_addr_t, prot: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn rk_mk_pte_invalid(pte: u32) -> u32 {
...
//
pub const RK_IOVA_DTE_MASK: c_uint = 0xffc00000;
pub const RK_IOVA_DTE_SHIFT: c_int = 22;
pub const RK_IOVA_PTE_MASK: c_uint = 0x003ff000;
pub const RK_IOVA_PTE_SHIFT: c_int = 12;
pub const RK_IOVA_PAGE_MASK: c_uint = 0x00000fff;
pub const RK_IOVA_PAGE_SHIFT: c_int = 0;
#[no_mangle]
unsafe extern "C" fn rk_iova_dte_index(iova: dma_addr_t) -> u32 {
    static u32 rk_iova_dte_index(dma_addr_t iova)
    {
    return (u32)(iova & RK_IOVA_DTE_MASK) >> RK_IOVA_DTE_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn rk_iova_pte_index(iova: dma_addr_t) -> u32 {
    static u32 rk_iova_pte_index(dma_addr_t iova)
    {
    return (u32)(iova & RK_IOVA_PTE_MASK) >> RK_IOVA_PTE_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn rk_iova_page_offset(iova: dma_addr_t) -> u32 {
    static u32 rk_iova_page_offset(dma_addr_t iova)
    {
    return (u32)(iova & RK_IOVA_PAGE_MASK) >> RK_IOVA_PAGE_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn rk_iommu_read(base: *mut void __iomem, offset: u32) -> u32 {
    static u32 rk_iommu_read(void __iomem *base, u32 offset)
    {
    return readl(base + offset);
    }
#[no_mangle]
unsafe extern "C" fn rk_iommu_write(base: *mut void __iomem, offset: u32, value: u32) {
    static void rk_iommu_write(void __iomem *base, u32 offset, u32 value)
    {
    writel(value, base + offset);
    }
#[no_mangle]
unsafe extern "C" fn rk_iommu_command(iommu: *mut rk_iommu, command: u32) {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_base_command(base: *mut void __iomem, command: u32) {
    ...
    {
    int i;
    let mut iova_end: dma_addr_t = iova_start + size;
//
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_is_stall_active(iommu: *mut rk_iommu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_is_paging_enabled(iommu: *mut rk_iommu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_is_reset_done(iommu: *mut rk_iommu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_enable_stall(iommu: *mut rk_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_disable_stall(iommu: *mut rk_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_enable_paging(iommu: *mut rk_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_disable_paging(iommu: *mut rk_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_force_reset(iommu: *mut rk_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn log_iova(iommu: *mut rk_iommu, index: c_int, iova: dma_addr_t) {
    ...
    u32 *dte_addr;
    u32 dte;
    let mut pte_addr_phys: phys_addr_t = 0;
    u32 *pte_addr = core::ptr::null_mut();
    let mut pte: u32 = 0;
    let mut page_addr_phys: phys_addr_t = 0;
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Shootdown iotlb entries for iova range that was just unmapped
    ...
    return data ? data.iommu : core::ptr::null_mut();
    }
// Must be called with iommu powered on and attached
#[no_mangle]
unsafe extern "C" fn rk_iommu_disable(iommu: *mut rk_iommu) {
...
// Must be called with iommu powered on and attached
#[no_mangle]
unsafe extern "C" fn rk_iommu_enable(iommu: *mut rk_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_domain_free(domain: *mut iommu_domain) {
    ...
    let mut dte: u32 = rk_domain.dt[i];
    if (rk_dte_is_pt_valid(dte)) {
    let mut pt_phys: phys_addr_t = rk_domain.rk_ops.pt_address(dte);
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_release_device(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_probe(pdev: *mut platform_device) -> c_int {
    static int rk_iommu_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct rk_iommu *iommu;
    struct resource *res;
    let mut num_res: c_int = pdev.num_resources;
    int err, i;
...
pub unsafe extern "C" fn if(0: err <) -> else {
    ...
    let mut irq: c_int = platform_get_irq(pdev, i);
    if (irq < 0) {
    err = irq;
    goto err_pm_disable;
    }
    ...
    err = iommu_device_sysfs_add(&iommu.iommu, dev, core::ptr::null_mut(), dev_name(dev));
    if (err)
    goto err_pm_disable;
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rk_iommu_resume(dev: *mut device) -> int __maybe_unused {
    ...
    SET_RUNTIME_PM_OPS(rk_iommu_suspend, rk_iommu_resume, core::ptr::null_mut())
