...
//! Source: drivers/iommu/s390-iommu.c
#![no_std]
...
//
    ...
    let mut s390_iommu_aperture_factor: static u32 = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s390_domain {
    pub domain: iommu_domain,
    pub devices: list_head,
    pub ctrs: zpci_iommu_ctrs,
...
#[no_mangle]
pub unsafe extern "C" fn calc_rfx(ptr: dma_addr_t) -> c_uint {
    static inline unsigned int calc_rfx(dma_addr_t ptr)
    {
    return ((unsigned long)ptr >> ZPCI_RF_SHIFT) & ZPCI_INDEX_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn calc_rsx(ptr: dma_addr_t) -> c_uint {
    static inline unsigned int calc_rsx(dma_addr_t ptr)
    {
    return ((unsigned long)ptr >> ZPCI_RS_SHIFT) & ZPCI_INDEX_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn calc_rtx(ptr: dma_addr_t) -> c_uint {
    static inline unsigned int calc_rtx(dma_addr_t ptr)
    {
    return ((unsigned long)ptr >> ZPCI_RT_SHIFT) & ZPCI_INDEX_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn calc_sx(ptr: dma_addr_t) -> c_uint {
    static inline unsigned int calc_sx(dma_addr_t ptr)
    {
    return ((unsigned long)ptr >> ZPCI_ST_SHIFT) & ZPCI_INDEX_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn calc_px(ptr: dma_addr_t) -> c_uint {
    static inline unsigned int calc_px(dma_addr_t ptr)
    {
    return ((unsigned long)ptr >> PAGE_SHIFT) & ZPCI_PT_MASK;
    }
#[no_mangle]
pub unsafe extern "C" fn set_pt_pfaa(entry: *mut c_ulong, pfaa: phys_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn set_rf_rso(entry: *mut c_ulong, rso: phys_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn set_rs_rto(entry: *mut c_ulong, rto: phys_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn set_rt_sto(entry: *mut c_ulong, sto: phys_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn set_st_pto(entry: *mut c_ulong, pto: phys_addr_t) {
...
#[no_mangle]
pub unsafe extern "C" fn validate_rf_entry(entry: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn validate_rs_entry(entry: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn validate_rt_entry(entry: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn validate_st_entry(entry: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn invalidate_pt_entry(entry: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn validate_pt_entry(entry: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn entry_set_protected(entry: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn entry_clr_protected(entry: *mut c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn reg_entry_isvalid(entry: c_ulong) -> c_int {
    static inline int reg_entry_isvalid(unsigned long entry)
    {
    return (entry & ZPCI_TABLE_VALID_MASK) == ZPCI_TABLE_VALID;
    }
#[no_mangle]
pub unsafe extern "C" fn pt_entry_isvalid(entry: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_alloc_cpu_table_caches() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dma_free_cpu_table(table: *mut c_void) {
    static void dma_free_cpu_table(void *table)
    {
    kmem_cache_free(dma_region_table_cache, table);
    }
#[no_mangle]
unsafe extern "C" fn dma_free_page_table(table: *mut c_void) {
    static void dma_free_page_table(void *table)
    {
    kmem_cache_free(dma_page_table_cache, table);
    }
#[no_mangle]
unsafe extern "C" fn dma_free_seg_table(entry: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn dma_free_rt_table(entry: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn dma_free_rs_table(entry: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn dma_cleanup_tables(domain: *mut s390_domain) {
...
// entry = ZPCI_PTE_INVALID;
    ...
    {
    let mut rsx: c_uint = calc_rsx(dma_addr);
...
// Somone else was faster, use theirs
    ...
    dma_addr_t dma_addr, gfp_t gfp)
    {
    let mut rfx: c_uint = calc_rfx(dma_addr);
...
#[no_mangle]
unsafe extern "C" fn dma_update_cpu_trans(ptep: *mut c_ulong, page_addr: phys_addr_t, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn s390_iommu_capable(dev: *mut device, cap: enum iommu_cap) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn max_tbl_size(domain: *mut s390_domain) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn s390_iommu_rcu_free_domain(head: *mut rcu_head) {
...
#[no_mangle]
unsafe extern "C" fn s390_domain_free(domain: *mut iommu_domain) {
...
#[no_mangle]
unsafe extern "C" fn get_iota_region_flag(domain: *mut s390_domain) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn reg_ioat_propagate_error(cc: c_int, status: u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_iommu_register_ioat(zdev: *mut zpci_dev, status: *mut u8) -> c_int {
    ...
    zdev.dma_table = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn zpci_refresh_all(zdev: *mut zpci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s390_iommu_flush_iotlb_all(domain: *mut iommu_domain) {
    ...
    {
    struct s390_domain *s390_domain = to_s390_domain(domain);
    let mut size: usize = gather.end - gather.start + 1;
    struct zpci_dev *zdev;
...
//
    ...
    gfp_t gfp)
    {
    let mut page_addr: phys_addr_t = pa & PAGE_MASK;
    unsigned long *entry;
    unsigned long i;
    int rc;
    ...
    {
    struct s390_domain *s390_domain = to_s390_domain(domain);
    let mut size: usize = pgcount << __ffs(pgsize);
    let mut flags: c_int = ZPCI_PTE_VALID, rc = 0;
    if (pgsize != SZ_4K)
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn zpci_init_iommu(zdev: *mut zpci_dev) -> c_int {
    int zpci_init_iommu(struct zpci_dev *zdev)
    {
    let mut rc: c_int = 0;
    rc = iommu_device_sysfs_add(&zdev.iommu_dev, core::ptr::null_mut(), core::ptr::null_mut(),
    "s390-iommu.%08x", zdev.fid);
    if (rc)
    goto out_err;
    if (zdev.rtr_avail) {
    rc = iommu_device_register(&zdev.iommu_dev,
    &s390_iommu_rtr_ops, core::ptr::null_mut());
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn zpci_destroy_iommu(zdev: *mut zpci_dev) {
...
#[no_mangle]
unsafe extern "C" fn s390_iommu_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn s390_iommu_aperture_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn s390_iommu_init() -> int __init {
