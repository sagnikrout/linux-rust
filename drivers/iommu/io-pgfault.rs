...
//! Source: drivers/iommu/io-pgfault.c
#![no_std]
...
//
    ...
    fault_param = core::ptr::null_mut();
    rcu_read_unlock();
    return fault_param;
    }
// Caller must hold a reference of the fault parameter.
#[no_mangle]
unsafe extern "C" fn iopf_put_dev_fault_param(fault_param: *mut iommu_fault_param) {
...
#[no_mangle]
unsafe extern "C" fn __iopf_free_group(group: *mut iopf_group) {
...
#[no_mangle]
pub unsafe extern "C" fn iopf_free_group(group: *mut iopf_group) {
...
#[no_mangle]
unsafe extern "C" fn iopf_error_response(dev: *mut device, evt: *mut iopf_fault) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iommu_report_device_fault(dev: *mut device, evt: *mut iopf_fault) -> c_int {
    int iommu_report_device_fault(struct device *dev, struct iopf_fault *evt)
    {
    struct iommu_attach_handle *attach_handle;
    struct iommu_fault *fault = &evt.fault;
    struct iommu_fault_param *iopf_param;
    let mut abort_group: iopf_group = {};
    struct iopf_group *group;
...
//
#[no_mangle]
pub unsafe extern "C" fn iopf_queue_flush_dev(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iopf_group_dequeue(group: *mut iopf_group) {
...
//
#[no_mangle]
pub unsafe extern "C" fn iopf_queue_discard_partial(queue: *mut iopf_queue) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iopf_queue_add_device(queue: *mut iopf_queue, dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iopf_queue_remove_device(queue: *mut iopf_queue, dev: *mut device) {
...
// dec the ref owned by iopf_queue_add_device()
    rcu_assign_pointer(param.fault_param, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn iopf_queue_free(queue: *mut iopf_queue) {
