...
//! Source: drivers/iommu/apple-dart.c
#![no_std]
...
pub const DART_MAX_STREAMS: c_int = 256;
pub const DART_MAX_TTBR: c_int = 4;
pub const MAX_DARTS_PER_DEVICE: c_int = 3;
// Common registers
pub const DART_PARAMS1: c_uint = 0x00;

pub const DART_PARAMS2: c_uint = 0x04;

// T8020/T6000 registers
pub const DART_T8020_STREAM_COMMAND: c_uint = 0x20;

pub const DART_T8020_STREAM_SELECT: c_uint = 0x34;
pub const DART_T8020_ERROR: c_uint = 0x40;

pub const DART_T8020_CONFIG: c_uint = 0x60;

pub const DART_STREAM_COMMAND_BUSY_TIMEOUT: c_int = 100;
pub const DART_T8020_ERROR_ADDR_HI: c_uint = 0x54;
pub const DART_T8020_ERROR_ADDR_LO: c_uint = 0x50;
pub const DART_T8020_STREAMS_ENABLE: c_uint = 0xfc;
pub const DART_T8020_TCR: c_uint = 0x100;

pub const DART_T8020_TTBR: c_uint = 0x200;
pub const DART_T8020_USB4_TTBR: c_uint = 0x400;

pub const DART_T8020_TTBR_ADDR_FIELD_SHIFT: c_int = 0;
pub const DART_T8020_TTBR_SHIFT: c_int = 12;
// T8110 registers
pub const DART_T8110_PARAMS3: c_uint = 0x08;

pub const DART_T8110_PARAMS4: c_uint = 0x0c;

pub const DART_T8110_TLB_CMD: c_uint = 0x80;

pub const DART_T8110_TLB_CMD_OP_FLUSH_ALL: c_int = 0;
pub const DART_T8110_TLB_CMD_OP_FLUSH_SID: c_int = 1;

pub const DART_T8110_ERROR: c_uint = 0x100;

pub const DART_T8110_ERROR_MASK: c_uint = 0x104;

pub const DART_T8110_ERROR_ADDR_LO: c_uint = 0x170;
pub const DART_T8110_ERROR_ADDR_HI: c_uint = 0x174;
pub const DART_T8110_ERROR_STREAMS: c_uint = 0x1c0;
pub const DART_T8110_PROTECT: c_uint = 0x200;
pub const DART_T8110_UNPROTECT: c_uint = 0x204;
pub const DART_T8110_PROTECT_LOCK: c_uint = 0x208;

pub const DART_T8110_ENABLE_STREAMS: c_uint = 0xc00;
pub const DART_T8110_DISABLE_STREAMS: c_uint = 0xc20;
pub const DART_T8110_TCR: c_uint = 0x1000;

pub const DART_T8110_TTBR: c_uint = 0x1400;

pub const DART_T8110_TTBR_ADDR_FIELD_SHIFT: c_int = 2;
pub const DART_T8110_TTBR_SHIFT: c_int = 14;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_dart_hw {
    pub type: enum dart_type,
    pub dev): *mut *mut irqreturn_t (irq_handler)(int irq, void,
    pub stream_map): *mut *mut int (invalidate_tlb)(struct apple_dart_stream_map,
    pub oas: u32,
    pub fmt: enum io_pgtable_fmt,
    pub max_sid_count: c_int,
    pub lock: u32,
    pub lock_bit: u32,
    pub error: u32,
    pub enable_streams: u32,
    pub tcr: u32,
    pub tcr_enabled: u32,
    pub tcr_disabled: u32,
    pub tcr_bypass: u32,
    pub tcr_4level: u32,
    pub ttbr: u32,
    pub ttbr_valid: u32,
    pub ttbr_addr_field_shift: u32,
    pub ttbr_shift: u32,
    pub ttbr_count: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_dart {
    pub dev: *mut device,
    pub hw: *const apple_dart_hw,
    ...
    pub pgsize: u32,
    pub num_streams: u32,
    pub 1: u32 supports_bypass :,
    pub 1: u32 four_level :,
    pub sid2group: [*mut iommu_group; DART_MAX_STREAMS],
    pub iommu: iommu_device,
    pub save_tcr: [u32; DART_MAX_STREAMS],
    pub save_ttbr: [u32; DART_MAX_STREAMS][DART_MAX_TTBR],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_dart_stream_map {
    pub dart: *mut apple_dart,
    pub DART_MAX_STREAMS): DECLARE_BITMAP(sidmap,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_dart_atomic_stream_map {
    pub dart: *mut apple_dart,
    pub sidmap: [atomic_long_t; BITS_TO_LONGS(DART_MAX_STREAMS)],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_dart_domain {
    pub pgtbl_ops: *mut io_pgtable_ops,
    pub finalized: bool,
    pub init_lock: mutex,
    pub stream_maps: [apple_dart_atomic_stream_map; MAX_DARTS_PER_DEVICE],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_dart_master_cfg {
// Intersection of DART capabilitles
    pub 1: u32 supports_bypass :,
    pub stream_maps: [apple_dart_stream_map; MAX_DARTS_PER_DEVICE],
}
...
//
    ...
    let mut tcr: u32 = dart.hw.tcr_enabled;
    int sid;
    if (levels == 4)
...
#[no_mangle]
unsafe extern "C" fn apple_dart_hw_disable_dma(stream_map: *mut apple_dart_stream_map) {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_hw_reset(dart: *mut apple_dart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_domain_flush_tlb(domain: *mut apple_dart_domain) {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_flush_iotlb_all(domain: *mut iommu_domain) {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_release_device(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_domain_free(domain: *mut iommu_domain) {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_release_group(iommu_data: *mut c_void) {
    ...
    stream_map.dart.sid2group[sid] = core::ptr::null_mut();
    kfree(iommu_data);
...
#[no_mangle]
unsafe extern "C" fn apple_dart_def_domain_type(dev: *mut device) -> c_int {
...
pub const CONFIG_PCIE_APPLE_MSI_DOORBELL_ADDR: c_int = 0;
    ...
    let mut prot: c_int = IOMMU_WRITE | IOMMU_NOEXEC | IOMMU_MMIO;
...
#[no_mangle]
unsafe extern "C" fn apple_dart_t8020_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t apple_dart_t8020_irq(int irq, void *dev)
    {
    struct apple_dart *dart = dev;
    const char *fault_name = core::ptr::null_mut();
    let mut error: u32 = readl(dart.regs + DART_T8020_ERROR);
    let mut error_code: u32 = FIELD_GET(DART_T8020_ERROR_CODE, error);
    let mut addr_lo: u32 = readl(dart.regs + DART_T8020_ERROR_ADDR_LO);
    let mut addr_hi: u32 = readl(dart.regs + DART_T8020_ERROR_ADDR_HI);
    let mut addr: u64 = addr_lo | (((u64)addr_hi) << 32);
    let mut stream_idx: u8 = FIELD_GET(DART_T8020_ERROR_STREAM, error);
...
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8020_ERROR_WRITE_FAULT: error_code ==) -> else {
    else if (error_code == DART_T8020_ERROR_WRITE_FAULT)
    fault_name = "WRITE FAULT";
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8020_ERROR_NO_PTE: error_code ==) -> else {
    else if (error_code == DART_T8020_ERROR_NO_PTE)
    fault_name = "NO PTE FOR IOVA";
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8020_ERROR_NO_PMD: error_code ==) -> else {
    else if (error_code == DART_T8020_ERROR_NO_PMD)
    fault_name = "NO PMD FOR IOVA";
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8020_ERROR_NO_TTBR: error_code ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_t8110_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
    static irqreturn_t apple_dart_t8110_irq(int irq, void *dev)
    {
    struct apple_dart *dart = dev;
    const char *fault_name = core::ptr::null_mut();
    let mut error: u32 = readl(dart.regs + DART_T8110_ERROR);
    let mut error_code: u32 = FIELD_GET(DART_T8110_ERROR_CODE, error);
    let mut addr_lo: u32 = readl(dart.regs + DART_T8110_ERROR_ADDR_LO);
    let mut addr_hi: u32 = readl(dart.regs + DART_T8110_ERROR_ADDR_HI);
    let mut addr: u64 = addr_lo | (((u64)addr_hi) << 32);
    let mut stream_idx: u8 = FIELD_GET(DART_T8110_ERROR_STREAM, error);
...
// there should only be a single bit set but let's use == to be sure
    ...
    fault_name = "READ FAULT";
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8110_ERROR_WRITE_FAULT: error_code ==) -> else {
    else if (error_code == DART_T8110_ERROR_WRITE_FAULT)
    fault_name = "WRITE FAULT";
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8110_ERROR_NO_PTE: error_code ==) -> else {
    else if (error_code == DART_T8110_ERROR_NO_PTE)
    fault_name = "NO PTE FOR IOVA";
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8110_ERROR_NO_PMD: error_code ==) -> else {
    else if (error_code == DART_T8110_ERROR_NO_PMD)
    fault_name = "NO PMD FOR IOVA";
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8110_ERROR_NO_PGD: error_code ==) -> else {
    else if (error_code == DART_T8110_ERROR_NO_PGD)
    fault_name = "NO PGD FOR IOVA";
#[no_mangle]
pub unsafe extern "C" fn if(DART_T8110_ERROR_NO_TTBR: error_code ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = iommu_device_sysfs_add(&dart.iommu, dev, core::ptr::null_mut(), "apple-dart.%s",
    dev_name(&pdev.dev));
    if (ret)
    goto err_free_irq;
...
#[no_mangle]
unsafe extern "C" fn apple_dart_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn apple_dart_resume(dev: *mut device) -> __maybe_unused int {
