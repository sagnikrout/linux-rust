...
//! Source: drivers/iommu/amd/iommu.c
#![no_std]
...
// Reserved IOVA ranges
    ...
    let mut amd_iommu_max_glx_val: c_int = -1;
//
...
//
#[no_mangle]
unsafe extern "C" fn amd_iommu_atomic128_set(ptr: *mut __int128, val: __int128) -> __always_inline void {
...
#[no_mangle]
unsafe extern "C" fn write_dte_upper128(ptr: *mut dev_table_entry, new: *mut dev_table_entry) {
...
#[no_mangle]
unsafe extern "C" fn write_dte_lower128(ptr: *mut dev_table_entry, new: *mut dev_table_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn pdom_is_v2_pgtbl_mode(pdom: *mut protection_domain) -> bool {
    static inline bool pdom_is_v2_pgtbl_mode(struct protection_domain *pdom)
    {
    return (pdom && (pdom.pd_mode == PD_MODE_V2));
    }
#[no_mangle]
pub unsafe extern "C" fn pdom_is_in_pt_mode(pdom: *mut protection_domain) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn pdom_is_sva_capable(pdom: *mut protection_domain) -> bool {
    ...
    struct acpihid_map_entry *p, *p1 = core::ptr::null_mut();
    let mut hid_count: c_int = 0;
    bool fw_bug;
    if (!adev)
    return -ENODEV;
    list_for_each_entry(p, &acpihid_map, list) {
    if (acpi_dev_hid_uid_match(adev, p.hid,
    p.uid[0] ? p.uid : core::ptr::null_mut())) {
    p1 = p;
    fw_bug = false;
    hid_count = 1;
    break;
...
#[no_mangle]
pub unsafe extern "C" fn get_device_sbdf_id(dev: *mut device) -> c_int {
    ...
    sbdf = get_acpihid_device_id(dev, core::ptr::null_mut());
    return sbdf;
    }
    ...
    BUG_ON(pci_seg == core::ptr::null_mut());
    dev_table = pci_seg.dev_table;
    BUG_ON(dev_table == core::ptr::null_mut());
    return dev_table;
    }
#[no_mangle]
pub unsafe extern "C" fn get_device_segment(dev: *mut device) -> u16 {
    ...
    let mut devid: u32 = get_acpihid_device_id(dev, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_set_rlookup_table(iommu: *mut amd_iommu, devid: u16) {
...
// IVRS may not describe every device on the bus
    ...
    {
    let mut seg: u16 = get_device_segment(dev);
    let mut devid: c_int = get_device_sbdf_id(dev);
    if (devid < 0)
    return core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn clone_alias(pdev_origin: *mut pci_dev, alias: u16, data: *mut c_void) -> c_int {
    ...
    let mut devid: u16 = pci_dev_id(pdev);
    let mut ret: c_int = 0;
    if (devid == alias)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn clone_aliases(iommu: *mut amd_iommu, dev: *mut device) {
    static void clone_aliases(struct amd_iommu *iommu, struct device *dev)
    {
    struct pci_dev *pdev;
    if (!dev_is_pci(dev))
...
#[no_mangle]
unsafe extern "C" fn setup_aliases(iommu: *mut amd_iommu, dev: *mut device) {
...
//
    ...
    {
    struct acpihid_map_entry *p, *entry = core::ptr::null_mut();
    int devid;
...
#[no_mangle]
pub unsafe extern "C" fn pdev_pasid_supported(dev_data: *mut iommu_dev_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pdev_get_caps(pdev: *mut pci_dev) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn pdev_enable_cap_ats(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdev_disable_cap_ats(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pdev_enable_cap_pri(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdev_disable_cap_pri(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pdev_enable_cap_pasid(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pdev_disable_cap_pasid(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pdev_enable_caps(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn pdev_disable_caps(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn check_device(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iommu_init_device(iommu: *mut amd_iommu, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_ignore_device(iommu: *mut amd_iommu, dev: *mut device) {
    ...
    return;
    devid = PCI_SBDF_TO_DEVID(sbdf);
    pci_seg.rlookup_table[devid] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn dump_dte_entry(iommu: *mut amd_iommu, devid: u16) {
...
#[no_mangle]
unsafe extern "C" fn dump_command(phys_addr: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_report_rmp_hw_error(iommu: *mut amd_iommu, event: *mut volatile u32) {
    static void amd_iommu_report_rmp_hw_error(struct amd_iommu *iommu, volatile u32 *event)
    {
    struct iommu_dev_data *dev_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_report_rmp_fault(iommu: *mut amd_iommu, event: *mut volatile u32) {
...
// Device not attached to domain properly
    if (dev_data.domain == core::ptr::null_mut()) {
    ...
    let mut pasid: u32 = PPR_PASID(*((u64 *)event));
    let mut tag: c_int = event[1] & 0x03FF;
    bool gn;
...
#[no_mangle]
unsafe extern "C" fn iommu_print_event(iommu: *mut amd_iommu, __evt: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn iommu_poll_events(iommu: *mut amd_iommu) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_register_ga_log_notifier((*notifier)(u32): *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_poll_ga_log(iommu: *mut amd_iommu) {
    static void iommu_poll_ga_log(struct amd_iommu *iommu)
    {
    u32 head, tail;
    if (iommu.ga_log == core::ptr::null_mut())
    return;
...
// Handle GA entry
    ...
    let mut status: u32 = readl(iommu.mmio_base + MMIO_STATUS_OFFSET);
    let mut mask: u32 = int_mask | overflow_mask;
    while (status & mask) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_int_thread_evtlog(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_int_thread_pprlog(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_int_thread_galog(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_int_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn dump_command_buffer(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn wait_on_sem(iommu: *mut amd_iommu, data: u64) -> c_int {
...
// Tell the IOMMU about it
    ...
    u64 data)
    {
    let mut paddr: u64 = iommu.cmd_sem_paddr;
...
#[no_mangle]
unsafe extern "C" fn build_inv_dte(cmd: *mut iommu_cmd, devid: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn build_inv_address(address: u64, last: u64) -> u64 {
...
//
    ...
    u32 flags)
    {
    let mut inv_address: u64 = build_inv_address(address, last);
    memset(cmd, 0, sizeof(*cmd));
    cmd.data[1] |= domid;
...
#[no_mangle]
unsafe extern "C" fn build_inv_all(cmd: *mut iommu_cmd) {
...
#[no_mangle]
unsafe extern "C" fn build_inv_irt(cmd: *mut iommu_cmd, devid: u16) {
...
#[no_mangle]
unsafe extern "C" fn iommu_queue_command(iommu: *mut amd_iommu, cmd: *mut iommu_cmd) -> c_int {
    static int iommu_queue_command(struct amd_iommu *iommu, struct iommu_cmd *cmd)
    {
    return iommu_queue_command_sync(iommu, cmd, true);
    }
#[no_mangle]
unsafe extern "C" fn get_cmdsem_val(iommu: *mut amd_iommu) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn iommu_completion_wait(iommu: *mut amd_iommu) -> c_int {
    static int iommu_completion_wait(struct amd_iommu *iommu)
    {
    struct iommu_cmd cmd;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn domain_flush_complete(domain: *mut protection_domain) {
...
#[no_mangle]
unsafe extern "C" fn iommu_flush_dte(iommu: *mut amd_iommu, devid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_flush_dte_sync(iommu: *mut amd_iommu, devid: u16) {
    static void iommu_flush_dte_sync(struct amd_iommu *iommu, u16 devid)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_flush_dte_all(iommu: *mut amd_iommu) {
    static void amd_iommu_flush_dte_all(struct amd_iommu *iommu)
    {
    u32 devid;
    let mut last_bdf: u16 = iommu.pci_seg.last_bdf;
...
//
#[no_mangle]
unsafe extern "C" fn amd_iommu_flush_tlb_all(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_flush_tlb_domid(iommu: *mut amd_iommu, dom_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_flush_all(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn iommu_flush_irt(iommu: *mut amd_iommu, devid: u16) {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_flush_irt_all(iommu: *mut amd_iommu) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_flush_all_caches(iommu: *mut amd_iommu) {
...
//
    ...
    struct iommu_cmd cmd;
    let mut qdep: c_int = dev_data.ats_qdep;
    build_inv_iotlb_pages(&cmd, dev_data.devid, qdep, address,
    last, pasid, gn);
    return iommu_queue_command(iommu, &cmd);
    }
#[no_mangle]
unsafe extern "C" fn device_flush_dte_alias(pdev: *mut pci_dev, alias: u16, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn device_flush_dte(dev_data: *mut iommu_dev_data) -> c_int {
    static int device_flush_dte(struct iommu_dev_data *dev_data)
    {
    struct amd_iommu *iommu = get_amd_iommu_from_dev_data(dev_data);
...
// Invalidate the entire contents of an IOTLB
    ...
    let mut domid: u16 = dev_data.gcr3_info.domid;
...
//
    ...
    struct iommu_dev_data *dev_data;
    let mut ret: c_int = 0;
    let mut pasid: ioasid_t = IOMMU_NO_PASID;
    let mut gn: bool = false;
    lockdep_assert_held(&domain.lock);
...
//
    while (address <= last) {
    let mut sz_lg2: c_uint = ilog2(last - address + 1);
    u64 flush_last;
    if (likely(address))
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_domain_flush_all(domain: *mut protection_domain) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_complete_ppr(dev: *mut device, pasid: u32, status: c_int, tag: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pdom_id_alloc() -> c_int {
    int amd_iommu_pdom_id_alloc(void)
    {
    return ida_alloc_range(&pdom_ids, 1, MAX_DOMAIN_ID - 1, GFP_ATOMIC);
    }
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pdom_id_reserve(id: u16, gfp: gfp_t) -> c_int {
    int amd_iommu_pdom_id_reserve(u16 id, gfp_t gfp)
    {
    return ida_alloc_range(&pdom_ids, id, id, gfp);
    }
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pdom_id_free(id: c_int) {
    void amd_iommu_pdom_id_free(int id)
    {
    ida_free(&pdom_ids, id);
    }
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pdom_id_destroy() {
    void amd_iommu_pdom_id_destroy(void)
    {
    ida_destroy(&pdom_ids);
    }
#[no_mangle]
unsafe extern "C" fn free_gcr3_tbl_level1(tbl: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn free_gcr3_tbl_level2(tbl: *mut u64) {
...
#[no_mangle]
unsafe extern "C" fn free_gcr3_table(gcr3_info: *mut gcr3_tbl_info) {
    static void free_gcr3_table(struct gcr3_tbl_info *gcr3_info)
    {
    if (gcr3_info.glx == 2)
    free_gcr3_tbl_level2(gcr3_info.gcr3_tbl);
#[no_mangle]
pub unsafe extern "C" fn if(1: gcr3_info->glx ==) -> else {
...
// Free per device domain ID
    ...
    gcr3_info.gcr3_tbl = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn get_gcr3_levels(pasids: c_int) -> c_int {
    ...
    {
    let mut levels: c_int = get_gcr3_levels(pasids);
    let mut nid: c_int = iommu ? dev_to_node(&iommu.dev.dev) : NUMA_NO_NODE;
    int domid;
...
// Allocate per device domain ID
    ...
    if (gcr3_info.gcr3_tbl == core::ptr::null_mut()) {
    ...
    let mut level: c_int = gcr3_info.glx;
    while (true) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_clear_gcr3(dev_data: *mut iommu_dev_data, pasid: ioasid_t) -> c_int {
...
//
    ...
    {
    struct gcr3_tbl_info *gcr3_info = &dev_data.gcr3_info;
    let mut gcr3: u64 = iommu_virt_to_phys(gcr3_info.gcr3_tbl);
...
// Guest page table can only support 4 and 5 levels
    ...
    struct dev_table_entry *new)
    {
    let mut host_pt_root: u64 = __sme_set(pt_info.host_pt_root);
...
#[no_mangle]
pub unsafe extern "C" fn if(IOMMU_DOMAIN_IDENTITY: domain->domain.type ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn clear_dte_entry(iommu: *mut amd_iommu, dev_data: *mut iommu_dev_data) {
...
#[no_mangle]
unsafe extern "C" fn dev_update_dte(dev_data: *mut iommu_dev_data, set: bool) {
...
//
    ...
    {
    struct amd_iommu *iommu = get_amd_iommu_from_dev_data(dev_data);
    let mut max_pasids: c_int = dev_data.max_pasids;
...
// Setup GCR3[0] only if domain is setup with v2 page table mode
    ...
    core::ptr::null_mut(), pdom_iommu_info, GFP_ATOMIC);
    if (curr) {
...
// Setup GCR3 table
    ...
    pdev = dev_is_pci(dev_data.dev) ? to_pci_dev(dev_data.dev) : core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn detach_device(dev: *mut device) {
...
// Update data structures
    dev_data.domain = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_release_device(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn protection_domain_init(domain: *mut protection_domain) {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_hd_support(iommu: *mut amd_iommu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_flush_iotlb_all(domain: *mut iommu_domain) {
...
//
    ...
    u32 flags)
    {
    let mut cfg: pt_iommu_x86_64_cfg = {};
    struct protection_domain *domain;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn is_nest_parent_supported(flags: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_domain_free(dom: *mut iommu_domain) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_init_identity_domain() {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_capable(dev: *mut device, cap: enum iommu_cap) -> bool {
    ...
    struct dev_table_entry *dte;
    struct iommu_dev_data *dev_data;
    let mut domain_flush: bool = false;
    struct amd_iommu *iommu;
    unsigned long flags;
    u64 new;
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_is_attach_deferred(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_def_domain_type(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_enforce_cache_coherency(domain: *mut iommu_domain) -> bool {
    static bool amd_iommu_enforce_cache_coherency(struct iommu_domain *domain)
    {
...
#[no_mangle]
unsafe extern "C" fn iommu_flush_dev_irt(unused: *mut pci_dev, devid: u16, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_flush_irt_and_complete(iommu: *mut amd_iommu, devid: u16) {
    ...
    ret = iommu_flush_dev_irt(core::ptr::null_mut(), devid, iommu);
    if (ret)
    goto out_err;
    ret = __iommu_queue_command_sync(iommu, &cmd, false);
    if (ret)
...
#[no_mangle]
pub unsafe extern "C" fn iommu_get_int_tablen(dev_data: *mut iommu_dev_data) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn get_irq_table_size(max_irqs: c_uint) -> usize {
    ...
    {
    struct irq_remap_table *table = core::ptr::null_mut();
    struct irq_remap_table *new_table = core::ptr::null_mut();
    struct amd_iommu_pci_seg *pci_seg;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn free_irte(iommu: *mut amd_iommu, devid: u16, index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn irte_activate(iommu: *mut amd_iommu, entry: *mut c_void, devid: u16, index: u16) {
...
#[no_mangle]
unsafe extern "C" fn irte_ga_activate(iommu: *mut amd_iommu, entry: *mut c_void, devid: u16, index: u16) {
...
#[no_mangle]
unsafe extern "C" fn irte_deactivate(iommu: *mut amd_iommu, entry: *mut c_void, devid: u16, index: u16) {
...
#[no_mangle]
unsafe extern "C" fn irte_ga_deactivate(iommu: *mut amd_iommu, entry: *mut c_void, devid: u16, index: u16) {
...
#[no_mangle]
unsafe extern "C" fn irte_set_allocated(table: *mut irq_remap_table, index: c_int) {
    static void irte_set_allocated(struct irq_remap_table *table, int index)
    {
    table.table[index] = IRTE_ALLOCATED;
    }
#[no_mangle]
unsafe extern "C" fn irte_ga_set_allocated(table: *mut irq_remap_table, index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn irte_is_allocated(table: *mut irq_remap_table, index: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn irte_ga_is_allocated(table: *mut irq_remap_table, index: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn irte_clear_allocated(table: *mut irq_remap_table, index: c_int) {
    static void irte_clear_allocated(struct irq_remap_table *table, int index)
    {
    table.table[index] = 0;
    }
#[no_mangle]
unsafe extern "C" fn irte_ga_clear_allocated(table: *mut irq_remap_table, index: c_int) {
...
#[no_mangle]
unsafe extern "C" fn get_devid(info: *mut irq_alloc_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fill_msi_msg(msg: *mut msi_msg, index: u32) {
...
//
    ...
    struct amd_ir_data *data = core::ptr::null_mut();
    struct amd_iommu *iommu;
    struct irq_cfg *cfg;
    struct iommu_dev_data *dev_data;
    unsigned long max_irqs;
    ...
    struct irq_remap_table *table;
    table = alloc_irq_table(iommu, devid, core::ptr::null_mut(), max_irqs);
    if (table) {
    if (!table.min_index) {
//
...
//
    ...
    let mut align: bool = (info.type == X86_IRQ_ALLOC_TYPE_PCI_MSI);
    index = alloc_irq_index(iommu, devid, nr_irqs, align,
    msi_desc_to_pci_dev(info.desc),
    max_irqs);
    } else {
    index = alloc_irq_index(iommu, devid, nr_irqs, false, core::ptr::null_mut(),
    max_irqs);
    }
    if (index < 0) {
    ...
    cfg = irq_data ? irqd_cfg(irq_data) : core::ptr::null_mut();
    if (!cfg) {
    ret = -EINVAL;
    goto out_free_data;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: x86_fwspec_is_hpet(fwspec)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_update_ga(data: *mut c_void, cpu: c_int, ga_log_intr: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_activate_guest_mode(data: *mut c_void, cpu: c_int, ga_log_intr: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_deactivate_guest_mode(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_ir_set_vcpu_affinity(data: *mut irq_data, info: *mut c_void) -> c_int {
    ...
    if (WARN_ON_ONCE(!AMD_IOMMU_GUEST_IR_VAPIC(amd_iommu_guest_ir)))
    return -EINVAL;
    if (ir_data.iommu == core::ptr::null_mut())
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ir_compose_msi_msg(irq_data: *mut irq_data, msg: *mut msi_msg) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_create_irq_domain(iommu: *mut amd_iommu) -> c_int {
