...
//! Source: drivers/iommu/amd/ppr.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_alloc_ppr_log(iommu: *mut amd_iommu) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_enable_ppr_log(iommu: *mut amd_iommu) {
    void amd_iommu_enable_ppr_log(struct amd_iommu *iommu)
    {
    u64 entry;
    if (iommu.ppr_log == core::ptr::null_mut())
    return;
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_free_ppr_log(iommu: *mut amd_iommu) -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_restart_ppr_log(iommu: *mut amd_iommu) {
...
#[no_mangle]
pub unsafe extern "C" fn ppr_flag_to_fault_perm(flag: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ppr_is_valid(iommu: *mut amd_iommu, raw: *mut u64) -> bool {
    static bool ppr_is_valid(struct amd_iommu *iommu, u64 *raw)
    {
    struct device *dev = iommu.iommu.dev;
    let mut devid: u16 = PPR_DEVID(raw[0]);
...
#[no_mangle]
unsafe extern "C" fn iommu_call_iopf_notifier(iommu: *mut amd_iommu, raw: *mut u64) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_poll_ppr_log(iommu: *mut amd_iommu) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_iopf_init(iommu: *mut amd_iommu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_iopf_uninit(iommu: *mut amd_iommu) {
