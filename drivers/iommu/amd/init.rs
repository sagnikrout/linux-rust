...
//! Source: drivers/iommu/amd/init.c
#![no_std]
...
//
pub const IVRS_HEADER_LENGTH: c_int = 48;
pub const ACPI_IVHD_TYPE_MAX_SUPPORTED: c_uint = 0x40;
pub const ACPI_IVMD_TYPE_ALL: c_uint = 0x20;
pub const ACPI_IVMD_TYPE: c_uint = 0x21;
pub const ACPI_IVMD_TYPE_RANGE: c_uint = 0x22;
pub const IVHD_DEV_ALL: c_uint = 0x01;
pub const IVHD_DEV_SELECT: c_uint = 0x02;
pub const IVHD_DEV_SELECT_RANGE_START: c_uint = 0x03;
pub const IVHD_DEV_RANGE_END: c_uint = 0x04;
pub const IVHD_DEV_ALIAS: c_uint = 0x42;
pub const IVHD_DEV_ALIAS_RANGE: c_uint = 0x43;
pub const IVHD_DEV_EXT_SELECT: c_uint = 0x46;
pub const IVHD_DEV_EXT_SELECT_RANGE: c_uint = 0x47;
pub const IVHD_DEV_SPECIAL: c_uint = 0x48;
pub const IVHD_DEV_ACPI_HID: c_uint = 0xf0;
pub const UID_NOT_PRESENT: c_int = 0;
pub const UID_IS_INTEGER: c_int = 1;
pub const UID_IS_CHARACTER: c_int = 2;
pub const IVHD_SPECIAL_IOAPIC: c_int = 1;
pub const IVHD_SPECIAL_HPET: c_int = 2;
pub const IVHD_FLAG_HT_TUN_EN_MASK: c_uint = 0x01;
pub const IVHD_FLAG_PASSPW_EN_MASK: c_uint = 0x02;
pub const IVHD_FLAG_RESPASSPW_EN_MASK: c_uint = 0x04;
pub const IVHD_FLAG_ISOC_EN_MASK: c_uint = 0x08;
pub const IVMD_FLAG_EXCL_RANGE: c_uint = 0x08;
pub const IVMD_FLAG_IW: c_uint = 0x04;
pub const IVMD_FLAG_IR: c_uint = 0x02;
pub const IVMD_FLAG_UNITY_MAP: c_uint = 0x01;
pub const ACPI_DEVFLAG_INITPASS: c_uint = 0x01;
pub const ACPI_DEVFLAG_EXTINT: c_uint = 0x02;
pub const ACPI_DEVFLAG_NMI: c_uint = 0x04;
pub const ACPI_DEVFLAG_SYSMGT1: c_uint = 0x10;
pub const ACPI_DEVFLAG_SYSMGT2: c_uint = 0x20;
pub const ACPI_DEVFLAG_LINT0: c_uint = 0x40;
pub const ACPI_DEVFLAG_LINT1: c_uint = 0x80;
pub const ACPI_DEVFLAG_ATSDIS: c_uint = 0x10000000;
...
// Following only valid on IVHD type 11h and 40h
    pub /: *mut *mut u64 efr_reg; / Exact copy of MMIO_EXT_FEATURES,
    pub efr_reg2: u64,
...
pub struct ivhd_entry {
    ...
    pub uid: u8,
    pub __attribute__((packed)): },
    pub EVTLOG_SIZE_DEF: int amd_iommu_evtlog_size =,
    pub PPRLOG_SIZE_DEF: int amd_iommu_pprlog_size =,
//
...
pub struct ivmd_header {
    ...
    pub __attribute__((packed)): },
    pub amd_iommu_dump: bool,
    pub __read_mostly: bool amd_iommu_irq_remap,
    pub PD_MODE_V1: enum protection_domain_mode amd_iommu_pgtable =,
// Virtual address size
    pub amd_iommu_hpt_vasize: u8,
// Guest page table level
    pub PAGE_MODE_4_LEVEL: int amd_iommu_gpt_level =,
    pub AMD_IOMMU_GUEST_IR_VAPIC: int amd_iommu_guest_ir =,
    pub IRQ_REMAP_XAPIC_MODE: static int amd_iommu_xt_mode =,
    pub amd_iommu_detected: static bool,
    pub __initdata: static bool amd_iommu_disabled,
    pub __initdata: static bool amd_iommu_force_enable,
    pub amd_iommu_irtcachedis: static bool,
    pub amd_iommu_target_ivhd_type: static int,
// Global EFR and EFR2 registers
    pub amd_iommu_efr: u64,
    pub amd_iommu_efr2: u64,
// Host (v1) page table is not supported
    pub amd_iommu_hatdis: bool,
// SNP is enabled on the system?
    pub amd_iommu_snp_en: bool,
// SNP page mode 0 support
    pub amd_iommu_snp_mode0_sup: bool,
    pub /: *mut *mut LIST_HEAD(amd_iommu_pci_seg_list); / list of all PCI segments,
    pub /: *mut *mut LIST_HEAD(amd_iommu_list); / list of all AMD IOMMUs in the system,
    pub /: *mut *mut LIST_HEAD(amd_ivhd_dev_flags_list); / list of all IVHD device entry settings,
// Number of IOMMUs present in the system
    pub amd_iommus_present: static int,
// IOMMUs have a non-present cache?
    pub __read_mostly: bool amd_iommu_np_cache,
    pub true: bool amd_iommu_iotlb_sup __read_mostly =,
    pub __read_mostly: static bool amd_iommu_pc_present,
    pub __read_mostly: bool amdr_ivrs_remap_support,
    pub __read_mostly: bool amd_iommu_force_isolation,
    pub AMD_IOMMU_PGSIZES: unsigned long amd_iommu_pgsize_bitmap __ro_after_init =,
...
pub const EARLY_MAP_SIZE: c_int = 4;
    ...
    let mut init_state: static enum iommu_init_state = IOMMU_START_STATE;
    static int amd_iommu_enable_interrupts(void);
    static void init_device_table_dma(struct amd_iommu_pci_seg *pci_seg);
    let mut amd_iommu_pre_enabled: static bool = true;
    static u32 amd_iommu_ivinfo __initdata;
#[no_mangle]
pub unsafe extern "C" fn translation_pre_enabled(iommu: *mut amd_iommu) -> bool {
    bool translation_pre_enabled(struct amd_iommu *iommu)
    {
    return (iommu.flags & AMD_IOMMU_FLAG_TRANS_PRE_ENABLED);
    }
#[no_mangle]
unsafe extern "C" fn clear_translation_pre_enabled(iommu: *mut amd_iommu) {
    static void clear_translation_pre_enabled(struct amd_iommu *iommu)
    {
    iommu.flags &= ~AMD_IOMMU_FLAG_TRANS_PRE_ENABLED;
    }
#[no_mangle]
unsafe extern "C" fn init_translation_status(iommu: *mut amd_iommu) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_get_num_iommus() -> c_int {
    int amd_iommu_get_num_iommus(void)
    {
    return amd_iommus_present;
    }
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_ht_range_ignore() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn get_global_efr() -> __init void {
    static __init void get_global_efr(void)
    {
    struct amd_iommu *iommu;
    for_each_iommu(iommu) {
    let mut tmp: u64 = iommu.features;
    let mut tmp2: u64 = iommu.features2;
...
#[no_mangle]
unsafe extern "C" fn iommu_read_l1(iommu: *mut amd_iommu, l1: u16, address: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn iommu_write_l1(iommu: *mut amd_iommu, l1: u16, address: u8, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn iommu_read_l2(iommu: *mut amd_iommu, address: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn iommu_write_l2(iommu: *mut amd_iommu, address: u8, val: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn iommu_set_cwwb_range(iommu: *mut amd_iommu) {
    static void iommu_set_cwwb_range(struct amd_iommu *iommu)
    {
    let mut start: u64 = iommu_virt_to_phys((void *)iommu.cmd_sem);
    let mut entry: u64 = start & PM_ADDR_MASK;
...
#[no_mangle]
unsafe extern "C" fn iommu_set_device_table(iommu: *mut amd_iommu) {
    static void iommu_set_device_table(struct amd_iommu *iommu)
    {
    u64 entry;
    let mut dev_table_size: u32 = iommu.pci_seg.dev_table_size;
    void *dev_table = (void *)get_dev_table(iommu);
    BUG_ON(iommu.mmio_base == core::ptr::null_mut());
    if (is_kdump_kernel())
    return;
...
#[no_mangle]
unsafe extern "C" fn iommu_feature_set(iommu: *mut amd_iommu, val: u64, mask: u64, shift: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn iommu_feature_enable(iommu: *mut amd_iommu, bit: u8) {
    void iommu_feature_enable(struct amd_iommu *iommu, u8 bit)
    {
    iommu_feature_set(iommu, 1ULL, 1ULL, bit);
    }
#[no_mangle]
unsafe extern "C" fn iommu_feature_disable(iommu: *mut amd_iommu, bit: u8) {
...
#[no_mangle]
unsafe extern "C" fn iommu_enable(iommu: *mut amd_iommu) {
    static void iommu_enable(struct amd_iommu *iommu)
    {
    iommu_feature_enable(iommu, CONTROL_IOMMU_EN);
    }
#[no_mangle]
unsafe extern "C" fn iommu_disable(iommu: *mut amd_iommu) {
...
//
#[no_mangle]
unsafe extern "C" fn iommu_map_mmio_space(address: u64, end: u64) -> *mut u8 __iomem  __init {
...
#[no_mangle]
unsafe extern "C" fn iommu_unmap_mmio_space(iommu: *mut amd_iommu) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn get_ivhd_header_size(h: *mut ivhd_header) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ivhd_entry_length(ivhd: *mut u8) -> c_int {
    static inline int ivhd_entry_length(u8 *ivhd)
    {
    let mut type: u32 = ((struct ivhd_entry *)ivhd).type;
    if (type < 0x80) {
    return 0x04 << (*ivhd >> 6);
...
//
#[no_mangle]
unsafe extern "C" fn find_last_devid_from_ivhd(h: *mut ivhd_header) -> int __init {
    static int __init find_last_devid_from_ivhd(struct ivhd_header *h)
    {
    u8 *p = (void *)h, *end = (void *)h;
    struct ivhd_entry *dev;
    let mut last_devid: c_int = -EINVAL;
    let mut ivhd_size: u32 = get_ivhd_header_size(h);
    if (!ivhd_size) {
...
#[no_mangle]
unsafe extern "C" fn check_ivrs_checksum(table: *mut acpi_table_header) -> int __init {
    static int __init check_ivrs_checksum(struct acpi_table_header *table)
    {
    int i;
    let mut checksum: u8 = 0, *p = (u8 *)table;
...
//
#[no_mangle]
unsafe extern "C" fn find_last_devid_acpi(table: *mut acpi_table_header, pci_seg: u16) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn alloc_dev_table(pci_seg: *mut amd_iommu_pci_seg) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn free_dev_table(pci_seg: *mut amd_iommu_pci_seg) {
    ...
    pci_seg.dev_table = core::ptr::null_mut();
    }
// Allocate per PCI segment IOMMU rlookup table.
#[no_mangle]
pub unsafe extern "C" fn alloc_rlookup_table(pci_seg: *mut amd_iommu_pci_seg) -> int __init {
    static inline int __init alloc_rlookup_table(struct amd_iommu_pci_seg *pci_seg)
    {
    pci_seg.rlookup_table = kvzalloc_objs(*pci_seg.rlookup_table,
    pci_seg.last_bdf + 1);
    if (pci_seg.rlookup_table == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn free_rlookup_table(pci_seg: *mut amd_iommu_pci_seg) {
    static inline void free_rlookup_table(struct amd_iommu_pci_seg *pci_seg)
    {
    kvfree(pci_seg.rlookup_table);
    pci_seg.rlookup_table = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn alloc_irq_lookup_table(pci_seg: *mut amd_iommu_pci_seg) -> int __init {
    static inline int __init alloc_irq_lookup_table(struct amd_iommu_pci_seg *pci_seg)
    {
    pci_seg.irq_lookup_table = kvzalloc_objs(*pci_seg.irq_lookup_table,
    pci_seg.last_bdf + 1);
    if (pci_seg.irq_lookup_table == core::ptr::null_mut())
    return -ENOMEM;
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn free_irq_lookup_table(pci_seg: *mut amd_iommu_pci_seg) {
    static inline void free_irq_lookup_table(struct amd_iommu_pci_seg *pci_seg)
    {
    kvfree(pci_seg.irq_lookup_table);
    pci_seg.irq_lookup_table = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn alloc_alias_table(pci_seg: *mut amd_iommu_pci_seg) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn free_alias_table(pci_seg: *mut amd_iommu_pci_seg) -> void __init {
    static void __init free_alias_table(struct amd_iommu_pci_seg *pci_seg)
    {
    kvfree(pci_seg.alias_table);
    pci_seg.alias_table = core::ptr::null_mut();
    }
...
//
    ...
    return ( void *)ioremap_encrypted(phys, size);
    else
...
//
#[no_mangle]
unsafe extern "C" fn alloc_command_buffer(iommu: *mut amd_iommu) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_restart_event_logging(iommu: *mut amd_iommu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_restart_ga_log(iommu: *mut amd_iommu) {
...
//
#[no_mangle]
unsafe extern "C" fn amd_iommu_reset_cmd_buffer(iommu: *mut amd_iommu) {
...
//
#[no_mangle]
unsafe extern "C" fn iommu_enable_command_buffer(iommu: *mut amd_iommu) {
    static void iommu_enable_command_buffer(struct amd_iommu *iommu)
    {
    u64 entry;
    BUG_ON(iommu.cmd_buf == core::ptr::null_mut());
    if (!is_kdump_kernel()) {
//
...
//
#[no_mangle]
unsafe extern "C" fn iommu_disable_command_buffer(iommu: *mut amd_iommu) {
    static void iommu_disable_command_buffer(struct amd_iommu *iommu)
    {
    iommu_feature_disable(iommu, CONTROL_CMDBUF_EN);
    }
#[no_mangle]
unsafe extern "C" fn free_command_buffer(iommu: *mut amd_iommu) -> void __init {
    ...
    size_t size)
    {
    let mut nid: c_int = iommu.dev ? dev_to_node(&iommu.dev.dev) : NUMA_NO_NODE;
    void *buf;
...
#[no_mangle]
unsafe extern "C" fn alloc_event_buffer() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iommu_enable_event_buffer() {
    static void iommu_enable_event_buffer(void)
    {
    struct amd_iommu *iommu;
    u64 entry;
    for_each_iommu(iommu) {
    BUG_ON(iommu.evt_buf == core::ptr::null_mut());
    if (!is_kdump_kernel()) {
//
...
//
#[no_mangle]
unsafe extern "C" fn iommu_disable_event_buffer(iommu: *mut amd_iommu) {
    static void iommu_disable_event_buffer(struct amd_iommu *iommu)
    {
    iommu_feature_disable(iommu, CONTROL_EVT_LOG_EN);
    }
#[no_mangle]
unsafe extern "C" fn free_event_buffer(iommu: *mut amd_iommu) -> void __init {
    static void __init free_event_buffer(struct amd_iommu *iommu)
    {
    iommu_free_pages(iommu.evt_buf);
    }
#[no_mangle]
unsafe extern "C" fn free_ga_log(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn iommu_ga_log_enable(iommu: *mut amd_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_init_ga_log(iommu: *mut amd_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alloc_cwwb_sem(iommu: *mut amd_iommu) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn remap_event_buffer() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn remap_command_buffer(iommu: *mut amd_iommu) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn remap_or_alloc_cwwb_sem(iommu: *mut amd_iommu) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn alloc_iommu_buffers(iommu: *mut amd_iommu) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn free_cwwb_sem(iommu: *mut amd_iommu) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn unmap_cwwb_sem(iommu: *mut amd_iommu) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn unmap_command_buffer(iommu: *mut amd_iommu) -> void __init {
    static void __init unmap_command_buffer(struct amd_iommu *iommu)
    {
    memunmap((void *)iommu.cmd_buf);
    }
#[no_mangle]
unsafe extern "C" fn unmap_event_buffer(iommu: *mut amd_iommu) -> void __init {
    static void __init unmap_event_buffer(struct amd_iommu *iommu)
    {
    memunmap(iommu.evt_buf);
    }
#[no_mangle]
unsafe extern "C" fn free_iommu_buffers(iommu: *mut amd_iommu) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn iommu_enable_xt(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn iommu_enable_gt(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn set_dte_bit(dte: *mut dev_table_entry, bit: u8) {
    static void set_dte_bit(struct dev_table_entry *dte, u8 bit)
    {
    let mut i: c_int = (bit >> 6) & 0x03;
    let mut _bit: c_int = bit & 0x3f;
    dte.data[i] |= (1UL << _bit);
    }
#[no_mangle]
unsafe extern "C" fn __reuse_device_table(iommu: *mut amd_iommu) -> bool {
...
//
    ...
    if (pci_seg.old_dev_tbl_cpy == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn reuse_device_table() -> bool {
...
//
    ...
    let mut best_len: c_uint = UINT_MAX;
    struct dev_table_entry *dte = core::ptr::null_mut();
...
//
    ...
    let mut len: c_uint = e.devid_last - e.devid_first;
    if (len < best_len) {
    dte = &(e.dte);
    best_len = len;
    }
...
#[no_mangle]
unsafe extern "C" fn search_ivhd_dte_flags(segid: u16, first: u16, last: u16) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn add_special_device(type: u8, id: u8, devid: *mut u32, cmd_line: bool) -> int __init {
    ...
    list = &ioapic_map;
#[no_mangle]
pub unsafe extern "C" fn if(IVHD_SPECIAL_HPET: type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn add_early_maps() -> int __init {
...
//
    ...
    u8 *p = (u8 *)h;
    u8 *end = p, flags = 0;
    let mut devid: u16 = 0, devid_start = 0, devid_to = 0, seg_id;
    u32 dev_i, ext_flags = 0;
    let mut alias: bool = false;
    struct ivhd_entry *e;
    struct amd_iommu_pci_seg *pci_seg = iommu.pci_seg;
    u32 ivhd_size;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn free_pci_segments() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn free_sysfs(iommu: *mut amd_iommu) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn free_iommu_one(iommu: *mut amd_iommu) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn free_iommu_all() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn amd_iommu_erratum_746_workaround(iommu: *mut amd_iommu) {
...
//
#[no_mangle]
unsafe extern "C" fn amd_iommu_ats_write_check_workaround(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn init_iommu_one_late(iommu: *mut amd_iommu) -> int __init {
...
//
    iommu.pci_seg.rlookup_table[iommu.devid] = core::ptr::null_mut();
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn get_highest_supported_ivhd_type(ivrs: *mut acpi_table_header) -> u8 {
    static u8 get_highest_supported_ivhd_type(struct acpi_table_header *ivrs)
    {
    u8 *base = (u8 *)ivrs;
    struct ivhd_header *ivhd = (struct ivhd_header *)
    (base + IVRS_HEADER_LENGTH);
    let mut last_type: u8 = ivhd.type;
    let mut devid: u16 = ivhd.devid;
...
//
#[no_mangle]
unsafe extern "C" fn init_iommu_all(table: *mut acpi_table_header) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn init_iommu_perf_ctr(iommu: *mut amd_iommu) {
    ...
    static DEVICE_ATTR(cap, S_IRUGO, amd_iommu_show_cap, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(features, S_IRUGO, amd_iommu_show_features, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn late_iommu_features_init(iommu: *mut amd_iommu) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn iommu_init_pci(iommu: *mut amd_iommu) -> int __init {
    static int __init iommu_init_pci(struct amd_iommu *iommu)
    {
    let mut cap_ptr: c_int = iommu.cap_ptr;
    int ret;
...
//
    ...
    ret = iommu_device_register(&iommu.iommu, &amd_iommu_ops, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn print_iommu_info() {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_init_pci() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn iommu_setup_msi(iommu: *mut amd_iommu) -> c_int {
    ...
    if (r)
    return r;
    r = request_threaded_irq(iommu.dev.irq, core::ptr::null_mut(), amd_iommu_int_thread,
...
#[no_mangle]
unsafe extern "C" fn intcapxt_unmask_irq(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn intcapxt_mask_irq(irqd: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn intcapxt_set_wake(irqd: *mut irq_data, on: c_uint) -> c_int {
...
// No need for locking here (yet) as the init is single-threaded
    ...
    int irq, ret;
    let mut node: c_int = dev_to_node(&iommu.dev.dev);
    domain = iommu_get_irqdomain();
    if (!domain)
    return -ENXIO;
    init_irq_alloc_info(&info, core::ptr::null_mut());
    ...
    ret = request_threaded_irq(irq, core::ptr::null_mut(), thread_fn, IRQF_ONESHOT, devname,
    iommu);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn iommu_setup_intcapxt(iommu: *mut amd_iommu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_init_irq(iommu: *mut amd_iommu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: iommu->dev->msi_cap) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn free_unity_maps() -> void __init {
...
// called for unity map ACPI definition
    ...
    struct acpi_table_header *ivrs_base)
    {
    struct unity_map_entry *e = core::ptr::null_mut();
    struct amd_iommu_pci_seg *pci_seg;
    char *s;
...
#[no_mangle]
unsafe extern "C" fn init_memory_definitions(table: *mut acpi_table_header) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn init_device_table_dma(pci_seg: *mut amd_iommu_pci_seg) {
    static void init_device_table_dma(struct amd_iommu_pci_seg *pci_seg)
    {
    u32 devid;
...
#[no_mangle]
unsafe extern "C" fn uninit_device_table_dma(pci_seg: *mut amd_iommu_pci_seg) -> void __init {
    static void __init uninit_device_table_dma(struct amd_iommu_pci_seg *pci_seg)
    {
    u32 devid;
    struct dev_table_entry *dev_table = pci_seg.dev_table;
    if (dev_table == core::ptr::null_mut())
    return;
    for (devid = 0; devid <= pci_seg.last_bdf; ++devid) {
...
#[no_mangle]
unsafe extern "C" fn init_device_table() {
...
#[no_mangle]
unsafe extern "C" fn iommu_init_flags(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn iommu_apply_resume_quirks(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn iommu_enable_ga(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn iommu_disable_irtcachedis(iommu: *mut amd_iommu) {
    static void iommu_disable_irtcachedis(struct amd_iommu *iommu)
    {
    iommu_feature_disable(iommu, CONTROL_IRTCACHEDIS);
    }
#[no_mangle]
unsafe extern "C" fn iommu_enable_irtcachedis(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn iommu_enable_2k_int(iommu: *mut amd_iommu) {
...
#[no_mangle]
unsafe extern "C" fn early_enable_iommu(iommu: *mut amd_iommu) {
...
//
#[no_mangle]
unsafe extern "C" fn early_enable_iommus() {
...
//
    ...
    pci_seg.old_dev_tbl_cpy = core::ptr::null_mut();
    }
    }
    for_each_iommu(iommu) {
    clear_translation_pre_enabled(iommu);
...
#[no_mangle]
unsafe extern "C" fn enable_iommus_ppr() {
...
#[no_mangle]
unsafe extern "C" fn enable_iommus_vapic() {
...
#[no_mangle]
unsafe extern "C" fn disable_iommus() {
...
//
#[no_mangle]
unsafe extern "C" fn amd_iommu_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_iommu_resources() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn check_sb_ioapic(devid: c_int) -> bool __init {
    static bool __init check_sb_ioapic(int devid)
    {
    let mut bus: u8 = PCI_BUS_NUM(devid);
    let mut devfn: u8 = devid & 0xff;
    u16 val;
...
//
    let mut val: return = = PCI_CLASS_SERIAL_SMBUS || val == PCI_CLASS_BRIDGE_ISA;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn get_sb_ioapic_id() -> int __init {
    static int __init get_sb_ioapic_id(void)
    {
    let mut idx: c_int = mp_find_ioapic(0);
    if (idx < 0)
    return -ENODEV;
    return mpc_ioapic_id(idx);
    }
#[no_mangle]
unsafe extern "C" fn check_ioapic_information() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn free_dma_resources() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn ivinfo_init(ivrs: *mut c_void) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn early_amd_iommu_init() -> int __init {
    ...
    return -ENODEV;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ACPI_FAILURE(status)) -> else {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_enable_interrupts() -> c_int {
    static int amd_iommu_enable_interrupts(void)
    {
    struct amd_iommu *iommu;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn detect_ivrs() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn iommu_snp_enable() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_apply_erratum_snp() {
...
//
#[no_mangle]
unsafe extern "C" fn state_next() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn iommu_go_to_state(state: enum iommu_init_state) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_prepare() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_enable() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_disable() {
    void amd_iommu_disable(void)
    {
    amd_iommu_suspend(core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_reenable(mode: c_int) -> c_int {
    int amd_iommu_reenable(int mode)
    {
    amd_iommu_resume(core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_enable_faulting(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd_iommu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn amd_iommu_sme_check() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_detect() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn parse_amd_iommu_dump(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_amd_iommu_intr(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_amd_iommu_options(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_ivrs_ioapic(str: *mut c_char) -> int __init {
    static int __init parse_ivrs_ioapic(char *str)
    {
    let mut seg: u32 = 0, bus, dev, fn;
    int id, i;
    u32 devid;
...
#[no_mangle]
unsafe extern "C" fn parse_ivrs_hpet(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn parse_ivrs_acpihid(str: *mut c_char) -> int __init {
    static int __init parse_ivrs_acpihid(char *str)
    {
    let mut seg: u32 = 0, bus, dev, fn;
    char *hid, *uid, *p, *addr;
    char acpiid[ACPIID_LEN + 1] = { }; /* size with core::ptr::null_mut() terminator */
    int i;
    addr = strchr(str, '@');
    if (!addr) {
    addr = strchr(str, '=');
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pasid_supported() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pc_get_max_banks(idx: c_uint) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pc_supported() -> bool {
    bool amd_iommu_pc_supported(void)
    {
    return amd_iommu_pc_present;
    }
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pc_get_max_counters(idx: c_uint) -> u8 {
...
// Limit the offset to the hw defined mmio region aperture
    ...
    return -EINVAL;
    if (is_write) {
    let mut val: u64 = *value & GENMASK_ULL(47, 0);
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pc_get_reg(iommu: *mut amd_iommu, bank: u8, cntr: u8, fxn: u8, value: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_pc_set_reg(iommu: *mut amd_iommu, bank: u8, cntr: u8, fxn: u8, value: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_page_make_shared(page: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iommu_make_shared(va: *mut c_void, size: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_snp_disable() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_iommu_sev_tio_supported() -> bool {
