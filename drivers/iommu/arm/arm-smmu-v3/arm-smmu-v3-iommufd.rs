...
//! Source: drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3-iommufd.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn arm_smmu_attach_commit_vmaster(state: *mut arm_smmu_attach_state) {
...
#[no_mangle]
pub unsafe extern "C" fn arm_smmu_master_clear_vmaster(master: *mut arm_smmu_master) {
    void arm_smmu_master_clear_vmaster(struct arm_smmu_master *master)
    {
    let mut state: arm_smmu_attach_state = { .master = master };
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_domain_nested_free(domain: *mut iommu_domain) {
...
#[no_mangle]
unsafe extern "C" fn arm_vsmmu_vsid_to_sid(vsmmu: *mut arm_vsmmu, vsid: u32, sid: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_vsmmu_vdevice_init(vdev: *mut iommufd_vdevice) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arm_vsmmu_invalidation_cmd {
    union {
    pub cmd: arm_smmu_cmd,
    pub ucmd: iommu_viommu_arm_smmuv3_invalidate,
}
...
#[no_mangle]
pub unsafe extern "C" fn arm_vmaster_report_event(vmaster: *mut arm_smmu_vmaster, evt: *mut u64) -> c_int {
