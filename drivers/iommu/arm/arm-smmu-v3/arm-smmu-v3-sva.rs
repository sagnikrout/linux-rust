...
//! Source: drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3-sva.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn page_size_to_cd() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_mm_release(mn: *mut mmu_notifier, mm: *mut mm_struct) {
...
//
    ...
    if (WARN_ON(!cdptr))
    continue;
    arm_smmu_make_sva_cd(&target, master, core::ptr::null_mut(),
    smmu_domain.cd.asid);
    arm_smmu_write_cd_entry(master, master_domain.ssid, cdptr,
    &target);
    }
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_mmu_notifier_free(mn: *mut mmu_notifier) {
...
#[no_mangle]
pub unsafe extern "C" fn arm_smmu_sva_supported(smmu: *mut arm_smmu_device) -> bool {
    bool arm_smmu_sva_supported(struct arm_smmu_device *smmu)
    {
    unsigned long reg, fld;
    unsigned long oas;
    unsigned long asid_bits;
    let mut feat_mask: u32 = ARM_SMMU_FEAT_COHERENCY;
    if (vabits_actual == 52) {
...
#[no_mangle]
pub unsafe extern "C" fn arm_smmu_sva_notifier_synchronize() {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_sva_domain_free(domain: *mut iommu_domain) {
