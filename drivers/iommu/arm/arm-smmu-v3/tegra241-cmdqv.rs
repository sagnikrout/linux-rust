...
//! Source: drivers/iommu/arm/arm-smmu-v3/tegra241-cmdqv.c
#![no_std]
...
pub const TEGRA241_CMDQV_CONFIG: c_uint = 0x0000;

pub const TEGRA241_CMDQV_PARAM: c_uint = 0x0004;

pub const TEGRA241_CMDQV_STATUS: c_uint = 0x0008;

pub const TEGRA241_CMDQV_VINTF_ERR_MAP: c_uint = 0x0014;
pub const TEGRA241_CMDQV_VINTF_INT_MASK: c_uint = 0x001C;

// VINTF base regs

pub const TEGRA241_VINTF_CONFIG: c_uint = 0x0000;

pub const TEGRA241_VINTF_STATUS: c_uint = 0x0004;

    (0x00C0 + 0x8*(m))
pub const LVCMDQ_ERR_MAP_NUM_64: c_int = 2;
// VCMDQ base regs
// -- PAGE0 --

pub const TEGRA241_VCMDQ_CONS: c_uint = 0x00000;

pub const TEGRA241_VCMDQ_PROD: c_uint = 0x00004;
pub const TEGRA241_VCMDQ_CONFIG: c_uint = 0x00008;

pub const TEGRA241_VCMDQ_STATUS: c_uint = 0x0000C;

pub const TEGRA241_VCMDQ_GERROR: c_uint = 0x00010;
pub const TEGRA241_VCMDQ_GERRORN: c_uint = 0x00014;
// -- PAGE1 --

pub const TEGRA241_VCMDQ_BASE: c_uint = 0x00000;
pub const TEGRA241_VCMDQ_CONS_INDX_BASE: c_uint = 0x00008;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra241_vcmdq {
    pub core: iommufd_hw_queue,
    pub idx: u16,
    pub lidx: u16,
    pub enabled: bool,
    pub cmdqv: *mut tegra241_cmdqv,
    pub vintf: *mut tegra241_vintf,
    pub prev: *mut tegra241_vcmdq,
    pub cmdq: arm_smmu_cmdq,
    pub page0: *mut void __iomem,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra241_vintf {
    pub vsmmu: arm_vsmmu,
    pub idx: u16,
    pub enabled: bool,
    pub hyp_own: bool,
    pub cmdqv: *mut tegra241_cmdqv,
    pub lvcmdqs: *mut tegra241_vcmdq,
    pub /: *mut *mut mutex lvcmdq_mutex; / user space race,
    pub base: *mut void __iomem,
    pub mmap_offset: c_ulong,
    pub sids: ida,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra241_vintf_sid {
    pub core: iommufd_vdevice,
    pub vintf: *mut tegra241_vintf,
    pub sid: u32,
    pub idx: u8,
}
...
// CMDQV Hardware Params
    pub num_vintfs: u16,
    pub num_vcmdqs: u16,
    pub num_lvcmdqs_per_vintf: u16,
    pub num_sids_per_vintf: u16,
    pub vintf_ids: ida,
    pub vintfs: *mut tegra241_vintf,
}
...
#[no_mangle]
pub unsafe extern "C" fn cmdqv_write_config(cmdqv: *mut tegra241_cmdqv, regval: u32) -> c_int {
    ...
    regval, "CMDQV: ", core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn vintf_write_config(vintf: *mut tegra241_vintf, regval: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vcmdq_write_config(vcmdq: *mut tegra241_vcmdq, regval: u32) -> c_int {
...
// ISR Functions
#[no_mangle]
unsafe extern "C" fn tegra241_vintf_user_handle_error(vintf: *mut tegra241_vintf) {
    ...
    let mut err: u64 = readq_relaxed(REG_VINTF(vintf, LVCMDQ_ERR_MAP_64(i)));
...
#[no_mangle]
unsafe extern "C" fn tegra241_vintf0_handle_error(vintf: *mut tegra241_vintf) {
    static void tegra241_vintf0_handle_error(struct tegra241_vintf *vintf)
    {
    struct tegra241_cmdqv *cmdqv = vintf.cmdqv;
    int i;
    for (i = 0; i < LVCMDQ_ERR_MAP_NUM_64; i++) {
    let mut map: u64 = readq_relaxed(REG_VINTF(vintf, LVCMDQ_ERR_MAP_64(i)));
    while (map) {
    let mut map_bit: c_ulong = __ffs64(map);
    let mut lidx: c_ulong = 64 * i + map_bit;
...
//
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_isr(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
// Handle other user VINTFs and their LVCMDQs
    while (vintf_map) {
    let mut idx: c_ulong = __ffs64(vintf_map);
...
#[no_mangle]
unsafe extern "C" fn tegra241_guest_vcmdq_supports_cmd(cmd: *mut arm_smmu_cmd) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn tegra241_vcmdq_hw_flush_timeout(vcmdq: *mut tegra241_vcmdq) {
    static void tegra241_vcmdq_hw_flush_timeout(struct tegra241_vcmdq *vcmdq)
    {
    struct arm_smmu_device *smmu = &vcmdq.cmdqv.smmu;
    let mut cmd_sync: arm_smmu_cmd = {};
...
#[no_mangle]
unsafe extern "C" fn tegra241_vcmdq_hw_deinit(vcmdq: *mut tegra241_vcmdq) {
...
#[no_mangle]
unsafe extern "C" fn tegra241_vcmdq_hw_init(vcmdq: *mut tegra241_vcmdq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra241_vcmdq_unmap_lvcmdq(vcmdq: *mut tegra241_vcmdq) {
    static void tegra241_vcmdq_unmap_lvcmdq(struct tegra241_vcmdq *vcmdq)
    {
    let mut regval: u32 = readl(REG_CMDQV(vcmdq.cmdqv, CMDQ_ALLOC(vcmdq.idx)));
    char header[64], *h = lvcmdq_error_header(vcmdq, header, 64);
...
#[no_mangle]
unsafe extern "C" fn tegra241_vintf_hw_deinit(vintf: *mut tegra241_vintf) {
    static void tegra241_vintf_hw_deinit(struct tegra241_vintf *vintf)
    {
    let mut lidx: u16 = vintf.cmdqv.num_lvcmdqs_per_vintf;
    int sidx;
...
#[no_mangle]
unsafe extern "C" fn tegra241_vcmdq_map_lvcmdq(vcmdq: *mut tegra241_vcmdq) {
...
#[no_mangle]
unsafe extern "C" fn tegra241_vintf_hw_init(vintf: *mut tegra241_vintf, hyp_own: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_hw_reset(smmu: *mut arm_smmu_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra241_vcmdq_alloc_smmu_cmdq(vcmdq: *mut tegra241_vcmdq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra241_vintf_free_lvcmdq(vintf: *mut tegra241_vintf, lidx: u16) {
...
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_deinit_vintf(cmdqv: *mut tegra241_cmdqv, idx: u16) {
...
// destroy callback.
//
    WRITE_ONCE(cmdqv.vintfs[idx], core::ptr::null_mut());
    if (cmdqv.irq > 0)
...
// Remove Helpers
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_remove_vintf(cmdqv: *mut tegra241_cmdqv, idx: u16) {
...
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_hw_disable(smmu: *mut arm_smmu_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_remove(smmu: *mut arm_smmu_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_get_vintf_size(viommu_type: enum iommu_viommu_type) -> usize {
...
// Probe Functions
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_init_structures(smmu: *mut arm_smmu_device) -> c_int {
...
//
    if (cmdqv.irq > 0) {
    ret = request_threaded_irq(irq, core::ptr::null_mut(), tegra241_cmdqv_isr,
...
#[no_mangle]
unsafe extern "C" fn tegra241_vcmdq_hw_init_user(vcmdq: *mut tegra241_vcmdq) -> c_int {
...
// Configure the vcmdq only; User space does the enabling
    ...
    struct tegra241_vcmdq *prev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tegra241_cmdqv_destroy_vintf_user(viommu: *mut iommufd_viommu) {
...
#[no_mangle]
unsafe extern "C" fn tegra241_vintf_destroy_vsid(vdev: *mut iommufd_vdevice) {
...
#[no_mangle]
unsafe extern "C" fn tegra241_vintf_init_vsid(vdev: *mut iommufd_vdevice) -> c_int {
    ...
    let mut virt_sid: u64 = vdev.virt_id;
    int sidx;
