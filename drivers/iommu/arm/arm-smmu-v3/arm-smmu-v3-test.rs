...
//! Source: drivers/iommu/arm/arm-smmu-v3/arm-smmu-v3-test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arm_smmu_test_writer {
    pub writer: arm_smmu_entry_writer,
    pub test: *mut kunit,
    pub init_entry: *const __le64,
    pub target_entry: *const __le64,
    pub entry: *mut __le64,
    pub invalid_entry_written: bool,
    pub num_syncs: c_uint,
}

pub const NUM_ENTRY_QWORDS: c_int = 8;
    ...
    unsigned int i;
    for (i = 0; i < length; i++) {
    let mut used: __le64 = used_bits[i] & ~safe[i];
...
//
    ...
    bool hitless)
    {
    let mut cur_copy: arm_smmu_ste = *cur;
    struct arm_smmu_test_writer test_writer = {
    .writer = {
    .ops = &test_ste_ops,
    },
    ...
    let mut fake_cdtab_dma_addr: static dma_addr_t = 0xF0F0F0F0F0F0;
    static void arm_smmu_test_make_cdtable_ste(struct arm_smmu_ste *ste,
    unsigned int s1dss,
    const dma_addr_t dma_addr,
    enum arm_smmu_test_master_feat feat)
    {
    let mut ats_enabled: bool = feat & ARM_SMMU_MASTER_TEST_ATS;
    let mut stall_enabled: bool = feat & ARM_SMMU_MASTER_TEST_STALL;
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_bypass_to_abort(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_abort_to_bypass(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_cdtable_to_abort(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_abort_to_cdtable(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_cdtable_to_bypass(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_bypass_to_cdtable(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_cdtable_s1dss_change(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_s2_to_abort(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_abort_to_s2(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_s2_to_bypass(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_bypass_to_s2(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_s1_to_s2(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_s2_to_s1(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_non_hitless(test: *mut kunit) {
...
//
    ...
    bool hitless)
    {
    let mut cur_copy: arm_smmu_cd = *cur;
    struct arm_smmu_test_writer test_writer = {
    .writer = {
    .ops = &test_cd_ops,
    },
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_test_make_s1_cd(cd: *mut arm_smmu_cd, asid: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_cd_test_s1_clear(test: *mut kunit) {
    static void arm_smmu_v3_write_cd_test_s1_clear(struct kunit *test)
    {
    let mut cd: arm_smmu_cd = {};
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_cd_test_s1_change_asid(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_test_make_sva_cd(cd: *mut arm_smmu_cd, asid: c_uint) {
    ...
    arm_smmu_make_sva_cd(cd, &master, core::ptr::null_mut(), asid);
    }
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_s1_to_s2_stall(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_ste_test_s2_to_s1_stall(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_cd_test_sva_clear(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_write_cd_test_sva_release(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_invs_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_test_suite_init(test: *mut kunit_suite) -> c_int {
