...
//! Source: drivers/iommu/arm/arm-smmu/arm-smmu-nvidia.c
#![no_std]
...
// SMMU instance.
//
pub const MAX_SMMU_INSTANCES: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nvidia_smmu {
    pub smmu: arm_smmu_device,
    pub bases: [*mut void __iomem; MAX_SMMU_INSTANCES],
    pub num_instances: c_uint,
    pub mc: *mut tegra_mc,
}
...
#[no_mangle]
unsafe extern "C" fn nvidia_smmu_reset(smmu: *mut arm_smmu_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvidia_smmu_global_fault(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nvidia_smmu_context_fault(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nvidia_smmu_probe_finalize(smmu: *mut arm_smmu_device, dev: *mut device) {
