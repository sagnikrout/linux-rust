...
//! Source: drivers/iommu/hyperv/hv-irq-remap-x86.c
#![no_std]
...
//
pub const IOAPIC_REMAPPING_ENTRY: c_int = 24;
    let mut ioapic_max_cpumask: static cpumask_t = { CPU_BITS_NONE };
...
#[no_mangle]
unsafe extern "C" fn hyperv_prepare_irq_remapping() -> int __init {
...
//
    ...
    0, IOAPIC_REMAPPING_ENTRY, fn, ops, core::ptr::null_mut());
    if (!ioapic_ir_domain) {
...
#[no_mangle]
unsafe extern "C" fn hyperv_enable_irq_remapping() -> int __init {
