...
//
    ...
    rb_link_node(&iovad.anchor.node, core::ptr::null_mut(), &iovad.rbroot.rb_node);
...
// Figure out where to put new node
    ...
    new = &((*new).rb_left);
#[no_mangle]
pub unsafe extern "C" fn if(this->pfn_lo: iova->pfn_lo >) -> else {
...
// Add new node and rebalance tree.
    ...
    let mut align_mask: c_ulong = ~0UL;
    let mut high_pfn: c_ulong = limit_pfn, low_pfn = iovad.start_pfn;
    if (size_aligned)
...
#[no_mangle]
unsafe extern "C" fn free_iova_mem(iova: *mut iova) {
...
//
    ...
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(iova->pfn_hi: pfn >) -> else {
...
#[no_mangle]
unsafe extern "C" fn remove_iova(iovad: *mut iova_domain, iova: *mut iova) {
...
#[no_mangle]
unsafe extern "C" fn iova_domain_free_rcaches(iovad: *mut iova_domain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn put_iova_domain(iovad: *mut iova_domain) {
    ...
    if (iova)
    iova_insert_rbtree(&iovad.rbroot, iova, core::ptr::null_mut());
    return iova;
    }
    static void
...
//
pub const IOVA_MAG_SIZE: c_int = 127;
...
pub struct iova_rcache {
    pub lock: spinlock_t,
    pub depot_size: c_uint,
    pub depot: *mut iova_magazine,
    pub cpu_rcaches: *mut iova_cpu_rcache __percpu,
    pub iovad: *mut iova_domain,
    pub work: delayed_work,
}

    static struct kmem_cache *iova_magazine_cache;
#[no_mangle]
pub unsafe extern "C" fn iova_rcache_range() -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn iova_magazine_free(mag: *mut iova_magazine) {
...
#[no_mangle]
unsafe extern "C" fn iova_magazine_full(mag: *mut iova_magazine) -> bool {
    static bool iova_magazine_full(struct iova_magazine *mag)
    {
    return mag.size == IOVA_MAG_SIZE;
    }
#[no_mangle]
unsafe extern "C" fn iova_magazine_empty(mag: *mut iova_magazine) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iova_magazine_push(mag: *mut iova_magazine, pfn: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn iova_depot_push(rcache: *mut iova_rcache, mag: *mut iova_magazine) {
...
#[no_mangle]
unsafe extern "C" fn iova_depot_work_func(work: *mut work_struct) {
    ...
    struct iova_magazine *mag = core::ptr::null_mut();
    unsigned long flags;
...
#[no_mangle]
pub unsafe extern "C" fn iova_domain_init_rcaches(iovad: *mut iova_domain) -> c_int {
...
//
    ...
    unsigned long size)
    {
    let mut log_size: c_uint = order_base_2(size);
...
//
    ...
    {
    struct iova_cpu_rcache *cpu_rcache;
    let mut iova_pfn: c_ulong = 0;
    let mut has_pfn: bool = false;
    unsigned long flags;
    cpu_rcache = raw_cpu_ptr(rcache.cpu_rcaches);
    spin_lock_irqsave(&cpu_rcache.lock, flags);
...
//
#[no_mangle]
unsafe extern "C" fn free_iova_rcaches(iovad: *mut iova_domain) {
    static void free_iova_rcaches(struct iova_domain *iovad)
    {
    struct iova_rcache *rcache;
    struct iova_cpu_rcache *cpu_rcache;
    ...
    kfree(iovad.rcaches);
    iovad.rcaches = core::ptr::null_mut();
    }
//
// free all the IOVA ranges cached by a cpu (used when cpu is unplugged)
//
#[no_mangle]
unsafe extern "C" fn free_cpu_cached_iovas(cpu: c_uint, iovad: *mut iova_domain) {
    static void free_cpu_cached_iovas(unsigned int cpu, struct iova_domain *iovad)
    {
    struct iova_cpu_rcache *cpu_rcache;
    struct iova_rcache *rcache;
...
//
#[no_mangle]
unsafe extern "C" fn free_global_cached_iovas(iovad: *mut iova_domain) {
    static void free_global_cached_iovas(struct iova_domain *iovad)
    {
    struct iova_rcache *rcache;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn iova_cpuhp_dead(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iova_cache_get() -> c_int {
    ...
    core::ptr::null_mut(), iova_cpuhp_dead);
    if (err) {
...
#[no_mangle]
pub unsafe extern "C" fn iova_cache_put() {
