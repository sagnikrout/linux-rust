...
//! Source: drivers/iommu/omap-iommu-debug.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn is_omap_iommu_detached(obj: *mut omap_iommu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn omap_dump_tlb_entries(obj: *mut omap_iommu, s: *mut seq_file) -> usize {
...
#[no_mangle]
unsafe extern "C" fn tlb_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dump_ioptable(s: *mut seq_file) {
...
#[no_mangle]
unsafe extern "C" fn pagetable_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn omap_iommu_debugfs_add(obj: *mut omap_iommu) {
...
#[no_mangle]
pub unsafe extern "C" fn omap_iommu_debugfs_remove(obj: *mut omap_iommu) {
...
#[no_mangle]
pub unsafe extern "C" fn omap_iommu_debugfs_init() -> void __init {
    void __init omap_iommu_debugfs_init(void)
    {
    iommu_debug_root = debugfs_create_dir("omap_iommu", core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn omap_iommu_debugfs_exit() -> void __exit {
