...
//! Source: drivers/iommu/io-pgtable-arm-selftests.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dummy_tlb_flush_all(cookie: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn arm_lpae_run_tests(test: *mut kunit, cfg: *mut io_pgtable_cfg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_lpae_do_selftests(test: *mut kunit) {
