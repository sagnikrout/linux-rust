...
pub const VHOST_SCSI_NAMELEN: c_int = 256;
pub const VHOST_SCSI_MAX_CDB_SIZE: c_int = 32;
pub const VHOST_SCSI_PREALLOC_SGLS: c_int = 2048;
pub const VHOST_SCSI_PREALLOC_UPAGES: c_int = 2048;
pub const VHOST_SCSI_PREALLOC_PROT_SGLS: c_int = 2048;
//
// For the legacy descriptor case we allocate an iov per byte in the
// virtio_scsi_cmd_resp struct.
//

    let mut vhost_scsi_inline_sg_cnt: static unsigned int = VHOST_SCSI_PREALLOC_SGLS;
    ...
    module_param_cb(inline_sg_cnt, &vhost_scsi_inline_sg_cnt_op, core::ptr::null_mut(), 0644);
...
// request.
//
pub const VHOST_SCSI_WEIGHT: c_int = 256;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_inflight {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_cmd {
// Descriptor from vhost_get_vq_desc() for virt_queue segment
    pub tvc_vq_desc: c_int,
// The number of scatterlists associated with this cmd
    pub tvc_sgl_count: u32,
    pub tvc_prot_sgl_count: u32,
    pub copied_iov:1: u32,
    pub read_iov: *const c_void,
    pub read_iter: *mut iov_iter,
    pub sgl: *mut scatterlist,
    pub table: sg_table,
    pub prot_sgl: *mut scatterlist,
    pub prot_table: sg_table,
// Fast path response header iovec used when only one vec is needed
    pub tvc_resp_iov: iovec,
// Number of iovs for response
    pub tvc_resp_iovs_cnt: c_uint,
// Pointer to response header iovecs if more than one is needed
    pub tvc_resp_iovs: *mut iovec,
// Pointer to vhost_virtqueue for the cmd
    pub tvc_vq: *mut vhost_virtqueue,
// The TCM I/O descriptor that is accessed via container_of()
    pub tvc_se_cmd: se_cmd,
// Sense buffer that will be mapped into outgoing status
    pub tvc_sense_buf: [c_uchar; TRANSPORT_SENSE_BUFFER],
//
// Dirty write descriptors of this command.
//
    pub tvc_log: *mut vhost_log,
    pub tvc_log_num: c_uint,
// Completed commands list, serviced from vhost worker thread
    pub tvc_completion_list: llist_node,
// Used to track inflight cmd
    pub inflight: *mut vhost_scsi_inflight,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_nexus {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_tpg {
// Vhost port target portal group tag for TCM
    pub tport_tpgt: u16,
// Used to track number of TPG Port/Lun Links wrt to explicit I_T Nexus shutdown
    pub tv_tpg_port_count: c_int,
// Used for vhost_scsi device reference to tpg_nexus, protected by tv_tpg_mutex
    pub tv_tpg_vhost_count: c_int,
// Used for enabling T10-PI with legacy devices
    pub tv_fabric_prot_type: c_int,
// list for vhost_scsi_list
    pub tv_tpg_list: list_head,
// Used to protect access for tpg_nexus
    pub tv_tpg_mutex: mutex,
// Pointer to the TCM VHost I_T Nexus for this TPG endpoint
    pub tpg_nexus: *mut vhost_scsi_nexus,
// Pointer back to vhost_scsi_tport
    pub tport: *mut vhost_scsi_tport,
// Returned by vhost_scsi_make_tpg()
    pub se_tpg: se_portal_group,
// Pointer back to vhost_scsi, protected by tv_tpg_mutex
    pub vhost_scsi: *mut vhost_scsi,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_tport {
// SCSI protocol the tport is providing
    pub tport_proto_id: u8,
// Binary World Wide unique Port Name for Vhost Target port
    pub tport_wwpn: u64,
// ASCII formatted WWPN for Vhost Target port
    pub tport_name: [c_char; VHOST_SCSI_NAMELEN],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_evt {
// event to be sent to guest
    pub event: virtio_scsi_event,
...
pub const VHOST_SCSI_MAX_TARGET: c_int = 256;
pub const VHOST_SCSI_MAX_IO_VQ: c_int = 1024;
pub const VHOST_SCSI_MAX_EVENT: c_int = 128;
    let mut vhost_scsi_max_io_vqs: static unsigned = 128;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_virtqueue {
    pub vq: vhost_virtqueue,
    pub vs: *mut vhost_scsi,
//
// Reference counting for inflight reqs, used for flush operation. At
// each time, one reference tracks new commands submitted, while we
// wait for another one to reach 0.
//
    pub inflights: [vhost_scsi_inflight; 2],
//
// Indicate current inflight in use, protected by vq->mutex.
// Writers must also take dev mutex and flush under it.
//
    pub inflight_idx: c_int,
    pub scsi_cmds: *mut vhost_scsi_cmd,
    pub scsi_tags: sbitmap,
    pub max_cmds: c_int,
    pub upages: *mut page,
    pub completion_work: vhost_work,
    pub completion_list: llist_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi {
// Protected by vhost_scsi->dev.mutex
    pub vs_tpg: *mut vhost_scsi_tpg,
    pub vs_vhost_wwpn: [c_char; TRANSPORT_IQN_LEN],
    pub dev: vhost_dev,
    pub vqs: *mut vhost_scsi_virtqueue,
    pub old_inflight: *mut vhost_scsi_inflight,
    pub /: *mut *mut vhost_work vs_event_work; / evt injection work item,
    pub /: *mut *mut llist_head vs_event_list; / evt injection queue,
    pub /: *mut *mut bool vs_events_missed; / any missed events, protected by vq->mutex,
    pub /: *mut *mut int vs_events_nr; / num of pending events, protected by vq->mutex,
    pub inline_sg_cnt: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_tmf {
    pub vwork: vhost_work,
    pub flush_work: work_struct,
    pub vhost: *mut vhost_scsi,
    pub svq: *mut vhost_scsi_virtqueue,
    pub se_cmd: se_cmd,
    pub scsi_resp: u8,
    pub inflight: *mut vhost_scsi_inflight,
    pub resp_iov: iovec,
...
// Dirty write descriptors of this command.
//
    pub tmf_log: *mut vhost_log,
    pub tmf_log_num: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_scsi_ctx {
    pub head: c_int,
    pub in: unsigned int out,,
    pub rsp_size: size_t req_size,,
    pub in_size: size_t out_size,,
    pub lunp: *mut *mut u8 target,,
    pub req: *mut c_void,
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_done_inflight(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_put_inflight(inflight: *mut vhost_scsi_inflight) {
    static void vhost_scsi_put_inflight(struct vhost_scsi_inflight *inflight)
    {
    kref_put(&inflight.kref, vhost_scsi_done_inflight);
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_check_true(se_tpg: *mut se_portal_group) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_get_tpgt(se_tpg: *mut se_portal_group) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_check_prot_fabric_only(se_tpg: *mut se_portal_group) -> c_int {
...
//
    ...
    vhost_log_write(vq, log, log_num, U64_MAX, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_release_cmd_res(se_cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_release_tmf_res(tmf: *mut vhost_scsi_tmf) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_drop_cmds(svq: *mut vhost_scsi_virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_release_cmd(se_cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_write_pending(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_queue_data_in(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_queue_status(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_queue_tm_rsp(se_cmd: *mut se_cmd) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_aborted_task(se_cmd: *mut se_cmd) {
    static void vhost_scsi_aborted_task(struct se_cmd *se_cmd)
    {
    return;
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_free_evt(vs: *mut vhost_scsi, evt: *mut vhost_scsi_evt) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_check_stop_free(se_cmd: *mut se_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_complete_events(vs: *mut vhost_scsi, drop: bool) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_evt_work(work: *mut vhost_work) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_copy_sgl_to_iov(cmd: *mut vhost_scsi_cmd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vhost_scsi_complete_cmd_work(work: *mut vhost_work) {
...
// Clear so we can re-use it for the copy path
    sg_set_page(curr, core::ptr::null_mut(), 0, 0);
    curr = sg_next(curr);
    }
...
// sgl = sg;
    ...
    {
    let mut sgl_count: c_int = 0;
    if (!iter || !iter_iov(iter)) {
    pr_err("%s: iter.iov is core::ptr::null_mut(), but expected bytes: %zu"
    " present\n", __func__, bytes);
    return -EINVAL;
    }
    ...
    int data_dir)
    {
    let mut len: usize = iov_iter_count(iter);
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_to_tcm_attr(attr: c_int) -> c_int {
    ...
    struct scatterlist *sg_ptr, *sg_prot_ptr = core::ptr::null_mut();
// FIXME: BIDI operation
    ...
    cmd.tvc_sgl_count, core::ptr::null_mut(), 0, sg_prot_ptr,
...
pub const TYPE_IO_CMD: c_int = 0;
pub const TYPE_CTRL_TMF: c_int = 1;
pub const TYPE_CTRL_AN: c_int = 2;
    static void
...
// virtio-scsi spec requires byte 0 of the lun to be 1
    ...
    struct vhost_scsi_tpg **vs_tpg, *tpg = core::ptr::null_mut();
    if (vc.target) {
...
#[no_mangle]
unsafe extern "C" fn vhost_buf_to_lun(lun_buf: *mut u8) -> u16 {
    ...
    u16 lun;
    u8 task_attr;
    let mut t10_pi: bool = vhost_has_feature(vq, VIRTIO_SCSI_F_T10_PI);
    u8 *cdb;
    struct vhost_log *vq_log;
    unsigned int log_num;
    mutex_lock(&vq.mutex);
...
//
    ...
    break;
#[no_mangle]
pub unsafe extern "C" fn if(-EIO: ret ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_tmf_resp_work(work: *mut vhost_work) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_tmf_flush_work(work: *mut work_struct) {
...
//
    ...
    if (target_submit_tmr(&tmf.se_cmd, tpg.tpg_nexus.tvn_se_sess, core::ptr::null_mut(),
    vhost_buf_to_lun(vtmf.lun), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_ctl_handle_kick(work: *mut vhost_work) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_evt_handle_kick(work: *mut vhost_work) {
    ...
    goto out;
    if (vs.vs_events_missed)
    vhost_scsi_send_evt(vs, vq, core::ptr::null_mut(), core::ptr::null_mut(), VIRTIO_SCSI_T_NO_EVENT,
    0);
    out:
    mutex_unlock(&vq.mutex);
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_handle_kick(work: *mut vhost_work) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_flush(vs: *mut vhost_scsi) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_destroy_vq_log(vq: *mut vhost_virtqueue) {
    ...
    tv_cmd.tvc_log = core::ptr::null_mut();
    tv_cmd.tvc_log_num = 0;
    }
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_destroy_vq_cmds(vq: *mut vhost_virtqueue) {
    ...
    kfree(svq.scsi_cmds);
    svq.scsi_cmds = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_setup_vq_cmds(vq: *mut vhost_virtqueue, max_cmds: c_int) -> c_int {
...
//
    ...
    if (tpg) {
    mutex_lock(&tpg.tv_tpg_mutex);
    tpg.vhost_scsi = core::ptr::null_mut();
    tpg.tv_tpg_vhost_count--;
    mutex_unlock(&tpg.tv_tpg_mutex);
...
// Prevent new cmds from starting and accessing the tpgs/sessions
    ...
    vq = &vs.vqs[i].vq;
    mutex_lock(&vq.mutex);
    vhost_vq_set_backend(vq, core::ptr::null_mut());
    mutex_unlock(&vq.mutex);
    }
...
//
    ...
    tpg.tv_tpg_vhost_count--;
    tpg.vhost_scsi = core::ptr::null_mut();
    vs.vs_tpg[target] = core::ptr::null_mut();
    mutex_unlock(&tpg.tv_tpg_mutex);
    se_tpg = &tpg.se_tpg;
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_set_features(vs: *mut vhost_scsi, features: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_open(inode: *mut inode, f: *mut file) -> c_int {
    static int vhost_scsi_open(struct inode *inode, struct file *f)
    {
    struct vhost_scsi_virtqueue *svq;
    struct vhost_scsi *vs;
    struct vhost_virtqueue **vqs;
    let mut r: c_int = -ENOMEM, i, nvqs = vhost_scsi_max_io_vqs;
    vs = kvzalloc_obj(*vs);
    if (!vs)
    goto err_vs;
    ...
    VHOST_SCSI_WEIGHT, 0, true, core::ptr::null_mut());
    vhost_scsi_init_inflight(vs, core::ptr::null_mut());
    f.private_data = vs;
    return 0;
    err_local_vqs:
    kfree(vs.vqs);
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_release(inode: *mut inode, f: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_register() -> int __init {
    static int __init vhost_scsi_register(void)
    {
    return misc_register(&vhost_scsi_misc);
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_deregister() {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_hotplug(tpg: *mut vhost_scsi_tpg, lun: *mut se_lun) {
    static void vhost_scsi_hotplug(struct vhost_scsi_tpg *tpg, struct se_lun *lun)
    {
    vhost_scsi_do_plug(tpg, lun, true);
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_hotunplug(tpg: *mut vhost_scsi_tpg, lun: *mut se_lun) {
    ...
    struct vhost_scsi_tpg, se_tpg);
    unsigned long val;
    let mut ret: c_int = kstrtoul(page, 0, &val);
    if (ret) {
...
//
    ...
    (unsigned char *)name, tv_nexus, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_drop_nexus(tpg: *mut vhost_scsi_tpg) -> c_int {
...
//
    ...
    tpg.tpg_nexus = core::ptr::null_mut();
    mutex_unlock(&tpg.tv_tpg_mutex);
    kfree(tv_nexus);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vhost_scsi_tpg_nexus_show(item: *mut config_item, page: *mut c_char) -> isize {
...
//
    if (!strncmp(page, "core::ptr::null_mut()", 4)) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_drop_tpg(se_tpg: *mut se_portal_group) {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_drop_tport(wwn: *mut se_wwn) {
    ...
    .sess_get_initiator_sid		= core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vhost_scsi_exit() {
