...
//
#[no_mangle]
pub unsafe extern "C" fn vhost_iotlb_del_range(iotlb: *mut vhost_iotlb, start: u64, last: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vhost_iotlb_reset(iotlb: *mut vhost_iotlb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vhost_iotlb_free(iotlb: *mut vhost_iotlb) {
