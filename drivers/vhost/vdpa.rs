...
//
    ...
    let mut max_iotlb_entries: static int = 2048;
    module_param(max_iotlb_entries, int, 0444);
    MODULE_PARM_DESC(max_iotlb_entries,
    "Maximum number of iotlb entries. (default: 2048)");
pub const VHOST_VDPA_IOTLB_BUCKETS: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_vdpa_as {
    pub hash_link: hlist_node,
    pub iotlb: vhost_iotlb,
    pub id: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhost_vdpa {
    pub vdev: vhost_dev,
    pub domain: *mut iommu_domain,
    pub vqs: *mut vhost_virtqueue,
    pub completion: completion,
    pub vdpa: *mut vdpa_device,
    pub as: [hlist_head; VHOST_VDPA_IOTLB_BUCKETS],
    pub dev: device,
    pub cdev: cdev,
    pub opened: core::sync::atomic::AtomicI32,
    pub nvqs: u32,
    pub virtio_id: c_int,
    pub minor: c_int,
    pub config_ctx: *mut eventfd_ctx,
    pub in_batch: c_int,
    pub range: vdpa_iova_range,
    pub batch_asid: u32,
    pub suspended: bool,
}
    ...
    u64 last, u32 asid);
#[no_mangle]
pub unsafe extern "C" fn iotlb_to_asid(iotlb: *mut vhost_iotlb) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_reset_map(v: *mut vhost_vdpa, asid: u32) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_remove_as(v: *mut vhost_vdpa, asid: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn handle_vq_kick(work: *mut vhost_work) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_virtqueue_cb(private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_config_cb(private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_setup_vq_irq(v: *mut vhost_vdpa, qid: u16) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_unsetup_vq_irq(v: *mut vhost_vdpa, qid: u16) {
...
#[no_mangle]
unsafe extern "C" fn _compat_vdpa_reset(v: *mut vhost_vdpa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_reset(v: *mut vhost_vdpa) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_bind_mm(v: *mut vhost_vdpa) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_unbind_mm(v: *mut vhost_vdpa) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_get_device_id(v: *mut vhost_vdpa, argp: *mut u8 __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_get_status(v: *mut vhost_vdpa, statusp: *mut u8 __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_set_status(v: *mut vhost_vdpa, statusp: *mut u8 __user) -> c_long {
    static long vhost_vdpa_set_status(struct vhost_vdpa *v, u8 __user *statusp)
    {
    struct vdpa_device *vdpa = v.vdpa;
    const struct vdpa_config_ops *ops = vdpa.config;
    u8 status, status_old;
    let mut nvqs: u32 = v.nvqs;
    int ret;
    u16 i;
...
//
    ...
    {
    struct vdpa_device *vdpa = v.vdpa;
    let mut size: usize = vdpa.config.get_config_size(vdpa);
    ...
    let mut size: c_ulong = offsetof(struct vhost_vdpa_config, buf);
    u8 *buf;
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_can_suspend(v: *const vhost_vdpa) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_can_resume(v: *const vhost_vdpa) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_has_desc_group(v: *const vhost_vdpa) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_get_features(v: *mut vhost_vdpa, featurep: *mut u64 __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_get_backend_features(v: *const vhost_vdpa) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_has_persistent_map(v: *const vhost_vdpa) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_set_features(v: *mut vhost_vdpa, featurep: *mut u64 __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_get_vring_num(v: *mut vhost_vdpa, argp: *mut u16 __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_config_put(v: *mut vhost_vdpa) {
    static void vhost_vdpa_config_put(struct vhost_vdpa *v)
    {
    if (v.config_ctx) {
    eventfd_ctx_put(v.config_ctx);
    v.config_ctx = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_set_config_call(v: *mut vhost_vdpa, argp: *mut u32 __user) -> c_long {
    ...
    return  -EFAULT;
    ctx = fd == VHOST_FILE_UNBIND ? core::ptr::null_mut() : eventfd_ctx_fdget(fd);
    swap(ctx, v.config_ctx);
    if (!IS_ERR_OR_NULL(ctx))
    eventfd_ctx_put(ctx);
    if (IS_ERR(v.config_ctx)) {
    let mut ret: c_long = PTR_ERR(v.config_ctx);
    v.config_ctx = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_get_iova_range(v: *mut vhost_vdpa, argp: *mut u32 __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_get_config_size(v: *mut vhost_vdpa, argp: *mut u32 __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_get_vqs_count(v: *mut vhost_vdpa, argp: *mut u32 __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_suspend(v: *mut vhost_vdpa) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_resume(v: *mut vhost_vdpa) -> c_long {
    ...
    return -EIO;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: copy_to_user(argp, _arg: &s, _arg: sizeof(s))) -> else {
...
pub unsafe extern "C" fn if(_arg: copy_to_user(argp, _arg: &s, _arg: sizeof(s))) -> else {
    ...
    cb.callback = core::ptr::null_mut();
    cb.private = core::ptr::null_mut();
    ...
    if (r)
    vhost_dev_reset_owner(d, core::ptr::null_mut());
    break;
    }
    out:
    ...
    } else if (ops.set_map == core::ptr::null_mut()) {
    ...
    while ((map = vhost_iotlb_itree_first(iotlb, start, last)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn perm_to_iommu_flags(perm: u32) -> c_int {
    ...
    struct vdpa_device *vdpa = v.vdpa;
    const struct vdpa_config_ops *ops = vdpa.config;
    let mut asid: u32 = iotlb_to_asid(iotlb);
    let mut r: c_int = 0;
    ...
    let mut list_size: c_ulong = PAGE_SIZE / sizeof(struct page *);
    let mut gup_flags: c_uint = FOLL_LONGTERM;
    unsigned long npages, cur_base, map_pfn, last_pfn = 0;
    unsigned long lock_limit, sz2pin, nchunks, i;
    unsigned long page_offset;
    let mut start: u64 = iova;
    long pinned;
    let mut ret: c_int = 0;
// Limit the use of memory for bookkeeping
    ...
    for (i = 0; i < pinned; i++) {
    let mut this_pfn: c_ulong = page_to_pfn(page_list[i]);
    u64 csize;
...
// Pin the rest chunk
    ...
    PFN_PHYS(map_pfn), perm, core::ptr::null_mut());
    out:
    if (ret) {
    if (nchunks) {
    unsigned long pfn;
...
//
    ...
    struct vdpa_device *vdpa = v.vdpa;
    const struct vdpa_config_ops *ops = vdpa.config;
    struct vhost_iotlb *iotlb = core::ptr::null_mut();
    struct vhost_vdpa_as *as = core::ptr::null_mut();
    let mut r: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_alloc_domain(v: *mut vhost_vdpa) -> c_int {
    static int vhost_vdpa_alloc_domain(struct vhost_vdpa *v)
    {
    struct vdpa_device *vdpa = v.vdpa;
    const struct vdpa_config_ops *ops = vdpa.config;
    let mut map: union virtio_map = vdpa_get_map(vdpa);
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_free_domain(v: *mut vhost_vdpa) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_set_iova_range(v: *mut vhost_vdpa) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_cleanup(v: *mut vhost_vdpa) {
    ...
    kfree(v.vdev.vqs);
    v.vdev.vqs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_open(inode: *mut inode, filep: *mut file) -> c_int {
    ...
    vqs[i].call_ctx.ctx = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_clean_irq(v: *mut vhost_vdpa) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_release(inode: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_fault(vmf: *mut vm_fault) -> vm_fault_t {
    static vm_fault_t vhost_vdpa_fault(struct vm_fault *vmf)
    {
    struct vhost_vdpa *v = vmf.vma.vm_file.private_data;
    struct vdpa_notification_area notify;
    struct vm_area_struct *vma = vmf.vma;
    let mut index: c_ulong = vma.vm_pgoff;
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_release_dev(device: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_probe(vdpa: *mut vdpa_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_remove(vdpa: *mut vdpa_device) {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vhost_vdpa_exit() -> void __exit {
