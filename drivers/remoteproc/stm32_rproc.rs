...
//! Source: drivers/remoteproc/stm32_rproc.c
#![no_std]
...
pub const HOLD_BOOT: c_int = 0;
pub const RELEASE_BOOT: c_int = 1;
pub const MBOX_NB_VQ: c_int = 2;
pub const MBOX_NB_MBX: c_int = 4;
pub const STM32_SMC_RCC: c_uint = 0x82001000;
pub const STM32_SMC_REG_WRITE: c_uint = 0x1;

pub const STM32_MBX_VQ0_ID: c_int = 0;

pub const STM32_MBX_VQ1_ID: c_int = 1;

pub const RSC_TBL_SIZE: c_int = 1024;
pub const M4_STATE_OFF: c_int = 0;
pub const M4_STATE_INI: c_int = 1;
pub const M4_STATE_CRUN: c_int = 2;
pub const M4_STATE_CSTOP: c_int = 3;
pub const M4_STATE_STANDBY: c_int = 4;
pub const M4_STATE_CRASH: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_syscon {
    pub map: *mut regmap,
    pub reg: u32,
    pub mask: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rproc_mem_ranges {
    pub dev_addr: u32,
    pub bus_addr: u32,
    pub size: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_mbox {
    pub name: [c_uchar; 10],
    pub chan: *mut mbox_chan,
    pub client: mbox_client,
    pub vq_work: work_struct,
    pub vq_id: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_rproc {
    pub rst: *mut reset_control,
    pub hold_boot_rst: *mut reset_control,
    pub hold_boot: stm32_syscon,
    pub pdds: stm32_syscon,
    pub m4_state: stm32_syscon,
    pub rsctbl: stm32_syscon,
    pub wdg_irq: c_int,
    pub nb_rmems: u32,
    pub rmems: *mut stm32_rproc_mem,
    pub mb: [stm32_mbox; MBOX_NB_MBX],
    pub workqueue: *mut workqueue_struct,
    pub hold_boot_smc: bool,
    pub rsc_va: *mut void __iomem,
}

#[no_mangle]
unsafe extern "C" fn stm32_rproc_pa_to_da(rproc: *mut rproc, pa: phys_addr_t, da: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_mbox_idx(rproc: *mut rproc, name: *const c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_prepare(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_parse_fw(rproc: *mut rproc, fw: *const firmware) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_wdg(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_mb_vq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_mb_callback(cl: *mut mbox_client, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_free_mbox(rproc: *mut rproc) {
    ...
    ddata.mb[i].chan = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_request_mbox(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_set_hold_boot(rproc: *mut rproc, hold: bool) -> c_int {
    static int stm32_rproc_set_hold_boot(struct rproc *rproc, bool hold)
    {
    struct stm32_rproc *ddata = rproc.priv;
    let mut hold_boot: stm32_syscon = ddata.hold_boot;
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_add_coredump_trace(rproc: *mut rproc) {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_start(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_attach(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_detach(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_stop(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_kick(rproc: *mut rproc, vqid: c_int) {
...
// no rsc table
    ...
    &rsc_pa, RSC_TBL_SIZE);
    ddata.rsc_va = core::ptr::null_mut();
...
//
    ...
    if (err) {
// remember this
    ddata.m4_state.map = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_rproc_resume(dev: *mut device) -> c_int {
