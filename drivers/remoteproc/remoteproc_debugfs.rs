...
//! Source: drivers/remoteproc/remoteproc_debugfs.c
#![no_std]
...
//
    ...
    char buf[100];
    int len;
    va = rproc_da_to_va(data.rproc, trace.da, trace.len, core::ptr::null_mut());
    if (!va) {
...
#[no_mangle]
unsafe extern "C" fn rproc_rsc_table_show(seq: *mut seq_file, p: *mut c_void) -> c_int {
    ...
    let mut offset: c_int = table.offset[i];
...
#[no_mangle]
unsafe extern "C" fn rproc_carveouts_show(seq: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rproc_remove_trace_file(tfile: *mut dentry) {
...
#[no_mangle]
pub unsafe extern "C" fn rproc_delete_debug_dir(rproc: *mut rproc) {
    void rproc_delete_debug_dir(struct rproc *rproc)
    {
    debugfs_remove_recursive(rproc.dbg_dir);
    }
#[no_mangle]
pub unsafe extern "C" fn rproc_create_debug_dir(rproc: *mut rproc) {
...
#[no_mangle]
pub unsafe extern "C" fn rproc_init_debugfs() -> void __init {
    void __init rproc_init_debugfs(void)
    {
    if (debugfs_initialized())
    rproc_dbg = debugfs_create_dir(KBUILD_MODNAME, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn rproc_exit_debugfs() -> void __exit {
