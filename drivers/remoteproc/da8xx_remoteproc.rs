...
//! Source: drivers/remoteproc/da8xx_remoteproc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da8xx_rproc {
    pub rproc: *mut rproc,
    pub mem: *mut da8xx_rproc_mem,
    pub num_mems: c_int,
    pub dsp_clk: *mut clk,
    pub dsp_reset: *mut reset_control,
    pub irq_data: *mut irq_data,
    pub chipsig: *mut void __iomem,
    pub bootreg: *mut void __iomem,
}
...
//
#[no_mangle]
unsafe extern "C" fn handle_event(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn da8xx_rproc_callback(irq: c_int, p: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da8xx_rproc_start(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da8xx_rproc_stop(rproc: *mut rproc) -> c_int {
...
// kick a virtqueue
#[no_mangle]
unsafe extern "C" fn da8xx_rproc_kick(rproc: *mut rproc, vqid: c_int) {
...
// Interrupt remote proc
    ...
    let mut num_mems: c_int = ARRAY_SIZE(mem_names);
...
#[no_mangle]
unsafe extern "C" fn da8xx_rproc_mem_release(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn da8xx_rproc_probe(pdev: *mut platform_device) -> c_int {
...
// error recovery is not supported at present
    ...
    drproc.dsp_clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(drproc.dsp_clk))
    return dev_err_probe(dev, PTR_ERR(drproc.dsp_clk), "clk_get error\n");
    drproc.dsp_reset = devm_reset_control_get_exclusive(dev, core::ptr::null_mut());
    ...
    if (!drproc.irq_data)
    return dev_err_probe(dev, -EINVAL, "irq_get_irq_data(%d): core::ptr::null_mut()\n", irq);
