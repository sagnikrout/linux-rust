...
//! Source: drivers/remoteproc/remoteproc_coredump.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rproc_coredump_state {
    pub rproc: *mut rproc,
    pub header: *mut c_void,
    pub dump_done: completion,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn rproc_coredump_cleanup(rproc: *mut rproc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rproc_coredump_add_segment(rproc: *mut rproc, da: dma_addr_t, size: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rproc_coredump_set_elf_info(rproc: *mut rproc, class: u8, machine: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rproc_coredump_free(data: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rproc_coredump(rproc: *mut rproc) {
    ...
    size_t offset;
    void *data;
    let mut class: u8 = rproc.elf_class;
    let mut phnum: c_int = 0;
    struct rproc_coredump_state dump_state;
    let mut dump_conf: enum rproc_dump_mechanism = rproc.dump_conf;
...
// Initialize the dump state struct to be used by rproc_coredump_read
    ...
    dev_coredumpm(&rproc.dev, core::ptr::null_mut(), &dump_state, data_size, GFP_KERNEL,
...
//
#[no_mangle]
pub unsafe extern "C" fn rproc_coredump_using_sections(rproc: *mut rproc) {
    ...
    void *ehdr;
    size_t data_size;
    let mut strtbl_size: usize = 0;
    let mut strtbl_index: usize = 1;
    size_t offset;
    void *data;
    let mut class: u8 = rproc.elf_class;
    int shnum;
    struct rproc_coredump_state dump_state;
    let mut dump_conf: c_uint = rproc.dump_conf;
