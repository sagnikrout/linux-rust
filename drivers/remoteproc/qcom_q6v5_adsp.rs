...
//! Source: drivers/remoteproc/qcom_q6v5_adsp.c
#![no_std]
...
// time out value
pub const ACK_TIMEOUT: c_int = 1000;
pub const ACK_TIMEOUT_US: c_int = 1000000;
pub const BOOT_FSM_TIMEOUT: c_int = 10000;
// mask values

// QDSP6SS register offsets
pub const RST_EVB_REG: c_uint = 0x10;
pub const CORE_START_REG: c_uint = 0x400;
pub const BOOT_CMD_REG: c_uint = 0x404;
pub const BOOT_STATUS_REG: c_uint = 0x408;
pub const RET_CFG_REG: c_uint = 0x1C;
// TCSR register offsets
pub const LPASS_MASTER_IDLE_REG: c_uint = 0x8;
pub const LPASS_HALTACK_REG: c_uint = 0x4;
pub const LPASS_PWR_ON_REG: c_uint = 0x10;
pub const LPASS_HALTREQ_REG: c_uint = 0x0;
pub const SID_MASK_DEFAULT: c_uint = 0xF;
pub const QDSP6SS_XO_CBCR: c_uint = 0x38;
pub const QDSP6SS_CORE_CBCR: c_uint = 0x20;
pub const QDSP6SS_SLEEP_CBCR: c_uint = 0x3c;

pub const LPASS_EFUSE_Q6SS_EVB_SEL: c_uint = 0x0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adsp_pil_data {
    ...
    pub has_iommu: bool,
    pub auto_boot: bool,
    pub clk_ids: *const c_char,
    pub num_clks: c_int,
    pub pd_names: *const c_char,
    pub num_pds: c_uint,
...
pub struct qcom_adsp {
    ...
    pub qdsp6ss_base: *mut void __iomem,
    pub lpass_efuse: *mut void __iomem,
    pub pdc_sync_reset: *mut reset_control,
    pub restart: *mut reset_control,
    pub halt_map: *mut regmap,
    pub halt_lpass: c_uint,
    pub crash_reason_smem: c_int,
    ...
    pub adsp): *mut *mut int (shutdown)(struct qcom_adsp,
}
...
#[no_mangle]
unsafe extern "C" fn qcom_rproc_pds_detach(adsp: *mut qcom_adsp) {
...
#[no_mangle]
unsafe extern "C" fn qcom_rproc_pds_enable(adsp: *mut qcom_adsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_rproc_pds_disable(adsp: *mut qcom_adsp) {
...
#[no_mangle]
unsafe extern "C" fn qcom_wpss_shutdown(adsp: *mut qcom_adsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_adsp_shutdown(adsp: *mut qcom_adsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adsp_load(rproc: *mut rproc, fw: *const firmware) -> c_int {
    static int adsp_load(struct rproc *rproc, const struct firmware *fw)
    {
    struct qcom_adsp *adsp = rproc.priv;
    int ret;
    ret = qcom_mdt_load_no_init(adsp.dev, fw, rproc.firmware,
    ( void *)adsp.mem_region, adsp.mem_phys,
...
#[no_mangle]
unsafe extern "C" fn adsp_unmap_carveout(rproc: *mut rproc) {
...
#[no_mangle]
unsafe extern "C" fn adsp_map_carveout(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adsp_start(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_adsp_pil_handover(q6v5: *mut qcom_q6v5) {
...
#[no_mangle]
unsafe extern "C" fn adsp_stop(rproc: *mut rproc) -> c_int {
    ...
    return ( void *)adsp.mem_region + offset;
    }
#[no_mangle]
unsafe extern "C" fn adsp_parse_firmware(rproc: *mut rproc, fw: *const firmware) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adsp_panic(rproc: *mut rproc) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn adsp_init_clock(adsp: *mut qcom_adsp, clk_ids: *const c_char) -> c_int {
    static int adsp_init_clock(struct qcom_adsp *adsp, const char **clk_ids)
    {
    let mut num_clks: c_int = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn adsp_init_reset(adsp: *mut qcom_adsp) -> c_int {
...
// Fall back to the  old "cc_lpass" if "restart" is absent
    ...
    if (!efuse_region) {
    adsp.lpass_efuse = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn adsp_alloc_memory_region(adsp: *mut qcom_adsp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adsp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adsp_remove(pdev: *mut platform_device) {
    ...
    "qdsp6ss_xo", "qdsp6ss_sleep", "qdsp6ss_core", core::ptr::null_mut()
    },
    .num_clks = 7,
    ...
    .auto_boot = true,
    .clk_ids = (const char*[]) {
    "gcc_cfg_noc_lpass", core::ptr::null_mut()
    },
    .num_clks = 1,
    };
    ...
    .load_state = "wpss",
    .clk_ids = (const char*[]) {
    "ahb_bdg", "ahb", "rscp", core::ptr::null_mut()
    },
    .num_clks = 3,
