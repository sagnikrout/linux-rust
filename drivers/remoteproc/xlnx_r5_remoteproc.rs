...
//! Source: drivers/remoteproc/xlnx_r5_remoteproc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mem_bank_data {
    pub addr: phys_addr_t,
    pub da: u32,
    pub size: usize,
    pub pm_domain_id: u32,
    pub bank_name: *mut c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_sram_bank {
    pub sram_res: resource,
    pub da: u32,
}
...
pub struct mbox_info {
    pub rx_mc_buf: [c_uchar; MBOX_CLIENT_BUF_MAX],
    pub tx_mc_buf: [c_uchar; MBOX_CLIENT_BUF_MAX],
    pub r5_core: *mut zynqmp_r5_core,
    pub mbox_work: work_struct,
    pub mbox_cl: mbox_client,
    pub tx_chan: *mut mbox_chan,
    pub rx_chan: *mut mbox_chan,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rsc_tbl_data {
    pub version: c_int,
    pub magic_num: u32,
    pub comp_magic_num: u32,
    pub rsc_tbl_size: u32,
    pub rsc_tbl: uintptr_t,
    pub __packed: },
...
pub const CRASH_REASON_STR_LEN: c_int = 16;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xlnx_rproc_crash_report {
    pub version: u8,
    pub crashed: u8,
    pub crash_reason: u8,
    pub crash_reason_str: [c_char; CRASH_REASON_STR_LEN],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_r5_core {
    pub crash_report: *mut xlnx_rproc_crash_report,
    pub rsc_tbl_va: *mut void __iomem,
    pub sram: *mut zynqmp_sram_bank,
    pub num_sram: c_int,
    pub dev: *mut device,
    pub np: *mut device_node,
    pub tcm_bank_count: c_int,
    pub tcm_banks: *mut mem_bank_data,
    pub rproc: *mut rproc,
    pub rsc_tbl_size: u32,
    pub pm_domain_id: u32,
    pub ipi: *mut mbox_info,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_r5_cluster {
    pub dev: *mut device,
    pub mode: enum zynqmp_r5_cluster_mode,
    pub core_count: c_int,
    pub r5_cores: *mut zynqmp_r5_core,
}
...
//
#[no_mangle]
unsafe extern "C" fn event_notified_idr_cb(id: c_int, ptr: *mut c_void, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn handle_event_notified(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_mb_rx_cb(cl: *mut mbox_client, msg: *mut c_void) {
...
// received and processed interrupt ack
    if (mbox_send_message(ipi.rx_chan, core::ptr::null_mut()) < 0)
...
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_free_mbox(ipi: *mut mbox_info) {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_rproc_kick(rproc: *mut rproc, vqid: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_rproc_start(rproc: *mut rproc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_rproc_stop(rproc: *mut rproc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_mem_regions_carveout(rproc: *mut rproc) -> c_int {
...
// Register associated reserved memory regions
    rproc_mem = rproc_mem_entry_init(&rproc.dev, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn add_sram_carveouts(rproc: *mut rproc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tcm_mem_unmap(rproc: *mut rproc, mem: *mut rproc_mem_entry) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn add_tcm_banks(rproc: *mut rproc) -> c_int {
...
//
    ...
    continue;
    rproc_mem = rproc_mem_entry_init(dev, core::ptr::null_mut(), bank_addr,
    bank_size, da,
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_parse_fw(rproc: *mut rproc, fw: *const firmware) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_rproc_prepare(rproc: *mut rproc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_rproc_unprepare(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_get_rsc_table_va(r5_core: *mut zynqmp_r5_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_attach(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_detach(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_get_sram_banks(r5_core: *mut zynqmp_r5_core) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_get_tcm_node_from_dt(cluster: *mut zynqmp_r5_cluster) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_get_tcm_node(cluster: *mut zynqmp_r5_cluster) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: device_is_compatible(dev, _arg: "xlnx, _arg: zynqmp-r5fss")) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_cluster_init(cluster: *mut zynqmp_r5_cluster) -> c_int {
    static int zynqmp_r5_cluster_init(struct zynqmp_r5_cluster *cluster)
    {
    let mut cluster_mode: enum zynqmp_r5_cluster_mode = LOCKSTEP_MODE;
    struct device *dev = cluster.dev;
...
//
    ...
    cluster.r5_cores = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_cluster_exit(data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_remoteproc_shutdown(pdev: *mut platform_device) {
    static void zynqmp_r5_remoteproc_shutdown(struct platform_device *pdev)
    {
    const char *rproc_state_str = core::ptr::null_mut();
    struct zynqmp_r5_cluster *cluster;
    struct zynqmp_r5_core *r5_core;
    struct rproc *rproc;
    int i, ret = 0;
...
//
#[no_mangle]
unsafe extern "C" fn zynqmp_r5_remoteproc_probe(pdev: *mut platform_device) -> c_int {
