...
//! Source: drivers/remoteproc/ti_k3_r5_remoteproc.c
#![no_std]
...
pub const K3_R5_TCM_DEV_ADDR: c_uint = 0x41010000;
// R5 TI-SCI Processor Configuration Flags
pub const PROC_BOOT_CFG_FLAG_R5_DBG_EN: c_uint = 0x00000001;
pub const PROC_BOOT_CFG_FLAG_R5_DBG_NIDEN: c_uint = 0x00000002;
pub const PROC_BOOT_CFG_FLAG_R5_LOCKSTEP: c_uint = 0x00000100;
pub const PROC_BOOT_CFG_FLAG_R5_TEINIT: c_uint = 0x00000200;
pub const PROC_BOOT_CFG_FLAG_R5_NMFI_EN: c_uint = 0x00000400;
pub const PROC_BOOT_CFG_FLAG_R5_TCM_RSTBASE: c_uint = 0x00000800;
pub const PROC_BOOT_CFG_FLAG_R5_BTCM_EN: c_uint = 0x00001000;
pub const PROC_BOOT_CFG_FLAG_R5_ATCM_EN: c_uint = 0x00002000;
// Available from J7200 SoCs onwards
pub const PROC_BOOT_CFG_FLAG_R5_MEM_INIT_DIS: c_uint = 0x00004000;
// Applicable to only AM64x SoCs
pub const PROC_BOOT_CFG_FLAG_R5_SINGLE_CORE: c_uint = 0x00008000;
// R5 TI-SCI Processor Control Flags
pub const PROC_BOOT_CTRL_FLAG_R5_CORE_HALT: c_uint = 0x00000001;
// R5 TI-SCI Processor Status Flags
pub const PROC_BOOT_STATUS_FLAG_R5_WFE: c_uint = 0x00000001;
pub const PROC_BOOT_STATUS_FLAG_R5_WFI: c_uint = 0x00000002;
pub const PROC_BOOT_STATUS_FLAG_R5_CLK_GATED: c_uint = 0x00000004;
pub const PROC_BOOT_STATUS_FLAG_R5_LOCKSTEP_PERMITTED: c_uint = 0x00000100;
// Applicable to only AM64x SoCs
pub const PROC_BOOT_STATUS_FLAG_R5_SINGLECORE_ONLY: c_uint = 0x00000200;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_r5_soc_data {
    pub tcm_is_double: bool,
    pub tcm_ecc_autoinit: bool,
    pub single_cpu_mode: bool,
    pub is_single_core: bool,
    pub core_data: *const k3_rproc_dev_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_r5_cluster {
    pub dev: *mut device,
    pub mode: enum cluster_mode,
    pub cores: list_head,
    pub core_transition: wait_queue_head_t,
    pub soc_data: *const k3_r5_soc_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct k3_r5_core {
    pub elem: list_head,
    pub dev: *mut device,
    pub kproc: *mut k3_rproc,
    pub cluster: *mut k3_r5_cluster,
    pub sram: *mut k3_rproc_mem,
    pub num_sram: c_int,
    pub atcm_enable: u32,
    pub btcm_enable: u32,
    pub loczrama: u32,
    pub released_from_reset: bool,
}

#[no_mangle]
unsafe extern "C" fn k3_r5_split_reset(kproc: *mut k3_rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_r5_split_release(kproc: *mut k3_rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_r5_lockstep_reset(cluster: *mut k3_r5_cluster) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_r5_lockstep_release(cluster: *mut k3_r5_cluster) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_r5_core_halt(kproc: *mut k3_rproc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn k3_r5_core_run(kproc: *mut k3_rproc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn k3_r5_rproc_prepare(rproc: *mut rproc) -> c_int {
    ...
    let mut ctrl: u32 = 0, cfg = 0, stat = 0;
    let mut boot_vec: u64 = 0;
    bool mem_init_dis;
    int ret;
//
...
//
#[no_mangle]
unsafe extern "C" fn k3_r5_rproc_unprepare(rproc: *mut rproc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn k3_r5_rproc_start(rproc: *mut rproc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn k3_r5_rproc_stop(rproc: *mut rproc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn k3_r5_rproc_configure(kproc: *mut k3_rproc) -> c_int {
    ...
    struct device *dev = kproc.dev;
    let mut ctrl: u32 = 0, cfg = 0, stat = 0;
    let mut set_cfg: u32 = 0, clr_cfg = 0;
    let mut boot_vec: u64 = 0;
    bool lockstep_en;
    bool single_cpu;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn k3_r5_adjust_tcm_sizes(kproc: *mut k3_rproc) {
...
//
#[no_mangle]
unsafe extern "C" fn k3_r5_rproc_configure_mode(kproc: *mut k3_rproc) -> c_int {
    static int k3_r5_rproc_configure_mode(struct k3_rproc *kproc)
    {
    struct k3_r5_core *core0, *core = kproc.priv;
    struct k3_r5_cluster *cluster = core.cluster;
    struct device *cdev = core.dev;
    let mut r_state: bool = false, c_state = false, lockstep_en = false, single_cpu = false;
    let mut ctrl: u32 = 0, cfg = 0, stat = 0, halted = 0;
    let mut boot_vec: u64 = 0;
    u32 atcm_enable, btcm_enable, loczrama;
    let mut mode: enum cluster_mode = cluster.mode;
...
// override rproc ops with only required IPC-only mode ops
    kproc.rproc.ops.prepare = core::ptr::null_mut();
    kproc.rproc.ops.unprepare = core::ptr::null_mut();
    kproc.rproc.ops.start = core::ptr::null_mut();
    kproc.rproc.ops.stop = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn k3_r5_cluster_rproc_init(pdev: *mut platform_device) -> c_int {
...
// error recovery is not supported at present
    ...
    kproc.ti_sci = core::ptr::null_mut();
    goto out;
    }
    ...
    kproc.reset = devm_reset_control_get_exclusive(cdev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn k3_r5_cluster_rproc_exit(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn k3_r5_core_of_init(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn k3_r5_core_of_exit(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn k3_r5_cluster_of_exit(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn k3_r5_cluster_of_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn k3_r5_probe(pdev: *mut platform_device) -> c_int {
