...
//! Source: drivers/remoteproc/mtk_scp.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn scp_put(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn scp_wdt_handler(scp: *mut mtk_scp, scp_to_host: u32) {
...
#[no_mangle]
unsafe extern "C" fn scp_init_ipi_handler(data: *mut c_void, len: c_uint, priv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn scp_ipi_handler(scp: *mut mtk_scp) {
    static void scp_ipi_handler(struct mtk_scp *scp)
    {
    struct mtk_share_obj __iomem *rcv_obj = scp.recv_buf;
    struct scp_ipi_desc *ipi_desc = scp.ipi_desc;
    scp_ipi_handler_t handler;
    let mut id: u32 = readl(&rcv_obj.id);
    let mut len: u32 = readl(&rcv_obj.len);
    ...
    size_t *offset);
#[no_mangle]
unsafe extern "C" fn scp_ipi_init(scp: *mut mtk_scp, fw: *const firmware) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8183_scp_reset_assert(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8183_scp_reset_deassert(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8192_scp_irq_handler(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8195_scp_irq_handler(scp: *mut mtk_scp) {
    ...
    let mut reason: u32 = readl(scp.cluster.reg_base + MT8195_SYS_STATUS);
...
#[no_mangle]
unsafe extern "C" fn mt8195_scp_c1_irq_handler(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn scp_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn scp_elf_load_segments(rproc: *mut rproc, fw: *const firmware) -> c_int {
...
// go through the available ELF segments
    ...
    let mut da: u32 = phdr.p_paddr;
    let mut memsz: u32 = phdr.p_memsz;
    let mut filesz: u32 = phdr.p_filesz;
    let mut offset: u32 = phdr.p_offset;
    void __iomem *ptr;
...
// grab the kernel address for this device address
    ptr = (void __iomem *)rproc_da_to_va(rproc, da, memsz, core::ptr::null_mut());
    if (!ptr) {
...
#[no_mangle]
unsafe extern "C" fn mt8183_scp_clk_get(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_scp_clk_get(scp: *mut mtk_scp) -> c_int {
    static int mt8192_scp_clk_get(struct mtk_scp *scp)
    {
    return mt8183_scp_clk_get(scp);
    }
#[no_mangle]
unsafe extern "C" fn mt8195_scp_clk_get(scp: *mut mtk_scp) -> c_int {
    static int mt8195_scp_clk_get(struct mtk_scp *scp)
    {
    scp.clk = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mt8183_scp_before_load(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scp_sram_power_on(addr: *mut void __iomem, reserved_mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn scp_sram_power_off(addr: *mut void __iomem, reserved_mask: u32) {
...
#[no_mangle]
unsafe extern "C" fn mt8186_scp_before_load(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_scp_l2tcm_on(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_scp_before_load(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8188_scp_c1_before_load(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8192_scp_before_load(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_scp_l2tcm_on(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_scp_before_load(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt8195_scp_c1_before_load(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scp_load(rproc: *mut rproc, fw: *const firmware) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scp_parse_fw(rproc: *mut rproc, fw: *const firmware) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scp_start(rproc: *mut rproc) -> c_int {
    ...
    return (void  *)scp.sram_base + offset;
...
// optional memory region
    ...
    return (void  *)scp.cluster.l1tcm_base + offset;
    }
// optional memory region
...
#[no_mangle]
unsafe extern "C" fn mt8183_scp_stop(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8188_scp_l2tcm_off(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8188_scp_stop(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8188_scp_c1_stop(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8192_scp_stop(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8195_scp_l2tcm_off(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8195_scp_stop(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn mt8195_scp_c1_stop(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn scp_stop(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scp_prepare(rproc: *mut rproc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scp_unprepare(rproc: *mut rproc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn scp_get_vdec_hw_capa(scp: *mut mtk_scp) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn scp_get_venc_hw_capa(scp: *mut mtk_scp) -> c_uint {
...
//
    ...
    {
    void *ptr;
    ptr = scp_da_to_va(scp.rproc, mem_addr, 0, core::ptr::null_mut());
    if (!ptr)
...
#[no_mangle]
unsafe extern "C" fn scp_map_memory_region(scp: *mut mtk_scp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scp_unmap_memory_region(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn scp_unregister_ipi(pdev: *mut platform_device, id: u32) {
...
#[no_mangle]
unsafe extern "C" fn scp_add_rpmsg_subdev(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn scp_remove_rpmsg_subdev(scp: *mut mtk_scp) {
    static void scp_remove_rpmsg_subdev(struct mtk_scp *scp)
    {
    if (scp.rpmsg_subdev) {
    rproc_remove_subdev(scp.rproc, scp.rpmsg_subdev);
    mtk_rpmsg_destroy_rproc_subdev(scp.rpmsg_subdev);
    scp.rpmsg_subdev = core::ptr::null_mut();
    }
    }
//
...
// register SCP initialization IPI
    ...
    ret = devm_request_threaded_irq(dev, platform_get_irq(pdev, 0), core::ptr::null_mut(),
    ...
    kfree(scp.share_buf);
    scp.share_buf = core::ptr::null_mut();
    release_dev_mem:
...
#[no_mangle]
unsafe extern "C" fn scp_free(scp: *mut mtk_scp) {
...
#[no_mangle]
unsafe extern "C" fn scp_is_single_core(pdev: *mut platform_device) -> bool {
    static bool scp_is_single_core(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct device_node *np = dev_of_node(dev);
    struct device_node *child;
    let mut num_cores: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn scp_cluster_init(pdev: *mut platform_device, scp_cluster: *mut mtk_scp_of_cluster) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scp_probe(pdev: *mut platform_device) -> c_int {
...
// l1tcm is an optional memory region
    ...
    ret = of_platform_populate(dev_of_node(dev), scp_core_match, core::ptr::null_mut(), dev);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn scp_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn scp_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn scp_resume(dev: *mut device) -> int __maybe_unused {
