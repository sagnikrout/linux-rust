...
//! Source: drivers/remoteproc/remoteproc_sysfs.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rproc_init_sysfs() -> int __init {
    int __init rproc_init_sysfs(void)
    {
// create remoteproc device class for sysfs
    let mut err: c_int = class_register(&rproc_class);
    if (err)
    pr_err("remoteproc: unable to register class\n");
    return err;
    }
#[no_mangle]
pub unsafe extern "C" fn rproc_exit_sysfs() -> void __exit {
