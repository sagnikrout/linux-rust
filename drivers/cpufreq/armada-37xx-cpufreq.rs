...
//! Source: drivers/cpufreq/armada-37xx-cpufreq.c
#![no_std]
...
// Clk register set
pub const ARMADA_37XX_CLK_TBG_SEL: c_int = 0;
pub const ARMADA_37XX_CLK_TBG_SEL_CPU_OFF: c_int = 22;
...
pub const ARMADA_37XX_NB_CLK_SEL_TBG: c_uint = 0x1;
pub const ARMADA_37XX_NB_TBG_SEL_OFF: c_int = 9;
pub const ARMADA_37XX_NB_TBG_SEL_MASK: c_uint = 0x3;
pub const ARMADA_37XX_NB_VDD_SEL_OFF: c_int = 6;
pub const ARMADA_37XX_NB_VDD_SEL_MASK: c_uint = 0x3;
...
// AVS register set
pub const ARMADA_37XX_AVS_CTL0: c_uint = 0x0;

pub const ARMADA_37XX_AVS_HIGH_VDD_LIMIT: c_int = 16;
pub const ARMADA_37XX_AVS_LOW_VDD_LIMIT: c_int = 22;
pub const ARMADA_37XX_AVS_VDD_MASK: c_uint = 0x3F;
pub const ARMADA_37XX_AVS_CTL2: c_uint = 0x8;
...
pub const MIN_VOLT_MV: c_int = 1000;
pub const MIN_VOLT_MV_FOR_L1_1000MHZ: c_int = 1108;
pub const MIN_VOLT_MV_FOR_L1_1200MHZ: c_int = 1155;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada37xx_cpufreq_state {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armada_37xx_dvfs {
    pub cpu_freq_max: u32,
    pub divider: [u8; LOAD_LEVEL_NR],
    pub avs: [u32; LOAD_LEVEL_NR],
}
...
//
#[no_mangle]
unsafe extern "C" fn armada_37xx_avs_val_match(target_vm: c_int) -> u32 {
...
// use L0 voltage;
//
    let mut avs_min: u32 = armada_37xx_avs_val_match(MIN_VOLT_MV);
...
#[no_mangle]
unsafe extern "C" fn armada37xx_cpufreq_disable_dvfs(base: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn armada37xx_cpufreq_enable_dvfs(base: *mut regmap) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn armada37xx_cpufreq_suspend(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada37xx_cpufreq_resume(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armada37xx_cpufreq_driver_init() -> int __init {
...
// Get parent CPU frequency
    ...
    load_lvl++) {
    let mut u_volt: c_ulong = avs_map[dvfs.avs[load_lvl]] * 1000;
...
// Now that everything is setup, enable the DVFS at hardware level
    ...
    pdev = platform_device_register_data(core::ptr::null_mut(), "cpufreq-dt", -1, &pdata,
    sizeof(pdata));
...
#[no_mangle]
unsafe extern "C" fn armada37xx_cpufreq_driver_exit() -> void __exit {
