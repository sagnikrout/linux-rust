...
//! Source: drivers/cpufreq/cppc_cpufreq.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cppc_freq_invariance {
    pub cpu: c_int,
    pub irq_work: irq_work,
    pub work: kthread_work,
    pub prev_perf_fb_ctrs: cppc_perf_fb_ctrs,
    pub cpu_data: *mut cppc_cpudata,
}
...
//
#[no_mangle]
unsafe extern "C" fn __cppc_scale_freq_tick(cppc_fi: *mut cppc_freq_invariance) {
...
#[no_mangle]
unsafe extern "C" fn cppc_scale_freq_tick() {
...
#[no_mangle]
unsafe extern "C" fn cppc_scale_freq_workfn(work: *mut kthread_work) {
...
#[no_mangle]
unsafe extern "C" fn cppc_irq_work(irq_work: *mut irq_work) {
...
//
#[no_mangle]
unsafe extern "C" fn cppc_scale_freq_tick_pcc() {
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_cpu_fie_init(policy: *mut cpufreq_policy) {
...
//
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_cpu_fie_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn cppc_fie_kworker_init() {
...
#[no_mangle]
unsafe extern "C" fn cppc_freq_invariance_init() -> void __init {
    static void __init cppc_freq_invariance_init(void)
    {
    let mut perf_ctrs_in_pcc: bool = cppc_perf_ctrs_in_pcc();
...
#[no_mangle]
unsafe extern "C" fn cppc_freq_invariance_exit() {
...
#[no_mangle]
pub unsafe extern "C" fn cppc_cpufreq_cpu_fie_init(policy: *mut cpufreq_policy) {
    static inline void cppc_cpufreq_cpu_fie_init(struct cpufreq_policy *policy)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn cppc_cpufreq_cpu_fie_exit(policy: *mut cpufreq_policy) {
    static inline void cppc_cpufreq_cpu_fie_exit(struct cpufreq_policy *policy)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn cppc_freq_invariance_init() {
    static inline void cppc_freq_invariance_init(void)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn cppc_freq_invariance_exit() {
...
#[no_mangle]
unsafe extern "C" fn cppc_verify_policy(policy: *mut cpufreq_policy_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __cppc_cpufreq_get_transition_delay_us(cpu: c_uint) -> c_uint {
    static unsigned int __cppc_cpufreq_get_transition_delay_us(unsigned int cpu)
    {
    let mut transition_latency_ns: c_int = cppc_get_transition_latency(cpu);
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_get_transition_delay_us(cpu: c_uint) -> c_uint {
    static unsigned int cppc_cpufreq_get_transition_delay_us(unsigned int cpu)
    {
    let mut implementor: c_ulong = read_cpuid_implementor();
    let mut part_num: c_ulong = read_cpuid_part_number();
    switch (implementor) {
...
// Add a cost gap correspnding to the energy of 4 CPUs.
    ...
    / CPPC_EM_CAP_STEP)
#[no_mangle]
unsafe extern "C" fn get_perf_level_count(policy: *mut cpufreq_policy) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn compute_cost(cpu: c_int, step: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_register_em(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn populate_efficiency_class() {
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_put_cpu_data(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_cpu_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_cpu_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
pub unsafe extern "C" fn get_delta(t1: u64, t0: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_get_rate(cpu: c_uint) -> c_uint {
    static unsigned int cppc_cpufreq_get_rate(unsigned int cpu)
    {
    struct cpufreq_policy *policy __free(put_cpufreq_policy) = cpufreq_cpu_get(cpu);
    let mut fb_ctrs_t0: cppc_perf_fb_ctrs = {0}, fb_ctrs_t1 = {0};
    struct cppc_cpudata *cpu_data;
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_set_boost(policy: *mut cpufreq_policy, state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_auto_select(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
// show "<unsupported>" when this register is not supported by cpc
    ...
    if (val) {
    let mut old_min_perf: u32 = cpu_data.perf_ctrls.min_perf;
    let mut old_max_perf: u32 = cpu_data.perf_ctrls.max_perf;
//
...
//
    ...
    {
    u64 val;
    let mut ret: c_int = get_func((int)cpu, &val);
    if (ret == -EOPNOTSUPP)
    return sysfs_emit(buf, "<unsupported>\n");
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn cppc_get_perf_limited_filtered(cpu: c_int, perf_limited: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cppc_cpufreq_exit() -> void __exit {
