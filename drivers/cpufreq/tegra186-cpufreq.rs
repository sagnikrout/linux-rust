...
//! Source: drivers/cpufreq/tegra186-cpufreq.c
#![no_std]
...
pub const TEGRA186_NUM_CLUSTERS: c_int = 2;

pub const EDVD_CORE_VOLT_FREQ_F_SHIFT: c_int = 0;
pub const EDVD_CORE_VOLT_FREQ_F_MASK: c_uint = 0xffff;
pub const EDVD_CORE_VOLT_FREQ_V_SHIFT: c_int = 16;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra186_cpufreq_cpu {
    pub bpmp_cluster_id: c_uint,
    pub edvd_offset: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra186_cpufreq_cluster {
    pub bpmp_lut: *mut cpufreq_frequency_table,
    pub ref_clk_khz: u32,
    pub div: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra186_cpufreq_data {
    pub regs: *mut void __iomem,
    pub cpus: *const tegra186_cpufreq_cpu,
    pub icc_dram_bw_scaling: bool,
    pub clusters: [tegra186_cpufreq_cluster; ],
}
...
#[no_mangle]
unsafe extern "C" fn tegra186_cpufreq_init(policy: *mut cpufreq_policy) -> c_int {
    static int tegra186_cpufreq_init(struct cpufreq_policy *policy)
    {
    struct tegra186_cpufreq_data *data = cpufreq_get_driver_data();
    let mut cluster: c_uint = data.cpus[policy.cpu].bpmp_cluster_id;
...
// set same policy for all cpus in a cluster
    ...
    let mut edvd_val: u32 = tbl.driver_data;
    u32 cpu;
...
#[no_mangle]
unsafe extern "C" fn tegra186_cpufreq_get(cpu: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra186_cpufreq_probe(pdev: *mut platform_device) -> c_int {
    static int tegra186_cpufreq_probe(struct platform_device *pdev)
    {
    struct tegra186_cpufreq_data *data;
    struct tegra_bpmp *bpmp;
    struct device *cpu_dev;
    let mut i: c_uint = 0, err, edvd_offset;
    let mut num_rates: c_int = 0;
    u32 edvd_val, cpu;
...
#[no_mangle]
unsafe extern "C" fn tegra186_cpufreq_remove(pdev: *mut platform_device) {
