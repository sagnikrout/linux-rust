...
//! Source: drivers/cpufreq/pxa2xx-cpufreq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pxa_cpufreq_change_voltage(pxa_freq: *const pxa_freqs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_cpufreq_init_voltages() {
    static void pxa_cpufreq_init_voltages(void)
    {
    vcc_core = regulator_get(core::ptr::null_mut(), "vcc_core");
    if (IS_ERR(vcc_core)) {
    pr_info("Didn't find vcc_core regulator\n");
    vcc_core = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn pxa27x_guess_max_freq() {
...
#[no_mangle]
unsafe extern "C" fn pxa_cpufreq_get(cpu: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pxa_set_target(policy: *mut cpufreq_policy, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_cpufreq_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpu_is_pxa27x()) -> else {
...
#[no_mangle]
unsafe extern "C" fn pxa_cpu_init() -> int __init {
    static int __init pxa_cpu_init(void)
    {
    let mut ret: c_int = -ENODEV;
    pxa_cpufreq_data.clk_core = clk_get_sys(core::ptr::null_mut(), "core");
...
#[no_mangle]
unsafe extern "C" fn pxa_cpu_exit() -> void __exit {
