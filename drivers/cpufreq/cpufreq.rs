...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_supports_freq_invariance() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn has_target() -> bool {
    static inline bool has_target(void)
    {
    return cpufreq_driver.target_index || cpufreq_driver.target;
    }
#[no_mangle]
pub unsafe extern "C" fn has_target_index() -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_disabled() -> c_int {
    static int cpufreq_disabled(void)
    {
    return off;
    }
#[no_mangle]
pub unsafe extern "C" fn disable_cpufreq() {
...
#[no_mangle]
pub unsafe extern "C" fn have_governor_per_policy() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn get_cpu_idle_time(cpu: c_uint, wall: *mut u64, io_busy: c_int) -> u64 {
    u64 get_cpu_idle_time(unsigned int cpu, u64 *wall, int io_busy)
    {
    let mut idle_time: u64 = get_cpu_idle_time_us(cpu, io_busy ? wall : core::ptr::null_mut());
    if (!io_busy)
...
//
    ...
    return policy && cpumask_test_cpu(cpu, policy.cpus) ? policy : core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_generic_get(cpu: c_uint) -> c_uint {
...
//
    ...
    {
    struct cpufreq_policy *policy = core::ptr::null_mut();
    unsigned long flags;
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_cpu_put(policy: *mut cpufreq_policy) {
...
//
#[no_mangle]
unsafe extern "C" fn adjust_jiffies(val: c_ulong, ci: *mut cpufreq_freqs) {
...
//
    ...
    policy.transition_task = core::ptr::null_mut();
    spin_unlock(&policy.transition_lock);
...
#[no_mangle]
unsafe extern "C" fn cpufreq_list_transition_notifiers() {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_enable_fast_switch(policy: *mut cpufreq_policy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_disable_fast_switch(policy: *mut cpufreq_policy) {
...
//
    ...
    unsigned int target_freq)
    {
    let mut min: c_uint = READ_ONCE(policy.min);
    let mut max: c_uint = READ_ONCE(policy.max);
//
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_policy_transition_delay_us(policy: *mut cpufreq_policy) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn show_local_boost(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
    static ssize_t show_local_boost(struct cpufreq_policy *policy, char *buf)
    {
    return sysfs_emit(buf, "%d\n", policy.boost_enabled);
    }
#[no_mangle]
unsafe extern "C" fn policy_set_boost(policy: *mut cpufreq_policy, enable: bool) -> c_int {
    ...
    let mut local_boost: static struct freq_attr = __ATTR(boost, 0644, show_local_boost, store_local_boost);
...
#[no_mangle]
unsafe extern "C" fn cpufreq_parse_policy(str_governor: *mut c_char) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn arch_freq_get_on_cpu(cpu: c_int) -> __weak int {
    __weak int arch_freq_get_on_cpu(int cpu)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
pub unsafe extern "C" fn cpufreq_avg_freq_supported(policy: *mut cpufreq_policy) -> bool {
    static inline bool cpufreq_avg_freq_supported(struct cpufreq_policy *policy)
    {
    return arch_freq_get_on_cpu(policy.cpu) != -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn show_scaling_cur_freq(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn if(cpufreq_driver->get: cpufreq_driver->setpolicy &&) -> else {
...
//
    ...
    char *buf)
    {
    let mut cur_freq: c_uint = __cpufreq_get(policy);
    if (cur_freq)
    return sysfs_emit(buf, "%u\n", cur_freq);
...
//
    ...
    char *buf)
    {
    let mut avg_freq: c_int = arch_freq_get_on_cpu(policy.cpu);
    if (avg_freq > 0)
    return sysfs_emit(buf, "%u\n", avg_freq);
...
//
#[no_mangle]
unsafe extern "C" fn show_scaling_governor(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
    static ssize_t show_scaling_governor(struct cpufreq_policy *policy, char *buf)
    {
    if (policy.policy == CPUFREQ_POLICY_POWERSAVE)
    return sysfs_emit(buf, "powersave\n");
#[no_mangle]
pub unsafe extern "C" fn if(CPUFREQ_POLICY_PERFORMANCE: policy->policy ==) -> else {
    else if (policy.policy == CPUFREQ_POLICY_PERFORMANCE)
    return sysfs_emit(buf, "performance\n");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: policy->governor) -> else {
...
//
    ...
    if (!new_pol)
    return -EINVAL;
    ret = cpufreq_set_policy(policy, core::ptr::null_mut(), new_pol);
    } else {
    struct cpufreq_governor *new_gov;
...
//
#[no_mangle]
unsafe extern "C" fn show_scaling_driver(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_show_cpus(mask: *const cpumask, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_related_cpus(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_affected_cpus(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn show_scaling_setspeed(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn show_bios_limit(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_sysfs_release(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_add_dev_interface(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_init_policy(policy: *mut cpufreq_policy) -> c_int {
    static int cpufreq_init_policy(struct cpufreq_policy *policy)
    {
    struct cpufreq_governor *gov = core::ptr::null_mut();
    let mut pol: c_uint = CPUFREQ_POLICY_UNKNOWN;
    int ret;
    if (has_target()) {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_add_policy_cpu(policy: *mut cpufreq_policy, cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn refresh_frequency_limits(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn handle_update(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_policy_put_kobj(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_policy_free(policy: *mut cpufreq_policy) {
...
// Remove policy from list
    ...
    per_cpu(cpufreq_cpu_data, cpu) = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cpufreq_policy_init_qos(policy: *mut cpufreq_policy) -> c_int {
...
// Use policy->min/max set by the driver as QoS requests.
    ...
    guard(cpufreq_policy_write)(policy);
    policy.cpu = cpu;
    policy.governor = core::ptr::null_mut();
...
//
    ...
    && has_target()) {
    let mut old_freq: c_uint = policy.cur;
...
#[no_mangle]
unsafe extern "C" fn cpufreq_online(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpufreq_add_dev(dev: *mut device, sif: *mut subsys_interface) -> c_int {
    static int cpufreq_add_dev(struct device *dev, struct subsys_interface *sif)
    {
    struct cpufreq_policy *policy;
    let mut cpu: unsigned = dev.id;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn __cpufreq_offline(cpu: c_uint, policy: *mut cpufreq_policy) {
...
//
    ...
    if (cpufreq_driver.exit)
    cpufreq_driver.exit(policy);
    policy.freq_table = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cpufreq_offline(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpufreq_remove_dev(dev: *mut device, sif: *mut subsys_interface) {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_verify_current_freq(policy: *mut cpufreq_policy, update: bool) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_quick_get(cpu: c_uint) -> c_uint {
    unsigned int cpufreq_quick_get(unsigned int cpu)
    {
    unsigned long flags;
    read_lock_irqsave(&cpufreq_driver_lock, flags);
    if (cpufreq_driver && cpufreq_driver.setpolicy && cpufreq_driver.get) {
    let mut ret_freq: c_uint = cpufreq_driver.get(cpu);
    read_unlock_irqrestore(&cpufreq_driver_lock, flags);
    return ret_freq;
    }
    read_unlock_irqrestore(&cpufreq_driver_lock, flags);
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_quick_get_max(cpu: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_get_hw_max_freq(cpu: c_uint) -> __weak unsigned int {
...
#[no_mangle]
unsafe extern "C" fn __cpufreq_get(policy: *mut cpufreq_policy) -> c_uint {
    static unsigned int __cpufreq_get(struct cpufreq_policy *policy)
    {
    if (unlikely(policy_is_inactive(policy)))
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_get(cpu: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_generic_suspend(policy: *mut cpufreq_policy) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_suspend() {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_resume() {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_driver_test_flags(flags: u16) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_register_notifier(nb: *mut notifier_block, list: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_unregister_notifier(nb: *mut notifier_block, list: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_driver_has_adjust_perf() -> bool {
...
#[no_mangle]
unsafe extern "C" fn __target_index(policy: *mut cpufreq_policy, index: c_int) -> c_int {
    static int __target_index(struct cpufreq_policy *policy, int index)
    {
    let mut freqs: cpufreq_freqs = {.old = policy.cur, .flags = 0};
    unsigned int restore_freq, intermediate_freq = 0;
    let mut newfreq: c_uint = policy.freq_table[index].frequency;
...
//
    ...
    unsigned int relation)
    {
    let mut old_target_freq: c_uint = target_freq;
    if (cpufreq_disabled())
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn cpufreq_init_governor(policy: *mut cpufreq_policy) -> c_int {
    static int cpufreq_init_governor(struct cpufreq_policy *policy)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cpufreq_exit_governor(policy: *mut cpufreq_policy) {
    static void cpufreq_exit_governor(struct cpufreq_policy *policy)
    {
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_start_governor(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_stop_governor(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_governor_limits(policy: *mut cpufreq_policy) {
    static void cpufreq_governor_limits(struct cpufreq_policy *policy)
    {
    if (cpufreq_suspended || !policy.governor)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_register_governor(governor: *mut cpufreq_governor) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_unregister_governor(governor: *mut cpufreq_governor) {
...
//
#[no_mangle]
unsafe extern "C" fn cpufreq_update_pressure(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_policy_refresh(policy: *mut cpufreq_policy) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_update_policy(cpu: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_update_limits(cpu: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_boost_set_sw(policy: *mut cpufreq_policy, state: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_boost_trigger_state(state: c_int) -> c_int {
    static int cpufreq_boost_trigger_state(int state)
    {
    struct cpufreq_policy *policy;
    unsigned long flags;
...
#[no_mangle]
unsafe extern "C" fn cpufreq_boost_supported() -> bool {
    static bool cpufreq_boost_supported(void)
    {
    return cpufreq_driver.set_boost;
    }
#[no_mangle]
unsafe extern "C" fn create_boost_sysfs_file() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_boost_sysfs_file() {
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_boost_enabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpuhp_cpufreq_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpuhp_cpufreq_offline(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_register_driver(driver_data: *mut cpufreq_driver) -> c_int {
...
// if all ->init() calls failed, unregister
    ...
    err_null_driver:
    write_lock_irqsave(&cpufreq_driver_lock, flags);
    cpufreq_driver = core::ptr::null_mut();
    write_unlock_irqrestore(&cpufreq_driver_lock, flags);
    out:
    cpus_read_unlock();
    return ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn cpufreq_unregister_driver(driver: *mut cpufreq_driver) {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_core_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_policy_is_good_for_eas(cpu: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cpufreq_ready_for_eas(cpu_mask: *const cpumask) -> bool {
