...
//! Source: drivers/cpufreq/qcom-cpufreq-hw.c
#![no_std]
...
pub const LUT_TURBO_IND: c_int = 1;

pub const MAX_FREQ_DOMAINS: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_cpufreq_soc_data {
    pub reg_enable: u32,
    pub reg_domain_state: u32,
    pub reg_dcvs_ctrl: u32,
    pub reg_freq_lut: u32,
    pub reg_volt_lut: u32,
    pub reg_intr_clr: u32,
    pub reg_current_vote: u32,
    pub reg_perf_state: u32,
    pub lut_max_entries: u32,
    pub lut_row_size: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_cpufreq_data {
...
//
    ...
    pub throttle_irq: c_int,
    pub irq_name: [c_char; 15],
    pub cancel_throttle: bool,
    pub throttle_work: delayed_work,
    ...
    {
    let mut freq_hz: c_ulong = freq_khz * 1000;
...
// Skip voltage update if the opp table is not available
    ...
    let mut freq: c_ulong = policy.freq_table[index].frequency;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn qcom_lmh_get_throttle_freq(data: *mut qcom_cpufreq_data) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_get_freq(policy: *mut cpufreq_policy) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn __qcom_cpufreq_hw_get(policy: *mut cpufreq_policy) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_get(cpu: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn qcom_get_related_cpus(index: c_int, m: *mut cpumask) {
...
#[no_mangle]
unsafe extern "C" fn qcom_lmh_dcvs_notify(data: *mut qcom_cpufreq_data) {
    static void qcom_lmh_dcvs_notify(struct qcom_cpufreq_data *data)
    {
    struct cpufreq_policy *policy = data.policy;
    let mut cpu: c_int = cpumask_first(policy.related_cpus);
...
#[no_mangle]
unsafe extern "C" fn qcom_lmh_dcvs_poll(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qcom_lmh_dcvs_handle_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_lmh_init(policy: *mut cpufreq_policy, index: c_int) -> c_int {
...
//
    ...
    ret = request_threaded_irq(data.throttle_irq, core::ptr::null_mut(), qcom_lmh_dcvs_handle_irq,
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_cpu_online(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_cpu_offline(policy: *mut cpufreq_policy) -> c_int {
    ...
    irq_set_affinity_and_hint(data.throttle_irq, core::ptr::null_mut());
    disable_irq_nosync(data.throttle_irq);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_lmh_exit(data: *mut qcom_cpufreq_data) {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_cpu_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_cpu_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_ready(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_recalc_rate(hw: *mut clk_hw, parent_rate: c_ulong) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_determine_rate(hw: *mut clk_hw, req: *mut clk_rate_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_driver_probe(pdev: *mut platform_device) -> c_int {
...
// Check for optional interconnect paths on CPU0
    ...
    if (!cpu_dev)
    return -EPROBE_DEFER;
    ret = dev_pm_opp_of_find_icc_paths(cpu_dev, core::ptr::null_mut());
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_driver_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpufreq_hw_exit() -> void __exit {
