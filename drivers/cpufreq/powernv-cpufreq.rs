...
//! Source: drivers/cpufreq/powernv-cpufreq.c
#![no_std]
...
pub const POWERNV_MAX_PSTATES_ORDER: c_int = 8;

pub const MAX_PSTATE_SHIFT: c_int = 32;
pub const LPSTATE_SHIFT: c_int = 48;
pub const GPSTATE_SHIFT: c_int = 56;
pub const MAX_NR_CHIPS: c_int = 32;
pub const MAX_RAMP_DOWN_TIME: c_int = 5120;
//
...
pub const GPSTATE_TIMER_INTERVAL: c_int = 2000;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct global_pstate_info {
    pub highest_lpstate_idx: c_int,
    pub elapsed_time: c_uint,
    pub last_sampled_time: c_uint,
    pub last_lpstate_idx: c_int,
    pub last_gpstate_idx: c_int,
    pub gpstate_lock: spinlock_t,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pstate_idx_revmap_data {
    pub pstate_id: u8,
    pub cpufreq_table_idx: c_uint,
...
#[no_mangle]
pub unsafe extern "C" fn extract_pstate(pmsr_val: u64, shift: c_uint) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn idx_to_pstate(i: c_uint) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn pstate_to_idx(pstate: u8) -> c_uint {
    static unsigned int pstate_to_idx(u8 pstate)
    {
    let mut key: c_uint = pstate % POWERNV_MAX_PSTATES;
...
#[no_mangle]
pub unsafe extern "C" fn reset_gpstates(policy: *mut cpufreq_policy) {
...
//
#[no_mangle]
unsafe extern "C" fn init_powernv_pstates() -> c_int {
    ...
    let mut id: u32 = be32_to_cpu(pstate_ids[i]);
    let mut freq: u32 = be32_to_cpu(pstate_freqs[i]);
    struct pstate_idx_revmap_data *revmap_data;
    unsigned int key;
...
#[no_mangle]
unsafe extern "C" fn pstate_id_to_freq(pstate_id: u8) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn get_pmspr(sprn: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn set_pmspr(sprn: c_ulong, val: c_ulong) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct powernv_smp_call_data {
    pub freq: c_uint,
    pub pstate_id: u8,
    pub gpstate_id: u8,
}
...
//
#[no_mangle]
unsafe extern "C" fn powernv_read_cpu_freq(arg: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn powernv_cpufreq_get(cpu: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn set_pstate(data: *mut c_void) {
    static void set_pstate(void *data)
    {
    unsigned long val;
    struct powernv_smp_call_data *freq_data = data;
    let mut pstate_ul: c_ulong = freq_data.pstate_id;
    let mut gpstate_ul: c_ulong = freq_data.gpstate_id;
...
//
#[no_mangle]
pub unsafe extern "C" fn get_nominal_index() -> c_uint {
    static inline unsigned int get_nominal_index(void)
    {
    return powernv_pstate_info.nominal;
    }
#[no_mangle]
unsafe extern "C" fn powernv_cpufreq_throttle_check(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn queue_gpstate_timer(gpstates: *mut global_pstate_info) {
...
//
#[no_mangle]
unsafe extern "C" fn gpstate_timer_handler(t: *mut timer_list) {
...
//
    preempt_disable();
    powernv_cpufreq_throttle_check(core::ptr::null_mut());
    preempt_enable();
    }
...
#[no_mangle]
unsafe extern "C" fn powernv_cpufreq_cpu_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn powernv_cpufreq_cpu_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn powernv_cpufreq_work_fn(work: *mut work_struct) {
    ...
    powernv_cpufreq_throttle_check, core::ptr::null_mut(), 0);
    if (!chip.restore)
    goto out;
    chip.restore = false;
...
#[no_mangle]
unsafe extern "C" fn init_chip_info() -> c_int {
    static int init_chip_info(void)
    {
    unsigned int *chip;
    unsigned int cpu, i;
    let mut prev_chip_id: c_uint = UINT_MAX;
...
// Allocate a chip cpu mask large enough to fit mask for all chips
    ...
    let mut id: c_uint = cpu_to_chip_id(cpu);
    if (prev_chip_id != id) {
    prev_chip_id = id;
    chip[nr_chips++] = id;
    }
...
#[no_mangle]
pub unsafe extern "C" fn clean_chip_info() {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_all_notifiers() {
...
#[no_mangle]
unsafe extern "C" fn powernv_cpufreq_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn powernv_cpufreq_exit() -> void __exit {
