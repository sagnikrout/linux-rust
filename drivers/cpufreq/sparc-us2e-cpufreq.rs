...
//! Source: drivers/cpufreq/sparc-us2e-cpufreq.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct us2e_freq_percpu_info {
    pub table: [cpufreq_frequency_table; 6],
}

// Indexed by cpu number.
    static struct us2e_freq_percpu_info *us2e_freq_table;
pub const HBIRD_MEM_CNTL0_ADDR: c_uint = 0x1fe0000f010UL;
pub const HBIRD_ESTAR_MODE_ADDR: c_uint = 0x1fe0000f080UL;
// UltraSPARC-IIe has five dividers: 1, 2, 4, 6, and 8.  These are controlled
// in the ESTAR mode control register.
//
pub const ESTAR_MODE_DIV_1: c_uint = 0x0000000000000000UL;
pub const ESTAR_MODE_DIV_2: c_uint = 0x0000000000000001UL;
pub const ESTAR_MODE_DIV_4: c_uint = 0x0000000000000003UL;
pub const ESTAR_MODE_DIV_6: c_uint = 0x0000000000000002UL;
pub const ESTAR_MODE_DIV_8: c_uint = 0x0000000000000004UL;
pub const ESTAR_MODE_DIV_MASK: c_uint = 0x0000000000000007UL;
pub const MCTRL0_SREFRESH_ENAB: c_uint = 0x0000000000010000UL;
pub const MCTRL0_REFR_COUNT_MASK: c_uint = 0x0000000000007f00UL;
pub const MCTRL0_REFR_COUNT_SHIFT: c_int = 8;
pub const MCTRL0_REFR_INTERVAL: c_int = 7800;
pub const MCTRL0_REFR_CLKS_P_CNT: c_int = 64;
#[no_mangle]
unsafe extern "C" fn read_hbreg(addr: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn write_hbreg(addr: c_ulong, val: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn self_refresh_ctl(enable: c_int) {
    static void self_refresh_ctl(int enable)
    {
    let mut mctrl: c_ulong = read_hbreg(HBIRD_MEM_CNTL0_ADDR);
    if (enable)
...
#[no_mangle]
unsafe extern "C" fn index_to_estar_mode(index: c_uint) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn index_to_divisor(index: c_uint) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn estar_to_divisor(estar: c_ulong) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn __us2e_freq_get(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn us2e_freq_get(cpu: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn __us2e_freq_target(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn us2e_freq_target(policy: *mut cpufreq_policy, index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us2e_freq_cpu_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn us2e_freq_cpu_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn us2e_freq_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn us2e_freq_exit() -> void __exit {
