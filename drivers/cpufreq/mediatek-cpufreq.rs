...
//! Source: drivers/cpufreq/mediatek-cpufreq.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_cpufreq_platform_data {
    pub min_volt_shift: c_int,
    pub max_volt_shift: c_int,
    pub proc_max_volt: c_int,
    pub sram_min_volt: c_int,
    pub sram_max_volt: c_int,
    pub ccifreq_supported: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_cpu_dvfs_info {
    pub cpus: cpumask,
    pub cpu_dev: *mut device,
    pub cci_dev: *mut device,
    pub proc_reg: *mut regulator,
    pub sram_reg: *mut regulator,
    pub cpu_clk: *mut clk,
    pub inter_clk: *mut clk,
    pub list_head: list_head,
    pub intermediate_voltage: c_int,
    pub need_voltage_tracking: bool,
    pub vproc_on_boot: c_int,
    pub pre_vproc: c_int,
// Avoid race condition for regulators between notify and policy
    pub reg_lock: mutex,
    pub opp_nb: notifier_block,
    pub opp_cpu: c_uint,
    pub current_freq: c_ulong,
    pub soc_data: *const mtk_cpufreq_platform_data,
    pub vtrack_max: c_int,
    pub ccifreq_bound: bool,
}
    ...
    let mut retry: c_int = info.vtrack_max;
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_set_voltage(info: *mut mtk_cpu_dvfs_info, vproc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_ccifreq_ready(info: *mut mtk_cpu_dvfs_info) -> bool {
    ...
    if (!sup_link) {
    dev_err(info.cpu_dev, "cpu%d: sup_link is core::ptr::null_mut()\n", info.opp_cpu);
    return false;
    }
...
#[no_mangle]
pub unsafe extern "C" fn __free(_arg: put_cpufreq_policy) -> *mut cpufreq_policy policy {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpu_dvfs_info_init(info: *mut mtk_cpu_dvfs_info, cpu: c_int) -> c_int {
...
// Both presence and absence of sram regulator are valid cases.
    ...
    info.sram_reg = core::ptr::null_mut();
    } else {
...
//
    info.need_voltage_tracking = (info.sram_reg != core::ptr::null_mut());
//
...
#[no_mangle]
unsafe extern "C" fn mtk_cpu_dvfs_info_release(info: *mut mtk_cpu_dvfs_info) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_driver_init() -> int __init {
...
// probing.
//
    cpufreq_pdev = platform_device_register_data(core::ptr::null_mut(), "mtk-cpufreq", -1,
    data, sizeof(*data));
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_driver_exit() -> void __exit {
