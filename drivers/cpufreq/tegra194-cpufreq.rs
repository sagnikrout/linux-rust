...
//! Source: drivers/cpufreq/tegra194-cpufreq.c
#![no_std]
...
pub const MAX_DELTA_KHZ: c_int = 115200;
pub const NDIV_MASK: c_uint = 0x1FF;

pub const CMU_CLKS_BASE: c_uint = 0x2000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_cpu_data {
    pub cpuid: u32,
    pub clusterid: u32,
    pub freq_core_reg: *mut void __iomem,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_cpu_ctr {
    pub cpu: u32,
    pub last_coreclk_cnt: u32 coreclk_cnt,,
    pub last_refclk_cnt: u32 refclk_cnt,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct read_counters_work {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_cpufreq_ops {
    pub c): *mut *mut void (read_counters)(struct tegra_cpu_ctr,
    pub ndiv): *mut *mut *mut void (set_cpu_ndiv)(struct cpufreq_policy policy, u64,
    pub clusterid): *mut *mut *mut void (get_cpu_cluster_id)(u32 cpu, u32 cpuid, u32,
    pub ndiv): *mut *mut int (get_cpu_ndiv)(u32 cpu, u32 cpuid, u32 clusterid, u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_cpufreq_soc {
    pub ops: *mut tegra_cpufreq_ops,
    pub maxcpus_per_cluster: c_int,
    pub num_clusters: c_uint,
    pub actmon_cntr_base: phys_addr_t,
    pub refclk_delta_min: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra194_cpufreq_data {
    pub regs: *mut void __iomem,
    pub bpmp_luts: *mut cpufreq_frequency_table,
    pub soc: *const tegra_cpufreq_soc,
    pub icc_dram_bw_scaling: bool,
    pub cpu_data: *mut tegra_cpu_data,
}

    static struct workqueue_struct *read_counters_wq;
#[no_mangle]
unsafe extern "C" fn tegra_cpufreq_set_bw(policy: *mut cpufreq_policy, freq_khz: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_get_cpu_mpidr(mpidr: *mut c_void) {
    static void tegra_get_cpu_mpidr(void *mpidr)
    {
// ((u64 *)mpidr) = read_cpuid_mpidr() & MPIDR_HWID_BITMASK;
    }
#[no_mangle]
unsafe extern "C" fn tegra234_get_cpu_cluster_id(cpu: u32, cpuid: *mut u32, clusterid: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra234_get_cpu_ndiv(cpu: u32, cpuid: u32, clusterid: u32, ndiv: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra234_set_cpu_ndiv(policy: *mut cpufreq_policy, ndiv: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn tegra234_read_counters(c: *mut tegra_cpu_ctr) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_get_cpu_cluster_id(cpu: u32, cpuid: *mut u32, clusterid: *mut u32) {
...
//
#[no_mangle]
unsafe extern "C" fn read_freq_feedback() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn tegra194_read_counters(c: *mut tegra_cpu_ctr) {
...
#[no_mangle]
unsafe extern "C" fn tegra_read_counters(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tegra194_calculate_speed(cpu: u32) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra194_get_cpu_ndiv_sysreg(ndiv: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_get_cpu_ndiv(cpu: u32, cpuid: u32, clusterid: u32, ndiv: *mut u64) -> c_int {
    static int tegra194_get_cpu_ndiv(u32 cpu, u32 cpuid, u32 clusterid, u64 *ndiv)
    {
    return smp_call_function_single(cpu, tegra194_get_cpu_ndiv_sysreg, &ndiv, true);
    }
#[no_mangle]
unsafe extern "C" fn tegra194_set_cpu_ndiv_sysreg(data: *mut c_void) {
    static void tegra194_set_cpu_ndiv_sysreg(void *data)
    {
    let mut ndiv_val: u64 = *(u64 *)data;
    asm volatile("msr s3_0_c15_c0_4, %0" : : "r" (ndiv_val));
    }
#[no_mangle]
unsafe extern "C" fn tegra194_set_cpu_ndiv(policy: *mut cpufreq_policy, ndiv: u64) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_get_speed(cpu: u32) -> c_uint {
    static unsigned int tegra194_get_speed(u32 cpu)
    {
    struct tegra194_cpufreq_data *data = cpufreq_get_driver_data();
    let mut clusterid: u32 = data.cpu_data[cpu].clusterid;
...
#[no_mangle]
unsafe extern "C" fn tegra194_cpufreq_init(policy: *mut cpufreq_policy) -> c_int {
    static int tegra194_cpufreq_init(struct cpufreq_policy *policy)
    {
    struct tegra194_cpufreq_data *data = cpufreq_get_driver_data();
    let mut maxcpus_per_cluster: c_int = data.soc.maxcpus_per_cluster;
    let mut clusterid: u32 = data.cpu_data[policy.cpu].clusterid;
...
#[no_mangle]
unsafe extern "C" fn tegra194_cpufreq_online(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cpufreq_offline(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cpufreq_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cpufreq_free_resources() {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cpufreq_store_physids(cpu: c_uint, data: *mut tegra194_cpufreq_data) -> c_int {
    static int tegra194_cpufreq_store_physids(unsigned int cpu, struct tegra194_cpufreq_data *data)
    {
    let mut num_cpus: c_int = data.soc.maxcpus_per_cluster * data.soc.num_clusters;
    u32 cpuid, clusterid;
    u64 mpidr_id;
    if (cpu > (num_cpus - 1)) {
...
#[no_mangle]
unsafe extern "C" fn tegra194_cpufreq_probe(pdev: *mut platform_device) -> c_int {
...
// Check for optional OPPv2 and interconnect paths on CPU0 to enable ICC scaling
    ...
    err = dev_pm_opp_of_find_icc_paths(cpu_dev, core::ptr::null_mut());
    if (!err)
...
#[no_mangle]
unsafe extern "C" fn tegra194_cpufreq_remove(pdev: *mut platform_device) {
