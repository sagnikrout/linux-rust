...
//! Source: drivers/cpufreq/cpufreq-dt-platdev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cpu0_node_has_opp_v2_prop() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_dt_platdev_init() -> int __init {
    ...
    return -ENODEV;
    create_pdev:
    return PTR_ERR_OR_ZERO(platform_device_register_data(core::ptr::null_mut(), "cpufreq-dt",
    -1, data,
