...
//! Source: drivers/cpufreq/imx-cpufreq-dt.c
#![no_std]
...
pub const OCOTP_CFG3_SPEED_GRADE_SHIFT: c_int = 8;

pub const OCOTP_CFG3_MKT_SEGMENT_SHIFT: c_int = 6;

pub const IMX8MP_OCOTP_CFG3_MKT_SEGMENT_SHIFT: c_int = 5;

pub const IMX7ULP_MAX_RUN_FREQ: c_int = 528000;
...
#[no_mangle]
unsafe extern "C" fn imx_cpufreq_dt_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ret)
    return ret;
    dt_pdev = platform_device_register_data(core::ptr::null_mut(), "cpufreq-dt",
    -1, &imx7ulp_data,
    sizeof(imx7ulp_data));
    if (IS_ERR(dt_pdev)) {
...
//
    ...
    &pdev.dev, "cpufreq-dt", -1, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn imx_cpufreq_dt_remove(pdev: *mut platform_device) {
