...
//! Source: drivers/cpufreq/brcmstb-avs-cpufreq.c
#![no_std]
...
pub const AVS_MAX_CMD_ARGS: c_int = 4;
//
...
pub const AVS_MBOX_COMMAND: c_uint = 0x00;
pub const AVS_MBOX_STATUS: c_uint = 0x04;
pub const AVS_MBOX_VOLTAGE0: c_uint = 0x08;
pub const AVS_MBOX_TEMP0: c_uint = 0x0c;
pub const AVS_MBOX_PV0: c_uint = 0x10;
pub const AVS_MBOX_MV0: c_uint = 0x14;

pub const AVS_MBOX_REVISION: c_uint = 0x28;
pub const AVS_MBOX_PSTATE: c_uint = 0x2c;
pub const AVS_MBOX_HEARTBEAT: c_uint = 0x30;
pub const AVS_MBOX_MAGIC: c_uint = 0x34;
pub const AVS_MBOX_SIGMA_HVT: c_uint = 0x38;
pub const AVS_MBOX_SIGMA_SVT: c_uint = 0x3c;
pub const AVS_MBOX_VOLTAGE1: c_uint = 0x40;
pub const AVS_MBOX_TEMP1: c_uint = 0x44;
pub const AVS_MBOX_PV1: c_uint = 0x48;
pub const AVS_MBOX_MV1: c_uint = 0x4c;
pub const AVS_MBOX_FREQUENCY: c_uint = 0x50;
// AVS Commands
pub const AVS_CMD_AVAILABLE: c_uint = 0x00;
pub const AVS_CMD_DISABLE: c_uint = 0x10;
pub const AVS_CMD_ENABLE: c_uint = 0x11;
pub const AVS_CMD_S2_ENTER: c_uint = 0x12;
pub const AVS_CMD_S2_EXIT: c_uint = 0x13;
pub const AVS_CMD_BBM_ENTER: c_uint = 0x14;
pub const AVS_CMD_BBM_EXIT: c_uint = 0x15;
pub const AVS_CMD_S3_ENTER: c_uint = 0x16;
pub const AVS_CMD_S3_EXIT: c_uint = 0x17;
pub const AVS_CMD_BALANCE: c_uint = 0x18;
// PMAP and P-STATE commands
pub const AVS_CMD_GET_PMAP: c_uint = 0x30;
pub const AVS_CMD_SET_PMAP: c_uint = 0x31;
pub const AVS_CMD_GET_PSTATE: c_uint = 0x40;
pub const AVS_CMD_SET_PSTATE: c_uint = 0x41;
// Different modes AVS supports (for GET_PMAP/SET_PMAP)
pub const AVS_MODE_AVS: c_uint = 0x0;
pub const AVS_MODE_DFS: c_uint = 0x1;
pub const AVS_MODE_DVS: c_uint = 0x2;
pub const AVS_MODE_DVFS: c_uint = 0x3;
//
// PMAP parameter p1
// unused:31-24, mdiv_p0:23-16, unused:15-14, pdiv:13-10 , ndiv_int:9-0
//
pub const NDIV_INT_SHIFT: c_int = 0;
pub const NDIV_INT_MASK: c_uint = 0x3ff;
pub const PDIV_SHIFT: c_int = 10;
pub const PDIV_MASK: c_uint = 0xf;
pub const MDIV_P0_SHIFT: c_int = 16;
pub const MDIV_P0_MASK: c_uint = 0xff;
//
// PMAP parameter p2
// mdiv_p4:31-24, mdiv_p3:23-16, mdiv_p2:15:8, mdiv_p1:7:0
//
pub const MDIV_P1_SHIFT: c_int = 0;
pub const MDIV_P1_MASK: c_uint = 0xff;
pub const MDIV_P2_SHIFT: c_int = 8;
pub const MDIV_P2_MASK: c_uint = 0xff;
pub const MDIV_P3_SHIFT: c_int = 16;
pub const MDIV_P3_MASK: c_uint = 0xff;
pub const MDIV_P4_SHIFT: c_int = 24;
pub const MDIV_P4_MASK: c_uint = 0xff;
// Different P-STATES AVS supports (for GET_PSTATE/SET_PSTATE)
pub const AVS_PSTATE_P0: c_uint = 0x0;
pub const AVS_PSTATE_P1: c_uint = 0x1;
pub const AVS_PSTATE_P2: c_uint = 0x2;
pub const AVS_PSTATE_P3: c_uint = 0x3;
pub const AVS_PSTATE_P4: c_uint = 0x4;

// CPU L2 Interrupt Controller Registers
pub const AVS_CPU_L2_SET0: c_uint = 0x04;

// AVS Command Status Values
pub const AVS_STATUS_CLEAR: c_uint = 0x00;
// Command/notification accepted
pub const AVS_STATUS_SUCCESS: c_uint = 0xf0;
// Command/notification rejected
pub const AVS_STATUS_FAILURE: c_uint = 0xff;
// Invalid command/notification (unknown)
pub const AVS_STATUS_INVALID: c_uint = 0xf1;
// Non-AVS modes are not supported
pub const AVS_STATUS_NO_SUPP: c_uint = 0xf2;
// Cannot set P-State until P-Map supplied
pub const AVS_STATUS_NO_MAP: c_uint = 0xf3;
// Cannot change P-Map after initial P-Map set
pub const AVS_STATUS_MAP_SET: c_uint = 0xf4;
// Max AVS status; higher numbers are used for debugging
pub const AVS_STATUS_MAX: c_uint = 0xff;
// Other AVS related constants
pub const AVS_LOOP_LIMIT: c_int = 10000;

pub const AVS_FIRMWARE_MAGIC: c_uint = 0xa11600d1;
...
pub struct private_data {
    ...
    pub avs_intr_base: *mut void __iomem,
    pub dev: *mut device,
    pub done: completion,
    pub sem: semaphore,
    pub pmap: pmap,
    ...
    void __iomem *ptr;
    np = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), name);
    if (!np)
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_get_pmap(priv: *mut private_data, pmap: *mut pmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_set_pmap(priv: *mut private_data, pmap: *mut pmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_get_pstate(priv: *mut private_data, pstate: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_set_pstate(priv: *mut private_data, pstate: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_get_voltage(base: *mut void __iomem) -> u32 {
    static u32 brcm_avs_get_voltage(void __iomem *base)
    {
    return readl(base + AVS_MBOX_VOLTAGE1);
    }
#[no_mangle]
unsafe extern "C" fn brcm_avs_get_frequency(base: *mut void __iomem) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn brcm_avs_is_firmware_loaded(priv: *mut private_data) -> bool {
    static bool brcm_avs_is_firmware_loaded(struct private_data *priv)
    {
    u32 magic;
    int rc;
    rc = brcm_avs_get_pmap(priv, core::ptr::null_mut());
    magic = readl(priv.base + AVS_MBOX_MAGIC);
    return (magic == AVS_FIRMWARE_MAGIC) && (rc != -ENOTSUPP) &&
    (rc != -EINVAL);
    }
#[no_mangle]
unsafe extern "C" fn brcm_avs_cpufreq_get(cpu: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_suspend(policy: *mut cpufreq_policy) -> c_int {
...
// This is best effort. Nothing to do if it fails.
    (void)__issue_avs_command(priv, AVS_CMD_S2_ENTER, 0, 0, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn brcm_avs_resume(policy: *mut cpufreq_policy) -> c_int {
    static int brcm_avs_resume(struct cpufreq_policy *policy)
    {
    struct private_data *priv = policy.driver_data;
    int ret;
// This is best effort. Nothing to do if it fails.
    (void)__issue_avs_command(priv, AVS_CMD_S2_EXIT, 0, 0, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn brcm_avs_prepare_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_prepare_uninit(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_cpufreq_init(policy: *mut cpufreq_policy) -> c_int {
...
// All cores share the same clock and thus the same policy.
    ...
    ret = __issue_avs_command(priv, AVS_CMD_ENABLE, 0, 0, core::ptr::null_mut());
    if (!ret) {
    unsigned int pstate;
    ret = brcm_avs_get_pstate(priv, &pstate);
    if (!ret) {
...
#[no_mangle]
unsafe extern "C" fn show_brcm_avs_pstate(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn show_brcm_avs_mode(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn show_brcm_avs_pmap(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn show_brcm_avs_voltage(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn show_brcm_avs_frequency(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_cpufreq_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brcm_avs_cpufreq_remove(pdev: *mut platform_device) {
