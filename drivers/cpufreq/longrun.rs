...
//! Source: drivers/cpufreq/longrun.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn longrun_get_policy(policy: *mut cpufreq_policy) {
...
//
#[no_mangle]
unsafe extern "C" fn longrun_set_policy(policy: *mut cpufreq_policy) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn longrun_verify_policy(policy: *mut cpufreq_policy_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn longrun_get(cpu: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn longrun_cpu_init(policy: *mut cpufreq_policy) -> c_int {
...
// cpuinfo and default policy values
    ...
    X86_MATCH_VENDOR_FEATURE(TRANSMETA, X86_FEATURE_LONGRUN, core::ptr::null_mut()),
    {}
    };
...
//
#[no_mangle]
unsafe extern "C" fn longrun_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn longrun_exit() -> void __exit {
