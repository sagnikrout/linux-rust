...
//! Source: drivers/cpufreq/intel_pstate.c
#![no_std]
...
pub const INTEL_CPUFREQ_TRANSITION_LATENCY: c_int = 20000;
pub const INTEL_CPUFREQ_TRANSITION_DELAY_HWP: c_int = 5000;
pub const INTEL_CPUFREQ_TRANSITION_DELAY: c_int = 500;

pub const FRAC_BITS: c_int = 8;

pub const EXT_BITS: c_int = 6;

#[no_mangle]
pub unsafe extern "C" fn mul_fp(x: i32, y: i32) -> i32 {
    static inline int32_t mul_fp(int32_t x, int32_t y)
    {
    return ((int64_t)x * (int64_t)y) >> FRAC_BITS;
    }
#[no_mangle]
pub unsafe extern "C" fn div_fp(x: i64, y: i64) -> i32 {
    static inline int32_t div_fp(s64 x, s64 y)
    {
    return div64_s64((int64_t)x << FRAC_BITS, y);
    }
#[no_mangle]
pub unsafe extern "C" fn ceiling_fp(x: i32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mul_ext_fp(x: u64, y: u64) -> u64 {
    static inline u64 mul_ext_fp(u64 x, u64 y)
    {
    return (x * y) >> EXT_FRAC_BITS;
    }
#[no_mangle]
pub unsafe extern "C" fn div_ext_fp(x: u64, y: u64) -> u64 {
...
pub struct pstate_data {
    pub current_pstate: c_int,
    pub min_pstate: c_int,
    pub max_pstate: c_int,
    pub max_pstate_physical: c_int,
    pub perf_ctl_scaling: c_int,
    pub scaling: c_int,
    pub turbo_pstate: c_int,
    pub min_freq: c_uint,
    pub max_freq: c_uint,
    pub turbo_freq: c_uint,
}
...
pub struct global_params {
    ...
    pub max_perf_pct: c_int,
    pub min_perf_pct: c_int,
}
...
pub struct cpudata {
    ...
    pub acpi_perf_data: acpi_processor_performance,
    pub valid_pss_table: bool,
    ...
    pub capacity_perf: c_uint,
    pub sched_flags: c_uint,
    pub hwp_boost_min: u32,
    pub suspended: bool,

    pub pd_registered: bool,

    pub hwp_notify_work: delayed_work,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pstate_funcs {
    pub cpu): *mut *mut int (get_max)(int,
    pub cpu): *mut *mut int (get_max_physical)(int,
    pub cpu): *mut *mut int (get_min)(int,
    pub cpu): *mut *mut int (get_turbo)(int,
    pub (*get_scaling)(void): *mut c_int,
    pub cpu): *mut *mut int (get_cpu_scaling)(int,
    pub (*get_aperf_mperf_shift)(void): *mut c_int,
    pub pstate): *mut *mut *mut u64 (get_val)(struct cpudata, int,
    pub ): *mut *mut void (get_vid)(struct cpudata,
}
    ...
    let mut __read_mostly: static u32 hwp_desired_mask = ~0U;
    static struct cpufreq_driver *intel_pstate_driver __read_mostly;
pub const INTEL_PSTATE_CORE_SCALING: c_int = 100000;
pub const HYBRID_SCALING_FACTOR_ADL: c_int = 78741;
pub const HYBRID_SCALING_FACTOR_MTL: c_int = 80000;
pub const HYBRID_SCALING_FACTOR_LNL: c_int = 86957;
    static int hybrid_scaling_factor;
#[no_mangle]
pub unsafe extern "C" fn core_get_scaling() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_acpi_pm_profile_server() -> bool {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_get_ppc_enable_status() -> bool {
...
#[no_mangle]
unsafe extern "C" fn intel_pstste_sched_itmt_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_set_itmt_prio(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_get_cppc_guaranteed(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_cppc_get_scaling(cpu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_set_itmt_prio(cpu: c_int) {
    static inline void intel_pstate_set_itmt_prio(int cpu)
    {
    }

#[no_mangle]
unsafe extern "C" fn intel_pstate_init_acpi_perf_limits(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_exit_perf_limits(policy: *mut cpufreq_policy) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_init_acpi_perf_limits(policy: *mut cpufreq_policy) {
    static inline void intel_pstate_init_acpi_perf_limits(struct cpufreq_policy *policy)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_exit_perf_limits(policy: *mut cpufreq_policy) {
    static inline void intel_pstate_exit_perf_limits(struct cpufreq_policy *policy)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_acpi_pm_profile_server() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_get_cppc_guaranteed(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_freq_to_hwp(cpu: *mut cpudata, freq: c_int) -> c_int {
    static int intel_pstate_freq_to_hwp(struct cpudata *cpu, int freq)
    {
    return intel_pstate_freq_to_hwp_rel(cpu, freq, CPUFREQ_RELATION_L);
    }
#[no_mangle]
unsafe extern "C" fn turbo_is_disabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn min_perf_pct_min() -> c_int {
    static int min_perf_pct_min(void)
    {
    struct cpudata *cpu = all_cpu_data[0];
    let mut turbo_pstate: c_int = cpu.pstate.turbo_pstate;
    return turbo_pstate ?
    (cpu.pstate.min_pstate * 100 / turbo_pstate) : 0;
    }
#[no_mangle]
unsafe extern "C" fn intel_pstate_get_epp(cpu_data: *mut cpudata, hwp_req_data: u64) -> i16 {
    static s16 intel_pstate_get_epp(struct cpudata *cpu_data, u64 hwp_req_data)
    {
    let mut epp: i16 = -EOPNOTSUPP;
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_get_energy_pref_index(cpu_data: *mut cpudata, raw_epp: *mut c_int) -> c_int {
    static int intel_pstate_get_energy_pref_index(struct cpudata *cpu_data, int *raw_epp)
    {
    s16 epp;
    let mut index: c_int = -EINVAL;
// raw_epp = 0;
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_set_epp(cpu: *mut cpudata, epp: u32) -> c_int {
...
//
    let mut value: u64 = READ_ONCE(cpu.hwp_req_cached);
...
//
    ...
    epp = raw_epp;
#[no_mangle]
pub unsafe extern "C" fn if(-EINVAL: epp ==) -> else {
    else if (epp == -EINVAL)
...
//
    ...
    let mut i: c_int = 0;
    let mut ret: c_int = 0;
    while (energy_perf_strings[i] != core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn show_base_frequency(policy: *mut cpufreq_policy, buf: *mut c_char) -> isize {
    ...
    [HWP_CPUFREQ_ATTR_COUNT] = core::ptr::null_mut(),
    };
#[no_mangle]
unsafe extern "C" fn hybrid_get_cpu_type(cpu: c_uint) -> u8 {
...
pub const HYBRID_EM_STATE_COUNT: c_int = 4;
...
#[no_mangle]
unsafe extern "C" fn hybrid_has_l3(cpu: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hybrid_register_perf_domain(cpu: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hybrid_register_all_perf_domains() {
...
#[no_mangle]
unsafe extern "C" fn hybrid_update_perf_domain(cpu: *mut cpudata) {
...
#[no_mangle]
unsafe extern "C" fn hybrid_set_cpu_capacity(cpu: *mut cpudata) {
...
#[no_mangle]
unsafe extern "C" fn hybrid_clear_cpu_capacity(cpunum: c_uint) {
    static void hybrid_clear_cpu_capacity(unsigned int cpunum)
    {
    arch_set_cpu_capacity(cpunum, 1, 1, 1, 1);
    }
#[no_mangle]
unsafe extern "C" fn hybrid_get_capacity_perf(cpu: *mut cpudata) {
    static void hybrid_get_capacity_perf(struct cpudata *cpu)
    {
    let mut hwp_cap: u64 = READ_ONCE(cpu.hwp_cap_cached);
...
#[no_mangle]
unsafe extern "C" fn hybrid_set_capacity_of_cpus() {
...
#[no_mangle]
unsafe extern "C" fn hybrid_update_cpu_capacity_scaling() {
    static void hybrid_update_cpu_capacity_scaling(void)
    {
    struct cpudata *max_perf_cpu = core::ptr::null_mut();
    let mut max_cap_perf: c_uint = 0;
    int cpunum;
    for_each_online_cpu(cpunum) {
    struct cpudata *cpu = all_cpu_data[cpunum];
    if (!cpu)
...
#[no_mangle]
unsafe extern "C" fn __hybrid_refresh_cpu_capacity_scaling() {
    static void __hybrid_refresh_cpu_capacity_scaling(void)
    {
    hybrid_max_perf_cpu = core::ptr::null_mut();
    hybrid_update_cpu_capacity_scaling();
    }
#[no_mangle]
unsafe extern "C" fn hybrid_refresh_cpu_capacity_scaling() {
...
#[no_mangle]
unsafe extern "C" fn hybrid_init_cpu_capacity_scaling(refresh: bool) {
...
#[no_mangle]
unsafe extern "C" fn hybrid_clear_max_perf_cpu() -> bool {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_update_freq_limits(cpu: *mut cpudata) {
    static void intel_pstate_update_freq_limits(struct cpudata *cpu)
    {
    let mut scaling: c_int = cpu.pstate.scaling;
    let mut turbo_freq: c_uint = cpu.pstate.turbo_pstate * scaling;
    let mut max_freq: c_uint = cpu.pstate.max_pstate * scaling;
    let mut perf_ctl_scaling: c_int = cpu.pstate.perf_ctl_scaling;
...
#[no_mangle]
unsafe extern "C" fn __intel_pstate_get_hwp_cap(cpu: *mut cpudata) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_get_hwp_cap(cpu: *mut cpudata) {
...
#[no_mangle]
unsafe extern "C" fn hybrid_update_capacity(cpu: *mut cpudata) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_hwp_set(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_hwp_offline(cpu: *mut cpudata) {
...
pub const POWER_CTL_EE_ENABLE: c_int = 1;
pub const POWER_CTL_EE_DISABLE: c_int = 2;
// Enable bit for Dynamic Efficiency Control (DEC)
pub const POWER_CTL_DEC_ENABLE: c_int = 27;
    static int power_ctl_ee_state;
#[no_mangle]
unsafe extern "C" fn set_power_ctl_ee_state(input: bool) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_hwp_reenable(cpu: *mut cpudata) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_suspend(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_resume(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(POWER_CTL_EE_DISABLE: power_ctl_ee_state ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_update_policies() {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_update_max_freq(cpu: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_update_limits(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_update_limits_for_all() {
...
// sysfs begin
    ...
    if (no_turbo) {
    struct cpudata *cpu = all_cpu_data[0];
    let mut pct: c_int = cpu.pstate.max_pstate * 100 / cpu.pstate.turbo_pstate;
...
#[no_mangle]
unsafe extern "C" fn update_cpu_qos_request(cpu: c_int, type: enum freq_qos_req_type) {
...
#[no_mangle]
unsafe extern "C" fn update_qos_requests(type: enum freq_qos_req_type) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_sysfs_expose_params() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_sysfs_remove() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_sysfs_expose_hwp_dynamic_boost() {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_sysfs_hide_hwp_dynamic_boost() {
...
// sysfs end
#[no_mangle]
unsafe extern "C" fn intel_pstate_notify_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn notify_hwp_interrupt() {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_disable_hwp_interrupt(cpudata: *mut cpudata) {
    static void intel_pstate_disable_hwp_interrupt(struct cpudata *cpudata)
    {
    bool cancel_work;
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_enable_hwp_interrupt(cpudata: *mut cpudata) {
    static void intel_pstate_enable_hwp_interrupt(struct cpudata *cpudata)
    {
// Enable HWP notification interrupt for performance change
    if (boot_cpu_has(X86_FEATURE_HWP_NOTIFY)) {
    let mut interrupt_mask: u64 = HWP_GUARANTEED_PERF_CHANGE_REQ;
    raw_spin_lock_irq(&hwp_notify_lock);
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_update_epp_defaults(cpudata: *mut cpudata) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_hwp_enable(cpudata: *mut cpudata) {
    static void intel_pstate_hwp_enable(struct cpudata *cpudata)
    {
...
#[no_mangle]
unsafe extern "C" fn get_perf_ctl_val(pstate: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn atom_get_min_pstate(not_used: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atom_get_max_pstate(not_used: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atom_get_turbo_pstate(not_used: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atom_get_val(cpudata: *mut cpudata, pstate: c_int) -> u64 {
    static u64 atom_get_val(struct cpudata *cpudata, int pstate)
    {
    let mut val: u64 = get_perf_ctl_val(pstate);
    int32_t vid_fp;
    u32 vid;
...
#[no_mangle]
unsafe extern "C" fn silvermont_get_scaling() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn airmont_get_scaling() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atom_get_vid(cpudata: *mut cpudata) {
...
#[no_mangle]
unsafe extern "C" fn core_get_min_pstate(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn core_get_max_pstate_physical(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn core_get_tdp_ratio(cpu: c_int, plat_info: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn core_get_max_pstate(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn core_get_turbo_pstate(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn core_get_val(cpudata: *mut cpudata, pstate: c_int) -> u64 {
    static u64 core_get_val(struct cpudata *cpudata, int pstate)
    {
    return get_perf_ctl_val(pstate);
    }
#[no_mangle]
unsafe extern "C" fn knl_get_aperf_mperf_shift() -> c_int {
    static int knl_get_aperf_mperf_shift(void)
    {
    return 10;
    }
#[no_mangle]
unsafe extern "C" fn knl_get_turbo_pstate(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwp_get_cpu_scaling(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_get_hwp_pstates(cpu: *mut cpudata) {
    static void intel_pstate_get_hwp_pstates(struct cpudata *cpu)
    {
    let mut perf_ctl_max_phys: c_int = cpu.pstate.max_pstate_physical;
    let mut perf_ctl_scaling: c_int = cpu.pstate.perf_ctl_scaling;
    let mut perf_ctl_turbo: c_int = cpu.pstate.turbo_pstate;
    let mut cpuid: c_int = cpu.cpu;
    __intel_pstate_get_hwp_cap(cpu);
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_get_cpu_pstates(cpu: *mut cpudata) {
    static void intel_pstate_get_cpu_pstates(struct cpudata *cpu)
    {
    let mut perf_ctl_scaling: c_int = pstate_funcs.get_scaling();
...
// workoads.
//
    let mut hwp_boost_hold_time_ns: static int = 3 * NSEC_PER_MSEC;
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_hwp_boost_up(cpu: *mut cpudata) {
    static inline void intel_pstate_hwp_boost_up(struct cpudata *cpu)
    {
    let mut hwp_req: u64 = READ_ONCE(cpu.hwp_req_cached);
    let mut hwp_cap: u64 = READ_ONCE(cpu.hwp_cap_cached);
    let mut max_limit: u32 = (hwp_req & 0xff00) >> 8;
    let mut min_limit: u32 = (hwp_req & 0xff);
    u32 boost_level1;
//
...
#[no_mangle]
pub unsafe extern "C" fn if(HWP_GUARANTEED_PERF(hwp_cap): cpu->hwp_boost_min <) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_hwp_boost_down(cpu: *mut cpudata) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_calc_avg_perf(cpu: *mut cpudata) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_pstate_sample(cpu: *mut cpudata, time: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn get_avg_frequency(cpu: *mut cpudata) -> i32 {
    static inline int32_t get_avg_frequency(struct cpudata *cpu)
    {
    return mul_ext_fp(cpu.sample.core_avg_perf, cpu_khz);
    }
#[no_mangle]
pub unsafe extern "C" fn get_avg_pstate(cpu: *mut cpudata) -> i32 {
...
#[no_mangle]
pub unsafe extern "C" fn get_target_pstate(cpu: *mut cpudata) -> i32 {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_prepare_request(cpu: *mut cpudata, pstate: c_int) -> c_int {
    static int intel_pstate_prepare_request(struct cpudata *cpu, int pstate)
    {
    let mut min_pstate: c_int = max(cpu.pstate.min_pstate, cpu.min_perf_ratio);
    let mut max_pstate: c_int = max(min_pstate, cpu.max_perf_ratio);
    return clamp_t(int, pstate, min_pstate, max_pstate);
    }
#[no_mangle]
unsafe extern "C" fn intel_pstate_update_pstate(cpu: *mut cpudata, pstate: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_adjust_pstate(cpu: *mut cpudata) {
    static void intel_pstate_adjust_pstate(struct cpudata *cpu)
    {
    let mut from: c_int = cpu.pstate.current_pstate;
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_init_cpu(cpunum: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_set_update_util_hook(cpu_num: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_clear_update_util_hook(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_get_max_freq(cpu: *mut cpudata) -> c_int {
...
// Normalize user input to [min_perf, max_perf]
    ...
    let mut turbo_max: c_int = cpu.pstate.turbo_pstate;
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_set_pstate(cpu: *mut cpudata, pstate: c_int) {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_set_policy(policy: *mut cpufreq_policy) -> c_int {
    static int intel_pstate_set_policy(struct cpufreq_policy *policy)
    {
    let mut freq: c_uint = policy.min;
    struct cpudata *cpu;
...
//
    ...
    let mut pstate: c_int = max(cpu.pstate.min_pstate, cpu.max_perf_ratio);
//
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_verify_policy(policy: *mut cpufreq_policy_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_set_min_pstate(cpu: *mut cpudata) {
    static void intel_pstate_set_min_pstate(struct cpudata *cpu)
    {
    intel_pstate_set_pstate(cpu, cpu.pstate.min_pstate);
    }
#[no_mangle]
unsafe extern "C" fn intel_cpufreq_cpu_offline(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_cpu_online(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_cpu_offline(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_cpu_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn __intel_pstate_cpu_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_cpu_init(policy: *mut cpufreq_policy) -> c_int {
    static int intel_pstate_cpu_init(struct cpufreq_policy *policy)
    {
    let mut ret: c_int = __intel_pstate_cpu_init(policy);
    struct cpudata *cpu;
    if (ret)
    return ret;
//
...
#[no_mangle]
unsafe extern "C" fn intel_cpufreq_verify_policy(policy: *mut cpufreq_policy_data) -> c_int {
...
//
pub const INTEL_PSTATE_TRACE_TARGET: c_int = 10;
pub const INTEL_PSTATE_TRACE_FAST_SWITCH: c_int = 90;
#[no_mangle]
unsafe extern "C" fn intel_cpufreq_trace(cpu: *mut cpudata, trace_type: c_uint, old_pstate: c_int) {
    ...
    {
    let mut prev: u64 = READ_ONCE(cpu.hwp_req_cached), value = prev;
    value &= ~HWP_MIN_PERF(~0L);
    value |= HWP_MIN_PERF(min);
    value &= ~HWP_MAX_PERF(~0L);
    value |= HWP_MAX_PERF(max);
    ...
    {
    struct cpudata *cpu = all_cpu_data[policy.cpu];
    let mut old_pstate: c_int = cpu.pstate.current_pstate;
    target_pstate = intel_pstate_prepare_request(cpu, target_pstate);
    if (hwp_active) {
...
#[no_mangle]
unsafe extern "C" fn intel_cpufreq_cpu_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_cpufreq_cpu_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn intel_cpufreq_suspend(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_driver_cleanup() {
    ...
    WRITE_ONCE(all_cpu_data[cpu], core::ptr::null_mut());
    }
    }
    cpus_read_unlock();
    intel_pstate_driver = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn intel_pstate_register_driver(driver: *mut cpufreq_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_show_status(buf: *mut c_char) -> isize {
    static ssize_t intel_pstate_show_status(char *buf)
    {
    if (!intel_pstate_driver)
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_update_status(buf: *const c_char, size: usize) -> c_int {
    static int intel_pstate_update_status(const char *buf, size_t size)
    {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_msrs_not_valid() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn copy_cpu_funcs(funcs: *mut pstate_funcs) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_no_acpi_pss() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_no_acpi_pcch() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_has_acpi_ppc() -> bool __init {
...
// Hardware vendor-specific info that has its own power management modes
    ...
    {"HP    ", "ProLiant", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PSS},
    {"ORACLE", "X4-2    ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X4-2L   ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X4-2B   ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X3-2    ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X3-2L   ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X3-2B   ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X4470M2 ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X4270M3 ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X4270M2 ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X4170M2 ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X4170 M3", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X4275 M3", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "X6-2    ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    {"ORACLE", "Sudbury ", 0, ACPI_SIG_FADT, all_versions, core::ptr::null_mut(), PPC},
    { } /* End */
    };

#[no_mangle]
unsafe extern "C" fn intel_pstate_platform_pwr_mgmt_exists() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_request_control_from_smm() {
...
pub const INTEL_PSTATE_HWP_NOT_HYBRID: c_uint = 0x01;
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_hwp_is_enabled() -> bool {
...
#[no_mangle]
unsafe extern "C" fn hwp_check_epp() -> bool {
    static bool hwp_check_epp(void)
    {
    if (boot_cpu_has(X86_FEATURE_HWP_EPP))
    return true;
// Without EPP support, don't expose EPP-related sysfs attributes.
    hwp_cpufreq_attrs[HWP_PERFORMANCE_PREFERENCE_INDEX] = core::ptr::null_mut();
    hwp_cpufreq_attrs[HWP_PERFORMANCE_AVAILABLE_PREFERENCES_INDEX] = core::ptr::null_mut();
    return false;
    }
#[no_mangle]
unsafe extern "C" fn hwp_check_dec() -> bool {
    static bool hwp_check_dec(void)
    {
    let mut power_ctl: u64 = 0;
    rdmsrq_safe(MSR_IA32_POWER_CTL, &power_ctl);
    return !!(power_ctl & BIT(POWER_CTL_DEC_ENABLE));
    }
#[no_mangle]
unsafe extern "C" fn intel_pstate_init() -> int __init {
...
//
    ...
    if (id) {
    let mut epp_present: bool = hwp_check_epp();
    let mut dec_present: bool = hwp_check_dec();
//
...
#[no_mangle]
unsafe extern "C" fn intel_pstate_setup(str: *mut c_char) -> int __init {
    ...
    no_load = 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "active")) -> else {
    else if (!strcmp(str, "active"))
    default_driver = &intel_pstate;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "passive")) -> else {
