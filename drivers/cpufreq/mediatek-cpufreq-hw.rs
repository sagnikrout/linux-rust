...
//! Source: drivers/cpufreq/mediatek-cpufreq-hw.c
#![no_std]
...
pub const LUT_ROW_SIZE: c_uint = 0x4;

pub const POLL_USEC: c_int = 1000;
pub const TIMEOUT_USEC: c_int = 300000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_cpufreq_priv {
    pub dev: *mut device,
    pub variant: *const mtk_cpufreq_variant,
    pub fdvfs: *mut void __iomem,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_cpufreq_domain {
    pub parent: *mut mtk_cpufreq_priv,
    pub table: *mut cpufreq_frequency_table,
    pub reg_bases: [*mut void __iomem; REG_ARRAY_SIZE],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_cpufreq_variant {
    pub priv): *mut *mut int (init)(struct mtk_cpufreq_priv,
    pub reg_offsets: [u16; REG_ARRAY_SIZE],
    pub is_hybrid_dvfs: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_hw_mt8196_init(priv: *mut mtk_cpufreq_priv) -> c_int {
    static int mtk_cpufreq_hw_mt8196_init(struct mtk_cpufreq_priv *priv)
    {
    priv.fdvfs = devm_of_iomap(priv.dev, priv.dev.of_node, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_hw_get(cpu: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_hw_cpu_init(policy: *mut cpufreq_policy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_hw_cpu_exit(policy: *mut cpufreq_policy) {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_register_em(policy: *mut cpufreq_policy) {
    static void mtk_cpufreq_register_em(struct cpufreq_policy *policy)
    {
    let mut em_cb: em_data_callback = EM_DATA_CB(mtk_cpufreq_get_cpu_power);
    struct mtk_cpufreq_domain *data = policy.driver_data;
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_hw_driver_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtk_cpufreq_hw_driver_remove(pdev: *mut platform_device) {
