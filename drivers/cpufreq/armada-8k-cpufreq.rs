...
//! Source: drivers/cpufreq/armada-8k-cpufreq.c
#![no_std]
...
pub struct freq_table {
    ...
    pub freq: [c_uint; ARRAY_SIZE(opps_div)],
}
...
#[no_mangle]
unsafe extern "C" fn armada_8k_cpufreq_free_table(freq_tables: *mut freq_table) {
...
#[no_mangle]
unsafe extern "C" fn armada_8k_cpufreq_init() -> int __init {
    static int __init armada_8k_cpufreq_init(void)
    {
    let mut ret: c_int = 0, opps_index = 0, cpu, nb_cpus;
    struct freq_table *freq_tables;
    struct device_node *node;
    static struct cpumask cpus, shared_cpus;
    node = of_find_matching_node_and_match(core::ptr::null_mut(), armada_8k_cpufreq_of_match,
    core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn armada_8k_cpufreq_exit() -> void __exit {
