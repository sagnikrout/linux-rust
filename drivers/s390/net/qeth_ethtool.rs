...
//! Source: drivers/s390/net/qeth_ethtool.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qeth_get_sset_count(dev: *mut net_device, stringset: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_get_strings(dev: *mut net_device, stringset: u32, data: *mut u8) {
