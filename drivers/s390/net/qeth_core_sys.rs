...
//! Source: drivers/s390/net/qeth_core_sys.c
#![no_std]
...
//
    ...
    static DEVICE_ATTR(state, 0444, qeth_dev_state_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(chpid, 0444, qeth_dev_chpid_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(if_name, 0444, qeth_dev_if_name_show, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(card_type, 0444, qeth_dev_card_type_show, core::ptr::null_mut());
    static const char *qeth_get_bufsize_str(struct qeth_card *card)
    {
    if (card.qdio.in_buf_size == 16384)
    return "16k";
#[no_mangle]
pub unsafe extern "C" fn if(24576: card->qdio.in_buf_size ==) -> else {
    else if (card.qdio.in_buf_size == 24576)
    return "24k";
#[no_mangle]
pub unsafe extern "C" fn if(32768: card->qdio.in_buf_size ==) -> else {
    else if (card.qdio.in_buf_size == 32768)
    return "32k";
#[no_mangle]
pub unsafe extern "C" fn if(40960: card->qdio.in_buf_size ==) -> else {
    ...
    static DEVICE_ATTR(inbuf_size, 0444, qeth_dev_inbuf_size_show, core::ptr::null_mut());
...
//
    ...
    static DEVICE_ATTR(recover, 0200, core::ptr::null_mut(), qeth_dev_recover_store);
...
// parse input into isolation mode
    ...
    qeth_dev_switch_attrs_show, core::ptr::null_mut());
