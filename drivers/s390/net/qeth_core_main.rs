...
//! Source: drivers/s390/net/qeth_core_main.c
#![no_std]
...
// N  P  A    M  L  V                      H
    ...
    8, 1,   8, 5, &debug_hex_ascii_view, core::ptr::null_mut()},
    [QETH_DBF_MSG]	 = {"qeth_msg", 8, 1, 11 * sizeof(long), 3,
    &debug_sprintf_view, core::ptr::null_mut()},
    [QETH_DBF_CTRL]  = {"qeth_control",
    8, 1, QETH_DBF_CTRL_LEN, 5, &debug_hex_ascii_view, core::ptr::null_mut()},
    };
...
#[no_mangle]
pub unsafe extern "C" fn qeth_threads_running(card: *mut qeth_card, threads: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_clear_working_pool_list(card: *mut qeth_card) {
    ...
    queue.bufs[i].pool_entry = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn qeth_free_pool_entry(entry: *mut qeth_buffer_pool_entry) {
...
#[no_mangle]
unsafe extern "C" fn qeth_free_buffer_pool(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_alloc_buffer_pool(card: *mut qeth_card) -> c_int {
    static int qeth_alloc_buffer_pool(struct qeth_card *card)
    {
    let mut buf_elements: c_uint = QETH_MAX_BUFFER_ELEMENTS(card);
    unsigned int i;
...
#[no_mangle]
pub unsafe extern "C" fn qeth_resize_buffer_pool(card: *mut qeth_card, count: c_uint) -> c_int {
    int qeth_resize_buffer_pool(struct qeth_card *card, unsigned int count)
    {
    let mut buf_elements: c_uint = QETH_MAX_BUFFER_ELEMENTS(card);
    struct qeth_qdio_buffer_pool *pool = &card.qdio.init_pool;
    struct qeth_buffer_pool_entry *entry, *tmp;
    let mut delta: c_int = count - pool.buf_count;
    LIST_HEAD(entries);
...
#[no_mangle]
unsafe extern "C" fn qeth_free_qdio_queue(q: *mut qeth_qdio_q) {
...
#[no_mangle]
unsafe extern "C" fn qeth_cq_init(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_free_cq(card: *mut qeth_card) {
    static void qeth_free_cq(struct qeth_card *card)
    {
    if (card.qdio.c_q) {
    qeth_free_qdio_queue(card.qdio.c_q);
    card.qdio.c_q = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn qeth_alloc_cq(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_put_cmd(iob: *mut qeth_cmd_buffer) {
...
#[no_mangle]
unsafe extern "C" fn __qeth_issue_next_read(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_issue_next_read(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_notify_cmd(iob: *mut qeth_cmd_buffer, reason: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qeth_flush_local_addrs4(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_flush_local_addrs6(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_flush_local_addrs(card: *mut qeth_card) {
    ...
    let mut key: c_uint = ipv4_addr_hash(cmd.addrs[i].addr);
    struct qeth_local_addr *addr;
    ...
    for (i = 0; i < cmd.count; i++) {
    let mut key: u32 = ipv6_addr_hash(&cmd.addrs[i].addr);
    struct qeth_local_addr *addr;
    let mut duplicate: bool = false;
    ...
    let mut key: c_uint = ipv4_addr_hash(addr.addr);
    ...
    let mut key: u32 = ipv6_addr_hash(&addr.addr);
    struct qeth_local_addr *tmp;
...
#[no_mangle]
unsafe extern "C" fn qeth_debugfs_local_addr_show(m: *mut seq_file, v: *mut c_void) -> c_int {
    ...
    {
    const char *ipa_name;
    let mut com: c_int = cmd.hdr.command;
...
#[no_mangle]
unsafe extern "C" fn qeth_default_link_info(card: *mut qeth_card) {
...
#[no_mangle]
pub unsafe extern "C" fn if(QETH_PROT_IPV6: cmd->hdr.prot_version ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qeth_clear_ipacmd_list(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_cancel_cmd(iob: *mut qeth_cmd_buffer, rc: c_int) {
    ...
    unsigned int data_length)
    {
    struct qeth_cmd_buffer *request = core::ptr::null_mut();
    struct qeth_ipa_cmd *cmd = core::ptr::null_mut();
    struct qeth_reply *reply = core::ptr::null_mut();
...
// Bail out when the requestor has already left:
    ...
    rc = -EPERM;
#[no_mangle]
pub unsafe extern "C" fn if(thread: card->thread_start_mask &) -> else {
...
#[no_mangle]
unsafe extern "C" fn __qeth_do_run_thread(card: *mut qeth_card, thread: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_do_run_thread(card: *mut qeth_card, thread: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_schedule_recovery(card: *mut qeth_card) -> c_int {
...
//
    ...
    int rc;
    int cstat, dstat;
    struct qeth_cmd_buffer *iob = core::ptr::null_mut();
...
// Empty buffer?
    ...
    while ((skb = __skb_dequeue(&buf.skb_list)) != core::ptr::null_mut()) {
    let mut bytes: c_uint = qdisc_pkt_len(skb);
    let mut is_tso: bool = skb_is_gso(skb);
...
#[no_mangle]
unsafe extern "C" fn qeth_free_out_buf(buf: *mut qeth_qdio_out_buffer) {
...
#[no_mangle]
unsafe extern "C" fn qeth_drain_output_queue(q: *mut qeth_qdio_out_q, free: bool) {
    ...
    q.bufs[j] = core::ptr::null_mut();
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn qeth_drain_output_queues(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_osa_set_output_queues(card: *mut qeth_card, single: bool) {
    static void qeth_osa_set_output_queues(struct qeth_card *card, bool single)
    {
    let mut max: c_uint = single ? 1 : card.dev.num_tx_queues;
...
#[no_mangle]
unsafe extern "C" fn qeth_update_from_chp_desc(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_init_qdio_info(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_set_initial_options(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_do_start_thread(card: *mut qeth_card, thread: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_start_kernel_thread(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qeth_setup_card(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_core_sl_print(m: *mut seq_file, slr: *mut service_level) {
    ...
    out_wq:
    dev_set_drvdata(&gdev.dev, core::ptr::null_mut());
    kfree(card);
    out:
    return core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn qeth_stop_channel(channel: *mut qeth_channel) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_start_channel(channel: *mut qeth_channel) -> c_int {
    static int qeth_start_channel(struct qeth_channel *channel)
    {
    struct ccw_device *cdev = channel.ccwdev;
    int rc;
    channel.state = CH_STATE_DOWN;
    xchg(&channel.active_cmd, core::ptr::null_mut());
    spin_lock_irq(get_ccwdev_lock(cdev));
...
#[no_mangle]
unsafe extern "C" fn qeth_halt_channels(card: *mut qeth_card) -> c_int {
    static int qeth_halt_channels(struct qeth_card *card)
    {
    let mut rc1: c_int = 0, rc2 = 0, rc3 = 0;
...
#[no_mangle]
unsafe extern "C" fn qeth_clear_channels(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_clear_halt_card(card: *mut qeth_card, halt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_qdio_clear_card(card: *mut qeth_card, use_halt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_vm_detect_layer(card: *mut qeth_card) -> enum qeth_discipline_id {
    static enum qeth_discipline_id qeth_vm_detect_layer(struct qeth_card *card)
    {
    let mut disc: enum qeth_discipline_id = QETH_DISCIPLINE_UNDETERMINED;
    struct diag26c_vnic_resp *response = core::ptr::null_mut();
    struct diag26c_vnic_req *request = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(VNIC_INFO_PROT_L3: response->protocol ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qeth_enforce_discipline(card: *mut qeth_card) -> enum qeth_discipline_id {
    ...
    disc = QETH_DISCIPLINE_LAYER2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_VM_NIC(card)) -> else {
...
#[no_mangle]
unsafe extern "C" fn qeth_set_blkt_defaults(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_idx_init(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_peer_func_level(level: c_int) -> c_int {
...
//
    ...
    let mut timeout: c_long = iob.timeout;
    int rc;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qeth_node_desc {
    pub nd1: node_descriptor,
    pub nd2: node_descriptor,
    pub nd3: node_descriptor,
}
...
#[no_mangle]
unsafe extern "C" fn qeth_read_conf_data(card: *mut qeth_card) -> c_int {
...
// scan for RCD command in extended SenseID data
    ...
    iob.data);
    return qeth_send_control_data(card, iob, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
// negative reply:
    ...
    struct qeth_cmd_buffer *iob)
    {
    let mut addr: u16 = (card.info.cula << 8) + card.info.unit_addr2;
    let mut port: u8 = ((u8)card.dev.dev_port) | 0x80;
    struct ccw1 *ccw = __ccw_from_cmd(iob);
...
#[no_mangle]
unsafe extern "C" fn qeth_idx_activate_read_channel(card: *mut qeth_card) -> c_int {
    ...
    rc = qeth_send_control_data(card, iob, core::ptr::null_mut(), core::ptr::null_mut());
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn qeth_idx_activate_write_channel(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_cm_enable(card: *mut qeth_card) -> c_int {
    ...
    return qeth_send_control_data(card, iob, qeth_cm_enable_cb, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn qeth_cm_setup(card: *mut qeth_card) -> c_int {
    ...
    return qeth_send_control_data(card, iob, qeth_cm_setup_cb, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn qeth_is_supported_link_type(card: *mut qeth_card, link_type: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qeth_update_max_mtu(card: *mut qeth_card, max_mtu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_LAYER2(card)) -> else {
...
#[no_mangle]
unsafe extern "C" fn qeth_get_mtu_outof_framesize(framesize: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_mpc_select_prot_type(card: *mut qeth_card) -> u8 {
    static u8 qeth_mpc_select_prot_type(struct qeth_card *card)
    {
    return IS_LAYER2(card) ? QETH_MPC_PROT_L2 : QETH_MPC_PROT_L3;
    }
#[no_mangle]
unsafe extern "C" fn qeth_ulp_enable(card: *mut qeth_card) -> c_int {
    static int qeth_ulp_enable(struct qeth_card *card)
    {
    let mut prot_type: u8 = qeth_mpc_select_prot_type(card);
    struct qeth_cmd_buffer *iob;
    u16 max_mtu;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn qeth_ulp_setup(card: *mut qeth_card) -> c_int {
    ...
    return qeth_send_control_data(card, iob, qeth_ulp_setup_cb, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn qeth_free_output_queue(q: *mut qeth_qdio_out_q) {
...
#[no_mangle]
unsafe extern "C" fn qeth_tx_completion_timer(timer: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn qeth_alloc_qdio_queues(card: *mut qeth_card) -> c_int {
...
// outbound
    ...
    card.qdio.out_qs[i] = core::ptr::null_mut();
    }
    qeth_free_buffer_pool(card);
    out_buffer_pool:
    atomic_set(&card.qdio.state, QETH_QDIO_UNINITIALIZED);
...
#[no_mangle]
unsafe extern "C" fn qeth_free_qdio_queues(card: *mut qeth_card) {
    static void qeth_free_qdio_queues(struct qeth_card *card)
    {
    int i, j;
    qeth_free_cq(card);
    ...
    card.qdio.in_q.bufs[j].rx_skb = core::ptr::null_mut();
    }
    }
// inbound buffer pool
    qeth_free_buffer_pool(card);
...
#[no_mangle]
unsafe extern "C" fn qeth_qdio_activate(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_dm_act(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_mpc_initialize(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_print_status_message(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_initialize_working_pool_list(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_init_qdio_queues(card: *mut qeth_card) -> c_int {
    static int qeth_init_qdio_queues(struct qeth_card *card)
    {
    let mut rx_bufs: c_uint = card.qdio.in_buf_pool.buf_count;
    unsigned int i;
    int rc;
...
// outbound queue
    ...
    queue.do_pack = 0;
    queue.prev_hdr = core::ptr::null_mut();
...
// override with IPA-specific values:
    ...
    {
    let mut prot_type: u8 = qeth_mpc_select_prot_type(card);
    let mut total_length: u16 = iob.length;
...
#[no_mangle]
unsafe extern "C" fn qeth_send_startlan(card: *mut qeth_card) -> c_int {
    ...
    if (!iob)
    return -ENOMEM;
    return qeth_send_ipa_cmd(card, iob, qeth_send_startlan_cb, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn qeth_setadpparms_inspect_rc(cmd: *mut qeth_ipa_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_query_setadapterparms(card: *mut qeth_card) -> c_int {
    ...
    if (!iob)
    return -ENOMEM;
    rc = qeth_send_ipa_cmd(card, iob, qeth_query_setadapterparms_cb, core::ptr::null_mut());
    return rc;
    }
...
pub unsafe extern "C" fn if(QETH_PROT_IPV6: cmd->hdr.prot_version ==) -> else {
    ...
    if (!iob)
    return -ENOMEM;
    rc = qeth_send_ipa_cmd(card, iob, qeth_query_ipassists_cb, core::ptr::null_mut());
    return rc;
    }
    ...
    {
    struct qeth_ipa_cmd *cmd = (struct qeth_ipa_cmd *) data;
    let mut rc: u16 = cmd.hdr.return_code;
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn qeth_query_setdiagass(card: *mut qeth_card) -> c_int {
    ...
    if (!iob)
    return -ENOMEM;
    return qeth_send_ipa_cmd(card, iob, qeth_query_setdiagass_cb, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn qeth_get_trap_id(card: *mut qeth_card, tid: *mut qeth_trap_id) {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_hw_trap(card: *mut qeth_card, action: enum qeth_diags_trap_action) -> c_int {
    ...
    return qeth_send_ipa_cmd(card, iob, qeth_hw_trap_cb, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn qeth_buffer_reclaim_work(work: *mut work_struct) {
...
// kick-start the NAPI softirq:
    ...
    {
    let mut sbalf15: c_int = buffer.buffer.element[15].sflags;
...
//
#[no_mangle]
unsafe extern "C" fn qeth_prep_flush_pack_buffer(queue: *mut qeth_qdio_out_q) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qeth_switch_to_packing_if_needed(queue: *mut qeth_qdio_out_q) {
...
//
#[no_mangle]
unsafe extern "C" fn qeth_switch_to_nonpacking_if_needed(queue: *mut qeth_qdio_out_q) -> c_int {
...
// switch PACKING -> non-PACKING
    ...
    struct qaob *aob = core::ptr::null_mut();
    int rc;
    int i;
    for (i = index; i < index + count; ++i) {
    let mut bidx: c_uint = QDIO_BUFNR(i);
    struct sk_buff *skb;
    buf = queue.bufs[bidx];
...
#[no_mangle]
unsafe extern "C" fn qeth_flush_queue(queue: *mut qeth_qdio_out_q) {
...
#[no_mangle]
unsafe extern "C" fn qeth_check_outbound_queue(queue: *mut qeth_qdio_out_q) {
...
#[no_mangle]
unsafe extern "C" fn qeth_qdio_poll(cdev: *mut ccw_device, card_ptr: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_configure_cq(card: *mut qeth_card, cq: enum qeth_cq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_qdio_handle_aob(card: *mut qeth_card, aob: *mut qaob) {
    ...
    let mut queue_no: c_uint = priv.queue_no;
    ...
    let mut phys_aob_addr: dma64_t = buffer.element[e].addr;
...
//
#[no_mangle]
unsafe extern "C" fn qeth_get_priority_queue(card: *mut qeth_card, skb: *mut sk_buff) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qeth_get_elements_for_frags(skb: *mut sk_buff) -> c_int {
...
//
    ...
    {
    let mut elements: c_uint = qeth_get_elements_for_frags(skb);
    let mut end: addr_t = (addr_t)skb.data + skb_headlen(skb);
    let mut start: addr_t = (addr_t)skb.data + data_offset;
    if (start != end)
...
//
    ...
    {
    let mut gfp: gfp_t = GFP_ATOMIC | (skb_pfmemalloc(skb) ? __GFP_MEMALLOC : 0);
    let mut contiguous: c_uint = proto_len ? proto_len : 1;
    let mut max_elements: c_uint = queue.max_elements;
...
//
    ...
    let mut element: c_int = buf.next_element_to_fill;
    let mut length: c_int = skb_headlen(skb) - offset;
...
//
    ...
    {
    let mut start_index: c_uint = queue.next_buf_to_fill;
    struct qeth_qdio_out_buffer *buffer;
    unsigned int next_element;
    struct netdev_queue *txq;
    let mut stopped: bool = false;
    let mut flush_count: c_int = 0;
    let mut do_pack: c_int = 0;
    let mut rc: c_int = 0;
    buffer = queue.bufs[queue.next_buf_to_fill];
// Just a sanity check, the wake/stop logic should ensure that we always
// get a free buffer.
...
//
    ...
    let mut frame_len: c_uint = skb.len;
    let mut is_tso: bool = skb_is_gso(skb);
    let mut data_offset: c_uint = 0;
    struct qeth_hdr *hdr = core::ptr::null_mut();
    let mut hd_len: c_uint = 0;
    unsigned int elements;
    int push_len, rc;
    if (is_tso) {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_setadp_promisc_mode(card: *mut qeth_card, enable: bool) {
    ...
    qeth_send_ipa_cmd(card, iob, qeth_setadp_promisc_mode_cb, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn qeth_setadpparms_change_macaddr(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_tx_timeout(dev: *mut net_device, txqueue: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn qeth_mdio_read(dev: *mut net_device, phy_id: c_int, regnum: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_snmp_command(card: *mut qeth_card, udata: *mut char __user) -> c_int {
    static int qeth_snmp_command(struct qeth_card *card, char __user *udata)
    {
    struct qeth_snmp_ureq __user *ureq;
    struct qeth_cmd_buffer *iob;
    unsigned int req_len;
    let mut qinfo: qeth_arp_query_info = {0, };
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn qeth_query_oat_command(card: *mut qeth_card, udata: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_init_link_info(card: *mut qeth_card) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qeth_vm_request_mac(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_determine_capabilities(card: *mut qeth_card) {
    static void qeth_determine_capabilities(struct qeth_card *card)
    {
    struct qeth_channel *channel = &card.data;
    struct ccw_device *ddev = channel.ccwdev;
    int rc;
    let mut ddev_offline: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn qeth_read_ccw_conf_data(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_qdio_establish(card: *mut qeth_card) -> c_int {
    static int qeth_qdio_establish(struct qeth_card *card)
    {
    struct qdio_buffer **out_sbal_ptrs[QETH_MAX_OUT_QUEUES];
    struct qdio_buffer **in_sbal_ptrs[QETH_MAX_IN_QUEUES];
    struct qeth_qib_parms *qib_parms = core::ptr::null_mut();
    struct qdio_initialize init_data;
    let mut no_input_qs: c_uint = 1;
    unsigned int i;
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn qeth_core_free_card(card: *mut qeth_card) {
    ...
    destroy_workqueue(card.event_wq);
    dev_set_drvdata(&card.gdev.dev, core::ptr::null_mut());
    kfree(card);
    }
#[no_mangle]
unsafe extern "C" fn qeth_trace_features(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_hardsetup_card(card: *mut qeth_card, carrier_ok: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_do_reset(data: *mut c_void) -> c_int {
    static int qeth_do_reset(void *data)
    {
    const struct qeth_discipline *disc;
...
#[no_mangle]
unsafe extern "C" fn qeth_create_skb_frag(skb: *mut sk_buff, data: *mut c_char, data_len: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_is_last_sbale(sbale: *mut qdio_buffer_element) -> c_int {
    ...
    let mut linear_len: c_uint = 0;
    let mut uses_frags: bool = false;
    let mut offset: c_int = *__offset;
    let mut use_rx_sg: bool = false;
    unsigned int headroom;
    struct qeth_hdr *hdr;
    struct sk_buff *skb;
    let mut skb_len: c_int = 0;
    bool is_cso;
...
// QETH_CQ_ENABLED only:
    ...
    qethbuffer.rx_skb = core::ptr::null_mut();
    goto use_skb;
    }
...
// Shouldn't happen. Don't optimize, fall back to linear skb.
    ...
    walk_packet:
    while (skb_len) {
    let mut data_len: c_int = min(skb_len, (int)(element.length - offset));
...
#[no_mangle]
unsafe extern "C" fn qeth_rx_poll(card: *mut qeth_card, budget: c_int) -> c_uint {
...
// Process one completed RX buffer:
    ...
    buffer.pool_entry = core::ptr::null_mut();
    card.rx.b_count--;
    ctx.bufs_refill++;
...
#[no_mangle]
unsafe extern "C" fn qeth_cq_poll(card: *mut qeth_card) {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_poll(napi: *mut napi_struct, budget: c_int) -> c_int {
...
// Exhausted the RX budget. Keep IRQ disabled, we get called again.
    ...
    let mut sflags: u8 = buffer.buffer.element[15].sflags;
    struct qeth_card *card = queue.card;
    let mut error: bool = !!qdio_error;
...
#[no_mangle]
unsafe extern "C" fn qeth_setassparms_inspect_rc(cmd: *mut qeth_ipa_cmd) -> c_int {
    ...
    enum qeth_prot_versions prot)
    {
    let mut length: c_uint = data ? SETASS_DATA_SIZEOF(flags_32bit) : 0;
    struct qeth_cmd_buffer *iob;
    ...
    return qeth_send_ipa_cmd(card, iob, qeth_setassparms_cb, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(qeth_send_simple_setassparms_prot);
#[no_mangle]
unsafe extern "C" fn qeth_unregister_dbf_views() {
    static void qeth_unregister_dbf_views(void)
    {
    int x;
    for (x = 0; x < QETH_DBF_INFOS; x++) {
    debug_unregister(qeth_dbf[x].id);
    qeth_dbf[x].id = core::ptr::null_mut();
    }
    }
#[no_mangle]
pub unsafe extern "C" fn qeth_dbf_longtext(id: *mut debug_info_t, level: c_int, fmt: *mut c_char, ...) {
...
#[no_mangle]
unsafe extern "C" fn qeth_register_dbf_views() -> c_int {
...
// register the areas
    ...
    qeth_dbf[x].areas,
    qeth_dbf[x].len);
    if (qeth_dbf[x].id == core::ptr::null_mut()) {
...
// set a passing level
    ...
    card.discipline = core::ptr::null_mut();
    return rc;
    }
...
#[no_mangle]
pub unsafe extern "C" fn qeth_remove_discipline(card: *mut qeth_card) {
...
pub const DBF_NAME_LEN: c_int = 20;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qeth_dbf_entry {
    pub dbf_name: [c_char; DBF_NAME_LEN],
    pub dbf_info: *mut debug_info_t,
    pub dbf_list: list_head,
}
    ...
    debug_info_t *rc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qeth_add_dbf_entry(card: *mut qeth_card, name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_clear_dbf_list() {
...
#[no_mangle]
unsafe extern "C" fn qeth_core_probe_device(gdev: *mut ccwgroup_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_core_remove_device(gdev: *mut ccwgroup_device) {
...
#[no_mangle]
unsafe extern "C" fn qeth_core_set_online(gdev: *mut ccwgroup_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_core_set_offline(gdev: *mut ccwgroup_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_core_shutdown(gdev: *mut ccwgroup_device) {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_siocdevprivate(dev: *mut net_device, rq: *mut ifreq, data: *mut void __user, cmd: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_do_ioctl(dev: *mut net_device, rq: *mut ifreq, cmd: c_int) -> c_int {
...
// features = cmd->data.setassparms.data.flags_32bit;
    ...
    core::ptr::null_mut(), prot);
    }
    static int qeth_set_csum_on(struct qeth_card *card, enum qeth_ipa_funcs cstype,
    enum qeth_prot_versions prot, u8 *lp2lp)
    {
    let mut required_features: u32 = QETH_IPA_CHECKSUM_UDP | QETH_IPA_CHECKSUM_TCP;
    struct qeth_cmd_buffer *iob;
...
// lp2lp = qeth_ipa_caps_enabled(&caps, QETH_IPA_CHECKSUM_LP2LP);
    ...
    IPA_CMD_ASS_STOP, core::ptr::null_mut(), prot);
    }
...
#[no_mangle]
unsafe extern "C" fn qeth_set_ipa_rx_csum(card: *mut qeth_card, on: bool) -> c_int {
    static int qeth_set_ipa_rx_csum(struct qeth_card *card, bool on)
    {
    let mut rc_ipv4: c_int = (on) ? -EOPNOTSUPP : 0;
    int rc_ipv6;
    if (qeth_is_supported(card, IPA_INBOUND_CHECKSUM))
    rc_ipv4 = qeth_set_ipa_csum(card, on, IPA_INBOUND_CHECKSUM,
    QETH_PROT_IPV4, core::ptr::null_mut());
    if (!qeth_is_supported6(card, IPA_INBOUND_CHECKSUM_V6))
// no/one Offload Assist available, so the rc is trivial
    return rc_ipv4;
    rc_ipv6 = qeth_set_ipa_csum(card, on, IPA_INBOUND_CHECKSUM,
    QETH_PROT_IPV6, core::ptr::null_mut());
    if (on)
...
//
#[no_mangle]
pub unsafe extern "C" fn qeth_enable_hw_features(dev: *mut net_device) {
...
// toggle VLAN filter, so that VIDs are re-programmed:
    ...
    {
    let mut ipv6_features: netdev_features_t = NETIF_F_TSO6;
    let mut ipv4_features: netdev_features_t = NETIF_F_TSO;
...
#[no_mangle]
pub unsafe extern "C" fn qeth_set_features(dev: *mut net_device, features: netdev_features_t) -> c_int {
...
// Traffic with local next-hop is not eligible for some offloads:
    ...
    let mut restricted: netdev_features_t = 0;
...
// match skb_segment():
    let mut doffset: c_uint = skb.data - skb_mac_header(skb);
    let mut hsize: c_uint = skb_shinfo(skb).gso_size;
    let mut hroom: c_uint = skb_headroom(skb);
...
#[no_mangle]
pub unsafe extern "C" fn qeth_get_stats64(dev: *mut net_device, stats: *mut rtnl_link_stats64) {
...
pub const TC_IQD_UCAST: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn qeth_set_real_num_tx_queues(card: *mut qeth_card, count: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_open(dev: *mut net_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_stop(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_core_init() -> int __init {
    static int __init qeth_core_init(void)
    {
    int rc;
    pr_info("loading core functions\n");
    qeth_debugfs_root = debugfs_create_dir("qeth", core::ptr::null_mut());
    ...
    sizeof(struct qeth_qdio_out_buffer), 0, 0, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn qeth_core_exit() -> void __exit {
