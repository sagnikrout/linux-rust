...
//! Source: drivers/s390/net/qeth_l3_main.c
#![no_std]
...
//
    ...
    {
    let mut key: u32 = qeth_l3_ipaddr_hash(query);
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_convert_addr_to_bits(addr: *mut u8, bits: *mut u8, len: c_int) {
...
// invert?
    ...
    rc = !rc;
#[no_mangle]
pub unsafe extern "C" fn if(card->ipato.invert6: (addr->proto == QETH_PROT_IPV6) &&) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(QETH_IP_TYPE_VIPA: tmp_addr->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_add_ip(card: *mut qeth_card, tmp_addr: *mut qeth_ipaddr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_drain_rx_mode_cache(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_clear_ip_htable(card: *mut qeth_card, recover: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_recover_ip(card: *mut qeth_card) {
...
// bad address
    ...
    return qeth_send_ipa_cmd(card, iob, qeth_l3_setdelip_cb, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn qeth_l3_set_ipv6_prefix(prefix: *mut in6_addr, len: c_uint) {
    static void qeth_l3_set_ipv6_prefix(struct in6_addr *prefix, unsigned int len)
    {
    let mut i: c_uint = 0;
    while (len && i < 4) {
    let mut mask_len: c_int = min_t(int, len, 32);
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_get_setdelip_flags(addr: *mut qeth_ipaddr, set: bool) -> u32 {
    ...
    rc = qeth_send_ipa_cmd(card, iob, core::ptr::null_mut(), core::ptr::null_mut());
    return rc;
    }
...
#[no_mangle]
pub unsafe extern "C" fn qeth_l3_setrouting_v4(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_l3_setrouting_v6(card: *mut qeth_card) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qeth_l3_update_ipato(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_clear_ipato_list(card: *mut qeth_card) {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_l3_modify_hsuid(card: *mut qeth_card, add: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_setadapter_parms(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_start_ipa_arp_processing(card: *mut qeth_card) -> c_int {
    ...
    IPA_CMD_ASS_START, core::ptr::null_mut());
    if (rc) {
    dev_warn(&card.gdev.dev,
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_start_ipa_source_mac(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_start_ipa_vlan(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_start_ipa_multicast(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_softsetup_ipv6(card: *mut qeth_card) -> c_int {
    static int qeth_l3_softsetup_ipv6(struct qeth_card *card)
    {
    let mut ipv6_data: u32 = 3;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_start_ipa_ipv6(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_start_ipa_broadcast(card: *mut qeth_card) -> c_int {
    static int qeth_l3_start_ipa_broadcast(struct qeth_card *card)
    {
    let mut filter_data: u32 = 1;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_start_ipassists(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_iqd_read_initial_mac(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_get_unique_id(card: *mut qeth_card, uid: u16) -> u16 {
    ...
    return qeth_send_ipa_cmd(card, iob, qeth_diags_trace_cb, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn qeth_l3_add_mcast_rtnl(dev: *mut net_device, vid: c_int, arg: *mut c_void) -> c_int {
    ...
    tmp.is_multicast = 1;
    for (im4 = rtnl_dereference(in4_dev.mc_list); im4 != core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_set_promisc_mode(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_rx_mode_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_arp_makerc(rc: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_arp_set_no_entries(card: *mut qeth_card, no_entries: c_int) -> c_int {
...
//
    ...
    rc = qeth_send_ipa_cmd(card, iob, qeth_l3_arp_cmd_cb, core::ptr::null_mut());
    if (rc)
...
#[no_mangle]
unsafe extern "C" fn arpentry_matches_prot(type: *mut qeth_arp_entrytype, prot: __u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_arp_query(card: *mut qeth_card, udata: *mut char __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_arp_flush_cache(card: *mut qeth_card) -> c_int {
...
//
    ...
    if (n) {
    let mut cast_type: c_int = n.type;
    neigh_release(n);
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_get_cast_type(skb: *mut sk_buff, proto: __be16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_cast_type_to_flag(cast_type: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_fixup_headers(skb: *mut sk_buff) {
...
// re-use the L2 header area for the HW header:
    ...
    {
    struct qeth_card *card = dev.ml_priv;
    let mut proto: __be16 = vlan_get_protocol(skb);
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_set_rx_mode(dev: *mut net_device) {
...
//
#[no_mangle]
unsafe extern "C" fn qeth_l3_neigh_setup_noarp(n: *mut neighbour) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_setup_netdev(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(NETIF_F_TSO: card->dev->hw_features &) -> else {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_probe_device(gdev: *mut ccwgroup_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_remove_device(cgdev: *mut ccwgroup_device) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_set_online(card: *mut qeth_card, carrier_ok: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_set_offline(card: *mut qeth_card) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qeth_l3_ip_event_work {
    pub work: work_struct,
    pub card: *mut qeth_card,
    pub addr: qeth_ipaddr,
}

#[no_mangle]
unsafe extern "C" fn qeth_l3_add_ip_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_delete_ip_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_register_notifiers() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_unregister_notifiers() {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qeth_l3_exit() -> void __exit {
