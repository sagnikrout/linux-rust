...
//! Source: drivers/s390/net/qeth_l2_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_setdelmac_makerc(card: *mut qeth_card, retcode: u16) -> c_int {
    ...
    return qeth_send_ipa_cmd(card, iob, qeth_l2_send_setdelmac_cb, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn qeth_l2_send_setmac(card: *mut qeth_card, mac: *const __u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_write_mac(card: *mut qeth_card, mac: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_remove_mac(card: *mut qeth_card, mac: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_drain_rx_mode_cache(card: *mut qeth_card) {
    ...
    {
    let mut cast_type: c_int = qeth_get_ether_cast_type(skb);
...
#[no_mangle]
pub unsafe extern "C" fn if(RTN_BROADCAST: cast_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_setdelvlan_makerc(card: *mut qeth_card, retcode: u16) -> c_int {
    ...
    return qeth_send_ipa_cmd(card, iob, qeth_l2_send_setdelvlan_cb, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_dev2br_fdb_flush(card: *mut qeth_card) {
    static void qeth_l2_dev2br_fdb_flush(struct qeth_card *card)
    {
    let mut info: switchdev_notifier_fdb_info = {};
    QETH_CARD_TEXT(card, 2, "fdbflush");
    info.addr = core::ptr::null_mut();
// flush all VLANs:
    info.vid = 0;
    info.added_by_user = false;
    info.offloaded = true;
    call_switchdev_notifiers(SWITCHDEV_FDB_FLUSH_TO_BRIDGE,
    card.dev, &info.info, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn qeth_l2_request_initial_mac(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_register_dev_addr(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_validate_addr(dev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_set_mac_address(dev: *mut net_device, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_promisc_to_bridge(card: *mut qeth_card, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_set_promisc_mode(card: *mut qeth_card) {
    static void qeth_l2_set_promisc_mode(struct qeth_card *card)
    {
    let mut enable: bool = card.dev.flags & IFF_PROMISC;
...
//
#[no_mangle]
unsafe extern "C" fn qeth_l2_add_mac(card: *mut qeth_card, ha: *mut netdev_hw_addr) {
    static void qeth_l2_add_mac(struct qeth_card *card, struct netdev_hw_addr *ha)
    {
    let mut mac_hash: u32 = get_unaligned((u32 *)(&ha.addr[2]));
    struct qeth_mac *mac;
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_rx_mode_work(work: *mut work_struct) {
...
// for next call to set_rx_mode():
    ...
    {
    struct qeth_card *card = dev.ml_priv;
    let mut txq: u16 = skb_get_queue_mapping(skb);
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_set_rx_mode(dev: *mut net_device) {
...
//
    ...
    let mut prev_instance: u32 = 0;
    let mut isfirstblock: c_int = 1;
    int i, size, elems;
    int rc;
    rr = (struct chsc_pnso_area *)get_zeroed_page(GFP_KERNEL);
    if (rr == core::ptr::null_mut())
    return -ENOMEM;
    do {
...
// don't report VLAN IDs
    ...
    {
    let mut code: u8 = IPA_ADDR_CHANGE_CODE_MACADDR;
...
//
#[no_mangle]
unsafe extern "C" fn qeth_l2_dev2br_an_set(card: *mut qeth_card, enable: bool) -> c_int {
...
//
    ...
    rc = qeth_l2_pnso(card, PNSO_OC_NET_ADDR_INFO, 0, core::ptr::null_mut(), core::ptr::null_mut());
    }
    return rc;
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qeth_l2_br2dev_event_work {
    pub work: work_struct,
    pub br_dev: *mut net_device,
    pub lsync_dev: *mut net_device,
...
//
#[no_mangle]
unsafe extern "C" fn qeth_l2_br2dev_worker(work: *mut work_struct) {
    ...
    let mut event: c_ulong = br2dev_event_work.event;
...
// Called under rtnl_lock
#[no_mangle]
unsafe extern "C" fn qeth_l2_br2dev_get() {
...
// Called under rtnl_lock
#[no_mangle]
unsafe extern "C" fn qeth_l2_br2dev_put() {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_setup_netdev(card: *mut qeth_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_trace_features(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_setup_bridgeport_attrs(card: *mut qeth_card) {
...
//
#[no_mangle]
unsafe extern "C" fn qeth_l2_detect_dev2br_support(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_enable_brport_features(card: *mut qeth_card) {
...
//
    ...
    env[i] = core::ptr::null_mut();
    kobject_uevent_env(&card.gdev.dev.kobj, KOBJ_CHANGE, env);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qeth_bridge_state_data {
...
#[no_mangle]
unsafe extern "C" fn qeth_bridge_state_change_worker(work: *mut work_struct) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qeth_addr_change_data {
    pub dwork: delayed_work,
    pub card: *mut qeth_card,
    pub ac_event: qeth_ipacmd_addr_change,
}

#[no_mangle]
unsafe extern "C" fn qeth_l2_dev2br_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qeth_addr_change_event_worker(work: *mut work_struct) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct _qeth_sbp_cbctl {
    union {
    pub supported: u32,
    struct {
    pub role: *mut enum qeth_sbp_roles,
    pub state: *mut enum qeth_sbp_states,
    pub qports: },
    pub data: },
}
    ...
    let mut setcmd: enum qeth_ipa_sbp_cmd = sbp.hdr.command_code;
    let mut ipa_rc: u16 = cmd.hdr.return_code;
    let mut sbp_rc: u16 = sbp.hdr.return_code;
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn qeth_bridgeport_query_support(card: *mut qeth_card) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qeth_bridgeport_setrole(card: *mut qeth_card, role: enum qeth_sbp_roles) -> c_int {
    int qeth_bridgeport_setrole(struct qeth_card *card, enum qeth_sbp_roles role)
    {
    struct qeth_cmd_buffer *iob;
    enum qeth_ipa_sbp_cmd setcmd;
    let mut cmdlength: c_uint = 0;
    ...
    if (!iob)
    return -ENOMEM;
    return qeth_send_ipa_cmd(card, iob, qeth_bridgeport_set_cb, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn qeth_bridgeport_an_set(card: *mut qeth_card, enable: c_int) -> c_int {
    ...
    return -EOPNOTSUPP;
    if (enable) {
    qeth_bridge_emit_host_event(card, anev_reset, 0, core::ptr::null_mut(), core::ptr::null_mut());
    ...
    rc = qeth_l2_pnso(card, PNSO_OC_NET_BRIDGE_INFO, 0, core::ptr::null_mut(), core::ptr::null_mut());
    qeth_l2_set_pnso_mode(card, QETH_PNSO_NONE);
    }
    return rc;
    }
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_vnicc_makerc(card: *mut qeth_card, ipa_rc: u16) -> c_int {
...
// generic VNICC request call back
    ...
    let mut sub_cmd: u32 = cmd.data.vnicc.hdr.sub_command;
...
#[no_mangle]
pub unsafe extern "C" fn if(IPA_VNICC_GET_TIMEOUT: sub_cmd ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_vnicc_query_chars(card: *mut qeth_card) -> c_int {
    ...
    if (!iob)
    return -ENOMEM;
    return qeth_send_ipa_cmd(card, iob, qeth_l2_vnicc_request_cb, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn qeth_l2_vnicc_set_state(card: *mut qeth_card, vnicc: u32, state: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qeth_l2_vnicc_get_state(card: *mut qeth_card, vnicc: u32, state: *mut bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qeth_l2_vnicc_set_timeout(card: *mut qeth_card, timeout: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qeth_l2_vnicc_get_timeout(card: *mut qeth_card, timeout: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _qeth_l2_vnicc_is_in_use(card: *mut qeth_card) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn qeth_bridgeport_allowed(card: *mut qeth_card) -> bool {
...
// recover user characteristic setting
    ...
    bool enable)
    {
    let mut cmd: u32 = enable ? IPA_VNICC_ENABLE : IPA_VNICC_DISABLE;
    if (card.options.vnicc.sup_chars & vnicc &&
    card.options.vnicc.set_char_sup & vnicc &&
...
// (re-)initialize VNICC
#[no_mangle]
unsafe extern "C" fn qeth_l2_vnicc_init(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_vnicc_set_defaults(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_probe_device(gdev: *mut ccwgroup_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_remove_device(gdev: *mut ccwgroup_device) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_set_online(card: *mut qeth_card, carrier_ok: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_set_offline(card: *mut qeth_card) {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn qeth_l2_exit() -> void __exit {
