...
//! Source: drivers/s390/net/ism_drv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ism_cmd(ism: *mut ism_dev, cmd: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_cmd_simple(ism: *mut ism_dev, cmd_code: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn query_info(ism: *mut ism_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_sba(ism: *mut ism_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_ieq(ism: *mut ism_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn unregister_sba(ism: *mut ism_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_free_sba(ism: *mut ism_dev) {
    static void ism_free_sba(struct ism_dev *ism)
    {
    dma_free_coherent(&ism.pdev.dev, PAGE_SIZE,
    ism.sba, ism.sba_dma_addr);
    ism.sba = core::ptr::null_mut();
    ism.sba_dma_addr = 0;
    }
#[no_mangle]
unsafe extern "C" fn unregister_ieq(ism: *mut ism_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_free_ieq(ism: *mut ism_dev) {
    static void ism_free_ieq(struct ism_dev *ism)
    {
    dma_free_coherent(&ism.pdev.dev, PAGE_SIZE,
    ism.ieq, ism.ieq_dma_addr);
    ism.ieq = core::ptr::null_mut();
    ism.ieq_dma_addr = 0;
    }
#[no_mangle]
unsafe extern "C" fn ism_read_local_gid(dibs: *mut dibs_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_max_dmbs() -> c_int {
    static int ism_max_dmbs(void)
    {
    return ISM_NR_DMBS;
    }
#[no_mangle]
unsafe extern "C" fn ism_free_dmb(ism: *mut ism_dev, dmb: *mut dibs_dmb) {
...
#[no_mangle]
unsafe extern "C" fn ism_alloc_dmb(ism: *mut ism_dev, dmb: *mut dibs_dmb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_unregister_dmb(dibs: *mut dibs_dev, dmb: *mut dibs_dmb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_add_vlan_id(dibs: *mut dibs_dev, vlan_id: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_del_vlan_id(dibs: *mut dibs_dev, vlan_id: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_get_chid(dibs: *mut dibs_dev) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ism_match_event_type(s390_event_type: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_match_event_subtype(s390_event_subtype: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_handle_event(ism: *mut ism_dev) {
...
#[no_mangle]
unsafe extern "C" fn ism_handle_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ism_dev_init(ism: *mut ism_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_dev_exit(ism: *mut ism_dev) {
...
#[no_mangle]
unsafe extern "C" fn ism_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ism_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn ism_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ism_exit() -> void __exit {
