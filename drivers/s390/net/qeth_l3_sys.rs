...
//! Source: drivers/s390/net/qeth_l3_sys.c
#![no_std]
...
//
    ...
    {
    let mut old_route_type: enum qeth_routing_types = route.type;
    let mut rc: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(QETH_PROT_IPV6: prot ==) -> else {
...
// sep = '\0';
    ...
    static QETH_DEVICE_ATTR(ipato_del4, del4, 0200, core::ptr::null_mut(),
    ...
    static QETH_DEVICE_ATTR(ipato_del6, del6, 0200, core::ptr::null_mut(),
    ...
    static QETH_DEVICE_ATTR(vipa_del4, del4, 0200, core::ptr::null_mut(),
    ...
    static QETH_DEVICE_ATTR(vipa_del6, del6, 0200, core::ptr::null_mut(),
    ...
    static QETH_DEVICE_ATTR(rxip_del4, del4, 0200, core::ptr::null_mut(),
    ...
    static QETH_DEVICE_ATTR(rxip_del6, del6, 0200, core::ptr::null_mut(),
