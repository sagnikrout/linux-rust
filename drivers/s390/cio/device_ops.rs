...
//! Source: drivers/s390/cio/device_ops.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_set_options_mask(cdev: *mut ccw_device, flags: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_set_options(cdev: *mut ccw_device, flags: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_clear_options(cdev: *mut ccw_device, flags: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_is_pathgroup(cdev: *mut ccw_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_is_multipath(cdev: *mut ccw_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_clear(cdev: *mut ccw_device, intparm: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_halt(cdev: *mut ccw_device, intparm: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_resume(cdev: *mut ccw_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_get_path_mask(cdev: *mut ccw_device) -> __u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_get_id(cdev: *mut ccw_device, dev_id: *mut ccw_dev_id) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_get_mdc(cdev: *mut ccw_device, mask: u8) -> c_int {
    int ccw_device_get_mdc(struct ccw_device *cdev, u8 mask)
    {
    struct subchannel *sch = to_subchannel(cdev.dev.parent);
    struct channel_path *chp;
    struct chp_id chpid;
    let mut mdc: c_int = 0, i;
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_tm_intrg(cdev: *mut ccw_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_get_schid(cdev: *mut ccw_device, schid: *mut subchannel_id) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_get_cssid(cdev: *mut ccw_device, cssid: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_get_iid(cdev: *mut ccw_device, iid: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_get_chpid(cdev: *mut ccw_device, chp_idx: c_int, chpid: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_get_chid(cdev: *mut ccw_device, chp_idx: c_int, chid: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ccw_device_dma_free(cdev: *mut ccw_device, cpu_addr: *mut c_void, size: usize) {
