...
//! Source: drivers/s390/cio/vfio_ccw_fsm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fsm_io_helper(private: *mut vfio_ccw_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsm_do_halt(private: *mut vfio_ccw_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsm_do_clear(private: *mut vfio_ccw_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_schid(p: *mut vfio_ccw_private) -> subchannel_id {
...
//
    ...
    char *errstr = "request";
    let mut schid: subchannel_id = get_schid(private);
