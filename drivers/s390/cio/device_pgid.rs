...
//! Source: drivers/s390/cio/device_pgid.c
#![no_std]
...
pub const PGID_RETRIES: c_int = 256;
...
//
#[no_mangle]
unsafe extern "C" fn verify_done(cdev: *mut ccw_device, rc: c_int) {
    static void verify_done(struct ccw_device *cdev, int rc)
    {
    struct subchannel *sch = to_subchannel(cdev.dev.parent);
    struct ccw_dev_id *id = &cdev.private.dev_id;
    let mut mpath: c_int = cdev.private.flags.mpath;
    let mut pgroup: c_int = cdev.private.flags.pgroup;
    if (rc)
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn nop_build_cp(cdev: *mut ccw_device) {
...
//
#[no_mangle]
unsafe extern "C" fn nop_do(cdev: *mut ccw_device) {
...
//
#[no_mangle]
unsafe extern "C" fn nop_callback(cdev: *mut ccw_device, data: *mut c_void, rc: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn spid_build_cp(cdev: *mut ccw_device, fn: u8) {
    static void spid_build_cp(struct ccw_device *cdev, u8 fn)
    {
    struct ccw_request *req = &cdev.private.req;
    struct ccw1 *cp = cdev.private.dma_area.iccws;
    let mut i: c_int = pathmask_to_pos(req.lpm);
...
#[no_mangle]
unsafe extern "C" fn pgid_wipeout_callback(cdev: *mut ccw_device, data: *mut c_void, rc: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pgid_wipeout_start(cdev: *mut ccw_device) {
...
//
#[no_mangle]
unsafe extern "C" fn spid_do(cdev: *mut ccw_device) {
...
//
#[no_mangle]
unsafe extern "C" fn spid_callback(cdev: *mut ccw_device, data: *mut c_void, rc: c_int) {
...
#[no_mangle]
unsafe extern "C" fn spid_start(cdev: *mut ccw_device) {
...
#[no_mangle]
unsafe extern "C" fn pgid_is_reset(p: *mut pgid) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pgid_cmp(p1: *mut pgid, p2: *mut pgid) -> c_int {
...
//
    ...
    struct pgid *first = core::ptr::null_mut();
    int lpm;
    int i;
// mismatch = 0;
// reserved = 0;
...
#[no_mangle]
unsafe extern "C" fn pgid_to_donepm(cdev: *mut ccw_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn pgid_fill(cdev: *mut ccw_device, pgid: *mut pgid) {
...
//
#[no_mangle]
unsafe extern "C" fn snid_done(cdev: *mut ccw_device, rc: c_int) {
    static void snid_done(struct ccw_device *cdev, int rc)
    {
    struct ccw_dev_id *id = &cdev.private.dev_id;
    struct subchannel *sch = to_subchannel(cdev.dev.parent);
    struct pgid *pgid;
    let mut mismatch: c_int = 0;
    ...
    rc = -EUSERS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mismatch) -> else {
    else if (mismatch)
    rc = -EOPNOTSUPP;
    else {
...
//
#[no_mangle]
unsafe extern "C" fn snid_build_cp(cdev: *mut ccw_device) {
...
//
#[no_mangle]
unsafe extern "C" fn snid_do(cdev: *mut ccw_device) {
    ...
    ret = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cdev->private->path_noirq_mask) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn snid_callback(cdev: *mut ccw_device, data: *mut c_void, rc: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn verify_start(cdev: *mut ccw_device) {
    static void verify_start(struct ccw_device *cdev)
    {
    struct subchannel *sch = to_subchannel(cdev.dev.parent);
    struct ccw_request *req = &cdev.private.req;
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_verify_start(cdev: *mut ccw_device) {
...
//
#[no_mangle]
unsafe extern "C" fn disband_callback(cdev: *mut ccw_device, data: *mut c_void, rc: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_disband_start(cdev: *mut ccw_device) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stlck_data {
    pub done: completion,
    pub rc: c_int,
}

#[no_mangle]
unsafe extern "C" fn stlck_build_cp(cdev: *mut ccw_device, buf1: *mut c_void, buf2: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn stlck_callback(cdev: *mut ccw_device, data: *mut c_void, rc: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_stlck(cdev: *mut ccw_device) -> c_int {
