...
//! Source: drivers/s390/cio/itcw.c
#![no_std]
...
pub struct itcw {
    pub tcw: *mut tcw,
    pub intrg_tcw: *mut tcw,
    pub num_tidaws: c_int,
    pub max_tidaws: c_int,
    pub intrg_num_tidaws: c_int,
    pub intrg_max_tidaws: c_int,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn itcw_calc_size(intrg: c_int, max_tidaws: c_int, intrg_max_tidaws: c_int) -> usize {
...
// Interrogate TCCB.
    ...
    tccb_add_dcw(chunk, TCCB_MAX_SIZE, DCW_CMD_INTRG, 0, core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn itcw_set_data(itcw: *mut itcw, addr: *mut c_void, use_tidal: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn itcw_finalize(itcw: *mut itcw) {
