...
//! Source: drivers/s390/cio/airq.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn register_adapter_interrupt(airq: *mut airq_struct) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn unregister_adapter_interrupt(airq: *mut airq_struct) {
    ...
    airq.lsi_ptr = core::ptr::null_mut();
    airq.flags &= ~AIRQ_PTR_ALLOCATED;
    }
    }
    EXPORT_SYMBOL(unregister_adapter_interrupt);
#[no_mangle]
unsafe extern "C" fn do_airq_interrupt(irq: c_int, dummy: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn init_airq_interrupts() -> void __init {
    void __init init_airq_interrupts(void)
    {
    irq_set_chip_and_handler(THIN_INTERRUPT,
    &dummy_irq_chip, handle_percpu_irq);
    if (request_irq(THIN_INTERRUPT, do_airq_interrupt, 0, "AIO", core::ptr::null_mut()))
    panic("Failed to register AIO interrupt\n");
    }
#[no_mangle]
pub unsafe extern "C" fn iv_size(bits: c_ulong) -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn if(AIRQ_IV_GUESTVEC): !(iv->flags &) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn airq_iv_release(iv: *mut airq_iv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn airq_iv_alloc(iv: *mut airq_iv, num: c_ulong) -> c_ulong {
...
//
#[no_mangle]
pub unsafe extern "C" fn airq_iv_free(iv: *mut airq_iv, bit: c_ulong, num: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn airq_init() -> int __init {
