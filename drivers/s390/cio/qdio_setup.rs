...
//! Source: drivers/s390/cio/qdio_setup.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn qdio_free_buffers(buf: *mut qdio_buffer, count: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qdio_alloc_buffers(buf: *mut qdio_buffer, count: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn qdio_reset_buffers(buf: *mut qdio_buffer, count: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn __qdio_free_queues(queues: *mut qdio_q, count: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn qdio_free_queues(irq_ptr: *mut qdio_irq) {
...
#[no_mangle]
unsafe extern "C" fn __qdio_allocate_qs(irq_ptr_qs: *mut qdio_q, nr_queues: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qdio_allocate_qs(irq_ptr: *mut qdio_irq, nr_input_qs: c_int, nr_output_qs: c_int) -> c_int {
    ...
    {
    let mut slib: *mut slib const = q.slib;
    let mut sl_page: *mut void const = q.sl_page;
    let mut sl: *mut sl const = q.sl;
...
#[no_mangle]
pub unsafe extern "C" fn qdio_setup_ssqd_info(irq_ptr: *mut qdio_irq) {
...
#[no_mangle]
unsafe extern "C" fn qdio_fill_qdr_desc(desc: *mut qdesfmt0, queue: *mut qdio_q) {
...
#[no_mangle]
pub unsafe extern "C" fn qdio_setup_irq(irq_ptr: *mut qdio_irq, init_data: *mut qdio_initialize) {
    ...
    irq_ptr.debugfs_dev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn qdio_shutdown_irq(irq: *mut qdio_irq) {
...
#[no_mangle]
pub unsafe extern "C" fn qdio_print_subchannel_info(irq_ptr: *mut qdio_irq) {
...
#[no_mangle]
pub unsafe extern "C" fn qdio_setup_init() -> int __init {
    int __init qdio_setup_init(void)
    {
    qdio_q_cache = kmem_cache_create("qdio_q", sizeof(struct qdio_q),
    256, 0, core::ptr::null_mut());
    if (!qdio_q_cache)
    return -ENOMEM;
...
#[no_mangle]
pub unsafe extern "C" fn qdio_setup_exit() {
