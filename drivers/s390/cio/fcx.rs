...
//
#[no_mangle]
pub unsafe extern "C" fn tcw_init(tcw: *mut tcw, r: c_int, w: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn tca_size(tccb: *mut tccb) -> usize {
    static inline size_t tca_size(struct tccb *tccb)
    {
    return tccb.tcah.tcal - 12;
    }
#[no_mangle]
unsafe extern "C" fn calc_dcw_count(tccb: *mut tccb) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn calc_cbc_size(tidaw: *mut tidaw, num: c_int) -> u32 {
    static u32 calc_cbc_size(struct tidaw *tidaw, int num)
    {
    int i;
    u32 cbc_data;
    let mut cbc_count: u32 = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn tcw_finalize(tcw: *mut tcw, num_tidaws: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: tcw->w) -> else {
    else if (tcw.w)
...
//
#[no_mangle]
pub unsafe extern "C" fn tcw_set_intrg(tcw: *mut tcw, intrg_tcw: *mut tcw) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tcw_set_data(tcw: *mut tcw, data: *mut c_void, use_tidal: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tcw_set_tccb(tcw: *mut tcw, tccb: *mut tccb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tcw_set_tsb(tcw: *mut tcw, tsb: *mut tsb) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tccb_init(tccb: *mut tccb, size: usize, sac: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn tsb_init(tsb: *mut tsb) {
