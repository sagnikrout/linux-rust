...
//! Source: drivers/s390/cio/device_fsm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ccw_timeout_log_setup(unused: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ccw_timeout_log(cdev: *mut ccw_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ccw_device_update_sense_data(cdev: *mut ccw_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ccw_device_test_sense_data(cdev: *mut ccw_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_notify(cdev: *mut ccw_device, event: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccw_device_oper_notify(cdev: *mut ccw_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ccw_device_recognition(cdev: *mut ccw_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ccw_device_request_event(cdev: *mut ccw_device, e: enum dev_event) {
...
#[no_mangle]
unsafe extern "C" fn ccw_device_report_path_events(cdev: *mut ccw_device) {
...
#[no_mangle]
unsafe extern "C" fn ccw_device_reset_path_events(cdev: *mut ccw_device) {
...
#[no_mangle]
unsafe extern "C" fn create_fake_irb(irb: *mut irb, type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ccw_device_handle_broken_paths(cdev: *mut ccw_device) {
    static void ccw_device_handle_broken_paths(struct ccw_device *cdev)
    {
    struct subchannel *sch = to_subchannel(cdev.dev.parent);
    let mut broken_paths: u8 = (sch.schib.pmcw.pam & sch.opm) ^ sch.vpm;
    if (broken_paths && (cdev.private.path_broken_mask != broken_paths))
    ccw_device_schedule_recovery();
    cdev.private.path_broken_mask = broken_paths;
    }
#[no_mangle]
pub unsafe extern "C" fn ccw_device_verify_done(cdev: *mut ccw_device, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ccw_device_call_handler(cdev: *mut ccw_device) -> c_int {
...
//
    ...
    dev_fsm_event(cdev, DEV_EVENT_NOTOPER);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cdev->handler) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn ccw_device_kill_io(cdev: *mut ccw_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ccw_device_trigger_reprobe(cdev: *mut ccw_device) {
