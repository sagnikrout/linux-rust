...
//! Source: drivers/s390/cio/vfio_ccw_ops.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_reset(private: *mut vfio_ccw_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_dma_unmap(vdev: *mut vfio_device, iova: u64, length: u64) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_init_dev(vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_probe(mdev: *mut mdev_device) -> c_int {
    ...
    return 0;
    err_put_vdev:
    dev_set_drvdata(&parent.dev, core::ptr::null_mut());
    vfio_put_device(&private.vdev);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_release_dev(vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_remove(mdev: *mut mdev_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_open_device(vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_close_device(vdev: *mut vfio_device) {
...
//
    ...
    struct vfio_ccw_private *private =
    container_of(vdev, struct vfio_ccw_private, vdev);
    let mut index: c_uint = VFIO_CCW_OFFSET_TO_INDEX(*ppos);
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_get_irq_info(info: *mut vfio_irq_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_ccw_unregister_dev_regions(private: *mut vfio_ccw_private) {
    ...
    private.region = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn vfio_ccw_mdev_request(vdev: *mut vfio_device, count: c_uint) {
