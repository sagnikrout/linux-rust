...
//! Source: drivers/s390/crypto/pkey_sysfs.c
#![no_std]
...
//
    ...
    {
    int rc;
    rc = pkey_handler_gen_key(core::ptr::null_mut(), 0,
    keytype, keysubtype,
    keybitsize, flags,
...
//
    ...
    seckey.seckey, &buflen, core::ptr::null_mut());
    if (rc)
    return rc;
    if (is_xts) {
    seckey++;
...
//
    ...
    size_t count)
    {
    let mut keysize: u32 = CCACIPHERTOKENSIZE;
    int rc;
...
//
    ...
    size_t count)
    {
    let mut keysize: u32 = MAXEP11AESKEYBLOBSIZE;
    int rc;
