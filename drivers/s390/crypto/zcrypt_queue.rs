...
//! Source: drivers/s390/crypto/zcrypt_queue.c
#![no_std]
...
//
    ...
    let mut online: c_int = aq.config && !aq.chkstop && zq.online ? 1 : 0;
...
#[no_mangle]
pub unsafe extern "C" fn zcrypt_queue_force_online(zq: *mut zcrypt_queue, online: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn zcrypt_queue_free(zq: *mut zcrypt_queue) {
...
#[no_mangle]
unsafe extern "C" fn zcrypt_queue_release(kref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn zcrypt_queue_get(zq: *mut zcrypt_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn zcrypt_queue_put(zq: *mut zcrypt_queue) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zcrypt_queue_register(zq: *mut zcrypt_queue) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zcrypt_queue_unregister(zq: *mut zcrypt_queue) {
