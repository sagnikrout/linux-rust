...
//! Source: drivers/s390/crypto/ap_queue.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ap_q_supported_in_se(aq: *mut ap_queue) -> bool {
    static inline bool ap_q_supported_in_se(struct ap_queue *aq)
    {
    return aq.card.hwinfo.ep11 || aq.card.hwinfo.accel;
    }
#[no_mangle]
pub unsafe extern "C" fn ap_q_supports_bind(aq: *mut ap_queue) -> bool {
    static inline bool ap_q_supports_bind(struct ap_queue *aq)
    {
    return aq.card.hwinfo.ep11 || aq.card.hwinfo.accel;
    }
#[no_mangle]
pub unsafe extern "C" fn ap_q_supports_assoc(aq: *mut ap_queue) -> bool {
    static inline bool ap_q_supports_assoc(struct ap_queue *aq)
    {
    return aq.card.hwinfo.ep11;
    }
#[no_mangle]
pub unsafe extern "C" fn ap_q_needs_bind(aq: *mut ap_queue) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ap_queue_enable_irq(aq: *mut ap_queue, ind: *mut c_void) -> c_int {
    static int ap_queue_enable_irq(struct ap_queue *aq, void *ind)
    {
    let mut qirqctrl: union ap_qirq_ctrl = { .value = 0 };
...
#[no_mangle]
unsafe extern "C" fn ap_sm_nop(aq: *mut ap_queue) -> enum ap_sm_wait {
...
//
#[no_mangle]
unsafe extern "C" fn ap_sm_recv(aq: *mut ap_queue) -> ap_queue_status {
...
//
    ...
    if (parts > 1) {
    ap_msg.rc = -EMSGSIZE;
    ap_msg.receive(aq, ap_msg, core::ptr::null_mut());
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn ap_sm_read(aq: *mut ap_queue) -> enum ap_sm_wait {
...
//
#[no_mangle]
unsafe extern "C" fn ap_sm_write(aq: *mut ap_queue) -> enum ap_sm_wait {
    static enum ap_sm_wait ap_sm_write(struct ap_queue *aq)
    {
    struct ap_queue_status status;
    struct ap_message *ap_msg;
    let mut qid: ap_qid_t = aq.qid;
...
//
#[no_mangle]
unsafe extern "C" fn ap_sm_read_write(aq: *mut ap_queue) -> enum ap_sm_wait {
...
//
#[no_mangle]
unsafe extern "C" fn ap_sm_reset(aq: *mut ap_queue) -> enum ap_sm_wait {
...
//
#[no_mangle]
unsafe extern "C" fn ap_sm_reset_wait(aq: *mut ap_queue) -> enum ap_sm_wait {
...
//
#[no_mangle]
unsafe extern "C" fn ap_sm_setirq_wait(aq: *mut ap_queue) -> enum ap_sm_wait {
...
// Get the status with TAPQ
    status = ap_tapq(aq.qid, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn ap_sm_assoc_wait(aq: *mut ap_queue) -> enum ap_sm_wait {
...
#[no_mangle]
pub unsafe extern "C" fn ap_sm_event(aq: *mut ap_queue, event: enum ap_sm_event) -> enum ap_sm_wait {
...
#[no_mangle]
pub unsafe extern "C" fn ap_sm_event_loop(aq: *mut ap_queue, event: enum ap_sm_event) -> enum ap_sm_wait {
...
#[no_mangle]
pub unsafe extern "C" fn if(device_has_driver_override(dev): !old_value &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn ap_queue_device_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn ap_queue_init_reply(aq: *mut ap_queue, reply: *mut ap_message) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ap_queue_message(aq: *mut ap_queue, ap_msg: *mut ap_message) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ap_queue_usable(aq: *mut ap_queue) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ap_cancel_message(aq: *mut ap_queue, ap_msg: *mut ap_message) {
...
//
#[no_mangle]
unsafe extern "C" fn __ap_flush_queue(aq: *mut ap_queue) {
    static void __ap_flush_queue(struct ap_queue *aq)
    {
...
#[no_mangle]
pub unsafe extern "C" fn ap_flush_queue(aq: *mut ap_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ap_queue_prepare_remove(aq: *mut ap_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ap_queue_remove(aq: *mut ap_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn _ap_queue_init_state(aq: *mut ap_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn ap_queue_init_state(aq: *mut ap_queue) {
