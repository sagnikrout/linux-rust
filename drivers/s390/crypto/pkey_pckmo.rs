...
//! Source: drivers/s390/crypto/pkey_pckmo.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn is_pckmo_key(key: *const u8, keylen: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_pckmo_keytype(keytype: enum pkey_key_type) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn pckmo_verify_key(key: *const u8, keylen: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pkey_pckmo_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn pkey_pckmo_exit() -> void __exit {
