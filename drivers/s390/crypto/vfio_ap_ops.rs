...
//! Source: drivers/s390/crypto/vfio_ap_ops.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn get_update_locks_for_kvm(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn release_update_locks_for_kvm(kvm: *mut kvm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_update_locks_for_mdev(matrix_mdev: *mut ap_matrix_mdev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn release_update_locks_for_mdev(matrix_mdev: *mut ap_matrix_mdev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn get_update_locks_for_queue(q: *mut vfio_ap_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_ap_wait_for_irqclear(apqn: c_int) {
    static void vfio_ap_wait_for_irqclear(int apqn)
    {
    struct ap_queue_status status;
    let mut retry: c_int = 5;
    do {
    status = ap_tapq(apqn, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn vfio_ap_free_aqic_resources(q: *mut vfio_ap_queue) {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_ap_irq_disable(q: *mut vfio_ap_queue) -> ap_queue_status {
    static struct ap_queue_status vfio_ap_irq_disable(struct vfio_ap_queue *q)
    {
    let mut aqic_gisa: union ap_qirq_ctrl = { .value = 0 };
    struct ap_queue_status status;
...
//
#[no_mangle]
unsafe extern "C" fn vfio_ap_validate_nib(vcpu: *mut kvm_vcpu, nib: *mut dma_addr_t) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ensure_nib_shared(addr: c_ulong) -> c_int {
...
//
    ...
    {
    let mut aqic_gisa: union ap_qirq_ctrl = { .value = 0 };
    let mut status: ap_queue_status = {};
...
//
#[no_mangle]
unsafe extern "C" fn vfio_ap_le_guid_to_be_uuid(guid: *mut guid_t, uuid: *mut c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn handle_pqap(vcpu: *mut kvm_vcpu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn signal_guest_ap_cfg_changed(matrix_mdev: *mut ap_matrix_mdev) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_update_guest_apcb(matrix_mdev: *mut ap_matrix_mdev) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_filter_cdoms(matrix_mdev: *mut ap_matrix_mdev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn _queue_passable(q: *mut vfio_ap_queue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_init_dev(vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_probe(mdev: *mut mdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_link_apqn(matrix_mdev: *mut ap_matrix_mdev, apqn: c_int) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_unlink_queue_fr_mdev(q: *mut vfio_ap_queue) {
    static void vfio_ap_unlink_queue_fr_mdev(struct vfio_ap_queue *q)
    {
    hash_del(&q.mdev_qnode);
    }
#[no_mangle]
unsafe extern "C" fn vfio_ap_unlink_mdev_fr_queue(q: *mut vfio_ap_queue) {
    static void vfio_ap_unlink_mdev_fr_queue(struct vfio_ap_queue *q)
    {
    q.matrix_mdev = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_unlink_fr_queues(matrix_mdev: *mut ap_matrix_mdev) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_remove(mdev: *mut mdev_device) {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_validate_masks(matrix_mdev: *mut ap_matrix_mdev) -> c_int {
...
// vfio_ap_unlink_apqn_fr_mdev(struct ap_matrix_mdev *matrix_mdev,
    ...
    {
    struct vfio_ap_queue *q = core::ptr::null_mut();
    q = vfio_ap_mdev_get_queue(matrix_mdev, AP_MKQID(apid, apqi));
...
//
    ...
    struct list_head qlist;
    unsigned long apid;
    let mut apcb_update: bool = false;
    INIT_LIST_HEAD(&qlist);
...
//
    ...
    unsigned long id;
    struct ap_matrix_mdev *matrix_mdev = dev_get_drvdata(dev);
    let mut max_domid: c_ulong = matrix_mdev.matrix.adm_max;
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_matrix_show(matrix: *mut ap_matrix, buf: *mut c_char) -> isize {
    ...
    unsigned long apid1;
    unsigned long apqi1;
    let mut napm_bits: c_ulong = matrix.apm_max + 1;
    let mut naqm_bits: c_ulong = matrix.aqm_max + 1;
    let mut nchars: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn write_ap_bitmap(bitmap: *mut c_ulong, buf: *mut c_char, offset: c_int, sep: c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn parse_bitmap(strbufptr: *mut c_char, bitmap: *mut c_ulong, nbits: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ap_matrix_overflow_check(matrix_mdev: *mut ap_matrix_mdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ap_matrix_copy(dst: *mut ap_matrix, src: *mut ap_matrix) {
...
#[no_mangle]
unsafe extern "C" fn unmap_iova(matrix_mdev: *mut ap_matrix_mdev, iova: u64, length: u64) {
...
//
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_unset_kvm(matrix_mdev: *mut ap_matrix_mdev) {
    static void vfio_ap_mdev_unset_kvm(struct ap_matrix_mdev *matrix_mdev)
    {
    struct kvm *kvm = matrix_mdev.kvm;
    if (kvm && kvm.arch.crypto.crycbd) {
    get_update_locks_for_kvm(kvm);
    kvm.arch.crypto.pqap_hook = core::ptr::null_mut();
    kvm_arch_crypto_clear_masks(kvm);
    vfio_ap_mdev_reset_queues(matrix_mdev);
    matrix_mdev.kvm = core::ptr::null_mut();
    release_update_locks_for_kvm(kvm);
    kvm_put_kvm(kvm);
    }
    }
...
#[no_mangle]
unsafe extern "C" fn apq_status_check(apqn: c_int, status: *mut ap_queue_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apq_reset_check(reset_work: *mut work_struct) {
    static void apq_reset_check(struct work_struct *reset_work)
    {
    let mut ret: c_int = -EBUSY, elapsed = 0;
    struct ap_queue_status status;
    struct vfio_ap_queue *q;
    ...
    status = ap_tapq(q.apqn, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_reset_queue(q: *mut vfio_ap_queue) {
    static void vfio_ap_mdev_reset_queue(struct vfio_ap_queue *q)
    {
    struct ap_queue_status status;
    if (!q)
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_reset_queues(matrix_mdev: *mut ap_matrix_mdev) -> c_int {
    static int vfio_ap_mdev_reset_queues(struct ap_matrix_mdev *matrix_mdev)
    {
    let mut ret: c_int = 0, loop_cursor;
    struct vfio_ap_queue *q;
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_reset_qlist(qlist: *mut list_head) -> c_int {
    static int vfio_ap_mdev_reset_qlist(struct list_head *qlist)
    {
    let mut ret: c_int = 0;
    struct vfio_ap_queue *q;
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_open_device(vdev: *mut vfio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_close_device(vdev: *mut vfio_device) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_request(vdev: *mut vfio_device, count: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_get_device_info(arg: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_get_irq_info(arg: c_ulong) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_irq_set_init(irq_set: *mut vfio_irq_set, arg: c_ulong) -> c_int {
    ...
    matrix_mdev.req_trigger = core::ptr::null_mut();
    } else if (fd >= 0) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_set_cfg_change_irq(matrix_mdev: *mut ap_matrix_mdev, arg: c_ulong) -> c_int {
    ...
    matrix_mdev.cfg_chg_trigger = core::ptr::null_mut();
    } else if (fd >= 0) {
    ...
    {
    struct ap_matrix_mdev *matrix_mdev;
    let mut apid: c_ulong = AP_QID_CARD(q.apqn);
    let mut apqi: c_ulong = AP_QID_QUEUE(q.apqn);
...
#[no_mangle]
pub unsafe extern "C" fn vfio_ap_mdev_register() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_ap_mdev_unregister() {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_ap_mdev_probe_queue(apdev: *mut ap_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vfio_ap_mdev_remove_queue(apdev: *mut ap_device) {
...
//
    ...
    if (matrix_mdev)
    vfio_ap_unlink_queue_fr_mdev(q);
    dev_set_drvdata(&apdev.device, core::ptr::null_mut());
    kfree(q);
    release_update_locks_for_mdev(matrix_mdev);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn vfio_ap_mdev_resource_in_use(apm: *mut c_ulong, aqm: *mut c_ulong) -> c_int {
    int vfio_ap_mdev_resource_in_use(unsigned long *apm, unsigned long *aqm)
    {
    int ret;
    mutex_lock(&matrix_dev.guests_lock);
    mutex_lock(&matrix_dev.mdevs_lock);
    ret = vfio_ap_mdev_verify_no_sharing(core::ptr::null_mut(), apm, aqm);
    mutex_unlock(&matrix_dev.mdevs_lock);
    mutex_unlock(&matrix_dev.guests_lock);
    return ret;
    }
...
//
#[no_mangle]
unsafe extern "C" fn vfio_ap_filter_apid_by_qtype(apm: *mut c_ulong, aqm: *mut c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn vfio_ap_mdev_hot_plug_cfg(matrix_mdev: *mut ap_matrix_mdev) {
