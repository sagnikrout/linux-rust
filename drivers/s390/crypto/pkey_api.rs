...
//! Source: drivers/s390/crypto/pkey_api.c
#![no_std]
...
//
    ...
    {
    int rc;
    rc = key2protkey(core::ptr::null_mut(), 0, key, keylen,
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_genseck(ugs: *mut pkey_genseck __user) -> c_int {
    ...
    kgs.seckey.seckey, &keybuflen, core::ptr::null_mut(), 0);
    pr_debug("gen_key()=%d\n", rc);
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_clr2seck(ucs: *mut pkey_clr2seck __user) -> c_int {
    ...
    kcs.seckey.seckey, &keybuflen, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_sec2protk(usp: *mut pkey_sec2protk __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_clr2protk(ucp: *mut pkey_clr2protk __user) -> c_int {
    static int pkey_ioctl_clr2protk(struct pkey_clr2protk __user *ucp)
    {
    struct pkey_clr2protk kcp;
    struct clearkeytoken *t;
    u8 *tmpbuf = core::ptr::null_mut();
    u32 keylen;
    int rc;
...
// build a 'clear key token' from the clear key value
    ...
    rc = key2protkey(core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_findcard(ufc: *mut pkey_findcard __user) -> c_int {
    static int pkey_ioctl_findcard(struct pkey_findcard __user *ufc)
    {
    struct pkey_apqn *apqns = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_skey2pkey(usp: *mut pkey_skey2pkey __user) -> c_int {
    ...
    return -EFAULT;
    ksp.protkey.len = sizeof(ksp.protkey.protkey);
    rc = pkey_handler_key_to_protkey(core::ptr::null_mut(), 0,
    ksp.seckey.seckey,
    sizeof(ksp.seckey.seckey),
    ksp.protkey.protkey,
    &ksp.protkey.len,
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_verifykey(uvk: *mut pkey_verifykey __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_genprotk(ugp: *mut pkey_genprotk __user) -> c_int {
    ...
    rc = pkey_handler_gen_key(core::ptr::null_mut(), 0, kgp.keytype,
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_verifyprotk(uvp: *mut pkey_verifyprotk __user) -> c_int {
...
// build a 'protected key token' from the raw protected key
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), 0);
    pr_debug("verify_key()=%d\n", rc);
    out:
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_kblob2protk(utp: *mut pkey_kblob2pkey __user) -> c_int {
    static int pkey_ioctl_kblob2protk(struct pkey_kblob2pkey __user *utp)
    {
    struct pkey_kblob2pkey ktp;
    u8 *kkey = core::ptr::null_mut();
    int rc;
    ...
    if (IS_ERR(kkey)) {
    rc = PTR_ERR(kkey);
    kkey = core::ptr::null_mut();
    goto out;
    }
    ktp.protkey.len = sizeof(ktp.protkey.protkey);
    rc = key2protkey(core::ptr::null_mut(), 0, kkey, ktp.keylen,
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_genseck2(ugs: *mut pkey_genseck2 __user) -> c_int {
    static int pkey_ioctl_genseck2(struct pkey_genseck2 __user *ugs)
    {
    struct pkey_apqn *apqns = core::ptr::null_mut();
    let mut klen: u32 = KEYBLOBBUFSIZE;
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_clr2seck2(ucs: *mut pkey_clr2seck2 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_verifykey2(uvk: *mut pkey_verifykey2 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_kblob2protk2(utp: *mut pkey_kblob2pkey2 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_apqns4k(uak: *mut pkey_apqns4key __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_apqns4kt(uat: *mut pkey_apqns4keytype __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_ioctl_kblob2protk3(utp: *mut pkey_kblob2pkey3 __user) -> c_int {
    static int pkey_ioctl_kblob2protk3(struct pkey_kblob2pkey3 __user *utp)
    {
    let mut protkeylen: u32 = PROTKEYBLOBBUFSIZE;
    u8 *kkey = core::ptr::null_mut(), *protkey = core::ptr::null_mut();
    struct pkey_apqn *apqns = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn pkey_api_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn pkey_api_exit() -> void __exit {
