...
//! Source: drivers/s390/char/fs3270.c
#![no_std]
...
pub struct fs3270 {
    ...
    pub /: *mut *mut *mut pid fs_pid; / Pid of controlling program.,
    pub /: *mut *mut int read_command; / ccw command to use for reads.,
    pub /: *mut *mut int write_command; / ccw command to use for writes.,
    pub /: *mut *mut int attention; / Got attention.,
    pub /: *mut *mut int active; / Fullscreen view is active.,
    pub /: *mut *mut *mut raw3270_request init; / single init request.,
    pub /: *mut *mut wait_queue_head_t wait; / Init & attention wait queue.,
    pub /: *mut *mut *mut idal_buffer rdbuf; / full-screen-deactivate buffer,
    pub /: *mut *mut size_t rdbuf_size; / size of data returned by RDBUF,
}

    static DEFINE_MUTEX(fs3270_mutex);
#[no_mangle]
unsafe extern "C" fn fs3270_wake_up(rq: *mut raw3270_request, data: *mut c_void) {
    static void fs3270_wake_up(struct raw3270_request *rq, void *data)
    {
    wake_up((wait_queue_head_t *)data);
    }
#[no_mangle]
pub unsafe extern "C" fn fs3270_working(fp: *mut fs3270) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs3270_do_io(view: *mut raw3270_view, rq: *mut raw3270_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fs3270_reset_callback(rq: *mut raw3270_request, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fs3270_restore_callback(rq: *mut raw3270_request, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fs3270_activate(view: *mut raw3270_view) -> c_int {
...
// Restore fullscreen buffer saved by fs3270_deactivate.
    ...
    fp.init.rc = rc;
    if (rc)
    fp.init.callback(fp.init, core::ptr::null_mut());
    else
    fp.active = 1;
    return rc;
    }
...
//
#[no_mangle]
unsafe extern "C" fn fs3270_save_callback(rq: *mut raw3270_request, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fs3270_deactivate(view: *mut raw3270_view) {
...
//
#[no_mangle]
unsafe extern "C" fn fs3270_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn fs3270_free_view(view: *mut raw3270_view) {
...
//
#[no_mangle]
unsafe extern "C" fn fs3270_release(view: *mut raw3270_view) {
...
//
#[no_mangle]
unsafe extern "C" fn fs3270_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fs3270_close(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fs3270_create_cb(minor: c_int) {
    static void fs3270_create_cb(int minor)
    {
    __register_chrdev(IBM_FS3270_MAJOR, minor, 1, "tub", &fs3270_fops);
    device_create(&class3270, core::ptr::null_mut(), MKDEV(IBM_FS3270_MAJOR, minor),
    core::ptr::null_mut(), "3270/tub%d", minor);
    }
#[no_mangle]
unsafe extern "C" fn fs3270_destroy_cb(minor: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn fs3270_init() -> int __init {
    ...
    if (rc)
    return rc;
    device_create(&class3270, core::ptr::null_mut(), MKDEV(IBM_FS3270_MAJOR, 0),
    core::ptr::null_mut(), "3270/tub");
    raw3270_register_notifier(&fs3270_notifier);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn fs3270_exit() -> void __exit {
