...
//! Source: drivers/s390/char/sclp_con.c
#![no_std]
...
pub const sclp_console_minor: c_int = 64;
...
pub const SCLP_CON_COLUMNS: c_int = 320;
pub const SPACES_PER_TAB: c_int = 8;
    static void
...
//
#[no_mangle]
unsafe extern "C" fn sclp_conbuf_emit() {
...
//
#[no_mangle]
unsafe extern "C" fn sclp_console_sync_queue() {
...
// make sure we have a console output buffer
    if (sclp_conbuf == core::ptr::null_mut()) {
...
// Setup timer to output current console buffer after 1/10 second
    if (sclp_conbuf != core::ptr::null_mut() && sclp_chars_in_buffer(sclp_conbuf) != 0 &&
...
//
#[no_mangle]
unsafe extern "C" fn __sclp_console_free_pages() -> void __init {
