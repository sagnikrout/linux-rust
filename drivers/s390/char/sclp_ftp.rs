...
//! Source: drivers/s390/char/sclp_ftp.h
#![no_std]
...
extern "C" {
    pub fn sclp_ftp_startup() -> c_int;
}
extern "C" {
    pub fn sclp_ftp_shutdown();
}
extern "C" {
    pub fn sclp_ftp_cmd(ftp: *const hmcdrv_ftp_cmdspec, fsize: *mut usize) -> isize;
}
