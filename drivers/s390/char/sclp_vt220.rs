...
//! Source: drivers/s390/char/sclp_vt220.c
#![no_std]
...
pub const SCLP_VT220_MINOR: c_int = 65;

// Representation of a single write request
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sclp_vt220_request {
    pub list: list_head,
    pub sclp_req: sclp_req,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sclp_vt220_sccb {
    pub header: sccb_header,
    pub evbuf: evbuf_header,
}
...
// Check if there is a pending buffer on the out queue.
    ...
    if (request == core::ptr::null_mut() && sclp_vt220_flush_later)
    sclp_vt220_emit_current();
    tty_port_tty_wakeup(&sclp_vt220_port);
    }
pub const SCLP_BUFFER_MAX_RETRY: c_int = 1;
//
...
// Only emit buffers with content
    ...
    &sclp_vt220_outqueue);
    sclp_vt220_current_request = core::ptr::null_mut();
...
pub const SCLP_NORMAL_WRITE: c_uint = 0x00;
//
...
// Create an sclp output buffer if none exists yet
    if (sclp_vt220_current_request == core::ptr::null_mut()) {
...
pub const SCLP_VT220_SESSION_ENDED: c_uint = 0x01;
pub const SCLP_VT220_SESSION_STARTED: c_uint = 0x80;
pub const SCLP_VT220_SESSION_DATA: c_uint = 0x00;

    static int sysrq_pressed;
    static struct sysrq_work sysrq;
#[no_mangle]
unsafe extern "C" fn sclp_vt220_reset_session() {
    static void sclp_vt220_reset_session(void)
    {
    sysrq_pressed = 0;
    }
#[no_mangle]
unsafe extern "C" fn sclp_vt220_handle_input(buffer: *const c_char, count: c_uint) {
...
//
    ...
    {
    if (tty.count == 1)
    tty_port_tty_set(&sclp_vt220_port, core::ptr::null_mut());
    }
//
...
#[no_mangle]
unsafe extern "C" fn __sclp_vt220_free_pages() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __sclp_vt220_cleanup() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn __sclp_vt220_init(num_pages: c_int) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn sclp_vt220_tty_init() -> int __init {
