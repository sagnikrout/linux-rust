...
//! Source: drivers/s390/char/con3270.c
#![no_std]
...
pub const TTY3270_CHAR_BUF_SIZE: c_int = 256;
pub const TTY3270_OUTPUT_BUFFER_SIZE: c_int = 4096;

pub const TTY3270_STATUS_AREA_SIZE: c_int = 40;
    static struct tty_driver *tty3270_driver;
    static int tty3270_max_index;
    static struct raw3270_fn tty3270_fn;
pub const TTY3270_HIGHLIGHT_BLINK: c_int = 1;
pub const TTY3270_HIGHLIGHT_REVERSE: c_int = 2;
pub const TTY3270_HIGHLIGHT_UNDERSCORE: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tty3270_attribute {
    pub /: *mut *mut unsigned char alternate_charset:1; / Graphics charset,
    pub /: *mut *mut unsigned char highlight:3; / Blink/reverse/underscore,
    pub /: *mut *mut unsigned char f_color:4; / Foreground color,
    pub /: *mut *mut unsigned char b_color:4; / Background color,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tty3270_cell {
    pub character: u8,
    pub attributes: tty3270_attribute,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tty3270_line {
    pub cells: *mut tty3270_cell,
    pub len: c_int,
    pub dirty: c_int,
}
...
#[derive(Copy, Clone)]
pub struct tty3270 {
    pub view: raw3270_view,
    pub port: tty_port,
// Output stuff.
    pub /: *mut *mut unsigned char wcc; / Write control character.,
    pub /: *mut *mut int nr_up; / # lines up in history.,
    pub /: *mut *mut unsigned long update_flags; / Update indication bits.,
    pub /: *mut *mut *mut raw3270_request write; / Single write request.,
    pub /: *mut *mut timer_list timer; / Output delay timer.,
    pub /: *mut *mut *mut char converted_line; / RAW 3270 data stream,
    pub /: *mut *mut unsigned int line_view_start; / Start of visible area,
    pub /: *mut *mut unsigned int line_write_start; / current write position,
    pub /: *mut *mut unsigned int oops_line; / line counter used when print oops,
// Current tty screen.
    pub /: *mut *mut unsigned int cx, cy; / Current output position.,
    pub attributes: tty3270_attribute,
    pub saved_attributes: tty3270_attribute,
    pub allocated_lines: c_int,
    pub screen: *mut tty3270_line,
// Input stuff.
    pub /: *mut *mut *mut char prompt; / Output string for input area.,
    pub /: *mut *mut size_t prompt_sz; / Size of output string.,
    pub /: *mut *mut *mut char input; / Input string for read request.,
    pub /: *mut *mut *mut raw3270_request read; / Single read request.,
    pub /: *mut *mut *mut raw3270_request kreset; / Single keyboard reset request.,
    pub readpartreq: *mut raw3270_request,
    pub /: *mut *mut unsigned char inattr; / Visible/invisible input.,
    pub /: *mut *mut int throttle, attn; / tty throttle/unthrottle.,
    pub /: *mut *mut tasklet_readlet; / Tasklet to issue read request.,
    pub /: *mut *mut tasklet_hanglet; / Tasklet to hang up the tty.,
    pub /: *mut *mut *mut kbd_data kbd; / key_maps stuff.,
// Escape sequence parsing.
    pub esc_npar: int esc_state, esc_ques,,
    pub esc_par: [c_int; ESCAPE_NPAR],
    pub saved_cy: unsigned int saved_cx,,
// Command recalling.
    pub /: *mut *mut *mut *mut char rcl_lines; / Array of recallable lines,
    pub /: *mut *mut int rcl_write_index; / Write index of recallable items,
    pub /: *mut *mut int rcl_read_index; / Read index of recallable items,
// Character array for put_char/flush_chars.
    pub char_count: c_uint,
    pub char_buf: [u8; TTY3270_CHAR_BUF_SIZE],
}

// tty3270->update_flags. See tty3270_update for details.
pub const TTY_UPDATE_INPUT: c_uint = 0x1	/* Update input line. */;
pub const TTY_UPDATE_STATUS: c_uint = 0x2	/* Update status line. */;
pub const TTY_UPDATE_LINES: c_uint = 0x4	/* Update visible screen lines */;
pub const TTY_UPDATE_ALL: c_uint = 0x7	/* Recreate screen. */;
pub const TTY3270_INPUT_AREA_ROWS: c_int = 2;
//
// Setup timeout for a device. On timeout trigger an update.
//
#[no_mangle]
unsafe extern "C" fn tty3270_set_timer(tp: *mut tty3270, expires: c_int) {
    static void tty3270_set_timer(struct tty3270 *tp, int expires)
    {
    mod_timer(&tp.timer, jiffies + expires);
    }
#[no_mangle]
unsafe extern "C" fn tty3270_tty_rows(tp: *mut tty3270) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tty3270_line_increment(tp: *mut tty3270, line: c_uint, incr: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tty3270_input_size(cols: c_int) -> c_int {
    static int tty3270_input_size(int cols)
    {
    return cols * 2 - 11;
    }
#[no_mangle]
unsafe extern "C" fn tty3270_update_prompt(tp: *mut tty3270, input: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_add_prompt(tp: *mut tty3270) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_add_status(tp: *mut tty3270) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tty3270_blank_screen(tp: *mut tty3270) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_write_callback(rq: *mut raw3270_request, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_required_length(tp: *mut tty3270, line: *mut tty3270_line) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tty3270_graphics_translate(tp: *mut tty3270, ch: c_char) -> c_char {
...
#[no_mangle]
unsafe extern "C" fn tty3270_reset_attributes(attr: *mut tty3270_attribute) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_convert_line(tp: *mut tty3270, line: *mut tty3270_line, lineno: c_int) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tty3270_update_lines_visible(tp: *mut tty3270, rq: *mut raw3270_request) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_update_lines_all(tp: *mut tty3270, rq: *mut raw3270_request) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_update(t: *mut timer_list) {
    static void tty3270_update(struct timer_list *t)
    {
    struct tty3270 *tp = timer_container_of(tp, t, timer);
    struct raw3270_request *wrq;
    let mut cmd: u8 = TC_WRITE;
    int rc, len;
    wrq = xchg(&tp.write, core::ptr::null_mut());
    if (!wrq) {
    tty3270_set_timer(tp, 1);
    return;
    }
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_rcl_add(tp: *mut tty3270, input: *mut c_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_rcl_backward(kbd: *mut kbd_data) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_exit_tty(kbd: *mut kbd_data) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_redraw(tp: *mut tty3270) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_scroll_forward(kbd: *mut kbd_data) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_scroll_backward(kbd: *mut kbd_data) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_read_callback(rq: *mut raw3270_request, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_issue_read(tp: *mut tty3270, lock: c_int) {
    static void tty3270_issue_read(struct tty3270 *tp, int lock)
    {
    struct raw3270_request *rrq;
    int rc;
    rrq = xchg(&tp.read, core::ptr::null_mut());
    if (!rrq)
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_hangup_tasklet(data: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_activate(view: *mut raw3270_view) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tty3270_deactivate(view: *mut raw3270_view) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_irq(tp: *mut tty3270, rq: *mut raw3270_request, irb: *mut irb) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_free_view(tp: *mut tty3270) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_free_recall(lines: *mut c_char) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_free_screen(screen: *mut tty3270_line, old_lines: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_release(view: *mut raw3270_view) {
    ...
    tty_port_tty_set(&tp.port, core::ptr::null_mut());
    tty_hangup(tty);
    raw3270_put_view(&tp.view);
    tty_kref_put(tty);
    }
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_free(view: *mut raw3270_view) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_del_views() {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_open(tty: *mut tty_struct, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_close(tty: *mut tty_struct, filp: *mut file) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_cleanup(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_write_room(tty: *mut tty_struct) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_put_character(tp: *mut tty3270, ch: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_cr(tp: *mut tty3270) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_lf(tp: *mut tty3270) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_ri(tp: *mut tty3270) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_reset_cell(tp: *mut tty3270, cell: *mut tty3270_cell) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_insert_characters(tp: *mut tty3270, n: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_delete_characters(tp: *mut tty3270, n: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_erase_characters(tp: *mut tty3270, n: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_erase_line(tp: *mut tty3270, mode: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_erase_display(tp: *mut tty3270, mode: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_set_attributes(tp: *mut tty3270) {
...
#[no_mangle]
pub unsafe extern "C" fn tty3270_getpar(tp: *mut tty3270, ix: c_int) -> c_int {
    static inline int tty3270_getpar(struct tty3270 *tp, int ix)
    {
    return (tp.esc_par[ix] > 0) ? tp.esc_par[ix] : 1;
    }
#[no_mangle]
unsafe extern "C" fn tty3270_goto_xy(tp: *mut tty3270, cx: c_int, cy: c_int) {
    static void tty3270_goto_xy(struct tty3270 *tp, int cx, int cy)
    {
    struct tty3270_line *line;
    struct tty3270_cell *cell;
    let mut max_cx: c_int = max(0, cx);
    let mut max_cy: c_int = max(0, cy);
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_escape_sequence(tp: *mut tty3270, ch: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_put_char(tty: *mut tty_struct, ch: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_flush_chars(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_set_termios(tty: *mut tty_struct, old: *const ktermios) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_throttle(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_unthrottle(tty: *mut tty_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_hangup(tty: *mut tty_struct) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_wait_until_sent(tty: *mut tty_struct, timeout: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tty3270_create_cb(minor: c_int) {
    static void tty3270_create_cb(int minor)
    {
    tty_register_device(tty3270_driver, minor - RAW3270_FIRSTMINOR, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn tty3270_destroy_cb(minor: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tty3270_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tty3270_exit() -> void __exit {
    static void __exit tty3270_exit(void)
    {
    struct tty_driver *driver;
    raw3270_unregister_notifier(&tty3270_notifier);
    driver = tty3270_driver;
    tty3270_driver = core::ptr::null_mut();
...
// Set the console mode for VM
    if (machine_is_vm()) {
    cpcmd("TERM CONMODE 3270", core::ptr::null_mut(), 0, core::ptr::null_mut());
