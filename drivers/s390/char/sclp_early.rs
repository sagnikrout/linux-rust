...
//! Source: drivers/s390/char/sclp_early.c
#![no_std]
...
//
    ...
    EXPORT_SYMBOL(sclp);
#[no_mangle]
unsafe extern "C" fn sclp_early_facilities_detect() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn sclp_early_get_ipl_info(info: *mut sclp_ipl_info) -> void __init {
    void __init sclp_early_get_ipl_info(struct sclp_ipl_info *info)
    {
// info = sclp_ipl_info;
    }
#[no_mangle]
pub unsafe extern "C" fn sclp_early_get_core_info(info: *mut sclp_core_info) -> int __init {
    int __init sclp_early_get_core_info(struct sclp_core_info *info)
    {
    struct read_cpu_info_sccb *sccb;
    let mut length: c_int = test_facility(140) ? EXT_SCCB_READ_CPU : PAGE_SIZE;
    let mut rc: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn sclp_early_console_detect(sccb: *mut init_sccb) -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn sclp_early_adjust_va() -> void __init __no_sanitize_address {
    void __init __no_sanitize_address sclp_early_adjust_va(void)
    {
    sclp_early_sccb = __va((unsigned long)sclp_early_sccb);
    }
#[no_mangle]
pub unsafe extern "C" fn sclp_early_detect() -> void __init {
