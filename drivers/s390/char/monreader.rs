...
//! Source: drivers/s390/char/monreader.c
#![no_std]
...
pub const MON_COLLECT_SAMPLE: c_uint = 0x80;
pub const MON_COLLECT_EVENT: c_uint = 0x40;

pub const MON_IN_USE: c_uint = 0x01;
pub const MON_MSGLIM: c_int = 255;
...
pub struct mon_msg {
    ...
    pub msglim_reached: c_char,
    pub replied_msglim: c_char,
}
...
pub struct mon_private {
    ...
    pub msg_array: [*mut mon_msg; MON_MSGLIM],
    pub write_index: c_uint,
    pub read_index: c_uint,
    pub msglim_count: core::sync::atomic::AtomicI32,
    pub read_ready: core::sync::atomic::AtomicI32,
    pub iucv_connected: core::sync::atomic::AtomicI32,
    pub iucv_severed: core::sync::atomic::AtomicI32,
}

    let mut mon_in_use: static unsigned long = 0;
...
//
#[no_mangle]
unsafe extern "C" fn dcss_mkname(ascii_name: *mut c_char, ebcdic_name: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn mon_mca_start(monmsg: *mut mon_msg) -> c_ulong {
    static inline unsigned long mon_mca_start(struct mon_msg *monmsg)
    {
    return *(u32 *) &monmsg.msg.rmmsg;
    }
#[no_mangle]
pub unsafe extern "C" fn mon_mca_end(monmsg: *mut mon_msg) -> c_ulong {
    static inline unsigned long mon_mca_end(struct mon_msg *monmsg)
    {
    return *(u32 *) &monmsg.msg.rmmsg[4];
    }
#[no_mangle]
pub unsafe extern "C" fn mon_mca_type(monmsg: *mut mon_msg, index: u8) -> u8 {
    static inline u8 mon_mca_type(struct mon_msg *monmsg, u8 index)
    {
    return *((u8 *)__va(mon_mca_start(monmsg)) + monmsg.mca_offset + index);
    }
#[no_mangle]
pub unsafe extern "C" fn mon_mca_size(monmsg: *mut mon_msg) -> u32 {
    static inline u32 mon_mca_size(struct mon_msg *monmsg)
    {
    return mon_mca_end(monmsg) - mon_mca_start(monmsg) + 1;
    }
#[no_mangle]
pub unsafe extern "C" fn mon_rec_start(monmsg: *mut mon_msg) -> u32 {
    static inline u32 mon_rec_start(struct mon_msg *monmsg)
    {
    return *((u32 *)(__va(mon_mca_start(monmsg)) + monmsg.mca_offset + 4));
    }
#[no_mangle]
pub unsafe extern "C" fn mon_rec_end(monmsg: *mut mon_msg) -> u32 {
    static inline u32 mon_rec_end(struct mon_msg *monmsg)
    {
    return *((u32 *)(__va(mon_mca_start(monmsg)) + monmsg.mca_offset + 8));
    }
#[no_mangle]
unsafe extern "C" fn mon_check_mca(monmsg: *mut mon_msg) -> c_int {
    ...
    IUCV_IPRMDATA, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn mon_free_mem(monpriv: *mut mon_private) {
...
#[no_mangle]
pub unsafe extern "C" fn mon_next_mca(monmsg: *mut mon_msg) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_iucv_path_complete(path: *mut iucv_path, ipuser: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn mon_iucv_path_severed(path: *mut iucv_path, ipuser: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn mon_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
    ...
    MON_SERVICE, core::ptr::null_mut(), user_data_connect, monpriv);
    if (rc) {
...
#[no_mangle]
unsafe extern "C" fn mon_close(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mon_poll(filp: *mut file, p: *mut poll_table_struct) -> __poll_t {
