...
//! Source: drivers/s390/char/tape_3490.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tape_3490_block_id {
    pub 10: unsigned int unused :,
    pub 22: unsigned int block :,
}
...
//
#[no_mangle]
unsafe extern "C" fn __tape_3490_medium_sense(request: *mut tape_request) {
...
#[no_mangle]
unsafe extern "C" fn tape_3490_medium_sense(device: *mut tape_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tape_3490_medium_sense_async(device: *mut tape_device) {
    ...
    request.callback_data = core::ptr::null_mut();
    tape_do_io_async(device, request);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tape_3490_work {
...
//
    ...
    {
    struct tape_3490_work *p;
    if ((p = kzalloc_obj(*p, GFP_ATOMIC)) == core::ptr::null_mut())
    return -ENOMEM;
...
// A medium was inserted in the drive.
    ...
    tape_dump_sense_dbf(device, core::ptr::null_mut(), irb);
    }
    return TAPE_IO_SUCCESS;
    }
    static int
...
// setup ccws
    ...
    tape_ccw_end(request.cpaddr + 2, NOP, 0, core::ptr::null_mut());
// execute it
...
//
    ...
    [MTRAS1]	 = core::ptr::null_mut(),
    [MTRAS2]	 = core::ptr::null_mut(),
    [MTRAS3]	 = core::ptr::null_mut(),
    [MTSETBLK]	 = tape_std_mtsetblk,
    [MTSETDENSITY]	 = core::ptr::null_mut(),
    [MTSEEK]	 = tape_3490_mtseek,
    [MTTELL]	 = tape_3490_mttell,
    [MTSETDRVBUFFER] = core::ptr::null_mut(),
    [MTFSS]		 = core::ptr::null_mut(),
    [MTBSS]		 = core::ptr::null_mut(),
    [MTWSM]		 = core::ptr::null_mut(),
    [MTLOCK]	 = core::ptr::null_mut(),
    [MTUNLOCK]	 = core::ptr::null_mut(),
    [MTLOAD]	 = tape_std_mtload,
    [MTUNLOAD]	 = tape_std_mtunload,
    [MTCOMPRESSION]	 = tape_std_mtcompression,
    [MTSETPART]	 = core::ptr::null_mut(),
    [MTMKPART]	 = core::ptr::null_mut()
    };
//
...
#[no_mangle]
pub unsafe extern "C" fn tape_3490_init() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tape_3490_exit() {
