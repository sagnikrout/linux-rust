...
//! Source: drivers/s390/char/uvdevice.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_supp_uv_cmds(supp_uv_cmds: *mut c_ulong) -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn uvio_uvdev_info(uv_ioctl: *mut uvio_ioctl_cb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_uvio_attest(uv_ioctl: *mut uvio_ioctl_cb, uvio_attest: *mut uvio_attest) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uvio_attestation(uv_ioctl: *mut uvio_ioctl_cb) -> c_int {
    static int uvio_attestation(struct uvio_ioctl_cb *uv_ioctl)
    {
    struct uv_cb_attest *uvcb_attest = core::ptr::null_mut();
    struct uvio_attest *uvio_attest = core::ptr::null_mut();
    u8 *measurement = core::ptr::null_mut();
    u8 *add_data = core::ptr::null_mut();
    u8 *arcb = core::ptr::null_mut();
    int ret;
    ret = -EINVAL;
...
//
#[no_mangle]
unsafe extern "C" fn uvio_add_secret(uv_ioctl: *mut uvio_ioctl_cb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uvio_get_list(zpage: *mut c_void, uv_ioctl: *mut uvio_ioctl_cb) -> c_int {
    static int uvio_get_list(void *zpage, struct uvio_ioctl_cb *uv_ioctl)
    {
    let mut data_off: usize = offsetof(struct uv_secret_list, secrets);
    u8 __user *user_buf = (u8 __user *)uv_ioctl.argument_addr;
    struct uv_secret_list *list = zpage;
    let mut num_secrets_stored: u16 = 0;
    let mut user_off: usize = data_off;
    size_t copy_len;
    do {
...
//
#[no_mangle]
unsafe extern "C" fn uvio_list_secrets(uv_ioctl: *mut uvio_ioctl_cb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uvio_lock_secrets(ioctl: *mut uvio_ioctl_cb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn uvio_retr_secret(uv_ioctl: *mut uvio_ioctl_cb) -> c_int {
    ...
    let mut buf_len: u32 = uv_ioctl.argument_len;
...
//
#[no_mangle]
unsafe extern "C" fn uvio_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    static long uvio_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
    {
    void __user *argp = (void __user *)arg;
    let mut uv_ioctl: uvio_ioctl_cb = { };
    long ret;
    int nr;
...
#[no_mangle]
unsafe extern "C" fn uvio_dev_exit() -> void __exit {
    static void __exit uvio_dev_exit(void)
    {
    misc_deregister(&uvio_dev_miscdev);
    }
#[no_mangle]
unsafe extern "C" fn uvio_dev_init() -> int __init {
