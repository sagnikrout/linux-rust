...
//! Source: drivers/s390/scsi/zfcp_aux.c
#![no_std]
...
pub const ZFCP_BUS_ID_SIZE: c_int = 20;
    ...
    unsigned long size)
    {
    return kmem_cache_create(name, size, roundup_pow_of_two(size), 0, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn zfcp_init_device_configure(busid: *mut c_char, wwpn: u64, lun: u64) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn zfcp_init_device_setup(devstr: *mut c_char) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn zfcp_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn zfcp_module_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn zfcp_allocate_low_mem_buffers(adapter: *mut zfcp_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zfcp_free_low_mem_buffers(adapter: *mut zfcp_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_status_read_refill(adapter: *mut zfcp_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _zfcp_status_read_scheduler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_version_change_lost_work(work: *mut work_struct) {
    static void zfcp_version_change_lost_work(struct work_struct *work)
    {
    struct zfcp_adapter *adapter = container_of(work, struct zfcp_adapter,
    version_change_lost_work);
    zfcp_fsf_exchange_config_data_sync(adapter.qdio, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn zfcp_print_sl(m: *mut seq_file, sl: *mut service_level) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_setup_adapter_work_queue(adapter: *mut zfcp_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zfcp_destroy_adapter_work_queue(adapter: *mut zfcp_adapter) {
    static void zfcp_destroy_adapter_work_queue(struct zfcp_adapter *adapter)
    {
    if (adapter.work_queue)
    destroy_workqueue(adapter.work_queue);
    adapter.work_queue = core::ptr::null_mut();
    }
//
...
//
    ...
    ccw_device.handler = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn zfcp_adapter_unregister(adapter: *mut zfcp_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_adapter_release(ref: *mut kref) {
    void zfcp_adapter_release(struct kref *ref)
    {
    struct zfcp_adapter *adapter = container_of(ref, struct zfcp_adapter,
    ref);
    struct ccw_device *cdev = adapter.ccw_device;
    dev_set_drvdata(&adapter.ccw_device.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn zfcp_port_release(dev: *mut device) {
