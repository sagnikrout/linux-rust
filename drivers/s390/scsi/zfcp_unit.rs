...
//! Source: drivers/s390/scsi/zfcp_unit.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_unit_scsi_scan(unit: *mut zfcp_unit) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_unit_scsi_scan_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_unit_queue_scsi_scan(port: *mut zfcp_port) {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_unit_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_unit_add(port: *mut zfcp_port, fcp_lun: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_unit_sdev_status(unit: *mut zfcp_unit) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_unit_remove(port: *mut zfcp_port, fcp_lun: u64) -> c_int {
