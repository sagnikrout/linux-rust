...
//! Source: drivers/s390/scsi/zfcp_ccw.c
#![no_std]
...
pub const ZFCP_MODEL_PRIV: c_uint = 0x4;
...
#[no_mangle]
pub unsafe extern "C" fn zfcp_ccw_adapter_put(adapter: *mut zfcp_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_ccw_activate(cdev: *mut ccw_device, clear: c_int, tag: *mut c_char) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_ccw_probe(cdev: *mut ccw_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_ccw_remove(cdev: *mut ccw_device) {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_ccw_set_online(cdev: *mut ccw_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_ccw_set_offline(cdev: *mut ccw_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_ccw_notify(cdev: *mut ccw_device, event: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_ccw_shutdown(cdev: *mut ccw_device) {
