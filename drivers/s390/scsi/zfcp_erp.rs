...
//! Source: drivers/s390/scsi/zfcp_erp.c
#![no_std]
...
pub const ZFCP_MAX_ERPS: c_int = 3;
...
//
pub const ZFCP_ERP_ACTION_NONE: c_uint = 0xc0;
//
// Eyecatcher pseudo flag to bitwise or-combine with enum zfcp_erp_act_type.
// Used to indicate that ERP not needed because the object has
// ZFCP_STATUS_COMMON_ERP_FAILED.
//
pub const ZFCP_ERP_ACTION_FAILED: c_uint = 0xe0;
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_adapter_block(adapter: *mut zfcp_adapter, mask: c_int) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_action_is_running(act: *mut zfcp_erp_action) -> bool {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_action_ready(act: *mut zfcp_erp_action) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_action_dismiss(act: *mut zfcp_erp_action) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_action_dismiss_lun(sdev: *mut scsi_device) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_action_dismiss_port(port: *mut zfcp_port) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_action_dismiss_adapter(adapter: *mut zfcp_adapter) {
    ...
    {
    let mut need: enum zfcp_erp_act_type = want;
...
// ensure propagation of failed status to new devices
    ...
    WARN_ON_ONCE(erp_action.port != port);
    WARN_ON_ONCE(erp_action.sdev != core::ptr::null_mut());
    ...
    WARN_ON_ONCE(erp_action.port != core::ptr::null_mut());
    WARN_ON_ONCE(erp_action.sdev != core::ptr::null_mut());
    if (!(atomic_read(&adapter.status) &
    ZFCP_STATUS_COMMON_RUNNING))
    act_status |= ZFCP_STATUS_ERP_CLOSE_ONLY;
...
//
    ...
    zfcp_dbf_rec_trig(dbftag, adapter, &tmpport, core::ptr::null_mut(),
    ...
    adapter, core::ptr::null_mut(), core::ptr::null_mut(), dbftag, 0);
    }
//
...
//
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), dbftag, 0);
    write_unlock_irqrestore(&adapter.erp_lock, flags);
    }
//
...
//
    ...
    char *dbftag)
    {
    let mut flags: c_int = ZFCP_STATUS_COMMON_RUNNING | ZFCP_STATUS_COMMON_ERP_FAILED;
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_port_shutdown(port: *mut zfcp_port, clear: c_int, dbftag: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_port_block(port: *mut zfcp_port, clear: c_int) {
    ...
    port.adapter, port, core::ptr::null_mut(), dbftag, 0);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_port_reopen(port: *mut zfcp_port, clear: c_int, dbftag: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_lun_block(sdev: *mut scsi_device, clear_mask: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_lun_reopen(sdev: *mut scsi_device, clear: c_int, dbftag: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_lun_shutdown(sdev: *mut scsi_device, clear: c_int, dbftag: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_lun_shutdown_wait(sdev: *mut scsi_device, dbftag: *mut c_char) {
    ...
    struct zfcp_port *port = zfcp_sdev.port;
    struct zfcp_adapter *adapter = port.adapter;
    let mut clear: c_int = ZFCP_STATUS_COMMON_RUNNING | ZFCP_STATUS_COMMON_ERP_FAILED;
    write_lock_irqsave(&adapter.erp_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_status_change_set(mask: c_ulong, status: *mut core::sync::atomic::AtomicI32) -> c_int {
    static int zfcp_erp_status_change_set(unsigned long mask, atomic_t *status)
    {
    return (atomic_read(status) ^ mask) & mask;
    }
#[no_mangle]
unsafe extern "C" fn zfcp_erp_adapter_unblock(adapter: *mut zfcp_adapter) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_port_unblock(port: *mut zfcp_port) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_lun_unblock(sdev: *mut scsi_device) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_action_to_running(erp_action: *mut zfcp_erp_action) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_strategy_check_fsfreq(act: *mut zfcp_erp_action) {
...
//
    WRITE_ONCE(req.erp_action, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_notify(erp_action: *mut zfcp_erp_action, set_mask: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_timeout_handler(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_memwait_handler(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_strategy_memwait(erp_action: *mut zfcp_erp_action) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_strategy_followup_failed(act: *mut zfcp_erp_action) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_strategy_followup_success(act: *mut zfcp_erp_action) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_wakeup(adapter: *mut zfcp_adapter) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_enqueue_ptp_port(adapter: *mut zfcp_adapter) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_adapter_strategy_close(act: *mut zfcp_erp_action) {
...
// all ports and LUNs are closed
    ...
    let mut status: c_int = atomic_read(&port.status);
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_open_ptp_port(act: *mut zfcp_erp_action) -> c_int {
    ...
    struct zfcp_adapter *adapter = act.adapter;
    struct zfcp_port *port = act.port;
    let mut p_status: c_int = atomic_read(&port.status);
    switch (act.step) {
    case ZFCP_ERP_STEP_UNINITIALIZED:
    case ZFCP_ERP_STEP_PHYS_PORT_CLOSING:
    case ZFCP_ERP_STEP_PORT_CLOSING:
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_lun_strategy_clearstati(sdev: *mut scsi_device) {
    ...
    struct zfcp_erp_action *erp_action)
    {
    let mut retval: c_int = zfcp_fsf_close_lun(erp_action);
    if (retval == -ENOMEM)
    return ZFCP_ERP_NOMEM;
    ...
    struct zfcp_erp_action *erp_action)
    {
    let mut retval: c_int = zfcp_fsf_open_lun(erp_action);
    if (retval == -ENOMEM)
    return ZFCP_ERP_NOMEM;
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_strat_change_det(target_status: *mut core::sync::atomic::AtomicI32, erp_status: u32) -> c_int {
    static int zfcp_erp_strat_change_det(atomic_t *target_status, u32 erp_status)
    {
    let mut status: c_int = atomic_read(target_status);
    ...
    {
    let mut type: enum zfcp_erp_act_type = act.type;
    struct zfcp_adapter *adapter = act.adapter;
    struct zfcp_port *port = act.port;
    struct scsi_device *sdev = act.sdev;
    struct zfcp_scsi_dev *zfcp_sdev;
    let mut erp_status: u32 = act.status;
    switch (type) {
    case ZFCP_ERP_ACTION_REOPEN_ADAPTER:
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_action_dequeue(erp_action: *mut zfcp_erp_action) {
...
//
#[no_mangle]
unsafe extern "C" fn zfcp_erp_try_rport_unblock(port: *mut zfcp_port) {
...
#[no_mangle]
unsafe extern "C" fn zfcp_erp_thread(data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_thread_setup(adapter: *mut zfcp_adapter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_thread_kill(adapter: *mut zfcp_adapter) {
    void zfcp_erp_thread_kill(struct zfcp_adapter *adapter)
    {
    kthread_stop(adapter.erp_thread);
    adapter.erp_thread = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_wait(adapter: *mut zfcp_adapter) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_set_adapter_status(adapter: *mut zfcp_adapter, mask: u32) {
    void zfcp_erp_set_adapter_status(struct zfcp_adapter *adapter, u32 mask)
    {
    struct zfcp_port *port;
    struct scsi_device *sdev;
    unsigned long flags;
    let mut common_mask: u32 = mask & ZFCP_COMMON_FLAGS;
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_clear_adapter_status(adapter: *mut zfcp_adapter, mask: u32) {
    ...
    unsigned long flags;
    let mut common_mask: u32 = mask & ZFCP_COMMON_FLAGS;
    let mut clear_counter: u32 = mask & ZFCP_STATUS_COMMON_ERP_FAILED;
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_set_port_status(port: *mut zfcp_port, mask: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_clear_port_status(port: *mut zfcp_port, mask: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_set_lun_status(sdev: *mut scsi_device, mask: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_clear_lun_status(sdev: *mut scsi_device, mask: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zfcp_erp_adapter_reset_sync(adapter: *mut zfcp_adapter, dbftag: *mut c_char) {
