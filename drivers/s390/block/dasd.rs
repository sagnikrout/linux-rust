...
//! Source: drivers/s390/block/dasd.c
#![no_std]
...
//
pub const DASD_CHANQ_MAX_SIZE: c_int = 4;
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_free_device(device: *mut dasd_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_free_block(block: *mut dasd_block) {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_state_new_to_known(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_state_known_to_new(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_state_known_to_basic(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_state_basic_to_known(device: *mut dasd_device) -> c_int {
    ...
    if (device.debug_area != core::ptr::null_mut()) {
    debug_unregister(device.debug_area);
    device.debug_area = core::ptr::null_mut();
    }
    device.state = DASD_STATE_KNOWN;
    return 0;
    }
...
//
#[no_mangle]
unsafe extern "C" fn dasd_state_basic_to_ready(device: *mut dasd_device) -> c_int {
...
// make disk known with correct capacity
    ...
    if (block.base.discipline.do_analysis != core::ptr::null_mut())
...
// Calculate max_discard_sectors and make it PAGE aligned
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn _wait_for_empty_queues(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_state_ready_to_basic(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_state_unfmt_to_basic(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_state_online_to_ready(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_increase_state(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_decrease_state(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_change_state(device: *mut dasd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn do_kick_device(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_kick_device(device: *mut dasd_device) {
...
//
#[no_mangle]
unsafe extern "C" fn do_reload_device(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_reload_device(device: *mut dasd_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_set_target_state(device: *mut dasd_device, target: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn _wait_for_device(device: *mut dasd_device) -> c_int {
    static inline int _wait_for_device(struct dasd_device *device)
    {
    return (device.state == device.target);
    }
#[no_mangle]
pub unsafe extern "C" fn dasd_enable_device(device: *mut dasd_device) {
...
//
    let mut dasd_global_profile_level: c_uint = DASD_PROFILE_OFF;
...
#[no_mangle]
pub unsafe extern "C" fn dasd_profile_reset(profile: *mut dasd_profile) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_profile_on(profile: *mut dasd_profile) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_profile_off(profile: *mut dasd_profile) {
    void dasd_profile_off(struct dasd_profile *profile)
    {
    spin_lock_bh(&profile.lock);
    kfree(profile.data);
    profile.data = core::ptr::null_mut();
    spin_unlock_bh(&profile.lock);
    }
...
#[no_mangle]
unsafe extern "C" fn dasd_stats_array(m: *mut seq_file, array: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn dasd_stats_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dasd_stats_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dasd_profile_exit(profile: *mut dasd_profile) {
    static void dasd_profile_exit(struct dasd_profile *profile)
    {
    dasd_profile_off(profile);
    debugfs_remove(profile.dentry);
    profile.dentry = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dasd_statistics_removeroot() {
...
#[no_mangle]
unsafe extern "C" fn dasd_statistics_createroot() {
    static void dasd_statistics_createroot(void)
    {
    dasd_debugfs_root_entry = debugfs_create_dir("dasd", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dasd_hosts_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dasd_hosts_exit(device: *mut dasd_device) {
    static void dasd_hosts_exit(struct dasd_device *device)
    {
    debugfs_remove(device.hosts_dentry);
    device.hosts_dentry = core::ptr::null_mut();
    }
    ...
    cqr.cpaddr = core::ptr::null_mut();
    if (cplength > 0) {
    cqr.cpaddr = data;
    data += cplength * sizeof(struct ccw1);
    memset(cqr.cpaddr, 0, cplength * sizeof(struct ccw1));
    }
    cqr.data = core::ptr::null_mut();
    if (datasize > 0) {
    cqr.data = data;
    memset(cqr.data, 0, datasize);
    }
...
#[no_mangle]
pub unsafe extern "C" fn dasd_sfree_request(cqr: *mut dasd_ccw_req, device: *mut dasd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_ffree_request(cqr: *mut dasd_ccw_req, device: *mut dasd_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_check_cqr(cqr: *mut dasd_ccw_req) -> c_int {
    static inline int dasd_check_cqr(struct dasd_ccw_req *cqr)
    {
    struct dasd_device *device;
    if (cqr == core::ptr::null_mut())
    return -EINVAL;
    device = cqr.startdev;
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_term_IO(cqr: *mut dasd_ccw_req) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_start_IO(cqr: *mut dasd_ccw_req) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_device_timeout(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_device_set_timer(device: *mut dasd_device, expires: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_device_clear_timer(device: *mut dasd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_handle_state_change(device: *mut dasd_device) {
...
#[no_mangle]
unsafe extern "C" fn dasd_check_hpf_error(irb: *mut irb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dasd_ese_needs_format(block: *mut dasd_block, irb: *mut irb) -> c_int {
    static int dasd_ese_needs_format(struct dasd_block *block, struct irb *irb)
    {
    struct dasd_device *device = core::ptr::null_mut();
    u8 *sense = core::ptr::null_mut();
    if (!block)
    return 0;
    device = block.base;
...
#[no_mangle]
unsafe extern "C" fn dasd_ese_oos_cond(sense: *mut u8) -> c_int {
...
//
    ...
    struct dasd_device *device;
    unsigned long now;
    let mut nrf_suppressed: c_int = 0;
    let mut it_suppressed: c_int = 0;
    struct request *req;
    u8 *sense = core::ptr::null_mut();
    int expires;
    cqr = (struct dasd_ccw_req *) intparm;
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_uc_handler(cdev: *mut ccw_device, irb: *mut irb) -> enum uc_todo {
    ...
    device.discipline.check_for_device_change(device, core::ptr::null_mut(), irb);
    dasd_put_device(device);
    out:
...
// without its wakeup.
//
    cqr.callback = core::ptr::null_mut();
    break;
    default:
    dev_err(&device.cdev.dev,
...
//
#[no_mangle]
unsafe extern "C" fn __dasd_device_check_expire(device: *mut dasd_device) {
...
//
    ...
    struct dasd_ccw_req *cqr)
    {
    let mut mask: c_int = ~(DASD_STOPPED_DC_WAIT | DASD_STOPPED_NOSPC);
    if (test_bit(DASD_FLAG_OFFLINE, &device.flags) &&
...
//
#[no_mangle]
unsafe extern "C" fn __dasd_device_start_head(device: *mut dasd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(-EACCES: rc ==) -> else {
    dasd_schedule_device_bh(device);
    } else
...
#[no_mangle]
unsafe extern "C" fn __dasd_device_check_path_events(device: *mut dasd_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_flush_device_queue(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_device_tasklet(data: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_schedule_device_bh(device: *mut dasd_device) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_device_set_stop_bits(device: *mut dasd_device, bits: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_device_remove_stop_bits(device: *mut dasd_device, bits: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_add_request_head(cqr: *mut dasd_ccw_req) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_add_request_tail(cqr: *mut dasd_ccw_req) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_wakeup_cb(cqr: *mut dasd_ccw_req, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn _wait_for_wakeup(cqr: *mut dasd_ccw_req) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __dasd_sleep_on_erp(cqr: *mut dasd_ccw_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __dasd_sleep_on_loop_condition(cqr: *mut dasd_ccw_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _dasd_sleep_on(maincqr: *mut dasd_ccw_req, interruptible: c_int) -> c_int {
...
// wait (non-interruptible) for final status
    ...
    rc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: maincqr->intrc) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn _wait_for_wakeup_queue(ccw_queue: *mut list_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _dasd_sleep_on_queue(ccw_queue: *mut list_head, interruptible: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_sleep_on(cqr: *mut dasd_ccw_req) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_sleep_on_queue(ccw_queue: *mut list_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_sleep_on_queue_interruptible(ccw_queue: *mut list_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_sleep_on_interruptible(cqr: *mut dasd_ccw_req) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn _dasd_term_running_cqr(device: *mut dasd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_sleep_on_immediatly(cqr: *mut dasd_ccw_req) -> c_int {
...
// let the bh start the request to keep them in order
    ...
    rc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cqr->intrc) -> else {
    else if (cqr.intrc)
    rc = cqr.intrc;
    else
    rc = -EIO;
...
//
#[no_mangle]
unsafe extern "C" fn __dasd_cancel_req(cqr: *mut dasd_ccw_req) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_cancel_req(cqr: *mut dasd_ccw_req) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_block_timeout(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_block_set_timer(block: *mut dasd_block, expires: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_block_clear_timer(block: *mut dasd_block) {
...
#[no_mangle]
pub unsafe extern "C" fn if(DASD_CQR_ABORTED: cqr->status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn __dasd_cleanup_cqr(cqr: *mut dasd_ccw_req) {
    static void __dasd_cleanup_cqr(struct dasd_ccw_req *cqr)
    {
    struct request *req;
    let mut error: blk_status_t = BLK_STS_OK;
...
#[no_mangle]
unsafe extern "C" fn dasd_return_cqr_cb(cqr: *mut dasd_ccw_req, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __dasd_block_start_head(block: *mut dasd_block) {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_block_tasklet(data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn _dasd_wake_block_flush_cb(cqr: *mut dasd_ccw_req, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn _dasd_requeue_request(cqr: *mut dasd_ccw_req) {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_flush_block_queue(block: *mut dasd_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_schedule_block_bh(block: *mut dasd_block) {
...
//
    ...
    struct dasd_ccw_req *cqr;
    let mut rc: blk_status_t = BLK_STS_OK;
    let mut complete_noop: bool = false;
    basedev = block.base;
    spin_lock_irq(&dq.lock);
...
// build_cp may collapse a non-transient build error to NULL
    DBF_DEV_EVENT(DBF_ERR, basedev,
    "CCW creation returned core::ptr::null_mut() on request %p", req);
    rc = BLK_STS_IOERR;
    goto out;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_times_out(req: *mut request) -> enum blk_eh_timer_return {
...
#[no_mangle]
unsafe extern "C" fn dasd_exit_hctx(hctx: *mut blk_mq_hw_ctx, idx: c_uint) {
    static void dasd_exit_hctx(struct blk_mq_hw_ctx *hctx, unsigned int idx)
    {
    kfree(hctx.driver_data);
    hctx.driver_data = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn dasd_request_done(req: *mut request) {
...
#[no_mangle]
unsafe extern "C" fn dasd_open(disk: *mut gendisk, mode: blk_mode_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dasd_release(disk: *mut gendisk) {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_getgeo(disk: *mut gendisk, geo: *mut hd_geometry) -> c_int {
...
//
    ...
    dasd_page_cache = core::ptr::null_mut();
    dasd_gendisk_exit();
    dasd_devmap_exit();
    if (dasd_debug_area != core::ptr::null_mut()) {
    debug_unregister(dasd_debug_area);
    dasd_debug_area = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_device_is_ro(device: *mut dasd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dasd_generic_auto_online(data: *mut c_void, cookie: async_cookie_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_probe(cdev: *mut ccw_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_free_discipline(device: *mut dasd_device) {
...
// Forget the discipline information.
    ...
    device.discipline = core::ptr::null_mut();
    }
    if (device.base_discipline) {
    module_put(device.base_discipline.owner);
    device.base_discipline = core::ptr::null_mut();
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_remove(cdev: *mut ccw_device) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_set_offline(cdev: *mut ccw_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_last_path_gone(device: *mut dasd_device) -> c_int {
...
// First call extended error reporting and check for autoquiesce.
    dasd_handle_autoquiesce(device, core::ptr::null_mut(), DASD_EER_NOPATH);
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_path_operational(device: *mut dasd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_notify(cdev: *mut ccw_device, event: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_path_event(cdev: *mut ccw_device, path_event: *mut c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_verify_path(device: *mut dasd_device, lpm: __u8) -> c_int {
    ...
    {
// First call extended error reporting and check for autoquiesce.
    dasd_handle_autoquiesce(device, core::ptr::null_mut(), DASD_EER_NOSPC);
    if (device.state < DASD_STATE_BASIC)
    return;
    if (cqr.status == DASD_CQR_IN_IO ||
    cqr.status == DASD_CQR_CLEAR_PENDING) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_space_avail(device: *mut dasd_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_requeue_all_requests(device: *mut dasd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn do_requeue_requests(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_schedule_requeue(device: *mut dasd_device) {
...
// notify eer about autoquiesce
    if (dasd_eer_enabled(device))
    dasd_eer_write(device, core::ptr::null_mut(), DASD_EER_AUTOQUIESCE);
...
//
    ...
    {
    struct tsb *tsb = core::ptr::null_mut();
    char *sense = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn dasd_generic_shutdown(cdev: *mut ccw_device) {
...
#[no_mangle]
unsafe extern "C" fn dasd_init() -> int __init {
...
// register 'common' DASD debug area, used for all DBF_XXX calls
    ...
    dasd_diag_discipline_pointer = core::ptr::null_mut();
