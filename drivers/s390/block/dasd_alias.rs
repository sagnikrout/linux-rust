...
//! Source: drivers/s390/block/dasd_alias.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn _free_server(server: *mut alias_server) {
...
#[no_mangle]
unsafe extern "C" fn _free_lcu(lcu: *mut alias_lcu) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_alias_make_device_known_to_lcu(device: *mut dasd_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_alias_disconnect_device_from_lcu(device: *mut dasd_device) {
...
// make sure that the workers don't use this device
    ...
    lcu.suc_data.device = core::ptr::null_mut();
    }
    }
    was_pending = 0;
    ...
    if (device == lcu.ruac_data.device) {
    dasd_put_device(device);
    lcu.ruac_data.device = core::ptr::null_mut();
    }
    }
    private.lcu = core::ptr::null_mut();
    spin_unlock_irqrestore(&lcu.lock, flags);
    spin_lock_irqsave(&aliastree.lock, flags);
    spin_lock(&lcu.lock);
    ...
    spin_unlock(&lcu.lock);
    _free_lcu(lcu);
    lcu = core::ptr::null_mut();
    } else {
    if (was_pending)
    _schedule_lcu_update(lcu, core::ptr::null_mut());
    spin_unlock(&lcu.lock);
    }
    server = _find_server(&uid);
...
// if we have no PAV anyway, we don't need to bother with PAV groups
    ...
    if (!group)
    return;
    private.pavgroup = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn _lcu_update(refdev: *mut dasd_device, lcu: *mut alias_lcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lcu_update_work(work: *mut work_struct) {
...
//
    ...
    struct dasd_device *device)
    {
    struct dasd_device *usedev = core::ptr::null_mut();
    struct alias_pav_group *group;
    lcu.flags |= NEED_UAC_UPDATE;
...
// already scheduled or running
    ...
    alias_list);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !list_empty(&group->aliaslist)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_alias_add_device(device: *mut dasd_device) -> c_int {
    int dasd_alias_add_device(struct dasd_device *device)
    {
    struct dasd_eckd_private *private = device.private;
    let mut uaddr: __u8 = private.uid.real_unit_addr;
...
#[no_mangle]
pub unsafe extern "C" fn dasd_alias_update_add_device(device: *mut dasd_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_alias_remove_device(device: *mut dasd_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _restart_all_base_devices_on_lcu(lcu: *mut alias_lcu) {
...
#[no_mangle]
unsafe extern "C" fn flush_all_alias_devices_on_lcu(lcu: *mut alias_lcu) {
...
#[no_mangle]
unsafe extern "C" fn _stop_all_devices_on_lcu(lcu: *mut alias_lcu) {
...
#[no_mangle]
unsafe extern "C" fn _unstop_all_devices_on_lcu(lcu: *mut alias_lcu) {
...
#[no_mangle]
unsafe extern "C" fn summary_unit_check_handling_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn dasd_alias_handle_summary_unit_check(work: *mut work_struct) {
