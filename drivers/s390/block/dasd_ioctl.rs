...
//! Source: drivers/s390/block/dasd_ioctl.c
#![no_std]
...
//
    ...
    {
    let mut ver: c_int = DASD_API_VERSION;
...
//
#[no_mangle]
unsafe extern "C" fn dasd_ioctl_quiesce(block: *mut dasd_block) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_ioctl_resume(block: *mut dasd_block) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_ioctl_abortio(block: *mut dasd_block) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_ioctl_allowio(block: *mut dasd_block) -> c_int {
...
//
    ...
    int rc;
    base = block.base;
    if (base.discipline.format_device == core::ptr::null_mut())
    return -EPERM;
...
//
#[no_mangle]
unsafe extern "C" fn dasd_ioctl_check_format(bdev: *mut block_device, argp: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_ioctl_release_space(bdev: *mut block_device, argp: *mut void __user) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_ioctl_reset_profile(block: *mut dasd_block) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dasd_ioctl_read_profile(block: *mut dasd_block, argp: *mut void __user) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_set_read_only(bdev: *mut block_device, ro: bool) -> c_int {
...
// do not manipulate hardware state for partitions
    ...
    {
    let mut size: usize = _IOC_SIZE(cmd);
    struct cmbdata data;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn dasd_biodasdinfo(disk: *mut gendisk, info: *mut dasd_information2_t) -> c_int {
