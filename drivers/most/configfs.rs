...
//! Source: drivers/most/configfs.c
#![no_std]
...
pub const MAX_STRING_SIZE: c_int = 80;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mdev_link {
    pub item: config_item,
    pub list: list_head,
    pub create_link: bool,
    pub destroy_link: bool,
    pub num_buffers: u16,
    pub buffer_size: u16,
    pub subbuffer_size: u16,
    pub packets_per_xact: u16,
    pub dbr_size: u16,
    pub datatype: [c_char; MAX_STRING_SIZE],
    pub direction: [c_char; MAX_STRING_SIZE],
    pub name: [c_char; MAX_STRING_SIZE],
    pub device: [c_char; MAX_STRING_SIZE],
    pub channel: [c_char; MAX_STRING_SIZE],
    pub comp: [c_char; MAX_STRING_SIZE],
    pub comp_params: [c_char; MAX_STRING_SIZE],
}

    static struct list_head mdev_link_list;
#[no_mangle]
unsafe extern "C" fn set_cfg_buffer_size(link: *mut mdev_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_cfg_subbuffer_size(link: *mut mdev_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_cfg_dbr_size(link: *mut mdev_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_cfg_num_buffers(link: *mut mdev_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_cfg_packets_xact(link: *mut mdev_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_cfg_direction(link: *mut mdev_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_cfg_datatype(link: *mut mdev_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_config_and_add_link(mdev_link: *mut mdev_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_direction_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_datatype_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_device_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_channel_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_comp_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_comp_params_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_num_buffers_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_buffer_size_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_dbr_size_show(item: *mut config_item, page: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn mdev_link_release(item: *mut config_item) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct most_common {
    pub group: config_group,
    pub mod: *mut module,
    pub subsys: configfs_subsystem,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(group->cg_item.ci_namebuf, _arg: "most_net")) -> else {
    else if (!strcmp(group.cg_item.ci_namebuf, "most_net"))
    strcpy(mdev_link.comp, "net");
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(group->cg_item.ci_namebuf, _arg: "most_video")) -> else {
...
#[no_mangle]
unsafe extern "C" fn most_common_release(item: *mut config_item) {
...
#[no_mangle]
unsafe extern "C" fn most_snd_grp_release(item: *mut config_item) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct most_sound {
    pub subsys: configfs_subsystem,
    pub soundcard_list: list_head,
    pub mod: *mut module,
}
...
#[no_mangle]
pub unsafe extern "C" fn most_register_configfs_subsys(c: *mut most_component) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_interface_register_notify(mdev: *const c_char) {
    void most_interface_register_notify(const char *mdev)
    {
    let mut register_snd_card: bool = false;
    struct mdev_link *mdev_link;
