...
pub const MAX_CHANNELS: c_int = 64;
pub const STRING_SIZE: c_int = 80;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct most_channel {
    pub dev: device,
    pub cleanup: completion,
    pub mbo_ref: core::sync::atomic::AtomicI32,
    pub mbo_nq_level: core::sync::atomic::AtomicI32,
    pub channel_id: u16,
    pub name: [c_char; STRING_SIZE],
    pub is_poisoned: bool,
    pub /: *mut *mut mutex start_mutex; / channel activation synchronization,
    pub /: *mut *mut mutex nq_mutex; / nq thread synchronization,
    pub is_starving: c_int,
    pub iface: *mut most_interface,
    pub cfg: most_channel_config,
    pub keep_mbo: bool,
    pub enqueue_halt: bool,
    pub fifo: list_head,
    pub /: *mut *mut spinlock_t fifo_lock; / fifo access synchronization,
    pub halt_fifo: list_head,
    pub list: list_head,
    pub pipe0: pipe,
    pub pipe1: pipe,
    pub trash_fifo: list_head,
    pub hdm_enqueue_task: *mut task_struct,
    pub hdm_fifo_wq: wait_queue_head_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct interface_private {
    pub dev_id: c_int,
    pub name: [c_char; STRING_SIZE],
    pub channel: [*mut most_channel; MAX_CHANNELS],
...
//
#[no_mangle]
unsafe extern "C" fn most_free_mbo_coherent(mbo: *mut mbo) {
    static void most_free_mbo_coherent(struct mbo *mbo)
    {
    struct most_channel *c = mbo.context;
    let mut coherent_buf_size: u16 const = c.cfg.buffer_size + c.cfg.extra_len;
    if (c.iface.dma_free)
...
//
#[no_mangle]
unsafe extern "C" fn flush_channel_fifos(c: *mut most_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn flush_trash_fifo(c: *mut most_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MOST_CH_RX: c->cfg.direction &) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct show_links_data {
    pub offs: c_int,
    pub buf: *mut c_char,
}

#[no_mangle]
unsafe extern "C" fn print_links(dev: *mut device, data: *mut c_void) -> c_int {
    static int print_links(struct device *dev, void *data)
    {
    struct show_links_data *d = data;
    let mut offs: c_int = d.offs;
    char *buf = d.buf;
...
#[no_mangle]
unsafe extern "C" fn most_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn links_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
    static ssize_t links_show(struct device_driver *drv, char *buf)
    {
    let mut d: show_links_data = { .buf = buf };
    bus_for_each_dev(&mostbus, core::ptr::null_mut(), &d, print_links);
    return d.offs;
    }
#[no_mangle]
unsafe extern "C" fn components_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
//
    ...
    dev = bus_find_device_by_name(&mostbus, core::ptr::null_mut(), mdev);
    if (!dev)
    return core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !c->pipe1.comp) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn most_set_cfg_buffer_size(mdev: *mut c_char, mdev_ch: *mut c_char, val: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_set_cfg_subbuffer_size(mdev: *mut c_char, mdev_ch: *mut c_char, val: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_set_cfg_dbr_size(mdev: *mut c_char, mdev_ch: *mut c_char, val: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_set_cfg_num_buffers(mdev: *mut c_char, mdev_ch: *mut c_char, val: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_set_cfg_datatype(mdev: *mut c_char, mdev_ch: *mut c_char, buf: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_set_cfg_direction(mdev: *mut c_char, mdev_ch: *mut c_char, buf: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_set_cfg_packets_xact(mdev: *mut c_char, mdev_ch: *mut c_char, val: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_cfg_complete(comp_name: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn most_remove_link(mdev: *mut c_char, mdev_ch: *mut c_char, comp_name: *mut c_char) -> c_int {
    ...
    c.pipe0.comp = core::ptr::null_mut();
    if (c.pipe1.comp == comp)
    c.pipe1.comp = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn trash_mbo(mbo: *mut mbo) {
...
#[no_mangle]
unsafe extern "C" fn hdm_mbo_ready(c: *mut most_channel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nq_hdm_mbo(mbo: *mut mbo) {
...
#[no_mangle]
unsafe extern "C" fn hdm_enqueue_thread(data: *mut c_void) -> c_int {
    ...
    nq_hdm_mbo(mbo);
    c.hdm_enqueue_task = core::ptr::null_mut();
    return 0;
    }
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn run_enqueue_thread(c: *mut most_channel, channel_id: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arm_mbo(mbo: *mut mbo) {
...
//
    ...
    struct mbo *mbo;
    unsigned long flags;
    let mut coherent_buf_size: u32 = c.cfg.buffer_size + c.cfg.extra_len;
...
//
#[no_mangle]
pub unsafe extern "C" fn most_submit_mbo(mbo: *mut mbo) {
...
//
#[no_mangle]
unsafe extern "C" fn most_write_completion(mbo: *mut mbo) {
...
#[no_mangle]
pub unsafe extern "C" fn if(c->pipe1.comp: comp ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn most_put_mbo(mbo: *mut mbo) {
...
//
#[no_mangle]
unsafe extern "C" fn most_read_completion(mbo: *mut mbo) {
...
//
#[no_mangle]
pub unsafe extern "C" fn most_register_component(comp: *mut most_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disconnect_channels(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn most_deregister_component(comp: *mut most_component) -> c_int {
    ...
    bus_for_each_dev(&mostbus, core::ptr::null_mut(), comp, disconnect_channels);
    list_del(&comp.list);
    return 0;
    }
    EXPORT_SYMBOL_GPL(most_deregister_component);
#[no_mangle]
unsafe extern "C" fn release_channel(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn most_register_interface(iface: *mut most_interface) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn most_deregister_interface(iface: *mut most_interface) {
...
//
#[no_mangle]
pub unsafe extern "C" fn most_stop_enqueue(iface: *mut most_interface, id: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn most_resume_enqueue(iface: *mut most_interface, id: c_int) {
...
#[no_mangle]
unsafe extern "C" fn most_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn most_exit() -> void __exit {
