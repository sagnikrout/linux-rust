...
//! Source: drivers/most/most_snd.c
#![no_std]
...
pub struct channel {
    ...
    pub pcm_hardware: snd_pcm_hardware,
    pub iface: *mut most_interface,
    pub cfg: *mut most_channel_config,
    pub card: *mut snd_card,
    pub list: list_head,
    pub id: c_int,
    pub period_pos: c_uint,
    pub buffer_pos: c_uint,
    pub is_stream_running: bool,
    pub playback_task: *mut task_struct,
    pub playback_waitq: wait_queue_head_t,
    pub bytes): *mut *mut *mut *mut void (copy_fn)(void alsa, void most, unsigned int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sound_adapter {
    pub dev_list: list_head,
    pub iface: *mut most_interface,
    pub card: *mut snd_card,
    pub list: list_head,
    pub registered: bool,
    pub pcm_dev_idx: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn swap_copy16(dest: *mut u16, source: *const u16, bytes: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn swap_copy24(dest: *mut u8, source: *const u8, bytes: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn swap_copy32(dest: *mut u32, source: *const u32, bytes: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn copy_data(channel: *mut channel, mbo: *mut mbo) -> bool {
    static bool copy_data(struct channel *channel, struct mbo *mbo)
    {
    let mut runtime: *mut snd_pcm_runtime const = channel.substream.runtime;
    let mut frame_bytes: unsigned int const = channel.cfg.subbuffer_size;
    let mut buffer_size: unsigned int const = runtime.buffer_size;
    unsigned int frames;
    unsigned int fr0;
...
//
#[no_mangle]
unsafe extern "C" fn playback_thread(data: *mut c_void) -> c_int {
    static int playback_thread(void *data)
    {
    let mut channel: *mut channel const = data;
    while (!kthread_should_stop()) {
    struct mbo *mbo = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn pcm_prepare(substream: *mut snd_pcm_substream) -> c_int {
    static int pcm_prepare(struct snd_pcm_substream *substream)
    {
    struct channel *channel = substream.private_data;
    struct snd_pcm_runtime *runtime = substream.runtime;
    struct most_channel_config *cfg = channel.cfg;
    let mut width: c_int = snd_pcm_format_physical_width(runtime.format);
    channel.copy_fn = core::ptr::null_mut();
    if (cfg.direction == MOST_CH_TX) {
    if (snd_pcm_format_big_endian(runtime.format) || width == 8)
    channel.copy_fn = alsa_to_most_memcpy;
#[no_mangle]
pub unsafe extern "C" fn if(16: width ==) -> else {
    else if (width == 16)
    channel.copy_fn = alsa_to_most_copy16;
#[no_mangle]
pub unsafe extern "C" fn if(24: width ==) -> else {
    else if (width == 24)
...
//
#[no_mangle]
unsafe extern "C" fn pcm_trigger(substream: *mut snd_pcm_substream, cmd: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcm_pointer(substream: *mut snd_pcm_substream) -> snd_pcm_uframes_t {
...
#[no_mangle]
unsafe extern "C" fn split_arg_list(buf: *mut c_char, ch_num: *mut u16, sample_res: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn release_adapter(adpt: *mut sound_adapter) {
...
//
    ...
    struct snd_pcm *pcm;
    let mut playback_count: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn audio_create_sound_card() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn audio_rx_completion(mbo: *mut mbo) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn audio_tx_completion(iface: *mut most_interface, channel_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn audio_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn audio_exit() -> void __exit {
