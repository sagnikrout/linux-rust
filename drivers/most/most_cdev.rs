...
//! Source: drivers/most/most_cdev.c
#![no_std]
...
pub const CHRDEV_REGION_SIZE: c_int = 50;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct comp_channel {
    pub wq: wait_queue_head_t,
    pub /: *mut *mut spinlock_t unlink; / synchronization lock to unlink channels,
    pub cdev: cdev,
    pub dev: *mut device,
    pub io_mutex: mutex,
    ...
    pub devno: dev_t,
    pub mbo_offs: usize,
    pub )): *mut DECLARE_KFIFO_PTR(fifo, typeof(struct mbo,
    pub access_ref: c_int,
    pub list: list_head,
}
...
#[no_mangle]
pub unsafe extern "C" fn ch_has_mbo(c: *mut comp_channel) -> bool {
...
#[no_mangle]
unsafe extern "C" fn stop_channel(c: *mut comp_channel) {
...
#[no_mangle]
unsafe extern "C" fn destroy_cdev(c: *mut comp_channel) {
...
#[no_mangle]
unsafe extern "C" fn destroy_channel(c: *mut comp_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn comp_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn comp_close(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn comp_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
#[no_mangle]
unsafe extern "C" fn comp_disconnect_channel(iface: *mut most_interface, channel_id: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn comp_rx_completion(mbo: *mut mbo) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn comp_tx_completion(iface: *mut most_interface, channel_id: c_int) -> c_int {
...
//
    ...
    c.dev = device_create(&most_cdev_class, core::ptr::null_mut(), c.devno, core::ptr::null_mut(), "%s", name);
    if (IS_ERR(c.dev)) {
...
#[no_mangle]
unsafe extern "C" fn most_cdev_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn most_cdev_exit() -> void __exit {
