...
//! Source: drivers/virt/vboxguest/vboxguest_linux.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn vbg_misc_device_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vbg_misc_device_user_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vbg_misc_device_close(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vbg_input_open(input: *mut input_dev) -> c_int {
    static int vbg_input_open(struct input_dev *input)
    {
    struct vbg_dev *gdev = input_get_drvdata(input);
    let mut feat: u32 = VMMDEV_MOUSE_GUEST_CAN_ABSOLUTE | VMMDEV_MOUSE_NEW_PROTOCOL;
...
//
#[no_mangle]
unsafe extern "C" fn vbg_input_close(input: *mut input_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn vbg_create_input_device(gdev: *mut vbg_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vbg_pci_probe(pci: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    if (devm_request_region(dev, io, io_len, DEVICE_NAME) == core::ptr::null_mut()) {
    ...
    if (devm_request_mem_region(dev, mmio, mmio_len, DEVICE_NAME) == core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn vbg_put_gdev(gdev: *mut vbg_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vbg_linux_mouse_event(gdev: *mut vbg_dev) {
