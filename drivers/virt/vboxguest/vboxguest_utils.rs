...
//! Source: drivers/virt/vboxguest/vboxguest_utils.c
#![no_std]
...
pub const VBG_DEBUG_PORT: c_uint = 0x504;
// This protects vbg_log_buf and serializes VBG_DEBUG_PORT accesses
    ...
    let mut order: c_int = get_order(PAGE_ALIGN(len));
...
#[no_mangle]
pub unsafe extern "C" fn vbg_req_free(req: *mut c_void, len: usize) {
...
#[no_mangle]
pub unsafe extern "C" fn vbg_req_perform(gdev: *mut vbg_dev, req: *mut c_void) -> c_int {
    int vbg_req_perform(struct vbg_dev *gdev, void *req)
    {
    let mut phys_req: c_ulong = virt_to_phys(req);
...
//
    ...
    {
    struct vmmdev_hgcm_connect *hgcm_connect = core::ptr::null_mut();
    int rc;
...
// vbox_status = rc;
    ...
    u32 client_id, int *vbox_status)
    {
    struct vmmdev_hgcm_disconnect *hgcm_disconnect = core::ptr::null_mut();
    int rc;
...
#[no_mangle]
unsafe extern "C" fn hgcm_call_buf_size_in_pages(buf: *mut c_void, len: u32) -> u32 {
    static u32 hgcm_call_buf_size_in_pages(void *buf, u32 len)
    {
    let mut size: u32 = PAGE_ALIGN(len + ((unsigned long)buf & ~PAGE_MASK));
    return size >> PAGE_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn hgcm_call_add_pagelist_size(buf: *mut c_void, len: u32, extra: *mut usize) {
...
//
    ...
    {
    void *buf, **bounce_bufs = core::ptr::null_mut();
    u32 i, len;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn hgcm_cancel_call(gdev: *mut vbg_dev, call: *mut vmmdev_hgcm_call) -> c_int {
...
// dst_parm = *src_parm;
    ...
    void **bounce_bufs = core::ptr::null_mut();
    bool leak_it;
    size_t size;
    int i, ret;
...
// vbox_status = call->header.result;
    ...
    {
    struct vmmdev_hgcm_function_parameter *parm64 = core::ptr::null_mut();
    u32 i, size;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn vbg_status_code_to_errno(rc: c_int) -> c_int {
