...
//! Source: drivers/virt/fsl_hypervisor.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ioctl_restart(p: *mut fsl_hv_ioctl_restart __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn ioctl_status(p: *mut fsl_hv_ioctl_status __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn ioctl_start(p: *mut fsl_hv_ioctl_start __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn ioctl_stop(p: *mut fsl_hv_ioctl_stop __user) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn ioctl_memcpy(p: *mut fsl_hv_ioctl_memcpy __user) -> c_long {
    ...
    void *sg_list_unaligned = core::ptr::null_mut();
    struct fh_sg_list *sg_list = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn ioctl_doorbell(p: *mut fsl_hv_ioctl_doorbell __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ioctl_dtprop(p: *mut fsl_hv_ioctl_prop __user, set: c_int) -> c_long {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct doorbell_isr {
    pub list: list_head,
    pub irq: c_uint,
    pub /: *mut *mut uint32_t doorbell; / The doorbell handle,
    pub /: *mut *mut uint32_t partition; / The partition handle, if used,
}
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hv_queue_doorbell(doorbell: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hv_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hv_state_change_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hv_state_change_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hv_poll(filp: *mut file, p: *mut poll_table_struct) -> __poll_t {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hv_open(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hv_close(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fsl_hv_shutdown_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn get_parent_handle(np: *mut device_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_hv_failover_register(nb: *mut notifier_block) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fsl_hv_failover_unregister(nb: *mut notifier_block) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn has_fsl_hypervisor() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hypervisor_init() -> int __init {
    ...
    for_each_compatible_node(np, core::ptr::null_mut(), "epapr,hv-receive-doorbell") {
    unsigned int irq;
    const uint32_t *handle;
    handle = of_get_property(np, "interrupts", core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn fsl_hypervisor_exit() -> void __exit {
