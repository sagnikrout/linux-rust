...
//! Source: drivers/virt/acrn/ioeventfd.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ioreq_type_from_flags(flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acrn_ioeventfd_shutdown(vm: *mut acrn_vm, p: *mut hsm_ioeventfd) {
...
// register the I/O range into ioreq client
    ...
    {
    struct hsm_ioeventfd *p = core::ptr::null_mut();
    lockdep_assert_held(&vm.ioeventfds_lock);
    list_for_each_entry(p, &vm.ioeventfds, list) {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioeventfd_config(vm: *mut acrn_vm, args: *mut acrn_ioeventfd) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioeventfd_init(vm: *mut acrn_vm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioeventfd_deinit(vm: *mut acrn_vm) {
