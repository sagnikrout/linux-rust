...
//! Source: drivers/virt/acrn/hsm.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn acrn_dev_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmcmd_ioctl(cmd: u64, uptr: *mut void __user) -> c_int {
...
//
    ...
    return -EEXIST;
    if (!acrn_ioreq_client_create(vm, core::ptr::null_mut(), core::ptr::null_mut(), true, "acrndm"))
    ret = -EINVAL;
    break;
...
#[no_mangle]
unsafe extern "C" fn acrn_dev_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acrn_attr_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn hsm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hsm_exit() -> void __exit {
