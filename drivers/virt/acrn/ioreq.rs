...
//! Source: drivers/virt/acrn/ioreq.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn has_pending_request(client: *mut acrn_ioreq_client) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_destroying(client: *mut acrn_ioreq_client) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioreq_request_default_complete(vm: *mut acrn_vm, vcpu: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ioreq_task(data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acrn_ioreq_request_clear(vm: *mut acrn_vm) {
...
// Clear all ioreqs belonging to the default client
    ...
    acrn_ioreq_complete_request(client, vcpu, core::ptr::null_mut());
    }
    spin_unlock_bh(&vm.ioreq_clients_lock);
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioreq_client_wait(client: *mut acrn_ioreq_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_cfg_addr(req: *mut acrn_io_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_cfg_data(req: *mut acrn_io_request) -> bool {
...
pub const PCI_LOWREG_MASK: c_uint = 0xFC;
// The high 4-bit of supported pci_reg addr
pub const PCI_HIGHREG_MASK: c_uint = 0xF00;
// Max number of supported functions
pub const PCI_FUNCMAX: c_int = 7;
// Max number of supported slots
pub const PCI_SLOTMAX: c_int = 31;
// Max number of supported buses
pub const PCI_BUSMAX: c_int = 255;
pub const CONF1_ENABLE: c_uint = 0x80000000UL;
//
...
//
    ...
    struct acrn_io_request *req)
    {
    struct acrn_ioreq_client *client, *found = core::ptr::null_mut();
    struct acrn_ioreq_range *range;
...
//
#[no_mangle]
pub unsafe extern "C" fn acrn_ioreq_client_destroy(client: *mut acrn_ioreq_client) {
    ...
    spin_lock_bh(&vm.ioreq_clients_lock);
    if (client.is_default)
    vm.default_client = core::ptr::null_mut();
    else
...
#[no_mangle]
unsafe extern "C" fn acrn_ioreq_dispatch(vm: *mut acrn_vm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ioreq_dispatcher(work: *mut work_struct) {
    static void ioreq_dispatcher(struct work_struct *work)
    {
    struct acrn_vm *vm;
...
#[no_mangle]
unsafe extern "C" fn ioreq_intr_handler() {
    static void ioreq_intr_handler(void)
    {
    queue_work(ioreq_wq, &ioreq_work);
    }
#[no_mangle]
unsafe extern "C" fn ioreq_pause() {
    static void ioreq_pause(void)
    {
...
#[no_mangle]
unsafe extern "C" fn ioreq_resume() {
    static void ioreq_resume(void)
    {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioreq_intr_setup() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioreq_intr_remove() {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioreq_init(vm: *mut acrn_vm, buf_vma: u64) -> c_int {
    ...
    vm.ioreq_buf = core::ptr::null_mut();
    goto free_buf;
    }
    dev_dbg(acrn_dev.this_device,
    "Init ioreq buffer %p!\n", vm.ioreq_buf);
...
#[no_mangle]
pub unsafe extern "C" fn acrn_ioreq_deinit(vm: *mut acrn_vm) {
