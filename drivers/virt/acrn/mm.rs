...
#[no_mangle]
unsafe extern "C" fn modify_region(vm: *mut acrn_vm, region: *mut vm_memory_region_op) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acrn_mm_region_del(vm: *mut acrn_vm, user_gpa: u64, size: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_vm_memseg_map(vm: *mut acrn_vm, memmap: *mut acrn_vm_memmap) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acrn_vm_memseg_unmap(vm: *mut acrn_vm, memmap: *mut acrn_vm_memmap) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acrn_vm_ram_map(vm: *mut acrn_vm, memmap: *mut acrn_vm_memmap) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acrn_vm_all_ram_unmap(vm: *mut acrn_vm) {
