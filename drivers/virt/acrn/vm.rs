...
#[no_mangle]
pub unsafe extern "C" fn acrn_vm_destroy(vm: *mut acrn_vm) -> c_int {
...
// Remove from global VM list
    ...
    vm.monitor_page = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acrn_msi_inject(vm: *mut acrn_vm, msi_addr: u64, msi_data: u64) -> c_int {
