...
//! Source: drivers/virt/coco/tdx-guest/tdx-guest.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tdx_do_report(data: sockptr_t, tdreport: sockptr_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdx_do_extend(mr_ind: u8, data: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdx_mr_refresh(tm: *const tsm_measurements) -> c_int {
    static int tdx_mr_refresh(const struct tsm_measurements *tm)
    {
    return tdx_do_report(KERNEL_SOCKPTR(core::ptr::null_mut()), KERNEL_SOCKPTR(core::ptr::null_mut()));
    }
...
#[no_mangle]
unsafe extern "C" fn tdx_mr_deinit(mr_grp: *const attribute_group) {
...
pub const GET_QUOTE_CMD_VER: c_int = 1;
// TDX GetQuote status codes
pub const GET_QUOTE_SUCCESS: c_int = 0;
pub const GET_QUOTE_IN_FLIGHT: c_uint = 0xffffffffffffffff;
...
//
    let mut getquote_timeout: static u32 = 30;
#[no_mangle]
unsafe extern "C" fn tdx_get_report0(req: *mut tdx_report_req __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn free_quote_buf(buf: *mut c_void) {
    static void free_quote_buf(void *buf)
    {
    let mut len: usize = PAGE_ALIGN(GET_QUOTE_BUF_SIZE);
    let mut count: c_uint = len >> PAGE_SHIFT;
...
//
#[no_mangle]
unsafe extern "C" fn wait_for_quote_completion(quote_buf: *mut tdx_quote_buf, timeout: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdx_report_new_locked(report: *mut tsm_report, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdx_report_new(report: *mut tsm_report, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdx_report_attr_visible(n: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tdx_report_bin_attr_visible(n: c_int) -> bool {
    ...
    core::ptr::null_mut(), /* measurements */
    core::ptr::null_mut()
    };
    ...
    X86_MATCH_FEATURE(X86_FEATURE_TDX_GUEST, core::ptr::null_mut()),
    {}
    };
...
#[no_mangle]
unsafe extern "C" fn tdx_guest_init() -> int __init {
    ...
    ret = tsm_report_register(&tdx_tsm_ops, core::ptr::null_mut());
    if (ret)
    goto free_quote;
    return 0;
    free_quote:
...
#[no_mangle]
unsafe extern "C" fn tdx_guest_exit() -> void __exit {
