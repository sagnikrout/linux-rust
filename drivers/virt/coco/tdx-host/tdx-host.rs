...
//! Source: drivers/virt/coco/tdx-host/tdx-host.c
#![no_std]
...
//
    ...
    X86_MATCH_FEATURE(X86_FEATURE_TDX_HOST_PLATFORM, core::ptr::null_mut()),
    {}
    };
...
#[no_mangle]
unsafe extern "C" fn supports_runtime_update() -> bool {
...
#[no_mangle]
unsafe extern "C" fn seamldr_group_visible(kobj: *mut kobject, attr: *mut attribute, idx: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn tdx_fw_poll_complete(fwl: *mut fw_upload) -> enum fw_upload_err {
...
#[no_mangle]
unsafe extern "C" fn tdx_fw_cancel(fwl: *mut fw_upload) {
...
#[no_mangle]
unsafe extern "C" fn seamldr_deinit(tdx_fwl: *mut c_void) {
    static void seamldr_deinit(void *tdx_fwl)
    {
    firmware_upload_unregister(tdx_fwl);
    }
#[no_mangle]
unsafe extern "C" fn seamldr_init(dev: *mut device) -> c_int {
    ...
    &tdx_fw_ops, core::ptr::null_mut());
    if (IS_ERR(tdx_fwl))
    return PTR_ERR(tdx_fwl);
    return devm_add_action_or_reset(dev, seamldr_deinit, tdx_fwl);
    }
#[no_mangle]
unsafe extern "C" fn tdx_host_probe(fdev: *mut faux_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tdx_host_init() -> int __init {
    static int __init tdx_host_init(void)
    {
    if (!x86_match_cpu(tdx_host_ids) || !tdx_get_sysinfo())
    return -ENODEV;
    fdev = faux_device_create_with_groups(KBUILD_MODNAME, core::ptr::null_mut(),
    &tdx_host_ops,
    tdx_host_groups);
    if (!fdev)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn tdx_host_exit() -> void __exit {
