...
//! Source: drivers/gpib/nec7210/nec7210.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_disable_eos(board: *mut gpib_board, priv: *mut nec7210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_parallel_poll(board: *mut gpib_board, priv: *mut nec7210_priv, result: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_parallel_poll_response(board: *mut gpib_board, priv: *mut nec7210_priv, ist: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_serial_poll_status(board: *mut gpib_board, priv: *mut nec7210_priv) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn update_talker_state(priv: *mut nec7210_priv, address_status_bits: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn update_listener_state(priv: *mut nec7210_priv, address_status_bits: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_update_status_nolock(board: *mut gpib_board, priv: *mut nec7210_priv) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_set_handshake_mode(board: *mut gpib_board, priv: *mut nec7210_priv, mode: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_read_data_in(board: *mut gpib_board, priv: *mut nec7210_priv, end: *mut c_int) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_take_control(board: *mut gpib_board, priv: *mut nec7210_priv, syncronous: c_int) -> c_int {
    int nec7210_take_control(struct gpib_board *board, struct nec7210_priv *priv, int syncronous)
    {
    int i;
    let mut timeout: c_int = 100;
    let mut retval: c_int = 0;
    let mut adsr_bits: c_uint = 0;
    if (syncronous)
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_go_to_standby(board: *mut gpib_board, priv: *mut nec7210_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_interface_clear(board: *mut gpib_board, priv: *mut nec7210_priv, assert: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_remote_enable(board: *mut gpib_board, priv: *mut nec7210_priv, enable: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_release_rfd_holdoff(board: *mut gpib_board, priv: *mut nec7210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_return_to_local(board: *const gpib_board, priv: *mut nec7210_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_atn_has_changed(board: *mut gpib_board, priv: *mut nec7210_priv) -> c_short {
    static inline short nec7210_atn_has_changed(struct gpib_board *board, struct nec7210_priv *priv)
    {
    let mut address_status_bits: c_short = read_byte(priv, ADSR);
    if (address_status_bits & HR_NATN) {
...
#[no_mangle]
unsafe extern "C" fn __dma_read(board: *mut gpib_board, priv: *mut nec7210_priv, length: usize) -> isize {
...
// wait until byte is ready to be sent
    ...
    let mut retval: isize = 0;
    unsigned long flags;
    let mut max_bus_errors: c_int = (length > 1000) ? length : 1000;
    let mut bus_error_count: c_int = 0;
// bytes_written = 0;
    clear_bit(BUS_ERROR_BN, &priv.state);
    while (*bytes_written < length) {
    if (need_resched())
...
//
#[no_mangle]
pub unsafe extern "C" fn nec7210_interrupt(board: *mut gpib_board, priv: *mut nec7210_priv) -> irqreturn_t {
...
// command pass through received
    ...
    if (status1 & HR_DEC) {
    let mut address_status_bits: c_ushort = read_byte(priv, ADSR);
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_board_reset(priv: *mut nec7210_priv, board: *const gpib_board) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_board_online(priv: *mut nec7210_priv, board: *const gpib_board) {
...
// wrappers for io
#[no_mangle]
pub unsafe extern "C" fn nec7210_ioport_read_byte(priv: *mut nec7210_priv, register_num: c_uint) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_ioport_write_byte(priv: *mut nec7210_priv, data: u8, register_num: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_locking_ioport_read_byte(priv: *mut nec7210_priv, register_num: c_uint) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_iomem_read_byte(priv: *mut nec7210_priv, register_num: c_uint) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_iomem_write_byte(priv: *mut nec7210_priv, data: u8, register_num: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn nec7210_locking_iomem_read_byte(priv: *mut nec7210_priv, register_num: c_uint) -> u8 {
