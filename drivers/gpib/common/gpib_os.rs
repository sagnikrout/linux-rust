...
//! Source: drivers/gpib/common/gpib_os.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn watchdog_timeout(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn os_start_timer(board: *mut gpib_board, usec_timeout: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn os_remove_timer(board: *mut gpib_board) {
...
#[no_mangle]
pub unsafe extern "C" fn io_timed_out(board: *mut gpib_board) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pseudo_irq_period() -> c_int {
    static inline int pseudo_irq_period(void)
    {
    return (HZ + 99) / 100;
    }
#[no_mangle]
unsafe extern "C" fn pseudo_irq_handler(t: *mut timer_list) {
    ...
    pr_err("gpib: bug! pseudo_irq.handler is core::ptr::null_mut()\n");
    if (atomic_read(&pseudo_irq.active))
    mod_timer(&pseudo_irq.timer, jiffies + pseudo_irq_period());
    }
#[no_mangle]
pub unsafe extern "C" fn gpib_request_pseudo_irq(board: *mut gpib_board, (*handler)(int: *mut irqreturn_t, ): *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gpib_free_pseudo_irq(board: *mut gpib_board) {
    ...
    board.pseudo_irq.handler = core::ptr::null_mut();
    }
    EXPORT_SYMBOL(gpib_free_pseudo_irq);
    let mut serial_timeout: static unsigned int = 1000000;
#[no_mangle]
pub unsafe extern "C" fn num_status_bytes(dev: *const gpib_status_queue) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn push_status_byte(board: *mut gpib_board, device: *mut gpib_status_queue, poll_byte: u8) -> c_int {
    ...
    let mut max_num_status_bytes: static unsigned int = 1024;
    int retval;
...
#[no_mangle]
pub unsafe extern "C" fn pop_status_byte(board: *mut gpib_board, device: *mut gpib_status_queue, poll_byte: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn autopoll_all_devices(board: *mut gpib_board) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_serial_poll(board: *mut gpib_board, usec_timeout: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_serial_poll(board: *mut gpib_board, usec_timeout: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn serial_poll_all(board: *mut gpib_board, usec_timeout: c_uint) -> c_int {
    int serial_poll_all(struct gpib_board *board, unsigned int usec_timeout)
    {
    let mut retval: c_int = 0;
    struct list_head *cur;
    const struct list_head *head = core::ptr::null_mut();
    struct gpib_status_queue *device;
    u8 result;
    let mut num_bytes: c_uint = 0;
...
//
    ...
    unsigned int usec_timeout, u8 *result)
    {
    let mut status: c_int = ibstatus(board);
    int retval;
    if ((status & CIC) == 0) {
...
#[no_mangle]
unsafe extern "C" fn init_gpib_file_private(priv: *mut gpib_file_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibopen(inode: *mut inode, filep: *mut file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibclose(inode: *mut inode, filep: *mut file) -> c_int {
    ...
    filep.private_data = core::ptr::null_mut();
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn ibioctl(filep: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
    long ibioctl(struct file *filep, unsigned int cmd, unsigned long arg)
    {
    let mut minor: c_uint = iminor(file_inode(filep));
    struct gpib_board *board;
    struct gpib_file_private *file_priv = filep.private_data;
    let mut retval: c_long = -EBADRQC;
    if (minor >= GPIB_MAX_NUM_BOARDS) {
    pr_err("gpib: invalid minor number of device file\n");
    return -ENODEV;
    }
...
//
    ...
    int i;
    let mut had_module: c_int = file_priv.got_module;
    if (board.use_count) {
    for (i = 0; i < board.use_count; ++i)
    module_put(board.provider_module);
    board.interface = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn status_bytes_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int status_bytes_ioctl(struct gpib_board *board, unsigned long arg)
    {
    struct gpib_status_queue *device;
...
#[no_mangle]
unsafe extern "C" fn cleanup_open_devices(file_priv: *mut gpib_file_private, board: *mut gpib_board) -> c_int {
    static int cleanup_open_devices(struct gpib_file_private *file_priv, struct gpib_board *board)
    {
    let mut retval: c_int = 0;
    int i;
    ...
    kfree(desc);
    file_priv.descriptors[i] = core::ptr::null_mut();
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn open_dev_ioctl(filep: *mut file, board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int open_dev_ioctl(struct file *filep, struct gpib_board *board, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn close_dev_ioctl(filep: *mut file, board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int close_dev_ioctl(struct file *filep, struct gpib_board *board, unsigned long arg)
    {
...
// Remove from table while holding lock to prevent new IO from starting
    file_priv.descriptors[cmd.handle] = core::ptr::null_mut();
    pad = desc.pad;
    sad = desc.sad;
    mutex_unlock(&file_priv.descriptors_mutex);
...
#[no_mangle]
unsafe extern "C" fn serial_poll_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int serial_poll_ioctl(struct gpib_board *board, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn parallel_poll_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int parallel_poll_ioctl(struct gpib_board *board, unsigned long arg)
    {
    u8 poll_byte;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn online_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int online_ioctl(struct gpib_board *board, unsigned long arg)
    {
    struct gpib_online_ioctl online_cmd;
    int retval;
    void __user *init_data = core::ptr::null_mut();
    board.config.init_data = core::ptr::null_mut();
    if (!capable(CAP_SYS_ADMIN))
    return -EPERM;
...
#[no_mangle]
unsafe extern "C" fn remote_enable_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int remote_enable_ioctl(struct gpib_board *board, unsigned long arg)
    {
    int enable;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn take_control_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int take_control_ioctl(struct gpib_board *board, unsigned long arg)
    {
    int synchronous;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn line_status_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int line_status_ioctl(struct gpib_board *board, unsigned long arg)
    {
    short lines;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn eos_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int eos_ioctl(struct gpib_board *board, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn request_service_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int request_service_ioctl(struct gpib_board *board, unsigned long arg)
    {
    u8 status_byte;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn request_service2_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int request_service2_ioctl(struct gpib_board *board, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn iobase_ioctl(config: *mut gpib_board_config, arg: c_ulong) -> c_int {
    static int iobase_ioctl(struct gpib_board_config *config, unsigned long arg)
    {
    u64 base_addr;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn irq_ioctl(config: *mut gpib_board_config, arg: c_ulong) -> c_int {
    static int irq_ioctl(struct gpib_board_config *config, unsigned long arg)
    {
    unsigned int irq;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn dma_ioctl(config: *mut gpib_board_config, arg: c_ulong) -> c_int {
    static int dma_ioctl(struct gpib_board_config *config, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn timeout_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int timeout_ioctl(struct gpib_board *board, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn ppc_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int ppc_ioctl(struct gpib_board *board, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn set_local_ppoll_mode_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int set_local_ppoll_mode_ioctl(struct gpib_board *board, unsigned long arg)
    {
    short cmd;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn get_local_ppoll_mode_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int get_local_ppoll_mode_ioctl(struct gpib_board *board, unsigned long arg)
    {
    short cmd;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn query_board_rsv_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int query_board_rsv_ioctl(struct gpib_board *board, unsigned long arg)
    {
    int status;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn board_info_ioctl(board: *const gpib_board, arg: c_ulong) -> c_int {
    static int board_info_ioctl(const struct gpib_board *board, unsigned long arg)
    {
    let mut info: gpib_board_info_ioctl = { };
    int retval;
    info.pad = board.pad;
    info.sad = board.sad;
...
#[no_mangle]
unsafe extern "C" fn interface_clear_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int interface_clear_ioctl(struct gpib_board *board, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn select_pci_ioctl(config: *mut gpib_board_config, arg: c_ulong) -> c_int {
    static int select_pci_ioctl(struct gpib_board_config *config, unsigned long arg)
    {
...
#[no_mangle]
unsafe extern "C" fn select_device_path_ioctl(config: *mut gpib_board_config, arg: c_ulong) -> c_int {
    static int select_device_path_ioctl(struct gpib_board_config *config, unsigned long arg)
    {
    ...
    config.device_path = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn num_gpib_events(queue: *const gpib_event_queue) -> c_uint {
    unsigned int num_gpib_events(const struct gpib_event_queue *queue)
    {
    return queue.num_events;
    }
#[no_mangle]
unsafe extern "C" fn push_gpib_event_nolock(board: *mut gpib_board, event_type: c_short) -> c_int {
    ...
    let mut max_num_events: static unsigned int = 1024;
    int retval;
...
#[no_mangle]
pub unsafe extern "C" fn push_gpib_event(board: *mut gpib_board, event_type: c_short) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pop_gpib_event(board: *mut gpib_board, queue: *mut gpib_event_queue, event_type: *mut c_short) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn event_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int event_ioctl(struct gpib_board *board, unsigned long arg)
    {
    short user_event;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn request_system_control_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int request_system_control_ioctl(struct gpib_board *board, unsigned long arg)
    {
    int request_control;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn t1_delay_ioctl(board: *mut gpib_board, arg: c_ulong) -> c_int {
    static int t1_delay_ioctl(struct gpib_board *board, unsigned long arg)
    {
    unsigned int cmd;
    unsigned int delay;
...
#[no_mangle]
pub unsafe extern "C" fn init_gpib_descriptor(desc: *mut gpib_descriptor) {
...
#[no_mangle]
pub unsafe extern "C" fn gpib_register_driver(interface: *mut gpib_interface, provider_module: *mut module) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gpib_unregister_driver(interface: *mut gpib_interface) {
...
#[no_mangle]
unsafe extern "C" fn init_gpib_board_config(config: *mut gpib_board_config) {
...
#[no_mangle]
pub unsafe extern "C" fn init_gpib_board(board: *mut gpib_board) {
    void init_gpib_board(struct gpib_board *board)
    {
    board.interface = core::ptr::null_mut();
    board.provider_module = core::ptr::null_mut();
    board.buffer = core::ptr::null_mut();
    ...
    timer_setup(&board.timer, core::ptr::null_mut(), 0);
    board.dev = core::ptr::null_mut();
    board.gpib_dev = core::ptr::null_mut();
    ...
    board.autospoll_task = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn gpib_allocate_board(board: *mut gpib_board) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gpib_deallocate_board(board: *mut gpib_board) {
...
#[no_mangle]
unsafe extern "C" fn init_board_array(board_array: *mut gpib_board, length: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn init_gpib_status_queue(device: *mut gpib_status_queue) {
...
#[no_mangle]
unsafe extern "C" fn gpib_common_init_module() -> int __init {
    ...
    for (i = 0; i < GPIB_MAX_NUM_BOARDS; ++i)
    board_array[i].gpib_dev = device_create(&gpib_class, core::ptr::null_mut(),
    MKDEV(GPIB_CODE, i), core::ptr::null_mut(), "gpib%i", i);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn gpib_common_exit_module() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn gpib_match_device_path(dev: *mut device, device_path_in: *const c_char) -> c_int {
    ...
    if (!device_path) {
    dev_err(dev, "kobject_get_path returned core::ptr::null_mut().");
    return 0;
    }
