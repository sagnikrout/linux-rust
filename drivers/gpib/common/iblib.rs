...
//! Source: drivers/gpib/common/iblib.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ibcac(board: *mut gpib_board, sync: c_int, fallback_to_async: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_for_command_acceptors(board: *mut gpib_board) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibcmd(board: *mut gpib_board, buf: *mut u8, length: usize, bytes_written: *mut usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibgts(board: *mut gpib_board) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn autospoll_wait_should_wake_up(board: *mut gpib_board) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn autospoll_thread(board_void: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibonline(board: *mut gpib_board) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iboffline(board: *mut gpib_board) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iblines(board: *const gpib_board, lines: *mut c_short) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibrd(board: *mut gpib_board, buf: *mut u8, length: usize, end_flag: *mut c_int, nbytes: *mut usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibrpp(board: *mut gpib_board, result: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibppc(board: *mut gpib_board, configuration: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibrsv2(board: *mut gpib_board, status_byte: u8, new_reason_for_service: c_int) -> c_int {
    int ibrsv2(struct gpib_board *board, u8 status_byte, int new_reason_for_service)
    {
    let mut board_status: c_int = ibstatus(board);
    let mut MSS: c_uint = status_byte & request_service_bit;
    if ((board_status & CIC))
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn ibsic(board: *mut gpib_board, usec_duration: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibrsc(board: *mut gpib_board, request_control: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibsre(board: *mut gpib_board, enable: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibpad(board: *mut gpib_board, addr: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibsad(board: *mut gpib_board, addr: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ibeos(board: *mut gpib_board, eos: c_int, eosflags: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ibstatus(board: *mut gpib_board) -> c_int {
    int ibstatus(struct gpib_board *board)
    {
    return general_ibstatus(board, core::ptr::null_mut(), 0, 0, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(CMPL: clear_mask &) -> else {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wait_info {
    pub board: *mut gpib_board,
    pub timer: timer_list,
    pub timed_out: c_int,
    pub usec_timeout: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn wait_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn init_wait_info(winfo: *mut wait_info) {
    static void init_wait_info(struct wait_info *winfo)
    {
    winfo.board = core::ptr::null_mut();
    winfo.timed_out = 0;
...
#[no_mangle]
unsafe extern "C" fn start_wait_timer(winfo: *mut wait_info) {
...
#[no_mangle]
unsafe extern "C" fn remove_wait_timer(winfo: *mut wait_info) {
...
//
    ...
    if (desc.is_board)
    status_queue = core::ptr::null_mut();
    else
...
// make sure we only clear status bits that we are reporting
    ...
    general_ibstatus(board, status_queue, *status & clear_mask, set_mask, core::ptr::null_mut());
    return 0;
    }
//
// IBWRT
...
//
#[no_mangle]
pub unsafe extern "C" fn ibwrt(board: *mut gpib_board, buf: *mut u8, cnt: usize, send_eoi: c_int, bytes_written: *mut usize) -> c_int {
