...
//! Source: drivers/gpib/tms9914/tms9914.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_take_control(board: *mut gpib_board, priv: *mut tms9914_priv, synchronous: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_go_to_standby(board: *mut gpib_board, priv: *mut tms9914_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_interface_clear(board: *mut gpib_board, priv: *mut tms9914_priv, assert: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_remote_enable(board: *mut gpib_board, priv: *mut tms9914_priv, enable: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_return_to_local(board: *const gpib_board, priv: *mut tms9914_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_set_holdoff_mode(priv: *mut tms9914_priv, mode: enum tms9914_holdoff_mode) {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_release_holdoff(priv: *mut tms9914_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_disable_eos(board: *mut gpib_board, priv: *mut tms9914_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_parallel_poll(board: *mut gpib_board, priv: *mut tms9914_priv, result: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_serial_poll_status(board: *mut gpib_board, priv: *mut tms9914_priv) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn update_talker_state(priv: *mut tms9914_priv, address_status_bits: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn update_listener_state(priv: *mut tms9914_priv, address_status_bits: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn update_status_nolock(board: *mut gpib_board, priv: *mut tms9914_priv) -> c_uint {
    static unsigned int update_status_nolock(struct gpib_board *board, struct tms9914_priv *priv)
    {
    int address_status;
    int bsr_bits;
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_line_status(board: *const gpib_board, priv: *mut tms9914_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn check_for_eos(priv: *mut tms9914_priv, byte: u8) -> c_int {
    static int check_for_eos(struct tms9914_priv *priv, u8 byte)
    {
    let mut seven_bit_compare_mask: static u8 = 0x7f;
...
#[no_mangle]
unsafe extern "C" fn wait_for_read_byte(board: *mut gpib_board, priv: *mut tms9914_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pio_write_wait(board: *mut gpib_board, priv: *mut tms9914_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_interrupt(board: *mut gpib_board, priv: *mut tms9914_priv) -> irqreturn_t {
...
// unrecognized command received
    if (status1 & HR_UNC) {
    let mut command_byte: c_ushort = read_byte(priv, CPTR) & gpib_command_mask;
    switch (command_byte) {
    case PP_CONFIG:
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_board_reset(priv: *mut tms9914_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn tms9914_online(board: *mut gpib_board, priv: *mut tms9914_priv) {
...
// wrapper for inb
#[no_mangle]
pub unsafe extern "C" fn tms9914_ioport_read_byte(priv: *mut tms9914_priv, register_num: c_uint) -> u8 {
...
// wrapper for outb
#[no_mangle]
pub unsafe extern "C" fn tms9914_ioport_write_byte(priv: *mut tms9914_priv, data: u8, register_num: c_uint) {
...
// wrapper for readb
#[no_mangle]
pub unsafe extern "C" fn tms9914_iomem_read_byte(priv: *mut tms9914_priv, register_num: c_uint) -> u8 {
...
// wrapper for writeb
#[no_mangle]
pub unsafe extern "C" fn tms9914_iomem_write_byte(priv: *mut tms9914_priv, data: u8, register_num: c_uint) {
