...
//! Source: drivers/hwtracing/stm/policy.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stp_policy_node {
    pub group: config_group,
    pub policy: *mut stp_policy,
    pub first_master: c_uint,
    pub last_master: c_uint,
    pub first_channel: c_uint,
    pub last_channel: c_uint,
...
#[no_mangle]
unsafe extern "C" fn stp_policy_node_release(item: *mut config_item) {
...
#[no_mangle]
pub unsafe extern "C" fn stp_policy_unbind(policy: *mut stp_policy) {
...
//
    ...
    stm.policy = core::ptr::null_mut();
    policy.stm = core::ptr::null_mut();
//
// Drop the reference on the protocol driver and lose the link.
//
    stm_put_protocol(stm.pdrv);
    stm.pdrv = core::ptr::null_mut();
    stm_put_device(stm);
    }
#[no_mangle]
unsafe extern "C" fn stp_policy_release(item: *mut config_item) {
...
//
    ...
    {
    struct stp_policy_node *policy_node, *ret = core::ptr::null_mut();
    ...
    {
    struct stp_policy_node *policy_node = core::ptr::null_mut();
    mutex_lock(&stp_policy_subsys.su_mutex);
    mutex_lock(&stm.policy_mutex);
    if (stm.policy)
...
#[no_mangle]
pub unsafe extern "C" fn stp_policy_node_put(policy_node: *mut stp_policy_node) {
...
#[no_mangle]
pub unsafe extern "C" fn stp_configfs_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn stp_configfs_exit() -> void __exit {
