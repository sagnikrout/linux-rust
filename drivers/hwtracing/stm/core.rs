...
//! Source: drivers/hwtracing/stm/core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn stm_put_device(stm: *mut stm_device) {
...
#[no_mangle]
unsafe extern "C" fn stp_master_alloc(stm: *mut stm_device, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stp_master_free(stm: *mut stm_device, idx: c_uint) {
    static void stp_master_free(struct stm_device *stm, unsigned int idx)
    {
    struct stp_master *master = stm_master(stm, idx);
    if (!master)
    return;
    __stm_master(stm, idx) = core::ptr::null_mut();
    kfree(master);
    }
#[no_mangle]
unsafe extern "C" fn stm_output_claim(stm: *mut stm_device, output: *mut stm_output) {
...
#[no_mangle]
unsafe extern "C" fn stm_output_free(stm: *mut stm_device, output: *mut stm_output) {
...
#[no_mangle]
unsafe extern "C" fn stm_output_init(output: *mut stm_output) {
    static void stm_output_init(struct stm_output *output)
    {
    spin_lock_init(&output.lock);
    }
#[no_mangle]
unsafe extern "C" fn major_match(dev: *mut device, data: *const c_void) -> c_int {
    static int major_match(struct device *dev, const void *data)
    {
    let mut major: c_uint = *(unsigned int *)data;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm_pdrv_entry {
    pub entry: list_head,
    pub pdrv: *const stm_protocol_driver,
    pub node_type: *const config_item_type,
}
...
#[no_mangle]
pub unsafe extern "C" fn stm_register_protocol(pdrv: *const stm_protocol_driver) -> c_int {
    int stm_register_protocol(const struct stm_protocol_driver *pdrv)
    {
    struct stm_pdrv_entry *pe = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn stm_unregister_protocol(pdrv: *const stm_protocol_driver) {
...
#[no_mangle]
unsafe extern "C" fn stm_get_protocol(pdrv: *const stm_protocol_driver) -> bool {
    static bool stm_get_protocol(const struct stm_protocol_driver *pdrv)
    {
    return try_module_get(pdrv.owner);
    }
#[no_mangle]
pub unsafe extern "C" fn stm_put_protocol(pdrv: *const stm_protocol_driver) {
...
#[no_mangle]
unsafe extern "C" fn stm_char_open(inode: *mut inode, file: *mut file) -> c_int {
    static int stm_char_open(struct inode *inode, struct file *file)
    {
    struct stm_file *stmf;
    struct device *dev;
    let mut major: c_uint = imajor(inode);
    let mut err: c_int = -ENOMEM;
    dev = class_find_device(&stm_class, core::ptr::null_mut(), &major, major_match);
    if (!dev)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn stm_char_release(inode: *mut inode, file: *mut file) -> c_int {
...
//
    for (n = 0, pn = core::ptr::null_mut(); ids[n] && !pn; n++)
...
//
    ...
    size_t count)
    {
    let mut flags: c_uint = ts_first ? STP_PACKET_TIMESTAMPED : 0;
    ssize_t sz;
    size_t pos;
...
//
    ...
    char *ids[] = { comm, "default", core::ptr::null_mut() };
...
//
    ...
    count = stm_write(stm, &stmf.output, 0, kbuf, count, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn stm_mmap_open(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn stm_mmap_close(vma: *mut vm_area_struct) {
...
#[no_mangle]
unsafe extern "C" fn stm_char_mmap_prepare(desc: *mut vm_area_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm_char_policy_set_ioctl(stmf: *mut stm_file, arg: *mut void __user) -> c_int {
    static int stm_char_policy_set_ioctl(struct stm_file *stmf, void __user *arg)
    {
    struct stm_device *stm = stmf.stm;
    struct stp_policy_id *id;
    char *ids[] = { core::ptr::null_mut(), core::ptr::null_mut() };
    let mut ret: c_int = -EINVAL, wlimit = 1;
    u32 size;
    if (stmf.output.nr_chans)
    return -EBUSY;
...
#[no_mangle]
unsafe extern "C" fn stm_char_policy_get_ioctl(stmf: *mut stm_file, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm_device_release(dev: *mut device) {
...
// calls stm_device_release()
    ...
    struct stm_device *stm);
#[no_mangle]
pub unsafe extern "C" fn stm_unregister_device(stm_data: *mut stm_data) {
...
//
    ...
    stm_data.stm = core::ptr::null_mut();
    }
...
//
    ...
    struct stm_device *stm)
    {
    char *ids[] = { core::ptr::null_mut(), "default", core::ptr::null_mut() };
    let mut err: c_int = -ENOMEM;
    mutex_lock(&stm.link_mutex);
...
// this is to let the source carry out all necessary preparations
    ...
    spin_lock(&stm.link_lock);
    spin_lock(&src.link_lock);
    rcu_assign_pointer(src.link, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn stm_source_link_drop(src: *mut stm_source_device) {
...
#[no_mangle]
unsafe extern "C" fn stm_source_device_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn stm_source_unregister_device(data: *mut stm_source_data) {
...
#[no_mangle]
unsafe extern "C" fn stm_core_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn stm_core_exit() -> void __exit {
