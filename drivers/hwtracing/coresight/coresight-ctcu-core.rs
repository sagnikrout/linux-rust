...
//! Source: drivers/hwtracing/coresight/coresight-ctcu-core.c
#![no_std]
...
pub const CTCU_ATID_REG_SIZE: c_uint = 0x10;
pub const CTCU_ETR0_ATID0: c_uint = 0xf8;
pub const CTCU_ETR1_ATID0: c_uint = 0x108;
...
//
#[no_mangle]
unsafe extern "C" fn ctcu_get_active_port(sink: *mut coresight_device, helper: *mut coresight_device) -> c_int {
    ...
    let mut traceid: u8 = path.trace_id;
    int port_num;
    if ((sink == core::ptr::null_mut()) || !IS_VALID_CS_TRACE_ID(traceid)) {
...
#[no_mangle]
unsafe extern "C" fn ctcu_disable(csdev: *mut coresight_device, path: *mut coresight_path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ctcu_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (IS_ERR(base))
    return PTR_ERR(base);
    ret = coresight_get_enable_clocks(dev, &drvdata.apb_clk, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn ctcu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ctcu_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ctcu_platform_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ctcu_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ctcu_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(ctcu_runtime_suspend, ctcu_runtime_resume, core::ptr::null_mut())
    };
