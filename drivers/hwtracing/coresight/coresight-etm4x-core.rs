...
//! Source: drivers/hwtracing/coresight/coresight-etm4x-core.c
#![no_std]
...
// will always save.
//
    let mut pm_save_enable: static int = PARAM_PM_SAVE_FIRMWARE;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct etm4_init_arg {
    pub dev: *mut device,
    pub csa: *mut csdev_access,
}
...
//
#[no_mangle]
unsafe extern "C" fn etm4x_sspcicrn_present(drvdata: *mut etmv4_drvdata, n: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn etm4x_sysreg_read(offset: u32, _relaxed: bool, _64bit: bool) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn etm4x_sysreg_write(val: u64, offset: u32, _relaxed: bool, _64bit: bool) {
...
#[no_mangle]
unsafe extern "C" fn ete_sysreg_read(offset: u32, _relaxed: bool, _64bit: bool) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ete_sysreg_write(val: u64, offset: u32, _relaxed: bool, _64bit: bool) {
    ...
    {
    let mut oslsr: u32 = etm4x_relaxed_read32(csa, TRCOSLSR);
...
#[no_mangle]
unsafe extern "C" fn etm4_os_unlock(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm4_os_lock(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
pub unsafe extern "C" fn etm4_release_trace_id(drvdata: *mut etmv4_drvdata) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct etm4_enable_arg {
    pub drvdata: *mut etmv4_drvdata,
...
//
#[no_mangle]
unsafe extern "C" fn etm4x_prohibit_trace(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm4x_get_kern_user_filter(drvdata: *mut etmv4_drvdata) -> u64 {
    static u64 etm4x_get_kern_user_filter(struct etmv4_drvdata *drvdata)
    {
    let mut trfcr: u64 = drvdata.trfcr;
...
//
#[no_mangle]
unsafe extern "C" fn etm4x_allow_trace(drvdata: *mut etmv4_drvdata) {
...
pub const HISI_HIP08_AMBA_ID: c_uint = 0x000b6d01;
pub const ETM4_AMBA_MASK: c_uint = 0xfffff;
pub const HISI_HIP08_CORE_COMMIT_MASK: c_uint = 0x3000;
pub const HISI_HIP08_CORE_COMMIT_SHIFT: c_int = 12;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct etm4_arch_features {
    pub enable): *mut *mut void (arch_callback)(bool,
}

#[no_mangle]
unsafe extern "C" fn etm4_hisi_match_pid(id: c_uint) -> bool {
    static bool etm4_hisi_match_pid(unsigned int id)
    {
    return (id & ETM4_AMBA_MASK) == HISI_HIP08_AMBA_ID;
    }
#[no_mangle]
unsafe extern "C" fn etm4_hisi_config_core_commit(enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn etm4_enable_arch_specific(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm4_disable_arch_specific(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm4x_sys_ins_barrier(csa: *mut csdev_access, offset: u32, pos: c_int, val: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn etm4x_wait_status(csa: *mut csdev_access, pos: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm4_enable_trace_unit(drvdata: *mut etmv4_drvdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm4_enable_hw(drvdata: *mut etmv4_drvdata) -> c_int {
...
// always clear status bit on restart if using single-shot
    ...
    let mut trcpdcr: u32 = etm4x_relaxed_read32(csa, TRCPDCR);
//
...
#[no_mangle]
unsafe extern "C" fn etm4_enable_sysfs_smp_call(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn etm4_enable_sysfs(csdev: *mut coresight_device, path: *mut coresight_path) -> c_int {
    static int etm4_enable_sysfs(struct coresight_device *csdev, struct coresight_path *path)
    {
    struct etmv4_drvdata *drvdata = dev_get_drvdata(csdev.dev.parent);
    let mut arg: etm4_enable_arg = { };
    unsigned long cfg_hash;
    int ret, preset;
...
#[no_mangle]
unsafe extern "C" fn etm4_disable_trace_unit(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm4_disable_hw(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm4_disable_sysfs_smp_call(info: *mut c_void) {
    static void etm4_disable_sysfs_smp_call(void *info)
    {
    struct etmv4_drvdata *drvdata = info;
    etm4_disable_hw(drvdata);
    drvdata.csdev.path = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn etm4_disable_sysfs(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn etm4_resume_perf(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm4_pause_perf(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn cpu_supports_sysreg_trace() -> bool {
    static bool cpu_supports_sysreg_trace(void)
    {
    let mut dfr0: u64 = read_sysreg_s(SYS_ID_AA64DFR0_EL1);
...
#[no_mangle]
unsafe extern "C" fn is_devtype_cpu_trace(base: *mut void __iomem) -> bool {
    static bool is_devtype_cpu_trace(void __iomem *base)
    {
    let mut devtype: u32 = readl(base + TRCDEVTYPE);
    return (devtype == CS_DEVTYPE_PE_TRACE);
    }
    static bool etm4_init_iomem_access(struct etmv4_drvdata *drvdata,
    struct csdev_access *csa)
    {
    let mut devarch: u32 = readl_relaxed(drvdata.base + TRCDEVARCH);
...
#[no_mangle]
unsafe extern "C" fn cpu_detect_trace_filtering(drvdata: *mut etmv4_drvdata) {
    static void cpu_detect_trace_filtering(struct etmv4_drvdata *drvdata)
    {
    let mut dfr0: u64 = read_sysreg(id_aa64dfr0_el1);
    u64 trfcr;
    drvdata.trfcr = 0;
...
#[no_mangle]
unsafe extern "C" fn etm4_fixup_wrong_ccitmin(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm4_init_arch_data(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn etm4_get_victlr_access_type(config: *mut etmv4_config) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn etm4_set_victlr_access(config: *mut etmv4_config) {
...
#[no_mangle]
unsafe extern "C" fn etm4_set_default_config(config: *mut etmv4_config) {
    static void etm4_set_default_config(struct etmv4_config *config)
    {
...
#[no_mangle]
unsafe extern "C" fn etm4_get_ns_access_type(config: *mut etmv4_config) -> u64 {
    static u64 etm4_get_ns_access_type(struct etmv4_config *config)
    {
    let mut access_type: u64 = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn etm4_get_access_type(config: *mut etmv4_config) -> u64 {
    static u64 etm4_get_access_type(struct etmv4_config *config)
    {
...
#[no_mangle]
unsafe extern "C" fn etm4_get_comparator_access_type(config: *mut etmv4_config) -> u64 {
    ...
    {
    let mut access_type: u64 = etm4_get_comparator_access_type(config);
...
#[no_mangle]
unsafe extern "C" fn etm4_set_default_filter(config: *mut etmv4_config) {
...
#[no_mangle]
unsafe extern "C" fn etm4_set_default(config: *mut etmv4_config) {
...
#[no_mangle]
unsafe extern "C" fn etm4_get_next_comparator(drvdata: *mut etmv4_drvdata, type: u32) -> c_int {
...
//
    ...
    let mut type: enum etm_addr_type = filter.type;
...
#[no_mangle]
pub unsafe extern "C" fn etm4_config_trace_mode(config: *mut etmv4_config) {
...
#[no_mangle]
unsafe extern "C" fn etm4_online_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn etm4_pm_save_needed(drvdata: *mut etmv4_drvdata) -> bool {
    static inline bool etm4_pm_save_needed(struct etmv4_drvdata *drvdata)
    {
    return !!drvdata.save_state;
    }
#[no_mangle]
unsafe extern "C" fn etm4_cpu_save(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm4_cpu_restore(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn etm4_pm_setup() -> int __init {
    static int __init etm4_pm_setup(void)
    {
    int ret;
    ret = cpuhp_setup_state_nocalls(CPUHP_AP_ONLINE_DYN,
    "arm/coresight4:online",
    etm4_online_cpu, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn etm4_pm_clear() {
...
#[no_mangle]
unsafe extern "C" fn etm4x_always_pm_save(dev: *mut device, csa: *mut csdev_access) -> bool {
...
#[no_mangle]
unsafe extern "C" fn etm4_add_coresight_dev(init_arg: *mut etm4_init_arg) -> c_int {
...
// ETE v1 has major version == 0b101. Adjust this for logging.
    ...
    pm_save = true;
#[no_mangle]
pub unsafe extern "C" fn if(PARAM_PM_SAVE_FIRMWARE: pm_save_enable ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn etm4_probe(dev: *mut device) -> c_int {
    static int etm4_probe(struct device *dev)
    {
    struct etmv4_drvdata *drvdata = dev_get_drvdata(dev);
    let mut access: csdev_access = { 0 };
    let mut init_arg: etm4_init_arg = { 0 };
...
#[no_mangle]
unsafe extern "C" fn etm4_probe_amba(adev: *mut amba_device, id: *const amba_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm4_probe_platform_dev(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm4_probe_cpu(cpu: c_uint) -> c_int {
    static int etm4_probe_cpu(unsigned int cpu)
    {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn clear_etmdrvdata(info: *mut c_void) {
    static void clear_etmdrvdata(void *info)
    {
    let mut cpu: c_int = *(int *)info;
    etmdrvdata[cpu] = core::ptr::null_mut();
    per_cpu(delayed_probe, cpu) = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn etm4_remove_dev(drvdata: *mut etmv4_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm4_remove_amba(adev: *mut amba_device) {
...
#[no_mangle]
unsafe extern "C" fn etm4_remove_platform_dev(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn etm4_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm4_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(etm4_runtime_suspend, etm4_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn etm4x_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn etm4x_exit() -> void __exit {
