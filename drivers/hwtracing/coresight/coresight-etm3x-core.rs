...
//! Source: drivers/hwtracing/coresight/coresight-etm3x-core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn etm_os_unlock(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm_set_pwrdwn(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm_clr_pwrdwn(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm_set_pwrup(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm_clr_pwrup(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm_set_prog(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm_clr_prog(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
pub unsafe extern "C" fn etm_set_default(config: *mut etm_config) {
...
#[no_mangle]
pub unsafe extern "C" fn etm_config_trace_mode(config: *mut etm_config) {
...
#[no_mangle]
unsafe extern "C" fn etm_enable_hw(drvdata: *mut etm_drvdata) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct etm_enable_arg {
    pub drvdata: *mut etm_drvdata,
    pub path: *mut coresight_path,
    pub rc: c_int,
}

#[no_mangle]
unsafe extern "C" fn etm_enable_sysfs_smp_call(info: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn etm_release_trace_id(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm_enable_sysfs(csdev: *mut coresight_device, path: *mut coresight_path) -> c_int {
    static int etm_enable_sysfs(struct coresight_device *csdev, struct coresight_path *path)
    {
    struct etm_drvdata *drvdata = dev_get_drvdata(csdev.dev.parent);
    let mut arg: etm_enable_arg = { };
    int ret;
...
#[no_mangle]
unsafe extern "C" fn etm_disable_hw(drvdata: *mut etm_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn etm_disable_sysfs_smp_call(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn etm_disable_perf(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn etm_disable_sysfs(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn etm_online_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm_arch_supported(arch: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn etm_init_arch_data(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn etm_hp_setup() -> int __init {
    static int __init etm_hp_setup(void)
    {
    int ret;
    ret = cpuhp_setup_state_nocalls(CPUHP_AP_ONLINE_DYN,
    "arm/coresight:online",
    etm_online_cpu, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn etm_hp_clear() {
...
#[no_mangle]
unsafe extern "C" fn etm_probe(adev: *mut amba_device, id: *const amba_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm_remove(adev: *mut amba_device) {
...
//
    ...
    etmdrvdata[drvdata.cpu] = core::ptr::null_mut();
    cpus_read_unlock();
    coresight_unregister(drvdata.csdev);
    }

#[no_mangle]
unsafe extern "C" fn etm_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn etm_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(etm_runtime_suspend, etm_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn etm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn etm_exit() -> void __exit {
