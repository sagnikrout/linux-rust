...
//! Source: drivers/hwtracing/coresight/coresight-tmc-etr.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct etr_perf_buffer {
    pub drvdata: *mut tmc_drvdata,
    pub etr_buf: *mut etr_buf,
    pub pid: pid_t,
    pub snapshot: bool,
    pub nr_pages: c_int,
...
//
    typedef u32 sgte_t;
pub const ETR_SG_PAGE_SHIFT: c_int = 12;

pub const ETR_SG_ET_MASK: c_uint = 0x3;
pub const ETR_SG_ET_LAST: c_uint = 0x1;
pub const ETR_SG_ET_NORMAL: c_uint = 0x2;
pub const ETR_SG_ET_LINK: c_uint = 0x3;
pub const ETR_SG_ADDR_SHIFT: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct etr_sg_table {
    pub sg_table: *mut tmc_sg_table,
...
//
    ...
    {
    let mut nr_sgpages: c_ulong = nr_pages * ETR_SG_PAGES_PER_SYSPAGE;
    let mut nr_sglinks: c_ulong = nr_sgpages / (ETR_SG_PTRS_PER_PAGE - 1);
//
...
//
    ...
    tmc_pages.pages = core::ptr::null_mut();
    tmc_pages.daddrs = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tmc_free_table_pages(sg_table: *mut tmc_sg_table) {
...
#[no_mangle]
unsafe extern "C" fn tmc_free_data_pages(sg_table: *mut tmc_sg_table) {
...
#[no_mangle]
pub unsafe extern "C" fn tmc_free_sg_table(sg_table: *mut tmc_sg_table) {
...
//
#[no_mangle]
unsafe extern "C" fn tmc_alloc_table_pages(sg_table: *mut tmc_sg_table) -> c_int {
    ...
    DMA_TO_DEVICE, core::ptr::null_mut());
    if (rc)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn tmc_alloc_data_pages(sg_table: *mut tmc_sg_table, pages: *mut c_void) -> c_int {
...
//
    ...
    {
    int i, index, start;
    let mut npages: c_int = DIV_ROUND_UP(size, PAGE_SIZE);
...
#[no_mangle]
pub unsafe extern "C" fn tmc_sg_table_sync_table(sg_table: *mut tmc_sg_table) {
...
//
    ...
    {
    size_t size;
    let mut pg_idx: c_int = offset >> PAGE_SHIFT;
    let mut pg_offset: c_int = offset & (PAGE_SIZE - 1);
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_sg_table_dump(etr_table: *mut etr_sg_table) {
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_sg_table_populate(etr_table: *mut etr_sg_table) {
...
//
    ...
    let mut nr_dpages: c_int = size >> PAGE_SHIFT;
    struct tmc_sg_table *sg_table;
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_free_flat_buf(etr_buf: *mut etr_buf) {
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_sync_flat_buf(etr_buf: *mut etr_buf, rrp: u64, rwp: u64) {
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_free_resrv_buf(etr_buf: *mut etr_buf) {
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_sync_resrv_buf(etr_buf: *mut etr_buf, rrp: u64, rwp: u64) {
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_free_sg_buf(etr_buf: *mut etr_buf) {
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_sync_sg_buf(etr_buf: *mut etr_buf, rrp: u64, rwp: u64) {
...
//
    ...
    [ETR_MODE_CATU] = core::ptr::null_mut(),
    [ETR_MODE_RESRV] = &etr_resrv_buf_ops
    };
#[no_mangle]
pub unsafe extern "C" fn tmc_etr_set_catu_ops(catu: *const etr_buf_operations) {
...
#[no_mangle]
pub unsafe extern "C" fn tmc_etr_remove_catu_ops() {
    void tmc_etr_remove_catu_ops(void)
    {
    etr_buf_ops[ETR_MODE_CATU] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn get_etr_buf_hw(dev: *mut device, buf_hw: *mut etr_buf_hw) {
...
#[no_mangle]
unsafe extern "C" fn etr_can_use_flat_mode(buf_hw: *mut etr_buf_hw, etr_buf_size: isize) -> bool {
    static bool etr_can_use_flat_mode(struct etr_buf_hw *buf_hw, ssize_t etr_buf_size)
    {
    let mut has_sg: bool = buf_hw.has_catu || buf_hw.has_etr_sg;
...
#[no_mangle]
unsafe extern "C" fn tmc_free_etr_buf(etr_buf: *mut etr_buf) {
...
//
#[no_mangle]
unsafe extern "C" fn tmc_sync_etr_buf(drvdata: *mut tmc_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn __tmc_etr_enable_hw(drvdata: *mut tmc_drvdata) -> c_int {
...
// Callers should provide an appropriate buffer for use
    ...
    if (rc) {
    drvdata.etr_buf = core::ptr::null_mut();
...
// Compute the offset from which we read the data
    ...
    0, cpu_to_node(0), core::ptr::null_mut());
    }
    static void
...
#[no_mangle]
unsafe extern "C" fn tmc_etr_sync_sysfs_buf(drvdata: *mut tmc_drvdata) {
    static void tmc_etr_sync_sysfs_buf(struct tmc_drvdata *drvdata)
    {
    struct etr_buf *etr_buf = drvdata.etr_buf;
    if (WARN_ON(drvdata.sysfs_buf != etr_buf)) {
    tmc_etr_free_sysfs_buf(drvdata.sysfs_buf);
    drvdata.sysfs_buf = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn __tmc_etr_disable_hw(drvdata: *mut tmc_drvdata) {
...
#[no_mangle]
pub unsafe extern "C" fn tmc_etr_disable_hw(drvdata: *mut tmc_drvdata) {
...
// Reset the ETR buf used by hardware
    ...
    struct etr_buf *sysfs_buf = core::ptr::null_mut(), *new_buf = core::ptr::null_mut(), *free_buf = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn tmc_enable_etr_sink_sysfs(csdev: *mut coresight_device) -> c_int {
...
//
    do {
    etr_buf = tmc_alloc_etr_buf(drvdata, size, 0, node, core::ptr::null_mut());
    if (!IS_ERR(etr_buf))
    return etr_buf;
    size /= 2;
    ...
    {
    int ret;
    let mut pid: pid_t = task_pid_nr(event.owner);
    struct etr_buf *etr_buf;
    retry:
//
...
#[no_mangle]
unsafe extern "C" fn tmc_free_etr_buffer(config: *mut c_void) {
...
//
    ...
    let mut mask: u32 = tmc_get_memwidth_mask(drvdata);
//
...
#[no_mangle]
unsafe extern "C" fn tmc_disable_etr_sink(csdev: *mut coresight_device) -> c_int {
...
// Reset perf specific data
    drvdata.perf_buf = core::ptr::null_mut();
    raw_spin_unlock_irqrestore(&drvdata.spinlock, flags);
    dev_dbg(&csdev.dev, "TMC-ETR disabled\n");
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tmc_panic_sync_etr(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tmc_read_prepare_etr(drvdata: *mut tmc_drvdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tmc_read_unprepare_etr(drvdata: *mut tmc_drvdata) -> c_int {
    int tmc_read_unprepare_etr(struct tmc_drvdata *drvdata)
    {
    unsigned long flags;
    struct etr_buf *sysfs_buf = core::ptr::null_mut();
// config types are set a boot time and never change
    if (WARN_ON_ONCE(drvdata.config_type != TMC_CONFIG_TYPE_ETR))
    return -EINVAL;
    raw_spin_lock_irqsave(&drvdata.spinlock, flags);
...
#[no_mangle]
unsafe extern "C" fn buf_mode_set_resrv(drvdata: *mut tmc_drvdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, buf_hw.has_etr_sg: buf_modes_str[ETR_MODE_ETR_SG]) &&) -> else {
    else if (sysfs_streq(buf, buf_modes_str[ETR_MODE_ETR_SG]) && buf_hw.has_etr_sg)
    drvdata.etr_mode = ETR_MODE_ETR_SG;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, buf_hw.has_catu: buf_modes_str[ETR_MODE_CATU]) &&) -> else {
    else if (sysfs_streq(buf, buf_modes_str[ETR_MODE_CATU]) && buf_hw.has_catu)
    drvdata.etr_mode = ETR_MODE_CATU;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, buf_hw.has_resrv: buf_modes_str[ETR_MODE_RESRV]) &&) -> else {
    else if (sysfs_streq(buf, buf_modes_str[ETR_MODE_RESRV]) && buf_hw.has_resrv)
    return buf_mode_set_resrv(drvdata) ? : size;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sysfs_streq(buf, _arg: buf_modes_str[ETR_MODE_AUTO])) -> else {
