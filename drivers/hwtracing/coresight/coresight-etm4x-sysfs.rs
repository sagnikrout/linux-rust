...
//! Source: drivers/hwtracing/coresight/coresight-etm4x-sysfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn etm4_set_mode_exclude(drvdata: *mut etmv4_drvdata, exclude: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(str, _arg: "ctxid")) -> else {
...
//
    ...
    {
    struct etmv4_drvdata *drvdata = dev_get_drvdata(dev.parent);
    let mut trace_id: c_int = coresight_etm_get_trace_id(drvdata.csdev, CS_MODE_SYSFS, core::ptr::null_mut());
    if (trace_id < 0)
    return trace_id;
...
#[no_mangle]
unsafe extern "C" fn do_smp_cross_read(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn etmv4_cross_read(drvdata: *const etmv4_drvdata, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn coresight_etm4x_attr_to_offset(attr: *mut device_attribute) -> u32 {
...
//
    ...
    {							\
    __ATTR(name, 0444, showfn, core::ptr::null_mut()),		\
