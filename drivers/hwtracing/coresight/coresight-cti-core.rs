...
//! Source: drivers/hwtracing/coresight/coresight-cti-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn cti_write_all_hw_regs(drvdata: *mut cti_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn cti_enable_hw(drvdata: *mut cti_drvdata) -> c_int {
...
// disable hardware
#[no_mangle]
unsafe extern "C" fn cti_disable_hw(drvdata: *mut cti_drvdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cti_read_single_reg(drvdata: *mut cti_drvdata, offset: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn cti_write_single_reg(drvdata: *mut cti_drvdata, offset: c_int, value: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cti_write_intack(dev: *mut device, ackval: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(NULL: assoc_dev_name !=) -> else {
...
// create a trigger connection with appropriately sized signal groups
    ...
    struct cti_trig_grp *in = core::ptr::null_mut(), *out = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn cti_add_default_connection(dev: *mut device, drvdata: *mut cti_drvdata) -> c_int {
    int cti_add_default_connection(struct device *dev, struct cti_drvdata *drvdata)
    {
    let mut ret: c_int = 0;
    let mut n_trigs: c_int = drvdata.config.nr_trig_max;
    let mut n_trig_mask: u32 = GENMASK(n_trigs - 1, 0);
    struct cti_trig_con *tc = core::ptr::null_mut();
//
...
//
    ...
    ret = cti_add_connection_entry(dev, drvdata, tc, core::ptr::null_mut(), "default");
    return ret;
    }
// cti channel api
...
//
#[no_mangle]
unsafe extern "C" fn cti_add_assoc_to_csdev(csdev: *mut coresight_device) {
    static void cti_add_assoc_to_csdev(struct coresight_device *csdev)
    {
    struct cti_drvdata *ect_item;
    struct cti_device *ctidev;
    const char *node_name = core::ptr::null_mut();
// protect the list
...
//
#[no_mangle]
unsafe extern "C" fn cti_remove_assoc_from_csdev(csdev: *mut coresight_device) {
...
//
#[no_mangle]
unsafe extern "C" fn cti_update_conn_xrefs(drvdata: *mut cti_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn cti_remove_conn_xrefs(drvdata: *mut cti_drvdata) {
...
#[no_mangle]
pub unsafe extern "C" fn cti_disable(csdev: *mut coresight_device, path: *mut coresight_path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cti_remove(adev: *mut amba_device) {
...
#[no_mangle]
unsafe extern "C" fn cti_probe(adev: *mut amba_device, id: *const amba_id) -> c_int {
    static int cti_probe(struct amba_device *adev, const struct amba_id *id)
    {
    let mut ret: c_int = 0;
    void __iomem *base;
    struct device *dev = &adev.dev;
    struct cti_drvdata *drvdata = core::ptr::null_mut();
    let mut cti_desc: coresight_desc = { 0 };
...
#[no_mangle]
unsafe extern "C" fn cti_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cti_exit() -> void __exit {
