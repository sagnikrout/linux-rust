...
//! Source: drivers/hwtracing/coresight/coresight-etm-cp14.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn etm_readl_cp14(reg: u32, val: *mut c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn etm_writel_cp14(reg: u32, val: u32) -> c_int {
