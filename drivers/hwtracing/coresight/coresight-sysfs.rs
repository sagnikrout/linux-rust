...
//! Source: drivers/hwtracing/coresight/coresight-sysfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn coresight_source_get_refcnt(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn coresight_source_put_refcnt(csdev: *mut coresight_device) {
...
//
    ...
    ret = coresight_enable_source(csdev, core::ptr::null_mut(), mode, path);
    if (ret)
    return ret;
    }
...
//
    ...
    {
    int i;
    struct coresight_device *sink = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn coresight_enable_sysfs(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_disable_sysfs(csdev: *mut coresight_device) {
...
//
    path = csdev.path;
    if (!coresight_disable_source_sysfs(csdev, core::ptr::null_mut()))
    goto out;
    coresight_disable_path(path);
    coresight_release_path(path);
    out:
...
//
#[no_mangle]
pub unsafe extern "C" fn coresight_create_conns_sysfs_group(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_remove_conns_sysfs_group(csdev: *mut coresight_device) {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_add_sysfs_link(info: *mut coresight_sysfs_link) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_remove_sysfs_link(info: *mut coresight_sysfs_link) {
...
//
    ...
    char *outs = core::ptr::null_mut(), *ins = core::ptr::null_mut();
    struct coresight_sysfs_link *link = core::ptr::null_mut();
