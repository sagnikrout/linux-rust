...
//! Source: drivers/hwtracing/coresight/coresight-core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn coresight_set_cti_ops(cti_op: *const cti_assoc_op) {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_remove_cti_ops() {
    void coresight_remove_cti_ops(void)
    {
    cti_assoc_ops = core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(coresight_remove_cti_ops);
#[no_mangle]
pub unsafe extern "C" fn coresight_set_percpu_sink(cpu: c_int, csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn coresight_set_percpu_source(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn coresight_clear_percpu_source(csdev: *mut coresight_device) {
...
// The per-CPU pointer should contain the same csdev
    ...
    per_cpu(csdev_source, csdev.cpu) = core::ptr::null_mut();
    }
...
#[no_mangle]
pub unsafe extern "C" fn coresight_put_percpu_source_ref(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn coresight_read_claim_tags_unlocked(csdev: *mut coresight_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn coresight_set_self_claim_tag_unlocked(csdev: *mut coresight_device) {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_clear_self_claim_tag(csa: *mut csdev_access) {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_clear_self_claim_tag_unlocked(csa: *mut csdev_access) {
...
//
#[no_mangle]
pub unsafe extern "C" fn coresight_claim_device_unlocked(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_claim_device(csdev: *mut coresight_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn coresight_disclaim_device_unlocked(csdev: *mut coresight_device) {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_disclaim_device(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn coresight_disable_sink(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn coresight_is_helper(csdev: *mut coresight_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_disable_source(csdev: *mut coresight_device, data: *mut c_void) {
    void coresight_disable_source(struct coresight_device *csdev, void *data)
    {
    if (!coresight_is_device_source(csdev))
    return;
    if (!coresight_is_percpu_source(csdev))
    csdev.path = core::ptr::null_mut();
    source_ops(csdev).disable(csdev, data);
    }
    EXPORT_SYMBOL_GPL(coresight_disable_source);
#[no_mangle]
pub unsafe extern "C" fn coresight_pause_source(csdev: *mut coresight_device) {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_resume_source(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_disable_path(path: *mut coresight_path) {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_enable_path(path: *mut coresight_path, mode: enum cs_mode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_get_sink_id(csdev: *mut coresight_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn coresight_sink_by_id(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    dev = bus_find_device(&coresight_bustype, core::ptr::null_mut(), &id,
    coresight_sink_by_id);
    return dev ? to_coresight_device(dev) : core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn coresight_get_ref(csdev: *mut coresight_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn coresight_put_ref(csdev: *mut coresight_device) {
...
//
#[no_mangle]
unsafe extern "C" fn coresight_grab_device(csdev: *mut coresight_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn coresight_drop_device(csdev: *mut coresight_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn coresight_release_path(path: *mut coresight_path) {
...
#[no_mangle]
unsafe extern "C" fn coresight_is_def_sink_type(csdev: *mut coresight_device) -> bool {
...
//
    ...
    struct coresight_device *found_sink = core::ptr::null_mut();
...
//
    for (i = 0; i < csdev.pdata.nr_outconns; i++) {
    struct coresight_device *child_dev, *sink = core::ptr::null_mut();
    let mut child_depth: c_int = curr_depth;
    child_dev = csdev.pdata.out_conns[i].dest_dev;
    if (child_dev)
...
#[no_mangle]
unsafe extern "C" fn coresight_remove_sink_ref(dev: *mut device, data: *mut c_void) -> c_int {
    ...
    source.def_sink = core::ptr::null_mut();
    return 0;
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn coresight_clear_default_sink(csdev: *mut coresight_device) {
    static void coresight_clear_default_sink(struct coresight_device *csdev)
    {
    if ((csdev.type == CORESIGHT_DEV_TYPE_SINK) ||
    (csdev.type == CORESIGHT_DEV_TYPE_LINKSINK)) {
    bus_for_each_dev(&coresight_bustype, core::ptr::null_mut(), csdev,
    coresight_remove_sink_ref);
    }
    }
#[no_mangle]
unsafe extern "C" fn coresight_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn coresight_orphan_match(dev: *mut device, data: *mut c_void) -> c_int {
    static int coresight_orphan_match(struct device *dev, void *data)
    {
    int i, ret = 0;
    let mut still_orphan: bool = false;
    struct coresight_device *dst_csdev = data;
    struct coresight_device *src_csdev = to_coresight_device(dev);
    struct coresight_connection *conn;
    let mut fixup_self: bool = (src_csdev == dst_csdev);
...
#[no_mangle]
unsafe extern "C" fn coresight_fixup_orphan_conns(csdev: *mut coresight_device) -> c_int {
    static int coresight_fixup_orphan_conns(struct coresight_device *csdev)
    {
    return bus_for_each_dev(&coresight_bustype, core::ptr::null_mut(),
    csdev, coresight_orphan_match);
    }
#[no_mangle]
unsafe extern "C" fn coresight_clear_filter_source(dev: *mut device, data: *mut c_void) -> c_int {
    ...
    csdev.pdata.out_conns[i].filter_src_dev = core::ptr::null_mut();
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn coresight_remove_conns(csdev: *mut coresight_device) {
    ...
    conn.filter_src_dev = core::ptr::null_mut();
...
//
    ...
    conn.dest_dev.pdata.in_conns[j] = core::ptr::null_mut();
    break;
    }
    }
//
...
// Input conns array is sparse
    ...
    conn.dest_dev = core::ptr::null_mut();
    }
...
//
    ...
    int position, int value)
    {
    return coresight_timeout_action(csa, offset, position, value, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(coresight_timeout);
#[no_mangle]
pub unsafe extern "C" fn coresight_relaxed_read32(csdev: *mut coresight_device, offset: u32) -> u32 {
    u32 coresight_relaxed_read32(struct coresight_device *csdev, u32 offset)
    {
    return csdev_access_relaxed_read32(&csdev.access, offset);
    }
#[no_mangle]
pub unsafe extern "C" fn coresight_read32(csdev: *mut coresight_device, offset: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_write32(csdev: *mut coresight_device, val: u32, offset: u32) {
    void coresight_write32(struct coresight_device *csdev, u32 val, u32 offset)
    {
    csdev_access_write32(&csdev.access, val, offset);
    }
#[no_mangle]
pub unsafe extern "C" fn coresight_relaxed_read64(csdev: *mut coresight_device, offset: u32) -> u64 {
    u64 coresight_relaxed_read64(struct coresight_device *csdev, u32 offset)
    {
    return csdev_access_relaxed_read64(&csdev.access, offset);
    }
#[no_mangle]
pub unsafe extern "C" fn coresight_read64(csdev: *mut coresight_device, offset: u32) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_write64(csdev: *mut coresight_device, val: u64, offset: u32) {
...
//
    ...
    conns[i].dest_fwnode = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn coresight_unregister(csdev: *mut coresight_device) {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_loses_context_with_cpu(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn coresight_release_device_list() {
...
//
    ...
    list.fwnode_list[i] = core::ptr::null_mut();
    list.nr_idx = 0;
    list_del(&list.node);
    kfree(list.pfx);
...
//
    return is_active ? source.path : core::ptr::null_mut();
    }
// Return: 1 if PM is required, 0 if skip, or a negative error
#[no_mangle]
unsafe extern "C" fn coresight_pm_is_needed(path: *mut coresight_path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coresight_pm_device_save(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coresight_pm_device_restore(csdev: *mut coresight_device) {
...
#[no_mangle]
unsafe extern "C" fn coresight_pm_save(path: *mut coresight_path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coresight_pm_restore(path: *mut coresight_path) {
...
#[no_mangle]
unsafe extern "C" fn coresight_dying_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coresight_pm_setup() -> int __init {
    ...
    core::ptr::null_mut(), coresight_dying_cpu);
    if (ret)
    cpu_pm_unregister_notifier(&coresight_cpu_pm_nb);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn coresight_pm_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn coresight_panic_sync(dev: *mut device, data: *mut c_void) -> c_int {
...
// Run through panic sync handlers for all enabled devices
    ...
    {
    bus_for_each_dev(&coresight_bustype, core::ptr::null_mut(), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn coresight_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn coresight_exit() -> void __exit {
