...
//! Source: drivers/hwtracing/coresight/coresight-platform.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn coresight_add_in_conn(out_conn: *mut coresight_connection) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_coresight_legacy_ep_is_input(ep: *mut device_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn of_coresight_get_cpu(dev: *mut device) -> c_int {
...
//
    ...
    struct device_node *rparent = core::ptr::null_mut();
    struct device_node *rep = core::ptr::null_mut();
    struct device *rdev = core::ptr::null_mut();
...
//
    ...
    conn.filter_src_fwnode = core::ptr::null_mut();
    } else {
    conn.filter_src_dev =
...
// Connection record updated
    ...
    {
    let mut ret: c_int = 0;
    struct device_node *ep = core::ptr::null_mut();
    const struct device_node *parent = core::ptr::null_mut();
    let mut legacy_binding: bool = false;
...
// Coresight ACPI Graph UUID : "3ecbc8b6-1d0e-4fb3-8107-e627f805c6cd"
    ...
    0x81, 0x07, 0xe6, 0x27,
    0xf8, 0x05, 0xc6, 0xcd);
pub const ACPI_CORESIGHT_LINK_SLAVE: c_int = 0;
pub const ACPI_CORESIGHT_LINK_MASTER: c_int = 1;
#[no_mangle]
unsafe extern "C" fn is_acpi_guid(obj: *const union acpi_object) -> bool {
...
#[no_mangle]
unsafe extern "C" fn is_acpi_dsd_graph_guid(obj: *const union acpi_object) -> bool {
    static bool is_acpi_dsd_graph_guid(const union acpi_object *obj)
    {
    return acpi_guid_matches(obj, &acpi_graph_uuid);
    }
#[no_mangle]
unsafe extern "C" fn is_acpi_coresight_graph_guid(obj: *const union acpi_object) -> bool {
    static bool is_acpi_coresight_graph_guid(const union acpi_object *obj)
    {
    return acpi_guid_matches(obj, &coresight_graph_uuid);
    }
#[no_mangle]
unsafe extern "C" fn is_acpi_coresight_graph(obj: *const union acpi_object) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_validate_dsd_graph(graph: *const union acpi_object) -> bool {
...
// acpi_get_dsd_graph	- Find the _DSD Graph property for the given device.
    ...
    status = acpi_evaluate_object_typed(adev.handle, "_DSD", core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn acpi_coresight_get_cpu(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_get_cpu(dev: *mut device) -> c_int {
    int coresight_get_cpu(struct device *dev)
    {
    if (is_of_node(dev.fwnode))
    return of_coresight_get_cpu(dev);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_acpi_device_node(dev->fwnode)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn coresight_get_static_trace_id(dev: *mut device, id: *mut u32) -> c_int {
