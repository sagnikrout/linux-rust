...
//! Source: drivers/hwtracing/coresight/coresight-cpu-debug.c
#![no_std]
...
pub const EDPCSR: c_uint = 0x0A0;
pub const EDCIDSR: c_uint = 0x0A4;
pub const EDVIDSR: c_uint = 0x0A8;
pub const EDPCSR_HI: c_uint = 0x0AC;
pub const EDOSLAR: c_uint = 0x300;
pub const EDPRCR: c_uint = 0x310;
pub const EDPRSR: c_uint = 0x314;
pub const EDDEVID1: c_uint = 0xFC4;
pub const EDDEVID: c_uint = 0xFC8;
pub const EDPCSR_PROHIBITED: c_uint = 0xFFFFFFFF;
...
pub const DEBUG_WAIT_SLEEP: c_int = 1000;
pub const DEBUG_WAIT_TIMEOUT: c_int = 32000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct debug_drvdata {
    pub pclk: *mut clk,
    pub base: *mut void __iomem,
    pub dev: *mut device,
    pub cpu: c_int,
    pub edpcsr_present: bool,
    pub edcidsr_present: bool,
    pub edvidsr_present: bool,
    pub pc_has_offset: bool,
    pub edpcsr: u32,
    pub edpcsr_hi: u32,
    pub edprsr: u32,
    pub edvidsr: u32,
    ...
    let mut debug_enable: static bool = IS_ENABLED(CONFIG_CORESIGHT_CPU_DEBUG_DEFAULT_ON);
    module_param_named(enable, debug_enable, bool, 0600);
    MODULE_PARM_DESC(enable, "Control to enable coresight CPU debug functionality");
#[no_mangle]
unsafe extern "C" fn debug_os_unlock(drvdata: *mut debug_drvdata) {
...
//
#[no_mangle]
unsafe extern "C" fn debug_access_permitted(drvdata: *mut debug_drvdata) -> bool {
...
#[no_mangle]
unsafe extern "C" fn debug_force_cpu_powered_up(drvdata: *mut debug_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn debug_read_regs(drvdata: *mut debug_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn debug_adjust_pc(drvdata: *mut debug_drvdata) -> c_ulong {
...
unsafe extern "C" fn debug_adjust_pc(drvdata: *mut debug_drvdata) -> c_ulong {
    static unsigned long debug_adjust_pc(struct debug_drvdata *drvdata)
    {
    let mut arm_inst_offset: c_ulong = 0, thumb_inst_offset = 0;
    unsigned long pc;
...
#[no_mangle]
unsafe extern "C" fn debug_dump_regs(drvdata: *mut debug_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn debug_init_arch_data(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn debug_enable_func() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_disable_func() {
...
#[no_mangle]
unsafe extern "C" fn debug_func_init() -> c_int {
    static int debug_func_init(void)
    {
    int ret;
// Create debugfs node
    debug_debugfs_dir = debugfs_create_dir("coresight_cpu_debug", core::ptr::null_mut());
    debugfs_create_file("enable", 0644, debug_debugfs_dir, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn debug_func_exit() {
...
#[no_mangle]
unsafe extern "C" fn __debug_probe(dev: *mut device, res: *mut resource) -> c_int {
...
// Turn off debug power domain if debugging is disabled
    ...
    debug_count--;
    err:
    per_cpu(debug_drvdata, drvdata.cpu) = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn debug_probe(adev: *mut amba_device, id: *const amba_id) -> c_int {
    static int debug_probe(struct amba_device *adev, const struct amba_id *id)
    {
    return __debug_probe(&adev.dev, &adev.res);
    }
#[no_mangle]
unsafe extern "C" fn __debug_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn debug_remove(adev: *mut amba_device) {
...
#[no_mangle]
unsafe extern "C" fn debug_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_platform_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn debug_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn debug_runtime_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(debug_runtime_suspend, debug_runtime_resume, core::ptr::null_mut())
    };
...
#[no_mangle]
unsafe extern "C" fn debug_exit() -> void __exit {
