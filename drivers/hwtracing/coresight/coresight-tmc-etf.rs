...
//! Source: drivers/hwtracing/coresight/coresight-tmc-etf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __tmc_etb_enable_hw(drvdata: *mut tmc_drvdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmc_etb_enable_hw(drvdata: *mut tmc_drvdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmc_etb_dump_hw(drvdata: *mut tmc_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn __tmc_etb_disable_hw(drvdata: *mut tmc_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn tmc_etb_disable_hw(drvdata: *mut tmc_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn __tmc_etf_enable_hw(drvdata: *mut tmc_drvdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmc_etf_enable_hw(drvdata: *mut tmc_drvdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmc_etf_disable_hw(drvdata: *mut tmc_drvdata) {
...
#[no_mangle]
unsafe extern "C" fn tmc_enable_etf_sink_sysfs(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmc_disable_etf_sink(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmc_free_etf_buffer(config: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tmc_panic_sync_etf(csdev: *mut coresight_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tmc_read_prepare_etb(drvdata: *mut tmc_drvdata) -> c_int {
...
// If drvdata::buf is NULL the trace data has been read already
    if (drvdata.buf == core::ptr::null_mut()) {
    ret = -EINVAL;
    goto out;
    }
...
#[no_mangle]
pub unsafe extern "C" fn tmc_read_unprepare_etb(drvdata: *mut tmc_drvdata) -> c_int {
