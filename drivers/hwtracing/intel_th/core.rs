...
//! Source: drivers/hwtracing/intel_th/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn intel_th_match(dev: *mut device, driver: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_th_child_remove(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_th_probe(dev: *mut device) -> c_int {
    static int intel_th_probe(struct device *dev)
    {
    struct intel_th_driver *thdrv = to_intel_th_driver(dev.driver);
    struct intel_th_device *thdev = to_intel_th_device(dev);
    struct intel_th_driver *hubdrv;
    struct intel_th_device *hub = core::ptr::null_mut();
    int ret;
    if (thdev.type == INTEL_TH_SWITCH)
    hub = thdev;
#[no_mangle]
...
#[no_mangle]
unsafe extern "C" fn intel_th_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn intel_th_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn intel_th_trace_prepare(thdev: *mut intel_th_device) {
...
#[no_mangle]
unsafe extern "C" fn intel_th_output_activate(thdev: *mut intel_th_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_th_output_deactivate(thdev: *mut intel_th_device) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_th_driver_register(thdrv: *mut intel_th_driver) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn intel_th_driver_unregister(thdrv: *mut intel_th_driver) {
...
#[no_mangle]
unsafe extern "C" fn intel_th_device_remove(thdev: *mut intel_th_device) {
    static void intel_th_device_remove(struct intel_th_device *thdev)
    {
...
#[no_mangle]
unsafe extern "C" fn intel_th_device_free(thdev: *mut intel_th_device) {
    static void intel_th_device_free(struct intel_th_device *thdev)
    {
...
#[no_mangle]
unsafe extern "C" fn __intel_th_request_hub_module(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn intel_th_request_hub_module(th: *mut intel_th) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_th_request_hub_module_flush(th: *mut intel_th) {
...
#[no_mangle]
pub unsafe extern "C" fn intel_th_request_hub_module(th: *mut intel_th) -> c_int {
    static inline int intel_th_request_hub_module(struct intel_th *th)
    {
    return -EINVAL;
    }
#[no_mangle]
pub unsafe extern "C" fn intel_th_request_hub_module_flush(th: *mut intel_th) {
    ...
    let mut bar: c_int = TH_MMIO_CONFIG;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_th_output_enable(th: *mut intel_th, otype: c_uint) -> c_int {
    int intel_th_output_enable(struct intel_th *th, unsigned int otype)
    {
    struct intel_th_device *thdev;
    let mut src: c_int = 0, dst = 0;
...
#[no_mangle]
unsafe extern "C" fn intel_th_populate(th: *mut intel_th) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_th_output_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_th_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn intel_th_free(th: *mut intel_th) {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_th_trace_enable(thdev: *mut intel_th_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_th_trace_switch(thdev: *mut intel_th_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_th_trace_disable(thdev: *mut intel_th_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_th_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn intel_th_exit() -> void __exit {
