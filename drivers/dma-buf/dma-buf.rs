...
//! Source: drivers/dma-buf/dma-buf.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dma_buf_sg_table_wrapper {
    pub original: *mut sg_table,
    pub wrapper: sg_table,
}
...
#[no_mangle]
unsafe extern "C" fn __dma_buf_list_add(dmabuf: *mut dma_buf) {
...
#[no_mangle]
unsafe extern "C" fn __dma_buf_list_del(dmabuf: *mut dma_buf) {
...
//
    ...
    {
    struct dma_buf *ret = core::ptr::null_mut(), *dmabuf;
//
...
//
    ...
    {
    struct dma_buf *ret = core::ptr::null_mut();
//
// The list mutex does not protect a dmabuf's refcount, so it can be
// zeroed while we are iterating. We cannot call get_dma_buf() since the
// caller may not already own a reference to the buffer.
...
#[no_mangle]
unsafe extern "C" fn dma_buf_release(dentry: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_file_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_fs_init_context(fc: *mut fs_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_mmap_internal(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_llseek(file: *mut file, offset: loff_t, whence: c_int) -> loff_t {
...
//
    ...
    base = dmabuf.size;
#[no_mangle]
pub unsafe extern "C" fn if(SEEK_SET: whence ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn dma_buf_poll_cb(fence: *mut dma_fence, cb: *mut dma_fence_cb) {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_poll(file: *mut file, poll: *mut poll_table) -> __poll_t {
...
// No callback queued, wake up any other waiters
    dma_buf_poll_cb(core::ptr::null_mut(), &dcb.cb);
    else
    events &= ~EPOLLOUT;
    }
    }
...
//
#[no_mangle]
unsafe extern "C" fn dma_buf_set_name(dmabuf: *mut dma_buf, buf: *const char __user) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_show_fdinfo(m: *mut seq_file, file: *mut file) {
...
//
#[no_mangle]
pub unsafe extern "C" fn is_dma_buf_file(file: *mut file) -> c_int {
    ...
    {
    let mut dmabuf_inode: static atomic64_t = ATOMIC64_INIT(0);
...
//
    ...
    struct file *file;
    let mut alloc_size: usize = sizeof(struct dma_buf);
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_fd(dmabuf: *mut dma_buf, flags: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_fd_install(dmabuf: *mut dma_buf, fd: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_put(dmabuf: *mut dma_buf) {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_wrap_sg_table(sg_table: *mut sg_table) -> c_int {
...
//
    ...
    to_sg.offset = 0;
    to_sg.length = 0;
    sg_assign_page(to_sg, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dma_buf_unwrap_sg_table(sg_table: *mut sg_table) {
...
//
    ...
    struct device *dev)
    {
    return dma_buf_dynamic_attach(dmabuf, dev, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_detach(dmabuf: *mut dma_buf, attach: *mut dma_buf_attachment) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_pin(attach: *mut dma_buf_attachment) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_unpin(attach: *mut dma_buf_attachment) {
...
//
    ...
    if (WARN_ON(!attach || !attach.dmabuf))
    return ERR_PTR(-EINVAL);
    dma_resv_lock(attach.dmabuf.resv, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_attach_revocable(attach: *mut dma_buf_attachment) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_invalidate_mappings(dmabuf: *mut dma_buf) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_vmap(dmabuf: *mut dma_buf, map: *mut iosys_map) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_vmap_unlocked(dmabuf: *mut dma_buf, map: *mut iosys_map) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_vunmap(dmabuf: *mut dma_buf, map: *mut iosys_map) {
    void dma_buf_vunmap(struct dma_buf *dmabuf, struct iosys_map *map)
    {
    if (WARN_ON(!dmabuf))
    return;
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_buf_vunmap_unlocked(dmabuf: *mut dma_buf, map: *mut iosys_map) {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_debug_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int dma_buf_debug_show(struct seq_file *s, void *unused)
    {
    struct dma_buf *buf_obj;
    struct dma_buf_attachment *attach_obj;
    let mut count: c_int = 0, attach_count;
    ...
    ret = dma_resv_lock_interruptible(buf_obj.resv, core::ptr::null_mut());
    if (ret)
    goto error_unlock;
...
#[no_mangle]
unsafe extern "C" fn dma_buf_init_debugfs() -> c_int {
    static int dma_buf_init_debugfs(void)
    {
    struct dentry *d;
    let mut err: c_int = 0;
    d = debugfs_create_dir("dma_buf", core::ptr::null_mut());
    if (IS_ERR(d))
    return PTR_ERR(d);
    dma_buf_debugfs_dir = d;
    d = debugfs_create_file("bufinfo", 0444, dma_buf_debugfs_dir,
    core::ptr::null_mut(), &dma_buf_debug_fops);
    if (IS_ERR(d)) {
    pr_debug("dma_buf: debugfs: failed to create node bufinfo\n");
    debugfs_remove_recursive(dma_buf_debugfs_dir);
    dma_buf_debugfs_dir = core::ptr::null_mut();
    err = PTR_ERR(d);
    }
    return err;
    }
#[no_mangle]
unsafe extern "C" fn dma_buf_uninit_debugfs() {
...
#[no_mangle]
pub unsafe extern "C" fn dma_buf_init_debugfs() -> c_int {
    static inline int dma_buf_init_debugfs(void)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn dma_buf_uninit_debugfs() {
    static inline void dma_buf_uninit_debugfs(void)
    {
    }

#[no_mangle]
unsafe extern "C" fn dma_buf_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dma_buf_deinit() -> void __exit {
