...
//! Source: drivers/dma-buf/dma-heap.c
#![no_std]
...
pub const NUM_HEAP_MINORS: c_int = 128;
//
...
#[no_mangle]
unsafe extern "C" fn dma_heap_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_heap_init() -> c_int {
