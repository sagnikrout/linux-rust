...
//! Source: drivers/dma-buf/dma-fence.c
#![no_std]
...
//
    let mut dma_fence_context_counter: static atomic64_t = ATOMIC64_INIT(1);
//
...
#[no_mangle]
unsafe extern "C" fn dma_fence_init_stub() -> int __init {
    static int __init dma_fence_init_stub(void)
    {
    dma_fence_init(&dma_fence_stub, &dma_fence_stub_ops, core::ptr::null_mut(), 0, 0);
...
//
    ...
    dma_fence_init(fence, &dma_fence_stub_ops, core::ptr::null_mut(), 0, 0);
    set_bit(DMA_FENCE_FLAG_ENABLE_SIGNAL_BIT,
    &fence.flags);
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_fence_context_alloc(num: unsigned) -> u64 {
...
// ... and non-recursive successful read_trylock
    lock_acquire(&dma_fence_lockdep_map, 0, 1, 1, 1, core::ptr::null_mut(), _RET_IP_);
    return false;
    }
...
pub unsafe extern "C" fn __dma_fence_might_wait() {
    ...
    if (tmp)
    lock_acquire(&dma_fence_lockdep_map, 0, 1, 1, 1, core::ptr::null_mut(), _THIS_IP_);
    }
...
//
    ...
    RCU_INIT_POINTER(fence.ops, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_fence_signal_locked(fence: *mut dma_fence) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_fence_free(fence: *mut dma_fence) {
...
#[no_mangle]
unsafe extern "C" fn __dma_fence_enable_signaling(fence: *mut dma_fence) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_fence_enable_signaling(fence: *mut dma_fence) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_fence_get_status(fence: *mut dma_fence) -> c_int {
...
//
    ...
    unsigned long flags;
    let mut ret: signed long = timeout ? timeout : 1;
    dma_fence_lock_irqsave(fence, flags);
    if (dma_fence_test_signaled_flag(fence))
    goto out;
...
//
    ...
    {
    struct default_wait_cb *cb;
    let mut ret: signed long = timeout;
    unsigned i;
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_fence_set_deadline(fence: *mut dma_fence, deadline: ktime_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_fence_describe(fence: *mut dma_fence, seq: *mut seq_file) {
