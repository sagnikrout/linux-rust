...
//! Source: drivers/dma-buf/st-dma-fence-chain.c
#![no_std]
...
unsafe extern "C" fn test_sanitycheck(test: *mut kunit) {
    ...
    chain = mock_chain(core::ptr::null_mut(), f, 1);
    if (chain)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fence_chains {
    pub chain_length: c_uint,
    pub fences: *mut dma_fence,
    pub chains: *mut dma_fence,
    pub tail: *mut dma_fence,
}

#[no_mangle]
unsafe extern "C" fn seqno_inc(i: c_uint) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn fence_chains_fini(fc: *mut fence_chains) {
...
#[no_mangle]
unsafe extern "C" fn test_find_seqno(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_find_signaled(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_find_out_of_order(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn seqno_inc2(i: c_uint) -> u64 {
    static uint64_t seqno_inc2(unsigned int i)
    {
    return 2 * i + 2;
    }
#[no_mangle]
unsafe extern "C" fn test_find_gap(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct find_race {
    pub fc: fence_chains,
    pub children: core::sync::atomic::AtomicI32,
}

#[no_mangle]
unsafe extern "C" fn __find_race(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_find_race(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_signal_forward(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_signal_backward(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn __wait_fence_chains(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn test_wait_forward(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_wait_backward(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn randomise_fences(fc: *mut fence_chains) {
    static void randomise_fences(struct fence_chains *fc)
    {
    let mut count: c_uint = fc.chain_length;
...
#[no_mangle]
unsafe extern "C" fn test_wait_random(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn dma_fence_chain_suite_init(suite: *mut kunit_suite) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dma_fence_chain_suite_exit(suite: *mut kunit_suite) {
