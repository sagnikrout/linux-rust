...
//! Source: drivers/dma-buf/dma-fence-unwrap.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn fence_cmp(_a: *const c_void, _b: *const c_void) -> c_int {
    ...
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(b->context: a->context >) -> else {
    else if (a.context > b.context)
    return 1;
    if (dma_fence_is_later(b, a))
    return 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dma_fence_is_later(a, _arg: b)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn dma_fence_dedup_array(fences: *mut dma_fence, num_fences: usize) -> usize {
    size_t dma_fence_dedup_array(struct dma_fence **fences, size_t num_fences)
    {
    size_t i, j;
    if (!num_fences)
    return 0;
    sort(fences, num_fences, sizeof(*fences), fence_cmp, core::ptr::null_mut());
//
...
// Implementation for the dma_fence_merge() marco, don't use directly
    ...
    {
    struct dma_fence *tmp, *unsignaled = core::ptr::null_mut(), **array;
    ...
    let mut t: ktime_t = dma_fence_timestamp(tmp);
