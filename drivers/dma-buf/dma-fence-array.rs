...
//! Source: drivers/dma-buf/dma-fence-array.c
#![no_std]
...
pub const PENDING_ERROR: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn dma_fence_array_clear_pending_error(array: *mut dma_fence_array) {
...
//
    ...
    let mut error: c_int = array.fences[i].error;
...
//
    ...
    dma_fence_init(&array.base, &dma_fence_array_ops, core::ptr::null_mut(), context,
    seqno);
