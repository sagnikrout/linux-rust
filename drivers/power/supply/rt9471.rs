...
//! Source: drivers/power/supply/rt9471.c
#![no_std]
...
pub const RT9471_REG_OTGCFG: c_uint = 0x00;
pub const RT9471_REG_TOP: c_uint = 0x01;
pub const RT9471_REG_FUNC: c_uint = 0x02;
pub const RT9471_REG_IBUS: c_uint = 0x03;
pub const RT9471_REG_VBUS: c_uint = 0x04;
pub const RT9471_REG_PRECHG: c_uint = 0x05;
pub const RT9471_REG_VCHG: c_uint = 0x07;
pub const RT9471_REG_ICHG: c_uint = 0x08;
pub const RT9471_REG_CHGTMR: c_uint = 0x09;
pub const RT9471_REG_EOC: c_uint = 0x0A;
pub const RT9471_REG_INFO: c_uint = 0x0B;
pub const RT9471_REG_JEITA: c_uint = 0x0C;
pub const RT9471_REG_PUMP_EXP: c_uint = 0x0D;
pub const RT9471_REG_DPDMDET: c_uint = 0x0E;
pub const RT9471_REG_ICSTAT: c_uint = 0x0F;
pub const RT9471_REG_STAT0: c_uint = 0x10;
pub const RT9471_REG_STAT1: c_uint = 0x11;
pub const RT9471_REG_STAT2: c_uint = 0x12;
pub const RT9471_REG_IRQ0: c_uint = 0x20;
pub const RT9471_REG_MASK0: c_uint = 0x30;

pub const RT9471_NUM_IRQ_REGS: c_int = 4;
pub const RT9471_OTGCV_MINUV: c_int = 4850000;
pub const RT9471_OTGCV_STEPUV: c_int = 150000;
pub const RT9471_NUM_VOTG: c_int = 4;
pub const RT9471_VCHG_MAXUV: c_int = 4700000;
pub const RT9471_ICHG_MAXUA: c_int = 3150000;
// Device ID
pub const RT9470_DEVID: c_uint = 0x09;
pub const RT9470D_DEVID: c_uint = 0x0A;
pub const RT9471_DEVID: c_uint = 0x0D;
pub const RT9471D_DEVID: c_uint = 0x0E;
// IRQ number
pub const RT9471_IRQ_BC12_DONE: c_int = 0;
pub const RT9471_IRQ_DETACH: c_int = 1;
pub const RT9471_IRQ_RECHG: c_int = 2;
pub const RT9471_IRQ_CHG_DONE: c_int = 3;
pub const RT9471_IRQ_BG_CHG: c_int = 4;
pub const RT9471_IRQ_IE0C: c_int = 5;
pub const RT9471_IRQ_CHG_RDY: c_int = 6;
pub const RT9471_IRQ_VBUS_GD: c_int = 7;
pub const RT9471_IRQ_CHG_BATOV: c_int = 9;
pub const RT9471_IRQ_CHG_SYSOV: c_int = 10;
pub const RT9471_IRQ_CHG_TOUT: c_int = 11;
pub const RT9471_IRQ_CHG_BUSUV: c_int = 12;
pub const RT9471_IRQ_CHG_THREG: c_int = 13;
pub const RT9471_IRQ_CHG_AICR: c_int = 14;
pub const RT9471_IRQ_CHG_MIVR: c_int = 15;
pub const RT9471_IRQ_SYS_SHORT: c_int = 16;
pub const RT9471_IRQ_SYS_MIN: c_int = 17;
pub const RT9471_IRQ_AICC_DONE: c_int = 18;
pub const RT9471_IRQ_PE_DONE: c_int = 19;
pub const RT9471_IRQ_JEITA_COLD: c_int = 20;
pub const RT9471_IRQ_JEITA_COOL: c_int = 21;
pub const RT9471_IRQ_JEITA_WARM: c_int = 22;
pub const RT9471_IRQ_JEITA_HOT: c_int = 23;
pub const RT9471_IRQ_OTG_FAULT: c_int = 24;
pub const RT9471_IRQ_OTG_LBP: c_int = 25;
pub const RT9471_IRQ_OTG_CC: c_int = 26;
pub const RT9471_IRQ_WDT: c_int = 29;
pub const RT9471_IRQ_VAC_OV: c_int = 30;
pub const RT9471_IRQ_OTP: c_int = 31;
    enum rt9471_fields {
    F_WDT = 0,
    F_WDT_RST,
    F_CHG_EN,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt9471_chip {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub rm_fields: [*mut regmap_field; F_MAX_FIELDS],
...
#[no_mangle]
unsafe extern "C" fn rt9471_set_ieoc(chip: *mut rt9471_chip, microamp: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9471_get_ieoc(chip: *mut rt9471_chip, microamp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9471_get_status(chip: *mut rt9471_chip, status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9471_get_vbus_good(chip: *mut rt9471_chip, stat: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9471_get_usb_type(chip: *mut rt9471_chip, usb_type: *mut c_int) -> c_int {
...
// microamp = chip->psy_usb_curr;
    ...
    let mut rt9471_manufacturer: *const static char  const = "Richtek Technology Corp.";
    let mut rt9471_model: *const static char  const = "RT9471";
...
#[no_mangle]
unsafe extern "C" fn rt9471_vbus_gd_handler(irqno: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9471_detach_handler(irqno: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9471_bc12_done_handler(irqno: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9471_wdt_handler(irqno: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9471_otg_fault_handler(irqno: c_int, devid: *mut c_void) -> irqreturn_t {
    static irqreturn_t rt9471_otg_fault_handler(int irqno, void *devid)
    {
    struct rt9471_chip *chip = devid;
    regulator_notifier_call_chain(chip.otg_rdev, REGULATOR_EVENT_FAIL, core::ptr::null_mut());
    return IRQ_HANDLED;
    }
...
#[no_mangle]
unsafe extern "C" fn rt9471_register_interrupts(chip: *mut rt9471_chip) -> c_int {
    ...
    if (virq <= 0)
    return virq;
    ret = devm_request_threaded_irq(dev, virq, core::ptr::null_mut(), curr.handler,
...
#[no_mangle]
unsafe extern "C" fn rt9471_register_otg_regulator(chip: *mut rt9471_chip) -> c_int {
    static int rt9471_register_otg_regulator(struct rt9471_chip *chip)
    {
    struct device *dev = chip.dev;
    let mut cfg: regulator_config = { .dev = dev, .driver_data = chip };
...
#[no_mangle]
unsafe extern "C" fn rt9471_register_psy(chip: *mut rt9471_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9471_check_devinfo(chip: *mut rt9471_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9471_accessible_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt9471_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9471_shutdown(i2c: *mut i2c_client) {
