...
//! Source: drivers/power/supply/sgm41542_charger.c
#![no_std]
...
pub const SGM4154X_CHRG_CTRL_0: c_uint = 0x00;

pub const SGM4154X_IINDPM_I_MIN_UA: c_int = 100000;
pub const SGM4154X_IINDPM_I_MAX_UA: c_int = 3800000;
pub const SGM4154X_IINDPM_STEP_UA: c_int = 100000;
pub const SGM4154X_IINDPM_DEF_UA: c_int = 2400000;
pub const SGM4154X_CHRG_CTRL_1: c_uint = 0x01;

pub const SGM4154X_CHRG_CTRL_2: c_uint = 0x02;

pub const SGM4154X_ICHRG_I_STEP_UA: c_int = 60000;
pub const SGM4154X_ICHRG_I_MIN_UA: c_int = 0;
pub const SGM4154X_ICHRG_I_MAX_UA: c_int = 3780000;
pub const SGM4154X_ICHRG_I_DEF_UA: c_int = 2040000;
pub const SGM4154X_CHRG_CTRL_3: c_uint = 0x03;

pub const SGM4154X_PRECHRG_CURRENT_STEP_UA: c_int = 60000;
pub const SGM4154X_PRECHRG_I_MIN_UA: c_int = 60000;
pub const SGM4154X_PRECHRG_I_MAX_UA: c_int = 780000;
pub const SGM4154X_PRECHRG_I_DEF_UA: c_int = 180000;

pub const SGM4154X_TERMCHRG_CURRENT_STEP_UA: c_int = 60000;
pub const SGM4154X_TERMCHRG_I_MIN_UA: c_int = 60000;
pub const SGM4154X_TERMCHRG_I_MAX_UA: c_int = 960000;
pub const SGM4154X_TERMCHRG_I_DEF_UA: c_int = 180000;
pub const SGM4154X_CHRG_CTRL_4: c_uint = 0x04;

pub const SGM4154X_VREG_V_MAX_UV: c_int = 4624000;
pub const SGM4154X_VREG_V_MIN_UV: c_int = 3856000;
pub const SGM4154X_VREG_V_DEF_UV: c_int = 4208000;
pub const SGM4154X_VREG_V_STEP_UV: c_int = 32000;

pub const SGM4154X_VRECHRG_STEP_UV: c_int = 100000;
pub const SGM4154X_VRECHRG_OFFSET_UV: c_int = 100000;
pub const SGM4154X_CHRG_CTRL_5: c_uint = 0x05;

pub const SGM4154X_CHRG_CTRL_6: c_uint = 0x06;

pub const SGM4154X_OVP_5_5V: c_int = 0;

pub const SGM4154X_VINDPM_V_MIN_UV: c_int = 3900000;
pub const SGM4154X_VINDPM_V_MAX_UV: c_int = 12000000;
pub const SGM4154X_VINDPM_STEP_UV: c_int = 100000;
pub const SGM4154X_VINDPM_DEF_UV: c_int = 4500000;
pub const SGM4154X_CHRG_CTRL_7: c_uint = 0x07;
pub const SGM4154X_CHRG_STAT: c_uint = 0x08;

pub const SGM4154X_NOT_CHRGING: c_int = 0;

pub const SGM4154X_CHRG_FAULT: c_uint = 0x09;

pub const SGM4154X_CHRG_CTRL_A: c_uint = 0x0a;

pub const SGM4154X_CHRG_CTRL_B: c_uint = 0x0b;

pub const SGM4154X_CHRG_CTRL_C: c_uint = 0x0c;
pub const SGM4154X_CHRG_CTRL_D: c_uint = 0x0d;

pub const SGM4154X_INPUT_DET: c_uint = 0x0e;

pub const SGM4154X_CHRG_CTRL_F: c_uint = 0x0f;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sgm4154x_init_data {
    pub /: *mut *mut int ilim; / input current limit,
    pub /: *mut *mut int vlim; / minimum system voltage limit,
    pub /: *mut *mut int iterm; / termination current,
    pub /: *mut *mut int iprechg; / precharge current,
    pub /: *mut *mut int max_ichg; / maximum charge current,
    pub /: *mut *mut int max_vreg; / maximum charge voltage,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sgm4154x_state {
    pub vsys_stat: bool,
    pub therm_stat: bool,
    pub online: bool,
    pub chrg_stat: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sgm4154x_device {
    pub dev: *mut device,
    pub charger: *mut power_supply,
    pub regmap: *mut regmap,
    pub init_data: sgm4154x_init_data,
    pub state: sgm4154x_state,
    pub otg_rdev: *mut regulator_dev,
    pub lock: mutex,
    pub watchdog_enable: bool,
    pub sgm_monitor_wq: *mut workqueue_struct,
    pub sgm_delay_work: delayed_work,
}
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_set_term_curr(sgm: *mut sgm4154x_device, cur_ua: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_set_prechrg_curr(sgm: *mut sgm4154x_device, cur_ua: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_set_ichrg_curr(sgm: *mut sgm4154x_device, cur_ua: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_get_ichrg_curr(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_set_chrg_volt(sgm: *mut sgm4154x_device, chrg_volt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_get_chrg_volt(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_set_input_curr_lim(sgm: *mut sgm4154x_device, iindpm: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_get_input_curr_lim(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_watchdog_timer_reset(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_set_watchdog_timer(sgm: *mut sgm4154x_device, time: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_enable_charger(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_disable_charger(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_set_vac_ovp(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_set_recharge_volt_ua(sgm: *mut sgm4154x_device, recharge_volt: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !state.chrg_stat) -> else {
    else if (!state.chrg_stat)
    val.intval = POWER_SUPPLY_STATUS_NOT_CHARGING;
#[no_mangle]
pub unsafe extern "C" fn if(SGM4154X_TERM_CHRG: state.chrg_stat ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_irq_handler_thread(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_hw_init(psy: *mut power_supply) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_vbus_regulator_register(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_hw_chipid_detect(sgm: *mut sgm4154x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm_charger_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_disable_irq_wake(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sgm4154x_resume(dev: *mut device) -> int __maybe_unused {
