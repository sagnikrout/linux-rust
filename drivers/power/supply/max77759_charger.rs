...
//! Source: drivers/power/supply/max77759_charger.c
#![no_std]
...
pub const CHG_CC_DEFAULT_UA: c_int = 2266770;
pub const CHG_FV_DEFAULT_MV: c_int = 4300;
pub const MAX_NUM_RETRIES: c_int = 3;
pub const PSY_WORK_RETRY_DELAY_MS: c_int = 10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77759_charger {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub psy: *mut power_supply,
    pub chgin_otg_rdev: *mut regulator_dev,
    pub nb: notifier_block,
    pub tcpm_psy: *mut power_supply,
    pub psy_work: delayed_work,
    pub /: *mut *mut mutex retry_lock; / Protects psy_work_retry_cnt,
    pub psy_work_retry_cnt: u32,
    pub irqs: [c_int; NUM_IRQS],
    pub /: *mut *mut mutex lock; / protects the state below,
    pub mode: enum max77759_chgr_mode,
}

#[no_mangle]
pub unsafe extern "C" fn unlock_prot_regs(chg: *mut max77759_charger, unlock: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn charger_input_valid(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_online(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_status(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_charge_type(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_chg_health(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_batt_health(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_health(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_fast_charge_current(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_float_voltage(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_float_voltage_limit(chg: *mut max77759_charger, fv_mv: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_input_current_limit(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_input_current_limit(chg: *mut max77759_charger, ilim_ua: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_chgin_otg(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn disable_chgin_otg(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chgin_otg_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bat_oilo_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max77759_init_irqhandler(chg: *mut max77759_charger) -> c_int {
    ...
    ret = devm_request_threaded_irq(dev, chg.irqs[i], core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn max77759_charger_init(chg: *mut max77759_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psy_work_item(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn psy_changed(nb: *mut notifier_block, evt: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max_tcpci_unregister_psy_notifier(nb: *mut c_void) {
    static void max_tcpci_unregister_psy_notifier(void *nb)
    {
    power_supply_unreg_notifier(nb);
    }
#[no_mangle]
unsafe extern "C" fn max77759_charger_probe(pdev: *mut platform_device) -> c_int {
