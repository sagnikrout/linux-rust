...
//! Source: drivers/power/supply/ltc4162-l-charger.c
#![no_std]
...
pub const LTC4162L_EN_LIMIT_ALERTS_REG: c_uint = 0x0D;
pub const LTC4162L_EN_CHARGER_STATE_ALERTS_REG: c_uint = 0x0E;
pub const LTC4162L_EN_CHARGE_STATUS_ALERTS_REG: c_uint = 0x0F;
pub const LTC4162L_CONFIG_BITS_REG: c_uint = 0x14;
pub const LTC4162L_IIN_LIMIT_TARGET: c_uint = 0x15;
pub const LTC4162L_ARM_SHIP_MODE: c_uint = 0x19;

pub const LTC4162L_C_OVER_X_THRESHOLD: c_uint = 0x1C;

pub const LTC4162L_CHARGER_CONFIG_BITS: c_uint = 0x29;
pub const LTC4162L_CHARGER_STATE: c_uint = 0x34;
pub const LTC4162L_CHARGE_STATUS: c_uint = 0x35;
pub const LTC4162L_LIMIT_ALERTS_REG: c_uint = 0x36;
pub const LTC4162L_CHARGER_STATE_ALERTS_REG: c_uint = 0x37;
pub const LTC4162L_CHARGE_STATUS_ALERTS_REG: c_uint = 0x38;
pub const LTC4162L_SYSTEM_STATUS_REG: c_uint = 0x39;
pub const LTC4162L_VBAT: c_uint = 0x3A;
pub const LTC4162L_VIN: c_uint = 0x3B;
pub const LTC4162L_VOUT: c_uint = 0x3C;
pub const LTC4162L_IBAT: c_uint = 0x3D;
pub const LTC4162L_IIN: c_uint = 0x3E;
pub const LTC4162L_DIE_TEMPERATURE: c_uint = 0x3F;
pub const LTC4162L_THERMISTOR_VOLTAGE: c_uint = 0x40;
pub const LTC4162L_BSR: c_uint = 0x41;
pub const LTC4162L_JEITA_REGION: c_uint = 0x42;
pub const LTC4162L_CHEM_CELLS_REG: c_uint = 0x43;
pub const LTC4162L_ICHARGE_DAC: c_uint = 0x44;
pub const LTC4162L_VCHARGE_DAC: c_uint = 0x45;
pub const LTC4162L_IIN_LIMIT_DAC: c_uint = 0x46;
pub const LTC4162L_VBAT_FILT: c_uint = 0x47;
pub const LTC4162L_INPUT_UNDERVOLTAGE_DAC: c_uint = 0x4B;
...
pub const LTC4162L_ARM_SHIP_MODE_MAGIC: c_int = 21325;
    struct ltc4162l_info;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc4162l_chip_info {
    ...
    pub val): *mut union power_supply_propval,
    pub ibat_resolution_pv: c_uint,
    pub vin_resolution_uv: c_uint,
    pub telemetry_mask: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc4162l_info {
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub charger: *mut power_supply,
    pub chip_info: *const ltc4162l_chip_info,
    pub /: *mut *mut u32 rsnsb; / Series resistor that sets charge current, microOhm,
    pub /: *mut *mut u32 rsnsi; / Series resistor to measure input current, microOhm,
    pub /: *mut *mut u8 cell_count; / Number of connected cells, 0 while unknown,
}

#[no_mangle]
unsafe extern "C" fn ltc4162l_get_cell_count(info: *mut ltc4162l_info) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ltc4162l_get_chem_type(info: *mut ltc4162l_info) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ltc4162l_state_decode(value: enum ltc4162l_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4162l_charge_status_decode(value: enum ltc4162l_charge_status) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4162l_state_to_health(value: enum ltc4162l_state) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc4162l_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc4162l_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ltc4162l_clear_interrupts(info: *mut ltc4162l_info) {
...
#[no_mangle]
unsafe extern "C" fn ltc4162l_probe(client: *mut i2c_client) -> c_int {
    static int ltc4162l_probe(struct i2c_client *client)
    {
    struct i2c_adapter *adapter = client.adapter;
    struct device *dev = &client.dev;
    struct ltc4162l_info *info;
    let mut ltc4162l_config: power_supply_config = {};
