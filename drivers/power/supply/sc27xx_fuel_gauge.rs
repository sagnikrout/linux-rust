...
//! Source: drivers/power/supply/sc27xx_fuel_gauge.c
#![no_std]
...
pub const SC27XX_FGU_START: c_uint = 0x0;
pub const SC27XX_FGU_CONFIG: c_uint = 0x4;
pub const SC27XX_FGU_ADC_CONFIG: c_uint = 0x8;
pub const SC27XX_FGU_STATUS: c_uint = 0xc;
pub const SC27XX_FGU_INT_EN: c_uint = 0x10;
pub const SC27XX_FGU_INT_CLR: c_uint = 0x14;
pub const SC27XX_FGU_INT_STS: c_uint = 0x1c;
pub const SC27XX_FGU_VOLTAGE: c_uint = 0x20;
pub const SC27XX_FGU_OCV: c_uint = 0x24;
pub const SC27XX_FGU_POCV: c_uint = 0x28;
pub const SC27XX_FGU_CURRENT: c_uint = 0x2c;
pub const SC27XX_FGU_LOW_OVERLOAD: c_uint = 0x34;
pub const SC27XX_FGU_CLBCNT_SETH: c_uint = 0x50;
pub const SC27XX_FGU_CLBCNT_SETL: c_uint = 0x54;
pub const SC27XX_FGU_CLBCNT_DELTH: c_uint = 0x58;
pub const SC27XX_FGU_CLBCNT_DELTL: c_uint = 0x5c;
pub const SC27XX_FGU_CLBCNT_VALH: c_uint = 0x68;
pub const SC27XX_FGU_CLBCNT_VALL: c_uint = 0x6c;
pub const SC27XX_FGU_CLBCNT_QMAXL: c_uint = 0x74;
pub const SC27XX_FGU_USER_AREA_SET: c_uint = 0xa0;
pub const SC27XX_FGU_USER_AREA_CLEAR: c_uint = 0xa4;
pub const SC27XX_FGU_USER_AREA_STATUS: c_uint = 0xa8;
pub const SC27XX_FGU_VOLTAGE_BUF: c_uint = 0xd0;
pub const SC27XX_FGU_CURRENT_BUF: c_uint = 0xf0;

pub const SC27XX_FGU_CLBCNT_SHIFT: c_int = 16;

pub const SC27XX_FGU_MODE_AREA_SHIFT: c_int = 12;

pub const SC27XX_FGU_NORMAIL_POWERTON: c_uint = 0x5;
pub const SC27XX_FGU_CUR_BASIC_ADC: c_int = 8192;
pub const SC27XX_FGU_SAMPLE_HZ: c_int = 2;
// micro Ohms
pub const SC27XX_FGU_IDEAL_RESISTANCE: c_int = 20000;
//
...
pub struct sc27xx_fgu_data {
    ...
    pub charge_chan: *mut iio_channel,
    pub bat_present: bool,
    pub internal_resist: c_int,
    pub total_cap: c_int,
    pub init_cap: c_int,
    pub alarm_cap: c_int,
    pub init_clbcnt: c_int,
    pub max_volt: c_int,
    pub min_volt: c_int,
    pub boot_volt: c_int,
    pub table_len: c_int,
    pub resist_table_len: c_int,
    pub cur_1000ma_adc: c_int,
    pub vol_1000mv_adc: c_int,
    pub calib_resist: c_int,
    pub cap_table: *mut power_supply_battery_ocv_table,
    pub resist_table: *mut power_supply_resistance_temp_table,
}
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_adc_to_current(data: *mut sc27xx_fgu_data, adc: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_adc_to_voltage(data: *mut sc27xx_fgu_data, adc: i64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_voltage_to_adc(data: *mut sc27xx_fgu_data, vol: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_is_first_poweron(data: *mut sc27xx_fgu_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_save_last_cap(data: *mut sc27xx_fgu_data, cap: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_read_last_cap(data: *mut sc27xx_fgu_data, cap: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_boot_capacity(data: *mut sc27xx_fgu_data, cap: *mut c_int) -> c_int {
    static int sc27xx_fgu_get_boot_capacity(struct sc27xx_fgu_data *data, int *cap)
    {
    int volt, cur, oci, ocv, ret;
    let mut is_first_poweron: bool = sc27xx_fgu_is_first_poweron(data);
//
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_set_clbcnt(data: *mut sc27xx_fgu_data, clbcnt: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_clbcnt(data: *mut sc27xx_fgu_data, clb_cnt: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_vol_now(data: *mut sc27xx_fgu_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_cur_now(data: *mut sc27xx_fgu_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_capacity(data: *mut sc27xx_fgu_data, cap: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_vbat_vol(data: *mut sc27xx_fgu_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_current(data: *mut sc27xx_fgu_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_vbat_ocv(data: *mut sc27xx_fgu_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_charge_vol(data: *mut sc27xx_fgu_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_temp(data: *mut sc27xx_fgu_data, temp: *mut c_int) -> c_int {
    static int sc27xx_fgu_get_temp(struct sc27xx_fgu_data *data, int *temp)
    {
    return iio_read_channel_processed(data.channel, temp);
    }
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_health(data: *mut sc27xx_fgu_data, health: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_get_status(data: *mut sc27xx_fgu_data, status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_adjust_cap(data: *mut sc27xx_fgu_data, cap: c_int) {
    static void sc27xx_fgu_adjust_cap(struct sc27xx_fgu_data *data, int cap)
    {
    int ret;
    data.init_cap = cap;
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_bat_detection(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_disable(_data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_cap_to_clbcnt(data: *mut sc27xx_fgu_data, capacity: c_int) -> c_int {
    static int sc27xx_fgu_cap_to_clbcnt(struct sc27xx_fgu_data *data, int capacity)
    {
//
...
//
    let mut cur_cap: c_int = DIV_ROUND_CLOSEST(data.total_cap * capacity, 100);
//
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_calibration(data: *mut sc27xx_fgu_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_hw_init(data: *mut sc27xx_fgu_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_probe(pdev: *mut platform_device) -> c_int {
    static int sc27xx_fgu_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    let mut fgu_cfg: power_supply_config = { };
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc27xx_fgu_suspend(dev: *mut device) -> c_int {
