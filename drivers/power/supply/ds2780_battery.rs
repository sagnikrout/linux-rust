...
//! Source: drivers/power/supply/ds2780_battery.c
#![no_std]
...
pub const DS2780_CURRENT_UNITS: c_int = 1563;
// Charge unit measurement in uAh for a 1 milli-ohm sense resistor
pub const DS2780_CHARGE_UNITS: c_int = 6250;
...
#[no_mangle]
pub unsafe extern "C" fn ds2780_store_eeprom(dev: *mut device, addr: c_int) -> c_int {
    static inline int ds2780_store_eeprom(struct device *dev, int addr)
    {
    return w1_ds2780_eeprom_cmd(dev, addr, W1_DS2780_COPY_DATA);
    }
#[no_mangle]
pub unsafe extern "C" fn ds2780_recall_eeprom(dev: *mut device, addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds2780_save_eeprom(dev_info: *mut ds2780_device_info, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds2780_get_status(dev_info: *mut ds2780_device_info, status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds2780_battery_probe(pdev: *mut platform_device) -> c_int {
