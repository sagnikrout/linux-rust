...
//! Source: drivers/power/supply/ds2781_battery.c
#![no_std]
...
pub const DS2781_CURRENT_UNITS: c_int = 1563;
// Charge unit measurement in uAh for a 1 milli-ohm sense resistor
pub const DS2781_CHARGE_UNITS: c_int = 6250;
...
#[no_mangle]
pub unsafe extern "C" fn ds2781_store_eeprom(dev: *mut device, addr: c_int) -> c_int {
    static inline int ds2781_store_eeprom(struct device *dev, int addr)
    {
    return w1_ds2781_eeprom_cmd(dev, addr, W1_DS2781_COPY_DATA);
    }
#[no_mangle]
pub unsafe extern "C" fn ds2781_recall_eeprom(dev: *mut device, addr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ds2781_save_eeprom(dev_info: *mut ds2781_device_info, reg: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CURRENT_AVG: type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ds2781_get_status(dev_info: *mut ds2781_device_info, status: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(50000: current_uA >) -> else {
...
#[no_mangle]
unsafe extern "C" fn ds2781_battery_probe(pdev: *mut platform_device) -> c_int {
