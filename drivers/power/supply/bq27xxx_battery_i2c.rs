...
//! Source: drivers/power/supply/bq27xxx_battery_i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_irq_handler_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_i2c_devm_ida_free(data: *mut c_void) {
    static void bq27xxx_battery_i2c_devm_ida_free(void *data)
    {
    let mut num: c_int = (long)data;
    ida_free(&battery_id, num);
    }
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_i2c_probe(client: *mut i2c_client) -> c_int {
...
// Schedule a polling after about 1 min
    ...
    core::ptr::null_mut(), bq27xxx_battery_irq_handler_thread,
    IRQF_ONESHOT,
    di.name, di);
    if (ret) {
    dev_err(&client.dev,
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_i2c_remove(client: *mut i2c_client) {
