...
//! Source: drivers/power/supply/lt3651-charger.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lt3651_charger {
    pub charger: *mut power_supply,
    pub charger_desc: power_supply_desc,
    pub acpr_gpio: *mut gpio_desc,
    pub fault_gpio: *mut gpio_desc,
    pub chrg_gpio: *mut gpio_desc,
}

#[no_mangle]
unsafe extern "C" fn lt3651_charger_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn lt3651_charger_probe(pdev: *mut platform_device) -> c_int {
