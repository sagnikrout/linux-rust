...
//! Source: drivers/power/supply/rn5t618_power.c
#![no_std]
...
pub const CHG_STATE_ADP_INPUT: c_uint = 0x40;
pub const CHG_STATE_USB_INPUT: c_uint = 0x80;
pub const CHG_STATE_MASK: c_uint = 0x1f;
pub const CHG_STATE_CHG_OFF: c_int = 0;
pub const CHG_STATE_CHG_READY_VADP: c_int = 1;
pub const CHG_STATE_CHG_TRICKLE: c_int = 2;
pub const CHG_STATE_CHG_RAPID: c_int = 3;
pub const CHG_STATE_CHG_COMPLETE: c_int = 4;
pub const CHG_STATE_SUSPEND: c_int = 5;
pub const CHG_STATE_VCHG_OVER_VOL: c_int = 6;
pub const CHG_STATE_BAT_ERROR: c_int = 7;
pub const CHG_STATE_NO_BAT: c_int = 8;
pub const CHG_STATE_BAT_OVER_VOL: c_int = 9;
pub const CHG_STATE_BAT_TEMP_ERR: c_int = 10;
pub const CHG_STATE_DIE_ERR: c_int = 11;
pub const CHG_STATE_DIE_SHUTDOWN: c_int = 12;
pub const CHG_STATE_NO_BAT2: c_int = 13;
pub const CHG_STATE_CHG_READY_VUSB: c_int = 14;
pub const GCHGDET_TYPE_MASK: c_uint = 0x30;
pub const GCHGDET_TYPE_SDP: c_uint = 0x00;
pub const GCHGDET_TYPE_CDP: c_uint = 0x10;
pub const GCHGDET_TYPE_DCP: c_uint = 0x20;
pub const FG_ENABLE: c_int = 1;
//
...
pub const CHG_MIN_CUR: c_int = 100000;
pub const CHG_MAX_CUR: c_int = 1800000;
pub const ADP_MAX_CUR: c_int = 2500000;
pub const USB_MAX_CUR: c_int = 1400000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rn5t618_power_info {
    pub rn5t618: *mut rn5t618,
    pub pdev: *mut platform_device,
    pub battery: *mut power_supply,
    pub usb: *mut power_supply,
    pub adp: *mut power_supply,
    pub channel_vusb: *mut iio_channel,
    pub channel_vadp: *mut iio_channel,
    pub irq: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn rn5t618_decode_status(status: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_charger_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rn5t618_power_probe(pdev: *mut platform_device) -> c_int {
