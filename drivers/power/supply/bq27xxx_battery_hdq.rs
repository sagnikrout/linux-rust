...
//! Source: drivers/power/supply/bq27xxx_battery_hdq.c
#![no_std]
...
pub const W1_FAMILY_BQ27000: c_uint = 0x01;

    static int F_ID;
    module_param(F_ID, int, S_IRUSR);
    MODULE_PARM_DESC(F_ID, "1-wire slave FID for BQ27xxx device");
#[no_mangle]
unsafe extern "C" fn w1_bq27000_read(sl: *mut w1_slave, reg: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_hdq_add_slave(sl: *mut w1_slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_hdq_remove_slave(sl: *mut w1_slave) {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_hdq_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_hdq_exit() -> void __exit {
