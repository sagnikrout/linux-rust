...
//! Source: drivers/power/supply/max8925_power.c
#![no_std]
...
// registers in GPM
pub const MAX8925_OUT5VEN: c_uint = 0x54;
pub const MAX8925_OUT3VEN: c_uint = 0x58;
pub const MAX8925_CHG_CNTL1: c_uint = 0x7c;
// bits definition

// registers in ADC
pub const MAX8925_ADC_RES_CNFG1: c_uint = 0x06;
pub const MAX8925_ADC_AVG_CNFG1: c_uint = 0x07;
pub const MAX8925_ADC_ACQ_CNFG1: c_uint = 0x08;
pub const MAX8925_ADC_ACQ_CNFG2: c_uint = 0x09;
// 2 bytes registers in below. MSB is 1st, LSB is 2nd.
pub const MAX8925_ADC_AUX2: c_uint = 0x62;
pub const MAX8925_ADC_VCHG: c_uint = 0x64;
pub const MAX8925_ADC_VBBATT: c_uint = 0x66;
pub const MAX8925_ADC_VMBATT: c_uint = 0x68;
pub const MAX8925_ADC_ISNS: c_uint = 0x6a;
pub const MAX8925_ADC_THM: c_uint = 0x6c;
pub const MAX8925_ADC_TDIE: c_uint = 0x6e;
pub const MAX8925_CMD_AUX2: c_uint = 0xc8;
pub const MAX8925_CMD_VCHG: c_uint = 0xd0;
pub const MAX8925_CMD_VBBATT: c_uint = 0xd8;
pub const MAX8925_CMD_VMBATT: c_uint = 0xe0;
pub const MAX8925_CMD_ISNS: c_uint = 0xe8;
pub const MAX8925_CMD_THM: c_uint = 0xf0;
pub const MAX8925_CMD_TDIE: c_uint = 0xf8;
    enum {
    MEASURE_AUX2,
    MEASURE_VCHG,
    MEASURE_VBBATT,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max8925_power_info {
    pub chip: *mut max8925_chip,
    pub gpm: *mut i2c_client,
    pub adc: *mut i2c_client,
    pub ac: *mut power_supply,
    pub usb: *mut power_supply,
    pub battery: *mut power_supply,
    pub irq_base: c_int,
    pub ac_online:1: unsigned,
    pub usb_online:1: unsigned,
    pub bat_online:1: unsigned,
    pub chg_mode:2: unsigned,
    pub /: *mut *mut unsigned batt_detect:1; / detecting MB by ID pin,
    pub topoff_threshold:2: unsigned,
    pub fast_charge:3: unsigned,
    pub no_temp_support:1: unsigned,
    pub no_insert_detect:1: unsigned,
    pub (int): *mut *mut int (set_charger),
}

#[no_mangle]
unsafe extern "C" fn __set_charger(info: *mut max8925_power_info, enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8925_charger_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn start_measure(info: *mut max8925_power_info, type: c_int) -> c_int {
    static int start_measure(struct max8925_power_info *info, int type)
    {
    unsigned char buf[2] = {0, 0};
    int meas_cmd;
    let mut meas_reg: c_int = 0, ret;
    switch (type) {
    case MEASURE_VCHG:
...
// assume r_sns is 0.02
    ...
    do {									\
    ret = request_threaded_irq(chip.irq_base + _irq, core::ptr::null_mut(),		\
...
#[no_mangle]
unsafe extern "C" fn max8925_deinit_charger(info: *mut max8925_power_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8925_power_probe(pdev: *mut platform_device) -> c_int {
    static int max8925_power_probe(struct platform_device *pdev)
    {
    struct max8925_chip *chip = dev_get_drvdata(pdev.dev.parent);
    struct power_supply_config psy_cfg = {}; /* Only for ac and usb */
    struct max8925_power_pdata *pdata = core::ptr::null_mut();
    struct max8925_power_info *info;
    ...
    info.battery = devm_power_supply_register(&pdev.dev, &battery_desc, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn max8925_power_remove(pdev: *mut platform_device) {
