...
//! Source: drivers/power/supply/rt9467-charger.c
#![no_std]
...
pub const RT9467_REG_CORE_CTRL0: c_uint = 0x00;
pub const RT9467_REG_CHG_CTRL1: c_uint = 0x01;
pub const RT9467_REG_CHG_CTRL2: c_uint = 0x02;
pub const RT9467_REG_CHG_CTRL3: c_uint = 0x03;
pub const RT9467_REG_CHG_CTRL4: c_uint = 0x04;
pub const RT9467_REG_CHG_CTRL5: c_uint = 0x05;
pub const RT9467_REG_CHG_CTRL6: c_uint = 0x06;
pub const RT9467_REG_CHG_CTRL7: c_uint = 0x07;
pub const RT9467_REG_CHG_CTRL8: c_uint = 0x08;
pub const RT9467_REG_CHG_CTRL9: c_uint = 0x09;
pub const RT9467_REG_CHG_CTRL10: c_uint = 0x0A;
pub const RT9467_REG_CHG_CTRL12: c_uint = 0x0C;
pub const RT9467_REG_CHG_CTRL13: c_uint = 0x0D;
pub const RT9467_REG_CHG_CTRL14: c_uint = 0x0E;
pub const RT9467_REG_CHG_ADC: c_uint = 0x11;
pub const RT9467_REG_CHG_DPDM1: c_uint = 0x12;
pub const RT9467_REG_CHG_DPDM2: c_uint = 0x13;
pub const RT9467_REG_DEVICE_ID: c_uint = 0x40;
pub const RT9467_REG_CHG_STAT: c_uint = 0x42;
pub const RT9467_REG_ADC_DATA_H: c_uint = 0x44;
pub const RT9467_REG_CHG_STATC: c_uint = 0x50;
pub const RT9467_REG_CHG_IRQ1: c_uint = 0x53;
pub const RT9467_REG_CHG_STATC_CTRL: c_uint = 0x60;
pub const RT9467_REG_CHG_IRQ1_CTRL: c_uint = 0x63;

pub const RT9467_NUM_IRQ_REGS: c_int = 4;
pub const RT9467_ICHG_MIN_uA: c_int = 100000;
pub const RT9467_ICHG_MAX_uA: c_int = 5000000;
pub const RT9467_CV_MAX_uV: c_int = 4710000;
pub const RT9467_OTG_MIN_uV: c_int = 4425000;
pub const RT9467_OTG_MAX_uV: c_int = 5825000;
pub const RT9467_OTG_STEP_uV: c_int = 25000;

pub const RT9467_AICLVTH_GAP_uV: c_int = 200000;
pub const RT9467_ADCCONV_TIME_MS: c_int = 35;
pub const RT9466_VID: c_uint = 0x8;
pub const RT9467_VID: c_uint = 0x9;
// IRQ number
pub const RT9467_IRQ_TS_STATC: c_int = 0;
pub const RT9467_IRQ_CHG_FAULT: c_int = 1;
pub const RT9467_IRQ_CHG_STATC: c_int = 2;
pub const RT9467_IRQ_CHG_TMR: c_int = 3;
pub const RT9467_IRQ_CHG_BATABS: c_int = 4;
pub const RT9467_IRQ_CHG_ADPBAD: c_int = 5;
pub const RT9467_IRQ_CHG_RVP: c_int = 6;
pub const RT9467_IRQ_OTP: c_int = 7;
pub const RT9467_IRQ_CHG_AICLM: c_int = 8;
pub const RT9467_IRQ_CHG_ICHGM: c_int = 9;
pub const RT9467_IRQ_WDTMR: c_int = 11;
pub const RT9467_IRQ_SSFINISH: c_int = 12;
pub const RT9467_IRQ_CHG_RECHG: c_int = 13;
pub const RT9467_IRQ_CHG_TERM: c_int = 14;
pub const RT9467_IRQ_CHG_IEOC: c_int = 15;
pub const RT9467_IRQ_ADC_DONE: c_int = 16;
pub const RT9467_IRQ_PUMPX_DONE: c_int = 17;
pub const RT9467_IRQ_BST_BATUV: c_int = 21;
pub const RT9467_IRQ_BST_MIDOV: c_int = 22;
pub const RT9467_IRQ_BST_OLP: c_int = 23;
pub const RT9467_IRQ_ATTACH: c_int = 24;
pub const RT9467_IRQ_DETACH: c_int = 25;
pub const RT9467_IRQ_HVDCP_DET: c_int = 29;
pub const RT9467_IRQ_CHGDET: c_int = 30;
pub const RT9467_IRQ_DCDT: c_int = 31;
    enum rt9467_fields {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt9467_chg_data {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub rm_field: [*mut regmap_field; F_MAX_FIELDS],
    pub irq_chip_data: *mut regmap_irq_chip_data,
    pub psy: *mut power_supply,
    pub adc_lock: mutex,
    pub attach_lock: mutex,
    pub ichg_ieoc_lock: mutex,
    pub rdev: *mut regulator_dev,
    pub aicl_done: completion,
    pub psy_usb_type: enum power_supply_usb_type,
    pub old_stat: c_uint,
    pub vid: c_uint,
    pub ichg_ua: c_int,
    pub ieoc_ua: c_int,
    ...
    cfg.ena_gpiod = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn rt9467_register_otg_regulator(data: *mut rt9467_chg_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_get_adc_sel(chan: enum rt9467_adc_chan, sel: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_psy_get_status(data: *mut rt9467_chg_data, state: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_psy_set_ichg(data: *mut rt9467_chg_data, microamp: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_run_aicl(data: *mut rt9467_chg_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_psy_set_ieoc(data: *mut rt9467_chg_data, microamp: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_register_psy(data: *mut rt9467_chg_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_mivr_handler(data: *mut rt9467_chg_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_statc_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9467_wdt_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9467_report_usb_state(data: *mut rt9467_chg_data) -> c_int {
    static int rt9467_report_usb_state(struct rt9467_chg_data *data)
    {
    unsigned int usb_stat, power_ready;
    let mut psy_changed: bool = true;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rt9467_usb_state_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9467_aiclmeas_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9467_request_interrupt(data: *mut rt9467_chg_data) -> c_int {
    ...
    chg_irqs[i].name);
    ret = devm_request_threaded_irq(dev, virq, core::ptr::null_mut(), chg_irqs[i].handler,
...
#[no_mangle]
unsafe extern "C" fn rt9467_do_charger_init(data: *mut rt9467_chg_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_is_accessible_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt9467_check_vendor_info(data: *mut rt9467_chg_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_reset_chip(data: *mut rt9467_chg_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9467_chg_complete_aicl_done(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rt9467_charger_probe(i2c: *mut i2c_client) -> c_int {
