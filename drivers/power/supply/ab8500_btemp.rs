...
//! Source: drivers/power/supply/ab8500_btemp.c
#![no_std]
...
pub const BTEMP_THERMAL_MED_LIMIT: c_int = 0;
pub const BTEMP_THERMAL_HIGH_LIMIT_52: c_int = 52;
pub const BTEMP_THERMAL_HIGH_LIMIT_57: c_int = 57;
pub const BTEMP_THERMAL_HIGH_LIMIT_62: c_int = 62;
pub const BTEMP_BATCTRL_CURR_SRC_7UA: c_int = 7;
pub const BTEMP_BATCTRL_CURR_SRC_20UA: c_int = 20;
pub const BTEMP_BATCTRL_CURR_SRC_16UA: c_int = 16;
pub const BTEMP_BATCTRL_CURR_SRC_18UA: c_int = 18;
pub const BTEMP_BATCTRL_CURR_SRC_60UA: c_int = 60;
pub const BTEMP_BATCTRL_CURR_SRC_120UA: c_int = 120;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_btemp_interrupts {
    pub name: *mut c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_btemp_events {
    pub batt_rem: bool,
    pub btemp_high: bool,
    pub btemp_medhigh: bool,
    pub btemp_lowmed: bool,
    pub btemp_low: bool,
    pub ac_conn: bool,
    pub usb_conn: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_btemp_ranges {
    pub btemp_high_limit: c_int,
    pub btemp_med_limit: c_int,
    pub btemp_low_limit: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_btemp {
    pub dev: *mut device,
    pub node: list_head,
    pub curr_source: c_int,
    pub bat_temp: c_int,
    pub prev_bat_temp: c_int,
    pub parent: *mut ab8500,
    pub tz: *mut thermal_zone_device,
    pub bat_ctrl: *mut iio_channel,
    pub fg: *mut ab8500_fg,
    pub bm: *mut ab8500_bm_data,
    pub btemp_psy: *mut power_supply,
    pub events: ab8500_btemp_events,
    pub btemp_ranges: ab8500_btemp_ranges,
    pub btemp_wq: *mut workqueue_struct,
    pub btemp_periodic_work: delayed_work,
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_read_batctrl_voltage(di: *mut ab8500_btemp) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_get_batctrl_res(di: *mut ab8500_btemp) -> c_int {
    static int ab8500_btemp_get_batctrl_res(struct ab8500_btemp *di)
    {
    int ret;
    let mut batctrl: c_int = 0;
    int res;
    int inst_curr;
    int i;
    if (!di.fg)
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_id(di: *mut ab8500_btemp) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_periodic_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_batctrlindb_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_templow_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_temphigh_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_lowmed_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_medhigh_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_get_temp(di: *mut ab8500_btemp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_get_ext_psy_data(ext: *mut power_supply, data: *mut c_void) -> c_int {
...
// AC connected
#[no_mangle]
pub unsafe extern "C" fn if(!di->events.ac_conn: ret.intval &&) -> else {
...
// USB connected
#[no_mangle]
pub unsafe extern "C" fn if(!di->events.usb_conn: ret.intval &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_external_power_changed(psy: *mut power_supply) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_suspend(dev: *mut device) -> int __maybe_unused {
...
// Create a work queue for the btemp
    ...
    0);
    if (di.btemp_wq == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_btemp_remove(pdev: *mut platform_device) {
