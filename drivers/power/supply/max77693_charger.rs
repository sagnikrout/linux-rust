...
//! Source: drivers/power/supply/max77693_charger.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77693_charger {
    pub dev: *mut device,
    pub max77693: *mut max77693_dev,
    pub charger: *mut power_supply,
    pub constant_volt: u32,
    pub min_system_volt: u32,
    pub thermal_regulation_temp: u32,
    pub batttery_overcurrent: u32,
    pub charge_input_threshold_volt: u32,
}

#[no_mangle]
unsafe extern "C" fn max77693_get_charger_state(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_get_charge_type(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max77693_get_battery_health(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_get_present(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_get_online(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max77693_get_input_current_limit(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_get_fast_charge_current(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(4350000: uvolt >= 4340000 && uvolt <) -> else {
    else if (uvolt >= 4340000 && uvolt < 4350000)
    data = 0x1c;
#[no_mangle]
pub unsafe extern "C" fn if(4400000: uvolt >= 4350000 && uvolt <=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn max77693_reg_init(chg: *mut max77693_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_dt_init(dev: *mut device, chg: *mut max77693_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_charger_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_charger_remove(pdev: *mut platform_device) {
