...
//! Source: drivers/power/supply/88pm860x_battery.c
#![no_std]
...
pub const CC6_BAT_DET_GPADC1: c_int = 1;
...
pub const CCNT_POS1: c_int = 0;
pub const CCNT_POS2: c_int = 1;
pub const CCNT_NEG1: c_int = 2;
pub const CCNT_NEG2: c_int = 3;
pub const CCNT_SPOS: c_int = 4;
pub const CCNT_SNEG: c_int = 5;
// OCV -- Open Circuit Voltage
pub const OCV_MODE_ACTIVE: c_int = 0;
pub const OCV_MODE_SLEEP: c_int = 1;
// Vbat range of CC for measuring Rbat
pub const LOW_BAT_THRESHOLD: c_int = 3600;
pub const VBATT_RESISTOR_MIN: c_int = 3800;
pub const VBATT_RESISTOR_MAX: c_int = 4100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pm860x_battery_info {
    ...
    pub /: *mut *mut int resistor; / Battery Internal Resistor,
    pub last_capacity: c_int,
    pub start_soc: c_int,
    pub present:1: unsigned,
    pub /: *mut *mut unsigned temp_type:1; / TINT or TBAT,
}
...
pub struct ccnt {
    ...
    pub spos: c_uint,
    pub sneg: c_uint,
    pub /: *mut *mut int total_chg; / mAh(3.6C),
    pub /: *mut *mut int total_dischg; / mAh(3.6C),
}
...
//
#[no_mangle]
unsafe extern "C" fn measure_current(info: *mut pm860x_battery_info, data: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_ccnt(info: *mut pm860x_battery_info, ccnt: *mut ccnt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clear_ccnt(info: *mut pm860x_battery_info, ccnt: *mut ccnt) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_ocv(info: *mut pm860x_battery_info, ocv: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_soc(info: *mut pm860x_battery_info, state: c_int, soc: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm860x_coulomb_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pm860x_batt_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pm860x_init_battery(info: *mut pm860x_battery_info) {
...
// restore SOC from RTC domain register
    ...
    info.start_soc = soc;
#[no_mangle]
pub unsafe extern "C" fn if(15: data < soc -) -> else {
    else if (data < soc - 15)
    info.start_soc = soc;
    else
    info.start_soc = data;
...
#[no_mangle]
unsafe extern "C" fn measure_temp(info: *mut pm860x_battery_info, data: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_resistor(info: *mut pm860x_battery_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn calc_capacity(info: *mut pm860x_battery_info, cap: *mut c_int) -> c_int {
    static int calc_capacity(struct pm860x_battery_info *info, int *cap)
    {
    int ret;
    int data;
    int ibat;
    let mut cap_ocv: c_int = 0;
    let mut cap_cc: c_int = 0;
    ...
    cap_cc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(100: cap_cc >) -> else {
    else if (cap_cc > 100)
    cap_cc = 100;
...
#[no_mangle]
unsafe extern "C" fn pm860x_external_power_changed(psy: *mut power_supply) {
    ...
    data = 0;
#[no_mangle]
pub unsafe extern "C" fn if(100: data >) -> else {
    else if (data > 100)
    data = 100;
...
#[no_mangle]
unsafe extern "C" fn pm860x_battery_probe(pdev: *mut platform_device) -> c_int {
    ...
    ret = devm_request_threaded_irq(chip.dev, info.irq_cc, core::ptr::null_mut(),
    pm860x_coulomb_handler, IRQF_ONESHOT,
    "coulomb", info);
    if (ret < 0)
    return ret;
    ret = devm_request_threaded_irq(chip.dev, info.irq_batt, core::ptr::null_mut(),
    pm860x_batt_handler,
...
#[no_mangle]
unsafe extern "C" fn pm860x_battery_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm860x_battery_resume(dev: *mut device) -> c_int {
