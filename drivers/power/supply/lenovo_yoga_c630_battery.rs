...
//! Source: drivers/power/supply/lenovo_yoga_c630_battery.c
#![no_std]
...
// guards all battery properties and registration of power supplies
    ...
    pub last_status_update: c_ulong,
    pub adapter_online: bool,
    pub unit_mA: bool,
    pub bat_present: bool,
    pub bat_status: c_uint,
    pub design_capacity: c_uint,
    pub design_voltage: c_uint,
    pub full_charge_capacity: c_uint,
    pub capacity_now: c_uint,
    pub voltage_now: c_uint,
    pub current_now: c_int,
    pub rate_now: c_int,
}

pub const LENOVO_EC_ADPT_STATUS: c_uint = 0xa3;

pub const LENOVO_EC_BAT_ATTRIBUTES: c_uint = 0xc0;

pub const LENOVO_EC_BAT_STATUS: c_uint = 0xc1;

pub const LENOVO_EC_BAT_REMAIN_CAPACITY: c_uint = 0xc2;
pub const LENOVO_EC_BAT_VOLTAGE: c_uint = 0xc6;
pub const LENOVO_EC_BAT_DESIGN_VOLTAGE: c_uint = 0xc8;
pub const LENOVO_EC_BAT_DESIGN_CAPACITY: c_uint = 0xca;
pub const LENOVO_EC_BAT_FULL_CAPACITY: c_uint = 0xcc;
pub const LENOVO_EC_BAT_CURRENT: c_uint = 0xd2;
pub const LENOVO_EC_BAT_FULL_FACTORY: c_uint = 0xd6;
pub const LENOVO_EC_BAT_PRESENT: c_uint = 0xda;

pub const LENOVO_EC_BAT_FULL_REGISTER: c_uint = 0xdb;

#[no_mangle]
unsafe extern "C" fn yoga_c630_psy_update_bat_info(ecbat: *mut yoga_c630_psy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yoga_c630_psy_maybe_update_bat_status(ecbat: *mut yoga_c630_psy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yoga_c630_psy_update_adapter_status(ecbat: *mut yoga_c630_psy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yoga_c630_psy_is_charged(ecbat: *mut yoga_c630_psy) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(LENOVO_EC_BAT_STATUS_CHARGING: ecbat->bat_status &) -> else {
    else if (ecbat.bat_status & LENOVO_EC_BAT_STATUS_CHARGING)
    val.intval = POWER_SUPPLY_STATUS_CHARGING;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: yoga_c630_psy_is_charged(ecbat)) -> else {
...
#[no_mangle]
unsafe extern "C" fn yoga_c630_psy_register_bat_psy(ecbat: *mut yoga_c630_psy) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yoga_c630_ec_refresh_bat_info(ecbat: *mut yoga_c630_psy) {
    ...
    let mut adp_cfg: power_supply_config = {};
...
#[no_mangle]
unsafe extern "C" fn yoga_c630_psy_remove(adev: *mut auxiliary_device) {
