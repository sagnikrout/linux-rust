...
//! Source: drivers/power/supply/max77705_charger.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn max77705_aicl_irq(irq: c_int, irq_drv_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max77705_chgin_irq(irq: c_int, irq_drv_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max77705_charger_enable(chg: *mut max77705_charger_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77705_charger_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn max77705_get_online(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77705_check_battery(chg: *mut max77705_charger_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77705_get_charge_type(chg: *mut max77705_charger_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77705_get_status(chg: *mut max77705_charger_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77705_get_vbus_state(regmap: *mut regmap, value: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77705_get_health(chg: *mut max77705_charger_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77705_chgin_isr_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn max77705_charger_initialize(chg: *mut max77705_charger_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77705_charger_probe(i2c: *mut i2c_client) -> c_int {
