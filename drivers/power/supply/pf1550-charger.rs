...
//! Source: drivers/power/supply/pf1550-charger.c
#![no_std]
...
pub const PF1550_DEFAULT_CONSTANT_VOLT: c_int = 4200000;
pub const PF1550_DEFAULT_MIN_SYSTEM_VOLT: c_int = 3500000;
pub const PF1550_DEFAULT_THERMAL_TEMP: c_int = 95;
pub const PF1550_CHARGER_IRQ_NR: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pf1550_charger {
    pub dev: *mut device,
    pub pf1550: *const pf1550_ddata,
    pub charger: *mut power_supply,
    pub battery: *mut power_supply,
    pub vbus_sense_work: delayed_work,
    pub chg_sense_work: delayed_work,
    pub bat_sense_work: delayed_work,
    pub virqs: [c_int; PF1550_CHARGER_IRQ_NR],
    pub constant_volt: u32,
    pub min_system_volt: u32,
    pub thermal_regulation_temp: u32,
}

#[no_mangle]
unsafe extern "C" fn pf1550_get_charger_state(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf1550_get_charge_type(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pf1550_get_battery_health(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf1550_get_present(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf1550_get_online(regmap: *mut regmap, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf1550_chg_bat_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pf1550_chg_chg_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pf1550_chg_vbus_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pf1550_charger_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn pf1550_reg_init(chg: *mut pf1550_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf1550_dt_parse_dev_info(chg: *mut pf1550_charger) {
...
#[no_mangle]
unsafe extern "C" fn pf1550_charger_probe(pdev: *mut platform_device) -> c_int {
