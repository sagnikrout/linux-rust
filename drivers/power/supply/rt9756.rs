...
//! Source: drivers/power/supply/rt9756.c
#![no_std]
...
pub const RT9756_REG_INTFLAG1: c_uint = 0x0B;
pub const RT9756_REG_INTFLAG2: c_uint = 0x0D;
pub const RT9756_REG_INTFLAG3: c_uint = 0x0F;
pub const RT9756_REG_ADCCTL: c_uint = 0x11;
pub const RT9756_REG_VBUSADC: c_uint = 0x12;
pub const RT9756_REG_BC12FLAG: c_uint = 0x45;
pub const RT9756_REG_INTFLAG4: c_uint = 0x49;
// Flag1
...
pub const RICHTEK_DEVID: c_int = 7;
pub const RT9756_REVID: c_int = 0;
pub const RT9756A_REVID: c_int = 1;
pub const RT9757_REVID: c_int = 2;
pub const RT9757A_REVID: c_int = 3;
pub const RT9756_ADC_CONVTIME: c_int = 1200;
pub const RT9756_ADC_MAXWAIT: c_int = 16000;
    enum rt9756_model {
    MODEL_RT9756 = 0,
    MODEL_RT9757,
    MODEL_RT9770,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt9756_data {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub rm_fields: [*mut regmap_field; F_MAX_FIELD],
    pub psy: *mut power_supply,
    pub bat_psy: *mut power_supply,
    pub adc_lock: mutex,
    pub psy_desc: power_supply_desc,
    pub bat_psy_desc: power_supply_desc,
    pub chg_evt: charger_event,
    pub rg_resistor: c_uint,
    pub real_resistor: c_uint,
    pub model: enum rt9756_model,
    pub usb_type: core::sync::atomic::AtomicI32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt975x_dev_data {
    pub regmap_config: *const regmap_config,
    pub reg_fields: *const reg_field,
    pub init_regs: *const reg_sequence,
    pub num_init_regs: usize,
    pub data): *mut *mut int (check_device_model)(struct rt9756_data,
}
...
// val = (int)value;
    ...
    let mut reg_addr: c_uint = RT9756_REG_VBUSADC + chan * 2;
    let mut mask: c_uint = RT9756_ADCEN_MASK | RT9756_ADCONCE_MASK;
    let mut shift: c_uint = 0, adc_cntl;
    __be16 raws;
...
#[no_mangle]
unsafe extern "C" fn rt9756_get_switching_state(data: *mut rt9756_data, status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9756_get_charger_health(data: *mut rt9756_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9756_get_charger_online(data: *mut rt9756_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9756_get_vbus_ovp(data: *mut rt9756_data, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9756_set_vbus_ovp(data: *mut rt9756_data, val: c_int) -> c_int {
...
// operating mode -> 0 bypass, 1 div2
    ...
    let mut rt9756_manufacturer: *const static char  const = "Richtek Technology Corp.";
...
// pval = atomic_read(&data->usb_type);
    ...
    {
    struct rt9756_data *data = power_supply_get_drvdata(psy);
    let mut intval: c_int = val.intval;
    switch (psp) {
    case POWER_SUPPLY_PROP_STATUS:
...
// pval = POWER_SUPPLY_TECHNOLOGY_LION;
    ...
    struct rt9756_data *data = power_supply_get_drvdata(psy);
    let mut wdt_tmr_now: c_uint = 0, wdt_sel, wdt_dis;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rt9756_register_psy(data: *mut rt9756_data) -> c_int {
    ...
    let mut cfg: power_supply_config = {}, bat_cfg = {};
...
#[no_mangle]
unsafe extern "C" fn rt9756_get_usb_type(data: *mut rt9756_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9756_irq_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
    static irqreturn_t rt9756_irq_handler(int irq, void *devid)
    {
    struct rt9756_data *data = devid;
    struct regmap *regmap = data.regmap;
    struct charger_event *evt = &data.chg_evt;
    let mut bc12_flag: c_uint = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rt9756_config_batsense_resistor(data: *mut rt9756_data) -> c_int {
    static int rt9756_config_batsense_resistor(struct rt9756_data *data)
    {
    let mut shunt_resistor_uohms: c_uint = 2000, rsense_sel;
...
#[no_mangle]
unsafe extern "C" fn rt9756_check_device_model(data: *mut rt9756_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(RT9756A_REVID: revid == RT9756_REVID || revid ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rt9770_check_device_model(data: *mut rt9756_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt9756_probe(i2c: *mut i2c_client) -> c_int {
...
// Get specific model
    ...
    return devm_request_threaded_irq(dev, i2c.irq, core::ptr::null_mut(), rt9756_irq_handler, IRQF_ONESHOT,
    dev_name(dev), data);
    }
#[no_mangle]
unsafe extern "C" fn rt9756_shutdown(i2c: *mut i2c_client) {
