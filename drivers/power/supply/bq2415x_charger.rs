...
//! Source: drivers/power/supply/bq2415x_charger.c
#![no_std]
...
pub const BQ2415X_TIMER_TIMEOUT: c_int = 10;
pub const BQ2415X_REG_STATUS: c_uint = 0x00;
pub const BQ2415X_REG_CONTROL: c_uint = 0x01;
pub const BQ2415X_REG_VOLTAGE: c_uint = 0x02;
pub const BQ2415X_REG_VENDER: c_uint = 0x03;
pub const BQ2415X_REG_CURRENT: c_uint = 0x04;
// reset state for all registers

// status register
pub const BQ2415X_BIT_TMR_RST: c_int = 7;
pub const BQ2415X_BIT_OTG: c_int = 7;
pub const BQ2415X_BIT_EN_STAT: c_int = 6;

pub const BQ2415X_SHIFT_STAT: c_int = 4;
pub const BQ2415X_BIT_BOOST: c_int = 3;

pub const BQ2415X_SHIFT_FAULT: c_int = 0;
// control register

pub const BQ2415X_SHIFT_LIMIT: c_int = 6;

pub const BQ2415X_SHIFT_VLOWV: c_int = 4;
pub const BQ2415X_BIT_TE: c_int = 3;
pub const BQ2415X_BIT_CE: c_int = 2;
pub const BQ2415X_BIT_HZ_MODE: c_int = 1;
pub const BQ2415X_BIT_OPA_MODE: c_int = 0;
// voltage register

pub const BQ2415X_SHIFT_VO: c_int = 2;
pub const BQ2415X_BIT_OTG_PL: c_int = 1;
pub const BQ2415X_BIT_OTG_EN: c_int = 0;
// vender register

pub const BQ2415X_SHIFT_VENDER: c_int = 5;

pub const BQ2415X_SHIFT_PN: c_int = 3;

pub const BQ2415X_SHIFT_REVISION: c_int = 0;
// current register

pub const BQ2415X_SHIFT_VI_CHRG: c_int = 4;
// N/A					BIT(3)

pub const BQ2415X_SHIFT_VI_TERM: c_int = 0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bq2415x_device {
    pub dev: *mut device,
    pub init_data: bq2415x_platform_data,
    pub charger: *mut power_supply,
    pub charger_desc: power_supply_desc,
    pub work: delayed_work,
    pub notify_node: *mut device_node,
    pub nb: notifier_block,
    pub /: *mut *mut enum bq2415x_mode reported_mode;/ mode reported by hook function,
    pub /: *mut *mut enum bq2415x_mode mode; / currently configured mode,
    pub chip: enum bq2415x_chip,
    pub timer_error: *const c_char,
    pub model: *mut c_char,
    pub name: *mut c_char,
    pub /: *mut *mut int autotimer; / 1 - if driver automatically reset timer, 0 - not,
    pub /: *mut *mut int automode; / 1 - enabled, 0 - disabled; -1 - not supported,
    pub charge_status: c_int,
    pub id: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn bq2415x_i2c_read(bq: *mut bq2415x_device, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_i2c_read_bit(bq: *mut bq2415x_device, reg: u8, bit: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_i2c_write(bq: *mut bq2415x_device, reg: u8, val: u8) -> c_int {
...
// detect chip type
#[no_mangle]
unsafe extern "C" fn bq2415x_detect_chip(bq: *mut bq2415x_device) -> enum bq2415x_chip {
    static enum bq2415x_chip bq2415x_detect_chip(struct bq2415x_device *bq)
    {
    struct i2c_client *client = to_i2c_client(bq.dev);
    let mut ret: c_int = bq2415x_exec_command(bq, BQ2415X_PART_NUMBER);
    if (ret < 0)
    return ret;
    switch (client.addr) {
    case 0x6b:
...
#[no_mangle]
unsafe extern "C" fn bq2415x_detect_revision(bq: *mut bq2415x_device) -> c_int {
    static int bq2415x_detect_revision(struct bq2415x_device *bq)
    {
    let mut ret: c_int = bq2415x_exec_command(bq, BQ2415X_REVISION);
    let mut chip: c_int = bq2415x_detect_chip(bq);
    if (ret < 0 || chip < 0)
    return -1;
    switch (chip) {
    case BQ24150:
...
#[no_mangle]
unsafe extern "C" fn bq2415x_get_vender_code(bq: *mut bq2415x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_reset_chip(bq: *mut bq2415x_device) {
    ...
    bq.timer_error = core::ptr::null_mut();
    }
// properties functions
// set current limit in mA
#[no_mangle]
unsafe extern "C" fn bq2415x_set_current_limit(bq: *mut bq2415x_device, mA: c_int) -> c_int {
    ...
    val = 0;
#[no_mangle]
pub unsafe extern "C" fn if(500: mA <=) -> else {
    else if (mA <= 500)
    val = 1;
#[no_mangle]
pub unsafe extern "C" fn if(800: mA <=) -> else {
    else if (mA <= 800)
    val = 2;
    else
    val = 3;
...
#[no_mangle]
unsafe extern "C" fn bq2415x_get_current_limit(bq: *mut bq2415x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_set_weak_battery_voltage(bq: *mut bq2415x_device, mV: c_int) -> c_int {
...
// round to 100mV
    ...
    val = 0;
#[no_mangle]
pub unsafe extern "C" fn if(50: mV <= 3500 +) -> else {
    else if (mV <= 3500 + 50)
    val = 1;
#[no_mangle]
pub unsafe extern "C" fn if(50: mV <= 3600 +) -> else {
    else if (mV <= 3600 + 50)
    val = 2;
    else
    val = 3;
...
#[no_mangle]
unsafe extern "C" fn bq2415x_get_weak_battery_voltage(bq: *mut bq2415x_device) -> c_int {
...
//
    ...
    val = 0;
#[no_mangle]
pub unsafe extern "C" fn if(47: val >) -> else {
    else if (val > 47)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn bq2415x_get_battery_regulation_voltage(bq: *mut bq2415x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_set_charge_current(bq: *mut bq2415x_device, mA: c_int) -> c_int {
    ...
    val = 0;
#[no_mangle]
pub unsafe extern "C" fn if(7: val >) -> else {
    else if (val > 7)
    val = 7;
...
#[no_mangle]
unsafe extern "C" fn bq2415x_get_charge_current(bq: *mut bq2415x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_set_termination_current(bq: *mut bq2415x_device, mA: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_get_termination_current(bq: *mut bq2415x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_set_defaults(bq: *mut bq2415x_device) -> c_int {
...
// set charger mode
#[no_mangle]
unsafe extern "C" fn bq2415x_set_mode(bq: *mut bq2415x_device, mode: enum bq2415x_mode) -> c_int {
    static int bq2415x_set_mode(struct bq2415x_device *bq, enum bq2415x_mode mode)
    {
    let mut ret: c_int = 0;
    let mut charger: c_int = 0;
    let mut boost: c_int = 0;
    if (mode == BQ2415X_MODE_BOOST)
    boost = 1;
#[no_mangle]
pub unsafe extern "C" fn if(BQ2415X_MODE_OFF: mode !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: boost) -> else {
    else if (boost)
    ...
    bq2415x_set_default_value(bq, battery_regulation_voltage);
    bq.mode = mode;
    sysfs_notify(&bq.charger.dev.kobj, core::ptr::null_mut(), "mode");
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bq2415x_update_reported_mode(bq: *mut bq2415x_device, mA: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(1800: mA <) -> else {
    else if (mA < 1800)
...
#[no_mangle]
unsafe extern "C" fn bq2415x_set_autotimer(bq: *mut bq2415x_device, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_timer_error(bq: *mut bq2415x_device, msg: *const c_char) {
    static void bq2415x_timer_error(struct bq2415x_device *bq, const char *msg)
    {
    bq.timer_error = msg;
    sysfs_notify(&bq.charger.dev.kobj, core::ptr::null_mut(), "timer");
    dev_err(bq.dev, "%s\n", msg);
    if (bq.automode > 0)
    bq.automode = 0;
...
#[no_mangle]
unsafe extern "C" fn bq2415x_timer_work(work: *mut work_struct) {
    ...
    sysfs_notify(&bq.charger.dev.kobj, core::ptr::null_mut(), "reported_mode");
...
#[no_mangle]
unsafe extern "C" fn bq2415x_power_supply_exit(bq: *mut bq2415x_device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "charge_status") ==) -> else {
    else if (strcmp(attr.attr.name, "charge_status") == 0)
    command = BQ2415X_CHARGE_STATUS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "boost_status") ==) -> else {
    else if (strcmp(attr.attr.name, "boost_status") == 0)
    command = BQ2415X_BOOST_STATUS;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "fault_status") ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strncmp(buf, _arg: "off", 0: 3) ==) -> else {
...
// print value of chip register, format: 'register=value'
    ...
    char *buf)
    {
    let mut ret: c_int = bq2415x_i2c_read(bq, reg);
    if (ret < 0)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "weak_battery_voltage") ==) -> else {
    else if (strcmp(attr.attr.name, "weak_battery_voltage") == 0)
    ret = bq2415x_set_weak_battery_voltage(bq, val);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "battery_regulation_voltage") ==) -> else {
    else if (strcmp(attr.attr.name, "battery_regulation_voltage") == 0)
    ret = bq2415x_set_battery_regulation_voltage(bq, val);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "charge_current") ==) -> else {
    else if (strcmp(attr.attr.name, "charge_current") == 0)
    ret = bq2415x_set_charge_current(bq, val);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "termination_current") ==) -> else {
...
// set *_enable entries
    ...
    BQ2415X_CHARGE_TERMINATION_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "high_impedance_enable") ==) -> else {
    else if (strcmp(attr.attr.name, "high_impedance_enable") == 0)
    command = val ? BQ2415X_HIGH_IMPEDANCE_ENABLE :
    BQ2415X_HIGH_IMPEDANCE_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "otg_pin_enable") ==) -> else {
    else if (strcmp(attr.attr.name, "otg_pin_enable") == 0)
    command = val ? BQ2415X_OTG_PIN_ENABLE :
    BQ2415X_OTG_PIN_DISABLE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "stat_pin_enable") ==) -> else {
...
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "stat_pin_enable") ==) -> else {
    ...
    bq2415x_sysfs_show_reported_mode, core::ptr::null_mut());
    ...
    static DEVICE_ATTR(otg_status, S_IRUGO, bq2415x_sysfs_show_status, core::ptr::null_mut());
    static DEVICE_ATTR(charge_status, S_IRUGO, bq2415x_sysfs_show_status, core::ptr::null_mut());
    static DEVICE_ATTR(boost_status, S_IRUGO, bq2415x_sysfs_show_status, core::ptr::null_mut());
    static DEVICE_ATTR(fault_status, S_IRUGO, bq2415x_sysfs_show_status, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn bq2415x_power_supply_init(bq: *mut bq2415x_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_probe(client: *mut i2c_client) -> c_int {
    ...
    const struct acpi_device_id *acpi_id = core::ptr::null_mut();
    struct power_supply *notify_psy = core::ptr::null_mut();
    union power_supply_propval prop;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ACPI_HANDLE(bq->dev)) -> else {
...
#[no_mangle]
unsafe extern "C" fn bq2415x_remove(client: *mut i2c_client) {
