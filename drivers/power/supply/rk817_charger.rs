...
//! Source: drivers/power/supply/rk817_charger.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk817_charger {
    pub dev: *mut device,
    pub rk808: *mut rk808,
    pub bat_ps: *mut power_supply,
    pub chg_ps: *mut power_supply,
    pub plugged_in: bool,
...
// Implementation specific immutable properties from device tree
    pub res_div: c_int,
    pub sleep_enter_current_ua: c_int,
    pub sleep_filter_current_ua: c_int,
    pub bat_charge_full_design_uah: c_int,
    pub bat_voltage_min_design_uv: c_int,
    pub bat_voltage_max_design_uv: c_int,
// Values updated periodically by driver for display.
    pub charge_now_uah: c_int,
    pub volt_avg_uv: c_int,
    pub cur_avg_ua: c_int,
    pub max_chg_cur_ua: c_int,
    pub max_chg_volt_uv: c_int,
    pub charge_status: c_int,
    pub charger_input_volt_avg_uv: c_int,
...
#[no_mangle]
unsafe extern "C" fn rk817_chg_cur_to_reg(chg_cur_ma: u32) -> c_int {
    static int rk817_chg_cur_to_reg(u32 chg_cur_ma)
    {
    if (chg_cur_ma >= 3500)
    return CHG_3_5A;
#[no_mangle]
pub unsafe extern "C" fn if(3000: chg_cur_ma >=) -> else {
    else if (chg_cur_ma >= 3000)
    return CHG_3A;
#[no_mangle]
pub unsafe extern "C" fn if(2750: chg_cur_ma >=) -> else {
    else if (chg_cur_ma >= 2750)
    return CHG_2_75A;
#[no_mangle]
pub unsafe extern "C" fn if(2500: chg_cur_ma >=) -> else {
    else if (chg_cur_ma >= 2500)
    return CHG_2_5A;
#[no_mangle]
pub unsafe extern "C" fn if(2000: chg_cur_ma >=) -> else {
    else if (chg_cur_ma >= 2000)
    return CHG_2A;
#[no_mangle]
pub unsafe extern "C" fn if(1500: chg_cur_ma >=) -> else {
    else if (chg_cur_ma >= 1500)
    return CHG_1_5A;
#[no_mangle]
pub unsafe extern "C" fn if(1000: chg_cur_ma >=) -> else {
    else if (chg_cur_ma >= 1000)
    return CHG_1A;
#[no_mangle]
pub unsafe extern "C" fn if(500: chg_cur_ma >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn rk817_chg_cur_from_reg(reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk817_bat_calib_vol(charger: *mut rk817_charger) {
    static void rk817_bat_calib_vol(struct rk817_charger *charger)
    {
    let mut vcalib0: u32 = 0;
    let mut vcalib1: u32 = 0;
    u8 bulk_reg[2];
// calibrate voltage
...
#[no_mangle]
unsafe extern "C" fn rk817_bat_calib_cur(charger: *mut rk817_charger) {
...
//
#[no_mangle]
unsafe extern "C" fn rk817_record_battery_nvram_values(charger: *mut rk817_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk817_bat_calib_cap(charger: *mut rk817_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk817_read_props(charger: *mut rk817_charger) {
...
#[no_mangle]
unsafe extern "C" fn rk817_plug_in_isr(irq: c_int, cg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rk817_plug_out_isr(irq: c_int, cg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rk817_read_battery_nvram_values(charger: *mut rk817_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk817_charging_monitor(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rk817_cleanup_node(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rk817_charger_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    if (plugout_irq < 0)
    return plugout_irq;
    ret = devm_request_threaded_irq(charger.dev, plugin_irq, core::ptr::null_mut(),
    rk817_plug_in_isr,
    IRQF_TRIGGER_RISING | IRQF_ONESHOT,
    "rk817_plug_in", charger);
    if (ret)
    return ret;
    ret = devm_request_threaded_irq(charger.dev, plugout_irq, core::ptr::null_mut(),
    rk817_plug_out_isr,
    IRQF_TRIGGER_RISING | IRQF_ONESHOT,
...
#[no_mangle]
unsafe extern "C" fn rk817_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn rk817_resume(dev: *mut device) -> int __maybe_unused {
