...
//! Source: drivers/power/supply/qcom_smbb.c
#![no_std]
...
pub const SMBB_CHG_VMAX: c_uint = 0x040;
pub const SMBB_CHG_VSAFE: c_uint = 0x041;
pub const SMBB_CHG_CFG: c_uint = 0x043;
pub const SMBB_CHG_IMAX: c_uint = 0x044;
pub const SMBB_CHG_ISAFE: c_uint = 0x045;
pub const SMBB_CHG_VIN_MIN: c_uint = 0x047;
pub const SMBB_CHG_CTRL: c_uint = 0x049;

pub const SMBB_CHG_VBAT_WEAK: c_uint = 0x052;
pub const SMBB_CHG_IBAT_TERM_CHG: c_uint = 0x05b;

pub const IBAT_TERM_CHG_IEOC_CHG: c_int = 0;
pub const SMBB_CHG_VBAT_DET: c_uint = 0x05d;
pub const SMBB_CHG_TCHG_MAX_EN: c_uint = 0x060;

pub const SMBB_CHG_WDOG_TIME: c_uint = 0x062;
pub const SMBB_CHG_WDOG_EN: c_uint = 0x065;

pub const SMBB_BUCK_REG_MODE: c_uint = 0x174;

pub const BUCK_REG_MODE_VSYS: c_int = 0;
pub const SMBB_BAT_PRES_STATUS: c_uint = 0x208;

pub const SMBB_BAT_TEMP_STATUS: c_uint = 0x209;

pub const SMBB_BAT_BTC_CTRL: c_uint = 0x249;

pub const SMBB_USB_IMAX: c_uint = 0x344;
pub const SMBB_USB_OTG_CTL: c_uint = 0x348;

pub const SMBB_USB_ENUM_TIMER_STOP: c_uint = 0x34e;

pub const SMBB_USB_SEC_ACCESS: c_uint = 0x3d0;
pub const SEC_ACCESS_MAGIC: c_uint = 0xa5;
pub const SMBB_USB_REV_BST: c_uint = 0x3ed;

pub const SMBB_DC_IMAX: c_uint = 0x444;
pub const SMBB_MISC_REV2: c_uint = 0x601;
pub const SMBB_MISC_BOOT_DONE: c_uint = 0x642;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct smbb_charger {
    pub revision: c_uint,
    pub addr: c_uint,
    pub dev: *mut device,
    pub edev: *mut extcon_dev,
    pub dc_disabled: bool,
    pub jeita_ext_temp: bool,
    pub status: c_ulong,
    pub statlock: mutex,
    pub attr: [c_uint; _ATTR_CNT],
    pub usb_psy: *mut power_supply,
    pub dc_psy: *mut power_supply,
    pub bat_psy: *mut power_supply,
    pub regmap: *mut regmap,
    pub otg_rdesc: regulator_desc,
    pub otg_reg: *mut regulator_dev,
}
...
#[no_mangle]
unsafe extern "C" fn smbb_vbat_weak_fn(index: c_uint) -> c_int {
    static int smbb_vbat_weak_fn(unsigned int index)
    {
    return 2100000 + index * 100000;
    }
#[no_mangle]
unsafe extern "C" fn smbb_vin_fn(index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbb_vmax_fn(index: c_uint) -> c_int {
    static int smbb_vmax_fn(unsigned int index)
    {
    return 3240000 + index * 10000;
    }
#[no_mangle]
unsafe extern "C" fn smbb_vbat_det_fn(index: c_uint) -> c_int {
    static int smbb_vbat_det_fn(unsigned int index)
    {
    return 3240000 + index * 20000;
    }
#[no_mangle]
unsafe extern "C" fn smbb_imax_fn(index: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbb_bat_imax_fn(index: c_uint) -> c_int {
    static int smbb_bat_imax_fn(unsigned int index)
    {
    return index * 50000;
    }
#[no_mangle]
unsafe extern "C" fn smbb_hw_lookup(val: c_uint, int): *mut *mut int (fn)(unsigned) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn smbb_set_line_flag(chg: *mut smbb_charger, irq: c_int, flag: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smbb_usb_valid_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smbb_dc_valid_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smbb_bat_temp_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smbb_bat_present_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smbb_chg_done_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smbb_chg_gone_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smbb_chg_fast_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smbb_chg_trkl_handler(irq: c_int, _data: *mut c_void) -> irqreturn_t {
    ...
    enum power_supply_property psp)
    {
    let mut psp: return = = POWER_SUPPLY_PROP_CHARGE_CONTROL_LIMIT;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_USBIN_VALID)): !(status & (STATUS_DCIN_VALID |) -> else {
    else if (!(status & (STATUS_DCIN_VALID | STATUS_USBIN_VALID)))
    val.intval = POWER_SUPPLY_STATUS_DISCHARGING;
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_CHG_DONE: status &) -> else {
    else if (status & STATUS_CHG_DONE)
    val.intval = POWER_SUPPLY_STATUS_FULL;
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_BAT_OK): !(status &) -> else {
    else if (!(status & STATUS_BAT_OK))
    val.intval = POWER_SUPPLY_STATUS_DISCHARGING;
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_CHG_TRKL): status & (STATUS_CHG_FAST |) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_BAT_HOT: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_CHG_TRKL: status &) -> else {
...
#[no_mangle]
unsafe extern "C" fn smbb_chg_otg_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbb_chg_otg_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbb_chg_otg_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smbb_charger_probe(pdev: *mut platform_device) -> c_int {
    static int smbb_charger_probe(struct platform_device *pdev)
    {
    let mut bat_cfg: power_supply_config = {};
    let mut usb_cfg: power_supply_config = {};
    let mut dc_cfg: power_supply_config = {};
    ...
    rc = devm_request_threaded_irq(&pdev.dev, irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn smbb_charger_remove(pdev: *mut platform_device) {
