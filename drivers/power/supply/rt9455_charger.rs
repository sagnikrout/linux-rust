...
//! Source: drivers/power/supply/rt9455_charger.c
#![no_std]
...
pub const RT9455_CHARGE_MODE: c_uint = 0x00;
pub const RT9455_BOOST_MODE: c_uint = 0x01;
pub const RT9455_FAULT: c_uint = 0x03;
pub const RT9455_IAICR_100MA: c_uint = 0x00;
pub const RT9455_IAICR_500MA: c_uint = 0x01;
pub const RT9455_IAICR_NO_LIMIT: c_uint = 0x03;
pub const RT9455_CHARGE_DISABLE: c_uint = 0x00;
pub const RT9455_CHARGE_ENABLE: c_uint = 0x01;
pub const RT9455_PWR_FAULT: c_uint = 0x00;
pub const RT9455_PWR_GOOD: c_uint = 0x01;
pub const RT9455_REG_CTRL1: c_uint = 0x00 /* CTRL1 reg address */;
pub const RT9455_REG_CTRL2: c_uint = 0x01 /* CTRL2 reg address */;
pub const RT9455_REG_CTRL3: c_uint = 0x02 /* CTRL3 reg address */;
pub const RT9455_REG_DEV_ID: c_uint = 0x03 /* DEV_ID reg address */;
pub const RT9455_REG_CTRL4: c_uint = 0x04 /* CTRL4 reg address */;
pub const RT9455_REG_CTRL5: c_uint = 0x05 /* CTRL5 reg address */;
pub const RT9455_REG_CTRL6: c_uint = 0x06 /* CTRL6 reg address */;
pub const RT9455_REG_CTRL7: c_uint = 0x07 /* CTRL7 reg address */;
pub const RT9455_REG_IRQ1: c_uint = 0x08 /* IRQ1 reg address */;
pub const RT9455_REG_IRQ2: c_uint = 0x09 /* IRQ2 reg address */;
pub const RT9455_REG_IRQ3: c_uint = 0x0A /* IRQ3 reg address */;
pub const RT9455_REG_MASK1: c_uint = 0x0B /* MASK1 reg address */;
pub const RT9455_REG_MASK2: c_uint = 0x0C /* MASK2 reg address */;
pub const RT9455_REG_MASK3: c_uint = 0x0D /* MASK3 reg address */;
    enum rt9455_fields {
...
pub struct rt9455_info {
    ...
    pub pwr_rdy_work: delayed_work,
    pub max_charging_time_work: delayed_work,
    pub batt_presence_work: delayed_work,
    pub voreg: u32,
...
//
#[no_mangle]
unsafe extern "C" fn rt9455_find_idx(tbl[]: c_int, tbl_size: c_int, v: c_int) -> c_uint {
...
// val = tbl[v];
    ...
    const int tbl[], int tbl_size, int val)
    {
    let mut idx: c_uint = rt9455_find_idx(tbl, tbl_size, val);
    return regmap_field_write(info.regmap_fields[field], idx);
    }
#[no_mangle]
unsafe extern "C" fn rt9455_register_reset(info: *mut rt9455_info) -> c_int {
...
//
    ...
    union power_supply_propval *val)
    {
    let mut idx: c_int = ARRAY_SIZE(rt9455_ichrg_values) - 1;
    ...
    union power_supply_propval *val)
    {
    let mut idx: c_int = ARRAY_SIZE(rt9455_vmreg_values) - 1;
...
//
#[no_mangle]
unsafe extern "C" fn rt9455_set_boost_voltage_before_boost_mode(info: *mut rt9455_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rt9455_set_voreg_before_charge_mode(info: *mut rt9455_info) -> c_int {
    ...
    struct device *dev = &info.client.dev;
    let mut is_battery_absent: bool = false;
    let mut alert_userspace: bool = false;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rt9455_irq_handler_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt9455_pwr_rdy_work_callback(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rt9455_max_charging_time_work_callback(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rt9455_batt_presence_work_callback(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rt9455_is_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt9455_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt9455_cancel_all_delayed_works(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rt9455_probe(client: *mut i2c_client) -> c_int {
    static int rt9455_probe(struct i2c_client *client)
    {
    struct i2c_adapter *adapter = client.adapter;
    struct device *dev = &client.dev;
    struct rt9455_info *info;
    let mut rt9455_charger_config: power_supply_config = {};
//
...
//
    info.nb.notifier_call = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn rt9455_remove(client: *mut i2c_client) {
