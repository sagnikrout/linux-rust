...
//! Source: drivers/power/supply/isp1704_charger.c
#![no_std]
...
pub const ISP1704_PWR_CTRL: c_uint = 0x3d;

pub const NXP_VENDOR_ID: c_uint = 0x04cc;
...
// properties
    ...
    pub online:1: unsigned,
    pub current_max: unsigned,
}

#[no_mangle]
pub unsafe extern "C" fn isp1704_read(isp: *mut isp1704_charger, reg: u32) -> c_int {
    static inline int isp1704_read(struct isp1704_charger *isp, u32 reg)
    {
    return usb_phy_io_read(isp.phy, reg);
    }
#[no_mangle]
pub unsafe extern "C" fn isp1704_write(isp: *mut isp1704_charger, reg: u32, val: u32) -> c_int {
    static inline int isp1704_write(struct isp1704_charger *isp, u32 reg, u32 val)
    {
    return usb_phy_io_write(isp.phy, val, reg);
    }
#[no_mangle]
unsafe extern "C" fn isp1704_charger_set_power(isp: *mut isp1704_charger, on: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn isp1704_charger_type(isp: *mut isp1704_charger) -> c_int {
    static inline int isp1704_charger_type(struct isp1704_charger *isp)
    {
    u8 reg;
    u8 func_ctrl;
    u8 otg_ctrl;
    let mut type: c_int = POWER_SUPPLY_TYPE_USB_DCP;
...
//
#[no_mangle]
pub unsafe extern "C" fn isp1704_charger_verify(isp: *mut isp1704_charger) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isp1704_charger_detect(isp: *mut isp1704_charger) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn isp1704_charger_detect_dcp(isp: *mut isp1704_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isp1704_charger_work(data: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn isp1704_test_ulpi(isp: *mut isp1704_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isp1704_charger_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isp1704_charger_remove(pdev: *mut platform_device) {
