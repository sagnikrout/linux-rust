...
//! Source: drivers/power/supply/sbs-battery.c
#![no_std]
...
pub const REG_ADDR_SPEC_INFO: c_uint = 0x1A;

pub const SPEC_INFO_VERSION_SHIFT: c_int = 4;
pub const SBS_VERSION_1_0: c_int = 1;
pub const SBS_VERSION_1_1: c_int = 2;
pub const SBS_VERSION_1_1_WITH_PEC: c_int = 3;
pub const REG_ADDR_MANUFACTURE_DATE: c_uint = 0x1B;
// Battery Mode defines
pub const BATTERY_MODE_OFFSET: c_uint = 0x03;
...
pub const MANUFACTURER_ACCESS_STATUS: c_uint = 0x0006;
pub const MANUFACTURER_ACCESS_SLEEP: c_uint = 0x0011;
// battery status value bits
pub const BATTERY_INITIALIZED: c_uint = 0x80;
pub const BATTERY_DISCHARGING: c_uint = 0x40;
pub const BATTERY_FULL_CHARGED: c_uint = 0x20;
pub const BATTERY_FULL_DISCHARGED: c_uint = 0x10;
...
pub struct sbs_info {
    ...
    pub is_present: bool,
    pub gpio_detect: *mut gpio_desc,
    pub charger_broadcasts: bool,
    ...
    pub 1]: char strings[NR_STRING_BUFFERS][I2C_SMBUS_BLOCK_MAX +,
    pub serial: [c_char; 5],
}
...
#[no_mangle]
unsafe extern "C" fn sbs_invalidate_cached_props(chip: *mut sbs_info) {
...
#[no_mangle]
unsafe extern "C" fn sbs_disable_charger_broadcasts(chip: *mut sbs_info) {
    static void sbs_disable_charger_broadcasts(struct sbs_info *chip)
    {
    let mut val: c_int = sbs_read_word_data(chip.client, BATTERY_MODE_OFFSET);
    if (val < 0)
    goto exit;
...
#[no_mangle]
unsafe extern "C" fn sbs_update_presence(chip: *mut sbs_info, is_present: bool) -> c_int {
    static int sbs_update_presence(struct sbs_info *chip, bool is_present)
    {
    struct i2c_client *client = chip.client;
    let mut retries: c_int = chip.i2c_retry_count;
    let mut ret: i32 = 0;
    u8 version;
...
#[no_mangle]
unsafe extern "C" fn sbs_read_word_data(client: *mut i2c_client, address: u8) -> c_int {
    static int sbs_read_word_data(struct i2c_client *client, u8 address)
    {
...
#[no_mangle]
unsafe extern "C" fn sbs_read_string_data_fallback(client: *mut i2c_client, address: u8, values: *mut c_char) -> c_int {
    static int sbs_read_string_data_fallback(struct i2c_client *client, u8 address, char *values)
    {
    struct sbs_info *chip = i2c_get_clientdata(client);
    let mut ret: i32 = 0, block_length = 0;
...
#[no_mangle]
unsafe extern "C" fn sbs_read_string_data(client: *mut i2c_client, address: u8, values: *mut c_char) -> c_int {
    ...
    let mut pec: bool = client.flags & I2C_CLIENT_PEC;
    client.flags &= ~I2C_CLIENT_PEC;
...
#[no_mangle]
unsafe extern "C" fn sbs_status_correct(client: *mut i2c_client, intval: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sbs_bat_needs_calibration(client: *mut i2c_client) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x0B: ret ==) -> else {
    else if (ret == 0x0B)
    val.intval = POWER_SUPPLY_HEALTH_OVERHEAT;
#[no_mangle]
pub unsafe extern "C" fn if(0x0C: ret ==) -> else {
    else if (ret == 0x0C)
    val.intval = POWER_SUPPLY_HEALTH_DEAD;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sbs_bat_needs_calibration(client)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(BATTERY_FULL_CHARGED: ret &) -> else {
    else if (ret & BATTERY_FULL_CHARGED)
    val.intval =
    POWER_SUPPLY_CAPACITY_LEVEL_FULL;
#[no_mangle]
pub unsafe extern "C" fn if(BATTERY_FULL_DISCHARGED: ret &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(BATTERY_DISCHARGING: ret &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(val->intval: chip->last_state !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(POWER_SUPPLY_PROP_CAPACITY: psp ==) -> else {
...
//
    ...
    {
pub const BASE_UNIT_CONVERSION: c_int = 1000;

pub const TIME_UNIT_CONVERSION: c_int = 60;
pub const TEMP_KELVIN_TO_CELSIUS: c_int = 2731;
    switch (psp) {
...
//
    ...
    {
    s32 ret;
    let mut mode: enum sbs_capacity_mode = CAPACITY_MODE_WATTS;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncasecmp(chemistry, _arg: "LiP", _arg: 3)) -> else {
    else if (!strncasecmp(chemistry, "LiP", 3))
    chip.technology = POWER_SUPPLY_TECHNOLOGY_LIPO;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncasecmp(chemistry, _arg: "NiCd", _arg: 4)) -> else {
    else if (!strncasecmp(chemistry, "NiCd", 4))
    chip.technology = POWER_SUPPLY_TECHNOLOGY_NiCd;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncasecmp(chemistry, _arg: "NiMH", _arg: 4)) -> else {
    else if (!strncasecmp(chemistry, "NiMH", 4))
    chip.technology = POWER_SUPPLY_TECHNOLOGY_NiMH;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncasecmp(chemistry, _arg: "PbAc", _arg: 4)) -> else {
    else if (!strncasecmp(chemistry, "PbAc", 4))
    chip.technology = POWER_SUPPLY_TECHNOLOGY_PbAc;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncasecmp(chemistry, _arg: "NiZn", _arg: 4)) -> else {
    else if (!strncasecmp(chemistry, "NiZn", 4))
    chip.technology = POWER_SUPPLY_TECHNOLOGY_NiZn;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncasecmp(chemistry, _arg: "RAM", _arg: 3)) -> else {
    else if (!strncasecmp(chemistry, "RAM", 3))
    chip.technology = POWER_SUPPLY_TECHNOLOGY_RAM;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncasecmp(chemistry, _arg: "ZnAr", _arg: 4)) -> else {
...
//
    ...
    let mut old_present: bool = chip.is_present;
    union power_supply_propval val;
...
#[no_mangle]
unsafe extern "C" fn sbs_supply_changed(chip: *mut sbs_info) {
...
#[no_mangle]
unsafe extern "C" fn sbs_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sbs_external_power_changed(psy: *mut power_supply) {
...
//
    ...
    rc = devm_request_threaded_irq(&client.dev, irq, core::ptr::null_mut(), sbs_irq,
...
#[no_mangle]
unsafe extern "C" fn sbs_suspend(dev: *mut device) -> c_int {
...
// Write to manufacturer access with sleep command.
    ...
    static SIMPLE_DEV_PM_OPS(sbs_pm_ops, sbs_suspend, core::ptr::null_mut());
