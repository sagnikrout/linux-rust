...
//! Source: drivers/power/supply/charger-manager.c
#![no_std]
...
//
pub const CM_DEFAULT_RECHARGE_TEMP_DIFF: c_int = 50;
pub const CM_DEFAULT_CHARGE_TEMP_MAX: c_int = 500;
//
...
//
#[no_mangle]
unsafe extern "C" fn is_batt_present(cm: *mut charger_manager) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn is_ext_pwr_online(cm: *mut charger_manager) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn get_batt_uV(cm: *mut charger_manager, uV: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn is_charging(cm: *mut charger_manager) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn is_full_charged(cm: *mut charger_manager) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn is_polling_required(cm: *mut charger_manager) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn try_charger_enable(cm: *mut charger_manager, enable: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_charging_duration(cm: *mut charger_manager) -> c_int {
    static int check_charging_duration(struct charger_manager *cm)
    {
    struct charger_desc *desc = cm.desc;
    let mut curr: u64 = ktime_to_ms(ktime_get());
    u64 duration;
...
#[no_mangle]
unsafe extern "C" fn cm_check_thermal_status(cm: *mut charger_manager) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(lower_limit: temp <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn cm_get_target_status(cm: *mut charger_manager) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _cm_monitor(cm: *mut charger_manager) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn cm_monitor() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn _setup_polling(work: *mut work_struct) {
    static void _setup_polling(struct work_struct *work)
    {
    let mut min: c_ulong = ULONG_MAX;
    struct charger_manager *cm;
    let mut keep_polling: bool = false;
    ...
    goto out;
    WARN(cm_wq == core::ptr::null_mut(), "charger-manager: workqueue not initialized"
    ". try it later. %s\n", __func__);
//
...
//
#[no_mangle]
unsafe extern "C" fn cm_monitor_poller(work: *mut work_struct) {
    ...
    struct charger_desc *desc = cm.desc;
    struct power_supply *fuel_gauge = core::ptr::null_mut();
    let mut ret: c_int = 0;
    int uV;
    switch (psp) {
...
#[no_mangle]
pub unsafe extern "C" fn if(CM_BATT_COLD: cm->emergency_stop ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn cm_setup_timer() -> bool {
    static bool cm_setup_timer(void)
    {
    struct charger_manager *cm;
    let mut wakeup_ms: c_uint = UINT_MAX;
    let mut timer_req: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn charger_extcon_work(work: *mut work_struct) {
...
//
    ...
    {
    int ret, i;
    let mut extcon_type: u64 = EXTCON_NONE;
//
...
#[no_mangle]
unsafe extern "C" fn charger_manager_get_regulators(cm: *mut charger_manager) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn charger_manager_register_extcon(cm: *mut charger_manager) -> c_int {
...
// help function of sysfs node to control charger(regulator)
    ...
    let mut chargers_externally_control: c_int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn charger_manager_prepare_sysfs(cm: *mut charger_manager) -> c_int {
...
// Create sysfs entry to control charger(regulator)
    ...
    charger.attrs[3] = core::ptr::null_mut();
...
// NOTICE : Default allowable minimum charge temperature is 0
    ...
    let mut poll_mode: u32 = CM_POLL_DISABLE;
    let mut battery_stat: u32 = CM_NO_BATTERY;
    let mut num_chgs: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn cm_timer_func(alarm: *mut alarm, now: ktime_t) {
    static void cm_timer_func(struct alarm *alarm, ktime_t now)
    {
    cm_timer_set = false;
    }
#[no_mangle]
unsafe extern "C" fn charger_manager_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn charger_manager_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cm_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_need_to_awake() -> bool {
...
#[no_mangle]
unsafe extern "C" fn cm_suspend_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_suspend_complete(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn charger_manager_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn charger_manager_cleanup() -> void __exit {
    static void __exit charger_manager_cleanup(void)
    {
    destroy_workqueue(cm_wq);
    cm_wq = core::ptr::null_mut();
