...
//! Source: drivers/power/supply/wm831x_backup.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm831x_backup {
    pub wm831x: *mut wm831x,
    pub backup: *mut power_supply,
    pub backup_desc: power_supply_desc,
    pub name: [c_char; 20],
}
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_config_backup(wm831x: *mut wm831x) {
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_backup_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    &devdata.backup_desc, core::ptr::null_mut());
