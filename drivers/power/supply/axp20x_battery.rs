...
//! Source: drivers/power/supply/axp20x_battery.c
#![no_std]
...
pub const AXP717_PWR_STATUS_BAT_STANDBY: c_int = 0;
pub const AXP717_PWR_STATUS_BAT_CHRG: c_int = 1;
pub const AXP717_PWR_STATUS_BAT_DISCHRG: c_int = 2;

pub const AXP717_CHRG_CV_4_0V: c_int = 0;
pub const AXP717_CHRG_CV_4_1V: c_int = 1;
pub const AXP717_CHRG_CV_4_2V: c_int = 2;
pub const AXP717_CHRG_CV_4_35V: c_int = 3;
pub const AXP717_CHRG_CV_4_4V: c_int = 4;
// Values 5 and 6 reserved.
pub const AXP717_CHRG_CV_5_0V: c_int = 7;

pub const AXP717_ITERM_CC_STEP: c_int = 64000;

pub const AXP717_BAT_VMIN_MIN_UV: c_int = 2600000;
pub const AXP717_BAT_VMIN_MAX_UV: c_int = 3300000;
pub const AXP717_BAT_VMIN_STEP: c_int = 100000;
pub const AXP717_BAT_CV_MIN_UV: c_int = 4000000;
pub const AXP717_BAT_CV_MAX_UV: c_int = 5000000;
pub const AXP717_BAT_CC_MIN_UA: c_int = 0;
pub const AXP717_BAT_CC_MAX_UA: c_int = 3008000;
...
pub struct axp_data {
    pub ccc_scale: c_int,
    pub ccc_offset: c_int,
    pub ccc_reg: c_uint,
    pub ccc_mask: c_uint,
    pub has_fg_valid: bool,
    pub bat_ps_desc: *const power_supply_desc,
    pub val): *mut *mut *mut int (get_max_voltage)(struct axp20x_batt_ps batt, int,
    pub val): *mut *mut *mut int (set_max_voltage)(struct axp20x_batt_ps batt, int,
    int	(*cfg_iio_chan)(struct platform_device *pdev,
    pub axp_batt): *mut axp20x_batt_ps,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct axp20x_batt_ps {
    pub regmap: *mut regmap,
    pub batt: *mut power_supply,
    pub dev: *mut device,
    pub batt_chrg_i: *mut iio_channel,
    pub batt_dischrg_i: *mut iio_channel,
    pub batt_v: *mut iio_channel,
// Maximum constant charge current
    pub max_ccc: c_uint,
    pub data: *const axp_data,
    pub ts_disable: bool,
}
...
//
    ...
    int min_voltage)
    {
    let mut val1: c_int = (min_voltage - 2600000) / 100000;
    ...
    int min_voltage)
    {
    let mut val1: c_int = (min_voltage - AXP717_BAT_VMIN_MIN_UV) / AXP717_BAT_VMIN_STEP;
    ...
    {
    let mut vmin: c_int = info.voltage_min_design_uv;
    let mut ccc: c_int = info.constant_charge_current_max_ua;
...
// Set max to unverified value to be able to set CCC
    ...
    {
    let mut vmin: c_int = info.voltage_min_design_uv;
    let mut vmax: c_int = info.voltage_max_design_uv;
    let mut ccc: c_int = info.constant_charge_current_max_ua;
    int val;
...
#[no_mangle]
unsafe extern "C" fn axp20x_power_probe(pdev: *mut platform_device) -> c_int {
    ...
    axp20x_batt.regmap = dev_get_regmap(pdev.dev.parent, core::ptr::null_mut());
