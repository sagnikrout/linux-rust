...
//! Source: drivers/power/supply/ingenic-battery.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn if(info->voltage_max_design_uv: val->intval >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ingenic_battery_set_scale(bat: *mut ingenic_battery) -> c_int {
    ...
    let mut scale_mV: u64 = (max_raw * scale_raw[i]) >> scale_raw[i + 1];
    if (scale_mV < max_mV)
    continue;
...
#[no_mangle]
unsafe extern "C" fn ingenic_battery_probe(pdev: *mut platform_device) -> c_int {
