...
//! Source: drivers/power/supply/goldfish_battery.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct goldfish_battery_data {
...
#[no_mangle]
unsafe extern "C" fn goldfish_battery_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn goldfish_battery_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (data.reg_base == core::ptr::null_mut()) {
