...
//! Source: drivers/power/supply/bq27xxx_battery.c
#![no_std]
...
pub const BQ27XXX_SEALED: c_uint = 0x20;
pub const BQ27XXX_SET_CFGUPDATE: c_uint = 0x13;
pub const BQ27XXX_SOFT_RESET: c_uint = 0x42;
pub const BQ27XXX_RESET: c_uint = 0x41;

pub const INVALID_REG_ADDR: c_uint = 0xff;
//
...
pub const BQ27XXX_DM_SZ: c_int = 32;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bq27xxx_dm_buf {
    pub class: u8,
    pub block: u8,
    pub data: [u8; BQ27XXX_DM_SZ],
    pub dirty: bool has_data,,
}
    ...
    let mut bq27xxx_dt_to_nvm: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn poll_interval_param_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int poll_interval_param_set(const char *val, const struct kernel_param *kp)
    {
    struct bq27xxx_device_info *di;
    let mut prev_val: c_uint = *(unsigned int *) kp.arg;
    int ret;
    ...
    let mut poll_interval: static unsigned int = 360;
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_seal(di: *mut bq27xxx_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_unseal(di: *mut bq27xxx_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_checksum_dm_block(buf: *mut bq27xxx_dm_buf) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_cfgupdate_priv(di: *mut bq27xxx_device_info, active: bool) -> c_int {
    static int bq27xxx_battery_cfgupdate_priv(struct bq27xxx_device_info *di, bool active)
    {
    let mut limit: c_int = 100;
    let mut cmd: u16 = active ? BQ27XXX_SET_CFGUPDATE : BQ27XXX_SOFT_RESET;
    int ret, try = limit;
...
#[no_mangle]
pub unsafe extern "C" fn bq27xxx_battery_set_cfgupdate(di: *mut bq27xxx_device_info) -> c_int {
    static inline int bq27xxx_battery_set_cfgupdate(struct bq27xxx_device_info *di)
    {
    let mut ret: c_int = bq27xxx_battery_cfgupdate_priv(di, true);
    if (ret < 0 && ret != -EINVAL)
    dev_err(di.dev, "bus error on set_cfgupdate: %d\n", ret);
    return ret;
    }
#[no_mangle]
pub unsafe extern "C" fn bq27xxx_battery_soft_reset(di: *mut bq27xxx_device_info) -> c_int {
    static inline int bq27xxx_battery_soft_reset(struct bq27xxx_device_info *di)
    {
    let mut ret: c_int = bq27xxx_battery_cfgupdate_priv(di, false);
    if (ret < 0 && ret != -EINVAL)
    ...
    struct bq27xxx_dm_buf *buf)
    {
    let mut cfgup: bool = di.opts & BQ27XXX_O_CFGUP;
    int ret;
    if (!buf.dirty)
    return 0;
    if (cfgup) {
...
//
    ...
    {
    let mut bd: bq27xxx_dm_buf = BQ27XXX_DM_BUF(di, BQ27XXX_DM_DESIGN_CAPACITY);
    let mut bt: bq27xxx_dm_buf = BQ27XXX_DM_BUF(di, BQ27XXX_DM_TERMINATE_VOLTAGE);
    bool updated;
...
// assume design energy & capacity are in same block
    ...
    let mut same: bool = bd.class == bt.class && bd.block == bt.block;
    if (!same)
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_settings(di: *mut bq27xxx_device_info) {
...
#[no_mangle]
pub unsafe extern "C" fn if(-EINVAL: info->charge_full_design_uah ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_read_soc(di: *mut bq27xxx_device_info) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_overtemp(di: *mut bq27xxx_device_info, flags: u16) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_undertemp(di: *mut bq27xxx_device_info, flags: u16) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_dead(di: *mut bq27xxx_device_info, flags: u16) -> bool {
    static bool bq27xxx_battery_dead(struct bq27xxx_device_info *di, u16 flags)
    {
    if (di.opts & BQ27XXX_O_ZERO)
    return flags & (BQ27000_FLAG_EDV1 | BQ27000_FLAG_EDVF);
#[no_mangle]
pub unsafe extern "C" fn if(BQ27Z561_O_BITS: di->opts &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: unlikely(bq27xxx_battery_undertemp(di, _arg: di->cache.flags))) -> else {
    else if (unlikely(bq27xxx_battery_undertemp(di, di.cache.flags)))
    health = POWER_SUPPLY_HEALTH_COLD;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: unlikely(bq27xxx_battery_dead(di, _arg: di->cache.flags))) -> else {
    else if (unlikely(bq27xxx_battery_dead(di, di.cache.flags)))
    health = POWER_SUPPLY_HEALTH_DEAD;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: unlikely(bq27xxx_battery_capacity_inaccurate(di, _arg: di->cache.flags))) -> else {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_is_full(di: *mut bq27xxx_device_info, flags: c_int) -> bool {
...
//
    ...
    {
    let mut single_flags: bool = (di.opts & BQ27XXX_O_ZERO);
    int curr;
    int flags;
...
#[no_mangle]
pub unsafe extern "C" fn if(0: curr >) -> else {
    else if (curr > 0)
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_update_unlocked(di: *mut bq27xxx_device_info) {
    static void bq27xxx_battery_update_unlocked(struct bq27xxx_device_info *di)
    {
    let mut status: union power_supply_propval = di.last_status;
    let mut cache: bq27xxx_reg_cache = {0, };
    let mut has_singe_flag: bool = di.opts & BQ27XXX_O_ZERO;
...
//
    if (!(di.opts & BQ27XXX_O_ZERO))
    bq27xxx_battery_current_and_status(di, core::ptr::null_mut(), &status, &cache);
    }
...
#[no_mangle]
pub unsafe extern "C" fn bq27xxx_battery_update(di: *mut bq27xxx_device_info) {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_poll(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(BQ27000_FLAG_EDVF: di->cache.flags &) -> else {
    else if (di.cache.flags & BQ27000_FLAG_EDVF)
    level = POWER_SUPPLY_CAPACITY_LEVEL_CRITICAL;
#[no_mangle]
pub unsafe extern "C" fn if(BQ27000_FLAG_EDV1: di->cache.flags &) -> else {
    ...
    level = POWER_SUPPLY_CAPACITY_LEVEL_FULL;
#[no_mangle]
pub unsafe extern "C" fn if(BQ27Z561_FLAG_FDC: di->cache.flags &) -> else {
    ...
    level = POWER_SUPPLY_CAPACITY_LEVEL_FULL;
#[no_mangle]
pub unsafe extern "C" fn if(BQ27XXX_FLAG_SOCF: di->cache.flags &) -> else {
    else if (di.cache.flags & BQ27XXX_FLAG_SOCF)
    level = POWER_SUPPLY_CAPACITY_LEVEL_CRITICAL;
#[no_mangle]
pub unsafe extern "C" fn if(BQ27XXX_FLAG_SOC1: di->cache.flags &) -> else {
...
// Save for later reads
    ...
    ret = bq27xxx_battery_current_and_status(di, core::ptr::null_mut(), val, core::ptr::null_mut());
    break;
    ...
    ret = bq27xxx_battery_current_and_status(di, val, core::ptr::null_mut(), core::ptr::null_mut());
    break;
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_external_power_changed(psy: *mut power_supply) {
...
#[no_mangle]
pub unsafe extern "C" fn bq27xxx_battery_setup(di: *mut bq27xxx_device_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bq27xxx_battery_teardown(di: *mut bq27xxx_device_info) {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq27xxx_battery_resume(dev: *mut device) -> c_int {
