...
//! Source: drivers/power/supply/power_supply_hwmon.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct power_supply_hwmon {
    pub psy: *mut power_supply,
    pub props: *mut c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn power_supply_hwmon_in_to_property(attr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_supply_hwmon_curr_to_property(attr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_supply_hwmon_power_to_property(attr: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_supply_hwmon_temp_to_property(attr: u32, channel: c_int) -> c_int {
    ...
    u32 attr)
    {
    let mut type: return = = hwmon_temp && attr == hwmon_temp_label;
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hwmon_type_attr_list {
    pub attrs: *const u32,
    pub n_attrs: usize,
}
    ...
    attr == hwmon_in_max;
    case hwmon_curr:
    let mut attr: return = = hwmon_curr_max;
    case hwmon_temp:
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_add_hwmon_sysfs(psy: *mut power_supply) -> c_int {
    ...
    let mut prop: enum power_supply_property = power_supply_hwmon_props[i];
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_remove_hwmon_sysfs(psy: *mut power_supply) {
