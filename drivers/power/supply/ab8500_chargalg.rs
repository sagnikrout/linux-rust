...
//! Source: drivers/power/supply/ab8500_chargalg.c
#![no_std]
...
pub const EOC_COND_CNT: c_int = 10;
// One hour expressed in seconds
pub const ONE_HOUR_IN_SECONDS: c_int = 3600;
// Five minutes expressed in seconds
pub const FIVE_MINUTES_IN_SECONDS: c_int = 300;
//
// This is the battery capacity limit that will trigger a new
// full charging cycle in the case where maintenance charging
// has been disabled
//
pub const AB8500_RECHARGE_CAP: c_int = 95;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_chargalg_charger_info {
    pub conn_chg: enum ab8500_chargers,
    pub prev_conn_chg: enum ab8500_chargers,
    pub online_chg: enum ab8500_chargers,
    pub prev_online_chg: enum ab8500_chargers,
    pub charger_type: enum ab8500_chargers,
    pub usb_chg_ok: bool,
    pub ac_chg_ok: bool,
    pub usb_volt_uv: c_int,
    pub usb_curr_ua: c_int,
    pub ac_volt_uv: c_int,
    pub ac_curr_ua: c_int,
    pub usb_vset_uv: c_int,
    pub usb_iset_ua: c_int,
    pub ac_vset_uv: c_int,
    pub ac_iset_ua: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_chargalg_battery_data {
    pub temp: c_int,
    pub volt_uv: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_chargalg_events {
    pub batt_unknown: bool,
    pub mainextchnotok: bool,
    pub batt_ovv: bool,
    pub batt_rem: bool,
    pub btemp_underover: bool,
    pub btemp_low: bool,
    pub btemp_high: bool,
    ...
    pub maintenance_timer_expired: bool,
    pub ac_wd_expired: bool,
    pub usb_wd_expired: bool,
    pub ac_cv_active: bool,
    pub usb_cv_active: bool,
    pub vbus_collapsed: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_charge_curr_maximization {
    pub original_iset_ua: c_int,
    pub current_iset_ua: c_int,
    pub condition_cnt: c_int,
    pub max_current_ua: c_int,
    pub wait_cnt: c_int,
    pub level: u8,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_chargalg {
    pub dev: *mut device,
    pub charge_status: c_int,
    pub eoc_cnt: c_int,
    pub maintenance_chg: bool,
    pub t_hyst_norm: c_int,
    pub t_hyst_lowhigh: c_int,
    pub charge_state: enum ab8500_chargalg_states,
    pub ccm: ab8500_charge_curr_maximization,
    pub chg_info: ab8500_chargalg_charger_info,
    pub batt_data: ab8500_chargalg_battery_data,
    pub parent: *mut ab8500,
    pub bm: *mut ab8500_bm_data,
    pub chargalg_psy: *mut power_supply,
    pub ac_chg: *mut ux500_charger,
    pub usb_chg: *mut ux500_charger,
    pub events: ab8500_chargalg_events,
    pub chargalg_wq: *mut workqueue_struct,
    pub chargalg_periodic_work: delayed_work,
    pub chargalg_wd_work: delayed_work,
    pub chargalg_work: work_struct,
    pub safety_timer: hrtimer,
    pub maintenance_timer: hrtimer,
    pub chargalg_kobject: kobject,
}
...
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_check_charger_enable(di: *mut ab8500_chargalg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_check_charger_connection(di: *mut ab8500_chargalg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_stop_safety_timer(di: *mut ab8500_chargalg) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_stop_maintenance_timer(di: *mut ab8500_chargalg) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_kick_watchdog(di: *mut ab8500_chargalg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_stop_charging(di: *mut ab8500_chargalg) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_hold_charging(di: *mut ab8500_chargalg) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_check_temp(di: *mut ab8500_chargalg) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_check_charger_voltage(di: *mut ab8500_chargalg) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_end_of_charge(di: *mut ab8500_chargalg) {
...
#[no_mangle]
unsafe extern "C" fn init_maxim_chg_curr(di: *mut ab8500_chargalg) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_chg_curr_maxim(di: *mut ab8500_chargalg) -> enum maxim_ret {
...
#[no_mangle]
unsafe extern "C" fn handle_maxim_chg_curr(di: *mut ab8500_chargalg) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_get_ext_psy_data(ext: *mut power_supply, data: *mut c_void) -> c_int {
    ...
    int j;
    let mut capacity_updated: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_external_power_changed(psy: *mut power_supply) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_time_to_restart(di: *mut ab8500_chargalg) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_algorithm(di: *mut ab8500_chargalg) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: di->events.safety_timer_expired) -> else {
...
// Battery removed
#[no_mangle]
pub unsafe extern "C" fn if(_arg: di->events.batt_rem) -> else {
    if (di.charge_state != STATE_BATT_REMOVED)
    ab8500_chargalg_state_to(di, STATE_BATT_REMOVED_INIT);
    }
// Main or USB charger not ok.
#[no_mangle]
pub unsafe extern "C" fn if(di->events.usbchargernotok: di->events.mainextchnotok ||) -> else {
//
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: di->events.btemp_underover) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(di->events.btemp_high: di->events.btemp_low ||) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_periodic_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_wd_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_suspend(dev: *mut device) -> int __maybe_unused {
...
// Create a work queue for the chargalg
    ...
    WQ_MEM_RECLAIM);
    if (di.chargalg_wq == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_chargalg_remove(pdev: *mut platform_device) {
