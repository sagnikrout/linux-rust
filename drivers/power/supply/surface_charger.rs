...
//! Source: drivers/power/supply/surface_charger.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spwr_ac_device {
    pub sdev: *mut ssam_device,
    pub name: [c_char; 32],
    pub psy: *mut power_supply,
    pub psy_desc: power_supply_desc,
    pub notif: ssam_event_notifier,
    pub /: *mut *mut mutex lock; / Guards access to state below.,
    pub state: __le32,
}

// -- State management. -----------------------------------------------------
#[no_mangle]
unsafe extern "C" fn spwr_ac_update_unlocked(ac: *mut spwr_ac_device) -> c_int {
    static int spwr_ac_update_unlocked(struct spwr_ac_device *ac)
    {
    let mut old: __le32 = ac.state;
    int status;
...
#[no_mangle]
unsafe extern "C" fn spwr_ac_update(ac: *mut spwr_ac_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_ac_recheck(ac: *mut spwr_ac_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_notify_ac(nf: *mut ssam_event_notifier, event: *const ssam_event) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn spwr_ac_register(ac: *mut spwr_ac_device) -> c_int {
...
// -- Driver setup. ---------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn surface_ac_resume(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused surface_ac_resume(struct device *dev)
    {
    return spwr_ac_recheck(dev_get_drvdata(dev));
    }
    static SIMPLE_DEV_PM_OPS(surface_ac_pm_ops, core::ptr::null_mut(), surface_ac_resume);
#[no_mangle]
unsafe extern "C" fn surface_ac_probe(sdev: *mut ssam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn surface_ac_remove(sdev: *mut ssam_device) {
