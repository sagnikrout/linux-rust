...
//! Source: drivers/power/supply/bq24735-charger.c
#![no_std]
...
pub const BQ24735_CHARGE_OPT: c_uint = 0x12;
pub const BQ24735_CHARGE_CURRENT: c_uint = 0x14;
pub const BQ24735_CHARGE_CURRENT_MASK: c_uint = 0x1fc0;
pub const BQ24735_CHARGE_VOLTAGE: c_uint = 0x15;
pub const BQ24735_CHARGE_VOLTAGE_MASK: c_uint = 0x7ff0;
pub const BQ24735_INPUT_CURRENT: c_uint = 0x3f;
pub const BQ24735_INPUT_CURRENT_MASK: c_uint = 0x1f80;
pub const BQ24735_MANUFACTURER_ID: c_uint = 0xfe;
pub const BQ24735_DEVICE_ID: c_uint = 0xff;
...
pub struct bq24735 {
    ...
    pub pdata: *mut bq24735_platform,
    pub lock: mutex,
    pub status_gpio: *mut gpio_desc,
    pub poll: delayed_work,
...
#[no_mangle]
pub unsafe extern "C" fn bq24735_read_word(client: *mut i2c_client, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq24735_config_charger(charger: *mut bq24735) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bq24735_enable_charging(charger: *mut bq24735) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bq24735_disable_charging(charger: *mut bq24735) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq24735_charger_is_present(charger: *mut bq24735) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bq24735_charger_is_charging(charger: *mut bq24735) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq24735_update(charger: *mut bq24735) {
...
#[no_mangle]
unsafe extern "C" fn bq24735_charger_isr(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bq24735_poll(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bq24735_charger_probe(client: *mut i2c_client) -> c_int {
    ...
    core::ptr::null_mut(), bq24735_charger_isr,
    IRQF_TRIGGER_RISING |
