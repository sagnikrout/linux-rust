...
//! Source: drivers/power/supply/max14656_charger_detector.c
#![no_std]
...
pub const MAX14656_DEVICE_ID: c_uint = 0x00;
pub const MAX14656_INTERRUPT_1: c_uint = 0x01;
pub const MAX14656_INTERRUPT_2: c_uint = 0x02;
pub const MAX14656_STATUS_1: c_uint = 0x03;
pub const MAX14656_STATUS_2: c_uint = 0x04;
pub const MAX14656_INTMASK_1: c_uint = 0x05;
pub const MAX14656_INTMASK_2: c_uint = 0x06;
pub const MAX14656_CONTROL_1: c_uint = 0x07;
pub const MAX14656_CONTROL_2: c_uint = 0x08;
pub const MAX14656_CONTROL_3: c_uint = 0x09;
pub const DEVICE_VENDOR_MASK: c_uint = 0xf0;
pub const DEVICE_REV_MASK: c_uint = 0x0f;

pub const STATUS1_CHG_TYPE_MASK: c_uint = 0xf;

pub const CONTROL1_DEFAULT: c_uint = 0x0d;

pub const CONTROL2_DEFAULT: c_uint = 0x8e;

pub const CONTROL3_DEFAULT: c_uint = 0x8d;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max14656_chip {
    pub client: *mut i2c_client,
    pub detect_psy: *mut power_supply,
...
#[no_mangle]
unsafe extern "C" fn max14656_read_reg(client: *mut i2c_client, reg: c_int, val: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14656_write_reg(client: *mut i2c_client, reg: c_int, val: u8) -> c_int {
...
pub const REG_TOTAL_NUM: c_int = 5;
#[no_mangle]
unsafe extern "C" fn max14656_irq_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn max14656_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max14656_hw_init(chip: *mut max14656_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14656_probe(client: *mut i2c_client) -> c_int {
