...
//! Source: drivers/power/supply/power_supply_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn __power_supply_changed_work(pst: *mut power_supply, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_supply_changed_work(work: *mut work_struct) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psy_for_each_psy_cb_data {
    pub data): *mut *mut *mut int (fn)(struct power_supply psy, void,
    pub data: *mut c_void,
}

#[no_mangle]
unsafe extern "C" fn psy_for_each_psy_cb(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_for_each_psy(data: *mut c_void, psy: *mut *mut int (fn)(struct power_supply, data): *mut c_void) -> c_int {
    ...
    return class_for_each_device(&power_supply_class, core::ptr::null_mut(), &cb_data, psy_for_each_psy_cb);
    }
    EXPORT_SYMBOL_GPL(power_supply_for_each_psy);
#[no_mangle]
pub unsafe extern "C" fn power_supply_changed(psy: *mut power_supply) {
...
//
#[no_mangle]
unsafe extern "C" fn power_supply_deferred_register_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn power_supply_populate_supplied_from(psy: *mut power_supply) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_supply_find_supply_from_fwnode(supply_node: *mut fwnode_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_supply_check_supplies(psy: *mut power_supply) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psy_am_i_supplied_data {
    pub psy: *mut power_supply,
    pub count: c_uint,
}

#[no_mangle]
unsafe extern "C" fn __power_supply_am_i_supplied(epsy: *mut power_supply, _data: *mut c_void) -> c_int {
    static int __power_supply_am_i_supplied(struct power_supply *epsy, void *_data)
    {
    let mut ret: union power_supply_propval = {0,};
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_am_i_supplied(psy: *mut power_supply) -> c_int {
    int power_supply_am_i_supplied(struct power_supply *psy)
    {
    let mut data: psy_am_i_supplied_data = { psy, 0 };
    int error;
...
#[no_mangle]
unsafe extern "C" fn __power_supply_is_system_supplied(psy: *mut power_supply, data: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psy_get_supplier_prop_data {
    pub psy: *mut power_supply,
    pub psp: enum power_supply_property,
    pub val: *mut union power_supply_propval,
}

#[no_mangle]
unsafe extern "C" fn __power_supply_get_supplier_property(epsy: *mut power_supply, _data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_supply_match_device_by_name(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    {
    struct power_supply *psy = core::ptr::null_mut();
    struct device *dev = class_find_device(&power_supply_class, core::ptr::null_mut(), name,
...
#[no_mangle]
unsafe extern "C" fn power_supply_is_system_battery(psy: *mut power_supply) -> bool {
...
#[no_mangle]
unsafe extern "C" fn power_supply_get_num_system_batteries(dev: *mut device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psy_get_supplies_data {
    pub cnt: c_int,
    pub size: c_int,
    pub psys: *mut power_supply,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn power_supply_put_system_batteries(psys: *mut power_supply, count: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn power_supply_put(psy: *mut power_supply) {
...
#[no_mangle]
unsafe extern "C" fn power_supply_match_device_fwnode(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    dev = class_find_device(&power_supply_class, core::ptr::null_mut(), power_supply_fwnode,
...
#[no_mangle]
unsafe extern "C" fn devm_power_supply_put(dev: *mut device, res: *mut c_void) {
...
// ptr = psy;
    ...
    u32 *propdata __free(kfree) = core::ptr::null_mut();
    u32 min_max[2];
...
#[no_mangle]
pub unsafe extern "C" fn if(-ENODEV: err ==) -> else {
    else if (err == -ENODEV)
//
...
//
    ...
    info.maintenance_charge             = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("nickel-metal-hydride", _arg: value)) -> else {
    else if (!strcmp("nickel-metal-hydride", value))
    info.technology = POWER_SUPPLY_TECHNOLOGY_NiMH;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("lithium-ion", _arg: value)) -> else {
    else if (!strcmp("lithium-ion", value))
// Imprecise lithium-ion type
    info.technology = POWER_SUPPLY_TECHNOLOGY_LION;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("lithium-ion-polymer", _arg: value)) -> else {
    else if (!strcmp("lithium-ion-polymer", value))
    info.technology = POWER_SUPPLY_TECHNOLOGY_LIPO;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("lithium-ion-iron-phosphate", _arg: value)) -> else {
    else if (!strcmp("lithium-ion-iron-phosphate", value))
    info.technology = POWER_SUPPLY_TECHNOLOGY_LiFe;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("lithium-ion-manganese-oxide", _arg: value)) -> else {
...
// info_out = info;
    ...
    let mut power_supply_battery_info_properties_size: usize = ARRAY_SIZE(power_supply_battery_info_properties);
...
// The library function will deal with high == low
    ...
    high = low = i;
#[no_mangle]
pub unsafe extern "C" fn if(table_len: i ==) -> else {
    else if (i == table_len)
    high = low = i - 1;
    else
    high = (low = i) - 1;
...
pub unsafe extern "C" fn if(table_len: i ==) -> else {
    ...
    {
    let mut best_temp_diff: c_int = INT_MAX, temp_diff;
    u8 i, best_index = 0;
    if (!info.ocv_table[0])
    return core::ptr::null_mut();
    for (i = 0; i < POWER_SUPPLY_OCV_TEMP_MAX; i++) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: power_supply_battery_info_has_prop(psy->battery_info, _arg: psp)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_external_power_changed(psy: *mut power_supply) {
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_powers(psy: *mut power_supply, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn power_supply_update_sysfs_and_hwmon(psy: *mut power_supply) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_unregister_extension(psy: *mut power_supply, ext: *const power_supply_ext) {
...
#[no_mangle]
unsafe extern "C" fn power_supply_dev_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_reg_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn power_supply_unreg_notifier(nb: *mut notifier_block) {
...
#[no_mangle]
unsafe extern "C" fn psy_register_thermal(psy: *mut power_supply) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn psy_unregister_thermal(psy: *mut power_supply) {
...
#[no_mangle]
unsafe extern "C" fn devm_power_supply_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn power_supply_unregister(psy: *mut power_supply) {
...
#[no_mangle]
unsafe extern "C" fn power_supply_class_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn power_supply_class_exit() -> void __exit {
