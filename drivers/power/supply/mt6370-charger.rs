...
//! Source: drivers/power/supply/mt6370-charger.c
#![no_std]
...
pub const MT6370_REG_CHG_CTRL1: c_uint = 0x111;
pub const MT6370_REG_CHG_CTRL2: c_uint = 0x112;
pub const MT6370_REG_CHG_CTRL3: c_uint = 0x113;
pub const MT6370_REG_CHG_CTRL4: c_uint = 0x114;
pub const MT6370_REG_CHG_CTRL5: c_uint = 0x115;
pub const MT6370_REG_CHG_CTRL6: c_uint = 0x116;
pub const MT6370_REG_CHG_CTRL7: c_uint = 0x117;
pub const MT6370_REG_CHG_CTRL8: c_uint = 0x118;
pub const MT6370_REG_CHG_CTRL9: c_uint = 0x119;
pub const MT6370_REG_CHG_CTRL10: c_uint = 0x11A;
pub const MT6370_REG_DEVICE_TYPE: c_uint = 0x122;
pub const MT6370_REG_USB_STATUS1: c_uint = 0x127;
pub const MT6370_REG_CHG_STAT: c_uint = 0x14A;
pub const MT6370_REG_FLED_EN: c_uint = 0x17E;

pub const MT6370_REG_OVPCTRL_STAT: c_uint = 0x1D8;

pub const MT6370_MIVR_IBUS_TH_100_mA: c_int = 100000;
pub const MT6370_ADC_CHAN_IBUS: c_int = 5;
pub const MT6370_ADC_CHAN_MAX: c_int = 9;
...
pub struct mt6370_priv {
    pub dev: *mut device,
    pub iio_adcs: *mut iio_channel,
    pub attach_lock: mutex,
    pub psy: *mut power_supply,
    pub regmap: *mut regmap,
    pub rmap_fields: [*mut regmap_field; F_MAX],
    pub rdev: *mut regulator_dev,
    pub wq: *mut workqueue_struct,
    pub bc12_work: work_struct,
    pub mivr_dwork: delayed_work,
    pub irq_nums: [c_uint; MT6370_IRQ_MAX],
    pub attach: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6370_chg_field {
    pub name: *const c_char,
    pub range: *const linear_range,
    pub field: reg_field,
}
...
// val = reg_val;
    ...
    rcfg.ena_gpiod = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_bc12_work_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_toggle_cfo(priv: *mut mt6370_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_mivr_dwork_func(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_pwr_rdy_check(priv: *mut mt6370_priv) {
...
// Check in OTG mode or not
    ...
    {
    let mut pwr_rdy: bool = !!val.intval;
    mutex_lock(&priv.attach_lock);
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_init_rmap_fields(priv: *mut mt6370_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_init_setting(priv: *mut mt6370_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_init_otg_regulator(priv: *mut mt6370_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_init_psy(priv: *mut mt6370_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_attach_i_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt6370_uvp_d_evt_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt6370_mivr_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_init_irq(priv: *mut mt6370_priv) -> c_int {
    ...
    return ret;
    priv.irq_nums[i] = ret;
    ret = devm_request_threaded_irq(priv.dev, ret, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn mt6370_chg_probe(pdev: *mut platform_device) -> c_int {
