...
//! Source: drivers/power/supply/wm97xx_battery.c
#![no_std]
...
//
    ...
    let mut bat_status: static int = POWER_SUPPLY_STATUS_UNKNOWN;
    static enum power_supply_property *prop;
#[no_mangle]
unsafe extern "C" fn wm97xx_read_bat(bat_ps: *mut power_supply) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_read_temp(bat_ps: *mut power_supply) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_bat_external_power_changed(bat_ps: *mut power_supply) {
    static void wm97xx_bat_external_power_changed(struct power_supply *bat_ps)
    {
    schedule_work(&bat_work);
    }
#[no_mangle]
unsafe extern "C" fn wm97xx_bat_update(bat_ps: *mut power_supply) {
    static void wm97xx_bat_update(struct power_supply *bat_ps)
    {
    let mut old_status: c_int = bat_status;
...
#[no_mangle]
unsafe extern "C" fn wm97xx_bat_work(work: *mut work_struct) {
    static void wm97xx_bat_work(struct work_struct *work)
    {
    wm97xx_bat_update(bat_psy);
    }
#[no_mangle]
unsafe extern "C" fn wm97xx_chrg_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_bat_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_bat_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm97xx_bat_probe(dev: *mut platform_device) -> c_int {
    ...
    if (dev.id != -1)
    return -EINVAL;
    charge_gpiod = devm_gpiod_get_optional(&dev.dev, core::ptr::null_mut(), GPIOD_IN);
...
#[no_mangle]
unsafe extern "C" fn wm97xx_bat_remove(dev: *mut platform_device) {
