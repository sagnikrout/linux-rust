...
//! Source: drivers/power/supply/ab8500_charger.c
#![no_std]
...
// Charger constants
pub const NO_PW_CONN: c_int = 0;
pub const AC_PW_CONN: c_int = 1;
pub const USB_PW_CONN: c_int = 2;
pub const MAIN_WDOG_ENA: c_uint = 0x01;
pub const MAIN_WDOG_KICK: c_uint = 0x02;
pub const MAIN_WDOG_DIS: c_uint = 0x00;
pub const CHARG_WD_KICK: c_uint = 0x01;
pub const MAIN_CH_ENA: c_uint = 0x01;
pub const MAIN_CH_NO_OVERSHOOT_ENA_N: c_uint = 0x02;
pub const USB_CH_ENA: c_uint = 0x01;
pub const USB_CHG_NO_OVERSHOOT_ENA_N: c_uint = 0x02;
pub const MAIN_CH_DET: c_uint = 0x01;
pub const MAIN_CH_CV_ON: c_uint = 0x04;
pub const USB_CH_CV_ON: c_uint = 0x08;
pub const VBUS_DET_DBNC100: c_uint = 0x02;
pub const VBUS_DET_DBNC1: c_uint = 0x01;
pub const OTP_ENABLE_WD: c_uint = 0x01;
pub const DROP_COUNT_RESET: c_uint = 0x01;
pub const USB_CH_DET: c_uint = 0x01;
pub const MAIN_CH_INPUT_CURR_SHIFT: c_int = 4;
pub const VBUS_IN_CURR_LIM_SHIFT: c_int = 4;
pub const AUTO_VBUS_IN_CURR_LIM_SHIFT: c_int = 4;

pub const LED_INDICATOR_PWM_ENA: c_uint = 0x01;
pub const LED_INDICATOR_PWM_DIS: c_uint = 0x00;
pub const LED_IND_CUR_5MA: c_uint = 0x04;
pub const LED_INDICATOR_PWM_DUTY_252_256: c_uint = 0xBF;
// HW failure constants
pub const MAIN_CH_TH_PROT: c_uint = 0x02;
pub const VBUS_CH_NOK: c_uint = 0x08;
pub const USB_CH_TH_PROT: c_uint = 0x02;
pub const VBUS_OVV_TH: c_uint = 0x01;
pub const MAIN_CH_NOK: c_uint = 0x01;
pub const VBUS_DET: c_uint = 0x80;
pub const MAIN_CH_STATUS2_MAINCHGDROP: c_uint = 0x80;
pub const MAIN_CH_STATUS2_MAINCHARGERDETDBNC: c_uint = 0x40;
pub const USB_CH_VBUSDROP: c_uint = 0x40;
pub const USB_CH_VBUSDETDBNC: c_uint = 0x01;
// UsbLineStatus register bit masks
pub const AB8500_USB_LINK_STATUS: c_uint = 0x78;
pub const AB8505_USB_LINK_STATUS: c_uint = 0xF8;
pub const AB8500_STD_HOST_SUSP: c_uint = 0x18;
pub const USB_LINK_STATUS_SHIFT: c_int = 3;
// Watchdog timeout constant
pub const WD_TIMER: c_uint = 0x30 /* 4min */;

// Lowest charger voltage is 3.39V -> 0x4E
pub const LOW_VOLT_REG: c_uint = 0x4E;
// Step up/down delay in us
pub const STEP_UDELAY: c_int = 1000;

pub const AB8500_SW_CONTROL_FALLBACK: c_uint = 0x03;
// Wait for enumeration before charing in us

// External charger control
pub const AB8500_SYS_CHARGER_CONTROL_REG: c_uint = 0x52;
pub const EXTERNAL_CHARGER_DISABLE_REG_VAL: c_uint = 0x03;
pub const EXTERNAL_CHARGER_ENABLE_REG_VAL: c_uint = 0x07;
...
pub const USB_CH_IP_CUR_LVL_0P05: c_int = 50000;
pub const USB_CH_IP_CUR_LVL_0P09: c_int = 98000;
pub const USB_CH_IP_CUR_LVL_0P19: c_int = 193000;
pub const USB_CH_IP_CUR_LVL_0P29: c_int = 290000;
pub const USB_CH_IP_CUR_LVL_0P38: c_int = 380000;
pub const USB_CH_IP_CUR_LVL_0P45: c_int = 450000;
pub const USB_CH_IP_CUR_LVL_0P5: c_int = 500000;
pub const USB_CH_IP_CUR_LVL_0P6: c_int = 600000;
pub const USB_CH_IP_CUR_LVL_0P7: c_int = 700000;
pub const USB_CH_IP_CUR_LVL_0P8: c_int = 800000;
pub const USB_CH_IP_CUR_LVL_0P9: c_int = 900000;
pub const USB_CH_IP_CUR_LVL_1P0: c_int = 1000000;
pub const USB_CH_IP_CUR_LVL_1P1: c_int = 1100000;
pub const USB_CH_IP_CUR_LVL_1P3: c_int = 1300000;
pub const USB_CH_IP_CUR_LVL_1P4: c_int = 1400000;
pub const USB_CH_IP_CUR_LVL_1P5: c_int = 1500000;
pub const VBAT_TRESH_IP_CUR_RED: c_int = 3800000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_charger_interrupts {
    pub name: *mut c_char,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_charger_info {
    pub charger_connected: c_int,
    pub charger_online: c_int,
    pub charger_voltage_uv: c_int,
    pub cv_active: c_int,
    pub wd_expired: bool,
    pub charger_current_ua: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_charger_event_flags {
    pub mainextchnotok: bool,
    pub main_thermal_prot: bool,
    pub usb_thermal_prot: bool,
    pub vbus_ovv: bool,
    pub usbchargernotok: bool,
    pub chgwdexp: bool,
    pub vbus_collapse: bool,
    pub vbus_drop_end: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_charger_usb_state {
    pub usb_current_ua: c_int,
    pub usb_current_tmp_ua: c_int,
    pub state: enum ab8500_usb_state,
    pub state_tmp: enum ab8500_usb_state,
    pub usb_lock: spinlock_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_charger_max_usb_in_curr {
    pub usb_type_max_ua: c_int,
    pub set_max_ua: c_int,
    pub calculated_max_ua: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_charger {
    pub dev: *mut device,
    pub vbus_detected: bool,
    pub vbus_detected_start: bool,
    pub ac_conn: bool,
    pub vddadc_en_ac: bool,
    pub vddadc_en_usb: bool,
    pub vbat: c_int,
    pub old_vbat: c_int,
    pub usb_device_is_unrecognised: bool,
    pub autopower: bool,
    pub autopower_cfg: bool,
    pub invalid_charger_detect_state: c_int,
    pub is_aca_rid: c_int,
    pub current_stepping_sessions: core::sync::atomic::AtomicI32,
    pub parent: *mut ab8500,
    pub adc_main_charger_v: *mut iio_channel,
    pub adc_main_charger_c: *mut iio_channel,
    pub adc_vbus_v: *mut iio_channel,
    pub adc_usb_charger_c: *mut iio_channel,
    pub bm: *mut ab8500_bm_data,
    pub flags: ab8500_charger_event_flags,
    pub usb_state: ab8500_charger_usb_state,
    pub max_usb_in_curr: ab8500_charger_max_usb_in_curr,
    pub ac_chg: ux500_charger,
    pub usb_chg: ux500_charger,
    pub ac: ab8500_charger_info,
    pub usb: ab8500_charger_info,
    pub regu: *mut regulator,
    pub charger_wq: *mut workqueue_struct,
    pub usb_ipt_crnt_lock: mutex,
    pub check_vbat_work: delayed_work,
    pub check_hw_failure_work: delayed_work,
    pub check_usbchgnotok_work: delayed_work,
    pub kick_wd_work: delayed_work,
    pub usb_state_changed_work: delayed_work,
    pub attach_work: delayed_work,
    pub ac_charger_attached_work: delayed_work,
    pub usb_charger_attached_work: delayed_work,
    pub vbus_drop_end_work: delayed_work,
    pub ac_work: work_struct,
    pub detect_usb_type_work: work_struct,
    pub usb_link_status_work: work_struct,
    pub check_main_thermal_prot_work: work_struct,
    pub check_usb_thermal_prot_work: work_struct,
    pub usb_phy: *mut usb_phy,
    pub nb: notifier_block,
    pub charger_attached_mutex: mutex,
}
...
//
    if (di.usb_chg.psy) {
    sysfs_notify(&di.usb_chg.psy.dev.kobj, core::ptr::null_mut(),
    "present");
    }
    if (connected) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_get_ac_voltage(di: *mut ab8500_charger) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_ac_cv(di: *mut ab8500_charger) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_get_vbus_voltage(di: *mut ab8500_charger) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_get_usb_current(di: *mut ab8500_charger) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_get_ac_current(di: *mut ab8500_charger) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usb_cv(di: *mut ab8500_charger) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_detect_chargers(di: *mut ab8500_charger, probe: bool) -> c_int {
    static int ab8500_charger_detect_chargers(struct ab8500_charger *di, bool probe)
    {
    let mut result: c_int = NO_PW_CONN;
    int ret;
    u8 val;
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_read_usb_type(di: *mut ab8500_charger) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_detect_usb_type(di: *mut ab8500_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_voltage_to_regval(voltage_uv: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_current_to_regval(di: *mut ab8500_charger, curr_ua: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_vbus_in_curr_to_regval(di: *mut ab8500_charger, curr_ua: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_get_usb_cur(di: *mut ab8500_charger) -> c_int {
...
//
    ...
    u8 reg_value;
    u32 step_udelay;
    let mut no_stepping: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_led_en(di: *mut ab8500_charger, on: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_watchdog_kick(charger: *mut ux500_charger) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(POWER_SUPPLY_TYPE_USB: charger->psy->desc->type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_get_ext_psy_data(ext: *mut power_supply, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_check_vbat_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_check_hw_failure_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_kick_watchdog_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_ac_work(work: *mut work_struct) {
...
//
    ...
    ab8500_power_supply_changed(di, di.ac_chg.psy);
    sysfs_notify(&di.ac_chg.psy.dev.kobj, core::ptr::null_mut(), "present");
    }
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usb_attached_work(work: *mut work_struct) {
    static void ab8500_charger_usb_attached_work(struct work_struct *work)
    {
    struct ab8500_charger *di = container_of(work,
    struct ab8500_charger,
    usb_charger_attached_work.work);
    let mut usbch: c_int = (USB_CH_VBUSDROP | USB_CH_VBUSDETDBNC);
    int ret, i;
    u8 statval;
    for (i = 0; i < 10; i++) {
    ret = abx500_get_register_interruptible(di.dev,
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_ac_attached_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_detect_usb_type_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usb_link_attach_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usb_link_status_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usb_state_changed_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_check_usbchargernotok_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_mainchunplugdet_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_mainchplugdet_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_mainextchnotok_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_mainchthprotr_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_mainchthprotf_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_vbus_drop_end_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_vbusdetf_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_vbusdetr_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usblinkstatus_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usbchthprotr_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usbchthprotf_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_usbchargernotokr_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_chwdexp_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_vbuschdropend_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_vbusovv_handler(irq: c_int, _di: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(di->usb.wd_expired: di->ac.wd_expired ||) -> else {
    else if (di.ac.wd_expired || di.usb.wd_expired)
    val.intval = POWER_SUPPLY_HEALTH_DEAD;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: di->flags.main_thermal_prot) -> else {
...
pub unsafe extern "C" fn if(di->usb.wd_expired: di->ac.wd_expired ||) -> else {
    ...
    val.intval = POWER_SUPPLY_HEALTH_DEAD;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: di->flags.usb_thermal_prot) -> else {
    else if (di.flags.usb_thermal_prot)
    val.intval = POWER_SUPPLY_HEALTH_OVERHEAT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: di->flags.vbus_ovv) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ab8500_charger_init_hw_registers(di: *mut ab8500_charger) -> c_int {
...
//
    let mut mA: unsigned = *((unsigned *)power);
...
#[no_mangle]
pub unsafe extern "C" fn if(0: mA ==) -> else {
    else if (mA == 0)
    bm_usb_state = AB8500_BM_USB_STATE_RESET_HS;
#[no_mangle]
pub unsafe extern "C" fn if(2: mA ==) -> else {
    else if (mA == 2)
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_bind(dev: *mut device) -> c_int {
...
// Create a work queue for the charger
    ...
    WQ_MEM_RECLAIM);
    if (di.charger_wq == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_probe(pdev: *mut platform_device) -> c_int {
    static int ab8500_charger_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct device_node *np = dev.of_node;
    struct component_match *match = core::ptr::null_mut();
    let mut ac_psy_cfg: power_supply_config = {}, usb_psy_cfg = {};
    struct ab8500_charger *di;
    int charger_status;
    int i, irq;
    int ret;
...
// Request interrupts
    ...
    irq, core::ptr::null_mut(), ab8500_charger_irq[i].isr,
...
// Create something that will match the subdrivers when we bind
    ...
    struct device *p = core::ptr::null_mut(), *d;
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ab8500_charger_exit() -> void __exit {
