...
//! Source: drivers/power/supply/lego_ev3_battery.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lego_ev3_battery {
    pub iio_v: *mut iio_channel,
    pub iio_i: *mut iio_channel,
    pub rechargeable_gpio: *mut gpio_desc,
...
#[no_mangle]
unsafe extern "C" fn lego_ev3_battery_probe(pdev: *mut platform_device) -> c_int {
