...
//! Source: drivers/power/supply/wm8350_power.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wm8350_read_battery_uvolts(wm8350: *mut wm8350) -> c_int {
    static int wm8350_read_battery_uvolts(struct wm8350 *wm8350)
    {
#[no_mangle]
pub unsafe extern "C" fn wm8350_read_auxadc(_arg: wm8350, _arg: WM8350_AUXADC_BATT, _arg: 0, _arg: 0) -> return {
    return wm8350_read_auxadc(wm8350, WM8350_AUXADC_BATT, 0, 0)
// WM8350_AUX_COEFF;
    }
#[no_mangle]
unsafe extern "C" fn wm8350_read_line_uvolts(wm8350: *mut wm8350) -> c_int {
    static int wm8350_read_line_uvolts(struct wm8350 *wm8350)
    {
#[no_mangle]
pub unsafe extern "C" fn wm8350_read_auxadc(_arg: wm8350, _arg: WM8350_AUXADC_LINE, _arg: 0, _arg: 0) -> return {
    return wm8350_read_auxadc(wm8350, WM8350_AUXADC_LINE, 0, 0)
// WM8350_AUX_COEFF;
    }
#[no_mangle]
unsafe extern "C" fn wm8350_read_usb_uvolts(wm8350: *mut wm8350) -> c_int {
    static int wm8350_read_usb_uvolts(struct wm8350 *wm8350)
    {
#[no_mangle]
pub unsafe extern "C" fn wm8350_read_auxadc(_arg: wm8350, _arg: WM8350_AUXADC_USB, _arg: 0, _arg: 0) -> return {
    return wm8350_read_auxadc(wm8350, WM8350_AUXADC_USB, 0, 0)
// WM8350_AUX_COEFF;
    }
pub const WM8350_BATT_SUPPLY: c_int = 1;
pub const WM8350_USB_SUPPLY: c_int = 2;
pub const WM8350_LINE_SUPPLY: c_int = 4;
#[no_mangle]
pub unsafe extern "C" fn wm8350_charge_time_min(wm8350: *mut wm8350, min: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_get_supplies(wm8350: *mut wm8350) -> c_int {
    static int wm8350_get_supplies(struct wm8350 *wm8350)
    {
    u16 sm, ov, co, chrg;
    let mut supplies: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(WM8350_WALL_FB_OVRDE: co &) -> else {
...
#[no_mangle]
unsafe extern "C" fn wm8350_batt_status(wm8350: *mut wm8350) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_charger_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn wm8350_bat_check_health(wm8350: *mut wm8350) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_bat_get_charge_type(wm8350: *mut wm8350) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm8350_init_charger(wm8350: *mut wm8350) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_charger_irq(wm8350: *mut wm8350) {
...
#[no_mangle]
unsafe extern "C" fn wm8350_power_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct wm8350_charger_policy *policy = power.policy;
    int ret;
    power.ac = devm_power_supply_register(&pdev.dev, &wm8350_ac_desc, core::ptr::null_mut());
    if (IS_ERR(power.ac))
    return PTR_ERR(power.ac);
    power.battery = devm_power_supply_register(&pdev.dev, &wm8350_battery_desc, core::ptr::null_mut());
    if (IS_ERR(power.battery))
    return PTR_ERR(power.battery);
    power.usb = devm_power_supply_register(&pdev.dev, &wm8350_usb_desc, core::ptr::null_mut());
    if (IS_ERR(power.usb))
...
#[no_mangle]
unsafe extern "C" fn wm8350_power_remove(pdev: *mut platform_device) {
