...
//! Source: drivers/power/supply/bq24257_charger.c
#![no_std]
...
pub const BQ24257_REG_1: c_uint = 0x00;
pub const BQ24257_REG_2: c_uint = 0x01;
pub const BQ24257_REG_3: c_uint = 0x02;
pub const BQ24257_REG_4: c_uint = 0x03;
pub const BQ24257_REG_5: c_uint = 0x04;
pub const BQ24257_REG_6: c_uint = 0x05;
pub const BQ24257_REG_7: c_uint = 0x06;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bq2425x_chip_info {
    pub name: *const *const c_char,
    pub chip: enum bq2425x_chip,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bq24257_init_data {
    pub /: *mut *mut u8 ichg; / charge current,
    pub /: *mut *mut u8 vbat; / regulation voltage,
    pub /: *mut *mut u8 iterm; / termination current,
    pub /: *mut *mut u8 iilimit; / input current limit,
    pub /: *mut *mut u8 vovp; / over voltage protection voltage,
    pub /: *mut *mut u8 vindpm; / VDMP input threshold voltage,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bq24257_state {
    pub status: u8,
    pub fault: u8,
    pub power_good: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bq24257_device {
    pub client: *mut i2c_client,
    pub dev: *mut device,
    pub charger: *mut power_supply,
    pub info: *const bq2425x_chip_info,
    pub rmap: *mut regmap,
    pub rmap_fields: [*mut regmap_field; F_MAX_FIELDS],
    pub pg: *mut gpio_desc,
    pub iilimit_setup_work: delayed_work,
    pub init_data: bq24257_init_data,
    pub state: bq24257_state,
    pub /: *mut *mut mutex lock; / protect state data,
    pub iilimit_autoset_enable: bool,
}

#[no_mangle]
unsafe extern "C" fn bq24257_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bq24257_find_idx(value: u32, map: *const u32, map_size: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_READY: state.status ==) -> else {
    else if (state.status == STATUS_READY)
    val.intval = POWER_SUPPLY_STATUS_NOT_CHARGING;
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_CHARGE_IN_PROGRESS: state.status ==) -> else {
    else if (state.status == STATUS_CHARGE_IN_PROGRESS)
    val.intval = POWER_SUPPLY_STATUS_CHARGING;
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_CHARGE_DONE: state.status ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn bq24257_iilimit_autoset(bq: *mut bq24257_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq24257_iilimit_setup_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn bq24257_irq_handler_thread(irq: c_int, private: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bq24257_hw_init(bq: *mut bq24257_device) -> c_int {
...
// activate D+/D- detection algorithm
    ret = bq24257_field_write(bq, F_DPDM_EN, 1);
#[no_mangle]
pub unsafe extern "C" fn if(FAULT_NO_BAT: state.fault !=) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "sysoff_enable") ==) -> else {
...
pub unsafe extern "C" fn if(_arg: strcmp(attr->attr.name, 0: "sysoff_enable") ==) -> else {
    ...
    static DEVICE_ATTR(ovp_voltage, S_IRUGO, bq24257_show_ovp_voltage, core::ptr::null_mut());
    static DEVICE_ATTR(in_dpm_voltage, S_IRUGO, bq24257_show_in_dpm_voltage, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn bq24257_power_supply_init(bq: *mut bq24257_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq24257_pg_gpio_probe(bq: *mut bq24257_device) {
...
#[no_mangle]
unsafe extern "C" fn bq24257_fw_probe(bq: *mut bq24257_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq24257_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !bq->pg) -> else {
    else if (!bq.pg)
...
#[no_mangle]
unsafe extern "C" fn bq24257_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn bq24257_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bq24257_resume(dev: *mut device) -> c_int {
