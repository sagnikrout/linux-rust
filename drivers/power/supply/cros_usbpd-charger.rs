...
//! Source: drivers/power/supply/cros_usbpd-charger.c
#![no_std]
...
pub const CHARGER_MANUFACTURER_MODEL_LENGTH: c_int = 32;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct port_data {
    pub port_number: c_int,
    pub name: [c_char; CHARGER_DIR_NAME_LENGTH],
    pub manufacturer: [c_char; CHARGER_MANUFACTURER_MODEL_LENGTH],
    pub model_name: [c_char; CHARGER_MANUFACTURER_MODEL_LENGTH],
    pub psy: *mut power_supply,
    pub psy_desc: power_supply_desc,
    pub psy_usb_type: c_int,
    pub psy_online: c_int,
    pub psy_status: c_int,
    pub psy_current_max: c_int,
    pub psy_voltage_max_design: c_int,
    pub psy_voltage_now: c_int,
    pub psy_power_max: c_int,
...
pub struct charger_data {
    ...
    pub num_charger_ports: c_int,
    pub num_usbpd_ports: c_int,
    pub num_registered_psy: c_int,
    pub ports: [*mut port_data; EC_USB_PD_MAX_PORTS],
...
// Input voltage/current limit in mV/mA. Default to none.
    let mut input_voltage_limit: static u16 = EC_POWER_LIMIT_NONE;
    let mut input_current_limit: static u16 = EC_POWER_LIMIT_NONE;
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_port_is_dedicated(port: *mut port_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_get_num_ports(charger: *mut charger_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_get_usbpd_num_ports(charger: *mut charger_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_get_discovery_info(port: *mut port_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_get_power_info(port: *mut port_data) -> c_int {
...
//
    ...
    &req, sizeof(req), core::ptr::null_mut(), 0);
    if (ret < 0)
    dev_err(charger.dev,
...
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_power_changed(psy: *mut power_supply) {
...
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_unregister_notifier(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_probe(pd: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_usbpd_charger_resume(dev: *mut device) -> c_int {
    ...
    static SIMPLE_DEV_PM_OPS(cros_usbpd_charger_pm_ops, core::ptr::null_mut(),
