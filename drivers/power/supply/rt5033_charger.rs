...
//! Source: drivers/power/supply/rt5033_charger.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt5033_charger_data {
    pub pre_uamp: c_uint,
    pub pre_uvolt: c_uint,
    pub const_uvolt: c_uint,
    pub eoc_uamp: c_uint,
    pub fast_uamp: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt5033_charger {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub psy: *mut power_supply,
    pub chg: rt5033_charger_data,
    ...
    pub online: bool,
    pub otg: bool,
    pub mivr_enabled: bool,
    pub cv_regval: u8,
}

#[no_mangle]
unsafe extern "C" fn rt5033_get_charger_state(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_get_charger_type(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_get_charger_current_limit(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_get_charger_const_voltage(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rt5033_init_const_charge(charger: *mut rt5033_charger) -> c_int {
...
// Set constant voltage mode
    ...
    reg_data = 0x00;
#[no_mangle]
pub unsafe extern "C" fn if(RT5033_CHARGER_CONST_VOLTAGE_LIMIT_MAX: chg->const_uvolt ==) -> else {
...
// Set end of charge current
    ...
    reg_data = 0x01;
#[no_mangle]
pub unsafe extern "C" fn if(RT5033_CHARGER_EOC_MAX: chg->eoc_uamp ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn rt5033_init_fast_charge(charger: *mut rt5033_charger) -> c_int {
...
// Set fast-charge mode charging current
    ...
    reg_data = 0x00;
#[no_mangle]
pub unsafe extern "C" fn if(RT5033_CHARGER_FAST_CURRENT_MAX: chg->fast_uamp ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn rt5033_init_pre_charge(charger: *mut rt5033_charger) -> c_int {
...
// Set pre-charge threshold voltage
    ...
    reg_data = 0x00;
#[no_mangle]
pub unsafe extern "C" fn if(RT5033_CHARGER_PRE_THRESHOLD_LIMIT_MAX: chg->pre_uvolt ==) -> else {
...
// Set pre-charge mode charging current
    ...
    reg_data = 0x00;
#[no_mangle]
pub unsafe extern "C" fn if(RT5033_CHARGER_PRE_CURRENT_LIMIT_MAX: chg->pre_uamp ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_reg_init(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_set_otg(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_unset_otg(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_set_charging(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_set_mivr(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_set_disconnect(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_dt_init(charger: *mut rt5033_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_extcon_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rt5033_charger_probe(pdev: *mut platform_device) -> c_int {
