...
//! Source: drivers/power/supply/max77976_charger.c
#![no_std]
...
pub const MAX77976_CHIP_ID: c_uint = 0x76;
    static const char *max77976_manufacturer	= "Maxim Integrated";
    static const char *max77976_model		= "MAX77976";
// --------------------------------------------------------------------------
// Register map
//
pub const MAX77976_REG_CHIP_ID: c_uint = 0x00;
pub const MAX77976_REG_CHIP_REVISION: c_uint = 0x01;
pub const MAX77976_REG_CHG_INT_OK: c_uint = 0x12;
pub const MAX77976_REG_CHG_DETAILS_01: c_uint = 0x14;
pub const MAX77976_REG_CHG_CNFG_00: c_uint = 0x16;
pub const MAX77976_REG_CHG_CNFG_02: c_uint = 0x18;
pub const MAX77976_REG_CHG_CNFG_06: c_uint = 0x1c;
pub const MAX77976_REG_CHG_CNFG_09: c_uint = 0x1f;
...
pub struct max77976 {
    ...
    pub rfield: [*mut regmap_field; MAX77976_N_REGMAP_FIELDS],
}
...
//
#[no_mangle]
unsafe extern "C" fn max77976_get_status(chg: *mut max77976, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77976_get_charge_type(chg: *mut max77976, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77976_get_health(chg: *mut max77976, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77976_get_online(chg: *mut max77976, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max77976_detect(chg: *mut max77976) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77976_configure(chg: *mut max77976) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77976_probe(client: *mut i2c_client) -> c_int {
