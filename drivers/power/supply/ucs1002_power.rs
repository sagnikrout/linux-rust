...
//! Source: drivers/power/supply/ucs1002_power.c
#![no_std]
...
// UCS1002 Registers
pub const UCS1002_REG_CURRENT_MEASUREMENT: c_uint = 0x00;
//
...
//
pub const UCS1002_REG_TOTAL_ACC_CHARGE: c_uint = 0x01;
// Other Status Register
pub const UCS1002_REG_OTHER_STATUS: c_uint = 0x0f;

// Interrupt Status
pub const UCS1002_REG_INTERRUPT_STATUS: c_uint = 0x10;

// Pin Status Register
pub const UCS1002_REG_PIN_STATUS: c_uint = 0x14;

// General Configuration Register
pub const UCS1002_REG_GENERAL_CFG: c_uint = 0x15;

// Emulation Configuration Register
pub const UCS1002_REG_EMU_CFG: c_uint = 0x16;
// Switch Configuration Register
pub const UCS1002_REG_SWITCH_CFG: c_uint = 0x17;

// Current Limit Register
pub const UCS1002_REG_ILIMIT: c_uint = 0x19;

// Product ID
pub const UCS1002_REG_PRODUCT_ID: c_uint = 0xfd;

// Manufacture name

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ucs1002_info {
    pub charger: *mut power_supply,
    pub client: *mut i2c_client,
    pub regmap: *mut regmap,
    pub regulator_descriptor: *mut regulator_desc,
    pub rdev: *mut regulator_dev,
    pub present: bool,
    pub output_disable: bool,
    pub health_poll: delayed_work,
    pub health: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn ucs1002_set_max_current(info: *mut ucs1002_info, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucs1002_set_usb_type(info: *mut ucs1002_info, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucs1002_health_poll(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(F_BACK_VOLT): reg & (F_OVER_VOLT |) -> else {
    else if (reg & (F_OVER_VOLT | F_BACK_VOLT))
    info.health = POWER_SUPPLY_HEALTH_OVERVOLTAGE;
#[no_mangle]
pub unsafe extern "C" fn if(F_OVER_ILIM: reg &) -> else {
    else if (reg & F_OVER_ILIM)
    info.health = POWER_SUPPLY_HEALTH_OVERCURRENT;
#[no_mangle]
pub unsafe extern "C" fn if(F_MIN_KEEP_OUT): reg & (F_DISCHARGE_ERR |) -> else {
    ...
    sysfs_notify(&info.charger.dev.kobj, core::ptr::null_mut(), "health");
    }
#[no_mangle]
unsafe extern "C" fn ucs1002_charger_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ucs1002_alert_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ucs1002_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ucs1002_probe(client: *mut i2c_client) -> c_int {
    static int ucs1002_probe(struct i2c_client *client)
    {
    struct device *dev = &client.dev;
    let mut charger_config: power_supply_config = {};
    const struct regmap_config regmap_config = {
    .reg_bits = 8,
    .val_bits = 8,
    };
    let mut regulator_config: regulator_config = {};
...
//
    ...
    return ret;
    if (irq_a_det > 0) {
    ret = devm_request_threaded_irq(dev, irq_a_det, core::ptr::null_mut(),
    ucs1002_charger_irq,
    IRQF_ONESHOT,
    "ucs1002-a_det", info);
    if (ret)
