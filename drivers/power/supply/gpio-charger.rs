...
//! Source: drivers/power/supply/gpio-charger.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_mapping {
    pub limit_ua: u32,
    pub gpiodata: u32,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct gpio_charger {
    pub dev: *mut device,
    pub irq: c_uint,
    pub charge_status_irq: c_uint,
    pub wakeup_enabled: bool,
    pub charger: *mut power_supply,
    pub charger_desc: power_supply_desc,
    pub gpiod: *mut gpio_desc,
    pub charge_status: *mut gpio_desc,
    pub current_limit_gpios: *mut gpio_descs,
    pub current_limit_map: *mut gpio_mapping,
    pub current_limit_map_size: u32,
    pub charge_current_limit: u32,
}

#[no_mangle]
unsafe extern "C" fn gpio_charger_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn set_charge_current_limit(gpio_charger: *mut gpio_charger, val: c_int) -> c_int {
    static int set_charge_current_limit(struct gpio_charger *gpio_charger, int val)
    {
    struct gpio_mapping mapping;
    let mut ndescs: c_int = gpio_charger.current_limit_gpios.ndescs;
...
//
    ...
    for (i = 0; i < ndescs; i++) {
    let mut val: bool = (mapping.gpiodata >> i) & 1;
...
#[no_mangle]
unsafe extern "C" fn gpio_charger_get_type(dev: *mut device) -> enum power_supply_type {
...
#[no_mangle]
unsafe extern "C" fn gpio_charger_probe(pdev: *mut platform_device) -> c_int {
...
//
    gpio_charger.gpiod = devm_gpiod_get_optional(dev, core::ptr::null_mut(), GPIOD_IN);
...
#[no_mangle]
unsafe extern "C" fn gpio_charger_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gpio_charger_resume(dev: *mut device) -> c_int {
