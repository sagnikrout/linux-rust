...
//! Source: drivers/power/supply/cpcap-battery.c
#![no_std]
...
pub const CPCAP_BATTERY_CC_SAMPLE_PERIOD_MS: c_int = 250;
pub const CPCAP_BATTERY_EB41_HW4X_ID: c_uint = 0x9E;
pub const CPCAP_BATTERY_BW8X_ID: c_uint = 0x98;
    enum {
...
pub struct cpcap_interrupt_desc {
    ...
    pub node: list_head,
    pub irq: c_int,
    pub action: enum cpcap_battery_irq_action,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpcap_battery_config {
    pub cd_factor: c_int,
    pub info: power_supply_info,
    pub bat: power_supply_battery_info,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpcap_coulomb_counter_data {
    pub /: *mut *mut s32 sample; / 24 or 32 bits,
    pub accumulator: i32,
    pub /: *mut *mut s16 offset; / 9 bits,
    pub /: *mut *mut s16 integrator; / 13 or 16 bits,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpcap_battery_state_data {
    pub voltage: c_int,
    pub current_ua: c_int,
    pub counter_uah: c_int,
    pub temperature: c_int,
    pub time: ktime_t,
    pub cc: cpcap_coulomb_counter_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cpcap_battery_ddata {
    pub dev: *mut device,
    pub reg: *mut regmap,
    pub irq_list: list_head,
    pub channels: [*mut iio_channel; CPCAP_BATTERY_IIO_NR],
    pub psy: *mut power_supply,
    pub config: cpcap_battery_config,
    pub state: [cpcap_battery_state_data; CPCAP_BATTERY_STATE_NR],
    pub /: *mut *mut u32 cc_lsb; / μAms per LSB,
    pub active: core::sync::atomic::AtomicI32,
    pub charge_full: c_int,
    pub status: c_int,
    pub vendor: u16,
    pub check_nvmem: bool,
    pub is_full:1: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_get_voltage(ddata: *mut cpcap_battery_ddata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_get_current(ddata: *mut cpcap_battery_ddata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_match_nvmem(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_update_battery_data(ddata: *mut cpcap_battery_ddata) {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_detect_battery_type(ddata: *mut cpcap_battery_ddata) {
    static void cpcap_battery_detect_battery_type(struct cpcap_battery_ddata *ddata)
    {
    struct nvmem_device *nvmem;
    let mut battery_id: u8 = 0;
    ddata.check_nvmem = false;
    nvmem = nvmem_device_find(core::ptr::null_mut(), &cpcap_battery_match_nvmem);
...
//
#[no_mangle]
unsafe extern "C" fn cpcap_battery_cc_get_avg_current(ddata: *mut cpcap_battery_ddata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_full(ddata: *mut cpcap_battery_ddata) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_low(ddata: *mut cpcap_battery_ddata) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_update_status(ddata: *mut cpcap_battery_ddata) -> c_int {
...
// empty, *full;
    ...
    if (latest) {
    let mut delta_ms: i64 = ktime_to_ms(ktime_sub(now, latest.time));
...
//
#[no_mangle]
unsafe extern "C" fn cpcap_battery_external_power_changed(psy: *mut power_supply) {
...
#[no_mangle]
pub unsafe extern "C" fn if(3750000: latest->voltage >=) -> else {
    else if (latest.voltage >= 3750000)
    val.intval = POWER_SUPPLY_CAPACITY_LEVEL_HIGH;
#[no_mangle]
pub unsafe extern "C" fn if(3300000: latest->voltage >=) -> else {
    else if (latest.voltage >= 3300000)
    val.intval = POWER_SUPPLY_CAPACITY_LEVEL_NORMAL;
#[no_mangle]
pub unsafe extern "C" fn if(3100000: latest->voltage >) -> else {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_irq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "lowbph", _arg: 6)) -> else {
    else if (!strncmp(name, "lowbph", 6))
    d.action = CPCAP_BATTERY_IRQ_ACTION_BATTERY_LOW;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strncmp(name, _arg: "lowbpl", _arg: 6)) -> else {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_init_iio(ddata: *mut cpcap_battery_ddata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_calibrate(ddata: *mut cpcap_battery_ddata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpcap_battery_remove(pdev: *mut platform_device) {
