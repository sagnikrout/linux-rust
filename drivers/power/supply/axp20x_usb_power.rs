...
//! Source: drivers/power/supply/axp20x_usb_power.c
#![no_std]
...
pub const AXP20X_VBUS_VHOLD_OFFSET: c_int = 3;
...
pub struct axp_data {
    ...
    pub curr_lim_table: *const c_int,
    pub curr_lim_table_size: c_int,
    pub curr_lim_fld: reg_field,
    pub vbus_valid_bit: reg_field,
    pub vbus_mon_bit: reg_field,
    pub usb_bc_en_bit: reg_field,
    pub usb_bc_det_fld: reg_field,
    pub vbus_disable_bit: reg_field,
    pub 1: bool vbus_needs_polling:,
    pub work): *mut *mut void (axp20x_read_vbus)(struct work_struct,
    int (*axp20x_cfg_iio_chan)(struct platform_device *pdev,
    pub power): *mut axp20x_usb_power,
    pub power): *mut *mut int (axp20x_cfg_adc_reg)(struct axp20x_usb_power,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct axp20x_usb_power {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub curr_lim_fld: *mut regmap_field,
    pub vbus_valid_bit: *mut regmap_field,
    pub vbus_mon_bit: *mut regmap_field,
    pub usb_bc_en_bit: *mut regmap_field,
    pub usb_bc_det_fld: *mut regmap_field,
    pub vbus_disable_bit: *mut regmap_field,
    pub supply: *mut power_supply,
    pub axp_data: *const axp_data,
    pub vbus_v: *mut iio_channel,
    pub vbus_i: *mut iio_channel,
    pub vbus_detect: delayed_work,
    pub max_input_cur: c_int,
...
#[no_mangle]
unsafe extern "C" fn axp20x_usb_vbus_needs_polling(power: *mut axp20x_usb_power) -> bool {
...
#[no_mangle]
unsafe extern "C" fn axp20x_usb_power_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn axp20x_usb_power_poll_vbus(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn axp717_usb_power_poll_vbus(work: *mut work_struct) {
...
// step size of 80ma with 3.88v offset.
    ...
    int ret;
    unsigned int reg;
    let mut max: c_uint = power.axp_data.curr_lim_table_size;
    if (intval == -1)
    return -EINVAL;
...
//
    ...
    return power.vbus_disable_bit != core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn axp20x_configure_adc_registers(power: *mut axp20x_usb_power) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp717_configure_adc_registers(power: *mut axp20x_usb_power) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_usb_power_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_usb_power_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_usb_power_probe(pdev: *mut platform_device) -> c_int {
