...
//! Source: drivers/power/supply/wm831x_power.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm831x_power {
    pub wm831x: *mut wm831x,
    pub wall: *mut power_supply,
    pub usb: *mut power_supply,
    pub battery: *mut power_supply,
    pub wall_desc: power_supply_desc,
    pub usb_desc: power_supply_desc,
    pub battery_desc: power_supply_desc,
    pub wall_name: [c_char; 20],
    pub usb_name: [c_char; 20],
    pub battery_name: [c_char; 20],
    pub have_battery: bool,
...
#[no_mangle]
unsafe extern "C" fn wm831x_config_battery(wm831x: *mut wm831x) {
...
#[no_mangle]
unsafe extern "C" fn wm831x_bat_check_status(wm831x: *mut wm831x, status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_bat_check_type(wm831x: *mut wm831x, type: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_bat_check_health(wm831x: *mut wm831x, health: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_bat_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_syslo_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm831x_pwr_src_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm831x_power_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    ret = request_threaded_irq(irq, core::ptr::null_mut(), wm831x_syslo_irq,
    ...
    ret = request_threaded_irq(irq, core::ptr::null_mut(), wm831x_pwr_src_irq,
    ...
    wm831x_bat_irqs[i]));
    ret = request_threaded_irq(irq, core::ptr::null_mut(), wm831x_bat_irq,
...
// ignore missing usb-phy, it's optional
    power.usb_phy = core::ptr::null_mut();
    ret = 0;
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn wm831x_power_remove(pdev: *mut platform_device) {
