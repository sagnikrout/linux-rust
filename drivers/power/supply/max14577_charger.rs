...
//! Source: drivers/power/supply/max14577_charger.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max14577_charger {
    pub dev: *mut device,
    pub max14577: *mut max14577,
    pub charger: *mut power_supply,
    pub pdata: *mut max14577_charger_platform_data,
}
...
#[no_mangle]
unsafe extern "C" fn max14577_get_charger_state(chg: *mut max14577_charger, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max14577_get_charge_type(chg: *mut max14577_charger, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_get_online(chg: *mut max14577_charger, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max14577_get_battery_health(chg: *mut max14577_charger, val: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max14577_get_present(chg: *mut max14577_charger, val: *mut c_int) -> c_int {
...
// Disable
    ...
    reg_data = 0x0;
#[no_mangle]
pub unsafe extern "C" fn if(MAXIM_CHARGER_CONSTANT_VOLTAGE_MAX: uvolt ==) -> else {
    else if (uvolt == MAXIM_CHARGER_CONSTANT_VOLTAGE_MAX)
    reg_data = 0x1f;
#[no_mangle]
pub unsafe extern "C" fn if(4280000: uvolt <=) -> else {
    let mut val: c_uint = uvolt;
    ...
    current_bits = 0x0;
#[no_mangle]
pub unsafe extern "C" fn if(50000: uamp <=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn max14577_charger_reg_init(chg: *mut max14577_charger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_charger_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_charger_remove(pdev: *mut platform_device) {
