...
//! Source: drivers/power/supply/macsmc-power.c
#![no_std]
...
pub const MAX_STRING_LENGTH: c_int = 256;
//
...
//
pub const MACSMC_NOMINAL_CELL_VOLTAGE_MV: c_int = 3800;
// SMC Key Flags

pub const CHWA_CHLS_FIXED_START_OFFSET: c_int = 5;
pub const CHLS_MIN_END_THRESHOLD: c_int = 10;
pub const CHLS_FORCE_DISCHARGE: c_uint = 0x100;
pub const CHWA_FIXED_END_THRESHOLD: c_int = 80;
pub const CHWA_PROP_WRITE_THRESHOLD: c_int = 95;
pub const MACSMC_MAX_BATT_PROPS: c_int = 50;
pub const MACSMC_MAX_AC_PROPS: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct macsmc_power {
    pub dev: *mut device,
    pub smc: *mut apple_smc,
    pub ac_desc: power_supply_desc,
    pub batt_desc: power_supply_desc,
    pub batt: *mut power_supply,
    pub ac: *mut power_supply,
    pub model_name: [c_char; MAX_STRING_LENGTH],
    pub serial_number: [c_char; MAX_STRING_LENGTH],
    pub mfg_date: [c_char; MAX_STRING_LENGTH],
// Supported feature flags based on SMC key presence
    pub /: *mut *mut bool has_chwa; / Charge limit (Modern firmware),
    pub /: *mut *mut bool has_chls; / Charge limit (Older firmware),
    pub /: *mut *mut bool has_ch0i; / Force discharge (Older firmware),
    pub /: *mut *mut bool has_ch0c; / Inhibit charge (Older firmware),
    pub /: *mut *mut bool has_chte; / Inhibit charge (Modern firmware),
//
...
//
    pub fw_ge_27: bool,
    pub num_cells: u8,
    pub nominal_voltage_mv: c_int,
    pub nb: notifier_block,
    pub critical_work: work_struct,
    pub emergency_shutdown_triggered: bool,
    pub orderly_shutdown_triggered: bool,
}

#[no_mangle]
unsafe extern "C" fn macsmc_battery_get_status(power: *mut macsmc_power) -> c_int {
    static int macsmc_battery_get_status(struct macsmc_power *power)
    {
    u64 nocharge_flags;
    u32 nopower_flags;
    u16 ac_current;
    let mut charge_limit: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(!limited: nocharge_flags == CHNC_BMS_BUSY &&) -> else {
    else if (nocharge_flags == CHNC_BMS_BUSY && !limited)
    return POWER_SUPPLY_STATUS_CHARGING;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: nocharge_flags) -> else {
...
#[no_mangle]
unsafe extern "C" fn macsmc_battery_get_charge_behaviour(power: *mut macsmc_power) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsmc_battery_set_charge_behaviour(power: *mut macsmc_power, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: power->has_ch0c) -> else {
    else if (power.has_ch0c)
...
#[no_mangle]
unsafe extern "C" fn macsmc_battery_get_date(s: *const c_char, out: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsmc_battery_read_bcf0(power: *mut macsmc_power, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsmc_battery_get_capacity_level(power: *mut macsmc_power) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsmc_swap_b0rm(power: *mut macsmc_power, b0rm: i16) -> i16 {
...
#[no_mangle]
unsafe extern "C" fn macsmc_power_critical_work(wrk: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn macsmc_power_event(nb: *mut notifier_block, event: c_ulong, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn macsmc_power_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut has_battery: bool = false;
    let mut has_ac_adapter: bool = false;
...
// Detect features based on key availability
    ...
    power.fw_ge_27 = true;
#[no_mangle]
pub unsafe extern "C" fn if(4: info.size ==) -> else {
    else if (info.size == 4)
...
// Detect charge limit method (CHWA vs CHLS)
    ...
    power.has_chwa = true;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: apple_smc_read_u16(power->smc, _arg: SMC_KEY(CHLS), 0: &vu16) >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn macsmc_power_remove(pdev: *mut platform_device) {
