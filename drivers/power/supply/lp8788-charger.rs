...
//! Source: drivers/power/supply/lp8788-charger.c
#![no_std]
...
// register address
pub const LP8788_CHG_STATUS: c_uint = 0x07;
pub const LP8788_CHG_IDCIN: c_uint = 0x13;
pub const LP8788_CHG_IBATT: c_uint = 0x14;
pub const LP8788_CHG_VTERM: c_uint = 0x15;
pub const LP8788_CHG_EOC: c_uint = 0x16;
// mask/shift bits
pub const LP8788_CHG_INPUT_STATE_M: c_uint = 0x03	/* Addr 07h */;
pub const LP8788_CHG_STATE_M: c_uint = 0x3C;
pub const LP8788_CHG_STATE_S: c_int = 2;

pub const LP8788_CHG_IBATT_M: c_uint = 0x1F	/* Addr 14h */;
pub const LP8788_CHG_VTERM_M: c_uint = 0x0F	/* Addr 15h */;
pub const LP8788_CHG_EOC_LEVEL_M: c_uint = 0x30	/* Addr 16h */;
pub const LP8788_CHG_EOC_LEVEL_S: c_int = 4;
pub const LP8788_CHG_EOC_TIME_M: c_uint = 0x0E;
pub const LP8788_CHG_EOC_TIME_S: c_int = 1;

pub const LP8788_CHG_START: c_uint = 0x11;
pub const LP8788_CHG_END: c_uint = 0x1C;
pub const LP8788_ISEL_MAX: c_int = 23;
pub const LP8788_ISEL_STEP: c_int = 50;
pub const LP8788_VTERM_MIN: c_int = 4100;
pub const LP8788_VTERM_STEP: c_int = 25;
pub const LP8788_MAX_BATT_CAPACITY: c_int = 100;
pub const LP8788_MAX_CHG_IRQS: c_int = 11;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp8788_chg_irq {
    pub which: enum lp8788_int_id,
    pub virq: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp8788_charger {
    pub lp: *mut lp8788,
    pub charger: *mut power_supply,
    pub battery: *mut power_supply,
    pub charger_work: work_struct,
    pub chan: [*mut iio_channel; LP8788_NUM_CHG_ADC],
    pub irqs: [lp8788_chg_irq; LP8788_MAX_CHG_IRQS],
    pub num_irqs: c_int,
    pub pdata: *mut lp8788_charger_platform_data,
}
...
#[no_mangle]
unsafe extern "C" fn lp8788_is_charger_detected(pchg: *mut lp8788_charger) -> bool {
    static bool lp8788_is_charger_detected(struct lp8788_charger *pchg)
    {
    u8 data;
    lp8788_read_byte(pchg.lp, LP8788_CHG_STATUS, &data);
    data &= LP8788_CHG_INPUT_STATE_M;
    let mut data: return = = LP8788_SYSTEM_SUPPLY || data == LP8788_FULL_FUNCTION;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(LP8788_BAD_BATT_M: data &) -> else {
...
#[no_mangle]
unsafe extern "C" fn lp8788_get_vbatt_adc(pchg: *mut lp8788_charger, result: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn lp8788_is_valid_charger_register(addr: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lp8788_charger_event(work: *mut work_struct) {
    static void lp8788_charger_event(struct work_struct *work)
    {
    struct lp8788_charger *pchg =
    container_of(work, struct lp8788_charger, charger_work);
    struct lp8788_charger_platform_data *pdata = pchg.pdata;
    let mut event: enum lp8788_charger_event = lp8788_is_charger_detected(pchg);
    pdata.charger_event(pchg.lp, event);
    }
#[no_mangle]
unsafe extern "C" fn lp8788_find_irq_id(pchg: *mut lp8788_charger, virq: c_int, id: *mut c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn lp8788_charger_irq_thread(virq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
// no error even if no irq resource
    ...
    pchg.num_irqs++;
    ret = request_threaded_irq(virq, core::ptr::null_mut(),
...
// ADC channel for battery voltage
    ...
    pchg.chan[LP8788_VBATT] = IS_ERR(chan) ? core::ptr::null_mut() : chan;
// ADC channel for battery temperature
    chan = devm_iio_channel_get(dev, pdata.adc_batt_temp);
    pchg.chan[LP8788_BATT_TEMP] = IS_ERR(chan) ? core::ptr::null_mut() : chan;
    }
    ...
    static DEVICE_ATTR(charger_status, S_IRUSR, lp8788_show_charger_status, core::ptr::null_mut());
    static DEVICE_ATTR(eoc_time, S_IRUSR, lp8788_show_eoc_time, core::ptr::null_mut());
    static DEVICE_ATTR(eoc_level, S_IRUSR, lp8788_show_eoc_level, core::ptr::null_mut());
    ...
    &lp8788_psy_battery_desc, core::ptr::null_mut());
    if (IS_ERR(pchg.battery))
    return -EPERM;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn lp8788_charger_probe(pdev: *mut platform_device) -> c_int {
    ...
    return -ENOMEM;
    pchg.lp = lp;
    pchg.pdata = lp.pdata ? lp.pdata.chg_pdata : core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lp8788_charger_remove(pdev: *mut platform_device) {
