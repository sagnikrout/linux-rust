...
//! Source: drivers/power/supply/da9052-battery.c
#![no_std]
...
pub const DA9052_BAT_CUTOFF_VOLT: c_int = 2800;
pub const DA9052_BAT_TSH: c_int = 62000;
pub const DA9052_BAT_LOW_CAP: c_int = 4;
pub const DA9052_AVG_SZ: c_int = 4;
pub const DA9052_VC_TBL_SZ: c_int = 68;
pub const DA9052_VC_TBL_REF_SZ: c_int = 3;
pub const DA9052_ISET_USB_MASK: c_uint = 0x0F;
pub const DA9052_CHG_USB_ILIM_MASK: c_uint = 0x40;
pub const DA9052_CHG_LIM_COLS: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9052_battery {
    pub da9052: *mut da9052,
    pub psy: *mut power_supply,
    pub nb: notifier_block,
    pub charger_type: c_int,
    pub status: c_int,
    pub health: c_int,
}

#[no_mangle]
pub unsafe extern "C" fn volt_reg_to_mV(value: c_int) -> c_int {
    static inline int volt_reg_to_mV(int value)
    {
    return ((value * 1000) / 512) + 2500;
    }
#[no_mangle]
pub unsafe extern "C" fn ichg_reg_to_mA(value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_read_chg_current(bat: *mut da9052_battery, current_mA: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_bat_check_status(bat: *mut da9052_battery, status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_bat_read_volt(bat: *mut da9052_battery, volt_mV: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_bat_check_presence(bat: *mut da9052_battery, illegal: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_determine_vc_tbl_index(adc_temp: c_uchar) -> c_uchar {
...
#[no_mangle]
unsafe extern "C" fn da9052_bat_read_capacity(bat: *mut da9052_battery, capacity: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_bat_check_health(bat: *mut da9052_battery, health: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9052_bat_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    da9052_bat_check_status(bat, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn da9052_bat_probe(pdev: *mut platform_device) -> i32 {
    ...
    if (pdata != core::ptr::null_mut() && pdata.use_for_apm)
...
#[no_mangle]
unsafe extern "C" fn da9052_bat_remove(pdev: *mut platform_device) {
