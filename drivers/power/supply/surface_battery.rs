...
//! Source: drivers/power/supply/surface_battery.c
#![no_std]
...
pub struct spwr_bix {
    ...
    pub design_cap: __le32,
    pub last_full_charge_cap: __le32,
    pub technology: __le32,
    pub design_voltage: __le32,
    pub design_cap_warn: __le32,
    pub design_cap_low: __le32,
    pub cycle_count: __le32,
    pub measurement_accuracy: __le32,
    pub max_sampling_time: __le32,
    pub min_sampling_time: __le32,
    pub max_avg_interval: __le32,
    pub min_avg_interval: __le32,
    pub bat_cap_granularity_1: __le32,
    pub bat_cap_granularity_2: __le32,
    pub model: [__u8; 21],
    pub serial: [__u8; 11],
    pub type: [__u8; 5],
    pub oem_info: [__u8; 21],
    pub __packed: },
    pub 119): static_assert(sizeof(struct spwr_bix) ==,
// Equivalent to data returned in ACPI _BST method.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spwr_bst {
    pub state: __le32,
    pub present_rate: __le32,
    pub remaining_cap: __le32,
    pub present_voltage: __le32,
    pub __packed: },
    pub 16): static_assert(sizeof(struct spwr_bst) ==,
pub const SPWR_BIX_REVISION: c_int = 0;
pub const SPWR_BATTERY_VALUE_UNKNOWN: c_uint = 0xffffffff;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spwr_psy_properties {
    pub name: *const c_char,
    pub registry: ssam_event_registry,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct spwr_battery_device {
    ...
    pub /: *mut *mut mutex lock; / Guards access to state data below.,
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_present(bat: *mut spwr_battery_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_load_sta(bat: *mut spwr_battery_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_load_bix(bat: *mut spwr_battery_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_load_bst(bat: *mut spwr_battery_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_set_alarm_unlocked(bat: *mut spwr_battery_device, value: u32) -> c_int {
    static int spwr_battery_set_alarm_unlocked(struct spwr_battery_device *bat, u32 value)
    {
    let mut value_le: __le32 = cpu_to_le32(value);
    lockdep_assert_held(&bat.lock);
    bat.alarm = value;
    return ssam_retry(ssam_bat_set_btp, bat.sdev, &value_le);
    }
#[no_mangle]
unsafe extern "C" fn spwr_battery_update_bst_unlocked(bat: *mut spwr_battery_device, cached: bool) -> c_int {
    static int spwr_battery_update_bst_unlocked(struct spwr_battery_device *bat, bool cached)
    {
    let mut cache_deadline: c_ulong = bat.timestamp + msecs_to_jiffies(cache_time);
    int status;
    lockdep_assert_held(&bat.lock);
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_update_bst(bat: *mut spwr_battery_device, cached: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_update_bix_unlocked(bat: *mut spwr_battery_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprw_battery_get_full_cap_safe(bat: *mut spwr_battery_device) -> u32 {
    static u32 sprw_battery_get_full_cap_safe(struct spwr_battery_device *bat)
    {
    let mut full_cap: u32 = get_unaligned_le32(&bat.bix.last_full_charge_cap);
    lockdep_assert_held(&bat.lock);
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_is_full(bat: *mut spwr_battery_device) -> bool {
    static bool spwr_battery_is_full(struct spwr_battery_device *bat)
    {
    let mut state: u32 = get_unaligned_le32(&bat.bst.state);
    let mut full_cap: u32 = sprw_battery_get_full_cap_safe(bat);
    let mut remaining_cap: u32 = get_unaligned_le32(&bat.bst.remaining_cap);
    lockdep_assert_held(&bat.lock);
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_recheck_full(bat: *mut spwr_battery_device) -> c_int {
...
// If battery has been attached, (re-)initialize alarm.
    ...
    let mut cap_warn: u32 = get_unaligned_le32(&bat.bix.design_cap_warn);
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_recheck_status(bat: *mut spwr_battery_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_notify_bat(nf: *mut ssam_event_notifier, event: *const ssam_event) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_update_bst_workfn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn spwr_external_power_changed(psy: *mut power_supply) {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_prop_status(bat: *mut spwr_battery_device) -> c_int {
    static int spwr_battery_prop_status(struct spwr_battery_device *bat)
    {
    let mut state: u32 = get_unaligned_le32(&bat.bst.state);
    let mut present_rate: u32 = get_unaligned_le32(&bat.bst.present_rate);
    lockdep_assert_held(&bat.lock);
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_prop_technology(bat: *mut spwr_battery_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_prop_capacity(bat: *mut spwr_battery_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_prop_capacity_level(bat: *mut spwr_battery_device) -> c_int {
...
// -- Alarm attribute. ------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn alarm_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn spwr_battery_register(bat: *mut spwr_battery_device) -> c_int {
...
// -- Driver setup. ---------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn surface_battery_resume(dev: *mut device) -> int __maybe_unused {
    static int __maybe_unused surface_battery_resume(struct device *dev)
    {
    return spwr_battery_recheck_full(dev_get_drvdata(dev));
    }
    static SIMPLE_DEV_PM_OPS(surface_battery_pm_ops, core::ptr::null_mut(), surface_battery_resume);
#[no_mangle]
unsafe extern "C" fn surface_battery_probe(sdev: *mut ssam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn surface_battery_remove(sdev: *mut ssam_device) {
