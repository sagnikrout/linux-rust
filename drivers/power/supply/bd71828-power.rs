...
//! Source: drivers/power/supply/bd71828-power.c
#![no_std]
...
// common defines
pub const BD7182x_MASK_VBAT_U: c_uint = 0x1f;
pub const BD7182x_MASK_VDCIN_U: c_uint = 0x0f;
pub const BD7182x_MASK_IBAT_U: c_uint = 0x3f;
pub const BD7182x_MASK_CURDIR_DISCHG: c_uint = 0x80;
pub const BD7182x_MASK_CHG_STATE: c_uint = 0x7f;
pub const BD7182x_MASK_BAT_TEMP: c_uint = 0x07;

pub const BD7182x_MASK_BAT_STAT: c_uint = 0x3f;
pub const BD7182x_MASK_ILIM: c_uint = 0x3f;

pub const BD7182x_MASK_DCIN_STAT: c_uint = 0x07;
pub const BD7182x_MASK_WDT_AUTO: c_uint = 0x40;
pub const BD7182x_MASK_VBAT_ALM_LIMIT_U: c_uint = 0x01;
pub const BD7182x_MASK_CHG_EN: c_uint = 0x01;
pub const BD7182x_DCIN_COLLAPSE_DEFAULT: c_uint = 0x36;

pub const BAT_OPEN: c_uint = 0x7;
//
// VBAT Low voltage detection Threshold
// 0x00D4*16mV = 212*0.016 = 3.392v
//
pub const VBAT_LOW_TH: c_uint = 0x00D4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwr_regs {
    pub vbat_avg: c_uint,
    pub ibat: c_uint,
    pub ibat_avg: c_uint,
    pub ilim_stat: c_uint,
    pub btemp_vth: c_uint,
    pub chg_state: c_uint,
    pub bat_temp: c_uint,
    pub dcin_set: c_uint,
    pub dcin_stat: c_uint,
    pub dcin_online_mask: c_uint,
    pub dcin_collapse_limit: c_uint,
    pub chg_set1: c_uint,
    pub chg_en: c_uint,
    pub vbat_alm_limit_u: c_uint,
    pub conf: c_uint,
    pub vdcin: c_uint,
    pub vdcin_himask: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd71828_power {
    pub regmap: *mut regmap,
    pub chip_type: enum rohm_chip_type,
    pub dev: *mut device,
    pub ac: *mut power_supply,
    pub bat: *mut power_supply,
    pub regs: *const pwr_regs,
// Reg val to uA
    pub curr_factor: c_int,
    pub rsens: c_int,
    pub temp): *mut *mut *mut int (get_temp)(struct bd71828_power pwr, int,
    pub pwr): *mut *mut int (bat_inserted)(struct bd71828_power,
}

#[no_mangle]
unsafe extern "C" fn bd7182x_write16(pwr: *mut bd71828_power, reg: c_int, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd71828_get_vbat(pwr: *mut bd71828_power, vcell: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd71828_get_current_ds_adc(pwr: *mut bd71828_power, curr: *mut c_int, curr_avg: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd71815_get_temp(pwr: *mut bd71828_power, temp: *mut c_int) -> c_int {
...
// Unit is tenths of degree C
#[no_mangle]
unsafe extern "C" fn bd71828_get_temp(pwr: *mut bd71828_power, temp: *mut c_int) -> c_int {
    static int bd71828_get_temp(struct bd71828_power *pwr, int *temp)
    {
    u16 t;
    int ret;
    let mut tmp: c_int = 200 * 10000;
...
#[no_mangle]
unsafe extern "C" fn get_chg_online(pwr: *mut bd71828_power, chg_online: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_bat_online(pwr: *mut bd71828_power, bat_online: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd71828_bat_inserted(pwr: *mut bd71828_power) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd71815_bat_inserted(pwr: *mut bd71828_power) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd71828_init_hardware(pwr: *mut bd71828_power) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd7182x_dcin_removed(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd718x7_chg_done(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd7182x_dcin_detected(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_vbat_low_res(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_vbat_low_det(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_temp_bat_hi_det(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_temp_bat_hi_res(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_temp_bat_low_det(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_temp_bat_low_res(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_temp_vf_det(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_temp_vf_res(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_temp_vf125_det(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd71828_temp_vf125_res(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bd7182x_get_rsens(pwr: *mut bd71828_power) -> c_int {
    static int bd7182x_get_rsens(struct bd71828_power *pwr)
    {
    let mut tmp: u64 = RSENS_CURR;
    let mut rsens_ohm: c_int = RSENS_DEFAULT_30MOHM;
    struct fwnode_handle *node = core::ptr::null_mut();
    if (pwr.dev.parent)
...
#[no_mangle]
unsafe extern "C" fn bd71828_ac_sysfs_group_visible(kobj: *mut kobject) -> bool {
...
#[no_mangle]
unsafe extern "C" fn bd71828_power_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    pwr.regmap = dev_get_regmap(pdev.dev.parent, core::ptr::null_mut());
    else
