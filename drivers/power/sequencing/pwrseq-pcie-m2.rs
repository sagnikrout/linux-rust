...
//! Source: drivers/power/sequencing/pwrseq-pcie-m2.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwrseq_pcie_m2_pdata {
    pub targets: *const pwrseq_target_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwrseq_pcie_m2_ctx {
    pub pwrseq: *mut pwrseq_device,
    pub of_node: *mut device_node,
    pub pdata: *const pwrseq_pcie_m2_pdata,
    pub regs: *mut regulator_bulk_data,
    pub num_vregs: usize,
    pub nb: notifier_block,
    pub w_disable1_gpio: *mut gpio_desc,
    pub w_disable2_gpio: *mut gpio_desc,
    pub dev: *mut device,
    pub pci_devices: list_head,
    pub list_lock: mutex,
}

#[no_mangle]
unsafe extern "C" fn pwrseq_pcie_m2_vregs_enable(pwrseq: *mut pwrseq_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_pcie_m2_vregs_disable(pwrseq: *mut pwrseq_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_pci_m2_e_uart_enable(pwrseq: *mut pwrseq_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_pci_m2_e_uart_disable(pwrseq: *mut pwrseq_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_pci_m2_e_pcie_enable(pwrseq: *mut pwrseq_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_pci_m2_e_pcie_disable(pwrseq: *mut pwrseq_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_pcie_m2_e_pwup_delay(pwrseq: *mut pwrseq_device) -> c_int {
...
// Bail out if the serdev device was already created for the PCI dev
    ...
    pci_dev.serdev = core::ptr::null_mut();
    err_free_pci_dev:
    kfree(pci_dev);
    err_put_ctrl:
    serdev_controller_put(serdev_ctrl);
...
//
#[no_mangle]
unsafe extern "C" fn pwrseq_pcie_m2_register_notifier(ctx: *mut pwrseq_pcie_m2_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_pcie_m2_create_serdev(ctx: *mut pwrseq_pcie_m2_ctx) -> c_int {
...
// Create serdev for existing PCI devices if required
    ...
    return 0;
    err_remove_serdev:
    pwrseq_pcie_m2_remove_serdev(ctx, core::ptr::null_mut());
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn pwrseq_pcie_m2_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_pcie_m2_remove(pdev: *mut platform_device) {
