...
//! Source: drivers/power/sequencing/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pwrseq_unit_put(unit: *mut pwrseq_unit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwrseq_unit_dep {
    pub list: list_head,
    pub unit: *mut pwrseq_unit,
}
...
#[no_mangle]
unsafe extern "C" fn pwrseq_unit_dep_free(ref: *mut pwrseq_unit_dep) {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_unit_free_deps(list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_unit_release(ref: *mut kref) {
    static void pwrseq_unit_release(struct kref *ref)
    {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_target_free(target: *mut pwrseq_target) {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_device_put(pwrseq: *mut pwrseq_device) {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_check_target_deps(data: *const pwrseq_target_data) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwrseq_device_unregister(pwrseq: *mut pwrseq_device) {
...
#[no_mangle]
unsafe extern "C" fn devm_pwrseq_device_unregister(data: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwrseq_match_data {
    pub desc: *mut pwrseq_desc,
    pub dev: *mut device,
    pub target: *const c_char,
}

#[no_mangle]
unsafe extern "C" fn pwrseq_match_device(pwrseq_dev: *mut device, data: *mut c_void) -> c_int {
...
//
    ...
    ret = bus_for_each_dev(&pwrseq_bus, core::ptr::null_mut(), &match_data,
    pwrseq_match_device);
    if (ret < 0)
    return ERR_PTR(ret);
...
//
#[no_mangle]
pub unsafe extern "C" fn pwrseq_put(desc: *mut pwrseq_desc) {
...
#[no_mangle]
unsafe extern "C" fn devm_pwrseq_put(data: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwrseq_enable(desc: *mut pwrseq_desc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pwrseq_disable(desc: *mut pwrseq_desc) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pwrseq_debugfs_count_ctx {
    pub dev: *mut device,
    pub index: loff_t,
}

#[no_mangle]
unsafe extern "C" fn pwrseq_debugfs_seq_count(dev: *mut device, data: *mut c_void) -> c_int {
...
//
    ...
    bus_for_each_dev(&pwrseq_bus, core::ptr::null_mut(), &ctx, pwrseq_debugfs_seq_count);
    if (!ctx.index)
    return core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pwrseq_debugfs_seq_show(seq: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_debugfs_seq_stop(seq: *mut seq_file, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pwrseq_init() -> int __init {
    ...
    pwrseq_debugfs_dentry = debugfs_create_file("pwrseq", 0444, core::ptr::null_mut(), core::ptr::null_mut(),
    &pwrseq_debugfs_fops);
...
#[no_mangle]
unsafe extern "C" fn pwrseq_exit() -> void __exit {
