...
//! Source: drivers/power/reset/qnap-poweroff.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qnap_power_off() {
    static void qnap_power_off(void)
    {
    let mut divisor: unsigned = ((tclk + (8 * cfg.baud)) / (16 * cfg.baud));
...
#[no_mangle]
unsafe extern "C" fn qnap_power_off_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qnap_power_off_remove(pdev: *mut platform_device) {
