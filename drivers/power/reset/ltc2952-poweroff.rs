...
//! Source: drivers/power/reset/ltc2952-poweroff.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ltc2952_poweroff {
    pub timer_trigger: hrtimer,
    pub timer_wde: hrtimer,
    pub trigger_delay: ktime_t,
    pub wde_interval: ktime_t,
    pub dev: *mut device,
    pub gpio_trigger: *mut gpio_desc,
    pub gpio_watchdog: *mut gpio_desc,
    pub gpio_kill: *mut gpio_desc,
...
//
#[no_mangle]
unsafe extern "C" fn ltc2952_poweroff_timer_wde(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn ltc2952_poweroff_start_wde(data: *mut ltc2952_poweroff) {
...
//
#[no_mangle]
unsafe extern "C" fn ltc2952_poweroff_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ltc2952_poweroff_kill() {
    static void ltc2952_poweroff_kill(void)
    {
    gpiod_set_value(ltc2952_data.gpio_kill, 1);
    }
#[no_mangle]
unsafe extern "C" fn ltc2952_poweroff_default(data: *mut ltc2952_poweroff) {
...
#[no_mangle]
unsafe extern "C" fn ltc2952_poweroff_init(pdev: *mut platform_device) -> c_int {
...
//
    ...
    data.gpio_trigger = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ltc2952_poweroff_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ltc2952_poweroff_remove(pdev: *mut platform_device) {
