...
//! Source: drivers/w1/masters/w1-uart.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w1_uart_device {
    pub serdev: *mut serdev_device,
    pub bus: w1_bus_master,
    pub cfg_reset: w1_uart_config,
    pub cfg_touch_0: w1_uart_config,
    pub cfg_touch_1: w1_uart_config,
    pub rx_byte_received: completion,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w1_uart_limits {
    pub baudrate: c_uint,
    pub bit_min_us: c_uint,
    pub bit_max_us: c_uint,
    pub sample_us: c_uint,
    pub cycle_us: c_uint,
}

#[no_mangle]
pub unsafe extern "C" fn baud_to_bit_ns(baud: c_uint) -> c_uint {
    static inline unsigned int baud_to_bit_ns(unsigned int baud)
    {
    return NSEC_PER_SEC / baud;
    }
#[no_mangle]
pub unsafe extern "C" fn to_ns(us: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn w1_uart_set_config_reset(w1dev: *mut w1_uart_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn w1_uart_set_config_touch_0(w1dev: *mut w1_uart_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn w1_uart_set_config_touch_1(w1dev: *mut w1_uart_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn w1_uart_serdev_open(w1dev: *mut w1_uart_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn w1_uart_reset_bus(data: *mut c_void) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn w1_uart_touch_bit(data: *mut c_void, bit: u8) -> u8 {
...
// return inactive bus state on error
    if (ret < 0)
    return 1;
    let mut val: return = = w1cfg.tx_byte ? 1 : 0;
    }
#[no_mangle]
unsafe extern "C" fn w1_uart_probe(serdev: *mut serdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w1_uart_remove(serdev: *mut serdev_device) {
