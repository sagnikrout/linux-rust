...
pub const W1_FAMILY_DEFAULT: c_int = 0;
pub const W1_FAMILY_DS28E04: c_uint = 0x1C /* for crc quirk */;
    let mut w1_timeout: static int = 10;
...
//
    let mut w1_max_slave_count: c_int = 64;
    module_param_named(max_slave_count, w1_max_slave_count, int, 0);
    MODULE_PARM_DESC(max_slave_count,
    "maximum number of slaves detected in a search");
    let mut w1_max_slave_ttl: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn w1_master_probe(dev: *mut device) -> c_int {
    static int w1_master_probe(struct device *dev)
    {
    return -ENODEV;
    }
#[no_mangle]
unsafe extern "C" fn w1_master_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn w1_slave_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn name_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    {
    struct w1_slave *sl = dev_to_w1_slave(dev);
    let mut count: isize = sizeof(sl.reg_num);
...
#[no_mangle]
unsafe extern "C" fn w1_master_attribute_show_name(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn w1_master_attribute_show_pointer(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn w1_master_attribute_show_timeout(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn w1_master_attribute_show_max_slave_count(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn w1_master_attribute_show_attempts(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn w1_master_attribute_show_slave_count(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
// refcnt 0 means it was detached in the call
    ...
    w1_master_attribute_show_##_name, core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn w1_create_master_attributes(master: *mut w1_master) -> c_int {
    int w1_create_master_attributes(struct w1_master *master)
    {
    return sysfs_create_group(&master.dev.kobj, &w1_master_defattr_group);
    }
#[no_mangle]
pub unsafe extern "C" fn w1_destroy_master_attributes(master: *mut w1_master) {
    void w1_destroy_master_attributes(struct w1_master *master)
    {
    sysfs_remove_group(&master.dev.kobj, &w1_master_defattr_group);
    }
#[no_mangle]
unsafe extern "C" fn w1_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
    static int w1_uevent(const struct device *dev, struct kobj_uevent_env *env)
    {
    const struct w1_master *md = core::ptr::null_mut();
    const struct w1_slave *sl = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn w1_family_notify(action: c_ulong, sl: *mut w1_slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __w1_attach_slave_device(sl: *mut w1_slave) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w1_attach_slave_device(dev: *mut w1_master, rn: *mut w1_reg_num) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w1_unref_slave(sl: *mut w1_slave) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w1_slave_detach(sl: *mut w1_slave) -> c_int {
...
// Only detach a slave once as it decreases the refcnt each time.
    ...
    {
    struct w1_master *dev = core::ptr::null_mut(), *iter;
    mutex_lock(&w1_mlock);
    ...
    struct w1_slave *sl = core::ptr::null_mut(), *iter;
    mutex_lock(&w1_mlock);
...
#[no_mangle]
pub unsafe extern "C" fn w1_reconnect_slaves(f: *mut w1_family, attach: c_int) {
...
#[no_mangle]
unsafe extern "C" fn w1_addr_crc_is_valid(dev: *mut w1_master, rn: u64) -> c_int {
    static int w1_addr_crc_is_valid(struct w1_master *dev, u64 rn)
    {
    let mut rn_le: u64 = cpu_to_le64(rn);
...
#[no_mangle]
pub unsafe extern "C" fn w1_slave_found(dev: *mut w1_master, rn: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_search(dev: *mut w1_master, search_type: u8, cb: w1_slave_found_callback) {
...
#[no_mangle]
pub unsafe extern "C" fn if(desc_bit: i >) -> else {
    else if (i > desc_bit)
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(W1_SLAVE_ACTIVE, _arg: &sl->flags)) -> else {
...
#[no_mangle]
unsafe extern "C" fn w1_search_process(dev: *mut w1_master, search_type: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_process_callbacks(dev: *mut w1_master) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w1_process(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w1_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn w1_fini() -> void __exit {
