...
//! Source: drivers/w1/slaves/w1_ds2413.c
#![no_std]
...
pub const W1_FAMILY_DS2413: c_uint = 0x3A;
pub const W1_F3A_RETRIES: c_int = 3;
pub const W1_F3A_FUNC_PIO_ACCESS_READ: c_uint = 0xF5;
pub const W1_F3A_FUNC_PIO_ACCESS_WRITE: c_uint = 0x5A;
pub const W1_F3A_SUCCESS_CONFIRM_BYTE: c_uint = 0xAA;
pub const W1_F3A_INVALID_PIO_STATE: c_uint = 0xFF;
    static ssize_t state_read(struct file *filp, struct kobject *kobj,
    const struct bin_attribute *bin_attr, char *buf,
    loff_t off, size_t count)
    {
    struct w1_slave *sl = kobj_to_w1_slave(kobj);
    let mut retries: c_uint = W1_F3A_RETRIES;
    let mut bytes_read: isize = -EIO;
    u8 state;
    dev_dbg(&sl.dev,
...
// buf = *buf | 0xFC;
    ...
    static const BIN_ATTR(output, 0664, core::ptr::null_mut(), output_write, 1);
