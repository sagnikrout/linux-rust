...
//! Source: drivers/w1/slaves/w1_ds2433.c
#![no_std]
...
pub const W1_EEPROM_DS2433: c_uint = 0x23;
pub const W1_EEPROM_DS28EC20: c_uint = 0x43;
pub const W1_EEPROM_DS2433_SIZE: c_int = 512;
pub const W1_EEPROM_DS28EC20_SIZE: c_int = 2560;
pub const W1_PAGE_SIZE: c_int = 32;
pub const W1_PAGE_BITS: c_int = 5;
pub const W1_PAGE_MASK: c_uint = 0x1F;
pub const W1_VALIDCRC_MAX: c_int = 96;
pub const W1_F23_READ_EEPROM: c_uint = 0xF0;
pub const W1_F23_WRITE_SCRATCH: c_uint = 0x0F;
pub const W1_F23_READ_SCRATCH: c_uint = 0xAA;
pub const W1_F23_COPY_SCRATCH: c_uint = 0x55;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ds2433_config {
    pub /: *mut *mut size_t eeprom_size; / eeprom size in bytes,
    pub /: *mut *mut unsigned int page_count; / number of 256 bits pages,
    pub /: *mut *mut unsigned int tprog; / time in ms for page programming,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w1_f23_data {

    pub memory: *mut u8,
    pub W1_VALIDCRC_MAX): DECLARE_BITMAP(validcrc,,

    pub cfg: *const ds2433_config,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_f23_fix_count(off: loff_t, count: usize, size: usize) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn w1_f23_write(sl: *mut w1_slave, addr: c_int, len: c_int, data: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w1_f23_add_slave(sl: *mut w1_slave) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w1_f23_remove_slave(sl: *mut w1_slave) {
...
#[no_mangle]
unsafe extern "C" fn w1_ds2433_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn w1_ds2433_exit() -> void __exit {
