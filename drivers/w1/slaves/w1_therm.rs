...
//! Source: drivers/w1/slaves/w1_therm.c
#![no_std]
...
pub const W1_THERM_DS18S20: c_uint = 0x10;
pub const W1_THERM_DS1822: c_uint = 0x22;
pub const W1_THERM_DS18B20: c_uint = 0x28;
pub const W1_THERM_DS1825: c_uint = 0x3B;
pub const W1_THERM_DS28EA00: c_uint = 0x42;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w1_therm_family_converter {
    pub broken: u8,
    pub reserved: u16,
    pub f: *mut w1_family,
    pub rom[9]): *mut *mut int (convert)(u8,
    pub sl): *mut *mut int (get_conversion_time)(struct w1_slave,
    pub val): *mut *mut *mut int (set_resolution)(struct w1_slave sl, int,
    pub sl): *mut *mut int (get_resolution)(struct w1_slave,
    pub data): *const *const *const int (write_data)(struct w1_slave sl, u8,
    pub bulk_read: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct w1_therm_family_data {
    pub rom: [u8; 9],
    pub refcnt: core::sync::atomic::AtomicI32,
    pub external_powered: c_int,
    pub resolution: c_int,
    pub convert_triggered: c_int,
    pub conv_time_override: c_int,
    pub features: c_uint,
    pub specific_functions: *mut w1_therm_family_converter,
}
...
// Attribute groups
    ...
    {
    let mut attr: return = = hwmon_temp_input ? 0444 : 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn w1_DS18B20_convert_time(sl: *mut w1_slave) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w1_DS18S20_convert_time(sl: *mut w1_slave) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w1_DS1825_convert_time(sl: *mut w1_slave) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w1_DS18B20_set_resolution(sl: *mut w1_slave, val: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn w1_DS18B20_get_resolution(sl: *mut w1_slave) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_DS18B20_convert_temp(rom[9]: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_DS18S20_convert_temp(rom[9]: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_DS1825_convert_temp(rom[9]: u8) -> c_int {
...
// GX20MH01 device shares family number and structure with DS18B20
    ...
    .set_resolution		= core::ptr::null_mut(),	/* no config register */
    .get_resolution		= core::ptr::null_mut(),	/* no config register */
...
//
    ...
    {
    struct w1_therm_family_converter *ret = core::ptr::null_mut();
    int i;
...
//
#[no_mangle]
pub unsafe extern "C" fn bus_mutex_lock(lock: *mut mutex) -> bool {
    static inline bool bus_mutex_lock(struct mutex *lock)
    {
    let mut max_trying: c_int = W1_THERM_MAX_TRY;
...
//
#[no_mangle]
unsafe extern "C" fn check_family_data(sl: *mut w1_slave) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn bulk_read_support(sl: *mut w1_slave) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn conversion_time(sl: *mut w1_slave) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn temperature_from_RAM(sl: *mut w1_slave, rom[9]: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn int_to_short(i: c_int) -> i8 {
...
// Interface Functions
#[no_mangle]
unsafe extern "C" fn w1_therm_add_slave(sl: *mut w1_slave) -> c_int {
    static int w1_therm_add_slave(struct w1_slave *sl)
    {
...
#[no_mangle]
unsafe extern "C" fn w1_therm_remove_slave(sl: *mut w1_slave) {
    static void w1_therm_remove_slave(struct w1_slave *sl)
    {
    let mut refcnt: c_int = atomic_sub_return(1, THERM_REFCNT(sl.family_data));
    if (bulk_read_support(sl)) {
    bulk_read_device_counter--;
...
#[no_mangle]
unsafe extern "C" fn reset_select_slave(sl: *mut w1_slave) -> c_int {
    static int reset_select_slave(struct w1_slave *sl)
    {
...
//
#[no_mangle]
unsafe extern "C" fn w1_poll_completion(dev_master: *mut w1_master, tout_ms: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn convert_t(sl: *mut w1_slave, info: *mut therm_info) -> c_int {
    static int convert_t(struct w1_slave *sl, struct therm_info *info)
    {
...
#[no_mangle]
unsafe extern "C" fn conv_time_measure(sl: *mut w1_slave, conv_time: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_scratchpad(sl: *mut w1_slave, info: *mut therm_info) -> c_int {
    static int read_scratchpad(struct w1_slave *sl, struct therm_info *info)
    {
    struct w1_master *dev_master = sl.master;
    let mut max_trying: c_int = W1_THERM_MAX_TRY;
...
#[no_mangle]
unsafe extern "C" fn write_scratchpad(sl: *mut w1_slave, data: *const u8, nb_bytes: u8) -> c_int {
    static int write_scratchpad(struct w1_slave *sl, const u8 *data, u8 nb_bytes)
    {
    struct w1_master *dev_master = sl.master;
    let mut max_trying: c_int = W1_THERM_MAX_TRY;
...
#[no_mangle]
unsafe extern "C" fn copy_scratchpad(sl: *mut w1_slave) -> c_int {
    static int copy_scratchpad(struct w1_slave *sl)
    {
    struct w1_master *dev_master = sl.master;
    let mut max_trying: c_int = W1_THERM_MAX_TRY;
...
#[no_mangle]
unsafe extern "C" fn recall_eeprom(sl: *mut w1_slave) -> c_int {
    static int recall_eeprom(struct w1_slave *sl)
    {
    struct w1_master *dev_master = sl.master;
    let mut max_trying: c_int = W1_THERM_MAX_TRY;
...
#[no_mangle]
unsafe extern "C" fn read_powermode(sl: *mut w1_slave) -> c_int {
    static int read_powermode(struct w1_slave *sl)
    {
    struct w1_master *dev_master = sl.master;
    let mut max_trying: c_int = W1_THERM_MAX_TRY;
...
#[no_mangle]
unsafe extern "C" fn trigger_bulk_read(dev_master: *mut w1_master) -> c_int {
    static int trigger_bulk_read(struct w1_master *dev_master)
    {
    struct w1_slave *sl = core::ptr::null_mut(); /* used to iterate through slaves */
    let mut max_trying: c_int = W1_THERM_MAX_TRY;
    let mut t_conv: c_int = 0;
    let mut ret: c_int = -ENODEV;
    let mut strong_pullup: bool = false;
//
...
//
    ...
    goto error;
    if (bulk_read_support(sl)) {
    let mut t_cur: c_int = conversion_time(sl);
...
// Reset the conversion time to default because it depends on resolution
    ...
    ret = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(INT_MAX: temp < INT_MIN || temp >) -> else {
...
// Write data in the device RAM
    ...
    {
    struct w1_master *dev_master = dev_to_w1_master(device);
    struct w1_slave *sl = core::ptr::null_mut();
    let mut ret: c_int = 0;
    list_for_each_entry(sl, &dev_master.slist, w1_slave_entry) {
    if (sl.family_data) {
    if (bulk_read_support(sl)) {
...
pub const W1_42_CHAIN: c_uint = 0x99;
pub const W1_42_CHAIN_OFF: c_uint = 0x3C;
pub const W1_42_CHAIN_OFF_INV: c_uint = 0xC3;
pub const W1_42_CHAIN_ON: c_uint = 0x5A;
pub const W1_42_CHAIN_ON_INV: c_uint = 0xA5;
pub const W1_42_CHAIN_DONE: c_uint = 0x96;
pub const W1_42_CHAIN_DONE_INV: c_uint = 0x69;
pub const W1_42_COND_READ: c_uint = 0x0F;
pub const W1_42_SUCCESS_CONFIRM_BYTE: c_uint = 0xAA;
pub const W1_42_FINISHED_BYTE: c_uint = 0xFF;
    static ssize_t w1_seq_show(struct device *device,
    struct device_attribute *attr, char *buf)
    {
    struct w1_slave *sl = dev_to_w1_slave(device);
...
#[no_mangle]
unsafe extern "C" fn w1_therm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn w1_therm_fini() -> void __exit {
