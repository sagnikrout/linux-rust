...
//! Source: drivers/w1/slaves/w1_ds2805.c
#![no_std]
...
pub const W1_EEPROM_DS2805: c_uint = 0x0D;
pub const W1_F0D_EEPROM_SIZE: c_int = 128;
pub const W1_F0D_PAGE_BITS: c_int = 3;

pub const W1_F0D_PAGE_MASK: c_uint = 0x0F;
pub const W1_F0D_SCRATCH_BITS: c_int = 1;

pub const W1_F0D_READ_EEPROM: c_uint = 0xF0;
pub const W1_F0D_WRITE_EEPROM: c_uint = 0x55;
pub const W1_F0D_RELEASE: c_uint = 0xFF;
pub const W1_F0D_CS_OK: c_uint = 0xAA /* Chip Status Ok */;
pub const W1_F0D_TPROG_MS: c_int = 16;
pub const W1_F0D_READ_RETRIES: c_int = 10;
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_f0d_fix_count(off: loff_t, count: usize, size: usize) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn w1_f0d_readblock(sl: *mut w1_slave, off: c_int, count: c_int, buf: *mut c_char) -> c_int {
    static int w1_f0d_readblock(struct w1_slave *sl, int off, int count, char *buf)
    {
    u8 wrbuf[3];
    u8 cmp[W1_F0D_READ_MAXLEN];
    let mut tries: c_int = W1_F0D_READ_RETRIES;
    do {
...
//
#[no_mangle]
unsafe extern "C" fn w1_f0d_write(sl: *mut w1_slave, addr: c_int, len: c_int, data: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn w1_f0d_add_slave(sl: *mut w1_slave) -> c_int {
    static int w1_f0d_add_slave(struct w1_slave *sl)
    {
    return sysfs_create_bin_file(&sl.dev.kobj, &w1_f0d_bin_attr);
    }
#[no_mangle]
unsafe extern "C" fn w1_f0d_remove_slave(sl: *mut w1_slave) {
