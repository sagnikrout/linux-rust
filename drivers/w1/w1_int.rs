...
//
    ...
    let mut w1_enable_pullup: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn w1_free_dev(dev: *mut w1_master) {
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_add_master_device(master: *mut w1_bus_master) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __w1_remove_master_device(dev: *mut w1_master) {
...
//
#[no_mangle]
pub unsafe extern "C" fn w1_remove_master_device(bm: *mut w1_bus_master) {
    void w1_remove_master_device(struct w1_bus_master *bm)
    {
    struct w1_master *dev, *found = core::ptr::null_mut();
