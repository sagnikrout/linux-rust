...
//! Source: drivers/mmc/core/regulator.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn mmc_ocrbitnum_to_vdd(vdd_bit: c_int, min_uV: *mut c_int, max_uV: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_regulator_get_ocrmask(supply: *mut regulator) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_regulator_set_vqmmc(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_regulator_set_vqmmc2(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mmc_regulator_get_ocrmask(supply: *mut regulator) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mmc_undervoltage_workfn(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_regulator_register_undervoltage_notifier(host: *mut mmc_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_regulator_unregister_undervoltage_notifier(host: *mut mmc_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_regulator_get_supply(mmc: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_regulator_enable_vqmmc(mmc: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_regulator_disable_vqmmc(mmc: *mut mmc_host) {
