...
//! Source: drivers/mmc/core/sd_uhs2.c
#![no_std]
...
pub const UHS2_WAIT_CFG_COMPLETE_TIMEOUT_MS: c_int = 100;
    static const unsigned int sd_uhs2_freqs[] = { 52000000, 26000000 };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sd_uhs2_wait_active_state_data {
    pub host: *mut mmc_host,
    pub cmd: *mut mmc_command,
}

#[no_mangle]
unsafe extern "C" fn sd_uhs2_power_up(host: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_power_off(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_phy_init(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_dev_init(host: *mut mmc_host) -> c_int {
    static int sd_uhs2_dev_init(struct mmc_host *host)
    {
    let mut cmd: mmc_command = {0};
    let mut uhs2_cmd: uhs2_command = {};
    u32 cnt;
...
//
    ...
    ((gd & 0xF) << 4) |
    (gap & 0xF);
    uhs2_cmd.payload[0] = ( __be32)payload0;
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_enum(host: *mut mmc_host, node_id: *mut u32) -> c_int {
    static int sd_uhs2_enum(struct mmc_host *host, u32 *node_id)
    {
    let mut cmd: mmc_command = {0};
    let mut uhs2_cmd: uhs2_command = {};
    u32 payload0;
    let mut id_f: u8 = 0xF, id_l = 0x0;
    int err;
//
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_config_read(host: *mut mmc_host, card: *mut mmc_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_config_write(host: *mut mmc_host, card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_go_dormant(host: *mut mmc_host, node_id: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_wait_active_state_cb(cb_data: *mut c_void, busy: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_go_dormant_state(host: *mut mmc_host, node_id: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_init_card(host: *mut mmc_host, oldcard: *mut mmc_card) -> c_int {
...
//
    ...
    mmc_hostname(host));
#[no_mangle]
pub unsafe extern "C" fn if(0: ro >) -> else {
    else if (ro > 0)
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_reinit(host: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_remove(host: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_alive(host: *mut mmc_host) -> c_int {
    static int sd_uhs2_alive(struct mmc_host *host)
    {
    return mmc_send_status(host.card, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn sd_uhs2_detect(host: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn _sd_uhs2_suspend(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_suspend(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _mmc_sd_uhs2_resume(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_resume(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sd_uhs2_runtime_suspend(host: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_runtime_resume(host: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_hw_reset(host: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_uhs2_attach(host: *mut mmc_host) -> c_int {
    ...
    if (err)
    goto err;
    err = sd_uhs2_init_card(host, core::ptr::null_mut());
    if (err)
    goto err;
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_attach_sd_uhs2(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_uhs2_prepare_cmd(host: *mut mmc_host, mrq: *mut mmc_request) {
