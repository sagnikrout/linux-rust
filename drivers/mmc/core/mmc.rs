...
pub const DEFAULT_CMD6_TIMEOUT_MS: c_int = 500;
pub const MIN_CACHE_EN_TIMEOUT_MS: c_int = 1600;
...
//
#[no_mangle]
unsafe extern "C" fn mmc_decode_cid(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_set_erase_size(card: *mut mmc_card) {
...
#[no_mangle]
unsafe extern "C" fn mmc_set_wp_grp_size(card: *mut mmc_card) {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_decode_csd(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_select_card_type(card: *mut mmc_card) {
    static void mmc_select_card_type(struct mmc_card *card)
    {
    struct mmc_host *host = card.host;
    let mut card_type: u8 = card.ext_csd.raw_card_type;
    let mut caps: u32 = host.caps, caps2 = host.caps2;
    let mut hs_max_dtr: c_uint = 0, hs200_max_dtr = 0;
    let mut avail_type: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn mmc_manage_enhanced_area(card: *mut mmc_card, ext_csd: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn mmc_manage_gp_partitions(card: *mut mmc_card, ext_csd: *mut u8) {
...
pub const MMC_MIN_PART_SWITCH_TIME: c_int = 300;
//
// Decode extended CSD.
//
#[no_mangle]
unsafe extern "C" fn mmc_decode_ext_csd(card: *mut mmc_card, ext_csd: *mut u8) -> c_int {
    static int mmc_decode_ext_csd(struct mmc_card *card, u8 *ext_csd)
    {
    let mut err: c_int = 0, idx;
    u64 part_size;
    struct device_node *np;
    let mut broken_hpi: bool = false;
...
// Cards with density > 2GiB are sector addressed
    ...
    let mut sa_shift: u8 = ext_csd[EXT_CSD_S_A_TIMEOUT];
...
#[no_mangle]
unsafe extern "C" fn mmc_read_ext_csd(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_compare_ext_csds(card: *mut mmc_card, bus_width: unsigned) -> c_int {
...
// only compare read only fields
    ...
    static DEVICE_ATTR(fwrev, 0444, mmc_fwrev_show, core::ptr::null_mut());
...
// return default DSR value
    ...
    static DEVICE_ATTR(dsr, 0444, mmc_dsr_show, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(MMC_HIGH_52_MAX_DTR: host->ios.clock <=) -> else {
    else if (host.ios.clock <= MMC_HIGH_52_MAX_DTR)
    pwrclass_val = (bus_width <= EXT_CSD_BUS_WIDTH_8) ?
    ext_csd.raw_pwr_cl_52_195 :
    ext_csd.raw_pwr_cl_ddr_52_195;
#[no_mangle]
pub unsafe extern "C" fn if(MMC_HS200_MAX_DTR: host->ios.clock <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn mmc_select_powerclass(card: *mut mmc_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_set_bus_speed(card: *mut mmc_card) {
    static void mmc_set_bus_speed(struct mmc_card *card)
    {
    let mut max_dtr: c_uint = (unsigned int)-1;
    if ((mmc_card_hs200(card) || mmc_card_hs400(card)) &&
    max_dtr > card.ext_csd.hs200_max_dtr)
    max_dtr = card.ext_csd.hs200_max_dtr;
#[no_mangle]
pub unsafe extern "C" fn if(card->ext_csd.hs_max_dtr: mmc_card_hs(card) && max_dtr >) -> else {
    else if (mmc_card_hs(card) && max_dtr > card.ext_csd.hs_max_dtr)
    max_dtr = card.ext_csd.hs_max_dtr;
#[no_mangle]
pub unsafe extern "C" fn if(card->csd.max_dtr: max_dtr >) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_select_bus_width(card: *mut mmc_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_select_hs(card: *mut mmc_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_select_hs_ddr(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_select_hs400(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mmc_hs200_to_hs400(card: *mut mmc_card) -> c_int {
    int mmc_hs200_to_hs400(struct mmc_card *card)
    {
    return mmc_select_hs400(card);
    }
#[no_mangle]
pub unsafe extern "C" fn mmc_hs400_to_hs200(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_select_driver_type(card: *mut mmc_card) {
    static void mmc_select_driver_type(struct mmc_card *card)
    {
    int card_drv_type, drive_strength, drv_type = 0;
    let mut fixed_drv_type: c_int = card.host.fixed_drv_type;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: drv_type) -> else {
    else if (drv_type)
    mmc_set_driver_type(card.host, drv_type);
    }
#[no_mangle]
unsafe extern "C" fn mmc_select_hs400es(card: *mut mmc_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_select_hs200(card: *mut mmc_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_select_timing(card: *mut mmc_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_hs200_tuning(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mmc_card_can_trim(card)) -> else {
...
//
    ...
    let mut timeout_ms: c_uint = MIN_CACHE_EN_TIMEOUT_MS;
...
#[no_mangle]
unsafe extern "C" fn mmc_card_can_sleep(card: *mut mmc_card) -> bool {
    static bool mmc_card_can_sleep(struct mmc_card *card)
    {
    return card.ext_csd.rev >= 3;
    }
#[no_mangle]
unsafe extern "C" fn mmc_sleep_busy_cb(cb_data: *mut c_void, busy: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_sleep(host: *mut mmc_host) -> c_int {
    static int mmc_sleep(struct mmc_host *host)
    {
    let mut cmd: mmc_command = {};
    struct mmc_card *card = host.card;
    let mut timeout_ms: c_uint = DIV_ROUND_UP(card.ext_csd.sa_timeout, 10000);
    bool use_r1b_resp;
    int err;
...
#[no_mangle]
unsafe extern "C" fn mmc_card_can_poweroff_notify(card: *const mmc_card) -> bool {
    ...
    return true;
    let mut pm_type: return = = MMC_POWEROFF_SHUTDOWN;
    }
#[no_mangle]
unsafe extern "C" fn mmc_poweroff_notify(card: *mut mmc_card, notify_type: c_uint) -> c_int {
    static int mmc_poweroff_notify(struct mmc_card *card, unsigned int notify_type)
    {
    let mut timeout: c_uint = card.ext_csd.generic_cmd6_time;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn mmc_alive(host: *mut mmc_host) -> c_int {
    static int mmc_alive(struct mmc_host *host)
    {
    return mmc_send_status(host.card, core::ptr::null_mut());
    }
//
// Card detection callback from host.
//
#[no_mangle]
unsafe extern "C" fn mmc_detect(host: *mut mmc_host) {
    static void mmc_detect(struct mmc_host *host)
    {
    int err;
    mmc_get_card(host.card, core::ptr::null_mut());
//
// Just check if our card has been removed.
//
    err = _mmc_detect_card_removed(host);
    mmc_put_card(host.card, core::ptr::null_mut());
    if (err) {
    mmc_remove_card(host.card);
    host.card = core::ptr::null_mut();
    mmc_claim_host(host);
    mmc_detach_bus(host);
    mmc_power_off(host);
...
#[no_mangle]
unsafe extern "C" fn _mmc_cache_enabled(host: *mut mmc_host) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn _mmc_flush_cache(host: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _mmc_suspend(host: *mut mmc_host, pm_type: enum mmc_poweroff_type) -> c_int {
    static int _mmc_suspend(struct mmc_host *host, enum mmc_poweroff_type pm_type)
    {
    let mut notify_type: c_uint = EXT_CSD_POWER_OFF_SHORT;
    let mut err: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mmc_card_can_sleep(host->card)) -> else {
    else if (mmc_card_can_sleep(host.card))
    err = mmc_sleep(host);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !mmc_host_is_spi(host)) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_remove(host: *mut mmc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_suspend(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _mmc_resume(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_shutdown(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_resume(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_runtime_suspend(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_runtime_resume(host: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_card_can_reset(card: *mut mmc_card) -> bool {
...
#[no_mangle]
unsafe extern "C" fn _mmc_hw_reset(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _mmc_handle_undervoltage(host: *mut mmc_host) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn mmc_attach_mmc(host: *mut mmc_host) -> c_int {
...
//
    err = mmc_init_card(host, rocr, core::ptr::null_mut());
    if (err)
    goto err;
    mmc_release_host(host);
