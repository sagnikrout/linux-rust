...
//! Source: drivers/mmc/core/mmc_test.c
#![no_std]
...
pub const RESULT_FAIL: c_int = 1;
pub const RESULT_UNSUP_HOST: c_int = 2;
pub const RESULT_UNSUP_CARD: c_int = 3;
pub const BUFFER_ORDER: c_int = 2;

pub const TEST_ALIGN_END: c_int = 8;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_mem {
    pub cnt: c_uint,
    pub __counted_by(cnt): mmc_test_pages arr[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_area {
    pub max_sz: c_ulong,
    pub dev_addr: c_uint,
    pub max_tfr: c_uint,
    pub max_segs: c_uint,
    pub max_seg_sz: c_uint,
    pub blocks: c_uint,
    pub sg_len: c_uint,
    pub mem: *mut mmc_test_mem,
    pub sg: *mut scatterlist,
    pub sg_areq: *mut scatterlist,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_transfer_result {
    pub link: list_head,
    pub count: c_uint,
    pub sectors: c_uint,
    pub ts: timespec64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_general_result {
    pub link: list_head,
    pub card: *mut mmc_card,
    pub testcase: c_int,
    pub result: c_int,
    pub tr_lst: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_dbgfs_file {
    pub link: list_head,
    pub card: *mut mmc_card,
    pub file: *mut dentry,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_card {
    pub card: *mut mmc_card,
    pub scratch: [u8; BUFFER_SIZE],
    pub highmem: *mut page,

    pub area: mmc_test_area,
    pub gr: *mut mmc_test_general_result,
    pub buffer: [u8; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_multiple_rw {
    pub sg_len: *mut c_uint,
    pub bs: *mut c_uint,
    pub len: c_uint,
    pub size: c_uint,
    pub do_write: bool,
    pub do_nonblock_req: bool,
    pub prepare: enum mmc_test_prep_media,
}
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_set_blksize(test: *mut mmc_test_card, size: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_busy(cmd: *mut mmc_command) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_wait_busy(test: *mut mmc_test_card) -> c_int {
    static int mmc_test_wait_busy(struct mmc_test_card *test)
    {
    int ret, busy;
    let mut cmd: mmc_command = {};
    busy = 0;
    do {
...
//
    ...
    {
    let mut mrq: mmc_request = {};
    let mut cmd: mmc_command = {};
    let mut stop: mmc_command = {};
    let mut data: mmc_data = {};
...
#[no_mangle]
unsafe extern "C" fn mmc_test_free_mem(mem: *mut mmc_test_mem) {
...
//
    ...
    {
    let mut max_page_cnt: c_ulong = DIV_ROUND_UP(max_sz, PAGE_SIZE);
    let mut min_page_cnt: c_ulong = DIV_ROUND_UP(min_sz, PAGE_SIZE);
    let mut max_seg_page_cnt: c_ulong = DIV_ROUND_UP(max_seg_sz, PAGE_SIZE);
    let mut page_cnt: c_ulong = 0;
    let mut limit: c_ulong = nr_free_buffer_pages() >> 4;
...
// sg_len = 0;
    do {
    for (i = 0; i < mem.cnt; i++) {
    let mut len: c_ulong = PAGE_SIZE << mem.arr[i].order;
...
//
    ...
    {
    struct scatterlist *sg = core::ptr::null_mut();
    let mut i: c_uint = mem.cnt, cnt;
    unsigned long len;
    void *base, *addr, *last_addr = core::ptr::null_mut();
    sg_init_table(sglist, max_segs);
// sg_len = 0;
    while (sz) {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_rate(bytes: u64, ts: *mut timespec64) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_capacity(card: *mut mmc_card) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn __mmc_test_prepare(test: *mut mmc_test_card, write: c_int, val: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_prepare_write(test: *mut mmc_test_card) -> c_int {
    static int mmc_test_prepare_write(struct mmc_test_card *test)
    {
    return __mmc_test_prepare(test, 1, 0xDF);
    }
#[no_mangle]
unsafe extern "C" fn mmc_test_prepare_read(test: *mut mmc_test_card) -> c_int {
    static int mmc_test_prepare_read(struct mmc_test_card *test)
    {
    return __mmc_test_prepare(test, 0, 0);
    }
#[no_mangle]
unsafe extern "C" fn mmc_test_cleanup(test: *mut mmc_test_card) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_req {
    pub mrq: mmc_request,
    pub sbc: mmc_command,
    pub cmd: mmc_command,
    pub stop: mmc_command,
    pub status: mmc_command,
    pub data: mmc_data,
}
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_req_reset(rq: *mut mmc_test_req) {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_wait_done(mrq: *mut mmc_request) {
    ...
    ret = mmc_test_start_areq(test, core::ptr::null_mut(), prev_mrq);
    err:
    kfree(rq1);
    kfree(rq2);
    return ret;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_test_case {
    pub name: *const c_char,
    pub ): *mut *mut int (prepare)(struct mmc_test_card,
    pub ): *mut *mut int (run)(struct mmc_test_card,
    pub ): *mut *mut int (cleanup)(struct mmc_test_card,
}

#[no_mangle]
unsafe extern "C" fn mmc_test_basic_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_basic_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_verify_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_verify_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_multi_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_multi_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_pow2_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_pow2_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_weird_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_weird_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_align_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_align_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_align_multi_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_align_multi_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_xfersize_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_xfersize_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_multi_xfersize_write(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_multi_xfersize_read(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_write_high(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_read_high(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_multi_write_high(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_multi_read_high(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_no_highmem(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_area_fill(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_area_erase(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_area_cleanup(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_area_init(test: *mut mmc_test_card, erase: c_int, fill: c_int) -> c_int {
    static int mmc_test_area_init(struct mmc_test_card *test, int erase, int fill)
    {
    struct mmc_test_area *t = &test.area;
    let mut min_sz: c_ulong = SZ_64K, sz;
    int ret;
    ret = mmc_test_set_blksize(test, 512);
    if (ret)
    return ret;
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_area_prepare(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_area_prepare_erase(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_area_prepare_fill(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_best_read_performance(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_best_write_performance(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_best_read_perf_max_scatter(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_best_write_perf_max_scatter(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_read_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_write_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_trim_perf(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_seq_read_perf(test: *mut mmc_test_card, sz: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_seq_read_perf(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_seq_write_perf(test: *mut mmc_test_card, sz: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_seq_write_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_seq_trim_perf(test: *mut mmc_test_card) -> c_int {
    ...
    let mut rnd_next: static unsigned int = 1;
#[no_mangle]
unsafe extern "C" fn mmc_test_rnd_num(rnd_cnt: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_random_perf(test: *mut mmc_test_card, write: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_retuning(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_random_read_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_random_write_perf(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_large_seq_perf(test: *mut mmc_test_card, write: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_large_seq_read_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_large_seq_write_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_mult_write_blocking_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_mult_write_nonblock_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_mult_read_blocking_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_mult_read_nonblock_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_sglen_wr_blocking_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_sglen_wr_nonblock_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_sglen_r_blocking_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_profile_sglen_r_nonblock_perf(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_reset(test: *mut mmc_test_card) -> c_int {
...
// Start ongoing data request
    if (use_areq) {
    ret = mmc_test_start_areq(test, mrq, core::ptr::null_mut());
    if (ret)
    goto out_free;
    } else {
...
// Wait for data request to complete
    if (use_areq) {
    ret = mmc_test_start_areq(test, core::ptr::null_mut(), mrq);
    } else {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_cmds_during_read(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_cmds_during_write(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_cmds_during_read_cmd23(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_cmds_during_write_cmd23(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_cmds_during_read_cmd23_nonblock(test: *mut mmc_test_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mmc_test_cmds_during_write_cmd23_nonblock(test: *mut mmc_test_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_run(test: *mut mmc_test_card, testcase: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_free_result(card: *mut mmc_card) {
...
#[no_mangle]
unsafe extern "C" fn mtf_test_show(sf: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtf_test_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtf_testlist_show(sf: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_free_dbgfs_file(card: *mut mmc_card) {
    ...
    {
    struct dentry *file = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mmc_test_register_dbgfs_file(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_probe(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_remove(card: *mut mmc_card) {
...
#[no_mangle]
unsafe extern "C" fn mmc_test_init() -> int __init {
    static int __init mmc_test_init(void)
    {
    return mmc_register_driver(&mmc_driver);
    }
#[no_mangle]
unsafe extern "C" fn mmc_test_exit() -> void __exit {
    static void __exit mmc_test_exit(void)
    {
// Clear stalled data if card is still plugged
    mmc_test_free_result(core::ptr::null_mut());
    mmc_test_free_dbgfs_file(core::ptr::null_mut());
