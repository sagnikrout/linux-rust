...
//! Source: drivers/mmc/core/pwrseq_simple.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mmc_pwrseq_simple {
    pub pwrseq: mmc_pwrseq,
    pub clk_enabled: bool,
    pub post_power_on_delay_ms: u32,
    pub power_off_delay_us: u32,
    pub ext_clk: *mut clk,
    pub reset_gpios: *mut gpio_descs,
    ...
    let mut nvalues: c_int = reset_gpios.ndescs;
...
#[no_mangle]
unsafe extern "C" fn mmc_pwrseq_simple_pre_power_on(host: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn mmc_pwrseq_simple_post_power_on(host: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn mmc_pwrseq_simple_power_off(host: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn mmc_pwrseq_simple_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (ngpio == 1) {
    pwrseq.reset_ctrl = devm_reset_control_get_optional_shared(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn mmc_pwrseq_simple_remove(pdev: *mut platform_device) {
