...
//! Source: drivers/mmc/core/debugfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mmc_ios_show(s: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: ios->vdd < (ARRAY_SIZE(vdd_str) -) -> else {
...
#[no_mangle]
unsafe extern "C" fn mmc_clock_opt_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_clock_opt_set(data: *mut c_void, val: u64) -> c_int {
...
// We need this check due to input value is u64
    ...
    "%llu\n");
#[no_mangle]
unsafe extern "C" fn mmc_err_state_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = 1;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(mmc_err_state, mmc_err_state_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn mmc_err_stats_show(file: *mut seq_file, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_err_stats_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_caps_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_caps_set(data: *mut c_void, val: u64) -> c_int {
    static int mmc_caps_set(void *data, u64 val)
    {
    u32 *caps = data;
    let mut diff: u32 = *caps ^ val;
...
#[no_mangle]
unsafe extern "C" fn mmc_caps2_set(data: *mut c_void, val: u64) -> c_int {
...
// caps = val;
    ...
    "0x%08llx\n");
#[no_mangle]
pub unsafe extern "C" fn mmc_add_host_debugfs(host: *mut mmc_host) {
    void mmc_add_host_debugfs(struct mmc_host *host)
    {
    struct dentry *root;
    root = debugfs_create_dir(mmc_hostname(host), core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn mmc_remove_host_debugfs(host: *mut mmc_host) {
    void mmc_remove_host_debugfs(struct mmc_host *host)
    {
    debugfs_remove_recursive(host.debugfs_root);
    }
#[no_mangle]
pub unsafe extern "C" fn mmc_add_card_debugfs(card: *mut mmc_card) {
...
#[no_mangle]
pub unsafe extern "C" fn mmc_remove_card_debugfs(card: *mut mmc_card) {
