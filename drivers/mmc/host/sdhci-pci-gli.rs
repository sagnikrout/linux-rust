...
//! Source: drivers/mmc/host/sdhci-pci-gli.c
#![no_std]
...
pub const SDHCI_GLI_9750_WT: c_uint = 0x800;

pub const GLI_9750_WT_EN_ON: c_uint = 0x1;
pub const GLI_9750_WT_EN_OFF: c_uint = 0x0;
pub const SDHCI_GLI_9750_CFG2: c_uint = 0x848;

pub const GLI_9750_CFG2_L1DLY_VALUE: c_uint = 0x1F;
pub const SDHCI_GLI_9750_DRIVING: c_uint = 0x860;

pub const GLI_9750_DRIVING_1_VALUE: c_uint = 0xFFF;
pub const GLI_9750_DRIVING_2_VALUE: c_uint = 0x3;

pub const SDHCI_GLI_9750_PLL: c_uint = 0x864;

pub const GLI_9750_PLL_TX2_INV_VALUE: c_uint = 0x1;
pub const GLI_9750_PLL_TX2_DLY_VALUE: c_uint = 0x0;

pub const SDHCI_GLI_9750_PLLSSC: c_uint = 0x86C;

pub const SDHCI_GLI_9750_SW_CTRL: c_uint = 0x874;

pub const GLI_9750_SW_CTRL_4_VALUE: c_uint = 0x3;
pub const SDHCI_GLI_9750_MISC: c_uint = 0x878;

pub const GLI_9750_MISC_TX1_INV_VALUE: c_uint = 0x0;
pub const GLI_9750_MISC_RX_INV_ON: c_uint = 0x1;
pub const GLI_9750_MISC_RX_INV_OFF: c_uint = 0x0;

pub const GLI_9750_MISC_TX1_DLY_VALUE: c_uint = 0x5;

pub const SDHCI_GLI_9750_GM_BURST_SIZE: c_uint = 0x510;

pub const SDHCI_GLI_9750_TUNING_CONTROL: c_uint = 0x540;

pub const GLI_9750_TUNING_CONTROL_EN_ON: c_uint = 0x1;
pub const GLI_9750_TUNING_CONTROL_EN_OFF: c_uint = 0x0;

pub const GLI_9750_TUNING_CONTROL_GLITCH_1_VALUE: c_uint = 0x1;
pub const GLI_9750_TUNING_CONTROL_GLITCH_2_VALUE: c_uint = 0x2;
pub const SDHCI_GLI_9750_TUNING_PARAMETERS: c_uint = 0x544;

pub const GLI_9750_TUNING_PARAMETERS_RX_DLY_VALUE: c_uint = 0x1;
pub const SDHCI_GLI_9763E_CTRL_HS400: c_uint = 0x7;
pub const SDHCI_GLI_9763E_HS400_ES_REG: c_uint = 0x52C;

pub const PCIE_GLI_9763E_VHS: c_uint = 0x884;

pub const GLI_9763E_VHS_REV_R: c_uint = 0x0;
pub const GLI_9763E_VHS_REV_M: c_uint = 0x1;
pub const GLI_9763E_VHS_REV_W: c_uint = 0x2;
pub const PCIE_GLI_9763E_MB: c_uint = 0x888;

pub const PCIE_GLI_9763E_SCR: c_uint = 0x8E0;

pub const PCIE_GLI_9763E_CFG: c_uint = 0x8A0;

pub const PCIE_GLI_9763E_CFG2: c_uint = 0x8A4;

pub const GLI_9763E_CFG2_L1DLY_MID: c_uint = 0x54;
pub const PCIE_GLI_9763E_MMC_CTRL: c_uint = 0x960;

pub const PCIE_GLI_9763E_CLKRXDLY: c_uint = 0x934;

pub const GLI_9763E_HS400_RXDLY_5: c_uint = 0x5;
pub const SDHCI_GLI_9763E_CQE_BASE_ADDR: c_uint = 0x200;

    SDHCI_TRNS_BLK_CNT_EN | \
    SDHCI_TRNS_DMA)
pub const PCI_GLI_9755_WT: c_uint = 0x800;

pub const GLI_9755_WT_EN_ON: c_uint = 0x1;
pub const GLI_9755_WT_EN_OFF: c_uint = 0x0;
pub const PCI_GLI_9755_PECONF: c_uint = 0x44;

pub const PCI_GLI_9755_CFG2: c_uint = 0x48;

pub const GLI_9755_CFG2_L1DLY_VALUE: c_uint = 0x1F;
pub const PCI_GLI_9755_PLL: c_uint = 0x64;

pub const PCI_GLI_9755_PLLSSC: c_uint = 0x68;

pub const GLI_9755_PLLSSC_RTL_VALUE: c_uint = 0x1;

pub const GLI_9755_PLLSSC_TRANS_PASS_VALUE: c_uint = 0x1;

pub const GLI_9755_PLLSSC_RECV_VALUE: c_uint = 0x0;

pub const GLI_9755_PLLSSC_TRAN_VALUE: c_uint = 0x3;
pub const PCI_GLI_9755_UHS2_PLL: c_uint = 0x6C;

pub const GLI_9755_UHS2_PLL_SSC_VALUE: c_uint = 0x0;

pub const GLI_9755_UHS2_PLL_DELAY_VALUE: c_uint = 0x1;

pub const GLI_9755_UHS2_PLL_PDRST_VALUE: c_uint = 0x1;
pub const PCI_GLI_9755_SerDes: c_uint = 0x70;

pub const GLI_9755_UHS2_SERDES_INTR_VALUE: c_uint = 0x3;

pub const GLI_9755_UHS2_SERDES_ZC1_VALUE: c_uint = 0x0;

pub const GLI_9755_UHS2_SERDES_ZC2_DEFAULT: c_uint = 0xB;
pub const GLI_9755_UHS2_SERDES_ZC2_SANDISK: c_uint = 0x0;

pub const GLI_9755_UHS2_SERDES_TRAN_VALUE: c_uint = 0xC;

pub const GLI_9755_UHS2_SERDES_RECV_VALUE: c_uint = 0xF;
pub const PCI_GLI_9755_MISC: c_uint = 0x78;

pub const SDHCI_GLI_9767_SD_HOST_OPERATION_CTL: c_uint = 0x508;

pub const SDHCI_GLI_9767_SD_HOST_OPERATION_CTL_DEBOUNCE_PLUG_IN_VALUE: c_uint = 0x05;
pub const SDHCI_GLI_9767_SD_HOST_OPERATION_CTL_DEBOUNCE_PLUG_OUT_VALUE: c_uint = 0x3F;

pub const SDHCI_GLI_9767_SD_HOST_OPERATION_CTL_DEBOUNCE_SCALE_1MS: c_uint = 0x2;
pub const SDHCI_GLI_9767_SD_HOST_OPERATION_CTL_DEBOUNCE_SCALE_10MS: c_uint = 0x3;
pub const SDHCI_GLI_9767_GM_BURST_SIZE: c_uint = 0x510;

pub const PCIE_GLI_9767_VHS: c_uint = 0x884;

pub const GLI_9767_VHS_REV_R: c_uint = 0x0;
pub const GLI_9767_VHS_REV_M: c_uint = 0x1;
pub const GLI_9767_VHS_REV_W: c_uint = 0x2;
pub const PCIE_GLI_9767_COM_MAILBOX: c_uint = 0x888;

pub const PCIE_GLI_9767_CFG: c_uint = 0x8A0;

pub const PCIE_GLI_9767_COMBO_MUX_CTL: c_uint = 0x8C8;

pub const PCIE_GLI_9767_PWR_MACRO_CTL: c_uint = 0x8D0;

pub const PCIE_GLI_9767_PWR_MACRO_CTL_LD0_LOW_OUTPUT_VOLTAGE_VALUE: c_uint = 0x7;

pub const PCIE_GLI_9767_PWR_MACRO_CTL_RCLK_AMPLITUDE_CTL_VALUE: c_uint = 0x3;
pub const PCIE_GLI_9767_SCR: c_uint = 0x8E0;

pub const PCIE_GLI_9767_RESET_REG: c_uint = 0x8E4;

pub const PCIE_GLI_9767_UHS2_PHY_SET_REG1: c_uint = 0x90C;

pub const PCIE_GLI_9767_UHS2_PHY_SET_REG1_SERDES_INTR_VALUE: c_uint = 0x3;
pub const PCIE_GLI_9767_SDHC_CAP: c_uint = 0x91C;

pub const PCIE_GLI_9767_SD_PLL_CTL: c_uint = 0x938;

pub const PCIE_GLI_9767_SD_PLL_CTL2: c_uint = 0x93C;

pub const PCIE_GLI_9767_SD_EXPRESS_CTL: c_uint = 0x940;

pub const PCIE_GLI_9767_SD_DATA_MULTI_CTL: c_uint = 0x944;

pub const PCIE_GLI_9767_SD_DATA_MULTI_CTL_DISCONNECT_TIME_VALUE: c_uint = 0x64;
pub const PCIE_GLI_9767_UHS2_PHY_SET_REG2: c_uint = 0x948;

pub const PCIE_GLI_9767_UHS2_PHY_SET_REG2_SSC_PPM_SETTING_VALUE: c_uint = 0x0;
pub const PCIE_GLI_9767_NORMAL_ERR_INT_STATUS_REG2: c_uint = 0x950;

pub const PCIE_GLI_9767_NORMAL_ERR_INT_STATUS_EN_REG2: c_uint = 0x954;

pub const PCIE_GLI_9767_NORMAL_ERR_INT_SIGNAL_EN_REG2: c_uint = 0x958;

pub const PCIE_GLI_9767_UHS2_CTL1: c_uint = 0x95C;

pub const PCIE_GLI_9767_UHS2_CTL1_TRANS_PASS_VALUE: c_uint = 0x1;

pub const PCIE_GLI_9767_UHS2_CTL1_DECODING_CTL_VALUE: c_uint = 0x1;

pub const PCIE_GLI_9767_UHS2_CTL1_SERDES_TRAN_VALUE: c_uint = 0x3;

pub const PCIE_GLI_9767_UHS2_CTL1_SERDES_RECV_VALUE: c_uint = 0xf;

pub const PCIE_GLI_9767_UHS2_CTL1_DIR_TRANS_VALUE: c_uint = 0x0;

pub const PCIE_GLI_9767_UHS2_CTL1_DIR_RECV_VALUE: c_uint = 0x0;

pub const PCIE_GLI_9767_UHS2_CTL1_PDRST_VALUE: c_uint = 0x1;
pub const PCIE_GLI_9767_UHS2_CTL2: c_uint = 0x964;

pub const PCIE_GLI_9767_UHS2_CTL2_ZC_VALUE: c_uint = 0xb;

pub const PCIE_GLI_9767_UHS2_CTL2_ZC_CTL_VALUE: c_uint = 0x1;

pub const GLI_MAX_TUNING_LOOP: c_int = 40;
// Genesys Logic chipset
#[no_mangle]
unsafe extern "C" fn sdhci_gli_mask_replay_timer_timeout(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn gl9750_wt_on(host: *mut sdhci_host) {
...
#[no_mangle]
pub unsafe extern "C" fn gl9750_wt_off(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn gli_set_9750(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn gli_set_9750_rx_inv(host: *mut sdhci_host, b: bool) {
...
#[no_mangle]
unsafe extern "C" fn __sdhci_execute_tuning_9750(host: *mut sdhci_host, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gl9750_execute_tuning(host: *mut sdhci_host, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gl9750_disable_ssc_pll(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn gl9750_set_pll(host: *mut sdhci_host, dir: u8, ldiv: u16, pdiv: u8) {
...
#[no_mangle]
unsafe extern "C" fn gl9750_ssc_enable(host: *mut sdhci_host) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gl9750_set_ssc(host: *mut sdhci_host, enable: u8, step: u8, ppm: u16) {
...
#[no_mangle]
unsafe extern "C" fn gl9750_set_ssc_pll_205mhz(host: *mut sdhci_host) {
    static void gl9750_set_ssc_pll_205mhz(struct sdhci_host *host)
    {
    let mut enable: bool = gl9750_ssc_enable(host);
// set pll to 205MHz and ssc
    gl9750_set_ssc(host, enable, 0xF, 0x5A1D);
    gl9750_set_pll(host, 0x1, 0x246, 0x0);
    }
#[no_mangle]
unsafe extern "C" fn gl9750_set_ssc_pll_100mhz(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn gl9750_set_ssc_pll_50mhz(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9750_set_clock(host: *mut sdhci_host, clock: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gl9750_hw_setting(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn gli_pcie_enable_msi(slot: *mut sdhci_pci_slot) {
...
#[no_mangle]
pub unsafe extern "C" fn gl9755_wt_on(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn gl9755_wt_off(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn gl9755_disable_ssc_pll(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn gl9755_set_pll(pdev: *mut pci_dev, dir: u8, ldiv: u16, pdiv: u8) {
...
#[no_mangle]
unsafe extern "C" fn gl9755_ssc_enable(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gl9755_set_ssc(pdev: *mut pci_dev, enable: u8, step: u8, ppm: u16) {
...
#[no_mangle]
unsafe extern "C" fn gl9755_set_ssc_pll_205mhz(pdev: *mut pci_dev) {
    static void gl9755_set_ssc_pll_205mhz(struct pci_dev *pdev)
    {
    let mut enable: bool = gl9755_ssc_enable(pdev);
// set pll to 205MHz and ssc
    gl9755_set_ssc(pdev, enable, 0xF, 0x5A1D);
    gl9755_set_pll(pdev, 0x1, 0x246, 0x0);
    }
#[no_mangle]
unsafe extern "C" fn gl9755_set_ssc_pll_100mhz(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn gl9755_set_ssc_pll_50mhz(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9755_set_clock(host: *mut sdhci_host, clock: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn gl9755_hw_setting(slot: *mut sdhci_pci_slot) {
...
#[no_mangle]
unsafe extern "C" fn gl9755_vendor_init(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gli_pre_detect_init(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gli_overcurrent_event_enable(host: *mut sdhci_host, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_wait_clock_stable(host: *mut sdhci_host) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gli_enable_internal_clock(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gli_wait_software_reset_done(host: *mut sdhci_host, mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gli_uhs2_reset_sd_tran(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9755_reset(host: *mut sdhci_host, mask: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn gl9767_vhs_read(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn gl9767_vhs_write(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn gl9767_ssc_enable(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn gl9767_set_ssc(pdev: *mut pci_dev, enable: u8, step: u8, ppm: u16) {
...
#[no_mangle]
unsafe extern "C" fn gl9767_set_pll(pdev: *mut pci_dev, dir: u8, ldiv: u16, pdiv: u8) {
...
#[no_mangle]
unsafe extern "C" fn gl9767_set_ssc_pll_205mhz(pdev: *mut pci_dev) {
    static void gl9767_set_ssc_pll_205mhz(struct pci_dev *pdev)
    {
    let mut enable: bool = gl9767_ssc_enable(pdev);
// set pll to 205MHz and ssc
    gl9767_set_ssc(pdev, enable, 0x1F, 0xF5C3);
    gl9767_set_pll(pdev, 0x1, 0x246, 0x0);
    }
#[no_mangle]
unsafe extern "C" fn gl9767_disable_ssc_pll(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn gl9767_set_low_power_negotiation(pdev: *mut pci_dev, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9767_uhs2_phy_reset(host: *mut sdhci_host, assert: bool) {
...
#[no_mangle]
unsafe extern "C" fn __gl9767_uhs2_set_power(host: *mut sdhci_host, mode: c_uchar, vdd: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9767_set_clock(host: *mut sdhci_host, clock: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9767_set_card_detect_debounce_time(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9767_card_event(host: *mut sdhci_host) {
    static void sdhci_gl9767_card_event(struct sdhci_host *host)
    {
    sdhci_gl9767_set_card_detect_debounce_time(host);
    }
#[no_mangle]
unsafe extern "C" fn gli_set_9767(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn gl9767_hw_setting(slot: *mut sdhci_pci_slot) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9767_reset(host: *mut sdhci_host, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn gl9767_init_sd_express(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gl9767_vendor_init(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9767_set_power(host: *mut sdhci_host, mode: c_uchar, vdd: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn gli_probe_slot_gl9750(slot: *mut sdhci_pci_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gli_probe_slot_gl9755(slot: *mut sdhci_pci_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gli_probe_slot_gl9767(slot: *mut sdhci_pci_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gli_voltage_switch(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9767_voltage_switch(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9750_reset(host: *mut sdhci_host, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9750_readl(host: *mut sdhci_host, reg: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(MMC_TIMING_MMC_HS: timing ==) -> else {
    else if (timing == MMC_TIMING_MMC_HS)
    ctrl_2 |= SDHCI_CTRL_UHS_SDR25;
#[no_mangle]
pub unsafe extern "C" fn if(MMC_TIMING_MMC_DDR52: timing ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9763e_dumpregs(mmc: *mut mmc_host) {
    static void sdhci_gl9763e_dumpregs(struct mmc_host *mmc)
    {
    sdhci_dumpregs(mmc_priv(mmc));
    }
#[no_mangle]
unsafe extern "C" fn sdhci_gl9763e_cqe_pre_enable(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9763e_cqe_enable(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9763e_cqhci_irq(host: *mut sdhci_host, intmask: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gl9763e_cqe_post_disable(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn gl9763e_add_host(slot: *mut sdhci_pci_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gl9763e_hw_setting(slot: *mut sdhci_pci_slot) {
...
#[no_mangle]
unsafe extern "C" fn gl9763e_runtime_suspend(chip: *mut sdhci_pci_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gl9763e_runtime_resume(chip: *mut sdhci_pci_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_pci_gli_resume(chip: *mut sdhci_pci_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gl9763e_resume(chip: *mut sdhci_pci_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gl9763e_suspend(chip: *mut sdhci_pci_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gli_probe_slot_gl9763e(slot: *mut sdhci_pci_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_gli_readw(host: *mut sdhci_host, reg: c_int) -> u16 {
    static u16 sdhci_gli_readw(struct sdhci_host *host, int reg)
    {
    let mut val: u32 = readl(host.ioaddr + (reg & ~3));
    u16 word;
    word = (val >> REG_OFFSET_IN_BITS(reg)) & 0xffff;
    return word;
    }
#[no_mangle]
unsafe extern "C" fn sdhci_gli_readb(host: *mut sdhci_host, reg: c_int) -> u8 {
    static u8 sdhci_gli_readb(struct sdhci_host *host, int reg)
    {
    let mut val: u32 = readl(host.ioaddr + (reg & ~3));
    let mut byte: u8 = (val >> REG_OFFSET_IN_BITS(reg)) & 0xff;
    return byte;
    }
