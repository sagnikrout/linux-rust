...
//! Source: drivers/mmc/host/sdhci-acpi.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_acpi_chip {
    pub ops: *const sdhci_ops,
    pub quirks: c_uint,
    pub quirks2: c_uint,
    pub caps: c_ulong,
    pub caps2: c_uint,
    pub pm_caps: mmc_pm_flag_t,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_acpi_slot {
    pub chip: *const sdhci_acpi_chip,
    pub quirks: c_uint,
    pub quirks2: c_uint,
    pub caps: c_ulong,
    pub caps2: c_uint,
    ...
    pub flags: c_uint,
    pub priv_size: usize,
    pub ): *mut *mut *mut int (probe_slot)(struct platform_device , struct acpi_device,
    pub ): *mut *mut int (remove_slot)(struct platform_device,
    pub pdev): *mut *mut int (free_slot)(struct platform_device,
    pub pdev): *mut *mut int (setup_host)(struct platform_device,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_acpi_host {
    pub host: *mut sdhci_host,
    pub slot: *const sdhci_acpi_slot,
    pub pdev: *mut platform_device,
    pub use_runtime_pm: bool,
    pub is_intel: bool,
    pub reset_signal_volt_on_suspend: bool,
...
#[no_mangle]
pub unsafe extern "C" fn sdhci_acpi_flag(c: *mut sdhci_acpi_host, flag: c_uint) -> bool {
...
pub struct intel_host {
    ...
    let mut err: c_int = 0;
    obj = acpi_evaluate_dsm(ACPI_HANDLE(dev), &intel_dsm_guid, 0, fn, core::ptr::null_mut());
    if (!obj)
    return -EOPNOTSUPP;
    if (obj.type == ACPI_TYPE_INTEGER) {
// result = obj->integer.value;
    } else if (obj.type == ACPI_TYPE_BUFFER && obj.buffer.length > 0) {
    let mut len: usize = min_t(size_t, obj.buffer.length, 4);
// result = 0;
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_int_hw_reset(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_byt_setting(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_byt_defer(dev: *mut device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sdhci_acpi_byt_setting(dev: *mut device) {
    static inline void sdhci_acpi_byt_setting(struct device *dev)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn sdhci_acpi_byt_defer(dev: *mut device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn intel_probe_slot(pdev: *mut platform_device, adev: *mut acpi_device) -> c_int {
    ...
    if (acpi_dev_hid_uid_match(adev, "80865ACA", core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn intel_setup_host(pdev: *mut platform_device) -> c_int {
...
pub const VENDOR_SPECIFIC_PWRCTL_CLEAR_REG: c_uint = 0x1a8;
pub const VENDOR_SPECIFIC_PWRCTL_CTL_REG: c_uint = 0x1ac;
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_qcom_handler(irq: c_int, ptr: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qcom_probe_slot(pdev: *mut platform_device, adev: *mut acpi_device) -> c_int {
...
// irq = -EINVAL;
    if (!acpi_dev_hid_uid_match(adev, "QCOM8051", core::ptr::null_mut()))
    return 0;
// irq = platform_get_irq(pdev, 1);
    if (*irq < 0)
    return 0;
    return request_threaded_irq(*irq, core::ptr::null_mut(), sdhci_acpi_qcom_handler,
    IRQF_ONESHOT | IRQF_TRIGGER_HIGH,
    "sdhci_qcom", host);
    }
#[no_mangle]
unsafe extern "C" fn qcom_free_slot(pdev: *mut platform_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_sdhci_host {
    pub tuned_clock: bool,
    pub dll_enabled: bool,
}

// AMD sdhci reset dll register.
pub const SDHCI_AMD_RESET_DLL_REGISTER: c_uint = 0x908;
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_amd_hs400_dll(host: *mut sdhci_host, enable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn amd_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
    static void amd_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
    {
    struct sdhci_host *host = mmc_priv(mmc);
    struct sdhci_acpi_host *acpi_host = sdhci_priv(host);
    struct amd_sdhci_host *amd_host = sdhci_acpi_priv(acpi_host);
    let mut old_timing: c_uint = host.timing;
    u16 val;
...
#[no_mangle]
unsafe extern "C" fn amd_sdhci_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_acpi_uid_slot {
    ...
    { "80865ACA", core::ptr::null_mut(), &sdhci_acpi_slot_int_sd },
    { "80865ACC", core::ptr::null_mut(), &sdhci_acpi_slot_int_emmc },
    { "80865AD0", core::ptr::null_mut(), &sdhci_acpi_slot_int_sdio },
    { "80860F14" , "1" , &sdhci_acpi_slot_int_emmc },
    { "80860F14" , "2" , &sdhci_acpi_slot_int_sdio },
    { "80860F14" , "3" , &sdhci_acpi_slot_int_sd   },
    { "80860F16" , core::ptr::null_mut(), &sdhci_acpi_slot_int_sd   },
    { "INT33BB"  , "2" , &sdhci_acpi_slot_int_sdio },
    { "INT33BB"  , "3" , &sdhci_acpi_slot_int_sd },
    { "INT33C6"  , core::ptr::null_mut(), &sdhci_acpi_slot_int_sdio },
    { "INT3436"  , core::ptr::null_mut(), &sdhci_acpi_slot_int_sdio },
    { "INT344D"  , core::ptr::null_mut(), &sdhci_acpi_slot_int_sdio },
    { "PNP0FFF"  , "3" , &sdhci_acpi_slot_int_sd   },
    { "PNP0D40"  },
    { "QCOM8051", core::ptr::null_mut(), &sdhci_acpi_slot_qcom_sd_3v },
    { "QCOM8052", core::ptr::null_mut(), &sdhci_acpi_slot_qcom_sd },
    { "AMDI0040", core::ptr::null_mut(), &sdhci_acpi_slot_amd_emmc },
    { "AMDI0041", core::ptr::null_mut(), &sdhci_acpi_slot_amd_emmc },
    { },
    };
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_probe(pdev: *mut platform_device) -> c_int {
...
// Power on the SDHCI controller and its children
    ...
    let mut v: bool = sdhci_acpi_flag(c, SDHCI_ACPI_SD_CD_OVERRIDE_LEVEL);
    if (quirks & DMI_QUIRK_SD_CD_ACTIVE_HIGH)
    host.mmc.caps2 |= MMC_CAP2_CD_ACTIVE_HIGH;
    err = mmc_gpiod_request_cd(host.mmc, core::ptr::null_mut(), 0, v, 0);
    if (err) {
    if (err == -EPROBE_DEFER)
    goto err_free;
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_reset_signal_voltage_if_needed(dev: *mut device) {
    ...
    struct intel_host *intel_host = sdhci_acpi_priv(c);
    let mut fn: c_uint = INTEL_DSM_V33_SWITCH;
    let mut result: u32 = 0;
    intel_dsm(intel_host, dev, fn, &result);
    }
    }
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_acpi_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(sdhci_acpi_runtime_suspend, sdhci_acpi_runtime_resume, core::ptr::null_mut())
    };
