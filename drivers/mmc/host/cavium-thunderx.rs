...
//! Source: drivers/mmc/host/cavium-thunderx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn thunder_mmc_acquire_bus(host: *mut cvm_mmc_host) {
    static void thunder_mmc_acquire_bus(struct cvm_mmc_host *host)
    {
    down(&host.mmc_serializer);
    }
#[no_mangle]
unsafe extern "C" fn thunder_mmc_release_bus(host: *mut cvm_mmc_host) {
    static void thunder_mmc_release_bus(struct cvm_mmc_host *host)
    {
    up(&host.mmc_serializer);
    }
#[no_mangle]
unsafe extern "C" fn thunder_mmc_int_enable(host: *mut cvm_mmc_host, val: u64) {
...
//
    ...
    host.slot_pdev[i] = of_platform_device_create(child_node, core::ptr::null_mut(),
    &pdev.dev);
    if (!host.slot_pdev[i])
    continue;
...
#[no_mangle]
unsafe extern "C" fn thunder_mmc_remove(pdev: *mut pci_dev) {
