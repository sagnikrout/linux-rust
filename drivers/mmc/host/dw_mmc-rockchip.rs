...
//! Source: drivers/mmc/host/dw_mmc-rockchip.c
#![no_std]
...
pub const RK3288_CLKGEN_DIV: c_int = 2;
pub const SDMMC_TIMING_CON0: c_uint = 0x130;
pub const SDMMC_TIMING_CON1: c_uint = 0x134;
pub const SDMMC_MISC_CON: c_uint = 0x138;

pub const ROCKCHIP_MMC_DEGREE_MASK: c_uint = 0x3;
pub const ROCKCHIP_MMC_DEGREE_OFFSET: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dw_mci_rockchip_priv_data {
    pub drv_clk: *mut clk,
    pub sample_clk: *mut clk,
    pub default_sample_phase: c_int,
    pub num_phases: c_int,
    pub internal_phase: bool,
    pub sample_phase: c_int,
    pub drv_phase: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn rockchip_mmc_get_internal_phase(host: *mut dw_mci, sample: bool) -> c_int {
    static int rockchip_mmc_get_internal_phase(struct dw_mci *host, bool sample)
    {
    let mut rate: c_ulong = clk_get_rate(host.ciu_clk) / RK3288_CLKGEN_DIV;
    u32 raw_value;
    u16 degrees;
...
#[no_mangle]
unsafe extern "C" fn rockchip_mmc_get_phase(host: *mut dw_mci, sample: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_mmc_set_internal_phase(host: *mut dw_mci, sample: bool, degrees: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_mmc_set_phase(host: *mut dw_mci, sample: bool, degrees: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rk3288_set_ios(host: *mut dw_mci, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rk3288_execute_tuning(host: *mut dw_mci, opcode: u32) -> c_int {
...
pub struct range_t {
    pub start: c_int,
    pub /: *mut *mut int end; / inclusive,
}

    struct range_t *ranges;
    let mut range_count: c_uint = 0;
    let mut longest_range_len: c_int = -1;
    let mut longest_range: c_int = -1;
    int middle_phase;
    int phase;
    if (IS_ERR(priv.sample_clk)) {
...
// Try each phase and extract good ranges
    ...
    i,
    priv.num_phases));
    v = !mmc_send_tuning(mmc, opcode, core::ptr::null_mut());
    if (i == 0)
    first_v = v;
    if ((!prev_v) && v) {
    range_count++;
...
// Find the longest range
    ...
    let mut len: c_int = (ranges[i].end - ranges[i].start + 1);
    if (len < 0)
    len += priv.num_phases;
...
#[no_mangle]
unsafe extern "C" fn dw_mci_common_parse_dt(host: *mut dw_mci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rk2928_parse_dt(host: *mut dw_mci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rk3288_parse_dt(host: *mut dw_mci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rk3576_parse_dt(host: *mut dw_mci) -> c_int {
    static int dw_mci_rk3576_parse_dt(struct dw_mci *host)
    {
    struct dw_mci_rockchip_priv_data *priv;
    let mut err: c_int = dw_mci_common_parse_dt(host);
    if (err)
    return err;
    priv = host.priv;
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rockchip_init(host: *mut dw_mci) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rockchip_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rockchip_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rockchip_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dw_mci_rockchip_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(dw_mci_rockchip_runtime_suspend, dw_mci_rockchip_runtime_resume, core::ptr::null_mut())
    };
