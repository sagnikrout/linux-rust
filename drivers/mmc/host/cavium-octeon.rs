...
//! Source: drivers/mmc/host/cavium-octeon.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn l2c_lock_line(addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn l2c_unlock_line(addr: u64) {
...
#[no_mangle]
unsafe extern "C" fn l2c_lock_mem_region(start: u64, len: u64) {
...
#[no_mangle]
unsafe extern "C" fn l2c_unlock_mem_region(start: u64, len: u64) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mmc_acquire_bus(host: *mut cvm_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mmc_release_bus(host: *mut cvm_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mmc_int_enable(host: *mut cvm_mmc_host, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mmc_set_shared_power(host: *mut cvm_mmc_host, dir: c_int) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mmc_dmar_fixup_done(host: *mut cvm_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn octeon_mmc_probe(pdev: *mut platform_device) -> c_int {
...
// Only CMD_DONE, DMA_DONE, CMD_ERR, DMA_ERR
    ...
    host.slot_pdev[i] =
    of_platform_device_create(cn, core::ptr::null_mut(), &pdev.dev);
    if (!host.slot_pdev[i]) {
    i++;
    continue;
    }
    ...
    if (host.slot_pdev[i])
    of_platform_device_destroy(&host.slot_pdev[i].dev, core::ptr::null_mut());
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn octeon_mmc_remove(pdev: *mut platform_device) {
