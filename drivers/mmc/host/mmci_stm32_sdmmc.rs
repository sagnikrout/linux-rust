...
//! Source: drivers/mmc/host/mmci_stm32_sdmmc.c
#![no_std]
...
pub const DLYB_CR: c_uint = 0x0;

pub const DLYB_CFGR: c_uint = 0x4;

pub const DLYB_NB_DELAY: c_int = 11;

pub const DLYB_CFGR_UNIT_MAX: c_int = 127;
pub const DLYB_LNG_TIMEOUT_US: c_int = 1000;
pub const SDMMC_VSWEND_TIMEOUT_US: c_int = 10000;
pub const SYSCFG_DLYBSD_CR: c_uint = 0x0;

pub const DLYBSD_TAPSEL_NB: c_int = 32;

pub const SYSCFG_DLYBSD_SR: c_uint = 0x4;

pub const DLYBSD_TIMEOUT_1S_IN_US: c_int = 1000000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdmmc_lli_desc {
    pub idmalar: u32,
    pub idmabase: u32,
    pub idmasize: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdmmc_tuning_ops {
    pub dlyb): *mut *mut int (dlyb_enable)(struct sdmmc_dlyb,
    pub dlyb): *mut *mut void (set_input_ck)(struct sdmmc_dlyb,
    pub host): *mut *mut int (tuning_prepare)(struct mmci_host,
    int (*set_cfg)(struct sdmmc_dlyb *dlyb, int unit __maybe_unused,
    pub __maybe_unused): int phase, bool sampler,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdmmc_dlyb {
    pub base: *mut void __iomem,
    pub unit: u32,
    pub max: u32,
    pub ops: *mut sdmmc_tuning_ops,
}
...
//
    ...
    let mut xfer_bytes: c_uint = data.blksz * data.blocks;
...
#[no_mangle]
unsafe extern "C" fn sdmmc_idma_setup(host: *mut mmci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_idma_start(host: *mut mmci_host, datactrl: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_idma_error(host: *mut mmci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_idma_finalize(host: *mut mmci_host, data: *mut mmc_data) {
...
#[no_mangle]
unsafe extern "C" fn mmci_sdmmc_set_clkreg(host: *mut mmci_host, desired: c_uint) {
    static void mmci_sdmmc_set_clkreg(struct mmci_host *host, unsigned int desired)
    {
    let mut clk: c_uint = 0, ddr = 0;
...
#[no_mangle]
unsafe extern "C" fn sdmmc_dlyb_mp15_input_ck(dlyb: *mut sdmmc_dlyb) {
...
#[no_mangle]
unsafe extern "C" fn mmci_sdmmc_set_pwrreg(host: *mut mmci_host, pwr: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_get_dctrl_cfg(host: *mut mmci_host) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn if(!host->mrq->sbc: host->data->stop &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_dlyb_mp15_enable(dlyb: *mut sdmmc_dlyb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_dlyb_mp15_prepare(host: *mut mmci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_dlyb_mp25_enable(dlyb: *mut sdmmc_dlyb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_dlyb_mp25_prepare(host: *mut mmci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_dlyb_phase_tuning(host: *mut mmci_host, opcode: u32) -> c_int {
    static int sdmmc_dlyb_phase_tuning(struct mmci_host *host, u32 opcode)
    {
    struct sdmmc_dlyb *dlyb = host.variant_priv;
    let mut cur_len: c_int = 0, max_len = 0, end_of_len = 0;
    int phase, ret;
...
#[no_mangle]
unsafe extern "C" fn sdmmc_pre_sig_volt_vswitch(host: *mut mmci_host) {
...
#[no_mangle]
pub unsafe extern "C" fn sdmmc_variant_init(host: *mut mmci_host) {
    ...
    base_dlyb = devm_of_iomap(mmc_dev(host.mmc), np, 1, core::ptr::null_mut());
    if (IS_ERR(base_dlyb))
    return;
