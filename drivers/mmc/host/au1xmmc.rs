...
//! Source: drivers/mmc/host/au1xmmc.c
#![no_std]
...
pub const AU1XMMC_DESCRIPTOR_COUNT: c_int = 1;
// max DMA seg size: 64KB on Au1100, 4MB on Au1200
pub const AU1100_MMC_DESCRIPTOR_SIZE: c_uint = 0x0000ffff;
pub const AU1200_MMC_DESCRIPTOR_SIZE: c_uint = 0x003fffff;
...
pub struct au1xmmc_host {
    ...
    pub data_bh_work: work_struct,
    pub platdata: *mut au1xmmc_platform_data,
...
pub const HOST_F_XMIT: c_uint = 0x0001;
pub const HOST_F_RECV: c_uint = 0x0002;
pub const HOST_F_DMA: c_uint = 0x0010;
pub const HOST_F_DBDMA: c_uint = 0x0020;
pub const HOST_F_ACTIVE: c_uint = 0x0100;
pub const HOST_F_STOP: c_uint = 0x1000;
pub const HOST_S_IDLE: c_uint = 0x0001;
pub const HOST_S_CMD: c_uint = 0x0002;
pub const HOST_S_DATA: c_uint = 0x0003;
pub const HOST_S_STOP: c_uint = 0x0004;
// Easy access macros

    (((h).flags & HOST_F_XMIT) ? (h).tx_chan : (h).rx_chan)
#[no_mangle]
pub unsafe extern "C" fn has_dbdma() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn IRQ_ON(host: *mut au1xmmc_host, mask: u32) {
    static inline void IRQ_ON(struct au1xmmc_host *host, u32 mask)
    {
    let mut val: u32 = __raw_readl(HOST_CONFIG(host));
    val |= mask;
    __raw_writel(val, HOST_CONFIG(host));
    wmb(); /* drain writebuffer */
    }
#[no_mangle]
pub unsafe extern "C" fn FLUSH_FIFO(host: *mut au1xmmc_host) {
    static inline void FLUSH_FIFO(struct au1xmmc_host *host)
    {
    let mut val: u32 = __raw_readl(HOST_CONFIG2(host));
...
#[no_mangle]
pub unsafe extern "C" fn IRQ_OFF(host: *mut au1xmmc_host, mask: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn SEND_STOP(host: *mut au1xmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_set_power(host: *mut au1xmmc_host, state: c_int) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_card_inserted(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_card_readonly(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_finish_request(host: *mut au1xmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_finish_bh_work(t: *mut work_struct) {
    ...
    {
    let mut mmccmd: u32 = (cmd.opcode << SD_CMD_CI_SHIFT);
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_data_complete(host: *mut au1xmmc_host, status: u32) {
...
// Clear the CRC bits
    ...
    let mut chan: u32 = DMA_CHANNEL(host);
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_data_bh_work(t: *mut work_struct) {
    static void au1xmmc_data_bh_work(struct work_struct *t)
    {
    struct au1xmmc_host *host = from_work(host, t, data_bh_work);
    let mut status: u32 = __raw_readl(HOST_STATUS(host));
    au1xmmc_data_complete(host, status);
    }
pub const AU1XMMC_MAX_TRANSFER: c_int = 8;
#[no_mangle]
unsafe extern "C" fn au1xmmc_send_pio(host: *mut au1xmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_receive_pio(host: *mut au1xmmc_host) {
    static void au1xmmc_receive_pio(struct au1xmmc_host *host)
    {
    struct mmc_data *data;
    int max, count, sg_len = 0;
    unsigned char *sg_ptr = core::ptr::null_mut();
    u32 status, val;
    struct scatterlist *sg;
    data = host.mrq.data;
...
#[no_mangle]
pub unsafe extern "C" fn if(SD_STATUS_RU: status &) -> else {
    DBG("RX Underrun [%d + %d]\n", host.pdev.id,
    host.pio.len,	count);
    break;
    }
...
//
#[no_mangle]
unsafe extern "C" fn au1xmmc_cmd_complete(host: *mut au1xmmc_host, status: u32) {
...
// Figure out errors
    ...
    if ((host.flags & (HOST_F_DMA | HOST_F_DBDMA))) {
    let mut channel: u32 = DMA_CHANNEL(host);
// Start the DBDMA as soon as the buffer gets something in it
    if (host.flags & HOST_F_RECV) {
    let mut mask: u32 = SD_STATUS_DB | SD_STATUS_NE;
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_set_clock(host: *mut au1xmmc_host, rate: c_int) {
    static void au1xmmc_set_clock(struct au1xmmc_host *host, int rate)
    {
    let mut pbus: c_uint = clk_get_rate(host.clk);
    let mut divisor: c_uint = ((pbus / rate) / 2) - 1;
    u32 config;
    ...
    struct mmc_data *data)
    {
    let mut datalen: c_int = data.blocks * data.blksz;
    if (data.flags & MMC_DATA_READ)
    ...
    let mut ret: u32 = 0, flags = DDMA_FLAGS_NOIE;
    struct scatterlist *sg = &data.sg[i];
    let mut sg_len: c_int = sg.length;
    let mut len: c_int = (datalen > sg_len) ? sg_len : datalen;
    if (i == host.dma.len - 1)
    flags = DDMA_FLAGS_IE;
    if (host.flags & HOST_F_XMIT) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_request(mmc: *mut *mut mmc_host, mrq: *mut *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_reset_controller(host: *mut au1xmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
pub unsafe extern "C" fn if(MMC_POWER_ON: ios->power_mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(SD_STATUS_DT: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(SD_STATUS_DD: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(SD_STATUS_CR: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(STATUS_DATA_IN): (host->flags & HOST_F_RECV) && (status &) -> else {
...
// 8bit memory DMA device
    ...
    static int memid;
#[no_mangle]
unsafe extern "C" fn au1xmmc_dbdma_callback(irq: c_int, dev_id: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_dbdma_init(host: *mut au1xmmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_dbdma_shutdown(host: *mut au1xmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_enable_sdio_irq(mmc: *mut mmc_host, en: c_int) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn au1xmmc_exit() -> void __exit {
