...
//! Source: drivers/mmc/host/sdhci-tegra.c
#![no_std]
...
pub const SDHCI_TEGRA_VENDOR_CLOCK_CTRL: c_uint = 0x100;
pub const SDHCI_CLOCK_CTRL_TAP_MASK: c_uint = 0x00ff0000;
pub const SDHCI_CLOCK_CTRL_TAP_SHIFT: c_int = 16;
pub const SDHCI_CLOCK_CTRL_TRIM_MASK: c_uint = 0x1f000000;
pub const SDHCI_CLOCK_CTRL_TRIM_SHIFT: c_int = 24;

pub const SDHCI_TEGRA_VENDOR_SYS_SW_CTRL: c_uint = 0x104;

pub const SDHCI_TEGRA_VENDOR_CAP_OVERRIDES: c_uint = 0x10c;
pub const SDHCI_TEGRA_CAP_OVERRIDES_DQS_TRIM_MASK: c_uint = 0x00003f00;
pub const SDHCI_TEGRA_CAP_OVERRIDES_DQS_TRIM_SHIFT: c_int = 8;
pub const SDHCI_TEGRA_VENDOR_MISC_CTRL: c_uint = 0x120;

pub const SDHCI_MISC_CTRL_ENABLE_SDR104: c_uint = 0x8;
pub const SDHCI_MISC_CTRL_ENABLE_SDR50: c_uint = 0x10;
pub const SDHCI_MISC_CTRL_ENABLE_SDHCI_SPEC_300: c_uint = 0x20;
pub const SDHCI_MISC_CTRL_ENABLE_DDR50: c_uint = 0x200;
pub const SDHCI_TEGRA_VENDOR_DLLCAL_CFG: c_uint = 0x1b0;

pub const SDHCI_TEGRA_VENDOR_DLLCAL_STA: c_uint = 0x1bc;

pub const SDHCI_VNDR_TUN_CTRL0_0: c_uint = 0x1c0;
pub const SDHCI_VNDR_TUN_CTRL0_TUN_HW_TAP: c_uint = 0x20000;
pub const SDHCI_VNDR_TUN_CTRL0_START_TAP_VAL_MASK: c_uint = 0x03fc0000;
pub const SDHCI_VNDR_TUN_CTRL0_START_TAP_VAL_SHIFT: c_int = 18;
pub const SDHCI_VNDR_TUN_CTRL0_MUL_M_MASK: c_uint = 0x00001fc0;
pub const SDHCI_VNDR_TUN_CTRL0_MUL_M_SHIFT: c_int = 6;
pub const SDHCI_VNDR_TUN_CTRL0_TUN_ITER_MASK: c_uint = 0x000e000;
pub const SDHCI_VNDR_TUN_CTRL0_TUN_ITER_SHIFT: c_int = 13;
pub const TRIES_128: c_int = 2;
pub const TRIES_256: c_int = 4;
pub const SDHCI_VNDR_TUN_CTRL0_TUN_WORD_SEL_MASK: c_uint = 0x7;
pub const SDHCI_TEGRA_VNDR_TUN_CTRL1_0: c_uint = 0x1c4;
pub const SDHCI_TEGRA_VNDR_TUN_STATUS0: c_uint = 0x1C8;
pub const SDHCI_TEGRA_VNDR_TUN_STATUS1: c_uint = 0x1CC;
pub const SDHCI_TEGRA_VNDR_TUN_STATUS1_TAP_MASK: c_uint = 0xFF;
pub const SDHCI_TEGRA_VNDR_TUN_STATUS1_END_TAP_SHIFT: c_uint = 0x8;
pub const TUNING_WORD_BIT_SIZE: c_int = 32;
pub const SDHCI_TEGRA_AUTO_CAL_CONFIG: c_uint = 0x1e4;

pub const SDHCI_AUTO_CAL_PDPU_OFFSET_MASK: c_uint = 0x0000ffff;
pub const SDHCI_TEGRA_SDMEM_COMP_PADCTRL: c_uint = 0x1e0;
pub const SDHCI_TEGRA_SDMEM_COMP_PADCTRL_VREF_SEL_MASK: c_uint = 0x0000000f;
pub const SDHCI_TEGRA_SDMEM_COMP_PADCTRL_VREF_SEL_VAL: c_uint = 0x7;

pub const SDHCI_COMP_PADCTRL_DRVUPDN_OFFSET_MASK: c_uint = 0x07FFF000;
pub const SDHCI_TEGRA_AUTO_CAL_STATUS: c_uint = 0x1ec;

pub const SDHCI_TEGRA_CIF2AXI_CTRL_0: c_uint = 0x1fc;
...
pub const SDHCI_TEGRA_CQE_BASE_ADDR: c_uint = 0xF000;

    SDHCI_TRNS_BLK_CNT_EN | \
    SDHCI_TRNS_DMA)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_tegra_soc_data {
    pub pdata: *const sdhci_pltfm_data,
    pub dma_mask: u64,
    pub nvquirks: u32,
    pub min_tap_delay: u8,
    pub max_tap_delay: u8,
}

// Magic pull up and pull down pad calibration offsets
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_tegra_autocal_offsets {
    pub pull_up_3v3: u32,
    pub pull_down_3v3: u32,
    pub pull_up_3v3_timeout: u32,
    pub pull_down_3v3_timeout: u32,
    pub pull_up_1v8: u32,
    pub pull_down_1v8: u32,
    pub pull_up_1v8_timeout: u32,
    pub pull_down_1v8_timeout: u32,
    pub pull_up_sdr104: u32,
    pub pull_down_sdr104: u32,
    pub pull_up_hs400: u32,
    pub pull_down_hs400: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_tegra {
    pub soc_data: *const sdhci_tegra_soc_data,
    pub power_gpio: *mut gpio_desc,
    pub tmclk: *mut clk,
    pub ddr_signaling: bool,
    pub pad_calib_required: bool,
    pub pad_control_available: bool,
    pub rst: *mut reset_control,
    pub pinctrl_sdmmc: *mut pinctrl,
    pub pinctrl_state_3v3: *mut pinctrl_state,
    pub pinctrl_state_1v8: *mut pinctrl_state,
    pub pinctrl_state_3v3_drv: *mut pinctrl_state,
    pub pinctrl_state_1v8_drv: *mut pinctrl_state,
    pub autocal_offsets: sdhci_tegra_autocal_offsets,
    pub last_calib: ktime_t,
    pub default_tap: u32,
    pub default_trim: u32,
    pub dqs_trim: u32,
    pub enable_hwcq: bool,
    pub curr_clk_rate: c_ulong,
    pub tuned_tap_delay: u8,
    pub stream_id: u32,
}

#[no_mangle]
unsafe extern "C" fn tegra_sdhci_readw(host: *mut sdhci_host, reg: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_writew(host: *mut sdhci_host, val: u16, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_writel(host: *mut sdhci_host, val: u32, reg: c_int) {
...
// Erratum: Must enable block gap interrupt detection
    let mut gap_ctrl: u8 = readb(host.ioaddr + SDHCI_BLOCK_GAP_CONTROL);
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_configure_card_clk(host: *mut sdhci_host, enable: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra210_sdhci_writew(host: *mut sdhci_host, val: u16, reg: c_int) {
    static void tegra210_sdhci_writew(struct sdhci_host *host, u16 val, int reg)
    {
    let mut is_tuning_cmd: bool = 0;
    bool clk_enabled;
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_get_ro(host: *mut sdhci_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_is_pad_and_regulator_valid(host: *mut sdhci_host) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_set_tap(host: *mut sdhci_host, tap: c_uint) {
    static void tegra_sdhci_set_tap(struct sdhci_host *host, unsigned int tap)
    {
    struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
    struct sdhci_tegra *tegra_host = sdhci_pltfm_priv(pltfm_host);
    const struct sdhci_tegra_soc_data *soc_data = tegra_host.soc_data;
    let mut card_clk_enabled: bool = false;
    u32 reg;
//
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_reset(host: *mut sdhci_host, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_configure_cal_pad(host: *mut sdhci_host, enable: bool) {
...
//
    ...
    struct pinctrl_state *pinctrl_drvupdn = core::ptr::null_mut();
    let mut ret: c_int = 0;
    let mut drvup: u8 = 0, drvdn = 0;
    u32 reg;
    if (!state_drvupdn) {
// PADS Drive Strength
    ...
    if (pinctrl_drvupdn != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_pad_autocalib(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_parse_pad_autocal_dt(host: *mut sdhci_host) {
...
//
    ...
    (tegra_host.pinctrl_state_3v3_drv == core::ptr::null_mut()))
    ...
    (tegra_host.pinctrl_state_1v8_drv == core::ptr::null_mut()))
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
    static void tegra_sdhci_request(struct mmc_host *mmc, struct mmc_request *mrq)
    {
    struct sdhci_host *host = mmc_priv(mmc);
    struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
    struct sdhci_tegra *tegra_host = sdhci_pltfm_priv(pltfm_host);
    let mut since_calib: ktime_t = ktime_sub(ktime_get(), tegra_host.last_calib);
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_parse_tap_and_trim(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_parse_dt(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_set_clock(host: *mut sdhci_host, clock: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_get_max_clock(host: *mut sdhci_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_set_dqs_trim(host: *mut sdhci_host, trim: u8) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_hs400_dll_cal(host: *mut sdhci_host) {
...
// 1 ms sleep, 5 ms timeout
    ...
    bool tap_result;
    let mut start_fail: bool = false;
    let mut start_pass: bool = false;
    let mut end_pass: bool = false;
    let mut first_fail: bool = false;
    let mut first_pass: bool = false;
    let mut start_pass_tap: u8 = 0;
    let mut end_pass_tap: u8 = 0;
    let mut first_fail_tap: u8 = 0;
    let mut first_pass_tap: u8 = 0;
    let mut total_tuning_words: u8 = host.tuning_loop_count / TUNING_WORD_BIT_SIZE;
//
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_post_tuning(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_execute_hw_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
    ...
    struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
    struct sdhci_tegra *tegra_host = sdhci_pltfm_priv(pltfm_host);
    let mut set_default_tap: bool = false;
    let mut set_dqs_trim: bool = false;
    let mut do_hs400_dll_cal: bool = false;
    let mut iter: u8 = TRIES_256;
    u32 val;
    tegra_host.ddr_signaling = false;
    switch (timing) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_execute_tuning(host: *mut sdhci_host, opcode: u32) -> c_int {
...
// The TRM states the ideal tap value is at 75% in the passing range.
    ...
    return mmc_send_tuning(host.mmc, opcode, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_voltage_switch(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn tegra_cqhci_writel(cq_host: *mut cqhci_host, val: u32, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_cqe_enable(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_dumpregs(mmc: *mut mmc_host) {
    static void sdhci_tegra_dumpregs(struct mmc_host *mmc)
    {
    sdhci_dumpregs(mmc_priv(mmc));
    }
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_cqhci_irq(host: *mut sdhci_host, intmask: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_cqe_pre_enable(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_cqe_post_disable(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn tegra_sdhci_set_dma_mask(host: *mut sdhci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_add_host(host: *mut sdhci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_program_stream_id(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    clk = devm_clk_get(mmc_dev(host.mmc), core::ptr::null_mut());
    if (IS_ERR(clk)) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_tegra_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(sdhci_tegra_runtime_suspend, sdhci_tegra_runtime_resume, core::ptr::null_mut())
