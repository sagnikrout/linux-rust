...
//! Source: drivers/mmc/host/sdhci-pxav2.c
#![no_std]
...
pub const SD_FIFO_PARAM: c_uint = 0xe0;
pub const DIS_PAD_SD_CLK_GATE: c_uint = 0x0400 /* Turn on/off Dynamic SD Clock Gating */;
pub const CLK_GATE_ON: c_uint = 0x0200 /* Disable/enable Clock Gate */;
pub const CLK_GATE_CTL: c_uint = 0x0100 /* Clock Gate Control */;

    CLK_GATE_ON | CLK_GATE_CTL)
pub const SD_CLOCK_BURST_SIZE_SETUP: c_uint = 0xe6;
pub const SDCLK_SEL_SHIFT: c_int = 8;
pub const SDCLK_SEL_MASK: c_uint = 0x3;
pub const SDCLK_DELAY_SHIFT: c_int = 10;
pub const SDCLK_DELAY_MASK: c_uint = 0x3c;
pub const SD_CE_ATA_2: c_uint = 0xea;
pub const MMC_CARD: c_uint = 0x1000;
pub const MMC_WIDTH: c_uint = 0x0100;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_pxav2_host {
    pub sdio_mrq: *mut mmc_request,
    pub pinctrl: *mut pinctrl,
    pub pins_default: *mut pinctrl_state,
    pub pins_cmd_gpio: *mut pinctrl_state,
}

#[no_mangle]
unsafe extern "C" fn pxav2_reset(host: *mut sdhci_host, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn pxav1_readw(host: *mut sdhci_host, reg: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn pxav1_irq(host: *mut sdhci_host, intmask: u32) -> u32 {
...
// Restore MMC function to CMD pin
    ...
    pxav2_host.sdio_mrq = core::ptr::null_mut();
    mmc_request_done(host.mmc, sdio_mrq);
    }
    return intmask;
    }
#[no_mangle]
unsafe extern "C" fn pxav1_request_done(host: *mut sdhci_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn pxav2_mmc_set_bus_width(host: *mut sdhci_host, width: c_int) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_pxa_variant {
    pub ops: *const sdhci_ops,
    pub extra_quirks: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn sdhci_pxav2_probe(pdev: *mut platform_device) -> c_int {
    ...
    host = sdhci_pltfm_init(pdev, core::ptr::null_mut(), sizeof(*pxav2_host));
    if (IS_ERR(host))
    return PTR_ERR(host);
...
// Set up optional pinctrl for PXA168 SDIO IRQ fix
    ...
    pxav2_host.pins_cmd_gpio = core::ptr::null_mut();
    pxav2_host.pins_default = pinctrl_lookup_state(pxav2_host.pinctrl,
    "default");
    if (IS_ERR(pxav2_host.pins_default))
    pxav2_host.pins_default = core::ptr::null_mut();
    } else {
    pxav2_host.pinctrl = core::ptr::null_mut();
    }
