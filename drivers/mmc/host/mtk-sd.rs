...
//! Source: drivers/mmc/host/mtk-sd.c
#![no_std]
...
pub const MAX_BD_NUM: c_int = 1024;
pub const MSDC_NR_CLOCKS: c_int = 3;
// --------------------------------------------------------------------------
// Common Definition
// --------------------------------------------------------------------------
pub const MSDC_BUS_1BITS: c_uint = 0x0;
pub const MSDC_BUS_4BITS: c_uint = 0x1;
pub const MSDC_BUS_8BITS: c_uint = 0x2;
pub const MSDC_BURST_64B: c_uint = 0x6;
// --------------------------------------------------------------------------
// Register Offset
// --------------------------------------------------------------------------
pub const MSDC_CFG: c_uint = 0x0;
pub const MSDC_IOCON: c_uint = 0x04;
pub const MSDC_PS: c_uint = 0x08;
pub const MSDC_INT: c_uint = 0x0c;
pub const MSDC_INTEN: c_uint = 0x10;
pub const MSDC_FIFOCS: c_uint = 0x14;
pub const SDC_CFG: c_uint = 0x30;
pub const SDC_CMD: c_uint = 0x34;
pub const SDC_ARG: c_uint = 0x38;
pub const SDC_STS: c_uint = 0x3c;
pub const SDC_RESP0: c_uint = 0x40;
pub const SDC_RESP1: c_uint = 0x44;
pub const SDC_RESP2: c_uint = 0x48;
pub const SDC_RESP3: c_uint = 0x4c;
pub const SDC_BLK_NUM: c_uint = 0x50;
pub const SDC_ADV_CFG0: c_uint = 0x64;
pub const MSDC_NEW_RX_CFG: c_uint = 0x68;
pub const EMMC_IOCON: c_uint = 0x7c;
pub const SDC_ACMD_RESP: c_uint = 0x80;
pub const DMA_SA_H4BIT: c_uint = 0x8c;
pub const MSDC_DMA_SA: c_uint = 0x90;
pub const MSDC_DMA_CTRL: c_uint = 0x98;
pub const MSDC_DMA_CFG: c_uint = 0x9c;
pub const MSDC_PATCH_BIT: c_uint = 0xb0;
pub const MSDC_PATCH_BIT1: c_uint = 0xb4;
pub const MSDC_PATCH_BIT2: c_uint = 0xb8;
pub const MSDC_PAD_TUNE: c_uint = 0xec;
pub const MSDC_PAD_TUNE0: c_uint = 0xf0;
pub const PAD_DS_TUNE: c_uint = 0x188;
pub const PAD_CMD_TUNE: c_uint = 0x18c;
pub const EMMC51_CFG0: c_uint = 0x204;
pub const EMMC50_CFG0: c_uint = 0x208;
pub const EMMC50_CFG1: c_uint = 0x20c;
pub const EMMC50_CFG2: c_uint = 0x21c;
pub const EMMC50_CFG3: c_uint = 0x220;
pub const SDC_FIFO_CFG: c_uint = 0x228;
pub const CQHCI_SETTING: c_uint = 0x7fc;
// --------------------------------------------------------------------------
// Top Pad Register Offset
// --------------------------------------------------------------------------
pub const EMMC_TOP_CONTROL: c_uint = 0x00;
pub const EMMC_TOP_CMD: c_uint = 0x04;
pub const EMMC50_PAD_DS_TUNE: c_uint = 0x0c;
pub const LOOP_TEST_CONTROL: c_uint = 0x30;
// --------------------------------------------------------------------------
// Register Mask
// --------------------------------------------------------------------------
// MSDC_CFG mask
...
pub const MTK_MMC_AUTOSUSPEND_DELAY: c_int = 50;

pub const TUNING_REG2_FIXED_OFFEST: c_int = 4;

pub const PAD_DELAY_FULL: c_int = 64;
// --------------------------------------------------------------------------
// Descriptor Structure
// --------------------------------------------------------------------------
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt_gpdma_desc {
    pub gpd_info: u32,

    pub next: u32,
    pub ptr: u32,
    pub gpd_data_len: u32,
...
pub struct msdc_dma {
    ...
    pub /: *mut *mut *mut mt_gpdma_desc gpd; / pointer to gpd array,
    pub /: *mut *mut *mut mt_bdma_desc bd; / pointer to bd array,
    pub /: *mut *mut dma_addr_t gpd_addr; / the physical address of gpd array,
    pub /: *mut *mut dma_addr_t bd_addr; / the physical address of bd array,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct msdc_save_para {
    pub msdc_cfg: u32,
    pub iocon: u32,
    pub sdc_cfg: u32,
    pub pad_tune: u32,
    ...
    pub patch_bit2: u32,
    pub pad_ds_tune: u32,
    pub pad_cmd_tune: u32,
    pub emmc50_cfg0: u32,
    pub emmc50_cfg3: u32,
    pub sdc_fifo_cfg: u32,
    pub emmc_top_control: u32,
    pub emmc_top_cmd: u32,
    pub emmc50_pad_ds_tune: u32,
    pub loop_test_control: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_mmc_compatible {
    pub clk_div_bits: u8,
    pub recheck_sdio_irq: bool,
    pub /: *mut *mut bool hs400_tune; / only used for MT8173,
    pub needs_top_base: bool,
    pub pad_tune_reg: u32,
    pub async_fifo: bool,
    pub data_tune: bool,
    pub busy_check: bool,
    pub stop_clk_fix: bool,
    pub stop_dly_sel: u8,
    pub pop_en_cnt: u8,
    pub enhance_rx: bool,
    pub support_64g: bool,
    pub use_internal_cd: bool,
    pub support_new_tx: bool,
    pub support_new_rx: bool,
    pub support_spm_res_release: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct msdc_tune_para {
    pub iocon: u32,
    pub pad_tune: u32,
    pub pad_cmd_tune: u32,
    pub emmc_top_control: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msdc_host {
    pub dev: *mut device,
    pub dev_comp: *const mtk_mmc_compatible,
    pub cmd_rsp: c_int,
    pub lock: spinlock_t,
    ...
    pub error: c_int,
    pub /: *mut *mut *mut void __iomem base; / host base address,
    pub /: *mut *mut *mut void __iomem top_base; / host top register base address,
    pub /: *mut *mut msdc_dma dma; / dma channel,
    pub dma_mask: u64,
    pub /: *mut *mut u32 timeout_ns; / data timeout ns,
    pub /: *mut *mut u32 timeout_clks; / data timeout clks,
    pub pinctrl: *mut pinctrl,
    pub pins_default: *mut pinctrl_state,
    pub pins_uhs: *mut pinctrl_state,
    pub pins_eint: *mut pinctrl_state,
    pub req_timeout: delayed_work,
    pub /: *mut *mut int irq; / host interrupt,
    pub /: *mut *mut int eint_irq; / interrupt from sdio device for waking up system,
    pub reset: *mut reset_control,
    pub /: *mut *mut *mut clk src_clk; / msdc source clock,
    pub /: *mut *mut *mut clk h_clk; / msdc h_clk,
    pub /: *mut *mut *mut clk bus_clk; / bus clock which used to access register,
    pub /: *mut *mut *mut clk src_clk_cg; / msdc source clock control gate,
    pub /: *mut *mut *mut clk sys_clk_cg; / msdc subsys clock control gate,
    pub /: *mut *mut *mut clk crypto_clk; / msdc crypto clock control gate,
    pub bulk_clks: [clk_bulk_data; MSDC_NR_CLOCKS],
    pub /: *mut *mut u32 mclk; / mmc subsystem clock frequency,
    pub /: *mut *mut u32 src_clk_freq; / source clock frequency,
    pub timing: c_uchar,
    pub vqmmc_enabled: bool,
    pub latch_ck: u32,
    pub hs400_ds_delay: u32,
    pub hs400_ds_dly3: u32,
    pub /: *mut *mut u32 hs200_cmd_int_delay; / cmd internal delay for HS200/SDR104,
    pub /: *mut *mut u32 hs400_cmd_int_delay; / cmd internal delay for HS400,
    pub tuning_step: u32,
    pub hs400_cmd_resp_sel_rising: bool,
// cmd response sample selection for HS400
    pub /: *mut *mut bool hs400_mode; / current eMMC will run at hs400 mode,
    pub /: *mut *mut bool hs400_tuning; / hs400 mode online tuning,
    pub /: *mut *mut bool internal_cd; / Use internal card-detect logic,
    pub /: *mut *mut bool cqhci; / support eMMC hw cmdq,
    pub /: *mut *mut bool hsq_en; / Host Software Queue is enabled,
    pub /: *mut *mut msdc_save_para save_para; / used when gate HCLK,
    pub /: *mut *mut msdc_tune_para def_tune_para; / default tune setting,
    pub /: *mut *mut msdc_tune_para saved_tune_para; / tune result of CMD21/CMD19,
    pub cq_host: *mut cqhci_host,
    pub cq_ssc1_time: u32,
}
...
#[no_mangle]
unsafe extern "C" fn sdr_set_bits(reg: *mut void __iomem, bs: u32) {
...
#[no_mangle]
unsafe extern "C" fn sdr_clr_bits(reg: *mut void __iomem, bs: u32) {
...
#[no_mangle]
unsafe extern "C" fn sdr_set_field(reg: *mut void __iomem, field: u32, val: u32) {
    static void sdr_set_field(void __iomem *reg, u32 field, u32 val)
    {
    let mut tv: c_uint = readl(reg);
    tv &= ~field;
    tv |= ((val) << (ffs((unsigned int)field) - 1));
    writel(tv, reg);
    }
#[no_mangle]
unsafe extern "C" fn sdr_get_field(reg: *mut void __iomem, field: u32, val: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn msdc_reset_hw(host: *mut msdc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_dma_calcs(buf: *mut u8, len: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn msdc_prepare_data(host: *mut msdc_host, data: *mut mmc_data) {
...
#[no_mangle]
unsafe extern "C" fn msdc_data_prepared(data: *mut mmc_data) -> bool {
    static bool msdc_data_prepared(struct mmc_data *data)
    {
    return data.host_cookie & MSDC_PREPARE_FLAG;
    }
#[no_mangle]
unsafe extern "C" fn msdc_unprepare_data(host: *mut msdc_host, data: *mut mmc_data) {
...
#[no_mangle]
unsafe extern "C" fn msdc_timeout_cal(host: *mut msdc_host, ns: u64, clks: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn msdc_set_timeout(host: *mut msdc_host, ns: u64, clks: u64) {
...
#[no_mangle]
unsafe extern "C" fn msdc_set_busy_timeout(host: *mut msdc_host, ns: u64, clks: u64) {
...
#[no_mangle]
unsafe extern "C" fn msdc_gate_clock(host: *mut msdc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_ungate_clock(host: *mut msdc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_new_tx_setting(host: *mut msdc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_set_mclk(host: *mut msdc_host, timing: c_uchar, hz: u32) {
    ...
    u32 div;
    u32 sclk;
    let mut tune_reg: u32 = host.dev_comp.pad_tune_reg;
    u32 val;
    bool timing_changed;
    if (!hz) {
...
//
    let mut opcode: u32 = cmd.opcode;
    let mut resp: u32 = msdc_cmd_find_resp(host, cmd);
    let mut rawcmd: u32 = (opcode & 0x3f) | ((resp & 0x7) << 7);
    host.cmd_rsp = resp;
    if ((opcode == SD_IO_RW_DIRECT && cmd.flags == (unsigned int) -1) ||
    opcode == MMC_STOP_TRANSMISSION)
    rawcmd |= BIT(14);
#[no_mangle]
pub unsafe extern "C" fn if(SD_SWITCH_VOLTAGE: opcode ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn msdc_recheck_sdio_irq(host: *mut msdc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_track_cmd_data(host: *mut msdc_host, cmd: *mut mmc_command) {
...
#[no_mangle]
unsafe extern "C" fn msdc_request_done(host: *mut msdc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
pub unsafe extern "C" fn if(mrq->sbc: cmd ==) -> else {
    else if (cmd == mrq.sbc)
    msdc_start_command(host, mrq, mrq.cmd);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !cmd->data) -> else {
    else if (!cmd.data)
    msdc_request_done(host, mrq);
    else
...
#[no_mangle]
unsafe extern "C" fn msdc_ops_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn msdc_pre_req(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn msdc_data_xfer_next(host: *mut msdc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
pub unsafe extern "C" fn if(MSDC_INT_DATCRCERR: events &) -> else {
...
#[no_mangle]
unsafe extern "C" fn msdc_set_buswidth(host: *mut msdc_host, width: u32) {
    static void msdc_set_buswidth(struct msdc_host *host, u32 width)
    {
    let mut val: u32 = readl(host.base + SDC_CFG);
...
#[no_mangle]
unsafe extern "C" fn msdc_ops_switch_volt(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_card_busy(mmc: *mut mmc_host) -> c_int {
    static int msdc_card_busy(struct mmc_host *mmc)
    {
    struct msdc_host *host = mmc_priv(mmc);
    let mut status: u32 = readl(host.base + MSDC_PS);
// only check if data0 is low
    return !(status & BIT(16));
    }
#[no_mangle]
unsafe extern "C" fn msdc_request_timeout(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __msdc_enable_sdio_irq(host: *mut msdc_host, enb: c_int) {
    static void __msdc_enable_sdio_irq(struct msdc_host *host, int enb)
    {
    if (enb) {
...
#[no_mangle]
unsafe extern "C" fn msdc_enable_sdio_irq(mmc: *mut mmc_host, enb: c_int) {
...
//
    ...
    host.pins_eint = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn msdc_cmdq_irq(host: *mut msdc_host, intsts: u32) -> irqreturn_t {
    static irqreturn_t msdc_cmdq_irq(struct msdc_host *host, u32 intsts)
    {
    struct mmc_host *mmc = mmc_from_priv(host);
    let mut cmd_err: c_int = 0, dat_err = 0;
...
#[no_mangle]
unsafe extern "C" fn msdc_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// clear interrupts
    ...
    if (!mrq) {
    dev_err(host.dev,
    "%s: MRQ=core::ptr::null_mut(); events=%08X; event_mask=%08X\n",
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: data) -> else {
    else if (data)
...
#[no_mangle]
unsafe extern "C" fn msdc_init_hw(host: *mut msdc_host) {
...
// Patch Bit 1/2 setup is done: pull the trigger!
    ...
    if (host.top_base) {
    let mut top_ctl_val: u32 = readl(host.top_base + EMMC_TOP_CONTROL);
    let mut top_cmd_val: u32 = readl(host.top_base + EMMC_TOP_CMD);
...
#[no_mangle]
unsafe extern "C" fn msdc_deinit_hw(host: *mut msdc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_init_gpd_bd(host: *mut msdc_host, dma: *mut msdc_dma) {
...
#[no_mangle]
unsafe extern "C" fn msdc_ops_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn test_delay_bit(delay: u64, bit: u32) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn get_delay_len(delay: u64, start_bit: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_best_delay(host: *mut msdc_host, delay: u64) -> msdc_delay_phase {
    static struct msdc_delay_phase get_best_delay(struct msdc_host *host, u64 delay)
    {
    let mut start: c_int = 0, len = 0;
    let mut start_final: c_int = 0, len_final = 0;
    let mut final_phase: u8 = 0xff;
    let mut delay_phase: msdc_delay_phase = { 0, };
    if (delay == 0) {
...
#[no_mangle]
pub unsafe extern "C" fn msdc_set_cmd_delay(host: *mut msdc_host, value: u32) {
    static inline void msdc_set_cmd_delay(struct msdc_host *host, u32 value)
    {
    let mut tune_reg: u32 = host.dev_comp.pad_tune_reg;
    if (host.top_base) {
    let mut regval: u32 = readl(host.top_base + EMMC_TOP_CMD);
...
#[no_mangle]
pub unsafe extern "C" fn msdc_set_data_delay(host: *mut msdc_host, value: u32) {
    static inline void msdc_set_data_delay(struct msdc_host *host, u32 value)
    {
    let mut tune_reg: u32 = host.dev_comp.pad_tune_reg;
    if (host.top_base) {
    let mut regval: u32 = readl(host.top_base + EMMC_TOP_CONTROL);
...
#[no_mangle]
pub unsafe extern "C" fn msdc_set_data_sample_edge(host: *mut msdc_host, rising: bool) {
    static inline void msdc_set_data_sample_edge(struct msdc_host *host, bool rising)
    {
    let mut value: u32 = rising ? 0 : 1;
    if (host.dev_comp.support_new_rx) {
...
#[no_mangle]
unsafe extern "C" fn msdc_tune_response(mmc: *mut mmc_host, opcode: u32) -> c_int {
    static int msdc_tune_response(struct mmc_host *mmc, u32 opcode)
    {
    struct msdc_host *host = mmc_priv(mmc);
    let mut rise_delay: u64 = 0, fall_delay = 0;
    struct msdc_delay_phase final_rise_delay, final_fall_delay = { 0,};
    struct msdc_delay_phase internal_delay_phase;
    u8 final_delay, final_maxlen;
    let mut internal_delay: u32 = 0;
    let mut tune_reg: u32 = host.dev_comp.pad_tune_reg;
    int cmd_err;
    int i, j;
...
//
    ...
    let mut final_delay: return = = 0xff ? -EIO : 0;
    }
#[no_mangle]
unsafe extern "C" fn hs400_tune_response(mmc: *mut mmc_host, opcode: u32) -> c_int {
    static int hs400_tune_response(struct mmc_host *mmc, u32 opcode)
    {
    struct msdc_host *host = mmc_priv(mmc);
    let mut cmd_delay: u32 = 0;
    let mut final_cmd_delay: msdc_delay_phase = { 0,};
    u8 final_delay;
    int cmd_err;
    int i, j;
...
#[no_mangle]
unsafe extern "C" fn msdc_tune_data(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn msdc_tune_together(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_prepare_hs400_tuning(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_execute_hs400_tuning(mmc: *mut mmc_host, card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_hw_reset(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_ack_sdio_irq(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_get_cd(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_cqe_cit_cal(host: *mut msdc_host, timer_ns: u64) {
...
#[no_mangle]
unsafe extern "C" fn msdc_cqe_enable(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_cqe_disable(mmc: *mut mmc_host, recovery: bool) {
...
#[no_mangle]
unsafe extern "C" fn msdc_cqe_pre_enable(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_cqe_post_disable(mmc: *mut mmc_host) {
    ...
    host.bus_clk = core::ptr::null_mut();
...
// If present, always enable for this clock gate
    ...
    host.sys_clk_cg = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn msdc_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: host->crypto_clk) -> else {
...
#[no_mangle]
unsafe extern "C" fn msdc_drv_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn msdc_save_reg(host: *mut msdc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_restore_reg(host: *mut msdc_host) {
...
#[no_mangle]
unsafe extern "C" fn msdc_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msdc_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(msdc_runtime_suspend, msdc_runtime_resume, core::ptr::null_mut())
    };
