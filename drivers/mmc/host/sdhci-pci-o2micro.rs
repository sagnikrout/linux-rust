...
//! Source: drivers/mmc/host/sdhci-pci-o2micro.c
#![no_std]
...
//
pub const O2_SD_PCIE_SWITCH: c_uint = 0x54;
pub const O2_SD_MISC_REG5: c_uint = 0x64;
pub const O2_SD_LD0_CTRL: c_uint = 0x68;
pub const O2_SD_DEV_CTRL: c_uint = 0x88;
pub const O2_SD_LOCK_WP: c_uint = 0xD3;
pub const O2_SD_TEST_REG: c_uint = 0xD4;
pub const O2_SD_FUNC_REG0: c_uint = 0xDC;
pub const O2_SD_MULTI_VCC3V: c_uint = 0xEE;
pub const O2_SD_CLKREQ: c_uint = 0xEC;
pub const O2_SD_CAPS: c_uint = 0xE0;
pub const O2_SD_ADMA1: c_uint = 0xE2;
pub const O2_SD_ADMA2: c_uint = 0xE7;
pub const O2_SD_MISC_CTRL2: c_uint = 0xF0;
pub const O2_SD_INF_MOD: c_uint = 0xF1;
pub const O2_SD_MISC_CTRL4: c_uint = 0xFC;
pub const O2_SD_MISC_CTRL: c_uint = 0x1C0;
pub const O2_SD_EXP_INT_REG: c_uint = 0x1E0;
pub const O2_SD_PWR_FORCE_L0: c_uint = 0x0002;
pub const O2_SD_TUNING_CTRL: c_uint = 0x300;
pub const O2_SD_PLL_SETTING: c_uint = 0x304;
pub const O2_SD_MISC_SETTING: c_uint = 0x308;
pub const O2_SD_CLK_SETTING: c_uint = 0x328;
pub const O2_SD_CAP_REG2: c_uint = 0x330;
pub const O2_SD_CAP_REG0: c_uint = 0x334;
pub const O2_SD_UHS1_CAP_SETTING: c_uint = 0x33C;
pub const O2_SD_DELAY_CTRL: c_uint = 0x350;
pub const O2_SD_OUTPUT_CLK_SOURCE_SWITCH: c_uint = 0x354;
pub const O2_SD_UHS2_L1_CTRL: c_uint = 0x35C;
pub const O2_SD_FUNC_REG3: c_uint = 0x3E0;
pub const O2_SD_FUNC_REG4: c_uint = 0x3E4;
pub const O2_SD_PARA_SET_REG1: c_uint = 0x444;
pub const O2_SD_VDDX_CTRL_REG: c_uint = 0x508;
pub const O2_SD_GPIO_CTRL_REG1: c_uint = 0x510;

pub const O2_SD_VENDOR_SETTING: c_uint = 0x110;
pub const O2_SD_VENDOR_SETTING2: c_uint = 0x1C8;

pub const O2_PLL_DLL_WDT_CONTROL1: c_uint = 0x1CC;

pub const O2_SD_DETECT_SETTING: c_uint = 0x324;
...
#[derive(Copy, Clone)]
pub struct o2_host {
    pub dll_adjust_count: u8,
}

#[no_mangle]
unsafe extern "C" fn sdhci_o2_wait_card_detect_stable(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_o2_enable_internal_clock(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_o2_get_cd(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn o2_pci_set_baseclk(chip: *mut sdhci_pci_chip, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_o2_pll_dll_wdt_control(host: *mut sdhci_host) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __sdhci_o2_execute_tuning(host: *mut sdhci_host, opcode: u32) {
    static void __sdhci_o2_execute_tuning(struct sdhci_host *host, u32 opcode)
    {
    int i;
    sdhci_send_tuning(host, opcode);
    for (i = 0; i < 150; i++) {
    let mut ctrl: u16 = sdhci_readw(host, SDHCI_HOST_CONTROL2);
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_o2_dll_recovery(host: *mut sdhci_host) -> c_int {
    static int sdhci_o2_dll_recovery(struct sdhci_host *host)
    {
    let mut ret: c_int = 0;
    let mut scratch_8: u8 = 0;
    let mut scratch_32: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn sdhci_o2_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
    static int sdhci_o2_execute_tuning(struct mmc_host *mmc, u32 opcode)
    {
    struct sdhci_host *host = mmc_priv(mmc);
    struct sdhci_pci_slot *slot = sdhci_priv(host);
    struct sdhci_pci_chip *chip = slot.chip;
    let mut current_bus_width: c_int = 0;
    let mut scratch32: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn o2_pci_led_enable(chip: *mut sdhci_pci_chip) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_pci_o2_fujin2_pci_init(chip: *mut sdhci_pci_chip) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_o2_enable_clk(host: *mut sdhci_host, clk: u16) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_pci_o2_set_clock(host: *mut sdhci_host, clock: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_pci_o2_init_sd_express(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_pci_o2_set_power(host: *mut sdhci_host, mode: c_uchar, vdd: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_pci_o2_probe_slot(slot: *mut sdhci_pci_slot) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_pci_o2_probe(chip: *mut sdhci_pci_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_pci_o2_resume(chip: *mut sdhci_pci_chip) -> c_int {
