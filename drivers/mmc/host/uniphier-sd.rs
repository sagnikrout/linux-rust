...
//! Source: drivers/mmc/host/uniphier-sd.c
#![no_std]
...
pub const UNIPHIER_SD_CC_EXT_MODE: c_uint = 0x1b0;

pub const UNIPHIER_SD_HOST_MODE: c_uint = 0x1c8;
pub const UNIPHIER_SD_VOLT: c_uint = 0x1e4;

pub const UNIPHIER_SD_VOLT_OFF: c_int = 0;

pub const UNIPHIER_SD_DMA_MODE: c_uint = 0x410;

pub const UNIPHIER_SD_DMA_MODE_DIR_TO_DEV: c_int = 0;
pub const UNIPHIER_SD_DMA_MODE_DIR_FROM_DEV: c_int = 1;

pub const UNIPHIER_SD_DMA_MODE_WIDTH_8: c_int = 0;
pub const UNIPHIER_SD_DMA_MODE_WIDTH_16: c_int = 1;
pub const UNIPHIER_SD_DMA_MODE_WIDTH_32: c_int = 2;
pub const UNIPHIER_SD_DMA_MODE_WIDTH_64: c_int = 3;

pub const UNIPHIER_SD_DMA_CTL: c_uint = 0x414;

pub const UNIPHIER_SD_DMA_RST: c_uint = 0x418;

pub const UNIPHIER_SD_DMA_ADDR_L: c_uint = 0x440;
pub const UNIPHIER_SD_DMA_ADDR_H: c_uint = 0x444;
// SD control
pub const UNIPHIER_SDCTRL_CHOFFSET: c_uint = 0x200;
pub const UNIPHIER_SDCTRL_MODE: c_uint = 0x30;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniphier_sd_priv {
    pub tmio_data: tmio_mmc_data,
    pub pinctrl: *mut pinctrl,
    pub pinstate_uhs: *mut pinctrl_state,
    pub clk: *mut clk,
    pub rst: *mut reset_control,
    pub rst_br: *mut reset_control,
    pub rst_hw: *mut reset_control,
    pub chan: *mut dma_chan,
    pub dma_dir: enum dma_data_direction,
    pub sdctrl_regmap: *mut regmap,
    pub sdctrl_ch: u32,
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_dma_endisable(host: *mut tmio_mmc_host, enable: c_int) {
...
// external DMA engine
#[no_mangle]
unsafe extern "C" fn uniphier_sd_external_dma_issue(t: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_external_dma_release(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_external_dma_abort(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_external_dma_dataend(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_internal_dma_issue(t: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_internal_dma_release(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_internal_dma_abort(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_internal_dma_dataend(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_clk_enable(host: *mut tmio_mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_clk_disable(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_hw_reset(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_speed_switch(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_uhs_enable(host: *mut tmio_mmc_host, uhs_en: bool) {
...
//
    ...
    tmp |= UNIPHIER_SD_CLK_CTL_DIV1;
#[no_mangle]
pub unsafe extern "C" fn if(512: priv->caps & UNIPHIER_SD_CAP_EXTENDED_IP && divisor >) -> else {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_host_init(host: *mut tmio_mmc_host) {
...
//
    ...
    struct tmio_mmc_host *host = mmc_priv(mmc);
    struct uniphier_sd_priv *priv = uniphier_sd_priv(host);
    struct pinctrl_state *pinstate = core::ptr::null_mut();
    u32 val, tmp;
    bool uhs_en;
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_uhs_init(host: *mut tmio_mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniphier_sd_remove(pdev: *mut platform_device) {
