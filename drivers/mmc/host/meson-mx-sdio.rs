...
//! Source: drivers/mmc/host/meson-mx-sdio.c
#![no_std]
...
pub const MESON_MX_SDIO_ARGU: c_uint = 0x00;
pub const MESON_MX_SDIO_SEND: c_uint = 0x04;

pub const MESON_MX_SDIO_CONF: c_uint = 0x08;
pub const MESON_MX_SDIO_CONF_CMD_CLK_DIV_SHIFT: c_int = 0;
pub const MESON_MX_SDIO_CONF_CMD_CLK_DIV_WIDTH: c_int = 10;

pub const MESON_MX_SDIO_IRQS: c_uint = 0x0c;

pub const MESON_MX_SDIO_IRQC: c_uint = 0x10;

pub const MESON_MX_SDIO_MULT: c_uint = 0x14;

pub const MESON_MX_SDIO_ADDR: c_uint = 0x18;
pub const MESON_MX_SDIO_EXT: c_uint = 0x1c;

pub const MESON_MX_SDIO_MAX_SLOTS: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_mx_mmc_host_clkc {
    pub cfg_div: clk_divider,
    pub fixed_div2: clk_fixed_factor,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_mx_mmc_host {
    pub controller_dev: *mut device,
    pub cfg_div_clk: *mut clk,
    pub regmap: *mut regmap,
    pub irq: c_int,
    pub irq_lock: spinlock_t,
    pub cmd_timeout: timer_list,
    pub slot_id: c_uint,
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_soft_reset(host: *mut meson_mx_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_request_done(host: *mut meson_mx_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
    static void meson_mx_mmc_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
    {
    struct meson_mx_mmc_host *host = mmc_priv(mmc);
    let mut vdd: c_ushort = ios.vdd;
    let mut clk_rate: c_ulong = ios.clock;
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_map_dma(mmc: *mut mmc_host, mrq: *mut mmc_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_irq_thread(irq: c_int, irq_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_timeout(t: *mut timer_list) {
...
//
    ...
    pdev = of_platform_device_create(slot_node, core::ptr::null_mut(), parent);
    if (!pdev)
    dev_err(parent,
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_add_host(host: *mut meson_mx_mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_probe(pdev: *mut platform_device) -> c_int {
    ...
    of_platform_device_destroy(&slot_pdev.dev, core::ptr::null_mut());
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn meson_mx_mmc_remove(pdev: *mut platform_device) {
    ...
    of_platform_device_destroy(slot_dev, core::ptr::null_mut());
    clk_disable_unprepare(host.cfg_div_clk);
    }
