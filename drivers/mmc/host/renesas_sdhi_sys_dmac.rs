...
//! Source: drivers/mmc/host/renesas_sdhi_sys_dmac.c
#![no_std]
...
pub const TMIO_MMC_MIN_DMA_LEN: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sys_dmac_abort_dma(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sys_dmac_dataend_dma(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sys_dmac_dma_callback(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sys_dmac_start_dma_rx(host: *mut tmio_mmc_host) {
    ...
    dma_cookie_t cookie;
    int ret, i;
    let mut aligned: bool = true, multiple = true;
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sys_dmac_start_dma_tx(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sys_dmac_issue_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sys_dmac_release_dma(host: *mut tmio_mmc_host) {
    ...
    host.bounce_buf = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sys_dmac_probe(pdev: *mut platform_device) -> c_int {
    static int renesas_sdhi_sys_dmac_probe(struct platform_device *pdev)
    {
    return renesas_sdhi_probe(pdev, &renesas_sdhi_sys_dmac_dma_ops,
    of_device_get_match_data(&pdev.dev), core::ptr::null_mut());
    }
    static DEFINE_RUNTIME_DEV_PM_OPS(renesas_sdhi_sys_dmac_dev_pm_ops,
    tmio_mmc_host_runtime_suspend,
    tmio_mmc_host_runtime_resume, core::ptr::null_mut());
