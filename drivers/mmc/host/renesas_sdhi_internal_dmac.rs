...
//! Source: drivers/mmc/host/renesas_sdhi_internal_dmac.c
#![no_std]
...
pub const DM_CM_DTRAN_MODE: c_uint = 0x820;
pub const DM_CM_DTRAN_CTRL: c_uint = 0x828;
pub const DM_CM_RST: c_uint = 0x830;
pub const DM_CM_INFO1: c_uint = 0x840;
pub const DM_CM_INFO1_MASK: c_uint = 0x848;
pub const DM_CM_INFO2: c_uint = 0x850;
pub const DM_CM_INFO2_MASK: c_uint = 0x858;
pub const DM_DTRAN_ADDR: c_uint = 0x880;
// DM_CM_DTRAN_MODE
...
//
pub const SDHI_INTERNAL_DMAC_RX_IN_USE: c_int = 0;
...
//
    ...
    {
    let mut val: u64 = RST_DTRANRST1 | RST_DTRANRST0;
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_internal_dmac_dma_irq(host: *mut tmio_mmc_host) -> bool {
    ...
    (sdhi_has_quirk(priv, old_info1_layout) ?
    INFO1_DTRANEND1_OLD : INFO1_DTRANEND1);
    let mut status: u32 = readl(host.ctl + DM_CM_INFO1);
    if (status & dma_irqs) {
...
// This DMAC needs buffers to be 128-byte aligned
    ...
    let mut dtran_mode: u32 = DTRAN_MODE_BUS_WIDTH;
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_internal_dmac_issue_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_internal_dmac_complete(host: *mut tmio_mmc_host) -> bool {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_internal_dmac_complete_work_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_internal_dmac_end_dma(host: *mut tmio_mmc_host) {
...
// Each value is set to zero to assume "disabling" each DMA
    host.chan_rx = host.chan_tx = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_internal_dmac_probe(pdev: *mut platform_device) -> c_int {
