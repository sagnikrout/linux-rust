...
//! Source: drivers/mmc/host/sdhci-of-arasan.c
#![no_std]
...
pub const SDHCI_ARASAN_VENDOR_REGISTER: c_uint = 0x78;
pub const SDHCI_ARASAN_ITAPDLY_REGISTER: c_uint = 0xF0F8;
pub const SDHCI_ARASAN_ITAPDLY_SEL_MASK: c_uint = 0xFF;
pub const SDHCI_ARASAN_OTAPDLY_REGISTER: c_uint = 0xF0FC;
pub const SDHCI_ARASAN_OTAPDLY_SEL_MASK: c_uint = 0x3F;
pub const SDHCI_ARASAN_CQE_BASE_ADDR: c_uint = 0x200;

pub const PHY_CLK_TOO_SLOW_HZ: c_int = 400000;
pub const MIN_PHY_CLK_HZ: c_int = 50000000;
pub const SDHCI_ITAPDLY_CHGWIN: c_uint = 0x200;
pub const SDHCI_ITAPDLY_ENABLE: c_uint = 0x100;
pub const SDHCI_OTAPDLY_ENABLE: c_uint = 0x40;
pub const PHY_CTRL_REG1: c_uint = 0x270;

pub const PHY_CTRL_ITAPDLY_SEL_SHIFT: c_int = 1;

pub const PHY_CTRL_OTAPDLY_SEL_SHIFT: c_int = 12;

pub const PHY_CTRL_STRB_SEL_SHIFT: c_int = 16;

pub const PHY_CTRL_REG2: c_uint = 0x274;

pub const PHY_CTRL_FREQ_SEL_SHIFT: c_int = 4;
...
pub const FREQSEL_275M_250M: c_uint = 0x5;
pub const FREQSEL_250M_225M: c_uint = 0x6;
pub const FREQSEL_225M_200M: c_uint = 0x7;
pub const PHY_DLL_TIMEOUT_MS: c_int = 100;
...
pub const CD_STABLE_TIMEOUT_US: c_int = 2000000;
pub const CD_STABLE_MAX_SLEEP_US: c_int = 10;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_arasan_soc_ctl_field {
    pub reg: u32,
    pub width: u16,
    pub shift: i16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_arasan_soc_ctl_map {
    pub baseclkfreq: sdhci_arasan_soc_ctl_field,
    pub clockmultiplier: sdhci_arasan_soc_ctl_field,
    pub support64b: sdhci_arasan_soc_ctl_field,
    pub hiword_update: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_arasan_clk_ops {
    pub sdcardclk_ops: *const clk_ops,
    pub sampleclk_ops: *const clk_ops,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_arasan_clk_data {
    pub sdcardclk_hw: clk_hw,
    pub sdcardclk: *mut clk,
    pub sampleclk_hw: clk_hw,
    pub sampleclk: *mut clk,
    pub phase_map: mmc_clk_phase_map,
    pub host): *mut *mut void (set_clk_delays)(struct sdhci_host,
    pub clk_of_data: *mut c_void,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_arasan_data {
    pub host: *mut sdhci_host,
    pub clk_ahb: *mut clk,
    pub phy: *mut phy,
    pub is_phy_on: bool,
    pub internal_phy_reg: bool,
    pub has_cqe: bool,
    pub clk_data: sdhci_arasan_clk_data,
    pub clk_ops: *const sdhci_arasan_clk_ops,
    pub soc_ctl_base: *mut regmap,
    pub soc_ctl_map: *const sdhci_arasan_soc_ctl_map,
    pub quirks: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_arasan_of_data {
    pub soc_ctl_map: *const sdhci_arasan_soc_ctl_map,
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_phy_set_delaychain(host: *mut sdhci_host, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_phy_set_dll(host: *mut sdhci_host, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_phy_dll_set_freq(host: *mut sdhci_host, clock: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(140: freq <= 170 && freq >) -> else {
    else if (freq <= 170 && freq > 140)
    freq_sel = FREQSEL_170M_140M;
#[no_mangle]
pub unsafe extern "C" fn if(110: freq <= 140 && freq >) -> else {
    else if (freq <= 140 && freq > 110)
    freq_sel = FREQSEL_140M_110M;
#[no_mangle]
pub unsafe extern "C" fn if(80: freq <= 110 && freq >) -> else {
...
//
    ...
    let mut reg: u32 = fld.reg;
    let mut width: u16 = fld.width;
    let mut shift: i16 = fld.shift;
    int ret;
//
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_set_clock(host: *mut sdhci_host, clock: c_uint) {
    static void sdhci_arasan_set_clock(struct sdhci_host *host, unsigned int clock)
    {
    struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
    struct sdhci_arasan_data *sdhci_arasan = sdhci_pltfm_priv(pltfm_host);
    struct sdhci_arasan_clk_data *clk_data = &sdhci_arasan.clk_data;
    let mut ctrl_phy: bool = false;
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_reset(host: *mut sdhci_host, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_hw_reset(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_cqhci_irq(host: *mut sdhci_host, intmask: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_dumpregs(mmc: *mut mmc_host) {
    static void sdhci_arasan_dumpregs(struct mmc_host *mmc)
    {
    sdhci_dumpregs(mmc_priv(mmc));
    }
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_cqe_enable(mmc: *mut mmc_host) {
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_zynqmp_sdcardclk_set_phase(hw: *mut clk_hw, degrees: c_int) -> c_int {
    ...
    let mut node_id: u32 = !strcmp(clk_name, "clk_out_sd0") ? NODE_SD_0 : NODE_SD_1;
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_zynqmp_sampleclk_set_phase(hw: *mut clk_hw, degrees: c_int) -> c_int {
    ...
    struct sdhci_host *host = sdhci_arasan.host;
    const char *clk_name = clk_hw_get_name(hw);
    let mut node_id: u32 = !strcmp(clk_name, "clk_in_sd0") ? NODE_SD_0 : NODE_SD_1;
    u8 tap_delay, tap_max = 0;
    int ret;
// This is applicable for SDHCI_SPEC_300 and above
    if (host.version < SDHCI_SPEC_300)
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_versal_sdcardclk_set_phase(hw: *mut clk_hw, degrees: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_versal_sampleclk_set_phase(hw: *mut clk_hw, degrees: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_versal_net_emmc_sdcardclk_set_phase(hw: *mut clk_hw, degrees: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_versal_net_emmc_sampleclk_set_phase(hw: *mut clk_hw, degrees: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arasan_zynqmp_dll_reset(host: *mut sdhci_host, deviceid: u32) {
...
#[no_mangle]
unsafe extern "C" fn arasan_zynqmp_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_update_baseclkfreq(host: *mut sdhci_host) {
    ...
    const struct sdhci_arasan_soc_ctl_map *soc_ctl_map =
    sdhci_arasan.soc_ctl_map;
    let mut mhz: u32 = DIV_ROUND_CLOSEST_ULL(clk_get_rate(pltfm_host.clk), 1000000);
// Having a map is optional
    if (!soc_ctl_map)
    return;
// If we have a map, we expect to have a syscon
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_set_clk_delays(host: *mut sdhci_host) {
...
//
    ...
    clk_data.sdcardclk_hw.init = core::ptr::null_mut();
...
//
    ...
    clk_data.sampleclk_hw.init = core::ptr::null_mut();
    ret = of_clk_add_provider(np, of_clk_src_simple_get,
    clk_data.sampleclk);
    if (ret)
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_unregister_sdclk(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_update_support64b(host: *mut sdhci_host, value: u32) {
...
// Obtain SDHC reset control
    ...
    mhz = 200;
#[no_mangle]
pub unsafe extern "C" fn if(100: mhz > 50 && mhz <=) -> else {
    else if (mhz > 50 && mhz <= 100)
    mhz = 100;
#[no_mangle]
pub unsafe extern "C" fn if(50: mhz > 25 && mhz <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_add_host(sdhci_arasan: *mut sdhci_arasan_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_arasan_remove(pdev: *mut platform_device) {
