...
//! Source: drivers/mmc/host/sdhci-of-sparx5.c
#![no_std]
...
pub const MSHC_DLY_CC_SHIFT: c_int = 13;
pub const MSHC_DLY_CC_MAX: c_int = 15;

pub const MSHC2_VERSION: c_uint = 0x500	/* Off 0x140, reg 0x0 */;
pub const MSHC2_TYPE: c_uint = 0x504	/* Off 0x140, reg 0x1 */;
pub const MSHC2_EMMC_CTRL: c_uint = 0x52c	/* Off 0x140, reg 0xB */;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_sparx5_data {
    pub host: *mut sdhci_host,
    pub cpu_ctrl: *mut regmap,
    pub delay_clock: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn sparx5_set_cacheable(host: *mut sdhci_host, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn sparx5_set_delay(host: *mut sdhci_host, value: u8) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sparx5_set_emmc(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sparx5_reset_emmc(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sparx5_reset(host: *mut sdhci_host, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sparx5_probe(pdev: *mut platform_device) -> c_int {
