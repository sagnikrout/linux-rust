...
//! Source: drivers/mmc/host/meson-gx-mmc.c
#![no_std]
...
pub const SD_EMMC_CLOCK: c_uint = 0x0;

pub const CLK_PHASE_0: c_int = 0;
pub const CLK_PHASE_180: c_int = 2;

pub const SD_EMMC_DELAY: c_uint = 0x4;
pub const SD_EMMC_ADJUST: c_uint = 0x8;

pub const SD_EMMC_DELAY1: c_uint = 0x4;
pub const SD_EMMC_DELAY2: c_uint = 0x8;
pub const SD_EMMC_V3_ADJUST: c_uint = 0xc;
pub const SD_EMMC_CALOUT: c_uint = 0x10;
pub const SD_EMMC_START: c_uint = 0x40;

pub const SD_EMMC_CFG: c_uint = 0x44;

pub const CFG_BUS_WIDTH_1: c_uint = 0x0;
pub const CFG_BUS_WIDTH_4: c_uint = 0x1;
pub const CFG_BUS_WIDTH_8: c_uint = 0x2;

pub const SD_EMMC_STATUS: c_uint = 0x48;

pub const SD_EMMC_IRQ_EN: c_uint = 0x4c;
...
pub const SD_EMMC_CMD_CFG: c_uint = 0x50;
pub const SD_EMMC_CMD_ARG: c_uint = 0x54;
pub const SD_EMMC_CMD_DAT: c_uint = 0x58;
pub const SD_EMMC_CMD_RSP: c_uint = 0x5c;
pub const SD_EMMC_CMD_RSP1: c_uint = 0x60;
pub const SD_EMMC_CMD_RSP2: c_uint = 0x64;
pub const SD_EMMC_CMD_RSP3: c_uint = 0x68;
pub const SD_EMMC_RXD: c_uint = 0x94;
pub const SD_EMMC_TXD: c_uint = 0x94;

pub const SD_EMMC_SRAM_DATA_BUF_LEN: c_int = 1536;
pub const SD_EMMC_SRAM_DATA_BUF_OFF: c_uint = 0x200;

pub const MUX_CLK_NUM_PARENTS: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_mmc_data {
    pub tx_delay_mask: c_uint,
    pub rx_delay_mask: c_uint,
    pub always_on: c_uint,
    pub adjust: c_uint,
    pub irq_sdio_sleep: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sd_emmc_desc {
    pub cmd_cfg: u32,
    pub cmd_arg: u32,
    pub cmd_data: u32,
    pub cmd_resp: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_host {
    pub dev: *mut device,
    pub data: *const meson_mmc_data,
    pub mmc: *mut mmc_host,
    pub cmd: *mut mmc_command,
    pub regs: *mut void __iomem,
    pub mux_clk: *mut clk,
    pub mmc_clk: *mut clk,
    pub req_rate: c_ulong,
    pub ddr: bool,
    pub dram_access_quirk: bool,
    pub pinctrl: *mut pinctrl,
    pub pins_clk_gate: *mut pinctrl_state,
    pub bounce_buf_size: c_uint,
    pub bounce_buf: *mut c_void,
    pub bounce_iomem_buf: *mut void __iomem,
    pub bounce_dma_addr: dma_addr_t,
    pub descs: *mut sd_emmc_desc,
    pub descs_dma_addr: dma_addr_t,
    pub irq: c_int,
    pub needs_pre_post_req: bool,
    pub lock: spinlock_t,
}

#[no_mangle]
unsafe extern "C" fn meson_mmc_get_timeout_msecs(data: *mut mmc_data) -> c_uint {
    static unsigned int meson_mmc_get_timeout_msecs(struct mmc_data *data)
    {
    let mut timeout: c_uint = data.timeout_ns / NSEC_PER_MSEC;
    if (!timeout)
...
#[no_mangle]
pub unsafe extern "C" fn meson_mmc_desc_chain_mode(data: *const mmc_data) -> bool {
    static inline bool meson_mmc_desc_chain_mode(const struct mmc_data *data)
    {
    return data.host_cookie & SD_EMMC_DESC_CHAIN_MODE;
    }
#[no_mangle]
pub unsafe extern "C" fn meson_mmc_bounce_buf_read(data: *const mmc_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_pre_req(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
//
#[no_mangle]
unsafe extern "C" fn meson_mmc_clk_gate(host: *mut meson_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_clk_ungate(host: *mut meson_host) {
...
//
#[no_mangle]
unsafe extern "C" fn meson_mmc_clk_init(host: *mut meson_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_disable_resampling(host: *mut meson_host) {
    static void meson_mmc_disable_resampling(struct meson_host *host)
    {
    let mut val: c_uint = readl(host.regs + host.data.adjust);
    val &= ~ADJUST_ADJ_EN;
    writel(val, host.regs + host.data.adjust);
    }
#[no_mangle]
unsafe extern "C" fn meson_mmc_reset_resampling(host: *mut meson_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_resampling_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_set_blksz(mmc: *mut mmc_host, blksz: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_set_response_bits(cmd: *mut mmc_command, cmd_cfg: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_desc_chain_transfer(mmc: *mut mmc_host, cmd_cfg: u32) {
...
// local sg copy for dram_access_quirk
    ...
    {
    let mut sg_flags: c_uint = SG_MITER_ATOMIC;
    struct scatterlist *sgl = data.sg;
    let mut nents: c_uint = data.sg_len;
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_start_cmd(mmc: *mut mmc_host, cmd: *mut mmc_command) {
    static void meson_mmc_start_cmd(struct mmc_host *mmc, struct mmc_command *cmd)
    {
    struct meson_host *host = mmc_priv(mmc);
    struct mmc_data *data = cmd.data;
    let mut cmd_cfg: u32 = 0, cmd_data = 0;
    let mut xfer_bytes: c_uint = 0;
// Setup descriptors
    dma_rmb();
    host.cmd = cmd;
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_validate_dram_access(mmc: *mut mmc_host, data: *mut mmc_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_read_resp(mmc: *mut mmc_host, cmd: *mut mmc_command) {
...
#[no_mangle]
unsafe extern "C" fn __meson_mmc_enable_sdio_irq(mmc: *mut mmc_host, enable: c_int) {
    static void __meson_mmc_enable_sdio_irq(struct mmc_host *mmc, int enable)
    {
    struct meson_host *host = mmc_priv(mmc);
    let mut reg_irqen: u32 = IRQ_EN_MASK;
    if (enable)
    reg_irqen |= IRQ_SDIO;
    writel(reg_irqen, host.regs + SD_EMMC_IRQ_EN);
    }
#[no_mangle]
unsafe extern "C" fn meson_mmc_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// Stop desc in case of errors
    let mut start: u32 = readl(host.regs + SD_EMMC_START);
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_wait_desc_stop(host: *mut meson_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_cfg_init(host: *mut meson_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_card_busy(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_voltage_switch(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_enable_sdio_irq(mmc: *mut mmc_host, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_ack_sdio_irq(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_probe(pdev: *mut platform_device) -> c_int {
...
// Get regulators and the supported OCR mask
    ...
    host.pins_clk_gate = core::ptr::null_mut();
    }
...
// data bounce buffer
    ...
    if (host.bounce_buf == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn meson_mmc_remove(pdev: *mut platform_device) {
