...
//! Source: drivers/mmc/host/rtsx_usb_sdmmc.c
#![no_std]
...
// Macro flag: #define RTSX_USB_USE_LEDS_CLASS

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtsx_usb_sdmmc {
    pub pdev: *mut platform_device,
    pub ucr: *mut rtsx_ucr,
    ...
    pub vpclk: bool,
    pub double_clk: bool,
    pub host_removal: bool,
    pub card_exist: bool,
    pub suppress_cd: bool,
...
#[no_mangle]
pub unsafe extern "C" fn sd_clear_error(host: *mut rtsx_usb_sdmmc) {
...
#[no_mangle]
unsafe extern "C" fn sd_print_debug_regs(host: *mut rtsx_usb_sdmmc) {
...
// unaligned byte
    ...
    trans_mode = (cmd != core::ptr::null_mut()) ? SD_TM_AUTO_WRITE_2 : SD_TM_AUTO_WRITE_3;
    rtsx_usb_init_cmd(ucr);
    if (cmd != core::ptr::null_mut()) {
    dev_dbg(sdmmc_dev(host), "%s: SD/MMC CMD%d\n", __func__,
    cmd.opcode);
...
#[no_mangle]
unsafe extern "C" fn sd_rw_multi(host: *mut rtsx_usb_sdmmc, mrq: *mut mmc_request) -> c_int {
    static int sd_rw_multi(struct rtsx_usb_sdmmc *host, struct mmc_request *mrq)
    {
    struct rtsx_ucr *ucr = host.ucr;
    struct mmc_data *data = mrq.data;
    let mut read: c_int = (data.flags & MMC_DATA_READ) ? 1 : 0;
    u8 cfg2, trans_mode;
    int err;
    u8 flag;
    ...
    data.sg_len,  core::ptr::null_mut(), 10000);
    if (err) {
...
#[no_mangle]
pub unsafe extern "C" fn sd_enable_initial_mode(host: *mut rtsx_usb_sdmmc) {
...
#[no_mangle]
pub unsafe extern "C" fn sd_disable_initial_mode(host: *mut rtsx_usb_sdmmc) {
...
#[no_mangle]
unsafe extern "C" fn sd_change_phase(host: *mut rtsx_usb_sdmmc, sample_point: u8, tx: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_phase_point(phase_map: u32, idx: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn get_phase_len(phase_map: u32, idx: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_search_final_phase(host: *mut rtsx_usb_sdmmc, phase_map: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sd_wait_data_idle(host: *mut rtsx_usb_sdmmc) {
...
#[no_mangle]
unsafe extern "C" fn sd_tuning_rx(host: *mut rtsx_usb_sdmmc, opcode: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_pull_ctl_disable_lqfp48(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_pull_ctl_disable_qfn24(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_pull_ctl_enable_lqfp48(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_pull_ctl_enable_qfn24(ucr: *mut rtsx_ucr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_power_on(host: *mut rtsx_usb_sdmmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_power_off(host: *mut rtsx_usb_sdmmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_update_led(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_init_host(host: *mut rtsx_usb_sdmmc) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_sdmmc_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_sdmmc_drv_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_sdmmc_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_usb_sdmmc_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(rtsx_usb_sdmmc_runtime_suspend, rtsx_usb_sdmmc_runtime_resume, core::ptr::null_mut())
    };
