...
//! Source: drivers/mmc/host/jz4740_mmc.c
#![no_std]
...
pub const JZ_REG_MMC_STRPCL: c_uint = 0x00;
pub const JZ_REG_MMC_STATUS: c_uint = 0x04;
pub const JZ_REG_MMC_CLKRT: c_uint = 0x08;
pub const JZ_REG_MMC_CMDAT: c_uint = 0x0C;
pub const JZ_REG_MMC_RESTO: c_uint = 0x10;
pub const JZ_REG_MMC_RDTO: c_uint = 0x14;
pub const JZ_REG_MMC_BLKLEN: c_uint = 0x18;
pub const JZ_REG_MMC_NOB: c_uint = 0x1C;
pub const JZ_REG_MMC_SNOB: c_uint = 0x20;
pub const JZ_REG_MMC_IMASK: c_uint = 0x24;
pub const JZ_REG_MMC_IREG: c_uint = 0x28;
pub const JZ_REG_MMC_CMD: c_uint = 0x2C;
pub const JZ_REG_MMC_ARG: c_uint = 0x30;
pub const JZ_REG_MMC_RESP_FIFO: c_uint = 0x34;
pub const JZ_REG_MMC_RXFIFO: c_uint = 0x38;
pub const JZ_REG_MMC_TXFIFO: c_uint = 0x3C;
pub const JZ_REG_MMC_LPM: c_uint = 0x40;
pub const JZ_REG_MMC_DMAC: c_uint = 0x44;

pub const JZ_MMC_CMDAT_RSP_R1: c_int = 1;
pub const JZ_MMC_CMDAT_RSP_R2: c_int = 2;
pub const JZ_MMC_CMDAT_RSP_R3: c_int = 3;

pub const JZ_MMC_CLK_RATE: c_int = 24000000;
pub const JZ_MMC_REQ_TIMEOUT_MS: c_int = 5000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct jz4740_mmc_host {
    pub mmc: *mut mmc_host,
    pub pdev: *mut platform_device,
    pub clk: *mut clk,
    pub version: enum jz4740_mmc_version,
    pub irq: c_int,
    ...
    pub irq_mask: u32,
    pub lock: spinlock_t,
    pub timeout_timer: timer_list,
    pub miter: sg_mapping_iter,
    pub state: enum jz4740_mmc_state,
// DMA support
...
//
pub const JZ4740_MMC_FIFO_HALF_SIZE: c_int = 8;
}
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_read_irq_reg(host: *mut jz4740_mmc_host) -> u32 {
...
// DMA infrastructure
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_release_dma_channels(host: *mut jz4740_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_acquire_dma_channels(host: *mut jz4740_mmc_host) -> c_int {
...
//
    ...
    let mut dir: enum dma_data_direction = mmc_get_dma_dir(data);
...
// ----------------------------------------------------------------------------
    ...
    bool start_transfer)
    {
    let mut val: u16 = JZ_MMC_STRPCL_CLOCK_START;
    if (start_transfer)
    val |= JZ_MMC_STRPCL_START_OP;
    writew(val, host.base + JZ_REG_MMC_STRPCL);
    }
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_clock_disable(host: *mut jz4740_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_reset(host: *mut jz4740_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_request_done(host: *mut jz4740_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_timeout(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn jz_mmc_prepare_data_transfer(host: *mut jz4740_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn jz_mmc_irq_worker(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn jz_mmc_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_set_clock_rate(host: *mut jz4740_mmc_host, rate: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_request(mmc: *mut mmc_host, req: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_enable_sdio_irq(mmc: *mut mmc_host, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_voltage_switch(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_probe(pdev: *mut *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_suspend(dev: *mut device) -> c_int {
    static int jz4740_mmc_suspend(struct device *dev)
    {
    return pinctrl_pm_select_sleep_state(dev);
    }
#[no_mangle]
unsafe extern "C" fn jz4740_mmc_resume(dev: *mut device) -> c_int {
