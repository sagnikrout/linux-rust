...
//! Source: drivers/mmc/host/sdhci_am654.c
#![no_std]
...
// CTL_CFG Registers
pub const CTL_CFG_2: c_uint = 0x14;
pub const CTL_CFG_3: c_uint = 0x18;

// PHY Registers
pub const PHY_CTRL1: c_uint = 0x100;
pub const PHY_CTRL2: c_uint = 0x104;
pub const PHY_CTRL3: c_uint = 0x108;
pub const PHY_CTRL4: c_uint = 0x10C;
pub const PHY_CTRL5: c_uint = 0x110;
pub const PHY_CTRL6: c_uint = 0x114;
pub const PHY_STAT1: c_uint = 0x130;
pub const PHY_STAT2: c_uint = 0x134;
pub const IOMUX_ENABLE_SHIFT: c_int = 31;

pub const OTAPDLYENA_SHIFT: c_int = 20;

pub const OTAPDLYSEL_SHIFT: c_int = 12;

pub const STRBSEL_SHIFT: c_int = 24;

pub const SEL50_SHIFT: c_int = 8;

pub const SEL100_SHIFT: c_int = 9;

pub const FREQSEL_SHIFT: c_int = 8;

pub const CLKBUFSEL_SHIFT: c_int = 0;

pub const DLL_TRIM_ICP_SHIFT: c_int = 4;

pub const DR_TY_SHIFT: c_int = 20;

pub const ENDLL_SHIFT: c_int = 1;

pub const DLLRDY_SHIFT: c_int = 0;

pub const PDB_SHIFT: c_int = 0;

pub const CALDONE_SHIFT: c_int = 1;

pub const RETRIM_SHIFT: c_int = 17;

pub const SELDLYTXCLK_SHIFT: c_int = 17;

pub const SELDLYRXCLK_SHIFT: c_int = 16;

pub const ITAPDLYSEL_SHIFT: c_int = 0;

pub const ITAPDLYENA_SHIFT: c_int = 8;

pub const ITAPCHGWIN_SHIFT: c_int = 9;

pub const DRIVER_STRENGTH_50_OHM: c_uint = 0x0;
pub const DRIVER_STRENGTH_33_OHM: c_uint = 0x1;
pub const DRIVER_STRENGTH_66_OHM: c_uint = 0x2;
pub const DRIVER_STRENGTH_100_OHM: c_uint = 0x3;
pub const DRIVER_STRENGTH_40_OHM: c_uint = 0x4;
pub const CLOCK_TOO_SLOW_HZ: c_int = 50000000;

pub const RETRY_TUNING_MAX: c_int = 10;
// Command Queue Host Controller Interface Base address
pub const SDHCI_AM654_CQE_BASE_ADDR: c_uint = 0x200;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct timing_data {
    pub otap_binding: *const c_char,
    pub itap_binding: *const c_char,
    pub capability: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_am654_data {
    pub base: *mut regmap,
    pub otap_del_sel: [u32; ARRAY_SIZE(td)],
    pub itap_del_sel: [u32; ARRAY_SIZE(td)],
    pub itap_del_ena: [u32; ARRAY_SIZE(td)],
    pub clkbuf_sel: c_int,
    pub trm_icp: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_am654_driver_data {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_setup_dll(host: *mut sdhci_host, clock: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_set_clock(host: *mut sdhci_host, clock: c_uint) {
    static void sdhci_am654_set_clock(struct sdhci_host *host, unsigned int clock)
    {
    struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
    struct sdhci_am654_data *sdhci_am654 = sdhci_pltfm_priv(pltfm_host);
    let mut timing: c_uchar = host.mmc.ios.timing;
    u32 otap_del_sel;
    u32 mask, val;
    regmap_update_bits(sdhci_am654.base, PHY_CTRL1, ENDLL_MASK, 0);
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_start_signal_voltage_switch(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_write_power_on(host: *mut sdhci_host, val: u8, reg: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_write_b(host: *mut sdhci_host, val: u8, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_reset(host: *mut sdhci_host, mask: u8) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_cqhci_irq(host: *mut sdhci_host, intmask: u32) -> u32 {
...
pub const ITAPDLY_LENGTH: c_int = 32;

    static int sdhci_am654_calculate_itap(struct sdhci_host *host, struct window
// fail_window, u8 num_fails, bool circular_buffer)
    {
    let mut itap: u8 = 0, start_fail = 0, end_fail = 0, pass_length = 0;
    let mut first_fail_start: u8 = 0, last_fail_end = 0;
    struct device *dev = mmc_dev(host.mmc);
    let mut pass_window: window = {0, 0, 0};
    let mut prev_fail_end: c_int = -1;
    u8 i;
    if (!num_fails) {
// Retry tuning
...
// Retry tuning
    ...
    struct device *dev = mmc_dev(host.mmc);
    u8 curr_pass, itap;
    let mut fail_index: u8 = 0;
    let mut prev_pass: u8 = 1;
    memset(fail_window, 0, sizeof(fail_window));
// Enable ITAPDLY
    sdhci_am654.itap_del_ena[timing] = 0x1;
    for (itap = 0; itap < ITAPDLY_LENGTH; itap++) {
    sdhci_am654_write_itapdly(sdhci_am654, itap, sdhci_am654.itap_del_ena[timing]);
    curr_pass = !mmc_send_tuning(host.mmc, opcode, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_dumpregs(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_cqe_add_host(host: *mut sdhci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_init(host: *mut sdhci_host) -> c_int {
    static int sdhci_am654_init(struct sdhci_host *host)
    {
    struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
    struct sdhci_am654_data *sdhci_am654 = sdhci_pltfm_priv(pltfm_host);
    struct device *dev = mmc_dev(host.mmc);
    let mut ctl_cfg_2: u32 = 0;
    u32 mask;
    u32 val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_restore(host: *mut sdhci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_am654_runtime_resume(dev: *mut device) -> c_int {
...
// Enable the clock
    ...
    RUNTIME_PM_OPS(sdhci_am654_runtime_suspend, sdhci_am654_runtime_resume, core::ptr::null_mut())
