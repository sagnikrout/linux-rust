...
//! Source: drivers/mmc/host/meson-mx-sdhc-mmc.c
#![no_std]
...
pub const MESON_SDHC_NUM_BULK_CLKS: c_int = 4;
pub const MESON_SDHC_MAX_BLK_SIZE: c_int = 512;
pub const MESON_SDHC_NUM_TUNING_TRIES: c_int = 10;
pub const MESON_SDHC_WAIT_CMD_READY_SLEEP_US: c_int = 1;
pub const MESON_SDHC_WAIT_CMD_READY_TIMEOUT_US: c_int = 100000;
pub const MESON_SDHC_WAIT_BEFORE_SEND_SLEEP_US: c_int = 1;
pub const MESON_SDHC_WAIT_BEFORE_SEND_TIMEOUT_US: c_int = 200;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_mx_sdhc_data {
    pub mmc): *mut *mut void (init_hw)(struct mmc_host,
    pub mmc): *mut *mut void (set_pdma)(struct mmc_host,
    pub mmc): *mut *mut void (wait_before_send)(struct mmc_host,
    pub hardware_flush_all_cmds: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct meson_mx_sdhc_host {
    ...
    pub pclk: *mut clk,
    pub sd_clk: *mut clk,
    pub bulk_clks: [clk_bulk_data; MESON_SDHC_NUM_BULK_CLKS],
    pub bulk_clks_enabled: bool,
    pub platform: *const meson_mx_sdhc_data,
}
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_reset(host: *mut meson_mx_sdhc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_clear_fifo(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_wait_cmd_ready(mmc: *mut mmc_host) {
    ...
    {
    struct meson_mx_sdhc_host *host = mmc_priv(mmc);
    let mut manual_stop: bool = false;
    u32 ictl, send;
    int pack_len;
    host.cmd = cmd;
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_disable_clks(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_enable_clks(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_set_clk(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
    static void meson_mx_sdhc_set_ios(struct mmc_host *mmc, struct mmc_ios *ios)
    {
    struct meson_mx_sdhc_host *host = mmc_priv(mmc);
    let mut vdd: c_ushort = ios.vdd;
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_map_dma(mmc: *mut mmc_host, mrq: *mut mmc_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_card_busy(mmc: *mut mmc_host) -> c_int {
    ...
    let mut num_matches: return = = MESON_SDHC_NUM_TUNING_TRIES;
    }
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: best_len) -> else {
    else if (best_len)
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_request_done(host: *mut meson_mx_sdhc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_read_response(host: *mut meson_mx_sdhc_host, idx: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
    ...
    cmd.error = -EIO;
#[no_mangle]
pub unsafe extern "C" fn if(MESON_SDHC_ISTA_RESP_ERR_CRC: ista &) -> else {
    else if (ista & MESON_SDHC_ISTA_RESP_ERR_CRC)
    cmd.error = -EILSEQ;
#[no_mangle]
pub unsafe extern "C" fn if(MESON_SDHC_ISTA_RESP_TIMEOUT: ista &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(MESON_SDHC_ISTA_DATA_TIMEOUT: ista &) -> else {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_irq_thread(irq: c_int, irq_data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_init_hw_meson8(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_set_pdma_meson8(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_wait_before_send_meson8(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_init_hw_meson8m2(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_set_pdma_meson8m2(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_init_hw(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn meson_mx_sdhc_remove(pdev: *mut platform_device) {
