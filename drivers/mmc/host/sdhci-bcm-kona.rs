...
//! Source: drivers/mmc/host/sdhci-bcm-kona.c
#![no_std]
...
pub const SDHCI_SOFT_RESET: c_uint = 0x01000000;
pub const KONA_SDHOST_CORECTRL: c_uint = 0x8000;
pub const KONA_SDHOST_CD_PINCTRL: c_uint = 0x00000008;
pub const KONA_SDHOST_STOP_HCLK: c_uint = 0x00000004;
pub const KONA_SDHOST_RESET: c_uint = 0x00000002;
pub const KONA_SDHOST_EN: c_uint = 0x00000001;
pub const KONA_SDHOST_CORESTAT: c_uint = 0x8004;
pub const KONA_SDHOST_WP: c_uint = 0x00000002;
pub const KONA_SDHOST_CD_SW: c_uint = 0x00000001;
pub const KONA_SDHOST_COREIMR: c_uint = 0x8008;
pub const KONA_SDHOST_IP: c_uint = 0x00000001;
pub const KONA_SDHOST_COREISR: c_uint = 0x800C;
pub const KONA_SDHOST_COREIMSR: c_uint = 0x8010;
pub const KONA_SDHOST_COREDBG1: c_uint = 0x8014;
pub const KONA_SDHOST_COREGPO_MASK: c_uint = 0x8018;
pub const SD_DETECT_GPIO_DEBOUNCE_128MS: c_int = 128;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_bcm_kona_dev {
    pub /: *mut *mut mutex write_lock; / protect back to back writes,
}

#[no_mangle]
unsafe extern "C" fn sdhci_bcm_kona_sd_reset(host: *mut sdhci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_bcm_kona_sd_init(host: *mut sdhci_host) {
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_bcm_kona_sd_card_emulate(host: *mut sdhci_host, insert: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sdhci_bcm_kona_card_event(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_bcm_kona_probe(pdev: *mut platform_device) -> c_int {
    static int sdhci_bcm_kona_probe(struct platform_device *pdev)
    {
    struct sdhci_bcm_kona_dev *kona_dev = core::ptr::null_mut();
...
// Get and enable the core clock
    pltfm_priv.clk = devm_clk_get(dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sdhci_bcm_kona_remove(pdev: *mut platform_device) {
