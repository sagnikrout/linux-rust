...
pub const VENDOR_V_22: c_uint = 0x12;
pub const VENDOR_V_23: c_uint = 0x13;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct esdhc_clk_fixup {
    pub sd_dflt_max_clk: c_uint,
    pub max_clk: [c_uint; MMC_TIMING_NUM],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_esdhc {
    pub vendor_ver: u8,
    pub spec_ver: u8,
    pub quirk_incorrect_hostver: bool,
    pub quirk_limited_clk_division: bool,
    pub quirk_unreliable_pulse_detection: bool,
    pub quirk_tuning_erratum_type1: bool,
    pub quirk_tuning_erratum_type2: bool,
    pub quirk_ignore_data_inhibit: bool,
    pub quirk_delay_before_data_reset: bool,
    pub quirk_trans_complete_erratum: bool,
    pub in_sw_tuning: bool,
    pub peripheral_clock: c_uint,
    pub clk_fixup: *const esdhc_clk_fixup,
    pub div_ratio: u32,
}
...
//
    ...
    struct sdhci_esdhc *esdhc = sdhci_pltfm_priv(pltfm_host);
    u16 ret;
    let mut shift: c_int = (spec_reg & 0x2) * 8;
...
//
    ...
    u8 ret;
    u8 dma_bits;
    let mut shift: c_int = (spec_reg & 0x3) * 8;
...
#[no_mangle]
unsafe extern "C" fn esdhc_be_readl(host: *mut sdhci_host, reg: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn esdhc_le_readl(host: *mut sdhci_host, reg: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn esdhc_be_readw(host: *mut sdhci_host, reg: c_int) -> u16 {
    static u16 esdhc_be_readw(struct sdhci_host *host, int reg)
    {
    u16 ret;
    u32 value;
    let mut base: c_int = reg & ~0x3;
    value = ioread32be(host.ioaddr + base);
    ret = esdhc_readw_fixup(host, reg, value);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn esdhc_le_readw(host: *mut sdhci_host, reg: c_int) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn esdhc_be_readb(host: *mut sdhci_host, reg: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn esdhc_le_readb(host: *mut sdhci_host, reg: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn esdhc_be_writel(host: *mut sdhci_host, val: u32, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_le_writel(host: *mut sdhci_host, val: u32, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_be_writew(host: *mut sdhci_host, val: u16, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_le_writew(host: *mut sdhci_host, val: u16, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_be_writeb(host: *mut sdhci_host, val: u8, reg: c_int) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_le_writeb(host: *mut sdhci_host, val: u8, reg: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn esdhc_of_adma_workaround(host: *mut sdhci_host, intmask: u32) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_of_enable_dma(host: *mut sdhci_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esdhc_of_get_max_clock(host: *mut sdhci_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn esdhc_of_get_min_clock(host: *mut sdhci_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn esdhc_clock_enable(host: *mut sdhci_host, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_flush_async_fifo(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_of_set_clock(host: *mut sdhci_host, clock: c_uint) {
    static void esdhc_of_set_clock(struct sdhci_host *host, unsigned int clock)
    {
    struct sdhci_pltfm_host *pltfm_host = sdhci_priv(host);
    struct sdhci_esdhc *esdhc = sdhci_pltfm_priv(pltfm_host);
    let mut pre_div: c_uint = 1, div = 1;
    let mut clock_fixup: c_uint = 0;
    ktime_t timeout;
    u32 temp;
    if (clock == 0) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: esdhc->clk_fixup) -> else {
...
pub const SCFG_SDHCIOVSELCR: c_uint = 0x408;
pub const SDHCIOVSELCR_TGLEN: c_uint = 0x80000000;
pub const SDHCIOVSELCR_VSELVAL: c_uint = 0x60000000;
pub const SDHCIOVSELCR_SDHC_VS: c_uint = 0x00000001;
    static int esdhc_signal_voltage_switch(struct mmc_host *mmc,
    struct mmc_ios *ios)
    {
    struct sdhci_host *host = mmc_priv(mmc);
    struct device_node *scfg_node;
    void __iomem *scfg_base = core::ptr::null_mut();
    u32 sdhciovselcr;
    u32 val;
//
...
//
    ...
    scfg_node = of_find_matching_node(core::ptr::null_mut(), scfg_device_ids);
    if (scfg_node)
...
#[no_mangle]
unsafe extern "C" fn esdhc_tuning_block_enable(host: *mut sdhci_host, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esdhc_irq(host: *mut sdhci_host, intmask: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn esdhc_of_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn esdhc_of_resume(dev: *mut device) -> c_int {
    static int esdhc_of_resume(struct device *dev)
    {
    struct sdhci_host *host = dev_get_drvdata(dev);
    let mut ret: c_int = sdhci_resume_host(host);
    if (ret == 0) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_init(pdev: *mut platform_device, host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn esdhc_hs400_prepare_ddr(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_esdhc_probe(pdev: *mut platform_device) -> c_int {
    ...
    tp = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "fsl,p2020-esdhc");
    if (tp) {
    of_node_put(tp);
