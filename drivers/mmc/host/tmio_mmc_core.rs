...
//! Source: drivers/mmc/host/tmio_mmc_core.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_end_dma(host: *mut tmio_mmc_host) {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_enable_dma(host: *mut tmio_mmc_host, enable: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_release_dma(host: *mut tmio_mmc_host) {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_abort_dma(host: *mut tmio_mmc_host) {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_dataend_dma(host: *mut tmio_mmc_host) {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_enable_mmc_irqs(host: *mut tmio_mmc_host, i: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_disable_mmc_irqs(host: *mut tmio_mmc_host, i: u32) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_ack_mmc_irqs(host: *mut tmio_mmc_host, i: u32) {
    static void tmio_mmc_ack_mmc_irqs(struct tmio_mmc_host *host, u32 i)
    {
    sd_ctrl_write32_as_16_and_16(host, CTL_STATUS, ~i);
    }
#[no_mangle]
unsafe extern "C" fn tmio_mmc_init_sg(host: *mut tmio_mmc_host, data: *mut mmc_data) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_next_sg(host: *mut tmio_mmc_host) -> c_int {
...
pub const CMDREQ_TIMEOUT: c_int = 5000;
#[no_mangle]
unsafe extern "C" fn tmio_mmc_enable_sdio_irq(mmc: *mut mmc_host, enable: c_int) {
...
// reg now applies to MMC_BUS_WIDTH_4
    ...
    reg |= CARD_OPT_WIDTH;
#[no_mangle]
pub unsafe extern "C" fn if(MMC_BUS_WIDTH_8: bus_width ==) -> else {
    else if (bus_width == MMC_BUS_WIDTH_8)
    reg |= CARD_OPT_WIDTH8;
    sd_ctrl_write16(host, CTL_SD_MEM_CARD_OPT, reg);
    }
#[no_mangle]
unsafe extern "C" fn tmio_mmc_reset(host: *mut tmio_mmc_host, preserve: bool) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_reset_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: host->cmd) -> else {
    else if (host.cmd)
...
pub const APP_CMD: c_uint = 0x0040;
pub const RESP_NONE: c_uint = 0x0300;
pub const RESP_R1: c_uint = 0x0400;
pub const RESP_R1B: c_uint = 0x0500;
pub const RESP_R2: c_uint = 0x0600;
pub const RESP_R3: c_uint = 0x0700;
pub const DATA_PRESENT: c_uint = 0x0800;
pub const TRANSFER_READ: c_uint = 0x1000;
pub const TRANSFER_MULTI: c_uint = 0x2000;
pub const SECURITY_CMD: c_uint = 0x4000;
pub const NO_CMD12_ISSUE: c_uint = 0x4000 /* TMIO_MMC_HAVE_CMD12_CTRL */;
    static int tmio_mmc_start_command(struct tmio_mmc_host *host,
    struct mmc_command *cmd)
    {
    struct mmc_data *data = host.data;
    let mut c: c_int = cmd.opcode;
...
// Fire off the command
    ...
    unsigned int count)
    {
    let mut is_read: c_int = host.data.flags & MMC_DATA_READ;
    u8  *buf8;
//
// Transfer the data
//
...
//
#[no_mangle]
unsafe extern "C" fn tmio_mmc_pio_irq(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_check_bounce_buffer(host: *mut tmio_mmc_host) {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_do_data_irq(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_data_irq(host: *mut tmio_mmc_host, stat: c_uint) {
    ...
    let mut status: u32 = sd_ctrl_read16_and_16_as_32(host, CTL_STATUS);
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_cmd_irq(host: *mut tmio_mmc_host, stat: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn __tmio_mmc_sdio_irq(host: *mut tmio_mmc_host) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_irq(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
// Some hardware cannot perform 2 byte requests in 4/8 bit mode
    ...
    let mut blksz_2bytes: c_int = pdata.flags & TMIO_MMC_BLKSZ_2BYTES;
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_finish_request(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_done_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_power_on(host: *mut tmio_mmc_host, vdd: c_ushort) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_power_off(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_get_timeout_cycles(host: *mut tmio_mmc_host) -> c_uint {
    static unsigned int tmio_mmc_get_timeout_cycles(struct tmio_mmc_host *host)
    {
    let mut val: u16 = sd_ctrl_read16(host, CTL_SD_MEM_CARD_OPT);
    val = (val & CARD_OPT_TOP_MASK) >> CARD_OPT_TOP_SHIFT;
    return 1 << (13 + val);
    }
#[no_mangle]
unsafe extern "C" fn tmio_mmc_max_busy_timeout(host: *mut tmio_mmc_host) {
    static void tmio_mmc_max_busy_timeout(struct tmio_mmc_host *host)
    {
    let mut clk_rate: c_uint = host.mmc.actual_clock ?: host.mmc.f_max;
...
//
#[no_mangle]
unsafe extern "C" fn tmio_mmc_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_get_ro(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_get_cd(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_init_ocr(host: *mut tmio_mmc_host) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_host_probe(_host: *mut tmio_mmc_host) -> c_int {
...
//
    ...
    _host.write16_hook = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_host_remove(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_clk_enable(host: *mut tmio_mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tmio_mmc_clk_disable(host: *mut tmio_mmc_host) {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_host_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tmio_mmc_host_runtime_resume(dev: *mut device) -> c_int {
