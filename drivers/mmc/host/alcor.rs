...
//! Source: drivers/mmc/host/alcor.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct alcor_pll_conf {
    pub clk_src_freq: c_uint,
    pub clk_src_reg: c_uint,
    pub min_div: c_uint,
    pub max_div: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct alcor_sdmmc_host {
    pub dev: *mut device,
    pub alcor_pci: *mut alcor_pci_priv,
    ...
    pub sg_count: c_int,
    pub irq_status_sd: u32,
    pub cur_power_mode: c_uchar,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn alcor_mask_sd_irqs(host: *mut alcor_sdmmc_host) {
...
#[no_mangle]
pub unsafe extern "C" fn alcor_unmask_sd_irqs(host: *mut alcor_sdmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn alcor_reset(host: *mut alcor_sdmmc_host, val: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn alcor_data_set_dma(host: *mut alcor_sdmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn alcor_trigger_data_transfer(host: *mut alcor_sdmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn alcor_trf_block_pio(host: *mut alcor_sdmmc_host, read: bool) {
...
#[no_mangle]
unsafe extern "C" fn alcor_prepare_sg_miter(host: *mut alcor_sdmmc_host) {
    static void alcor_prepare_sg_miter(struct alcor_sdmmc_host *host)
    {
    let mut flags: c_uint = SG_MITER_ATOMIC;
    struct mmc_data *data = host.data;
...
#[no_mangle]
unsafe extern "C" fn alcor_finish_data(host: *mut alcor_sdmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn alcor_err_irq(host: *mut alcor_sdmmc_host, intmask: u32) {
...
#[no_mangle]
unsafe extern "C" fn alcor_cmd_irq_done(host: *mut alcor_sdmmc_host, intmask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alcor_cmd_irq_thread(host: *mut alcor_sdmmc_host, intmask: u32) {
...
#[no_mangle]
unsafe extern "C" fn alcor_data_irq_done(host: *mut alcor_sdmmc_host, intmask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alcor_data_irq_thread(host: *mut alcor_sdmmc_host, intmask: u32) {
...
#[no_mangle]
unsafe extern "C" fn alcor_cd_irq(host: *mut alcor_sdmmc_host, intmask: u32) {
...
#[no_mangle]
unsafe extern "C" fn alcor_irq_thread(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn alcor_irq(irq: c_int, d: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn alcor_set_clock(host: *mut alcor_sdmmc_host, clock: c_uint) {
    static void alcor_set_clock(struct alcor_sdmmc_host *host, unsigned int clock)
    {
    struct alcor_pci_priv *priv = host.alcor_pci;
    int i, diff = 0x7fffffff, tmp_clock = 0;
    let mut clk_src: u16 = 0;
    let mut clk_div: u8 = 0;
    if (clock == 0) {
...
#[no_mangle]
unsafe extern "C" fn alcor_set_timing(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn alcor_set_bus_width(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn alcor_card_busy(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alcor_get_cd(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alcor_get_ro(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alcor_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn alcor_set_power_mode(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn alcor_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn alcor_timeout_timer(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn alcor_hw_init(host: *mut alcor_sdmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn alcor_hw_uninit(host: *mut alcor_sdmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn alcor_init_mmc(host: *mut alcor_sdmmc_host) {
...
#[no_mangle]
unsafe extern "C" fn alcor_pci_sdmmc_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alcor_pci_sdmmc_drv_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn alcor_pci_sdmmc_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alcor_pci_sdmmc_resume(dev: *mut device) -> c_int {
