...
//! Source: drivers/mmc/host/sdhci-sprd.c
#![no_std]
...
pub const SDHCI_SPRD_REG_32_DLL_CFG: c_uint = 0x200;

pub const SDHCI_SPRD_DLL_INIT_COUNT: c_uint = 0xc00;
pub const SDHCI_SPRD_DLL_PHASE_INTERNAL: c_uint = 0x3;
pub const SDHCI_SPRD_REG_32_DLL_DLY: c_uint = 0x204;
pub const SDHCI_SPRD_REG_32_DLL_DLY_OFFSET: c_uint = 0x208;

pub const SDHCI_SPRD_REG_32_DLL_STS0: c_uint = 0x210;

pub const SDHCI_SPRD_REG_32_BUSY_POSI: c_uint = 0x250;

pub const SDHCI_SPRD_REG_DEBOUNCE: c_uint = 0x28C;

pub const SDHCI_SPRD_INT_SIGNAL_MASK: c_uint = 0x1B7F410B;
// SDHCI_HOST_CONTROL2
pub const SDHCI_SPRD_CTRL_HS200: c_uint = 0x0005;
pub const SDHCI_SPRD_CTRL_HS400: c_uint = 0x0006;
pub const SDHCI_SPRD_CTRL_HS400ES: c_uint = 0x0007;
//
...
pub const SDHCI_SPRD_MAX_CUR: c_uint = 0xFFFFFF;
pub const SDHCI_SPRD_CLK_MAX_DIV: c_int = 1023;
pub const SDHCI_SPRD_CLK_DEF_RATE: c_int = 26000000;
pub const SDHCI_SPRD_PHY_DLL_CLK: c_int = 52000000;
pub const SDHCI_SPRD_MAX_RANGE: c_uint = 0xff;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdhci_sprd_host {
    pub version: u32,
    pub clk_sdio: *mut clk,
    pub clk_enable: *mut clk,
    pub clk_2x_enable: *mut clk,
    pub pinctrl: *mut pinctrl,
    pub pins_uhs: *mut pinctrl_state,
    pub pins_default: *mut pinctrl_state,
    pub base_rate: u32,
    pub /: *mut *mut int flags; / backup of host attribute,
    pub 2]: u32 phy_delay[MMC_TIMING_MMC_HS400 +,
}
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_init_config(host: *mut sdhci_host) {
...
#[no_mangle]
pub unsafe extern "C" fn sdhci_sprd_readl(host: *mut sdhci_host, reg: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn sdhci_sprd_writel(host: *mut sdhci_host, val: u32, reg: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sdhci_sprd_writew(host: *mut sdhci_host, val: u16, reg: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sdhci_sprd_writeb(host: *mut sdhci_host, val: u8, reg: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn sdhci_sprd_sd_clk_off(host: *mut sdhci_host) {
    static inline void sdhci_sprd_sd_clk_off(struct sdhci_host *host)
    {
    let mut ctrl: u16 = sdhci_readw(host, SDHCI_CLOCK_CONTROL);
    ctrl &= ~SDHCI_CLOCK_CARD_EN;
    sdhci_writew(host, ctrl, SDHCI_CLOCK_CONTROL);
    }
#[no_mangle]
pub unsafe extern "C" fn sdhci_sprd_sd_clk_on(host: *mut sdhci_host) {
...
#[no_mangle]
pub unsafe extern "C" fn sdhci_sprd_calc_div(base_clk: u32, clk: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_enable_phy_dll(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_set_clock(host: *mut sdhci_host, clock: c_uint) {
    static void sdhci_sprd_set_clock(struct sdhci_host *host, unsigned int clock)
    {
    let mut en: bool = false, clk_changed = false;
    if (clock == 0) {
    sdhci_writew(host, 0, SDHCI_CLOCK_CONTROL);
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_get_max_clock(host: *mut sdhci_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_get_min_clock(host: *mut sdhci_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_hw_reset(host: *mut sdhci_host) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_get_max_timeout_count(host: *mut sdhci_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_get_ro(host: *mut sdhci_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_voltage_switch(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mmc_send_tuning_cmd(card: *mut mmc_card) -> c_int {
    static int mmc_send_tuning_cmd(struct mmc_card *card)
    {
    return mmc_send_status(card, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn mmc_send_tuning_data(card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_get_best_clk_sample(mmc: *mut mmc_host, value: *mut u8) -> c_int {
    static int sdhci_sprd_get_best_clk_sample(struct mmc_host *mmc, u8 *value)
    {
    let mut range_end: c_int = SDHCI_SPRD_MAX_RANGE;
    let mut range_length: c_int = 0;
    let mut middle_range: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_prepare_sd_hs_cmd_tuning(mmc: *mut mmc_host, card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_execute_sd_hs_data_tuning(mmc: *mut mmc_host, card: *mut mmc_card) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdhci_sprd_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(sdhci_sprd_runtime_suspend, sdhci_sprd_runtime_resume, core::ptr::null_mut())
    };
