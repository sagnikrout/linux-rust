...
//! Source: drivers/mmc/host/rtsx_pci_sdmmc.c
#![no_std]
...
pub struct realtek_pci_sdmmc {
    ...
    pub host_mutex: mutex,
    pub ssc_depth: u8,
    pub clock: c_uint,
    pub vpclk: bool,
    pub double_clk: bool,
    pub eject: bool,
    pub initial_mode: bool,
    pub prev_power_state: c_int,
    pub sg_count: c_int,
    pub cookie: i32,
    pub cookie_sg_count: c_int,
    pub using_cookie: bool,
}
...
#[no_mangle]
pub unsafe extern "C" fn sd_clear_error(host: *mut realtek_pci_sdmmc) {
...
#[no_mangle]
unsafe extern "C" fn dump_reg_range(host: *mut realtek_pci_sdmmc, start: u16, end: u16) {
    static void dump_reg_range(struct realtek_pci_sdmmc *host, u16 start, u16 end)
    {
    let mut len: u16 = end - start + 1;
    int i;
    u8 data[8];
    for (i = 0; i < len; i += 8) {
    int j;
    let mut n: c_int = min(8, len - i);
...
#[no_mangle]
unsafe extern "C" fn sd_print_debug_regs(host: *mut realtek_pci_sdmmc) {
...
// Macro flag: #define sd_print_debug_regs(host)

#[no_mangle]
pub unsafe extern "C" fn sd_get_cd_int(host: *mut realtek_pci_sdmmc) -> c_int {
    static inline int sd_get_cd_int(struct realtek_pci_sdmmc *host)
    {
    return rtsx_pci_readl(host.pcr, RTSX_BIPR) & SD_EXIST;
    }
#[no_mangle]
unsafe extern "C" fn sd_cmd_set_sd_cmd(pcr: *mut rtsx_pcr, cmd: *mut mmc_command) {
...
#[no_mangle]
unsafe extern "C" fn sd_cmd_set_data_len(pcr: *mut rtsx_pcr, blocks: u16, blksz: u16) {
...
#[no_mangle]
unsafe extern "C" fn sd_response_type(cmd: *mut mmc_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_status_index(resp_type: c_int) -> c_int {
    static int sd_status_index(int resp_type)
    {
    if (resp_type == SD_RSP_TYPE_R0)
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if(SD_RSP_TYPE_R2: resp_type ==) -> else {
...
//
    ...
    let mut read: c_int = data.flags & MMC_DATA_READ;
    let mut count: c_int = 0;
    let mut using_cookie: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn sdmmc_pre_req(mmc: *mut mmc_host, mrq: *mut mmc_request) {
    ...
    {
    struct rtsx_pcr *pcr = host.pcr;
    let mut cmd_idx: u8 = (u8)cmd.opcode;
    let mut arg: u32 = cmd.arg;
    let mut err: c_int = 0;
    ...
    int rsp_type;
    int stat_idx;
    let mut clock_toggled: bool = false;
...
//
    ...
    struct mmc_data *data = mrq.data;
    let mut uhs: c_int = mmc_card_uhs(card);
    let mut cfg2: u8 = 0;
    int err;
    int resp_type;
    let mut data_len: usize = data.blksz * data.blocks;
    dev_dbg(sdmmc_dev(host), "%s: SD/MMC CMD %d, arg = 0x%08x\n",
    __func__, cmd.opcode, cmd.arg);
...
#[no_mangle]
pub unsafe extern "C" fn sd_enable_initial_mode(host: *mut realtek_pci_sdmmc) {
...
#[no_mangle]
pub unsafe extern "C" fn sd_disable_initial_mode(host: *mut realtek_pci_sdmmc) {
...
#[no_mangle]
unsafe extern "C" fn sd_rw_multi(host: *mut realtek_pci_sdmmc, mrq: *mut mmc_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn test_phase_bit(phase_map: u32, bit: c_uint) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sd_get_phase_len(phase_map: u32, start_bit: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_search_final_phase(host: *mut realtek_pci_sdmmc, phase_map: u32) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn sd_wait_data_idle(host: *mut realtek_pci_sdmmc) {
    ...
    cmd.opcode = opcode;
    err = sd_read_data(host, &cmd, 0x40, core::ptr::null_mut(), 0, 100);
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn sd_tuning_rx(host: *mut realtek_pci_sdmmc, opcode: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sd_rw_cmd(cmd: *mut mmc_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_request(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_request(mmc: *mut mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn sd_power_on(host: *mut realtek_pci_sdmmc, power_mode: c_uchar) -> c_int {
...
//
    ...
    sdmmc_init_sd_express(mmc, core::ptr::null_mut());
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn sd_power_off(host: *mut realtek_pci_sdmmc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sd_set_timing(host: *mut realtek_pci_sdmmc, timing: c_uchar) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_set_ios(mmc: *mut mmc_host, ios: *mut mmc_ios) {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_get_ro(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_get_cd(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_switch_voltage(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_card_busy(mmc: *mut mmc_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MMC_TIMING_UHS_DDR50: mmc->ios.timing ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn sdmmc_init_sd_express(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
    static int sdmmc_init_sd_express(struct mmc_host *mmc, struct mmc_ios *ios)
    {
    u32 relink_time;
    struct realtek_pci_sdmmc *host = mmc_priv(mmc);
...
#[no_mangle]
unsafe extern "C" fn init_extra_caps(host: *mut realtek_pci_sdmmc) {
...
#[no_mangle]
unsafe extern "C" fn realtek_init_host(host: *mut realtek_pci_sdmmc) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_pci_sdmmc_card_event(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn rtsx_pci_sdmmc_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtsx_pci_sdmmc_drv_remove(pdev: *mut platform_device) {
    ...
    struct mmc_host *mmc;
    pcr = host.pcr;
    pcr.slots[RTSX_SD_CARD].p_dev = core::ptr::null_mut();
    pcr.slots[RTSX_SD_CARD].card_event = core::ptr::null_mut();
    mmc = host.mmc;
