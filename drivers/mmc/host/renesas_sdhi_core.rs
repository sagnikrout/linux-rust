...
//! Source: drivers/mmc/host/renesas_sdhi_core.c
#![no_std]
...
pub const CTL_HOST_MODE: c_uint = 0xe4;

pub const HOST_MODE_GEN3_64BIT: c_int = 0;
pub const SDHI_VER_GEN2_SDR50: c_uint = 0x490c;
pub const SDHI_VER_RZ_A1: c_uint = 0x820b;
// very old datasheets said 0x490c for SDR104, too. They are wrong!
pub const SDHI_VER_GEN2_SDR104: c_uint = 0xcb0d;
pub const SDHI_VER_GEN3_SD: c_uint = 0xcc10;
pub const SDHI_VER_GEN3_SDMMC: c_uint = 0xcd10;
pub const SDHI_GEN3_MMC0_ADDR: c_uint = 0xee140000;
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sdbuf_width(host: *mut tmio_mmc_host, width: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn if(32: width ==) -> else {
    else if (width == 32)
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_clk_enable(host: *mut tmio_mmc_host) -> c_int {
...
// HS400 with 4TAP needs different clock settings
    let mut use_4tap: bool = sdhi_has_quirk(priv, hs400_4taps);
    let mut need_slow_clkh: bool = host.mmc.ios.timing == MMC_TIMING_MMC_HS400;
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_clk_disable(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_card_busy(mmc: *mut mmc_host) -> c_int {
...
// SCC registers
pub const SH_MOBILE_SDHI_SCC_DTCNTL: c_uint = 0x000;
pub const SH_MOBILE_SDHI_SCC_TAPSET: c_uint = 0x002;
pub const SH_MOBILE_SDHI_SCC_DT2FF: c_uint = 0x004;
pub const SH_MOBILE_SDHI_SCC_CKSEL: c_uint = 0x006;
pub const SH_MOBILE_SDHI_SCC_RVSCNTL: c_uint = 0x008;
pub const SH_MOBILE_SDHI_SCC_RVSREQ: c_uint = 0x00A;
pub const SH_MOBILE_SDHI_SCC_SMPCMP: c_uint = 0x00C;
pub const SH_MOBILE_SDHI_SCC_TMPPORT2: c_uint = 0x00E;
pub const SH_MOBILE_SDHI_SCC_TMPPORT3: c_uint = 0x014;
pub const SH_MOBILE_SDHI_SCC_TMPPORT4: c_uint = 0x016;
pub const SH_MOBILE_SDHI_SCC_TMPPORT5: c_uint = 0x018;
pub const SH_MOBILE_SDHI_SCC_TMPPORT6: c_uint = 0x01A;
pub const SH_MOBILE_SDHI_SCC_TMPPORT7: c_uint = 0x01C;

pub const SH_MOBILE_SDHI_SCC_DTCNTL_TAPNUM_SHIFT: c_int = 16;
pub const SH_MOBILE_SDHI_SCC_DTCNTL_TAPNUM_MASK: c_uint = 0xff;

// Definitions for values the SH_MOBILE_SDHI_SCC_TMPPORT4 register

// Definitions for values the SH_MOBILE_SDHI_SCC_TMPPORT5 register

pub const SH_MOBILE_SDHI_SCC_TMPPORT5_DLL_ADR_MASK: c_uint = 0x3F;
// Definitions for values the SH_MOBILE_SDHI_SCC register
pub const SH_MOBILE_SDHI_SCC_TMPPORT_DISABLE_WP_CODE: c_uint = 0xa5000000;
pub const SH_MOBILE_SDHI_SCC_TMPPORT_CALIB_CODE_MASK: c_uint = 0x1f;
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_init_tuning(host: *mut tmio_mmc_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_hs400_complete(mmc: *mut mmc_host) {
    static void renesas_sdhi_hs400_complete(struct mmc_host *mmc)
    {
    struct tmio_mmc_host *host = mmc_priv(mmc);
    struct renesas_sdhi *priv = host_to_priv(host);
    let mut bad_taps: u32 = priv.quirks ? priv.quirks.hs400_bad_taps : 0;
    let mut use_4tap: bool = sdhi_has_quirk(priv, hs400_4taps);
    sd_ctrl_write16(host, CTL_SD_CARD_CLK_CTL, ~CLK_CTL_SCLKEN &
    sd_ctrl_read16(host, CTL_SD_CARD_CLK_CTL));
// Set HS400 mode
...
// Avoid bad TAP
    ...
    let mut new_tap: u32 = (priv.tap_set + 1) % priv.tap_num;
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_disable_scc(mmc: *mut mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_adjust_hs400_mode_enable(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_adjust_hs400_mode_disable(host: *mut tmio_mmc_host) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_prepare_hs400_tuning(mmc: *mut mmc_host, ios: *mut mmc_ios) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_scc_reset(host: *mut tmio_mmc_host, priv: *mut renesas_sdhi) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_reset(host: *mut tmio_mmc_host, preserve: bool) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_gen3_get_cycles(host: *mut tmio_mmc_host) -> c_uint {
...
pub const SH_MOBILE_SDHI_MIN_TAP_ROW: c_int = 3;
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_select_tuning(host: *mut tmio_mmc_host) -> c_int {
    static int renesas_sdhi_select_tuning(struct tmio_mmc_host *host)
    {
    struct renesas_sdhi *priv = host_to_priv(host);
    let mut tap_start: c_uint = 0, tap_end = 0, tap_cnt = 0, rs, re, i;
    let mut taps_size: c_uint = priv.tap_num * 2, min_tap_row;
...
//
    ...
    let mut offset: c_int = priv.tap_num * (i < priv.tap_num ? 1 : -1);
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_execute_tuning(mmc: *mut mmc_host, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_manual_correction(host: *mut tmio_mmc_host, use_4tap: bool) -> bool {
    static bool renesas_sdhi_manual_correction(struct tmio_mmc_host *host, bool use_4tap)
    {
    struct renesas_sdhi *priv = host_to_priv(host);
    let mut new_tap: c_uint = priv.tap_set, error_tap = priv.tap_set;
    u32 val;
...
//
    ...
    let mut smpcmp: u32 = sd_scc_read32(host, priv, SH_MOBILE_SDHI_SCC_SMPCMP);
// DAT1 is unmatched because of an SDIO irq
    ...
    return true;    /* need retune */
#[no_mangle]
pub unsafe extern "C" fn if(SH_MOBILE_SDHI_SCC_RVSREQ_REQTAPUP: val &) -> else {
    else if (val & SH_MOBILE_SDHI_SCC_RVSREQ_REQTAPUP)
    new_tap++;
#[no_mangle]
pub unsafe extern "C" fn if(SH_MOBILE_SDHI_SCC_RVSREQ_REQTAPDOWN: val &) -> else {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_auto_correction(host: *mut tmio_mmc_host) -> bool {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_init_card(mmc: *mut mmc_host, card: *mut mmc_card) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_sdio_irq(host: *mut tmio_mmc_host) {
    static void renesas_sdhi_sdio_irq(struct tmio_mmc_host *host)
    {
// This controller requires retune when an SDIO irq occurs
    if (renesas_sdhi_check_scc_error(host, core::ptr::null_mut()))
    mmc_retune_needed(host.mmc);
    }
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_wait_idle(host: *mut tmio_mmc_host, bit: u32) -> c_int {
    static int renesas_sdhi_wait_idle(struct tmio_mmc_host *host, u32 bit)
    {
    let mut timeout: c_int = 1000;
// CBSY is set when busy, SCLKDIVEN is cleared when busy
    let mut wait_state: u32 = (bit == TMIO_STAT_CMD_BUSY ? TMIO_STAT_CMD_BUSY : 0);
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_write16_hook(host: *mut tmio_mmc_host, addr: c_int) -> c_int {
    static int renesas_sdhi_write16_hook(struct tmio_mmc_host *host, int addr)
    {
    let mut bit: u32 = TMIO_STAT_SCLKDIVEN;
    switch (addr) {
    case CTL_SD_CMD:
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_fixup_request(host: *mut tmio_mmc_host, mrq: *mut mmc_request) {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_enable_dma(host: *mut tmio_mmc_host, enable: bool) {
    static void renesas_sdhi_enable_dma(struct tmio_mmc_host *host, bool enable)
    {
// Iff regs are 8 byte apart, sdbuf is 64 bit. Otherwise always 32.
    let mut width: c_int = (host.bus_shift == 2) ? 64 : 32;
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn renesas_sdhi_regulator_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
// selector = 0;
    ...
    let mut rcfg: regulator_config = { .dev = &pdev.dev, };
...
//
    ...
    priv.rstc = devm_reset_control_get_optional_exclusive_deasserted(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(priv.rstc))
    ...
    mux_state = devm_mux_state_get_optional_selected(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(mux_state))
...
#[no_mangle]
pub unsafe extern "C" fn renesas_sdhi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
pub unsafe extern "C" fn renesas_sdhi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn renesas_sdhi_resume(dev: *mut device) -> c_int {
