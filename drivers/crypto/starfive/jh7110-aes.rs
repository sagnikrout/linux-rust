...
//! Source: drivers/crypto/starfive/jh7110-aes.c
#![no_std]
...
pub const STARFIVE_AES_REGS_OFFSET: c_uint = 0x100;

// Misc
pub const CCM_B0_ADATA: c_uint = 0x40;

#[no_mangle]
pub unsafe extern "C" fn starfive_aes_wait_busy(cryp: *mut starfive_cryp_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_wait_keydone(cryp: *mut starfive_cryp_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_wait_gcmdone(cryp: *mut starfive_cryp_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_gcm(cryp: *mut starfive_cryp_dev) -> c_int {
    static inline int is_gcm(struct starfive_cryp_dev *cryp)
    {
    return (cryp.flags & FLG_MODE_MASK) == STARFIVE_AES_MODE_GCM;
    }
#[no_mangle]
pub unsafe extern "C" fn is_encrypt(cryp: *mut starfive_cryp_dev) -> bool {
    static inline bool is_encrypt(struct starfive_cryp_dev *cryp)
    {
    return cryp.flags & FLG_ENCRYPT;
    }
#[no_mangle]
unsafe extern "C" fn starfive_aes_aead_hw_start(ctx: *mut starfive_cryp_ctx, hw_mode: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_set_alen(ctx: *mut starfive_cryp_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_set_mlen(ctx: *mut starfive_cryp_ctx) {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_ccm_check_iv(iv: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_write_iv(ctx: *mut starfive_cryp_ctx, iv: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_get_iv(cryp: *mut starfive_cryp_dev, iv: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_write_nonce(ctx: *mut starfive_cryp_ctx, nonce: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_write_key(ctx: *mut starfive_cryp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_ccm_init(ctx: *mut starfive_cryp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_hw_init(ctx: *mut starfive_cryp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_read_authtag(ctx: *mut starfive_cryp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_finish_req(ctx: *mut starfive_cryp_ctx) {
    static void starfive_aes_finish_req(struct starfive_cryp_ctx *ctx)
    {
    struct starfive_cryp_dev *cryp = ctx.cryp;
    let mut err: c_int = cryp.err;
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_gcm_write_adata(ctx: *mut starfive_cryp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_ccm_write_adata(ctx: *mut starfive_cryp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_dma_done(param: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_dma_init(cryp: *mut starfive_cryp_dev) {
    ...
    let mut ret: c_int = 0, in_save, out_save;
    alg_cr.v = 0;
    alg_cr.start = 1;
    alg_cr.aes_dma_en = 1;
    ...
    let mut remain: c_uint = cryp.total_in;
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_do_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_exit_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_aead_do_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_aead_exit_tfm(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_do_fallback(req: *mut skcipher_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_crypt(req: *mut skcipher_request, flags: c_ulong) -> c_int {
    static int starfive_aes_crypt(struct skcipher_request *req, unsigned long flags)
    {
    struct crypto_skcipher *tfm = crypto_skcipher_reqtfm(req);
    struct starfive_cryp_ctx *ctx = crypto_skcipher_ctx(tfm);
    struct starfive_cryp_dev *cryp = ctx.cryp;
    let mut blocksize_align: c_uint = crypto_skcipher_blocksize(tfm) - 1;
    cryp.flags = flags;
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_aead_do_fallback(req: *mut aead_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_aead_crypt(req: *mut aead_request, flags: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_ecb_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_ecb_decrypt(req: *mut skcipher_request) -> c_int {
    static int starfive_aes_ecb_decrypt(struct skcipher_request *req)
    {
    return starfive_aes_crypt(req, STARFIVE_AES_MODE_ECB);
    }
#[no_mangle]
unsafe extern "C" fn starfive_aes_cbc_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_cbc_decrypt(req: *mut skcipher_request) -> c_int {
    static int starfive_aes_cbc_decrypt(struct skcipher_request *req)
    {
    return starfive_aes_crypt(req, STARFIVE_AES_MODE_CBC);
    }
#[no_mangle]
unsafe extern "C" fn starfive_aes_ctr_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_ctr_decrypt(req: *mut skcipher_request) -> c_int {
    static int starfive_aes_ctr_decrypt(struct skcipher_request *req)
    {
    return starfive_aes_crypt(req, STARFIVE_AES_MODE_CTR);
    }
#[no_mangle]
unsafe extern "C" fn starfive_aes_gcm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_gcm_decrypt(req: *mut aead_request) -> c_int {
    static int starfive_aes_gcm_decrypt(struct aead_request *req)
    {
    return starfive_aes_aead_crypt(req, STARFIVE_AES_MODE_GCM);
    }
#[no_mangle]
unsafe extern "C" fn starfive_aes_ccm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_ccm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_aes_gcm_init_tfm(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_register_algs() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_aes_unregister_algs() {
