...
//! Source: drivers/crypto/starfive/jh7110-hash.c
#![no_std]
...
pub const STARFIVE_HASH_REGS_OFFSET: c_uint = 0x300;

pub const STARFIVE_HASH_RESET: c_uint = 0x2;
#[no_mangle]
pub unsafe extern "C" fn starfive_hash_wait_busy(cryp: *mut starfive_cryp_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_hash_wait_hmac_done(cryp: *mut starfive_cryp_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_hash_wait_key_done(ctx: *mut starfive_cryp_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_hmac_key(ctx: *mut starfive_cryp_ctx) -> c_int {
    static int starfive_hash_hmac_key(struct starfive_cryp_ctx *ctx)
    {
    struct starfive_cryp_request_ctx *rctx = ctx.rctx;
    struct starfive_cryp_dev *cryp = ctx.cryp;
    let mut klen: c_int = ctx.keylen, loop;
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_start(cryp: *mut starfive_cryp_dev) {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_dma_init(cryp: *mut starfive_cryp_dev) {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_copy_hash(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_done_task(cryp: *mut starfive_cryp_dev) {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hash_exit_tfm(hash: *mut crypto_ahash) {
    ...
    {
    struct starfive_cryp_ctx *ctx = crypto_ahash_ctx(hash);
    let mut digestsize: c_uint = crypto_ahash_digestsize(hash);
    let mut blocksize: c_uint = crypto_ahash_blocksize(hash);
    const char *alg_name;
...
#[no_mangle]
unsafe extern "C" fn starfive_sha224_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_sha256_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_sha384_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_sha512_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_sm3_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hmac_sha224_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hmac_sha256_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hmac_sha384_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hmac_sha512_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn starfive_hmac_sm3_init_tfm(hash: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn starfive_hash_register_algs() -> c_int {
    int starfive_hash_register_algs(void)
    {
    return crypto_engine_register_ahashes(algs_sha2_sm3, ARRAY_SIZE(algs_sha2_sm3));
    }
#[no_mangle]
pub unsafe extern "C" fn starfive_hash_unregister_algs() {
