...
//! Source: drivers/crypto/marvell/octeontx2/otx2_cptvf_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cptvf_enable_pfvf_mbox_intrs(cptvf: *mut otx2_cptvf_dev) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_disable_pfvf_mbox_intrs(cptvf: *mut otx2_cptvf_dev) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_register_interrupts(cptvf: *mut otx2_cptvf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptvf_pfvf_mbox_init(cptvf: *mut otx2_cptvf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptvf_pfvf_mbox_destroy(cptvf: *mut otx2_cptvf_dev) {
...
#[no_mangle]
unsafe extern "C" fn cptlf_work_handler(data: c_ulong) {
    static void cptlf_work_handler(unsigned long data)
    {
    otx2_cpt_post_process((struct otx2_cptlf_wqe *) data);
    }
#[no_mangle]
unsafe extern "C" fn cleanup_tasklet_work(lfs: *mut otx2_cptlfs_info) {
...
#[no_mangle]
unsafe extern "C" fn init_tasklet_work(lfs: *mut otx2_cptlfs_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_pending_queues(lfs: *mut otx2_cptlfs_info) {
...
#[no_mangle]
unsafe extern "C" fn alloc_pending_queues(lfs: *mut otx2_cptlfs_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lf_sw_cleanup(lfs: *mut otx2_cptlfs_info) {
...
#[no_mangle]
unsafe extern "C" fn lf_sw_init(lfs: *mut otx2_cptlfs_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptvf_lf_shutdown(lfs: *mut otx2_cptlfs_info) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_lf_init(cptvf: *mut otx2_cptvf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_cptvf_remove(pdev: *mut pci_dev) {
