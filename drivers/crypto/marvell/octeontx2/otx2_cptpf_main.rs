...
//! Source: drivers/crypto/marvell/octeontx2/otx2_cptpf_main.c
#![no_std]
...
pub const CPT_UC_RID_CN9K_B0: c_int = 1;
pub const CPT_UC_RID_CN10K_A: c_int = 4;
pub const CPT_UC_RID_CN10K_B: c_int = 5;
...
#[no_mangle]
unsafe extern "C" fn cptpf_flr_wq_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cptpf_vf_flr_intr(irq: int __always_unused, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cptpf_vf_me_intr(irq: int __always_unused, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cptpf_register_vfpf_intr(cptpf: *mut otx2_cptpf_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptpf_flr_wq_destroy(pf: *mut otx2_cptpf_dev) {
...
#[no_mangle]
unsafe extern "C" fn cptpf_flr_wq_init(cptpf: *mut otx2_cptpf_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptpf_vfpf_mbox_init(cptpf: *mut otx2_cptpf_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptpf_vfpf_mbox_destroy(cptpf: *mut otx2_cptpf_dev) {
...
#[no_mangle]
unsafe extern "C" fn cptpf_disable_afpf_mbox_intr(cptpf: *mut otx2_cptpf_dev) {
...
#[no_mangle]
unsafe extern "C" fn cptpf_register_afpf_mbox_intr(cptpf: *mut otx2_cptpf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptpf_afpf_mbox_init(cptpf: *mut otx2_cptpf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptpf_afpf_mbox_destroy(cptpf: *mut otx2_cptpf_dev) {
...
#[no_mangle]
unsafe extern "C" fn cpt_is_pf_usable(cptpf: *mut otx2_cptpf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptpf_get_rid(pdev: *mut pci_dev, cptpf: *mut otx2_cptpf_dev) {
    static void cptpf_get_rid(struct pci_dev *pdev, struct otx2_cptpf_dev *cptpf)
    {
    struct otx2_cpt_eng_grps *eng_grps = &cptpf.eng_grps;
    let mut reg_val: u64 = 0x0;
    if (is_dev_otx2(pdev)) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cpt_feature_sgv2(pdev)) -> else {
    else if (cpt_feature_sgv2(pdev))
    eng_grps.rid = CPT_UC_RID_CN10K_B;
    }
#[no_mangle]
unsafe extern "C" fn cptpf_check_block_implemented(cptpf: *mut otx2_cptpf_dev) {
...
#[no_mangle]
unsafe extern "C" fn cptpf_device_init(cptpf: *mut otx2_cptpf_dev) -> c_int {
    static int cptpf_device_init(struct otx2_cptpf_dev *cptpf)
    {
    let mut af_cnsts1: union otx2_cptx_af_constants1 = {0};
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn cptpf_sriov_disable(pdev: *mut pci_dev) -> c_int {
    static int cptpf_sriov_disable(struct pci_dev *pdev)
    {
    struct otx2_cptpf_dev *cptpf = pci_get_drvdata(pdev);
    let mut num_vfs: c_int = pci_num_vf(pdev);
    if (!num_vfs)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn cptpf_sriov_enable(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_cptpf_sriov_configure(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn otx2_cptpf_remove(pdev: *mut pci_dev) {
