...
//! Source: drivers/crypto/marvell/octeontx2/otx2_cptpf_mbox.c
#![no_std]
...
//
pub const OTX2_CPT_PF_DRV_VERSION: c_uint = 0x1;
...
#[no_mangle]
pub unsafe extern "C" fn otx2_cptpf_vfpf_mbox_intr(irq: int __always_unused, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_cptpf_vfpf_mbox_handler(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_cptpf_afpf_mbox_intr(irq: int __always_unused, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_cptpf_afpf_mbox_handler(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn otx2_cptpf_afpf_mbox_up_handler(work: *mut work_struct) {
