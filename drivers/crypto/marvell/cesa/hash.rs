...
//! Source: drivers/crypto/marvell/cesa/hash.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_cesa_ahash_dma_iter {
    pub base: mv_cesa_dma_iter,
    pub src: mv_cesa_sg_dma_iter,
}
    ...
    let mut len: c_uint = req.nbytes + creq.cache_ptr;
    if (!creq.last_req)
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_dma_free_padding(req: *mut mv_cesa_ahash_dma_req) {
    ...
    req.padding_dma);
    req.padding = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn mv_cesa_ahash_dma_last_cleanup(req: *mut ahash_request) {
...
#[no_mangle]
pub unsafe extern "C" fn mv_cesa_ahash_dma_cleanup(req: *mut ahash_request) {
...
#[no_mangle]
pub unsafe extern "C" fn mv_cesa_ahash_cleanup(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_last_cleanup(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_pad_len(creq: *mut mv_cesa_ahash_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_pad_req(creq: *mut mv_cesa_ahash_req, buf: *mut u8) -> c_int {
...
// Pad out to 56 mod 64
    ...
    if (creq.algo_le) {
    let mut bits: __le64 = cpu_to_le64(creq.len << 3);
    memcpy(buf + padlen, &bits, sizeof(bits));
    } else {
    let mut bits: __be64 = cpu_to_be64(creq.len << 3);
    memcpy(buf + padlen, &bits, sizeof(bits));
    }
    return padlen + 8;
    }
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_std_step(req: *mut ahash_request) {
    ...
    let mut new_cache_ptr: c_uint = 0;
    u32 frag_mode;
    size_t  len;
...
#[no_mangle]
pub unsafe extern "C" fn if(CESA_SA_DESC_CFG_MID_FRAG: frag_mode ==) -> else {
    ...
    let mut trailerlen: c_int = mv_cesa_ahash_pad_len(creq) + 8;
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_std_process(req: *mut ahash_request, status: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mv_cesa_ahash_dma_prepare(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_std_prepare(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_dma_step(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_step(req: *mut crypto_async_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_process(req: *mut crypto_async_request, status: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_complete(req: *mut crypto_async_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_req_cleanup(req: *mut crypto_async_request) {
...
#[no_mangle]
pub unsafe extern "C" fn mv_cesa_ahash_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_cache_req(req: *mut ahash_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_dma_req_init(req: *mut ahash_request) -> c_int {
    ...
    struct mv_cesa_op_ctx *op = core::ptr::null_mut();
    unsigned int frag_len;
    let mut set_state: bool = false;
    int ret;
    u32 type;
    basereq.chain.first = core::ptr::null_mut();
    basereq.chain.last = core::ptr::null_mut();
...
//
    ...
    frag_len, flags);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: frag_len) -> else {
    else if (frag_len)
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_req_init(req: *mut ahash_request, cached: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_queue_req(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahash_finup(req: *mut ahash_request) -> c_int {
    ...
    struct mv_cesa_ahash_req *creq = ahash_request_ctx(req);
    let mut digsize: c_uint = crypto_ahash_digestsize(ahash);
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_md5_init(req: *mut ahash_request) -> c_int {
    static int mv_cesa_md5_init(struct ahash_request *req)
    {
    struct mv_cesa_ahash_req *creq = ahash_request_ctx(req);
    let mut tmpl: mv_cesa_op_ctx = { };
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_md5_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_md5_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_md5_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_sha1_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_sha1_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_sha1_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_sha1_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_sha256_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_sha256_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_sha256_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_sha256_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahmac_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahmac_md5_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahmac_md5_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahmac_sha1_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahmac_sha1_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahmac_sha256_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ahmac_sha256_digest(req: *mut ahash_request) -> c_int {
