...
//! Source: drivers/crypto/marvell/cesa/cipher.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_cesa_des_ctx {
    pub base: mv_cesa_ctx,
    pub key: [u8; DES_KEY_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_cesa_des3_ctx {
    pub base: mv_cesa_ctx,
    pub key: [u8; DES3_EDE_KEY_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_cesa_aes_ctx {
    pub base: mv_cesa_ctx,
    pub aes: crypto_aes_ctx,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_cesa_skcipher_dma_iter {
    pub base: mv_cesa_dma_iter,
    pub src: mv_cesa_sg_dma_iter,
    pub dst: mv_cesa_sg_dma_iter,
}
...
#[no_mangle]
pub unsafe extern "C" fn mv_cesa_skcipher_cleanup(req: *mut skcipher_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_skcipher_std_step(req: *mut skcipher_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_skcipher_step(req: *mut crypto_async_request) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_skcipher_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_skcipher_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
// Add output data for IV
    ...
    let mut blksize: c_uint = crypto_skcipher_blocksize(tfm);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ecb_des_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ecb_des_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_cbc_des_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_cbc_des_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ecb_des3_ede_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ecb_des3_ede_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_cbc_des3_ede_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_cbc_des3_ede_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(32: ctx->aes.key_length ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ecb_aes_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_ecb_aes_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_cbc_aes_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_cesa_cbc_aes_decrypt(req: *mut skcipher_request) -> c_int {
