...
//! Source: drivers/crypto/marvell/octeontx/otx_cptvf_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_worker_threads(cptvf: *mut otx_cptvf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_worker_threads(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn free_pending_queues(pqinfo: *mut otx_cpt_pending_qinfo) {
...
// free single queue
    ...
    u32 num_queues)
    {
    struct otx_cpt_pending_queue *queue = core::ptr::null_mut();
    int ret;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn cleanup_pending_queues(cptvf: *mut otx_cptvf) {
    ...
    {
    struct otx_cpt_cmd_queue *queue = core::ptr::null_mut();
    struct otx_cpt_cmd_chunk *chunk = core::ptr::null_mut();
    struct pci_dev *pdev = cptvf.pdev;
    int i;
...
#[no_mangle]
unsafe extern "C" fn init_command_queues(cptvf: *mut otx_cptvf, qlen: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_command_queues(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_sw_cleanup(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_sw_init(cptvf: *mut otx_cptvf, qlen: u32, num_queues: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptvf_free_irq_affinity(cptvf: *mut otx_cptvf, vec: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_ctl(cptvf: *mut otx_cptvf, val: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn otx_cptvf_write_vq_doorbell(cptvf: *mut otx_cptvf, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_inprog(cptvf: *mut otx_cptvf, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_done_numwait(cptvf: *mut otx_cptvf, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_read_vq_done_numwait(cptvf: *mut otx_cptvf) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_done_timewait(cptvf: *mut otx_cptvf, time: u16) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_read_vq_done_timewait(cptvf: *mut otx_cptvf) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn cptvf_enable_swerr_interrupts(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_enable_mbox_interrupts(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_enable_done_interrupts(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_dovf_intr(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_irde_intr(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_nwrp_intr(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_mbox_intr(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_swerr_intr(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_read_vf_misc_intr_status(cptvf: *mut otx_cptvf) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn cptvf_read_vq_done_count(cptvf: *mut otx_cptvf) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cptvf_set_irq_affinity(cptvf: *mut otx_cptvf, vec: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_saddr(cptvf: *mut otx_cptvf, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_device_init(cptvf: *mut otx_cptvf) {
...
#[no_mangle]
unsafe extern "C" fn otx_cptvf_remove(pdev: *mut pci_dev) {
