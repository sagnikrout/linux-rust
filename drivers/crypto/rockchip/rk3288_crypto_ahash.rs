...
//! Source: drivers/crypto/rockchip/rk3288_crypto_ahash.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn rk_ahash_need_fallback(req: *mut ahash_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rk_ahash_digest_fb(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zero_message_process(req: *mut ahash_request) -> c_int {
    static int zero_message_process(struct ahash_request *req)
    {
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(req);
    let mut rk_digest_size: c_int = crypto_ahash_digestsize(tfm);
...
#[no_mangle]
unsafe extern "C" fn rk_ahash_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_ahash_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_ahash_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_ahash_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_ahash_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_ahash_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_ahash_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto_ahash_dma_start(dev: *mut rk_crypto_info, sg: *mut scatterlist) {
...
#[no_mangle]
unsafe extern "C" fn rk_hash_prepare(engine: *mut crypto_engine, breq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hash_unprepare(engine: *mut crypto_engine, breq: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rk_hash_run(engine: *mut crypto_engine, breq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hash_init_tfm(tfm: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk_hash_exit_tfm(tfm: *mut crypto_ahash) {
