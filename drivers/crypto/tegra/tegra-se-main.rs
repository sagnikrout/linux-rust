...
//! Source: drivers/crypto/tegra/tegra-se-main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tegra_se_cmdbuf_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_cmdbuf_put(host_bo: *mut host1x_bo) {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_cmdbuf_unpin(map: *mut host1x_bo_mapping) {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_cmdbuf_munmap(host_bo: *mut host1x_bo, addr: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_se_host1x_submit(se: *mut tegra_se, cmdbuf: *mut tegra_se_cmdbuf, size: u32) -> c_int {
    ...
    MAX_SCHEDULE_TIMEOUT, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_client_init(client: *mut host1x_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_client_deinit(client: *mut host1x_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_host1x_register(se: *mut tegra_se) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_probe(pdev: *mut platform_device) -> c_int {
    ...
    se.clk = devm_clk_get_enabled(se.dev, core::ptr::null_mut());
    if (IS_ERR(se.clk))
...
#[no_mangle]
unsafe extern "C" fn tegra_se_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_host1x_probe(dev: *mut host1x_device) -> c_int {
    static int tegra_se_host1x_probe(struct host1x_device *dev)
    {
    return host1x_device_init(dev);
    }
#[no_mangle]
unsafe extern "C" fn tegra_se_host1x_remove(dev: *mut host1x_device) {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tegra_se_module_exit() -> void __exit {
