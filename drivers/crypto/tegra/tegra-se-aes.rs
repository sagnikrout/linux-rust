...
//! Source: drivers/crypto/tegra/tegra-se-aes.c
#![no_std]
...
pub struct tegra_aes_ctx {
    ...
    pub key2: [u8; AES_MAX_KEY_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_aes_reqctx {
    pub datbuf: tegra_se_datbuf,
    pub encrypt: bool,
    pub config: u32,
    pub crypto_config: u32,
    pub len: u32,
    pub iv: *mut u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_aead_reqctx {
    pub inbuf: tegra_se_datbuf,
    pub outbuf: tegra_se_datbuf,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_cmac_ctx {
    pub se: *mut tegra_se,
    pub alg: c_uint,
    pub key_id: u32,
    pub keylen: u32,
    pub key: [u8; AES_MAX_KEY_SIZE],
    pub fallback_tfm: *mut crypto_shash,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_cmac_reqctx {
    pub src_sg: *mut scatterlist,
    pub datbuf: tegra_se_datbuf,
    pub residue: tegra_se_datbuf,
    pub total_len: c_uint,
    pub blk_size: c_uint,
    pub task: c_uint,
    pub crypto_config: u32,
    pub config: u32,
    pub key_id: u32,
    pub iv: *mut u32,
    pub result: [u32; CMAC_RESULT_REG_COUNT],
}

// increment counter (128-bit int)
#[no_mangle]
unsafe extern "C" fn ctr_iv_inc(counter: *mut __u8, bits: __u8, nums: __u32) {
...
#[no_mangle]
unsafe extern "C" fn tegra_cbc_iv_copyback(req: *mut skcipher_request, ctx: *mut tegra_aes_ctx) {
...
#[no_mangle]
unsafe extern "C" fn tegra_aes_update_iv(req: *mut skcipher_request, ctx: *mut tegra_aes_ctx) {
...
#[no_mangle]
unsafe extern "C" fn tegra234_aes_crypto_cfg(alg: u32, encrypt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra234_aes_cfg(alg: u32, encrypt: bool) -> c_int {
    ...
    let mut addr: dma_addr_t = rctx.datbuf.addr;
...
#[no_mangle]
unsafe extern "C" fn tegra_aes_do_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
    ...
    int ret;
    rctx.iv = (ctx.alg == SE_ALG_ECB) ? core::ptr::null_mut() : (u32 *)req.iv;
...
#[no_mangle]
unsafe extern "C" fn tegra_aes_cra_init(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_aes_cra_exit(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn tegra_aes_kac_manifest(user: u32, alg: u32, keylen: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_aes_crypt(req: *mut skcipher_request, encrypt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_aes_encrypt(req: *mut skcipher_request) -> c_int {
    static int tegra_aes_encrypt(struct skcipher_request *req)
    {
    return tegra_aes_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn tegra_aes_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gcm_do_gmac(ctx: *mut tegra_aead_ctx, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gcm_do_crypt(ctx: *mut tegra_aead_ctx, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gcm_do_final(ctx: *mut tegra_aead_ctx, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gcm_do_verify(se: *mut tegra_se, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_ccm_check_iv(iv: *const u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_do_cbcmac(ctx: *mut tegra_aead_ctx, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_set_msg_len(block: *mut u8, msglen: c_uint, csize: c_int) -> c_int {
    ...
    csize = 4;
#[no_mangle]
pub unsafe extern "C" fn if(csize)): *mut *mut msglen > (1 << (8) -> else {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_format_nonce(rctx: *mut tegra_aead_reqctx, nonce: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_format_adata(adata: *mut u8, a: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_add_padding(buf: *mut u8, len: c_uint) -> c_int {
    static int tegra_ccm_add_padding(u8 *buf, unsigned int len)
    {
    let mut padlen: c_uint = 16 - (len % 16);
    u8 padding[16] = {0};
    if (padlen == 16)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_format_blocks(rctx: *mut tegra_aead_reqctx) -> c_int {
    static int tegra_ccm_format_blocks(struct tegra_aead_reqctx *rctx)
    {
    let mut alen: c_uint = 0, offset = 0;
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_mac_result(se: *mut tegra_se, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_ctr_result(se: *mut tegra_se, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_compute_auth(ctx: *mut tegra_aead_ctx, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_do_ctr(ctx: *mut tegra_aead_ctx, rctx: *mut tegra_aead_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_do_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gcm_do_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_aead_cra_init(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_ccm_setauthsize(tfm: *mut crypto_aead, authsize: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_gcm_setauthsize(tfm: *mut crypto_aead, authsize: c_uint) -> c_int {
    static int tegra_gcm_setauthsize(struct crypto_aead *tfm,  unsigned int authsize)
    {
    return crypto_gcm_check_authsize(authsize);
    }
#[no_mangle]
unsafe extern "C" fn tegra_aead_cra_exit(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn tegra_aead_crypt(req: *mut aead_request, encrypt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_aead_encrypt(req: *mut aead_request) -> c_int {
    static int tegra_aead_encrypt(struct aead_request *req)
    {
    return tegra_aead_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn tegra_aead_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_copy_result(se: *mut tegra_se, rctx: *mut tegra_cmac_reqctx) {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_paste_result(se: *mut tegra_se, rctx: *mut tegra_cmac_reqctx) {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_do_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_do_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_do_final(req: *mut ahash_request) -> c_int {
    ...
    let mut ret: c_int = 0, i, cmdlen;
    if (!req.nbytes && !rctx.total_len && ctx.fallback_tfm) {
    return crypto_shash_tfm_digest(ctx.fallback_tfm,
    core::ptr::null_mut(), 0, req.result);
    }
    if (rctx.residue.size) {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_do_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
    ...
    ctx.fallback_tfm = core::ptr::null_mut();
    return;
    }
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_cmac_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_init_aes(se: *mut tegra_se) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tegra_deinit_aes(se: *mut tegra_se) {
