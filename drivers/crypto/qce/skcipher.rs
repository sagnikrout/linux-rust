...
//! Source: drivers/crypto/qce/skcipher.c
#![no_std]
...
//
    ...
    let mut aes_sw_max_len: static unsigned int = CONFIG_CRYPTO_DEV_QCE_SW_MAX_LEN;
...
unsafe extern "C" fn qce_skcipher_done(data: *mut c_void) {
    ...
    let mut flags: c_ulong = to_cipher_tmpl(ablk).alg_flags;
...
#[no_mangle]
unsafe extern "C" fn qce_skcipher_crypt(req: *mut skcipher_request, encrypt: c_int) -> c_int {
    ...
    let mut blocksize: c_uint = crypto_skcipher_blocksize(tfm);
    int keylen;
...
#[no_mangle]
unsafe extern "C" fn qce_skcipher_encrypt(req: *mut skcipher_request) -> c_int {
    static int qce_skcipher_encrypt(struct skcipher_request *req)
    {
    return qce_skcipher_crypt(req, 1);
    }
#[no_mangle]
unsafe extern "C" fn qce_skcipher_decrypt(req: *mut skcipher_request) -> c_int {
    static int qce_skcipher_decrypt(struct skcipher_request *req)
    {
    return qce_skcipher_crypt(req, 0);
    }
#[no_mangle]
unsafe extern "C" fn qce_skcipher_init(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qce_skcipher_init_fallback(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qce_skcipher_exit(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn qce_skcipher_unregister(qce: *mut qce_device) {
