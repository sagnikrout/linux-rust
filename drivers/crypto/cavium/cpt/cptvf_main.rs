...
//! Source: drivers/crypto/cavium/cpt/cptvf_main.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cptvf_wqe {
    pub twork: tasklet_struct,
    pub cptvf: *mut c_void,
    pub qno: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cptvf_wqe_info {
    pub vq_wqe: [cptvf_wqe; CPT_NUM_QS_PER_VF],
}

#[no_mangle]
unsafe extern "C" fn vq_work_handler(data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn init_worker_threads(cptvf: *mut cpt_vf) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_worker_threads(cptvf: *mut cpt_vf) {
    ...
    cptvf.wqe_info = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn free_pending_queues(pqinfo: *mut pending_qinfo) {
...
// free single queue
    ...
    u32 i;
    int ret;
    struct pending_queue *queue = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn init_pending_queues(cptvf: *mut cpt_vf, qlen: u32, nr_queues: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_pending_queues(cptvf: *mut cpt_vf) {
    ...
    {
    int i;
    struct command_queue *queue = core::ptr::null_mut();
    struct command_chunk *chunk = core::ptr::null_mut();
    struct pci_dev *pdev = cptvf.pdev;
...
// per queue initialization
    ...
    let mut rem_q_size: usize = q_size;
    struct command_chunk *curr = core::ptr::null_mut(), *first = core::ptr::null_mut(), *last = core::ptr::null_mut();
    let mut qcsize_bytes: u32 = cqinfo.qchunksize * cqinfo.cmd_size;
    queue = &cqinfo.queue[i];
...
#[no_mangle]
unsafe extern "C" fn init_command_queues(cptvf: *mut cpt_vf, qlen: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cleanup_command_queues(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_sw_cleanup(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_sw_init(cptvf: *mut cpt_vf, qlen: u32, nr_queues: u32) -> c_int {
    static int cptvf_sw_init(struct cpt_vf *cptvf, u32 qlen, u32 nr_queues)
    {
    struct pci_dev *pdev = cptvf.pdev;
    let mut ret: c_int = 0;
    let mut max_dev_queues: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn cptvf_free_irq_affinity(cptvf: *mut cpt_vf, vec: c_int) {
    static void cptvf_free_irq_affinity(struct cpt_vf *cptvf, int vec)
    {
    irq_set_affinity_hint(pci_irq_vector(cptvf.pdev, vec), core::ptr::null_mut());
    free_cpumask_var(cptvf.affinity_mask[vec]);
    }
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_ctl(cptvf: *mut cpt_vf, val: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn cptvf_write_vq_doorbell(cptvf: *mut cpt_vf, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_inprog(cptvf: *mut cpt_vf, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_done_numwait(cptvf: *mut cpt_vf, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_done_timewait(cptvf: *mut cpt_vf, time: u16) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_enable_swerr_interrupts(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_enable_mbox_interrupts(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_enable_done_interrupts(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_dovf_intr(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_irde_intr(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_nwrp_intr(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_mbox_intr(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_clear_swerr_intr(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_read_vf_misc_intr_status(cptvf: *mut cpt_vf) -> u64 {
    static u64 cptvf_read_vf_misc_intr_status(struct cpt_vf *cptvf)
    {
    return cpt_read_csr64(cptvf.reg_base, CPTX_VQX_MISC_INT(0, 0));
    }
#[no_mangle]
unsafe extern "C" fn cptvf_misc_intr_handler(irq: c_int, cptvf_irq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn cptvf_read_vq_done_count(cptvf: *mut cpt_vf) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cptvf_done_intr_handler(irq: c_int, cptvf_irq: *mut c_void) -> irqreturn_t {
    static irqreturn_t cptvf_done_intr_handler(int irq, void *cptvf_irq)
    {
    struct cpt_vf *cptvf = (struct cpt_vf *)cptvf_irq;
    struct pci_dev *pdev = cptvf.pdev;
// Read the number of completions
    let mut intr: u32 = cptvf_read_vq_done_count(cptvf);
    if (intr) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_set_irq_affinity(cptvf: *mut cpt_vf, vec: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_write_vq_saddr(cptvf: *mut cpt_vf, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_device_init(cptvf: *mut cpt_vf) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cptvf_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cptvf_shutdown(pdev: *mut pci_dev) {
