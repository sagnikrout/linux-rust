...
//! Source: drivers/crypto/cavium/cpt/cptpf_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cpt_disable_mbox_interrupts(cpt: *mut cpt_device) {
...
#[no_mangle]
unsafe extern "C" fn cpt_disable_ecc_interrupts(cpt: *mut cpt_device) {
...
#[no_mangle]
unsafe extern "C" fn cpt_disable_exec_interrupts(cpt: *mut cpt_device) {
...
#[no_mangle]
unsafe extern "C" fn cpt_disable_all_interrupts(cpt: *mut cpt_device) {
...
#[no_mangle]
unsafe extern "C" fn cpt_enable_mbox_interrupts(cpt: *mut cpt_device) {
...
#[no_mangle]
unsafe extern "C" fn cpt_load_microcode(cpt: *mut cpt_device, mcode: *mut microcode) -> c_int {
    static int cpt_load_microcode(struct cpt_device *cpt, struct microcode *mcode)
    {
    let mut ret: c_int = 0, core = 0, shift = 0;
    let mut total_cores: u32 = 0;
    struct device *dev = &cpt.pdev.dev;
    if (!mcode || !mcode.code) {
    dev_err(dev, "Either the mcode is null or data is core::ptr::null_mut()\n");
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn do_cpt_init(cpt: *mut cpt_device, mcode: *mut microcode) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ucode_header {
    pub version: [u8; CPT_UCODE_VERSION_SZ],
    pub code_length: __be32,
    pub data_length: u32,
    pub sram_address: u64,
}

#[no_mangle]
unsafe extern "C" fn cpt_ucode_load_fw(cpt: *mut cpt_device, fw: *const u8, is_ae: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_ucode_load(cpt: *mut cpt_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_mbx0_intr_handler(irq: c_int, cpt_irq: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn cpt_unload_microcode(cpt: *mut cpt_device) {
    static void cpt_unload_microcode(struct cpt_device *cpt)
    {
    let mut grp: u32 = 0, core;
...
#[no_mangle]
unsafe extern "C" fn cpt_device_init(cpt: *mut cpt_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_register_interrupts(cpt: *mut cpt_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_unregister_interrupts(cpt: *mut cpt_device) {
...
#[no_mangle]
unsafe extern "C" fn cpt_sriov_init(cpt: *mut cpt_device, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpt_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cpt_shutdown(pdev: *mut pci_dev) {
