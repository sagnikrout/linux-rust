...
//! Source: drivers/crypto/cavium/nitrox/nitrox_lib.c
#![no_std]
...
pub const CRYPTO_CTX_SIZE: c_int = 256;
// packet input ring alignments
pub const PKTIN_Q_ALIGN_BYTES: c_int = 16;
// AQM Queue input alignments
pub const AQM_Q_ALIGN_BYTES: c_int = 32;
#[no_mangle]
unsafe extern "C" fn nitrox_cmdq_init(cmdq: *mut nitrox_cmdq, align_bytes: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_cmdq_reset(cmdq: *mut nitrox_cmdq) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_cmdq_cleanup(cmdq: *mut nitrox_cmdq) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_free_aqm_queues(ndev: *mut nitrox_device) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_alloc_aqm_queues(ndev: *mut nitrox_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_free_pktin_queues(ndev: *mut nitrox_device) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_alloc_pktin_queues(ndev: *mut nitrox_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn create_crypto_dma_pool(ndev: *mut nitrox_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn destroy_crypto_dma_pool(ndev: *mut nitrox_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn crypto_free_context(ctx: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn nitrox_common_sw_init(ndev: *mut nitrox_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn nitrox_common_sw_cleanup(ndev: *mut nitrox_device) {
