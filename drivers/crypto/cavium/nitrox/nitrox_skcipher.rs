...
//! Source: drivers/crypto/cavium/nitrox/nitrox_skcipher.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nitrox_cipher {
    pub name: *const c_char,
    pub value: enum flexi_cipher,
}
...
//
    ...
    { core::ptr::null_mut(),			CIPHER_INVALID }
    };
#[no_mangle]
unsafe extern "C" fn flexi_cipher_type(name: *const c_char) -> enum flexi_cipher {
...
#[no_mangle]
unsafe extern "C" fn free_src_sglist(skreq: *mut skcipher_request) {
...
#[no_mangle]
unsafe extern "C" fn free_dst_sglist(skreq: *mut skcipher_request) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_skcipher_callback(arg: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_cbc_cipher_callback(arg: *mut c_void, err: c_int) {
    static void nitrox_cbc_cipher_callback(void *arg, int err)
    {
    struct skcipher_request *skreq = arg;
    struct nitrox_kcrypt_request *nkreq = skcipher_request_ctx(skreq);
    struct crypto_skcipher *cipher = crypto_skcipher_reqtfm(skreq);
    let mut ivsize: c_int = crypto_skcipher_ivsize(cipher);
    let mut start: c_uint = skreq.cryptlen - ivsize;
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_skcipher_init(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_cbc_init(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_skcipher_exit(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn alloc_src_sglist(skreq: *mut skcipher_request, ivsize: c_int) -> c_int {
    static int alloc_src_sglist(struct skcipher_request *skreq, int ivsize)
    {
    struct nitrox_kcrypt_request *nkreq = skcipher_request_ctx(skreq);
    let mut nents: c_int = sg_nents(skreq.src) + 1;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn alloc_dst_sglist(skreq: *mut skcipher_request, ivsize: c_int) -> c_int {
    static int alloc_dst_sglist(struct skcipher_request *skreq, int ivsize)
    {
    struct nitrox_kcrypt_request *nkreq = skcipher_request_ctx(skreq);
    let mut nents: c_int = sg_nents(skreq.dst) + 3;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn nitrox_skcipher_crypt(skreq: *mut skcipher_request, enc: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_cbc_decrypt(skreq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_aes_encrypt(skreq: *mut skcipher_request) -> c_int {
    static int nitrox_aes_encrypt(struct skcipher_request *skreq)
    {
    return nitrox_skcipher_crypt(skreq, true);
    }
#[no_mangle]
unsafe extern "C" fn nitrox_aes_decrypt(skreq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_3des_encrypt(skreq: *mut skcipher_request) -> c_int {
    static int nitrox_3des_encrypt(struct skcipher_request *skreq)
    {
    return nitrox_skcipher_crypt(skreq, true);
    }
#[no_mangle]
unsafe extern "C" fn nitrox_3des_decrypt(skreq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nitrox_register_skciphers() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nitrox_unregister_skciphers() {
