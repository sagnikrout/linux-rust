...
//! Source: drivers/crypto/cavium/nitrox/nitrox_reqmgr.c
#![no_std]
...
// SLC_STORE_INFO
pub const MIN_UDD_LEN: c_int = 16;
// PKT_IN_HDR + SLC_STORE_INFO
pub const FDATA_SIZE: c_int = 32;
// Base destination port for the solicited requests
pub const SOLICIT_BASE_DPORT: c_int = 256;
pub const REQ_NOT_POSTED: c_int = 1;
pub const REQ_BACKLOG: c_int = 2;
pub const REQ_POSTED: c_int = 3;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn incr_index(index: c_int, count: c_int, max: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn softreq_unmap_sgbufs(sr: *mut nitrox_softreq) {
...
#[no_mangle]
unsafe extern "C" fn softreq_destroy(sr: *mut nitrox_softreq) {
...
#[no_mangle]
pub unsafe extern "C" fn cmdq_full(cmdq: *mut nitrox_cmdq, qlen: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn post_backlog_cmds(cmdq: *mut nitrox_cmdq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_enqueue_request(sr: *mut nitrox_softreq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cmd_timeout(tstamp: c_ulong, timeout: c_ulong) -> c_int {
    static inline int cmd_timeout(unsigned long tstamp, unsigned long timeout)
    {
    return time_after_eq(jiffies, (tstamp + timeout));
    }
#[no_mangle]
pub unsafe extern "C" fn backlog_qflush_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sr_completed(sr: *mut nitrox_softreq) -> bool {
    static bool sr_completed(struct nitrox_softreq *sr)
    {
    let mut orh: u64 = READ_ONCE(*sr.resp.orh);
...
//
#[no_mangle]
unsafe extern "C" fn process_response_list(cmdq: *mut nitrox_cmdq) {
    static void process_response_list(struct nitrox_cmdq *cmdq)
    {
    struct nitrox_device *ndev = cmdq.ndev;
    struct nitrox_softreq *sr;
    let mut req_completed: c_int = 0, err = 0, budget;
    completion_t callback;
    void *cb_arg;
...
//
#[no_mangle]
pub unsafe extern "C" fn pkt_slc_resp_tasklet(data: c_ulong) {
