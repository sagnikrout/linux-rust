...
//! Source: drivers/crypto/cavium/nitrox/nitrox_main.c
#![no_std]
...
pub const CNN55XX_DEV_ID: c_uint = 0x12;
pub const UCODE_HLEN: c_int = 48;
pub const DEFAULT_SE_GROUP: c_int = 0;
pub const DEFAULT_AE_GROUP: c_int = 0;

pub const CNN55XX_UCD_BLOCK_SIZE: c_int = 32768;
...
// required last entry
    ...
    let mut qlen: static unsigned int = DEFAULT_CMD_QLEN;
...
pub struct ucode {
    pub id: u8,
    pub 1]: char version[VERSION_LEN -,
    pub code_size: __be32,
    pub raz: [u8; 12],
    pub code: [u64; ],
}
...
#[no_mangle]
unsafe extern "C" fn nitrox_load_fw(ndev: *mut nitrox_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nitrox_add_to_devlist(ndev: *mut nitrox_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nitrox_remove_from_devlist(ndev: *mut nitrox_device) {
    ...
    {
    struct nitrox_device *ndev = core::ptr::null_mut(), *iter;
    mutex_lock(&devlist_lock);
...
#[no_mangle]
pub unsafe extern "C" fn nitrox_put_device(ndev: *mut nitrox_device) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_device_flr(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_pf_sw_init(ndev: *mut nitrox_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_pf_sw_cleanup(ndev: *mut nitrox_device) {
...
//
#[no_mangle]
unsafe extern "C" fn nitrox_bist_check(ndev: *mut nitrox_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_pf_hw_init(ndev: *mut nitrox_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nitrox_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_shutdown(pdev: *mut pci_dev) {
