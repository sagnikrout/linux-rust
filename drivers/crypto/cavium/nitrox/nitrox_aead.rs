...
//! Source: drivers/crypto/cavium/nitrox/nitrox_aead.c
#![no_std]
...
pub const GCM_AES_SALT_SIZE: c_int = 4;
    union gph_p3 {
    struct {
...
// copy enc key to context
    ...
    int buflen)
    {
    let mut nents: c_int = sg_nents_for_len(src, buflen);
    int ret;
    if (nents < 0)
    return nents;
// IV entry
...
// Allocate buffer to hold IV and input scatterlist array
    ...
    {
    let mut nents: c_int = sg_nents_for_len(dst, buflen);
    int ret;
    if (nents < 0)
    return nents;
...
#[no_mangle]
unsafe extern "C" fn free_src_sglist(nkreq: *mut nitrox_kcrypt_request) {
    static void free_src_sglist(struct nitrox_kcrypt_request *nkreq)
    {
    kfree(nkreq.src);
    }
#[no_mangle]
unsafe extern "C" fn free_dst_sglist(nkreq: *mut nitrox_kcrypt_request) {
    static void free_dst_sglist(struct nitrox_kcrypt_request *nkreq)
    {
    kfree(nkreq.dst);
    }
#[no_mangle]
unsafe extern "C" fn nitrox_set_creq(rctx: *mut nitrox_aead_rctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_aead_callback(arg: *mut c_void, err: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn nitrox_aes_gcm_assoclen_supported(assoclen: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nitrox_aes_gcm_enc(areq: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_aes_gcm_dec(areq: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_aead_init(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_gcm_common_init(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_aes_gcm_init(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_aead_exit(aead: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_rfc4106_set_aead_rctx_sglist(areq: *mut aead_request) -> c_int {
    ...
    let mut assoclen: c_uint = areq.assoclen - GCM_RFC4106_IV_SIZE;
...
#[no_mangle]
unsafe extern "C" fn nitrox_rfc4106_callback(arg: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn nitrox_rfc4106_enc(areq: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_rfc4106_dec(areq: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nitrox_rfc4106_init(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn nitrox_register_aeads() -> c_int {
    int nitrox_register_aeads(void)
    {
    return crypto_register_aeads(nitrox_aeads, ARRAY_SIZE(nitrox_aeads));
    }
#[no_mangle]
pub unsafe extern "C" fn nitrox_unregister_aeads() {
