...
//! Source: drivers/crypto/padlock-aes.c
#![no_std]
...
//
    let mut ecb_fetch_blocks: static unsigned int = 2;

    let mut cbc_fetch_blocks: static unsigned int = 1;
...
pub struct cword {
#[no_mangle]
pub unsafe extern "C" fn __attribute__(_arg: (__packed__)) -> c_uint {
...
// TODO: We should check the actual CPU model/stepping
    ...
    {
    let mut addr: c_ulong = (unsigned long)ctx;
    let mut align: c_ulong = PADLOCK_ALIGNMENT;
...
// Don't generate extended keys if the hardware can do it.
    ...
    per_cpu(paes_last_cword, cpu) = core::ptr::null_mut();
    return 0;
    }
...
#[no_mangle]
pub unsafe extern "C" fn padlock_reset_key(cword: *mut cword) {
...
#[no_mangle]
pub unsafe extern "C" fn padlock_store_cword(cword: *mut cword) {
...
// Padlock in CBC mode fetches at least cbc_fetch_bytes of data.
    ...
    {
    let mut initial: u32 = count & (ecb_fetch_blocks - 1);
    ...
    {
    let mut initial: u32 = count & (cbc_fetch_blocks - 1);
...
#[no_mangle]
unsafe extern "C" fn padlock_aes_encrypt(tfm: *mut crypto_tfm, out: *mut u8, in: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn padlock_aes_decrypt(tfm: *mut crypto_tfm, out: *mut u8, in: *const u8) {
...
unsafe extern "C" fn cbc_aes_decrypt(req: *mut skcipher_request) -> c_int {
    ...
    X86_MATCH_FEATURE(X86_FEATURE_XCRYPT, core::ptr::null_mut()),
    {}
    };
