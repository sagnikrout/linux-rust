...
//! Source: drivers/crypto/caam/blob_gen.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct caam_blob_job_result {
    pub err: c_int,
    pub completion: completion,
}

#[no_mangle]
unsafe extern "C" fn caam_blob_job_done(dev: *mut device, desc: *mut u32, err: u32, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn check_caam_state(jrdev: *mut device) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn caam_blob_gen_exit(priv: *mut caam_blob_priv) {
