...
//! Source: drivers/crypto/caam/caamalg_qi.c
#![no_std]
...
// crypto alg
//
pub const CAAM_CRA_PRIORITY: c_int = 2000;
...
pub struct caam_ctx {
    ...
    pub /: *mut *mut spinlock_t lock; / Protects multiple init of driver context,
...
#[no_mangle]
unsafe extern "C" fn aead_setauthsize(authenc: *mut crypto_aead, authsize: c_uint) -> c_int {
...
// Read again to check if some other core init drv_ctx
    ...
    let mut ivsize: c_int = crypto_aead_ivsize(aead);
...
#[no_mangle]
unsafe extern "C" fn aead_done(drv_req: *mut caam_drv_req, status: u32) {
...
//
    ...
    let mut ivsize: c_int = 0;
    let mut authsize: c_uint = ctx.authsize;
    let mut qm_sg_index: c_int = 0, qm_sg_ents = 0, qm_sg_bytes;
    int in_len, out_len;
...
#[no_mangle]
pub unsafe extern "C" fn if(1): (req->src == req->dst) && (mapped_src_nents >) -> else {
...
#[no_mangle]
unsafe extern "C" fn skcipher_done(drv_req: *mut caam_drv_req, status: u32) {
...
// copy descriptor header template value
    ...
    ctx.drv_ctx[ENCRYPT] = core::ptr::null_mut();
    ctx.drv_ctx[DECRYPT] = core::ptr::null_mut();
    return 0;
    }
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn caam_qi_algapi_exit() {
...
#[no_mangle]
pub unsafe extern "C" fn caam_qi_algapi_init(ctrldev: *mut device) -> c_int {
