...
//! Source: drivers/crypto/caam/caamalg.c
#![no_std]
...
pub struct caam_alg_entry {
    pub class1_alg_type: c_int,
    pub class2_alg_type: c_int,
    pub rfc3686: bool,
    pub geniv: bool,
    pub nodkp: bool,
}
...
pub struct caam_ctx {
    ...
    pub sh_desc_enc_dma: dma_addr_t,
    pub sh_desc_dec_dma: dma_addr_t,
    pub key_dma: dma_addr_t,
    pub protected_key: [u8; CAAM_MAX_KEY_SIZE],
...
pub struct caam_skcipher_req_ctx {
    pub edesc: *mut skcipher_edesc,
    pub fallback_req: skcipher_request,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct caam_aead_req_ctx {
    pub edesc: *mut aead_edesc,
}

#[no_mangle]
unsafe extern "C" fn aead_null_set_sh_desc(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aead_set_sh_desc(aead: *mut crypto_aead) -> c_int {
    static int aead_set_sh_desc(struct crypto_aead *aead)
    {
    struct caam_aead_alg *alg = container_of(crypto_aead_alg(aead),
    struct caam_aead_alg,
    aead.base);
    let mut ivsize: c_uint = crypto_aead_ivsize(aead);
    struct caam_ctx *ctx = crypto_aead_ctx_dma(aead);
    struct device *jrdev = ctx.jrdev;
    struct caam_drv_private *ctrlpriv = dev_get_drvdata(jrdev.parent);
    let mut ctx1_iv_off: u32 = 0;
    u32 *desc, *nonce = core::ptr::null_mut();
    u32 inl_mask;
    unsigned int data_len[2];
    const bool ctr_mode = ((ctx.cdata.algtype & OP_ALG_AAI_MASK) ==
    OP_ALG_AAI_CTR_MOD128);
    let mut is_rfc3686: bool = alg.caam.rfc3686;
    if (!ctx.authsize)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn gcm_set_sh_desc(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcm_setauthsize(authenc: *mut crypto_aead, authsize: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfc4106_set_sh_desc(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfc4543_set_sh_desc(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn chachapoly_set_sh_desc(aead: *mut crypto_aead) -> c_int {
    ...
    struct caam_ctx *ctx = crypto_aead_ctx_dma(aead);
    let mut ivsize: c_uint = crypto_aead_ivsize(aead);
    let mut saltlen: c_uint = CHACHAPOLY_IV_SIZE - ivsize;
...
pub struct skcipher_edesc {
    ...
    let mut ivsize: c_int = crypto_skcipher_ivsize(skcipher);
    caam_unmap(dev, req.src, req.dst,
...
//
    ...
    struct caam_ctx *ctx = crypto_aead_ctx_dma(aead);
    let mut authsize: c_int = ctx.authsize;
    ...
    let mut ivsize: c_uint = crypto_aead_ivsize(aead);
    u32 *desc = edesc.hw_desc;
    let mut generic_gcm: bool = (ivsize == GCM_AES_IV_SIZE);
    unsigned int last;
...
//
    ...
    dma_addr_t desc_dma;
    u32 *sh_desc;
    let mut in_options: u32 = 0, out_options = 0;
...
#[no_mangle]
unsafe extern "C" fn aead_enqueue_req(jrdev: *mut device, req: *mut aead_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn chachapoly_crypt(req: *mut aead_request, encrypt: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aead_crypt(req: *mut aead_request, encrypt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aead_do_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gcm_crypt(req: *mut aead_request, encrypt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ipsec_gcm_encrypt(req: *mut aead_request) -> c_int {
    static int ipsec_gcm_encrypt(struct aead_request *req)
    {
    return crypto_ipsec_check_assoclen(req.assoclen) ? : gcm_encrypt(req);
    }
#[no_mangle]
unsafe extern "C" fn ipsec_gcm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skcipher_do_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn xts_skcipher_ivsize(req: *mut skcipher_request) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn skcipher_crypt(req: *mut skcipher_request, encrypt: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn skcipher_encrypt(req: *mut skcipher_request) -> c_int {
    static int skcipher_encrypt(struct skcipher_request *req)
    {
    return skcipher_crypt(req, true);
    }
#[no_mangle]
unsafe extern "C" fn skcipher_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn caam_cra_init(tfm: *mut crypto_skcipher) -> c_int {
    ...
    let mut alg_aai: u32 = caam_alg.caam.class1_alg_type & OP_ALG_AAI_MASK;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn caam_aead_init(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn caam_exit_common(ctx: *mut caam_ctx) {
...
#[no_mangle]
unsafe extern "C" fn caam_cra_exit(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn caam_aead_exit(tfm: *mut crypto_aead) {
    static void caam_aead_exit(struct crypto_aead *tfm)
    {
    caam_exit_common(crypto_aead_ctx_dma(tfm));
    }
#[no_mangle]
pub unsafe extern "C" fn caam_algapi_exit() {
...
#[no_mangle]
unsafe extern "C" fn caam_skcipher_alg_init(t_alg: *mut caam_skcipher_alg) {
...
#[no_mangle]
unsafe extern "C" fn caam_aead_alg_init(t_alg: *mut caam_aead_alg) {
...
#[no_mangle]
pub unsafe extern "C" fn caam_algapi_init(ctrldev: *mut device) -> c_int {
    ...
    let mut registered: bool = false, gcm_support;
//
...
// If MD is present, limit digest size based on LP256
    ...
    for (i = 0; i < ARRAY_SIZE(driver_algs); i++) {
    struct caam_skcipher_alg *t_alg = driver_algs + i;
    let mut alg_sel: u32 = t_alg.caam.class1_alg_type & OP_ALG_ALGSEL_MASK;
...
//
    ...
    OP_ALG_ALGSEL_MASK;
    let mut alg_aai: u32 = t_alg.caam.class1_alg_type & OP_ALG_AAI_MASK;
// Skip DES algorithms if not supported by device
    if (!des_inst &&
