...
//! Source: drivers/crypto/intel/qat/qat_6xxx/adf_drv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn adf_device_down(accel_dev: *mut c_void) {
    static void adf_device_down(void *accel_dev)
    {
    adf_dev_down(accel_dev);
    }
#[no_mangle]
unsafe extern "C" fn adf_dbgfs_cleanup(accel_dev: *mut c_void) {
    static void adf_dbgfs_cleanup(void *accel_dev)
    {
    adf_dbgfs_exit(accel_dev);
    }
#[no_mangle]
unsafe extern "C" fn adf_cfg_device_remove(accel_dev: *mut c_void) {
    static void adf_cfg_device_remove(void *accel_dev)
    {
    adf_cfg_dev_remove(accel_dev);
    }
#[no_mangle]
unsafe extern "C" fn adf_cleanup_hw_data(accel_dev: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn adf_devmgr_remove(accel_dev: *mut c_void) {
    static void adf_devmgr_remove(void *accel_dev)
    {
    adf_devmgr_rm_dev(accel_dev, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn adf_gen6_cfg_dev_init(accel_dev: *mut adf_accel_dev) -> c_int {
