...
//! Source: drivers/crypto/intel/qat/qat_common/adf_init.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn adf_service_add(service: *mut service_hndl) {
...
#[no_mangle]
pub unsafe extern "C" fn adf_service_register(service: *mut service_hndl) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adf_service_remove(service: *mut service_hndl) {
...
#[no_mangle]
pub unsafe extern "C" fn adf_service_unregister(service: *mut service_hndl) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adf_dev_init(accel_dev: *mut adf_accel_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adf_dev_start(accel_dev: *mut adf_accel_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn adf_dev_stop(accel_dev: *mut adf_accel_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn adf_dev_shutdown(accel_dev: *mut adf_accel_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn adf_dev_restarting_notify(accel_dev: *mut adf_accel_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adf_dev_restarted_notify(accel_dev: *mut adf_accel_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adf_error_notifier(accel_dev: *mut adf_accel_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn adf_dev_down(accel_dev: *mut adf_accel_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adf_dev_up(accel_dev: *mut adf_accel_dev, config: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adf_dev_restart(accel_dev: *mut adf_accel_dev) -> c_int {
