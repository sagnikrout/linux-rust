...
//! Source: drivers/crypto/intel/qat/qat_common/qat_algs.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct qat_enc {
    pub cipher: icp_qat_hw_cipher_algo_blk,
    pub hash: icp_qat_hw_auth_algo_blk,
    pub qat_enc_cd: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qat_dec {
...
pub struct qat_alg_aead_ctx {
    ...
    pub enc_cd_paddr: dma_addr_t,
    pub dec_cd_paddr: dma_addr_t,
    pub enc_fw_req: icp_qat_fw_la_bulk_req,
    pub dec_fw_req: icp_qat_fw_la_bulk_req,
    pub qat_hash_alg: enum icp_qat_hw_auth_algo,
    pub hash_digestsize: c_uint,
    pub hash_blocksize: c_uint,
...
pub struct qat_alg_skcipher_ctx {
    pub enc_cd: *mut icp_qat_hw_cipher_algo_blk,
    pub dec_cd: *mut icp_qat_hw_cipher_algo_blk,
    pub enc_cd_paddr: dma_addr_t,
    pub dec_cd_paddr: dma_addr_t,
    pub enc_fw_req: icp_qat_fw_la_bulk_req,
    pub dec_fw_req: icp_qat_fw_la_bulk_req,
    pub inst: *mut qat_crypto_instance,
    pub ftfm: *mut crypto_skcipher,
    pub tweak: *mut crypto_cipher,
    pub fallback: bool,
    pub mode: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn qat_alg_init_common_hdr(header: *mut icp_qat_fw_comn_req_hdr) {
    ...
    let mut digestsize: c_uint = crypto_aead_authsize(aead_tfm);
...
// Auth CD config setup
    ...
    let mut aes_v2_capable: bool = HW_CAP_AES_V2(ctx.inst.accel_dev);
    let mut mode: c_int = ctx.mode;
    qat_alg_init_common_hdr(header);
...
#[no_mangle]
unsafe extern "C" fn qat_alg_validate_key(key_len: c_int, alg: *mut c_int, mode: c_int) -> c_int {
...
// alg = ICP_QAT_HW_CIPHER_ALGO_AES256;
    ...
    {
    struct qat_alg_aead_ctx *ctx = crypto_aead_ctx(tfm);
    struct qat_crypto_instance *inst = core::ptr::null_mut();
    ...
    ctx.dec_cd = core::ptr::null_mut();
    out_free_enc:
    memset(ctx.enc_cd, 0, sizeof(struct qat_alg_cd));
    dma_free_coherent(dev, sizeof(struct qat_alg_cd),
    ctx.enc_cd, ctx.enc_cd_paddr);
    ctx.enc_cd = core::ptr::null_mut();
    out_free_inst:
    ctx.inst = core::ptr::null_mut();
    ...
    let mut stat_filed: u8 = qat_resp.comn_resp.comn_status;
    let mut res: c_int = 0, qat_res = ICP_QAT_FW_COMN_RESP_CRYPTO_STAT_GET(stat_filed);
...
#[no_mangle]
unsafe extern "C" fn qat_alg_update_iv_ctr_mode(qat_req: *mut qat_crypto_request) {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_update_iv_cbc_mode(qat_req: *mut qat_crypto_request) {
    static void qat_alg_update_iv_cbc_mode(struct qat_crypto_request *qat_req)
    {
    struct skcipher_request *sreq = qat_req.skcipher_req;
    let mut offset: c_int = sreq.cryptlen - AES_BLOCK_SIZE;
...
#[no_mangle]
unsafe extern "C" fn qat_alg_update_iv(qat_req: *mut qat_crypto_request) {
...
#[no_mangle]
pub unsafe extern "C" fn qat_alg_callback(resp: *mut c_void) {
    void qat_alg_callback(void *resp)
    {
    struct icp_qat_fw_la_resp *qat_resp = resp;
    struct qat_crypto_request *qat_req =
    (void *)( long)qat_resp.opaque_data;
...
#[no_mangle]
unsafe extern "C" fn qat_alg_aead_dec(areq: *mut aead_request) -> c_int {
    ...
    let mut digst_size: c_int = crypto_aead_authsize(aead_tfm);
    ...
    &qat_req.buf, core::ptr::null_mut(), f);
    if (unlikely(ret))
    return ret;
    msg = &qat_req.req;
// msg = ctx->dec_fw_req;
    ...
    qat_req.req.comn_mid.opaque_data = (u64)( long)qat_req;
...
#[no_mangle]
unsafe extern "C" fn qat_alg_aead_enc(areq: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_set_req_iv(qat_req: *mut qat_crypto_request) {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_encrypt(req: *mut skcipher_request) -> c_int {
    ...
    struct icp_qat_fw_la_cipher_req_params *cipher_param;
    let mut f: gfp_t = qat_algs_alloc_flags(&req.base);
    struct icp_qat_fw_la_bulk_req *msg;
    int ret;
    if (req.cryptlen == 0)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_blk_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_xts_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_blk_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_xts_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_aead_sha1_init(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_aead_sha256_init(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_aead_sha512_init(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_aead_exit(tfm: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_init_xts_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_exit_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn qat_alg_skcipher_exit_xts_tfm(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
pub unsafe extern "C" fn qat_algs_register() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qat_algs_unregister() {
