...
//! Source: drivers/crypto/intel/qat/qat_common/adf_gen4_pm.h
#![no_std]
...
// Power management
pub const ADF_GEN4_PM_POLL_DELAY_US: c_int = 20;
...
extern "C" {
    pub fn adf_gen4_enable_pm(accel_dev: *mut adf_accel_dev) -> c_int;
}
extern "C" {
