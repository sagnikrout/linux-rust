...
//! Source: drivers/crypto/intel/qat/qat_common/adf_accel_engine.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn adf_ae_fw_load(accel_dev: *mut adf_accel_dev) -> c_int {
    ...
    if (qat_uclo_map_obj(loader_data.fw_loader, fw_addr, fw_size, core::ptr::null_mut())) {
...
#[no_mangle]
pub unsafe extern "C" fn adf_ae_fw_release(accel_dev: *mut adf_accel_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn adf_ae_start(accel_dev: *mut adf_accel_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adf_ae_stop(accel_dev: *mut adf_accel_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adf_ae_reset(accel_dev: *mut adf_accel_dev, ae: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adf_ae_init(accel_dev: *mut adf_accel_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn adf_ae_shutdown(accel_dev: *mut adf_accel_dev) -> c_int {
