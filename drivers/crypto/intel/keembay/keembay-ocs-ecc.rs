...
//! Source: drivers/crypto/intel/keembay/keembay-ocs-ecc.c
#![no_std]
...
pub const KMB_OCS_ECC_PRIORITY: c_int = 350;
pub const HW_OFFS_OCS_ECC_COMMAND: c_uint = 0x00000000;
pub const HW_OFFS_OCS_ECC_STATUS: c_uint = 0x00000004;
pub const HW_OFFS_OCS_ECC_DATA_IN: c_uint = 0x00000080;
pub const HW_OFFS_OCS_ECC_CX_DATA_OUT: c_uint = 0x00000100;
pub const HW_OFFS_OCS_ECC_CY_DATA_OUT: c_uint = 0x00000180;
pub const HW_OFFS_OCS_ECC_ISR: c_uint = 0x00000400;
pub const HW_OFFS_OCS_ECC_IER: c_uint = 0x00000404;

pub const OCS_ECC_OP_SIZE_256: c_int = 0;
// ECC Instruction : for ECC_COMMAND

pub const ECC_ENABLE_INTR: c_int = 1;
pub const POLL_USEC: c_int = 100;
pub const TIMEOUT_USEC: c_int = 10000;

    << ECC_DIGITS_TO_BYTES_SHIFT)
pub const POW_CUBE: c_int = 3;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocs_ecc_ctx {
    pub ecc_dev: *mut ocs_ecc_dev,
    pub curve: *const ecc_curve,
    pub private_key: [u64; KMB_ECC_VLI_MAX_DIGITS],
}

// Driver data.
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocs_ecc_drv {
...
#[no_mangle]
pub unsafe extern "C" fn digits_to_bytes(n: c_uint) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn ocs_ecc_wait_idle(dev: *mut ocs_ecc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocs_ecc_cmd_start(ecc_dev: *mut ocs_ecc_dev, op_size: u32) {
...
// Do point multiplication using OCS ECC HW.
    ...
    let mut nbytes: usize = digits_to_bytes(curve.g.ndigits);
    let mut rc: c_int = 0;
...
//
    ...
    OCS_ECC_OP_SIZE_384 : OCS_ECC_OP_SIZE_256;
    let mut nbytes: usize = digits_to_bytes(ndigits);
    int rc;
// Wait engine to be idle before starting new operation.
    rc = ocs_ecc_wait_idle(ecc_dev);
    if (rc)
...
// Check 4: Verify that nQ is the zero point.
    ...
    {
    let mut ndigits: usize = curve.g.ndigits;
...
//
#[no_mangle]
unsafe extern "C" fn kmb_ecc_gen_privkey(curve: *const ecc_curve, privkey: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_ecdh_generate_public_key(req: *mut kpp_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_ecdh_compute_shared_secret(req: *mut kpp_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ecc_tctx_init(tctx: *mut ocs_ecc_ctx, curve_id: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_ecdh_nist_p256_init_tfm(tfm: *mut crypto_kpp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_ecdh_nist_p384_init_tfm(tfm: *mut crypto_kpp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_ecdh_exit_tfm(tfm: *mut crypto_kpp) {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_ecdh_max_size(tfm: *mut crypto_kpp) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ocs_ecc_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_ecc_probe(pdev: *mut platform_device) -> c_int {
...
// Get and request IRQ
    ...
    core::ptr::null_mut(), 0, "keembay-ocs-ecc", ecc_dev);
    if (rc < 0)
    goto list_del;
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_ecc_remove(pdev: *mut platform_device) {
