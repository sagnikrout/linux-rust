...
//! Source: drivers/crypto/intel/keembay/keembay-ocs-aes-core.c
#![no_std]
...
pub const KMB_OCS_PRIORITY: c_int = 350;

pub const OCS_AES_MIN_KEY_SIZE: c_int = 16;
pub const OCS_AES_MAX_KEY_SIZE: c_int = 32;
pub const OCS_AES_KEYSIZE_128: c_int = 16;
pub const OCS_AES_KEYSIZE_192: c_int = 24;
pub const OCS_AES_KEYSIZE_256: c_int = 32;
pub const OCS_SM4_KEY_SIZE: c_int = 16;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocs_aes_tctx {
    pub aes_dev: *mut ocs_aes_dev,
    pub key: [u8; OCS_AES_KEYSIZE_256],
    pub key_len: c_uint,
    pub cipher: enum ocs_cipher,
    union {
    pub sk: *mut crypto_sync_skcipher,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocs_aes_rctx {
// Fields common across all modes.
    pub instruction: enum ocs_instruction,
    pub mode: enum ocs_mode,
    pub src_nents: c_int,
    pub dst_nents: c_int,
    pub src_dma_count: c_int,
    pub dst_dma_count: c_int,
    pub in_place: bool,
    pub src_dll: ocs_dll_desc,
    pub dst_dll: ocs_dll_desc,
// CBC specific
    pub last_ct_blk: [u8; AES_BLOCK_SIZE],
// CTS specific
    pub cts_swap: c_int,
// CCM/GCM specific
    pub aad_src_dll: ocs_dll_desc,
    pub aad_dst_dll: ocs_dll_desc,
    pub in_tag: [u8; AES_BLOCK_SIZE],
// GCM specific
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocs_aes_drv {
    pub dev_list: list_head,
    pub /: *mut *mut spinlock_t lock; / Protects dev_list.,
}
...
//
#[no_mangle]
unsafe extern "C" fn check_key(in_key: *const u8, key_len: usize, cipher: enum ocs_cipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocs_aes_init_rctx(rctx: *mut ocs_aes_rctx) {
...
// Set initial value for DMA addresses.
    ...
    let mut iv_size: c_int = crypto_skcipher_ivsize(tfm);
    switch (mode) {
    case OCS_MODE_ECB:
...
//
    ...
    skcipher_request_set_callback(subreq, req.base.flags, core::ptr::null_mut(),
    core::ptr::null_mut());
...
//
    ...
    dll.vaddr = core::ptr::null_mut();
    dll.size = 0;
    dll.dma_addr = DMA_MAPPING_ERROR;
    }
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sk_dma_cleanup(req: *mut skcipher_request) {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sk_prepare_inplace(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sk_prepare_notinplace(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sk_run(req: *mut skcipher_request) -> c_int {
...
// For all other modes there's nothing to do.
    ...
    let mut tag_size: c_int = crypto_aead_authsize(tfm);
    let mut iv_size: c_int = crypto_aead_ivsize(tfm);
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aead_dma_cleanup(req: *mut aead_request) {
...
//
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aead_dma_prepare(req: *mut aead_request, src_dll_size: *mut u32) -> c_int {
    static int kmb_ocs_aead_dma_prepare(struct aead_request *req, u32 *src_dll_size)
    {
    struct ocs_aes_tctx *tctx = crypto_aead_ctx(crypto_aead_reqtfm(req));
    let mut tag_size: c_int = crypto_aead_authsize(crypto_aead_reqtfm(req));
    struct ocs_aes_rctx *rctx = aead_request_ctx(req);
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aead_run(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_ecb_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_ecb_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_cbc_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_cbc_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_ctr_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_ctr_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_cts_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_cts_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_gcm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_gcm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_ccm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_ccm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_ecb_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_ecb_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_cbc_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_cbc_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_ctr_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_ctr_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_cts_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_cts_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_gcm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_gcm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_ccm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_sm4_ccm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocs_aes_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocs_sm4_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn clear_key(tctx: *mut ocs_aes_tctx) {
...
#[no_mangle]
unsafe extern "C" fn ocs_exit_tfm(tfm: *mut crypto_skcipher) {
    ...
    tctx.sw_cipher.sk = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn ocs_aes_aead_cra_init(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocs_sm4_aead_cra_init(tfm: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ocs_aead_cra_exit(tfm: *mut crypto_aead) {
    ...
    tctx.sw_cipher.aead = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn unregister_aes_algs(aes_dev: *mut ocs_aes_dev) {
...
#[no_mangle]
unsafe extern "C" fn register_aes_algs(aes_dev: *mut ocs_aes_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_aes_probe(pdev: *mut platform_device) -> c_int {
...
// Get and request IRQ
    ...
    core::ptr::null_mut(), 0, "keembay-ocs-aes", aes_dev);
    if (rc < 0)
    return rc;
