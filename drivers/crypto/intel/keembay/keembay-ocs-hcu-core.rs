...
//! Source: drivers/crypto/intel/keembay/keembay-ocs-hcu-core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocs_hcu_ctx {
    pub hcu_dev: *mut ocs_hcu_dev,
    pub key: [u8; SHA512_BLOCK_SIZE],
    pub key_len: usize,
    pub is_sm3_tfm: bool,
    pub is_hmac_tfm: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ocs_hcu_rctx {
    pub hcu_dev: *mut ocs_hcu_dev,
    pub flags: u32,
    pub algo: enum ocs_hcu_algo,
    pub blk_sz: usize,
    pub dig_sz: usize,
    pub dma_list: *mut ocs_hcu_dma_list,
    pub hash_ctx: ocs_hcu_hash_ctx,
//
...
//
    pub SHA512_BLOCK_SIZE]: *mut *mut u8 buffer[2,
    pub buf_cnt: usize,
    pub buf_dma_addr: dma_addr_t,
    pub buf_dma_count: usize,
    pub sg: *mut scatterlist,
    pub sg_data_total: c_uint,
    pub sg_data_offset: c_uint,
    pub sg_dma_nents: c_uint,
    pub nents: c_uint,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn kmb_get_total_data(rctx: *mut ocs_hcu_rctx) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn flush_sg_to_ocs_buffer(rctx: *mut ocs_hcu_rctx) -> c_int {
    ...
    if (!rctx.sg) {
    WARN(1, "%s: unexpected core::ptr::null_mut() sg\n", __func__);
    return -EINVAL;
    }
//
...
// Free dma_list (if allocated).
    ...
    rctx.dma_list = core::ptr::null_mut();
    }
    }
//
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_secure_cleanup(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_handle_queue(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn prepare_ipad(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_do_one_request(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_fin_common(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
// Intermediate data is always stored and applied per request.
    ...
    unsigned int keylen)
    {
    let mut digestsize: c_uint = crypto_ahash_digestsize(tfm);
    struct ocs_hcu_ctx *ctx = crypto_ahash_ctx(tfm);
    let mut blk_sz: usize = crypto_ahash_blocksize(tfm);
...
#[no_mangle]
unsafe extern "C" fn __cra_init(tfm: *mut crypto_tfm, ctx: *mut ocs_hcu_ctx) {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_sha_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_sm3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_hmac_sm3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_hmac_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_hmac_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn kmb_ocs_hcu_probe(pdev: *mut platform_device) -> c_int {
...
// Get and request IRQ.
    ...
    ocs_hcu_irq_handler, core::ptr::null_mut(), 0,
