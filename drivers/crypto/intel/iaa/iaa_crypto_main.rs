...
//! Source: drivers/crypto/intel/iaa/iaa_crypto_main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wq_table_add(cpu: c_int, wq: *mut idxd_wq) {
...
#[no_mangle]
unsafe extern "C" fn wq_table_free_entry(cpu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn wq_table_clear_entry(cpu: c_int) {
...
// Verify results of IAA compress or not
    let mut iaa_verify_compress: static bool = true;
#[no_mangle]
unsafe extern "C" fn verify_compress_show(driver: *mut device_driver, buf: *mut c_char) -> isize {
...
pub struct iaa_req_ctx {
    ...
    pub bounce_src: *mut page,
    pub bounce_src_dma: dma_addr_t,
    pub bounce_src_len: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn set_iaa_sync_mode(name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sync_mode_show(driver: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn if(!use_irq: async_mode &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn find_empty_iaa_compression_mode() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_iaa_compression_mode(mode: *mut iaa_compression_mode) {
...
//
#[no_mangle]
pub unsafe extern "C" fn remove_iaa_compression_mode(name: *const c_char) {
    ...
    iaa_compression_modes[idx] = core::ptr::null_mut();
    }
    out:
    mutex_unlock(&iaa_devices_lock);
    }
...
//
    ...
    {
    let mut size: usize = sizeof(struct aecs_comp_table_record) + IAA_AECS_ALIGN;
...
pub const IDXD_OP_FLAG_AECS_RW_TGLS: c_uint = 0x400000;
...
#[no_mangle]
unsafe extern "C" fn remove_device_compression_modes(iaa_device: *mut iaa_device) {
    ...
    free_device_compression_mode(iaa_device, device_mode);
    iaa_device.compression_modes[i] = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn iaa_has_wq(iaa_device: *mut iaa_device, wq: *mut idxd_wq) -> bool {
...
#[no_mangle]
unsafe extern "C" fn init_iaa_device(iaa_device: *mut iaa_device, iaa_wq: *mut iaa_wq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn del_iaa_device(iaa_device: *mut iaa_device) {
...
#[no_mangle]
unsafe extern "C" fn del_iaa_wq(iaa_device: *mut iaa_device, wq: *mut idxd_wq) {
...
#[no_mangle]
unsafe extern "C" fn clear_wq_table() {
...
#[no_mangle]
unsafe extern "C" fn free_iaa_device(iaa_device: *mut iaa_device) {
...
#[no_mangle]
unsafe extern "C" fn __free_iaa_wq(iaa_wq: *mut iaa_wq) {
...
#[no_mangle]
unsafe extern "C" fn free_iaa_wq(iaa_wq: *mut iaa_wq) {
    ...
    wq = iaa_wq.wq;
    kfree(iaa_wq);
    idxd_wq_set_private(wq, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn iaa_wq_get(wq: *mut idxd_wq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iaa_wq_put(wq: *mut idxd_wq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_wq_table() {
...
#[no_mangle]
unsafe extern "C" fn alloc_wq_table(max_wqs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn save_iaa_wq(wq: *mut idxd_wq) -> c_int {
    static int save_iaa_wq(struct idxd_wq *wq)
    {
    struct iaa_device *iaa_device, *found = core::ptr::null_mut();
...
//
    ...
    found = iaa_device;
    ret = add_iaa_wq(iaa_device, wq, core::ptr::null_mut());
    if (ret)
    goto out;
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn remove_iaa_wq(wq: *mut idxd_wq) {
...
#[no_mangle]
unsafe extern "C" fn wq_table_add_wqs(iaa: c_int, cpu: c_int) -> c_int {
    static int wq_table_add_wqs(int iaa, int cpu)
    {
    struct iaa_device *iaa_device, *found_device = core::ptr::null_mut();
    let mut ret: c_int = 0, cur_iaa = 0, n_wqs_added = 0;
    struct idxd_device *idxd;
    struct iaa_wq *iaa_wq;
    struct pci_dev *pdev;
    struct device *dev;
...
//
#[no_mangle]
unsafe extern "C" fn rebalance_wq_table() {
...
#[no_mangle]
unsafe extern "C" fn iaa_error_should_retry(idxd_desc: *mut idxd_desc) -> bool {
    static bool iaa_error_should_retry(struct idxd_desc *idxd_desc)
    {
    return idxd_desc.iax_completion.status == IAA_ANALYTICS_ERROR;
    }
#[no_mangle]
unsafe extern "C" fn iaa_unmap_src(dev: *mut device, req: *mut acomp_req) {
    ...
    req_ctx.bounce_src = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn deflate_generic_decompress(req: *mut acomp_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn deflate_generic_compress(req: *mut acomp_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iaa_comp_acompress(req: *mut acomp_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iaa_comp_adecompress(req: *mut acomp_req) -> c_int {
    static int iaa_comp_adecompress(struct acomp_req *req)
    {
    struct iaa_req_ctx *req_ctx = acomp_request_ctx(req);
    struct crypto_tfm *tfm = req.base.tfm;
    dma_addr_t src_addr, dst_addr;
    let mut use_bounce_src: bool = false;
    int cpu, ret = 0;
    struct iaa_wq *iaa_wq;
    struct device *dev;
    struct idxd_wq *wq;
...
#[no_mangle]
unsafe extern "C" fn compression_ctx_init(ctx: *mut iaa_compression_ctx) {
...
#[no_mangle]
unsafe extern "C" fn iaa_comp_init_fixed(acomp_tfm: *mut crypto_acomp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iaa_register_compression_device() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iaa_unregister_compression_device() {
...
#[no_mangle]
unsafe extern "C" fn iaa_crypto_probe(idxd_dev: *mut idxd_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iaa_crypto_remove(idxd_dev: *mut idxd_dev) {
...
#[no_mangle]
unsafe extern "C" fn iaa_crypto_init_module() -> int __init {
    ...
    iaa_bounce_pool = core::ptr::null_mut();
    err_bounce_pool:
...
#[no_mangle]
unsafe extern "C" fn iaa_crypto_cleanup_module() -> void __exit {
