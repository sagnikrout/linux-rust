...
//! Source: drivers/crypto/intel/iaa/iaa_crypto_comp_fixed.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn init_fixed_mode(mode: *mut iaa_device_compression_mode) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn iaa_aecs_init_fixed() -> c_int {
    ...
    fixed_d_sym,
    sizeof(fixed_d_sym),
    init_fixed_mode, core::ptr::null_mut());
    if (!ret)
