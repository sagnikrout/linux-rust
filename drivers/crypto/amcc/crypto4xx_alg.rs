...
//! Source: drivers/crypto/amcc/crypto4xx_alg.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_encrypt_noiv_block(req: *mut skcipher_request) -> c_int {
    int crypto4xx_encrypt_noiv_block(struct skcipher_request *req)
    {
    return crypto4xx_crypt(req, 0, false, true);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_encrypt_iv_stream(req: *mut skcipher_request) -> c_int {
    int crypto4xx_encrypt_iv_stream(struct skcipher_request *req)
    {
    return crypto4xx_crypt(req, AES_IV_SIZE, false, false);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_decrypt_noiv_block(req: *mut skcipher_request) -> c_int {
    int crypto4xx_decrypt_noiv_block(struct skcipher_request *req)
    {
    return crypto4xx_crypt(req, 0, true, true);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_decrypt_iv_stream(req: *mut skcipher_request) -> c_int {
    int crypto4xx_decrypt_iv_stream(struct skcipher_request *req)
    {
    return crypto4xx_crypt(req, AES_IV_SIZE, true, false);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_encrypt_iv_block(req: *mut skcipher_request) -> c_int {
    int crypto4xx_encrypt_iv_block(struct skcipher_request *req)
    {
    return crypto4xx_crypt(req, AES_IV_SIZE, false, true);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_decrypt_iv_block(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_rfc3686_encrypt(req: *mut skcipher_request) -> c_int {
    ...
    ctx.sa_out, ctx.sa_len, 0, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_rfc3686_decrypt(req: *mut skcipher_request) -> c_int {
    ...
    let mut counter: c_uint = be32_to_cpup((__be32 *)(req.iv + iv_len - 4));
...
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_encrypt_ctr(req: *mut skcipher_request) -> c_int {
    int crypto4xx_encrypt_ctr(struct skcipher_request *req)
    {
    return crypto4xx_ctr_crypt(req, true);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_decrypt_ctr(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn crypto4xx_crypt_aes_ccm(req: *mut aead_request, decrypt: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_encrypt_aes_ccm(req: *mut aead_request) -> c_int {
    int crypto4xx_encrypt_aes_ccm(struct aead_request *req)
    {
    return crypto4xx_crypt_aes_ccm(req, false);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_decrypt_aes_ccm(req: *mut aead_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn crypto4xx_aes_gcm_validate_keylen(keylen: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_encrypt_aes_gcm(req: *mut aead_request) -> c_int {
    int crypto4xx_encrypt_aes_gcm(struct aead_request *req)
    {
    return crypto4xx_crypt_aes_gcm(req, false);
    }
#[no_mangle]
pub unsafe extern "C" fn crypto4xx_decrypt_aes_gcm(req: *mut aead_request) -> c_int {
