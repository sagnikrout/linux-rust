...
//! Source: drivers/crypto/hisilicon/zip/zip_main.c
#![no_std]
...
pub const PCI_DEVICE_ID_HUAWEI_ZIP_PF: c_uint = 0xa250;
pub const HZIP_QUEUE_NUM_V1: c_int = 4096;
pub const HZIP_CLOCK_GATE_CTRL: c_uint = 0x301004;

pub const HZIP_FSM_MAX_CNT: c_uint = 0x301008;
pub const HZIP_PORT_ARCA_CHE_0: c_uint = 0x301040;
pub const HZIP_PORT_ARCA_CHE_1: c_uint = 0x301044;
pub const HZIP_PORT_AWCA_CHE_0: c_uint = 0x301060;
pub const HZIP_PORT_AWCA_CHE_1: c_uint = 0x301064;
pub const HZIP_CACHE_ALL_EN: c_uint = 0xffffffff;
pub const HZIP_BD_RUSER_32_63: c_uint = 0x301110;
pub const HZIP_SGL_RUSER_32_63: c_uint = 0x30111c;
pub const HZIP_DATA_RUSER_32_63: c_uint = 0x301128;
pub const HZIP_DATA_WUSER_32_63: c_uint = 0x301134;
pub const HZIP_BD_WUSER_32_63: c_uint = 0x301140;
pub const HZIP_QM_IDEL_STATUS: c_uint = 0x3040e4;
pub const HZIP_CORE_DFX_BASE: c_uint = 0x301000;
pub const HZIP_CORE_DFX_DECOMP_BASE: c_uint = 0x304000;
pub const HZIP_CORE_DFX_COMP_0: c_uint = 0x302000;
pub const HZIP_CORE_DFX_COMP_1: c_uint = 0x303000;
pub const HZIP_CORE_DFX_DECOMP_0: c_uint = 0x304000;
pub const HZIP_CORE_DFX_DECOMP_1: c_uint = 0x305000;
pub const HZIP_CORE_DFX_DECOMP_2: c_uint = 0x306000;
pub const HZIP_CORE_DFX_DECOMP_3: c_uint = 0x307000;
pub const HZIP_CORE_DFX_DECOMP_4: c_uint = 0x308000;
pub const HZIP_CORE_DFX_DECOMP_5: c_uint = 0x309000;
pub const HZIP_CORE_REGS_BASE_LEN: c_uint = 0xB0;
pub const HZIP_CORE_REGS_DFX_LEN: c_uint = 0x28;
pub const HZIP_CORE_ADDR_INTRVL: c_uint = 0x1000;
pub const HZIP_CORE_INT_SOURCE: c_uint = 0x3010A0;
pub const HZIP_CORE_INT_MASK_REG: c_uint = 0x3010A4;
pub const HZIP_CORE_INT_SET: c_uint = 0x3010A8;
pub const HZIP_CORE_INT_STATUS: c_uint = 0x3010AC;

pub const HZIP_CORE_SRAM_ECC_ERR_INFO: c_uint = 0x301148;
pub const HZIP_CORE_INT_RAS_CE_ENB: c_uint = 0x301160;
pub const HZIP_CORE_INT_RAS_NFE_ENB: c_uint = 0x301164;
pub const HZIP_CORE_INT_RAS_FE_ENB: c_uint = 0x301168;
pub const HZIP_CORE_INT_RAS_FE_ENB_MASK: c_uint = 0x0;
pub const HZIP_OOO_SHUTDOWN_SEL: c_uint = 0x30120C;
pub const HZIP_SRAM_ECC_ERR_NUM_SHIFT: c_int = 16;
pub const HZIP_SRAM_ECC_ERR_ADDR_SHIFT: c_int = 24;

pub const HZIP_SQE_SIZE: c_int = 128;
pub const HZIP_PF_DEF_Q_NUM: c_int = 64;
pub const HZIP_PF_DEF_Q_BASE: c_int = 0;
pub const HZIP_CTX_Q_NUM_DEF: c_int = 2;
pub const HZIP_SOFT_CTRL_CNT_CLR_CE: c_uint = 0x301000;

pub const HZIP_SOFT_CTRL_ZIP_CONTROL: c_uint = 0x30100C;

pub const HZIP_BUF_SIZE: c_int = 22;
pub const HZIP_SQE_MASK_OFFSET: c_int = 64;
pub const HZIP_SQE_MASK_LEN: c_int = 48;

    HZIP_RO_CNT_CLR_CE_EN)
pub const HZIP_PREFETCH_CFG: c_uint = 0x3011B0;
pub const HZIP_SVA_TRANS: c_uint = 0x3011C4;

pub const HZIP_SHAPER_RATE_COMPRESS: c_int = 750;
pub const HZIP_SHAPER_RATE_DECOMPRESS: c_int = 140;
pub const HZIP_DELAY_1_US: c_int = 1;
pub const HZIP_POLL_TIMEOUT_US: c_int = 1000;
pub const HZIP_WAIT_SVA_READY: c_int = 500000;
pub const HZIP_READ_SVA_STATUS_TIMES: c_int = 3;
pub const HZIP_WAIT_US_MIN: c_int = 10;
pub const HZIP_WAIT_US_MAX: c_int = 20;
// clock gating
pub const HZIP_PEH_CFG_AUTO_GATE: c_uint = 0x3011A8;

    HZIP_CORE_GATED_OOO_EN)
// zip comp high performance
pub const HZIP_HIGH_PERF_OFFSET: c_uint = 0x301208;
pub const HZIP_LIT_LEN_EN_OFFSET: c_uint = 0x301204;

pub const HZIP_MAX_CHANNEL_NUM: c_int = 3;
    enum {
    HZIP_HIGH_COMP_RATE,
    HZIP_HIGH_COMP_PERF,
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ctrl_debug_file {
    pub index: enum ctrl_debug_file_index,
    pub lock: spinlock_t,
...
pub struct hisi_zip_ctrl {
    pub hisi_zip: *mut hisi_zip,
    pub files: [ctrl_debug_file; HZIP_DEBUG_FILE_NUM],
}
...
#[no_mangle]
unsafe extern "C" fn hzip_diff_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perf_mode_set(val: *const c_char, kp: *const kernel_param) -> c_int {
...
//
    let mut perf_mode: static u32 = HZIP_HIGH_COMP_RATE;
...
unsafe extern "C" fn pf_q_num_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    let mut pf_q_num: static u32 = HZIP_PF_DEF_Q_NUM;
...
#[no_mangle]
pub unsafe extern "C" fn zip_create_qps(qps: *mut hisi_qp, qp_num: c_int, node: c_int, alg_type: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hisi_zip_alg_support(qm: *mut hisi_qm, alg: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_literal_set(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_set_high_perf(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_wait_sva_ready(qm: *mut hisi_qm, offset: __u32, mask: __u32) -> c_int {
...
//
    ...
    count = 0;
#[no_mangle]
pub unsafe extern "C" fn if(HZIP_READ_SVA_STATUS_TIMES: ++count ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_close_sva_prefetch(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_open_sva_prefetch(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_enable_clock_gate(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_set_user_domain_and_cache(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_master_ooo_ctrl(qm: *mut hisi_qm, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_hw_error_enable(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_hw_error_disable(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn clear_enable_read(qm: *mut hisi_qm) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn clear_enable_write(qm: *mut hisi_qm, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zip_debugfs_atomic64_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zip_debugfs_atomic64_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_core_debug_init(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zip_cap_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_dfx_debug_init(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_ctrl_debug_init(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_debugfs_init(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_debug_regs_clear(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_debugfs_exit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_show_last_regs_init(qm: *mut hisi_qm) -> c_int {
    static int hisi_zip_show_last_regs_init(struct hisi_qm *qm)
    {
    let mut core_dfx_regs_num: c_int = ARRAY_SIZE(hzip_dump_dfx_regs);
    let mut com_dfx_regs_num: c_int = ARRAY_SIZE(hzip_com_dfx_regs);
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_show_last_regs_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_show_last_dfx_regs(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_log_hw_error(qm: *mut hisi_qm, err_sts: u32) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_get_hw_err_status(qm: *mut hisi_qm) -> u32 {
    static u32 hisi_zip_get_hw_err_status(struct hisi_qm *qm)
    {
    return readl(qm.io_base + HZIP_CORE_INT_STATUS);
    }
#[no_mangle]
unsafe extern "C" fn hisi_zip_clear_hw_err_status(qm: *mut hisi_qm, err_sts: u32) {
    static void hisi_zip_clear_hw_err_status(struct hisi_qm *qm, u32 err_sts)
    {
    writel(err_sts, qm.io_base + HZIP_CORE_INT_SOURCE);
    }
#[no_mangle]
unsafe extern "C" fn hisi_zip_disable_error_report(qm: *mut hisi_qm, err_type: u32) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_enable_error_report(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_open_axi_master_ooo(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_close_axi_master_ooo(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_get_err_result(qm: *mut hisi_qm) -> enum acc_err_result {
    static enum acc_err_result hisi_zip_get_err_result(struct hisi_qm *qm)
    {
    let mut zip_result: enum acc_err_result = ACC_ERR_NONE;
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_dev_is_abnormal(qm: *mut hisi_qm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_set_priv_status(qm: *mut hisi_qm) -> c_int {
    static int hisi_zip_set_priv_status(struct hisi_qm *qm)
    {
    return hisi_dae_close_axi_master_ooo(qm);
    }
#[no_mangle]
unsafe extern "C" fn hisi_zip_disable_axi_error(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_enable_axi_error(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_err_info_init(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_pf_probe_init(hisi_zip: *mut hisi_zip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zip_pre_store_cap_reg(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zip_set_channels(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_qm_init(qm: *mut hisi_qm, pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_qm_uninit(qm: *mut hisi_qm) {
    static void hisi_zip_qm_uninit(struct hisi_qm *qm)
    {
    hisi_qm_uninit(qm);
    }
#[no_mangle]
unsafe extern "C" fn hisi_zip_probe_init(hisi_zip: *mut hisi_zip) -> c_int {
    static int hisi_zip_probe_init(struct hisi_zip *hisi_zip)
    {
    let mut type_rate: u32 = HZIP_SHAPER_RATE_COMPRESS;
    struct hisi_qm *qm = &hisi_zip.qm;
    int ret;
    if (qm.fun_type == QM_HW_PF) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_probe_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_register_debugfs() {
    static void hisi_zip_register_debugfs(void)
    {
    if (!debugfs_initialized())
    return;
    hzip_debugfs_root = debugfs_create_dir("hisi_zip", core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn hisi_zip_unregister_debugfs() {
    static void hisi_zip_unregister_debugfs(void)
    {
    debugfs_remove_recursive(hzip_debugfs_root);
    }
#[no_mangle]
unsafe extern "C" fn hisi_zip_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hisi_zip_exit() -> void __exit {
