...
//! Source: drivers/crypto/hisilicon/sec/sec_algs.c
#![no_std]
...
pub const SEC_MAX_CIPHER_KEY: c_int = 64;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sec_c_alg_cfg {
    pub 3: unsigned c_alg :,
    pub 3: unsigned c_mode :,
    pub 2: unsigned key_len :,
    pub 2: unsigned c_width :,
}
...
//
    ...
    gfp_t gfp)
    {
    struct sec_hw_sgl *sgl_current = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn sec_send_request(sec_req: *mut sec_request, queue: *mut sec_queue) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sec_alg_callback(resp: *mut sec_bd_info, shadow: *mut c_void) {
...
// Writing whole u32 so no need to take care of masking
    ...
    struct scatterlist **splits_out = core::ptr::null_mut();
    int *splits_in_nents;
    int *splits_out_nents = core::ptr::null_mut();
    struct sec_request_el *el, *temp;
    let mut split: bool = skreq.src != skreq.dst;
    let mut gfp: gfp_t = skreq.base.flags & CRYPTO_TFM_REQ_MAY_SLEEP ? GFP_KERNEL : GFP_ATOMIC;
...
// Set them all up then queue - cleaner error handling.
    ...
    split ? splits_out[i] : core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn sec_alg_skcipher_encrypt(req: *mut skcipher_request) -> c_int {
    static int sec_alg_skcipher_encrypt(struct skcipher_request *req)
    {
    return sec_alg_skcipher_crypto(req, true);
    }
#[no_mangle]
unsafe extern "C" fn sec_alg_skcipher_decrypt(req: *mut skcipher_request) -> c_int {
    static int sec_alg_skcipher_decrypt(struct skcipher_request *req)
    {
    return sec_alg_skcipher_crypto(req, false);
    }
#[no_mangle]
unsafe extern "C" fn sec_alg_skcipher_init(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sec_alg_skcipher_exit(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
unsafe extern "C" fn sec_alg_skcipher_init_with_queue(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sec_alg_skcipher_exit_with_queue(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
pub unsafe extern "C" fn sec_algs_register() -> c_int {
