...
//! Source: drivers/crypto/hisilicon/debugfs.c
#![no_std]
...
pub const QM_DFX_BASE: c_uint = 0x0100000;
pub const QM_DFX_STATE1: c_uint = 0x0104000;
pub const QM_DFX_STATE2: c_uint = 0x01040C8;
pub const QM_DFX_COMMON: c_uint = 0x0000;
pub const QM_DFX_BASE_LEN: c_uint = 0x5A;
pub const QM_DFX_STATE1_LEN: c_uint = 0x2E;
pub const QM_DFX_STATE2_LEN: c_uint = 0x11;
pub const QM_DFX_COMMON_LEN: c_uint = 0xC3;

pub const QM_DBG_TMP_BUF_LEN: c_int = 22;

pub const QM_DFX_MB_CNT_VF: c_uint = 0x104010;
pub const QM_DFX_DB_CNT_VF: c_uint = 0x104020;
pub const QM_DFX_SQE_CNT_VF_SQN: c_uint = 0x104030;
pub const QM_DFX_CQE_CNT_VF_CQN: c_uint = 0x104040;
pub const QM_DFX_QN_SHIFT: c_int = 16;
pub const QM_DFX_CNT_CLR_CE: c_uint = 0x100118;
pub const QM_DBG_WRITE_LEN: c_int = 1024;
pub const QM_IN_IDLE_ST_REG: c_uint = 0x1040e4;
pub const QM_IN_IDLE_STATE: c_uint = 0x1;
...
pub struct qm_cmd_dump_item {
    ...
    pub info_name): *const *const *const *const int (dump_fn)(struct hisi_qm qm, char cmd, char,
}
...
pub const CNT_CYC_REGS_NUM: c_int = 10;
...
#[no_mangle]
unsafe extern "C" fn qm_sqc_dump(qm: *mut hisi_qm, s: *mut c_char, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_cqc_dump(qm: *mut hisi_qm, s: *mut c_char, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_eqc_aeqc_dump(qm: *mut hisi_qm, s: *mut c_char, name: *const c_char) -> c_int {
    ...
    {
    struct device *dev = &qm.pdev.dev;
    let mut qp_num: c_uint = qm.qp_num;
    char *presult;
    int ret;
    presult = strsep(&s, " ");
    if (!presult) {
...
#[no_mangle]
unsafe extern "C" fn qm_sq_dump(qm: *mut hisi_qm, s: *mut c_char, name: *const c_char) -> c_int {
    static int qm_sq_dump(struct hisi_qm *qm, char *s, const char *name)
    {
    let mut sq_depth: u16 = qm.qp_array.sq_depth;
    struct hisi_qp *qp;
    u32 qp_id, sqe_id;
    void *sqe;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qm_cq_dump(qm: *mut hisi_qm, s: *mut c_char, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_eq_aeq_dump(qm: *mut hisi_qm, s: *mut c_char, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_dbg_help(qm: *mut hisi_qm, s: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_cmd_write_dump(qm: *mut hisi_qm, cmd_buf: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_regs_dump(s: *mut seq_file, regset: *mut debugfs_regset32) {
    void hisi_qm_regs_dump(struct seq_file *s, struct debugfs_regset32 *regset)
    {
    struct pci_dev *pdev = to_pci_dev(regset.dev);
    struct hisi_qm *qm = pci_get_drvdata(pdev);
    const struct debugfs_reg32 *regs = regset.regs;
    let mut regs_len: c_int = regset.nregs;
    int i, ret;
    u32 val;
    ret = hisi_qm_get_dfx_access(qm);
    if (ret)
...
#[no_mangle]
unsafe extern "C" fn qm_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn current_q_read(qm: *mut hisi_qm) -> u32 {
    static u32 current_q_read(struct hisi_qm *qm)
    {
    return readl(qm.io_base + QM_DFX_SQE_CNT_VF_SQN) >> QM_DFX_QN_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn current_q_write(qm: *mut hisi_qm, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clear_enable_write(qm: *mut hisi_qm, rd_clr_ctrl: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn current_qm_read(qm: *mut hisi_qm) -> u32 {
    static u32 current_qm_read(struct hisi_qm *qm)
    {
    return readl(qm.io_base + QM_DFX_MB_CNT_VF);
    }
#[no_mangle]
unsafe extern "C" fn qm_get_vf_qp_num(qm: *mut hisi_qm, fun_num: u32) -> c_int {
    static int qm_get_vf_qp_num(struct hisi_qm *qm, u32 fun_num)
    {
    u32 remain_q_num, vfq_num;
    let mut num_vfs: u32 = qm.vfs_num;
    ...
    let mut fun_num: return = = num_vfs ? vfq_num + remain_q_num : vfq_num;
//
...
#[no_mangle]
unsafe extern "C" fn current_qm_write(qm: *mut hisi_qm, val: u32) -> c_int {
...
// According PF or VF Dev ID to calculation curr_qm_qp_num and store
    ...
    let mut index: enum qm_debug_file = file.index;
...
// Setting the pointer is NULL to prevent double free
    ...
    continue;
    kfree(dregs[i].regs);
    dregs[i].regs = core::ptr::null_mut();
    }
    kfree(dregs);
    }
    ...
    qm.debug.qm_diff_regs = core::ptr::null_mut();
    return ret;
    }
    ...
    qm.debug.acc_diff_regs = core::ptr::null_mut();
    qm.debug.qm_diff_regs = core::ptr::null_mut();
    return ret;
    }
    return 0;
...
#[no_mangle]
unsafe extern "C" fn qm_last_regs_uninit(qm: *mut hisi_qm) {
    ...
    debug.qm_last_words = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn qm_last_regs_init(qm: *mut hisi_qm) -> c_int {
    static int qm_last_regs_init(struct hisi_qm *qm)
    {
    let mut dfx_regs_num: c_int = ARRAY_SIZE(qm_dfx_regs);
    struct qm_debug *debug = &qm.debug;
    int i;
...
#[no_mangle]
unsafe extern "C" fn qm_diff_regs_uninit(qm: *mut hisi_qm, reg_len: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_regs_debugfs_uninit(qm: *mut hisi_qm, reg_len: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_show_last_dfx_regs(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_usage_percent(qm: *mut hisi_qm, chan_num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_usage_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int qm_usage_show(struct seq_file *s, void *unused)
    {
    struct hisi_qm *qm = s.private;
    let mut dev_is_active: bool = true;
    int i, ret;
...
#[no_mangle]
unsafe extern "C" fn qm_diff_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_state_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_debugfs_atomic64_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_debugfs_atomic64_get(data: *mut c_void, val: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_debug_init(qm: *mut hisi_qm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_debug_regs_clear(qm: *mut hisi_qm) {
