...
//! Source: drivers/crypto/hisilicon/hpre/hpre_main.c
#![no_std]
...
pub const HPRE_CTRL_CNT_CLR_CE: c_uint = 0x301000;
pub const HPRE_FSM_MAX_CNT: c_uint = 0x301008;
pub const HPRE_VFG_AXQOS: c_uint = 0x30100c;
pub const HPRE_VFG_AXCACHE: c_uint = 0x301010;
pub const HPRE_RDCHN_INI_CFG: c_uint = 0x301014;
pub const HPRE_AWUSR_FP_CFG: c_uint = 0x301018;
pub const HPRE_BD_ENDIAN: c_uint = 0x301020;
pub const HPRE_ECC_BYPASS: c_uint = 0x301024;
pub const HPRE_RAS_WIDTH_CFG: c_uint = 0x301028;
pub const HPRE_POISON_BYPASS: c_uint = 0x30102c;
pub const HPRE_BD_ARUSR_CFG: c_uint = 0x301030;
pub const HPRE_BD_AWUSR_CFG: c_uint = 0x301034;
pub const HPRE_TYPES_ENB: c_uint = 0x301038;

pub const HPRE_DATA_RUSER_CFG: c_uint = 0x30103c;
pub const HPRE_DATA_WUSER_CFG: c_uint = 0x301040;
pub const HPRE_INT_MASK: c_uint = 0x301400;
pub const HPRE_INT_STATUS: c_uint = 0x301800;
pub const HPRE_HAC_INT_MSK: c_uint = 0x301400;
pub const HPRE_HAC_RAS_CE_ENB: c_uint = 0x301410;
pub const HPRE_HAC_RAS_NFE_ENB: c_uint = 0x301414;
pub const HPRE_HAC_RAS_FE_ENB: c_uint = 0x301418;
pub const HPRE_HAC_INT_SET: c_uint = 0x301500;

pub const HPRE_RNG_TIMEOUT_NUM: c_uint = 0x301A34;
pub const HPRE_CORE_INT_ENABLE: c_int = 0;
pub const HPRE_RDCHN_INI_ST: c_uint = 0x301a00;
pub const HPRE_CLSTR_BASE: c_uint = 0x302000;
pub const HPRE_CORE_EN_OFFSET: c_uint = 0x04;
pub const HPRE_CORE_INI_CFG_OFFSET: c_uint = 0x20;
pub const HPRE_CORE_INI_STATUS_OFFSET: c_uint = 0x80;
pub const HPRE_CORE_HTBT_WARN_OFFSET: c_uint = 0x8c;
pub const HPRE_CORE_IS_SCHD_OFFSET: c_uint = 0x90;
pub const HPRE_RAS_CE_ENB: c_uint = 0x301410;
pub const HPRE_RAS_NFE_ENB: c_uint = 0x301414;
pub const HPRE_RAS_FE_ENB: c_uint = 0x301418;
pub const HPRE_OOO_SHUTDOWN_SEL: c_uint = 0x301a3c;
pub const HPRE_HAC_RAS_FE_ENABLE: c_int = 0;

pub const HPRE_HAC_ECC1_CNT: c_uint = 0x301a04;
pub const HPRE_HAC_ECC2_CNT: c_uint = 0x301a08;
pub const HPRE_HAC_SOURCE_INT: c_uint = 0x301600;
pub const HPRE_CLSTR_ADDR_INTRVL: c_uint = 0x1000;
pub const HPRE_CLUSTER_INQURY: c_uint = 0x100;
pub const HPRE_CLSTR_ADDR_INQRY_RSLT: c_uint = 0x104;
pub const HPRE_PASID_EN_BIT: c_int = 9;
pub const HPRE_REG_RD_INTVRL_US: c_int = 10;
pub const HPRE_REG_RD_TMOUT_US: c_int = 1000;
pub const HPRE_DBGFS_VAL_MAX_LEN: c_int = 20;
pub const PCI_DEVICE_ID_HUAWEI_HPRE_PF: c_uint = 0xa258;

pub const HPRE_PREFETCH_CFG: c_uint = 0x301130;
pub const HPRE_SVA_PREFTCH_DFX: c_uint = 0x30115C;

pub const HPRE_SVA_PREFTCH_DFX4: c_uint = 0x301144;
pub const HPRE_WAIT_SVA_READY: c_int = 500000;
pub const HPRE_READ_SVA_STATUS_TIMES: c_int = 3;
pub const HPRE_WAIT_US_MIN: c_int = 10;
pub const HPRE_WAIT_US_MAX: c_int = 20;
// clock gate
pub const HPRE_CLKGATE_CTL: c_uint = 0x301a10;
pub const HPRE_PEH_CFG_AUTO_GATE: c_uint = 0x301a2c;
pub const HPRE_CLUSTER_DYN_CTL: c_uint = 0x302010;
pub const HPRE_CORE_SHB_CFG: c_uint = 0x302088;

pub const HPRE_AM_OOO_SHUTDOWN_ENB: c_uint = 0x301044;

pub const HPRE_SHAPER_TYPE_RATE: c_int = 640;
pub const HPRE_VIA_MSI_DSM: c_int = 1;
pub const HPRE_SQE_MASK_OFFSET: c_int = 8;
pub const HPRE_SQE_MASK_LEN: c_int = 44;
pub const HPRE_CTX_Q_NUM_DEF: c_int = 1;
pub const HPRE_DFX_BASE: c_uint = 0x301000;
pub const HPRE_DFX_COMMON1: c_uint = 0x301400;
pub const HPRE_DFX_COMMON2: c_uint = 0x301A00;
pub const HPRE_DFX_CORE: c_uint = 0x302000;
pub const HPRE_DFX_BASE_LEN: c_uint = 0x55;
pub const HPRE_DFX_COMMON1_LEN: c_uint = 0x41;
pub const HPRE_DFX_COMMON2_LEN: c_uint = 0xE;
pub const HPRE_DFX_CORE_LEN: c_uint = 0x43;
pub const HPRE_MAX_CHANNEL_NUM: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn hpre_check_alg_support(qm: *mut hisi_qm, alg: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hpre_diff_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_com_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_cluster_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf_q_num_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    ...
    let mut pf_q_num: static u32 = HPRE_PF_DEF_Q_NUM;
    ...
    struct hisi_qp *qp = core::ptr::null_mut();
    int ret;
...
#[no_mangle]
unsafe extern "C" fn hpre_wait_sva_ready(qm: *mut hisi_qm) -> c_int {
...
//
    ...
    count = 0;
#[no_mangle]
pub unsafe extern "C" fn if(HPRE_READ_SVA_STATUS_TIMES: ++count ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn hpre_config_pasid(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_cfg_by_dsm(qm: *mut hisi_qm) -> c_int {
...
// Switch over to MSI handling due to non-standard PCI implementation
    ...
    0, HPRE_VIA_MSI_DSM, core::ptr::null_mut());
    if (!obj) {
...
#[no_mangle]
unsafe extern "C" fn hpre_set_cluster(qm: *mut hisi_qm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn disable_flr_of_bme(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_close_sva_prefetch(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_open_sva_prefetch(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_enable_clock_gate(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_disable_clock_gate(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_set_user_domain_and_cache(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_cnt_regs_clear(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_master_ooo_ctrl(qm: *mut hisi_qm, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn hpre_hw_error_disable(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_hw_error_enable(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_clear_enable_read(file: *mut hpre_debugfs_file) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hpre_clear_enable_write(file: *mut hpre_debugfs_file, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_cluster_inqry_read(file: *mut hpre_debugfs_file) -> u32 {
    static u32 hpre_cluster_inqry_read(struct hpre_debugfs_file *file)
    {
    struct hisi_qm *qm = hpre_file_to_qm(file);
    let mut cluster_index: c_int = file.index - HPRE_CLUSTER_CTRL;
...
#[no_mangle]
unsafe extern "C" fn hpre_cluster_inqry_write(file: *mut hpre_debugfs_file, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn hpre_debugfs_atomic64_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_debugfs_atomic64_set(data: *mut c_void, val: u64) -> c_int {
    static int hpre_debugfs_atomic64_set(void *data, u64 val)
    {
    struct hpre_dfx *dfx_item = data;
    struct hpre_dfx *hpre_dfx = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn hpre_pf_comm_regs_debugfs_init(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_cluster_debugfs_init(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_ctrl_debug_init(qm: *mut hisi_qm) -> c_int {
    static int hpre_ctrl_debug_init(struct hisi_qm *qm)
    {
    int ret;
    ret = hpre_create_debugfs_file(qm, core::ptr::null_mut(), HPRE_CLEAR_ENABLE,
    HPRE_CLEAR_ENABLE);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn hpre_cap_regs_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_dfx_debug_init(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_debugfs_init(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_debugfs_exit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_pre_store_cap_reg(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_set_channels(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_qm_init(qm: *mut hisi_qm, pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_show_last_regs_init(qm: *mut hisi_qm) -> c_int {
    static int hpre_show_last_regs_init(struct hisi_qm *qm)
    {
    let mut cluster_dfx_regs_num: c_int = ARRAY_SIZE(hpre_cluster_dfx_regs);
    let mut com_dfx_regs_num: c_int = ARRAY_SIZE(hpre_com_dfx_regs);
...
#[no_mangle]
unsafe extern "C" fn hpre_show_last_regs_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_show_last_dfx_regs(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_log_hw_error(qm: *mut hisi_qm, err_sts: u32) {
...
#[no_mangle]
unsafe extern "C" fn hpre_get_hw_err_status(qm: *mut hisi_qm) -> u32 {
    static u32 hpre_get_hw_err_status(struct hisi_qm *qm)
    {
    return readl(qm.io_base + HPRE_INT_STATUS);
    }
#[no_mangle]
unsafe extern "C" fn hpre_clear_hw_err_status(qm: *mut hisi_qm, err_sts: u32) {
    static void hpre_clear_hw_err_status(struct hisi_qm *qm, u32 err_sts)
    {
    writel(err_sts, qm.io_base + HPRE_HAC_SOURCE_INT);
    }
#[no_mangle]
unsafe extern "C" fn hpre_disable_error_report(qm: *mut hisi_qm, err_type: u32) {
...
#[no_mangle]
unsafe extern "C" fn hpre_enable_error_report(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_open_axi_master_ooo(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_get_err_result(qm: *mut hisi_qm) -> enum acc_err_result {
...
#[no_mangle]
unsafe extern "C" fn hpre_dev_is_abnormal(qm: *mut hisi_qm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hpre_disable_axi_error(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_enable_axi_error(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_err_info_init(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_pf_probe_init(hpre: *mut hpre) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_probe_init(hpre: *mut hpre) -> c_int {
    static int hpre_probe_init(struct hpre *hpre)
    {
    let mut type_rate: u32 = HPRE_SHAPER_TYPE_RATE;
    struct hisi_qm *qm = &hpre.qm;
    int ret;
    if (qm.fun_type == QM_HW_PF) {
...
#[no_mangle]
unsafe extern "C" fn hpre_probe_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hpre_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpre_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hpre_register_debugfs() {
    static void hpre_register_debugfs(void)
    {
    if (!debugfs_initialized())
    return;
    hpre_debugfs_root = debugfs_create_dir(hpre_name, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn hpre_unregister_debugfs() {
    static void hpre_unregister_debugfs(void)
    {
    debugfs_remove_recursive(hpre_debugfs_root);
    }
#[no_mangle]
unsafe extern "C" fn hpre_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hpre_exit() -> void __exit {
