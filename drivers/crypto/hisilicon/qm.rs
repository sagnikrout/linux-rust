...
//! Source: drivers/crypto/hisilicon/qm.c
#![no_std]
...
// eq/aeq irq enable
pub const QM_VF_AEQ_INT_SOURCE: c_uint = 0x0;
pub const QM_VF_AEQ_INT_MASK: c_uint = 0x4;
pub const QM_VF_EQ_INT_SOURCE: c_uint = 0x8;
pub const QM_VF_EQ_INT_MASK: c_uint = 0xc;

pub const QM_IRQ_TYPE_SHIFT: c_int = 16;

// mailbox
pub const QM_MB_PING_ALL_VFS: c_uint = 0xffff;

// sqc shift
pub const QM_SQ_HOP_NUM_SHIFT: c_int = 0;
pub const QM_SQ_PAGE_SIZE_SHIFT: c_int = 4;
pub const QM_SQ_BUF_SIZE_SHIFT: c_int = 8;
pub const QM_SQ_SQE_SIZE_SHIFT: c_int = 12;
pub const QM_SQ_PRIORITY_SHIFT: c_int = 0;
pub const QM_SQ_ORDERS_SHIFT: c_int = 4;
pub const QM_SQ_TYPE_SHIFT: c_int = 8;
pub const QM_QC_PASID_ENABLE: c_uint = 0x1;
pub const QM_QC_PASID_ENABLE_SHIFT: c_int = 7;

pub const QM_XQC_RANDOM_DATA: c_uint = 0xaaaa;
// cqc shift
pub const QM_CQ_HOP_NUM_SHIFT: c_int = 0;
pub const QM_CQ_PAGE_SIZE_SHIFT: c_int = 4;
pub const QM_CQ_BUF_SIZE_SHIFT: c_int = 8;
pub const QM_CQ_CQE_SIZE_SHIFT: c_int = 12;
pub const QM_CQ_PHASE_SHIFT: c_int = 0;
pub const QM_CQ_FLAG_SHIFT: c_int = 1;

pub const QM_QC_CQE_SIZE: c_int = 4;

// eqc shift

pub const QM_EQC_PHASE_SHIFT: c_int = 16;

pub const QM_AEQE_TYPE_SHIFT: c_int = 17;
pub const QM_AEQE_TYPE_MASK: c_uint = 0xf;

pub const QM_CQ_OVERFLOW: c_int = 0;
pub const QM_EQ_OVERFLOW: c_int = 1;
pub const QM_CQE_ERROR: c_int = 2;
pub const QM_XQ_DEPTH_SHIFT: c_int = 16;
...
pub const QM_DOORBELL_BASE_V1: c_uint = 0x340;
pub const QM_DB_CMD_SHIFT_V1: c_int = 16;
pub const QM_DB_INDEX_SHIFT_V1: c_int = 32;
pub const QM_DB_PRIORITY_SHIFT_V1: c_int = 48;
pub const QM_PAGE_SIZE: c_uint = 0x0034;
pub const QM_QP_DB_INTERVAL: c_uint = 0x10000;
pub const QM_DB_TIMEOUT_CFG: c_uint = 0x100074;
pub const QM_DB_TIMEOUT_SET: c_uint = 0x1fffff;
pub const QM_MEM_START_INIT: c_uint = 0x100040;
pub const QM_MEM_INIT_DONE: c_uint = 0x100044;
...
pub const QM_PM_CTRL: c_uint = 0x100148;

pub const QM_SUB_VERSION_ID: c_uint = 0x210;
pub const QM_VFT_CFG_DATA_L: c_uint = 0x100064;
pub const QM_VFT_CFG_DATA_H: c_uint = 0x100068;

pub const QM_SQC_VFT_START_SQN_SHIFT: c_int = 28;

pub const QM_SQC_VFT_SQN_SHIFT: c_int = 45;

pub const QM_SQC_VFT_BASE_SHIFT_V2: c_int = 28;

pub const QM_SQC_VFT_NUM_SHIFT_V2: c_int = 45;

pub const QM_MAX_QC_TYPE: c_int = 2;
pub const QM_ABNORMAL_INT_SOURCE: c_uint = 0x100000;
pub const QM_ABNORMAL_INT_MASK: c_uint = 0x100004;
pub const QM_ABNORMAL_INT_STATUS: c_uint = 0x100008;
pub const QM_ABNORMAL_INT_SET: c_uint = 0x10000c;
pub const QM_ABNORMAL_INF00: c_uint = 0x100010;
pub const QM_FIFO_OVERFLOW_TYPE: c_uint = 0xc0;
pub const QM_FIFO_OVERFLOW_TYPE_SHIFT: c_int = 6;
pub const QM_FIFO_OVERFLOW_VF: c_uint = 0x3f;
pub const QM_FIFO_OVERFLOW_QP_SHIFT: c_int = 16;
pub const QM_ABNORMAL_INF01: c_uint = 0x100014;
pub const QM_DB_TIMEOUT_TYPE: c_uint = 0xc0;
pub const QM_DB_TIMEOUT_TYPE_SHIFT: c_int = 6;
pub const QM_DB_TIMEOUT_VF: c_uint = 0x3f;
pub const QM_DB_TIMEOUT_QP_SHIFT: c_int = 16;
pub const QM_ABNORMAL_INF02: c_uint = 0x100018;

pub const QM_RAS_CE_ENABLE: c_uint = 0x1000ec;
pub const QM_RAS_FE_ENABLE: c_uint = 0x1000f0;
pub const QM_RAS_NFE_ENABLE: c_uint = 0x1000f4;
pub const QM_RAS_CE_THRESHOLD: c_uint = 0x1000f8;
pub const QM_RAS_CE_TIMES_PER_IRQ: c_int = 1;
pub const QM_OOO_SHUTDOWN_SEL: c_uint = 0x1040f8;

pub const QM_RESET_WAIT_TIMEOUT: c_int = 400;
pub const QM_PEH_VENDOR_ID: c_uint = 0x1000d8;
pub const ACC_VENDOR_ID_VALUE: c_uint = 0x5a5a;
pub const QM_PEH_DFX_INFO0: c_uint = 0x1000fc;
pub const QM_PEH_DFX_INFO1: c_uint = 0x100100;

pub const ACC_PEH_SRIOV_CTRL_VF_MSE_SHIFT: c_int = 3;

pub const ACC_MASTER_GLOBAL_CTRL_SHUTDOWN: c_uint = 0x1;
pub const ACC_MASTER_TRANS_RETURN_RW: c_int = 3;
pub const ACC_MASTER_TRANS_RETURN: c_uint = 0x300150;
pub const ACC_MASTER_GLOBAL_CTRL: c_uint = 0x300000;
pub const ACC_AM_CFG_PORT_WR_EN: c_uint = 0x30001c;
pub const ACC_AM_ROB_ECC_INT_STS: c_uint = 0x300104;

// interfunction communication
pub const QM_IFC_READY_STATUS: c_uint = 0x100128;
pub const QM_IFC_INT_SET_P: c_uint = 0x100130;
pub const QM_IFC_INT_CFG: c_uint = 0x100134;
pub const QM_IFC_INT_SOURCE_P: c_uint = 0x100138;
...
pub const QM_PF2VF_PF_W: c_uint = 0x104700;
pub const QM_VF2PF_PF_R: c_uint = 0x104800;
pub const QM_VF2PF_VF_W: c_uint = 0x320;
pub const QM_PF2VF_VF_R: c_uint = 0x380;

pub const QM_WAIT_DST_ACK: c_int = 1000;
pub const QM_MAX_PF_WAIT_COUNT: c_int = 20;
pub const QM_MAX_VF_WAIT_COUNT: c_int = 40;
pub const QM_VF_RESET_WAIT_US: c_int = 20000;
pub const QM_VF_RESET_WAIT_CNT: c_int = 3000;
pub const QM_VF2PF_REG_SIZE: c_int = 4;

pub const QM_IFC_DATA_SHIFT: c_int = 32;

    (QM_VF_RESET_WAIT_US * QM_VF_RESET_WAIT_CNT)
pub const POLL_PERIOD: c_int = 10;
pub const POLL_TIMEOUT: c_int = 1000;
pub const WAIT_PERIOD_US_MAX: c_int = 200;
pub const WAIT_PERIOD_US_MIN: c_int = 100;
pub const MAX_WAIT_COUNTS: c_int = 1000;
pub const QM_CACHE_WB_START: c_uint = 0x204;
pub const QM_CACHE_WB_DONE: c_uint = 0x208;
pub const QM_FUNC_CAPS_REG: c_uint = 0x3100;

pub const PCI_BAR_2: c_int = 2;
pub const PCI_BAR_4: c_int = 4;

pub const QM_DBG_READ_LEN: c_int = 256;

pub const QM_RESET_STOP_TX_OFFSET: c_int = 1;
pub const QM_RESET_STOP_RX_OFFSET: c_int = 2;
pub const WAIT_PERIOD: c_int = 20;
pub const REMOVE_WAIT_DELAY: c_int = 10;
pub const QM_QOS_PARAM_NUM: c_int = 2;
pub const QM_QOS_MAX_VAL: c_int = 1000;
pub const QM_QOS_RATE: c_int = 100;
pub const QM_QOS_EXPAND_RATE: c_int = 1000;

pub const QM_SHAPER_FACTOR_CIR_U_SHIFT: c_int = 8;
pub const QM_SHAPER_FACTOR_CIR_S_SHIFT: c_int = 11;
pub const QM_SHAPER_FACTOR_CBS_B_SHIFT: c_int = 15;
pub const QM_SHAPER_FACTOR_CBS_S_SHIFT: c_int = 19;
pub const QM_SHAPER_CBS_B: c_int = 1;
pub const QM_SHAPER_VFT_OFFSET: c_int = 6;
pub const QM_QOS_MIN_ERROR_RATE: c_int = 5;
pub const QM_SHAPER_MIN_CBS_S: c_int = 8;
pub const QM_QOS_TICK: c_uint = 0x300U;
pub const QM_QOS_DIVISOR_CLK: c_uint = 0x1f40U;
pub const QM_QOS_MAX_CIR_B: c_int = 200;
pub const QM_QOS_MIN_CIR_B: c_int = 100;
pub const QM_QOS_MAX_CIR_U: c_int = 6;
pub const QM_AUTOSUSPEND_DELAY: c_int = 3000;

pub const QM_DB_DROP_ALL_FUNC_DISABLE: c_int = 0;
pub const QM_DEV_DB_DROP: c_uint = 0x0100250;
pub const QM_FUN_DB_DROP: c_uint = 0x0038;
// qm function err mask
pub const QM_FUNC_AXI_ERR_ST0: c_uint = 0x100280;

// qm isolation state mask

// abnormal status value for stopping queue
pub const QM_STOP_QUEUE_FAIL: c_int = 1;
pub const QM_DUMP_SQC_FAIL: c_int = 3;
pub const QM_DUMP_CQC_FAIL: c_int = 4;
pub const QM_FINISH_WAIT: c_int = 5;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_qm_hw_ops {
    pub number): *mut *mut *mut *mut int (get_vft)(struct hisi_qm qm, u32 base, u32,
    void (*qm_db)(struct hisi_qm *qm, u16 qn,
    pub priority): u8 cmd, u16 index, u8,
    pub qm): *mut *mut int (debug_init)(struct hisi_qm,
    pub qm): *mut *mut void (hw_error_init)(struct hisi_qm,
    pub qm): *mut *mut void (hw_error_uninit)(struct hisi_qm,
    pub qm): *mut *mut enum acc_err_result (hw_error_handle)(struct hisi_qm,
    pub set): *mut *mut *mut int (set_msi)(struct hisi_qm qm, bool,
// (u64)msg = (u32)data << 32 | (enum qm_ifc_cmd)cmd
    pub fun_num): *mut *mut *mut int (set_ifc_begin)(struct hisi_qm qm, enum qm_ifc_cmd cmd, u32 data, u32,
    pub qm): *mut *mut void (set_ifc_end)(struct hisi_qm,
    pub fun_num): *mut *mut *mut *mut *mut int (get_ifc)(struct hisi_qm qm, enum qm_ifc_cmd cmd, u32 data, u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_qm_hw_error {
    pub int_msk: u32,
...
// the qos step is 100
    ...
    if (!val)
    return -EINVAL;
    pdev = pci_get_device(PCI_VENDOR_ID_HUAWEI, device, core::ptr::null_mut());
    if (!pdev) {
...
#[no_mangle]
unsafe extern "C" fn qm_get_hw_error_status(qm: *mut hisi_qm) -> u32 {
    static u32 qm_get_hw_error_status(struct hisi_qm *qm)
    {
    return readl(qm.io_base + QM_ABNORMAL_INT_STATUS);
    }
#[no_mangle]
unsafe extern "C" fn qm_get_dev_err_status(qm: *mut hisi_qm) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qm_check_dev_error(qm: *mut hisi_qm) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qm_wait_reset_finish(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_fun_db_ctrl(qm: *mut hisi_qm, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn qm_dev_db_ctrl(qm: *mut hisi_qm, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn qm_reset_prepare_ready(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_reset_bit_clear(qm: *mut hisi_qm) {
...
//
#[no_mangle]
unsafe extern "C" fn qm_mb_read(qm: *mut hisi_qm) -> qm_mailbox {
    static struct qm_mailbox qm_mb_read(struct hisi_qm *qm)
    {
    let mut mailbox: qm_mailbox = {0};
...
#[no_mangle]
unsafe extern "C" fn qm_mb_write(qm: *mut hisi_qm, src: *const c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_wait_mb_ready(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_wait_mb_finish(qm: *mut hisi_qm, mailbox: *mut qm_mailbox, wait_timeout: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_mb_nolock(qm: *mut hisi_qm, mailbox: *mut qm_mailbox, wait_timeout: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_mb_read(qm: *mut hisi_qm, base: *mut u64, cmd: u8, queue: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn qm_set_and_get_xqc(qm: *mut hisi_qm, cmd: u8, xqc: *mut c_void, qp_id: u32, op: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_db_v1(qm: *mut hisi_qm, qn: u16, cmd: u8, index: u16, priority: u8) {
...
#[no_mangle]
unsafe extern "C" fn qm_db_v2(qm: *mut hisi_qm, qn: u16, cmd: u8, index: u16, priority: u8) {
    static void qm_db_v2(struct hisi_qm *qm, u16 qn, u8 cmd, u16 index, u8 priority)
    {
    void __iomem *io_base = qm.io_base;
    let mut randata: u16 = 0;
    u64 doorbell;
...
#[no_mangle]
unsafe extern "C" fn qm_db(qm: *mut hisi_qm, qn: u16, cmd: u8, index: u16, priority: u8) {
...
#[no_mangle]
unsafe extern "C" fn qm_disable_clock_gate(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_dev_mem_reset(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_get_irq_num(qm: *mut hisi_qm) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qm_pm_get_sync(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_pm_put_sync(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_cq_head_update(qp: *mut hisi_qp) {
...
#[no_mangle]
unsafe extern "C" fn qm_poll_req_cb(qp: *mut hisi_qp) {
...
#[no_mangle]
unsafe extern "C" fn qm_work_process(work: *mut work_struct) {
    static void qm_work_process(struct work_struct *work)
    {
    struct hisi_qm_poll_data *poll_data =
    container_of(work, struct hisi_qm_poll_data, work);
    struct hisi_qm *qm = poll_data.qm;
    let mut eqe_num: u16 = poll_data.eqe_num;
    struct hisi_qp *qp;
    int i;
...
#[no_mangle]
unsafe extern "C" fn qm_get_complete_eqe_num(qm: *mut hisi_qm) {
    static void qm_get_complete_eqe_num(struct hisi_qm *qm)
    {
    struct qm_eqe *eqe = qm.eqe + qm.status.eq_head;
    struct hisi_qm_poll_data *poll_data = core::ptr::null_mut();
    let mut dw0: u32 = le32_to_cpu(eqe.dw0);
    let mut eq_depth: u16 = qm.eq_depth;
    u16 cqn, eqe_num = 0;
...
#[no_mangle]
unsafe extern "C" fn qm_eq_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qm_mb_cmd_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qm_set_qp_disable(qp: *mut hisi_qp, offset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qm_disable_qp(qm: *mut hisi_qm, qp_id: u32) {
...
#[no_mangle]
unsafe extern "C" fn qm_reset_function(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_aeq_thread(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t qm_aeq_thread(int irq, void *data)
    {
    struct hisi_qm *qm = data;
    struct qm_aeqe *aeqe = qm.aeqe + qm.status.aeq_head;
    let mut dw0: u32 = le32_to_cpu(aeqe.dw0);
    let mut aeq_depth: u16 = qm.aeq_depth;
    u32 type, qp_id;
...
#[no_mangle]
unsafe extern "C" fn qm_init_qp_status(qp: *mut hisi_qp) {
...
#[no_mangle]
unsafe extern "C" fn qm_init_prefetch(qm: *mut hisi_qm) {
    static void qm_init_prefetch(struct hisi_qm *qm)
    {
    struct device *dev = &qm.pdev.dev;
    let mut page_type: u32 = 0x0;
...
//
#[no_mangle]
unsafe extern "C" fn acc_shaper_para_calc(cir_b: u64, cir_u: u64, cir_s: u64) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn acc_shaper_calc_cbs_s(ir: u32) -> u32 {
    static u32 acc_shaper_calc_cbs_s(u32 ir)
    {
    let mut table_size: c_int = ARRAY_SIZE(shaper_cbs_s);
    int i;
...
#[no_mangle]
unsafe extern "C" fn acc_shaper_calc_cir_s(ir: u32) -> u32 {
    static u32 acc_shaper_calc_cir_s(u32 ir)
    {
    let mut table_size: c_int = ARRAY_SIZE(shaper_cir_s);
    int i;
    for (i = 0; i < table_size; i++) {
...
#[no_mangle]
unsafe extern "C" fn qm_get_shaper_para(ir: u32, factor: *mut qm_shaper_factor) -> c_int {
...
//
    ...
    {
    struct qm_shaper_factor *factor = core::ptr::null_mut();
    unsigned int val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qm_shaper_init_vft(qm: *mut hisi_qm, fun_num: u32) -> c_int {
    static int qm_shaper_init_vft(struct hisi_qm *qm, u32 fun_num)
    {
    let mut qos: u32 = qm.factor[fun_num].func_qos;
    int ret, i;
...
#[no_mangle]
unsafe extern "C" fn qm_get_vft_v2(qm: *mut hisi_qm, base: *mut u32, number: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_hw_error_init_v2(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_hw_error_uninit_v2(qm: *mut hisi_qm) {
    static void qm_hw_error_uninit_v2(struct hisi_qm *qm)
    {
    writel(QM_RAS_MASK_ALL, qm.io_base + QM_ABNORMAL_INT_MASK);
    }
#[no_mangle]
unsafe extern "C" fn qm_hw_error_init_v3(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_hw_error_uninit_v3(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_log_hw_error(qm: *mut hisi_qm, error_status: u32) {
...
#[no_mangle]
unsafe extern "C" fn qm_hw_error_handle_v2(qm: *mut hisi_qm) -> enum acc_err_result {
...
#[no_mangle]
unsafe extern "C" fn qm_clear_cmd_interrupt(qm: *mut hisi_qm, vf_mask: u64) {
...
#[no_mangle]
unsafe extern "C" fn qm_handle_vf_msg(qm: *mut hisi_qm, vf_id: u32) {
    static void qm_handle_vf_msg(struct hisi_qm *qm, u32 vf_id)
    {
    struct device *dev = &qm.pdev.dev;
    enum qm_ifc_cmd cmd;
    int ret;
    ret = qm.ops.get_ifc(qm, &cmd, core::ptr::null_mut(), vf_id);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn qm_wait_vf_prepare_finish(qm: *mut hisi_qm) -> c_int {
    static int qm_wait_vf_prepare_finish(struct hisi_qm *qm)
    {
    struct device *dev = &qm.pdev.dev;
    let mut vfs_num: u32 = qm.vfs_num;
    let mut cnt: c_int = 0;
    let mut ret: c_int = 0;
    u64 val;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn qm_trigger_vf_interrupt(qm: *mut hisi_qm, fun_num: u32) {
...
#[no_mangle]
unsafe extern "C" fn qm_trigger_pf_interrupt(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_ping_single_vf(qm: *mut hisi_qm, cmd: enum qm_ifc_cmd, data: u32, fun_num: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_ping_all_vfs(qm: *mut hisi_qm, cmd: enum qm_ifc_cmd, data: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_ping_pf(qm: *mut hisi_qm, cmd: enum qm_ifc_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_drain_qm(qm: *mut hisi_qm) -> c_int {
    static int qm_drain_qm(struct hisi_qm *qm)
    {
    return hisi_qm_mb(qm, QM_MB_CMD_FLUSH_QM, 0, 0, 0);
    }
#[no_mangle]
unsafe extern "C" fn qm_stop_qp(qp: *mut hisi_qp) -> c_int {
    static int qm_stop_qp(struct hisi_qp *qp)
    {
    return hisi_qm_mb(qp.qm, QM_MB_CMD_STOP_QP, 0, qp.qp_id, 0);
    }
#[no_mangle]
unsafe extern "C" fn qm_set_msi(qm: *mut hisi_qm, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_wait_msi_finish(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_set_msi_v3(qm: *mut hisi_qm, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_set_ifc_begin_v3(qm: *mut hisi_qm, cmd: enum qm_ifc_cmd, data: u32, fun_num: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_set_ifc_end_v3(qm: *mut hisi_qm) {
    static void qm_set_ifc_end_v3(struct hisi_qm *qm)
    {
    mutex_unlock(&qm.mailbox_lock);
    }
#[no_mangle]
unsafe extern "C" fn qm_get_ifc_v3(qm: *mut hisi_qm, cmd: *mut enum qm_ifc_cmd, data: *mut u32, fun_num: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_set_ifc_begin_v4(qm: *mut hisi_qm, cmd: enum qm_ifc_cmd, data: u32, fun_num: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_set_ifc_end_v4(qm: *mut hisi_qm) {
    static void qm_set_ifc_end_v4(struct hisi_qm *qm)
    {
    mutex_unlock(&qm.ifc_lock);
    }
#[no_mangle]
unsafe extern "C" fn qm_get_ifc_pf(qm: *mut hisi_qm, fun_num: u32) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn qm_get_ifc_vf(qm: *mut hisi_qm) -> u64 {
    static u64 qm_get_ifc_vf(struct hisi_qm *qm)
    {
    return readq(qm.io_base + QM_PF2VF_VF_R);
    }
#[no_mangle]
unsafe extern "C" fn qm_get_ifc_v4(qm: *mut hisi_qm, cmd: *mut enum qm_ifc_cmd, data: *mut u32, fun_num: u32) -> c_int {
...
// data = msg >> QM_IFC_DATA_SHIFT;
    ...
    {
    struct hisi_qp_status *qp_status = &qp.qp_status;
    let mut sq_tail: u16 = qp_status.sq_tail;
    if (unlikely(atomic_read(&qp.qp_status.used) == qp.sq_depth - 1))
    return core::ptr::null_mut();
    return qp.sqe + sq_tail * qp.qm.sqe_size;
    }
#[no_mangle]
unsafe extern "C" fn hisi_qm_unset_hw_reset(qp: *mut hisi_qp) {
...
// addr = 0;
    ...
    {
    struct device *dev = &qm.pdev.dev;
    struct hisi_qp *share_qp = core::ptr::null_mut();
    struct hisi_qp *qp;
...
// Try to find a shareable queue when all queues are busy
    ...
    qp_id = idr_alloc_cyclic(&qm.qp_idr, core::ptr::null_mut(), 0, qm.qp_num, GFP_ATOMIC);
    if (qp_id < 0) {
    ...
    qp.event_cb = core::ptr::null_mut();
    qp.req_cb = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn hisi_qm_release_qp(qp: *mut hisi_qp) {
...
#[no_mangle]
unsafe extern "C" fn qm_sq_ctx_cfg(qp: *mut hisi_qp, qp_id: c_int, pasid: u32) -> c_int {
    static int qm_sq_ctx_cfg(struct hisi_qp *qp, int qp_id, u32 pasid)
    {
    struct hisi_qm *qm = qp.qm;
    let mut ver: enum qm_hw_ver = qm.ver;
    let mut sqc: qm_sqc = {0};
    if (ver == QM_HW_V1) {
...
#[no_mangle]
unsafe extern "C" fn qm_cq_ctx_cfg(qp: *mut hisi_qp, qp_id: c_int, pasid: u32) -> c_int {
    static int qm_cq_ctx_cfg(struct hisi_qp *qp, int qp_id, u32 pasid)
    {
    struct hisi_qm *qm = qp.qm;
    let mut ver: enum qm_hw_ver = qm.ver;
    let mut cqc: qm_cqc = {0};
    if (ver == QM_HW_V1) {
...
#[no_mangle]
unsafe extern "C" fn qm_qp_ctx_cfg(qp: *mut hisi_qp, qp_id: c_int, pasid: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_start_qp_nolock(qp: *mut hisi_qp, arg: c_ulong) -> c_int {
    static int qm_start_qp_nolock(struct hisi_qp *qp, unsigned long arg)
    {
    struct hisi_qm *qm = qp.qm;
    struct device *dev = &qm.pdev.dev;
    let mut qp_id: c_int = qp.qp_id;
    let mut pasid: u32 = arg;
    int ret;
    if (atomic_read(&qm.status.flags) == QM_STOP) {
...
//
#[no_mangle]
unsafe extern "C" fn hisi_qm_start_qp(qp: *mut hisi_qp, arg: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qp_stop_fail_cb(qp: *mut hisi_qp) {
    static void qp_stop_fail_cb(struct hisi_qp *qp)
    {
    let mut qp_used: c_int = atomic_read(&qp.qp_status.used);
    let mut cur_tail: u16 = qp.qp_status.sq_tail;
    let mut sq_depth: u16 = qp.sq_depth;
    let mut cur_head: u16 = (cur_tail + sq_depth - qp_used) % sq_depth;
    struct hisi_qm *qm = qp.qm;
    u16 pos;
    int i;
    for (i = 0; i < qp_used; i++) {
...
#[no_mangle]
unsafe extern "C" fn qm_wait_qp_empty(qm: *mut hisi_qm, state: *mut u32, qp_id: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qm_drain_qp(qp: *mut hisi_qp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_stop_qp_nolock(qp: *mut hisi_qp) {
...
//
#[no_mangle]
unsafe extern "C" fn hisi_qm_stop_qp(qp: *mut hisi_qp) {
    static void hisi_qm_stop_qp(struct hisi_qp *qp)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qp_send(qp: *mut hisi_qp, msg: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_cache_wb(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_qp_event_notifier(qp: *mut hisi_qp) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_get_available_instances(uacce: *mut uacce_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_set_hw_reset(qm: *mut hisi_qm, offset: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_uacce_put_queue(q: *mut uacce_queue) {
...
// map sq/cq/doorbell to user space
    ...
    let mut sz: usize = vma.vm_end - vma.vm_start;
    struct pci_dev *pdev = qm.pdev;
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_uacce_start_queue(q: *mut uacce_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_uacce_stop_queue(q: *mut uacce_queue) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_is_q_updated(q: *mut uacce_queue) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_set_sqctype(q: *mut uacce_queue, type: u16) {
...
//
#[no_mangle]
unsafe extern "C" fn qm_hw_err_isolate(qm: *mut hisi_qm) -> c_int {
...
pub const SECONDS_PER_HOUR: c_int = 3600;
...
#[no_mangle]
unsafe extern "C" fn qm_hw_err_destroy(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_get_isolate_state(uacce: *mut uacce_device) -> enum uacce_dev_state {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_isolate_threshold_write(uacce: *mut uacce_device, num: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_isolate_threshold_read(uacce: *mut uacce_device) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qm_remove_uacce(qm: *mut hisi_qm) {
    ...
    mutex_unlock(&qm.isolate_data.isolate_lock);
    uacce_remove(uacce);
    qm.uacce = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn qm_uacce_api_ver_init(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_alloc_uacce(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !test_bit(QM_SUPPORT_DB_ISOLATION, _arg: &qm->caps)) -> else {
    else if (!test_bit(QM_SUPPORT_DB_ISOLATION, &qm.caps))
    mmio_page_nr = QM_DOORBELL_PAGE_NR +
    QM_DOORBELL_SQ_CQ_BASE_V2 / PAGE_SIZE;
    else
...
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_register_uacce(qm: *mut hisi_qm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qm_frozen(qm: *mut hisi_qm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_wait_task_finish(qm: *mut hisi_qm, qm_list: *mut hisi_qm_list) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qp_memory_uninit(qm: *mut hisi_qm, num: c_int) {
    ...
    {
    struct device *dev = &qm.pdev.dev;
    let mut off: usize = qm.sqe_size * sq_depth;
    struct hisi_qp *qp;
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_pre_init(qm: *mut hisi_qm) {
    ...
    qm.ops = &qm_hw_ops_v1;
#[no_mangle]
pub unsafe extern "C" fn if(QM_HW_V2: qm->ver ==) -> else {
    else if (qm.ver == QM_HW_V2)
    qm.ops = &qm_hw_ops_v2;
#[no_mangle]
pub unsafe extern "C" fn if(QM_HW_V3: qm->ver ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn qm_cmd_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_cmd_init(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_put_pci_res(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_mig_region_clear(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_mig_region_enable(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_pci_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_set_state(qm: *mut hisi_qm, state: u8) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_unint_work(qm: *mut hisi_qm) {
    static void hisi_qm_unint_work(struct hisi_qm *qm)
    {
    destroy_workqueue(qm.wq);
    }
#[no_mangle]
unsafe extern "C" fn hisi_qm_free_rsv_buf(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_memory_uninit(qm: *mut hisi_qm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_uninit(qm: *mut hisi_qm) {
...
//
#[no_mangle]
unsafe extern "C" fn hisi_qm_get_vft(qm: *mut hisi_qm, base: *mut u32, number: *mut u32) -> c_int {
...
//
    ...
    u32 number)
    {
    let mut max_q_num: u32 = qm.ctrl_qp_num;
...
#[no_mangle]
unsafe extern "C" fn qm_init_eq_aeq_status(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_enable_eq_aeq_interrupts(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_disable_eq_aeq_interrupts(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_eq_ctx_cfg(qm: *mut hisi_qm) -> c_int {
    static int qm_eq_ctx_cfg(struct hisi_qm *qm)
    {
    let mut eqc: qm_eqc = {0};
...
#[no_mangle]
unsafe extern "C" fn qm_aeq_ctx_cfg(qm: *mut hisi_qm) -> c_int {
    static int qm_aeq_ctx_cfg(struct hisi_qm *qm)
    {
    let mut aeqc: qm_aeqc = {0};
...
#[no_mangle]
unsafe extern "C" fn qm_eq_aeq_ctx_cfg(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __hisi_qm_start(qm: *mut hisi_qm) -> c_int {
    static int __hisi_qm_start(struct hisi_qm *qm)
    {
    struct device *dev = &qm.pdev.dev;
    int ret;
    if (!qm.qdma.va) {
    dev_err(dev, "qm qdma is core::ptr::null_mut()!\n");
    return -EINVAL;
    }
    if (qm.fun_type == QM_HW_PF) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_start(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_restart(qm: *mut hisi_qm) -> c_int {
    static int qm_restart(struct hisi_qm *qm)
    {
    struct device *dev = &qm.pdev.dev;
    struct hisi_qp *qp;
...
#[no_mangle]
unsafe extern "C" fn qm_stop_started_qp(qm: *mut hisi_qm) {
...
//
#[no_mangle]
unsafe extern "C" fn qm_invalid_queues(qm: *mut hisi_qm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_stop(qm: *mut hisi_qm, r: enum qm_stop_reason) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_hw_error_init(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_hw_error_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_hw_error_handle(qm: *mut hisi_qm) -> enum acc_err_result {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_dev_err_init(qm: *mut hisi_qm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_dev_err_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_release_qp_nolock(qp: *mut hisi_qp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_free_qps(qps: *mut hisi_qp, qp_num: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qm_insert_sorted(head: *mut list_head, res: *mut hisi_qm_resource) {
...
#[no_mangle]
unsafe extern "C" fn free_list(head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn qm_get_and_start_qp(qm: *mut hisi_qm, qp_num: c_int, qps: *mut hisi_qp, alg_type: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_vf_q_assign(qm: *mut hisi_qm, num_vfs: u32) -> c_int {
    static int qm_vf_q_assign(struct hisi_qm *qm, u32 num_vfs)
    {
    u32 remain_q_num, vfs_q_num, act_q_num, q_num, i, j;
    let mut max_qp_num: u32 = qm.max_qp_num;
    let mut q_base: u32 = qm.qp_num;
    int ret;
    if (!num_vfs)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn qm_clear_vft_config(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_func_shaper_enable(qm: *mut hisi_qm, fun_index: u32, qos: u32) -> c_int {
    static int qm_func_shaper_enable(struct hisi_qm *qm, u32 fun_index, u32 qos)
    {
    struct device *dev = &qm.pdev.dev;
    struct qm_shaper_factor t_factor;
    let mut ir: u32 = qos * QM_QOS_RATE;
    int ret, total_vfs, i;
...
#[no_mangle]
unsafe extern "C" fn qm_get_shaper_vft_qos(qm: *mut hisi_qm, fun_index: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn qm_vf_get_qos(qm: *mut hisi_qm, fun_num: u32) {
...
#[no_mangle]
unsafe extern "C" fn qm_vf_read_qos(qm: *mut hisi_qm) -> c_int {
...
// Mailbox and reset cannot be operated at the same time
    ...
    dev = bus_find_device_by_name(bus_type, core::ptr::null_mut(), tbuf_bdf);
    if (!dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_set_algqos_init(qm: *mut hisi_qm) {
    ...
    qm, &qm_algqos_fops);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(QM_SUPPORT_MB_COMMAND, _arg: &qm->caps)) -> else {
    else if (test_bit(QM_SUPPORT_MB_COMMAND, &qm.caps))
    debugfs_create_file("alg_qos", 0444, qm.debug.debug_root,
    qm, &qm_algqos_fops);
    }
#[no_mangle]
unsafe extern "C" fn hisi_qm_init_vf_qos(qm: *mut hisi_qm, total_func: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_sriov_enable(pdev: *mut pci_dev, max_vfs: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_sriov_disable(pdev: *mut pci_dev, is_frozen: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_sriov_configure(pdev: *mut pci_dev, num_vfs: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_dev_err_handle(qm: *mut hisi_qm) -> enum acc_err_result {
...
#[no_mangle]
unsafe extern "C" fn qm_process_dev_error(qm: *mut hisi_qm) -> enum acc_err_result {
...
#[no_mangle]
unsafe extern "C" fn qm_check_req_recv(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_set_pf_mse(qm: *mut hisi_qm, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_set_vf_mse(qm: *mut hisi_qm, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_dev_ecc_mbit_handle(qm: *mut hisi_qm) {
    static void qm_dev_ecc_mbit_handle(struct hisi_qm *qm)
    {
    let mut nfe_enb: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn qm_controller_reset_prepare(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_master_ooo_check(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_soft_reset_prepare(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_reset_device(qm: *mut hisi_qm) -> c_int {
    static int qm_reset_device(struct hisi_qm *qm)
    {
    struct pci_dev *pdev = qm.pdev;
...
#[no_mangle]
unsafe extern "C" fn qm_soft_reset(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_vf_reset_done(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_try_start_vfs(qm: *mut hisi_qm, cmd: enum qm_ifc_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_dev_hw_init(qm: *mut hisi_qm) -> c_int {
    static int qm_dev_hw_init(struct hisi_qm *qm)
    {
    return qm.err_ini.hw_init(qm);
    }
#[no_mangle]
unsafe extern "C" fn qm_restart_prepare(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_restart_done(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_disable_axi_error(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_enable_axi_error(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_controller_reset_done(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_controller_reset(qm: *mut hisi_qm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_dev_slot_reset(pdev: *mut pci_dev) -> pci_ers_result_t {
...
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_reset_prepare(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qm_flr_reset_complete(pdev: *mut pci_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_reset_done(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qm_rsvd_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qm_abnormal_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_dev_shutdown(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn qm_get_function_mask(qm: *mut hisi_qm) -> u64 {
    static u64 qm_get_function_mask(struct hisi_qm *qm)
    {
    return readq(qm.io_base + QM_FUNC_AXI_ERR_ST0);
    }
#[no_mangle]
unsafe extern "C" fn qm_clear_function_mask(qm: *mut hisi_qm, func_mask: u64) {
...
#[no_mangle]
unsafe extern "C" fn qm_function_reset(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_controller_reset(rst_work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(ACC_ERR_NEED_FUNC_RESET: err_result ==) -> else {
    ...
    enum qm_stop_reason stop_reason)
    {
    let mut cmd: enum qm_ifc_cmd = QM_VF_PREPARE_DONE;
    struct pci_dev *pdev = qm.pdev;
    int ret;
    ret = qm_reset_prepare_ready(qm);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn qm_pf_reset_vf_done(qm: *mut hisi_qm) {
    static void qm_pf_reset_vf_done(struct hisi_qm *qm)
    {
    let mut cmd: enum qm_ifc_cmd = QM_VF_START_DONE;
    struct pci_dev *pdev = qm.pdev;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn qm_vf_update_isolate_info(qm: *mut hisi_qm, data: u32) {
...
#[no_mangle]
unsafe extern "C" fn qm_wait_pf_reset_finish(qm: *mut hisi_qm, stop_reason: enum qm_stop_reason) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_vf_get_isolate_data(qm: *mut hisi_qm, fun_num: u32) {
    static void qm_vf_get_isolate_data(struct hisi_qm *qm, u32 fun_num)
    {
    let mut data: u32 = qm.isolate_data.err_threshold;
    struct device *dev = &qm.pdev.dev;
    int ret;
    if (qm.isolate_data.is_isolate)
    data |= QM_ISOLATED_STATE;
...
#[no_mangle]
unsafe extern "C" fn qm_handle_cmd_msg(qm: *mut hisi_qm, fun_num: u32) {
...
#[no_mangle]
unsafe extern "C" fn qm_cmd_process(cmd_process: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_alg_register(qm: *mut hisi_qm, qm_list: *mut hisi_qm_list, guard: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_alg_unregister(qm: *mut hisi_qm, qm_list: *mut hisi_qm_list, guard: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qm_unregister_abnormal_irq(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_register_abnormal_irq(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_unregister_mb_cmd_irq(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_register_mb_cmd_irq(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_unregister_aeq_irq(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_register_aeq_irq(qm: *mut hisi_qm) -> c_int {
    ...
    return 0;
    irq_vector = val & QM_IRQ_VECTOR_MASK;
    ret = request_threaded_irq(pci_irq_vector(pdev, irq_vector), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn qm_unregister_eq_irq(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_register_eq_irq(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_irqs_unregister(qm: *mut hisi_qm) {
    static void qm_irqs_unregister(struct hisi_qm *qm)
    {
...
#[no_mangle]
unsafe extern "C" fn qm_irqs_register(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_get_qp_num(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_pre_store_caps(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_get_hw_caps(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_get_version(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_get_pci_res(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_clear_device(qm: *mut hisi_qm) -> c_int {
    static int qm_clear_device(struct hisi_qm *qm)
    {
    let mut handle: acpi_handle = ACPI_HANDLE(&qm.pdev.dev);
    int ret;
    if (qm.fun_type == QM_HW_VF)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_pci_init(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_init_work(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_qp_alloc_memory(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_alloc_rsv_buf(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_qm_memory_init(qm: *mut hisi_qm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_init(qm: *mut hisi_qm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_get_dfx_access(qm: *mut hisi_qm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_put_dfx_access(qm: *mut hisi_qm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_pm_init(qm: *mut hisi_qm) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_pm_uninit(qm: *mut hisi_qm) {
...
#[no_mangle]
unsafe extern "C" fn qm_prepare_for_suspend(qm: *mut hisi_qm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qm_rebuild_for_resume(qm: *mut hisi_qm) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hisi_qm_resume(dev: *mut device) -> c_int {
