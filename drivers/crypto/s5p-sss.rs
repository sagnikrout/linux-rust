...
//! Source: drivers/crypto/s5p-sss.c
#![no_std]
...
pub const SSS_REG_FCINTSTAT: c_uint = 0x0000;

pub const SSS_REG_FCINTENSET: c_uint = 0x0004;

pub const SSS_REG_FCINTENCLR: c_uint = 0x0008;

pub const SSS_REG_FCINTPEND: c_uint = 0x000C;

pub const SSS_REG_FCFIFOSTAT: c_uint = 0x0010;

pub const SSS_REG_FCFIFOCTRL: c_uint = 0x0014;

pub const SSS_REG_FCBRDMAS: c_uint = 0x0020;
pub const SSS_REG_FCBRDMAL: c_uint = 0x0024;
pub const SSS_REG_FCBRDMAC: c_uint = 0x0028;

pub const SSS_REG_FCBTDMAS: c_uint = 0x0030;
pub const SSS_REG_FCBTDMAL: c_uint = 0x0034;
pub const SSS_REG_FCBTDMAC: c_uint = 0x0038;

pub const SSS_REG_FCHRDMAS: c_uint = 0x0040;
pub const SSS_REG_FCHRDMAL: c_uint = 0x0044;
pub const SSS_REG_FCHRDMAC: c_uint = 0x0048;

pub const SSS_REG_FCPKDMAS: c_uint = 0x0050;
pub const SSS_REG_FCPKDMAL: c_uint = 0x0054;
pub const SSS_REG_FCPKDMAC: c_uint = 0x0058;

pub const SSS_REG_FCPKDMAO: c_uint = 0x005C;
// AES registers
pub const SSS_REG_AES_CONTROL: c_uint = 0x00;

pub const SSS_REG_AES_STATUS: c_uint = 0x04;

    SSS_AES_REG(dev, reg))
// HW engine modes

pub const AES_KEY_LEN: c_int = 16;
pub const CRYPTO_QUEUE_LEN: c_int = 1;
// HASH registers
pub const SSS_REG_HASH_CTRL: c_uint = 0x00;

pub const SSS_REG_HASH_CTRL_PAUSE: c_uint = 0x04;

pub const SSS_REG_HASH_CTRL_FIFO: c_uint = 0x08;

pub const SSS_HASH_FIFO_MODE_CPU: c_int = 0;
pub const SSS_REG_HASH_CTRL_SWAP: c_uint = 0x0C;

pub const SSS_REG_HASH_STATUS: c_uint = 0x10;

pub const SSS_REG_HASH_MSG_SIZE_LOW: c_uint = 0x20;
pub const SSS_REG_HASH_MSG_SIZE_HIGH: c_uint = 0x24;
pub const SSS_REG_HASH_PRE_MSG_SIZE_LOW: c_uint = 0x28;
pub const SSS_REG_HASH_PRE_MSG_SIZE_HIGH: c_uint = 0x2C;

pub const HASH_BLOCK_SIZE: c_int = 64;
pub const HASH_REG_SIZEOF: c_int = 4;
...
//
pub const HASH_FLAGS_BUSY: c_int = 0;
pub const HASH_FLAGS_FINAL: c_int = 1;
pub const HASH_FLAGS_DMA_ACTIVE: c_int = 2;
pub const HASH_FLAGS_OUTPUT_READY: c_int = 3;
pub const HASH_FLAGS_DMA_READY: c_int = 4;
pub const HASH_FLAGS_SGS_COPIED: c_int = 5;
pub const HASH_FLAGS_SGS_ALLOCED: c_int = 6;
// HASH HW constants

pub const SSS_HASH_QUEUE_LENGTH: c_int = 10;
//
...
pub struct samsung_aes_variant {
    pub aes_offset: c_uint,
    pub hash_offset: c_uint,
    pub clk_names: [*const c_char; 2],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s5p_aes_reqctx {
    pub mode: c_ulong,
}
...
pub struct s5p_aes_ctx {
    ...
    pub aes_key: [u8; AES_MAX_KEY_SIZE],
...
pub struct s5p_aes_dev {
    ...
    pub aes_ioaddr: *mut void __iomem,
    pub irq_fc: c_int,
    pub req: *mut skcipher_request,
    pub ctx: *mut s5p_aes_ctx,
    pub sg_src: *mut scatterlist,
    pub sg_dst: *mut scatterlist,
    pub sg_src_cpy: *mut scatterlist,
    pub sg_dst_cpy: *mut scatterlist,
    pub tasklet: tasklet_struct,
    pub queue: crypto_queue,
    pub busy: bool,
    pub lock: spinlock_t,
    pub res: *mut resource,
    pub io_hash_base: *mut void __iomem,
    pub /: *mut *mut spinlock_t hash_lock; / protect hash_ vars,
    pub hash_flags: c_ulong,
    pub hash_queue: crypto_queue,
    pub hash_tasklet: tasklet_struct,
    pub xmit_buf: [u8; BUFLEN],
    pub hash_req: *mut ahash_request,
    pub hash_sg_iter: *mut scatterlist,
    pub hash_sg_cnt: c_uint,
    pub use_hash: bool,
}
...
pub struct s5p_hash_reqctx {
    ...
    pub /: *mut *mut unsigned int nregs; / digest_size / sizeof(reg),
    pub engine: u32,
    pub sg: *mut scatterlist,
    pub sg_len: c_uint,
    pub sgl: [scatterlist; 2],
    pub skip: c_uint,
    pub total: c_uint,
    pub finup: bool,
    pub error: bool,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s5p_hash_ctx {
    pub dd: *mut s5p_aes_dev,
    pub flags: c_ulong,
    pub fallback: *mut crypto_shash,
}
...
#[no_mangle]
unsafe extern "C" fn s5p_free_sg_cpy(dev: *mut s5p_aes_dev, sg: *mut scatterlist) {
...
#[no_mangle]
unsafe extern "C" fn s5p_sg_done(dev: *mut s5p_aes_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(FLAGS_AES_CTR: reqctx->mode &) -> else {
    else if (reqctx.mode & FLAGS_AES_CTR)
    memcpy_fromio(req.iv, dev.aes_ioaddr + SSS_REG_AES_CNT_DATA(0), AES_BLOCK_SIZE);
    }
// Calls the completion. Cannot be called with dev->lock hold.
#[no_mangle]
unsafe extern "C" fn s5p_aes_complete(req: *mut skcipher_request, err: c_int) {
    static void s5p_aes_complete(struct skcipher_request *req, int err)
    {
    skcipher_request_complete(req, err);
    }
#[no_mangle]
unsafe extern "C" fn s5p_unset_outdata(dev: *mut s5p_aes_dev) {
    static void s5p_unset_outdata(struct s5p_aes_dev *dev)
    {
    dma_unmap_sg(dev.dev, dev.sg_dst, 1, DMA_FROM_DEVICE);
    }
#[no_mangle]
unsafe extern "C" fn s5p_unset_indata(dev: *mut s5p_aes_dev) {
...
#[no_mangle]
unsafe extern "C" fn s5p_set_outdata(dev: *mut s5p_aes_dev, sg: *mut scatterlist) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5p_set_indata(dev: *mut s5p_aes_dev, sg: *mut scatterlist) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_aes_tx(dev: *mut s5p_aes_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_aes_rx(dev/*: *mut s5p_aes_dev, set_dma*/: *mut bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn s5p_hash_read(dd: *mut s5p_aes_dev, offset: u32) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_rx(dev: *mut s5p_aes_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5p_aes_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t s5p_aes_interrupt(int irq, void *dev_id)
    {
    struct platform_device *pdev = dev_id;
    struct s5p_aes_dev *dev = platform_get_drvdata(pdev);
    struct skcipher_request *req;
    let mut err_dma_tx: c_int = 0;
    let mut err_dma_rx: c_int = 0;
    let mut err_dma_hx: c_int = 0;
    let mut tx_end: bool = false;
    let mut hx_end: bool = false;
    unsigned long flags;
    u32 status, st_bits;
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn if(2: err_dma_hx ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_read_msg(req: *mut ahash_request) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_write_iv(req: *mut ahash_request) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_copy_result(req: *mut ahash_request) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_dma_flush(dev: *mut s5p_aes_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_dma_enable(dev: *mut s5p_aes_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_irq_disable(dev: *mut s5p_aes_dev, flags: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_irq_enable(dev: *mut s5p_aes_dev, flags: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_set_flow(dev: *mut s5p_aes_dev, hashflow: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_ahash_dma_init(dev: *mut s5p_aes_dev, hashflow: u32) {
...
//
    ...
    struct scatterlist *sg, unsigned int new_len)
    {
    let mut skip: c_uint = ctx.skip, n = sg_nents(sg);
...
//
    ...
    {
    let mut skip: c_uint = ctx.skip, nbytes = new_len, n = 0;
    let mut aligned: bool = true, list_ok = true;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !list_ok) -> else {
    else if (!list_ok)
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_prepare_request(req: *mut ahash_request, update: bool) -> c_int {
    static int s5p_hash_prepare_request(struct ahash_request *req, bool update)
    {
    struct s5p_hash_reqctx *ctx = ahash_request_ctx(req);
    let mut final: bool = ctx.finup;
...
// bytes left from previous request, so fill up to BUFLEN
    let mut len: c_int = BUFLEN - ctx.bufcnt % BUFLEN;
    if (len > nbytes)
    len = nbytes;
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_update_dma_stop(dd: *mut s5p_aes_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_finish(req: *mut ahash_request) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_finish_req(req: *mut ahash_request, err: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_enqueue(req: *mut ahash_request, op: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_update(req: *mut ahash_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_final(req: *mut ahash_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_finup(req: *mut ahash_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_init(req: *mut ahash_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_digest(req: *mut ahash_request) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_cra_init_alg(tfm: *mut crypto_tfm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_cra_exit(tfm: *mut crypto_tfm) {
    static void s5p_hash_cra_exit(struct crypto_tfm *tfm)
    {
    struct s5p_hash_ctx *tctx = crypto_tfm_ctx(tfm);
    crypto_free_shash(tctx.fallback);
    tctx.fallback = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn s5p_hash_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5p_is_sg_aligned(sg: *mut scatterlist) -> bool {
    ...
    struct scatterlist *sg;
    int err;
    dev.sg_src_cpy = core::ptr::null_mut();
    sg = req.src;
    ...
    struct scatterlist *sg;
    int err;
    dev.sg_dst_cpy = core::ptr::null_mut();
    sg = req.dst;
    if (!s5p_is_sg_aligned(sg)) {
    dev_dbg(dev.dev,
...
#[no_mangle]
unsafe extern "C" fn s5p_aes_crypt_start(dev: *mut s5p_aes_dev, mode: c_ulong) {
...
// This sets bit [13:12] to 00, which selects 128-bit counter
    ...
    iv = req.iv;
    ctr = core::ptr::null_mut();
    } else if ((mode & FLAGS_AES_MODE_MASK) == FLAGS_AES_CTR) {
    aes_control |= SSS_AES_CHAIN_MODE_CTR;
    iv = core::ptr::null_mut();
    ctr = req.iv;
    } else {
    iv = core::ptr::null_mut(); /* AES_ECB */
    ctr = core::ptr::null_mut();
    }
    if (dev.ctx.keylen == AES_KEYSIZE_192)
    aes_control |= SSS_AES_KEY_SIZE_192;
#[no_mangle]
pub unsafe extern "C" fn if(AES_KEYSIZE_256: dev->ctx->keylen ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn s5p_tasklet_cb(data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn s5p_aes_crypt(req: *mut skcipher_request, mode: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5p_aes_ecb_encrypt(req: *mut skcipher_request) -> c_int {
    static int s5p_aes_ecb_encrypt(struct skcipher_request *req)
    {
    return s5p_aes_crypt(req, 0);
    }
#[no_mangle]
unsafe extern "C" fn s5p_aes_ecb_decrypt(req: *mut skcipher_request) -> c_int {
    static int s5p_aes_ecb_decrypt(struct skcipher_request *req)
    {
    return s5p_aes_crypt(req, FLAGS_AES_DECRYPT);
    }
#[no_mangle]
unsafe extern "C" fn s5p_aes_cbc_encrypt(req: *mut skcipher_request) -> c_int {
    static int s5p_aes_cbc_encrypt(struct skcipher_request *req)
    {
    return s5p_aes_crypt(req, FLAGS_AES_CBC);
    }
#[no_mangle]
unsafe extern "C" fn s5p_aes_cbc_decrypt(req: *mut skcipher_request) -> c_int {
    static int s5p_aes_cbc_decrypt(struct skcipher_request *req)
    {
    return s5p_aes_crypt(req, FLAGS_AES_DECRYPT | FLAGS_AES_CBC);
    }
#[no_mangle]
unsafe extern "C" fn s5p_aes_ctr_crypt(req: *mut skcipher_request) -> c_int {
    static int s5p_aes_ctr_crypt(struct skcipher_request *req)
    {
    return s5p_aes_crypt(req, FLAGS_AES_CTR);
    }
#[no_mangle]
unsafe extern "C" fn s5p_aes_init_tfm(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s5p_aes_probe(pdev: *mut platform_device) -> c_int {
...
// try AES without HASH
    ...
    err = devm_request_threaded_irq(dev, pdata.irq_fc, core::ptr::null_mut(),
    ...
    s5p_dev = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn s5p_aes_remove(pdev: *mut platform_device) {
