...
//! Source: drivers/crypto/omap-sham.c
#![no_std]
...
pub const SHA_REG_CTRL: c_uint = 0x18;

pub const SHA_REG_IRQSTATUS: c_uint = 0x118;

pub const SHA_REG_IRQENA: c_uint = 0x11C;

pub const DEFAULT_AUTOSUSPEND_DELAY: c_int = 1000;
// mostly device flags
pub const FLAGS_FINAL: c_int = 1;
pub const FLAGS_DMA_ACTIVE: c_int = 2;
pub const FLAGS_OUTPUT_READY: c_int = 3;
pub const FLAGS_CPU: c_int = 5;
pub const FLAGS_DMA_READY: c_int = 6;
pub const FLAGS_AUTO_XOR: c_int = 7;
pub const FLAGS_BE32_SHA1: c_int = 8;
pub const FLAGS_SGS_COPIED: c_int = 9;
pub const FLAGS_SGS_ALLOCED: c_int = 10;
pub const FLAGS_HUGE: c_int = 11;
// context flags
pub const FLAGS_FINUP: c_int = 16;
pub const FLAGS_MODE_SHIFT: c_int = 18;

pub const FLAGS_HMAC: c_int = 21;
pub const FLAGS_ERROR: c_int = 22;
pub const OP_UPDATE: c_int = 1;
pub const OP_FINAL: c_int = 2;

pub const OMAP_SHA_DMA_THRESHOLD: c_int = 256;

    struct omap_sham_dev;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_sham_reqctx {
    pub dd: *mut omap_sham_dev,
    pub flags: c_ulong,
    pub op: u8,
    pub OMAP_ALIGNED: u8 digest[SHA512_DIGEST_SIZE],
    pub digcnt: usize,
    pub bufcnt: usize,
// walk state
    pub sg: *mut scatterlist,
    pub sgl: [scatterlist; 2],
    pub /: *mut *mut int offset; / offset in current sg,
    pub sg_len: c_int,
    pub /: *mut *mut unsigned int total; / total request,
    pub OMAP_ALIGNED: u8 buffer[BUFLEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_sham_hmac_ctx {
    pub shash: *mut crypto_shash,
    pub OMAP_ALIGNED: u8 ipad[SHA512_BLOCK_SIZE],
    pub OMAP_ALIGNED: u8 opad[SHA512_BLOCK_SIZE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_sham_ctx {
    pub flags: c_ulong,
// fallback stuff
    pub fallback: *mut crypto_shash,
    pub base: [omap_sham_hmac_ctx; ],
}

pub const OMAP_SHAM_QUEUE_LENGTH: c_int = 10;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_sham_algs_info {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct omap_sham_pdata {
    pub algs_info: *mut omap_sham_algs_info,
    pub algs_info_size: c_uint,
    pub flags: c_ulong,
    pub digest_size: c_int,
    pub out): *mut *mut *mut void (copy_hash)(struct ahash_request req, int,
    void		(*write_ctrl)(struct omap_sham_dev *dd, size_t length,
    pub dma): int final, int,
    pub length): *mut *mut *mut void (trigger)(struct omap_sham_dev dd, size_t,
    pub dd): *mut *mut int (poll_irq)(struct omap_sham_dev,
    pub dev_id): *mut *mut irqreturn_t (intr_hdlr)(int irq, void,
    pub odigest_ofs: u32,
    pub idigest_ofs: u32,
    pub din_ofs: u32,
    pub digcnt_ofs: u32,
...
pub struct omap_sham_dev {
    ...
    pub polling_mode: u8,
    pub OMAP_ALIGNED: u8 xmit_buf[BUFLEN],
    pub flags: c_ulong,
    pub fallback_sz: c_int,
...
#[no_mangle]
pub unsafe extern "C" fn omap_sham_read(dd: *mut omap_sham_dev, offset: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn omap_sham_wait(dd: *mut omap_sham_dev, offset: u32, bit: u32) -> c_int {
    static inline int omap_sham_wait(struct omap_sham_dev *dd, u32 offset, u32 bit)
    {
    let mut timeout: c_ulong = jiffies + DEFAULT_TIMEOUT_INTERVAL;
...
#[no_mangle]
unsafe extern "C" fn omap_sham_copy_hash_omap2(req: *mut ahash_request, out: c_int) {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_copy_hash_omap4(req: *mut ahash_request, out: c_int) {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_copy_ready_hash(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_trigger_omap2(dd: *mut omap_sham_dev, length: usize) {
    static void omap_sham_trigger_omap2(struct omap_sham_dev *dd, size_t length)
    {
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_poll_irq_omap2(dd: *mut omap_sham_dev) -> c_int {
    static int omap_sham_poll_irq_omap2(struct omap_sham_dev *dd)
    {
    return omap_sham_wait(dd, SHA_REG_CTRL, SHA_REG_CTRL_INPUT_READY);
    }
#[no_mangle]
unsafe extern "C" fn get_block_size(ctx: *mut omap_sham_reqctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_trigger_omap4(dd: *mut omap_sham_dev, length: usize) {
    static void omap_sham_trigger_omap4(struct omap_sham_dev *dd, size_t length)
    {
    omap_sham_write(dd, SHA_REG_LENGTH(dd), length);
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_poll_irq_omap4(dd: *mut omap_sham_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_dma_callback(param: *mut c_void) {
    ...
    {
    let mut n: c_int = sg_nents(sg);
    struct scatterlist *tmp;
    let mut offset: c_int = ctx.offset;
    ctx.total = new_len;
    if (ctx.bufcnt)
    n++;
    ...
    while (sg && new_len) {
    let mut len: c_int = sg.length - offset;
    if (len <= 0) {
    offset -= sg.length;
    sg = sg_next(sg);
    continue;
    ...
    let mut list_ok: bool = true;
    struct scatterlist *sg_tmp = sg;
    int new_len;
    let mut offset: c_int = rctx.offset;
    let mut bufcnt: c_int = rctx.bufcnt;
...
#[no_mangle]
unsafe extern "C" fn omap_sham_prepare_request(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
    ...
    int ret;
    unsigned int nbytes;
    let mut final: bool = rctx.flags & BIT(FLAGS_FINUP);
    let mut update: bool = rctx.op == OP_UPDATE;
    int hash_later;
    ...
    let mut len: c_int = bs - rctx.bufcnt % bs;
    if (len > req.nbytes)
    len = req.nbytes;
...
#[no_mangle]
unsafe extern "C" fn omap_sham_update_dma_stop(dd: *mut omap_sham_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_update_req(dd: *mut omap_sham_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_final_req(dd: *mut omap_sham_dev) -> c_int {
    static int omap_sham_final_req(struct omap_sham_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct omap_sham_reqctx *ctx = ahash_request_ctx(req);
    let mut err: c_int = 0, use_dma = 1;
...
#[no_mangle]
unsafe extern "C" fn omap_sham_hash_one_req(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(OP_FINAL: ctx->op ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_finish_hmac(req: *mut ahash_request) -> c_int {
    static int omap_sham_finish_hmac(struct ahash_request *req)
    {
    struct omap_sham_ctx *tctx = crypto_tfm_ctx(req.base.tfm);
    struct omap_sham_hmac_ctx *bctx = tctx.base;
    let mut bs: c_int = crypto_shash_blocksize(bctx.shash);
    let mut ds: c_int = crypto_shash_digestsize(bctx.shash);
...
#[no_mangle]
unsafe extern "C" fn omap_sham_finish(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_finish_req(req: *mut ahash_request, err: c_int) {
    static void omap_sham_finish_req(struct ahash_request *req, int err)
    {
    struct omap_sham_reqctx *ctx = ahash_request_ctx(req);
    struct omap_sham_dev *dd = ctx.dd;
...
#[no_mangle]
unsafe extern "C" fn omap_sham_enqueue(req: *mut ahash_request, op: c_uint) -> c_int {
    static int omap_sham_enqueue(struct ahash_request *req, unsigned int op)
    {
    struct omap_sham_reqctx *ctx = ahash_request_ctx(req);
    struct omap_sham_dev *dd = ctx.dd;
...
#[no_mangle]
unsafe extern "C" fn omap_sham_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_final_shash(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ctx->bufcnt) -> else {
    else if (ctx.bufcnt)
...
#[no_mangle]
unsafe extern "C" fn omap_sham_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_init_alg(tfm: *mut crypto_tfm, alg_base: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_init(tfm: *mut crypto_tfm) -> c_int {
    static int omap_sham_cra_init(struct crypto_tfm *tfm)
    {
    return omap_sham_cra_init_alg(tfm, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_sha1_init(tfm: *mut crypto_tfm) -> c_int {
    static int omap_sham_cra_sha1_init(struct crypto_tfm *tfm)
    {
    return omap_sham_cra_init_alg(tfm, "sha1");
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_sha224_init(tfm: *mut crypto_tfm) -> c_int {
    static int omap_sham_cra_sha224_init(struct crypto_tfm *tfm)
    {
    return omap_sham_cra_init_alg(tfm, "sha224");
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_sha256_init(tfm: *mut crypto_tfm) -> c_int {
    static int omap_sham_cra_sha256_init(struct crypto_tfm *tfm)
    {
    return omap_sham_cra_init_alg(tfm, "sha256");
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_md5_init(tfm: *mut crypto_tfm) -> c_int {
    static int omap_sham_cra_md5_init(struct crypto_tfm *tfm)
    {
    return omap_sham_cra_init_alg(tfm, "md5");
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_sha384_init(tfm: *mut crypto_tfm) -> c_int {
    static int omap_sham_cra_sha384_init(struct crypto_tfm *tfm)
    {
    return omap_sham_cra_init_alg(tfm, "sha384");
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_sha512_init(tfm: *mut crypto_tfm) -> c_int {
    static int omap_sham_cra_sha512_init(struct crypto_tfm *tfm)
    {
    return omap_sham_cra_init_alg(tfm, "sha512");
    }
#[no_mangle]
unsafe extern "C" fn omap_sham_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_done_task(t: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_irq_common(dd: *mut omap_sham_dev) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_irq_omap2(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_irq_omap4(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_unregister_algs(pdata: *const omap_sham_pdata) {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_sham_remove(pdev: *mut platform_device) {
