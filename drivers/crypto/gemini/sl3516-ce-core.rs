...
//! Source: drivers/crypto/gemini/sl3516-ce-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_desc_init(ce: *mut sl3516_ce_dev) -> c_int {
    static int sl3516_ce_desc_init(struct sl3516_ce_dev *ce)
    {
    let mut sz: usize = sizeof(struct descriptor) * MAXDESC;
    int i;
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_free_descs(ce: *mut sl3516_ce_dev) {
...
#[no_mangle]
unsafe extern "C" fn start_dma_tx(ce: *mut sl3516_ce_dev) {
...
#[no_mangle]
unsafe extern "C" fn start_dma_rx(ce: *mut sl3516_ce_dev) {
    ...
    const char *name)
    {
    struct descriptor *dd, *rdd = core::ptr::null_mut();
    u32 v;
    int i, err = 0;
    ce.stat_req++;
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_debugfs_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_register_algs(ce: *mut sl3516_ce_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_unregister_algs(ce: *mut sl3516_ce_dev) {
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_start(ce: *mut sl3516_ce_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn sl3516_ce_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_pm_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(sl3516_ce_pm_suspend, sl3516_ce_pm_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn sl3516_ce_pm_init(ce: *mut sl3516_ce_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_pm_exit(ce: *mut sl3516_ce_dev) {
    static void sl3516_ce_pm_exit(struct sl3516_ce_dev *ce)
    {
    pm_runtime_disable(ce.dev);
    }
#[no_mangle]
unsafe extern "C" fn sl3516_ce_probe(pdev: *mut platform_device) -> c_int {
    ...
    ce.clks = devm_clk_get(ce.dev, core::ptr::null_mut());
    if (IS_ERR(ce.clks)) {
    err = PTR_ERR(ce.clks);
...
// Ignore error of debugfs
    dbgfs_dir = debugfs_create_dir("sl3516", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sl3516_ce_remove(pdev: *mut platform_device) {
