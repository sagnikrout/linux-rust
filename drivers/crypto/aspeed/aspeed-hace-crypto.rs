...
//! Source: drivers/crypto/aspeed/aspeed-hace-crypto.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aspeed_crypto_do_fallback(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_crypto_need_fallback(areq: *mut skcipher_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn aspeed_crypto_do_request(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sk_complete(hace_dev: *mut aspeed_hace_dev, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sk_transfer_sg(hace_dev: *mut aspeed_hace_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sk_transfer(hace_dev: *mut aspeed_hace_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sk_start(hace_dev: *mut aspeed_hace_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sk_start_sg(hace_dev: *mut aspeed_hace_dev) -> c_int {
...
// BIDIRECTIONAL
    ...
    let mut phy_addr: u32 = sg_dma_address(s);
    let mut len: u32 = sg_dma_len(s);
    if (total > len)
    total -= len;
    else {
// last sg list
...
#[no_mangle]
unsafe extern "C" fn aspeed_hace_skcipher_trigger(hace_dev: *mut aspeed_hace_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_des_crypt(req: *mut skcipher_request, cmd: u32) -> c_int {
    ...
    struct aspeed_cipher_ctx *ctx = crypto_skcipher_ctx(cipher);
    struct aspeed_hace_dev *hace_dev = ctx.hace_dev;
    let mut crypto_alg: u32 = cmd & HACE_CMD_OP_MODE_MASK;
    CIPHER_DBG(hace_dev, "\n");
...
#[no_mangle]
unsafe extern "C" fn aspeed_tdes_ctr_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_tdes_ctr_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_tdes_cbc_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_tdes_cbc_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_tdes_ecb_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_tdes_ecb_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_des_ctr_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_des_ctr_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_des_cbc_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_des_cbc_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_des_ecb_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_des_ecb_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_aes_crypt(req: *mut skcipher_request, cmd: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_crypto_cra_exit(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
pub unsafe extern "C" fn aspeed_unregister_hace_crypto_algs(hace_dev: *mut aspeed_hace_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn aspeed_register_hace_crypto_algs(hace_dev: *mut aspeed_hace_dev) {
