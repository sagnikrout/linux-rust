...
//! Source: drivers/crypto/aspeed/aspeed-hace-hash.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn aspeed_sham_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sham_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn aspeed_ahash_dma_prepare(hace_dev: *mut aspeed_hace_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(SHA_FLAGS_FINUP: rctx->flags &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn aspeed_ahash_dma_prepare_sg(hace_dev: *mut aspeed_hace_dev) -> c_int {
    static int aspeed_ahash_dma_prepare_sg(struct aspeed_hace_dev *hace_dev)
    {
    struct aspeed_engine_hash *hash_engine = &hace_dev.hash_engine;
    struct ahash_request *req = hash_engine.req;
    struct aspeed_sham_reqctx *rctx = ahash_request_ctx(req);
    let mut final: bool = rctx.flags & SHA_FLAGS_FINUP;
...
#[no_mangle]
unsafe extern "C" fn aspeed_ahash_complete(hace_dev: *mut aspeed_hace_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_ahash_update_resume_sg(hace_dev: *mut aspeed_hace_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_ahash_req_update(hace_dev: *mut aspeed_hace_dev) -> c_int {
    static int aspeed_ahash_req_update(struct aspeed_hace_dev *hace_dev)
    {
    struct aspeed_engine_hash *hash_engine = &hace_dev.hash_engine;
    struct ahash_request *req = hash_engine.req;
...
#[no_mangle]
unsafe extern "C" fn aspeed_ahash_fallback(req: *mut ahash_request) -> noinline int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_ahash_do_request(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_ahash_do_one(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sham_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sham_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn aspeed_sham_init(req: *mut ahash_request) -> c_int {
    static int aspeed_sham_init(struct ahash_request *req)
    {
    struct aspeed_sham_reqctx *rctx = ahash_request_ctx(req);
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(req);
...
#[no_mangle]
unsafe extern "C" fn aspeed_sham_digest(req: *mut ahash_request) -> c_int {
    static int aspeed_sham_digest(struct ahash_request *req)
    {
    return aspeed_sham_init(req) ? : aspeed_sham_finup(req);
    }
#[no_mangle]
unsafe extern "C" fn aspeed_sham_cra_init(tfm: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn aspeed_unregister_hace_hash_algs(hace_dev: *mut aspeed_hace_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn aspeed_register_hace_hash_algs(hace_dev: *mut aspeed_hace_dev) {
