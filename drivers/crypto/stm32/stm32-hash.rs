...
//! Source: drivers/crypto/stm32/stm32-hash.c
#![no_std]
...
pub const HASH_CR: c_uint = 0x00;
pub const HASH_DIN: c_uint = 0x04;
pub const HASH_STR: c_uint = 0x08;

pub const HASH_IMR: c_uint = 0x20;
pub const HASH_SR: c_uint = 0x24;

pub const HASH_HWCFGR: c_uint = 0x3F0;
pub const HASH_VER: c_uint = 0x3F4;
pub const HASH_ID: c_uint = 0x3F8;
// Control Register

pub const HASH_CR_DATATYPE_POS: c_int = 4;

pub const HASH_CR_ALGO_POS: c_int = 7;
...
pub const HASH_CSR_NB_SHA256_HMAC: c_int = 54;
pub const HASH_CSR_NB_SHA256: c_int = 38;
pub const HASH_CSR_NB_SHA512_HMAC: c_int = 103;
pub const HASH_CSR_NB_SHA512: c_int = 91;
pub const HASH_CSR_NB_SHA3_HMAC: c_int = 88;
pub const HASH_CSR_NB_SHA3: c_int = 72;

pub const HASH_FLAGS_ALGO_SHIFT: c_int = 17;

pub const HASH_OP_UPDATE: c_int = 1;
pub const HASH_OP_FINAL: c_int = 2;
pub const HASH_BURST_LEVEL: c_int = 4;
...
pub const HASH_AUTOSUSPEND_DELAY: c_int = 50;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_hash_ctx {
    pub hdev: *mut stm32_hash_dev,
    pub xtfm: *mut crypto_shash,
    pub flags: c_ulong,
    pub key: [u8; HASH_MAX_KEY_SIZE],
    pub keylen: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_hash_state {
    pub flags: u32,
    pub bufcnt: u16,
    pub blocklen: u16,
    pub __aligned(sizeof(u32)): u8 buffer[HASH_BUFLEN],
// hash state
    pub HASH_CSR_NB_MAX]: u32 hw_context[3 +,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_hash_request_ctx {
    pub hdev: *mut stm32_hash_dev,
    pub op: c_ulong,
    pub __aligned(sizeof(u32)): u8 digest[SHA512_DIGEST_SIZE],
    pub digcnt: usize,
    pub sg: *mut scatterlist,
    pub /: *mut *mut scatterlist sgl[2]; / scatterlist used to realize alignment,
    pub offset: c_uint,
    pub total: c_uint,
    pub sg_key: scatterlist,
    pub dma_addr: dma_addr_t,
    pub dma_ct: usize,
    pub nents: c_int,
    pub data_type: u8,
    pub state: stm32_hash_state,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_hash_algs_info {
    pub algs_list: *mut ahash_engine_alg,
    pub size: usize,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_hash_pdata {
    pub alg_shift: c_int,
    pub algs_info: *const stm32_hash_algs_info,
    pub algs_info_size: usize,
    pub has_sr: bool,
    pub has_mdmat: bool,
    pub context_secured: bool,
    pub broken_emptymsg: bool,
    pub ux500: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_hash_dev {
    pub list: list_head,
    pub dev: *mut device,
    pub clk: *mut clk,
    ...
    pub __aligned(sizeof(u32)): u8 xmit_buf[HASH_BUFLEN],
    pub dma_mode: u32,
    pub polled: bool,
    ...
    pub pdata: *const stm32_hash_pdata,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct stm32_hash_drv {
    pub dev_list: list_head,
    pub /: *mut *mut spinlock_t lock; / List protection access,
}
...
#[no_mangle]
pub unsafe extern "C" fn stm32_hash_read(hdev: *mut stm32_hash_dev, offset: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn stm32_hash_wait_busy(hdev: *mut stm32_hash_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn stm32_hash_set_nblw(hdev: *mut stm32_hash_dev, length: c_int) {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_write_key(hdev: *mut stm32_hash_dev) -> c_int {
    static int stm32_hash_write_key(struct stm32_hash_dev *hdev)
    {
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(hdev.req);
    struct stm32_hash_ctx *ctx = crypto_ahash_ctx(tfm);
    u32 reg;
    let mut keylen: c_int = ctx.keylen;
    void *key = ctx.key;
    if (keylen) {
...
//
#[no_mangle]
unsafe extern "C" fn stm32_hash_write_ctrl(hdev: *mut stm32_hash_dev) {
    ...
    let mut alg: u32 = (state.flags & HASH_FLAGS_ALGO_MASK) >> HASH_FLAGS_ALGO_SHIFT;
    let mut reg: u32 = HASH_CR_INIT;
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_append_sg(rctx: *mut stm32_hash_request_ctx) {
...
#[no_mangle]
unsafe extern "C" fn hash_swap_reg(rctx: *mut stm32_hash_request_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_update_cpu(hdev: *mut stm32_hash_dev) -> c_int {
...
// do not use dma if there is no data to send
    ...
    core::ptr::null_mut(), core::ptr::null_mut()) != DMA_COMPLETE)
    err = -ETIMEDOUT;
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_dma_callback(param: *mut c_void) {
    static void stm32_hash_dma_callback(void *param)
    {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_hmac_dma_send(hdev: *mut stm32_hash_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_dma_init(hdev: *mut stm32_hash_dev) -> c_int {
    ...
    hdev.dma_lch = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_dma_send(hdev: *mut stm32_hash_dev) -> c_int {
    static int stm32_hash_dma_send(struct stm32_hash_dev *hdev)
    {
    struct stm32_hash_request_ctx *rctx = ahash_request_ctx(hdev.req);
    u32 *buffer = (void *)rctx.state.buffer;
    struct scatterlist sg[1], *tsg;
    let mut err: c_int = 0, reg, ncp = 0;
    unsigned int i, len = 0, bufcnt = 0;
    let mut final: bool = hdev.flags & HASH_FLAGS_FINAL;
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_init(req: *mut ahash_request) -> c_int {
    ...
    struct stm32_hash_state *state = &rctx.state;
    let mut sha3_mode: bool = ctx.flags & HASH_FLAGS_SHA3_MODE;
    rctx.hdev = hdev;
    state.flags = 0;
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_update_req(hdev: *mut stm32_hash_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_final_req(hdev: *mut stm32_hash_dev) -> c_int {
    static int stm32_hash_final_req(struct stm32_hash_dev *hdev)
    {
    struct ahash_request *req = hdev.req;
    struct stm32_hash_request_ctx *rctx = ahash_request_ctx(req);
    struct stm32_hash_state *state = &rctx.state;
    let mut buflen: c_int = state.bufcnt;
    if (!(state.flags & HASH_FLAGS_CPU)) {
    hdev.flags |= HASH_FLAGS_FINAL;
    return stm32_hash_dma_send(hdev);
    }
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_emptymsg_fallback(req: *mut ahash_request) {
    ...
    ret = crypto_shash_tfm_digest(ctx.xtfm, core::ptr::null_mut(), 0, rctx.digest);
    if (ret)
    dev_err(hdev.dev, "shash digest error\n");
    }
#[no_mangle]
unsafe extern "C" fn stm32_hash_copy_hash(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_finish(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_finish_req(req: *mut ahash_request, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_one_request(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(HASH_OP_FINAL: rctx->op ==) -> else {
...
// done task will not finish it, so do it here
    ...
    let mut offset: c_int = rctx.offset;
    int new_len;
    let mut n: c_int = 0;
    let mut bufcnt: c_int = state.bufcnt;
    let mut secure_ctx: bool = hdev.pdata.context_secured;
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_prepare_request(req: *mut ahash_request) -> c_int {
    static int stm32_hash_prepare_request(struct ahash_request *req)
    {
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(req);
    struct stm32_hash_ctx *ctx = crypto_ahash_ctx(tfm);
    ...
    let mut update: bool = rctx.op & HASH_OP_UPDATE;
    let mut init: bool = !(state.flags & HASH_FLAGS_INIT);
    let mut finup: bool = state.flags & HASH_FLAGS_FINUP;
    let mut final: bool = state.flags & HASH_FLAGS_FINAL;
...
//
    ...
    let mut len: c_int = bs - state.bufcnt % bs;
    if (len > req.nbytes)
    len = req.nbytes;
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_unprepare_request(req: *mut ahash_request) {
    static void stm32_hash_unprepare_request(struct ahash_request *req)
    {
    struct stm32_hash_request_ctx *rctx = ahash_request_ctx(req);
    struct stm32_hash_state *state = &rctx.state;
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_enqueue(req: *mut ahash_request, op: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_digest(req: *mut ahash_request) -> c_int {
    static int stm32_hash_digest(struct ahash_request *req)
    {
    return stm32_hash_init(req) ?: stm32_hash_finup(req);
    }
#[no_mangle]
unsafe extern "C" fn stm32_hash_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_init_fallback(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_cra_init_algs(tfm: *mut crypto_tfm, algs_flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_cra_init(tfm: *mut crypto_tfm) -> c_int {
    static int stm32_hash_cra_init(struct crypto_tfm *tfm)
    {
    return stm32_hash_cra_init_algs(tfm, 0);
    }
#[no_mangle]
unsafe extern "C" fn stm32_hash_cra_hmac_init(tfm: *mut crypto_tfm) -> c_int {
    static int stm32_hash_cra_hmac_init(struct crypto_tfm *tfm)
    {
    return stm32_hash_cra_init_algs(tfm, HASH_FLAGS_HMAC);
    }
#[no_mangle]
unsafe extern "C" fn stm32_hash_cra_sha3_init(tfm: *mut crypto_tfm) -> c_int {
    static int stm32_hash_cra_sha3_init(struct crypto_tfm *tfm)
    {
    return stm32_hash_cra_init_algs(tfm, HASH_FLAGS_SHA3_MODE);
    }
#[no_mangle]
unsafe extern "C" fn stm32_hash_cra_sha3_hmac_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_register_algs(hdev: *mut stm32_hash_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_unregister_algs(hdev: *mut stm32_hash_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_probe(pdev: *mut platform_device) -> c_int {
    ...
    hdev.clk = devm_clk_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(hdev.clk))
    ...
    hdev.rst = devm_reset_control_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(hdev.rst)) {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stm32_hash_runtime_resume(dev: *mut device) -> c_int {
    ...
    stm32_hash_runtime_resume, core::ptr::null_mut())
    };
