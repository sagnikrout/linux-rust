...
//! Source: drivers/crypto/allwinner/sun8i-ce/sun8i-ce-cipher.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_cipher_need_fallback(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_cipher_fallback(areq: *mut skcipher_request) -> c_int {
    ...
    let mut err: c_int = 0;
    let mut ns: c_int = sg_nents_for_len(areq.src, areq.cryptlen);
    let mut nd: c_int = sg_nents_for_len(areq.dst, areq.cryptlen);
    algt = container_of(alg, struct sun8i_ce_alg_template, alg.skcipher.base);
...
// CTS and recent CE (H6) need length in bytes, in word otherwise
    ...
    let mut nr_sgs: c_int = rctx.nr_sgs;
    let mut nr_sgd: c_int = rctx.nr_sgd;
    ivsize = crypto_skcipher_ivsize(tfm);
    if (areq.src == areq.dst) {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_cipher_do_one(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_skdecrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_skencrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_cipher_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_cipher_exit(tfm: *mut crypto_tfm) {
