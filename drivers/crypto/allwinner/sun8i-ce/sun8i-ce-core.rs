...
//! Source: drivers/crypto/allwinner/sun8i-ce/sun8i-ce-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_dump_task_descriptors(chan: *mut sun8i_ce_flow) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_get_engine_number(ce: *mut sun8i_ce_dev) -> c_int {
    int sun8i_ce_get_engine_number(struct sun8i_ce_dev *ce)
    {
    return atomic_inc_return(&ce.flow) % (MAXFLOW - 1);
    }
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_run_task(ce: *mut sun8i_ce_dev, flow: c_int, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ce_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_debugfs_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int sun8i_ce_debugfs_show(struct seq_file *seq, void *v)
    {
    let mut __maybe_unused: *mut sun8i_ce_dev ce = seq.private;
    unsigned int i;
    for (i = 0; i < MAXFLOW; i++)
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_free_chanlist(ce: *mut sun8i_ce_dev, i: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn sun8i_ce_allocate_chanlist(ce: *mut sun8i_ce_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sun8i_ce_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_pm_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(sun8i_ce_pm_suspend, sun8i_ce_pm_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn sun8i_ce_pm_init(ce: *mut sun8i_ce_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_get_clks(ce: *mut sun8i_ce_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_register_algs(ce: *mut sun8i_ce_dev) -> c_int {
    ...
    ce_algs[i].alg.skcipher.base.base.cra_name);
    ce_algs[i].ce = core::ptr::null_mut();
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_unregister_algs(ce: *mut sun8i_ce_dev) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_probe(pdev: *mut platform_device) -> c_int {
...
// Get Non Secure IRQ
    ...
    if (irq < 0)
    return irq;
    ce.reset = devm_reset_control_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(ce.reset))
...
// Ignore error of debugfs
    dbgfs_dir = debugfs_create_dir("sun8i-ce", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_remove(pdev: *mut platform_device) {
