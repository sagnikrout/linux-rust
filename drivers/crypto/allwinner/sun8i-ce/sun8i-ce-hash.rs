...
//! Source: drivers/crypto/allwinner/sun8i-ce/sun8i-ce-hash.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_hash_stat_fb_inc(tfm: *mut crypto_ahash) {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_init_tfm(tfm: *mut crypto_ahash) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_exit_tfm(tfm: *mut crypto_ahash) {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_export(areq: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_import(areq: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_final(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_update(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_finup(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_hash_digest_fb(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_hash_need_fallback(areq: *mut ahash_request) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_digest(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ce_hash_prepare(areq: *mut ahash_request, cet: *mut ce_task) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ce_hash_run(engine: *mut crypto_engine, async_req: *mut c_void) -> c_int {
