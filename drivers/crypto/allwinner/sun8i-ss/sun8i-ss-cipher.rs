...
//! Source: drivers/crypto/allwinner/sun8i-ss/sun8i-ss-cipher.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_need_fallback(areq: *mut skcipher_request) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_cipher_fallback(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_setup_ivs(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_cipher(areq: *mut skcipher_request) -> c_int {
    ...
    let mut err: c_int = 0;
    let mut nsgs: c_int = sg_nents_for_len(areq.src, areq.cryptlen);
    let mut nsgd: c_int = sg_nents_for_len(areq.dst, areq.cryptlen);
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ss_handle_cipher_request(engine: *mut crypto_engine, areq: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ss_skdecrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ss_skencrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ss_cipher_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun8i_ss_cipher_exit(tfm: *mut crypto_tfm) {
