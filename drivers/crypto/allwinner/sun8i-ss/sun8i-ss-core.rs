...
//! Source: drivers/crypto/allwinner/sun8i-ss/sun8i-ss-core.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn sun8i_ss_get_engine_number(ss: *mut sun8i_ss_dev) -> c_int {
    ...
    let mut ivlen: c_uint = rctx.ivlen;
...
#[no_mangle]
unsafe extern "C" fn ss_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_debugfs_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
    static int sun8i_ss_debugfs_show(struct seq_file *seq, void *v)
    {
    let mut __maybe_unused: *mut sun8i_ss_dev ss = seq.private;
    unsigned int i;
    for (i = 0; i < MAXFLOW; i++)
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_free_flows(ss: *mut sun8i_ss_dev, i: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn allocate_flows(ss: *mut sun8i_ss_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sun8i_ss_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_pm_resume(dev: *mut device) -> c_int {
...
// enable interrupts for all flows
    ...
    SET_RUNTIME_PM_OPS(sun8i_ss_pm_suspend, sun8i_ss_pm_resume, core::ptr::null_mut())
    };
#[no_mangle]
unsafe extern "C" fn sun8i_ss_pm_init(ss: *mut sun8i_ss_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_pm_exit(ss: *mut sun8i_ss_dev) {
    static void sun8i_ss_pm_exit(struct sun8i_ss_dev *ss)
    {
    pm_runtime_disable(ss.dev);
    }
#[no_mangle]
unsafe extern "C" fn sun8i_ss_register_algs(ss: *mut sun8i_ss_dev) -> c_int {
    ...
    ss_algs[i].alg.skcipher.base.base.cra_name);
    ss_algs[i].ss = core::ptr::null_mut();
    break;
    }
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_unregister_algs(ss: *mut sun8i_ss_dev) {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_get_clks(ss: *mut sun8i_ss_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_probe(pdev: *mut platform_device) -> c_int {
    ...
    if (irq < 0)
    return irq;
    ss.reset = devm_reset_control_get(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(ss.reset))
...
// Ignore error of debugfs
    dbgfs_dir = debugfs_create_dir("sun8i-ss", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sun8i_ss_remove(pdev: *mut platform_device) {
