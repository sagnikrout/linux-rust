...
//! Source: drivers/crypto/allwinner/sun4i-ss/sun4i-ss-core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun4i_ss_debugfs_show(seq: *mut seq_file, v: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sun4i_ss_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_ss_pm_resume(dev: *mut device) -> c_int {
    ...
    SET_RUNTIME_PM_OPS(sun4i_ss_pm_suspend, sun4i_ss_pm_resume, core::ptr::null_mut())
    };
//
...
//
#[no_mangle]
unsafe extern "C" fn sun4i_ss_pm_init(ss: *mut sun4i_ss_ctx) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun4i_ss_pm_exit(ss: *mut sun4i_ss_ctx) {
    static void sun4i_ss_pm_exit(struct sun4i_ss_ctx *ss)
    {
    pm_runtime_disable(ss.dev);
    }
#[no_mangle]
unsafe extern "C" fn sun4i_ss_probe(pdev: *mut platform_device) -> c_int {
    static int sun4i_ss_probe(struct platform_device *pdev)
    {
    u32 v;
    int err, i;
    unsigned long cr;
    let mut cr_ahb: c_ulong = 24 * 1000 * 1000;
    let mut cr_mod: c_ulong = 150 * 1000 * 1000;
...
// Ignore error of debugfs
    ss.dbgfs_dir = debugfs_create_dir("sun4i-ss", core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sun4i_ss_remove(pdev: *mut platform_device) {
