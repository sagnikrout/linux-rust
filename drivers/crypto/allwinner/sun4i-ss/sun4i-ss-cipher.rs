...
//! Source: drivers/crypto/allwinner/sun4i-ss/sun4i-ss-cipher.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sun4i_ss_opti_poll(areq: *mut skcipher_request) -> int noinline_for_stack {
...
// when activating SS, the default FIFO space is SS_RX_DEFAULT(32)
    ...
    let mut err: c_int = 0;
    unsigned int i;
    let mut ileft: c_uint = areq.cryptlen;
    let mut oleft: c_uint = areq.cryptlen;
    unsigned int todo;
    ...
    dev_err_ratelimited(ss.dev, "ERROR: Some SGs are core::ptr::null_mut()\n");
    return -EINVAL;
    }
...
#[no_mangle]
unsafe extern "C" fn sun4i_ss_cipher_poll_fallback(areq: *mut skcipher_request) -> int noinline_for_stack {
...
#[no_mangle]
unsafe extern "C" fn sun4i_ss_cipher_poll(areq: *mut skcipher_request) -> c_int {
    static int sun4i_ss_cipher_poll(struct skcipher_request *areq)
    {
    struct crypto_skcipher *tfm = crypto_skcipher_reqtfm(areq);
    struct sun4i_tfm_ctx *op = crypto_skcipher_ctx(tfm);
    struct sun4i_ss_ctx *ss = op.ss;
    let mut no_chunk: c_int = 1;
...
// when activating SS, the default FIFO space is SS_RX_DEFAULT(32)
    ...
    unsigned long flags;
    let mut need_fallback: bool = false;
    if (!areq.cryptlen)
    return 0;
    if (!areq.src || !areq.dst) {
    dev_err_ratelimited(ss.dev, "ERROR: Some SGs are core::ptr::null_mut()\n");
...
// CBC AES
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_cbc_aes_encrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_cbc_aes_decrypt(areq: *mut skcipher_request) -> c_int {
...
// ECB AES
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_ecb_aes_encrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_ecb_aes_decrypt(areq: *mut skcipher_request) -> c_int {
...
// CBC DES
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_cbc_des_encrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_cbc_des_decrypt(areq: *mut skcipher_request) -> c_int {
...
// ECB DES
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_ecb_des_encrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_ecb_des_decrypt(areq: *mut skcipher_request) -> c_int {
...
// CBC 3DES
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_cbc_des3_encrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_cbc_des3_decrypt(areq: *mut skcipher_request) -> c_int {
...
// ECB 3DES
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_ecb_des3_encrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_ecb_des3_decrypt(areq: *mut skcipher_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_cipher_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_ss_cipher_exit(tfm: *mut crypto_tfm) {
