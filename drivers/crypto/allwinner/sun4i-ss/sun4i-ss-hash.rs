...
//! Source: drivers/crypto/allwinner/sun4i-ss/sun4i-ss-hash.c
#![no_std]
...
pub const SS_TIMEOUT: c_int = 100;
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_crainit(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_craexit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_export_md5(areq: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_import_md5(areq: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_export_sha1(areq: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_import_sha1(areq: *mut ahash_request, in: *const c_void) -> c_int {
...
pub const SS_HASH_UPDATE: c_int = 1;
pub const SS_HASH_FINAL: c_int = 2;
//
...
//
#[no_mangle]
unsafe extern "C" fn sun4i_hash(areq: *mut ahash_request) -> c_int {
...
//
    let mut i: c_uint = 0, end, fill, min_fill, nwait, nbw = 0, j = 0, todo;
    let mut in_i: c_uint = 0;
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_final(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_update(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_finup(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn sun4i_hash_digest(areq: *mut ahash_request) -> c_int {
