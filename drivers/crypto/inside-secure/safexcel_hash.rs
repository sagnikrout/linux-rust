...
//! Source: drivers/crypto/inside-secure/safexcel_hash.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct safexcel_ahash_ctx {
    pub base: safexcel_context,
    pub alg: u32,
    pub key_sz: u8,
    pub cbcmac: bool,
    pub do_fallback: bool,
    pub fb_init_done: bool,
    pub fb_do_setkey: bool,
    pub aes: *mut aes_enckey,
    pub fback: *mut crypto_ahash,
    pub shpre: *mut crypto_shash,
    pub shdesc: *mut shash_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct safexcel_ahash_req {
    pub last_req: bool,
    pub finish: bool,
    pub hmac: bool,
    pub needs_inv: bool,
    ...
    pub xcbcmac: bool,
    pub nents: c_int,
    pub result_dma: dma_addr_t,
    pub digest: u32,
    pub /: *mut *mut u8 state_sz; / expected state size, only set once,
    pub /: *mut *mut u8 block_sz; / block size, only set once,
    pub /: *mut *mut u8 digest_sz; / output digest size, only set once,
    __le32 state[SHA3_512_BLOCK_SIZE /
    pub __aligned(sizeof(__le32)): sizeof(__le32)],
    pub len: u64,
    pub processed: u64,
    pub __aligned(sizeof(u32)): u8 cache[HASH_CACHE_SIZE],
    pub cache_dma: dma_addr_t,
    pub cache_sz: c_uint,
    pub __aligned(sizeof(u32)): u8 cache_next[HASH_CACHE_SIZE],
}

#[no_mangle]
pub unsafe extern "C" fn safexcel_queued_len(req: *mut safexcel_ahash_req) -> u64 {
...
// should_complete = true;
    ...
    struct safexcel_crypto_priv *priv = ctx.base.priv;
    struct safexcel_command_desc *cdesc, *first_cdesc = core::ptr::null_mut();
    struct safexcel_result_desc *rdesc;
...
// More data follows: borrow bytes
    let mut tmp: u64 = queued - cache_len;
...
// Now handle the current ahash request buffer(s)
    ...
    let mut sglen: c_int = sg_dma_len(sg);
...
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_exit_inv(tfm: *mut crypto_tfm) -> c_int {
    ...
    let mut ring: c_int = ctx.base.ring;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_cache(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_enqueue(areq: *mut ahash_request) -> c_int {
    static int safexcel_ahash_enqueue(struct ahash_request *areq)
    {
    struct safexcel_ahash_ctx *ctx = crypto_ahash_ctx(crypto_ahash_reqtfm(areq));
    struct safexcel_ahash_req *req = ahash_request_ctx_dma(areq);
...
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_update(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_final(areq: *mut ahash_request) -> c_int {
...
//
    ...
    MD5_DIGEST_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(CONTEXT_CONTROL_CRYPTO_ALG_SHA1: ctx->alg ==) -> else {
    else if (ctx.alg == CONTEXT_CONTROL_CRYPTO_ALG_SHA1)
    memcpy(areq.result, sha1_zero_message_hash,
    SHA1_DIGEST_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(CONTEXT_CONTROL_CRYPTO_ALG_SHA224: ctx->alg ==) -> else {
    else if (ctx.alg == CONTEXT_CONTROL_CRYPTO_ALG_SHA224)
    memcpy(areq.result, sha224_zero_message_hash,
    SHA224_DIGEST_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(CONTEXT_CONTROL_CRYPTO_ALG_SHA256: ctx->alg ==) -> else {
    else if (ctx.alg == CONTEXT_CONTROL_CRYPTO_ALG_SHA256)
    memcpy(areq.result, sha256_zero_message_hash,
    SHA256_DIGEST_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(CONTEXT_CONTROL_CRYPTO_ALG_SHA384: ctx->alg ==) -> else {
    else if (ctx.alg == CONTEXT_CONTROL_CRYPTO_ALG_SHA384)
    memcpy(areq.result, sha384_zero_message_hash,
    SHA384_DIGEST_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(CONTEXT_CONTROL_CRYPTO_ALG_SHA512: ctx->alg ==) -> else {
    else if (ctx.alg == CONTEXT_CONTROL_CRYPTO_ALG_SHA512)
    memcpy(areq.result, sha512_zero_message_hash,
    SHA512_DIGEST_SIZE);
#[no_mangle]
pub unsafe extern "C" fn if(CONTEXT_CONTROL_CRYPTO_ALG_SM3: ctx->alg ==) -> else {
    memcpy(areq.result,
...
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_finup(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_export(areq: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_import(areq: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha1_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha1_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_sha1_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_sha1_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
#[no_mangle]
unsafe extern "C" fn safexcel_ahash_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha1_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha1_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_hmac_sha1_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_hmac_sha1_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha256_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha256_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_sha256_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_sha256_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha224_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha224_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_sha224_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_sha224_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha224_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha224_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_hmac_sha224_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_hmac_sha224_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha256_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha256_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_hmac_sha256_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_hmac_sha256_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha512_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha512_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_sha512_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_sha512_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha384_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha384_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_sha384_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_sha384_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha512_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha512_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_hmac_sha512_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_hmac_sha512_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha384_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha384_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_hmac_sha384_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_hmac_sha384_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_md5_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_md5_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_md5_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_md5_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_md5_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_md5_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_hmac_md5_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_hmac_md5_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_cbcmac_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_cbcmac_digest(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_xcbcmac_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_xcbcmac_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sm3_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sm3_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_sm3_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_sm3_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sm3_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sm3_digest(areq: *mut ahash_request) -> c_int {
    static int safexcel_hmac_sm3_digest(struct ahash_request *areq)
    {
    let mut ret: c_int = safexcel_hmac_sm3_init(areq);
    if (ret)
    return ret;
    return safexcel_ahash_finup(areq);
    }
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_224_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_fbcheck(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_digest_fallback(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_224_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_256_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_256_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_384_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_384_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_512_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sha3_512_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_cra_init(tfm: *mut crypto_tfm, alg: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_224_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_224_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_224_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_256_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_256_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_256_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_384_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_384_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_384_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_512_init(areq: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_512_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_hmac_sha3_512_cra_init(tfm: *mut crypto_tfm) -> c_int {
