...
//! Source: drivers/crypto/inside-secure/safexcel_cipher.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct safexcel_cipher_ctx {
    pub base: safexcel_context,
    pub priv: *mut safexcel_crypto_priv,
    pub mode: u32,
    pub alg: enum safexcel_cipher_alg,
    pub /: *mut *mut u8 aead; / !=0=AEAD, 2=IPSec ESP AEAD, 3=IPsec ESP GMAC,
    pub /: *mut *mut u8 xcm; / 0=authenc, 1=GCM, 2 reserved for CCM,
    pub aadskip: u8,
    pub blocksz: u8,
    pub ivmask: u32,
    pub ctrinit: u32,
    pub key: [__le32; 16],
    pub nonce: u32,
    pub xts: unsigned int key_len,,
// All the below is AEAD specific
    pub hash_alg: u32,
    pub state_sz: u32,
    pub fback: *mut crypto_aead,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct safexcel_cipher_req {
    pub direction: enum safexcel_cipher_direction,
// Number of result descriptors associated to the request
    pub rdescs: c_uint,
    pub needs_inv: bool,
    pub nr_dst: int nr_src,,
}
...
// CBC
    ...
    let mut assocadj: c_int = assoclen - ctx.aadskip, aadalign;
...
// Now copy the keys into the context
    ...
    {
    struct safexcel_crypto_priv *priv = ctx.base.priv;
    let mut ctrl_size: c_int = ctx.key_len / sizeof(u32);
...
#[no_mangle]
pub unsafe extern "C" fn if(SAFEXCEL_ENCRYPT: sreq->direction ==) -> else {
    else if (sreq.direction == SAFEXCEL_ENCRYPT)
    cdesc.control_data.control0 |=
    CONTEXT_CONTROL_TYPE_ENCRYPT_HASH_OUT;
#[no_mangle]
pub unsafe extern "C" fn if(EIP197_XCM_MODE_CCM: ctx->xcm ==) -> else {
...
// should_complete = true;
    ...
    struct safexcel_crypto_priv *priv = ctx.base.priv;
    struct safexcel_command_desc *cdesc;
    struct safexcel_command_desc *first_cdesc = core::ptr::null_mut();
    struct safexcel_result_desc *rdesc, *first_rdesc = core::ptr::null_mut();
    struct scatterlist *sg;
    unsigned int totlen;
    let mut totlen_src: c_uint = cryptlen + assoclen;
    let mut totlen_dst: c_uint = totlen_src;
    struct safexcel_token *atoken;
    let mut n_cdesc: c_int = 0, n_rdesc = 0;
    int queued, i, ret = 0;
...
// command descriptors
    ...
    let mut len: c_int = sg_dma_len(sg);
...
// result descriptors
    ...
    let mut last: bool = (i == sreq.nr_dst - 1);
    let mut len: u32 = sg_dma_len(sg);
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_exit_inv(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_exit_inv(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_cipher_cra_exit(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_aes_ecb_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_aes_cbc_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_aes_ctr_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_des_cbc_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_des_ecb_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_des3_cbc_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_des3_ecb_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_md5_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha1_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha256_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha224_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha512_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha384_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_md5_des3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha1_des3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha256_des3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha224_des3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha512_des3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha384_des3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_md5_des_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha1_des_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha256_des_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha224_des_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha512_des_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha384_des_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_md5_ctr_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha1_ctr_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha256_ctr_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha224_ctr_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha512_ctr_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sha384_ctr_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_aes_xts_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_encrypt_xts(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_decrypt_xts(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_gcm_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_gcm_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
pub unsafe extern "C" fn if(AES_KEYSIZE_256: len ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_ccm_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_ccm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_ccm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_chacha20_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_chachapoly_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_chachapoly_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_fallback_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_chachapoly_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_fallback_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_chachapolyesp_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sm4_blk_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_sm4_blk_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_sm4_ecb_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_sm4_cbc_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_skcipher_sm4_ctr_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sm4_blk_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sm4_blk_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sm4cbc_sha1_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sm4cbc_sm3_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sm4cbc_sm3_decrypt(req: *mut aead_request) -> c_int {
...
// Workaround for HW bug: EIP96 4.3 does not report blocksize error
    ...
    return -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(req->assoclen: req->cryptlen > crypto_aead_authsize(tfm) ||) -> else {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sm4cbc_sm3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sm4ctr_sha1_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_aead_sm4ctr_sm3_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_rfc4106_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_rfc4106_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_rfc4106_gcm_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_rfc4543_gcm_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_rfc4309_ccm_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_rfc4309_ccm_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn safexcel_rfc4309_ccm_cra_init(tfm: *mut crypto_tfm) -> c_int {
