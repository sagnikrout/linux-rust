...
//! Source: drivers/crypto/virtio/virtio_crypto_core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_ctrlq_callback(vc_ctrl_req: *mut virtio_crypto_ctrl_request) {
    static void virtio_crypto_ctrlq_callback(struct virtio_crypto_ctrl_request *vc_ctrl_req)
    {
    complete(&vc_ctrl_req.compl);
    }
#[no_mangle]
unsafe extern "C" fn virtcrypto_ctrlq_callback(vq: *mut virtqueue) {
    ...
    while ((vc_ctrl_req = virtqueue_get_buf(vq, &len)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_done_work(work: *mut work_struct) {
    ...
    do {
    virtqueue_disable_cb(vq);
    while ((vc_req = virtqueue_get_buf(vq, &len)) != core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_dataq_callback(vq: *mut virtqueue) {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_find_vqs(vi: *mut virtio_crypto) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_alloc_queues(vi: *mut virtio_crypto) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_clean_affinity(vi: *mut virtio_crypto, hcpu: c_long) {
    static void virtcrypto_clean_affinity(struct virtio_crypto *vi, long hcpu)
    {
    int i;
    if (vi.affinity_hint_set) {
    for (i = 0; i < vi.max_data_queues; i++)
    virtqueue_set_affinity(vi.data_vq[i].vq, core::ptr::null_mut());
    vi.affinity_hint_set = false;
    }
    }
#[no_mangle]
unsafe extern "C" fn virtcrypto_set_affinity(vcrypto: *mut virtio_crypto) {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_free_queues(vi: *mut virtio_crypto) {
    static void virtcrypto_free_queues(struct virtio_crypto *vi)
    {
    kfree(vi.data_vq);
    }
#[no_mangle]
unsafe extern "C" fn virtcrypto_init_vqs(vi: *mut virtio_crypto) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_update_status(vcrypto: *mut virtio_crypto) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_start_crypto_engines(vcrypto: *mut virtio_crypto) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_clear_crypto_engines(vcrypto: *mut virtio_crypto) {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_del_vqs(vcrypto: *mut virtio_crypto) {
...
#[no_mangle]
unsafe extern "C" fn vcrypto_config_changed_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_probe(vdev: *mut virtio_device) -> c_int {
    static int virtcrypto_probe(struct virtio_device *vdev)
    {
    let mut err: c_int = -EFAULT;
    struct virtio_crypto *vcrypto;
    let mut max_data_queues: u32 = 0, max_cipher_key_len = 0;
    let mut max_auth_key_len: u32 = 0;
    let mut max_size: u64 = 0;
    let mut cipher_algo_l: u32 = 0;
    let mut cipher_algo_h: u32 = 0;
    let mut hash_algo: u32 = 0;
    let mut mac_algo_l: u32 = 0;
    let mut mac_algo_h: u32 = 0;
    let mut aead_algo: u32 = 0;
    let mut akcipher_algo: u32 = 0;
    let mut crypto_services: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_free_unused_reqs(vcrypto: *mut virtio_crypto) {
    ...
    while ((vc_req = virtqueue_detach_unused_buf(vq)) != core::ptr::null_mut())
    virtcrypto_clear_request(vc_req);
    cond_resched();
    }
    }
#[no_mangle]
unsafe extern "C" fn virtcrypto_remove(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_config_changed(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_freeze(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtcrypto_restore(vdev: *mut virtio_device) -> c_int {
