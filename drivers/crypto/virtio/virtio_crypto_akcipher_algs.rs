...
//! Source: drivers/crypto/virtio/virtio_crypto_akcipher_algs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_crypto_rsa_ctx {
    pub key_size: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_crypto_akcipher_ctx {
    pub vcrypto: *mut virtio_crypto,
    pub session_valid: bool,
    pub session_id: __u64,
    union {
    pub rsa_ctx: virtio_crypto_rsa_ctx,
}

    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_crypto_akcipher_request {
    pub base: virtio_crypto_request,
    pub src_buf: *mut c_void,
    pub dst_buf: *mut c_void,
    pub opcode: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct virtio_crypto_akcipher_algo {
    pub algonum: u32,
    pub service: u32,
    pub active_devs: c_uint,
    pub algo: akcipher_engine_alg,
}
    ...
    vc_akcipher_req.src_buf = core::ptr::null_mut();
    vc_akcipher_req.dst_buf = core::ptr::null_mut();
    virtcrypto_clear_request(&vc_akcipher_req.base);
    crypto_finalize_akcipher_request(vc_akcipher_req.base.dataq.engine, req, err);
    }
#[no_mangle]
unsafe extern "C" fn virtio_crypto_dataq_akcipher_callback(vc_req: *mut virtio_crypto_request, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_alg_akcipher_close_session(ctx: *mut virtio_crypto_akcipher_ctx) -> c_int {
    ...
    void *src_buf, *dst_buf = core::ptr::null_mut();
    let mut num_out: c_uint = 0, num_in = 0;
    let mut node: c_int = dev_to_node(&vcrypto.vdev.dev);
    unsigned long flags;
    int ret;
// out header
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_rsa_do_req(engine: *mut crypto_engine, vreq: *mut c_void) -> c_int {
...
// build request akcipher data
    ...
    vc_req.req_data = core::ptr::null_mut();
    return ret;
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn virtio_crypto_rsa_req(req: *mut akcipher_request, opcode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_rsa_encrypt(req: *mut akcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_rsa_decrypt(req: *mut akcipher_request) -> c_int {
    ...
    struct virtio_crypto_ctrl_header header;
    struct virtio_crypto_akcipher_session_para para;
    let mut rsa_key: rsa_key = {0};
    let mut node: c_int = virtio_crypto_get_current_node();
    uint32_t keytype;
    int ret;
    MPI n;
    if (private) {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_rsa_max_size(tfm: *mut crypto_akcipher) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_rsa_init_tfm(tfm: *mut crypto_akcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_rsa_exit_tfm(tfm: *mut crypto_akcipher) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_crypto_akcipher_algs_register(vcrypto: *mut virtio_crypto) -> c_int {
    ...
    let mut service: u32 = virtio_crypto_akcipher_algs[i].service;
    let mut algonum: u32 = virtio_crypto_akcipher_algs[i].algonum;
...
#[no_mangle]
pub unsafe extern "C" fn virtio_crypto_akcipher_algs_unregister(vcrypto: *mut virtio_crypto) {
