...
//! Source: drivers/crypto/virtio/virtio_crypto_skcipher_algs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_alg_sg_nents_length(sg: *mut scatterlist) -> u64 {
...
// alg = VIRTIO_CRYPTO_CIPHER_AES_CBC;
    ...
    let mut op: c_int = encrypt ? VIRTIO_CRYPTO_OP_ENCRYPT : VIRTIO_CRYPTO_OP_DECRYPT;
    int err;
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_skcipher_encrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_skcipher_decrypt(req: *mut skcipher_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_skcipher_init(tfm: *mut crypto_skcipher) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn virtio_crypto_skcipher_exit(tfm: *mut crypto_skcipher) {
...
#[no_mangle]
pub unsafe extern "C" fn virtio_crypto_skcipher_algs_register(vcrypto: *mut virtio_crypto) -> c_int {
    ...
    let mut service: u32 = virtio_crypto_algs[i].service;
    let mut algonum: u32 = virtio_crypto_algs[i].algonum;
...
#[no_mangle]
pub unsafe extern "C" fn virtio_crypto_skcipher_algs_unregister(vcrypto: *mut virtio_crypto) {
