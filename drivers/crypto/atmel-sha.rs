...
//! Source: drivers/crypto/atmel-sha.c
#![no_std]
...
pub const ATMEL_SHA_PRIORITY: c_int = 300;
// SHA flags

// bits[11:8] are reserved.

pub const SHA_OP_INIT: c_int = 0;
pub const SHA_OP_UPDATE: c_int = 1;
pub const SHA_OP_FINAL: c_int = 2;
pub const SHA_OP_DIGEST: c_int = 3;

pub const ATMEL_SHA_DMA_THRESHOLD: c_int = 56;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_sha_caps {
    pub has_dma: bool,
    pub has_dualbuff: bool,
    pub has_sha224: bool,
    pub has_sha_384_512: bool,
    pub has_uihv: bool,
    pub has_hmac: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_sha_reqctx {
    pub dd: *mut atmel_sha_dev,
    pub flags: c_ulong,
    pub op: c_ulong,
    pub __aligned(sizeof(u32)): u8 digest[SHA512_DIGEST_SIZE],
    pub digcnt: [u64; 2],
    pub bufcnt: usize,
    pub buflen: usize,
...
// walk state
    ...
    pub /: *mut *mut unsigned int total; / total request,
    pub block_size: usize,
    pub hash_size: usize,
    pub __aligned(sizeof(u32)): u8 buffer[SHA_BUFFER_LEN + SHA512_BLOCK_SIZE],
}

    typedef int (*atmel_sha_fn_t)(struct atmel_sha_dev *);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_sha_ctx {
    pub dd: *mut atmel_sha_dev,
    pub start: atmel_sha_fn_t,
    pub flags: c_ulong,
}

pub const ATMEL_SHA_QUEUE_LENGTH: c_int = 50;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_sha_dma {
    pub chan: *mut dma_chan,
    pub dma_conf: dma_slave_config,
    pub sg: *mut scatterlist,
    pub nents: c_int,
    pub last_sg_length: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_sha_dev {
    pub list: list_head,
    ...
    pub resume: atmel_sha_fn_t,
    pub cpu_transfer_complete: atmel_sha_fn_t,
    pub dma_lch_in: atmel_sha_dma,
    pub caps: atmel_sha_caps,
    pub tmp: scatterlist,
    pub hw_version: u32,
}
...
#[no_mangle]
pub unsafe extern "C" fn atmel_sha_read(dd: *mut atmel_sha_dev, offset: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn atmel_sha_complete(dd: *mut atmel_sha_dev, err: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_append_sg(ctx: *mut atmel_sha_reqctx) -> usize {
...
//
#[no_mangle]
unsafe extern "C" fn atmel_sha_fill_padding(ctx: *mut atmel_sha_reqctx, length: c_int) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_write_ctrl(dd: *mut atmel_sha_dev, dma: c_int) {
    static void atmel_sha_write_ctrl(struct atmel_sha_dev *dd, int dma)
    {
    struct atmel_sha_reqctx *ctx = ahash_request_ctx(dd.req);
    let mut valmr: u32 = SHA_MR_MODE_AUTO;
...
//
    ...
    {
    let mut isr: u32 = atmel_sha_read(dd, SHA_ISR);
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_dma_callback(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_update_cpu(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_update_dma_slow(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_update_dma_start(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_update_dma_stop(dd: *mut atmel_sha_dev) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_update_req(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_final_req(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_copy_hash(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_copy_ready_hash(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_finish(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_finish_req(req: *mut ahash_request, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hw_init(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn atmel_sha_get_version(dd: *mut atmel_sha_dev) -> c_uint {
    static inline unsigned int atmel_sha_get_version(struct atmel_sha_dev *dd)
    {
    return atmel_sha_read(dd, SHA_HW_VERSION) & 0x00000fff;
    }
#[no_mangle]
unsafe extern "C" fn atmel_sha_hw_version_init(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_start(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_enqueue(req: *mut ahash_request, op: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_update(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_final(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_finup(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_digest(req: *mut ahash_request) -> c_int {
    static int atmel_sha_digest(struct ahash_request *req)
    {
    return atmel_sha_init(req) ?: atmel_sha_finup(req);
    }
#[no_mangle]
unsafe extern "C" fn atmel_sha_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_alg_init(alg: *mut ahash_alg) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_queue_task(data: c_ulong) {
    static void atmel_sha_queue_task(unsigned long data)
    {
    struct atmel_sha_dev *dd = (struct atmel_sha_dev *)data;
    atmel_sha_handle_queue(dd, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn atmel_sha_done(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_done(struct atmel_sha_dev *dd)
    {
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_done_task(data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
// DMA transfer functions
    ...
    struct ahash_request *req = dd.req;
    struct atmel_sha_reqctx *ctx = ahash_request_ctx(req);
    let mut bs: usize = ctx.block_size;
    int nents;
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_dma_callback2(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_cpu_transfer(dd: *mut atmel_sha_dev) -> c_int {
...
// Prepare the first block to be written.
    ...
    struct ahash_request *req = dd.req;
    struct atmel_sha_reqctx *ctx = ahash_request_ctx(req);
    let mut msglen: u32 = (auto_padding) ? datalen : 0;
    let mut mr: u32 = SHA_MR_MODE_AUTO;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_sha_hmac_key {
    pub valid: bool,
    pub keylen: c_uint,
    pub buffer: [u8; SHA512_BLOCK_SIZE],
    pub keydup: *mut u8,
}

#[no_mangle]
pub unsafe extern "C" fn atmel_sha_hmac_key_init(hkey: *mut atmel_sha_hmac_key) {
    static inline void atmel_sha_hmac_key_init(struct atmel_sha_hmac_key *hkey)
    {
    memset(hkey, 0, sizeof(*hkey));
    }
#[no_mangle]
pub unsafe extern "C" fn atmel_sha_hmac_key_release(hkey: *mut atmel_sha_hmac_key) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_sha_hmac_ctx {
    pub base: atmel_sha_ctx,
    pub hkey: atmel_sha_hmac_key,
    pub sizeof(u32)]: u32 ipad[SHA512_BLOCK_SIZE /,
    pub sizeof(u32)]: u32 opad[SHA512_BLOCK_SIZE /,
    pub resume: atmel_sha_fn_t,
}
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_prehash_key_done(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_hmac_prehash_key_done(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(req);
    struct atmel_sha_hmac_ctx *hmac = crypto_ahash_ctx(tfm);
    struct atmel_sha_reqctx *ctx = ahash_request_ctx(req);
    let mut ds: usize = crypto_ahash_digestsize(tfm);
    let mut bs: usize = ctx.block_size;
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_compute_ipad_hash(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_hmac_compute_ipad_hash(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(req);
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_compute_opad_hash(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_hmac_compute_opad_hash(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(req);
    ...
    struct atmel_sha_reqctx *ctx = ahash_request_ctx(req);
    let mut bs: usize = ctx.block_size;
    let mut hs: usize = ctx.hash_size;
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_setup_done(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_hmac_setup_done(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct crypto_ahash *tfm = crypto_ahash_reqtfm(req);
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_start(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_init_done(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_hmac_init_done(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct atmel_sha_reqctx *ctx = ahash_request_ctx(req);
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_final(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_hmac_final(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct atmel_sha_reqctx *ctx = ahash_request_ctx(req);
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_final_done(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_hmac_final_done(struct atmel_sha_dev *dd)
    {
//
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_digest(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_digest2(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_hmac_digest2(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct atmel_sha_reqctx *ctx = ahash_request_ctx(req);
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_cra_exit(tfm: *mut crypto_tfm) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_hmac_alg_init(alg: *mut ahash_alg) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atmel_sha_authenc_reqctx {
    pub base: atmel_sha_reqctx,
    pub cb: atmel_aes_authenc_fn_t,
    pub aes_dev: *mut atmel_aes_dev,
// _init() parameters.
...
// _final() parameters.
    pub digest: *mut u32,
    pub digestlen: c_uint,
}

#[no_mangle]
unsafe extern "C" fn atmel_sha_authenc_complete(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_authenc_start(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn atmel_sha_authenc_is_ready() -> bool {
    bool atmel_sha_authenc_is_ready(void)
    {
    struct atmel_sha_ctx dummy;
    dummy.dd = core::ptr::null_mut();
    return (atmel_sha_find_dev(&dummy) != core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(atmel_sha_authenc_is_ready);
#[no_mangle]
pub unsafe extern "C" fn atmel_sha_authenc_get_reqsize() -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn atmel_sha_authenc_free(auth: *mut atmel_sha_authenc_ctx) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_authenc_init2(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_authenc_init2(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct atmel_sha_authenc_reqctx *authctx = ahash_request_ctx(req);
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_authenc_init_done(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_authenc_init_done(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct atmel_sha_authenc_reqctx *authctx = ahash_request_ctx(req);
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_authenc_final_done(dd: *mut atmel_sha_dev) -> c_int {
    static int atmel_sha_authenc_final_done(struct atmel_sha_dev *dd)
    {
    struct ahash_request *req = dd.req;
    struct atmel_sha_authenc_reqctx *authctx = ahash_request_ctx(req);
...
#[no_mangle]
pub unsafe extern "C" fn atmel_sha_authenc_abort(req: *mut ahash_request) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_unregister_algs(dd: *mut atmel_sha_dev) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_register_algs(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_dma_init(dd: *mut atmel_sha_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_dma_cleanup(dd: *mut atmel_sha_dev) {
    static void atmel_sha_dma_cleanup(struct atmel_sha_dev *dd)
    {
    dma_release_channel(dd.dma_lch_in.chan);
    }
#[no_mangle]
unsafe extern "C" fn atmel_sha_get_cap(dd: *mut atmel_sha_dev) {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atmel_sha_remove(pdev: *mut platform_device) {
