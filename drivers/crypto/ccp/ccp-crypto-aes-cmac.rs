...
//! Source: drivers/crypto/ccp/ccp-crypto-aes-cmac.c
#![no_std]
...
// Update result area if supplied
    ...
    struct ccp_aes_cmac_req_ctx *rctx = ahash_request_ctx_dma(req);
    struct scatterlist *sg, *cmac_key_sg = core::ptr::null_mut();
...
//
    ...
    if (need_pad) {
    let mut pad_length: c_int = block_size - (len & (block_size - 1));
...
#[no_mangle]
unsafe extern "C" fn ccp_aes_cmac_init(req: *mut ahash_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp_aes_cmac_export(req: *mut ahash_request, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp_aes_cmac_import(req: *mut ahash_request, in: *const c_void) -> c_int {
...
// 'in' may not be aligned so memcpy to local variable
    ...
    let mut rb_hi: u64 = 0x00, rb_lo = 0x87;
...
#[no_mangle]
unsafe extern "C" fn ccp_aes_cmac_cra_init(tfm: *mut crypto_tfm) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ccp_register_aes_cmac_algs(head: *mut list_head) -> c_int {
