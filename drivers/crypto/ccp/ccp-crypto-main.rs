...
//! Source: drivers/crypto/ccp/ccp-crypto-main.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ccp_crypto_queue {
    pub cmds: list_head,
    pub backlog: *mut list_head,
    pub cmd_count: c_uint,
}

pub const CCP_CRYPTO_MAX_QLEN: c_int = 100;
    static struct ccp_crypto_queue req_queue;
    static DEFINE_SPINLOCK(req_queue_lock);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ccp_crypto_cmd {
    pub entry: list_head,
    pub cmd: *mut ccp_cmd,
...
#[no_mangle]
pub unsafe extern "C" fn ccp_crypto_success(err: c_int) -> bool {
    ...
    {
    struct ccp_crypto_cmd *held = core::ptr::null_mut(), *tmp;
    unsigned long flags;
// backlog = NULL;
...
#[no_mangle]
unsafe extern "C" fn ccp_crypto_complete(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ccp_crypto_enqueue_cmd(crypto_cmd: *mut ccp_crypto_cmd) -> c_int {
    static int ccp_crypto_enqueue_cmd(struct ccp_crypto_cmd *crypto_cmd)
    {
    struct ccp_crypto_cmd *active = core::ptr::null_mut(), *tmp;
    unsigned long flags;
    let mut free_cmd: bool = true;
    int ret;
    spin_lock_irqsave(&req_queue_lock, flags);
...
//
    ...
    {
    struct scatterlist *sg, *sg_last = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ccp_register_algs() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp_unregister_algs() {
...
#[no_mangle]
unsafe extern "C" fn ccp_crypto_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ccp_crypto_exit() -> void __exit {
