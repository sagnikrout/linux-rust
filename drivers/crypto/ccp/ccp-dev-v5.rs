...
//! Source: drivers/crypto/ccp/ccp-dev-v5.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ccp_lsb_alloc(cmd_q: *mut ccp_cmd_queue, count: c_uint) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn low_address(addr: c_ulong) -> u32 {
    static inline u32 low_address(unsigned long addr)
    {
    return (u64)addr & 0x0ffffffff;
    }
#[no_mangle]
pub unsafe extern "C" fn high_address(addr: c_ulong) -> u32 {
    static inline u32 high_address(unsigned long addr)
    {
    return ((u64)addr >> 32) & 0x00000ffff;
    }
#[no_mangle]
unsafe extern "C" fn ccp5_get_free_slots(cmd_q: *mut ccp_cmd_queue) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ccp5_perform_aes(op: *mut ccp_op) -> c_int {
    static int ccp5_perform_aes(struct ccp_op *op)
    {
    struct ccp5_desc desc;
    union ccp_function function;
    let mut key_addr: u32 = op.sb_key * LSB_ITEM_SIZE;
...
#[no_mangle]
unsafe extern "C" fn ccp5_perform_xts_aes(op: *mut ccp_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp5_perform_sha(op: *mut ccp_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp5_perform_des3(op: *mut ccp_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp5_perform_rsa(op: *mut ccp_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp5_perform_passthru(op: *mut ccp_op) -> c_int {
...
// Length of source data is always 256 bytes
    ...
    let mut key_addr: u32 = op.src.u.sb * CCP_SB_BYTES;
    ...
    let mut key_addr: u32 = op.dst.u.sb * CCP_SB_BYTES;
...
#[no_mangle]
unsafe extern "C" fn ccp5_perform_ecc(op: *mut ccp_op) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp_find_lsb_regions(cmd_q: *mut ccp_cmd_queue, status: u64) -> c_int {
    static int ccp_find_lsb_regions(struct ccp_cmd_queue *cmd_q, u64 status)
    {
    let mut q_mask: c_int = 1 << cmd_q.id;
    let mut queues: c_int = 0;
    int j;
...
#[no_mangle]
unsafe extern "C" fn ccp5_disable_queue_interrupts(ccp: *mut ccp_device) {
...
#[no_mangle]
unsafe extern "C" fn ccp5_enable_queue_interrupts(ccp: *mut ccp_device) {
...
#[no_mangle]
unsafe extern "C" fn ccp5_irq_bh(data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn ccp5_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ccp5_init(ccp: *mut ccp_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp5_destroy(ccp: *mut ccp_device) {
...
#[no_mangle]
unsafe extern "C" fn ccp5_config(ccp: *mut ccp_device) {
...
#[no_mangle]
unsafe extern "C" fn ccp5other_config(ccp: *mut ccp_device) {
