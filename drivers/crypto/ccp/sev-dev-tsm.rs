...
//! Source: drivers/crypto/ccp/sev-dev-tsm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn sev_tio_spdm_cmd(dsm: *mut tio_dsm, ret: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stream_enable(ide: *mut pci_ide) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn streams_enable(ide: *mut pci_ide) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn stream_disable(ide: *mut pci_ide) {
...
#[no_mangle]
unsafe extern "C" fn streams_disable(ide: *mut pci_ide) {
...
#[no_mangle]
unsafe extern "C" fn stream_setup(ide: *mut pci_ide) {
...
#[no_mangle]
unsafe extern "C" fn streams_setup(ide: *mut pci_ide, ids: *mut u8) -> u8 {
    static u8 streams_setup(struct pci_ide **ide, u8 *ids)
    {
    let mut def: bool = false;
    let mut tc_mask: u8 = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn streams_register(ide: *mut pci_ide) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn streams_unregister(ide: *mut pci_ide) {
...
#[no_mangle]
unsafe extern "C" fn stream_teardown(ide: *mut pci_ide) {
...
#[no_mangle]
unsafe extern "C" fn streams_teardown(ide: *mut pci_ide) {
...
#[no_mangle]
unsafe extern "C" fn dsm_remove(tsm: *mut pci_tsm) {
...
#[no_mangle]
unsafe extern "C" fn dsm_create(dsm: *mut tio_dsm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsm_connect(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dsm_disconnect(pdev: *mut pci_dev) {
    static void dsm_disconnect(struct pci_dev *pdev)
    {
    let mut force: bool = SYSTEM_HALT <= system_state && system_state <= SYSTEM_RESTART;
    struct tio_dsm *dsm = pdev_to_tio_dsm(pdev);
    struct tsm_dsm_tio *dev_data = &dsm.data;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn sev_tsm_init_locked(sev: *mut sev_device, tio_status_page: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn sev_tsm_uninit(sev: *mut sev_device) {
