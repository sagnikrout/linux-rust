...
//! Source: drivers/crypto/ccp/ccp-dmaengine.c
#![no_std]
...
//
    let mut dma_chan_attr: static unsigned int = CCP_DMA_DFLT;
    module_param(dma_chan_attr, uint, 0444);
    MODULE_PARM_DESC(dma_chan_attr, "Set DMA channel visibility: 0 (default) = device defaults, 1 = make private, 2 = make public");
    let mut dmaengine: static unsigned int = 1;
...
#[no_mangle]
unsafe extern "C" fn ccp_get_dma_chan_attr(ccp: *mut ccp_device) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ccp_free_chan_resources(dma_chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn ccp_do_cleanup(data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn ccp_issue_next_cmd(desc: *mut ccp_dma_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp_free_active_cmd(desc: *mut ccp_dma_desc) {
...
#[no_mangle]
unsafe extern "C" fn ccp_cmd_callback(data: *mut c_void, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ccp_tx_submit(tx_desc: *mut dma_async_tx_descriptor) -> dma_cookie_t {
...
#[no_mangle]
unsafe extern "C" fn ccp_issue_pending(dma_chan: *mut dma_chan) {
...
#[no_mangle]
unsafe extern "C" fn ccp_pause(dma_chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp_resume(dma_chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp_terminate_all(dma_chan: *mut dma_chan) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccp_dma_release(ccp: *mut ccp_device) {
...
#[no_mangle]
unsafe extern "C" fn ccp_dma_release_channels(ccp: *mut ccp_device) {
...
#[no_mangle]
pub unsafe extern "C" fn ccp_dmaengine_register(ccp: *mut ccp_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ccp_dmaengine_unregister(ccp: *mut ccp_device) {
