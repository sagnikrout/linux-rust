...
//! Source: drivers/crypto/xilinx/zynqmp-aes-gcm.c
#![no_std]
...
pub const ZYNQMP_AES_GCM_TAG_MISMATCH_ERR: c_uint = 0x01;
pub const ZYNQMP_AES_WRONG_KEY_SRC_ERR: c_uint = 0x13;
pub const ZYNQMP_AES_PUF_NOT_PROGRAMMED: c_uint = 0xE300;
pub const XILINX_KEY_MAGIC: c_uint = 0x3EA0;
    enum xilinx_aead_op {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_aead_dev {
    pub dev: *mut device,
    pub engine: *mut crypto_engine,
    pub aead_algs: *mut xilinx_aead_alg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_aead_alg {
    pub aead_dev: *mut xilinx_aead_dev,
    pub aead: aead_engine_alg,
    pub areq): *mut *mut int (aes_aead_cipher)(struct aead_request,
    pub dma_bit_mask: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_hwkey_info {
    pub magic: u16,
    pub type: u16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct zynqmp_aead_hw_req {
    pub src: u64,
    pub iv: u64,
    pub key: u64,
    pub dst: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_aead_tfm_ctx {
    pub dev: *mut device,
    pub key_dma_addr: dma_addr_t,
    pub key: *mut u8,
    pub keylen: u32,
    pub authsize: u32,
    pub keysrc: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xilinx_aead_req_ctx {
    pub op: enum xilinx_aead_op,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct versal_in_params {
    pub in_data_addr: u64,
    pub size: u32,
    pub is_last: u32,
}

#[no_mangle]
unsafe extern "C" fn zynqmp_aes_aead_cipher(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn versal_aes_aead_cipher(req: *mut aead_request) -> c_int {
    ...
    let mut total_len: u32 = req.assoclen + req.cryptlen;
    struct device *dev = tfm_ctx.dev;
...
#[no_mangle]
unsafe extern "C" fn xilinx_handle_aes_req(engine: *mut crypto_engine, req: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xilinx_aes_fallback_crypt(req: *mut aead_request, encrypt: bool) -> c_int {
    ...
    aead_request_set_callback(subreq, req.base.flags, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn zynqmp_aes_aead_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn versal_aes_aead_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn zynqmp_aes_aead_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xilinx_paes_aead_init(aead: *mut crypto_aead) -> c_int {
    ...
    tfm_ctx.keylen = 0;
    tfm_ctx.key = core::ptr::null_mut();
    tfm_ctx.fbk_cipher = core::ptr::null_mut();
    crypto_aead_set_reqsize(aead, sizeof(struct xilinx_aead_req_ctx));
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn versal_aes_aead_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xilinx_aes_aead_init(aead: *mut crypto_aead) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xilinx_paes_aead_exit(aead: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn xilinx_aes_aead_exit(aead: *mut crypto_aead) {
...
#[no_mangle]
unsafe extern "C" fn xilinx_aes_aead_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xilinx_aes_aead_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn aes_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn aes_driver_exit() -> void __exit {
