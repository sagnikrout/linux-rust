...
//! Source: drivers/crypto/nx/nx-sha512.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sha512_state_be {
    pub 8]: __be64 state[SHA512_DIGEST_SIZE /,
    pub count: [u64; 2],
}

#[no_mangle]
unsafe extern "C" fn nx_crypto_ctx_sha512_init(tfm: *mut crypto_shash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nx_sha512_init(desc: *mut shash_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nx_sha512_export(desc: *mut shash_desc, out: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nx_sha512_import(desc: *mut shash_desc, in: *const c_void) -> c_int {
