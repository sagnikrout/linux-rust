...
//! Source: drivers/crypto/nx/nx-aes-cbc.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn cbc_aes_nx_encrypt(req: *mut skcipher_request) -> c_int {
    static int cbc_aes_nx_encrypt(struct skcipher_request *req)
    {
    return cbc_aes_nx_crypt(req, 1);
    }
#[no_mangle]
unsafe extern "C" fn cbc_aes_nx_decrypt(req: *mut skcipher_request) -> c_int {
