...
//! Source: drivers/crypto/nx/nx-aes-xcbc.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn nx_xcbc_empty(desc: *mut shash_desc, out: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nx_crypto_ctx_aes_xcbc_init2(tfm: *mut crypto_shash) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nx_xcbc_init(desc: *mut shash_desc) -> c_int {
