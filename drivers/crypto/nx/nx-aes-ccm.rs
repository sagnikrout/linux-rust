...
//! Source: drivers/crypto/nx/nx-aes-ccm.c
#![no_std]
...
unsafe extern "C" fn set_msg_len(block: *mut u8, msglen: c_uint, csize: c_int) -> c_int {
    ...
    csize = 4;
#[no_mangle]
pub unsafe extern "C" fn if(csize)): *mut *mut msglen > (unsigned int)(1 << (8) -> else {
...
// b0 |= 64;
    ...
    let mut iauth_len: c_uint = 0;
    u8 tmp[16], *b1 = core::ptr::null_mut(), *b0 = core::ptr::null_mut(), *result = core::ptr::null_mut();
    int rc;
...
// pointer to an sg list
    ...
    let mut processed: c_uint = 0, to_process;
    processed += iauth_len;
// page_limit: number of sg entries that fit on one page
    ...
    let mut authsize: c_uint = crypto_aead_authsize(crypto_aead_reqtfm(req));
...
#[no_mangle]
unsafe extern "C" fn ccm4309_aes_nx_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccm_aes_nx_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccm4309_aes_nx_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ccm_aes_nx_decrypt(req: *mut aead_request) -> c_int {
