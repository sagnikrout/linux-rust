...
//! Source: drivers/crypto/nx/nx-aes-gcm.c
#![no_std]
...
//
    ...
    let mut nbytes: c_uint = assoclen;
...
#[no_mangle]
unsafe extern "C" fn gmac(req: *mut aead_request, iv: *const u8, assoclen: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcm_empty(req: *mut aead_request, iv: *const u8, enc: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcm_aes_nx_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcm_aes_nx_decrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcm4106_aes_nx_encrypt(req: *mut aead_request) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gcm4106_aes_nx_decrypt(req: *mut aead_request) -> c_int {
