...
//! Source: drivers/crypto/nx/nx-aes-ctr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ctr_aes_nx_crypt(req: *mut skcipher_request, iv: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ctr3686_aes_nx_crypt(req: *mut skcipher_request) -> c_int {
