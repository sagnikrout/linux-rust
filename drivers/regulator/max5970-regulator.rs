...
//! Source: drivers/regulator/max5970-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max5970_regulator {
    pub lim_uA: int num_switches, mon_rng, irng, shunt_micro_ohms,,
...
#[no_mangle]
unsafe extern "C" fn max5970_read_adc(regmap: *mut regmap, reg: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max597x_uvp_ovp_check_mode(rdev: *mut regulator_dev, severity: c_int) -> c_int {
...
// Check soft straps match requested mode
    ...
    let mut channel: c_int = rdev_get_id(rdev);
    if (overvoltage) {
...
#[no_mangle]
unsafe extern "C" fn max597x_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max597x_regulator_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct regulator_dev **rdevs = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(i2c->dev.of_node, _arg: "maxim, _arg: max5970")) -> else {
    ...
    &max5970_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwmon_dev)) {
