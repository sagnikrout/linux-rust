...
//! Source: drivers/regulator/tps6594-regulator.c
#![no_std]
...
pub const BUCK_NB: c_int = 5;
pub const LDO_NB: c_int = 4;
pub const MULTI_PHASE_NB: c_int = 4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6594_regulator_irq_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6594_regulator_irq_data {
    pub dev: *mut device,
    pub type: *const tps6594_regulator_irq_type,
    pub rdev: *mut regulator_dev,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6594_ext_regulator_irq_data {
    pub dev: *mut device,
    pub type: *const tps6594_regulator_irq_type,
}
...
// Buck configuration for TPS65224
    ...
    TPS6594_REG_BUCKX_CTRL(0),
    TPS6594_BIT_BUCK_EN, 0, 0, bucks_ranges,
    4, 4000, 0, core::ptr::null_mut(), 0, 0),
    ...
    1, 0, 0, core::ptr::null_mut(), 0, TPS6594_BIT_LDO_BYPASS),
...
#[no_mangle]
unsafe extern "C" fn tps6594_regulator_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// This is the timeout interrupt no specific regulator
    ...
    irq_data.type.event, core::ptr::null_mut());
    return IRQ_HANDLED;
    }
    ...
    error = devm_request_threaded_irq(tps.dev, irq, core::ptr::null_mut(),
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6594_regulator_desc {
    pub multi_phase_regs: *const regulator_desc,
    pub num_multi_phase_regs: c_uint,
    pub buck_regs: *const regulator_desc,
    pub num_buck_regs: c_int,
    pub ldo_regs: *const regulator_desc,
    pub num_ldo_regs: c_int,
    pub bucks_irq_types: *const tps6594_regulator_irq_type,
    pub ldos_irq_types: *const tps6594_regulator_irq_type,
    pub num_irq_types: c_int,
    pub ext_irq_types: *const tps6594_regulator_irq_type,
    pub num_ext_irqs: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn tps6594_regulator_probe(pdev: *mut platform_device) -> c_int {
    static int tps6594_regulator_probe(struct platform_device *pdev)
    {
    struct tps6594 *tps = dev_get_drvdata(pdev.dev.parent);
    struct regulator_dev *rdev;
    struct device_node *np = core::ptr::null_mut();
    struct device_node *np_pmic_parent = core::ptr::null_mut();
