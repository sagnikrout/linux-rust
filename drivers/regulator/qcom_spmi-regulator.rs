...
//! Source: drivers/regulator/qcom_spmi-regulator.c
#![no_std]
...
pub const SPMI_REGULATOR_PIN_CTRL_ENABLE_NONE: c_uint = 0x00;
pub const SPMI_REGULATOR_PIN_CTRL_ENABLE_EN0: c_uint = 0x01;
pub const SPMI_REGULATOR_PIN_CTRL_ENABLE_EN1: c_uint = 0x02;
pub const SPMI_REGULATOR_PIN_CTRL_ENABLE_EN2: c_uint = 0x04;
pub const SPMI_REGULATOR_PIN_CTRL_ENABLE_EN3: c_uint = 0x08;
pub const SPMI_REGULATOR_PIN_CTRL_ENABLE_HW_DEFAULT: c_uint = 0x10;
// Pin control high power mode input pins.
pub const SPMI_REGULATOR_PIN_CTRL_HPM_NONE: c_uint = 0x00;
pub const SPMI_REGULATOR_PIN_CTRL_HPM_EN0: c_uint = 0x01;
pub const SPMI_REGULATOR_PIN_CTRL_HPM_EN1: c_uint = 0x02;
pub const SPMI_REGULATOR_PIN_CTRL_HPM_EN2: c_uint = 0x04;
pub const SPMI_REGULATOR_PIN_CTRL_HPM_EN3: c_uint = 0x08;
pub const SPMI_REGULATOR_PIN_CTRL_HPM_SLEEP_B: c_uint = 0x10;
pub const SPMI_REGULATOR_PIN_CTRL_HPM_HW_DEFAULT: c_uint = 0x20;
//
// Used with enable parameters to specify that hardware default register values
// should be left unaltered.
//
pub const SPMI_REGULATOR_USE_HW_DEFAULT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spmi_regulator_init_data {
    pub pin_ctrl_enable: unsigned,
    pub pin_ctrl_hpm: unsigned,
    pub vs_soft_start_strength: enum spmi_vs_soft_start_str,
}
...
pub const SPMI_COMMON_ENABLE_MASK: c_uint = 0x80;
pub const SPMI_COMMON_ENABLE: c_uint = 0x80;
pub const SPMI_COMMON_DISABLE: c_uint = 0x00;
pub const SPMI_COMMON_ENABLE_FOLLOW_HW_EN3_MASK: c_uint = 0x08;
pub const SPMI_COMMON_ENABLE_FOLLOW_HW_EN2_MASK: c_uint = 0x04;
pub const SPMI_COMMON_ENABLE_FOLLOW_HW_EN1_MASK: c_uint = 0x02;
pub const SPMI_COMMON_ENABLE_FOLLOW_HW_EN0_MASK: c_uint = 0x01;
pub const SPMI_COMMON_ENABLE_FOLLOW_ALL_MASK: c_uint = 0x0f;
// Common regulator mode register layout
pub const SPMI_COMMON_MODE_HPM_MASK: c_uint = 0x80;
pub const SPMI_COMMON_MODE_AUTO_MASK: c_uint = 0x40;
pub const SPMI_COMMON_MODE_BYPASS_MASK: c_uint = 0x20;
pub const SPMI_COMMON_MODE_FOLLOW_AWAKE_MASK: c_uint = 0x10;
pub const SPMI_COMMON_MODE_FOLLOW_HW_EN3_MASK: c_uint = 0x08;
pub const SPMI_COMMON_MODE_FOLLOW_HW_EN2_MASK: c_uint = 0x04;
pub const SPMI_COMMON_MODE_FOLLOW_HW_EN1_MASK: c_uint = 0x02;
pub const SPMI_COMMON_MODE_FOLLOW_HW_EN0_MASK: c_uint = 0x01;
pub const SPMI_COMMON_MODE_FOLLOW_ALL_MASK: c_uint = 0x1f;
pub const SPMI_FTSMPS426_MODE_BYPASS_MASK: c_int = 3;
pub const SPMI_FTSMPS426_MODE_RETENTION_MASK: c_int = 4;
pub const SPMI_FTSMPS426_MODE_LPM_MASK: c_int = 5;
pub const SPMI_FTSMPS426_MODE_AUTO_MASK: c_int = 6;
pub const SPMI_FTSMPS426_MODE_HPM_MASK: c_int = 7;
pub const SPMI_FTSMPS426_MODE_MASK: c_uint = 0x07;
// Third common regulator mode register values
pub const SPMI_HFSMPS_MODE_BYPASS_MASK: c_int = 2;
pub const SPMI_HFSMPS_MODE_RETENTION_MASK: c_int = 3;
pub const SPMI_HFSMPS_MODE_LPM_MASK: c_int = 4;
pub const SPMI_HFSMPS_MODE_AUTO_MASK: c_int = 6;
pub const SPMI_HFSMPS_MODE_HPM_MASK: c_int = 7;
pub const SPMI_HFSMPS_MODE_MASK: c_uint = 0x07;
// Common regulator pull down control register layout
pub const SPMI_COMMON_PULL_DOWN_ENABLE_MASK: c_uint = 0x80;
// LDO regulator current limit control register layout
pub const SPMI_LDO_CURRENT_LIMIT_ENABLE_MASK: c_uint = 0x80;
// LDO regulator soft start control register layout
pub const SPMI_LDO_SOFT_START_ENABLE_MASK: c_uint = 0x80;
// VS regulator over current protection control register layout
pub const SPMI_VS_OCP_OVERRIDE: c_uint = 0x01;
pub const SPMI_VS_OCP_NO_OVERRIDE: c_uint = 0x00;
// VS regulator soft start control register layout
pub const SPMI_VS_SOFT_START_ENABLE_MASK: c_uint = 0x80;
pub const SPMI_VS_SOFT_START_SEL_MASK: c_uint = 0x03;
// Boost regulator current limit control register layout
pub const SPMI_BOOST_CURRENT_LIMIT_ENABLE_MASK: c_uint = 0x80;
pub const SPMI_BOOST_CURRENT_LIMIT_MASK: c_uint = 0x07;
pub const SPMI_VS_OCP_DEFAULT_MAX_RETRIES: c_int = 10;
pub const SPMI_VS_OCP_DEFAULT_RETRY_DELAY_MS: c_int = 30;
pub const SPMI_VS_OCP_FALL_DELAY_US: c_int = 90;
pub const SPMI_VS_OCP_FAULT_DELAY_US: c_int = 20000;
pub const SPMI_FTSMPS_STEP_CTRL_STEP_MASK: c_uint = 0x18;
pub const SPMI_FTSMPS_STEP_CTRL_STEP_SHIFT: c_int = 3;
pub const SPMI_FTSMPS_STEP_CTRL_DELAY_MASK: c_uint = 0x07;
pub const SPMI_FTSMPS_STEP_CTRL_DELAY_SHIFT: c_int = 0;
// Clock rate in kHz of the FTSMPS regulator reference clock.
pub const SPMI_FTSMPS_CLOCK_RATE: c_int = 19200;
// Minimum voltage stepper delay for each step.
pub const SPMI_FTSMPS_STEP_DELAY: c_int = 8;
pub const SPMI_DEFAULT_STEP_DELAY: c_int = 20;
//
// The ratio SPMI_FTSMPS_STEP_MARGIN_NUM/SPMI_FTSMPS_STEP_MARGIN_DEN is used to
// adjust the step rate in order to account for oscillator variance.
//
pub const SPMI_FTSMPS_STEP_MARGIN_NUM: c_int = 4;
pub const SPMI_FTSMPS_STEP_MARGIN_DEN: c_int = 5;
// slew_rate has units of uV/us.
pub const SPMI_HFSMPS_SLEW_RATE_38p4: c_int = 38400;
pub const SPMI_FTSMPS426_STEP_CTRL_DELAY_MASK: c_uint = 0x03;
pub const SPMI_FTSMPS426_STEP_CTRL_DELAY_SHIFT: c_int = 0;
// Clock rate in kHz of the FTSMPS426 regulator reference clock.
pub const SPMI_FTSMPS426_CLOCK_RATE: c_int = 4800;
pub const SPMI_HFS430_CLOCK_RATE: c_int = 1600;
// Minimum voltage stepper delay for each step.
pub const SPMI_FTSMPS426_STEP_DELAY: c_int = 2;
//
...
//
pub const SPMI_FTSMPS426_STEP_MARGIN_NUM: c_int = 10;
pub const SPMI_FTSMPS426_STEP_MARGIN_DEN: c_int = 11;
// VSET value to decide the range of ULT SMPS
pub const ULT_SMPS_RANGE_SPLIT: c_uint = 0x60;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spmi_voltage_range {
    pub min_uV: c_int,
    pub max_uV: c_int,
    pub step_uV: c_int,
    pub set_point_min_uV: c_int,
    pub set_point_max_uV: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spmi_voltage_set_points {
    pub range: *const spmi_voltage_range,
    pub count: c_int,
    pub n_voltages: unsigned,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spmi_regulator {
    pub desc: regulator_desc,
    pub dev: *mut device,
    pub ocp_work: delayed_work,
    pub regmap: *mut regmap,
    pub set_points: *mut spmi_voltage_set_points,
    pub logical_type: enum spmi_regulator_logical_type,
    pub ocp_irq: c_int,
    pub ocp_count: c_int,
    pub ocp_max_retries: c_int,
    pub ocp_retry_delay_ms: c_int,
    pub hpm_min_load: c_int,
    pub slew_rate: c_int,
    pub vs_enable_time: ktime_t,
    pub base: u16,
    pub node: list_head,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spmi_regulator_mapping {
    pub type: enum spmi_regulator_type,
    pub subtype: enum spmi_regulator_subtype,
    pub logical_type: enum spmi_regulator_logical_type,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct spmi_regulator_data {
    pub name: *const c_char,
    pub base: u16,
    pub supply: *const c_char,
    pub ocp: *const c_char,
    pub force_type: u16,
}
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_vs_enable(rdev: *mut regulator_dev) -> c_int {
    ...
    {
    struct spmi_regulator *vreg = rdev_get_drvdata(rdev);
    let mut reg: u8 = SPMI_VS_OCP_OVERRIDE;
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_common_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_ftsmps426_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_single_range_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_ult_lo_smps_get_voltage(rdev: *mut regulator_dev) -> c_int {
    ...
    {
    struct spmi_regulator *vreg = rdev_get_drvdata(rdev);
    let mut mask: u8 = SPMI_COMMON_MODE_BYPASS_MASK;
    let mut val: u8 = 0;
    if (enable)
    val = mask;
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_common_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_ftsmps426_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_hfsmps_get_mode(rdev: *mut regulator_dev) -> c_uint {
    ...
    {
    struct spmi_regulator *vreg = rdev_get_drvdata(rdev);
    let mut mask: u8 = SPMI_COMMON_MODE_HPM_MASK | SPMI_COMMON_MODE_AUTO_MASK;
    u8 val;
    switch (mode) {
    ...
    {
    struct spmi_regulator *vreg = rdev_get_drvdata(rdev);
    let mut mask: u8 = SPMI_FTSMPS426_MODE_MASK;
    u8 val;
    switch (mode) {
    case REGULATOR_MODE_NORMAL:
    ...
    {
    struct spmi_regulator *vreg = rdev_get_drvdata(rdev);
    let mut mask: u8 = SPMI_HFSMPS_MODE_MASK;
    u8 val;
    switch (mode) {
    case REGULATOR_MODE_NORMAL:
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_common_set_pull_down(rdev: *mut regulator_dev) -> c_int {
    static int spmi_regulator_common_set_pull_down(struct regulator_dev *rdev)
    {
    struct spmi_regulator *vreg = rdev_get_drvdata(rdev);
    let mut mask: c_uint = SPMI_COMMON_PULL_DOWN_ENABLE_MASK;
    return spmi_vreg_update_bits(vreg, SPMI_COMMON_REG_PULL_DOWN,
    mask, mask);
    }
#[no_mangle]
unsafe extern "C" fn spmi_regulator_hfsmps_set_pull_down(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_common_set_soft_start(rdev: *mut regulator_dev) -> c_int {
    static int spmi_regulator_common_set_soft_start(struct regulator_dev *rdev)
    {
    struct spmi_regulator *vreg = rdev_get_drvdata(rdev);
    let mut mask: c_uint = SPMI_LDO_SOFT_START_ENABLE_MASK;
    return spmi_vreg_update_bits(vreg, SPMI_COMMON_REG_SOFT_START,
    mask, mask);
    }
#[no_mangle]
unsafe extern "C" fn spmi_regulator_set_ilim(rdev: *mut regulator_dev, ilim_uA: c_int) -> c_int {
    static int spmi_regulator_set_ilim(struct regulator_dev *rdev, int ilim_uA)
    {
    struct spmi_regulator *vreg = rdev_get_drvdata(rdev);
    let mut type: enum spmi_regulator_logical_type = vreg.logical_type;
    unsigned int current_reg;
    u8 reg;
    u8 mask = SPMI_BOOST_CURRENT_LIMIT_MASK |
    SPMI_BOOST_CURRENT_LIMIT_ENABLE_MASK;
    let mut max: c_int = (SPMI_BOOST_CURRENT_LIMIT_MASK + 1) * 500;
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_vs_clear_ocp(vreg: *mut spmi_regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_vs_ocp_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_vs_ocp_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
pub const SAW3_VCTL_DATA_MASK: c_uint = 0xFF;
pub const SAW3_VCTL_CLEAR_MASK: c_uint = 0x700FF;
pub const SAW3_AVS_CTL_EN_MASK: c_uint = 0x1;
pub const SAW3_AVS_CTL_TGGL_MASK: c_uint = 0x8000000;
pub const SAW3_AVS_CTL_CLEAR_MASK: c_uint = 0x7efc00;
    static struct regmap *saw_regmap;
#[no_mangle]
unsafe extern "C" fn spmi_saw_set_vdd(data: *mut c_void) {
    static void spmi_saw_set_vdd(void *data)
    {
    u32 vctl, data3, avs_ctl, pmic_sts;
    let mut avs_enabled: bool = false;
    unsigned long timeout;
    let mut voltage_sel: u8 = *(u8 *)data;
...
// Always do the SAW register writes on the first CPU
    ...
    let mut spmi_saw_ops: static struct regulator_ops = {};
...
#[no_mangle]
unsafe extern "C" fn spmi_calculate_num_voltages(points: *mut spmi_voltage_set_points) {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_match(vreg: *mut spmi_regulator, force_type: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_init_slew_rate(vreg: *mut spmi_regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_init_slew_rate_hfsmps(vreg: *mut spmi_regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spmi_regulator_of_map_mode(mode: c_uint) -> c_uint {
    ...
    {
    let mut data: spmi_regulator_init_data = { };
...
// l4 is unaccessible on PM660
    ...
    { "s1", 0x1400, "vdd_s1", },
    { "s2", 0x1700, "vdd_s2", core::ptr::null_mut(), 0x1c08 },
    { "s3", 0x1a00, "vdd_s3", },
    { "s4", 0x1d00, "vdd_s4", core::ptr::null_mut(), 0x1c08 },
    { "s5", 0x2000, "vdd_s5", core::ptr::null_mut(), 0x1c08 },
    { "s6", 0x2300, "vdd_s6", core::ptr::null_mut(), 0x1c08 },
    { "s7", 0x2600, "vdd_s7", core::ptr::null_mut(), 0x1c08 },
    { "s8", 0x2900, "vdd_s8", core::ptr::null_mut(), 0x1c08 },
    { }
    };
    ...
    { "l5", 0x4400, "vdd_l5_l7", core::ptr::null_mut(), 0x0410 },
    { "l6", 0x4500, "vdd_l6_l12_l14_l15", },
    { "l7", 0x4600, "vdd_l5_l7", core::ptr::null_mut(), 0x0410 },
...
#[no_mangle]
unsafe extern "C" fn qcom_spmi_regulator_probe(pdev: *mut platform_device) -> c_int {
