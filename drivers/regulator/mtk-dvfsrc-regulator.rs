...
//! Source: drivers/regulator/mtk-dvfsrc-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dvfsrc_regulator_pdata {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_cmd(rdev_id: c_int, cmd: *mut enum mtk_dvfsrc_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dvfsrc_vcore_regulator_probe(pdev: *mut platform_device) -> c_int {
