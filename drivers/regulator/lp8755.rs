...
//! Source: drivers/regulator/lp8755.c
#![no_std]
...
pub const LP8755_REG_BUCK0: c_uint = 0x00;
pub const LP8755_REG_BUCK1: c_uint = 0x03;
pub const LP8755_REG_BUCK2: c_uint = 0x04;
pub const LP8755_REG_BUCK3: c_uint = 0x01;
pub const LP8755_REG_BUCK4: c_uint = 0x05;
pub const LP8755_REG_BUCK5: c_uint = 0x02;
pub const LP8755_REG_MAX: c_uint = 0xFF;

pub const LP8755_BUCK_LINEAR_OUT_MAX: c_uint = 0x76;
pub const LP8755_BUCK_VOUT_M: c_uint = 0x7F;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp8755_mphase {
    pub nreg: c_int,
    pub buck_num: [c_int; LP8755_BUCK_MAX],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct lp8755_chip {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub pdata: *mut lp8755_platform_data,
    pub irq: c_int,
    pub irqmask: c_uint,
    pub mphase: c_int,
    pub rdev: [*mut regulator_dev; LP8755_BUCK_MAX],
}

#[no_mangle]
unsafe extern "C" fn lp8755_buck_enable_time(rdev: *mut regulator_dev) -> c_int {
    static int lp8755_buck_enable_time(struct regulator_dev *rdev)
    {
    int ret;
    unsigned int regval;
    let mut id: enum lp8755_bucks = rdev_get_id(rdev);
...
#[no_mangle]
unsafe extern "C" fn lp8755_buck_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
    static int lp8755_buck_set_mode(struct regulator_dev *rdev, unsigned int mode)
    {
    int ret;
    let mut regbval: c_uint = 0x0;
    let mut id: enum lp8755_bucks = rdev_get_id(rdev);
...
#[no_mangle]
unsafe extern "C" fn lp8755_buck_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
// Macro flag: #define lp8755_buck_init(_id)\
    {\
    .constraints = {\
...
#[no_mangle]
unsafe extern "C" fn lp8755_init_data(pchip: *mut lp8755_chip) -> c_int {
...
// Macro flag: #define lp8755_buck_desc(_id)\
    {\
    .name = lp8755_rail(_id),\
    .id   = LP8755_BUCK##_id,\
    .ops  = &lp8755_buck_ops,\
...
#[no_mangle]
unsafe extern "C" fn lp8755_regulator_init(pchip: *mut lp8755_chip) -> c_int {
    static int lp8755_regulator_init(struct lp8755_chip *pchip)
    {
    int ret, icnt, buck_num;
    struct lp8755_platform_data *pdata = pchip.pdata;
    let mut rconfig: regulator_config = { };
    ...
    pchip.rdev[buck_num] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lp8755_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
// sent power fault detection event to specific regulator
    ...
    && (pchip.rdev[icnt] != core::ptr::null_mut())) {
...
// send OCP event to all regulator devices
    ...
    for (icnt = 0; icnt < LP8755_BUCK_MAX; icnt++)
    if (pchip.rdev[icnt] != core::ptr::null_mut()) {
    regulator_notifier_call_chain(pchip.rdev[icnt],
    LP8755_EVENT_OCP,
    core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn lp8755_int_config(pchip: *mut lp8755_chip) -> c_int {
    ...
    return devm_request_threaded_irq(pchip.dev, pchip.irq, core::ptr::null_mut(),
    lp8755_irq_handler,
...
#[no_mangle]
unsafe extern "C" fn lp8755_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp8755_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn lp8755_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lp8755_exit() -> void __exit {
