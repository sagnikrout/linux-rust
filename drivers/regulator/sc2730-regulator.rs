...
//! Source: drivers/regulator/sc2730-regulator.c
#![no_std]
...
//
pub const SC2730_REGULATOR_BASE: c_uint = 0x1800;
//
// SC2730 regulator lock register
//
pub const SC2730_WR_UNLOCK_VALUE: c_uint = 0x6e7f;
...
#[no_mangle]
unsafe extern "C" fn sc2730_regulator_unlock(regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sc2730_regulator_probe(pdev: *mut platform_device) -> c_int {
