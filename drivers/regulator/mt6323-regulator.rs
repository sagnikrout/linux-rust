...
//! Source: drivers/regulator/mt6323-regulator.c
#![no_std]
...
pub const MT6323_LDO_MODE_NORMAL: c_int = 0;
pub const MT6323_LDO_MODE_LP: c_int = 1;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6323_regulator_info {
...
#[no_mangle]
unsafe extern "C" fn mt6323_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6323_ldo_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6323_ldo_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6323_set_buck_vosel_reg(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6323_regulator_probe(pdev: *mut platform_device) -> c_int {
