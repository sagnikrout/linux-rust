...
//! Source: drivers/regulator/pca9450-regulator.c
#![no_std]
...
pub struct pca9450 {
    ...
    pub type: enum pca9450_chip_type,
    pub rcnt: c_uint,
    pub irq: c_int,
    pub sd_vsel_fixed_low: bool,
    pub default_t_off_deb: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn pca9450_ldo5_get_reg_voltage_sel(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pca9450_ldo5_get_voltage_sel_regmap(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9450_ldo5_set_voltage_sel_regmap(rdev: *mut regulator_dev, sel: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pca9450_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pca9450_buck_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
    static int pca9450_buck_set_mode(struct regulator_dev *rdev, unsigned int mode)
    {
...
#[no_mangle]
unsafe extern "C" fn pca9450_buck_get_mode(rdev: *mut regulator_dev) -> c_uint {
    static unsigned int pca9450_buck_get_mode(struct regulator_dev *rdev)
    {
    const struct pca9450_regulator_desc *desc = container_of_const(rdev.desc,
    struct pca9450_regulator_desc, desc);
    const struct pc9450_dvs_config *dvs = &desc.dvs;
    let mut ret: c_int = 0, regval;
...
#[no_mangle]
unsafe extern "C" fn pca9450_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pca9450_i2c_restart_handler(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9450_of_init(pca9450: *mut pca9450) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pca9450_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
// Check your board and dts for match the right pmic
    ...
    if (pca9450.irq) {
    ret = devm_request_threaded_irq(pca9450.dev, pca9450.irq, core::ptr::null_mut(),
    pca9450_irq_handler,
