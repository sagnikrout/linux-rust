...
//! Source: drivers/regulator/s2mpa01.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2mpa01_info {
    pub ramp_delay24: c_int,
    pub ramp_delay3: c_int,
    pub ramp_delay5: c_int,
    pub ramp_delay16: c_int,
    pub ramp_delay7: c_int,
    pub ramp_delay8910: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn s2mpa01_set_ramp_delay(rdev: *mut regulator_dev, ramp_delay: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2mpa01_pmic_probe(pdev: *mut platform_device) -> c_int {
