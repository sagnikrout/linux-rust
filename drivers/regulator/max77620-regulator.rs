...
//! Source: drivers/regulator/max77620-regulator.c
#![no_std]
...
// Power Mode
pub const MAX77620_POWER_MODE_NORMAL: c_int = 3;
pub const MAX77620_POWER_MODE_LPM: c_int = 2;
pub const MAX77620_POWER_MODE_GLPM: c_int = 1;
pub const MAX77620_POWER_MODE_DISABLE: c_int = 0;
// SD Slew Rate
pub const MAX77620_SD_SR_13_75: c_int = 0;
pub const MAX77620_SD_SR_27_5: c_int = 1;
pub const MAX77620_SD_SR_55: c_int = 2;
pub const MAX77620_SD_SR_100: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_regulator_info {
    pub type: u8,
    pub fps_addr: u8,
    pub volt_addr: u8,
    pub cfg_addr: u8,
    pub power_mode_mask: u8,
    pub power_mode_shift: u8,
    pub remote_sense_addr: u8,
    pub remote_sense_mask: u8,
    pub desc: regulator_desc,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_regulator_pdata {
    pub active_fps_src: c_int,
    pub active_fps_pd_slot: c_int,
    pub active_fps_pu_slot: c_int,
    pub suspend_fps_src: c_int,
    pub suspend_fps_pd_slot: c_int,
    pub suspend_fps_pu_slot: c_int,
    pub current_mode: c_int,
    pub power_ok: c_int,
    pub ramp_rate_setting: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77620_regulator {
    pub dev: *mut device,
    pub rmap: *mut regmap,
    pub rinfo: [*mut max77620_regulator_info; MAX77620_NUM_REGS],
    pub reg_pdata: [max77620_regulator_pdata; MAX77620_NUM_REGS],
    pub enable_power_mode: [c_int; MAX77620_NUM_REGS],
    pub current_power_mode: [c_int; MAX77620_NUM_REGS],
    pub active_fps_src: [c_int; MAX77620_NUM_REGS],
}
    ...
    let mut pu: c_int = rpdata.active_fps_pu_slot;
    let mut pd: c_int = rpdata.active_fps_pd_slot;
    let mut ret: c_int = 0;
    if (!rinfo)
    return 0;
    if (is_suspend) {
...
// FPS power down period setting
    ...
    {
    struct max77620_regulator_info *rinfo = pmic.rinfo[id];
    let mut mask: u8 = rinfo.power_mode_mask;
    let mut shift: u8 = rinfo.power_mode_shift;
    u8 addr;
    int ret;
    switch (rinfo.type) {
...
#[no_mangle]
unsafe extern "C" fn max77620_read_slew_rate(pmic: *mut max77620_regulator, id: c_int) -> c_int {
    ...
    val = 0;
#[no_mangle]
pub unsafe extern "C" fn if(27500: slew_rate <=) -> else {
    else if (slew_rate <= 27500)
    val = 1;
#[no_mangle]
pub unsafe extern "C" fn if(55000: slew_rate <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn max77620_config_power_ok(pmic: *mut max77620_regulator, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_init_pmic(pmic: *mut max77620_regulator, id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
    static unsigned int max77620_regulator_get_mode(struct regulator_dev *rdev)
    {
    struct max77620_regulator *pmic = rdev_get_drvdata(rdev);
    let mut id: c_int = rdev_get_id(rdev);
    struct max77620_regulator_info *rinfo = pmic.rinfo[id];
    let mut fpwm: c_int = 0;
    int ret;
...
pub const MAX77620_SD_CNF2_ROVS_EN_NONE: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn max77620_regulator_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_regulator_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77620_regulator_resume(dev: *mut device) -> c_int {
