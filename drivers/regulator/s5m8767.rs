...
//! Source: drivers/regulator/s5m8767.c
#![no_std]
...
pub const S5M8767_OPMODE_NORMAL_MODE: c_uint = 0x1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s5m8767_info {
    pub dev: *mut device,
    pub iodev: *mut sec_pmic_dev,
    pub num_regulators: c_int,
    pub opmode: *mut sec_opmode_data,
    pub ramp_delay: c_int,
    pub buck2_ramp: bool,
    pub buck3_ramp: bool,
    pub buck4_ramp: bool,
    ...
    pub buck3_vol: [u8; 8],
    pub buck4_vol: [u8; 8],
    pub buck_gpios: [*mut gpio_desc; 3],
    pub buck_ds: [*mut gpio_desc; 3],
    pub buck_gpioindex: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sec_voltage_desc {
    pub max: c_int,
    pub min: c_int,
    pub step: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn s5m8767_get_vsel_reg(reg_id: c_int, s5m8767: *mut s5m8767_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn s5m8767_set_high(s5m8767: *mut s5m8767_info) -> c_int {
    static inline int s5m8767_set_high(struct s5m8767_info *s5m8767)
    {
    let mut temp_index: c_int = s5m8767.buck_gpioindex;
...
#[no_mangle]
pub unsafe extern "C" fn s5m8767_set_low(s5m8767: *mut s5m8767_info) -> c_int {
    ...
    let mut reg_id: c_int = rdev_get_id(rdev);
    int old_index, index = 0;
    u8 *buck234_vol = core::ptr::null_mut();
    switch (reg_id) {
...
#[no_mangle]
pub unsafe extern "C" fn if(s5m8767->buck3_gpiodvs: reg_id == S5M8767_BUCK3 &&) -> else {
    else if (reg_id == S5M8767_BUCK3 && s5m8767.buck3_gpiodvs)
    buck234_vol = &s5m8767.buck3_vol[0];
#[no_mangle]
pub unsafe extern "C" fn if(s5m8767->buck4_gpiodvs: reg_id == S5M8767_BUCK4 &&) -> else {
...
// count the number of regulators to be supported in pmic
    ...
    rdata.ext_control_gpiod = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn s5m8767_pmic_probe(pdev: *mut platform_device) -> c_int {
...
// Initialize GPIO DVS registers
    ...
    let mut id: c_uint = pdata.regulators[i].id;
