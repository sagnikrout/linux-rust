...
//! Source: drivers/regulator/bd71828-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd71828_regulator_data {
    pub desc: regulator_desc,
    pub dvs: rohm_dvs_config,
    pub reg_inits: *const reg_init,
    pub reg_init_amnt: c_int,
}
...
pub const BD72720_BUCK10_DESC_INDEX: c_int = 9;
pub const BD72720_NUM_BUCK_VOLTS: c_uint = 0x100;
pub const BD72720_NUM_LDO_VOLTS: c_uint = 0x100;
pub const BD72720_NUM_LDO12346_VOLTS: c_uint = 0x80;
...
unsafe extern "C" fn bd71828_probe(pdev: *mut platform_device) -> c_int {
    ...
    config.regmap = dev_get_regmap(pdev.dev.parent, core::ptr::null_mut());
    if (!config.regmap)
    return -ENODEV;
    switch (chip) {
