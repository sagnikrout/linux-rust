...
//! Source: drivers/regulator/max8973-regulator.c
#![no_std]
...
pub const MAX8973_VOUT: c_uint = 0x0;
pub const MAX8973_VOUT_DVS: c_uint = 0x1;
pub const MAX8973_CONTROL1: c_uint = 0x2;
pub const MAX8973_CONTROL2: c_uint = 0x3;
pub const MAX8973_CHIPID1: c_uint = 0x4;
pub const MAX8973_CHIPID2: c_uint = 0x5;
pub const MAX8973_MAX_VOUT_REG: c_int = 2;
// MAX8973_VOUT

pub const MAX8973_VOUT_MASK: c_uint = 0x7F;
// MAX8973_VOUT_DVS
pub const MAX8973_DVS_VOUT_MASK: c_uint = 0x7F;
// MAX8973_CONTROL1

pub const MAX8973_RAMP_12mV_PER_US: c_uint = 0x0;
pub const MAX8973_RAMP_25mV_PER_US: c_uint = 0x1;
pub const MAX8973_RAMP_50mV_PER_US: c_uint = 0x2;
pub const MAX8973_RAMP_200mV_PER_US: c_uint = 0x3;
pub const MAX8973_RAMP_MASK: c_uint = 0x3;
// MAX8973_CONTROL2

pub const MAX8973_CKKADV_TRIP_MASK: c_uint = 0xC;
pub const MAX8973_CKKADV_TRIP_DISABLE: c_uint = 0xC;
pub const MAX8973_CKKADV_TRIP_75mV_PER_US: c_uint = 0x0;
pub const MAX8973_CKKADV_TRIP_150mV_PER_US: c_uint = 0x4;
pub const MAX8973_CKKADV_TRIP_75mV_PER_US_HIST_DIS: c_uint = 0x8;
pub const MAX8973_CONTROL_CLKADV_TRIP_MASK: c_uint = 0x00030000;
pub const MAX8973_INDUCTOR_MIN_30_PER: c_uint = 0x0;
pub const MAX8973_INDUCTOR_NOMINAL: c_uint = 0x1;
pub const MAX8973_INDUCTOR_PLUS_30_PER: c_uint = 0x2;
pub const MAX8973_INDUCTOR_PLUS_60_PER: c_uint = 0x3;
pub const MAX8973_CONTROL_INDUCTOR_VALUE_MASK: c_uint = 0x00300000;
pub const MAX8973_MIN_VOLATGE: c_int = 606250;
pub const MAX8973_MAX_VOLATGE: c_int = 1400000;
pub const MAX8973_VOLATGE_STEP: c_int = 6250;
pub const MAX8973_BUCK_N_VOLTAGE: c_uint = 0x80;

pub const MAX77621_NORMAL_OPERATING_TEMP: c_int = 100000;
pub const MAX77621_TJINT_WARNING_TEMP_120: c_int = 120000;
pub const MAX77621_TJINT_WARNING_TEMP_140: c_int = 140000;
    enum device_id {
    MAX8973,
    MAX77621
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max8973_chip {
    pub dev: *mut device,
    pub desc: regulator_desc,
    pub regmap: *mut regmap,
    pub enable_external_control: bool,
    pub dvs_gpiod: *mut gpio_desc,
    pub lru_index: [c_int; MAX8973_MAX_VOUT_REG],
    pub curr_vout_val: [c_int; MAX8973_MAX_VOUT_REG],
    pub curr_vout_reg: c_int,
    pub curr_gpio_val: c_int,
    pub ops: regulator_ops,
    pub id: enum device_id,
    pub junction_temp_warning: c_int,
    pub irq: c_int,
...
//
    ...
    let mut new_vout_reg: c_int = tps.lru_index[MAX8973_MAX_VOUT_REG - 1];
    let mut found_index: c_int = MAX8973_MAX_VOUT_REG - 1;
...
#[no_mangle]
unsafe extern "C" fn max8973_dcdc_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
    ...
    int ret;
    let mut found: bool = false;
    let mut vout_reg: c_int = max.curr_vout_reg;
    let mut gpio_val: c_int = max.curr_gpio_val;
//
...
#[no_mangle]
unsafe extern "C" fn max8973_dcdc_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8973_dcdc_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(12000000: max_ua <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn max8973_get_current_limit(rdev: *mut regulator_dev) -> c_int {
    ...
    {
    int ret;
    let mut control1: u8 = 0;
    let mut control2: u8 = 0;
    unsigned int data;
    ret = regmap_read(max.regmap, MAX8973_CONTROL1, &data);
    if (ret < 0) {
    dev_err(max.dev, "register %d read failed, err = %d",
...
#[no_mangle]
unsafe extern "C" fn max8973_thermal_read_temp(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8973_thermal_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max8973_thermal_init(mchip: *mut max8973_chip) -> c_int {
    ...
    ret = devm_request_threaded_irq(mchip.dev, mchip.irq, core::ptr::null_mut(),
    max8973_thermal_irq,
...
#[no_mangle]
unsafe extern "C" fn max8973_probe(client: *mut i2c_client) -> c_int {
    ...
    let mut pdata_from_dt: bool = false;
...
#[no_mangle]
unsafe extern "C" fn max8973_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max8973_cleanup() -> void __exit {
