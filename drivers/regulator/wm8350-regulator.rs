...
//! Source: drivers/regulator/wm8350-regulator.c
#![no_std]
...
pub const WM8350_DCDC_MAX_VSEL: c_uint = 0x66;
// Microamps
...
#[no_mangle]
unsafe extern "C" fn wm8350_isink_enable(rdev: *mut regulator_dev) -> c_int {
    static int wm8350_isink_enable(struct regulator_dev *rdev)
    {
    struct wm8350 *wm8350 = rdev_get_drvdata(rdev);
    let mut isink: c_int = rdev_get_id(rdev);
    switch (isink) {
    case WM8350_ISINK_A:
...
#[no_mangle]
unsafe extern "C" fn wm8350_isink_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_isink_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_isink_enable_time(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_dcdc_set_suspend_voltage(rdev: *mut regulator_dev, uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_dcdc_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_dcdc_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_dcdc25_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_dcdc25_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_ldo_set_suspend_voltage(rdev: *mut regulator_dev, uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_ldo_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_ldo_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wm8350_ldo_set_slot(wm8350: *mut wm8350, ldo: c_int, start: u16, stop: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn force_continuous_enable(wm8350: *mut wm8350, dcdc: c_int, enable: c_int) -> c_int {
    static int force_continuous_enable(struct wm8350 *wm8350, int dcdc, int enable)
    {
    let mut reg: c_int = 0, ret;
    switch (dcdc) {
    case WM8350_DCDC_1:
...
#[no_mangle]
unsafe extern "C" fn wm8350_dcdc_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_dcdc_get_mode(rdev: *mut regulator_dev) -> c_uint {
    static unsigned int wm8350_dcdc_get_mode(struct regulator_dev *rdev)
    {
    struct wm8350 *wm8350 = rdev_get_drvdata(rdev);
    let mut dcdc: c_int = rdev_get_id(rdev);
    u16 mask, sleep, active, force;
    let mut mode: c_int = REGULATOR_MODE_NORMAL;
    int reg;
    switch (dcdc) {
    case WM8350_DCDC_1:
    reg = WM8350_DCDC1_FORCE_PWM;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sleep) -> else {
    else if (sleep)
    mode = REGULATOR_MODE_STANDBY;
    return mode;
    }
#[no_mangle]
unsafe extern "C" fn wm8350_ldo_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm8350_dcdc_efficiency {
    pub uA_load_min: c_int,
    pub uA_load_max: c_int,
    pub mode: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn get_mode(uA: c_int, eff: *const wm8350_dcdc_efficiency) -> c_uint {
...
//
    ...
    int output_uA)
    {
    let mut dcdc: c_int = rdev_get_id(rdev), mode;
    switch (dcdc) {
    case WM8350_DCDC_1:
    case WM8350_DCDC_6:
...
#[no_mangle]
unsafe extern "C" fn pmic_uv_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm8350_regulator_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm8350_regulator_remove(pdev: *mut platform_device) {
    ...
    wm8350.pmic.pdev[reg] = core::ptr::null_mut();
    }
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn wm8350_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wm8350_regulator_exit() -> void __exit {
