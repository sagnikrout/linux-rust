...
//! Source: drivers/regulator/max77503-regulator.c
#![no_std]
...
pub const MAX77503_REG_CFG: c_uint = 0x00;
pub const MAX77503_REG_VOUT: c_uint = 0x01;

pub const MAX77503_AD_ENABLED: c_uint = 0x1;
pub const MAX77503_AD_DISABLED: c_uint = 0x0;
...
#[no_mangle]
unsafe extern "C" fn max77503_regulator_probe(client: *mut i2c_client) -> c_int {
