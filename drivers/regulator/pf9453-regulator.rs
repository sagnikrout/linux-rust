...
//! Source: drivers/regulator/pf9453-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pf9453_dvs_config {
    pub /: *mut *mut unsigned int run_reg; / dvs0,
    pub run_mask: c_uint,
    pub /: *mut *mut unsigned int standby_reg; / dvs1,
    pub standby_mask: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pf9453_regulator_desc {
    pub desc: regulator_desc,
    pub dvs: pf9453_dvs_config,
}
...
pub struct pf9453 {
    ...
    pub sd_vsel_gpio: *mut gpio_desc,
    pub irq: c_int,
}
...
pub const PF9453_BUCK1_VOLTAGE_NUM: c_uint = 0x80;
pub const PF9453_BUCK2_VOLTAGE_NUM: c_uint = 0x80;
pub const PF9453_BUCK3_VOLTAGE_NUM: c_uint = 0x80;
pub const PF9453_BUCK4_VOLTAGE_NUM: c_uint = 0x80;
pub const PF9453_LDO1_VOLTAGE_NUM: c_uint = 0x65;
pub const PF9453_LDO2_VOLTAGE_NUM: c_uint = 0x3b;
pub const PF9453_LDOSNVS_VOLTAGE_NUM: c_uint = 0x59;
    enum {
...
pub const PF9453_UNLOCK_KEY: c_uint = 0x5c;
pub const PF9453_LOCK_KEY: c_uint = 0x0;
// PF9453 BUCK ENMODE bits
pub const BUCK_ENMODE_OFF: c_uint = 0x00;
pub const BUCK_ENMODE_ONREQ: c_uint = 0x01;
pub const BUCK_ENMODE_ONREQ_STBY: c_uint = 0x02;
pub const BUCK_ENMODE_ONREQ_STBY_DPSTBY: c_uint = 0x03;
// PF9453 BUCK ENMODE bits
pub const LDO_ENMODE_OFF: c_uint = 0x00;
pub const LDO_ENMODE_ONREQ: c_uint = 0x01;
pub const LDO_ENMODE_ONREQ_STBY: c_uint = 0x02;
pub const LDO_ENMODE_ONREQ_STBY_DPSTBY: c_uint = 0x03;
...
// PF9453_REG_IRQ bits
pub const IRQ_RSVD: c_uint = 0x80;
pub const IRQ_RSTB: c_uint = 0x40;
pub const IRQ_ONKEY: c_uint = 0x20;
pub const IRQ_RESETKEY: c_uint = 0x10;
pub const IRQ_VR_FLT1: c_uint = 0x08;
pub const IRQ_LOWVSYS: c_uint = 0x04;
pub const IRQ_THERM_100: c_uint = 0x02;
pub const IRQ_THERM_80: c_uint = 0x01;
// PF9453_REG_RESET_CTRL bits

pub const WDOG_B_CFG_NONE: c_uint = 0x00;
pub const WDOG_B_CFG_WARM: c_uint = 0x40;
pub const WDOG_B_CFG_COLD: c_uint = 0x80;
...
#[no_mangle]
unsafe extern "C" fn is_reg_protect(reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn pf9453_pmic_write(pf9453: *mut pf9453, reg: c_uint, mask: u8, val: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pf9453_regulator_enable_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pf9453_regulator_disable_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pf9453_regulator_set_voltage_sel_regmap(rdev: *mut regulator_dev, sel: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pf9453_regulator_set_ramp_delay_regmap(rdev: *mut regulator_dev, ramp_delay: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf9453_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pf9453_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
// Check your board and dts for match the right pmic
    ...
    ret = devm_request_threaded_irq(pf9453.dev, pf9453.irq, core::ptr::null_mut(), pf9453_irq_handler,
