...
//! Source: drivers/regulator/scmi-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_regulator {
    pub id: u32,
    pub sdev: *mut scmi_device,
    pub ph: *mut scmi_protocol_handle,
    pub rdev: *mut regulator_dev,
    pub of_node: *mut device_node,
    pub desc: regulator_desc,
    pub conf: regulator_config,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct scmi_regulator_info {
    pub num_doms: c_int,
    pub sregv: *mut scmi_regulator,
}

#[no_mangle]
unsafe extern "C" fn scmi_reg_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_reg_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_reg_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_reg_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_regulator_common_init(sreg: *mut scmi_regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_regulator_probe(sdev: *mut scmi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn scmi_regulator_remove(sdev: *mut scmi_device) {
