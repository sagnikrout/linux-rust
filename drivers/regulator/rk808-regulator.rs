...
//! Source: drivers/regulator/rk808-regulator.c
#![no_std]
...
// Field definitions
pub const RK801_BUCK_VSEL_MASK: c_uint = 0x7f;
pub const RK801_LDO_VSEL_MASK: c_uint = 0x3f;
pub const RK808_BUCK_VSEL_MASK: c_uint = 0x3f;
pub const RK808_BUCK4_VSEL_MASK: c_uint = 0xf;
pub const RK808_LDO_VSEL_MASK: c_uint = 0x1f;
pub const RK809_BUCK5_VSEL_MASK: c_uint = 0x7;
pub const RK817_LDO_VSEL_MASK: c_uint = 0x7f;
pub const RK817_BOOST_VSEL_MASK: c_uint = 0x7;
pub const RK817_BUCK_VSEL_MASK: c_uint = 0x7f;
pub const RK818_BUCK_VSEL_MASK: c_uint = 0x3f;
pub const RK818_BUCK4_VSEL_MASK: c_uint = 0x1f;
pub const RK818_LDO_VSEL_MASK: c_uint = 0x1f;
pub const RK818_LDO3_ON_VSEL_MASK: c_uint = 0xf;
pub const RK818_BOOST_ON_VSEL_MASK: c_uint = 0xe0;
pub const RK806_DCDC_SLP_REG_OFFSET: c_uint = 0x0A;
pub const RK806_NLDO_SLP_REG_OFFSET: c_uint = 0x05;
pub const RK806_PLDO_SLP_REG_OFFSET: c_uint = 0x06;
pub const RK806_BUCK_SEL_CNT: c_uint = 0xff;
pub const RK806_LDO_SEL_CNT: c_uint = 0xff;
// Ramp rate definitions for buck1 / buck2 only
pub const RK808_RAMP_RATE_OFFSET: c_int = 3;

// Offset from XXX_ON_VSEL to XXX_SLP_VSEL
pub const RK808_SLP_REG_OFFSET: c_int = 1;
// Offset from XXX_ON_VSEL to XXX_DVS_VSEL
pub const RK808_DVS_REG_OFFSET: c_int = 2;
// Offset from XXX_EN_REG to SLEEP_SET_OFF_XXX
pub const RK808_SLP_SET_OFF_REG_OFFSET: c_int = 2;
// max steps for increase voltage of Buck1/2, equal 100mv
pub const MAX_STEPS_ONE_TIME: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rk808_regulator_data {
    pub dvs_gpio: [*mut gpio_desc; 2],
}
...
pub const RK817_BUCK1_MIN0: c_int = 500000;
pub const RK817_BUCK1_MAX0: c_int = 1500000;
pub const RK817_BUCK1_MIN1: c_int = 1600000;
pub const RK817_BUCK1_MAX1: c_int = 2400000;
pub const RK817_BUCK3_MAX1: c_int = 3400000;
pub const RK817_BUCK1_STP0: c_int = 12500;
pub const RK817_BUCK1_STP1: c_int = 100000;
...
#[no_mangle]
unsafe extern "C" fn rk806_set_mode_dcdc(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
    static int rk806_set_mode_dcdc(struct regulator_dev *rdev, unsigned int mode)
    {
    let mut rid: c_uint = rdev_get_id(rdev);
...
#[no_mangle]
unsafe extern "C" fn rk806_get_mode_dcdc(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rk806_set_ramp_delay_dcdc(rdev: *mut regulator_dev, ramp_delay: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk806_set_suspend_voltage_range(rdev: *mut regulator_dev, reg_offset: c_int, uv: c_int) -> c_int {
    static int rk806_set_suspend_voltage_range(struct regulator_dev *rdev, int reg_offset, int uv)
    {
    let mut sel: c_int = regulator_map_voltage_linear_range(rdev, uv, uv);
    unsigned int reg;
    if (sel < 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn rk806_set_suspend_voltage_range_dcdc(rdev: *mut regulator_dev, uv: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk806_set_suspend_voltage_range_nldo(rdev: *mut regulator_dev, uv: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk806_set_suspend_voltage_range_pldo(rdev: *mut regulator_dev, uv: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk808_buck1_2_get_voltage_sel_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
    ...
    let mut id: c_int = rdev_get_id(rdev);
    struct gpio_desc *gpio = pdata.dvs_gpio[id];
    let mut reg: c_uint = rdev.desc.vsel_reg;
    unsigned old_sel;
    int ret, gpio_level;
    if (!gpio)
...
#[no_mangle]
unsafe extern "C" fn rk808_set_suspend_voltage(rdev: *mut regulator_dev, uv: c_int) -> c_int {
    static int rk808_set_suspend_voltage(struct regulator_dev *rdev, int uv)
    {
    unsigned int reg;
    let mut sel: c_int = regulator_map_voltage_linear(rdev, uv, uv);
    if (sel < 0)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn rk808_set_suspend_voltage_range(rdev: *mut regulator_dev, uv: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk805_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk805_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk806_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk806_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk808_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk808_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk816_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk816_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
    ...
    id_slp = id;
#[no_mangle]
pub unsafe extern "C" fn if(RK817_ID_LDO8: id >= RK817_ID_LDO1 && id <=) -> else {
    else if (id >= RK817_ID_LDO1 && id <= RK817_ID_LDO8)
    id_slp = 8 + (id - RK817_ID_LDO1);
#[no_mangle]
pub unsafe extern "C" fn if(RK809_ID_SW2: id >= RK817_ID_LDO9 && id <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn rk817_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
    static int rk817_set_suspend_enable(struct regulator_dev *rdev)
    {
    return rk817_set_suspend_enable_ctrl(rdev, 1);
    }
#[no_mangle]
unsafe extern "C" fn rk817_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
    static int rk817_set_suspend_disable(struct regulator_dev *rdev)
    {
    return rk817_set_suspend_enable_ctrl(rdev, 0);
    }
#[no_mangle]
unsafe extern "C" fn rk8xx_set_suspend_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk8xx_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk8xx_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rk8xx_is_enabled_wmsk_regmap(rdev: *mut regulator_dev) -> c_int {
...
// add write mask bit
    ...
    if (rdev.desc.enable_val)
    let mut val: return = = rdev.desc.enable_val;
    return val != 0;
    }
#[no_mangle]
unsafe extern "C" fn rk8xx_regulator_of_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rk801_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rk801_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
    static int rk801_set_mode(struct regulator_dev *rdev, unsigned int mode)
    {
    let mut offset: c_uint = rdev.desc.id;
    switch (mode) {
    case REGULATOR_MODE_FAST:
...
#[no_mangle]
unsafe extern "C" fn rk801_set_suspend_voltage(rdev: *mut regulator_dev, uv: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk801_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk801_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk808_regulator_probe(pdev: *mut platform_device) -> c_int {
