...
//! Source: drivers/regulator/tps6507x-regulator.c
#![no_std]
...
// DCDC's
pub const TPS6507X_DCDC_1: c_int = 0;
pub const TPS6507X_DCDC_2: c_int = 1;
pub const TPS6507X_DCDC_3: c_int = 2;
// LDOs
pub const TPS6507X_LDO_1: c_int = 3;
pub const TPS6507X_LDO_2: c_int = 4;

// Number of step-down converters available
pub const TPS6507X_NUM_DCDC: c_int = 3;
// Number of LDO voltage regulators  available
pub const TPS6507X_NUM_LDO: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps6507x_pmic {
    pub desc: [regulator_desc; TPS6507X_NUM_REGULATOR],
    pub mfd: *mut tps6507x_dev,
    pub info: [*mut tps_info; TPS6507X_NUM_REGULATOR],
    pub io_lock: mutex,
}

#[no_mangle]
pub unsafe extern "C" fn tps6507x_pmic_read(tps: *mut tps6507x_pmic, reg: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn tps6507x_pmic_write(tps: *mut tps6507x_pmic, reg: u8, val: u8) -> c_int {
    static inline int tps6507x_pmic_write(struct tps6507x_pmic *tps, u8 reg, u8 val)
    {
    return tps.mfd.write_dev(tps.mfd, reg, 1, &val);
    }
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_set_bits(tps: *mut tps6507x_pmic, reg: u8, mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_clear_bits(tps: *mut tps6507x_pmic, reg: u8, mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_reg_read(tps: *mut tps6507x_pmic, reg: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_reg_write(tps: *mut tps6507x_pmic, reg: u8, val: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_is_enabled(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_enable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_disable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_get_voltage_sel(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_probe(pdev: *mut platform_device) -> c_int {
    static int tps6507x_pmic_probe(struct platform_device *pdev)
    {
    struct tps6507x_dev *tps6507x_dev = dev_get_drvdata(pdev.dev.parent);
    struct tps_info *info = &tps6507x_pmic_regs[0];
    let mut config: regulator_config = { };
    struct regulator_init_data *init_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps6507x_pmic_cleanup() -> void __exit {
