...
//! Source: drivers/regulator/qcom-rpmh-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct resource_name_formats {
    pub rsc_name_fmt: *const c_char,
    pub rsc_name_fmt1: *const c_char,
}
...
pub const RPMH_REGULATOR_REG_VRM_VOLTAGE: c_uint = 0x0;

pub const RPMH_REGULATOR_REG_ENABLE: c_uint = 0x4;

pub const RPMH_REGULATOR_REG_VRM_MODE: c_uint = 0x8;

pub const PMIC4_LDO_MODE_RETENTION: c_int = 4;
pub const PMIC4_LDO_MODE_LPM: c_int = 5;
pub const PMIC4_LDO_MODE_HPM: c_int = 7;
pub const PMIC4_SMPS_MODE_RETENTION: c_int = 4;
pub const PMIC4_SMPS_MODE_PFM: c_int = 5;
pub const PMIC4_SMPS_MODE_AUTO: c_int = 6;
pub const PMIC4_SMPS_MODE_PWM: c_int = 7;
pub const PMIC4_BOB_MODE_PASS: c_int = 0;
pub const PMIC4_BOB_MODE_PFM: c_int = 1;
pub const PMIC4_BOB_MODE_AUTO: c_int = 2;
pub const PMIC4_BOB_MODE_PWM: c_int = 3;
pub const PMIC5_LDO_MODE_RETENTION: c_int = 3;
pub const PMIC5_LDO_MODE_LPM: c_int = 4;
pub const PMIC5_LDO_MODE_HPM: c_int = 7;
pub const PMIC5_SMPS_MODE_RETENTION: c_int = 3;
pub const PMIC5_SMPS_MODE_PFM: c_int = 4;
pub const PMIC5_SMPS_MODE_AUTO: c_int = 6;
pub const PMIC5_SMPS_MODE_PWM: c_int = 7;
pub const PMIC5_BOB_MODE_PASS: c_int = 2;
pub const PMIC5_BOB_MODE_PFM: c_int = 4;
pub const PMIC5_BOB_MODE_AUTO: c_int = 6;
pub const PMIC5_BOB_MODE_PWM: c_int = 7;
pub const PMIC530_LDO_MODE_RETENTION: c_int = 3;
pub const PMIC530_LDO_MODE_LPM: c_int = 4;
pub const PMIC530_LDO_MODE_OPM: c_int = 5;
pub const PMIC530_LDO_MODE_HPM: c_int = 7;
pub const PMIC_ID_LEN: c_int = 4;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmh_vreg_hw_data {
    pub regulator_type: enum rpmh_regulator_type,
    pub ops: *const regulator_ops,
    pub voltage_ranges: *const linear_range,
    pub n_linear_ranges: c_int,
    pub n_voltages: c_int,
    pub hpm_min_load_uA: c_int,
    pub pmic_bypass_mode: c_int,
    pub pmic_mode_map: *const c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmh_vreg {
    pub dev: *mut device,
    pub addr: u32,
    pub rdesc: regulator_desc,
    pub hw_data: *const rpmh_vreg_hw_data,
    pub always_wait_for_ack: bool,
    pub enabled: c_int,
    pub bypassed: bool,
    pub voltage_selector: c_int,
    pub mode: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpmh_vreg_init_data {
    pub name: *const c_char,
    pub vreg_hw_type: enum regulator_hw_type,
    pub index: c_int,
...
#[no_mangle]
unsafe extern "C" fn _rpmh_regulator_vrm_get_voltage(rdev: *mut regulator_dev, uV: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_vrm_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_enable(rdev: *mut regulator_dev) -> c_int {
    static int rpmh_regulator_enable(struct regulator_dev *rdev)
    {
    return rpmh_regulator_set_enable_state(rdev, true);
    }
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_vrm_get_pmic_mode(vreg: *mut rpmh_vreg, pmic_mode: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_vrm_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
//
    ...
    {
    let mut reg_config: regulator_config = {};
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_determine_initial_mode(vreg: *mut rpmh_vreg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_pmic4_ldo_of_map_mode(rpmh_mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_pmic530_ldo_of_map_mode(rpmh_mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_pmic4_bob_of_map_mode(rpmh_mode: c_uint) -> c_uint {
...
// LVS hardware does not support voltage or mode configuration.
    ...
    RPMH_VREG("smps1",  SMPS, 1,  &pmic5_ftsmps510, core::ptr::null_mut()),
    RPMH_VREG("smps2",  SMPS, 2,  &pmic5_hfsmps510, core::ptr::null_mut()),
// smps3 - smps5 not configured
    RPMH_VREG("ldo1",   LDO,  1,  &pmic5_nldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo2",   LDO,  2,  &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo3",   LDO,  3,  &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo4",   LDO,  4,  &pmic5_nldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo5",   LDO,  5,  &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo6",   LDO,  6,  &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo7",   LDO,  7,  &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo8",   LDO,  8,  &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo9",   LDO,  9,  &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo10",  LDO,  10, &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo11",  LDO,  11, &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo12",  LDO,  12, &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo13",  LDO,  13, &pmic5_nldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo14",  LDO,  14, &pmic5_pldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo15",  LDO,  15, &pmic5_nldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo16",  LDO,  16, &pmic5_nldo,      core::ptr::null_mut()),
// ldo17 not configured
    RPMH_VREG("ldo18",  LDO,  18, &pmic5_nldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo19",  LDO,  19, &pmic5_nldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo20",  LDO,  20, &pmic5_nldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo21",  LDO,  21, &pmic5_nldo,      core::ptr::null_mut()),
    RPMH_VREG("ldo22",  LDO,  22, &pmic5_nldo,      core::ptr::null_mut()),
    };
...
#[no_mangle]
unsafe extern "C" fn rpmh_regulator_probe(pdev: *mut platform_device) -> c_int {
