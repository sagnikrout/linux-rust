...
//! Source: drivers/regulator/mt6357-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6357_regulator_info {
...
//
#[no_mangle]
unsafe extern "C" fn mt6357_get_buck_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6357_regulator_probe(pdev: *mut platform_device) -> c_int {
