...
//! Source: drivers/regulator/qcom_rpm-regulator.c
#![no_std]
...
pub const MAX_REQUEST_LEN: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct request_member {
    pub word: c_int,
    pub mask: c_uint,
    pub shift: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpm_reg_parts {
    pub /: *mut *mut request_member mV; / used if voltage is in mV,
    pub /: *mut *mut request_member uV; / used if voltage is in uV,
    pub /: *mut *mut request_member ip; / peak current in mA,
    pub /: *mut *mut request_member pd; / pull down enable,
    pub /: *mut *mut request_member ia; / average current in mA,
    pub /: *mut *mut request_member fm; / force mode,
    pub /: *mut *mut request_member pm; / power mode,
    pub /: *mut *mut request_member pc; / pin control,
    pub /: *mut *mut request_member pf; / pin function,
    pub /: *mut *mut request_member enable_state; / NCP and switch,
    pub /: *mut *mut request_member comp_mode; / NCP,
    pub /: *mut *mut request_member freq; / frequency: NCP and SMPS,
    pub /: *mut *mut request_member freq_clk_src; / clock source: SMPS,
    pub /: *mut *mut request_member hpm; / switch: control OCP and SS,
    pub request_len: c_int,
}

    (((reg).parts.fm.mask >> (reg).parts.fm.shift) == 3)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_rpm_reg {
    pub rpm: *mut qcom_rpm,
    pub lock: mutex,
    pub dev: *mut device,
    pub desc: regulator_desc,
    pub parts: *const rpm_reg_parts,
    pub resource: c_int,
    pub val: [u32; MAX_REQUEST_LEN],
    pub uV: c_int,
    pub is_enabled: c_int,
    pub supports_force_mode_auto: bool,
    pub supports_force_mode_bypass: bool,
}
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_mV_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_uV_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_switch_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_mV_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_uV_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_switch_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_set_load(rdev: *mut regulator_dev, load_uA: c_int) -> c_int {
    static int rpm_reg_set_load(struct regulator_dev *rdev, int load_uA)
    {
    struct qcom_rpm_reg *vreg = rdev_get_drvdata(rdev);
    const struct rpm_reg_parts *parts = vreg.parts;
    const struct request_member *req = &parts.ia;
    let mut load_mA: c_int = load_uA / 1000;
    let mut max_mA: c_int = req.mask >> req.shift;
    int ret;
    if (req.mask == 0)
    return -EINVAL;
    if (load_mA > max_mA)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpm_regulator_data {
    pub name: *const c_char,
    pub resource: c_int,
    pub template: *const qcom_rpm_reg,
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_exit() -> void __exit {
