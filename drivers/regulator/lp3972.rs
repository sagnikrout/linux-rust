...
//! Source: drivers/regulator/lp3972.c
#![no_std]
...
pub const LP3972_SCR_REG: c_uint = 0x07;
pub const LP3972_OVER1_REG: c_uint = 0x10;
pub const LP3972_OVSR1_REG: c_uint = 0x11;
pub const LP3972_OVER2_REG: c_uint = 0x12;
pub const LP3972_OVSR2_REG: c_uint = 0x13;
pub const LP3972_VCC1_REG: c_uint = 0x20;
pub const LP3972_ADTV1_REG: c_uint = 0x23;
pub const LP3972_ADTV2_REG: c_uint = 0x24;
pub const LP3972_AVRC_REG: c_uint = 0x25;
pub const LP3972_CDTC1_REG: c_uint = 0x26;
pub const LP3972_CDTC2_REG: c_uint = 0x27;
pub const LP3972_SDTV1_REG: c_uint = 0x29;
pub const LP3972_SDTV2_REG: c_uint = 0x2A;
pub const LP3972_MDTV1_REG: c_uint = 0x32;
pub const LP3972_MDTV2_REG: c_uint = 0x33;
pub const LP3972_L2VCR_REG: c_uint = 0x39;
pub const LP3972_L34VCR_REG: c_uint = 0x3A;
pub const LP3972_SCR1_REG: c_uint = 0x80;
pub const LP3972_SCR2_REG: c_uint = 0x81;
pub const LP3972_OEN3_REG: c_uint = 0x82;
pub const LP3972_OSR3_REG: c_uint = 0x83;
pub const LP3972_LOER4_REG: c_uint = 0x84;
pub const LP3972_B2TV_REG: c_uint = 0x85;
pub const LP3972_B3TV_REG: c_uint = 0x86;
pub const LP3972_B32RC_REG: c_uint = 0x87;
pub const LP3972_ISRA_REG: c_uint = 0x88;
pub const LP3972_BCCR_REG: c_uint = 0x89;
pub const LP3972_II1RR_REG: c_uint = 0x8E;
pub const LP3972_II2RR_REG: c_uint = 0x8F;

// System control register 1 initial value,
// bits 5, 6 and 7 are EPROM programmable
pub const SYS_CONTROL1_INIT_VAL: c_uint = 0x02;
pub const SYS_CONTROL1_INIT_MASK: c_uint = 0x1F;

pub const LP3972_VOL_CHANGE_FLAG_GO: c_uint = 0x01;
pub const LP3972_VOL_CHANGE_FLAG_MASK: c_uint = 0x03;
...
pub const LP3972_BUCK_VOL_MASK: c_uint = 0x1f;
...
#[no_mangle]
unsafe extern "C" fn lp3972_reg_read(lp3972: *mut lp3972, reg: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn lp3972_set_bits(lp3972: *mut lp3972, reg: u8, mask: u16, val: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3972_ldo_is_enabled(dev: *mut regulator_dev) -> c_int {
    static int lp3972_ldo_is_enabled(struct regulator_dev *dev)
    {
    struct lp3972 *lp3972 = rdev_get_drvdata(dev);
    let mut ldo: c_int = rdev_get_id(dev) - LP3972_LDO1;
    let mut mask: u16 = LP3972_LDO_OUTPUT_ENABLE_MASK(ldo);
    u16 val;
    val = lp3972_reg_read(lp3972, LP3972_LDO_OUTPUT_ENABLE_REG(ldo));
    return !!(val & mask);
    }
#[no_mangle]
unsafe extern "C" fn lp3972_ldo_enable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3972_ldo_disable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3972_ldo_get_voltage_sel(dev: *mut regulator_dev) -> c_int {
    static int lp3972_ldo_get_voltage_sel(struct regulator_dev *dev)
    {
    struct lp3972 *lp3972 = rdev_get_drvdata(dev);
    let mut ldo: c_int = rdev_get_id(dev) - LP3972_LDO1;
    let mut mask: u16 = LP3972_LDO_VOL_MASK(ldo);
    u16 val, reg;
...
#[no_mangle]
unsafe extern "C" fn lp3972_dcdc_is_enabled(dev: *mut regulator_dev) -> c_int {
    static int lp3972_dcdc_is_enabled(struct regulator_dev *dev)
    {
    struct lp3972 *lp3972 = rdev_get_drvdata(dev);
    let mut buck: c_int = rdev_get_id(dev) - LP3972_DCDC1;
    let mut mask: u16 = 1 << (buck * 2);
    u16 val;
    val = lp3972_reg_read(lp3972, LP3972_BUCK_VOL_ENABLE_REG(buck));
    return !!(val & mask);
    }
#[no_mangle]
unsafe extern "C" fn lp3972_dcdc_enable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3972_dcdc_disable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3972_dcdc_get_voltage_sel(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3972_i2c_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3972_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn lp3972_module_exit() -> void __exit {
