...
//! Source: drivers/regulator/max14577-regulator.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn max14577_reg_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_reg_get_current_limit(rdev: *mut regulator_dev) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77836_ldo {
    pub max14577: *mut max14577,
    pub mode: c_uint,
}

#[no_mangle]
unsafe extern "C" fn max77836_ldo_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77836_ldo_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77836_ldo_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn max77836_ldo_of_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn max14577_regulator_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut dev_type: enum maxim_device_type = max14577.dev_type;
    switch (dev_type) {
    case MAXIM_DEVICE_TYPE_MAX77836:
...
#[no_mangle]
unsafe extern "C" fn max14577_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max14577_regulator_exit() -> void __exit {
