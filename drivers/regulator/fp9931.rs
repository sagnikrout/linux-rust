...
//! Source: drivers/regulator/fp9931.c
#![no_std]
...
pub const FP9931_REG_TMST_VALUE: c_int = 0;
pub const FP9931_REG_VCOM_SETTING: c_int = 1;
pub const FP9931_REG_VPOSNEG_SETTING: c_int = 2;
pub const FP9931_REG_PWRON_DELAY: c_int = 3;
pub const FP9931_REG_CONTROL_REG1: c_int = 11;
pub const PGOOD_TIMEOUT_MSECS: c_int = 200;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fp9931_data {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub vin_reg: *mut regulator,
    pub pgood_gpio: *mut gpio_desc,
    pub en_gpio: *mut gpio_desc,
    pub en_ts_gpio: *mut gpio_desc,
...
#[no_mangle]
unsafe extern "C" fn setup_timings(data: *mut fp9931_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
    static bool fp9931_volatile_reg(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = FP9931_REG_TMST_VALUE;
    }
...
#[no_mangle]
unsafe extern "C" fn disable_nopm(d: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fp9931_v3p3_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_v3p3_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_v3p3_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_check_powergood(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_set_voltage_sel(rdev: *mut regulator_dev, selector: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_set_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_clear_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fp9931_probe(client: *mut i2c_client) -> c_int {
    ...
    &fp9931_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwmon_dev))
    ...
    SET_RUNTIME_PM_OPS(fp9931_runtime_suspend, fp9931_runtime_resume, core::ptr::null_mut())
    };
