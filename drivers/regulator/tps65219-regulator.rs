...
//! Source: drivers/regulator/tps65219-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps65219_regulator_irq_type {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps65219_regulator_irq_data {
    pub dev: *mut device,
    pub type: *mut tps65219_regulator_irq_type,
...
#[no_mangle]
unsafe extern "C" fn tps65219_set_mode(dev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65219_get_mode(dev: *mut regulator_dev) -> c_uint {
...
// Operations permitted on LDO3/4
    ...
    3, 4000, 0, core::ptr::null_mut(), 0, 0),
...
//
    ...
    2, 0, 0, core::ptr::null_mut(), 0, TPS65219_LDOS_BYP_CONFIG_MASK),
...
#[no_mangle]
unsafe extern "C" fn tps65219_regulator_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps65219_chip_data {
    pub rdesc_size: usize,
    pub common_rdesc_size: usize,
    pub dev_irq_size: usize,
    pub common_irq_size: usize,
    pub rdesc: *const regulator_desc,
    pub common_rdesc: *const regulator_desc,
    pub irq_types: *mut tps65219_regulator_irq_type,
    pub common_irq_types: *mut tps65219_regulator_irq_type,
}
...
#[no_mangle]
unsafe extern "C" fn tps65219_regulator_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut chip: enum pmic_id = platform_get_device_id(pdev).driver_data;
...
// Register non-regulator IRQs (TIMEOUT, SENSOR) with rdev=NULL
    ...
    continue;
    error = tps65219_register_irqs(pdev, tps, core::ptr::null_mut(),
    irq_type, 1,
