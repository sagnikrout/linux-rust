...
//! Source: drivers/regulator/mp886x.c
#![no_std]
...
pub const MP886X_VSEL: c_uint = 0x00;

pub const MP886X_SYSCNTLREG1: c_uint = 0x01;

pub const MP886X_SLEW_SHIFT: c_int = 3;

pub const MP8869_SYSCNTLREG2: c_uint = 0x02;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mp886x_cfg_info {
    pub rops: *const regulator_ops,
    pub slew_rates: [c_uint; 8],
    pub switch_freq: [c_int; 4],
    pub fs_reg: u8,
    pub fs_shift: u8,
}
...
#[no_mangle]
unsafe extern "C" fn mp886x_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp886x_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mp8869_set_voltage_sel(rdev: *mut regulator_dev, sel: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mp8869_scale(uv: c_uint, r1: u32, r2: u32) -> c_uint {
    static inline unsigned int mp8869_scale(unsigned int uv, u32 r1, u32 r2)
    {
    let mut tmp: u32 = uv * r1 / r2;
    return uv + tmp;
    }
#[no_mangle]
unsafe extern "C" fn mp8869_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp8867_set_voltage_sel(rdev: *mut regulator_dev, sel: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp8867_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mp886x_i2c_probe(client: *mut i2c_client) -> c_int {
