...
//! Source: drivers/regulator/max77693-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct chg_reg_data {
    pub linear_reg: c_uint,
    pub linear_mask: c_uint,
    pub uA_step: c_uint,
    pub min_sel: c_uint,
}
...
//
#[no_mangle]
unsafe extern "C" fn max77693_chg_get_current_limit(rdev: *mut regulator_dev) -> c_int {
    static int max77693_chg_get_current_limit(struct regulator_dev *rdev)
    {
    const struct chg_reg_data *reg_data = rdev_get_drvdata(rdev);
    let mut chg_min_uA: c_uint = rdev.constraints.min_uA;
    let mut chg_max_uA: c_uint = rdev.constraints.max_uA;
...
#[no_mangle]
unsafe extern "C" fn max77693_pmic_probe(pdev: *mut platform_device) -> c_int {
    static int max77693_pmic_probe(struct platform_device *pdev)
    {
    let mut type: enum max77693_types = platform_get_device_id(pdev).driver_data;
...
#[no_mangle]
unsafe extern "C" fn max77693_pmic_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max77693_pmic_cleanup() -> void __exit {
