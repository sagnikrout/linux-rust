...
//! Source: drivers/regulator/88pm8607.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pm8607_regulator_info {
    pub desc: regulator_desc,
    pub vol_suspend: *mut c_uint,
    pub slope_double: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn pm8607_list_voltage(rdev: *mut regulator_dev, index: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm8607_regulator_probe(pdev: *mut platform_device) -> c_int {
    static int pm8607_regulator_probe(struct platform_device *pdev)
    {
    struct pm860x_chip *chip = dev_get_drvdata(pdev.dev.parent);
    struct pm8607_regulator_info *info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn pm8607_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn pm8607_regulator_exit() -> void __exit {
