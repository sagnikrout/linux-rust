...
//! Source: drivers/regulator/hi6421-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi6421_regulator_pdata {
    pub lock: mutex,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi6421_regulator_info {
    pub desc: regulator_desc,
    pub mode_mask: u8,
    pub eco_microamp: u32,
}
...
#[no_mangle]
unsafe extern "C" fn hi6421_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi6421_regulator_ldo_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hi6421_regulator_buck_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hi6421_regulator_probe(pdev: *mut platform_device) -> c_int {
