...
//! Source: drivers/regulator/mt6315-regulator.c
#![no_std]
...
pub const MT6315_BUCK_MODE_AUTO: c_int = 0;
pub const MT6315_BUCK_MODE_FORCE_PWM: c_int = 1;
pub const MT6315_BUCK_MODE_LP: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6315_regulator_info {
    pub desc: regulator_desc,
    pub status_reg: u32,
    pub lp_mode_mask: u32,
    pub lp_mode_shift: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt_regulator_init_data {
    pub modeset_mask: [u32; MT6315_VBUCK_MAX],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6315_chip {
    pub dev: *mut device,
...
#[no_mangle]
unsafe extern "C" fn mt6315_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6315_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6315_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6315_regulator_probe(pdev: *mut spmi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6315_regulator_shutdown(pdev: *mut spmi_device) {
