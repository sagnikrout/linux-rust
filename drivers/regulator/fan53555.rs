...
//! Source: drivers/regulator/fan53555.c
#![no_std]
...
// Voltage setting
pub const FAN53555_VSEL0: c_uint = 0x00;
pub const FAN53555_VSEL1: c_uint = 0x01;
pub const RK8602_VSEL0: c_uint = 0x06;
pub const RK8602_VSEL1: c_uint = 0x07;
pub const TCS4525_VSEL0: c_uint = 0x11;
pub const TCS4525_VSEL1: c_uint = 0x10;
pub const TCS4525_TIME: c_uint = 0x13;
pub const TCS4525_COMMAND: c_uint = 0x14;
// Control register
pub const FAN53555_CONTROL: c_uint = 0x02;
// IC Type
pub const FAN53555_ID1: c_uint = 0x03;
// IC mask version
pub const FAN53555_ID2: c_uint = 0x04;
// Monitor register
pub const FAN53555_MONITOR: c_uint = 0x05;
// VSEL bit definitions

// Chip ID and Version
pub const DIE_ID: c_uint = 0x0F	/* ID1 */;
pub const DIE_REV: c_uint = 0x0F	/* ID2 */;
// Control bit definitions

pub const FAN53526_NVOLTAGES: c_int = 128;
pub const RK8602_NVOLTAGES: c_int = 160;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fan53555_device_info {
    pub vendor: enum fan53555_vendor,
    pub dev: *mut device,
...
// Voltage setting register
    pub vol_reg: c_uint,
    pub sleep_reg: c_uint,
    pub en_reg: c_uint,
    pub sleep_en_reg: c_uint,
...
// Sleep voltage cache
    pub sleep_vol_cache: c_uint,
// Slew rate
    pub slew_reg: c_uint,
    pub slew_mask: c_uint,
...
#[no_mangle]
unsafe extern "C" fn fan53555_set_suspend_voltage(rdev: *mut regulator_dev, uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan53555_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan53555_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan53555_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan53555_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn fan53526_voltages_setup_fairchild(di: *mut fan53555_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan53555_voltages_setup_fairchild(di: *mut fan53555_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan53555_voltages_setup_rockchip(di: *mut fan53555_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk8602_voltages_setup_rockchip(di: *mut fan53555_device_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fan53555_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn fan53555_voltages_setup_silergy(di: *mut fan53555_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan53526_voltages_setup_tcs(di: *mut fan53555_device_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan53555_device_mode_map_setup(di: *mut fan53555_device_info) {
...
#[no_mangle]
unsafe extern "C" fn fan53555_regulator_probe(client: *mut i2c_client) -> c_int {
