...
//! Source: drivers/regulator/s2mps11.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2mps11_info {
    pub ramp_delay2: c_int,
    pub ramp_delay34: c_int,
    pub ramp_delay5: c_int,
    pub ramp_delay16: c_int,
    pub ramp_delay7810: c_int,
    pub ramp_delay9: c_int,
    pub dev_type: enum sec_device_type,
//
// One bit for each S2MPS11/S2MPS13/S2MPS14/S2MPU02 regulator whether
// the suspend mode was enabled.
//
    pub S2MPS_REGULATOR_MAX): DECLARE_BITMAP(suspend_state,,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct s2mpg10_regulator_desc {
    pub desc: regulator_desc,
// Ramp rate during enable, valid for bucks only.
    pub enable_ramp_rate: c_uint,
// Registers for external control of rail.
    pub pctrlsel_reg: c_uint,
    pub pctrlsel_mask: c_uint,
// Populated from DT.
    pub pctrlsel_val: c_uint,
}

#[no_mangle]
unsafe extern "C" fn get_ramp_delay(ramp_delay: c_int) -> c_int {
    ...
    let mut rdev_id: c_int = rdev_get_id(rdev);
...
#[no_mangle]
unsafe extern "C" fn s2mps11_set_ramp_delay(rdev: *mut regulator_dev, ramp_delay: c_int) -> c_int {
    static int s2mps11_set_ramp_delay(struct regulator_dev *rdev, int ramp_delay)
    {
    struct s2mps11_info *s2mps11 = rdev_get_drvdata(rdev);
    unsigned int ramp_val, ramp_shift, ramp_reg = S2MPS11_REG_RAMP_BUCK;
    let mut ramp_enable: c_uint = 1, enable_shift = 0;
    let mut rdev_id: c_int = rdev_get_id(rdev);
    int ret;
    switch (rdev_id) {
    case S2MPS11_BUCK1:
...
#[no_mangle]
unsafe extern "C" fn s2mps11_regulator_enable(rdev: *mut regulator_dev) -> c_int {
    ...
    val = S2MPS14_ENABLE_SUSPEND;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdev->ena_pin) -> else {
...
#[no_mangle]
unsafe extern "C" fn s2mps11_regulator_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2mpg10_regulator_enable_nop(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2mpg10_regulator_buck_enable_time(rdev: *mut regulator_dev) -> c_int {
    ...
    let mut ops: *const regulator_ops  const = rdev.desc.ops;
    int vsel, curr_uV;
...
#[no_mangle]
unsafe extern "C" fn s2mpu02_set_ramp_delay(rdev: *mut regulator_dev, ramp_delay: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn s2mps11_pmic_probe(pdev: *mut platform_device) -> c_int {
    ...
    const struct s2mpg10_regulator_desc *s2mpg1x_regulators = core::ptr::null_mut();
    ...
    let mut regulators_sz: usize = rdev_num * sizeof(*s2mpg1x_regulators);
