...
//! Source: drivers/regulator/irq_helpers.c
#![no_std]
...
pub const REGULATOR_FORCED_SAFETY_SHUTDOWN_WAIT_MS: c_int = 10000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct regulator_irq {
    pub rdata: regulator_irq_data,
    pub desc: regulator_irq_desc,
    pub irq: c_int,
    pub retry_cnt: c_int,
    pub isr_work: delayed_work,
}
...
//
#[no_mangle]
unsafe extern "C" fn rdev_flag_err(rdev: *mut regulator_dev, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rdev_clear_err(rdev: *mut regulator_dev, err: c_int) {
...
#[no_mangle]
unsafe extern "C" fn regulator_notifier_isr_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn regulator_notifier_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t regulator_notifier_isr(int irq, void *data)
    {
    struct regulator_irq *h = data;
    struct regulator_irq_desc *d;
    struct regulator_irq_data *rid;
    let mut rdev_map: c_ulong = 0;
    int num_rdevs;
    int ret, i;
    d = &h.desc;
    rid = &h.rdata;
...
//
    ...
    stat.notifs);
    regulator_notifier_call_chain(rdev, stat.notifs, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn init_rdev_errors(h: *mut regulator_irq) {
...
//
    ...
    ret = request_threaded_irq(h.irq, core::ptr::null_mut(), regulator_notifier_isr,
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_irq_helper_cancel(handle: *mut c_void) {
...
//
    ...
    {
    let mut err: c_int = rid.states[0].possible_errs;
// dev_mask = 1;
//
