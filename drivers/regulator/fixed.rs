...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fixed_voltage_data {
    pub desc: regulator_desc,
    pub dev: *mut regulator_dev,
    pub enable_clock: *mut clk,
    pub enable_counter: c_uint,
    pub performance_state: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct fixed_dev_type {
    pub has_enable_clock: bool,
    pub has_performance_state: bool,
}

#[no_mangle]
unsafe extern "C" fn reg_clock_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reg_clock_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reg_domain_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reg_domain_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reg_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn reg_fixed_under_voltage_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn reg_fixed_voltage_probe(pdev: *mut platform_device) -> c_int {
    ...
    drvdata.enable_clock = devm_clk_get(dev, core::ptr::null_mut());
...
//
    cfg.ena_gpiod = gpiod_get_optional(&pdev.dev, core::ptr::null_mut(), gflags);
...
#[no_mangle]
unsafe extern "C" fn regulator_fixed_voltage_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn regulator_fixed_voltage_exit() -> void __exit {
