...
//! Source: drivers/regulator/bd96801-regulator.c
#![no_std]
...
pub const BD96801_ALWAYS_ON_REG: c_uint = 0x3c;
pub const BD96801_REG_ENABLE: c_uint = 0x0b;

pub const BD96801_BUCK1_VSEL_REG: c_uint = 0x28;
pub const BD96801_BUCK2_VSEL_REG: c_uint = 0x29;
pub const BD96801_BUCK3_VSEL_REG: c_uint = 0x2a;
pub const BD96801_BUCK4_VSEL_REG: c_uint = 0x2b;
pub const BD96801_LDO5_VSEL_REG: c_uint = 0x25;
pub const BD96801_LDO6_VSEL_REG: c_uint = 0x26;
pub const BD96801_LDO7_VSEL_REG: c_uint = 0x27;
pub const BD96801_BUCK_VSEL_MASK: c_uint = 0x1F;
pub const BD96805_BUCK_VSEL_MASK: c_uint = 0x3f;
pub const BD96801_LDO_VSEL_MASK: c_uint = 0xff;
pub const BD96801_MASK_RAMP_DELAY: c_uint = 0xc0;
pub const BD96801_INT_VOUT_BASE_REG: c_uint = 0x21;
pub const BD96801_BUCK_INT_VOUT_MASK: c_uint = 0xff;
pub const BD96801_BUCK_VOLTS: c_int = 256;
pub const BD96805_BUCK_VOLTS: c_int = 64;
pub const BD96801_LDO_VOLTS: c_int = 256;
pub const BD96801_OVP_MASK: c_uint = 0x03;
pub const BD96801_MASK_BUCK1_OVP_SHIFT: c_uint = 0x00;
pub const BD96801_MASK_BUCK2_OVP_SHIFT: c_uint = 0x02;
pub const BD96801_MASK_BUCK3_OVP_SHIFT: c_uint = 0x04;
pub const BD96801_MASK_BUCK4_OVP_SHIFT: c_uint = 0x06;
pub const BD96801_MASK_LDO5_OVP_SHIFT: c_uint = 0x00;
pub const BD96801_MASK_LDO6_OVP_SHIFT: c_uint = 0x02;
pub const BD96801_MASK_LDO7_OVP_SHIFT: c_uint = 0x04;
pub const BD96801_PROT_LIMIT_OCP_MIN: c_uint = 0x00;
pub const BD96801_PROT_LIMIT_LOW: c_uint = 0x01;
pub const BD96801_PROT_LIMIT_MID: c_uint = 0x02;
pub const BD96801_PROT_LIMIT_HI: c_uint = 0x03;
pub const BD96801_REG_BUCK1_OCP: c_uint = 0x32;
pub const BD96801_REG_BUCK2_OCP: c_uint = 0x32;
pub const BD96801_REG_BUCK3_OCP: c_uint = 0x33;
pub const BD96801_REG_BUCK4_OCP: c_uint = 0x33;
pub const BD96801_MASK_BUCK1_OCP_SHIFT: c_uint = 0x00;
pub const BD96801_MASK_BUCK2_OCP_SHIFT: c_uint = 0x04;
pub const BD96801_MASK_BUCK3_OCP_SHIFT: c_uint = 0x00;
pub const BD96801_MASK_BUCK4_OCP_SHIFT: c_uint = 0x04;
pub const BD96801_REG_LDO5_OCP: c_uint = 0x34;
pub const BD96801_REG_LDO6_OCP: c_uint = 0x34;
pub const BD96801_REG_LDO7_OCP: c_uint = 0x34;
pub const BD96801_MASK_LDO5_OCP_SHIFT: c_uint = 0x00;
pub const BD96801_MASK_LDO6_OCP_SHIFT: c_uint = 0x02;
pub const BD96801_MASK_LDO7_OCP_SHIFT: c_uint = 0x04;

pub const BD96801_NUM_REGULATORS: c_int = 7;
pub const BD96801_NUM_LDOS: c_int = 4;
//
...
pub const BD96801_LDO_SD_VOLT_MASK: c_uint = 0x1;
pub const BD96801_LDO_MODE_MASK: c_uint = 0x6;
pub const BD96801_LDO_MODE_INT: c_uint = 0x0;
pub const BD96801_LDO_MODE_SD: c_uint = 0x2;
pub const BD96801_LDO_MODE_DDR: c_uint = 0x4;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd96801_irqinfo {
    pub type: c_int,
    pub irq_desc: regulator_irq_desc,
    pub err_cfg: c_int,
    pub wrn_cfg: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd96801_irq_desc {
    pub irqinfo: *mut bd96801_irqinfo,
    pub num_irqs: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd96801_regulator_data {
    pub desc: regulator_desc,
    pub init_ranges: *const linear_range,
    pub num_ranges: c_int,
    pub irq_desc: bd96801_irq_desc,
    pub initial_voltage: c_int,
    pub ldo_vol_lvl: c_int,
    pub ldo_errs: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd96801_pmic_data {
    pub regulator_data: [bd96801_regulator_data; BD96801_NUM_REGULATORS],
...
//
    ...
    {
    let mut ret: c_int = 0, sel, initial_uv;
    let mut reg: c_int = BD96801_INT_VOUT_BASE_REG + data.desc.id;
    if (data.num_ranges) {
...
// dev_mask |= BIT(i);
    ...
    REGULATOR_ERROR_FAIL, core::ptr::null_mut(),
    rdev_arr, 1);
    if (IS_ERR(retp))
    return PTR_ERR(retp);
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: iinfo->wrn_cfg) -> else {
...
// Find notifications for this IRQ (WARN/ERR)
    ...
    &iinfo.irq_desc, irq,
    0, err, core::ptr::null_mut(), rdev_arr,
    1);
    if (IS_ERR(retp))
    return PTR_ERR(retp);
    return 0;
...
#[no_mangle]
unsafe extern "C" fn bd96801_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct bd96801_pmic_data *pdata;
    let mut temp_notif_ldos: c_int = 0;
    ...
    return -ENOMEM;
    pdata.regmap = dev_get_regmap(parent, core::ptr::null_mut());
    if (!pdata.regmap) {
