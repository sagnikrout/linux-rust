...
//! Source: drivers/regulator/max8907-regulator.c
#![no_std]
...
pub const MAX8907_II2RR_VERSION_MASK: c_uint = 0xF0;
pub const MAX8907_II2RR_VERSION_REV_A: c_uint = 0x00;
pub const MAX8907_II2RR_VERSION_REV_B: c_uint = 0x10;
pub const MAX8907_II2RR_VERSION_REV_C: c_uint = 0x30;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max8907_regulator {
    pub desc: [regulator_desc; MAX8907_NUM_REGULATORS],
}
...
#[no_mangle]
unsafe extern "C" fn max8907_regulator_parse_dt(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8907_regulator_probe(pdev: *mut platform_device) -> c_int {
    ...
    const char *mbatt_rail_name = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn max8907_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max8907_reg_exit() -> void __exit {
