...
//! Source: drivers/regulator/rtq2208-regulator.c
#![no_std]
...
// Register
pub const RTQ2208_REG_FSOUTB_CNTL: c_uint = 0x11;
pub const RTQ2208_REG_GLOBAL_INT1: c_uint = 0x12;
pub const RTQ2208_REG_FLT_RECORDBUCK_CB: c_uint = 0x18;
pub const RTQ2208_REG_GLOBAL_INT1_MASK: c_uint = 0x1D;
pub const RTQ2208_REG_FLT_MASKBUCK_CB: c_uint = 0x1F;
pub const RTQ2208_REG_BUCK_C_CFG0: c_uint = 0x32;
pub const RTQ2208_REG_BUCK_B_CFG0: c_uint = 0x42;
pub const RTQ2208_REG_BUCK_A_CFG0: c_uint = 0x52;
pub const RTQ2208_REG_BUCK_D_CFG0: c_uint = 0x62;
pub const RTQ2208_REG_BUCK_G_CFG0: c_uint = 0x72;
pub const RTQ2208_REG_BUCK_F_CFG0: c_uint = 0x82;
pub const RTQ2208_REG_BUCK_E_CFG0: c_uint = 0x92;
pub const RTQ2208_REG_BUCK_H_CFG0: c_uint = 0xA2;
pub const RTQ2208_REG_LDO1_CFG: c_uint = 0xB1;
pub const RTQ2208_REG_LDO2_CFG: c_uint = 0xC1;
pub const RTQ2208_REG_LDO_DVS_CTRL: c_uint = 0xD0;
pub const RTQ2208_REG_HIDDEN_BUCKPH: c_uint = 0x55;
pub const RTQ2208_REG_HIDDEN_LDOCFG0: c_uint = 0x8F;
pub const RTQ2208_REG_HIDDEN_LDOCFG1: c_uint = 0x96;
pub const RTQ2208_REG_HIDDEN0: c_uint = 0xFE;
pub const RTQ2208_REG_HIDDEN1: c_uint = 0xFF;
// Mask

// Size
pub const RTQ2208_VOUT_MAXNUM: c_int = 256;
pub const RTQ2208_BUCK_NUM_IRQ_REGS: c_int = 5;
pub const RTQ2208_STS_NUM_IRQ_REGS: c_int = 2;
// Value
pub const RTQ2208_RAMP_VALUE_MIN_uV: c_int = 500;
pub const RTQ2208_RAMP_VALUE_MAX_uV: c_int = 16000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtq2208_regulator_desc {
    pub desc: regulator_desc,
    pub mtp_sel_reg: c_uint,
    pub mtp_sel_mask: c_uint,
    pub mode_reg: c_uint,
    pub mode_mask: c_uint,
    pub suspend_config_reg: c_uint,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtq2208_rdev_map {
    pub rdev: [*mut regulator_dev; RTQ2208_LDO_MAX],
...
#[no_mangle]
unsafe extern "C" fn rtq2208_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtq2208_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rtq2208_set_ramp_delay(rdev: *mut regulator_dev, ramp_delay: c_int) -> c_int {
    static int rtq2208_set_ramp_delay(struct regulator_dev *rdev, int ramp_delay)
    {
    const struct regulator_desc *desc = rdev.desc;
    let mut sel: c_uint = 0, val;
...
#[no_mangle]
unsafe extern "C" fn rtq2208_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtq2208_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtq2208_set_suspend_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtq2208_of_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rtq2208_init_irq_mask(rdev_map: *mut rtq2208_rdev_map, buck_masks: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtq2208_irq_handler(irqno: c_int, devid: *mut c_void) -> irqreturn_t {
    ...
    let mut ret: c_int = 0, i, uv_bit, ov_bit;
...
// uv irq
    ...
    REGULATOR_EVENT_UNDER_VOLTAGE, core::ptr::null_mut());
// ov irq
    ov_bit = uv_bit + 1;
...
// hd irq
    ...
    regulator_notifier_call_chain(rdev,
    REGULATOR_EVENT_OVER_TEMP, core::ptr::null_mut());
    }
    return IRQ_HANDLED;
    }
...
// ldo2_fixed_uV = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: FIELD_GET(RTQ2208_MASK_LDO2_OPT1, _arg: ldo_cfg1)) -> else {
...
#[no_mangle]
unsafe extern "C" fn rtq2208_probe(i2c: *mut i2c_client) -> c_int {
...
// init interrupt mask
    ...
    return ret;
// register interrupt
    return devm_request_threaded_irq(dev, i2c.irq, core::ptr::null_mut(), rtq2208_irq_handler,
