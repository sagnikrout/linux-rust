...
//! Source: drivers/regulator/pf530x-regulator.c
#![no_std]
...
// registers
pub const PF530X_DEVICEID: c_uint = 0x00;
pub const PF530X_REV: c_uint = 0x01;
pub const PF530X_EMREV: c_uint = 0x02;
pub const PF530X_PROGID: c_uint = 0x03;
pub const PF530X_CONFIG1: c_uint = 0x04;
pub const PF530X_INT_STATUS1: c_uint = 0x05;
pub const PF530X_INT_SENSE1: c_uint = 0x06;
pub const PF530X_INT_STATUS2: c_uint = 0x07;
pub const PF530X_INT_SENSE2: c_uint = 0x08;
pub const PF530X_BIST_STAT1: c_uint = 0x09;
pub const PF530X_BIST_CTRL: c_uint = 0x0a;
pub const PF530X_STATE: c_uint = 0x0b;
pub const PF530X_STATE_CTRL: c_uint = 0x0c;
pub const PF530X_SW1_VOLT: c_uint = 0x0d;
pub const PF530X_SW1_STBY_VOLT: c_uint = 0x0e;
pub const PF530X_SW1_CTRL1: c_uint = 0x0f;
pub const PF530X_SW1_CTRL2: c_uint = 0x10;
pub const PF530X_CLK_CTRL: c_uint = 0x11;
pub const PF530X_SEQ_CTRL1: c_uint = 0x12;
pub const PF530X_SEQ_CTRL2: c_uint = 0x13;
pub const PF530X_RANDOM_CHK: c_uint = 0x14;
pub const PF530X_RANDOM_GEN: c_uint = 0x15;
pub const PF530X_WD_CTRL1: c_uint = 0x16;
pub const PF530X_WD_SEED: c_uint = 0x17;
pub const PF530X_WD_ANSWER: c_uint = 0x18;
pub const PF530X_FLT_CNT1: c_uint = 0x19;
pub const PF530X_FLT_CNT2: c_uint = 0x1a;
pub const PF530X_OTP_MODE: c_uint = 0x2f;
    enum pf530x_states {
    PF530X_STATE_POF,
...
pub const PF530_FAM: c_uint = 0x50;
    enum pf530x_devid {
    PF5300			= 0x3,
    PF5301			= 0x4,
    PF5302			= 0x5,
    };
pub const PF530x_FAM: c_uint = 0x50;

pub const PF530x_STATE_RUN: c_uint = 0x07;
pub const PF530x_STATE_STANDBY: c_uint = 0x08;
pub const PF530x_STATE_LP_OFF: c_uint = 0x02;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pf530x_chip {
...
#[no_mangle]
unsafe extern "C" fn pf530x_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf530x_get_error_flags(rdev: *mut regulator_dev, flags: *mut c_uint) -> c_int {
...
// flags |= REGULATOR_ERROR_OVER_TEMP_WARN;
    ...
    let mut vrange: static struct linear_range = REGULATOR_LINEAR_RANGE(500000, 0, 140, 5000);
...
#[no_mangle]
unsafe extern "C" fn pf530x_identify(chip: *mut pf530x_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf530x_i2c_probe(client: *mut i2c_client) -> c_int {
