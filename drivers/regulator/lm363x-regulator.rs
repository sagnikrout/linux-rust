...
//! Source: drivers/regulator/lm363x-regulator.c
#![no_std]
...
// LM3631
pub const LM3631_BOOST_VSEL_MAX: c_uint = 0x25;
pub const LM3631_LDO_VSEL_MAX: c_uint = 0x28;
pub const LM3631_CONT_VSEL_MAX: c_uint = 0x03;
pub const LM3631_VBOOST_MIN: c_int = 4500000;
pub const LM3631_VCONT_MIN: c_int = 1800000;
pub const LM3631_VLDO_MIN: c_int = 4000000;
pub const ENABLE_TIME_USEC: c_int = 1000;
// LM3632
pub const LM3632_BOOST_VSEL_MAX: c_uint = 0x26;
pub const LM3632_LDO_VSEL_MAX: c_uint = 0x28;
pub const LM3632_VBOOST_MIN: c_int = 4500000;
pub const LM3632_VLDO_MIN: c_int = 4000000;
// LM36274
pub const LM36274_BOOST_VSEL_MAX: c_uint = 0x3f;
pub const LM36274_LDO_VSEL_MAX: c_uint = 0x32;
pub const LM36274_VOLTAGE_MIN: c_int = 4000000;
// Common
pub const LM363X_STEP_50mV: c_int = 50000;
pub const LM363X_STEP_500mV: c_int = 500000;
    static const int ldo_cont_enable_time[] = {
    0, 2000, 5000, 10000, 20000, 50000, 100000, 200000,
    };
#[no_mangle]
unsafe extern "C" fn lm363x_regulator_enable_time(rdev: *mut regulator_dev) -> c_int {
    static int lm363x_regulator_enable_time(struct regulator_dev *rdev)
    {
    let mut id: enum lm363x_regulator_id = rdev_get_id(rdev);
...
#[no_mangle]
unsafe extern "C" fn lm363x_regulator_set_ext_en(regmap: *mut regmap, id: c_int) -> c_int {
    static int lm363x_regulator_set_ext_en(struct regmap *regmap, int id)
    {
    let mut ext_en_mask: c_int = 0;
    switch (id) {
    case LM3632_LDO_POS:
    case LM3632_LDO_NEG:
...
#[no_mangle]
unsafe extern "C" fn lm363x_regulator_probe(pdev: *mut platform_device) -> c_int {
