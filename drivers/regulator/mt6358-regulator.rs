...
//! Source: drivers/regulator/mt6358-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6358_regulator_info {
    pub desc: regulator_desc,
    pub status_reg: u32,
    pub qi: u32,
    pub da_vsel_reg: u32,
    pub da_vsel_mask: u32,
    pub modeset_reg: u32,
...
#[no_mangle]
unsafe extern "C" fn mt6358_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6358_get_buck_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6358_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6358_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6358_sync_vcn33_setting(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6358_regulator_probe(pdev: *mut platform_device) -> c_int {
