...
//! Source: drivers/regulator/mt6370-regulator.c
#![no_std]
...
pub const MT6370_REG_LDO_CFG: c_uint = 0x180;
pub const MT6370_REG_LDO_VOUT: c_uint = 0x181;
pub const MT6370_REG_DB_CTRL1: c_uint = 0x1B0;
pub const MT6370_REG_DB_CTRL2: c_uint = 0x1B1;
pub const MT6370_REG_DB_VBST: c_uint = 0x1B2;
pub const MT6370_REG_DB_VPOS: c_uint = 0x1B3;
pub const MT6370_REG_DB_VNEG: c_uint = 0x1B4;
pub const MT6370_REG_LDO_STAT: c_uint = 0x1DC;
pub const MT6370_REG_DB_STAT: c_uint = 0x1DF;

pub const MT6370_LDO_MINUV: c_int = 1600000;
pub const MT6370_LDO_STPUV: c_int = 200000;
pub const MT6370_LDO_N_VOLT: c_int = 13;
pub const MT6370_DBVBOOST_MINUV: c_int = 4000000;
pub const MT6370_DBVBOOST_STPUV: c_int = 50000;
pub const MT6370_DBVBOOST_N_VOLT: c_int = 45;
pub const MT6370_DBVOUT_MINUV: c_int = 4000000;
pub const MT6370_DBVOUT_STPUV: c_int = 50000;
pub const MT6370_DBVOUT_N_VOLT: c_int = 41;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6370_priv {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub rdev: [*mut regulator_dev; MT6370_MAX_IDX],
    pub use_external_ctrl: bool,
}
...
#[no_mangle]
unsafe extern "C" fn mt6370_scp_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt6370_ocp_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt6370_regulator_irq_register(priv: *mut mt6370_priv) -> c_int {
    ...
    ret = devm_request_threaded_irq(priv.dev, irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn mt6370_regulator_register(priv: *mut mt6370_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6370_regulator_probe(pdev: *mut platform_device) -> c_int {
