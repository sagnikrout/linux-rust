...
//! Source: drivers/regulator/as3722-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3722_register_mapping {
    pub regulator_id: u8,
    ...
    pub control_reg: u32,
    pub mode_mask: u8,
    pub sleep_ctrl_reg: u32,
    pub sleep_ctrl_mask: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3722_regulator_config_data {
    pub reg_init: *mut regulator_init_data,
    pub enable_tracking: bool,
    pub ext_control: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct as3722_regulators {
    pub dev: *mut device,
    pub as3722: *mut as3722,
    pub desc: [regulator_desc; AS3722_REGULATOR_ID_MAX],
...
#[no_mangle]
unsafe extern "C" fn as3722_ldo3_get_current_limit(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn as3722_sd_get_mode(rdev: *mut regulator_dev) -> c_uint {
    ...
    struct as3722_regulators *as3722_regs = rdev_get_drvdata(rdev);
    struct as3722 *as3722 = as3722_regs.as3722;
    let mut id: u8 = rdev_get_id(rdev);
    let mut val: u8 = 0;
    int ret;
    if (!as3722_reg_lookup[id].control_reg)
    return -ERANGE;
...
#[no_mangle]
unsafe extern "C" fn as3722_sd0_is_low_voltage(as3722_regs: *mut as3722_regulators) -> bool {
...
#[no_mangle]
unsafe extern "C" fn as3722_regulator_probe(pdev: *mut platform_device) -> c_int {
