...
//! Source: drivers/regulator/bd71815-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd71815_regulator {
    pub desc: regulator_desc,
    pub dvs: *const rohm_dvs_config,
}
...
#[no_mangle]
unsafe extern "C" fn bd7181x_buck12_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd7181x_probe(pdev: *mut platform_device) -> c_int {
