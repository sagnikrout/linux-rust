...
//! Source: drivers/regulator/ti-abb-regulator.c
#![no_std]
...
//
pub const TI_ABB_NOMINAL_OPP: c_int = 0;
pub const TI_ABB_FAST_OPP: c_int = 1;
pub const TI_ABB_SLOW_OPP: c_int = 3;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ti_abb_reg {
    pub setup_off: u32,
    pub control_off: u32,
// Setup register fields
    pub sr2_wtcnt_value_mask: u32,
    pub fbb_sel_mask: u32,
    pub rbb_sel_mask: u32,
    pub sr2_en_mask: u32,
// Control register fields
    pub opp_change_mask: u32,
    pub opp_sel_mask: u32,
}
...
pub struct ti_abb {
    ...
    pub setup_reg: *mut void __iomem,
    pub control_reg: *mut void __iomem,
    pub int_base: *mut void __iomem,
    pub efuse_base: *mut void __iomem,
    pub ldo_base: *mut void __iomem,
    pub regs: *const ti_abb_reg,
    pub txdone_mask: u32,
    pub ldovbb_override_mask: u32,
    pub ldovbb_vset_mask: u32,
    pub info: *mut ti_abb_info,
    pub current_info_idx: c_int,
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_abb_rmw(mask: u32, value: u32, reg: *mut void __iomem) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_abb_check_txdone(abb: *const ti_abb) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ti_abb_clear_txdone(abb: *const ti_abb) {
...
//
#[no_mangle]
unsafe extern "C" fn ti_abb_wait_txdone(dev: *mut device, abb: *mut ti_abb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_abb_clear_all_txdone(dev: *mut device, abb: *const ti_abb) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_abb_set_voltage_sel(rdev: *mut regulator_dev, sel: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_abb_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ti_abb_init_timings(dev: *mut device, abb: *mut ti_abb) -> c_int {
...
// ABB LDO cannot be settle in 0 clock cycles
    ...
    abb.clk = devm_clk_get(dev, core::ptr::null_mut());
    if (IS_ERR(abb.clk)) {
    ret = PTR_ERR(abb.clk);
...
#[no_mangle]
pub unsafe extern "C" fn if(fbb_mask: efuse_val &) -> else {
    else if (efuse_val & fbb_mask)
    info.opp_sel = TI_ABB_FAST_OPP;
#[no_mangle]
pub unsafe extern "C" fn if(fbb_mask: rbb_mask ||) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ti_abb_probe(pdev: *mut platform_device) -> c_int {
    static int ti_abb_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct resource *res;
    struct ti_abb *abb;
    struct regulator_init_data *initdata = core::ptr::null_mut();
    struct regulator_dev *rdev = core::ptr::null_mut();
