...
//! Source: drivers/regulator/rt5190a-regulator.c
#![no_std]
...
pub const RT5190A_REG_MANUFACTURE: c_uint = 0x00;
pub const RT5190A_REG_BUCK2VSEL: c_uint = 0x04;
pub const RT5190A_REG_BUCK3VSEL: c_uint = 0x05;
pub const RT5190A_REG_DCDCCNTL: c_uint = 0x06;
pub const RT5190A_REG_ENABLE: c_uint = 0x07;
pub const RT5190A_REG_DISCHARGE: c_uint = 0x09;
pub const RT5190A_REG_PROTMODE: c_uint = 0x0A;
pub const RT5190A_REG_MUTECNTL: c_uint = 0x0B;
pub const RT5190A_REG_PGSTAT: c_uint = 0x0F;
pub const RT5190A_REG_OVINT: c_uint = 0x10;
pub const RT5190A_REG_HOTDIEMASK: c_uint = 0x17;

pub const RT5190A_BUCK1_DISCHG_ONVAL: c_uint = 0x01;

pub const RT5190A_BUCK23_MINUV: c_int = 600000;
pub const RT5190A_BUCK23_MAXUV: c_int = 1400000;
pub const RT5190A_BUCK23_STEPUV: c_int = 10000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt5190a_priv {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub rdesc: [regulator_desc; RT5190A_MAX_IDX],
    pub rdev: [*mut regulator_dev; RT5190A_MAX_IDX],
}
...
// flags = 0;
    ...
    struct regmap *regmap = rdev_get_regmap(rdev);
    let mut rid: c_int = rdev_get_id(rdev);
    let mut mask: c_uint = RT5190A_RID_BITMASK(rid), val;
    switch (mode) {
...
#[no_mangle]
unsafe extern "C" fn rt5190a_fixed_buck_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rt5190a_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn rt5190a_of_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rt5190a_fillin_regulator_desc(desc: *mut regulator_desc, rid: c_int) {
    ...
    "buck3", "buck4",
    "ldo" };
    static const char * const supply[] = { core::ptr::null_mut(), "vin2", "vin3", "vin4",
    "vinldo" };
...
#[no_mangle]
unsafe extern "C" fn rt5190a_parse_regulator_dt_data(priv: *mut rt5190a_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5190a_device_initialize(priv: *mut rt5190a_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5190a_device_check(priv: *mut rt5190a_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5190a_probe(i2c: *mut i2c_client) -> c_int {
    ...
    if (i2c.irq) {
    ret = devm_request_threaded_irq(&i2c.dev, i2c.irq, core::ptr::null_mut(),
    rt5190a_irq_handler,
    IRQF_ONESHOT,
