...
//! Source: drivers/regulator/mt6359-regulator.c
#![no_std]
...
pub const MT6359_BUCK_MODE_AUTO: c_int = 0;
pub const MT6359_BUCK_MODE_FORCE_PWM: c_int = 1;
pub const MT6359_BUCK_MODE_NORMAL: c_int = 0;
pub const MT6359_BUCK_MODE_LP: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6359_regulator_info {
...
#[no_mangle]
pub unsafe extern "C" fn mt6359_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6359_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6359_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6359p_vemc_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
// Used for backward-compatible placeholder regulators
    let mut mt6359_noop_ops: static struct regulator_ops = {};
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6359_vcn33_regs {
    pub wifi_en_reg: u32,
    pub wifi_en_mask: u32,
    pub bt_en_reg: u32,
    pub bt_en_mask: u32,
}
...
#[no_mangle]
unsafe extern "C" fn mt6359_sync_vcn33_setting(dev: *mut device, idx: c_uint) -> c_int {
...
//
    ...
    let mut bt_en_mask: u32 = vcn33_regs[idx][i].bt_en_mask;
    let mut wifi_en_mask: u32 = vcn33_regs[idx][i].wifi_en_mask;
...
#[no_mangle]
unsafe extern "C" fn mt6359_regulator_probe(pdev: *mut platform_device) -> c_int {
