...
//! Source: drivers/regulator/max8952.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max8952_data {
    pub client: *mut i2c_client,
    pub pdata: *mut max8952_platform_data,
    pub vid0_gpiod: *mut gpio_desc,
    pub vid1_gpiod: *mut gpio_desc,
    pub vid0: bool,
    pub vid1: bool,
}

#[no_mangle]
unsafe extern "C" fn max8952_read_reg(max8952: *mut max8952_data, reg: u8) -> c_int {
    static int max8952_read_reg(struct max8952_data *max8952, u8 reg)
    {
    let mut ret: c_int = i2c_smbus_read_byte_data(max8952.client, reg);
    if (ret > 0)
    ret &= 0xff;
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn max8952_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8952_pmic_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8952_pmic_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max8952_pmic_exit() -> void __exit {
