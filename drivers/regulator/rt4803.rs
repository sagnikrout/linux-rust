...
//! Source: drivers/regulator/rt4803.c
#![no_std]
...
pub const RT4803_AUTO_MODE: c_int = 1;
pub const RT4803_FPWM_MODE: c_int = 2;
pub const RT4803_REG_CONFIG: c_uint = 0x01;
pub const RT4803_REG_VSELL: c_uint = 0x02;
pub const RT4803_REG_VSELH: c_uint = 0x03;
pub const RT4803_REG_ILIM: c_uint = 0x04;
pub const RT4803_REG_STAT: c_uint = 0x05;

pub const RT4803_VOUT_MINUV: c_int = 2850000;
pub const RT4803_VOUT_STEPUV: c_int = 50000;
pub const RT4803_VOUT_NUM: c_int = 32;
#[no_mangle]
unsafe extern "C" fn rt4803_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt4803_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rt4803_get_error_flags(rdev: *mut regulator_dev, flags: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt4803_set_suspend_voltage(rdev: *mut regulator_dev, uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt4803_of_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rt4803_probe(i2c: *mut i2c_client) -> c_int {
