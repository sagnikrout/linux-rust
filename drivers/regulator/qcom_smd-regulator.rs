...
//! Source: drivers/regulator/qcom_smd-regulator.c
#![no_std]
...
pub struct qcom_rpm_reg {
    ...
    pub uV: c_int,
    pub load: u32,
    pub enabled_updated:1: c_uint,
    pub uv_updated:1: c_uint,
    pub load_updated:1: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rpm_regulator_req {
    pub key: __le32,
    pub nbytes: __le32,
    pub value: __le32,
}

pub const RPM_KEY_SWEN: c_uint = 0x6e657773 /* "swen" */;
pub const RPM_KEY_UV: c_uint = 0x00007675 /* "uv" */;
pub const RPM_KEY_MA: c_uint = 0x0000616d /* "ma" */;
#[no_mangle]
unsafe extern "C" fn rpm_reg_write_active(vreg: *mut qcom_rpm_reg) -> c_int {
    static int rpm_reg_write_active(struct qcom_rpm_reg *vreg)
    {
    struct rpm_regulator_req req[3];
    let mut reqlen: c_int = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rpm_reg_disable(rdev: *mut regulator_dev) -> c_int {
...
unsafe extern "C" fn rpm_reg_set_load(rdev: *mut regulator_dev, load_uA: c_int) -> c_int {
    ...
    {
    struct qcom_rpm_reg *vreg = rdev_get_drvdata(rdev);
    let mut old_load: u32 = vreg.load;
    int ret;
    vreg.load = load_uA;
    vreg.load_updated = 1;
    ret = rpm_reg_write_active(vreg);
