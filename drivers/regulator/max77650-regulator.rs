...
//! Source: drivers/regulator/max77650-regulator.c
#![no_std]
...
pub const MAX77650_REGULATOR_AD_DISABLED: c_uint = 0x00;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77650_regulator_desc {
...
#[no_mangle]
unsafe extern "C" fn max77650_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77650_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77650_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77650_regulator_probe(pdev: *mut platform_device) -> c_int {
