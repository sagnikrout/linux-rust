...
//! Source: drivers/regulator/ab8500-ext.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_ext_regulator_cfg {
    pub /: *mut *mut bool hwreq; / requires hw mode or high power mode,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_ext_regulator_info {
    pub dev: *mut device,
    pub desc: regulator_desc,
    pub cfg: *mut ab8500_ext_regulator_cfg,
    pub update_bank: u8,
    pub update_reg: u8,
    pub update_mask: u8,
    pub update_val: u8,
    pub update_val_hp: u8,
    pub update_val_lp: u8,
    pub update_val_hw: u8,
}

#[no_mangle]
unsafe extern "C" fn ab8500_ext_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_ext_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_ext_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_ext_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(info->update_val_lp: info->update_val ==) -> else {
    ...
    {
    struct regulation_constraints *regu_constraints = rdev.constraints;
    if (regu_constraints == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn ab8500_ext_regulator_probe(pdev: *mut platform_device) -> c_int {
...
// register all regulators
    ...
    struct ab8500_ext_regulator_info *info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ab8500_ext_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ab8500_ext_regulator_exit() -> void __exit {
