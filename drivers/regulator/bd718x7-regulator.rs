...
//! Source: drivers/regulator/bd718x7-regulator.c
#![no_std]
...
pub const BD71847_BUCK1_STARTUP_TIME: c_int = 144;
pub const BD71847_BUCK2_STARTUP_TIME: c_int = 162;
pub const BD71847_BUCK3_STARTUP_TIME: c_int = 162;
pub const BD71847_BUCK4_STARTUP_TIME: c_int = 240;
pub const BD71847_BUCK5_STARTUP_TIME: c_int = 270;
pub const BD71847_BUCK6_STARTUP_TIME: c_int = 200;
pub const BD71847_LDO1_STARTUP_TIME: c_int = 440;
pub const BD71847_LDO2_STARTUP_TIME: c_int = 370;
pub const BD71847_LDO3_STARTUP_TIME: c_int = 310;
pub const BD71847_LDO4_STARTUP_TIME: c_int = 400;
pub const BD71847_LDO5_STARTUP_TIME: c_int = 530;
pub const BD71847_LDO6_STARTUP_TIME: c_int = 400;
pub const BD71837_BUCK1_STARTUP_TIME: c_int = 160;
pub const BD71837_BUCK2_STARTUP_TIME: c_int = 180;
pub const BD71837_BUCK3_STARTUP_TIME: c_int = 180;
pub const BD71837_BUCK4_STARTUP_TIME: c_int = 180;
pub const BD71837_BUCK5_STARTUP_TIME: c_int = 160;
pub const BD71837_BUCK6_STARTUP_TIME: c_int = 240;
pub const BD71837_BUCK7_STARTUP_TIME: c_int = 220;
pub const BD71837_BUCK8_STARTUP_TIME: c_int = 200;
pub const BD71837_LDO1_STARTUP_TIME: c_int = 440;
pub const BD71837_LDO2_STARTUP_TIME: c_int = 370;
pub const BD71837_LDO3_STARTUP_TIME: c_int = 310;
pub const BD71837_LDO4_STARTUP_TIME: c_int = 400;
pub const BD71837_LDO5_STARTUP_TIME: c_int = 310;
pub const BD71837_LDO6_STARTUP_TIME: c_int = 400;
pub const BD71837_LDO7_STARTUP_TIME: c_int = 530;
//
...
//
#[no_mangle]
unsafe extern "C" fn always_enabled_by_hwstate(rdev: *mut regulator_dev) -> c_int {
    static int always_enabled_by_hwstate(struct regulator_dev *rdev)
    {
    return 1;
    }
#[no_mangle]
unsafe extern "C" fn never_enabled_by_hwstate(rdev: *mut regulator_dev) -> c_int {
    static int never_enabled_by_hwstate(struct regulator_dev *rdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn bd71837_get_buck34_enable_hwctrl(rdev: *mut regulator_dev) -> c_int {
...
//
    ...
    int tmp;
    int prot_bit;
    let mut ldo_offset: c_int = rdev.desc.id - BD718XX_LDO1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd718xx_regulator_data {
    pub desc: regulator_desc,
    pub dvs: rohm_dvs_config,
    pub init: reg_init,
    pub additional_inits: *const reg_init,
    pub additional_init_amnt: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn bd718x7_get_buck_prot_reg(id: c_int, reg: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd718x7_get_buck_ovp_info(id: c_int, reg: *mut c_int, bit: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd718x7_get_buck_uvp_info(id: c_int, reg: *mut c_int, bit: *mut c_int) -> c_int {
...
//
    ...
    regulator_list_voltage_pickable_linear_range, core::ptr::null_mut(),
    bd718xx_set_voltage_sel_pickable_restricted,
    regulator_get_voltage_sel_pickable_regmap, core::ptr::null_mut(), core::ptr::null_mut(),
    bd718x7_set_ldo_uvp, core::ptr::null_mut());
// BD71847 and BD71850 LDO 5 is by default OFF at RUN state
    ...
    regulator_set_voltage_time_sel, core::ptr::null_mut(), bd718x7_set_buck_uvp,
    bd718x7_set_buck_ovp);
    BD718XX_OPS(bd718xx_ldo_regulator_ops, regulator_list_voltage_linear_range,
    core::ptr::null_mut(), bd718xx_set_voltage_sel_restricted,
    regulator_get_voltage_sel_regmap, core::ptr::null_mut(), core::ptr::null_mut(), bd718x7_set_ldo_uvp,
    core::ptr::null_mut());
    ...
    core::ptr::null_mut(), regulator_set_voltage_sel_regmap,
    regulator_get_voltage_sel_regmap, regulator_set_voltage_time_sel,
    core::ptr::null_mut(), bd718x7_set_buck_uvp, bd718x7_set_buck_ovp);
...
//
    ...
    core::ptr::null_mut(), rohm_regulator_set_voltage_sel_restricted,
    regulator_get_voltage_sel_regmap, core::ptr::null_mut(), core::ptr::null_mut(), bd718x7_set_ldo_uvp,
    core::ptr::null_mut());
...
// The feedback loop connection does not make sense for LDOs
    ...
    let mut min: c_int = desc.linear_ranges[j].min;
    let mut step: c_int = desc.linear_ranges[j].step;
    min -= (fb_uv - min)*r2/r1;
    step = step * (r1 + r2);
    step /= r1;
    new[j].min = min;
...
#[no_mangle]
unsafe extern "C" fn bd718xx_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    let mut no_enable_control: c_int = omit_enable & (1 << i);
    r = &reg_data[i];
    desc = &r.desc;
