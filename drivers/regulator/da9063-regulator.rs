...
//! Source: drivers/regulator/da9063-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_regulator_data {
    pub id: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_regulators_pdata {
    pub n_regulators: c_uint,
    pub __counted_by(n_regulators): da9063_regulator_data regulator_data[],
}

// Regulator capabilities and registers description
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_regulator_info {
    pub desc: regulator_desc,
// DA9063 main register fields
    pub /: *mut *mut reg_field mode; / buck mode of operation,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_dev_model {
    pub regulator_info: *const da9063_regulator_info,
    pub n_regulators: c_uint,
    pub type: enum da9063_type,
}

// Single regulator settings
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_regulator {
    pub desc: regulator_desc,
    pub rdev: *mut regulator_dev,
    pub hw: *mut da9063,
    pub info: *const da9063_regulator_info,
    pub mode: *mut regmap_field,
    pub suspend: *mut regmap_field,
    pub sleep: *mut regmap_field,
    pub suspend_sleep: *mut regmap_field,
    pub vmon: *mut regmap_field,
}

// Encapsulates all information for the regulators driver
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9063_regulators {
    pub n_regulators: c_uint,
// Array size to be defined during init. Keep at end.
    pub __counted_by(n_regulators): da9063_regulator regulator[],
}
...
#[no_mangle]
unsafe extern "C" fn da9063_set_xvp(rdev: *mut regulator_dev, lim_uV: c_int, severity: c_int, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_buck_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn da9063_buck_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn da9063_ldo_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_ldo_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn da9063_buck_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_ldo_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_set_suspend_voltage(rdev: *mut regulator_dev, uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_get_overdrive_mask(desc: *const regulator_desc) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn da9063_buck_get_current_limit(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9063_ldo_lim_event(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da9063_check_xvp_constraints(config: *mut regulator_config) -> c_int {
...
// The following LDOs are present only on DA9063, not on DA9063L
    ...
    let mut da9063_matches_len: c_int = ARRAY_SIZE(da9063_matches);
    int i, n, num;
...
#[no_mangle]
unsafe extern "C" fn da9063_regulator_probe(pdev: *mut platform_device) -> c_int {
    static int da9063_regulator_probe(struct platform_device *pdev)
    {
    struct da9063 *da9063 = dev_get_drvdata(pdev.dev.parent);
    struct of_regulator_match *da9063_reg_matches = core::ptr::null_mut();
...
// LDOs overcurrent event support
    ...
    core::ptr::null_mut(), da9063_ldo_lim_event,
...
#[no_mangle]
unsafe extern "C" fn da9063_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn da9063_regulator_cleanup() -> void __exit {
