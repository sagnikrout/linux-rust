...
//! Source: drivers/regulator/tps65217-regulator.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn tps65217_pmic_enable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65217_pmic_disable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65217_pmic_set_suspend_enable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65217_pmic_set_suspend_disable(dev: *mut regulator_dev) -> c_int {
...
// Operations permitted on LDO1
    ...
    core::ptr::null_mut(), tps65217_uv1_ranges,
    ...
    LDO1_VSEL_table, core::ptr::null_mut(), 0, TPS65217_REG_SEQ2,
    ...
    core::ptr::null_mut(), tps65217_uv2_ranges,
...
#[no_mangle]
unsafe extern "C" fn tps65217_regulator_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65217_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps65217_regulator_exit() -> void __exit {
