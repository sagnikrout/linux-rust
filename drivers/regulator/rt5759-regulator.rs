...
//! Source: drivers/regulator/rt5759-regulator.c
#![no_std]
...
pub const RT5759_REG_VENDORINFO: c_uint = 0x00;
pub const RT5759_REG_FREQ: c_uint = 0x01;
pub const RT5759_REG_VSEL: c_uint = 0x02;
pub const RT5759_REG_DCDCCTRL: c_uint = 0x03;
pub const RT5759_REG_STATUS: c_uint = 0x04;
pub const RT5759_REG_DCDCSET: c_uint = 0x05;
pub const RT5759A_REG_WDTEN: c_uint = 0x42;

pub const RT5759_OCLVL_SHIFT: c_int = 6;

pub const RT5759_OTLVL_SHIFT: c_int = 4;

pub const RT5759_MANUFACTURER_ID: c_uint = 0x82;
// vsel range 0x00 ~ 0x5A
pub const RT5759_NUM_VOLTS: c_int = 91;
pub const RT5759_MIN_UV: c_int = 600000;
pub const RT5759_STEP_UV: c_int = 10000;
pub const RT5759A_STEP_UV: c_int = 12500;
pub const RT5759_MINSS_TIMEUS: c_int = 1500;
pub const RT5759_PSKIP_MODE: c_int = 0;
pub const RT5759_FPWM_MODE: c_int = 1;
    enum {
    CHIP_TYPE_RT5759 = 0,
    CHIP_TYPE_RT5759A,
    CHIP_TYPE_MAX
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt5759_priv {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub desc: regulator_desc,
    pub chip_type: c_ulong,
}

#[no_mangle]
unsafe extern "C" fn rt5759_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5759_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rt5759_of_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rt5759_regulator_register(priv: *mut rt5759_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5759_init_device_property(priv: *mut rt5759_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5759_manufacturer_check(priv: *mut rt5759_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt5759_is_accessible_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt5759_probe(i2c: *mut i2c_client) -> c_int {
