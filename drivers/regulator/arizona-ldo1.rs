...
//! Source: drivers/regulator/arizona-ldo1.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn arizona_ldo1_hc_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_ldo1_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_ldo1_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn madera_ldo1_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arizona_ldo1_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn madera_ldo1_exit() -> void __exit {
