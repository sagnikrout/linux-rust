...
//! Source: drivers/regulator/tps65910-regulator.c
#![no_std]
...
pub const TPS65910_SUPPLY_STATE_ENABLED: c_uint = 0x1;
...
pub struct tps_info {
    ...
    pub vin_name: *const c_char,
    pub n_voltages: u8,
    pub voltage_table: *const c_uint,
    pub enable_time_us: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps65910_reg {
    pub desc: *mut regulator_desc,
    pub mfd: *mut tps65910,
    pub rdev: *mut regulator_dev,
    pub info: *mut tps_info,
    pub num_regulators: c_int,
    pub mode: c_int,
    pub (*get_ctrl_reg)(int): *mut c_int,
    pub ext_sleep_control: *mut c_uint,
    pub board_ext_control: [c_uint; TPS65910_NUM_REGS],
}

#[no_mangle]
unsafe extern "C" fn tps65910_get_ctrl_register(id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65911_get_ctrl_register(id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_set_mode(dev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_get_mode(dev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(LDO_ST_MODE_BIT: value &) -> else {
...
#[no_mangle]
unsafe extern "C" fn tps65910_get_voltage_dcdc_sel(dev: *mut regulator_dev) -> c_int {
    static int tps65910_get_voltage_dcdc_sel(struct regulator_dev *dev)
    {
    struct regmap *regmap = rdev_get_regmap(dev);
    int ret, id = rdev_get_id(dev);
    let mut opvsel: c_int = 0, srvsel = 0, vselmax = 0, mult = 0, sr = 0;
    switch (id) {
    case TPS65910_REG_VDD1:
...
#[no_mangle]
unsafe extern "C" fn tps65910_get_voltage_sel(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65910_get_voltage_vdd3(dev: *mut regulator_dev) -> c_int {
    static int tps65910_get_voltage_vdd3(struct regulator_dev *dev)
    {
    return dev.desc.volt_table[0];
    }
#[no_mangle]
unsafe extern "C" fn tps65911_get_voltage_sel(dev: *mut regulator_dev) -> c_int {
    ...
    {
    struct regmap *regmap = rdev_get_regmap(dev);
    let mut id: c_int = rdev_get_id(dev), vsel;
    let mut dcdc_mult: c_int = 0;
    switch (id) {
    case TPS65910_REG_VDD1:
...
#[no_mangle]
unsafe extern "C" fn tps65911_list_voltage(dev: *mut regulator_dev, selector: unsigned) -> c_int {
    static int tps65911_list_voltage(struct regulator_dev *dev, unsigned selector)
    {
    struct tps65910_reg *pmic = rdev_get_drvdata(dev);
    let mut step_mv: c_int = 0, id = rdev_get_id(dev);
    switch (id) {
    case TPS65911_REG_LDO1:
    case TPS65911_REG_LDO2:
    case TPS65911_REG_LDO4:
...
// Regulator ops (except VRTC)
    ...
    let mut regoffs: u8 = (pmic.ext_sleep_control[id] >> 8) & 0xFF;
    let mut bit_pos: u8 = (1 << pmic.ext_sleep_control[id] & 0xFF);
    int ret;
//
...
//
    ...
    let mut op_reg_add: c_int = pmic.get_ctrl_reg(id) + 1;
    let mut sr_reg_add: c_int = pmic.get_ctrl_reg(id) + 2;
    int opvsel, srvsel;
    ...
    let mut reg_val: u8 = srvsel & VDD1_OP_SEL_MASK;
...
#[no_mangle]
unsafe extern "C" fn tps65910_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct tps65910_board *pmic_plat_data;
    struct of_regulator_match *tps65910_reg_matches = core::ptr::null_mut();
    int i, err;
...
#[no_mangle]
unsafe extern "C" fn tps65910_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tps65910_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps65910_cleanup() -> void __exit {
