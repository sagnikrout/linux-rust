...
//! Source: drivers/regulator/pf0900-regulator.c
#![no_std]
...
pub const PF0900_VAON_VOLTAGE_NUM: c_uint = 0x03;
pub const PF0900_SW_VOLTAGE_NUM: c_uint = 0x100;
pub const PF0900_LDO_VOLTAGE_NUM: c_uint = 0x20;
pub const REGU_SW_CNT: c_uint = 0x5;
pub const REGU_LDO_VAON_CNT: c_uint = 0x4;
    enum {
...
// PF0900 SW MODE
pub const SW_RUN_MODE_OFF: c_uint = 0x00;
pub const SW_RUN_MODE_PWM: c_uint = 0x01;
pub const SW_RUN_MODE_PFM: c_uint = 0x02;
pub const SW_STBY_MODE_OFF: c_uint = 0x00;
pub const SW_STBY_MODE_PWM: c_uint = 0x04;
pub const SW_STBY_MODE_PFM: c_uint = 0x08;
// PF0900 SW MODE MASK

// PF0900 SW VRUN/VSTBY MASK

// PF0900_REG_VAON_CFG1 bits
pub const PF0900_VAON_1P8V: c_uint = 0x01;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pf0900_regulator_desc {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pf0900_drvdata {
    pub desc: *const pf0900_regulator_desc,
    pub rcnt: c_uint,
}
...
pub struct pf0900 {
    ...
    pub drvdata: *const pf0900_drvdata,
    pub rdevs: [*mut regulator_dev; PF0900_REGULATOR_CNT],
    pub irq: c_int,
    pub addr: c_ushort,
    pub crc_en: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pf0900_regulator_irq {
    pub reg: c_uint,
    pub type: c_uint,
    pub event: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn pf0900_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf0900_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf0900_set_suspend_voltage(rdev: *mut regulator_dev, uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pf0900_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pf0900_i2c_probe(i2c: *mut i2c_client) -> c_int {
    static int pf0900_i2c_probe(struct i2c_client *i2c)
    {
    const struct pf0900_regulator_desc *regulator_desc;
    const struct pf0900_drvdata *drvdata = core::ptr::null_mut();
...
// Check your board and dts for match the right pmic
    ...
    ret = devm_request_threaded_irq(pf0900.dev, pf0900.irq, core::ptr::null_mut(),
    pf0900_irq_handler,
