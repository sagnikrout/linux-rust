...
//! Source: drivers/regulator/atc260x-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct atc260x_regulator_data {
    pub voltage_time_dcdc: c_int,
    pub voltage_time_ldo: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn atc260x_regulator_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut atc2603c_ver_b: bool = false;
    int i, nregulators;
