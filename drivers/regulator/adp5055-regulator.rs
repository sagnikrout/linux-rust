...
//! Source: drivers/regulator/adp5055-regulator.c
#![no_std]
...
pub const ADP5055_CTRL123: c_uint = 0xD1;
pub const ADP5055_CTRL_MODE1: c_uint = 0xD3;
pub const ADP5055_CTRL_MODE2: c_uint = 0xD4;
pub const ADP5055_DLY0: c_uint = 0xD5;
pub const ADP5055_DLY1: c_uint = 0xD6;
pub const ADP5055_DLY2: c_uint = 0xD7;
pub const ADP5055_VID0: c_uint = 0xD8;
pub const ADP5055_VID1: c_uint = 0xD9;
pub const ADP5055_VID2: c_uint = 0xDA;
pub const ADP5055_DVS_LIM0: c_uint = 0xDC;
pub const ADP5055_DVS_LIM1: c_uint = 0xDD;
pub const ADP5055_DVS_LIM2: c_uint = 0xDE;
pub const ADP5055_FT_CFG: c_uint = 0xDF;
pub const ADP5055_PG_CFG: c_uint = 0xE0;
// ADP5055 Field Masks.

pub const ADP5055_MIN_VOUT: c_int = 408000;
pub const ADP5055_NUM_CH: c_int = 3;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct adp5055 {
    pub dev: *mut device,
    ...
    pub tset: u32,
    pub en_gpiod: [*mut gpio_desc; ADP5055_NUM_CH],
    pub en_mode_software: bool,
    pub dvs_limit_upper: [c_int; ADP5055_NUM_CH],
    pub dvs_limit_lower: [c_int; ADP5055_NUM_CH],
    pub fast_transient: [u32; ADP5055_NUM_CH],
    pub mask_power_good: [bool; ADP5055_NUM_CH],
}
...
#[no_mangle]
unsafe extern "C" fn adp5055_parse_fw(dev: *mut device, adp5055: *mut adp5055) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5055_set_mode(rdev: *mut regulator_dev, mode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adp5055_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn adp5055_probe(client: *mut i2c_client) -> c_int {
