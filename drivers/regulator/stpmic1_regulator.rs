...
//! Source: drivers/regulator/stpmic1_regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct stpmic1_regulator_cfg {
    pub desc: regulator_desc,
    pub mask_reset_reg: u8,
    pub mask_reset_mask: u8,
    pub icc_reg: u8,
    pub icc_mask: u8,
}
...
pub const PMIC_ENABLE_TIME_US: c_int = 2200;
// Ramp delay worst case is (2250uV/uS)
pub const PMIC_RAMP_DELAY: c_int = 2200;
...
#[no_mangle]
unsafe extern "C" fn stpmic1_map_mode(mode: c_uint) -> c_uint {
    static unsigned int stpmic1_map_mode(unsigned int mode)
    {
    switch (mode) {
...
#[no_mangle]
unsafe extern "C" fn stpmic1_get_mode(rdev: *mut regulator_dev) -> c_uint {
    static unsigned int stpmic1_get_mode(struct regulator_dev *rdev)
    {
    int value;
...
#[no_mangle]
unsafe extern "C" fn stpmic1_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
    static int stpmic1_set_mode(struct regulator_dev *rdev, unsigned int mode)
    {
    int value;
    struct regmap *regmap = rdev_get_regmap(rdev);
...
#[no_mangle]
unsafe extern "C" fn stpmic1_curlim_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn stpmic1_regulator_probe(pdev: *mut platform_device) -> c_int {
