...
//! Source: drivers/regulator/helpers.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_is_enabled_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_enable_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_disable_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_voltage_sel_pickable_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
    ...
    unsigned int range;
    int ret, i;
    let mut voltages_in_range: c_uint = 0;
    for (i = 0; i < rdev.desc.n_linear_ranges; i++) {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_voltage_sel_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_voltage_sel_regmap(rdev: *mut regulator_dev, sel: unsigned) -> c_int {
...
//
    ...
    {
    let mut best_val: c_int = INT_MAX;
    let mut selector: c_int = 0;
    int i, ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_bypass_regmap(rdev: *mut regulator_dev, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_soft_start_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_pull_down_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_bypass_regmap(rdev: *mut regulator_dev, enable: *mut bool) -> c_int {
    int regulator_get_bypass_regmap(struct regulator_dev *rdev, bool *enable)
    {
    unsigned int val;
    let mut val_on: c_uint = rdev.desc.bypass_val_on;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_current_limit_regmap(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_is_equal(reg1: *mut regulator, reg2: *mut regulator) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_ramp_delay_regmap(rdev: *mut regulator_dev, ramp_delay: c_int) -> c_int {
