...
//! Source: drivers/regulator/anatop-regulator.c
#![no_std]
...
pub const LDO_POWER_GATE: c_uint = 0x00;
pub const LDO_FET_FULL_ON: c_uint = 0x1f;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct anatop_regulator {
    pub delay_reg: u32,
    pub delay_bit_shift: c_int,
    pub delay_bit_width: c_int,
...
#[no_mangle]
unsafe extern "C" fn anatop_regmap_enable(reg: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anatop_regmap_disable(reg: *mut regulator_dev) -> c_int {
    static int anatop_regmap_disable(struct regulator_dev *reg)
    {
    return regulator_set_voltage_sel_regmap(reg, LDO_POWER_GATE);
    }
#[no_mangle]
unsafe extern "C" fn anatop_regmap_is_enabled(reg: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anatop_regmap_core_get_voltage_sel(reg: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anatop_regmap_get_bypass(reg: *mut regulator_dev, enable: *mut bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(LDO_POWER_GATE: sel !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn anatop_regmap_set_bypass(reg: *mut regulator_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anatop_regulator_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn anatop_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn anatop_regulator_exit() -> void __exit {
