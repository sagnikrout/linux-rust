...
//! Source: drivers/regulator/wm831x-dcdc.c
#![no_std]
...
pub const WM831X_BUCKV_MAX_SELECTOR: c_uint = 0x68;
pub const WM831X_BUCKP_MAX_SELECTOR: c_uint = 0x66;
pub const WM831X_DCDC_MODE_FAST: c_int = 0;
pub const WM831X_DCDC_MODE_NORMAL: c_int = 1;
pub const WM831X_DCDC_MODE_IDLE: c_int = 2;
pub const WM831X_DCDC_MODE_STANDBY: c_int = 3;
pub const WM831X_DCDC_MAX_NAME: c_int = 9;
// Register offsets in control block
pub const WM831X_DCDC_CONTROL_1: c_int = 0;
pub const WM831X_DCDC_CONTROL_2: c_int = 1;
pub const WM831X_DCDC_ON_CONFIG: c_int = 2;
pub const WM831X_DCDC_SLEEP_CONTROL: c_int = 3;
pub const WM831X_DCDC_DVS_CONTROL: c_int = 4;
//
// Shared
//
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wm831x_dcdc {
    pub name: [c_char; WM831X_DCDC_MAX_NAME],
    pub supply_name: [c_char; WM831X_DCDC_MAX_NAME],
    pub desc: regulator_desc,
    pub base: c_int,
    pub wm831x: *mut wm831x,
    pub regulator: *mut regulator_dev,
    pub dvs_gpiod: *mut gpio_desc,
    pub dvs_gpio_state: c_int,
    pub on_vsel: c_int,
    pub dvs_vsel: c_int,
}

#[no_mangle]
unsafe extern "C" fn wm831x_dcdc_get_mode(rdev: *mut regulator_dev) -> c_uint {
    static unsigned int wm831x_dcdc_get_mode(struct regulator_dev *rdev)
    {
    struct wm831x_dcdc *dcdc = rdev_get_drvdata(rdev);
    struct wm831x *wm831x = dcdc.wm831x;
    let mut reg: u16 = dcdc.base + WM831X_DCDC_ON_CONFIG;
    int val;
...
#[no_mangle]
unsafe extern "C" fn wm831x_dcdc_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
    ...
    struct wm831x_dcdc *dcdc = rdev_get_drvdata(rdev);
    struct wm831x *wm831x = dcdc.wm831x;
    let mut reg: u16 = dcdc.base + WM831X_DCDC_SLEEP_CONTROL;
    return wm831x_dcdc_set_mode_int(wm831x, reg, mode);
    }
#[no_mangle]
unsafe extern "C" fn wm831x_dcdc_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_dcdc_uv_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm831x_dcdc_oc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn wm831x_buckv_set_dvs(rdev: *mut regulator_dev, state: c_int) -> c_int {
...
//
    ...
    struct wm831x_dcdc *dcdc = rdev_get_drvdata(rdev);
    struct wm831x *wm831x = dcdc.wm831x;
    let mut on_reg: c_int = dcdc.base + WM831X_DCDC_ON_CONFIG;
    let mut dvs_reg: c_int = dcdc.base + WM831X_DCDC_DVS_CONTROL;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn wm831x_buckv_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_buckv_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_buckp_set_suspend_voltage(rdev: *mut regulator_dev, uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_buckp_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn wm831x_boostp_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wm831x_boostp_probe(pdev: *mut platform_device) -> c_int {
    static int wm831x_boostp_probe(struct platform_device *pdev)
    {
    struct wm831x *wm831x = dev_get_drvdata(pdev.dev.parent);
    struct wm831x_pdata *pdata = dev_get_platdata(wm831x.dev);
    let mut config: regulator_config = { };
    let mut id: c_int = pdev.id % ARRAY_SIZE(pdata.dcdc);
    struct wm831x_dcdc *dcdc;
    struct resource *res;
    int ret, irq;
    dev_dbg(&pdev.dev, "Probing DCDC%d\n", id + 1);
    if (pdata == core::ptr::null_mut() || pdata.dcdc[id] == core::ptr::null_mut())
    return -ENODEV;
...
// code.
//
pub const WM831X_EPE_BASE: c_int = 6;
...
#[no_mangle]
unsafe extern "C" fn wm831x_epe_probe(pdev: *mut platform_device) -> c_int {
    static int wm831x_epe_probe(struct platform_device *pdev)
    {
    struct wm831x *wm831x = dev_get_drvdata(pdev.dev.parent);
    struct wm831x_pdata *pdata = dev_get_platdata(wm831x.dev);
    let mut config: regulator_config = { };
    let mut id: c_int = pdev.id % ARRAY_SIZE(pdata.epe);
    struct wm831x_dcdc *dcdc;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn wm831x_dcdc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn wm831x_dcdc_exit() -> void __exit {
