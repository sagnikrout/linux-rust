...
//! Source: drivers/regulator/mcp16502.c
#![no_std]
...
pub const VDD_LOW_SEL: c_uint = 0x0D;
pub const VDD_HIGH_SEL: c_uint = 0x3F;
...
pub const MCP16502_MODE_AUTO_PFM: c_int = 0;

pub const MCP16502_VSEL: c_uint = 0x3F;

pub const MCP16502_MIN_REG: c_uint = 0x0;
pub const MCP16502_MAX_REG: c_uint = 0x65;
//
...
#[no_mangle]
unsafe extern "C" fn mcp16502_of_map_mode(mode: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_gpio_set_mode(mcp: *mut mcp16502, mode: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_get_state_reg(rdev: *mut regulator_dev, opmode: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MCP16502_ENS: val &) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_suspend_get_target_reg(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_set_suspend_voltage(rdev: *mut regulator_dev, uV: c_int) -> c_int {
    static int mcp16502_set_suspend_voltage(struct regulator_dev *rdev, int uV)
    {
    let mut sel: c_int = regulator_map_voltage_linear_range(rdev, uV, uV);
    let mut reg: c_int = mcp16502_suspend_get_target_reg(rdev);
    if (sel < 0)
    return sel;
    if (reg < 0)
    return reg;
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_set_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mcp16502_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp16502_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp16502_suspend_noirq(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mcp16502_resume_noirq(dev: *mut device) -> c_int {
