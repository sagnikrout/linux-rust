...
//! Source: drivers/regulator/ab8500.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_shared_mode {
    pub shared_regulator: *mut ab8500_regulator_info,
    pub lp_mode_req: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ab8500_regulator_info {
    pub dev: *mut device,
    pub desc: regulator_desc,
    pub shared_mode: *mut ab8500_shared_mode,
    pub load_lp_uA: c_int,
    pub update_bank: u8,
    pub update_reg: u8,
    pub update_mask: u8,
    pub update_val: u8,
    pub update_val_idle: u8,
    pub update_val_normal: u8,
    pub mode_bank: u8,
    pub mode_reg: u8,
    pub mode_mask: u8,
    pub mode_val_idle: u8,
    pub mode_val_normal: u8,
    pub voltage_bank: u8,
    pub voltage_reg: u8,
    pub voltage_mask: u8,
}
...
#[no_mangle]
unsafe extern "C" fn ab8500_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
    ...
    let mut lp_mode_req: bool = false;
    struct ab8500_regulator_info *info = rdev_get_drvdata(rdev);
    if (info == core::ptr::null_mut()) {
    dev_err(rdev_get_dev(rdev), "regulator info null pointer\n");
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn ab8500_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(val_idle: val ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ab8500_regulator_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn abx500_get_regulator_info(ab8500: *mut ab8500) {
    ...
    struct ab8500_regulator_info *info = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ab8500_regulator_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ab8500_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ab8500_regulator_exit() -> void __exit {
