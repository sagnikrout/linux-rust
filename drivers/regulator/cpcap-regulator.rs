...
//! Source: drivers/regulator/cpcap-regulator.c
#![no_std]
...
pub const CPCAP_BIT_AUDIO_NORMAL_MODE: c_uint = 0x00;
//
...
//
#[no_mangle]
unsafe extern "C" fn cpcap_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cpcap_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpcap_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cpcap_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn cpcap_regulator_probe(pdev: *mut platform_device) -> c_int {
