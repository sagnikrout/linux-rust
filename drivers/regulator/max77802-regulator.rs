...
//! Source: drivers/regulator/max77802-regulator.c
#![no_std]
...
pub const MAX77802_OPMODE_SHIFT_LDO: c_int = 6;
pub const MAX77802_OPMODE_BUCK234_SHIFT: c_int = 4;
pub const MAX77802_OPMODE_MASK: c_uint = 0x3;
pub const MAX77802_VSEL_MASK: c_uint = 0x3F;
pub const MAX77802_DVS_VSEL_MASK: c_uint = 0xFF;
pub const MAX77802_RAMP_RATE_MASK_2BIT: c_uint = 0xC0;
pub const MAX77802_RAMP_RATE_SHIFT_2BIT: c_int = 6;
pub const MAX77802_RAMP_RATE_MASK_4BIT: c_uint = 0xF0;
pub const MAX77802_RAMP_RATE_SHIFT_4BIT: c_int = 4;
pub const MAX77802_STATUS_OFF: c_uint = 0x0;
pub const MAX77802_OFF_PWRREQ: c_uint = 0x1;
pub const MAX77802_LP_PWRREQ: c_uint = 0x2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max77802_regulator_prv {
// Array indexed by regulator id
    pub opmode: [c_uint; MAX77802_REG_MAX],
}

#[no_mangle]
pub unsafe extern "C" fn max77802_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn max77802_get_opmode_shift(id: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max77802_set_suspend_disable(rdev: *mut regulator_dev) -> c_int {
    static int max77802_set_suspend_disable(struct regulator_dev *rdev)
    {
    let mut val: c_uint = MAX77802_OFF_PWRREQ;
    struct max77802_regulator_prv *max77802 = rdev_get_drvdata(rdev);
    let mut id: c_uint = rdev_get_id(rdev);
    let mut shift: c_int = max77802_get_opmode_shift(id);
...
//
#[no_mangle]
unsafe extern "C" fn max77802_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77802_get_mode(rdev: *mut regulator_dev) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn max77802_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77802_pmic_probe(pdev: *mut platform_device) -> c_int {
    ...
    let mut id: c_uint = regulators[i].id;
    let mut shift: c_int = max77802_get_opmode_shift(id);
    int ret;
