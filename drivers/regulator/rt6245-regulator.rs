...
//! Source: drivers/regulator/rt6245-regulator.c
#![no_std]
...
pub const RT6245_VIRT_OCLIMIT: c_uint = 0x00;
pub const RT6245_VIRT_OTLEVEL: c_uint = 0x01;
pub const RT6245_VIRT_PGDLYTIME: c_uint = 0x02;
pub const RT6245_VIRT_SLEWRATE: c_uint = 0x03;
pub const RT6245_VIRT_SWFREQ: c_uint = 0x04;
pub const RT6245_VIRT_VOUT: c_uint = 0x05;

// HW Enable + Soft start time
pub const RT6245_ENTIME_IN_US: c_int = 5000;
pub const RT6245_VOUT_MINUV: c_int = 437500;
pub const RT6245_VOUT_MAXUV: c_int = 1387500;
pub const RT6245_VOUT_STEPUV: c_int = 12500;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt6245_priv {
    pub enable_gpio: *mut gpio_desc,
    pub enable_state: bool,
}

#[no_mangle]
unsafe extern "C" fn rt6245_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6245_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6245_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6245_init_device_properties(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6245_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6245_probe(i2c: *mut i2c_client) -> c_int {
    ...
    usleep_range(RT6245_ENTIME_IN_US, RT6245_ENTIME_IN_US + 1000);
    regmap = devm_regmap_init(&i2c.dev, core::ptr::null_mut(), i2c, &rt6245_regmap_config);
    if (IS_ERR(regmap)) {
