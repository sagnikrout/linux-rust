...
//! Source: drivers/regulator/lp3971.c
#![no_std]
...
pub const LP3971_SYS_CONTROL1_REG: c_uint = 0x07;
// System control register 1 initial value,
    bits 4 and 5 are EPROM programmable */
pub const SYS_CONTROL1_INIT_VAL: c_uint = 0x40;
pub const SYS_CONTROL1_INIT_MASK: c_uint = 0xCF;
pub const LP3971_BUCK_VOL_ENABLE_REG: c_uint = 0x10;
pub const LP3971_BUCK_VOL_CHANGE_REG: c_uint = 0x20;
...
pub const BUCK_VOL_CHANGE_FLAG_GO: c_uint = 0x01;
pub const BUCK_VOL_CHANGE_FLAG_TARGET: c_uint = 0x02;
pub const BUCK_VOL_CHANGE_FLAG_MASK: c_uint = 0x03;
pub const LP3971_BUCK1_BASE: c_uint = 0x23;
pub const LP3971_BUCK2_BASE: c_uint = 0x29;
pub const LP3971_BUCK3_BASE: c_uint = 0x32;
...
pub const BUCK_TARGET_VOL_MASK: c_uint = 0x3f;

pub const LP3971_LDO_ENABLE_REG: c_uint = 0x12;
pub const LP3971_LDO_VOL_CONTR_BASE: c_uint = 0x39;
...
pub const LDO_VOL_CONTR_MASK: c_uint = 0x0f;
...
pub const LDO_VOL_MIN_IDX: c_uint = 0x00;
pub const LDO_VOL_MAX_IDX: c_uint = 0x0f;
#[no_mangle]
unsafe extern "C" fn lp3971_ldo_is_enabled(dev: *mut regulator_dev) -> c_int {
    static int lp3971_ldo_is_enabled(struct regulator_dev *dev)
    {
    struct lp3971 *lp3971 = rdev_get_drvdata(dev);
    let mut ldo: c_int = rdev_get_id(dev) - LP3971_LDO1;
    let mut mask: u16 = 1 << (1 + ldo);
    u16 val;
    val = lp3971_reg_read(lp3971, LP3971_LDO_ENABLE_REG);
    return (val & mask) != 0;
    }
#[no_mangle]
unsafe extern "C" fn lp3971_ldo_enable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3971_ldo_disable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3971_ldo_get_voltage_sel(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3971_dcdc_is_enabled(dev: *mut regulator_dev) -> c_int {
    static int lp3971_dcdc_is_enabled(struct regulator_dev *dev)
    {
    struct lp3971 *lp3971 = rdev_get_drvdata(dev);
    let mut buck: c_int = rdev_get_id(dev) - LP3971_DCDC1;
...
#[no_mangle]
unsafe extern "C" fn lp3971_dcdc_enable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3971_dcdc_disable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3971_dcdc_get_voltage_sel(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lp3971_reg_read(lp3971: *mut lp3971, reg: u8) -> u8 {
    static u8 lp3971_reg_read(struct lp3971 *lp3971, u8 reg)
    {
    let mut val: u16 = 0;
...
#[no_mangle]
unsafe extern "C" fn lp3971_set_bits(lp3971: *mut lp3971, reg: u8, mask: u16, val: u16) -> c_int {
    static int lp3971_set_bits(struct lp3971 *lp3971, u8 reg, u16 mask, u16 val)
    {
    u16 tmp;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn lp3971_i2c_probe(i2c: *mut i2c_client) -> c_int {
