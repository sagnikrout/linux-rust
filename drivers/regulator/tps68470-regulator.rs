...
//! Source: drivers/regulator/tps68470-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps68470_regulator_data {
    pub clk: *mut clk,
}
...
#[no_mangle]
unsafe extern "C" fn tps68470_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps68470_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps68470_regulator_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tps68470_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tps68470_regulator_exit() -> void __exit {
