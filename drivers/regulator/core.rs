...
//! Source: drivers/regulator/core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct regulator_map {
    pub list: list_head,
    pub /: *const *const *const char dev_name; / The dev_name() for the consumer,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct regulator_enable_gpio {
    pub list: list_head,
    pub gpiod: *mut gpio_desc,
    pub /: *mut *mut u32 enable_count; / a number of enabled shared GPIO,
    pub /: *mut *mut u32 request_count; / a number of requested shared GPIO,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct regulator_supply_alias {
    pub list: list_head,
    pub src_dev: *mut device,
    pub src_supply: *const c_char,
    pub alias_dev: *mut device,
    pub alias_supply: *const c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct regulator_event_work {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdev->desc->name) -> else {
...
#[no_mangle]
unsafe extern "C" fn have_full_constraints() -> bool {
    static bool have_full_constraints(void)
    {
    return has_full_constraints || of_have_populated_dt();
    }
#[no_mangle]
unsafe extern "C" fn regulator_ops_is_valid(rdev: *mut regulator_dev, ops: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn regulator_lock(rdev: *mut regulator_dev) {
    static void regulator_lock(struct regulator_dev *rdev)
    {
    regulator_lock_nested(rdev, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn regulator_unlock(rdev: *mut regulator_dev) {
    static void regulator_unlock(struct regulator_dev *rdev)
    {
    mutex_lock(&regulator_nesting_mutex);
    if (--rdev.ref_cnt == 0) {
    rdev.mutex_owner = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn regulator_supply_is_couple(rdev: *mut regulator_dev) -> bool {
...
//
    ...
    struct ww_acquire_ctx *ww_ctx)
    {
    struct regulator_dev *new_contended_rdev = core::ptr::null_mut();
    struct regulator_dev *old_contended_rdev = core::ptr::null_mut();
    int err;
...
#[no_mangle]
unsafe extern "C" fn regulator_check_states(state: suspend_state_t) -> c_int {
...
// mode /= 2;
    ...
    {
    if (rdev.constraints == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn regulator_print_opmode(buf: *mut c_char, mode: c_int) -> isize {
...
#[no_mangle]
unsafe extern "C" fn regulator_print_state(buf: *mut c_char, state: c_int) -> isize {
...
pub unsafe extern "C" fn if(0: state ==) -> else {
    ...
    report = "unknown";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: bypass) -> else {
    else if (bypass)
    report = "enabled";
    else
    report = "disabled";
...
//
#[no_mangle]
unsafe extern "C" fn drms_uA_update(rdev: *mut regulator_dev) -> c_int {
    static int drms_uA_update(struct regulator_dev *rdev)
    {
    struct regulator *sibling;
    let mut current_uA: c_int = 0, output_uV, input_uV, err;
    unsigned int mode;
//
...
// check the new mode is allowed
    ...
    else /* OK if set_suspend_enable or set_suspend_disable is core::ptr::null_mut() */
    ret = 0;
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn suspend_set_initial_state(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn print_constraints_debug(rdev: *mut regulator_dev) {
    static void print_constraints_debug(struct regulator_dev *rdev)
    {
    struct regulation_constraints *constraints = rdev.constraints;
    char buf[160] = "";
    let mut len: usize = sizeof(buf) - 1;
...
#[no_mangle]
unsafe extern "C" fn print_constraints(rdev: *mut regulator_dev) {
...
//
    ...
    let mut count: c_int = rdev.desc.n_voltages;
    int	i;
    let mut min_uV: c_int = INT_MAX;
    let mut max_uV: c_int = INT_MIN;
    let mut cmin: c_int = constraints.min_uV;
    let mut cmax: c_int = constraints.max_uV;
...
// do we need to apply the constraint voltage
    ...
    let mut current_uV: c_int = regulator_get_voltage_rdev(rdev);
...
//
    ...
    let mut lim: c_int = rdev.constraints.over_curr_limits.prot;
...
//
    if (rdev.constraints.always_on || rdev.constraints.boot_on) {
    let mut supply_enabled: bool = false;
...
//
#[no_mangle]
unsafe extern "C" fn regulator_event_work_fn(work: *mut work_struct) {
    ...
    int ret;
    regulator_lock(rdev);
    ret = regulator_notifier_call_chain(rdev, rew.event, core::ptr::null_mut());
    regulator_unlock(rdev);
    if (ret == NOTIFY_BAD)
...
//
#[no_mangle]
unsafe extern "C" fn register_regulator_event_forwarding(rdev: *mut regulator_dev) -> c_int {
    ...
    ERR_PTR(ret));
    rdev.supply_fwd_nb.notifier_call = core::ptr::null_mut();
    return ret;
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn unregister_regulator_event_forwarding(rdev: *mut regulator_dev) {
...
//
    ...
    if (rdev.supply == core::ptr::null_mut()) {
...
//
    ...
    int has_dev;
    if (supply == core::ptr::null_mut())
    return -EINVAL;
    if (consumer_dev_name != core::ptr::null_mut())
    has_dev = 1;
    else
    has_dev = 0;
    new_node = kzalloc_obj(struct regulator_map);
    if (new_node == core::ptr::null_mut())
    return -ENOMEM;
    new_node.regulator = rdev;
    new_node.supply = supply;
    if (has_dev) {
    new_node.dev_name = kstrdup(consumer_dev_name, GFP_KERNEL);
    if (new_node.dev_name == core::ptr::null_mut()) {
    kfree(new_node);
    return -ENOMEM;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn unset_regulator_supplies(rdev: *mut regulator_dev) {
...
// non-fatal
    ...
    regulator.debugfs = core::ptr::null_mut();
    }
    }
    ...
    if (supply_name == core::ptr::null_mut())
    return core::ptr::null_mut();
    } else {
    ...
    if (regulator == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn _regulator_get_enable_time(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_supply_alias(dev: *mut device, supply: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn regulator_match(dev: *mut device, data: *const c_void) -> c_int {
    ...
    {
    struct device *dev;
    dev = class_find_device(&regulator_class, core::ptr::null_mut(), name, regulator_match);
    return dev ? dev_to_rdev(dev) : core::ptr::null_mut();
    }
    static struct regulator_dev *regulator_dt_lookup(struct device *dev,
    const char *supply)
    {
    struct regulator_dev *r = core::ptr::null_mut();
    if (dev_of_node(dev)) {
...
#[no_mangle]
unsafe extern "C" fn regulator_resolve_supply(rdev: *mut regulator_dev) -> c_int {
...
// Constraints might still be pending due to concurrency.
    let mut done: bool = !rdev.constraints_pending;
    supply = rdev.supply;
...
#[no_mangle]
unsafe extern "C" fn destroy_regulator(regulator: *mut regulator) {
    static void destroy_regulator(struct regulator *regulator)
    {
...
#[no_mangle]
unsafe extern "C" fn _regulator_put(regulator: *mut regulator) {
    static void _regulator_put(struct regulator *regulator)
    {
    struct regulator_dev *rdev;
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_put(regulator: *mut regulator) {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_unregister_supply_alias(dev: *mut device, id: *const c_char) {
...
//
    ...
    if (new_pin == core::ptr::null_mut()) {
    mutex_unlock(&regulator_list_mutex);
    return -ENOMEM;
    }
    skip_compare:
    pin = new_pin;
    new_pin = core::ptr::null_mut();
    pin.gpiod = gpiod;
...
#[no_mangle]
unsafe extern "C" fn regulator_ena_gpio_free(rdev: *mut regulator_dev) {
...
// Free the GPIO only in case of no use
    ...
    rdev.ena_pin = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn regulator_ena_gpio_ctrl(rdev: *mut regulator_dev, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn _regulator_check_status_enabled(rdev: *mut regulator_dev) -> c_int {
    static inline int _regulator_check_status_enabled(struct regulator_dev *rdev)
    {
    let mut ret: c_int = rdev.desc.ops.get_status(rdev);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn _regulator_do_enable(rdev: *mut regulator_dev) -> c_int {
    static int _regulator_do_enable(struct regulator_dev *rdev)
    {
    int ret, delay;
...
//
    let mut end: ktime_t = ktime_add_us(rdev.last_off, rdev.desc.off_on_delay);
    let mut remaining: i64 = ktime_us_delta(end, ktime_get_boottime());
    if (remaining > 0)
    fsleep(remaining);
    }
    if (rdev.ena_pin) {
...
//
    ...
    let mut time_remaining: c_int = delay;
...
//
#[no_mangle]
unsafe extern "C" fn _regulator_handle_consumer_enable(regulator: *mut regulator) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn _regulator_handle_consumer_disable(regulator: *mut regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _regulator_enable(regulator: *mut regulator) -> c_int {
    static int _regulator_enable(struct regulator *regulator)
    {
    struct regulator_dev *rdev = regulator.rdev;
    int ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_enable(regulator: *mut regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _regulator_do_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _regulator_disable(regulator: *mut regulator) -> c_int {
    static int _regulator_disable(struct regulator *regulator)
    {
    struct regulator_dev *rdev = regulator.rdev;
    let mut ret: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_disable(regulator: *mut regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _regulator_force_disable(rdev: *mut regulator_dev) -> c_int {
    static int _regulator_force_disable(struct regulator_dev *rdev)
    {
    let mut ret: c_int = 0;
    lockdep_assert_held_once(&rdev.mutex.base);
    ret = _notifier_call_chain(rdev, REGULATOR_EVENT_FORCE_DISABLE |
    REGULATOR_EVENT_PRE_DISABLE, core::ptr::null_mut());
    if (ret & NOTIFY_STOP_MASK)
    return -EINVAL;
    ret = _regulator_do_disable(rdev);
    if (ret < 0) {
    ...
    REGULATOR_EVENT_ABORT_DISABLE, core::ptr::null_mut());
    return ret;
    }
    _notifier_call_chain(rdev, REGULATOR_EVENT_FORCE_DISABLE |
    REGULATOR_EVENT_DISABLE, core::ptr::null_mut());
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_force_disable(regulator: *mut regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_disable_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_disable_deferred(regulator: *mut regulator, ms: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
    static int _regulator_is_enabled(struct regulator_dev *rdev)
    {
...
// If we don't know then assume that the regulator is always on
    ...
    ret = 0;
#[no_mangle]
pub unsafe extern "C" fn if(rdev->constraints->max_uV: ret >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_is_enabled(regulator: *mut regulator) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_count_voltages(regulator: *mut regulator) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_list_voltage(regulator: *mut regulator, selector: unsigned) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_hardware_enable(regulator: *mut regulator, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_linear_step(regulator: *mut regulator) -> c_uint {
...
//
    ...
    {
    let mut ramp_delay: c_uint = 0;
    if (rdev.constraints.ramp_delay)
    ramp_delay = rdev.constraints.ramp_delay;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdev->desc->ramp_delay) -> else {
    else if (rdev.desc.ramp_delay)
    ramp_delay = rdev.desc.ramp_delay;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdev->constraints->settling_time) -> else {
    ...
    let mut best_val: c_int = 0;
    unsigned int selector;
    let mut old_selector: c_int = -1;
    const struct regulator_ops *ops = rdev.desc.ops;
    let mut old_uV: c_int = regulator_get_voltage_rdev(rdev);
...
//
    ...
    ret = 0;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdev->desc->vsel_step) -> else {
...
#[no_mangle]
unsafe extern "C" fn regulator_get_voltage_delta(rdev: *mut regulator_dev, uV: c_int) -> c_int {
...
// check that voltage is converging quickly enough
    ...
    {
    let mut best_supply_uV: c_int = 0;
    let mut supply_change_uV: c_int = 0;
    int ret;
    if (rdev.supply &&
...
// min_uV);
    ...
    struct regulation_constraints *constraints = rdev.constraints;
    let mut desired_min_uV: c_int = 0, desired_max_uV = INT_MAX;
    let mut max_current_uV: c_int = 0, min_current_uV = INT_MAX;
    let mut highest_min_uV: c_int = 0, target_uV, possible_uV;
...
// Find highest min desired voltage
    ...
    let mut tmp_min: c_int = 0;
    let mut tmp_max: c_int = INT_MAX;
...
//
    let mut optimal_uV: c_int = 0, optimal_max_uV = 0, current_uV = 0;
...
// Nothing to change, return successfully
    ...
    let mut skip_coupled: bool = false;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_voltage(regulator: *mut regulator, min_uV: c_int, max_uV: c_int) -> c_int {
...
//
    ...
    struct regulator_dev *rdev = regulator.rdev;
    const struct regulator_ops *ops = rdev.desc.ops;
    let mut old_sel: c_int = -1;
    let mut new_sel: c_int = -1;
    int voltage;
    int i;
    if (ops.set_voltage_time)
    return ops.set_voltage_time(rdev, old_uV, new_uV);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !ops->set_voltage_time_sel) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn regulator_sync_voltage_rdev(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_sync_voltage(regulator: *mut regulator) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn regulator_get_voltage_rdev(rdev: *mut regulator_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_voltage(regulator: *mut regulator) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _regulator_get_current_limit_unlocked(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _regulator_get_current_limit(rdev: *mut regulator_dev) -> c_int {
    static int _regulator_get_current_limit(struct regulator_dev *rdev)
    {
    int ret;
    regulator_lock(rdev);
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_current_limit(regulator: *mut regulator) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_unclaimed_power_budget(regulator: *mut regulator) -> c_int {
...
//
    ...
    {
    struct regulator_dev *rdev = regulator.rdev;
    let mut ret: c_int = 0, pw_tot_req;
    regulator_lock(rdev);
    if (rdev.supply) {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_mode(regulator: *mut regulator, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _regulator_get_mode_unlocked(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn _regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
    static unsigned int _regulator_get_mode(struct regulator_dev *rdev)
    {
    int ret;
    regulator_lock(rdev);
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_get_mode(regulator: *mut regulator) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rdev_get_cached_err_flags(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !rdev->use_cached_err) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_load(regulator: *mut regulator, uA_load: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_allow_bypass(regulator: *mut regulator, enable: bool) -> c_int {
...
// call rdev chain first
    let mut ret: c_int = blocking_notifier_call_chain(&rdev.notifier, event, data);
...
// Avoid duplicate debugfs directory names
    ...
    consumers[i].consumer = core::ptr::null_mut();
    for (i = 0; i < num_consumers; i++) {
...
#[no_mangle]
unsafe extern "C" fn regulator_bulk_enable_async(data: *mut c_void, cookie: async_cookie_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_mode_to_status(mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn rdev_init_debugfs(rdev: *mut regulator_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn regulator_coupler_register(coupler: *mut regulator_coupler) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_resolve_coupling(rdev: *mut regulator_dev) {
    static void regulator_resolve_coupling(struct regulator_dev *rdev)
    {
    struct regulator_coupler *coupler = rdev.coupling_desc.coupler;
    struct coupling_desc *c_desc = &rdev.coupling_desc;
    let mut n_coupled: c_int = c_desc.n_coupled;
    struct regulator_dev *c_rdev;
    int i;
    for (i = 1; i < n_coupled; i++) {
// already resolved
...
#[no_mangle]
unsafe extern "C" fn regulator_remove_coupling(rdev: *mut regulator_dev) {
    ...
    if (__c_rdev == rdev) {
    __c_desc.coupled_rdevs[k] = core::ptr::null_mut();
    __c_desc.n_resolved--;
    break;
    }
    }
    regulator_unlock(c_rdev);
    c_desc.coupled_rdevs[i] = core::ptr::null_mut();
    c_desc.n_resolved--;
    }
    ...
    rdev.coupling_desc.coupled_rdevs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn regulator_init_coupling(rdev: *mut regulator_dev) -> c_int {
...
//
    ...
    struct regulator_config *config = core::ptr::null_mut();
    let mut regulator_no: static atomic_t = ATOMIC_INIT(-1);
    struct regulator_dev *rdev;
    let mut tried_supply_resolve: bool = false;
    let mut dangling_cfg_gpiod: bool = false;
    let mut dangling_of_gpiod: bool = false;
    int ret, i;
    if (cfg == core::ptr::null_mut())
    return ERR_PTR(-EINVAL);
    if (cfg.ena_gpiod)
    dangling_cfg_gpiod = true;
    if (regulator_desc == core::ptr::null_mut()) {
    ret = -EINVAL;
    goto rinse;
    }
    WARN_ON(!dev || !cfg.dev);
    if (regulator_desc.name == core::ptr::null_mut() || regulator_desc.ops == core::ptr::null_mut()) {
    ret = -EINVAL;
    goto rinse;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev_get_regmap(dev, _arg: NULL)) -> else {
    else if (dev_get_regmap(dev, core::ptr::null_mut()))
    rdev.regmap = dev_get_regmap(dev, core::ptr::null_mut());
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev->parent) -> else {
    else if (dev.parent)
    rdev.regmap = dev_get_regmap(dev.parent, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: regulator_desc->supply_name) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_unregister(rdev: *mut regulator_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn regulator_suspend(dev: *mut device) -> c_int {
    static int regulator_suspend(struct device *dev)
    {
    struct regulator_dev *rdev = dev_to_rdev(dev);
    let mut state: suspend_state_t = pm_suspend_target_state;
    int ret;
    const struct regulator_state *rstate;
...
#[no_mangle]
unsafe extern "C" fn regulator_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_bus_probe(bdev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_has_full_constraints() {
...
//
#[no_mangle]
pub unsafe extern "C" fn regulator_set_drvdata(regulator: *mut regulator, data: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdev_get_id(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn supply_map_show(sf: *mut seq_file, data: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct summary_data {
    pub s: *mut seq_file,
    pub parent: *mut regulator_dev,
    pub level: c_int,
}
    ...
    int level);
#[no_mangle]
unsafe extern "C" fn regulator_summary_show_children(dev: *mut device, data: *mut c_void) -> c_int {
    ...
    class_for_each_device(&regulator_class, core::ptr::null_mut(), &summary_data,
    regulator_summary_show_children);
    }
#[repr(C)]
#[derive(Copy, Clone)]
pub struct summary_lock_data {
    pub ww_ctx: *mut ww_acquire_ctx,
    pub new_contended_rdev: *mut regulator_dev,
    pub old_contended_rdev: *mut regulator_dev,
}

#[no_mangle]
unsafe extern "C" fn regulator_summary_lock_one(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_summary_unlock_one(dev: *mut device, data: *mut c_void) -> c_int {
    ...
    ret = class_for_each_device(&regulator_class, core::ptr::null_mut(), &lock_data,
    regulator_summary_lock_one);
    if (ret)
    class_for_each_device(&regulator_class, core::ptr::null_mut(), &lock_data,
    regulator_summary_unlock_one);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn regulator_summary_lock(ww_ctx: *mut ww_acquire_ctx) {
...
#[no_mangle]
unsafe extern "C" fn regulator_summary_unlock(ww_ctx: *mut ww_acquire_ctx) {
    static void regulator_summary_unlock(struct ww_acquire_ctx *ww_ctx)
    {
    class_for_each_device(&regulator_class, core::ptr::null_mut(), core::ptr::null_mut(),
    regulator_summary_unlock_one);
    ww_acquire_fini(ww_ctx);
    mutex_unlock(&regulator_list_mutex);
    }
#[no_mangle]
unsafe extern "C" fn regulator_summary_show_roots(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_summary_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    ...
    class_for_each_device(&regulator_class, core::ptr::null_mut(), s,
...
#[no_mangle]
unsafe extern "C" fn regulator_init() -> int __init {
    ...
    if (ret)
    goto err_driver;
    debugfs_root = debugfs_create_dir("regulator", core::ptr::null_mut());
    if (IS_ERR(debugfs_root))
    pr_debug("regulator: Failed to create debugfs directory\n");

    debugfs_create_file("supply_map", 0444, debugfs_root, core::ptr::null_mut(),
    &supply_map_fops);
    debugfs_create_file("regulator_summary", 0444, debugfs_root,
    core::ptr::null_mut(), &regulator_summary_fops);
...
#[no_mangle]
unsafe extern "C" fn regulator_late_cleanup(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regulator_ignore_unused_setup(__unused: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn regulator_init_complete_work_function(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn regulator_init_complete() -> int __init {
