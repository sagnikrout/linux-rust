...
//! Source: drivers/regulator/bd9576-regulator.c
#![no_std]
...
pub const BD957X_VOUTS1_VOLT: c_int = 3300000;
pub const BD957X_VOUTS4_BASE_VOLT: c_int = 1030000;
pub const BD957X_VOUTS34_NUM_VOLT: c_int = 32;

pub const BD9576_xVD_IRQ_MASK_VOUT1TO4: c_uint = 0x0F;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd957x_regulator_data {
    pub desc: regulator_desc,
    pub base_voltage: c_int,
    pub rdev: *mut regulator_dev,
    pub ovd_notif: c_int,
    pub uvd_notif: c_int,
    pub temp_notif: c_int,
    pub ovd_err: c_int,
    pub uvd_err: c_int,
    pub temp_err: c_int,
    pub xvd_ranges: *const linear_range,
    pub num_xvd_ranges: c_int,
    pub oc_supported: bool,
    pub ovd_reg: c_uint,
    pub uvd_reg: c_uint,
    pub xvd_mask: c_uint,
    pub ocp_reg: c_uint,
...
pub const BD9576_NUM_REGULATORS: c_int = 6;
pub const BD9576_NUM_OVD_REGULATORS: c_int = 5;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bd957x_data {
    pub regulator_data: [bd957x_regulator_data; BD9576_NUM_REGULATORS],
    pub regmap: *mut regmap,
    pub therm_irq_suppress: delayed_work,
    pub ovd_irq_suppress: delayed_work,
    pub uvd_irq_suppress: delayed_work,
    pub therm_irq: c_uint,
    pub ovd_irq: c_uint,
    pub uvd_irq: c_uint,
    pub err_lock: spinlock_t,
    pub regulator_global_err: c_int,
}
    ...
    let mut multiplier: c_int = selector & desc.vsel_mask & 0x7f;
    int tune;
// VOUT3 and 4 has 10mV step
    ...
    {
    const struct regulator_desc *desc = rdev.desc;
    let mut index: c_int = selector & desc.vsel_mask & 0x7f;
    if (!(selector & 0x80))
...
//
    ...
    let mut warn: bool = severity == REGULATOR_SEVERITY_WARN;
...
#[no_mangle]
unsafe extern "C" fn bd9576_renable(rid: *mut regulator_irq_data, reg: c_int, mask: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd9576_uvd_renable(rid: *mut regulator_irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd9576_ovd_renable(rid: *mut regulator_irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bd9576_temp_renable(rid: *mut regulator_irq_data) -> c_int {
...
pub const BD9576_DEV_MASK_ALL_REGULATORS: c_uint = 0x3F;
...
#[no_mangle]
unsafe extern "C" fn bd957x_probe(pdev: *mut platform_device) -> c_int {
...
// Register notifiers - can fail if IRQ is not given
    ...
    irq, 0, uvd_errs, core::ptr::null_mut(),
    &rdevs[0],
    ...
    irq, 0, ovd_errs, core::ptr::null_mut(),
    &ovd_devs[0],
    ...
    irq, 0, temp_errs, core::ptr::null_mut(),
    &rdevs[0],
    BD9576_NUM_REGULATORS);
    if (IS_ERR(ret)) {
    if (PTR_ERR(ret) == -EPROBE_DEFER)
