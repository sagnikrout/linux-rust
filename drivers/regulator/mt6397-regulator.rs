...
//! Source: drivers/regulator/mt6397-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6397_regulator_info {
...
#[no_mangle]
unsafe extern "C" fn mt6397_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6397_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6397_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6397_set_buck_vosel_reg(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6397_regulator_probe(pdev: *mut platform_device) -> c_int {
