...
//! Source: drivers/regulator/mc13783-regulator.c
#![no_std]
...
pub const MC13783_REG_SWITCHERS0: c_int = 24;
// Enable does not exist for SW1A
pub const MC13783_REG_SWITCHERS0_SW1AEN: c_int = 0;
pub const MC13783_REG_SWITCHERS0_SW1AVSEL: c_int = 0;

pub const MC13783_REG_SWITCHERS1: c_int = 25;
// Enable does not exist for SW1B
pub const MC13783_REG_SWITCHERS1_SW1BEN: c_int = 0;
pub const MC13783_REG_SWITCHERS1_SW1BVSEL: c_int = 0;

pub const MC13783_REG_SWITCHERS2: c_int = 26;
// Enable does not exist for SW2A
pub const MC13783_REG_SWITCHERS2_SW2AEN: c_int = 0;
pub const MC13783_REG_SWITCHERS2_SW2AVSEL: c_int = 0;

pub const MC13783_REG_SWITCHERS3: c_int = 27;
// Enable does not exist for SW2B
pub const MC13783_REG_SWITCHERS3_SW2BEN: c_int = 0;
pub const MC13783_REG_SWITCHERS3_SW2BVSEL: c_int = 0;

pub const MC13783_REG_SWITCHERS5: c_int = 29;

pub const MC13783_REG_SWITCHERS5_SW3VSEL: c_int = 18;

pub const MC13783_REG_REGULATORSETTING0: c_int = 30;
pub const MC13783_REG_REGULATORSETTING0_VIOLOVSEL: c_int = 2;
pub const MC13783_REG_REGULATORSETTING0_VDIGVSEL: c_int = 4;
pub const MC13783_REG_REGULATORSETTING0_VGENVSEL: c_int = 6;
pub const MC13783_REG_REGULATORSETTING0_VRFDIGVSEL: c_int = 9;
pub const MC13783_REG_REGULATORSETTING0_VRFREFVSEL: c_int = 11;
pub const MC13783_REG_REGULATORSETTING0_VRFCPVSEL: c_int = 13;
pub const MC13783_REG_REGULATORSETTING0_VSIMVSEL: c_int = 14;
pub const MC13783_REG_REGULATORSETTING0_VESIMVSEL: c_int = 15;
pub const MC13783_REG_REGULATORSETTING0_VCAMVSEL: c_int = 16;

pub const MC13783_REG_REGULATORSETTING1: c_int = 31;
pub const MC13783_REG_REGULATORSETTING1_VVIBVSEL: c_int = 0;
pub const MC13783_REG_REGULATORSETTING1_VRF1VSEL: c_int = 2;
pub const MC13783_REG_REGULATORSETTING1_VRF2VSEL: c_int = 4;
pub const MC13783_REG_REGULATORSETTING1_VMMC1VSEL: c_int = 6;
pub const MC13783_REG_REGULATORSETTING1_VMMC2VSEL: c_int = 9;

pub const MC13783_REG_REGULATORMODE0: c_int = 32;

pub const MC13783_REG_REGULATORMODE1: c_int = 33;

pub const MC13783_REG_POWERMISC: c_int = 34;
...
#[no_mangle]
unsafe extern "C" fn mc13783_gpo_regulator_enable(rdev: *mut regulator_dev) -> c_int {
    static int mc13783_gpo_regulator_enable(struct regulator_dev *rdev)
    {
    struct mc13xxx_regulator_priv *priv = rdev_get_drvdata(rdev);
    struct mc13xxx_regulator *mc13xxx_regulators = priv.mc13xxx_regulators;
    let mut id: c_int = rdev_get_id(rdev);
    let mut en_val: u32 = mc13xxx_regulators[id].enable_bit;
...
#[no_mangle]
unsafe extern "C" fn mc13783_gpo_regulator_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13783_gpo_regulator_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13783_regulator_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mc13783_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mc13783_regulator_exit() -> void __exit {
