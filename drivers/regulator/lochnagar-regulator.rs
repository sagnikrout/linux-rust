...
//! Source: drivers/regulator/lochnagar-regulator.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn lochnagar_micbias_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lochnagar_micbias_disable(rdev: *mut regulator_dev) -> c_int {
    ...
    let mut mask: c_int = LOCHNAGAR2_P1_MICBIAS_SRC_MASK << shift;
    unsigned int val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn lochnagar_regulator_probe(pdev: *mut platform_device) -> c_int {
