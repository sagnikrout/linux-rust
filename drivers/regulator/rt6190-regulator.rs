...
//! Source: drivers/regulator/rt6190-regulator.c
#![no_std]
...
pub const RT6190_REG_VID: c_uint = 0x00;
pub const RT6190_REG_OUTV: c_uint = 0x01;
pub const RT6190_REG_OUTC: c_uint = 0x03;
pub const RT6190_REG_SET1: c_uint = 0x0D;
pub const RT6190_REG_SET2: c_uint = 0x0E;
pub const RT6190_REG_SET4: c_uint = 0x10;
pub const RT6190_REG_RATIO: c_uint = 0x11;
pub const RT6190_REG_OUT_VOLT_L: c_uint = 0x12;
pub const RT6190_REG_TEMP_H: c_uint = 0x1B;
pub const RT6190_REG_STAT1: c_uint = 0x1C;
pub const RT6190_REG_ALERT1: c_uint = 0x1E;
pub const RT6190_REG_ALERT2: c_uint = 0x1F;
pub const RT6190_REG_MASK2: c_uint = 0x21;
pub const RT6190_REG_OCPEN: c_uint = 0x28;
pub const RT6190_REG_SET5: c_uint = 0x29;
pub const RT6190_REG_VBUSC_ADC: c_uint = 0x32;
pub const RT6190_REG_BUSC_VOLT_L: c_uint = 0x33;
pub const RT6190_REG_BUSC_VOLT_H: c_uint = 0x34;
pub const RT6190_REG_STAT3: c_uint = 0x37;
pub const RT6190_REG_ALERT3: c_uint = 0x38;
pub const RT6190_REG_MASK3: c_uint = 0x39;

pub const RICHTEK_VID: c_uint = 0x82;
pub const RT6190_OUT_MIN_UV: c_int = 3000000;
pub const RT6190_OUT_MAX_UV: c_int = 32000000;
pub const RT6190_OUT_STEP_UV: c_int = 20000;

pub const RT6190_OUTV_MINSEL: c_int = 150;
pub const RT6190_OUT_MIN_UA: c_int = 306000;
pub const RT6190_OUT_MAX_UA: c_int = 12114000;
pub const RT6190_OUT_STEP_UA: c_int = 24000;
pub const RT6190_OUTC_MINSEL: c_int = 19;
pub const RT6190_EN_TIME_US: c_int = 500;
pub const RT6190_PSM_MODE: c_int = 0;
pub const RT6190_FCCM_MODE: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rt6190_data {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub enable_gpio: *mut gpio_desc,
    pub cached_alert_evt: c_uint,
}
    ...
    let mut le_sel: __le16 = cpu_to_le16(selector);
    return regmap_raw_write(regmap, RT6190_REG_OUTV, &le_sel,
    sizeof(le_sel));
    }
#[no_mangle]
unsafe extern "C" fn rt6190_out_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6190_out_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6190_out_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6190_out_get_current_limit(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6190_out_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6190_out_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rt6190_out_of_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn rt6190_is_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rt6190_irq_handler(irq: c_int, devid: *mut c_void) -> irqreturn_t {
...
// Write clear alert events
    ...
    regulator_notifier_call_chain(rdev, REGULATOR_EVENT_OVER_TEMP, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rt6190_init_registers(regmap: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6190_probe(i2c: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6190_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rt6190_runtime_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(rt6190_runtime_suspend, rt6190_runtime_resume, core::ptr::null_mut())
    };
