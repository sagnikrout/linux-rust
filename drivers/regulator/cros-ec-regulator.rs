...
//! Source: drivers/regulator/cros-ec-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_regulator_data {
    pub desc: regulator_desc,
    pub dev: *mut regulator_dev,
    pub ec_dev: *mut cros_ec_device,
    pub index: u32,
    pub voltages_mV: *mut u16,
    pub num_voltages: u16,
}

#[no_mangle]
unsafe extern "C" fn cros_ec_regulator_enable(dev: *mut regulator_dev) -> c_int {
    ...
    sizeof(cmd), core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_regulator_disable(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_regulator_is_enabled(dev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_regulator_get_voltage(dev: *mut regulator_dev) -> c_int {
    ...
    {
    struct cros_ec_regulator_data *data = rdev_get_drvdata(dev);
    let mut min_mV: c_int = DIV_ROUND_UP(min_uV, 1000);
    let mut max_mV: c_int = max_uV / 1000;
...
#[no_mangle]
unsafe extern "C" fn cros_ec_regulator_probe(pdev: *mut platform_device) -> c_int {
