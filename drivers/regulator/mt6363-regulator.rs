...
//! Source: drivers/regulator/mt6363-regulator.c
#![no_std]
...
pub const MT6363_REGULATOR_MODE_NORMAL: c_int = 0;
pub const MT6363_REGULATOR_MODE_FCCM: c_int = 1;
pub const MT6363_REGULATOR_MODE_LP: c_int = 2;
pub const MT6363_REGULATOR_MODE_ULP: c_int = 3;
pub const EN_SET_OFFSET: c_uint = 0x1;
pub const EN_CLR_OFFSET: c_uint = 0x2;
pub const OP_CFG_OFFSET: c_uint = 0x5;
pub const NORMAL_OP_CFG: c_uint = 0x10;
pub const NORMAL_OP_EN: c_uint = 0x800000;
pub const OC_IRQ_ENABLE_DELAY_MS: c_int = 10;
// Unlock keys for TMA and BUCK_TOP
pub const MT6363_TMA_UNLOCK_VALUE: c_uint = 0x9c9c;
pub const MT6363_BUCK_TOP_UNLOCK_VALUE: c_uint = 0x5543;
    enum {
    MT6363_ID_VBUCK1,
    MT6363_ID_VBUCK2,
    MT6363_ID_VBUCK3,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6363_regulator_info {
    pub desc: regulator_desc,
    pub lp_mode_reg: u16,
    pub lp_mode_mask: u16,
    pub hw_lp_mode_reg: u16,
    pub hw_lp_mode_mask: u16,
    pub modeset_reg: u16,
    pub modeset_mask: u16,
    pub lp_imax_uA: c_int,
    pub op_en_reg: u16,
    pub orig_op_en: u32,
    pub orig_op_cfg: u8,
    pub oc_work: delayed_work,
    pub hwirq: u8,
    pub virq: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn mt6363_vreg_enable_setclr(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6363_vreg_disable_setclr(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mt6363_map_mode(mode: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6363_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6363_buck_unlock(map: *mut regmap, unlock: bool) -> c_int {
    static int mt6363_buck_unlock(struct regmap *map, bool unlock)
    {
    let mut buf: u16 = unlock ? MT6363_BUCK_TOP_UNLOCK_VALUE : 0;
...
#[no_mangle]
unsafe extern "C" fn mt6363_regulator_set_load(rdev: *mut regulator_dev, load_uA: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6363_vemc_set_voltage_sel(rdev: *mut regulator_dev, sel: c_uint) -> c_int {
    static int mt6363_vemc_set_voltage_sel(struct regulator_dev *rdev, unsigned int sel)
    {
    let mut tma_unlock_key: u16 = MT6363_TMA_UNLOCK_VALUE;
    ...
    let mut voltages_in_range: c_uint = linear_range_values_in_range(r);
...
#[no_mangle]
unsafe extern "C" fn mt6363_vemc_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
// If HW trapping value is 1, use VEMC_VOSEL_1 instead of VEMC_VOSEL_0
    ...
    return -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(1: trap ==) -> else {
    else if (trap == 1)
...
#[no_mangle]
unsafe extern "C" fn mt6363_va15_set_voltage_sel(rdev: *mut regulator_dev, sel: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6363_oc_irq_enable_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mt6363_oc_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mt6363_set_ocp(rdev: *mut regulator_dev, lim: c_int, severity: c_int, enable: bool) -> c_int {
...
// If there is no OCP interrupt, there's nothing to set
    if (info.virq <= 0)
    return -EOPNOTSUPP;
    return devm_request_threaded_irq(&rdev.dev, info.virq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn mt6363_backup_op_setting(map: *mut regmap, info: *mut mt6363_regulator_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6363_irq_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mt6363_spmi_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mt6363_regulator_probe(pdev: *mut platform_device) -> c_int {
