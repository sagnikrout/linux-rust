...
//! Source: drivers/regulator/twl-regulator.c
#![no_std]
...
pub const VREG_TYPE: c_int = 1;
pub const VREG_REMAP: c_int = 2;

pub const VREG_VOLTAGE_SMPS_4030: c_int = 9;
...
#[no_mangle]
unsafe extern "C" fn twl4030reg_is_enabled(rdev: *mut regulator_dev) -> c_int {
    static int twl4030reg_is_enabled(struct regulator_dev *rdev)
    {
    let mut state: c_int = twlreg_grp(rdev);
    if (state < 0)
    return state;
...
#[no_mangle]
unsafe extern "C" fn twl4030_wait_pb_ready() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030_send_pb_msg(msg: unsigned) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030reg_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030reg_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030reg_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn twl4030reg_set_mode(rdev: *mut regulator_dev, mode: unsigned) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn twl4030reg_map_mode(mode: c_uint) -> c_uint {
...
//
pub const UNSUP_MASK: c_uint = 0x8000;
...
#[no_mangle]
unsafe extern "C" fn twl4030ldo_list_voltage(rdev: *mut regulator_dev, index: unsigned) -> c_int {
    static int twl4030ldo_list_voltage(struct regulator_dev *rdev, unsigned index)
    {
    struct twlreg_info	*info = rdev_get_drvdata(rdev);
    let mut mV: c_int = info.table[index];
...
#[no_mangle]
unsafe extern "C" fn twl4030ldo_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
    ...
    {
    struct twlreg_info *info = rdev_get_drvdata(rdev);
    let mut vsel: c_int = DIV_ROUND_UP(min_uV - 600000, 12500);
    twlreg_write(info, TWL_MODULE_PM_RECEIVER, VREG_VOLTAGE_SMPS_4030, vsel);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn twl4030smps_get_voltage(rdev: *mut regulator_dev) -> c_int {
