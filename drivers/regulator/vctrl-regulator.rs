...
//! Source: drivers/regulator/vctrl-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vctrl_voltage_range {
    pub min_uV: c_int,
    pub max_uV: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vctrl_voltage_ranges {
    pub ctrl: vctrl_voltage_range,
    pub out: vctrl_voltage_range,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vctrl_voltage_table {
    pub ctrl: c_int,
    pub out: c_int,
    pub ovp_min_sel: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct vctrl_data {
    pub rdev: *mut regulator_dev,
    pub desc: regulator_desc,
    pub enabled: bool,
    pub min_slew_down_rate: c_uint,
    pub ovp_threshold: c_uint,
    pub vrange: vctrl_voltage_ranges,
    pub vtable: *mut vctrl_voltage_table,
    pub sel: c_uint,
}

#[no_mangle]
unsafe extern "C" fn vctrl_calc_ctrl_voltage(vctrl: *mut vctrl_data, out_uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vctrl_calc_output_voltage(vctrl: *mut vctrl_data, ctrl_uV: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vctrl_get_voltage(rdev: *mut regulator_dev) -> c_int {
...
// voltage rising or no OVP
    ...
    PM_SUSPEND_ON);
    while (uV > req_min_uV) {
    let mut max_drop_uV: c_int = (uV * vctrl.ovp_threshold) / 100;
    int next_uV;
    int next_ctrl_uV;
    int delay;
...
#[no_mangle]
unsafe extern "C" fn vctrl_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
    ...
    {
    struct vctrl_data *vctrl = rdev_get_drvdata(rdev);
    let mut orig_sel: c_uint = vctrl.sel;
    int ret;
    if (!rdev.supply)
    return -EPROBE_DEFER;
...
#[no_mangle]
unsafe extern "C" fn vctrl_cmp_ctrl_uV(a: *const c_void, b: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vctrl_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vctrl_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vctrl_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vctrl_probe(pdev: *mut platform_device) -> c_int {
