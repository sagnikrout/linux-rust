...
//! Source: drivers/regulator/palmas-regulator.c
#![no_std]
...
pub const SMPS_CTRL_MODE_OFF: c_uint = 0x00;
pub const SMPS_CTRL_MODE_ON: c_uint = 0x01;
pub const SMPS_CTRL_MODE_ECO: c_uint = 0x02;
pub const SMPS_CTRL_MODE_PWM: c_uint = 0x03;
pub const PALMAS_SMPS_NUM_VOLTAGES: c_int = 122;
pub const PALMAS_SMPS10_NUM_VOLTAGES: c_int = 2;
pub const PALMAS_LDO_NUM_VOLTAGES: c_int = 50;

pub const REGULATOR_SLAVE: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn palmas_set_mode_smps(dev: *mut regulator_dev, mode: c_uint) -> c_int {
    static int palmas_set_mode_smps(struct regulator_dev *dev, unsigned int mode)
    {
    let mut id: c_int = rdev_get_id(dev);
    int ret;
    struct palmas_pmic *pmic = rdev_get_drvdata(dev);
    struct palmas_pmic_driver_data *ddata = pmic.palmas.pmic_ddata;
    struct palmas_regs_info *rinfo = &ddata.palmas_regs_info[id];
    unsigned int reg;
    let mut rail_enable: bool = true;
...
#[no_mangle]
unsafe extern "C" fn palmas_get_mode_smps(dev: *mut regulator_dev) -> c_uint {
...
// SMPS3 and SMPS7 do not have tstep_addr setting
    ...
    reg = 0;
#[no_mangle]
pub unsafe extern "C" fn if(2500: ramp_delay <=) -> else {
    else if (ramp_delay <= 2500)
    reg = 3;
#[no_mangle]
pub unsafe extern "C" fn if(5000: ramp_delay <=) -> else {
...
#[no_mangle]
unsafe extern "C" fn palmas_is_enabled_ldo(dev: *mut regulator_dev) -> c_int {
...
//
    ...
    struct palmas_pmic_driver_data *ddata = palmas.pmic_ddata;
    struct palmas_regs_info *rinfo = &ddata.palmas_regs_info[id];
    let mut addr: c_uint = rinfo.ctrl_addr;
...
#[no_mangle]
unsafe extern "C" fn palmas_enable_ldo8_track(palmas: *mut palmas) {
...
// Initialise sleep/init values from platform data
    ...
    let mut ramp_delay_support: bool = false;
//
// Miss out regulators which are not available due
...
#[no_mangle]
unsafe extern "C" fn palmas_regulators_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn palmas_exit() -> void __exit {
