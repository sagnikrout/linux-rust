...
//! Source: drivers/regulator/tps65185.c
#![no_std]
...
pub const TPS65185_REG_TMST_VALUE: c_int = 0;
pub const TPS65185_REG_ENABLE: c_int = 1;
pub const TPS65185_REG_VADJ: c_int = 2;
pub const TPS65185_REG_VCOM1: c_int = 3;
pub const TPS65185_REG_VCOM2: c_int = 4;
pub const TPS65185_REG_INT_EN1: c_int = 5;
pub const TPS65185_REG_INT_EN2: c_int = 6;
pub const TPS65185_REG_INT1: c_int = 7;
pub const TPS65185_REG_INT2: c_int = 8;
pub const TPS65185_REG_TMST1: c_uint = 0xd;
pub const TPS65185_REG_TMST2: c_uint = 0xe;
pub const TPS65185_REG_PG: c_uint = 0xf;
pub const TPS65185_REG_REVID: c_uint = 0x10;

pub const PGOOD_TIMEOUT_MSECS: c_int = 200;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tps65185_data {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub pgood_gpio: *mut gpio_desc,
    pub pwrup_gpio: *mut gpio_desc,
    pub vcom_ctrl_gpio: *mut gpio_desc,
    pub wakeup_gpio: *mut gpio_desc,
    pub pgood_completion: completion,
    pub pgood_irq: c_int,
    pub tmst_completion: completion,
}
...
#[no_mangle]
unsafe extern "C" fn tps65185_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tps65185_check_powergood(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65185_vposneg_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65185_vposneg_set_voltage_sel(rdev: *mut regulator_dev, selector: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pgood_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tps65185_vposneg_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65185_vposneg_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65185_vcom_set_voltage_sel(rdev: *mut regulator_dev, selector: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65185_vcom_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tps65185_irq_thread(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tps65185_probe(client: *mut i2c_client) -> c_int {
...
// https://www.ti.com/lit/ds/symlink/tps65185.pdf
    ...
    ret = devm_request_threaded_irq(&client.dev, data.pgood_irq, core::ptr::null_mut(),
    pgood_handler,
    ...
    core::ptr::null_mut(), tps65185_irq_thread,
    ...
    &tps65185_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwmon_dev))
