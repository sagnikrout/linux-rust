...
//! Source: drivers/regulator/max8660.c
#![no_std]
...
pub const MAX8660_DCDC_MIN_UV: c_int = 725000;
pub const MAX8660_DCDC_MAX_UV: c_int = 1800000;
pub const MAX8660_DCDC_STEP: c_int = 25000;
pub const MAX8660_DCDC_MAX_SEL: c_uint = 0x2b;
pub const MAX8660_LDO5_MIN_UV: c_int = 1700000;
pub const MAX8660_LDO5_MAX_UV: c_int = 2000000;
pub const MAX8660_LDO5_STEP: c_int = 25000;
pub const MAX8660_LDO5_MAX_SEL: c_uint = 0x0c;
pub const MAX8660_LDO67_MIN_UV: c_int = 1800000;
pub const MAX8660_LDO67_MAX_UV: c_int = 3300000;
pub const MAX8660_LDO67_STEP: c_int = 100000;
pub const MAX8660_LDO67_MAX_SEL: c_uint = 0x0f;
    enum {
    MAX8660_OVER1,
    MAX8660_OVER2,
    MAX8660_VCC1,
...
pub struct max8660 {
    ...
    pub /: *mut *mut u8 shadow_regs[MAX8660_N_REGS]; / as chip is write only,
}

#[no_mangle]
unsafe extern "C" fn max8660_write(max8660: *mut max8660, reg: u8, mask: u8, val: u8) -> c_int {
    ...
    int ret;
    let mut reg_val: u8 = (max8660.shadow_regs[reg] & mask) | val;
...
//
#[no_mangle]
unsafe extern "C" fn max8660_dcdc_is_enabled(rdev: *mut regulator_dev) -> c_int {
    static int max8660_dcdc_is_enabled(struct regulator_dev *rdev)
    {
    struct max8660 *max8660 = rdev_get_drvdata(rdev);
    let mut val: u8 = max8660.shadow_regs[MAX8660_OVER1];
    let mut mask: u8 = (rdev_get_id(rdev) == MAX8660_V3) ? 1 : 4;
    return !!(val & mask);
    }
#[no_mangle]
unsafe extern "C" fn max8660_dcdc_enable(rdev: *mut regulator_dev) -> c_int {
    static int max8660_dcdc_enable(struct regulator_dev *rdev)
    {
    struct max8660 *max8660 = rdev_get_drvdata(rdev);
    let mut bit: u8 = (rdev_get_id(rdev) == MAX8660_V3) ? 1 : 4;
    return max8660_write(max8660, MAX8660_OVER1, 0xff, bit);
    }
#[no_mangle]
unsafe extern "C" fn max8660_dcdc_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8660_dcdc_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
    static int max8660_dcdc_get_voltage_sel(struct regulator_dev *rdev)
    {
    struct max8660 *max8660 = rdev_get_drvdata(rdev);
    let mut reg: u8 = (rdev_get_id(rdev) == MAX8660_V3) ? MAX8660_ADTV2 : MAX8660_SDTV2;
    let mut selector: u8 = max8660.shadow_regs[reg];
    return selector;
    }
...
//
#[no_mangle]
unsafe extern "C" fn max8660_ldo5_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
    static int max8660_ldo5_get_voltage_sel(struct regulator_dev *rdev)
    {
    struct max8660 *max8660 = rdev_get_drvdata(rdev);
    let mut selector: u8 = max8660.shadow_regs[MAX8660_MDTV2];
    return selector;
    }
...
//
#[no_mangle]
unsafe extern "C" fn max8660_ldo67_is_enabled(rdev: *mut regulator_dev) -> c_int {
    static int max8660_ldo67_is_enabled(struct regulator_dev *rdev)
    {
    struct max8660 *max8660 = rdev_get_drvdata(rdev);
    let mut val: u8 = max8660.shadow_regs[MAX8660_OVER2];
    let mut mask: u8 = (rdev_get_id(rdev) == MAX8660_V6) ? 2 : 4;
    return !!(val & mask);
    }
#[no_mangle]
unsafe extern "C" fn max8660_ldo67_enable(rdev: *mut regulator_dev) -> c_int {
    static int max8660_ldo67_enable(struct regulator_dev *rdev)
    {
    struct max8660 *max8660 = rdev_get_drvdata(rdev);
    let mut bit: u8 = (rdev_get_id(rdev) == MAX8660_V6) ? 2 : 4;
    return max8660_write(max8660, MAX8660_OVER2, 0xff, bit);
    }
#[no_mangle]
unsafe extern "C" fn max8660_ldo67_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8660_ldo67_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
    static int max8660_ldo67_get_voltage_sel(struct regulator_dev *rdev)
    {
    struct max8660 *max8660 = rdev_get_drvdata(rdev);
    let mut shift: u8 = (rdev_get_id(rdev) == MAX8660_V6) ? 0 : 4;
    let mut selector: u8 = (max8660.shadow_regs[MAX8660_L12VCR] >> shift) & 0xf;
    return selector;
    }
...
#[no_mangle]
unsafe extern "C" fn max8660_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8660_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max8660_exit() -> void __exit {
