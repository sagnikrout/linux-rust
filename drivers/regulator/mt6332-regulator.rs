...
//! Source: drivers/regulator/mt6332-regulator.c
#![no_std]
...
pub const MT6332_LDO_MODE_NORMAL: c_int = 0;
pub const MT6332_LDO_MODE_LP: c_int = 1;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mt6332_regulator_info {
    pub desc: regulator_desc,
    pub qi: u32,
    pub vselon_reg: u32,
    pub vselctrl_reg: u32,
    pub vselctrl_mask: u32,
    pub modeset_reg: u32,
...
#[no_mangle]
unsafe extern "C" fn mt6332_get_status(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6332_ldo_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6332_ldo_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mt6332_set_buck_vosel_reg(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt6332_regulator_probe(pdev: *mut platform_device) -> c_int {
