...
//! Source: drivers/regulator/da9055-regulator.c
#![no_std]
...
pub const DA9055_MIN_UA: c_int = 0;
pub const DA9055_MAX_UA: c_int = 3;
pub const DA9055_LDO_MODE_SYNC: c_int = 0;
pub const DA9055_LDO_MODE_SLEEP: c_int = 1;
pub const DA9055_BUCK_MODE_SLEEP: c_int = 1;
pub const DA9055_BUCK_MODE_SYNC: c_int = 2;
pub const DA9055_BUCK_MODE_AUTO: c_int = 3;
// DA9055 REGULATOR IDs
pub const DA9055_ID_BUCK1: c_int = 0;
pub const DA9055_ID_BUCK2: c_int = 1;
pub const DA9055_ID_LDO1: c_int = 2;
pub const DA9055_ID_LDO2: c_int = 3;
pub const DA9055_ID_LDO3: c_int = 4;
pub const DA9055_ID_LDO4: c_int = 5;
pub const DA9055_ID_LDO5: c_int = 6;
pub const DA9055_ID_LDO6: c_int = 7;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9055_regulator_info {
    pub reg_desc: regulator_desc,
    pub conf: da9055_conf_reg,
    pub volt: da9055_volt_reg,
    pub mode: da9055_mode_reg,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct da9055_regulator {
    pub da9055: *mut da9055,
    pub info: *const da9055_regulator_info,
    pub rdev: *mut regulator_dev,
    pub reg_rselect: enum gpio_select,
}

#[no_mangle]
unsafe extern "C" fn da9055_buck_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn da9055_ldo_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn da9055_ldo_set_mode(rdev: *mut regulator_dev, mode: c_uint) -> c_int {
    static int da9055_ldo_set_mode(struct regulator_dev *rdev, unsigned int mode)
    {
    struct da9055_regulator *regulator = rdev_get_drvdata(rdev);
    const struct da9055_regulator_info *info = regulator.info;
    let mut volt: da9055_volt_reg = info.volt;
    let mut val: c_int = 0;
    switch (mode) {
    case REGULATOR_MODE_NORMAL:
    case REGULATOR_MODE_FAST:
...
#[no_mangle]
unsafe extern "C" fn da9055_regulator_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_suspend_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_suspend_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_ldo5_6_oc_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn da9055_regulator_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn da9055_regulator_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn da9055_regulator_exit() -> void __exit {
