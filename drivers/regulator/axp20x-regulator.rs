...
//! Source: drivers/regulator/axp20x-regulator.c
#![no_std]
...
pub const AXP20X_IO_ENABLED: c_uint = 0x03;
pub const AXP20X_IO_DISABLED: c_uint = 0x07;

    ((x) << 0)

    ((x) << 1)

pub const AXP20X_LDO4_V_OUT_1250mV_START: c_uint = 0x0;
pub const AXP20X_LDO4_V_OUT_1250mV_STEPS: c_int = 0;

    (AXP20X_LDO4_V_OUT_1250mV_START + AXP20X_LDO4_V_OUT_1250mV_STEPS)
pub const AXP20X_LDO4_V_OUT_1300mV_START: c_uint = 0x1;
pub const AXP20X_LDO4_V_OUT_1300mV_STEPS: c_int = 7;

    (AXP20X_LDO4_V_OUT_1300mV_START + AXP20X_LDO4_V_OUT_1300mV_STEPS)
pub const AXP20X_LDO4_V_OUT_2500mV_START: c_uint = 0x9;
pub const AXP20X_LDO4_V_OUT_2500mV_STEPS: c_int = 0;

    (AXP20X_LDO4_V_OUT_2500mV_START + AXP20X_LDO4_V_OUT_2500mV_STEPS)
pub const AXP20X_LDO4_V_OUT_2700mV_START: c_uint = 0xa;
pub const AXP20X_LDO4_V_OUT_2700mV_STEPS: c_int = 1;

    (AXP20X_LDO4_V_OUT_2700mV_START + AXP20X_LDO4_V_OUT_2700mV_STEPS)
pub const AXP20X_LDO4_V_OUT_3000mV_START: c_uint = 0xc;
pub const AXP20X_LDO4_V_OUT_3000mV_STEPS: c_int = 3;

    (AXP20X_LDO4_V_OUT_3000mV_START + AXP20X_LDO4_V_OUT_3000mV_STEPS)
pub const AXP20X_LDO4_V_OUT_NUM_VOLTAGES: c_int = 16;
pub const AXP22X_IO_ENABLED: c_uint = 0x03;
pub const AXP22X_IO_DISABLED: c_uint = 0x04;

pub const AXP313A_DCDC1_NUM_VOLTAGES: c_int = 107;
pub const AXP313A_DCDC23_NUM_VOLTAGES: c_int = 88;

pub const AXP717_DCDC1_NUM_VOLTAGES: c_int = 88;
pub const AXP717_DCDC2_NUM_VOLTAGES: c_int = 107;
pub const AXP717_DCDC3_NUM_VOLTAGES: c_int = 103;

pub const AXP803_DCDC234_500mV_START: c_uint = 0x00;
pub const AXP803_DCDC234_500mV_STEPS: c_int = 70;

    (AXP803_DCDC234_500mV_START + AXP803_DCDC234_500mV_STEPS)
pub const AXP803_DCDC234_1220mV_START: c_uint = 0x47;
pub const AXP803_DCDC234_1220mV_STEPS: c_int = 4;

    (AXP803_DCDC234_1220mV_START + AXP803_DCDC234_1220mV_STEPS)
pub const AXP803_DCDC234_NUM_VOLTAGES: c_int = 76;
pub const AXP803_DCDC5_800mV_START: c_uint = 0x00;
pub const AXP803_DCDC5_800mV_STEPS: c_int = 32;

    (AXP803_DCDC5_800mV_START + AXP803_DCDC5_800mV_STEPS)
pub const AXP803_DCDC5_1140mV_START: c_uint = 0x21;
pub const AXP803_DCDC5_1140mV_STEPS: c_int = 35;

    (AXP803_DCDC5_1140mV_START + AXP803_DCDC5_1140mV_STEPS)
pub const AXP803_DCDC5_NUM_VOLTAGES: c_int = 69;
pub const AXP803_DCDC6_600mV_START: c_uint = 0x00;
pub const AXP803_DCDC6_600mV_STEPS: c_int = 50;

    (AXP803_DCDC6_600mV_START + AXP803_DCDC6_600mV_STEPS)
pub const AXP803_DCDC6_1120mV_START: c_uint = 0x33;
pub const AXP803_DCDC6_1120mV_STEPS: c_int = 20;

    (AXP803_DCDC6_1120mV_START + AXP803_DCDC6_1120mV_STEPS)
pub const AXP803_DCDC6_NUM_VOLTAGES: c_int = 72;
pub const AXP803_DLDO2_700mV_START: c_uint = 0x00;
pub const AXP803_DLDO2_700mV_STEPS: c_int = 26;

    (AXP803_DLDO2_700mV_START + AXP803_DLDO2_700mV_STEPS)
pub const AXP803_DLDO2_3400mV_START: c_uint = 0x1b;
pub const AXP803_DLDO2_3400mV_STEPS: c_int = 4;

    (AXP803_DLDO2_3400mV_START + AXP803_DLDO2_3400mV_STEPS)
pub const AXP803_DLDO2_NUM_VOLTAGES: c_int = 32;

pub const AXP806_DCDCAB_POLYPHASE_DUAL: c_uint = 0x40;
pub const AXP806_DCDCABC_POLYPHASE_TRI: c_uint = 0x80;

pub const AXP806_DCDCA_600mV_START: c_uint = 0x00;
pub const AXP806_DCDCA_600mV_STEPS: c_int = 50;

    (AXP806_DCDCA_600mV_START + AXP806_DCDCA_600mV_STEPS)
pub const AXP806_DCDCA_1120mV_START: c_uint = 0x33;
pub const AXP806_DCDCA_1120mV_STEPS: c_int = 20;

    (AXP806_DCDCA_1120mV_START + AXP806_DCDCA_1120mV_STEPS)
pub const AXP806_DCDCA_NUM_VOLTAGES: c_int = 72;
pub const AXP806_DCDCD_600mV_START: c_uint = 0x00;
pub const AXP806_DCDCD_600mV_STEPS: c_int = 45;

    (AXP806_DCDCD_600mV_START + AXP806_DCDCD_600mV_STEPS)
pub const AXP806_DCDCD_1600mV_START: c_uint = 0x2e;
pub const AXP806_DCDCD_1600mV_STEPS: c_int = 17;

    (AXP806_DCDCD_1600mV_START + AXP806_DCDCD_1600mV_STEPS)
pub const AXP806_DCDCD_NUM_VOLTAGES: c_int = 64;
pub const AXP809_DCDC4_600mV_START: c_uint = 0x00;
pub const AXP809_DCDC4_600mV_STEPS: c_int = 47;

    (AXP809_DCDC4_600mV_START + AXP809_DCDC4_600mV_STEPS)
pub const AXP809_DCDC4_1800mV_START: c_uint = 0x30;
pub const AXP809_DCDC4_1800mV_STEPS: c_int = 8;

    (AXP809_DCDC4_1800mV_START + AXP809_DCDC4_1800mV_STEPS)
pub const AXP809_DCDC4_NUM_VOLTAGES: c_int = 57;

pub const AXP15060_DCDC234_500mV_START: c_uint = 0x00;
pub const AXP15060_DCDC234_500mV_STEPS: c_int = 70;

    (AXP15060_DCDC234_500mV_START + AXP15060_DCDC234_500mV_STEPS)
pub const AXP15060_DCDC234_1220mV_START: c_uint = 0x47;
pub const AXP15060_DCDC234_1220mV_STEPS: c_int = 16;

    (AXP15060_DCDC234_1220mV_START + AXP15060_DCDC234_1220mV_STEPS)
pub const AXP15060_DCDC234_NUM_VOLTAGES: c_int = 88;
pub const AXP15060_DCDC5_800mV_START: c_uint = 0x00;
pub const AXP15060_DCDC5_800mV_STEPS: c_int = 32;

    (AXP15060_DCDC5_800mV_START + AXP15060_DCDC5_800mV_STEPS)
pub const AXP15060_DCDC5_1140mV_START: c_uint = 0x21;
pub const AXP15060_DCDC5_1140mV_STEPS: c_int = 35;

    (AXP15060_DCDC5_1140mV_START + AXP15060_DCDC5_1140mV_STEPS)
pub const AXP15060_DCDC5_NUM_VOLTAGES: c_int = 69;
...
#[no_mangle]
unsafe extern "C" fn axp20x_set_ramp_delay(rdev: *mut regulator_dev, ramp: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn axp20x_regulator_enable_regmap(rdev: *mut regulator_dev) -> c_int {
...
// secondary switchable output of DCDC1
    AXP_DESC_SW(AXP22X, DC1SW, "dc1sw", core::ptr::null_mut(),
    AXP22X_PWR_OUT_CTRL2, AXP22X_PWR_OUT_DC1SW_MASK),
// LDO regulator internally chained to DCDC5
    AXP_DESC(AXP22X, DC5LDO, "dc5ldo", core::ptr::null_mut(), 700, 1400, 100,
...
// secondary switchable output of DCDC1
    AXP_DESC_SW(AXP803, DC1SW, "dc1sw", core::ptr::null_mut(),
    AXP22X_PWR_OUT_CTRL2, AXP22X_PWR_OUT_DC1SW_MASK),
    ...
    AXP22X_PWR_OUT_CTRL1, AXP22X_PWR_OUT_DCDC5_MASK),
// secondary switchable output of DCDC1
    AXP_DESC_SW(AXP809, DC1SW, "dc1sw", core::ptr::null_mut(),
    AXP22X_PWR_OUT_CTRL2, AXP22X_PWR_OUT_DC1SW_MASK),
// LDO regulator internally chained to DCDC5
    AXP_DESC(AXP809, DC5LDO, "dc5ldo", core::ptr::null_mut(), 700, 1400, 100,
    AXP22X_DC5LDO_V_OUT, AXP22X_DC5LDO_V_OUT_MASK,
    AXP22X_PWR_OUT_CTRL1, AXP22X_PWR_OUT_DC5LDO_MASK),
...
// Supply comes from DCDC5
    AXP_DESC(AXP15060, CPUSLDO, "cpusldo", core::ptr::null_mut(), 700, 1400, 50,
...
// Supply comes from DCDC1
    AXP_DESC_SW(AXP15060, SW, "sw", core::ptr::null_mut(),
    AXP15060_PWR_OUT_CTRL3, AXP15060_PWR_OUT_SW_MASK),
// Supply comes from ALDO1
    AXP_DESC_FIXED(AXP15060, RTC_LDO, "rtc-ldo", core::ptr::null_mut(), 1800),
    };
#[no_mangle]
unsafe extern "C" fn axp20x_set_dcdc_freq(pdev: *mut platform_device, dcdcfreq: u32) -> c_int {
    static int axp20x_set_dcdc_freq(struct platform_device *pdev, u32 dcdcfreq)
    {
    struct axp20x_dev *axp20x = dev_get_drvdata(pdev.dev.parent);
    let mut reg: c_uint = AXP20X_DCDC_FREQ;
...
#[no_mangle]
unsafe extern "C" fn axp20x_regulator_parse_dt(pdev: *mut platform_device) -> c_int {
    static int axp20x_regulator_parse_dt(struct platform_device *pdev)
    {
    struct device_node *np, *regulators;
    let mut ret: c_int = 0;
    let mut dcdcfreq: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn axp20x_set_dcdc_workmode(rdev: *mut regulator_dev, id: c_int, workmode: u32) -> c_int {
    static int axp20x_set_dcdc_workmode(struct regulator_dev *rdev, int id, u32 workmode)
    {
    struct axp20x_dev *axp20x = rdev_get_drvdata(rdev);
    let mut reg: c_uint = AXP20X_DCDC_MODE;
    unsigned int mask;
    switch (axp20x.variant) {
    case AXP202_ID:
    case AXP209_ID:
...
//
#[no_mangle]
unsafe extern "C" fn axp20x_is_polyphase_slave(axp20x: *mut axp20x_dev, id: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn axp20x_regulator_probe(pdev: *mut platform_device) -> c_int {
