...
//! Source: drivers/regulator/max8997-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max8997_data {
    pub dev: *mut device,
    pub iodev: *mut max8997_dev,
    pub num_regulators: c_int,
    pub /: *mut *mut int ramp_delay; / in mV/us,
    ...
    pub buck2_vol: [u8; 8],
    pub buck5_vol: [u8; 8],
    pub buck125_gpiods: [*mut gpio_desc; 3],
    pub buck125_gpioindex: c_int,
    pub ignore_gpiodvs_side_effect: bool,
    pub saved_states: [u8; MAX8997_REG_MAX],
}
...
#[no_mangle]
pub unsafe extern "C" fn max8997_set_gpio(max8997: *mut max8997_data) {
    static inline void max8997_set_gpio(struct max8997_data *max8997)
    {
    let mut set3: c_int = (max8997.buck125_gpioindex) & 0x1;
    let mut set2: c_int = ((max8997.buck125_gpioindex) >> 1) & 0x1;
    let mut set1: c_int = ((max8997.buck125_gpioindex) >> 2) & 0x1;
...
// current map in uA
    ...
    [MAX8997_BUCK6] = core::ptr::null_mut(),
    [MAX8997_BUCK7] = &buck37_voltage_map_desc,
    [MAX8997_EN32KHZ_AP] = core::ptr::null_mut(),
    [MAX8997_EN32KHZ_CP] = core::ptr::null_mut(),
    [MAX8997_ENVICHG] = core::ptr::null_mut(),
    [MAX8997_ESAFEOUT1] = core::ptr::null_mut(),
    [MAX8997_ESAFEOUT2] = core::ptr::null_mut(),
    [MAX8997_CHARGER_CV] = core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn max8997_reg_is_enabled(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_reg_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_reg_disable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_get_voltage_sel(rdev: *mut regulator_dev) -> c_int {
    ...
    val = 0x1;
#[no_mangle]
pub unsafe extern "C" fn if(4200000: min_uV <= 4200000 && max_uV >=) -> else {
...
//
    ...
    int side_effect[8];
    let mut min_side_effect: c_int = INT_MAX;
    int i;
// best = -1;
    switch (rid) {
    case MAX8997_BUCK1:
...
//
    ...
    let mut gpio_dvs_mode: bool = false;
...
#[no_mangle]
unsafe extern "C" fn max8997_reg_disable_suspend(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_get_current_limit(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_pmic_probe(pdev: *mut platform_device) -> c_int {
    ...
    int i, ret, nr_dvs;
    let mut max_buck1: u8 = 0, max_buck2 = 0, max_buck5 = 0;
    if (!pdata) {
...
// Misc Settings
    ...
    const struct voltage_map_desc *desc;
    let mut id: c_int = pdata.regulators[i].id;
...
#[no_mangle]
unsafe extern "C" fn max8997_pmic_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn max8997_pmic_cleanup() -> void __exit {
