...
//! Source: drivers/regulator/wm8994-regulator.c
#![no_std]
...
pub const WM8994_LDO1_MAX_SELECTOR: c_uint = 0x7;
pub const WM8994_LDO2_MAX_SELECTOR: c_uint = 0x3;
...
#[no_mangle]
unsafe extern "C" fn wm8994_ldo_probe(pdev: *mut platform_device) -> c_int {
    static int wm8994_ldo_probe(struct platform_device *pdev)
    {
    struct wm8994 *wm8994 = dev_get_drvdata(pdev.dev.parent);
    struct wm8994_pdata *pdata = dev_get_platdata(wm8994.dev);
    let mut id: c_int = pdev.id % ARRAY_SIZE(pdata.ldo);
