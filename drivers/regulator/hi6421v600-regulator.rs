...
//! Source: drivers/regulator/hi6421v600-regulator.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi6421_spmi_reg_priv {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hi6421_spmi_reg_info {
    pub desc: regulator_desc,
    pub eco_mode_mask: u8,
    pub eco_uA: u32,
}
...
#[no_mangle]
unsafe extern "C" fn hi6421_spmi_regulator_enable(rdev: *mut regulator_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hi6421_spmi_regulator_get_mode(rdev: *mut regulator_dev) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hi6421_spmi_regulator_probe(pdev: *mut platform_device) -> c_int {
