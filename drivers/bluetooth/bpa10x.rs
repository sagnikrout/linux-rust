...
//! Source: drivers/bluetooth/bpa10x.c
#![no_std]
...
pub const HCI_VENDOR_HDR_SIZE: c_int = 5;
...
unsafe extern "C" fn bpa10x_rx_complete(urb: *mut urb) {
    ...
    return;
    if (urb.status == 0) {
    let mut idx: bool = usb_pipebulk(urb.pipe);
...
#[no_mangle]
pub unsafe extern "C" fn bpa10x_submit_intr_urb(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bpa10x_submit_bulk_urb(hdev: *mut hci_dev) -> c_int {
