...
//! Source: drivers/bluetooth/hci_vhci.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vhci_data {
    pub hdev: *mut hci_dev,
    pub read_wait: wait_queue_head_t,
    pub readq: sk_buff_head,
    pub open_mutex: mutex,
    pub open_timeout: delayed_work,
...
#[no_mangle]
unsafe extern "C" fn vhci_open_dev(hdev: *mut hci_dev) -> c_int {
    static int vhci_open_dev(struct hci_dev *hdev)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn vhci_close_dev(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_flush(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_get_data_path_id(hdev: *mut hci_dev, data_path_id: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_wakeup(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn vhci_suspend_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn msft_opcode_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msft_opcode_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_setup(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_coredump(hdev: *mut hci_dev) {
    static void vhci_coredump(struct hci_dev *hdev)
    {
// No need to do anything
    }
#[no_mangle]
unsafe extern "C" fn vhci_coredump_hdr(hdev: *mut hci_dev, skb: *mut sk_buff) {
...
pub const MAX_COREDUMP_LINE_LEN: c_int = 40;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devcoredump_test_data {
    pub state: enum devcoredump_state,
    pub timeout: c_uint,
    pub data: [c_char; MAX_COREDUMP_LINE_LEN],
}
    ...
    hci_devcd_register(hdev, vhci_coredump, vhci_coredump_hdr, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vhci_debugfs_init(data: *mut vhci_data) {
...
#[no_mangle]
unsafe extern "C" fn __vhci_create_device(data: *mut vhci_data, opcode: __u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_create_device(data: *mut vhci_data, opcode: __u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_write(iocb: *mut kiocb, from: *mut iov_iter) -> isize {
...
#[no_mangle]
unsafe extern "C" fn vhci_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn vhci_open_timeout(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn vhci_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vhci_debugfs_remove(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn vhci_release(inode: *mut inode, file: *mut file) -> c_int {
