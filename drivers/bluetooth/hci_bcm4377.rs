...
//! Source: drivers/bluetooth/hci_bcm4377.c
#![no_std]
...
pub const BCM4377_DEVICE_ID: c_uint = 0x5fa0;
pub const BCM4378_DEVICE_ID: c_uint = 0x5f69;
pub const BCM4387_DEVICE_ID: c_uint = 0x5f71;
pub const BCM4388_DEVICE_ID: c_uint = 0x5f72;
...
//
pub const BCM4377_DMA_MASK: c_uint = 0xfffffe00;
pub const BCM4377_PCIECFG_BAR0_WINDOW1: c_uint = 0x80;
pub const BCM4377_PCIECFG_BAR0_WINDOW2: c_uint = 0x70;
pub const BCM4377_PCIECFG_BAR0_CORE2_WINDOW1: c_uint = 0x74;
pub const BCM4377_PCIECFG_BAR0_CORE2_WINDOW2: c_uint = 0x78;
pub const BCM4377_PCIECFG_BAR2_WINDOW: c_uint = 0x84;
pub const BCM4377_PCIECFG_BAR0_CORE2_WINDOW1_DEFAULT: c_uint = 0x18011000;
pub const BCM4377_PCIECFG_BAR2_WINDOW_DEFAULT: c_uint = 0x19000000;
pub const BCM4377_PCIECFG_SUBSYSTEM_CTRL: c_uint = 0x88;
pub const BCM4377_BAR0_FW_DOORBELL: c_uint = 0x140;
pub const BCM4377_BAR0_RTI_CONTROL: c_uint = 0x144;
pub const BCM4377_BAR0_SLEEP_CONTROL: c_uint = 0x150;
pub const BCM4377_BAR0_SLEEP_CONTROL_UNQUIESCE: c_int = 0;
pub const BCM4377_BAR0_SLEEP_CONTROL_AWAKE: c_int = 2;
pub const BCM4377_BAR0_SLEEP_CONTROL_QUIESCE: c_int = 3;
pub const BCM4377_BAR0_DOORBELL: c_uint = 0x174;

pub const BCM4377_BAR0_HOST_WINDOW_LO: c_uint = 0x590;
pub const BCM4377_BAR0_HOST_WINDOW_HI: c_uint = 0x594;
pub const BCM4377_BAR0_HOST_WINDOW_SIZE: c_uint = 0x598;
pub const BCM4377_BAR2_BOOTSTAGE: c_uint = 0x200454;
pub const BCM4377_BAR2_FW_LO: c_uint = 0x200478;
pub const BCM4377_BAR2_FW_HI: c_uint = 0x20047c;
pub const BCM4377_BAR2_FW_SIZE: c_uint = 0x200480;
pub const BCM4377_BAR2_CONTEXT_ADDR_LO: c_uint = 0x20048c;
pub const BCM4377_BAR2_CONTEXT_ADDR_HI: c_uint = 0x200450;
pub const BCM4377_BAR2_RTI_STATUS: c_uint = 0x20045c;
pub const BCM4377_BAR2_RTI_WINDOW_LO: c_uint = 0x200494;
pub const BCM4377_BAR2_RTI_WINDOW_HI: c_uint = 0x200498;
pub const BCM4377_BAR2_RTI_WINDOW_SIZE: c_uint = 0x20049c;
pub const BCM4377_OTP_SIZE: c_uint = 0xe0;
pub const BCM4377_OTP_SYS_VENDOR: c_uint = 0x15;
pub const BCM4377_OTP_CIS: c_uint = 0x80;
pub const BCM4377_OTP_VENDOR_HDR: c_uint = 0x00000008;
pub const BCM4377_OTP_MAX_PARAM_LEN: c_int = 16;
pub const BCM4377_N_TRANSFER_RINGS: c_int = 9;
pub const BCM4377_N_COMPLETION_RINGS: c_int = 6;
pub const BCM4377_MAX_RING_SIZE: c_int = 256;

pub const BCM4377_RING_N_ENTRIES: c_int = 128;
pub const BCM4377_CONTROL_MSG_SIZE: c_uint = 0x34;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_xfer_ring_entry {
    ...
    pub _unk1: [u8; 2],
    pub __packed: },
    pub 0x10): static_assert(sizeof(struct bcm4377_xfer_ring_entry) ==,
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_completion_ring_entry {
    pub flags: u8,
    pub _unk0: u8,
    pub ring_id: __le16,
    pub msg_id: __le16,
    ...
    pub _unk1: [u8; 6],
    pub __packed: },
    pub 0x10): static_assert(sizeof(struct bcm4377_completion_ring_entry) ==,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_create_completion_ring_msg {
    pub msg_type: u8,
    pub header_size: u8,
    pub footer_size: u8,
    pub _unk0: u8,
    pub id: __le16,
    pub id_again: __le16,
    pub ring_iova: __le64,
    pub n_elements: __le16,
    pub unk: __le32,
    pub _unk1: [u8; 6],
    pub msi: __le16,
    pub intmod_delay: __le16,
    pub intmod_bytes: __le32,
    pub _unk2: __le16,
    pub _unk3: __le32,
    pub _unk4: [u8; 10],
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_destroy_completion_ring_msg {
    pub msg_type: u8,
    pub _pad0: u8,
    pub ring_id: __le16,
    pub _pad1: [u8; 48],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_create_transfer_ring_msg {
    pub msg_type: u8,
    pub header_size: u8,
    pub footer_size: u8,
    pub _unk0: u8,
    pub ring_id: __le16,
    pub ring_id_again: __le16,
    pub ring_iova: __le64,
    pub _unk1: [u8; 8],
    pub n_elements: __le16,
    pub completion_ring_id: __le16,
    pub doorbell: __le16,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_destroy_transfer_ring_msg {
    pub msg_type: u8,
    pub _pad0: u8,
    pub ring_id: __le16,
    pub _pad1: [u8; 48],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_context {
    pub version: __le16,
    pub size: __le16,
    pub enabled_caps: __le32,
    pub peripheral_info_addr: __le64,
// ring heads and tails
    pub completion_ring_heads_addr: __le64,
    pub xfer_ring_tails_addr: __le64,
    pub completion_ring_tails_addr: __le64,
    pub xfer_ring_heads_addr: __le64,
    pub n_completion_rings: __le16,
    pub n_xfer_rings: __le16,
// control ring configuration
    pub control_completion_ring_addr: __le64,
    pub control_xfer_ring_addr: __le64,
    pub control_xfer_ring_n_entries: __le16,
    pub control_completion_ring_n_entries: __le16,
    pub control_xfer_ring_doorbell: __le16,
    pub control_completion_ring_doorbell: __le16,
    pub control_xfer_ring_msi: __le16,
    pub control_completion_ring_msi: __le16,
    pub control_xfer_ring_header_size: u8,
    pub control_xfer_ring_footer_size: u8,
    pub control_completion_ring_header_size: u8,
    pub control_completion_ring_footer_size: u8,
    pub _unk0: __le16,
    pub _unk1: __le16,
    pub scratch_pad: __le64,
    pub scratch_pad_size: __le32,
    pub _unk3: __le32,
    pub __packed: },
    pub 0x68): static_assert(sizeof(struct bcm4377_context) ==,
pub const BCM4378_CALIBRATION_CHUNK_SIZE: c_uint = 0xe6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4378_hci_send_calibration_cmd {
    pub unk: u8,
    pub blocks_left: __le16,
    pub data: [u8; BCM4378_CALIBRATION_CHUNK_SIZE],
    pub __packed: },
pub const BCM4378_PTB_CHUNK_SIZE: c_uint = 0xcf;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4378_hci_send_ptb_cmd {
    pub blocks_left: __le16,
    pub data: [u8; BCM4378_PTB_CHUNK_SIZE],
    pub __packed: },
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_ring_state {
    pub completion_ring_head: [__le16; BCM4377_N_COMPLETION_RINGS],
    pub completion_ring_tail: [__le16; BCM4377_N_COMPLETION_RINGS],
    pub xfer_ring_head: [__le16; BCM4377_N_TRANSFER_RINGS],
    pub xfer_ring_tail: [__le16; BCM4377_N_TRANSFER_RINGS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_transfer_ring {
    pub ring_id: enum bcm4377_transfer_ring_id,
    pub doorbell: enum bcm4377_doorbell,
    pub payload_size: usize,
    pub mapped_payload_size: usize,
    pub completion_ring: u8,
    pub n_entries: u16,
    pub generation: u8,
    pub sync: bool,
    pub virtual: bool,
    pub d2h_buffers_only: bool,
    pub allow_wait: bool,
    pub enabled: bool,
    pub ring: *mut c_void,
    pub ring_dma: dma_addr_t,
    pub payloads: *mut c_void,
    pub payloads_dma: dma_addr_t,
    pub events: *mut completion,
    pub BCM4377_MAX_RING_SIZE): DECLARE_BITMAP(msgids,,
    pub lock: spinlock_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_completion_ring {
    pub ring_id: enum bcm4377_completion_ring_id,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bcm4377_hw {
    pub id: c_uint,
    pub otp_offset: u32,
    pub bar0_window1: u32,
    pub bar0_window2: u32,
    pub bar0_core2_window2: u32,
    pub bar2_offset: u32,
    pub 1: unsigned long has_bar0_core2_window2 :,
    pub 1: unsigned long clear_pciecfg_subsystem_ctrl_bit19 :,
    pub 1: unsigned long disable_aspm :,
    pub 1: unsigned long broken_ext_scan :,
    pub 1: unsigned long broken_mws_transport_config :,
    pub 1: unsigned long broken_le_coded :,
    pub 1: unsigned long broken_le_ext_adv_report_phy :,
    pub bcm4377): *mut *mut int (send_calibration)(struct bcm4377_data,
...
pub struct bcm4377_data {
    ...
    pub bootstage: u32,
    pub rti_status: u32,
    pub hw: *const bcm4377_hw,
    pub taurus_cal_blob: *const c_void,
    pub taurus_cal_size: c_int,
    pub taurus_beamforming_cal_blob: *const c_void,
    pub taurus_beamforming_cal_size: c_int,
    pub stepping: [c_char; BCM4377_OTP_MAX_PARAM_LEN],
    pub vendor: [c_char; BCM4377_OTP_MAX_PARAM_LEN],
    pub board_type: *const c_char,
    pub event: completion,
    pub ctx: *mut bcm4377_context,
    pub ctx_dma: dma_addr_t,
    pub ring_state: *mut bcm4377_ring_state,
    pub ring_state_dma: dma_addr_t,
//
// The HCI and ACL rings have to be merged because this structure is
// hardcoded in the firmware.
//
    pub control_ack_ring: bcm4377_completion_ring,
    pub hci_acl_ack_ring: bcm4377_completion_ring,
    pub hci_acl_event_ring: bcm4377_completion_ring,
    pub sco_ack_ring: bcm4377_completion_ring,
    pub sco_event_ring: bcm4377_completion_ring,
    pub control_h2d_ring: bcm4377_transfer_ring,
    pub hci_h2d_ring: bcm4377_transfer_ring,
    pub hci_d2h_ring: bcm4377_transfer_ring,
    pub sco_h2d_ring: bcm4377_transfer_ring,
    pub sco_d2h_ring: bcm4377_transfer_ring,
    pub acl_h2d_ring: bcm4377_transfer_ring,
    pub acl_d2h_ring: bcm4377_transfer_ring,
}
    ...
    {
    let mut generation: u8 = FIELD_GET(BCM4377_MSGID_GENERATION, raw_msgid);
// msgid = FIELD_GET(BCM4377_MSGID_ID, raw_msgid);
    ...
    ring.events[msgid] = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn bcm4377_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn bcm4378_send_calibration(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4387_send_calibration(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4388_send_calibration(bcm4377: *mut bcm4377_data) -> c_int {
...
//
    ...
    const struct firmware *fw)
    {
    let mut chunks: usize = DIV_ROUND_UP(fw.size, (size_t)BCM4378_PTB_CHUNK_SIZE);
    size_t i, left, transfer_len;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn bcm4377_hci_open(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_hci_close(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_check_bdaddr(bcm4377: *mut bcm4377_data) -> c_int {
    static int bcm4377_check_bdaddr(struct bcm4377_data *bcm4377)
    {
    struct hci_rp_read_bd_addr *bda;
    struct sk_buff *skb;
    skb = __hci_cmd_sync(bcm4377.hdev, HCI_OP_READ_BD_ADDR, 0, core::ptr::null_mut(),
    HCI_INIT_TIMEOUT);
    if (IS_ERR(skb)) {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_hci_setup(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_hci_send_frame(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_hci_set_bdaddr(hdev: *mut hci_dev, bdaddr: *const bdaddr_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_init_context(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_prepare_rings(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_boot(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_setup_rti(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_parse_otp(bcm4377: *mut bcm4377_data) -> c_int {
    ...
    let mut type: u8 = otp[i];
    let mut length: u8 = otp[i + 1];
    if (type == 0)
    break;
...
#[no_mangle]
unsafe extern "C" fn bcm4377_init_cfg(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_probe_dmi(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_probe_of(bcm4377: *mut bcm4377_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_disable_aspm(bcm4377: *mut bcm4377_data) {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_pci_free_irq_vectors(data: *mut c_void) {
    static void bcm4377_pci_free_irq_vectors(void *data)
    {
    pci_free_irq_vectors(data);
    }
#[no_mangle]
unsafe extern "C" fn bcm4377_hci_free_dev(data: *mut c_void) {
    static void bcm4377_hci_free_dev(void *data)
    {
    hci_free_dev(data);
    }
#[no_mangle]
unsafe extern "C" fn bcm4377_hci_unregister_dev(data: *mut c_void) {
    static void bcm4377_hci_unregister_dev(void *data)
    {
    hci_unregister_dev(data);
    }
#[no_mangle]
unsafe extern "C" fn bcm4377_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bcm4377_resume(dev: *mut device) -> c_int {
