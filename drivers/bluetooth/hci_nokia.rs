...
//! Source: drivers/bluetooth/hci_nokia.c
#![no_std]
...
pub const NOKIA_ID_BCM2048: c_uint = 0x04;
pub const NOKIA_ID_TI1271: c_uint = 0x31;

pub const HCI_NOKIA_NEG_PKT: c_uint = 0x06;
pub const HCI_NOKIA_ALIVE_PKT: c_uint = 0x07;
pub const HCI_NOKIA_RADIO_PKT: c_uint = 0x08;
pub const HCI_NOKIA_NEG_HDR_SIZE: c_int = 1;
pub const HCI_NOKIA_MAX_NEG_SIZE: c_int = 255;
pub const HCI_NOKIA_ALIVE_HDR_SIZE: c_int = 1;
pub const HCI_NOKIA_MAX_ALIVE_SIZE: c_int = 255;
pub const HCI_NOKIA_RADIO_HDR_SIZE: c_int = 2;
pub const HCI_NOKIA_MAX_RADIO_SIZE: c_int = 255;
pub const NOKIA_PROTO_PKT: c_uint = 0x44;
pub const NOKIA_PROTO_BYTE: c_uint = 0x4c;
pub const NOKIA_NEG_REQ: c_uint = 0x00;
pub const NOKIA_NEG_ACK: c_uint = 0x20;
pub const NOKIA_NEG_NAK: c_uint = 0x40;
pub const H4_TYPE_SIZE: c_int = 1;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hci_nokia_neg_hdr {
    pub dlen: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hci_nokia_neg_cmd {
    pub ack: u8,
    pub baud: u16,
    pub unused1: u16,
    pub proto: u8,
    ...
    pub unused2: u16,
    pub __packed: },
pub const NOKIA_ALIVE_REQ: c_uint = 0x55;
pub const NOKIA_ALIVE_RESP: c_uint = 0xcc;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hci_nokia_alive_hdr {
    pub dlen: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hci_nokia_alive_pkt {
    pub mid: u8,
    pub unused: u8,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hci_nokia_neg_evt {
    pub ack: u8,
    pub baud: u16,
    pub unused1: u16,
    pub proto: u8,
    ...
    pub ver_id: u8,
    pub __packed: },
pub const MAX_BAUD_RATE: c_int = 3692300;
pub const SETUP_BAUD_RATE: c_int = 921600;
pub const INIT_BAUD_RATE: c_int = 120000;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nokia_bt_dev {
    pub hu: hci_uart,
    pub serdev: *mut serdev_device,
    pub reset: *mut gpio_desc,
    pub wakeup_host: *mut gpio_desc,
    pub wakeup_bt: *mut gpio_desc,
    pub sysclk_speed: c_ulong,
    pub wake_irq: c_int,
...
#[no_mangle]
unsafe extern "C" fn nokia_flow_control(serdev: *mut serdev_device, enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn wakeup_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t wakeup_handler(int irq, void *data)
    {
    struct nokia_bt_dev *btdev = data;
    struct device *dev = &btdev.serdev.dev;
    let mut wake_state: c_int = gpiod_get_value(btdev.wakeup_host);
...
#[no_mangle]
unsafe extern "C" fn nokia_reset(hu: *mut hci_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_send_alive_packet(hu: *mut hci_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_send_negotiation(hu: *mut hci_uart) -> c_int {
    ...
    struct sk_buff *skb;
    int len, err;
    let mut baud: u16 = DIV_ROUND_CLOSEST(btdev.sysclk_speed * 10, SETUP_BAUD_RATE);
    let mut sysclk: c_int = btdev.sysclk_speed / 1000;
...
#[no_mangle]
unsafe extern "C" fn nokia_setup_fw(hu: *mut hci_uart) -> c_int {
    ...
    fw_size = fw.size;
    while (fw_size >= 4) {
    let mut pkt_size: u16 = get_unaligned_le16(fw_ptr);
    let mut pkt_type: u8 = fw_ptr[2];
...
#[no_mangle]
unsafe extern "C" fn nokia_setup(hu: *mut hci_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_open(hu: *mut hci_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_flush(hu: *mut hci_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_close(hu: *mut hci_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_enqueue(hu: *mut hci_uart, skb: *mut sk_buff) -> c_int {
    static int nokia_enqueue(struct hci_uart *hu, struct sk_buff *skb)
    {
    struct nokia_bt_dev *btdev = hu.priv;
    int err;
...
#[no_mangle]
unsafe extern "C" fn nokia_recv_alive_packet(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_recv_radio(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_recv(hu: *mut hci_uart, data: *const c_void, count: c_int) -> c_int {
    ...
    btdev.rx_skb = core::ptr::null_mut();
    return err;
    }
    return count;
    }
...
#[no_mangle]
unsafe extern "C" fn nokia_bluetooth_serdev_probe(serdev: *mut serdev_device) -> c_int {
    ...
    err = devm_request_threaded_irq(dev, btdev.wake_irq, core::ptr::null_mut(),
    wakeup_handler,
...
#[no_mangle]
unsafe extern "C" fn nokia_bluetooth_serdev_remove(serdev: *mut serdev_device) {
...
#[no_mangle]
unsafe extern "C" fn nokia_bluetooth_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nokia_bluetooth_runtime_resume(dev: *mut device) -> c_int {
