...
//! Source: drivers/bluetooth/btmtkuart.c
#![no_std]
...
pub const MTK_STP_TLR_SIZE: c_int = 2;
pub const BTMTKUART_TX_STATE_ACTIVE: c_int = 1;
pub const BTMTKUART_TX_STATE_WAKEUP: c_int = 2;
pub const BTMTKUART_TX_WAIT_VND_EVT: c_int = 3;
pub const BTMTKUART_REQUIRED_WAKEUP: c_int = 4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_stp_hdr {
    pub prefix: u8,
    pub dlen: __be16,
    pub cs: u8,
    pub __packed: },
...
pub struct btmtkuart_dev {
    ...
    pub boot: *mut gpio_desc,
    pub pinctrl: *mut pinctrl,
    pub pins_runtime: *mut pinctrl_state,
    pub pins_boot: *mut pinctrl_state,
    pub desired_speed: speed_t,
    pub curr_speed: speed_t,
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_recv_event(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_tx_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_tx_wakeup(bdev: *mut btmtkuart_dev) {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_recv(hdev: *mut hci_dev, data: *const u8, count: usize) {
    static void btmtkuart_recv(struct hci_dev *hdev, const u8 *data, size_t count)
    {
    struct btmtkuart_dev *bdev = hci_get_drvdata(hdev);
    const unsigned char *p_left = data, *p_h4;
    let mut sz_left: c_int = count, sz_h4, adv;
    int err;
    while (sz_left > 0) {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_write_wakeup(serdev: *mut serdev_device) {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_open(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_close(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_flush(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_func_query(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_change_baudrate(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_setup(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_shutdown(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_send_frame(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_parse_dt(serdev: *mut serdev_device) -> c_int {
    static int btmtkuart_parse_dt(struct serdev_device *serdev)
    {
    struct btmtkuart_dev *bdev = serdev_device_get_drvdata(serdev);
    struct device_node *node = serdev.dev.of_node;
    let mut speed: u32 = 921600;
    int err;
    if (btmtkuart_is_standalone(bdev)) {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_probe(serdev: *mut serdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtkuart_remove(serdev: *mut serdev_device) {
