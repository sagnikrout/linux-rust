...
//! Source: drivers/bluetooth/btusb.c
#![no_std]
...
//
    ...
    let mut enable_autosuspend: static bool = IS_ENABLED(CONFIG_BT_HCIBTUSB_AUTOSUSPEND);
    let mut enable_poll_sync: static bool = IS_ENABLED(CONFIG_BT_HCIBTUSB_POLL_SYNC);
    let mut reset: static bool = true;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qca_dump_info {
// fields for dump collection
    pub id_vendor: u16,
    pub id_product: u16,
    pub fw_version: u32,
    pub controller_id: u32,
    pub ram_dump_size: u32,
    pub ram_dump_seqno: u16,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct btqca_data {
    pub qca_dump: qca_dump_info,
}

pub const BTUSB_MAX_ISOC_FRAMES: c_int = 10;
pub const BTUSB_INTR_RUNNING: c_int = 0;
pub const BTUSB_BULK_RUNNING: c_int = 1;
pub const BTUSB_ISOC_RUNNING: c_int = 2;
pub const BTUSB_SUSPENDING: c_int = 3;
pub const BTUSB_DID_ISO_RESUME: c_int = 4;
pub const BTUSB_BOOTLOADER: c_int = 5;
pub const BTUSB_DOWNLOADING: c_int = 6;
pub const BTUSB_FIRMWARE_LOADED: c_int = 7;
pub const BTUSB_FIRMWARE_FAILED: c_int = 8;
pub const BTUSB_BOOTING: c_int = 9;
pub const BTUSB_DIAG_RUNNING: c_int = 10;
pub const BTUSB_OOB_WAKE_ENABLED: c_int = 11;
pub const BTUSB_HW_RESET_ACTIVE: c_int = 12;
pub const BTUSB_TX_WAIT_VND_EVT: c_int = 13;
pub const BTUSB_WAKEUP_AUTOSUSPEND: c_int = 14;
pub const BTUSB_USE_ALT3_FOR_WBS: c_int = 15;
pub const BTUSB_ALT6_CONTINUOUS_TX: c_int = 16;
pub const BTUSB_HW_SSR_ACTIVE: c_int = 17;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btusb_data {
    pub hdev: *mut hci_dev,
    pub udev: *mut usb_device,
    pub intf: *mut usb_interface,
    pub isoc: *mut usb_interface,
    pub diag: *mut usb_interface,
    pub isoc_ifnum: unsigned,
    pub flags: c_ulong,
    pub poll_sync: bool,
    pub intr_interval: c_int,
    pub work: work_struct,
    pub waker: work_struct,
    pub rx_work: delayed_work,
    pub acl_q: sk_buff_head,
    pub deferred: usb_anchor,
    pub tx_anchor: usb_anchor,
    pub tx_in_flight: c_int,
    pub txlock: spinlock_t,
    pub intr_anchor: usb_anchor,
    pub bulk_anchor: usb_anchor,
    pub isoc_anchor: usb_anchor,
    pub diag_anchor: usb_anchor,
    pub ctrl_anchor: usb_anchor,
    pub rxlock: spinlock_t,
    pub evt_skb: *mut sk_buff,
    pub acl_skb: *mut sk_buff,
    pub sco_skb: *mut sk_buff,
    pub intr_ep: *mut usb_endpoint_descriptor,
    pub bulk_tx_ep: *mut usb_endpoint_descriptor,
    pub bulk_rx_ep: *mut usb_endpoint_descriptor,
    pub isoc_tx_ep: *mut usb_endpoint_descriptor,
    pub isoc_rx_ep: *mut usb_endpoint_descriptor,
    pub diag_tx_ep: *mut usb_endpoint_descriptor,
    pub diag_rx_ep: *mut usb_endpoint_descriptor,
    pub reset_gpio: *mut gpio_desc,
    pub cmdreq_type: __u8,
    pub cmdreq: __u8,
    pub sco_num: c_uint,
    pub air_mode: c_uint,
    pub usb_alt6_packet_flow: bool,
    pub isoc_altsetting: c_int,
    pub suspend_count: c_int,
    pub match_id: *const usb_device_id,
    pub skb): *mut *mut *mut int (recv_event)(struct hci_dev hdev, struct sk_buff,
    pub skb): *mut *mut *mut int (recv_acl)(struct hci_dev hdev, struct sk_buff,
    pub count): *mut *mut *mut *mut int (recv_bulk)(struct btusb_data data, void buffer, int,
    pub hdev): *mut *mut int (setup_on_usb)(struct hci_dev,
    pub hdev): *mut *mut int (suspend)(struct hci_dev,
    pub hdev): *mut *mut int (resume)(struct hci_dev,
    pub hdev): *mut *mut int (disconnect)(struct hci_dev,
    pub /: *mut *mut int oob_wake_irq; / irq for out-of-band wake-on-bt,
}

#[no_mangle]
unsafe extern "C" fn btusb_reset(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn btusb_intel_reset(hdev: *mut hci_dev) {
...
pub const RTK_DEVCOREDUMP_CODE_MEMDUMP: c_uint = 0x01;
pub const RTK_DEVCOREDUMP_CODE_HW_ERR: c_uint = 0x02;
pub const RTK_DEVCOREDUMP_CODE_CMD_TIMEOUT: c_uint = 0x03;
pub const RTK_SUB_EVENT_CODE_COREDUMP: c_uint = 0x34;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rtk_dev_coredump_hdr {
    pub type: u8,
    pub code: u8,
    pub reserved: [u8; 2],
    pub __packed: },
    ...
    {
    pub skb: *mut sk_buff,
    pub GFP_ATOMIC): *mut *mut skb = alloc_skb(len + sizeof(hdr),,
    if (!skb)
    pub sizeof(*hdr)): *mut skb_put_data(skb, hdr,,
    if (len)
    pub len): skb_put_data(skb, buf,,
    if (!hci_devcd_init(hdev, skb.len)) {
    pub skb): hci_devcd_append(hdev,,
    } else {
    pub devcoredump"): bt_dev_err(hdev, "RTL: Failed to generate,
    }
    }
#[no_mangle]
unsafe extern "C" fn btusb_rtl_reset(hdev: *mut hci_dev) {
    static void btusb_rtl_reset(struct hci_dev *hdev)
    {
    pub hci_get_drvdata(hdev): *mut *mut btusb_data data =,
    pub data->reset_gpio: *mut *mut gpio_desc reset_gpio =,
...
#[no_mangle]
unsafe extern "C" fn btusb_rtl_hw_error(hdev: *mut hci_dev, code: u8) {
...
#[no_mangle]
unsafe extern "C" fn btusb_qca_reset(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn btusb_classify_qca_pkt_type(hdev: *mut hci_dev, skb: *mut sk_buff) -> u8 {
...
//
    if (skb.len >= 2) {
    let mut handle: u16 = get_unaligned_le16(skb.data);
    if (handle == 0x2EDC)
    return HCI_DIAG_PKT;
    }
...
#[no_mangle]
pub unsafe extern "C" fn btusb_free_frags(data: *mut btusb_data) {
...
#[no_mangle]
unsafe extern "C" fn btusb_recv_event(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_recv_intr(data: *mut btusb_data, buffer: *mut c_void, count: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_recv_acl(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_recv_bulk(data: *mut btusb_data, buffer: *mut c_void, count: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_recv_isoc(data: *mut btusb_data, buffer: *mut c_void, count: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_intr_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn btusb_submit_intr_urb(hdev: *mut hci_dev, mem_flags: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_bulk_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn btusb_submit_bulk_urb(hdev: *mut hci_dev, mem_flags: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_isoc_complete(urb: *mut urb) {
    ...
    let mut offset: c_uint = urb.iso_frame_desc[i].offset;
    let mut length: c_uint = urb.iso_frame_desc[i].actual_length;
...
#[no_mangle]
pub unsafe extern "C" fn __fill_isoc_descriptor(urb: *mut urb, len: c_int, mtu: c_int) {
...
#[no_mangle]
unsafe extern "C" fn btusb_submit_isoc_urb(hdev: *mut hci_dev, mem_flags: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_diag_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn btusb_submit_diag_urb(hdev: *mut hci_dev, mem_flags: gfp_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_tx_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn btusb_isoc_tx_complete(urb: *mut urb) {
...
#[no_mangle]
unsafe extern "C" fn btusb_open(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_stop_traffic(data: *mut btusb_data) {
...
#[no_mangle]
unsafe extern "C" fn btusb_prepare_reset(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn btusb_close(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_flush(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn submit_tx_urb(hdev: *mut hci_dev, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn submit_or_queue_tx_urb(hdev: *mut hci_dev, urb: *mut urb) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_send_frame(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_notify(hdev: *mut hci_dev, evt: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn __set_isoc_interface(hdev: *mut hci_dev, altsetting: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_switch_alt_setting(hdev: *mut hci_dev, new_alts: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_work(work: *mut work_struct) {
    static void btusb_work(struct work_struct *work)
    {
    struct btusb_data *data = container_of(work, struct btusb_data, work);
    struct hci_dev *hdev = data.hdev;
    let mut new_alts: c_int = 0;
    int err;
    if (data.sco_num > 0) {
...
#[no_mangle]
unsafe extern "C" fn btusb_waker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn btusb_rx_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn btusb_setup_bcm92035(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_setup_csr(hdev: *mut hci_dev) -> c_int {
    static int btusb_setup_csr(struct hci_dev *hdev)
    {
    struct btusb_data *data = hci_get_drvdata(hdev);
    let mut bcdDevice: u16 = le16_to_cpu(data.udev.descriptor.bcdDevice);
    struct hci_rp_read_local_version *rp;
    struct sk_buff *skb;
    let mut is_fake: bool = false;
    int ret;
    BT_DBG("%s", hdev.name);
    skb = __hci_cmd_sync(hdev, HCI_OP_READ_LOCAL_VERSION, 0, core::ptr::null_mut(),
    HCI_INIT_TIMEOUT);
    if (IS_ERR(skb)) {
    let mut err: c_int = PTR_ERR(skb);
...
#[no_mangle]
unsafe extern "C" fn btusb_send_frame_intel(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_setup_realtek(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_recv_event_realtek(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_mtk_claim_iso_intf(data: *mut btusb_data) {
...
#[no_mangle]
unsafe extern "C" fn btusb_mtk_release_iso_intf(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn btusb_mtk_disconnect(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_mtk_reset(hdev: *mut hci_dev, rst_data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_send_frame_mtk(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_mtk_setup(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_mtk_shutdown(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn marvell_config_oob_wake(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn marvell_config_oob_wake(hdev: *mut hci_dev) -> c_int {
...
pub const QCA_MEMDUMP_ACL_HANDLE: c_uint = 0x2EDD;
pub const QCA_MEMDUMP_SIZE_MAX: c_uint = 0x100000;
pub const QCA_MEMDUMP_VSE_CLASS: c_uint = 0x01;
pub const QCA_MEMDUMP_MSG_TYPE: c_uint = 0x08;
pub const QCA_MEMDUMP_PKT_SIZE: c_int = 248;
pub const QCA_LAST_SEQUENCE_NUM: c_uint = 0xffff;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qca_dump_hdr {
    pub vse_class: u8,
    pub msg_type: u8,
    pub seqno: __le16,
    pub reserved: u8,
...
#[no_mangle]
unsafe extern "C" fn btusb_dump_hdr_qca(hdev: *mut hci_dev, skb: *mut sk_buff) {
...
#[no_mangle]
unsafe extern "C" fn btusb_coredump_qca(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn handle_dump_pkt_qca(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
    static int handle_dump_pkt_qca(struct hci_dev *hdev, struct sk_buff *skb)
    {
    let mut ret: c_int = 0;
    let mut skip: c_uint = 0;
    u8 pkt_type;
    u16 seqno;
    u32 dump_size;
...
#[no_mangle]
unsafe extern "C" fn acl_pkt_is_dump_qca(hdev: *mut hci_dev, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn evt_pkt_is_dump_qca(hdev: *mut hci_dev, skb: *mut sk_buff) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btusb_recv_acl_qca(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_recv_evt_qca(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
pub const QCA_DFU_PACKET_LEN: c_int = 4096;
pub const QCA_GET_TARGET_VERSION: c_uint = 0x09;
pub const QCA_CHECK_STATUS: c_uint = 0x05;
pub const QCA_DFU_DOWNLOAD: c_uint = 0x01;
pub const QCA_SYSCFG_UPDATED: c_uint = 0x40;
pub const QCA_PATCH_UPDATED: c_uint = 0x80;
pub const QCA_DFU_TIMEOUT: c_int = 3000;
pub const QCA_FLAG_MULTI_NVM: c_uint = 0x80;
pub const QCA_BT_RESET_WAIT_MS: c_int = 100;
pub const WCN6855_2_0_RAM_VERSION_GF: c_uint = 0x400c1200;
pub const WCN6855_2_1_RAM_VERSION_GF: c_uint = 0x400c1211;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qca_version {
    pub rom_version: __le32,
    pub patch_version: __le32,
    pub ram_version: __le32,
    pub chip_id: __u8,
    pub platform_id: __u8,
    pub flag: __le16,
    pub reserved: [__u8; 4],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qca_rampatch_version {
    pub rom_version_high: __le16,
    pub rom_version_low: __le16,
    pub patch_version: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qca_device_info {
    pub rom_version: u32,
    pub /: *mut *mut u8 rampatch_hdr; / length of header in rampatch,
    pub /: *mut *mut u8 nvm_hdr; / length of header in NVM,
    pub /: *mut *mut u8 ver_offset; / offset of version structure in rampatch,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qca_custom_firmware {
    pub rom_version: u32,
    pub board_id: u16,
    pub subdirectory: *const c_char,
}
...
#[no_mangle]
unsafe extern "C" fn qca_extract_board_id(ver: *const qca_version) -> u16 {
    static u16 qca_extract_board_id(const struct qca_version *ver)
    {
    let mut flag: u16 = le16_to_cpu(ver.flag);
    let mut board_id: u16 = 0;
...
//
    ...
    {
    let mut rom_version: u32 = le32_to_cpu(ver.rom_version);
...
#[no_mangle]
unsafe extern "C" fn btusb_qca_need_patch(udev: *mut usb_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btusb_setup_qca(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn __set_diag_interface(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_bcm_set_diag(hdev: *mut hci_dev, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_oob_wake_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn btusb_config_oob_wake(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn btusb_config_oob_wake(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_check_needs_reset_resume(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn btusb_wakeup(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btusb_shutdown_qca(hdev: *mut hci_dev) -> c_int {
...
pub const BTUSB_HCI_DRV_SUPPORTED_ALTSETTINGS_SIZE: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btusb_hci_drv_rp_supported_altsettings {
    pub num: __u8,
    pub altsettings: [__u8; ],
    pub __packed: },

    hci_opcode_pack(HCI_DRV_OGF_DRIVER_SPECIFIC, 0x0001)
pub const BTUSB_HCI_DRV_SWITCH_ALTSETTING_SIZE: c_int = 1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btusb_hci_drv_cmd_switch_altsetting {
    pub altsetting: __u8,
    pub __packed: },
    static const struct {
    pub opcode: u16,
...
// Support is advertised, but not implemented
    ...
    let mut bcdDevice: u16 = le16_to_cpu(udev.descriptor.bcdDevice);
...
#[no_mangle]
unsafe extern "C" fn btusb_disconnect(intf: *mut usb_interface) {
...
#[no_mangle]
unsafe extern "C" fn btusb_suspend(intf: *mut usb_interface, message: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn play_deferred(data: *mut btusb_data) {
...
#[no_mangle]
unsafe extern "C" fn btusb_resume(intf: *mut usb_interface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btusb_coredump(dev: *mut device) {
