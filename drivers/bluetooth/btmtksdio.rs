...
//! Source: drivers/bluetooth/btmtksdio.c
#![no_std]
...
pub const MTKBTSDIO_AUTOSUSPEND_DELAY: c_int = 1000;
    let mut enable_autosuspend: static bool = true;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btmtksdio_data {
    pub fwname: *const c_char,
    pub chipid: u16,
    pub lp_mbox_supported: bool,
    pub pm_runtime_supported: bool,
}
...
pub const MTK_REG_CHLPCR: c_uint = 0x4	/* W1S */;

pub const MTK_REG_CSDIOCSR: c_uint = 0x8;

pub const MTK_REG_CHCR: c_uint = 0xc;

// CHISR have the same bits field definition with CHIER
pub const MTK_REG_CHISR: c_uint = 0x10;
pub const MTK_REG_CHIER: c_uint = 0x14;

pub const MTK_REG_CSICR: c_uint = 0xc0;

pub const MTK_REG_PH2DSM0R: c_uint = 0xc4;

pub const MTK_REG_PD2HRM0R: c_uint = 0xdc;

pub const MTK_REG_CTDR: c_uint = 0x18;
pub const MTK_REG_CRDR: c_uint = 0x1c;
pub const MTK_REG_CRPLR: c_uint = 0x24;
pub const MTK_SDIO_BLOCK_SIZE: c_int = 256;
pub const BTMTKSDIO_TX_WAIT_VND_EVT: c_int = 1;
pub const BTMTKSDIO_HW_TX_READY: c_int = 2;
pub const BTMTKSDIO_FUNC_ENABLED: c_int = 3;
pub const BTMTKSDIO_PATCH_ENABLED: c_int = 4;
pub const BTMTKSDIO_HW_RESET_ACTIVE: c_int = 5;
pub const BTMTKSDIO_BT_WAKE_ENABLED: c_int = 6;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtkbtsdio_hdr {
    pub len: __le16,
    pub reserved: __le16,
    pub bt_type: u8,
    pub __packed: },
...
#[no_mangle]
pub unsafe extern "C" fn if(0x420: be16_to_cpu(wmt_evt_funcc->status) ==) -> else {
    ...
    status = BTMTK_WMT_PATCH_DONE;
#[no_mangle]
pub unsafe extern "C" fn if(1: wmt_evt->whdr.flag ==) -> else {
...
// wmt_params->status = status;
    ...
    bdev.evt_skb = core::ptr::null_mut();
    err_free_wc:
    kfree(wc);
    return err;
    }
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_drv_own_query(bdev: *mut btmtksdio_dev) -> u32 {
    static u32 btmtksdio_drv_own_query(struct btmtksdio_dev *bdev)
    {
    return sdio_readl(bdev.func, MTK_REG_CHLPCR, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn btmtksdio_drv_own_query_79xx(bdev: *mut btmtksdio_dev) -> u32 {
    static u32 btmtksdio_drv_own_query_79xx(struct btmtksdio_dev *bdev)
    {
    return sdio_readl(bdev.func, MTK_REG_PD2HRM0R, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn btmtksdio_chcr_query(bdev: *mut btmtksdio_dev) -> u32 {
    static u32 btmtksdio_chcr_query(struct btmtksdio_dev *bdev)
    {
    return sdio_readl(bdev.func, MTK_REG_CHCR, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn btmtksdio_fw_pmctrl(bdev: *mut btmtksdio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_drv_pmctrl(bdev: *mut btmtksdio_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_recv_event(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
    static int btmtksdio_recv_event(struct hci_dev *hdev, struct sk_buff *skb)
    {
    struct btmtksdio_dev *bdev = hci_get_drvdata(hdev);
    struct hci_event_hdr *hdr = (void *)skb.data;
    let mut evt: u8 = hdr.evt;
    int err;
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_recv_acl(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
    static int btmtksdio_recv_acl(struct hci_dev *hdev, struct sk_buff *skb)
    {
    struct btmtksdio_dev *bdev = hci_get_drvdata(hdev);
    let mut handle: u16 = le16_to_cpu(hci_acl_hdr(skb).handle);
    switch (handle) {
    case 0xfc6f:
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_rx_packet(bdev: *mut btmtksdio_dev, rx_size: u16) -> c_int {
    static int btmtksdio_rx_packet(struct btmtksdio_dev *bdev, u16 rx_size)
    {
    const struct h4_recv_pkt *pkts = mtk_recv_pkts;
    let mut pkts_count: c_int = ARRAY_SIZE(mtk_recv_pkts);
    struct mtkbtsdio_hdr *sdio_hdr;
    int err, i, pad_size;
    struct sk_buff *skb;
    u16 dlen;
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_txrx_work(work: *mut work_struct) {
    ...
    sdio_claim_host(bdev.func);
// Disable interrupt
    sdio_writel(bdev.func, C_INT_EN_CLR, MTK_REG_CHLPCR, core::ptr::null_mut());
    txrx_timeout = jiffies + 5 * HZ;
    do {
    int_status = sdio_readl(bdev.func, MTK_REG_CHISR, core::ptr::null_mut());
...
// FIFO.
//
    sdio_writel(bdev.func, int_status, MTK_REG_CHISR, core::ptr::null_mut());
    int_status &= INT_MASK;
    if ((int_status & FW_MAILBOX_INT) &&
    bdev.data.chipid == 0x7921) {
    sdio_writel(bdev.func, PH2DSM0R_DRIVER_OWN,
    MTK_REG_PH2DSM0R, core::ptr::null_mut());
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(TX_FIFO_OVERFLOW): unlikely(int_status &) -> else {
    ...
    rx_size = sdio_readl(bdev.func, MTK_REG_CRPLR, core::ptr::null_mut());
...
// Enable interrupt
    ...
    sdio_writel(bdev.func, C_INT_EN_SET, MTK_REG_CHLPCR, core::ptr::null_mut());
    sdio_release_host(bdev.func);
    pm_runtime_put_autosuspend(bdev.dev);
    }
#[no_mangle]
unsafe extern "C" fn btmtksdio_interrupt(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_open(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_close(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_flush(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_func_query(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mt76xx_setup(hdev: *mut hci_dev, fwname: *const c_char) -> c_int {
    ...
    struct sk_buff *skb;
    int err, status;
    let mut param: u8 = 0x1;
// Query whether the firmware is already download
    wmt_params.op = BTMTK_WMT_SEMAPHORE;
    wmt_params.flag = 1;
    wmt_params.dlen = 0;
    wmt_params.data = core::ptr::null_mut();
    wmt_params.status = &status;
    err = mtk_hci_wmt_sync(hdev, &wmt_params);
    if (err < 0) {
...
// Enable Bluetooth protocol
    ...
    wmt_params.dlen = sizeof(param);
    wmt_params.data = &param;
    wmt_params.status = core::ptr::null_mut();
    err = mtk_hci_wmt_sync(hdev, &wmt_params);
    if (err < 0) {
...
#[no_mangle]
unsafe extern "C" fn mt79xx_setup(hdev: *mut hci_dev, fwname: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_mtk_reg_read(hdev: *mut hci_dev, reg: u32, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_mtk_reg_write(hdev: *mut hci_dev, reg: u32, val: u32, mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_get_data_path_id(hdev: *mut hci_dev, data_path_id: *mut __u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_sco_setting(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_reset_setting(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_setup(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_shutdown(hdev: *mut hci_dev) -> c_int {
    static int btmtksdio_shutdown(struct hci_dev *hdev)
    {
    struct btmtksdio_dev *bdev = hci_get_drvdata(hdev);
    struct btmtk_hci_wmt_params wmt_params;
    let mut param: u8 = 0x0;
    int err;
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_send_frame(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_reset(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_sdio_inband_wakeup(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_sdio_wakeup(hdev: *mut hci_dev) -> bool {
    static bool btmtksdio_sdio_wakeup(struct hci_dev *hdev)
    {
    struct btmtksdio_dev *bdev = hci_get_drvdata(hdev);
    let mut may_wakeup: bool = device_may_wakeup(bdev.dev);
...
//
    ...
    bdev.dev.of_node = of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_remove(func: *mut sdio_func) {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_system_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_runtime_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btmtksdio_system_resume(dev: *mut device) -> c_int {
    ...
    RUNTIME_PM_OPS(btmtksdio_runtime_suspend, btmtksdio_runtime_resume, core::ptr::null_mut())
    };
