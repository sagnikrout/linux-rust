...
//! Source: drivers/bluetooth/btnxpuart.c
#![no_std]
...
pub const MANUFACTURER_NXP: c_int = 37;
pub const BTNXPUART_TX_STATE_ACTIVE: c_int = 1;
pub const BTNXPUART_FW_DOWNLOADING: c_int = 2;
pub const BTNXPUART_CHECK_BOOT_SIGNATURE: c_int = 3;
pub const BTNXPUART_SERDEV_OPEN: c_int = 4;
pub const BTNXPUART_IR_IN_PROGRESS: c_int = 5;
pub const BTNXPUART_FW_DOWNLOAD_ABORT: c_int = 6;
pub const BTNXPUART_FW_DUMP_IN_PROGRESS: c_int = 7;
// NXP HW err codes
pub const BTNXPUART_IR_HW_ERR: c_uint = 0xb0;

pub const CHIP_ID_W9098: c_uint = 0x5c03;
pub const CHIP_ID_IW416: c_uint = 0x7201;
pub const CHIP_ID_IW612: c_uint = 0x7601;
pub const CHIP_ID_IW624a: c_uint = 0x8000;
pub const CHIP_ID_IW624c: c_uint = 0x8001;
pub const CHIP_ID_AW693a0: c_uint = 0x8200;
pub const CHIP_ID_AW693a1: c_uint = 0x8201;
pub const CHIP_ID_IW610a0: c_uint = 0x8800;
pub const CHIP_ID_IW610a1: c_uint = 0x8801;
pub const FW_SECURE_MASK: c_uint = 0xc0;
pub const FW_OPEN: c_uint = 0x00;
pub const FW_AUTH_ILLEGAL: c_uint = 0x40;
pub const FW_AUTH_PLAIN: c_uint = 0x80;
pub const FW_AUTH_ENC: c_uint = 0xc0;
pub const HCI_NXP_PRI_BAUDRATE: c_int = 115200;
pub const HCI_NXP_SEC_BAUDRATE_3M: c_int = 3000000;
pub const HCI_NXP_SEC_BAUDRATE_4M: c_int = 4000000;
pub const MAX_FW_FILE_NAME_LEN: c_int = 50;
// Default ps timeout period in milliseconds
pub const PS_DEFAULT_TIMEOUT_PERIOD_MS: c_int = 2000;
// wakeup methods
pub const WAKEUP_METHOD_DTR: c_int = 0;
pub const WAKEUP_METHOD_BREAK: c_int = 1;
pub const WAKEUP_METHOD_EXT_BREAK: c_int = 2;
pub const WAKEUP_METHOD_RTS: c_int = 3;
pub const WAKEUP_METHOD_GPIO: c_int = 4;
pub const WAKEUP_METHOD_INVALID: c_uint = 0xff;
// power save mode status
pub const PS_MODE_DISABLE: c_int = 0;
pub const PS_MODE_ENABLE: c_int = 1;
// Power Save Commands to ps_work_func
pub const PS_CMD_EXIT_PS: c_int = 1;
pub const PS_CMD_ENTER_PS: c_int = 2;
// power save state
pub const PS_STATE_AWAKE: c_int = 0;
pub const PS_STATE_SLEEP: c_int = 1;
// NXP Vendor Commands. Refer user manual UM11628 on nxp.com
// Set custom BD Address
pub const HCI_NXP_SET_BD_ADDR: c_uint = 0xfc22;
// Set Auto-Sleep mode
pub const HCI_NXP_AUTO_SLEEP_MODE: c_uint = 0xfc23;
// Set Wakeup method
pub const HCI_NXP_WAKEUP_METHOD: c_uint = 0xfc53;
// Set operational baudrate
pub const HCI_NXP_SET_OPER_SPEED: c_uint = 0xfc09;
// Independent Reset (Soft Reset)
pub const HCI_NXP_IND_RESET: c_uint = 0xfcfc;
// Bluetooth vendor command: Trigger FW dump
pub const HCI_NXP_TRIGGER_DUMP: c_uint = 0xfe91;
// Bluetooth Power State : Vendor cmd params
pub const BT_PS_ENABLE: c_uint = 0x02;
pub const BT_PS_DISABLE: c_uint = 0x03;
// Bluetooth Host Wakeup Methods
pub const BT_HOST_WAKEUP_METHOD_NONE: c_uint = 0x00;
pub const BT_HOST_WAKEUP_METHOD_DTR: c_uint = 0x01;
pub const BT_HOST_WAKEUP_METHOD_BREAK: c_uint = 0x02;
pub const BT_HOST_WAKEUP_METHOD_GPIO: c_uint = 0x03;
// Bluetooth Chip Wakeup Methods
pub const BT_CTRL_WAKEUP_METHOD_DSR: c_uint = 0x00;
pub const BT_CTRL_WAKEUP_METHOD_BREAK: c_uint = 0x01;
pub const BT_CTRL_WAKEUP_METHOD_GPIO: c_uint = 0x02;
pub const BT_CTRL_WAKEUP_METHOD_EXT_BREAK: c_uint = 0x04;
pub const BT_CTRL_WAKEUP_METHOD_RTS: c_uint = 0x05;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ps_data {
    pub /: *mut *mut u8 target_ps_mode; / ps mode to be set,
    pub /: *mut *mut u8 cur_psmode; / current ps_mode,
    pub /: *mut *mut u8 ps_state; / controller's power save state,
    pub ps_cmd: u8,
    pub h2c_wakeupmode: u8,
    pub cur_h2c_wakeupmode: u8,
    pub c2h_wakeupmode: u8,
    pub c2h_wakeup_gpio: u8,
    pub h2c_wakeup_gpio: u8,
    pub driver_sent_cmd: bool,
    pub h2c_ps_interval: u16,
    pub c2h_ps_interval: u16,
    pub wakeup_source: bool,
    pub h2c_ps_gpio: *mut gpio_desc,
    pub irq_handler: i32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct psmode_cmd_payload {
    pub ps_cmd: u8,
    pub c2h_ps_interval: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct btnxpuart_data {
    pub helper_fw_name: *const c_char,
    pub fw_name: *const c_char,
    pub fw_name_old: *const c_char,
}
...
pub struct btnxpuart_dev {
    ...
    pub fw_name: [u8; MAX_FW_FILE_NAME_LEN],
    pub fw_dnld_v1_offset: u32,
    pub fw_v1_sent_bytes: u32,
    pub fw_dnld_v3_offset: u32,
    pub fw_v3_offset_correction: u32,
    pub fw_v3_prev_sent: u32,
    pub fw_v1_expected_len: u32,
    pub boot_reg_offset: u32,
    pub fw_dnld_done_wait_q: wait_queue_head_t,
    pub check_boot_sign_wait_q: wait_queue_head_t,
    pub new_baudrate: u32,
    pub current_baudrate: u32,
    pub fw_init_baudrate: u32,
    pub secondary_baudrate: u32,
    pub timeout_changed: enum bootloader_param_change,
    pub baudrate_changed: enum bootloader_param_change,
    pub helper_downloaded: bool,
    pub psdata: ps_data,
    pub nxp_data: *mut btnxpuart_data,
    pub pwrseq: *mut pwrseq_desc,
    pub pdn: *mut reset_control,
    pub hu: hci_uart,
}

pub const NXP_V1_FW_REQ_PKT: c_uint = 0xa5;
pub const NXP_V1_CHIP_VER_PKT: c_uint = 0xaa;
pub const NXP_V3_FW_REQ_PKT: c_uint = 0xa7;
pub const NXP_V3_CHIP_VER_PKT: c_uint = 0xab;
pub const NXP_ACK_V1: c_uint = 0x5a;
pub const NXP_NAK_V1: c_uint = 0xbf;
pub const NXP_ACK_V3: c_uint = 0x7a;
pub const NXP_NAK_V3: c_uint = 0x7b;
pub const NXP_CRC_ERROR_V3: c_uint = 0x7c;
// Bootloader signature error codes: Refer AN12820 from nxp.com

pub const HDR_LEN: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v1_data_req {
    pub len: __le16,
    pub len_comp: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v1_start_ind {
    pub chip_id: __le16,
    pub chip_id_comp: __le16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v3_data_req {
    pub len: __le16,
    pub offset: __le32,
    pub error: __le16,
    pub crc: u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct v3_start_ind {
    pub chip_id: __le16,
    pub loader_ver: u8,
    pub crc: u8,
    pub __packed: },
// UART register addresses of BT chip
pub const CLKDIVADDR: c_uint = 0x7f00008f;
pub const UARTDIVADDR: c_uint = 0x7f000090;
pub const UARTMCRADDR: c_uint = 0x7f000091;
pub const UARTREINITADDR: c_uint = 0x7f000092;
pub const UARTICRADDR: c_uint = 0x7f000093;
pub const UARTFCRADDR: c_uint = 0x7f000094;
pub const MCR: c_uint = 0x00000022;
pub const INIT: c_uint = 0x00000001;
pub const ICR: c_uint = 0x000000c7;
pub const FCR: c_uint = 0x000000c7;
pub const POLYNOMIAL8: c_uint = 0x07;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uart_reg {
    pub address: __le32,
...
pub struct uart_config {
    pub clkdiv: uart_reg,
    pub uartdiv: uart_reg,
    pub mcr: uart_reg,
    pub re_init: uart_reg,
    pub icr: uart_reg,
    pub fcr: uart_reg,
    pub crc: __be32,
    pub __packed: },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nxp_v3_rx_timeout_nak {
    pub nak: u8,
    pub offset: __le32,
    pub crc: u8,
    pub __packed: },
    union nxp_v3_rx_timeout_nak_u {
    pub pkt: nxp_v3_rx_timeout_nak,
    pub buf: [u8; 6],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nxp_v3_crc_nak {
    pub nak: u8,
    pub crc: u8,
    pub __packed: },
    union nxp_v3_crc_nak_u {
    pub pkt: nxp_v3_crc_nak,
    pub buf: [u8; 2],
}
...
#[no_mangle]
unsafe extern "C" fn btnxpuart_tx_wakeup(nxpdev: *mut btnxpuart_dev) {
...
#[no_mangle]
unsafe extern "C" fn ps_start_timer(nxpdev: *mut btnxpuart_dev) {
...
#[no_mangle]
unsafe extern "C" fn ps_cancel_timer(nxpdev: *mut btnxpuart_dev) {
...
#[no_mangle]
unsafe extern "C" fn ps_control(hdev: *mut hci_dev, ps_state: u8) {
...
#[no_mangle]
unsafe extern "C" fn ps_work_func(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PS_CMD_EXIT_PS: data->ps_cmd ==) -> else {
    else if (data.ps_cmd == PS_CMD_EXIT_PS)
    ps_control(data.hdev, PS_STATE_AWAKE);
    }
#[no_mangle]
unsafe extern "C" fn ps_timeout_func(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn ps_host_wakeup_irq_handler(irq: c_int, priv: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ps_setup(hdev: *mut hci_dev) -> c_int {
...
// Out-Of-Band Host Wakeup
    ...
    core::ptr::null_mut(), ps_host_wakeup_irq_handler,
    IRQF_ONESHOT,
...
#[no_mangle]
unsafe extern "C" fn ps_wakeup(nxpdev: *mut btnxpuart_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ps_cleanup(nxpdev: *mut btnxpuart_dev) {
...
#[no_mangle]
unsafe extern "C" fn send_ps_cmd(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_wakeup_method_cmd(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ps_init(hdev: *mut hci_dev) {
    static void ps_init(struct hci_dev *hdev)
    {
    struct btnxpuart_dev *nxpdev = hci_get_drvdata(hdev);
    struct ps_data *psdata = &nxpdev.psdata;
    let mut default_h2c_wakeup_mode: u8 = DEFAULT_H2C_WAKEUP_MODE;
...
#[no_mangle]
unsafe extern "C" fn nxp_download_firmware(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_send_ack(ack: u8, hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nxp_fw_change_baudrate(hdev: *mut hci_dev, req_len: u16) -> bool {
    static bool nxp_fw_change_baudrate(struct hci_dev *hdev, u16 req_len)
    {
    struct btnxpuart_dev *nxpdev = hci_get_drvdata(hdev);
    struct nxp_bootloader_cmd nxp_cmd5;
    struct uart_config uart_config;
    let mut clkdivaddr: u32 = CLKDIVADDR - nxpdev.boot_reg_offset;
    let mut uartdivaddr: u32 = UARTDIVADDR - nxpdev.boot_reg_offset;
    let mut uartmcraddr: u32 = UARTMCRADDR - nxpdev.boot_reg_offset;
    let mut uartreinitaddr: u32 = UARTREINITADDR - nxpdev.boot_reg_offset;
    let mut uarticraddr: u32 = UARTICRADDR - nxpdev.boot_reg_offset;
    let mut uartfcraddr: u32 = UARTFCRADDR - nxpdev.boot_reg_offset;
...
#[no_mangle]
unsafe extern "C" fn nxp_fw_change_timeout(hdev: *mut hci_dev, req_len: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nxp_get_data_len(buf: *const u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nxp_recv_chip_ver_v1(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_recv_fw_req_v1(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
    ...
    if (nxp_request_firmware(hdev, nxp_data.helper_fw_name, core::ptr::null_mut()))
    goto free_skb;
    }
    if (!len) {
...
#[no_mangle]
pub unsafe extern "C" fn if(FW_AUTH_ILLEGAL: (loader_ver & FW_SECURE_MASK) !=) -> else {
...
pub unsafe extern "C" fn if(FW_AUTH_ILLEGAL: (loader_ver & FW_SECURE_MASK) !=) -> else {
    ...
    u8 loader_ver)
    {
    char *fw_name_old = core::ptr::null_mut();
    switch (chipid) {
    case CHIP_ID_W9098:
...
#[no_mangle]
unsafe extern "C" fn nxp_recv_chip_ver_v3(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_handle_fw_download_error(hdev: *mut hci_dev, req: *mut v3_data_req) {
    static void nxp_handle_fw_download_error(struct hci_dev *hdev, struct v3_data_req *req)
    {
    struct btnxpuart_dev *nxpdev = hci_get_drvdata(hdev);
    let mut offset: __u32 = __le32_to_cpu(req.offset);
    let mut err: __u16 = __le16_to_cpu(req.error);
...
#[no_mangle]
unsafe extern "C" fn nxp_recv_fw_req_v3(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_set_baudrate_cmd(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
    static int nxp_set_baudrate_cmd(struct hci_dev *hdev, void *data)
    {
    struct btnxpuart_dev *nxpdev = hci_get_drvdata(hdev);
    let mut new_baudrate: __le32 = __cpu_to_le32(nxpdev.new_baudrate);
    struct ps_data *psdata = &nxpdev.psdata;
    struct sk_buff *skb;
    u8 *status;
    if (!psdata)
...
#[no_mangle]
unsafe extern "C" fn nxp_check_boot_sign(nxpdev: *mut btnxpuart_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_set_ind_reset(hdev: *mut hci_dev, data: *mut c_void) -> c_int {
...
// Firmware dump
#[no_mangle]
unsafe extern "C" fn nxp_coredump(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn nxp_coredump_hdr(hdev: *mut hci_dev, skb: *mut sk_buff) {
    static void nxp_coredump_hdr(struct hci_dev *hdev, struct sk_buff *skb)
    {
// Nothing to be added in FW dump header
    }
#[no_mangle]
unsafe extern "C" fn nxp_process_fw_dump(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
    ...
    nxp_set_ind_reset(hdev, core::ptr::null_mut());
    }
    free_skb:
    kfree_skb(skb);
    return 0;
...
#[no_mangle]
unsafe extern "C" fn nxp_recv_acl_pkt(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
    static int nxp_recv_acl_pkt(struct hci_dev *hdev, struct sk_buff *skb)
    {
    let mut handle: __u16 = __le16_to_cpu(hci_acl_hdr(skb).handle);
...
#[no_mangle]
unsafe extern "C" fn nxp_set_bdaddr(hdev: *mut hci_dev, bdaddr: *const bdaddr_t) -> c_int {
...
// BD address can be assigned only after first reset command.
    err = __hci_cmd_sync_status(hdev, HCI_OP_RESET, 0, core::ptr::null_mut(),
    HCI_INIT_TIMEOUT);
    if (err) {
    bt_dev_err(hdev,
...
// NXP protocol
#[no_mangle]
unsafe extern "C" fn nxp_setup(hdev: *mut hci_dev) -> c_int {
    ...
    char *envp[] = {device_string, event_string, core::ptr::null_mut()};
    let mut err: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn nxp_post_init(hdev: *mut hci_dev) -> c_int {
    ...
    nxpdev.new_baudrate = nxpdev.secondary_baudrate;
    nxp_set_baudrate_cmd(hdev, core::ptr::null_mut());
    }
    if (psdata.cur_h2c_wakeupmode != psdata.h2c_wakeupmode)
    send_wakeup_method_cmd(hdev, core::ptr::null_mut());
    if (psdata.cur_psmode != psdata.target_ps_mode)
    send_ps_cmd(hdev, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn nxp_hw_err(hdev: *mut hci_dev, code: u8) {
...
#[no_mangle]
unsafe extern "C" fn nxp_shutdown(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_wakeup(hdev: *mut hci_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nxp_reset(hdev: *mut hci_dev) {
...
#[no_mangle]
unsafe extern "C" fn btnxpuart_queue_skb(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nxp_enqueue(hdev: *mut hci_dev, skb: *mut sk_buff) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(BT_PS_DISABLE: ps_parm.ps_cmd ==) -> else {
    ...
    hci_cmd_sync_queue(hdev, send_ps_cmd, core::ptr::null_mut(), core::ptr::null_mut());
    goto free_skb;
    }
    break;
    ...
    hci_cmd_sync_queue(hdev, send_wakeup_method_cmd, core::ptr::null_mut(), core::ptr::null_mut());
    goto free_skb;
    }
    break;
    ...
    hci_cmd_sync_queue(hdev, nxp_set_baudrate_cmd, core::ptr::null_mut(), core::ptr::null_mut());
    goto free_skb;
    }
    break;
    case HCI_NXP_IND_RESET:
    if (hdr.plen == 1) {
    hci_cmd_sync_queue(hdev, nxp_set_ind_reset, core::ptr::null_mut(), core::ptr::null_mut());
    goto free_skb;
    }
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn btnxpuart_tx_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn btnxpuart_open(hdev: *mut hci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn btnxpuart_close(hdev: *mut hci_dev) -> c_int {
    ...
    nxpdev.rx_skb = core::ptr::null_mut();
    }
    clear_bit(BTNXPUART_SERDEV_OPEN, &nxpdev.tx_state);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn btnxpuart_flush(hdev: *mut hci_dev) -> c_int {
...
// Flush any pending characters
    ...
    let mut err: c_int = PTR_ERR(nxpdev.rx_skb);
...
#[no_mangle]
unsafe extern "C" fn btnxpuart_write_wakeup(serdev: *mut serdev_device) {
...
#[no_mangle]
unsafe extern "C" fn nxp_coredump_notify(hdev: *mut hci_dev, state: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn nxp_m2_connector_is_available(dev: *mut device) -> bool {
    static bool nxp_m2_connector_is_available(struct device *dev)
    {
    struct device_node *ep __free(device_node) =
    of_graph_get_next_endpoint(dev_of_node(dev), core::ptr::null_mut());
    if (!ep)
    return false;
...
#[no_mangle]
unsafe extern "C" fn nxp_serdev_probe(serdev: *mut serdev_device) -> c_int {
    static int nxp_serdev_probe(struct serdev_device *serdev)
    {
    struct hci_dev *hdev;
    struct btnxpuart_dev *nxpdev;
    let mut ba: bdaddr_t = {0};
    int err;
    ...
    nxpdev.pdn = devm_reset_control_get_optional_shared(&serdev.dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn nxp_serdev_remove(serdev: *mut serdev_device) {
...
#[no_mangle]
unsafe extern "C" fn nxp_serdev_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn nxp_serdev_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn nxp_serdev_coredump(dev: *mut device) {
    ...
    .helper_fw_name = core::ptr::null_mut(),
