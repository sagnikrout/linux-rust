...
//! Source: drivers/bluetooth/hci_serdev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hci_uart_wakeup(hdev: *mut hci_dev) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn hci_uart_write_wakeup(serdev: *mut serdev_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hci_uart_unregister_device(hu: *mut hci_uart) {
