...
//! Source: drivers/hwspinlock/hwspinlock_core.c
#![no_std]
...
pub const HWSPINLOCK_RETRY_DELAY_US: c_int = 100;
// radix tree tags
...
//
#[no_mangle]
pub unsafe extern "C" fn __hwspin_trylock(hwlock: *mut hwspinlock, mode: c_int, flags: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __hwspin_unlock(hwlock: *mut hwspinlock, mode: c_int, flags: *mut c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hwspin_lock_bust(hwlock: *mut hwspinlock, id: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_hwspin_lock_get_id(np: *mut device_node, index: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn of_hwspin_lock_get_id_byname(np: *mut device_node, name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hwspin_lock_register_single(hwlock: *mut hwspinlock, id: c_int) -> c_int {
...
// self-sanity check which should never fail
    ...
    {
    struct hwspinlock *hwlock = core::ptr::null_mut();
    int ret;
    mutex_lock(&hwspinlock_tree_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn hwspin_lock_unregister(bank: *mut hwspinlock_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_hwspin_lock_unreg(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn __hwspin_lock_request(hwlock: *mut hwspinlock) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hwspin_lock_free(hwlock: *mut hwspinlock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_hwspin_lock_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_hwspin_lock_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_hwspin_lock_free(dev: *mut device, hwlock: *mut hwspinlock) -> c_int {
