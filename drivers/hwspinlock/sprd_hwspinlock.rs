...
//! Source: drivers/hwspinlock/sprd_hwspinlock.c
#![no_std]
...
pub const HWSPINLOCK_RECCTRL: c_uint = 0x4;

// unlocked value
pub const HWSPINLOCK_NOTTAKEN: c_uint = 0x55aa10c5;
// bits definition of RECCTRL reg
pub const HWSPINLOCK_USER_BITS: c_uint = 0x1;
// hwspinlock number
pub const SPRD_HWLOCKS_NUM: c_int = 32;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sprd_hwspinlock_dev {
...
#[no_mangle]
unsafe extern "C" fn sprd_hwspinlock_trylock(lock: *mut hwspinlock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sprd_hwspinlock_unlock(lock: *mut hwspinlock) {
...
#[no_mangle]
unsafe extern "C" fn sprd_hwspinlock_relax(lock: *mut hwspinlock) {
...
#[no_mangle]
unsafe extern "C" fn sprd_hwspinlock_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sprd_hwspinlock_probe(pdev: *mut platform_device) -> c_int {
