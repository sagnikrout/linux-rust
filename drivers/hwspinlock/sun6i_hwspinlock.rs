...
//! Source: drivers/hwspinlock/sun6i_hwspinlock.c
#![no_std]
...
pub const SPINLOCK_SYSSTATUS_REG: c_uint = 0x0000;
pub const SPINLOCK_LOCK_REGN: c_uint = 0x0100;
pub const SPINLOCK_NOTTAKEN: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sun6i_hwspinlock_data {
...
#[no_mangle]
unsafe extern "C" fn hwlocks_supported_show(seqf: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun6i_hwspinlock_debugfs_init(priv: *mut sun6i_hwspinlock_data) {
    static void sun6i_hwspinlock_debugfs_init(struct sun6i_hwspinlock_data *priv)
    {
    priv.debugfs = debugfs_create_dir(DRIVER_NAME, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn sun6i_hwspinlock_trylock(lock: *mut hwspinlock) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sun6i_hwspinlock_unlock(lock: *mut hwspinlock) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_hwspinlock_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sun6i_hwspinlock_probe(pdev: *mut platform_device) -> c_int {
...
// failure of debugfs is considered non-fatal
    ...
    priv.debugfs = core::ptr::null_mut();
