...
//! Source: drivers/cpuidle/governors/menu.c
#![no_std]
...
pub const BUCKETS: c_int = 6;
pub const INTERVAL_SHIFT: c_int = 3;

pub const RESOLUTION: c_int = 1024;
pub const DECAY: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct menu_device {
    pub needs_update: c_int,
    pub tick_wakeup: c_int,
    pub next_timer_ns: u64,
    pub bucket: c_uint,
    pub correction_factor: [c_uint; BUCKETS],
    pub intervals: [c_uint; INTERVALS],
    pub interval_ptr: c_int,
}

#[no_mangle]
pub unsafe extern "C" fn which_bucket(duration_ns: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn menu_update_intervals(data: *mut menu_device, interval_us: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn get_typical_interval(data: *mut menu_device) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn menu_reflect(dev: *mut cpuidle_device, index: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn menu_update(drv: *mut cpuidle_driver, dev: *mut cpuidle_device) {
    static void menu_update(struct cpuidle_driver *drv, struct cpuidle_device *dev)
    {
    struct menu_device *data = this_cpu_ptr(&menu_devices);
...
//
#[no_mangle]
unsafe extern "C" fn init_menu() -> int __init {
