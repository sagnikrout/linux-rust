...
//! Source: drivers/cpuidle/cpuidle-qcom-spm.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn qcom_pm_collapse(unused: unsigned long int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_cpu_spc(drv: *mut spm_driver_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn spm_cpuidle_register(cpuidle_dev: *mut device, cpu: c_int) -> c_int {
    ...
    if (ret <= 0)
    return ret ? : -ENODEV;
    return cpuidle_register(&data.cpuidle_driver, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn spm_cpuidle_drv_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_spm_find_any_cpu() -> bool __init {
...
#[no_mangle]
unsafe extern "C" fn qcom_spm_cpuidle_init() -> int __init {
