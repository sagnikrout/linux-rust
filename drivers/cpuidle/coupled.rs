...
//! Source: drivers/cpuidle/coupled.c
#![no_std]
...
pub struct cpuidle_coupled {
    ...
    pub ready_waiting_counts: core::sync::atomic::AtomicI32,
    pub abort_barrier: core::sync::atomic::AtomicI32,
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_parallel_barrier(dev: *mut cpuidle_device, a: *mut core::sync::atomic::AtomicI32) {
    void cpuidle_coupled_parallel_barrier(struct cpuidle_device *dev, atomic_t *a)
    {
    let mut n: c_int = dev.coupled.online_count;
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_state_is_coupled(drv: *mut cpuidle_driver, state: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_state_verify(drv: *mut cpuidle_driver) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_set_ready(coupled: *mut cpuidle_coupled) {
...
//
    static
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_set_not_ready(coupled: *mut cpuidle_coupled) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_no_cpus_ready(coupled: *mut cpuidle_coupled) -> c_int {
    static inline int cpuidle_coupled_no_cpus_ready(struct cpuidle_coupled *coupled)
    {
    let mut r: c_int = atomic_read(&coupled.ready_waiting_counts) >> WAITING_BITS;
    let mut r: return = = 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_cpus_ready(coupled: *mut cpuidle_coupled) -> bool {
    static inline bool cpuidle_coupled_cpus_ready(struct cpuidle_coupled *coupled)
    {
    let mut r: c_int = atomic_read(&coupled.ready_waiting_counts) >> WAITING_BITS;
    let mut r: return = = coupled.online_count;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_cpus_waiting(coupled: *mut cpuidle_coupled) -> bool {
    static inline bool cpuidle_coupled_cpus_waiting(struct cpuidle_coupled *coupled)
    {
    let mut w: c_int = atomic_read(&coupled.ready_waiting_counts) & WAITING_MASK;
    let mut w: return = = coupled.online_count;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_no_cpus_waiting(coupled: *mut cpuidle_coupled) -> c_int {
...
unsafe extern "C" fn cpuidle_coupled_handle_poke(info: *mut c_void) {
    ...
    {
    let mut cpu: c_int = (unsigned long)info;
...
//
#[no_mangle]
unsafe extern "C" fn cpuidle_coupled_poke(cpu: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn cpuidle_coupled_set_done(cpu: c_int, coupled: *mut cpuidle_coupled) {
...
//
#[no_mangle]
unsafe extern "C" fn cpuidle_coupled_clear_pokes(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpuidle_coupled_any_pokes_pending(coupled: *mut cpuidle_coupled) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cpuidle_coupled_update_online_cpus(coupled: *mut cpuidle_coupled) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_register_device(dev: *mut cpuidle_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpuidle_coupled_unregister_device(dev: *mut cpuidle_device) {
...
//
#[no_mangle]
unsafe extern "C" fn cpuidle_coupled_prevent_idle(coupled: *mut cpuidle_coupled) {
...
//
#[no_mangle]
unsafe extern "C" fn cpuidle_coupled_allow_idle(coupled: *mut cpuidle_coupled) {
...
#[no_mangle]
unsafe extern "C" fn coupled_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn coupled_cpu_up_prepare(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpuidle_coupled_init() -> int __init {
