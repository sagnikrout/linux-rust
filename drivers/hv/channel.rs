...
//
#[no_mangle]
pub unsafe extern "C" fn hv_gpadl_size(type: enum hv_gpadl_type, size: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_ring_gpadl_send_hvpgoffset(offset: u32) -> u32 {
...
//
    ...
    {
    let mut send_idx: c_int = hv_ring_gpadl_send_hvpgoffset(send_offset);
    let mut delta: c_ulong = 0UL;
    switch (type) {
    case HV_GPADL_BUFFER:
    case HV_GPADL_BUFFER_DECRYPTED:
    break;
    ...
    delta = 0;
#[no_mangle]
pub unsafe extern "C" fn if(send_idx: i <=) -> else {
    else if (i <= send_idx)
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_setevent(channel: *mut vmbus_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_free_ring(channel: *mut vmbus_channel) {
...
// In a CoCo VM leak the memory if it didn't get re-encrypted
    ...
    << PAGE_SHIFT));
    channel.ringbuffer_page = core::ptr::null_mut();
    }
    }
...
#[no_mangle]
unsafe extern "C" fn send_modifychannel_without_ack(channel: *mut vmbus_channel, target_vp: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn send_modifychannel_with_ack(channel: *mut vmbus_channel, target_vp: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_send_modifychannel(channel: *mut vmbus_channel, target_vp: u32) -> c_int {
...
//
    ...
    struct vmbus_channel_msginfo *msgbody = core::ptr::null_mut();
    u32 msgsize;
...
//
    ...
    if (!msgbody) {
    struct vmbus_channel_msginfo *pos = core::ptr::null_mut();
    struct vmbus_channel_msginfo *tmp = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn vmbus_free_channel_msginfo(msginfo: *mut vmbus_channel_msginfo) {
...
//
    ...
    struct vmbus_channel_gpadl_body *gpadl_body;
    struct vmbus_channel_msginfo *msginfo = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_free_buffer(addr: *mut c_void, chunks: *mut page, chunk_cnt: u32) {
    ...
    let mut order: c_uint = folio_order(page_folio(chunks[i]));
...
//
    ...
    u32 *chunk_cnt_out)
    {
    let mut nr_pages: c_ulong = PFN_UP(size);
    let mut remaining: c_ulong = nr_pages;
    let mut page_idx: c_ulong = 0;
    struct page **chunks = core::ptr::null_mut();
    struct page **pages = core::ptr::null_mut();
    let mut order: c_int = MAX_PAGE_ORDER;
    let mut chunk_cnt: u32 = 0;
    void *addr;
    u32 i;
    int ret;
// chunks_out = NULL;
...
// chunk_cnt_out = chunk_cnt;
    ...
    err:
    kvfree(pages);
    vmbus_free_buffer(core::ptr::null_mut(), chunks, chunk_cnt);
    return core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_alloc_requestor(rqstor: *mut vmbus_requestor, size: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_free_requestor(rqstor: *mut vmbus_requestor) {
    ...
    struct vmbus_channel_msginfo *open_info = core::ptr::null_mut();
...
//
    ...
    void (*onchannelcallback)(void *context), void *context)
    {
    return  __vmbus_open(newchannel, core::ptr::null_mut(), 0, onchannelcallback, context);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_teardown_gpadl(channel: *mut vmbus_channel, gpadl: *mut vmbus_gpadl) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_reset_channel_cb(channel: *mut vmbus_channel) {
...
// See the inline comments in vmbus_chan_sched().
    ...
    channel.onchannel_callback = core::ptr::null_mut();
    spin_unlock_irqrestore(&channel.sched_lock, flags);
    channel.sc_creation_callback = core::ptr::null_mut();
// Re-enable tasklet for use on re-open
    tasklet_enable(&channel.callback_event);
    }
#[no_mangle]
unsafe extern "C" fn vmbus_close_internal(channel: *mut vmbus_channel) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: channel->ringbuffer_gpadlhandle.gpadl_handle) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_disconnect_ring(channel: *mut vmbus_channel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_close(channel: *mut vmbus_channel) {
...
//
    ...
    let mut packetlen: u32 = sizeof(struct vmpacket_descriptor) + bufferlen;
    let mut packetlen_aligned: u32 = ALIGN(packetlen, sizeof(u64));
    struct kvec bufferlist[3];
    let mut aligned_data: u64 = 0;
    let mut num_vecs: c_int = ((bufferlen != 0) ? 3 : 1);
...
//
    ...
    requestid, core::ptr::null_mut(), type, flags);
    }
...
// Setup the descriptor
    ...
    bufferlist[2].iov_base = &aligned_data;
    bufferlist[2].iov_len = (packetlen_aligned - packetlen);
    return hv_ringbuffer_write(channel, bufferlist, 3, requestid, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_next_request_id(channel: *mut vmbus_channel, rqst_addr: u64) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_request_addr(channel: *mut vmbus_channel, trans_id: u64) -> u64 {
