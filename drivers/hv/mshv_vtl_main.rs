...
//! Source: drivers/hv/mshv_vtl_main.c
#![no_std]
...
pub const MSHV_ENTRY_REASON_LOWER_VTL_CALL: c_uint = 0x1;
pub const MSHV_ENTRY_REASON_INTERRUPT: c_uint = 0x2;
pub const MSHV_ENTRY_REASON_INTERCEPT: c_uint = 0x3;
pub const MSHV_REAL_OFF_SHIFT: c_int = 16;

pub const MSHV_RUN_PAGE_OFFSET: c_int = 0;
pub const MSHV_REG_PAGE_OFFSET: c_int = 1;
pub const VTL2_VMBUS_SINT_INDEX: c_int = 7;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mshv_vtl_hvcall_fd {
    pub allow_bitmap: [u8; MAX_BITMAP_SIZE],
    pub allow_map_initialized: bool,
//
// Used to protect hvcall setup in IOCTLs
//
    pub init_mutex: mutex,
    pub dev: *mut miscdevice,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mshv_vtl_poll_file {
    pub file: *mut file,
...
#[derive(Copy, Clone)]
pub struct mshv_vtl {
    pub module_dev: *mut device,
    pub id: u64,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mshv_vtl_per_cpu {
    pub run: *mut mshv_vtl_run,
    pub reg_page: *mut page,
}
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_configure_reg_page(per_cpu: *mut mshv_vtl_per_cpu) {
    static void mshv_vtl_configure_reg_page(struct mshv_vtl_per_cpu *per_cpu)
    {
    let mut reg_assoc: hv_register_assoc = {};
    let mut overlay: union hv_synic_overlay_page_msr = {};
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_synic_enable_regs(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_get_vsm_regs() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_configure_vsm_partition(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_vmbus_isr() {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_alloc_context(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_vtl_setup_synic() -> c_int {
...
// Use our isr to first filter out packets destined for userspace
    ...
    mshv_vtl_alloc_context, core::ptr::null_mut());
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn hv_vtl_remove_synic() {
...
#[no_mangle]
unsafe extern "C" fn vtl_get_vp_register(reg: *mut hv_register_assoc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vtl_set_vp_register(reg: *mut hv_register_assoc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_ioctl_add_vtl0_mem(vtl: *mut mshv_vtl, arg: *mut void __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_cancel(cpu: c_int) {
    static void mshv_vtl_cancel(int cpu)
    {
    let mut here: c_int = get_cpu();
    if (here != cpu) {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_poll_file_wake(wait: *mut wait_queue_entry_t, mode: c_uint, sync: c_int, key: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_ptable_queue_proc(file: *mut file, wqh: *mut wait_queue_head_t, pt: *mut poll_table) {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_ioctl_set_poll_file(user_input: *mut mshv_vtl_set_poll_file __user) -> c_int {
...
//
    ...
    poll_file.wqh = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_get_set_reg(regs: *mut hv_register_assoc, set: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_return(vtl0: *mut mshv_vtl_cpu_context) {
...
//
    ...
    let mut offset: u32 = READ_ONCE(mshv_vtl_this_run().vtl_ret_action_size);
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_process_intercept() -> bool {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_ioctl_return_to_lower_vtl() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_fault(vmf: *mut vm_fault) -> vm_fault_t {
    static vm_fault_t mshv_vtl_fault(struct vm_fault *vmf)
    {
    struct page *page;
    let mut cpu: c_int = vmf.pgoff & MSHV_PG_OFF_CPU_MASK;
    let mut real_off: c_int = vmf.pgoff >> MSHV_REAL_OFF_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_synic_mask_vmbus_sint(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_read_remote(buffer: *mut c_void) {
    ...
    VTL2_VMBUS_SINT_INDEX;
    let mut message_type: u32 = READ_ONCE(msg.header.message_type);
    ...
    let mut vtl_synic_mask_vmbus_sint_masked: static bool = true;
#[no_mangle]
unsafe extern "C" fn mshv_vtl_sint_read(filp: *mut file, arg: *mut char __user, size: usize, offset: *mut loff_t) -> isize {
    static ssize_t mshv_vtl_sint_read(struct file *filp, char __user *arg, size_t size, loff_t *offset)
    {
    let mut msg: hv_message = {};
    int ret;
    if (size < sizeof(msg))
    return -EINVAL;
    for (;;) {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_sint_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_sint_on_msg_dpc(data: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_sint_ioctl_post_msg(arg: *mut mshv_vtl_sint_post_msg __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_sint_ioctl_signal_event(arg: *mut mshv_vtl_signal_event __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_sint_ioctl_set_eventfd(arg: *mut mshv_vtl_set_eventfd __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_sint_ioctl_pause_msg_stream(arg: *mut mshv_sint_mask __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_sint_ioctl(f: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_hvcall_dev_open(node: *mut inode, f: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_hvcall_dev_release(node: *mut inode, f: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_hvcall_is_allowed(fd: *mut mshv_vtl_hvcall_fd, call_code: u16) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_hvcall_dev_ioctl(f: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_low_open(inodep: *mut inode, filp: *mut file) -> c_int {
    static int mshv_vtl_low_open(struct inode *inodep, struct file *filp)
    {
    let mut pid: pid_t = task_pid_vnr(current);
    let mut uid: uid_t = current_uid().val;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn can_fault(vmf: *mut vm_fault, size: c_ulong, pfn: *mut c_ulong) -> bool {
    static bool can_fault(struct vm_fault *vmf, unsigned long size, unsigned long *pfn)
    {
    let mut mask: c_ulong = size - 1;
    let mut start: c_ulong = vmf.address & ~mask;
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_low_huge_fault(vmf: *mut vm_fault, order: c_uint) -> vm_fault_t {
    static vm_fault_t mshv_vtl_low_huge_fault(struct vm_fault *vmf, unsigned int order)
    {
    let mut pfn: c_ulong = vmf.pgoff;
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_low_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_low_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mshv_vtl_exit() -> void __exit {
