...
//
#[no_mangle]
pub unsafe extern "C" fn hv_init() -> c_int {
    int hv_init(void)
    {
...
pub unsafe extern "C" fn if(_arg: hv_isolation_type_snp()) -> else {
    ...
    aligned_msg, core::ptr::null_mut(),
    sizeof(*aligned_msg));
    else
    status = HV_STATUS_INVALID_PARAMETER;
    } else {
    let mut control: u64 = HVCALL_POST_MESSAGE;
...
//
    status = hv_do_hypercall(control, aligned_msg, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn hv_alloc_page(page: *mut c_void, decrypt: bool, note: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_free_page(page: *mut c_void, encrypt: bool, note: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hv_synic_alloc() -> c_int {
    int hv_synic_alloc(void)
    {
    int cpu, ret = -ENOMEM;
    struct hv_per_cpu_context *hv_cpu;
    let mut decrypt: bool = !vmbus_is_confidential();
//
...
#[no_mangle]
pub unsafe extern "C" fn hv_synic_free() {
    void hv_synic_free(void)
    {
    int cpu;
    let mut encrypt: bool = !vmbus_is_confidential();
    for_each_present_cpu(cpu) {
    struct hv_per_cpu_context *hv_cpu =
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_hyp_synic_enable_regs(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn hv_hyp_synic_enable_interrupts() {
...
#[no_mangle]
unsafe extern "C" fn hv_para_synic_enable_regs(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn hv_para_synic_enable_interrupts() {
...
#[no_mangle]
pub unsafe extern "C" fn hv_synic_init(cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hv_hyp_synic_disable_regs(cpu: c_uint) {
...
//
    ...
    hv_cpu.hyp_synic_message_page = core::ptr::null_mut();
    }
    } else {
    ...
    hv_cpu.hyp_synic_event_page = core::ptr::null_mut();
    }
    } else {
...
#[no_mangle]
unsafe extern "C" fn hv_hyp_synic_disable_interrupts() {
...
#[no_mangle]
unsafe extern "C" fn hv_para_synic_disable_regs(cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn hv_para_synic_disable_interrupts() {
...
pub const HV_MAX_TRIES: c_int = 3;
//
...
//
#[no_mangle]
unsafe extern "C" fn __hv_synic_event_pending(event: *mut union hv_synic_event_flags, sint: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hv_synic_event_pending() -> bool {
...
#[no_mangle]
unsafe extern "C" fn hv_pick_new_cpu(channel: *mut vmbus_channel) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_synic_cleanup(cpu: c_uint) -> c_int {
