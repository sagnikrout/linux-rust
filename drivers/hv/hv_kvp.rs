...
//
pub const WS2008_SRV_MAJOR: c_int = 1;
pub const WS2008_SRV_MINOR: c_int = 0;

pub const WIN7_SRV_MAJOR: c_int = 3;
pub const WIN7_SRV_MINOR: c_int = 0;

pub const WIN8_SRV_MAJOR: c_int = 4;
pub const WIN8_SRV_MINOR: c_int = 0;

pub const KVP_VER_COUNT: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn kvp_poll_wrapper(channel: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn kvp_register_done() {
...
#[no_mangle]
unsafe extern "C" fn kvp_timeout_func(dummy: *mut work_struct) {
    static void kvp_timeout_func(struct work_struct *dummy)
    {
//
...
//
    kvp_respond_to_host(core::ptr::null_mut(), HV_E_FAIL);
    hv_poll_channel(kvp_transaction.recv_channel, kvp_poll_wrapper);
    }
#[no_mangle]
unsafe extern "C" fn kvp_host_handshake_func(dummy: *mut work_struct) {
    static void kvp_host_handshake_func(struct work_struct *dummy)
    {
    tasklet_schedule(&kvp_transaction.recv_channel.callback_event);
    }
#[no_mangle]
unsafe extern "C" fn kvp_handle_handshake(msg: *mut hv_kvp_msg) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn kvp_on_msg(msg: *mut c_void, len: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_ob_ipinfo(in_msg: *mut c_void, out_msg: *mut c_void, op: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn process_ib_ipinfo(in_msg: *mut c_void, out_msg: *mut c_void, op: c_int) {
...
//
    ...
    let mut operation: __u8 = kvp_transaction.kvp_msg.kvp_hdr.operation;
    let mut pool: __u8 = kvp_transaction.kvp_msg.kvp_hdr.pool;
    __u32 val32;
    __u64 val64;
    int rc;
...
//
    ...
    rc = hvutil_transport_send(hvt, message, sizeof(*message), core::ptr::null_mut());
    if (rc) {
...
//
    ...
    if (channel.onchannel_callback == core::ptr::null_mut())
//
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_kvp_onchannelcallback(context: *mut c_void) {
...
// Ensure recvlen is big enough to read header data
    ...
    core::ptr::null_mut(), &kvp_srv_version)) {
...
#[no_mangle]
unsafe extern "C" fn kvp_on_reset() {
...
#[no_mangle]
unsafe extern "C" fn hv_kvp_cancel_work() {
...
#[no_mangle]
pub unsafe extern "C" fn hv_kvp_pre_suspend() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hv_kvp_pre_resume() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hv_kvp_deinit() {
