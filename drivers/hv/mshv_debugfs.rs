...
//! Source: drivers/hv/mshv_debugfs.c
#![no_std]
...
// Macro flag: #define MSHV_DEBUGFS_C

pub const U32_BUF_SZ: c_int = 11;
pub const U64_BUF_SZ: c_int = 21;
// Only support SELF and PARENT areas
pub const NUM_STATS_AREAS: c_int = 2;
...
pub const HV_HYPERVISOR_COUNTER_LOGICAL_PROCESSORS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn lp_stats_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_lp_stats_unmap(lp_index: u32) {
    ...
    mshv_lps_stats[lp_index] = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mshv_lp_stats_map(lp_index: u32) -> *mut hv_stats_page  __init {
...
#[no_mangle]
unsafe extern "C" fn lp_debugfs_create(lp_index: u32, parent: *mut dentry) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mshv_debugfs_lp_remove() {
    ...
    mshv_lps_stats = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mshv_debugfs_lp_create(parent: *mut dentry) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vp_stats_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vp_debugfs_remove(vp_stats: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn partition_stats_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn partition_debugfs_remove(partition_id: u64, dentry: *mut dentry) {
    static void partition_debugfs_remove(u64 partition_id, struct dentry *dentry)
    {
    struct hv_stats_page **pstats = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mshv_debugfs_parent_partition_remove() {
    ...
    parent_vp_stats = core::ptr::null_mut();
    parent_partition_stats = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mshv_debugfs_parent_partition_create() -> int __init {
    ...
    mshv_debugfs_partition = core::ptr::null_mut();
    return err;
    }
#[no_mangle]
unsafe extern "C" fn hv_stats_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_hv_stats_unmap() {
    ...
    int err;
    err = hv_unmap_stats_page(HV_STATS_OBJECT_HYPERVISOR, core::ptr::null_mut(), &identity);
    if (err)
    pr_err("%s: failed to unmap hypervisor stats: %d\n",
    __func__, err);
    }
#[no_mangle]
unsafe extern "C" fn mshv_hv_stats_map() -> *mut void  __init {
...
#[no_mangle]
unsafe extern "C" fn mshv_debugfs_hv_stats_create(parent: *mut dentry) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_debugfs_vp_create(vp: *mut mshv_vp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_debugfs_vp_remove(vp: *mut mshv_vp) {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_debugfs_partition_create(partition: *mut mshv_partition) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_debugfs_partition_remove(partition: *mut mshv_partition) {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_debugfs_init() -> int __init {
    int __init mshv_debugfs_init(void)
    {
    int err;
    mshv_debugfs = debugfs_create_dir("mshv", core::ptr::null_mut());
    if (IS_ERR(mshv_debugfs)) {
    err = PTR_ERR(mshv_debugfs);
    mshv_debugfs = core::ptr::null_mut();
    ...
    mshv_debugfs_lp = core::ptr::null_mut();
    }
    unmap_hv_stats:
    if (hv_root_partition())
    mshv_hv_stats_unmap();
...
#[no_mangle]
pub unsafe extern "C" fn mshv_debugfs_exit() {
