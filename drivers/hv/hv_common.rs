...
//
    ...
    let mut hv_current_partition_id: u64 = HV_PARTITION_ID_SELF;
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_common_free() -> void __init {
    void __init hv_common_free(void)
    {
    unregister_sysctl_table(hv_ctl_table_hdr);
    hv_ctl_table_hdr = core::ptr::null_mut();
    if (ms_hyperv.misc_features & HV_FEATURE_GUEST_CRASH_MSR_AVAILABLE)
    hv_kmsg_dump_unregister();
    kfree(hv_vp_index);
    hv_vp_index = core::ptr::null_mut();
    free_percpu(hyperv_pcpu_output_arg);
    hyperv_pcpu_output_arg = core::ptr::null_mut();
    free_percpu(hyperv_pcpu_input_arg);
    hyperv_pcpu_input_arg = core::ptr::null_mut();
    free_percpu(hv_synic_eventring_tail);
    hv_synic_eventring_tail = core::ptr::null_mut();
    }
...
//
    let mut sysctl_record_panic_msg: static int = 1;
//
...
#[no_mangle]
unsafe extern "C" fn hv_kmsg_dump_unregister() {
    static void hv_kmsg_dump_unregister(void)
    {
    ...
    kfree(hv_panic_page);
    hv_panic_page = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn hv_kmsg_dump_register() {
...
#[no_mangle]
pub unsafe extern "C" fn hv_output_page_exists() -> bool {
    static inline bool hv_output_page_exists(void)
    {
    return hv_parent_partition() || IS_ENABLED(CONFIG_HYPERV_VTL_MODE);
    }
#[no_mangle]
pub unsafe extern "C" fn hv_get_partition_id() -> void __init {
    ...
    status = hv_do_hypercall(HVCALL_GET_PARTITION_ID, core::ptr::null_mut(), output);
...
#[no_mangle]
pub unsafe extern "C" fn get_vtl() -> u8 __init {
    u8 __init get_vtl(void)
    {
    let mut control: u64 = HV_HYPERCALL_REP_COMP_1 | HVCALL_GET_VP_REGISTERS;
...
#[no_mangle]
pub unsafe extern "C" fn hv_common_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ms_hyperv_late_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_common_cpu_init(cpu: c_uint) -> c_int {
    ...
    u64 msr_vp_index;
    gfp_t flags;
    let mut pgcount: c_int = hv_output_page_exists() ? 2 : 1;
    void *mem;
    let mut ret: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn hv_common_cpu_die(cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hv_query_ext_cap(cap_query: u64) -> bool {
...
// Extended capabilities do not change at runtime.
    ...
    status = hv_do_hypercall(HV_EXT_CALL_QUERY_CAPABILITIES, core::ptr::null_mut(),
    &hv_extended_cap);
//
...
#[no_mangle]
pub unsafe extern "C" fn hv_setup_dma_ops(dev: *mut device, coherent: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_is_hibernation_supported() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn __hv_read_ref_counter() -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_is_isolation_supported() -> bool __weak {
...
#[no_mangle]
pub unsafe extern "C" fn hv_isolation_type_snp() -> bool __weak {
...
#[no_mangle]
pub unsafe extern "C" fn hv_isolation_type_tdx() -> bool __weak {
...
#[no_mangle]
pub unsafe extern "C" fn hv_setup_vmbus_handler((*handler)(void): *mut c_void) -> void __weak {
    void __weak hv_setup_vmbus_handler(void (*handler)(void))
    {
    }
    EXPORT_SYMBOL_GPL(hv_setup_vmbus_handler);
#[no_mangle]
pub unsafe extern "C" fn hv_remove_vmbus_handler() -> void __weak {
    void __weak hv_remove_vmbus_handler(void)
    {
    }
    EXPORT_SYMBOL_GPL(hv_remove_vmbus_handler);
#[no_mangle]
pub unsafe extern "C" fn hv_setup_mshv_handler((*handler)(void): *mut c_void) -> void __weak {
    void __weak hv_setup_mshv_handler(void (*handler)(void))
    {
    }
    EXPORT_SYMBOL_GPL(hv_setup_mshv_handler);
#[no_mangle]
pub unsafe extern "C" fn hv_setup_kexec_handler((*handler)(void): *mut c_void) -> void __weak {
    void __weak hv_setup_kexec_handler(void (*handler)(void))
    {
    }
    EXPORT_SYMBOL_GPL(hv_setup_kexec_handler);
#[no_mangle]
pub unsafe extern "C" fn hv_remove_kexec_handler() -> void __weak {
    void __weak hv_remove_kexec_handler(void)
    {
    }
    EXPORT_SYMBOL_GPL(hv_remove_kexec_handler);
#[no_mangle]
pub unsafe extern "C" fn hv_setup_crash_handler(regs): *mut *mut void (handler)(struct pt_regs) -> void __weak {
    void __weak hv_setup_crash_handler(void (*handler)(struct pt_regs *regs))
    {
    }
    EXPORT_SYMBOL_GPL(hv_setup_crash_handler);
#[no_mangle]
pub unsafe extern "C" fn hv_remove_crash_handler() -> void __weak {
    void __weak hv_remove_crash_handler(void)
    {
    }
    EXPORT_SYMBOL_GPL(hv_remove_crash_handler);
#[no_mangle]
pub unsafe extern "C" fn hyperv_cleanup() -> void __weak {
    void __weak hyperv_cleanup(void)
    {
    }
    EXPORT_SYMBOL_GPL(hyperv_cleanup);
#[no_mangle]
pub unsafe extern "C" fn hv_ghcb_hypercall(control: u64, input: *mut c_void, output: *mut c_void, input_size: u32) -> u64 __weak {
...
#[no_mangle]
pub unsafe extern "C" fn hv_tdx_hypercall(control: u64, param1: u64, param2: u64) -> u64 __weak {
...
#[no_mangle]
pub unsafe extern "C" fn hv_enable_coco_interrupt(cpu: c_uint, vector: c_uint, set: bool) -> void __weak {
...
#[no_mangle]
pub unsafe extern "C" fn hv_para_set_sint_proxy(enable: bool) -> void __weak {
    void __weak hv_para_set_sint_proxy(bool enable)
    {
    }
    EXPORT_SYMBOL_GPL(hv_para_set_sint_proxy);
#[no_mangle]
pub unsafe extern "C" fn hv_para_get_synic_register(reg: c_uint) -> u64 __weak {
...
#[no_mangle]
pub unsafe extern "C" fn hv_para_set_synic_register(reg: c_uint, val: u64) -> void __weak {
    void __weak hv_para_set_synic_register(unsigned int reg, u64 val)
    {
    }
    EXPORT_SYMBOL_GPL(hv_para_set_synic_register);
#[no_mangle]
pub unsafe extern "C" fn hv_identify_partition_type() {
...
//
    ...
    {
    int i;
    let mut code: u16 = hv_result(hv_status);
...
#[no_mangle]
pub unsafe extern "C" fn hv_result_to_errno(status: u64) -> c_int {
