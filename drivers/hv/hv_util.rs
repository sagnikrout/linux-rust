...
pub const SD_MAJOR: c_int = 3;
pub const SD_MINOR: c_int = 0;
pub const SD_MINOR_1: c_int = 1;
pub const SD_MINOR_2: c_int = 2;

pub const SD_MAJOR_1: c_int = 1;

pub const TS_MAJOR: c_int = 4;
pub const TS_MINOR: c_int = 0;

pub const TS_MAJOR_1: c_int = 1;

pub const TS_MAJOR_3: c_int = 3;

pub const HB_MAJOR: c_int = 3;
pub const HB_MINOR: c_int = 0;

pub const HB_MAJOR_1: c_int = 1;

    static int sd_srv_version;
    static int ts_srv_version;
    static int hb_srv_version;
pub const SD_VER_COUNT: c_int = 4;
...
pub const TS_VER_COUNT: c_int = 3;
    static const int ts_versions[] = {
    TS_VERSION,
    TS_VERSION_3,
    TS_VERSION_1
    };
pub const HB_VER_COUNT: c_int = 2;
    static const int hb_versions[] = {
    HB_VERSION,
    HB_VERSION_1
    };
pub const FW_VER_COUNT: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hibernate_work_context {
...
#[no_mangle]
unsafe extern "C" fn send_hibernate_uevent(work: *mut work_struct) {
    static void send_hibernate_uevent(struct work_struct *work)
    {
    char *uevent_env[2] = { "EVENT=hibernate", core::ptr::null_mut() };
...
#[no_mangle]
unsafe extern "C" fn hv_shutdown_init(srv: *mut hv_util_service) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn perform_shutdown(dummy: *mut work_struct) {
    static void perform_shutdown(struct work_struct *dummy)
    {
    orderly_poweroff(true);
    }
#[no_mangle]
unsafe extern "C" fn perform_restart(dummy: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn shutdown_onchannelcallback(context: *mut c_void) {
    static void shutdown_onchannelcallback(void *context)
    {
    struct vmbus_channel *channel = context;
    struct work_struct *work = core::ptr::null_mut();
    u32 recvlen;
    u64 requestid;
...
// Ensure recvlen is big enough to read header data
    ...
    core::ptr::null_mut(), &sd_srv_version)) {
...
#[no_mangle]
pub unsafe extern "C" fn reftime_to_ns(reftime: u64) -> u64 {
...
//
    let mut HOST_TIMESYNC_DELAY_THRESH: static u64 = 600 * (u64)NSEC_PER_SEC;
#[no_mangle]
unsafe extern "C" fn hv_get_adj_host_time(ts: *mut timespec64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_set_host_time(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_implicit_sync(host_time: u64) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn adj_guesttime(hosttime: u64, reftime: u64, adj_flags: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn timesync_onchannelcallback(context: *mut c_void) {
    static void timesync_onchannelcallback(void *context)
    {
    struct vmbus_channel *channel = context;
    u32 recvlen;
...
// Ensure recvlen is big enough to read header data
    ...
    core::ptr::null_mut(), &ts_srv_version)) {
...
//
#[no_mangle]
unsafe extern "C" fn heartbeat_onchannelcallback(context: *mut c_void) {
    static void heartbeat_onchannelcallback(void *context)
    {
    struct vmbus_channel *channel = context;
    u32 recvlen;
...
// Ensure recvlen is big enough to read header data
    ...
    core::ptr::null_mut(), &hb_srv_version)) {
...
//
    ...
    HV_UTIL_RING_RECV_SIZE, core::ptr::null_mut(), 0, srv.util_cb,
    dev.channel);
    if (ret)
    goto error;
...
#[no_mangle]
unsafe extern "C" fn util_remove(dev: *mut hv_device) {
...
//
#[no_mangle]
unsafe extern "C" fn util_suspend(dev: *mut hv_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn util_resume(dev: *mut hv_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_ptp_settime(p: *mut ptp_clock_info, ts: *const timespec64) -> c_int {
    static int hv_ptp_settime(struct ptp_clock_info *p, const struct timespec64 *ts)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn hv_ptp_adjfine(ptp: *mut ptp_clock_info, delta: c_long) -> c_int {
    static int hv_ptp_adjfine(struct ptp_clock_info *ptp, long delta)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn hv_ptp_adjtime(ptp: *mut ptp_clock_info, delta: i64) -> c_int {
    static int hv_ptp_adjtime(struct ptp_clock_info *ptp, s64 delta)
    {
    return -EOPNOTSUPP;
    }
#[no_mangle]
unsafe extern "C" fn hv_ptp_gettime(info: *mut ptp_clock_info, ts: *mut timespec64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_timesync_init(srv: *mut hv_util_service) -> c_int {
    static int hv_timesync_init(struct hv_util_service *srv)
    {
...
//
    hv_ptp_clock = ptp_clock_register(&ptp_hyperv_info, core::ptr::null_mut());
    if (IS_ERR_OR_NULL(hv_ptp_clock)) {
    pr_err("cannot register PTP clock: %d\n",
    PTR_ERR_OR_ZERO(hv_ptp_clock));
    hv_ptp_clock = core::ptr::null_mut();
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn hv_timesync_cancel_work() {
    static void hv_timesync_cancel_work(void)
    {
    cancel_work_sync(&adj_time_work);
    }
#[no_mangle]
unsafe extern "C" fn hv_timesync_pre_suspend() -> c_int {
    static int hv_timesync_pre_suspend(void)
    {
...
#[no_mangle]
unsafe extern "C" fn hv_timesync_deinit() {
    static void hv_timesync_deinit(void)
    {
    if (hv_ptp_clock)
...
#[no_mangle]
unsafe extern "C" fn init_hyperv_utils() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn exit_hyperv_utils() {
