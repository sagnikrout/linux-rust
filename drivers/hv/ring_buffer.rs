...
//! Source: drivers/hv/ring_buffer.c
#![no_std]
...
pub const VMBUS_PKT_TRAILER: c_int = 8;
//
...
//
#[no_mangle]
unsafe extern "C" fn hv_signal_on_write(old_write: u32, channel: *mut vmbus_channel) {
...
// Get the next write location for the specified ring buffer.
    ...
    {
    let mut next: u32 = ring_info.ring_buffer.write_index;
    return next;
    }
...
//
    ...
    let mut ring_buffer_size: u32 = hv_get_ring_buffersize(ring_info);
...
#[no_mangle]
pub unsafe extern "C" fn hv_ringbuffer_pre_init(channel: *mut vmbus_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_ringbuffer_cleanup(ring_info: *mut hv_ring_buffer_info) {
    void hv_ringbuffer_cleanup(struct hv_ring_buffer_info *ring_info)
    {
    mutex_lock(&ring_info.ring_buffer_mutex);
    vunmap(ring_info.ring_buffer);
    ring_info.ring_buffer = core::ptr::null_mut();
    mutex_unlock(&ring_info.ring_buffer_mutex);
    kfree(ring_info.pkt_buffer);
    ring_info.pkt_buffer = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_ringbuffer_spinlock_busy(channel: *mut vmbus_channel) -> bool {
...
// Write to the ring buffer.
    ...
    int i;
    u32 bytes_avail_towrite;
    let mut totalbytes_towrite: u32 = sizeof(u64);
    u32 next_write_location;
    u32 old_write;
    u64 prev_indices;
    unsigned long flags;
...
//
    ...
    if (channel.next_request_id_callback != core::ptr::null_mut()) {
...
// Reclaim request ID to avoid leak of IDs
    if (channel.request_addr_callback != core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn hv_pkt_iter_avail(rbi: *const hv_ring_buffer_info) -> u32 {
    static u32 hv_pkt_iter_avail(const struct hv_ring_buffer_info *rbi)
    {
    let mut priv_read_loc: u32 = rbi.priv_read_index;
    u32 write_loc;
//
...
//
    ...
    {
    struct hv_ring_buffer_info *rbi = &channel.inbound;
    let mut packetlen: u32 = desc.len8 << 3;
    let mut dsize: u32 = rbi.ring_datasize;
    hv_debug_delay_test(channel, MESSAGE_DELAY);
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_pkt_iter_close(channel: *mut vmbus_channel) {
