...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmbus_dynid {
    pub node: list_head,
    pub id: hv_vmbus_device_id,
}
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_is_confidential() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_set_skip_unload(skip: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_vmbus_exists() -> bool {
    bool hv_vmbus_exists(void)
    {
    return vmbus_root_device != core::ptr::null_mut();
    }
    EXPORT_SYMBOL_GPL(hv_vmbus_exists);
#[no_mangle]
unsafe extern "C" fn channel_monitor_group(channel: *const vmbus_channel) -> u8 {
    static u8 channel_monitor_group(const struct vmbus_channel *channel)
    {
    return (u8)channel.offermsg.monitorid / 32;
    }
#[no_mangle]
unsafe extern "C" fn channel_monitor_offset(channel: *const vmbus_channel) -> u8 {
    ...
    {
    let mut monitor_group: u8 = channel_monitor_group(channel);
    ...
    {
    let mut monitor_group: u8 = channel_monitor_group(channel);
    let mut monitor_offset: u8 = channel_monitor_offset(channel);
...
#[no_mangle]
unsafe extern "C" fn hibernation_show(bus: *const bus_type, buf: *mut c_char) -> isize {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_uevent(device: *const device, env: *mut kobj_uevent_env) -> c_int {
    ...
    return core::ptr::null_mut(); /* empty device table */
    ...
    {
    const struct hv_vmbus_device_id *id = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_add_dynid(drv: *mut hv_driver, guid: *mut guid_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmbus_free_dynids(drv: *mut hv_driver) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_match(device: *mut device, driver: *const device_driver) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_probe(child_device: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_dma_configure(child_device: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_remove(child_device: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_shutdown(child_device: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_suspend(child_device: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_resume(child_device: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_device_release(device: *mut device) {
...
//
    ...
    .suspend_noirq	= core::ptr::null_mut(),
    .resume_noirq	= core::ptr::null_mut(),
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct onmessage_work_context {
...
#[no_mangle]
unsafe extern "C" fn vmbus_onmessage_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn __vmbus_on_msg_dpc(message_page_addr: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_on_msg_dpc(data: c_ulong) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_force_channel_rescinded(channel: *mut vmbus_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_chan_sched(event_page_addr: *mut c_void) {
...
//
    ...
    if (unlikely(callback_fn == core::ptr::null_mut()))
    goto sched_unlock;
...
#[no_mangle]
unsafe extern "C" fn vmbus_message_sched(hv_cpu: *mut hv_per_cpu_context, message_page_addr: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __vmbus_isr() {
...
#[no_mangle]
unsafe extern "C" fn vmbus_irqd_wake() {
...
#[no_mangle]
unsafe extern "C" fn vmbus_irqd_setup(cpu: c_uint) {
    static void vmbus_irqd_setup(unsigned int cpu)
    {
    sched_set_fifo(current);
    }
#[no_mangle]
unsafe extern "C" fn vmbus_irqd_should_run(cpu: c_uint) -> c_int {
    static int vmbus_irqd_should_run(unsigned int cpu)
    {
    return __this_cpu_read(vmbus_irq_pending);
    }
#[no_mangle]
unsafe extern "C" fn run_vmbus_irqd(cpu: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_isr() {
    void vmbus_isr(void)
    {
...
#[no_mangle]
unsafe extern "C" fn vmbus_percpu_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn vmbus_percpu_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn vmbus_alloc_synic_and_connect() -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_bus_init() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __vmbus_driver_register(hv_driver: *mut hv_driver, owner: *mut module, mod_name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_driver_unregister(hv_driver: *mut hv_driver) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_chan_release(kobj: *mut kobject) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vmbus_chan_attribute {
    pub attr: attribute,
    pub buf): *mut *mut *mut ssize_t (show)(struct vmbus_channel chan, char,
...
#[no_mangle]
unsafe extern "C" fn out_mask_show(channel: *mut vmbus_channel, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn in_mask_show(channel: *mut vmbus_channel, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn read_avail_show(channel: *mut vmbus_channel, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn write_avail_show(channel: *mut vmbus_channel, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn target_cpu_show(channel: *mut vmbus_channel, buf: *mut c_char) -> isize {
    static ssize_t target_cpu_show(struct vmbus_channel *channel, char *buf)
    {
    return sprintf(buf, "%u\n", channel.target_cpu);
    }
#[no_mangle]
pub unsafe extern "C" fn vmbus_channel_set_cpu(channel: *mut vmbus_channel, target_cpu: u32) -> c_int {
...
// Currently set only for storvsc channels.
    ...
    static VMBUS_CHAN_ATTR(pending, 0444, channel_pending_show, core::ptr::null_mut());
    ...
    static VMBUS_CHAN_ATTR(latency, 0444, channel_latency_show, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn channel_interrupts_show(channel: *mut vmbus_channel, buf: *mut c_char) -> isize {
    static ssize_t channel_interrupts_show(struct vmbus_channel *channel, char *buf)
    {
    return sprintf(buf, "%llu\n", channel.interrupts);
    }
    static VMBUS_CHAN_ATTR(interrupts, 0444, channel_interrupts_show, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn channel_events_show(channel: *mut vmbus_channel, buf: *mut c_char) -> isize {
    static ssize_t channel_events_show(struct vmbus_channel *channel, char *buf)
    {
    return sprintf(buf, "%llu\n", channel.sig_events);
    }
    static VMBUS_CHAN_ATTR(events, 0444, channel_events_show, core::ptr::null_mut());
    ...
    static VMBUS_CHAN_ATTR(intr_in_full, 0444, channel_intr_in_full_show, core::ptr::null_mut());
    ...
    static VMBUS_CHAN_ATTR(intr_out_empty, 0444, channel_intr_out_empty_show, core::ptr::null_mut());
    ...
    static VMBUS_CHAN_ATTR(out_full_first, 0444, channel_out_full_first_show, core::ptr::null_mut());
    ...
    static VMBUS_CHAN_ATTR(out_full_total, 0444, channel_out_full_total_show, core::ptr::null_mut());
    static ssize_t subchannel_monitor_id_show(struct vmbus_channel *channel,
    char *buf)
    {
    return sprintf(buf, "%u\n", channel.offermsg.monitorid);
    }
    static VMBUS_CHAN_ATTR(monitor_id, 0444, subchannel_monitor_id_show, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn hv_remove_ring_sysfs(channel: *mut vmbus_channel) -> c_int {
    ...
    channel.mmap_prepare_ring_buffer = core::ptr::null_mut();
    return ret;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_add_channel_kobj(dev: *mut hv_device, channel: *mut vmbus_channel) -> c_int {
    int vmbus_add_channel_kobj(struct hv_device *dev, struct vmbus_channel *channel)
    {
    const struct device *device = &dev.device;
    struct kobject *kobj = &channel.kobj;
    let mut relid: u32 = channel.offermsg.child_relid;
    int ret;
    kobj.kset = dev.channels_kset;
    ret = kobject_init_and_add(kobj, &vmbus_chan_ktype, core::ptr::null_mut(),
    "%u", relid);
    if (ret) {
    kobject_put(kobj);
    return ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_remove_channel_attr_group(channel: *mut vmbus_channel) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_device_register(child_device_obj: *mut hv_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_device_unregister(device_obj: *mut hv_device) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_walk_resources(res: *mut acpi_resource, ctx: *mut c_void) -> acpi_status {
    static acpi_status vmbus_walk_resources(struct acpi_resource *res, void *ctx)
    {
    let mut start: resource_size_t = 0;
    let mut end: resource_size_t = 0;
    struct resource *new_res;
    struct resource **old_res = &hyperv_mmio;
    struct resource **prev_res = core::ptr::null_mut();
    struct resource r;
    switch (res.type) {
//
...
#[no_mangle]
unsafe extern "C" fn vmbus_mmio_remove() {
...
#[no_mangle]
unsafe extern "C" fn vmbus_reserve_fb() -> void __maybe_unused {
    static void __maybe_unused vmbus_reserve_fb(void)
    {
    let mut start: resource_size_t = 0, size;
...
// Gen1 VM: get FB base from PCI
    ...
    PCI_DEVICE_ID_HYPERV_VIDEO, core::ptr::null_mut());
    if (!pdev)
    return;
...
// Skip the whole fb_mmio region if not fb_overlap_ok
    ...
    continue;
    shadow = __request_region(iter, start, size, core::ptr::null_mut(),
    IORESOURCE_BUSY);
    if (!shadow)
    continue;
// new = request_mem_region_exclusive(start, size, dev_n);
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_free_mmio(start: resource_size_t, size: resource_size_t) {
...
#[no_mangle]
unsafe extern "C" fn vmbus_acpi_add(pdev: *mut platform_device) -> c_int {
    static int vmbus_acpi_add(struct platform_device *pdev)
    {
    acpi_status result;
    let mut ret_val: c_int = -ENODEV;
...
//
    ...
    vmbus_walk_resources, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn vmbus_set_irq(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmbus_device_add(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmbus_platform_driver_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmbus_platform_driver_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vmbus_bus_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vmbus_bus_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_kexec_handler() {
...
#[no_mangle]
unsafe extern "C" fn hv_crash_handler(regs: *mut pt_regs) {
...
#[no_mangle]
unsafe extern "C" fn hv_synic_suspend(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hv_synic_resume(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hv_acpi_init() -> int __init {
...
//
    ...
    vmbus_root_device = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn vmbus_exit() -> void __exit {
