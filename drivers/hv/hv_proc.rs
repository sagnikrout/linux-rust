...
#[no_mangle]
pub unsafe extern "C" fn hv_call_deposit_pages(node: c_int, partition_id: u64, num_pages: u32) -> c_int {
...
// Populate gpa_page_list - these will fit on the input page
    ...
    page_count, 0, input_page, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn hv_result_needs_memory(status: u64) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hv_call_add_logical_proc(node: c_int, lp_index: u32, apic_id: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hv_call_create_vp(node: c_int, partition_id: u64, vp_index: u32, flags: u32) -> c_int {
...
// The value 90 is empirically determined. It may change.
    ...
    input.proximity_domain_info = hv_numa_node_to_pxm_info(node);
    status = hv_do_hypercall(HVCALL_CREATE_VP, input, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn hv_call_notify_all_processors_started() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hv_lp_exists(lp_index: u32) -> bool {
