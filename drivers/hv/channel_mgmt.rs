...
//! Source: drivers/hv/channel_mgmt.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_rescind_cleanup(channel: *mut vmbus_channel) {
...
#[no_mangle]
unsafe extern "C" fn is_unsupported_vmbus_devs(guid: *const guid_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hv_get_dev_type(channel: *const vmbus_channel) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn free_channel(channel: *mut vmbus_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_channel_map_relid(channel: *mut vmbus_channel) {
    void vmbus_channel_map_relid(struct vmbus_channel *channel)
    {
    let mut new_relid: u32 = channel.offermsg.child_relid;
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_channel_unmap_relid(channel: *mut vmbus_channel) {
...
#[no_mangle]
unsafe extern "C" fn vmbus_release_relid(relid: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn hv_process_channel_removal(channel: *mut vmbus_channel) {
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_free_channels() {
...
#[no_mangle]
unsafe extern "C" fn vmbus_add_channel_work(work: *mut work_struct) {
...
//
    ...
    if (primary_channel != core::ptr::null_mut()) {
// newchannel is a sub-channel.
    struct hv_device *dev = primary_channel.device_obj;
    if (vmbus_add_channel_kobj(dev, newchannel))
    goto err_deq_chan;
    if (primary_channel.sc_creation_callback != core::ptr::null_mut())
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_process_offer(newchannel: *mut vmbus_channel) {
    static void vmbus_process_offer(struct vmbus_channel *newchannel)
    {
    struct vmbus_channel *channel;
    struct workqueue_struct *wq;
    let mut fnew: bool = true;
//
...
//
#[no_mangle]
unsafe extern "C" fn hv_cpuself_used(cpu: u32, chn: *mut vmbus_channel) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn init_vp_index(channel: *mut vmbus_channel) {
    static void init_vp_index(struct vmbus_channel *channel)
    {
    let mut perf_chn: bool = hv_is_perf_channel(channel);
...
#[no_mangle]
unsafe extern "C" fn vmbus_wait_for_unload() {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_unload_response(hdr: *mut vmbus_channel_message_header) {
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_initiate_unload(crash: bool) {
...
//
    ...
    {
    struct vmbus_channel *channel = core::ptr::null_mut(), *iter;
...
#[no_mangle]
unsafe extern "C" fn vmbus_is_valid_offer(offer: *const vmbus_channel_offer_channel) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_onoffer(hdr: *mut vmbus_channel_message_header) {
    ...
    if (oldchannel != core::ptr::null_mut()) {
//
...
#[no_mangle]
unsafe extern "C" fn check_ready_for_suspend_event() {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_onoffer_rescind(hdr: *mut vmbus_channel_message_header) {
...
//
    ...
    } else if (channel.primary_channel != core::ptr::null_mut()) {
//
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_hvsock_device_unregister(channel: *mut vmbus_channel) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_onopen_result(hdr: *mut vmbus_channel_message_header) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_ongpadl_created(hdr: *mut vmbus_channel_message_header) {
...
//
#[no_mangle]
unsafe extern "C" fn vmbus_onmodifychannel_response(hdr: *mut vmbus_channel_message_header) {
...
// Channel message dispatch table
    ...
    { CHANNELMSG_INVALID,			0, core::ptr::null_mut(), 0},
    { CHANNELMSG_OFFERCHANNEL,		0, vmbus_onoffer,
    sizeof(struct vmbus_channel_offer_channel)},
    { CHANNELMSG_RESCIND_CHANNELOFFER,	0, vmbus_onoffer_rescind,
    sizeof(struct vmbus_channel_rescind_offer) },
    { CHANNELMSG_REQUESTOFFERS,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_ALLOFFERS_DELIVERED,	1, vmbus_onoffers_delivered, 0},
    { CHANNELMSG_OPENCHANNEL,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_OPENCHANNEL_RESULT,	1, vmbus_onopen_result,
    sizeof(struct vmbus_channel_open_result)},
    { CHANNELMSG_CLOSECHANNEL,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_GPADL_HEADER,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_GPADL_BODY,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_GPADL_CREATED,		1, vmbus_ongpadl_created,
    sizeof(struct vmbus_channel_gpadl_created)},
    { CHANNELMSG_GPADL_TEARDOWN,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_GPADL_TORNDOWN,		1, vmbus_ongpadl_torndown,
    sizeof(struct vmbus_channel_gpadl_torndown) },
    { CHANNELMSG_RELID_RELEASED,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_INITIATE_CONTACT,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_VERSION_RESPONSE,		1, vmbus_onversion_response,
    sizeof(struct vmbus_channel_version_response)},
    { CHANNELMSG_UNLOAD,			0, core::ptr::null_mut(), 0},
    { CHANNELMSG_UNLOAD_RESPONSE,		1, vmbus_unload_response, 0},
    { CHANNELMSG_18,			0, core::ptr::null_mut(), 0},
    { CHANNELMSG_19,			0, core::ptr::null_mut(), 0},
    { CHANNELMSG_20,			0, core::ptr::null_mut(), 0},
    { CHANNELMSG_TL_CONNECT_REQUEST,	0, core::ptr::null_mut(), 0},
    { CHANNELMSG_MODIFYCHANNEL,		0, core::ptr::null_mut(), 0},
    { CHANNELMSG_TL_CONNECT_RESULT,		0, core::ptr::null_mut(), 0},
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_onmessage(hdr: *mut vmbus_channel_message_header) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_request_offers() -> c_int {
