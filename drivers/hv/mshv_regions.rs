...
//! Source: drivers/hv/mshv_regions.c
#![no_std]
...
//
    ...
    u64 page_count)
    {
    let mut page_order: c_uint = folio_order(page_folio(page));
//
...
//
    ...
    bool huge_page))
    {
    let mut gfn: u64 = region.start_gfn + page_offset;
    u64 count;
    struct page *page;
    unsigned int stride;
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn mshv_region_share(region: *mut mshv_mem_region) -> c_int {
    int mshv_region_share(struct mshv_mem_region *region)
    {
    let mut flags: u32 = HV_MODIFY_SPA_PAGE_HOST_ACCESS_MAKE_SHARED;
...
#[no_mangle]
pub unsafe extern "C" fn mshv_region_unshare(region: *mut mshv_mem_region) -> c_int {
    int mshv_region_unshare(struct mshv_mem_region *region)
    {
    let mut flags: u32 = HV_MODIFY_SPA_PAGE_HOST_ACCESS_MAKE_EXCLUSIVE;
    return mshv_region_process_range(region, flags,
    0, region.nr_pages,
...
#[no_mangle]
pub unsafe extern "C" fn mshv_region_map(region: *mut mshv_mem_region) -> c_int {
    int mshv_region_map(struct mshv_mem_region *region)
    {
    let mut map_flags: u32 = region.hv_map_flags;
...
#[no_mangle]
pub unsafe extern "C" fn mshv_region_invalidate(region: *mut mshv_mem_region) {
    void mshv_region_invalidate(struct mshv_mem_region *region)
    {
    mshv_region_invalidate_pages(region, 0, region.nr_pages);
    }
#[no_mangle]
pub unsafe extern "C" fn mshv_region_pin(region: *mut mshv_mem_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_region_unmap(region: *mut mshv_mem_region) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mshv_region_destroy(ref: *mut kref) {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_region_put(region: *mut mshv_mem_region) {
    void mshv_region_put(struct mshv_mem_region *region)
    {
    kref_put(&region.mreg_refcount, mshv_region_destroy);
    }
#[no_mangle]
pub unsafe extern "C" fn mshv_region_get(region: *mut mshv_mem_region) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_region_handle_gfn_fault(region: *mut mshv_mem_region, gfn: u64) -> bool {
...
//
    ...
    mutex_lock(&region.mreg_mutex);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !mutex_trylock(&region->mreg_mutex)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn mshv_region_movable_fini(region: *mut mshv_mem_region) {
    void mshv_region_movable_fini(struct mshv_mem_region *region)
    {
    mmu_interval_notifier_remove(&region.mreg_mni);
    }
#[no_mangle]
pub unsafe extern "C" fn mshv_region_movable_init(region: *mut mshv_mem_region) -> bool {
