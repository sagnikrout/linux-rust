...
//! Source: drivers/hv/connection.c
#![no_std]
...
//
    let mut max_version: static uint = VERSION_WIN10_V6_0;
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_negotiate_version(msginfo: *mut vmbus_channel_msginfo, version: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_connect() -> c_int {
...
//
    ...
    if (vmbus_connection.int_page == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto cleanup;
    }
...
//
    ...
    if ((vmbus_connection.monitor_pages[0] == core::ptr::null_mut()) ||
    (vmbus_connection.monitor_pages[1] == core::ptr::null_mut())) {
    ret = -ENOMEM;
    goto cleanup;
    }
...
//
    vmbus_connection.monitor_pages[0] = core::ptr::null_mut();
    vmbus_connection.monitor_pages[1] = core::ptr::null_mut();
    goto cleanup;
    }
//
...
//
    ...
    MAX_CHANNEL_RELIDS);
    if (vmbus_connection.channels == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto cleanup;
    }
    kfree(msginfo);
...
#[no_mangle]
pub unsafe extern "C" fn vmbus_disconnect() {
...
//
    ...
    vmbus_connection.int_page = core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_on_event(data: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_post_msg(buffer: *mut c_void, buflen: usize, can_sleep: bool) -> c_int {
...
//
    ...
    msleep(usec / 1000);
#[no_mangle]
pub unsafe extern "C" fn if(1000: *mut *mut usec < MAX_UDELAY_MS) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn vmbus_set_event(channel: *mut vmbus_channel) {
    void vmbus_set_event(struct vmbus_channel *channel)
    {
    let mut child_relid: u32 = channel.offermsg.child_relid;
    ...
    core::ptr::null_mut(), sizeof(channel.sig_event));
#[no_mangle]
pub unsafe extern "C" fn if(_arg: hv_isolation_type_tdx()) -> else {
    ...
    let mut control: u64 = HVCALL_SIGNAL_EVENT;
