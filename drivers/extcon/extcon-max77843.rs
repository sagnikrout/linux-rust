...
//! Source: drivers/extcon/extcon-max77843.c
#![no_std]
...
pub struct max77843_muic_info {
    pub dev: *mut device,
    pub max77843: *mut max77693_dev,
    pub edev: *mut extcon_dev,
    pub mutex: mutex,
    pub irq_work: work_struct,
    pub wq_detcable: delayed_work,
    pub status: [u8; MAX77843_MUIC_STATUS_NUM],
    pub prev_cable_type: c_int,
    pub prev_chg_type: c_int,
    pub prev_gnd_type: c_int,
    pub irq_adc: bool,
    pub irq_chg: bool,
}
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_adc_gnd_handler(info: *mut max77843_muic_info) -> c_int {
    ...
    {
    int ret;
    let mut path: u8 = MAX77843_MUIC_CONTROL1_SW_OPEN;
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_adc_handler(info: *mut max77843_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_chg_handler(info: *mut max77843_muic_info) -> c_int {
...
// Charger cable on MHL accessory is attach or detach
    ...
    true);
#[no_mangle]
pub unsafe extern "C" fn if(MAX77843_MUIC_GND_MHL: gnd_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_irq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_detect_cable_wq(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn max77843_init_muic_regmap(max77843: *mut max77693_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn max77843_muic_init() -> int __init {
