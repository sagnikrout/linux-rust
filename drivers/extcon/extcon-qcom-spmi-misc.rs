...
//! Source: drivers/extcon/extcon-qcom-spmi-misc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_usb_extcon_info {
...
#[no_mangle]
unsafe extern "C" fn qcom_usb_extcon_detect_cable(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn qcom_usb_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qcom_usb_extcon_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_usb_extcon_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_usb_extcon_resume(dev: *mut device) -> c_int {
