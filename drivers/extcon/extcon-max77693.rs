...
//! Source: drivers/extcon/extcon-max77693.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn max77693_muic_adc_ground_handler(info: *mut max77693_muic_info) -> c_int {
...
// MHL or MHL with USB/TA cable
    ...
    {
    let mut ret: c_int = 0;
    let mut path: u8 = MAX77693_CONTROL1_SW_OPEN;
    dev_info(info.dev,
    "external connector is %s (adc:0x%02x)\n",
    attached ? "attached" : "detached", cable_type);
    switch (cable_type) {
...
#[no_mangle]
unsafe extern "C" fn max77693_muic_adc_handler(info: *mut max77693_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_muic_chg_handler(info: *mut max77693_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_muic_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max77693_muic_detect_accessory(info: *mut max77693_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max77693_muic_detect_cable_wq(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn max77693_muic_probe(pdev: *mut platform_device) -> c_int {
