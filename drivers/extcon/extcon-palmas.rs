...
//! Source: drivers/extcon/extcon-palmas.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn palmas_usb_wakeup(palmas: *mut palmas, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn palmas_vbus_irq_handler(irq: c_int, _palmas_usb: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn palmas_id_irq_handler(irq: c_int, _palmas_usb: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn palmas_gpio_id_detect(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn palmas_gpio_id_irq_handler(irq: c_int, _palmas_usb: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn palmas_enable_irq(palmas_usb: *mut palmas_usb) {
...
#[no_mangle]
unsafe extern "C" fn palmas_usb_probe(pdev: *mut platform_device) -> c_int {
    ...
    palmas_usb.id_irq,
    core::ptr::null_mut(), palmas_id_irq_handler,
    ...
    PALMAS_VBUS_IRQ);
    status = devm_request_threaded_irq(palmas_usb.dev,
    palmas_usb.vbus_irq, core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn palmas_usb_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmas_usb_resume(dev: *mut device) -> c_int {
