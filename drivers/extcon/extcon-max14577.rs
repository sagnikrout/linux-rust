...
//! Source: drivers/extcon/extcon-max14577.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max14577_muic_info {
    pub dev: *mut device,
    pub max14577: *mut max14577,
    pub edev: *mut extcon_dev,
    pub prev_cable_type: c_int,
    pub prev_chg_type: c_int,
    pub status: [u8; MAX14577_MUIC_STATUS_END],
    pub muic_irqs: *mut max14577_muic_irq,
    pub muic_irqs_num: c_uint,
    pub irq_adc: bool,
    pub irq_chg: bool,
...
#[no_mangle]
unsafe extern "C" fn max14577_muic_adc_handler(info: *mut max14577_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_muic_chg_handler(info: *mut max14577_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_muic_irq_work(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn max14577_parse_irq(info: *mut max14577_muic_info, irq_type: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn max77836_parse_irq(info: *mut max14577_muic_info, irq_type: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_muic_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max14577_muic_detect_accessory(info: *mut max14577_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14577_muic_detect_cable_wq(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn max14577_muic_probe(pdev: *mut platform_device) -> c_int {
