...
//! Source: drivers/extcon/extcon-max14526.c
#![no_std]
...
pub const MAX14526_DEVICE_ID: c_uint = 0x00;
pub const MAX14526_ID: c_uint = 0x02;
// CONTROL_1 register masks
pub const MAX14526_CONTROL_1: c_uint = 0x01;

// CONTROL_2 register masks
pub const MAX14526_CONTROL_2: c_uint = 0x02;

// SW_CONTROL register masks
pub const MAX14526_SW_CONTROL: c_uint = 0x03;
pub const SW_DATA: c_uint = 0x00;
pub const SW_UART: c_uint = 0x01;
pub const SW_AUDIO: c_uint = 0x02;
pub const SW_OPEN: c_uint = 0x07;
// INT_STATUS register masks
pub const MAX14526_INT_STAT: c_uint = 0x04;

// STATUS register masks
pub const MAX14526_STATUS: c_uint = 0x05;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max14526_data {
    pub client: *mut i2c_client,
    pub edev: *mut extcon_dev,
    pub regmap: *mut regmap,
    pub rfield: [*mut regmap_field; MAX14526_N_REGMAP_FIELDS],
...
#[no_mangle]
unsafe extern "C" fn max14526_ap_usb_mode(priv: *mut max14526_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max14526_interrupt(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max14526_probe(client: *mut i2c_client) -> c_int {
...
// Detect if MUIC version is supported
    ...
    ret = devm_request_threaded_irq(dev, client.irq, core::ptr::null_mut(), &max14526_interrupt,
...
#[no_mangle]
unsafe extern "C" fn max14526_resume(dev: *mut device) -> c_int {
    ...
    static DEFINE_SIMPLE_DEV_PM_OPS(max14526_pm_ops, core::ptr::null_mut(), max14526_resume);
