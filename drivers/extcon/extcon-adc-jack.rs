...
//! Source: drivers/extcon/extcon-adc-jack.c
#![no_std]
...
pub struct adc_jack_data {
    ...
    pub num_conditions: c_int,
    pub irq: c_int,
    pub /: *mut *mut unsigned long handling_delay; / in jiffies,
...
#[no_mangle]
unsafe extern "C" fn adc_jack_irq_thread(irq: c_int, _data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn adc_jack_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adc_jack_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn adc_jack_resume(dev: *mut device) -> c_int {
