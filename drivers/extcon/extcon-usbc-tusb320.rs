...
//! Source: drivers/extcon/extcon-usbc-tusb320.c
#![no_std]
...
pub const TUSB320_REG8: c_uint = 0x8;

pub const TUSB320_REG8_CURRENT_MODE_ADVERTISE_USB: c_uint = 0x0;
pub const TUSB320_REG8_CURRENT_MODE_ADVERTISE_15A: c_uint = 0x1;
pub const TUSB320_REG8_CURRENT_MODE_ADVERTISE_30A: c_uint = 0x2;

pub const TUSB320_REG8_CURRENT_MODE_DETECT_DEF: c_uint = 0x0;
pub const TUSB320_REG8_CURRENT_MODE_DETECT_MED: c_uint = 0x1;
pub const TUSB320_REG8_CURRENT_MODE_DETECT_ACC: c_uint = 0x2;
pub const TUSB320_REG8_CURRENT_MODE_DETECT_HI: c_uint = 0x3;

pub const TUSB320_REG8_ACCESSORY_CONNECTED_NONE: c_uint = 0x0;
pub const TUSB320_REG8_ACCESSORY_CONNECTED_AUDIO: c_uint = 0x4;
pub const TUSB320_REG8_ACCESSORY_CONNECTED_ACHRG: c_uint = 0x5;
pub const TUSB320_REG8_ACCESSORY_CONNECTED_DBGDFP: c_uint = 0x6;
pub const TUSB320_REG8_ACCESSORY_CONNECTED_DBGUFP: c_uint = 0x7;

pub const TUSB320_REG9: c_uint = 0x9;

pub const TUSB320_REGA: c_uint = 0xa;

pub const TUSB320_REGA_MODE_SELECT_SHIFT: c_int = 4;
pub const TUSB320_REGA_MODE_SELECT_MASK: c_uint = 0x3;
pub const TUSB320L_REGA0_REVISION: c_uint = 0xa0;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tusb320_ops {
    pub mode): *mut *mut *mut int (set_mode)(struct tusb320_priv priv, enum tusb320_mode,
    pub revision): *mut *mut *mut int (get_revision)(struct tusb320_priv priv, unsigned int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tusb320_priv {
    pub dev: *mut device,
    pub regmap: *mut regmap,
    pub edev: *mut extcon_dev,
    pub ops: *mut tusb320_ops,
    pub state: enum tusb320_attached_state,
...
#[no_mangle]
unsafe extern "C" fn tusb320_check_signature(priv: *mut tusb320_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb320_set_mode(priv: *mut tusb320_priv, mode: enum tusb320_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb320l_set_mode(priv: *mut tusb320_priv, mode: enum tusb320_mode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb320_reset(priv: *mut tusb320_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb320l_get_revision(priv: *mut tusb320_priv, revision: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb320_set_adv_pwr_mode(priv: *mut tusb320_priv) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(TYPEC_PWR_MODE_1_5A: priv->pwr_opmode ==) -> else {
    else if (priv.pwr_opmode == TYPEC_PWR_MODE_1_5A)
    mode = TUSB320_REG8_CURRENT_MODE_ADVERTISE_15A;
#[no_mangle]
pub unsafe extern "C" fn if(TYPEC_PWR_MODE_3_0A: priv->pwr_opmode ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(TYPEC_PORT_SNK: type ==) -> else {
    else if (type == TYPEC_PORT_SNK)
    return priv.ops.set_mode(priv, TUSB320_MODE_UFP);
#[no_mangle]
pub unsafe extern "C" fn if(TYPEC_PORT_DRP: type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tusb320_extcon_irq_handler(priv: *mut tusb320_priv, reg: u8) {
...
#[no_mangle]
unsafe extern "C" fn tusb320_typec_irq_handler(priv: *mut tusb320_priv, reg9: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn if(TUSB320_REG8_CURRENT_MODE_DETECT_MED: mode ==) -> else {
    else if (mode == TUSB320_REG8_CURRENT_MODE_DETECT_MED)
    typec_set_pwr_opmode(port, TYPEC_PWR_MODE_1_5A);
#[no_mangle]
pub unsafe extern "C" fn if(TUSB320_REG8_CURRENT_MODE_DETECT_HI: mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn tusb320_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tusb320_extcon_probe(priv: *mut tusb320_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tusb320_typec_remove(priv: *mut tusb320_priv) {
...
#[no_mangle]
unsafe extern "C" fn tusb320_probe(client: *mut i2c_client) -> c_int {
    ...
    int ret;
    let mut irq_trigger_type: u32 = IRQF_TRIGGER_FALLING;
...
#[no_mangle]
unsafe extern "C" fn tusb320_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tusb320_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tusb320_exit() -> void __exit {
