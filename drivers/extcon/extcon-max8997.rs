...
//! Source: drivers/extcon/extcon-max8997.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct max8997_muic_info {
    pub dev: *mut device,
    pub muic: *mut i2c_client,
    ...
    pub pre_charger_type: enum max8997_muic_charger_type,
//
...
#[no_mangle]
unsafe extern "C" fn max8997_muic_adc_handler(info: *mut max8997_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_muic_chg_handler(info: *mut max8997_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_muic_irq_work(work: *mut work_struct) {
    static void max8997_muic_irq_work(struct work_struct *work)
    {
    struct max8997_muic_info *info = container_of(work,
    struct max8997_muic_info, irq_work);
    let mut irq_type: c_int = 0;
    int i, ret;
    if (!info.edev)
    return;
...
#[no_mangle]
unsafe extern "C" fn max8997_muic_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn max8997_muic_detect_dev(info: *mut max8997_muic_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn max8997_muic_detect_cable_wq(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn max8997_muic_probe(pdev: *mut platform_device) -> c_int {
