...
//! Source: drivers/auxdisplay/ht16k33.c
#![no_std]
...
// Registers
pub const REG_SYSTEM_SETUP: c_uint = 0x20;

pub const REG_DISPLAY_SETUP: c_uint = 0x80;

pub const REG_ROWINT_SET: c_uint = 0xA0;

pub const REG_BRIGHTNESS: c_uint = 0xE0;
// Defines

pub const MIN_BRIGHTNESS: c_uint = 0x1;
pub const MAX_BRIGHTNESS: c_uint = 0x10;
pub const HT16K33_MATRIX_LED_MAX_COLS: c_int = 8;
pub const HT16K33_MATRIX_LED_MAX_ROWS: c_int = 16;
pub const HT16K33_MATRIX_KEYPAD_MAX_COLS: c_int = 3;
pub const HT16K33_MATRIX_KEYPAD_MAX_ROWS: c_int = 12;
...
pub struct ht16k33_keypad {
    ...
    pub row_shift: u32,
    pub debounce_ms: u32,
    pub last_key_state: [u16; HT16K33_MATRIX_KEYPAD_MAX_COLS],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ht16k33_priv {
    pub client: *mut i2c_client,
    pub work: delayed_work,
    pub led: led_classdev,
    pub keypad: ht16k33_keypad,
    union {
    pub fbdev: ht16k33_fbdev,
...
#[no_mangle]
unsafe extern "C" fn ht16k33_display_on(priv: *mut ht16k33_priv) -> c_int {
    static int ht16k33_display_on(struct ht16k33_priv *priv)
    {
    let mut data: u8 = REG_DISPLAY_SETUP | REG_DISPLAY_SETUP_ON | priv.blink;
    return i2c_smbus_write_byte(priv.client, data);
    }
#[no_mangle]
unsafe extern "C" fn ht16k33_display_off(priv: *mut ht16k33_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_fb_queue(priv: *mut ht16k33_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn ht16k33_fb_update(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_initialize(priv: *mut ht16k33_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_bl_update_status(bl: *mut backlight_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ht16k33_blank(blank: c_int, info: *mut fb_info) -> c_int {
    static int ht16k33_blank(int blank, struct fb_info *info)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ht16k33_mmap(info: *mut fb_info, vma: *mut vm_area_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ht16k33_keypad_scan(keypad: *mut ht16k33_keypad) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_keypad_irq_thread(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_keypad_start(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_keypad_stop(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_seg7_update(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_seg14_update(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_linedisp_get_map_type(linedisp: *mut linedisp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_linedisp_update(linedisp: *mut linedisp) {
...
// The LED is optional
    ...
    let mut rows: u32 = HT16K33_MATRIX_KEYPAD_MAX_ROWS;
    let mut cols: u32 = HT16K33_MATRIX_KEYPAD_MAX_COLS;
    int err;
    ...
    err = matrix_keypad_build_keymap(core::ptr::null_mut(), core::ptr::null_mut(), rows, cols, core::ptr::null_mut(),
    keypad.dev);
    if (err) {
    ...
    {
    struct ht16k33_fbdev *fbdev = &priv.fbdev;
    struct backlight_device *bl = core::ptr::null_mut();
    int err;
    if (priv.led.dev) {
...
// Framebuffer (2 bytes per column)
    ...
    fbdev.info.pseudo_palette = core::ptr::null_mut();
    fbdev.info.par = priv;
...
#[no_mangle]
unsafe extern "C" fn ht16k33_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ht16k33_remove(client: *mut i2c_client) {
