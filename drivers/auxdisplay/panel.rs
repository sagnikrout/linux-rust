...
//! Source: drivers/auxdisplay/panel.c
#![no_std]
...
pub const KEYPAD_BUFFER: c_int = 64;
...
pub const PNL_PBUSY: c_uint = 0x80	/* inverted input, active low */;
pub const PNL_PACK: c_uint = 0x40	/* direct input, active low */;
pub const PNL_POUTPA: c_uint = 0x20	/* direct input, active high */;
pub const PNL_PSELECD: c_uint = 0x10	/* direct input, active high */;
pub const PNL_PERRORP: c_uint = 0x08	/* direct input, active low */;
pub const PNL_PBIDIR: c_uint = 0x20	/* bi-directional ports */;
// high to read data in or-ed with data out
pub const PNL_PINTEN: c_uint = 0x10;
pub const PNL_PSELECP: c_uint = 0x08	/* inverted output, active low */;
pub const PNL_PINITP: c_uint = 0x04	/* direct output, active low */;
pub const PNL_PAUTOLF: c_uint = 0x02	/* inverted output, active low */;
pub const PNL_PSTROBE: c_uint = 0x01	/* inverted output */;
pub const PNL_PD0: c_uint = 0x01;
pub const PNL_PD1: c_uint = 0x02;
pub const PNL_PD2: c_uint = 0x04;
pub const PNL_PD3: c_uint = 0x08;
pub const PNL_PD4: c_uint = 0x10;
pub const PNL_PD5: c_uint = 0x20;
pub const PNL_PD6: c_uint = 0x40;
pub const PNL_PD7: c_uint = 0x80;
pub const PIN_NONE: c_int = 0;
pub const PIN_STROBE: c_int = 1;
pub const PIN_D0: c_int = 2;
pub const PIN_D1: c_int = 3;
pub const PIN_D2: c_int = 4;
pub const PIN_D3: c_int = 5;
pub const PIN_D4: c_int = 6;
pub const PIN_D5: c_int = 7;
pub const PIN_D6: c_int = 8;
pub const PIN_D7: c_int = 9;
pub const PIN_AUTOLF: c_int = 14;
pub const PIN_INITP: c_int = 16;
pub const PIN_SELECP: c_int = 17;
pub const PIN_NOT_SET: c_int = 127;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct logical_input {
    pub list: list_head,
    pub mask: __u64,
    pub value: __u64,
    pub type: enum input_type,
    pub state: enum input_state,
    pub fall_time: __u8 rise_time,,
    pub high_timer: __u8 rise_timer, fall_timer,,
    union {
    struct {	/* valid when type == INPUT_TYPE_STD */
    pub (*press_fct)(int): *mut c_void,
    pub (*release_fct)(int): *mut c_void,
    pub press_data: c_int,
    pub release_data: c_int,
    pub std: },
    struct {	/* valid when type == INPUT_TYPE_KBD */
    pub __nonstring: *mut *mut char press_str[sizeof(void ) + sizeof(int)],
    pub __nonstring: *mut *mut char repeat_str[sizeof(void ) + sizeof(int)],
    pub __nonstring: *mut *mut char release_str[sizeof(void ) + sizeof(int)],
    pub kbd: },
    pub u: },
}
...
// Needed only for init
    let mut selected_lcd_type: static int = NOT_SET;
//
// Bit masks to convert LCD signals to parallel port outputs.
// _d_ are values for data port, _c_ are for control port.
// [0] = signal OFF, [1] = signal ON, [2] = mask
//
pub const BIT_CLR: c_int = 0;
pub const BIT_SET: c_int = 1;
pub const BIT_MSK: c_int = 2;
pub const BIT_STATES: c_int = 3;
//
// one entry for each bit on the LCD
//
pub const LCD_BIT_E: c_int = 0;
pub const LCD_BIT_RS: c_int = 1;
pub const LCD_BIT_RW: c_int = 2;
pub const LCD_BIT_BL: c_int = 3;
pub const LCD_BIT_CL: c_int = 4;
pub const LCD_BIT_DA: c_int = 5;
pub const LCD_BITS: c_int = 6;
//
// each bit can be either connected to a DATA or CTRL port
//
pub const LCD_PORT_C: c_int = 0;
pub const LCD_PORT_D: c_int = 1;
pub const LCD_PORTS: c_int = 2;
    static unsigned char lcd_bits[LCD_PORTS][LCD_BITS][BIT_STATES];
//
// LCD protocols
//
pub const LCD_PROTO_PARALLEL: c_int = 0;
pub const LCD_PROTO_SERIAL: c_int = 1;
pub const LCD_PROTO_TI_DA8XX_LCD: c_int = 2;
//
// LCD character sets
//
pub const LCD_CHARSET_NORMAL: c_int = 0;
pub const LCD_CHARSET_KS0074: c_int = 1;
//
// LCD types
//
pub const LCD_TYPE_NONE: c_int = 0;
pub const LCD_TYPE_CUSTOM: c_int = 1;
pub const LCD_TYPE_OLD: c_int = 2;
pub const LCD_TYPE_KS0074: c_int = 3;
pub const LCD_TYPE_HANTRONIX: c_int = 4;
pub const LCD_TYPE_NEXCOM: c_int = 5;
//
// keypad types
//
pub const KEYPAD_TYPE_NONE: c_int = 0;
pub const KEYPAD_TYPE_OLD: c_int = 1;
pub const KEYPAD_TYPE_NEW: c_int = 2;
pub const KEYPAD_TYPE_NEXCOM: c_int = 3;
//
// panel profiles
//
pub const PANEL_PROFILE_CUSTOM: c_int = 0;
pub const PANEL_PROFILE_OLD: c_int = 1;
pub const PANEL_PROFILE_NEW: c_int = 2;
pub const PANEL_PROFILE_HANTRONIX: c_int = 3;
pub const PANEL_PROFILE_NEXCOM: c_int = 4;
pub const PANEL_PROFILE_LARGE: c_int = 5;
//
// Construct custom config from the kernel's configuration
//
pub const DEFAULT_PARPORT: c_int = 0;

pub const DEFAULT_LCD_HEIGHT: c_int = 2;
pub const DEFAULT_LCD_WIDTH: c_int = 40;

// global variables
// Device single-open policy control
    let mut keypad_available: static atomic_t = ATOMIC_INIT(1);
    static struct pardevice *pprt;
    static int keypad_initialized;
    static DEFINE_SPINLOCK(pprt_lock);
    static struct timer_list scan_timer;
    MODULE_DESCRIPTION("Generic parallel port LCD/Keypad driver");
    let mut parport: static int = DEFAULT_PARPORT;
    module_param(parport, int, 0000);
    MODULE_PARM_DESC(parport, "Parallel port index (0=lpt1, 1=lpt2, ...)");
    let mut profile: static int = DEFAULT_PROFILE;
    module_param(profile, int, 0000);
    MODULE_PARM_DESC(profile,
    "1=16x2 old kp; 2=serial 16x2, new kp; 3=16x2 hantronix; "
    "4=16x2 nexcom; default=40x2, old kp");
    let mut keypad_type: static int = NOT_SET;
    module_param(keypad_type, int, 0000);
    MODULE_PARM_DESC(keypad_type,
    "Keypad type: 0=none, 1=old 6 keys, 2=new 6+1 keys, 3=nexcom 4 keys");
    let mut lcd_type: static int = NOT_SET;
    module_param(lcd_type, int, 0000);
    MODULE_PARM_DESC(lcd_type,
    "LCD type: 0=none, 1=compiled-in, 2=old, 3=serial ks0074, 4=hantronix, 5=nexcom");
    let mut lcd_height: static int = NOT_SET;
    module_param(lcd_height, int, 0000);
    MODULE_PARM_DESC(lcd_height, "Number of lines on the LCD");
    let mut lcd_width: static int = NOT_SET;
    ...
    let mut lcd_charset: static int = NOT_SET;
    module_param(lcd_charset, int, 0000);
    MODULE_PARM_DESC(lcd_charset, "LCD character set: 0=standard, 1=KS0074");
    let mut lcd_proto: static int = NOT_SET;
...
//
    let mut lcd_e_pin: static int = PIN_NOT_SET;
    module_param(lcd_e_pin, int, 0000);
    MODULE_PARM_DESC(lcd_e_pin,
    "# of the // port pin connected to LCD 'E' signal, with polarity (-17..17)");
    let mut lcd_rs_pin: static int = PIN_NOT_SET;
    module_param(lcd_rs_pin, int, 0000);
    MODULE_PARM_DESC(lcd_rs_pin,
    "# of the // port pin connected to LCD 'RS' signal, with polarity (-17..17)");
    let mut lcd_rw_pin: static int = PIN_NOT_SET;
    module_param(lcd_rw_pin, int, 0000);
    MODULE_PARM_DESC(lcd_rw_pin,
    "# of the // port pin connected to LCD 'RW' signal, with polarity (-17..17)");
    let mut lcd_cl_pin: static int = PIN_NOT_SET;
    module_param(lcd_cl_pin, int, 0000);
    MODULE_PARM_DESC(lcd_cl_pin,
    "# of the // port pin connected to serial LCD 'SCL' signal, with polarity (-17..17)");
    let mut lcd_da_pin: static int = PIN_NOT_SET;
    module_param(lcd_da_pin, int, 0000);
    MODULE_PARM_DESC(lcd_da_pin,
    "# of the // port pin connected to serial LCD 'SDA' signal, with polarity (-17..17)");
    let mut lcd_bl_pin: static int = PIN_NOT_SET;
    module_param(lcd_bl_pin, int, 0000);
    MODULE_PARM_DESC(lcd_bl_pin,
    "# of the // port pin connected to LCD backlight, with polarity (-17..17)");
// Deprecated module parameters - consider not using them anymore
    let mut lcd_enabled: static int = NOT_SET;
    module_param(lcd_enabled, int, 0000);
    MODULE_PARM_DESC(lcd_enabled, "Deprecated option, use lcd_type instead");
    let mut keypad_enabled: static int = NOT_SET;
...
#[no_mangle]
unsafe extern "C" fn lcd_get_bits(port: c_uint, val: *mut c_int) {
...
#[no_mangle]
unsafe extern "C" fn set_data_bits() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_ctrl_bits() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn panel_set_bits() {
...
//
#[no_mangle]
unsafe extern "C" fn pin_to_bits(pin: c_int, d_val: *mut c_uchar, c_val: *mut c_uchar) {
...
//
#[no_mangle]
unsafe extern "C" fn lcd_send_serial(byte: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lcd_backlight(charlcd: *mut charlcd, on: enum charlcd_onoff) {
...
#[no_mangle]
unsafe extern "C" fn lcd_write_cmd_s(hdc: *mut hd44780_common, cmd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lcd_write_data_s(hdc: *mut hd44780_common, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lcd_write_cmd_p8(hdc: *mut hd44780_common, cmd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lcd_write_data_p8(hdc: *mut hd44780_common, data: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lcd_write_cmd_tilcd(hdc: *mut hd44780_common, cmd: c_int) {
...
#[no_mangle]
unsafe extern "C" fn lcd_write_data_tilcd(hdc: *mut hd44780_common, data: c_int) {
...
// this is used to catch wrong and default values
    ...
    charlcd.char_conv = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn keypad_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keypad_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn keypad_send_key(string: *const c_char, max_len: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn phys_scan_contacts() {
...
#[no_mangle]
pub unsafe extern "C" fn input_state_high(input: *mut logical_input) -> c_int {
...
// will turn on the light
    ...
    if (press_str[0]) {
    let mut s: c_int = sizeof(input.u.kbd.press_str);
    ...
    let mut s: c_int = sizeof(input.u.kbd.repeat_str);
...
#[no_mangle]
pub unsafe extern "C" fn input_state_falling(input: *mut logical_input) {
...
// call release event
    ...
    if (release_str[0]) {
    let mut s: c_int = sizeof(input.u.kbd.release_str);
...
#[no_mangle]
unsafe extern "C" fn panel_process_inputs() {
...
#[no_mangle]
unsafe extern "C" fn panel_scan_timer(unused: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn init_scan_timer() {
...
#[no_mangle]
unsafe extern "C" fn keypad_init() {
...
//
#[no_mangle]
unsafe extern "C" fn panel_attach(port: *mut parport) {
    static void panel_attach(struct parport *port)
    {
    let mut selected_keypad_type: c_int = NOT_SET;
...
//
    ...
    break;
    default:
    keypad_profile = core::ptr::null_mut();
    break;
    }
...
//
    ...
    lcd.charlcd = core::ptr::null_mut();
    parport_unregister_device(pprt);
    pprt = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn panel_detach(port: *mut parport) {
