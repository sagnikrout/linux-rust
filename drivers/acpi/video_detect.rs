...
//! Source: drivers/acpi/video_detect.c
#![no_std]
...
//
    ...
    let mut acpi_backlight_cmdline: static enum acpi_backlight_type = acpi_backlight_undef;
    let mut acpi_backlight_dmi: static enum acpi_backlight_type = acpi_backlight_undef;
#[no_mangle]
unsafe extern "C" fn acpi_video_parse_cmdline() {
...
#[no_mangle]
unsafe extern "C" fn nvidia_wmi_ec_supported() -> bool {
...
// buggy
#[no_mangle]
unsafe extern "C" fn video_detect_force_vendor(d: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn video_detect_force_video(d: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn video_detect_force_native(d: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn video_detect_portege_r100(d: *const dmi_system_id) -> c_int {
    static int video_detect_portege_r100(const struct dmi_system_id *d)
    {
    struct pci_dev *dev;
// Search for Trident CyberBlade XP4m32 to confirm Portégé R100
    dev = pci_get_device(PCI_VENDOR_ID_TRIDENT, 0x2100, core::ptr::null_mut());
    if (dev) {
    acpi_backlight_dmi = acpi_backlight_vendor;
    pci_dev_put(dev);
    }
...
#[no_mangle]
unsafe extern "C" fn google_cros_ec_present() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn prefer_native_over_acpi_video() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn __acpi_video_get_backlight_type(native: bool, auto_detect: *mut bool) -> enum acpi_backlight_type {
