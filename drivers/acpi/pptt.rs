...
#[no_mangle]
pub unsafe extern "C" fn acpi_pptt_match_type(table_type: c_int, type: c_int) -> bool {
...
// split_levels = local_level;
    ...
    if (*found != core::ptr::null_mut() && cache != *found)
...
//
    ...
    {
    struct acpi_subtable_header *res;
    let mut number_of_levels: c_uint = *starting_level;
    let mut resource: c_int = 0;
    struct acpi_pptt_cache *ret = core::ptr::null_mut();
    unsigned int local_level;
...
#[no_mangle]
unsafe extern "C" fn acpi_cache_type(type: enum cache_type) -> u8 {
...
//
    ...
    struct acpi_pptt_processor **node)
    {
    let mut total_levels: c_uint = 0;
    struct acpi_pptt_cache *found = core::ptr::null_mut();
    struct acpi_pptt_processor *cpu_node;
    let mut acpi_type: u8 = acpi_cache_type(type);
    pr_debug("Looking for CPU %d's level %u cache type %d\n",
    acpi_cpu_id, level, acpi_type);
    cpu_node = acpi_find_processor_node(table_hdr, acpi_cpu_id);
    while (cpu_node && !found) {
    found = acpi_find_cache_level(table_hdr, cpu_node,
    &total_levels, core::ptr::null_mut(), level, acpi_type);
// node = cpu_node;
    cpu_node = fetch_pptt_node(table_hdr, cpu_node.parent);
    }
    return found;
...
//
    ...
    struct acpi_pptt_processor *cpu_node = core::ptr::null_mut();
...
pub const PPTT_ABORT_PACKAGE: c_uint = 0xFF;
...
// special case the identical flag to find last identical
    ...
    if (prev_node == core::ptr::null_mut())
    break;
    cpu = prev_node;
    level--;
    }
...
#[no_mangle]
unsafe extern "C" fn acpi_pptt_warn_missing() {
...
#[no_mangle]
unsafe extern "C" fn find_acpi_cpu_topology_tag(cpu: c_uint, level: c_int, flag: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_acpi_cpu_flag(cpu: c_uint, rev: c_int, flag: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cache_setup_acpi(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_pptt_cpu_is_thread(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn find_acpi_cpu_topology(cpu: c_uint, level: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn find_acpi_cpu_topology_package(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn find_acpi_cpu_topology_cluster(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn find_acpi_cpu_topology_hetero_id(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_pptt_get_cpus_from_container(acpi_cpu_id: u32, cpus: *mut cpumask_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn find_acpi_cache_level_from_id(cache_id: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_pptt_get_cpumask_from_cache_id(cache_id: u32, cpus: *mut cpumask_t) -> c_int {
