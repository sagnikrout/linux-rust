...
//! Source: drivers/acpi/acpi_lpat.c
#![no_std]
...
//
    ...
    handle)
    {
    struct acpi_lpat_conversion_table *lpat_table = core::ptr::null_mut();
    let mut buffer: acpi_buffer = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
    union acpi_object *obj_p, *obj_e;
    int *lpat, i;
    acpi_status status;
    status = acpi_evaluate_object(handle, "LPAT", core::ptr::null_mut(), &buffer);
