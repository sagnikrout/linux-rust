...
#[no_mangle]
unsafe extern "C" fn setup_res(acpi_res: *mut acpi_resource, data: *mut c_void) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn acpi_is_ioapic(handle: acpi_handle, type: *mut c_char) -> bool {
    static bool acpi_is_ioapic(acpi_handle handle, char **type)
    {
    acpi_status status;
    struct acpi_device_info *info;
    char *hid = core::ptr::null_mut();
...
// type = "IOAPIC";
    ...
    struct resource *res = core::ptr::null_mut(), *pci_res = core::ptr::null_mut(), *crs_res;
    ...
    status = acpi_evaluate_integer(handle, "_GSB", core::ptr::null_mut(), &gsi_base);
...
#[no_mangle]
pub unsafe extern "C" fn acpi_ioapic_add(root_handle: acpi_handle) -> c_int {
    int acpi_ioapic_add(acpi_handle root_handle)
    {
    acpi_status status, retval = AE_OK;
    status = acpi_walk_namespace(ACPI_TYPE_DEVICE, root_handle,
    UINT_MAX, handle_ioapic_add, core::ptr::null_mut(),
    root_handle, (void **)&retval);
    return ACPI_SUCCESS(status) && ACPI_SUCCESS(retval) ? 0 : -ENODEV;
    }
#[no_mangle]
pub unsafe extern "C" fn pci_ioapic_remove(root: *mut acpi_pci_root) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_ioapic_remove(root: *mut acpi_pci_root) -> c_int {
