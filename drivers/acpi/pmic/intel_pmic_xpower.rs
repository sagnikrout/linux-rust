...
//! Source: drivers/acpi/pmic/intel_pmic_xpower.c
#![no_std]
...
pub const XPOWER_GPADC_LOW: c_uint = 0x5b;
pub const XPOWER_GPI1_CTRL: c_uint = 0x92;
...
//
#[no_mangle]
unsafe extern "C" fn intel_xpower_pmic_get_raw_temp(regmap: *mut regmap, reg: c_int) -> c_int {
...
// Wait a bit after switching the current-source
    ...
    int raw)
    {
    let mut first: acpi_lpat = lpat_table.lpat[0];
    let mut last: acpi_lpat = lpat_table.lpat[lpat_table.lpat_count - 1];
//
...
#[no_mangle]
unsafe extern "C" fn intel_xpower_pmic_opregion_probe(pdev: *mut platform_device) -> c_int {
