...
//! Source: drivers/acpi/pmic/intel_pmic_bxtwc.c
#![no_std]
...
pub const WHISKEY_COVE_ALRT_HIGH_BIT_MASK: c_uint = 0x0F;

pub const VR_MODE_DISABLED: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn intel_bxtwc_pmic_get_raw_temp(regmap: *mut regmap, reg: c_int) -> c_int {
...
// value = (val & mask) >> bit;
    ...
    {
    let mut mask: u8 = BIT(bit), val = enable << bit;
    return regmap_update_bits(regmap, reg, mask, val);
    }
...
#[no_mangle]
unsafe extern "C" fn intel_bxtwc_pmic_opregion_probe(pdev: *mut platform_device) -> c_int {
