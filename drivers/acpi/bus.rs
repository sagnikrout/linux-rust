...
#[no_mangle]
pub unsafe extern "C" fn set_copy_dsdt(id: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_copy_dsdt(id: *const dmi_system_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_bus_get_status(device: *mut acpi_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_bus_attach_private_data(handle: acpi_handle, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_bus_get_private_data(handle: acpi_handle, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_bus_detach_private_data(handle: acpi_handle) {
...
// Only take defined error bits into account.
    let mut errors: u32 = retbuf[OSC_QUERY_DWORD] & OSC_ERROR_MASK;
    u32 *capbuf = cap.pointer;
    bool fail;
//
...
#[no_mangle]
unsafe extern "C" fn acpi_bus_osc_negotiate_platform_control() {
    ...
    if (ACPI_FAILURE(acpi_get_handle(core::ptr::null_mut(), "\\_SB", &handle)))
    return;
...
#[no_mangle]
unsafe extern "C" fn acpi_bus_decode_usb_osc(msg: *const c_char, bits: u32) {
...
#[no_mangle]
unsafe extern "C" fn acpi_bus_osc_negotiate_usb_control() {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_bus_notify(handle: acpi_handle, type: u32, data: *mut c_void) {
...
// TBD: Exactly what does 'light' mean?
    ...
    acpi_evaluate_ost(handle, type, ACPI_OST_SC_NON_SPECIFIC_FAILURE, core::ptr::null_mut());
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_notify_handler_devres {
...
#[no_mangle]
unsafe extern "C" fn devm_acpi_notify_handler_release(dev: *mut device, res: *mut c_void) {
...
pub const ACPI_SB_NOTIFY_SHUTDOWN_REQUEST: c_uint = 0x81;
pub const ACPI_SB_INDICATE_INTERVAL: c_int = 10000;
#[no_mangle]
unsafe extern "C" fn sb_notify_work(dummy: *mut work_struct) {
...
//
    acpi_get_handle(core::ptr::null_mut(), "\\_SB", &sb_handle);
    while (1) {
    pr_info("Graceful shutdown in progress.\n");
    acpi_evaluate_ost(sb_handle, ACPI_OST_EC_OSPM_SHUTDOWN,
    ACPI_OST_SC_OS_SHUTDOWN_IN_PROGRESS, core::ptr::null_mut());
    msleep(ACPI_SB_INDICATE_INTERVAL);
    }
    }
#[no_mangle]
unsafe extern "C" fn acpi_sb_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_setup_sb_notify_handler() -> int __init {
    static int __init acpi_setup_sb_notify_handler(void)
    {
    acpi_handle sb_handle;
    if (ACPI_FAILURE(acpi_get_handle(core::ptr::null_mut(), "\\_SB", &sb_handle)))
    return -ENXIO;
    if (ACPI_FAILURE(acpi_install_notify_handler(sb_handle, ACPI_DEVICE_NOTIFY,
    acpi_sb_notify, core::ptr::null_mut())))
    return -EINVAL;
    return 0;
    }
// --------------------------------------------------------------------------
...
//
    ...
    return phys_dev && phys_dev == dev ? adev : core::ptr::null_mut();
    }
//
...
//
    ...
    {
    const struct acpi_device_id *id = core::ptr::null_mut();
    __acpi_match_device(adev, ids, core::ptr::null_mut(), &id, core::ptr::null_mut());
    return id;
    }
...
//
    ...
    {
    return __acpi_match_device(device, ids, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut()) ? 0 : -ENOENT;
    }
    ...
    if (!acpi_ids)
    return acpi_of_match_device(ACPI_COMPANION(dev), of_ids, core::ptr::null_mut());
    return __acpi_match_device(acpi_companion_match(dev), acpi_ids, of_ids, core::ptr::null_mut(), core::ptr::null_mut());
    }
...
// --------------------------------------------------------------------------
    ...
    -------------------------------------------------------------------------- */
#[no_mangle]
unsafe extern "C" fn acpi_bus_match(dev: *mut device, drv: *const device_driver) -> c_int {
    static int acpi_bus_match(struct device *dev, const struct device_driver *drv)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn acpi_device_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_bus_for_each_dev(: *mut *mut int (fn)(struct device, ): *mut c_void, data: *mut c_void) -> c_int {
    int acpi_bus_for_each_dev(int (*fn)(struct device *, void *), void *data)
    {
    return bus_for_each_dev(&acpi_bus_type, core::ptr::null_mut(), data, fn);
    }
...
//
    ...
    {
    return bus_find_device_by_name(&acpi_bus_type, core::ptr::null_mut(), name);
    }
    EXPORT_SYMBOL_GPL(acpi_bus_find_device_by_name);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_dev_walk_context {
    pub ): *mut *mut *mut int (fn)(struct acpi_device , void,
    pub data: *mut c_void,
}

#[no_mangle]
unsafe extern "C" fn acpi_dev_for_one_check(dev: *mut device, context: *mut c_void) -> c_int {
...
// --------------------------------------------------------------------------
    ...
    -------------------------------------------------------------------------- */
#[no_mangle]
unsafe extern "C" fn acpi_bus_init_irq() -> int __init {
    static int __init acpi_bus_init_irq(void)
    {
    acpi_status status;
    char *message = core::ptr::null_mut();
//
...
//
    ...
    status = acpi_execute_simple_method(core::ptr::null_mut(), "\\_PIC", acpi_irq_model);
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_early_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_subsystem_init() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_bus_table_handler(event: u32, table: *mut c_void, context: *mut c_void) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn acpi_bus_init() -> int __init {
...
//
    status = acpi_install_table_handler(acpi_bus_table_handler, core::ptr::null_mut());
    acpi_sysfs_init();
...
//
    ...
    &acpi_bus_notify, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
...
//
    acpi_root_dir = proc_mkdir(ACPI_BUS_FILE_ROOT, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn acpi_init() -> int __init {
