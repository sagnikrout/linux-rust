...
//! Source: drivers/acpi/pfr_telemetry.c
#![no_std]
...
pub const PFRT_LOG_EXEC_IDX: c_int = 0;
pub const PFRT_LOG_HISTORY_IDX: c_int = 1;
pub const PFRT_LOG_ERR: c_int = 0;
pub const PFRT_LOG_WARN: c_int = 1;
pub const PFRT_LOG_INFO: c_int = 2;
pub const PFRT_LOG_VERB: c_int = 4;
pub const PFRT_FUNC_SET_LEV: c_int = 1;
pub const PFRT_FUNC_GET_LEV: c_int = 2;
pub const PFRT_FUNC_GET_DATA: c_int = 3;
pub const PFRT_REVID_1: c_int = 1;
pub const PFRT_REVID_2: c_int = 2;
...
// pfrt_guid is the parameter for _DSM method
    ...
    {
    let mut handle: acpi_handle = ACPI_HANDLE(pfrt_log_dev.parent_dev);
...
#[no_mangle]
unsafe extern "C" fn set_pfrt_log_level(level: c_int, pfrt_log_dev: *mut pfrt_log_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_pfrt_log_level(pfrt_log_dev: *mut pfrt_log_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn valid_log_level(level: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn valid_log_type(type: u32) -> c_int {
    static int valid_log_type(u32 type)
    {
    let mut type: return = = PFRT_LOG_EXEC_IDX || type == PFRT_LOG_HISTORY_IDX;
    }
#[no_mangle]
pub unsafe extern "C" fn valid_log_revid(id: u32) -> c_int {
    static inline int valid_log_revid(u32 id)
    {
    let mut id: return = = PFRT_REVID_1 || id == PFRT_REVID_2;
    }
#[no_mangle]
unsafe extern "C" fn pfrt_log_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn acpi_pfrt_log_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pfrt_log_put_idx(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_pfrt_log_probe(pdev: *mut platform_device) -> c_int {
