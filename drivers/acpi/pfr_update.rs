...
//! Source: drivers/acpi/pfr_update.c
#![no_std]
...
pub const PFRU_FUNC_STANDARD_QUERY: c_int = 0;
pub const PFRU_FUNC_QUERY_UPDATE_CAP: c_int = 1;
pub const PFRU_FUNC_QUERY_BUF: c_int = 2;
pub const PFRU_FUNC_START: c_int = 3;
pub const PFRU_CODE_INJECT_TYPE: c_int = 1;
pub const PFRU_DRIVER_UPDATE_TYPE: c_int = 2;
pub const PFRU_REVID_1: c_int = 1;
pub const PFRU_REVID_2: c_int = 2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pfru_device {
    pub index: u32 rev_id,,
...
// pfru_drv_update_guid is the UUID to identify driver update EFI capsule file
    ...
    0x80, 0x97, 0xA0, 0xDF);
#[no_mangle]
pub unsafe extern "C" fn pfru_valid_revid(id: u32) -> c_int {
    static inline int pfru_valid_revid(u32 id)
    {
    let mut id: return = = PFRU_REVID_1 || id == PFRU_REVID_2;
    }
    ...
    {
    let mut handle: acpi_handle = ACPI_HANDLE(pfru_dev.parent_dev);
...
#[no_mangle]
unsafe extern "C" fn start_update(action: c_int, pfru_dev: *mut pfru_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pfru_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn acpi_pfru_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pfru_put_idx(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_pfru_probe(pdev: *mut platform_device) -> c_int {
