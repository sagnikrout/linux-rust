...
//! Source: drivers/acpi/nfit/core.c
#![no_std]
...
//
    ...
    let mut default_dsm_family: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn xlat_bus_status(buf: *mut c_void, cmd: c_uint, status: u32) -> c_int {
...
pub const ACPI_LABELS_LOCKED: c_int = 3;
...
// convert _LS{I,R} packages to the buffer object acpi_nfit_ctl expects
    ...
    union acpi_object *buf = core::ptr::null_mut();
...
pub unsafe extern "C" fn if(ACPI_TYPE_BUFFER: obj->type ==) -> else {
    ...
    acpi_status rc;
    let mut buf: acpi_buffer = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
    rc = acpi_evaluate_object(handle, "_LSI", core::ptr::null_mut(), &buf);
    if (ACPI_FAILURE(rc))
    return core::ptr::null_mut();
    return pkg_to_buf(buf.pointer);
    }
#[no_mangle]
unsafe extern "C" fn nfit_dsm_revid(family: unsigned, func: unsigned) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn payload_dumpable(nvdimm: *mut nvdimm, func: c_uint) -> bool {
...
//
    ...
    struct nd_cmd_pkg *call_pkg = core::ptr::null_mut();
...
//
    ...
    return -ENOTTY;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !test_bit(cmd, _arg: &cmd_mask)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn nfit_spa_type(spa: *mut acpi_nfit_system_address) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sizeof_spa(spa: *mut acpi_nfit_system_address) -> usize {
...
#[no_mangle]
pub unsafe extern "C" fn nfit_get_smbios_id(device_handle: u32, flags: *mut u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sizeof_dcr(dcr: *mut acpi_nfit_control_region) -> usize {
...
#[no_mangle]
unsafe extern "C" fn sizeof_idt(idt: *mut acpi_nfit_interleave) -> usize {
...
#[no_mangle]
unsafe extern "C" fn sizeof_flush(flush: *mut acpi_nfit_flush_address) -> usize {
    ...
    struct nfit_memdev *nfit_memdev;
    let mut type: c_int = spa ? nfit_spa_type(spa) : 0;
    switch (type) {
    case NFIT_SPA_DCR:
    case NFIT_SPA_PM:
    break;
...
//
    ...
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(handleB: handleA >) -> else {
    else if (handleA > handleB)
    return 1;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn nfit_mem_init(acpi_desc: *mut acpi_nfit_desc) -> c_int {
...
//
    rc = __nfit_mem_init(acpi_desc, core::ptr::null_mut());
    if (rc)
    return rc;
    list_sort(core::ptr::null_mut(), &acpi_desc.dimms, nfit_mem_cmp);
    return 0;
    }
    ...
    __ATTR(dsm_mask, 0444, bus_dsm_mask_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ars_supported(nvdimm_bus: *mut nvdimm_bus) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfit_visible(kobj: *mut kobject, a: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn num_nvdimm_formats(nvdimm: *mut nvdimm) -> c_int {
...
// assumes DIMMs have at most 2 published interface codes
    ...
    struct nvdimm *nvdimm = to_nvdimm(dev);
    struct nfit_mem *nfit_mem = nvdimm_provider_data(nvdimm);
    let mut flags: u16 = __to_nfit_memdev(nfit_mem).flags;
...
#[no_mangle]
pub unsafe extern "C" fn __acpi_nvdimm_notify(dev: *mut device, event: u32) {
...
#[no_mangle]
unsafe extern "C" fn acpi_nvdimm_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_nvdimm_has_method(adev: *mut acpi_device, method: *mut c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn nfit_intel_shutdown_status(nfit_mem: *mut nfit_mem) -> __weak void {
    __weak void nfit_intel_shutdown_status(struct nfit_mem *nfit_mem)
    {
    struct device *dev = &nfit_mem.adev.dev;
    let mut smart: nd_intel_smart = { 0 };
    ...
    let mut func: u8 = ND_INTEL_SMART;
    const guid_t *guid = to_nfit_uuid(nfit_mem.family);
    let mut revid: u8 = nfit_dsm_revid(nfit_mem.family, func);
    struct acpi_device *adev = nfit_mem.adev;
...
#[no_mangle]
unsafe extern "C" fn populate_shutdown_status(nfit_mem: *mut nfit_mem) {
...
#[no_mangle]
pub unsafe extern "C" fn if(NVDIMM_FAMILY_INTEL: nfit_mem->family ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn shutdown_dimm_notify(data: *mut c_void) {
...
//
    ...
    nfit_mem.flags_attr = core::ptr::null_mut();
    }
    if (adev_dimm) {
    acpi_remove_notify_handler(adev_dimm.handle,
    ACPI_DEVICE_NOTIFY, acpi_nvdimm_notify);
    dev_set_drvdata(&adev_dimm.dev, core::ptr::null_mut());
    }
    }
    mutex_unlock(&acpi_desc.init_mutex);
    }
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_register_dimms(acpi_desc: *mut acpi_nfit_desc) -> c_int {
    static int acpi_nfit_register_dimms(struct acpi_nfit_desc *acpi_desc)
    {
    struct nfit_mem *nfit_mem;
    let mut dimm_count: c_int = 0, rc;
    struct nvdimm *nvdimm;
    list_for_each_entry(nfit_mem, &acpi_desc.dimms, list) {
    struct acpi_nfit_flush_address *flush;
    let mut flags: c_ulong = 0, cmd_mask;
    struct nfit_memdev *nfit_memdev;
    u32 device_handle;
    u16 mem_flags;
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_init_dsms(acpi_desc: *mut acpi_nfit_desc) {
...
#[no_mangle]
unsafe extern "C" fn cmp_map_compat(m0: *const c_void, m1: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmp_map(m0: *const c_void, m1: *const c_void) -> c_int {
    ...
    return -1;
#[no_mangle]
pub unsafe extern "C" fn if(map1->region_offset: map0->region_offset >) -> else {
    else if (map0.region_offset > map1.region_offset)
    return 1;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn cmp_map2(m0: *const c_void, m1: *const c_void) -> c_int {
...
// Retrieve the nth entry referencing this spa
    ...
    struct acpi_nfit_system_address *spa)
    {
    let mut nr: u16 = ndr_desc.num_mappings;
...
// v1.1 namespaces
    sort(info, nr, sizeof(*info), cmp_map, core::ptr::null_mut());
    nd_set.cookie1 = nd_fletcher64(info, sizeof(*info) * nr, 0);
// v1.2 namespaces
    sort(info2, nr, sizeof(*info2), cmp_map2, core::ptr::null_mut());
    nd_set.cookie2 = nd_fletcher64(info2, sizeof(*info2) * nr, 0);
// support v1.1 namespaces created with the wrong sort order
    sort(info, nr, sizeof(*info), cmp_map_compat, core::ptr::null_mut());
...
// record the result of the sort for the mapping position
    ...
    rc = nd_desc.ndctl(nd_desc, core::ptr::null_mut(), ND_CMD_ARS_CAP, cmd,
    sizeof(*cmd), &cmd_rc);
    if (rc < 0)
    return rc;
    return cmd_rc;
...
#[no_mangle]
pub unsafe extern "C" fn if(NFIT_SPA_VOLATILE: nfit_spa_type(spa) ==) -> else {
    else if (nfit_spa_type(spa) == NFIT_SPA_VOLATILE)
    ars_start.type = ND_ARS_VOLATILE;
    else
    return -ENOTTY;
    rc = nd_desc.ndctl(nd_desc, core::ptr::null_mut(), ND_CMD_ARS_START, &ars_start,
...
#[no_mangle]
unsafe extern "C" fn ars_continue(acpi_desc: *mut acpi_nfit_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ars_get_status(acpi_desc: *mut acpi_nfit_desc) -> c_int {
    static int ars_get_status(struct acpi_nfit_desc *acpi_desc)
    {
    struct nvdimm_bus_descriptor *nd_desc = &acpi_desc.nd_desc;
    struct nd_cmd_ars_status *ars_status = acpi_desc.ars_status;
    int rc, cmd_rc;
    rc = nd_desc.ndctl(nd_desc, core::ptr::null_mut(), ND_CMD_ARS_STATUS, ars_status,
...
// complete */;
    ...
    return;
    acpi_desc.scrub_spa = core::ptr::null_mut();
    if (nd_region) {
...
#[no_mangle]
unsafe extern "C" fn ars_status_process_records(acpi_desc: *mut acpi_nfit_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_remove_resource(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn nfit_spa_is_virtual(spa: *mut acpi_nfit_system_address) -> bool {
...
#[no_mangle]
unsafe extern "C" fn nfit_spa_is_volatile(spa: *mut acpi_nfit_system_address) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_NFIT_CAPABILITY_MEM_FLUSH: acpi_desc->platform_cap &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ars_status_alloc(acpi_desc: *mut acpi_nfit_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_query_poison(acpi_desc: *mut acpi_nfit_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ars_complete_all(acpi_desc: *mut acpi_nfit_desc) {
    ...
    int query_rc)
    {
    let mut tmo: c_uint = acpi_desc.scrub_tmo;
    struct device *dev = acpi_desc.dev;
    struct nfit_spa *nfit_spa;
    lockdep_assert_held(&acpi_desc.init_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: test_bit(ARS_REQ_LONG, _arg: &nfit_spa->ars_state)) -> else {
...
#[no_mangle]
unsafe extern "C" fn __sched_ars(acpi_desc: *mut acpi_nfit_desc, tmo: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn sched_ars(acpi_desc: *mut acpi_nfit_desc) {
    static void sched_ars(struct acpi_nfit_desc *acpi_desc)
    {
    __sched_ars(acpi_desc, 0);
    }
#[no_mangle]
unsafe extern "C" fn notify_ars_done(acpi_desc: *mut acpi_nfit_desc) {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_scrub(work: *mut work_struct) {
    ...
    struct nfit_spa *nfit_spa)
    {
    let mut type: c_int = nfit_spa_type(nfit_spa.spa);
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_register_regions(acpi_desc: *mut acpi_nfit_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_desc_init_scrub_attr(acpi_desc: *mut acpi_nfit_desc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_unregister(data: *mut c_void) {
    static void acpi_nfit_unregister(void *data)
    {
    struct acpi_nfit_desc *acpi_desc = data;
    nvdimm_bus_unregister(acpi_desc.nvdimm_bus);
// The nvdimm_bus object may have been freed, so clear the pointer.
    acpi_desc.nvdimm_bus = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn acpi_nfit_init(acpi_desc: *mut acpi_nfit_desc, data: *mut c_void, sz: acpi_size) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_flush_probe(nd_desc: *mut nvdimm_bus_descriptor) -> c_int {
...
// block all non-nfit bus commands
    ...
    {
    struct device *dev = acpi_desc.dev;
    let mut scheduled: c_int = 0, busy = 0;
    struct nfit_spa *nfit_spa;
    mutex_lock(&acpi_desc.init_mutex);
    if (test_bit(ARS_CANCEL, &acpi_desc.scrub_flags)) {
    mutex_unlock(&acpi_desc.init_mutex);
...
#[no_mangle]
pub unsafe extern "C" fn acpi_nfit_desc_init(acpi_desc: *mut acpi_nfit_desc, dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_put_table(table: *mut c_void) {
    static void acpi_nfit_put_table(void *table)
    {
    acpi_put_table(table);
    }
#[no_mangle]
unsafe extern "C" fn acpi_nfit_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_nfit_shutdown(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_probe(pdev: *mut platform_device) -> c_int {
...
// Evaluate _FIT and override with that if present
    status = acpi_evaluate_object(adev.handle, "_FIT", core::ptr::null_mut(), &buf);
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_remove(pdev: *mut platform_device) {
    static void acpi_nfit_remove(struct platform_device *pdev)
    {
    struct acpi_device *adev = ACPI_COMPANION(&pdev.dev);
    guard(mutex)(&acpi_notify_lock);
// Make notify handlers bail out early going forward.
    dev_set_drvdata(&adev.dev, core::ptr::null_mut());
    acpi_nfit_shutdown(platform_get_drvdata(pdev));
    }
#[no_mangle]
unsafe extern "C" fn acpi_nfit_update_notify(dev: *mut device, handle: acpi_handle) {
...
// Evaluate _FIT
    status = acpi_evaluate_object(handle, "_FIT", core::ptr::null_mut(), &buf);
    if (ACPI_FAILURE(status)) {
...
#[no_mangle]
unsafe extern "C" fn acpi_nfit_uc_error_notify(dev: *mut device, handle: acpi_handle) {
...
#[no_mangle]
pub unsafe extern "C" fn __acpi_nfit_notify(dev: *mut device, handle: acpi_handle, event: u32) {
...
#[no_mangle]
unsafe extern "C" fn nfit_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn nfit_exit() -> __exit void {
