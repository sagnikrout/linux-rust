...
//! Source: drivers/acpi/acpica/psparse.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ps_get_opcode_size(opcode: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ps_peek_opcode(parser_state: *mut *mut acpi_parse_state) -> u16 {
...
//
    ...
    union acpi_parse_object *replacement_op = core::ptr::null_mut();
...
//
    ...
    let mut status: acpi_status = AE_CTRL_PENDING;
    u8 *aml;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ps_parse_aml(walk_state: *mut acpi_walk_state) -> acpi_status {
...
// Either the method parse or actual execution failed
    ...
    walk_state.method_node, core::ptr::null_mut(),
    status);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: previous_walk_state->caller_return_desc) -> else {
