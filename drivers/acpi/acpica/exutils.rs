...
//! Source: drivers/acpi/acpica/exutils.c
#![no_std]
...
// header files.
//
// Macro flag: #define DEFINE_AML_GLOBALS
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_enter_interpreter() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_exit_interpreter() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_truncate_for32bit_table(obj_desc: *mut union acpi_operand_object) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_acquire_global_lock(field_flags: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_release_global_lock(field_flags: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ex_digits_needed(value: u64, base: u32) -> u32 {
    static u32 acpi_ex_digits_needed(u64 value, u32 base)
    {
    u32 num_digits;
    u64 current_value;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_eisa_id_to_string(out_string: *mut c_char, compressed_id: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_integer_to_string(out_string: *mut c_char, value: u64) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_pci_cls_to_string(out_string: *mut c_char, class_code[3]: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_is_valid_space_id(space_id: u8) -> u8 {
