...
//! Source: drivers/acpi/acpica/evxface.c
#![no_std]
...
// Root Object. Global handlers are removed here
    ...
    acpi_gbl_global_notify[i].handler = core::ptr::null_mut();
    acpi_gbl_global_notify[i].context = core::ptr::null_mut();
    (void)acpi_ut_release_mutex(ACPI_MTX_NAMESPACE);
...
// Internal object exists. Find the handler and remove it
    ...
    handler_obj = obj_desc.common_notify.notify_list[i];
    previous_handler_obj = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn acpi_install_exception_handler(handler: acpi_exception_handler) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_install_sci_handler(address: acpi_sci_handler, context: *mut c_void) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_remove_sci_handler(address: acpi_sci_handler) -> acpi_status {
...
// Remove the SCI handler with lock
    flags = acpi_os_acquire_lock(acpi_gbl_gpe_lock);
    prev_sci_handler = core::ptr::null_mut();
...
// Remove the handler
    acpi_gbl_fixed_event_handlers[event].handler = core::ptr::null_mut();
    acpi_gbl_fixed_event_handlers[event].context = core::ptr::null_mut();
    } else {
    ACPI_DEBUG_PRINT((ACPI_DB_INFO,
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_acquire_global_lock(timeout: u16, handle: *mut u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_release_global_lock(handle: u32) -> acpi_status {
