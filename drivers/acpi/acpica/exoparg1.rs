...
//! Source: drivers/acpi/acpica/exoparg1.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_opcode_0A_0T_1R(walk_state: *mut acpi_walk_state) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_opcode_1A_0T_0R(walk_state: *mut acpi_walk_state) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_opcode_1A_1T_1R(walk_state: *mut acpi_walk_state) -> acpi_status {
...
//
    ...
    walk_state.operands[0] = core::ptr::null_mut();	/* Prevent deletion */
    }
    return_ACPI_STATUS(status);
//
// ACPI 2.0 Opcodes
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !walk_state->result_obj) -> else {
    walk_state.result_obj = return_desc;
    }
    return_ACPI_STATUS(status);
    }
