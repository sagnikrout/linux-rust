...
//! Source: drivers/acpi/acpica/rscalc.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn acpi_rs_count_set_bits(bit_field: u16) -> u8 {
    static u8 acpi_rs_count_set_bits(u16 bit_field)
    {
    u8 bits_set;
    ACPI_FUNCTION_ENTRY();
...
// Validate the Resource Type and Resource Length
    status =
    acpi_ut_validate_resource(core::ptr::null_mut(), aml_buffer,
    &resource_index);
...
//
    ...
    let mut temp_size_needed: acpi_size = 0;
