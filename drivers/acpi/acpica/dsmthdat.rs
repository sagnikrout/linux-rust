...
//! Source: drivers/acpi/acpica/dsmthdat.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_method_data_init(walk_state: *mut acpi_walk_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_method_data_delete_all(walk_state: *mut acpi_walk_state) {
