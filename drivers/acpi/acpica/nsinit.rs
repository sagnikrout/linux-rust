...
//! Source: drivers/acpi/acpica/nsinit.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_initialize_objects() -> acpi_status {
...
//
    ...
    core::ptr::null_mut(), &info, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_initialize_devices(flags: u32) -> acpi_status {
...
// Tree analysis: find all subtrees that contain _INI methods
    ...
    acpi_ns_find_ini_methods, core::ptr::null_mut(),
...
// Walk namespace to execute all _INIs on present devices
    status = acpi_ns_walk_namespace(ACPI_TYPE_ANY, ACPI_ROOT_OBJECT,
    ACPI_UINT32_MAX, FALSE,
    acpi_ns_init_one_device, core::ptr::null_mut(),
    &info, core::ptr::null_mut());
//
...
// Exit if package is already initialized
    ...
    status =
    acpi_ut_walk_package_tree(obj_desc, core::ptr::null_mut(),
    acpi_ds_init_package_element, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
    return (AE_OK);
    }
...
// Complete the initialization/resolution of the package object
    info.package_init++;
    status =
    acpi_ns_init_one_package(obj_handle, level, core::ptr::null_mut(), core::ptr::null_mut());
    break;
    default:
