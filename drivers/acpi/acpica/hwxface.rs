...
//! Source: drivers/acpi/acpica/hwxface.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_reset() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_read(return_value: *mut u64, reg: *mut acpi_generic_address) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_write(value: u64, reg: *mut acpi_generic_address) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_read_bit_register(register_id: u32, return_value: *mut u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_write_bit_register(register_id: u32, value: u32) -> acpi_status {
