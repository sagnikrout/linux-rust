...
//! Source: drivers/acpi/acpica/nsxfname.c
#![no_std]
...
//
    ...
    struct acpi_namespace_node *prefix_node = core::ptr::null_mut();
    ACPI_FUNCTION_ENTRY();
...
//
    ...
    struct acpi_pnp_device_id *hid = core::ptr::null_mut();
    struct acpi_pnp_device_id *uid = core::ptr::null_mut();
    struct acpi_pnp_device_id *cls = core::ptr::null_mut();
    char *next_id_string;
...
// The lookup either returns an existing node or creates a new one
    status =
    acpi_ns_lookup(core::ptr::null_mut(), path, ACPI_TYPE_METHOD, ACPI_IMODE_LOAD_PASS1,
