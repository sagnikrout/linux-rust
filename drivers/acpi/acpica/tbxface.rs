...
//! Source: drivers/acpi/acpica/tbxface.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_allocate_root_table(initial_table_count: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_reallocate_root_table() -> acpi_status ACPI_INIT_FUNCTION {
...
//
    ...
    status =
    acpi_tb_verify_temp_table(table_desc, core::ptr::null_mut(),
    &j);
    if (ACPI_FAILURE(status)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_put_table(table: *mut acpi_table_header) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_remove_table_handler(handler: acpi_table_handler) -> acpi_status {
