...
//! Source: drivers/acpi/acpica/dswstate.c
#![no_std]
...
// object = state->results.obj_desc[index];
    ...
    state.results.obj_desc[index] = core::ptr::null_mut();
    if (index == 0) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ds_result_stack_push(walk_state: *mut acpi_walk_state) -> acpi_status {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ds_result_stack_pop(walk_state: *mut acpi_walk_state) -> acpi_status {
    static acpi_status acpi_ds_result_stack_pop(struct acpi_walk_state *walk_state)
    {
    union acpi_generic_state *state;
    ACPI_FUNCTION_NAME(ds_result_stack_pop);
// Check for stack underflow
    if (walk_state.results == core::ptr::null_mut()) {
    ACPI_DEBUG_PRINT((ACPI_DB_EXEC,
...
// Just set the stack entry to null
    walk_state.num_operands--;
    walk_state.operands[walk_state.num_operands] = core::ptr::null_mut();
    }
...
// The next_op of the next_walk will be the beginning of the method
    walk_state.next_op = core::ptr::null_mut();
...
//
    ...
    if (!extra_op) {
    parser_state.start_node = core::ptr::null_mut();
    } else {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_delete_walk_state(walk_state: *mut acpi_walk_state) {
