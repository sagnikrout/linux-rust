...
//! Source: drivers/acpi/acpica/utdelete.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ut_delete_internal_obj(object: *mut union acpi_operand_object) {
    static void acpi_ut_delete_internal_obj(union acpi_operand_object *object)
    {
    void *obj_pointer = core::ptr::null_mut();
...
// Delete the method mutex if it exists
    ...
    object.method.mutex = core::ptr::null_mut();
    }
    if (object.method.node) {
    object.method.node = core::ptr::null_mut();
    }
    break;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_delete_internal_object_list(obj_list: *mut union acpi_operand_object) {
...
//
    ...
    union acpi_generic_state *state_list = core::ptr::null_mut();
    union acpi_operand_object *next_object = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_add_reference(object: *mut union acpi_operand_object) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_remove_reference(object: *mut union acpi_operand_object) {
