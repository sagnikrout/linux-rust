...
//! Source: drivers/acpi/acpica/nspredef.c
#![no_std]
...
//
// Macro flag: #define ACPI_CREATE_PREDEFINED_TABLE
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ns_get_bitmapped_type(return_object: *mut union acpi_operand_object) -> u32 {
    static u32 acpi_ns_get_bitmapped_type(union acpi_operand_object *return_object)
    {
    u32 return_btype;
    if (!return_object) {
