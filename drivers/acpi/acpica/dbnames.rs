...
//! Source: drivers/acpi/acpica/dbnames.c
#![no_std]
...
//
    ...
    {"RESOURCEFIELD"},
    {"SCOPES"},
    {core::ptr::null_mut()}			/* Must be null terminated */
    };
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_set_scope(name: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_dump_namespace(start_arg: *mut c_char, depth_arg: *mut c_char) {
    void acpi_db_dump_namespace(char *start_arg, char *depth_arg)
    {
    let mut subtree_entry: acpi_handle = acpi_gbl_root_node;
    let mut max_depth: u32 = ACPI_UINT32_MAX;
...
// Now we can check for the depth argument
    if (depth_arg) {
    max_depth = strtoul(depth_arg, core::ptr::null_mut(), 0);
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_dump_namespace_paths() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_dump_namespace_by_owner(owner_arg: *mut c_char, depth_arg: *mut c_char) {
    void acpi_db_dump_namespace_by_owner(char *owner_arg, char *depth_arg)
    {
    let mut subtree_entry: acpi_handle = acpi_gbl_root_node;
    let mut max_depth: u32 = ACPI_UINT32_MAX;
    acpi_owner_id owner_id;
    owner_id = (acpi_owner_id)strtoul(owner_arg, core::ptr::null_mut(), 0);
// Now we can check for the depth argument
    if (depth_arg) {
    max_depth = strtoul(depth_arg, core::ptr::null_mut(), 0);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_find_name_in_namespace(name_arg: *mut c_char) -> acpi_status {
...
// Walk the namespace from the root
    ...
    core::ptr::null_mut(), acpi_name, core::ptr::null_mut());
    acpi_db_set_output_destination(ACPI_DB_CONSOLE_OUTPUT);
    return (AE_OK);
    }
//
...
//
    ...
    const union acpi_predefined_info *package = core::ptr::null_mut();
    char *pathname;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_check_predefined_names() {
...
// Search all nodes in namespace
    (void)acpi_walk_namespace(ACPI_TYPE_ANY, ACPI_ROOT_OBJECT,
    ACPI_UINT32_MAX,
    acpi_db_walk_for_predefined_names, core::ptr::null_mut(),
    (void *)&count, core::ptr::null_mut());
...
// Get and display the full pathname to this object
    ...
    ACPI_FREE(buffer.pointer);
    buffer.length = ACPI_ALLOCATE_LOCAL_BUFFER;
    status = acpi_evaluate_object(obj_handle, core::ptr::null_mut(), core::ptr::null_mut(), &buffer);
    if (ACPI_FAILURE(status)) {
...
// Dump short info about the object
    (void)acpi_ns_dump_one_object(obj_handle, nesting_level, info, core::ptr::null_mut());
    return (AE_OK);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_objects(obj_type_arg: *mut c_char, display_count_arg: *mut c_char) -> acpi_status {
...
// Walk the namespace from the root
    (void)acpi_walk_namespace(ACPI_TYPE_ANY, ACPI_ROOT_OBJECT,
    ACPI_UINT32_MAX,
    acpi_db_walk_for_object_counts, core::ptr::null_mut(),
    (void *)object_info, core::ptr::null_mut());
...
// Walk the namespace from the root
    ...
    acpi_db_walk_for_specific_objects, core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_fields(address_space_id: u32) -> acpi_status {
...
// Walk the namespace from the root
    ...
    acpi_db_walk_for_fields, core::ptr::null_mut(), (void *)&info,
    core::ptr::null_mut());
    return (AE_OK);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_check_integrity() {
    void acpi_db_check_integrity(void)
    {
    let mut info: acpi_integrity_info = { 0, 0 };
// Search all nodes in namespace
    (void)acpi_walk_namespace(ACPI_TYPE_ANY, ACPI_ROOT_OBJECT,
    ACPI_UINT32_MAX, acpi_db_integrity_walk, core::ptr::null_mut(),
    (void *)&info, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_find_references(object_arg: *mut c_char) {
    void acpi_db_find_references(char *object_arg)
    {
    union acpi_operand_object *obj_desc;
    acpi_size address;
// Convert string to object pointer
    address = strtoul(object_arg, core::ptr::null_mut(), 16);
    obj_desc = ACPI_TO_POINTER(address);
// Search all nodes in namespace
    (void)acpi_walk_namespace(ACPI_TYPE_ANY, ACPI_ROOT_OBJECT,
    ACPI_UINT32_MAX, acpi_db_walk_for_references,
    core::ptr::null_mut(), (void *)obj_desc, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_get_bus_info() {
    void acpi_db_get_bus_info(void)
    {
// Search all nodes in namespace
    (void)acpi_walk_namespace(ACPI_TYPE_ANY, ACPI_ROOT_OBJECT,
    ACPI_UINT32_MAX, acpi_db_bus_walk, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut());
    }
