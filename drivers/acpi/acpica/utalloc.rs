...
//! Source: drivers/acpi/acpica/utalloc.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_create_caches() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_delete_caches() -> acpi_status {
    ...
    acpi_gbl_namespace_cache = core::ptr::null_mut();
    (void)acpi_os_delete_cache(acpi_gbl_state_cache);
    acpi_gbl_state_cache = core::ptr::null_mut();
    (void)acpi_os_delete_cache(acpi_gbl_operand_cache);
    acpi_gbl_operand_cache = core::ptr::null_mut();
    (void)acpi_os_delete_cache(acpi_gbl_ps_node_cache);
    acpi_gbl_ps_node_cache = core::ptr::null_mut();
    (void)acpi_os_delete_cache(acpi_gbl_ps_node_ext_cache);
    acpi_gbl_ps_node_ext_cache = core::ptr::null_mut();

    (void)acpi_os_delete_cache(acpi_gbl_reg_comment_cache);
    acpi_gbl_reg_comment_cache = core::ptr::null_mut();
    (void)acpi_os_delete_cache(acpi_gbl_comment_addr_cache);
    acpi_gbl_comment_addr_cache = core::ptr::null_mut();
    (void)acpi_os_delete_cache(acpi_gbl_file_cache);
    acpi_gbl_file_cache = core::ptr::null_mut();

// Debug only - display leftover memory allocation, if any
    acpi_ut_dump_allocations(ACPI_UINT32_MAX, core::ptr::null_mut());
// Free memory lists
    acpi_os_free(acpi_gbl_global_list);
    acpi_gbl_global_list = core::ptr::null_mut();
    acpi_os_free(acpi_gbl_ns_node_list);
    acpi_gbl_ns_node_list = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_validate_buffer(buffer: *mut acpi_buffer) -> acpi_status {
