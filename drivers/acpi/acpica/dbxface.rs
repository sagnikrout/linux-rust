...
//! Source: drivers/acpi/acpica/dbxface.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_signal_break_point(walk_state: *mut acpi_walk_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_initialize_debugger() -> acpi_status {
...
// Create the debug execution thread to execute commands
    ...
    acpi_db_execute_thread, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
    ACPI_EXCEPTION((AE_INFO, status,
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_terminate_debugger() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_set_debugger_thread_id(thread_id: acpi_thread_id) {
