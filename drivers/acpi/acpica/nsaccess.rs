...
//! Source: drivers/acpi/acpica/nsaccess.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_root_initialize() -> acpi_status {
    acpi_status acpi_ns_root_initialize(void)
    {
    acpi_status status;
    const struct acpi_predefined_names *init_val = core::ptr::null_mut();
    struct acpi_namespace_node *new_node;
    struct acpi_namespace_node *prev_node = core::ptr::null_mut();
...
// Save a handle to "_GPE", it is always present
    ...
    status = acpi_ns_get_node(core::ptr::null_mut(), "\\_GPE", ACPI_NS_NO_UPSEARCH,
...
//
    ...
    struct acpi_namespace_node *current_node = core::ptr::null_mut();
    struct acpi_namespace_node *this_node = core::ptr::null_mut();
    u32 num_segments;
    u32 num_carats;
    acpi_name simple_name;
    acpi_object_type type_to_check_for;
    acpi_object_type this_search_type;
    let mut search_parent_flag: u32 = ACPI_NS_SEARCH_PARENT;
    u32 local_flags;
...
//
    ...
    (ACPI_UINT32_MAX, pathname, core::ptr::null_mut(),
    &external_path);
    if (ACPI_SUCCESS(status)) {
    ACPI_ERROR((AE_INFO,
