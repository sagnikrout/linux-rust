...
//! Source: drivers/acpi/acpica/dsopcode.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_initialize_region(obj_handle: acpi_handle) -> acpi_status {
...
// All other, create_xxx_field opcodes
    ...
    acpi_ds_init_buffer_field(op.common.aml_opcode, obj_desc,
    walk_state.operands[0],
    walk_state.operands[1], core::ptr::null_mut(),
    walk_state.operands[2]);
    }
    return_ACPI_STATUS(status);
    }
