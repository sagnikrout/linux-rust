...
//! Source: drivers/acpi/acpica/nsxfobj.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_get_type(handle: acpi_handle, ret_type: *mut acpi_object_type) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_get_parent(handle: acpi_handle, ret_handle: *mut acpi_handle) -> acpi_status {
...
//
    ...
    acpi_status status;
    struct acpi_namespace_node *node;
    struct acpi_namespace_node *parent_node = core::ptr::null_mut();
