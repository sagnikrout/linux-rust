...
//! Source: drivers/acpi/acpica/utstrtoul64.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_strtoul64(string: *mut c_char, return_value: *mut u64) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn if(_arg: acpi_ut_detect_octal_prefix(&string)) -> else {
    base = 8;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_implicit_strtoul64(string: *mut c_char) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_explicit_strtoul64(string: *mut c_char) -> u64 {
