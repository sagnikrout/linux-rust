...
//! Source: drivers/acpi/acpica/dsdebug.c
#![no_std]
...
//
    ...
    if (!node) {
    ACPI_DEBUG_PRINT_RAW((ACPI_DB_DISPATCH, "[core::ptr::null_mut() NAME]"));
    return_VOID;
    }
...
//
    ...
    struct acpi_namespace_node *previous_method = core::ptr::null_mut();
...
// Display exception and method name
    ...
    acpi_ds_print_node_pathname(walk_state.method_node, core::ptr::null_mut());
...
//
    ACPI_DEBUG_PRINT_RAW((ACPI_DB_DISPATCH,
    "Call to method "));
    acpi_ds_print_node_pathname(previous_method, core::ptr::null_mut());
    }
