...
//! Source: drivers/acpi/acpica/evregion.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_initialize_op_regions() -> acpi_status {
...
//
    ...
    void *region_context = core::ptr::null_mut();
...
// last_obj_ptr = obj_desc->region.next;
    obj_desc.region.next = core::ptr::null_mut();	/* Must clear field */
...
// region's handler
//
    region_obj.region.handler = core::ptr::null_mut();
...
//
    ...
    if (region_obj2.extra.method_REG == core::ptr::null_mut()) {
    return_ACPI_STATUS(AE_OK);
    }
...
// Allocate and initialize the evaluation information block
    ...
    info.relative_pathname = core::ptr::null_mut();
...
//
    ...
    args[2] = core::ptr::null_mut();		/* Terminate list */
// Execute the method, no return value
    ACPI_DEBUG_EXEC(acpi_ut_display_init_pathname
    (ACPI_TYPE_METHOD, info.prefix_node, core::ptr::null_mut()));
...
//
    ...
    ACPI_NS_WALK_UNLOCK, acpi_ev_reg_run, core::ptr::null_mut(),
...
//
    next_node = acpi_ns_get_next_node(device_node, core::ptr::null_mut());
    while (next_node) {
...
// Evaluate the _REG(space_id,Connect) method
    ...
    (void)acpi_evaluate_object(reg_method, core::ptr::null_mut(), &args, core::ptr::null_mut());
    exit:
