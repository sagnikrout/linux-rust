...
//! Source: drivers/acpi/acpica/rscreate.c
#![no_std]
...
// Perform the AML-to-Resource conversion
    status = acpi_ut_walk_aml_resources(core::ptr::null_mut(), aml_buffer, aml_buffer_length,
...
// Do the conversion
    ...
    status = acpi_ut_walk_aml_resources(core::ptr::null_mut(), aml_start, aml_buffer_length,
    acpi_rs_convert_aml_to_resources,
    &resource);
    if (ACPI_FAILURE(status)) {
    return_ACPI_STATUS(status);
