...
//! Source: drivers/acpi/acpica/evrgnini.c
#![no_std]
...
// Install a handler for this PCI root bridge
    status = acpi_install_address_space_handler((acpi_handle)pci_root_node, ACPI_ADR_SPACE_PCI_CONFIG, ACPI_DEFAULT_HANDLER, core::ptr::null_mut(), core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_is_pci_root_bridge(node: *mut acpi_namespace_node) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_initialize_region(region_obj: *mut union acpi_operand_object) -> acpi_status {
