...
//! Source: drivers/acpi/acpica/psopcode.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn objects(flag: AML_NSOBJECT) -> Opcodes that have associated namespace {
    ...
    AML_INT_NAMEDFIELD_OP
#[no_mangle]
pub unsafe extern "C" fn node(flag: AML_NSNODE) -> Opcodes that have an associated namespace {
    ...
    AML_INT_NAMEPATH_OP
#[no_mangle]
pub unsafe extern "C" fn objects(flag: AML_NAMED) -> Opcodes that define named ACPI {
