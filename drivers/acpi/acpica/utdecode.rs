...
//! Source: drivers/acpi/acpica/utdecode.c
#![no_std]
...
// 30 */ "Invalid"
    ...
    return_STR("[core::ptr::null_mut() Object Descriptor]");
    }
...
// 15 */ "Namespace Node"
    ...
    {
    if (!object) {
    return ("core::ptr::null_mut() OBJECT");
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_valid_object_type(type: acpi_object_type) -> u8 {
