...
//! Source: drivers/acpi/acpica/evgpeinit.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_gpe_initialize() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_update_gpes(table_owner_id: acpi_owner_id) {
...
// Walk all Gpe Blocks attached to this interrupt level
    ...
    core::ptr::null_mut(), &walk_info, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
    ACPI_EXCEPTION((AE_INFO, status,
