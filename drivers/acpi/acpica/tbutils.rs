...
//! Source: drivers/acpi/acpica/tbutils.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_initialize_facs() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_check_dsdt_header() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_put_table(table_desc: *mut acpi_table_desc) {
