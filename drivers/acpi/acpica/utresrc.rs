...
//! Source: drivers/acpi/acpica/utresrc.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_get_resource_type(aml: *mut c_void) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_get_resource_length(aml: *mut c_void) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_get_resource_header_length(aml: *mut c_void) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_get_descriptor_length(aml: *mut c_void) -> u32 {
...
// Validate the template and get a pointer to the end_tag
    status = acpi_ut_walk_aml_resources(core::ptr::null_mut(), obj_desc.buffer.pointer,
    obj_desc.buffer.length, core::ptr::null_mut(),
    (void **)end_tag);
    return_ACPI_STATUS(status);
    }
