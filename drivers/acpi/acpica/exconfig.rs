...
//! Source: drivers/acpi/acpica/exconfig.c
#![no_std]
...
//
    ...
    struct acpi_namespace_node *parameter_node = core::ptr::null_mut();
...
// Bytewise reads
    for (i = 0; i < length; i++) {
    status =
    acpi_ev_address_space_dispatch(obj_desc, core::ptr::null_mut(), ACPI_READ,
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_unload_table(ddb_handle: *mut union acpi_operand_object) -> acpi_status {
