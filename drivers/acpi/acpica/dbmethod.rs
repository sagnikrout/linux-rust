...
//! Source: drivers/acpi/acpica/dbmethod.c
#![no_std]
...
// Get and verify the breakpoint address
    address = strtoul(location, core::ptr::null_mut(), 16);
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_set_method_call_breakpoint(op: *mut union acpi_parse_object) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_set_method_data(type_arg: *mut c_char, index_arg: *mut c_char, value_arg: *mut c_char) {
...
// Validate type_arg
    ...
    value = strtoul(value_arg, core::ptr::null_mut(), 16);
    if (type == 'N') {
...
// Get the index and value
    index = strtoul(index_arg, core::ptr::null_mut(), 16);
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_disassemble_aml(statements: *mut c_char, op: *mut union acpi_parse_object) {
    ...
    if (statements) {
    num_statements = strtoul(statements, core::ptr::null_mut(), 0);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_disassemble_method(name: *mut c_char) -> acpi_status {
...
// Create and initialize a new walk state
    walk_state = acpi_ds_create_walk_state(0, op, core::ptr::null_mut(), core::ptr::null_mut());
    if (!walk_state) {
    return (AE_NO_MEMORY);
    }
    status = acpi_ds_init_aml_walk(walk_state, op, core::ptr::null_mut(),
    obj_desc.method.aml_start,
    obj_desc.method.aml_length, core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_evaluate_object(node: *mut acpi_namespace_node) -> acpi_status {
    static acpi_status acpi_db_evaluate_object(struct acpi_namespace_node *node)
    {
    char *pathname;
    u32 i;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_evaluate_predefined_names() {
...
// Search all nodes in namespace
    ...
    core::ptr::null_mut(), (void *)&info, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_evaluate_all(name_seg: *mut c_char) {
