...
//! Source: drivers/acpi/acpica/hwgpe.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_gpe_read(value: *mut u64, reg: *mut acpi_gpe_address) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_gpe_write(value: u64, reg: *mut acpi_gpe_address) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_get_gpe_register_bit(gpe_event_info: *mut acpi_gpe_event_info) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_clear_gpe(gpe_event_info: *mut acpi_gpe_event_info) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_disable_all_gpes() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_enable_all_runtime_gpes() -> acpi_status {
    acpi_status acpi_hw_enable_all_runtime_gpes(void)
    {
    acpi_status status;
    ACPI_FUNCTION_TRACE(hw_enable_all_runtime_gpes);
    status = acpi_ev_walk_gpe_list(acpi_hw_enable_runtime_gpe_block, core::ptr::null_mut());
    return_ACPI_STATUS(status);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_enable_all_wakeup_gpes() -> acpi_status {
    acpi_status acpi_hw_enable_all_wakeup_gpes(void)
    {
    acpi_status status;
    ACPI_FUNCTION_TRACE(hw_enable_all_wakeup_gpes);
    status = acpi_ev_walk_gpe_list(acpi_hw_enable_wakeup_gpe_block, core::ptr::null_mut());
    return_ACPI_STATUS(status);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_check_all_gpes(gpe_skip_device: acpi_handle, gpe_skip_number: u32) -> u8 {
