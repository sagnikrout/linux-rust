...
//! Source: drivers/acpi/acpica/tbinstal.c
#![no_std]
...
//
    ...
    u32 i;
    acpi_status status;
    status = acpi_tb_get_next_table_descriptor(&i, core::ptr::null_mut());
...
// Validate and verify a table before installation
    status = acpi_tb_verify_temp_table(&new_table_desc, core::ptr::null_mut(), &i);
    if (ACPI_FAILURE(status)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_override_table(old_table_desc: *mut acpi_table_desc) {
...
//
    status = acpi_tb_verify_temp_table(&new_table_desc, core::ptr::null_mut(), core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
    return;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_uninstall_table(table_desc: *mut acpi_table_desc) {
