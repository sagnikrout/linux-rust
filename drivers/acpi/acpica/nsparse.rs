...
//! Source: drivers/acpi/acpica/nsparse.c
#![no_std]
...
//
    ...
    struct acpi_evaluate_info *info = core::ptr::null_mut();
    u32 aml_length;
    u8 *aml_start;
    union acpi_operand_object *method_obj = core::ptr::null_mut();
...
// Create and initialize a new walk state
    ...
    status = acpi_ds_init_aml_walk(walk_state, parse_root, core::ptr::null_mut(),
    aml_start, aml_length, core::ptr::null_mut(),
    (u8)pass_number);
    if (ACPI_FAILURE(status)) {
