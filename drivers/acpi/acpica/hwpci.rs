...
//! Source: drivers/acpi/acpica/hwpci.c
#![no_std]
...
pub const PCI_CFG_HEADER_TYPE_REG: c_uint = 0x0E;
pub const PCI_CFG_PRIMARY_BUS_NUMBER_REG: c_uint = 0x18;
pub const PCI_CFG_SECONDARY_BUS_NUMBER_REG: c_uint = 0x19;
// PCI header values
pub const PCI_HEADER_TYPE_MASK: c_uint = 0x7F;
pub const PCI_TYPE_BRIDGE: c_uint = 0x01;
pub const PCI_TYPE_CARDBUS_BRIDGE: c_uint = 0x02;
...
//
#[no_mangle]
unsafe extern "C" fn acpi_hw_delete_pci_list(list_head: *mut acpi_pci_device) {
    static void acpi_hw_delete_pci_list(struct acpi_pci_device *list_head)
    {
    struct acpi_pci_device *next;
