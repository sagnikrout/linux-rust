...
//! Source: drivers/acpi/acpica/exoparg3.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_opcode_3A_0T_0R(walk_state: *mut acpi_walk_state) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_opcode_3A_1T_1R(walk_state: *mut acpi_walk_state) -> acpi_status {
