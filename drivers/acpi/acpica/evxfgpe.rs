...
//! Source: drivers/acpi/acpica/evxfgpe.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_update_all_gpes() -> acpi_status {
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_GPE_DISPATCH_TYPE(gpe_event_info->flags): dispatch_type !=) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_enable_gpe(gpe_device: acpi_handle, gpe_number: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_disable_gpe(gpe_device: acpi_handle, gpe_number: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_set_gpe(gpe_device: acpi_handle, gpe_number: u32, action: u8) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_mask_gpe(gpe_device: acpi_handle, gpe_number: u32, is_masked: u8) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_mark_gpe_for_wake(gpe_device: acpi_handle, gpe_number: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_clear_gpe(gpe_device: acpi_handle, gpe_number: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_dispatch_gpe(gpe_device: acpi_handle, gpe_number: u32) -> u32 {
    u32 acpi_dispatch_gpe(acpi_handle gpe_device, u32 gpe_number)
    {
    ACPI_FUNCTION_TRACE(acpi_dispatch_gpe);
    return acpi_ev_detect_gpe(gpe_device, core::ptr::null_mut(), gpe_number);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_finish_gpe(gpe_device: acpi_handle, gpe_number: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_disable_all_gpes() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_enable_all_runtime_gpes() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_enable_all_wakeup_gpes() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_any_gpe_status_set(gpe_skip_number: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_remove_gpe_block(gpe_device: acpi_handle) -> acpi_status {
...
// Delete the GPE block (but not the device_object)
    ...
    if (ACPI_SUCCESS(status)) {
    obj_desc.device.gpe_block = core::ptr::null_mut();
    }
    unlock_and_exit:
    (void)acpi_ut_release_mutex(ACPI_MTX_NAMESPACE);
    return_ACPI_STATUS(status);
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_get_gpe_device(index: u32, gpe_device: *mut acpi_handle) -> acpi_status {
...
// Setup and walk the GPE list
    ...
    info.gpe_device = core::ptr::null_mut();
