...
//! Source: drivers/acpi/acpica/uttrack.c
#![no_std]
...
//
    ...
    if (core::ptr::null_mut() == allocation) {
    ACPI_ERROR((module, line, "Attempt to delete a core::ptr::null_mut() address"));
    return_VOID;
    }
...
//
    ...
    mem_list = acpi_gbl_global_list;
    if (core::ptr::null_mut() == mem_list.list_head) {
// No allocations!
    ACPI_ERROR((module, line,
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_dump_allocation_info() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_dump_allocations(component: u32, module: *const c_char) {
