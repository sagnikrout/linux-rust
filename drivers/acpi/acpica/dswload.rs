...
//! Source: drivers/acpi/acpica/dswload.c
#![no_std]
...
// Parse only - caller will setup callbacks
    ...
    walk_state.descending_callback = core::ptr::null_mut();
    walk_state.ascending_callback = core::ptr::null_mut();
    break;
    case 1:
// Load pass 1
    walk_state.parse_flags = ACPI_PARSE_LOAD_PASS1 |
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_load1_end_op(walk_state: *mut acpi_walk_state) -> acpi_status {
