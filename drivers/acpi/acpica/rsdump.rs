...
//! Source: drivers/acpi/acpica/rsdump.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_rs_dump_resource_list(resource_list: *mut acpi_resource) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_rs_dump_irq_list(route_table: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_rs_dump_address_common(resource: *mut union acpi_resource_data) {
    static void acpi_rs_dump_address_common(union acpi_resource_data *resource)
    {
    ACPI_FUNCTION_ENTRY();
...
//
#[no_mangle]
unsafe extern "C" fn acpi_rs_out_string(title: *const c_char, value: *const c_char) {
    static void acpi_rs_out_string(const char *title, const char *value)
    {
    acpi_os_printf("%27s : %s", title, value);
    if (!*value) {
    acpi_os_printf("[core::ptr::null_mut() NAMESTRING]");
    }
    acpi_os_printf("\n");
    }
#[no_mangle]
unsafe extern "C" fn acpi_rs_out_integer8(title: *const c_char, value: u8) {
    static void acpi_rs_out_integer8(const char *title, u8 value)
    {
    acpi_os_printf("%27s : %2.2X\n", title, value);
    }
#[no_mangle]
unsafe extern "C" fn acpi_rs_out_integer16(title: *const c_char, value: u16) {
    static void acpi_rs_out_integer16(const char *title, u16 value)
    {
    acpi_os_printf("%27s : %4.4X\n", title, value);
    }
#[no_mangle]
unsafe extern "C" fn acpi_rs_out_integer32(title: *const c_char, value: u32) {
    static void acpi_rs_out_integer32(const char *title, u32 value)
    {
    acpi_os_printf("%27s : %8.8X\n", title, value);
    }
#[no_mangle]
unsafe extern "C" fn acpi_rs_out_integer64(title: *const c_char, value: u64) {
    static void acpi_rs_out_integer64(const char *title, u64 value)
    {
    acpi_os_printf("%27s : %8.8X%8.8X\n", title, ACPI_FORMAT_UINT64(value));
    }
#[no_mangle]
unsafe extern "C" fn acpi_rs_out_title(title: *const c_char) {
    static void acpi_rs_out_title(const char *title)
    {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_rs_dump_byte_list(length: u16, data: *mut *mut u8) {
    static void acpi_rs_dump_byte_list(u16 length, u8 * data)
    {
    u16 i;
    for (i = 0; i < length; i++) {
...
#[no_mangle]
unsafe extern "C" fn acpi_rs_dump_short_byte_list(length: u8, data: *mut *mut u8) {
    static void acpi_rs_dump_short_byte_list(u8 length, u8 * data)
    {
    u8 i;
    for (i = 0; i < length; i++) {
...
#[no_mangle]
unsafe extern "C" fn acpi_rs_dump_dword_list(length: u8, data: *mut *mut u32) {
    static void acpi_rs_dump_dword_list(u8 length, u32 * data)
    {
    u8 i;
    for (i = 0; i < length; i++) {
...
#[no_mangle]
unsafe extern "C" fn acpi_rs_dump_word_list(length: u16, data: *mut u16) {
    static void acpi_rs_dump_word_list(u16 length, u16 *data)
    {
    u16 i;
    for (i = 0; i < length; i++) {
