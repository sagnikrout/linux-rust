...
//! Source: drivers/acpi/acpica/nsrepair2.c
#![no_std]
...
pub const ACPI_SORT_ASCENDING: c_int = 0;
pub const ACPI_SORT_DESCENDING: c_int = 1;
    static void
...
//
    ...
    {{0, 0, 0, 0}, core::ptr::null_mut()}	/* Table terminator */
    };
pub const ACPI_FDE_FIELD_COUNT: c_int = 5;
pub const ACPI_FDE_BYTE_BUFFER_SIZE: c_int = 5;
