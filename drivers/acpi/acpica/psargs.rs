...
//! Source: drivers/acpi/acpica/psargs.c
#![no_std]
...
//
    ...
    u16 opcode;
    u8 *aml = parser_state.aml;
    let mut remaining: u32 = (u32)ACPI_PTR_DIFF(parser_state.aml_end, aml);
    u64 partial_value;
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ps_free_field_list(start: *mut union acpi_parse_object) {
    static void acpi_ps_free_field_list(union acpi_parse_object *start)
    {
...
//
    ...
    {
    union acpi_parse_object *arg = core::ptr::null_mut();
    union acpi_parse_object *prev = core::ptr::null_mut();
    union acpi_parse_object *field;
    u32 subop;
