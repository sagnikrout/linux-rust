...
//! Source: drivers/acpi/acpica/utxfinit.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_initialize_subsystem() -> acpi_status ACPI_INIT_FUNCTION {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_enable_subsystem(flags: u32) -> acpi_status ACPI_INIT_FUNCTION {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_initialize_objects(flags: u32) -> acpi_status ACPI_INIT_FUNCTION {
