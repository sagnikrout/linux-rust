...
//! Source: drivers/acpi/acpica/nsdump.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_print_pathname(num_segments: u32, pathname: *const c_char) {
...
//
    ...
    acpi_ns_dump_one_object, core::ptr::null_mut(),
...
//
    ...
    u32 level, void *context, void **return_value)
    {
    let mut max_level: u32 = *((u32 *)context);
    char *pathname;
...
// Get the max depth of the namespace tree, for formatting later
    ...
    ACPI_NS_WALK_NO_UNLOCK |
    ACPI_NS_WALK_TEMP_NODES,
    acpi_ns_get_max_depth, core::ptr::null_mut(),
    (void *)&max_level, core::ptr::null_mut());
// Now dump the entire namespace
    (void)acpi_ns_walk_namespace(type, start_handle, max_depth,
    ACPI_NS_WALK_NO_UNLOCK |
    ACPI_NS_WALK_TEMP_NODES,
    acpi_ns_dump_one_object_path, core::ptr::null_mut(),
    (void *)&max_level, core::ptr::null_mut());
    (void)acpi_ut_release_mutex(ACPI_MTX_NAMESPACE);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_dump_entry(handle: acpi_handle, debug_level: u32) {
    ...
    (void)acpi_ns_dump_one_object(handle, 1, &info, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_dump_tables(search_base: acpi_handle, max_depth: u32) {
    void acpi_ns_dump_tables(acpi_handle search_base, u32 max_depth)
    {
    let mut search_handle: acpi_handle = search_base;
