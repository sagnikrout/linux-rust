...
//! Source: drivers/acpi/acpica/rsmisc.c
#![no_std]
...
//
    ...
    info.value,
    destination, aml, core::ptr::null_mut());
    break;
...
//
    ...
    struct acpi_rsconvert_info *info)
    {
    void *source = core::ptr::null_mut();
    void *destination;
    char *target;
    let mut aml_length: acpi_rsdesc_size = 0;
    u8 count;
    let mut temp16: u16 = 0;
    let mut item_count: u16 = 0;
