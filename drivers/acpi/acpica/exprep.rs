...
//! Source: drivers/acpi/acpica/exprep.c
#![no_std]
...
//
    ...
    let mut minimum_access_width: u32 = 0xFFFFFFFF;
    let mut minimum_accesses: u32 = 0xFFFFFFFF;
    u32 accesses;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_prep_field_value(info: *mut acpi_create_field_info) -> acpi_status {
    acpi_status acpi_ex_prep_field_value(struct acpi_create_field_info *info)
    {
    union acpi_operand_object *obj_desc;
    union acpi_operand_object *second_desc = core::ptr::null_mut();
    acpi_status status;
    u32 access_byte_width;
    u32 type;
...
// Fields specific to generic_serial_bus fields
    ...
    if (second_desc == core::ptr::null_mut()) {
    break;
    }
