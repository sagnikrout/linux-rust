...
//! Source: drivers/acpi/acpica/tbxfroot.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_get_rsdp_length(rsdp: *mut acpi_table_rsdp) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_validate_rsdp(rsdp: *mut acpi_table_rsdp) -> acpi_status {
