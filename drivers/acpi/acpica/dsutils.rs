...
//! Source: drivers/acpi/acpica/dsutils.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_clear_implicit_return(walk_state: *mut acpi_walk_state) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_resolve_operands(walk_state: *mut acpi_walk_state) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_clear_operands(walk_state: *mut acpi_walk_state) {
...
//
    ...
    let mut index: u32 = walk_state.num_operands;
    let mut prev_num_operands: u32 = walk_state.num_operands;
...
// Get all arguments in the list
    ...
    arguments[index] = arg;
    walk_state.operands[index] = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_evaluate_name_path(walk_state: *mut acpi_walk_state) -> acpi_status {
