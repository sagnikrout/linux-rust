...
//! Source: drivers/acpi/acpica/dbobject.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_decode_internal_object(obj_desc: *mut union acpi_operand_object) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_decode_node(node: *mut acpi_namespace_node) {
    static void acpi_db_decode_node(struct acpi_namespace_node *node)
    {
...
pub unsafe extern "C" fn acpi_db_decode_locals(walk_state: *mut acpi_walk_state) {
    ...
    struct acpi_namespace_node *node;
    let mut display_locals: u8 = FALSE;
    node = walk_state.method_node;
