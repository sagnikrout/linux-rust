...
//! Source: drivers/acpi/acpica/exnames.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ex_name_segment(in_aml_address: *mut *mut *mut u8, name_string: *mut c_char) -> acpi_status {
    static acpi_status acpi_ex_name_segment(u8 ** in_aml_address, char *name_string)
    {
...
//
    ...
    char *name_string = core::ptr::null_mut();
    u32 num_segments;
    let mut prefix_count: u32 = 0;
    let mut has_prefix: u8 = FALSE;
...
// null_name valid as of 8-12-98 ASL/AML Grammar Update
    ...
    "NameSeg is \"\\\" followed by core::ptr::null_mut()\n"));
    }
