...
//! Source: drivers/acpi/acpica/exfield.c
#![no_std]
...
//
pub const ACPI_INVALID_PROTOCOL_ID: c_uint = 0x80;
pub const ACPI_MAX_PROTOCOL_ID: c_uint = 0x0F;
...
pub const PCC_MASTER_SUBSPACE: c_int = 3;
//
