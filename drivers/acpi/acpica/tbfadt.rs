...
pub const ACPI_FADT_OPTIONAL: c_int = 0;
pub const ACPI_FADT_REQUIRED: c_int = 1;
pub const ACPI_FADT_SEPARATE_LENGTH: c_int = 2;
pub const ACPI_FADT_GPE_REGISTER: c_int = 4;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_parse_fadt() {
...
// Obtain the DSDT and FACS tables via their addresses within the FADT
    ...
    core::ptr::null_mut(), FALSE, TRUE, &acpi_gbl_dsdt_index);
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_create_local_fadt(table: *mut acpi_table_header, length: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_tb_convert_fadt() {
    static void acpi_tb_convert_fadt(void)
    {
    const char *name;
...
//
#[no_mangle]
unsafe extern "C" fn acpi_tb_setup_fadt_registers() {
    static void acpi_tb_setup_fadt_registers(void)
    {
