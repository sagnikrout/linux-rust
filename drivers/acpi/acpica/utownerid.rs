...
//! Source: drivers/acpi/acpica/utownerid.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_allocate_owner_id(owner_id: *mut acpi_owner_id) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_release_owner_id(owner_id_ptr: *mut acpi_owner_id) {
