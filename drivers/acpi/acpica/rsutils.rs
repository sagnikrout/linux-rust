...
//! Source: drivers/acpi/acpica/rsutils.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_rs_decode_bitmask(mask: u16, list: *mut *mut u8) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_rs_encode_bitmask(list: *mut *mut u8, count: u8) -> u16 {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_rs_strcpy(destination: *mut c_char, source: *mut c_char) -> u16 {
