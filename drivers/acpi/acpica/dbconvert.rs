...
//! Source: drivers/acpi/acpica/dbconvert.c
#![no_std]
...
pub const DB_DEFAULT_PKG_ELEMENTS: c_int = 33;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_hex_char_to_value(hex_char: c_int, return_value: *mut u8) -> acpi_status {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_hex_byte_to_binary(hex_byte: *mut c_char, return_value: *mut u8) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_convert_to_package(string: *mut c_char, object: *mut union acpi_object) -> acpi_status {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_db_dump_pld_buffer(obj_desc: *mut union acpi_object) {
