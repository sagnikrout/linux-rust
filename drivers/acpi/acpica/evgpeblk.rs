...
//! Source: drivers/acpi/acpica/evgpeblk.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_delete_gpe_block(gpe_block: *mut acpi_gpe_block_info) -> acpi_status {
...
// Disable all GPEs in this block
    status =
    acpi_hw_disable_gpe_block(gpe_block.xrupt_block, gpe_block, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
    return_ACPI_STATUS(status);
    }
...
//
    ...
    acpi_ev_create_gpe_info_blocks(struct acpi_gpe_block_info *gpe_block)
    {
    struct acpi_gpe_register_info *gpe_register_info = core::ptr::null_mut();
    struct acpi_gpe_event_info *gpe_event_info = core::ptr::null_mut();
...
// Find all GPE methods (_Lxx or_Exx) for this block
    ...
    acpi_ev_match_gpe_method, core::ptr::null_mut(), &walk_info,
    core::ptr::null_mut());
