...
//! Source: drivers/acpi/acpica/nswalk.c
#![no_std]
...
// child_node)
    {
    struct acpi_namespace_node *next_node = core::ptr::null_mut();
    ACPI_FUNCTION_ENTRY();
...
#[no_mangle]
pub unsafe extern "C" fn if(type: child_type ==) -> else {
//
...
// There is at least one child of this node, visit it
    ...
    child_node =
    acpi_ns_get_next_node(parent_node, core::ptr::null_mut());
    continue;
    }
    }
