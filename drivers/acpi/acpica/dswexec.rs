...
//! Source: drivers/acpi/acpica/dswexec.c
#![no_std]
...
//
    ...
    core::ptr::null_mut(),			/* Was: acpi_ex_opcode_1A_0T_0R (Was for Load operator) */
...
//
    ...
    union acpi_operand_object *local_obj_desc = core::ptr::null_mut();
...
//
    ...
    status =
    acpi_ds_load2_begin_op(walk_state, core::ptr::null_mut());
    } else {
    status =
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ds_exec_end_op(walk_state: *mut acpi_walk_state) -> acpi_status {
