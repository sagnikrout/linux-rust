...
//! Source: drivers/acpi/acpica/utmath.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_short_shift_left(operand: u64, count: u32, out_result: *mut u64) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_short_shift_right(operand: u64, count: u32, out_result: *mut u64) -> acpi_status {
