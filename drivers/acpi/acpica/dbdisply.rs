...
//! Source: drivers/acpi/acpica/dbdisply.c
#![no_std]
...
//
    ...
    void *obj_ptr;
    acpi_size address;
    address = strtoul(target, core::ptr::null_mut(), 16);
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_dump_parser_descriptor(op: *mut union acpi_parse_object) {
    static void acpi_db_dump_parser_descriptor(union acpi_parse_object *op)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_decode_and_display_object(target: *mut c_char, output_type: *mut c_char) {
    void acpi_db_decode_and_display_object(char *target, char *output_type)
    {
    void *obj_ptr;
    struct acpi_namespace_node *node;
    union acpi_operand_object *obj_desc;
    let mut display: u32 = DB_BYTE_DISPLAY;
    char buffer[80];
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_method_info(start_op: *mut union acpi_parse_object) {
    ...
    let mut num_operands: u32 = 0;
    let mut num_operators: u32 = 0;
    let mut num_remaining_ops: u32 = 0;
    let mut num_remaining_operands: u32 = 0;
    let mut num_remaining_operators: u32 = 0;
    let mut count_remaining: u8 = FALSE;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_locals() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_arguments() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_results() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_calling_tree() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_object_type(object_arg: *mut c_char) {
    ...
    acpi_status status;
    u32 i;
    arg = strtoul(object_arg, core::ptr::null_mut(), 16);
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_gpes() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_handlers() {
...
// Other handlers that are installed throughout the namespace
    ...
    ACPI_UINT32_MAX,
    acpi_db_display_non_root_handlers, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut());
    }
//
