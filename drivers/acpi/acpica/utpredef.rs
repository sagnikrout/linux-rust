...
//! Source: drivers/acpi/acpica/utpredef.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_get_expected_return_types(buffer: *mut c_char, expected_btypes: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ut_get_argument_types(buffer: *mut c_char, argument_types: u16) -> u32 {
    static u32 acpi_ut_get_argument_types(char *buffer, u16 argument_types)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_get_resource_bit_width(buffer: *mut c_char, types: u16) -> u32 {
