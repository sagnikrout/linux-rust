...
//! Source: drivers/acpi/acpica/nsutils.c
#![no_std]
...
//
    ...
    acpi_status status;
    if (!node) {
    acpi_os_printf("[core::ptr::null_mut() NAME]");
    return;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_get_type(node: *mut *mut acpi_namespace_node) -> acpi_object_type {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_local(type: acpi_object_type) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_get_internal_name_length(info: *mut acpi_namestring_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_build_internal_name(info: *mut acpi_namestring_info) -> acpi_status {
    acpi_status acpi_ns_build_internal_name(struct acpi_namestring_info *info)
    {
    let mut num_segments: u32 = info.num_segments;
...
//
    ...
    {
    let mut names_index: u32 = 0;
    let mut num_segments: u32 = 0;
    u32 required_length;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_terminate() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ns_opens_scope(type: acpi_object_type) -> u32 {
...
// Lookup the name in the namespace
    ...
    ACPI_IMODE_EXECUTE,
    (flags | ACPI_NS_DONT_OPEN_SCOPE), core::ptr::null_mut(),
    return_node);
    if (ACPI_FAILURE(status)) {
