...
//! Source: drivers/acpi/acpica/psloop.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ps_parse_loop(walk_state: *mut acpi_walk_state) -> acpi_status {
    acpi_status acpi_ps_parse_loop(struct acpi_walk_state *walk_state)
    {
    let mut status: acpi_status = AE_OK;
    union acpi_parse_object *op = core::ptr::null_mut();	/* current op */
    struct acpi_parse_state *parser_state;
    u8 *aml_op_start = core::ptr::null_mut();
    u8 opcode_length;
...
// This op complete, notify the dispatcher
    if (walk_state.ascending_callback != core::ptr::null_mut()) {
    walk_state.op = op;
