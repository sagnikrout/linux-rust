...
//! Source: drivers/acpi/acpica/nsrepair.c
#![no_std]
...
// Unicode conversions
    ...
    ACPI_NOT_PACKAGE_ELEMENT,
    acpi_ns_convert_to_unicode},
    {{0, 0, 0, 0}, 0, 0, core::ptr::null_mut()}	/* Table terminator */
    };
//
...
//
    ...
    union acpi_operand_object *new_object = core::ptr::null_mut();
    acpi_status status;
...
//
    ...
    info.full_pathname,
    ACPI_WARN_ALWAYS,
    "Found unexpected core::ptr::null_mut() package element"));
    status =
...
// Check if we can actually repair this name/type combination
    ...
    return (core::ptr::null_mut());		/* Name was not found in the repair table */
    }
//
...
// Set the reference count according to the parent Package object
    ...
    ACPI_DEBUG_PRINT((ACPI_DB_REPAIR,
    "%s: Converted core::ptr::null_mut() package element to expected %s at index %u\n",
    info.full_pathname,
    acpi_ut_get_object_type_name(new_object),
    package_index));
// return_object_ptr = new_object;
...
// Update parent package if any null elements were removed
    if (new_count < count) {
    ACPI_DEBUG_PRINT((ACPI_DB_REPAIR,
    "%s: Found and removed %u core::ptr::null_mut() elements\n",
