...
//! Source: drivers/acpi/acpica/exmutex.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_unlink_mutex(obj_desc: *mut union acpi_operand_object) {
...
// Acquired the mutex: update mutex object
    ...
    obj_desc.mutex.owner_thread = core::ptr::null_mut();	/* Used only for AML Acquire() */
    return_ACPI_STATUS(AE_OK);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_release_mutex_object(obj_desc: *mut union acpi_operand_object) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_release_all_mutexes(thread: *mut acpi_thread_state) {
