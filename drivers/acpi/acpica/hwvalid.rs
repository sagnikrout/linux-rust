...
//! Source: drivers/acpi/acpica/hwvalid.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_read_port(address: acpi_io_address, value: *mut u32, width: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_write_port(address: acpi_io_address, value: u32, width: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_validate_io_block(address: u64, bit_width: u32, count: u32) -> acpi_status {
