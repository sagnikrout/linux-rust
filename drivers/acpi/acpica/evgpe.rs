...
//! Source: drivers/acpi/acpica/evgpe.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_enable_gpe(gpe_event_info: *mut acpi_gpe_event_info) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_gpe_detect(gpe_xrupt_list: *mut acpi_gpe_xrupt_info) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ev_asynch_execute_gpe_method(context: *mut c_void) -> void ACPI_SYSTEM_XFACE {
    static void ACPI_SYSTEM_XFACE acpi_ev_asynch_execute_gpe_method(void *context)
    {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ev_asynch_enable_gpe(context: *mut c_void) -> void ACPI_SYSTEM_XFACE {
    static void ACPI_SYSTEM_XFACE acpi_ev_asynch_enable_gpe(void *context)
    {
    struct acpi_gpe_event_info *gpe_event_info = context;
    acpi_cpu_flags flags;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ev_finish_gpe(gpe_event_info: *mut acpi_gpe_event_info) -> acpi_status {
