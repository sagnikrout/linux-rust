...
//! Source: drivers/acpi/acpica/tbdata.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_release_temp_table(table_desc: *mut acpi_table_desc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_validate_table(table_desc: *mut acpi_table_desc) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_invalidate_table(table_desc: *mut acpi_table_desc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_validate_temp_table(table_desc: *mut acpi_table_desc) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_resize_root_table_list() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_terminate() {
...
//
    ...
    acpi_gbl_root_table_list.tables = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_delete_namespace_by_owner(table_index: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_allocate_owner_id(table_index: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_release_owner_id(table_index: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_get_owner_id(table_index: u32, owner_id: *mut acpi_owner_id) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_is_table_loaded(table_index: u32) -> u8 {
    u8 acpi_tb_is_table_loaded(u32 table_index)
    {
    let mut is_loaded: u8 = FALSE;
    (void)acpi_ut_acquire_mutex(ACPI_MTX_TABLES);
    if (table_index < acpi_gbl_root_table_list.current_table_count) {
    is_loaded = (u8)
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_set_table_loaded_flag(table_index: u32, is_loaded: u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_unload_table(table_index: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_notify_table(event: u32, table: *mut c_void) {
