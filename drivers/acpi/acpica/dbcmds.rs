...
//! Source: drivers/acpi/acpica/dbcmds.c
#![no_std]
...
// Local prototypes
    ...
    static char *acpi_db_trace_method_name = core::ptr::null_mut();
//
...
// Numeric argument, convert
    address = strtoul(in_string, core::ptr::null_mut(), 16);
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_sleep(object_arg: *mut c_char) -> acpi_status {
...
// Convert argument to binary and invoke the sleep state
    sleep_state = (u8)strtoul(object_arg, core::ptr::null_mut(), 0);
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_do_one_sleep_state(sleep_state: u8) {
    static void acpi_db_do_one_sleep_state(u8 sleep_state)
    {
    acpi_status status;
    u8 sleep_type_a;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_locks() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_table_info(table_arg: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_unload_acpi_table(object_name: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_send_notify(name: *mut c_char, value: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_interfaces(action_arg: *mut c_char, interface_name_arg: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_template(buffer_arg: *mut c_char) {
...
//
    ...
    let mut offset: acpi_rsdesc_size = 0;
    u8 resource_type;
    let mut count: u32 = 0;
    u32 i;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: memcmp(aml1, _arg: aml2, _arg: aml1_length)) -> else {
    acpi_os_printf
...
// Get the original _CRS AML resource template
    status = acpi_evaluate_object(node, name, core::ptr::null_mut(), &return_buffer);
    if (ACPI_FAILURE(status)) {
...
//
    ...
    {
    struct acpi_namespace_node *node;
    struct acpi_namespace_node *prt_node = core::ptr::null_mut();
    struct acpi_namespace_node *crs_node = core::ptr::null_mut();
    struct acpi_namespace_node *prs_node = core::ptr::null_mut();
    struct acpi_namespace_node *aei_node = core::ptr::null_mut();
    char *parent_path;
    struct acpi_buffer return_buffer;
    acpi_status status;
...
// _PRT
    ...
    status =
    acpi_evaluate_object(prt_node, core::ptr::null_mut(), core::ptr::null_mut(), &return_buffer);
    if (ACPI_FAILURE(status)) {
...
// _CRS
    ...
    return_buffer.length = ACPI_DEBUG_BUFFER_SIZE;
    status =
    acpi_evaluate_object(crs_node, core::ptr::null_mut(), core::ptr::null_mut(), &return_buffer);
    if (ACPI_FAILURE(status)) {
...
// This code exercises the acpi_walk_resources interface
    ...
    acpi_db_resource_callback, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
...
// _PRS
    ...
    return_buffer.length = ACPI_DEBUG_BUFFER_SIZE;
    status =
    acpi_evaluate_object(prs_node, core::ptr::null_mut(), core::ptr::null_mut(), &return_buffer);
    if (ACPI_FAILURE(status)) {
...
// _AEI
    ...
    return_buffer.length = ACPI_DEBUG_BUFFER_SIZE;
    status =
    acpi_evaluate_object(aei_node, core::ptr::null_mut(), core::ptr::null_mut(), &return_buffer);
    if (ACPI_FAILURE(status)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_resources(object_arg: *mut c_char) {
...
// Asterisk means "display resources for all devices"
    ...
    ACPI_UINT32_MAX,
    acpi_db_device_resources, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut());
    } else {
// Convert string to object pointer
    ...
    (void)acpi_db_device_resources(node, 0, core::ptr::null_mut(),
    core::ptr::null_mut());
    }
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_generate_interrupt(gsiv_arg: *mut c_char) {
    ...
    gsiv_number = strtoul(gsiv_arg, core::ptr::null_mut(), 0);
    while (ged_info) {
    if (ged_info.int_id == gsiv_number) {
    struct acpi_object_list arg_list;
    union acpi_object arg0;
    let mut evt_handle: acpi_handle = ged_info.evt_method;
    acpi_status status;
    ...
    status =
    acpi_evaluate_object(evt_handle, core::ptr::null_mut(), &arg_list,
    core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_generate_gpe(gpe_arg: *mut c_char, block_arg: *mut c_char) {
    void acpi_db_generate_gpe(char *gpe_arg, char *block_arg)
    {
    let mut block_number: u32 = 0;
    u32 gpe_number;
    struct acpi_gpe_event_info *gpe_event_info;
    gpe_number = strtoul(gpe_arg, core::ptr::null_mut(), 0);
//
// If no block arg, or block arg == 0 or 1, use the FADT-defined
// GPE blocks.
//
    if (block_arg) {
    block_number = strtoul(block_arg, core::ptr::null_mut(), 0);
    if (block_number == 1) {
    block_number = 0;
    }
    }
    ...
    (void)acpi_ev_gpe_dispatch(core::ptr::null_mut(), gpe_event_info, gpe_number);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_generate_sci() {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_trace(enable_arg: *mut c_char, method_arg: *mut c_char, once_arg: *mut c_char) {
    void acpi_db_trace(char *enable_arg, char *method_arg, char *once_arg)
    {
    let mut debug_level: u32 = 0;
    let mut debug_layer: u32 = 0;
    let mut flags: u32 = 0;
    ...
    acpi_db_trace_method_name = core::ptr::null_mut();
    }
