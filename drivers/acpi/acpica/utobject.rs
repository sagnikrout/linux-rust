...
//! Source: drivers/acpi/acpica/utobject.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_valid_internal_object(object: *mut c_void) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_delete_object_desc(object: *mut union acpi_operand_object) {
...
// Package object - nothing much to do here, let the walk handle it
    info.num_packages++;
    state.pkg.this_target_obj = core::ptr::null_mut();
    break;
    default:
...
//
    ...
    info.num_packages = 1;
    status =
    acpi_ut_walk_package_tree(internal_object, core::ptr::null_mut(),
