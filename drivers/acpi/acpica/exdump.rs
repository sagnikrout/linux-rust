...
//! Source: drivers/acpi/acpica/exdump.c
#![no_std]
...
//
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_integer), core::ptr::null_mut()},
    {ACPI_EXD_UINT64, ACPI_EXD_OFFSET(integer.value), "Value"}
    };
    static struct acpi_exdump_info acpi_ex_dump_string[4] = {
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_string), core::ptr::null_mut()},
    {ACPI_EXD_UINT32, ACPI_EXD_OFFSET(string.length), "Length"},
    {ACPI_EXD_POINTER, ACPI_EXD_OFFSET(string.pointer), "Pointer"},
    {ACPI_EXD_STRING, 0, core::ptr::null_mut()}
    };
    static struct acpi_exdump_info acpi_ex_dump_buffer[5] = {
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_buffer), core::ptr::null_mut()},
    {ACPI_EXD_UINT32, ACPI_EXD_OFFSET(buffer.length), "Length"},
    {ACPI_EXD_POINTER, ACPI_EXD_OFFSET(buffer.pointer), "Pointer"},
    {ACPI_EXD_NODE, ACPI_EXD_OFFSET(buffer.node), "Parent Node"},
    {ACPI_EXD_BUFFER, 0, core::ptr::null_mut()}
    };
    static struct acpi_exdump_info acpi_ex_dump_package[6] = {
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_package), core::ptr::null_mut()},
    {ACPI_EXD_NODE, ACPI_EXD_OFFSET(package.node), "Parent Node"},
    {ACPI_EXD_UINT8, ACPI_EXD_OFFSET(package.flags), "Flags"},
    {ACPI_EXD_UINT32, ACPI_EXD_OFFSET(package.count), "Element Count"},
    {ACPI_EXD_POINTER, ACPI_EXD_OFFSET(package.elements), "Element List"},
    {ACPI_EXD_PACKAGE, 0, core::ptr::null_mut()}
    };
    static struct acpi_exdump_info acpi_ex_dump_device[4] = {
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_device), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_event), core::ptr::null_mut()},
    {ACPI_EXD_POINTER, ACPI_EXD_OFFSET(event.os_semaphore), "OsSemaphore"}
    };
    static struct acpi_exdump_info acpi_ex_dump_method[9] = {
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_method), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_mutex), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_region), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_power), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_processor), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_thermal), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_buffer_field), core::ptr::null_mut()},
    {ACPI_EXD_FIELD, 0, core::ptr::null_mut()},
    {ACPI_EXD_POINTER, ACPI_EXD_OFFSET(buffer_field.buffer_obj),
    "Buffer Object"}
    };
    static struct acpi_exdump_info acpi_ex_dump_region_field[5] = {
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_region_field), core::ptr::null_mut()},
    {ACPI_EXD_FIELD, 0, core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_bank_field), core::ptr::null_mut()},
    {ACPI_EXD_FIELD, 0, core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_reference), core::ptr::null_mut()},
    ...
    "Index Pointer"},
    {ACPI_EXD_REFERENCE, 0, core::ptr::null_mut()}
    };
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_notify), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_extra), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_data), core::ptr::null_mut()},
...
// Miscellaneous tables
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_common), core::ptr::null_mut()},
    {ACPI_EXD_TYPE, 0, core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_field_common), core::ptr::null_mut()},
    ...
    {ACPI_EXD_INIT, ACPI_EXD_TABLE_SIZE(acpi_ex_dump_node), core::ptr::null_mut()},
...
//
    ...
    union acpi_operand_object *data = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_dump_operand(obj_desc: *mut union acpi_operand_object, depth: u32) {
...
//
    ...
    ACPI_DEBUG_PRINT((ACPI_DB_EXEC, "*core::ptr::null_mut()*\n"));
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ex_out_string(title: *const c_char, value: *const c_char) {
    static void acpi_ex_out_string(const char *title, const char *value)
    {
    acpi_os_printf("%20s : %s\n", title, value);
    }
#[no_mangle]
unsafe extern "C" fn acpi_ex_out_pointer(title: *const c_char, value: *const c_void) {
    static void acpi_ex_out_pointer(const char *title, const void *value)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ex_dump_namespace_node(node: *mut acpi_namespace_node, flags: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_ex_dump_reference_obj(obj_desc: *mut union acpi_operand_object) {
    static void acpi_ex_dump_reference_obj(union acpi_operand_object *obj_desc)
    {
