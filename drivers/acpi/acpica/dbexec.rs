...
//! Source: drivers/acpi/acpica/dbexec.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_delete_objects(count: u32, objects: *mut union acpi_object) {
...
// Do the actual method execution
    ...
    status = acpi_evaluate_object(core::ptr::null_mut(), info.pathname,
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_execute_setup(info: *mut acpi_db_method_info) -> acpi_status {
    static acpi_status acpi_db_execute_setup(struct acpi_db_method_info *info)
    {
    acpi_status status;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_db_get_cache_info(cache: *mut acpi_memory_list) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_get_outstanding_allocations() -> u32 {
    static u32 acpi_db_get_outstanding_allocations(void)
    {
...
// Do the actual method execution
    acpi_os_printf("\n");
    acpi_gbl_method_executing = TRUE;
    status = acpi_evaluate_object(node, core::ptr::null_mut(), core::ptr::null_mut(), &return_obj);
    acpi_gbl_method_executing = FALSE;
...
// Memory allocation tracking
    ...
    ACPI_UINT32_MAX,
    acpi_db_execution_walk, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut());
    return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(EX_ALL: flags &) -> else {
...
// Get the NS node, determines existence also
    status = acpi_get_handle(core::ptr::null_mut(), acpi_gbl_db_method_info.pathname,
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_method_thread(context: *mut c_void) -> void ACPI_SYSTEM_XFACE {
    static void ACPI_SYSTEM_XFACE acpi_db_method_thread(void *context)
    {
    acpi_status status;
...
//
    ...
    local_info.arguments[3] = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_single_execution_thread(context: *mut c_void) -> void ACPI_SYSTEM_XFACE {
    static void ACPI_SYSTEM_XFACE acpi_db_single_execution_thread(void *context)
    {
    struct acpi_db_method_info *info = context;
    acpi_status status;
...
// Get the arguments
    num_threads = strtoul(num_threads_arg, core::ptr::null_mut(), 0);
    num_loops = strtoul(num_loops_arg, core::ptr::null_mut(), 0);
...
// Array to store IDs of threads
    ...
    if (acpi_gbl_db_method_info.threads == core::ptr::null_mut()) {
...
// Init arguments to be passed to method
    ...
    acpi_gbl_db_method_info.arguments[3] = core::ptr::null_mut();
    acpi_gbl_db_method_info.types = acpi_gbl_db_method_info.arg_types;
...
// Cleanup and exit
    ...
    acpi_gbl_db_method_info.threads = core::ptr::null_mut();
    }
