...
//! Source: drivers/acpi/acpica/utprint.c
#![no_std]
...
pub const ACPI_FORMAT_SIGN: c_uint = 0x01;
pub const ACPI_FORMAT_SIGN_PLUS: c_uint = 0x02;
pub const ACPI_FORMAT_SIGN_PLUS_SPACE: c_uint = 0x04;
pub const ACPI_FORMAT_ZERO: c_uint = 0x08;
pub const ACPI_FORMAT_LEFT: c_uint = 0x10;
pub const ACPI_FORMAT_UPPER: c_uint = 0x20;
pub const ACPI_FORMAT_PREFIX: c_uint = 0x40;
// Local prototypes
    static acpi_size
...
//
#[no_mangle]
pub unsafe extern "C" fn vsnprintf(string: *mut c_char, size: acpi_size, format: *const c_char, args: va_list) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn snprintf(string: *mut c_char, size: acpi_size, format: *const c_char, ...) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sprintf(string: *mut c_char, format: *const c_char, ...) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn vfprintf(file: *mut *mut FILE, format: *const c_char, args: va_list) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fprintf(file: *mut *mut FILE, format: *const c_char, ...) -> c_int {
