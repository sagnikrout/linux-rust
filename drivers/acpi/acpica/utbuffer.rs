...
//! Source: drivers/acpi/acpica/utbuffer.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ut_dump_buffer(buffer: *mut u8, count: u32, display: u32, base_offset: u32) {
    ...
    u32 temp32;
    u8 buf_char;
    let mut display_data_only: u32 = display & DB_DISPLAY_DATA_ONLY;
