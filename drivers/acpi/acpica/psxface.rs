...
//! Source: drivers/acpi/acpica/psxface.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ps_execute_method(info: *mut acpi_evaluate_info) -> acpi_status {
...
// Init for new method, wait on concurrency semaphore
    status =
    acpi_ds_begin_method_execution(info.node, info.obj_desc, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
...
// Create and initialize a new walk state
    ...
    walk_state =
    acpi_ds_create_walk_state(info.obj_desc.method.owner_id, core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_ps_execute_table(info: *mut acpi_evaluate_info) -> acpi_status {
    acpi_status acpi_ps_execute_table(struct acpi_evaluate_info *info)
    {
    acpi_status status;
    union acpi_parse_object *op = core::ptr::null_mut();
    struct acpi_walk_state *walk_state = core::ptr::null_mut();
