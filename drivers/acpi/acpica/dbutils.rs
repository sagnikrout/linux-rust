...
//! Source: drivers/acpi/acpica/dbutils.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_set_output_destination(output_flags: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_dump_external_object(obj_desc: *mut union acpi_object, level: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_prep_namestring(name: *mut c_char) {
...
//
    ...
    char *internal_path;
    acpi_status status;
    struct acpi_namespace_node *node = core::ptr::null_mut();
...
//
    status = acpi_ns_lookup(core::ptr::null_mut(), internal_path, ACPI_TYPE_ANY,
    ACPI_IMODE_EXECUTE,
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_uint32_to_hex_string(value: u32, buffer: *mut c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_second_pass_parse(root: *mut union acpi_parse_object) -> acpi_status {
    acpi_status acpi_db_second_pass_parse(union acpi_parse_object *root)
    {
...
// Create a new walk state for the parse
    walk_state =
    acpi_ds_create_walk_state(0, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut());
    if (!walk_state) {
    return (AE_NO_MEMORY);
    }
// Init the Walk State
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_dump_buffer(address: u32) {
    void acpi_db_dump_buffer(u32 address)
    {
    acpi_os_printf("\nLocation %X:\n", address);
