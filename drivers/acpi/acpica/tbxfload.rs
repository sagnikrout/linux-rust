...
//! Source: drivers/acpi/acpica/tbxfload.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_load_tables() -> acpi_status ACPI_INIT_FUNCTION {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_tb_load_namespace() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_load_table(table: *mut acpi_table_header, table_idx: *mut u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_unload_parent_table(object: acpi_handle) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_unload_table(table_index: u32) -> acpi_status {
