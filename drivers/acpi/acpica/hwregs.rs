...
//! Source: drivers/acpi/acpica/hwregs.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_read(value: *mut u64, reg: *mut acpi_generic_address) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_write(value: u64, reg: *mut acpi_generic_address) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_clear_acpi_status() -> acpi_status {
    acpi_status acpi_hw_clear_acpi_status(void)
    {
    acpi_status status;
    let mut lock_flags: acpi_cpu_flags = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_write_pm1_control(pm1a_control: u32, pm1b_control: u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_register_read(register_id: u32, return_value: *mut u32) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_hw_register_write(register_id: u32, value: u32) -> acpi_status {
