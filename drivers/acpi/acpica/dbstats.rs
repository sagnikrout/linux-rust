...
//! Source: drivers/acpi/acpica/dbstats.c
#![no_std]
...
pub const CMD_STAT_ALLOCATIONS: c_int = 0;
pub const CMD_STAT_OBJECTS: c_int = 1;
pub const CMD_STAT_MEMORY: c_int = 2;
pub const CMD_STAT_MISC: c_int = 3;
pub const CMD_STAT_TABLES: c_int = 4;
pub const CMD_STAT_SIZES: c_int = 5;
pub const CMD_STAT_STACK: c_int = 6;
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_list_info(list: *mut acpi_memory_list) {
    static void acpi_db_list_info(struct acpi_memory_list *list)
    {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_enumerate_object(obj_desc: *mut union acpi_operand_object) {
    static void acpi_db_enumerate_object(union acpi_operand_object *obj_desc)
    {
    u32 i;
    if (!obj_desc) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_db_count_namespace_objects() {
    static void acpi_db_count_namespace_objects(void)
    {
    u32 i;
    ...
    acpi_db_classify_one_object, core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_db_display_statistics(type_arg: *mut c_char) -> acpi_status {
