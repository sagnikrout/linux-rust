...
//! Source: drivers/acpi/cppc_acpi.c
#![no_std]
...
pub struct cppc_pcc_data {
    ...
    pub deadline_us: c_uint,
    pub pcc_nominal: unsigned int pcc_mpar, pcc_mrtt,,
    pub /: *mut *mut bool pending_pcc_write_cmd; / Any pending/batched PCC write cmds?,
    pub /: *mut *mut bool platform_owns_pcc; / Ownership of PCC subspace,
    pub /: *mut *mut unsigned int pcc_write_cnt; / Running count of PCC write commands,
//
...
//
    ...
    __ATTR(_name, 0444, show_##_name, core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn cpc_sysmem_access_size(reg: *const cpc_register_resource) -> u64 {
    ...
    let mut a_size: u64 = cpc_sysmem_access_size(a);
    let mut b_size: u64 = cpc_sysmem_access_size(b);
...
#[no_mangle]
unsafe extern "C" fn cpc_mark_rmw_lock_users(cpc_desc: *mut cpc_desc) {
    ...
    {
    struct cpc_desc *cpc_ptr = to_cpc_desc(kobj);
    let mut fb_ctrs: cppc_perf_fb_ctrs = {0};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn check_pcc_chan(pcc_ss_id: c_int, chk_err_bit: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn send_pcc_cmd(pcc_ss_id: c_int, cmd: u16) -> c_int {
    static int send_pcc_cmd(int pcc_ss_id, u16 cmd)
    {
    let mut ret: c_int = -EIO, i;
    struct cppc_pcc_data *pcc_ss_data = pcc_data[pcc_ss_id];
    struct acpi_pcct_shared_memory __iomem *generic_comm_base =
    pcc_ss_data.pcc_channel.shmem;
...
#[no_mangle]
unsafe extern "C" fn cppc_chan_tx_done(cl: *mut mbox_client, msg: *mut c_void, ret: c_int) {
...
#[no_mangle]
unsafe extern "C" fn acpi_get_psd(cpc_ptr: *mut cpc_desc, handle: acpi_handle) -> c_int {
    static int acpi_get_psd(struct cpc_desc *cpc_ptr, acpi_handle handle)
    {
    let mut result: c_int = -EFAULT;
    ...
    status = acpi_evaluate_object_typed(handle, "_PSD", core::ptr::null_mut(),
...
#[no_mangle]
pub unsafe extern "C" fn acpi_cpc_valid() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cppc_allow_fast_switch(cpus: *const cpumask) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_get_psd_map(cpu: c_uint, cpu_data: *mut cppc_cpudata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_pcc_channel(pcc_ss_idx: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpc_ffh_supported() -> bool __weak {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpc_supported_by_cpu() -> bool __weak {
...
//
#[no_mangle]
unsafe extern "C" fn pcc_data_alloc(pcc_ss_id: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_cppc_processor_probe(pr: *mut acpi_processor) -> c_int {
    ...
    let mut handle: acpi_handle = pr.handle;
    unsigned int num_ent, i, cpc_rev;
    let mut pcc_subspace_id: c_int = -1;
    acpi_status status;
...
// Parse the ACPI _CPC table for this CPU.
    status = acpi_evaluate_object_typed(handle, "_CPC", core::ptr::null_mut(), &output,
    ACPI_TYPE_PACKAGE);
    if (ACPI_FAILURE(status)) {
    ret = -ENODEV;
    goto out_buf_free;
...
// Plug PSD data into this CPU's CPC descriptor.
    ...
    "acpi_cppc");
    if (ret) {
    per_cpu(cpc_desc_ptr, pr.id) = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_cppc_processor_exit(pr: *mut acpi_processor) {
    void acpi_cppc_processor_exit(struct acpi_processor *pr)
    {
    struct cpc_desc *cpc_ptr;
    unsigned int i;
    void __iomem *addr;
    let mut pcc_ss_id: c_int = per_cpu(cpu_pcc_subspace_idx, pr.id);
    ...
    pcc_data[pcc_ss_id] = core::ptr::null_mut();
    }
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn cpc_read_ffh(cpunum: c_int, reg: *mut cpc_reg, val: *mut u64) -> int __weak {
...
//
#[no_mangle]
pub unsafe extern "C" fn cpc_write_ffh(cpunum: c_int, reg: *mut cpc_reg, val: u64) -> int __weak {
...
//
#[no_mangle]
unsafe extern "C" fn cpc_read(cpu: c_int, reg_res: *mut cpc_register_resource, val: *mut u64) -> c_int {
    static int cpc_read(int cpu, struct cpc_register_resource *reg_res, u64 *val)
    {
    void __iomem *vaddr = core::ptr::null_mut();
    int size;
    let mut pcc_ss_id: c_int = per_cpu(cpu_pcc_subspace_idx, cpu);
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_ADR_SPACE_SYSTEM_MEMORY: reg->space_id ==) -> else {
    else if (reg.space_id == ACPI_ADR_SPACE_SYSTEM_MEMORY)
    vaddr = reg_res.sys_mem_vaddr;
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_ADR_SPACE_FIXED_HARDWARE: reg->space_id ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cpc_write(cpu: c_int, reg_res: *mut cpc_register_resource, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cppc_get_reg_val_in_pcc(cpu: c_int, reg: *mut cpc_register_resource, val: *mut u64) -> c_int {
    static int cppc_get_reg_val_in_pcc(int cpu, struct cpc_register_resource *reg, u64 *val)
    {
    let mut pcc_ss_id: c_int = per_cpu(cpu_pcc_subspace_idx, cpu);
    struct cppc_pcc_data *pcc_ss_data = core::ptr::null_mut();
    int ret;
    if (pcc_ss_id < 0) {
...
#[no_mangle]
unsafe extern "C" fn cppc_get_reg_val(cpu: c_int, reg_idx: enum cppc_regs, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cppc_set_reg_val_in_pcc(cpu: c_int, reg: *mut cpc_register_resource, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cppc_set_reg_val(cpu: c_int, reg_idx: enum cppc_regs, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cppc_desired_perf_readable(cpc_desc: *const cpc_desc) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_desired_perf(cpunum: c_int, desired_perf: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_nominal_perf(cpunum: c_int, nominal_perf: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_highest_perf(cpunum: c_int, highest_perf: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_epp_perf(cpunum: c_int, epp_perf: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_perf_caps(cpunum: c_int, perf_caps: *mut cppc_perf_caps) -> c_int {
...
// guaranteed_reg, *low_freq_reg = NULL, *nom_freq_reg = NULL;
    ...
    low_f = 0, nom_f = 0;
    let mut pcc_ss_id: c_int = per_cpu(cpu_pcc_subspace_idx, cpunum);
    struct cppc_pcc_data *pcc_ss_data = core::ptr::null_mut();
    let mut ret: c_int = 0, regs_in_pcc = 0;
    if (!cpc_desc) {
    pr_debug("No CPC descriptor for CPU:%d\n", cpunum);
    return -ENODEV;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_perf_ctrs_in_pcc_cpu(cpu: c_uint) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_perf_ctrs_in_pcc() -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_perf_ctrs(cpunum: c_int, perf_fb_ctrs: *mut cppc_perf_fb_ctrs) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_set_epp_perf(cpu: c_int, perf_ctrls: *mut cppc_perf_ctrls, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_set_epp(cpu: c_int, epp_val: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_auto_act_window(cpu: c_int, auto_act_window: *mut u64) -> c_int {
    int cppc_get_auto_act_window(int cpu, u64 *auto_act_window)
    {
    unsigned int exp;
    u64 val, sig;
    int ret;
    if (auto_act_window == core::ptr::null_mut())
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_set_auto_act_window(cpu: c_int, auto_act_window: u64) -> c_int {
    int cppc_set_auto_act_window(int cpu, u64 auto_act_window)
    {
// The max value to store is 1270000000
    let mut max_val: u64 = CPPC_AUTO_ACT_WINDOW_MAX_SIG * int_pow(10, CPPC_AUTO_ACT_WINDOW_MAX_EXP);
    let mut exp: c_int = 0;
    u64 val;
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_auto_sel(cpu: c_int, enable: *mut bool) -> c_int {
    int cppc_get_auto_sel(int cpu, bool *enable)
    {
    u64 auto_sel;
    int ret;
    if (enable == core::ptr::null_mut())
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_set_auto_sel(cpu: c_int, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_set_enable(cpu: c_int, enable: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_perf(cpu: c_int, perf_ctrls: *mut cppc_perf_ctrls) -> c_int {
    int cppc_get_perf(int cpu, struct cppc_perf_ctrls *perf_ctrls)
    {
    struct cpc_desc *cpc_desc = per_cpu(cpc_desc_ptr, cpu);
    struct cpc_register_resource *min_perf_reg, *max_perf_reg,
// energy_perf_reg, *auto_sel_reg;
    let mut min: u64 = 0, max = 0, energy_perf = 0, auto_sel = 0;
    let mut pcc_ss_id: c_int = per_cpu(cpu_pcc_subspace_idx, cpu);
    struct cppc_pcc_data *pcc_ss_data = core::ptr::null_mut();
    let mut ret: c_int = 0, regs_in_pcc = 0;
    if (!cpc_desc) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_set_perf(cpu: c_int, perf_ctrls: *mut cppc_perf_ctrls) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_perf_limited(cpu: c_int, perf_limited: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_set_perf_limited(cpu: c_int, bits_to_clear: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_get_transition_latency(cpu_num: c_int) -> c_int {
...
//
    ...
    let mut pcc_ss_id: c_int = per_cpu(cpu_pcc_subspace_idx, cpu_num);
    struct cppc_pcc_data *pcc_ss_data;
    let mut latency_ns: c_int = 0;
...
pub const DMI_ENTRY_PROCESSOR_MIN_LENGTH: c_int = 48;
// Offset in the DMI processor structure for the max frequency
pub const DMI_PROCESSOR_MAX_SPEED: c_uint = 0x14;
// Callback function used to retrieve the max frequency from DMI
#[no_mangle]
unsafe extern "C" fn cppc_find_dmi_mhz(dm: *const dmi_header, private: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn cppc_get_dmi_max_khz() -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn cppc_perf_to_khz(caps: *mut cppc_perf_caps, perf: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn cppc_khz_to_perf(caps: *mut cppc_perf_caps, freq: c_uint) -> c_uint {
