...
//! Source: drivers/acpi/arm64/apmt.c
#![no_std]
...
pub const DEV_MAX_RESOURCE_COUNT: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn apmt_init_platform_devices() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_apmt_init() -> void __init {
