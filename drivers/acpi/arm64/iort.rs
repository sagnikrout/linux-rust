...
//! Source: drivers/acpi/arm64/iort.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iort_fwnode {
    pub list: list_head,
    pub iort_node: *mut acpi_iort_node,
...
//
#[no_mangle]
pub unsafe extern "C" fn iort_delete_fwnode(node: *mut acpi_iort_node) {
...
//
    ...
    {
    struct iort_fwnode *curr;
    struct acpi_iort_node *iort_node = core::ptr::null_mut();
    spin_lock(&iort_fwnode_lock);
    list_for_each_entry(curr, &iort_fwnode_list, list) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_status(_arg: *mut iort_find_node_callback) -> typedef {
...
//
#[no_mangle]
pub unsafe extern "C" fn iort_deregister_domain_token(trans_id: c_int) {
...
//
    ...
    {
    struct fwnode_handle *fw_node = core::ptr::null_mut();
    struct iort_its_msi_chip *its_msi_chip;
    spin_lock(&iort_msi_chip_lock);
...
// Get the first IORT node
    ...
    let mut status: acpi_status = AE_NOT_FOUND;
...
#[no_mangle]
unsafe extern "C" fn iort_match_iwb_callback(node: *mut acpi_iort_node, context: *mut c_void) -> acpi_status {
...
// Firmware bug!
    ...
    pr_err(FW_BUG "[node %p type %d] ID map has core::ptr::null_mut() parent reference\n",
    node, node.type);
    return core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn iort_get_id_mapping_index(node: *mut acpi_iort_node) -> c_int {
...
//
    ...
    u8 type_mask)
    {
    let mut id: u32 = id_in;
// Parse the ID mapping tree to find specified node type
    while (node) {
    struct acpi_iort_id_mapping *map;
    int i, index, rc = 0;
    let mut out_ref: u32 = 0, map_id = id;
...
//
#[no_mangle]
pub unsafe extern "C" fn iort_msi_map_id(dev: *mut device, input_id: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn iort_msi_xlate(dev: *mut device, input_id: u32, fwnode: *mut fwnode_handle) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn iort_its_translate_pa(node: *mut fwnode_handle, base: *mut phys_addr_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn iort_find_its_base(its_id: u32, base: *mut phys_addr_t) -> int __maybe_unused {
...
//
#[no_mangle]
pub unsafe extern "C" fn iort_pmsi_get_msi_info(dev: *mut device, dev_id: *mut u32, pa: *mut phys_addr_t) -> c_int {
    int iort_pmsi_get_msi_info(struct device *dev, u32 *dev_id, phys_addr_t *pa)
    {
    struct acpi_iort_node *node, *parent = core::ptr::null_mut();
    struct acpi_iort_its_group *its;
    int i, index;
    node = iort_find_dev_node(dev);
    if (!node)
...
//
    ...
    if (!node)
    return -ENXIO;
    node = iort_node_map_id(node, id, core::ptr::null_mut(), IORT_MSI_TYPE);
    if (!node)
    return -ENXIO;
// Move to ITS specific data
    its = (struct acpi_iort_its_group *)node.node_data;
...
#[no_mangle]
pub unsafe extern "C" fn iort_iwb_handle(iwb_id: u32) -> acpi_handle {
...
// find its associated IWB node
    ...
    return core::ptr::null_mut();
    iwb = (struct acpi_iort_iwb *)node.node_data;
    status = acpi_get_handle(core::ptr::null_mut(), iwb.device_name, &handle);
    if (ACPI_FAILURE(status))
    return core::ptr::null_mut();
    return handle;
    }
...
//
    ...
    {
    struct acpi_iort_node *node, *msi_parent = core::ptr::null_mut();
    struct fwnode_handle *iort_fwnode;
    struct acpi_iort_its_group *its;
    int i;
...
// then find its msi parent node
    for (i = 0; i < node.mapping_count; i++) {
    msi_parent = iort_node_map_platform_id(node, core::ptr::null_mut(),
    IORT_MSI_TYPE, i);
    if (msi_parent)
    break;
    }
...
#[no_mangle]
pub unsafe extern "C" fn acpi_configure_pmsi_domain(dev: *mut device) {
    ...
    struct iommu_resv_region *region;
    u32 *sids_copy;
    let mut addr: u64 = rmr_desc.base_address, size = rmr_desc.length;
...
// Check for address overlap
    for (j = i + 1; j < count; j++) {
    let mut e_start: u64 = desc[j].base_address;
    let mut e_end: u64 = e_start + desc[j].length - 1;
...
//
    ...
    let mut prot: c_int = IOMMU_READ | IOMMU_WRITE;
...
// Attributes 0x00 - 0x03 represents device memory
    ...
    {
    u32 *new_sids;
    let mut total_count: u32 = count + new_count;
    int i;
...
//
    ...
    {
    struct acpi_iort_node *smmu = core::ptr::null_mut();
    struct acpi_iort_rmr *rmr;
    struct acpi_iort_id_mapping *map;
    u32 *sids = core::ptr::null_mut();
    let mut num_sids: u32 = 0;
    int i;
    if (!node.mapping_offset || !node.mapping_count) {
...
//
    ...
    struct iommu_fwspec *fwspec = dev_iommu_fwspec_get(dev);
    struct acpi_iort_its_group *its;
    struct acpi_iort_node *iommu_node, *its_node = core::ptr::null_mut();
    int i;
...
//
    ...
    fwspec.ids[i],
    core::ptr::null_mut(), IORT_MSI_TYPE);
    if (its_node)
    break;
    }
    if (!its_node)
...
//
#[no_mangle]
pub unsafe extern "C" fn iort_iommu_get_resv_regions(dev: *mut device, head: *mut list_head) {
...
//
    ...
    struct list_head *head)
    {
    iort_iommu_rmr_get_resv_regions(iommu_fwnode, core::ptr::null_mut(), head);
    }
...
//
    ...
    entry.free(core::ptr::null_mut(), entry);
    }
    EXPORT_SYMBOL_GPL(iort_put_rmr_sids);
#[no_mangle]
pub unsafe extern "C" fn iort_iommu_driver_enabled(type: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iort_pci_rc_supports_ats(node: *mut acpi_iort_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn iort_pci_rc_supports_canwbs(node: *mut acpi_iort_node) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iort_pci_alias_info {
    pub dev: *mut device,
    pub node: *mut acpi_iort_node,
}

#[no_mangle]
unsafe extern "C" fn iort_pci_iommu_init(pdev: *mut pci_dev, alias: u16, data: *mut c_void) -> c_int {
    ...
    if (device_create_managed_software_node(dev, props, core::ptr::null_mut()))
    dev_warn(dev, "Could not add device properties\n");
    }
#[no_mangle]
unsafe extern "C" fn iort_nc_iommu_map(dev: *mut device, node: *mut acpi_iort_node) -> c_int {
    static int iort_nc_iommu_map(struct device *dev, struct acpi_iort_node *node)
    {
    struct acpi_iort_node *parent;
    let mut err: c_int = -ENODEV, i = 0;
    let mut streamid: u32 = 0;
    do {
...
//
#[no_mangle]
pub unsafe extern "C" fn iort_iommu_configure_id(dev: *mut device, id_in: *const u32) -> c_int {
    ...
    let mut info: iort_pci_alias_info = { .dev = dev };
...
pub unsafe extern "C" fn iort_iommu_get_resv_regions(dev: *mut device, head: *mut list_head) {
    ...
    { }
#[no_mangle]
pub unsafe extern "C" fn iort_iommu_configure_id(dev: *mut device, input_id: *const u32) -> c_int {
    int iort_iommu_configure_id(struct device *dev, const u32 *input_id)
    { return -ENODEV; }

#[no_mangle]
unsafe extern "C" fn nc_dma_get_range(dev: *mut device, limit: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rc_dma_get_range(dev: *mut device, limit: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn iort_dma_get_ranges(dev: *mut device, limit: *mut u64) -> c_int {
    ...
    struct resource *res)
    {
    int irq = acpi_register_gsi(core::ptr::null_mut(), hwirq, trigger,
    ACPI_ACTIVE_HIGH);
    if (irq <= 0) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_count_resources(node: *mut acpi_iort_node) -> int __init {
    static int __init arm_smmu_v3_count_resources(struct acpi_iort_node *node)
    {
    struct acpi_iort_smmu_v3 *smmu;
// Always present mem resource
    let mut num_res: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_is_combined_irq(smmu: *mut acpi_iort_smmu_v3) -> bool {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_resource_size(smmu: *mut acpi_iort_smmu_v3) -> c_ulong {
...
//
    ...
    let mut dev_node: c_int = pxm_to_node(smmu.pxm);
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_count_resources(node: *mut acpi_iort_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_pmcg_count_resources(node: *mut acpi_iort_node) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_v3_pmcg_add_platdata(pdev: *mut platform_device) -> int __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iort_dev_config {
    pub name: *const c_char,
    pub node): *mut *mut int (dev_init)(struct acpi_iort_node,
    void (*dev_dma_configure)(struct device *dev,
    pub node): *mut acpi_iort_node,
    pub node): *mut *mut int (dev_count_resources)(struct acpi_iort_node,
    void (*dev_init_resources)(struct resource *res,
    pub node): *mut acpi_iort_node,
    int (*dev_set_proximity)(struct device *dev,
    pub node): *mut acpi_iort_node,
    pub pdev): *mut *mut int (dev_add_platdata)(struct platform_device,
}
...
#[no_mangle]
unsafe extern "C" fn iort_enable_acs(iort_node: *mut acpi_iort_node) -> void __init {
...
#[no_mangle]
unsafe extern "C" fn iort_init_platform_devices() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_iort_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_iort_dma_get_max_cpu_address() -> phys_addr_t __init {
    phys_addr_t __init acpi_iort_dma_get_max_cpu_address(void)
    {
    let mut limit: phys_addr_t = PHYS_ADDR_MAX;
