...
//! Source: drivers/acpi/arm64/gtdt.c
#![no_std]
...
pub struct acpi_gtdt_descriptor {
    ...
    pub gtdt_end: *mut c_void,
    pub platform_timer: *mut c_void,
}
...
#[no_mangle]
unsafe extern "C" fn platform_timer_valid(platform_timer: *mut c_void) -> __init bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_timer_block(platform_timer: *mut c_void) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_non_secure_watchdog(platform_timer: *mut c_void) -> bool {
...
#[no_mangle]
unsafe extern "C" fn map_gt_gsi(interrupt: u32, flags: u32) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_gtdt_map_ppi(type: c_int) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_gtdt_c3stop(type: c_int) -> bool __init {
...
//
    ...
    let mut nr_res: c_int = ARRAY_SIZE(res);
...
#[no_mangle]
unsafe extern "C" fn gtdt_platform_timer_init() -> int __init {
...
//
    ...
    let mut atm: arch_timer_mem = {};
    struct platform_device *pdev;
    ret = gtdt_parse_timer_block(platform_timer, &atm);
    if (ret)
    continue;
    pdev = platform_device_register_data(core::ptr::null_mut(), "gtdt-arm-mmio-timer",
