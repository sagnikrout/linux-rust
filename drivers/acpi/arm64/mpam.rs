...
//! Source: drivers/acpi/arm64/mpam.c
#![no_std]
...
pub const ACPI_MPAM_MSC_IRQ_TYPE_WIRED: c_int = 0;

pub const ACPI_MPAM_MSC_IRQ_AFFINITY_TYPE_PROCESSOR: c_int = 0;
pub const ACPI_MPAM_MSC_IRQ_AFFINITY_TYPE_PROCESSOR_CONTAINER: c_int = 1;

//
// Encodings for the MSC node body interface type field.
// See 2.1 MPAM MSC node, Table 4 of DEN0065B_MPAM_ACPI_3.0-bet.
//
pub const ACPI_MPAM_MSC_IFACE_MMIO: c_uint = 0x00;
pub const ACPI_MPAM_MSC_IFACE_PCC: c_uint = 0x0a;
#[no_mangle]
unsafe extern "C" fn _is_ppi_partition(flags: u32) -> bool {
...
//
    ...
    let mut acpi_id_valid: bool = false;
...
#[no_mangle]
unsafe extern "C" fn acpi_mpam_parse_msc(tbl_msc: *mut acpi_mpam_msc_node) -> *mut platform_device  __init {
    ...
    let mut next_res: c_int = 0, next_prop = 0, err;
...
//
    ...
    err = device_create_managed_software_node(&pdev.dev, props, core::ptr::null_mut());
    if (err)
    return ERR_PTR(err);
//
...
#[no_mangle]
unsafe extern "C" fn acpi_mpam_parse() -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_mpam_count_msc() -> c_int {
