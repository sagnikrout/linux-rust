...
pub const ACPI_BUTTON_TYPE_UNKNOWN: c_uint = 0x00;
pub const ACPI_BUTTON_NOTIFY_WAKE: c_uint = 0x02;
pub const ACPI_BUTTON_NOTIFY_STATUS: c_uint = 0x80;

pub const ACPI_BUTTON_TYPE_POWER: c_uint = 0x01;

pub const ACPI_BUTTON_TYPE_SLEEP: c_uint = 0x03;

pub const ACPI_BUTTON_TYPE_LID: c_uint = 0x05;
    enum {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_button {
    pub adev: *mut acpi_device,
    pub /: *mut *mut *mut device dev; / physical button device,
    pub type: c_uint,
    pub input: *mut input_dev,
    pub /: *const *const *const char class; / for netlink messages,
    pub /: *mut *mut char phys[32]; / for input device,
    pub pushed: c_ulong,
    pub last_state: bool,
    pub last_time: ktime_t,
    pub suspended: bool,
    pub lid_state_initialized: bool,
    pub gpe_enabled: bool,
}

    let mut lid_init_state: static long = -1;
    let mut __read_mostly: static unsigned long lid_report_interval = 500;
...
#[no_mangle]
unsafe extern "C" fn acpi_lid_evaluate_state(lid_handle: acpi_handle) -> c_int {
    static int acpi_lid_evaluate_state(acpi_handle lid_handle)
    {
    unsigned long long lid_state;
    acpi_status status;
    status = acpi_evaluate_integer(lid_handle, "_LID", core::ptr::null_mut(), &lid_state);
    if (ACPI_FAILURE(status))
    return -ENODEV;
    return !!lid_state;
    }
#[no_mangle]
unsafe extern "C" fn acpi_lid_notify_state(button: *mut acpi_button, state: bool) {
...
#[no_mangle]
unsafe extern "C" fn acpi_lid_add_fs(button: *mut acpi_button) -> c_int {
    static int acpi_lid_add_fs(struct acpi_button *button)
    {
    struct acpi_device *device = button.adev;
    struct proc_dir_entry *entry = core::ptr::null_mut();
...
// create /proc/acpi/button/lid/LID/state
    ...
    acpi_device_dir(device) = core::ptr::null_mut();
    remove_lid_dir:
    remove_proc_entry(ACPI_BUTTON_SUBCLASS_LID, acpi_button_dir);
    acpi_lid_dir = core::ptr::null_mut();
    remove_button_dir:
    remove_proc_entry(ACPI_BUTTON_CLASS, acpi_root_dir);
    acpi_button_dir = core::ptr::null_mut();
    return -ENODEV;
    }
#[no_mangle]
unsafe extern "C" fn acpi_lid_remove_fs(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_acpi_lid_add_fs(dev: *mut device, button: *mut acpi_button) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_lid_save(adev: *mut acpi_device) {
...
#[no_mangle]
unsafe extern "C" fn acpi_lid_forget(adev: *mut acpi_device) {
    static void acpi_lid_forget(struct acpi_device *adev)
    {
    guard(mutex)(&acpi_lid_lock);
    if (saved_lid_handle == adev.handle)
    saved_lid_handle = core::ptr::null_mut();
    }
// Driver Interface
#[no_mangle]
pub unsafe extern "C" fn acpi_lid_open() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_lid_update_state(button: *mut acpi_button, signal_wakeup: bool) {
...
#[no_mangle]
unsafe extern "C" fn acpi_lid_initialize_state(button: *mut acpi_button) {
...
#[no_mangle]
unsafe extern "C" fn acpi_lid_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_notify_run(data: *mut c_void) {
    static void acpi_button_notify_run(void *data)
    {
    acpi_button_notify(core::ptr::null_mut(), ACPI_BUTTON_NOTIFY_STATUS, data);
    }
#[no_mangle]
unsafe extern "C" fn acpi_button_event(data: *mut c_void) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_suspend(dev: *mut device) -> c_int {
    static int acpi_button_suspend(struct device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_resume(dev: *mut device) -> c_int {
    static int acpi_button_resume(struct device *dev)
    {
    struct acpi_button *button = dev_get_drvdata(dev);
    struct input_dev *input;
...
#[no_mangle]
unsafe extern "C" fn acpi_lid_input_open(input: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_notify_handler(button: *mut acpi_button) -> acpi_notify_handler {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_wakeup_cleanup(data: *mut c_void) {
    static void acpi_button_wakeup_cleanup(void *data)
    {
    device_init_wakeup(data, false);
    }
#[no_mangle]
unsafe extern "C" fn devm_acpi_button_init_wakeup(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_remove_event_handler(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_add_event_handler(button: *mut acpi_button) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_probe(pdev: *mut platform_device) -> c_int {
    static int acpi_button_probe(struct platform_device *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_remove(pdev: *mut platform_device) {
    static void acpi_button_remove(struct platform_device *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn param_get_lid_init_state(buf: *mut c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_button_exit() -> void __exit {
