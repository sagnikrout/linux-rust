...
//! Source: drivers/acpi/acpi_ipmi.c
#![no_std]
...
//
    ...
    MODULE_LICENSE("GPL");
pub const ACPI_IPMI_OK: c_int = 0;
pub const ACPI_IPMI_TIMEOUT: c_uint = 0x10;
pub const ACPI_IPMI_UNKNOWN: c_uint = 0x07;
// the IPMI timeout is 5s

pub const ACPI_IPMI_MAX_MSG_LENGTH: c_int = 64;
// 2s should be suffient for SMI being selected

#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_ipmi_device {
// the device list attached to driver_data.ipmi_devices
    pub head: list_head,
// the IPMI request message list
    pub tx_msg_list: list_head,
    pub tx_msg_lock: spinlock_t,
    pub handle: acpi_handle,
    pub dev: *mut device,
    pub user_interface: *mut ipmi_user,
    pub /: *mut *mut int ipmi_ifnum; / IPMI interface number,
    pub curr_msgid: c_long,
    pub dead: bool,
    pub kref: kref,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ipmi_driver_data {
    pub ipmi_devices: list_head,
...
//
    pub selected_smi: *mut acpi_ipmi_device,
    pub smi_selection_done: completion,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_ipmi_msg {
    pub head: list_head,
//
...
// tx/rx data . And copy it from/to ACPI object buffer
    pub data: [u8; ACPI_IPMI_MAX_MSG_LENGTH],
    pub rx_len: u8,
    pub device: *mut acpi_ipmi_device,
    pub kref: kref,
}
...
#[no_mangle]
unsafe extern "C" fn ipmi_dev_release(ipmi_device: *mut acpi_ipmi_device) {
...
#[no_mangle]
unsafe extern "C" fn __ipmi_dev_kill(ipmi_device: *mut acpi_ipmi_device) {
    static void __ipmi_dev_kill(struct acpi_ipmi_device *ipmi_device)
    {
    list_del(&ipmi_device.head);
    if (driver_data.selected_smi == ipmi_device)
    driver_data.selected_smi = core::ptr::null_mut();
//
...
//
    ...
    {
    struct acpi_ipmi_device *ipmi_device = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn acpi_ipmi_dev_put(ipmi_device: *mut acpi_ipmi_device) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_msg_release(tx_msg: *mut acpi_ipmi_msg) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_msg_release_kref(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn acpi_ipmi_msg_put(tx_msg: *mut acpi_ipmi_msg) {
...
#[no_mangle]
unsafe extern "C" fn ipmi_flush_tx_msg(ipmi: *mut acpi_ipmi_device) {
...
// wake up the sleep thread on the Tx msg
    ...
    {
    struct acpi_ipmi_msg *tx_msg = core::ptr::null_mut(), *iter, *temp;
    unsigned long flags;
    spin_lock_irqsave(&ipmi.tx_msg_lock, flags);
...
#[no_mangle]
unsafe extern "C" fn ipmi_register_bmc(iface: c_int, dev: *mut device) {
    static void ipmi_register_bmc(int iface, struct device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn ipmi_bmc_gone(iface: c_int) {
    static void ipmi_bmc_gone(int iface)
    {
    struct acpi_ipmi_device *ipmi_device = core::ptr::null_mut(), *iter, *temp;
    mutex_lock(&driver_data.ipmi_lock);
...
// Do not add a tx_msg that can not be flushed.
    ...
    tx_msg.tx_msgid,
    &tx_msg.tx_message,
    core::ptr::null_mut(), 0, 0, IPMI_TIMEOUT);
    if (err) {
    status = AE_ERROR;
    goto out_msg;
    }
...
#[no_mangle]
pub unsafe extern "C" fn acpi_wait_for_acpi_ipmi() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_ipmi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_ipmi_exit() -> void __exit {
