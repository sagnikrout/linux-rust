...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_nhlt_get_gbl_table() -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_nhlt_put_gbl_table() {
...
#[no_mangle]
unsafe extern "C" fn acpi_nhlt_config_is_micdevice(cfg: *mut acpi_nhlt_config) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acpi_nhlt_config_is_vendor_micdevice(cfg: *mut acpi_nhlt_config) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_nhlt_endpoint_mic_count(ep: *const acpi_nhlt_endpoint) -> c_int {
