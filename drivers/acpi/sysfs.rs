...
#[no_mangle]
unsafe extern "C" fn param_get_debug_layer(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn param_get_debug_level(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    ...
    {
    let mut saved_flags: u32 = 0;
    let mut is_abs_path: bool = true;
    if (*val != '\\')
    is_abs_path = false;
...
//
    ...
    (void)acpi_debug_trace(core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn param_get_trace_method_name(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
...
// So "xxx-once" comparison should go prior than "xxx" comparison
    ...
    method = core::ptr::null_mut();
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !acpi_compare_param(val, _arg: "method-once")) -> else {
    else if (!acpi_compare_param(val, "method-once"))
    flags = ACPI_TRACE_ENABLED | ACPI_TRACE_ONESHOT;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !acpi_compare_param(val, _arg: "method")) -> else {
    else if (!acpi_compare_param(val, "method"))
    flags = ACPI_TRACE_ENABLED;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !acpi_compare_param(val, _arg: "opcode-once")) -> else {
    else if (!acpi_compare_param(val, "opcode-once"))
    flags = ACPI_TRACE_ENABLED | ACPI_TRACE_ONESHOT | ACPI_TRACE_OPCODE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !acpi_compare_param(val, _arg: "opcode")) -> else {
...
#[no_mangle]
unsafe extern "C" fn param_get_trace_state(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
...
// /sys/module/acpi/parameters/acpica_version
    ...
    module_param_call(acpica_version, core::ptr::null_mut(), param_get_acpica_version, core::ptr::null_mut(), 0444);
//
...
pub const ACPI_MAX_TABLE_INSTANCES: c_int = 999;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_table_attr {
    pub attr: bin_attribute,
    pub name: [c_char; ACPI_NAMESEG_SIZE],
    pub instance: c_int,
    pub filename: [c_char; ACPI_NAMESEG_SIZE+ACPI_INST_SIZE],
    pub node: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_data_attr {
    pub attr: bin_attribute,
    pub addr: u64,
    pub filename: [c_char; ACPI_NAMESEG_SIZE+ACPI_INST_SIZE],
}
    ...
    struct acpi_table_header *table_header = core::ptr::null_mut();
    acpi_status status;
    ssize_t rc;
    ...
    struct acpi_table_attr *attr = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn acpi_sysfs_table_handler(event: u32, table: *mut c_void, context: *mut c_void) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn acpi_bert_data_init(th: *mut c_void, data_attr: *mut acpi_data_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_ccel_data_init(th: *mut c_void, data_attr: *mut acpi_data_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_data_init(th: *mut acpi_table_header, table_attr: *mut acpi_table_attr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_tables_sysfs_init() -> c_int {
...
pub const COUNT_GPE: c_int = 0;

pub const NUM_COUNTERS_EXTRA: c_int = 4;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct event_counter {
    pub count: u32,
    pub flags: u32,
}
...
#[no_mangle]
unsafe extern "C" fn delete_gpe_attr_array() {
    static void delete_gpe_attr_array(void)
    {
    struct event_counter *tmp = all_counters;
    all_counters = core::ptr::null_mut();
    kfree(tmp);
    if (counter_attrs) {
    int i;
...
#[no_mangle]
unsafe extern "C" fn gpe_count(gpe_number: u32) {
...
#[no_mangle]
unsafe extern "C" fn fixed_event_count(event_number: u32) {
    ...
    {
    let mut index: c_int = attr - counter_attrs;
    int size;
    acpi_handle handle;
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_EVENT_FLAG_ENABLED: status &) -> else {
    else if (status & ACPI_EVENT_FLAG_ENABLED)
    size += sysfs_emit_at(buf, size, " enabled     ");
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_EVENT_FLAG_WAKE_ENABLED: status &) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "mask\n")) -> else {
    else if (!strcmp(buf, "mask\n"))
    result = acpi_mask_gpe(handle, index, TRUE);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(buf, _arg: "unmask\n")) -> else {
    else if (!strcmp(buf, "unmask\n"))
    result = acpi_mask_gpe(handle, index, FALSE);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !kstrtoul(buf, _arg: 0, _arg: &tmp)) -> else {
    else if (!kstrtoul(buf, 0, &tmp))
    all_counters[index].count = tmp;
    else
    result = -EINVAL;
    } else if (index < num_gpes + ACPI_NUM_FIXED_EVENTS) {
    let mut event: c_int = index - num_gpes;
    if (!strcmp(buf, "disable\n") &&
...
pub unsafe extern "C" fn if(_arg: !kstrtoul(buf, _arg: 0, _arg: &tmp)) -> else {
    ...
    all_counters[index].count = strtoul(buf, core::ptr::null_mut(), 0);
...
//
pub const ACPI_MASKABLE_GPE_MAX: c_uint = 0x100;
    static DECLARE_BITMAP(acpi_masked_gpes_map, ACPI_MASKABLE_GPE_MAX) __initdata;
#[no_mangle]
unsafe extern "C" fn acpi_gpe_set_masked_gpes(val: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_gpe_apply_masked_gpes() -> void __init {
...
pub unsafe extern "C" fn acpi_irq_stats_init() {
    ...
    if (all_attrs == core::ptr::null_mut())
    return;
    all_counters = kzalloc_objs(*all_counters, num_counters);
    if (all_counters == core::ptr::null_mut())
    goto fail;
    status = acpi_install_global_event_handler(acpi_global_event_handler, core::ptr::null_mut());
    if (ACPI_FAILURE(status))
    goto fail;
    counter_attrs = kzalloc_objs(*counter_attrs, num_counters);
    if (counter_attrs == core::ptr::null_mut())
    goto fail;
    for (i = 0; i < num_counters; ++i) {
    char buffer[12];
    char *name;
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_EVENT_PMTIMER: i == num_gpes +) -> else {
    else if (i == num_gpes + ACPI_EVENT_PMTIMER)
    sprintf(buffer, "ff_pmtimer");
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_EVENT_GLOBAL: i == num_gpes +) -> else {
    else if (i == num_gpes + ACPI_EVENT_GLOBAL)
    sprintf(buffer, "ff_gbl_lock");
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_EVENT_POWER_BUTTON: i == num_gpes +) -> else {
    else if (i == num_gpes + ACPI_EVENT_POWER_BUTTON)
    sprintf(buffer, "ff_pwr_btn");
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_EVENT_SLEEP_BUTTON: i == num_gpes +) -> else {
    else if (i == num_gpes + ACPI_EVENT_SLEEP_BUTTON)
    sprintf(buffer, "ff_slp_btn");
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_EVENT_RTC: i == num_gpes +) -> else {
    else if (i == num_gpes + ACPI_EVENT_RTC)
    sprintf(buffer, "ff_rt_clk");
#[no_mangle]
pub unsafe extern "C" fn if(COUNT_GPE: i == num_gpes + ACPI_NUM_FIXED_EVENTS +) -> else {
    else if (i == num_gpes + ACPI_NUM_FIXED_EVENTS + COUNT_GPE)
    sprintf(buffer, "gpe_all");
#[no_mangle]
pub unsafe extern "C" fn if(COUNT_SCI: i == num_gpes + ACPI_NUM_FIXED_EVENTS +) -> else {
    else if (i == num_gpes + ACPI_NUM_FIXED_EVENTS + COUNT_SCI)
    sprintf(buffer, "sci");
#[no_mangle]
pub unsafe extern "C" fn if(COUNT_SCI_NOT: i == num_gpes + ACPI_NUM_FIXED_EVENTS +) -> else {
    else if (i == num_gpes + ACPI_NUM_FIXED_EVENTS + COUNT_SCI_NOT)
    sprintf(buffer, "sci_not");
#[no_mangle]
pub unsafe extern "C" fn if(COUNT_ERROR: i == num_gpes + ACPI_NUM_FIXED_EVENTS +) -> else {
...
#[no_mangle]
unsafe extern "C" fn interrupt_stats_exit() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn pm_profile_show(kobj: *mut kobject, attr: *mut kobj_attribute, buf: *mut c_char) -> isize {
    static ssize_t pm_profile_show(struct kobject *kobj, struct kobj_attribute *attr, char *buf)
    {
    return sysfs_emit(buf, "%d\n", acpi_gbl_FADT.preferred_profile);
    }
    let mut pm_profile_attr: static struct kobj_attribute = __ATTR_RO(pm_profile);
#[no_mangle]
unsafe extern "C" fn enabled_show(kobj: *mut kobject, attr: *mut kobj_attribute, buf: *mut c_char) -> isize {
    ...
    let mut hotplug_enabled_attr: static struct kobj_attribute = __ATTR_RW(enabled);
    ...
    let mut force_remove_attr: static struct kobj_attribute = __ATTR_RW(force_remove);
#[no_mangle]
pub unsafe extern "C" fn acpi_sysfs_init() -> int __init {
