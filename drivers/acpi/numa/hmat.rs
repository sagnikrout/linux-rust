...
//! Source: drivers/acpi/numa/hmat.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn disable_hmat() -> void __init {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct memory_target {
    pub node: list_head,
    pub memory_pxm: c_uint,
    pub processor_pxm: c_uint,
    pub memregions: resource,
    pub coord: [access_coordinate; NODE_ACCESS_CLASS_MAX],
    pub caches: list_head,
    pub cache_attrs: node_cache_attrs,
    pub gen_port_device_handle: [u8; ACPI_SRAT_DEVICE_HANDLE_SIZE],
    pub registered: bool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct memory_initiator {
    pub node: list_head,
    pub processor_pxm: c_uint,
    pub has_cpu: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct memory_locality {
    pub node: list_head,
    pub hmat_loc: *mut acpi_hmat_locality,
}
...
//
    ...
    {
    let mut pxm: c_uint = node_to_pxm(nid);
    struct memory_target *target;
...
#[no_mangle]
unsafe extern "C" fn alloc_memory_initiator(cpu_pxm: c_uint) -> __init void {
...
#[no_mangle]
unsafe extern "C" fn alloc_genport_target(mem_pxm: c_uint, handle: *mut u8) -> __init void {
...
#[no_mangle]
unsafe extern "C" fn hmat_normalize(entry: u16, base: u64, type: u8) -> u32 {
...
//
    ...
    return 0;
#[no_mangle]
pub unsafe extern "C" fn if((entry)): base > (UINT_MAX /) -> else {
...
#[no_mangle]
unsafe extern "C" fn hmat_add_locality(hmat_loc: *mut acpi_hmat_locality) -> __init void {
...
// Extended Linear mode is only valid if cache is direct mapped
    ...
    struct memory_target *target = core::ptr::null_mut();
    ...
    let mut p_node: c_int = pxm_to_node(p.processor_PD);
...
#[no_mangle]
unsafe extern "C" fn hmat_update_best(type: u8, value: u32, best: *mut u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn initiators_to_nodemask(p_nodes: *mut c_ulong) -> c_int {
    ...
    struct memory_locality *loc = core::ptr::null_mut();
    let mut best: u32 = 0;
    int i;
...
// initiators.
//
    list_sort(core::ptr::null_mut(), &initiators, initiator_cmp);
...
#[no_mangle]
unsafe extern "C" fn hmat_update_generic_target(target: *mut memory_target) {
...
#[no_mangle]
unsafe extern "C" fn hmat_register_target_initiators(target: *mut memory_target) {
...
#[no_mangle]
unsafe extern "C" fn hmat_register_target_cache(target: *mut memory_target) {
    static void hmat_register_target_cache(struct memory_target *target)
    {
    let mut mem_nid: unsigned = pxm_to_node(target.memory_pxm);
    struct target_cache *tcache;
    list_for_each_entry(tcache, &target.caches, node)
    node_add_cache(mem_nid, &tcache.cache_attrs);
    }
#[no_mangle]
unsafe extern "C" fn hmat_register_target_perf(target: *mut memory_target, access: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hmat_register_target_devices(target: *mut memory_target) {
...
//
    ...
    let mut target_nid: c_int = pxm_to_node(target.memory_pxm);
    hmem_register_resource(target_nid, res);
    }
    }
#[no_mangle]
unsafe extern "C" fn hmat_hotplug_target(target: *mut memory_target) {
    static void hmat_hotplug_target(struct memory_target *target)
    {
    let mut nid: c_int = pxm_to_node(target.memory_pxm);
//
...
#[no_mangle]
unsafe extern "C" fn hmat_register_target(target: *mut memory_target) {
...
#[no_mangle]
unsafe extern "C" fn hmat_register_targets() {
...
#[no_mangle]
unsafe extern "C" fn hmat_set_default_dram_perf() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hmat_free_structures() -> __init void {
...
#[no_mangle]
unsafe extern "C" fn hmat_init() -> __init int {
