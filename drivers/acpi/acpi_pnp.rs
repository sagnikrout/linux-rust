...
//! Source: drivers/acpi/acpi_pnp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn matching_id(idstr: *const c_char, list_id: *const c_char) -> bool {
    ...
    return false;
    for (i = 3; i < 7; i++) {
    let mut c: c_char = toupper(idstr[i]);
    if (!isxdigit(c)
...
#[no_mangle]
unsafe extern "C" fn acpi_pnp_match(idstr: *const c_char, matchid: *const acpi_device_id) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_is_pnp_device(adev: *mut acpi_device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_pnp_init() -> void __init {
