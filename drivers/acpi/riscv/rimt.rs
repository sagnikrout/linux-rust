...
//! Source: drivers/acpi/riscv/rimt.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rimt_fwnode {
    pub list: list_head,
    pub rimt_node: *mut acpi_rimt_node,
...
//
#[no_mangle]
pub unsafe extern "C" fn rimt_iommu_register(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rimt_pcie_rc_supports_ats(node: *mut acpi_rimt_node) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rimt_iommu_xlate(dev: *mut device, node: *mut acpi_rimt_node, deviceid: u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rimt_pci_alias_info {
    pub dev: *mut device,
    pub node: *mut acpi_rimt_node,
    pub ops: *const iommu_ops,
}

#[no_mangle]
unsafe extern "C" fn rimt_id_map(map: *mut acpi_rimt_id_mapping, type: u8, rid_in: u32, rid_out: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rimt_pci_iommu_init(pdev: *mut pci_dev, alias: u16, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rimt_plat_iommu_map(dev: *mut device, node: *mut acpi_rimt_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rimt_iommu_configure_id(dev: *mut device, id_in: *const u32) -> c_int {
    ...
    let mut info: rimt_pci_alias_info = { .dev = dev };
...
#[no_mangle]
pub unsafe extern "C" fn riscv_acpi_rimt_init() -> void __init {
