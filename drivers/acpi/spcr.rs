...
//
#[no_mangle]
unsafe extern "C" fn qdf2400_erratum_44_present(h: *mut acpi_table_header) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn xgene_8250_erratum_present(tb: *mut acpi_table_spcr) -> bool {
    static bool xgene_8250_erratum_present(struct acpi_table_spcr *tb)
    {
    let mut xgene_8250: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_parse_spcr(enable_earlycon: bool, enable_console: bool) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn switch(_arg: table->baud_rate) -> else {
    case 0:
//
