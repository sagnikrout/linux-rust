...
//! Source: drivers/acpi/acpi_configfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_table {
    pub cfg: config_item,
    pub header: *mut acpi_table_header,
    pub index: u32,
}
    ...
    if (ret) {
    kfree(table.header);
    table.header = core::ptr::null_mut();
    }
    return ret;
    }
    ...
    CONFIGFS_BIN_ATTR(acpi_table_, aml, core::ptr::null_mut(), MAX_ACPI_TABLE_SIZE);
    static struct configfs_bin_attribute *acpi_table_bin_attrs[] = {
    &acpi_table_attr_aml,
    core::ptr::null_mut(),
    };
#[no_mangle]
unsafe extern "C" fn acpi_table_signature_show(cfg: *mut config_item, str: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_length_show(cfg: *mut config_item, str: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_revision_show(cfg: *mut config_item, str: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_oem_id_show(cfg: *mut config_item, str: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_oem_table_id_show(cfg: *mut config_item, str: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_oem_revision_show(cfg: *mut config_item, str: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn acpi_configfs_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_configfs_exit() -> void __exit {
