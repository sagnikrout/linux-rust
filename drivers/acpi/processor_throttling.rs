...
//! Source: drivers/acpi/processor_throttling.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct throttling_tstate {
    pub /: *mut *mut unsigned int cpu; / cpu nr,
    pub /: *mut *mut int target_state; / target T-state,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct acpi_processor_throttling_arg {
    pub pr: *mut acpi_processor,
    pub target_state: c_int,
    pub force: bool,
}
...
#[no_mangle]
unsafe extern "C" fn acpi_processor_update_tsd_coord() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_processor_throttling_init() {
...
#[no_mangle]
unsafe extern "C" fn acpi_processor_throttling_notifier(event: c_ulong, data: *mut c_void) -> c_int {
...
unsafe extern "C" fn acpi_processor_get_platform_limit(pr: *mut acpi_processor) -> c_int {
    ...
    let mut tpc: c_ulonglong = 0;
    if (!pr)
    return -EINVAL;
    if (ignore_tpc)
    goto end;
    status = acpi_evaluate_integer(pr.handle, "_TPC", core::ptr::null_mut(), &tpc);
...
#[no_mangle]
pub unsafe extern "C" fn acpi_processor_tstate_has_changed(pr: *mut acpi_processor) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_processor_get_throttling_control(pr: *mut acpi_processor) -> c_int {
    static int acpi_processor_get_throttling_control(struct acpi_processor *pr)
    {
    let mut result: c_int = 0;
    let mut status: acpi_status = 0;
    let mut buffer: acpi_buffer = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
    union acpi_object *ptc = core::ptr::null_mut();
    union acpi_object obj;
    struct acpi_processor_throttling *throttling;
    status = acpi_evaluate_object(pr.handle, "_PTC", core::ptr::null_mut(), &buffer);
    if (ACPI_FAILURE(status)) {
    if (status != AE_NOT_FOUND)
...
//
    ...
    || (obj.buffer.pointer == core::ptr::null_mut())) {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_processor_get_throttling_states(pr: *mut acpi_processor) -> c_int {
    ...
    union acpi_object *tss = core::ptr::null_mut();
    int i;
    status = acpi_evaluate_object(pr.handle, "_TSS", core::ptr::null_mut(), &buffer);
    if (ACPI_FAILURE(status)) {
    if (status != AE_NOT_FOUND)
...
//
#[no_mangle]
unsafe extern "C" fn acpi_processor_get_tsd(pr: *mut acpi_processor) -> c_int {
    ...
    let mut format: acpi_buffer = { sizeof("NNNNN"), "NNNNN" };
    let mut state: acpi_buffer = { 0, core::ptr::null_mut() };
    union acpi_object *tsd = core::ptr::null_mut();
    struct acpi_tsd_package *pdomain;
    struct acpi_processor_throttling *pthrottling;
    pthrottling = &pr.throttling;
    pthrottling.tsd_valid_flag = 0;
    status = acpi_evaluate_object(pr.handle, "_TSD", core::ptr::null_mut(), &buffer);
    if (ACPI_FAILURE(status)) {
    if (status != AE_NOT_FOUND)
...
// --------------------------------------------------------------------------
    ...
    -------------------------------------------------------------------------- */
#[no_mangle]
unsafe extern "C" fn acpi_processor_get_throttling_fadt(pr: *mut acpi_processor) -> c_int {
    static int acpi_processor_get_throttling_fadt(struct acpi_processor *pr)
    {
    let mut state: c_int = 0;
    let mut value: u32 = 0;
    let mut duty_mask: u32 = 0;
    let mut duty_value: u32 = 0;
    if (!pr)
    return -EINVAL;
    if (!pr.flags.throttling)
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn acpi_throttling_rdmsr(value: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_throttling_wrmsr(value: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_processor_get_throttling_ptc(pr: *mut acpi_processor) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __acpi_processor_get_throttling(data: *mut c_void) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn acpi_processor_get_throttling(pr: *mut acpi_processor) -> c_int {
    static int acpi_processor_get_throttling(struct acpi_processor *pr)
    {
    if (!pr)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn acpi_processor_get_fadt_info(pr: *mut acpi_processor) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(4: (pr->throttling.duty_offset + pr->throttling.duty_width) >) -> else {
...
#[no_mangle]
unsafe extern "C" fn acpi_processor_throttling_fn(data: *mut c_void) -> c_long {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_processor_get_throttling_info(pr: *mut acpi_processor) -> c_int {
