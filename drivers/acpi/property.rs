...
//! Source: drivers/acpi/property.c
#![no_std]
...
// ACPI _DSD data buffer GUID [1]: edb12dd0-363d-4085-a3d2-49522ca160c4
    ...
    let mut scope: acpi_handle = core::ptr::null_mut();
    bool result;
...
//
    ...
    return false;
    status = acpi_evaluate_object_typed(handle, core::ptr::null_mut(), core::ptr::null_mut(), &buf,
    ACPI_TYPE_PACKAGE);
    if (ACPI_FAILURE(status))
    return false;
...
//
    ...
    result = acpi_nondev_subnode_extract(desc, core::ptr::null_mut(), link,
    list, parent);
    break;
...
#[no_mangle]
unsafe extern "C" fn acpi_property_value_ok(value: *const union acpi_object) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acpi_properties_format_valid(properties: *const union acpi_object) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acpi_init_of_compatible(adev: *mut acpi_device) {
...
#[no_mangle]
unsafe extern "C" fn acpi_is_property_guid(guid: *const guid_t) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acpi_nondev_subnode_tag(handle: acpi_handle, context: *mut c_void) {
    static void acpi_nondev_subnode_tag(acpi_handle handle, void *context)
    {
    }
#[no_mangle]
unsafe extern "C" fn acpi_untie_nondev_subnodes(data: *mut acpi_device_data) {
...
#[no_mangle]
unsafe extern "C" fn acpi_tie_nondev_subnodes(data: *mut acpi_device_data) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_init_properties(adev: *mut acpi_device) {
    void acpi_init_properties(struct acpi_device *adev)
    {
    let mut buf: acpi_buffer = { ACPI_ALLOCATE_BUFFER };
    struct acpi_hardware_id *hwid;
    acpi_status status;
    let mut acpi_of: bool = false;
...
//
    ...
    status = acpi_evaluate_object_typed(adev.handle, "_DSD", core::ptr::null_mut(), &buf,
    ACPI_TYPE_PACKAGE);
    if (ACPI_FAILURE(status))
    goto out;
...
#[no_mangle]
unsafe extern "C" fn acpi_free_device_properties(list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn acpi_destroy_nondev_subnodes(list: *mut list_head) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_free_properties(adev: *mut acpi_device) {
    void acpi_free_properties(struct acpi_device *adev)
    {
    acpi_untie_nondev_subnodes(&adev.data);
    acpi_destroy_nondev_subnodes(&adev.data.subnodes);
    ACPI_FREE((void *)adev.data.pointer);
    adev.data.of_compatible = core::ptr::null_mut();
    adev.data.pointer = core::ptr::null_mut();
...
//
    ...
    let mut type: acpi_object_type = (*element)[i].type;
    ...
    if (ret)
    let mut ret: return = = -EINVAL ? -ENOENT : -EINVAL;
    switch (obj.type) {
    case ACPI_TYPE_LOCAL_REFERENCE:
...
//
    ...
    return -EINVAL;
    element++;
    ret = acpi_get_ref_args(idx == index ? args : core::ptr::null_mut(),
...
//
    ...
    struct fwnode_reference_args *args)
    {
    return acpi_fwnode_get_reference_args(fwnode, propname, core::ptr::null_mut(), num_args, index, args);
    }
...
#[no_mangle]
pub unsafe extern "C" fn if(DEV_PROP_STRING: proptype ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn stop_on_next(adev: *mut acpi_device, data: *mut c_void) -> c_int {
...
//
    ...
    {
    struct fwnode_handle *port = core::ptr::null_mut();
...
// Direct endpoint reference?
    ...
    return args.nargs ? core::ptr::null_mut() : args.fwnode;
//
...
#[no_mangle]
unsafe extern "C" fn acpi_fwnode_device_is_available(fwnode: *const fwnode_handle) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acpi_fwnode_device_dma_supported(fwnode: *const fwnode_handle) -> bool {
    ...
    const char *propname)
    {
    return !acpi_node_prop_get(fwnode, propname, core::ptr::null_mut());
    }
    static int
...
#[no_mangle]
pub unsafe extern "C" fn is_acpi_device_node(fwnode: *const fwnode_handle) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn is_acpi_data_node(fwnode: *const fwnode_handle) -> bool {
