...
//! Source: drivers/acpi/acpi_platform.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn acpi_platform_resource_count(ares: *mut acpi_resource, data: *mut c_void) -> c_uint {
...
//
    ...
    struct resource *resources = core::ptr::null_mut();
...
// If the ACPI node already has a physical device attached, skip it.
    ...
    let mut has_resources: bool = false;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_platform_init() -> void __init {
