...
pub const ACPI_MAX_TABLES: c_int = 128;
...
//
    let mut __initdata_or_acpilib: static bool acpi_verify_table_checksum = false;
#[no_mangle]
pub unsafe extern "C" fn acpi_table_print_madt_entry(header: *mut acpi_subtable_header) {
    ...
    core::ptr::null_mut(), handler_arg, arg, 0);
    }
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), max_entries);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_table_parse(id: *mut c_char, handler: acpi_tbl_table_handler) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn check_multiple_madt() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_taint(table: *mut acpi_table_header) {
...
#[no_mangle]
unsafe extern "C" fn acpi_table_checksum(buffer: *mut u8, length: u32) -> u8 __init {
...
pub const NR_ACPI_INITRD_TABLES: c_int = 64;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_table_upgrade() -> void __init {
    ...
    if (data == core::ptr::null_mut() || size == 0)
    return;
...
//
    ...
    let mut size: phys_addr_t = acpi_initrd_files[no].size;
    let mut dest_addr: phys_addr_t = acpi_tables_addr + total_offset;
...
#[no_mangle]
unsafe extern "C" fn acpi_table_initrd_scan() -> void __init {
...
// new_table = (struct acpi_table_header *)&dsdt_amlcode;
    ...
    if (*new_table != core::ptr::null_mut())
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_locate_initial_tables() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_reserve_initial_tables() -> void __init {
    void __init acpi_reserve_initial_tables(void)
    {
    int i;
    for (i = 0; i < ACPI_MAX_TABLES; i++) {
    struct acpi_table_desc *table_desc = &initial_tables[i];
    let mut start: u64 = table_desc.address;
    let mut size: u64 = table_desc.length;
    if (!start || !size)
    break;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_table_init_complete() -> void __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_table_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_parse_apic_instance(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_force_table_verification_setup(s: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_force_32bit_fadt_addr(s: *mut c_char) -> int __init {
