...
//! Source: drivers/acpi/acpi_pad.c
#![no_std]
...
pub const ACPI_PROCESSOR_AGGREGATOR_STATUS_SUCCESS: c_int = 0;
pub const ACPI_PROCESSOR_AGGREGATOR_STATUS_NO_ACTION: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn power_saving_mwait_init() {
    static void power_saving_mwait_init(void)
    {
    unsigned int eax, ebx, ecx, edx;
    let mut highest_cstate: c_uint = 0;
    let mut highest_subcstate: c_uint = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn round_robin_cpu(tsk_index: c_uint) {
    static void round_robin_cpu(unsigned int tsk_index)
    {
    struct cpumask *pad_busy_cpus = to_cpumask(pad_busy_cpus_bits);
    cpumask_var_t tmp;
    int cpu;
    let mut min_weight: c_ulong = -1;
...
#[no_mangle]
unsafe extern "C" fn exit_round_robin(tsk_index: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn power_saving_thread(data: *mut c_void) -> c_int {
    static int power_saving_thread(void *data)
    {
    int do_sleep;
    let mut tsk_index: c_uint = (unsigned long)data;
...
#[no_mangle]
unsafe extern "C" fn create_power_saving_task() -> c_int {
    ...
    ps_tsks[ps_tsk_num] = core::ptr::null_mut();
    } else {
    rc = 0;
    ps_tsk_num++;
    }
...
#[no_mangle]
unsafe extern "C" fn destroy_power_saving_task() {
...
#[no_mangle]
unsafe extern "C" fn set_power_saving_task_num(num: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn acpi_pad_idle_cpus(num_cpus: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn acpi_pad_idle_cpus_num() -> u32 {
...
#[no_mangle]
unsafe extern "C" fn acpi_pad_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_pad_exit() -> void __exit {
