...
#[no_mangle]
unsafe extern "C" fn viot_check_bounds(hdr: *const acpi_viot_header) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn viot_get_iommu(offset: c_uint) -> *mut viot_iommu  __init {
...
#[no_mangle]
unsafe extern "C" fn viot_parse_node(hdr: *const acpi_viot_header) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_viot_early_init() -> void __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_viot_init() -> void __init {
...
unsafe extern "C" fn viot_pci_dev_iommu_init(pdev: *mut pci_dev, dev_id: u16, data: *mut c_void) -> c_int {
    ...
    let mut domain_nr: u32 = pci_domain_nr(pdev.bus);
...
#[no_mangle]
unsafe extern "C" fn viot_mmio_dev_iommu_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev_is_platform(dev)) -> else {
