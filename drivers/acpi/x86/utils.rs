...
//! Source: drivers/acpi/x86/utils.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct override_status_id {
    pub hid: [acpi_device_id; 2],
    pub cpu_ids: [x86_cpu_id; 2],
    pub /: *mut *mut dmi_system_id dmi_ids[2]; / Optional,
    ...
    { { hid, }, {} },						\
    { X86_MATCH_VFM(cpu_vfm, core::ptr::null_mut()), {} },				\
    { { .matches = dmi }, {} },					\
    uid,								\
    path,								\
    status,								\
    ...
    ENTRY(ACPI_STA_DEFAULT, hid, uid, core::ptr::null_mut(), cpu_vfm, dmi)

    ENTRY(0, hid, uid, core::ptr::null_mut(), cpu_vfm, dmi)

    ENTRY(ACPI_STA_DEFAULT, "", core::ptr::null_mut(), path, cpu_vfm, dmi)

    ENTRY(0, "", core::ptr::null_mut(), path, cpu_vfm, dmi)
...
#[no_mangle]
pub unsafe extern "C" fn acpi_device_override_status(adev: *mut acpi_device, status: *mut c_ulonglong) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_quirk_skip_i2c_client_enumeration(adev: *mut acpi_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn acpi_dmi_skip_serdev_enumeration(controller_parent: *mut device, skip: *mut bool) -> c_int {
...
//
    ...
    uid = 1;
#[no_mangle]
pub unsafe extern "C" fn if(PCI_DEVFN(0x1e: pdev->devfn ==, _arg: 4)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_quirk_skip_serdev_enumeration(controller_parent: *mut device, skip: *mut bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn acpi_proc_quirk_set_no_mwait(id: *const dmi_system_id) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_proc_quirk_mwait_check() -> void __init {
