...
//! Source: drivers/acpi/x86/apple.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_extract_apple_properties(adev: *mut acpi_device) {
    void acpi_extract_apple_properties(struct acpi_device *adev)
    {
    unsigned int i, j = 0, newsize = 0, numprops, numvalid;
    union acpi_object *props, *newprops;
    unsigned long *valid = core::ptr::null_mut();
    void *free_space;
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_TYPE_STRING: val->type ==) -> else {
