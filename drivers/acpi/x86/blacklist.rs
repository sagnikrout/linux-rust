...
//! Source: drivers/acpi/x86/blacklist.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn acpi_blacklisted() -> int __init {
    int __init acpi_blacklisted(void)
    {
    int i;
    let mut blacklisted: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn dmi_enable_rev_override(d: *const dmi_system_id) -> int __init {
    static int __init dmi_enable_rev_override(const struct dmi_system_id *d)
    {
    pr_notice("DMI detected: %s (force ACPI _REV to 5)\n", d.ident);
    acpi_rev_override_setup(core::ptr::null_mut());
    return 0;
    }
