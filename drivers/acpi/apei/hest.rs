...
//! Source: drivers/acpi/apei/hest.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn is_generic_error(hest_hdr: *mut acpi_hest_header) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hest_esrc_len(hest_hdr: *mut acpi_hest_header) -> c_int {
    static int hest_esrc_len(struct acpi_hest_header *hest_hdr)
    {
    let mut hest_type: u16 = hest_hdr.type;
    int len;
...
//
#[no_mangle]
unsafe extern "C" fn is_ghes_assist_struct(hest_hdr: *mut acpi_hest_header) -> bool {
...
#[no_mangle]
unsafe extern "C" fn apei_hest_parse(func: apei_hest_func_t, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hest_parse_cmc(hest_hdr: *mut acpi_hest_header, data: *mut c_void) -> int __init {
...
#[derive(Copy, Clone)]
pub struct ghes_arr {
    pub ghes_devs: *mut platform_device,
    pub count: c_uint,
}

#[no_mangle]
unsafe extern "C" fn hest_parse_ghes_count(hest_hdr: *mut acpi_hest_header, data: *mut c_void) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hest_parse_ghes(hest_hdr: *mut acpi_hest_header, data: *mut c_void) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hest_ghes_dev_register(ghes_count: c_uint) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn setup_hest_disable(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_hest_init() -> void __init {
    void __init acpi_hest_init(void)
    {
    acpi_status status;
    int rc;
    let mut ghes_count: c_uint = 0;
    if (hest_disable) {
    ...
    rc = apei_hest_parse(hest_parse_cmc, core::ptr::null_mut());
    if (rc)
    goto err;
    if (!ghes_disable) {
