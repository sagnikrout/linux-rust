...
//! Source: drivers/acpi/apei/einj-core.c
#![no_std]
...
pub const COMPONENT_LEN: c_int = 16;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct syndrome_array {
    union {
    pub acpi_id: [u8; COMPONENT_LEN],
    pub device_id: [u8; COMPONENT_LEN],
    pub pcie_sbdf: [u8; COMPONENT_LEN],
    pub vendor_id: [u8; COMPONENT_LEN],
    pub comp_id: },
    union {
    pub proc_synd: [u8; COMPONENT_LEN],
    pub mem_synd: [u8; COMPONENT_LEN],
    pub pcie_synd: [u8; COMPONENT_LEN],
    pub vendor_synd: [u8; COMPONENT_LEN],
    pub comp_synd: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct einjv2_extension_struct {
    pub length: u32,
    pub revision: u16,
    pub component_arr_count: u16,
    pub __counted_by(component_arr_count): syndrome_array component_arr[],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct set_error_type_with_address {
    pub type: u32,
    pub vendor_extension: u32,
    pub flags: u32,
    pub apicid: u32,
    pub memory_address: u64,
    pub memory_address_range: u64,
    pub pcie_sbdf: u32,
    pub einjv2_struct: einjv2_extension_struct,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct vendor_error_type_extension {
    pub length: u32,
    pub pcie_sbdf: u32,
    pub vendor_id: u16,
    pub device_id: u16,
...
pub const EINJ_OP_BUSY: c_uint = 0x1;
pub const EINJ_STATUS_SUCCESS: c_uint = 0x0;
pub const EINJ_STATUS_FAIL: c_uint = 0x1;
pub const EINJ_STATUS_INVAL: c_uint = 0x2;
...
//
    ...
    static bool is_v2;
#[no_mangle]
unsafe extern "C" fn einj_exec_ctx_init(ctx: *mut apei_exec_context) {
...
#[no_mangle]
unsafe extern "C" fn __einj_get_available_error_type(type: *mut u32, einj_action: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn einj_get_available_error_type(type: *mut u32, einj_action: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn einj_get_available_error_types(type1: *mut u32, type2: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn einj_timedout(t: *mut u64) -> c_int {
...
// t -= SLEEP_UNIT_MIN;
    ...
    let mut target_pa: u64 = paddr + offset + sizeof(struct vendor_error_type_extension);
    ...
    {
    let mut offset: c_int = v5param.vendor_extension;
    struct	vendor_error_type_extension v;
...
#[no_mangle]
unsafe extern "C" fn einjv2_init(e: *mut einjv2_extension_struct) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn einj_check_trigger_header(trigger_tab: *mut acpi_einj_trigger) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_memory_injection(type: u32, flags: u32) -> bool {
...
// Execute instructions in trigger error action table
    ...
    struct acpi_generic_address *trigger_param_region = core::ptr::null_mut();
    struct acpi_einj_trigger __iomem *p = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn is_end_of_list(val: *mut u8) -> bool {
    ...
    {
    struct apei_exec_context ctx;
    let mut param_size: u32 = is_v2 ? v66param_size : v5param_size;
    ...
    return -EBUSY;
#[no_mangle]
pub unsafe extern "C" fn if(EINJ_STATUS_INVAL: val ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn is_allowed_range(base_addr: u64, size: u64) -> bool {
...
#[no_mangle]
unsafe extern "C" fn available_error_type_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn einj_is_cxl_error_type(type: u64) -> bool {
    bool einj_is_cxl_error_type(u64 type)
    {
    return (type & CXL_ERROR_MASK) && (!(type & ACPI5_VENDOR_BIT));
    }
#[no_mangle]
pub unsafe extern "C" fn einj_validate_error_type(type: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn error_inject_set(data: *mut c_void, val: u64) -> c_int {
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(error_inject_fops, core::ptr::null_mut(), error_inject_set, "%llu\n");
#[no_mangle]
unsafe extern "C" fn einj_check_table(einj_tab: *mut acpi_table_einj) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn u128_read(f: *mut file, buf: *mut char __user, count: usize, off: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn u128_write(f: *mut file, buf: *const char __user, count: usize, off: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn setup_einjv2_component_files() -> bool {
...
#[no_mangle]
unsafe extern "C" fn einj_probe(fdev: *mut faux_device) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn einj_remove(fdev: *mut faux_device) {
    ...
    size = v66param_size;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: acpi5) -> else {
    else if (acpi5)
    size = v5param_size;
    else
...
#[no_mangle]
unsafe extern "C" fn einj_init() -> int __init {
    ...
    einj_dev = faux_device_create("acpi-einj", core::ptr::null_mut(), &einj_device_ops);
    if (einj_dev)
    einj_initialized = true;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn einj_exit() -> void __exit {
