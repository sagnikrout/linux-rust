...
// stuff for debugger support
    ...
    let mut acpi_sci_irq: c_uint = INVALID_ACPI_IRQ;
    let mut acpi_permanent_mmap: bool = false;
    let mut poweroff_on_fatal: static bool = true;
...
#[no_mangle]
pub unsafe extern "C" fn if(ACPI_ADR_SPACE_SYSTEM_MEMORY: gas->space_id ==) -> else {
    else if (gas.space_id == ACPI_ADR_SPACE_SYSTEM_MEMORY)
    request_mem_region(addr, length, desc);
    }
#[no_mangle]
unsafe extern "C" fn acpi_reserve_resources() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_printf(fmt: *const c_char, ...) {
...
#[no_mangle]
pub unsafe extern "C" fn __printf(_arg: 1, fmt: *const 0) acpi_os_vprintf(char, args: va_list) {
...
#[no_mangle]
unsafe extern "C" fn setup_acpi_rsdp(arg: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_get_root_pointer() -> acpi_physical_address __init {
...
// Must be called with 'acpi_ioremap_lock' or RCU read lock held.
    ...
    {
    struct acpi_ioremap *map;
    void __iomem *virt = core::ptr::null_mut();
...
pub const should_use_kmap(pfn): c_int = 0;
    ...
    if (pg_sz > PAGE_SIZE)
    return core::ptr::null_mut();
    return (void __iomem  *)kmap(pfn_to_page(pfn));
    } else
    return acpi_os_ioremap(pg_off, pg_sz);
    }
#[no_mangle]
unsafe extern "C" fn acpi_unmap(pg_off: acpi_physical_address, vaddr: *mut void __iomem) {
...
// Check if there's a suitable mapping already.
    ...
    map.virt = (void __iomem  *)((unsigned long)virt & PAGE_MASK);
    map.phys = pg_off;
    map.size = pg_sz;
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_map_memory(phys: acpi_physical_address, size: acpi_size) -> *mut void __ref {
...
#[no_mangle]
unsafe extern "C" fn acpi_os_drop_map_ref(map: *mut acpi_ioremap) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_unmap_iomem(virt: *mut void __iomem, size: acpi_size) -> void __ref {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_unmap_memory(virt: *mut c_void, size: acpi_size) -> void __ref {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_unmap_generic_address(gas: *mut acpi_generic_address) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_rev_override_setup(str: *mut c_char) -> int __init {
...
pub const ACPI_MAX_OVERRIDE_LEN: c_int = 100;
...
#[no_mangle]
unsafe extern "C" fn acpi_irq(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
//
    ...
    if (request_threaded_irq(irq, core::ptr::null_mut(), acpi_irq, IRQF_SHARED | IRQF_ONESHOT,
    "acpi", acpi_irq)) {
    pr_err("SCI (IRQ%d) allocation failed\n", irq);
    acpi_irq_handler = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_remove_interrupt_handler(gsi: u32, handler: acpi_osd_handler) -> acpi_status {
...
pub unsafe extern "C" fn acpi_os_sleep(ms: u64) {
    ...
    {
    let mut usec: u64 = ms * USEC_PER_MSEC, delta_us = 50;
//
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_stall(us: u32) {
    void acpi_os_stall(u32 us)
    {
    while (us) {
    let mut delay: u32 = 1000;
    if (delay > us)
    delay = us;
    udelay(delay);
    touch_nmi_watchdog();
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_read_iomem(virt_addr: *mut void __iomem, value: *mut u64, width: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_os_execute_deferred(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_unregister_debugger(ops: *const acpi_debugger_ops) {
    void acpi_unregister_debugger(const struct acpi_debugger_ops *ops)
    {
    mutex_lock(&acpi_debugger.lock);
    if (ops == acpi_debugger.ops) {
    acpi_debugger.ops = core::ptr::null_mut();
    acpi_debugger.owner = core::ptr::null_mut();
    }
    mutex_unlock(&acpi_debugger.lock);
    }
    EXPORT_SYMBOL(acpi_unregister_debugger);
#[no_mangle]
pub unsafe extern "C" fn acpi_debugger_create_thread(function: acpi_osd_exec_callback, context: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_debugger_write_log(msg: *const c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_debugger_read_cmd(buffer: *mut c_char, buffer_length: usize) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_debugger_wait_command_ready() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_debugger_notify_command_complete() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_debugger_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_hotplug_work_fn(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_hotplug_schedule(adev: *mut acpi_device, src: u32) -> acpi_status {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_queue_hotplug_work(work: *mut work_struct) -> bool {
    ...
    {
    struct semaphore *sem = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_wait_semaphore(handle: acpi_handle, units: u32, timeout: u16) -> acpi_status {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_get_line(buffer: *mut c_char, buffer_length: u32, bytes_read: *mut u32) -> acpi_status {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_wait_command_ready() -> acpi_status {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_notify_command_complete() -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn acpi_os_name_setup(str: *mut c_char) -> int __init {
    static int __init acpi_os_name_setup(char *str)
    {
    char *p = acpi_os_name;
    let mut count: c_int = ACPI_MAX_OVERRIDE_LEN - 1;
    if (!str || !*str)
    return 0;
    for (; count-- && *str; str++) {
...
// p++ = *str;
#[no_mangle]
pub unsafe extern "C" fn if('"': *mut *mut *mut str == '\'' || str ==) -> else {
    else if (*str == '\'' || *str == '"')
    continue;
    else
    break;
...
//
#[no_mangle]
unsafe extern "C" fn acpi_no_auto_serialize_setup(str: *mut c_char) -> int __init {
...
//
pub const ENFORCE_RESOURCES_STRICT: c_int = 2;
pub const ENFORCE_RESOURCES_LAX: c_int = 1;
pub const ENFORCE_RESOURCES_NO: c_int = 0;
    let mut acpi_enforce_resources: static unsigned int = ENFORCE_RESOURCES_STRICT;
#[no_mangle]
unsafe extern "C" fn acpi_enforce_resources_setup(str: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("lax", _arg: str)) -> else {
    else if (!strcmp("lax", str))
    acpi_enforce_resources = ENFORCE_RESOURCES_LAX;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp("no", _arg: str)) -> else {
...
// drivers
#[no_mangle]
pub unsafe extern "C" fn acpi_check_resource_conflict(res: *const resource) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_MEM: res->flags &) -> else {
    ...
    const char *name)
    {
    let mut res: resource = DEFINE_RES_IO_NAMED(start, n, name);
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_resources_are_enforced() -> c_int {
    int acpi_resources_are_enforced(void)
    {
    let mut acpi_enforce_resources: return = = ENFORCE_RESOURCES_STRICT;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_acquire_lock(lockp: acpi_spinlock) -> acpi_cpu_flags {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_release_lock(lockp: acpi_spinlock, not_used: acpi_cpu_flags) {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_purge_cache(cache: *mut acpi_cache_t) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_delete_cache(cache: *mut acpi_cache_t) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn acpi_os_release_object(cache: *mut acpi_cache_t, object: *mut c_void) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn acpi_no_static_ssdt_setup(s: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_disable_return_repair(s: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_initialize() -> acpi_status __init {
...
#[no_mangle]
pub unsafe extern "C" fn acpi_os_initialize1() -> acpi_status __init {
