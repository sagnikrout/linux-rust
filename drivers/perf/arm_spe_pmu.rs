...
//! Source: drivers/perf/arm_spe_pmu.c
#![no_std]
...
//
pub const SPE_PMU_HW_FLAGS_CX: c_uint = 0x00001;
    static_assert((PERF_EVENT_FLAG_ARCH & SPE_PMU_HW_FLAGS_CX) == SPE_PMU_HW_FLAGS_CX);
#[no_mangle]
unsafe extern "C" fn set_spe_event_has_cx(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn get_spe_event_has_cx(event: *mut perf_event) -> bool {
    static bool get_spe_event_has_cx(struct perf_event *event)
    {
    return !!(event.hw.flags & SPE_PMU_HW_FLAGS_CX);
    }
pub const ARM_SPE_BUF_PAD_BYTE: c_int = 0;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arm_spe_pmu_buf {
    pub nr_pages: c_int,
    pub snapshot: bool,
    pub base: *mut c_void,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arm_spe_pmu {
    pub pmu: pmu,
    pub pdev: *mut platform_device,
    pub supported_cpus: cpumask_t,
    pub hotplug_node: hlist_node,
    pub /: *mut *mut int irq; / PPI,
    pub pmsver: u16,
    pub min_period: u16,
    pub counter_sz: u16,

    pub features: u64,
    pub pmsevfr_res0: u64,
    pub max_record_sz: u16,
    pub align: u16,
    pub handle: *mut perf_output_handle __percpu,
}
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_cap_get(spe_pmu: *mut arm_spe_pmu, cap: c_int) -> u64 {
    ...
    { __ATTR(_name, S_IRUGO, _func, core::ptr::null_mut()), (void *)_var }	\
    })[0].attr.attr
...
pub const ATTR_CFG_FLD_ts_enable_LO: c_int = 0;
pub const ATTR_CFG_FLD_ts_enable_HI: c_int = 0;

pub const ATTR_CFG_FLD_pa_enable_LO: c_int = 1;
pub const ATTR_CFG_FLD_pa_enable_HI: c_int = 1;

pub const ATTR_CFG_FLD_pct_enable_LO: c_int = 2;
pub const ATTR_CFG_FLD_pct_enable_HI: c_int = 2;

pub const ATTR_CFG_FLD_jitter_LO: c_int = 16;
pub const ATTR_CFG_FLD_jitter_HI: c_int = 16;

pub const ATTR_CFG_FLD_branch_filter_LO: c_int = 32;
pub const ATTR_CFG_FLD_branch_filter_HI: c_int = 32;

pub const ATTR_CFG_FLD_load_filter_LO: c_int = 33;
pub const ATTR_CFG_FLD_load_filter_HI: c_int = 33;

pub const ATTR_CFG_FLD_store_filter_LO: c_int = 34;
pub const ATTR_CFG_FLD_store_filter_HI: c_int = 34;

pub const ATTR_CFG_FLD_discard_LO: c_int = 35;
pub const ATTR_CFG_FLD_discard_HI: c_int = 35;

pub const ATTR_CFG_FLD_branch_filter_mask_LO: c_int = 36;
pub const ATTR_CFG_FLD_branch_filter_mask_HI: c_int = 36;

pub const ATTR_CFG_FLD_load_filter_mask_LO: c_int = 37;
pub const ATTR_CFG_FLD_load_filter_mask_HI: c_int = 37;

pub const ATTR_CFG_FLD_store_filter_mask_LO: c_int = 38;
pub const ATTR_CFG_FLD_store_filter_mask_HI: c_int = 38;

pub const ATTR_CFG_FLD_simd_filter_LO: c_int = 39;
pub const ATTR_CFG_FLD_simd_filter_HI: c_int = 39;

pub const ATTR_CFG_FLD_simd_filter_mask_LO: c_int = 40;
pub const ATTR_CFG_FLD_simd_filter_mask_HI: c_int = 40;

pub const ATTR_CFG_FLD_float_filter_LO: c_int = 41;
pub const ATTR_CFG_FLD_float_filter_HI: c_int = 41;

pub const ATTR_CFG_FLD_float_filter_mask_LO: c_int = 42;
pub const ATTR_CFG_FLD_float_filter_mask_HI: c_int = 42;

pub const ATTR_CFG_FLD_event_filter_LO: c_int = 0;
pub const ATTR_CFG_FLD_event_filter_HI: c_int = 63;

pub const ATTR_CFG_FLD_min_latency_LO: c_int = 0;
pub const ATTR_CFG_FLD_min_latency_HI: c_int = 11;

pub const ATTR_CFG_FLD_inv_event_filter_LO: c_int = 0;
pub const ATTR_CFG_FLD_inv_event_filter_HI: c_int = 63;

pub const ATTR_CFG_FLD_inv_data_src_filter_LO: c_int = 0;
pub const ATTR_CFG_FLD_inv_data_src_filter_HI: c_int = 63;
...
#[no_mangle]
unsafe extern "C" fn arm_spe_event_to_pmscr(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_event_sanitise_period(event: *mut perf_event) {
    static void arm_spe_event_sanitise_period(struct perf_event *event)
    {
    let mut period: u64 = event.hw.sample_period;
    let mut max_period: u64 = PMSIRR_EL1_INTERVAL_MASK;
//
...
// minimum value.
//
    let mut min_period: u64 = FIELD_PREP(PMSIRR_EL1_INTERVAL_MASK, 1);
    period = clamp_t(u64, period, min_period, max_period) & max_period;
    event.hw.sample_period = period;
    }
#[no_mangle]
unsafe extern "C" fn arm_spe_event_to_pmsirr(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_event_to_pmsfcr(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_event_to_pmsevfr(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_event_to_pmsnevfr(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_event_to_pmslatfr(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_event_to_pmsdsfr(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_pad_buf(handle: *mut perf_output_handle, len: c_int) {
    static void arm_spe_pmu_pad_buf(struct perf_output_handle *handle, int len)
    {
    struct arm_spe_pmu_buf *buf = perf_get_aux(handle);
    let mut head: u64 = PERF_IDX2OFF(handle.head, buf);
    memset(buf.base + head, ARM_SPE_BUF_PAD_BYTE, len);
    if (!buf.snapshot)
    perf_aux_output_skip(handle, len);
    }
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_next_snapshot_off(handle: *mut perf_output_handle) -> u64 {
    ...
    let mut head: u64 = PERF_IDX2OFF(handle.head, buf);
    let mut limit: u64 = buf.nr_pages * PAGE_SIZE;
//
...
#[no_mangle]
unsafe extern "C" fn __arm_spe_pmu_next_off(handle: *mut perf_output_handle) -> u64 {
    static u64 __arm_spe_pmu_next_off(struct perf_output_handle *handle)
    {
    struct arm_spe_pmu *spe_pmu = to_spe_pmu(handle.event.pmu);
    struct arm_spe_pmu_buf *buf = perf_get_aux(handle);
    let mut bufsize: u64 = buf.nr_pages * PAGE_SIZE;
    let mut limit: u64 = bufsize;
...
//
    ...
    let mut delta: c_ulong = roundup(head, spe_pmu.align) - head;
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_next_off(handle: *mut perf_output_handle) -> u64 {
    static u64 arm_spe_pmu_next_off(struct perf_output_handle *handle)
    {
    struct arm_spe_pmu_buf *buf = perf_get_aux(handle);
    struct arm_spe_pmu *spe_pmu = to_spe_pmu(handle.event.pmu);
    let mut limit: u64 = __arm_spe_pmu_next_off(handle);
    let mut head: u64 = PERF_IDX2OFF(handle.head, buf);
//
...
#[no_mangle]
unsafe extern "C" fn arm_spe_perf_aux_output_end(handle: *mut perf_output_handle) {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_disable_and_drain_local() {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_irq_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
// Perf callbacks
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_stop(event: *mut perf_event, flags: c_int) {
    static void arm_spe_pmu_stop(struct perf_event *event, int flags)
    {
    struct arm_spe_pmu *spe_pmu = to_spe_pmu(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
    static int arm_spe_pmu_add(struct perf_event *event, int flags)
    {
    let mut ret: c_int = 0;
    struct arm_spe_pmu *spe_pmu = to_spe_pmu(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
    let mut cpu: c_int = event.cpu == -1 ? smp_processor_id() : event.cpu;
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_del(event: *mut perf_event, flags: c_int) {
    static void arm_spe_pmu_del(struct perf_event *event, int flags)
    {
    arm_spe_pmu_stop(event, PERF_EF_UPDATE);
    }
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_read(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_free_aux(aux: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_perf_init(spe_pmu: *mut arm_spe_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_perf_destroy(spe_pmu: *mut arm_spe_pmu) {
    static void arm_spe_pmu_perf_destroy(struct arm_spe_pmu *spe_pmu)
    {
    perf_pmu_unregister(&spe_pmu.pmu);
    }
#[no_mangle]
unsafe extern "C" fn __arm_spe_pmu_dev_probe(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __arm_spe_pmu_reset_local() {
...
#[no_mangle]
unsafe extern "C" fn __arm_spe_pmu_setup_one(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn __arm_spe_pmu_stop_one(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_cpu_startup(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_cpu_teardown(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_dev_init(spe_pmu: *mut arm_spe_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_dev_teardown(spe_pmu: *mut arm_spe_pmu) {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_irq_probe(spe_pmu: *mut arm_spe_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_device_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_device_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn arm_spe_pmu_exit() -> void __exit {
