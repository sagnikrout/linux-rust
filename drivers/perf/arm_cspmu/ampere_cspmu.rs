...
//! Source: drivers/perf/arm_cspmu/ampere_cspmu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ampere_cspmu_init_ops(cspmu: *mut arm_cspmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ampere_cspmu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ampere_cspmu_exit() -> void __exit {
