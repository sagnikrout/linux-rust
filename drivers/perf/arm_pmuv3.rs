...
pub const ARMV8_A53_PERFCTR_PREF_LINEFILL: c_uint = 0xC2;
// ARMv8 Cavium ThunderX specific event types.
pub const ARMV8_THUNDER_PERFCTR_L1D_CACHE_MISS_ST: c_uint = 0xE9;
pub const ARMV8_THUNDER_PERFCTR_L1D_CACHE_PREF_ACCESS: c_uint = 0xEA;
pub const ARMV8_THUNDER_PERFCTR_L1D_CACHE_PREF_MISS: c_uint = 0xEB;
pub const ARMV8_THUNDER_PERFCTR_L1I_CACHE_PREF_ACCESS: c_uint = 0xEC;
pub const ARMV8_THUNDER_PERFCTR_L1I_CACHE_PREF_MISS: c_uint = 0xED;
//
...
// Don't expose the chain event in /sys, since it's useless in isolation
    ...
    let mut id: u64 = pmu_attr.id - ARMV8_PMUV3_EXT_COMMON_EVENT_BASE;
...
pub const ATTR_CFG_FLD_event_LO: c_int = 0;
pub const ATTR_CFG_FLD_event_HI: c_int = 15;

pub const ATTR_CFG_FLD_long_LO: c_int = 0;
pub const ATTR_CFG_FLD_long_HI: c_int = 0;

pub const ATTR_CFG_FLD_rdpmc_LO: c_int = 1;
pub const ATTR_CFG_FLD_rdpmc_HI: c_int = 1;

pub const ATTR_CFG_FLD_threshold_count_LO: c_int = 2;
pub const ATTR_CFG_FLD_threshold_count_HI: c_int = 2;

pub const ATTR_CFG_FLD_threshold_compare_LO: c_int = 3;
pub const ATTR_CFG_FLD_threshold_compare_HI: c_int = 4;

pub const ATTR_CFG_FLD_threshold_LO: c_int = 5;
pub const ATTR_CFG_FLD_threshold_HI: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_event_is_64bit(event: *mut perf_event) -> bool {
    static bool armv8pmu_event_is_64bit(struct perf_event *event)
    {
    return ATTR_CFG_GET_FLD(&event.attr, long);
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_event_want_user_access(event: *mut perf_event) -> bool {
    static bool armv8pmu_event_want_user_access(struct perf_event *event)
    {
    return ATTR_CFG_GET_FLD(&event.attr, rdpmc);
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_event_get_threshold(attr: *mut perf_event_attr) -> u32 {
    static u32 armv8pmu_event_get_threshold(struct perf_event_attr *attr)
    {
    return ATTR_CFG_GET_FLD(attr, threshold);
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_event_threshold_control(attr: *mut perf_event_attr) -> u8 {
    static u8 armv8pmu_event_threshold_control(struct perf_event_attr *attr)
    {
    let mut th_compare: u8 = ATTR_CFG_GET_FLD(attr, threshold_compare);
    let mut th_count: u8 = ATTR_CFG_GET_FLD(attr, threshold_count);
//
...
//
    ...
    struct pmu *pmu = dev_get_drvdata(dev);
    struct arm_pmu *cpu_pmu = container_of(pmu, struct arm_pmu, pmu);
    let mut slots: u32 = FIELD_GET(ARMV8_PMU_SLOTS, cpu_pmu.reg_pmmir);
    ...
    struct pmu *pmu = dev_get_drvdata(dev);
    struct arm_pmu *cpu_pmu = container_of(pmu, struct arm_pmu, pmu);
    let mut bus_slots: u32 = FIELD_GET(ARMV8_PMU_BUS_SLOTS, cpu_pmu.reg_pmmir);
    return sysfs_emit(page, "0x%08x\n", bus_slots);
    }
    ...
    struct pmu *pmu = dev_get_drvdata(dev);
    struct arm_pmu *cpu_pmu = container_of(pmu, struct arm_pmu, pmu);
    let mut bus_width: u32 = FIELD_GET(ARMV8_PMU_BUS_WIDTH, cpu_pmu.reg_pmmir);
    let mut val: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn threshold_max(cpu_pmu: *mut arm_pmu) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn caps_is_visible(kobj: *mut kobject, attr: *mut attribute, i: c_int) -> umode_t {
...
//
#[no_mangle]
unsafe extern "C" fn armv8pmu_has_long_event(cpu_pmu: *mut arm_pmu) -> bool {
    static bool armv8pmu_has_long_event(struct arm_pmu *cpu_pmu)
    {
    return (IS_ENABLED(CONFIG_ARM64) && is_pmuv3p5(cpu_pmu.pmuver));
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_event_has_user_read(event: *mut perf_event) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn armv8pmu_event_is_chained(event: *mut perf_event) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn armv8pmu_pmcr_read() -> u64 {
    static u64 armv8pmu_pmcr_read(void)
    {
    return read_pmcr();
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_pmcr_write(val: u64) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_has_overflowed(pmovsr: u64) -> c_int {
    static int armv8pmu_has_overflowed(u64 pmovsr)
    {
    return !!(pmovsr & ARMV8_PMU_OVERFLOWED_MASK);
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_counter_has_overflowed(pmnc: u64, idx: c_int) -> c_int {
    static int armv8pmu_counter_has_overflowed(u64 pmnc, int idx)
    {
    return !!(pmnc & BIT(idx));
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_read_evcntr(idx: c_int) -> u64 {
    static u64 armv8pmu_read_evcntr(int idx)
    {
    return read_pmevcntrn(idx);
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_read_hw_counter(event: *mut perf_event) -> u64 {
    static u64 armv8pmu_read_hw_counter(struct perf_event *event)
    {
    let mut idx: c_int = event.hw.idx;
    let mut val: u64 = armv8pmu_read_evcntr(idx);
...
//
#[no_mangle]
unsafe extern "C" fn armv8pmu_event_needs_bias(event: *mut perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_bias_long_counter(event: *mut perf_event, value: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_unbias_long_counter(event: *mut perf_event, value: u64) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_read_counter(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_write_evcntr(idx: c_int, value: u64) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_write_counter(event: *mut perf_event, value: u64) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_write_evtype(idx: c_int, val: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_write_event_type(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_event_cnten_mask(event: *mut perf_event) -> u64 {
    static u64 armv8pmu_event_cnten_mask(struct perf_event *event)
    {
    let mut counter: c_int = event.hw.idx;
    let mut mask: u64 = BIT(counter);
    if (armv8pmu_event_is_chained(event))
    mask |= BIT(counter - 1);
    return mask;
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_enable_counter(mask: u64) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_enable_event_counter(event: *mut perf_event) {
    static void armv8pmu_enable_event_counter(struct perf_event *event)
    {
    struct perf_event_attr *attr = &event.attr;
    let mut mask: u64 = armv8pmu_event_cnten_mask(event);
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_disable_counter(mask: u64) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_disable_event_counter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_enable_intens(mask: u64) {
    static void armv8pmu_enable_intens(u64 mask)
    {
    write_pmintenset(mask);
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_enable_event_irq(event: *mut perf_event) {
    static void armv8pmu_enable_event_irq(struct perf_event *event)
    {
    armv8pmu_enable_intens(BIT(event.hw.idx));
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_disable_intens(mask: u64) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_disable_event_irq(event: *mut perf_event) {
    static void armv8pmu_disable_event_irq(struct perf_event *event)
    {
    armv8pmu_disable_intens(BIT(event.hw.idx));
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_getreset_flags() -> u64 {
...
#[no_mangle]
unsafe extern "C" fn update_pmuserenr(val: u64) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_disable_user_access() {
    static void armv8pmu_disable_user_access(void)
    {
    update_pmuserenr(0);
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_enable_user_access(cpu_pmu: *mut arm_pmu) {
    static void armv8pmu_enable_user_access(struct arm_pmu *cpu_pmu)
    {
    int i;
    let mut userenr: u64 = ARMV8_PMU_USERENR_ER | ARMV8_PMU_USERENR_UEN;
...
// Clear any unused counters to avoid leaking their contents
    ...
    write_pmccntr(0);
#[no_mangle]
pub unsafe extern "C" fn if(ARMV8_PMU_INSTR_IDX: i ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_enable_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_disable_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_start(cpu_pmu: *mut arm_pmu) {
    static void armv8pmu_start(struct arm_pmu *cpu_pmu)
    {
    struct perf_event_context *ctx;
    struct pmu_hw_events *hw_events = this_cpu_ptr(cpu_pmu.hw_events);
    let mut nr_user: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_stop(cpu_pmu: *mut arm_pmu) {
...
// Disable all counters
    ...
    perf_sample_save_brstack(data, event, branch_stack, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn armv8pmu_handle_irq(cpu_pmu: *mut arm_pmu) -> irqreturn_t {
...
// Release the Odd counter
    ...
    struct arm_pmu *cpu_pmu = to_arm_pmu(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
    let mut evtype: c_ulong = hwc.config_base & ARMV8_PMU_EVTYPE_EVENT;
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_user_event_idx(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_reset(info: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn unsigned(_arg: *mut extra_event_map) -> const {
    const unsigned (*extra_event_map)
    [PERF_COUNT_HW_MAX],
#[no_mangle]
pub unsafe extern "C" fn unsigned(_arg: *mut extra_cache_map) -> const {
...
#[no_mangle]
unsafe extern "C" fn armv8_pmuv3_map_event(event: *mut perf_event) -> c_int {
    static int armv8_pmuv3_map_event(struct perf_event *event)
    {
    return __armv8_pmuv3_map_event(event, core::ptr::null_mut(), core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn armv8_a53_map_event(event: *mut perf_event) -> c_int {
    static int armv8_a53_map_event(struct perf_event *event)
    {
    return __armv8_pmuv3_map_event(event, core::ptr::null_mut(), &armv8_a53_perf_cache_map);
    }
#[no_mangle]
unsafe extern "C" fn armv8_a57_map_event(event: *mut perf_event) -> c_int {
    static int armv8_a57_map_event(struct perf_event *event)
    {
    return __armv8_pmuv3_map_event(event, core::ptr::null_mut(), &armv8_a57_perf_cache_map);
    }
#[no_mangle]
unsafe extern "C" fn armv8_a73_map_event(event: *mut perf_event) -> c_int {
    static int armv8_a73_map_event(struct perf_event *event)
    {
    return __armv8_pmuv3_map_event(event, core::ptr::null_mut(), &armv8_a73_perf_cache_map);
    }
#[no_mangle]
unsafe extern "C" fn armv8_thunder_map_event(event: *mut perf_event) -> c_int {
    static int armv8_thunder_map_event(struct perf_event *event)
    {
    return __armv8_pmuv3_map_event(event, core::ptr::null_mut(),
    &armv8_thunder_perf_cache_map);
    }
#[no_mangle]
unsafe extern "C" fn armv8_vulcan_map_event(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_is_in_avoid_pmccntr_cpus() -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct armv8pmu_probe_info {
    pub pmu: *mut arm_pmu,
    pub present: bool,
}

#[no_mangle]
unsafe extern "C" fn __armv8pmu_probe_pmu(info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn branch_records_alloc(armpmu: *mut arm_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_probe_pmu(cpu_pmu: *mut arm_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armv8pmu_disable_user_access_ipi(unused: *mut c_void) {
    ...
    return ret;
    on_each_cpu(armv8pmu_disable_user_access_ipi, core::ptr::null_mut(), 1);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn armv8_pmu_register_sysctl_table() {
    static void armv8_pmu_register_sysctl_table(void)
    {
    let mut tbl_registered: static u32 = 0;
    ...
    {
    let mut ret: c_int = armv8pmu_probe_pmu(cpu_pmu);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn armv8_pmu_device_probe(pdev: *mut platform_device) -> c_int {
    static int armv8_pmu_device_probe(struct platform_device *pdev)
    {
    return arm_pmu_device_probe(pdev, armv8_pmu_of_device_ids, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn armv8_pmu_driver_init() -> int __init {
