...
//! Source: drivers/perf/hisilicon/hisi_uncore_hha_pmu.c
#![no_std]
...
pub const HHA_INT_MASK: c_uint = 0x0804;
pub const HHA_INT_STATUS: c_uint = 0x0808;
pub const HHA_INT_CLEAR: c_uint = 0x080C;
pub const HHA_VERSION: c_uint = 0x1cf0;
pub const HHA_PERF_CTRL: c_uint = 0x1E00;
pub const HHA_EVENT_CTRL: c_uint = 0x1E04;
pub const HHA_SRCID_CTRL: c_uint = 0x1E08;
pub const HHA_DATSRC_CTRL: c_uint = 0x1BF0;
pub const HHA_EVENT_TYPE0: c_uint = 0x1E80;
//
// If the HW version only supports a 48-bit counter, then
// bits [63:48] are reserved, which are Read-As-Zero and
// Writes-Ignored.
//
pub const HHA_CNT0_LOWER: c_uint = 0x1F00;
// HHA PMU v1 has 16 counters and v2 only has 8 counters
pub const HHA_V1_NR_COUNTERS: c_uint = 0x10;
pub const HHA_V2_NR_COUNTERS: c_uint = 0x8;
pub const HHA_PERF_CTRL_EN: c_uint = 0x1;

pub const HHA_SRCID_CMD_SHIFT: c_int = 6;
pub const HHA_SRCID_MSK_SHIFT: c_int = 20;

pub const HHA_V1_NR_EVENT: c_uint = 0x65;
pub const HHA_V2_NR_EVENT: c_uint = 0xFF;
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_enable_tracetag(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_clear_tracetag(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_config_ds(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_clear_ds(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_config_srcid(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_disable_srcid(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_enable_filter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_disable_filter(event: *mut perf_event) {
...
//
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_get_counter_offset(cntr_idx: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_start_counters(hha_pmu: *mut hisi_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_stop_counters(hha_pmu: *mut hisi_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_get_int_status(hha_pmu: *mut hisi_pmu) -> u32 {
    static u32 hisi_hha_pmu_get_int_status(struct hisi_pmu *hha_pmu)
    {
    return readl(hha_pmu.base + HHA_INT_STATUS);
    }
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_clear_int_status(hha_pmu: *mut hisi_pmu, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hisi_hha_pmu_module_exit() -> void __exit {
