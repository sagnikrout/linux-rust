...
//! Source: drivers/perf/hisilicon/hisi_uncore_l3c_pmu.c
#![no_std]
...
pub const L3C_PERF_CTRL: c_uint = 0x0408;
pub const L3C_INT_MASK: c_uint = 0x0800;
pub const L3C_INT_STATUS: c_uint = 0x0808;
pub const L3C_INT_CLEAR: c_uint = 0x080c;
pub const L3C_CORE_CTRL: c_uint = 0x1b04;
pub const L3C_TRACETAG_CTRL: c_uint = 0x1b20;
pub const L3C_DATSRC_TYPE: c_uint = 0x1b48;
pub const L3C_DATSRC_CTRL: c_uint = 0x1bf0;
pub const L3C_EVENT_CTRL: c_uint = 0x1c00;
pub const L3C_VERSION: c_uint = 0x1cf0;
pub const L3C_EVENT_TYPE0: c_uint = 0x1d00;
//
// If the HW version only supports a 48-bit counter, then
// bits [63:48] are reserved, which are Read-As-Zero and
// Writes-Ignored.
//
pub const L3C_CNTR0_LOWER: c_uint = 0x1e00;
// L3C has 8-counters
pub const L3C_NR_COUNTERS: c_uint = 0x8;
pub const L3C_MAX_EXT: c_int = 2;
pub const L3C_PERF_CTRL_EN: c_uint = 0x10000;

pub const L3C_TRACETAG_REQ_SHIFT: c_int = 7;

pub const L3C_COER_NONE: c_uint = 0x0;
pub const L3C_DATSRC_MASK: c_uint = 0xFF;

pub const L3C_DATSRC_NONE: c_uint = 0x0;
pub const L3C_EVTYPE_NONE: c_uint = 0xff;
pub const L3C_V1_NR_EVENTS: c_uint = 0x59;
pub const L3C_V2_NR_EVENTS: c_uint = 0xFF;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_l3c_pmu {
    pub l3c_pmu: hisi_pmu,
// MMIO and IRQ resources for extension events
    pub ext_base: [*mut void __iomem; L3C_MAX_EXT],
    pub ext_irq: [c_int; L3C_MAX_EXT],
    pub ext_num: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_l3c_pmu_ext {
    pub support_ext: bool,
}

#[no_mangle]
unsafe extern "C" fn support_ext(pmu: *mut hisi_l3c_pmu) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_get_tt_core(event: *mut perf_event) -> u32 {
    static u32 hisi_l3c_pmu_get_tt_core(struct perf_event *event)
    {
    let mut core: u32 = hisi_get_tt_core(event);
    if (core)
    return core;
    return hisi_get_tt_core_deprecated(event);
    }
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_get_event_idx(event: *mut perf_event) -> c_int {
    ...
    let mut ext: c_int = hisi_get_ext(event);
    int idx;
//
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_clear_req_tracetag(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_write_ds(event: *mut perf_event, ds_cfg: u32) {
    static void hisi_l3c_pmu_write_ds(struct perf_event *event, u32 ds_cfg)
    {
    struct hw_perf_event *hwc = &event.hw;
    u32 reg, reg_idx, shift, val;
    let mut idx: c_int = L3C_HW_IDX(hwc.idx);
//
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_config_ds(event: *mut perf_event) {
    static void hisi_l3c_pmu_config_ds(struct perf_event *event)
    {
    struct hw_perf_event *hwc = &event.hw;
    let mut ds_cfg: u32 = hisi_get_datasrc_cfg(event);
    let mut ds_skt: u32 = hisi_get_datasrc_skt(event);
    if (ds_cfg)
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_clear_ds(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_config_core_tracetag(event: *mut perf_event) {
    static void hisi_l3c_pmu_config_core_tracetag(struct perf_event *event)
    {
    struct hw_perf_event *hwc = &event.hw;
    let mut core: u32 = hisi_l3c_pmu_get_tt_core(event);
    if (core) {
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_clear_core_tracetag(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_have_filter(event: *mut perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_enable_filter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_disable_filter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_check_filter(event: *mut perf_event) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_get_counter_offset(cntr_idx: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_start_counters(l3c_pmu: *mut hisi_pmu) {
    static void hisi_l3c_pmu_start_counters(struct hisi_pmu *l3c_pmu)
    {
    struct hisi_l3c_pmu *hisi_l3c_pmu = to_hisi_l3c_pmu(l3c_pmu);
    unsigned long *used_mask = l3c_pmu.pmu_events.used_mask;
    let mut used_cntr: c_ulong = find_first_bit(used_mask, l3c_pmu.num_counters);
    u32 val;
    int i;
//
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_stop_counters(l3c_pmu: *mut hisi_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_get_int_status(l3c_pmu: *mut hisi_pmu) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_clear_int_status(l3c_pmu: *mut hisi_pmu, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_init_ext(l3c_pmu: *mut hisi_pmu, pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_online_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hisi_l3c_pmu_module_exit() -> void __exit {
