...
//! Source: drivers/perf/hisilicon/hisi_pcie_pmu.c
#![no_std]
...
// Define registers
pub const HISI_PCIE_GLOBAL_CTRL: c_uint = 0x00;
pub const HISI_PCIE_EVENT_CTRL: c_uint = 0x010;
pub const HISI_PCIE_CNT: c_uint = 0x090;
pub const HISI_PCIE_EXT_CNT: c_uint = 0x110;
pub const HISI_PCIE_INT_STAT: c_uint = 0x150;
pub const HISI_PCIE_INT_MASK: c_uint = 0x154;
pub const HISI_PCIE_REG_BDF: c_uint = 0xfe0;
pub const HISI_PCIE_REG_VERSION: c_uint = 0xfe4;
pub const HISI_PCIE_REG_INFO: c_uint = 0xfe8;
// Define command in HISI_PCIE_GLOBAL_CTRL
pub const HISI_PCIE_GLOBAL_EN: c_uint = 0x01;
pub const HISI_PCIE_GLOBAL_NONE: c_int = 0;
...
pub const HISI_PCIE_MAX_COUNTERS: c_int = 8;
pub const HISI_PCIE_REG_STEP: c_int = 8;
pub const HISI_PCIE_THR_MAX_VAL: c_int = 10;
pub const HISI_PCIE_TRIG_MAX_VAL: c_int = 10;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_pcie_pmu {
    pub hw_events: [*mut perf_event; HISI_PCIE_MAX_COUNTERS],
    pub node: hlist_node,
...
pub struct hisi_pcie_reg_pair {
    ...
    { .attr = __ATTR(_name, 0444, device_show_string, core::ptr::null_mut()),       \
    .var = (void *)_format }                                     \
    })[0].attr.attr)

    PMU_EVENT_ATTR_ID(_name, hisi_pcie_event_sysfs_show, _id)
#[no_mangle]
unsafe extern "C" fn cpumask_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn identifier_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn bus_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn bdf_min_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn bdf_max_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
    ...
    {
    let mut val: u32 = readl_relaxed(pcie_pmu.base + reg_off);
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_get_real_event(event: *mut perf_event) -> u32 {
    static u32 hisi_pcie_get_real_event(struct perf_event *event)
    {
    return hisi_pcie_get_event(event) & GENMASK(15, 0);
    }
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_get_offset(offset: u32, idx: u32) -> u32 {
    ...
    u32 idx)
    {
    let mut offset: u32 = hisi_pcie_pmu_get_offset(reg_offset, idx);
    return readl_relaxed(pcie_pmu.base + offset);
    }
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_writel(pcie_pmu: *mut hisi_pcie_pmu, reg_offset: u32, idx: u32, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_readq(pcie_pmu: *mut hisi_pcie_pmu, reg_offset: u32, idx: u32) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_writeq(pcie_pmu: *mut hisi_pcie_pmu, reg_offset: u32, idx: u32, val: u64) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_get_event_ctrl_val(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_config_event_ctrl(event: *mut perf_event) {
    static void hisi_pcie_pmu_config_event_ctrl(struct perf_event *event)
    {
    struct hisi_pcie_pmu *pcie_pmu = to_pcie_pmu(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
    let mut reg: u64 = hisi_pcie_pmu_get_event_ctrl_val(event);
    hisi_pcie_pmu_writeq(pcie_pmu, HISI_PCIE_EVENT_CTRL, hwc.idx, reg);
    }
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_clear_event_ctrl(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_valid_requester_id(pcie_pmu: *mut hisi_pcie_pmu, bdf: u32) -> bool {
    ...
    {
    let mut requester_id: u32 = hisi_pcie_get_bdf(event);
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_validate_event_group(event: *mut perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_read_counter(event: *mut perf_event) -> u64 {
...
//
    ...
    struct perf_event *event)
    {
    let mut first_idle: c_int = -EAGAIN;
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_read(event: *mut perf_event) {
    static void hisi_pcie_pmu_read(struct perf_event *event)
    {
    hisi_pcie_pmu_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_set_period(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_enable_counter(pcie_pmu: *mut hisi_pcie_pmu, hwc: *mut hw_perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_disable_counter(pcie_pmu: *mut hisi_pcie_pmu, hwc: *mut hw_perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_enable_int(pcie_pmu: *mut hisi_pcie_pmu, hwc: *mut hw_perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_disable_int(pcie_pmu: *mut hisi_pcie_pmu, hwc: *mut hw_perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_reset_counter(pcie_pmu: *mut hisi_pcie_pmu, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_del(event: *mut perf_event, flags: c_int) {
    static void hisi_pcie_pmu_del(struct perf_event *event, int flags)
    {
    struct hisi_pcie_pmu *pcie_pmu = to_pcie_pmu(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
    hisi_pcie_pmu_stop(event, PERF_EF_UPDATE);
    pcie_pmu.hw_events[hwc.idx] = core::ptr::null_mut();
    perf_event_update_userpage(event);
    }
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_enable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_disable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_irq_register(pdev: *mut pci_dev, pcie_pmu: *mut hisi_pcie_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_irq_unregister(pdev: *mut pci_dev, pcie_pmu: *mut hisi_pcie_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_online_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_alloc_pmu(pdev: *mut pci_dev, pcie_pmu: *mut hisi_pcie_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_init_pmu(pdev: *mut pci_dev, pcie_pmu: *mut hisi_pcie_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_uninit_pmu(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_init_dev(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_probe(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_pmu_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hisi_pcie_module_exit() -> void __exit {
