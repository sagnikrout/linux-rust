...
//! Source: drivers/perf/hisilicon/hisi_uncore_uc_pmu.c
#![no_std]
...
pub const HISI_UC_INT_MASK_REG: c_uint = 0x0800;
pub const HISI_UC_INT_STS_REG: c_uint = 0x0808;
pub const HISI_UC_INT_CLEAR_REG: c_uint = 0x080c;
pub const HISI_UC_TRACETAG_CTRL_REG: c_uint = 0x1b2c;

pub const HISI_UC_SRCID_CTRL_REG: c_uint = 0x1b40;

pub const HISI_UC_EVENT_CTRL_REG: c_uint = 0x1c00;

pub const HISI_UC_VERSION_REG: c_uint = 0x1cf0;

pub const HISI_UC_NR_COUNTERS: c_uint = 0x8;
pub const HISI_UC_V2_NR_EVENTS: c_uint = 0xFF;
pub const HISI_UC_CNTR_REG_BITS: c_int = 64;
pub const HISI_UC_RD_REQ_TRACETAG: c_uint = 0x4;
pub const HISI_UC_URING_EVENT_MIN: c_uint = 0x47;
pub const HISI_UC_URING_EVENT_MAX: c_uint = 0x59;
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_check_filter(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_config_req_tracetag(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_clear_req_tracetag(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_config_srcid_tracetag(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_clear_srcid_tracetag(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_config_uring_channel(event: *mut perf_event) {
    static void hisi_uc_pmu_config_uring_channel(struct perf_event *event)
    {
    struct hisi_pmu *uc_pmu = to_hisi_pmu(event.pmu);
    let mut uring_channel: u32 = hisi_get_uring_channel(event);
    u32 val;
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_clear_uring_channel(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_enable_filter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_disable_filter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_write_evtype(uc_pmu: *mut hisi_pmu, idx: c_int, type: u32) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_start_counters(uc_pmu: *mut hisi_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_stop_counters(uc_pmu: *mut hisi_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_get_glb_en_state(uc_pmu: *mut hisi_pmu) -> bool {
    ...
    struct hw_perf_event *hwc, u64 val)
    {
    let mut enable: bool = hisi_uc_pmu_get_glb_en_state(uc_pmu);
    let mut erratum: bool = uc_pmu.identifier == HISI_PMU_V2;
//
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_get_int_status(uc_pmu: *mut hisi_pmu) -> u32 {
    static u32 hisi_uc_pmu_get_int_status(struct hisi_pmu *uc_pmu)
    {
    return readl(uc_pmu.base + HISI_UC_INT_STS_REG);
    }
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_clear_int_status(uc_pmu: *mut hisi_pmu, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_remove_cpuhp_instance(hotplug_node: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_unregister_pmu(pmu: *mut c_void) {
    static void hisi_uc_pmu_unregister_pmu(void *pmu)
    {
    perf_pmu_unregister(pmu);
    }
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hisi_uc_pmu_module_exit() -> void __exit {
