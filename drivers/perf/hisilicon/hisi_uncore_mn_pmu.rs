...
//! Source: drivers/perf/hisilicon/hisi_uncore_mn_pmu.c
#![no_std]
...
pub const HISI_MN_DYNAMIC_CTRL_REG: c_uint = 0x400;

pub const HISI_MN_PERF_CTRL_REG: c_uint = 0x408;

pub const HISI_MN_INT_MASK_REG: c_uint = 0x800;
pub const HISI_MN_INT_STATUS_REG: c_uint = 0x808;
pub const HISI_MN_INT_CLEAR_REG: c_uint = 0x80C;
pub const HISI_MN_EVENT_CTRL_REG: c_uint = 0x1C00;
pub const HISI_MN_VERSION_REG: c_uint = 0x1C04;
pub const HISI_MN_EVTYPE0_REG: c_uint = 0x1d00;

pub const HISI_MN_CNTR0_REG: c_uint = 0x1e00;

pub const HISI_MN_NR_COUNTERS: c_int = 4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_mn_pmu_regs {
    pub version: u32,
    pub dyn_ctrl: u32,
    pub perf_ctrl: u32,
    pub int_mask: u32,
...
//
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_counter_flush(mn_pmu: *mut hisi_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_write_evtype(mn_pmu: *mut hisi_pmu, idx: c_int, type: u32) {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_start_counters(mn_pmu: *mut hisi_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_stop_counters(mn_pmu: *mut hisi_pmu) {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_get_int_status(mn_pmu: *mut hisi_pmu) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_clear_int_status(mn_pmu: *mut hisi_pmu, idx: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_remove_cpuhp(hotplug_node: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_unregister(pmu: *mut c_void) {
    static void hisi_mn_pmu_unregister(void *pmu)
    {
    perf_pmu_unregister(pmu);
    }
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn hisi_mn_pmu_module_exit() -> void __exit {
