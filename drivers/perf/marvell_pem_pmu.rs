...
//! Source: drivers/perf/marvell_pem_pmu.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn eventid_to_offset(eventid: c_int) -> c_int {
...
// Events
    ...
    { .attr = __ATTR(_name, 0444, pem_pmu_event_show, core::ptr::null_mut()),	\
    .id = _id, }						\
    })[0].attr.attr)
...
// cpumask
    ...
    __ATTR(cpumask, 0444, pem_perf_cpumask_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn pem_perf_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pem_perf_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn pem_perf_event_start(event: *mut perf_event, flags: c_int) {
    static void pem_perf_event_start(struct perf_event *event, int flags)
    {
    struct pem_pmu *pmu = to_pem_pmu(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
    let mut eventid: c_int = hwc.idx;
//
...
#[no_mangle]
unsafe extern "C" fn pem_perf_event_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pem_perf_event_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pem_perf_event_del(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn pem_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pem_perf_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pem_perf_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn pem_pmu_exit() -> void __exit {
