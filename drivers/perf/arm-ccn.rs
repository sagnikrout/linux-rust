...
pub const CCN_NUM_XP_PORTS: c_int = 2;
pub const CCN_NUM_VCS: c_int = 4;
pub const CCN_NUM_REGIONS: c_int = 256;
pub const CCN_REGION_SIZE: c_uint = 0x10000;
pub const CCN_ALL_OLY_ID: c_uint = 0xff00;
pub const CCN_ALL_OLY_ID__OLY_ID__SHIFT: c_int = 0;
pub const CCN_ALL_OLY_ID__OLY_ID__MASK: c_uint = 0x1f;
pub const CCN_ALL_OLY_ID__NODE_ID__SHIFT: c_int = 8;
pub const CCN_ALL_OLY_ID__NODE_ID__MASK: c_uint = 0x3f;
pub const CCN_MN_ERRINT_STATUS: c_uint = 0x0008;
pub const CCN_MN_ERRINT_STATUS__INTREQ__DESSERT: c_uint = 0x11;
pub const CCN_MN_ERRINT_STATUS__ALL_ERRORS__ENABLE: c_uint = 0x02;
pub const CCN_MN_ERRINT_STATUS__ALL_ERRORS__DISABLED: c_uint = 0x20;
pub const CCN_MN_ERRINT_STATUS__ALL_ERRORS__DISABLE: c_uint = 0x22;
pub const CCN_MN_ERRINT_STATUS__CORRECTED_ERRORS_ENABLE: c_uint = 0x04;
pub const CCN_MN_ERRINT_STATUS__CORRECTED_ERRORS_DISABLED: c_uint = 0x40;
pub const CCN_MN_ERRINT_STATUS__CORRECTED_ERRORS_DISABLE: c_uint = 0x44;
pub const CCN_MN_ERRINT_STATUS__PMU_EVENTS__ENABLE: c_uint = 0x08;
pub const CCN_MN_ERRINT_STATUS__PMU_EVENTS__DISABLED: c_uint = 0x80;
pub const CCN_MN_ERRINT_STATUS__PMU_EVENTS__DISABLE: c_uint = 0x88;
pub const CCN_MN_OLY_COMP_LIST_63_0: c_uint = 0x01e0;
pub const CCN_MN_ERR_SIG_VAL_63_0: c_uint = 0x0300;

pub const CCN_DT_ACTIVE_DSM: c_uint = 0x0000;

pub const CCN_DT_ACTIVE_DSM__DSM_ID__MASK: c_uint = 0xff;
pub const CCN_DT_CTL: c_uint = 0x0028;

pub const CCN_DT_PMCCNTR: c_uint = 0x0140;
pub const CCN_DT_PMCCNTRSR: c_uint = 0x0190;
pub const CCN_DT_PMOVSR: c_uint = 0x0198;
pub const CCN_DT_PMOVSR_CLR: c_uint = 0x01a0;
pub const CCN_DT_PMOVSR_CLR__MASK: c_uint = 0x1f;
pub const CCN_DT_PMCR: c_uint = 0x01a8;

pub const CCN_DT_PMSR: c_uint = 0x01b0;
pub const CCN_DT_PMSR_REQ: c_uint = 0x01b8;
pub const CCN_DT_PMSR_CLR: c_uint = 0x01c0;
pub const CCN_HNF_PMU_EVENT_SEL: c_uint = 0x0600;

pub const CCN_HNF_PMU_EVENT_SEL__ID__MASK: c_uint = 0xf;
pub const CCN_XP_DT_CONFIG: c_uint = 0x0300;

pub const CCN_XP_DT_CONFIG__DT_CFG__MASK: c_uint = 0xf;
pub const CCN_XP_DT_CONFIG__DT_CFG__PASS_THROUGH: c_uint = 0x0;
pub const CCN_XP_DT_CONFIG__DT_CFG__WATCHPOINT_0_OR_1: c_uint = 0x1;

pub const CCN_XP_DT_INTERFACE_SEL: c_uint = 0x0308;

pub const CCN_XP_DT_INTERFACE_SEL__DT_IO_SEL__MASK: c_uint = 0x1;

pub const CCN_XP_DT_INTERFACE_SEL__DT_DEV_SEL__MASK: c_uint = 0x1;

pub const CCN_XP_DT_INTERFACE_SEL__DT_VC_SEL__MASK: c_uint = 0x3;

pub const CCN_XP_DT_CONTROL: c_uint = 0x0370;

pub const CCN_XP_DT_CONTROL__WP_ARM_SEL__MASK: c_uint = 0xf;
pub const CCN_XP_DT_CONTROL__WP_ARM_SEL__ALWAYS: c_uint = 0xf;
pub const CCN_XP_PMU_EVENT_SEL: c_uint = 0x0600;

pub const CCN_XP_PMU_EVENT_SEL__ID__MASK: c_uint = 0x3f;
pub const CCN_SBAS_PMU_EVENT_SEL: c_uint = 0x0600;

pub const CCN_SBAS_PMU_EVENT_SEL__ID__MASK: c_uint = 0xf;
pub const CCN_RNI_PMU_EVENT_SEL: c_uint = 0x0600;

pub const CCN_RNI_PMU_EVENT_SEL__ID__MASK: c_uint = 0xf;
pub const CCN_TYPE_MN: c_uint = 0x01;
pub const CCN_TYPE_DT: c_uint = 0x02;
pub const CCN_TYPE_HNF: c_uint = 0x04;
pub const CCN_TYPE_HNI: c_uint = 0x05;
pub const CCN_TYPE_XP: c_uint = 0x08;
pub const CCN_TYPE_SBSX: c_uint = 0x0c;
pub const CCN_TYPE_SBAS: c_uint = 0x10;
pub const CCN_TYPE_RNI_1P: c_uint = 0x14;
pub const CCN_TYPE_RNI_2P: c_uint = 0x15;
pub const CCN_TYPE_RNI_3P: c_uint = 0x16;
pub const CCN_TYPE_RND_1P: c_uint = 0x18 /* RN-D = RN-I + DVM */;
pub const CCN_TYPE_RND_2P: c_uint = 0x19;
pub const CCN_TYPE_RND_3P: c_uint = 0x1a;
pub const CCN_TYPE_CYCLES: c_uint = 0xff /* Pseudotype */;
pub const CCN_EVENT_WATCHPOINT: c_uint = 0xfe /* Pseudoevent */;
pub const CCN_NUM_PMU_EVENTS: c_int = 4;

pub const CCN_NUM_PREDEFINED_MASKS: c_int = 4;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct arm_ccn_component {
    pub base: *mut void __iomem,
    pub type: u32,
    pub CCN_NUM_PMU_EVENTS): DECLARE_BITMAP(pmu_events_mask,,
    union {
    struct {
    pub CCN_NUM_XP_WATCHPOINTS): DECLARE_BITMAP(dt_cmp_mask,,
    pub xp: },
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct arm_ccn_dt {
    pub id: c_int,
    pub base: *mut void __iomem,
    pub config_lock: spinlock_t,
    pub 1): DECLARE_BITMAP(pmu_counters_mask, CCN_NUM_PMU_EVENT_COUNTERS +,
    struct {
    pub source: *mut arm_ccn_component,
    pub event: *mut perf_event,
    pub 1]: } pmu_counters[CCN_NUM_PMU_EVENT_COUNTERS +,
    struct {
    pub h: u64 l,,
    pub CCN_NUM_PREDEFINED_MASKS]: } cmp_mask[CCN_NUM_PMU_EVENT_COUNTERS +,
    pub hrtimer: hrtimer,
    pub cpu: c_uint,
    pub node: hlist_node,
    pub pmu: pmu,
...
pub struct arm_ccn {
    ...
    pub base: *mut void __iomem,
    pub irq: c_uint,
    pub sbas_present:1: unsigned,
    pub sbsx_present:1: unsigned,
    pub num_nodes: c_int,
    pub node: *mut arm_ccn_component,
    pub num_xps: c_int,
    pub xp: *mut arm_ccn_component,
    pub dt: arm_ccn_dt,
    pub mn_id: c_int,
}

#[no_mangle]
unsafe extern "C" fn arm_ccn_node_to_xp(node: c_int) -> c_int {
    static int arm_ccn_node_to_xp(int node)
    {
    return node / CCN_NUM_XP_PORTS;
    }
#[no_mangle]
unsafe extern "C" fn arm_ccn_node_to_xp_port(node: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_config_set(config: *mut u64, node_xp: u32, type: u32, port: u32) {
...
pub struct arm_ccn_pmu_event {
    ...
    __ATTR(_name, S_IRUGO, arm_ccn_pmu_event_show, core::ptr::null_mut())
//
...
// arm_ccn_pmu_events_attrs[ARRAY_SIZE(arm_ccn_pmu_events) + 1];
    ...
    struct device_attribute arm_ccn_pmu_cmp_mask_attr_##_name = \
    __ATTR(_name, S_IRUGO, arm_ccn_pmu_cmp_mask_show, core::ptr::null_mut())
    ...
    __ATTR(cpumask, S_IRUGO, arm_ccn_pmu_cpumask_show, core::ptr::null_mut());
...
// more than 4s.
//
    let mut arm_ccn_pmu_poll_period_us: static unsigned int = 10000;
    module_param_named(pmu_poll_period_us, arm_ccn_pmu_poll_period_us, uint,
    S_IRUGO | S_IWUSR);
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_timer_period() -> ktime_t {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_alloc_bit(bitmap: *mut c_ulong, size: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_type_eq(a: u32, b: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_alloc(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_release(event: *mut perf_event) {
    ...
    ccn.dt.pmu_counters[hw.idx].source = core::ptr::null_mut();
    ccn.dt.pmu_counters[hw.idx].event = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_init(event: *mut perf_event) -> c_int {
...
// Validate event ID vs available for the type
    ...
    let mut port: u32 = CCN_CONFIG_PORT(event.attr.config);
    let mut vc: u32 = CCN_CONFIG_VC(event.attr.config);
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_read_counter(ccn: *mut arm_ccn, idx: c_int) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_xp_dt_config(event: *mut perf_event, enable: c_int) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_xp_watchpoint_config(event: *mut perf_event) {
    ...
    struct arm_ccn_component *source =
    ccn.dt.pmu_counters[hw.idx].source;
    let mut wp: c_ulong = hw.config_base;
    u32 val;
    let mut cmp_l: u64 = event.attr.config1;
    let mut cmp_h: u64 = event.attr.config2;
    let mut mask_l: u64 = ccn.dt.cmp_mask[CCN_CONFIG_MASK(event.attr.config)].l;
    let mut mask_h: u64 = ccn.dt.cmp_mask[CCN_CONFIG_MASK(event.attr.config)].h;
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_xp_event_config(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_node_event_config(event: *mut perf_event) {
    ...
    struct arm_ccn_component *source =
    ccn.dt.pmu_counters[hw.idx].source;
    let mut type: u32 = CCN_CONFIG_TYPE(event.attr.config);
    u32 val, port;
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_config(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_active_counters(ccn: *mut arm_ccn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_del(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_event_read(event: *mut perf_event) {
    static void arm_ccn_pmu_event_read(struct perf_event *event)
    {
    arm_ccn_pmu_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_enable(pmu: *mut pmu) {
    static void arm_ccn_pmu_enable(struct pmu *pmu)
    {
    struct arm_ccn *ccn = pmu_to_arm_ccn(pmu);
    let mut val: u32 = readl(ccn.dt.base + CCN_DT_PMCR);
    val |= CCN_DT_PMCR__PMU_EN;
    writel(val, ccn.dt.base + CCN_DT_PMCR);
    }
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_disable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_overflow_handler(dt: *mut arm_ccn_dt) -> irqreturn_t {
    static irqreturn_t arm_ccn_pmu_overflow_handler(struct arm_ccn_dt *dt)
    {
    let mut pmovsr: u32 = readl(dt.base + CCN_DT_PMOVSR);
    int idx;
    if (!pmovsr)
    return IRQ_NONE;
    ...
    let mut overflowed: c_int = pmovsr & BIT(idx);
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_timer_handler(hrtimer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_init(ccn: *mut arm_ccn) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_pmu_cleanup(ccn: *mut arm_ccn) {
    ...
    ccn.num_xps = id + 1;
#[no_mangle]
pub unsafe extern "C" fn if(ccn->num_nodes: id >=) -> else {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_irq_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_init() -> int __init {
    static int __init arm_ccn_init(void)
    {
    int i, ret;
    ret = cpuhp_setup_state_multi(CPUHP_AP_PERF_ARM_CCN_ONLINE,
    "perf/arm/ccn:online", core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn arm_ccn_exit() -> void __exit {
