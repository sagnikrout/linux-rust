...
//! Source: drivers/perf/riscv_pmu_sbi.c
#![no_std]
...
//
    ...
    : : "r"(__irq_mask)						\
    : "memory")
pub const SYSCTL_NO_USER_ACCESS: c_int = 0;
pub const SYSCTL_USER_ACCESS: c_int = 1;
pub const SYSCTL_LEGACY: c_int = 2;
...
// Allow user mode access by default
    let mut __read_mostly: static int sysctl_perf_user_access = SYSCTL_USER_ACCESS;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sbi_pmu_event_data {
    union {
    union {
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hw_gen_event {
    pub event_code:16: u32,
    pub event_type:4: u32,
    pub reserved:12: u32,
    pub hw_gen_event: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hw_cache_event {
    pub result_id:1: u32,
    pub op_id:2: u32,
    pub cache_id:13: u32,
    pub event_type:4: u32,
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_check_event_info() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_check_event(edata: *mut sbi_pmu_event_data) {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_check_std_events(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_ctr_get_width(idx: c_int) -> c_int {
    static int pmu_sbi_ctr_get_width(int idx)
    {
    return pmu_ctr_list[idx].width;
    }
#[no_mangle]
unsafe extern "C" fn pmu_sbi_ctr_is_fw(cidx: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn riscv_pmu_get_event_info(type: u32, config: u64, econfig: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn riscv_pmu_get_hpm_info(hw_ctr_width: *mut u32, num_hw_ctr: *mut u32) -> c_int {
    int riscv_pmu_get_hpm_info(u32 *hw_ctr_width, u32 *num_hw_ctr)
    {
    int i;
    union sbi_pmu_ctr_info *info;
    let mut hpm_width: u32 = 0, hpm_count = 0;
    if (!cmask)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_csr_index(event: *mut perf_event) -> u8 {
    static uint8_t pmu_sbi_csr_index(struct perf_event *event)
    {
    return pmu_ctr_list[event.hw.idx].csr - CSR_CYCLE;
    }
#[no_mangle]
unsafe extern "C" fn pmu_sbi_get_filter_flags(event: *mut perf_event) -> c_ulong {
    static unsigned long pmu_sbi_get_filter_flags(struct perf_event *event)
    {
    let mut cflags: c_ulong = 0;
    let mut guest_events: bool = false;
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_ctr_get_idx(event: *mut perf_event) -> c_int {
    ...
    struct sbiret ret;
    int idx;
    let mut cbase: u64 = 0, cmask = rvpmu.cmask;
    let mut cflags: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_ctr_clear_idx(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn pmu_event_find_cache(config: u64) -> c_int {
    static int pmu_event_find_cache(u64 config)
    {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_is_fw_event(event: *mut perf_event) -> bool {
    static bool pmu_sbi_is_fw_event(struct perf_event *event)
    {
    let mut type: u32 = event.attr.type;
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_event_map(event: *mut perf_event, econfig: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_snapshot_free(pmu: *mut riscv_pmu) {
    ...
    cpu_hw_evt.snapshot_addr = core::ptr::null_mut();
    cpu_hw_evt.snapshot_addr_phys = 0;
    }
    }
#[no_mangle]
unsafe extern "C" fn pmu_sbi_snapshot_alloc(pmu: *mut riscv_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_snapshot_disable() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_snapshot_setup(pmu: *mut riscv_pmu, cpu: c_int) -> c_int {
    static int pmu_sbi_snapshot_setup(struct riscv_pmu *pmu, int cpu)
    {
    struct cpu_hw_events *cpu_hw_evt;
    let mut ret: sbiret = {0};
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_ctr_read(event: *mut perf_event) -> u64 {
    ...
    let mut info: union sbi_pmu_ctr_info = pmu_ctr_list[idx];
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_set_scounteren(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_reset_scounteren(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_ctr_start(event: *mut perf_event, ival: u64) {
    static void pmu_sbi_ctr_start(struct perf_event *event, u64 ival)
    {
    struct sbiret ret;
    struct hw_perf_event *hwc = &event.hw;
    let mut flag: c_ulong = SBI_PMU_START_FLAG_SET_INIT_VALUE;
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_ctr_stop(event: *mut perf_event, flag: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_find_num_ctrs() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_get_ctrinfo(nctr: c_int, mask: *mut c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn pmu_sbi_stop_all(pmu: *mut riscv_pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn pmu_sbi_stop_hw_ctrs(pmu: *mut riscv_pmu) {
    ...
    int i, idx;
    struct sbiret ret;
    let mut temp_ctr_overflow_mask: u64 = 0;
    if (sbi_pmu_snapshot_available())
    flag = SBI_PMU_STOP_FLAG_TAKE_SNAPSHOT;
...
//
    ...
    u64 ctr_ovf_mask)
    {
    let mut idx: c_int = 0, i;
    struct perf_event *event;
    let mut flag: c_ulong = SBI_PMU_START_FLAG_SET_INIT_VALUE;
    let mut ctr_start_mask: c_ulong = 0;
    uint64_t max_period;
...
// Reinitialize and start all the counter that overflowed
    ...
    int i, idx = 0;
    struct perf_event *event;
    let mut flag: c_ulong = SBI_PMU_START_FLAG_INIT_SNAPSHOT;
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_ovf_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_starting_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_dying_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_setup_irqs(pmu: *mut riscv_pmu, pdev: *mut platform_device) -> c_int {
    static int pmu_sbi_setup_irqs(struct riscv_pmu *pmu, struct platform_device *pdev)
    {
    int ret;
    struct cpu_hw_events __percpu *hw_events = pmu.hw_events;
    struct irq_domain *domain = core::ptr::null_mut();
    if (riscv_isa_extension_available(core::ptr::null_mut(), SSCOFPMF)) {
    ...
    struct cpu_hw_events *cpuc = this_cpu_ptr(rvpmu.hw_events);
    let mut enabled: bool = !bitmap_empty(cpuc.used_hw_ctrs, RISCV_MAX_COUNTERS);
    struct perf_event *event;
    int idx;
    if (!enabled)
    return NOTIFY_OK;
...
#[no_mangle]
unsafe extern "C" fn riscv_pm_pmu_register(pmu: *mut riscv_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn riscv_pm_pmu_unregister(pmu: *mut riscv_pmu) {
...
#[no_mangle]
unsafe extern "C" fn riscv_pmu_destroy(pmu: *mut riscv_pmu) {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_event_init(event: *mut perf_event) {
...
#[no_mangle]
pub unsafe extern "C" fn if(SYSCTL_USER_ACCESS: sysctl_perf_user_access ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_event_mapped(event: *mut perf_event, mm: *mut mm_struct) {
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_event_unmapped(event: *mut perf_event, mm: *mut mm_struct) {
...
#[no_mangle]
unsafe extern "C" fn riscv_pmu_update_counter_access(info: *mut c_void) {
    ...
    {
    let mut prev: c_int = sysctl_perf_user_access;
...
//
    ...
    return ret;
    on_each_cpu(riscv_pmu_update_counter_access, core::ptr::null_mut(), 1);
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_device_probe(pdev: *mut platform_device) -> c_int {
    static int pmu_sbi_device_probe(struct platform_device *pdev)
    {
    struct riscv_pmu *pmu = core::ptr::null_mut();
    let mut ret: c_int = -ENODEV;
    int num_counters;
    let mut irq_requested: bool = false;
...
// Asynchronously check which standard events are available
    ...
    kfree(pmu_ctr_list);
    pmu_ctr_list = core::ptr::null_mut();
    kfree(pmu);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn pmu_sbi_devinit() -> int __init {
    ...
    if (ret)
    return ret;
    pdev = platform_device_register_simple(RISCV_PMU_SBI_PDEV_NAME, -1, core::ptr::null_mut(), 0);
    if (IS_ERR(pdev)) {
