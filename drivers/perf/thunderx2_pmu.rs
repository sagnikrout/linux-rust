...
//! Source: drivers/perf/thunderx2_pmu.c
#![no_std]
...
//
pub const TX2_PMU_DMC_L3C_MAX_COUNTERS: c_int = 4;
pub const TX2_PMU_CCPI2_MAX_COUNTERS: c_int = 8;

pub const TX2_PMU_DMC_CHANNELS: c_int = 8;
pub const TX2_PMU_L3_TILES: c_int = 16;
...
pub const CCPI2_COUNTER_OFFSET: c_int = 8;
pub const L3C_COUNTER_CTL: c_uint = 0xA8;
pub const L3C_COUNTER_DATA: c_uint = 0xAC;
pub const DMC_COUNTER_CTL: c_uint = 0x234;
pub const DMC_COUNTER_DATA: c_uint = 0x240;
pub const CCPI2_PERF_CTL: c_uint = 0x108;
pub const CCPI2_COUNTER_CTL: c_uint = 0x10C;
pub const CCPI2_COUNTER_SEL: c_uint = 0x12c;
pub const CCPI2_COUNTER_DATA_L: c_uint = 0x130;
pub const CCPI2_COUNTER_DATA_H: c_uint = 0x134;
// L3C event IDs
pub const L3_EVENT_READ_REQ: c_uint = 0xD;
pub const L3_EVENT_WRITEBACK_REQ: c_uint = 0xE;
pub const L3_EVENT_INV_N_WRITE_REQ: c_uint = 0xF;
pub const L3_EVENT_INV_REQ: c_uint = 0x10;
pub const L3_EVENT_EVICT_REQ: c_uint = 0x13;
pub const L3_EVENT_INV_N_WRITE_HIT: c_uint = 0x14;
pub const L3_EVENT_INV_HIT: c_uint = 0x15;
pub const L3_EVENT_READ_HIT: c_uint = 0x17;
pub const L3_EVENT_MAX: c_uint = 0x18;
// DMC event IDs
pub const DMC_EVENT_COUNT_CYCLES: c_uint = 0x1;
pub const DMC_EVENT_WRITE_TXNS: c_uint = 0xB;
pub const DMC_EVENT_DATA_TRANSFERS: c_uint = 0xD;
pub const DMC_EVENT_READ_TXNS: c_uint = 0xF;
pub const DMC_EVENT_MAX: c_uint = 0x10;
pub const CCPI2_EVENT_REQ_PKT_SENT: c_uint = 0x3D;
pub const CCPI2_EVENT_SNOOP_PKT_SENT: c_uint = 0x65;
pub const CCPI2_EVENT_DATA_PKT_SENT: c_uint = 0x105;
pub const CCPI2_EVENT_GIC_PKT_SENT: c_uint = 0x12D;
pub const CCPI2_EVENT_MAX: c_uint = 0x200;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tx2_uncore_pmu {
    pub hpnode: hlist_node,
    pub entry: list_head,
    pub pmu: pmu,
    pub name: *mut c_char,
    pub node: c_int,
    ...
    pub counters_mask: u32,
    pub prorate_factor: u32,
    pub max_events: u32,
    pub events_mask: u32,
    pub hrtimer_interval: u64,
    pub base: *mut void __iomem,
    pub TX2_PMU_MAX_COUNTERS): DECLARE_BITMAP(active_counters,,
    pub events: [*mut perf_event; TX2_PMU_MAX_COUNTERS],
    pub dev: *mut device,
    pub hrtimer: hrtimer,
    pub attr_groups: *const attribute_group,
    pub type: enum tx2_uncore_type,
    pub cb): *mut *mut enum hrtimer_restart (hrtimer_callback)(struct hrtimer,
    void (*init_cntr_base)(struct perf_event *event,
    pub tx2_pmu): *mut tx2_uncore_pmu,
    pub event): *mut *mut void (stop_event)(struct perf_event,
    pub flags): *mut *mut *mut void (start_event)(struct perf_event event, int,
}
    ...
    __ATTR(_name, 0444, __tx2_pmu_##_var##_show, core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn reg_readl(addr: c_ulong) -> u32 {
    static inline u32 reg_readl(unsigned long addr)
    {
    return readl((void __iomem *)addr);
    }
#[no_mangle]
pub unsafe extern "C" fn reg_writel(val: u32, addr: c_ulong) {
    static inline void reg_writel(u32 val, unsigned long addr)
    {
    writel(val, (void __iomem *)addr);
    }
#[no_mangle]
unsafe extern "C" fn alloc_counter(tx2_pmu: *mut tx2_uncore_pmu) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn free_counter(tx2_pmu: *mut tx2_uncore_pmu, counter: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uncore_start_event_l3c(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn uncore_stop_event_l3c(event: *mut perf_event) {
    static inline void uncore_stop_event_l3c(struct perf_event *event)
    {
    reg_writel(0, event.hw.config_base);
    }
#[no_mangle]
unsafe extern "C" fn uncore_start_event_dmc(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uncore_stop_event_dmc(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn uncore_start_event_ccpi2(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn uncore_stop_event_ccpi2(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn get_tx2_pmu_type(adev: *mut acpi_device) -> enum tx2_uncore_type {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_event_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_event_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_event_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_event_del(event: *mut perf_event, flags: c_int) {
...
// clear the assigned counter
    ...
    perf_event_update_userpage(event);
    tx2_pmu.events[hwc.idx] = core::ptr::null_mut();
    hwc.idx = -1;
    if (!tx2_pmu.hrtimer_callback)
    return;
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_event_read(event: *mut perf_event) {
    static void tx2_uncore_event_read(struct perf_event *event)
    {
    tx2_uncore_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn tx2_hrtimer_callback(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_pmu_add_dev(tx2_pmu: *mut tx2_uncore_pmu) -> c_int {
...
// Add to list
    ...
    int ret;
    INIT_LIST_HEAD(&list);
    ret = acpi_dev_get_resources(adev, &list, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret <= 0) {
...
// CCPI2 has 8 counters
    ...
    tx2_pmu.hrtimer_callback = core::ptr::null_mut();
    break;
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_probe(pdev: *mut platform_device) -> c_int {
...
// Walk through the tree for all PMU UNCORE devices
    ...
    tx2_uncore_pmu_add,
    core::ptr::null_mut(), dev, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tx2_uncore_driver_exit() -> void __exit {
