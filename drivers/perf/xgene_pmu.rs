...
//! Source: drivers/perf/xgene_pmu.c
#![no_std]
...
pub const CSW_CSWCR: c_uint = 0x0000;

pub const MCBADDRMR: c_uint = 0x0000;

pub const PCPPMU_INTSTATUS_REG: c_uint = 0x000;
pub const PCPPMU_INTMASK_REG: c_uint = 0x004;
pub const PCPPMU_INTMASK: c_uint = 0x0000000F;
pub const PCPPMU_INTENMASK: c_uint = 0xFFFFFFFF;
pub const PCPPMU_INTCLRMASK: c_uint = 0xFFFFFFF0;

pub const PCPPMU_V3_INTMASK: c_uint = 0x00FF33FF;
pub const PCPPMU_V3_INTENMASK: c_uint = 0xFFFFFFFF;
pub const PCPPMU_V3_INTCLRMASK: c_uint = 0xFF00CC00;
pub const PCPPMU_V3_INT_MCU: c_uint = 0x000000FF;
pub const PCPPMU_V3_INT_MCB: c_uint = 0x00000300;
pub const PCPPMU_V3_INT_L3C: c_uint = 0x00FF0000;
pub const PCPPMU_V3_INT_IOB: c_uint = 0x00003000;
pub const PMU_MAX_COUNTERS: c_int = 4;
pub const PMU_CNT_MAX_PERIOD: c_uint = 0xFFFFFFFFULL;
pub const PMU_V3_CNT_MAX_PERIOD: c_uint = 0xFFFFFFFFFFFFFFFFULL;
pub const PMU_OVERFLOW_MASK: c_uint = 0xF;

pub const PMU_PMEVCNTR0: c_uint = 0x000;
pub const PMU_PMEVCNTR1: c_uint = 0x004;
pub const PMU_PMEVCNTR2: c_uint = 0x008;
pub const PMU_PMEVCNTR3: c_uint = 0x00C;
pub const PMU_PMEVTYPER0: c_uint = 0x400;
pub const PMU_PMEVTYPER1: c_uint = 0x404;
pub const PMU_PMEVTYPER2: c_uint = 0x408;
pub const PMU_PMEVTYPER3: c_uint = 0x40C;
pub const PMU_PMAMR0: c_uint = 0xA00;
pub const PMU_PMAMR1: c_uint = 0xA04;
pub const PMU_PMCNTENSET: c_uint = 0xC00;
pub const PMU_PMCNTENCLR: c_uint = 0xC20;
pub const PMU_PMINTENSET: c_uint = 0xC40;
pub const PMU_PMINTENCLR: c_uint = 0xC60;
pub const PMU_PMOVSR: c_uint = 0xC80;
pub const PMU_PMCR: c_uint = 0xE04;
// PMU registers for V3
pub const PMU_PMOVSCLR: c_uint = 0xC80;
pub const PMU_PMOVSSET: c_uint = 0xCC0;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct hw_pmu_info {
    pub type: u32,
    pub enable_mask: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_pmu_dev {
    pub inf: *mut hw_pmu_info,
    pub parent: *mut xgene_pmu,
    pub pmu: pmu,
    pub max_counters: u8,
    pub PMU_MAX_COUNTERS): DECLARE_BITMAP(cntr_assign_mask,,
    pub max_period: u64,
    pub attr_groups: *const attribute_group,
    pub pmu_counter_event: [*mut perf_event; PMU_MAX_COUNTERS],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_pmu_ops {
    pub pmu): *mut *mut void (mask_int)(struct xgene_pmu,
    pub pmu): *mut *mut void (unmask_int)(struct xgene_pmu,
    pub idx): *mut *mut *mut u64 (read_counter)(struct xgene_pmu_dev pmu, int,
    pub val): *mut *mut *mut void (write_counter)(struct xgene_pmu_dev pmu, int idx, u64,
    pub val): *mut *mut *mut void (write_evttype)(struct xgene_pmu_dev pmu_dev, int idx, u32,
    pub val): *mut *mut *mut void (write_agentmsk)(struct xgene_pmu_dev pmu_dev, u32,
    pub val): *mut *mut *mut void (write_agent1msk)(struct xgene_pmu_dev pmu_dev, u32,
    pub idx): *mut *mut *mut void (enable_counter)(struct xgene_pmu_dev pmu_dev, int,
    pub idx): *mut *mut *mut void (disable_counter)(struct xgene_pmu_dev pmu_dev, int,
    pub idx): *mut *mut *mut void (enable_counter_int)(struct xgene_pmu_dev pmu_dev, int,
    pub idx): *mut *mut *mut void (disable_counter_int)(struct xgene_pmu_dev pmu_dev, int,
    pub pmu_dev): *mut *mut void (reset_counters)(struct xgene_pmu_dev,
    pub pmu_dev): *mut *mut void (start_counters)(struct xgene_pmu_dev,
    pub pmu_dev): *mut *mut void (stop_counters)(struct xgene_pmu_dev,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_pmu {
    pub dev: *mut device,
    pub node: hlist_node,
    pub version: c_int,
    pub pcppmu_csr: *mut void __iomem,
    pub mcb_active_mask: u32,
    pub mc_active_mask: u32,
    pub l3c_active_mask: u32,
    pub cpu: cpumask_t,
    pub irq: c_int,
    pub lock: raw_spinlock_t,
    pub ops: *const xgene_pmu_ops,
    pub l3cpmus: list_head,
    pub iobpmus: list_head,
    pub mcbpmus: list_head,
    pub mcpmus: list_head,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_pmu_dev_ctx {
    pub name: *mut c_char,
    pub next: list_head,
    pub pmu_dev: *mut xgene_pmu_dev,
    pub inf: hw_pmu_info,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_pmu_data {
    pub id: c_int,
    pub data: u32,
}
...
//
    ...
    { .attr = __ATTR(_name, S_IRUGO, device_show_string, core::ptr::null_mut()), \
    .var = (void *) _config, }		\
    })[0].attr.attr)
...
#[no_mangle]
unsafe extern "C" fn get_next_avail_cntr(pmu_dev: *mut xgene_pmu_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn clear_avail_cntr(pmu_dev: *mut xgene_pmu_dev, cntr: c_int) {
    static void clear_avail_cntr(struct xgene_pmu_dev *pmu_dev, int cntr)
    {
    clear_bit(cntr, pmu_dev.cntr_assign_mask);
    }
#[no_mangle]
pub unsafe extern "C" fn xgene_pmu_mask_int(xgene_pmu: *mut xgene_pmu) {
    static inline void xgene_pmu_mask_int(struct xgene_pmu *xgene_pmu)
    {
    writel(PCPPMU_INTENMASK, xgene_pmu.pcppmu_csr + PCPPMU_INTMASK_REG);
    }
#[no_mangle]
pub unsafe extern "C" fn xgene_pmu_v3_mask_int(xgene_pmu: *mut xgene_pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn xgene_pmu_unmask_int(xgene_pmu: *mut xgene_pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn xgene_pmu_v3_unmask_int(xgene_pmu: *mut xgene_pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn xgene_pmu_reset_counters(pmu_dev: *mut xgene_pmu_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn xgene_pmu_start_counters(pmu_dev: *mut xgene_pmu_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn xgene_pmu_stop_counters(pmu_dev: *mut xgene_pmu_dev) {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_pmu_enable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_pmu_disable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_enable_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_disable_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_event_set_period(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_read(event: *mut perf_event) {
    static void xgene_perf_read(struct perf_event *event)
    {
    xgene_perf_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn xgene_perf_start(event: *mut perf_event, flags: c_int) {
    ...
    let mut prev_raw_count: u64 = local64_read(&hw.prev_count);
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_perf_del(event: *mut perf_event, flags: c_int) {
...
// clear the assigned counter
    ...
    perf_event_update_userpage(event);
    pmu_dev.pmu_counter_event[hw.idx] = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn xgene_init_perf(pmu_dev: *mut xgene_pmu_dev, name: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn _xgene_pmu_isr(irq: c_int, pmu_dev: *mut xgene_pmu_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(PCP_PMU_V2: xgene_pmu->version ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgene_pmu_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x1): (mcb0routing == 0x1) && (mcb1routing ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x1: mcb0routing ==) -> else {
...
// Probe all active MC(s)
    ...
    rc = acpi_dev_get_resources(adev, &resource_list, core::ptr::null_mut(), core::ptr::null_mut());
    if (rc <= 0) {
...
// A PMU device node without enable-bit-index is always enabled
    ...
    {
    const struct acpi_device_id *match_id = core::ptr::null_mut();
    const struct acpi_device_id *id;
    for (id = ids; id.id[0] || id.cls; id++) {
    if (!acpi_match_device_ids(adev, id))
    match_id = id;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: match_id) -> else {
    else if (match_id)
    break;
    }
    return match_id;
...
// Can't add the PMU device, skip it
    ...
    acpi_pmu_dev_add, core::ptr::null_mut(), xgene_pmu, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "apm, _arg: xgene-pmu-iob")) -> else {
    else if (of_device_is_compatible(np, "apm,xgene-pmu-iob"))
    ctx = fdt_get_pmu_hw_inf(xgene_pmu, np, PMU_TYPE_IOB);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "apm, _arg: xgene-pmu-mcb")) -> else {
    else if (of_device_is_compatible(np, "apm,xgene-pmu-mcb"))
    ctx = fdt_get_pmu_hw_inf(xgene_pmu, np, PMU_TYPE_MCB);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: of_device_is_compatible(np, _arg: "apm, _arg: xgene-pmu-mc")) -> else {
...
#[no_mangle]
unsafe extern "C" fn xgene_pmu_online_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_pmu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_pmu_remove(pdev: *mut platform_device) {
