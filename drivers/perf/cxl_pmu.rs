...
pub const CXL_PMU_CAP_REG: c_uint = 0x0;

pub const CXL_PMU_OVERFLOW_REG: c_uint = 0x10;
pub const CXL_PMU_FREEZE_REG: c_uint = 0x18;

pub const CXL_PMU_COUNTER_CFG_TYPE_FREE_RUN: c_int = 0;
pub const CXL_PMU_COUNTER_CFG_TYPE_FIXED_FUN: c_int = 1;
pub const CXL_PMU_COUNTER_CFG_TYPE_CONFIGURABLE: c_int = 2;

// CXL rev 3.0 Table 13-5 Events under CXL Vendor ID
pub const CXL_PMU_GID_CLOCK_TICKS: c_uint = 0x00;
pub const CXL_PMU_GID_D2H_REQ: c_uint = 0x0010;
pub const CXL_PMU_GID_D2H_RSP: c_uint = 0x0011;
pub const CXL_PMU_GID_H2D_REQ: c_uint = 0x0012;
pub const CXL_PMU_GID_H2D_RSP: c_uint = 0x0013;
pub const CXL_PMU_GID_CACHE_DATA: c_uint = 0x0014;
pub const CXL_PMU_GID_M2S_REQ: c_uint = 0x0020;
pub const CXL_PMU_GID_M2S_RWD: c_uint = 0x0021;
pub const CXL_PMU_GID_M2S_BIRSP: c_uint = 0x0022;
pub const CXL_PMU_GID_S2M_BISNP: c_uint = 0x0023;
pub const CXL_PMU_GID_S2M_NDR: c_uint = 0x0024;
pub const CXL_PMU_GID_S2M_DRS: c_uint = 0x0025;
pub const CXL_PMU_GID_DDR: c_uint = 0x8000;
pub const CXL_PMU_GID_QUEUE_OCC: c_uint = 0x8001;
pub const CXL_PMU_GID_QUEUE_RESID: c_uint = 0x8002;
pub const CXL_PMU_GID_RETRY_EVENTS: c_uint = 0x8003;
pub const CXL_PMU_GID_THROTTLE: c_uint = 0x8004;
    static int cxl_pmu_cpuhp_state_num;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_pmu_ev_cap {
    pub vid: u16,
    pub gid: u16,
    pub msk: u32,
    union {
    pub /: *mut *mut int counter_idx; / fixed counters,
    pub /: *mut *mut int event_idx; / configurable counters,
}

    struct list_head node;
    };
pub const CXL_PMU_MAX_COUNTERS: c_int = 64;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cxl_pmu_info {
    pub pmu: pmu,
    pub base: *mut void __iomem,
    pub hw_events: *mut perf_event,
    pub event_caps_configurable: list_head,
    pub event_caps_fixed: list_head,
    pub CXL_PMU_MAX_COUNTERS): DECLARE_BITMAP(used_counter_bm,,
    pub CXL_PMU_MAX_COUNTERS): DECLARE_BITMAP(conf_counter_bm,,
    pub counter_width: u16,
    pub num_counters: u8,
    pub num_event_capabilities: u8,
    pub on_cpu: c_int,
    pub node: hlist_node,
    pub filter_hdm: bool,
    pub filter_crb: bool,
...
//
#[no_mangle]
unsafe extern "C" fn cxl_pmu_parse_caps(dev: *mut device, info: *mut cxl_pmu_info) -> c_int {
    static int cxl_pmu_parse_caps(struct device *dev, struct cxl_pmu_info *info)
    {
    let mut fixed_counter_event_cap_bm: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_config_get_mask(event: *mut perf_event) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_config1_get_invert(event: *mut perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_config1_get_edge(event: *mut perf_event) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn cxl_pmu_config1_hdm_filter_en(event: *mut perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_config2_get_hdm_decoder(event: *mut perf_event) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_config1_crb_filter_en(event: *mut perf_event) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_config2_get_crb(event: *mut perf_event) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_event_is_visible(kobj: *mut kobject, attr: *mut attribute, a: c_int) -> umode_t {
    ...
    struct device *dev = kobj_to_dev(kobj);
    struct cxl_pmu_info *info = dev_get_drvdata(dev);
    let mut vid: c_int = FIELD_GET(CXL_PMU_ATTR_CONFIG_VID_MSK, pmu_attr.id);
    let mut gid: c_int = FIELD_GET(CXL_PMU_ATTR_CONFIG_GID_MSK, pmu_attr.id);
    let mut msk: c_int = FIELD_GET(CXL_PMU_ATTR_CONFIG_MASK_MSK, pmu_attr.id);
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_event_init(event: *mut perf_event) -> c_int {
...
//
    rc = cxl_pmu_get_event_idx(event, core::ptr::null_mut(), core::ptr::null_mut());
    if (rc < 0)
    return rc;
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_enable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_disable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_event_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_read_counter(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn __cxl_pmu_read(event: *mut perf_event, overflow: bool) {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_read(event: *mut perf_event) {
    static void cxl_pmu_read(struct perf_event *event)
    {
    __cxl_pmu_read(event, false);
    }
#[no_mangle]
unsafe extern "C" fn cxl_pmu_event_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_event_add(event: *mut perf_event, flags: c_int) -> c_int {
    static int cxl_pmu_event_add(struct perf_event *event, int flags)
    {
    struct cxl_pmu_info *info = pmu_to_cxl_pmu_info(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
    int idx, rc;
    let mut event_idx: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_event_del(event: *mut perf_event, flags: c_int) {
    ...
    info.hw_events[hwc.idx] = core::ptr::null_mut();
    perf_event_update_userpage(event);
    }
#[no_mangle]
unsafe extern "C" fn cxl_pmu_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_perf_unregister(_info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_cpuhp_remove(_info: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_online_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_init() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn cxl_pmu_exit() -> __exit void {
