...
//! Source: drivers/perf/arm_v6_pmu.c
#![no_std]
...
pub const ARMV6_PMCR_EVT_COUNT0_SHIFT: c_int = 20;

pub const ARMV6_PMCR_EVT_COUNT1_SHIFT: c_int = 12;
...
#[no_mangle]
pub unsafe extern "C" fn if(counter: ARMV6_COUNTER0 ==) -> else {
    else if (ARMV6_COUNTER0 == counter)
    ret = pmcr & ARMV6_PMCR_COUNT0_OVERFLOW;
#[no_mangle]
pub unsafe extern "C" fn if(counter: ARMV6_COUNTER1 ==) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn armv6pmu_read_counter(event: *mut perf_event) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn armv6pmu_write_counter(event: *mut perf_event, value: u64) {
...
#[no_mangle]
unsafe extern "C" fn armv6pmu_enable_event(event: *mut perf_event) {
...
//
    ...
    {
    let mut pmcr: c_ulong = armv6_pmcr_read();
...
#[no_mangle]
unsafe extern "C" fn armv6pmu_start(cpu_pmu: *mut arm_pmu) {
...
#[no_mangle]
unsafe extern "C" fn armv6pmu_stop(cpu_pmu: *mut arm_pmu) {
...
#[no_mangle]
unsafe extern "C" fn armv6pmu_disable_event(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn armv6_map_event(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armv6pmu_init(cpu_pmu: *mut arm_pmu) {
...
#[no_mangle]
unsafe extern "C" fn armv6_1136_pmu_init(cpu_pmu: *mut arm_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armv6_1176_pmu_init(cpu_pmu: *mut arm_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armv6_pmu_device_probe(pdev: *mut platform_device) -> c_int {
    static int armv6_pmu_device_probe(struct platform_device *pdev)
    {
    return arm_pmu_device_probe(pdev, armv6_pmu_of_device_ids, core::ptr::null_mut());
    }
