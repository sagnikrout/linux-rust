...
//! Source: drivers/perf/qcom_l3_pmu.c
#![no_std]
...
pub const L3_NUM_COUNTERS: c_int = 8;
// Mask for the event type field within perf_event_attr.config and EVTYPE reg
pub const L3_EVTYPE_MASK: c_uint = 0xFF;
//
...
//
pub const L3_EVENT_LC_BIT: c_int = 32;
//
// Register offsets
//
// Perfmon registers
pub const L3_HML3_PM_CR: c_uint = 0x000;

pub const L3_HML3_PM_FILTRA: c_uint = 0x300;
pub const L3_HML3_PM_FILTRB: c_uint = 0x308;
pub const L3_HML3_PM_FILTRC: c_uint = 0x310;
pub const L3_HML3_PM_FILTRAM: c_uint = 0x304;
pub const L3_HML3_PM_FILTRBM: c_uint = 0x30C;
pub const L3_HML3_PM_FILTRCM: c_uint = 0x314;
// Basic counter registers
pub const L3_M_BC_CR: c_uint = 0x500;
pub const L3_M_BC_SATROLL_CR: c_uint = 0x504;
pub const L3_M_BC_CNTENSET: c_uint = 0x508;
pub const L3_M_BC_CNTENCLR: c_uint = 0x50C;
pub const L3_M_BC_INTENSET: c_uint = 0x510;
pub const L3_M_BC_INTENCLR: c_uint = 0x514;
pub const L3_M_BC_GANG: c_uint = 0x718;
pub const L3_M_BC_OVSR: c_uint = 0x740;
pub const L3_M_BC_IRQCTL: c_uint = 0x96C;
//
...
// Events
//
pub const L3_EVENT_CYCLES: c_uint = 0x01;
pub const L3_EVENT_READ_HIT: c_uint = 0x20;
pub const L3_EVENT_READ_MISS: c_uint = 0x21;
pub const L3_EVENT_READ_HIT_D: c_uint = 0x22;
pub const L3_EVENT_READ_MISS_D: c_uint = 0x23;
pub const L3_EVENT_WRITE_HIT: c_uint = 0x24;
pub const L3_EVENT_WRITE_MISS: c_uint = 0x25;
//
...
#[no_mangle]
pub unsafe extern "C" fn event_uses_long_counter(event: *mut perf_event) -> bool {
    static inline bool event_uses_long_counter(struct perf_event *event)
    {
    return !!(event.attr.config & BIT_ULL(L3_EVENT_LC_BIT));
    }
#[no_mangle]
pub unsafe extern "C" fn event_num_counters(event: *mut perf_event) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct l3cache_pmu {
    pub pmu: pmu,
    pub node: hlist_node,
    pub regs: *mut void __iomem,
    pub events: [*mut perf_event; L3_NUM_COUNTERS],
    pub used_mask: [c_ulong; BITS_TO_LONGS(L3_NUM_COUNTERS)],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct l3cache_event_ops {
// Called to start event monitoring
    pub event): *mut *mut void (start)(struct perf_event,
...
// Called to update the perf_event
    pub event): *mut *mut void (update)(struct perf_event,
}
...
//
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__64bit_counter_start(event: *mut perf_event) {
    ...
    let mut evsel: u32 = get_event_type(event);
    u32 gang;
...
// Finally, enable the counters
    ...
    struct l3cache_pmu *l3pmu = to_l3cache_pmu(event.pmu);
    let mut idx: c_int = event.hw.idx;
    let mut gang: u32 = readl_relaxed(l3pmu.regs + L3_M_BC_GANG);
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__64bit_counter_update(event: *mut perf_event) {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__32bit_counter_start(event: *mut perf_event) {
    static void qcom_l3_cache__32bit_counter_start(struct perf_event *event)
    {
    struct l3cache_pmu *l3pmu = to_l3cache_pmu(event.pmu);
    let mut idx: c_int = event.hw.idx;
    let mut evsel: u32 = get_event_type(event);
    let mut irqctl: u32 = readl_relaxed(l3pmu.regs + L3_M_BC_IRQCTL);
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__32bit_counter_update(event: *mut perf_event) {
...
//
#[no_mangle]
pub unsafe extern "C" fn qcom_l3_cache__init(l3pmu: *mut l3cache_pmu) {
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__handle_irq(irq_num: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t qcom_l3_cache__handle_irq(int irq_num, void *data)
    {
    struct l3cache_pmu *l3pmu = data;
// Read the overflow status register
    let mut status: c_long = readl_relaxed(l3pmu.regs + L3_M_BC_OVSR);
    int idx;
    if (status == 0)
    return IRQ_NONE;
...
//
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__pmu_enable(pmu: *mut pmu) {
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__pmu_disable(pmu: *mut pmu) {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__validate_event_group(event: *mut perf_event) -> bool {
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__event_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__event_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__event_add(event: *mut perf_event, flags: c_int) -> c_int {
    static int qcom_l3_cache__event_add(struct perf_event *event, int flags)
    {
    struct l3cache_pmu *l3pmu = to_l3cache_pmu(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
    let mut order: c_int = event_uses_long_counter(event) ? 1 : 0;
    int idx;
//
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__event_del(event: *mut perf_event, flags: c_int) {
...
// Stop and clean up
    ...
    l3pmu.events[hwc.idx] = core::ptr::null_mut();
    bitmap_release_region(l3pmu.used_mask, hwc.idx, order);
// Propagate changes to the userspace mapping.
    perf_event_update_userpage(event);
    }
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache__event_read(event: *mut perf_event) {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache_pmu_online_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_l3_cache_pmu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn register_qcom_l3_cache_pmu_driver() -> int __init {
