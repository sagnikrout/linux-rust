...
//! Source: drivers/perf/alibaba_uncore_drw_pmu.c
#![no_std]
...
pub const ALI_DRW_PMU_COMMON_MAX_COUNTERS: c_int = 16;
pub const ALI_DRW_PMU_TEST_SEL_COMMON_COUNTER_BASE: c_int = 19;
pub const ALI_DRW_PMU_PA_SHIFT: c_int = 12;
pub const ALI_DRW_PMU_CNT_INIT: c_uint = 0x00000000;
pub const ALI_DRW_CNT_MAX_PERIOD: c_uint = 0xffffffff;
pub const ALI_DRW_PMU_CYCLE_EVT_ID: c_uint = 0x80;
pub const ALI_DRW_PMU_CNT_CTRL: c_uint = 0xC00;

pub const ALI_DRW_PMU_CNT_STATE: c_uint = 0xC04;
pub const ALI_DRW_PMU_TEST_CTRL: c_uint = 0xC08;
pub const ALI_DRW_PMU_CNT_PRELOAD: c_uint = 0xC0C;

pub const ALI_DRW_PMU_CYCLE_CNT_HIGH: c_uint = 0xC10;
pub const ALI_DRW_PMU_CYCLE_CNT_LOW: c_uint = 0xC14;
// PMU EVENT SEL 0-3 are paired in 32-bit registers on a 4-byte stride
pub const ALI_DRW_PMU_EVENT_SEL0: c_uint = 0xC68;
...
pub const ALI_DRW_PMU_COMMON_COUNTER0: c_uint = 0xC78;

    (ALI_DRW_PMU_COMMON_COUNTER0 + 0x4 * (n))
pub const ALI_DRW_PMU_OV_INTR_ENABLE_CTL: c_uint = 0xCB8;
pub const ALI_DRW_PMU_OV_INTR_DISABLE_CTL: c_uint = 0xCBC;
pub const ALI_DRW_PMU_OV_INTR_ENABLE_STATUS: c_uint = 0xCC0;
pub const ALI_DRW_PMU_OV_INTR_CLR: c_uint = 0xCC4;
pub const ALI_DRW_PMU_OV_INTR_STATUS: c_uint = 0xCC8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ali_drw_pmu {
    pub cfg_base: *mut void __iomem,
    pub dev: *mut device,
    pub pmus_node: list_head,
    pub irq: *mut ali_drw_pmu_irq,
    pub irq_num: c_int,
    pub cpu: c_int,
    pub ALI_DRW_PMU_COMMON_MAX_COUNTERS): DECLARE_BITMAP(used_mask,,
    pub events: [*mut perf_event; ALI_DRW_PMU_COMMON_MAX_COUNTERS],
    pub evtids: [c_int; ALI_DRW_PMU_COMMON_MAX_COUNTERS],
    pub pmu: pmu,
}
...
//
    ...
    __ATTR(cpumask, 0444, ali_drw_pmu_cpumask_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ali_drw_get_counter_idx(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_read_counter(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_event_set_period(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_enable_counter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_disable_counter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_isr(irq_num: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_uninit_irq(drw_pmu: *mut ali_drw_pmu) {
    ...
    mutex_unlock(&ali_drw_pmu_irqs_lock);
    WARN_ON(irq_set_affinity_hint(irq.irq_num, core::ptr::null_mut()));
    cpuhp_state_remove_instance_nocalls(ali_drw_cpuhp_state_num,
    &irq.node);
    kfree(irq);
    }
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_del(event: *mut perf_event, flags: c_int) {
    ...
    drw_pmu.events[idx] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_read(event: *mut perf_event) {
    static void ali_drw_pmu_read(struct perf_event *event)
    {
    ali_drw_pmu_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_init() -> int __init {
    static int __init ali_drw_pmu_init(void)
    {
    int ret;
    ret = cpuhp_setup_state_multi(CPUHP_AP_ONLINE_DYN,
    "ali_drw_pmu:online",
    core::ptr::null_mut(), ali_drw_pmu_offline_cpu);
    if (ret < 0) {
...
#[no_mangle]
unsafe extern "C" fn ali_drw_pmu_exit() -> void __exit {
