...
//! Source: drivers/perf/arm_dmc620_pmu.c
#![no_std]
...
pub const DMC620_PA_SHIFT: c_int = 12;
pub const DMC620_CNT_INIT: c_uint = 0x80000000;
pub const DMC620_CNT_MAX_PERIOD: c_uint = 0xffffffff;
pub const DMC620_PMU_CLKDIV2_MAX_COUNTERS: c_int = 8;
pub const DMC620_PMU_CLK_MAX_COUNTERS: c_int = 2;
...
//
pub const DMC620_PMU_OVERFLOW_STATUS_CLKDIV2: c_uint = 0x8;

    (DMC620_PMU_CLKDIV2_MAX_COUNTERS - 1)
pub const DMC620_PMU_OVERFLOW_STATUS_CLK: c_uint = 0xC;

    (DMC620_PMU_CLK_MAX_COUNTERS - 1)
pub const DMC620_PMU_COUNTERS_BASE: c_uint = 0x10;
pub const DMC620_PMU_COUNTERn_MASK_31_00: c_uint = 0x0;
pub const DMC620_PMU_COUNTERn_MASK_63_32: c_uint = 0x4;
pub const DMC620_PMU_COUNTERn_MATCH_31_00: c_uint = 0x8;
pub const DMC620_PMU_COUNTERn_MATCH_63_32: c_uint = 0xC;
pub const DMC620_PMU_COUNTERn_CONTROL: c_uint = 0x10;

pub const DMC620_PMU_COUNTERn_VALUE: c_uint = 0x20;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmc620_pmu_irq {
    pub node: hlist_node,
    pub pmus_node: list_head,
    pub irqs_node: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmc620_pmu {
    pub pmu: pmu,
    pub base: *mut void __iomem,
    pub irq: *mut dmc620_pmu_irq,
    pub pmus_node: list_head,
//
...
//
    pub DMC620_PMU_MAX_COUNTERS): DECLARE_BITMAP(used_mask,,
    pub events: [*mut perf_event; DMC620_PMU_MAX_COUNTERS],
}

    static int cpuhp_state_num;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmc620_pmu_event_attr {
    ...
    .attr = __ATTR(_name, 0444, dmc620_pmu_event_show, core::ptr::null_mut()),	\
    .clkdiv2 = _clkdiv2,						\
    .eventid = _eventid,					\
    }})[0].attr.attr)
...
pub const ATTR_CFG_FLD_mask_LO: c_int = 0;
pub const ATTR_CFG_FLD_mask_HI: c_int = 44;

pub const ATTR_CFG_FLD_match_LO: c_int = 0;
pub const ATTR_CFG_FLD_match_HI: c_int = 44;

pub const ATTR_CFG_FLD_invert_LO: c_int = 0;
pub const ATTR_CFG_FLD_invert_HI: c_int = 0;

pub const ATTR_CFG_FLD_incr_LO: c_int = 1;
pub const ATTR_CFG_FLD_incr_HI: c_int = 2;

pub const ATTR_CFG_FLD_event_LO: c_int = 3;
pub const ATTR_CFG_FLD_event_HI: c_int = 8;

pub const ATTR_CFG_FLD_clkdiv2_LO: c_int = 9;
pub const ATTR_CFG_FLD_clkdiv2_HI: c_int = 9;
    ...
    __ATTR(cpumask, 0444, dmc620_pmu_cpumask_show, core::ptr::null_mut());
    ...
    static
#[no_mangle]
pub unsafe extern "C" fn dmc620_event_to_counter_control(event: *mut perf_event) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn dmc620_get_event_idx(event: *mut perf_event) -> c_int {
...
// The counters are all in use.
    ...
    static inline
#[no_mangle]
pub unsafe extern "C" fn dmc620_pmu_read_counter(event: *mut perf_event) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_event_set_period(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_enable_counter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_disable_counter(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_handle_irq(irq_num: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_get_irq(dmc620_pmu: *mut dmc620_pmu, irq_num: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_put_irq(dmc620_pmu: *mut dmc620_pmu) {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_read(event: *mut perf_event) {
    static void dmc620_pmu_read(struct perf_event *event)
    {
    dmc620_pmu_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_del(event: *mut perf_event, flags: c_int) {
    ...
    dmc620_pmu.events[idx] = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_device_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_device_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn dmc620_pmu_exit() -> void __exit {
