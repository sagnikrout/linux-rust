...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pmu_irq_ops {
    pub irq): *mut *mut void (enable_pmuirq)(unsigned int,
    pub irq): *mut *mut void (disable_pmuirq)(unsigned int,
    pub devid): *mut *mut void (free_pmuirq)(unsigned int irq, int cpu, void __percpu,
}

#[no_mangle]
unsafe extern "C" fn armpmu_free_pmuirq(irq: c_uint, cpu: c_int, devid: *mut void __percpu) {
...
#[no_mangle]
unsafe extern "C" fn armpmu_free_pmunmi(irq: c_uint, cpu: c_int, devid: *mut void __percpu) {
...
#[no_mangle]
unsafe extern "C" fn armpmu_enable_percpu_pmuirq(irq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn armpmu_enable_percpu_pmunmi(irq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn armpmu_disable_percpu_pmunmi(irq: c_uint) {
    ...
    static bool has_nmi;
#[no_mangle]
pub unsafe extern "C" fn arm_pmu_event_max_period(event: *mut perf_event) -> u64 {
    static inline u64 arm_pmu_event_max_period(struct perf_event *event)
    {
    if (event.hw.flags & ARMPMU_EVT_64BIT)
    return GENMASK_ULL(63, 0);
#[no_mangle]
pub unsafe extern "C" fn if(ARMPMU_EVT_63BIT: event->hw.flags &) -> else {
    else if (event.hw.flags & ARMPMU_EVT_63BIT)
    return GENMASK_ULL(62, 0);
#[no_mangle]
pub unsafe extern "C" fn if(ARMPMU_EVT_47BIT: event->hw.flags &) -> else {
    ...
    let mut mapping: return = = HW_OP_UNSUPPORTED ? -ENOENT : mapping;
    }
    static int
...
#[no_mangle]
pub unsafe extern "C" fn unsigned(_arg: *mut cache_map) -> const {
...
#[no_mangle]
pub unsafe extern "C" fn armpmu_event_set_period(event: *mut perf_event) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn armpmu_event_update(event: *mut perf_event) -> u64 {
    u64 armpmu_event_update(struct perf_event *event)
    {
    struct arm_pmu *armpmu = to_arm_pmu(event.pmu);
    struct hw_perf_event *hwc = &event.hw;
    u64 delta, prev_raw_count, new_raw_count;
    let mut max_period: u64 = arm_pmu_event_max_period(event);
    again:
...
#[no_mangle]
unsafe extern "C" fn armpmu_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn armpmu_dispatch_irq(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn armpmu_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn armpmu_enable(pmu: *mut pmu) {
    static void armpmu_enable(struct pmu *pmu)
    {
    struct arm_pmu *armpmu = to_arm_pmu(pmu);
    struct pmu_hw_events *hw_events = this_cpu_ptr(armpmu.hw_events);
    let mut enabled: bool = !bitmap_empty(hw_events.used_mask, ARMPMU_MAX_HWEVENTS);
...
#[no_mangle]
unsafe extern "C" fn armpmu_disable(pmu: *mut pmu) {
...
//
#[no_mangle]
unsafe extern "C" fn armpmu_filter(pmu: *mut pmu, cpu: c_int) -> bool {
...
#[no_mangle]
unsafe extern "C" fn armpmu_count_irq_users(affinity: *const cpumask, irq: c_int) -> c_int {
    ...
    {
    const struct pmu_irq_ops *ops = core::ptr::null_mut();
    int cpu;
    for_each_cpu(cpu, affinity) {
    if (per_cpu(cpu_irq, cpu) != irq)
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn armpmu_free_irq(armpmu: *mut *mut arm_pmu  __percpu, irq: c_int, cpu: c_int) {
    ...
    per_cpu(cpu_irq_ops, cpu) = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn armpmu_request_irq(pcpu_armpmu: *mut *mut arm_pmu  __percpu, irq: c_int, cpu: c_int) -> c_int {
    ...
    let mut handler: irq_handler_t = armpmu_dispatch_irq;
...
#[no_mangle]
unsafe extern "C" fn armpmu_get_cpu_irq(pmu: *mut arm_pmu, cpu: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn arm_pmu_irq_is_nmi() -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn arm_perf_starting_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_perf_teardown_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_pm_pmu_setup(armpmu: *mut arm_pmu, cmd: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn cpu_pm_pmu_register(cpu_pmu: *mut arm_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_pm_pmu_unregister(cpu_pmu: *mut arm_pmu) {
...
#[no_mangle]
unsafe extern "C" fn cpu_pmu_init(cpu_pmu: *mut arm_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpu_pmu_destroy(cpu_pmu: *mut arm_pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn armpmu_free(pmu: *mut arm_pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn armpmu_register(pmu: *mut arm_pmu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arm_pmu_hp_init() -> c_int {
