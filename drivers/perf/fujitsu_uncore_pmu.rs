...
//! Source: drivers/perf/fujitsu_uncore_pmu.c
#![no_std]
...
pub const MAC_NUM_COUNTERS: c_int = 8;
pub const PCI_NUM_COUNTERS: c_int = 8;
// Mask for the event type field within perf_event_attr.config and EVTYPE reg
pub const UNCORE_EVTYPE_MASK: c_uint = 0xFF;
// Perfmon registers

pub const PM_CNTCTL_RESET: c_int = 0;

pub const PM_CR: c_uint = 0x400;

pub const PM_CNTENSET: c_uint = 0x410;

pub const PM_CNTENCLR: c_uint = 0x418;

pub const PM_CNTENCLR_RESET: c_uint = 0xFF;
pub const PM_INTENSET: c_uint = 0x420;

pub const PM_INTENCLR: c_uint = 0x428;

pub const PM_INTENCLR_RESET: c_uint = 0xFF;
pub const PM_OVSR: c_uint = 0x440;
pub const PM_OVSR_OVSRCLR_RESET: c_uint = 0xFF;
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_counter_start(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_counter_stop(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_counter_update(event: *mut perf_event) {
...
#[no_mangle]
pub unsafe extern "C" fn fujitsu_uncore_init(uncorepmu: *mut uncore_pmu) {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_handle_irq(irq_num: c_int, data: *mut c_void) -> irqreturn_t {
    static irqreturn_t fujitsu_uncore_handle_irq(int irq_num, void *data)
    {
    struct uncore_pmu *uncorepmu = data;
// Read the overflow status register
    let mut status: c_long = readq_relaxed(uncorepmu.regs + PM_OVSR);
    int idx;
    if (status == 0)
    return IRQ_NONE;
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_event_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_event_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_event_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_event_del(event: *mut perf_event, flags: c_int) {
...
// Stop and clean up
    ...
    uncorepmu.events[hwc.idx] = core::ptr::null_mut();
    bitmap_release_region(uncorepmu.used_mask, hwc.idx, 0);
// Propagate changes to the userspace mapping.
    perf_event_update_userpage(event);
    }
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_event_read(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_pmu_migrate(uncorepmu: *mut uncore_pmu, cpu: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_pmu_online_cpu(cpu: c_uint, cpuhp_node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_pmu_offline_cpu(cpu: c_uint, cpuhp_node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_pmu_probe(pdev: *mut platform_device) -> c_int {
    static int fujitsu_uncore_pmu_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    let mut device_type: c_ulong = (unsigned long)device_get_match_data(dev);
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_pmu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_pmu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fujitsu_uncore_pmu_exit() -> void __exit {
