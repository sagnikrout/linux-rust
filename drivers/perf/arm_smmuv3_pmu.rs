...
//! Source: drivers/perf/arm_smmuv3_pmu.c
#![no_std]
...
pub const SMMU_PMCG_EVCNTR0: c_uint = 0x0;

pub const SMMU_PMCG_EVTYPER0: c_uint = 0x400;

pub const SMMU_PMCG_SID_SPAN_SHIFT: c_int = 29;
pub const SMMU_PMCG_SMR0: c_uint = 0xA00;

pub const SMMU_PMCG_CNTENSET0: c_uint = 0xC00;
pub const SMMU_PMCG_CNTENCLR0: c_uint = 0xC20;
pub const SMMU_PMCG_INTENSET0: c_uint = 0xC40;
pub const SMMU_PMCG_INTENCLR0: c_uint = 0xC60;
pub const SMMU_PMCG_OVSCLR0: c_uint = 0xC80;
pub const SMMU_PMCG_OVSSET0: c_uint = 0xCC0;
pub const SMMU_PMCG_CFGR: c_uint = 0xE00;

pub const SMMU_PMCG_CR: c_uint = 0xE04;

pub const SMMU_PMCG_IIDR: c_uint = 0xE08;

pub const SMMU_PMCG_CEID0: c_uint = 0xE20;
pub const SMMU_PMCG_CEID1: c_uint = 0xE28;
pub const SMMU_PMCG_IRQ_CTRL: c_uint = 0xE50;

pub const SMMU_PMCG_IRQ_CFG0: c_uint = 0xE58;
pub const SMMU_PMCG_IRQ_CFG1: c_uint = 0xE60;
pub const SMMU_PMCG_IRQ_CFG2: c_uint = 0xE64;
// IMP-DEF ID registers
pub const SMMU_PMCG_PIDR0: c_uint = 0xFE0;

pub const SMMU_PMCG_PIDR1: c_uint = 0xFE4;

pub const SMMU_PMCG_PIDR2: c_uint = 0xFE8;

pub const SMMU_PMCG_PIDR3: c_uint = 0xFEC;

pub const SMMU_PMCG_PIDR4: c_uint = 0xFD0;

// MSI config fields

pub const MSI_CFG2_MEMATTR_DEVICE_nGnRE: c_uint = 0x1;
pub const SMMU_PMCG_DEFAULT_FILTER_SPAN: c_int = 1;

pub const SMMU_PMCG_MAX_COUNTERS: c_int = 64;
pub const SMMU_PMCG_ARCH_MAX_EVENTS: c_int = 128;
pub const SMMU_PMCG_PA_SHIFT: c_int = 12;
...
pub struct smmu_pmu {
    pub node: hlist_node,
    pub events: [*mut perf_event; SMMU_PMCG_MAX_COUNTERS],
    pub SMMU_PMCG_MAX_COUNTERS): DECLARE_BITMAP(used_counters,,
    pub SMMU_PMCG_ARCH_MAX_EVENTS): DECLARE_BITMAP(supported_events,,
    pub irq: c_uint,
    pub on_cpu: c_uint,
    pub pmu: pmu,
    ...
    pub reloc_base: *mut void __iomem,
...
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_enable(pmu: *mut pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_enable_quirk_hip08_09(pmu: *mut pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_disable(pmu: *mut pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_disable_quirk_hip08_09(pmu: *mut pmu) {
...
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_counter_get_value(smmu_pmu: *mut smmu_pmu, idx: u32) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_counter_enable(smmu_pmu: *mut smmu_pmu, idx: u32) {
    static inline void smmu_pmu_counter_enable(struct smmu_pmu *smmu_pmu, u32 idx)
    {
    writeq(BIT(idx), smmu_pmu.reg_base + SMMU_PMCG_CNTENSET0);
    }
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_counter_disable(smmu_pmu: *mut smmu_pmu, idx: u32) {
    static inline void smmu_pmu_counter_disable(struct smmu_pmu *smmu_pmu, u32 idx)
    {
    writeq(BIT(idx), smmu_pmu.reg_base + SMMU_PMCG_CNTENCLR0);
    }
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_interrupt_enable(smmu_pmu: *mut smmu_pmu, idx: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn smmu_pmu_set_smr(smmu_pmu: *mut smmu_pmu, idx: u32, val: u32) {
    static inline void smmu_pmu_set_smr(struct smmu_pmu *smmu_pmu, u32 idx, u32 val)
    {
    writel(val, smmu_pmu.reg_base + SMMU_PMCG_SMR(idx));
    }
#[no_mangle]
unsafe extern "C" fn smmu_pmu_event_update(event: *mut perf_event) {
...
//
    ...
    let mut filter_en: bool = !!get_filter_enable(event);
...
// Otherwise, must match whatever's currently scheduled
    ...
    {
    int idx, err;
    let mut num_ctrs: c_uint = smmu_pmu.num_counters;
...
//
#[no_mangle]
unsafe extern "C" fn smmu_pmu_event_init(event: *mut perf_event) -> c_int {
    ...
    let mut group_num_events: c_int = 1;
    u16 event_id;
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_event_start(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_event_stop(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_event_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_event_del(event: *mut perf_event, flags: c_int) {
    ...
    smmu_pmu.events[idx] = core::ptr::null_mut();
    clear_bit(idx, smmu_pmu.used_counters);
    perf_event_update_userpage(event);
    }
#[no_mangle]
unsafe extern "C" fn smmu_pmu_event_read(event: *mut perf_event) {
...
// cpumask
    ...
    __ATTR(cpumask, 0444, smmu_pmu_cpumask_show, core::ptr::null_mut());
...
// Events
    ...
    __ATTR(identifier, 0444, smmu_pmu_identifier_attr_show, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn smmu_pmu_offline_cpu(cpu: c_uint, node: *mut hlist_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_handle_irq(irq_num: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_free_msis(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_write_msi_msg(desc: *mut msi_desc, msg: *mut msi_msg) {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_setup_msi(pmu: *mut smmu_pmu) {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_setup_irq(pmu: *mut smmu_pmu) -> c_int {
    static int smmu_pmu_setup_irq(struct smmu_pmu *pmu)
    {
    let mut flags: c_ulong = IRQF_NOBALANCING | IRQF_SHARED | IRQF_NO_THREAD;
    int irq, ret = -ENXIO;
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_reset(smmu_pmu: *mut smmu_pmu) {
    static void smmu_pmu_reset(struct smmu_pmu *smmu_pmu)
    {
    let mut counter_present_mask: u64 = GENMASK_ULL(smmu_pmu.num_counters - 1, 0);
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_get_acpi_options(smmu_pmu: *mut smmu_pmu) {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_coresight_id_regs(smmu_pmu: *mut smmu_pmu) -> bool {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_get_iidr(smmu_pmu: *mut smmu_pmu) {
    static void smmu_pmu_get_iidr(struct smmu_pmu *smmu_pmu)
    {
    let mut iidr: u32 = readl_relaxed(smmu_pmu.reg_base + SMMU_PMCG_IIDR);
    if (!iidr && smmu_pmu_coresight_id_regs(smmu_pmu)) {
    let mut pidr0: u32 = readl(smmu_pmu.reg_base + SMMU_PMCG_PIDR0);
    let mut pidr1: u32 = readl(smmu_pmu.reg_base + SMMU_PMCG_PIDR1);
    let mut pidr2: u32 = readl(smmu_pmu.reg_base + SMMU_PMCG_PIDR2);
    let mut pidr3: u32 = readl(smmu_pmu.reg_base + SMMU_PMCG_PIDR3);
    let mut pidr4: u32 = readl(smmu_pmu.reg_base + SMMU_PMCG_PIDR4);
    u32 productid = FIELD_GET(SMMU_PMCG_PIDR0_PART_0, pidr0) |
    (FIELD_GET(SMMU_PMCG_PIDR1_PART_1, pidr1) << 8);
    let mut variant: u32 = FIELD_GET(SMMU_PMCG_PIDR2_REVISION, pidr2);
    let mut revision: u32 = FIELD_GET(SMMU_PMCG_PIDR3_REVAND, pidr3);
    u32 implementer =
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn smmu_pmu_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_pmu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn arm_smmu_pmu_exit() -> void __exit {
