...
//! Source: drivers/infiniband/core/counters.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rdma_counter_free(counter: *mut rdma_counter) {
...
#[no_mangle]
unsafe extern "C" fn __rdma_counter_unbind_qp(qp: *mut ib_qp, port: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn counter_history_stat_update(counter: *mut rdma_counter) {
...
//
    ...
    {
    struct rdma_port_counter *port_counter;
    struct rdma_counter *counter = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn counter_release(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_counter_bind_qp_auto(qp: *mut ib_qp, port: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_counter_unbind_qp(qp: *mut ib_qp, port: u32, force: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_counter_query_stats(counter: *mut rdma_counter) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_counter_get_hwstat_value(dev: *mut ib_device, port: u32, index: u32) -> u64 {
    ...
    {
    struct rdma_restrack_entry *res = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn rdma_counter_init(dev: *mut ib_device) {
    ...
    port_counter.hstats = core::ptr::null_mut();
    mutex_destroy(&port_counter.lock);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn rdma_counter_release(dev: *mut ib_device) {
