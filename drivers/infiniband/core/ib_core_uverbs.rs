...
//! Source: drivers/infiniband/core/ib_core_uverbs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rdma_user_mmap_entry_free(kref: *mut kref) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_user_mmap_entry_put(entry: *mut rdma_user_mmap_entry) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_user_mmap_entry_remove(entry: *mut rdma_user_mmap_entry) {
    ...
    dma_resv_lock(uverbs_dmabuf.dmabuf.resv, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn uverbs_get_handler_fn(udata: *mut ib_udata) -> uverbs_api_ioctl_handler_fn {
...
#[no_mangle]
pub unsafe extern "C" fn _ib_respond_udata(udata: *mut ib_udata, src: *const c_void, len: usize) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn uverbs_destroy_def_handler(attrs: *mut uverbs_attr_bundle) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(4: attr->ptr_attr.len ==) -> else {
