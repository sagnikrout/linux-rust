...
//! Source: drivers/infiniband/core/uverbs_std_types_qp.c
#![no_std]
...
//
    ...
    let mut cap: ib_uverbs_qp_cap = {};
    struct ib_rwq_ind_table *rwq_ind_tbl = core::ptr::null_mut();
    struct ib_qp *qp;
    struct ib_pd *pd = core::ptr::null_mut();
    struct ib_srq *srq = core::ptr::null_mut();
    struct ib_cq *recv_cq = core::ptr::null_mut();
    struct ib_cq *send_cq = core::ptr::null_mut();
    struct ib_xrcd *xrcd = core::ptr::null_mut();
    struct ib_uobject *xrcd_uobj = core::ptr::null_mut();
...
//
    ...
    let mut attr: ib_qp_attach_comp_cntr_attr = {};
