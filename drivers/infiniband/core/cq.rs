...
//! Source: drivers/infiniband/core/cq.c
#![no_std]
...
pub const IB_POLL_BATCH: c_int = 16;
pub const IB_POLL_BATCH_DIRECT: c_int = 8;
// # of WCs to iterate over before yielding
pub const IB_POLL_BUDGET_IRQ: c_int = 256;
pub const IB_POLL_BUDGET_WORKQUEUE: c_int = 65536;
...
#[no_mangle]
unsafe extern "C" fn ib_cq_rdma_dim_work(w: *mut work_struct) {
    static void ib_cq_rdma_dim_work(struct work_struct *w)
    {
    struct dim *dim = container_of(w, struct dim, work);
    struct ib_cq *cq = dim.priv;
    let mut usec: u16 = rdma_dim_prof[dim.profile_ix].usec;
    let mut comps: u16 = rdma_dim_prof[dim.profile_ix].comps;
    dim.state = DIM_START_MEASURE;
    trace_cq_modify(cq, comps, usec);
    cq.device.ops.modify_cq(cq, comps, usec);
    }
#[no_mangle]
unsafe extern "C" fn rdma_dim_init(cq: *mut ib_cq) {
...
#[no_mangle]
unsafe extern "C" fn rdma_dim_destroy(cq: *mut ib_cq) {
...
#[no_mangle]
unsafe extern "C" fn __poll_cq(cq: *mut ib_cq, num_entries: c_int, wc: *mut ib_wc) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ib_process_cq_direct(cq: *mut ib_cq, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ib_cq_completion_direct(cq: *mut ib_cq, private: *mut c_void) {
    static void ib_cq_completion_direct(struct ib_cq *cq, void *private)
    {
    WARN_ONCE(1, "got unsolicited completion for CQ 0x%p\n", cq);
    }
#[no_mangle]
unsafe extern "C" fn ib_poll_handler(iop: *mut irq_poll, budget: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ib_cq_completion_softirq(cq: *mut ib_cq, private: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ib_cq_poll_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: cq->dim) -> else {
    else if (cq.dim)
    rdma_dim(cq.dim, completed);
    }
#[no_mangle]
unsafe extern "C" fn ib_cq_completion_workqueue(cq: *mut ib_cq, private: *mut c_void) {
...
//
    ...
    ret = dev.ops.create_cq(cq, &cq_attr, core::ptr::null_mut());
    if (ret)
    goto out_free_wc;
    rdma_dim_init(cq);
    switch (cq.poll_ctx) {
    ...
    out_destroy_cq:
    rdma_dim_destroy(cq);
    cq.device.ops.destroy_cq(cq, core::ptr::null_mut());
    out_free_wc:
...
//
#[no_mangle]
pub unsafe extern "C" fn ib_free_cq(cq: *mut ib_cq) {
    ...
    ret = cq.device.ops.destroy_cq(cq, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn ib_cq_pool_cleanup(dev: *mut ib_device) {
...
//
    ...
    for (i = 0; i < nr_cqs; i++) {
    cq = ib_alloc_cq(dev, core::ptr::null_mut(), nr_cqes, i, poll_ctx);
    if (IS_ERR(cq)) {
    ret = PTR_ERR(cq);
    goto out_free_cqs;
    }
...
//
    ...
    struct ib_cq *cq, *found = core::ptr::null_mut();
    int ret;
    if (poll_ctx > IB_POLL_LAST_POOL_TYPE) {
    WARN_ON_ONCE(poll_ctx > IB_POLL_LAST_POOL_TYPE);
    return ERR_PTR(-EINVAL);
...
//
#[no_mangle]
pub unsafe extern "C" fn ib_cq_pool_put(cq: *mut ib_cq, nr_cqe: c_uint) {
