...
//! Source: drivers/infiniband/core/cma.c
#![no_std]
...
pub const CMA_CM_RESPONSE_TIMEOUT: c_int = 20;
pub const CMA_MAX_CM_RETRIES: c_int = 15;
pub const CMA_IBOE_PACKET_LIFETIME: c_int = 16;
...
#[no_mangle]
pub unsafe extern "C" fn rdma_event_msg(event: enum rdma_cm_event_type) -> *const char __attribute_const__ {
    const char *__attribute_const__ rdma_event_msg(enum rdma_cm_event_type event)
    {
    let mut index: usize = event;
...
//
#[no_mangle]
unsafe extern "C" fn rdma_is_consumer_reject(id: *mut rdma_cm_id, reason: c_int) -> bool {
    static bool rdma_is_consumer_reject(struct rdma_cm_id *id, int reason)
    {
    if (rdma_ib_or_roce(id.device, id.port_num))
    let mut reason: return = = IB_CM_REJ_CONSUMER_DEFINED;
    if (rdma_protocol_iwarp(id.device, id.port_num))
    let mut reason: return = = -ECONNREFUSED;
    WARN_ON_ONCE(1);
    return false;
    }
...
//
    ...
    let mut id_table: static struct rb_root = RB_ROOT;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct id_table_entry {
    pub id_list: list_head,
    pub rb_node: rb_node,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cma_device {
    pub list: list_head,
    pub device: *mut ib_device,
    pub comp: completion,
    pub refcount: refcount_t,
    pub id_list: list_head,
    pub default_gid_type: *mut enum ib_gid_type,
    pub default_roce_tos: *mut u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct rdma_bind_list {
    pub ps: enum rdma_ucm_port_space,
...
#[no_mangle]
pub unsafe extern "C" fn cma_dev_get(cma_dev: *mut cma_device) {
    void cma_dev_get(struct cma_device *cma_dev)
    {
    refcount_inc(&cma_dev.refcount);
    }
#[no_mangle]
pub unsafe extern "C" fn cma_dev_put(cma_dev: *mut cma_device) {
    ...
    struct cma_device *found_cma_dev = core::ptr::null_mut();
    mutex_lock(&lock);
...
#[no_mangle]
pub unsafe extern "C" fn cma_get_default_roce_tos(cma_dev: *mut cma_device, port: u32) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cma_multicast {
    pub id_priv: *mut rdma_id_private,
    union {
    pub sa_mc: *mut ib_sa_multicast,
    struct {
    pub work: work_struct,
    pub event: rdma_cm_event,
    pub iboe_join: },
}
...
pub struct cma_work {
    pub work: work_struct,
    pub id: *mut rdma_id_private,
    pub old_state: enum rdma_cm_state,
    pub new_state: enum rdma_cm_state,
    pub event: rdma_cm_event,
}
...
pub struct cma_hdr {
    pub cma_version: u8,
    pub /: *mut *mut u8 ip_version; / IP version: 7:4,
    pub port: __be16,
    pub src_addr: union cma_ip_addr,
    pub dst_addr: union cma_ip_addr,
}

pub const CMA_VERSION: c_uint = 0x00;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cma_req_info {
    pub listen_addr_storage: sockaddr_storage,
    pub src_addr_storage: sockaddr_storage,
    pub device: *mut ib_device,
    pub local_gid: union ib_gid,
...
#[no_mangle]
pub unsafe extern "C" fn cma_get_ip_ver(hdr: *const cma_hdr) -> u8 {
    static inline u8 cma_get_ip_ver(const struct cma_hdr *hdr)
    {
    return hdr.ip_version >> 4;
    }
#[no_mangle]
unsafe extern "C" fn cma_set_ip_ver(hdr: *mut cma_hdr, ip_ver: u8) {
...
#[no_mangle]
unsafe extern "C" fn cma_igmp_send(ndev: *mut net_device, mgid: *mut union ib_gid, join: bool) -> c_int {
...
// (__be32 *)(mgid->raw + 12));
    ...
    let mut ifindex_b: c_int = id_priv.id.route.addr.dev_addr.bound_dev_if;
...
#[no_mangle]
unsafe extern "C" fn cma_add_id_to_tree(node_id_priv: *mut rdma_id_private) -> c_int {
    static int cma_add_id_to_tree(struct rdma_id_private *node_id_priv)
    {
    struct rb_node **new, *parent = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cma_remove_id_from_tree(id_priv: *mut rdma_id_private) {
...
#[no_mangle]
unsafe extern "C" fn cma_release_dev(id_priv: *mut rdma_id_private) {
    static void cma_release_dev(struct rdma_id_private *id_priv)
    {
    mutex_lock(&lock);
    list_del_init(&id_priv.device_item);
    cma_dev_put(id_priv.cma_dev);
    id_priv.cma_dev = core::ptr::null_mut();
    id_priv.id.device = core::ptr::null_mut();
    if (id_priv.id.route.addr.dev_addr.sgid_attr) {
    rdma_put_gid_attr(id_priv.id.route.addr.dev_addr.sgid_attr);
    id_priv.id.route.addr.dev_addr.sgid_attr = core::ptr::null_mut();
    }
    mutex_unlock(&lock);
    }
#[no_mangle]
pub unsafe extern "C" fn cma_family(id_priv: *mut rdma_id_private) -> c_ushort {
    static inline unsigned short cma_family(struct rdma_id_private *id_priv)
    {
    return id_priv.id.route.addr.src_addr.ss_family;
    }
#[no_mangle]
unsafe extern "C" fn cma_set_default_qkey(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_set_qkey(id_priv: *mut rdma_id_private, qkey: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_translate_ib(sib: *mut sockaddr_ib, dev_addr: *mut rdma_dev_addr) {
...
#[no_mangle]
unsafe extern "C" fn cma_translate_addr(addr: *mut sockaddr, dev_addr: *mut rdma_dev_addr) -> c_int {
    ...
    let mut bound_if_index: c_int = dev_addr.bound_dev_if;
    let mut dev_type: c_int = dev_addr.dev_type;
    struct net_device *ndev = core::ptr::null_mut();
    struct net_device *pdev = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn cma_acquire_dev_by_src_ip(id_priv: *mut rdma_id_private) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cma_resolve_ib_dev(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_id_get(id_priv: *mut rdma_id_private) {
    static void cma_id_get(struct rdma_id_private *id_priv)
    {
    refcount_inc(&id_priv.refcount);
    }
#[no_mangle]
unsafe extern "C" fn cma_id_put(id_priv: *mut rdma_id_private) {
    ...
    ret = __rdma_create_id(net, event_handler, context, ps, qp_type, core::ptr::null_mut());
    if (IS_ERR(ret))
    return ERR_CAST(ret);
    ...
    ps, qp_type, core::ptr::null_mut());
    if (IS_ERR(ret))
    return ERR_CAST(ret);
    rdma_restrack_set_name(&ret.res, core::ptr::null_mut());
    return &ret.id;
    }
    EXPORT_SYMBOL(rdma_create_user_id);
#[no_mangle]
unsafe extern "C" fn cma_init_ud_qp(id_priv: *mut rdma_id_private, qp: *mut ib_qp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_init_conn_qp(id_priv: *mut rdma_id_private, qp: *mut ib_qp) -> c_int {
    ...
    id_priv.srq = (qp.srq != core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn rdma_destroy_qp(id: *mut rdma_cm_id) {
    ...
    id_priv.id.qp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cma_modify_qp_err(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cma_zero_addr(addr: *const sockaddr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cma_loopback_addr(addr: *const sockaddr) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cma_any_addr(addr: *const sockaddr) -> bool {
    static inline bool cma_any_addr(const struct sockaddr *addr)
    {
    return cma_zero_addr(addr) || cma_loopback_addr(addr);
    }
#[no_mangle]
unsafe extern "C" fn cma_addr_cmp(src: *const sockaddr, dst: *const sockaddr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_port(addr: *const sockaddr) -> __be16 {
...
#[no_mangle]
pub unsafe extern "C" fn cma_any_port(addr: *const sockaddr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_port_from_service_id(service_id: __be64) -> u16 {
...
#[no_mangle]
pub unsafe extern "C" fn if(IB_CM_SIDR_REQ_RECEIVED: ib_event->event ==) -> else {
    else if (ib_event.event == IB_CM_SIDR_REQ_RECEIVED)
    cma_save_ib_info(src_addr, dst_addr, listen_id, core::ptr::null_mut());
    return 0;
    }
    ...
    {
    const struct ib_gid_attr *sgid_attr = core::ptr::null_mut();
...
pub unsafe extern "C" fn if(IB_CM_SIDR_REQ_RECEIVED: ib_event->event ==) -> else {
    ...
    const union ib_gid *gid = req.has_gid ? &req.local_gid : core::ptr::null_mut();
    int err;
...
#[no_mangle]
unsafe extern "C" fn rdma_ps_from_service_id(service_id: __be64) -> enum rdma_ucm_port_space {
...
#[no_mangle]
unsafe extern "C" fn cma_protocol_roce(id: *const rdma_cm_id) -> bool {
    static bool cma_protocol_roce(const struct rdma_cm_id *id)
    {
    struct ib_device *device = id.device;
    let mut port_num: u32 = id.port_num ?: rdma_start_port(device);
    return rdma_protocol_roce(device, port_num);
    }
#[no_mangle]
unsafe extern "C" fn cma_is_req_ipv6_ll(req: *const cma_req_info) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn cma_user_data_offset(id_priv: *mut rdma_id_private) -> u8 {
    static inline u8 cma_user_data_offset(struct rdma_id_private *id_priv)
    {
    return cma_family(id_priv) == AF_IB ? 0 : sizeof(struct cma_hdr);
    }
#[no_mangle]
unsafe extern "C" fn cma_cancel_route(id_priv: *mut rdma_id_private) {
...
#[no_mangle]
unsafe extern "C" fn _cma_cancel_listens(id_priv: *mut rdma_id_private) {
...
#[no_mangle]
unsafe extern "C" fn cma_cancel_listens(id_priv: *mut rdma_id_private) {
...
#[no_mangle]
unsafe extern "C" fn cma_release_port(id_priv: *mut rdma_id_private) {
    ...
    {
    let mut send_only: bool = mc.join_state == BIT(SENDONLY_FULLMEMBER_JOIN);
...
#[no_mangle]
unsafe extern "C" fn cma_leave_mc_groups(id_priv: *mut rdma_id_private) {
...
//
#[no_mangle]
unsafe extern "C" fn destroy_id_handler_unlock(id_priv: *mut rdma_id_private) {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_destroy_id(id: *mut rdma_cm_id) {
...
#[no_mangle]
unsafe extern "C" fn cma_rep_recv(id_priv: *mut rdma_id_private) -> c_int {
    static int cma_rep_recv(struct rdma_id_private *id_priv)
    {
    int ret;
    ret = cma_modify_qp_rtr(id_priv, core::ptr::null_mut());
    if (ret)
    goto reject;
    ret = cma_modify_qp_rts(id_priv, core::ptr::null_mut());
    if (ret)
    goto reject;
    trace_cm_send_rtu(id_priv);
    ret = ib_send_cm_rtu(id_priv.cm_id.ib, core::ptr::null_mut(), 0);
    if (ret)
    goto reject;
    return 0;
    reject:
...
// Destroy the CM ID by returning a non-zero value.
    id_priv.cm_id.ib = core::ptr::null_mut();
    destroy_id_handler_unlock(id_priv);
    return ret;
    }
    out:
    ...
    let mut ss_family: sa_family_t = listen_id.route.addr.src_addr.ss_family;
    ...
    const struct ib_cm_event *ib_event)
    {
    struct rdma_id_private *listen_id, *conn_id = core::ptr::null_mut();
    let mut event: rdma_cm_event = {};
    let mut req: cma_req_info = {};
    struct net_device *net_dev;
    u8 offset;
    int ret;
    ...
    if (ret) {
// Destroy the CM ID by returning a non-zero value.
    conn_id.cm_id.ib = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn rdma_get_service_id(id: *mut rdma_cm_id, addr: *mut sockaddr) -> __be64 {
...
#[no_mangle]
unsafe extern "C" fn cma_iw_handler(iw_id: *mut iw_cm_id, iw_event: *mut iw_cm_event) -> c_int {
    ...
    if (ret) {
// Destroy the CM ID by returning a non-zero value.
    id_priv.cm_id.iw = core::ptr::null_mut();
    destroy_id_handler_unlock(id_priv);
    return ret;
    }
    out:
    ...
    let mut event: rdma_cm_event = {};
    let mut ret: c_int = -ECONNABORTED;
    struct sockaddr *laddr = (struct sockaddr *)&iw_event.local_addr;
    struct sockaddr *raddr = (struct sockaddr *)&iw_event.remote_addr;
    event.event = RDMA_CM_EVENT_CONNECT_REQUEST;
    event.param.conn.private_data = iw_event.private_data;
...
// User wants to destroy the CM ID
    conn_id.cm_id.iw = core::ptr::null_mut();
    mutex_unlock(&listen_id.handler_mutex);
    destroy_id_handler_unlock(conn_id);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn cma_ib_listen(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_iw_listen(id_priv: *mut rdma_id_private, backlog: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_listen_on_all(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_set_service_type(id: *mut rdma_cm_id, tos: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_set_ack_timeout(id: *mut rdma_cm_id, timeout: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_set_min_rnr_timer(id: *mut rdma_cm_id, min_rnr_timer: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(IB_PATH_INBOUND: path_rec[i].flags &) -> else {
    else if (path_rec[i].flags & IB_PATH_INBOUND)
    status = route_set_path_rec_inbound(work, &path_rec[i]);
#[no_mangle]
pub unsafe extern "C" fn if(IB_PATH_OUTBOUND: path_rec[i].flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn cma_iboe_join_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cma_work_handler(_work: *mut work_struct) {
...
// Balances with cma_id_put() in cma_work_handler
    ...
    route.path_rec = core::ptr::null_mut();
    err1:
    kfree(work);
    return ret;
    }
...
//
    ...
    {
    struct rdma_route *route = &id_priv.id.route;
    let mut gid_type: enum ib_gid_type = IB_GID_TYPE_ROCE;
...
// Use the hint from IP Stack to select GID Type
    ...
    id.route.path_rec = core::ptr::null_mut();
    err:
...
#[no_mangle]
unsafe extern "C" fn cma_resolve_iw_route(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_vlan_ndev_tc(vlan_ndev: *mut net_device, prio: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct iboe_prio_tc_map {
    pub input_prio: c_int,
    pub output_tc: c_int,
    pub found: bool,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev->num_tc) -> else {
    else if (dev.num_tc)
...
#[no_mangle]
unsafe extern "C" fn iboe_tos_to_sl(ndev: *mut net_device, tos: c_int) -> c_int {
    static int iboe_tos_to_sl(struct net_device *ndev, int tos)
    {
    let mut prio_tc_map: iboe_prio_tc_map = {};
    let mut prio: c_int = rt_tos2priority(tos);
    struct netdev_nested_priv priv;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ndev->num_tc) -> else {
    else if (ndev.num_tc)
...
#[no_mangle]
unsafe extern "C" fn cma_get_roce_udp_flow_label(id_priv: *mut rdma_id_private) -> __be32 {
...
#[no_mangle]
unsafe extern "C" fn cma_resolve_iboe_route(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_resolve_route(id: *mut rdma_cm_id, timeout_ms: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdma_protocol_roce(id->device, _arg: id->port_num)) -> else {
    ret = cma_resolve_iboe_route(id_priv);
    if (!ret)
    cma_add_id_to_tree(id_priv);
    }
#[no_mangle]
pub unsafe extern "C" fn if(_arg: rdma_protocol_iwarp(id->device, _arg: id->port_num)) -> else {
...
#[no_mangle]
unsafe extern "C" fn cma_set_loopback(addr: *mut sockaddr) {
...
#[no_mangle]
unsafe extern "C" fn cma_bind_loopback(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_resolve_loopback(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_resolve_ib_addr(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_set_reuseaddr(id: *mut rdma_cm_id, reuse: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_set_afonly(id: *mut rdma_cm_id, afonly: c_int) -> c_int {
    ...
    err:
    kfree(bind_list);
    let mut ret: return = = -ENOSPC ? -EADDRNOTAVAIL : ret;
    }
    ...
    let mut dport: __be16 = cma_port(daddr);
    lockdep_assert_held(&lock);
    hlist_for_each_entry(cur_id, &bind_list.owners, node) {
    struct sockaddr  *cur_daddr = cma_dst_addr(cur_id);
    struct sockaddr  *cur_saddr = cma_src_addr(cur_id);
    let mut cur_dport: __be16 = cma_port(cur_daddr);
    if (id_priv == cur_id)
    continue;
...
//
    ...
    {
    let mut ps: enum rdma_ucm_port_space = 0;
    struct sockaddr_ib *sib;
    u64 sid_ps, mask, sid;
    sib = (struct sockaddr_ib *) cma_src_addr(id_priv);
...
#[no_mangle]
unsafe extern "C" fn cma_get_port(id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_listen(id: *mut rdma_cm_id, backlog: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(AF_INET6: addr->sa_family ==) -> else {
    struct net *net = id_priv.id.route.addr.dev_addr.net;
    ...
    struct rdma_id_private *id_priv =
    container_of(id, struct rdma_id_private, id);
    let mut zero_sock: sockaddr_storage = {};
...
#[no_mangle]
pub unsafe extern "C" fn rdma_restrict_node_type(id: *mut rdma_cm_id, node_type: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_bind_addr(id: *mut rdma_cm_id, addr: *mut sockaddr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_format_hdr(hdr: *mut c_void, id_priv: *mut rdma_id_private) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_connect(id: *mut rdma_cm_id, conn_param: *mut rdma_conn_param) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rdma_accept(id: *mut rdma_cm_id, conn_param: *mut rdma_conn_param) -> c_int {
    ...
    reject:
    cma_modify_qp_err(id_priv);
    rdma_reject(id, core::ptr::null_mut(), 0, IB_CM_REJ_CONSUMER_DEFINED);
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn rdma_lock_handler(id: *mut rdma_cm_id) {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_unlock_handler(id: *mut rdma_cm_id) {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_notify(id: *mut rdma_cm_id, event: enum ib_event_type) -> c_int {
    ...
    trace_cm_send_rej(id_priv);
    ret = ib_send_cm_rej(id_priv.cm_id.ib, reason, core::ptr::null_mut(), 0,
    private_data, private_data_len);
    }
    } else if (rdma_cap_iw_cm(id.device, id.port_num)) {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_disconnect(id: *mut rdma_cm_id) -> c_int {
...
// Initiate or respond to a disconnect.
    ...
    if (ib_send_cm_dreq(id_priv.cm_id.ib, core::ptr::null_mut(), 0)) {
    if (!ib_send_cm_drep(id_priv.cm_id.ib, core::ptr::null_mut(), 0))
...
#[no_mangle]
unsafe extern "C" fn cma_ib_mc_handler(status: c_int, multicast: *mut ib_sa_multicast) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rdma_leave_multicast(id: *mut rdma_cm_id, addr: *mut sockaddr) {
...
#[no_mangle]
unsafe extern "C" fn cma_netdev_change(ndev: *mut net_device, id_priv: *mut rdma_id_private) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_netevent_work_handler(_work: *mut work_struct) {
    static void cma_netevent_work_handler(struct work_struct *_work)
    {
    struct rdma_id_private *id_priv =
    ...
    {
    struct id_table_entry *ips_node = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cma_send_device_removal_put(id_priv: *mut rdma_id_private) {
    static void cma_send_device_removal_put(struct rdma_id_private *id_priv)
    {
    let mut event: rdma_cm_event = { .event = RDMA_CM_EVENT_DEVICE_REMOVAL };
    enum rdma_cm_state state;
    unsigned long flags;
    mutex_lock(&id_priv.handler_mutex);
...
#[no_mangle]
unsafe extern "C" fn cma_process_remove(cma_dev: *mut cma_device) {
...
#[no_mangle]
unsafe extern "C" fn cma_supported(device: *mut ib_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cma_add_one(device: *mut ib_device) -> c_int {
    static int cma_add_one(struct ib_device *device)
    {
    struct rdma_id_private *to_destroy;
    struct cma_device *cma_dev;
    struct rdma_id_private *id_priv;
    let mut supported_gids: c_ulong = 0;
    int ret;
    u32 i;
...
#[no_mangle]
unsafe extern "C" fn cma_remove_one(device: *mut ib_device, client_data: *mut c_void) {
    static void cma_remove_one(struct ib_device *device, void *client_data)
    {
...
#[no_mangle]
unsafe extern "C" fn cma_init_net(net: *mut net) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cma_exit_net(net: *mut net) {
...
#[no_mangle]
unsafe extern "C" fn cma_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cma_cleanup() -> void __exit {
    ...
    {
    let mut sr: sa_service_rec = {};
    let mut mask: ib_sa_comp_mask = 0;
    struct cma_work *work;
    work = kzalloc_obj(*work);
    if (!work)
    return -ENOMEM;
