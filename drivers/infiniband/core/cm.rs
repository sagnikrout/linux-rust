...
//! Source: drivers/infiniband/core/cm.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ibcm_reject_msg(reason: c_int) -> *const char __attribute_const__ {
    const char *__attribute_const__ ibcm_reject_msg(int reason)
    {
    let mut index: usize = reason;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cm_counter_attribute {
...
#[derive(Copy, Clone)]
pub struct cm_port {
    pub cm_dev: *mut cm_device,
    pub mad_agent: *mut ib_mad_agent,
    pub rep_agent: *mut ib_mad_agent,
    pub port_num: u32,
    pub counters: [atomic_long_t; CM_COUNTER_GROUPS][CM_ATTR_COUNT],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cm_device {
    pub kref: kref,
    pub list: list_head,
    pub mad_agent_lock: rwlock_t,
    pub ib_device: *mut ib_device,
    pub ack_delay: u8,
    pub going_down: c_int,
    pub port: [*mut cm_port; ],
}
...
pub struct cm_work {
    ...
    pub list: list_head,
    pub port: *mut cm_port,
    pub /: *mut *mut *mut ib_mad_recv_wc mad_recv_wc; / Received MADs,
    pub /: *mut *mut __be32 local_id; / Established / timewait,
    pub remote_id: __be32,
    pub cm_event: ib_cm_event,
    pub path: [sa_path_rec; ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cm_timewait_info {
    pub work: cm_work,
    pub list: list_head,
    pub remote_qp_node: rb_node,
    pub remote_id_node: rb_node,
    pub remote_ca_guid: __be64,
    pub remote_qpn: __be32,
    pub inserted_remote_qp: u8,
    pub inserted_remote_id: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cm_id_private {
    pub id: ib_cm_id,
    pub service_node: rb_node,
    pub sidr_id_node: rb_node,
    pub sidr_slid: u32,
    pub /: *mut *mut spinlock_t lock; / Do not acquire inside cm.lock,
    pub comp: completion,
    pub refcount: refcount_t,
// Number of clients sharing this ib_cm_id. Only valid for listeners.
// Protected by the cm.lock spinlock.
//
    pub listen_sharecount: c_int,
    pub rcu: rcu_head,
    pub msg: *mut ib_mad_send_buf,
    pub timewait_info: *mut cm_timewait_info,
// todo: use alternate port on send failure
    ...
    pub remote_qpn: __be32,
    pub qp_type: enum ib_qp_type,
    pub sq_psn: __be32,
    pub rq_psn: __be32,
    pub timeout_ms: c_int,
    pub path_mtu: enum ib_mtu,
    pub pkey: __be16,
...
#[no_mangle]
unsafe extern "C" fn cm_dev_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn cm_device_put(cm_dev: *mut cm_device) {
...
#[no_mangle]
pub unsafe extern "C" fn cm_deref_id(cm_id_priv: *mut cm_id_private) {
...
#[no_mangle]
unsafe extern "C" fn cm_free_msg(msg: *mut ib_mad_send_buf) {
...
unsafe extern "C" fn cm_free_priv_msg(msg: *mut ib_mad_send_buf) {
    ...
    if (!IS_ERR(m))
    m.context[0] = direct_retry ? CM_DIRECT_RETRY_CTX : core::ptr::null_mut();
    return m;
    }
...
#[no_mangle]
unsafe extern "C" fn cm_set_av_port(av: *mut cm_av, port: *mut cm_port) {
    ...
    struct cm_port *port = core::ptr::null_mut();
    unsigned long flags;
    if (attr) {
...
#[no_mangle]
unsafe extern "C" fn cm_move_av_from_path(dest: *mut cm_av, src: *mut cm_av) {
    static void cm_move_av_from_path(struct cm_av *dest, struct cm_av *src)
    {
    cm_set_av_port(dest, src.port);
    cm_set_av_port(src, core::ptr::null_mut());
    dest.pkey_index = src.pkey_index;
    rdma_move_ah_attr(&dest.ah_attr, &src.ah_attr);
    dest.timeout = src.timeout;
    }
#[no_mangle]
unsafe extern "C" fn cm_destroy_av(av: *mut cm_av) {
    static void cm_destroy_av(struct cm_av *av)
    {
    rdma_destroy_ah_attr(&av.ah_attr);
    cm_set_av_port(av, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn cm_local_id(local_id: __be32) -> u32 {
    static u32 cm_local_id(__be32 local_id)
    {
    return ( u32) (local_id ^ cm.random_id_operand);
    }
...
//
#[no_mangle]
unsafe extern "C" fn be32_lt(a: __be32, b: __be32) -> c_int {
    static int be32_lt(__be32 a, __be32 b)
    {
    return ( u32) a < ( u32) b;
    }
#[no_mangle]
unsafe extern "C" fn be32_gt(a: __be32, b: __be32) -> c_int {
    static int be32_gt(__be32 a, __be32 b)
    {
    return ( u32) a > ( u32) b;
    }
#[no_mangle]
unsafe extern "C" fn be64_lt(a: __be64, b: __be64) -> c_int {
    static int be64_lt(__be64 a, __be64 b)
    {
    return ( u64) a < ( u64) b;
    }
#[no_mangle]
unsafe extern "C" fn be64_gt(a: __be64, b: __be64) -> c_int {
...
//
    ...
    let mut service_id: __be64 = cm_id_priv.id.service_id;
    unsigned long flags;
    ...
    link = &(*link).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(cur_cm_id_priv->id.device: cm_id_priv->id.device >) -> else {
    else if (cm_id_priv.id.device > cur_cm_id_priv.id.device)
    link = &(*link).rb_right;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be64_lt(service_id, _arg: cur_cm_id_priv->id.service_id)) -> else {
    else if (be64_lt(service_id, cur_cm_id_priv.id.service_id))
    link = &(*link).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be64_gt(service_id, _arg: cur_cm_id_priv->id.service_id)) -> else {
...
//
    ...
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(cm_id_priv->id.device: device >) -> else {
    else if (device > cm_id_priv.id.device)
    node = node.rb_right;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be64_lt(service_id, _arg: cm_id_priv->id.service_id)) -> else {
    else if (be64_lt(service_id, cm_id_priv.id.service_id))
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be64_gt(service_id, _arg: cm_id_priv->id.service_id)) -> else {
    ...
    let mut remote_ca_guid: __be64 = timewait_info.remote_ca_guid;
    let mut remote_id: __be32 = timewait_info.work.remote_id;
    while (*link) {
    parent = *link;
    ...
    link = &(*link).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be32_gt(remote_id, _arg: cur_timewait_info->work.remote_id)) -> else {
    else if (be32_gt(remote_id, cur_timewait_info.work.remote_id))
    link = &(*link).rb_right;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be64_lt(remote_ca_guid, _arg: cur_timewait_info->remote_ca_guid)) -> else {
    else if (be64_lt(remote_ca_guid, cur_timewait_info.remote_ca_guid))
    link = &(*link).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be64_gt(remote_ca_guid, _arg: cur_timewait_info->remote_ca_guid)) -> else {
    ...
    struct cm_id_private *res = core::ptr::null_mut();
    ...
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be32_gt(remote_id, _arg: timewait_info->work.remote_id)) -> else {
    else if (be32_gt(remote_id, timewait_info.work.remote_id))
    node = node.rb_right;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be64_lt(remote_ca_guid, _arg: timewait_info->remote_ca_guid)) -> else {
    else if (be64_lt(remote_ca_guid, timewait_info.remote_ca_guid))
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be64_gt(remote_ca_guid, _arg: timewait_info->remote_ca_guid)) -> else {
    ...
    struct cm_timewait_info *cur_timewait_info;
    let mut remote_ca_guid: __be64 = timewait_info.remote_ca_guid;
    let mut remote_qpn: __be32 = timewait_info.remote_qpn;
    while (*link) {
    parent = *link;
    cur_timewait_info = rb_entry(parent, struct cm_timewait_info,
    remote_qp_node);
    ...
    link = &(*link).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be32_gt(remote_qpn, _arg: cur_timewait_info->remote_qpn)) -> else {
...
pub unsafe extern "C" fn if(_arg: be64_gt(remote_ca_guid, _arg: cur_timewait_info->remote_ca_guid)) -> else {
    ...
    struct rb_node *parent = core::ptr::null_mut();
    struct cm_id_private *cur_cm_id_priv;
    let mut remote_id: __be32 = cm_id_priv.id.remote_id;
    while (*link) {
    parent = *link;
    cur_cm_id_priv = rb_entry(parent, struct cm_id_private,
    sidr_id_node);
    ...
    link = &(*link).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: be32_gt(remote_id, _arg: cur_cm_id_priv->id.remote_id)) -> else {
    ...
    link = &(*link).rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(cm_id_priv->sidr_slid: cur_cm_id_priv->sidr_slid >) -> else {
    ...
    ret = xa_alloc_cyclic(&cm.local_id_table, &id, core::ptr::null_mut(), xa_limit_32b,
    &cm.local_id_next, GFP_KERNEL);
    if (ret < 0)
    goto error;
    cm_id_priv.id.local_id = ( __be32)id ^ cm.random_id_operand;
    return cm_id_priv;
    error:
    kfree(cm_id_priv);
    return ERR_PTR(ret);
...
//
#[no_mangle]
unsafe extern "C" fn cm_finalize_id(cm_id_priv: *mut cm_id_private) {
...
#[no_mangle]
unsafe extern "C" fn cm_free_work(work: *mut cm_work) {
...
#[no_mangle]
pub unsafe extern "C" fn cm_convert_to_ms(iba_time: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cm_ack_timeout(ca_ack_delay: u8, packet_life_time: u8) -> u8 {
    static u8 cm_ack_timeout(u8 ca_ack_delay, u8 packet_life_time)
    {
    let mut ack_timeout: c_int = packet_life_time + 1;
...
#[no_mangle]
unsafe extern "C" fn cm_remove_remote(cm_id_priv: *mut cm_id_private) {
...
#[no_mangle]
unsafe extern "C" fn cm_enter_timewait(cm_id_priv: *mut cm_id_private) {
...
//
    ...
    cm_id_priv.timewait_info = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cm_reset_to_idle(cm_id_priv: *mut cm_id_private) {
...
#[no_mangle]
unsafe extern "C" fn cm_destroy_id(cm_id: *mut ib_cm_id, err: c_int) {
...
// Do not reject to allow future retries.
    ...
    IB_CM_REJ_CONSUMER_DEFINED, core::ptr::null_mut(), 0,
    core::ptr::null_mut(), 0);
    }
    break;
    case IB_CM_REP_SENT:
    ...
    ib_cancel_mad(cm_id_priv.msg);
    cm_send_rej_locked(cm_id_priv, IB_CM_REJ_CONSUMER_DEFINED, core::ptr::null_mut(),
    ...
    cm_send_drep_locked(cm_id_priv, core::ptr::null_mut(), 0);
...
// Required for cleanup paths related cm_req_handler()
    ...
    while ((work = cm_dequeue_work(cm_id_priv)) != core::ptr::null_mut())
    cm_free_work(work);
...
#[no_mangle]
pub unsafe extern "C" fn ib_destroy_cm_id(cm_id: *mut ib_cm_id) {
...
#[no_mangle]
unsafe extern "C" fn cm_init_listen(cm_id_priv: *mut cm_id_private, service_id: __be64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ib_cm_listen(cm_id: *mut ib_cm_id, service_id: __be64) -> c_int {
    ...
    if (ret)
    goto out;
    if (!cm_insert_listen(cm_id_priv, core::ptr::null_mut())) {
    ret = -EBUSY;
    goto out;
    }
...
// Create an ID in advance, since the creation may sleep
    cm_id_priv = cm_alloc_id_priv(device, cm_handler, core::ptr::null_mut());
    if (IS_ERR(cm_id_priv))
    return ERR_CAST(cm_id_priv);
...
#[no_mangle]
unsafe extern "C" fn cm_form_tid(cm_id_priv: *mut cm_id_private) -> __be64 {
    static __be64 cm_form_tid(struct cm_id_private *cm_id_priv)
    {
    let mut hi_tid: u64 = 0, low_tid;
    lockdep_assert_held(&cm_id_priv.lock);
...
#[no_mangle]
unsafe extern "C" fn cm_validate_req_param(param: *mut ib_cm_req_param) -> c_int {
...
// Verify that we're not in timewait.
    ...
    return ret;
    if (param.alternate_path) {
    ret = cm_init_av_by_path(param.alternate_path, core::ptr::null_mut(),
    &alt_av);
    if (ret) {
    cm_destroy_av(&av);
    return ret;
    ...
    ret = ib_post_send_mad(msg, core::ptr::null_mut());
    if (ret)
    goto out_free;
    ...
    {
    struct ib_mad_send_buf *msg = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cm_req_has_alt_path(req_msg: *mut cm_req_msg) -> bool {
...
#[no_mangle]
unsafe extern "C" fn cm_get_bth_pkey(work: *mut cm_work) -> u16 {
    static u16 cm_get_bth_pkey(struct cm_work *work)
    {
    struct ib_device *ib_dev = work.port.cm_dev.ib_device;
    let mut port_num: u32 = work.port.port_num;
    let mut pkey_index: u16 = work.mad_recv_wc.wc.pkey_index;
    u16 pkey;
    int ret;
...
//
    ...
    param.alternate_path = core::ptr::null_mut();
    }
...
// Quick state check to discard duplicate REQs.
    ...
    IB_CM_REJ_STALE_CONN, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0,
    IB_CM_TIMEWAIT);
    break;
    default:
    goto unlock;
...
// Check for stale connections.
    ...
    core::ptr::null_mut(), 0);
    if (cur_cm_id_priv) {
    ib_send_cm_dreq(&cur_cm_id_priv.id, core::ptr::null_mut(), 0);
    cm_deref_id(cur_cm_id_priv);
    }
    return core::ptr::null_mut();
    }
...
//
#[no_mangle]
unsafe extern "C" fn cm_process_routed_req(req_msg: *mut cm_req_msg, wc: *mut ib_wc) {
...
#[no_mangle]
unsafe extern "C" fn cm_req_handler(work: *mut cm_work) -> c_int {
    ...
    req_msg = (struct cm_req_msg *)work.mad_recv_wc.recv_buf.mad;
    cm_id_priv =
    cm_alloc_id_priv(work.port.cm_dev.ib_device, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(cm_id_priv))
...
//
    ...
    if (cm_req_has_alt_path(req_msg)) {
    ret = cm_init_av_by_path(&work.path[1], core::ptr::null_mut(),
    &cm_id_priv.alt_av);
    if (ret) {
    ib_send_cm_rej(&cm_id_priv.id,
    IB_CM_REJ_INVALID_ALT_GID,
    &work.path[0].sgid,
    sizeof(work.path[0].sgid), core::ptr::null_mut(), 0);
    goto rejected;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn cm_format_rep_event(work: *mut cm_work, qp_type: enum ib_qp_type) {
...
#[no_mangle]
unsafe extern "C" fn cm_dup_rep_handler(work: *mut cm_work) {
    ...
    cm_id_priv.private_data_len);
#[no_mangle]
pub unsafe extern "C" fn if(IB_CM_MRA_REP_SENT: cm_id_priv->id.state ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn cm_rep_handler(work: *mut cm_work) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_establish_handler(work: *mut cm_work) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_rtu_handler(work: *mut cm_work) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_issue_dreq(cm_id_priv: *mut cm_id_private) {
    static void cm_issue_dreq(struct cm_id_private *cm_id_priv)
    {
    struct ib_mad_send_buf *msg;
    int ret;
    ...
    if (IS_ERR(msg))
    return;
    cm_format_dreq((struct cm_dreq_msg *) msg.mad, cm_id_priv, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn cm_dreq_handler(work: *mut cm_work) -> c_int {
    ...
    ib_post_send_mad(msg, core::ptr::null_mut()))
    cm_free_msg(msg);
    goto deref;
    case IB_CM_DREQ_RCVD:
    atomic_long_inc(&work.port.counters[CM_RECV_DUPLICATES]
...
#[no_mangle]
unsafe extern "C" fn cm_drep_handler(work: *mut cm_work) -> c_int {
    ...
    u8 private_data_len)
    {
    let mut state: enum ib_cm_state = cm_id_priv.id.state;
    struct ib_mad_send_buf *msg;
    int ret;
    lockdep_assert_held(&cm_id_priv.lock);
...
#[no_mangle]
unsafe extern "C" fn cm_format_rej_event(work: *mut cm_work) {
...
#[no_mangle]
unsafe extern "C" fn cm_rej_handler(work: *mut cm_work) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ib_prepare_cm_mra(cm_id: *mut ib_cm_id) -> c_int {
    ...
    cm_set_private_data(cm_id_priv, core::ptr::null_mut(), 0);
    error_unlock:
    spin_unlock_irqrestore(&cm_id_priv.lock, flags);
    return ret;
    }
...
#[no_mangle]
unsafe extern "C" fn cm_mra_handler(work: *mut cm_work) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_lap_handler(work: *mut cm_work) -> c_int {
...
// todo: verify LAP request and send reject APR if invalid.
    ...
    if (ret)
    goto deref;
    ret = cm_init_av_by_path(param.alternate_path, core::ptr::null_mut(), &alt_av);
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn cm_apr_handler(work: *mut cm_work) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_timewait_handler(work: *mut cm_work) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_sidr_req_handler(work: *mut cm_work) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_sidr_rep_handler(work: *mut cm_work) -> c_int {
    ...
    {
    let mut state: enum ib_cm_state = (unsigned long) msg.context[1];
    let mut cm_event: ib_cm_event = {};
    int ret;
// Discard old sends.
    spin_lock_irq(&cm_id_priv.lock);
...
#[no_mangle]
unsafe extern "C" fn cm_work_handler(_work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cm_establish(cm_id: *mut ib_cm_id) -> c_int {
...
//
    ...
    work.mad_recv_wc = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cm_migrate(cm_id: *mut ib_cm_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ib_cm_notify(cm_id: *mut ib_cm_id, event: enum ib_event_type) -> c_int {
    ...
    let mut alt_path: bool = false;
    u16 attr_id;
    let mut paths: c_int = 0;
    let mut going_down: c_int = 0;
...
// qp_attr_mask = IB_QP_ALT_PATH | IB_QP_PATH_MIG_STATE;
    ...
    {                                                                      \
    .attr = __ATTR(_name, 0444, cm_show_counter, core::ptr::null_mut()),            \
...
#[no_mangle]
unsafe extern "C" fn cm_add_one(ib_device: *mut ib_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cm_remove_one(ib_device: *mut ib_device, client_data: *mut c_void) {
...
//
    ...
    port.mad_agent = core::ptr::null_mut();
    port.rep_agent = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ib_cm_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ib_cm_cleanup() -> void __exit {
