...
//! Source: drivers/infiniband/core/umem_dmabuf.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn ib_umem_dmabuf_map_pages(umem_dmabuf: *mut ib_umem_dmabuf) -> c_int {
    int ib_umem_dmabuf_map_pages(struct ib_umem_dmabuf *umem_dmabuf)
    {
    struct sg_table *sgt;
    struct scatterlist *sg;
    unsigned long start, end, cur = 0;
    let mut nmap: c_uint = 0;
    long ret;
    int i;
...
// modify the sg list in-place to match umem address and length
    ...
    let mut offset: c_ulong = start - cur;
    ...
    let mut trim: c_ulong = cur + sg_dma_len(sg) - end;
...
#[no_mangle]
pub unsafe extern "C" fn ib_umem_dmabuf_unmap_pages(umem_dmabuf: *mut ib_umem_dmabuf) {
...
#[no_mangle]
unsafe extern "C" fn ib_umem_dmabuf_revoke_locked(attach: *mut dma_buf_attachment) {
...
#[no_mangle]
pub unsafe extern "C" fn ib_umem_dmabuf_revoke_lock(umem_dmabuf: *mut ib_umem_dmabuf) {
...
#[no_mangle]
pub unsafe extern "C" fn ib_umem_dmabuf_revoke_unlock(umem_dmabuf: *mut ib_umem_dmabuf) {
...
#[no_mangle]
pub unsafe extern "C" fn ib_umem_dmabuf_revoke(umem_dmabuf: *mut ib_umem_dmabuf) {
...
#[no_mangle]
pub unsafe extern "C" fn ib_umem_dmabuf_release(umem_dmabuf: *mut ib_umem_dmabuf) {
