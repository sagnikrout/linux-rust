...
//! Source: drivers/infiniband/core/uverbs_std_types_comp_cntr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut UVERBS_METHOD_COMP_CNTR_CREATE)(struct uverbs_attr_bundle) -> c_int {
    ...
    rdma_restrack_set_name(&cc.res, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut UVERBS_METHOD_COMP_CNTR_MODIFY)(struct uverbs_attr_bundle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut UVERBS_METHOD_COMP_CNTR_READ)(struct uverbs_attr_bundle) -> c_int {
