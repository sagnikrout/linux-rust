...
//! Source: drivers/infiniband/hw/bnxt_re/uapi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut BNXT_RE_METHOD_NOTIFY_DRV)(struct uverbs_attr_bundle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut BNXT_RE_METHOD_ALLOC_PAGE)(struct uverbs_attr_bundle) -> c_int {
...
// already allocated — one WC page per context
    ...
    uctx.wcdpi.dbr = core::ptr::null_mut();
    mutex_unlock(&uctx.wcdpi_lock);
    }
    return -ENOMEM;
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct bnxt_re_toggle_mem {
    pub toggle_entry: *mut bnxt_re_user_mmap_entry,
    pub mmap_offset: u64,
}

#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut BNXT_RE_METHOD_GET_TOGGLE_MEM)(struct uverbs_attr_bundle) -> c_int {
    static int UVERBS_HANDLER(BNXT_RE_METHOD_GET_TOGGLE_MEM)(struct uverbs_attr_bundle *attrs)
    {
    struct ib_uobject *uobj = uverbs_attr_get_uobject(attrs, BNXT_RE_TOGGLE_MEM_HANDLE);
    struct bnxt_re_user_mmap_entry *toggle_entry = core::ptr::null_mut();
    enum bnxt_re_get_toggle_mem_type res_type;
    struct bnxt_re_toggle_mem *tmem;
    struct ib_uobject *res_uobj;
    struct bnxt_re_ucontext *uctx;
    struct ib_ucontext *ib_uctx;
    let mut length: u32 = PAGE_SIZE;
...
#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut BNXT_RE_METHOD_DBR_ALLOC)(struct uverbs_attr_bundle) -> c_int {
    static int UVERBS_HANDLER(BNXT_RE_METHOD_DBR_ALLOC)(struct uverbs_attr_bundle *attrs)
    {
    let mut dbr: bnxt_re_db_region = {};
    struct bnxt_re_ucontext *uctx;
...
#[no_mangle]
pub unsafe extern "C" fn bnxt_re_dbr_kref_release(ref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut BNXT_RE_METHOD_GET_DEFAULT_DBR)(struct uverbs_attr_bundle) -> c_int {
    static int UVERBS_HANDLER(BNXT_RE_METHOD_GET_DEFAULT_DBR)(struct uverbs_attr_bundle *attrs)
    {
    let mut dpi: bnxt_re_db_region = {};
    struct bnxt_re_ucontext *uctx;
    struct ib_ucontext *ib_uctx;
    int ret;
    ib_uctx = ib_uverbs_get_ucontext(attrs);
