...
//! Source: drivers/infiniband/hw/efa/efa_verbs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct efa_user_mmap_entry {
...
pub const EFA_CHUNK_PAYLOAD_SHIFT: c_int = 12;

pub const EFA_CHUNK_PAYLOAD_PTR_SIZE: c_int = 8;
pub const EFA_CHUNK_SHIFT: c_int = 12;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pbl_chunk_list {
    pub chunks: *mut pbl_chunk,
    pub size: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pbl_context {
    union {
    struct {
    pub dma_addr: dma_addr_t,
    pub continuous: },
    struct {
    pub pbl_buf_size_in_pages: u32,
    pub sgl: *mut scatterlist,
    pub sg_dma_cnt: c_int,
    pub chunk_list: pbl_chunk_list,
    pub indirect: },
    pub phys: },
    pub pbl_buf: *mut u64,
    pub pbl_buf_size_in_bytes: u32,
    pub physically_continuous: u8,
}
...
// dma_addr = dma_map_single(&dev->pdev->dev, addr, size, dir);
    ...
    let mut resp: efa_ibv_ex_query_device_resp = {};
...
#[no_mangle]
pub unsafe extern "C" fn efa_query_port_speed(ibdev: *mut ib_device, port_num: u32, speed: *mut u64) -> c_int {
...
// speed = dev->dev_attr.max_link_speed_gbps * 10;
    ...
    let mut params: efa_com_query_qp_params = {};
...
#[no_mangle]
unsafe extern "C" fn efa_pd_dealloc(dev: *mut efa_dev, pdn: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efa_alloc_pd(ibpd: *mut ib_pd, udata: *mut ib_udata) -> c_int {
    int efa_alloc_pd(struct ib_pd *ibpd, struct ib_udata *udata)
    {
    struct efa_dev *dev = to_edev(ibpd.device);
    let mut resp: efa_ibv_alloc_pd_resp = {};
...
#[no_mangle]
pub unsafe extern "C" fn efa_dealloc_pd(ibpd: *mut ib_pd, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_destroy_qp_handle(dev: *mut efa_dev, qp_handle: u32) -> c_int {
    static int efa_destroy_qp_handle(struct efa_dev *dev, u32 qp_handle)
    {
    let mut params: efa_com_destroy_qp_params = { .qp_handle = qp_handle };
    return efa_com_destroy_qp(&dev.edev, &params);
    }
#[no_mangle]
unsafe extern "C" fn efa_qp_user_mmap_entries_remove(qp: *mut efa_qp) {
...
#[no_mangle]
pub unsafe extern "C" fn efa_destroy_qp(ibqp: *mut ib_qp, udata: *mut ib_udata) -> c_int {
...
// offset = rdma_user_mmap_get_offset(&entry->rdma_entry);
    ...
    struct ib_udata *udata)
    {
    let mut create_qp_params: efa_com_create_qp_params = {};
    struct efa_com_create_qp_result create_qp_resp;
    struct efa_dev *dev = to_edev(ibqp.device);
    let mut resp: efa_ibv_create_qp_resp = {};
    struct efa_ibv_create_qp cmd;
    struct efa_qp *qp = to_eqp(ibqp);
    struct efa_ucontext *ucontext;
    let mut supported_efa_flags: u16 = 0;
    int err;
    ...
    {
    struct efa_dev *dev = to_edev(ibqp.device);
    let mut params: efa_com_modify_qp_params = {};
    struct efa_qp *qp = to_eqp(ibqp);
    enum ib_qp_state cur_state;
    enum ib_qp_state new_state;
    int err;
...
#[no_mangle]
unsafe extern "C" fn efa_destroy_cq_idx(dev: *mut efa_dev, cq_idx: c_int) -> c_int {
    static int efa_destroy_cq_idx(struct efa_dev *dev, int cq_idx)
    {
    let mut params: efa_com_destroy_cq_params = { .cq_idx = cq_idx };
    return efa_com_destroy_cq(&dev.edev, &params);
    }
#[no_mangle]
unsafe extern "C" fn efa_cq_user_mmap_entries_remove(cq: *mut efa_cq) {
...
#[no_mangle]
pub unsafe extern "C" fn efa_destroy_cq(ibcq: *mut ib_cq, udata: *mut ib_udata) -> c_int {
    ...
    let mut params: efa_com_create_cq_params = {};
    let mut resp: efa_ibv_create_cq_resp = {};
    struct efa_com_create_cq_result result;
    struct ib_device *ibdev = ibcq.device;
    struct efa_dev *dev = to_edev(ibdev);
    struct efa_ibv_create_cq cmd;
    struct efa_cq *cq = to_ecq(ibcq);
    let mut entries: c_int = attr.cqe;
    struct ib_umem *umem;
    bool set_src_addr;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn pbl_chunk_list_create(dev: *mut efa_dev, pbl: *mut pbl_context) -> c_int {
    ...
    let mut page_cnt: c_int = pbl.phys.indirect.pbl_buf_size_in_pages;
    struct scatterlist *pages_sgl = pbl.phys.indirect.sgl;
    unsigned int chunk_list_size, chunk_idx, payload_idx;
    let mut sg_dma_cnt: c_int = pbl.phys.indirect.sg_dma_cnt;
...
#[no_mangle]
unsafe extern "C" fn pbl_chunk_list_destroy(dev: *mut efa_dev, pbl: *mut pbl_context) {
...
//
#[no_mangle]
unsafe extern "C" fn pbl_indirect_initialize(dev: *mut efa_dev, pbl: *mut pbl_context) -> c_int {
    static int pbl_indirect_initialize(struct efa_dev *dev, struct pbl_context *pbl)
    {
    let mut size_in_pages: u32 = DIV_ROUND_UP(pbl.pbl_buf_size_in_bytes, EFA_CHUNK_PAYLOAD_SIZE);
...
#[no_mangle]
unsafe extern "C" fn pbl_indirect_terminate(dev: *mut efa_dev, pbl: *mut pbl_context) {
...
#[no_mangle]
unsafe extern "C" fn pbl_destroy(dev: *mut efa_dev, pbl: *mut pbl_context) {
    ...
    {
    struct efa_dev *dev = to_edev(ibpd.device);
    let mut params: efa_com_reg_mr_params = {};
    let mut result: efa_com_reg_mr_result = {};
    struct pbl_context pbl;
    unsigned int pg_sz;
    int inline_size;
    int err;
...
#[no_mangle]
unsafe extern "C" fn UVERBS_HANDLER(attrs: *mut EFA_IB_METHOD_MR_QUERY)(struct uverbs_attr_bundle) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efa_dereg_mr(ibmr: *mut ib_mr, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_dealloc_uar(dev: *mut efa_dev, uarn: u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efa_alloc_ucontext(ibucontext: *mut ib_ucontext, udata: *mut ib_udata) -> c_int {
    int efa_alloc_ucontext(struct ib_ucontext *ibucontext, struct ib_udata *udata)
    {
    struct efa_ucontext *ucontext = to_eucontext(ibucontext);
    struct efa_dev *dev = to_edev(ibucontext.device);
    let mut resp: efa_ibv_alloc_ucontext_resp = {};
    let mut cmd: efa_ibv_alloc_ucontext_cmd = {};
...
#[no_mangle]
pub unsafe extern "C" fn efa_dealloc_ucontext(ibucontext: *mut ib_ucontext) {
...
#[no_mangle]
pub unsafe extern "C" fn efa_mmap_free(rdma_entry: *mut rdma_user_mmap_entry) {
    ...
    struct efa_ucontext *ucontext = to_eucontext(ibucontext);
    struct efa_dev *dev = to_edev(ibucontext.device);
    let mut length: usize = vma.vm_end - vma.vm_start;
    ibdev_dbg(&dev.ibdev,
...
#[no_mangle]
unsafe extern "C" fn efa_ah_destroy(dev: *mut efa_dev, ah: *mut efa_ah) -> c_int {
    static int efa_ah_destroy(struct efa_dev *dev, struct efa_ah *ah)
    {
    let mut params: efa_com_destroy_ah_params = {};
    params.ah = ah.ah;
    ...
    let mut params: efa_com_create_ah_params = {};
    let mut resp: efa_ibv_create_ah_resp = {};
...
#[no_mangle]
pub unsafe extern "C" fn efa_destroy_ah(ibah: *mut ib_ah, flags: u32) -> c_int {
    ...
    u32 port_num)
    {
    let mut params: efa_com_get_stats_params = {};
    ...
    {
    struct efa_dev *dev = to_edev(ibdev);
    let mut dev_ops: u32 = dev.dev_attr.supported_event_counter_qp_events;
...
#[no_mangle]
unsafe extern "C" fn efa_create_event_counter(dev: *mut efa_dev, uarn: u16, addr: dma_addr_t, handle: *mut u32) -> c_int {
    static int efa_create_event_counter(struct efa_dev *dev, u16 uarn, dma_addr_t addr, u32 *handle)
    {
    let mut params: efa_com_create_event_counter_params = {};
...
#[no_mangle]
unsafe extern "C" fn efa_destroy_event_counter(dev: *mut efa_dev, handle: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efa_create_comp_cntr(ibcc: *mut ib_comp_cntr, attrs: *mut uverbs_attr_bundle) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn efa_destroy_comp_cntr(ibcc: *mut ib_comp_cntr) -> c_int {
    ...
    {
    let mut params: efa_com_modify_event_counter_params = {};
    struct efa_comp_cntr *cc = to_ecc(ibcc);
...
#[no_mangle]
unsafe extern "C" fn efa_comp_cntr_op_to_comp_events(op_mask: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn efa_comp_cntr_op_to_err_events(op_mask: u32) -> u32 {
    ...
    {
    let mut detach_params: efa_com_detach_event_counter_params = {};
    let mut params: efa_com_attach_event_counter_params = {};
    struct efa_dev *dev = to_edev(ibqp.device);
    struct efa_comp_cntr *cc = to_ecc(ibcc);
    struct efa_qp *qp = to_eqp(ibqp);
    int err;
