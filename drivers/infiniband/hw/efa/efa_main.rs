...
//! Source: drivers/infiniband/hw/efa/efa_main.c
#![no_std]
...
pub const PCI_DEV_ID_EFA0_VF: c_uint = 0xefa0;
pub const PCI_DEV_ID_EFA1_VF: c_uint = 0xefa1;
pub const PCI_DEV_ID_EFA2_VF: c_uint = 0xefa2;
pub const PCI_DEV_ID_EFA3_VF: c_uint = 0xefa3;
pub const PCI_DEV_ID_EFA4_VF: c_uint = 0xefa4;
...
pub const EFA_REG_BAR: c_int = 0;
pub const EFA_MEM_BAR: c_int = 2;
...
#[no_mangle]
unsafe extern "C" fn efa_keep_alive(data: *mut c_void, aenq_e: *mut efa_admin_aenq_entry) {
...
#[no_mangle]
unsafe extern "C" fn efa_release_bars(dev: *mut efa_dev, bars_mask: c_int) {
...
#[no_mangle]
unsafe extern "C" fn efa_process_comp_eqe(dev: *mut efa_dev, eqe: *mut efa_admin_eqe) {
    static void efa_process_comp_eqe(struct efa_dev *dev, struct efa_admin_eqe *eqe)
    {
    let mut cqn: u16 = eqe.u.comp_event.cqn;
    struct efa_cq *cq;
...
#[no_mangle]
unsafe extern "C" fn efa_process_eqe(eeq: *mut efa_com_eq, eqe: *mut efa_admin_eqe) {
...
#[no_mangle]
unsafe extern "C" fn efa_intr_msix_comp(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn efa_intr_msix_mgmnt(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn efa_request_irq(dev: *mut efa_dev, irq: *mut efa_irq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_setup_comp_irq(dev: *mut efa_dev, eq: *mut efa_eq, vector: u32) {
...
#[no_mangle]
unsafe extern "C" fn efa_free_irq(dev: *mut efa_dev, irq: *mut efa_irq) {
    static void efa_free_irq(struct efa_dev *dev, struct efa_irq *irq)
    {
    irq_set_affinity_hint(irq.irqn, core::ptr::null_mut());
    free_irq(irq.irqn, irq.data);
    }
#[no_mangle]
unsafe extern "C" fn efa_setup_mgmnt_irq(dev: *mut efa_dev) {
...
#[no_mangle]
unsafe extern "C" fn efa_set_mgmnt_irq(dev: *mut efa_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_request_doorbell_bar(dev: *mut efa_dev) -> c_int {
    static int efa_request_doorbell_bar(struct efa_dev *dev)
    {
    let mut db_bar_idx: u8 = dev.dev_attr.db_bar;
    struct pci_dev *pdev = dev.pdev;
    int pci_mem_bars;
    int db_bar;
    int err;
...
#[no_mangle]
unsafe extern "C" fn efa_release_doorbell_bar(dev: *mut efa_dev) {
...
#[no_mangle]
unsafe extern "C" fn efa_stats_init(dev: *mut efa_dev) {
...
#[no_mangle]
unsafe extern "C" fn efa_set_host_info(dev: *mut efa_dev) {
    static void efa_set_host_info(struct efa_dev *dev)
    {
    let mut resp: efa_admin_set_feature_resp = {};
    let mut cmd: efa_admin_set_feature_cmd = {};
    struct efa_admin_host_info *hinf;
    let mut bufsz: u32 = sizeof(*hinf);
    dma_addr_t hinf_dma;
...
#[no_mangle]
unsafe extern "C" fn efa_destroy_eq(dev: *mut efa_dev, eq: *mut efa_eq) {
...
#[no_mangle]
unsafe extern "C" fn efa_create_eq(dev: *mut efa_dev, eq: *mut efa_eq, msix_vec: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_create_eqs(dev: *mut efa_dev) -> c_int {
    static int efa_create_eqs(struct efa_dev *dev)
    {
    let mut neqs: u32 = dev.dev_attr.max_eq;
    int err, i;
...
#[no_mangle]
unsafe extern "C" fn efa_destroy_eqs(dev: *mut efa_dev) {
...
#[no_mangle]
unsafe extern "C" fn efa_ib_device_add(dev: *mut efa_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_ib_device_remove(dev: *mut efa_dev) {
...
#[no_mangle]
unsafe extern "C" fn efa_disable_msix(dev: *mut efa_dev) {
    static void efa_disable_msix(struct efa_dev *dev)
    {
    pci_free_irq_vectors(dev.pdev);
    }
#[no_mangle]
unsafe extern "C" fn efa_enable_msix(dev: *mut efa_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_device_init(edev: *mut efa_com_dev, pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn efa_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn efa_shutdown(pdev: *mut pci_dev) {
