...
//! Source: drivers/infiniband/hw/bng_re/bng_dev.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bng_re_register_netdev(rdev: *mut bng_re_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bng_re_destroy_chip_ctx(rdev: *mut bng_re_dev) {
    ...
    rdev.bng_res.cctx = core::ptr::null_mut();
    rdev.bng_res.pdev = core::ptr::null_mut();
    kfree(chip_ctx);
    }
#[no_mangle]
unsafe extern "C" fn bng_re_setup_chip_ctx(rdev: *mut bng_re_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bng_re_init_hwrm_hdr(hdr: *mut input, opcd: u16) {
...
#[no_mangle]
unsafe extern "C" fn bng_re_stats_ctx_free(rdev: *mut bng_re_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bng_re_stats_ctx_alloc(rdev: *mut bng_re_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bng_re_query_hwrm_version(rdev: *mut bng_re_dev) -> c_int {
    static int bng_re_query_hwrm_version(struct bng_re_dev *rdev)
    {
    struct bnge_auxr_dev *aux_dev = rdev.aux_dev;
    let mut ver_get_resp: hwrm_ver_get_output = {};
    let mut ver_get_req: hwrm_ver_get_input = {};
...
#[no_mangle]
unsafe extern "C" fn bng_re_dev_uninit(rdev: *mut bng_re_dev) {
...
#[no_mangle]
unsafe extern "C" fn bng_re_dev_init(rdev: *mut bng_re_dev) -> c_int {
    static int bng_re_dev_init(struct bng_re_dev *rdev)
    {
    let mut rattr: bng_re_ring_attr = {};
...
#[no_mangle]
unsafe extern "C" fn bng_re_add_device(adev: *mut auxiliary_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bng_re_remove(adev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn bng_re_mod_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bng_re_mod_exit() -> void __exit {
