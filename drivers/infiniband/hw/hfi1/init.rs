...
//! Source: drivers/infiniband/hw/hfi1/init.c
#![no_std]
...
//
pub const HFI1_MIN_USER_CTXT_BUFCNT: c_int = 7;

pub const NUM_IB_PORTS: c_int = 1;
//
// Number of user receive contexts we are configured to use (to allow for more
// pio buffers per ctxt, etc.)  Zero means use one user context per CPU.
//
    let mut num_user_contexts: c_int = -1;
...
// computed based on above array
    ...
    let mut hfi1_rcvarr_split: static unsigned = 25;
    ...
    let mut hfi1_hdrq_entsize: static uint = 32;
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_create_kctxts(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hfi1_rcd_init(rcd: *mut hfi1_ctxtdata) {
...
//
#[no_mangle]
unsafe extern "C" fn hfi1_rcd_free(kref: *mut kref) {
    ...
    rcd.dd.rcd[rcd.ctxt] = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_rcd_put(rcd: *mut hfi1_ctxtdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_rcd_get(rcd: *mut hfi1_ctxtdata) -> c_int {
...
//
    ...
    {
    unsigned long flags;
    struct hfi1_ctxtdata *rcd = core::ptr::null_mut();
    spin_lock_irqsave(&dd.uctxt_lock, flags);
    if (dd.rcd[ctxt]) {
    rcd = dd.rcd[ctxt];
    if (!hfi1_rcd_get(rcd))
    rcd = core::ptr::null_mut();
    }
    spin_unlock_irqrestore(&dd.uctxt_lock, flags);
    return rcd;
    }
...
//
    ...
    struct hfi1_ctxtdata *rcd;
    let mut kctxt_ngroups: unsigned = 0;
    u32 base;
...
//
    ...
    let mut ct: u16 = ctxt - dd.first_dyn_alloc_ctxt;
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_free_ctxt(rcd: *mut hfi1_ctxtdata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_link_ipg(ppd: *mut hfi1_pportdata) {
...
//
    ...
    let mut ccti: u16 = ppd.cca_timer[i].ccti;
    if (ccti > max_ccti)
    max_ccti = ccti;
    }
...
#[no_mangle]
unsafe extern "C" fn cca_timer_fn(t: *mut hrtimer) -> enum hrtimer_restart {
...
//
    ...
    if (cca_timer.ccti > ccti_min) {
    let mut nsec: c_ulong = 1024 * ccti_timer;
...
//
#[no_mangle]
unsafe extern "C" fn loadtime_init(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_after_reset(dd: *mut hfi1_devdata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn enable_chip(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
unsafe extern "C" fn create_workqueues(dd: *mut hfi1_devdata) -> c_int {
...
//
    ...
    ppd.hfi1_wq = core::ptr::null_mut();
    }
    if (ppd.link_wq) {
    destroy_workqueue(ppd.link_wq);
    ppd.link_wq = core::ptr::null_mut();
    }
    }
    return -ENOMEM;
    }
...
//
#[no_mangle]
unsafe extern "C" fn destroy_workqueues(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
unsafe extern "C" fn enable_general_intr(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_init(dd: *mut hfi1_devdata, reinit: c_int) -> c_int {
    int hfi1_init(struct hfi1_devdata *dd, int reinit)
    {
    let mut ret: c_int = 0, pidx, lastfail = 0;
    unsigned long len;
    u16 i;
    struct hfi1_ctxtdata *rcd;
    struct hfi1_pportdata *ppd;
...
//
#[no_mangle]
unsafe extern "C" fn stop_timers(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
unsafe extern "C" fn shutdown_device(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_free_ctxtdata(dd: *mut hfi1_devdata, rcd: *mut hfi1_ctxtdata) {
    ...
    rcd.rcvhdrq = core::ptr::null_mut();
    if (hfi1_rcvhdrtail_kvaddr(rcd)) {
    dma_free_coherent(&dd.pcidev.dev, PAGE_SIZE,
    (void *)hfi1_rcvhdrtail_kvaddr(rcd),
    rcd.rcvhdrqtailaddr_dma);
    rcd.rcvhdrtail_kvaddr = core::ptr::null_mut();
    }
    }
// all the RcvArray entries should have been cleared by now
    kfree(rcd.egrbufs.rcvtids);
    rcd.egrbufs.rcvtids = core::ptr::null_mut();
    ...
    rcd.egrbufs.buffers = core::ptr::null_mut();
    sc_free(rcd.sc);
    rcd.sc = core::ptr::null_mut();
    vfree(rcd.subctxt_uregbase);
    vfree(rcd.subctxt_rcvegrbuf);
    vfree(rcd.subctxt_rcvhdr_base);
    kfree(rcd.opstats);
    rcd.subctxt_uregbase = core::ptr::null_mut();
    rcd.subctxt_rcvegrbuf = core::ptr::null_mut();
    rcd.subctxt_rcvhdr_base = core::ptr::null_mut();
    rcd.opstats = core::ptr::null_mut();
    }
//
...
//
    ...
    if (!dd.asic_data)
    return core::ptr::null_mut();
    dd.asic_data.dds[dd.hfi1_id] = core::ptr::null_mut();
    other = dd.hfi1_id ? 0 : 1;
    ad = dd.asic_data;
    dd.asic_data = core::ptr::null_mut();
// return NULL if the other dd still has a link
    return ad.dds[other] ? core::ptr::null_mut() : ad;
    }
...
//
#[no_mangle]
unsafe extern "C" fn hfi1_free_devdata(dd: *mut hfi1_devdata) {
    ...
    dd.int_counter   = core::ptr::null_mut();
    dd.rcv_limit     = core::ptr::null_mut();
    dd.send_schedule = core::ptr::null_mut();
    dd.tx_opstats    = core::ptr::null_mut();
    kfree(dd.comp_vect);
    dd.comp_vect = core::ptr::null_mut();
    if (dd.rcvhdrtail_dummy_kvaddr)
    dma_free_coherent(&dd.pcidev.dev, sizeof(u64),
    (void *)dd.rcvhdrtail_dummy_kvaddr,
    dd.rcvhdrtail_dummy_dma);
    dd.rcvhdrtail_dummy_kvaddr = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_disable_after_error(dd: *mut hfi1_devdata) {
...
#[no_mangle]
unsafe extern "C" fn compute_krcvqs() -> void __init {
...
//
#[no_mangle]
unsafe extern "C" fn hfi1_mod_init() -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn hfi1_mod_cleanup() -> void __exit {
...
#[no_mangle]
unsafe extern "C" fn cleanup_device_data(dd: *mut hfi1_devdata) {
...
// ppd->statusp &= ~HFI1_STATUS_CHIP_PRESENT;
    ...
    RCU_INIT_POINTER(ppd.cc_state, core::ptr::null_mut());
...
// must follow rcv context free - need to remove rcv's hooks
    ...
    dd.send_contexts = core::ptr::null_mut();
    kfree(dd.hw_to_sw);
    dd.hw_to_sw = core::ptr::null_mut();
    kfree(dd.boardname);
    vfree(dd.events);
    vfree(dd.status);
    }
...
//
#[no_mangle]
unsafe extern "C" fn postinit_cleanup(dd: *mut hfi1_devdata) {
...
#[no_mangle]
unsafe extern "C" fn wait_for_clients(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_create_rcvhdrq(dd: *mut hfi1_devdata, rcd: *mut hfi1_ctxtdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_setup_eagerbufs(rcd: *mut hfi1_ctxtdata) -> c_int {
    ...
    u16 order, idx = 0;
    let mut ret: c_int = 0;
    let mut round_mtu: u16 = roundup_pow_of_two(hfi1_max_mtu);
//
...
//
    ...
    rcd.egrbufs.buffers[idx].addr,
    rcd.egrbufs.buffers[idx].dma);
    rcd.egrbufs.buffers[idx].addr = core::ptr::null_mut();
