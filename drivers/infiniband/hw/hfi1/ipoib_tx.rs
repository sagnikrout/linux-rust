...
//! Source: drivers/infiniband/hw/hfi1/ipoib_tx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_txreqs(sent: u64, completed: u64) -> u32 {
    static u32 hfi1_ipoib_txreqs(const u64 sent, const u64 completed)
    {
    return sent - completed;
    }
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_used(txq: *mut hfi1_ipoib_txq) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_stop_txq(txq: *mut hfi1_ipoib_txq) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_wake_txq(txq: *mut hfi1_ipoib_txq) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_ring_hwat(txq: *mut hfi1_ipoib_txq) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_ring_lwat(txq: *mut hfi1_ipoib_txq) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_check_queue_depth(txq: *mut hfi1_ipoib_txq) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_check_queue_stopped(txq: *mut hfi1_ipoib_txq) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_free_tx(tx: *mut ipoib_txreq, budget: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_drain_tx_ring(txq: *mut hfi1_ipoib_txq) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_poll_tx_ring(napi: *mut napi_struct, budget: c_int) -> c_int {
    static int hfi1_ipoib_poll_tx_ring(struct napi_struct *napi, int budget)
    {
    struct hfi1_ipoib_txq *txq =
    container_of(napi, struct hfi1_ipoib_txq, napi);
    struct hfi1_ipoib_circ_buf *tx_ring = &txq.tx_ring;
    let mut head: u32 = tx_ring.head;
    let mut max_tx: u32 = tx_ring.max_items;
    int work_done;
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_sdma_complete(txreq: *mut sdma_txreq, status: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_calc_entropy(skb: *mut sk_buff) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_sdma_wakeup(wait: *mut iowait, reason: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_flush_txq(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_ipoib_txreq_init(priv: *mut hfi1_ipoib_dev_priv) -> c_int {
...
//
    ...
    kfree(priv.txqs);
    priv.txqs = core::ptr::null_mut();
    return -ENOMEM;
    }
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_drain_tx_list(txq: *mut hfi1_ipoib_txq) {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_ipoib_txreq_deinit(priv: *mut hfi1_ipoib_dev_priv) {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_ipoib_napi_tx_enable(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_ipoib_napi_tx_disable(dev: *mut net_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_ipoib_tx_timeout(dev: *mut net_device, q: c_uint) {
