...
//! Source: drivers/infiniband/hw/hfi1/pcie.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_pcie_init(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_pcie_cleanup(pdev: *mut pci_dev) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_pcie_ddinit(dd: *mut hfi1_devdata, pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_pcie_ddcleanup(dd: *mut hfi1_devdata) {
    void hfi1_pcie_ddcleanup(struct hfi1_devdata *dd)
    {
    dd.flags &= ~HFI1_PRESENT;
    if (dd.kregbase1)
    iounmap(dd.kregbase1);
    dd.kregbase1 = core::ptr::null_mut();
    if (dd.kregbase2)
    iounmap(dd.kregbase2);
    dd.kregbase2 = core::ptr::null_mut();
    if (dd.rcvarray_wc)
    iounmap(dd.rcvarray_wc);
    dd.rcvarray_wc = core::ptr::null_mut();
    if (dd.piobase)
    iounmap(dd.piobase);
    dd.piobase = core::ptr::null_mut();
    }
// return the PCIe link speed from the given link status
#[no_mangle]
unsafe extern "C" fn extract_speed(linkstat: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn update_lbus_info(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn pcie_speeds(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn restore_pci_variables(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn save_pci_variables(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn tune_pcie_caps(dd: *mut hfi1_devdata) {
...
//
    ...
    let mut ret: pci_ers_result_t = PCI_ERS_RESULT_RECOVERED;
    switch (state) {
...
pub const DL_STATUS_HFI0: c_uint = 0x1	/* hfi0 firmware download complete */;
pub const DL_STATUS_HFI1: c_uint = 0x2	/* hfi1 firmware download complete */;
pub const DL_STATUS_BOTH: c_uint = 0x3	/* hfi0 and hfi1 firmware download complete */;
// ASIC_PCI_SD_HOST_STATUS.FW_DNLD_ERR field values
pub const DL_ERR_NONE: c_uint = 0x0	/* no error */;
pub const DL_ERR_SWAP_PARITY: c_uint = 0x1	/* parity error in SerDes interrupt */;
// or response data
pub const DL_ERR_DISABLED: c_uint = 0x2	/* hfi disabled */;
pub const DL_ERR_SECURITY: c_uint = 0x3	/* security check failed */;
pub const DL_ERR_SBUS: c_uint = 0x4	/* SBus status error */;
pub const DL_ERR_XFR_PARITY: c_uint = 0x5	/* parity error during ROM transfer*/;
// gasket block secondary bus reset delay

    let mut pcie_target: static uint = 3;
...
pub const PREC: c_int = 0;
pub const ATTN: c_int = 1;
pub const POST: c_int = 2;
...
//
#[no_mangle]
unsafe extern "C" fn pcie_post_steps(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
unsafe extern "C" fn trigger_sbr(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn arm_gasket_logic(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
unsafe extern "C" fn write_xmt_margin(dd: *mut hfi1_devdata, fname: *const c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn do_pcie_gen3_transition(dd: *mut hfi1_devdata) -> c_int {
    ...
    let mut intnum: c_int = 0;
    uint default_pset;
    let mut pset: c_uint = pcie_pset;
