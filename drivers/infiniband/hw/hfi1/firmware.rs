...
//! Source: drivers/infiniband/hw/hfi1/firmware.c
#![no_std]
...
//
    ...
    let mut fw_8051_load: static uint = 1;
    let mut fw_fabric_serdes_load: static uint = 1;
    let mut fw_pcie_serdes_load: static uint = 1;
    let mut fw_sbus_load: static uint = 1;
// Firmware file names get set in hfi1_firmware_init() based on the above
    static char *fw_8051_name;
    static char *fw_fabric_serdes_name;
    static char *fw_sbus_name;
    static char *fw_pcie_serdes_name;
pub const SBUS_MAX_POLL_COUNT: c_int = 100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct css_header {
    pub module_type: u32,
    pub header_len: u32,
    pub header_version: u32,
    pub module_id: u32,
    pub module_vendor: u32,
    pub /: *mut *mut u32 date; / BCD yyyymmdd,
    pub /: *mut *mut u32 size; / in DWORDs,
    pub /: *mut *mut u32 key_size; / in DWORDs,
...
pub const CSS_MODULE_TYPE: c_uint = 0x00000006;
pub const CSS_HEADER_LEN: c_uint = 0x000000a1;
pub const CSS_HEADER_VERSION: c_uint = 0x00010000;
pub const CSS_MODULE_VENDOR: c_uint = 0x00008086;
pub const KEY_SIZE: c_int = 256;
pub const MU_SIZE: c_int = 8;
pub const EXPONENT_SIZE: c_int = 4;
// size of platform configuration partition
pub const MAX_PLATFORM_CONFIG_FILE_SIZE: c_int = 4096;
// size of file of plaform configuration encoded in format version 4
pub const PLATFORM_CONFIG_FORMAT_4_FILE_SIZE: c_int = 528;
// the file itself
#[repr(C)]
#[derive(Copy, Clone)]
pub struct firmware_file {
    pub css_header: css_header,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct augmented_firmware_file {
    pub css_header: css_header,
    pub modulus: [u8; KEY_SIZE],
    pub exponent: [u8; EXPONENT_SIZE],
    pub signature: [u8; KEY_SIZE],
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct firmware_details {
// Linux core piece
    pub fw: *const firmware,
    pub css_header: *mut css_header,
    pub /: *mut *mut *mut u8 firmware_ptr; / pointer to binary data,
    pub /: *mut *mut u32 firmware_len; / length in bytes,
    pub /: *mut *mut *mut u8 modulus; / pointer to the modulus,
    pub /: *mut *mut *mut u8 exponent; / pointer to the exponent,
    pub /: *mut *mut *mut u8 signature; / pointer to the signature,
    pub /: *mut *mut *mut u8 r2; / pointer to r2,
    pub /: *mut *mut *mut u8 mu; / pointer to mu,
    pub dummy_header: augmented_firmware_file,
}
...
//
    ...
    let mut fw_state: static enum fw_state = FW_EMPTY;
    static int fw_err;
...
pub const SPICO_SBUS: c_uint = 0x1;
pub const SPICO_FABRIC: c_uint = 0x2;
pub const ENABLE_SPICO_SMASK: c_uint = 0x1;
// security block commands
pub const RSA_CMD_INIT: c_uint = 0x1;
pub const RSA_CMD_START: c_uint = 0x2;
// security block status
pub const RSA_STATUS_IDLE: c_uint = 0x0;
pub const RSA_STATUS_ACTIVE: c_uint = 0x1;
pub const RSA_STATUS_DONE: c_uint = 0x2;
pub const RSA_STATUS_FAILED: c_uint = 0x3;
...
pub const NUM_FABRIC_SERDES: c_int = 4;
// ASIC_STS_SBUS_RESULT.RESULT_CODE value
pub const SBUS_READ_COMPLETE: c_uint = 0x4;
...
// SBus fabric SerDes broadcast addresses, one per HFI
    ...
    let mut all_fabric_serdes_broadcast: static u8 = 0xe1;
// SBus PCIe SerDes broadcast addresses, one per HFI
    const u8 pcie_serdes_broadcast[2] = { 0xe2, 0xe3 };
    let mut all_pcie_serdes_broadcast: static u8 = 0xe0;
...
//
#[no_mangle]
unsafe extern "C" fn __read_8051_data(dd: *mut hfi1_devdata, addr: u32, result: *mut u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn read_8051_data(dd: *mut hfi1_devdata, addr: u32, len: u32, result: *mut u64) -> c_int {
...
// write
    ...
    let mut bytes: c_int = len - offset;
    if (bytes < 8) {
    reg = 0;
...
//
#[no_mangle]
unsafe extern "C" fn verify_css_header(dd: *mut hfi1_devdata, css: *mut css_header) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dispose_one_firmware(fdet: *mut firmware_details) {
    static void dispose_one_firmware(struct firmware_details *fdet)
    {
...
//
#[no_mangle]
unsafe extern "C" fn __obtain_firmware(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
unsafe extern "C" fn obtain_firmware(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dispose_firmware() {
...
//
#[no_mangle]
unsafe extern "C" fn retry_firmware(dd: *mut hfi1_devdata, load_result: c_int) -> c_int {
...
//
    ...
    {
    let mut qw_size: c_int = nbytes / 8;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn get_firmware_state(dd: *mut hfi1_devdata) -> u32 {
    static inline u32 get_firmware_state(struct hfi1_devdata *dd)
    {
    let mut reg: u64 = read_csr(dd, DC_DC8051_STS_CUR_STATE);
...
//
#[no_mangle]
pub unsafe extern "C" fn wait_fm_ready(dd: *mut hfi1_devdata, mstimeout: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn turn_off_spicos(dd: *mut hfi1_devdata, flags: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fabric_serdes_reset(dd: *mut hfi1_devdata) {
...
// A0 serdes do not work with a re-download
    let mut ra: u8 = fabric_serdes_broadcast[dd.hfi1_id];
...
// Wait for both DONE and RCV_DATA_VALID to go high
    ...
    let mut counts: u64 = read_csr(dd, ASIC_STS_SBUS_COUNTERS);
//
...
#[no_mangle]
pub unsafe extern "C" fn acquire_hw_mutex(dd: *mut hfi1_devdata) -> c_int {
    int acquire_hw_mutex(struct hfi1_devdata *dd)
    {
    unsigned long timeout;
    let mut try: c_int = 0;
    let mut mask: u8 = 1 << dd.hfi1_id;
    let mut user: u8 = (u8)read_csr(dd, ASIC_CFG_MUTEX);
    if (user == mask) {
    dd_dev_info(dd,
...
#[no_mangle]
pub unsafe extern "C" fn release_hw_mutex(dd: *mut hfi1_devdata) {
...
#[no_mangle]
pub unsafe extern "C" fn resource_mask(hfi1_id: u32, resource: u32) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn __acquire_chip_resource(dd: *mut hfi1_devdata, resource: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn acquire_chip_resource(dd: *mut hfi1_devdata, resource: u32, mswait: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn release_chip_resource(dd: *mut hfi1_devdata, resource: u32) {
...
#[no_mangle]
unsafe extern "C" fn clear_chip_resources(dd: *mut hfi1_devdata, func: *const c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn init_chip_resources(dd: *mut hfi1_devdata) {
...
#[no_mangle]
pub unsafe extern "C" fn finish_chip_resources(dd: *mut hfi1_devdata) {
...
#[no_mangle]
pub unsafe extern "C" fn set_sbus_fast_mode(dd: *mut hfi1_devdata) {
...
#[no_mangle]
pub unsafe extern "C" fn clear_sbus_fast_mode(dd: *mut hfi1_devdata) {
...
#[no_mangle]
pub unsafe extern "C" fn load_firmware(dd: *mut hfi1_devdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_firmware_init(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn check_meta_version(dd: *mut hfi1_devdata, system_table: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn parse_platform_config(dd: *mut hfi1_devdata) -> c_int {
    int parse_platform_config(struct hfi1_devdata *dd)
    {
    struct platform_config_cache *pcfgcache = &dd.pcfg_cache;
    struct hfi1_pportdata *ppd = dd.pport;
    u32 *ptr = core::ptr::null_mut();
    let mut header1: u32 = 0, header2 = 0, magic_num = 0, crc = 0, file_length = 0;
    let mut record_idx: u32 = 0, table_type = 0, table_length_dwords = 0;
...
// Jump the CRC DWORD
    ...
    let mut tx_preset: u32 = 0;
    switch (table_type) {
    case PLATFORM_CONFIG_SYSTEM_TABLE:
    if (field_index == SYSTEM_TABLE_QSFP_POWER_CLASS_MAX)
// data = ppd->max_power_class;
#[no_mangle]
pub unsafe extern "C" fn if(SYSTEM_TABLE_QSFP_ATTENUATION_DEFAULT_25G: field_index ==) -> else {
...
// data = ppd->port_type;
#[no_mangle]
pub unsafe extern "C" fn if(PORT_TABLE_LOCAL_ATTEN_25G: field_index ==) -> else {
    else if (field_index == PORT_TABLE_LOCAL_ATTEN_25G)
// data = ppd->local_atten;
#[no_mangle]
pub unsafe extern "C" fn if(PORT_TABLE_REMOTE_ATTEN_25G: field_index ==) -> else {
...
//
    ...
    u32 *data, u32 len)
    {
    let mut ret: c_int = 0, wlen = 0, seek = 0;
    let mut field_len_bits: u32 = 0, field_start_bits = 0, *src_ptr = core::ptr::null_mut();
    struct platform_config_cache *pcfgcache = &dd.pcfg_cache;
    struct hfi1_pportdata *ppd = dd.pport;
    if (data)
    memset(data, 0, len);
...
//
#[no_mangle]
pub unsafe extern "C" fn load_pcie_firmware(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn read_guid(dd: *mut hfi1_devdata) {
...
#[no_mangle]
unsafe extern "C" fn dump_fw_version(dd: *mut hfi1_devdata) {
    static void dump_fw_version(struct hfi1_devdata *dd)
    {
