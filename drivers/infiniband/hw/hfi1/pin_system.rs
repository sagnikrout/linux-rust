...
//! Source: drivers/infiniband/hw/hfi1/pin_system.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdma_mmu_node {
    pub rb: mmu_rb_node,
    pub pq: *mut hfi1_user_sdma_pkt_q,
    pub pages: *mut page,
    pub npages: c_uint,
}
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_init_system_pinning(pq: *mut hfi1_user_sdma_pkt_q) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_free_system_pinning(pq: *mut hfi1_user_sdma_pkt_q) {
...
#[no_mangle]
unsafe extern "C" fn sdma_cache_evict(pq: *mut hfi1_user_sdma_pkt_q, npages: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn free_system_node(node: *mut sdma_mmu_node) {
...
// node_p = node;
    ...
    {
    struct hfi1_user_sdma_pkt_q *pq = req.pq;
    let mut start: u64 = ALIGN_DOWN(req_start, PAGE_SIZE);
    let mut end: u64 = PFN_ALIGN(req_start + req_len);
    int ret;
    if ((end - start) == 0) {
    SDMA_DBG(req,
...
#[no_mangle]
unsafe extern "C" fn sdma_mmu_rb_node_get(ctx: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn sdma_mmu_rb_node_put(ctx: *mut c_void) {
...
//
    ...
    {
    let mut remaining_to_add: usize = *pkt_data_remaining;
//
...
#[no_mangle]
unsafe extern "C" fn sdma_rb_remove(arg: *mut c_void, mnode: *mut mmu_rb_node) {
    static void sdma_rb_remove(void *arg, struct mmu_rb_node *mnode)
    {
    struct sdma_mmu_node *node =
    container_of(mnode, struct sdma_mmu_node, rb);
