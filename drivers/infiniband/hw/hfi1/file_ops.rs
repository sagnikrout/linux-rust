...
//! Source: drivers/infiniband/hw/hfi1/file_ops.c
#![no_std]
...
//
pub const HFI1_MMAP_OFFSET_MASK: c_uint = 0xfffULL;
pub const HFI1_MMAP_OFFSET_SHIFT: c_int = 0;
pub const HFI1_MMAP_SUBCTXT_MASK: c_uint = 0xfULL;
pub const HFI1_MMAP_SUBCTXT_SHIFT: c_int = 12;
pub const HFI1_MMAP_CTXT_MASK: c_uint = 0xffULL;
pub const HFI1_MMAP_CTXT_SHIFT: c_int = 16;
pub const HFI1_MMAP_TYPE_MASK: c_uint = 0xfULL;
pub const HFI1_MMAP_TYPE_SHIFT: c_int = 24;
pub const HFI1_MMAP_MAGIC_MASK: c_uint = 0xffffffffULL;
pub const HFI1_MMAP_MAGIC_SHIFT: c_int = 32;
pub const HFI1_MMAP_MAGIC: c_uint = 0xdabbad00;
...
#[no_mangle]
pub unsafe extern "C" fn is_valid_mmap(token: u64) -> c_int {
    static inline int is_valid_mmap(u64 token)
    {
    return (HFI1_MMAP_TOKEN_GET(MAGIC, token) == HFI1_MMAP_MAGIC);
    }
#[no_mangle]
unsafe extern "C" fn hfi1_file_open(inode: *mut inode, fp: *mut file) -> c_int {
    static int hfi1_file_open(struct inode *inode, struct file *fp)
    {
...
#[no_mangle]
unsafe extern "C" fn hfi1_write_iter(kiocb: *mut kiocb, from: *mut iov_iter) -> isize {
    static ssize_t hfi1_write_iter(struct kiocb *kiocb, struct iov_iter *from)
    {
    struct hfi1_filedata *fd = kiocb.ki_filp.private_data;
    struct hfi1_user_sdma_pkt_q *pq;
    struct hfi1_user_sdma_comp_q *cq = fd.cq;
    let mut done: c_int = 0, reqs = 0;
    let mut dim: c_ulong = from.nr_segs;
    int idx;
...
#[no_mangle]
unsafe extern "C" fn hfi1_file_mmap(fp: *mut file, vma: *mut vm_area_struct) -> c_int {
    static int hfi1_file_mmap(struct file *fp, struct vm_area_struct *vma)
    {
    struct hfi1_filedata *fd = fp.private_data;
    struct hfi1_ctxtdata *uctxt = fd.uctxt;
    ...
    memaddr = 0;
    void *memvirt = core::ptr::null_mut();
    let mut memdma: dma_addr_t = 0;
    u8 subctxt, mapio = 0, vmf = 0, type;
    let mut memlen: isize = 0;
    let mut ret: c_int = 0;
    u16 ctxt;
...
//
#[no_mangle]
unsafe extern "C" fn vma_fault(vmf: *mut vm_fault) -> vm_fault_t {
    static vm_fault_t vma_fault(struct vm_fault *vmf)
    {
    struct page *page;
...
#[no_mangle]
unsafe extern "C" fn hfi1_poll(fp: *mut file, pt: *mut poll_table_struct) -> __poll_t {
    static __poll_t hfi1_poll(struct file *fp, struct poll_table_struct *pt)
    {
    struct hfi1_ctxtdata *uctxt;
    __poll_t pollflag;
    ...
    pollflag = EPOLLERR;
#[no_mangle]
pub unsafe extern "C" fn if(HFI1_POLL_TYPE_URGENT: uctxt->poll_type ==) -> else {
    else if (uctxt.poll_type == HFI1_POLL_TYPE_URGENT)
    pollflag = poll_urgent(fp, pt);
#[no_mangle]
pub unsafe extern "C" fn if(HFI1_POLL_TYPE_ANYRCV: uctxt->poll_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn hfi1_file_close(inode: *mut inode, fp: *mut file) -> c_int {
    static int hfi1_file_close(struct inode *inode, struct file *fp)
    {
...
//
#[no_mangle]
unsafe extern "C" fn kvirt_to_phys(addr: *mut c_void) -> u64 {
    static u64 kvirt_to_phys(void *addr)
    {
    struct page *page;
    let mut paddr: u64 = 0;
...
//
#[no_mangle]
unsafe extern "C" fn complete_subctxt(fd: *mut hfi1_filedata) -> c_int {
...
// Finish the sub-context init
    ...
    fd.uctxt = core::ptr::null_mut();
    }
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn assign_ctxt(fd: *mut hfi1_filedata, arg: c_ulong, len: u32) -> c_int {
    static int assign_ctxt(struct hfi1_filedata *fd, unsigned long arg, u32 len)
    {
    int ret;
    unsigned int swmajor;
    struct hfi1_ctxtdata *uctxt = core::ptr::null_mut();
    struct hfi1_user_info uinfo;
    if (fd.uctxt)
    return -EINVAL;
    if (sizeof(uinfo) != len)
...
#[no_mangle]
unsafe extern "C" fn deallocate_ctxt(uctxt: *mut hfi1_ctxtdata) {
    static void deallocate_ctxt(struct hfi1_ctxtdata *uctxt)
    {
    mutex_lock(&hfi1_mutex);
    hfi1_stats.sps_ctxts--;
...
#[no_mangle]
unsafe extern "C" fn setup_subctxt(uctxt: *mut hfi1_ctxtdata) -> c_int {
    static int setup_subctxt(struct hfi1_ctxtdata *uctxt)
    {
    let mut ret: c_int = 0;
    let mut num_subctxts: u16 = uctxt.subctxt_cnt;
...
// We can take the size of the RcvHdr Queue from the master
    ...
    uctxt.subctxt_rcvhdr_base = core::ptr::null_mut();
    bail_ureg:
    vfree(uctxt.subctxt_uregbase);
    uctxt.subctxt_uregbase = core::ptr::null_mut();
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn user_init(uctxt: *mut hfi1_ctxtdata) {
    static void user_init(struct hfi1_ctxtdata *uctxt)
    {
    let mut rcvctrl_ops: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn get_ctxt_info(fd: *mut hfi1_filedata, arg: c_ulong, len: u32) -> c_int {
    static int get_ctxt_info(struct hfi1_filedata *fd, unsigned long arg, u32 len)
    {
...
#[no_mangle]
unsafe extern "C" fn get_base_info(fd: *mut hfi1_filedata, arg: c_ulong, len: u32) -> c_int {
    static int get_base_info(struct hfi1_filedata *fd, unsigned long arg, u32 len)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_set_uevent_bits(ppd: *mut hfi1_pportdata, evtbit: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_ctxt_pkey(uctxt: *mut hfi1_ctxtdata, arg: c_ulong) -> c_int {
    static int set_ctxt_pkey(struct hfi1_ctxtdata *uctxt, unsigned long arg)
    {
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn ctxt_reset(uctxt: *mut hfi1_ctxtdata) -> c_int {
    static int ctxt_reset(struct hfi1_ctxtdata *uctxt)
    {
...
#[no_mangle]
unsafe extern "C" fn user_remove(dd: *mut hfi1_devdata) {
    static void user_remove(struct hfi1_devdata *dd)
    {
    hfi1_cdev_cleanup(&dd.user_cdev, &dd.user_device);
    }
#[no_mangle]
unsafe extern "C" fn user_add(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_device_create(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_device_remove(dd: *mut hfi1_devdata) {
