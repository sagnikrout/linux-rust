...
//! Source: drivers/infiniband/hw/hfi1/pio_copy.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn jcopy(dest: *mut u8, src: *const u8, n: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn carry8_write8(carry: union mix, dest: *mut void __iomem) {
...
//
#[no_mangle]
pub unsafe extern "C" fn carry_write8(pbuf: *mut pio_buf, dest: *mut void __iomem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mid_copy_mix(pbuf: *mut pio_buf, from: *const c_void, nbytes: usize) {
    static void mid_copy_mix(struct pio_buf *pbuf, const void *from, size_t nbytes)
    {
    void __iomem *dest = pbuf.start + (pbuf.qw_written * sizeof(u64));
    void __iomem *dend;			/* 8-byte data end */
    let mut qw_to_write: c_ulong = nbytes >> 3;
    let mut bytes_left: c_ulong = nbytes & 0x7;
...
#[no_mangle]
pub unsafe extern "C" fn if(PIO_BLOCK_QWS: pbuf->qw_written <) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn seg_pio_copy_mid(pbuf: *mut pio_buf, from: *const c_void, nbytes: usize) {
    void seg_pio_copy_mid(struct pio_buf *pbuf, const void *from, size_t nbytes)
    {
    let mut from_align: c_ulong = (unsigned long)from & 0x7;
...
// bytes to fill carry
    let mut to_fill: c_ulong = 8 - pbuf.carry_bytes;
// bytes left over to be read
    let mut extra: c_ulong = to_align - to_fill;
    void __iomem *dest;
// fill carry...
...
//
#[no_mangle]
pub unsafe extern "C" fn seg_pio_copy_end(pbuf: *mut pio_buf) {
