...
//! Source: drivers/infiniband/hw/hfi1/intr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn set_mgmt_allowed(ppd: *mut hfi1_pportdata) {
...
//
#[no_mangle]
unsafe extern "C" fn add_full_mgmt_pkey(ppd: *mut hfi1_pportdata) {
...
#[no_mangle]
unsafe extern "C" fn signal_ib_event(ppd: *mut hfi1_pportdata, ev: enum ib_event_type) {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_linkup_change(dd: *mut hfi1_devdata, linkup: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_user_interrupt(rcd: *mut hfi1_ctxtdata) {
