...
//! Source: drivers/infiniband/hw/hfi1/driver.c
#![no_std]
...
//
    ...
    let mut hfi1_max_mtu: c_uint = HFI1_DEFAULT_MAX_MTU;
    module_param_named(max_mtu, hfi1_max_mtu, uint, S_IRUGO);
    MODULE_PARM_DESC(max_mtu, "Set max MTU bytes, default is " __stringify(
    HFI1_DEFAULT_MAX_MTU));
    let mut hfi1_cu: c_uint = 1;
    module_param_named(cu, hfi1_cu, uint, S_IRUGO);
    MODULE_PARM_DESC(cu, "Credit return units");
    let mut hfi1_cap_mask: c_ulong = HFI1_CAP_MASK_DEFAULT;
...
//
pub const MAX_PKT_RECV: c_int = 64;
//
// MAX_PKT_THREAD_RCV is the max # of packets processed before
// the qp_wait_list queue is flushed.
//

pub const EGR_HEAD_UPDATE_THRESHOLD: c_int = 16;
    struct hfi1_ib_stats hfi1_stats;
#[no_mangle]
unsafe extern "C" fn hfi1_caps_set(val: *const c_char, kp: *const kernel_param) -> c_int {
    static int hfi1_caps_set(const char *val, const struct kernel_param *kp)
    {
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn hfi1_caps_get(buffer: *mut c_char, kp: *const kernel_param) -> c_int {
    static int hfi1_caps_get(char *buffer, const struct kernel_param *kp)
    {
    let mut cap_mask: c_ulong = *(unsigned long *)kp.arg;
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_count_active_units() -> c_int {
...
//
    ...
    u8 *update)
    {
    let mut idx: u32 = rhf_egr_index(rhf), offset = rhf_egr_buf_offset(rhf);
// update |= !(idx & (rcd->egrbufs.threshold - 1)) && !offset;
    ...
    __le32 *rhf_addr)
    {
    let mut offset: u32 = rhf_hdrq_offset(rhf_to_cpu(rhf_addr));
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_rcvbuf_validate(size: u32, type: u8, encoded: *mut u16) -> c_int {
...
// encoded = ilog2(size / PAGE_SIZE) + 1;
    ...
    let mut rte: u32 = rhf_rcv_type_err(packet.rhf);
    u32 mlid_base;
    ...
    let mut lnh: u8 = ib_get_lnh(rhdr);
...
// For TIDERR and RC QPs preemptively schedule a NAK
    ...
    let mut dlid: u32 = ib_get_dlid(rhdr);
    u32 qp_num;
// Sanity check packet
    if (tlen < 24)
    goto drop;
...
// via this code path.
//
    struct rvt_qp *qp = core::ptr::null_mut();
    u32 lqpn, rqpn;
    u16 rlid;
    u8 svc_type, sl, sc5;
...
// Call appropriate CNP handler
    ...
    dlid, rlid, sc, grh);
    if (becn) {
    let mut lqpn: u32 = be32_to_cpu(ohdr.bth[1]) & RVT_QPN_MASK;
    let mut sl: u8 = ibp.sc_to_sl[sc];
    process_becn(ppd, sl, rlid, lqpn, rqpn, svc_type);
    }
...
#[no_mangle]
unsafe extern "C" fn __prescan_rxq(packet: *mut hfi1_packet) {
    ...
    let mut rhf: u64 = rhf_to_cpu(rhf_addr);
    let mut etype: u32 = rhf_rcv_type(rhf), qpn, bth1;
    u8 lnh;
...
#[no_mangle]
unsafe extern "C" fn process_rcv_qp_work(packet: *mut hfi1_packet) {
...
#[no_mangle]
unsafe extern "C" fn max_packet_exceeded(packet: *mut hfi1_packet, thread: c_int) -> noinline int {
...
#[no_mangle]
pub unsafe extern "C" fn check_max_packet(packet: *mut hfi1_packet, thread: c_int) -> c_int {
    static inline int check_max_packet(struct hfi1_packet *packet, int thread)
    {
    let mut ret: c_int = RCV_PKT_OK;
    if (unlikely((packet.numpkt & (MAX_PKT_RECV - 1)) == 0))
    ret = max_packet_exceeded(packet, thread);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn skip_rcv_packet(packet: *mut hfi1_packet, thread: c_int) -> noinline int {
...
#[no_mangle]
unsafe extern "C" fn process_rcv_packet_napi(packet: *mut hfi1_packet) {
...
#[no_mangle]
pub unsafe extern "C" fn process_rcv_packet(packet: *mut hfi1_packet, thread: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn process_rcv_update(last: c_int, packet: *mut hfi1_packet) {
...
#[no_mangle]
pub unsafe extern "C" fn finish_packet(packet: *mut hfi1_packet) {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_receive_interrupt_napi_fp(rcd: *mut hfi1_ctxtdata, budget: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_receive_interrupt_nodma_rtail(rcd: *mut hfi1_ctxtdata, thread: c_int) -> c_int {
    int handle_receive_interrupt_nodma_rtail(struct hfi1_ctxtdata *rcd, int thread)
    {
    let mut last: c_int = RCV_PKT_OK;
    struct hfi1_packet packet;
    init_packet(rcd, &packet);
    if (last_rcv_seq(rcd, rhf_rcv_seq(packet.rhf))) {
    last = RCV_PKT_DONE;
...
#[no_mangle]
pub unsafe extern "C" fn handle_receive_interrupt_dma_rtail(rcd: *mut hfi1_ctxtdata, thread: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_all_fastpath(dd: *mut hfi1_devdata, rcd: *mut hfi1_ctxtdata) {
...
#[no_mangle]
pub unsafe extern "C" fn set_all_slowpath(dd: *mut hfi1_devdata) {
...
#[no_mangle]
unsafe extern "C" fn __set_armed_to_active(packet: *mut hfi1_packet) -> bool {
    static bool __set_armed_to_active(struct hfi1_packet *packet)
    {
    let mut etype: u8 = rhf_rcv_type(packet.rhf);
    let mut sc: u8 = SC15_PACKET;
    if (etype == RHF_RCV_TYPE_IB) {
    ...
    if (sc != SC15_PACKET) {
    let mut hwstate: c_int = driver_lstate(packet.rcd.ppd);
...
//
#[no_mangle]
unsafe extern "C" fn set_armed_to_active(packet: *mut hfi1_packet) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_receive_interrupt(rcd: *mut hfi1_ctxtdata, thread: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn handle_receive_interrupt_napi_sp(rcd: *mut hfi1_ctxtdata, budget: c_int) -> c_int {
    int handle_receive_interrupt_napi_sp(struct hfi1_ctxtdata *rcd, int budget)
    {
    struct hfi1_devdata *dd = rcd.dd;
    let mut last: c_int = RCV_PKT_OK;
    let mut needset: bool = true;
    struct hfi1_packet packet;
    init_packet(rcd, &packet);
    if (last_rcv_seq(rcd, rhf_rcv_seq(packet.rhf)))
    goto bail;
...
//
#[no_mangle]
pub unsafe extern "C" fn receive_interrupt_work(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mtu_to_enum(mtu: u32, default_if_bad: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn enum_to_mtu(mtu: c_int) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_mtu(ppd: *mut hfi1_pportdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_set_lid(ppd: *mut hfi1_pportdata, lid: u32, lmc: u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn shutdown_led_override(ppd: *mut hfi1_pportdata) {
...
#[no_mangle]
unsafe extern "C" fn run_led_override(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_reset_device(unit: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_setup_ib_header(packet: *mut hfi1_packet) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_bypass_ingress_pkt_check(packet: *mut hfi1_packet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfi1_setup_9B_packet(packet: *mut hfi1_packet) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hfi1_setup_bypass_packet(packet: *mut hfi1_packet) -> c_int {
...
// hdr_len_by_opcode already has an IB LRH factored in
    ...
    u32 vtf;
    let mut grh_len: u8 = sizeof(struct ib_grh);
...
#[no_mangle]
unsafe extern "C" fn show_eflags_errs(packet: *mut hfi1_packet) {
...
#[no_mangle]
pub unsafe extern "C" fn handle_eflags(packet: *mut hfi1_packet) {
...
#[no_mangle]
unsafe extern "C" fn hfi1_ipoib_ib_rcv(packet: *mut hfi1_packet) {
...
//
#[no_mangle]
unsafe extern "C" fn process_receive_ib(packet: *mut hfi1_packet) {
...
#[no_mangle]
unsafe extern "C" fn process_receive_bypass(packet: *mut hfi1_packet) {
...
#[no_mangle]
unsafe extern "C" fn process_receive_error(packet: *mut hfi1_packet) {
...
#[no_mangle]
unsafe extern "C" fn kdeth_process_expected(packet: *mut hfi1_packet) {
...
#[no_mangle]
unsafe extern "C" fn kdeth_process_eager(packet: *mut hfi1_packet) {
...
#[no_mangle]
unsafe extern "C" fn process_receive_invalid(packet: *mut hfi1_packet) {
    static void process_receive_invalid(struct hfi1_packet *packet)
    {
    dd_dev_err(packet.rcd.dd, "Invalid packet type %d. Dropping\n",
    rhf_rcv_type(packet.rhf));
    }
pub const HFI1_RCVHDR_DUMP_MAX: c_int = 5;
#[no_mangle]
pub unsafe extern "C" fn seqfile_dump_rcd(s: *mut seq_file, rcd: *mut hfi1_ctxtdata) {
    ...
    struct ib_header *hdr;
    let mut rhf: u64 = rhf_to_cpu(rhf_addr);
    let mut etype: u32 = rhf_rcv_type(rhf), qpn;
    u8 opcode;
    u32 psn;
    u8 lnh;
    if (ps_done(&mdata, rhf, rcd))
    ...
    packet.ohdr = &hdr.u.oth;
#[no_mangle]
pub unsafe extern "C" fn if(HFI1_LRH_GRH: lnh ==) -> else {
    else if (lnh == HFI1_LRH_GRH)
    packet.ohdr = &hdr.u.l.oth;
    else
    goto next; /* just in case */
