...
//! Source: drivers/infiniband/hw/hfi1/netdev_rx.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hfi1_netdev_rxq_init(rx: *mut hfi1_netdev_rx) -> c_int {
...
//
    ...
    rxq.rcd = core::ptr::null_mut();
    }
    }
    kfree(rx.rxq);
    rx.rxq = core::ptr::null_mut();
    return rc;
    }
#[no_mangle]
unsafe extern "C" fn hfi1_netdev_rxq_deinit(rx: *mut hfi1_netdev_rx) {
...
#[no_mangle]
unsafe extern "C" fn enable_queues(rx: *mut hfi1_netdev_rx) {
...
#[no_mangle]
unsafe extern "C" fn disable_queues(rx: *mut hfi1_netdev_rx) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_netdev_rx_init(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_netdev_rx_destroy(dd: *mut hfi1_devdata) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_alloc_rx(dd: *mut hfi1_devdata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_free_rx(dd: *mut hfi1_devdata) {
    ...
    kfree(dd.netdev_rx);
    dd.netdev_rx = core::ptr::null_mut();
    }
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_netdev_enable_queues(dd: *mut hfi1_devdata) {
...
#[no_mangle]
pub unsafe extern "C" fn hfi1_netdev_disable_queues(dd: *mut hfi1_devdata) {
...
//
#[no_mangle]
pub unsafe extern "C" fn hfi1_netdev_add_data(dd: *mut hfi1_devdata, id: c_int, data: *mut c_void) -> c_int {
...
//
    ...
    {
    struct hfi1_netdev_rx *rx = dd.netdev_rx;
    let mut index: c_ulong = *start_id;
    void *ret;
