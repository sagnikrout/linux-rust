...
//! Source: drivers/infiniband/hw/hns/hns_roce_srq.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hns_roce_srq_event(hr_dev: *mut hns_roce_dev, srqn: u32, event_type: c_int) {
...
#[no_mangle]
unsafe extern "C" fn alloc_srqn(hr_dev: *mut hns_roce_dev, srq: *mut hns_roce_srq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_srqn(hr_dev: *mut hns_roce_dev, srq: *mut hns_roce_srq) {
...
#[no_mangle]
unsafe extern "C" fn alloc_srqc(hr_dev: *mut hns_roce_dev, srq: *mut hns_roce_srq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_srqc(hr_dev: *mut hns_roce_dev, srq: *mut hns_roce_srq) {
...
#[no_mangle]
unsafe extern "C" fn free_srq_idx(hr_dev: *mut hns_roce_dev, srq: *mut hns_roce_srq) {
    static void free_srq_idx(struct hns_roce_dev *hr_dev, struct hns_roce_srq *srq)
    {
    struct hns_roce_idx_que *idx_que = &srq.idx_que;
    bitmap_free(idx_que.bitmap);
    idx_que.bitmap = core::ptr::null_mut();
    hns_roce_mtr_destroy(hr_dev, &idx_que.mtr);
    }
...
#[no_mangle]
unsafe extern "C" fn alloc_srq_wrid(srq: *mut hns_roce_srq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn free_srq_wrid(srq: *mut hns_roce_srq) {
    static void free_srq_wrid(struct hns_roce_srq *srq)
    {
    kvfree(srq.wrid);
    srq.wrid = core::ptr::null_mut();
    }
    static u32 proc_srq_sge(struct hns_roce_dev *dev, struct hns_roce_srq *hr_srq,
    bool user)
    {
    let mut max_sge: u32 = dev.caps.max_srq_sges;
...
#[no_mangle]
unsafe extern "C" fn free_srq_buf(hr_dev: *mut hns_roce_dev, srq: *mut hns_roce_srq) {
...
// srq->rdb.db_record = 0;
    ...
    let mut resp: hns_roce_ib_create_srq_resp = {};
    struct hns_roce_srq *srq = to_hr_srq(ib_srq);
    let mut ucmd: hns_roce_ib_create_srq = {};
    int ret;
...
#[no_mangle]
pub unsafe extern "C" fn hns_roce_destroy_srq(ibsrq: *mut ib_srq, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn hns_roce_init_srq_table(hr_dev: *mut hns_roce_dev) {
