...
//! Source: drivers/infiniband/hw/irdma/utils.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_add_arp(rf: *mut irdma_pci_f, ip: *mut u32, ipv4: bool, mac: *const u8) -> c_int {
    int irdma_add_arp(struct irdma_pci_f *rf, u32 *ip, bool ipv4, const u8 *mac)
    {
    int arpidx;
    arpidx = irdma_arp_table(rf, &ip[0], ipv4, core::ptr::null_mut(), IRDMA_ARP_RESOLVE);
    if (arpidx >= 0) {
    ...
    return irdma_arp_table(rf, ip, ipv4, core::ptr::null_mut(), IRDMA_ARP_RESOLVE);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn wr32(hw: *mut irdma_hw, reg: u32, val: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rd32(hw: *mut irdma_hw, reg: u32) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn rd64(hw: *mut irdma_hw, reg: u32) -> u64 {
    inline u64 rd64(struct irdma_hw *hw, u32 reg)
    {
    return readq(hw.hw_addr + reg);
    }
#[no_mangle]
unsafe extern "C" fn irdma_gid_change_event(ibdev: *mut ib_device) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_add_ipv6_addr(iwdev: *mut irdma_device) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_add_ipv4_addr(iwdev: *mut irdma_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_add_ip(iwdev: *mut irdma_device) {
...
//
    ...
    bool wait)
    {
    struct irdma_cqp_request *cqp_request = core::ptr::null_mut();
    unsigned long flags;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_get_cqp_request(cqp_request: *mut irdma_cqp_request) {
...
//
    ...
    cqp_request.callback_fcn = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cleanup_pending_cqp_op(rf: *mut irdma_pci_f) {
    void irdma_cleanup_pending_cqp_op(struct irdma_pci_f *rf)
    {
    struct irdma_sc_dev *dev = &rf.sc_dev;
    struct irdma_cqp *cqp = &rf.cqp;
    struct irdma_cqp_request *cqp_request = core::ptr::null_mut();
    struct cqp_cmds_info *pcmdinfo = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn irdma_get_timeout_threshold(dev: *mut irdma_sc_dev) -> c_int {
    int irdma_get_timeout_threshold(struct irdma_sc_dev *dev)
    {
    let mut time_s: u16 = dev.vc_caps.cqp_timeout_s;
    if (!time_s)
    return CQP_TIMEOUT_THRESHOLD;
    return time_s * 1000 / dev.hw_attrs.max_cqp_compl_wait_time_ms;
    }
#[no_mangle]
unsafe extern "C" fn irdma_get_def_timeout_threshold(dev: *mut irdma_sc_dev) -> c_int {
    static int irdma_get_def_timeout_threshold(struct irdma_sc_dev *dev)
    {
    let mut time_s: u16 = dev.vc_caps.cqp_def_timeout_s;
    if (!time_s)
...
//
    ...
    struct irdma_cqp_request *cqp_request)
    {
    let mut cqp_timeout: irdma_cqp_timeout = {};
    let mut timeout_threshold: c_int = irdma_get_timeout_threshold(&rf.sc_dev);
    let mut cqp_error: bool = false;
...
//
    ...
    err_code = -EBUSY;
#[no_mangle]
pub unsafe extern "C" fn if(0x8029: cqp_request->compl_info.min_err_code ==) -> else {
    if (!rf.reset) {
    rf.reset = true;
    rf.gen_ops.request_reset(rf);
    }
...
//
    ...
    int status;
    let mut put_cqp_request: bool = true;
    if (rf.reset)
    return -EBUSY;
...
#[no_mangle]
pub unsafe extern "C" fn irdma_qp_add_ref(ibqp: *mut ib_qp) {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_qp_rem_ref(ibqp: *mut ib_qp) {
    ...
    iwdev.rf.qp_table[qp_num] = core::ptr::null_mut();
    spin_unlock_irqrestore(&iwdev.rf.qptable_lock, flags);
    complete(&iwqp.free_qp);
    }
#[no_mangle]
pub unsafe extern "C" fn irdma_cq_add_ref(ibcq: *mut ib_cq) {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_cq_rem_ref(ibcq: *mut ib_cq) {
...
// May be asynchronously sampled by CEQ ISR without holding tbl lock.
    WRITE_ONCE(iwdev.rf.cq_table[iwcq.cq_num], core::ptr::null_mut());
    spin_unlock_irqrestore(&iwdev.rf.cqtable_lock, flags);
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cqp_qp_suspend_resume(qp: *mut irdma_sc_qp, op: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_terminate_done(qp: *mut irdma_sc_qp, timeout_occurred: c_int) {
...
#[no_mangle]
unsafe extern "C" fn irdma_terminate_timeout(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_terminate_start_timer(qp: *mut irdma_sc_qp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_terminate_del_timer(qp: *mut irdma_sc_qp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cqp_cq_create_cmd(dev: *mut irdma_sc_dev, cq: *mut irdma_sc_cq) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cqp_qp_create_cmd(dev: *mut irdma_sc_dev, qp: *mut irdma_sc_qp) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irdma_free_gsi_qp_rsrc(iwqp: *mut irdma_qp, qp_num: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_free_qp_rsrc(iwqp: *mut irdma_qp) {
    void irdma_free_qp_rsrc(struct irdma_qp *iwqp)
    {
    struct irdma_device *iwdev = iwqp.iwdev;
    struct irdma_pci_f *rf = iwdev.rf;
    let mut qp_num: u32 = iwqp.sc_qp.qp_uk.qp_id;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_srq_wq_destroy(rf: *mut irdma_pci_f, srq: *mut irdma_sc_srq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cq_wq_destroy(rf: *mut irdma_pci_f, cq: *mut irdma_sc_cq) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_hw_modify_qp_callback(cqp_request: *mut irdma_cqp_request) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cqp_cq_destroy_cmd(dev: *mut irdma_sc_dev, cq: *mut irdma_sc_cq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cqp_qp_destroy_cmd(dev: *mut irdma_sc_dev, qp: *mut irdma_sc_qp) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_ieq_mpa_crc_ae(dev: *mut irdma_sc_dev, qp: *mut irdma_sc_qp) {
    void irdma_ieq_mpa_crc_ae(struct irdma_sc_dev *dev, struct irdma_sc_qp *qp)
    {
    let mut info: irdma_gen_ae_info = {};
    struct irdma_pci_f *rf = dev_to_rf(dev);
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_ieq_check_mpacrc(addr: *const c_void, len: u32, val: u32) -> c_int {
    int irdma_ieq_check_mpacrc(const void *addr, u32 len, u32 val)
    {
    if (( u32)cpu_to_le32(~crc32c(~0, addr, len)) != val)
    return -EINVAL;
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_send_ieq_ack(qp: *mut irdma_sc_qp) {
...
//
    ...
    ah_info.ipv4_valid,
    core::ptr::null_mut(), IRDMA_ARP_RESOLVE);
    }
//
...
//
    ...
    buf.data = buf.datalen ? buf.tcph + buf.tcphlen : core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn irdma_hw_stats_timeout(t: *mut timer_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_hw_stats_start_timer(vsi: *mut irdma_sc_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_hw_stats_stop_timer(vsi: *mut irdma_sc_vsi) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_process_stats(pestat: *mut irdma_vsi_pestat) {
...
//
    ...
    let mut max_stats_idx: u16 = dev.hw_attrs.max_stat_idx;
...
//
#[no_mangle]
unsafe extern "C" fn irdma_process_cqp_stats(cqp_request: *mut irdma_cqp_request) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_ieq_ah_cb(cqp_request: *mut irdma_cqp_request) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_ilq_ah_cb(cqp_request: *mut irdma_cqp_request) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_puda_free_ah(dev: *mut irdma_sc_dev, ah: *mut irdma_sc_ah) {
    ...
    irdma_ah_cqp_op(rf, ah, IRDMA_OP_AH_DESTROY, false, core::ptr::null_mut(), core::ptr::null_mut());
    irdma_free_rsrc(rf, rf.allocated_ahs, ah.ah_info.ah_idx);
    }
    kfree(ah);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_gsi_ud_qp_ah_cb(cqp_request: *mut irdma_cqp_request) {
...
//
    ...
    {
    u64 bits_needed;
    let mut bit_idx: u64 = PBLE_INVALID_IDX;
    struct irdma_chunk *pchunk = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn irdma_unmap_vm_page_list(hw: *mut irdma_hw, pg_dma: *mut dma_addr_t, pg_cnt: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_pble_free_paged_mem(chunk: *mut irdma_chunk) {
    ...
    chunk.dmainfo.dmaaddrs = core::ptr::null_mut();
    vfree(chunk.vaddr);
    chunk.vaddr = core::ptr::null_mut();
    chunk.type = 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_pble_get_paged_mem(chunk: *mut irdma_chunk, pg_cnt: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_alloc_ws_node_id(dev: *mut irdma_sc_dev) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_free_ws_node_id(dev: *mut irdma_sc_dev, node_id: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_modify_qp_to_err(sc_qp: *mut irdma_sc_qp) {
    ...
    irdma_modify_qp_roce(&qp.ibqp, &attr, IB_QP_STATE, core::ptr::null_mut());
    else
    irdma_modify_qp(&qp.ibqp, &attr, IB_QP_STATE, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn irdma_ib_qp_event(iwqp: *mut irdma_qp, event: enum irdma_qp_event_type) {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_remove_cmpls_list(iwcq: *mut irdma_cq) {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_generated_cmpls(iwcq: *mut irdma_cq, cq_poll_info: *mut irdma_cq_poll_info) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_comp_handler(cq: *mut irdma_cq) {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_generate_flush_completions(iwqp: *mut irdma_qp) {
    ...
    u64 wqe_qword;
    u32 wqe_idx;
    let mut compl_generated: bool = false;
