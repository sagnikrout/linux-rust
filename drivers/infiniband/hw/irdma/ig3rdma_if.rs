...
//! Source: drivers/infiniband/hw/irdma/ig3rdma_if.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ig3rdma_request_reset(rf: *mut irdma_pci_f) {
...
#[no_mangle]
unsafe extern "C" fn ig3rdma_decfg_rf(rf: *mut irdma_pci_f) {
...
#[no_mangle]
unsafe extern "C" fn ig3rdma_core_remove(aux_dev: *mut auxiliary_device) {
