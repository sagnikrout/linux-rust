...
//! Source: drivers/infiniband/hw/irdma/ctrl.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_suspend_resume_qps(vsi: *mut irdma_sc_vsi, op: u8) {
    void irdma_sc_suspend_resume_qps(struct irdma_sc_vsi *vsi, u8 op)
    {
    struct irdma_sc_qp *qp = core::ptr::null_mut();
    u8 i;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_qp_rem_qos(qp: *mut irdma_sc_qp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_qp_add_qos(qp: *mut irdma_sc_qp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_qp_init(qp: *mut irdma_sc_qp, info: *mut irdma_qp_init_info) -> c_int {
...
//
    ...
    struct irdma_sc_cqp *cqp;
    u64 hdr;
    let mut term_actions: u8 = 0;
    let mut term_len: u8 = 0;
    cqp = qp.dev.cqp;
    wqe = irdma_sc_cqp_get_next_send_wqe(cqp, scratch);
    if (!wqe)
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn irdma_sc_get_encoded_ird_size(ird_size: u16) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_sc_get_encoded_ird_size_gen_3(ird_size: u16) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn if(0x200000: info->page_size ==) -> else {
...
pub unsafe extern "C" fn if(0x200000: info->page_size ==) -> else {
    ...
    page_size = IRDMA_PAGE_SIZE_2M;
#[no_mangle]
pub unsafe extern "C" fn if(0x1000: info->page_size ==) -> else {
...
//
    ...
    u32 wqe_idx;
    enum irdma_page_size page_size;
    let mut sq_info: irdma_post_sq_info = {};
    if (info.page_size == 0x40000000)
    page_size = IRDMA_PAGE_SIZE_1G;
#[no_mangle]
pub unsafe extern "C" fn if(0x200000: info->page_size ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_sc_gen_rts_ae(qp: *mut irdma_sc_qp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_send_rtt(qp: *mut irdma_sc_qp, read: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_iwarp_opcode(info: *mut irdma_aeqe_info, pkt: *mut u8) -> u32 {
    static u32 irdma_iwarp_opcode(struct irdma_aeqe_info *info, u8 *pkt)
    {
    __be16 *mpa;
    let mut opcode: u32 = 0xffffffff;
...
//
    ...
    let mut copy_len: c_int = 0;
    let mut is_tagged: u8 = 0;
    u32 opcode;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_terminate_send_fin(qp: *mut irdma_sc_qp) {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: (ddp_ctl & 0x03) !=) -> else {
    else if ((ddp_ctl & 0x03) != 1)
    aeq_id = IRDMA_AE_DDP_UBE_INVALID_DDP_VERSION;
#[no_mangle]
pub unsafe extern "C" fn if(2: ntohl(mpa[2]) !=) -> else {
    else if (ntohl(mpa[2]) != 2)
    aeq_id = IRDMA_AE_DDP_UBE_INVALID_QN;
#[no_mangle]
pub unsafe extern "C" fn if(1: ntohl(mpa[3]) !=) -> else {
    else if (ntohl(mpa[3]) != 1)
    aeq_id = IRDMA_AE_DDP_INVALID_MSN_GAP_IN_MSN;
#[no_mangle]
pub unsafe extern "C" fn if(0: ntohl(mpa[4]) !=) -> else {
    else if (ntohl(mpa[4]) != 0)
    aeq_id = IRDMA_AE_DDP_UBE_INVALID_MO;
#[no_mangle]
pub unsafe extern "C" fn if(0x40: (rdma_ctl & 0xc0) !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn irdma_null_ws_add(vsi: *mut irdma_sc_vsi, user_pri: u8) -> c_int {
    static int irdma_null_ws_add(struct irdma_sc_vsi *vsi, u8 user_pri)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn irdma_null_ws_remove(vsi: *mut irdma_sc_vsi, user_pri: u8) {
    static void irdma_null_ws_remove(struct irdma_sc_vsi *vsi, u8 user_pri)
    {
// do nothing
    }
#[no_mangle]
unsafe extern "C" fn irdma_null_ws_reset(vsi: *mut irdma_sc_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_get_stats_idx(vsi: *mut irdma_sc_vsi) -> u16 {
    static u16 irdma_get_stats_idx(struct irdma_sc_vsi *vsi)
    {
    let mut stats_info: irdma_stats_inst_info = {};
...
//
#[no_mangle]
unsafe extern "C" fn irdma_hw_stats_init_gen1(vsi: *mut irdma_sc_vsi) {
...
// when stat allocation is not required default to fcn_id.
    ...
    let mut stats_idx: u16 = irdma_get_stats_idx(vsi);
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_vsi_stats_free(vsi: *mut irdma_sc_vsi) {
    void irdma_vsi_stats_free(struct irdma_sc_vsi *vsi)
    {
    let mut stats_info: irdma_stats_inst_info = {};
    struct irdma_sc_dev *dev = vsi.dev;
    let mut stats_idx: u16 = vsi.stats_idx;
    if (dev.hw_attrs.uk_attrs.hw_rev >= IRDMA_GEN_2) {
    ...
    vsi.pestat.gather_info.stats_buff_mem.va = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_get_encoded_wqe_size(wqsize: u32, queue_type: enum irdma_queue_type) -> u8 {
    u8 irdma_get_encoded_wqe_size(u32 wqsize, enum irdma_queue_type queue_type)
    {
    let mut encoded_size: u8 = 0;
...
//
    ...
    struct irdma_sc_cqp *cqp;
    u64 hdr;
    let mut flush_sq: bool = false, flush_rq = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cq_init(cq: *mut irdma_sc_cq, info: *mut irdma_cq_init_info) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cq_destroy(cq: *mut irdma_sc_cq, scratch: u64, post_sq: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cq_resize(cq: *mut irdma_sc_cq, info: *mut irdma_modify_cq_info) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_sc_get_decoded_ird_size_gen_3(ird_enc: u8) -> u16 {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_check_cqp_progress(timeout: *mut irdma_cqp_timeout, dev: *mut irdma_sc_dev) {
    void irdma_check_cqp_progress(struct irdma_cqp_timeout *timeout, struct irdma_sc_dev *dev)
    {
    let mut completed_ops: u64 = atomic64_read(&dev.cqp.completed_ops);
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cqp_cleanup_handler(dev: *mut irdma_sc_dev) -> u64 {
...
//
    ...
    u64 size;
    u32 i;
    let mut max_base: u64 = 0;
    let mut last_hmc_obj: u32 = 0;
...
//
    ...
    hmc_fpm_misc.fw_scratch_buf0.va,
    hmc_fpm_misc.fw_scratch_buf0.pa);
    hmc_fpm_misc.fw_scratch_buf0.va = core::ptr::null_mut();
    hmc_fpm_misc.fw_scratch_buf0.size = 0;
    return -ENOMEM;
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cqp_create(cqp: *mut irdma_sc_cqp, maj_err: *mut u16, min_err: *mut u16) -> c_int {
    int irdma_sc_cqp_create(struct irdma_sc_cqp *cqp, u16 *maj_err, u16 *min_err)
    {
    u64 temp;
    u8 hw_rev;
    let mut cnt: u32 = 0, p1, p2, val = 0, err_code;
    int ret_code;
    ...
    cqp.sdbuf.va = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cqp_post_sq(cqp: *mut irdma_sc_cqp) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cqp_destroy(cqp: *mut irdma_sc_cqp) -> c_int {
    int irdma_sc_cqp_destroy(struct irdma_sc_cqp *cqp)
    {
    let mut cnt: u32 = 0, val;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_ccq_arm(ccq: *mut irdma_sc_cq) {
...
//
    ...
    {
    u32 def_info;
    let mut def_cmpl: bool = false;
    let mut pend_cmpl: bool = false;
    let mut ooo_final_cmpl: bool = false;
...
//
    ...
    {
    let mut info: irdma_ccq_cqe_info = {};
...
//
#[no_mangle]
unsafe extern "C" fn irdma_sc_commit_fpm_val_done(cqp: *mut irdma_sc_cqp) -> c_int {
...
//
    ...
    cqp.dev.hmc_fpm_misc.fw_scratch_buf0.va != core::ptr::null_mut()) |
    FIELD_PREP(IRDMA_CQPSQ_WQEVALID, cqp.polarity);
    dma_wmb(); /* make sure WQE is written before valid bit is set */
    set_64bit_val(wqe, 24, hdr);
...
#[no_mangle]
pub unsafe extern "C" fn if(IRDMA_CQP_WAIT_POLL_CQ: wait_type ==) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_sc_query_fpm_val_done(cqp: *mut irdma_sc_cqp) -> c_int {
...
//
    ...
    ceq.pbl_list = (ceq.virtual_map ? info.pbl_list : core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn irdma_sc_cceq_create_done(ceq: *mut irdma_sc_ceq) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cceq_destroy_done(ceq: *mut irdma_sc_ceq) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cceq_create(ceq: *mut irdma_sc_ceq, scratch: u64) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_ceq_destroy(ceq: *mut irdma_sc_ceq, scratch: u64, post_sq: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_cleanup_ceqes(cq: *mut irdma_sc_cq, ceq: *mut irdma_sc_ceq) {
    void irdma_sc_cleanup_ceqes(struct irdma_sc_cq *cq, struct irdma_sc_ceq *ceq)
    {
    let mut ceq_polarity: u8 = ceq.polarity;
    __le64 *ceqe;
    u8 polarity;
    u32 cq_idx;
    u64 temp;
...
//
    ...
    aeq.pbl_list = (aeq.virtual_map ? info.pbl_list : core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_repost_aeq_entries(dev: *mut irdma_sc_dev, count: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_ccq_init(cq: *mut irdma_sc_cq, info: *mut irdma_ccq_init_info) -> c_int {
...
// Only applicable to CQs other than CCQ so initialize to zero
    cq.cq_uk.cqe_alloc_db = core::ptr::null_mut();
    info.dev.ccq = cq;
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_ccq_create_done(ccq: *mut irdma_sc_cq) -> c_int {
    static inline int irdma_sc_ccq_create_done(struct irdma_sc_cq *ccq)
    {
    struct irdma_sc_cqp *cqp;
    cqp = ccq.dev.cqp;
    return irdma_sc_poll_for_cqp_op_done(cqp, IRDMA_CQP_OP_CREATE_CQ, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_ccq_destroy(ccq: *mut irdma_sc_cq, scratch: u64, post_sq: bool) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_init_iw_hmc(dev: *mut irdma_sc_dev, hmc_fn_id: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_set_loc_mem(buf: *mut __le64) {
    static void irdma_set_loc_mem(__le64 *buf)
    {
    let mut loc_mem_en: u64 = BIT_ULL(ENABLE_LOC_MEM);
    u32 offset;
    u64 temp;
...
//
#[no_mangle]
unsafe extern "C" fn irdma_sc_cfg_iw_fpm(dev: *mut irdma_sc_dev, hmc_fn_id: u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_cqp_ring_full(cqp: *mut irdma_sc_cqp) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_get_rdma_features(dev: *mut irdma_sc_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_get_rsrc_mem_config(dev: *mut irdma_sc_dev, is_mrte_loc_mem: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_set_host_hmc_rsrc_gen_3(dev: *mut irdma_sc_dev) {
...
//
    ...
    struct irdma_hmc_info *hmc_info;
    let mut rrffl_cnt: u32 = 0;
    let mut xffl_cnt: u32 = 0;
    u32 q1fl_cnt;
    hmc_info = dev.hmc_info;
    hmc_fpm_misc = &dev.hmc_fpm_misc;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cfg_fpm_val(dev: *mut irdma_sc_dev, qp_count: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_process_bh(dev: *mut irdma_sc_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cfg_aeq(dev: *mut irdma_sc_dev, idx: u32, enable: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sc_vsi_update_stats(vsi: *mut irdma_sc_vsi) {
    ...
    let mut max_stat_idx: u16 = vsi.dev.hw_attrs.max_stat_idx;
    u16 i;
    if (vsi.dev.hw_attrs.uk_attrs.hw_rev >= IRDMA_GEN_3) {
    for (i = 0; i < max_stat_idx; i++) {
    let mut idx: u16 = map[i].byteoff / sizeof(u64);
...
//
#[no_mangle]
unsafe extern "C" fn irdma_wait_pe_ready(dev: *mut irdma_sc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_sc_init_hw(dev: *mut irdma_sc_dev) {
...
//
    ...
    dev.ilq_cq = core::ptr::null_mut();
    dev.ieq_cq = core::ptr::null_mut();
...
//
    ...
    u64 bitmask)
    {
    let mut idx: u16 = byteoff / sizeof(*stats_val);
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_stat_delta(new_val: u64, old_val: u64, max_val: u64) -> u64 {
