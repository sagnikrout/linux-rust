...
//! Source: drivers/infiniband/hw/irdma/hw.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn irdma_iwarp_ce_handler(iwcq: *mut irdma_sc_cq) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_process_ceq(rf: *mut irdma_pci_f, ceq: *mut irdma_ceq) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_process_aeq(rf: *mut irdma_pci_f) {
    ...
    int ret;
    struct irdma_qp *iwqp = core::ptr::null_mut();
    struct irdma_cq *iwcq = core::ptr::null_mut();
    struct irdma_sc_qp *qp = core::ptr::null_mut();
    struct irdma_qp_host_ctx_info *ctx_info = core::ptr::null_mut();
    struct irdma_device *iwdev = rf.iwdev;
    struct irdma_sc_srq *srq;
    unsigned long flags;
    let mut aeqcnt: u32 = 0;
    if (!sc_aeq.size)
    return;
    do {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_ena_intr(dev: *mut irdma_sc_dev, msix_id: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_dpc(t: *mut tasklet_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_ceq_dpc(t: *mut tasklet_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_save_msix_info(rf: *mut irdma_pci_f) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_ceq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
    ...
    irq_update_affinity_hint(msix_vec.irq, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn irdma_destroy_cqp(rf: *mut irdma_pci_f) {
    ...
    cqp.sq.pa);
    cqp.sq.va = core::ptr::null_mut();
    kfree(cqp.oop_op_array);
    cqp.oop_op_array = core::ptr::null_mut();
    kfree(cqp.scratch_array);
    cqp.scratch_array = core::ptr::null_mut();
    kfree(cqp.cqp_requests);
    cqp.cqp_requests = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn irdma_destroy_virt_aeq(rf: *mut irdma_pci_f) {
    static void irdma_destroy_virt_aeq(struct irdma_pci_f *rf)
    {
    struct irdma_aeq *aeq = &rf.aeq;
    let mut pg_cnt: u32 = DIV_ROUND_UP(aeq.mem.size, PAGE_SIZE);
...
//
#[no_mangle]
unsafe extern "C" fn irdma_destroy_aeq(rf: *mut irdma_pci_f) {
    static void irdma_destroy_aeq(struct irdma_pci_f *rf)
    {
    struct irdma_sc_dev *dev = &rf.sc_dev;
    struct irdma_aeq *aeq = &rf.aeq;
    let mut status: c_int = -EBUSY;
    if (!rf.msix_shared) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_destroy_ceq(rf: *mut irdma_pci_f, iwceq: *mut irdma_ceq) {
    ...
    iwceq.mem.pa);
    iwceq.mem.va = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn irdma_del_ceq_0(rf: *mut irdma_pci_f) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_del_ceqs(rf: *mut irdma_pci_f) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_destroy_ccq(rf: *mut irdma_pci_f) {
    ...
    ccq.mem_cq.pa);
    ccq.mem_cq.va = core::ptr::null_mut();
    }
//
...
//
    ...
    {
    let mut info: irdma_hmc_del_obj_info = {};
...
//
    ...
    {
    struct irdma_sc_dev *dev = &rf.sc_dev;
    let mut info: irdma_hmc_create_obj_info = {};
    int i, status = 0;
...
//
#[no_mangle]
unsafe extern "C" fn irdma_create_cqp(rf: *mut irdma_pci_f) -> c_int {
    static int irdma_create_cqp(struct irdma_pci_f *rf)
    {
    let mut sqsize: u32 = IRDMA_CQP_SW_SQSIZE_2048;
    struct irdma_dma_mem mem;
    struct irdma_sc_dev *dev = &rf.sc_dev;
    let mut cqp_init_info: irdma_cqp_init_info = {};
    struct irdma_cqp *cqp = &rf.cqp;
    u16 maj_err, min_err;
    int i, status;
...
//
#[no_mangle]
unsafe extern "C" fn irdma_create_ccq(rf: *mut irdma_pci_f) -> c_int {
    static int irdma_create_ccq(struct irdma_pci_f *rf)
    {
    struct irdma_sc_dev *dev = &rf.sc_dev;
    let mut info: irdma_ccq_init_info = {};
    struct irdma_ccq *ccq = &rf.ccq;
    int ccq_size;
    int status;
    dev.ccq = &ccq.sc_cq;
...
//
#[no_mangle]
unsafe extern "C" fn irdma_alloc_set_mac(iwdev: *mut irdma_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_cfg_aeq_vector(rf: *mut irdma_pci_f) -> c_int {
...
//
    ...
    {
    int status;
    let mut info: irdma_ceq_init_info = {};
    struct irdma_sc_dev *dev = &rf.sc_dev;
    u32 ceq_size;
    info.ceq_id = ceq_id;
    iwceq.rf = rf;
...
//
#[no_mangle]
unsafe extern "C" fn irdma_setup_ceq_0(rf: *mut irdma_pci_f) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_setup_ceqs(rf: *mut irdma_pci_f, vsi_idx: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn irdma_create_virt_aeq(rf: *mut irdma_pci_f, size: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_create_aeq(rf: *mut irdma_pci_f) -> c_int {
    static int irdma_create_aeq(struct irdma_pci_f *rf)
    {
    let mut info: irdma_aeq_init_info = {};
    struct irdma_sc_dev *dev = &rf.sc_dev;
    struct irdma_aeq *aeq = &rf.aeq;
    struct irdma_hmc_info *hmc_info = rf.sc_dev.hmc_info;
    u32 aeq_size;
    let mut multiplier: u8 = (rf.protocol_used == IRDMA_IWARP_PROTOCOL_ONLY) ? 2 : 1;
    int status;
...
// GEN_3 does not support virtual AEQ. Cap at max Kernel alloc size
    ...
    goto skip_virt_aeq;
#[no_mangle]
pub unsafe extern "C" fn if(IRDMA_GEN_3: rf->rdma_ver >=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_setup_aeq(rf: *mut irdma_pci_f) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_initialize_ilq(iwdev: *mut irdma_device) -> c_int {
    static int irdma_initialize_ilq(struct irdma_device *iwdev)
    {
    let mut info: irdma_puda_rsrc_info = {};
    int status;
...
//
#[no_mangle]
unsafe extern "C" fn irdma_initialize_ieq(iwdev: *mut irdma_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_reinitialize_ieq(vsi: *mut irdma_sc_vsi) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_hmc_setup(rf: *mut irdma_pci_f) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_del_init_mem(rf: *mut irdma_pci_f) {
    ...
    dev.hmc_info.sd_table.sd_entry = core::ptr::null_mut();
    vfree(rf.mem_rsrc);
    rf.mem_rsrc = core::ptr::null_mut();
    dma_free_coherent(rf.hw.device, rf.obj_mem.size, rf.obj_mem.va,
    rf.obj_mem.pa);
    rf.obj_mem.va = core::ptr::null_mut();
    if (rf.rdma_ver != IRDMA_GEN_1) {
    bitmap_free(rf.allocated_ws_nodes);
    rf.allocated_ws_nodes = core::ptr::null_mut();
    }
    kfree(rf.ceqlist);
    rf.ceqlist = core::ptr::null_mut();
    kfree(rf.iw_msixtbl);
    rf.iw_msixtbl = core::ptr::null_mut();
    kfree(rf.hmc_info_mem);
    rf.hmc_info_mem = core::ptr::null_mut();
...
//
#[no_mangle]
unsafe extern "C" fn irdma_initialize_dev(rf: *mut irdma_pci_f) -> c_int {
    static int irdma_initialize_dev(struct irdma_pci_f *rf)
    {
    int status;
    struct irdma_sc_dev *dev = &rf.sc_dev;
    let mut info: irdma_device_init_info = {};
    struct irdma_dma_mem mem;
    u32 size;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_rt_deinit_hw(iwdev: *mut irdma_device) {
...
#[no_mangle]
unsafe extern "C" fn irdma_setup_init_state(rf: *mut irdma_pci_f) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_get_used_rsrc(iwdev: *mut irdma_device) {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_ctrl_deinit_hw(rf: *mut irdma_pci_f) {
    void irdma_ctrl_deinit_hw(struct irdma_pci_f *rf)
    {
    let mut state: enum init_completion_state = rf.init_state;
...
//
    ...
    struct irdma_pci_f *rf = iwdev.rf;
    struct irdma_sc_dev *dev = &rf.sc_dev;
    let mut vsi_info: irdma_vsi_init_info = {};
    let mut stats_info: irdma_vsi_stats_info = {};
    int status;
    vsi_info.dev = dev;
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_ctrl_init_hw(rf: *mut irdma_pci_f) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_set_hw_rsrc(rf: *mut irdma_pci_f) {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_calc_mem_rsrc_size(rf: *mut irdma_pci_f) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_initialize_hw_rsrc(rf: *mut irdma_pci_f) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_cqp_ce_handler(rf: *mut irdma_pci_f, cq: *mut irdma_sc_cq) {
    void irdma_cqp_ce_handler(struct irdma_pci_f *rf, struct irdma_sc_cq *cq)
    {
    struct irdma_cqp_request *cqp_request;
    struct irdma_sc_dev *dev = &rf.sc_dev;
    let mut cqe_count: u32 = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn cqp_compl_worker(work: *mut work_struct) {
...
//
    ...
    u8 termlen)
    {
    let mut info: irdma_modify_qp_info = {};
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_del_local_mac_entry(rf: *mut irdma_pci_f, idx: u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_add_local_mac_entry(rf: *mut irdma_pci_f, mac_addr: *const u8, idx: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn irdma_alloc_local_mac_entry(rf: *mut irdma_pci_f, mac_tbl_idx: *mut u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn irdma_send_syn_cqp_callback(cqp_request: *mut irdma_cqp_request) {
...
//
    ...
    cmnode ? cmnode : core::ptr::null_mut());
    else
    ibdev_dbg(&iwdev.ibdev,
...
//
#[no_mangle]
unsafe extern "C" fn irdma_hw_flush_wqes_callback(cqp_request: *mut irdma_cqp_request) {
...
#[no_mangle]
pub unsafe extern "C" fn irdma_flush_wqes(iwqp: *mut irdma_qp, flush_mask: u32) {
    void irdma_flush_wqes(struct irdma_qp *iwqp, u32 flush_mask)
    {
    let mut info: irdma_qp_flush_info = {};
    struct irdma_pci_f *rf = iwqp.iwdev.rf;
    let mut flush_code: u8 = iwqp.sc_qp.flush_code;
