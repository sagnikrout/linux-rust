...
//! Source: drivers/infiniband/hw/mana/cq.c
#![no_std]
...
//
    ...
    let mut resp: mana_ib_create_cq_resp = {};
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_destroy_cq(ibcq: *mut ib_cq, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mana_ib_cq_handler(ctx: *mut c_void, gdma_cq: *mut gdma_queue) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_install_cq_cb(mdev: *mut mana_ib_dev, cq: *mut mana_ib_cq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_remove_cq_cb(mdev: *mut mana_ib_dev, cq: *mut mana_ib_cq) {
...
// Then it will be cleaned and removed by the mana
    ...
    gc.cq_table[cq.queue.id] = core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn mana_ib_arm_cq(ibcq: *mut ib_cq, flags: enum ib_cq_notify_flags) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn handle_ud_sq_cqe(qp: *mut mana_ib_qp, cqe: *mut gdma_comp) {
...
#[no_mangle]
pub unsafe extern "C" fn handle_ud_rq_cqe(qp: *mut mana_ib_qp, cqe: *mut gdma_comp) {
...
#[no_mangle]
unsafe extern "C" fn mana_handle_cqe(mdev: *mut mana_ib_dev, cqe: *mut gdma_comp) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_drain_gsi_sqs(mdev: *mut mana_ib_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_poll_cq(ibcq: *mut ib_cq, num_entries: c_int, wc: *mut ib_wc) -> c_int {
