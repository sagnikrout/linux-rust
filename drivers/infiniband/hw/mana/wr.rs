...
//! Source: drivers/infiniband/hw/mana/wr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mana_ib_post_recv_ud(qp: *mut mana_ib_qp, wr: *const ib_recv_wr) -> c_int {
    ...
    let mut wqe_info: gdma_posted_wqe_info = {0};
    struct gdma_sge gdma_sgl[MAX_WR_SGL_NUM];
    let mut wqe_req: gdma_wqe_request = {0};
...
#[no_mangle]
unsafe extern "C" fn mana_ib_post_send_ud(qp: *mut mana_ib_qp, wr: *const ib_ud_wr) -> c_int {
    ...
    let mut wqe_info: gdma_posted_wqe_info = {0};
    let mut wqe_req: gdma_wqe_request = {0};
    let mut send_oob: rdma_send_oob = {0};
