...
//! Source: drivers/infiniband/hw/mana/mr.c
#![no_std]
...
//
    ...
    {
    let mut flags: enum gdma_mr_access_flags = GDMA_ACCESS_FLAG_LOCAL_READ;
    ...
    {
    let mut resp: gdma_create_mr_response = {};
    let mut req: gdma_create_mr_request = {};
...
#[no_mangle]
unsafe extern "C" fn mana_ib_gd_destroy_mr(dev: *mut mana_ib_dev, mr_handle: u64) -> c_int {
    static int mana_ib_gd_destroy_mr(struct mana_ib_dev *dev, u64 mr_handle)
    {
    let mut resp: gdma_destroy_mr_response = {};
    let mut req: gdma_destroy_mr_request = {};
    struct gdma_context *gc = mdev_to_gc(dev);
    ...
    let mut mr_params: gdma_create_mr_params = {};
...
#[no_mangle]
unsafe extern "C" fn mana_ib_gd_create_mw(dev: *mut mana_ib_dev, pd: *mut mana_ib_pd, ibmw: *mut ib_mw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_alloc_mw(ibmw: *mut ib_mw, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_dealloc_mw(ibmw: *mut ib_mw) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_dereg_mr(ibmr: *mut ib_mr, udata: *mut ib_udata) -> c_int {
    ...
    let mut resp: gdma_alloc_dm_resp = {};
    let mut req: gdma_alloc_dm_req = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn mana_ib_gd_destroy_dm(mdev: *mut mana_ib_dev, dm: *mut mana_ib_dm) -> c_int {
    static int mana_ib_gd_destroy_dm(struct mana_ib_dev *mdev, struct mana_ib_dm *dm)
    {
    struct gdma_context *gc = mdev_to_gc(mdev);
    let mut resp: gdma_destroy_dm_resp = {};
    let mut req: gdma_destroy_dm_req = {};
    mana_gd_init_req_hdr(&req.hdr, GDMA_DESTROY_DM, sizeof(req), sizeof(resp));
    req.dm_handle = dm.dm_handle;
    return mana_gd_send_request(gc, sizeof(req), &req, sizeof(resp), &resp);
    }
#[no_mangle]
pub unsafe extern "C" fn mana_ib_dealloc_dm(ibdm: *mut ib_dm, attrs: *mut uverbs_attr_bundle) -> c_int {
