...
//! Source: drivers/infiniband/hw/mana/main.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mana_gd_destroy_pd(mdev: *mut mana_ib_dev, pd_handle: u64) -> c_int {
    static int mana_gd_destroy_pd(struct mana_ib_dev *mdev, u64 pd_handle)
    {
    let mut resp: gdma_destroy_pd_resp = {};
    let mut req: gdma_destroy_pd_req = {};
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_alloc_pd(ibpd: *mut ib_pd, udata: *mut ib_udata) -> c_int {
    int mana_ib_alloc_pd(struct ib_pd *ibpd, struct ib_udata *udata)
    {
    struct mana_ib_pd *pd = container_of(ibpd, struct mana_ib_pd, ibpd);
    let mut ucmd_resp: mana_ib_alloc_pd_resp = {};
    struct ib_device *ibdev = ibpd.device;
    let mut resp: gdma_create_pd_resp = {};
    let mut req: gdma_create_pd_req = {};
    struct mana_ib_alloc_pd ucmd;
    let mut flags: enum gdma_pd_flags = 0;
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_dealloc_pd(ibpd: *mut ib_pd, udata: *mut ib_udata) -> c_int {
    ...
    int doorbell_page)
    {
    let mut req: gdma_destroy_resource_range_req = {};
    let mut resp: gdma_resp_hdr = {};
    ...
    int *doorbell_page)
    {
    let mut req: gdma_allocate_resource_range_req = {};
    let mut resp: gdma_allocate_resource_range_resp = {};
    int err;
...
// doorbell_page = resp.allocated_resources;
    ...
    let mut ucmd_resp: mana_ib_alloc_ucontext_resp = {};
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_dealloc_ucontext(ibcontext: *mut ib_ucontext) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_destroy_queue(mdev: *mut mana_ib_dev, queue: *mut mana_ib_queue) {
...
//
    ...
    u32 expected_status)
    {
    let mut create_resp: gdma_create_dma_region_resp = {};
...
// gdma_region);
    ...
    let mut add_resp: gdma_general_resp = {};
    int err;
    ...
    {
    struct gdma_dma_region_add_pages_req *add_req = core::ptr::null_mut();
    let mut num_pages_processed: usize = 0, num_pages_to_handle;
    struct gdma_create_dma_region_req *create_req;
    unsigned int create_req_msg_size;
    struct hw_channel_context *hwc;
    struct ib_block_iter biter;
    let mut max_pgs_add_cmd: usize = 0;
    size_t max_pgs_create_cmd;
    struct gdma_context *gc;
    size_t num_pages_total;
    let mut tail: c_uint = 0;
    u64 *page_addr_list;
    void *request_buf;
    let mut err: c_int = 0;
    gc = mdev_to_gc(dev);
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_destroy_dma_region(dev: *mut mana_ib_dev, gdma_region: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_mmap(ibcontext: *mut ib_ucontext, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_get_link_layer(device: *mut ib_device, port_num: u32) -> enum rdma_link_layer {
    enum rdma_link_layer mana_ib_get_link_layer(struct ib_device *device, u32 port_num)
    {
    return IB_LINK_LAYER_ETHERNET;
    }
#[no_mangle]
pub unsafe extern "C" fn mana_ib_query_pkey(ibdev: *mut ib_device, port: u32, index: u16, pkey: *mut u16) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_disassociate_ucontext(ibcontext: *mut ib_ucontext) {
    void mana_ib_disassociate_ucontext(struct ib_ucontext *ibcontext)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_query_adapter_caps(dev: *mut mana_ib_dev) -> c_int {
    int mana_ib_gd_query_adapter_caps(struct mana_ib_dev *dev)
    {
    struct mana_ib_adapter_caps *caps = &dev.adapter_caps;
    let mut resp: mana_ib_query_adapter_caps_resp = {};
    let mut req: mana_ib_query_adapter_caps_req = {};
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn mana_eth_query_adapter_caps(dev: *mut mana_ib_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_create_eqs(mdev: *mut mana_ib_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_destroy_eqs(mdev: *mut mana_ib_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_create_rnic_adapter(mdev: *mut mana_ib_dev) -> c_int {
    int mana_ib_gd_create_rnic_adapter(struct mana_ib_dev *mdev)
    {
    let mut resp: mana_rnic_create_adapter_resp = {};
    let mut req: mana_rnic_create_adapter_req = {};
    struct gdma_context *gc = mdev_to_gc(mdev);
    int err;
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_destroy_rnic_adapter(mdev: *mut mana_ib_dev) -> c_int {
    int mana_ib_gd_destroy_rnic_adapter(struct mana_ib_dev *mdev)
    {
    let mut resp: mana_rnic_destroy_adapter_resp = {};
    let mut req: mana_rnic_destroy_adapter_req = {};
    struct gdma_context *gc;
    gc = mdev_to_gc(mdev);
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_add_gid(attr: *const ib_gid_attr, context: *mut c_void) -> c_int {
    ...
    let mut ntype: enum rdma_network_type = rdma_gid_attr_network_type(attr);
    let mut resp: mana_rnic_config_addr_resp = {};
    struct gdma_context *gc = mdev_to_gc(mdev);
    let mut req: mana_rnic_config_addr_req = {};
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_del_gid(attr: *const ib_gid_attr, context: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_config_mac(mdev: *mut mana_ib_dev, op: enum mana_ib_addr_op, mac: *mut u8) -> c_int {
    int mana_ib_gd_config_mac(struct mana_ib_dev *mdev, enum mana_ib_addr_op op, u8 *mac)
    {
    let mut resp: mana_rnic_config_mac_addr_resp = {};
    let mut req: mana_rnic_config_mac_addr_req = {};
    struct gdma_context *gc = mdev_to_gc(mdev);
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_create_cq(mdev: *mut mana_ib_dev, cq: *mut mana_ib_cq, doorbell: u32) -> c_int {
    int mana_ib_gd_create_cq(struct mana_ib_dev *mdev, struct mana_ib_cq *cq, u32 doorbell)
    {
    struct gdma_context *gc = mdev_to_gc(mdev);
    let mut resp: mana_rnic_create_cq_resp = {};
    let mut req: mana_rnic_create_cq_req = {};
    int err;
    if (!mdev.eqs)
    return -EINVAL;
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_destroy_cq(mdev: *mut mana_ib_dev, cq: *mut mana_ib_cq) -> c_int {
    int mana_ib_gd_destroy_cq(struct mana_ib_dev *mdev, struct mana_ib_cq *cq)
    {
    struct gdma_context *gc = mdev_to_gc(mdev);
    let mut resp: mana_rnic_destroy_cq_resp = {};
    let mut req: mana_rnic_destroy_cq_req = {};
    ...
    struct gdma_context *gc = mdev_to_gc(mdev);
    let mut resp: mana_rnic_create_qp_resp = {};
    let mut req: mana_rnic_create_qp_req = {};
    int err, i;
...
// The GDMA regions are now owned by the RNIC QP handle
    ...
    struct mana_ib_pd *pd = container_of(qp.ibqp.pd, struct mana_ib_pd, ibpd);
    struct gdma_context *gc = mdev_to_gc(mdev);
    let mut resp: mana_rnic_create_uc_qp_resp = {};
    let mut req: mana_rnic_create_uc_qp_req = {};
    int err, i;
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_destroy_rnic_qp(mdev: *mut mana_ib_dev, qp: *mut mana_ib_qp) -> c_int {
    int mana_ib_gd_destroy_rnic_qp(struct mana_ib_dev *mdev, struct mana_ib_qp *qp)
    {
    let mut resp: mana_rnic_destroy_rnic_qp_resp = {0};
    let mut req: mana_rnic_destroy_rnic_qp_req = {0};
    struct gdma_context *gc = mdev_to_gc(mdev);
    ...
    struct mana_ib_pd *pd = container_of(qp.ibqp.pd, struct mana_ib_pd, ibpd);
    struct gdma_context *gc = mdev_to_gc(mdev);
    let mut resp: mana_rnic_create_udqp_resp = {};
    let mut req: mana_rnic_create_udqp_req = {};
    int err, i;
...
#[no_mangle]
pub unsafe extern "C" fn mana_ib_gd_destroy_ud_qp(mdev: *mut mana_ib_dev, qp: *mut mana_ib_qp) -> c_int {
    int mana_ib_gd_destroy_ud_qp(struct mana_ib_dev *mdev, struct mana_ib_qp *qp)
    {
    let mut resp: mana_rnic_destroy_udqp_resp = {0};
    let mut req: mana_rnic_destroy_udqp_req = {0};
    struct gdma_context *gc = mdev_to_gc(mdev);
