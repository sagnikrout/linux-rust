...
//! Source: drivers/infiniband/hw/mlx5/main.c
#![no_std]
...
//
    ...
    let mut port_type_cap: c_int = MLX5_CAP_GEN(dev.mdev, port_type);
...
// RDMA devie is in switchdev
    ...
    let mut port_num: u32 = roce.native_port_num;
    struct net_device *ib_ndev = core::ptr::null_mut();
    struct mlx5_core_dev *mdev;
    struct mlx5_ib_dev *ibdev;
    ibdev = roce.dev;
    mdev = mlx5_ib_get_native_port_mdev(ibdev, port_num, core::ptr::null_mut());
    if (!mdev)
    return NOTIFY_DONE;
    switch (event) {
...
// In case of reps, ib device goes away before the netdevs
    ...
    ib_ndev = ib_device_get_netdev(&ibdev.ib_dev, port_num);
    if (ib_ndev == ndev)
    ib_device_set_netdev(&ibdev.ib_dev, core::ptr::null_mut(), port_num);
    goto put_ndev;
    case NETDEV_CHANGE:
    case NETDEV_UP:
    case NETDEV_DOWN: {
    struct net_device *upper = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(IB_PORT_ACTIVE: port_state ==) -> else {
    ...
    ib_port_num);
    struct mlx5_core_dev *mdev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ib_put_native_port_mdev(ibdev: *mut mlx5_ib_dev, port_num: u32) {
...
// If this is a stub query for an unaffiliated port stop here
    ...
    let mut vlan_id: u16 = 0xffff;
    let mut roce_version: u8 = 0;
    let mut roce_l3_type: u8 = 0;
    u8 mac[ETH_ALEN];
    int ret;
    ...
    attr.index, core::ptr::null_mut(), attr);
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn mlx5_use_mad_ifc(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_get_vport_access_method(ibdev: *mut ib_device) -> c_int {
    ...
    {
    u8 tmp;
    let mut atomic_operations: u8 = MLX5_CAP_ATOMIC(dev.mdev, atomic_operations);
...
//
    ...
    struct ib_device_attr *props)
    {
    let mut atomic_size_qp: u8 = MLX5_CAP_ATOMIC(dev.mdev, atomic_size_qp);
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlx5_reg_node_desc {
    pub desc: [u8; IB_DEVICE_NODE_DESC_MAX],
}

#[no_mangle]
unsafe extern "C" fn mlx5_query_node_desc(dev: *mut mlx5_ib_dev, node_desc: *mut c_char) -> c_int {
    ...
    let mut vport: u16 = mlx5_eswitch_manager_vport(mdev);
...
//
#[no_mangle]
unsafe extern "C" fn mlx5_ib_calc_max_sq_overhead() -> u32 {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_calc_max_qp_wr(dev: *mut mlx5_ib_dev) -> u32 {
    static u32 mlx5_ib_calc_max_qp_wr(struct mlx5_ib_dev *dev)
    {
    struct mlx5_core_dev *mdev = dev.mdev;
    let mut max_wqe_bb_units: u32 = 1 << MLX5_CAP_GEN(mdev, log_max_qp_sz);
    u32 max_wqe_size;
// max QP overhead + 1 SGE, no inline, no special features
    ...
    struct ib_udata *uhw)
    {
    let mut uhw_outlen: usize = (uhw) ? uhw.outlen : 0;
    struct mlx5_ib_dev *dev = to_mdev(ibdev);
    struct mlx5_core_dev *mdev = dev.mdev;
    ...
    int max_rq_sg;
    int max_sq_sg;
    let mut min_page_size: u64 = 1ull << MLX5_CAP_GEN(mdev, log_pg_sz);
    let mut raw_support: bool = !mlx5_core_mp_enabled(mdev);
    let mut resp: mlx5_ib_query_device_resp = {};
    size_t resp_len;
    u64 max_tso;
...
#[no_mangle]
pub unsafe extern "C" fn if(MLX5_PTYS_WIDTH_2X: active_width &) -> else {
    else if (active_width & MLX5_PTYS_WIDTH_2X)
// ib_width = IB_WIDTH_2X;
#[no_mangle]
pub unsafe extern "C" fn if(MLX5_PTYS_WIDTH_4X: active_width &) -> else {
    else if (active_width & MLX5_PTYS_WIDTH_4X)
// ib_width = IB_WIDTH_4X;
#[no_mangle]
pub unsafe extern "C" fn if(MLX5_PTYS_WIDTH_8X: active_width &) -> else {
    else if (active_width & MLX5_PTYS_WIDTH_8X)
// ib_width = IB_WIDTH_8X;
#[no_mangle]
pub unsafe extern "C" fn if(MLX5_PTYS_WIDTH_12X: active_width &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mlx5_mtu_to_ib_mtu(mtu: c_int) -> c_int {
...
// props being zeroed by the caller, avoid zeroing it here
    ...
    struct mlx5_core_dev *mdev;
    let mut put_mdev: bool = true;
    mdev = mlx5_ib_get_native_port_mdev(dev, port, core::ptr::null_mut());
    if (!mdev) {
...
// speed = bond_speed / MLX5_MAX_TX_SPEED_UNIT;
    ...
    u32 port_num, u64 *speed)
    {
    let mut op_mod: u16 = MLX5_VPORT_STATE_OP_MOD_VNIC_VPORT;
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ib_query_port_speed(ibdev: *mut ib_device, port_num: u32, speed: *mut u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !dev->is_rep) -> else {
    else if (!dev.is_rep)
...
//
    ...
    u32 value)
    {
    let mut ctx: mlx5_hca_vport_context = {};
    struct mlx5_core_dev *mdev;
    u32 mdev_port_num;
    int err;
    mdev = mlx5_ib_get_native_port_mdev(dev, port_num, &mdev_port_num);
...
#[no_mangle]
unsafe extern "C" fn print_lib_caps(dev: *mut mlx5_ib_dev, caps: u64) {
...
#[no_mangle]
unsafe extern "C" fn calc_dynamic_bfregs(uars_per_sys_page: c_int) -> u16 {
...
// Large page with non 4k uar support might limit the dynamic size
    ...
    let mut ref_bfregs: c_int = req.total_num_bfregs;
...
#[no_mangle]
unsafe extern "C" fn allocate_uars(dev: *mut mlx5_ib_dev, context: *mut mlx5_ib_ucontext) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ib_enable_lb(dev: *mut mlx5_ib_dev, td: bool, qp: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ib_disable_lb(dev: *mut mlx5_ib_dev, td: bool, qp: bool) {
...
#[no_mangle]
unsafe extern "C" fn uctx_rdma_ctrl_is_enabled(enabled_caps: u64) -> bool {
    ...
    struct mlx5_ib_dev *dev = to_mdev(ibdev);
    struct mlx5_ib_alloc_ucontext_req_v2 req;
    let mut resp: mlx5_ib_alloc_ucontext_resp = {};
    struct mlx5_ib_ucontext *context = to_mucontext(uctx);
    struct mlx5_bfreg_info *bfregi;
    int ver;
    int err;
    ...
    ver = 0;
#[no_mangle]
pub unsafe extern "C" fn if(min_req_v2: udata->inlen >=) -> else {
...
// updates req->total_num_bfregs
    ...
    let mut port: u32 = mlx5_core_native_port_num(dev.mdev) - 1;
    ...
    {
    let mut uctx_resp: mlx5_ib_alloc_ucontext_resp = {};
    int ret;
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_dealloc_ucontext(ibcontext: *mut ib_ucontext) {
...
#[no_mangle]
unsafe extern "C" fn get_command(offset: c_ulong) -> c_int {
    static int get_command(unsigned long offset)
    {
    return (offset >> MLX5_IB_MMAP_CMD_SHIFT) & MLX5_IB_MMAP_CMD_MASK;
    }
#[no_mangle]
unsafe extern "C" fn get_arg(offset: c_ulong) -> c_int {
    static int get_arg(unsigned long offset)
    {
    return offset & ((1 << MLX5_IB_MMAP_CMD_SHIFT) - 1);
    }
#[no_mangle]
unsafe extern "C" fn get_index(offset: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_extended_index(offset: c_ulong) -> c_int {
    static int get_extended_index(unsigned long offset)
    {
    return get_arg(offset) | ((offset >> 16) & 0xff) << 8;
    }
#[no_mangle]
unsafe extern "C" fn mlx5_ib_disassociate_ucontext(ibcontext: *mut ib_ucontext) {
...
#[no_mangle]
unsafe extern "C" fn phys_addr_to_bar(pdev: *mut pci_dev, pa: phys_addr_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_mmap_free(entry: *mut rdma_user_mmap_entry) {
    ...
    phys_addr_t pfn;
    pgprot_t prot;
    let mut bfreg_dyn_idx: u32 = 0;
    u32 uar_index;
    let mut dyn_uar: c_int = (cmd == MLX5_IB_MMAP_ALLOC_WC);
...
#[no_mangle]
unsafe extern "C" fn mlx5_vma_to_pgoff(vma: *mut vm_area_struct) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn mlx5_entry_to_mmap_offset(entry: *mut mlx5_user_mmap_entry) -> u64 {
    static u64 mlx5_entry_to_mmap_offset(struct mlx5_user_mmap_entry *entry)
    {
    let mut cmd: u64 = (entry.rdma_entry.start_pgoff >> 16) & 0xFFFF;
    let mut index: u64 = entry.rdma_entry.start_pgoff & 0xFFFF;
    return (((index >> 8) << 16) | (cmd << MLX5_IB_MMAP_CMD_SHIFT) |
    (index & 0xFF)) << PAGE_SHIFT;
    }
#[no_mangle]
unsafe extern "C" fn mlx5_ib_mmap(ibcontext: *mut ib_ucontext, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_alloc_pd(ibpd: *mut ib_pd, udata: *mut ib_udata) -> c_int {
    static int mlx5_ib_alloc_pd(struct ib_pd *ibpd, struct ib_udata *udata)
    {
    struct mlx5_ib_pd *pd = to_mpd(ibpd);
    struct ib_device *ibdev = ibpd.device;
    let mut resp: mlx5_ib_alloc_pd_resp = {};
    int err;
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_dealloc_pd(pd: *mut ib_pd, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_mcg_attach(ibqp: *mut ib_qp, gid: *mut union ib_gid, lid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_mcg_detach(ibqp: *mut ib_qp, gid: *mut union ib_gid, lid: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_node_data(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pkey_change_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_handle_internal_error(ibdev: *mut mlx5_ib_dev) {
...
//
    ...
    mcq.comp(mcq, core::ptr::null_mut());
    }
    spin_unlock_irqrestore(&ibdev.reset_flow_resource_lock, flags);
    }
#[no_mangle]
unsafe extern "C" fn delay_drop_handler(work: *mut work_struct) {
    ...
    {
    let mut port: u32 = (eqe.data.port.port >> 4) & 0xf;
    switch (eqe.sub_type) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_handle_event(_work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_handle_sys_error_event(_work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_sys_error_notifier_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_sys_error_notifier_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_get_plane_num(mdev: *mut mlx5_core_dev, num_plane: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_has_smi_cap(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_ext_port_caps(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_get_umr_fence(umr_fence_cap: u8) -> u8 {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ib_dev_res_cq_init(dev: *mut mlx5_ib_dev) -> c_int {
    int mlx5_ib_dev_res_cq_init(struct mlx5_ib_dev *dev)
    {
    struct mlx5_ib_resources *devr = &dev.devr;
    let mut cq_attr: ib_cq_init_attr = {.cqe = 1};
...
//
    ...
    cq = ib_create_cq(ibdev, core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(), &cq_attr);
    if (IS_ERR(cq)) {
    ret = PTR_ERR(cq);
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ib_dev_res_srq_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_dev_res_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_dev_res_cleanup(dev: *mut mlx5_ib_dev) {
...
// RO is defined as best effort
    ...
    {
    struct mlx5_ib_dev *dev = to_mdev(ibdev);
    let mut ll: enum rdma_link_layer = mlx5_ib_port_link_layer(ibdev, 1);
    let mut l3_type_cap: u8 = MLX5_CAP_ROCE(dev.mdev, l3_type);
    let mut roce_version_cap: u8 = MLX5_CAP_ROCE(dev.mdev, roce_version);
    let mut raw_support: bool = !mlx5_core_mp_enabled(dev.mdev);
    let mut ret: u32 = 0;
    if (rep.grh_required)
    ...
    RDMA_CORE_CAP_AF_IB;
#[no_mangle]
pub unsafe extern "C" fn if(RDMA_DEVICE_TYPE_SMI: ibdev->type ==) -> else {
    else if (ibdev.type == RDMA_DEVICE_TYPE_SMI)
    ...
    struct ib_port_attr attr;
    struct mlx5_ib_dev *dev = to_mdev(ibdev);
    let mut ll: enum rdma_link_layer = mlx5_ib_port_link_layer(ibdev, port_num);
    let mut rep: mlx5_hca_vport_context = {0};
    int err;
...
#[no_mangle]
unsafe extern "C" fn get_dev_fw_str(ibdev: *mut ib_device, str: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn lag_event(nb: *mut notifier_block, event: c_ulong, data: *mut c_void) -> c_int {
    ...
    struct net_device *old_ndev = core::ptr::null_mut();
    struct mlx5_ib_port *port;
    struct net_device *ndev;
...
#[no_mangle]
unsafe extern "C" fn mlx5e_lag_event_register(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5e_lag_event_unregister(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_eth_lag_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_eth_lag_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_netdev_notifier_unregister(roce: *mut mlx5_roce) {
    ...
    &roce.nn);
    roce.tracking_netdev = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn mlx5_mdev_netdev_track(dev: *mut mlx5_ib_dev, port_num: u32) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_mdev_netdev_untrack(dev: *mut mlx5_ib_dev, port_num: u32) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_enable_eth(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_disable_eth(dev: *mut mlx5_ib_dev) {
    ...
    struct mlx5_ib_multiport_info *mpi)
    {
    let mut port_num: u32 = mlx5_core_native_port_num(mpi.mdev) - 1;
    ...
    mpi.ibdev = core::ptr::null_mut();
    spin_unlock(&port.mp.mpi_lock);
    if (mpi.mdev_events.notifier_call)
    mlx5_notifier_unregister(mpi.mdev, &mpi.mdev_events);
    mpi.mdev_events.notifier_call = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_data_direct_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_data_direct_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_init_multiport_master(dev: *mut mlx5_ib_dev) -> c_int {
    static int mlx5_ib_init_multiport_master(struct mlx5_ib_dev *dev)
    {
    let mut port_num: u32 = mlx5_core_native_port_num(dev.mdev) - 1;
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_cleanup_multiport_master(dev: *mut mlx5_ib_dev) {
...
// Destroy the native port stub
    ...
    dev.port[i].mp.mpi = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn var_is_supported(device: *mut ib_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_init_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_init_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_init_var_region(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_init_tlp_var_region(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_cleanup_ucaps(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_init_ucaps(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_cleanup_var_table(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_caps_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_caps_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_non_default_cb(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_raw_eth_non_default_cb(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_roce_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_roce_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_cong_debugfs_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_cong_debugfs_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_bfrag_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_bfrag_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_ib_reg_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_pre_ib_reg_umr_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_ib_reg_cleanup(dev: *mut mlx5_ib_dev) {
    static void mlx5_ib_stage_ib_reg_cleanup(struct mlx5_ib_dev *dev)
    {
    ib_unregister_device(&dev.ib_dev);
    }
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_post_ib_reg_umr_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_delay_drop_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_delay_drop_cleanup(dev: *mut mlx5_ib_dev) {
    ...
    dev.delay_drop.dir_debugfs = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_dev_notifier_init(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_stage_dev_notifier_cleanup(dev: *mut mlx5_ib_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_ib_data_direct_unbind(ibdev: *mut mlx5_ib_dev) {
    void mlx5_ib_data_direct_unbind(struct mlx5_ib_dev *ibdev)
    {
    mutex_lock(&ibdev.data_direct_lock);
    mlx5_ib_revoke_data_direct_mrs(ibdev);
    ibdev.data_direct_dev = core::ptr::null_mut();
    mutex_unlock(&ibdev.data_direct_lock);
    }
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_del_sub_dev(sub_dev: *mut ib_device) {
    static void mlx5_ib_del_sub_dev(struct ib_device *sub_dev)
    {
    struct mlx5_ib_dev *mdev = to_mdev(sub_dev);
    to_mdev(sub_dev.parent).smi_dev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn mlx5r_mp_remove(adev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn mlx5r_remove(adev: *mut auxiliary_device) {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mlx5_ib_cleanup() -> void __exit {
