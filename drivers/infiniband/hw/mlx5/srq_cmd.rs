...
//! Source: drivers/infiniband/hw/mlx5/srq_cmd.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn get_pas_size(in: *mut mlx5_srq_attr) -> c_int {
    static int get_pas_size(struct mlx5_srq_attr *in)
    {
    let mut log_page_size: u32 = in.log_page_size + 12;
    let mut log_srq_size: u32 = in.log_size;
    let mut log_rq_stride: u32 = in.wqe_shift;
    let mut page_offset: u32 = in.page_offset;
    let mut po_quanta: u32 = 1 << (log_page_size - 6);
    let mut rq_sz: u32 = 1 << (log_srq_size + 4 + log_rq_stride);
    let mut page_size: u32 = 1 << log_page_size;
    let mut rq_sz_po: u32 = rq_sz + (page_offset * po_quanta);
    let mut rq_num_pas: u32 = DIV_ROUND_UP(rq_sz_po, page_size);
    return rq_num_pas * sizeof(u64);
    }
#[no_mangle]
unsafe extern "C" fn set_wq(wq: *mut c_void, in: *mut mlx5_srq_attr) {
...
#[no_mangle]
unsafe extern "C" fn set_srqc(srqc: *mut c_void, in: *mut mlx5_srq_attr) {
...
#[no_mangle]
unsafe extern "C" fn get_wq(wq: *mut c_void, in: *mut mlx5_srq_attr) {
...
#[no_mangle]
unsafe extern "C" fn get_srqc(srqc: *mut c_void, in: *mut mlx5_srq_attr) {
...
#[no_mangle]
unsafe extern "C" fn destroy_srq_cmd(dev: *mut mlx5_ib_dev, srq: *mut mlx5_core_srq) -> c_int {
    ...
    struct mlx5_srq_attr *in)
    {
    void *create_out = core::ptr::null_mut();
    void *create_in = core::ptr::null_mut();
    void *rmpc;
    void *wq;
    void *pas;
    int pas_size;
...
#[no_mangle]
unsafe extern "C" fn destroy_rmp_cmd(dev: *mut mlx5_ib_dev, srq: *mut mlx5_core_srq) -> c_int {
    ...
    struct mlx5_srq_attr *out)
    {
    u32 *rmp_out = core::ptr::null_mut();
    u32 *rmp_in = core::ptr::null_mut();
    void *rmpc;
    int outlen;
    int inlen;
    int err;
...
#[no_mangle]
unsafe extern "C" fn destroy_xrq_cmd(dev: *mut mlx5_ib_dev, srq: *mut mlx5_core_srq) -> c_int {
    ...
    u32 *xrq_out;
    let mut outlen: c_int = MLX5_ST_SZ_BYTES(query_xrq_out);
    void *xrqc;
    int err;
...
#[no_mangle]
unsafe extern "C" fn destroy_srq_split(dev: *mut mlx5_ib_dev, srq: *mut mlx5_core_srq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_cmd_destroy_srq(dev: *mut mlx5_ib_dev, srq: *mut mlx5_core_srq) -> c_int {
...
//
    xa_cmpxchg_irq(&table.array, srq.srqn, XA_ZERO_ENTRY, core::ptr::null_mut(), 0);
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_init_srq_table(dev: *mut mlx5_ib_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mlx5_cleanup_srq_table(dev: *mut mlx5_ib_dev) {
