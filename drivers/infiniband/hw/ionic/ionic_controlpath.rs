...
//! Source: drivers/infiniband/hw/ionic/ionic_controlpath.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ionic_validate_qdesc(q: *mut ionic_qdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_get_eqid(dev: *mut ionic_ibdev, comp_vector: u32, udma_idx: u8) -> u32 {
...
//
    let mut comp_vec_count: u32 = dev.lif_cfg.eq_count / dev.lif_cfg.udma_count - 1;
    return (comp_vector % comp_vec_count + 1) * dev.lif_cfg.udma_count + udma_idx;
    }
#[no_mangle]
unsafe extern "C" fn ionic_get_cqid(dev: *mut ionic_ibdev, cqid: *mut u32, udma_idx: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_put_cqid(dev: *mut ionic_ibdev, cqid: u32) {
...
// resp_cqid = cq->cqid;
    ...
    err_args:
    cq.vcq = core::ptr::null_mut();
    return rc;
    }
#[no_mangle]
pub unsafe extern "C" fn ionic_destroy_cq_common(dev: *mut ionic_ibdev, cq: *mut ionic_cq) {
...
#[no_mangle]
unsafe extern "C" fn ionic_validate_qdesc_zero(q: *mut ionic_qdesc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_get_pdid(dev: *mut ionic_ibdev, pdid: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_get_ahid(dev: *mut ionic_ibdev, ahid: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_get_mrid(dev: *mut ionic_ibdev, mrid: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_get_gsi_qpid(dev: *mut ionic_ibdev, qpid: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_get_dbid(dev: *mut ionic_ibdev, dbid: *mut u32, addr: *mut phys_addr_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_put_dbid(dev: *mut ionic_ibdev, dbid: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_alloc_ucontext(ibctx: *mut ib_ucontext, udata: *mut ib_udata) -> c_int {
    ...
    let mut resp: ionic_ctx_resp = {};
    struct ionic_ctx_req req;
    let mut db_phys: phys_addr_t = 0;
    int rc;
...
// try to allocate dbid for user ctx
    ...
    PHYS_PFN(db_phys), 0, core::ptr::null_mut());
    if (!ctx.mmap_dbell) {
    rc = -ENOMEM;
    goto err_mmap_dbell;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ionic_dealloc_ucontext(ibctx: *mut ib_ucontext) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_mmap(ibctx: *mut ib_ucontext, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_mmap_free(rdma_entry: *mut rdma_user_mmap_entry) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_alloc_pd(ibpd: *mut ib_pd, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_dealloc_pd(ibpd: *mut ib_pd, udata: *mut ib_udata) -> c_int {
...
// (__be32 *)(hdr->grh.destination_gid.raw + 12) = hdr->ip4.daddr;
    ...
    rdma_ah_set_grh(ah_attr, core::ptr::null_mut(), flow_label, sgid_index, ttl, tos);
    ...
    let mut admin_flags: enum ionic_admin_flags = 0;
    let mut hdr_dma: dma_addr_t = 0;
    void *hdr_buf;
    let mut gfp: gfp_t = GFP_ATOMIC;
    int rc, hdr_len = 0;
...
#[no_mangle]
unsafe extern "C" fn ionic_destroy_ah_cmd(dev: *mut ionic_ibdev, ahid: u32, flags: u32) -> c_int {
    ...
    let mut admin_flags: enum ionic_admin_flags = IONIC_ADMIN_F_TEARDOWN;
...
//
    ...
    let mut resp: ionic_ah_resp = {};
    let mut flags: u32 = init_attr.flags;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn ionic_query_ah(ibah: *mut ib_ah, ah_attr: *mut rdma_ah_attr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_destroy_ah(ibah: *mut ib_ah, flags: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_destroy_mr_cmd(dev: *mut ionic_ibdev, mrid: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_dereg_mr(ibmr: *mut ib_mr, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_map_mr_page(ibmr: *mut ib_mr, dma: u64) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_alloc_mw(ibmw: *mut ib_mw, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_dealloc_mw(ibmw: *mut ib_mw) -> c_int {
    ...
    struct ionic_tbl_buf *buf)
    {
    let mut dbid: u16 = ionic_ctx_dbid(dev, ctx);
    struct ionic_admin_wr wr = {
    .work = COMPLETION_INITIALIZER_ONSTACK(wr.work),
    .wqe = {
...
#[no_mangle]
unsafe extern "C" fn ionic_destroy_cq_cmd(dev: *mut ionic_ibdev, cqid: u32) -> c_int {
    ...
    let mut buf: ionic_tbl_buf = {};
    let mut resp: ionic_cq_resp = {};
    struct ionic_cq_req req;
    let mut udma_idx: c_int = 0, rc;
    if (udata) {
    rc = ib_copy_validate_udata_in(udata, req, rsvd);
    if (rc)
    return rc;
...
#[no_mangle]
pub unsafe extern "C" fn ionic_destroy_cq(ibcq: *mut ib_cq, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pd_remote_privileged(pd: *mut ib_pd) -> bool {
    ...
    {
    let mut dbid: u16 = ionic_obj_dbid(dev, pd.ibpd.uobject);
    ...
    void *hdr_buf = core::ptr::null_mut();
    let mut hdr_dma: dma_addr_t = 0;
    int rc, hdr_len = 0;
    u16 sport;
...
// Account for hole and round down to the next order
    ...
    return -EBADRQC;
    if (qp.has_sq) {
    let mut expdb: bool = !!(qp.sq_cmb & IONIC_CMB_EXPDB);
...
#[no_mangle]
unsafe extern "C" fn ionic_destroy_qp_cmd(dev: *mut ionic_ibdev, qpid: u32) -> c_int {
    ...
    int max_data)
    {
    let mut expdb_stride_log2: u8 = 0;
    bool expdb;
    int rc;
    ...
    if (qp.sq_cmb & IONIC_CMB_ENABLE)
    rc = ionic_pgtbl_init(dev, buf, core::ptr::null_mut(),
    ...
    let mut sq_buf: ionic_tbl_buf = {}, rq_buf = {};
    struct ionic_pd *pd = to_ionic_pd(ibqp.pd);
    struct ionic_qp *qp = to_ionic_qp(ibqp);
    struct ionic_ctx *ctx =
    rdma_udata_to_drv_context(udata, struct ionic_ctx, ibctx);
    let mut resp: ionic_qp_resp = {};
    let mut req: ionic_qp_req = {};
    struct ionic_cq *cq;
    u8 udma_mask;
    void *entry;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn ionic_notify_flush_cq(cq: *mut ionic_cq) {
...
#[no_mangle]
unsafe extern "C" fn ionic_notify_qp_cqs(dev: *mut ionic_ibdev, qp: *mut ionic_qp) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_flush_qp(dev: *mut ionic_ibdev, qp: *mut ionic_qp) {
...
#[no_mangle]
unsafe extern "C" fn ionic_clean_cq(cq: *mut ionic_cq, qpid: u32) {
...
#[no_mangle]
unsafe extern "C" fn ionic_reset_qp(dev: *mut ionic_ibdev, qp: *mut ionic_qp) {
    ...
    let mut q_state: return = = IB_QPS_RTS || q_state == IB_QPS_SQD;
    return false;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ionic_destroy_qp(ibqp: *mut ib_qp, udata: *mut ib_udata) -> c_int {
