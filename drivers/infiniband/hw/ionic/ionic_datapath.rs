...
//! Source: drivers/infiniband/hw/ionic/ionic_datapath.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ionic_flush_recv(qp: *mut ionic_qp, wc: *mut ib_wc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_flush_send(qp: *mut ionic_qp, wc: *mut ib_wc) -> c_int {
    ...
    struct ib_wc *wc)
    {
    struct ionic_qp *qp = core::ptr::null_mut();
    struct ionic_rq_meta *meta;
...
#[no_mangle]
unsafe extern "C" fn ionic_peek_send(qp: *mut ionic_qp) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ionic_comp_msn(qp: *mut ionic_qp, cqe: *mut ionic_v1_cqe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_comp_npg(qp: *mut ionic_qp, cqe: *mut ionic_v1_cqe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_reserve_sync_cq(dev: *mut ionic_ibdev, cq: *mut ionic_cq) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_poll_cq(ibcq: *mut ib_cq, nwc: c_int, wc: *mut ib_wc) -> c_int {
...
pub unsafe extern "C" fn if(_arg: !rc) -> else {
    ...
    {
    let mut dbell_val: u64 = cq.q.dbell;
...
#[no_mangle]
pub unsafe extern "C" fn ionic_req_notify_cq(ibcq: *mut ib_cq, flags: enum ib_cq_notify_flags) -> c_int {
    int ionic_req_notify_cq(struct ib_cq *ibcq, enum ib_cq_notify_flags flags)
    {
    struct ionic_ibdev *dev = to_ionic_ibdev(ibcq.device);
    struct ionic_vcq *vcq = to_ionic_vcq(ibcq);
    let mut rc: c_int = 0, cq_i;
    ...
    {
    let mut bit_31: static s64 = 1u << 31;
    let mut len: i64 = 0, sg_len;
    int sg_i;
...
// greater than max inline data is invalid
    ...
    int num_sge)
    {
    let mut bit_31: static s64 = 1l << 31;
    struct ionic_sge *sgl;
    __be32 *spec32 = core::ptr::null_mut();
    __be16 *spec16 = core::ptr::null_mut();
    let mut len: i64 = 0, sg_len;
    let mut sg_i: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ionic_prep_sq_wqe(qp: *mut ionic_qp, wqe: *mut c_void) {
    static void ionic_prep_sq_wqe(struct ionic_qp *qp, void *wqe)
    {
    memset(wqe, 0, 1u << qp.sq.stride_log2);
    }
#[no_mangle]
unsafe extern "C" fn ionic_prep_rq_wqe(qp: *mut ionic_qp, wqe: *mut c_void) {
