...
//! Source: drivers/infiniband/hw/ionic/ionic_admin.c
#![no_std]
...
pub const IONIC_EQ_COUNT_MIN: c_int = 4;
pub const IONIC_AQ_COUNT_MIN: c_int = 1;
// not a valid queue position or negative error status
pub const IONIC_ADMIN_POSTED: c_uint = 0x10000;
// cpu can be held with irq disabled for COUNT * MS  (for create/destroy_ah)
pub const IONIC_ADMIN_BUSY_RETRY_COUNT: c_int = 2000;
pub const IONIC_ADMIN_BUSY_RETRY_MS: c_int = 1;
...
#[no_mangle]
unsafe extern "C" fn ionic_admin_timedout(aq: *mut ionic_aq) {
...
#[no_mangle]
unsafe extern "C" fn ionic_admin_reset_dwork(dev: *mut ionic_ibdev) {
...
#[no_mangle]
unsafe extern "C" fn ionic_admin_reset_wdog(aq: *mut ionic_aq) {
...
#[no_mangle]
unsafe extern "C" fn ionic_admin_poll_locked(aq: *mut ionic_aq) {
    ...
    aq.q_wr[wr.status].wr = core::ptr::null_mut();
    ...
    if (wr) {
    aq.q_wr[aq.q.cons].wr = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ionic_admin_dwork(ws: *mut work_struct) {
    static void ionic_admin_dwork(struct work_struct *ws)
    {
    struct ionic_ibdev *dev =
    container_of(ws, struct ionic_ibdev, admin_dwork.work);
    struct ionic_aq *aq, *bad_aq = core::ptr::null_mut();
    let mut do_reschedule: bool = false;
    unsigned long irqflags;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: do_reschedule) -> else {
    else if (do_reschedule)
// Try to poll again later
    ionic_admin_reset_dwork(dev);
    }
#[no_mangle]
unsafe extern "C" fn ionic_admin_work(ws: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ionic_admin_post_aq(aq: *mut ionic_aq, wr: *mut ionic_admin_wr) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_admin_post(dev: *mut ionic_ibdev, wr: *mut ionic_admin_wr) {
...
#[no_mangle]
unsafe extern "C" fn ionic_admin_cancel(wr: *mut ionic_admin_wr) {
...
#[no_mangle]
unsafe extern "C" fn ionic_admin_busy_wait(wr: *mut ionic_admin_wr) -> c_int {
...
//
    ...
    rc = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: timo ==) -> else {
    else if (timo == 0)
    rc = -ETIMEDOUT;
    else
    rc = timo;
...
#[no_mangle]
pub unsafe extern "C" fn ionic_rdma_reset_devcmd(dev: *mut ionic_ibdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_rdma_admincq_comp(ibcq: *mut ib_cq, cq_context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ionic_rdma_admincq_event(event: *mut ib_event, cq_context: *mut c_void) {
    ...
    vcq.udma_mask = 1;
    cq = &vcq.cq[0];
    rc = ionic_create_cq_common(vcq, &buf, &attr, core::ptr::null_mut(), core::ptr::null_mut(),
...
#[no_mangle]
unsafe extern "C" fn ionic_flush_qs(dev: *mut ionic_ibdev) {
...
#[no_mangle]
unsafe extern "C" fn ionic_kill_ibdev(dev: *mut ionic_ibdev, fatal_path: bool) {
    static void ionic_kill_ibdev(struct ionic_ibdev *dev, bool fatal_path)
    {
    unsigned long irqflags;
    let mut do_flush: bool = false;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn ionic_kill_rdma_admin(dev: *mut ionic_ibdev, fatal_path: bool) {
...
#[no_mangle]
unsafe extern "C" fn ionic_reset_work(ws: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ionic_next_eqe(eq: *mut ionic_eq, eqe: *mut ionic_v1_eqe) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ionic_cq_event(dev: *mut ionic_ibdev, cqid: u32, code: u8) {
...
#[no_mangle]
unsafe extern "C" fn ionic_qp_event(dev: *mut ionic_ibdev, qpid: u32, code: u8) {
...
#[no_mangle]
unsafe extern "C" fn ionic_poll_eq_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ionic_poll_eq_isr(irq: c_int, eqptr: *mut c_void) -> irqreturn_t {
    ...
    {
    let mut intr_obj: ionic_intr_info = { };
    struct ionic_eq *eq;
    int rc;
    eq = kzalloc_obj(*eq);
    if (!eq)
...
#[no_mangle]
unsafe extern "C" fn ionic_destroy_eq(eq: *mut ionic_eq) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_create_rdma_admin(dev: *mut ionic_ibdev) -> c_int {
    int ionic_create_rdma_admin(struct ionic_ibdev *dev)
    {
    let mut eq_i: c_int = 0, aq_i = 0, rc = 0;
    struct ionic_vcq *vcq;
    struct ionic_aq *aq;
    struct ionic_eq *eq;
    dev.eq_vec = core::ptr::null_mut();
    dev.aq_vec = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ionic_destroy_rdma_admin(dev: *mut ionic_ibdev) {
