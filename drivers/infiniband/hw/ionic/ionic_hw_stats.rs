...
//! Source: drivers/infiniband/hw/ionic/ionic_hw_stats.c
#![no_std]
...
// Copyright (C) 2018-2025, Advanced Micro Devices, Inc.
    ...
    {
    let mut off: c_uint = ionic_v1_stat_off(stat);
    let mut type: c_int = ionic_v1_stat_type(stat);
...
#[no_mangle]
unsafe extern "C" fn ionic_init_hw_stats(dev: *mut ionic_ibdev) -> c_int {
...
// alloc and init array of names, for alloc_hw_stats
    ...
    err_buf:
    dev.hw_stats_count = 0;
    dev.hw_stats = core::ptr::null_mut();
    dev.hw_stats_buf = core::ptr::null_mut();
    dev.hw_stats_hdrs = core::ptr::null_mut();
    return rc;
    }
...
#[no_mangle]
unsafe extern "C" fn ionic_counter_dealloc(counter: *mut rdma_counter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_counter_unbind_qp(ibqp: *mut ib_qp, port: u32) -> c_int {
    static int ionic_counter_unbind_qp(struct ib_qp *ibqp, u32 port)
    {
    struct ionic_qp *qp = to_ionic_qp(ibqp);
    if (ibqp.counter) {
    list_del(&qp.qp_list_counter);
    ibqp.counter = core::ptr::null_mut();
    }
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ionic_counter_update_stats(counter: *mut rdma_counter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_alloc_counters(dev: *mut ionic_ibdev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ionic_counter_init(counter: *mut rdma_counter) {
...
#[no_mangle]
pub unsafe extern "C" fn ionic_stats_init(dev: *mut ionic_ibdev) {
    void ionic_stats_init(struct ionic_ibdev *dev)
    {
    let mut stats_type: u16 = dev.lif_cfg.stats_type;
    int rc;
    ...
    dev.counter_stats = core::ptr::null_mut();
    return;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ionic_stats_cleanup(dev: *mut ionic_ibdev) {
