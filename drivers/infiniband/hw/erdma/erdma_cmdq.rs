...
//! Source: drivers/infiniband/hw/erdma/erdma_cmdq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn arm_cmdq_cq(cmdq: *mut erdma_cmdq) {
...
#[no_mangle]
unsafe extern "C" fn kick_cmdq_db(cmdq: *mut erdma_cmdq) {
    static void kick_cmdq_db(struct erdma_cmdq *cmdq)
    {
    struct erdma_dev *dev = container_of(cmdq, struct erdma_dev, cmdq);
    let mut db_data: u64 = FIELD_PREP(ERDMA_CMD_HDR_WQEBB_INDEX_MASK, cmdq.sq.pi);
...
#[no_mangle]
unsafe extern "C" fn erdma_cmdq_sq_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_cmdq_cq_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_cmdq_eq_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_cmdq_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_finish_cmdq_init(dev: *mut erdma_dev) {
    void erdma_finish_cmdq_init(struct erdma_dev *dev)
    {
    arm_cmdq_cq(&dev.cmdq);
    }
#[no_mangle]
pub unsafe extern "C" fn erdma_cmdq_destroy(dev: *mut erdma_dev) {
    ...
    return owner ^ !!(cmdq.cq.ci & cmdq.cq.depth) ? cqe : core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn erdma_poll_single_cmd_completion(cmdq: *mut erdma_cmdq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_polling_cmd_completions(cmdq: *mut erdma_cmdq) {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_cmdq_completion_handler(cmdq: *mut erdma_cmdq) {
    void erdma_cmdq_completion_handler(struct erdma_cmdq *cmdq)
    {
    let mut got_event: c_int = 0;
    ...
    {
    let mut comp_timeout: c_ulong = jiffies + msecs_to_jiffies(timeout);
    while (1) {
    erdma_polling_cmd_completions(cmdq);
...
#[no_mangle]
pub unsafe extern "C" fn erdma_cmdq_build_reqhdr(hdr: *mut u64, mod: u32, op: u32) {
