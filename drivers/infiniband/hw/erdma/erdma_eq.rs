...
//! Source: drivers/infiniband/hw/erdma/erdma_eq.c
#![no_std]
...
pub const MAX_POLL_CHUNK_SIZE: c_int = 16;
#[no_mangle]
pub unsafe extern "C" fn notify_eq(eq: *mut erdma_eq) {
...
// eq->dbrec = db_data;
    ...
    let mut owner: u32 = FIELD_GET(ERDMA_CEQE_HDR_O_MASK, READ_ONCE(*eqe));
    return owner ^ !!(eq.ci & eq.depth) ? eqe : core::ptr::null_mut();
    }
#[no_mangle]
pub unsafe extern "C" fn erdma_aeq_event_handler(dev: *mut erdma_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_eq_common_init(dev: *mut erdma_dev, eq: *mut erdma_eq, depth: u32) -> c_int {
    int erdma_eq_common_init(struct erdma_dev *dev, struct erdma_eq *eq, u32 depth)
    {
    let mut buf_size: u32 = depth << EQE_SHIFT;
...
#[no_mangle]
pub unsafe extern "C" fn erdma_eq_destroy(dev: *mut erdma_dev, eq: *mut erdma_eq) {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_aeq_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_ceq_completion_handler(ceq_cb: *mut erdma_eq_cb) {
...
#[no_mangle]
unsafe extern "C" fn erdma_intr_ceq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn erdma_intr_ceq_task(data: c_ulong) {
    static void erdma_intr_ceq_task(unsigned long data)
    {
    erdma_ceq_completion_handler((struct erdma_eq_cb *)data);
    }
#[no_mangle]
unsafe extern "C" fn erdma_set_ceq_irq(dev: *mut erdma_dev, ceqn: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_free_ceq_irq(dev: *mut erdma_dev, ceqn: u16) {
    static void erdma_free_ceq_irq(struct erdma_dev *dev, u16 ceqn)
    {
    struct erdma_eq_cb *eqc = &dev.ceqs[ceqn];
    irq_set_affinity_hint(eqc.irq.msix_vector, core::ptr::null_mut());
    free_irq(eqc.irq.msix_vector, eqc);
    tasklet_kill(&eqc.tasklet);
    }
#[no_mangle]
unsafe extern "C" fn create_eq_cmd(dev: *mut erdma_dev, eqn: u32, eq: *mut erdma_eq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_ceq_init_one(dev: *mut erdma_dev, ceqn: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_ceq_uninit_one(dev: *mut erdma_dev, ceqn: u16) {
...
// CEQ indexed from 1, 0 rsvd for CMDQ-EQ.
    ...
    err = erdma_post_cmd_wait(&dev.cmdq, &req, sizeof(req), core::ptr::null_mut(), core::ptr::null_mut(),
    false);
    if (err)
    return;
    erdma_eq_destroy(dev, eq);
...
#[no_mangle]
pub unsafe extern "C" fn erdma_ceqs_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_ceqs_uninit(dev: *mut erdma_dev) {
