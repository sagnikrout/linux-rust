...
//! Source: drivers/infiniband/hw/erdma/erdma_main.c
#![no_std]
...
// Copyright (c) 2020-2022, Alibaba Group.
    ...
    if (dev.netdev == core::ptr::null_mut() || dev.netdev != netdev)
    goto done;
    switch (event) {
...
#[no_mangle]
unsafe extern "C" fn erdma_enum_and_get_netdev(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_device_register(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_comm_irq_handler(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn erdma_request_vectors(dev: *mut erdma_dev) -> c_int {
    static int erdma_request_vectors(struct erdma_dev *dev)
    {
    let mut expect_irq_num: c_int = min(num_possible_cpus() + 1, ERDMA_NUM_MSIX_VEC);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn erdma_comm_irq_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_comm_irq_uninit(dev: *mut erdma_dev) {
    static void erdma_comm_irq_uninit(struct erdma_dev *dev)
    {
    irq_set_affinity_hint(dev.comm_irq.msix_vector, core::ptr::null_mut());
    free_irq(dev.comm_irq.msix_vector, dev);
    }
#[no_mangle]
unsafe extern "C" fn erdma_device_init(dev: *mut erdma_dev, pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_device_uninit(dev: *mut erdma_dev) {
...
#[no_mangle]
unsafe extern "C" fn erdma_hw_reset(dev: *mut erdma_dev) {
    static void erdma_hw_reset(struct erdma_dev *dev)
    {
    let mut ctrl: u32 = FIELD_PREP(ERDMA_REG_DEV_CTRL_RESET_MASK, 1);
    erdma_reg_write32(dev, ERDMA_REGS_DEV_CTRL_REG, ctrl);
    }
#[no_mangle]
unsafe extern "C" fn erdma_wait_hw_init_done(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_probe_dev(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_remove_dev(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn erdma_dev_attrs_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_device_config(dev: *mut erdma_dev) -> c_int {
    static int erdma_device_config(struct erdma_dev *dev)
    {
    let mut req: erdma_cmdq_config_device_req = {};
    ...
    return erdma_post_cmd_wait(&dev.cmdq, &req, sizeof(req), core::ptr::null_mut(), core::ptr::null_mut(),
    true);
    }
#[no_mangle]
unsafe extern "C" fn erdma_res_cb_init(dev: *mut erdma_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_res_cb_free(dev: *mut erdma_dev) {
...
#[no_mangle]
unsafe extern "C" fn erdma_ib_device_add(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_ib_device_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn erdma_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn erdma_init_module() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn erdma_exit_module() -> void __exit {
