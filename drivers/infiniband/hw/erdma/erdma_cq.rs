...
//! Source: drivers/infiniband/hw/erdma/erdma_cq.c
#![no_std]
...
// Copyright (c) 2020-2022, Alibaba Group.
    ...
    return owner ^ !!(cq.kern_cq.ci & cq.depth) ? cqe : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn notify_cq(cq: *mut erdma_cq, solcitied: u8) {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_req_notify_cq(ibcq: *mut ib_cq, flags: enum ib_cq_notify_flags) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn erdma_process_ud_cqe(cqe: *mut erdma_cqe, wc: *mut ib_wc) {
...
pub const ERDMA_POLLCQ_NO_QP: c_int = 1;
#[no_mangle]
unsafe extern "C" fn erdma_poll_one_cqe(cq: *mut erdma_cq, wc: *mut ib_wc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_poll_cq(ibcq: *mut ib_cq, num_entries: c_int, wc: *mut ib_wc) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn erdma_remove_cqes_of_qp(ibcq: *mut ib_cq, qpn: u32) {
    void erdma_remove_cqes_of_qp(struct ib_cq *ibcq, u32 qpn)
    {
    struct erdma_cq *cq = to_ecq(ibcq);
    struct erdma_cqe *cqe, *dst_cqe;
    u32 prev_cq_ci, cur_cq_ci;
    let mut ncqe: u32 = 0, nqp_cqe = 0;
    unsigned long flags;
    u8 owner;
    spin_lock_irqsave(&cq.kern_cq.lock, flags);
    prev_cq_ci = cq.kern_cq.ci;
    while (ncqe < cq.depth && (cqe = get_next_valid_cqe(cq)) != core::ptr::null_mut()) {
    ++cq.kern_cq.ci;
    ++ncqe;
    }
    while (ncqe > 0) {
