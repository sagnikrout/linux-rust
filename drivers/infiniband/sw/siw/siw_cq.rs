...
//! Source: drivers/infiniband/sw/siw/siw_cq.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn siw_reap_cqe(cq: *mut siw_cq, wc: *mut ib_wc) -> c_int {
...
//
    let mut opcode: u8 = cqe.opcode;
    let mut status: u16 = cqe.status;
...
//
#[no_mangle]
pub unsafe extern "C" fn siw_cq_flush(cq: *mut siw_cq) {
