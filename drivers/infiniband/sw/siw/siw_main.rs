...
//! Source: drivers/infiniband/sw/siw/siw_main.c
#![no_std]
...
// Attach siw also with loopback devices
    let mut loopback_enabled: bool = true;
...
// Select MPA version to be used during connection setup
    let mut mpa_version: u_char = MPA_REVISION_2;
...
#[no_mangle]
unsafe extern "C" fn siw_device_register(sdev: *mut siw_device, name: *const c_char) -> c_int {
    static int siw_device_register(struct siw_device *sdev, const char *name)
    {
    struct ib_device *base_dev = &sdev.base_dev;
    let mut dev_id: static int = 1;
    int rv;
    sdev.vendor_part_id = dev_id++;
    rv = ib_register_device(base_dev, name, core::ptr::null_mut());
    if (rv) {
...
#[no_mangle]
unsafe extern "C" fn siw_device_cleanup(base_dev: *mut ib_device) {
...
#[no_mangle]
unsafe extern "C" fn siw_dev_qualified(netdev: *mut net_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siw_destroy_cpulist(number: c_int) {
    ...
    siw_cpu_info.tx_valid_cpus = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn siw_init_cpulist() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn siw_get_tx_cpu(sdev: *mut siw_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn siw_put_tx_cpu(cpu: c_int) {
...
//
    ...
    {
    struct siw_device *sdev = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn siw_newlink(basedev_name: *const c_char, netdev: *mut net_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn siw_init_module() -> __init int {
...
#[no_mangle]
unsafe extern "C" fn siw_exit_module() -> void __exit {
