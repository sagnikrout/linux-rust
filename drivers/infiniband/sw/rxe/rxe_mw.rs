...
//! Source: drivers/infiniband/sw/rxe/rxe_mw.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rxe_alloc_mw(ibmw: *mut ib_mw, udata: *mut ib_udata) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_dealloc_mw(ibmw: *mut ib_mw) -> c_int {
...
// o10-37.2.40
    ...
    rxe_dbg_mw(mw,
    "attempt to invalidate type 2 MW by binding with core::ptr::null_mut() or zero length MR\n");
    return -EINVAL;
    }
    }
// C10-72
...
// C10-75
    ...
    struct rxe_mw *mw, struct rxe_mr *mr, int access)
    {
    let mut key: u32 = wqe.wr.wr.mw.rkey & 0xff;
...
#[no_mangle]
pub unsafe extern "C" fn rxe_bind_mw(qp: *mut rxe_qp, wqe: *mut rxe_send_wqe) -> c_int {
    ...
    let mut mw_rkey: u32 = wqe.wr.wr.mw.mw_rkey;
    let mut mr_lkey: u32 = wqe.wr.wr.mw.mr_lkey;
    let mut access: c_int = wqe.wr.wr.mw.access;
...
#[no_mangle]
unsafe extern "C" fn rxe_check_invalidate_mw(qp: *mut rxe_qp, mw: *mut rxe_mw) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rxe_do_invalidate_mw(mw: *mut rxe_mw) {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_invalidate_mw(qp: *mut rxe_qp, rkey: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_mw_cleanup(elem: *mut rxe_pool_elem) {
