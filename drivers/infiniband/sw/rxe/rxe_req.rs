...
//! Source: drivers/infiniband/sw/rxe/rxe_req.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn req_retry(qp: *mut rxe_qp) {
...
#[no_mangle]
pub unsafe extern "C" fn rnr_nak_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn req_check_sq_drain_done(qp: *mut rxe_qp) {
...
// comp not done yet
    ...
    {
    struct rxe_queue *q = qp.sq.queue;
    let mut index: c_uint = qp.req.wqe_index;
    unsigned int prod;
    prod = queue_get_producer(q, QUEUE_TYPE_FROM_CLIENT);
    if (index == prod)
...
//
#[no_mangle]
unsafe extern "C" fn rxe_wqe_is_fenced(qp: *mut rxe_qp, wqe: *mut rxe_send_wqe) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn next_opcode_rc(qp: *mut rxe_qp, opcode: u32, fits: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn next_opcode_uc(qp: *mut rxe_qp, opcode: u32, fits: c_int) -> c_int {
    ...
    u32 opcode)
    {
    let mut fits: c_int = (wqe.dma.resid <= qp.mtu);
    switch (qp_type(qp)) {
    case IB_QPT_RC:
...
#[no_mangle]
pub unsafe extern "C" fn check_init_depth(qp: *mut rxe_qp, wqe: *mut rxe_send_wqe) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn get_mtu(qp: *mut rxe_qp) -> c_int {
    ...
    let mut pad: c_int = (-payload) & 0x3;
    int			paylen;
    int			solicited;
    u32			qp_num;
    let mut ack_req: c_int = 0;
...
// number of packets left to send including current one
    let mut num_pkt: c_int = (wqe.dma.resid + payload + qp.mtu - 1) / qp.mtu;
...
#[no_mangle]
unsafe extern "C" fn update_state(qp: *mut rxe_qp, pkt: *mut rxe_pkt_info) {
...
#[no_mangle]
unsafe extern "C" fn rxe_do_local_ops(qp: *mut rxe_qp, wqe: *mut rxe_send_wqe) -> c_int {
    static int rxe_do_local_ops(struct rxe_qp *qp, struct rxe_send_wqe *wqe)
    {
    let mut opcode: u8 = wqe.wr.opcode;
    u32 rkey;
    int ret;
    switch (opcode) {
    case IB_WR_LOCAL_INV:
...
#[no_mangle]
pub unsafe extern "C" fn rxe_requester(qp: *mut rxe_qp) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_sender(qp: *mut rxe_qp) -> c_int {
