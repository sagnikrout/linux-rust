...
//! Source: drivers/infiniband/sw/rxe/rxe_av.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rxe_init_av(attr: *mut rdma_ah_attr, av: *mut rxe_av) {
...
#[no_mangle]
unsafe extern "C" fn chk_attr(obj: *mut c_void, attr: *mut rdma_ah_attr, obj_is_ah: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_av_chk_attr(qp: *mut rxe_qp, attr: *mut rdma_ah_attr) -> c_int {
    int rxe_av_chk_attr(struct rxe_qp *qp, struct rdma_ah_attr *attr)
    {
    return chk_attr(qp, attr, false);
    }
#[no_mangle]
pub unsafe extern "C" fn rxe_ah_chk_attr(ah: *mut rxe_ah, attr: *mut rdma_ah_attr) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_av_to_attr(av: *mut rxe_av, attr: *mut rdma_ah_attr) {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_av_fill_ip_info(av: *mut rxe_av, attr: *mut rdma_ah_attr) {
