...
//! Source: drivers/infiniband/sw/rxe/rxe_mcast.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn rxe_mcast_add(rxe: *mut rxe_dev, mgid: *mut union ib_gid) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn rxe_mcast_del(rxe: *mut rxe_dev, mgid: *mut union ib_gid) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __rxe_insert_mcg(mcg: *mut rxe_mcg) {
...
//
#[no_mangle]
unsafe extern "C" fn __rxe_remove_mcg(mcg: *mut rxe_mcg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxe_cleanup_mcg(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn __rxe_destroy_mcg(mcg: *mut rxe_mcg) {
...
//
#[no_mangle]
unsafe extern "C" fn rxe_destroy_mcg(mcg: *mut rxe_mcg) {
...
//
#[no_mangle]
unsafe extern "C" fn rxe_attach_mcg(mcg: *mut rxe_mcg, qp: *mut rxe_qp) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __rxe_cleanup_mca(mca: *mut rxe_mca, mcg: *mut rxe_mcg) {
...
//
#[no_mangle]
unsafe extern "C" fn rxe_detach_mcg(mcg: *mut rxe_mcg, qp: *mut rxe_qp) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxe_attach_mcast(ibqp: *mut ib_qp, mgid: *mut union ib_gid, mlid: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn rxe_detach_mcast(ibqp: *mut ib_qp, mgid: *mut union ib_gid, mlid: u16) -> c_int {
