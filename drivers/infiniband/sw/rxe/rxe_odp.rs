...
//! Source: drivers/infiniband/sw/rxe/rxe_odp.c
#![no_std]
...
pub const RXE_PAGEFAULT_DEFAULT: c_int = 0;

#[no_mangle]
unsafe extern "C" fn rxe_odp_do_pagefault_and_lock(mr: *mut rxe_mr, user_va: u64, bcnt: c_int, flags: u32) -> c_int {
    static int rxe_odp_do_pagefault_and_lock(struct rxe_mr *mr, u64 user_va, int bcnt, u32 flags)
    {
    struct ib_umem_odp *umem_odp = to_ib_umem_odp(mr.umem);
    let mut fault: bool = !(flags & RXE_PAGEFAULT_SNAPSHOT);
...
#[no_mangle]
unsafe extern "C" fn rxe_odp_init_pages(mr: *mut rxe_mr) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rxe_odp_iova_to_index(umem_odp: *mut ib_umem_odp, iova: u64) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn rxe_odp_iova_to_page_offset(umem_odp: *mut ib_umem_odp, iova: u64) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn rxe_odp_map_range_and_lock(mr: *mut rxe_mr, iova: u64, length: c_int, flags: u32) -> c_int {
...
// umem_mutex is locked on success.
    ...
    {
    struct ib_umem_odp *umem_odp = to_ib_umem_odp(mr.umem);
    let mut flags: u32 = RXE_PAGEFAULT_DEFAULT;
    int err;
    if (length == 0)
    return 0;
...
#[no_mangle]
pub unsafe extern "C" fn rxe_odp_do_atomic_write(mr: *mut rxe_mr, iova: u64, value: u64) -> enum resp_states {
...
#[no_mangle]
unsafe extern "C" fn rxe_ib_prefetch_mr_work(w: *mut work_struct) {
...
//
    ...
    {
    struct rxe_pd *pd = container_of(ibpd, struct rxe_pd, ibpd);
    let mut pf_flags: u32 = RXE_PAGEFAULT_DEFAULT;
    struct prefetch_mr_work *work;
    struct rxe_mr *mr;
    u32 i;
