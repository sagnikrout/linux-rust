...
//! Source: drivers/infiniband/sw/rxe/rxe_comp.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rnrnak_jiffies(timeout: u8) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn wr_to_wc_opcode(opcode: enum ib_wr_opcode) -> enum ib_wc_opcode {
...
#[no_mangle]
pub unsafe extern "C" fn retransmit_timer(t: *mut timer_list) {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_comp_queue_pkt(qp: *mut rxe_qp, skb: *mut sk_buff) {
...
#[no_mangle]
pub unsafe extern "C" fn reset_retry_counters(qp: *mut rxe_qp) {
...
//
    ...
    {
    int ret;
    let mut atomic_orig: u64 = atmack_orig(pkt);
    ret = copy_data(qp.pd, IB_ACCESS_LOCAL_WRITE,
    &wqe.dma, &atomic_orig,
...
//
#[no_mangle]
unsafe extern "C" fn do_complete(qp: *mut rxe_qp, wqe: *mut rxe_send_wqe) {
...
#[no_mangle]
unsafe extern "C" fn comp_check_sq_drain_done(qp: *mut rxe_qp) {
...
#[no_mangle]
unsafe extern "C" fn drain_resp_pkts(qp: *mut rxe_qp) {
...
#[no_mangle]
unsafe extern "C" fn flush_send_wqe(qp: *mut rxe_qp, wqe: *mut rxe_send_wqe) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn flush_send_queue(qp: *mut rxe_qp, notify: bool) {
...
#[no_mangle]
unsafe extern "C" fn free_pkt(pkt: *mut rxe_pkt_info) {
...
//
#[no_mangle]
unsafe extern "C" fn reset_retry_timer(qp: *mut rxe_qp) {
...
#[no_mangle]
pub unsafe extern "C" fn rxe_completer(qp: *mut rxe_qp) -> c_int {
    int rxe_completer(struct rxe_qp *qp)
    {
    struct rxe_dev *rxe = to_rdev(qp.ibqp.device);
    struct rxe_send_wqe *wqe = core::ptr::null_mut();
