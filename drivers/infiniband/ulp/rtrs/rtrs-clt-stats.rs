...
//! Source: drivers/infiniband/ulp/rtrs/rtrs-clt-stats.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_update_wc_stats(con: *mut rtrs_clt_con) {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_inc_failover_cnt(stats: *mut rtrs_clt_stats) {
    void rtrs_clt_inc_failover_cnt(struct rtrs_clt_stats *stats)
    {
    this_cpu_inc(stats.pcpu_stats.rdma.failover_cnt);
    }
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_stats_migration_from_cnt_to_str(stats: *mut rtrs_clt_stats, buf: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_stats_migration_to_cnt_to_str(stats: *mut rtrs_clt_stats, buf: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_stats_reconnects_to_str(stats: *mut rtrs_clt_stats, buf: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_stats_rdma_to_str(stats: *mut rtrs_clt_stats, page: *mut c_char) -> isize {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_reset_all_help(s: *mut rtrs_clt_stats, page: *mut c_char) -> isize {
    ssize_t rtrs_clt_reset_all_help(struct rtrs_clt_stats *s, char *page)
    {
    return sysfs_emit(page, "echo 1 to reset all statistics\n");
    }
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_reset_rdma_stats(stats: *mut rtrs_clt_stats, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_reset_cpu_migr_stats(stats: *mut rtrs_clt_stats, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_reset_reconnects_stat(stats: *mut rtrs_clt_stats, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_reset_all_stats(s: *mut rtrs_clt_stats, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_update_all_stats(req: *mut rtrs_clt_io_req, dir: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_clt_init_stats(stats: *mut rtrs_clt_stats) -> c_int {
