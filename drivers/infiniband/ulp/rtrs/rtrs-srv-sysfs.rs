...
//! Source: drivers/infiniband/ulp/rtrs/rtrs-srv-sysfs.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn rtrs_srv_release(kobj: *mut kobject) {
...
// first remove sysfs itself to avoid deadlock
    ...
    __ATTR(hca_port, 0444, rtrs_srv_hca_port_show, core::ptr::null_mut());
    ...
    __ATTR(hca_name, 0444, rtrs_srv_hca_name_show, core::ptr::null_mut());
    ...
    __ATTR(src_addr, 0444, rtrs_srv_src_addr_show, core::ptr::null_mut());
    ...
    __ATTR(dst_addr, 0444, rtrs_srv_dst_addr_show, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn rtrs_srv_create_once_sysfs_root_folders(srv_path: *mut rtrs_srv_path) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rtrs_srv_path_stats_release(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn rtrs_srv_create_stats_files(srv_path: *mut rtrs_srv_path) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_srv_create_path_files(srv_path: *mut rtrs_srv_path) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn rtrs_srv_destroy_path_files(srv_path: *mut rtrs_srv_path) {
