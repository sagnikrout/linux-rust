...
//! Source: drivers/ata/pata_hpt37x.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_find_mode(ap: *mut ata_port, speed: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn hpt370_filter(adev: *mut ata_device, mask: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn hpt370a_filter(adev: *mut ata_device, mask: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn hpt372_filter(adev: *mut ata_device, mask: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpt374_fn1_cable_detect(ap: *mut ata_port) -> c_int {
    static int hpt374_fn1_cable_detect(struct ata_port *ap)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut mcrbase: c_uint = 0x50 + 4 * ap.port_no;
    u16 mcr3;
    u8 ata66;
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
// Is it HPT370/A?
    ...
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut addr: c_int = 0x40 + 4 * (adev.devno + 2 * ap.port_no);
    u32 reg, timing, mask;
// Determine timing mask and find matching mode entry
    if (mode < XFER_MW_DMA_0)
    mask = 0xcfc3ffff;
#[no_mangle]
pub unsafe extern "C" fn if(XFER_UDMA_0: mode <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt370_bmdma_stop(qc: *mut ata_queued_cmd) {
    static void hpt370_bmdma_stop(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    void __iomem *bmdma = ap.ioaddr.bmdma_addr;
    let mut dma_stat: u8 = ioread8(bmdma + ATA_DMA_STATUS);
    u8 dma_cmd;
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_bmdma_stop(qc: *mut ata_queued_cmd) {
    static void hpt37x_bmdma_stop(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut mscreg: c_int = 0x50 + 4 * ap.port_no;
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_clock_slot(freq: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_calibrate_dpll(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpt37x_pci_clock(pdev: *mut pci_dev, base: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpt37x_init_one(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// HPT374 - UDMA100, function 1 uses different cable_detect method
    ...
    void *private_data = core::ptr::null_mut();
    const struct ata_port_info *ppi[] = { core::ptr::null_mut(), core::ptr::null_mut() };
    let mut rev: u8 = dev.revision;
    u8 irqmask;
    u8 mcr1;
    unsigned int freq; /* MHz */
    let mut prefer_dpll: c_int = 1;
    let mut iobase: c_ulong = pci_resource_start(dev, 4);
...
//
    ...
    if (chip_table.clocks[clock_slot] == core::ptr::null_mut() || prefer_dpll) {
//
