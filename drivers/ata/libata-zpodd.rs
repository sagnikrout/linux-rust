...
//! Source: drivers/ata/libata-zpodd.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct zpodd {
    pub /: *mut *mut enum odd_mech_type mech_type; / init during probe, RO afterwards,
    pub dev: *mut ata_device,
// The following fields are synchronized by PM core.
    pub of: *mut *mut bool from_notify; / resumed as a result,
// acpi wake notification
    pub /: *mut *mut bool zp_ready; / ZP ready state,
    pub /: *mut *mut unsigned long last_ready; / last ZP ready timestamp,
    pub /: *mut *mut bool zp_sampled; / ZP ready state sampled,
    pub off: *mut *mut bool powered_off; / ODD is powered,
// during suspend
}

#[no_mangle]
unsafe extern "C" fn eject_tray(dev: *mut ata_device) -> c_int {
    ...
    return ata_exec_internal(dev, &tf, cdb, DMA_NONE, core::ptr::null_mut(), 0, 0);
    }
// Per the spec, only slot type and drawer type ODD can be supported
#[no_mangle]
unsafe extern "C" fn zpodd_get_mech_type(dev: *mut ata_device) -> enum odd_mech_type {
...
#[no_mangle]
unsafe extern "C" fn zpready(dev: *mut ata_device) -> bool {
...
// no media inside
    let mut asc: return = = 0x3a;
    else
// no media inside and door closed
    let mut asc: return = = 0x3a && ascq == 0x01;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn zpodd_on_suspend(dev: *mut ata_device) {
...
#[no_mangle]
pub unsafe extern "C" fn zpodd_zpready(dev: *mut ata_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn zpodd_enable_run_wake(dev: *mut ata_device) {
...
#[no_mangle]
pub unsafe extern "C" fn zpodd_disable_run_wake(dev: *mut ata_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn zpodd_post_poweron(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn zpodd_wake_dev(handle: acpi_handle, event: u32, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn ata_acpi_add_pm_notifier(dev: *mut ata_device) {
    static void ata_acpi_add_pm_notifier(struct ata_device *dev)
    {
    let mut handle: acpi_handle = ata_dev_acpi_handle(dev);
    acpi_install_notify_handler(handle, ACPI_SYSTEM_NOTIFY,
    zpodd_wake_dev, dev);
    }
#[no_mangle]
unsafe extern "C" fn ata_acpi_remove_pm_notifier(dev: *mut ata_device) {
...
#[no_mangle]
pub unsafe extern "C" fn zpodd_init(dev: *mut ata_device) {
...
#[no_mangle]
pub unsafe extern "C" fn zpodd_exit(dev: *mut ata_device) {
