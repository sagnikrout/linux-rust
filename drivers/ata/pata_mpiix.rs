...
//! Source: drivers/ata/pata_mpiix.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn mpiix_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
    static int mpiix_pre_reset(struct ata_link *link, unsigned long deadline)
    {
    struct ata_port *ap = link.ap;
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut mpiix_enable_bits: static struct pci_bits = { 0x6D, 1, 0x80, 0x80 };
...
//
#[no_mangle]
unsafe extern "C" fn mpiix_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn mpiix_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mpiix_init_one(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
