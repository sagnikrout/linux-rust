...
//! Source: drivers/ata/acard-ahci.c
#![no_std]
...
//
pub const ACARD_AHCI_RX_FIS_SZ: c_int = 128;
    enum {
    AHCI_PCI_BAR		= 5,
    };
    enum board_ids {
...
pub struct acard_sg {
    ...
    pub addr_hi: __le32,
    pub reserved: __le32,
    pub /: *mut *mut __le32 size; / bit 31 (EOT) max==0x10000 (64k),
}
...
#[no_mangle]
unsafe extern "C" fn acard_ahci_pci_device_suspend(pdev: *mut pci_dev, mesg: pm_message_t) -> c_int {
    static int acard_ahci_pci_device_suspend(struct pci_dev *pdev, pm_message_t mesg)
    {
...
#[no_mangle]
unsafe extern "C" fn acard_ahci_pci_device_resume(pdev: *mut pci_dev) -> c_int {
    static int acard_ahci_pci_device_resume(struct pci_dev *pdev)
    {
    struct ata_host *host = pci_get_drvdata(pdev);
    int rc;
...
#[no_mangle]
unsafe extern "C" fn acard_ahci_pci_print_info(host: *mut ata_host) {
    ...
    scc_s = "IDE";
#[no_mangle]
pub unsafe extern "C" fn if(PCI_CLASS_STORAGE_SATA: cc ==) -> else {
    else if (cc == PCI_CLASS_STORAGE_SATA)
    scc_s = "SATA";
#[no_mangle]
pub unsafe extern "C" fn if(PCI_CLASS_STORAGE_RAID: cc ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn acard_ahci_fill_sg(qc: *mut ata_queued_cmd, cmd_tbl: *mut c_void) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn acard_ahci_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    static enum ata_completion_errors acard_ahci_qc_prep(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn acard_ahci_qc_fill_rtf(qc: *mut ata_queued_cmd) {
    static void acard_ahci_qc_fill_rtf(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn acard_ahci_port_start(ap: *mut ata_port) -> c_int {
    static int acard_ahci_port_start(struct ata_port *ap)
    {
...
#[no_mangle]
unsafe extern "C" fn acard_ahci_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int acard_ahci_init_one(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    let mut board_id: c_uint = ent.driver_data;
    let mut pi: ata_port_info = acard_ahci_port_info[board_id];
