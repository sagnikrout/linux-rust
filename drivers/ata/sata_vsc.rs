...
#[no_mangle]
unsafe extern "C" fn vsc_freeze(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn vsc_thaw(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn vsc_intr_mask_update(ap: *mut ata_port, ctl: u8) {
...
#[no_mangle]
unsafe extern "C" fn vsc_sata_tf_load(ap: *mut ata_port, tf: *const ata_taskfile) {
...
#[no_mangle]
unsafe extern "C" fn vsc_sata_tf_read(ap: *mut ata_port, tf: *mut ata_taskfile) {
...
#[no_mangle]
pub unsafe extern "C" fn vsc_error_intr(port_status: u8, ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn vsc_port_intr(port_status: u8, ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn vsc_sata_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    ...
    let mut port_status: u8 = (status >> (8 * i)) & 0xff;
    if (port_status) {
...
#[no_mangle]
unsafe extern "C" fn vsc_sata_setup_port(port: *mut ata_ioports, base: *mut void __iomem) {
...
// map IO regions and initialize host accordingly
    ...
    let mut offset: c_uint = (i + 1) * VSC_SATA_PORT_OFFSET;
