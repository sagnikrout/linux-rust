...
//! Source: drivers/ata/pata_ftide010.c
#![no_std]
...
pub struct ftide010 {
    ...
    pub master_cbl: c_uint,
    pub slave_cbl: c_uint,
// Gemini-specific properties
    pub sg: *mut sata_gemini,
    pub master_to_sata0: bool,
    pub slave_to_sata0: bool,
    pub master_to_sata1: bool,
    pub slave_to_sata1: bool,
}

pub const FTIDE010_DMA_REG: c_uint = 0x00;
pub const FTIDE010_DMA_STATUS: c_uint = 0x02;
pub const FTIDE010_IDE_BMDTPR: c_uint = 0x04;
pub const FTIDE010_IDE_DEVICE_ID: c_uint = 0x08;
pub const FTIDE010_PIO_TIMING: c_uint = 0x10;
pub const FTIDE010_MWDMA_TIMING: c_uint = 0x11;
pub const FTIDE010_UDMA_TIMING0: c_uint = 0x12 /* Master */;
pub const FTIDE010_UDMA_TIMING1: c_uint = 0x13 /* Slave */;
pub const FTIDE010_CLK_MOD: c_uint = 0x14;
// These registers are mapped directly to the IDE registers
pub const FTIDE010_CMD_DATA: c_uint = 0x20;
pub const FTIDE010_ERROR_FEATURES: c_uint = 0x21;
pub const FTIDE010_NSECT: c_uint = 0x22;
pub const FTIDE010_LBAL: c_uint = 0x23;
pub const FTIDE010_LBAM: c_uint = 0x24;
pub const FTIDE010_LBAH: c_uint = 0x25;
pub const FTIDE010_DEVICE: c_uint = 0x26;
pub const FTIDE010_STATUS_COMMAND: c_uint = 0x27;
pub const FTIDE010_ALTSTAT_CTRL: c_uint = 0x36;
...
#[no_mangle]
unsafe extern "C" fn ftide010_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ftide010_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ftide010_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn pata_ftide010_gemini_port_stop(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn pata_ftide010_gemini_cable_detect(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pata_ftide010_probe(pdev: *mut platform_device) -> c_int {
    static int pata_ftide010_probe(struct platform_device *pdev)
    {
    struct device *dev = &pdev.dev;
    struct device_node *np = dev.of_node;
    let mut pi: ata_port_info = ftide010_port_info;
...
#[no_mangle]
unsafe extern "C" fn pata_ftide010_remove(pdev: *mut platform_device) {
