...
//! Source: drivers/ata/libata-eh.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ata_eh_cmd_timeout_ent {
    pub commands: *const u8,
    pub timeouts: *const c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn ata_eh_handle_port_suspend(ap: *mut ata_port) {
    static void ata_eh_handle_port_suspend(struct ata_port *ap)
    { }
#[no_mangle]
unsafe extern "C" fn ata_eh_handle_port_resume(ap: *mut ata_port) {
    static void ata_eh_handle_port_resume(struct ata_port *ap)
    { }
...
//
#[no_mangle]
pub unsafe extern "C" fn __ata_ehi_push_desc(ehi: *mut ata_eh_info, fmt: *const c_char, ...) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_ehi_push_desc(ehi: *mut ata_eh_info, fmt: *const c_char, ...) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_ehi_clear_desc(ehi: *mut ata_eh_info) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_port_desc(ap: *mut ata_port, fmt: *const c_char, ...) {
...
//
    ...
    type = "m";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: pci_resource_flags(pdev, IORESOURCE_IO: bar) &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ata_lookup_timeout_table(cmd: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_internal_cmd_timeout(dev: *mut ata_device, cmd: u8) -> c_uint {
    unsigned int ata_internal_cmd_timeout(struct ata_device *dev, u8 cmd)
    {
    struct ata_eh_context *ehc = &dev.link.eh_context;
    let mut ent: c_int = ata_lookup_timeout_table(cmd);
    int idx;
    if (ent < 0)
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_internal_cmd_timed_out(dev: *mut ata_device, cmd: u8) {
...
#[no_mangle]
unsafe extern "C" fn ata_ering_clear_cb(ent: *mut ata_ering_entry, void_arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_ering_clear(ering: *mut ata_ering) {
    static void ata_ering_clear(struct ata_ering *ering)
    {
    ata_ering_map(ering, ata_ering_clear_cb, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn ata_eh_dev_action(dev: *mut ata_device) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_acquire(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_release(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_dev_disable(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_unload(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_error(host: *mut Scsi_Host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_port_error_handler(host: *mut Scsi_Host, ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_port_wait_eh(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_nr_in_flight(ap: *mut ata_port) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn ata_eh_fastdrain_timerfn(t: *mut timer_list) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_set_pending(ap: *mut ata_port, fastdrain: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_qc_schedule_eh(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_std_sched_eh(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_std_end_eh(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_port_schedule_eh(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ata_do_link_abort(ap: *mut ata_port, link: *mut ata_link) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_link_abort(link: *mut ata_link) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_port_abort(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __ata_port_freeze(ap: *mut ata_port) {
    static void __ata_port_freeze(struct ata_port *ap)
    {
    if (ap.ops.freeze)
    ap.ops.freeze(ap);
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_port_freeze(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_freeze_port(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_thaw_port(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_scsidone(scmd: *mut scsi_cmnd) {
    static void ata_eh_scsidone(struct scsi_cmnd *scmd)
    {
// nada
    }
#[no_mangle]
unsafe extern "C" fn __ata_eh_qc_complete(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_qc_complete(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_qc_retry(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_disable(dev: *mut ata_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_detach_dev(dev: *mut ata_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atapi_eh_tur(dev: *mut ata_device, r_sense_key: *mut u8) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_decide_disposition(qc: *mut ata_queued_cmd) -> enum scsi_disposition {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_request_sense(qc: *mut ata_queued_cmd) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_analyze_serror(link: *mut ata_link) {
    static void ata_eh_analyze_serror(struct ata_link *link)
    {
    struct ata_eh_context *ehc = &link.eh_context;
    let mut serror: u32 = ehc.i.serror;
...
#[no_mangle]
pub unsafe extern "C" fn if(ata_is_host_link(link): !(link->flags & ATA_LFLAG_DISABLED) ||) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_analyze_tf(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int ata_eh_analyze_tf(struct ata_queued_cmd *qc)
    {
    const struct ata_taskfile *tf = &qc.result_tf;
    unsigned int tmp, action = 0;
    let mut stat: u8 = tf.status, err = tf.error;
...
//
    ...
    if (qc.flags & ATA_QCFLAG_SENSE_VALID) {
    let mut ret: enum scsi_disposition = ata_eh_decide_disposition(qc);
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct speed_down_verdict_arg {
    pub since: u64,
    pub xfer_ok: c_int,
    pub nr_errors: [c_int; ATA_ECAT_NR],
}

#[no_mangle]
unsafe extern "C" fn speed_down_verdict_cb(ent: *mut ata_ering_entry, void_arg: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_speed_down_verdict(dev: *mut ata_device) -> c_uint {
    static unsigned int ata_eh_speed_down_verdict(struct ata_device *dev)
    {
    let mut j5mins: u64 = 5LLU * 60 * HZ, j10mins = 10LLU * 60 * HZ;
    let mut j64: u64 = get_jiffies_64();
    struct speed_down_verdict_arg arg;
    let mut verdict: c_uint = 0;
...
//
    ...
    let mut xfer_ok: c_int = 0;
    unsigned int verdict;
    let mut action: c_uint = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_worth_retry(qc: *mut ata_queued_cmd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_quiet(qc: *mut ata_queued_cmd) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_get_non_ncq_success_sense(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_get_success_sense(link: *mut ata_link) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_link_established(link: *mut ata_link) -> bool {
...
//
    ...
    let mut old_policy: enum ata_lpm_policy = link.lpm_policy;
    let mut host_has_dipm: bool = !(link.ap.flags & ATA_FLAG_NO_DIPM);
    let mut hints: c_uint = ATA_LPM_EMPTY | ATA_LPM_HIPM;
    unsigned int err_mask;
    int rc;
...
//
    ata_for_each_dev(dev, link, ENABLED) {
    let mut dev_has_hipm: bool = ata_id_has_hipm(dev.id);
    let mut dev_has_dipm: bool = ata_id_has_dipm(dev.id);
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_link_autopsy(link: *mut ata_link) {
    ...
    struct ata_queued_cmd *qc;
    struct ata_device *dev;
    let mut all_err_mask: c_uint = 0, eflags = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ata_eh_worth_retry(qc)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_autopsy(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_link_report(link: *mut ata_link) {
    ...
    const u8 *cdb = qc.cdb;
    let mut cdb_len: usize = qc.dev.cdb_len;
    if (qc.scsicmd) {
    cdb = qc.scsicmd.cmnd;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_report(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_followup_srst_needed(link: *mut ata_link, rc: c_int) -> bool {
    ...
    let mut hardreset: ata_reset_fn_t = reset_ops.hardreset;
    let mut softreset: ata_reset_fn_t = reset_ops.softreset;
    let mut prereset: ata_prereset_fn_t = reset_ops.prereset;
    let mut postreset: ata_postreset_fn_t = reset_ops.postreset;
    unsigned int *classes = ehc.classes;
    let mut lflags: c_uint = link.flags;
    let mut verbose: c_int = !(ehc.i.flags & ATA_EHI_QUIET);
    let mut max_tries: c_int = 0, try = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(ATA_LFLAG_ASSUME_SEMB: lflags &) -> else {
...
//
    ...
    now = jiffies;
    if (time_before(now, deadline)) {
    let mut delta: c_ulong = deadline - now;
...
#[no_mangle]
pub unsafe extern "C" fn ata_eh_pull_park_action(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_park_issue_cmd(dev: *mut ata_device, park: c_int) {
...
//
    ...
    let mut action: c_uint = ata_eh_dev_action(dev);
    let mut readid_flags: c_uint = 0;
    if (ehc.i.flags & ATA_EHI_DID_RESET)
...
// if transfer mode has changed, set DUBIOUS_XFER on device
    ata_for_each_dev(dev, link, ENABLED) {
    struct ata_eh_context *ehc = &link.eh_context;
    let mut saved_xfer_mode: u8 = ehc.saved_xfer_mode[dev.devno];
    let mut saved_ncq: u8 = !!(ehc.saved_ncq_enabled & (1 << dev.devno));
...
//
#[no_mangle]
unsafe extern "C" fn atapi_eh_clear_ua(dev: *mut ata_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_eh_maybe_retry_flush(dev: *mut ata_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ata_link_nr_enabled(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_link_nr_vacant(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_eh_skip_recovery(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_count_probe_trials_cb(ent: *mut ata_ering_entry, void_arg: *mut c_void) -> c_int {
    static int ata_count_probe_trials_cb(struct ata_ering_entry *ent, void *void_arg)
    {
    let mut interval: u64 = msecs_to_jiffies(ATA_EH_PROBE_TRIAL_INTERVAL);
...
#[no_mangle]
unsafe extern "C" fn ata_eh_schedule_probe(dev: *mut ata_device) -> c_int {
    static int ata_eh_schedule_probe(struct ata_device *dev)
    {
    struct ata_eh_context *ehc = &dev.link.eh_context;
    struct ata_link *link = ata_dev_phys_link(dev);
    let mut trials: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn ata_eh_handle_dev_fail(dev: *mut ata_device, err: c_int) -> c_int {
...
//
    ...
    deadline = tmp;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: time_before_eq(tmp, _arg: jiffies)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_finish(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_std_error_handler(ap: *mut ata_port) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ata_port_is_frozen(ap)) -> else {
