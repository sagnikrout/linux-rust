...
//! Source: drivers/ata/ahci_xgene.c
#![no_std]
...
pub const MAX_AHCI_CHN_PERCTR: c_int = 2;
// MUX CSR
pub const SATA_ENET_CONFIG_REG: c_uint = 0x00000000;
pub const CFG_SATA_ENET_SELECT_MASK: c_uint = 0x00000001;
// SATA core host controller CSR
pub const SLVRDERRATTRIBUTES: c_uint = 0x00000000;
pub const SLVWRERRATTRIBUTES: c_uint = 0x00000004;
pub const MSTRDERRATTRIBUTES: c_uint = 0x00000008;
pub const MSTWRERRATTRIBUTES: c_uint = 0x0000000c;
pub const BUSCTLREG: c_uint = 0x00000014;
pub const IOFMSTRWAUX: c_uint = 0x00000018;
pub const INTSTATUSMASK: c_uint = 0x0000002c;
pub const ERRINTSTATUS: c_uint = 0x00000030;
pub const ERRINTSTATUSMASK: c_uint = 0x00000034;
// SATA host AHCI CSR
pub const PORTCFG: c_uint = 0x000000a4;

    (((dst) & ~0x0000003f) | (((u32)(src)) & 0x0000003f))
pub const PORTPHY1CFG: c_uint = 0x000000a8;

    (((dst) & ~0x00100000) | (((u32)(src) << 0x14) & 0x00100000))
pub const PORTPHY2CFG: c_uint = 0x000000ac;
pub const PORTPHY3CFG: c_uint = 0x000000b0;
pub const PORTPHY4CFG: c_uint = 0x000000b4;
pub const PORTPHY5CFG: c_uint = 0x000000b8;
pub const SCTL0: c_uint = 0x0000012C;

    (((dst) & ~0xfff00000) | (((u32)(src) << 0x14) & 0xfff00000))

    (((dst) & ~0x01000000) | (((u32)(src) << 0x18) & 0x01000000))
pub const PORTAXICFG: c_uint = 0x000000bc;

    (((dst) & ~0x00f00000) | (((u32)(src) << 0x14) & 0x00f00000))
pub const PORTRANSCFG: c_uint = 0x000000c8;

    (((dst) & ~0x0000007f) | (((u32)(src)) & 0x0000007f))
// SATA host controller AXI CSR
pub const INT_SLV_TMOMASK: c_uint = 0x00000010;
// SATA diagnostic CSR
pub const CFG_MEM_RAM_SHUTDOWN: c_uint = 0x00000070;
pub const BLOCK_MEM_RDY: c_uint = 0x00000074;
// Max retry for link down
pub const MAX_LINK_DOWN_RETRY: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct xgene_ahci_context {
    pub hpriv: *mut ahci_host_priv,
    pub dev: *mut device,
    pub issued*/: *mut *mut u8 last_cmd[MAX_AHCI_CHN_PERCTR]; / tracking the last command,
    pub /: *mut *mut u32 class[MAX_AHCI_CHN_PERCTR]; / tracking the class of device,
    pub /: *mut *mut *mut void __iomem csr_core; / Core CSR address of IP,
    pub /: *mut *mut *mut void __iomem csr_diag; / Diag CSR address of IP,
    pub /: *mut *mut *mut void __iomem csr_axi; / AXI CSR address of IP,
    pub /: *mut *mut *mut void __iomem csr_mux; / MUX CSR address of IP,
}

#[no_mangle]
unsafe extern "C" fn xgene_ahci_init_memram(ctx: *mut xgene_ahci_context) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xgene_ahci_restart_engine(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn xgene_ahci_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn xgene_ahci_is_memram_inited(ctx: *mut xgene_ahci_context) -> bool {
...
#[no_mangle]
unsafe extern "C" fn xgene_ahci_set_phy_cfg(ctx: *mut xgene_ahci_context, channel: c_int) {
...
//
    ...
    let mut link_down_retry: c_int = 0;
    int rc;
    u32 val, sstatus;
    do {
...
#[no_mangle]
unsafe extern "C" fn xgene_ahci_host_stop(host: *mut ata_host) {
...
#[no_mangle]
unsafe extern "C" fn xgene_ahci_irq_intr(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn xgene_ahci_hw_init(hpriv: *mut ahci_host_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_ahci_mux_select(ctx: *mut xgene_ahci_context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn xgene_ahci_probe(pdev: *mut platform_device) -> c_int {
    ...
    struct resource *res;
    let mut version: enum xgene_ahci_version = XGENE_AHCI_V1;
