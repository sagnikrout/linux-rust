...
//! Source: drivers/ata/pata_it821x.c
#![no_std]
...
pub const ATA_66: c_int = 0;
pub const ATA_50: c_int = 1;
pub const ATA_ANY: c_int = 2;
pub const UDMA_OFF: c_int = 0;
pub const MWDMA_OFF: c_int = 0;
//
...
//
#[no_mangle]
unsafe extern "C" fn it821x_program(ap: *mut ata_port, adev: *mut ata_device, timing: u16) {
    static void it821x_program(struct ata_port *ap, struct ata_device *adev, u16 timing)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    struct it821x_dev *itdev = ap.private_data;
    let mut channel: c_int = ap.port_no;
    u8 conf;
...
//
#[no_mangle]
unsafe extern "C" fn it821x_program_udma(ap: *mut ata_port, adev: *mut ata_device, timing: u16) {
    static void it821x_program_udma(struct ata_port *ap, struct ata_device *adev, u16 timing)
    {
    struct it821x_dev *itdev = ap.private_data;
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut channel: c_int = ap.port_no;
    let mut unit: c_int = adev.devno;
    u8 conf;
...
//
#[no_mangle]
unsafe extern "C" fn it821x_clock_strategy(ap: *mut ata_port, adev: *mut ata_device) {
    static void it821x_clock_strategy(struct ata_port *ap, struct ata_device *adev)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    struct it821x_dev *itdev = ap.private_data;
    let mut unit: u8 = adev.devno;
...
//
#[no_mangle]
unsafe extern "C" fn it821x_passthru_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
// Spec says 89 ref driver uses 88
    ...
    struct it821x_dev *itdev = ap.private_data;
    let mut unit: c_int = adev.devno;
    let mut mode_wanted: c_int = adev.pio_mode - XFER_PIO_0;
...
//
#[no_mangle]
unsafe extern "C" fn it821x_passthru_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    ...
    let mut mode_wanted: c_int = adev.dma_mode - XFER_UDMA_0;
...
// UDMA on. Again revision 0x10 must do the pair
    ...
    let mut mode_wanted: c_int = adev.dma_mode - XFER_MW_DMA_0;
...
//
#[no_mangle]
unsafe extern "C" fn it821x_passthru_bmdma_start(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn if(itdev->timing10: itdev->udma[unit] != UDMA_OFF &&) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_passthru_bmdma_stop(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_smart_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_passthru_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_smart_set_mode(link: *mut ata_link, unused: *mut ata_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_dev_config(adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_display_disk(ap: *mut ata_port, n: c_int, buf: *mut u8) {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_probe_firmware(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn it821x_port_start(ap: *mut ata_port) -> c_int {
    static int it821x_port_start(struct ata_port *ap)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    struct it821x_dev *itdev;
    u8 conf;
    let mut ret: c_int = ata_bmdma_port_start(ap);
    if (ret < 0)
    return ret;
    itdev = devm_kzalloc(&pdev.dev, sizeof(struct it821x_dev), GFP_KERNEL);
    if (itdev == core::ptr::null_mut())
    return -ENOMEM;
...
//
#[no_mangle]
unsafe extern "C" fn it821x_rdc_cable(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn it821x_disable_raid(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn it821x_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// Force the card into bypass mode if so requested
    ...
    return ata_pci_bmdma_init_one(pdev, ppi, &it821x_sht, core::ptr::null_mut(), 0);
    }

#[no_mangle]
unsafe extern "C" fn it821x_reinit_one(pdev: *mut pci_dev) -> c_int {
