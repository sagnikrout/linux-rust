...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct piix_host_priv {
    pub map: *const c_int,
    pub saved_iocfg: u32,
    pub sidpr: *mut void __iomem,
}

    let mut in_module_init: static unsigned int = 1;
...
#[no_mangle]
unsafe extern "C" fn piix_port_start(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ich_pata_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn piix_pata_prereset(link: *mut ata_link, deadline: c_ulong) -> c_int {
    ...
    let mut slave_port: c_uint = 0x44;
    u16 master_data;
    u8 slave_data;
    u8 udma_enable;
...
//
#[no_mangle]
unsafe extern "C" fn piix_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn do_pata_set_dmamode(ap: *mut ata_port, adev: *mut ata_device, isich: c_int) {
    ...
    let mut udma: c_uint = speed - XFER_UDMA_0;
    u16 udma_timing;
    u16 ideconf;
    int u_clock, u_speed;
    spin_lock_irqsave(&piix_lock, flags);
...
#[no_mangle]
pub unsafe extern "C" fn if(2: udma >) -> else {
    else if (udma > 2)
    u_clock = 1;		/* 66Mhz */
    else
    u_clock = 0;		/* 33Mhz */
...
// MWDMA is driven by the PIO timings.
    let mut mwdma: c_uint = speed - XFER_MW_DMA_0;
...
//
#[no_mangle]
unsafe extern "C" fn piix_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ich_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn piix_sidpr_sel(link: *mut ata_link, reg: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn piix_irq_check(ap: *mut ata_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn piix_broken_suspend() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn piix_pci_device_suspend(pdev: *mut pci_dev, mesg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn piix_pci_device_resume(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn piix_vmw_bmdma_status(ap: *mut ata_port) -> u8 {
...
pub const AHCI_PCI_BAR: c_int = 5;
pub const AHCI_GLOBAL_CTL: c_uint = 0x04;

#[no_mangle]
unsafe extern "C" fn piix_disable_ahci(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn piix_check_450nx_errata(ata_dev: *mut pci_dev) -> c_int {
    static int piix_check_450nx_errata(struct pci_dev *ata_dev)
    {
    struct pci_dev *pdev = core::ptr::null_mut();
    u16 cfg;
    let mut no_piix_dma: c_int = 0;
    while ((pdev = pci_get_device(PCI_VENDOR_ID_INTEL, PCI_DEVICE_ID_INTEL_82454NX, pdev)) != core::ptr::null_mut()) {
...
#[no_mangle]
pub unsafe extern "C" fn if(5: cfg & (1<<14) && pdev->revision <) -> else {
...
#[no_mangle]
unsafe extern "C" fn piix_no_sidpr(host: *mut ata_host) -> bool {
...
#[no_mangle]
unsafe extern "C" fn piix_init_sidpr(host: *mut ata_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn piix_iocfg_bit18_quirk(host: *mut ata_host) {
...
#[no_mangle]
unsafe extern "C" fn piix_broken_system_poweroff(pdev: *mut pci_dev) -> bool {
...
// PCI slot number of the controller
    ...
    if (dmi) {
    let mut slot: c_ulong = (unsigned long)dmi.driver_data;
// apply the quirk only to on-board controllers
    let mut slot: return = = PCI_SLOT(pdev.devfn);
    }
    return false;
    }
    let mut prefer_ms_hyperv: static int = 1;
...
#[no_mangle]
unsafe extern "C" fn piix_ignore_devices_quirk(host: *mut ata_host) {
...
//
#[no_mangle]
unsafe extern "C" fn piix_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn piix_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn piix_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn piix_exit() -> void __exit {
