...
//! Source: drivers/ata/pata_parport/fit2.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn fit2_write_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fit2_read_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fit2_read_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fit2_write_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn fit2_connect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn fit2_disconnect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn fit2_log_adapter(pi: *mut pi_adapter) {
