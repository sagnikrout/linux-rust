...
//! Source: drivers/ata/pata_parport/epat.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn epat_write_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn epat_read_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn epat_read_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn epat_write_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn epat_connect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn epat_disconnect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn epat_test_proto(pi: *mut pi_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn epat_log_adapter(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn epat_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn epat_exit() -> void __exit {
