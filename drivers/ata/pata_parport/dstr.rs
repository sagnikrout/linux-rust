...
//! Source: drivers/ata/pata_parport/dstr.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn dstr_read_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dstr_write_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dstr_connect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn dstr_disconnect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn dstr_read_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dstr_write_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn dstr_log_adapter(pi: *mut pi_adapter) {
