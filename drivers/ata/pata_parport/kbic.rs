...
//! Source: drivers/ata/pata_parport/kbic.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn kbic_read_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbic_write_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int, val: c_int) {
    static void kbic_write_regr(struct pi_adapter *pi, int cont, int regr, int val)
    {
    let mut s: c_int = cont_map[cont];
    switch (pi.mode) {
    case 0:
    case 1:
    case 2:
...
#[no_mangle]
unsafe extern "C" fn k951_connect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn k951_disconnect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn k971_connect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn k971_disconnect(pi: *mut pi_adapter) {
...
//
#[no_mangle]
unsafe extern "C" fn kbic_read_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kbic_write_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn kbic_log_adapter(pi: *mut pi_adapter, chip: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn k951_log_adapter(pi: *mut pi_adapter) {
    static void k951_log_adapter(struct pi_adapter *pi)
    {
    kbic_log_adapter(pi, "KBIC-951A");
    }
#[no_mangle]
unsafe extern "C" fn k971_log_adapter(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn kbic_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn kbic_exit() -> void __exit {
