...
//! Source: drivers/ata/pata_parport/bpck.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn bpck_read_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpck_write_regr(pi: *mut pi_adapter, cont: c_int, regr: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bpck_write_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bpck_read_block(pi: *mut pi_adapter, buf: *mut c_char, count: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bpck_probe_unit(pi: *mut pi_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpck_connect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn bpck_disconnect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn bpck_force_spp(pi: *mut pi_adapter) {
...
pub const TEST_LEN: c_int = 16;
#[no_mangle]
unsafe extern "C" fn bpck_test_proto(pi: *mut pi_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpck_read_eeprom(pi: *mut pi_adapter, buf: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn bpck_test_port(pi: *mut pi_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpck_log_adapter(pi: *mut pi_adapter) {
