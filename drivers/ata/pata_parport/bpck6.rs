...
//! Source: drivers/ata/pata_parport/bpck6.c
#![no_std]
...
// 60772 Commands
pub const ACCESS_REG: c_uint = 0x00;
pub const ACCESS_PORT: c_uint = 0x40;
pub const ACCESS_READ: c_uint = 0x00;
pub const ACCESS_WRITE: c_uint = 0x20;
// 60772 Command Prefix
pub const CMD_PREFIX_SET: c_uint = 0xe0	// Special command that modifies next command's operation;
pub const CMD_PREFIX_RESET: c_uint = 0xc0	// Resets current cmd modifier reg bits;
pub const PREFIX_IO16: c_uint = 0x01	// perform 16-bit wide I/O;
pub const PREFIX_FASTWR: c_uint = 0x04	// enable PPC mode fast-write;
pub const PREFIX_BLK: c_uint = 0x08	// enable block transfer mode;
// 60772 Registers
pub const REG_STATUS: c_uint = 0x00	// status register;
pub const STATUS_IRQA: c_uint = 0x01	// Peripheral IRQA line;
pub const STATUS_EEPROM_DO: c_uint = 0x40	// Serial EEPROM data bit;
pub const REG_VERSION: c_uint = 0x01	// PPC version register (read);
pub const REG_HWCFG: c_uint = 0x02	// Hardware Config register;
pub const REG_RAMSIZE: c_uint = 0x03	// Size of RAM Buffer;
pub const RAMSIZE_128K: c_uint = 0x02;
pub const REG_EEPROM: c_uint = 0x06	// EEPROM control register;
pub const EEPROM_SK: c_uint = 0x01	// eeprom SK bit;
pub const EEPROM_DI: c_uint = 0x02	// eeprom DI bit;
pub const EEPROM_CS: c_uint = 0x04	// eeprom CS bit;
pub const EEPROM_EN: c_uint = 0x08	// eeprom output enable;
pub const REG_BLKSIZE: c_uint = 0x08	// Block transfer len (24 bit);
// flags
pub const fifo_wait: c_uint = 0x10;
// DONT CHANGE THESE LEST YOU BREAK EVERYTHING - BIT FIELD DEPENDENCIES
pub const PPCMODE_UNI_SW: c_int = 0;
pub const PPCMODE_UNI_FW: c_int = 1;
pub const PPCMODE_BI_SW: c_int = 2;
pub const PPCMODE_BI_FW: c_int = 3;
pub const PPCMODE_EPP_BYTE: c_int = 4;
pub const PPCMODE_EPP_WORD: c_int = 5;
pub const PPCMODE_EPP_DWORD: c_int = 6;
    static int mode_map[] = { PPCMODE_UNI_FW, PPCMODE_BI_FW, PPCMODE_EPP_BYTE,
    PPCMODE_EPP_WORD, PPCMODE_EPP_DWORD };
#[no_mangle]
unsafe extern "C" fn bpck6_send_cmd(pi: *mut pi_adapter, cmd: u8) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_rd_data_byte(pi: *mut pi_adapter) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn bpck6_wr_data_byte(pi: *mut pi_adapter, data: u8) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_read_regr(pi: *mut pi_adapter, cont: c_int, reg: c_int) -> c_int {
    static int bpck6_read_regr(struct pi_adapter *pi, int cont, int reg)
    {
    let mut port: u8 = cont ? reg | 8 : reg;
    bpck6_send_cmd(pi, port | ACCESS_PORT | ACCESS_READ);
    return bpck6_rd_data_byte(pi);
    }
#[no_mangle]
unsafe extern "C" fn bpck6_write_regr(pi: *mut pi_adapter, cont: c_int, reg: c_int, val: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_wait_for_fifo(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_write_block(pi: *mut pi_adapter, buf: *mut c_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_read_block(pi: *mut pi_adapter, buf: *mut c_char, len: c_int) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_open(pi: *mut pi_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpck6_deselect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_wr_extout(pi: *mut pi_adapter, regdata: u8) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_connect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_disconnect(pi: *mut pi_adapter) {
...
#[no_mangle]
unsafe extern "C" fn bpck6_test_port(pi: *mut pi_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpck6_probe_unit(pi: *mut pi_adapter) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bpck6_log_adapter(pi: *mut pi_adapter) {
