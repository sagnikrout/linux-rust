...
//! Source: drivers/ata/libata-scsi.c
#![no_std]
...
pub const RW_RECOVERY_MPAGE: c_uint = 0x1;
pub const RW_RECOVERY_MPAGE_LEN: c_int = 12;
pub const CACHE_MPAGE: c_uint = 0x8;
pub const CACHE_MPAGE_LEN: c_int = 20;
pub const CONTROL_MPAGE: c_uint = 0xa;
pub const CONTROL_MPAGE_LEN: c_int = 12;
pub const ALL_MPAGES: c_uint = 0x3f;
pub const ALL_SUB_MPAGES: c_uint = 0xff;
pub const CDL_T2A_SUB_MPAGE: c_uint = 0x07;
pub const CDL_T2B_SUB_MPAGE: c_uint = 0x08;
pub const CDL_T2_SUB_MPAGE_LEN: c_int = 232;
pub const ATA_FEATURE_SUB_MPAGE: c_uint = 0xf2;
pub const ATA_FEATURE_SUB_MPAGE_LEN: c_int = 16;
...
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_sense_is_valid(sk: u8, asc: u8, ascq: u8) -> bool {
...
// If sk > COMPLETED, sense data is bogus.
    ...
    {
    let mut d_sense: bool = (dev.flags & ATA_DFLAG_D_SENSE);
    scsi_build_sense(cmd, d_sense, sk, asc, ascq);
    }
#[no_mangle]
unsafe extern "C" fn ata_scsi_set_sense_information(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_set_passthru_sense_fields(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_unlock_native_capacity(sdev: *mut scsi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_cmd_ioctl(scsidev: *mut scsi_device, arg: *mut void __user) -> c_int {
    int ata_cmd_ioctl(struct scsi_device *scsidev, void __user *arg)
    {
    let mut rc: c_int = 0;
    u8 sensebuf[SCSI_SENSE_BUFFERSIZE];
    u8 scsi_cmd[MAX_COMMAND_SIZE];
    u8 args[4], *argbuf = core::ptr::null_mut();
    let mut argsize: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_task_ioctl(scsidev: *mut scsi_device, arg: *mut void __user) -> c_int {
...
// Good values for timeout and retries?  Values below
    from scsi_ioctl_send_command() for default case... */
    cmd_result = scsi_execute_cmd(scsidev, scsi_cmd, REQ_OP_DRV_IN, core::ptr::null_mut(),
    0, 10 * HZ, 5, &exec_args);
    if (cmd_result < 0) {
    rc = cmd_result;
    goto error;
...
#[no_mangle]
unsafe extern "C" fn ata_ioc32(ap: *mut ata_port) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ata_qc_set_pc_nbytes(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_gen_passthru_sense(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_gen_ata_sense(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_sdev_config(sdev: *mut scsi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_dma_need_drain(rq: *mut request) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_sdev_init(sdev: *mut scsi_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_sdev_configure(sdev: *mut scsi_device, lim: *mut queue_limits) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_sdev_destroy(sdev: *mut scsi_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_start_stop_xlat(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_flush_xlat(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn scsi_6_lba_len(cdb: *const u8, plba: *mut u64, plen: *mut u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_10_lba_len(cdb: *const u8, plba: *mut u64, plen: *mut u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_16_lba_len(cdb: *const u8, plba: *mut u64, plen: *mut u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn scsi_dld(cdb: *const u8) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_verify_xlat(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int ata_scsi_verify_xlat(struct ata_queued_cmd *qc)
    {
    struct scsi_cmnd *scmd = qc.scsicmd;
    struct ata_taskfile *tf = &qc.tf;
    struct ata_device *dev = qc.dev;
    let mut dev_sectors: u64 = qc.dev.n_sectors;
    const u8 *cdb = scmd.cmnd;
    u64 block;
    u32 n_block;
    u16 fp;
...
#[no_mangle]
unsafe extern "C" fn ata_check_nblocks(scmd: *mut scsi_cmnd, n_blocks: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_rw_xlat(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int ata_scsi_rw_xlat(struct ata_queued_cmd *qc)
    {
    struct scsi_cmnd *scmd = qc.scsicmd;
    const u8 *cdb = scmd.cmnd;
    struct request *rq = scsi_cmd_to_rq(scmd);
    let mut class: c_int = IOPRIO_PRIO_CLASS(req_get_ioprio(rq));
    let mut tf_flags: c_uint = 0;
    let mut dld: c_int = 0;
    u64 block;
    u32 n_block;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_deferred_qc_work(work: *mut work_struct) {
...
//
    ...
    link.deferred_qc = core::ptr::null_mut();
    ata_qc_issue(ap, qc);
    }
    spin_unlock_irqrestore(ap.lock, flags);
    }
    ...
    {
    let mut action: enum scsi_timeout_action = SCSI_EH_NOT_HANDLED;
    struct ata_queued_cmd *qc;
    struct ata_link *link;
    u32 host_byte;
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_schedule_deferred_qc(link: *mut ata_link) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_eh_timed_out(scmd: *mut scsi_cmnd) -> enum scsi_timeout_action {
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_qc_complete(qc: *mut ata_queued_cmd) {
    static void ata_scsi_qc_complete(struct ata_queued_cmd *qc)
    {
    struct ata_link *link = qc.dev.link;
    struct scsi_cmnd *cmd = qc.scsicmd;
    u8 *cdb = cmd.cmnd;
    let mut have_sense: bool = qc.flags & ATA_QCFLAG_SENSE_VALID;
    let mut is_ata_passthru: bool = cdb[0] == ATA_16 || cdb[0] == ATA_12;
    let mut is_ck_cond_request: bool = cdb[2] & 0x20;
    let mut is_error: bool = qc.err_mask != 0;
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_qc_issue(ap: *mut ata_port, qc: *mut ata_queued_cmd) -> c_int {
...
//
    ...
    struct scsi_cmnd *cmd, u8 *rbuf)
    {
    let mut sat_model_serial_desc_len: c_int = 68;
    int num;
...
//
#[no_mangle]
unsafe extern "C" fn ata_dsm_trim_pages(dev: *mut ata_device) -> c_uint {
    static unsigned int ata_dsm_trim_pages(struct ata_device *dev)
    {
    let mut sector_size: c_uint = ata_id_logical_sector_size(dev.id);
    let mut max_pages: c_uint = ata_id_dsm_max_pages(dev.id);
    let mut pages: c_uint = sector_size / ATA_SECT_SIZE;
...
//
    ...
    let mut max_pages: c_uint = ata_dsm_trim_pages(dev);
    let mut max_blocks: u64 = max_pages * ATA_MAX_TRIM_RNUM * (u64)U16_MAX;
...
//
    ...
    struct scsi_cmnd *cmd, u8 *rbuf)
    {
    let mut form_factor: c_int = ata_id_form_factor(dev.id);
    let mut media_rotation_rate: c_int = ata_id_rotation_rate(dev.id);
    let mut zoned: u8 = ata_id_zoned_cap(dev.id);
    rbuf[1] = 0xb1;
    rbuf[3] = 0x3c;
...
//
#[no_mangle]
unsafe extern "C" fn modecpy(dest: *mut u8, src: *const u8, n: c_int, changeable: bool) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_msense_caching(id: *mut u16, buf: *mut u8, changeable: bool) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_xlat_cdl_limit(buf: *mut u8) -> u16 {
    static inline u16 ata_xlat_cdl_limit(u8 *buf)
    {
    let mut limit: u32 = get_unaligned_le32(buf);
...
//
#[no_mangle]
unsafe extern "C" fn ata_msense_rw_recovery(buf: *mut u8, changeable: bool) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn atapi_fixup_inquiry(cmd: *mut scsi_cmnd) {
...
#[no_mangle]
unsafe extern "C" fn atapi_qc_complete(qc: *mut ata_queued_cmd) {
    static void atapi_qc_complete(struct ata_queued_cmd *qc)
    {
    struct ata_link *link = qc.dev.link;
    struct scsi_cmnd *cmd = qc.scsicmd;
    let mut err_mask: c_uint = qc.err_mask;
...
//
#[no_mangle]
unsafe extern "C" fn atapi_xlat(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int atapi_xlat(struct ata_queued_cmd *qc)
    {
    struct scsi_cmnd *scmd = qc.scsicmd;
    struct ata_device *dev = qc.dev;
    let mut nodata: c_int = (scmd.sc_data_direction == DMA_NONE);
    let mut using_pio: c_int = !nodata && (dev.flags & ATA_DFLAG_PIO);
    unsigned int nbytes;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: using_pio) -> else {
    else if (using_pio)
...
//
    ...
    let mut link_max_devices: c_int = ata_link_max_devices(&ap.link);
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_pass_thru(qc: *mut ata_queued_cmd) -> c_uint {
...
// sanity check for pio multi commands
    ...
    let mut multi_count: c_uint = 1 << (cdb[1] >> 5);
...
//
    ...
    let mut chunk: usize = min_t(size_t, miter.length, size - offset);
    let mut n: c_uint = chunk / sizeof(__le64);
    unsigned int i;
    for (i = 0; i < n; i++) {
    let mut entry: u64 = 0;
    if (count) {
    let mut rlen: u32 = min_t(u32, count, 0xffff);
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_write_same_xlat(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_supported_cmd_use_sa(op: u8) -> bool {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ata_scsi_cmd_support {
    pub cdlp: u8,
    pub rwcdlp: u8,
}
...
//
    ...
    {
    u8 *cdb = cmd.cmnd;
    let mut service_action: u8 = cdb[1] & 0x1f;
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_report_zones_complete(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_zbc_in_xlat(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_zbc_out_xlat(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_mode_select_xlat(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_trusted_op(len: u32, send: bool, dma: bool) -> u8 {
    static u8 ata_scsi_trusted_op(u32 len, bool send, bool dma)
    {
    if (len == 0)
    return ATA_CMD_TRUSTED_NONDATA;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: send) -> else {
    else if (send)
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_security_inout_xlat(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int ata_scsi_security_inout_xlat(struct ata_queued_cmd *qc)
    {
    struct scsi_cmnd *scmd = qc.scsicmd;
    const u8 *cdb = scmd.cmnd;
    struct ata_taskfile *tf = &qc.tf;
    let mut secp: u8 = cdb[1];
    let mut send: bool = (cdb[0] == SECURITY_PROTOCOL_OUT);
    let mut spsp: u16 = get_unaligned_be16(&cdb[2]);
    let mut len: u32 = get_unaligned_be32(&cdb[6]);
    let mut dma: bool = !(qc.dev.flags & ATA_DFLAG_PIO);
//
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_get_phys_element_status_complete(qc: *mut ata_queued_cmd) {
...
// Swizzle the descriptors.
    ...
    let mut capacity: u64 = get_unaligned_le64(&desc[16]);
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_var_len_cdb_xlat(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int ata_scsi_var_len_cdb_xlat(struct ata_queued_cmd *qc)
    {
    struct scsi_cmnd *scmd = qc.scsicmd;
    const u8 *cdb = scmd.cmnd;
    let mut sa: u16 = get_unaligned_be16(&cdb[8]);
//
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_simulate(dev: *mut ata_device, cmd: *mut scsi_cmnd) {
...
// relay SCSI command to ATAPI device
    let mut len: c_int = COMMAND_SIZE(scsi_op);
...
//
    ...
    let mut rc: enum scsi_qc_status = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_add_hosts(host: *mut ata_host, sht: *const scsi_host_template) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_assign_ofnode(dev: *mut ata_device, ap: *mut ata_port) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_scan_host(ap: *mut ata_port, sync: c_int) {
    void ata_scsi_scan_host(struct ata_port *ap, int sync)
    {
    let mut tries: c_int = 5;
    struct ata_device *last_failed_dev = core::ptr::null_mut();
    struct ata_link *link;
    struct ata_device *dev;
    repeat:
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_offline_dev(dev: *mut ata_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_remove_dev(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_scsi_handle_link_detach(link: *mut ata_link) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_media_change_notify(dev: *mut ata_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_hotplug(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_dev_rescan(work: *mut work_struct) {
