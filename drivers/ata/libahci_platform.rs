...
//! Source: drivers/ata/libahci_platform.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_enable_phys(hpriv: *mut ahci_host_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_disable_phys(hpriv: *mut ahci_host_priv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_enable_clks(hpriv: *mut ahci_host_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_disable_clks(hpriv: *mut ahci_host_priv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_deassert_rsts(hpriv: *mut ahci_host_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_assert_rsts(hpriv: *mut ahci_host_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_enable_regulators(hpriv: *mut ahci_host_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_disable_regulators(hpriv: *mut ahci_host_priv) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_enable_resources(hpriv: *mut ahci_host_priv) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_disable_resources(hpriv: *mut ahci_host_priv) {
...
#[no_mangle]
unsafe extern "C" fn ahci_platform_put_resources(dev: *mut device, res: *mut c_void) {
...
//
    ...
    {
    int rc;
    hpriv.phys[port] = devm_of_phy_get(dev, node, core::ptr::null_mut());
...
// No PHY support. Check if PHY is required.
    ...
    case -ENODEV:
// continue normally
    hpriv.phys[port] = core::ptr::null_mut();
    rc = 0;
    break;
    case -EPROBE_DEFER:
// Do not complain yet
...
#[no_mangle]
unsafe extern "C" fn ahci_platform_find_max_port_id(dev: *mut device) -> u32 {
    static u32 ahci_platform_find_max_port_id(struct device *dev)
    {
    let mut max_port: u32 = 0;
    for_each_child_of_node_scoped(dev.of_node, child) {
    u32 port;
    if (!of_property_read_u32(child, "reg", &port))
...
//
    ...
    hpriv.clks.clk = devm_clk_get_optional(dev, core::ptr::null_mut());
...
//
    ...
    of_platform_device_create(child, core::ptr::null_mut(), core::ptr::null_mut());
...
//
    ...
    {
    struct device *dev = &pdev.dev;
    let mut pi: ata_port_info = *pi_template;
...
#[no_mangle]
unsafe extern "C" fn ahci_host_stop(host: *mut ata_host) {
    static void ahci_host_stop(struct ata_host *host)
    {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_shutdown(pdev: *mut platform_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_suspend_host(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_resume_host(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_suspend(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_platform_resume(dev: *mut device) -> c_int {
