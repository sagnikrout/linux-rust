...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct imx_ahci_priv {
    pub ahci_pdev: *mut platform_device,
    pub type: enum ahci_imx_type,
    pub sata_clk: *mut clk,
    pub sata_ref_clk: *mut clk,
    pub ahb_clk: *mut clk,
    pub gpr: *mut regmap,
    pub sata_phy: *mut phy,
    pub cali_phy0: *mut phy,
    pub cali_phy1: *mut phy,
    pub no_device: bool,
    pub first_time: bool,
    pub phy_params: u32,
    pub imped_ratio: u32,
...
#[no_mangle]
unsafe extern "C" fn imx_phy_crbit_assert(mmio: *mut void __iomem, bit: u32, assert: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_phy_reg_addressing(addr: u16, mmio: *mut void __iomem) -> c_int {
    static int imx_phy_reg_addressing(u16 addr, void __iomem *mmio)
    {
    let mut crval: u32 = addr;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn imx_phy_reg_write(val: u16, mmio: *mut void __iomem) -> c_int {
    static int imx_phy_reg_write(u16 val, void __iomem *mmio)
    {
    let mut crval: u32 = val;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn imx_phy_reg_read(val: *mut u16, mmio: *mut void __iomem) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_sata_phy_reset(hpriv: *mut ahci_host_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn read_adc_sum(dev: *mut c_void, rtune_ctl_reg: u16, mmio: *mut *mut void __iomem) -> c_int {
    static int read_adc_sum(void *dev, u16 rtune_ctl_reg, void __iomem * mmio)
    {
    u16 adc_out_reg, read_sum;
    u32 index, read_attempt;
    let mut attempt_limit: u32 = 200;
...
#[no_mangle]
unsafe extern "C" fn __sata_ahci_read_temperature(dev: *mut c_void, temp: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sata_ahci_read_temperature(tz: *mut thermal_zone_device, temp: *mut c_int) -> c_int {
    ...
    static SENSOR_DEVICE_ATTR(temp1_input, S_IRUGO, sata_ahci_show_temp, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn imx8_sata_enable(hpriv: *mut ahci_host_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_sata_enable(hpriv: *mut ahci_host_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_sata_disable(hpriv: *mut ahci_host_priv) {
...
#[no_mangle]
unsafe extern "C" fn ahci_imx_error_handler(ap: *mut ata_port) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct reg_property {
    pub name: *const c_char,
    pub values: *const reg_value,
...
#[no_mangle]
unsafe extern "C" fn imx8_sata_probe(dev: *mut device, imxpriv: *mut imx_ahci_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_ahci_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahci_imx_host_stop(host: *mut ata_host) {
    static void ahci_imx_host_stop(struct ata_host *host)
    {
    struct ahci_host_priv *hpriv = host.private_data;
    struct imx_ahci_priv *imxpriv = hpriv.plat_data;
...
#[no_mangle]
unsafe extern "C" fn imx_ahci_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_ahci_resume(dev: *mut device) -> c_int {
