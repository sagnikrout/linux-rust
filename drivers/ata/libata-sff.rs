...
//! Source: drivers/ata/libata-sff.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_check_status(ap: *mut ata_port) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn ata_sff_altstatus(ap: *mut ata_port, status: *mut u8) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ata_sff_irq_status(ap: *mut ata_port) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn ata_sff_sync(ap: *mut ata_port) {
    static void ata_sff_sync(struct ata_port *ap)
    {
    ata_sff_altstatus(ap, core::ptr::null_mut());
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_pause(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_dma_pause(ap: *mut ata_port) {
...
//
    if (ata_sff_altstatus(ap, core::ptr::null_mut()))
    return;
...
#[no_mangle]
unsafe extern "C" fn ata_sff_check_ready(link: *mut ata_link) -> c_int {
    static int ata_sff_check_ready(struct ata_link *link)
    {
    let mut status: u8 = link.ap.ops.sff_check_status(link.ap);
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_wait_ready(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_sff_set_devctl(ap: *mut ata_port, ctl: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_dev_select(ap: *mut ata_port, device: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_irq_on(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_tf_load(ap: *mut ata_port, tf: *const ata_taskfile) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_tf_read(ap: *mut ata_port, tf: *mut ata_taskfile) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_exec_command(ap: *mut ata_port, tf: *const ata_taskfile) {
...
//
    ...
    void __iomem *data_addr = ap.ioaddr.data_addr;
    let mut words: c_uint = buflen >> 2;
    let mut slop: c_int = buflen & 3;
...
//
    ...
    {
    let mut do_write: bool = (qc.tf.flags & ATA_TFLAG_WRITE);
    unsigned char *buf;
...
//
#[no_mangle]
unsafe extern "C" fn ata_pio_sector(qc: *mut ata_queued_cmd) {
...
//
    ...
    let mut split_len: c_uint = PAGE_SIZE - offset;
...
//
#[no_mangle]
unsafe extern "C" fn ata_pio_sectors(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn atapi_send_cdb(ap: *mut ata_port, qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn __atapi_pio_bytes(qc: *mut ata_queued_cmd, bytes: c_uint) -> c_int {
    static int __atapi_pio_bytes(struct ata_queued_cmd *qc, unsigned int bytes)
    {
    let mut rw: c_int = (qc.tf.flags & ATA_TFLAG_WRITE) ? WRITE : READ;
    struct ata_port *ap = qc.ap;
    struct ata_device *dev = qc.dev;
...
//
#[no_mangle]
unsafe extern "C" fn atapi_pio_bytes(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_hsm_qc_complete(qc: *mut ata_queued_cmd, in_wq: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_sff_queue_work(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_sff_queue_delayed_work(dwork: *mut delayed_work, delay: c_ulong) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_sff_queue_pio_task(link: *mut ata_link, delay: c_ulong) {
    void ata_sff_queue_pio_task(struct ata_link *link, unsigned long delay)
    {
    struct ata_port *ap = link.ap;
    WARN_ON((ap.sff_pio_task_link != core::ptr::null_mut()) &&
...
#[no_mangle]
pub unsafe extern "C" fn ata_sff_flush_pio_task(ap: *mut ata_port) {
...
//
    ...
    ap.sff_pio_task_link = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ata_sff_pio_task(work: *mut work_struct) {
    ...
    int poll_next;
    spin_lock_irq(ap.lock);
    BUG_ON(ap.sff_pio_task_link == core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_qc_fill_rtf(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn ata_sff_idle_irq(ap: *mut ata_port) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_port_intr(ap: *mut ata_port, qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn int(: *mut *mut port_intr)(struct ata_port, ): *mut ata_queued_cmd) -> unsigned {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_lost_interrupt(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_freeze(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_thaw(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_prereset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_devchk(ap: *mut ata_port, device: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn if(1: err ==) -> else {
    else if (err == 1)
// do nothing */ ;
#[no_mangle]
pub unsafe extern "C" fn if(0x81): (dev->devno == 0) && (err ==) -> else {
...
//
    ...
    struct ata_port *ap = link.ap;
    struct ata_ioports *ioaddr = &ap.ioaddr;
    let mut dev0: c_uint = devmask & (1 << 0);
    let mut dev1: c_uint = devmask & (1 << 1);
    int rc, ret = 0;
...
//
    ...
    {
    struct ata_port *ap = link.ap;
    let mut slave_possible: c_uint = ap.flags & ATA_FLAG_SLAVE_POSS;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_postreset(link: *mut ata_link, classes: *mut c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_drain_fifo(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_error_handler(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_std_ports(ioaddr: *mut ata_ioports) {
...
#[no_mangle]
unsafe extern "C" fn ata_resources_present(pdev: *mut pci_dev, port: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_pci_sff_init_host(host: *mut ata_host) -> c_int {
...
//
    ...
    if (rc)
    goto err_out;
    devres_remove_group(&pdev.dev, core::ptr::null_mut());
// r_host = host;
    return 0;
    err_out:
...
//
    ...
    let mut legacy_mode: c_int = 0, rc;
...
//
#[no_mangle]
unsafe extern "C" fn ata_bmdma_fill_sg(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_bmdma_fill_sg_dumb(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_dumb_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_port_intr(ap: *mut ata_port, qc: *mut ata_queued_cmd) -> c_uint {
    unsigned int ata_bmdma_port_intr(struct ata_port *ap, struct ata_queued_cmd *qc)
    {
    struct ata_eh_info *ehi = &ap.link.eh_info;
    let mut host_stat: u8 = 0;
    let mut bmdma_stopped: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_error_handler(ap: *mut ata_port) {
    void ata_bmdma_error_handler(struct ata_port *ap)
    __must_hold(&ap.host.eh_mutex)
    {
    struct ata_queued_cmd *qc;
    unsigned long flags;
    let mut thaw: bool = false;
    qc = __ata_qc_from_tag(ap, ap.link.active_tag);
    if (qc && !(qc.flags & ATA_QCFLAG_EH))
    qc = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_post_internal_cmd(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_irq_clear(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_setup(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_start(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_stop(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_status(ap: *mut ata_port) -> u8 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_port_start(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_bmdma_port_start32(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_pci_bmdma_clear_simplex(pdev: *mut pci_dev) -> c_int {
    int ata_pci_bmdma_clear_simplex(struct pci_dev *pdev)
    {

    let mut bmdma: c_ulong = pci_resource_start(pdev, 4);
    u8 simplex;
    if (bmdma == 0)
    return -ENOENT;
...
#[no_mangle]
unsafe extern "C" fn ata_bmdma_nodma(host: *mut ata_host, reason: *const c_char) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_pci_bmdma_init(host: *mut ata_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sff_port_init(ap: *mut ata_port) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_sff_init() -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn ata_sff_exit() {
