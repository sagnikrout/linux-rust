...
//! Source: drivers/ata/pata_sl82c105.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_configure_piomode(ap: *mut ata_port, adev: *mut ata_device, pio: c_int) {
    ...
    u16 dummy;
    let mut timing: c_int = 0x44 + (8 * ap.port_no) + (4 * adev.devno);
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_configure_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_reset_engine(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_bmdma_start(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_bmdma_stop(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_qc_defer(qc: *mut ata_queued_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sl82c105_sff_irq_check(ap: *mut ata_port) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn sl82c105_bridge_revision(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sl82c105_fixup(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn sl82c105_init_one(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(5: rev <=) -> else {
    else if (rev <= 5)
    dev_warn(&dev.dev,
    ...
    ppi[0] = &info_dma;
    sl82c105_fixup(dev);
    return ata_pci_bmdma_init_one(dev, ppi, &sl82c105_sht, core::ptr::null_mut(), 0);
    }

#[no_mangle]
unsafe extern "C" fn sl82c105_reinit_one(pdev: *mut pci_dev) -> c_int {
