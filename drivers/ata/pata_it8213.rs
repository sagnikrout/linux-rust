...
//! Source: drivers/ata/pata_it8213.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn it8213_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn it8213_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn it8213_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn it8213_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void it8213_set_dmamode (struct ata_port *ap, struct ata_device *adev)
    {
    struct pci_dev *dev	= to_pci_dev(ap.host.dev);
    u16 master_data;
    let mut speed: u8 = adev.dma_mode;
    let mut devid: c_int = adev.devno;
    u8 udma_enable;
    static const	 /* ISP  RTC */
    u8 timings[][2]	= { { 0, 0 },
    { 0, 0 },
...
//
#[no_mangle]
unsafe extern "C" fn it8213_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
// Current IT8213 stuff is single port
    ...
    return ata_pci_bmdma_init_one(pdev, ppi, &it8213_sht, core::ptr::null_mut(), 0);
    }
