...
//! Source: drivers/ata/pata_cypress.c
#![no_std]
...
// here are the offset definitions for the registers
    ...
    let mut enable_dma: static bool = true;
...
//
#[no_mangle]
unsafe extern "C" fn cy82c693_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn cy82c693_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void cy82c693_set_dmamode(struct ata_port *ap, struct ata_device *adev)
    {
    let mut reg: c_int = CY82_INDEX_CHANNEL0 + ap.port_no;
...
#[no_mangle]
unsafe extern "C" fn cy82c693_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// Devfn 1 is the ATA primary. The secondary is magic and on devfn2.
    ...
    return -ENODEV;
    return ata_pci_bmdma_init_one(pdev, ppi, &cy82c693_sht, core::ptr::null_mut(), 0);
    }
