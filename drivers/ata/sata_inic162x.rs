...
//! Source: drivers/ata/sata_inic162x.c
#![no_std]
...
#[derive(Copy, Clone)]
pub struct inic_cpb {
    pub /: *mut *mut u8 resp_flags; / Response Flags,
    pub /: *mut *mut u8 error; / ATA Error,
    pub /: *mut *mut u8 status; / ATA Status,
    pub /: *mut *mut u8 ctl_flags; / Control Flags,
    pub /: *mut *mut __le32 len; / Total Transfer Length,
    pub /: *mut *mut __le32 prd; / First PRD pointer,
    pub rsvd: [u8; 4],
// 16 bytes
    pub /: *mut *mut u8 feature; / ATA Feature,
    pub /: *mut *mut u8 hob_feature; / ATA Ex. Feature,
    pub /: *mut *mut u8 device; / ATA Device/Head,
    pub /: *mut *mut u8 mirctl; / Mirror Control,
    pub /: *mut *mut u8 nsect; / ATA Sector Count,
    pub /: *mut *mut u8 hob_nsect; / ATA Ex. Sector Count,
    pub /: *mut *mut u8 lbal; / ATA Sector Number,
    pub /: *mut *mut u8 hob_lbal; / ATA Ex. Sector Number,
    pub /: *mut *mut u8 lbam; / ATA Cylinder Low,
    pub /: *mut *mut u8 hob_lbam; / ATA Ex. Cylinder Low,
    pub /: *mut *mut u8 lbah; / ATA Cylinder High,
    pub /: *mut *mut u8 hob_lbah; / ATA Ex. Cylinder High,
    pub /: *mut *mut u8 command; / ATA Command,
    pub /: *mut *mut u8 ctl; / ATA Control,
    pub /: *mut *mut u8 slave_error; / Slave ATA Error,
    pub /: *mut *mut u8 slave_status; / Slave ATA Status,
// 32 bytes
    pub __packed: },
...
#[derive(Copy, Clone)]
pub struct inic_prd {
    pub /: *mut *mut __le32 mad; / Physical Memory Address,
    pub /: *mut *mut __le16 len; / Transfer Length,
    pub rsvd: u8,
    pub /: *mut *mut u8 flags; / Control Flags,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inic_pkt {
    pub cpb: inic_cpb,
    pub /: *mut *mut inic_prd prd[LIBATA_MAX_PRD + 1]; / + 1 for cdb,
    pub cdb: [u8; ATAPI_CDB_LEN],
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct inic_host_priv {
...
pub struct inic_port_priv {
    pub pkt: *mut inic_pkt,
    pub pkt_dma: dma_addr_t,
    pub cpb_tbl: *mut u32,
    pub cpb_tbl_dma: dma_addr_t,
}
...
#[no_mangle]
unsafe extern "C" fn inic_reset_port(port_base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn inic_scr_read(link: *mut ata_link, sc_reg: unsigned, val: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inic_scr_write(link: *mut ata_link, sc_reg: unsigned, val: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inic_stop_idma(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn inic_host_err_intr(ap: *mut ata_port, irq_stat: u8, idma_stat: u16) {
...
#[no_mangle]
unsafe extern "C" fn inic_host_intr(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn inic_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn inic_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inic_fill_sg(prd: *mut inic_prd, qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn inic_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    ...
    let mut is_atapi: bool = ata_is_atapi(qc.tf.protocol);
    let mut is_data: bool = ata_is_data(qc.tf.protocol);
    let mut cdb_len: c_uint = 0;
    if (is_atapi)
...
#[no_mangle]
unsafe extern "C" fn inic_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn inic_tf_read(ap: *mut ata_port, tf: *mut ata_taskfile) {
...
#[no_mangle]
unsafe extern "C" fn inic_qc_fill_rtf(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn inic_freeze(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn inic_thaw(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn inic_check_ready(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inic_error_handler(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn inic_post_internal_cmd(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn init_port(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn inic_port_resume(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inic_port_start(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn init_controller(mmio_base: *mut void __iomem, hctl: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inic_pci_device_resume(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inic_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int inic_init_one(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    const struct ata_port_info *ppi[] = { &inic_port_info, core::ptr::null_mut() };
