...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sis_chipset {
    pub /: *mut *mut u16 device; / PCI host ID,
    pub /: *const *const *const ata_port_info info; / Info block,
...
#[no_mangle]
unsafe extern "C" fn sis_short_ata40(dev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sis_old_port_base(adev: *mut ata_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sis_port_base(adev: *mut ata_device) -> c_int {
    static int sis_port_base(struct ata_device *adev)
    {
    struct ata_port *ap = adev.link.ap;
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut port: c_int = 0x40;
    u32 reg54;
...
//
#[no_mangle]
unsafe extern "C" fn sis_133_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sis_66_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sis_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sis_set_fifo(ap: *mut ata_port, adev: *mut ata_device) {
    static void sis_set_fifo(struct ata_port *ap, struct ata_device *adev)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    u8 fifoctrl;
    let mut mask: u8 = 0x11;
    mask <<= (2 * ap.port_no);
    mask <<= adev.devno;
...
//
#[no_mangle]
unsafe extern "C" fn sis_old_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
    static void sis_old_set_piomode (struct ata_port *ap, struct ata_device *adev)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut port: c_int = sis_old_port_base(adev);
    u8 t1, t2;
    let mut speed: c_int = adev.pio_mode - XFER_PIO_0;
...
//
#[no_mangle]
unsafe extern "C" fn sis_100_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sis_133_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sis_old_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void sis_old_set_dmamode (struct ata_port *ap, struct ata_device *adev)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut speed: c_int = adev.dma_mode - XFER_MW_DMA_0;
    let mut drive_pci: c_int = sis_old_port_base(adev);
    u16 timing;
...
//
#[no_mangle]
unsafe extern "C" fn sis_66_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sis_100_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sis_133_early_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sis_133_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn sis_133_mode_filter(adev: *mut ata_device, mask: c_uint) -> c_uint {
    static unsigned int sis_133_mode_filter(struct ata_device *adev, unsigned int mask)
    {
    struct ata_port *ap = adev.link.ap;
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut port: c_int = sis_port_base(adev);
    u32 t1;
    pci_read_config_dword(pdev, port, &t1);
...
#[no_mangle]
unsafe extern "C" fn sis_fixup(pdev: *mut pci_dev, sis: *mut sis_chipset) {
...
//
#[no_mangle]
unsafe extern "C" fn sis_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int sis_init_one (struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    const struct ata_port_info *ppi[] = { core::ptr::null_mut(), core::ptr::null_mut() };
    struct pci_dev *host = core::ptr::null_mut();
    struct sis_chipset *chipset = core::ptr::null_mut();
...
// We have to find the bridge first
    ...
    host = pci_get_device(PCI_VENDOR_ID_SI, sets.device, core::ptr::null_mut());
...
// Try the second unmasking technique
    ...
    if (lpc_bridge == core::ptr::null_mut())
    break;
...
#[no_mangle]
unsafe extern "C" fn sis_reinit_one(pdev: *mut pci_dev) -> c_int {
