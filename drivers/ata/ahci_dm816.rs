...
//! Source: drivers/ata/ahci_dm816.c
#![no_std]
...
pub const AHCI_DM816_P0PHYCR_REG: c_uint = 0x178;
pub const AHCI_DM816_P1PHYCR_REG: c_uint = 0x1f8;
...
#[no_mangle]
unsafe extern "C" fn ahci_dm816_get_mpy_bits(refclk_rate: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahci_dm816_phy_init(hpriv: *mut ahci_host_priv, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahci_dm816_probe(pdev: *mut platform_device) -> c_int {
