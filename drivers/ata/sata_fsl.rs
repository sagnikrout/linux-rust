...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmdhdr_tbl_entry {
    pub cda: __le32,
    pub prde_fis_len: __le32,
    pub ttl: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct command_desc {
    pub 4]: *mut *mut u8 cfis[8,
    pub 4]: *mut *mut u8 sfis[8,
    struct_group(cdb,
    pub 4]: *mut *mut u8 acmd[4,
    pub 4]: *mut *mut u8 fill[4,
    pub 4]: *mut *mut u32 prdt[SATA_FSL_MAX_PRD_DIRECT,
    pub 4]: *mut *mut u32 prdt_indirect[(SATA_FSL_MAX_PRD - SATA_FSL_MAX_PRD_DIRECT),
}
...
pub struct prde {
    pub dba: __le32,
    pub 4]: *mut *mut u8 fill[2,
    pub ddc_and_ext: __le32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sata_fsl_port_priv {
    pub cmdslot: *mut cmdhdr_tbl_entry,
    pub cmdslot_paddr: dma_addr_t,
    pub cmdentry: *mut command_desc,
    pub cmdentry_paddr: dma_addr_t,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sata_fsl_host_priv {
    pub hcr_base: *mut void __iomem,
    pub ssr_base: *mut void __iomem,
    pub csr_base: *mut void __iomem,
    pub irq: c_int,
    pub data_snoop: c_int,
    pub intr_coalescing: device_attribute,
    pub rx_watermark: device_attribute,
}
...
#[no_mangle]
pub unsafe extern "C" fn if(ICC_MIN_INT_COUNT_THRESHOLD: count <) -> else {
...
// NOTE: both data_xfer_len & fis_len are Dword counts
    ...
    let mut num_prde: c_uint = 0;
    let mut ttl_dwords: u32 = 0;
//
// NOTE : direct & indirect prdt's are contiguously allocated
//
    struct prde *prd = (struct prde *)&((struct command_desc *)
    cmd_desc).prdt;
    struct prde *prd_ptr_to_indirect_ext = core::ptr::null_mut();
    let mut indirect_ext_segment_sz: unsigned = 0;
    dma_addr_t indirect_ext_segment_paddr;
    unsigned int si;
    indirect_ext_segment_paddr = cmd_desc_paddr +
    SATA_FSL_CMD_DESC_OFFSET_TO_PRDT + SATA_FSL_MAX_PRD_DIRECT * 16;
    for_each_sg(qc.sg, sg, qc.n_elem, si) {
    let mut sg_addr: dma_addr_t = sg_dma_address(sg);
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    ...
    void __iomem *hcr_base = host_priv.hcr_base;
    let mut tag: c_uint = sata_fsl_tag(ap, qc.hw_tag, hcr_base);
    struct command_desc *cd;
    let mut desc_info: u32 = CMD_DESC_RES | CMD_DESC_SNOOP_ENABLE;
    let mut num_prde: u32 = 0;
    let mut ttl_dwords: u32 = 0;
    dma_addr_t cd_paddr;
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_qc_fill_rtf(qc: *mut ata_queued_cmd) {
    static void sata_fsl_qc_fill_rtf(struct ata_queued_cmd *qc)
    {
    struct sata_fsl_port_priv *pp = qc.ap.private_data;
    struct sata_fsl_host_priv *host_priv = qc.ap.host.private_data;
    void __iomem *hcr_base = host_priv.hcr_base;
    let mut tag: c_uint = sata_fsl_tag(qc.ap, qc.hw_tag, hcr_base);
    struct command_desc *cd;
    cd = pp.cmdentry + tag;
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_freeze(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_thaw(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_pmp_attach(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_pmp_detach(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_port_start(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_port_stop(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_dev_classify(ap: *mut ata_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_error_handler(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_post_internal_cmd(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_error_intr(ap: *mut ata_port) {
    ...
    let mut freeze: c_int = 0, abort=0;
    struct ata_link *link = core::ptr::null_mut();
    struct ata_queued_cmd *qc = core::ptr::null_mut();
...
// freeze or abort
    ...
    ata_port_freeze(ap);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: abort) -> else {
    if (qc)
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_host_intr(ap: *mut ata_port) {
    ...
    u32 SError;
    u32 tag;
    let mut status_mask: u32 = INT_ON_ERROR;
    hstatus = ioread32(hcr_base + HSTATUS);
    sata_fsl_scr_read(&ap.link, SCR_ERROR, &SError);
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn sata_fsl_init_controller(host: *mut ata_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_host_stop(host: *mut ata_host) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_probe(ofdev: *mut platform_device) -> c_int {
    static int sata_fsl_probe(struct platform_device *ofdev)
    {
    let mut retval: c_int = -ENXIO;
    void __iomem *hcr_base = core::ptr::null_mut();
    void __iomem *ssr_base = core::ptr::null_mut();
    void __iomem *csr_base = core::ptr::null_mut();
    struct sata_fsl_host_priv *host_priv = core::ptr::null_mut();
    int irq;
    struct ata_host *host = core::ptr::null_mut();
    u32 temp;
    let mut pi: ata_port_info = sata_fsl_port_info[0];
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_remove(ofdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_suspend(op: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sata_fsl_resume(op: *mut platform_device) -> c_int {
