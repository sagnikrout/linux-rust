...
//! Source: drivers/ata/libata-sata.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_scr_valid(link: *mut ata_link) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_scr_read(link: *mut ata_link, reg: c_int, val: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_scr_write(link: *mut ata_link, reg: c_int, val: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_scr_write_flush(link: *mut ata_link, reg: c_int, val: u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_tf_to_fis(tf: *const ata_taskfile, pmp: u8, is_cmd: c_int, fis: *mut u8) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_tf_from_fis(fis: *const u8, tf: *mut ata_taskfile) {
...
//
    ...
    {
    let mut interval: c_uint = params[0];
    let mut duration: c_uint = params[1];
...
//
    ...
    unsigned long deadline)
    {
    let mut tries: c_int = ATA_LINK_RESUME_TRIES;
    u32 scontrol, serror;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn __sata_set_spd_needed(link: *mut ata_link, scontrol: *mut u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sata_set_spd_needed(link: *mut ata_link) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_set_spd(link: *mut ata_link) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_down_spd_limit(link: *mut ata_link, spd_limit: u32) -> c_int {
...
//
    ...
    mask &= (1 << (spd - 1)) - 1;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: link->sata_spd) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_qc_complete_multiple(ap: *mut ata_port, qc_active: u64) -> c_int {
    int ata_qc_complete_multiple(struct ata_port *ap, u64 qc_active)
    {
    u64 done_mask, ap_qc_active = ap.qc_active;
    let mut nr_done: c_int = 0;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_slave_link_init(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_lpm_ignore_phy_events(link: *mut ata_link) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ata_scsi_lpm_supported(ap: *mut ata_port) -> bool {
    ...
    ata_scsi_lpm_supported_show, core::ptr::null_mut());
...
// supported = dev->flags & ATA_DFLAG_NCQ_PRIO;
    ...
    DEVICE_ATTR(ncq_prio_supported, S_IRUGO, ata_ncq_prio_supported_show, core::ptr::null_mut());
...
//
    ...
    ata_scsi_em_message_type_show, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_scsi_change_queue_depth(sdev: *mut scsi_device, queue_depth: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sas_queuecmd(cmd: *mut scsi_cmnd, ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_async_notification(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_get_ncq_success_sense(link: *mut ata_link) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_eh_analyze_ncq_error(link: *mut ata_link) {
