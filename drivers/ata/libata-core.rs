...
//! Source: drivers/ata/libata-core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ata_force_param {
    pub name: *const c_char,
    pub value: u64,
    pub cbl: u8,
    pub spd_limit: u8,
    pub xfer_mask: c_uint,
    pub quirk_on: u64,
    pub quirk_off: u64,
    pub pflags_on: c_uint,
    pub lflags_on: u16,
    pub lflags_off: u16,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ata_force_ent {
    pub port: c_int,
    pub device: c_int,
    pub param: ata_force_param,
}
...
// param_buf is thrown away after initialization, disallow read
    ...
    let mut atapi_enabled: static int = 1;
    module_param(atapi_enabled, int, 0444);
    MODULE_PARM_DESC(atapi_enabled, "Enable discovery of ATAPI devices (0=off, 1=on [default])");
    let mut atapi_dmadir: static int = 0;
    module_param(atapi_dmadir, int, 0444);
    MODULE_PARM_DESC(atapi_dmadir, "Enable ATAPI DMADIR bridge support (0=off [default], 1=on)");
    let mut atapi_passthru16: c_int = 1;
    module_param(atapi_passthru16, int, 0444);
    MODULE_PARM_DESC(atapi_passthru16, "Enable ATA_16 passthru for ATAPI devices (0=off, 1=on [default])");
    let mut libata_fua: c_int = 0;
    module_param_named(fua, libata_fua, int, 0444);
    MODULE_PARM_DESC(fua, "FUA support (0=off [default], 1=on)");
    static int ata_ignore_hpa;
    module_param_named(ignore_hpa, ata_ignore_hpa, int, 0644);
    MODULE_PARM_DESC(ignore_hpa, "Ignore HPA limit (0=keep BIOS limits, 1=ignore limits, using full disk)");
    let mut libata_dma_mask: static int = ATA_DMA_MASK_ATA|ATA_DMA_MASK_ATAPI|ATA_DMA_MASK_CFA;
    module_param_named(dma, libata_dma_mask, int, 0444);
    MODULE_PARM_DESC(dma, "DMA enable/disable (0x1==ATA, 0x2==ATAPI, 0x4==CF)");
    static int ata_probe_timeout;
    module_param(ata_probe_timeout, int, 0444);
    MODULE_PARM_DESC(ata_probe_timeout, "Set ATA probing timeout (seconds)");
    let mut libata_noacpi: c_int = 0;
    module_param_named(noacpi, libata_noacpi, int, 0444);
    MODULE_PARM_DESC(noacpi, "Disable the use of ACPI in probe/suspend/resume (0=off [default], 1=on)");
    let mut libata_allow_tpm: c_int = 0;
...
#[no_mangle]
pub unsafe extern "C" fn ata_dev_print_info(dev: *const ata_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_force_cbl(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_force_pflags(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_force_link_limits(link: *mut ata_link) {
    static void ata_force_link_limits(struct ata_link *link)
    {
    let mut did_spd: bool = false;
    let mut linkno: c_int = link.pmp;
    int i;
...
//
#[no_mangle]
unsafe extern "C" fn ata_force_xfermask(dev: *mut ata_device) {
    static void ata_force_xfermask(struct ata_device *dev)
    {
    let mut devno: c_int = dev.link.pmp + dev.devno;
    let mut alt_devno: c_int = devno;
    int i;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: mwdma_mask) -> else {
    dev.udma_mask = 0;
...
//
#[no_mangle]
unsafe extern "C" fn ata_force_quirks(dev: *mut ata_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn atapi_cmd_type(opcode: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_tf_read_block(tf: *const ata_taskfile, dev: *mut ata_device) -> u64 {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_set_tf_cdl(qc: *mut ata_queued_cmd, cdl: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_xfer_mask2mode(xfer_mask: c_uint) -> u8 {
    u8 ata_xfer_mask2mode(unsigned int xfer_mask)
    {
    let mut highbit: c_int = fls(xfer_mask) - 1;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_xfer_mode2mask(xfer_mode: u8) -> c_uint {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_xfer_mode2shift(xfer_mode: u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_classify(tf: *const ata_taskfile) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn ata_tf_to_lba48(tf: *const ata_taskfile) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn ata_tf_to_lba(tf: *const ata_taskfile) -> u64 {
...
//
#[no_mangle]
unsafe extern "C" fn ata_read_native_max_address(dev: *mut ata_device, max_sectors: *mut u64) -> c_int {
    static int ata_read_native_max_address(struct ata_device *dev, u64 *max_sectors)
    {
    unsigned int err_mask;
    struct ata_taskfile tf;
    let mut lba48: c_int = ata_id_has_lba48(dev.id);
    ata_tf_init(dev, &tf);
...
//
#[no_mangle]
unsafe extern "C" fn ata_set_max_sectors(dev: *mut ata_device, new_sectors: u64) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_hpa_resize(dev: *mut ata_device) -> c_int {
    static int ata_hpa_resize(struct ata_device *dev)
    {
    let mut print_info: bool = ata_dev_print_info(dev);
    let mut unlock_hpa: bool = ata_ignore_hpa || dev.flags & ATA_DFLAG_UNLOCK_HPA;
    let mut sectors: u64 = ata_id_n_sectors(dev.id);
    u64 native_sectors;
    int rc;
// do we need to do it?
...
#[no_mangle]
pub unsafe extern "C" fn if(sectors: native_sectors <) -> else {
...
// re-read IDENTIFY data
    ...
    if (print_info) {
    let mut new_sectors: u64 = ata_id_n_sectors(dev.id);
    ata_dev_info(dev,
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dump_id(dev: *mut ata_device, id: *const u16) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_id_xfermask(id: *const u16) -> c_uint {
...
// a mask.
//
    let mut mode: u8 = (id[ATA_ID_OLD_PIO_MODES] >> 8) & 0xFF;
...
//
    let mut pio: c_int = (id[ATA_ID_CFA_MODES] >> 0) & 0x7;
    let mut dma: c_int = (id[ATA_ID_CFA_MODES] >> 3) & 0x7;
    if (pio)
    pio_mask |= (1 << 5);
    if (pio > 1)
    pio_mask |= (1 << 6);
...
#[no_mangle]
unsafe extern "C" fn ata_qc_complete_internal(qc: *mut ata_queued_cmd) {
...
//
    ...
    let mut owns_eh_mutex: bool = ap.host.eh_owner == current;
    let mut command: u8 = tf.command;
    ...
    let mut auto_timeout: bool = false;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_pio_need_iordy(adev: *const ata_device) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn ata_pio_mask_no_iordy(adev: *const ata_device) -> u32 {
    static u32 ata_pio_mask_no_iordy(const struct ata_device *adev)
    {
// If we have no drive specific rule, then PIO 2 is non IORDY
    if (adev.id[ATA_ID_FIELD_VALID] & 2) {	/* EIDE */
    let mut pio: u16 = adev.id[ATA_ID_EIDE_PIO];
...
//
    ...
    {
    return ata_exec_internal(dev, tf, core::ptr::null_mut(), DMA_FROM_DEVICE,
...
//
    ...
    {
    struct ata_port *ap = dev.link.ap;
    let mut class: c_uint = *p_class;
    struct ata_taskfile tf;
    let mut err_mask: c_uint = 0;
    const char *reason;
    let mut is_semb: bool = class == ATA_DEV_SEMB;
    let mut may_fallback: c_int = 1, tried_spinup = 0;
    int rc;
    retry:
    ata_tf_init(dev, &tf);
    switch (class) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_power_is_active(dev: *mut ata_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_power_set_standby(dev: *mut ata_device) {
    void ata_dev_power_set_standby(struct ata_device *dev)
    {
    let mut ap_flags: c_ulong = dev.link.ap.flags;
    struct ata_taskfile tf;
    unsigned int err_mask;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_power_set_active(dev: *mut ata_device) {
...
//
    ...
    err_mask = ata_exec_internal(dev, &tf, core::ptr::null_mut(), DMA_FROM_DEVICE,
...
#[no_mangle]
pub unsafe extern "C" fn ata_clear_log_directory(dev: *mut ata_device) {
    static inline void ata_clear_log_directory(struct ata_device *dev)
    {
    memset(dev.gp_log_dir, 0, ATA_SECT_SIZE);
    }
#[no_mangle]
unsafe extern "C" fn ata_read_log_directory(dev: *mut ata_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_log_supported(dev: *mut ata_device, log: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_identify_page_supported(dev: *mut ata_device, page: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ata_do_link_spd_quirk(dev: *mut ata_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ata_dev_knobble(dev: *mut ata_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_ncq_send_recv(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_ncq_non_data(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_ncq_prio(dev: *mut ata_device) {
    ...
    {
    struct pci_dev *pcidev = core::ptr::null_mut();
    struct device *parent_dev = core::ptr::null_mut();
    for (parent_dev = dev.tdev.parent; parent_dev != core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn ata_adapter_is_online(ap: *mut ata_port) -> bool {
    ...
    {
    struct ata_port *ap = dev.link.ap;
    let mut hdepth: c_int = 0, ddepth = ata_id_queue_depth(dev.id);
    unsigned int err_mask;
    char *aa_desc = "";
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_sense_reporting(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_zoned(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_trusted(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_cleanup_cdl_resources(dev: *mut ata_device) {
    static void ata_dev_cleanup_cdl_resources(struct ata_device *dev)
    {
    kfree(dev.cdl);
    dev.cdl = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn ata_dev_init_cdl_resources(dev: *mut ata_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_cdl(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_depop(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_lba(dev: *mut ata_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_chs(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_fua(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_devslp(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_config_cpr(dev: *mut ata_device) {
    static void ata_dev_config_cpr(struct ata_device *dev)
    {
    unsigned int err_mask;
    size_t buf_len;
    int i, nr_cpr = 0;
    struct ata_cpr_log *cpr_log = core::ptr::null_mut();
    u8 *desc, *buf = core::ptr::null_mut();
    if (ata_id_major_version(dev.id) < 11)
    goto out;
...
//
#[no_mangle]
unsafe extern "C" fn ata_dev_config_lpm(dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_print_features(dev: *mut ata_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_configure(dev: *mut ata_device) -> c_int {
...
// get current R/W Multiple count setting
    ...
    let mut max: c_uint = dev.id[47] & 0xff;
    let mut cnt: c_uint = dev.id[59] & 0xff;
...
#[no_mangle]
pub unsafe extern "C" fn if(ATA_DEV_ATAPI: dev->class ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_cable_40wire(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_cable_80wire(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_cable_unknown(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_cable_ignore(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_cable_sata(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn sata_print_link_status(link: *mut ata_link) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_timing_cycle2mode(xfer_shift: c_uint, cycle: c_int) -> u8 {
    u8 ata_timing_cycle2mode(unsigned int xfer_shift, int cycle)
    {
    let mut base_mode: u8 = 0xff, last_mode = 0xff;
    const struct ata_xfer_ent *ent;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_down_xfermask_limit(dev: *mut ata_device, sel: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_set_mode(dev: *mut ata_device) -> c_int {
    static int ata_dev_set_mode(struct ata_device *dev)
    {
    struct ata_port *ap = dev.link.ap;
    struct ata_eh_context *ehc = &dev.link.eh_context;
    let mut nosetxfer: bool = dev.quirks & ATA_QUIRK_NOSETXFER;
    const char *dev_err_whine = "";
    let mut ign_dev_err: c_int = 0;
    let mut err_mask: c_uint = 0;
    int rc;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_set_mode(link: *mut ata_link, r_failed_dev: *mut ata_device) -> c_int {
    int ata_set_mode(struct ata_link *link, struct ata_device **r_failed_dev)
    {
    struct ata_port *ap = link.ap;
    struct ata_device *dev;
    let mut rc: c_int = 0, used_dma = 0, found = 0;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ata_id_is_cfa(dev->id)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_std_prereset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_std_postreset(link: *mut ata_link, classes: *mut c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_reread_id(dev: *mut ata_device, readid_flags: c_uint) -> c_int {
    int ata_dev_reread_id(struct ata_device *dev, unsigned int readid_flags)
    {
    let mut class: c_uint = dev.class;
...
//
    ...
    {
    let mut n_sectors: u64 = dev.n_sectors;
    let mut n_native_sectors: u64 = dev.n_native_sectors;
    int rc;
    if (!ata_dev_enabled(dev))
    return -ENODEV;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ata_dev_quirk_value {
    pub model_num: *const c_char,
    pub model_rev: *const c_char,
    pub val: u64,
}

    static const struct ata_dev_quirk_value __ata_dev_max_sec_quirks[] = {
    { "TORiSAN DVD-ROM DRD-N216",	core::ptr::null_mut(),		128 },
    { "ST380013AS",			"3.20",		1024 },
    { "LITEON CX1-JB*-HP",		core::ptr::null_mut(),		1024 },
    { "LITEON EP1-*",		core::ptr::null_mut(),		1024 },
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ata_dev_quirks_entry {
    pub model_num: *const c_char,
    pub model_rev: *const c_char,
    pub quirks: u64,
}
...
// Devices with DMA related problems under Linux
    { "WDC AC11000H",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "WDC AC22100H",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "WDC AC32500H",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "WDC AC33100H",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "WDC AC31600H",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "WDC AC32100H",	"24.09P07",	ATA_QUIRK_NODMA },
    { "WDC AC23200L",	"21.10N21",	ATA_QUIRK_NODMA },
    { "Compaq CRD-8241B",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "CRD-8400B",		core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "CRD-848[02]B",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "CRD-84",		core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "SanDisk SDP3B",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "SanDisk SDP3B-64",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "SANYO CD-ROM CRD",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "HITACHI CDR-8",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "HITACHI CDR-8[34]35", core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "Toshiba CD-ROM XM-6202B", core::ptr::null_mut(),	ATA_QUIRK_NODMA },
    { "TOSHIBA CD-ROM XM-1702BC", core::ptr::null_mut(),	ATA_QUIRK_NODMA },
    { "CD-532E-A",		core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "E-IDE CD-ROM CR-840", core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "CD-ROM Drive/F5A",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "WPI CDD-820",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "SAMSUNG CD-ROM SC-148C", core::ptr::null_mut(),	ATA_QUIRK_NODMA },
    { "SAMSUNG CD-ROM SC",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "ATAPI CD-ROM DRIVE 40X MAXIMUM", core::ptr::null_mut(), ATA_QUIRK_NODMA },
    { "_NEC DV5800A",	core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { "SAMSUNG CD-ROM SN-124", "N001",	ATA_QUIRK_NODMA },
    { "Seagate STT20000A", core::ptr::null_mut(),		ATA_QUIRK_NODMA },
    { " 2GB ATA Flash Disk", "ADMA428M",	ATA_QUIRK_NODMA },
    { "VRFDFC22048UCHC-TE*", core::ptr::null_mut(),		ATA_QUIRK_NODMA },
// Odd clown on sil3726/4726 PMPs
    { "Config  Disk",	core::ptr::null_mut(),		ATA_QUIRK_DISABLE },
// Similar story with ASMedia 1092
    { "ASMT109x- Config",	core::ptr::null_mut(),		ATA_QUIRK_DISABLE },
// Weird ATAPI devices
    { "TORiSAN DVD-ROM DRD-N216", core::ptr::null_mut(),	ATA_QUIRK_MAX_SEC },
    { "QUANTUM DAT    DAT72-000", core::ptr::null_mut(),	ATA_QUIRK_ATAPI_MOD16_DMA },
    { "Slimtype DVD A  DS8A8SH", core::ptr::null_mut(),	ATA_QUIRK_MAX_SEC_LBA48 },
    { "Slimtype DVD A  DS8A9SH", core::ptr::null_mut(),	ATA_QUIRK_MAX_SEC_LBA48 },
//
...
//
    { "LITEON CX1-JB*-HP",	core::ptr::null_mut(),		ATA_QUIRK_MAX_SEC },
    { "LITEON EP1-*",	core::ptr::null_mut(),		ATA_QUIRK_MAX_SEC },
//
// These devices time out with higher max sects.
...
// NCQ is slow
    { "WDC WD740ADFD-00",	core::ptr::null_mut(),		ATA_QUIRK_NONCQ },
    { "WDC WD740ADFD-00NLR1", core::ptr::null_mut(),		ATA_QUIRK_NONCQ },
// http://thread.gmane.org/gmane.linux.ide/14907
    { "FUJITSU MHT2060BH",	core::ptr::null_mut(),		ATA_QUIRK_NONCQ },
// NCQ is broken
...
// ADATA devices with LPM issues.
    { "ADATA SU680",	core::ptr::null_mut(),		ATA_QUIRK_NOLPM },
// Seagate disks with LPM issues
    { "ST1000DM010-2EP102",	core::ptr::null_mut(),		ATA_QUIRK_NOLPM },
    { "ST2000DM008-2FR102",	core::ptr::null_mut(),		ATA_QUIRK_NOLPM },
// drives which fail FPDMA_AA activation (some may freeze afterwards)
    the ST disks also have LPM issues */
    { "ST1000LM024 HN-M101MBB", core::ptr::null_mut(),	ATA_QUIRK_BROKEN_FPDMA_AA |
    ATA_QUIRK_NOLPM },
...
// Sandisk SD7/8/9s lock up hard on large trims
    { "SanDisk SD[789]*",	core::ptr::null_mut(),		ATA_QUIRK_MAX_TRIM_128M },
...
// Devices which report 1 sector over size HPA
    { "ST340823A",		core::ptr::null_mut(),		ATA_QUIRK_HPA_SIZE },
    { "ST320413A",		core::ptr::null_mut(),		ATA_QUIRK_HPA_SIZE },
    { "ST310211A",		core::ptr::null_mut(),		ATA_QUIRK_HPA_SIZE },
...
// Devices that do not need bridging limits applied
    { "MTRON MSP-SATA*",		core::ptr::null_mut(),	ATA_QUIRK_BRIDGE_OK },
    { "BUFFALO HD-QSU2/R5",		core::ptr::null_mut(),	ATA_QUIRK_BRIDGE_OK },
    { "QEMU HARDDISK",		"2.5+",	ATA_QUIRK_BRIDGE_OK },
// Devices which aren't very happy with higher link speeds
    { "WD My Book",			core::ptr::null_mut(),	ATA_QUIRK_1_5_GBPS },
    { "Seagate FreeAgent GoFlex",	core::ptr::null_mut(),	ATA_QUIRK_1_5_GBPS },
//
// Devices which choke on SETXFER.  Applies only if both the
// device and controller are SATA.
//
    { "PIONEER DVD-RW  DVRTD08",	core::ptr::null_mut(),	ATA_QUIRK_NOSETXFER },
    { "PIONEER DVD-RW  DVRTD08A",	core::ptr::null_mut(),	ATA_QUIRK_NOSETXFER },
    { "PIONEER DVD-RW  DVR-215",	core::ptr::null_mut(),	ATA_QUIRK_NOSETXFER },
    { "PIONEER DVD-RW  DVR-212D",	core::ptr::null_mut(),	ATA_QUIRK_NOSETXFER },
    { "PIONEER DVD-RW  DVR-216D",	core::ptr::null_mut(),	ATA_QUIRK_NOSETXFER },
// These specific Pioneer models have LPM issues
    { "PIONEER BD-RW   BDR-207M",	core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
    { "PIONEER BD-RW   BDR-205",	core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
// Crucial devices with broken LPM support
    { "CT*0BX*00SSD1",		core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
// 512GB MX100 with MU01 firmware has both queued TRIM and LPM issues
    { "Crucial_CT512MX100*",	"MU01",	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM |
    ATA_QUIRK_NOLPM },
// 512GB MX100 with newer firmware has only LPM issues
    { "Crucial_CT512MX100*",	core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM |
    ATA_QUIRK_NOLPM },
// 480GB+ M500 SSDs have both queued TRIM and LPM issues
    { "Crucial_CT480M500*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM |
    ATA_QUIRK_NOLPM },
    { "Crucial_CT960M500*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM |
    ATA_QUIRK_NOLPM },
// AMD Radeon devices with broken LPM support
    { "R3SL240G",			core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
// Apacer models with LPM issues
    { "Apacer AS340*",		core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
// PNY CS900 (Phison PS3111-S11, DRAM-less) drops the link on DIPM
    { "PNY CS900 1TB SSD",		core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
...
// These specific Samsung models/firmware-revs do not handle LPM well
    ...
    { "SAMSUNG MZ7TD256HAFV-000L9", core::ptr::null_mut(),       ATA_QUIRK_NOLPM },
    { "SAMSUNG MZ7TE512HMHP-000L1", "EXT06L0Q", ATA_QUIRK_NOLPM },
// devices that don't properly handle queued TRIM commands
    { "Micron_M500IT_*",		"MU01",	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Micron_M500_*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Micron_M5[15]0_*",		"MU01",	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Micron_1100_*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM, },
    { "Crucial_CT*M500*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Crucial_CT*M550*",		"MU01",	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Crucial_CT*MX100*",		"MU01",	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Samsung SSD 840 EVO*",	core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_NO_DMA_LOG |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Samsung SSD 840*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Samsung SSD 850*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Samsung SSD 860*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM |
    ATA_QUIRK_NO_NCQ_ON_ATI |
    ATA_QUIRK_NO_LPM_ON_ATI },
    { "Samsung SSD 870*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM |
    ATA_QUIRK_NO_NCQ_ON_ATI |
    ATA_QUIRK_NO_LPM_ON_ATI },
    { "SAMSUNG*MZ7LH*",		core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM |
    ATA_QUIRK_NO_NCQ_ON_ATI |
    ATA_QUIRK_NO_LPM_ON_ATI },
    { "FCCT*M500*",			core::ptr::null_mut(),	ATA_QUIRK_NO_NCQ_TRIM |
    ATA_QUIRK_ZERO_AFTER_TRIM },
// devices that don't properly handle TRIM commands
    { "SuperSSpeed S238*",		core::ptr::null_mut(),	ATA_QUIRK_NOTRIM },
    { "M88V29*",			core::ptr::null_mut(),	ATA_QUIRK_NOTRIM },
//
...
//
    { "INTEL*SSDSC2MH*",		core::ptr::null_mut(),	0 },
    { "Micron*",			core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Crucial*",			core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM },
    { "INTEL SSDSC2KG480G8", "XCV10120",	ATA_QUIRK_ZERO_AFTER_TRIM |
    ATA_QUIRK_MAX_SEC },
    { "INTEL*SSD*",			core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM },
    { "SSD*INTEL*",			core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM },
    { "Samsung*SSD*",		core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM },
    { "SAMSUNG*SSD*",		core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM },
    { "SAMSUNG*MZ7KM*",		core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM },
    { "ST[1248][0248]0[FH]*",	core::ptr::null_mut(),	ATA_QUIRK_ZERO_AFTER_TRIM },
//
...
//
    { "WDC WD800JD-*",		core::ptr::null_mut(),	ATA_QUIRK_WD_BROKEN_LPM },
    { "WDC WD1200JD-*",		core::ptr::null_mut(),	ATA_QUIRK_WD_BROKEN_LPM },
    { "WDC WD1600JD-*",		core::ptr::null_mut(),	ATA_QUIRK_WD_BROKEN_LPM },
    { "WDC WD2000JD-*",		core::ptr::null_mut(),	ATA_QUIRK_WD_BROKEN_LPM },
    { "WDC WD2500JD-*",		core::ptr::null_mut(),	ATA_QUIRK_WD_BROKEN_LPM },
    { "WDC WD3000JD-*",		core::ptr::null_mut(),	ATA_QUIRK_WD_BROKEN_LPM },
    { "WDC WD3200JD-*",		core::ptr::null_mut(),	ATA_QUIRK_WD_BROKEN_LPM },
//
...
//
    { "WDC WD100EFGX-68CPLN0",	core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
    { "WDC WD102KFBX-68M95N0",	core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
    { "WDC WD141KFGX-68FH9N0",	core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
    { "WD Green 2.5 480GB",		core::ptr::null_mut(),	ATA_QUIRK_NOLPM },
//
// This sata dom device goes on a walkabout when the ATA_LOG_DIRECTORY
// log page is accessed. Ensure we never ask for this log page with
// these devices.
//
    { "SATADOM-ML 3ME",		core::ptr::null_mut(),	ATA_QUIRK_NO_LOG_DIR },
// Buggy FUA
    { "Maxtor",		"BANC1G10",	ATA_QUIRK_NO_FUA },
    { "WDC*WD2500J*",	core::ptr::null_mut(),		ATA_QUIRK_NO_FUA },
    { "OCZ-VERTEX*",	core::ptr::null_mut(),		ATA_QUIRK_NO_FUA },
    { "INTEL*SSDSC2CT*",	core::ptr::null_mut(),		ATA_QUIRK_NO_FUA },
// End Marker
    { }
    };
#[no_mangle]
unsafe extern "C" fn ata_dev_quirks(dev: *const ata_device) -> u64 {
    static u64 ata_dev_quirks(const struct ata_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_get_max_sec_quirk_value(dev: *mut ata_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_get_quirk_value(dev: *mut ata_device, quirk: u64) -> u64 {
    static u64 ata_dev_get_quirk_value(struct ata_device *dev, u64 quirk)
    {
...
#[no_mangle]
unsafe extern "C" fn ata_dev_nodma(dev: *const ata_device) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ata_is_40wire(dev: *mut ata_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cable_is_40wire(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_dev_xfermask(dev: *mut ata_device) {
    static void ata_dev_xfermask(struct ata_device *dev)
    {
    struct ata_link *link = dev.link;
    struct ata_port *ap = link.ap;
...
//
#[no_mangle]
unsafe extern "C" fn ata_dev_set_xfermode(dev: *mut ata_device) -> c_uint {
    static unsigned int ata_dev_set_xfermode(struct ata_device *dev)
    {
    struct ata_taskfile tf;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: ata_id_has_iordy(dev->id)) -> else {
...
// timeout.
//
    return ata_exec_internal(dev, &tf, core::ptr::null_mut(), DMA_NONE, core::ptr::null_mut(), 0, 15000);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_set_feature(dev: *mut ata_device, subcmd: u8, action: u8) -> c_uint {
...
// set up set-features taskfile
    ...
    return ata_exec_internal(dev, &tf, core::ptr::null_mut(), DMA_NONE, core::ptr::null_mut(), 0, timeout);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn atapi_check_dma(qc: *mut ata_queued_cmd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_std_qc_defer(qc: *mut ata_queued_cmd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_sg_clean(qc: *mut ata_queued_cmd) {
    static void ata_sg_clean(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct scatterlist *sg = qc.sg;
    let mut dir: c_int = qc.dma_dir;
    WARN_ON_ONCE(sg == core::ptr::null_mut());
    if (qc.n_elem)
    dma_unmap_sg(ap.dev, sg, qc.orig_n_elem, dir);
    qc.flags &= ~ATA_QCFLAG_DMAMAP;
    qc.sg = core::ptr::null_mut();
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn ata_sg_setup(qc: *mut ata_queued_cmd) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn swap_buf_le16(buf: *mut u16, buf_words: c_uint) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_qc_free(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
pub unsafe extern "C" fn __ata_qc_complete(qc: *mut ata_queued_cmd) {
...
// clear exclusive status
    ...
    ap.excl_link == link))
    ap.excl_link = core::ptr::null_mut();
//
...
#[no_mangle]
unsafe extern "C" fn fill_result_tf(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn ata_verify_xfer(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_qc_complete(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_qc_get_active(ap: *mut ata_port) -> u64 {
    u64 ata_qc_get_active(struct ata_port *ap)
    {
    let mut qc_active: u64 = ap.qc_active;
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_qc_issue(ap: *mut ata_port, qc: *mut ata_queued_cmd) {
    void ata_qc_issue(struct ata_port *ap, struct ata_queued_cmd *qc)
    __must_hold(ap.lock)
    {
    struct ata_link *link = qc.dev.link;
    let mut prot: u8 = qc.tf.protocol;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_phys_link_online(link: *mut ata_link) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_phys_link_offline(link: *mut ata_link) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_link_online(link: *mut ata_link) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_link_offline(link: *mut ata_link) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ata_port_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_port_pm_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_port_pm_poweroff(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_port_pm_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ata_port_runtime_idle(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_port_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ata_port_runtime_resume(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_sas_port_suspend(ap: *mut ata_port) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_sas_port_resume(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_host_suspend(host: *mut ata_host, mesg: pm_message_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_host_resume(host: *mut ata_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_init(dev: *mut ata_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_link_init(ap: *mut ata_port, link: *mut ata_link, pmp: c_int) {
...
//
#[no_mangle]
pub unsafe extern "C" fn sata_link_init_spd(link: *mut ata_link) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ata_port_free(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ata_devres_release(gendev: *mut device, res: *mut c_void) {
    ...
    dev_set_drvdata(gendev, core::ptr::null_mut());
    ata_host_put(host);
    }
#[no_mangle]
unsafe extern "C" fn ata_host_release(kref: *mut kref) {
    ...
    host.ports[i] = core::ptr::null_mut();
    }
    kfree(host);
    }
#[no_mangle]
pub unsafe extern "C" fn ata_host_get(host: *mut ata_host) {
    void ata_host_get(struct ata_host *host)
    {
    kref_get(&host.kref);
    }
#[no_mangle]
pub unsafe extern "C" fn ata_host_put(host: *mut ata_host) {
...
// alloc a container for our list of ATA ports (buses)
    ...
    if (!host)
    return core::ptr::null_mut();
    if (!devres_open_group(dev, core::ptr::null_mut(), GFP_KERNEL)) {
    kfree(host);
    return core::ptr::null_mut();
    }
...
// allocate ports bound to this host
    ...
    devres_remove_group(dev, core::ptr::null_mut());
    return host;
    err_out:
    devres_release_group(dev, core::ptr::null_mut());
    return core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn ata_host_stop(gendev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_finalize_port_ops(ops: *mut ata_port_operations) {
...
// pp = *inherit;
    ...
    if (IS_ERR(*pp))
// pp = NULL;
    ops.inherits = core::ptr::null_mut();
    spin_unlock(&lock);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_host_start(host: *mut ata_host) -> c_int {
    int ata_host_start(struct ata_host *host)
    {
    let mut have_stop: c_int = 0;
    void *start_dr = core::ptr::null_mut();
    int i, rc;
...
#[no_mangle]
pub unsafe extern "C" fn ata_port_probe(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn async_port_probe(data: *mut c_void, cookie: async_cookie_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_host_register(host: *mut ata_host, sht: *const scsi_host_template) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_dev_free_resources(dev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ata_port_detach(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_host_detach(host: *mut ata_host) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_pci_remove_one(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_pci_shutdown_one(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn pci_test_config_bits(pdev: *mut pci_dev, bits: *const pci_bits) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ata_pci_device_do_suspend(pdev: *mut pci_dev, mesg: pm_message_t) {
...
#[no_mangle]
pub unsafe extern "C" fn ata_pci_device_do_resume(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ata_pci_device_suspend(pdev: *mut pci_dev, mesg: pm_message_t) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ata_pci_device_resume(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_platform_remove_one(pdev: *mut platform_device) {
...
//
    ...
    const struct ata_force_param *match_fp = core::ptr::null_mut();
    u64 val_after_equalsign;
    let mut nr_matches: c_int = 0, i;
...
#[no_mangle]
unsafe extern "C" fn ata_parse_force_param() -> void __init {
    static void __init ata_parse_force_param(void)
    {
    let mut idx: c_int = 0, size = 1;
    let mut last_port: c_int = -1, last_device = -1;
    char *p, *cur, *next;
...
// parse and populate the table
    ...
    const char *reason = "";
    let mut te: ata_force_ent = { .port = -1, .device = -1 };
    next = cur;
...
#[no_mangle]
unsafe extern "C" fn ata_free_force_param() {
...
#[no_mangle]
unsafe extern "C" fn ata_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ata_exit() -> void __exit {
...
#[no_mangle]
pub unsafe extern "C" fn ata_ratelimit() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn ata_msleep(ap: *mut ata_port, msecs: c_uint) {
    void ata_msleep(struct ata_port *ap, unsigned int msecs)
    __context_unsafe(conditional locking)
    {
    let mut owns_eh: bool = ap && ap.host.eh_owner == current;
    if (owns_eh)
    ata_eh_release(ap);
    if (msecs < 20) {
    let mut usecs: c_ulong = msecs * USEC_PER_MSEC;
...
//
#[no_mangle]
unsafe extern "C" fn ata_dummy_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int ata_dummy_qc_issue(struct ata_queued_cmd *qc)
    {
    return AC_ERR_SYSTEM;
    }
#[no_mangle]
unsafe extern "C" fn ata_dummy_error_handler(ap: *mut ata_port) {
