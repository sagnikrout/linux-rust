...
//! Source: drivers/ata/pata_optidma.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn optidma_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn optidma_unlock(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn optidma_lock(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn optidma_mode_setup(ap: *mut ata_port, adev: *mut ata_device, mode: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn optiplus_mode_setup(ap: *mut ata_port, adev: *mut ata_device, mode: u8) {
    static void optiplus_mode_setup(struct ata_port *ap, struct ata_device *adev, u8 mode)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    u8 udcfg;
    u8 udslave;
    let mut dev2: c_int = 2 * adev.devno;
    let mut unit: c_int = 2 * ap.port_no + adev.devno;
    let mut udma: c_int = mode - XFER_UDMA_0;
...
//
#[no_mangle]
unsafe extern "C" fn optidma_set_pio_mode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn optidma_set_dma_mode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn optiplus_set_pio_mode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn optiplus_set_dma_mode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn optidma_make_bits43(adev: *mut ata_device) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn optidma_set_mode(link: *mut ata_link, r_failed: *mut ata_device) -> c_int {
    static int optidma_set_mode(struct ata_link *link, struct ata_device **r_failed)
    {
    struct ata_port *ap = link.ap;
    u8 r;
    let mut nybble: c_int = 4 * ap.port_no;
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    int rc;
...
//
#[no_mangle]
unsafe extern "C" fn optiplus_with_udma(pdev: *mut pci_dev) -> c_int {
    static int optiplus_with_udma(struct pci_dev *pdev)
    {
    u8 r;
    let mut ret: c_int = 0;
    let mut ioport: c_int = 0x22;
    struct pci_dev *dev1;
// Find function 1
    dev1 = pci_get_device(0x1045, 0xC701, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn optidma_init_one(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    const struct ata_port_info *ppi[] = { &info_82c700, core::ptr::null_mut() };
    int rc;
...
// Fixed location chipset magic
    ...
    return ata_pci_bmdma_init_one(dev, ppi, &optidma_sht, core::ptr::null_mut(), 0);
    }
