...
unsafe extern "C" fn pxa_ata_dma_irq(d: *mut c_void) {
    ...
    status = dmaengine_tx_status(pd.dma_chan, pd.dma_cookie, core::ptr::null_mut());
...
//
#[no_mangle]
unsafe extern "C" fn pxa_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
...
//
#[no_mangle]
unsafe extern "C" fn pxa_bmdma_status(ap: *mut ata_port) -> c_uchar {
    static unsigned char pxa_bmdma_status(struct ata_port *ap)
    {
    struct pata_pxa_data *pd = ap.private_data;
    let mut ret: c_uchar = ATA_DMA_INTR;
...
//
#[no_mangle]
unsafe extern "C" fn pxa_irq_clear(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn pxa_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pxa_ata_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    if (unlikely(dma_res == core::ptr::null_mut()))
    return -EINVAL;
//
// IRQ pin
//
