...
//! Source: drivers/ata/pata_ep93xx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ep93xx_pata_data {
    pub pdev: *mut platform_device,
    pub ide_base: *mut void __iomem,
    pub t: ata_timing,
    pub iordy: bool,
    pub udma_in_phys: c_ulong,
    pub udma_out_phys: c_ulong,
    pub dma_rx_channel: *mut dma_chan,
    pub dma_tx_channel: *mut dma_chan,
}

#[no_mangle]
unsafe extern "C" fn ep93xx_pata_clear_regs(base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_check_iordy(base: *mut void __iomem) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_get_wst(pio_mode: c_int) -> c_int {
    ...
    val = 3;
#[no_mangle]
pub unsafe extern "C" fn if(3: pio_mode <) -> else {
    else if (pio_mode < 3)
    val = 2;
    else
    val = 1;
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_enable_pio(base: *mut void __iomem, pio_mode: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_delay(count: c_ulong) {
...
//
    let mut start: c_ulong = (1250 + 35) / 25 - t2;
    let mut counter: c_ulong = start;
...
// lengthen t2 if needed
    ...
    let mut t0: c_ulong = reg ? t.cyc8b : t.cycle;
    let mut t2: c_ulong = reg ? t.act8b : t.active;
    let mut t2i: c_ulong = reg ? t.rec8b : t.recover;
...
//
    let mut T: c_ulong = 1000000 / (200 / 5);
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_check_status(ap: *mut ata_port) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_check_altstatus(ap: *mut ata_port) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_tf_read(ap: *mut ata_port, tf: *mut ata_taskfile) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_dev_select(ap: *mut ata_port, device: c_uint) {
    static void ep93xx_pata_dev_select(struct ata_port *ap, unsigned int device)
    {
    struct ep93xx_pata_data *drv_data = ap.host.private_data;
    let mut tmp: u8 = ATA_DEVICE_OBS;
    if (device != 0)
    tmp |= ATA_DEV1;
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_set_devctl(ap: *mut ata_port, ctl: u8) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_release_dma(drv_data: *mut ep93xx_pata_data) {
    static void ep93xx_pata_release_dma(struct ep93xx_pata_data *drv_data)
    {
    if (drv_data.dma_rx_channel) {
    dma_release_channel(drv_data.dma_rx_channel);
    drv_data.dma_rx_channel = core::ptr::null_mut();
    }
    if (drv_data.dma_tx_channel) {
    dma_release_channel(drv_data.dma_tx_channel);
    drv_data.dma_tx_channel = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_dma_init(drv_data: *mut ep93xx_pata_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_dma_start(qc: *mut ata_queued_cmd) {
    ...
    let mut v: u32 = qc.dma_dir == DMA_TO_DEVICE ? IDEUDMAOP_RWOP : 0;
    ...
    txd.callback = core::ptr::null_mut();
    txd.callback_param = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_dma_stop(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_dma_setup(qc: *mut ata_queued_cmd) {
    static void ep93xx_pata_dma_setup(struct ata_queued_cmd *qc)
    {
    qc.ap.ops.sff_exec_command(qc.ap, &qc.tf);
    }
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_dma_status(ap: *mut ata_port) -> u8 {
    static u8 ep93xx_pata_dma_status(struct ata_port *ap)
    {
    struct ep93xx_pata_data *drv_data = ap.host.private_data;
    let mut val: u32 = readl(drv_data.ide_base + IDEUDMASTS);
//
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_drain_fifo(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_port_start(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ep93xx_pata_remove(pdev: *mut platform_device) {
