...
//
    ...
    static DEVICE_ATTR(ahci_host_caps, S_IRUGO, ahci_show_host_caps, core::ptr::null_mut());
    static DEVICE_ATTR(ahci_host_cap2, S_IRUGO, ahci_show_host_cap2, core::ptr::null_mut());
    static DEVICE_ATTR(ahci_host_version, S_IRUGO, ahci_show_host_version, core::ptr::null_mut());
    static DEVICE_ATTR(ahci_port_cmd, S_IRUGO, ahci_show_port_cmd, core::ptr::null_mut());
    static DEVICE_ATTR(em_buffer, S_IWUSR | S_IRUGO,
    ahci_read_em_buffer, ahci_store_em_buffer);
    static DEVICE_ATTR(em_message_supported, S_IRUGO, ahci_show_em_supported, core::ptr::null_mut());
    ...
    let mut __read_mostly: static bool ahci_em_messages = true;
    module_param(ahci_em_messages, bool, 0444);
// add other LED protocol types when they become supported
    MODULE_PARM_DESC(ahci_em_messages,
    "AHCI Enclosure Management Message control (0 = off, 1 = on)");
// device sleep idle timeout in ms
    let mut __read_mostly: static int devslp_idle_timeout = 1000;
    module_param(devslp_idle_timeout, int, 0644);
    MODULE_PARM_DESC(devslp_idle_timeout, "device sleep idle timeout");
#[no_mangle]
unsafe extern "C" fn ahci_enable_ahci(mmio: *mut void __iomem) {
...
//
#[no_mangle]
unsafe extern "C" fn ahci_rpm_get_port(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ahci_rpm_put_port(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_save_initial_config(dev: *mut device, hpriv: *mut ahci_host_priv) {
...
// cross check port_map and cap.n_ports
    if (port_map) {
    let mut map_ports: c_int = hweight_long(port_map);
...
//
#[no_mangle]
unsafe extern "C" fn ahci_restore_initial_config(host: *mut ata_host) {
...
#[no_mangle]
unsafe extern "C" fn ahci_scr_offset(ap: *mut ata_port, sc_reg: c_uint) -> unsigned {
...
#[no_mangle]
unsafe extern "C" fn ahci_scr_read(link: *mut ata_link, sc_reg: c_uint, val: *mut u32) -> c_int {
    static int ahci_scr_read(struct ata_link *link, unsigned int sc_reg, u32 *val)
    {
    void __iomem *port_mmio = ahci_port_base(link.ap);
    let mut offset: c_int = ahci_scr_offset(link.ap, sc_reg);
    if (offset) {
...
#[no_mangle]
unsafe extern "C" fn ahci_scr_write(link: *mut ata_link, sc_reg: c_uint, val: u32) -> c_int {
    static int ahci_scr_write(struct ata_link *link, unsigned int sc_reg, u32 val)
    {
    void __iomem *port_mmio = ahci_port_base(link.ap);
    let mut offset: c_int = ahci_scr_offset(link.ap, sc_reg);
...
#[no_mangle]
pub unsafe extern "C" fn ahci_start_engine(ap: *mut ata_port) {
...
#[no_mangle]
pub unsafe extern "C" fn ahci_stop_engine(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ahci_start_fis_rx(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ahci_stop_fis_rx(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahci_power_up(ap: *mut ata_port) {
...
//
    ...
    let mut cmd: u32 = readl(port_mmio + PORT_CMD);
...
// wait 10ms to be sure we've come out of LPM state
    ...
    cmd |= PORT_CMD_ASP;
#[no_mangle]
pub unsafe extern "C" fn if(ATA_LPM_MIN_POWER_WITH_PARTIAL: policy ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn ahci_power_down(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ahci_start_port(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ahci_deinit_port(ap: *mut ata_port, emsg: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ahci_reset_controller(host: *mut ata_host) -> c_int {
...
//
    tmp = ata_wait_register(core::ptr::null_mut(), mmio + HOST_CTL, HOST_RESET,
    HOST_RESET, 10, 1000);
    if (tmp & HOST_RESET) {
...
#[no_mangle]
unsafe extern "C" fn ahci_sw_activity(link: *mut ata_link) {
...
#[no_mangle]
unsafe extern "C" fn ahci_sw_activity_blink(t: *mut timer_list) {
    ...
    struct ata_port *ap = link.ap;
    let mut led_message: c_ulong = emp.led_state;
...
#[no_mangle]
unsafe extern "C" fn ahci_init_sw_activity(link: *mut ata_link) {
    static void ahci_init_sw_activity(struct ata_link *link)
    {
    struct ata_port *ap = link.ap;
    struct ahci_port_priv *pp = ap.private_data;
...
#[no_mangle]
pub unsafe extern "C" fn ahci_reset_em(host: *mut ata_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahci_led_show(ap: *mut ata_port, buf: *mut c_char) -> isize {
    static ssize_t ahci_led_show(struct ata_port *ap, char *buf)
    {
    struct ahci_port_priv *pp = ap.private_data;
    struct ata_link *link;
...
#[no_mangle]
unsafe extern "C" fn ahci_activity_store(dev: *mut ata_device, val: enum sw_activity) -> isize {
    ...
    struct ahci_port_priv *pp = ap.private_data;
    struct ahci_em_priv *emp = &pp.em_priv[link.pmp];
    let mut port_led_state: u32 = emp.led_state;
...
#[no_mangle]
unsafe extern "C" fn ahci_activity_show(dev: *mut ata_device, buf: *mut c_char) -> isize {
    static ssize_t ahci_activity_show(struct ata_device *dev, char *buf)
    {
    struct ata_link *link = dev.link;
    struct ata_port *ap = link.ap;
...
#[no_mangle]
unsafe extern "C" fn ahci_port_clear_pending_irq(ap: *mut ata_port) {
...
// clear port IRQ
    ...
    void __iomem *port_mmio)
    {
    const char *emsg = core::ptr::null_mut();
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn ahci_init_controller(host: *mut ata_host) {
...
#[no_mangle]
unsafe extern "C" fn ahci_dev_config(dev: *mut ata_device) {
    static void ahci_dev_config(struct ata_device *dev)
    {
...
#[no_mangle]
pub unsafe extern "C" fn ahci_dev_classify(ap: *mut ata_port) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn ahci_kick_engine(ap: *mut ata_port) -> c_int {
    int ahci_kick_engine(struct ata_port *ap)
    {
    void __iomem *port_mmio = ahci_port_base(ap);
    struct ahci_host_priv *hpriv = ap.host.private_data;
    let mut status: u8 = readl(port_mmio + PORT_TFDATA) & 0xFF;
    u32 tmp;
    int busy, rc;
// stop engine
    rc = hpriv.stop_engine(ap);
...
// issue & wait
    ...
    unsigned int msecs;
    struct ata_taskfile tf;
    let mut fbs_disabled: bool = false;
    int rc;
...
#[no_mangle]
pub unsafe extern "C" fn ahci_check_ready(link: *mut ata_link) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahci_bad_pmp_check_ready(link: *mut ata_link) -> c_int {
    static int ahci_bad_pmp_check_ready(struct ata_link *link)
    {
    void __iomem *port_mmio = ahci_port_base(link.ap);
    let mut status: u8 = readl(port_mmio + PORT_TFDATA) & 0xFF;
    let mut irq_status: u32 = readl(port_mmio + PORT_IRQ_STAT);
//
...
#[no_mangle]
unsafe extern "C" fn ahci_postreset(link: *mut ata_link, class: *mut c_uint) {
    static void ahci_postreset(struct ata_link *link, unsigned int *class)
    {
    struct ata_port *ap = link.ap;
    void __iomem *port_mmio = ahci_port_base(ap);
...
#[no_mangle]
unsafe extern "C" fn ahci_fill_sg(qc: *mut ata_queued_cmd, cmd_tbl: *mut c_void) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ahci_pmp_qc_defer(qc: *mut ata_queued_cmd) -> c_int {
    static int ahci_pmp_qc_defer(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn ahci_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    static enum ata_completion_errors ahci_qc_prep(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct ahci_port_priv *pp = ap.private_data;
    let mut is_atapi: c_int = ata_is_atapi(qc.tf.protocol);
    void *cmd_tbl;
    u32 opts;
    const u32 cmd_fis_len = 5; /* five dwords */
    unsigned int n_elem;
...
#[no_mangle]
unsafe extern "C" fn ahci_fbs_dec_intr(ap: *mut ata_port) {
    static void ahci_fbs_dec_intr(struct ata_port *ap)
    {
    struct ahci_port_priv *pp = ap.private_data;
    void __iomem *port_mmio = ahci_port_base(ap);
    let mut fbs: u32 = readl(port_mmio + PORT_FBS);
...
#[no_mangle]
unsafe extern "C" fn ahci_error_intr(ap: *mut ata_port, irq_stat: u32) {
    static void ahci_error_intr(struct ata_port *ap, u32 irq_stat)
    {
    struct ahci_host_priv *hpriv = ap.host.private_data;
    struct ahci_port_priv *pp = ap.private_data;
    struct ata_eh_info *host_ehi = &ap.link.eh_info;
    struct ata_link *link = core::ptr::null_mut();
    struct ata_queued_cmd *active_qc;
    struct ata_eh_info *active_ehi;
    let mut fbs_need_dec: bool = false;
    u32 serror;
// determine active link with error
    if (pp.fbs_enabled) {
    void __iomem *port_mmio = ahci_port_base(ap);
    let mut fbs: u32 = readl(port_mmio + PORT_FBS);
    let mut pmp: c_int = fbs >> PORT_FBS_DWE_OFFSET;
...
// okay, let's hand over to EH
    ...
    ata_port_freeze(ap);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fbs_need_dec) -> else {
    ata_link_abort(link);
...
#[no_mangle]
unsafe extern "C" fn ahci_qc_complete(ap: *mut ata_port, port_mmio: *mut void __iomem) {
    static void ahci_qc_complete(struct ata_port *ap, void __iomem *port_mmio)
    {
    struct ata_eh_info *ehi = &ap.link.eh_info;
    struct ahci_port_priv *pp = ap.private_data;
    let mut qc_active: u32 = 0;
    int rc;
//
...
//
    ...
    let mut f0: u32 = le32_to_cpu(f[0]);
    if (f0 & (1 << 15))
    sata_async_notification(ap);
    }
    }
...
#[no_mangle]
unsafe extern "C" fn ahci_port_intr(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ahci_multi_irqs_intr_hard(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn ahci_handle_port_intr(host: *mut ata_host, irq_masked: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn ahci_single_level_irq_intr(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t ahci_single_level_irq_intr(int irq, void *dev_instance)
    {
...
#[no_mangle]
pub unsafe extern "C" fn ahci_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ahci_qc_fill_rtf(qc: *mut ata_queued_cmd) {
    static void ahci_qc_fill_rtf(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn ahci_qc_ncq_fill_rtf(ap: *mut ata_port, done_mask: u64) {
    static void ahci_qc_ncq_fill_rtf(struct ata_port *ap, u64 done_mask)
    {
    struct ahci_port_priv *pp = ap.private_data;
    const u8 *fis;
...
// No outstanding NCQ commands.
    ...
    let mut tag: c_uint = __ffs64(done_mask);
...
#[no_mangle]
unsafe extern "C" fn ahci_freeze(ap: *mut ata_port) {
    static void ahci_freeze(struct ata_port *ap)
    {
    void __iomem *port_mmio = ahci_port_base(ap);
// turn IRQ off
...
#[no_mangle]
unsafe extern "C" fn ahci_thaw(ap: *mut ata_port) {
    static void ahci_thaw(struct ata_port *ap)
    {
    struct ahci_host_priv *hpriv = ap.host.private_data;
    void __iomem *mmio = hpriv.mmio;
...
#[no_mangle]
pub unsafe extern "C" fn ahci_error_handler(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ahci_post_internal_cmd(qc: *mut ata_queued_cmd) {
    static void ahci_post_internal_cmd(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
...
#[no_mangle]
unsafe extern "C" fn ahci_set_aggressive_devslp(ap: *mut ata_port, sleep: bool) {
    static void ahci_set_aggressive_devslp(struct ata_port *ap, bool sleep)
    {
    struct ahci_host_priv *hpriv = ap.host.private_data;
    void __iomem *port_mmio = ahci_port_base(ap);
...
#[no_mangle]
unsafe extern "C" fn ahci_enable_fbs(ap: *mut ata_port) {
    static void ahci_enable_fbs(struct ata_port *ap)
    {
    struct ahci_host_priv *hpriv = ap.host.private_data;
    struct ahci_port_priv *pp = ap.private_data;
...
#[no_mangle]
unsafe extern "C" fn ahci_disable_fbs(ap: *mut ata_port) {
    static void ahci_disable_fbs(struct ata_port *ap)
    {
    struct ahci_host_priv *hpriv = ap.host.private_data;
    struct ahci_port_priv *pp = ap.private_data;
...
#[no_mangle]
unsafe extern "C" fn ahci_pmp_attach(ap: *mut ata_port) {
    static void ahci_pmp_attach(struct ata_port *ap)
    {
    void __iomem *port_mmio = ahci_port_base(ap);
    struct ahci_port_priv *pp = ap.private_data;
...
#[no_mangle]
unsafe extern "C" fn ahci_pmp_detach(ap: *mut ata_port) {
    static void ahci_pmp_detach(struct ata_port *ap)
    {
    void __iomem *port_mmio = ahci_port_base(ap);
    struct ahci_port_priv *pp = ap.private_data;
...
#[no_mangle]
pub unsafe extern "C" fn ahci_port_resume(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ahci_handle_s2idle(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn ahci_port_suspend(ap: *mut ata_port, mesg: pm_message_t) -> c_int {
    static int ahci_port_suspend(struct ata_port *ap, pm_message_t mesg)
    {
    const char *emsg = core::ptr::null_mut();
    int rc;
...
#[no_mangle]
unsafe extern "C" fn ahci_port_start(ap: *mut ata_port) -> c_int {
    static int ahci_port_start(struct ata_port *ap)
    {
    struct ahci_host_priv *hpriv = ap.host.private_data;
...
#[no_mangle]
pub unsafe extern "C" fn if(AHCI_HFLAG_YES_FBS: hpriv->flags &) -> else {
...
#[no_mangle]
unsafe extern "C" fn ahci_port_stop(ap: *mut ata_port) {
    static void ahci_port_stop(struct ata_port *ap)
    {
    const char *emsg = core::ptr::null_mut();
    struct ahci_host_priv *hpriv = ap.host.private_data;
...
#[no_mangle]
pub unsafe extern "C" fn ahci_print_info(host: *mut ata_host, scc_s: *const c_char) {
    ...
    speed_s = "1.5";
#[no_mangle]
pub unsafe extern "C" fn if(2: speed ==) -> else {
    else if (speed == 2)
    speed_s = "3";
#[no_mangle]
pub unsafe extern "C" fn if(3: speed ==) -> else {
    else if (speed == 3)
    speed_s = "6";
    else
    speed_s = "?";
    ...
    u8 messages;
    void __iomem *mmio = hpriv.mmio;
    let mut em_loc: u32 = readl(mmio + HOST_EM_LOC);
    let mut em_ctl: u32 = readl(mmio + HOST_EM_CTL);
...
//
    ...
    let mut irq: c_int = hpriv.get_irq_vector(host, i);
...
//
#[no_mangle]
pub unsafe extern "C" fn ahci_host_activate(host: *mut ata_host, sht: *const scsi_host_template) -> c_int {
    int ahci_host_activate(struct ata_host *host, const struct scsi_host_template *sht)
    {
    struct ahci_host_priv *hpriv = host.private_data;
    let mut irq: c_int = hpriv.irq;
    int rc;
    if (hpriv.flags & AHCI_HFLAG_MULTI_MSI) {
    if (hpriv.irq_handler &&
    hpriv.irq_handler != ahci_single_level_irq_intr)
