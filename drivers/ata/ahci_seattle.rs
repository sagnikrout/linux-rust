...
//! Source: drivers/ata/ahci_seattle.c
#![no_std]
...
pub const ACTIVITY_MASK: c_uint = 0x00010000;
pub const LOCATE_MASK: c_uint = 0x00080000;
pub const FAULT_MASK: c_uint = 0x00400000;

    static ssize_t seattle_transmit_led_message(struct ata_port *ap, u32 state,
    ssize_t size);
#[repr(C)]
#[derive(Copy, Clone)]
pub struct seattle_plat_data {
    pub sgpio_ctrl: *mut void __iomem,
}
...
#[no_mangle]
unsafe extern "C" fn ahci_seattle_probe(pdev: *mut platform_device) -> c_int {
