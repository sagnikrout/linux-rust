...
//! Source: drivers/ata/pata_pcmcia.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn pcmcia_set_mode(link: *mut ata_link, r_failed_dev: *mut ata_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcmcia_8bit_drain_fifo(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn pcmcia_check_one_config(pdev: *mut pcmcia_device, priv_data: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pcmcia_init_one(pdev: *mut pcmcia_device) -> c_int {
    static int pcmcia_init_one(struct pcmcia_device *pdev)
    {
    struct ata_host *host;
    struct ata_port *ap;
    let mut is_kme: c_int = 0, ret = -ENOMEM, p;
    unsigned long io_base, ctl_base;
    void __iomem *io_addr, *ctl_addr;
    let mut n_ports: c_int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn pcmcia_remove_one(pdev: *mut pcmcia_device) {
