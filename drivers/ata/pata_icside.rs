...
//! Source: drivers/ata/pata_icside.c
#![no_std]
...
pub const ICS_IDENT_OFFSET: c_uint = 0x2280;
pub const ICS_ARCIN_V5_INTRSTAT: c_uint = 0x0000;
pub const ICS_ARCIN_V5_INTROFFSET: c_uint = 0x0004;
pub const ICS_ARCIN_V6_INTROFFSET_1: c_uint = 0x2200;
pub const ICS_ARCIN_V6_INTRSTAT_1: c_uint = 0x2290;
pub const ICS_ARCIN_V6_INTROFFSET_2: c_uint = 0x3200;
pub const ICS_ARCIN_V6_INTRSTAT_2: c_uint = 0x3290;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct portinfo {
    pub dataoffset: c_uint,
    pub ctrloffset: c_uint,
    pub stepping: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pata_icside_state {
    pub irq_port: *mut void __iomem,
    pub ioc_base: *mut void __iomem,
    pub type: c_uint,
    pub dma: c_uint,
    struct {
    pub port_sel: u8,
    pub disabled: u8,
    pub speed: [c_uint; ATA_MAX_DEVICES],
    pub port: [}; 2],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct pata_icside_info {
    pub state: *mut pata_icside_state,
    pub ec: *mut expansion_card,
    pub base: *mut void __iomem,
    pub irqaddr: *mut void __iomem,
    pub irqmask: c_uint,
    pub irqops: *const expansioncard_ops_t,
    pub mwdma_mask: c_uint,
    pub nr_ports: c_uint,
    pub port: [*const portinfo; 2],
    pub raw_base: c_ulong,
    pub raw_ioc_base: c_ulong,
}

pub const ICS_TYPE_A3IN: c_int = 0;
pub const ICS_TYPE_A3USER: c_int = 1;
pub const ICS_TYPE_V6: c_int = 3;
pub const ICS_TYPE_V5: c_int = 15;
...
//
#[no_mangle]
unsafe extern "C" fn pata_icside_irqenable_arcin_v5(ec: *mut expansion_card, irqnr: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pata_icside_irqdisable_arcin_v5(ec: *mut expansion_card, irqnr: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pata_icside_irqenable_arcin_v6(ec: *mut expansion_card, irqnr: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pata_icside_irqdisable_arcin_v6(ec: *mut expansion_card, irqnr: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn pata_icside_irqpending_arcin_v6(ec: *mut expansion_card) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pata_icside_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_bmdma_setup(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_bmdma_start(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_bmdma_stop(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_bmdma_status(ap: *mut ata_port) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn icside_dma_init(info: *mut pata_icside_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_postreset(link: *mut ata_link, classes: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_register_v5(info: *mut pata_icside_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_register_v6(info: *mut pata_icside_info) -> c_int {
    static int pata_icside_register_v6(struct pata_icside_info *info)
    {
    struct pata_icside_state *state = info.state;
    struct expansion_card *ec = info.ec;
    void __iomem *ioc_base, *easi_base;
    let mut sel: c_uint = 0;
...
#[no_mangle]
unsafe extern "C" fn pata_icside_add_ports(info: *mut pata_icside_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_shutdown(ec: *mut expansion_card) {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_remove(ec: *mut expansion_card) {
...
#[no_mangle]
unsafe extern "C" fn pata_icside_init() -> int __init {
    static int __init pata_icside_init(void)
    {
    return ecard_register_driver(&pata_icside_driver);
    }
#[no_mangle]
unsafe extern "C" fn pata_icside_exit() -> void __exit {
