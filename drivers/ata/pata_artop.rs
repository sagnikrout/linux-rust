...
//! Source: drivers/ata/pata_artop.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn artop62x0_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn artop6260_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn artop6210_load_piomode(ap: *mut ata_port, adev: *mut ata_device, pio: c_uint) {
    static void artop6210_load_piomode(struct ata_port *ap, struct ata_device *adev, unsigned int pio)
    {
    struct pci_dev *pdev	= to_pci_dev(ap.host.dev);
    let mut dn: c_int = adev.devno + 2 * ap.port_no;
...
//
#[no_mangle]
unsafe extern "C" fn artop6210_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn artop6260_load_piomode(ap: *mut ata_port, adev: *mut ata_device, pio: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn artop6260_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn artop6210_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
// Add ultra DMA bits if in UDMA mode
    ...
    let mut mode: u8 = (adev.dma_mode - XFER_UDMA_0) + 1 - clock;
    if (mode == 0)
    mode = 1;
    ultra |= (mode << (2 * dn));
    }
...
//
#[no_mangle]
unsafe extern "C" fn artop6260_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn artop6210_qc_defer(qc: *mut ata_queued_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn atp8xx_fixup(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn artop_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    BUG_ON(ppi[0] == core::ptr::null_mut());
    atp8xx_fixup(pdev);
    return ata_pci_bmdma_init_one(pdev, ppi, &artop_sht, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn atp8xx_reinit_one(pdev: *mut pci_dev) -> c_int {
