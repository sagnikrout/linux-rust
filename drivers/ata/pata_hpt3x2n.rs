...
//! Source: drivers/ata/pata_hpt3x2n.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x2n_find_mode(ap: *mut ata_port, speed: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn hpt372n_filter(adev: *mut ata_device, mask: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x2n_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x2n_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x2n_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x2n_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x2n_bmdma_stop(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x2n_set_clock(ap: *mut ata_port, source: c_int) {
...
#[no_mangle]
unsafe extern "C" fn hpt3x2n_use_dpll(ap: *mut ata_port, writing: c_int) -> c_int {
    static int hpt3x2n_use_dpll(struct ata_port *ap, int writing)
    {
    let mut flags: c_long = (long)ap.host.private_data;
...
#[no_mangle]
unsafe extern "C" fn hpt3x2n_qc_defer(qc: *mut ata_queued_cmd) -> c_int {
    static int hpt3x2n_qc_defer(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct ata_port *alt = ap.host.ports[ap.port_no ^ 1];
    int rc, flags = (long)ap.host.private_data;
    let mut dpll: c_int = hpt3x2n_use_dpll(ap, qc.tf.flags & ATA_TFLAG_WRITE);
...
#[no_mangle]
unsafe extern "C" fn hpt3x2n_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int hpt3x2n_qc_issue(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    let mut flags: c_int = (long)ap.host.private_data;
    let mut dpll: c_int = hpt3x2n_use_dpll(ap, qc.tf.flags & ATA_TFLAG_WRITE);
...
//
#[no_mangle]
unsafe extern "C" fn hpt3xn_calibrate_dpll(dev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpt3x2n_pci_clock(pdev: *mut pci_dev, base: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x2n_init_one(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// HPT302N and HPT371N - UDMA133
    ...
    const struct ata_port_info *ppi[] = { &info_hpt3xxn, core::ptr::null_mut() };
