...
//! Source: drivers/ata/pata_cs5520.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn cs5520_set_timings(ap: *mut ata_port, adev: *mut ata_device, pio: c_int) {
    static void cs5520_set_timings(struct ata_port *ap, struct ata_device *adev, int pio)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut slave: c_int = adev.devno;
    pio -= XFER_PIO_0;
...
//
#[no_mangle]
unsafe extern "C" fn cs5520_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn cs5520_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cs5520_reinit_one(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cs5520_pci_device_suspend(pdev: *mut pci_dev, mesg: pm_message_t) -> c_int {
