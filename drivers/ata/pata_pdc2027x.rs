...
//! Source: drivers/ata/pata_pdc2027x.c
#![no_std]
...
//
    ...
    {
    let mut adj: u8 = (adev.devno) ? 0x08 : 0x00;
...
//
#[no_mangle]
unsafe extern "C" fn pdc2027x_cable_detect(ap: *mut ata_port) -> c_int {
    static int pdc2027x_cable_detect(struct ata_port *ap)
    {
    u32 cgcr;
...
//
#[no_mangle]
pub unsafe extern "C" fn pdc2027x_port_enabled(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn pdc2027x_prereset(link: *mut ata_link, deadline: c_ulong) -> c_int {
    static int pdc2027x_prereset(struct ata_link *link, unsigned long deadline)
    {
...
//
#[no_mangle]
unsafe extern "C" fn pdc2027x_mode_filter(adev: *mut ata_device, mask: c_uint) -> c_uint {
    static unsigned int pdc2027x_mode_filter(struct ata_device *adev, unsigned int mask)
    {
    unsigned char model_num[ATA_ID_PROD_LEN + 1];
    struct ata_device *pair = ata_dev_pair(adev);
    if (adev.class != ATA_DEV_ATA || adev.devno == 0 || pair == core::ptr::null_mut())
    return mask;
// Check for slave of a Maxtor at UDMA6
    ata_id_c_string(pair.id, model_num, ATA_ID_PROD,
    ATA_ID_PROD_LEN + 1);
// If the master is a maxtor in UDMA6 then the slave should not use UDMA 6
    if (strstr(model_num, "Maxtor") == core::ptr::null_mut() && pair.dma_mode == XFER_UDMA_6)
...
//
#[no_mangle]
unsafe extern "C" fn pdc2027x_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
    static void pdc2027x_set_piomode(struct ata_port *ap, struct ata_device *adev)
    {
...
//
#[no_mangle]
unsafe extern "C" fn pdc2027x_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void pdc2027x_set_dmamode(struct ata_port *ap, struct ata_device *adev)
    {
    let mut dma_mode: c_uint = adev.dma_mode;
    u32 ctcr0, ctcr1;
    if ((dma_mode >= XFER_UDMA_0) &&
    (dma_mode <= XFER_UDMA_6)) {
// Set the UDMA timing registers with value table for 133MHz
    let mut udma_mode: c_uint = dma_mode & 0x07;
...
// Set the MDMA timing registers with value table for 133MHz
    let mut mdma_mode: c_uint = dma_mode & 0x07;
...
//
#[no_mangle]
unsafe extern "C" fn pdc2027x_set_mode(link: *mut ata_link, r_failed: *mut ata_device) -> c_int {
    static int pdc2027x_set_mode(struct ata_link *link, struct ata_device **r_failed)
    {
...
//
    ...
    let mut ctcr1: u32 = ioread32(dev_mmio(ap, dev, PDC_CTCR1));
    ctcr1 |= (1 << 25);
...
//
#[no_mangle]
unsafe extern "C" fn pdc2027x_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
    static int pdc2027x_check_atapi_dma(struct ata_queued_cmd *qc)
    {
...
//
#[no_mangle]
unsafe extern "C" fn pdc_read_counter(host: *mut ata_host) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn pdc_adjust_pll(host: *mut ata_host, pll_clock: c_long, board_idx: c_uint) {
    static void pdc_adjust_pll(struct ata_host *host, long pll_clock, unsigned int board_idx)
    {
    void __iomem *mmio_base = host.iomap[PDC_MMIO_BAR];
    u16 pll_ctl;
    let mut pll_clock_khz: c_long = pll_clock / 1000;
    let mut pout_required: c_long = board_idx? PDC_133_MHZ:PDC_100_MHZ;
    let mut ratio: c_long = pout_required / pll_clock_khz;
    int F, R;
// Sanity check
...
//
#[no_mangle]
unsafe extern "C" fn pdc_detect_pll_input_clock(host: *mut ata_host) -> c_long {
...
//
#[no_mangle]
unsafe extern "C" fn pdc_hardware_init(host: *mut ata_host, board_idx: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn pdc_ata_setup_port(port: *mut ata_ioports, base: *mut void __iomem) {
...
//
    ...
    { &pdc2027x_port_info[board_idx], core::ptr::null_mut() };
...
#[no_mangle]
unsafe extern "C" fn pdc2027x_reinit_one(pdev: *mut pci_dev) -> c_int {
    static int pdc2027x_reinit_one(struct pci_dev *pdev)
    {
