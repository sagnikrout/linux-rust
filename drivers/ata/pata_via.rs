...
#[no_mangle]
unsafe extern "C" fn via_cable_override(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn via_cable_detect(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(ATA_UDMA5: config->udma_mask <) -> else {
...
#[no_mangle]
unsafe extern "C" fn via_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
    ...
    let mut T: c_int = 1000000000 / via_clock;
    let mut UT: c_int = T;
    int ut;
    let mut offset: c_int = 3 - (2*ap.port_no) - adev.devno;
    switch (udma_type) {
    case ATA_UDMA4:
    UT = T / 2; break;
    case ATA_UDMA5:
...
#[no_mangle]
unsafe extern "C" fn via_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
    static void via_set_piomode(struct ata_port *ap, struct ata_device *adev)
    {
    const struct via_isa_bridge *config = ap.host.private_data;
    let mut set_ast: c_int = (config.flags & VIA_BAD_AST) ? 0 : 1;
    via_do_set_mode(ap, adev, adev.pio_mode, set_ast, config.udma_mask);
    }
#[no_mangle]
unsafe extern "C" fn via_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn via_mode_filter(dev: *mut ata_device, mask: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn via_port_start(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn via_config_fifo(pdev: *mut pci_dev, flags: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn via_fixup(pdev: *mut pci_dev, config: *const via_isa_bridge) {
...
//
#[no_mangle]
unsafe extern "C" fn via_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// UDMA133 with bad AST (All current 133)
    ...
    u8 enable;
    let mut flags: c_ulong = id.driver_data;
    int rc;
...
// To find out how the IDE will behave and what features we
    ...
    config.id, core::ptr::null_mut()))) {
    let mut rev: u8 = isa.revision;
    pci_dev_put(isa);
...
//
#[no_mangle]
unsafe extern "C" fn via_reinit_one(pdev: *mut pci_dev) -> c_int {
