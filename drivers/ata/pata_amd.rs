...
//
#[no_mangle]
unsafe extern "C" fn timing_setup(ap: *mut ata_port, adev: *mut ata_device, offset: c_int, speed: c_int, clock: c_int) {
    ...
    let mut dn: c_int = ap.port_no * 2 + adev.devno;
...
//
#[no_mangle]
unsafe extern "C" fn amd_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd_fifo_setup(ap: *mut ata_port) {
    static void amd_fifo_setup(struct ata_port *ap)
    {
    struct ata_device *adev;
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    static const u8 fifobit[2] = { 0xC0, 0x30};
    let mut fifo: u8 = fifobit[ap.port_no];
    u8 r;
...
//
#[no_mangle]
unsafe extern "C" fn amd33_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn amd66_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn amd100_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn amd133_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn amd33_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void amd33_set_dmamode(struct ata_port *ap, struct ata_device *adev)
    {
    timing_setup(ap, adev, 0x40, adev.dma_mode, 1);
    }
#[no_mangle]
unsafe extern "C" fn amd66_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void amd66_set_dmamode(struct ata_port *ap, struct ata_device *adev)
    {
    timing_setup(ap, adev, 0x40, adev.dma_mode, 2);
    }
#[no_mangle]
unsafe extern "C" fn amd100_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void amd100_set_dmamode(struct ata_port *ap, struct ata_device *adev)
    {
    timing_setup(ap, adev, 0x40, adev.dma_mode, 3);
    }
#[no_mangle]
unsafe extern "C" fn amd133_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
    ...
    let mut bios_limit: c_uint = 0, acpi_limit = 0, limit;
...
//
#[no_mangle]
unsafe extern "C" fn nv_pre_reset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn nv100_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
    static void nv100_set_piomode(struct ata_port *ap, struct ata_device *adev)
    {
    timing_setup(ap, adev, 0x50, adev.pio_mode, 3);
    }
#[no_mangle]
unsafe extern "C" fn nv133_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn nv100_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void nv100_set_dmamode(struct ata_port *ap, struct ata_device *adev)
    {
    timing_setup(ap, adev, 0x50, adev.dma_mode, 3);
    }
#[no_mangle]
unsafe extern "C" fn nv133_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void nv133_set_dmamode(struct ata_port *ap, struct ata_device *adev)
    {
    timing_setup(ap, adev, 0x50, adev.dma_mode, 4);
    }
#[no_mangle]
unsafe extern "C" fn nv_host_stop(host: *mut ata_host) {
    static void nv_host_stop(struct ata_host *host)
    {
    let mut udma: u32 = (unsigned long)host.private_data;
...
#[no_mangle]
unsafe extern "C" fn amd_clear_fifo(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    let mut type: c_int = id.driver_data;
    void *hpriv = core::ptr::null_mut();
    u8 fifo;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn amd_reinit_one(pdev: *mut pci_dev) -> c_int {
