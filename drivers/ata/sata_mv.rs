...
pub struct mv_crqb {
    pub sg_addr: __le32,
    pub sg_addr_hi: __le32,
    pub ctrl_flags: __le16,
    pub ata_cmd: [__le16; 11],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_crqb_iie {
    pub addr: __le32,
    pub addr_hi: __le32,
    pub flags: __le32,
    pub len: __le32,
    pub ata_cmd: [__le32; 4],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_cached_regs {
    pub fiscfg: u32,
    pub ltmode: u32,
    pub haltcond: u32,
    pub unknown_rsvd: u32,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_port_priv {
    pub crqb: *mut mv_crqb,
    pub crqb_dma: dma_addr_t,
    pub crpb: *mut mv_crpb,
    pub crpb_dma: dma_addr_t,
    pub sg_tbl: [*mut mv_sg; MV_MAX_Q_DEPTH],
    pub sg_tbl_dma: [dma_addr_t; MV_MAX_Q_DEPTH],
    pub req_idx: c_uint,
    pub resp_idx: c_uint,
    pub pp_flags: u32,
    pub cached: mv_cached_regs,
    pub delayed_eh_pmp_map: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_port_signal {
    pub amps: u32,
    pub pre: u32,
}
...
pub struct mv_host_priv {
    pub hp_flags: u32,
    pub board_idx: c_uint,
    pub main_irq_mask: u32,
    pub signal: [mv_port_signal; 8],
    pub ops: *const mv_hw_ops,
    pub n_ports: c_int,
    pub base: *mut void __iomem,
    pub main_irq_cause_addr: *mut void __iomem,
    pub main_irq_mask_addr: *mut void __iomem,
    pub irq_cause_offset: u32,
    pub irq_mask_offset: u32,
    pub unmask_all_irqs: u32,
//
...
//
    pub port_phys: *mut phy,
//
// These consistent DMA memory pools give us guaranteed
// alignment for hardware-accessed data structures,
// and less memory waste in accomplishing the alignment.
//
    pub crqb_pool: *mut dma_pool,
    pub crpb_pool: *mut dma_pool,
    pub sg_tbl_pool: *mut dma_pool,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct mv_hw_ops {
    void (*phy_errata)(struct mv_host_priv *hpriv, void __iomem *mmio,
    pub port): c_uint,
    pub mmio): *mut *mut *mut void (enable_leds)(struct mv_host_priv hpriv, void __iomem,
    void (*read_preamp)(struct mv_host_priv *hpriv, int idx,
    pub mmio): *mut void __iomem,
    int (*reset_hc)(struct ata_host *host, void __iomem *mmio,
    pub n_hc): c_uint,
    pub mmio): *mut *mut *mut void (reset_flash)(struct mv_host_priv hpriv, void __iomem,
    pub mmio): *mut *mut *mut void (reset_bus)(struct ata_host host, void __iomem,
}
...
//
#[no_mangle]
pub unsafe extern "C" fn writelfl(data: c_ulong, addr: *mut void __iomem) {
...
#[no_mangle]
pub unsafe extern "C" fn mv_hc_from_port(port: c_uint) -> c_uint {
    static inline unsigned int mv_hc_from_port(unsigned int port)
    {
    return port >> MV_PORT_HC_SHIFT;
    }
#[no_mangle]
pub unsafe extern "C" fn mv_hardport_from_port(port: c_uint) -> c_uint {
...
//
    ...
    let mut ofs: c_ulong = (mv_hardport_from_port(port) + 1) * 0x100UL;
    return hc_mmio + ofs;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mv_get_hc_count(port_flags: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv_save_cached_regs(ap: *mut ata_port) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mv_write_cached_reg(addr: *mut void __iomem, old: *mut u32, new: u32) {
...
#[no_mangle]
unsafe extern "C" fn mv_write_main_irq_mask(mask: u32, hpriv: *mut mv_host_priv) {
...
//
    ...
    let mut hardport: c_int = mv_hardport_from_port(ap.port_no);
...
//
    ...
    {
    let mut want_ncq: c_int = (protocol == ATA_PROT_NCQ);
    if (pp.pp_flags & MV_PP_FLAG_EDMA_EN) {
    let mut using_ncq: c_int = ((pp.pp_flags & MV_PP_FLAG_NCQ_EN) != 0);
...
#[no_mangle]
unsafe extern "C" fn mv_wait_for_edma_empty_idle(ap: *mut ata_port) {
    static void mv_wait_for_edma_empty_idle(struct ata_port *ap)
    {
    void __iomem *port_mmio = mv_ap_base(ap);
    let mut empty_idle: u32 = (EDMA_STATUS_CACHE_EMPTY | EDMA_STATUS_IDLE);
    let mut per_loop: c_int = 5, timeout = (15 * 1000 / per_loop);
    int i;
//
...
//
    for (i = 0; i < timeout; ++i) {
    let mut edma_stat: u32 = readl(port_mmio + EDMA_STATUS);
...
//
#[no_mangle]
unsafe extern "C" fn mv_stop_edma_engine(port_mmio: *mut void __iomem) -> c_int {
    static int mv_stop_edma_engine(void __iomem *port_mmio)
    {
    int i;
...
// Wait for the chip to confirm eDMA is off.
    for (i = 10000; i > 0; i--) {
    let mut reg: u32 = readl(port_mmio + EDMA_CMD);
    if (!(reg & EDMA_EN))
    return 0;
    udelay(10);
    }
...
#[no_mangle]
unsafe extern "C" fn mv_stop_edma(ap: *mut ata_port) -> c_int {
    static int mv_stop_edma(struct ata_port *ap)
    {
    void __iomem *port_mmio = mv_ap_base(ap);
    struct mv_port_priv *pp = ap.private_data;
...
#[no_mangle]
unsafe extern "C" fn mv_dump_mem(dev: *mut device, start: *mut void __iomem, bytes: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn mv_dump_pci_cfg(pdev: *mut pci_dev, bytes: unsigned) {
...
#[no_mangle]
unsafe extern "C" fn mv_scr_offset(sc_reg_in: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mv_scr_read(link: *mut ata_link, sc_reg_in: c_uint, val: *mut u32) -> c_int {
    static int mv_scr_read(struct ata_link *link, unsigned int sc_reg_in, u32 *val)
    {
    let mut ofs: c_uint = mv_scr_offset(sc_reg_in);
    if (ofs != 0xffffffffU) {
...
#[no_mangle]
unsafe extern "C" fn mv_scr_write(link: *mut ata_link, sc_reg_in: c_uint, val: u32) -> c_int {
    static int mv_scr_write(struct ata_link *link, unsigned int sc_reg_in, u32 val)
    {
    let mut ofs: c_uint = mv_scr_offset(sc_reg_in);
    if (ofs != 0xffffffffU) {
...
#[no_mangle]
unsafe extern "C" fn mv6_dev_config(adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn mv_qc_defer(qc: *mut ata_queued_cmd) -> c_int {
    static int mv_qc_defer(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn mv_config_fbs(ap: *mut ata_port, want_ncq: c_int, want_fbs: c_int) {
...
#[no_mangle]
unsafe extern "C" fn mv_60x1_errata_sata25(ap: *mut ata_port, want_ncq: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mv_bmdma_enable_iie(ap: *mut ata_port, enable_bmdma: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mv_soc_led_blink_enable(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn mv_soc_led_blink_disable(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn mv_edma_cfg(ap: *mut ata_port, want_ncq: c_int, want_edma: c_int) {
    static void mv_edma_cfg(struct ata_port *ap, int want_ncq, int want_edma)
    {
    u32 cfg;
    struct mv_port_priv *pp    = ap.private_data;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_GEN_II(hpriv)) -> else {
    cfg |= EDMA_CFG_RD_BRST_EXT | EDMA_CFG_WR_BUFF_LEN;
    mv_60x1_errata_sata25(ap, want_ncq);
    } else if (IS_GEN_IIE(hpriv)) {
    let mut want_fbs: c_int = sata_pmp_attached(ap);
//
...
#[no_mangle]
unsafe extern "C" fn mv_port_free_dma_mem(ap: *mut ata_port) {
    ...
    pp.crqb = core::ptr::null_mut();
    }
    if (pp.crpb) {
    dma_pool_free(hpriv.crpb_pool, pp.crpb, pp.crpb_dma);
    pp.crpb = core::ptr::null_mut();
    }
//
...
//
    ...
    pp.sg_tbl[tag],
    pp.sg_tbl_dma[tag]);
    pp.sg_tbl[tag] = core::ptr::null_mut();
    }
    }
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn mv_port_start(ap: *mut ata_port) -> c_int {
    static int mv_port_start(struct ata_port *ap)
    {
...
//
#[no_mangle]
unsafe extern "C" fn mv_port_stop(ap: *mut ata_port) {
    static void mv_port_stop(struct ata_port *ap)
    {
    unsigned long flags;
    spin_lock_irqsave(ap.lock, flags);
...
//
#[no_mangle]
unsafe extern "C" fn mv_fill_sg(qc: *mut ata_queued_cmd) {
    static void mv_fill_sg(struct ata_queued_cmd *qc)
    {
    struct mv_port_priv *pp = qc.ap.private_data;
    struct scatterlist *sg;
    struct mv_sg *mv_sg, *last_sg = core::ptr::null_mut();
    unsigned int si;
    mv_sg = pp.sg_tbl[qc.hw_tag];
    for_each_sg(qc.sg, sg, qc.n_elem, si) {
    let mut addr: dma_addr_t = sg_dma_address(sg);
    let mut sg_len: u32 = sg_dma_len(sg);
    while (sg_len) {
    let mut offset: u32 = addr & 0xffff;
    let mut len: u32 = sg_len;
...
#[no_mangle]
unsafe extern "C" fn mv_crqb_pack_cmd(cmdw: *mut __le16, data: u8, addr: u8, last: unsigned) {
...
//
#[no_mangle]
unsafe extern "C" fn mv_sff_irq_clear(ap: *mut ata_port) {
    static void mv_sff_irq_clear(struct ata_port *ap)
    {
...
//
#[no_mangle]
unsafe extern "C" fn mv_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
    static int mv_check_atapi_dma(struct ata_queued_cmd *qc)
    {
...
//
#[no_mangle]
unsafe extern "C" fn mv_bmdma_setup(qc: *mut ata_queued_cmd) {
    static void mv_bmdma_setup(struct ata_queued_cmd *qc)
    {
...
//
#[no_mangle]
unsafe extern "C" fn mv_bmdma_start(qc: *mut ata_queued_cmd) {
    static void mv_bmdma_start(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    void __iomem *port_mmio = mv_ap_base(ap);
    let mut rw: c_uint = (qc.tf.flags & ATA_TFLAG_WRITE);
    let mut cmd: u32 = (rw ? 0 : ATA_DMA_WR) | ATA_DMA_START;
...
//
#[no_mangle]
unsafe extern "C" fn mv_bmdma_stop_ap(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn mv_bmdma_stop(qc: *mut ata_queued_cmd) {
    static void mv_bmdma_stop(struct ata_queued_cmd *qc)
    {
...
//
#[no_mangle]
unsafe extern "C" fn mv_bmdma_status(ap: *mut ata_port) -> u8 {
    static u8 mv_bmdma_status(struct ata_port *ap)
    {
    void __iomem *port_mmio = mv_ap_base(ap);
    u32 reg, status;
...
#[no_mangle]
pub unsafe extern "C" fn if(ATA_DMA_ERR: reg &) -> else {
...
#[no_mangle]
unsafe extern "C" fn mv_rw_multi_errata_sata24(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn mv_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    static enum ata_completion_errors mv_qc_prep(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct mv_port_priv *pp = ap.private_data;
...
//
#[no_mangle]
unsafe extern "C" fn mv_qc_prep_iie(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    static enum ata_completion_errors mv_qc_prep_iie(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct mv_port_priv *pp = ap.private_data;
...
//
#[no_mangle]
unsafe extern "C" fn mv_sff_check_status(ap: *mut ata_port) -> u8 {
    static u8 mv_sff_check_status(struct ata_port *ap)
    {
    let mut stat: u8 = ioread8(ap.ioaddr.status_addr);
    struct mv_port_priv *pp = ap.private_data;
...
//
#[no_mangle]
unsafe extern "C" fn mv_send_fis(ap: *mut ata_port, fis: *mut u32, nwords: c_int) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mv_qc_issue_fis(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn mv_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int mv_qc_issue(struct ata_queued_cmd *qc)
    {
    let mut limit_warnings: static int = 10;
    struct ata_port *ap = qc.ap;
    void __iomem *port_mmio = mv_ap_base(ap);
    struct mv_port_priv *pp = ap.private_data;
    u32 in_index;
...
#[no_mangle]
unsafe extern "C" fn mv_pmp_error_handler(ap: *mut ata_port) {
    static void mv_pmp_error_handler(struct ata_port *ap)
...
#[no_mangle]
unsafe extern "C" fn mv_get_err_pmp_map(ap: *mut ata_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mv_pmp_eh_prep(ap: *mut ata_port, pmp_map: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn mv_req_q_empty(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_handle_fbs_ncq_dev_err(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_handle_fbs_non_ncq_dev_err(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_handle_dev_err(ap: *mut ata_port, edma_err_cause: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_unexpected_intr(ap: *mut ata_port, edma_was_enabled: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn mv_err_intr(ap: *mut ata_port) {
    static void mv_err_intr(struct ata_port *ap)
    {
    void __iomem *port_mmio = mv_ap_base(ap);
    u32 edma_err_cause, eh_freeze_mask, serr = 0;
    let mut fis_cause: u32 = 0;
    struct mv_port_priv *pp = ap.private_data;
    struct mv_host_priv *hpriv = ap.host.private_data;
    let mut action: c_uint = 0, err_mask = 0;
    struct ata_eh_info *ehi = &ap.link.eh_info;
    struct ata_queued_cmd *qc;
...
//
    ...
    {
    u8 ata_status;
    let mut edma_status: u16 = le16_to_cpu(response.flags);
//
...
//
    if (!ncq_enabled) {
    let mut err_cause: u8 = edma_status & 0xff & ~EDMA_ERR_DEV;
    if (err_cause) {
//
...
#[no_mangle]
unsafe extern "C" fn mv_process_crpb_entries(ap: *mut ata_port, pp: *mut mv_port_priv) {
    ...
    let mut done_mask: u32 = 0;
    let mut ncq_enabled: c_int = (pp.pp_flags & MV_PP_FLAG_NCQ_EN);
...
#[no_mangle]
unsafe extern "C" fn mv_port_intr(ap: *mut ata_port, port_cause: u32) {
...
//
#[no_mangle]
unsafe extern "C" fn mv_host_intr(host: *mut ata_host, main_irq_cause: u32) -> c_int {
    static int mv_host_intr(struct ata_host *host, u32 main_irq_cause)
    {
    struct mv_host_priv *hpriv = host.private_data;
    void __iomem *mmio = hpriv.base, *hc_mmio;
    let mut handled: c_uint = 0, port;
...
//
    ...
    let mut hc_cause: u32 = (main_irq_cause >> shift) & HC0_IRQ_PEND;
...
#[no_mangle]
unsafe extern "C" fn mv_pci_error(host: *mut ata_host, mmio: *mut void __iomem) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t mv_interrupt(int irq, void *dev_instance)
    {
    struct ata_host *host = dev_instance;
    struct mv_host_priv *hpriv = host.private_data;
    let mut handled: c_uint = 0;
    let mut using_msi: c_int = hpriv.hp_flags & MV_HP_FLAG_MSI;
...
#[no_mangle]
unsafe extern "C" fn mv5_scr_offset(sc_reg_in: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mv5_scr_read(link: *mut ata_link, sc_reg_in: c_uint, val: *mut u32) -> c_int {
    static int mv5_scr_read(struct ata_link *link, unsigned int sc_reg_in, u32 *val)
    {
    struct mv_host_priv *hpriv = link.ap.host.private_data;
    void __iomem *mmio = hpriv.base;
    void __iomem *addr = mv5_phy_base(mmio, link.ap.port_no);
    let mut ofs: c_uint = mv5_scr_offset(sc_reg_in);
    if (ofs != 0xffffffffU) {
// val = readl(addr + ofs);
    return 0;
    } else
...
#[no_mangle]
unsafe extern "C" fn mv5_scr_write(link: *mut ata_link, sc_reg_in: c_uint, val: u32) -> c_int {
    static int mv5_scr_write(struct ata_link *link, unsigned int sc_reg_in, u32 val)
    {
    struct mv_host_priv *hpriv = link.ap.host.private_data;
    void __iomem *mmio = hpriv.base;
...
#[no_mangle]
unsafe extern "C" fn mv5_reset_bus(host: *mut ata_host, mmio: *mut void __iomem) {
    static void mv5_reset_bus(struct ata_host *host, void __iomem *mmio)
    {
    ...
    if (!early_5080) {
    let mut tmp: u32 = readl(mmio + MV_PCI_EXP_ROM_BAR_CTL);
    tmp |= (1 << 0);
...
#[no_mangle]
unsafe extern "C" fn mv5_reset_flash(hpriv: *mut mv_host_priv, mmio: *mut void __iomem) {
    static void mv5_reset_flash(struct mv_host_priv *hpriv, void __iomem *mmio)
    {
...
#[no_mangle]
unsafe extern "C" fn mv5_enable_leds(hpriv: *mut mv_host_priv, mmio: *mut void __iomem) {
    static void mv5_enable_leds(struct mv_host_priv *hpriv, void __iomem *mmio)
    {
    u32 tmp;
...
// FIXME: handle MV_HP_ERRATA_50XXB2 errata
    ...
    let mut mask: u32 = (1<<12) | (1<<11) | (1<<7) | (1<<6) | (1<<5);
    u32 tmp;
    let mut fix_apm_sq: c_int = (hpriv.hp_flags & MV_HP_ERRATA_50XXB0);
    if (fix_apm_sq) {
...
#[no_mangle]
unsafe extern "C" fn mv_reset_pci_bus(host: *mut ata_host, mmio: *mut void __iomem) {
    static void mv_reset_pci_bus(struct ata_host *host, void __iomem *mmio)
    {
    struct mv_host_priv *hpriv = host.private_data;
    u32 tmp;
...
#[no_mangle]
unsafe extern "C" fn mv6_reset_flash(hpriv: *mut mv_host_priv, mmio: *mut void __iomem) {
    static void mv6_reset_flash(struct mv_host_priv *hpriv, void __iomem *mmio)
    {
    u32 tmp;
...
#[no_mangle]
unsafe extern "C" fn mv6_enable_leds(hpriv: *mut mv_host_priv, mmio: *mut void __iomem) {
    static void mv6_enable_leds(struct mv_host_priv *hpriv, void __iomem *mmio)
    {
    ...
    {
    void __iomem *port_mmio = mv_port_base(mmio, port);
    let mut hp_flags: u32 = hpriv.hp_flags;
    int fix_phy_mode2 =
...
// Guideline 88F5182 (GL# SATA-S11)
    ...
    m3 &= ~0x1c;
    if (fix_phy_mode4) {
    let mut m4: u32 = readl(port_mmio + PHY_MODE4);
//
...
#[no_mangle]
unsafe extern "C" fn mv_soc_reset_bus(host: *mut ata_host, mmio: *mut void __iomem) {
    static void mv_soc_reset_bus(struct ata_host *host, void __iomem *mmio)
    {
    return;
    }
...
//
#[no_mangle]
unsafe extern "C" fn soc_is_65n(hpriv: *mut mv_host_priv) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mv_setup_ifcfg(port_mmio: *mut void __iomem, want_gen2i: c_int) {
    static void mv_setup_ifcfg(void __iomem *port_mmio, int want_gen2i)
    {
    let mut ifcfg: u32 = readl(port_mmio + SATA_IFCFG);
...
#[no_mangle]
unsafe extern "C" fn mv_pmp_select(ap: *mut ata_port, pmp: c_int) {
    static void mv_pmp_select(struct ata_port *ap, int pmp)
    {
    if (sata_pmp_supported(ap)) {
    void __iomem *port_mmio = mv_ap_base(ap);
    let mut reg: u32 = readl(port_mmio + SATA_IFCTL);
    let mut old: c_int = reg & 0xf;
    if (old != pmp) {
    reg = (reg & ~0xf) | pmp;
...
#[no_mangle]
unsafe extern "C" fn mv_eh_freeze(ap: *mut ata_port) {
    static void mv_eh_freeze(struct ata_port *ap)
    {
    mv_stop_edma(ap);
    mv_enable_port_irqs(ap, 0);
...
#[no_mangle]
unsafe extern "C" fn mv_eh_thaw(ap: *mut ata_port) {
    static void mv_eh_thaw(struct ata_port *ap)
    {
    struct mv_host_priv *hpriv = ap.host.private_data;
    let mut port: c_uint = ap.port_no;
    let mut hardport: c_uint = mv_hardport_from_port(port);
...
//
#[no_mangle]
unsafe extern "C" fn mv_port_init(port: *mut ata_ioports, port_mmio: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn mv_in_pcix_mode(host: *mut ata_host) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn mv_pci_cut_through_okay(host: *mut ata_host) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_60x1b2_errata_pci7(host: *mut ata_host) {
...
// workaround for 60x1-B2 errata PCI#7
    if (mv_in_pcix_mode(host)) {
    let mut reg: u32 = readl(mmio + MV_PCI_COMMAND);
    writelfl(reg & ~MV_PCI_COMMAND_MWRCOM, mmio + MV_PCI_COMMAND);
    }
    }
#[no_mangle]
unsafe extern "C" fn mv_chip_id(host: *mut ata_host, board_idx: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv_init_host(host: *mut ata_host) -> c_int {
    static int mv_init_host(struct ata_host *host)
    {
    let mut rc: c_int = 0, n_hc, port, hc;
    struct mv_host_priv *hpriv = host.private_data;
    void __iomem *mmio = hpriv.base;
...
#[no_mangle]
unsafe extern "C" fn mv_create_dma_pools(hpriv: *mut mv_host_priv, dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv_platform_probe(pdev: *mut platform_device) -> c_int {
    static int mv_platform_probe(struct platform_device *pdev)
    {
    const struct mv_sata_platform_data *mv_platform_data;
    const struct mbus_dram_target_info *dram;
    const struct ata_port_info *ppi[] =
    { &mv_port_info[chip_soc], core::ptr::null_mut() };
    struct ata_host *host;
    struct mv_host_priv *hpriv;
    struct resource *res;
    let mut n_ports: c_int = 0, irq = 0;
    int rc;
    int port;
...
// allocate host
    ...
    host.iomap = core::ptr::null_mut();
    hpriv.base = devm_ioremap(&pdev.dev, res.start,
    resource_size(res));
    if (!hpriv.base)
    return -ENOMEM;
    hpriv.base -= SATAHC0_REG_BASE;
    hpriv.clk = devm_clk_get_optional_enabled(&pdev.dev, core::ptr::null_mut());
    if (IS_ERR(hpriv.clk))
    ...
    hpriv.port_phys[port] = core::ptr::null_mut();
    if (rc != -EPROBE_DEFER)
...
//
#[no_mangle]
unsafe extern "C" fn mv_platform_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mv_platform_suspend(pdev: *mut platform_device, state: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mv_platform_resume(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mv_print_info(host: *mut ata_host) {
...
//
    ...
    scc_s = "SCSI";
#[no_mangle]
pub unsafe extern "C" fn if(0x01: scc ==) -> else {
    else if (scc == 0x01)
    scc_s = "RAID";
    else
    scc_s = "?";
...
pub unsafe extern "C" fn if(_arg: IS_GEN_II(hpriv)) -> else {
    ...
    gen = "II";
#[no_mangle]
pub unsafe extern "C" fn if(_arg: IS_GEN_IIE(hpriv)) -> else {
    else if (IS_GEN_IIE(hpriv))
    gen = "IIE";
    else
    gen = "?";
...
//
    ...
    const struct pci_device_id *ent)
    {
    let mut board_idx: c_uint = (unsigned int)ent.driver_data;
    const struct ata_port_info *ppi[] = { &mv_port_info[board_idx], core::ptr::null_mut() };
    struct ata_host *host;
    struct mv_host_priv *hpriv;
    int n_ports, port, rc;
    ata_print_version_once(&pdev.dev, DRV_VERSION);
...
// acquire resources
    ...
    let mut offset: c_uint = port_mmio - hpriv.base;
...
#[no_mangle]
unsafe extern "C" fn mv_pci_device_resume(pdev: *mut pci_dev) -> c_int {
    static int mv_pci_device_resume(struct pci_dev *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn mv_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn mv_exit() -> void __exit {
