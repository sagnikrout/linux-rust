...
pub const NV_ADMA_DMA_BOUNDARY: c_uint = 0xffffffffUL;
    enum {
    NV_MMIO_BAR			= 5,
    NV_PORTS			= 2,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nv_adma_cpb {
    pub /: *mut *mut u8 resp_flags; / 0,
    pub /: *mut *mut u8 reserved1; / 1,
    pub /: *mut *mut u8 ctl_flags; / 2,
// len is length of taskfile in 64 bit words
    pub /: *mut *mut u8 len; / 3,
    pub /: *mut *mut u8 tag; / 4,
    pub /: *mut *mut u8 next_cpb_idx; / 5,
    pub /: *mut *mut __le16 reserved2; / 6-7,
    pub /: *mut *mut __le16 tf[12]; / 8-31,
    pub /: *mut *mut nv_adma_prd aprd[5]; / 32-111,
    pub /: *mut *mut __le64 next_aprd; / 112-119,
    pub /: *mut *mut __le64 reserved3; / 120-127,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nv_adma_port_priv {
    pub cpb: *mut nv_adma_cpb,
    pub cpb_dma: dma_addr_t,
    pub aprd: *mut nv_adma_prd,
    pub aprd_dma: dma_addr_t,
    pub ctl_block: *mut void __iomem,
    pub gen_block: *mut void __iomem,
    pub notifier_clear_block: *mut void __iomem,
    pub adma_dma_mask: u64,
    pub flags: u8,
    pub last_issue_ncq: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct nv_host_priv {
    pub type: c_ulong,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct defer_queue {
    pub defer_bits: u32,
    pub head: c_uint,
    pub tail: c_uint,
    pub tag: [c_uint; ATA_MAX_QUEUE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct nv_swncq_port_priv {
    pub /: *mut *mut *mut ata_bmdma_prd prd; / our SG list,
    pub /: *mut *mut dma_addr_t prd_dma; / and its DMA mapping,
    pub sactive_block: *mut void __iomem,
    pub irq_block: *mut void __iomem,
    pub tag_block: *mut void __iomem,
    pub qc_active: u32,
    pub last_issue_tag: c_uint,
// fifo circular queue to store deferral command
    pub defer_queue: defer_queue,
// for NCQ interrupt analysis
    pub dhfis_bits: u32,
    pub dmafis_bits: u32,
    pub sdbfis_bits: u32,
    pub ncq_flags: c_uint,
}
...
// SWNCQ
    ...
    let mut swncq_enabled: static bool = true;
    static bool msi_enabled;
#[no_mangle]
unsafe extern "C" fn nv_adma_register_mode(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_mode(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
    static int nv_adma_check_atapi_dma(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_tf_read(ap: *mut ata_port, tf: *mut ata_taskfile) {
    static void nv_adma_tf_read(struct ata_port *ap, struct ata_taskfile *tf)
    {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_tf_to_cpb(tf: *mut ata_taskfile, cpb: *mut __le16) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_check_cpb(ap: *mut ata_port, cpb_num: c_int, force_err: c_int) -> c_int {
    static int nv_adma_check_cpb(struct ata_port *ap, int cpb_num, int force_err)
    {
    struct nv_adma_port_priv *pp = ap.private_data;
    let mut flags: u8 = pp.cpb[cpb_num].resp_flags;
...
#[no_mangle]
unsafe extern "C" fn nv_host_intr(ap: *mut ata_port, irq_stat: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t nv_adma_interrupt(int irq, void *dev_instance)
    {
...
// let EH analyze SError and figure out cause
    ...
    let mut check_commands: u32 = notifier_clears[i];
...
// check CPBs for completed commands
    ...
    done_mask |= 1 << pos;
#[no_mangle]
pub unsafe extern "C" fn if(0): unlikely(rc <) -> else {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_freeze(ap: *mut ata_port) {
    static void nv_adma_freeze(struct ata_port *ap)
    {
    struct nv_adma_port_priv *pp = ap.private_data;
    void __iomem *mmio = pp.ctl_block;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_thaw(ap: *mut ata_port) {
    static void nv_adma_thaw(struct ata_port *ap)
    {
    struct nv_adma_port_priv *pp = ap.private_data;
    void __iomem *mmio = pp.ctl_block;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_irq_clear(ap: *mut ata_port) {
    static void nv_adma_irq_clear(struct ata_port *ap)
    {
    struct nv_adma_port_priv *pp = ap.private_data;
    void __iomem *mmio = pp.ctl_block;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_post_internal_cmd(qc: *mut ata_queued_cmd) {
    static void nv_adma_post_internal_cmd(struct ata_queued_cmd *qc)
    {
    struct nv_adma_port_priv *pp = qc.ap.private_data;
    if (pp.flags & NV_ADMA_PORT_REGISTER_MODE)
...
#[no_mangle]
unsafe extern "C" fn nv_adma_port_start(ap: *mut ata_port) -> c_int {
    static int nv_adma_port_start(struct ata_port *ap)
    {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_port_stop(ap: *mut ata_port) {
    static void nv_adma_port_stop(struct ata_port *ap)
    {
    struct nv_adma_port_priv *pp = ap.private_data;
    void __iomem *mmio = pp.ctl_block;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_port_suspend(ap: *mut ata_port, mesg: pm_message_t) -> c_int {
    static int nv_adma_port_suspend(struct ata_port *ap, pm_message_t mesg)
    {
    struct nv_adma_port_priv *pp = ap.private_data;
    void __iomem *mmio = pp.ctl_block;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_port_resume(ap: *mut ata_port) -> c_int {
    static int nv_adma_port_resume(struct ata_port *ap)
    {
    struct nv_adma_port_priv *pp = ap.private_data;
    void __iomem *mmio = pp.ctl_block;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_setup_port(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_host_init(host: *mut ata_host) -> c_int {
...
// enable ADMA on the ports
    ...
    flags |= NV_APRD_END;
#[no_mangle]
pub unsafe extern "C" fn if(4: idx !=) -> else {
    else if (idx != 4)
    flags |= NV_APRD_CONT;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_fill_sg(qc: *mut ata_queued_cmd, cpb: *mut nv_adma_cpb) {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_use_reg_mode(qc: *mut ata_queued_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nv_adma_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    static enum ata_completion_errors nv_adma_qc_prep(struct ata_queued_cmd *qc)
    {
    struct nv_adma_port_priv *pp = qc.ap.private_data;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int nv_adma_qc_issue(struct ata_queued_cmd *qc)
    {
    struct nv_adma_port_priv *pp = qc.ap.private_data;
    void __iomem *mmio = pp.ctl_block;
    let mut curr_ncq: c_int = (qc.tf.protocol == ATA_PROT_NCQ);
...
#[no_mangle]
unsafe extern "C" fn nv_generic_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t nv_generic_interrupt(int irq, void *dev_instance)
    {
    struct ata_host *host = dev_instance;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn nv_do_interrupt(host: *mut ata_host, irq_stat: u8) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn nv_nf2_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t nv_nf2_interrupt(int irq, void *dev_instance)
    {
    struct ata_host *host = dev_instance;
    u8 irq_stat;
...
#[no_mangle]
unsafe extern "C" fn nv_ck804_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t nv_ck804_interrupt(int irq, void *dev_instance)
    {
    struct ata_host *host = dev_instance;
    u8 irq_stat;
...
#[no_mangle]
unsafe extern "C" fn nv_scr_read(link: *mut ata_link, sc_reg: c_uint, val: *mut u32) -> c_int {
    static int nv_scr_read(struct ata_link *link, unsigned int sc_reg, u32 *val)
    {
...
#[no_mangle]
unsafe extern "C" fn nv_scr_write(link: *mut ata_link, sc_reg: c_uint, val: u32) -> c_int {
    static int nv_scr_write(struct ata_link *link, unsigned int sc_reg, u32 val)
    {
    if (sc_reg > SCR_CONTROL)
    return -EINVAL;
...
#[no_mangle]
unsafe extern "C" fn nv_nf2_freeze(ap: *mut ata_port) {
    static void nv_nf2_freeze(struct ata_port *ap)
    {
    void __iomem *scr_addr = ap.host.ports[0].ioaddr.scr_addr;
    let mut shift: c_int = ap.port_no * NV_INT_PORT_SHIFT;
    u8 mask;
...
#[no_mangle]
unsafe extern "C" fn nv_nf2_thaw(ap: *mut ata_port) {
    static void nv_nf2_thaw(struct ata_port *ap)
    {
    void __iomem *scr_addr = ap.host.ports[0].ioaddr.scr_addr;
    let mut shift: c_int = ap.port_no * NV_INT_PORT_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn nv_ck804_freeze(ap: *mut ata_port) {
    static void nv_ck804_freeze(struct ata_port *ap)
    {
...
#[no_mangle]
unsafe extern "C" fn nv_ck804_thaw(ap: *mut ata_port) {
    static void nv_ck804_thaw(struct ata_port *ap)
    {
    void __iomem *mmio_base = ap.host.iomap[NV_MMIO_BAR];
    let mut shift: c_int = ap.port_no * NV_INT_PORT_SHIFT;
...
#[no_mangle]
unsafe extern "C" fn nv_mcp55_freeze(ap: *mut ata_port) {
    static void nv_mcp55_freeze(struct ata_port *ap)
    {
    void __iomem *mmio_base = ap.host.iomap[NV_MMIO_BAR];
    let mut shift: c_int = ap.port_no * NV_INT_PORT_SHIFT_MCP55;
    u32 mask;
...
#[no_mangle]
unsafe extern "C" fn nv_mcp55_thaw(ap: *mut ata_port) {
    static void nv_mcp55_thaw(struct ata_port *ap)
    {
    void __iomem *mmio_base = ap.host.iomap[NV_MMIO_BAR];
    let mut shift: c_int = ap.port_no * NV_INT_PORT_SHIFT_MCP55;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_error_handler(ap: *mut ata_port) {
    static void nv_adma_error_handler(struct ata_port *ap)
    ...
    let mut notifier: u32 = readl(mmio + NV_ADMA_NOTIFIER);
    let mut notifier_error: u32 = readl(mmio + NV_ADMA_NOTIFIER_ERROR);
    let mut gen_ctl: u32 = readl(pp.gen_block + NV_ADMA_GEN_CTL);
    let mut status: u32 = readw(mmio + NV_ADMA_STAT);
    let mut cpb_count: u8 = readb(mmio + NV_ADMA_CPB_COUNT);
    let mut next_cpb_idx: u8 = readb(mmio + NV_ADMA_NEXT_CPB_IDX);
    ata_port_err(ap,
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_qc_to_dq(ap: *mut ata_port, qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_fis_reinit(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_pp_reinit(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_irq_clear(ap: *mut ata_port, fis: u16) {
    static void nv_swncq_irq_clear(struct ata_port *ap, u16 fis)
    {
    struct nv_swncq_port_priv *pp = ap.private_data;
...
#[no_mangle]
unsafe extern "C" fn __ata_bmdma_stop(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_ncq_stop(ap: *mut ata_port) {
    ...
    err = 0;
#[no_mangle]
pub unsafe extern "C" fn if(i): done_mask & (1 <<) -> else {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_error_handler(ap: *mut ata_port) {
    static void nv_swncq_error_handler(struct ata_port *ap)
    __must_hold(&ap.host.eh_mutex)
    {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_port_suspend(ap: *mut ata_port, mesg: pm_message_t) -> c_int {
    static int nv_swncq_port_suspend(struct ata_port *ap, pm_message_t mesg)
    {
    void __iomem *mmio = ap.host.iomap[NV_MMIO_BAR];
    u32 tmp;
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_port_resume(ap: *mut ata_port) -> c_int {
    static int nv_swncq_port_resume(struct ata_port *ap)
    {
    void __iomem *mmio = ap.host.iomap[NV_MMIO_BAR];
    u32 tmp;
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_host_init(host: *mut ata_host) {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_port_start(ap: *mut ata_port) -> c_int {
    static int nv_swncq_port_start(struct ata_port *ap)
    {
    struct device *dev = ap.host.dev;
    void __iomem *mmio = ap.host.iomap[NV_MMIO_BAR];
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    static enum ata_completion_errors nv_swncq_qc_prep(struct ata_queued_cmd *qc)
    {
    if (qc.tf.protocol != ATA_PROT_NCQ) {
    ata_bmdma_qc_prep(qc);
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_fill_sg(qc: *mut ata_queued_cmd) {
    static void nv_swncq_fill_sg(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int nv_swncq_qc_issue(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct nv_swncq_port_priv *pp = ap.private_data;
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_hotplug(ap: *mut ata_port, fis: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn if(NV_SWNCQ_IRQ_REMOVED: fis &) -> else {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_sdbfis(ap: *mut ata_port) -> c_int {
...
// send deferral queue command
    ...
    WARN_ON(qc == core::ptr::null_mut());
    nv_swncq_issue_atacmd(ap, qc);
    }
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn nv_swncq_tag(ap: *mut ata_port) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_dmafis(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_host_interrupt(ap: *mut ata_port, fis: u16) {
...
#[no_mangle]
unsafe extern "C" fn nv_swncq_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
    static irqreturn_t nv_swncq_interrupt(int irq, void *dev_instance)
    {
    struct ata_host *host = dev_instance;
    unsigned int i;
...
#[no_mangle]
unsafe extern "C" fn nv_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int nv_init_one(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    const struct ata_port_info *ppi[] = { core::ptr::null_mut(), core::ptr::null_mut() };
    ...
    u32 bar;
    void __iomem *base;
    let mut type: c_ulong = ent.driver_data;
...
#[no_mangle]
unsafe extern "C" fn nv_pci_device_resume(pdev: *mut pci_dev) -> c_int {
    static int nv_pci_device_resume(struct pci_dev *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn nv_ck804_host_stop(host: *mut ata_host) {
    static void nv_ck804_host_stop(struct ata_host *host)
    {
    struct pci_dev *pdev = to_pci_dev(host.dev);
    u8 regval;
...
#[no_mangle]
unsafe extern "C" fn nv_adma_host_stop(host: *mut ata_host) {
    static void nv_adma_host_stop(struct ata_host *host)
    {
    struct pci_dev *pdev = to_pci_dev(host.dev);
    u32 tmp32;
