...
//! Source: drivers/ata/pata_cmd640.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cmd640_reg {
    pub last: c_int,
    pub reg58: [u8; ATA_MAX_DEVICES],
}
...
//
#[no_mangle]
unsafe extern "C" fn cmd640_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
    ...
    u8 reg;
    let mut arttim: c_int = ARTIM0 + 2 * adev.devno;
...
//
#[no_mangle]
unsafe extern "C" fn cmd640_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn cmd640_port_start(ap: *mut ata_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmd640_sff_irq_check(ap: *mut ata_port) -> bool {
    static bool cmd640_sff_irq_check(struct ata_port *ap)
    {
    struct pci_dev *pdev	= to_pci_dev(ap.host.dev);
    let mut irq_reg: c_int = ap.port_no ? ARTIM23 : CFR;
...
#[no_mangle]
unsafe extern "C" fn cmd640_hardware_init(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn cmd640_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    return ata_pci_sff_init_one(pdev, ppi, &cmd640_sht, core::ptr::null_mut(), 0);
    }

#[no_mangle]
unsafe extern "C" fn cmd640_reinit_one(pdev: *mut pci_dev) -> c_int {
