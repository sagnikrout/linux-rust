...
//! Source: drivers/ata/pata_hpt366.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn hpt36x_find_mode(ap: *mut ata_port, speed: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn hpt366_filter(adev: *mut ata_device, mask: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn hpt36x_cable_detect(ap: *mut ata_port) -> c_int {
...
//
    ...
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut addr: u32 = 0x40 + 4 * adev.devno;
    u32 mask, reg, t;
...
//
#[no_mangle]
unsafe extern "C" fn hpt366_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt366_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt366_prereset(link: *mut ata_link, deadline: c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpt36x_init_chipset(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt36x_init_one(dev: *mut pci_dev, id: *const pci_device_id) -> c_int {
    ...
    const struct ata_port_info *ppi[] = { &info_hpt366, core::ptr::null_mut() };
    const void *hpriv = core::ptr::null_mut();
    u32 reg1;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn hpt36x_reinit_one(dev: *mut pci_dev) -> c_int {
