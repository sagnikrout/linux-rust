...
//! Source: drivers/ata/pata_falcon.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pata_falcon_init_one(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pata_falcon_remove_one(pdev: *mut platform_device) {
