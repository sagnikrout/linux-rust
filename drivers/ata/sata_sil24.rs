...
//! Source: drivers/ata/sata_sil24.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sil24_prb {
    pub ctrl: __le16,
    pub prot: __le16,
    pub rx_cnt: __le32,
    pub 4]: *mut *mut u8 fis[6,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sil24_ata_block {
    pub prb: sil24_prb,
    pub sge: [sil24_sge; SIL24_MAX_SGE],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct sil24_atapi_block {
    pub prb: sil24_prb,
    pub cdb: [u8; 16],
    pub sge: [sil24_sge; SIL24_MAX_SGE],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sil24_port_priv {
    pub /: *mut *mut *mut union sil24_cmd_block cmd_block; / 32 cmd blocks,
    pub /: *mut *mut dma_addr_t cmd_block_dma; / DMA base addr for them,
    pub do_port_rst: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn sil24_tag(tag: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sil24_port_offset(ap: *mut ata_port) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn sil24_dev_config(dev: *mut ata_device) {
    static void sil24_dev_config(struct ata_device *dev)
    {
...
#[no_mangle]
unsafe extern "C" fn sil24_read_tf(ap: *mut ata_port, tag: c_int, tf: *mut ata_taskfile) {
...
#[no_mangle]
unsafe extern "C" fn sil24_scr_read(link: *mut ata_link, sc_reg: unsigned, val: *mut u32) -> c_int {
    static int sil24_scr_read(struct ata_link *link, unsigned sc_reg, u32 *val)
    {
...
#[no_mangle]
unsafe extern "C" fn sil24_scr_write(link: *mut ata_link, sc_reg: unsigned, val: u32) -> c_int {
    static int sil24_scr_write(struct ata_link *link, unsigned sc_reg, u32 val)
    {
    void __iomem *scr_addr = sil24_port_base(link.ap) + PORT_SCONTROL;
    if (sc_reg < ARRAY_SIZE(sil24_scr_map)) {
...
#[no_mangle]
unsafe extern "C" fn sil24_config_port(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sil24_config_pmp(ap: *mut ata_port, attached: c_int) {
...
#[no_mangle]
unsafe extern "C" fn sil24_clear_pmp(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sil24_init_port(ap: *mut ata_port) -> c_int {
...
// clear PMP error status
    ...
    let mut paddr: dma_addr_t = pp.cmd_block_dma;
...
//
    ...
    struct sil24_sge *last_sge = core::ptr::null_mut();
    unsigned int si;
...
#[no_mangle]
unsafe extern "C" fn sil24_qc_defer(qc: *mut ata_queued_cmd) -> c_int {
    static int sil24_qc_defer(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn sil24_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    static enum ata_completion_errors sil24_qc_prep(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn sil24_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int sil24_qc_issue(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct sil24_port_priv *pp = ap.private_data;
    void __iomem *port = sil24_port_base(ap);
    let mut tag: c_uint = sil24_tag(qc.hw_tag);
    dma_addr_t paddr;
...
#[no_mangle]
unsafe extern "C" fn sil24_qc_fill_rtf(qc: *mut ata_queued_cmd) {
    static void sil24_qc_fill_rtf(struct ata_queued_cmd *qc)
    {
    sil24_read_tf(qc.ap, qc.hw_tag, &qc.result_tf);
    }
#[no_mangle]
unsafe extern "C" fn sil24_pmp_attach(ap: *mut ata_port) {
    static void sil24_pmp_attach(struct ata_port *ap)
    {
...
#[no_mangle]
unsafe extern "C" fn sil24_pmp_detach(ap: *mut ata_port) {
    static void sil24_pmp_detach(struct ata_port *ap)
    {
    sil24_init_port(ap);
...
#[no_mangle]
unsafe extern "C" fn sil24_freeze(ap: *mut ata_port) {
    static void sil24_freeze(struct ata_port *ap)
    {
    void __iomem *port = sil24_port_base(ap);
...
#[no_mangle]
unsafe extern "C" fn sil24_thaw(ap: *mut ata_port) {
    static void sil24_thaw(struct ata_port *ap)
    {
    void __iomem *port = sil24_port_base(ap);
    u32 tmp;
...
#[no_mangle]
unsafe extern "C" fn sil24_error_intr(ap: *mut ata_port) {
    ...
    let mut abort: c_int = 0, freeze = 0;
    u32 irq_stat;
...
// deal with command error
    if (irq_stat & PORT_IRQ_ERROR) {
    const struct sil24_cerr_info *ci = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn sil24_host_intr(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn sil24_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn sil24_error_handler(ap: *mut ata_port) {
    static void sil24_error_handler(struct ata_port *ap)
...
#[no_mangle]
unsafe extern "C" fn sil24_post_internal_cmd(qc: *mut ata_queued_cmd) {
    static void sil24_post_internal_cmd(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
...
#[no_mangle]
unsafe extern "C" fn sil24_port_start(ap: *mut ata_port) -> c_int {
    static int sil24_port_start(struct ata_port *ap)
    {
    struct device *dev = ap.host.dev;
    struct sil24_port_priv *pp;
    union sil24_cmd_block *cb;
    let mut cb_size: usize = sizeof(*cb) * SIL24_MAX_CMDS;
    dma_addr_t cb_dma;
...
#[no_mangle]
unsafe extern "C" fn sil24_init_controller(host: *mut ata_host) {
...
// Clear port RST
    ...
    writel(PORT_CS_PORT_RST, port + PORT_CTRL_CLR);
    tmp = ata_wait_register(core::ptr::null_mut(), port + PORT_CTRL_STAT,
    PORT_CS_PORT_RST,
...
#[no_mangle]
unsafe extern "C" fn sil24_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    static int sil24_init_one(struct pci_dev *pdev, const struct pci_device_id *ent)
    {
    extern int __MARKER__sil24_cmd_block_is_sized_wrongly;
    let mut pi: ata_port_info = sil24_port_info[ent.driver_data];
...
#[no_mangle]
unsafe extern "C" fn sil24_pci_device_resume(pdev: *mut pci_dev) -> c_int {
    static int sil24_pci_device_resume(struct pci_dev *pdev)
    {
...
#[no_mangle]
unsafe extern "C" fn sil24_port_resume(ap: *mut ata_port) -> c_int {
    static int sil24_port_resume(struct ata_port *ap)
    {
    sil24_config_pmp(ap, ap.nr_pmp_links);
    return 0;
