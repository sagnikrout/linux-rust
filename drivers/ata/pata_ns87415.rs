...
//! Source: drivers/ata/pata_ns87415.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ns87415_set_mode(ap: *mut ata_port, adev: *mut ata_device, mode: u8) {
    ...
    let mut timing: c_int = 0x44 + 2 * unit;
...
//
#[no_mangle]
unsafe extern "C" fn ns87415_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ns87415_bmdma_setup(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ns87415_bmdma_start(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ns87415_bmdma_stop(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn ns87415_irq_clear(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn ns87415_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
...
pub const SUPERIO_IDE_MAX_RETRIES: c_int = 25;
//
...
//
#[no_mangle]
unsafe extern "C" fn ns87560_read_buggy(port: *mut void __iomem) -> u8 {
    static u8 ns87560_read_buggy(void __iomem *port)
    {
    u8 tmp;
    let mut retries: c_int = SUPERIO_IDE_MAX_RETRIES;
    do {
    tmp = ioread8(port);
    if (tmp != 0)
    return tmp;
...
//
#[no_mangle]
unsafe extern "C" fn ns87560_check_status(ap: *mut ata_port) -> u8 {
...
//
#[no_mangle]
unsafe extern "C" fn ns87560_tf_read(ap: *mut ata_port, tf: *mut ata_taskfile) {
...
//
#[no_mangle]
unsafe extern "C" fn ns87560_bmdma_status(ap: *mut ata_port) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ns87415_fixup(pdev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn ns87415_init_one(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
    ...
    return rc;
    ns87415_fixup(pdev);
    return ata_pci_bmdma_init_one(pdev, ppi, &ns87415_sht, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn ns87415_reinit_one(pdev: *mut pci_dev) -> c_int {
