...
//! Source: drivers/ata/pata_ixp4xx_cf.c
#![no_std]
...
pub const IXP4XX_EXP_PIO_0_8: c_uint = 0x0a470000;
pub const IXP4XX_EXP_PIO_1_8: c_uint = 0x06430000;
pub const IXP4XX_EXP_PIO_2_8: c_uint = 0x02410000;
pub const IXP4XX_EXP_PIO_3_8: c_uint = 0x00820000;
pub const IXP4XX_EXP_PIO_4_8: c_uint = 0x00400000;
pub const IXP4XX_EXP_PIO_0_16: c_uint = 0x29640000;
pub const IXP4XX_EXP_PIO_1_16: c_uint = 0x05030000;
pub const IXP4XX_EXP_PIO_2_16: c_uint = 0x00b20000;
pub const IXP4XX_EXP_PIO_3_16: c_uint = 0x00820000;
pub const IXP4XX_EXP_PIO_4_16: c_uint = 0x00400000;

#[no_mangle]
unsafe extern "C" fn ixp4xx_set_8bit_timing(ixpp: *mut ixp4xx_pata, pio_mode: u8) {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_set_16bit_timing(ixpp: *mut ixp4xx_pata, pio_mode: u8) {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn ixp4xx_pata_probe(pdev: *mut platform_device) -> c_int {
    static int ixp4xx_pata_probe(struct platform_device *pdev)
    {
    struct resource *cmd, *ctl;
    let mut pi: ata_port_info = ixp4xx_port_info;
