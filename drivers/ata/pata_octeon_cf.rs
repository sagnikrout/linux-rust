...
//! Source: drivers/ata/pata_octeon_cf.c
#![no_std]
...
// Poll interval in nS.
pub const OCTEON_CF_BUSY_POLL_INTERVAL: c_int = 500000;
pub const DMA_CFG: c_int = 0;
pub const DMA_TIM: c_uint = 0x20;
pub const DMA_INT: c_uint = 0x38;
pub const DMA_INT_EN: c_uint = 0x50;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct octeon_cf_port {
    pub delayed_finish: hrtimer,
    pub ap: *mut ata_port,
    pub dma_finished: c_int,
    pub c0: *mut c_void,
    pub cs0: c_uint,
    pub cs1: c_uint,
    pub is_true_ide: bool,
    pub dma_base: u64,
}
...
//
#[no_mangle]
unsafe extern "C" fn ns_to_tim_reg(tim_mult: c_uint, nsecs: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_set_boot_reg_cfg(cs: c_int, multiplier: c_uint) {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_cf_set_piomode(ap: *mut ata_port, dev: *mut ata_device) {
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_set_dmamode(ap: *mut ata_port, dev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_cf_tf_read16(ap: *mut ata_port, tf: *mut ata_taskfile) {
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_check_status16(ap: *mut ata_port) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_dev_select(ap: *mut ata_port, device: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_ata_port_noaction(ap: *mut ata_port) {
    static void octeon_cf_ata_port_noaction(struct ata_port *ap)
    {
    }
#[no_mangle]
unsafe extern "C" fn octeon_cf_dma_setup(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_cf_dma_start(qc: *mut ata_queued_cmd) {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_cf_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_delayed_finish(hrt: *mut hrtimer) -> enum hrtimer_restart {
    ...
    unsigned long flags;
    u8 status;
    let mut rv: enum hrtimer_restart = HRTIMER_NORESTART;
    spin_lock_irqsave(&host.lock, flags);
//
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_dev_config(dev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn octeon_cf_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
    static int octeon_cf_check_atapi_dma(struct ata_queued_cmd *qc)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn octeon_cf_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_probe(pdev: *mut platform_device) -> c_int {
    ...
    void __iomem *cs0;
    void __iomem *cs1 = core::ptr::null_mut();
    ...
    is_16bit = false;
    rv = of_property_read_reg(node, 0, &reg, core::ptr::null_mut());
    if (rv < 0)
    return rv;
    ...
    if (!cs1)
    return -EINVAL;
    rv = of_property_read_reg(node, 1, &reg, core::ptr::null_mut());
    if (rv < 0)
    return rv;
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_shutdown(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn octeon_cf_init() -> int __init {
