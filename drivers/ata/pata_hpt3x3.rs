...
//! Source: drivers/ata/pata_hpt3x3.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x3_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x3_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    static void hpt3x3_set_dmamode(struct ata_port *ap, struct ata_device *adev)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    u32 r1, r2;
    let mut dn: c_int = 2 * ap.port_no + adev.devno;
    let mut mode_num: c_int = adev.dma_mode & 0x0F;
    pci_read_config_dword(pdev, 0x44, &r1);
    pci_read_config_dword(pdev, 0x48, &r2);
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x3_freeze(ap: *mut ata_port) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x3_bmdma_setup(qc: *mut ata_queued_cmd) {
    static void hpt3x3_bmdma_setup(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    let mut r: u8 = ioread8(ap.ioaddr.bmdma_addr + ATA_DMA_STATUS);
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x3_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x3_init_chipset(dev: *mut pci_dev) {
...
//
#[no_mangle]
unsafe extern "C" fn hpt3x3_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hpt3x3_reinit_one(dev: *mut pci_dev) -> c_int {
