...
#[no_mangle]
unsafe extern "C" fn ali_cable_override(pdev: *mut pci_dev) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ali_c2_cable_detect(ap: *mut ata_port) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ali_20_filter(adev: *mut ata_device, mask: c_uint) -> c_uint {
...
//
#[no_mangle]
unsafe extern "C" fn ali_fifo_control(ap: *mut ata_port, adev: *mut ata_device, on: c_int) {
    static void ali_fifo_control(struct ata_port *ap, struct ata_device *adev, int on)
    {
    struct pci_dev *pdev = to_pci_dev(ap.host.dev);
    let mut pio_fifo: c_int = 0x54 + ap.port_no;
    u8 fifo;
    let mut shift: c_int = 4 * adev.devno;
...
//
#[no_mangle]
unsafe extern "C" fn ali_program_modes(ap: *mut ata_port, adev: *mut ata_device, t: *mut ata_timing, ultra: u8) {
...
//
#[no_mangle]
unsafe extern "C" fn ali_set_piomode(ap: *mut ata_port, adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ali_set_dmamode(ap: *mut ata_port, adev: *mut ata_device) {
    ...
    ali_program_modes(ap, adev, core::ptr::null_mut(), udma_timing[adev.dma_mode - XFER_UDMA_0]);
...
//
#[no_mangle]
unsafe extern "C" fn ali_warn_atapi_dma(adev: *mut ata_device) {
    static void ali_warn_atapi_dma(struct ata_device *adev)
    {
    struct ata_eh_context *ehc = &adev.link.eh_context;
    let mut print_info: c_int = ehc.i.flags & ATA_EHI_PRINTINFO;
...
//
#[no_mangle]
unsafe extern "C" fn ali_lock_sectors(adev: *mut ata_device) {
...
//
#[no_mangle]
unsafe extern "C" fn ali_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali_c2_c3_postreset(link: *mut ata_link, classes: *mut c_uint) {
    static void ali_c2_c3_postreset(struct ata_link *link, unsigned int *classes)
    {
    u8 r;
    let mut port_bit: c_int = 4 << link.ap.port_no;
...
//
#[no_mangle]
unsafe extern "C" fn ali_init_chipset(pdev: *mut pci_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0xC5: pdev->revision > 0xC2 && pdev->revision <) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn ali_init_one(pdev: *mut pci_dev, id: *const pci_device_id) -> c_int {
...
// Are we paired with a UDMA capable chip
    ...
    return ata_pci_sff_init_one(pdev, ppi, &ali_sht, core::ptr::null_mut(), 0);
    else
    return ata_pci_bmdma_init_one(pdev, ppi, &ali_sht, core::ptr::null_mut(), 0);
    }

#[no_mangle]
unsafe extern "C" fn ali_reinit_one(pdev: *mut pci_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ali_init() -> int __init {
    static int __init ali_init(void)
    {
    int ret;
    ali_isa_bridge = pci_get_device(PCI_VENDOR_ID_AL, PCI_DEVICE_ID_AL_M1533, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn ali_exit() -> void __exit {
