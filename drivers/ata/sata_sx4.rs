...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pdc_port_priv {
    pub 512]: *mut *mut u8 dimm_buf[(ATA_PRD_SZ  ATA_MAX_PRD) +,
    pub pkt: *mut u8,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pdc_host_priv {
    pub doing_hdma: c_uint,
    pub hdma_prod: c_uint,
    pub hdma_cons: c_uint,
    struct {
...
#[no_mangle]
unsafe extern "C" fn pdc_port_start(ap: *mut ata_port) -> c_int {
    static int pdc_port_start(struct ata_port *ap)
    {
    ...
    {
    u32 addr;
    let mut dw: c_uint = PDC_DIMM_APKT_PRD >> 2;
...
// output ATA packet S/G table
    ...
    {
    u32 addr;
    let mut dw: c_uint = PDC_DIMM_HPKT_PRD >> 2;
    __le32 *buf32 = (__le32 *) buf;
...
//
    ...
    buf[i++] = PDC_PKT_READ;
#[no_mangle]
pub unsafe extern "C" fn if(ATA_PROT_NODATA: tf->protocol ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn pdc20621_dma_prep(qc: *mut ata_queued_cmd) {
    ...
    let mut portno: c_uint = ap.port_no;
...
#[no_mangle]
unsafe extern "C" fn pdc20621_nodata_prep(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn pdc20621_qc_prep(qc: *mut ata_queued_cmd) -> enum ata_completion_errors {
    static enum ata_completion_errors pdc20621_qc_prep(struct ata_queued_cmd *qc)
    {
...
// hard-code chip #0
    ...
    let mut idx: c_uint = pp.hdma_prod & PDC_HDMA_Q_MASK;
    if (!pp.doing_hdma) {
...
#[no_mangle]
unsafe extern "C" fn pdc20621_pop_hdma(qc: *mut ata_queued_cmd) {
    static void pdc20621_pop_hdma(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    struct pdc_host_priv *pp = ap.host.private_data;
    let mut idx: c_uint = pp.hdma_cons & PDC_HDMA_Q_MASK;
...
#[no_mangle]
unsafe extern "C" fn pdc20621_dump_hdma(qc: *mut ata_queued_cmd) {
    static void pdc20621_dump_hdma(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
    let mut port_no: c_uint = ap.port_no;
    void __iomem *dimm_mmio = ap.host.iomap[PDC_DIMM_BAR];
...
#[no_mangle]
unsafe extern "C" fn pdc20621_packet_start(qc: *mut ata_queued_cmd) {
...
#[no_mangle]
unsafe extern "C" fn pdc20621_qc_issue(qc: *mut ata_queued_cmd) -> c_uint {
    static unsigned int pdc20621_qc_issue(struct ata_queued_cmd *qc)
    {
    switch (qc.tf.protocol) {
    case ATA_PROT_NODATA:
...
#[no_mangle]
unsafe extern "C" fn pdc20621_irq_clear(ap: *mut ata_port) {
    static void pdc20621_irq_clear(struct ata_port *ap)
    {
    ioread8(ap.ioaddr.status_addr);
    }
#[no_mangle]
unsafe extern "C" fn pdc20621_interrupt(irq: c_int, dev_instance: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn pdc_freeze(ap: *mut ata_port) {
    static void pdc_freeze(struct ata_port *ap)
    {
...
#[no_mangle]
unsafe extern "C" fn pdc_thaw(ap: *mut ata_port) {
    static void pdc_thaw(struct ata_port *ap)
    {
    void __iomem *mmio = ap.ioaddr.cmd_addr;
    u32 tmp;
...
#[no_mangle]
unsafe extern "C" fn pdc_reset_port(ap: *mut ata_port) {
...
#[no_mangle]
unsafe extern "C" fn pdc_error_handler(ap: *mut ata_port) {
    static void pdc_error_handler(struct ata_port *ap)
...
#[no_mangle]
unsafe extern "C" fn pdc_post_internal_cmd(qc: *mut ata_queued_cmd) {
    static void pdc_post_internal_cmd(struct ata_queued_cmd *qc)
    {
    struct ata_port *ap = qc.ap;
...
#[no_mangle]
unsafe extern "C" fn pdc_check_atapi_dma(qc: *mut ata_queued_cmd) -> c_int {
    static int pdc_check_atapi_dma(struct ata_queued_cmd *qc)
    {
...
#[no_mangle]
unsafe extern "C" fn pdc_tf_load_mmio(ap: *mut ata_port, tf: *const ata_taskfile) {
    static void pdc_tf_load_mmio(struct ata_port *ap, const struct ata_taskfile *tf)
    {
...
#[no_mangle]
unsafe extern "C" fn pdc_exec_command_mmio(ap: *mut ata_port, tf: *const ata_taskfile) {
    static void pdc_exec_command_mmio(struct ata_port *ap, const struct ata_taskfile *tf)
    {
    WARN_ON(tf.protocol == ATA_PROT_DMA ||
    tf.protocol == ATAPI_PROT_DMA);
...
#[no_mangle]
unsafe extern "C" fn pdc_sata_setup_port(port: *mut ata_ioports, base: *mut void __iomem) {
...
#[no_mangle]
unsafe extern "C" fn pdc20621_detect_dimm(host: *mut ata_host) -> c_int {
    static int pdc20621_detect_dimm(struct ata_host *host)
    {
    let mut data: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn pdc20621_prog_dimm0(host: *mut ata_host) -> c_int {
    static int pdc20621_prog_dimm0(struct ata_host *host)
    {
    u32 spd0[50];
    let mut data: u32 = 0;
...
// hard-code chip #0
    ...
    data |= ((0x03) << 14);
#[no_mangle]
pub unsafe extern "C" fn if(0x04: spd0[18] &) -> else {
    else if (spd0[18] & 0x04)
    data |= ((0x02) << 14);
#[no_mangle]
pub unsafe extern "C" fn if(0x01: spd0[18] &) -> else {
...
#[no_mangle]
unsafe extern "C" fn pdc20621_prog_dimm_global(host: *mut ata_host) -> c_uint {
    static unsigned int pdc20621_prog_dimm_global(struct ata_host *host)
    {
    u32 data, spd0;
    int error, i;
...
#[no_mangle]
pub unsafe extern "C" fn Disable(20: bit) -> DIMM Arbitration {
    DIMM Arbitration Disable (bit 20)
    DIMM Data/Control Output Driving Selection (bit12 - bit15)
#[no_mangle]
pub unsafe extern "C" fn Enable(17: bit) -> Refresh {
...
#[no_mangle]
unsafe extern "C" fn pdc20621_dimm_init(host: *mut ata_host) -> c_uint {
    static unsigned int pdc20621_dimm_init(struct ata_host *host)
    {
    int speed, size, length;
    u32 addr, spd0, pci_status;
    let mut time_period: u32 = 0;
    let mut tcount: u32 = 0;
    let mut ticks: u32 = 0;
    let mut clock: u32 = 0;
    let mut fparam: u32 = 0;
    void __iomem *mmio = host.iomap[PDC_MMIO_BAR];
// hard-code chip #0
    mmio += PDC_CHIP0_OFS;
...
#[no_mangle]
unsafe extern "C" fn pdc_20621_init(host: *mut ata_host) {
...
//
    ...
    { &pdc_port_info[ent.driver_data], core::ptr::null_mut() };
...
// acquire resources and fill host
    ...
    let mut offset: c_uint = 0x200 + i * 0x80;
