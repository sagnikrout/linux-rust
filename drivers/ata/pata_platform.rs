...
//! Source: drivers/ata/pata_platform.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn pata_platform_set_mode(link: *mut ata_link, unused: *mut ata_device) -> c_int {
...
// activate
    return ata_host_activate(host, irq, irq ? ata_sff_interrupt : core::ptr::null_mut(),
    irq_flags, sht);
    }
    EXPORT_SYMBOL_GPL(__pata_platform_probe);
#[no_mangle]
unsafe extern "C" fn pata_platform_probe(pdev: *mut platform_device) -> c_int {
