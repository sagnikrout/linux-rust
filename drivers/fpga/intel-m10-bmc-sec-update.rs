...
//! Source: drivers/fpga/intel-m10-bmc-sec-update.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct m10bmc_sec_ops {
    pub sec): *mut *mut int (rsu_status)(struct m10bmc_sec,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct m10bmc_sec {
    pub dev: *mut device,
    pub m10bmc: *mut intel_m10bmc,
    pub fwl: *mut fw_upload,
    pub fw_name: *mut c_char,
    pub fw_name_id: u32,
    pub cancel_request: bool,
    pub ops: *const m10bmc_sec_ops,
}

    static DEFINE_XARRAY_ALLOC(fw_upload_xa);
// Root Entry Hash (REH) support
pub const REH_SHA256_SIZE: c_int = 32;
pub const REH_SHA384_SIZE: c_int = 48;

#[no_mangle]
unsafe extern "C" fn m10bmc_sec_write(sec: *mut m10bmc_sec, buf: *const u8, offset: u32, size: u32) -> c_int {
    static int m10bmc_sec_write(struct m10bmc_sec *sec, const u8 *buf, u32 offset, u32 size)
    {
    struct intel_m10bmc *m10bmc = sec.m10bmc;
    let mut stride: c_uint = regmap_get_reg_stride(m10bmc.regmap);
    let mut write_count: u32 = size / stride;
    let mut leftover_offset: u32 = write_count * stride;
    let mut leftover_size: u32 = size - leftover_offset;
    let mut leftover_tmp: u32 = 0;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn m10bmc_sec_read(sec: *mut m10bmc_sec, buf: *mut u8, addr: u32, size: u32) -> c_int {
    static int m10bmc_sec_read(struct m10bmc_sec *sec, u8 *buf, u32 addr, u32 size)
    {
    struct intel_m10bmc *m10bmc = sec.m10bmc;
    let mut stride: c_uint = regmap_get_reg_stride(m10bmc.regmap);
    let mut read_count: u32 = size / stride;
    let mut leftover_offset: u32 = read_count * stride;
    let mut leftover_size: u32 = size - leftover_offset;
    u32 leftover_tmp;
    int ret;
    if (sec.m10bmc.flash_bulk_ops)
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RO(_arg: _name##_root_entry_hash) -> static {
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RO(_arg: _name##_canceled_csks) -> static {
    static DEVICE_ATTR_RO(_name##_canceled_csks)
pub const CSK_VEC_OFFSET: c_uint = 0x34;
...
#[no_mangle]
unsafe extern "C" fn log_error_regs(sec: *mut m10bmc_sec, doorbell: u32) {
...
#[no_mangle]
unsafe extern "C" fn m10bmc_sec_n3000_rsu_status(sec: *mut m10bmc_sec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m10bmc_sec_n6000_rsu_status(sec: *mut m10bmc_sec) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsu_status_ok(status: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rsu_progress_done(progress: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rsu_progress_busy(progress: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rsu_check_idle(sec: *mut m10bmc_sec) -> enum fw_upload_err {
...
#[no_mangle]
pub unsafe extern "C" fn rsu_start_done(doorbell_reg: u32, progress: u32, status: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn rsu_update_init(sec: *mut m10bmc_sec) -> enum fw_upload_err {
...
#[no_mangle]
unsafe extern "C" fn rsu_prog_ready(sec: *mut m10bmc_sec) -> enum fw_upload_err {
...
#[no_mangle]
unsafe extern "C" fn rsu_send_data(sec: *mut m10bmc_sec) -> enum fw_upload_err {
...
#[no_mangle]
unsafe extern "C" fn rsu_check_complete(sec: *mut m10bmc_sec, doorbell_reg: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rsu_cancel(sec: *mut m10bmc_sec) -> enum fw_upload_err {
...
pub const WRITE_BLOCK_SIZE: c_uint = 0x4000	/* Default write-block size is 0x4000 bytes */;
...
#[no_mangle]
unsafe extern "C" fn m10bmc_sec_poll_complete(fwl: *mut fw_upload) -> enum fw_upload_err {
...
//
#[no_mangle]
unsafe extern "C" fn m10bmc_sec_cancel(fwl: *mut fw_upload) {
...
#[no_mangle]
unsafe extern "C" fn m10bmc_sec_cleanup(fwl: *mut fw_upload) {
...
pub const SEC_UPDATE_LEN_MAX: c_int = 32;
#[no_mangle]
unsafe extern "C" fn m10bmc_sec_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn m10bmc_sec_remove(pdev: *mut platform_device) {
