...
//! Source: drivers/fpga/of-fpga-region.c
#![no_std]
...
//
    ...
    {
    return fpga_region_class_find(core::ptr::null_mut(), np, device_match_of_node);
    }
//
...
//
#[no_mangle]
unsafe extern "C" fn of_fpga_region_get_bridges(region: *mut fpga_region) -> c_int {
    static int of_fpga_region_get_bridges(struct fpga_region *region)
    {
    struct device *dev = &region.dev;
    struct device_node *region_np = dev.of_node;
    struct fpga_image_info *info = region.info;
    struct device_node *br, *np, *parent_br = core::ptr::null_mut();
    int i, ret;
...
//
#[no_mangle]
unsafe extern "C" fn child_regions_with_firmware(overlay: *mut device_node) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn of_fpga_region_probe(pdev: *mut platform_device) -> c_int {
...
// Find the FPGA mgr specified by region or parent region.
    ...
    of_platform_populate(np, fpga_region_of_match, core::ptr::null_mut(), &region.dev);
...
#[no_mangle]
unsafe extern "C" fn of_fpga_region_remove(pdev: *mut platform_device) {
...
//
#[no_mangle]
unsafe extern "C" fn of_fpga_region_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn of_fpga_region_exit() -> void __exit {
