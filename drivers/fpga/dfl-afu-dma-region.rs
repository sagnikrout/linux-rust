...
//! Source: drivers/fpga/dfl-afu-dma-region.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn afu_dma_region_init(fdata: *mut dfl_feature_dev_data) {
...
//
    ...
    {
    let mut npages: c_int = region.length >> PAGE_SHIFT;
...
//
    ...
    struct dfl_afu_dma_region *region)
    {
    let mut npages: c_long = region.length >> PAGE_SHIFT;
    struct device *dev = &fdata.dev.dev;
...
//
#[no_mangle]
unsafe extern "C" fn afu_dma_check_continuous_pages(region: *mut dfl_afu_dma_region) -> bool {
...
//
    ...
    new = &((*new).rb_left);
#[no_mangle]
pub unsafe extern "C" fn if(this->iova: region->iova >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn afu_dma_region_destroy(fdata: *mut dfl_feature_dev_data) {
...
//
    ...
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(region->iova: iova >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn afu_dma_unmap_region(fdata: *mut dfl_feature_dev_data, iova: u64) -> c_int {
