...
//! Source: drivers/fpga/fpga-mgr.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fpga_mgr_devres {
    pub mgr: *mut fpga_manager,
}

#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_fpga_remove(mgr: *mut fpga_manager) {
...
#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_state(mgr: *mut fpga_manager) -> enum fpga_mgr_states {
...
#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_status(mgr: *mut fpga_manager) -> u64 {
...
#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_write(mgr: *mut fpga_manager, buf: *const c_char, count: usize) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_image_info_free(info: *mut fpga_image_info) {
...
//
    ...
    char *new_buf, *buf = core::ptr::null_mut();
    int ret;
    do {
...
//
    ...
    const char *buf, size_t count)
    {
    let mut header_size: usize = info.header_size;
    int ret;
    mgr.state = FPGA_MGR_STATE_WRITE_INIT;
    if (header_size > count)
    ret = -EINVAL;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !header_size) -> else {
    else if (!header_size)
    ret = fpga_mgr_write_init(mgr, info, core::ptr::null_mut(), 0);
    else
...
// Short path. Low level driver don't care about image header.
    ...
    return fpga_mgr_write_init_buf(mgr, info, core::ptr::null_mut(), 0);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_load(mgr: *mut fpga_manager, info: *mut fpga_image_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fpga_mgr_dev_match(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    mgr_dev = class_find_device(&fpga_mgr_class, core::ptr::null_mut(), dev, fpga_mgr_dev_match);
    if (!mgr_dev)
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_put(mgr: *mut fpga_manager) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_lock(mgr: *mut fpga_manager) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_unlock(mgr: *mut fpga_manager) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_mgr_unregister(mgr: *mut fpga_manager) {
...
#[no_mangle]
unsafe extern "C" fn devm_fpga_mgr_unregister(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn fpga_mgr_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fpga_mgr_class_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fpga_mgr_class_exit() -> void __exit {
