...
//! Source: drivers/fpga/fpga-bridge.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_bridge_enable(bridge: *mut fpga_bridge) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_bridge_disable(bridge: *mut fpga_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fpga_bridge_dev_match(dev: *mut device, data: *const c_void) -> c_int {
...
//
    ...
    struct fpga_bridge *bridge;
    struct device *bridge_dev;
    bridge_dev = class_find_device(&fpga_bridge_class, core::ptr::null_mut(), dev,
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_bridge_put(bridge: *mut fpga_bridge) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_bridges_enable(bridge_list: *mut list_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_bridges_disable(bridge_list: *mut list_head) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_bridges_put(bridge_list: *mut list_head) {
...
//
    ...
    of_platform_populate(bridge.dev.of_node, core::ptr::null_mut(), core::ptr::null_mut(), &bridge.dev);
    return bridge;
    error_device:
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_bridge_unregister(bridge: *mut fpga_bridge) {
...
#[no_mangle]
unsafe extern "C" fn fpga_bridge_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fpga_bridge_dev_init() -> int __init {
    static int __init fpga_bridge_dev_init(void)
    {
    return class_register(&fpga_bridge_class);
    }
#[no_mangle]
unsafe extern "C" fn fpga_bridge_dev_exit() -> void __exit {
