...
//! Source: drivers/fpga/tests/fpga-mgr-test.c
#![no_std]
...
pub const IMAGE_BLOCK: c_int = 1024;
...
pub struct mgr_stats {
    ...
    pub op_parse_header_state: enum fpga_mgr_states,
    pub op_write_init_state: enum fpga_mgr_states,
    pub op_write_state: enum fpga_mgr_states,
    pub op_write_sg_state: enum fpga_mgr_states,
    pub op_write_complete_state: enum fpga_mgr_states,
}
...
#[no_mangle]
unsafe extern "C" fn op_write_complete(mgr: *mut fpga_manager, info: *mut fpga_image_info) -> c_int {
