...
//! Source: drivers/fpga/microchip-spi.c
#![no_std]
...
pub const MPF_SPI_ISC_ENABLE: c_uint = 0x0B;
pub const MPF_SPI_ISC_DISABLE: c_uint = 0x0C;
pub const MPF_SPI_READ_STATUS: c_uint = 0x00;
pub const MPF_SPI_READ_DATA: c_uint = 0x01;
pub const MPF_SPI_FRAME_INIT: c_uint = 0xAE;
pub const MPF_SPI_FRAME: c_uint = 0xEE;
pub const MPF_SPI_PRG_MODE: c_uint = 0x01;
pub const MPF_SPI_RELEASE: c_uint = 0x23;
pub const MPF_SPI_FRAME_SIZE: c_int = 16;
pub const MPF_HEADER_SIZE_OFFSET: c_int = 24;
pub const MPF_DATA_SIZE_OFFSET: c_int = 55;
pub const MPF_LOOKUP_TABLE_RECORD_SIZE: c_int = 9;
pub const MPF_LOOKUP_TABLE_BLOCK_ID_OFFSET: c_int = 0;
pub const MPF_LOOKUP_TABLE_BLOCK_START_OFFSET: c_int = 1;
pub const MPF_COMPONENTS_SIZE_ID: c_int = 5;
pub const MPF_BITSTREAM_ID: c_int = 8;
pub const MPF_BITS_PER_COMPONENT_SIZE: c_int = 22;
...
pub struct mpf_priv {
    ...
    pub __aligned(ARCH_KMALLOC_MINALIGN): u8 tx,
    pub rx: u8,
}

#[no_mangle]
unsafe extern "C" fn mpf_read_status(priv: *mut mpf_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpf_ops_state(mgr: *mut fpga_manager) -> enum fpga_mgr_states {
...
#[no_mangle]
unsafe extern "C" fn mpf_poll_status(priv: *mut mpf_priv, mask: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpf_spi_write(priv: *mut mpf_priv, buf: *const c_void, buf_size: usize) -> c_int {
    static int mpf_spi_write(struct mpf_priv *priv, const void *buf, size_t buf_size)
    {
    let mut status: c_int = mpf_poll_status(priv, 0);
    if (status < 0)
    return status;
    return spi_write_then_read(priv.spi, buf, buf_size, core::ptr::null_mut(), 0);
    }
...
#[no_mangle]
unsafe extern "C" fn mpf_spi_frame_write(priv: *mut mpf_priv, buf: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpf_ops_write(mgr: *mut fpga_manager, buf: *const c_char, count: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpf_probe(spi: *mut spi_device) -> c_int {
