...
//! Source: drivers/fpga/dfl-afu-main.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn __afu_port_enable(fdata: *mut dfl_feature_dev_data) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn __afu_port_disable(fdata: *mut dfl_feature_dev_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn __port_reset(fdata: *mut dfl_feature_dev_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_reset(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn port_get_id(fdata: *mut dfl_feature_dev_data) -> c_int {
    ...
    let mut id: c_int = port_get_id(fdata);
...
#[no_mangle]
unsafe extern "C" fn afu_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afu_release(inode: *mut inode, filp: *mut file) -> c_int {
    ...
    feature.nr_irqs, core::ptr::null_mut());
    __port_reset(fdata);
...
#[no_mangle]
unsafe extern "C" fn afu_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn afu_mmap(filp: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afu_dev_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afu_dev_destroy(pdev: *mut platform_device) -> c_int {
    ...
    afu_dma_region_destroy(fdata);
    dfl_fpga_fdata_set_private(fdata, core::ptr::null_mut());
    mutex_unlock(&fdata.lock);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn port_enable_set(fdata: *mut dfl_feature_dev_data, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afu_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn afu_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn afu_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn afu_exit() -> void __exit {
