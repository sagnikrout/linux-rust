...
//! Source: drivers/fpga/ice40-spi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ice40_fpga_ops_state(mgr: *mut fpga_manager) -> enum fpga_mgr_states {
...
#[no_mangle]
unsafe extern "C" fn ice40_fpga_probe(spi: *mut spi_device) -> c_int {
