...
//! Source: drivers/fpga/dfl-afu-region.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn afu_mmio_region_init(fdata: *mut dfl_feature_dev_data) {
...
//
#[no_mangle]
pub unsafe extern "C" fn afu_mmio_region_destroy(fdata: *mut dfl_feature_dev_data) {
