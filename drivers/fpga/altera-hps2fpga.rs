...
//! Source: drivers/fpga/altera-hps2fpga.c
#![no_std]
...
pub const ALT_L3_REMAP_OFST: c_uint = 0x0;
pub const ALT_L3_REMAP_MPUZERO_MSK: c_uint = 0x00000001;
pub const ALT_L3_REMAP_H2F_MSK: c_uint = 0x00000008;
pub const ALT_L3_REMAP_LWH2F_MSK: c_uint = 0x00000010;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct altera_hps2fpga_data {
    pub name: *const c_char,
    pub bridge_reset: *mut reset_control,
    pub l3reg: *mut regmap,
    pub remap_mask: c_uint,
    pub clk: *mut clk,
}

#[no_mangle]
unsafe extern "C" fn alt_hps2fpga_enable_show(bridge: *mut fpga_bridge) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn alt_hps2fpga_enable_set(bridge: *mut fpga_bridge, enable: bool) -> c_int {
