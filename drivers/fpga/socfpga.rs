...
// Register offsets
pub const SOCFPGA_FPGMGR_STAT_OFST: c_uint = 0x0;
pub const SOCFPGA_FPGMGR_CTL_OFST: c_uint = 0x4;
pub const SOCFPGA_FPGMGR_DCLKCNT_OFST: c_uint = 0x8;
pub const SOCFPGA_FPGMGR_DCLKSTAT_OFST: c_uint = 0xc;
pub const SOCFPGA_FPGMGR_GPIO_INTEN_OFST: c_uint = 0x830;
pub const SOCFPGA_FPGMGR_GPIO_INTMSK_OFST: c_uint = 0x834;
pub const SOCFPGA_FPGMGR_GPIO_INTTYPE_LEVEL_OFST: c_uint = 0x838;
pub const SOCFPGA_FPGMGR_GPIO_INT_POL_OFST: c_uint = 0x83c;
pub const SOCFPGA_FPGMGR_GPIO_INTSTAT_OFST: c_uint = 0x840;
pub const SOCFPGA_FPGMGR_GPIO_RAW_INTSTAT_OFST: c_uint = 0x844;
pub const SOCFPGA_FPGMGR_GPIO_PORTA_EOI_OFST: c_uint = 0x84c;
pub const SOCFPGA_FPGMGR_GPIO_EXT_PORTA_OFST: c_uint = 0x850;
// Register bit defines
// SOCFPGA_FPGMGR_STAT register mode field values
pub const SOCFPGA_FPGMGR_STAT_POWER_UP: c_uint = 0x0 /*ramping*/;
pub const SOCFPGA_FPGMGR_STAT_RESET: c_uint = 0x1;
pub const SOCFPGA_FPGMGR_STAT_CFG: c_uint = 0x2;
pub const SOCFPGA_FPGMGR_STAT_INIT: c_uint = 0x3;
pub const SOCFPGA_FPGMGR_STAT_USER_MODE: c_uint = 0x4;
pub const SOCFPGA_FPGMGR_STAT_UNKNOWN: c_uint = 0x5;
pub const SOCFPGA_FPGMGR_STAT_STATE_MASK: c_uint = 0x7;
// This is a flag value that doesn't really happen in this register field
pub const SOCFPGA_FPGMGR_STAT_POWER_OFF: c_uint = 0x0;
pub const MSEL_PP16_FAST_NOAES_NODC: c_uint = 0x0;
pub const MSEL_PP16_FAST_AES_NODC: c_uint = 0x1;
pub const MSEL_PP16_FAST_AESOPT_DC: c_uint = 0x2;
pub const MSEL_PP16_SLOW_NOAES_NODC: c_uint = 0x4;
pub const MSEL_PP16_SLOW_AES_NODC: c_uint = 0x5;
pub const MSEL_PP16_SLOW_AESOPT_DC: c_uint = 0x6;
pub const MSEL_PP32_FAST_NOAES_NODC: c_uint = 0x8;
pub const MSEL_PP32_FAST_AES_NODC: c_uint = 0x9;
pub const MSEL_PP32_FAST_AESOPT_DC: c_uint = 0xa;
pub const MSEL_PP32_SLOW_NOAES_NODC: c_uint = 0xc;
pub const MSEL_PP32_SLOW_AES_NODC: c_uint = 0xd;
pub const MSEL_PP32_SLOW_AESOPT_DC: c_uint = 0xe;
pub const SOCFPGA_FPGMGR_STAT_MSEL_MASK: c_uint = 0x000000f8;
pub const SOCFPGA_FPGMGR_STAT_MSEL_SHIFT: c_int = 3;
// SOCFPGA_FPGMGR_CTL register
pub const SOCFPGA_FPGMGR_CTL_EN: c_uint = 0x00000001;
pub const SOCFPGA_FPGMGR_CTL_NCE: c_uint = 0x00000002;
pub const SOCFPGA_FPGMGR_CTL_NCFGPULL: c_uint = 0x00000004;
pub const CDRATIO_X1: c_uint = 0x00000000;
pub const CDRATIO_X2: c_uint = 0x00000040;
pub const CDRATIO_X4: c_uint = 0x00000080;
pub const CDRATIO_X8: c_uint = 0x000000c0;
pub const SOCFPGA_FPGMGR_CTL_CDRATIO_MASK: c_uint = 0x000000c0;
pub const SOCFPGA_FPGMGR_CTL_AXICFGEN: c_uint = 0x00000100;
pub const CFGWDTH_16: c_uint = 0x00000000;
pub const CFGWDTH_32: c_uint = 0x00000200;
pub const SOCFPGA_FPGMGR_CTL_CFGWDTH_MASK: c_uint = 0x00000200;
// SOCFPGA_FPGMGR_DCLKSTAT register
pub const SOCFPGA_FPGMGR_DCLKSTAT_DCNTDONE_E_DONE: c_uint = 0x1;
// SOCFPGA_FPGMGR_GPIO_* registers share the same bit positions
pub const SOCFPGA_FPGMGR_MON_NSTATUS: c_uint = 0x0001;
pub const SOCFPGA_FPGMGR_MON_CONF_DONE: c_uint = 0x0002;
pub const SOCFPGA_FPGMGR_MON_INIT_DONE: c_uint = 0x0004;
pub const SOCFPGA_FPGMGR_MON_CRC_ERROR: c_uint = 0x0008;
pub const SOCFPGA_FPGMGR_MON_CVP_CONF_DONE: c_uint = 0x0010;
pub const SOCFPGA_FPGMGR_MON_PR_READY: c_uint = 0x0020;
pub const SOCFPGA_FPGMGR_MON_PR_ERROR: c_uint = 0x0040;
pub const SOCFPGA_FPGMGR_MON_PR_DONE: c_uint = 0x0080;
pub const SOCFPGA_FPGMGR_MON_NCONFIG_PIN: c_uint = 0x0100;
pub const SOCFPGA_FPGMGR_MON_NSTATUS_PIN: c_uint = 0x0200;
pub const SOCFPGA_FPGMGR_MON_CONF_DONE_PIN: c_uint = 0x0400;
pub const SOCFPGA_FPGMGR_MON_FPGA_POWER_ON: c_uint = 0x0800;
pub const SOCFPGA_FPGMGR_MON_STATUS_MASK: c_uint = 0x0fff;
pub const SOCFPGA_FPGMGR_NUM_SUPPLIES: c_int = 3;
pub const SOCFPGA_RESUME_TIMEOUT: c_int = 3;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct socfpga_fpga_priv {
    pub fpga_base_addr: *mut void __iomem,
    pub fpga_data_addr: *mut void __iomem,
    pub status_complete: completion,
    pub irq: c_int,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct cfgmgr_mode {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_readl(priv: *mut socfpga_fpga_priv, reg_offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_data_writel(priv: *mut socfpga_fpga_priv, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_mon_status_get(priv: *mut socfpga_fpga_priv) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_state_get(priv: *mut socfpga_fpga_priv) -> u32 {
    static u32 socfpga_fpga_state_get(struct socfpga_fpga_priv *priv)
    {
    let mut status: u32 = socfpga_fpga_mon_status_get(priv);
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_clear_done_status(priv: *mut socfpga_fpga_priv) {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_enable_irqs(priv: *mut socfpga_fpga_priv, irqs: u32) {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_disable_irqs(priv: *mut socfpga_fpga_priv) {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_isr(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_wait_for_config_done(priv: *mut socfpga_fpga_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_cfg_mode_get(priv: *mut socfpga_fpga_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_cfg_mode_set(priv: *mut socfpga_fpga_priv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_reset(mgr: *mut fpga_manager) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_ops_state(mgr: *mut fpga_manager) -> enum fpga_mgr_states {
...
#[no_mangle]
unsafe extern "C" fn socfpga_fpga_probe(pdev: *mut platform_device) -> c_int {
