...
//! Source: drivers/fpga/fpga-region.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn fpga_region_put(region: *mut fpga_region) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_region_program_fpga(region: *mut fpga_region) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fpga_region_unregister(region: *mut fpga_region) {
...
//
#[no_mangle]
unsafe extern "C" fn fpga_region_init() -> int __init {
    static int __init fpga_region_init(void)
    {
    return class_register(&fpga_region_class);
    }
#[no_mangle]
unsafe extern "C" fn fpga_region_exit() -> void __exit {
