...
//! Source: drivers/fpga/dfl-fme-main.c
#![no_std]
...
pub const FME_THERM_THRESHOLD: c_uint = 0x8;

// threshold1 policy: 0 - AP2 (90% throttle) / 1 - AP1 (50% throttle)

pub const FME_THERM_RDSENSOR_FMT1: c_uint = 0x10;

pub const FME_THERM_CAP: c_uint = 0x20;

// Macro flag: #define MD_PRE_DEG
#[no_mangle]
unsafe extern "C" fn fme_thermal_throttle_support(base: *mut void __iomem) -> bool {
    static bool fme_thermal_throttle_support(void __iomem *base)
    {
    let mut v: u64 = readq(base + FME_THERM_CAP);
...
pub const FME_PWR_STATUS: c_uint = 0x8;

pub const FME_PWR_THRESHOLD: c_uint = 0x10;

pub const PWR_THRESHOLD_MAX: c_uint = 0x7f			/* in Watts */;

pub const FME_PWR_XEON_LIMIT: c_uint = 0x18;

pub const FME_PWR_FPGA_LIMIT: c_uint = 0x20;
...
#[no_mangle]
unsafe extern "C" fn fme_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fme_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fme_ioctl(filp: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn fme_dev_init(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fme_dev_destroy(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn fme_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fme_remove(pdev: *mut platform_device) {
