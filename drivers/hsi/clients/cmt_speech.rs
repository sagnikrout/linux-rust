...
//! Source: drivers/hsi/clients/cmt_speech.c
#![no_std]
...
pub struct cs_char {
    ...
    pub hi: *mut cs_hsi_iface,
    pub chardev_queue: list_head,
    pub dataind_queue: list_head,
    pub dataind_pending: c_int,
// mmap things
...
pub const SSI_CHANNEL_STATE_READING: c_int = 1;

pub const TARGET_MASK: c_uint = 0xf000000;

pub const TARGET_LOCAL: c_int = 0;
// Number of pre-allocated commands buffers
pub const CS_MAX_CMDS: c_int = 4;
//
// During data transfers, transactions must be handled
// within 20ms (fixed value in cmtspeech HSI protocol)
//
pub const CS_QOS_LATENCY_FOR_DATA_USEC: c_int = 20000;
// Timeout to wait for pending HSI transfers to complete
pub const CS_HSI_TRANSFER_TIMEOUT_MS: c_int = 500;
pub const RX_PTR_BOUNDARY_SHIFT: c_int = 8;

    CS_MAX_BUFFERS_SHIFT)
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cs_hsi_iface {
    pub cl: *mut hsi_client,
    pub master: *mut hsi_client,
    pub iface_state: c_uint,
    pub wakeline_state: c_uint,
    pub control_state: c_uint,
    pub data_state: c_uint,
// state exposed to application
    pub mmap_cfg: *mut cs_mmap_config_block,
    pub mmap_base: c_ulong,
    pub mmap_size: c_ulong,
    pub rx_slot: c_uint,
    pub tx_slot: c_uint,
...
// mmap_cfg, but instead duplicate the variables here
    ...
    pub rx_bufs: c_uint,
    pub tx_bufs: c_uint,
    pub rx_ptr_boundary: c_uint,
    pub rx_offsets: [c_uint; CS_MAX_BUFFERS],
    pub tx_offsets: [c_uint; CS_MAX_BUFFERS],
// size of aligned memory blocks
    pub slot_size: c_uint,
    pub flags: c_uint,
    pub cmdqueue: list_head,
    pub data_rx_msg: *mut hsi_msg,
    pub data_tx_msg: *mut hsi_msg,
    pub datawait: wait_queue_head_t,
...
#[no_mangle]
pub unsafe extern "C" fn rx_ptr_shift_too_big() {
    static inline void rx_ptr_shift_too_big(void)
    {
    BUILD_BUG_ON((1LLU << RX_PTR_MAX_SHIFT) > UINT_MAX);
    }
#[no_mangle]
unsafe extern "C" fn cs_notify(message: u32, head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn cs_pop_entry(head: *mut list_head) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cs_notify_control(message: u32) {
    static void cs_notify_control(u32 message)
    {
    cs_notify(message, &cs_char_data.chardev_queue);
    }
#[no_mangle]
unsafe extern "C" fn cs_notify_data(message: u32, maxlength: c_int) {
...
#[no_mangle]
pub unsafe extern "C" fn cs_set_cmd(msg: *mut hsi_msg, cmd: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn cs_get_cmd(msg: *mut hsi_msg) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn cs_release_cmd(msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_cmd_destructor(msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_free_cmds(ssi: *mut cs_hsi_iface) {
...
#[no_mangle]
unsafe extern "C" fn cs_alloc_cmds(hi: *mut cs_hsi_iface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_data_destructor(msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_alloc_data(hi: *mut cs_hsi_iface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_free_data_msg(msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_free_data(hi: *mut cs_hsi_iface) {
...
#[no_mangle]
pub unsafe extern "C" fn __cs_hsi_error_post(hi: *mut cs_hsi_iface) {
    static inline void __cs_hsi_error_post(struct cs_hsi_iface *hi)
    {
    spin_unlock(&hi.lock);
    }
#[no_mangle]
pub unsafe extern "C" fn __cs_hsi_error_read_bits(state: *mut c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn __cs_hsi_error_write_bits(state: *mut c_uint) {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_data_read_error(hi: *mut cs_hsi_iface, msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_read_on_control_complete(msg: *mut hsi_msg) {
    static void cs_hsi_read_on_control_complete(struct hsi_msg *msg)
    {
    let mut cmd: u32 = cs_get_cmd(msg);
    struct cs_hsi_iface *hi = msg.context;
    spin_lock(&hi.lock);
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_peek_on_control_complete(msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_read_on_control(hi: *mut cs_hsi_iface) {
    static void cs_hsi_read_on_control(struct cs_hsi_iface *hi)
    {
    struct hsi_msg *msg;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_write_on_control_complete(msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_write_on_control(hi: *mut cs_hsi_iface, message: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_read_on_data_complete(msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_peek_on_data_complete(msg: *mut hsi_msg) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_state_xfer_active(state: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cs_state_idle(state: c_uint) -> c_int {
    static inline int cs_state_idle(unsigned int state)
    {
    return !(state & ~SSI_CHANNEL_STATE_ERROR);
    }
#[no_mangle]
unsafe extern "C" fn cs_hsi_read_on_data(hi: *mut cs_hsi_iface) {
    static void cs_hsi_read_on_data(struct cs_hsi_iface *hi)
    {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_write_on_data_complete(msg: *mut hsi_msg) {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_write_on_data(hi: *mut cs_hsi_iface, slot: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_get_state(hi: *mut cs_hsi_iface) -> c_uint {
    static unsigned int cs_hsi_get_state(struct cs_hsi_iface *hi)
    {
    return hi.iface_state;
    }
#[no_mangle]
unsafe extern "C" fn cs_hsi_command(hi: *mut cs_hsi_iface, cmd: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_set_wakeline(hi: *mut cs_hsi_iface, new_state: bool) {
...
#[no_mangle]
unsafe extern "C" fn set_buffer_sizes(hi: *mut cs_hsi_iface, rx_bufs: c_int, tx_bufs: c_int) {
...
//
    ...
    let mut ctrl_size_aligned: usize = L1_CACHE_ALIGN(sizeof(*hi.mmap_cfg));
    let mut r: c_int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn cs_hsi_data_sync(hi: *mut cs_hsi_iface) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_data_disable(hi: *mut cs_hsi_iface, old_state: c_int) {
    ...
    {
    let mut r: c_int = 0;
    let mut old_state: c_uint = hi.iface_state;
    spin_lock_bh(&hi.lock);
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_stop(hi: *mut cs_hsi_iface) {
...
#[no_mangle]
unsafe extern "C" fn cs_char_vma_fault(vmf: *mut vm_fault) -> vm_fault_t {
...
#[no_mangle]
unsafe extern "C" fn cs_char_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_char_poll(file: *mut file, wait: *mut poll_table) -> __poll_t {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !list_empty(&csdata->dataind_queue)) -> else {
    ...
    let mut ifver: c_uint = CS_IF_VERSION;
...
#[no_mangle]
unsafe extern "C" fn cs_char_mmap(file: *mut file, vma: *mut vm_area_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_char_open(unused: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_free_char_queue(head: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn cs_char_release(unused: *mut inode, file: *mut file) -> c_int {
    static int cs_char_release(struct inode *unused, struct file *file)
    {
    struct cs_char *csdata = file.private_data;
    cs_hsi_stop(csdata.hi);
    spin_lock_bh(&csdata.lock);
    csdata.hi = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_client_probe(dev: *mut device) -> c_int {
    ...
    cs_char_data.opened = 0;
    cs_char_data.cl = cl;
    cs_char_data.hi = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cs_hsi_client_remove(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cs_char_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cs_char_exit() -> void __exit {
