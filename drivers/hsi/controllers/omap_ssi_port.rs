...
//! Source: drivers/hsi/controllers/omap_ssi_port.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn hsi_dummy_msg(__maybe_unused: *mut *mut hsi_msg msg) -> c_int {
    static inline int hsi_dummy_msg(struct hsi_msg *msg __maybe_unused)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn hsi_dummy_cl(__maybe_unused: *mut *mut hsi_client cl) -> c_int {
    static inline int hsi_dummy_cl(struct hsi_client *cl __maybe_unused)
    {
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn ssi_wakein(port: *mut hsi_port) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn ssi_debug_remove_port(port: *mut hsi_port) {
...
#[no_mangle]
unsafe extern "C" fn ssi_port_regs_show(m: *mut seq_file, __maybe_unused: *mut *mut void p) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_div_get(data: *mut c_void, val: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_div_set(data: *mut c_void, val: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_process_errqueue(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ssi_claim_lch(msg: *mut hsi_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_start_dma(msg: *mut hsi_msg, lch: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_start_pio(msg: *mut hsi_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_start_transfer(queue: *mut list_head) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_async_break(msg: *mut hsi_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_async(msg: *mut hsi_msg) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_calculate_div(ssi: *mut hsi_controller) -> u32 {
    static u32 ssi_calculate_div(struct hsi_controller *ssi)
    {
    struct omap_ssi_controller *omap_ssi = hsi_controller_drvdata(ssi);
    let mut tx_fckrate: u32 = (u32) omap_ssi.fck_rate;
...
#[no_mangle]
unsafe extern "C" fn ssi_flush_queue(queue: *mut list_head, cl: *mut hsi_client) {
...
#[no_mangle]
unsafe extern "C" fn ssi_setup(cl: *mut hsi_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_flush(cl: *mut hsi_client) -> c_int {
...
// Stop all DMA transfers
    ...
    if (msg.ttype == HSI_MSG_READ)
    pm_runtime_put_autosuspend(omap_port.pdev);
    omap_ssi.gdd_trn[i].msg = core::ptr::null_mut();
    }
...
// Release write clocks
    ...
    pm_runtime_put_autosuspend(omap_port.pdev);
    ssi_flush_queue(&omap_port.txqueue[i], core::ptr::null_mut());
    ssi_flush_queue(&omap_port.rxqueue[i], core::ptr::null_mut());
    }
    ssi_flush_queue(&omap_port.brkqueue, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn start_tx_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn ssi_start_tx(cl: *mut hsi_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_stop_tx(cl: *mut hsi_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_cleanup_queues(cl: *mut hsi_client) {
    ...
    struct hsi_msg *msg;
    unsigned int i;
    let mut rxbufstate: u32 = 0;
    let mut txbufstate: u32 = 0;
    let mut status: u32 = SSI_ERROROCCURED;
    u32 tmp;
    ssi_flush_queue(&omap_port.brkqueue, cl);
...
#[no_mangle]
unsafe extern "C" fn ssi_cleanup_gdd(ssi: *mut hsi_controller, cl: *mut hsi_client) {
...
#[no_mangle]
unsafe extern "C" fn ssi_set_port_mode(omap_port: *mut omap_ssi_port, mode: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_release(cl: *mut hsi_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_error(port: *mut hsi_port) {
...
#[no_mangle]
unsafe extern "C" fn ssi_break_complete(port: *mut hsi_port) {
...
#[no_mangle]
unsafe extern "C" fn ssi_pio_complete(port: *mut hsi_port, queue: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn ssi_pio_thread(irq: c_int, ssi_port: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ssi_wake_thread(__maybe_unused: int irq, ssi_port: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn ssi_port_irq(port: *mut hsi_port, pd: *mut platform_device) -> c_int {
    ...
    return err;
    omap_port.irq = err;
    err = devm_request_threaded_irq(&port.device, omap_port.irq, core::ptr::null_mut(),
    ssi_pio_thread, IRQF_ONESHOT, "SSI PORT", port);
    return err;
    }
#[no_mangle]
unsafe extern "C" fn ssi_wake_irq(port: *mut hsi_port, pd: *mut platform_device) -> c_int {
    ...
    err = devm_request_threaded_irq(&port.device, cawake_irq, core::ptr::null_mut(),
    ssi_wake_thread,
...
#[no_mangle]
unsafe extern "C" fn ssi_queues_init(omap_port: *mut omap_ssi_port) {
...
#[no_mangle]
unsafe extern "C" fn ssi_port_probe(pd: *mut platform_device) -> c_int {
    ...
    struct omap_ssi_controller *omap_ssi = hsi_controller_drvdata(ssi);
    struct gpio_desc *cawake_gpio = core::ptr::null_mut();
    u32 port_id;
    int err;
...
#[no_mangle]
unsafe extern "C" fn ssi_port_remove(pd: *mut platform_device) {
    ...
    omap_ssi.port[omap_port.port_id] = core::ptr::null_mut();
    platform_set_drvdata(pd, core::ptr::null_mut());
    pm_runtime_dont_use_autosuspend(&pd.dev);
    pm_runtime_disable(&pd.dev);
    }
#[no_mangle]
unsafe extern "C" fn ssi_restore_divisor(omap_port: *mut omap_ssi_port) -> c_int {
    ...
    {
// update divisor
    let mut div: u32 = ssi_calculate_div(ssi);
    omap_port.sst.divisor = div;
    ssi_restore_divisor(omap_port);
    }

#[no_mangle]
unsafe extern "C" fn ssi_save_port_ctx(omap_port: *mut omap_ssi_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_restore_port_ctx(omap_port: *mut omap_ssi_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssi_restore_port_mode(omap_port: *mut omap_ssi_port) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_ssi_port_runtime_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omap_ssi_port_runtime_resume(dev: *mut device) -> c_int {
    ...
    omap_ssi_port_runtime_resume, core::ptr::null_mut())
    };
