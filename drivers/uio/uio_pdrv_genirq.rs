...
//! Source: drivers/uio/uio_pdrv_genirq.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uio_pdrv_genirq_platdata {
...
#[no_mangle]
unsafe extern "C" fn uio_pdrv_genirq_open(info: *mut uio_info, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uio_pdrv_genirq_release(info: *mut uio_info, inode: *mut inode) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uio_pdrv_genirq_handler(irq: c_int, dev_info: *mut uio_info) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn uio_pdrv_genirq_irqcontrol(dev_info: *mut uio_info, irq_on: i32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uio_pdrv_genirq_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn uio_pdrv_genirq_probe(pdev: *mut platform_device) -> c_int {
