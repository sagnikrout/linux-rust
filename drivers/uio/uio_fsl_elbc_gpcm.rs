...
//! Source: drivers/uio/uio_fsl_elbc_gpcm.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct fsl_elbc_gpcm {
    pub dev: *mut device,
    pub lbc: *mut fsl_lbc_regs __iomem,
    pub bank: u32,
    pub name: *const c_char,
    pub info): *mut *mut void (init)(struct uio_info,
    pub init_err): *mut *mut *mut void (shutdown)(struct uio_info info, bool,
    pub info): *mut *mut irqreturn_t (irq_handler)(int irq, struct uio_info,
}
...
pub const DPM_HOST_WIN0_OFFSET: c_uint = 0xff00;
pub const DPM_HOST_INT_STAT0: c_uint = 0xe0;
pub const DPM_HOST_INT_EN0: c_uint = 0xf0;
pub const DPM_HOST_INT_MASK: c_uint = 0xe600ffff;
pub const DPM_HOST_INT_GLOBAL_EN: c_uint = 0x80000000;
#[no_mangle]
unsafe extern "C" fn netx5152_irq_handler(irq: c_int, info: *mut uio_info) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn netx5152_init(info: *mut uio_info) {
    static void netx5152_init(struct uio_info *info)
    {
    let mut win0_offset: c_ulong = DPM_HOST_WIN0_OFFSET;
    struct fsl_elbc_gpcm *priv = info.priv;
    const void *prop;
// get an optional initial win0 offset
    prop = of_get_property(priv.dev.of_node,
    "netx5152,init-win0-offset", core::ptr::null_mut());
    if (prop)
...
#[no_mangle]
unsafe extern "C" fn netx5152_shutdown(info: *mut uio_info, init_err: bool) {
...
#[no_mangle]
unsafe extern "C" fn uio_fsl_elbc_gpcm_probe(pdev: *mut platform_device) -> c_int {
    static int uio_fsl_elbc_gpcm_probe(struct platform_device *pdev)
    {
    struct device_node *node = pdev.dev.of_node;
    struct fsl_elbc_gpcm *priv;
    struct uio_info *info;
    char *uio_name = core::ptr::null_mut();
    struct resource *res;
    void __iomem *base;
    unsigned int irq;
    u32 reg_br_cur;
...
#[no_mangle]
unsafe extern "C" fn uio_fsl_elbc_gpcm_remove(pdev: *mut platform_device) {
