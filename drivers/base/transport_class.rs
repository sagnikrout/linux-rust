...
//! Source: drivers/base/transport_class.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_class_register(tclass: *mut transport_class) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_class_unregister(tclass: *mut transport_class) {
...
//
#[no_mangle]
pub unsafe extern "C" fn anon_transport_class_register(atc: *mut anon_transport_class) {
...
//
#[no_mangle]
pub unsafe extern "C" fn anon_transport_class_unregister(atc: *mut anon_transport_class) {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_setup_device(dev: *mut device) {
    ...
    {
    struct transport_class *tclass = class_to_transport_class(cont.class);
    let mut error: c_int = attribute_container_add_class_device(classdev);
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_add_device(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_configure_device(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_remove_device(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn transport_destroy_device(dev: *mut device) {
