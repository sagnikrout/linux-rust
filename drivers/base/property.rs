...
//! Source: drivers/base/property.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn device_property_present(dev: *const device, propname: *const c_char) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_property_read_bool(dev: *const device, propname: *const c_char) -> bool {
...
//
    ...
    const char *propname, const char **val)
    {
    let mut ret: c_int = fwnode_property_read_string_array(fwnode, propname, val, 1);
    return ret < 0 ? ret : 0;
    }
...
//
    ...
    struct fwnode_reference_args args;
    int ret;
    ret = fwnode_property_get_reference_args(fwnode, name, core::ptr::null_mut(), 0, index,
    &args);
...
//
#[no_mangle]
pub unsafe extern "C" fn fwnode_name_eq(fwnode: *const fwnode_handle, name: *const c_char) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fwnode_count_parents(fwnode: *const fwnode_handle) -> c_uint {
...
//
    ...
    struct fwnode_handle *child_parent __free(fwnode_handle) = core::ptr::null_mut();
...
// When no more children in primary, continue with secondary
    return fwnode_get_next_child_node(parent.secondary, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn fwnode_device_is_available(fwnode: *const fwnode_handle) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn fwnode_get_child_node_count(fwnode: *const fwnode_handle) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn device_dma_supported(dev: *const device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn device_get_dma_attr(dev: *const device) -> enum dev_dma_attr {
...
//
#[no_mangle]
pub unsafe extern "C" fn fwnode_get_phy_mode(fwnode: *const fwnode_handle) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_get_phy_mode(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fwnode_irq_get(fwnode: *const fwnode_handle, index: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn fwnode_irq_get_byname(fwnode: *const fwnode_handle, name: *const c_char) -> c_int {
...
//
    ...
    {
    const struct fwnode_handle *parent;
    struct fwnode_handle *port_parent __free(fwnode_handle) = core::ptr::null_mut();
...
//
    ...
    if (ep)
    return ep;
    return fwnode_graph_get_next_endpoint(parent.secondary, core::ptr::null_mut());
    }
...
#[no_mangle]
unsafe extern "C" fn fwnode_graph_remote_available(ep: *mut fwnode_handle) -> bool {
...
//
    ...
    {
    struct fwnode_handle *ep, *best_ep = core::ptr::null_mut();
    let mut best_ep_id: c_uint = 0;
    let mut endpoint_next: bool = flags & FWNODE_GRAPH_ENDPOINT_NEXT;
    let mut enabled_only: bool = !(flags & FWNODE_GRAPH_DEVICE_DISABLED);
    fwnode_graph_for_each_endpoint(fwnode, ep) {
    let mut fwnode_ep: fwnode_endpoint = { 0 };
    int ret;
...
//
    ...
    if (IS_ERR(node))
    break;
    ret = match(node, core::ptr::null_mut(), data);
    fwnode_handle_put(node);
    if (ret) {
    if (matches)
    matches[count] = ret;
...
//
    ...
    return count ? ret : core::ptr::null_mut();
    }
