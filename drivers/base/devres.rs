...
//
    pub data: [u8 __aligned(ARCH_DMA_MINALIGN); ],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct devres_group {
...
#[no_mangle]
pub unsafe extern "C" fn free_node(node: *mut devres_node) {
    ...
    let mut log_devres: static int = 0;
...
//
#[no_mangle]
unsafe extern "C" fn group_open_release(dev: *mut device, node: *mut devres_node) {
    static void group_open_release(struct device *dev, struct devres_node *node)
    {
// noop
    }
#[no_mangle]
unsafe extern "C" fn group_close_release(dev: *mut device, node: *mut devres_node) {
...
#[no_mangle]
unsafe extern "C" fn check_dr_size(size: usize, tot_size: *mut usize) -> bool {
...
#[no_mangle]
unsafe extern "C" fn dr_node_release(dev: *mut device, node: *mut devres_node) {
...
#[no_mangle]
unsafe extern "C" fn dr_node_free(node: *mut devres_node) {
...
#[no_mangle]
unsafe extern "C" fn add_dr(dev: *mut device, node: *mut devres_node) {
...
#[no_mangle]
pub unsafe extern "C" fn free_dr(dr: *mut devres) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devres_free(res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devres_add(dev: *mut device, res: *mut c_void) {
...
//
    ...
    let mut cnt: c_int = 0, nr_groups = 0;
...
#[no_mangle]
unsafe extern "C" fn release_nodes(dev: *mut device, todo: *mut list_head) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devres_release_all(dev: *mut device) -> c_int {
...
// Looks like an uninitialized device structure
    if (WARN_ON(dev.devres_head.next == core::ptr::null_mut()))
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn devres_group_free(node: *mut devres_node) {
...
//
    ...
    devres_node_init(&grp.node[1], &group_close_release, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn devres_close_group(dev: *mut device, id: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devres_remove_group(dev: *mut device, id: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devres_release_group(dev: *mut device, id: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct action_devres {
    pub data: *mut c_void,
    pub ): *mut *mut void (action)(void,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct devres_action {
    pub node: devres_node,
    pub action: action_devres,
}

#[no_mangle]
unsafe extern "C" fn devm_action_match(devres: *mut devres_action, target: *mut action_devres) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_action_release(dev: *mut device, node: *mut devres_node) {
...
#[no_mangle]
unsafe extern "C" fn devm_action_free(node: *mut devres_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn __devm_add_action(dev: *mut device, ): *mut *mut void (action)(void, data: *mut c_void, name: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn devm_is_action_added(dev: *mut device, ): *mut *mut void (action)(void, data: *mut c_void) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_release_action(dev: *mut device, ): *mut *mut void (action)(void, data: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn devm_kmalloc_release(dev: *mut device, res: *mut c_void) {
    static void devm_kmalloc_release(struct device *dev, void *res)
    {
// noop
    }
#[no_mangle]
unsafe extern "C" fn devm_kmalloc_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
    static int devm_kmalloc_match(struct device *dev, void *res, void *data)
    {
    let mut res: return = = data;
    }
//
...
//
    ...
    va_list aq;
    va_copy(aq, ap);
    len = vsnprintf(core::ptr::null_mut(), 0, fmt, aq);
    va_end(aq);
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_kfree(dev: *mut device, p: *const c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct pages_devres {
    pub addr: c_ulong,
    pub order: c_uint,
}

#[no_mangle]
unsafe extern "C" fn devm_pages_match(dev: *mut device, res: *mut c_void, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_pages_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_free_pages(dev: *mut device, addr: c_ulong) {
    void devm_free_pages(struct device *dev, unsigned long addr)
    {
    let mut devres: pages_devres = { .addr = addr };
    WARN_ON(devres_release(dev, devm_pages_release, devm_pages_match,
    &devres));
    }
    EXPORT_SYMBOL_GPL(devm_free_pages);
#[no_mangle]
unsafe extern "C" fn devm_percpu_release(dev: *mut device, pdata: *mut c_void) {
