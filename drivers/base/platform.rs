...
//! Source: drivers/base/platform.c
#![no_std]
...
//
    ...
    unsigned int index)
    {
    return devm_platform_get_and_ioremap_resource(pdev, index, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_get_irq_optional(dev: *mut platform_device, num: c_uint) -> c_int {
    int platform_get_irq_optional(struct platform_device *dev, unsigned int num)
    {
    return platform_get_irq_affinity(dev, num, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_get_irq(dev: *mut platform_device, num: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_irq_count(dev: *mut platform_device) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct irq_affinity_devres {
    pub count: c_uint,
    pub __counted_by(count): unsigned int irq[],
}

#[no_mangle]
unsafe extern "C" fn platform_disable_acpi_irq(pdev: *mut platform_device, index: c_int) {
...
//
    ...
    ptr.count = nvec;
    for (i = 0; i < nvec; i++) {
    let mut irq: c_int = platform_get_irq(dev, i);
    if (irq < 0) {
    ret = irq;
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_get_irq_byname(dev: *mut platform_device, name: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_add_devices(devs: *mut platform_device, num: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn setup_pdev_dma_masks(pdev: *mut platform_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_device_put(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn platform_device_release(dev: *mut device) {
...
//
    ...
    return pa ? &pa.pdev : core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_device_add(pdev: *mut platform_device) -> c_int {
...
//
    ...
    p = &iomem_resource;
#[no_mangle]
pub unsafe extern "C" fn if(IORESOURCE_IO: resource_type(r) ==) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_device_del(pdev: *mut platform_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_device_register(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_device_unregister(pdev: *mut platform_device) {
...
//
    ...
    pdevinfo.properties, core::ptr::null_mut());
    if (ret)
    goto err;
    }
    ...
    if (ret) {
    err:
    ACPI_COMPANION_SET(&pdev.dev, core::ptr::null_mut());
    platform_device_put(pdev);
    return ERR_PTR(ret);
    }
    return pdev;
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_driver_unregister(drv: *mut platform_driver) {
...
#[no_mangle]
unsafe extern "C" fn platform_probe_fail(pdev: *mut platform_device) -> c_int {
    static int platform_probe_fail(struct platform_device *pdev)
    {
    return -ENXIO;
    }
#[no_mangle]
unsafe extern "C" fn is_bound_to_driver(dev: *mut device, driver: *mut c_void) -> c_int {
...
//
    if (!bus_for_each_dev(&platform_bus_type, core::ptr::null_mut(), &drv.driver, is_bound_to_driver)) {
    retval = -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn platform_legacy_suspend(dev: *mut device, mesg: pm_message_t) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn platform_legacy_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn platform_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn platform_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn platform_pm_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn platform_pm_thaw(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn platform_pm_poweroff(dev: *mut device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn platform_pm_restore(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn platform_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
// Then try to match against the id table
    if (pdrv.id_table)
    return platform_match_id(pdrv.id_table, pdev) != core::ptr::null_mut();
// fall-back to driver name match
    return (strcmp(pdev.name, drv.name) == 0);
    }
#[no_mangle]
unsafe extern "C" fn platform_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn platform_probe(_dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn platform_remove(_dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn platform_shutdown(_dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn platform_dma_configure(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn platform_dma_cleanup(dev: *mut device) {
    ...
    SET_RUNTIME_PM_OPS(pm_generic_runtime_suspend, pm_generic_runtime_resume, core::ptr::null_mut())
...
#[no_mangle]
pub unsafe extern "C" fn __platform_match(dev: *mut device, drv: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn platform_bus_init() -> int __init {
