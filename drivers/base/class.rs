...
#[no_mangle]
unsafe extern "C" fn class_release(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn klist_class_dev_get(n: *mut klist_node) {
...
#[no_mangle]
unsafe extern "C" fn klist_class_dev_put(n: *mut klist_node) {
...
#[no_mangle]
pub unsafe extern "C" fn class_register(cls: *const class) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn class_unregister(cls: *const class) {
...
#[no_mangle]
unsafe extern "C" fn class_create_release(cls: *const class) {
...
//
#[no_mangle]
pub unsafe extern "C" fn class_destroy(cls: *const class) {
...
//
#[no_mangle]
pub unsafe extern "C" fn class_dev_iter_exit(iter: *mut class_dev_iter) {
...
//
    ...
    class_dev_iter_init(&iter, class, start, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn class_interface_register(class_intf: *mut class_interface) -> c_int {
...
//
    ...
    class_dev_iter_init(&iter, parent, core::ptr::null_mut(), core::ptr::null_mut());
    while ((dev = class_dev_iter_next(&iter)))
...
#[no_mangle]
pub unsafe extern "C" fn class_interface_unregister(class_intf: *mut class_interface) {
...
//
#[no_mangle]
pub unsafe extern "C" fn class_compat_unregister(cls: *mut class_compat) {
...
//
#[no_mangle]
pub unsafe extern "C" fn class_compat_create_link(cls: *mut class_compat, dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn class_compat_remove_link(cls: *mut class_compat, dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn class_is_registered(class: *const class) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn classes_init() -> int __init {
    int __init classes_init(void)
    {
    class_kset = kset_create_and_add("class", core::ptr::null_mut(), core::ptr::null_mut());
    if (!class_kset)
    return -ENOMEM;
    return 0;
    }
