...
#[no_mangle]
pub unsafe extern "C" fn mhp_online_type_from_str(str: *const c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn register_memory_notifier(nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn unregister_memory_notifier(nb: *mut notifier_block) {
...
#[no_mangle]
unsafe extern "C" fn memory_block_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn memory_block_advise_max_size(size: c_ulong) -> int __init {
...
//
#[no_mangle]
pub unsafe extern "C" fn memory_block_advised_max_size() -> c_ulong {
...
#[no_mangle]
pub unsafe extern "C" fn memory_block_size_bytes() -> unsigned long __weak {
...
#[no_mangle]
pub unsafe extern "C" fn memory_notify(state: enum memory_block_state, v: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn memblk_nr_poison(mem: *mut memory_block) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn memory_block_online(mem: *mut memory_block) -> c_int {
    static int memory_block_online(struct memory_block *mem)
    {
    let mut start_pfn: c_ulong = section_nr_to_pfn(mem.start_section_nr);
    let mut nr_pages: c_ulong = PAGES_PER_SECTION * sections_per_block;
    let mut nr_vmemmap_pages: c_ulong = 0;
    struct zone *zone;
    int ret;
...
//
#[no_mangle]
unsafe extern "C" fn memory_block_offline(mem: *mut memory_block) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn memory_subsys_online(dev: *mut device) -> c_int {
    static int memory_subsys_online(struct device *dev)
    {
    struct memory_block *mem = to_memory_block(dev);
    int ret;
...
#[no_mangle]
unsafe extern "C" fn memory_subsys_offline(dev: *mut device) -> c_int {
    static int memory_subsys_offline(struct device *dev)
    {
    struct memory_block *mem = to_memory_block(dev);
    ...
    {
    let mut online_type: c_int = mhp_online_type_from_str(buf);
    struct memory_block *mem = to_memory_block(dev);
    int ret;
    if (online_type < 0)
    return -EINVAL;
...
//
    ...
    u64 phys_addr;
    int nid, ret;
    let mut pages_per_block: c_ulong = PAGES_PER_SECTION * sections_per_block;
...
#[no_mangle]
pub unsafe extern "C" fn arch_get_memory_phys_device(start_pfn: c_ulong) -> int __weak {
...
#[no_mangle]
unsafe extern "C" fn __add_memory_block(memory: *mut memory_block) -> c_int {
    ...
    let mut start_pfn: c_ulong = section_nr_to_pfn(mem.start_section_nr);
    let mut nr_pages: c_ulong = PAGES_PER_SECTION * sections_per_block;
    struct zone *zone, *matching_zone = core::ptr::null_mut();
...
// Spans multiple zones ...
    matching_zone = core::ptr::null_mut();
    break;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn memory_block_add_nid_early(mem: *mut memory_block, nid: c_int) {
...
#[no_mangle]
unsafe extern "C" fn remove_memory_block(memory: *mut memory_block) {
    static void remove_memory_block(struct memory_block *memory)
    {
    if (WARN_ON_ONCE(memory.dev.bus != &memory_subsys))
    return;
    WARN_ON(xa_erase(&memory_blocks, memory.dev.id) == core::ptr::null_mut());
    if (memory.group) {
    list_del(&memory.group_next);
    memory.group = core::ptr::null_mut();
    }
...
//
    ...
    struct memory_group *group)
    {
    let mut start_block_id: c_ulong = pfn_to_block_id(PFN_DOWN(start));
    let mut end_block_id: c_ulong = pfn_to_block_id(PFN_DOWN(start + size));
    struct memory_block *mem;
...
//
#[no_mangle]
pub unsafe extern "C" fn remove_memory_block_devices(start: c_ulong, size: c_ulong) {
...
//
#[no_mangle]
pub unsafe extern "C" fn memory_dev_init() -> void __init {
...
//
    ...
    ret = add_memory_block(block_id, NUMA_NO_NODE, MEM_ONLINE, core::ptr::null_mut(), core::ptr::null_mut());
    if (ret) {
...
//
    ...
    {
    let mut start_block_id: c_ulong = phys_to_block_id(start);
    let mut end_block_id: c_ulong = phys_to_block_id(start + size - 1);
    struct memory_block *mem;
    unsigned long block_id;
    let mut ret: c_int = 0;
    if (!size)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct for_each_memory_block_cb_data {
    pub func: walk_memory_blocks_func_t,
    pub arg: *mut c_void,
}

#[no_mangle]
unsafe extern "C" fn for_each_memory_block_cb(dev: *mut device, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn for_each_memory_block(arg: *mut c_void, func: walk_memory_blocks_func_t) -> c_int {
    ...
    return bus_for_each_dev(&memory_subsys, core::ptr::null_mut(), &cb_data,
...
//
#[no_mangle]
unsafe extern "C" fn memory_group_register(group: memory_group) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn memory_group_register_static(nid: c_int, max_pages: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn memory_group_register_dynamic(nid: c_int, unit_pages: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn memory_group_unregister(mgid: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn memblk_nr_poison_inc(pfn: c_ulong) {
    void memblk_nr_poison_inc(unsigned long pfn)
    {
    let mut block_id: c_ulong = pfn_to_block_id(pfn);
...
#[no_mangle]
pub unsafe extern "C" fn memblk_nr_poison_sub(pfn: c_ulong, i: c_long) {
...
#[no_mangle]
unsafe extern "C" fn memblk_nr_poison(mem: *mut memory_block) -> c_ulong {
    static unsigned long memblk_nr_poison(struct memory_block *mem)
    {
