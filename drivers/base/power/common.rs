...
//! Source: drivers/base/power/common.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_get_subsys_data(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_put_subsys_data(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_domain_attach(dev: *mut device, flags: u32) -> c_int {
...
//
    ...
    struct device *pd_dev = core::ptr::null_mut();
    int ret, i, num_pds = 0;
    let mut by_id: bool = true;
    size_t size;
    let mut pd_flags: u32 = data ? data.pd_flags : 0;
...
//
#[no_mangle]
unsafe extern "C" fn devm_pm_domain_detach_list(_list: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_domain_detach(dev: *mut device, power_off: bool) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_domain_detach_list(list: *mut dev_pm_domain_list) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_domain_start(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_domain_set(dev: *mut device, pd: *mut dev_pm_domain) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_domain_set_performance_state(dev: *mut device, state: c_uint) -> c_int {
