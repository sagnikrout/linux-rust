...
//! Source: drivers/base/power/wakeirq.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn dev_pm_attach_wake_irq(dev: *mut device, wirq: *mut wake_irq) -> c_int {
...
pub unsafe extern "C" fn dev_pm_clear_wake_irq(dev: *mut device) {
    ...
    dev.power.wakeirq = core::ptr::null_mut();
    spin_unlock_irqrestore(&dev.power.lock, flags);
...
#[no_mangle]
unsafe extern "C" fn devm_pm_clear_wake_irq(dev: *mut c_void) {
...
//
#[no_mangle]
unsafe extern "C" fn handle_threaded_wake_irq(irq: c_int, _wirq: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn __dev_pm_set_dedicated_wake_irq(dev: *mut device, irq: c_int, flag: c_uint) -> c_int {
...
//
    err = request_threaded_irq(irq, core::ptr::null_mut(), handle_threaded_wake_irq,
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_set_dedicated_wake_irq(dev: *mut device, irq: c_int) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_pm_set_dedicated_wake_irq_reverse(dev: *mut device, irq: c_int) -> c_int {
