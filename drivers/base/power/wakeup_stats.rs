...
//! Source: drivers/base/power/wakeup_stats.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn wakeup_source_sysfs_add(parent: *mut device, ws: *mut wakeup_source) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn pm_wakeup_source_sysfs_add(parent: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wakeup_source_sysfs_remove(ws: *mut wakeup_source) {
    void wakeup_source_sysfs_remove(struct wakeup_source *ws)
    {
    device_unregister(ws.dev);
    }
#[no_mangle]
unsafe extern "C" fn wakeup_sources_sysfs_init() -> int __init {
