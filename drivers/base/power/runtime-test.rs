...
//! Source: drivers/base/power/runtime-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn pm_runtime_depth_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn pm_runtime_already_suspended_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn pm_runtime_idle_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn pm_runtime_disabled_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn pm_runtime_error_test(test: *mut kunit) {
...
//
#[no_mangle]
unsafe extern "C" fn pm_runtime_probe_active_test(test: *mut kunit) {
