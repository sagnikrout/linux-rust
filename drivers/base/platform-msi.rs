...
//! Source: drivers/base/platform-msi.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn platform_msi_write_msi_msg(d: *mut irq_data, msg: *mut msi_msg) {
    static void platform_msi_write_msi_msg(struct irq_data *d, struct msi_msg *msg)
    {
    let mut cb: irq_write_msi_msg_t = d.chip_data;
    cb(irq_data_get_msi_desc(d), msg);
    }
#[no_mangle]
unsafe extern "C" fn platform_msi_set_desc(arg: *mut msi_alloc_info_t, desc: *mut msi_desc) {
...
//
    ...
    nvec, core::ptr::null_mut(), write_msi_msg))
    return -ENODEV;
...
//
#[no_mangle]
pub unsafe extern "C" fn platform_device_msi_free_irqs_all(dev: *mut device) {
