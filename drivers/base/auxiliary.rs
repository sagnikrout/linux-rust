...
//! Source: drivers/base/auxiliary.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn auxiliary_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn auxiliary_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn auxiliary_bus_probe(dev: *mut device) -> c_int {
...
unsafe extern "C" fn auxiliary_bus_shutdown(dev: *mut device) {
    ...
    {
    const struct auxiliary_driver *auxdrv = core::ptr::null_mut();
    struct auxiliary_device *auxdev;
    if (dev.driver) {
...
//
#[no_mangle]
pub unsafe extern "C" fn auxiliary_device_init(auxdev: *mut auxiliary_device) -> c_int {
    int auxiliary_device_init(struct auxiliary_device *auxdev)
    {
    struct device *dev = &auxdev.dev;
    if (!dev.parent) {
    pr_err("auxiliary_device has a core::ptr::null_mut() dev.parent\n");
    return -EINVAL;
    }
    if (!auxdev.name) {
    pr_err("auxiliary_device has a core::ptr::null_mut() name\n");
    return -EINVAL;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn __auxiliary_device_add(auxdev: *mut auxiliary_device, modname: *const c_char) -> c_int {
    int __auxiliary_device_add(struct auxiliary_device *auxdev, const char *modname)
    {
    struct device *dev = &auxdev.dev;
    int ret;
    if (!modname) {
    dev_err(dev, "auxiliary device modname is core::ptr::null_mut()\n");
    return -EINVAL;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn auxiliary_driver_unregister(auxdrv: *mut auxiliary_driver) {
...
//
#[no_mangle]
pub unsafe extern "C" fn auxiliary_device_destroy(auxdev: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_is_auxiliary(dev: *mut device) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn auxiliary_bus_init() -> void __init {
