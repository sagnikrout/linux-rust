...
//! Source: drivers/base/firmware_loader/builtin/main.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn firmware_request_builtin(fw: *mut firmware, name: *const c_char) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn firmware_is_builtin(fw: *const firmware) -> bool {
