...
//! Source: drivers/base/test/swnode-devlink-test.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn swnode_count_suppliers(fwnode: *mut fwnode_handle) -> c_int {
...
// True if a supplier link con->sup exists, checked from both list ends.
    ...
    {
    let mut from_con: bool = false, from_sup = false;
    struct fwnode_link *link;
...
#[no_mangle]
unsafe extern "C" fn swnode_devlink_test_single_ref(test: *mut kunit) {
    ...
    cons_fwnode = kunit_fwnode_create_software_node(test, props, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn swnode_devlink_test_multiple_refs(test: *mut kunit) {
    ...
    &supp1_swnode, &supp2_swnode, core::ptr::null_mut()
    };
    const struct property_entry props[] = {
    ...
    fwnode = kunit_fwnode_create_software_node(test, props, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn swnode_devlink_test_unregistered_ref(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn swnode_devlink_test_remote_endpoint_excluded(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn swnode_devlink_test_ref_array(test: *mut kunit) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct swnode_test_probe_order {
// Names in the order their drivers' .probe ran.
    pub probed: [*const c_char; 2],
    pub count: c_uint,
    pub wq: wait_queue_head_t,
}

#[no_mangle]
unsafe extern "C" fn swnode_test_record_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn swnode_devlink_test_probe_order(test: *mut kunit) {
    ...
    consumer_props, core::ptr::null_mut());
    KUNIT_ASSERT_EQ(test, ret, 0);
