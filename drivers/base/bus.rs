...
#[no_mangle]
unsafe extern "C" fn bus_put(bus: *const bus_type) {
...
#[no_mangle]
unsafe extern "C" fn driver_release(kobj: *mut kobject) {
...
#[no_mangle]
pub unsafe extern "C" fn bus_create_file(bus: *const bus_type, attr: *mut bus_attribute) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bus_remove_file(bus: *const bus_type, attr: *mut bus_attribute) {
...
#[no_mangle]
unsafe extern "C" fn bus_release(kobj: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn bus_uevent_filter(kobj: *const kobject) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn drivers_autoprobe_show(bus: *const bus_type, buf: *mut c_char) -> isize {
    ...
    if (!dev)
    return -ENODEV;
    if (bus_rescan_devices_helper(dev, core::ptr::null_mut()) == 0)
    err = count;
    put_device(dev);
    return err;
    }
...
//
    ...
    (start ? &start.p.knode_bus : core::ptr::null_mut()));
...
#[no_mangle]
unsafe extern "C" fn add_bind_files(drv: *mut device_driver) -> int __must_check {
...
#[no_mangle]
unsafe extern "C" fn remove_bind_files(drv: *mut device_driver) {
...
#[no_mangle]
unsafe extern "C" fn add_probe_files(bus: *const bus_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_probe_files(bus: *const bus_type) {
...
//
    ...
    klist_init(&priv.klist_devices, core::ptr::null_mut(), core::ptr::null_mut());
    priv.driver = drv;
    drv.p = priv;
    priv.kobj.kset = sp.drivers_kset;
    error = kobject_init_and_add(&priv.kobj, &driver_ktype, core::ptr::null_mut(),
    "%s", drv.name);
    if (error)
    goto out_unregister;
...
pub unsafe extern "C" fn bus_rescan_devices(bus: *const bus_type) -> c_int {
    ...
    {
    return bus_for_each_dev(bus, core::ptr::null_mut(), core::ptr::null_mut(), bus_rescan_devices_helper);
    }
...
pub unsafe extern "C" fn device_reprobe(dev: *mut device) -> c_int {
    ...
    if (dev.driver)
    device_driver_detach(dev);
    return bus_rescan_devices_helper(dev, core::ptr::null_mut());
    }
    EXPORT_SYMBOL_GPL(device_reprobe);
#[no_mangle]
unsafe extern "C" fn klist_devices_get(n: *mut klist_node) {
...
#[no_mangle]
unsafe extern "C" fn klist_devices_put(n: *mut klist_node) {
...
// function name.
//
    static struct bus_attribute bus_attr_uevent = __ATTR(uevent, 0200, core::ptr::null_mut(),
    bus_uevent_store);
//
...
//
#[no_mangle]
pub unsafe extern "C" fn bus_register(bus: *const bus_type) -> c_int {
    ...
    priv.devices_kset = kset_create_and_add("devices", core::ptr::null_mut(), bus_kobj);
    if (!priv.devices_kset) {
    retval = -ENOMEM;
    goto bus_devices_fail;
    }
    priv.drivers_kset = kset_create_and_add("drivers", core::ptr::null_mut(), bus_kobj);
    ...
    klist_init(&priv.klist_drivers, core::ptr::null_mut(), core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn bus_unregister(bus: *const bus_type) {
...
#[no_mangle]
pub unsafe extern "C" fn bus_register_notifier(bus: *const bus_type, nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bus_unregister_notifier(bus: *const bus_type, nb: *mut notifier_block) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn bus_notify(dev: *mut device, value: enum bus_notifier_event) {
...
//
    ...
    {
    struct klist_node *start_knode = core::ptr::null_mut();
    if (start)
...
//
#[no_mangle]
unsafe extern "C" fn subsys_dev_iter_exit(iter: *mut subsys_dev_iter) {
    static void subsys_dev_iter_exit(struct subsys_dev_iter *iter)
    {
    klist_iter_exit(&iter.ki);
    }
#[no_mangle]
pub unsafe extern "C" fn subsys_interface_register(sif: *mut subsys_interface) -> c_int {
...
//
    ...
    if (sif.add_dev) {
    subsys_dev_iter_init(&iter, sp, core::ptr::null_mut(), core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn subsys_interface_unregister(sif: *mut subsys_interface) {
...
#[no_mangle]
unsafe extern "C" fn system_root_device_release(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn buses_init() -> int __init {
    int __init buses_init(void)
    {
    bus_kset = kset_create_and_add("bus", &bus_uevent_ops, core::ptr::null_mut());
    if (!bus_kset)
    return -ENOMEM;
    system_kset = kset_create_and_add("system", core::ptr::null_mut(), &devices_kset.kobj);
    if (!system_kset) {
// Do error handling here as devices_init() do
    kset_unregister(bus_kset);
    bus_kset = core::ptr::null_mut();
