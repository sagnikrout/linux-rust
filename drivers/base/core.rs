...
// Device links support.
    ...
    let mut defer_sync_state_count: static unsigned int = 1;
...
//
#[no_mangle]
unsafe extern "C" fn __fwnode_link_del(link: *mut fwnode_link) {
...
//
#[no_mangle]
unsafe extern "C" fn __fwnode_link_cycle(link: *mut fwnode_link) {
...
//
#[no_mangle]
unsafe extern "C" fn fwnode_links_purge_suppliers(fwnode: *mut fwnode_handle) {
...
//
#[no_mangle]
unsafe extern "C" fn fwnode_links_purge_consumers(fwnode: *mut fwnode_handle) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fwnode_links_purge(fwnode: *mut fwnode_handle) {
...
#[no_mangle]
pub unsafe extern "C" fn fw_devlink_purge_absent_suppliers(fwnode: *mut fwnode_handle) {
...
#[no_mangle]
unsafe extern "C" fn fw_devlink_pickup_dangling_consumers(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn fw_devlink_refresh_fwnode(fwnode: *mut fwnode_handle) {
...
#[no_mangle]
pub unsafe extern "C" fn device_links_write_lock() {
    static inline void device_links_write_lock(void)
    {
    mutex_lock(&device_links_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn device_links_write_unlock() {
    static inline void device_links_write_unlock(void)
    {
    mutex_unlock(&device_links_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn device_links_read_lock(__acquires(&device_links_srcu: void)) -> c_int {
    int device_links_read_lock(void) __acquires(&device_links_srcu)
    {
    return srcu_read_lock(&device_links_srcu);
    }
#[no_mangle]
pub unsafe extern "C" fn device_links_read_unlock(__releases(&device_links_srcu: int idx)) {
    void device_links_read_unlock(int idx) __releases(&device_links_srcu)
    {
    srcu_read_unlock(&device_links_srcu, idx);
    }
#[no_mangle]
pub unsafe extern "C" fn device_links_read_lock_held() -> c_int {
    int device_links_read_lock_held(void)
    {
    return srcu_read_lock_held(&device_links_srcu);
    }
#[no_mangle]
unsafe extern "C" fn device_link_synchronize_removal() {
    static void device_link_synchronize_removal(void)
    {
    synchronize_srcu(&device_links_srcu);
    }
#[no_mangle]
unsafe extern "C" fn device_link_remove_from_lists(link: *mut device_link) {
...
#[no_mangle]
unsafe extern "C" fn device_is_ancestor(dev: *mut device, target: *mut device) -> bool {
    ...
    DL_FLAG_MANAGED)
#[no_mangle]
pub unsafe extern "C" fn device_link_flag_is_sync_state_only(flags: u32) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn device_is_dependent(dev: *mut device, target: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_reorder_to_tail(dev: *mut device, not_used: *mut c_void) -> c_int {
...
//
    ...
    device_for_each_child(dev, core::ptr::null_mut(), device_reorder_to_tail);
    list_for_each_entry(link, &dev.links.consumers, s_node) {
    if (device_link_flag_is_sync_state_only(link.flags))
    continue;
    device_reorder_to_tail(link.consumer, core::ptr::null_mut());
    }
    return 0;
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn device_pm_move_to_tail(dev: *mut device) {
    void device_pm_move_to_tail(struct device *dev)
    {
    int idx;
    idx = device_links_read_lock();
    device_pm_lock();
    device_reorder_to_tail(dev, core::ptr::null_mut());
    device_pm_unlock();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: device_link_test(link, _arg: DL_FLAG_AUTOREMOVE_CONSUMER)) -> else {
...
#[no_mangle]
unsafe extern "C" fn device_link_release_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn devlink_dev_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_link_wait_removal() {
...
#[no_mangle]
unsafe extern "C" fn devlink_add_symlinks(dev: *mut device) -> c_int {
    static int devlink_add_symlinks(struct device *dev)
    {
    char *buf_con __free(kfree) = core::ptr::null_mut(), *buf_sup __free(kfree) = core::ptr::null_mut();
    int ret;
    struct device_link *link = to_devlink(dev);
...
#[no_mangle]
unsafe extern "C" fn devlink_remove_symlinks(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn devlink_class_init() -> int __init {
...
//
    device_reorder_to_tail(consumer, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn __device_link_del(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn device_link_put_kref(link: *mut device_link) {
    static void device_link_put_kref(struct device_link *link)
    {
    if (device_link_test(link, DL_FLAG_STATELESS))
    kref_put(&link.kref, __device_link_del);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !device_is_registered(link->consumer)) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_link_del(link: *mut device_link) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_link_remove(consumer: *mut c_void, supplier: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn device_links_missing_supplier(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn dev_is_best_effort(dev: *mut device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_links_check_suppliers(dev: *mut device) -> c_int {
    int device_links_check_suppliers(struct device *dev)
    {
    struct device_link *link;
    let mut ret: c_int = 0, fwnode_ret = 0;
...
#[no_mangle]
pub unsafe extern "C" fn device_links_supplier_sync_state_pause() {
...
#[no_mangle]
pub unsafe extern "C" fn device_links_supplier_sync_state_resume() {
...
//
    ...
    out:
    device_links_write_unlock();
    device_links_flush_sync_list(&sync_list, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn sync_state_resume_initcall() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __device_links_supplier_defer_sync(sup: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn device_link_drop_managed(link: *mut device_link) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_links_force_bind(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_links_driver_bound(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn __device_links_no_driver(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_links_no_driver(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_links_driver_cleanup(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_links_busy(dev: *mut device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_links_unbind_consumers(dev: *mut device) {
    ...
    get_device(consumer);
    device_links_write_unlock();
    device_release_driver_internal(consumer, core::ptr::null_mut(),
    consumer.parent);
    put_device(consumer);
    goto start;
    }
...
//
#[no_mangle]
unsafe extern "C" fn device_links_purge(dev: *mut device) {
...
//
    ...
    DL_FLAG_PM_RUNTIME)
    let mut fw_devlink_flags: static u32 = FW_DEVLINK_FLAGS_RPM;
#[no_mangle]
unsafe extern "C" fn fw_devlink_setup(arg: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn fw_devlink_strict_setup(arg: *mut c_char) -> int __init {
    static int __init fw_devlink_strict_setup(char *arg)
    {
    return kstrtobool(arg, &fw_devlink_strict);
    }
    early_param("fw_devlink.strict", fw_devlink_strict_setup);
pub const FW_DEVLINK_SYNC_STATE_STRICT: c_int = 0;
pub const FW_DEVLINK_SYNC_STATE_TIMEOUT: c_int = 1;

    static int fw_devlink_sync_state;

    let mut fw_devlink_sync_state: static int = FW_DEVLINK_SYNC_STATE_TIMEOUT;

#[no_mangle]
unsafe extern "C" fn fw_devlink_sync_state_setup(arg: *mut c_char) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn fw_devlink_get_flags(fwlink_flags: u8) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn fw_devlink_is_permissive() -> bool {
    static bool fw_devlink_is_permissive(void)
    {
    let mut fw_devlink_flags: return = = FW_DEVLINK_FLAGS_PERMISSIVE;
    }
#[no_mangle]
pub unsafe extern "C" fn fw_devlink_is_strict() -> bool {
    bool fw_devlink_is_strict(void)
    {
    return fw_devlink_strict && !fw_devlink_is_permissive();
    }
#[no_mangle]
unsafe extern "C" fn fw_devlink_parse_fwnode(fwnode: *mut fwnode_handle) {
...
#[no_mangle]
unsafe extern "C" fn fw_devlink_parse_fwtree(fwnode: *mut fwnode_handle) {
...
#[no_mangle]
unsafe extern "C" fn fw_devlink_relax_link(link: *mut device_link) {
...
#[no_mangle]
unsafe extern "C" fn fw_devlink_no_driver(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fw_devlink_drivers_done() {
    void fw_devlink_drivers_done(void)
    {
    fw_devlink_drv_reg_done = true;
    device_links_write_lock();
    class_for_each_device(&devlink_class, core::ptr::null_mut(), core::ptr::null_mut(),
    fw_devlink_no_driver);
    device_links_write_unlock();
    }
#[no_mangle]
unsafe extern "C" fn fw_devlink_dev_sync_state(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fw_devlink_probing_done() {
    void fw_devlink_probing_done(void)
    {
    LIST_HEAD(sync_list);
    device_links_write_lock();
    class_for_each_device(&devlink_class, core::ptr::null_mut(), &sync_list,
...
//
#[no_mangle]
pub unsafe extern "C" fn wait_for_init_devices_probe() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn fw_devlink_unblock_consumers(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn fwnode_init_without_drv(fwnode: *mut fwnode_handle) -> bool {
...
#[no_mangle]
unsafe extern "C" fn fwnode_ancestor_init_without_drv(fwnode: *mut fwnode_handle) -> bool {
...
//
    ...
    {
    struct device *sup_dev = core::ptr::null_mut(), *par_dev = core::ptr::null_mut(), *con_dev = core::ptr::null_mut();
    struct fwnode_link *link;
...
//
#[no_mangle]
unsafe extern "C" fn __fw_devlink_link_to_consumers(dev: *mut device) {
    static void __fw_devlink_link_to_consumers(struct device *dev)
    {
...
//
    ...
    struct fwnode_handle *fwnode)
    {
    let mut own_link: bool = (dev.fwnode == fwnode);
    struct fwnode_link *link, *tmp;
    struct fwnode_handle *child = core::ptr::null_mut();
    list_for_each_entry_safe(link, tmp, &fwnode.suppliers, c_hook) {
    int ret;
...
#[no_mangle]
unsafe extern "C" fn fw_devlink_link_device(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn lock_device_hotplug() {
    void lock_device_hotplug(void)
    {
    mutex_lock(&device_hotplug_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn unlock_device_hotplug() {
    void unlock_device_hotplug(void)
    {
    mutex_unlock(&device_hotplug_lock);
    }
#[no_mangle]
pub unsafe extern "C" fn lock_device_hotplug_sysfs() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn device_is_not_partition(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_platform_notify(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn device_platform_notify_remove(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev_attr->show_const) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev_attr->store_const) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn device_release(kobj: *mut kobject) {
...
//
    ...
    dev.release(dev);
#[no_mangle]
pub unsafe extern "C" fn if(dev->type->release: dev->type &&) -> else {
    else if (dev.type && dev.type.release)
    dev.type.release(dev);
#[no_mangle]
pub unsafe extern "C" fn if(dev->class->dev_release: dev->class &&) -> else {
...
#[no_mangle]
unsafe extern "C" fn device_get_ownership(kobj: *const kobject, uid: *mut kuid_t, gid: *mut kgid_t) {
...
#[no_mangle]
unsafe extern "C" fn dev_uevent_filter(kobj: *const kobject) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn dev_driver_uevent(dev: *const device, env: *mut kobj_uevent_env) {
...
#[no_mangle]
unsafe extern "C" fn dev_uevent(kobj: *const kobject, env: *mut kobj_uevent_env) -> c_int {
...
// have the device type specific function add its stuff
    ...
    struct kset *kset;
    struct kobj_uevent_env *env = core::ptr::null_mut();
    int i;
    let mut len: c_int = 0;
    int retval;
...
#[no_mangle]
unsafe extern "C" fn devm_attr_group_remove(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_device_add_group(dev: *mut device, grp: *const attribute_group) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_add_attrs(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_remove_attrs(dev: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn devices_kset_move_before(deva: *mut device, devb: *mut device) {
...
//
#[no_mangle]
unsafe extern "C" fn devices_kset_move_after(deva: *mut device, devb: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devices_kset_move_last(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn klist_children_get(n: *mut klist_node) {
...
#[no_mangle]
unsafe extern "C" fn klist_children_put(n: *mut klist_node) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_initialize(dev: *mut device) {
    ...
    {
    static struct kobject *virtual_dir = core::ptr::null_mut();
    if (!virtual_dir)
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct class_dir {
    pub kobj: kobject,
    pub class: *const class,
}

#[no_mangle]
unsafe extern "C" fn class_dir_release(kobj: *mut kobject) {
...
#[no_mangle]
pub unsafe extern "C" fn if(!dev->class->ns_type: parent->class &&) -> else {
    subsys_put(sp);
    return &parent.kobj;
    } else {
...
//
#[no_mangle]
pub unsafe extern "C" fn kobject_has_children(kobj: *mut kobject) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn cleanup_glue_dir(dev: *mut device, glue_dir: *mut kobject) {
...
#[no_mangle]
unsafe extern "C" fn device_add_class_symlinks(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_remove_class_symlinks(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_set_name(dev: *mut device, fmt: *const c_char, ...) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_create_sys_dev_entry(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn device_remove_sys_dev_entry(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn device_private_init(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_add(dev: *mut device) -> c_int {
    ...
    let mut error: c_int = -EINVAL;
    struct kobject *glue_dir = core::ptr::null_mut();
    dev = get_device(dev);
    if (!dev)
    goto done;
    if (!dev.p) {
...
//
    ...
    dev.init_name = core::ptr::null_mut();
    }
    if (dev_name(dev))
    error = 0;
// subsystems can specify simple device enumeration
#[no_mangle]
pub unsafe extern "C" fn if(dev->bus->dev_name: dev->bus &&) -> else {
...
// we require the name to be set before, and pass NULL
    error = kobject_add(&dev.kobj, dev.kobj.parent, core::ptr::null_mut());
    if (error) {
    glue_dir = kobj;
    goto Error;
    }
...
// notify any interfaces that the device is here
    ...
    DPMError:
    device_set_driver(dev, core::ptr::null_mut());
...
//
#[no_mangle]
pub unsafe extern "C" fn device_register(dev: *mut device) -> c_int {
...
//
    ...
    {
    return dev ? kobj_to_dev(kobject_get(&dev.kobj)) : core::ptr::null_mut();
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn put_device(dev: *mut device) {
...
#[no_mangle]
pub unsafe extern "C" fn kill_device(dev: *mut device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_del(dev: *mut device) {
    ...
    device_unlock(dev);
    if (dev.fwnode && dev.fwnode.dev == dev)
    dev.fwnode.dev = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn device_unregister(dev: *mut device) {
...
// return name without allocation, tmp == NULL
    if (strchr(dev_name(dev), '!') == core::ptr::null_mut())
    return dev_name(dev);
...
//
    ...
    (from ? &from.p.knode_parent : core::ptr::null_mut()));
    while ((child = prev_device(&i)) && !error)
    error = fn(child, data);
    klist_iter_exit(&i);
    return error;
...
#[no_mangle]
pub unsafe extern "C" fn devices_init() -> int __init {
    int __init devices_init(void)
    {
    devices_kset = kset_create_and_add("devices", &device_uevent_ops, core::ptr::null_mut());
    if (!devices_kset)
    return -ENOMEM;
    dev_kobj = kobject_create_and_add("dev", core::ptr::null_mut());
    if (!dev_kobj)
    goto dev_kobj_err;
...
#[no_mangle]
unsafe extern "C" fn device_check_offline(dev: *mut device, not_used: *mut c_void) -> c_int {
    static int device_check_offline(struct device *dev, void *not_used)
    {
    int ret;
    ret = device_for_each_child(dev, core::ptr::null_mut(), device_check_offline);
    if (ret)
    return ret;
...
//
#[no_mangle]
pub unsafe extern "C" fn device_offline(dev: *mut device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_online(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn root_device_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn root_device_unregister(dev: *mut device) {
...
//
    ...
    struct device *dev;
    va_start(vargs, fmt);
    dev = device_create_groups_vargs(class, parent, devt, drvdata, core::ptr::null_mut(),
    fmt, vargs);
    va_end(vargs);
    return dev;
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn device_destroy(class: *const class, devt: dev_t) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_rename(dev: *mut device, new_name: *const c_char) -> c_int {
    int device_rename(struct device *dev, const char *new_name)
    {
    struct subsys_private *sp = core::ptr::null_mut();
    struct kobject *kobj = &dev.kobj;
    char *old_device_name = core::ptr::null_mut();
    int error;
    let mut is_link_renamed: bool = false;
    dev = get_device(dev);
    if (!dev)
    return -EINVAL;
...
//
    ...
    __func__, new_parent ? dev_name(new_parent) : "<core::ptr::null_mut()>");
...
//
#[no_mangle]
pub unsafe extern "C" fn device_change_owner(dev: *mut device, kuid: kuid_t, kgid: kgid_t) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_shutdown() {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dev->bus) -> else {
    else if (dev.bus)
    subsys = dev.bus.name;
    else
    return;
...
#[no_mangle]
pub unsafe extern "C" fn dev_printk_emit(level: c_int, dev: *const device, fmt: *const c_char, ...) -> c_int {
    ...
    printk("%s(core::ptr::null_mut() device *): %pV", level, vaf);
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_err_probe(dev: *const device, err: c_int, fmt: *const c_char, ...) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn dev_warn_probe(dev: *const device, err: c_int, fmt: *const c_char, ...) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fwnode_is_primary(fwnode: *mut fwnode_handle) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn set_primary_fwnode(dev: *mut device, fwnode: *mut fwnode_handle) {
...
// Set fn->secondary = NULL, so fn remains the primary fwnode
    fn.secondary = core::ptr::null_mut();
    } else {
    dev.fwnode = core::ptr::null_mut();
    }
    }
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn set_secondary_fwnode(dev: *mut device, fwnode: *mut fwnode_handle) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_remove_of_node(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_add_of_node(dev: *mut device, of_node: *mut device_node) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn device_set_of_node_from_dev(dev: *mut device, dev2: *const device) {
...
#[no_mangle]
pub unsafe extern "C" fn device_set_node(dev: *mut device, fwnode: *mut fwnode_handle) {
...
#[no_mangle]
pub unsafe extern "C" fn device_match_name(dev: *mut device, name: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn device_match_type(dev: *mut device, type: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn device_match_of_node(dev: *mut device, np: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn device_match_fwnode(dev: *mut device, fwnode: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn device_match_devt(dev: *mut device, pdevt: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn device_match_acpi_dev(dev: *mut device, adev: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn device_match_acpi_handle(dev: *mut device, handle: *const c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn device_match_any(dev: *mut device, unused: *const c_void) -> c_int {
