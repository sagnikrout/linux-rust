...
//! Source: drivers/base/regmap/regcache-maple.c
#![no_std]
...
// initialized to work around false-positive -Wuninitialized warning
    let mut lower_index: c_ulong = 0, lower_last = 0;
    let mut upper_index: c_ulong = 0, upper_last = 0;
    let mut ret: c_int = 0;
...
// Render the data for a raw write
    ...
    unsigned long *entry;
    MA_STATE(mas, mt, min, max);
    let mut lmin: c_ulong = min;
    let mut lmax: c_ulong = max;
...
#[no_mangle]
unsafe extern "C" fn regcache_maple_init(map: *mut regmap) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regcache_maple_exit(map: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn regcache_maple_populate(map: *mut regmap) -> c_int {
