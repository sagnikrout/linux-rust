...
//! Source: drivers/base/regmap/regmap-debugfs.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct regmap_debugfs_node {
    pub map: *mut regmap,
    pub link: list_head,
}
...
#[no_mangle]
unsafe extern "C" fn regmap_calc_reg_len(max_val: c_int) -> usize {
    static size_t regmap_calc_reg_len(int max_val)
    {
    return snprintf(core::ptr::null_mut(), 0, "%x", max_val);
    }
...
#[no_mangle]
unsafe extern "C" fn regmap_debugfs_free_dump_cache(map: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn regmap_printable(map: *mut regmap, reg: c_uint) -> bool {
...
//
    ...
    loff_t *pos)
    {
    struct regmap_debugfs_off_cache *c = core::ptr::null_mut();
    let mut p: loff_t = 0;
    unsigned int i, ret;
...
#[no_mangle]
unsafe extern "C" fn regmap_next_readable_reg(map: *mut regmap, reg: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regmap_access_show(s: *mut seq_file, ignored: *mut c_void) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_debugfs_init(map: *mut regmap) {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_debugfs_exit(map: *mut regmap) {
    ...
    kfree(map.debugfs_name);
    map.debugfs_name = core::ptr::null_mut();
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_debugfs_initcall() {
    void regmap_debugfs_initcall(void)
    {
    struct regmap_debugfs_node *node, *tmp;
    regmap_debugfs_root = debugfs_create_dir("regmap", core::ptr::null_mut());
    mutex_lock(&regmap_debugfs_early_lock);
