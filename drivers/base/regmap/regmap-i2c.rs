...
//! Source: drivers/base/regmap/regmap-i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn regmap_i2c_write(context: *mut c_void, data: *const c_void, count: usize) -> c_int {
...
//
    ...
    let mut max_read: u16 = 0, max_write = 0;
    ...
    i2c_check_functionality(i2c.adapter,
    I2C_FUNC_SMBUS_WORD_DATA))
    switch (regmap_get_val_endian(&i2c.dev, core::ptr::null_mut(), config)) {
