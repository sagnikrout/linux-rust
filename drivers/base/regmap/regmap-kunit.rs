...
//! Source: drivers/base/regmap/regmap-kunit.c
#![no_std]
...
pub const BLOCK_TEST_SIZE: c_int = 12;
...
pub struct regmap_test_priv {
    ...
    pub reg_default_max: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct regmap_test_param {
    pub cache: enum regcache_type,
    pub val_endian: enum regmap_endian,
    pub from_reg: c_uint,
    pub fast_io: bool,
}

#[no_mangle]
unsafe extern "C" fn get_changed_bytes(orig: *mut c_void, new: *mut c_void, size: usize) {
...
#[no_mangle]
unsafe extern "C" fn param_to_desc(param: *const regmap_test_param, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn reg_5_false(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn reg_default_expected(reg: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn basic_read_write(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn bulk_write(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn bulk_read(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn multi_write(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn multi_read(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn read_bypassed(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn read_bypassed_volatile(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn write_readonly(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn read_writeonly(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn reg_defaults(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn reg_default_callback_populates_flat_cache(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn reg_defaults_read_dev(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn register_patch(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn stride(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn test_range_window_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn test_range_all_volatile(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn basic_ranges(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn stress_insert(test: *mut kunit) {
    ...
    KUNIT_ASSERT_FALSE(test, vals == core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cache_bypass(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_sync_marked_dirty(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_sync_after_cache_only(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_sync_defaults_marked_dirty(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_sync_default_after_cache_only(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_sync_readonly(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_sync_patch(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_drop(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_drop_with_non_contiguous_ranges(test: *mut kunit) {
    ...
    unsigned int reg;
    let mut num_ranges: c_int = ARRAY_SIZE(val) * 2;
    int rangeidx, i;
...
#[no_mangle]
unsafe extern "C" fn cache_drop_all_and_sync_marked_dirty(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_drop_all_and_sync_no_defaults(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_drop_all_and_sync_has_defaults(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_present(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_write_zero(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cache_range_window_reg(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn raw_read_defaults_single(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn raw_read_defaults(test: *mut kunit) {
    ...
    KUNIT_ASSERT_TRUE(test, rval != core::ptr::null_mut());
    if (!rval)
    return;
// Check that we can read the defaults via the API
    ...
    KUNIT_EXPECT_EQ(test, def, be16_to_cpu(( __be16)rval[i]));
    } else {
    KUNIT_EXPECT_EQ(test, def, le16_to_cpu(( __le16)rval[i]));
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn raw_write_read_single(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn raw_write(test: *mut kunit) {
...
// We should read back the new values, and defaults for the rest
    ...
    be16_to_cpu(( __be16)val[i % 2]));
    } else {
    KUNIT_EXPECT_EQ(test, rval,
    le16_to_cpu(( __le16)val[i % 2]));
    }
    break;
    default:
    KUNIT_EXPECT_EQ(test, config.reg_defaults[i].def, rval);
...
#[no_mangle]
unsafe extern "C" fn reg_zero(dev: *mut device, reg: c_uint) -> bool {
    static bool reg_zero(struct device *dev, unsigned int reg)
    {
    let mut reg: return = = 0;
    }
#[no_mangle]
unsafe extern "C" fn ram_reg_zero(data: *mut regmap_ram_data, reg: c_uint) -> bool {
    static bool ram_reg_zero(struct regmap_ram_data *data, unsigned int reg)
    {
    let mut reg: return = = 0;
    }
#[no_mangle]
unsafe extern "C" fn raw_noinc_write(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn raw_sync(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn raw_ranges(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn regmap_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regmap_test_exit(test: *mut kunit) {
