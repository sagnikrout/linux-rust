...
//! Source: drivers/base/regmap/regmap.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn regmap_should_log(map: *mut regmap) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_writeable(map: *mut regmap, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_cached(map: *mut regmap, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_readable(map: *mut regmap, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_volatile(map: *mut regmap, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_precious(map: *mut regmap, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_writeable_noinc(map: *mut regmap, reg: c_uint) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_readable_noinc(map: *mut regmap, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn regmap_format_8(buf: *mut c_void, val: c_uint, shift: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn regmap_format_16_be(buf: *mut c_void, val: c_uint, shift: c_uint) {
    static void regmap_format_16_be(void *buf, unsigned int val, unsigned int shift)
    {
    put_unaligned_be16(val << shift, buf);
    }
#[no_mangle]
unsafe extern "C" fn regmap_format_16_le(buf: *mut c_void, val: c_uint, shift: c_uint) {
    ...
    unsigned int shift)
    {
    let mut v: u16 = val << shift;
    memcpy(buf, &v, sizeof(v));
    }
#[no_mangle]
unsafe extern "C" fn regmap_format_24_be(buf: *mut c_void, val: c_uint, shift: c_uint) {
    static void regmap_format_24_be(void *buf, unsigned int val, unsigned int shift)
    {
    put_unaligned_be24(val << shift, buf);
    }
#[no_mangle]
unsafe extern "C" fn regmap_format_32_be(buf: *mut c_void, val: c_uint, shift: c_uint) {
    static void regmap_format_32_be(void *buf, unsigned int val, unsigned int shift)
    {
    put_unaligned_be32(val << shift, buf);
    }
#[no_mangle]
unsafe extern "C" fn regmap_format_32_le(buf: *mut c_void, val: c_uint, shift: c_uint) {
    ...
    unsigned int shift)
    {
    let mut v: u32 = val << shift;
    memcpy(buf, &v, sizeof(v));
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_inplace_noop(buf: *mut c_void) {
    static void regmap_parse_inplace_noop(void *buf)
    {
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_8(buf: *const c_void) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn regmap_parse_16_be(buf: *const c_void) -> c_uint {
    static unsigned int regmap_parse_16_be(const void *buf)
    {
    return get_unaligned_be16(buf);
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_16_le(buf: *const c_void) -> c_uint {
    static unsigned int regmap_parse_16_le(const void *buf)
    {
    return get_unaligned_le16(buf);
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_16_be_inplace(buf: *mut c_void) {
    static void regmap_parse_16_be_inplace(void *buf)
    {
    let mut v: u16 = get_unaligned_be16(buf);
    memcpy(buf, &v, sizeof(v));
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_16_le_inplace(buf: *mut c_void) {
    static void regmap_parse_16_le_inplace(void *buf)
    {
    let mut v: u16 = get_unaligned_le16(buf);
    memcpy(buf, &v, sizeof(v));
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_16_native(buf: *const c_void) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn regmap_parse_24_be(buf: *const c_void) -> c_uint {
    static unsigned int regmap_parse_24_be(const void *buf)
    {
    return get_unaligned_be24(buf);
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_32_be(buf: *const c_void) -> c_uint {
    static unsigned int regmap_parse_32_be(const void *buf)
    {
    return get_unaligned_be32(buf);
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_32_le(buf: *const c_void) -> c_uint {
    static unsigned int regmap_parse_32_le(const void *buf)
    {
    return get_unaligned_le32(buf);
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_32_be_inplace(buf: *mut c_void) {
    static void regmap_parse_32_be_inplace(void *buf)
    {
    let mut v: u32 = get_unaligned_be32(buf);
    memcpy(buf, &v, sizeof(v));
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_32_le_inplace(buf: *mut c_void) {
    static void regmap_parse_32_le_inplace(void *buf)
    {
    let mut v: u32 = get_unaligned_le32(buf);
    memcpy(buf, &v, sizeof(v));
    }
#[no_mangle]
unsafe extern "C" fn regmap_parse_32_native(buf: *const c_void) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn regmap_lock_hwlock(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_lock_hwlock_irq(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_lock_hwlock_irqsave(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_unlock_hwlock(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_unlock_hwlock_irq(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_unlock_hwlock_irqrestore(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_lock_unlock_none(__map: *mut c_void) {
    static void regmap_lock_unlock_none(void *__map)
    {
    }
#[no_mangle]
unsafe extern "C" fn regmap_lock_mutex(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_unlock_mutex(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_lock_spinlock(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_unlock_spinlock(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_lock_raw_spinlock(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn regmap_unlock_raw_spinlock(__map: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn dev_get_regmap_release(dev: *mut device, res: *mut c_void) {
...
//
    ...
    new = &((*new).rb_left);
#[no_mangle]
pub unsafe extern "C" fn if(this->range_max: data->range_min >) -> else {
    ...
    node = node.rb_left;
#[no_mangle]
pub unsafe extern "C" fn if(this->range_max: reg >) -> else {
...
#[no_mangle]
unsafe extern "C" fn regmap_range_exit(map: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn regmap_set_name(map: *mut regmap, config: *const regmap_config) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regmap_detach_dev(dev: *mut device, map: *mut regmap) -> c_int {
...
// Use this if no other value was found
    ...
    const struct regmap_config *config)
    {
    struct fwnode_handle *fwnode = dev ? dev_fwnode(dev) : core::ptr::null_mut();
    enum regmap_endian endian;
// Retrieve the endianness specification from the regmap config
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fwnode_property_read_bool(fwnode, _arg: "little-endian")) -> else {
    else if (fwnode_property_read_bool(fwnode, "little-endian"))
    endian = REGMAP_ENDIAN_LITTLE;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: fwnode_property_read_bool(fwnode, _arg: "native-endian")) -> else {
...
// Bulk read/write
    ...
    if (map.work_buf == core::ptr::null_mut()) {
    ret = -ENOMEM;
    goto err_hwlock;
    }
    if (map.format.format_write) {
...
// Make sure, that this register range has no selector
    ...
    let mut sel_reg: c_uint = config.ranges[j].selector_reg;
    let mut win_min: c_uint = config.ranges[j].window_start;
...
// Allow data window inside its own virtual range
    ...
    if (map.selector_work_buf == core::ptr::null_mut()) {
...
#[no_mangle]
unsafe extern "C" fn devm_regmap_release(regmap: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_field_bulk_free(field: *mut regmap_field) {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_field_free(field: *mut regmap_field) {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_reinit_cache(map: *mut regmap, config: *const regmap_config) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_exit(map: *mut regmap) {
...
#[no_mangle]
unsafe extern "C" fn dev_get_regmap_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
    static int dev_get_regmap_match(struct device *dev, void *res, void *data)
    {
    struct regmap **r = res;
    if (!r || !*r) {
...
#[no_mangle]
unsafe extern "C" fn regmap_reg_addr(map: *mut regmap, reg: c_uint) -> c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: map->format.reg_shift <) -> else {
...
//
    ...
    let mut val_bytes: c_int = map.format.val_bytes;
// Cache the last written value for noinc writes
    ...
    if (range) {
    let mut val_num: c_int = val_len / map.format.val_bytes;
    let mut win_offset: c_int = (reg - range.range_min) % range.window_len;
    let mut win_residue: c_int = range.window_len - win_offset;
...
// If the caller supplied the value we can use it safely.
    ...
    map.format.reg_bytes +
    map.format.pad_bytes +
    val_len, core::ptr::null_mut(), 0, async);
    if (ret != 0) {
...
//
    ...
    val_len);
#[no_mangle]
pub unsafe extern "C" fn if(map->bus->gather_write: map->bus &&) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_can_raw_write(map: *mut regmap) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_get_raw_read_max(map: *mut regmap) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_get_raw_write_max(map: *mut regmap) -> usize {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_write(map: *mut regmap, reg: c_uint, val: c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_write_async(map: *mut regmap, reg: c_uint, val: c_uint) -> c_int {
    ...
    let mut val_count: usize = val_len / val_bytes;
    size_t chunk_count, chunk_bytes;
    let mut chunk_regs: usize = val_count;
    int ret, i;
    if (!val_count)
    return -EINVAL;
    ...
    chunk_regs = 1;
#[no_mangle]
pub unsafe extern "C" fn if(map->max_raw_write: map->max_raw_write && val_len >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_field_test_bits(field: *mut regmap_field, bits: c_uint) -> c_int {
...
//
    ...
    u8 *u8;
    let mut val_bytes: usize = map.format.val_bytes;
    let mut reg_bytes: usize = map.format.reg_bytes;
    let mut pad_bytes: usize = map.format.pad_bytes;
    let mut pair_size: usize = reg_bytes + pad_bytes + val_bytes;
    let mut len: usize = pair_size * num_regs;
    if (!len)
    return -EINVAL;
    buf = kzalloc(len, GFP_KERNEL);
    if (!buf)
...
// We have to linearise by hand.
    ...
    let mut reg: c_uint = regs[i].reg;
    let mut val: c_uint = regs[i].def;
    trace_regmap_hw_write_start(map, reg, 1);
    reg = regmap_reg_addr(map, reg);
...
// u8 |= map->write_flag_mask;
    ...
    struct regmap_range_node *range)
    {
    let mut win_page: c_uint = (reg - range.range_min) / range.window_len;
    return win_page;
    }
    ...
    let mut this_page: c_uint = 0;
    let mut page_change: c_uint = 0;
//
...
//
    ...
    let mut len: usize = sizeof(struct reg_sequence)*num_regs;
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_read(map: *mut regmap, reg: c_uint, val: *mut c_uint) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_read_bypassed(map: *mut regmap, reg: c_uint, val: *mut c_uint) -> c_int {
...
//
    ...
    chunk_regs = 1;
#[no_mangle]
pub unsafe extern "C" fn if(map->max_raw_read: map->max_raw_read && val_len >) -> else {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_field_read(field: *mut regmap_field, val: *mut c_uint) -> c_int {
...
//
    ...
    int ret, i;
    let mut val_bytes: usize = map.format.val_bytes;
    let mut vol: bool = regmap_volatile_range(map, reg, val_count);
    if (!IS_ALIGNED(reg, map.reg_stride))
    return -EINVAL;
    if (val_count == 0)
    return -EINVAL;
    ...
    ret = _regmap_bulk_read(map, reg, core::ptr::null_mut(), val, val_count);
    }
    if (!ret)
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_test_bits(map: *mut regmap, reg: c_uint, bits: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn regmap_async_complete_cb(async: *mut regmap_async, ret: c_int) {
...
#[no_mangle]
unsafe extern "C" fn regmap_async_is_done(map: *mut regmap) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_async_complete(map: *mut regmap) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_get_val_bytes(map: *mut regmap) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_get_max_register(map: *mut regmap) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_get_reg_stride(map: *mut regmap) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_might_sleep(map: *mut regmap) -> bool {
...
#[no_mangle]
unsafe extern "C" fn regmap_initcall() -> int __init {
