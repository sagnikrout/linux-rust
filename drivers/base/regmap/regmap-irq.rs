...
//! Source: drivers/base/regmap/regmap-irq.c
#![no_std]
...
pub struct regmap_irq_chip_data {
    ...
    pub map: *mut regmap,
    pub chip: *const regmap_irq_chip,
    pub irq_base: c_int,
    pub domain: *mut irq_domain,
    pub irq: c_int,
    pub wake_count: c_int,
    pub status_reg_buf: *mut c_void,
    pub main_status_buf: *mut c_uint,
    pub status_buf: *mut c_uint,
    pub prev_status_buf: *mut c_uint,
    pub mask_buf: *mut c_uint,
    pub mask_buf_def: *mut c_uint,
    pub wake_buf: *mut c_uint,
    pub type_buf: *mut c_uint,
    pub type_buf_def: *mut c_uint,
    pub config_buf: *mut c_uint,
    pub irq_reg_stride: c_uint,
    unsigned int (*get_irq_reg)(struct regmap_irq_chip_data *data,
    pub index): unsigned int base, int,
    pub clear_status:1: c_uint,
}
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_can_bulk_read_status(data: *mut regmap_irq_chip_data) -> bool {
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_lock(data: *mut irq_data) {
...
#[no_mangle]
pub unsafe extern "C" fn if(0: d->wake_count >) -> else {
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_enable(data: *mut irq_data) {
    static void regmap_irq_enable(struct irq_data *data)
    {
    struct regmap_irq_chip_data *d = irq_data_get_irq_chip_data(data);
    struct regmap *map = d.map;
    const struct regmap_irq *irq_data = irq_to_regmap_irq(d, data.hwirq);
    let mut reg: c_uint = irq_data.reg_offset / map.reg_stride;
    unsigned int mask;
//
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_disable(data: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_set_type(data: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_set_wake(data: *mut irq_data, on: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_reqres(data: *mut irq_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_relres(data: *mut irq_data) {
...
//
    ...
    let mut offset: c_uint = subreg.offset[i];
    let mut index: c_uint = offset / map.reg_stride;
...
#[no_mangle]
unsafe extern "C" fn read_irq_data(data: *mut regmap_irq_chip_data) -> c_int {
...
// Read sub registers with active IRQs
    for (i = 0; i < chip.num_main_regs; i++) {
    unsigned int b;
    let mut mreg: c_ulong = data.main_status_buf[i];
...
#[no_mangle]
unsafe extern "C" fn regmap_irq_thread(irq: c_int, d: *mut c_void) -> irqreturn_t {
    ...
    for (i = 0; i < data.chip.num_regs; i++) {
    let mut val: c_uint = data.status_buf[i];
...
// Store current levels
    ...
    if (ret)
    goto err_mutex;
    ret = request_threaded_irq(irq, core::ptr::null_mut(), regmap_irq_thread,
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_del_irq_chip(irq: c_int, d: *mut regmap_irq_chip_data) {
...
#[no_mangle]
unsafe extern "C" fn devm_regmap_irq_chip_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devm_regmap_irq_chip_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_irq_chip_get_base(data: *mut regmap_irq_chip_data) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn regmap_irq_get_virq(data: *mut regmap_irq_chip_data, irq: c_int) -> c_int {
