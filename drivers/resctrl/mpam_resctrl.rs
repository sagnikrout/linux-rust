...
//! Source: drivers/resctrl/mpam_resctrl.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_alloc_capable() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_mon_capable() -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_is_evt_configurable(evt: enum resctrl_event_id) -> bool {
    bool resctrl_arch_is_evt_configurable(enum resctrl_event_id evt)
    {
    return false;
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_mon_event_config_read(info: *mut c_void) {
    void resctrl_arch_mon_event_config_read(void *info)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_mon_event_config_write(info: *mut c_void) {
    void resctrl_arch_mon_event_config_write(void *info)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_reset_rmid_all(r: *mut rdt_resource, d: *mut rdt_l3_mon_domain) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_mbm_cntr_assign_enabled(r: *mut rdt_resource) -> bool {
    bool resctrl_arch_mbm_cntr_assign_enabled(struct rdt_resource *r)
    {
    return (r == &mpam_resctrl_controls[RDT_RESOURCE_L3].resctrl_res);
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_mbm_cntr_assign_set(r: *mut rdt_resource, enable: bool) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_pre_mount() {
    void resctrl_arch_pre_mount(void)
    {
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_get_cdp_enabled(rid: enum resctrl_res_level) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn resctrl_reset_task_closids() {
...
#[no_mangle]
unsafe extern "C" fn mpam_resctrl_monitor_sync_abmc_vals(l3: *mut rdt_resource) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_set_cdp_enabled(rid: enum resctrl_res_level, enable: bool) -> c_int {
    int resctrl_arch_set_cdp_enabled(enum resctrl_res_level rid, bool enable)
    {
    let mut partid_i: u32 = RESCTRL_RESERVED_CLOSID, partid_d = RESCTRL_RESERVED_CLOSID;
    struct mpam_resctrl_res *res = &mpam_resctrl_controls[RDT_RESOURCE_L3];
    struct rdt_resource *l3 = &res.resctrl_res;
    int cpu;
...
// On unmount when CDP is disabled, re-enable MBA
    ...
    on_each_cpu(resctrl_arch_sync_cpu_closid_rmid, core::ptr::null_mut(), 1);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn mpam_resctrl_hide_cdp(rid: enum resctrl_res_level) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_get_num_closid(ignored: *mut rdt_resource) -> u32 {
    u32 resctrl_arch_get_num_closid(struct rdt_resource *ignored)
    {
    return mpam_partid_max + 1;
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_system_num_rmid_idx() -> u32 {
    u32 resctrl_arch_system_num_rmid_idx(void)
    {
    return (mpam_pmg_max + 1) * (mpam_partid_max + 1);
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_rmid_idx_encode(closid: u32, rmid: u32) -> u32 {
    u32 resctrl_arch_rmid_idx_encode(u32 closid, u32 rmid)
    {
    return closid * (mpam_pmg_max + 1) + rmid;
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_rmid_idx_decode(idx: u32, closid: *mut u32, rmid: *mut u32) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_sched_in(tsk: *mut task_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_set_cpu_default_closid_rmid(cpu: c_int, closid: u32, rmid: u32) {
...
//
    let mut partid_d: u32 = resctrl_get_config_index(closid, CDP_DATA);
    let mut partid_i: u32 = resctrl_get_config_index(closid, CDP_CODE);
    mpam_set_cpu_defaults(cpu, partid_d, partid_i, rmid, rmid);
    }
    }
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_sync_cpu_closid_rmid(info: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_set_closid_rmid(tsk: *mut task_struct, closid: u32, rmid: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_match_closid(tsk: *mut task_struct, closid: u32) -> bool {
    bool resctrl_arch_match_closid(struct task_struct *tsk, u32 closid)
    {
    let mut regval: u64 = mpam_get_regval(tsk);
    let mut tsk_closid: u32 = FIELD_GET(MPAM0_EL1_PARTID_D, regval);
    if (cdp_enabled)
    tsk_closid >>= 1;
    let mut tsk_closid: return = = closid;
    }
// The task's pmg is not unique, the partid must be considered too
#[no_mangle]
pub unsafe extern "C" fn resctrl_arch_match_rmid(tsk: *mut task_struct, closid: u32, rmid: u32) -> bool {
    bool resctrl_arch_match_rmid(struct task_struct *tsk, u32 closid, u32 rmid)
    {
    let mut regval: u64 = mpam_get_regval(tsk);
    let mut tsk_closid: u32 = FIELD_GET(MPAM0_EL1_PARTID_D, regval);
    let mut tsk_rmid: u32 = FIELD_GET(MPAM0_EL1_PMG_D, regval);
    if (cdp_enabled)
    tsk_closid >>= 1;
...
#[no_mangle]
unsafe extern "C" fn resctrl_arch_mon_ctx_alloc_no_wait(evtid: enum resctrl_event_id) -> c_int {
...
// ret = resctrl_arch_mon_ctx_alloc_no_wait(evtid);
    ...
    {
    let mut mon_idx: u32 = *(u32 *)arch_mon_ctx;
    kfree(arch_mon_ctx);
...
// Shift closid to account for CDP
    ...
    let mut mbwu_idx: c_int = resctrl_arch_rmid_idx_encode(closid, rmid);
...
// Check if we can access this domain without an IPI
    ...
    {
    if (cdp_enabled) {
    let mut code_val: u64 = 0, data_val = 0;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn update_rmid_limits(class: *mut mpam_class) -> c_int {
    static int update_rmid_limits(struct mpam_class *class)
    {
    let mut num_unique_pmg: u32 = resctrl_arch_system_num_rmid_idx();
...
#[no_mangle]
unsafe extern "C" fn cache_has_usable_cpor(class: *mut mpam_class) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mba_class_use_mbw_max(cprops: *mut mpam_props) -> bool {
...
#[no_mangle]
unsafe extern "C" fn class_has_usable_mba(cprops: *mut mpam_props) -> bool {
    static bool class_has_usable_mba(struct mpam_props *cprops)
    {
    return mba_class_use_mbw_max(cprops);
    }
#[no_mangle]
unsafe extern "C" fn cache_has_usable_csu(class: *mut mpam_class) -> bool {
...
#[no_mangle]
unsafe extern "C" fn class_has_usable_mbwu(class: *mut mpam_class) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn get_mba_granularity(cprops: *mut mpam_props) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn mbw_max_to_percent(mbw_max: u16, cprops: *mut mpam_props) -> u32 {
    static u32 mbw_max_to_percent(u16 mbw_max, struct mpam_props *cprops)
    {
    let mut val: u32 = mbw_max;
...
//
#[no_mangle]
unsafe extern "C" fn percent_to_mbw_max(pc: u8, cprops: *mut mpam_props) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn get_mba_min(cprops: *mut mpam_props) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn find_l3_equivalent_bitmask(cpu: c_int, tmp_cpumask: cpumask_var_t) -> c_int {
    static int find_l3_equivalent_bitmask(int cpu, cpumask_var_t tmp_cpumask)
    {
    let mut cache_id: u32 = get_cpu_cacheinfo_id(cpu, 3);
    lockdep_assert_cpus_held();
...
//
#[no_mangle]
unsafe extern "C" fn topology_matches_l3(victim: *mut mpam_class) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn traffic_matches_l3(class: *mut mpam_class) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mpam_resctrl_pick_caches() {
...
#[no_mangle]
unsafe extern "C" fn mpam_resctrl_pick_mba() {
    static void mpam_resctrl_pick_mba(void)
    {
    struct mpam_class *class, *candidate_class = core::ptr::null_mut();
    struct mpam_resctrl_res *res;
    lockdep_assert_cpus_held();
    guard(srcu)(&mpam_srcu);
    list_for_each_entry_srcu(class, &mpam_classes, classes_list,
...
//
    ...
    {
    for (int i = 0; i < num_mbwu_mon; i++) {
    let mut mbwu_mon: c_int = mpam_alloc_mbwu_mon(class);
    if (mbwu_mon < 0) {
...
#[no_mangle]
unsafe extern "C" fn mpam_resctrl_pick_counters() {
...
#[no_mangle]
unsafe extern "C" fn mpam_resctrl_control_init(res: *mut mpam_resctrl_res) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_resctrl_pick_domain_id(cpu: c_int, comp: *mut mpam_component) -> c_int {
...
// Use the corresponding L3 component ID as the domain ID
    let mut id: c_int = get_cpu_cacheinfo_id(cpu, 3);
...
//
#[no_mangle]
unsafe extern "C" fn mpam_resctrl_monitor_init_abmc(mon: *mut mpam_resctrl_mon) -> c_int {
    static int mpam_resctrl_monitor_init_abmc(struct mpam_resctrl_mon *mon)
    {
    struct mpam_resctrl_res *res = &mpam_resctrl_controls[RDT_RESOURCE_L3];
    let mut num_rmid: usize = resctrl_arch_system_num_rmid_idx();
    struct rdt_resource *l3 = &res.resctrl_res;
...
//
    ...
    if (!resctrl_enable_mon_event(type, false, 0, core::ptr::null_mut()))
    return -EINVAL;
    l3.mon_capable = true;
    return 0;
    }
...
// class has no component for this CPU
    ...
    if (r.mon_capable) {
    struct mpam_component *any_mon_comp = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn mpam_resctrl_online_cpu(cpu: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mpam_resctrl_offline_cpu(cpu: c_uint) {
...
#[no_mangle]
pub unsafe extern "C" fn mpam_resctrl_setup() -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn mpam_resctrl_exit() {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpam_resctrl_teardown_class(class: *mut mpam_class) {
    ...
    for_each_mpam_resctrl_control(res, rid) {
    if (res.class == class) {
    res.class = core::ptr::null_mut();
    break;
    }
    }
    for_each_mpam_resctrl_mon(mon, eventid) {
    if (mon.class == class) {
    mon.class = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn __cacheinfo_ready() -> int __init {
