...
//! Source: drivers/resctrl/mpam_devices.c
#![no_std]
...
pub const T241_CHIPS_MAX: c_int = 4;
pub const T241_CHIP_NSLICES: c_int = 12;
pub const T241_SPARE_REG0_OFF: c_uint = 0x1b0000;
pub const T241_SPARE_REG1_OFF: c_uint = 0x1c0000;
...
#[no_mangle]
pub unsafe extern "C" fn init_garbage(garbage: *mut mpam_garbage) {
...
#[no_mangle]
unsafe extern "C" fn mpam_free_garbage() {
...
//
#[no_mangle]
unsafe extern "C" fn mpam_assert_partid_sizes_fixed() {
...
#[no_mangle]
unsafe extern "C" fn __mpam_read_reg(msc: *mut mpam_msc, reg: u16) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn _mpam_read_partsel_reg(msc: *mut mpam_msc, reg: u16) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn __mpam_write_reg(msc: *mut mpam_msc, reg: u16, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn _mpam_write_partsel_reg(msc: *mut mpam_msc, reg: u16, val: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn _mpam_read_monsel_reg(msc: *mut mpam_msc, reg: u16) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn _mpam_write_monsel_reg(msc: *mut mpam_msc, reg: u16, val: u32) {
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_check_aidr(msc: *mut mpam_msc) -> bool {
    static bool mpam_msc_check_aidr(struct mpam_msc *msc)
    {
    let mut aidr: u32 = __mpam_read_reg(msc, MPAMF_AIDR);
    let mut major: u32 = FIELD_GET(MPAMF_AIDR_ARCH_MAJOR_REV, aidr);
    let mut minor: u32 = FIELD_GET(MPAMF_AIDR_ARCH_MINOR_REV, aidr);
//
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_read_idr(msc: *mut mpam_msc) -> u64 {
    static u64 mpam_msc_read_idr(struct mpam_msc *msc)
    {
    let mut idr_high: u64 = 0, idr_low;
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_clear_esr(msc: *mut mpam_msc) {
    static void mpam_msc_clear_esr(struct mpam_msc *msc)
    {
    let mut esr_low: u64 = __mpam_read_reg(msc, MPAMF_ESR);
    if (!esr_low)
    return;
//
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_read_esr(msc: *mut mpam_msc) -> u64 {
    static u64 mpam_msc_read_esr(struct mpam_msc *msc)
    {
    let mut esr_high: u64 = 0, esr_low;
...
#[no_mangle]
unsafe extern "C" fn __mpam_part_sel_raw(partsel: u32, msc: *mut mpam_msc) {
...
#[no_mangle]
unsafe extern "C" fn __mpam_part_sel(ris_idx: u8, partid: u16, msc: *mut mpam_msc) {
...
#[no_mangle]
unsafe extern "C" fn __mpam_intpart_sel(ris_idx: u8, intpartid: u16, msc: *mut mpam_msc) {
...
#[no_mangle]
pub unsafe extern "C" fn mpam_register_requestor(partid_max: u16, pmg_max: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_class_destroy(class: *mut mpam_class) {
...
#[no_mangle]
unsafe extern "C" fn mpam_component_destroy(comp: *mut mpam_component) {
...
#[no_mangle]
unsafe extern "C" fn mpam_vmsc_destroy(vmsc: *mut mpam_vmsc) {
...
//
#[no_mangle]
unsafe extern "C" fn get_cpumask_from_node_id(node_id: u32, affinity: *mut cpumask_t) {
...
#[no_mangle]
unsafe extern "C" fn mpam_ris_destroy(ris: *mut mpam_msc_ris) {
...
// ARM CMN-650 CSU erratum 3642720
    ...
    { core::ptr::null_mut() } /* Sentinel */
    };
#[no_mangle]
unsafe extern "C" fn mpam_enable_quirks(msc: *mut mpam_msc) {
...
//
#[no_mangle]
unsafe extern "C" fn mpam_ris_hw_probe_csu_nrdy(ris: *mut mpam_msc_ris) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mpam_ris_hw_probe(ris: *mut mpam_msc_ris) {
...
// Cache Capacity Partitioning
    ...
    let mut ccap_features: u32 = mpam_read_partsel_reg(msc, CCAP_IDR);
...
// Cache Portion partitioning
    ...
    let mut cpor_features: u32 = mpam_read_partsel_reg(msc, CPOR_IDR);
...
// Memory bandwidth partitioning
    ...
    let mut mbw_features: u32 = mpam_read_partsel_reg(msc, MBW_IDR);
...
// Priority partitioning
    ...
    let mut pri_features: u32 = mpam_read_partsel_reg(msc, PRI_IDR);
...
// Performance Monitoring
    ...
    let mut msmon_features: u32 = mpam_read_partsel_reg(msc, MSMON_IDR);
//
...
//
    ...
    bool has_long;
    let mut mbwumon_idr: u32 = mpam_read_partsel_reg(msc, MBWUMON_IDR);
...
//
    ...
    let mut nrwidr: u32 = mpam_read_partsel_reg(msc, PARTID_NRW_IDR);
    let mut partid_max: u16 = FIELD_GET(MPAMF_PARTID_NRW_IDR_INTPARTID_MAX, nrwidr);
    mpam_set_feature(mpam_feat_partid_nrw, props);
    msc.partid_max = min(msc.partid_max, partid_max);
    }
    }
#[no_mangle]
unsafe extern "C" fn mpam_msc_hw_probe(msc: *mut mpam_msc) -> c_int {
...
#[derive(Copy, Clone)]
pub struct mon_read {
    pub ris: *mut mpam_msc_ris,
    pub ctx: *mut mon_cfg,
    pub type: enum mpam_device_features,
    pub val: *mut u64,
    pub err: c_int,
    pub waited_timeout: bool,
}

#[no_mangle]
unsafe extern "C" fn mpam_ris_has_mbwu_long_counter(ris: *mut mpam_msc_ris) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_read_mbwu_l(msc: *mut mpam_msc) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_zero_mbwu_l(msc: *mut mpam_msc) {
...
#[no_mangle]
pub unsafe extern "C" fn clean_msmon_ctl_val(cur_ctl: *mut u32) {
...
#[no_mangle]
unsafe extern "C" fn __mpam_msmon_overflow_val(type: enum mpam_device_features) -> u64 {
...
// TODO: implement scaling counters
    ...
    struct mpam_msc *msc)
    {
    let mut overflow_val: u64 = __mpam_msmon_overflow_val(type);
    if (mpam_has_quirk(T241_MBW_COUNTER_SCALE_64, msc))
    overflow_val *= 64;
    return overflow_val;
    }
#[no_mangle]
unsafe extern "C" fn __ris_msmon_read(arg: *mut c_void) {
    static void __ris_msmon_read(void *arg)
    {
    u64 now;
    let mut nrdy: bool = false;
    bool config_mismatch;
    let mut overflow: bool = false;
    struct mon_read *m = arg;
    struct mon_cfg *ctx = m.ctx;
    let mut reset_on_next_read: bool = false;
...
#[no_mangle]
unsafe extern "C" fn _msmon_read(comp: *mut mpam_component, arg: *mut mon_read) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_msmon_choose_counter(class: *mut mpam_class) -> enum mpam_device_features {
...
#[no_mangle]
pub unsafe extern "C" fn mpam_msmon_reset_mbwu(comp: *mut mpam_component, ctx: *mut mon_cfg) {
...
#[no_mangle]
unsafe extern "C" fn mpam_reset_msc_bitmap(msc: *mut mpam_msc, reg: u16, wd: u16) {
...
#[no_mangle]
unsafe extern "C" fn mpam_apply_t241_erratum(ris: *mut mpam_msc_ris, partid: u16) {
...
#[no_mangle]
unsafe extern "C" fn mpam_wa_t241_force_mbw_min_to_one(props: *mut mpam_props) -> u16 {
    ...
    let mut val: u16 = 0;
    u16 max;
    let mut delta: u16 = ((5 * MPAMCFG_MBW_MAX_MAX) / 100) - 1;
...
// Called via IPI. Call while holding an SRCU reference
    ...
    struct mpam_config *cfg)
    {
    let mut cmax: u16 = MPAMCFG_CMAX_CMAX;
    struct mpam_msc *msc = ris.vmsc.msc;
...
//
    ...
    let mut min: u16 = mpam_wa_t241_force_mbw_min_to_one(rprops);
    ...
    let mut pri_val: u32 = 0;
    if (mpam_has_feature(mpam_feat_intpri_part, rprops)) {
    let mut intpri: u16 = GENMASK(rprops.intpri_wd - 1, 0);
// aces high?
    ...
    let mut dspri: u16 = GENMASK(rprops.dspri_wd - 1, 0);
...
#[no_mangle]
unsafe extern "C" fn mpam_restore_mbwu_state(_ris: *mut c_void) -> c_int {
...
// Call with MSC cfg_lock held
#[no_mangle]
unsafe extern "C" fn mpam_save_mbwu_state(arg: *mut c_void) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mpam_reset_ris(arg: *mut c_void) -> c_int {
    static int mpam_reset_ris(void *arg)
    {
    u16 partid, partid_max;
    let mut reset_cfg: mpam_config = {};
    struct mpam_msc_ris *ris = arg;
...
//
#[no_mangle]
unsafe extern "C" fn mpam_get_msc_preferred_cpu(msc: *mut mpam_msc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_touch_msc(msc: *mut mpam_msc, a): *mut *mut int (fn)(void, arg: *mut c_void) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mpam_write_config_arg {
    pub ris: *mut mpam_msc_ris,
...
#[no_mangle]
unsafe extern "C" fn __write_config(arg: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_reprogram_msc(msc: *mut mpam_msc) {
...
#[no_mangle]
unsafe extern "C" fn _enable_percpu_irq(_irq: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn mpam_cpu_online(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_discovery_cpu_online(cpu: c_uint) -> c_int {
    static int mpam_discovery_cpu_online(unsigned int cpu)
    {
    let mut err: c_int = 0;
    struct mpam_msc *msc;
    let mut new_device_probed: bool = false;
    if (mpam_is_enabled())
    return 0;
    guard(srcu)(&mpam_srcu);
    list_for_each_entry_srcu(msc, &mpam_all_msc, all_msc_list,
...
#[no_mangle]
unsafe extern "C" fn mpam_cpu_offline(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __setup_ppi(msc: *mut mpam_msc) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_setup_error_irq(msc: *mut mpam_msc) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn update_msc_accessibility(msc: *mut mpam_msc) {
...
//
#[no_mangle]
unsafe extern "C" fn mpam_msc_destroy(msc: *mut mpam_msc) {
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_drv_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_drv_probe(pdev: *mut platform_device) -> c_int {
    static int mpam_msc_drv_probe(struct platform_device *pdev)
    {
    int err;
    struct mpam_msc *msc = core::ptr::null_mut();
...
// Create RIS entries described by firmware
    ...
    mpam_register_cpuhp_callbacks(mpam_discovery_cpu_online, core::ptr::null_mut(),
    "mpam:drv_probe");
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn mpam_has_bwa_wd_feature(props: *mut mpam_props) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mpam_has_cmax_wd_feature(props: *mut mpam_props) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn mpam_enable_init_class_features(class: *mut mpam_class) {
...
#[no_mangle]
unsafe extern "C" fn mpam_enable_merge_vmsc_features(comp: *mut mpam_component) {
...
#[no_mangle]
unsafe extern "C" fn mpam_enable_merge_class_features(comp: *mut mpam_component) {
...
//
#[no_mangle]
unsafe extern "C" fn mpam_enable_merge_features(all_classes_list: *mut list_head) {
...
#[no_mangle]
unsafe extern "C" fn mpam_enable_msc_ecr(_msc: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_disable_msc_ecr(_msc: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __mpam_irq_handler(irq: c_int, msc: *mut mpam_msc) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpam_ppi_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpam_spi_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mpam_register_irqs() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_unregister_irqs() {
...
#[no_mangle]
unsafe extern "C" fn __destroy_component_cfg(comp: *mut mpam_component) {
    static void __destroy_component_cfg(struct mpam_component *comp)
    {
    struct mpam_msc *msc;
    struct mpam_vmsc *vmsc;
...
#[no_mangle]
unsafe extern "C" fn mpam_reset_component_cfg(comp: *mut mpam_component) {
...
#[no_mangle]
unsafe extern "C" fn __allocate_component_cfg(comp: *mut mpam_component) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mpam_allocate_config() -> c_int {
    ...
    list_for_each_entry(class, &mpam_classes, classes_list) {
    list_for_each_entry(comp, &class.components, class_list) {
    let mut err: c_int = __allocate_component_cfg(comp);
    if (err)
    return err;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn mpam_enable_once() {
...
#[no_mangle]
unsafe extern "C" fn mpam_reset_component_locked(comp: *mut mpam_component) {
...
#[no_mangle]
pub unsafe extern "C" fn mpam_reset_class_locked(class: *mut mpam_class) {
...
#[no_mangle]
unsafe extern "C" fn mpam_reset_class(class: *mut mpam_class) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpam_disable(ignored: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn mpam_enable(work: *mut work_struct) {
    void mpam_enable(struct work_struct *work)
    {
    static atomic_t once;
    struct mpam_msc *msc;
    let mut all_devices_probed: bool = true;
...
#[no_mangle]
unsafe extern "C" fn mpam_msc_driver_init() -> int __init {
