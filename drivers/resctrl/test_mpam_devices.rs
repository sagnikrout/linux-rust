...
//! Source: drivers/resctrl/test_mpam_devices.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn test__props_mismatch(test: *mut kunit) {
    static void test__props_mismatch(struct kunit *test)
    {
    let mut parent: mpam_props = { 0 };
    ...
    let mut fake_class: static struct mpam_class = { 0 };
    let mut fake_comp1: static struct mpam_component = { 0 };
    let mut fake_comp2: static struct mpam_component = { 0 };
    let mut fake_vmsc1: static struct mpam_vmsc = { 0 };
    let mut fake_vmsc2: static struct mpam_vmsc = { 0 };
    let mut fake_msc1: static struct mpam_msc = { 0 };
    let mut fake_msc2: static struct mpam_msc = { 0 };
    let mut fake_ris1: static struct mpam_msc_ris = { 0 };
    let mut fake_ris2: static struct mpam_msc_ris = { 0 };
    let mut fake_pdev: static struct platform_device = { 0 };
#[no_mangle]
pub unsafe extern "C" fn reset_fake_hierarchy() {
...
#[no_mangle]
unsafe extern "C" fn test_mpam_enable_merge_features(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn __test_mpam_reset_msc_bitmap(msc: *mut mpam_msc, reg: u16, wd: u16) {
...
#[no_mangle]
unsafe extern "C" fn test_mpam_reset_msc_bitmap(test: *mut kunit) {
    static void test_mpam_reset_msc_bitmap(struct kunit *test)
    {
    char __iomem *buf = ( char __iomem *)kunit_kzalloc(test, SZ_16K, GFP_KERNEL);
    let mut fake_msc: mpam_msc = {};
    u32 *test_result;
    if (!buf)
    return;
