...
//! Source: drivers/siox/siox-core.c
#![no_std]
...
//
pub const SIOX_STATUS_WDG: c_uint = 0x01;
//
...
//
pub const SIOX_STATUS_COUNTER: c_uint = 0x0e;
//
...
//
pub const SIOX_STATUS_TYPE: c_uint = 0xf0;
// Macro flag: #define CREATE_TRACE_POINTS

    static bool siox_is_registered;
#[no_mangle]
unsafe extern "C" fn siox_master_lock(smaster: *mut siox_master) {
    static void siox_master_lock(struct siox_master *smaster)
    {
    mutex_lock(&smaster.lock);
    }
#[no_mangle]
unsafe extern "C" fn siox_master_unlock(smaster: *mut siox_master) {
    static void siox_master_unlock(struct siox_master *smaster)
    {
    mutex_unlock(&smaster.lock);
    }
#[no_mangle]
pub unsafe extern "C" fn siox_status_clean(status_read: u8, status_written: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn siox_device_type_error(sdevice: *mut siox_device, status_clean: u8) -> bool {
    static bool siox_device_type_error(struct siox_device *sdevice, u8 status_clean)
    {
    let mut statustype: u8 = (status_clean & SIOX_STATUS_TYPE) >> 4;
//
...
#[no_mangle]
unsafe extern "C" fn siox_device_wdg_error(sdevice: *mut siox_device, status_clean: u8) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn siox_device_synced(sdevice: *mut siox_device) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn siox_device_connected(sdevice: *mut siox_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn siox_poll(smaster: *mut siox_master) {
    static void siox_poll(struct siox_master *smaster)
    {
    struct siox_device *sdevice;
    let mut i: usize = smaster.setbuf_len;
    let mut devno: c_uint = 0;
    let mut unsync_error: c_int = 0;
...
// interpret data pulled in from devices in buf[setbuf_len..]
    ...
    struct siox_driver *sdriver =
    to_siox_driver(sdevice.dev.driver);
    let mut status: u8 = smaster.buf[i + sdevice.outbytes - 1];
    u8 status_clean;
    let mut prev_status_clean: u8 = sdevice.status_read_clean;
...
#[no_mangle]
unsafe extern "C" fn siox_poll_thread(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __siox_start(smaster: *mut siox_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siox_start(smaster: *mut siox_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __siox_stop(smaster: *mut siox_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siox_stop(smaster: *mut siox_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siox_device_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn siox_match(dev: *mut device, drv: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siox_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siox_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn siox_shutdown(dev: *mut device) {
    ...
    int ret;
    char type[20] = "";
    let mut inbytes: usize = 0, outbytes = 0;
...
#[no_mangle]
unsafe extern "C" fn siox_master_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn devm_siox_master_put(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn siox_master_register(smaster: *mut siox_master) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn siox_master_unregister(smaster: *mut siox_master) {
...
#[no_mangle]
unsafe extern "C" fn devm_siox_master_unregister(data: *mut c_void) {
...
#[no_mangle]
pub unsafe extern "C" fn devm_siox_master_register(dev: *mut device, smaster: *mut siox_master) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siox_device_remove(smaster: *mut siox_master) {
    static void siox_device_remove(struct siox_master *smaster)
    {
    struct siox_device *sdevice;
    siox_master_lock(smaster);
...
#[no_mangle]
pub unsafe extern "C" fn __siox_driver_register(sdriver: *mut siox_driver, owner: *mut module) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn siox_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn siox_exit() -> void __exit {
