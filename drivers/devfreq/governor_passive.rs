...
//! Source: drivers/devfreq/governor_passive.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devfreq_cpu_data {
    pub node: list_head,
    pub dev: *mut device,
    pub first_cpu: c_uint,
...
#[no_mangle]
unsafe extern "C" fn delete_parent_cpu_data(p_data: *mut devfreq_passive_data) {
    ...
    unsigned long *freq)
    {
    struct dev_pm_opp *opp = core::ptr::null_mut(), *p_opp = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cpufreq_passive_unregister_notifier(devfreq: *mut devfreq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cpufreq_passive_register_notifier(devfreq: *mut devfreq) -> c_int {
    static int cpufreq_passive_register_notifier(struct devfreq *devfreq)
    {
    struct devfreq_passive_data *p_data
    = (struct devfreq_passive_data *)devfreq.data;
    struct device *dev = devfreq.dev.parent;
    struct opp_table *opp_table = core::ptr::null_mut();
    struct devfreq_cpu_data *parent_cpu_data;
    struct cpufreq_policy *policy;
    ...
    p_data.nb.notifier_call = core::ptr::null_mut();
    goto err;
    }
    ...
    let mut freq: c_ulong = freqs.new;
    let mut ret: c_int = 0;
...
#[no_mangle]
unsafe extern "C" fn devfreq_passive_unregister_notifier(devfreq: *mut devfreq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devfreq_passive_register_notifier(devfreq: *mut devfreq) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(CPUFREQ_PARENT_DEV: p_data->parent_type ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn devfreq_passive_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn devfreq_passive_exit() -> void __exit {
