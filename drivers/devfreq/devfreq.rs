...
//! Source: drivers/devfreq/devfreq.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn find_available_min_freq(devfreq: *mut devfreq) -> c_ulong {
    static unsigned long find_available_min_freq(struct devfreq *devfreq)
    {
    struct dev_pm_opp *opp;
    let mut min_freq: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn find_available_max_freq(devfreq: *mut devfreq) -> c_ulong {
...
//
#[no_mangle]
unsafe extern "C" fn devfreq_get_freq_level(devfreq: *mut devfreq, freq: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_freq_table(devfreq: *mut devfreq) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_update_status(devfreq: *mut devfreq, freq: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_update_target(devfreq: *mut devfreq, freq: c_ulong) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn update_devfreq(devfreq: *mut devfreq) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn devfreq_monitor(work: *mut work_struct) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_monitor_start(devfreq: *mut devfreq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_monitor_stop(devfreq: *mut devfreq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_monitor_suspend(devfreq: *mut devfreq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_monitor_resume(devfreq: *mut devfreq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_update_interval(devfreq: *mut devfreq, delay: *mut c_uint) {
    void devfreq_update_interval(struct devfreq *devfreq, unsigned int *delay)
    {
    let mut cur_delay: c_uint = devfreq.profile.polling_ms;
    let mut new_delay: c_uint = *delay;
    mutex_lock(&devfreq.lock);
...
//
#[no_mangle]
unsafe extern "C" fn qos_notifier_call(devfreq: *mut devfreq) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn devfreq_dev_release(dev: *mut device) {
...
//
    ...
    devfreq.opp_table = core::ptr::null_mut();
    ...
    devfreq.cdev = devfreq_cooling_em_register(devfreq, core::ptr::null_mut());
    if (IS_ERR(devfreq.cdev))
    devfreq.cdev = core::ptr::null_mut();
    }
    return devfreq;
    err_init:
    mutex_unlock(&devfreq_list_lock);
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_remove_device(devfreq: *mut devfreq) -> c_int {
    ...
    DEVFREQ_GOV_STOP, core::ptr::null_mut());
    device_unregister(&devfreq.dev);
    return 0;
    }
    EXPORT_SYMBOL(devfreq_remove_device);
#[no_mangle]
unsafe extern "C" fn devm_devfreq_dev_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_devfreq_dev_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devm_devfreq_remove_device(dev: *mut device, devfreq: *mut devfreq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_suspend_device(devfreq: *mut devfreq) -> c_int {
    ...
    DEVFREQ_GOV_SUSPEND, core::ptr::null_mut());
    if (ret)
    return ret;
    }
    if (devfreq.suspend_freq) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_resume_device(devfreq: *mut devfreq) -> c_int {
    ...
    if (devfreq.governor) {
    ret = devfreq.governor.event_handler(devfreq,
    DEVFREQ_GOV_RESUME, core::ptr::null_mut());
    if (ret)
    return ret;
    }
    return 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_suspend() {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_resume() {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_add_governor(governor: *mut devfreq_governor) -> c_int {
...
// Fall through
    ...
    devfreq.governor = governor;
    ret = devfreq.governor.event_handler(devfreq,
    DEVFREQ_GOV_START, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn devm_devfreq_remove_governor(governor: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_remove_governor(governor: *mut devfreq_governor) -> c_int {
    ...
    devfreq.governor = core::ptr::null_mut();
    }
    }
...
//
    ret = df.governor.event_handler(df, DEVFREQ_GOV_STOP, core::ptr::null_mut());
    if (ret) {
...
//
    ...
    ret = df.governor.event_handler(df, DEVFREQ_GOV_START, core::ptr::null_mut());
    if (ret) {
...
//
#[no_mangle]
unsafe extern "C" fn devfreq_summary_show(s: *mut seq_file, data: *mut c_void) -> c_int {
    static int devfreq_summary_show(struct seq_file *s, void *data)
    {
    struct devfreq *devfreq;
    struct devfreq *p_devfreq = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn devfreq_init() -> int __init {
    ...
    devfreq_debugfs = debugfs_create_dir("devfreq", core::ptr::null_mut());
    debugfs_create_file("devfreq_summary", 0444,
    devfreq_debugfs, core::ptr::null_mut(),
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_register_opp_notifier(dev: *mut device, devfreq: *mut devfreq) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_unregister_opp_notifier(dev: *mut device, devfreq: *mut devfreq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_devfreq_opp_release(dev: *mut device, res: *mut c_void) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct devfreq_notifier_devres {
...
#[no_mangle]
unsafe extern "C" fn devm_devfreq_notifier_release(dev: *mut device, res: *mut c_void) {
