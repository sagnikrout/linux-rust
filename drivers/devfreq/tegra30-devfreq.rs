...
//! Source: drivers/devfreq/tegra30-devfreq.c
#![no_std]
...
pub const ACTMON_GLB_STATUS: c_uint = 0x0;
pub const ACTMON_GLB_PERIOD_CTRL: c_uint = 0x4;
pub const ACTMON_DEV_CTRL: c_uint = 0x0;
pub const ACTMON_DEV_CTRL_K_VAL_SHIFT: c_int = 10;

pub const ACTMON_DEV_CTRL_CONSECUTIVE_BELOW_WMARK_NUM_SHIFT: c_int = 23;
pub const ACTMON_DEV_CTRL_CONSECUTIVE_ABOVE_WMARK_NUM_SHIFT: c_int = 26;

pub const ACTMON_DEV_CTRL_STOP: c_uint = 0x00000000;
pub const ACTMON_DEV_UPPER_WMARK: c_uint = 0x4;
pub const ACTMON_DEV_LOWER_WMARK: c_uint = 0x8;
pub const ACTMON_DEV_INIT_AVG: c_uint = 0xc;
pub const ACTMON_DEV_AVG_UPPER_WMARK: c_uint = 0x10;
pub const ACTMON_DEV_AVG_LOWER_WMARK: c_uint = 0x14;
pub const ACTMON_DEV_COUNT_WEIGHT: c_uint = 0x18;
pub const ACTMON_DEV_AVG_COUNT: c_uint = 0x20;
pub const ACTMON_DEV_INTR_STATUS: c_uint = 0x24;
pub const ACTMON_INTR_STATUS_CLEAR: c_uint = 0xffffffff;

pub const ACTMON_ABOVE_WMARK_WINDOW: c_int = 1;
pub const ACTMON_BELOW_WMARK_WINDOW: c_int = 3;
pub const ACTMON_BOOST_FREQ_STEP: c_int = 16000;
//
// ACTMON_AVERAGE_WINDOW_LOG2: default value for @DEV_CTRL_K_VAL, which
// translates to 2 ^ (K_VAL + 1). ex: 2 ^ (6 + 1) = 128
//
pub const ACTMON_AVERAGE_WINDOW_LOG2: c_int = 6;

pub const KHZ: c_int = 1000;

// Assume that the bus is saturated if the utilization is 25%
pub const BUS_SATURATION_RATIO: c_int = 25;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_devfreq_device_config {
    pub offset: u32,
    pub irq_mask: u32,
// Factors applied to boost_freq every consecutive watermark breach
    pub boost_up_coeff: c_uint,
    pub boost_down_coeff: c_uint,
// Define the watermark bounds when applied to the current avg
    pub boost_up_threshold: c_uint,
    pub boost_down_threshold: c_uint,
//
...
//
    pub avg_dependency_threshold: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_devfreq_device {
    pub config: *const tegra_devfreq_device_config,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_devfreq_soc_data {
    pub configs: *const tegra_devfreq_device_config,
// Weight value for count measurements
    pub count_weight: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_devfreq {
    pub devfreq: *mut devfreq,
    pub reset: *mut reset_control,
    pub clock: *mut clk,
    pub regs: *mut void __iomem,
    pub emc_clock: *mut clk,
    pub max_freq: c_ulong,
    pub cur_freq: c_ulong,
    pub clk_rate_change_nb: notifier_block,
    pub cpufreq_update_work: delayed_work,
    pub cpu_rate_change_nb: notifier_block,
    pub devices: [tegra_devfreq_device; 2],
    pub irq: c_uint,
    pub started: bool,
    pub soc: *const tegra_devfreq_soc_data,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tegra_actmon_emc_ratio {
    pub cpu_freq: c_ulong,
    pub emc_freq: c_ulong,
}
...
#[no_mangle]
unsafe extern "C" fn actmon_readl(tegra: *mut tegra_devfreq, offset: u32) -> u32 {
    static u32 actmon_readl(struct tegra_devfreq *tegra, u32 offset)
    {
    return readl_relaxed(tegra.regs + offset);
    }
#[no_mangle]
unsafe extern "C" fn actmon_writel(tegra: *mut tegra_devfreq, val: u32, offset: u32) {
    static void actmon_writel(struct tegra_devfreq *tegra, u32 val, u32 offset)
    {
    writel_relaxed(val, tegra.regs + offset);
    }
#[no_mangle]
unsafe extern "C" fn device_readl(dev: *mut tegra_devfreq_device, offset: u32) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn do_percent(val: c_ulonglong, pct: c_uint) -> c_ulong {
...
//
    ...
    {
    let mut avg_band_freq: u32 = tegra.max_freq * ACTMON_DEFAULT_AVG_BAND / KHZ;
    let mut band: u32 = avg_band_freq * tegra.devfreq.profile.polling_ms;
    u32 avg;
    ...
    struct tegra_devfreq_device *dev)
    {
    let mut val: u32 = tegra.cur_freq * tegra.devfreq.profile.polling_ms;
...
//
    ...
    struct tegra_devfreq_device *dev)
    {
    let mut cpu_freq: c_ulong = 0;
    let mut static_cpu_emc_freq: c_ulong = 0;
...
#[no_mangle]
unsafe extern "C" fn actmon_thread_isr(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tegra_actmon_delayed_update(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tegra_actmon_stop_devices(tegra: *mut tegra_devfreq) {
...
#[no_mangle]
unsafe extern "C" fn tegra_actmon_resume(tegra: *mut tegra_devfreq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_actmon_start(tegra: *mut tegra_devfreq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tegra_actmon_pause(tegra: *mut tegra_devfreq) {
...
#[no_mangle]
unsafe extern "C" fn tegra_actmon_stop(tegra: *mut tegra_devfreq) {
...
#[no_mangle]
unsafe extern "C" fn devm_tegra_devfreq_deinit_hw(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tegra_devfreq_probe(pdev: *mut platform_device) -> c_int {
    ...
    long rate;
    int err;
    const char *clk_names[] = { "actmon", core::ptr::null_mut() };
    ...
    err = devm_request_threaded_irq(&pdev.dev, tegra.irq, core::ptr::null_mut(),
    ...
    "tegra_actmon", core::ptr::null_mut());
    if (IS_ERR(devfreq)) {
