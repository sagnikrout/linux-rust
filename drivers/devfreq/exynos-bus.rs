...
//! Source: drivers/devfreq/exynos-bus.c
#![no_std]
...
pub const DEFAULT_SATURATION_RATIO: c_int = 40;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct exynos_bus {
    pub dev: *mut device,
    pub icc_pdev: *mut platform_device,
    pub devfreq: *mut devfreq,
    pub edev: *mut devfreq_event_dev,
    pub edev_count: c_uint,
    pub lock: mutex,
    pub curr_freq: c_ulong,
    pub opp_token: c_int,
    pub clk: *mut clk,
    pub ratio: c_uint,
}
...
//
    ...
    let mut load_count: c_ulong = 0, total_count = 0;
    int i, ret = 0;
    for (i = 0; i < bus.edev_count; i++) {
    if (!bus.edev[i])
    continue;
...
//
#[no_mangle]
unsafe extern "C" fn exynos_bus_target(dev: *mut device, freq: *mut c_ulong, flags: u32) -> c_int {
...
unsafe extern "C" fn exynos_bus_passive_exit(dev: *mut device) {
    ...
    const char *supplies[] = { "vdd", core::ptr::null_mut() };
...
#[no_mangle]
unsafe extern "C" fn exynos_bus_parse_of(bus: *mut exynos_bus) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_bus_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_bus_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn exynos_bus_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn exynos_bus_suspend(dev: *mut device) -> c_int {
