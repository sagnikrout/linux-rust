...
//! Source: drivers/devfreq/hisi_uncore_freq.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_uncore_pcc_data {
    pub status: u16,
    pub resv: u16,
    pub data: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_uncore_pcc_shmem {
    pub head: acpi_pcct_shared_memory,
    pub pcc_data: hisi_uncore_pcc_data,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct hisi_uncore_freq {
    pub dev: *mut device,
    pub cl: mbox_client,
    pub pchan: *mut pcc_mbox_chan,
    pub chan_id: c_int,
    pub last_cmd_cmpl_time: ktime_t,
    pub pcc_lock: mutex,
    pub devfreq: *mut devfreq,
    pub related_cpus: cpumask,
    pub cap: u32,
}

// PCC channel timeout = PCC nominal latency * NUM
pub const HUCF_PCC_POLL_TIMEOUT_NUM: c_int = 1000;
pub const HUCF_PCC_POLL_INTERVAL_US: c_int = 5;
// Default polling interval in ms for devfreq governors
pub const HUCF_DEFAULT_POLLING_MS: c_int = 100;
#[no_mangle]
unsafe extern "C" fn hisi_uncore_free_pcc_chan(uncore: *mut hisi_uncore_freq) {
...
#[no_mangle]
unsafe extern "C" fn devm_hisi_uncore_free_pcc_chan(data: *mut c_void) {
    static void devm_hisi_uncore_free_pcc_chan(void *data)
    {
    hisi_uncore_free_pcc_chan(data);
    }
#[no_mangle]
unsafe extern "C" fn hisi_uncore_request_pcc_chan(uncore: *mut hisi_uncore_freq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_uncore_init_pcc_chan(uncore: *mut hisi_uncore_freq) -> c_int {
    static int hisi_uncore_init_pcc_chan(struct hisi_uncore_freq *uncore)
    {
    let mut handle: acpi_handle = ACPI_HANDLE(uncore.dev);
    acpi_status status;
    int rc;
    uncore.chan_id = -1;
...
#[no_mangle]
unsafe extern "C" fn hisi_uncore_get_cur_freq(dev: *mut device, freq: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_hisi_uncore_remove_opp(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn hisi_uncore_init_opp(uncore: *mut hisi_uncore_freq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_platform_gov_func(df: *mut devfreq, freq: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_uncore_remove_platform_gov(uncore: *mut hisi_uncore_freq) {
    static void hisi_uncore_remove_platform_gov(struct hisi_uncore_freq *uncore)
    {
    let mut data: u32 = HUCF_MODE_PLATFORM;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn devm_hisi_uncore_remove_platform_gov(data: *mut c_void) {
    static void devm_hisi_uncore_remove_platform_gov(void *data)
    {
    hisi_uncore_remove_platform_gov(data);
    }
#[no_mangle]
unsafe extern "C" fn hisi_uncore_add_platform_gov(uncore: *mut hisi_uncore_freq) -> c_int {
    ...
    guard(mutex)(&hisi_platform_gov_usage_lock);
    if (hisi_platform_gov_usage == 0) {
    let mut rc: c_int = devfreq_add_governor(&hisi_platform_governor);
    if (rc)
    return rc;
    }
...
#[no_mangle]
unsafe extern "C" fn get_package_id(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_cluster_id(cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_uncore_mark_related_cpus_wrap(uncore: *mut hisi_uncore_freq) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hisi_uncore_devfreq_register(uncore: *mut hisi_uncore_freq) -> c_int {
...
// profile = (struct devfreq_dev_profile) {
    ...
    hisi_platform_governor.name, core::ptr::null_mut());
    else
    uncore.devfreq = devm_devfreq_add_device(dev, profile,
    DEVFREQ_GOV_PERFORMANCE, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn hisi_uncore_freq_probe(pdev: *mut platform_device) -> c_int {
