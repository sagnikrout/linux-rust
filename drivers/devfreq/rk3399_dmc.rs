...
//! Source: drivers/devfreq/rk3399_dmc.c
#![no_std]
...
pub struct rk3399_dmcfreq {
    ...
    pub lock: mutex,
    pub vdd_center: *mut regulator,
    pub regmap_pmu: *mut regmap,
    pub target_rate: unsigned long rate,,
    pub target_volt: unsigned long volt,,
    pub odt_dis_freq: c_uint,
    pub pd_idle_ns: c_uint,
    pub sr_idle_ns: c_uint,
    pub sr_mc_gate_idle_ns: c_uint,
    pub srpd_lite_idle_ns: c_uint,
    pub standby_idle_ns: c_uint,
    pub ddr3_odt_dis_freq: c_uint,
    pub lpddr3_odt_dis_freq: c_uint,
    pub lpddr4_odt_dis_freq: c_uint,
    pub pd_idle_dis_freq: c_uint,
    pub sr_idle_dis_freq: c_uint,
    pub sr_mc_gate_idle_dis_freq: c_uint,
    pub srpd_lite_idle_dis_freq: c_uint,
    pub standby_idle_dis_freq: c_uint,
}
    ...
    let mut old_clk_rate: c_ulong = dmcfreq.rate;
    unsigned long target_volt, target_rate;
    unsigned int ddrcon_mhz;
    struct arm_smccc_res res;
    int err;
    let mut odt_pd_arg0: u32 = 0;
    let mut odt_pd_arg1: u32 = 0;
    let mut odt_pd_arg2: u32 = 0;
...
#[no_mangle]
unsafe extern "C" fn rk3399_dmcfreq_get_cur_freq(dev: *mut device, freq: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3399_dmcfreq_suspend(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn rk3399_dmcfreq_resume(dev: *mut device) -> __maybe_unused int {
...
#[no_mangle]
unsafe extern "C" fn rk3399_dmcfreq_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3399_dmcfreq_remove(pdev: *mut platform_device) {
