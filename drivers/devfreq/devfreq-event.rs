...
//! Source: drivers/devfreq/devfreq-event.c
#![no_std]
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_event_enable_edev(edev: *mut devfreq_event_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_event_disable_edev(edev: *mut devfreq_event_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_event_is_enabled(edev: *mut devfreq_event_dev) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_event_set_event(edev: *mut devfreq_event_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_event_reset_event(edev: *mut devfreq_event_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_event_get_edev_count(dev: *mut device, phandle_name: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devfreq_event_release_edev(dev: *mut device) {
...
//
    ...
    {
    struct devfreq_event_dev *edev;
    let mut event_no: static atomic_t = ATOMIC_INIT(-1);
    int ret;
    if (!dev || !desc)
    return ERR_PTR(-EINVAL);
...
//
#[no_mangle]
pub unsafe extern "C" fn devfreq_event_remove_edev(edev: *mut devfreq_event_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_devfreq_event_match(dev: *mut device, res: *mut c_void, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn devm_devfreq_event_release(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn devfreq_event_init() -> int __init {
