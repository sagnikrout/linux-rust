...
//! Source: drivers/devfreq/imx-bus.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn imx_bus_get_cur_freq(dev: *mut device, freq: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx_bus_exit(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn imx_bus_init_icc(dev: *mut device) -> c_int {
    ...
    dev, icc_driver_name, -1, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn imx_bus_probe(pdev: *mut platform_device) -> c_int {
