...
//! Source: drivers/devfreq/imx8m-ddrc.c
#![no_std]
...
pub const IMX_SIP_DDR_DVFS: c_uint = 0xc2000004;
// Query available frequencies.
pub const IMX_SIP_DDR_DVFS_GET_FREQ_COUNT: c_uint = 0x10;
pub const IMX_SIP_DDR_DVFS_GET_FREQ_INFO: c_uint = 0x11;
//
...
// Hardware limitation
pub const IMX8M_DDRC_MAX_FREQ_COUNT: c_int = 4;
//
...
// For frequency switching:
    ...
    pub freq_table: [imx8m_ddrc_freq; IMX8M_DDRC_MAX_FREQ_COUNT],
}
...
#[no_mangle]
unsafe extern "C" fn imx8m_ddrc_smc_set_freq(target_freq: c_int) {
...
// change the ddr freqency
    ...
    return hw ? hw.clk : core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn imx8m_ddrc_set_freq(dev: *mut device, freq: *mut imx8m_ddrc_freq) -> c_int {
...
//
    ...
    new_dram_alt_parent = core::ptr::null_mut();
    ...
    new_dram_apb_parent = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn imx8m_ddrc_target(dev: *mut device, freq: *mut c_ulong, flags: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(new_freq: *mut *mut freq !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn imx8m_ddrc_get_cur_freq(dev: *mut device, freq: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8m_ddrc_init_freq_info(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8m_ddrc_check_opps(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn imx8m_ddrc_exit(dev: *mut device) {
    static void imx8m_ddrc_exit(struct device *dev)
    {
    dev_pm_opp_of_remove_table(dev);
    }
#[no_mangle]
unsafe extern "C" fn imx8m_ddrc_probe(pdev: *mut platform_device) -> c_int {
