...
//! Source: drivers/devfreq/event/rockchip-dfi.c
#![no_std]
...
pub const DMC_MAX_CHANNELS: c_int = 4;
// DDRMON_CTRL
pub const DDRMON_CTRL: c_uint = 0x04;

pub const DDRMON_CH0_WR_NUM: c_uint = 0x20;
pub const DDRMON_CH0_RD_NUM: c_uint = 0x24;
pub const DDRMON_CH0_COUNT_NUM: c_uint = 0x28;
pub const DDRMON_CH0_DFI_ACCESS_NUM: c_uint = 0x2c;
pub const DDRMON_CH1_COUNT_NUM: c_uint = 0x3c;
pub const DDRMON_CH1_DFI_ACCESS_NUM: c_uint = 0x40;
pub const PERF_EVENT_CYCLES: c_uint = 0x0;
pub const PERF_EVENT_READ_BYTES: c_uint = 0x1;
pub const PERF_EVENT_WRITE_BYTES: c_uint = 0x2;
pub const PERF_EVENT_READ_BYTES0: c_uint = 0x3;
pub const PERF_EVENT_WRITE_BYTES0: c_uint = 0x4;
pub const PERF_EVENT_READ_BYTES1: c_uint = 0x5;
pub const PERF_EVENT_WRITE_BYTES1: c_uint = 0x6;
pub const PERF_EVENT_READ_BYTES2: c_uint = 0x7;
pub const PERF_EVENT_WRITE_BYTES2: c_uint = 0x8;
pub const PERF_EVENT_READ_BYTES3: c_uint = 0x9;
pub const PERF_EVENT_WRITE_BYTES3: c_uint = 0xa;
pub const PERF_EVENT_BYTES: c_uint = 0xb;
pub const PERF_ACCESS_TYPE_MAX: c_uint = 0xc;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct dmc_count {
    pub c: [dmc_count_channel; DMC_MAX_CHANNELS],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct rockchip_dfi {
    pub edev: *mut devfreq_event_dev,
    pub desc: devfreq_event_desc,
    pub last_event_count: dmc_count,
    pub last_perf_count: dmc_count,
    pub total_count: dmc_count,
    pub /: *mut *mut seqlock_t count_seqlock; / protects last_perf_count and total_count,
    pub dev: *mut device,
    ...
    pub burst_len: c_int,
    pub buswidth: [c_int; DMC_MAX_CHANNELS],
    pub ddrmon_stride: c_int,
    pub ddrmon_ctrl_single: bool,
    pub lp5_bank_mode: u32,
    pub /: *mut *mut bool lp5_ckr; / true if in 4:1 command-to-data clock ratio mode,
    pub /: *mut *mut unsigned int count_multiplier; / number of data clocks per count,
}

#[no_mangle]
unsafe extern "C" fn rockchip_dfi_ddrtype_to_ctrl(dfi: *mut rockchip_dfi, ctrl: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dfi_enable(dfi: *mut rockchip_dfi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dfi_disable(dfi: *mut rockchip_dfi) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dfi_read_counters(dfi: *mut rockchip_dfi, res: *mut dmc_count) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dfi_event_disable(edev: *mut devfreq_event_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dfi_event_enable(edev: *mut devfreq_event_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dfi_set_event(edev: *mut devfreq_event_dev) -> c_int {
    ...
    let mut access: u32 = 0, clock_cycles = 0;
    int i;
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_event_init(event: *mut perf_event) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_event_get_count(event: *mut perf_event) -> u64 {
    static u64 rockchip_ddr_perf_event_get_count(struct perf_event *event)
    {
    struct rockchip_dfi *dfi = container_of(event.pmu, struct rockchip_dfi, pmu);
    let mut blen: c_int = dfi.burst_len;
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_event_update(event: *mut perf_event) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_event_start(event: *mut perf_event, flags: c_int) {
    static void rockchip_ddr_perf_event_start(struct perf_event *event, int flags)
    {
    let mut now: u64 = rockchip_ddr_perf_event_get_count(event);
    local64_set(&event.hw.prev_count, now);
    }
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_event_add(event: *mut perf_event, flags: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_event_stop(event: *mut perf_event, flags: c_int) {
    static void rockchip_ddr_perf_event_stop(struct perf_event *event, int flags)
    {
    rockchip_ddr_perf_event_update(event);
    }
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_event_del(event: *mut perf_event, flags: c_int) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dfi_timer(timer: *mut hrtimer) -> enum hrtimer_restart {
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_cpuhp_remove_state(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_cpuhp_remove_instance(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn rockchip_ddr_perf_init(dfi: *mut rockchip_dfi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3399_dfi_init(dfi: *mut rockchip_dfi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3568_dfi_init(dfi: *mut rockchip_dfi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rk3588_dfi_init(dfi: *mut rockchip_dfi) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rockchip_dfi_probe(pdev: *mut platform_device) -> c_int {
