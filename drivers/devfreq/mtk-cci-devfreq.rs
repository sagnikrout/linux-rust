...
//! Source: drivers/devfreq/mtk-cci-devfreq.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mtk_ccifreq_platform_data {
...
pub struct mtk_ccifreq_drv {
    ...
    pub inter_voltage: c_int,
    pub pre_freq: c_ulong,
// Avoid race condition for regulators between notify and policy
    pub reg_lock: mutex,
    pub opp_nb: notifier_block,
    pub soc_data: *const mtk_ccifreq_platform_data,
    pub vtrack_max: c_int,
}

#[no_mangle]
unsafe extern "C" fn mtk_ccifreq_set_voltage(drv: *mut mtk_ccifreq_drv, new_voltage: c_int) -> c_int {
    ...
    let mut retry_max: c_int = drv.vtrack_max;
    if (!drv.sram_reg) {
...
#[no_mangle]
unsafe extern "C" fn mtk_ccifreq_probe(pdev: *mut platform_device) -> c_int {
    ...
    drv.sram_reg = core::ptr::null_mut();
    } else {
...
#[no_mangle]
unsafe extern "C" fn mtk_ccifreq_remove(pdev: *mut platform_device) {
