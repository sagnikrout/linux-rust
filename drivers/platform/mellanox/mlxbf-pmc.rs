...
//! Source: drivers/platform/mellanox/mlxbf-pmc.c
#![no_std]
...
pub const MLXBF_PMC_WRITE_REG_32: c_uint = 0x82000009;
pub const MLXBF_PMC_READ_REG_32: c_uint = 0x8200000A;
pub const MLXBF_PMC_WRITE_REG_64: c_uint = 0x8200000B;
pub const MLXBF_PMC_READ_REG_64: c_uint = 0x8200000C;
pub const MLXBF_PMC_SIP_SVC_UID: c_uint = 0x8200ff01;
pub const MLXBF_PMC_SIP_SVC_VERSION: c_uint = 0x8200ff03;
pub const MLXBF_PMC_SVC_REQ_MAJOR: c_int = 0;
pub const MLXBF_PMC_SVC_MIN_MINOR: c_int = 3;

pub const MLXBF_PMC_EVENT_SET_BF1: c_int = 0;
pub const MLXBF_PMC_EVENT_SET_BF2: c_int = 1;
pub const MLXBF_PMC_EVENT_SET_BF3: c_int = 2;
pub const MLXBF_PMC_EVENT_INFO_LEN: c_int = 100;
pub const MLXBF_PMC_MAX_BLOCKS: c_int = 40;
pub const MLXBF_PMC_MAX_ATTRS: c_int = 70;
pub const MLXBF_PMC_INFO_SZ: c_int = 4;
pub const MLXBF_PMC_REG_SIZE: c_int = 8;
pub const MLXBF_PMC_L3C_REG_SIZE: c_int = 4;
pub const MLXBF_PMC_TYPE_CRSPACE: c_int = 2;
pub const MLXBF_PMC_TYPE_COUNTER: c_int = 1;
pub const MLXBF_PMC_TYPE_REGISTER: c_int = 0;
pub const MLXBF_PMC_PERFCTL: c_int = 0;
pub const MLXBF_PMC_PERFEVT: c_int = 1;
pub const MLXBF_PMC_PERFACC0: c_int = 4;

pub const MLXBF_PMC_L3C_PERF_CNT_CFG: c_uint = 0x0;
pub const MLXBF_PMC_L3C_PERF_CNT_SEL: c_uint = 0x10;
pub const MLXBF_PMC_L3C_PERF_CNT_SEL_1: c_uint = 0x14;
pub const MLXBF_PMC_L3C_PERF_CNT_LOW: c_uint = 0x40;
pub const MLXBF_PMC_L3C_PERF_CNT_HIGH: c_uint = 0x60;

pub const MLXBF_PMC_CRSPACE_PERFMON_REG0: c_uint = 0x0;
pub const MLXBF_PMC_CRSPACE_PERFSEL_SZ: c_int = 4;

pub const MLXBF_PMC_CRSPACE_PERFMON_REG0_SZ: c_uint = 0x2;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_pmc_attribute {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_pmc_block_info {
    pub mmio_base: *mut void __iomem,
    pub blk_size: usize,
    pub counters: usize,
    pub type: c_uint,
    pub attr_counter: *mut mlxbf_pmc_attribute,
    pub attr_event: *mut mlxbf_pmc_attribute,
    pub attr_event_list: mlxbf_pmc_attribute,
    pub attr_enable: mlxbf_pmc_attribute,
    pub attr_count_clock: mlxbf_pmc_attribute,
    pub block_attr: [*mut attribute; MLXBF_PMC_MAX_ATTRS],
    pub block_attr_grp: attribute_group,
}
...
pub struct mlxbf_pmc_context {
    ...
    pub block_name: [*const c_char; MLXBF_PMC_MAX_BLOCKS],
    pub block: [mlxbf_pmc_block_info; MLXBF_PMC_MAX_BLOCKS],
    pub groups: [*const attribute_group; MLXBF_PMC_MAX_BLOCKS],
    pub svc_sreg_support: bool,
    pub sreg_tbl_perf: u32,
    pub event_set: c_uint,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_pmc_events {
    pub evt_num: u32,
    pub evt_name: *mut c_char,
}
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_secure_read(addr: *mut void __iomem, command: u32, result: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_read(addr: *mut void __iomem, command: u32, result: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_readl(addr: *mut void __iomem, result: *mut u32) -> c_int {
...
// Calls an SMC to access a performance register
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_secure_write(addr: *mut void __iomem, command: u32, value: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_write(addr: *mut void __iomem, command: c_int, value: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_valid_range(blk_num: c_uint, offset: u32) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_event_supported(blk: *const c_char) -> bool {
    static bool mlxbf_pmc_event_supported(const char *blk)
    {
    return !!mlxbf_pmc_event_list(blk, core::ptr::null_mut());
    }
// Get the event number given the name
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_get_event_num(blk: *const c_char, evt: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_config_l3_counters(blk_num: c_uint, enable: bool, reset: bool) -> c_int {
    static int mlxbf_pmc_config_l3_counters(unsigned int blk_num, bool enable, bool reset)
    {
    let mut perfcnt_cfg: u32 = 0;
    if (enable)
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_program_l3_counter(blk_num: c_uint, cnt_num: u32, evt: u32) -> c_int {
    static int mlxbf_pmc_program_l3_counter(unsigned int blk_num, u32 cnt_num, u32 evt)
    {
    let mut perfcnt_sel_1: u32 = 0, perfcnt_sel = 0, *wordaddr;
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_program_crspace_counter(blk_num: c_uint, cnt_num: u32, evt: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_clear_crspace_counter(blk_num: c_uint, cnt_num: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_program_counter(blk_num: c_uint, cnt_num: u32, evt: u32, is_l3: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_read_l3_counter(blk_num: c_uint, cnt_num: u32, result: *mut u64) -> c_int {
    static int mlxbf_pmc_read_l3_counter(unsigned int blk_num, u32 cnt_num, u64 *result)
    {
    let mut perfcnt_low: u32 = 0, perfcnt_high = 0;
    int status;
    u64 value;
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_read_crspace_counter(blk_num: c_uint, cnt_num: u32, result: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_read_counter(blk_num: c_uint, cnt_num: u32, is_l3: bool, result: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_read_l3_event(blk_num: c_uint, cnt_num: u32, result: *mut u64) -> c_int {
    static int mlxbf_pmc_read_l3_event(unsigned int blk_num, u32 cnt_num, u64 *result)
    {
    let mut perfcnt_sel: u32 = 0, perfcnt_sel_1 = 0, *wordaddr;
    void __iomem *pmcaddr;
    u64 evt;
// Select appropriate register information
    switch (cnt_num) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_read_crspace_event(blk_num: c_uint, cnt_num: u32, result: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_read_event(blk_num: c_uint, cnt_num: u32, is_l3: bool, result: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_read_reg(blk_num: c_uint, offset: u32, result: *mut u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_write_reg(blk_num: c_uint, offset: u32, data: u64) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_init_perftype_reg(dev: *mut device, blk_num: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_create_groups(dev: *mut device, blk_num: c_uint) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(MLXBF_PMC_TYPE_REGISTER: pmc->block[blk_num].type ==) -> else {
    else if (pmc.block[blk_num].type == MLXBF_PMC_TYPE_REGISTER)
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_map_counters(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_pmc_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(hid, _arg: "MLNXBFD1")) -> else {
    else if (!strcmp(hid, "MLNXBFD1"))
    pmc.event_set = MLXBF_PMC_EVENT_SET_BF2;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: !strcmp(hid, _arg: "MLNXBFD2")) -> else {
