...
//! Source: drivers/platform/mellanox/mlxreg-lc.c
#![no_std]
...
// I2C bus IO offsets
pub const MLXREG_LC_REG_CPLD1_VER_OFFSET: c_uint = 0x2500;
pub const MLXREG_LC_REG_FPGA1_VER_OFFSET: c_uint = 0x2501;
pub const MLXREG_LC_REG_CPLD1_PN_OFFSET: c_uint = 0x2504;
pub const MLXREG_LC_REG_FPGA1_PN_OFFSET: c_uint = 0x2506;
pub const MLXREG_LC_REG_RESET_CAUSE_OFFSET: c_uint = 0x251d;
pub const MLXREG_LC_REG_LED1_OFFSET: c_uint = 0x2520;
pub const MLXREG_LC_REG_GP0_OFFSET: c_uint = 0x252e;
pub const MLXREG_LC_REG_FIELD_UPGRADE: c_uint = 0x2534;
pub const MLXREG_LC_CHANNEL_I2C_REG: c_uint = 0x25dc;
pub const MLXREG_LC_REG_CPLD1_MVER_OFFSET: c_uint = 0x25de;
pub const MLXREG_LC_REG_FPGA1_MVER_OFFSET: c_uint = 0x25df;
pub const MLXREG_LC_REG_MAX_POWER_OFFSET: c_uint = 0x25f1;
pub const MLXREG_LC_REG_CONFIG_OFFSET: c_uint = 0x25fb;
pub const MLXREG_LC_REG_MAX: c_uint = 0x3fff;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxreg_lc {
    pub dev: *mut device,
    pub /: *mut *mut mutex lock; / line card access lock,
    pub par_regmap: *mut c_void,
    pub data: *mut mlxreg_core_data,
    pub io_data: *mut mlxreg_core_platform_data,
    pub led_data: *mut mlxreg_core_platform_data,
    pub mux_data: *mut mlxcpld_mux_plat_data,
    pub led: *mut platform_device,
    pub io_regs: *mut platform_device,
    pub mux_brdinfo: *mut i2c_board_info,
    pub mux: *mut platform_device,
    pub aux_devs: *mut mlxreg_hotplug_device,
    pub aux_devs_num: c_int,
    pub main_devs: *mut mlxreg_hotplug_device,
    pub main_devs_num: c_int,
    pub state: enum mlxreg_lc_state,
}

#[no_mangle]
unsafe extern "C" fn mlxreg_lc_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_lc_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_lc_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_lc_power_on_off(mlxreg_lc: *mut mlxreg_lc, action: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_lc_enable_disable(mlxreg_lc: *mut mlxreg_lc, action: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn mlxreg_lc_event_handler(handle: *mut c_void, kind: enum mlxreg_hotplug_kind, action: u8) -> c_int {
...
// Create mux infrastructure.
    ...
    core::ptr::null_mut(), 0, mlxreg_lc.mux_data,
...
// Register IO access driver.
    ...
    mlxreg_lc.io_regs =
    platform_device_register_resndata(dev, "mlxreg-io", data.hpdev.nr, core::ptr::null_mut(), 0,
...
// Register LED driver.
    ...
    mlxreg_lc.led =
    platform_device_register_resndata(dev, "leds-mlxreg", data.hpdev.nr, core::ptr::null_mut(), 0,
    mlxreg_lc.led_data,
...
#[no_mangle]
unsafe extern "C" fn mlxreg_lc_config_exit(mlxreg_lc: *mut mlxreg_lc) {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_lc_probe(pdev: *mut platform_device) -> c_int {
...
// Configure line card.
    ...
    data.hpdev.client = core::ptr::null_mut();
    i2c_new_device_fail:
    i2c_put_adapter(data.hpdev.adapter);
    data.hpdev.adapter = core::ptr::null_mut();
    i2c_get_adapter_fail:
// Clear event notification callback and handle.
    if (data.notifier) {
    data.notifier.user_handler = core::ptr::null_mut();
    data.notifier.handle = core::ptr::null_mut();
    }
    return err;
    }
#[no_mangle]
unsafe extern "C" fn mlxreg_lc_remove(pdev: *mut platform_device) {
