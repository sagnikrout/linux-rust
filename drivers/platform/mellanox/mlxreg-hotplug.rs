...
//! Source: drivers/platform/mellanox/mlxreg-hotplug.c
#![no_std]
...
pub const MLXREG_HOTPLUG_EVENT_OFF: c_int = 1;
pub const MLXREG_HOTPLUG_MASK_OFF: c_int = 2;
pub const MLXREG_HOTPLUG_AGGR_MASK_OFF: c_int = 1;
// ASIC good health mask.
pub const MLXREG_HOTPLUG_GOOD_HEALTH_MASK: c_uint = 0x02;
pub const MLXREG_HOTPLUG_ATTRS_MAX: c_int = 128;
pub const MLXREG_HOTPLUG_NOT_ASSERT: c_int = 3;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxreg_hotplug_priv_data {
    pub irq: c_int,
    pub dev: *mut device,
    pub pdev: *mut platform_device,
    pub plat: *mut mlxreg_hotplug_platform_data,
    pub regmap: *mut regmap,
    pub dwork_irq: delayed_work,
    pub /: *mut *mut spinlock_t lock; / sync with interrupt,
    pub hwmon: *mut device,
    pub 1]: *mut *mut attribute mlxreg_hotplug_attr[MLXREG_HOTPLUG_ATTRS_MAX +,
    ...
    pub mask: u32,
    pub aggr_cache: u32,
    pub after_probe: bool,
    pub not_asserted: u8,
}

// Environment variables array for udev.
    static char *mlxreg_hotplug_udev_envp[] = { core::ptr::null_mut(), core::ptr::null_mut() };
    static int
...
#[no_mangle]
unsafe extern "C" fn mlxreg_hotplug_item_label_index_get(mask: u32, bit: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_hotplug_attr_init(priv: *mut mlxreg_hotplug_priv_data) -> c_int {
    ...
    unsigned long mask;
    u32 regval;
    let mut num_attrs: c_int = 0, id = 0, i, j, k, count, ret;
    pdata = dev_get_platdata(&priv.pdev.dev);
    item = pdata.items;
...
//
#[no_mangle]
unsafe extern "C" fn mlxreg_hotplug_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_hotplug_set_irq(priv: *mut mlxreg_hotplug_priv_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_hotplug_unset_irq(priv: *mut mlxreg_hotplug_priv_data) {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_hotplug_irq_handler(irq: c_int, dev: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_hotplug_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxreg_hotplug_remove(pdev: *mut platform_device) {
