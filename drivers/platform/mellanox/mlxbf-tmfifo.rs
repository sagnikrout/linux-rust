...
//! Source: drivers/platform/mellanox/mlxbf-tmfifo.c
#![no_std]
...
pub const MLXBF_TMFIFO_CON_TX_BUF_RSV_SIZE: c_int = 8;
...
//
pub const MLXBF_TMFIFO_RESERVE_RATIO: c_int = 16;
// Message with data needs at least two words (for header & data).
pub const MLXBF_TMFIFO_DATA_MIN_WORDS: c_int = 2;
// Tx timeout in milliseconds.
pub const TMFIFO_TX_TIMEOUT: c_int = 2000;
// ACPI UID for BlueField-3.
pub const TMFIFO_BF3_UID: c_int = 1;
    struct mlxbf_tmfifo;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_tmfifo_vring {
    pub va: *mut c_void,
    pub dma: dma_addr_t,
    pub vq: *mut virtqueue,
    pub desc: *mut vring_desc,
    pub desc_head: *mut vring_desc,
    pub drop_desc: vring_desc,
    pub cur_len: c_int,
    pub rem_len: c_int,
    pub rem_padding: c_int,
    pub pkt_len: u32,
    pub next_avail: u16,
    pub num: c_int,
    pub align: c_int,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_tmfifo_vdev {
    pub vdev: virtio_device,
    pub status: u8,
    pub features: u64,
    pub vrings: [mlxbf_tmfifo_vring; MLXBF_TMFIFO_VRING_MAX],
    union {
    pub cons: virtio_console_config,
    pub net: virtio_net_config,
    pub config: },
    pub tx_buf: circ_buf,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_tmfifo_irq_info {
    pub fifo: *mut mlxbf_tmfifo,
    pub irq: c_int,
    pub index: c_int,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_tmfifo_io {
    pub ctl: *mut void __iomem,
    pub sts: *mut void __iomem,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_tmfifo {
    pub vdev: [*mut mlxbf_tmfifo_vdev; MLXBF_TMFIFO_VDEV_MAX],
    pub /: *mut *mut mutex lock; / TmFifo lock,
    pub res0: *mut void __iomem,
    pub res1: *mut void __iomem,
    pub rx: mlxbf_tmfifo_io,
    pub tx: mlxbf_tmfifo_io,
    pub rx_fifo_size: c_int,
    pub tx_fifo_size: c_int,
    pub pend_events: c_ulong,
    pub irq_info: [mlxbf_tmfifo_irq_info; MLXBF_TM_MAX_IRQ],
    pub work: work_struct,
    pub timer: timer_list,
    pub vring: [*mut mlxbf_tmfifo_vring; 2],
    pub /: *mut *mut spinlock_t spin_lock[2]; / spin lock,
    pub is_ready: bool,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct mlxbf_tmfifo_msg_hdr {
    pub type: u8,
    pub len: __be16,
// private:
    pub unused: [u8; 5],
    pub __aligned(sizeof(u64)): } __packed,
//
// Default MAC.
...
// Free vrings of the FIFO device.
    ...
    vring.va, vring.dma);
    vring.va = core::ptr::null_mut();
    if (vring.vq) {
    vring_del_virtqueue(vring.vq);
    vring.vq = core::ptr::null_mut();
    }
    }
    }
    }
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_disable_irqs(fifo: *mut mlxbf_tmfifo) {
...
// Interrupt handler.
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_irq_handler(irq: c_int, arg: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_release_pkt(vring: *mut mlxbf_tmfifo_vring) {
    ...
    vring.pkt_len = 0;
    vring.desc = core::ptr::null_mut();
    vring.desc_head = core::ptr::null_mut();
    }
...
// House-keeping timer.
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_timer(t: *mut timer_list) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_get_rx_avail(fifo: *mut mlxbf_tmfifo) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_get_tx_avail(fifo: *mut mlxbf_tmfifo, vdev_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_console_tx(fifo: *mut mlxbf_tmfifo, avail: c_int) {
...
//
    ...
    let mut vring_change: bool = false;
    struct vring_desc *desc;
    unsigned long flags;
    u32 len, idx;
...
// Done and release the packet.
    ...
    fifo.vring[is_rx] = core::ptr::null_mut();
    if (!IS_VRING_DROP(vring)) {
    mlxbf_tmfifo_release_pkt(vring);
    } else {
    vring.pkt_len = 0;
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_check_tx_timeout(vring: *mut mlxbf_tmfifo_vring) {
...
//
    ...
    vring.cur_len = 0;
    vring.rem_len = 0;
    vring.fifo.vring[0] = core::ptr::null_mut();
//
// Make sure the load/store are in order before
// returning back to virtio.
//
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_rxtx(vring: *mut mlxbf_tmfifo_vring, is_rx: bool) {
    static void mlxbf_tmfifo_rxtx(struct mlxbf_tmfifo_vring *vring, bool is_rx)
    {
    let mut avail: c_int = 0, devid = vring.vdev_id;
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_work_handler(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_virtio_notify(vq: *mut virtqueue) -> bool {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_virtio_get_features(vdev: *mut virtio_device) -> u64 {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_virtio_finalize_features(vdev: *mut virtio_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_virtio_del_vqs(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_virtio_get_status(vdev: *mut virtio_device) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_virtio_reset(vdev: *mut virtio_device) {
...
#[no_mangle]
unsafe extern "C" fn tmfifo_virtio_dev_release(device: *mut device) {
...
// Create vdev for the FIFO.
    ...
    {
    struct mlxbf_tmfifo_vdev *tm_vdev, *reg_dev = core::ptr::null_mut();
    int ret;
    mutex_lock(&fifo.lock);
...
// Register the virtio device.
    ...
    vdev_fail:
    mlxbf_tmfifo_free_vrings(fifo, tm_vdev);
    fifo.vdev[vdev_id] = core::ptr::null_mut();
    if (reg_dev)
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_delete_vdev(fifo: *mut mlxbf_tmfifo, vdev_id: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_get_cfg_mac(mac: *mut u8) {
    static void mlxbf_tmfifo_get_cfg_mac(u8 *mac)
    {
    let mut guid: efi_guid_t = EFI_GLOBAL_VARIABLE_GUID;
    let mut size: c_ulong = ETH_ALEN;
    u8 buf[ETH_ALEN];
    efi_status_t rc;
    rc = efi.get_variable(mlxbf_tmfifo_efi_name, &guid, core::ptr::null_mut(), &size, buf);
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_set_threshold(fifo: *mut mlxbf_tmfifo) {
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_cleanup(fifo: *mut mlxbf_tmfifo) {
...
// Probe the TMFIFO.
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_probe(pdev: *mut platform_device) -> c_int {
...
// Create the console vdev.
    rc = mlxbf_tmfifo_create_vdev(dev, fifo, VIRTIO_ID_CONSOLE, 0, core::ptr::null_mut(), 0);
    if (rc)
    goto fail;
...
#[no_mangle]
unsafe extern "C" fn mlxbf_tmfifo_remove(pdev: *mut platform_device) {
