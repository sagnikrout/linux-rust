...
//! Source: drivers/platform/olpc/olpc-xo175-ec.c
#![no_std]
...
//
pub const CMD_GET_API_VERSION: c_uint = 0x08 /* out: u8 */;
pub const CMD_READ_VOLTAGE: c_uint = 0x10 /* out: u16, *9.76/32, mV */;
pub const CMD_READ_CURRENT: c_uint = 0x11 /* out: s16, *15.625/120, mA */;
pub const CMD_READ_ACR: c_uint = 0x12 /* out: s16, *6250/15, uAh */;
pub const CMD_READ_BATT_TEMPERATURE: c_uint = 0x13 /* out: u16, *100/256, deg C */;
pub const CMD_READ_AMBIENT_TEMPERATURE: c_uint = 0x14 /* unimplemented, no hardware */;
pub const CMD_READ_BATTERY_STATUS: c_uint = 0x15 /* out: u8, bitmask */;
pub const CMD_READ_SOC: c_uint = 0x16 /* out: u8, percentage */;
pub const CMD_READ_GAUGE_ID: c_uint = 0x17 /* out: u8 * 8 */;
pub const CMD_READ_GAUGE_DATA: c_uint = 0x18 /* in: u8 addr, out: u8 data */;
pub const CMD_READ_BOARD_ID: c_uint = 0x19 /* out: u16 (platform id) */;
pub const CMD_READ_BATT_ERR_CODE: c_uint = 0x1f /* out: u8, error bitmask */;
pub const CMD_SET_DCON_POWER: c_uint = 0x26 /* in: u8 */;
pub const CMD_RESET_EC: c_uint = 0x28 /* none */;
pub const CMD_READ_BATTERY_TYPE: c_uint = 0x2c /* out: u8 */;
pub const CMD_SET_AUTOWAK: c_uint = 0x33 /* out: u8 */;
pub const CMD_SET_EC_WAKEUP_TIMER: c_uint = 0x36 /* in: u32, out: ? */;
pub const CMD_READ_EXT_SCI_MASK: c_uint = 0x37 /* ? */;
pub const CMD_WRITE_EXT_SCI_MASK: c_uint = 0x38 /* ? */;
pub const CMD_CLEAR_EC_WAKEUP_TIMER: c_uint = 0x39 /* none */;
pub const CMD_ENABLE_RUNIN_DISCHARGE: c_uint = 0x3B /* none */;
pub const CMD_DISABLE_RUNIN_DISCHARGE: c_uint = 0x3C /* none */;
pub const CMD_READ_MPPT_ACTIVE: c_uint = 0x3d /* out: u8 */;
pub const CMD_READ_MPPT_LIMIT: c_uint = 0x3e /* out: u8 */;
pub const CMD_SET_MPPT_LIMIT: c_uint = 0x3f /* in: u8 */;
pub const CMD_DISABLE_MPPT: c_uint = 0x40 /* none */;
pub const CMD_ENABLE_MPPT: c_uint = 0x41 /* none */;
pub const CMD_READ_VIN: c_uint = 0x42 /* out: u16 */;
pub const CMD_EXT_SCI_QUERY: c_uint = 0x43 /* ? */;
pub const RSP_KEYBOARD_DATA: c_uint = 0x48 /* ? */;
pub const RSP_TOUCHPAD_DATA: c_uint = 0x49 /* ? */;
pub const CMD_GET_FW_VERSION: c_uint = 0x4a /* out: u8 * 16 */;
pub const CMD_POWER_CYCLE: c_uint = 0x4b /* none */;
pub const CMD_POWER_OFF: c_uint = 0x4c /* none */;
pub const CMD_RESET_EC_SOFT: c_uint = 0x4d /* none */;
pub const CMD_READ_GAUGE_U16: c_uint = 0x4e /* ? */;
pub const CMD_ENABLE_MOUSE: c_uint = 0x4f /* ? */;
pub const CMD_ECHO: c_uint = 0x52 /* in: u8 * 5, out: u8 * 5 */;
pub const CMD_GET_FW_DATE: c_uint = 0x53 /* out: u8 * 16 */;
pub const CMD_GET_FW_USER: c_uint = 0x54 /* out: u8 * 16 */;
pub const CMD_TURN_OFF_POWER: c_uint = 0x55 /* none (same as 0x4c) */;
pub const CMD_READ_OLS: c_uint = 0x56 /* out: u16 */;
pub const CMD_OLS_SMT_LEDON: c_uint = 0x57 /* none */;
pub const CMD_OLS_SMT_LEDOFF: c_uint = 0x58 /* none */;
pub const CMD_START_OLS_ASSY: c_uint = 0x59 /* none */;
pub const CMD_STOP_OLS_ASSY: c_uint = 0x5a /* none */;
pub const CMD_OLS_SMTTEST_STOP: c_uint = 0x5b /* none */;
pub const CMD_READ_VIN_SCALED: c_uint = 0x5c /* out: u16 */;
pub const CMD_READ_BAT_MIN_W: c_uint = 0x5d /* out: u16 */;
pub const CMD_READ_BAR_MAX_W: c_uint = 0x5e /* out: u16 */;
pub const CMD_RESET_BAT_MINMAX_W: c_uint = 0x5f /* none */;
pub const CMD_READ_LOCATION: c_uint = 0x60 /* in: u16 addr, out: u8 data */;
pub const CMD_WRITE_LOCATION: c_uint = 0x61 /* in: u16 addr, u8 data */;
pub const CMD_KEYBOARD_CMD: c_uint = 0x62 /* in: u8, out: ? */;
pub const CMD_TOUCHPAD_CMD: c_uint = 0x63 /* in: u8, out: ? */;
pub const CMD_GET_FW_HASH: c_uint = 0x64 /* out: u8 * 16 */;
pub const CMD_SUSPEND_HINT: c_uint = 0x65 /* in: u8 */;
pub const CMD_ENABLE_WAKE_TIMER: c_uint = 0x66 /* in: u8 */;
pub const CMD_SET_WAKE_TIMER: c_uint = 0x67 /* in: 32 */;
pub const CMD_ENABLE_WAKE_AUTORESET: c_uint = 0x68 /* in: u8 */;
pub const CMD_OLS_SET_LIMITS: c_uint = 0x69 /* in: u16, u16 */;
pub const CMD_OLS_GET_LIMITS: c_uint = 0x6a /* out: u16, u16 */;
pub const CMD_OLS_SET_CEILING: c_uint = 0x6b /* in: u16 */;
pub const CMD_OLS_GET_CEILING: c_uint = 0x6c /* out: u16 */;
//
...
pub const EC_MAX_CMD_DATA_LEN: c_int = 5;
pub const EC_MAX_RESP_LEN: c_int = 16;
pub const LOG_BUF_SIZE: c_int = 128;
pub const PM_WAKEUP_TIME: c_int = 1000;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct olpc_xo175_ec_cmd {
    pub command: u8,
    pub nr_args: u8,
    pub data_len: u8,
    pub args: [u8; EC_MAX_CMD_DATA_LEN],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct olpc_xo175_ec_resp {
    pub channel: u8,
    pub byte: u8,
}
...
// SPI related stuff.
    ...
    pub msg: spi_message,
    union {
    pub cmd: olpc_xo175_ec_cmd,
    pub resp: olpc_xo175_ec_resp,
    pub rx_buf: } tx_buf,,
// GPIO for the CMD signals.
    pub gpio_cmd: *mut gpio_desc,
// Command handling related state.
    pub cmd_state_lock: spinlock_t,
    pub cmd_state: c_int,
    pub cmd_running: bool,
    pub cmd_done: completion,
    pub cmd: olpc_xo175_ec_cmd,
    pub resp_data: [u8; EC_MAX_RESP_LEN],
    pub expected_resp_len: c_int,
    pub resp_len: c_int,
// Power button.
    pub pwrbtn: *mut input_dev,
// Debug handling.
    pub logbuf: [c_char; LOG_BUF_SIZE],
    pub logbuf_len: c_int,
}

    static struct platform_device *olpc_ec;
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_resp_len(cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_flush_logbuf(priv: *mut olpc_xo175_ec) {
...
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_read_packet(priv: *mut olpc_xo175_ec) {
...
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_complete(arg: *mut c_void) {
    static void olpc_xo175_ec_complete(void *arg)
    {
...
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_set_event_mask(mask: c_uint) -> c_int {
    static int olpc_xo175_ec_set_event_mask(unsigned int mask)
    {
    u8 args[2];
    args[0] = mask >> 0;
    args[1] = mask >> 8;
    return olpc_ec_cmd(CMD_WRITE_EXT_SCI_MASK, args, 2, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_power_off() {
    static void olpc_xo175_ec_power_off(void)
    {
    while (1) {
    olpc_ec_cmd(CMD_POWER_OFF, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    mdelay(1000);
    }
    }
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_resume_noirq(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_resume(dev: *mut device) -> int __maybe_unused {
...
//
    olpc_ec_cmd(CMD_SUSPEND_HINT, &x, 1, core::ptr::null_mut(), 0);
...
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_remove(spi: *mut spi_device) {
    ...
    olpc_ec = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn olpc_xo175_ec_probe(spi: *mut spi_device) -> c_int {
...
// Enable all EC events while we're awake
    olpc_xo175_ec_set_event_mask(EC_ALL_EVENTS);
    if (pm_power_off == core::ptr::null_mut())
    ...
    SET_NOIRQ_SYSTEM_SLEEP_PM_OPS(core::ptr::null_mut(), olpc_xo175_ec_resume_noirq)
    SET_RUNTIME_PM_OPS(olpc_xo175_ec_suspend, olpc_xo175_ec_resume, core::ptr::null_mut())
    };
