...
//! Source: drivers/platform/surface/surface_dtx.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssam_bas_base_info {
    pub state: u8,
    pub base_id: u8,
    pub __packed: },
    pub 2): static_assert(sizeof(struct ssam_bas_base_info) ==,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdtx_device {
    pub kref: kref,
    pub /: *mut *mut rw_semaphore lock; / Guards device and controller reference.,
    pub dev: *mut device,
    pub ctrl: *mut ssam_controller,
    pub flags: c_ulong,
    pub mdev: miscdevice,
    pub waitq: wait_queue_head_t,
    pub /: *mut *mut mutex write_lock; / Guards order of events/notifications.,
    pub /: *mut *mut rw_semaphore client_lock; / Guards client list.,
    pub client_list: list_head,
    pub state_work: delayed_work,
    struct {
    pub base: ssam_bas_base_info,
    pub device_mode: u8,
    pub latch_status: u8,
    pub state: },
    pub mode_work: delayed_work,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdtx_client {
    pub ddev: *mut sdtx_device,
    pub node: list_head,
    pub flags: c_ulong,
    pub fasync: *mut fasync_struct,
    pub /: *mut *mut mutex read_lock; / Guards FIFO buffer read access.,
    pub 512): DECLARE_KFIFO(buffer, u8,,
}

#[no_mangle]
unsafe extern "C" fn __sdtx_device_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn sdtx_device_put(ddev: *mut sdtx_device) {
...
#[no_mangle]
unsafe extern "C" fn sdtx_translate_base_state(ddev: *mut sdtx_device, state: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn sdtx_translate_latch_status(ddev: *mut sdtx_device, status: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn sdtx_translate_cancel_reason(ddev: *mut sdtx_device, reason: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn sdtx_ioctl_get_device_mode(ddev: *mut sdtx_device, buf: *mut u16 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn sdtx_ioctl_get_latch_status(ddev: *mut sdtx_device, buf: *mut u16 __user) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __surface_dtx_ioctl(client: *mut sdtx_client, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
// -- File operations. ------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn surface_dtx_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_read(file: *mut file, buf: *mut char __user, count: usize, offs: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_poll(file: *mut file, pt: *mut poll_table_struct) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdtx_status_event {
    pub e: sdtx_event,
    pub v: __u16,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct sdtx_base_info_event {
    pub e: sdtx_event,
    pub v: sdtx_base_info,
    pub __packed: },
    union sdtx_generic_event {
    pub common: sdtx_event,
    pub status: sdtx_status_event,
    pub base: sdtx_base_info_event,
}
...
#[no_mangle]
unsafe extern "C" fn sdtx_push_event(ddev: *mut sdtx_device, evt: *mut sdtx_event) {
    static void sdtx_push_event(struct sdtx_device *ddev, struct sdtx_event *evt)
    {
    let mut len: usize = sizeof(struct sdtx_event) + evt.length;
    struct sdtx_client *client;
...
#[no_mangle]
unsafe extern "C" fn sdtx_notifier(nf: *mut ssam_event_notifier, in: *const ssam_event) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn sdtx_device_mode_invalid(mode: u8, base_state: u8) -> bool {
...
#[no_mangle]
unsafe extern "C" fn sdtx_device_mode_workfn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sdtx_update_device_mode(ddev: *mut sdtx_device, delay: c_ulong) {
    static void sdtx_update_device_mode(struct sdtx_device *ddev, unsigned long delay)
    {
...
// Must be executed with ddev->write_lock held.
#[no_mangle]
unsafe extern "C" fn __sdtx_device_state_update_mode(ddev: *mut sdtx_device, mode: u8) {
...
// Must be executed with ddev->write_lock held.
#[no_mangle]
unsafe extern "C" fn __sdtx_device_state_update_latch(ddev: *mut sdtx_device, status: u8) {
...
#[no_mangle]
unsafe extern "C" fn sdtx_device_state_workfn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn sdtx_update_device_state(ddev: *mut sdtx_device, delay: c_ulong) {
...
#[no_mangle]
unsafe extern "C" fn sdtx_device_destroy(ddev: *mut sdtx_device) {
...
//
    ...
    ddev.dev = core::ptr::null_mut();
    ddev.ctrl = core::ptr::null_mut();
    up_write(&ddev.lock);
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_pm_complete(dev: *mut device) {
...
//
    ...
    let mut surface_dtx_pm_ops: static struct dev_pm_ops = {};

// -- Platform driver. ------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn surface_dtx_platform_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_platform_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_ssam_probe(sdev: *mut ssam_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_ssam_remove(sdev: *mut ssam_device) {
...
// -- Module setup. ---------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn surface_dtx_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn surface_dtx_exit() -> void __exit {
