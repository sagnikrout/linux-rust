...
//! Source: drivers/platform/surface/surface_aggregator_cdev.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssam_cdev_notifier {
    pub client: *mut ssam_cdev_client,
    pub nf: ssam_event_notifier,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ssam_cdev_client {
    pub cdev: *mut ssam_cdev,
    pub node: list_head,
    pub /: *mut *mut mutex notifier_lock; / Guards notifier access for registration,
    pub notifier: [*mut ssam_cdev_notifier; SSH_NUM_EVENTS],
    pub /: *mut *mut mutex read_lock; / Guards FIFO buffer read access,
    pub /: *mut *mut mutex write_lock; / Guards FIFO buffer write access,
    pub 4096): DECLARE_KFIFO(buffer, u8,,
    pub waitq: wait_queue_head_t,
    pub fasync: *mut fasync_struct,
}

#[no_mangle]
unsafe extern "C" fn __ssam_cdev_release(kref: *mut kref) {
...
#[no_mangle]
unsafe extern "C" fn ssam_cdev_put(cdev: *mut ssam_cdev) {
...
// -- Notifier handling. ----------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ssam_cdev_notifier(nf: *mut ssam_event_notifier, in: *const ssam_event) -> u32 {
    ...
    let mut n: usize = struct_size(&event, data, in.length);
// Translate event.
...
#[no_mangle]
unsafe extern "C" fn ssam_cdev_notifier_register(client: *mut ssam_cdev_client, tc: u8, priority: c_int) -> c_int {
    static int ssam_cdev_notifier_register(struct ssam_cdev_client *client, u8 tc, int priority)
    {
    let mut rqid: u16 = ssh_tc_to_rqid(tc);
    let mut event: u16 = ssh_rqid_to_event(rqid);
...
#[no_mangle]
unsafe extern "C" fn ssam_cdev_notifier_unregister(client: *mut ssam_cdev_client, tc: u8) -> c_int {
...
// Unregister and free notifier.
    ...
    client.notifier[event] = core::ptr::null_mut();
    mutex_unlock(&client.notifier_lock);
    return status;
    }
#[no_mangle]
unsafe extern "C" fn ssam_cdev_notifier_unregister_all(client: *mut ssam_cdev_client) {
...
//
    ...
    client.notifier[i] = core::ptr::null_mut();
    }
    mutex_unlock(&client.notifier_lock);
    WARN_ON(count > 0);
    }
...
// -- IOCTL functions. ------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ssam_cdev_request(client: *mut ssam_cdev_client, r: *mut ssam_cdev_request __user) -> c_long {
    static long ssam_cdev_request(struct ssam_cdev_client *client, struct ssam_cdev_request __user *r)
    {
    struct ssam_cdev_request rqst;
    let mut spec: ssam_request = {};
    let mut rsp: ssam_response = {};
    const void __user *plddata;
    void __user *rspdata;
    let mut status: c_int = 0, ret = 0, tmp;
    lockdep_assert_held_read(&client.cdev.lock);
...
// Setup basic request fields.
    ...
    spec.payload = core::ptr::null_mut();
...
// -- File operations. ------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ssam_cdev_device_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_cdev_device_release(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_cdev_device_ioctl(file: *mut file, cmd: c_uint, arg: c_ulong) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn ssam_cdev_read(file: *mut file, buf: *mut char __user, count: usize, offs: *mut loff_t) -> isize {
...
#[no_mangle]
unsafe extern "C" fn ssam_cdev_poll(file: *mut file, pt: *mut poll_table_struct) -> __poll_t {
...
#[no_mangle]
unsafe extern "C" fn ssam_cdev_fasync(fd: c_int, file: *mut file, on: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_dbg_device_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_dbg_device_remove(pdev: *mut platform_device) {
...
//
    ...
    cdev.ctrl = core::ptr::null_mut();
    cdev.dev = core::ptr::null_mut();
    up_write(&cdev.lock);
...
#[no_mangle]
unsafe extern "C" fn ssam_debug_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ssam_debug_exit() -> void __exit {
