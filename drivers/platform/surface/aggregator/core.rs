...
//! Source: drivers/platform/surface/aggregator/core.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn ssam_try_set_controller(ctrl: *mut ssam_controller) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn ssam_clear_controller() {
    static void ssam_clear_controller(void)
    {
    spin_lock(&__ssam_controller_lock);
    __ssam_controller = core::ptr::null_mut();
    spin_unlock(&__ssam_controller_lock);
    }
//
...
//
#[no_mangle]
pub unsafe extern "C" fn ssam_client_link(c: *mut ssam_controller, client: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_write_wakeup(dev: *mut serdev_device) {
...
// -- SysFS and misc. -------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ssam_log_firmware_version(ctrl: *mut ssam_controller) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_serdev_setup_via_acpi(serdev: *mut serdev_device, handle: acpi_handle) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_serdev_setup(ssh: *mut acpi_device, serdev: *mut serdev_device) -> c_int {
...
// -- Power management. -----------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_shutdown(serdev: *mut serdev_device) {
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_pm_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_pm_complete(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_pm_freeze(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_pm_thaw(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_pm_poweroff(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_pm_restore(dev: *mut device) -> c_int {
...
//
    ...
    let mut ssam_serial_hub_pm_ops: static struct dev_pm_ops = { };

// -- Device/driver setup. --------------------------------------------------
    let mut gpio_ssam_wakeup_int: static struct acpi_gpio_params = { 0, 0, false };
    let mut gpio_ssam_wakeup: static struct acpi_gpio_params = { 1, 0, false };
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_probe(serdev: *mut serdev_device) -> c_int {
    ...
    int status;
    if (ssh) {
    status = gpiod_count(dev, core::ptr::null_mut());
    if (status < 0)
...
#[no_mangle]
unsafe extern "C" fn ssam_serial_hub_remove(serdev: *mut serdev_device) {
...
// -- Module setup. ---------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn ssam_core_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ssam_core_exit() -> void __exit {
