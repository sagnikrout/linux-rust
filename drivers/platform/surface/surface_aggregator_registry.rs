...
//! Source: drivers/platform/surface/surface_aggregator_registry.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ssam_platform_hub_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    if (status) {
    set_secondary_fwnode(&pdev.dev, core::ptr::null_mut());
    software_node_unregister_node_group(nodes);
    }
...
#[no_mangle]
unsafe extern "C" fn ssam_platform_hub_remove(pdev: *mut platform_device) {
