...
//! Source: drivers/platform/chrome/cros_ec_rpmsg.c
#![no_std]
...
pub const EC_MSG_TIMEOUT_MS: c_int = 200;
pub const HOST_COMMAND_MARK: c_int = 1;
pub const HOST_EVENT_MARK: c_int = 2;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_rpmsg_response {
    pub type: u8,
    pub __aligned(4): u8 data[],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_rpmsg {
    pub rpdev: *mut rpmsg_device,
    pub xfer_ack: completion,
    pub host_event_work: work_struct,
    pub ept: *mut rpmsg_endpoint,
    pub has_pending_host_event: bool,
    pub probe_done: bool,
}
...
//
    ...
    return rpmsg_create_ept(rpdev, cros_ec_rpmsg_callback, core::ptr::null_mut(), chinfo);
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_rpmsg_probe(rpdev: *mut rpmsg_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_rpmsg_remove(rpdev: *mut rpmsg_device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_rpmsg_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_rpmsg_resume(dev: *mut device) -> c_int {
