...
//! Source: drivers/platform/chrome/cros_hps_i2c.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn hps_set_power(hps: *mut hps_drvdata, state: bool) {
    static void hps_set_power(struct hps_drvdata *hps, bool state)
    {
    gpiod_set_value_cansleep(hps.enable_gpio, state);
    }
#[no_mangle]
unsafe extern "C" fn hps_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hps_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hps_i2c_probe(client: *mut i2c_client) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hps_i2c_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn hps_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hps_resume(dev: *mut device) -> c_int {
    ...
    static DEFINE_RUNTIME_DEV_PM_OPS(hps_pm_ops, hps_suspend, hps_resume, core::ptr::null_mut());
