...
//! Source: drivers/platform/chrome/cros_ec_proto.c
#![no_std]
...
pub const EC_COMMAND_RETRIES: c_int = 50;
pub const RWSIG_CONTINUE_RETRIES: c_int = 8;
pub const RWSIG_CONTINUE_MAX_ERRORS_IN_ROW: c_int = 3;
...
#[no_mangle]
unsafe extern "C" fn cros_ec_map_error(result: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_xfer_command(ec_dev: *mut cros_ec_device, msg: *mut cros_ec_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_wait_until_complete(ec_dev: *mut cros_ec_device, result: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_send_command(ec_dev: *mut cros_ec_device, msg: *mut cros_ec_command) -> c_int {
    static int cros_ec_send_command(struct cros_ec_device *ec_dev, struct cros_ec_command *msg)
    {
    let mut ret: c_int = cros_ec_xfer_command(ec_dev, msg);
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_get_host_event_wake_mask(ec_dev: *mut cros_ec_device, mask: *mut u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cros_ec_rwsig_continue(ec_dev: *mut cros_ec_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_get_proto_info(ec_dev: *mut cros_ec_device, devidx: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_get_proto_info_legacy(ec_dev: *mut cros_ec_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_get_host_command_version_mask(ec_dev: *mut cros_ec_device, cmd: u16, mask: *mut u32) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_query_all(ec_dev: *mut cros_ec_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_cmd_xfer(ec_dev: *mut cros_ec_device, msg: *mut cros_ec_command) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_next_event(ec_dev: *mut cros_ec_device) -> c_int {
    ...
    let mut cmd_version: c_int = ec_dev.mkbp_event_supported - 1;
    u32 size;
    if (ec_dev.suspended) {
...
#[no_mangle]
unsafe extern "C" fn get_keyboard_state_event(ec_dev: *mut cros_ec_device) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_get_host_event(ec_dev: *mut cros_ec_device) -> u32 {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_read_features(ec: *mut cros_ec_dev) -> c_int {
    int cros_ec_read_features(struct cros_ec_dev *ec)
    {
    int ret = cros_ec_cmd(ec.ec_dev, 0, EC_CMD_GET_FEATURES + ec.cmd_offset,
    core::ptr::null_mut(), 0, &ec.features, sizeof(ec.features));
    if (ret < 0) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_check_features(ec: *mut cros_ec_dev, feature: c_int) -> bool {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_get_sensor_count(ec: *mut cros_ec_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_cmd_readmem(ec_dev: *mut cros_ec_device, offset: u8, size: u8, dest: *mut c_void) -> c_int {
    int cros_ec_cmd_readmem(struct cros_ec_device *ec_dev, u8 offset, u8 size, void *dest)
    {
    let mut params: ec_params_read_memmap = {};
    if (!size)
    return -EINVAL;
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_get_cmd_versions(ec_dev: *mut cros_ec_device, cmd: u16) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_device_registered(ec_dev: *mut cros_ec_device) -> bool {
