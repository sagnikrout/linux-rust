...
//! Source: drivers/platform/chrome/cros_ec_proto_test.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_proto_test_priv {
    pub ec_dev: cros_ec_device,
    pub dout: [u8; BUFSIZE],
    pub din: [u8; BUFSIZE],
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_prepare_tx_legacy_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_prepare_tx_legacy_bad_msg_outsize(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_prepare_tx_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_prepare_tx_bad_msg_outsize(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_check_result(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_pretest(test: *mut kunit) {
...
//
    ec_dev.din = core::ptr::null_mut();
    ec_dev.dout = core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_normal(test: *mut kunit) {
...
// For cros_ec_get_proto_info() without passthru.
    ...
    KUNIT_ASSERT_PTR_NE(test, mock, core::ptr::null_mut());
...
// For cros_ec_get_proto_info() without passthru.
    ...
    KUNIT_EXPECT_PTR_NE(test, mock, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_no_pd_return_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_no_pd_return0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_legacy_normal_v3_return_error(test: *mut kunit) {
...
// For cros_ec_get_proto_info_legacy().
    ...
    KUNIT_EXPECT_EQ(test, ec_dev.max_passthru, 0);
    KUNIT_EXPECT_PTR_EQ(test, ec_dev.pkt_xfer, core::ptr::null_mut());
    KUNIT_EXPECT_EQ(test, ec_dev.din_size, EC_PROTO2_MSG_BYTES);
    KUNIT_EXPECT_EQ(test, ec_dev.dout_size, EC_PROTO2_MSG_BYTES);
    }
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_legacy_normal_v3_return0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_legacy_xfer_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_legacy_return_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_legacy_data_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_legacy_return0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_no_mkbp(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_no_mkbp_return_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_no_mkbp_return0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_no_host_sleep(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_no_host_sleep_return0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_default_wake_mask_return_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_query_all_default_wake_mask_return0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_excess_msg_insize(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_excess_msg_outsize_without_passthru(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_excess_msg_outsize_with_passthru(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_protocol_v3_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_protocol_v3_no_op(test: *mut kunit) {
    ...
    ec_dev.proto_version = 3;
    ec_dev.cmd_xfer = cros_kunit_ec_cmd_xfer_mock;
    ec_dev.pkt_xfer = core::ptr::null_mut();
    ret = cros_ec_cmd_xfer(ec_dev, &msg);
    KUNIT_EXPECT_EQ(test, ret, -EIO);
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_protocol_v2_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_protocol_v2_no_op(test: *mut kunit) {
    ...
    memset(&msg, 0, sizeof(msg));
    ec_dev.proto_version = 2;
    ec_dev.cmd_xfer = core::ptr::null_mut();
    ec_dev.pkt_xfer = cros_kunit_ec_pkt_xfer_mock;
    ret = cros_ec_cmd_xfer(ec_dev, &msg);
    KUNIT_EXPECT_EQ(test, ret, -EIO);
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_in_progress_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_in_progress_retries_eagain(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_in_progress_retries_status_processing(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_in_progress_xfer_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_in_progress_return_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_in_progress_return0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_status_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_status_xfer_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_cmd_xfer_status_return_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_next_event_no_mkbp_event(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_next_event_mkbp_event_ec_suspended(test: *mut kunit) {
    ...
    ret = cros_ec_get_next_event(ec_dev, core::ptr::null_mut(), core::ptr::null_mut());
    KUNIT_EXPECT_EQ(test, ret, -EHOSTDOWN);
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_next_event_mkbp_event_version0(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_next_event_mkbp_event_version2(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_next_event_mkbp_event_host_event_rtc(test: *mut kunit) {
...
// For get_next_event_xfer().
    ...
    ret = cros_ec_get_next_event(ec_dev, &wake_event, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_next_event_mkbp_event_host_event_masked(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_host_event_no_mkbp_event(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_host_event_not_host_event(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_host_event_wrong_event_size(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_host_event_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_check_features_cached(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_check_features_not_cached(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_sensor_count_normal(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_sensor_count_xfer_error(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_get_sensor_count_legacy(test: *mut kunit) {
...
// For readmem.
    ...
    KUNIT_ASSERT_PTR_NE(test, cros_kunit_readmem_mock_data, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_ec_cmd(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_release(dev: *mut device) {
    static void cros_ec_proto_test_release(struct device *dev)
    {
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_init(test: *mut kunit) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_proto_test_exit(test: *mut kunit) {
