...
//! Source: drivers/platform/chrome/cros_ec_sensorhub.c
#![no_std]
...
pub const CROS_EC_CMD_INFO_RETRIES: c_int = 50;
#[no_mangle]
unsafe extern "C" fn cros_ec_sensorhub_free_sensor(arg: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_sensorhub_probe(pdev: *mut platform_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_sensorhub_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_sensorhub_resume(dev: *mut device) -> c_int {
