...
//! Source: drivers/platform/chrome/cros_ec_ishtp.c
#![no_std]
...
// buffer for them.
//
pub const CROS_ISH_CL_TX_RING_SIZE: c_int = 8;
pub const CROS_ISH_CL_RX_RING_SIZE: c_int = 8;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ish_out_msg {
    pub hdr: header,
    pub ec_request: ec_host_request,
    pub __packed: },
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ish_in_msg {
    pub hdr: header,
...
//
    pub DECLARE_RWSEM(init_lock): static,
//
...
//
#[no_mangle]
unsafe extern "C" fn ish_evt_handler(work: *mut work_struct) {
...
//
#[no_mangle]
unsafe extern "C" fn ish_event_cb(cl_device: *mut ishtp_cl_device) {
...
//
    ...
    while ((rb_in_proc = ishtp_cl_rx_get_rb(cros_ish_cl)) != core::ptr::null_mut()) {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ish_init(cros_ish_cl: *mut ishtp_cl, reset: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ish_deinit(cros_ish_cl: *mut ishtp_cl) {
...
// Copy response packet payload and compute checksum
    ...
    let mut in_size: usize = sizeof(struct cros_ish_in_msg) + msg.insize;
    let mut out_size: usize = sizeof(struct cros_ish_out_msg) + msg.outsize;
// Sanity checks
...
#[no_mangle]
unsafe extern "C" fn cros_ec_dev_init(client_data: *mut ishtp_cl_data) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_ishtp_probe(cl_device: *mut ishtp_cl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_ishtp_remove(cl_device: *mut ishtp_cl_device) {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_ishtp_reset(cl_device: *mut ishtp_cl_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_ishtp_suspend(device: *mut device) -> int __maybe_unused {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_ishtp_resume(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_ishtp_mod_init() -> int __init {
    static int __init cros_ec_ishtp_mod_init(void)
    {
    return ishtp_cl_driver_register(&cros_ec_ishtp_driver, THIS_MODULE);
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_ishtp_mod_exit() -> void __exit {
