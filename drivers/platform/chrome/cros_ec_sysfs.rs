...
//! Source: drivers/platform/chrome/cros_ec_sysfs.c
#![no_std]
...
// Accessor functions
    ...
    let mut got_cmd: c_int = 0, offset = 0;
    int i;
    int ret;
...
// Keyboard wake angle control
    ...
    int ret;
    int i;
    ret = cros_ec_cmd(ec.ec_dev, 0, EC_CMD_USB_PD_PORTS, core::ptr::null_mut(), 0,
...
#[no_mangle]
unsafe extern "C" fn cros_ec_sysfs_probe(pd: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_sysfs_remove(pd: *mut platform_device) {
