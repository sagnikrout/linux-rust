...
//! Source: drivers/platform/chrome/cros_ec_sensorhub_ring.c
#![no_std]
...
//
    ...
    u8 sensor_num)
    {
    sensorhub.push_data[sensor_num].indio_dev = core::ptr::null_mut();
    sensorhub.push_data[sensor_num].push_data_cb = core::ptr::null_mut();
    }
...
#[no_mangle]
unsafe extern "C" fn cros_ec_sensor_ring_median_swap(a: *mut i64, b: *mut i64) {
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_sensor_ring_median(array: *mut i64, length: usize) -> i64 {
    static s64 cros_ec_sensor_ring_median(s64 *array, size_t length)
    {
    let mut lo: c_int = 0;
    let mut hi: c_int = length - 1;
    while (lo <= hi) {
...
//
    ...
    {
#[no_mangle]
pub unsafe extern "C" fn div_s64(state->x_offset): *mut *mut state->median_m  (x -, _arg: M_PRECISION) -> return {
...
// sample)
    {
    let mut sensor_id: u8 = sample.sensor_id;
...
// fifo_info,
    ...
    {
    let mut now: i64 = cros_ec_get_time_ns();
    int axis, async_flags;
// Do not populate the filter based on asynchronous events.
    async_flags = in.flags &
    (MOTIONSENSE_SENSOR_FLAG_ODR | MOTIONSENSE_SENSOR_FLAG_FLUSH);
    if (in.flags & MOTIONSENSE_SENSOR_FLAG_TIMESTAMP && !async_flags) {
    let mut a: i64 = in.timestamp;
    let mut b: i64 = fifo_info.timestamp;
    let mut c: i64 = fifo_timestamp;
...
//
    ...
    let mut batch_timestamp: i64 = batch_start.timestamp;
    s64 sample_period;
//
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_sensorhub_ring_handler(sensorhub: *mut cros_ec_sensorhub) {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_sensorhub_ring_allocate(sensorhub: *mut cros_ec_sensorhub) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn cros_ec_sensorhub_ring_add(sensorhub: *mut cros_ec_sensorhub) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn cros_ec_sensorhub_ring_remove(arg: *mut c_void) {
