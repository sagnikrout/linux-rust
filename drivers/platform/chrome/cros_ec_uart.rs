...
//! Source: drivers/platform/chrome/cros_ec_uart.c
#![no_std]
...
// in RO.
//
pub const EC_MSG_DEADLINE_MS: c_int = 500;
//
...
// Invalidate response buffer to guard against out of band rx data
    resp.data = core::ptr::null_mut();
    if (ec_msg.command == EC_CMD_REBOOT_EC)
    msleep(EC_REBOOT_DELAY_MS);
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn cros_ec_uart_resource(ares: *mut acpi_resource, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_uart_acpi_probe(ec_uart: *mut cros_ec_uart) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_uart_probe(serdev: *mut serdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_uart_remove(serdev: *mut serdev_device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_uart_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_uart_resume(dev: *mut device) -> int __maybe_unused {
