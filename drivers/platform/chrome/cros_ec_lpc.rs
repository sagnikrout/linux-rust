...
//! Source: drivers/platform/chrome/cros_ec_lpc.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lpc_driver_data {
    pub quirks: u32,
    pub quirk_mmio_memory_base: u16,
    pub quirk_acpi_id: *const c_char,
    pub quirk_aml_mutex_name: *const c_char,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_lpc {
    pub mmio_memory_base: u16,
    pub base: *mut void __iomem,
    pub mem32: acpi_resource_fixed_memory32,
    int (*read)(struct cros_ec_lpc *ec_lpc, unsigned int offset,
    pub dest): *mut unsigned int length, u8,
    int (*write)(struct cros_ec_lpc *ec_lpc, unsigned int offset,
    pub msg): *const unsigned int length, u8,
}
...
//
    ...
    {
    let mut in_range: c_int = cros_ec_lpc_mec_in_range(offset, length);
    if (in_range < 0)
    return in_range;
    return in_range ?
...
#[no_mangle]
unsafe extern "C" fn ec_response_timed_out(ec_lpc: *mut cros_ec_lpc) -> c_int {
    static int ec_response_timed_out(struct cros_ec_lpc *ec_lpc)
    {
    let mut one_second: c_ulong = jiffies + HZ;
    u8 data;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_acpi_notify(device: acpi_handle, value: u32, data: *mut c_void) {
    static void cros_ec_lpc_acpi_notify(acpi_handle device, u32 value, void *data)
    {
    static const char *env[] = { "ERROR=PANIC", core::ptr::null_mut() };
...
// Do not query for other events after a panic is reported
    ...
    do {
    ret = cros_ec_get_next_event(ec_dev, core::ptr::null_mut(),
    &ec_has_more_events);
    if (ret > 0)
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_resources(res: *mut acpi_resource, data: *mut c_void) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_probe(pdev: *mut platform_device) -> c_int {
...
//
    ...
    ec_dev.irq = irq;
#[no_mangle]
pub unsafe extern "C" fn if(-ENXIO: irq !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_prepare(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_complete(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_suspend_late(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_resume_early(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lpc_exit() -> void __exit {
