...
//! Source: drivers/platform/chrome/cros_ec_lightbar.c
#![no_std]
...
// Rate-limit the lightbar interface to prevent DoS.
    let mut lb_interval_jiffies: static unsigned long = 50 * HZ / 1000;
//
...
//
    ...
    {
    let mut msec: c_ulong = lb_interval_jiffies * 1000 / HZ;
...
#[no_mangle]
unsafe extern "C" fn lb_throttle() -> c_int {
...
// interrupted - just abort
    ...
    {
    let mut len: c_int = max(ec.ec_dev.max_response, ec.ec_dev.max_request);
...
#[no_mangle]
unsafe extern "C" fn lb_send_empty_cmd(ec: *mut cros_ec_dev, cmd: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lb_manual_suspend_ctrl(ec: *mut cros_ec_dev, enable: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lightbar_probe(pd: *mut platform_device) -> c_int {
...
//
    if (!get_lightbar_version(ec_dev, &lb_version, core::ptr::null_mut()))
    return -ENODEV;
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lightbar_remove(pd: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lightbar_resume(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_lightbar_suspend(dev: *mut device) -> int __maybe_unused {
