...
//! Source: drivers/platform/chrome/cros_ec_debugfs.c
#![no_std]
...
pub const LOG_SHIFT: c_int = 14;

pub const LOG_POLL_SEC: c_int = 10;

    let mut log_poll_period_ms: static unsigned int = LOG_POLL_SEC * MSEC_PER_SEC;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_debugfs {
    pub ec: *mut cros_ec_dev,
    pub dir: *mut dentry,
// EC log
    pub log_buffer: circ_buf,
    pub read_msg: *mut cros_ec_command,
    pub log_mutex: mutex,
    pub log_poll_work: delayed_work,
// EC panicinfo
    pub panicinfo_blob: debugfs_blob_wrapper,
    pub notifier_panic: notifier_block,
}
...
//
#[no_mangle]
unsafe extern "C" fn cros_ec_console_log_work(__work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_console_log_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_console_log_release(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_uptime_is_supported(ec_dev: *mut cros_ec_device) -> bool {
...
#[no_mangle]
unsafe extern "C" fn ec_read_version_supported(ec: *mut cros_ec_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_create_console_log(debug_info: *mut cros_ec_debugfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_cleanup_console_log(debug_info: *mut cros_ec_debugfs) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_create_panicinfo(debug_info: *mut cros_ec_debugfs) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_debugfs_probe(pd: *mut platform_device) -> c_int {
    ...
    return -ENOMEM;
    debug_info.ec = ec;
    debug_info.dir = debugfs_create_dir(name, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cros_ec_debugfs_remove(pd: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_debugfs_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_debugfs_resume(dev: *mut device) -> int __maybe_unused {
