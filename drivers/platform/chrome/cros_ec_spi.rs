...
//! Source: drivers/platform/chrome/cros_ec_spi.c
#![no_std]
...
pub const EC_MSG_HEADER: c_uint = 0xec;
//
...
//
pub const EC_MSG_PREAMBLE_COUNT: c_int = 32;
//
...
//
pub const EC_MSG_DEADLINE_MS: c_int = 200;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_spi {
    pub spi: *mut spi_device,
    pub last_transfer_ns: i64,
    pub start_of_msg_delay: c_uint,
    pub end_of_msg_delay: c_uint,
    pub high_pri_worker: *mut kthread_worker,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cros_ec_xfer_work_params {
    pub work: kthread_work,
    pub fn: cros_ec_xfer_fn_t,
    pub ec_dev: *mut cros_ec_device,
    pub ec_msg: *mut cros_ec_command,
    pub ret: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn terminate_request(ec_dev: *mut cros_ec_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn receive_n_bytes(ec_dev: *mut cros_ec_device, buf: *mut u8, n: c_int) -> c_int {
...
// Receive data until we see the header byte
    ...
    while (true) {
    let mut start_jiffies: c_ulong = jiffies;
...
#[no_mangle]
unsafe extern "C" fn cros_ec_xfer_high_pri_work(work: *mut kthread_work) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_spi_dt_probe(ec_spi: *mut cros_ec_spi, dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_spi_high_pri_release(worker: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_spi_probe(spi: *mut spi_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_spi_remove(spi: *mut spi_device) {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_spi_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cros_ec_spi_resume(dev: *mut device) -> c_int {
