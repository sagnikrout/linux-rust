...
//! Source: drivers/platform/chrome/wilco_ec/core.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wilco_ec_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wilco_ec_remove(pdev: *mut platform_device) {
