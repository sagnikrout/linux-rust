...
//! Source: drivers/platform/chrome/wilco_ec/event.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ec_event_queue {
    pub capacity: c_int,
    pub head: c_int,
    pub tail: c_int,
    pub __counted_by(capacity): *mut *mut ec_event entries[],
}

// Maximum number of events to store in ec_event_queue
    let mut queue_size: static int = 64;
...
#[no_mangle]
pub unsafe extern "C" fn event_queue_empty(q: *mut ec_event_queue) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn event_queue_full(q: *mut ec_event_queue) -> bool {
...
// head==tail when both full and empty, but head!=NULL when full
    ...
    return core::ptr::null_mut();
    ev = q.entries[q.tail];
    q.entries[q.tail] = core::ptr::null_mut();
...
//
    ...
    struct ec_event *ev)
    {
    struct ec_event *popped = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn event_queue_free(q: *mut ec_event_queue) {
    static void event_queue_free(struct ec_event_queue *q)
    {
    struct ec_event *event;
    while ((event = event_queue_pop(q)) != core::ptr::null_mut())
    kfree(event);
    kfree(q);
    }
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct event_device_data {
    pub events: *mut ec_event_queue,
...
//
#[no_mangle]
unsafe extern "C" fn enqueue_events(dev: *mut device, buf: *const u8, length: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn event_device_notify(handle: acpi_handle, value: u32, data: *mut c_void) {
    static void event_device_notify(acpi_handle handle, u32 value, void *data)
    {
    let mut event_buffer: acpi_buffer = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
...
// Execute ACPI method to get event data buffer.
    ...
    core::ptr::null_mut(), &event_buffer);
...
#[no_mangle]
unsafe extern "C" fn event_open(inode: *mut inode, filp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn event_poll(filp: *mut file, wait: *mut poll_table) -> __poll_t {
...
//
    ...
    struct event_device_data *dev_data = filp.private_data;
    struct ec_event *event;
    let mut n_bytes_written: isize = 0;
    int err;
...
#[no_mangle]
unsafe extern "C" fn event_release(inode: *mut inode, filp: *mut file) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn free_device_data(d: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn hangup_device(dev_data: *mut event_device_data) {
...
//
#[no_mangle]
unsafe extern "C" fn event_device_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn event_device_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn event_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn event_module_exit() -> void __exit {
