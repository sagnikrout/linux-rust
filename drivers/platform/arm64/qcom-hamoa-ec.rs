...
//! Source: drivers/platform/arm64/qcom-hamoa-ec.c
#![no_std]
...
pub const EC_SCI_EVT_READ_CMD: c_uint = 0x05;
pub const EC_FW_VERSION_CMD: c_uint = 0x0e;
pub const EC_MODERN_STANDBY_CMD: c_uint = 0x23;
pub const EC_FAN_DBG_CONTROL_CMD: c_uint = 0x30;
pub const EC_SCI_EVT_CONTROL_CMD: c_uint = 0x35;
pub const EC_THERMAL_CAP_CMD: c_uint = 0x42;
pub const EC_FW_VERSION_RESP_LEN: c_int = 4;
pub const EC_THERMAL_CAP_RESP_LEN: c_int = 3;
pub const EC_FAN_DEBUG_CMD_LEN: c_int = 6;
pub const EC_FAN_SPEED_DATA_SIZE: c_int = 4;
pub const EC_MODERN_STANDBY_ENTER: c_uint = 0x01;
pub const EC_MODERN_STANDBY_EXIT: c_uint = 0x00;
pub const EC_FAN_DEBUG_MODE_OFF: c_int = 0;

pub const EC_MAX_FAN_CNT: c_int = 2;
pub const EC_FAN_NAME_SIZE: c_int = 20;
pub const EC_FAN_MAX_PWM: c_int = 255;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_ec_thermal_cap {

    pub fan_cnt: u8,
    pub fan_type: u8,
    pub thermistor_mask: u8,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct qcom_ec_cooling_dev {
...
#[derive(Copy, Clone)]
pub struct qcom_ec {
    pub ec_cdev: *mut qcom_ec_cooling_dev,
    pub thermal_cap: qcom_ec_thermal_cap,
    pub version: qcom_ec_version,
    pub client: *mut i2c_client,
}

#[no_mangle]
unsafe extern "C" fn qcom_ec_read(ec: *mut qcom_ec, cmd: u8, resp_len: u8, resp: *mut u8) -> c_int {
    ...
    return ret;
#[no_mangle]
pub unsafe extern "C" fn if(0xff: ret == 0 || ret ==) -> else {
    else if (ret == 0 || ret == 0xff)
    return -EOPNOTSUPP;
#[no_mangle]
pub unsafe extern "C" fn if(resp_len: ret !=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_ec_read_fw_version(dev: *mut device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_ec_thermal_capabilities(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_sci_evt_control(dev: *mut device, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_fan_get_max_state(cdev: *mut thermal_cooling_device, state: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_fan_get_cur_state(cdev: *mut thermal_cooling_device, state: *mut c_ulong) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn qcom_ec_fan_debug_mode_off(ec_cdev: *mut qcom_ec_cooling_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_fan_set_cur_state(cdev: *mut thermal_cooling_device, state: c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_probe(client: *mut i2c_client) -> c_int {
    ...
    return -ENOMEM;
    ec.client = client;
    ret = devm_request_threaded_irq(dev, client.irq, core::ptr::null_mut(), qcom_ec_irq,
    ...
    ec_cdev.cdev = devm_thermal_of_child_cooling_device_register(dev, core::ptr::null_mut(), name, ec_cdev,
    &qcom_ec_thermal_ops);
...
#[no_mangle]
unsafe extern "C" fn qcom_ec_remove(client: *mut i2c_client) {
