...
//! Source: drivers/platform/loongarch/loongson-laptop.c
#![no_std]
...
pub const MAX_ACPI_ARGS: c_int = 3;
pub const GENERIC_HOTKEY_MAP_MAX: c_int = 64;
pub const GENERIC_EVENT_TYPE_OFF: c_int = 12;
pub const GENERIC_EVENT_TYPE_MASK: c_uint = 0xF000;
pub const GENERIC_EVENT_CODE_MASK: c_uint = 0x0FFF;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct generic_sub_driver {
    pub type: u32,
    pub name: *mut c_char,
    pub handle: *mut acpi_handle,
    pub device: *mut acpi_device,
    pub driver: *mut platform_driver,
    pub sub_driver): *mut *mut int (init)(struct generic_sub_driver,
    pub event): *mut *mut *mut void (notify)(struct generic_sub_driver sub_driver, u32,
    pub acpi_notify_installed: u8,
}
...
#[no_mangle]
unsafe extern "C" fn acpi_evalf(handle: acpi_handle, res: *mut c_int, method: *mut c_char, fmt: *mut c_char, ...) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn setup_acpi_notify(sub_driver: *mut generic_sub_driver) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn loongson_hotkey_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_hotkey_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn loongson_hotkey_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hotkey_map() -> c_int {
    ...
    status = acpi_evaluate_object_typed(hotkey_handle, "KMAP", core::ptr::null_mut(), &buf, ACPI_TYPE_PACKAGE);
    if (status != AE_OK) {
...
#[no_mangle]
unsafe extern "C" fn hotkey_backlight_set(enable: bool) -> c_int {
    static int hotkey_backlight_set(bool enable)
    {
    if (!acpi_evalf(hotkey_handle, core::ptr::null_mut(), "VCBL", "vd", enable ? 1 : 0))
    return -EIO;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn ec_get_brightness() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ec_set_brightness(level: c_int) -> c_int {
    static int ec_set_brightness(int level)
    {
    let mut ret: c_int = 0;
    if (!hotkey_handle)
    return -ENXIO;
    if (!acpi_evalf(hotkey_handle, core::ptr::null_mut(), "ECBS", "vd", level))
    ret = -EIO;
    return ret;
    }
#[no_mangle]
unsafe extern "C" fn ec_backlight_level(level: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ec_backlight_set_power(state: bool) -> c_int {
    ...
    status = acpi_evaluate_object(core::ptr::null_mut(), "\\BLSW", &args, core::ptr::null_mut());
    if (ACPI_FAILURE(status)) {
...
#[no_mangle]
unsafe extern "C" fn loongson_laptop_backlight_update(bd: *mut backlight_device) -> c_int {
    static int loongson_laptop_backlight_update(struct backlight_device *bd)
    {
    let mut target_powered: bool = !backlight_is_blank(bd);
    let mut ret: c_int = 0, lvl = ec_backlight_level(bd.props.brightness);
    if (lvl < 0)
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn loongson_laptop_get_brightness(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn laptop_backlight_register() -> c_int {
    ...
    core::ptr::null_mut(), core::ptr::null_mut(), &backlight_laptop_ops, &props);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn event_init(sub_driver: *mut generic_sub_driver) -> int __init {
    ...
    ret = sparse_keymap_setup(generic_inputdev, hotkey_keycode_map, core::ptr::null_mut());
    if (ret < 0) {
    pr_err("Failed to setup input device keymap\n");
    input_free_device(generic_inputdev);
    generic_inputdev = core::ptr::null_mut();
    return ret;
    }
//
...
#[no_mangle]
unsafe extern "C" fn event_notify(sub_driver: *mut generic_sub_driver, event: u32) {
    static void event_notify(struct generic_sub_driver *sub_driver, u32 event)
    {
    int type, scan_code;
    struct key_entry *ke = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn generic_subdriver_init(sub_driver: *mut generic_sub_driver) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn generic_subdriver_exit(sub_driver: *mut generic_sub_driver) {
    static void generic_subdriver_exit(struct generic_sub_driver *sub_driver)
    {
...
#[no_mangle]
unsafe extern "C" fn generic_acpi_laptop_init() -> int __init {
...
// Prepare input device, but don't register
    ...
    generic_inputdev.dev.parent = core::ptr::null_mut();
// Init subdrivers
...
#[no_mangle]
unsafe extern "C" fn generic_acpi_laptop_exit() -> void __exit {
