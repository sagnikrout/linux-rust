...
//! Source: drivers/platform/cznic/turris-omnia-mcu-gpio.c
#![no_std]
...
pub const OMNIA_CMD_INT_ARG_LEN: c_int = 8;
pub const FRONT_BUTTON_RELEASE_DELAY_MS: c_int = 50;
...
pub const OMNIA_GPIO_INVALID_INT_BIT: c_uint = 0xff;
...
#[no_mangle]
pub unsafe extern "C" fn is_int_bit_valid(gpio: *const omnia_gpio) -> bool {
...
pub const OMNIA_GPIO_PHY_SFP_OFFSET: c_int = 54;
#[no_mangle]
unsafe extern "C" fn omnia_ctl_cmd_locked(mcu: *mut omnia_mcu, cmd: u8, val: u16, mask: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_ctl_cmd(mcu: *mut omnia_mcu, cmd: u8, val: u16, mask: u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_gpio_request(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_gpio_get_direction(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_gpio_direction_input(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_gpio_get(gc: *mut gpio_chip, offset: c_uint) -> c_int {
...
//
    ...
    unsigned long *bits)
    {
    let mut sts: c_ulong = 0, ext_sts = 0, ext_ctl = 0, *field;
    struct omnia_mcu *mcu = gpiochip_get_data(gc);
...
#[no_mangle]
unsafe extern "C" fn omnia_gpio_set(gc: *mut gpio_chip, offset: c_uint, value: c_int) -> c_int {
    ...
    unsigned long *bits)
    {
    let mut ctl: c_ulong = 0, ctl_mask = 0, ext_ctl = 0, ext_ctl_mask = 0;
    struct omnia_mcu *mcu = gpiochip_get_data(gc);
    unsigned int i;
    int err;
    for_each_set_bit(i, mask, ARRAY_SIZE(omnia_gpios)) {
    unsigned long *field, *field_mask;
    let mut bit: u8 = omnia_gpios[i].ctl_bit;
    ...
    break;
    default:
    field = field_mask = core::ptr::null_mut();
    break;
    }
    if (!field)
    continue;
...
#[no_mangle]
unsafe extern "C" fn omnia_irq_unmask(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn omnia_irq_set_type(d: *mut irq_data, type: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_irq_bus_lock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn omnia_irq_bus_sync_unlock(d: *mut irq_data) {
...
#[no_mangle]
unsafe extern "C" fn omnia_irq_init_hw(gc: *mut gpio_chip) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn button_release_emul_fn(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn omnia_irq_thread_handler(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
pub unsafe extern "C" fn omnia_mcu_register_gpiochip(mcu: *mut omnia_mcu) -> c_int {
    int omnia_mcu_register_gpiochip(struct omnia_mcu *mcu)
    {
    let mut new_api: bool = mcu.features & OMNIA_FEAT_NEW_INT_API;
    struct device *dev = &mcu.client.dev;
...
// This will let us handle the parent IRQ in the driver
    mcu.gc.irq.parent_handler = core::ptr::null_mut();
    mcu.gc.irq.num_parents = 0;
    mcu.gc.irq.parents = core::ptr::null_mut();
...
//
    ...
    err = devm_request_threaded_irq(dev, mcu.client.irq, core::ptr::null_mut(),
...
//
    ...
    if (irq < 0)
    return irq;
    return devm_request_threaded_irq(&mcu.client.dev, irq, core::ptr::null_mut(),
