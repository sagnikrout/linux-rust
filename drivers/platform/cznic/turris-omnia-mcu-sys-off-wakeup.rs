...
//! Source: drivers/platform/cznic/turris-omnia-mcu-sys-off-wakeup.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn omnia_read_time(dev: *mut device, tm: *mut rtc_time) -> c_int {
    static int omnia_read_time(struct device *dev, struct rtc_time *tm)
    {
    u32 uptime;
    int err;
    err = omnia_get_uptime_wakeup(to_i2c_client(dev), &uptime, core::ptr::null_mut());
    if (err)
    return err;
...
#[no_mangle]
unsafe extern "C" fn omnia_read_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
    ...
    u32 wakeup;
    int err;
    err = omnia_get_uptime_wakeup(client, core::ptr::null_mut(), &wakeup);
    if (err)
    return err;
    alrm.enabled = !!wakeup;
...
#[no_mangle]
unsafe extern "C" fn omnia_set_alarm(dev: *mut device, alrm: *mut rtc_wkalrm) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_alarm_irq_enable(dev: *mut device, enabled: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_power_off(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_restart(data: *mut sys_off_data) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn omnia_mcu_register_sys_off_and_wakeup(mcu: *mut omnia_mcu) -> c_int {
