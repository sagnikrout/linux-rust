...
//! Source: drivers/platform/cznic/turris-omnia-mcu-base.c
#![no_std]
...
pub const OMNIA_FW_VERSION_LEN: c_int = 20;

pub const OMNIA_BOARD_INFO_LEN: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn omnia_mcu_print_version_hash(mcu: *mut omnia_mcu, bootloader: bool) {
...
#[no_mangle]
unsafe extern "C" fn omnia_info_missing_feature(dev: *mut device, feature: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn omnia_mcu_read_features(mcu: *mut omnia_mcu) -> c_int {
    ...
    let mut suggest_fw_upgrade: bool = false;
    u16 status;
    int err;
...
#[no_mangle]
unsafe extern "C" fn omnia_mcu_read_board_info(mcu: *mut omnia_mcu) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn omnia_mcu_probe(client: *mut i2c_client) -> c_int {
