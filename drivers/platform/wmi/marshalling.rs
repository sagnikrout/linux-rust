...
//! Source: drivers/platform/wmi/marshalling.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn wmi_adjust_buffer_length(length: *mut usize, obj: *const union acpi_object) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_obj_get_buffer_length(obj: *const union acpi_object, length: *mut usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_obj_transform_simple(obj: *const union acpi_object, buffer: *mut u8, consumed: *mut usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_obj_transform(obj: *const union acpi_object, buffer: *mut u8) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn wmi_marshal_string(buffer: *const wmi_buffer, out: *mut acpi_buffer) -> c_int {
