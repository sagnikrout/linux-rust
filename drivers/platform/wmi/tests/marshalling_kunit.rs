...
//! Source: drivers/platform/wmi/tests/marshalling_kunit.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_acpi_param {
    pub name: *const c_char,
    pub obj: union acpi_object,
    pub buffer: wmi_buffer,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_invalid_acpi_param {
    pub name: *const c_char,
    pub obj: union acpi_object,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_invalid_string_param {
    pub name: *const c_char,
    pub buffer: wmi_buffer,
}
...
#[no_mangle]
unsafe extern "C" fn wmi_acpi_param_get_desc(param: *const wmi_acpi_param, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn wmi_invalid_acpi_param_get_desc(param: *const wmi_invalid_acpi_param, desc: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn wmi_unmarshal_acpi_object_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmi_unmarshal_acpi_object_failure_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmi_marshal_string_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmi_marshal_string_failure_test(test: *mut kunit) {
...
#[no_mangle]
unsafe extern "C" fn wmi_unmarshal_acpi_object_undersized_test(test: *mut kunit) {
