...
//! Source: drivers/platform/wmi/core.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct guid_block {
    pub guid: guid_t,
    union {
    pub object_id: [c_char; 2],
    struct {
    pub notify_id: c_uchar,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_block {
    pub dev: wmi_device,
    pub gblock: guid_block,
    pub acpi_device: *mut acpi_device,
    pub /: *mut *mut rw_semaphore notify_lock; / Protects notify callback add/remove,
    pub handler: wmi_notify_handler,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_guid_count_context {
...
//
#[no_mangle]
unsafe extern "C" fn guid_parse_and_compare(string: *const c_char, guid: *const guid_t) -> bool {
...
pub const WMI_ACPI_METHOD_NAME_SIZE: c_int = 5;
...
#[no_mangle]
unsafe extern "C" fn wmidev_match_guid(dev: *mut device, data: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_device_enable(wdev: *mut wmi_device, enable: bool) -> c_int {
...
//
    ...
    return 0;
    status = acpi_execute_simple_method(handle, core::ptr::null_mut(), enable);
    if (ACPI_FAILURE(status))
    return -EIO;
    return 0;
    }
    ...
    if (ret < 0)
    return ERR_PTR(ret);
    dev = bus_find_device(&wmi_bus_type, core::ptr::null_mut(), &guid, wmidev_match_guid);
    if (!dev)
    return ERR_PTR(-ENODEV);
    return to_wmi_device(dev);
    }
#[no_mangle]
unsafe extern "C" fn wmi_device_put(wdev: *mut wmi_device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn wmi_instance_count(guid_string: *const c_char) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wmidev_instance_count(wdev: *mut wmi_device) -> u8 {
...
//
    ...
    {
    struct wmi_block *wblock = container_of(wdev, struct wmi_block, dev);
    let mut aout: acpi_buffer = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
...
//
    ...
    status = wmidev_evaluate_method(wdev, instance, method_id, &ain, core::ptr::null_mut());
    if (wblock.gblock.flags & ACPI_WMI_STRING)
    kfree(ain.pointer);
    if (ACPI_FAILURE(status))
    return -EIO;
...
//
#[no_mangle]
pub unsafe extern "C" fn wmi_set_block(guid_string: *const c_char, instance: u8, in: *const acpi_buffer) -> acpi_status {
...
//
#[no_mangle]
pub unsafe extern "C" fn wmidev_block_set(wdev: *mut wmi_device, instance: u8, in: *const acpi_buffer) -> acpi_status {
    acpi_status wmidev_block_set(struct wmi_device *wdev, u8 instance, const struct acpi_buffer *in)
    {
    struct wmi_block *wblock = container_of(wdev, struct wmi_block, dev);
    let mut handle: acpi_handle = wblock.acpi_device.handle;
...
// Check GUID is a data block
    ...
    return acpi_evaluate_object(handle, method, &input, core::ptr::null_mut());
    }
...
//
#[no_mangle]
pub unsafe extern "C" fn wmidev_set_block(wdev: *mut wmi_device, instance: u8, in: *const wmi_buffer) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn wmi_remove_notify_handler(guid: *const c_char) -> acpi_status {
    ...
    wblock.handler = core::ptr::null_mut();
    wblock.handler_data = core::ptr::null_mut();
    status = AE_OK;
    }
    up_write(&wblock.notify_lock);
    wmi_device_put(wdev);
...
//
#[no_mangle]
pub unsafe extern "C" fn wmi_has_guid(guid_string: *const c_char) -> bool {
...
#[no_mangle]
unsafe extern "C" fn wmi_dev_uevent(dev: *const device, env: *mut kobj_uevent_env) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_dev_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn wmi_dev_match(dev: *mut device, driver: *const device_driver) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_dev_disable(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wmi_dev_probe(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_dev_remove(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn wmi_dev_shutdown(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn wmi_count_guids(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn guid_count(guid: *const guid_t) -> c_int {
    ...
    int ret;
    ret = bus_for_each_dev(&wmi_bus_type, core::ptr::null_mut(), &context, wmi_count_guids);
    if (ret < 0)
    return ret;
    return context.count;
    }
#[no_mangle]
unsafe extern "C" fn wmi_dev_set_name(wblock: *mut wmi_block, count: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wmi_add_device(pdev: *mut platform_device, wdev: *mut wmi_device) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn parse_wdg(wmi_bus_dev: *mut device, pdev: *mut platform_device) -> c_int {
    ...
    u32 i, total;
    int retval;
    status = acpi_evaluate_object(device.handle, "_WDG", core::ptr::null_mut(), &out);
    if (ACPI_FAILURE(status))
    return -ENXIO;
    obj = out.pointer;
    if (!obj)
...
#[no_mangle]
unsafe extern "C" fn wmi_get_notify_data(wblock: *mut wmi_block, obj: *mut union acpi_object) -> c_int {
    static int wmi_get_notify_data(struct wmi_block *wblock, union acpi_object **obj)
    {
    let mut data: acpi_buffer = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
...
#[no_mangle]
unsafe extern "C" fn wmi_notify_driver(wblock: *mut wmi_block, obj: *mut union acpi_object) {
...
#[no_mangle]
unsafe extern "C" fn wmi_notify_device(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn acpi_wmi_notify_handler(handle: acpi_handle, event: u32, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn wmi_remove_device(dev: *mut device, data: *mut c_void) -> c_int {
    static int wmi_remove_device(struct device *dev, void *data)
    {
    let mut id: c_int = dev.id;
    device_unregister(dev);
    ida_free(&wmi_ida, id);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn acpi_wmi_remove(device: *mut platform_device) {
    static void acpi_wmi_remove(struct platform_device *device)
    {
    struct device *wmi_bus_device = dev_get_drvdata(&device.dev);
    device_for_each_child_reverse(wmi_bus_device, core::ptr::null_mut(), wmi_remove_device);
    }
#[no_mangle]
unsafe extern "C" fn acpi_wmi_remove_notify_handler(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_wmi_remove_bus_device(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn acpi_wmi_probe(device: *mut platform_device) -> c_int {
    ...
    wmi_bus_dev = device_create(&wmi_bus_class, &device.dev, MKDEV(0, 0), core::ptr::null_mut(), "wmi_bus-%s",
    dev_name(&device.dev));
...
//
#[no_mangle]
pub unsafe extern "C" fn wmi_driver_unregister(driver: *mut wmi_driver) {
...
#[no_mangle]
unsafe extern "C" fn acpi_wmi_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_wmi_exit() -> void __exit {
