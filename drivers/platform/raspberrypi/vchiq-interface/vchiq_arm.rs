...
//! Source: drivers/platform/raspberrypi/vchiq-interface/vchiq_arm.c
#![no_std]
...
pub const VCHIQ_PLATFORM_FRAGMENTS_OFFSET_IDX: c_int = 0;
pub const VCHIQ_PLATFORM_FRAGMENTS_COUNT_IDX: c_int = 1;
pub const BELL0: c_uint = 0x00;

// Override the default prefix, which would be vchiq_arm (from the filename)

pub const KEEPALIVE_VER: c_int = 1;
...
//
    pub ka_thread: *mut task_struct,
    pub ka_evt: completion,
    pub ka_use_count: core::sync::atomic::AtomicI32,
    pub ka_use_ack_count: core::sync::atomic::AtomicI32,
    pub ka_release_count: core::sync::atomic::AtomicI32,
    pub susp_res_lock: rwlock_t,
...
//
    pub videocore_use_count: c_int,
//
// Use count to track requests from videocore peer.
// This use count is not associated with a service, so needs to be
// tracked separately with the state.
//
    pub peer_use_count: c_int,
//
// Flag to indicate that the first vchiq connect has made it through.
// This means that both sides should be fully ready, and we should
// be able to suspend after this point.
//
    pub first_connect: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn vchiq_call_connected_callbacks(drv_mgmt: *mut vchiq_drv_mgmt) {
...
//
#[no_mangle]
pub unsafe extern "C" fn vchiq_add_connected_callback(device: *mut vchiq_device, (*callback)(void): *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn vchiq_platform_init(pdev: *mut platform_device, state: *mut vchiq_state) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn vchiq_dump_platform_state(f: *mut seq_file) {
    void vchiq_dump_platform_state(struct seq_file *f)
    {
    seq_puts(f, "  Platform: 2835 (VC master)\n");
    }
pub const VCHIQ_INIT_RETRIES: c_int = 10;
#[no_mangle]
pub unsafe extern "C" fn vchiq_initialise(state: *mut vchiq_state, instance_out: *mut vchiq_instance) -> c_int {
    int vchiq_initialise(struct vchiq_state *state, struct vchiq_instance **instance_out)
    {
    struct vchiq_instance *instance = core::ptr::null_mut();
    int i, ret;
//
...
#[no_mangle]
pub unsafe extern "C" fn free_bulk_waiter(instance: *mut vchiq_instance) {
...
#[no_mangle]
pub unsafe extern "C" fn vchiq_shutdown(instance: *mut vchiq_instance) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn vchiq_is_connected(instance: *mut vchiq_instance) -> c_int {
    static int vchiq_is_connected(struct vchiq_instance *instance)
    {
    return instance.connected;
    }
#[no_mangle]
pub unsafe extern "C" fn vchiq_connect(instance: *mut vchiq_instance) -> c_int {
...
// phandle = VCHIQ_SERVICE_HANDLE_INVALID;
    ...
    service = vchiq_add_service_internal(state, params, srvstate, instance, core::ptr::null_mut());
    if (service) {
...
// phandle = VCHIQ_SERVICE_HANDLE_INVALID;
    ...
    goto failed;
    service = vchiq_add_service_internal(state, params, VCHIQ_SRVSTATE_OPENING, instance, core::ptr::null_mut());
    if (service) {
// phandle = service->handle;
...
//
    ...
    ret = add_completion(instance, reason, core::ptr::null_mut(), user_service,
    cb_data, cb_userdata);
    if (ret)
    return ret;
    }
...
//
    ...
    struct user_service *user_service;
    struct vchiq_service *service;
    let mut skip_completion: bool = false;
    DEBUG_INITIALISE(mgmt.state.local);
    DEBUG_TRACE(SERVICE_CALLBACK_LINE);
    rcu_read_lock();
...
#[no_mangle]
pub unsafe extern "C" fn vchiq_dump_platform_instances(state: *mut vchiq_state, f: *mut seq_file) {
...
//
    ...
    if (!ret) {
    let mut ret: c_int = 0;
    let mut ack_cnt: c_long = atomic_xchg(&arm_state.ka_use_ack_count, 0);
    while (ack_cnt && !ret) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct service_data_struct {
    pub fourcc: c_int,
    pub clientid: c_int,
    pub use_count: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn vchiq_probe(pdev: *mut platform_device) -> c_int {
    ...
    of_find_compatible_node(core::ptr::null_mut(), core::ptr::null_mut(), "raspberrypi,bcm2835-firmware");
    if (!fw_node) {
...
#[no_mangle]
unsafe extern "C" fn vchiq_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn vchiq_driver_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn vchiq_driver_exit() -> void __exit {
