...
//! Source: drivers/platform/x86/topstar-laptop.c
#![no_std]
...
//
#[no_mangle]
unsafe extern "C" fn topstar_led_get(led: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn topstar_led_init(topstar: *mut topstar_laptop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn topstar_led_exit(topstar: *mut topstar_laptop) {
...
#[no_mangle]
unsafe extern "C" fn topstar_input_notify(topstar: *mut topstar_laptop, event: c_int) {
...
#[no_mangle]
unsafe extern "C" fn topstar_input_init(topstar: *mut topstar_laptop) -> c_int {
    ...
    err = sparse_keymap_setup(input, topstar_keymap, core::ptr::null_mut());
    if (err) {
...
#[no_mangle]
unsafe extern "C" fn topstar_input_exit(topstar: *mut topstar_laptop) {
...
#[no_mangle]
unsafe extern "C" fn topstar_platform_init(topstar: *mut topstar_laptop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn topstar_platform_exit(topstar: *mut topstar_laptop) {
...
//
#[no_mangle]
unsafe extern "C" fn topstar_acpi_fncx_switch(device: *mut acpi_device, state: bool) -> c_int {
    static int topstar_acpi_fncx_switch(struct acpi_device *device, bool state)
    {
    acpi_status status;
    let mut arg: u64 = state ? 0x86 : 0x87;
...
#[no_mangle]
unsafe extern "C" fn topstar_acpi_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn topstar_acpi_init(topstar: *mut topstar_laptop) -> c_int {
    static int topstar_acpi_init(struct topstar_laptop *topstar)
    {
    return topstar_acpi_fncx_switch(topstar.device, true);
    }
#[no_mangle]
unsafe extern "C" fn topstar_acpi_exit(topstar: *mut topstar_laptop) {
...
#[no_mangle]
unsafe extern "C" fn dmi_led_workaround(id: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn topstar_acpi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn topstar_acpi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn topstar_laptop_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn topstar_laptop_exit() -> void __exit {
