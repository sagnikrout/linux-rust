...
//! Source: drivers/platform/x86/msi-laptop.c
#![no_std]
...
pub const MSI_LCD_LEVEL_MAX: c_int = 9;
pub const MSI_EC_COMMAND_WIRELESS: c_uint = 0x10;
pub const MSI_EC_COMMAND_LCD_LEVEL: c_uint = 0x11;
pub const MSI_STANDARD_EC_COMMAND_ADDRESS: c_uint = 0x2e;

// For set SCM load flag to disable BIOS fn key
pub const MSI_STANDARD_EC_SCM_LOAD_ADDRESS: c_uint = 0x2d;

pub const MSI_STANDARD_EC_FUNCTIONS_ADDRESS: c_uint = 0xe4;
...
pub const MSI_STANDARD_EC_FAN_ADDRESS: c_uint = 0x33;
// If zero, fan rotates at maximal speed

    static int msi_laptop_resume(struct device *device);

    static SIMPLE_DEV_PM_OPS(msi_laptop_pm, core::ptr::null_mut(), msi_laptop_resume);
pub const MSI_STANDARD_EC_DEVICES_EXISTS_ADDRESS: c_uint = 0x2f;
    static bool force;
...
//
    pub ec_read_only: bool,
}

    static struct quirk_entry *quirks;
// Hardware access
#[no_mangle]
unsafe extern "C" fn set_lcd_level(level: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_lcd_level() -> c_int {
    static int get_lcd_level(void)
    {
    let mut wdata: u8 = 0, rdata;
    int result;
...
#[no_mangle]
unsafe extern "C" fn get_auto_brightness() -> c_int {
    static int get_auto_brightness(void)
    {
    let mut wdata: u8 = 4, rdata;
    int result;
    result = ec_transaction(MSI_EC_COMMAND_LCD_LEVEL, &wdata, 1,
    &rdata, 1);
    if (result < 0)
...
#[no_mangle]
unsafe extern "C" fn set_auto_brightness(enable: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn set_device_state(buf: *const c_char, count: usize, mask: u8) -> isize {
...
#[no_mangle]
unsafe extern "C" fn get_wireless_state(wlan: *mut c_int, bluetooth: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_wireless_state_ec_standard() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_threeg_exists() -> c_int {
...
// Platform device
    ...
    ret = get_wireless_state(&enabled, core::ptr::null_mut());
    } else {
    ...
    int ret, enabled = 0;
    if (quirks.old_ec_model) {
    ret = get_wireless_state(core::ptr::null_mut(), &enabled);
    } else {
    ret = get_wireless_state_ec_standard();
    enabled = bluetooth_s;
    }
...
// old msi ec not support 3G
    ...
    static DEVICE_ATTR(bluetooth, 0444, show_bluetooth, core::ptr::null_mut());
    static DEVICE_ATTR(wlan, 0444, show_wlan, core::ptr::null_mut());
    static DEVICE_ATTR(threeg, 0444, show_threeg, core::ptr::null_mut());
    static DEVICE_ATTR(touchpad, 0444, show_touchpad, core::ptr::null_mut());
    static DEVICE_ATTR(turbo_mode, 0444, show_turbo, core::ptr::null_mut());
    static DEVICE_ATTR(eco_mode, 0444, show_eco, core::ptr::null_mut());
    static DEVICE_ATTR(turbo_cooldown, 0444, show_turbo_cooldown, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dmi_check_cb(dmi: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi_work_delay(msecs: c_int) -> c_ulong {
...
#[no_mangle]
unsafe extern "C" fn rfkill_bluetooth_set(data: *mut c_void, blocked: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfkill_wlan_set(data: *mut c_void, blocked: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfkill_threeg_set(data: *mut c_void, blocked: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rfkill_cleanup() {
...
#[no_mangle]
unsafe extern "C" fn msi_rfkill_set_state(rfkill: *mut rfkill, blocked: bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn msi_update_rfkill(ignored: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn msi_send_touchpad_key(ignored: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn msi_init_rfkill(ignored: *mut work_struct) {
    static void msi_init_rfkill(struct work_struct *ignored)
    {
    if (rfk_wlan) {
    msi_rfkill_set_state(rfk_wlan, !wlan_s);
    rfkill_wlan_set(core::ptr::null_mut(), !wlan_s);
    }
    if (rfk_bluetooth) {
    msi_rfkill_set_state(rfk_bluetooth, !bluetooth_s);
    rfkill_bluetooth_set(core::ptr::null_mut(), !bluetooth_s);
    }
    if (rfk_threeg) {
    msi_rfkill_set_state(rfk_threeg, !threeg_s);
    rfkill_threeg_set(core::ptr::null_mut(), !threeg_s);
    }
    }
    static DECLARE_DELAYED_WORK(msi_rfkill_init, msi_init_rfkill);
#[no_mangle]
unsafe extern "C" fn rfkill_init(sdev: *mut platform_device) -> c_int {
...
// keep the hardware wireless state
    ...
    &rfkill_bluetooth_ops, core::ptr::null_mut());
    if (!rfk_bluetooth) {
    retval = -ENOMEM;
    goto err_bluetooth;
    }
    ...
    &rfkill_wlan_ops, core::ptr::null_mut());
    if (!rfk_wlan) {
    retval = -ENOMEM;
    goto err_wlan;
    }
    ...
    RFKILL_TYPE_WWAN, &rfkill_threeg_ops, core::ptr::null_mut());
    if (!rfk_threeg) {
    retval = -ENOMEM;
    goto err_threeg;
    }
...
#[no_mangle]
unsafe extern "C" fn msi_scm_disable_hw_fn_handling() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi_laptop_resume(device: *mut device) -> c_int {
    static int msi_laptop_resume(struct device *device)
    {
...
#[no_mangle]
unsafe extern "C" fn msi_laptop_input_setup() -> int __init {
    ...
    msi_laptop_keymap, core::ptr::null_mut());
    if (err)
    goto err_free_dev;
...
#[no_mangle]
unsafe extern "C" fn load_scm_model_init(sdev: *mut platform_device) -> int __init {
...
// setup input device
    ...
    if (result)
    goto fail_input;
    result = i8042_install_filter(msi_laptop_i8042_filter, core::ptr::null_mut());
    if (result) {
...
#[no_mangle]
unsafe extern "C" fn msi_scm_model_exit() {
...
#[no_mangle]
unsafe extern "C" fn msi_init() -> int __init {
...
// Register backlight stuff
    ...
    msibl_device = backlight_device_register("msi-laptop-bl", core::ptr::null_mut(),
    core::ptr::null_mut(), &msibl_ops,
    &props);
...
#[no_mangle]
unsafe extern "C" fn msi_cleanup() -> void __exit {
