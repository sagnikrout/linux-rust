...
//! Source: drivers/platform/x86/eeepc-wmi.c
#![no_std]
...
pub const HOME_PRESS: c_uint = 0xe4;
pub const HOME_HOLD: c_uint = 0xea;
pub const HOME_RELEASE: c_uint = 0xe5;
...
#[no_mangle]
unsafe extern "C" fn et2012_quirks() {
...
#[no_mangle]
pub unsafe extern "C" fn if('3': oemstring[18] ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn dmi_matched(dmi: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_wmi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_wmi_quirks(driver: *mut asus_wmi_driver) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_wmi_init() -> int __init {
    static int __init eeepc_wmi_init(void)
    {
    return asus_wmi_register_driver(&asus_wmi_driver);
    }
#[no_mangle]
unsafe extern "C" fn eeepc_wmi_exit() -> void __exit {
