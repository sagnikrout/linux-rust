...
//! Source: drivers/platform/x86/oxpec.c
#![no_std]
...
pub const ACPI_LOCK_DELAY_MS: c_int = 500;
#[no_mangle]
unsafe extern "C" fn lock_global_acpi_lock() -> bool {
    static bool lock_global_acpi_lock(void)
    {
    return ACPI_SUCCESS(acpi_acquire_global_lock(ACPI_LOCK_DELAY_MS, &oxp_mutex));
    }
#[no_mangle]
unsafe extern "C" fn unlock_global_acpi_lock() -> bool {
...
// Fan reading and PWM
pub const OXP_SENSOR_FAN_REG: c_uint = 0x76 /* Fan reading is 2 registers long */;
pub const OXP_2_SENSOR_FAN_REG: c_uint = 0x58 /* Fan reading is 2 registers long */;
pub const OXP_SENSOR_PWM_ENABLE_REG: c_uint = 0x4A /* PWM enable is 1 register long */;
pub const OXP_SENSOR_PWM_REG: c_uint = 0x4B /* PWM reading is 1 register long */;
pub const PWM_MODE_AUTO: c_uint = 0x00;
pub const PWM_MODE_MANUAL: c_uint = 0x01;
// OrangePi fan reading and PWM
pub const ORANGEPI_SENSOR_FAN_REG: c_uint = 0x78 /* Fan reading is 2 registers long */;
pub const ORANGEPI_SENSOR_PWM_ENABLE_REG: c_uint = 0x40 /* PWM enable is 1 register long */;
pub const ORANGEPI_SENSOR_PWM_REG: c_uint = 0x38 /* PWM reading is 1 register long */;
// Turbo button takeover function
// Different boards have different values and EC registers
// for the same function
//
pub const OXP_TURBO_SWITCH_REG: c_uint = 0xF1 /* Mini Pro, OneXFly, AOKZOE */;
pub const OXP_2_TURBO_SWITCH_REG: c_uint = 0xEB /* OXP2 and X1 */;
pub const OXP_MINI_TURBO_SWITCH_REG: c_uint = 0x1E /* Mini AO7 */;
pub const OXP_MINI_TURBO_TAKE_VAL: c_uint = 0x01 /* Mini AO7 */;
pub const OXP_TURBO_TAKE_VAL: c_uint = 0x40 /* All other models */;
// X1 Turbo LED
pub const OXP_X1_TURBO_LED_REG: c_uint = 0x57;
pub const OXP_X1_TURBO_LED_OFF: c_uint = 0x01;
pub const OXP_X1_TURBO_LED_ON: c_uint = 0x02;
// Battery extension settings

    BIT(POWER_SUPPLY_CHARGE_BEHAVIOUR_INHIBIT_CHARGE) |	\
    BIT(POWER_SUPPLY_CHARGE_BEHAVIOUR_INHIBIT_CHARGE_AWAKE))
pub const OXP_X1_CHARGE_LIMIT_REG: c_uint = 0xA3 /* X1 charge limit (%) */;
pub const OXP_X1_CHARGE_INHIBIT_REG: c_uint = 0xA4 /* X1 bypass charging */;
pub const OXP_X1_CHARGE_INHIBIT_MASK_AWAKE: c_uint = 0x01;
// X1 Mask is 0x0A, F1Pro is 0x02 but the extra bit on the X1 does nothing.
pub const OXP_X1_CHARGE_INHIBIT_MASK_OFF: c_uint = 0x02;
...
#[no_mangle]
unsafe extern "C" fn read_from_ec(reg: u8, size: c_int, val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_to_ec(reg: u8, value: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oxp_psy_ext_supported() -> bool {
...
#[no_mangle]
unsafe extern "C" fn oxp_add_battery(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
    static int oxp_add_battery(struct power_supply *battery, struct acpi_battery_hook *hook)
    {
    return power_supply_register_extension(battery, &oxp_psy_ext, oxp_dev, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn oxp_remove_battery(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oxp_pwm_enable() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oxp_pwm_disable() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oxp_pwm_read(val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oxp_pwm_fan_speed(val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oxp_pwm_input_write(val: c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oxp_pwm_input_read(val: *mut c_long) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn oxp_platform_probe(pdev: *mut platform_device) -> c_int {
    ...
    int ret;
    oxp_dev = dev;
    hwdev = devm_hwmon_device_register_with_info(dev, "oxp_ec", core::ptr::null_mut(),
    &oxp_ec_chip_info, core::ptr::null_mut());
    if (IS_ERR(hwdev))
...
#[no_mangle]
unsafe extern "C" fn oxp_platform_init() -> int __init {
...
//
    ...
    oxp_platform_probe, core::ptr::null_mut(), 0, core::ptr::null_mut(), 0);
    return PTR_ERR_OR_ZERO(oxp_platform_device);
    }
#[no_mangle]
unsafe extern "C" fn oxp_platform_exit() -> void __exit {
