...
//! Source: drivers/platform/x86/inspur_platform_profile.c
#![no_std]
...
pub struct inspur_wmi_priv {
    ...
    let mut input: acpi_buffer = { insize, buffer};
...
#[no_mangle]
unsafe extern "C" fn inspur_platform_profile_probe(drvdata: *mut c_void, choices: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn inspur_wmi_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
