...
//! Source: drivers/platform/x86/compal-laptop.c
#![no_std]
...
pub const BACKLIGHT_LEVEL_ADDR: c_uint = 0xB9;
pub const BACKLIGHT_LEVEL_MAX: c_int = 7;
pub const BACKLIGHT_STATE_ADDR: c_uint = 0x59;
pub const BACKLIGHT_STATE_ON_DATA: c_uint = 0xE1;
pub const BACKLIGHT_STATE_OFF_DATA: c_uint = 0xE2;
pub const WAKE_UP_ADDR: c_uint = 0xA4;

pub const WIRELESS_ADDR: c_uint = 0xBB;

pub const PWM_ADDRESS: c_uint = 0x46;
pub const PWM_DISABLE_ADDR: c_uint = 0x59;
pub const PWM_DISABLE_DATA: c_uint = 0xA5;
pub const PWM_ENABLE_ADDR: c_uint = 0x59;
pub const PWM_ENABLE_DATA: c_uint = 0xA8;
pub const FAN_ADDRESS: c_uint = 0x46;
pub const FAN_DATA: c_uint = 0x81;
pub const FAN_FULL_ON_CMD: c_uint = 0x59 /* Doesn't seem to work. Just */;
pub const FAN_FULL_ON_ENABLE: c_uint = 0x76 /* force the pwm signal to its */;
pub const FAN_FULL_ON_DISABLE: c_uint = 0x77 /* maximum value instead */;
pub const TEMP_CPU: c_uint = 0xB0;
pub const TEMP_CPU_LOCAL: c_uint = 0xB1;
pub const TEMP_CPU_DTS: c_uint = 0xB5;
pub const TEMP_NORTHBRIDGE: c_uint = 0xB6;
pub const TEMP_VGA: c_uint = 0xB4;
pub const TEMP_SKIN: c_uint = 0xB2;
pub const BAT_MANUFACTURER_NAME_ADDR: c_uint = 0x10;
pub const BAT_MANUFACTURER_NAME_LEN: c_int = 9;
pub const BAT_MODEL_NAME_ADDR: c_uint = 0x19;
pub const BAT_MODEL_NAME_LEN: c_int = 6;
pub const BAT_SERIAL_NUMBER_ADDR: c_uint = 0xC4;
pub const BAT_SERIAL_NUMBER_LEN: c_int = 5;
pub const BAT_CHARGE_NOW: c_uint = 0xC2;
pub const BAT_CHARGE_DESIGN: c_uint = 0xCA;
pub const BAT_VOLTAGE_NOW: c_uint = 0xC6;
pub const BAT_VOLTAGE_DESIGN: c_uint = 0xC8;
pub const BAT_CURRENT_NOW: c_uint = 0xD0;
pub const BAT_CURRENT_AVG: c_uint = 0xD2;
pub const BAT_POWER: c_uint = 0xD4;
pub const BAT_CAPACITY: c_uint = 0xCE;
pub const BAT_TEMP: c_uint = 0xD6;
pub const BAT_TEMP_AVG: c_uint = 0xD7;
pub const BAT_STATUS0: c_uint = 0xC1;
pub const BAT_STATUS1: c_uint = 0xF0;
pub const BAT_STATUS2: c_uint = 0xF1;
pub const BAT_STOP_CHARGE1: c_uint = 0xF2;
pub const BAT_STOP_CHARGE2: c_uint = 0xF3;
pub const BAT_CHARGE_LIMIT: c_uint = 0x03;
pub const BAT_CHARGE_LIMIT_MAX: c_int = 100;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct compal_data {
// Fan control
    pub /: *mut *mut int pwm_enable; / 0:full on, 1:set by pwm1, 2:control by motherboard,
    pub curr_pwm: c_uchar,
// Power supply
    pub psy: *mut power_supply,
    pub psy_info: power_supply_info,
    pub 1]: char bat_model_name[BAT_MODEL_NAME_LEN +,
    pub 1]: char bat_manufacturer_name[BAT_MANUFACTURER_NAME_LEN +,
    pub 1]: char bat_serial_number[BAT_SERIAL_NUMBER_LEN +,
}
...
// General access
#[no_mangle]
unsafe extern "C" fn ec_read_u8(addr: u8) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn ec_read_s8(addr: u8) -> i8 {
    static s8 ec_read_s8(u8 addr)
    {
    return (s8)ec_read_u8(addr);
    }
#[no_mangle]
unsafe extern "C" fn ec_read_u16(addr: u8) -> u16 {
...
#[no_mangle]
unsafe extern "C" fn ec_read_s16(addr: u8) -> i16 {
    static s16 ec_read_s16(u8 addr)
    {
    return (s16) ec_read_u16(addr);
    }
#[no_mangle]
unsafe extern "C" fn ec_read_sequence(addr: u8, buf: *mut u8, len: c_int) {
...
// Backlight access
#[no_mangle]
unsafe extern "C" fn set_backlight_level(level: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_backlight_level() -> c_int {
    static int get_backlight_level(void)
    {
    return (int) ec_read_u8(BACKLIGHT_LEVEL_ADDR);
    }
#[no_mangle]
unsafe extern "C" fn set_backlight_state(on: bool) {
    static void set_backlight_state(bool on)
    {
    let mut data: u8 = on ? BACKLIGHT_STATE_ON_DATA : BACKLIGHT_STATE_OFF_DATA;
    ec_transaction(BACKLIGHT_STATE_ADDR, &data, 1, core::ptr::null_mut(), 0);
    }
// Fan control access
#[no_mangle]
unsafe extern "C" fn pwm_enable_control() {
    static void pwm_enable_control(void)
    {
    let mut writeData: c_uchar = PWM_ENABLE_DATA;
    ec_transaction(PWM_ENABLE_ADDR, &writeData, 1, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn pwm_disable_control() {
    static void pwm_disable_control(void)
    {
    let mut writeData: c_uchar = PWM_DISABLE_DATA;
    ec_transaction(PWM_DISABLE_ADDR, &writeData, 1, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn set_pwm(pwm: c_int) {
    static void set_pwm(int pwm)
    {
    ec_transaction(PWM_ADDRESS, &pwm_lookup_table[pwm], 1, core::ptr::null_mut(), 0);
    }
#[no_mangle]
unsafe extern "C" fn get_fan_rpm() -> c_int {
...
unsafe extern "C" fn bl_update_status(b: *mut backlight_device) -> c_int {
    ...
    {
    let mut ret: c_int = set_backlight_level(b.props.brightness);
    if (ret)
    return ret;
...
// Wireless interface
#[no_mangle]
unsafe extern "C" fn compal_rfkill_set(data: *mut c_void, blocked: bool) -> c_int {
    static int compal_rfkill_set(void *data, bool blocked)
    {
    let mut radio: c_ulong = (unsigned long) data;
    let mut result: u8 = ec_read_u8(WIRELESS_ADDR);
    u8 value;
    if (!blocked)
...
#[no_mangle]
unsafe extern "C" fn compal_rfkill_poll(rfkill: *mut rfkill, data: *mut c_void) {
    static void compal_rfkill_poll(struct rfkill *rfkill, void *data)
    {
    let mut result: u8 = ec_read_u8(WIRELESS_ADDR);
    let mut hw_blocked: bool = !(result & WIRELESS_KILLSWITCH);
...
#[no_mangle]
unsafe extern "C" fn bat_status() -> c_int {
    static int bat_status(void)
    {
    let mut status0: u8 = ec_read_u8(BAT_STATUS0);
    let mut status1: u8 = ec_read_u8(BAT_STATUS1);
...
#[no_mangle]
unsafe extern "C" fn bat_health() -> c_int {
    static int bat_health(void)
    {
    let mut status: u8 = ec_read_u8(BAT_STOP_CHARGE1);
...
#[no_mangle]
unsafe extern "C" fn bat_is_present() -> c_int {
    static int bat_is_present(void)
    {
    let mut status: u8 = ec_read_u8(BAT_STATUS2);
    return ((status & BAT_S1_EXISTS) != 0);
    }
#[no_mangle]
unsafe extern "C" fn bat_technology() -> c_int {
    static int bat_technology(void)
    {
    let mut status: u8 = ec_read_u8(BAT_STATUS1);
    if (status & BAT_S1_LiION_OR_NiMH)
    return POWER_SUPPLY_TECHNOLOGY_LION;
    return POWER_SUPPLY_TECHNOLOGY_NiMH;
    }
#[no_mangle]
unsafe extern "C" fn bat_capacity_level() -> c_int {
    static int bat_capacity_level(void)
    {
    let mut status0: u8 = ec_read_u8(BAT_STATUS0);
    let mut status1: u8 = ec_read_u8(BAT_STATUS1);
    let mut status2: u8 = ec_read_u8(BAT_STATUS2);
...
// ==============
    ...
    static DEVICE_ATTR(fan1_input,  S_IRUGO, fan_show,          core::ptr::null_mut());
    static DEVICE_ATTR(temp1_input, S_IRUGO, temp_cpu,          core::ptr::null_mut());
    static DEVICE_ATTR(temp2_input, S_IRUGO, temp_cpu_local,    core::ptr::null_mut());
    static DEVICE_ATTR(temp3_input, S_IRUGO, temp_cpu_DTS,      core::ptr::null_mut());
    static DEVICE_ATTR(temp4_input, S_IRUGO, temp_northbridge,  core::ptr::null_mut());
    static DEVICE_ATTR(temp5_input, S_IRUGO, temp_vga,          core::ptr::null_mut());
    static DEVICE_ATTR(temp6_input, S_IRUGO, temp_SKIN,         core::ptr::null_mut());
    static DEVICE_ATTR(temp1_label, S_IRUGO, label_cpu,         core::ptr::null_mut());
    static DEVICE_ATTR(temp2_label, S_IRUGO, label_cpu_local,   core::ptr::null_mut());
    static DEVICE_ATTR(temp3_label, S_IRUGO, label_cpu_DTS,     core::ptr::null_mut());
    static DEVICE_ATTR(temp4_label, S_IRUGO, label_northbridge, core::ptr::null_mut());
    static DEVICE_ATTR(temp5_label, S_IRUGO, label_vga,         core::ptr::null_mut());
    static DEVICE_ATTR(temp6_label, S_IRUGO, label_SKIN,        core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn dmi_check_cb_extra(id: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn initialize_power_supply_data(data: *mut compal_data) {
...
#[no_mangle]
unsafe extern "C" fn initialize_fan_control_data(data: *mut compal_data) {
...
#[no_mangle]
unsafe extern "C" fn setup_rfkill() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compal_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn compal_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn compal_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn compal_cleanup() -> void __exit {
