...
//! Source: drivers/platform/x86/msi-wmi-platform.c
#![no_std]
...
pub const MSI_WMI_PLATFORM_INTERFACE_VERSION: c_int = 2;
pub const MSI_PLATFORM_WMI_MAJOR_OFFSET: c_int = 1;
pub const MSI_PLATFORM_WMI_MINOR_OFFSET: c_int = 2;
pub const MSI_PLATFORM_EC_FLAGS_OFFSET: c_int = 1;

pub const MSI_PLATFORM_EC_VERSION_OFFSET: c_int = 2;
    static bool force;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct msi_wmi_platform_data {
    pub wdev: *mut wmi_device,
    pub /: *mut *mut mutex wmi_lock; / Necessary when calling WMI methods,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct msi_wmi_platform_debugfs_data {
    pub data: *mut msi_wmi_platform_data,
    pub method: enum msi_wmi_platform_method,
    pub /: *mut *mut rw_semaphore buffer_lock; / Protects debugfs buffer,
    pub length: usize,
    pub buffer: [u8; 32],
}
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_parse_buffer(obj: *mut union acpi_object, output: *mut u8, length: usize) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_show(seq: *mut seq_file, p: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_open(inode: *mut inode, fp: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_debugfs_remove(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_debugfs_init(data: *mut msi_wmi_platform_data) {
    ...
    dir = debugfs_create_dir(dir_name, core::ptr::null_mut());
    if (IS_ERR(dir))
    return;
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_hwmon_init(data: *mut msi_wmi_platform_data) -> c_int {
    ...
    &msi_wmi_platform_chip_info, core::ptr::null_mut());
    return PTR_ERR_OR_ZERO(hdev);
    }
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_ec_init(data: *mut msi_wmi_platform_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_init(data: *mut msi_wmi_platform_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
    ...
    { MSI_PLATFORM_GUID, core::ptr::null_mut() },
    { }
    };
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn msi_wmi_platform_module_exit() -> void __exit {
