...
//! Source: drivers/platform/x86/asus-tf103c-dock.c
#![no_std]
...
pub const TF103C_DOCK_TP_ADDR: c_uint = 0x15;
// Keyboard I2C device defines **A
pub const TF103C_DOCK_KBD_ADDR: c_uint = 0x16;
pub const TF103C_DOCK_KBD_DATA_REG: c_uint = 0x73;
pub const TF103C_DOCK_KBD_DATA_MIN_LENGTH: c_int = 4;
pub const TF103C_DOCK_KBD_DATA_MAX_LENGTH: c_int = 11;
pub const TF103C_DOCK_KBD_DATA_MODIFIERS: c_int = 3;
pub const TF103C_DOCK_KBD_DATA_KEYS: c_int = 5;
pub const TF103C_DOCK_KBD_CMD_REG: c_uint = 0x75;
pub const TF103C_DOCK_KBD_CMD_ENABLE: c_uint = 0x0800;
// EC innterrupt data I2C device defines
pub const TF103C_DOCK_INTR_ADDR: c_uint = 0x19;
pub const TF103C_DOCK_INTR_DATA_REG: c_uint = 0x6a;
pub const TF103C_DOCK_INTR_DATA1_OBF_MASK: c_uint = 0x01;
pub const TF103C_DOCK_INTR_DATA1_KEY_MASK: c_uint = 0x04;
pub const TF103C_DOCK_INTR_DATA1_KBC_MASK: c_uint = 0x08;
pub const TF103C_DOCK_INTR_DATA1_AUX_MASK: c_uint = 0x20;
pub const TF103C_DOCK_INTR_DATA1_SCI_MASK: c_uint = 0x40;
pub const TF103C_DOCK_INTR_DATA1_SMI_MASK: c_uint = 0x80;
// Special values for the OOB data on kbd_client / tp_client
pub const TF103C_DOCK_INTR_DATA1_OOB_VALUE: c_uint = 0xc1;
pub const TF103C_DOCK_INTR_DATA2_OOB_VALUE: c_uint = 0x04;
pub const TF103C_DOCK_SMI_AC_EVENT: c_uint = 0x31;
pub const TF103C_DOCK_SMI_HANDSHAKING: c_uint = 0x50;
pub const TF103C_DOCK_SMI_EC_WAKEUP: c_uint = 0x53;
pub const TF103C_DOCK_SMI_BOOTBLOCK_RESET: c_uint = 0x5e;
pub const TF103C_DOCK_SMI_WATCHDOG_RESET: c_uint = 0x5f;
pub const TF103C_DOCK_SMI_ADAPTER_CHANGE: c_uint = 0x60;
pub const TF103C_DOCK_SMI_DOCK_INSERT: c_uint = 0x61;
pub const TF103C_DOCK_SMI_DOCK_REMOVE: c_uint = 0x62;
pub const TF103C_DOCK_SMI_PAD_BL_CHANGE: c_uint = 0x63;
pub const TF103C_DOCK_SMI_HID_STATUS_CHANGED: c_uint = 0x64;
pub const TF103C_DOCK_SMI_HID_WAKEUP: c_uint = 0x65;
pub const TF103C_DOCK_SMI_S3: c_uint = 0x83;
pub const TF103C_DOCK_SMI_S5: c_uint = 0x85;
pub const TF103C_DOCK_SMI_NOTIFY_SHUTDOWN: c_uint = 0x90;
pub const TF103C_DOCK_SMI_RESUME: c_uint = 0x91;
// EC (dockram) I2C device defines
pub const TF103C_DOCK_EC_ADDR: c_uint = 0x1b;
pub const TF103C_DOCK_EC_CMD_REG: c_uint = 0x0a;
pub const TF103C_DOCK_EC_CMD_LEN: c_int = 9;
    enum {
    TF103C_DOCK_FLAG_HID_OPEN,
    };
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tf103c_dock_data {
    pub hpd_work: delayed_work,
    pub tp_irqchip: irq_chip,
    pub tp_irq_domain: *mut irq_domain,
    pub ec_client: *mut i2c_client,
    pub intr_client: *mut i2c_client,
    pub kbd_client: *mut i2c_client,
    pub tp_client: *mut i2c_client,
    pub pwr_en: *mut gpio_desc,
    ...
    pub hpd_irq: c_int,
    pub tp_irq: c_int,
    pub last_press_0x13: c_int,
    pub last_press_0x14: c_int,
    pub enabled: bool,
    pub tp_enabled: bool,
    pub altgr_pressed: bool,
    pub esc_pressed: bool,
    pub filter_esc: bool,
    pub kbd_buf: [u8; TF103C_DOCK_KBD_DATA_MAX_LENGTH],
}
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_kbd_read(dock: *mut tf103c_dock_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_kbd_write(dock: *mut tf103c_dock_data, cmd: u16) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_hid_parse(hid: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_hid_start(hid: *mut hid_device) -> c_int {
    static int tf103c_dock_hid_start(struct hid_device *hid)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tf103c_dock_hid_stop(hid: *mut hid_device) {
    static void tf103c_dock_hid_stop(struct hid_device *hid)
    {
    hid.claimed = 0;
    }
#[no_mangle]
unsafe extern "C" fn tf103c_dock_hid_open(hid: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_hid_close(hid: *mut hid_device) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_report_toprow_kbd_hook(dock: *mut tf103c_dock_data) {
...
// esc = 0;
    ...
    dock.esc_pressed = esc != core::ptr::null_mut();
    }
#[no_mangle]
unsafe extern "C" fn tf103c_dock_toprow_press(dock: *mut tf103c_dock_data, key_code: c_int) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_toprow_release(dock: *mut tf103c_dock_data, key_code: c_int) {
...
//
#[no_mangle]
unsafe extern "C" fn tf103c_dock_kbd_interrupt(dock: *mut tf103c_dock_data) {
...
//
#[no_mangle]
unsafe extern "C" fn tf103c_dock_enable_touchpad(dock: *mut tf103c_dock_data) {
    static void tf103c_dock_enable_touchpad(struct tf103c_dock_data *dock)
    {
    let mut board_info: i2c_board_info = { };
    struct device *dev = &dock.ec_client.dev;
    int ret;
    if (dock.tp_enabled) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_disable_touchpad(dock: *mut tf103c_dock_data) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_ec_cmd(dock: *mut tf103c_dock_data, cmd: *const u8) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_sci(dock: *mut tf103c_dock_data, val: u8) {
    static void tf103c_dock_sci(struct tf103c_dock_data *dock, u8 val)
    {
    struct device *dev = &dock.ec_client.dev;
    switch (val) {
    case 2:
    tf103c_dock_toprow_event(dock, 1, core::ptr::null_mut());
    return;
    case 4:
    tf103c_dock_toprow_event(dock, 2, core::ptr::null_mut());
    return;
    case 8:
    tf103c_dock_toprow_event(dock, 5, core::ptr::null_mut());
    return;
    case 17:
    tf103c_dock_toprow_event(dock, 6, core::ptr::null_mut());
    return;
    }
    dev_warn(dev, "warning unknown SCI value: 0x%02x\n", val);
    }
#[no_mangle]
unsafe extern "C" fn tf103c_dock_smi(dock: *mut tf103c_dock_data, val: u8) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
//
#[no_mangle]
unsafe extern "C" fn tf103c_dock_enable(dock: *mut tf103c_dock_data) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_disable(dock: *mut tf103c_dock_data) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_hpd_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_hpd_irq(irq: c_int, data: *mut c_void) -> irqreturn_t {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_start_hpd(dock: *mut tf103c_dock_data) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_stop_hpd(dock: *mut tf103c_dock_data) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_non_devm_cleanup(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_probe(client: *mut i2c_client) -> c_int {
...
//
    ...
    ret = devm_request_threaded_irq(dev, dock.irq, core::ptr::null_mut(), tf103c_dock_irq,
...
// 5. Setup irqchip for touchpad IRQ pass-through
    ...
    dock.tp_irq_domain = irq_domain_create_linear(core::ptr::null_mut(), 1, &irq_domain_simple_ops, core::ptr::null_mut());
    if (!dock.tp_irq_domain)
    return -ENOMEM;
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_remove(client: *mut i2c_client) {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_suspend(dev: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn tf103c_dock_resume(dev: *mut device) -> int __maybe_unused {
