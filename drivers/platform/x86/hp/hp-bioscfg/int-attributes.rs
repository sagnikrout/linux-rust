...
//! Source: drivers/platform/x86/hp/hp-bioscfg/int-attributes.c
#![no_std]
...
unsafe extern "C" fn current_value_show(kobj: *mut kobject, attr: *mut kobj_attribute, buf: *mut c_char) -> isize {
    ...
    {
    let mut instance_id: c_int = get_integer_instance_id(kobj);
    if (instance_id < 0)
    return -EIO;
...
//
#[no_mangle]
unsafe extern "C" fn validate_integer_input(instance_id: c_int, buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_integer_value(instance_id: c_int, attr_value: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn hp_alloc_integer_data() -> c_int {
...
//
    ...
    int instance_id)
    {
    char *dst = core::ptr::null_mut();
    let mut dst_size: c_int = *buffer_size / sizeof(u16);
    struct integer_data *integer_data = &bioscfg_drv.integer_data[instance_id];
    let mut ret: c_int = 0;
...
//
#[no_mangle]
pub unsafe extern "C" fn hp_exit_integer_attributes() {
    ...
    bioscfg_drv.integer_data = core::ptr::null_mut();
    }
