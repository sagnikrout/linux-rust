...
//! Source: drivers/platform/x86/hp/hp-bioscfg/biosattr-interface.c
#![no_std]
...
pub struct bios_args {
    ...
    pub commandtype: u32,
    pub datasize: u32,
    pub __counted_by(datasize): u8 data[],
}
...
//
#[no_mangle]
pub unsafe extern "C" fn hp_set_attribute(a_name: *const c_char, a_value: *const c_char) -> c_int {
    int hp_set_attribute(const char *a_name, const char *a_value)
    {
    int security_area_size;
    int a_name_size, a_value_size;
    u16 *buffer = core::ptr::null_mut();
    u16 *start;
...
//
    ...
    {
    struct acpi_buffer input, output = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
    struct bios_return *bios_return;
    union acpi_object *obj = core::ptr::null_mut();
    struct bios_args *args = core::ptr::null_mut();
...
//
#[no_mangle]
pub unsafe extern "C" fn hp_wmi_set_bios_setting(input_buffer: *mut u16, input_size: u32) -> c_int {
    int hp_wmi_set_bios_setting(u16 *input_buffer, u32 input_size)
    {
    union acpi_object *obj;
    let mut input: acpi_buffer = {input_size, input_buffer};
...
#[no_mangle]
unsafe extern "C" fn hp_attr_set_interface_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hp_attr_set_interface_remove(wdev: *mut wmi_device) {
...
#[no_mangle]
pub unsafe extern "C" fn hp_init_attr_set_interface() -> c_int {
    int hp_init_attr_set_interface(void)
    {
    return wmi_driver_register(&hp_attr_set_interface_driver);
    }
#[no_mangle]
pub unsafe extern "C" fn hp_exit_attr_set_interface() {
