...
//! Source: drivers/platform/x86/hp/hp-bioscfg/string-attributes.c
#![no_std]
...
unsafe extern "C" fn current_value_show(kobj: *mut kobject, attr: *mut kobj_attribute, buf: *mut c_char) -> isize {
    ...
    {
    let mut instance_id: c_int = get_string_instance_id(kobj);
    if (instance_id < 0)
    return -EIO;
...
//
#[no_mangle]
unsafe extern "C" fn validate_string_input(instance_id: c_int, buf: *const c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_string_value(instance_id: c_int, attr_value: *mut c_char) {
...
#[no_mangle]
pub unsafe extern "C" fn hp_alloc_string_data() -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn hp_exit_string_attributes() {
    ...
    bioscfg_drv.string_data = core::ptr::null_mut();
    }
