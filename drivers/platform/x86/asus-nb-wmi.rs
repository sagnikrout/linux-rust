...
//! Source: drivers/platform/x86/asus-nb-wmi.c
#![no_std]
...
// 4  | Software  | Software
//
    let mut wapf: static int = -1;
    module_param(wapf, uint, 0444);
    MODULE_PARM_DESC(wapf, "WAPF value");
    let mut tablet_mode_sw: static int = -1;
...
#[no_mangle]
unsafe extern "C" fn asus_nb_wmi_quirks(driver: *mut asus_wmi_driver) {
...
#[no_mangle]
unsafe extern "C" fn asus_nb_wmi_init() -> int __init {
    static int __init asus_nb_wmi_init(void)
    {
    return asus_wmi_register_driver(&asus_nb_wmi_driver);
    }
#[no_mangle]
unsafe extern "C" fn asus_nb_wmi_exit() -> void __exit {
