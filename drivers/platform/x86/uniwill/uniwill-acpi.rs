...
//! Source: drivers/platform/x86/uniwill/uniwill-acpi.c
#![no_std]
...
pub const EC_ADDR_BAT_POWER_UNIT_1: c_uint = 0x0400;
pub const EC_ADDR_BAT_POWER_UNIT_2: c_uint = 0x0401;
pub const EC_ADDR_BAT_DESIGN_CAPACITY_1: c_uint = 0x0402;
pub const EC_ADDR_BAT_DESIGN_CAPACITY_2: c_uint = 0x0403;
pub const EC_ADDR_BAT_FULL_CAPACITY_1: c_uint = 0x0404;
pub const EC_ADDR_BAT_FULL_CAPACITY_2: c_uint = 0x0405;
pub const EC_ADDR_BAT_DESIGN_VOLTAGE_1: c_uint = 0x0408;
pub const EC_ADDR_BAT_DESIGN_VOLTAGE_2: c_uint = 0x0409;
pub const EC_ADDR_BAT_STATUS_1: c_uint = 0x0432;

pub const EC_ADDR_BAT_STATUS_2: c_uint = 0x0433;
pub const EC_ADDR_BAT_CURRENT_1: c_uint = 0x0434;
pub const EC_ADDR_BAT_CURRENT_2: c_uint = 0x0435;
pub const EC_ADDR_BAT_REMAIN_CAPACITY_1: c_uint = 0x0436;
pub const EC_ADDR_BAT_REMAIN_CAPACITY_2: c_uint = 0x0437;
pub const EC_ADDR_BAT_VOLTAGE_1: c_uint = 0x0438;
pub const EC_ADDR_BAT_VOLTAGE_2: c_uint = 0x0439;
pub const EC_ADDR_CPU_TEMP: c_uint = 0x043E;
pub const EC_ADDR_GPU_TEMP: c_uint = 0x044F;
pub const EC_ADDR_SYSTEM_ID: c_uint = 0x0456;

pub const EC_ADDR_MAIN_FAN_RPM_1: c_uint = 0x0464;
pub const EC_ADDR_MAIN_FAN_RPM_2: c_uint = 0x0465;
pub const EC_ADDR_SCREEN_STATUS: c_uint = 0x0466;

pub const EC_ADDR_SECOND_FAN_RPM_1: c_uint = 0x046C;
pub const EC_ADDR_SECOND_FAN_RPM_2: c_uint = 0x046D;
pub const EC_ADDR_DEVICE_STATUS: c_uint = 0x047B;

// BIT(5) is also unset depending on the rfkill state (bluetooth?)
pub const EC_ADDR_BAT_ALERT: c_uint = 0x0494;
pub const EC_ADDR_BAT_CYCLE_COUNT_1: c_uint = 0x04A6;
pub const EC_ADDR_BAT_CYCLE_COUNT_2: c_uint = 0x04A7;
pub const EC_ADDR_OEM_9: c_uint = 0x0726;

pub const EC_ADDR_PROJECT_ID: c_uint = 0x0740;
pub const PROJECT_ID_NONE: c_uint = 0x00;
pub const PROJECT_ID_GI: c_uint = 0x01;
pub const PROJECT_ID_GJ: c_uint = 0x02;
pub const PROJECT_ID_GK: c_uint = 0x03;
pub const PROJECT_ID_GICN: c_uint = 0x04;
pub const PROJECT_ID_GJCN: c_uint = 0x05;
pub const PROJECT_ID_GK5CN_X: c_uint = 0x06;
pub const PROJECT_ID_GK7CN_S: c_uint = 0x07;
pub const PROJECT_ID_GK7CPCS_GK5CQ7Z: c_uint = 0x08;
pub const PROJECT_ID_PF: c_uint = 0x09;
pub const PROJECT_ID_GK5CP_4X_5X_6X: c_uint = 0x0A;
pub const PROJECT_ID_IDP: c_uint = 0x0B;
pub const PROJECT_ID_IDY_6Y: c_uint = 0x0C;
pub const PROJECT_ID_IDY_7Y: c_uint = 0x0D;
pub const PROJECT_ID_PF4MU_PF4MN_PF5MU: c_uint = 0x0E;
pub const PROJECT_ID_CML_GAMING: c_uint = 0x0F;
pub const PROJECT_ID_GK7NXXR: c_uint = 0x10;
pub const PROJECT_ID_GM5MU1Y: c_uint = 0x11;
pub const PROJECT_ID_PH4TRX1: c_uint = 0x12;
pub const PROJECT_ID_PH4TUX1: c_uint = 0x13;
pub const PROJECT_ID_PH4TQX1: c_uint = 0x14;
pub const PROJECT_ID_PH6TRX1: c_uint = 0x15;
pub const PROJECT_ID_PH6TQXX: c_uint = 0x16;
pub const PROJECT_ID_PHXAXXX: c_uint = 0x17;
pub const PROJECT_ID_PHXPXXX: c_uint = 0x18;
pub const EC_ADDR_AP_OEM: c_uint = 0x0741;

pub const EC_ADDR_SUPPORT_5: c_uint = 0x0742;

pub const EC_ADDR_CTGP_DB_CTRL: c_uint = 0x0743;

pub const EC_ADDR_CTGP_DB_CTGP_OFFSET: c_uint = 0x0744;
pub const EC_ADDR_CTGP_DB_TPP_OFFSET: c_uint = 0x0745;
pub const EC_ADDR_CTGP_DB_DB_OFFSET: c_uint = 0x0746;
pub const EC_ADDR_LIGHTBAR_AC_CTRL: c_uint = 0x0748;

pub const EC_ADDR_LIGHTBAR_AC_RED: c_uint = 0x0749;
pub const EC_ADDR_LIGHTBAR_AC_GREEN: c_uint = 0x074A;
pub const EC_ADDR_LIGHTBAR_AC_BLUE: c_uint = 0x074B;
pub const EC_ADDR_BIOS_OEM: c_uint = 0x074E;

pub const EC_ADDR_MANUAL_FAN_CTRL: c_uint = 0x0751;

pub const EC_ADDR_PWM_1: c_uint = 0x075B;
pub const EC_ADDR_PWM_2: c_uint = 0x075C;
// Unreliable
pub const EC_ADDR_SUPPORT_1: c_uint = 0x0765;

pub const EC_ADDR_SUPPORT_2: c_uint = 0x0766;

pub const EC_ADDR_TRIGGER: c_uint = 0x0767;

pub const EC_ADDR_SWITCH_STATUS: c_uint = 0x0768;

pub const EC_ADDR_RGB_RED: c_uint = 0x0769;
pub const EC_ADDR_RGB_GREEN: c_uint = 0x076A;
pub const EC_ADDR_RGB_BLUE: c_uint = 0x076B;
pub const EC_ADDR_ROMID_START: c_uint = 0x0770;
pub const ROMID_LENGTH: c_int = 14;
pub const EC_ADDR_ROMID_EXTRA_1: c_uint = 0x077E;
pub const EC_ADDR_ROMID_EXTRA_2: c_uint = 0x077F;
pub const EC_ADDR_BIOS_OEM_2: c_uint = 0x0782;

pub const EC_ADDR_PL1_SETTING: c_uint = 0x0783;
pub const EC_ADDR_PL2_SETTING: c_uint = 0x0784;
pub const EC_ADDR_PL4_SETTING: c_uint = 0x0785;
pub const EC_ADDR_FAN_DEFAULT: c_uint = 0x0786;
pub const FAN_CURVE_LENGTH: c_int = 5;
pub const EC_ADDR_KBD_STATUS: c_uint = 0x078C;
// Unreliable on some models, use the device descriptor instead.

pub const EC_ADDR_FAN_CTRL: c_uint = 0x078E;

pub const EC_ADDR_BIOS_OEM_3: c_uint = 0x07A3;

pub const EC_ADDR_BIOS_BYTE: c_uint = 0x07A4;

pub const EC_ADDR_OEM_3: c_uint = 0x07A5;

pub const POWER_LED_LEFT: c_uint = 0x00;
pub const POWER_LED_BOTH: c_uint = 0x01;
pub const POWER_LED_NONE: c_uint = 0x02;

pub const EC_ADDR_OEM_4: c_uint = 0x07A6;

pub const CHARGING_PROFILE_HIGH_CAPACITY: c_uint = 0x00;
pub const CHARGING_PROFILE_BALANCED: c_uint = 0x01;
pub const CHARGING_PROFILE_STATIONARY: c_uint = 0x02;

pub const EC_ADDR_CHARGE_CTRL: c_uint = 0x07B9;

pub const EC_ADDR_UNIVERSAL_FAN_CTRL: c_uint = 0x07C5;

pub const EC_ADDR_AP_OEM_6: c_uint = 0x07C6;

pub const EC_ADDR_USB_C_POWER_PRIORITY: c_uint = 0x07CC;

// Same bits as EC_ADDR_LIGHTBAR_AC_CTRL except LIGHTBAR_S3_OFF
pub const EC_ADDR_LIGHTBAR_BAT_CTRL: c_uint = 0x07E2;
pub const EC_ADDR_LIGHTBAR_BAT_RED: c_uint = 0x07E3;
pub const EC_ADDR_LIGHTBAR_BAT_GREEN: c_uint = 0x07E4;
pub const EC_ADDR_LIGHTBAR_BAT_BLUE: c_uint = 0x07E5;
pub const EC_ADDR_CPU_TEMP_END_TABLE: c_uint = 0x0F00;
pub const EC_ADDR_CPU_TEMP_START_TABLE: c_uint = 0x0F10;
pub const EC_ADDR_CPU_FAN_SPEED_TABLE: c_uint = 0x0F20;
pub const EC_ADDR_GPU_TEMP_END_TABLE: c_uint = 0x0F30;
pub const EC_ADDR_GPU_TEMP_START_TABLE: c_uint = 0x0F40;
pub const EC_ADDR_GPU_FAN_SPEED_TABLE: c_uint = 0x0F50;
//
...
// the WMI interface.
//
pub const EC_ADDR_PWM_1_WRITEABLE: c_uint = 0x1804;
pub const EC_ADDR_PWM_2_WRITEABLE: c_uint = 0x1809;
...
//
pub const UNIWILL_EC_DELAY_US: c_int = 6000;
pub const PWM_MAX: c_int = 200;
pub const FAN_TABLE_LENGTH: c_int = 16;
pub const LED_CHANNELS: c_int = 3;
pub const KBD_LED_CHANNELS: c_int = 3;
pub const KBD_LED_MAX_INTENSITY: c_int = 50;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniwill_data {
    pub dev: *mut device,
    pub handle: acpi_handle,
    pub regmap: *mut regmap,
    pub features: c_uint,
    pub project_id: u8,
    pub hook: acpi_battery_hook,
    pub /: *mut *mut mutex battery_lock; / Protects the list of currently registered batteries,
    union {
    struct {
// Protects writes to last_charge_type
    pub charge_type_lock: mutex,
    pub last_charge_type: enum power_supply_charge_type,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniwill_battery_entry {
    pub head: list_head,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct uniwill_device_descriptor {
    pub features: c_uint,
    pub kbd_led_single_color: bool,
    pub kbd_led_max_brightness: u8,
    pub lightbar_max_brightness: u8,
// Executed during driver probing
    pub data): *mut *mut int (probe)(struct uniwill_data,
}
...
#[no_mangle]
unsafe extern "C" fn uniwill_ec_reg_write(context: *mut c_void, reg: c_uint, val: c_uint) -> c_int {
    ...
    acpi_status status;
    status = acpi_evaluate_object(data.handle, "ECRW", &input, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn uniwill_ec_reg_read(context: *mut c_void, reg: c_uint, val: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_writeable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn uniwill_readable_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn uniwill_volatile_reg(dev: *mut device, reg: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn uniwill_write_fn_lock(data: *mut uniwill_data, status: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_read_fn_lock(data: *mut uniwill_data, status: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_write_super_key_enable(data: *mut uniwill_data, status: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_read_super_key_enable(data: *mut uniwill_data, status: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn super_key_enable_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn uniwill_write_touchpad_toggle_enable(data: *mut uniwill_data, status: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_read_touchpad_toggle_enable(data: *mut uniwill_data, status: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn rainbow_animation_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn uniwill_nvidia_ctgp_init(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_c_power_priority_restore(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn usb_c_power_priority_init(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ac_auto_boot_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn uniwill_write_usb_powershare_high(data: *mut uniwill_data, status: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_read_usb_powershare_high(data: *mut uniwill_data, status: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_attr_is_visible(kobj: *mut kobject, attr: *mut attribute, n: c_int) -> umode_t {
...
#[no_mangle]
unsafe extern "C" fn uniwill_hwmon_init(data: *mut uniwill_data) -> c_int {
    ...
    &uniwill_chip_info, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn uniwill_led_brightness_set(led_cdev: *mut led_classdev, brightness: enum led_brightness) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_led_init(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_notify_kbd_led(data: *mut uniwill_data, brightness: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_kbd_led_write_brightness(data: *mut uniwill_data, brightness: c_int) -> c_int {
...
// KBD_POWER_OFF is always implicitly cleared
    let mut regval: c_uint = FIELD_PREP(KBD_BRIGHTNESS_MASK, brightness) | KBD_APPLY;
...
#[no_mangle]
unsafe extern "C" fn uniwill_kbd_led_read_brightness(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_kbd_led_brightness_get(led_cdev: *mut led_classdev) -> enum led_brightness {
    ...
    let mut min_intensity: c_uint = 0;
    unsigned int regval;
    int ret;
...
#[no_mangle]
unsafe extern "C" fn uniwill_kbd_led_mc_brightness_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn uniwill_white_kbd_led_init(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_rgb_kbd_led_init(data: *mut uniwill_data) -> c_int {
    ...
    let mut intensity_all_zeros: bool = true;
    let mut needs_trigger: bool = false;
    unsigned int regval;
    int ret;
    for (int i = 0; i < KBD_LED_CHANNELS; i++) {
...
#[no_mangle]
unsafe extern "C" fn uniwill_kbd_led_init(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_sanitize_battery_threshold(value: c_uint) -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn uniwill_read_charge_type(data: *mut uniwill_data, type: *mut enum power_supply_charge_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_write_charge_type(data: *mut uniwill_data, type: enum power_supply_charge_type) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_restore_charge_type(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_add_battery(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_remove_battery(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_battery_init(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_notifier_call(nb: *mut notifier_block, action: c_ulong, dummy: *mut c_void) -> c_int {
    ...
    if (!uniwill_device_supports(data, UNIWILL_FEATURE_FN_LOCK))
    return NOTIFY_DONE;
    sysfs_notify(&data.dev.kobj, core::ptr::null_mut(), "fn_lock");
    return NOTIFY_OK;
...
#[no_mangle]
unsafe extern "C" fn uniwill_input_init(data: *mut uniwill_data) -> c_int {
    ...
    return -ENOMEM;
    ret = sparse_keymap_setup(data.input_device, uniwill_keymap, core::ptr::null_mut());
    if (ret < 0)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn uniwill_disable_manual_control(context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn uniwill_ec_init(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_shutdown(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn uniwill_suspend_fn_lock(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_suspend_super_key(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_suspend_touchpad_toggle(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_suspend_battery(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_suspend_kbd_led(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_suspend_usb_powershare(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_suspend_nvidia_ctgp(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume_fn_lock(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume_super_key(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume_touchpad_toggle(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume_battery(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume_kbd_led(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume_usb_powershare(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume_nvidia_ctgp(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume_usb_c_power_priority(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phxtxx1_probe(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn phxarx1_phxaqf1_probe(data: *mut uniwill_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uniwill_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn uniwill_exit() -> void __exit {
