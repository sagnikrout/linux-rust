...
//! Source: drivers/platform/x86/apple-gmux.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_gmux_data {
    pub iomem_base: *mut u8 __iomem,
    pub iostart: c_ulong,
    pub iolen: c_ulong,
    pub config: *const apple_gmux_config,
    pub index_lock: mutex,
    pub bdev: *mut backlight_device,
// switcheroo data
    pub dhandle: acpi_handle,
    pub gpe: c_int,
    pub external_switchable: bool,
    pub switch_state_display: enum vga_switcheroo_client_id,
    pub switch_state_ddc: enum vga_switcheroo_client_id,
    pub switch_state_external: enum vga_switcheroo_client_id,
    pub power_state: enum vga_switcheroo_state,
    pub powerchange_done: completion,
// debugfs data
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct apple_gmux_config {
    pub port): *mut *mut *mut u8 (read8)(struct apple_gmux_data gmux_data, int,
    pub val): *mut *mut *mut void (write8)(struct apple_gmux_data gmux_data, int port, u8,
    pub port): *mut *mut *mut u32 (read32)(struct apple_gmux_data gmux_data, int,
    pub val): *mut *mut *mut void (write32)(struct apple_gmux_data gmux_data, int port, u32,
    pub gmux_handler: *const vga_switcheroo_handler,
    pub handler_flags: enum vga_switcheroo_handler_flags_t,
    pub resource_type: c_ulong,
    pub read_version_as_u32: bool,
    pub name: *mut c_char,
}

pub const GMUX_INTERRUPT_ENABLE: c_uint = 0xff;
pub const GMUX_INTERRUPT_DISABLE: c_uint = 0x00;
pub const GMUX_INTERRUPT_STATUS_ACTIVE: c_int = 0;

pub const GMUX_BRIGHTNESS_MASK: c_uint = 0x00ffffff;

#[no_mangle]
unsafe extern "C" fn gmux_pio_read8(gmux_data: *mut apple_gmux_data, port: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn gmux_pio_read32(gmux_data: *mut apple_gmux_data, port: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gmux_index_wait_ready(gmux_data: *mut apple_gmux_data) -> c_int {
    static int gmux_index_wait_ready(struct apple_gmux_data *gmux_data)
    {
    let mut i: c_int = 200;
    let mut gwr: u8 = inb(gmux_data.iostart + GMUX_PORT_WRITE);
    while (i && (gwr & 0x01)) {
...
#[no_mangle]
unsafe extern "C" fn gmux_index_wait_complete(gmux_data: *mut apple_gmux_data) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gmux_index_read8(gmux_data: *mut apple_gmux_data, port: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn gmux_index_read32(gmux_data: *mut apple_gmux_data, port: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gmux_mmio_wait(gmux_data: *mut apple_gmux_data) -> c_int {
    static int gmux_mmio_wait(struct apple_gmux_data *gmux_data)
    {
    let mut i: c_int = 200;
    let mut gwr: u8 = ioread8(gmux_data.iomem_base + GMUX_MMIO_COMMAND_SEND);
    while (i && gwr) {
...
#[no_mangle]
unsafe extern "C" fn gmux_mmio_read8(gmux_data: *mut apple_gmux_data, port: c_int) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn gmux_mmio_read32(gmux_data: *mut apple_gmux_data, port: c_int) -> u32 {
...
#[no_mangle]
unsafe extern "C" fn gmux_read8(gmux_data: *mut apple_gmux_data, port: c_int) -> u8 {
    static u8 gmux_read8(struct apple_gmux_data *gmux_data, int port)
    {
    return gmux_data.config.read8(gmux_data, port);
    }
#[no_mangle]
unsafe extern "C" fn gmux_write8(gmux_data: *mut apple_gmux_data, port: c_int, val: u8) {
    static void gmux_write8(struct apple_gmux_data *gmux_data, int port, u8 val)
    {
    return gmux_data.config.write8(gmux_data, port, val);
    }
#[no_mangle]
unsafe extern "C" fn gmux_read32(gmux_data: *mut apple_gmux_data, port: c_int) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn gmux_get_brightness(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gmux_update_status(bd: *mut backlight_device) -> c_int {
    static int gmux_update_status(struct backlight_device *bd)
    {
    struct apple_gmux_data *gmux_data = bl_get_data(bd);
    let mut brightness: u32 = backlight_get_brightness(bd);
...
//
#[no_mangle]
unsafe extern "C" fn gmux_read_switch_state(gmux_data: *mut apple_gmux_data) {
...
#[no_mangle]
unsafe extern "C" fn gmux_write_switch_state(gmux_data: *mut apple_gmux_data) {
...
#[no_mangle]
unsafe extern "C" fn gmux_switchto(id: enum vga_switcheroo_client_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gmux_switch_ddc(id: enum vga_switcheroo_client_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gmux_get_client_id(pdev: *mut pci_dev) -> enum vga_switcheroo_client_id {
...
//
#[no_mangle]
pub unsafe extern "C" fn gmux_disable_interrupts(gmux_data: *mut apple_gmux_data) {
...
#[no_mangle]
pub unsafe extern "C" fn gmux_enable_interrupts(gmux_data: *mut apple_gmux_data) {
...
#[no_mangle]
pub unsafe extern "C" fn gmux_interrupt_get_status(gmux_data: *mut apple_gmux_data) -> u8 {
...
#[no_mangle]
unsafe extern "C" fn gmux_clear_interrupts(gmux_data: *mut apple_gmux_data) {
...
#[no_mangle]
unsafe extern "C" fn gmux_notify_handler(device: acpi_handle, value: u32, context: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn gmux_init_debugfs(gmux_data: *mut apple_gmux_data) {
    static void gmux_init_debugfs(struct apple_gmux_data *gmux_data)
    {
    gmux_data.debug_dentry = debugfs_create_dir(KBUILD_MODNAME, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn gmux_fini_debugfs(gmux_data: *mut apple_gmux_data) {
    static void gmux_fini_debugfs(struct apple_gmux_data *gmux_data)
    {
    debugfs_remove_recursive(gmux_data.debug_dentry);
    }
#[no_mangle]
unsafe extern "C" fn gmux_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn gmux_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn is_thunderbolt(dev: *mut device, data: *mut c_void) -> c_int {
    static int is_thunderbolt(struct device *dev, void *data)
    {
    return to_pci_dev(dev).is_thunderbolt;
    }
#[no_mangle]
unsafe extern "C" fn gmux_probe(pnp: *mut pnp_dev, id: *const pnp_device_id) -> c_int {
    static int gmux_probe(struct pnp_dev *pnp, const struct pnp_device_id *id)
    {
    struct apple_gmux_data *gmux_data;
    struct resource *res;
    struct backlight_properties props;
    struct backlight_device *bdev = core::ptr::null_mut();
    u8 ver_major, ver_minor, ver_release;
    let mut register_bdev: bool = true;
...
//
    ...
    status = acpi_evaluate_integer(gmux_data.dhandle, "GMGP", core::ptr::null_mut(), &gpe);
    ...
    status = acpi_enable_gpe(core::ptr::null_mut(), gmux_data.gpe);
    if (ACPI_FAILURE(status)) {
...
//
    ...
    !bus_for_each_dev(&pci_bus_type, core::ptr::null_mut(), core::ptr::null_mut(), is_thunderbolt);
...
//
    ...
    gmux_disable_interrupts(gmux_data);
    apple_gmux_data = core::ptr::null_mut();
    if (gmux_data.gpe >= 0)
    acpi_disable_gpe(core::ptr::null_mut(), gmux_data.gpe);
    err_enable_gpe:
    if (gmux_data.gpe >= 0)
...
#[no_mangle]
unsafe extern "C" fn gmux_remove(pnp: *mut pnp_dev) {
