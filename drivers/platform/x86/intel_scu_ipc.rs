...
//! Source: drivers/platform/x86/intel_scu_ipc.c
#![no_std]
...
pub const IPCMSG_PCNTRL: c_uint = 0xff /* Power controller unit read/write */;
...
pub const IPC_IOC: c_uint = 0x100		/* IPC command register IOC bit */;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_scu_ipc_dev {
    pub dev: device,
    pub owner: *mut module,
    pub ipc_base: *mut void __iomem,
    pub cmd_complete: completion,
    pub data: intel_scu_ipc_data,
}

pub const IPC_STATUS: c_uint = 0x04;

//
// IPC Write/Read Buffers:
// 16 byte buffer for sending and receiving data to and from SCU.
//
pub const IPC_WRITE_BUFFER: c_uint = 0x80;
pub const IPC_READ_BUFFER: c_uint = 0x90;
// Timeout in jiffies
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_scu_ipc_dev_put(scu: *mut intel_scu_ipc_dev) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct intel_scu_ipc_devres {
    pub scu: *mut intel_scu_ipc_dev,
}

#[no_mangle]
unsafe extern "C" fn devm_intel_scu_ipc_dev_release(dev: *mut device, res: *mut c_void) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipc_command(scu: *mut intel_scu_ipc_dev, cmd: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipc_data_writel(scu: *mut intel_scu_ipc_dev, data: u32, offset: u32) {
...
//
#[no_mangle]
pub unsafe extern "C" fn ipc_read_status(scu: *mut intel_scu_ipc_dev) -> u8 {
...
// Read ipc u32 data
#[no_mangle]
pub unsafe extern "C" fn ipc_data_readl(scu: *mut intel_scu_ipc_dev, offset: u32) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn busy_loop(scu: *mut intel_scu_ipc_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ipc_wait_for_interrupt(scu: *mut intel_scu_ipc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn intel_scu_ipc_check_status(scu: *mut intel_scu_ipc_dev) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_scu_ipc_dev_ioread8(scu: *mut intel_scu_ipc_dev, addr: u16, data: *mut u8) -> c_int {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_scu_ipc_dev_iowrite8(scu: *mut intel_scu_ipc_dev, addr: u16, data: u8) -> c_int {
...
//
    ...
    {
    let mut outbuflen: usize = DIV_ROUND_UP(outlen, sizeof(u32));
    let mut inbuflen: usize = DIV_ROUND_UP(inlen, sizeof(u32));
...
//
#[no_mangle]
unsafe extern "C" fn ioc(irq: c_int, dev_id: *mut c_void) -> irqreturn_t {
    static irqreturn_t ioc(int irq, void *dev_id)
    {
    struct intel_scu_ipc_dev *scu = dev_id;
    let mut status: c_int = ipc_read_status(scu);
    writel(status | IPC_STATUS_IRQ, scu.ipc_base + IPC_STATUS);
    complete(&scu.cmd_complete);
    return IRQ_HANDLED;
    }
#[no_mangle]
unsafe extern "C" fn intel_scu_ipc_release(dev: *mut device) {
...
//
#[no_mangle]
pub unsafe extern "C" fn intel_scu_ipc_unregister(scu: *mut intel_scu_ipc_dev) {
    void intel_scu_ipc_unregister(struct intel_scu_ipc_dev *scu)
    {
    guard(mutex)(&ipclock);
    if (!WARN_ON(!ipcdev)) {
    ipcdev = core::ptr::null_mut();
    device_unregister(&scu.dev);
    }
    }
    EXPORT_SYMBOL_GPL(intel_scu_ipc_unregister);
#[no_mangle]
unsafe extern "C" fn devm_intel_scu_ipc_unregister(dev: *mut device, res: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn intel_scu_ipc_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn intel_scu_ipc_exit() -> void __exit {
