...
//! Source: drivers/platform/x86/eeepc-laptop.c
#![no_std]
...
//
pub const NOTIFY_BRN_MIN: c_uint = 0x20;
pub const NOTIFY_BRN_MAX: c_uint = 0x2f;
    enum {
    ...
    "WLDG", "BTHG", core::ptr::null_mut(), core::ptr::null_mut(),
    "CAMG", core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    core::ptr::null_mut(), "PBLG", core::ptr::null_mut(), core::ptr::null_mut(),
    "CFVG", core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    "USBG", core::ptr::null_mut(), core::ptr::null_mut(), "MODG",
    "CRDG", "M3GG", "WIMG", "HWCF",
    "LIDG",	"TYPE", "PBPG",	"TPDG"
    };
    static const char *cm_setv[] = {
    "WLDS", "BTHS", core::ptr::null_mut(), core::ptr::null_mut(),
    "CAMS", core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    "SDSP", "PBLS", "HDPS", core::ptr::null_mut(),
    "CFVS", core::ptr::null_mut(), core::ptr::null_mut(), core::ptr::null_mut(),
    "USBG", core::ptr::null_mut(), core::ptr::null_mut(), "MODS",
    "CRDS", "M3GS", "WIMS", core::ptr::null_mut(),
    core::ptr::null_mut(), core::ptr::null_mut(), "PBPS", "TPDS"
    };
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eeepc_laptop {
    pub /: *mut *mut acpi_handle handle; / the handle of the acpi device,
    pub supported: *mut *mut u32 cm_supported; / the control methods,
    by this BIOS */
    pub cpufv_disabled: bool,
    pub hotplug_disabled: bool,
    pub /: *mut *mut u16 event_count[128]; / count for each event,
    ...
    pub wlan_rfkill: *mut rfkill,
    pub bluetooth_rfkill: *mut rfkill,
    pub wwan3g_rfkill: *mut rfkill,
    pub wimax_rfkill: *mut rfkill,
    pub hotplug_slot: hotplug_slot,
    pub hotplug_lock: mutex,
    pub tpd_led: led_classdev,
    pub tpd_led_wk: c_int,
    pub led_workqueue: *mut workqueue_struct,
    pub tpd_led_work: work_struct,
}
...
#[no_mangle]
unsafe extern "C" fn read_acpi_int(handle: acpi_handle, method: *const c_char, val: *mut c_int) -> c_int {
    static int read_acpi_int(acpi_handle handle, const char *method, int *val)
    {
    acpi_status status;
    unsigned long long result;
    status = acpi_evaluate_integer(handle, (char *)method, core::ptr::null_mut(), &result);
...
#[no_mangle]
unsafe extern "C" fn set_acpi(eeepc: *mut eeepc_laptop, cm: c_int, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn get_acpi(eeepc: *mut eeepc_laptop, cm: c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn parse_arg(buf: *const c_char, val: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn show_sys_acpi(dev: *mut device, cm: c_int, buf: *mut c_char) -> isize {
    static ssize_t show_sys_acpi(struct device *dev, int cm, char *buf)
    {
    struct eeepc_laptop *eeepc = dev_get_drvdata(dev);
    let mut value: c_int = get_acpi(eeepc, cm);
    if (value < 0)
    return -EIO;
...
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_RW(_arg: _name) -> static {
    static DEVICE_ATTR_RW(_name)

    EEEPC_ACPI_STORE_FUNC(_name, _cm)				\
#[no_mangle]
pub unsafe extern "C" fn DEVICE_ATTR_WO(_arg: _name) -> static {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct eeepc_cpufv {
    pub num: c_int,
    pub cur: c_int,
}

#[no_mangle]
unsafe extern "C" fn get_cpufv(eeepc: *mut eeepc_laptop, c: *mut eeepc_cpufv) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_platform_init(eeepc: *mut eeepc_laptop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_platform_exit(eeepc: *mut eeepc_laptop) {
...
//
#[no_mangle]
unsafe extern "C" fn tpd_led_update(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn tpd_led_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn eeepc_led_init(eeepc: *mut eeepc_laptop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_led_exit(eeepc: *mut eeepc_laptop) {
...
//
#[no_mangle]
unsafe extern "C" fn eeepc_wlan_rfkill_blocked(eeepc: *mut eeepc_laptop) -> bool {
...
#[no_mangle]
unsafe extern "C" fn eeepc_rfkill_hotplug(eeepc: *mut eeepc_laptop, handle: acpi_handle) {
    static void eeepc_rfkill_hotplug(struct eeepc_laptop *eeepc, acpi_handle handle)
    {
    struct pci_dev *port;
    struct pci_dev *dev;
    struct pci_bus *bus;
    let mut blocked: bool = eeepc_wlan_rfkill_blocked(eeepc);
    bool absent;
    u32 l;
...
#[no_mangle]
unsafe extern "C" fn eeepc_rfkill_hotplug_update(eeepc: *mut eeepc_laptop, node: *mut c_char) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_rfkill_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_setup_pci_hotplug(eeepc: *mut eeepc_laptop) -> c_int {
    ...
    return 0;
    error_register:
    eeepc.hotplug_slot.ops = core::ptr::null_mut();
    return ret;
    }
//
// Rfkill devices
//
#[no_mangle]
unsafe extern "C" fn eeepc_rfkill_set(data: *mut c_void, blocked: bool) -> c_int {
    static int eeepc_rfkill_set(void *data, bool blocked)
    {
    let mut handle: acpi_handle = data;
    return write_acpi_int(handle, core::ptr::null_mut(), !blocked);
    }
...
#[no_mangle]
unsafe extern "C" fn eeepc_rfkill_exit(eeepc: *mut eeepc_laptop) {
    ...
    eeepc.wlan_rfkill = core::ptr::null_mut();
    }
    if (eeepc.hotplug_slot.ops)
    ...
    eeepc.bluetooth_rfkill = core::ptr::null_mut();
    }
    if (eeepc.wwan3g_rfkill) {
    rfkill_unregister(eeepc.wwan3g_rfkill);
    rfkill_destroy(eeepc.wwan3g_rfkill);
    eeepc.wwan3g_rfkill = core::ptr::null_mut();
    }
    if (eeepc.wimax_rfkill) {
    rfkill_unregister(eeepc.wimax_rfkill);
    rfkill_destroy(eeepc.wimax_rfkill);
    eeepc.wimax_rfkill = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn eeepc_rfkill_init(eeepc: *mut eeepc_laptop) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn eeepc_hotk_thaw(device: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_hotk_restore(device: *mut device) -> c_int {
...
// Hwmon device
//
pub const EEEPC_EC_SC00: c_uint = 0x61;

pub const EEEPC_EC_SFB0: c_uint = 0xD0;

#[no_mangle]
pub unsafe extern "C" fn eeepc_pwm_to_lmsensors(value: c_int) -> c_int {
    static inline int eeepc_pwm_to_lmsensors(int value)
    {
    return value * 255 / 100;
    }
#[no_mangle]
pub unsafe extern "C" fn eeepc_lmsensors_to_pwm(value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_get_fan_pwm() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_set_fan_pwm(value: c_int) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_get_fan_rpm() -> c_int {
...
pub const EEEPC_EC_FAN_CTRL_BIT: c_uint = 0x02;
pub const EEEPC_FAN_CTRL_MANUAL: c_int = 1;
pub const EEEPC_FAN_CTRL_AUTO: c_int = 2;
#[no_mangle]
unsafe extern "C" fn eeepc_get_fan_ctrl() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_set_fan_ctrl(manual: c_int) {
...
#[no_mangle]
unsafe extern "C" fn store_sys_hwmon((*set)(int): *mut c_void, buf: *const c_char, count: usize) -> isize {
...
#[no_mangle]
unsafe extern "C" fn show_sys_hwmon((*get)(void): *mut c_int, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn eeepc_hwmon_init(eeepc: *mut eeepc_laptop) -> c_int {
    static int eeepc_hwmon_init(struct eeepc_laptop *eeepc)
    {
    struct device *dev = &eeepc.platform_device.dev;
    struct device *hwmon;
    hwmon = devm_hwmon_device_register_with_groups(dev, "eeepc", core::ptr::null_mut(),
    hwmon_groups);
    if (IS_ERR(hwmon)) {
...
#[no_mangle]
unsafe extern "C" fn set_brightness(bd: *mut backlight_device, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_backlight_notify(eeepc: *mut eeepc_laptop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_backlight_init(eeepc: *mut eeepc_laptop) -> c_int {
    ...
    eeepc.backlight_device = core::ptr::null_mut();
    return PTR_ERR(bd);
    }
...
#[no_mangle]
unsafe extern "C" fn eeepc_backlight_exit(eeepc: *mut eeepc_laptop) {
...
//
#[no_mangle]
unsafe extern "C" fn eeepc_input_init(eeepc: *mut eeepc_laptop) -> c_int {
    ...
    error = sparse_keymap_setup(input, eeepc_keymap, core::ptr::null_mut());
    if (error) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_input_exit(eeepc: *mut eeepc_laptop) {
    static void eeepc_input_exit(struct eeepc_laptop *eeepc)
    {
    if (eeepc.inputdev)
    input_unregister_device(eeepc.inputdev);
    eeepc.inputdev = core::ptr::null_mut();
    }
//
// ACPI driver
//
#[no_mangle]
unsafe extern "C" fn eeepc_input_notify(eeepc: *mut eeepc_laptop, event: c_int) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_acpi_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_dmi_check(eeepc: *mut eeepc_laptop) {
...
#[no_mangle]
unsafe extern "C" fn cmsg_quirk(eeepc: *mut eeepc_laptop, cm: c_int, name: *const c_char) {
...
#[no_mangle]
unsafe extern "C" fn cmsg_quirks(eeepc: *mut eeepc_laptop) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_acpi_init(eeepc: *mut eeepc_laptop) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_enable_camera(eeepc: *mut eeepc_laptop) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_acpi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn eeepc_acpi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn eeepc_laptop_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn eeepc_laptop_exit() -> void __exit {
