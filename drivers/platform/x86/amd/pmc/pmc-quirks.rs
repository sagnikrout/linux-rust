...
//! Source: drivers/platform/x86/amd/pmc/pmc-quirks.c
#![no_std]
...
pub struct quirk_entry {
    pub s2idle_bug_mmio: u32,
    pub spurious_8042: bool,
    pub need_suspend_delay: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn amd_pmc_skip_nvme_smi_handler(s2idle_bug_mmio: u32) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmc_process_restore_quirks(dev: *mut amd_pmc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmc_quirk_need_suspend_delay(dev: *mut amd_pmc_dev) -> bool {
    bool amd_pmc_quirk_need_suspend_delay(struct amd_pmc_dev *dev)
    {
    return dev.quirks && dev.quirks.need_suspend_delay;
    }
#[no_mangle]
pub unsafe extern "C" fn amd_pmc_quirks_init(dev: *mut amd_pmc_dev) {
