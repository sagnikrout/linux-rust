...
//! Source: drivers/platform/x86/amd/amd_isp4.c
#![no_std]
...
pub const AMDISP_OV05C10_I2C_ADDR: c_uint = 0x10;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amdisp_platform_info {
    pub board_info: i2c_board_info,
    pub swnodes: *const software_node,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amdisp_platform {
    pub pinfo: *const amdisp_platform_info,
    pub board_info: i2c_board_info,
    pub i2c_nb: notifier_block,
    pub i2c_dev: *mut i2c_client,
    pub /: *mut *mut mutex lock; / protects i2c client creation,
}
...
#[no_mangle]
pub unsafe extern "C" fn is_isp_i2c_adapter(adap: *mut i2c_adapter) -> bool {
    ...
    isp4_platform.i2c_dev = core::ptr::null_mut();
    }
    }
    break;
    default:
...
#[no_mangle]
unsafe extern "C" fn try_to_instantiate_i2c_client(dev: *mut device, data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_isp_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_isp_remove(pdev: *mut platform_device) {
