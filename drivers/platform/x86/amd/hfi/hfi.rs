...
//! Source: drivers/platform/x86/amd/hfi/hfi.c
#![no_std]
...
pub const AMD_HFI_MAILBOX_COUNT: c_int = 1;
pub const AMD_HETERO_RANKING_TABLE_MIN_VER: c_int = 2;
pub const AMD_HETERO_RANKING_TABLE_MAX_VER: c_int = 3;
pub const AMD_HETERO_CPUID_27: c_uint = 0x80000027;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_shmem_info {
    pub header: acpi_pcct_ext_pcc_shared_memory,
    u32	version_number		:8,
    n_logical_processors	:8,
    n_capabilities		:8,
    pub :8: table_update_context,
    u32	n_bitmaps		:8,
    pub :24: reserved,
    pub table_data: [u32; ],
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_hfi_data {
    pub name: *const c_char,
    pub dev: *mut device,
// PCCT table related
    pub pcc_chan: *mut pcc_mbox_chan,
    pub pcc_comm_addr: *mut void __iomem,
    pub pcct_entry: *mut acpi_subtable_header,
    pub shmem: *mut amd_shmem_info,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_hfi_cpuinfo {
    pub cpu: c_int,
    pub apic_id: u32,
    pub class_index: i16,
    pub nr_class: u8,
    pub ipcc_scores: *mut c_int,
    pub amd_hfi_classes: *mut amd_hfi_classes,
}

    static DEFINE_PER_CPU(struct amd_hfi_cpuinfo, amd_hfi_cpuinfo) = {.class_index = -1};
    static DEFINE_MUTEX(hfi_cpuinfo_lock);
#[no_mangle]
unsafe extern "C" fn amd_hfi_sched_itmt_work(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn find_cpu_index_by_apicid(target_apicid: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_fill_metadata(amd_hfi_data: *mut amd_hfi_data) -> c_int {
    ...
    let mut bitmap: u32 = amd_hfi_data.shmem.table_data[i];
    for (unsigned int j = 0; j < BITS_PER_TYPE(u32); j++) {
    let mut apic_id: u32 = i * BITS_PER_TYPE(u32) + j;
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_alloc_class_data(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn amd_set_hfi_ipcc_score(hfi_cpuinfo: *mut amd_hfi_cpuinfo, cpu: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_set_state(cpu: c_uint, state: bool) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd_hfi_online(cpu: c_uint) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd_hfi_offline(cpu: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn update_hfi_ipcc_scores() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn class_capabilities_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_pm_resume(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_pm_suspend(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_init() -> int __init {
    ...
    return -ENODEV;
    device = platform_device_register_simple(AMD_HFI_DRIVER, -1, core::ptr::null_mut(), 0);
    if (IS_ERR(device)) {
...
#[no_mangle]
unsafe extern "C" fn amd_hfi_exit() -> __exit void {
