...
//! Source: drivers/platform/x86/amd/pmf/acpi.c
#![no_std]
...
pub const APMF_CQL_NOTIFICATION: c_int = 2;
pub const APMF_AMT_NOTIFICATION: c_int = 3;
    ...
    let mut ahandle: acpi_handle = ACPI_HANDLE(pdev.dev);
...
#[no_mangle]
unsafe extern "C" fn apmf_if_call_store_buffer(pdev: *mut amd_pmf_dev, fn: c_int, dest: *mut c_void, out_sz: usize) -> c_int {
    static int apmf_if_call_store_buffer(struct amd_pmf_dev *pdev, int fn, void *dest, size_t out_sz)
    {
    union acpi_object *info;
    size_t size;
    let mut err: c_int = 0;
    info = apmf_if_call(pdev, fn, core::ptr::null_mut());
    if (!info)
    return -EIO;
...
#[no_mangle]
pub unsafe extern "C" fn is_apmf_func_supported(pdev: *mut amd_pmf_dev, index: c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn is_apmf_bios_input_notifications_supported(pdev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apmf_os_power_slider_update(pdev: *mut amd_pmf_dev, event: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apmf_sbios_heartbeat_notify(work: *mut work_struct) {
    static void apmf_sbios_heartbeat_notify(struct work_struct *work)
    {
    struct amd_pmf_dev *dev = container_of(work, struct amd_pmf_dev, heart_beat.work);
    union acpi_object *info;
    dev_dbg(dev.dev, "Sending heartbeat to SBIOS\n");
    info = apmf_if_call(dev, APMF_FUNC_SBIOS_HEARTBEAT, core::ptr::null_mut());
    if (!info)
    return;
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_notify_sbios_heartbeat_event_v2(dev: *mut amd_pmf_dev, flag: u8) -> c_int {
    int amd_pmf_notify_sbios_heartbeat_event_v2(struct amd_pmf_dev *dev, u8 flag)
    {
    let mut args: sbios_hb_event_v2 = { };
    struct acpi_buffer params;
    union acpi_object *info;
    args.size = sizeof(args);
    switch (flag) {
...
#[no_mangle]
pub unsafe extern "C" fn apmf_update_fan_idx(pdev: *mut amd_pmf_dev, manual: bool, idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apmf_notify_smart_pc_update(pdev: *mut amd_pmf_dev, val: u32, preq: u32, index: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apmf_get_auto_mode_def(pdev: *mut amd_pmf_dev, data: *mut apmf_auto_mode) -> c_int {
    int apmf_get_auto_mode_def(struct amd_pmf_dev *pdev, struct apmf_auto_mode *data)
    {
    return apmf_if_call_store_buffer(pdev, APMF_FUNC_AUTO_MODE, data, sizeof(*data));
    }
#[no_mangle]
pub unsafe extern "C" fn apmf_get_sbios_requests_v2(pdev: *mut amd_pmf_dev, req: *mut apmf_sbios_req_v2) -> c_int {
    int apmf_get_sbios_requests_v2(struct amd_pmf_dev *pdev, struct apmf_sbios_req_v2 *req)
    {
    return apmf_if_call_store_buffer(pdev, APMF_FUNC_SBIOS_REQUESTS, req, sizeof(*req));
    }
#[no_mangle]
pub unsafe extern "C" fn apmf_get_sbios_requests_v1(pdev: *mut amd_pmf_dev, req: *mut apmf_sbios_req_v1) -> c_int {
    int apmf_get_sbios_requests_v1(struct amd_pmf_dev *pdev, struct apmf_sbios_req_v1 *req)
    {
    return apmf_if_call_store_buffer(pdev, APMF_FUNC_SBIOS_REQUESTS, req, sizeof(*req));
    }
#[no_mangle]
pub unsafe extern "C" fn apmf_get_sbios_requests(pdev: *mut amd_pmf_dev, req: *mut apmf_sbios_req) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_custom_bios_inputs_rb(pmf_dev: *mut amd_pmf_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_handle_early_preq(pdev: *mut amd_pmf_dev) {
...
#[no_mangle]
unsafe extern "C" fn apmf_event_handler_v2(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn apmf_event_handler_v1(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn apmf_event_handler(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn apmf_if_verify_interface(pdev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn apmf_get_system_params(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apmf_get_dyn_slider_def_ac(pdev: *mut amd_pmf_dev, data: *mut apmf_dyn_slider_output) -> c_int {
    int apmf_get_dyn_slider_def_ac(struct amd_pmf_dev *pdev, struct apmf_dyn_slider_output *data)
    {
    return apmf_if_call_store_buffer(pdev, APMF_FUNC_DYN_SLIDER_AC, data, sizeof(*data));
    }
#[no_mangle]
pub unsafe extern "C" fn apmf_get_dyn_slider_def_dc(pdev: *mut amd_pmf_dev, data: *mut apmf_dyn_slider_output) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apmf_install_handler(pmf_dev: *mut amd_pmf_dev) -> c_int {
    int apmf_install_handler(struct amd_pmf_dev *pmf_dev)
    {
    let mut ahandle: acpi_handle = ACPI_HANDLE(pmf_dev.dev);
    acpi_status status;
...
#[no_mangle]
pub unsafe extern "C" fn apmf_check_smart_pc(pmf_dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_smartpc_apply_bios_output(dev: *mut amd_pmf_dev, val: u32, preq: u32, idx: u32) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn apmf_acpi_deinit(pmf_dev: *mut amd_pmf_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn apmf_acpi_init(pmf_dev: *mut amd_pmf_dev) -> c_int {
