...
//! Source: drivers/platform/x86/amd/pmf/auto-mode.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_dump_auto_mode_defaults(data: *mut auto_mode_mode_config) {
...
// Fan ID
    ...
    amd_pmf_send_cmd(dev, SET_SPL, SET_CMD, pwr_ctrl.spl, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_FPPT, SET_CMD, pwr_ctrl.fppt, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_SPPT, SET_CMD, pwr_ctrl.sppt, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_SPPT_APU_ONLY, SET_CMD, pwr_ctrl.sppt_apu_only, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_MIN_LIMIT, SET_CMD, pwr_ctrl.stt_min, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_LIMIT_APU, SET_CMD,
    fixp_q88_fromint(pwr_ctrl.stt_skin_temp[STT_TEMP_APU]), core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_LIMIT_HS2, SET_CMD,
    fixp_q88_fromint(pwr_ctrl.stt_skin_temp[STT_TEMP_HS2]), core::ptr::null_mut());
    if (is_apmf_func_supported(dev, APMF_FUNC_SET_FAN_IDX))
    apmf_update_fan_idx(dev, config_store.mode_set[idx].fan_control.manual,
    config_store.mode_set[idx].fan_control.fan_id);
    }
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_moving_avg(pdev: *mut amd_pmf_dev, socket_power: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_trans_automode(dev: *mut amd_pmf_dev, socket_power: c_int, time_elapsed_ms: ktime_t) {
    void amd_pmf_trans_automode(struct amd_pmf_dev *dev, int socket_power, ktime_t time_elapsed_ms)
    {
    let mut avg_power: c_int = 0;
...
// Apply the mode with highest priority indentified
    ...
    state_as_str(config_store.current_mode));
    amd_pmf_set_automode(dev, config_store.current_mode, core::ptr::null_mut());
    }
    break;
    }
    }
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_update_2_cql(dev: *mut amd_pmf_dev, is_cql_event: bool) {
    void amd_pmf_update_2_cql(struct amd_pmf_dev *dev, bool is_cql_event)
    {
    let mut mode: c_int = config_store.current_mode;
    ...
    mode = config_store.transition[AUTO_TRANSITION_TO_PERFORMANCE].target_mode;
    amd_pmf_set_automode(dev, mode, core::ptr::null_mut());
    }
    dev_dbg(dev.dev, "updated CQL thermals\n");
    }
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_power_threshold() {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_load_defaults_auto_mode(dev: *mut amd_pmf_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_reset_amt(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_handle_amt(dev: *mut amd_pmf_dev) {
    void amd_pmf_handle_amt(struct amd_pmf_dev *dev)
    {
    amd_pmf_set_automode(dev, config_store.current_mode, core::ptr::null_mut());
    }
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_deinit_auto_mode(dev: *mut amd_pmf_dev) {
    void amd_pmf_deinit_auto_mode(struct amd_pmf_dev *dev)
    {
    cancel_delayed_work_sync(&dev.work_buffer);
    }
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_init_auto_mode(dev: *mut amd_pmf_dev) {
