...
//! Source: drivers/platform/x86/amd/pmf/tee-if.c
#![no_std]
...
pub const MAX_TEE_PARAM: c_int = 4;
// Policy binary actions sampling frequency (in ms)
    let mut pb_actions_ms: static int = MSEC_PER_SEC;
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_update_uevents(dev: *mut amd_pmf_dev, event: u16) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_bios_output_idx(action_idx: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_update_bios_output(pdev: *mut amd_pmf_dev, action: *mut ta_pmf_action) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_apply_policies(dev: *mut amd_pmf_dev, out: *mut ta_pmf_enact_result) {
    ...
    amd_pmf_send_cmd(dev, SET_SPL, SET_CMD, val, core::ptr::null_mut());
    ...
    amd_pmf_send_cmd(dev, SET_SPPT, SET_CMD, val, core::ptr::null_mut());
    ...
    amd_pmf_send_cmd(dev, SET_FPPT, SET_CMD, val, core::ptr::null_mut());
    ...
    amd_pmf_send_cmd(dev, SET_SPPT_APU_ONLY, SET_CMD, val, core::ptr::null_mut());
    ...
    amd_pmf_send_cmd(dev, SET_STT_MIN_LIMIT, SET_CMD, val, core::ptr::null_mut());
    ...
    fixp_q88_fromint(val), core::ptr::null_mut());
    ...
    amd_pmf_send_cmd(dev, SET_P3T, SET_CMD, val, core::ptr::null_mut());
    ...
    amd_pmf_send_cmd(dev, SET_PMF_PPT, SET_CMD, val, core::ptr::null_mut());
    ...
    amd_pmf_send_cmd(dev, SET_PMF_PPT_APU_ONLY, SET_CMD, val, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_invoke_cmd_enact(dev: *mut amd_pmf_dev) -> c_int {
    int amd_pmf_invoke_cmd_enact(struct amd_pmf_dev *dev)
    {
    struct ta_pmf_shared_memory *ta_sm = core::ptr::null_mut();
    struct ta_pmf_enact_result *out = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_invoke_cmd_init(dev: *mut amd_pmf_dev) -> c_int {
    static int amd_pmf_invoke_cmd_init(struct amd_pmf_dev *dev)
    {
    struct ta_pmf_shared_memory *ta_sm = core::ptr::null_mut();
    struct tee_param param[MAX_TEE_PARAM];
    struct ta_pmf_init_table *in = core::ptr::null_mut();
    struct tee_ioctl_invoke_arg arg;
    let mut ret: c_int = 0;
    if (!dev.tee_ctx) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_invoke_cmd(work: *mut work_struct) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_start_policy_engine(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_pb_valid(dev: *mut amd_pmf_dev) -> bool {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_hex_dump_pb(dev: *mut amd_pmf_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_open_pb(dev: *mut amd_pmf_dev, debugfs_root: *mut dentry) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_remove_pb(dev: *mut amd_pmf_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_amdtee_ta_match(ver: *mut tee_ioctl_version_data, data: *const c_void) -> c_int {
    static int amd_pmf_amdtee_ta_match(struct tee_ioctl_version_data *ver, const void *data)
    {
    return ver.impl_id == TEE_IMPL_ID_AMDTEE;
    }
#[no_mangle]
unsafe extern "C" fn amd_pmf_ta_open_session(ctx: *mut tee_context, id: *mut u32, uuid: *const uuid_t) -> c_int {
    static int amd_pmf_ta_open_session(struct tee_context *ctx, u32 *id, const uuid_t *uuid)
    {
    let mut sess_arg: tee_ioctl_open_session_arg = {};
    int rc;
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_register_input_device(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_tee_init(dev: *mut amd_pmf_dev, uuid: *const uuid_t) -> c_int {
    int amd_pmf_tee_init(struct amd_pmf_dev *dev, const uuid_t *uuid)
    {
    u32 size;
    int ret;
    dev.tee_ctx = tee_client_open_context(core::ptr::null_mut(), amd_pmf_amdtee_ta_match, core::ptr::null_mut(), core::ptr::null_mut());
    if (IS_ERR(dev.tee_ctx)) {
    dev_err(dev.dev, "Failed to open TEE context\n");
    ret = PTR_ERR(dev.tee_ctx);
    dev.tee_ctx = core::ptr::null_mut();
    return ret;
    }
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_tee_deinit(dev: *mut amd_pmf_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_init_smart_pc(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_deinit_smart_pc(dev: *mut amd_pmf_dev) {
