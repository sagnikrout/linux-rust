...
//! Source: drivers/platform/x86/amd/pmf/metrics.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_q10_acc_to_mW(avg_acc: u64) -> u16 {
    static u16 amd_pmf_q10_acc_to_mW(u64 avg_acc)
    {
    let mut val: u64 = DIV_U64_ROUND_CLOSEST(avg_acc, 1024) * MILLIWATT_PER_WATT;
    return min_t(u16, val, U16_MAX);
    }
#[no_mangle]
unsafe extern "C" fn amd_pmf_q10_acc_to_int(avg_acc: u64) -> u16 {
    static u16 amd_pmf_q10_acc_to_int(u64 avg_acc)
    {
    let mut val: u64 = DIV_U64_ROUND_CLOSEST(avg_acc, 1024);
    return min_t(u16, val, U16_MAX);
    }
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_get_tbl_dram_addr(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_metrics_table_log_sample(dev: *mut amd_pmf_dev) -> c_int {
...
// Send command to PMFW to update metrics table log sample
    ret = amd_pmf_send_cmd(dev, GET_1AH_M80H_METRICS_TABLE_LOG_SAMPLE, SET_CMD, ARG_NONE, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_metrics(work: *mut work_struct) {
...
// Transfer table contents
    ...
    amd_pmf_send_cmd(dev, SET_TRANSFER_TABLE, SET_CMD, METRICS_TABLE_ID, core::ptr::null_mut());
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_set_dram_addr(dev: *mut amd_pmf_dev, alloc_buffer: bool) -> c_int {
...
// Get Metrics Table Address
    ...
    amd_pmf_send_cmd(dev, SET_DRAM_ADDR_HIGH, SET_CMD, hi, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_DRAM_ADDR_LOW, SET_CMD, low, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_init_metrics_table(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_set_device(p_device: *mut device) {
    void amd_pmf_set_device(struct device *p_device)
    {
    pmf_device = p_device;
    }
#[no_mangle]
unsafe extern "C" fn is_npu_metrics_supported(pdev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_smu_metrics(dev: *mut amd_pmf_dev, data: *mut amd_pmf_npu_metrics) -> c_int {
...
// Send SMU command to get NPU metrics
    ret = amd_pmf_send_cmd(dev, SET_TRANSFER_TABLE, SET_CMD, METRICS_TABLE_ID, core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_get_npu_data(info: *mut amd_pmf_npu_metrics) -> c_int {
