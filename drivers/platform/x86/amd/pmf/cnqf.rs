...
//! Source: drivers/platform/x86/amd/pmf/cnqf.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_cnqf_dump_defaults(data: *mut apmf_dyn_slider_output, idx: c_int) {
...
// Time constants
    ...
    amd_pmf_send_cmd(dev, SET_SPL, SET_CMD, pc.spl, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_FPPT, SET_CMD, pc.fppt, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_SPPT, SET_CMD, pc.sppt, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_SPPT_APU_ONLY, SET_CMD, pc.sppt_apu_only, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_MIN_LIMIT, SET_CMD, pc.stt_min, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_LIMIT_APU, SET_CMD,
    fixp_q88_fromint(pc.stt_skin_temp[STT_TEMP_APU]), core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_LIMIT_HS2, SET_CMD,
    fixp_q88_fromint(pc.stt_skin_temp[STT_TEMP_HS2]), core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_update_power_threshold(src: c_int) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_cnqf_get_power_source(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: is_apmf_func_supported(dev, _arg: APMF_FUNC_DYN_SLIDER_DC)) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_trans_cnqf(dev: *mut amd_pmf_dev, socket_power: c_int, time_lapsed_ms: ktime_t) -> c_int {
    int amd_pmf_trans_cnqf(struct amd_pmf_dev *dev, int socket_power, ktime_t time_lapsed_ms)
    {
    struct cnqf_tran_params *tp;
    int src, i, j;
    let mut avg_power: u32 = 0;
    src = amd_pmf_cnqf_get_power_source(dev);
    if (is_pprof_balanced(dev)) {
    amd_pmf_set_cnqf(dev, src, config_store.current_mode, core::ptr::null_mut());
    } else {
//
...
// apply the highest priority
    ...
    config_store.current_mode, core::ptr::null_mut());
    }
    break;
    }
    }
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_update_trans_data(idx: c_int, out: *mut apmf_dyn_slider_output) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_update_mode_set(idx: c_int, out: *mut apmf_dyn_slider_output) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_check_flags(dev: *mut amd_pmf_dev) -> c_int {
    static int amd_pmf_check_flags(struct amd_pmf_dev *dev)
    {
    let mut out: apmf_dyn_slider_output = {};
    if (is_apmf_func_supported(dev, APMF_FUNC_DYN_SLIDER_AC))
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_load_defaults_cnqf(dev: *mut amd_pmf_dev) -> c_int {
...
// set to initial default values
    ...
    amd_pmf_set_cnqf(pdev, src, config_store.current_mode, core::ptr::null_mut());
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_deinit_cnqf(dev: *mut amd_pmf_dev) {
    void amd_pmf_deinit_cnqf(struct amd_pmf_dev *dev)
    {
    cancel_delayed_work_sync(&dev.work_buffer);
    }
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_init_cnqf(dev: *mut amd_pmf_dev) -> c_int {
