...
//! Source: drivers/platform/x86/amd/pmf/spc.c
#![no_std]
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_get_ta_custom_bios_inputs(in: *mut ta_pmf_enact_table, index: c_int) -> u32 {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_dump_ta_inputs(dev: *mut amd_pmf_dev, in: *mut ta_pmf_enact_table) {
...
//
#[no_mangle]
unsafe extern "C" fn amd_pmf_set_ta_custom_bios_input(in: *mut ta_pmf_enact_table, index: c_int, value: u32) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_c0_residency(core_res: *mut u16, size: usize, in: *mut ta_pmf_enact_table) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_smu_info(dev: *mut amd_pmf_dev, in: *mut ta_pmf_enact_table) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_battery_prop(prop: enum power_supply_property) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_battery_info(dev: *mut amd_pmf_dev, in: *mut ta_pmf_enact_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_slider_info(dev: *mut amd_pmf_dev, in: *mut ta_pmf_enact_table) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_get_sensor_info(dev: *mut amd_pmf_dev, in: *mut ta_pmf_enact_table) {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_populate_ta_inputs(dev: *mut amd_pmf_dev, in: *mut ta_pmf_enact_table) {
