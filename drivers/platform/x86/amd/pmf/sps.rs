...
//! Source: drivers/platform/x86/amd/pmf/sps.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_dump_sps_defaults(data: *mut amd_pmf_static_slider_granular) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_dump_sps_defaults_v2(data: *mut amd_pmf_static_slider_granular_v2) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_dump_apts_sps_defaults(info: *mut amd_pmf_apts_granular) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_load_apts_defaults_sps_v2(pdev: *mut amd_pmf_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_load_defaults_sps_v2(dev: *mut amd_pmf_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_load_defaults_sps(dev: *mut amd_pmf_dev) {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_update_slider_v2(dev: *mut amd_pmf_dev, idx: c_int) {
    static void amd_pmf_update_slider_v2(struct amd_pmf_dev *dev, int idx)
    {
    amd_pmf_send_cmd(dev, SET_PMF_PPT, SET_CMD, apts_config_store.val[idx].pmf_ppt, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_PMF_PPT_APU_ONLY, SET_CMD,
    apts_config_store.val[idx].ppt_pmf_apu_only, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_MIN_LIMIT, SET_CMD,
    apts_config_store.val[idx].stt_min_limit, core::ptr::null_mut());
    ...
    {
    let mut src: c_int = amd_pmf_get_power_source();
    if (op == SLIDER_OP_SET) {
    amd_pmf_send_cmd(dev, SET_SPL, SET_CMD, config_store.prop[src][idx].spl, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_FPPT, SET_CMD, config_store.prop[src][idx].fppt, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_SPPT, SET_CMD, config_store.prop[src][idx].sppt, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_SPPT_APU_ONLY, SET_CMD,
    config_store.prop[src][idx].sppt_apu_only, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_MIN_LIMIT, SET_CMD,
    config_store.prop[src][idx].stt_min, core::ptr::null_mut());
    amd_pmf_send_cmd(dev, SET_STT_LIMIT_APU, SET_CMD,
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_update_sps_power_limits_v2(pdev: *mut amd_pmf_dev, pwr_mode: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_set_sps_power_limits(pmf: *mut amd_pmf_dev) -> c_int {
    ...
    amd_pmf_update_slider(pmf, SLIDER_OP_SET, mode, core::ptr::null_mut());
    return 0;
    }
#[no_mangle]
pub unsafe extern "C" fn is_pprof_balanced(pmf: *mut amd_pmf_dev) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_get_pprof_modes(pmf: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_power_slider_update_event(dev: *mut amd_pmf_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_hidden_choices(drvdata: *mut c_void, choices: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_pmf_profile_probe(drvdata: *mut c_void, choices: *mut c_ulong) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn amd_pmf_init_sps(dev: *mut amd_pmf_dev) -> c_int {
