...
//! Source: drivers/platform/x86/amd/amd_halo_led.c
#![no_std]
...
pub const AMD_HALO_STATUS_SUCCESS: c_uint = 0x0000;
pub const AMD_HALO_STATUS_INVALID_PARAM: c_uint = 0xFFFD;
// Brightness uses 0-100 range
pub const AMD_HALO_MAX_HW_BRIGHTNESS: c_int = 100;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_halo_wmi_args_rgb {
    pub cmd: __le32,
    pub red: __le32,
    pub green: __le32,
    pub blue: __le32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct amd_halo_wmi_output_rgb {
    pub status: __le16,
    pub red: u8,
    pub green: u8,
    pub blue: u8,
    pub __packed: },
#[no_mangle]
pub unsafe extern "C" fn wmi_status_to_err(status: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd_halo_wmi_turn_off(wdev: *mut wmi_device) -> c_int {
    static int amd_halo_wmi_turn_off(struct wmi_device *wdev)
    {
    let mut args: amd_halo_wmi_args = { };
...
//
#[no_mangle]
unsafe extern "C" fn amd_halo_wmi_set_rgb(wdev: *mut wmi_device, r: u32, g: u32, b: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn amd_halo_wmi_get_rgb(wdev: *mut wmi_device, r: *mut u8, g: *mut u8, b: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn amd_halo_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
