...
//! Source: drivers/platform/x86/amd/hsmp/acpi.c
#![no_std]
...
// This is the UUID used for HSMP
    ...
    0x87, 0x1f, 0xc2, 0xf6);
#[no_mangle]
pub unsafe extern "C" fn is_acpi_hsmp_uuid(obj: *mut union acpi_object) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn hsmp_get_uid(dev: *mut device, sock_ind: *mut u16) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hsmp_resource(res: *mut acpi_resource, data: *mut c_void) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn hsmp_read_acpi_dsd(dev: *mut device, sock: *mut hsmp_socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hsmp_read_acpi_crs(dev: *mut device, sock: *mut hsmp_socket) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hsmp_parse_acpi_table(dev: *mut device, sock_ind: u16) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn init_acpi(dev: *mut device) -> c_int {
...
// Test the hsmp interface
    ...
    .dattr = __ATTR(_name, _mode, _show, core::ptr::null_mut()),	\
    .msg_id = _msg_id,				\
    }
...
//
#[no_mangle]
unsafe extern "C" fn hsmp_acpi_sock_release(kref: *mut kref) {
...
//
#[no_mangle]
unsafe extern "C" fn hsmp_acpi_probe_failure_cleanup(dev: *mut device) {
    static void hsmp_acpi_probe_failure_cleanup(struct device *dev)
    {
    struct hsmp_socket *sock = dev_get_drvdata(dev);
    lockdep_assert_held_write(&hsmp_sock_rwsem);
    if (sock)
    sock.dev = core::ptr::null_mut();
    kref_put(&hsmp_acpi_sock_kref, hsmp_acpi_sock_release);
    }
#[no_mangle]
unsafe extern "C" fn hsmp_acpi_probe(pdev: *mut platform_device) -> c_int {
...
//
    ret = hsmp_misc_register(core::ptr::null_mut());
    if (ret) {
...
#[no_mangle]
unsafe extern "C" fn hsmp_acpi_remove(pdev: *mut platform_device) {
