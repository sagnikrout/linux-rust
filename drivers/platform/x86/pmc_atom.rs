...
//! Source: drivers/platform/x86/pmc_atom.c
#![no_std]
...
pub struct pmc_reg_map {
    pub d3_sts_0: *const pmc_bit_map,
    pub d3_sts_1: *const pmc_bit_map,
    pub func_dis: *const pmc_bit_map,
    pub func_dis_2: *const pmc_bit_map,
    pub pss: *const pmc_bit_map,
}
...
#[no_mangle]
pub unsafe extern "C" fn pmc_reg_read(pmc: *mut pmc_dev, reg_offset: c_int) -> u32 {
    static inline u32 pmc_reg_read(struct pmc_dev *pmc, int reg_offset)
    {
    return readl(pmc.regmap + reg_offset);
    }
#[no_mangle]
pub unsafe extern "C" fn pmc_reg_write(pmc: *mut pmc_dev, reg_offset: c_int, val: u32) {
    static inline void pmc_reg_write(struct pmc_dev *pmc, int reg_offset, u32 val)
    {
    writel(val, pmc.regmap + reg_offset);
    }
#[no_mangle]
pub unsafe extern "C" fn pmc_atom_read(offset: c_int, value: *mut u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_power_off() {
...
#[no_mangle]
unsafe extern "C" fn pmc_hw_reg_setup(pmc: *mut pmc_dev) {
...
//
    ...
    {
    let mut offset: c_int = PMC_REG_BIT_WIDTH * reg_index;
    int index;
...
#[no_mangle]
unsafe extern "C" fn pmc_dev_state_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_pss_state_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    static int pmc_pss_state_show(struct seq_file *s, void *unused)
    {
    struct pmc_dev *pmc = s.private;
    const struct pmc_bit_map *map = pmc.map.pss;
    let mut pss: u32 = pmc_reg_read(pmc, PMC_PSS);
    int index;
...
#[no_mangle]
unsafe extern "C" fn pmc_sleep_tmr_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_dbgfs_register(pmc: *mut pmc_dev) {
    static void pmc_dbgfs_register(struct pmc_dev *pmc)
    {
    struct dentry *dir;
    dir = debugfs_create_dir("pmc_atom", core::ptr::null_mut());
    pmc.dbgfs_dir = dir;
...
unsafe extern "C" fn pmc_dbgfs_register(pmc: *mut pmc_dev) {
    ...
    let mut pmc_clk_is_critical: static bool = true;
#[no_mangle]
unsafe extern "C" fn dmi_callback(d: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dmi_callback_siemens(d: *const dmi_system_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pmc_s2idle_check() {
...
// Forced-on PMC clocks prevent S0i3
    ...
    let mut ctl: u32 = pmc_reg_read(pmc, PMC_CLK_CTL_OFFSET + 4 * i);
...
#[no_mangle]
unsafe extern "C" fn pmc_s2idle_check_register() {
...
#[no_mangle]
unsafe extern "C" fn pmc_setup_dev(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
// Install power off function
    if (acpi_base_addr != 0 && pm_power_off == core::ptr::null_mut())
...
#[no_mangle]
unsafe extern "C" fn pmc_atom_init() -> int __init {
