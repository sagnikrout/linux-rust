...
//! Source: drivers/platform/x86/touchscreen_dmi.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn ts_dmi_add_props(client: *mut i2c_client) {
    ...
    error = device_create_managed_software_node(dev, ts_data.properties, core::ptr::null_mut());
    if (error)
...
pub const MAX_CMDLINE_PROPS: c_int = 16;
...
#[no_mangle]
unsafe extern "C" fn ts_parse_props(str: *mut c_char) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn ts_dmi_init() -> int __init {
    ...
    ts_data_dmi = dmi_id ? dmi_id.driver_data : core::ptr::null_mut();
    if (ts_data) {
//
