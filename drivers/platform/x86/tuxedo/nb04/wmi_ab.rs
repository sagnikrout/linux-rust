...
//! Source: drivers/platform/x86/tuxedo/nb04/wmi_ab.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tux_kbl_map_entry_t {
    pub code: u8,
    struct {
    pub x: u32,
    pub y: u32,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tux_driver_data_t {
    pub hdev: *mut hid_device,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tux_hdev_driver_data_t {
    pub lamp_count: u8,
    pub kbl_map: *const tux_kbl_map_entry_t,
    pub next_lamp_id: u8,
    pub next_kbl_set_multiple_keys_in: union tux_wmi_xx_496in_80out_in_t,
}

#[no_mangle]
unsafe extern "C" fn tux_ll_start(hdev: *mut hid_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tux_ll_stop(__always_unused: *mut *mut hid_device hdev) {
    static void tux_ll_stop(struct hid_device *hdev __always_unused)
    {
    }
#[no_mangle]
unsafe extern "C" fn tux_ll_open(__always_unused: *mut *mut hid_device hdev) -> c_int {
    static int tux_ll_open(struct hid_device *hdev __always_unused)
    {
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tux_ll_close(__always_unused: *mut *mut hid_device hdev) {
    static void tux_ll_close(struct hid_device *hdev __always_unused)
    {
    }
#[no_mangle]
unsafe extern "C" fn tux_ll_parse(hdev: *mut hid_device) -> c_int {
...
// Some guessed value for interval microseconds
    ...
    {
    struct tux_hdev_driver_data_t *driver_data = dev_get_drvdata(&hdev.dev);
    let mut lamp_id: u16 = driver_data.next_lamp_id;
    rep.lamp_id = lamp_id;
...
pub const LAMP_MULTI_UPDATE_REPORT_LAMP_COUNT_MAX: c_int = 8;
...
#[no_mangle]
unsafe extern "C" fn tux_probe(wdev: *mut wmi_device, __always_unused: *const *const void context) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tux_remove(wdev: *mut wmi_device) {
...
#[no_mangle]
unsafe extern "C" fn tuxedo_nb04_wmi_tux_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tuxedo_nb04_wmi_tux_exit() -> void __exit {
