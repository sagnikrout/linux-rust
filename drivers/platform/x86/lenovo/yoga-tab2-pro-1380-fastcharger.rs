...
//! Source: drivers/platform/x86/lenovo/yoga-tab2-pro-1380-fastcharger.c
#![no_std]
...
pub const YT2_1380_FC_MAX_TRIES: c_int = 5;

#[repr(C)]
#[derive(Copy, Clone)]
pub struct yt2_1380_fc {
    pub dev: *mut device,
    pub pinctrl: *mut pinctrl,
    pub gpio_state: *mut pinctrl_state,
    pub uart_state: *mut pinctrl_state,
    pub uart3_txd: *mut gpio_desc,
    pub uart3_rxd: *mut gpio_desc,
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_set_gpio_mode(fc: *mut yt2_1380_fc, enable: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_dedicated_charger_connected(fc: *mut yt2_1380_fc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_fast_charger_connected(fc: *mut yt2_1380_fc) -> bool {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_worker(work: *mut work_struct) {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_receive(serdev: *mut serdev_device, data: *const u8, len: usize) -> usize {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_serdev_probe(serdev: *mut serdev_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_pdev_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_pdev_remove(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_module_init() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn yt2_1380_fc_module_exit() -> void __exit {
