...
//! Source: drivers/platform/x86/lenovo/thinkpad_acpi.c
#![no_std]
...
pub const TPACPI_SYSFS_VERSION: c_uint = 0x030000;
//
// Changelog:
...
pub const TP_CMOS_VOLUME_DOWN: c_int = 0;
pub const TP_CMOS_VOLUME_UP: c_int = 1;
pub const TP_CMOS_VOLUME_MUTE: c_int = 2;
pub const TP_CMOS_BRIGHTNESS_UP: c_int = 4;
pub const TP_CMOS_BRIGHTNESS_DOWN: c_int = 5;
pub const TP_CMOS_THINKLIGHT_ON: c_int = 12;
pub const TP_CMOS_THINKLIGHT_OFF: c_int = 13;
// NVRAM Addresses
    enum tp_nvram_addr {
...
// Input IDs
pub const TPACPI_HKEY_INPUT_PRODUCT: c_uint = 0x5054 /* "TP" */;
pub const TPACPI_HKEY_INPUT_VERSION: c_uint = 0x4101;
// ACPI \WGSV commands
    enum {
...
pub const TPACPI_MAX_ACPI_ARGS: c_int = 3;
// Debugging printk groups
pub const TPACPI_DBG_ALL: c_uint = 0xffff;
pub const TPACPI_DBG_DISCLOSETASK: c_uint = 0x8000;
pub const TPACPI_DBG_INIT: c_uint = 0x0001;
pub const TPACPI_DBG_EXIT: c_uint = 0x0002;
pub const TPACPI_DBG_RFKILL: c_uint = 0x0004;
pub const TPACPI_DBG_HKEY: c_uint = 0x0008;
pub const TPACPI_DBG_FAN: c_uint = 0x0010;
pub const TPACPI_DBG_BRGHT: c_uint = 0x0020;
pub const TPACPI_DBG_MIXER: c_uint = 0x0040;
pub const FAN_NOT_PRESENT: c_int = 65535;
//
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tp_acpi_drv_struct {
    pub hid: *const acpi_device_id,
    pub u32): *mut *mut *mut void (notify) (struct ibm_struct ,,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ibm_struct {
    pub name: *mut c_char,
    pub device_class: acpi_device_class,
    pub ): *mut *mut int (read) (struct seq_file,
    pub ): *mut *mut int (write) (char,
    pub (void): *mut *mut void (exit),
    pub (void): *mut *mut void (resume),
    pub (void): *mut *mut void (suspend),
    pub (void): *mut *mut void (shutdown),
    pub all_drivers: list_head,
    pub acpi: *mut tp_acpi_drv_struct,
    struct {
    pub acpi_notify_installed:1: u8,
    pub proc_created:1: u8,
    pub init_called:1: u8,
    pub experimental:1: u8,
    pub flags: },
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct ibm_init_struct {
    pub param: [c_char; 32],
    pub ): *mut *mut int (init) (struct ibm_init_struct,
    pub base_procfs_mode: umode_t,
    pub data: *mut ibm_struct,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct thinkpad_id_data {
    pub vendor:: *mut *mut unsigned int vendor; / ThinkPad,
// PCI_VENDOR_ID_IBM/PCI_VENDOR_ID_LENOVO
    pub /: *mut *mut *mut char bios_version_str; / Something like 1ZET51WW (1.03z),
    pub /: *mut *mut *mut char ec_version_str; / Something like 1ZHT51WW-1.04a,
    pub /: *mut *mut u32 bios_model; / 1Y = 0x3159, 0 = unknown,
    pub ec_model: u32,
    pub /: *mut *mut u16 bios_release; / 1ZETK1WW = 0x4b31, 0 = unknown,
    pub ec_release: u16,
    pub /: *mut *mut *mut char model_str; / ThinkPad T43,
    pub /: *mut *mut *mut char nummodel_str; / 9384A9C for a 9384-A9C model,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpacpi_led_classdev {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_log_usertask(what: *const *const c_char) {
...
//
pub const TPACPI_MATCH_ANY: c_uint = 0xffffffffU;
pub const TPACPI_MATCH_ANY_VERSION: c_uint = 0xffffU;
...
#[no_mangle]
unsafe extern "C" fn tpacpi_is_lenovo() -> __always_inline bool __pure __init {
    static __always_inline bool __pure __init tpacpi_is_lenovo(void)
    {
    return thinkpad_id.vendor == PCI_VENDOR_ID_LENOVO;
    }
#[no_mangle]
unsafe extern "C" fn tpacpi_is_ibm() -> __always_inline bool __pure __init {
...
#[no_mangle]
unsafe extern "C" fn acpi_ec_read(i: c_int, p: *mut u8) -> c_int {
    static int acpi_ec_read(int i, u8 *p)
    {
    int v;
    if (ecrd_handle) {
    if (!acpi_evalf(ecrd_handle, &v, core::ptr::null_mut(), "dd", i))
    return 0;
// p = v;
    } else {
    if (ec_read(i, p) < 0)
...
#[no_mangle]
unsafe extern "C" fn acpi_ec_write(i: c_int, v: u8) -> c_int {
    static int acpi_ec_write(int i, u8 v)
    {
    if (ecwr_handle) {
    if (!acpi_evalf(ecwr_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd", i, v))
    return 0;
    } else {
    if (ec_write(i, v) < 0)
    return 0;
...
#[no_mangle]
unsafe extern "C" fn issue_thinkpad_cmos_command(cmos_cmd: c_int) -> c_int {
    static int issue_thinkpad_cmos_command(int cmos_cmd)
    {
    if (!cmos_handle)
    return -ENXIO;
    if (!acpi_evalf(cmos_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vd", cmos_cmd))
    return -EIO;
    return 0;
    }
//
...
// (acpi_handle *)return_value = handle;
    ...
    name, hid ? hid : "core::ptr::null_mut()");
...
#[no_mangle]
unsafe extern "C" fn dispatch_acpi_notify(handle: acpi_handle, event: u32, data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn setup_acpi_notify(ibm: *mut ibm_struct) -> int __init {
...
//
#[no_mangle]
unsafe extern "C" fn dispatch_proc_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dispatch_proc_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_suspend_handler(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_resume_handler(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_shutdown_handler(pdev: *mut platform_device) {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_disable_brightness_delay() {
    static void tpacpi_disable_brightness_delay(void)
    {
    if (acpi_evalf(hkey_handle, core::ptr::null_mut(), "PWMS", "qvd", 0))
...
// rfkill switches
    ...
    [TPACPI_RFK_SW_MAX] = core::ptr::null_mut()
    };
// ThinkPad-ACPI rfkill subdriver
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpacpi_rfk {
    pub rfkill: *mut rfkill,
    pub id: enum tpacpi_rfk_id,
    pub ops: *const tpacpi_rfk_ops,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpacpi_rfk_ops {
// firmware interface
    pub (*get_status)(void): *mut c_int,
    pub tpacpi_rfkill_state): *const *const int (set_status)(enum,
}

    static struct tpacpi_rfk *tpacpi_rfkill_switches[TPACPI_RFK_SW_MAX];
// Query FW and update rfkill sw state for a given rfkill switch
#[no_mangle]
unsafe extern "C" fn tpacpi_rfk_update_swstate(tp_rfk: *const tpacpi_rfk) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tpacpi_rfk_update_hwblock_state(blocked: bool) {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_rfk_check_hwblock_state() -> bool {
    static bool tpacpi_rfk_check_hwblock_state(void)
    {
    let mut res: c_int = hotkey_get_wlsw();
    int hw_blocked;
...
#[no_mangle]
unsafe extern "C" fn tpacpi_rfk_hook_set_block(data: *mut c_void, blocked: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_destroy_rfkill(id: enum tpacpi_rfk_id) {
    ...
    tpacpi_rfkill_switches[id] = core::ptr::null_mut();
    kfree(tp_rfk);
    }
    }
#[no_mangle]
unsafe extern "C" fn printk_deprecated_rfkill_attribute(what: *const *const c_char) {
...
// procfs --------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tpacpi_rfk_procfs_read(id: enum tpacpi_rfk_id, m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_rfk_procfs_write(id: enum tpacpi_rfk_id, buf: *mut c_char) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstarts(cmd, _arg: "disable")) -> else {
...
// interface_version ---------------------------------------------------
#[no_mangle]
unsafe extern "C" fn interface_version_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
// debug_level ---------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn debug_level_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
// version -------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn version_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
// wlsw_emulstate ------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn wlsw_emulstate_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
// bluetooth_emulstate -------------------------------------------------
#[no_mangle]
unsafe extern "C" fn bluetooth_emulstate_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
// wwan_emulstate -------------------------------------------------
#[no_mangle]
unsafe extern "C" fn wwan_emulstate_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
// uwb_emulstate -------------------------------------------------
#[no_mangle]
unsafe extern "C" fn uwb_emulstate_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_check_outdated_fw() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_is_fw_known() -> bool __init {
...
//
#[no_mangle]
unsafe extern "C" fn thinkpad_acpi_driver_read(m: *mut seq_file) -> c_int {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tp_nvram_state {
    pub thinkpad_toggle:1: u16,
    pub zoom_toggle:1: u16,
    pub display_toggle:1: u16,
    pub thinklight_toggle:1: u16,
    pub hibernate_toggle:1: u16,
    pub displayexp_toggle:1: u16,
    pub display_state:1: u16,
    pub brightness_toggle:1: u16,
    pub volume_toggle:1: u16,
    pub mute:1: u16,
...
// Macro flag: #define HOTKEY_CONFIG_CRITICAL_START
// Macro flag: #define HOTKEY_CONFIG_CRITICAL_END
...
#[no_mangle]
unsafe extern "C" fn hotkey_get_wlsw() -> c_int {
    static int hotkey_get_wlsw(void)
    {
    int status;
...
#[no_mangle]
unsafe extern "C" fn hotkey_gmms_get_tablet_mode(s: c_int, has_tablet_mode: *mut c_int) -> c_int {
    static int hotkey_gmms_get_tablet_mode(int s, int *has_tablet_mode)
    {
    let mut type: c_int = (s >> 16) & 0xffff;
    let mut value: c_int = s & 0xffff;
    let mut mode: c_int = TP_ACPI_MULTI_MODE_INVALID;
    let mut valid_modes: c_int = 0;
    if (has_tablet_mode)
// has_tablet_mode = 0;
    switch (type) {
    case 1:
...
#[no_mangle]
unsafe extern "C" fn hotkey_get_tablet_mode(status: *mut c_int) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn hotkey_mask_get() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hotkey_mask_warn_incomplete_mask() {
...
//
#[no_mangle]
unsafe extern "C" fn hotkey_mask_set(mask: u32) -> c_int {
    static int hotkey_mask_set(u32 mask)
    {
    int i;
    let mut rc: c_int = 0;
    let mut fwmask: u32 = mask & ~hotkey_source_mask;
    lockdep_assert_held(&hotkey_mutex);
    if (tp_features.hotkey_mask) {
    for (i = 0; i < 32; i++) {
    if (!acpi_evalf(hkey_handle,
    core::ptr::null_mut(), "MHKM", "vdd", i + 1,
    !!(mask & (1 << i)))) {
    rc = -EIO;
    break;
    }
...
//
#[no_mangle]
unsafe extern "C" fn hotkey_user_mask_set(mask: u32) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn tpacpi_hotkey_driver_mask_set(mask: u32) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hotkey_status_get(status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hotkey_status_set(enable: bool) -> c_int {
    static int hotkey_status_set(bool enable)
    {
    if (!acpi_evalf(hkey_handle, core::ptr::null_mut(), "MHKC", "vd", enable ? 1 : 0))
    return -EIO;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn tpacpi_input_send_tabletsw() {
...
#[no_mangle]
unsafe extern "C" fn get_camera_shutter() -> c_int {
    ...
    return -ENODEV;
    if (!acpi_evalf(gces_handle, &output, core::ptr::null_mut(), "dd", 0))
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn tpacpi_input_send_key(hkey: u32, send_acpi_ev: *mut bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_hotkey_send_key(scancode: c_uint) {
    static void tpacpi_hotkey_send_key(unsigned int scancode)
    {
    tpacpi_input_send_key(TP_HKEY_EV_ORIG_KEY_START + scancode, core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn hotkey_read_nvram(n: *mut tp_nvram_state, m: u32) {
...
// repeated vol up/down keypress at end of scale ?
    ...
    TPACPI_MAY_SEND_KEY(TP_ACPI_HOTKEYSCAN_VOLUMEDOWN);
#[no_mangle]
pub unsafe extern "C" fn if(TP_NVRAM_LEVEL_VOLUME_MAX: newn->volume_level >=) -> else {
...
//
#[no_mangle]
unsafe extern "C" fn hotkey_kthread(data: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hotkey_poll_stop_sync() {
    static void hotkey_poll_stop_sync(void)
    {
    lockdep_assert_held(&hotkey_mutex);
    if (tpacpi_hotkey_task) {
    kthread_stop(tpacpi_hotkey_task);
    tpacpi_hotkey_task = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn hotkey_poll_setup(may_warn: bool) {
    static void hotkey_poll_setup(const bool may_warn)
    {
    let mut poll_driver_mask: u32 = hotkey_driver_mask & hotkey_source_mask;
    let mut poll_user_mask: u32 = hotkey_user_mask & hotkey_source_mask;
    lockdep_assert_held(&hotkey_mutex);
    ...
    core::ptr::null_mut(), TPACPI_NVRAM_KTHREAD_NAME);
...
#[no_mangle]
unsafe extern "C" fn hotkey_poll_setup_safe(may_warn: bool) {
...
#[no_mangle]
unsafe extern "C" fn hotkey_poll_set_freq(freq: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn hotkey_poll_setup(__unused: bool) {
    static void hotkey_poll_setup(const bool __unused)
    {
    }
#[no_mangle]
unsafe extern "C" fn hotkey_poll_setup_safe(__unused: bool) {
...
#[no_mangle]
unsafe extern "C" fn hotkey_inputdev_open(dev: *mut input_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hotkey_inputdev_close(dev: *mut input_dev) {
...
#[no_mangle]
unsafe extern "C" fn hotkey_radio_sw_notify_change() {
    static void hotkey_radio_sw_notify_change(void)
    {
    if (tp_features.hotkey_wlsw)
    sysfs_notify(&tpacpi_pdev.dev.kobj, core::ptr::null_mut(),
    "hotkey_radio_sw");
    }
...
#[no_mangle]
unsafe extern "C" fn hotkey_tablet_mode_notify_change() {
...
// sysfs wakeup reason (pollable) --------------------------------------
    ...
    static DEVICE_ATTR(wakeup_reason, S_IRUGO, hotkey_wakeup_reason_show, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn hotkey_wakeup_reason_notify_change() {
...
// sysfs wakeup hotunplug_complete (pollable) --------------------------
    ...
    hotkey_wakeup_hotunplug_complete_show, core::ptr::null_mut());
#[no_mangle]
unsafe extern "C" fn hotkey_wakeup_hotunplug_complete_notify_change() {
...
//
#[no_mangle]
unsafe extern "C" fn tpacpi_send_radiosw_update() {
...
#[no_mangle]
unsafe extern "C" fn hotkey_exit() {
...
//
pub const TPACPI_HK_Q_INIMASK: c_uint = 0x0001;
...
#[no_mangle]
unsafe extern "C" fn hotkey_init_tablet_mode() -> c_int {
    static int hotkey_init_tablet_mode(void)
    {
    let mut in_tablet_mode: c_int = 0, res;
...
#[no_mangle]
unsafe extern "C" fn hotkey_init(iibm: *mut ibm_init_struct) -> int __init {
...
// Generic maps (fallback)
    ...
    let mut radiosw_state: bool = false;
    let mut tabletsw_state: bool = false;
    int hkeyv, res, status, camera_shutter_state;
    vdbg_printk(TPACPI_DBG_INIT | TPACPI_DBG_HKEY,
    "initializing hotkey subdriver\n");
    BUG_ON(!tpacpi_inputdev);
    BUG_ON(tpacpi_inputdev.open != core::ptr::null_mut() ||
    tpacpi_inputdev.close != core::ptr::null_mut());
...
// hotkey not supported on 570
    tp_features.hotkey = hkey_handle != core::ptr::null_mut();
    vdbg_printk(TPACPI_DBG_INIT | TPACPI_DBG_HKEY,
    "hotkeys are %s\n",
...
//
    ...
    res = sparse_keymap_setup(tpacpi_inputdev, keymap, core::ptr::null_mut());
    if (res)
    return res;
...
#[no_mangle]
unsafe extern "C" fn adaptive_keyboard_get_mode() -> c_int {
    static int adaptive_keyboard_get_mode(void)
    {
...
#[no_mangle]
unsafe extern "C" fn adaptive_keyboard_set_mode(new_mode: c_int) -> c_int {
    static int adaptive_keyboard_set_mode(int new_mode)
    {
    if (new_mode < 0 ||
    new_mode > LAYFLAT_MODE)
    return -EINVAL;
    if (!acpi_evalf(hkey_handle, core::ptr::null_mut(), "STRW", "vd", new_mode)) {
...
#[no_mangle]
unsafe extern "C" fn adaptive_keyboard_get_next_mode(mode: c_int) -> c_int {
    static int adaptive_keyboard_get_next_mode(int mode)
    {
    size_t i;
    let mut max_mode: usize = ARRAY_SIZE(adaptive_keyboard_modes) - 1;
...
#[no_mangle]
unsafe extern "C" fn adaptive_keyboard_change_row() {
...
#[no_mangle]
unsafe extern "C" fn adaptive_keyboard_s_quickview_row() {
...
#[no_mangle]
unsafe extern "C" fn hotkey_notify_hotkey(hkey: u32, send_acpi_ev: *mut bool) -> bool {
...
// Original hotkeys may be polled from NVRAM instead
    let mut scancode: c_uint = hkey - TP_HKEY_EV_ORIG_KEY_START;
...
#[no_mangle]
unsafe extern "C" fn hotkey_notify_wakeup(hkey: u32, send_acpi_ev: *mut bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hotkey_notify_dockevent(hkey: u32, send_acpi_ev: *mut bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hotkey_notify_usrevent(hkey: u32, send_acpi_ev: *mut bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hotkey_notify_6xxx(hkey: u32, send_acpi_ev: *mut bool) -> bool {
...
// Get the media key status to force the status LED to update
    acpi_evalf(hkey_handle, core::ptr::null_mut(), "GMKS", "v");
// send_acpi_ev = false;
    return true;
...
#[no_mangle]
unsafe extern "C" fn hotkey_notify_8xxx(hkey: u32, send_acpi_ev: *mut bool) -> bool {
...
#[no_mangle]
unsafe extern "C" fn hotkey_notify(ibm: *mut ibm_struct, event: u32) {
...
#[no_mangle]
unsafe extern "C" fn hotkey_suspend() {
...
#[no_mangle]
unsafe extern "C" fn hotkey_resume() {
...
// restore previous mode of adapive keyboard of X1 Carbon
    if (tp_features.has_adaptive_kbd) {
    if (!acpi_evalf(hkey_handle, core::ptr::null_mut(), "STRW", "vd",
...
// procfs --------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn hotkey_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn hotkey_enabledisable_warn(enable: bool) {
...
#[no_mangle]
unsafe extern "C" fn hotkey_write(buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bluetooth_get_status() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn bluetooth_set_status(state: enum tpacpi_rfkill_state) -> c_int {
    ...
    status = 0;
    if (!acpi_evalf(hkey_handle, core::ptr::null_mut(), "SBDC", "vd", status))
    return -EIO;
    return 0;
    }
...
#[no_mangle]
unsafe extern "C" fn bluetooth_shutdown() {
    static void bluetooth_shutdown(void)
    {
// Order firmware to save current state to NVRAM
    if (!acpi_evalf(core::ptr::null_mut(), core::ptr::null_mut(), "\\BLTH", "vd",
...
#[no_mangle]
unsafe extern "C" fn bluetooth_exit() {
...
#[no_mangle]
unsafe extern "C" fn have_bt_fwbug() -> int __init {
...
#[no_mangle]
unsafe extern "C" fn bluetooth_init(iibm: *mut ibm_init_struct) -> int __init {
...
// procfs --------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn bluetooth_read(m: *mut seq_file) -> c_int {
    static int bluetooth_read(struct seq_file *m)
    {
    return tpacpi_rfk_procfs_read(TPACPI_RFK_BLUETOOTH_SW_ID, m);
    }
#[no_mangle]
unsafe extern "C" fn bluetooth_write(buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wan_get_status() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wan_set_status(state: enum tpacpi_rfkill_state) -> c_int {
    ...
    status = 0;
    if (!acpi_evalf(hkey_handle, core::ptr::null_mut(), "SWAN", "vd", status))
    return -EIO;
    return 0;
    }
// sysfs wan enable ----------------------------------------------------
...
#[no_mangle]
unsafe extern "C" fn wan_shutdown() {
    static void wan_shutdown(void)
    {
// Order firmware to save current state to NVRAM
    if (!acpi_evalf(core::ptr::null_mut(), core::ptr::null_mut(), "\\WGSV", "vd",
...
#[no_mangle]
unsafe extern "C" fn wan_init(iibm: *mut ibm_init_struct) -> int __init {
...
// procfs --------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn wan_read(m: *mut seq_file) -> c_int {
    static int wan_read(struct seq_file *m)
    {
    return tpacpi_rfk_procfs_read(TPACPI_RFK_WWAN_SW_ID, m);
    }
#[no_mangle]
unsafe extern "C" fn wan_write(buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uwb_get_status() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uwb_set_status(state: enum tpacpi_rfkill_state) -> c_int {
    ...
    status = 0;
    if (!acpi_evalf(hkey_handle, core::ptr::null_mut(), "SUWB", "vd", status))
    return -EIO;
    return 0;
    }
// ---------------------------------------------------------------------
...
#[no_mangle]
unsafe extern "C" fn uwb_exit() {
    static void uwb_exit(void)
    {
    tpacpi_destroy_rfkill(TPACPI_RFK_UWB_SW_ID);
    }
#[no_mangle]
unsafe extern "C" fn uwb_init(iibm: *mut ibm_init_struct) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn video_init(iibm: *mut ibm_init_struct) -> int __init {
    ...
    if (vid2_handle && acpi_evalf(core::ptr::null_mut(), &ivga, "\\IVGA", "d") && ivga)
...
#[no_mangle]
unsafe extern "C" fn video_outputsw_get() -> c_int {
    ...
    if (!acpi_evalf(core::ptr::null_mut(), &i, "\\_SB.PHS", "dd",
    TP_ACPI_VIDEO_570_PHSCMD))
    return -EIO;
    status = i & TP_ACPI_VIDEO_570_PHSMASK;
    break;
    case TPACPI_VIDEO_770:
    if (!acpi_evalf(core::ptr::null_mut(), &i, "\\VCDL", "d"))
    return -EIO;
    if (i)
    status |= TP_ACPI_VIDEO_S_LCD;
    if (!acpi_evalf(core::ptr::null_mut(), &i, "\\VCDC", "d"))
    return -EIO;
    if (i)
    status |= TP_ACPI_VIDEO_S_CRT;
    break;
    case TPACPI_VIDEO_NEW:
    if (!acpi_evalf(core::ptr::null_mut(), core::ptr::null_mut(), "\\VUPS", "vd", 1) ||
    !acpi_evalf(core::ptr::null_mut(), &i, "\\VCDC", "d"))
    return -EIO;
    if (i)
    status |= TP_ACPI_VIDEO_S_CRT;
    if (!acpi_evalf(core::ptr::null_mut(), core::ptr::null_mut(), "\\VUPS", "vd", 0) ||
    !acpi_evalf(core::ptr::null_mut(), &i, "\\VCDL", "d"))
    return -EIO;
    if (i)
    status |= TP_ACPI_VIDEO_S_LCD;
    if (!acpi_evalf(core::ptr::null_mut(), &i, "\\VCDD", "d"))
    return -EIO;
    if (i)
...
#[no_mangle]
unsafe extern "C" fn video_outputsw_set(status: c_int) -> c_int {
    ...
    switch (video_supported) {
    case TPACPI_VIDEO_570:
    res = acpi_evalf(core::ptr::null_mut(), core::ptr::null_mut(),
    "\\_SB.PHS2", "vdd",
    ...
    if (res)
    return res;
    res = acpi_evalf(vid_handle, core::ptr::null_mut(),
    ...
    break;
    case TPACPI_VIDEO_NEW:
    res = acpi_evalf(core::ptr::null_mut(), core::ptr::null_mut(), "\\VUPS", "vd", 0x80) &&
    acpi_evalf(core::ptr::null_mut(), core::ptr::null_mut(), "\\VSDS", "vdd", status, 1);
    break;
    default:
    return -ENOSYS;
    }
...
#[no_mangle]
unsafe extern "C" fn video_autosw_get() -> c_int {
    static int video_autosw_get(void)
    {
    let mut autosw: c_int = 0;
    switch (video_supported) {
    case TPACPI_VIDEO_570:
...
#[no_mangle]
unsafe extern "C" fn video_autosw_set(enable: c_int) -> c_int {
    static int video_autosw_set(int enable)
    {
    if (!acpi_evalf(vid_handle, core::ptr::null_mut(), "_DOS", "vd", (enable) ? 1 : 0))
    return -EIO;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn video_outputsw_cycle() -> c_int {
    static int video_outputsw_cycle(void)
    {
    let mut autosw: c_int = video_autosw_get();
    int res;
    if (autosw < 0)
    return autosw;
    switch (video_supported) {
    ...
    if (res)
    return res;
    res = acpi_evalf(ec_handle, core::ptr::null_mut(), "_Q16", "v");
    break;
    case TPACPI_VIDEO_770:
    case TPACPI_VIDEO_NEW:
    res = video_autosw_set(1);
    if (res)
    return res;
    res = acpi_evalf(vid_handle, core::ptr::null_mut(), "VSWT", "v");
    break;
    default:
    return -ENOSYS;
    }
...
#[no_mangle]
unsafe extern "C" fn video_expand_toggle() -> c_int {
    static int video_expand_toggle(void)
    {
    switch (video_supported) {
    case TPACPI_VIDEO_570:
    return acpi_evalf(ec_handle, core::ptr::null_mut(), "_Q17", "v") ?
    0 : -EIO;
    case TPACPI_VIDEO_770:
    return acpi_evalf(vid_handle, core::ptr::null_mut(), "VEXP", "v") ?
    0 : -EIO;
    case TPACPI_VIDEO_NEW:
    return acpi_evalf(core::ptr::null_mut(), core::ptr::null_mut(), "\\VEXP", "v") ?
    0 : -EIO;
    default:
    return -ENOSYS;
    }
...
#[no_mangle]
unsafe extern "C" fn video_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn video_write(buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbdlight_set_level(level: c_int) -> c_int {
    ...
    if (!acpi_evalf(hkey_handle, core::ptr::null_mut(), "MLCS", "dd", level))
    ret = -EIO;
    else
...
#[no_mangle]
unsafe extern "C" fn kbdlight_get_level() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbdlight_is_supported() -> bool {
...
#[no_mangle]
unsafe extern "C" fn kbdlight_sysfs_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn kbdlight_init(iibm: *mut ibm_init_struct) -> int __init {
    ...
    kbdlight_brightness = kbdlight_sysfs_get(core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn kbdlight_exit() {
    static void kbdlight_exit(void)
    {
    led_classdev_unregister(&tpacpi_led_kbdlight.led_classdev);
    }
#[no_mangle]
unsafe extern "C" fn kbdlight_set_level_and_update(level: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbdlight_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbdlight_write(buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn kbdlight_suspend() {
...
#[no_mangle]
unsafe extern "C" fn kbdlight_resume() {
...
#[no_mangle]
unsafe extern "C" fn light_get_status() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn light_set_status(status: c_int) -> c_int {
    static int light_set_status(int status)
    {
    int rc;
    if (tp_features.light) {
    if (cmos_handle) {
    rc = acpi_evalf(cmos_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vd",
    (status) ?
    TP_CMOS_THINKLIGHT_ON :
    TP_CMOS_THINKLIGHT_OFF);
    } else {
    rc = acpi_evalf(lght_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vd",
    (status) ? 1 : 0);
    }
    return (rc) ? 0 : -EIO;
    }
...
#[no_mangle]
unsafe extern "C" fn light_sysfs_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn light_init(iibm: *mut ibm_init_struct) -> int __init {
...
// light status not supported on
    ...
    acpi_evalf(ec_handle, core::ptr::null_mut(), "KBLT", "qv");
...
#[no_mangle]
unsafe extern "C" fn light_exit() {
    static void light_exit(void)
    {
    led_classdev_unregister(&tpacpi_led_thinklight.led_classdev);
    }
#[no_mangle]
unsafe extern "C" fn light_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn light_write(buf: *mut c_char) -> c_int {
    static int light_write(char *buf)
    {
    char *cmd;
    let mut newstatus: c_int = 0;
    if (!tp_features.light)
    return -ENODEV;
    while ((cmd = strsep(&buf, ","))) {
    if (strstarts(cmd, "on")) {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn cmos_init(iibm: *mut ibm_init_struct) -> int __init {
    ...
    str_supported(cmos_handle != core::ptr::null_mut()));
    return cmos_handle ? 0 : -ENODEV;
    }
#[no_mangle]
unsafe extern "C" fn cmos_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cmos_write(buf: *mut c_char) -> c_int {
...
pub const TPACPI_LED_NUMLEDS: c_int = 16;
...
pub const TPACPI_SAFE_LEDS: c_uint = 0x1481U;
#[no_mangle]
pub unsafe extern "C" fn tpacpi_is_led_restricted(led: c_uint) -> bool {
...
#[no_mangle]
unsafe extern "C" fn led_get_status(led: c_uint) -> c_int {
...
// 570
    ...
    return -EPERM;
    if (!acpi_evalf(led_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd",
...
#[no_mangle]
pub unsafe extern "C" fn if(TPACPI_LED_BLINK: tpacpi_led_state_cache[data->led] !=) -> else {
...
#[no_mangle]
unsafe extern "C" fn led_sysfs_get(led_cdev: *mut led_classdev) -> enum led_brightness {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_init_led(led: c_uint) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn led_init_detect_mode() -> enum led_access_mode __init {
...
// R30, R31, and unknown firmwares
    led_handle = core::ptr::null_mut();
    return TPACPI_LED_NONE;
    }
#[no_mangle]
unsafe extern "C" fn led_init(iibm: *mut ibm_init_struct) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn led_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn led_write(buf: *mut c_char) -> c_int {
...
pub const TPACPI_BEEP_Q1: c_uint = 0x0001;
    static const struct tpacpi_quirk beep_quirk_table[] __initconst = {
    TPACPI_Q_IBM('I', 'M', TPACPI_BEEP_Q1), /* 570 */
    TPACPI_Q_IBM('I', 'U', TPACPI_BEEP_Q1), /* 570E - unverified */
    };
#[no_mangle]
unsafe extern "C" fn beep_init(iibm: *mut ibm_init_struct) -> int __init {
    ...
    str_supported(beep_handle != core::ptr::null_mut()));
...
#[no_mangle]
unsafe extern "C" fn beep_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn beep_write(buf: *mut c_char) -> c_int {
...
// beep_cmd set
    ...
    if (!acpi_evalf(beep_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd",
    beep_cmd, 0))
    return -EIO;
    } else {
    if (!acpi_evalf(beep_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vd",
    beep_cmd))
    return -EIO;
    }
    }
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct ibm_thermal_sensors_struct {
    pub temp: [i32; TPACPI_MAX_THERMAL_SENSORS],
}
...
#[no_mangle]
unsafe extern "C" fn thermal_read_mode_check() -> enum thermal_access_mode __init {
    static enum thermal_access_mode __init thermal_read_mode_check(void)
    {
    u8 t, ta1, ta2, ver = 0;
    int i;
    int acpi_tmp7;
    acpi_tmp7 = acpi_evalf(ec_handle, core::ptr::null_mut(), "TMP7", "qv");
...
// This is sheer paranoia, but we handle it anyway
    ...
    if (acpi_tmp7) {
    if (tpacpi_is_ibm() && acpi_evalf(ec_handle, core::ptr::null_mut(), "UPDT", "qv")) {
// 600e/x, 770e, 770x
...
// idx is zero-based
#[no_mangle]
unsafe extern "C" fn thermal_get_sensor(idx: c_int, value: *mut i32) -> c_int {
...
// value = tmp * MILLIDEGREE_PER_DEGREE;
    ...
    if (!acpi_evalf(ec_handle, core::ptr::null_mut(), "UPDT", "v"))
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn thermal_get_sensors(s: *mut ibm_thermal_sensors_struct) -> c_int {
    ...
    n = 16;
#[no_mangle]
pub unsafe extern "C" fn if(TPACPI_THERMAL_TPEC_12: thermal_read_mode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn thermal_dump_all_sensors() {
    static void thermal_dump_all_sensors(void)
    {
    int n, i;
...
// sysfs temp##_input --------------------------------------------------
    ...
    let mut idx: c_int = sensor_attr.index;
    s32 value;
    int res;
    ...
    thermal_temp_input_show, core::ptr::null_mut(), _idxB)
...
#[no_mangle]
unsafe extern "C" fn temp1_label_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
#[no_mangle]
unsafe extern "C" fn temp2_label_show(dev: *mut device, attr: *mut device_attribute, buf: *mut c_char) -> isize {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn thermal_init(iibm: *mut ibm_init_struct) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn thermal_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_brightness_nvram_get() -> c_uint {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_brightness_checkpoint_nvram() {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_brightness_get_raw(status: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_brightness_set_ec(value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_brightness_set_ucmsstep(value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brightness_set(value: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brightness_update_status(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn brightness_get(bd: *mut backlight_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_brightness_notify_change() {
...
// ---------------------------------------------------------------------
#[no_mangle]
unsafe extern "C" fn tpacpi_evaluate_bcl(adev: *mut acpi_device, not_used: *mut c_void) -> int __init {
    ...
    acpi_status status;
    int rc;
    status = acpi_evaluate_object(adev.handle, "_BCL", core::ptr::null_mut(), &buffer);
    if (ACPI_FAILURE(status))
    return 0;
    obj = buffer.pointer;
...
//
#[no_mangle]
unsafe extern "C" fn tpacpi_query_bcl_levels(handle: acpi_handle) -> int __init {
    ...
    if (!device)
    return 0;
    return acpi_dev_for_each_child(device, tpacpi_evaluate_bcl, core::ptr::null_mut());
    }
//
// Returns 0 (no ACPI _BCL or _BCL invalid), or size of brightness map
//
#[no_mangle]
unsafe extern "C" fn tpacpi_check_std_acpi_brightness_support() -> unsigned int __init {
    static unsigned int __init tpacpi_check_std_acpi_brightness_support(void)
    {
    acpi_handle video_device;
    let mut bcl_levels: c_int = 0;
    tpacpi_acpi_handle_locate("video", core::ptr::null_mut(), &video_device);
    if (video_device)
...
// these quirks.
//
pub const TPACPI_BRGHT_Q_NOEC: c_uint = 0x0001	/* Must NOT use EC HBRV */;
pub const TPACPI_BRGHT_Q_EC: c_uint = 0x0002  /* Should or must use EC HBRV */;
pub const TPACPI_BRGHT_Q_ASK: c_uint = 0x8000	/* Ask for user report */;
...
//
#[no_mangle]
unsafe extern "C" fn tpacpi_detect_brightness_capabilities() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn brightness_init(iibm: *mut ibm_init_struct) -> int __init {
...
// Safety
    ...
    let mut rc: c_int = PTR_ERR(ibm_backlight_device);
    ibm_backlight_device = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn brightness_suspend() {
    static void brightness_suspend(void)
    {
    tpacpi_brightness_checkpoint_nvram();
    }
#[no_mangle]
unsafe extern "C" fn brightness_shutdown() {
    static void brightness_shutdown(void)
    {
    tpacpi_brightness_checkpoint_nvram();
    }
#[no_mangle]
unsafe extern "C" fn brightness_exit() {
...
#[no_mangle]
unsafe extern "C" fn brightness_read(m: *mut seq_file) -> c_int {
    static int brightness_read(struct seq_file *m)
    {
    int level;
    level = brightness_get(core::ptr::null_mut());
    if (level < 0) {
...
#[no_mangle]
unsafe extern "C" fn brightness_write(buf: *mut c_char) -> c_int {
...
//
    ...
    let mut alsa_enable: static bool = SNDRV_DEFAULT_ENABLE1;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpacpi_alsa_data {
    pub card: *mut snd_card,
    pub ctl_mute_id: *mut snd_ctl_elem_id,
    pub ctl_vol_id: *mut snd_ctl_elem_id,
}
...
// We don't know what mode 1 is.
    ...
    let mut software_mute_requested: static bool = true;
...
#[no_mangle]
unsafe extern "C" fn tpacpi_volume_checkpoint_nvram() {
...
#[no_mangle]
unsafe extern "C" fn volume_get_status_ec(status: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn volume_get_status(status: *mut u8) -> c_int {
    static int volume_get_status(u8 *status)
    {
    return volume_get_status_ec(status);
    }
#[no_mangle]
unsafe extern "C" fn volume_set_status_ec(status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn volume_set_status(status: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn __volume_set_mute_ec(mute: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn volume_alsa_set_mute(mute: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn volume_set_mute(mute: bool) -> c_int {
...
// returns < 0 on error, 0 on no change, 1 on change
#[no_mangle]
unsafe extern "C" fn __volume_set_volume_ec(vol: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn volume_set_software_mute(startup: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn volume_exit_software_mute() {
...
#[no_mangle]
unsafe extern "C" fn volume_alsa_set_volume(vol: u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn volume_alsa_notify_change() {
...
#[no_mangle]
unsafe extern "C" fn volume_suspend() {
    static void volume_suspend(void)
    {
    tpacpi_volume_checkpoint_nvram();
    }
#[no_mangle]
unsafe extern "C" fn volume_resume() {
...
#[no_mangle]
unsafe extern "C" fn volume_shutdown() {
    static void volume_shutdown(void)
    {
    tpacpi_volume_checkpoint_nvram();
    }
#[no_mangle]
unsafe extern "C" fn volume_exit() {
    static void volume_exit(void)
    {
    if (alsa_card) {
    snd_card_free(alsa_card);
    alsa_card = core::ptr::null_mut();
    }
    tpacpi_volume_checkpoint_nvram();
    if (software_mute_active)
...
#[no_mangle]
unsafe extern "C" fn volume_create_alsa_mixer() -> int __init {
    ...
    if (!tp_features.mixer_no_level_control) {
    ctl_vol = snd_ctl_new1(&volume_alsa_control_vol, core::ptr::null_mut());
    ...
    ctl_mute = snd_ctl_new1(&volume_alsa_control_mute, core::ptr::null_mut());
...
pub const TPACPI_VOL_Q_MUTEONLY: c_uint = 0x0001	/* Mute-only control available */;
pub const TPACPI_VOL_Q_LEVEL: c_uint = 0x0002  /* Volume control available */;
...
#[no_mangle]
unsafe extern "C" fn volume_init(iibm: *mut ibm_init_struct) -> int __init {
...
#[no_mangle]
pub unsafe extern "C" fn if(TPACPI_VOL_Q_LEVEL: quirks &) -> else {
...
#[no_mangle]
unsafe extern "C" fn volume_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn volume_write(buf: *mut c_char) -> c_int {
...
//
    ...
    new_mute = 0;
#[no_mangle]
pub unsafe extern "C" fn if(TP_EC_VOLUME_MAX: new_level <) -> else {
    ...
    new_mute = 0;
#[no_mangle]
pub unsafe extern "C" fn if(0: new_level >) -> else {
    else if (new_level > 0)
    new_level--;
    continue;
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstarts(cmd, _arg: "unmute")) -> else {
...
#[no_mangle]
pub unsafe extern "C" fn volume_alsa_notify_change() {
...
//
#[no_mangle]
unsafe extern "C" fn fan_quirk1_setup() {
...
#[no_mangle]
unsafe extern "C" fn fan_quirk1_handle(fan_status: *mut u8) {
...
#[no_mangle]
unsafe extern "C" fn fan_select_fan1() -> bool {
...
#[no_mangle]
unsafe extern "C" fn fan_select_fan2() -> bool {
...
#[no_mangle]
unsafe extern "C" fn fan_update_desired_level(status: u8) {
...
#[no_mangle]
unsafe extern "C" fn fan_get_status(status: *mut u8) -> c_int {
...
// 570, 600e/x, 770e, 770x
    int res;
    if (unlikely(!acpi_evalf(gfan_handle, &res, core::ptr::null_mut(), "d")))
    return -EIO;
    if (likely(status))
// status = res & 0x07;
    break;
...
// E531
    int mode, speed;
    if (unlikely(!acpi_evalf(fang_handle, &mode, core::ptr::null_mut(), "dd", 0x8100)))
    return -EIO;
    if (unlikely(!acpi_evalf(fang_handle, &speed, core::ptr::null_mut(), "dd", 0x8102)))
    return -EIO;
    if (likely(status)) {
// status = speed * 7 / 100;
    if (mode < 9)
...
#[no_mangle]
unsafe extern "C" fn fan_get_status_safe(status: *mut u8) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan_get_speed(speed: *mut c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan2_get_speed(speed: *mut c_uint) -> c_int {
...
// E531
    int speed_tmp;
    if (unlikely(!acpi_evalf(fang_handle, &speed_tmp, core::ptr::null_mut(), "dd", 0x8102)))
    return -EIO;
    if (likely(speed))
...
#[no_mangle]
unsafe extern "C" fn fan_set_level(level: c_int) -> c_int {
    ...
    if (!fan_select_fan2() ||
    !acpi_evalf(sfan_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vd", level)) {
    pr_warn("Couldn't set 2nd fan level, disabling support\n");
    tp_features.second_fan_ctl = 0;
    }
    fan_select_fan1();
    }
    if (!acpi_evalf(sfan_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vd", level))
    return -EIO;
    break;
...
#[no_mangle]
pub unsafe extern "C" fn if(TP_EC_FAN_AUTO: level &) -> else {
    ...
    return -EINVAL;
    if (level & TP_EC_FAN_AUTO) {
    if (!acpi_evalf(fanw_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd", 0x8106, 0x05)) {
    return -EIO;
    }
    if (!acpi_evalf(fanw_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd", 0x8100, 0x00)) {
    return -EIO;
    }
    } else {
    if (!acpi_evalf(fanw_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd", 0x8106, 0x45)) {
    return -EIO;
    }
    if (!acpi_evalf(fanw_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd", 0x8100, 0xff)) {
    return -EIO;
    }
    if (!acpi_evalf(fanw_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd", 0x8102, level * 100 / 7)) {
    return -EIO;
    }
    }
    break;
...
#[no_mangle]
unsafe extern "C" fn fan_set_level_safe(level: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan_set_enable() -> c_int {
...
// Set fan to at least level 4
    s |= 4;
    if (!acpi_evalf(sfan_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vd", s))
    rc = -EIO;
    else
    rc = 0;
    break;
...
#[no_mangle]
unsafe extern "C" fn fan_set_disable() -> c_int {
    ...
    break;
    case TPACPI_FAN_WR_ACPI_SFAN:
    if (!acpi_evalf(sfan_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vd", 0x00))
    rc = -EIO;
    else
    fan_control_desired_level = 0;
    break;
    ...
    if (!acpi_evalf(fanw_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd", 0x8102, 0x00)) {
    rc = -EIO;
    break;
    }
    rc = 0;
...
#[no_mangle]
unsafe extern "C" fn fan_set_speed(speed: c_int) -> c_int {
    ...
    if (!acpi_evalf(fans_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vddd",
    speed, speed, speed))
    rc = -EIO;
    } else
    rc = -EINVAL;
    ...
    if (!acpi_evalf(fanw_handle, core::ptr::null_mut(), core::ptr::null_mut(), "vdd",
...
#[no_mangle]
unsafe extern "C" fn fan_watchdog_reset() {
...
#[no_mangle]
unsafe extern "C" fn fan_watchdog_fire(ignored: *mut work_struct) {
    static void fan_watchdog_fire(struct work_struct *ignored)
    {
    int rc;
    if (tpacpi_lifecycle != TPACPI_LIFE_RUNNING)
...
// Check for fan speeds displayed in hexadecimal
    ...
    static DEVICE_ATTR(fan1_input, S_IRUGO, fan_fan1_input_show, core::ptr::null_mut());
...
// Check for fan speeds displayed in hexadecimal
    ...
    static DEVICE_ATTR(fan2_input, S_IRUGO, fan_fan2_input_show, core::ptr::null_mut());
// sysfs fan fan_watchdog (hwmon driver) -------------------------------
#[no_mangle]
unsafe extern "C" fn fan_watchdog_show(drv: *mut device_driver, buf: *mut c_char) -> isize {
...
pub const TPACPI_FAN_Q1: c_uint = 0x0001		/* Uninitialized HFSP */;
pub const TPACPI_FAN_2FAN: c_uint = 0x0002		/* EC 0x31 bit 0 selects fan2 */;
pub const TPACPI_FAN_2CTL: c_uint = 0x0004		/* selects fan2 control */;
pub const TPACPI_FAN_NOFAN: c_uint = 0x0008		/* no fan available */;
pub const TPACPI_FAN_NS: c_uint = 0x0010		/* For EC with non-Standard register addresses */;
pub const TPACPI_FAN_DECRPM: c_uint = 0x0020		/* For ECFW's with RPM in register as decimal */;
pub const TPACPI_FAN_TPR: c_uint = 0x0040		/* Fan speed is in Ticks Per Revolution */;
pub const TPACPI_FAN_NOACPI: c_uint = 0x0080		/* Don't use ACPI methods even if detected */;
...
#[no_mangle]
unsafe extern "C" fn fan_init(iibm: *mut ibm_init_struct) -> int __init {
...
// E560, T495, T495s
    ...
    fang_handle = core::ptr::null_mut();
    fanw_handle = core::ptr::null_mut();
    }
    if (gfan_handle) {
// 570, 600e/x, 770e, 770x
...
// update fan_control_desired_level
    if (fan_status_access_mode != TPACPI_FAN_NONE)
    fan_get_status_safe(core::ptr::null_mut());
    if (fan_status_access_mode == TPACPI_FAN_NONE &&
    fan_control_access_mode == TPACPI_FAN_WR_NONE)
    return -ENODEV;
    return 0;
...
#[no_mangle]
unsafe extern "C" fn fan_suspend() {
...
#[no_mangle]
unsafe extern "C" fn fan_resume() {
    static void fan_resume(void)
    {
    let mut current_level: u8 = 7;
    let mut do_set: bool = false;
    int rc;
...
#[no_mangle]
unsafe extern "C" fn fan_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(TP_EC_FAN_AUTO: status &) -> else {
    else if (status & TP_EC_FAN_AUTO)
...
#[no_mangle]
unsafe extern "C" fn fan_write_cmd_level(cmd: *const c_char, rc: *mut c_int) -> c_int {
    ...
    level = TP_EC_FAN_AUTO;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: strstarts(cmd, strstarts(cmd: "level disengaged") ||, full-speed"): "level) -> else {
    else if (strstarts(cmd, "level disengaged") || strstarts(cmd, "level full-speed"))
    level = TP_EC_FAN_FULLSPEED;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: sscanf(cmd, %d": "level, 1: &level) !=) -> else {
    else if (sscanf(cmd, "level %d", &level) != 1)
    return 0;
// rc = fan_set_level_safe(level);
    ...
    fan_control_access_mode);
#[no_mangle]
pub unsafe extern "C" fn if(_arg: *mut !rc) -> else {
    else if (!*rc)
...
#[no_mangle]
unsafe extern "C" fn fan_write_cmd_enable(cmd: *const c_char, rc: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan_write_cmd_disable(cmd: *const c_char, rc: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan_write_cmd_speed(cmd: *const c_char, rc: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan_write_cmd_watchdog(cmd: *const c_char, rc: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn fan_write(buf: *mut c_char) -> c_int {
...
// Mute LED subdriver
//
pub const TPACPI_LED_MAX: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tp_led_table {
    pub name: acpi_string,
    pub on_value: c_int,
    pub off_value: c_int,
    pub state: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn mute_led_on_off(t: *mut tp_led_table, state: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_led_set(whichled: c_int, on: bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mute_led_init(iibm: *mut ibm_init_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mute_led_exit() {
...
#[no_mangle]
unsafe extern "C" fn mute_led_resume() {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpacpi_battery_data {
    pub charge_start: c_int,
    pub start_support: c_int,
    pub charge_stop: c_int,
    pub stop_support: c_int,
    pub charge_behaviours: c_uint,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpacpi_battery_driver_data {
    pub batteries: [tpacpi_battery_data; 3],
    pub individual_addressing: c_int,
}
...
//
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_acpi_eval(method: *mut c_char, ret: *mut c_int, param: c_int) -> acpi_status {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_get(what: c_int, battery: c_int, ret: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ACPI_FAILURE(_arg: tpacpi_battery_acpi_eval(GET_DISCHARGE, _arg: ret, _arg: battery)) -> if {
...
// ret = *ret & 0x01;
    ...
    case INHIBIT_CHARGE:
#[no_mangle]
pub unsafe extern "C" fn ACPI_FAILURE(_arg: tpacpi_battery_acpi_eval(GET_INHIBIT, _arg: ret, _arg: battery)) -> if {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_set(what: c_int, battery: c_int, value: c_int) -> c_int {
...
// The battery ID is in bits 8-9, 2 bits
    ...
    case THRESHOLD_START:
#[no_mangle]
pub unsafe extern "C" fn ACPI_FAILURE(_arg: tpacpi_battery_acpi_eval(SET_START, _arg: &ret, _arg: param)) -> if {
    ...
    case THRESHOLD_STOP:
#[no_mangle]
pub unsafe extern "C" fn ACPI_FAILURE(_arg: tpacpi_battery_acpi_eval(SET_STOP, _arg: &ret, _arg: param)) -> if {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_set_validate(what: c_int, battery: c_int, value: c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_probe(battery: c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn ACPI_FAILURE(_arg: tpacpi_battery_acpi_eval(GET_START, _arg: &ret, _arg: battery)) -> if {
...
#[no_mangle]
pub unsafe extern "C" fn ACPI_FAILURE(_arg: tpacpi_battery_acpi_eval(GET_STOP, _arg: &ret, _arg: battery)) -> if {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_get_id(battery_name: *const c_char) -> c_int {
...
// BAT_PRIMARY or BAT_SECONDARY
    ...
    char *buf)
    {
    let mut active: enum power_supply_charge_behaviour = POWER_SUPPLY_CHARGE_BEHAVIOUR_AUTO;
    struct power_supply *supply = to_power_supply(dev);
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_add(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
    static int tpacpi_battery_add(struct power_supply *battery, struct acpi_battery_hook *hook)
    {
    let mut batteryid: c_int = tpacpi_battery_get_id(battery.desc.name);
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_remove(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_init(ibm: *mut ibm_init_struct) -> int __init {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_battery_exit() {
...
//
    ...
    return -EIO;
    if (!acpi_evalf(lcdshadow_set_handle, &output, core::ptr::null_mut(), "dd", (int)state))
    return -EIO;
    priv.hw_state = priv.sw_state = state;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn lcdshadow_get_hw_state(priv: *mut drm_privacy_screen) {
    static void lcdshadow_get_hw_state(struct drm_privacy_screen *priv)
    {
    int output;
    if (!acpi_evalf(lcdshadow_get_handle, &output, core::ptr::null_mut(), "dd", 0))
    return;
...
#[no_mangle]
unsafe extern "C" fn tpacpi_lcdshadow_init(iibm: *mut ibm_init_struct) -> c_int {
    ...
    &lcdshadow_ops, core::ptr::null_mut());
    if (IS_ERR(lcdshadow_dev))
    return PTR_ERR(lcdshadow_dev);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn lcdshadow_exit() {
    static void lcdshadow_exit(void)
    {
    drm_privacy_screen_unregister(lcdshadow_dev);
    }
#[no_mangle]
unsafe extern "C" fn lcdshadow_resume() {
...
#[no_mangle]
unsafe extern "C" fn lcdshadow_read(m: *mut seq_file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lcdshadow_write(buf: *mut c_char) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dytc_command(command: c_int, output: *mut c_int) -> c_int {
...
// Platform doesn't support DYTC
    ...
    if (!acpi_evalf(dytc_handle, output, core::ptr::null_mut(), "dd", command))
    return -EIO;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn lapsensor_get(present: *mut bool, state: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn palmsensor_get(present: *mut bool, state: *mut bool) -> c_int {
...
// present = false;
    ...
    return -ENODEV;
    if (!acpi_evalf(psensor_handle, &output, core::ptr::null_mut(), "d"))
    return -EIO;
...
#[no_mangle]
unsafe extern "C" fn lapsensor_refresh() {
    ...
    if (lap_state != state) {
    lap_state = state;
    sysfs_notify(&tpacpi_pdev.dev.kobj, core::ptr::null_mut(), "dytc_lapmode");
    }
    }
    }
#[no_mangle]
unsafe extern "C" fn palmsensor_refresh() {
    static void palmsensor_refresh(void)
    {
    bool state;
    int err;
    ...
    if (palm_state != state) {
    palm_state = state;
    sysfs_notify(&tpacpi_pdev.dev.kobj, core::ptr::null_mut(), "palmsensor");
    }
    }
    }
...
#[no_mangle]
unsafe extern "C" fn tpacpi_proxsensor_init(iibm: *mut ibm_init_struct) -> c_int {
...
pub const DYTC_CMD_RESET: c_uint = 0x1ff /* To reset back to default */;

pub const DYTC_MODE_AMT_ENABLE: c_uint = 0x1 /* Enable AMT (in balanced mode) */;
pub const DYTC_MODE_AMT_DISABLE: c_uint = 0xF /* Disable AMT (in other modes) */;

pub const DYTC_MODE_MMC_BALANCE: c_uint = 0xF  /* Default mode aka balanced */;

pub const DYTC_ERR_MASK: c_uint = 0xF  /* Bits 0-3 in cmd result are the error result */;
    ...
    let mut dytc_ignore_event: static atomic_t = ATOMIC_INIT(0);
    static DEFINE_MUTEX(dytc_mutex);
    static int dytc_capabilities;
    static bool dytc_mmc_get_available;
    static int profile_force;
    let mut platform_psc_profile_lowpower: static int = DYTC_MODE_PSC_LOWPOWER;
    let mut platform_psc_profile_balanced: static int = DYTC_MODE_PSC_BALANCE;
    let mut platform_psc_profile_performance: static int = DYTC_MODE_PSC_PERFORM;
...
// profile = PLATFORM_PROFILE_LOW_POWER;
#[no_mangle]
pub unsafe extern "C" fn if(platform_psc_profile_balanced: dytcmode ==) -> else {
    else if (dytcmode == platform_psc_profile_balanced)
// profile =  PLATFORM_PROFILE_BALANCED;
#[no_mangle]
pub unsafe extern "C" fn if(platform_psc_profile_performance: dytcmode ==) -> else {
...
#[no_mangle]
unsafe extern "C" fn convert_profile_to_dytc(profile: enum platform_profile_option, perfmode: *mut c_int) -> c_int {
...
#[no_mangle]
pub unsafe extern "C" fn if(BIT(DYTC_FC_PSC): dytc_capabilities &) -> else {
...
#[no_mangle]
unsafe extern "C" fn dytc_control_amt(enable: bool) -> c_int {
    static int dytc_control_amt(bool enable)
    {
    int dummy;
    int err;
...
//
#[no_mangle]
unsafe extern "C" fn dytc_cql_command(command: c_int, output: *mut c_int) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dytc_profile_probe(drvdata: *mut c_void, choices: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn dytc_profile_refresh() {
    static void dytc_profile_refresh(void)
    {
    enum platform_profile_option profile;
    let mut output: c_int = 0, err = 0;
...
#[no_mangle]
unsafe extern "C" fn tpacpi_dytc_profile_init(iibm: *mut ibm_init_struct) -> c_int {
...
// Create platform_profile structure and register
    ...
    core::ptr::null_mut(), &dytc_profile_ops);
//
...
// Workaround for https://bugzilla.kernel.org/show_bug.cgi?id=216347
    ...
    dytc_profile_set(core::ptr::null_mut(), PLATFORM_PROFILE_BALANCED);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn dytc_profile_exit() {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct keyboard_lang_data {
    pub lang_str: *const c_char,
    pub lang_code: c_int,
}
...
#[no_mangle]
unsafe extern "C" fn set_keyboard_lang_command(command: c_int) -> c_int {
...
// Platform doesn't support SSKL
    ...
    if (!acpi_evalf(sskl_handle, &output, core::ptr::null_mut(), "dd", command))
    return -EIO;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn get_keyboard_lang(output: *mut c_int) -> c_int {
...
// Platform doesn't support GSKL
    ...
    if (!acpi_evalf(gskl_handle, &kbd_lang, core::ptr::null_mut(), "dd", 0x02000000))
    return -EIO;
//
...
// sysfs keyboard language entry
    ...
    {
    int err, i;
    let mut lang_found: bool = false;
    let mut lang_code: c_int = 0;
    for (i = 0; i < ARRAY_SIZE(keyboard_lang_data); i++) {
...
// Set language code
    ...
    sysfs_notify(&tpacpi_pdev.dev.kobj, core::ptr::null_mut(), "keyboard_lang");
    return count;
    }
...
#[no_mangle]
unsafe extern "C" fn tpacpi_kbdlang_init(iibm: *mut ibm_init_struct) -> c_int {
...
// and WLAN feature.
//
pub const DPRC_GET_WWAN_ANTENNA_TYPE: c_uint = 0x40000;

    static bool has_antennatype;
    static int wwan_antennatype;
#[no_mangle]
unsafe extern "C" fn dprc_command(command: c_int, output: *mut c_int) -> c_int {
...
// Platform doesn't support DPRC
    ...
    if (!acpi_evalf(dprc_handle, output, core::ptr::null_mut(), "dd", command))
    return -EIO;
//
...
#[no_mangle]
unsafe extern "C" fn get_wwan_antenna(wwan_antennatype: *mut c_int) -> c_int {
...
// wwan_antennatype = 1;
#[no_mangle]
pub unsafe extern "C" fn if(DPRC_WWAN_ANTENNA_TYPE_B_BIT: output &) -> else {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_dprc_init(iibm: *mut ibm_init_struct) -> c_int {
...
//
pub const AUXMAC_LEN: c_int = 12;
pub const AUXMAC_START: c_int = 9;
pub const AUXMAC_STRLEN: c_int = 22;
pub const AUXMAC_BEGIN_MARKER: c_int = 8;
pub const AUXMAC_END_MARKER: c_int = 21;
    static char auxmac[AUXMAC_LEN + 1];
#[no_mangle]
unsafe extern "C" fn auxmac_init(iibm: *mut ibm_init_struct) -> c_int {
    static int auxmac_init(struct ibm_init_struct *iibm)
    {
    acpi_status status;
    let mut buffer: acpi_buffer = { ACPI_ALLOCATE_BUFFER, core::ptr::null_mut() };
    union acpi_object *obj;
    status = acpi_evaluate_object(core::ptr::null_mut(), "\\MACA", core::ptr::null_mut(), &buffer);
    if (ACPI_FAILURE(status))
    return -ENODEV;
    obj = buffer.pointer;
...
//
pub const HWDD_GET_DMG_USBC: c_uint = 0x80000001;
pub const HWDD_GET_CAP: c_int = 0;

pub const PORT_DETAIL_OFFSET: c_int = 16;
pub const PANEL_TOP: c_int = 0;
pub const PANEL_BASE: c_int = 1;
pub const PANEL_LEFT: c_int = 2;
pub const PANEL_RIGHT: c_int = 3;
pub const POS_LEFT: c_int = 0;
pub const POS_CENTER: c_int = 1;
pub const POS_RIGHT: c_int = 2;
pub const NUM_PORTS: c_int = 4;
    static bool hwdd_support_available;
    static bool ucdd_supported;
#[no_mangle]
unsafe extern "C" fn hwdd_command(command: c_int, output: *mut c_int) -> c_int {
    ...
    return -ENODEV;
    if (!acpi_evalf(hwdd_handle, output, core::ptr::null_mut(), "dd", command))
    return -EIO;
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn display_damage(buf: *mut c_char, count: *mut c_int, type: *mut c_char, dmg_status: c_uint) -> bool {
    ...
    let mut damage_detected: bool = false;
    int i;
...
#[no_mangle]
unsafe extern "C" fn hwdd_raw_show(m: *mut seq_file, v: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_hwdd_init(iibm: *mut ibm_init_struct) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn usbc_security_query(enabled: *mut bool) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_usbc_security_init(iibm: *mut ibm_init_struct) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_usbc_security_hotkey() -> bool {
    ...
    return false;
    sysfs_notify(&tpacpi_pdev.dev.kobj, core::ptr::null_mut(), "usb_c_security");
    return true;
    }
...
//
#[no_mangle]
unsafe extern "C" fn tpacpi_driver_event(hkey_event: c_uint) -> bool {
    static bool tpacpi_driver_event(const unsigned int hkey_event)
    {
...
//
    brightness = kbdlight_sysfs_get(core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn str_supported(is_supported: c_int) -> *const char  __init {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_debugfs_init() {
    static void tpacpi_debugfs_init(void)
    {
    tpacpi_dbg = debugfs_create_dir("tpacpi", core::ptr::null_mut());
// HWDD raw data
    debugfs_create_file("hwdd-raw", 0444, tpacpi_dbg, core::ptr::null_mut(), &hwdd_raw_fops);
    }
#[no_mangle]
unsafe extern "C" fn tpacpi_debugfs_remove() {
    static void tpacpi_debugfs_remove(void)
    {
    debugfs_remove_recursive(tpacpi_dbg);
    }
#[no_mangle]
unsafe extern "C" fn ibm_exit(ibm: *mut ibm_struct) {
    ...
    ibm.acpi.device.driver_data = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn ibm_init(iibm: *mut ibm_init_struct) -> int __init {
    static int __init ibm_init(struct ibm_init_struct *iibm)
    {
    int ret;
    struct ibm_struct *ibm = iibm.data;
    struct proc_dir_entry *entry;
    BUG_ON(ibm == core::ptr::null_mut());
    ...
    "%s installed\n", ibm.name);
    if (ibm.read) {
    let mut mode: umode_t = iibm.base_procfs_mode;
    if (!mode)
    mode = S_IRUGO;
    if (ibm.write)
    mode |= S_IWUSR;
...
pub const EC_FW_STRING_LEN: c_int = 18;
#[no_mangle]
unsafe extern "C" fn find_new_ec_fwstr(dm: *const dmi_header, private: *mut c_void) {
...
// On error, kfree() cleanup on tp->* is not performed, caller must do it
    ...
    {
    const struct dmi_device *dev = core::ptr::null_mut();
...
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dmi_name_in_vendors("LENOVO")) -> else {
    else if (dmi_name_in_vendors("LENOVO"))
    tp.vendor = PCI_VENDOR_ID_LENOVO;
#[no_mangle]
pub unsafe extern "C" fn if(_arg: dmi_name_in_vendors("NEC")) -> else {
...
#[no_mangle]
unsafe extern "C" fn probe_for_thinkpad() -> int __init {
...
//
    is_thinkpad = (thinkpad_id.model_str != core::ptr::null_mut()) ||
...
#[no_mangle]
unsafe extern "C" fn thinkpad_acpi_init_banner() -> void __init {
...
#[no_mangle]
unsafe extern "C" fn set_ibm_param(val: *const c_char, kp: *const kernel_param) -> int __init {
...
// The module parameter can't be read back, that's why 0 is used here
    ...
    module_param_call(feature, set_ibm_param, core::ptr::null_mut(), core::ptr::null_mut(), 0); \
...
#[no_mangle]
unsafe extern "C" fn thinkpad_acpi_module_exit() {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_subdrivers_release(data: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn tpacpi_pdriver_probe(pdev: *mut platform_device) -> int __init {
...
// Init subdrivers
    ...
    if (ret < 0) {
    tpacpi_subdrivers_release(core::ptr::null_mut());
    return ret;
    }
    }
    ret = devm_add_action_or_reset(&pdev.dev, tpacpi_subdrivers_release, core::ptr::null_mut());
    if (ret)
    return ret;
...
#[no_mangle]
unsafe extern "C" fn tpacpi_hwmon_pdriver_probe(pdev: *mut platform_device) -> int __init {
    ...
    core::ptr::null_mut(), tpacpi_hwmon_groups);
    if (IS_ERR(tpacpi_hwmon))
    pr_err("unable to register hwmon device\n");
    return PTR_ERR_OR_ZERO(tpacpi_hwmon);
    }
#[no_mangle]
unsafe extern "C" fn thinkpad_acpi_module_init() -> int __init {
...
//
    ...
    ecrd_handle = core::ptr::null_mut();
    }
    if (ecwr_handle) {
    acpi_get_type(ecwr_handle, &obj_type);
    if (obj_type != ACPI_TYPE_METHOD)
    ecwr_handle = core::ptr::null_mut();
    }
...
// Device initialization
    ...
    tpacpi_sensors_pdev = core::ptr::null_mut();
