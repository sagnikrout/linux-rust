...
//! Source: drivers/platform/x86/lenovo/wmi-gamezone.c
#![no_std]
...
pub const LWMI_GZ_METHOD_ID_SMARTFAN_SUP: c_int = 43;
pub const LWMI_GZ_METHOD_ID_SMARTFAN_SET: c_int = 44;
pub const LWMI_GZ_METHOD_ID_SMARTFAN_GET: c_int = 45;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lwmi_gz_priv {
    pub current_mode: enum thermal_mode,
    pub event_nb: notifier_block,
    pub mode_nb: notifier_block,
    pub /: *mut *mut spinlock_t gz_mode_lock; / current_mode lock,
    pub wdev: *mut wmi_device,
    pub extreme_supported: c_int,
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_gz_extreme_supported(profile_support_ver: c_int) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_gz_platform_profile_probe(drvdata: *mut c_void, choices: *mut c_ulong) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lwmi_gz_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
    ...
    { LENOVO_GAMEZONE_GUID, core::ptr::null_mut() },
    {}
    };
