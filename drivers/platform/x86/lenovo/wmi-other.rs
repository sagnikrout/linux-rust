...
//! Source: drivers/platform/x86/lenovo/wmi-other.c
#![no_std]
...
pub const LWMI_FEATURE_ID_FAN_RPM: c_uint = 0x03;
pub const LWMI_TYPE_ID_CROSSLOAD: c_uint = 0x01;
pub const LWMI_TYPE_ID_PSU_AC: c_uint = 0x01;
pub const LWMI_FEATURE_VALUE_GET: c_int = 17;
pub const LWMI_FEATURE_VALUE_SET: c_int = 18;
pub const LWMI_FAN_ID_BASE: c_int = 1;
pub const LWMI_FAN_NR: c_int = 4;

pub const LWMI_FAN_DIV: c_int = 100;
pub const LWMI_CHARGE_BEHAVIOR_DISCHARGE: c_uint = 0x00;
pub const LWMI_CHARGE_BEHAVIOR_AUTO: c_uint = 0x01;
pub const LWMI_CHARGE_TYPE_STANDARD: c_uint = 0x00;
pub const LWMI_CHARGE_TYPE_LONGLIFE: c_uint = 0x01;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lwmi_om_priv {
    pub ops: *mut component_master_ops,
// only valid after capdata bind
    pub cd00_list: *mut cd_list,
    pub cd01_list: *mut cd_list,
    pub hwmon_dev: *mut device,
    pub fw_attr_dev: *mut device,
    pub fw_attr_kset: *mut kset,
    pub wdev: *mut wmi_device,
    pub ida_id: c_int,
    pub fan_info: [lwmi_fan_info; LWMI_FAN_NR],
    struct {
    pub 1: bool capdata00_collected :,
    pub 1: bool capdata_fan_collected :,
    pub fan_flags: },
    pub charge_behaviour: enum power_supply_charge_behaviour,
    pub battery_ext: *const power_supply_ext,
    pub battery_hook: acpi_battery_hook,
    pub bh_registered: bool,
}
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_fan_get_set(priv: *mut lwmi_om_priv, channel: c_int, val: *mut u32, set: bool) -> c_int {
    static int lwmi_om_fan_get_set(struct lwmi_om_priv *priv, int channel, u32 *val, bool set)
    {
    let mut args: wmi_method_args_32 = {};
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_hwmon_add(priv: *mut lwmi_om_priv) {
    ...
    priv.hwmon_dev = core::ptr::null_mut();
    return;
    }
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_hwmon_remove(priv: *mut lwmi_om_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_fan_info_init(priv: *mut lwmi_om_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_fan_info_collect_cd00(priv: *mut lwmi_om_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_fan_info_collect_cd_fan(dev: *mut device, cd_fan_list: *mut cd_list) {
...
//
    ...
    (u8 *)&args, sizeof(args), core::ptr::null_mut());
    }
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_psy_prop_get_supported(priv: *mut lwmi_om_priv, prop: enum power_supply_property) -> u32 {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_psy_prop_is_supported(priv: *mut lwmi_om_priv, prop: enum power_supply_property) -> bool {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_add_battery(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_remove_battery(battery: *mut power_supply, hook: *mut acpi_battery_hook) -> c_int {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_psy_ext_init(priv: *mut lwmi_om_priv) {
    static void lwmi_om_psy_ext_init(struct lwmi_om_priv *priv)
    {
    let mut ideapad_hid: *const static char  const = "VPC2004";
    let mut handle: acpi_handle = core::ptr::null_mut();
    let mut props: c_uint = 0;
    int ret;
...
// Deconflict ideapad_laptop driver
    ret = acpi_get_devices(ideapad_hid, lwmi_acpi_match, &handle, core::ptr::null_mut());
    if (ret)
    return;
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_psy_remove(priv: *mut lwmi_om_priv) {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tunable_attr_01 {
    pub dev: *mut device,
    pub feature_id: u8,
    pub device_id: u8,
    pub type_id: u8,
    pub /: *mut *mut u8 cd_mode_id; / mode arg for searching capdata,
    pub /: *mut *mut u8 cv_mode_id; / mode arg for set/get current_value,
}
...
//
#[no_mangle]
unsafe extern "C" fn tunable_attr_01_id(attr: *mut tunable_attr_01, mode: u8) -> u32 {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct capdata01_attr_group {
    pub attr_group: *const attribute_group,
    pub tunable_attr: *mut tunable_attr_01,
}
...
//
    ...
    (unsigned char *)&args, sizeof(args), core::ptr::null_mut());
    if (ret)
    return ret;
    return count;
    };
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_attr_01_is_supported(tunable_attr: *mut tunable_attr_01) -> bool {
    ...
    struct lwmi_om_priv *priv = dev_get_drvdata(tunable_attr.dev);
    let mut args: wmi_method_args_32 = {};
    let mut cd_mode_found: bool = false;
    let mut cv_mode_found: bool = false;
    struct capdata01 capdata;
    int retval, ret, i;
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_fw_attr_add(priv: *mut lwmi_om_priv) {
    ...
    goto err_no_ida;
    priv.ida_id = err;
    priv.fw_attr_dev = device_create(&firmware_attributes_class, core::ptr::null_mut(),
    MKDEV(0, 0), core::ptr::null_mut(), "%s-%u",
    LWMI_OM_SYSFS_NAME, priv.ida_id);
    if (IS_ERR(priv.fw_attr_dev)) {
    err = PTR_ERR(priv.fw_attr_dev);
    goto err_free_ida;
    }
    priv.fw_attr_kset = kset_create_and_add("attributes", core::ptr::null_mut(),
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_fw_attr_remove(priv: *mut lwmi_om_priv) {
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_master_bind(dev: *mut device) -> c_int {
    ...
    component_unbind_all(dev, core::ptr::null_mut());
    return -ENODEV;
    }
...
//
#[no_mangle]
unsafe extern "C" fn lwmi_om_master_unbind(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn lwmi_other_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
    static int lwmi_other_probe(struct wmi_device *wdev, const void *context)
    {
    struct component_match *master_match = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn lwmi_other_remove(wdev: *mut wmi_device) {
    static void lwmi_other_remove(struct wmi_device *wdev)
    {
    component_master_del(&wdev.dev, &lwmi_om_master_ops);
    }
    static const struct wmi_device_id lwmi_other_id_table[] = {
    { LENOVO_OTHER_MODE_GUID, core::ptr::null_mut() },
    {}
    };
