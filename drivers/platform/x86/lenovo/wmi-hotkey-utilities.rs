...
//! Source: drivers/platform/x86/lenovo/wmi-hotkey-utilities.c
#![no_std]
...
pub const WMI_LUD_GET_SUPPORT: c_int = 1;
pub const WMI_LUD_SET_FEATURE: c_int = 2;
pub const WMI_LUD_GET_MICMUTE_LED_VER: c_int = 20;
pub const WMI_LUD_GET_AUDIOMUTE_LED_VER: c_int = 26;
pub const WMI_LUD_SUPPORT_MICMUTE_LED_VER: c_int = 25;
pub const WMI_LUD_SUPPORT_AUDIOMUTE_LED_VER: c_int = 27;
// Input parameters to mute/unmute audio LED and Mic LED
#[repr(C)]
#[derive(Copy, Clone)]
pub struct wmi_led_args {
    pub id: u8,
    pub subid: u8,
    pub value: u16,
}
...
pub const LSH_ACPI_LED_MAX: c_int = 2;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct lenovo_super_hotkey_wmi_private {
    pub cdev: [led_classdev; LSH_ACPI_LED_MAX],
    pub led_wdev: *mut wmi_device,
}
    ...
    let mut led_arg: wmi_led_args = {0, 0, 0};
    ...
    status = wmidev_evaluate_method(wpriv.led_wdev, 0, WMI_LUD_SET_FEATURE, &input, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn lenovo_super_hotkey_wmi_led_init(led_type: enum mute_led_type, dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lenovo_super_hotkey_wmi_leds_setup(dev: *mut device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lenovo_super_hotkey_wmi_probe(wdev: *mut wmi_device, context: *const c_void) -> c_int {
    ...
    { LUD_WMI_METHOD_GUID, core::ptr::null_mut() }, /* Utility data */
    { }
    };
