...
//! Source: drivers/platform/x86/p2sb.c
#![no_std]
...
//
pub const NR_P2SB_RES_CACHE: c_int = 8;
#[repr(C)]
#[derive(Copy, Clone)]
pub struct p2sb_res_cache {
    pub bus_dev_id: u32,
    pub res: resource,
}
...
#[no_mangle]
unsafe extern "C" fn p2sb_get_devfn(devfn: *mut c_uint) {
    static void p2sb_get_devfn(unsigned int *devfn)
    {
    let mut fn: c_uint = P2SB_DEVFN_DEFAULT;
...
#[no_mangle]
unsafe extern "C" fn p2sb_valid_resource(res: *const resource) -> bool {
...
#[no_mangle]
unsafe extern "C" fn p2sb_read_bar0(pdev: *mut pci_dev, mem: *mut resource) {
...
#[no_mangle]
unsafe extern "C" fn p2sb_scan_and_cache_devfn(bus: *mut pci_bus, devfn: c_uint) {
...
#[no_mangle]
unsafe extern "C" fn p2sb_scan_and_cache(bus: *mut pci_bus, devfn: c_uint) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p2sb_cache_resources() -> c_int {
    static int p2sb_cache_resources(void)
    {
    unsigned int devfn_p2sb;
    let mut value: u32 = P2SBC_HIDE;
    struct pci_bus *bus;
    u16 class;
    let mut ret: c_int = 0;
// Get devfn for P2SB device itself
    p2sb_get_devfn(&devfn_p2sb);
    bus = p2sb_get_bus(core::ptr::null_mut());
    if (!bus)
    return -ENODEV;
//
...
//
#[no_mangle]
pub unsafe extern "C" fn p2sb_bar(bus: *mut pci_bus, devfn: c_uint, mem: *mut resource) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn p2sb_fs_init() -> int __init {
