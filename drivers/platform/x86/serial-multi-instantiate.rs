...
//! Source: drivers/platform/x86/serial-multi-instantiate.c
#![no_std]
...
pub const IRQ_RESOURCE_NONE: c_int = 0;
pub const IRQ_RESOURCE_GPIO: c_int = 1;
pub const IRQ_RESOURCE_APIC: c_int = 2;
pub const IRQ_RESOURCE_AUTO: c_int = 3;
...
#[derive(Copy, Clone)]
pub struct smi_node {
    pub bus_type: enum smi_bus_type,
    pub instances: [smi_instance; ],
}
...
pub struct smi {
    pub i2c_num: c_int,
    pub spi_num: c_int,
    pub i2c_devs: *mut i2c_client,
    pub spi_devs: *mut spi_device,
}
...
#[no_mangle]
unsafe extern "C" fn smi_devs_unregister(smi: *mut smi) {
...
//
    ...
    spi_dev = acpi_spi_device_alloc(core::ptr::null_mut(), adev, i);
    if (IS_ERR(spi_dev)) {
...
#[no_mangle]
unsafe extern "C" fn smi_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn smi_remove(pdev: *mut platform_device) {
