...
//! Source: drivers/platform/x86/intel/uncore-frequency/uncore-frequency-tpmi.c
#![no_std]
...
pub const UNCORE_MAJOR_VERSION: c_int = 0;
pub const UNCORE_MINOR_VERSION: c_int = 3;
pub const UNCORE_ELC_SUPPORTED_VERSION: c_int = 2;
pub const UNCORE_HEADER_INDEX: c_int = 0;
pub const UNCORE_FABRIC_CLUSTER_OFFSET: c_int = 8;
// status + control + adv_ctl1 + adv_ctl2

pub const UNCORE_STATUS_INDEX: c_int = 0;
pub const UNCORE_CONTROL_INDEX: c_int = 8;
pub const UNCORE_FREQ_KHZ_MULTIPLIER: c_int = 100000;
    struct tpmi_uncore_struct;
// Information for each cluster
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpmi_uncore_cluster_info {
    pub root_domain: bool,
    pub elc_supported: bool,
    pub cluster_base: *mut u8 __iomem,
    pub cdie_id: u16,
    pub uncore_data: uncore_data,
    pub uncore_root: *mut tpmi_uncore_struct,
}

// Information for each power domain
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpmi_uncore_power_domain_info {
    pub uncore_base: *mut u8 __iomem,
    pub ufs_header_ver: c_int,
    pub cluster_count: c_int,
    pub cluster_infos: *mut tpmi_uncore_cluster_info,
}

// Information for all power domains in a package
#[repr(C)]
#[derive(Copy, Clone)]
pub struct tpmi_uncore_struct {
    pub power_domain_count: c_int,
    pub max_ratio: c_int,
    pub min_ratio: c_int,
    pub pd_info: *mut tpmi_uncore_power_domain_info,
    pub root_cluster: tpmi_uncore_cluster_info,
...
#[no_mangle]
unsafe extern "C" fn read_eff_lat_ctrl(data: *mut uncore_data, val: *mut c_uint, index: enum uncore_index) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn write_eff_lat_ctrl(data: *mut uncore_data, val: c_uint, index: enum uncore_index) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn uncore_set_agent_type(cluster_info: *mut tpmi_uncore_cluster_info) {
...
pub const MAX_PARTITIONS: c_int = 2;
...
#[no_mangle]
pub unsafe extern "C" fn set_instance_id(id: c_int, cluster_info: *mut tpmi_uncore_cluster_info) {
...
#[no_mangle]
unsafe extern "C" fn uncore_write(data: *mut uncore_data, value: c_uint, index: enum uncore_index) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn remove_cluster_entries(tpmi_uncore: *mut tpmi_uncore_struct) {
...
pub const UNCORE_MAX_CLUSTER_PER_DOMAIN: c_int = 8;
#[no_mangle]
unsafe extern "C" fn uncore_probe(auxdev: *mut auxiliary_device, id: *const auxiliary_device_id) -> c_int {
    static int uncore_probe(struct auxiliary_device *auxdev, const struct auxiliary_device_id *id)
    {
    let mut read_blocked: bool = 0, write_blocked = 0;
    struct oobmsm_plat_info *plat_info;
    struct tpmi_uncore_struct *tpmi_uncore;
    let mut uncore_sysfs_added: bool = false;
    int ret, i, pkg = 0;
    int num_resources;
...
// Get the package ID from the TPMI core
    ...
    dev_info(&auxdev.dev, "Platform information is core::ptr::null_mut()\n");
    ret = -ENODEV;
    goto err_rem_common;
    }
...
//
    pd_info.uncore_base = core::ptr::null_mut();
...
// There are no dies like Cascade Lake
    ...
    if (ret) {
    cluster_info.cluster_base = core::ptr::null_mut();
    goto remove_clusters;
    }
...
#[no_mangle]
unsafe extern "C" fn uncore_remove(auxdev: *mut auxiliary_device) {
