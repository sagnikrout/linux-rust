...
//! Source: drivers/platform/x86/intel/speed_select_if/isst_if_mbox_pci.c
#![no_std]
...
pub const PUNIT_MAILBOX_DATA: c_uint = 0xA0;
pub const PUNIT_MAILBOX_INTERFACE: c_uint = 0xA4;
pub const PUNIT_MAILBOX_BUSY_BIT: c_int = 31;
//
...
//
pub const OS_MAILBOX_TIMEOUT_AVG_US: c_int = 40;
pub const OS_MAILBOX_TIMEOUT_MAX_US: c_int = 1000;
#[repr(C)]
#[derive(Copy, Clone)]
...
#[no_mangle]
unsafe extern "C" fn isst_if_mbox_remove(pdev: *mut pci_dev) {
...
unsafe extern "C" fn isst_if_resume(device: *mut device) -> int __maybe_unused {
    ...
    static SIMPLE_DEV_PM_OPS(isst_if_pm_ops, core::ptr::null_mut(), isst_if_resume);
