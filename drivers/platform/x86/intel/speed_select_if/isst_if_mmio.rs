...
//! Source: drivers/platform/x86/intel/speed_select_if/isst_if_mmio.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct isst_if_device {
    pub punit_mmio: *mut void __iomem,
    pub range_0: [u32; 5],
    pub range_1: [u32; 64],
    pub mmio_range: *mut isst_mmio_range,
    pub mutex: mutex,
}

#[no_mangle]
unsafe extern "C" fn isst_if_mmio_rd_wr(cmd_ptr: *mut u8, write_only: *mut c_int, resume: c_int) -> c_long {
...
#[no_mangle]
unsafe extern "C" fn isst_if_probe(pdev: *mut pci_dev, ent: *const pci_device_id) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn isst_if_remove(pdev: *mut pci_dev) {
...
#[no_mangle]
unsafe extern "C" fn isst_if_suspend(device: *mut device) -> int __maybe_unused {
...
#[no_mangle]
unsafe extern "C" fn isst_if_resume(device: *mut device) -> int __maybe_unused {
