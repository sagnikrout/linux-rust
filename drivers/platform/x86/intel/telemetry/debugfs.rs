...
//! Source: drivers/platform/x86/intel/telemetry/debugfs.c
#![no_std]
...
pub const TELEM_APL_PSS_PSTATES_ID: c_uint = 0x2802;
pub const TELEM_APL_PSS_IDLE_ID: c_uint = 0x2806;
pub const TELEM_APL_PCS_IDLE_BLOCKED_ID: c_uint = 0x2C00;
pub const TELEM_APL_PCS_S0IX_BLOCKED_ID: c_uint = 0x2C01;
pub const TELEM_APL_PSS_WAKEUP_ID: c_uint = 0x2C02;
pub const TELEM_APL_PSS_LTR_BLOCKING_ID: c_uint = 0x2C03;
pub const TELEM_APL_S0IX_TOTAL_OCC_ID: c_uint = 0x4000;
pub const TELEM_APL_S0IX_SHLW_OCC_ID: c_uint = 0x4001;
pub const TELEM_APL_S0IX_DEEP_OCC_ID: c_uint = 0x4002;
pub const TELEM_APL_S0IX_TOTAL_RES_ID: c_uint = 0x4800;
pub const TELEM_APL_S0IX_SHLW_RES_ID: c_uint = 0x4801;
pub const TELEM_APL_S0IX_DEEP_RES_ID: c_uint = 0x4802;
pub const TELEM_APL_D0IX_ID: c_uint = 0x581A;
pub const TELEM_APL_D3_ID: c_uint = 0x5819;
pub const TELEM_APL_PG_ID: c_uint = 0x5818;
pub const TELEM_INFO_SRAMEVTS_MASK: c_uint = 0xFF00;
pub const TELEM_INFO_SRAMEVTS_SHIFT: c_uint = 0x8;
pub const TELEM_SSRAM_READ_TIMEOUT: c_int = 10;
pub const TELEM_MASK_BIT: c_int = 1;
pub const TELEM_MASK_BYTE: c_uint = 0xFF;
pub const BYTES_PER_LONG: c_int = 8;
pub const TELEM_APL_MASK_PCS_STATE: c_uint = 0xF;
// Max events in bitmap to check for
pub const TELEM_PSS_IDLE_EVTS: c_int = 25;
pub const TELEM_PSS_IDLE_BLOCKED_EVTS: c_int = 20;
pub const TELEM_PSS_S0IX_BLOCKED_EVTS: c_int = 20;
pub const TELEM_PSS_S0IX_WAKEUP_EVTS: c_int = 20;
pub const TELEM_PSS_LTR_BLOCKING_EVTS: c_int = 20;
pub const TELEM_IOSS_DX_D0IX_EVTS: c_int = 25;
pub const TELEM_IOSS_PG_EVTS: c_int = 30;
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct telemetry_susp_stats {
    pub shlw_ctr: u32,
    pub deep_ctr: u32,
    pub shlw_res: u64,
    pub deep_res: u64,
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct telem_pss_idle_stateinfo {
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct telem_pcs_blkd_info {
    pub name: *const c_char,
    pub bit_pos: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct telem_pss_wakeup_info {
    pub name: *const c_char,
    pub bit_pos: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct telem_ioss_d0ix_stateinfo {
    pub name: *const c_char,
    pub bit_pos: u32,
}
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct telemetry_debugfs_conf {
    pub suspend_stats: telemetry_susp_stats,
    pub telemetry_dbg_dir: *mut dentry,
// Bitmap Data
    pub ioss_d0ix_data: *mut telem_ioss_d0ix_stateinfo,
    pub pss_idle_data: *mut telem_pss_idle_stateinfo,
    pub pcs_idle_blkd_data: *mut telem_pcs_blkd_info,
    pub pcs_s0ix_blkd_data: *mut telem_pcs_blkd_info,
    pub pss_wakeup: *mut telem_pss_wakeup_info,
    pub pss_ltr_data: *mut telem_pss_ltr_info,
    pub ioss_pg_data: *mut telem_ioss_pg_info,
    pub pcs_idle_blkd_evts: u8,
    pub pcs_s0ix_blkd_evts: u8,
    pub pss_wakeup_evts: u8,
    pub pss_idle_evts: u8,
    pub pss_ltr_evts: u8,
    pub ioss_d0ix_evts: u8,
    pub ioss_pg_evts: u8,
// IDs
    pub pss_ltr_blocking_id: u16,
    pub pcs_idle_blkd_id: u16,
    pub pcs_s0ix_blkd_id: u16,
    pub s0ix_total_occ_id: u16,
    pub s0ix_shlw_occ_id: u16,
    pub s0ix_deep_occ_id: u16,
    pub s0ix_total_res_id: u16,
    pub s0ix_shlw_res_id: u16,
    pub s0ix_deep_res_id: u16,
    pub pss_wakeup_id: u16,
    pub ioss_d0ix_id: u16,
    pub pstates_id: u16,
    pub pss_idle_id: u16,
    pub ioss_d3_id: u16,
    pub ioss_pg_id: u16,
...
#[no_mangle]
unsafe extern "C" fn telemetry_debugfs_check_evts() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn telem_pss_states_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn telem_ioss_states_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn telem_soc_states_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
    ...
    struct telemetry_evtlog evtlog[TELEM_MAX_OS_ALLOCATED_EVENTS];
    let mut s0ix_total_ctr: u32 = 0, s0ix_shlw_ctr = 0, s0ix_deep_ctr = 0;
    let mut s0ix_total_res: u64 = 0, s0ix_shlw_res = 0, s0ix_deep_res = 0;
    struct telemetry_debugfs_conf *conf = debugfs_conf;
...
#[no_mangle]
unsafe extern "C" fn telem_s0ix_res_get(data: *mut c_void, val: *mut u64) -> c_int {
...
// val = s0ix_total_res;
    ...
    DEFINE_DEBUGFS_ATTRIBUTE(telem_s0ix_fops, telem_s0ix_res_get, core::ptr::null_mut(), "%llu\n");
#[no_mangle]
unsafe extern "C" fn telem_pss_trc_verb_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn telem_pss_trc_verb_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn telem_ioss_trc_verb_show(s: *mut seq_file, unused: *mut c_void) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn telem_ioss_trc_verb_open(inode: *mut inode, file: *mut file) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm_suspend_prep_cb() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn pm_suspend_exit_cb() -> c_int {
...
#[no_mangle]
unsafe extern "C" fn telemetry_debugfs_init() -> int __init {
...
// Only APL supported for now
    ...
    dir = debugfs_create_dir("telemetry", core::ptr::null_mut());
    debugfs_conf.telemetry_dbg_dir = dir;
    debugfs_create_file("pss_info", S_IFREG | S_IRUGO, dir, core::ptr::null_mut(),
    &telem_pss_states_fops);
    debugfs_create_file("ioss_info", S_IFREG | S_IRUGO, dir, core::ptr::null_mut(),
    &telem_ioss_states_fops);
    debugfs_create_file("soc_states", S_IFREG | S_IRUGO, dir, core::ptr::null_mut(),
    &telem_soc_states_fops);
    debugfs_create_file("s0ix_residency_usec", S_IFREG | S_IRUGO, dir, core::ptr::null_mut(),
    &telem_s0ix_fops);
    debugfs_create_file("pss_trace_verbosity", S_IFREG | S_IRUGO, dir, core::ptr::null_mut(),
    &telem_pss_trc_verb_ops);
    debugfs_create_file("ioss_trace_verbosity", S_IFREG | S_IRUGO, dir,
    core::ptr::null_mut(), &telem_ioss_trc_verb_ops);
    return 0;
    }
#[no_mangle]
unsafe extern "C" fn telemetry_debugfs_exit() -> void __exit {
    static void __exit telemetry_debugfs_exit(void)
    {
    debugfs_remove_recursive(debugfs_conf.telemetry_dbg_dir);
    debugfs_conf.telemetry_dbg_dir = core::ptr::null_mut();
