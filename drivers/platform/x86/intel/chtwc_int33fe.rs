...
//! Source: drivers/platform/x86/intel/chtwc_int33fe.c
#![no_std]
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct cht_int33fe_data {
    pub battery_fg: *mut i2c_client,
    pub fusb302: *mut i2c_client,
    pub pi3usb30532: *mut i2c_client,
    pub dp: *mut fwnode_handle,
}
...
//
#[no_mangle]
unsafe extern "C" fn cht_int33fe_check_for_max17047(dev: *mut device, data: *mut c_void) -> c_int {
...
// The MAX17047 ACPI node doesn't have an UID, so we don't check that
    if (!acpi_dev_hid_uid_match(adev, "MAX17047", core::ptr::null_mut()))
    return 0;
...
//
    ...
    SOFTWARE_NODE_REFERENCE(core::ptr::null_mut()),
    };
...
#[no_mangle]
unsafe extern "C" fn cht_int33fe_setup_dp(data: *mut cht_int33fe_data) -> c_int {
...
// First let's find the GPU PCI device
    pdev = pci_get_class(PCI_CLASS_DISPLAY_VGA << 8, core::ptr::null_mut());
...
#[no_mangle]
unsafe extern "C" fn cht_int33fe_remove_nodes(data: *mut cht_int33fe_data) {
    static void cht_int33fe_remove_nodes(struct cht_int33fe_data *data)
    {
    software_node_unregister_node_group(node_group);
    if (data.dp) {
    data.dp.secondary = core::ptr::null_mut();
    fwnode_handle_put(data.dp);
    data.dp = core::ptr::null_mut();
    }
    }
#[no_mangle]
unsafe extern "C" fn cht_int33fe_put_swnode(data: *mut c_void) {
    static void cht_int33fe_put_swnode(void *data)
    {
    struct fwnode_handle *fwnode = data;
    fwnode_handle_put(fwnode);
    fusb302_mux_refs[0] = SOFTWARE_NODE_REFERENCE(core::ptr::null_mut());
    }
#[no_mangle]
unsafe extern "C" fn cht_int33fe_add_nodes(dev: *mut device, data: *mut cht_int33fe_data) -> c_int {
...
//
    mux_ref_node = software_node_find_by_name(core::ptr::null_mut(), "intel-xhci-usb-sw");
    if (!mux_ref_node)
    return -EPROBE_DEFER;
...
//
    ...
    {
    struct i2c_client *max17047 = core::ptr::null_mut();
...
#[no_mangle]
unsafe extern "C" fn cht_int33fe_typec_probe(pdev: *mut platform_device) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn cht_int33fe_typec_remove(pdev: *mut platform_device) {
