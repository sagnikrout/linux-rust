...
//! Source: drivers/platform/x86/intel/pmc/arl.c
#![no_std]
...
pub const IOEP_LPM_REQ_GUID: c_uint = 0x5077612;
pub const SOCS_LPM_REQ_GUID: c_uint = 0x8478657;
pub const PCHS_LPM_REQ_GUID: c_uint = 0x9684572;
pub const SOCM_LPM_REQ_GUID: c_uint = 0x2625030;
...
pub const ARL_NPU_PCI_DEV: c_uint = 0xad1d;
pub const ARL_GNA_PCI_DEV: c_uint = 0xae4c;
pub const ARL_H_NPU_PCI_DEV: c_uint = 0x7d1d;
pub const ARL_H_GNA_PCI_DEV: c_uint = 0x774c;
//
// Set power state of select devices that do not have drivers to D3
// so that they do not block Package C entry.
//
#[no_mangle]
unsafe extern "C" fn arl_d3_fixup() {
...
#[no_mangle]
unsafe extern "C" fn arl_h_d3_fixup() {
...
#[no_mangle]
unsafe extern "C" fn arl_resume(pmcdev: *mut pmc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arl_h_resume(pmcdev: *mut pmc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arl_core_init(pmcdev: *mut pmc_dev, pmc_dev_info: *mut pmc_dev_info) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn arl_h_core_init(pmcdev: *mut pmc_dev, pmc_dev_info: *mut pmc_dev_info) -> c_int {
