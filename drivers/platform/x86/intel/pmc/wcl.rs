...
//! Source: drivers/platform/x86/intel/pmc/wcl.c
#![no_std]
...
pub const PCDN_LPM_REQ_GUID: c_uint = 0x33747648;
...
pub const WCL_NPU_PCI_DEV: c_uint = 0xfd3e;
//
// Set power state of select devices that do not have drivers to D3
// so that they do not block Package C entry.
//
#[no_mangle]
unsafe extern "C" fn wcl_d3_fixup() {
    static void wcl_d3_fixup(void)
    {
    pmc_core_set_device_d3(WCL_NPU_PCI_DEV);
    }
#[no_mangle]
unsafe extern "C" fn wcl_resume(pmcdev: *mut pmc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn wcl_core_init(pmcdev: *mut pmc_dev, pmc_dev_info: *mut pmc_dev_info) -> c_int {
