...
//! Source: drivers/platform/x86/intel/pmc/mtl.c
#![no_std]
...
pub const SOCP_LPM_REQ_GUID: c_uint = 0x2625030;
pub const IOEM_LPM_REQ_GUID: c_uint = 0x4357464;
...
pub const MTL_GNA_PCI_DEV: c_uint = 0x7e4c;
pub const MTL_IPU_PCI_DEV: c_uint = 0x7d19;
pub const MTL_VPU_PCI_DEV: c_uint = 0x7d1d;
//
// Set power state of select devices that do not have drivers to D3
// so that they do not block Package C entry.
//
#[no_mangle]
unsafe extern "C" fn mtl_d3_fixup() {
...
#[no_mangle]
unsafe extern "C" fn mtl_resume(pmcdev: *mut pmc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn mtl_core_init(pmcdev: *mut pmc_dev, pmc_dev_info: *mut pmc_dev_info) -> c_int {
