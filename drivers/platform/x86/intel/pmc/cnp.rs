...
//! Source: drivers/platform/x86/intel/pmc/cnp.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn disable_c1_auto_demote(unused: *mut c_void) {
    static void disable_c1_auto_demote(void *unused)
    {
    let mut cpunum: c_int = smp_processor_id();
    u64 val;
...
#[no_mangle]
unsafe extern "C" fn restore_c1_auto_demote(unused: *mut c_void) {
...
#[no_mangle]
unsafe extern "C" fn s2idle_cpu_quirk(func: smp_call_func_t) {
    static void s2idle_cpu_quirk(smp_call_func_t func)
    {
    if (pm_suspend_via_firmware())
    return;
    on_each_cpu(func, core::ptr::null_mut(), true);
    }
#[no_mangle]
pub unsafe extern "C" fn cnl_suspend(pmcdev: *mut pmc_dev) {
...
#[no_mangle]
pub unsafe extern "C" fn cnl_resume(pmcdev: *mut pmc_dev) -> c_int {
