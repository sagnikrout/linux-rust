...
//! Source: drivers/platform/x86/intel/pmc/pltdrv.c
#![no_std]
...
#[no_mangle]
unsafe extern "C" fn intel_pmc_core_release(dev: *mut device) {
...
#[no_mangle]
unsafe extern "C" fn pmc_core_platform_init() -> int __init {
    static int __init pmc_core_platform_init(void)
    {
    int retval;
// Skip creating the platform device if ACPI already has a device
    if (acpi_dev_present("INT33A1", core::ptr::null_mut(), -1))
    return -ENODEV;
//
...
#[no_mangle]
unsafe extern "C" fn pmc_core_platform_exit() -> void __exit {
