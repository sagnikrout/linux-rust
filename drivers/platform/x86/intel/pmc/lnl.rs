...
//! Source: drivers/platform/x86/intel/pmc/lnl.c
#![no_std]
...
pub const SOCM_LPM_REQ_GUID: c_uint = 0x15099748;
...
pub const LNL_NPU_PCI_DEV: c_uint = 0x643e;
pub const LNL_IPU_PCI_DEV: c_uint = 0x645d;
//
// Set power state of select devices that do not have drivers to D3
// so that they do not block Package C entry.
//
#[no_mangle]
unsafe extern "C" fn lnl_d3_fixup() {
...
#[no_mangle]
unsafe extern "C" fn lnl_resume(pmcdev: *mut pmc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn lnl_core_init(pmcdev: *mut pmc_dev, pmc_dev_info: *mut pmc_dev_info) -> c_int {
