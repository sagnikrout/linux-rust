...
//! Source: drivers/platform/x86/intel/pmc/ptl.c
#![no_std]
...
pub const PCDP_LPM_REQ_GUID: c_uint = 0x47179370;
//
...
pub const PTL_NPU_PCI_DEV: c_uint = 0xb03e;
pub const PTL_IPU_PCI_DEV: c_uint = 0xb05d;
//
// Set power state of select devices that do not have drivers to D3
// so that they do not block Package C entry.
//
#[no_mangle]
unsafe extern "C" fn ptl_d3_fixup() {
...
#[no_mangle]
unsafe extern "C" fn ptl_resume(pmcdev: *mut pmc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn ptl_core_init(pmcdev: *mut pmc_dev, pmc_dev_info: *mut pmc_dev_info) -> c_int {
