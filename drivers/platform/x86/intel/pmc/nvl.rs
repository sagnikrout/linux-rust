...
//! Source: drivers/platform/x86/intel/pmc/nvl.c
#![no_std]
...
pub const PCDH_LPM_REQ_GUID: c_uint = 0x01093101;
pub const PCHS_LPM_REQ_GUID: c_uint = 0x01092101;
pub const PCDS_LPM_REQ_GUID: c_uint = 0x01091102;
//
...
pub const NVL_NPU_PCI_DEV: c_uint = 0xd71d;
//
// Set power state of select devices that do not have drivers to D3
// so that they do not block Package C entry.
//
#[no_mangle]
unsafe extern "C" fn nvl_d3_fixup() {
    static void nvl_d3_fixup(void)
    {
    pmc_core_set_device_d3(NVL_NPU_PCI_DEV);
    }
#[no_mangle]
unsafe extern "C" fn nvl_resume(pmcdev: *mut pmc_dev) -> c_int {
...
#[no_mangle]
unsafe extern "C" fn nvl_core_init(pmcdev: *mut pmc_dev, pmc_dev_info: *mut pmc_dev_info) -> c_int {
